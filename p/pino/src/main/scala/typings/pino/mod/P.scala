...
object P {
  ...
  object stdSerializers {
    ...
    @JSImport("pino", "P.stdSerializers")
    @js.native
    val ^ : js.Any = js.native
  ...
  object stdTimeFunctions {
    ...
    @JSImport("pino", "P.stdTimeFunctions")
    @js.native
    val ^ : js.Any = js.native
    ...
    /**
      * The default time function for Pino. Returns a string like `,"time":1493426328206`.
      */
    @JSImport("pino", "P.stdTimeFunctions.epochTime")
    @js.native
    ...
    /*
      * Returns ISO 8601-formatted time in UTC
      */
    @JSImport("pino", "P.stdTimeFunctions.isoTime")
    @js.native
    ...
    /**
      * Returns an empty string. This function is used when the `timestamp` option is set to `false`.
      */
    @JSImport("pino", "P.stdTimeFunctions.nullTime")
    @js.native
    ...
    /*
      * Returns the seconds since Unix epoch
      */
    @JSImport("pino", "P.stdTimeFunctions.unixTime")
    @js.native
  ...
  object symbols {
    ...
    @JSImport("pino", "P.symbols.asJsonSym")
    @js.native
    val asJsonSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.chindingsSym")
    @js.native
    val chindingsSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.endSym")
    @js.native
    val endSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.errorKeySym")
    @js.native
    val errorKeySym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.formatOptsSym")
    @js.native
    val formatOptsSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.formattersSym")
    @js.native
    val formattersSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.getLevelSym")
    @js.native
    val getLevelSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.hooksSym")
    @js.native
    val hooksSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.levelValSym")
    @js.native
    val levelValSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.lsCacheSym")
    @js.native
    val lsCacheSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.messageKeySym")
    @js.native
    val messageKeySym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.mixinSym")
    @js.native
    val mixinSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.needsMetadataGsym")
    @js.native
    val needsMetadataGsym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.nestedKeySym")
    @js.native
    val nestedKeySym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.parsedChindingsSym")
    @js.native
    val parsedChindingsSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.redactFmtSym")
    @js.native
    val redactFmtSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.serializersSym")
    @js.native
    val serializersSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.setLevelSym")
    @js.native
    val setLevelSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.streamSym")
    @js.native
    val streamSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.stringifiersSym")
    @js.native
    val stringifiersSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.stringifySafeSym")
    @js.native
    val stringifySafeSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.stringifySym")
    @js.native
    val stringifySym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.timeSliceIndexSym")
    @js.native
    val timeSliceIndexSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.timeSym")
    @js.native
    val timeSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.useLevelLabelsSym")
    @js.native
    val useLevelLabelsSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.useOnlyCustomLevelsSym")
    @js.native
    val useOnlyCustomLevelsSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.wildcardFirstSym")
    @js.native
    val wildcardFirstSym: js.Symbol = js.native
    
    @JSImport("pino", "P.symbols.writeSym")
    @js.native
