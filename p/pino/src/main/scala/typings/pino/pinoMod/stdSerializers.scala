...
import typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomErrorSerializer
import typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomRequestSerializer
import typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.CustomResponseSerializer
...
object stdSerializers extends js.Object {
  ...
  var err_Original: js.Function1[
    /* err */ Error, 
    typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedError
  ] = js.native
  /**
    * Returns an object:
    * ```
  ...
  var req_Original: js.Function1[
    /* req */ IncomingMessage, 
    typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedRequest
  ] = js.native
  /**
  ...
  var res_Original: js.Function1[
    /* res */ ServerResponse, 
    typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedResponse
  ] = js.native
  /**
  ...
  /**
    * Serializes an Error object.
    */
  def err(err: Error): typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedError = js.native
  /**
    * Returns an object:
    * ```
    * {
  ...
  /**
    * Generates a JSONifiable object from the HTTP `request` object passed to the `createServer` callback of Node's HTTP server.
    */
  def req(req: IncomingMessage): typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedRequest = js.native
  /**
    * Generates a JSONifiable object from the HTTP `response` object passed to the `createServer` callback of Node's HTTP server.
    */
  def res(res: ServerResponse): typings.pinoDashStdDashSerializers.pinoDashStdDashSerializersMod.SerializedResponse = js.native
  /**
    * A utility method for wrapping the default error serializer. Allows custom serializers to work with the
    * already serialized object.
    * @param customSerializer The custom error serializer. Accepts a single parameter: the newly serialized
