...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def destination(): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  def destination(fileDescriptor: String): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  def destination(fileDescriptor: Double): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  /**
    ...
    * @returns A Sonic-Boom  stream to be used as destination for the pino function
    */
  def extreme(): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  def extreme(fileDescriptor: String): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  def extreme(fileDescriptor: Double): typings.sonicDashBoom.sonicDashBoomMod.^ = js.native
  /**
