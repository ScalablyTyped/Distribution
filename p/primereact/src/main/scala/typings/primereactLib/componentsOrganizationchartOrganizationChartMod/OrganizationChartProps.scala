...
trait OrganizationChartProps extends js.Object {
  ...
  var nodeTemplate: js.UndefOr[js.Function1[/* node */ OrganizationChartNodeData, reactLib.reactMod.ReactNode]] = js.undefined
...
object OrganizationChartProps {
  ...
  def apply(
    ...
    nodeTemplate: /* node */ OrganizationChartNodeData => reactLib.reactMod.ReactNode = null,
