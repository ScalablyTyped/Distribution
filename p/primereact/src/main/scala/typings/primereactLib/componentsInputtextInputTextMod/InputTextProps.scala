...
trait InputTextProps
  ...
  var onKeyPress_InputTextProps: js.UndefOr[
    js.Function1[
      /* event */ reactLib.reactMod.ReactNs.KeyboardEvent[stdLib.HTMLInputElement], 
      scala.Unit
    ]
  ] = js.undefined
...
object InputTextProps {
  ...
  def apply(
    ...
    onInput: /* event */ reactLib.reactMod.ReactNs.FormEvent[stdLib.HTMLInputElement] => scala.Unit = null,
    onKeyPress: /* event */ reactLib.reactMod.ReactNs.KeyboardEvent[stdLib.HTMLInputElement] => scala.Unit = null,
    tooltip: js.Any = null,
