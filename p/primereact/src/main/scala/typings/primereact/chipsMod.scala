...
object chipsMod {
  ...
  @JSImport("primereact/chips/chips", "Chips")
  @js.native
  open class Chips protected () extends Component[ChipsProps, Any, Any] {
  ...
  object ChipsRemovableOptions {
    ...
    inline def apply(index: Double, props: ChipsProps, value: Any): ChipsRemovableOptions = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: ChipsRemovableOptions](x: Self) {
      ...
      inline def setProps(value: ChipsProps): Self = StObject.set(x, "props", value.asInstanceOf[js.Any])
