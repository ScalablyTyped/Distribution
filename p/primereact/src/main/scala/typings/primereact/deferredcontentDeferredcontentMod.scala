...
object deferredcontentDeferredcontentMod {
  ...
  trait DeferredContentProps extends StObject {
    ...
    var onLoad: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.undefined
  ...
  object DeferredContentProps {
    ...
    implicit open class MutableBuilder[Self <: DeferredContentProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnLoad(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onLoad", js.Any.fromFunction1(value))
