...
object scrollpanelScrollpanelMod {
  
  @JSImport("primereact/scrollpanel/scrollpanel", "ScrollPanel")
  @js.native
  open class ScrollPanel protected () extends Component[ScrollPanelProps, Any, Any] {
    def this(props: ScrollPanelProps) = this()
    /**
      * @deprecated
      * @see https://legacy.reactjs.org/docs/legacy-context.html
      */
    def this(props: ScrollPanelProps, context: Any) = this()
    ...
    /**
      ...
      */
    def getXBar(): HTMLDivElement = js.native
  ...
  object ScrollPanelProps {
    ...
    inline def apply(): ScrollPanelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ScrollPanelProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ScrollPanelProps] (val x: Self) extends AnyVal {
