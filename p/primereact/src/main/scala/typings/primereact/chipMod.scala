...
object chipMod {
  ...
  @JSImport("primereact/chip/chip", "Chip")
  @js.native
  open class Chip protected () extends Component[ChipProps, Any, Any] {
  ...
  object ChipProps {
    ...
    extension [Self <: ChipProps](x: Self) {
      ...
      inline def setOnImageError(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onImageError", js.Any.fromFunction1(value))
      ...
      inline def setOnRemove(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onRemove", js.Any.fromFunction1(value))
