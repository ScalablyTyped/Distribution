...
object toolbarMod {
  ...
  object ToolbarProps {
    ...
    extension [Self <: ToolbarProps](x: Self) {
      ...
      inline def setLeft(value: /* props */ js.Object => js.Any): Self = StObject.set(x, "left", js.Any.fromFunction1(value))
      
      inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
      
      inline def setRight(value: /* props */ js.Object => js.Any): Self = StObject.set(x, "right", js.Any.fromFunction1(value))
