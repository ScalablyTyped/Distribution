...
object multiselectMod {
  ...
  @JSImport("primereact/multiselect/multiselect", "MultiSelect")
  @js.native
  open class MultiSelect protected () extends Component[MultiSelectProps, Any, Any] {
  ...
  object MultiSelectChangeParams {
    ...
    extension [Self <: MultiSelectChangeParams](x: Self) {
      ...
      inline def setTarget(value: MultiSelectChangeTargetOptions): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object MultiSelectChangeTargetOptions {
    ...
    inline def apply(id: String, name: String, value: Any): MultiSelectChangeTargetOptions = {
  ...
  */
  ...
  object MultiSelectFilterOptions {
    ...
    inline def apply(): MultiSelectFilterOptions = {
