...
/* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement>, 'onContextMenu' | 'onSelect' | 'ref' | 'value'> */
trait TreeTableProps extends StObject {
  ...
  var columnResizeMode: js.UndefOr[TreeTableColumnResizeModeType] = js.undefined
  ...
  var defaultSortOrder: js.UndefOr[TreeTableSortOrderType] = js.undefined
  ...
  var expandedKeys: js.UndefOr[TreeTableExpandedKeysType] = js.undefined
  
  var filterDelay: js.UndefOr[Double] = js.undefined
  
  var filterLocale: js.UndefOr[String] = js.undefined
  
  var filterMode: js.UndefOr[TreeTableFilterModeType] = js.undefined
  
  var filters: js.UndefOr[TreeTableFilterMeta] = js.undefined
  
  var first: js.UndefOr[Double] = js.undefined
  
  var footer: js.UndefOr[ReactNode] = js.undefined
  
  var footerColumnGroup: js.UndefOr[ReactElement] = js.undefined
  ...
  var frozenFooterColumnGroup: js.UndefOr[ReactElement] = js.undefined
  
  var frozenHeaderColumnGroup: js.UndefOr[ReactElement] = js.undefined
  ...
  var headerColumnGroup: js.UndefOr[ReactElement] = js.undefined
  ...
  var multiSortMeta: js.UndefOr[TreeTableMultiSortMetaType] = js.undefined
  ...
  var onColReorder: js.UndefOr[js.Function1[/* e */ TreeTableColReorderParams, Unit]] = js.undefined
  
  var onCollapse: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  
  var onColumnResizeEnd: js.UndefOr[js.Function1[/* e */ TreeTableColumnResizeEndParams, Unit]] = js.undefined
  ...
  var onContextMenu: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  
  var onContextMenuSelectionChange: js.UndefOr[js.Function1[/* e */ TreeTableSelectionParams, Unit]] = js.undefined
  ...
  var onExpand: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  
  var onFilter: js.UndefOr[js.Function1[/* filters */ js.Array[TreeTableFilterMeta], Unit]] = js.undefined
  ...
  var onPage: js.UndefOr[js.Function1[/* e */ TreeTablePageParams, Unit]] = js.undefined
  ...
  var onRowClick: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  ...
  var onSelect: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  
  var onSelectionChange: js.UndefOr[js.Function1[/* e */ TreeTableSelectionParams, Unit]] = js.undefined
  
  var onSort: js.UndefOr[js.Function1[/* e */ TreeTableSortParams, Unit]] = js.undefined
  ...
  var onToggle: js.UndefOr[js.Function1[/* e */ TreeTableToggleParams, Unit]] = js.undefined
  ...
  var onUnselect: js.UndefOr[js.Function1[/* e */ TreeTableEventParams, Unit]] = js.undefined
  ...
  var paginatorDropdownAppendTo: js.UndefOr[TreeTableAppendToType] = js.undefined
  
  var paginatorLeft: js.UndefOr[ReactNode] = js.undefined
  
  var paginatorPosition: js.UndefOr[TreeTablePaginatorPositionType] = js.undefined
  ...
  var rowClassName: js.UndefOr[
    js.Function1[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TreeNode */ /* data */ Any, 
      js.Object
    ]
  ] = js.undefined
  ...
  var selectionKeys: js.UndefOr[TreeTableSelectionKeys] = js.undefined
  
  var selectionMode: js.UndefOr[TreeTableSelectionModeType] = js.undefined
  ...
  var sortMode: js.UndefOr[TreeTableSortModeType] = js.undefined
  
  var sortOrder: js.UndefOr[TreeTableSortOrderType] = js.undefined
...
object TreeTableProps {
  ...
  extension [Self <: TreeTableProps](x: Self) {
    ...
    inline def setColumnResizeMode(value: TreeTableColumnResizeModeType): Self = StObject.set(x, "columnResizeMode", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultSortOrder(value: TreeTableSortOrderType): Self = StObject.set(x, "defaultSortOrder", value.asInstanceOf[js.Any])
    ...
    inline def setExpandedKeys(value: TreeTableExpandedKeysType): Self = StObject.set(x, "expandedKeys", value.asInstanceOf[js.Any])
    ...
    inline def setFilterMode(value: TreeTableFilterModeType): Self = StObject.set(x, "filterMode", value.asInstanceOf[js.Any])
    
    inline def setFilterModeUndefined: Self = StObject.set(x, "filterMode", js.undefined)
    
    inline def setFilters(value: TreeTableFilterMeta): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
    ...
    inline def setFooterColumnGroup(value: ReactElement): Self = StObject.set(x, "footerColumnGroup", value.asInstanceOf[js.Any])
    ...
    inline def setFrozenFooterColumnGroup(value: ReactElement): Self = StObject.set(x, "frozenFooterColumnGroup", value.asInstanceOf[js.Any])
    
    inline def setFrozenFooterColumnGroupUndefined: Self = StObject.set(x, "frozenFooterColumnGroup", js.undefined)
    
    inline def setFrozenHeaderColumnGroup(value: ReactElement): Self = StObject.set(x, "frozenHeaderColumnGroup", value.asInstanceOf[js.Any])
    ...
    inline def setHeaderColumnGroup(value: ReactElement): Self = StObject.set(x, "headerColumnGroup", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: ChangeEvent[HTMLDivElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    inline def setOnColReorder(value: /* e */ TreeTableColReorderParams => Unit): Self = StObject.set(x, "onColReorder", js.Any.fromFunction1(value))
    
    inline def setOnColReorderUndefined: Self = StObject.set(x, "onColReorder", js.undefined)
    
    inline def setOnCollapse(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onCollapse", js.Any.fromFunction1(value))
    
    inline def setOnCollapseUndefined: Self = StObject.set(x, "onCollapse", js.undefined)
    
    inline def setOnColumnResizeEnd(value: /* e */ TreeTableColumnResizeEndParams => Unit): Self = StObject.set(x, "onColumnResizeEnd", js.Any.fromFunction1(value))
    ...
    inline def setOnContextMenu(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onContextMenu", js.Any.fromFunction1(value))
    
    inline def setOnContextMenuSelectionChange(value: /* e */ TreeTableSelectionParams => Unit): Self = StObject.set(x, "onContextMenuSelectionChange", js.Any.fromFunction1(value))
    ...
    inline def setOnExpand(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onExpand", js.Any.fromFunction1(value))
    
    inline def setOnExpandUndefined: Self = StObject.set(x, "onExpand", js.undefined)
    
    inline def setOnFilter(value: /* filters */ js.Array[TreeTableFilterMeta] => Unit): Self = StObject.set(x, "onFilter", js.Any.fromFunction1(value))
    ...
    inline def setOnPage(value: /* e */ TreeTablePageParams => Unit): Self = StObject.set(x, "onPage", js.Any.fromFunction1(value))
    ...
    inline def setOnRowClick(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onRowClick", js.Any.fromFunction1(value))
    ...
    inline def setOnSelect(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction1(value))
    
    inline def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
    
    inline def setOnSelectionChange(value: /* e */ TreeTableSelectionParams => Unit): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction1(value))
    
    inline def setOnSelectionChangeUndefined: Self = StObject.set(x, "onSelectionChange", js.undefined)
    
    inline def setOnSort(value: /* e */ TreeTableSortParams => Unit): Self = StObject.set(x, "onSort", js.Any.fromFunction1(value))
    ...
    inline def setOnToggle(value: /* e */ TreeTableToggleParams => Unit): Self = StObject.set(x, "onToggle", js.Any.fromFunction1(value))
    ...
    inline def setOnUnselect(value: /* e */ TreeTableEventParams => Unit): Self = StObject.set(x, "onUnselect", js.Any.fromFunction1(value))
    ...
    inline def setPaginatorClassName(value: String): Self = StObject.set(x, "paginatorClassName", value.asInstanceOf[js.Any])
    
    inline def setPaginatorClassNameUndefined: Self = StObject.set(x, "paginatorClassName", js.undefined)
    
    inline def setPaginatorDropdownAppendTo(value: TreeTableAppendToType): Self = StObject.set(x, "paginatorDropdownAppendTo", value.asInstanceOf[js.Any])
    ...
    inline def setPaginatorLeft(value: ReactNode): Self = StObject.set(x, "paginatorLeft", value.asInstanceOf[js.Any])
    
    inline def setPaginatorLeftUndefined: Self = StObject.set(x, "paginatorLeft", js.undefined)
    
    inline def setPaginatorPosition(value: TreeTablePaginatorPositionType): Self = StObject.set(x, "paginatorPosition", value.asInstanceOf[js.Any])
    
    inline def setPaginatorPositionUndefined: Self = StObject.set(x, "paginatorPosition", js.undefined)
    
    inline def setPaginatorRight(value: ReactNode): Self = StObject.set(x, "paginatorRight", value.asInstanceOf[js.Any])
    
    inline def setPaginatorRightUndefined: Self = StObject.set(x, "paginatorRight", js.undefined)
    
    inline def setPaginatorTemplate(
      value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PaginatorTemplate */ Any
    ): Self = StObject.set(x, "paginatorTemplate", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "rowClassName", js.Any.fromFunction1(value))
    ...
    inline def setSelectOnEdit(value: Boolean): Self = StObject.set(x, "selectOnEdit", value.asInstanceOf[js.Any])
    
    inline def setSelectOnEditUndefined: Self = StObject.set(x, "selectOnEdit", js.undefined)
    
    inline def setSelectionKeys(value: TreeTableSelectionKeys): Self = StObject.set(x, "selectionKeys", value.asInstanceOf[js.Any])
    ...
    inline def setSelectionKeysVarargs(value: TreeTableSelectionKeysType*): Self = StObject.set(x, "selectionKeys", js.Array(value*))
    
    inline def setSelectionMode(value: TreeTableSelectionModeType): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
    ...
    inline def setSortMode(value: TreeTableSortModeType): Self = StObject.set(x, "sortMode", value.asInstanceOf[js.Any])
