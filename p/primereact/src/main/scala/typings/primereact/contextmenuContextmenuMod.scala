...
object contextmenuContextmenuMod {
  
  @JSImport("primereact/contextmenu/contextmenu", "ContextMenu")
  @js.native
  open class ContextMenu protected () extends Component[ContextMenuProps, Any, Any] {
