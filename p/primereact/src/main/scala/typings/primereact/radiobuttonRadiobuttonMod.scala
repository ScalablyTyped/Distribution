...
object radiobuttonRadiobuttonMod {
  ...
  open class RadioButton protected () extends Component[RadioButtonProps, Any, Any] {
    ...
    def select(e: SyntheticEvent[Element, Event]): Unit = js.native
  }
  ...
  object RadioButtonProps {
    ...
    implicit open class MutableBuilder[Self <: RadioButtonProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: /* e */ RadioButtonChangeParams => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
