package typings.primereact.componentsCarouselCarouselMod

import typings.primereact.Anon_Page
...
object CarouselProps {
  ...
  def apply(
    ...
    if (dotsContainerClassName != null) __obj.updateDynamic("dotsContainerClassName")(dotsContainerClassName)
    ...
    if (responsiveOptions != null) __obj.updateDynamic("responsiveOptions")(responsiveOptions)
    if (style != null) __obj.updateDynamic("style")(style)
    if (value != null) __obj.updateDynamic("value")(value)
    if (verticalViewPortHeight != null) __obj.updateDynamic("verticalViewPortHeight")(verticalViewPortHeight)
