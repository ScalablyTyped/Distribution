...
object TargetValue {
  ...
  inline def apply(originalEvent: typings.std.Event, target: IdName, value: Boolean): TargetValue = {
  ...
  extension [Self <: TargetValue](x: Self) {
    
    inline def setOriginalEvent(value: typings.std.Event): Self = StObject.set(x, "originalEvent", value.asInstanceOf[js.Any])
    
    inline def setTarget(value: IdName): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
