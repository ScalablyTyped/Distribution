...
object speeddialSpeeddialMod {
  ...
  @JSImport("primereact/speeddial/speeddial", "SpeedDial")
  @js.native
  open class SpeedDial protected () extends Component[SpeedDialProps, Any, Any] {
  ...
  object SpeedDialButtonOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], element = element.asInstanceOf[js.Any], iconClassName = iconClassName.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], visible = visible.asInstanceOf[js.Any])
  ...
  */
  ...
  object SpeedDialProps {
    ...
    inline def apply(): SpeedDialProps = {
    ...
    extension [Self <: SpeedDialProps](x: Self) {
      ...
      inline def setButtonClassName(value: String): Self = StObject.set(x, "buttonClassName", value.asInstanceOf[js.Any])
      ...
      inline def setHideIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<SpeedDialProps> */ Any
      ): Self = StObject.set(x, "hideIcon", value.asInstanceOf[js.Any])
      
      inline def setHideIconUndefined: Self = StObject.set(x, "hideIcon", js.undefined)
      
      inline def setHideOnClickOutside(value: Boolean): Self = StObject.set(x, "hideOnClickOutside", value.asInstanceOf[js.Any])
      
      inline def setHideOnClickOutsideUndefined: Self = StObject.set(x, "hideOnClickOutside", js.undefined)
      ...
      inline def setRotateAnimation(value: Boolean): Self = StObject.set(x, "rotateAnimation", value.asInstanceOf[js.Any])
      
      inline def setRotateAnimationUndefined: Self = StObject.set(x, "rotateAnimation", js.undefined)
      
      inline def setSecurity(value: String): Self = StObject.set(x, "security", value.asInstanceOf[js.Any])
      
      inline def setSecurityUndefined: Self = StObject.set(x, "security", js.undefined)
      
      inline def setShowIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<SpeedDialProps> */ Any
      ): Self = StObject.set(x, "showIcon", value.asInstanceOf[js.Any])
