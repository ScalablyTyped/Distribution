...
object listboxMod {
  ...
  @JSImport("primereact/listbox/listbox", "ListBox")
  @js.native
  open class ListBox protected () extends Component[ListBoxProps, Any, Any] {
  ...
  object ListBoxChangeParams {
    ...
    extension [Self <: ListBoxChangeParams](x: Self) {
      ...
      inline def setTarget(value: ListBoxChangeTargetOptions): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
  ...
  object ListBoxChangeTargetOptions {
    ...
    inline def apply(id: String, name: String, value: Any): ListBoxChangeTargetOptions = {
  ...
  object ListBoxFilterOptions {
    ...
    inline def apply(): ListBoxFilterOptions = {
