...
object avatargroupMod {
  ...
  @JSImport("primereact/avatargroup/avatargroup", "AvatarGroup")
  @js.native
  open class AvatarGroup protected () extends Component[AvatarGroupProps, Any, Any] {
    def this(props: AvatarGroupProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: AvatarGroupProps, context: Any) = this()
  ...
  object AvatarGroupProps {
    ...
    inline def apply(): AvatarGroupProps = {
