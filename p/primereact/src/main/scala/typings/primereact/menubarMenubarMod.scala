...
object menubarMenubarMod {
  
  @JSImport("primereact/menubar/menubar", "Menubar")
  @js.native
  open class Menubar protected () extends Component[MenubarProps, Any, Any] {
  ...
  object MenubarProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: MenubarProps] (val x: Self) extends AnyVal {
