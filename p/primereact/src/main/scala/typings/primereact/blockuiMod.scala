...
object blockuiMod {
  ...
  @JSImport("primereact/blockui/blockui", "BlockUI")
  @js.native
  open class BlockUI protected () extends Component[BlockUIProps, Any, Any] {
  ...
  object BlockUIProps {
    ...
    extension [Self <: BlockUIProps](x: Self) {
      ...
      inline def setOnBlocked(value: () => Unit): Self = StObject.set(x, "onBlocked", js.Any.fromFunction0(value))
      
      inline def setOnBlockedUndefined: Self = StObject.set(x, "onBlocked", js.undefined)
      ...
      inline def setOnUnblocked(value: () => Unit): Self = StObject.set(x, "onUnblocked", js.Any.fromFunction0(value))
      
      inline def setOnUnblockedUndefined: Self = StObject.set(x, "onUnblocked", js.undefined)
