...
object panelPanelMod {
  ...
  @JSImport("primereact/panel/panel", "Panel")
  @js.native
  open class Panel protected () extends Component[PanelProps, Any, Any] {
  ...
  object PanelHeaderTemplateOptions {
    ...
    inline def apply(
      ...
      onTogglerClick: MouseEvent[HTMLElement, NativeMouseEvent] => Unit,
      props: PanelProps,
      ...
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], collapsed = collapsed.asInstanceOf[js.Any], element = element.asInstanceOf[js.Any], iconsClassName = iconsClassName.asInstanceOf[js.Any], iconsElement = iconsElement.asInstanceOf[js.Any], onTogglerClick = js.Any.fromFunction1(onTogglerClick), props = props.asInstanceOf[js.Any], titleClassName = titleClassName.asInstanceOf[js.Any], titleElement = titleElement.asInstanceOf[js.Any], togglerClassName = togglerClassName.asInstanceOf[js.Any], togglerElement = togglerElement.asInstanceOf[js.Any], togglerIconClassName = togglerIconClassName.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: PanelHeaderTemplateOptions] (val x: Self) extends AnyVal {
      ...
      inline def setIconsClassName(value: String): Self = StObject.set(x, "iconsClassName", value.asInstanceOf[js.Any])
      
      inline def setIconsElement(value: Element): Self = StObject.set(x, "iconsElement", value.asInstanceOf[js.Any])
      
      inline def setOnTogglerClick(value: MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onTogglerClick", js.Any.fromFunction1(value))
      ...
      inline def setTogglerClassName(value: String): Self = StObject.set(x, "togglerClassName", value.asInstanceOf[js.Any])
      
      inline def setTogglerElement(value: Element): Self = StObject.set(x, "togglerElement", value.asInstanceOf[js.Any])
  ...
  object PanelProps {
    ...
    implicit open class MutableBuilder[Self <: PanelProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnCollapse(value: /* event */ SyntheticEvent[typings.std.Element, Event] => Unit): Self = StObject.set(x, "onCollapse", js.Any.fromFunction1(value))
      ...
      inline def setOnExpand(value: /* event */ SyntheticEvent[typings.std.Element, Event] => Unit): Self = StObject.set(x, "onExpand", js.Any.fromFunction1(value))
