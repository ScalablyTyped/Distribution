...
object autocompleteMod {
  ...
  object AutoCompleteProps {
    ...
    extension [Self <: AutoCompleteProps](x: Self) {
      ...
      inline def setOnClear(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onClear", js.Any.fromFunction1(value))
      ...
      inline def setOnDblClick(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onDblClick", js.Any.fromFunction1(value))
      ...
      inline def setOnMouseDown(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
