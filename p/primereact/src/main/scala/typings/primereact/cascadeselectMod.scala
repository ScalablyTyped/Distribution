...
import typings.primereact.selectitemMod.SelectItem
import typings.primereact.selectitemMod.SelectItemOptionsType
...
object cascadeselectMod {
  
  @JSImport("primereact/cascadeselect/cascadeselect", "CascadeSelect")
  @js.native
  open class CascadeSelect protected () extends Component[CascadeSelectProps, Any, Any] {
  ...
  object CascadeSelectProps {
    
    inline def apply(): CascadeSelectProps = {
    ...
    extension [Self <: CascadeSelectProps](x: Self) {
      ...
      inline def setOnBeforeHide(value: () => Unit): Self = StObject.set(x, "onBeforeHide", js.Any.fromFunction0(value))
      ...
      inline def setOnBeforeShow(value: () => Unit): Self = StObject.set(x, "onBeforeShow", js.Any.fromFunction0(value))
      ...
      inline def setOptionGroupChildren(value: js.Array[String]): Self = StObject.set(x, "optionGroupChildren", value.asInstanceOf[js.Any])
      ...
      inline def setOptions(value: SelectItemOptionsType): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
