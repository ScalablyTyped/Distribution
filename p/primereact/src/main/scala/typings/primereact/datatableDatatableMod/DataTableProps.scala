...
object DataTableProps {
  ...
  extension [Self <: DataTableProps](x: Self) {
    ...
    inline def setCustomSaveState(value: /* state */ js.Object => Unit): Self = StObject.set(x, "customSaveState", js.Any.fromFunction1(value))
    ...
    inline def setOnStateRestore(value: /* state */ js.Object => Unit): Self = StObject.set(x, "onStateRestore", js.Any.fromFunction1(value))
    
    inline def setOnStateRestoreUndefined: Self = StObject.set(x, "onStateRestore", js.undefined)
    
    inline def setOnStateSave(value: /* state */ js.Object => Unit): Self = StObject.set(x, "onStateSave", js.Any.fromFunction1(value))
