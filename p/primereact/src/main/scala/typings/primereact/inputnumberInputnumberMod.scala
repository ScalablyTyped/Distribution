...
object inputnumberInputnumberMod {
  
  @JSImport("primereact/inputnumber/inputnumber", "InputNumber")
  @js.native
  open class InputNumber protected () extends Component[InputNumberProps, Any, Any] {
  ...
  /* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLSpanElement>, std.HTMLSpanElement>, 'onChange' | 'ref'> */
