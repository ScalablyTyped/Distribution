...
object GrowlProps {
  ...
  implicit class GrowlPropsOps[Self <: GrowlProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnClick(value: /* message */ GrowlMessage => Unit): Self = this.set("onClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnClick: Self = this.set("onClick", js.undefined)
    @scala.inline
    def setOnClose(value: /* message */ GrowlMessage => Unit): Self = this.set("onClose", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnClose: Self = this.set("onClose", js.undefined)
    @scala.inline
    def setOnRemove(value: /* message */ GrowlMessage => Unit): Self = this.set("onRemove", js.Any.fromFunction1(value))
    @scala.inline
