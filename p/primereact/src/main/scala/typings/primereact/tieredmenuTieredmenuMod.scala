...
object tieredmenuTieredmenuMod {
  
  @JSImport("primereact/tieredmenu/tieredmenu", "TieredMenu")
  @js.native
  open class TieredMenu protected () extends Component[TieredMenuProps, Any, Any] {
    def this(props: TieredMenuProps) = this()
    /**
      * @deprecated
      * @see https://legacy.reactjs.org/docs/legacy-context.html
      */
    def this(props: TieredMenuProps, context: Any) = this()
  ...
  trait TieredMenuProps extends StObject {
    ...
    /**
      * Icon of the submenu.
      */
    var submenuIcon: js.UndefOr[IconType[TieredMenuProps]] = js.undefined
  ...
  object TieredMenuProps {
    ...
    inline def apply(): TieredMenuProps = {
    ...
    implicit open class MutableBuilder[Self <: TieredMenuProps] (val x: Self) extends AnyVal {
      ...
      inline def setSubmenuIcon(value: IconType[TieredMenuProps]): Self = StObject.set(x, "submenuIcon", value.asInstanceOf[js.Any])
      
      inline def setSubmenuIconFunction1(value: /* options */ IconOptions[TieredMenuProps] => ReactNode): Self = StObject.set(x, "submenuIcon", js.Any.fromFunction1(value))
