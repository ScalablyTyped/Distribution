...
object tieredmenuTieredmenuMod {
  ...
  type TieredMenuAppendToType = js.UndefOr[self | HTMLElement | Null]
  ...
  trait TieredMenuProps extends StObject {
    ...
    var appendTo: js.UndefOr[TieredMenuAppendToType] = js.undefined
  ...
  object TieredMenuProps {
    ...
    implicit open class MutableBuilder[Self <: TieredMenuProps] (val x: Self) extends AnyVal {
      ...
      inline def setAppendTo(value: TieredMenuAppendToType): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
