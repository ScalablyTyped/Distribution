...
object colorpickerMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.primereact.colorpickerMod.ColorPickerRGBType
    - typings.primereact.colorpickerMod.ColorPickerHSBType
    - scala.Unit
  */
  ...
  object _ColorPickerValueType {
    ...
    inline def ColorPickerHSBType(b: Double, h: Double, s: Double): typings.primereact.colorpickerMod.ColorPickerHSBType = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], h = h.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.primereact.colorpickerMod.ColorPickerHSBType]
    }
    
    inline def ColorPickerRGBType(b: Double, g: Double, r: Double): typings.primereact.colorpickerMod.ColorPickerRGBType = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.primereact.colorpickerMod.ColorPickerRGBType]
    }
  }
}
