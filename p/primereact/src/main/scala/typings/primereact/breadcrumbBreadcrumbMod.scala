...
object breadcrumbBreadcrumbMod {
  ...
  @JSImport("primereact/breadcrumb/breadcrumb", "BreadCrumb")
  @js.native
  open class BreadCrumb protected () extends Component[BreadCrumbProps, Any, Any] {
  ...
  /* Inlined parent std.Omit<react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLElement>, std.HTMLElement>, 'ref'> */
  ...
  object BreadCrumbProps {
    ...
    implicit open class MutableBuilder[Self <: BreadCrumbProps] (val x: Self) extends AnyVal {
      ...
      ): Self = StObject.set(x, "home", value.asInstanceOf[js.Any])
