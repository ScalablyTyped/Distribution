...
object panelmenuPanelmenuMod {
  ...
  trait PanelMenuProps extends StObject {
    ...
    /**
      * Icon of the submenu.
      */
    var submenuIcon: js.UndefOr[IconType[PanelMenuProps]] = js.undefined
  ...
  object PanelMenuProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PanelMenuProps] (val x: Self) extends AnyVal {
      ...
      inline def setSubmenuIcon(value: IconType[PanelMenuProps]): Self = StObject.set(x, "submenuIcon", value.asInstanceOf[js.Any])
      
      inline def setSubmenuIconFunction1(value: /* options */ IconOptions[PanelMenuProps] => ReactNode): Self = StObject.set(x, "submenuIcon", js.Any.fromFunction1(value))
