...
object overlaypanelOverlaypanelMod {
  
  @JSImport("primereact/overlaypanel/overlaypanel", "OverlayPanel")
  @js.native
  open class OverlayPanel protected () extends Component[OverlayPanelProps, Any, Any] {
  ...
  object OverlayPanelProps {
    ...
    implicit open class MutableBuilder[Self <: OverlayPanelProps] (val x: Self) extends AnyVal {
      ...
      inline def setBreakpoints(value: OverlayPanelBreakpoints): Self = StObject.set(x, "breakpoints", value.asInstanceOf[js.Any])
