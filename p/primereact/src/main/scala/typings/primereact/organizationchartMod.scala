...
object organizationchartMod {
  ...
  @JSImport("primereact/organizationchart/organizationchart", "OrganizationChart")
  @js.native
  open class OrganizationChart protected () extends Component[OrganizationChartProps, Any, Any] {
  ...
  object OrganizationChartNodeData {
    ...
    extension [Self <: OrganizationChartNodeData](x: Self) {
      ...
      inline def setChildrenVarargs(value: OrganizationChartNodeData*): Self = StObject.set(x, "children", js.Array(value*))
  ...
  object OrganizationChartProps {
    ...
    extension [Self <: OrganizationChartProps](x: Self) {
      ...
      inline def setSelectionVarargs(value: OrganizationChartNodeData*): Self = StObject.set(x, "selection", js.Array(value*))
      ...
      inline def setValueVarargs(value: OrganizationChartNodeData*): Self = StObject.set(x, "value", js.Array(value*))
