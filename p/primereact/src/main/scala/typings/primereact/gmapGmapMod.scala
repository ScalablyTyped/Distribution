...
object gmapGmapMod {
  ...
  @JSImport("primereact/gmap/gmap", "GMap")
  @js.native
  open class GMap protected () extends Component[GMapProps, Any, Any] {
    def this(props: GMapProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: GMapProps, context: Any) = this()
  ...
  trait GMapEventParams extends StObject {
  ...
  object GMapEventParams {
    
    inline def apply(map: Any, originalEvent: SyntheticEvent[Element, Event], overlay: Any): GMapEventParams = {
  ...
  trait GMapProps extends StObject {
    ...
    var onMapClick: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.undefined
    
    var onMapDragEnd: js.UndefOr[js.Function0[Unit]] = js.undefined
    
    var onMapReady: js.UndefOr[js.Function1[/* map */ Any, Unit]] = js.undefined
    ...
    var onOverlayClick: js.UndefOr[js.Function1[/* e */ GMapEventParams, Unit]] = js.undefined
    
    var onOverlayDrag: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.undefined
    
    var onOverlayDragEnd: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.undefined
    
    var onOverlayDragStart: js.UndefOr[js.Function1[/* event */ SyntheticEvent[Element, Event], Unit]] = js.undefined
  ...
  object GMapProps {
    ...
    extension [Self <: GMapProps](x: Self) {
      ...
      inline def setOnMapClick(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onMapClick", js.Any.fromFunction1(value))
      ...
      inline def setOnMapReady(value: /* map */ Any => Unit): Self = StObject.set(x, "onMapReady", js.Any.fromFunction1(value))
      ...
      inline def setOnOverlayClick(value: /* e */ GMapEventParams => Unit): Self = StObject.set(x, "onOverlayClick", js.Any.fromFunction1(value))
      
      inline def setOnOverlayClickUndefined: Self = StObject.set(x, "onOverlayClick", js.undefined)
      
      inline def setOnOverlayDrag(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onOverlayDrag", js.Any.fromFunction1(value))
      
      inline def setOnOverlayDragEnd(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onOverlayDragEnd", js.Any.fromFunction1(value))
      
      inline def setOnOverlayDragEndUndefined: Self = StObject.set(x, "onOverlayDragEnd", js.undefined)
      
      inline def setOnOverlayDragStart(value: /* event */ SyntheticEvent[Element, Event] => Unit): Self = StObject.set(x, "onOverlayDragStart", js.Any.fromFunction1(value))
