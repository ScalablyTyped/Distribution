...
object tagTagMod {
  ...
  @JSImport("primereact/tag/tag", "Tag")
  @js.native
  open class Tag protected () extends Component[TagProps, Any, Any] {
  ...
  object TagProps {
    ...
    extension [Self <: TagProps](x: Self) {
      ...
      inline def setIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<TagProps> */ Any
