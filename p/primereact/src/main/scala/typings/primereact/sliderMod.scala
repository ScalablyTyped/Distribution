...
object sliderMod {
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ OriginalEventEventValue => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnSlideEnd(value: /* e */ OriginalEventEventValue => Unit): Self = StObject.set(x, "onSlideEnd", js.Any.fromFunction1(value))
