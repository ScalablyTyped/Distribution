...
object avatargroupAvatargroupMod {
  ...
  trait AvatarGroupPassThroughMethodOptions extends StObject
  
  trait AvatarGroupPassThroughOptions extends StObject {
    
    /**
      * Uses to pass attributes to the root's DOM element.
      */
    var root: js.UndefOr[AvatarGroupPassThroughType[HTMLAttributes[HTMLDivElement]]] = js.undefined
  }
  object AvatarGroupPassThroughOptions {
    
    inline def apply(): AvatarGroupPassThroughOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AvatarGroupPassThroughOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AvatarGroupPassThroughOptions] (val x: Self) extends AnyVal {
      
      inline def setRoot(value: AvatarGroupPassThroughType[HTMLAttributes[HTMLDivElement]]): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
      
      inline def setRootFunction1(
        value: /* options */ js.UndefOr[AvatarGroupPassThroughMethodOptions] => HTMLAttributes[HTMLDivElement] | Unit
  ...
  type AvatarGroupPassThroughType[T] = PassThroughType[T, AvatarGroupPassThroughMethodOptions]
  ...
  trait AvatarGroupProps extends StObject {
    ...
    /**
      ...
      */
    var pt: js.UndefOr[AvatarGroupPassThroughOptions] = js.undefined
  ...
  object AvatarGroupProps {
    ...
    implicit open class MutableBuilder[Self <: AvatarGroupProps] (val x: Self) extends AnyVal {
      ...
      inline def setPt(value: AvatarGroupPassThroughOptions): Self = StObject.set(x, "pt", value.asInstanceOf[js.Any])
