...
object terminalTerminalMod {
  ...
  @JSImport("primereact/terminal/terminal", "Terminal")
  @js.native
  open class Terminal protected () extends Component[TerminalProps, Any, Any] {
    def this(props: TerminalProps) = this()
    /**
      * @deprecated
      * @see https://legacy.reactjs.org/docs/legacy-context.html
      */
    def this(props: TerminalProps, context: Any) = this()
  ...
  trait TerminalProps extends StObject {
    ...
    /**
      ...
      */
    var welcomeMessage: js.UndefOr[String] = js.undefined
  }
  object TerminalProps {
    
    inline def apply(): TerminalProps = {
