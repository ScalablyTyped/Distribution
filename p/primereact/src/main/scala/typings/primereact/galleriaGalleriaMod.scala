...
object galleriaGalleriaMod {
  
  @JSImport("primereact/galleria/galleria", "Galleria")
  @js.native
  open class Galleria protected () extends Component[GalleriaProps, Any, Any] {
  ...
  */
  ...
  object GalleriaProps {
    ...
    extension [Self <: GalleriaProps](x: Self) {
      ...
      inline def setResponsiveOptions(value: js.Array[GalleriaResponsiveOptions]): Self = StObject.set(x, "responsiveOptions", value.asInstanceOf[js.Any])
      
      inline def setResponsiveOptionsUndefined: Self = StObject.set(x, "responsiveOptions", js.undefined)
      
      inline def setResponsiveOptionsVarargs(value: GalleriaResponsiveOptions*): Self = StObject.set(x, "responsiveOptions", js.Array(value*))
  ...
  object GalleriaResponsiveOptions {
    ...
    inline def apply(breakpoint: String, numVisible: Double): GalleriaResponsiveOptions = {
      val __obj = js.Dynamic.literal(breakpoint = breakpoint.asInstanceOf[js.Any], numVisible = numVisible.asInstanceOf[js.Any])
