...
object inputtextInputtextMod {
  ...
  object InputTextProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InputTextProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnInput(value: (/* event */ FormEvent[HTMLInputElement], /* validatePattern */ Boolean) => Unit): Self = StObject.set(x, "onInput", js.Any.fromFunction2(value))
