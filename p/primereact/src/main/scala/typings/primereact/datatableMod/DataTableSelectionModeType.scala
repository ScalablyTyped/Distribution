...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.primereact.primereactStrings.radiobutton
*/
trait DataTableSelectionModeType extends StObject
object DataTableSelectionModeType {
  ...
  inline def radiobutton: typings.primereact.primereactStrings.radiobutton = "radiobutton".asInstanceOf[typings.primereact.primereactStrings.radiobutton]
