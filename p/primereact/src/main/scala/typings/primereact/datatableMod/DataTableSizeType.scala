...
/* Rewritten from type alias, can be one of: 
  - typings.primereact.primereactStrings.small
  - typings.primereact.primereactStrings.normal
  - typings.primereact.primereactStrings.large
*/
trait DataTableSizeType extends StObject
object DataTableSizeType {
  ...
  inline def small: typings.primereact.primereactStrings.small = "small".asInstanceOf[typings.primereact.primereactStrings.small]
}
