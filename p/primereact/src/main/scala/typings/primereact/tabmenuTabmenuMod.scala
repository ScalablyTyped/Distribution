...
object tabmenuTabmenuMod {
  
  @JSImport("primereact/tabmenu/tabmenu", "TabMenu")
  @js.native
  open class TabMenu protected () extends Component[TabMenuProps, Any, Any] {
