...
object accordionAccordionMod {
  ...
  @JSImport("primereact/accordion/accordion", "Accordion")
  @js.native
  open class Accordion protected () extends Component[AccordionProps, Any, Any] {
  ...
  @JSImport("primereact/accordion/accordion", "AccordionTab")
  @js.native
  open class AccordionTab protected () extends Component[AccordionTabProps, Any, Any] {
  ...
  object AccordionProps {
    ...
    extension [Self <: AccordionProps](x: Self) {
      ...
      inline def setCollapseIcon(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify IconType<AccordionProps> */ Any
