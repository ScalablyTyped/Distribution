...
trait SidebarProps extends js.Object {
  ...
  var iconsTemplate: js.UndefOr[js.Function0[js.UndefOr[Element]]] = js.native
...
object SidebarProps {
  ...
  implicit class SidebarPropsOps[Self <: SidebarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIconsTemplate(value: () => js.UndefOr[Element]): Self = this.set("iconsTemplate", js.Any.fromFunction0(value))
    @scala.inline
