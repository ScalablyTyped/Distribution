...
object carouselMod {
  ...
  @JSImport("primereact/carousel/carousel", "Carousel")
  @js.native
  open class Carousel protected () extends Component[CarouselProps, Any, Any] {
  ...
  */
  ...
  object CarouselProps {
    ...
    extension [Self <: CarouselProps](x: Self) {
      ...
      inline def setShowNavigators(value: Boolean): Self = StObject.set(x, "showNavigators", value.asInstanceOf[js.Any])
      
      inline def setShowNavigatorsUndefined: Self = StObject.set(x, "showNavigators", js.undefined)
