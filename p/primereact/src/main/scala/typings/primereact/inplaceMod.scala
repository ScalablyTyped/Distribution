...
object inplaceMod {
  ...
  object InplaceProps {
    ...
    extension [Self <: InplaceProps](x: Self) {
      ...
      inline def setOnClose(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      ...
      inline def setOnOpen(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onOpen", js.Any.fromFunction1(value))
