...
package object pDashSomeMod {
  ...
  import typings.aggregateDashError.aggregateDashErrorMod.^
  import typings.pDashSome.AggregateError_
  import typings.std.Error

  type AggregateError = AggregateError_
  type AggregateErrorConstructor = Instantiable1[/* errors */ js.Array[Error | StringDictionary[js.Any] | String], ^]
