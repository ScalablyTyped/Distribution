package typings.prometheusDashGcDashStats.prometheusDashGcDashStatsMod

import typings.prometheusDashGcDashStats.prometheusDashGcDashStatsMod.prometheusGcStatsNs.Config
