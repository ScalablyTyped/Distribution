...
object ^ extends js.Object {
  /**
  	...
  	```
  	*/
  def apply(): js.Promise[java.lang.String | scala.Null] = js.native
  def apply(options: Options): js.Promise[java.lang.String | scala.Null] = js.native
  /**
  	Synchronously find the closest `package.json` file.
  	@returns The filepath, or `null` if it couldn't be found.
  	*/
  def sync(): java.lang.String | scala.Null = js.native
  def sync(options: Options): java.lang.String | scala.Null = js.native
}
