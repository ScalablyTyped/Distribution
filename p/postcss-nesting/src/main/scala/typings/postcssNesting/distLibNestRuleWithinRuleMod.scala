...
object distLibNestRuleWithinRuleMod {
  ...
  inline def default(node: AtRule_, parent: Rule_, result: Result, walk: walkFunc, opts: options): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any], result.asInstanceOf[js.Any], walk.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
