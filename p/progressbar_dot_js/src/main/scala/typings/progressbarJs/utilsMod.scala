...
object utilsMod {
  ...
  inline def forEachObject(obj: Any, cb: js.Function2[/* val */ Any, /* key */ String, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("forEachObject")(obj.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def render(template: String, vars: StringDictionary[Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("render")(template.asInstanceOf[js.Any], vars.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def setStyle(element: Element, style: String, value: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setStyle")(element.asInstanceOf[js.Any], style.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def setStyles(element: Element, styles: StringDictionary[Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setStyles")(element.asInstanceOf[js.Any], styles.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
