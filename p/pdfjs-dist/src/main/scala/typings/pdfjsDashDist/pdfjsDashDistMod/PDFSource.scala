...
import typings.pdfjsDashDist.pdfjsDashDistStrings.decode
import typings.pdfjsDashDist.pdfjsDashDistStrings.display
import typings.pdfjsDashDist.pdfjsDashDistStrings.none
...
object PDFSource {
  ...
  def apply(
    ...
    if (CMapReaderFactory != null) __obj.updateDynamic("CMapReaderFactory")(CMapReaderFactory)
    if (!js.isUndefined(cMapPacked)) __obj.updateDynamic("cMapPacked")(cMapPacked)
    if (cMapUrl != null) __obj.updateDynamic("cMapUrl")(cMapUrl)
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (!js.isUndefined(disableAutoFetch)) __obj.updateDynamic("disableAutoFetch")(disableAutoFetch)
    if (!js.isUndefined(disableCreateObjectURL)) __obj.updateDynamic("disableCreateObjectURL")(disableCreateObjectURL)
    if (!js.isUndefined(disableFontFace)) __obj.updateDynamic("disableFontFace")(disableFontFace)
    if (!js.isUndefined(disableRange)) __obj.updateDynamic("disableRange")(disableRange)
    if (!js.isUndefined(disableStream)) __obj.updateDynamic("disableStream")(disableStream)
    if (docBaseUrl != null) __obj.updateDynamic("docBaseUrl")(docBaseUrl)
    ...
    if (!js.isUndefined(isEvalSupported)) __obj.updateDynamic("isEvalSupported")(isEvalSupported)
    ...
    if (!js.isUndefined(pdfBug)) __obj.updateDynamic("pdfBug")(pdfBug)
    if (range != null) __obj.updateDynamic("range")(range)
    if (rangeChunkSize != null) __obj.updateDynamic("rangeChunkSize")(rangeChunkSize.asInstanceOf[js.Any])
    if (!js.isUndefined(stopAtErrors)) __obj.updateDynamic("stopAtErrors")(stopAtErrors)
