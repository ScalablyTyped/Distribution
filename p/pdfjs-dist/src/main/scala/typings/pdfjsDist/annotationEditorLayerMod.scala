...
object annotationEditorLayerMod {
  ...
  open class AnnotationEditorLayer protected () extends StObject {
    ...
    var annotationStorage: typings.pdfjsDist.annotationStorageMod.AnnotationStorage = js.native
  ...
  type AnnotationEditor = typings.pdfjsDist.editorMod.AnnotationEditor
  ...
  type AnnotationStorage = typings.pdfjsDist.annotationStorageMod.AnnotationStorage
