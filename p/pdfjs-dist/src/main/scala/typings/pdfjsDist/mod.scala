...
object mod {
  ...
  @JSImport("pdfjs-dist", "AbortException")
  @js.native
  open class AbortException protected ()
    extends typings.pdfjsDist.typesSrcSharedUtilMod.AbortException {
  ...
  open class FeatureTest ()
    extends typings.pdfjsDist.typesSrcSharedUtilMod.FeatureTest
  ...
  object PDFWorker {
    ...
    @JSImport("pdfjs-dist", "PDFWorker.__#21@#workerPorts")
    @js.native
  ...
  @JSImport("pdfjs-dist", "PromiseCapability")
  @js.native
  open class PromiseCapability ()
    extends typings.pdfjsDist.typesSrcSharedUtilMod.PromiseCapability
  ...
  inline def getDocument(src: String): typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  inline def getDocument(src: js.typedarray.ArrayBuffer): typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  inline def getDocument(src: DocumentInitParameters): typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  inline def getDocument(src: TypedArray): typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  inline def getDocument(src: URL): typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask = ^.asInstanceOf[js.Dynamic].applyDynamic("getDocument")(src.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayApiMod.PDFDocumentLoadingTask]
  ...
  inline def renderTextLayer(params: TextLayerRenderParameters): typings.pdfjsDist.typesSrcDisplayTextLayerMod.TextLayerRenderTask = ^.asInstanceOf[js.Dynamic].applyDynamic("renderTextLayer")(params.asInstanceOf[js.Any]).asInstanceOf[typings.pdfjsDist.typesSrcDisplayTextLayerMod.TextLayerRenderTask]
  
  inline def setLayerDimensions(div: HTMLDivElement, viewport: typings.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PageViewport): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setLayerDimensions")(div.asInstanceOf[js.Any], viewport.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def setLayerDimensions(
    div: HTMLDivElement,
    viewport: typings.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PageViewport,
    mustFlip: Boolean
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setLayerDimensions")(div.asInstanceOf[js.Any], viewport.asInstanceOf[js.Any], mustFlip.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def setLayerDimensions(
    div: HTMLDivElement,
    viewport: typings.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PageViewport,
    mustFlip: Boolean,
    mustRotate: Boolean
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setLayerDimensions")(div.asInstanceOf[js.Any], viewport.asInstanceOf[js.Any], mustFlip.asInstanceOf[js.Any], mustRotate.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def setLayerDimensions(
    div: HTMLDivElement,
    viewport: typings.pdfjsDist.typesSrcDisplayDisplayUtilsMod.PageViewport,
    mustFlip: Unit,
  ...
  type OnProgressParameters = typings.pdfjsDist.typesSrcDisplayApiMod.OnProgressParameters
