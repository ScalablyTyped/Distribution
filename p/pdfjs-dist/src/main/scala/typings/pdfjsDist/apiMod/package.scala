...
import typings.pdfjsDist.displayUtilsMod.DOMStandardFontDataFactory
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typings.std.URL
  - typings.pdfjsDist.apiMod.TypedArray
  - js.typedarray.ArrayBuffer
  - typings.pdfjsDist.apiMod.PDFDataRangeTransport
  - typings.pdfjsDist.apiMod.DocumentInitParameters
*/
