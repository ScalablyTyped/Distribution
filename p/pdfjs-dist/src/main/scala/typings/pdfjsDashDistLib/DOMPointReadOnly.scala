...
object DOMPointReadOnly
  ...
  def fromPoint(): pdfjsDashDistLib.DOMPointReadOnly = js.native
  def fromPoint(other: pdfjsDashDistLib.DOMPointInit): pdfjsDashDistLib.DOMPointReadOnly = js.native
}
