...
trait MSInputMethodContext extends EventTarget {
  ...
  def addEventListener_MSCandidateWindowHide(
    `type`: pdfjsDashDistLib.pdfjsDashDistLibStrings.MSCandidateWindowHide,
  ...
  def addEventListener_MSCandidateWindowShow(
    `type`: pdfjsDashDistLib.pdfjsDashDistLibStrings.MSCandidateWindowShow,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_MSCandidateWindowShow(
  ...
  def addEventListener_MSCandidateWindowUpdate(
    `type`: pdfjsDashDistLib.pdfjsDashDistLibStrings.MSCandidateWindowUpdate,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_MSCandidateWindowUpdate(
