...
trait HTMLTextAreaElement extends HTMLElement {
  ...
  def setSelectionRange_backward(
    ...
    direction: pdfjsDashDistLib.pdfjsDashDistLibStrings.backward
  ): scala.Unit = js.native
  @JSName("setSelectionRange")
  def setSelectionRange_forward(
    start: scala.Double,
    end: scala.Double,
    direction: pdfjsDashDistLib.pdfjsDashDistLibStrings.forward
  ): scala.Unit = js.native
  @JSName("setSelectionRange")
  def setSelectionRange_none(start: scala.Double, end: scala.Double, direction: pdfjsDashDistLib.pdfjsDashDistLibStrings.none): scala.Unit = js.native
}
