...
object DOMQuad
  ...
  def fromQuad(): pdfjsDashDistLib.DOMQuad = js.native
  def fromQuad(other: pdfjsDashDistLib.DOMQuadInit): pdfjsDashDistLib.DOMQuad = js.native
  def fromRect(): pdfjsDashDistLib.DOMQuad = js.native
  def fromRect(other: pdfjsDashDistLib.DOMRectInit): pdfjsDashDistLib.DOMQuad = js.native
}
