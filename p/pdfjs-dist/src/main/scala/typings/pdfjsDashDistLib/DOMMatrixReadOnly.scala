...
trait DOMMatrixReadOnly extends js.Object {
  ...
  def toFloat32Array(): stdLib.Float32Array = js.native
  def toFloat64Array(): stdLib.Float64Array = js.native
...
object DOMMatrixReadOnly
  ...
  def fromFloat32Array(array32: stdLib.Float32Array): pdfjsDashDistLib.DOMMatrixReadOnly = js.native
  def fromFloat64Array(array64: stdLib.Float64Array): pdfjsDashDistLib.DOMMatrixReadOnly = js.native
  def fromMatrix(): pdfjsDashDistLib.DOMMatrixReadOnly = js.native
  def fromMatrix(other: pdfjsDashDistLib.DOMMatrixInit): pdfjsDashDistLib.DOMMatrixReadOnly = js.native
}
