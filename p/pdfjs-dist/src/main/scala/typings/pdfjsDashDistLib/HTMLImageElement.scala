...
trait HTMLImageElement
  ...
  var decoding: pdfjsDashDistLib.pdfjsDashDistLibStrings.async | pdfjsDashDistLib.pdfjsDashDistLibStrings.sync | pdfjsDashDistLib.pdfjsDashDistLibStrings.auto = js.native
  /**
