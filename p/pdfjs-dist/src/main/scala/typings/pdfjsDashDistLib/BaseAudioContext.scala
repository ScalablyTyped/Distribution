...
trait BaseAudioContext extends EventTarget {
  ...
  def addEventListener_statechange(
    `type`: pdfjsDashDistLib.pdfjsDashDistLibStrings.statechange,
  ...
  def createIIRFilter(feedforward: js.Array[scala.Double], feedback: js.Array[scala.Double]): IIRFilterNode = js.native
  def createOscillator(): OscillatorNode = js.native
  def createPanner(): PannerNode = js.native
  def createPeriodicWave(real: js.Array[scala.Double], imag: js.Array[scala.Double]): PeriodicWave = js.native
  def createPeriodicWave(real: js.Array[scala.Double], imag: js.Array[scala.Double], constraints: PeriodicWaveConstraints): PeriodicWave = js.native
  def createPeriodicWave(real: js.Array[scala.Double], imag: stdLib.Float32Array): PeriodicWave = js.native
  def createPeriodicWave(real: js.Array[scala.Double], imag: stdLib.Float32Array, constraints: PeriodicWaveConstraints): PeriodicWave = js.native
  def createPeriodicWave(real: stdLib.Float32Array, imag: js.Array[scala.Double]): PeriodicWave = js.native
  def createPeriodicWave(real: stdLib.Float32Array, imag: js.Array[scala.Double], constraints: PeriodicWaveConstraints): PeriodicWave = js.native
  def createPeriodicWave(real: stdLib.Float32Array, imag: stdLib.Float32Array): PeriodicWave = js.native
  def createPeriodicWave(real: stdLib.Float32Array, imag: stdLib.Float32Array, constraints: PeriodicWaveConstraints): PeriodicWave = js.native
  ...
  def decodeAudioData(audioData: stdLib.ArrayBuffer): js.Promise[AudioBuffer] = js.native
  def decodeAudioData(audioData: stdLib.ArrayBuffer, successCallback: DecodeSuccessCallback): js.Promise[AudioBuffer] = js.native
  def decodeAudioData(
  ...
  def decodeAudioData(audioData: stdLib.ArrayBuffer, successCallback: scala.Null, errorCallback: DecodeErrorCallback): js.Promise[AudioBuffer] = js.native
