...
import typings.typeFest.packageJsonMod.PackageJson.Exports
import typings.typeFest.packageJsonMod.PackageJson.Imports
import typings.typeFest.packageJsonMod.PackageJson.Person
import typings.typeFest.packageJsonMod.PackageJson.PublishConfig
...
object typesMod {
  ...
  trait PackageJson extends StObject {
    ...
    {[ EngineName in 'npm' | 'node' | string ]:? string}
      */ typings.prettierPackageJson.prettierPackageJsonStrings.PackageJson & TopLevel[Any]
      ] = js.native
