...
object PifyOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(errorFirst)) __obj.updateDynamic("errorFirst")(errorFirst.get.asInstanceOf[js.Any])
    if (exclude != null) __obj.updateDynamic("exclude")(exclude.asInstanceOf[js.Any])
    if (!js.isUndefined(excludeMain)) __obj.updateDynamic("excludeMain")(excludeMain.get.asInstanceOf[js.Any])
