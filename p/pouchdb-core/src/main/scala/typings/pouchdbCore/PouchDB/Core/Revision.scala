...
object Revision {
  @scala.inline
  def apply[/* <: js.Object */ Content](ok: Document[Content] with RevisionIdMeta): Revision[Content] = {
    val __obj = js.Dynamic.literal(ok = ok.asInstanceOf[js.Any])
    __obj.asInstanceOf[Revision[Content]]
  }
  @scala.inline
  implicit class RevisionOps[Self <: Revision[_], /* <: js.Object */ Content] (val x: Self with Revision[Content]) extends AnyVal {
    @scala.inline
