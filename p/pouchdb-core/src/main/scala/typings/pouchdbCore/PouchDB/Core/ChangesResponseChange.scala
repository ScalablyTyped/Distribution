...
object ChangesResponseChange {
  @scala.inline
  def apply[/* <: js.Object */ Content](changes: js.Array[RevString], id: String, seq: Double | String): ChangesResponseChange[Content] = {
  ...
  @scala.inline
  implicit class ChangesResponseChangeOps[Self <: ChangesResponseChange[_], /* <: js.Object */ Content] (val x: Self with ChangesResponseChange[Content]) extends AnyVal {
    @scala.inline
