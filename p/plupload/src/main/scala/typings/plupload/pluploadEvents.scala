...
object pluploadEvents {
  ...
  extension [Self <: pluploadEvents](x: Self) {
    ...
    inline def setBeforeUpload(value: (/* uploader */ Uploader, /* file */ js.Any) => js.Any): Self = StObject.set(x, "BeforeUpload", js.Any.fromFunction2(value))
    
    inline def setBeforeUploadUndefined: Self = StObject.set(x, "BeforeUpload", js.undefined)
    
    inline def setChunkUploaded(
    ...
    inline def setDestroy(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "Destroy", js.Any.fromFunction1(value))
    
    inline def setDestroyUndefined: Self = StObject.set(x, "Destroy", js.undefined)
    
    inline def setError(value: (/* uploader */ Uploader, /* error */ pluploadError) => js.Any): Self = StObject.set(x, "Error", js.Any.fromFunction2(value))
    
    inline def setErrorUndefined: Self = StObject.set(x, "Error", js.undefined)
    
    inline def setFileFiltered(value: (/* uploader */ Uploader, /* file */ js.Any) => js.Any): Self = StObject.set(x, "FileFiltered", js.Any.fromFunction2(value))
    
    inline def setFileFilteredUndefined: Self = StObject.set(x, "FileFiltered", js.undefined)
    
    inline def setFileUploaded(value: (/* uploader */ Uploader, /* file */ js.Any, /* response */ pluploadResponse) => js.Any): Self = StObject.set(x, "FileUploaded", js.Any.fromFunction3(value))
    
    inline def setFileUploadedUndefined: Self = StObject.set(x, "FileUploaded", js.undefined)
    
    inline def setFilesAdded(value: (/* uploader */ Uploader, /* files */ js.Array[js.Any]) => js.Any): Self = StObject.set(x, "FilesAdded", js.Any.fromFunction2(value))
    
    inline def setFilesAddedUndefined: Self = StObject.set(x, "FilesAdded", js.undefined)
    
    inline def setFilesRemoved(value: (/* uploader */ Uploader, /* files */ js.Array[js.Any]) => js.Any): Self = StObject.set(x, "FilesRemoved", js.Any.fromFunction2(value))
    
    inline def setFilesRemovedUndefined: Self = StObject.set(x, "FilesRemoved", js.undefined)
    
    inline def setInit(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "Init", js.Any.fromFunction1(value))
    
    inline def setInitUndefined: Self = StObject.set(x, "Init", js.undefined)
    
    inline def setOptionChanged(
    ...
    inline def setPostInit(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "PostInit", js.Any.fromFunction1(value))
    
    inline def setPostInitUndefined: Self = StObject.set(x, "PostInit", js.undefined)
    
    inline def setQueueChanged(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "QueueChanged", js.Any.fromFunction1(value))
    
    inline def setQueueChangedUndefined: Self = StObject.set(x, "QueueChanged", js.undefined)
    
    inline def setRefresh(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "Refresh", js.Any.fromFunction1(value))
    
    inline def setRefreshUndefined: Self = StObject.set(x, "Refresh", js.undefined)
    
    inline def setStateChanged(value: /* uploader */ Uploader => js.Any): Self = StObject.set(x, "StateChanged", js.Any.fromFunction1(value))
    
    inline def setStateChangedUndefined: Self = StObject.set(x, "StateChanged", js.undefined)
    
    inline def setUploadComplete(value: (/* uploader */ Uploader, /* files */ js.Array[js.Any]) => js.Any): Self = StObject.set(x, "UploadComplete", js.Any.fromFunction2(value))
    
    inline def setUploadCompleteUndefined: Self = StObject.set(x, "UploadComplete", js.undefined)
    
    inline def setUploadFile(value: (/* uploader */ Uploader, /* file */ js.Any) => js.Any): Self = StObject.set(x, "UploadFile", js.Any.fromFunction2(value))
    
    inline def setUploadFileUndefined: Self = StObject.set(x, "UploadFile", js.undefined)
    
    inline def setUploadProgress(value: (/* uploader */ Uploader, /* file */ js.Any) => js.Any): Self = StObject.set(x, "UploadProgress", js.Any.fromFunction2(value))
