...
object PhononNavigatorOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(animatePages)) __obj.updateDynamic("animatePages")(animatePages.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableBrowserBackButton)) __obj.updateDynamic("enableBrowserBackButton")(enableBrowserBackButton.get.asInstanceOf[js.Any])
