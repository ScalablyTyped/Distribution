...
object mod {
  ...
  inline def default[ValueType](count: Double, mapper: js.Function1[/* index */ Double, ValueType | js.Thenable[ValueType]]): js.Promise[js.Array[ValueType]] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(count.asInstanceOf[js.Any], mapper.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[ValueType]]]
