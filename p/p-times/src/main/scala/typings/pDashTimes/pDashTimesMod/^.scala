package typings.pDashTimes.pDashTimesMod

import typings.pDashTimes.Anon_Count
...
object ^ extends js.Object {
  ...
  // ): Promise<ValueType[]>;
  // export = pTimes;
  def default[ValueType](count: Double, mapper: js.Function1[/* index */ Double, ValueType | js.Thenable[ValueType]]): js.Promise[js.Array[ValueType]] = js.native
