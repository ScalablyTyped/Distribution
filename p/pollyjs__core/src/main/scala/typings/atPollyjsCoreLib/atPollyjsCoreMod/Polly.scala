...
class Polly protected () extends js.Object {
  ...
  def connectTo(name: atPollyjsCoreLib.TypeofClassAdapter): scala.Unit = js.native
  def connectTo(name: java.lang.String): scala.Unit = js.native
  def disconnect(): scala.Unit = js.native
  def disconnectFrom(name: atPollyjsCoreLib.TypeofClassAdapter): scala.Unit = js.native
...
object Polly extends js.Object {
  ...
  def register(Factory: atPollyjsCoreLib.TypeofClassAdapter): scala.Unit = js.native
  def register(Factory: atPollyjsCoreLib.TypeofClassPersister): scala.Unit = js.native
}
