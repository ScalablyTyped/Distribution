...
/* Rewritten from type alias, can be one of: 
  - plaidDashLinkLib.plaidDashLinkLibStrings.ERROR
  - plaidDashLinkLib.plaidDashLinkLibStrings.EXIT
  - plaidDashLinkLib.plaidDashLinkLibStrings.HANDOFF
  - plaidDashLinkLib.plaidDashLinkLibStrings.OPEN
