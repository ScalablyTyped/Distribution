...
object PayoutItem {
  ...
  inline def apply(amount: typings.paypalPayoutsSdk.anon.Currency, receiver: String): PayoutItem = {
  ...
  extension [Self <: PayoutItem](x: Self) {
    ...
    inline def setAmount(value: typings.paypalPayoutsSdk.anon.Currency): Self = StObject.set(x, "amount", value.asInstanceOf[js.Any])
