...
@js.native
object hNs extends js.Object {
  /**
    * A bound factory function for a specific `h()` tag.
    */
  @js.native
  trait IFactory extends js.Object {
    def apply(attrs: atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.ElementAttrs, children: Child*): atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.VirtualElement = js.native
    def apply(children: Child*): atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.VirtualElement = js.native
  }
  ...
  /**
    ...
    */
  type Child = java.lang.String | atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.VirtualNode | scala.Null | (js.Array[
    java.lang.String | atPhosphorVirtualdomLib.atPhosphorVirtualdomMod.VirtualNode | scala.Null
  ])
}
