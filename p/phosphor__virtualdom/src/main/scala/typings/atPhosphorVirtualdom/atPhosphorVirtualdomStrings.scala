...
import typings.atPhosphorVirtualdom.atPhosphorVirtualdomMod.CSSPropertyNames
import typings.atPhosphorVirtualdom.atPhosphorVirtualdomMod.ElementAttrNames
