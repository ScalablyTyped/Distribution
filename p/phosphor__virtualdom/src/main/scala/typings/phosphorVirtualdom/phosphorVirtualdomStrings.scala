...
import typings.phosphorVirtualdom.mod.CSSPropertyNames
import typings.phosphorVirtualdom.mod.ElementAttrNames
...
object phosphorVirtualdomStrings {
  @js.native
  sealed trait ElementBaseAttrs extends js.Object
  
  @js.native
  sealed trait ElementEventAttrs extends js.Object
  
  @js.native
  sealed trait ElementInlineStyle extends js.Object
  ...
  @scala.inline
  def ElementBaseAttrs: ElementBaseAttrs = "ElementBaseAttrs".asInstanceOf[ElementBaseAttrs]
  @scala.inline
  def ElementEventAttrs: ElementEventAttrs = "ElementEventAttrs".asInstanceOf[ElementEventAttrs]
  @scala.inline
  def ElementInlineStyle: ElementInlineStyle = "ElementInlineStyle".asInstanceOf[ElementInlineStyle]
  @scala.inline
