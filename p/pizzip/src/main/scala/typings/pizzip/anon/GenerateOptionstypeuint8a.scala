...
trait GenerateOptionstypeuint8a extends js.Object {
  ...
  /**
    ...
    * @default "base64"
    */
  var `type`: js.UndefOr[(base64 | string | uint8array | arraybuffer | blob | nodebuffer) with uint8array] = js.undefined
}
...
object GenerateOptionstypeuint8a {
  ...
  def apply(
    ...
    `type`: (base64 | string | uint8array | arraybuffer | blob | nodebuffer) with uint8array = null
