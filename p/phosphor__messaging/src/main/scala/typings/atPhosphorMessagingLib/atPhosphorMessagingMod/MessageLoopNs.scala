...
@js.native
object MessageLoopNs extends js.Object {
  /**
    ...
    */
  def clearData(handler: atPhosphorMessagingLib.atPhosphorMessagingMod.IMessageHandler): scala.Unit = js.native
  /**
  ...
  def installMessageHook(
    ...
    hook: atPhosphorMessagingLib.atPhosphorMessagingMod.MessageHook
