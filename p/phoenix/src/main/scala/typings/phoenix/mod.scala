...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.phoenix.phoenixStrings.errored
    - typings.phoenix.phoenixStrings.joined
    - typings.phoenix.phoenixStrings.joining
    - typings.phoenix.phoenixStrings.leaving
  */
  ...
  object ChannelState {
    ...
    inline def errored: typings.phoenix.phoenixStrings.errored = "errored".asInstanceOf[typings.phoenix.phoenixStrings.errored]
    
    inline def joined: typings.phoenix.phoenixStrings.joined = "joined".asInstanceOf[typings.phoenix.phoenixStrings.joined]
    
    inline def joining: typings.phoenix.phoenixStrings.joining = "joining".asInstanceOf[typings.phoenix.phoenixStrings.joining]
    
    inline def leaving: typings.phoenix.phoenixStrings.leaving = "leaving".asInstanceOf[typings.phoenix.phoenixStrings.leaving]
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.phoenix.phoenixStrings.ok
    - typings.phoenix.phoenixStrings.error
    - typings.phoenix.phoenixStrings.timeout
  */
  trait PushStatus extends StObject
  object PushStatus {
    
    inline def error: typings.phoenix.phoenixStrings.error = "error".asInstanceOf[typings.phoenix.phoenixStrings.error]
    
    inline def ok: typings.phoenix.phoenixStrings.ok = "ok".asInstanceOf[typings.phoenix.phoenixStrings.ok]
    
    inline def timeout: typings.phoenix.phoenixStrings.timeout = "timeout".asInstanceOf[typings.phoenix.phoenixStrings.timeout]
  }
  ...
  object SocketConnectOption {
    ...
    extension [Self <: SocketConnectOption](x: Self) {
      ...
      inline def setLogger(value: (String, String, Any) => Unit): Self = StObject.set(x, "logger", js.Any.fromFunction3(value))
