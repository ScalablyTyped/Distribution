...
object PartialSocketConnectOptio {
  ...
  def apply(
    ...
    longpollerTimeout: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(longpollerTimeout)) __obj.updateDynamic("longpollerTimeout")(longpollerTimeout.get.asInstanceOf[js.Any])
