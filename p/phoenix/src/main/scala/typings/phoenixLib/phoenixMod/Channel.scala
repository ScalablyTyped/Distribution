...
class Channel protected () extends js.Object {
  ...
  def this(topic: java.lang.String, params: js.Function0[js.Object]) = this()
  def this(topic: java.lang.String, params: js.Object) = this()
  def this(topic: java.lang.String, params: js.Function0[js.Object], socket: Socket) = this()
  ...
  def on(event: java.lang.String, callback: js.Function1[/* response */ js.UndefOr[js.Any], scala.Unit]): scala.Double = js.native
  def onClose(callback: js.Function3[/* payload */ js.Any, /* ref */ js.Any, /* joinRef */ js.Any, scala.Unit]): scala.Unit = js.native
