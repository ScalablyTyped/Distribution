...
class Socket protected () extends js.Object {
  ...
  def disconnect(callback: js.Function, code: scala.Double): scala.Unit = js.native
  def disconnect(callback: js.Function, code: scala.Double, reason: java.lang.String): scala.Unit = js.native
  def endPointURL(): java.lang.String = js.native
  def hasLogger(): scala.Boolean = js.native
  def isConnected(): scala.Boolean = js.native
  def log(kind: java.lang.String, message: java.lang.String, data: js.Object): scala.Unit = js.native
