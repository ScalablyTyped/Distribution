...
object distSrcModulesRootContainerRootContainerMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesRootContainerRootContainerDotviewMod.default = js.native
  }
  object default {
  ...
  trait RootContainer
    ...
    var view: typings.playable.distSrcModulesRootContainerRootContainerDotviewMod.default
  }
  object RootContainer {
    ...
    inline def apply(
      ...
      show: () => Unit,
      view: typings.playable.distSrcModulesRootContainerRootContainerDotviewMod.default
    ): RootContainer = {
    ...
    extension [Self <: RootContainer](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesRootContainerRootContainerDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
