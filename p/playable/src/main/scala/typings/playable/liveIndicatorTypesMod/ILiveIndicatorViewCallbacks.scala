...
@js.native
trait ILiveIndicatorViewCallbacks extends js.Object {
...
object ILiveIndicatorViewCallbacks {
  ...
  @scala.inline
  implicit class ILiveIndicatorViewCallbacksOps[Self <: ILiveIndicatorViewCallbacks] (val x: Self) extends AnyVal {
