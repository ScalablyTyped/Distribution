...
import typings.playable.distSrcModulesUiLoadingCoverTypesMod.ILoadingCover
...
object distSrcModulesUiLoadingCoverLoadingCoverMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    @js.native
    def View: Instantiable0[typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default] = js.native
    inline def View_=(x: Instantiable0[typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait LoadingCover
    ...
    var view: typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default
  }
  object LoadingCover {
    ...
    inline def apply(
      ...
      show: () => Unit,
      view: typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default
    ): LoadingCover = {
    ...
    extension [Self <: LoadingCover](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesUiLoadingCoverLoadingCoverDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
