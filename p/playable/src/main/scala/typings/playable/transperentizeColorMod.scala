...
object transperentizeColorMod {
  ...
  inline def default(color: String, alpha: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(color.asInstanceOf[js.Any], alpha.asInstanceOf[js.Any])).asInstanceOf[String]
}
