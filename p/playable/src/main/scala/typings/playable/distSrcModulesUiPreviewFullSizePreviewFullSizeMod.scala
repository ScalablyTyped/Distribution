...
object distSrcModulesUiPreviewFullSizePreviewFullSizeMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiPreviewFullSizePreviewFullSizeDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable0[
        typings.playable.distSrcModulesUiPreviewFullSizePreviewFullSizeDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable0[
          typings.playable.distSrcModulesUiPreviewFullSizePreviewFullSizeDotviewMod.default
  ...
  trait PreviewFullsize
    ...
    var view: typings.playable.distSrcModulesUiPreviewFullSizePreviewFullSizeDotviewMod.default
  }
  object PreviewFullsize {
    ...
    inline def apply(
      ...
      hide: () => Unit,
      showAt: Double => Unit,
      view: typings.playable.distSrcModulesUiPreviewFullSizePreviewFullSizeDotviewMod.default
    ): PreviewFullsize = {
