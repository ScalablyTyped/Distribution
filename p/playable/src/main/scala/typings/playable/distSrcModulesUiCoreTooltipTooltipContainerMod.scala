...
import typings.playable.distSrcModulesUiCoreTooltipTypesMod.ITooltipPositionFunction
...
object distSrcModulesUiCoreTooltipTooltipContainerMod {
  ...
  open class default protected () extends TooltipContainer {
    def this(tooltip: typings.playable.distSrcModulesUiCoreTooltipTooltipMod.default) = this()
  ...
  object ITooltipContainer {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ITooltipContainer] (val x: Self) extends AnyVal {
  ...
  trait TooltipContainer
    extends typings.playable.distSrcModulesUiCoreStylableMod.default[IStyles]
