...
object distSrcModulesUiLoaderLoaderMod {
  ...
  object default {
    ...
    @js.native
    def View: Instantiable0[typings.playable.distSrcModulesUiLoaderLoaderDotviewMod.default] = js.native
    inline def View_=(x: Instantiable0[typings.playable.distSrcModulesUiLoaderLoaderDotviewMod.default]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("View")(x.asInstanceOf[js.Any])
  ...
  trait Loader
    ...
    var view: typings.playable.distSrcModulesUiLoaderLoaderDotviewMod.default = js.native
  }
}
