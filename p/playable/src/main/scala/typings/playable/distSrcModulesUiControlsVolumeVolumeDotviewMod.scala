...
import typings.playable.distSrcModulesUiControlsVolumeTypesMod.IVolumeViewConfig
import typings.playable.distSrcModulesUiControlsVolumeTypesMod.IVolumeViewStyles
...
object distSrcModulesUiControlsVolumeVolumeDotviewMod {
  ...
  @js.native
  trait VolumeView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IVolumeViewStyles] {
