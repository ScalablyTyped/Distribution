...
object distSrcModulesUiControlsLogoLogoMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typings.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default {
    ...
    def View: Instantiable1[
        /* config */ ILogoViewConfig, 
        typings.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ ILogoViewConfig, 
  ...
  trait Logo
    ...
    var view: typings.playable.distSrcModulesUiControlsLogoLogoDotviewMod.default = js.native
  }
}
