...
object distSrcModulesUiControlsVolumeVolumeMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typings.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IVolumeViewConfig, 
  ...
  trait VolumeControl
    ...
    var view: typings.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default
  }
  object VolumeControl {
    ...
    inline def apply(
      ...
      isHidden: Boolean,
      show: () => Unit,
      view: typings.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default
    ): VolumeControl = {
    ...
    extension [Self <: VolumeControl](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesUiControlsVolumeVolumeDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
