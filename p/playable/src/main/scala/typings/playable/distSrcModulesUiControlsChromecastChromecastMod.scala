...
import typings.playable.distSrcModulesUiControlsChromecastTypesMod.IChromecastViewConfig
import typings.std.HTMLElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcModulesUiControlsChromecastChromecastMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        /* config */ IChromecastViewConfig, 
        typings.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IChromecastViewConfig, 
  ...
  trait ChromecastButton
    ...
    var view: typings.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default
  }
  object ChromecastButton {
    ...
    inline def apply(
      ...
      show: () => Unit,
      view: typings.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default
    ): ChromecastButton = {
    ...
    extension [Self <: ChromecastButton](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesUiControlsChromecastChromecastDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
