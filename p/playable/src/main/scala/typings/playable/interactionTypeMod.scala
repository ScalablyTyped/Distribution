...
object interactionTypeMod {
  ...
  object default {
    ...
    inline def engage(): Get = ^.asInstanceOf[js.Dynamic].applyDynamic("engage")().asInstanceOf[Get]
    ...
    inline def engage_Fdefault_=(x: js.Function0[Get]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("engage")(x.asInstanceOf[js.Any])
  }
}
