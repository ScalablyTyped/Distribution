...
object storiesTypesMod {
  ...
  object StoryProps {
    ...
    inline def apply(): StoryProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StoryProps]
    }
    
    extension [Self <: StoryProps](x: Self) {
      ...
      inline def setProgressBarMode(value: String): Self = StObject.set(x, "progressBarMode", value.asInstanceOf[js.Any])
      
      inline def setProgressBarModeUndefined: Self = StObject.set(x, "progressBarMode", js.undefined)
      ...
      inline def setVideoType(value: MediaStreamType): Self = StObject.set(x, "videoType", value.asInstanceOf[js.Any])
