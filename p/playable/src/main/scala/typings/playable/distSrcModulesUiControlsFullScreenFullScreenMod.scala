...
object distSrcModulesUiControlsFullScreenFullScreenMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typings.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IFullScreenViewConfig, 
  ...
  trait FullScreenControl
    ...
    var view: typings.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default
  }
  object FullScreenControl {
    ...
    inline def apply(
      ...
      isHidden: Boolean,
      show: () => Unit,
      view: typings.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default
    ): FullScreenControl = {
    ...
    extension [Self <: FullScreenControl](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesUiControlsFullScreenFullScreenDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
