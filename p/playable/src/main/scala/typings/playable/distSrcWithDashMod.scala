...
import typings.playable.distSrcCorePlayerFactoryMod.IPlayerInstance
...
object distSrcWithDashMod {
  ...
  object default {
    ...
    @js.native
    def Tooltip: Instantiable0[typings.playable.distSrcModulesUiCoreTooltipMod.Tooltip] = js.native
    
    /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
    @JSImport("playable/dist/src/with-dash", "default.Tooltip")
    @js.native
    open class TooltipCls ()
      extends typings.playable.distSrcModulesUiCoreTooltipMod.Tooltip
    
    inline def Tooltip_=(x: Instantiable0[typings.playable.distSrcModulesUiCoreTooltipMod.Tooltip]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Tooltip")(x.asInstanceOf[js.Any])
