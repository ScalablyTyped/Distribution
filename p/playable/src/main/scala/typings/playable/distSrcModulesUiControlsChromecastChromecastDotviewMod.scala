...
import typings.playable.distSrcModulesUiControlsChromecastTypesMod.IChromecastStyles
...
object distSrcModulesUiControlsChromecastChromecastDotviewMod {
  ...
  trait ChromecastView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IChromecastStyles] {
