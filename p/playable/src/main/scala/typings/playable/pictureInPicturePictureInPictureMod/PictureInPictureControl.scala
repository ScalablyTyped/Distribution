package typings.playable.pictureInPicturePictureInPictureMod
...
object PictureInPictureControl {
  ...
  @scala.inline
  implicit class PictureInPictureControlOps[Self <: PictureInPictureControl] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_pictureInPictureManager(value: js.Any): Self = this.set("_pictureInPictureManager", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def set_togglePictureInPicture(value: js.Any): Self = this.set("_togglePictureInPicture", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setView(value: typings.playable.pictureInPictureViewMod.default): Self = this.set("view", value.asInstanceOf[js.Any])
  }
}
