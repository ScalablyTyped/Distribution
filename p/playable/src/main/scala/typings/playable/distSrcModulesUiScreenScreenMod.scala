...
object distSrcModulesUiScreenScreenMod {
  ...
  object default {
    ...
    open class View protected ()
      extends typings.playable.distSrcModulesUiScreenScreenDotviewMod.default {
    ...
    def View: Instantiable1[
        /* config */ IScreenViewConfig, 
        typings.playable.distSrcModulesUiScreenScreenDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IScreenViewConfig, 
  ...
  trait Screen
    ...
    var view: typings.playable.distSrcModulesUiScreenScreenDotviewMod.default = js.native
  }
}
