...
object distSrcModulesUiDebugPanelDebugPanelMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var view: typings.playable.distSrcModulesUiDebugPanelDebugPanelDotviewMod.default = js.native
  }
  /* static members */
  object default {
    ...
    def View: Instantiable1[
        ...
        typings.playable.distSrcModulesUiDebugPanelDebugPanelDotviewMod.default
      ] = js.native
    inline def View_=(
      x: Instantiable1[
          /* config */ IDebugPanelViewConfig, 
  ...
  trait DebugPanel extends StObject {
    ...
    var view: typings.playable.distSrcModulesUiDebugPanelDebugPanelDotviewMod.default
  }
  object DebugPanel {
    ...
    inline def apply(
      ...
      show: () => Unit,
      updateInfo: () => Unit,
      view: typings.playable.distSrcModulesUiDebugPanelDebugPanelDotviewMod.default
    ): DebugPanel = {
    ...
    extension [Self <: DebugPanel](x: Self) {
      ...
      inline def setView(value: typings.playable.distSrcModulesUiDebugPanelDebugPanelDotviewMod.default): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
