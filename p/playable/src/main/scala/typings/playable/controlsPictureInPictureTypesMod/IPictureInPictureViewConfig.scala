...
@js.native
trait IPictureInPictureViewConfig extends js.Object {
...
object IPictureInPictureViewConfig {
  ...
  @scala.inline
  implicit class IPictureInPictureViewConfigOps[Self <: IPictureInPictureViewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallbacks(value: IPictureInPictureViewCallbacks): Self = this.set("callbacks", value.asInstanceOf[js.Any])
