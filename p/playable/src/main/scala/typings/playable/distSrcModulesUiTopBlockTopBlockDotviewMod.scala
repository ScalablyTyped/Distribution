...
import typings.playable.distSrcModulesUiTopBlockTypesMod.ITopBlockViewStyles
...
object distSrcModulesUiTopBlockTopBlockDotviewMod {
  ...
  @js.native
  trait TopBlockView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[ITopBlockViewStyles] {
