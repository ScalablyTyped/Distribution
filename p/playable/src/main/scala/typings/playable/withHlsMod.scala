...
object withHlsMod {
  ...
  object default {
    ...
    @JSImport("playable/dist/src/with-hls", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("playable/dist/src/with-hls", "default.CROSS_ORIGIN_VALUES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.ENGINE_STATES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.ERRORS")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.LIVE_STATES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.MEDIA_STREAM_DELIVERY_PRIORITY")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.MEDIA_STREAM_TYPES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.PRELOAD_TYPES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.TEXT_LABELS")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.Tooltip")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.UI_EVENTS")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.VIDEO_EVENTS")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.VIDEO_VIEW_MODES")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.clearAdditionalModules")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.clearPlaybackAdapters")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.create")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.playerAPIDecorator")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.registerModule")
    @js.native
    ...
    @JSImport("playable/dist/src/with-hls", "default.registerPlaybackAdapter")
    @js.native
  ...
  @JSImport("playable/dist/src/with-hls", "TEXT_LABELS")
  @js.native
  ...
  @JSImport("playable/dist/src/with-hls", "Tooltip")
  @js.native
  class Tooltip ()
  ...
  @JSImport("playable/dist/src/with-hls", "playerAPIDecorator")
  @js.native
  def playerAPIDecorator(): js.Function3[/* target */ js.Any, /* property */ String, /* descriptor */ PropertyDescriptor, Unit] = js.native
  @JSImport("playable/dist/src/with-hls", "playerAPIDecorator")
  @js.native
  ...
  @JSImport("playable/dist/src/with-hls", "registerModule")
  @js.native
  def registerModule(id: String, module: js.Any): Unit = js.native
  
  @JSImport("playable/dist/src/with-hls", "registerPlaybackAdapter")
  @js.native
  def registerPlaybackAdapter(adapter: js.Any): Unit = js.native
}
