...
import typings.playable.distSrcModulesUiLiveIndicatorTypesMod.ILiveIndicatorViewStyles
...
object distSrcModulesUiLiveIndicatorLiveIndicatorDotviewMod {
  ...
  trait LiveIndicatorView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[ILiveIndicatorViewStyles] {
