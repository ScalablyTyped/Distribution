...
import typings.playable.distSrcModulesUiBottomBlockTypesMod.IBottomBlockViewStyles
...
object distSrcModulesUiBottomBlockBottomBlockDotviewMod {
  ...
  trait BottomBlockView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IBottomBlockViewStyles] {
