...
import typings.playable.distSrcModulesUiControlsFullScreenTypesMod.IFullScreenViewConfig
import typings.playable.distSrcModulesUiControlsFullScreenTypesMod.IFullScreenViewStyles
...
object distSrcModulesUiControlsFullScreenFullScreenDotviewMod {
  ...
  trait FullScreenView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IFullScreenViewStyles] {
