...
import typings.playable.distSrcModulesUiInteractionIndicatorTypesMod.IInteractionIndicatorViewStyles
import typings.std.HTMLElement
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distSrcModulesUiInteractionIndicatorInteractionIndicatorDotviewMod {
  ...
  trait InteractionIndicatorView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IInteractionIndicatorViewStyles] {
