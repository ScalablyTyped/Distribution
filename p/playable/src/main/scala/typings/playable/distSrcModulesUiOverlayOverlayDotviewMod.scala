...
import typings.playable.distSrcModulesUiOverlayTypesMod.IOverlayViewStyles
...
object distSrcModulesUiOverlayOverlayDotviewMod {
  ...
  @js.native
  trait OverlayView
    extends typings.playable.distSrcModulesUiCoreViewMod.default[IOverlayViewStyles] {
