...
@js.native
trait IVolumeViewConfig extends js.Object {
...
object IVolumeViewConfig {
  ...
  @scala.inline
  implicit class IVolumeViewConfigOps[Self <: IVolumeViewConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCallbacks(value: IVolumeViewCallbacks): Self = this.set("callbacks", value.asInstanceOf[js.Any])
