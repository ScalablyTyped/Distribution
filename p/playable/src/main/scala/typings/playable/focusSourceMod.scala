...
object focusSourceMod {
  ...
  object default {
    ...
    @scala.inline
    def disengage(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("disengage")().asInstanceOf[Unit]
    ...
    @scala.inline
    def engage(): Current = ^.asInstanceOf[js.Dynamic].applyDynamic("engage")().asInstanceOf[Current]
