...
@js.native
trait AuthenticateOptionsBase extends js.Object {
...
object AuthenticateOptionsBase {
  ...
  @scala.inline
  implicit class AuthenticateOptionsBaseOps[Self <: AuthenticateOptionsBase] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPrivateKeyLocation(value: String): Self = this.set("privateKeyLocation", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePrivateKeyLocation: Self = this.set("privateKeyLocation", js.undefined)
    @scala.inline
    def setPrivateKeyString(value: String): Self = this.set("privateKeyString", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePrivateKeyString: Self = this.set("privateKeyString", js.undefined)
    @scala.inline
