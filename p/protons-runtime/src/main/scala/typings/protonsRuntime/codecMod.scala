...
object codecMod {
  ...
  object CODEC_TYPES extends StObject {
    ...
    sealed trait BIT32
      extends StObject
         with CODEC_TYPES
    /* 5 */ val BIT32: typings.protonsRuntime.codecMod.CODEC_TYPES.BIT32 & Double = js.native
    
    @js.native
    sealed trait BIT64
      extends StObject
         with CODEC_TYPES
    /* 1 */ val BIT64: typings.protonsRuntime.codecMod.CODEC_TYPES.BIT64 & Double = js.native
    
    @js.native
    sealed trait END_GROUP
      extends StObject
         with CODEC_TYPES
    /* 4 */ val END_GROUP: typings.protonsRuntime.codecMod.CODEC_TYPES.END_GROUP & Double = js.native
    
    @js.native
    sealed trait LENGTH_DELIMITED
      extends StObject
         with CODEC_TYPES
    /* 2 */ val LENGTH_DELIMITED: typings.protonsRuntime.codecMod.CODEC_TYPES.LENGTH_DELIMITED & Double = js.native
    
    @js.native
    sealed trait START_GROUP
      extends StObject
         with CODEC_TYPES
    /* 3 */ val START_GROUP: typings.protonsRuntime.codecMod.CODEC_TYPES.START_GROUP & Double = js.native
    
    @js.native
    sealed trait VARINT
      extends StObject
         with CODEC_TYPES
    /* 0 */ val VARINT: typings.protonsRuntime.codecMod.CODEC_TYPES.VARINT & Double = js.native
  }
