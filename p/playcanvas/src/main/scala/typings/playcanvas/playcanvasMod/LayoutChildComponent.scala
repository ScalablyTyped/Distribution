...
class LayoutChildComponent protected ()
  extends typings.playcanvas.pcNs.LayoutChildComponent {
  def this(system: typings.playcanvas.pcNs.LayoutChildComponentSystem, entity: typings.playcanvas.pcNs.Entity) = this()
}
