...
class CollisionComponent protected ()
  extends typings.playcanvas.pcNs.CollisionComponent {
  def this(system: typings.playcanvas.pcNs.CollisionComponentSystem, entity: typings.playcanvas.pcNs.Entity) = this()
}
