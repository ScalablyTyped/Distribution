...
class AnimationComponent protected ()
  extends typings.playcanvas.pcNs.AnimationComponent {
  def this(system: typings.playcanvas.pcNs.AnimationComponentSystem, entity: typings.playcanvas.pcNs.Entity) = this()
}
