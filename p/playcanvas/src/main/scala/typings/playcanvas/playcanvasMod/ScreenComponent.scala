...
class ScreenComponent protected ()
  extends typings.playcanvas.pcNs.ScreenComponent {
  def this(system: typings.playcanvas.pcNs.ScreenComponentSystem, entity: typings.playcanvas.pcNs.Entity) = this()
}
