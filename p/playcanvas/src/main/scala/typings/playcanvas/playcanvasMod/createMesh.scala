...
object createMesh extends js.Object {
  /**
    ...
    *     });
    */
  def apply(device: typings.playcanvas.pc.GraphicsDevice, positions: js.Array[Number]): typings.playcanvas.pc.Mesh = js.native
  def apply(device: typings.playcanvas.pc.GraphicsDevice, positions: js.Array[Number], opts: Anon_Colors): typings.playcanvas.pc.Mesh = js.native
}
