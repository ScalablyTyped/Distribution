...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  val http: typings.playcanvas.pcNs.Http = js.native
  /**
    * @static
    * @readonly
    * @type {Object}
  ...
  /**
    ...
    */
  def createBox(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createBox(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_HalfExtentsHeightSegments): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    ...
    */
  def createCapsule(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createCapsule(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_Height): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    * @name pc.createCone
    ...
    */
  def createCone(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createCone(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_BaseRadius): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    ...
    * @returns {pc.Mesh} A new cylinder-shaped mesh.
    */
  def createCylinder(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createCylinder(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_CapSegments): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    * @name pc.createMesh
    ...
    *     });
    */
  def createMesh(device: typings.playcanvas.pcNs.GraphicsDevice, positions: js.Array[Number]): typings.playcanvas.pcNs.Mesh = js.native
  def createMesh(device: typings.playcanvas.pcNs.GraphicsDevice, positions: js.Array[Number], opts: Anon_Colors): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    * @name pc.createPlane
    ...
    */
  def createPlane(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createPlane(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_HalfExtents): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @static
    * @function
  ...
  def createScript(name: String, app: typings.playcanvas.pcNs.Application): js.Function1[/* repeated */ js.Any, _] = js.native
  /**
    * @function
    ...
    */
  def createSphere(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createSphere(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_Radius): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @function
    * @name pc.createStyle
  ...
  /**
    ...
    */
  def createTorus(device: typings.playcanvas.pcNs.GraphicsDevice): typings.playcanvas.pcNs.Mesh = js.native
  def createTorus(device: typings.playcanvas.pcNs.GraphicsDevice, opts: Anon_RingRadius): typings.playcanvas.pcNs.Mesh = js.native
  /**
    * @static
    * @function
  ...
  def drawFullscreenQuad(
    ...
    target: typings.playcanvas.pcNs.RenderTarget,
    vertexBuffer: typings.playcanvas.pcNs.VertexBuffer,
    shader: typings.playcanvas.pcNs.Shader
  ): Unit = js.native
  def drawFullscreenQuad(
    device: typings.playcanvas.pcNs.GraphicsDevice,
    target: typings.playcanvas.pcNs.RenderTarget,
    vertexBuffer: typings.playcanvas.pcNs.VertexBuffer,
    shader: typings.playcanvas.pcNs.Shader,
    rect: typings.playcanvas.pcNs.Vec4
  ): Unit = js.native
  /**
    * @function
    ...
    */
  def getTouchTargetCoords(touch: typings.playcanvas.pcNs.Touch): js.Any = js.native
  /**
    * @static
    * @function
