...
@JSGlobal("pc.PhongMaterial")
@js.native
open class PhongMaterial ()
  extends typings.playcanvas.mod.PhongMaterial
/* was `typeof StandardMaterial` */
object PhongMaterial {
  ...
  /* static member */
  @JSGlobal("pc.PhongMaterial.CUBEMAP_PARAMETERS")
  @js.native
  ...
  /* static member */
  @JSGlobal("pc.PhongMaterial.TEXTURE_PARAMETERS")
  @js.native
