...
object string {
  ...
  /**
    ...
    */
  @JSGlobal("pc.string.fromCodePoint")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("pc.string.getCodePoint")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("pc.string.getCodePoints")
  @js.native
