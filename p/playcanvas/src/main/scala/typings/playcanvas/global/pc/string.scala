...
object string {
  ...
  /**
    ...
    */
  inline def format(s: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("format")(s.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def format(s: String, arguments: js.Any): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(s.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  /**
    ...
    */
  inline def fromCodePoint(args: Double*): String = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCodePoint")(args.asInstanceOf[js.Any]).asInstanceOf[String]
