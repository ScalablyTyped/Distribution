...
): typings.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShaderFromCode")(device.asInstanceOf[js.Any], vsCode.asInstanceOf[js.Any], fsCode.asInstanceOf[js.Any], uniqueName.asInstanceOf[js.Any], attributes.asInstanceOf[js.Any])).asInstanceOf[typings.playcanvas.mod.Shader]
inline def createShaderFromCode(
  device: typings.playcanvas.mod.GraphicsDevice,
  vsCode: String,
  fsCode: String,
  ...
  attributes: StringDictionary[String],
  useTransformFeedback: Boolean
): typings.playcanvas.mod.Shader = (^.asInstanceOf[js.Dynamic].applyDynamic("createShaderFromCode")(device.asInstanceOf[js.Any], vsCode.asInstanceOf[js.Any], fsCode.asInstanceOf[js.Any], uniqueName.asInstanceOf[js.Any], attributes.asInstanceOf[js.Any], useTransformFeedback.asInstanceOf[js.Any])).asInstanceOf[typings.playcanvas.mod.Shader]
inline def createShaderFromCode(
  device: typings.playcanvas.mod.GraphicsDevice,
  vsCode: String,
  fsCode: String,
