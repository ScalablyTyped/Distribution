...
import typings.playcanvas.Anon_LoopVolume
...
class SoundManager protected () extends js.Object {
  ...
  /**
    ...
    */
  /* private */ def hasAudio(): Boolean = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def hasAudioContext(): Boolean = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def playSound(sound: Sound, options: Anon_LoopVolume): Channel = js.native
  /**
    * @private
    * @function
    ...
    * @param {Boolean} [options.loop] Whether to loop the sound when it reaches the end.
    */
  /* private */ def playSound3d(sound: Sound, position: Vec3, options: Anon_LoopVolume): Channel3d = js.native
}
