...
class ComponentSystem protected () extends js.Object {
  ...
  /**
    ...
    */
  /* private */ def initializeComponentData(component: Component, data: js.Object, properties: js.Object): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  /* private */ def removeComponent(entity: Entity): Unit = js.native
}
