...
/**
  ...
  */
@js.native
trait ScriptTypeConstructor[S /* <: typings.playcanvas.pcNs.ScriptType */]
  extends /* key */ StringDictionary[js.Any]
     with Instantiable1[/* args */ Anon_App, S] {
  /**
    * @private
    * @readonly
    * @static
  ...
  /**
    ...
    * })
    */
  var extend: js.UndefOr[js.Function1[/* methods */ StringDictionary[js.Function0[_]], Unit]] = js.native
}
