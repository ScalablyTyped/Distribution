...
class ElementTouchEvent protected () extends ElementInputEvent {
  def this(event: BrowserTouchEvent, element: ElementComponent, input: ElementInput) = this()
  var changedTouches: js.Array[BrowserTouch] = js.native
  var touches: js.Array[BrowserTouch] = js.native
}
