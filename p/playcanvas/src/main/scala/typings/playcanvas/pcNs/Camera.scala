...
import typings.playcanvas.Anon_ColorDepthFlags
...
class Camera () extends js.Object {
  ...
  /**
    ...
    */
  var clearDepth: Double = js.native
  /**
    * @private
    * @type Number
    ...
    */
  var clearFlags: Double = js.native
  /**
    * @private
    * @type Number
    ...
    */
  var clearStencil: Double = js.native
  /**
    * @private
    * @type Number
  ...
  /**
    ...
    */
  /* private */ def screenToWorld(x: Double, y: Double, z: Double, cw: Double, ch: Double): Vec3 = js.native
  /* private */ def screenToWorld(x: Double, y: Double, z: Double, cw: Double, ch: Double, worldCoord: Vec3): Vec3 = js.native
  /**
    * @private
    * @function
    ...
    */
  def setClearOptions(options: Anon_ColorDepthFlags): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def worldToScreen(worldCoord: Vec3, cw: Double, ch: Double): Vec3 = js.native
  /* private */ def worldToScreen(worldCoord: Vec3, cw: Double, ch: Double, screenCoord: Vec3): Vec3 = js.native
}
