...
class StandardMaterial () extends Material {
  ...
  var emissiveMapTint: Boolean = js.native
  var emissiveMapUv: Double = js.native
  var emissiveMapVertexColor: Boolean = js.native
  var fresnelModel: Double = js.native
  var glossMap: Texture = js.native
  ...
  var glossMapVertexColor: Boolean = js.native
  var heightMap: Texture = js.native
  ...
  var lightMapVertexColor: Boolean = js.native
  ...
  var metalnessMapVertexColor: Boolean = js.native
  ...
  var opacityMap: Texture = js.native
  ...
  var opacityMapVertexColor: Boolean = js.native
  ...
  var shereMap: Texture = js.native
  ...
  var specularMapTing: Boolean = js.native
  var specularMapUv: Double = js.native
  var specularMapVertexColor: Boolean = js.native
