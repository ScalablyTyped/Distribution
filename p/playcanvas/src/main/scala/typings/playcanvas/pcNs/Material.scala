...
class Material () extends js.Object {
  ...
  /**
    ...
    * @author Will Eastcott
    */
  def getParameter(name: String): Double | js.Array[_] | Texture = js.native
  /**
    * @function
    ...
    */
  def init(data: js.Any): Error = js.native
  def setParameter(name: String, data: js.Array[_]): Unit = js.native
  def setParameter(name: String, data: js.Array[_], passFlags: Double): Unit = js.native
  /**
    * @function
