...
class ResourceLoader protected () extends js.Object {
  ...
  /**
    ...
    * });
    */
  def load(url: String, `type`: String, callback: typings.playcanvas.pcNs.callbacksNs.ResourceLoader): Unit = js.native
  def load(
    url: String,
    `type`: String,
    callback: typings.playcanvas.pcNs.callbacksNs.ResourceLoader,
    asset: Asset
  ): Unit = js.native
  /**
    * @function
