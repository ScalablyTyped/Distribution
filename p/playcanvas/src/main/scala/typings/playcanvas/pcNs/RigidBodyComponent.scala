...
class RigidBodyComponent protected () extends Component {
  ...
  /**
    ...
    */
  /* private */ def _updateKinematic(dt: Double): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def applyImpulse(impulse: Vec3): Unit = js.native
  ...
  /**
    ...
    */
  def applyTorque(force: Vec3): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def applyTorqueImpulse(torqueImpulse: Vec3): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  /* private */ def createBody(): Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  /* private */ def syncBodyToEntity(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def syncEntityToBody(): Unit = js.native
  /**
    * @function
    ...
    */
  def teleport(position: Vec3): Unit = js.native
  def teleport(position: Vec3, angles: Vec3): Unit = js.native
  /**
    * @function
  ...
  def teleport(x: Double, y: Double, z: Double, ax: Double): Unit = js.native
  def teleport(x: Double, y: Double, z: Double, ax: Double, ay: Double): Unit = js.native
  def teleport(x: Double, y: Double, z: Double, ax: Double, ay: Double, az: Double): Unit = js.native
}
