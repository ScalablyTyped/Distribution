...
class CameraComponent protected () extends Component {
  ...
  /**
    ...
    * });
    */
  def enterVr(display: VrDisplay, callback: js.Function): Unit = js.native
  /**
    * @function
    ...
    * });
    */
  def exitVr(callback: js.Function): Unit = js.native
  /**
    * @function
    * @private
    ...
    */
  /* private */ def frameBegin(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def frameEnd(): Unit = js.native
  /**
    * @function
