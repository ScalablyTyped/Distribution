...
class Asset protected () extends js.Object {
  ...
  def this(name: String, `type`: String, file: Anon_Filename) = this()
  def this(name: String, `type`: String, file: Null, data: js.Object) = this()
  def this(name: String, `type`: String, file: Anon_Filename, data: js.Object) = this()
  var file: Anon_Filename | Null = js.native
  ...
  /**
    ...
    */
  def ready(callback: js.Function1[/* repeated */ js.Any, Unit]): Unit = js.native
  def ready(callback: js.Function1[/* repeated */ js.Any, Unit], scope: js.Any): Unit = js.native
  /**
    * @function
