...
class SoundInstance protected () extends js.Object {
  ...
  /**
    ...
    */
  /* private */ def _createSource(): AudioBufferSourceNode = js.native
  /**
    * @function
    * @private
    ...
    */
  /* private */ def _initializeNodes(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def _onManagerDestroy(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def _onManagerResume(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def _onManagerSuspend(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def _onManagerVolumeChange(): Unit = js.native
  /**
    * @private
    * @function
    ...
    */
  /* private */ def _updateCurrentTime(): Unit = js.native
  /**
    * @function
