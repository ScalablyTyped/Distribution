...
object scriptNs extends js.Object {
  /**
    ...
    * }
    */
  def attribute(name: String, `type`: String, defaultValue: js.Any): Unit = js.native
  def attribute(name: String, `type`: String, defaultValue: js.Any, options: Anon_Color): Unit = js.native
  /**
    * @function
    ...
    * }
    */
  def create(name: String, callback: js.Function): Unit = js.native
  /**
    * @function
    ...
    * });
    */
  def createLoadingScreen(callback: js.Function): Unit = js.native
}
