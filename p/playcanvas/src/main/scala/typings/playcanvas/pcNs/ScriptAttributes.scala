...
class ScriptAttributes protected () extends js.Object {
  def this(scriptType: typings.playcanvas.pcNs.ScriptType) = this()
  /**
    * @function
    ...
    * });
    */
  def add(name: String, args: AttributesArgs): Unit = js.native
  /**
    * @function
    ...
    */
  def get(name: String): AttributesArgs = js.native
  /**
    * @function
