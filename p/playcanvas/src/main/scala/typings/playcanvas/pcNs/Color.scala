...
class Color () extends js.Object {
  ...
  /**
    ...
    */
  def copy(rhs: Color): this.type = js.native
  /**
    * @function
    ...
    * @returns {pc.Color} Self for chaining
    */
  def fromString(hex: String): this.type = js.native
  /**
    * @function
    * @name pc.Color#set
    ...
    * @returns {pc.Color} Self for chaining
    */
  def set(r: Double, g: Double, b: Double): this.type = js.native
  ...
  /**
    ...
    */
  def toString(alpha: Double): String = js.native
}
