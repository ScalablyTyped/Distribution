...
trait ResourceHandler extends js.Object {
  ...
  /**
    ...
    */
  def load(url: String, callback: typings.playcanvas.pcNs.callbacksNs.ResourceHandler): Unit = js.native
  def load(url: String, callback: typings.playcanvas.pcNs.callbacksNs.ResourceHandler, asset: Asset): Unit = js.native
  /**
    * @function
