...
@js.native
trait BrowserKeyboardEvent
  extends Instantiable1[/* typeArg */ String, KeyboardEvent]
     with Instantiable2[/* typeArg */ String, /* eventInitDict */ KeyboardEventInit, KeyboardEvent] {
