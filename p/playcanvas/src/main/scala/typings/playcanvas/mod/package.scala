...
/**
  ...
  */
inline def createBox(device: GraphicsDevice): Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createBox")(device.asInstanceOf[js.Any]).asInstanceOf[Mesh]
inline def createBox(device: GraphicsDevice, opts: CalculateTangents): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createBox")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Mesh]
...
/**
  ...
  */
inline def createCapsule(device: GraphicsDevice): Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCapsule")(device.asInstanceOf[js.Any]).asInstanceOf[Mesh]
inline def createCapsule(device: GraphicsDevice, opts: Height): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createCapsule")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Mesh]
...
/**
  ...
  */
inline def createCone(device: GraphicsDevice): Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCone")(device.asInstanceOf[js.Any]).asInstanceOf[Mesh]
inline def createCone(device: GraphicsDevice, opts: BaseRadius): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createCone")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Mesh]
...
/**
  ...
  * @returns {Mesh} A new cylinder-shaped mesh.
  */
inline def createCylinder(device: GraphicsDevice): Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createCylinder")(device.asInstanceOf[js.Any]).asInstanceOf[Mesh]
...
/**
  ...
  * });
  */
inline def createMesh(device: GraphicsDevice, positions: js.Array[Double]): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createMesh")(device.asInstanceOf[js.Any], positions.asInstanceOf[js.Any])).asInstanceOf[Mesh]
inline def createMesh(device: GraphicsDevice, positions: js.Array[Double], opts: BlendIndices): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createMesh")(device.asInstanceOf[js.Any], positions.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Mesh]
...
/**
  ...
  */
inline def createTorus(device: GraphicsDevice): Mesh = ^.asInstanceOf[js.Dynamic].applyDynamic("createTorus")(device.asInstanceOf[js.Any]).asInstanceOf[Mesh]
inline def createTorus(device: GraphicsDevice, opts: RingRadius): Mesh = (^.asInstanceOf[js.Dynamic].applyDynamic("createTorus")(device.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Mesh]
...
type FilterAssetCallback = js.Function1[/* asset */ Asset_, Boolean]

type FindNodeCallback = js.Function1[/* node */ GraphNode, Boolean]

type ForEachNodeCallback = js.Function1[/* node */ GraphNode, Any]

type HandleEventCallback = js.Function8[
/* arg1 */ js.UndefOr[Any], 
/* arg2 */ js.UndefOr[Any], 
/* arg3 */ js.UndefOr[Any], 
/* arg4 */ js.UndefOr[Any], 
...
type HttpResponseCallback = js.Function2[/* err */ Double | String | js.Error | Null, /* response */ js.UndefOr[Any], Any]

type LoadAssetCallback = js.Function2[/* err */ String | Null, /* asset */ js.UndefOr[Asset_], Any]

type LoadHierarchyCallback = js.Function2[/* err */ String | Null, /* entity */ js.UndefOr[Entity], Any]

type LoadSceneCallback = js.Function2[/* err */ String | Null, /* entity */ js.UndefOr[Entity], Any]

type LoadSceneDataCallback = js.Function2[/* err */ String | Null, /* sceneItem */ js.UndefOr[SceneRegistryItem], Any]

type LoadSettingsCallback = js.Function1[/* err */ String | Null, Any]

type LockMouseCallback = js.Function0[Any]

type MakeTickCallback = js.Function2[/* timestamp */ js.UndefOr[Double], /* frame */ js.UndefOr[Any], Any]

type ModuleErrorCallback = js.Function1[/* error */ String, Any]

type ModuleInstanceCallback = js.Function1[/* moduleInstance */ Any, Any]
...
type PhongMaterial = StandardMaterial

type PreloadAppCallback = js.Function0[Any]

type ResourceHandlerCallback = js.Function2[/* err */ String | Null, /* response */ js.UndefOr[Any], Any]
...
type XrHitTestStartCallback = js.Function2[/* err */ js.Error | Null, /* hitTestSource */ XrHitTestSource | Null, Any]
