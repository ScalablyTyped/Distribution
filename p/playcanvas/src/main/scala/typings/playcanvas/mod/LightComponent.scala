...
open class LightComponent protected () extends Component {
  ...
  def penumbraSize: Any = js.native
  def penumbraSize_=(arg: Any): Unit = js.native
  ...
  def shadowUpdateOverrides: Any = js.native
  /**
    * Returns an array of SHADOWUPDATE_ settings per shadow cascade, or undefined if not used.
    *
    * @type {number[] | null}
    */
  def shadowUpdateOverrides_=(arg: Any): Unit = js.native
