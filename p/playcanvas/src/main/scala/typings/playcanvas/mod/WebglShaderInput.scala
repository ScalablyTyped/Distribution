...
/**
  ...
  * @ignore
  */
trait WebglShaderInput extends StObject {
...
object WebglShaderInput {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[WebglShaderInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WebglShaderInput] (val x: Self) extends AnyVal {
