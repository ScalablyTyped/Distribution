...
/**
  ...
  * @augments Material
  */
/* was `typeof StandardMaterial` */
@JSImport("playcanvas", "PhongMaterial")
@js.native
open class PhongMaterial () extends StandardMaterial
/* was `typeof StandardMaterial` */
object PhongMaterial {
  ...
  /* static member */
  @JSImport("playcanvas", "PhongMaterial.CUBEMAP_PARAMETERS")
  @js.native
  ...
  /* static member */
  @JSImport("playcanvas", "PhongMaterial.TEXTURE_PARAMETERS")
  @js.native
