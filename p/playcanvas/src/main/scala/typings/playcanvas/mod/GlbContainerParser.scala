...
trait GlbContainerParser extends StObject {
...
object GlbContainerParser {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[GlbContainerParser]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GlbContainerParser] (val x: Self) extends AnyVal {
