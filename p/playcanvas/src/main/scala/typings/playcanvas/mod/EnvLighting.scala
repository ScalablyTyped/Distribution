...
/**
  ...
  * @ignore
  */
@JSImport("playcanvas", "EnvLighting")
@js.native
open class EnvLighting () extends StObject
object EnvLighting {
  ...
  /**
    ...
    */
  /* static member */
  inline def generateAtlas(source: Texture): Texture = ^.asInstanceOf[js.Dynamic].applyDynamic("generateAtlas")(source.asInstanceOf[js.Any]).asInstanceOf[Texture]
  inline def generateAtlas(source: Texture, options: NumAmbientSamples): Texture = (^.asInstanceOf[js.Dynamic].applyDynamic("generateAtlas")(source.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Texture]
  ...
  /**
    ...
    */
  /* static member */
  inline def generateLightingSource(source: Texture): Texture = ^.asInstanceOf[js.Dynamic].applyDynamic("generateLightingSource")(source.asInstanceOf[js.Any]).asInstanceOf[Texture]
  inline def generateLightingSource(source: Texture, options: Size): Texture = (^.asInstanceOf[js.Dynamic].applyDynamic("generateLightingSource")(source.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Texture]
  ...
  /**
    ...
    */
  /* static member */
  inline def generatePrefilteredAtlas(sources: js.Array[Texture]): Texture = ^.asInstanceOf[js.Dynamic].applyDynamic("generatePrefilteredAtlas")(sources.asInstanceOf[js.Any]).asInstanceOf[Texture]
  inline def generatePrefilteredAtlas(sources: js.Array[Texture], options: LegacyAmbient): Texture = (^.asInstanceOf[js.Dynamic].applyDynamic("generatePrefilteredAtlas")(sources.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Texture]
  ...
  /**
    ...
    */
  /* static member */
  inline def generateSkyboxCubemap(source: Texture): Texture = ^.asInstanceOf[js.Dynamic].applyDynamic("generateSkyboxCubemap")(source.asInstanceOf[js.Any]).asInstanceOf[Texture]
  inline def generateSkyboxCubemap(source: Texture, size: Double): Texture = (^.asInstanceOf[js.Dynamic].applyDynamic("generateSkyboxCubemap")(source.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[Texture]
}
