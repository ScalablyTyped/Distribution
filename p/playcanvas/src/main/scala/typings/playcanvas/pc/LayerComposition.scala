...
class LayerComposition () extends EventHandler {
  ...
  /**
    ...
    */
  def sortOpaqueLayers(layersA: js.Array[Number], layersB: js.Array[Number]): Double = js.native
  /**
    * @function
    ...
    */
  def sortTransparentLayers(layersA: js.Array[Number], layersB: js.Array[Number]): Double = js.native
}
