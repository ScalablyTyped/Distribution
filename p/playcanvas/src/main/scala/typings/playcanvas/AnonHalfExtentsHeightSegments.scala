...
trait AnonHalfExtentsHeightSegments extends js.Object {
...
object AnonHalfExtentsHeightSegments {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonHalfExtentsHeightSegments]
  }
}
