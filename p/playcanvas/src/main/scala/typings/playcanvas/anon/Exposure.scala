...
object Exposure {
  ...
  extension [Self <: Exposure](x: Self) {
    ...
    inline def setFog_colorVarargs(value: Double*): Self = StObject.set(x, "fog_color", js.Array(value :_*))
    ...
    inline def setGlobal_ambientVarargs(value: Double*): Self = StObject.set(x, "global_ambient", js.Array(value :_*))
    ...
    inline def setSkyboxRotationVarargs(value: Double*): Self = StObject.set(x, "skyboxRotation", js.Array(value :_*))
