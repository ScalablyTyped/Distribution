...
class Texture protected () extends js.Object {
  ...
  /**
           ...
           * </ul>
           */
  var addressU: scala.Double = js.native
  /**
           ...
           * </ul>
           */
  var addressV: scala.Double = js.native
  /**
           ...
           * </ul>
           */
  var addressW: scala.Double = js.native
  /**
  ...
  /**
           ...
           */
  var autoMipmap: scala.Boolean = js.native
  /**
           ...
           * </ul>
           */
  var compareFunc: scala.Double = js.native
  /**
           ...
           * hardware PCF is enabled for this texture, and you can get filtered results of comparison using texture() in your shader (WebGL2 only).
           */
  var compareOnRead: scala.Boolean = js.native
  /**
           * @readonly
           ...
           */
  val cubemap: scala.Boolean = js.native
  /**
           * @readonly
  ...
  /**
           ...
           * </ul>
           */
  val format: scala.Double = js.native
  /**
           * @readonly
  ...
  /**
           ...
           * </ul>
           */
  var magFilter: scala.Double = js.native
  /**
  ...
  /**
           ...
           */
  val volume: scala.Boolean = js.native
  /**
           * @readonly
  ...
  /**
           ...
           */
  /* private */ def bind(): scala.Unit = js.native
  /**
           * @function
  ...
  /**
           ...
           */
  def getSource(): stdLib.HTMLImageElement = js.native
  /**
           * @function
  ...
  /**
           ...
           * restored.
           */
  /* private */ def recover(): scala.Unit = js.native
  /**
           * @function
           ...
           */
  def setSource(source: js.Array[stdLib.HTMLCanvasElement | stdLib.HTMLImageElement | stdLib.HTMLVideoElement]): scala.Unit = js.native
  /**
           * @function
           * @name pc.Texture#setSource
           * @description Set the pixel data of the texture from a canvas, image, video DOM element. If the
           ...
           * or an array of 6 canvas, image or video elements.
           */
  def setSource(source: stdLib.HTMLCanvasElement): scala.Unit = js.native
  /**
           * @function
           * @name pc.Texture#setSource
           * @description Set the pixel data of the texture from a canvas, image, video DOM element. If the
           ...
           * or an array of 6 canvas, image or video elements.
           */
  def setSource(source: stdLib.HTMLImageElement): scala.Unit = js.native
  /**
           * @function
           * @name pc.Texture#setSource
           * @description Set the pixel data of the texture from a canvas, image, video DOM element. If the
           ...
           * or an array of 6 canvas, image or video elements.
           */
  def setSource(source: stdLib.HTMLVideoElement): scala.Unit = js.native
  /**
           * @function
