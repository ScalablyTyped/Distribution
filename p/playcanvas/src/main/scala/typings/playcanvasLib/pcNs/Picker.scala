...
class Picker protected () extends js.Object {
  def this(device: GraphicsDevice, width: scala.Double, height: scala.Double) = this()
  ...
  /**
    ...
    */
  def getSelection(x: scala.Double, y: scala.Double): js.Array[MeshInstance] = js.native
  def getSelection(x: scala.Double, y: scala.Double, width: scala.Double): js.Array[MeshInstance] = js.native
  def getSelection(x: scala.Double, y: scala.Double, width: scala.Double, height: scala.Double): js.Array[MeshInstance] = js.native
  /**
    * @function
    ...
    */
  def prepare(camera: Camera, scene: Scene): scala.Unit = js.native
  /**
    * @function
