...
class Material () extends js.Object {
  ...
  var alphaWrite: scala.Boolean = js.native
  var blend: scala.Boolean = js.native
  var blendDst: scala.Double = js.native
  var blendSrc: scala.Double = js.native
  var blendType: scala.Double = js.native
  var blueWrite: scala.Boolean = js.native
  var cull: scala.Double = js.native
  var depthTest: scala.Boolean = js.native
  var depthWrite: scala.Boolean = js.native
  var greenWrite: scala.Boolean = js.native
  var name: java.lang.String = js.native
  var redWrite: scala.Boolean = js.native
  ...
  /**
    ...
    */
  def deleteParameter(name: java.lang.String): scala.Unit = js.native
  /**
    * @function
    ...
    * @author Will Eastcott
    */
  def getParameter(name: java.lang.String): scala.Double | js.Array[_] | Texture = js.native
  /**
    * @function
    ...
    */
  def init(data: js.Any): stdLib.Error = js.native
  def setParameter(name: java.lang.String, data: js.Array[_]): scala.Unit = js.native
  def setParameter(name: java.lang.String, data: js.Array[_], passFlags: scala.Double): scala.Unit = js.native
  def setParameter(name: java.lang.String, data: Texture): scala.Unit = js.native
  def setParameter(name: java.lang.String, data: Texture, passFlags: scala.Double): scala.Unit = js.native
  /**
    * @function
    ...
    * @author Will Eastcott
    */
  def setParameter(name: java.lang.String, data: scala.Double): scala.Unit = js.native
  def setParameter(name: java.lang.String, data: scala.Double, passFlags: scala.Double): scala.Unit = js.native
  /**
    * @function
