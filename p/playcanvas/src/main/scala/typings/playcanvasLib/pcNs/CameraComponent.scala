...
class CameraComponent protected () extends Component {
  ...
  var calculateProjection: js.Function = js.native
  var calculateTransform: js.Function = js.native
  var clearColor: Color = js.native
  var clearColorBuffer: scala.Boolean = js.native
  var clearDepthBuffer: scala.Boolean = js.native
  var clearStencilBuffer: scala.Boolean = js.native
  var cullFaces: scala.Boolean = js.native
  var farClip: scala.Double = js.native
  var flipFaces: scala.Boolean = js.native
  ...
  var frustumCulling: scala.Boolean = js.native
  ...
  /**
           ...
           * });
           */
  def enterVr(display: VrDisplay, callback: js.Function): scala.Unit = js.native
  /**
           * @function
           ...
           * });
           */
  def exitVr(callback: js.Function): scala.Unit = js.native
  /**
           * @function
           * @private
           ...
           */
  /* private */ def frameBegin(): scala.Unit = js.native
  /**
           * @private
           * @function
           ...
           */
  /* private */ def frameEnd(): scala.Unit = js.native
  /**
           * @function
           ...
           */
  def screenToWorld(screenx: scala.Double, screeny: scala.Double, cameraz: scala.Double): Vec3 = js.native
  /**
           * @function
           * @name pc.CameraComponent#screenToWorld
           * @description Convert a point from 2D screen space to 3D world space.
           ...
           * @returns {pc.Vec3} The world space coordinate.
           */
  def screenToWorld(screenx: scala.Double, screeny: scala.Double, cameraz: scala.Double, worldCoord: Vec3): Vec3 = js.native
  /**
           * @function
