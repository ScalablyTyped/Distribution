...
class IndexBuffer protected () extends js.Object {
  def this(graphicsDevice: GraphicsDevice, format: scala.Double, numIndices: scala.Double) = this()
  def this(graphicsDevice: GraphicsDevice, format: scala.Double, numIndices: scala.Double, usage: scala.Double) = this()
  def this(graphicsDevice: GraphicsDevice, format: scala.Double, numIndices: scala.Double, usage: scala.Double, initialData: js.Any) = this()
  /**
           * @function
  ...
  /**
           ...
           */
  def getFormat(): scala.Unit = js.native
  /**
           * @function
           ...
           */
  def getNumIndices(): scala.Double = js.native
  /**
           * @function
