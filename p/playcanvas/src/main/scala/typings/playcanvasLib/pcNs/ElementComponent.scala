...
class ElementComponent protected () extends Component {
  ...
  var autoHeight: scala.Double = js.native
  var autoWidth: scala.Double = js.native
  var batchGroupId: scala.Double = js.native
  var bottom: scala.Double = js.native
  var canvasCorners: js.Array[Vec2] = js.native
  var color: Color = js.native
  var drawOrder: scala.Double = js.native
  var font: Font = js.native
  var fontAsset: scala.Double = js.native
  ...
  var textureAsset: scala.Double = js.native
  var top: scala.Double = js.native
  var `type`: java.lang.String = js.native
  var useInput: scala.Boolean = js.native
