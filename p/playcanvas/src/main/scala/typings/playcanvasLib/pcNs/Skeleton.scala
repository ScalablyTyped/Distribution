...
class Skeleton protected () extends js.Object {
  ...
  /**
           ...
           */
  val numNodes: scala.Double = js.native
  /**
           * @function
           ...
           */
  def addTime(delta: scala.Double): scala.Unit = js.native
  /**
           * @function
           ...
           * @author Will Eastcott
           */
  def blend(skel1: Skeleton, skel2: Skeleton, alpha: scala.Double): scala.Unit = js.native
  /**
           * @function
           ...
           * @author Will Eastcott
           */
  def setGraph(graph: GraphNode): scala.Unit = js.native
  /**
           * @function
