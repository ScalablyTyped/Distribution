...
class LightComponent protected () extends Component {
  ...
  var affectDynamic: scala.Boolean = js.native
  var affectLightmapped: scala.Boolean = js.native
  var bake: scala.Boolean = js.native
  var bakeDir: scala.Boolean = js.native
  var castShadows: scala.Boolean = js.native
  var color: Color = js.native
  var cookie: Texture = js.native
  var cookieAngle: scala.Double = js.native
  var cookieAsset: scala.Double = js.native
  var cookieChannel: java.lang.String = js.native
  var cookieFalloff: scala.Boolean = js.native
  var cookieIntensity: scala.Double = js.native
  var cookieOffset: Vec2 = js.native
  var cookieScale: Vec2 = js.native
  var falloffMode: scala.Double = js.native
  var innerConeAngle: scala.Double = js.native
  var intensity: scala.Double = js.native
  var isStatic: scala.Boolean = js.native
  var mask: scala.Double = js.native
  var normalOffsetBias: scala.Double = js.native
  var outerConeAngle: scala.Double = js.native
  var range: scala.Double = js.native
  var shadowBias: scala.Double = js.native
  var shadowDistance: scala.Double = js.native
  var shadowResolution: scala.Double = js.native
  var shadowType: scala.Double = js.native
  var shadowUpdateMode: scala.Double = js.native
  var `type`: java.lang.String = js.native
  var vsmBlurMode: scala.Double = js.native
  var vsmBlurSize: scala.Double = js.native
}
