...
class ParticleSystemComponent protected () extends Component {
  ...
  var alignToMotion: scala.Boolean = js.native
  var alphaGraph: Curve = js.native
  var alphaGraph2: Curve = js.native
  var animLoop: scala.Boolean = js.native
  var animNumFrames: scala.Double = js.native
  var animSpeed: scala.Double = js.native
  var animTilesX: scala.Double = js.native
  var animTilesY: scala.Double = js.native
  var autoPlay: scala.Boolean = js.native
  var blend: scala.Double = js.native
  var colorGraph: CurveSet = js.native
  var colorMap: Texture = js.native
  var depthSoftening: scala.Double = js.native
  var depthWrite: scala.Boolean = js.native
  var emitterExtents: Vec3 = js.native
  var emitterRadius: scala.Double = js.native
  var emmitterShape: scala.Double = js.native
  var halfLambert: scala.Boolean = js.native
  var initialVelocity: scala.Double = js.native
  var intensity: scala.Double = js.native
  var lifetime: scala.Double = js.native
  var lighting: scala.Boolean = js.native
  ...
  var noFog: scala.Boolean = js.native
  var normalMap: Texture = js.native
  var numParticles: scala.Double = js.native
  var preWarm: scala.Boolean = js.native
  var rate: scala.Double = js.native
  var rate2: scala.Double = js.native
  ...
  var sort: scala.Double = js.native
  var startAngle: scala.Double = js.native
  var startAngle2: scala.Double = js.native
  ...
  /**
          ...
          */
  def isPlaying(): scala.Unit = js.native
  /**
          * @function
  ...
  /**
          ...
          */
  /* private */ def rebuild(): scala.Unit = js.native
  /**
          * @function
