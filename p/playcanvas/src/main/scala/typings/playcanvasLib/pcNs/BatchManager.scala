...
class BatchManager protected () extends js.Object {
  ...
  /**
           ...
           */
  def addGroup(name: java.lang.String, dynamic: scala.Boolean, maxAabbSize: scala.Double): BatchGroup = js.native
  /**
           * @function
           * @name pc.BatchManager#addGroup
           * @description Adds new global batch group.
           ...
           * @returns {pc.BatchGroup} Group object.
           */
  def addGroup(name: java.lang.String, dynamic: scala.Boolean, maxAabbSize: scala.Double, id: scala.Double): BatchGroup = js.native
  /**
           * @function
  ...
  /**
           ...
           */
  def create(meshInstances: js.Array[MeshInstance], dynamic: scala.Boolean): Batch = js.native
  /**
           * @function
           * @name pc.BatchManager#create
           * @description Takes a mesh instance list that has been prepared by {@link pc.BatchManager#prepare}, and returns a {@link pc.Batch} object. This method assumes that all mesh instances provided can be rendered in a single draw call.
           ...
           * @returns {pc.Batch} The resulting batch object.
           */
  def create(meshInstances: js.Array[MeshInstance], dynamic: scala.Boolean, batchGroupId: scala.Double): Batch = js.native
  /**
           * @function
           ...
           * @param {pc.Batch} batch A batch object
           */
  def destroy(batch: Batch): scala.Unit = js.native
  /**
           * @function
           ...
           */
  def generate(): scala.Unit = js.native
  /**
           * @function
           * @name pc.BatchManager#generate
           * @description Destroys all batches and creates new based on scene models. Hides original models. Called by engine automatically on app start, and if batchGroupIds on models are changed.
           * @param {Array} [groupIds] Optional array of batch group IDs to update. Otherwise all groups are updated.
           */
  def generate(groupIds: js.Array[scala.Double]): scala.Unit = js.native
  /**
           * @function
           ...
           * @returns {pc.BatchGroup} Group object.
           */
  def getGroupByName(name: java.lang.String): BatchGroup = js.native
  /**
           * @function
           ...
           */
  def prepare(meshInstances: js.Array[MeshInstance], dynamic: scala.Boolean, maxAabbSize: scala.Double): js.Array[js.Array[MeshInstance]] = js.native
  /**
           * @function
           ...
           */
  def register(batch: BatchGroup, entities: js.Array[Entity]): scala.Unit = js.native
  /**
           * @function
           ...
           */
  def removeGroup(id: java.lang.String): scala.Unit = js.native
  /**
           * @private
           * @function
           ...
           * @param {pc.Batch} batch A batch object
           */
  /* private */ def update(batch: Batch): scala.Unit = js.native
  /**
           * @private
           * @function
           ...
           */
  /* private */ def updateAll(): scala.Unit = js.native
}
