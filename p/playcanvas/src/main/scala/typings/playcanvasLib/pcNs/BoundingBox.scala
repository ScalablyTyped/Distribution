...
class BoundingBox () extends js.Object {
  ...
  /**
    ...
    */
  def add(other: BoundingBox): scala.Unit = js.native
  /**
    * @function
    ...
    */
  def containsPoint(point: Vec3): playcanvasLib.playcanvasLibNumbers.`true` = js.native
  def copy(src: BoundingBox): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def intersects(other: BoundingBox): scala.Boolean = js.native
  /**
    * @function
    ...
    */
  def intersectsBoundingSphere(sphere: BoundingSphere): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def setFromTransformedAabb(aabb: BoundingBox, m: Mat4): scala.Unit = js.native
}
