...
class Vec3 () extends js.Object {
  def this(x: js.Tuple3[scala.Double, scala.Double, scala.Double]) = this()
  ...
  /**
    ...
    */
  def dot(rhs: Vec3): scala.Double = js.native
  /**
    * @function
    * @name pc.Vec3#equals
    ...
    */
  def equals(rhs: Vec3): scala.Boolean = js.native
  /**
    * @function
    * @name pc.Vec3#length
  ...
  /**
    ...
    */
  def lerp(lhs: Vec3, rhs: Vec3, alpha: scala.Double): this.type = js.native
  /**
    * @function
    * @name pc.Vec3#mul
...
object Vec3 extends js.Object {
  /**
    ...
    */
  val BACK: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @static
    * @readonly
    * @type pc.Vec3
    ...
    */
  val DOWN: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @static
    * @readonly
    * @type pc.Vec3
    ...
    * @description A constant vector set to [0, 0, -1].
    */
  val FORWARD: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val LEFT: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ONE: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    * @description A constant vector set to [1, 0, 0].
    */
  val RIGHT: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    * @description A constant vector set to [0, 1, 0].
    */
  val UP: playcanvasLib.pcNs.Vec3 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ZERO: playcanvasLib.pcNs.Vec3 = js.native
}
