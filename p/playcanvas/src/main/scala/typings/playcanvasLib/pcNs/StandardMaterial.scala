...
class StandardMaterial () extends Material {
  ...
  var ambientTint: scala.Boolean = js.native
  var aoMap: Texture = js.native
  var aoMapChannel: java.lang.String = js.native
  var aoMapOffset: Vec2 = js.native
  var aoMapTiling: Vec2 = js.native
  var aoMapUv: scala.Double = js.native
  var aoMapVertexColor: scala.Boolean = js.native
  var bumpiness: scala.Double = js.native
  var conserveEnergy: scala.Boolean = js.native
  var cubeMap: Texture = js.native
  var cubeMapProjection: scala.Double = js.native
  var cubeMapProjectionBox: BoundingBox = js.native
  var diffuse: Color = js.native
  var diffuseMap: Texture = js.native
  var diffuseMapChannel: java.lang.String = js.native
  var diffuseMapOffset: Vec2 = js.native
  var diffuseMapTiling: Vec2 = js.native
  var diffuseMapTint: scala.Boolean = js.native
  var diffuseMapUv: scala.Double = js.native
  var diffuseMapVertexColor: scala.Boolean = js.native
  var emissive: Color = js.native
  var emissiveIntensity: scala.Double = js.native
  var emissiveMap: Texture = js.native
  var emissiveMapChannel: java.lang.String = js.native
  var emissiveMapOffset: Vec2 = js.native
  var emissiveMapTiling: Vec2 = js.native
  var emissiveMapTint: scala.Boolean = js.native
  var emissiveMapUv: scala.Double = js.native
  var emissiveMapVertexColor: scala.Boolean = js.native
  var fresnelModel: scala.Double = js.native
  var glossMap: Texture = js.native
  var glossMapChannel: java.lang.String = js.native
  var glossMapOffset: Vec2 = js.native
  var glossMapTiling: Vec2 = js.native
  var glossMapUv: scala.Double = js.native
  var glossMapVertexColor: scala.Boolean = js.native
  var heightMap: Texture = js.native
  var heightMapChannel: java.lang.String = js.native
  var heightMapFactor: scala.Double = js.native
  var heightMapOffset: Vec2 = js.native
  var heightMapTiling: Vec2 = js.native
  var heightMapUv: scala.Double = js.native
  var lightMap: Texture = js.native
  var lightMapChannel: java.lang.String = js.native
  var lightMapOffset: Vec2 = js.native
  var lightMapTiling: Vec2 = js.native
  var lightMapUv: scala.Double = js.native
  var lightMapVertexColor: scala.Boolean = js.native
  var metalness: scala.Double = js.native
  var metalnessMap: Texture = js.native
  var metalnessMapChannel: java.lang.String = js.native
  var metalnessMapOffset: Vec2 = js.native
  var metalnessMapTiling: Vec2 = js.native
  var metalnessMapUv: scala.Double = js.native
  var metalnessMapVertexColor: scala.Boolean = js.native
  var normalMap: Texture = js.native
  var normalMapOffset: Vec2 = js.native
  var normalMapTiling: Vec2 = js.native
  var normalMapUv: scala.Double = js.native
  var occludeSpecular: scala.Double = js.native
  var occludeSpecularIntensity: scala.Double = js.native
  var opacity: scala.Double = js.native
  var opacityMap: Texture = js.native
  var opacityMapChannel: java.lang.String = js.native
  var opacityMapOffset: Vec2 = js.native
  var opacityMapTiling: Vec2 = js.native
  var opacityMapUv: scala.Double = js.native
  var opacityMapVertexColor: scala.Boolean = js.native
  var reflectivity: scala.Double = js.native
  var refraction: scala.Double = js.native
  var refractionIndex: scala.Double = js.native
  var shadingModel: scala.Double = js.native
  var shereMap: Texture = js.native
  var shininess: scala.Double = js.native
  var specular: Color = js.native
  var specularAntialias: scala.Boolean = js.native
  var specularMap: Texture = js.native
  var specularMapChannel: java.lang.String = js.native
  var specularMapOffset: Vec2 = js.native
  var specularMapTiling: Vec2 = js.native
  var specularMapTing: scala.Boolean = js.native
  var specularMapUv: scala.Double = js.native
  var specularMapVertexColor: scala.Boolean = js.native
  var twoSidedLighting: scala.Boolean = js.native
  var useFog: scala.Boolean = js.native
  var useGammaTonemap: scala.Boolean = js.native
  var useLighting: scala.Boolean = js.native
  var useMetalness: scala.Boolean = js.native
  var useSkybox: scala.Boolean = js.native
}
