...
class Color () extends js.Object {
  def this(r: js.Array[scala.Double]) = this()
  def this(r: scala.Double) = this()
  def this(r: js.Array[scala.Double], g: scala.Double) = this()
  def this(r: scala.Double, g: scala.Double) = this()
  def this(r: js.Array[scala.Double], g: scala.Double, b: scala.Double) = this()
  def this(r: scala.Double, g: scala.Double, b: scala.Double) = this()
  def this(r: js.Array[scala.Double], g: scala.Double, b: scala.Double, a: scala.Double) = this()
  ...
  /**
           ...
           * @returns {pc.Color} Self for chaining
           */
  def fromString(hex: java.lang.String): this.type = js.native
  /**
           * @function
           * @name pc.Color#set
           ...
           * @returns {pc.Color} Self for chaining
           */
  def set(r: scala.Double, g: scala.Double, b: scala.Double): this.type = js.native
  /**
           * @function
           * @name pc.Color#set
           * @description Assign values to the color components, including alpha
  ...
  /**
           ...
           */
  def toString(alpha: scala.Double): java.lang.String = js.native
}
