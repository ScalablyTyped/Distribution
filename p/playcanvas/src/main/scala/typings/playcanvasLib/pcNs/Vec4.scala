...
class Vec4 () extends js.Object {
  ...
  /**
    ...
    */
  def equals(rhs: Vec4): scala.Boolean = js.native
  /**
    * @function
    * @name pc.Vec4#length
  ...
  /**
    ...
    */
  def lerp(lhs: Vec4, rhs: Vec4, alpha: scala.Double): this.type = js.native
  /**
    * @function
    * @name pc.Vec4#mul
...
object Vec4 extends js.Object {
  /**
    ...
    */
  val ONE: playcanvasLib.pcNs.Vec4 = js.native
  /**
    * @field
    * @static
    * @readonly
    ...
    */
  val ZERO: playcanvasLib.pcNs.Vec4 = js.native
}
