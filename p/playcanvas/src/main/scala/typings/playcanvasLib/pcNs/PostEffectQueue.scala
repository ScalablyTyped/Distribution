...
class PostEffectQueue protected () extends js.Object {
  ...
  /**
    ...
    */
  /* private */ def _createOffscreenTarget(useDepth: scala.Boolean, hdr: scala.Boolean): RenderTarget = js.native
  /**
    * @function
    ...
    */
  def addEffect(effect: PostEffect): scala.Unit = js.native
  /**
    * @function
  ...
  /**
    ...
    */
  def removeEffect(effect: PostEffect): scala.Unit = js.native
}
