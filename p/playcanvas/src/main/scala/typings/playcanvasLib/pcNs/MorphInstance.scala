...
class MorphInstance protected () extends js.Object {
  ...
  /**
           ...
           */
  def getWeight(index: scala.Double): scala.Double = js.native
  /**
           * @private
           * @function
           ...
           */
  def setWeight(index: scala.Double, weight: scala.Double): scala.Unit = js.native
  /**
           * @private
           * @function
           ...
           */
  def update(mesh: Mesh): scala.Unit = js.native
  /**
           * @private
           * @function
