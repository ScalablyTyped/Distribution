...
object keyframesMod {
  ...
  inline def defaultEasing(values: js.Array[js.Any]): js.Array[Easing] = ^.asInstanceOf[js.Dynamic].applyDynamic("defaultEasing")(values.asInstanceOf[js.Any]).asInstanceOf[js.Array[Easing]]
  inline def defaultEasing(values: js.Array[js.Any], easing: Easing): js.Array[Easing] = (^.asInstanceOf[js.Dynamic].applyDynamic("defaultEasing")(values.asInstanceOf[js.Any], easing.asInstanceOf[js.Any])).asInstanceOf[js.Array[Easing]]
  
  inline def defaultOffset(values: js.Array[js.Any]): js.Array[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("defaultOffset")(values.asInstanceOf[js.Any]).asInstanceOf[js.Array[Double]]
