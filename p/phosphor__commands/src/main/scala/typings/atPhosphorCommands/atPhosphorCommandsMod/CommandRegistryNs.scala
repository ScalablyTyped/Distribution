...
import typings.atPhosphorCommands.atPhosphorCommandsMod.CommandRegistryNs.CommandFunc
...
import typings.atPhosphorCommands.atPhosphorCommandsMod.CommandRegistryNs.IKeystrokeParts
