...
import typings.phosphorCommands.mod.CommandRegistry.ICommandChangedArgs
import typings.phosphorCommands.mod.CommandRegistry.ICommandExecutedArgs
import typings.phosphorCommands.mod.CommandRegistry.ICommandOptions
import typings.phosphorCommands.mod.CommandRegistry.IKeyBinding
import typings.phosphorCommands.mod.CommandRegistry.IKeyBindingChangedArgs
import typings.phosphorCommands.mod.CommandRegistry.IKeyBindingOptions
