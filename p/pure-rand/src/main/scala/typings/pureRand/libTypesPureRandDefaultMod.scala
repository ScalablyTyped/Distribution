...
object libTypesPureRandDefaultMod {
  
  @JSImport("pure-rand/lib/types/pure-rand-default", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("pure-rand/lib/types/pure-rand-default", "__commitHash")
  @js.native
  ...
  @JSImport("pure-rand/lib/types/pure-rand-default", "__type")
  @js.native
  ...
  @JSImport("pure-rand/lib/types/pure-rand-default", "__version")
  @js.native
