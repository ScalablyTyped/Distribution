...
class LargeObject protected () extends js.Object {
  ...
  def seek(
    ...
    ref: scala.Double,
    callback: js.Function2[/* error */ stdLib.Error, /* position */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  def seekAsync(position: scala.Double, ref: scala.Double): js.Promise[scala.Double] = js.native
  def size(callback: js.Function2[/* error */ stdLib.Error, /* size */ scala.Double, scala.Unit]): scala.Unit = js.native
  def sizeAsync(): js.Promise[scala.Double] = js.native
  def tell(callback: js.Function2[/* error */ stdLib.Error, /* position */ scala.Double, scala.Unit]): scala.Unit = js.native
  def tellAsync(): js.Promise[scala.Double] = js.native
  def truncate(length: scala.Double): scala.Unit = js.native
  def truncate(length: scala.Double, callback: js.Function1[/* error */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  def truncateAsync(length: scala.Double): js.Promise[_] = js.native
  def write(buffer: nodeLib.Buffer): scala.Unit = js.native
  def write(buffer: nodeLib.Buffer, callback: js.Function1[/* error */ stdLib.Error, scala.Unit]): scala.Unit = js.native
