...
class LargeObject protected () extends js.Object {
  ...
  def closeAsync(): stdLib.Promise[_] = js.native
  ...
  def readAsync(length: scala.Double): stdLib.Promise[nodeLib.Buffer] = js.native
  ...
  def truncateAsync(length: scala.Double): stdLib.Promise[_] = js.native
  ...
  def writeAsync(buffer: nodeLib.Buffer): stdLib.Promise[_] = js.native
}
