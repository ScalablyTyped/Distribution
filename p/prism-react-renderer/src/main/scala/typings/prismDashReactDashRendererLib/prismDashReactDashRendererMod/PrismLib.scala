...
trait PrismLib extends js.Object {
  ...
  def tokenize(code: java.lang.String, grammar: PrismGrammar, language: Language): js.Array[PrismToken] | js.Array[java.lang.String]
}
...
object PrismLib {
  ...
  def apply(
    ...
    tokenize: (java.lang.String, PrismGrammar, Language) => js.Array[PrismToken] | js.Array[java.lang.String]
  ): PrismLib = {
