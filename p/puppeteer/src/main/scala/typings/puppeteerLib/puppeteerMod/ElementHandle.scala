...
trait ElementHandle[E /* <: stdLib.Element */]
  ...
  /**
     ...
     */
  def boundingBox(): stdLib.Promise[BoundingBox | scala.Null] = js.native
  /**
     * This method returns boxes of the element, or null if the element is not visible.
     * Boxes are represented as an array of points; each Point is an object {x, y}. Box points are sorted clock-wise.
     */
  def boxModel(): stdLib.Promise[BoxModel | scala.Null] = js.native
  /**
     ...
     * @since 0.9.0
     */
  def click(): stdLib.Promise[scala.Unit] = js.native
  /**
     * This method scrolls element into view if needed, and then uses page.mouse to click in the center of the element.
     * If the element is detached from DOM, the method throws an error.
     * @param options Specifies the options.
     * @since 0.9.0
     */
  def click(options: ClickOptions): stdLib.Promise[scala.Unit] = js.native
  /**
     * @returns Resolves to the content frame for element handles referencing iframe nodes, or null otherwise.
     * @since 1.2.0
     */
  def contentFrame(): stdLib.Promise[Frame | scala.Null] = js.native
  /**
     * Calls focus on the element.
     */
  def focus(): stdLib.Promise[scala.Unit] = js.native
  /**
     * This method scrolls element into view if needed, and then uses page.mouse to hover over the center of the element.
     * If the element is detached from DOM, the method throws an error.
     */
  def hover(): stdLib.Promise[scala.Unit] = js.native
  /**
     * Resolves to true if the element is visible in the current viewport.
     */
  def isIntersectingViewport(): stdLib.Promise[scala.Boolean] = js.native
  /**
     ...
     */
  def press(key: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
     * Focuses the element, and then uses keyboard.down and keyboard.up.
     * @param key Name of key to press, such as ArrowLeft. See USKeyboardLayout for a list of all key names.
     * @param options The text and delay options.
     */
  def press(key: java.lang.String, options: puppeteerLib.Anon_TextDelay): stdLib.Promise[scala.Unit] = js.native
  /**
  ...
  /**
     ...
     * If the element is detached from DOM, the method throws an error.
     */
  def tap(): stdLib.Promise[scala.Unit] = js.native
  /**
     * Focuses the element, and then sends a keydown, keypress/input, and keyup event for each character in the text.
     * @param text A text to type into a focused element.
     * @param options The typing options.
     */
  def `type`(text: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  /**
     * Focuses the element, and then sends a keydown, keypress/input, and keyup event for each character in the text.
     * @param text A text to type into a focused element.
     * @param options The typing options.
     */
  def `type`(text: java.lang.String, options: puppeteerLib.Anon_DelayNumber): stdLib.Promise[scala.Unit] = js.native
  /**
     ...
     */
  def uploadFile(filePaths: java.lang.String*): stdLib.Promise[scala.Unit] = js.native
}
