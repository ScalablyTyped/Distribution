...
trait JSHandle extends js.Object {
  ...
  /**
     ...
     */
  def dispose(): stdLib.Promise[scala.Unit]
  /**
  ...
  /**
     ...
     */
  def getProperties(): stdLib.Promise[stdLib.Map[java.lang.String, JSHandle]]
  /**
     * Fetches a single property from the objectHandle.
     * @param propertyName The property to get.
     */
  def getProperty(propertyName: java.lang.String): stdLib.Promise[JSHandle]
  /**
     ...
     */
  def jsonValue(): stdLib.Promise[_]
}
