...
object puppeteerLibStrings {
  ...
  @js.native
  sealed trait DELETE
    extends puppeteerLib.puppeteerMod.HttpMethod
  ...
  @js.native
  sealed trait alert
    extends puppeteerLib.puppeteerMod.DialogType
  ...
  sealed trait other
    extends puppeteerLib.puppeteerMod.ResourceType
       with puppeteerLib.puppeteerMod.TargetType
  ...
  @js.native
  sealed trait print
    extends puppeteerLib.puppeteerMod.MediaType
