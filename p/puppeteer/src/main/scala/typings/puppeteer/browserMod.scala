...
object browserMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/api/Browser", "Browser")
  @js.native
  /**
    * @internal
    */
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/api/Browser", "BrowserContext")
  @js.native
  /**
    * @internal
    */
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/api/Browser", "WEB_PERMISSION_TO_PROTOCOL_PERMISSION")
  @js.native
