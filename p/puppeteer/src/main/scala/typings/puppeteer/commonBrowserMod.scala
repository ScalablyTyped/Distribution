...
import typings.puppeteer.browserMod.BrowserContext
...
object commonBrowserMod {
  
  @JSImport("puppeteer/lib/cjs/puppeteer/common/Browser", "CDPBrowser")
  @js.native
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/Browser", "CDPBrowserContext")
  @js.native
