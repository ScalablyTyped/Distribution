...
import typings.puppeteer.errorsMod.TimeoutError
...
object lifecycleWatcherMod {
  
  @JSImport("puppeteer/lib/cjs/puppeteer/common/LifecycleWatcher", "LifecycleWatcher")
  @js.native
