...
import typings.puppeteer.anon.RefererTimeout
...
import typings.puppeteer.commonIsolatedWorldMod.IsolatedWorldChart
...
object commonFrameMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/common/Frame", "Frame")
  @js.native
