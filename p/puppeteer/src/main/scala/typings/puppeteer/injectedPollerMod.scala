...
object injectedPollerMod {
  
  @JSImport("puppeteer/lib/esm/puppeteer/injected/Poller", "IntervalPoller")
  @js.native
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/injected/Poller", "MutationPoller")
  @js.native
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/injected/Poller", "RAFPoller")
  @js.native
