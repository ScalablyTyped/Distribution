...
import typings.puppeteer.commonFrameTreeMod.FrameTree
import typings.puppeteer.commonNetworkManagerMod.NetworkManager
import typings.puppeteer.commonTargetMod.Target
import typings.puppeteer.commonTimeoutSettingsMod.TimeoutSettings
...
object commonFrameManagerMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManager")
  @js.native
  ...
  object FrameManagerEmittedEvents {
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.ExecutionContextCreated")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.ExecutionContextDestroyed")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameAttached")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameDetached")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameNavigated")
    @js.native
    def FrameNavigated: js.Symbol = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameNavigatedWithinDocument")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.FrameSwapped")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/FrameManager", "FrameManagerEmittedEvents.LifecycleEvent")
    @js.native
