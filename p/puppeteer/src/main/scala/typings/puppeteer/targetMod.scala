...
import typings.puppeteer.taskQueueMod.TaskQueue
import typings.puppeteer.webWorkerMod.WebWorker
...
object targetMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/Target", "Target")
  @js.native
