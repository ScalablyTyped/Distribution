...
object connectionMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/bidi/Connection", "Connection")
  @js.native
  open class Connection protected () extends EventEmitter {
    ...
    def send(method: String, params: js.Object): js.Promise[
        /* import warning: importer.ImportType#apply Failed type conversion: puppeteer.puppeteer/lib/cjs/puppeteer/common/bidi/Connection.CommandResponse['result'] */ js.Any
      ] = js.native
  }
