...
import typings.puppeteer.Anon_Metrics
...
trait Page
  ...
  @JSName("on")
  def on_metrics(eventName: metrics, handler: js.Function2[/* e */ Anon_Metrics, /* repeated */ js.Any, Unit]): this.type = js.native
  @JSName("on")
  ...
  @JSName("once")
  def once_metrics(eventName: metrics, handler: js.Function2[/* e */ Anon_Metrics, /* repeated */ js.Any, Unit]): this.type = js.native
  @JSName("once")
