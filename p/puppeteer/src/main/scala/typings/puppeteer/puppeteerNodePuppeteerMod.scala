...
import typings.puppeteer.anon.projectRootstringundefineIsPuppeteerCore
import typings.puppeteer.apiBrowserMod.Browser
import typings.puppeteer.commonBrowserConnectorMod.BrowserConnectOptions
import typings.puppeteer.commonProductMod.Product
import typings.puppeteer.commonPuppeteerMod.Puppeteer
import typings.puppeteer.nodeBrowserFetcherMod.BrowserFetcher
import typings.puppeteer.nodeBrowserFetcherMod.BrowserFetcherOptions
import typings.puppeteer.nodeLaunchOptionsMod.BrowserLaunchArgumentOptions
...
object puppeteerNodePuppeteerMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/node/Puppeteer", "PuppeteerNode")
  @js.native
