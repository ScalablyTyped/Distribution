...
object utilErrorLikeMod {
  
  @JSImport("puppeteer/lib/esm/puppeteer/util/ErrorLike", JSImport.Namespace)
  @js.native
  ...
  inline def isErrorLike(obj: Any): /* is puppeteer.puppeteer/lib/esm/puppeteer/util/ErrorLike.ErrorLike */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isErrorLike")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is puppeteer.puppeteer/lib/esm/puppeteer/util/ErrorLike.ErrorLike */ Boolean]
