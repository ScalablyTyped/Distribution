...
object commonNetworkManagerMod {
  
  @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManager")
  @js.native
  ...
  object NetworkManagerEmittedEvents {
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManagerEmittedEvents.Request")
    @js.native
    val Request: js.Symbol = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManagerEmittedEvents.RequestFailed")
    @js.native
    val RequestFailed: js.Symbol = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManagerEmittedEvents.RequestFinished")
    @js.native
    val RequestFinished: js.Symbol = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManagerEmittedEvents.RequestServedFromCache")
    @js.native
    val RequestServedFromCache: js.Symbol = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/NetworkManager", "NetworkManagerEmittedEvents.Response")
    @js.native
