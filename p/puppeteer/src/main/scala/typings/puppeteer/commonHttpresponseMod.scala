...
import typings.puppeteer.commonHttprequestMod.HTTPRequest
import typings.puppeteer.commonSecurityDetailsMod.SecurityDetails
...
object commonHttpresponseMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/common/HTTPResponse", "HTTPResponse")
  @js.native
