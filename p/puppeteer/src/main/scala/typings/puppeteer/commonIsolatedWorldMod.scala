...
import typings.puppeteer.anon.ClickCount
import typings.puppeteer.anon.Delay
import typings.puppeteer.anon.Polling
import typings.puppeteer.anon.TimeoutWaitUntil
import typings.puppeteer.commonElementHandleMod.ElementHandle
import typings.puppeteer.commonExecutionContextMod.ExecutionContext
import typings.puppeteer.commonFrameMod.Frame
import typings.puppeteer.commonJshandleMod.JSHandle
import typings.puppeteer.commonTypesMod.EvaluateFunc
import typings.puppeteer.commonTypesMod.HandleFor
import typings.puppeteer.commonTypesMod.InnerLazyParams
import typings.puppeteer.commonTypesMod.NodeFor
import typings.puppeteer.commonWaitTaskMod.TaskManager
import typings.puppeteer.puppeteerInjectedInjectedMod.PuppeteerUtil
...
object commonIsolatedWorldMod {
  
  @JSImport("puppeteer/lib/esm/puppeteer/common/IsolatedWorld", "IsolatedWorld")
  @js.native
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/common/IsolatedWorld", "MAIN_WORLD")
  @js.native
  val MAIN_WORLD: js.Symbol = js.native
  
  @JSImport("puppeteer/lib/esm/puppeteer/common/IsolatedWorld", "PUPPETEER_WORLD")
  @js.native
