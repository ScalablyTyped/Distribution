...
import typings.puppeteer.anon.Emitter
import typings.puppeteer.anon.TypeofimportedFs
...
object utilMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/util", JSImport.Namespace)
  @js.native
