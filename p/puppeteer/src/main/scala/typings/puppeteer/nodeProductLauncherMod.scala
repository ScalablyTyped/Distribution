...
import typings.puppeteer.nodeChromeLauncherMod.ChromeLauncher
import typings.puppeteer.nodeFirefoxLauncherMod.FirefoxLauncher
...
import typings.puppeteer.nodeLaunchOptionsMod.PuppeteerNodeLaunchOptions
...
object nodeProductLauncherMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/node/ProductLauncher", JSImport.Namespace)
  @js.native
