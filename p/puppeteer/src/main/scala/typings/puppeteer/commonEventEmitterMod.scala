...
import typings.puppeteer.mittSrcMod.EventType
import typings.puppeteer.mittSrcMod.Handler
...
object commonEventEmitterMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/common/EventEmitter", "EventEmitter")
  @js.native
  /**
    * @internal
    */
