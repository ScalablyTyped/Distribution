...
import typings.puppeteer.commonTypesMod.HandleOr
...
object commonJshandleMod {
  ...
  - typings.puppeteer.commonTypesMod._HandleOr because Already inherited */ @JSImport("puppeteer/lib/esm/puppeteer/common/JSHandle", "JSHandle")
  @js.native
