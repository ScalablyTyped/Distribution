...
object commonPdfoptionsMod {
  ...
  /* Inlined std.Record<puppeteer.puppeteer/lib/esm/puppeteer/common/PDFOptions.LowerCasePaperFormat, puppeteer.puppeteer/lib/esm/puppeteer/common/PDFOptions.PaperFormatDimensions> */
  object paperFormats {
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a0")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a1")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a2")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a3")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a4")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a5")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.a6")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.ledger")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.legal")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.letter")
    @js.native
    ...
    @JSImport("puppeteer/lib/esm/puppeteer/common/PDFOptions", "_paperFormats.tabloid")
    @js.native
