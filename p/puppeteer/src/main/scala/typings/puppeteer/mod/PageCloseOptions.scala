...
object PageCloseOptions {
  ...
  implicit class PageCloseOptionsOps[Self <: PageCloseOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRunBeforeUnload(value: Boolean): Self = this.set("runBeforeUnload", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteRunBeforeUnload: Self = this.set("runBeforeUnload", js.undefined)
  }
