...
/**
  ...
  * @public
  */
trait Configuration2 extends StObject {
  ...
  /**
    ...
    * @defaultValue `'chrome'`
    */
  var defaultProduct: js.UndefOr[Product2] = js.undefined
  ...
  /**
    ...
    */
  var experiments: js.UndefOr[ExperimentsConfiguration2] = js.undefined
...
object Configuration2 {
  ...
  inline def apply(): Configuration2 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Configuration2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Configuration2] (val x: Self) extends AnyVal {
    ...
    inline def setDefaultProduct(value: Product2): Self = StObject.set(x, "defaultProduct", value.asInstanceOf[js.Any])
    ...
    inline def setExperiments(value: ExperimentsConfiguration2): Self = StObject.set(x, "experiments", value.asInstanceOf[js.Any])
