...
import typings.puppeteer.httprequestMod.HTTPRequest
import typings.puppeteer.securityDetailsMod.SecurityDetails
...
object httpresponseMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/HTTPResponse", "HTTPResponse")
  @js.native
