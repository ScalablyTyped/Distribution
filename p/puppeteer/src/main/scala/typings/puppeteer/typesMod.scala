...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.puppeteer.jshandleMod.JSHandle[T]
    - typings.puppeteer.elementHandleMod.ElementHandle[T]
  */
  trait HandleFor[T]
    extends StObject
       with _HandleOr[T]
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.puppeteer.typesMod.HandleFor[T]
    - typings.puppeteer.jshandleMod.JSHandle[T]
    - T
  */
  ...
  {[ K in keyof T ]: puppeteer.puppeteer/lib/cjs/puppeteer/common/types.FlattenLazyArg<T[K]>}
  ...
  {[ K in keyof T ]: puppeteer.puppeteer/lib/cjs/puppeteer/common/types.FlattenHandle<T[K]>}
