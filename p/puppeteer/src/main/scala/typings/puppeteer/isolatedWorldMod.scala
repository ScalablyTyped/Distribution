...
import typings.puppeteer.typesMod.InnerLazyParams
import typings.puppeteer.typesMod.NodeFor
import typings.puppeteer.waitTaskMod.TaskManager
...
object isolatedWorldMod {
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/IsolatedWorld", "IsolatedWorld")
  @js.native
  ...
  @JSImport("puppeteer/lib/cjs/puppeteer/common/IsolatedWorld", "MAIN_WORLD")
  @js.native
  val MAIN_WORLD: js.Symbol = js.native
  
  @JSImport("puppeteer/lib/cjs/puppeteer/common/IsolatedWorld", "PUPPETEER_WORLD")
  @js.native
