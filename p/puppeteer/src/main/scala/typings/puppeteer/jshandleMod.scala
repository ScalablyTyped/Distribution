...
import typings.puppeteer.typesMod.HandleOr
...
object jshandleMod {
  ...
  - typings.puppeteer.typesMod._HandleOr because Already inherited */ @JSImport("puppeteer/lib/cjs/puppeteer/common/JSHandle", "JSHandle")
  @js.native
