...
import typings.puppeteer.anon.PreferredRevision
import typings.puppeteer.anon.SlowMo
import typings.puppeteer.commonProductMod.Product
import typings.puppeteer.nodeLaunchOptionsMod.LaunchOptions
...
object nodeBrowserRunnerMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/node/BrowserRunner", "BrowserRunner")
  @js.native
  open class BrowserRunner protected () extends StObject {
    ...
    def setupWebDriverBiDiConnection(options: PreferredRevision): js.Promise[typings.puppeteer.bidiConnectionMod.Connection] = js.native
