...
trait UserAgentViewport extends StObject {
  ...
  var viewport: typings.puppeteer.mod.Viewport
}
object UserAgentViewport {
  
  inline def apply(userAgent: String, viewport: typings.puppeteer.mod.Viewport): UserAgentViewport = {
  ...
  extension [Self <: UserAgentViewport](x: Self) {
    ...
    inline def setViewport(value: typings.puppeteer.mod.Viewport): Self = StObject.set(x, "viewport", value.asInstanceOf[js.Any])
  }
}
