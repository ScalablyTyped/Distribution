...
/* Inlined puppeteer.puppeteer/lib/cjs/puppeteer/common/BrowserConnector.BrowserConnectOptions & {  browserWSEndpoint :string | undefined,   browserURL :string | undefined,   transport :puppeteer.puppeteer/lib/cjs/puppeteer/common/ConnectionTransport.ConnectionTransport | undefined} */
trait BrowserConnectOptionsbrow extends StObject {
  ...
  /**
    ...
    */
  var defaultViewport: js.UndefOr[typings.puppeteer.puppeteerViewportMod.Viewport | Null] = js.undefined
...
object BrowserConnectOptionsbrow {
  ...
  extension [Self <: BrowserConnectOptionsbrow](x: Self) {
    ...
    inline def setDefaultViewport(value: typings.puppeteer.puppeteerViewportMod.Viewport): Self = StObject.set(x, "defaultViewport", value.asInstanceOf[js.Any])
