...
import typings.puppeteer.textContentMod.TextContent
...
object injectedInjectedMod {
  ...
  /**
    * @internal
    */
  /* Inlined std.Readonly<{  createDeferredPromise :{None <T>(opts : puppeteer.puppeteer/lib/cjs/puppeteer/util/DeferredPromise.DeferredPromiseOptions | undefined): puppeteer.puppeteer/lib/cjs/puppeteer/util/DeferredPromise.DeferredPromise<T>}, createTextContent (root : std.Node): puppeteer.puppeteer/lib/cjs/puppeteer/injected/TextContent.TextContent,   IntervalPoller :new <T>(fn : (): std.Promise</ * import warning: RewrittenClass.unapply cls was tparam T * / any>, ms : number): puppeteer.puppeteer/lib/cjs/puppeteer/injected/Poller.IntervalPoller<T>, isSuitableNodeForTextMatching (node : std.Node): boolean,   MutationPoller :new <T>(fn : (): std.Promise</ * import warning: RewrittenClass.unapply cls was tparam T * / any>, root : std.Node): puppeteer.puppeteer/lib/cjs/puppeteer/injected/Poller.MutationPoller<T>,   RAFPoller :new <T>(fn : (): std.Promise</ * import warning: RewrittenClass.unapply cls was tparam T * / any>): puppeteer.puppeteer/lib/cjs/puppeteer/injected/Poller.RAFPoller<T>, pierceQuerySelector (root : std.Node, selector : string): std.Element | null, pierceQuerySelectorAll (element : std.Node, selector : string): std.Array<std.Element>, xpathQuerySelector (root : std.Node, selector : string): std.Node | null, xpathQuerySelectorAll (root : std.Node, selector : string): std.Array<std.Node>, textQuerySelector (root : std.Node, selector : string): std.Element | null, textQuerySelectorAll (root : std.Node, selector : string): std.Array<std.Element>, createFunction (functionValue : string): (args : ...unknown): unknown, checkVisibility (node : std.Node | null, visible : boolean | undefined): boolean | std.Node}> */
  object default {
    
    @JSImport("puppeteer/lib/cjs/puppeteer/injected/injected", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer/lib/cjs/puppeteer/injected/injected", "default.IntervalPoller")
    @js.native
    open class IntervalPoller[T] protected ()
      extends typings.puppeteer.pollerMod.IntervalPoller[T] {
      def this(
    ...
    val IntervalPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* ms */ Double, 
        typings.puppeteer.pollerMod.IntervalPoller[js.Object]
      ] = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer/lib/cjs/puppeteer/injected/injected", "default.MutationPoller")
    @js.native
    open class MutationPoller[T] protected ()
      extends typings.puppeteer.pollerMod.MutationPoller[T] {
      def this(
        fn: js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]],
        root: Node
      ) = this()
    ...
    val MutationPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* root */ Node, 
        typings.puppeteer.pollerMod.MutationPoller[js.Object]
      ] = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer/lib/cjs/puppeteer/injected/injected", "default.RAFPoller")
    @js.native
    open class RAFPoller[T] protected ()
      extends typings.puppeteer.pollerMod.RAFPoller[T] {
    ...
    val RAFPoller: Instantiable1[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        typings.puppeteer.pollerMod.RAFPoller[js.Object]
      ] = js.native
