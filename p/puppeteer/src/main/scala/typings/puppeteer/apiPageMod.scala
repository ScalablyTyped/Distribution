...
import typings.puppeteer.anon.Title
import typings.puppeteer.anon.Viewport
import typings.puppeteer.anon.WaitForOptionsrefererstriReferer
import typings.puppeteer.apiBrowserMod.Browser
import typings.puppeteer.apiBrowserMod.BrowserContext
import typings.puppeteer.commonAccessibilityMod.Accessibility
import typings.puppeteer.commonConsoleMessageMod.ConsoleMessage
import typings.puppeteer.commonCoverageMod.Coverage
import typings.puppeteer.commonDialogMod.Dialog
import typings.puppeteer.commonElementHandleMod.ElementHandle
import typings.puppeteer.commonEventEmitterMod.EventEmitter
import typings.puppeteer.commonFileChooserMod.FileChooser
import typings.puppeteer.commonFrameMod.Frame
import typings.puppeteer.commonFrameMod.FrameAddScriptTagOptions
import typings.puppeteer.commonFrameMod.FrameAddStyleTagOptions
import typings.puppeteer.commonFrameMod.FrameWaitForFunctionOptions
import typings.puppeteer.commonHttprequestMod.HTTPRequest
import typings.puppeteer.commonHttpresponseMod.HTTPResponse
import typings.puppeteer.commonInputMod.Keyboard
import typings.puppeteer.commonInputMod.Mouse
import typings.puppeteer.commonInputMod.Touchscreen
...
import typings.puppeteer.commonNetworkManagerMod.Credentials
import typings.puppeteer.commonNetworkManagerMod.NetworkConditions
import typings.puppeteer.commonPdfoptionsMod.PDFOptions
import typings.puppeteer.commonTargetMod.Target
import typings.puppeteer.commonTracingMod.Tracing
...
object apiPageMod {
  ...
  @JSImport("puppeteer/lib/esm/puppeteer/api/Page", "Page")
  @js.native
  /**
    * @internal
    */
  open class Page () extends EventEmitter {
    ...
    /**
      ...
      */
    def setViewport(viewport: typings.puppeteer.commonPuppeteerViewportMod.Viewport): js.Promise[Unit] = js.native
    ...
    /**
      ...
      *   `false`.
      */
    def viewport(): typings.puppeteer.commonPuppeteerViewportMod.Viewport | Null = js.native
