...
object puppeteerStrings {
  ...
  sealed trait ^
    extends StObject
       with KeyInput
       with typings.puppeteer.mod.KeyInput
       with typings.puppeteer.commonUskeyboardlayoutMod.KeyInput
  ...
  - typings.puppeteer.commonUskeyboardlayoutMod.KeyInput because Already inherited
  - typings.puppeteer.mod.KeyInput because Already inherited
  - typings.puppeteer.uskeyboardlayoutMod.KeyInput because Already inherited */ @js.native
