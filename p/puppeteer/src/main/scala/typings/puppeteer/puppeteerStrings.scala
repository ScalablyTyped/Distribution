...
import typings.puppeteer.mod.BrowserContextEmittedEvents
import typings.puppeteer.mod.BrowserEmittedEvents
...
object puppeteerStrings {
  ...
  - typings.puppeteer.mod._KeyInput because Already inherited */ @js.native
  sealed trait Comma
    extends StObject
       with _KeyInput
