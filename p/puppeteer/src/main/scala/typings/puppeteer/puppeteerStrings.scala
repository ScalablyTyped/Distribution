...
import typings.puppeteer.mod.DialogType
import typings.puppeteer.mod.ErrorCode
import typings.puppeteer.mod.HttpMethod
import typings.puppeteer.mod.LoadEvent
import typings.puppeteer.mod.MediaType
import typings.puppeteer.mod.MouseButtons
import typings.puppeteer.mod.PDFFormat
import typings.puppeteer.mod.Permission
import typings.puppeteer.mod.Platform
import typings.puppeteer.mod.Product_
import typings.puppeteer.mod.ResourceType
import typings.puppeteer.mod.SameSiteSetting
import typings.puppeteer.mod.TargetType
...
object puppeteerStrings {
  ...
  @js.native
  sealed trait pageerror extends StObject
  ...
  @js.native
  sealed trait requestfailed extends StObject
  inline def requestfailed: requestfailed = "requestfailed".asInstanceOf[requestfailed]
  
  @js.native
  sealed trait requestfinished extends StObject
  ...
  @js.native
  sealed trait targetchanged extends StObject
  ...
  @js.native
  sealed trait workercreated extends StObject
  inline def workercreated: workercreated = "workercreated".asInstanceOf[workercreated]
  
  @js.native
  sealed trait workerdestroyed extends StObject
