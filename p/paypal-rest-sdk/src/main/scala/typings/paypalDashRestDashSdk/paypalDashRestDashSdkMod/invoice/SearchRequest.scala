...
object SearchRequest {
  ...
  def apply(
    ...
    if (end_creation_date != null) __obj.updateDynamic("end_creation_date")(end_creation_date)
    if (end_due_date != null) __obj.updateDynamic("end_due_date")(end_due_date)
    if (end_invoice_date != null) __obj.updateDynamic("end_invoice_date")(end_invoice_date)
    if (end_payment_date != null) __obj.updateDynamic("end_payment_date")(end_payment_date)
    if (lower_total_amount != null) __obj.updateDynamic("lower_total_amount")(lower_total_amount)
    if (number != null) __obj.updateDynamic("number")(number)
    if (page != null) __obj.updateDynamic("page")(page.asInstanceOf[js.Any])
    if (page_size != null) __obj.updateDynamic("page_size")(page_size.asInstanceOf[js.Any])
    if (recipient_business_name != null) __obj.updateDynamic("recipient_business_name")(recipient_business_name)
    if (recipient_first_name != null) __obj.updateDynamic("recipient_first_name")(recipient_first_name)
    if (recipient_last_name != null) __obj.updateDynamic("recipient_last_name")(recipient_last_name)
    if (start_creation_date != null) __obj.updateDynamic("start_creation_date")(start_creation_date)
    if (start_due_date != null) __obj.updateDynamic("start_due_date")(start_due_date)
    if (start_invoice_date != null) __obj.updateDynamic("start_invoice_date")(start_invoice_date)
    if (start_payment_date != null) __obj.updateDynamic("start_payment_date")(start_payment_date)
    if (status != null) __obj.updateDynamic("status")(status)
    if (!js.isUndefined(total_count_required)) __obj.updateDynamic("total_count_required")(total_count_required)
    if (upper_total_amount != null) __obj.updateDynamic("upper_total_amount")(upper_total_amount)
