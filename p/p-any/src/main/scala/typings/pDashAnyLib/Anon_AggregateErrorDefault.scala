...
@js.native
trait Anon_AggregateErrorDefault extends js.Object {
  ...
  /**
  	 ...
  	 */
  // TODO: Remove this for the next major release
  def default[ValueType](input: stdLib.Iterable[pDashAnyLib.pDashAnyMod.pAnyNs.Value[ValueType]]): pDashAnyLib.pDashAnyMod.pAnyNs.CancelablePromise[ValueType] = js.native
