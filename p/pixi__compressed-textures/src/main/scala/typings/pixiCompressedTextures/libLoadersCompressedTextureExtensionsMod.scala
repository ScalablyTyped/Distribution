...
object libLoadersCompressedTextureExtensionsMod {
  
  /* keyof @pixi/compressed-textures.@pixi/compressed-textures/lib/loaders/compressedTextureExtensions.CompressedTextureExtensions */ /* Rewritten from type alias, can be one of: 
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.s3tc
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.s3tc_sRGB
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.etc
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.etc1
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.pvrtc
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.atc
    - typings.pixiCompressedTextures.pixiCompressedTexturesStrings.astc
  */
  trait CompressedTextureExtensionRef extends StObject
