...
trait PopupService extends js.Object {
  ...
  /**
  			 ...
  			 */
  def createPopup(props: typings.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup): Unit
  /**
  ...
  def updatePopup(
    name: String,
    newProps: typings.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup
  ): Unit
}
...
object PopupService {
  ...
  def apply(
    ...
    createPopup: typings.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup => Unit,
    deletePopup: String => Unit,
    getPopupsId: () => String,
    openPopup: String => Unit,
    setPopupsId: String => Unit,
    updatePopup: (String, typings.powerappsDashComponentDashFramework.ComponentFramework.FactoryApi.Popup.Popup) => Unit
  ): PopupService = {
