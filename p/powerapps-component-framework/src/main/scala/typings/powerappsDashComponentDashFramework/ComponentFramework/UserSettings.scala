...
import typings.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi.DateFormattingInfo
import typings.powerappsDashComponentDashFramework.ComponentFramework.UserSettingApi.NumberFormattingInfo
