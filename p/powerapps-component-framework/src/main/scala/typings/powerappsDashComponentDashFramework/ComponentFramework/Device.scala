...
import typings.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.CaptureImageOptions
import typings.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.PickFileOptions
import typings.powerappsDashComponentDashFramework.ComponentFramework.DeviceApi.Position
