...
import typings.powerappsDashComponentDashFramework.ComponentFramework.WebApi.Entity
import typings.powerappsDashComponentDashFramework.ComponentFramework.WebApi.RetrieveMultipleResponse
