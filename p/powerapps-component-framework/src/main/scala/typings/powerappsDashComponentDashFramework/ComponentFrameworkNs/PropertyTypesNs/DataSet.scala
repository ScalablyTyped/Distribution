...
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.Column
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.EntityRecord
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.Filtering
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.Linking
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.Paging
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.PropertyHelperNs.DataSetApiNs.SortStatus
