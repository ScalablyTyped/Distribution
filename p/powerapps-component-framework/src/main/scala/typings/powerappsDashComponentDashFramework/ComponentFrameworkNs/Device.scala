...
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.DeviceApiNs.CaptureImageOptions
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.DeviceApiNs.PickFileOptions
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.DeviceApiNs.Position
