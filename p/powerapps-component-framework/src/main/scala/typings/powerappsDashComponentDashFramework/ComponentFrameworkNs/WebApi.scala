...
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.WebApiNs.Entity
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.WebApiNs.RetrieveMultipleResponse
