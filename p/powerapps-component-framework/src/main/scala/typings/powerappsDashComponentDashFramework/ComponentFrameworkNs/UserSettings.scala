...
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.UserSettingApiNs.DateFormattingInfo
import typings.powerappsDashComponentDashFramework.ComponentFrameworkNs.UserSettingApiNs.NumberFormattingInfo
