...
trait EntityRecord extends js.Object {
  ...
  /**
  				 ...
  				 * @param columnName Column name of the record
  				 */
  def getValue(columnName: java.lang.String): java.lang.String | stdLib.Date | scala.Double | js.Array[scala.Double] | scala.Boolean | powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.EntityReference | js.Array[powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.EntityReference]
}
...
object EntityRecord {
  ...
  def apply(
    ...
    getValue: java.lang.String => java.lang.String | stdLib.Date | scala.Double | js.Array[scala.Double] | scala.Boolean | powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.EntityReference | js.Array[powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.EntityReference]
  ): EntityRecord = {
