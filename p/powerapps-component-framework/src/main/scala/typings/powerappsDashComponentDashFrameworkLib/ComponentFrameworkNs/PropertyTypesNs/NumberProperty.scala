...
trait NumberProperty extends Property {
  var attributes: js.UndefOr[
    powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.PropertyHelperNs.FieldPropertyMetadataNs.NumberMetadata
  ] = js.undefined
  @JSName("raw")
  var raw_NumberProperty: scala.Double
}
...
object NumberProperty {
  ...
  def apply(
    ...
    attributes: powerappsDashComponentDashFrameworkLib.ComponentFrameworkNs.PropertyHelperNs.FieldPropertyMetadataNs.NumberMetadata = null,
