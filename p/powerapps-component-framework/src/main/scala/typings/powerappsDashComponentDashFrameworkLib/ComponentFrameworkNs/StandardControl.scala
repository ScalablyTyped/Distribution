...
trait StandardControl[TInputs, TOutputs] extends js.Object {
  ...
  /**
  		 ...
  		 */
  def init(context: Context[TInputs]): scala.Unit = js.native
  def init(context: Context[TInputs], notifyOutputChanged: js.Function0[scala.Unit]): scala.Unit = js.native
  def init(context: Context[TInputs], notifyOutputChanged: js.Function0[scala.Unit], state: Dictionary): scala.Unit = js.native
  def init(
    context: Context[TInputs],
    notifyOutputChanged: js.Function0[scala.Unit],
    state: Dictionary,
  ...
  /**
  		 ...
  		 */
  def updateView(context: Context[TInputs]): scala.Unit = js.native
}
