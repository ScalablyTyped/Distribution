...
version := "1.0-dt-20180214Z-e8aef9"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-9da921",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-bb2fae",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.0-33463a",
