...
version := "1.0-dt-20190212Z-ccb2a1"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-227835",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-003181",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.1-0e1f09",
