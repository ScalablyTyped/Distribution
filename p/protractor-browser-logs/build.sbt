...
version := "1.0-dt-20180214Z-959710"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-884c45",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-896ded",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.1-11ece0",
