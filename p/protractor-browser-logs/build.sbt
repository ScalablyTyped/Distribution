...
version := "1.0-dt-20190312Z-e5143a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-3b6a11",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-5027c2",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.1-3785a2",
