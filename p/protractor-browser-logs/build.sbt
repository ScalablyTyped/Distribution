...
version := "1.0-dt-20180910Z-6c6529"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "blocking-proxy" % "1.0.1-7d68f3",
  ...
  "com.scalablytyped" %%% "protractor" % "5.4.1-fdf9d2",
  ...
  "com.scalablytyped" %%% "webdriver-manager" % "12.1.0-0978fd",
