...
version := "1.0-dt-20180214Z-ae92ee"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-254082",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-668209",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.1-6f0a9d",
