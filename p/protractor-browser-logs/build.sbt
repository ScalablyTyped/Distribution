...
version := "1.0-dt-20190212Z-de5316"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "blocking-proxy" % "1.0.1-0e9330",
  ...
  "org.scalablytyped" %%% "protractor" % "5.4.2-82576b",
  ...
  "org.scalablytyped" %%% "webdriver-manager" % "12.1.1-15764f",
