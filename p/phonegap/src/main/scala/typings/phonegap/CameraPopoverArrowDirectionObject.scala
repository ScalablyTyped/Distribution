...
object CameraPopoverArrowDirectionObject {
  ...
  inline def apply(ARROW_ANY: Double, ARROW_DOWN: Double, ARROW_LEFT: Double, ARROW_RIGHT: Double, ARROW_UP: Double): CameraPopoverArrowDirectionObject = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CameraPopoverArrowDirectionObject] (val x: Self) extends AnyVal {
