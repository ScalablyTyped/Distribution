...
trait PhonegapNotification extends StObject {
  ...
  def alert(message: String, alertCallback: js.Function, title: Unit, buttonName: String): Unit = js.native
  ...
  def confirm(message: String, confirmCallback: js.Function, title: Unit, buttonLabels: String): Unit = js.native
  def confirm(message: String, confirmCallback: js.Function, title: Unit, buttonLabels: js.Array[String]): Unit = js.native
