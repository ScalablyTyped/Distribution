package typings.promiseDashFtp

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object promiseDashFtpStrings {
  @js.native
  ...
  @js.native
  sealed trait `Connection closed, transfer aborted` extends js.Object
  ...
  @js.native
  sealed trait `Requested action aborted: local error in processing` extends js.Object
  
  @js.native
  sealed trait `Requested action aborted: page type unknown` extends js.Object
  
  @js.native
  sealed trait `Requested action not taken / File name not allowed` extends js.Object
  
  @js.native
  sealed trait `Requested action not taken / File unavailable (eDOTgDOT, file not found, no access)` extends js.Object
  
  @js.native
  sealed trait `Requested action not taken / Insufficient storage space in system` extends js.Object
  
  @js.native
  sealed trait `Requested file action aborted / Exceeded storage allocation (for current directory or dataset)` extends js.Object
  
  @js.native
  sealed trait `Requested file action not taken / File unavailable (eDOTgDOT, file busy)` extends js.Object
  
  @js.native
  sealed trait `Service not available, closing control connection` extends js.Object
  
  @js.native
  sealed trait `Syntax error / Command unrecognized` extends js.Object
