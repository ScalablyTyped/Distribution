...
object mod {
  ...
  inline def apply[T, U](promise: Promise[T], onFinally: js.Function0[U | js.Thenable[U]]): Promise[T] = (^.asInstanceOf[js.Dynamic].apply(promise.asInstanceOf[js.Any], onFinally.asInstanceOf[js.Any])).asInstanceOf[Promise[T]]
