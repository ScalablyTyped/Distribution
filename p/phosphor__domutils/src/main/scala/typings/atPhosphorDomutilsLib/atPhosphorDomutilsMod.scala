...
object atPhosphorDomutilsMod extends js.Object {
  ...
  object ElementExtNs extends js.Object {
    /**
      ...
      */
    def boxSizing(element: stdLib.Element): atPhosphorDomutilsLib.libElementMod.ElementExtNs.IBoxSizing = js.native
    /**
    ...
    /**
      ...
      */
    def sizeLimits(element: stdLib.Element): atPhosphorDomutilsLib.libElementMod.ElementExtNs.ISizeLimits = js.native
  }
  ...
  object PlatformNs extends js.Object {
    /**
      ...
      */
    val IS_EDGE: scala.Boolean = js.native
    /**
      * A flag indicating whether the browser is IE.
      */
    val IS_IE: scala.Boolean = js.native
    /**
      * A flag indicating whether the platform is Mac.
      */
    val IS_MAC: scala.Boolean = js.native
    /**
      * A flag indicating whether the platform is Windows.
      */
    val IS_WIN: scala.Boolean = js.native
  }
  ...
  object SelectorNs extends js.Object {
    /**
      ...
      */
    def calculateSpecificity(selector: java.lang.String): scala.Double = js.native
    /**
      ...
      */
    def isValid(selector: java.lang.String): scala.Boolean = js.native
    /**
