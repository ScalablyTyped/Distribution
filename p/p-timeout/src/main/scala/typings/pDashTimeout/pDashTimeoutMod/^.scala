...
import typings.pDashTimeout.Anon_Default
...
object ^ extends js.Object {
  ...
  /**
  	...
  	*/
  // TODO: Remove this for the next major release
  def default[ValueType](input: js.Thenable[ValueType], milliseconds: Double): js.Promise[ValueType] = js.native
  def default[ValueType](input: js.Thenable[ValueType], milliseconds: Double, message: String): js.Promise[ValueType] = js.native
  def default[ValueType](input: js.Thenable[ValueType], milliseconds: Double, message: Error): js.Promise[ValueType] = js.native
  /**
  	Timeout a promise after a specified amount of time.
  	If you pass in a cancelable promise, specifically a promise with a `.cancel()` method, that method will be called when the `pTimeout` promise times out.
  	@param input - Promise to decorate.
