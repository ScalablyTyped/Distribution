...
object CommonBase {
  ...
  def apply(
    is: String,
    $: js.Any = null,
    DollarDollar: /* selector */ String => Element = null,
    ...
    attributeChangedCallback: (/* attributeName */ String, /* oldValue */ String | Null, /* newValue */ String | Null, /* namespace */ String | Null) => Unit = null,
    ...
    if (DollarDollar != null) __obj.updateDynamic("$$")(js.Any.fromFunction1(DollarDollar))
    ...
    if (attributeChangedCallback != null) __obj.updateDynamic("attributeChangedCallback")(js.Any.fromFunction4(attributeChangedCallback))
    ...
    if (hostAttributes != null) __obj.updateDynamic("hostAttributes")(hostAttributes.asInstanceOf[js.Any])
