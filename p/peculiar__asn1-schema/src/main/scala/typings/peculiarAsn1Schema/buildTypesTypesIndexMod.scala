...
object buildTypesTypesIndexMod {
  ...
  open class BitString[T /* <: Double */] ()
    extends typings.peculiarAsn1Schema.buildTypesTypesBitStringMod.BitString[T] {
  ...
  open class OctetString ()
    extends typings.peculiarAsn1Schema.buildTypesTypesOctetStringMod.OctetString {
