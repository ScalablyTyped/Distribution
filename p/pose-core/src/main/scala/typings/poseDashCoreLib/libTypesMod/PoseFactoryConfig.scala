...
trait PoseFactoryConfig[V, A, C, P, TD] extends js.Object {
  ...
  var defaultTransitions: js.UndefOr[stdLib.Map[java.lang.String, TransitionMap[A, TD]]] = js.native
  @JSName("extendAPI")
  ...
  def addActionDelay(delay: scala.Double, transition: A): A = js.native
  def bindOnChange(values: ValueMap[V], onChange: OnChangeCallbacks): js.Function1[/* key */ java.lang.String, _] = js.native
  def convertTransitionDefinition(value: V, transitionDef: A | TD, props: Props): A = js.native
  def convertValue(value: js.Any, key: java.lang.String, props: Props): V = js.native
  def createValue(init: js.Any, key: java.lang.String, props: Props): V = js.native
  def createValue(init: js.Any, key: java.lang.String, props: Props, createValueProps: CreateValueProps): V = js.native
  ...
  def getTransitionProps(value: V, target: scala.Double, props: Props): Props = js.native
  ...
  def setValue(v: V, value: js.Any): scala.Unit = js.native
  def setValueNative(key: java.lang.String, value: js.Any, props: Props): scala.Unit = js.native
