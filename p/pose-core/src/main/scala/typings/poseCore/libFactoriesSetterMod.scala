...
import typings.poseCore.libTypesMod.AddTransitionDelay
import typings.poseCore.libTypesMod.ConvertTransitionDefinition
import typings.poseCore.libTypesMod.GetInstantTransition
import typings.poseCore.libTypesMod.GetTransitionProps
import typings.poseCore.libTypesMod.Pose
import typings.poseCore.libTypesMod.PoseMap
import typings.poseCore.libTypesMod.PoserState
import typings.poseCore.libTypesMod.Props
import typings.poseCore.libTypesMod.ResolveTarget
import typings.poseCore.libTypesMod.SetValue
import typings.poseCore.libTypesMod.SetValueNative
import typings.poseCore.libTypesMod.StartAction
import typings.poseCore.libTypesMod.StopAction
