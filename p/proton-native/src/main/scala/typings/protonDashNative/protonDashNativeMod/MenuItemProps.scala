...
import typings.protonDashNative.protonDashNativeStrings.About
import typings.protonDashNative.protonDashNativeStrings.Check
import typings.protonDashNative.protonDashNativeStrings.Item
import typings.protonDashNative.protonDashNativeStrings.Preferences
import typings.protonDashNative.protonDashNativeStrings.Quit
...
trait MenuItemProps extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    Check | Quit | About | Preferences | typings.protonDashNative.protonDashNativeStrings.Separator | Item
  ] = js.undefined
}
...
object MenuItemProps {
  ...
  def apply(
    ...
    `type`: Check | Quit | About | Preferences | typings.protonDashNative.protonDashNativeStrings.Separator | Item = null
  ): MenuItemProps = {
