...
object mod {
  ...
  object Icons {
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("plotly.js-basic-dist-min", "Icons.3d_rotate")
    @js.native
    val `3dRotate`: Icon = js.native
    
    @JSImport("plotly.js-basic-dist-min", "Icons.autoscale")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.camera")
    @js.native
    def camera: Icon = js.native
    
    @JSImport("plotly.js-basic-dist-min", "Icons.camera-retro")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.drawclosedpath")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.drawline")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.drawopenpath")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.drawrect")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.eraseshape")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.plotlylogo")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.question")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.selectbox")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.spikeline")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.tooltip_basic")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.tooltip_compare")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.zoom_plus")
    @js.native
    ...
    @JSImport("plotly.js-basic-dist-min", "Icons.zoombox")
    @js.native
