...
object libLoaderParsersMod {
  
  @JSImport("@pixi/assets/lib/loader/parsers", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@pixi/assets/lib/loader/parsers", "LoaderParserPriority")
  @js.native
  ...
  @JSImport("@pixi/assets/lib/loader/parsers", "loadJson")
  @js.native
  val loadJson: LoaderParser[Any, Any, Record[String, Any]] = js.native
  
  @JSImport("@pixi/assets/lib/loader/parsers", "loadSVG")
  @js.native
