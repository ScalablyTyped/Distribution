...
object otherRecipientInfoMod {
  ...
  object OtherRecipientInfo {
    ...
    extension [Self <: OtherRecipientInfo](x: Self) {
      ...
      inline def setOriValue(value: js.Any): Self = StObject.set(x, "oriValue", value.asInstanceOf[js.Any])
