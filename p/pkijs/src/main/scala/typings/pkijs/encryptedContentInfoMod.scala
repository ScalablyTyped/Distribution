...
object encryptedContentInfoMod {
  ...
  object EncryptedContentInfo {
    ...
    extension [Self <: EncryptedContentInfo](x: Self) {
      ...
      inline def setContentEncryptionAlgorithm(value: typings.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "contentEncryptionAlgorithm", value.asInstanceOf[js.Any])
