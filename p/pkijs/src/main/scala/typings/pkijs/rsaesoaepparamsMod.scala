...
object rsaesoaepparamsMod {
  ...
  object RSAESOAEPParams {
    ...
    extension [Self <: RSAESOAEPParams](x: Self) {
      ...
      inline def setPSourceAlgorithm(value: typings.pkijs.algorithmIdentifierMod.default): Self = StObject.set(x, "pSourceAlgorithm", value.asInstanceOf[js.Any])
