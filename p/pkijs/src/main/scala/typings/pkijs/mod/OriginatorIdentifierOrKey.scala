...
/**
  ...
  */
@JSImport("pkijs", "OriginatorIdentifierOrKey")
@js.native
/**
  * Initializes a new instance of the {@link OriginatorIdentifierOrKey} class
  * @param parameters Initialization parameters
  */
open class OriginatorIdentifierOrKey ()
  extends PkiObject
     with IOriginatorIdentifierOrKey {
  def this(parameters: OriginatorIdentifierOrKeyParameters) = this()
...
object OriginatorIdentifierOrKey {
  ...
  /* static member */
  @JSImport("pkijs", "OriginatorIdentifierOrKey.CLASS_NAME")
  @js.native
  ...
  inline def schema(parameters: OriginatorIdentifierOrKeySchema): SchemaType = ^.asInstanceOf[js.Dynamic].applyDynamic("schema")(parameters.asInstanceOf[js.Any]).asInstanceOf[SchemaType]
}
