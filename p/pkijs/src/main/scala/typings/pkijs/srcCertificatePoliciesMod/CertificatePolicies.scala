...
trait CertificatePolicies extends js.Object {
  var certificatePolicies: js.Array[typings.pkijs.srcPolicyInformationMod.default]
...
object CertificatePolicies {
  @scala.inline
  def apply(
    certificatePolicies: js.Array[typings.pkijs.srcPolicyInformationMod.default],
