...
class default () extends RevokedCertificate {
  ...
  /* CompleteClass */
  override var crlEntryExtensions: typings.pkijs.srcExtensionsMod.default = js.native
  /* CompleteClass */
  override var revocationDate: typings.pkijs.srcTimeMod.default = js.native
  /* CompleteClass */
