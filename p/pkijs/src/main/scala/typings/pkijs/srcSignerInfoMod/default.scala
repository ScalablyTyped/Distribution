...
class default () extends SignerInfo {
  ...
  /* CompleteClass */
  override var digestAlgorithm: typings.pkijs.srcAlgorithmIdentifierMod.default = js.native
  /* CompleteClass */
  override var sid: js.Any = js.native
  /* CompleteClass */
  override var signature: OctetString = js.native
  /* CompleteClass */
  override var signatureAlgorithm: typings.pkijs.srcAlgorithmIdentifierMod.default = js.native
  /* CompleteClass */
