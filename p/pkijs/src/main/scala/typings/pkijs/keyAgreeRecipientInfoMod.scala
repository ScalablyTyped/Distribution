...
object keyAgreeRecipientInfoMod {
  ...
  object KeyAgreeRecipientInfo {
    ...
    extension [Self <: KeyAgreeRecipientInfo](x: Self) {
      ...
      inline def setOriginator(value: typings.pkijs.originatorIdentifierOrKeyMod.default): Self = StObject.set(x, "originator", value.asInstanceOf[js.Any])
      ...
      inline def setRecipientEncryptedKeys(value: typings.pkijs.recipientEncryptedKeysMod.default): Self = StObject.set(x, "recipientEncryptedKeys", value.asInstanceOf[js.Any])
