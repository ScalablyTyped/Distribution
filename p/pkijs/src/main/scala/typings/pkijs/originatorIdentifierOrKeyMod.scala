...
object originatorIdentifierOrKeyMod {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("pkijs/src/OriginatorIdentifierOrKey", "default.compareWithDefault")
    @js.native
    def compareWithDefault(memberName: String, memberValue: js.Any): Boolean = js.native
    
    @JSImport("pkijs/src/OriginatorIdentifierOrKey", "default.defaultValues")
    @js.native
    def defaultValues(memberName: String): js.Any = js.native
    
    @JSImport("pkijs/src/OriginatorIdentifierOrKey", "default.schema")
    @js.native
  ...
  object OriginatorIdentifierOrKey {
    ...
    @scala.inline
    implicit class OriginatorIdentifierOrKeyMutableBuilder[Self <: OriginatorIdentifierOrKey] (val x: Self) extends AnyVal {
