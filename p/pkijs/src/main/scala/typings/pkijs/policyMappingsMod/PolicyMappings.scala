...
object PolicyMappings {
  ...
  implicit class PolicyMappingsOps[Self <: PolicyMappings] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMappingsVarargs(value: typings.pkijs.policyMappingMod.default*): Self = this.set("mappings", js.Array(value :_*))
    @scala.inline
    def setMappings(value: js.Array[typings.pkijs.policyMappingMod.default]): Self = this.set("mappings", value.asInstanceOf[js.Any])
    @scala.inline
