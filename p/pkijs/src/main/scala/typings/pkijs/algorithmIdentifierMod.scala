...
object algorithmIdentifierMod {
  ...
  object AlgorithmIdentifier {
    ...
    extension [Self <: AlgorithmIdentifier](x: Self) {
      ...
      inline def setAlgorithmParams(value: js.Any): Self = StObject.set(x, "algorithmParams", value.asInstanceOf[js.Any])
      
      inline def setFromSchema(value: js.Any => Unit): Self = StObject.set(x, "fromSchema", js.Any.fromFunction1(value))
      
      inline def setIsEqual(value: AlgorithmIdentifier => Boolean): Self = StObject.set(x, "isEqual", js.Any.fromFunction1(value))
