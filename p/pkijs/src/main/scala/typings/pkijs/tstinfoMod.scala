...
object tstinfoMod {
  ...
  object TSTInfo {
    ...
    extension [Self <: TSTInfo](x: Self) {
      
      inline def setAccuracy(value: typings.pkijs.accuracyMod.default): Self = StObject.set(x, "accuracy", value.asInstanceOf[js.Any])
      ...
      inline def setGenTime(value: Date): Self = StObject.set(x, "genTime", value.asInstanceOf[js.Any])
      ...
      inline def setTsa(value: typings.pkijs.generalNameMod.default): Self = StObject.set(x, "tsa", value.asInstanceOf[js.Any])
      
      inline def setTsaUndefined: Self = StObject.set(x, "tsa", js.undefined)
      
      inline def setVerify(value: VerifyParams => js.Thenable[Boolean]): Self = StObject.set(x, "verify", js.Any.fromFunction1(value))
  ...
  object VerifyParams {
    ...
    inline def apply(data: BufferSource): VerifyParams = {
