...
class default () extends SingleResponse {
  ...
  /* CompleteClass */
  override var certID: pkijsLib.srcCertIDMod.default = js.native
  /* CompleteClass */
  override var certStatus: js.Any = js.native
  /* CompleteClass */
  override var singleExtensions: js.Array[pkijsLib.srcExtensionMod.default] = js.native
  /* CompleteClass */
  override var thisUpdate: stdLib.Date = js.native
  /* CompleteClass */
