...
class default () extends EncryptedContentInfo {
  ...
  /* CompleteClass */
  override var contentEncryptionAlgorithm: pkijsLib.srcAlgorithmIdentifierMod.default = js.native
  /* CompleteClass */
  override var eContentType: java.lang.String = js.native
  /* CompleteClass */
  override var encryptedContent: asn1jsLib.asn1jsMod.OctetString = js.native
  /* CompleteClass */
