...
class default () extends KeyAgreeRecipientInfo {
  ...
  /* CompleteClass */
  override var originator: pkijsLib.srcOriginatorIdentifierOrKeyMod.default = js.native
  /* CompleteClass */
  override var recipientCertificate: pkijsLib.srcCertificateMod.default = js.native
  /* CompleteClass */
  override var recipientEncryptedKeys: pkijsLib.srcRecipientEncryptedKeysMod.default = js.native
  /* CompleteClass */
