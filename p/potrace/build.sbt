...
name := "potrace"
version := "2.1-dt-20220225Z-b2a5d0"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "jimp" % "0.22.8-646d35",
  ...
  "org.scalablytyped" %%% "jimp__plugins" % "0.22.8-ec8d32",
  "org.scalablytyped" %%% "jimp__png" % "0.22.8-accfa8",
  "org.scalablytyped" %%% "jimp__tiff" % "0.22.8-16f300",
  "org.scalablytyped" %%% "jimp__types" % "0.22.8-bf91fd",
