...
object _TransitionDefinition {
  ...
  inline def DecayDefinition(ease: Unit): typings.popmotionPose.typesMod.DecayDefinition = {
  ...
  inline def KeyframesDefinition(): typings.popmotionPose.typesMod.KeyframesDefinition = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("keyframes")
    __obj.asInstanceOf[typings.popmotionPose.typesMod.KeyframesDefinition]
  }
  
  inline def PhysicsDefinition(ease: Unit): typings.popmotionPose.typesMod.PhysicsDefinition = {
    val __obj = js.Dynamic.literal(ease = ease.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("physics")
    __obj.asInstanceOf[typings.popmotionPose.typesMod.PhysicsDefinition]
  }
  
  inline def SpringDefinition(ease: Unit): typings.popmotionPose.typesMod.SpringDefinition = {
    val __obj = js.Dynamic.literal(ease = ease.asInstanceOf[js.Any])
