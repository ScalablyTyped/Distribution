...
object DomPopmotionConfig {
  ...
  extension [Self <: DomPopmotionConfig](x: Self) {
    ...
    inline def setOnDragEnd(value: /* e */ MouseEvent | TouchEvent => js.Any): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1(value))
    
    inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
    
    inline def setOnDragStart(value: /* e */ MouseEvent | TouchEvent => js.Any): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1(value))
    
    inline def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
    
    inline def setOnPressEnd(value: /* e */ MouseEvent | TouchEvent => js.Any): Self = StObject.set(x, "onPressEnd", js.Any.fromFunction1(value))
    
    inline def setOnPressEndUndefined: Self = StObject.set(x, "onPressEnd", js.undefined)
    
    inline def setOnPressStart(value: /* e */ MouseEvent | TouchEvent => js.Any): Self = StObject.set(x, "onPressStart", js.Any.fromFunction1(value))
