...
object Detect {
  ...
  def apply(
    ...
    if (!js.isUndefined(analyzesAge)) __obj.updateDynamic("analyzesAge")(analyzesAge.get.asInstanceOf[js.Any])
    if (!js.isUndefined(analyzesFaceLandmarks)) __obj.updateDynamic("analyzesFaceLandmarks")(analyzesFaceLandmarks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(analyzesGender)) __obj.updateDynamic("analyzesGender")(analyzesGender.get.asInstanceOf[js.Any])
    if (!js.isUndefined(analyzesHeadPose)) __obj.updateDynamic("analyzesHeadPose")(analyzesHeadPose.get.asInstanceOf[js.Any])
