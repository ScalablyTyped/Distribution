package typings
package promiseDashRetryLib.promiseDashRetryMod
...
object ^ extends js.Object {
  def apply[ResolutionType](options: retryLib.retryMod.OperationOptions, retryableFn: RetryableFn[ResolutionType]): js.Promise[ResolutionType] = js.native
  /**
  ...
  def apply[ResolutionType](retryableFn: RetryableFn[ResolutionType], options: retryLib.retryMod.OperationOptions): js.Promise[ResolutionType] = js.native
}
