...
object _SupportOption {
  ...
  @scala.inline
  def BooleanArraySupportOption(category: String, default: js.Array[ValueArray], since: String): typings.prettier.mod.BooleanArraySupportOption = {
  ...
  @scala.inline
  def BooleanSupportOption(category: String, default: Boolean, description: String, since: String): typings.prettier.mod.BooleanSupportOption = {
  ...
  @scala.inline
  def IntArraySupportOption(category: String, default: js.Array[Value], since: String): typings.prettier.mod.IntArraySupportOption = {
    val __obj = js.Dynamic.literal(array = true, category = category.asInstanceOf[js.Any], default = default.asInstanceOf[js.Any], since = since.asInstanceOf[js.Any])
  ...
  @scala.inline
  def IntSupportOption(category: String, default: Double, since: String): typings.prettier.mod.IntSupportOption = {
  ...
  @scala.inline
  def PathArraySupportOption(category: String, default: js.Array[`0`], since: String): typings.prettier.mod.PathArraySupportOption = {
    val __obj = js.Dynamic.literal(array = true, category = category.asInstanceOf[js.Any], default = default.asInstanceOf[js.Any], since = since.asInstanceOf[js.Any])
  ...
  @scala.inline
  def PathSupportOption(category: String, default: String, since: String): typings.prettier.mod.PathSupportOption = {
    val __obj = js.Dynamic.literal(category = category.asInstanceOf[js.Any], default = default.asInstanceOf[js.Any], since = since.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("path")
