...
object Indent_ {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Indent_] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.prettier.prettierStrings.indent): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
