...
/* Rewritten from type alias, can be one of: 
  - typings.prettier.prettierStrings.int
  - typings.prettier.prettierStrings.boolean
  - typings.prettier.prettierStrings.choice
  - typings.prettier.prettierStrings.path
*/
trait SupportOptionType extends js.Object
