...
object BuiltInParserName {
  ...
  inline def angular: typings.prettier.prettierStrings.angular = "angular".asInstanceOf[typings.prettier.prettierStrings.angular]
  
  inline def babel: typings.prettier.prettierStrings.babel = "babel".asInstanceOf[typings.prettier.prettierStrings.babel]
  
  inline def `babel-flow`: typings.prettier.prettierStrings.`babel-flow` = "babel-flow".asInstanceOf[typings.prettier.prettierStrings.`babel-flow`]
  
  inline def `babel-ts`: typings.prettier.prettierStrings.`babel-ts` = "babel-ts".asInstanceOf[typings.prettier.prettierStrings.`babel-ts`]
  ...
  inline def html: typings.prettier.prettierStrings.html = "html".asInstanceOf[typings.prettier.prettierStrings.html]
  
  inline def json: typings.prettier.prettierStrings.json = "json".asInstanceOf[typings.prettier.prettierStrings.json]
  
  inline def `json-stringify`: typings.prettier.prettierStrings.`json-stringify` = "json-stringify".asInstanceOf[typings.prettier.prettierStrings.`json-stringify`]
  
  inline def json5: typings.prettier.prettierStrings.json5 = "json5".asInstanceOf[typings.prettier.prettierStrings.json5]
  
  inline def less: typings.prettier.prettierStrings.less = "less".asInstanceOf[typings.prettier.prettierStrings.less]
  
  inline def lwc: typings.prettier.prettierStrings.lwc = "lwc".asInstanceOf[typings.prettier.prettierStrings.lwc]
  ...
  inline def typescript: typings.prettier.prettierStrings.typescript = "typescript".asInstanceOf[typings.prettier.prettierStrings.typescript]
  
  inline def vue: typings.prettier.prettierStrings.vue = "vue".asInstanceOf[typings.prettier.prettierStrings.vue]
  
  inline def yaml: typings.prettier.prettierStrings.yaml = "yaml".asInstanceOf[typings.prettier.prettierStrings.yaml]
}
