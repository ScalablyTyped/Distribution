...
trait Concat_ extends _Doc {
  ...
  var `type`: typings.prettier.prettierStrings.concat = js.native
}
object Concat_ {
  ...
  implicit class Concat_Ops[Self <: Concat_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.prettier.prettierStrings.concat): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
