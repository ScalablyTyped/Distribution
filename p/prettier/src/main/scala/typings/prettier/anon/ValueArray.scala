...
object ValueArray {
  ...
  implicit class ValueArrayOps[Self <: ValueArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueVarargs(value: Boolean*): Self = this.set("value", js.Array(value :_*))
    
    @scala.inline
    def setValue(value: js.Array[Boolean]): Self = this.set("value", value.asInstanceOf[js.Any])
  }
}
