...
// -----------------------------------
@JSGlobal("photonui.TabItem")
@js.native
class TabItem ()
  extends typings.photonui.photonui.TabItem {
  /* CompleteClass */
  override var absolutePosition: X = js.native
  /* CompleteClass */
  override var child: typings.photonui.photonui.Widget = js.native
  /* CompleteClass */
  override var childName: String = js.native
  /* CompleteClass */
  override var containerNode: HTMLElement = js.native
   // readonly
  /* CompleteClass */
  ...
  override var contextMenuName: String = js.native
   // readonly
  /* CompleteClass */
  override var horizontalChildExpansion: Boolean = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var tabHtml: HTMLElement = js.native
   // readonly
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var verticalChildExpansion: Boolean = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def removeChild(widget: typings.photonui.photonui.Widget): Unit = js.native
  /* CompleteClass */
