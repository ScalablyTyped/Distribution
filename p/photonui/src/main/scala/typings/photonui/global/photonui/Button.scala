...
class Button ()
  extends StObject
     with typings.photonui.photonui.Button {
  ...
  /* CompleteClass */
  var leftIcon: typings.photonui.photonui.BaseIcon = js.native
  ...
  /* CompleteClass */
  var rightIcon: typings.photonui.photonui.BaseIcon = js.native
