...
@js.native
class SpriteIcon ()
  extends typings.photonui.photonui.SpriteIcon {
  ...
  /* CompleteClass */
  override var icon: String = js.native
  /* CompleteClass */
  override var iconName: String = js.native
   // readonly
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var spriteSheetName: String = js.native
  /* CompleteClass */
