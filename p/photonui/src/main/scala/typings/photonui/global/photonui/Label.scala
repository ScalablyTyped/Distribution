...
@JSGlobal("photonui.Label")
@js.native
class Label ()
  extends typings.photonui.photonui.Label {
  ...
  /* CompleteClass */
  override var forInput: typings.photonui.photonui.Field | typings.photonui.photonui.CheckBox = js.native
  /* CompleteClass */
  override var forInputName: String = js.native
  /* CompleteClass */
