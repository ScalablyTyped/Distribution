...
@JSGlobal("photonui.Slider")
@js.native
class Slider ()
  extends typings.photonui.photonui.Slider {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var decimalDigits: Double = js.native
  /* CompleteClass */
  override var decimalSymbol: String = js.native
  /* CompleteClass */
  override var fieldVisible: Boolean = js.native
  /* CompleteClass */
