...
object Close {
  ...
  extension [Self <: Close](x: Self) {
    ...
    inline def setDOMContentLoaded(value: domcontentloaded_): Self = StObject.set(x, "DOMContentLoaded", value.asInstanceOf[js.Any])
    
    inline def setDialog(value: dialog): Self = StObject.set(x, "Dialog", value.asInstanceOf[js.Any])
    
    inline def setError(value: error): Self = StObject.set(x, "Error", value.asInstanceOf[js.Any])
    
    inline def setFrameAttached(value: frameattached): Self = StObject.set(x, "FrameAttached", value.asInstanceOf[js.Any])
    
    inline def setFrameDetached(value: framedetached): Self = StObject.set(x, "FrameDetached", value.asInstanceOf[js.Any])
    
    inline def setFrameNavigated(value: framenavigated): Self = StObject.set(x, "FrameNavigated", value.asInstanceOf[js.Any])
    
    inline def setLoad(value: load): Self = StObject.set(x, "Load", value.asInstanceOf[js.Any])
    
    inline def setMetrics(value: metrics): Self = StObject.set(x, "Metrics", value.asInstanceOf[js.Any])
    
    inline def setPageError(value: pageerror): Self = StObject.set(x, "PageError", value.asInstanceOf[js.Any])
    
    inline def setPopup(value: popup): Self = StObject.set(x, "Popup", value.asInstanceOf[js.Any])
    
    inline def setRequest(value: request): Self = StObject.set(x, "Request", value.asInstanceOf[js.Any])
    
    inline def setRequestFailed(value: requestfailed): Self = StObject.set(x, "RequestFailed", value.asInstanceOf[js.Any])
    
    inline def setRequestFinished(value: requestfinished): Self = StObject.set(x, "RequestFinished", value.asInstanceOf[js.Any])
    
    inline def setResponse(value: response): Self = StObject.set(x, "Response", value.asInstanceOf[js.Any])
    
    inline def setWorkerCreated(value: workercreated): Self = StObject.set(x, "WorkerCreated", value.asInstanceOf[js.Any])
    
    inline def setWorkerDestroyed(value: workerdestroyed): Self = StObject.set(x, "WorkerDestroyed", value.asInstanceOf[js.Any])
  }
}
