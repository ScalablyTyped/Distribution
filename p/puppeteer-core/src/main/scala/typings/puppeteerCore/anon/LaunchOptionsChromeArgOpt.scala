...
/* Inlined puppeteer-core.puppeteer-core/lib/cjs/puppeteer/node/LaunchOptions.LaunchOptions & puppeteer-core.puppeteer-core/lib/cjs/puppeteer/node/LaunchOptions.ChromeArgOptions & puppeteer-core.puppeteer-core/lib/cjs/puppeteer/common/BrowserConnector.BrowserOptions & {  product :puppeteer-core.puppeteer-core/lib/cjs/puppeteer/common/Product.Product | undefined,   extraPrefsFirefox :std.Record<string, unknown> | undefined} */
trait LaunchOptionsChromeArgOpt extends StObject {
...
object LaunchOptionsChromeArgOpt {
  
  @scala.inline
  def apply(): LaunchOptionsChromeArgOpt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LaunchOptionsChromeArgOpt]
  }
  
  @scala.inline
  implicit class LaunchOptionsChromeArgOptMutableBuilder[Self <: LaunchOptionsChromeArgOpt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDefaultViewport(value: typings.puppeteerCore.puppeteerViewportMod.Viewport): Self = StObject.set(x, "defaultViewport", value.asInstanceOf[js.Any])
