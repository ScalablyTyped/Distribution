...
object projectRootstringpreferre {
  ...
  inline def apply(isPuppeteerCore: Boolean, preferredRevision: String, projectRoot: String): projectRootstringpreferre = {
  ...
  extension [Self <: projectRootstringpreferre](x: Self) {
