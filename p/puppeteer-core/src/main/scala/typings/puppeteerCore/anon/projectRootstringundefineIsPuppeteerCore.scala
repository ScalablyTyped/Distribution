...
/* Inlined {  projectRoot :string | undefined,   preferredRevision :string,   productName :puppeteer-core.puppeteer-core/lib/esm/puppeteer/common/Product.Product | undefined} & puppeteer-core.puppeteer-core/lib/esm/puppeteer/common/Puppeteer.CommonPuppeteerSettings */
