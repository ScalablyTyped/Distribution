...
/* Inlined {  projectRoot :string | undefined,   preferredRevision :string,   productName :puppeteer-core.puppeteer-core/lib/cjs/puppeteer/common/Product.Product | undefined} & puppeteer-core.puppeteer-core/lib/cjs/puppeteer/common/Puppeteer.CommonPuppeteerSettings */
