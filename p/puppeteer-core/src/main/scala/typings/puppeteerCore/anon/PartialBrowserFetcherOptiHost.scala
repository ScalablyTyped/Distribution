...
import typings.puppeteerCore.libEsmPuppeteerNodeBrowserFetcherMod.Platform
...
/* Inlined std.Partial<puppeteer-core.puppeteer-core/lib/esm/puppeteer/node/BrowserFetcher.BrowserFetcherOptions> */
trait PartialBrowserFetcherOptiHost extends StObject {
...
object PartialBrowserFetcherOptiHost {
  
  inline def apply(): PartialBrowserFetcherOptiHost = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBrowserFetcherOptiHost]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBrowserFetcherOptiHost] (val x: Self) extends AnyVal {
