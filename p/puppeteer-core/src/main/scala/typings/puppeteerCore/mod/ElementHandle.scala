...
- typings.puppeteerCore.mod._HandleOr because Already inherited
- typings.puppeteerCore.mod.HandleFor because Already inherited */ @JSImport("puppeteer-core", "ElementHandle")
@js.native
