...
object networkConditionsMod {
  ...
  object networkConditions {
    ...
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/NetworkConditions", "networkConditions.Fast 3G")
    @js.native
    val Fast3G: NetworkConditions = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/NetworkConditions", "networkConditions.Slow 3G")
    @js.native
