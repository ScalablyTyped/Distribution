...
import typings.puppeteerCore.typesMod.HandleOr
...
object jshandleMod {
  ...
  - typings.puppeteerCore.typesMod._HandleOr because Already inherited */ @JSImport("puppeteer-core/lib/cjs/puppeteer/common/JSHandle", "JSHandle")
  @js.native
