...
import typings.puppeteerCore.anon.projectRootstringundefine
import typings.puppeteerCore.browserConnectorMod.BrowserConnectOptions
...
object nodePuppeteerMod {
  ...
  open class PuppeteerNode protected () extends Puppeteer {
    /**
      * @internal
      */
    def this(settings: projectRootstringundefine) = this()
