...
object libCjsPuppeteerCommonErrorsMod {
  ...
  trait PuppeteerErrors extends StObject {
    ...
    var ProtocolError: Instantiable0[typings.puppeteerCore.libCjsPuppeteerCommonErrorsMod.ProtocolError]
    
    var TimeoutError: Instantiable0[typings.puppeteerCore.libCjsPuppeteerCommonErrorsMod.TimeoutError]
  }
