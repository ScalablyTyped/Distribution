...
import typings.puppeteerCore.libEsmPuppeteerCommonTaskQueueMod.TaskQueue
import typings.puppeteerCore.libEsmPuppeteerCommonWebWorkerMod.WebWorker
...
object libEsmPuppeteerCommonTargetMod {
