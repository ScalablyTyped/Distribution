...
object commonErrorsMod {
  ...
  trait PuppeteerErrors extends StObject {
    ...
    var ProtocolError: Instantiable0[typings.puppeteerCore.commonErrorsMod.ProtocolError]
    
    var TimeoutError: Instantiable0[typings.puppeteerCore.commonErrorsMod.TimeoutError]
  }
