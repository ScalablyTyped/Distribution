...
object libCjsPuppeteerCommonBidiBrowserMod {
  
  @JSImport("puppeteer-core/lib/cjs/puppeteer/common/bidi/Browser", "Browser")
  @js.native
  open class Browser protected ()
    extends typings.puppeteerCore.libCjsPuppeteerApiBrowserMod.Browser {
    /**
      * @internal
      */
