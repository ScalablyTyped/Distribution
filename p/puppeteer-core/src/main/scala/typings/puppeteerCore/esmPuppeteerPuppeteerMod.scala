...
object esmPuppeteerPuppeteerMod {
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", JSImport.Namespace)
  @js.native
  ...
  /**
    * @public
    */
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", JSImport.Default)
  @js.native
  val default: PuppeteerNode = js.native
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "CustomError")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "ProtocolError")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "TimeoutError")
  @js.native
  ...
  /**
    ...
    * @public
    */
  @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "devices")
  @js.native
  val devices: DevicesMap = js.native
  
  object errors extends Shortcut {
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "errors")
    @js.native
    val ^ : PuppeteerErrors = js.native
    
    /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
    @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "errors.ProtocolError")
    @js.native
    open class ProtocolErrorCls ()
      extends typings.puppeteerCore.commonErrorsMod.ProtocolError
    
    /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
    @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "errors.TimeoutError")
    @js.native
  ...
  object networkConditions {
    ...
    @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "networkConditions.Fast 3G")
    @js.native
    val Fast3G: NetworkConditions = js.native
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/puppeteer", "networkConditions.Slow 3G")
    @js.native
