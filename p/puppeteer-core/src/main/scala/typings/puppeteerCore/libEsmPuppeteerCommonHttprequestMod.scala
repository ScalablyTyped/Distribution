...
object libEsmPuppeteerCommonHttprequestMod {
  ...
  object InterceptResolutionAction extends StObject {
    ...
    /* "abort" */ val Abort: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.Abort & String = js.native
    
    @js.native
    sealed trait AlreadyHandled
      extends StObject
         with InterceptResolutionAction
    /* "already-handled" */ val AlreadyHandled: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.AlreadyHandled & String = js.native
    
    @js.native
    sealed trait Continue
      extends StObject
         with InterceptResolutionAction
    /* "continue" */ val Continue: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.Continue & String = js.native
    
    @js.native
    sealed trait Disabled
      extends StObject
         with InterceptResolutionAction
    /* "disabled" */ val Disabled: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.Disabled & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with InterceptResolutionAction
    /* "none" */ val None: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.None & String = js.native
    
    @js.native
    sealed trait Respond
      extends StObject
         with InterceptResolutionAction
    /* "respond" */ val Respond: typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.InterceptResolutionAction.Respond & String = js.native
  }
