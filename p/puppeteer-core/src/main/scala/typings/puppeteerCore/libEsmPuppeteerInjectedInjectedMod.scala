...
object libEsmPuppeteerInjectedInjectedMod {
  ...
  object default {
    ...
    open class IntervalPoller[T] protected ()
      extends typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.IntervalPoller[T] {
      def this(
    ...
    val IntervalPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* ms */ Double, 
        typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.IntervalPoller[js.Object]
      ] = js.native
    ...
    open class MutationPoller[T] protected ()
      extends typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.MutationPoller[T] {
      def this(
        fn: js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]],
        root: Node
      ) = this()
    ...
    val MutationPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* root */ Node, 
        typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.MutationPoller[js.Object]
      ] = js.native
    ...
    open class RAFPoller[T] protected ()
      extends typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.RAFPoller[T] {
    ...
    val RAFPoller: Instantiable1[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        typings.puppeteerCore.libEsmPuppeteerInjectedPollerMod.RAFPoller[js.Object]
      ] = js.native
