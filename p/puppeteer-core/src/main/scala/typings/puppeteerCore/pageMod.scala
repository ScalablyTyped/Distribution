...
import typings.puppeteerCore.accessibilityMod.Accessibility
...
import typings.puppeteerCore.anon.UserAgent
...
import typings.puppeteerCore.consoleMessageMod.ConsoleMessage
import typings.puppeteerCore.coverageMod.Coverage
...
import typings.puppeteerCore.fileChooserMod.FileChooser
import typings.puppeteerCore.frameMod.Frame
import typings.puppeteerCore.frameMod.FrameAddScriptTagOptions
import typings.puppeteerCore.frameMod.FrameAddStyleTagOptions
import typings.puppeteerCore.frameMod.FrameWaitForFunctionOptions
import typings.puppeteerCore.httprequestMod.HTTPRequest
import typings.puppeteerCore.httpresponseMod.HTTPResponse
import typings.puppeteerCore.inputMod.Keyboard
import typings.puppeteerCore.inputMod.Mouse
import typings.puppeteerCore.inputMod.Touchscreen
...
import typings.puppeteerCore.networkManagerMod.Credentials
import typings.puppeteerCore.networkManagerMod.NetworkConditions
import typings.puppeteerCore.pdfoptionsMod.PDFOptions
...
import typings.puppeteerCore.tracingMod.Tracing
...
object pageMod {
  ...
  open class Page () extends EventEmitter {
    ...
    /**
      ...
      */
    def emulate(options: UserAgent): js.Promise[Unit] = js.native
    ...
    @JSName("off")
    def off_metrics(eventName: metrics, handler: js.Function1[/* event */ typings.puppeteerCore.anon.Metrics, Unit]): EventEmitter = js.native
    @JSName("off")
    ...
    @JSName("on")
    def on_metrics(eventName: metrics, handler: js.Function1[/* event */ typings.puppeteerCore.anon.Metrics, Unit]): EventEmitter = js.native
    @JSName("on")
    ...
    @JSName("once")
    def once_metrics(eventName: metrics, handler: js.Function1[/* event */ typings.puppeteerCore.anon.Metrics, Unit]): EventEmitter = js.native
    @JSName("once")
  ...
  */
  ...
  trait PageEventObject extends StObject {
    ...
    var metrics: typings.puppeteerCore.anon.Metrics
  ...
  object PageEventObject {
    ...
    inline def apply(
      ...
      metrics: typings.puppeteerCore.anon.Metrics,
      pageerror: js.Error,
      popup: Page,
      request: HTTPRequest,
    ...
    extension [Self <: PageEventObject](x: Self) {
      ...
      inline def setMetrics(value: typings.puppeteerCore.anon.Metrics): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
