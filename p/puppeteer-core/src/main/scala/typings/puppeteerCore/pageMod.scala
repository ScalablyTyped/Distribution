...
object pageMod {
  ...
  @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Page", "Page")
  @js.native
  class Page protected () extends EventEmitter {
    ...
    def goto(url: String, options: WaitForOptionsrefererstri): js.Promise[HTTPResponse] = js.native
  ...
  object Page {
    ...
    inline def create(client: CDPSession, target: Target, ignoreHTTPSErrors: Boolean, defaultViewport: Viewport): js.Promise[Page] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(client.asInstanceOf[js.Any], target.asInstanceOf[js.Any], ignoreHTTPSErrors.asInstanceOf[js.Any], defaultViewport.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Page]]
  }
