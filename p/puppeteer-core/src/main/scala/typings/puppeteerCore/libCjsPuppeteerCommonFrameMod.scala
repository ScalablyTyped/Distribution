...
import typings.puppeteerCore.libCjsPuppeteerCommonFrameManagerMod.FrameManager
import typings.puppeteerCore.libCjsPuppeteerCommonHttpresponseMod.HTTPResponse
import typings.puppeteerCore.libCjsPuppeteerCommonIsolatedWorldMod.IsolatedWorldChart
...
object libCjsPuppeteerCommonFrameMod {
