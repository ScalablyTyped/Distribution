...
object eventsMod {
  ...
  object Events {
    ...
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.Browser")
    @js.native
    val Browser: Disconnected = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.BrowserContext")
    @js.native
    val BrowserContext: TargetChanged = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.CDPSession")
    @js.native
    val CDPSession: DisconnectedSymbol = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.Connection")
    @js.native
    val Connection: DisconnectedSymbol = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.FrameManager")
    @js.native
    val FrameManager: ExecutionContextCreated = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.NetworkManager")
    @js.native
    val NetworkManager: Request = js.native
    
    @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Events", "Events.Page")
    @js.native
