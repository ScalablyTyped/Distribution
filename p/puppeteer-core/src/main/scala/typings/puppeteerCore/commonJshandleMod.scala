...
import typings.puppeteerCore.commonTypesMod.HandleOr
...
object commonJshandleMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.puppeteerCore.commonTypesMod._HandleOr because Already inherited */ @JSImport("puppeteer-core/lib/esm/puppeteer/common/JSHandle", "JSHandle")
  @js.native
