...
import typings.puppeteerCore.commonEvalTypesMod._SerializableOrJSHandle
...
object commonJshandleMod {
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/common/JSHandle", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/common/JSHandle", "ElementHandle")
  @js.native
