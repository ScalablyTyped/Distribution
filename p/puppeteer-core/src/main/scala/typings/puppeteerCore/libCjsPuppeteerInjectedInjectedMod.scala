...
import typings.puppeteerCore.libCjsPuppeteerInjectedTextContentMod.TextContent
...
object libCjsPuppeteerInjectedInjectedMod {
  ...
  object default {
    ...
    @JSImport("puppeteer-core/lib/cjs/puppeteer/injected/injected", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer-core/lib/cjs/puppeteer/injected/injected", "default.IntervalPoller")
    @js.native
    open class IntervalPoller[T] protected ()
      extends typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.IntervalPoller[T] {
      def this(
    ...
    val IntervalPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* ms */ Double, 
        typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.IntervalPoller[js.Object]
      ] = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer-core/lib/cjs/puppeteer/injected/injected", "default.MutationPoller")
    @js.native
    open class MutationPoller[T] protected ()
      extends typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.MutationPoller[T] {
      def this(
        fn: js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]],
        root: Node
      ) = this()
    ...
    val MutationPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* root */ Node, 
        typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.MutationPoller[js.Object]
      ] = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("puppeteer-core/lib/cjs/puppeteer/injected/injected", "default.RAFPoller")
    @js.native
    open class RAFPoller[T] protected ()
      extends typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.RAFPoller[T] {
    ...
    val RAFPoller: Instantiable1[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        typings.puppeteerCore.libCjsPuppeteerInjectedPollerMod.RAFPoller[js.Object]
      ] = js.native
