...
import typings.puppeteerCore.networkManagerMod.NetworkManager
...
object frameManagerMod {
  ...
  @JSImport("puppeteer-core/lib/cjs/puppeteer/common/FrameManager", "Frame")
  @js.native
  ...
  class FrameManager protected () extends EventEmitter {
    ...
    def navigateFrame(frame: Frame, url: String, options: Referer): js.Promise[HTTPResponse | Null] = js.native
    ...
    def waitForFrameNavigation(frame: Frame, options: WaitUntil): js.Promise[HTTPResponse | Null] = js.native
  }
