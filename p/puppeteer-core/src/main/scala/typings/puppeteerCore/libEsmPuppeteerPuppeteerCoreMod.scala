...
import typings.puppeteerCore.libCjsPuppeteerTypesMod.Browser
import typings.puppeteerCore.libEsmPuppeteerCommonDeviceMod.Device
import typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.PuppeteerErrors
import typings.puppeteerCore.libEsmPuppeteerCommonNetworkManagerMod.NetworkConditions
import typings.puppeteerCore.libEsmPuppeteerCommonPuppeteerMod.CommonPuppeteerSettings
import typings.puppeteerCore.libEsmPuppeteerCommonQueryHandlerMod.CustomQueryHandler
import typings.puppeteerCore.libEsmPuppeteerNodeBrowserFetcherMod.BrowserFetcherOptions
...
object libEsmPuppeteerPuppeteerCoreMod {
  ...
  open class CustomError ()
    extends typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.CustomError {
  ...
  open class ProtocolError ()
    extends typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.ProtocolError {
    def this(message: String) = this()
  }
  ...
  open class Puppeteer protected ()
    extends typings.puppeteerCore.libEsmPuppeteerCommonPuppeteerMod.Puppeteer {
    /**
      * @internal
      */
  ...
  open class TimeoutError ()
    extends typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.TimeoutError {
    def this(message: String) = this()
  }
