...
object helperMod {
  ...
  object helper {
    ...
    inline def removeEventListeners_=(x: js.Function1[/* listeners */ js.Array[Emitter], Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("removeEventListeners")(x.asInstanceOf[js.Any])
    ...
    inline def waitForEvent_=(x: FnCallEmitterEventNamePredicateTimeoutAbortPromise): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("waitForEvent")(x.asInstanceOf[js.Any])
