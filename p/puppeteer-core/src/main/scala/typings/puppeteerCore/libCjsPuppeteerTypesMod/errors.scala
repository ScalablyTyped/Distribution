...
import typings.puppeteerCore.libCjsPuppeteerCommonErrorsMod.PuppeteerErrors
...
object errors extends Shortcut {
  ...
  open class ProtocolErrorCls ()
    extends typings.puppeteerCore.libCjsPuppeteerCommonErrorsMod.ProtocolError
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("puppeteer-core/lib/cjs/puppeteer/types", "errors.TimeoutError")
  @js.native
  open class TimeoutErrorCls ()
    extends typings.puppeteerCore.libCjsPuppeteerCommonErrorsMod.TimeoutError
