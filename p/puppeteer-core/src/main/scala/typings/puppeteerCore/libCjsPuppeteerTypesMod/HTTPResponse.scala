...
open class HTTPResponse protected ()
  extends typings.puppeteerCore.libCjsPuppeteerCommonHttpresponseMod.HTTPResponse {
  /**
    * @internal
    */
  def this(
    client: typings.puppeteerCore.libCjsPuppeteerCommonHttpresponseMod.CDPSession,
    request: typings.puppeteerCore.libCjsPuppeteerCommonHttprequestMod.HTTPRequest,
