...
import typings.puppeteerCore.jshandleMod.BoundingBox
import typings.puppeteerCore.jshandleMod.BoxModel
import typings.puppeteerCore.jshandleMod.ClickOptions
import typings.puppeteerCore.jshandleMod.JSHandle
import typings.puppeteerCore.jshandleMod.Offset
import typings.puppeteerCore.jshandleMod.Point
import typings.puppeteerCore.jshandleMod.PressOptions
import typings.puppeteerCore.pageMod.ScreenshotOptions
...
object elementHandleMod {
  ...
  - typings.puppeteerCore.typesMod._HandleOr because Already inherited
  - typings.puppeteerCore.typesMod.HandleFor because Already inherited */ @JSImport("puppeteer-core/lib/cjs/puppeteer/common/ElementHandle", "ElementHandle")
  @js.native
