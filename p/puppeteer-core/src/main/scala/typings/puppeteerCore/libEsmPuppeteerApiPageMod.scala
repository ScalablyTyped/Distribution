...
import typings.puppeteerCore.libEsmPuppeteerCommonDeviceMod.Device
import typings.puppeteerCore.libEsmPuppeteerCommonDialogMod.Dialog
...
import typings.puppeteerCore.libEsmPuppeteerCommonFileChooserMod.FileChooser
import typings.puppeteerCore.libEsmPuppeteerCommonFrameMod.Frame
import typings.puppeteerCore.libEsmPuppeteerCommonFrameMod.FrameAddScriptTagOptions
import typings.puppeteerCore.libEsmPuppeteerCommonFrameMod.FrameAddStyleTagOptions
import typings.puppeteerCore.libEsmPuppeteerCommonFrameMod.FrameWaitForFunctionOptions
import typings.puppeteerCore.libEsmPuppeteerCommonHttprequestMod.HTTPRequest
import typings.puppeteerCore.libEsmPuppeteerCommonHttpresponseMod.HTTPResponse
import typings.puppeteerCore.libEsmPuppeteerCommonInputMod.Keyboard
import typings.puppeteerCore.libEsmPuppeteerCommonInputMod.Mouse
import typings.puppeteerCore.libEsmPuppeteerCommonInputMod.Touchscreen
import typings.puppeteerCore.libEsmPuppeteerCommonIsolatedWorldMod.WaitForSelectorOptions
...
import typings.puppeteerCore.libEsmPuppeteerCommonNetworkManagerMod.Credentials
import typings.puppeteerCore.libEsmPuppeteerCommonNetworkManagerMod.NetworkConditions
import typings.puppeteerCore.libEsmPuppeteerCommonPdfoptionsMod.PDFOptions
import typings.puppeteerCore.libEsmPuppeteerCommonPuppeteerViewportMod.Viewport
import typings.puppeteerCore.libEsmPuppeteerCommonTargetMod.Target
import typings.puppeteerCore.libEsmPuppeteerCommonTracingMod.Tracing
...
import typings.puppeteerCore.puppeteerCoreStrings.base64
import typings.puppeteerCore.puppeteerCoreStrings.binary
...
import typings.puppeteerCore.puppeteerCoreStrings.webp
...
object libEsmPuppeteerApiPageMod {
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "Page")
  @js.native
  /**
    * @internal
    */
  open class Page () extends EventEmitter {
    ...
    def goto(url: String, options: WaitForOptionsrefererstriReferer): js.Promise[HTTPResponse | Null] = js.native
    ...
    @JSName("off")
    def off_metrics(eventName: metrics, handler: js.Function1[/* event */ Title, Unit]): EventEmitter = js.native
    @JSName("off")
    ...
    @JSName("on")
    def on_metrics(eventName: metrics, handler: js.Function1[/* event */ Title, Unit]): EventEmitter = js.native
    @JSName("on")
    ...
    @JSName("once")
    def once_metrics(eventName: metrics, handler: js.Function1[/* event */ Title, Unit]): EventEmitter = js.native
    @JSName("once")
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "supportedMetrics")
  @js.native
  val supportedMetrics: Set[String] = js.native
  
  object unitToPixels {
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "unitToPixels")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "unitToPixels.cm")
    @js.native
    def cm: Double = js.native
    inline def cm_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cm")(x.asInstanceOf[js.Any])
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "unitToPixels.in")
    @js.native
    def in: Double = js.native
    inline def in_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("in")(x.asInstanceOf[js.Any])
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "unitToPixels.mm")
    @js.native
    def mm: Double = js.native
    inline def mm_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("mm")(x.asInstanceOf[js.Any])
    
    @JSImport("puppeteer-core/lib/esm/puppeteer/api/Page", "unitToPixels.px")
    @js.native
  ...
  */
  ...
  object PageEventObject {
    ...
    implicit open class MutableBuilder[Self <: PageEventObject] (val x: Self) extends AnyVal {
      ...
      inline def setMetrics(value: Title): Self = StObject.set(x, "metrics", value.asInstanceOf[js.Any])
