...
import typings.puppeteerCore.libEsmPuppeteerApiBrowserMod.Permission
...
object libEsmPuppeteerApiBrowserContextMod {
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/api/BrowserContext", "BrowserContext")
  @js.native
  /**
    * @internal
    */
