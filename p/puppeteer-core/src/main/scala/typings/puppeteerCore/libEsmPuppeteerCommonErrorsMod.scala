...
object libEsmPuppeteerCommonErrorsMod {
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/common/Errors", "CustomError")
  @js.native
  /**
    * @internal
    */
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/common/Errors", "ProtocolError")
  @js.native
  /**
    * @internal
    */
  ...
  object errors extends Shortcut {
    ...
    @JSImport("puppeteer-core/lib/esm/puppeteer/common/Errors", "errors")
    @js.native
    val ^ : PuppeteerErrors = js.native
    
    /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
    @JSImport("puppeteer-core/lib/esm/puppeteer/common/Errors", "errors.ProtocolError")
    @js.native
    open class ProtocolErrorCls () extends ProtocolError
    
    /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
    @JSImport("puppeteer-core/lib/esm/puppeteer/common/Errors", "errors.TimeoutError")
    @js.native
  ...
  trait PuppeteerErrors extends StObject {
    ...
    var ProtocolError: Instantiable0[typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.ProtocolError]
    
    var TimeoutError: Instantiable0[typings.puppeteerCore.libEsmPuppeteerCommonErrorsMod.TimeoutError]
  }
