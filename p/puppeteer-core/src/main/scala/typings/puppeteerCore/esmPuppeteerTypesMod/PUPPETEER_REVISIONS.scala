...
object PUPPETEER_REVISIONS {
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "PUPPETEER_REVISIONS.chromium")
  @js.native
  val chromium: `1036745` = js.native
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "PUPPETEER_REVISIONS.firefox")
  @js.native
