...
object FrameManagerEmittedEvents {
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.ExecutionContextCreated")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.ExecutionContextDestroyed")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.FrameAttached")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.FrameDetached")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.FrameNavigated")
  @js.native
  def FrameNavigated: js.Symbol = js.native
  
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.FrameNavigatedWithinDocument")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.FrameSwapped")
  @js.native
  ...
  @JSImport("puppeteer-core/lib/esm/puppeteer/types", "FrameManagerEmittedEvents.LifecycleEvent")
  @js.native
