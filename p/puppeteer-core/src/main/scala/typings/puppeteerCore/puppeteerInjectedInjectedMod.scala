...
import typings.puppeteerCore.injectedTextContentMod.TextContent
...
object puppeteerInjectedInjectedMod {
  ...
  object default {
    ...
    open class IntervalPoller[T] protected ()
      extends typings.puppeteerCore.injectedPollerMod.IntervalPoller[T] {
      def this(
    ...
    val IntervalPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* ms */ Double, 
        typings.puppeteerCore.injectedPollerMod.IntervalPoller[js.Object]
      ] = js.native
    ...
    open class MutationPoller[T] protected ()
      extends typings.puppeteerCore.injectedPollerMod.MutationPoller[T] {
      def this(
        fn: js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]],
        root: Node
      ) = this()
    ...
    val MutationPoller: Instantiable2[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        /* root */ Node, 
        typings.puppeteerCore.injectedPollerMod.MutationPoller[js.Object]
      ] = js.native
    ...
    open class RAFPoller[T] protected ()
      extends typings.puppeteerCore.injectedPollerMod.RAFPoller[T] {
    ...
    val RAFPoller: Instantiable1[
        /* fn */ js.Function0[js.Promise[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]], 
        typings.puppeteerCore.injectedPollerMod.RAFPoller[js.Object]
      ] = js.native
