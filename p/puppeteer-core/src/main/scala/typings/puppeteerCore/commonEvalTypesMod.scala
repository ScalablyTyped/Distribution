...
object commonEvalTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Null
    - js.BigInt
    - typings.puppeteerCore.commonEvalTypesMod.JSONArray
    - typings.puppeteerCore.commonEvalTypesMod.JSONObject
  */
  type Serializable = _Serializable | Double | String | Boolean | Null | js.BigInt
  
  /* Rewritten from type alias, can be one of: 
    - typings.puppeteerCore.commonEvalTypesMod.Serializable
    - typings.puppeteerCore.commonJshandleMod.JSHandle
  */
