...
object commonBrowserConnectorMod {
  ...
  inline def connectToBrowser(options: BrowserOptionsbrowserWSEnBrowserURL): js.Promise[Browser] = ^.asInstanceOf[js.Dynamic].applyDynamic("connectToBrowser")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Browser]]
