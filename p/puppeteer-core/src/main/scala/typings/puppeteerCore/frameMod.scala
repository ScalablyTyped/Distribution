...
import typings.puppeteerCore.anon.Referer
...
import typings.puppeteerCore.isolatedWorldMod.IsolatedWorldChart
...
object frameMod {
  ...
  @JSImport("puppeteer-core/lib/cjs/puppeteer/common/Frame", "Frame")
  @js.native
