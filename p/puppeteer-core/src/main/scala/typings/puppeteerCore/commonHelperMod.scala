...
object commonHelperMod {
  ...
  object helper {
    ...
    @scala.inline
    def removeEventListeners(listeners: js.Array[EventName]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeEventListeners")(listeners.asInstanceOf[js.Any]).asInstanceOf[Unit]
    @scala.inline
    def removeEventListeners_=(x: js.Function1[/* listeners */ js.Array[EventName], Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("removeEventListeners")(x.asInstanceOf[js.Any])
    ...
    @scala.inline
    def waitForEvent_=(x: Fn0): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("waitForEvent")(x.asInstanceOf[js.Any])
