...
trait Modifiers
  ...
  var flip: js.UndefOr[BaseModifier with popperDotJsLib.Anon_BoundariesElement] = js.undefined
  ...
  var preventOverflow: js.UndefOr[BaseModifier with popperDotJsLib.Anon_BoundariesElementPriority] = js.undefined
