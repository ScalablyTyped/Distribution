...
object ParameterRuleArray {
  ...
  @scala.inline
  implicit class ParameterRuleArrayOps[Self <: ParameterRuleArray] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: array | arrayQuestionmark): Self = this.set("type", value.asInstanceOf[js.Any])
