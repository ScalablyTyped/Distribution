...
- Dropped {[ P in keyof passport-oauth2.passport-oauth2.OAuth2Strategy._StrategyOptionsBase ]:? passport-oauth2.passport-oauth2.OAuth2Strategy._StrategyOptionsBase[P]} */ trait _BaseBnetOptions extends js.Object {
