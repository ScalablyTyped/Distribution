...
package object protobufjsMod {
  ...
  /**
    ...
    */
  type LoadCallback = js.Function2[/* error */ stdLib.Error | scala.Null, /* root */ js.UndefOr[Root], scala.Unit]
  /**
  ...
  type RPCImpl = js.Function3[
    /* method */ Method | (protobufjsLib.protobufjsMod.rpcNs.ServiceMethod[Message[js.Object], Message[js.Object]]), 
  ...
  /**
    ...
    */
  type TypeDecorator[T /* <: Message[T] */] = js.Function1[/* target */ Constructor[T], scala.Unit]
  /**
