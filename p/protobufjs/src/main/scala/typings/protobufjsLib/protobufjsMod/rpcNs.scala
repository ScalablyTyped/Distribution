...
object rpcNs extends js.Object {
  ...
  /**
    ...
    */
  type ServiceMethodCallback[TRes /* <: protobufjsLib.protobufjsMod.Message[TRes] */] = js.Function2[/* error */ stdLib.Error | scala.Null, /* response */ js.UndefOr[TRes], scala.Unit]
}
