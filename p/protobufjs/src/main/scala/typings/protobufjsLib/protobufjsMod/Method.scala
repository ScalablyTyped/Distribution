...
class Method protected () extends ReflectionObject {
  ...
  /** Request type. */
  var requestType: java.lang.String = js.native
  /** Resolved request type. */
  var resolvedRequestType: Type | scala.Null = js.native
  /** Resolved response type. */
  var resolvedResponseType: Type | scala.Null = js.native
  /** Whether responses are streamed or not. */
  var responseStream: js.UndefOr[scala.Boolean] = js.native
  /** Response type. */
