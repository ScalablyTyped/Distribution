...
object Namespace {
  ...
  /**
    ...
    */
  @scala.inline
  def arrayToJSON(array: js.Array[ReflectionObject]): js.UndefOr[StringDictionary[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayToJSON")(array.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[StringDictionary[js.Any]]]
  @scala.inline
  def arrayToJSON(array: js.Array[ReflectionObject], toJSONOptions: IToJSONOptions): js.UndefOr[StringDictionary[js.Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("arrayToJSON")(array.asInstanceOf[js.Any], toJSONOptions.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[StringDictionary[js.Any]]]
  ...
  /**
    ...
    */
  @scala.inline
  def fromJSON(name: String, json: StringDictionary[js.Any]): Namespace = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[Namespace]
