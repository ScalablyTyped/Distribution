...
object util {
  ...
  class LongBits protected () extends StObject {
    ...
    /**
      ...
      * @returns Long
      */
    def toLong(): typings.protobufjs.mod.Long = js.native
    def toLong(unsigned: Boolean): typings.protobufjs.mod.Long = js.native
  ...
  object LongBits {
    ...
    /**
      ...
      */
    /* static member */
    inline def from(value: typings.protobufjs.mod.Long): LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[LongBits]
