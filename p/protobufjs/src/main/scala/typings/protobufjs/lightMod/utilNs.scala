...
object utilNs extends js.Object {
  ...
  class EventEmitter ()
    extends typings.protobufjs.protobufjsMod.utilNs.EventEmitter
  ...
  class LongBits protected ()
    extends typings.protobufjs.protobufjsMod.utilNs.LongBits {
    /**
  ...
  class ProtocolError[T /* <: typings.protobufjs.protobufjsMod.Message[T] */] protected ()
    extends typings.protobufjs.protobufjsMod.utilNs.ProtocolError[T] {
    /**
  ...
  object LongBits extends js.Object {
    /** Zero bits. */
    var zero: typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
    /** Zero hash. */
    var zeroHash: String = js.native
    def from(value: String): typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
    def from(value: Double): typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
    /**
      * Constructs new long bits from a number, long or string.
      * @param value Value
      * @returns Instance
      */
    def from(value: typings.protobufjs.protobufjsMod.Long): typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
    /**
      * Constructs new long bits from the specified 8 characters long hash.
      * @param hash Hash
      * @returns Bits
      */
    def fromHash(hash: String): typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
    /**
      * Constructs new long bits from the specified number.
      * @param value Value
      * @returns Instance
      */
    def fromNumber(value: Double): typings.protobufjs.protobufjsMod.utilNs.LongBits = js.native
  }
