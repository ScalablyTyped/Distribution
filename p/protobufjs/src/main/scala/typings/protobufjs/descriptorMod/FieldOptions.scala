...
/* Inlined protobufjs.protobufjs.Type & {  CType :protobufjs.protobufjs.Enum,   JSType :protobufjs.protobufjs.Enum} */
object FieldOptions {
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.add")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.addJSON")
  @js.native
  ...
  /** Comment text, if any. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.constructor")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.ctor")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.d")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.decode")
  @js.native
  ...
  /**
    ...
    * @throws {util.ProtocolError} If required fields are missing
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.decodeDelimited")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.define")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.encode")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.encodeDelimited")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.extensions")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.filename")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.fromJSON")
  @js.native
  ...
  /**
    ...
    * @returns Message instance
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.fromObject")
  @js.native
  def fromObject(`object`: StringDictionary[js.Any]): Message[js.Object] = js.native
  
  /** Full name including leading dot. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.fullName")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.generateConstructor")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.get")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.getEnum")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.getOption")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.isReservedId")
  @js.native
  ...
  /**
    ...
    * @returns `true` if reserved, otherwise `false`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.isReservedName")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.lookup")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.lookupEnum")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.lookupService")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.lookupType")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.lookupTypeOrEnum")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.name")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.nestedArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.onAdd")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.onRemove")
  @js.native
  def onRemove(parent: ReflectionObject): Unit = js.native
  
  /** Oneofs of this message as an array for iteration. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.parent")
  @js.native
  ...
  /** Parsed Options. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.parsedOptions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.remove")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.reserved")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.resolve")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.resolveAll")
  @js.native
  def resolveAll(): Namespace = js.native
  
  /** Whether already resolved or not. */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.resolved")
  @js.native
  ...
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.root")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.setOption")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.setOptions")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.setParsedOption")
  @js.native
  ...
  /**
    ...
    * @returns `this`
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.setup")
  @js.native
  ...
  /**
    ...
    * @returns Descriptor
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.toJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.toObject")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.toString")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/ext/descriptor", "FieldOptions.verify")
  @js.native
