...
object Namespace {
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "Namespace.arrayToJSON")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("protobufjs/minimal", "Namespace.fromJSON")
  @js.native
  def fromJSON(name: String, json: StringDictionary[js.Any]): typings.protobufjs.mod.Namespace = js.native
  
  @JSImport("protobufjs/minimal", "Namespace.isReservedId")
  @js.native
  ...
  @JSImport("protobufjs/minimal", "Namespace.isReservedName")
  @js.native
