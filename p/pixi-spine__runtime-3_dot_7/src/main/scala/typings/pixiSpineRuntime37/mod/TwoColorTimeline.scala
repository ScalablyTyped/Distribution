...
@JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline")
@js.native
...
object TwoColorTimeline {
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.A")
  @js.native
  def A: Double = js.native
  inline def A_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("A")(x.asInstanceOf[js.Any])
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.B")
  @js.native
  def B: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.B2")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.ENTRIES")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.G")
  @js.native
  def G: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.G2")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_A")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_B")
  @js.native
  def PREV_B: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_B2")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_G")
  @js.native
  def PREV_G: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_G2")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_R")
  @js.native
  def PREV_R: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_R2")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.PREV_TIME")
  @js.native
  ...
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.R")
  @js.native
  def R: Double = js.native
  
  @JSImport("@pixi-spine/runtime-3.7", "TwoColorTimeline.R2")
  @js.native
