...
- typings.pixiSpineBase.mod.IRegionAttachment because var conflicts: name, `type`. Inlined x, rotation, height, y, region, color, scaleX, width, scaleY */ @JSImport("@pixi-spine/runtime-3.7", "RegionAttachment")
@js.native
