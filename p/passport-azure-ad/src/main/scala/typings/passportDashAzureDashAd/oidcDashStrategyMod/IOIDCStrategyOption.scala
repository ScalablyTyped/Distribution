...
object IOIDCStrategyOption {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(clientID = clientID, identityMetadata = identityMetadata, redirectUrl = redirectUrl, responseMode = responseMode.asInstanceOf[js.Any], responseType = responseType.asInstanceOf[js.Any])
