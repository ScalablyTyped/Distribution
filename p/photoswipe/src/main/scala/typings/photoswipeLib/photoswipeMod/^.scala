...
class ^[T /* <: Options */] protected () extends PhotoSwipe[T] {
  /**
    ...
    * (4) Options.
    */
  def this(pswpElement: stdLib.HTMLElement, uiConstructor: org.scalablytyped.runtime.Instantiable2[/* pswp */ PhotoSwipe[T], /* framework */ UIFramework, UI[T]], items: js.Array[Item], options: T) = this()
  def this(pswpElement: stdLib.HTMLElement, uiConstructor: scala.Boolean, items: js.Array[Item], options: T) = this()
}
