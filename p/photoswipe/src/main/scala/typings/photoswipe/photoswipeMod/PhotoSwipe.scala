...
import typings.photoswipe.Anon_Prevent
import typings.photoswipe.Anon_X
...
trait PhotoSwipe[T /* <: Options */] extends js.Object {
  ...
  /**
    ...
    */
  var viewportSize: Anon_X = js.native
  /**
  ...
  def listen_preventDragEvent(
    ...
    callback: js.Function3[/* e */ MouseEvent, /* isDown */ Boolean, /* preventObj */ Anon_Prevent, Unit]
  ): Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def zoomTo(destZoomLevel: Double, centerPoint: Anon_X, speed: Double): Unit = js.native
  def zoomTo(
