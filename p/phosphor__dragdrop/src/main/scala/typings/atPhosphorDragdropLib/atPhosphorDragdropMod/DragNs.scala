...
object DragNs extends js.Object {
  ...
  trait IOptions extends js.Object {
    /**
      ...
      */
    var dragImage: js.UndefOr[stdLib.HTMLElement] = js.undefined
    /**
      * The populated mime data for the drag operation.
      */
    var mimeData: atPhosphorCoreutilsLib.atPhosphorCoreutilsMod.MimeData
    /**
      ...
      */
    var proposedAction: js.UndefOr[atPhosphorDragdropLib.atPhosphorDragdropMod.DropAction] = js.undefined
    /**
    ...
    /**
      ...
      */
    var supportedActions: js.UndefOr[atPhosphorDragdropLib.atPhosphorDragdropMod.SupportedActions] = js.undefined
  }
  ...
  /**
    ...
    * ```
    */
  def overrideCursor(cursor: java.lang.String): atPhosphorDisposableLib.atPhosphorDisposableMod.IDisposable = js.native
}
