...
object typesMod {
  ...
  */
  ...
  object Point {
    ...
    @scala.inline
    def Point2D(x: Double, y: Double): typings.popmotionPopcorn.typesMod.Point2D = {
      val __obj = js.Dynamic.literal(x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.popmotionPopcorn.typesMod.Point2D]
    }
    
    @scala.inline
    def Point3D(x: Double, y: Double, z: Double): typings.popmotionPopcorn.typesMod.Point3D = {
