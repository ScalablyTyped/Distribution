package typings
package atPulumiKubernetesLib.coordinationV1LeaseMod
...
class Lease protected ()
  ...
  /**
    ...
    */
  val spec: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.typesOutputMod.coordinationNs.v1Ns.LeaseSpec] = js.native
  def getInputs(): atPulumiKubernetesLib.typesInputMod.coordinationNs.v1Ns.Lease = js.native
}
