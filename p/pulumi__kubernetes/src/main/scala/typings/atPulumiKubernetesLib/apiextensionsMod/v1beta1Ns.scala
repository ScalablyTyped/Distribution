...
@JSImport("@pulumi/kubernetes/apiextensions", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class CustomResourceDefinition protected ()
    extends atPulumiKubernetesLib.apiextensionsV1beta1Mod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends atPulumiKubernetesLib.apiextensionsV1beta1Mod.CustomResourceDefinitionList {
    /**
  ...
  object CustomResourceDefinition extends js.Object {
    ...
    /**
      ...
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apiextensions/v1beta1/CustomResourceDefinition.CustomResourceDefinition */ scala.Boolean = js.native
  }
