package typings
package atPulumiKubernetesLib.rbacV1alpha1RoleBindingListMod
...
class RoleBindingList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.rbacNs.v1alpha1Ns.RoleBinding]] = js.native
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.RoleBindingList] = js.native
  /**
...
object RoleBindingList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1alpha1/RoleBindingList.RoleBindingList */ scala.Boolean = js.native
}
