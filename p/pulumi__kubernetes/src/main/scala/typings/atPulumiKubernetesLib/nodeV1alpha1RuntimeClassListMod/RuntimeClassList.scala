package typings
package atPulumiKubernetesLib.nodeV1alpha1RuntimeClassListMod
...
class RuntimeClassList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.nodeNs.v1alpha1Ns.RuntimeClass]] = js.native
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.RuntimeClassList] = js.native
  /**
  ...
  def getInputs(): atPulumiKubernetesLib.typesInputMod.nodeNs.v1alpha1Ns.RuntimeClassList = js.native
}
