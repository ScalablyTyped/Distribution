package typings
package atPulumiKubernetesLib.extensionsMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@pulumi/kubernetes/extensions", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class DaemonSet protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.DaemonSet {
    /**
  ...
  class DaemonSetList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.DaemonSetList {
    /**
  ...
  class Deployment protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.Deployment {
    /**
  ...
  class DeploymentList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.DeploymentList {
    /**
  ...
  class Ingress protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.Ingress {
    /**
  ...
  class IngressList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.IngressList {
    /**
  ...
  class NetworkPolicy protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.NetworkPolicy {
    /**
  ...
  class NetworkPolicyList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.NetworkPolicyList {
    /**
  ...
  class PodSecurityPolicy protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.PodSecurityPolicy {
    /**
  ...
  class PodSecurityPolicyList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.PodSecurityPolicyList {
    /**
  ...
  class ReplicaSet protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.ReplicaSet {
    /**
  ...
  class ReplicaSetList protected ()
    extends atPulumiKubernetesLib.extensionsV1beta1Mod.ReplicaSetList {
    /**
  ...
  object DaemonSet extends js.Object {
    ...
    /**
      ...
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/DaemonSet.DaemonSet */ scala.Boolean = js.native
  }
  ...
  object Ingress extends js.Object {
    ...
    /**
      ...
      * when multiple copies of the Pulumi SDK have been loaded into the same process.
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/Ingress.Ingress */ scala.Boolean = js.native
  }
  ...
  object IngressList extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiKubernetesLib.extensionsV1beta1IngressListMod.IngressList = js.native
    def get(
      name: java.lang.String,
      id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID],
      opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions
    ): atPulumiKubernetesLib.extensionsV1beta1IngressListMod.IngressList = js.native
    /**
      * Returns true if the given object is an instance of IngressList.  This is designed to work even
      * when multiple copies of the Pulumi SDK have been loaded into the same process.
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/IngressList.IngressList */ scala.Boolean = js.native
  }
  ...
  object NetworkPolicy extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiKubernetesLib.extensionsV1beta1NetworkPolicyMod.NetworkPolicy = js.native
    def get(
      name: java.lang.String,
      id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID],
      opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions
    ): atPulumiKubernetesLib.extensionsV1beta1NetworkPolicyMod.NetworkPolicy = js.native
    /**
      * Returns true if the given object is an instance of NetworkPolicy.  This is designed to work even
      * when multiple copies of the Pulumi SDK have been loaded into the same process.
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/NetworkPolicy.NetworkPolicy */ scala.Boolean = js.native
  }
