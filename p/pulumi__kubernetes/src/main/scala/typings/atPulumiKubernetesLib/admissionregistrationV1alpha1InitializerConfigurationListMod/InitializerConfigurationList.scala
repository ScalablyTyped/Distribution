package typings
package atPulumiKubernetesLib.admissionregistrationV1alpha1InitializerConfigurationListMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@pulumi/kubernetes/admissionregistration/v1alpha1/InitializerConfigurationList", "InitializerConfigurationList")
@js.native
class InitializerConfigurationList protected ()
  ...
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.InitializerConfigurationList] = js.native
  /**
