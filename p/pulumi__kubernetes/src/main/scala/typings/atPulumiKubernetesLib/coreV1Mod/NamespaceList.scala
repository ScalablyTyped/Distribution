...
class NamespaceList protected ()
  extends atPulumiKubernetesLib.coreV1NamespaceListMod.NamespaceList {
  /**
...
object NamespaceList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/NamespaceList.NamespaceList */ scala.Boolean = js.native
}
