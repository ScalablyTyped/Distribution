...
class PodTemplate protected ()
  extends atPulumiKubernetesLib.coreV1PodTemplateMod.PodTemplate {
  /**
...
object PodTemplate extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/PodTemplate.PodTemplate */ scala.Boolean = js.native
}
