...
class ServiceAccountList protected ()
  extends atPulumiKubernetesLib.coreV1ServiceAccountListMod.ServiceAccountList {
  /**
...
object ServiceAccountList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/ServiceAccountList.ServiceAccountList */ scala.Boolean = js.native
}
