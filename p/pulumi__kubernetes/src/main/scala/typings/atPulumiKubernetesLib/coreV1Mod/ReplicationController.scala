...
class ReplicationController protected ()
  extends atPulumiKubernetesLib.coreV1ReplicationControllerMod.ReplicationController {
  /**
...
object ReplicationController extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/ReplicationController.ReplicationController */ scala.Boolean = js.native
}
