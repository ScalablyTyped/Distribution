...
class PersistentVolumeList protected ()
  extends atPulumiKubernetesLib.coreV1PersistentVolumeListMod.PersistentVolumeList {
  /**
...
object PersistentVolumeList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/PersistentVolumeList.PersistentVolumeList */ scala.Boolean = js.native
}
