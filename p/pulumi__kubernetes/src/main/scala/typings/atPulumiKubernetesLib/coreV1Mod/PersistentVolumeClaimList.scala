...
class PersistentVolumeClaimList protected ()
  extends atPulumiKubernetesLib.coreV1PersistentVolumeClaimListMod.PersistentVolumeClaimList {
  /**
...
object PersistentVolumeClaimList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/core/v1/PersistentVolumeClaimList.PersistentVolumeClaimList */ scala.Boolean = js.native
}
