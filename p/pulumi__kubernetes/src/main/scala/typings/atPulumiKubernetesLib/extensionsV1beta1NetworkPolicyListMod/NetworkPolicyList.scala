package typings
package atPulumiKubernetesLib.extensionsV1beta1NetworkPolicyListMod
...
class NetworkPolicyList protected ()
  ...
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.NetworkPolicyList] = js.native
  /**
...
object NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/NetworkPolicyList.NetworkPolicyList */ scala.Boolean = js.native
}
