...
object v2beta1Ns extends js.Object {
  ...
  class HorizontalPodAutoscaler protected ()
    extends atPulumiKubernetesLib.autoscalingV2beta1Mod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends atPulumiKubernetesLib.autoscalingV2beta1Mod.HorizontalPodAutoscalerList {
    /**
