package typings
package atPulumiKubernetesLib.authenticationV1TokenReviewMod
...
object TokenReview extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/authentication/v1/TokenReview.TokenReview */ scala.Boolean = js.native
}
