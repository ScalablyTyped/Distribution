...
object v1beta1Ns extends js.Object {
  ...
  class StorageClassList protected ()
    extends atPulumiKubernetesLib.storageV1beta1Mod.StorageClassList {
    /**
  ...
  class VolumeAttachment protected ()
    extends atPulumiKubernetesLib.storageV1beta1Mod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends atPulumiKubernetesLib.storageV1beta1Mod.VolumeAttachmentList {
    /**
