package typings
package atPulumiKubernetesLib.admissionregistrationV1beta1MutatingWebhookConfigurationMod
...
class MutatingWebhookConfiguration protected ()
  ...
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.MutatingWebhookConfiguration] = js.native
  /**
