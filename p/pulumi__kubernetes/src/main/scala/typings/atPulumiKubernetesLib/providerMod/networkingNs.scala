  ...
  object v1Ns extends js.Object {
    ...
    class NetworkPolicy protected ()
      ...
      /**
        ...
        */
      val apiVersion: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`networkingDOTk8sDOTio/v1`] = js.native
      /**
      ...
      /**
        ...
        */
      val spec: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.typesOutputMod.networkingNs.v1Ns.NetworkPolicySpec] = js.native
    ...
    class NetworkPolicyList protected ()
      ...
      /**
        ...
        */
      val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.networkingNs.v1Ns.NetworkPolicy]] = js.native
      /**
        * Kind is a string value representing the REST resource this object represents. Servers may
        * infer this from the endpoint the client submits requests to. Cannot be updated. In
        * CamelCase. More info:
