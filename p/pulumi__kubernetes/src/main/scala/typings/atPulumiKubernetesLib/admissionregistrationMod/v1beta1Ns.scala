...
object v1beta1Ns extends js.Object {
  ...
  class MutatingWebhookConfiguration protected ()
    extends atPulumiKubernetesLib.admissionregistrationV1beta1Mod.MutatingWebhookConfiguration {
    /**
  ...
  class MutatingWebhookConfigurationList protected ()
    extends atPulumiKubernetesLib.admissionregistrationV1beta1Mod.MutatingWebhookConfigurationList {
    /**
  ...
  class ValidatingWebhookConfiguration protected ()
    extends atPulumiKubernetesLib.admissionregistrationV1beta1Mod.ValidatingWebhookConfiguration {
    /**
  ...
  class ValidatingWebhookConfigurationList protected ()
    extends atPulumiKubernetesLib.admissionregistrationV1beta1Mod.ValidatingWebhookConfigurationList {
    /**
