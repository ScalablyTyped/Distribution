...
class PodSecurityPolicy protected ()
  extends atPulumiKubernetesLib.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy {
  /**
...
object PodSecurityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: java.lang.String, id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID]): atPulumiKubernetesLib.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  def get(
    name: java.lang.String,
    id: atPulumiPulumiLib.outputMod.Input[atPulumiPulumiLib.resourceMod.ID],
    opts: atPulumiPulumiLib.resourceMod.CustomResourceOptions
  ): atPulumiKubernetesLib.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  /**
    * Returns true if the given object is an instance of PodSecurityPolicy.  This is designed to work even
    * when multiple copies of the Pulumi SDK have been loaded into the same process.
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/PodSecurityPolicy.PodSecurityPolicy */ scala.Boolean = js.native
}
