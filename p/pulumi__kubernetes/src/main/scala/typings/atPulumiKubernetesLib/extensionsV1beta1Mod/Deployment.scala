...
class Deployment protected ()
  extends atPulumiKubernetesLib.extensionsV1beta1DeploymentMod.Deployment {
  /**
...
object Deployment extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/extensions/v1beta1/Deployment.Deployment */ scala.Boolean = js.native
}
