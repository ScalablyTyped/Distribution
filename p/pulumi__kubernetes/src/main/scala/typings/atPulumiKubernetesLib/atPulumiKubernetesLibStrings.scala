package typings
package atPulumiKubernetesLib

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object atPulumiKubernetesLibStrings {
  @js.native
  ...
  @js.native
  sealed trait `apps/v1beta1/DeploymentRollback` extends js.Object
  
  @js.native
  sealed trait `apps/v1beta1/Scale` extends js.Object
  ...
  @js.native
  sealed trait `apps/v1beta2/Scale` extends js.Object
  ...
  @js.native
  sealed trait `autoscaling/v1/CrossVersionObjectReference` extends js.Object
  ...
  @js.native
  sealed trait `autoscaling/v1/Scale` extends js.Object
  
  @js.native
  sealed trait `autoscaling/v2beta1/CrossVersionObjectReference` extends js.Object
  ...
  @js.native
  sealed trait `autoscaling/v2beta2/CrossVersionObjectReference` extends js.Object
  ...
  @js.native
  sealed trait block_owner_deletion extends js.Object
  ...
  @js.native
  sealed trait `core/v1/ObjectReference` extends js.Object
  ...
  @js.native
  sealed trait delete_options extends js.Object
  ...
  @js.native
  sealed trait dry_run extends js.Object
  ...
  @js.native
  sealed trait `extensions/v1beta1/DeploymentRollback` extends js.Object
  ...
  @js.native
  sealed trait `extensions/v1beta1/Scale` extends js.Object
  
  @js.native
  sealed trait field_path extends js.Object
  ...
  @js.native
  sealed trait grace_period_seconds extends js.Object
  
  @js.native
  sealed trait group_version extends js.Object
  ...
  @js.native
  sealed trait `meta/v1/OwnerReference` extends js.Object
  ...
  @js.native
  sealed trait orphan_dependents extends js.Object
  
  @js.native
  sealed trait parameters extends js.Object
  
  @js.native
  sealed trait `policy/v1beta1/Eviction` extends js.Object
  ...
  @js.native
  sealed trait preconditions extends js.Object
  
  @js.native
  sealed trait preferred_version extends js.Object
  
  @js.native
  sealed trait propagation_policy extends js.Object
  
  @js.native
  sealed trait provisioner extends js.Object
  
  @js.native
  sealed trait `rbac/v1alpha1/Subject` extends js.Object
  ...
  @js.native
  sealed trait resource_version extends js.Object
  ...
  @js.native
  sealed trait rollback_to extends js.Object
  ...
  @js.native
  sealed trait server_address_by_client_cid_rs extends js.Object
  ...
  @js.native
  sealed trait updated_annotations extends js.Object
  
  @js.native
  sealed trait `v1/APIGroup` extends js.Object
  
  @js.native
  sealed trait `v1/APIGroupList` extends js.Object
  
  @js.native
  sealed trait `v1/APIResourceList` extends js.Object
  
  @js.native
  sealed trait `v1/APIVersions` extends js.Object
  ...
  @js.native
  sealed trait `v1/DeleteOptions` extends js.Object
  ...
  def `apps/v1beta1/DeploymentRollback`: `apps/v1beta1/DeploymentRollback` = "apps/v1beta1/DeploymentRollback".asInstanceOf[`apps/v1beta1/DeploymentRollback`]
  def `apps/v1beta1/Scale`: `apps/v1beta1/Scale` = "apps/v1beta1/Scale".asInstanceOf[`apps/v1beta1/Scale`]
  ...
  def `apps/v1beta2/Scale`: `apps/v1beta2/Scale` = "apps/v1beta2/Scale".asInstanceOf[`apps/v1beta2/Scale`]
  ...
  def `autoscaling/v1/CrossVersionObjectReference`: `autoscaling/v1/CrossVersionObjectReference` = "autoscaling/v1/CrossVersionObjectReference".asInstanceOf[`autoscaling/v1/CrossVersionObjectReference`]
  ...
  def `autoscaling/v1/Scale`: `autoscaling/v1/Scale` = "autoscaling/v1/Scale".asInstanceOf[`autoscaling/v1/Scale`]
  def `autoscaling/v2beta1/CrossVersionObjectReference`: `autoscaling/v2beta1/CrossVersionObjectReference` = "autoscaling/v2beta1/CrossVersionObjectReference".asInstanceOf[`autoscaling/v2beta1/CrossVersionObjectReference`]
  ...
  def `autoscaling/v2beta2/CrossVersionObjectReference`: `autoscaling/v2beta2/CrossVersionObjectReference` = "autoscaling/v2beta2/CrossVersionObjectReference".asInstanceOf[`autoscaling/v2beta2/CrossVersionObjectReference`]
  ...
  def block_owner_deletion: block_owner_deletion = "block_owner_deletion".asInstanceOf[block_owner_deletion]
  ...
  def `core/v1/ObjectReference`: `core/v1/ObjectReference` = "core/v1/ObjectReference".asInstanceOf[`core/v1/ObjectReference`]
  def count: count = "count".asInstanceOf[count]
  def data: data = "data".asInstanceOf[data]
  def delete_options: delete_options = "delete_options".asInstanceOf[delete_options]
  ...
  def dry_run: dry_run = "dry_run".asInstanceOf[dry_run]
  ...
  def `extensions/v1beta1/DeploymentRollback`: `extensions/v1beta1/DeploymentRollback` = "extensions/v1beta1/DeploymentRollback".asInstanceOf[`extensions/v1beta1/DeploymentRollback`]
  ...
  def `extensions/v1beta1/Scale`: `extensions/v1beta1/Scale` = "extensions/v1beta1/Scale".asInstanceOf[`extensions/v1beta1/Scale`]
  def field_path: field_path = "field_path".asInstanceOf[field_path]
  ...
  def grace_period_seconds: grace_period_seconds = "grace_period_seconds".asInstanceOf[grace_period_seconds]
  def group_version: group_version = "group_version".asInstanceOf[group_version]
  ...
  def `meta/v1/OwnerReference`: `meta/v1/OwnerReference` = "meta/v1/OwnerReference".asInstanceOf[`meta/v1/OwnerReference`]
  ...
  def orphan_dependents: orphan_dependents = "orphan_dependents".asInstanceOf[orphan_dependents]
  def parameters: parameters = "parameters".asInstanceOf[parameters]
  def `policy/v1beta1/Eviction`: `policy/v1beta1/Eviction` = "policy/v1beta1/Eviction".asInstanceOf[`policy/v1beta1/Eviction`]
  ...
  def preconditions: preconditions = "preconditions".asInstanceOf[preconditions]
  def preferred_version: preferred_version = "preferred_version".asInstanceOf[preferred_version]
  def propagation_policy: propagation_policy = "propagation_policy".asInstanceOf[propagation_policy]
  def provisioner: provisioner = "provisioner".asInstanceOf[provisioner]
  def `rbac/v1alpha1/Subject`: `rbac/v1alpha1/Subject` = "rbac/v1alpha1/Subject".asInstanceOf[`rbac/v1alpha1/Subject`]
  ...
  def resource_version: resource_version = "resource_version".asInstanceOf[resource_version]
  ...
  def rollback_to: rollback_to = "rollback_to".asInstanceOf[rollback_to]
  ...
  def server_address_by_client_cid_rs: server_address_by_client_cid_rs = "server_address_by_client_cid_rs".asInstanceOf[server_address_by_client_cid_rs]
  ...
  def updated_annotations: updated_annotations = "updated_annotations".asInstanceOf[updated_annotations]
  def `v1/APIGroup`: `v1/APIGroup` = "v1/APIGroup".asInstanceOf[`v1/APIGroup`]
  def `v1/APIGroupList`: `v1/APIGroupList` = "v1/APIGroupList".asInstanceOf[`v1/APIGroupList`]
  def `v1/APIResourceList`: `v1/APIResourceList` = "v1/APIResourceList".asInstanceOf[`v1/APIResourceList`]
  def `v1/APIVersions`: `v1/APIVersions` = "v1/APIVersions".asInstanceOf[`v1/APIVersions`]
  ...
  def `v1/DeleteOptions`: `v1/DeleteOptions` = "v1/DeleteOptions".asInstanceOf[`v1/DeleteOptions`]
  ...
  def versions: versions = "versions".asInstanceOf[versions]
