package typings
package atPulumiKubernetesLib.nodeV1alpha1RuntimeClassMod
...
class RuntimeClass protected ()
  ...
  /**
    ...
    */
  val apiVersion: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`nodeDOTk8sDOTio/v1alpha1`] = js.native
  /**
  ...
  /**
    ...
    */
  val spec: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.typesOutputMod.nodeNs.v1alpha1Ns.RuntimeClassSpec] = js.native
  def getInputs(): atPulumiKubernetesLib.typesInputMod.nodeNs.v1alpha1Ns.RuntimeClass = js.native
}
