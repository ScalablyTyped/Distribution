...
class ClusterRoleBinding protected ()
  extends atPulumiKubernetesLib.rbacV1alpha1ClusterRoleBindingMod.ClusterRoleBinding {
  /**
...
object ClusterRoleBinding extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/rbac/v1alpha1/ClusterRoleBinding.ClusterRoleBinding */ scala.Boolean = js.native
}
