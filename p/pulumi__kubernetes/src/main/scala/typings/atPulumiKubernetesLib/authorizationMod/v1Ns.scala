...
object v1Ns extends js.Object {
  ...
  class LocalSubjectAccessReview protected ()
    extends atPulumiKubernetesLib.authorizationV1Mod.LocalSubjectAccessReview {
    /**
  ...
  class SelfSubjectAccessReview protected ()
    extends atPulumiKubernetesLib.authorizationV1Mod.SelfSubjectAccessReview {
    /**
  ...
  class SelfSubjectRulesReview protected ()
    extends atPulumiKubernetesLib.authorizationV1Mod.SelfSubjectRulesReview {
    /**
  ...
  class SubjectAccessReview protected ()
    extends atPulumiKubernetesLib.authorizationV1Mod.SubjectAccessReview {
    /**
  ...
  object LocalSubjectAccessReview extends js.Object {
    ...
    /**
      ...
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/authorization/v1/LocalSubjectAccessReview.LocalSubjectAccessReview */ scala.Boolean = js.native
  }
  ...
  object SelfSubjectRulesReview extends js.Object {
    ...
    /**
      ...
      * when multiple copies of the Pulumi SDK have been loaded into the same process.
      */
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/authorization/v1/SelfSubjectRulesReview.SelfSubjectRulesReview */ scala.Boolean = js.native
  }
