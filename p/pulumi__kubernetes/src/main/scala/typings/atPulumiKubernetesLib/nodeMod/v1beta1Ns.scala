...
@JSImport("@pulumi/kubernetes/node", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class RuntimeClass protected ()
    extends atPulumiKubernetesLib.nodeV1beta1Mod.RuntimeClass {
    /**
  ...
  class RuntimeClassList protected ()
    extends atPulumiKubernetesLib.nodeV1beta1Mod.RuntimeClassList {
    /**
