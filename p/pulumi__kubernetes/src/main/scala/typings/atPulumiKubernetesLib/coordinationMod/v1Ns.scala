package typings
package atPulumiKubernetesLib.coordinationMod
...
object v1Ns extends js.Object {
  ...
  class Lease protected ()
    extends atPulumiKubernetesLib.coordinationV1Mod.Lease {
    /**
  ...
  class LeaseList protected ()
    extends atPulumiKubernetesLib.coordinationV1Mod.LeaseList {
    /**
