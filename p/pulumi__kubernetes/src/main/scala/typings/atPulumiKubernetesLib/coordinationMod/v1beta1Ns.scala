...
@JSImport("@pulumi/kubernetes/coordination", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class Lease protected ()
    extends atPulumiKubernetesLib.coordinationV1beta1Mod.Lease {
    /**
  ...
  class LeaseList protected ()
    extends atPulumiKubernetesLib.coordinationV1beta1Mod.LeaseList {
    /**
