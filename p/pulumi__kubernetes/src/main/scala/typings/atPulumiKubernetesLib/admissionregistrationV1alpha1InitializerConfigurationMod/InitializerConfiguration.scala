package typings
package atPulumiKubernetesLib.admissionregistrationV1alpha1InitializerConfigurationMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@pulumi/kubernetes/admissionregistration/v1alpha1/InitializerConfiguration", "InitializerConfiguration")
@js.native
class InitializerConfiguration protected ()
  ...
  /**
    ...
    */
  val initializers: atPulumiPulumiLib.outputMod.Output[
    js.Array[
  ...
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.InitializerConfiguration] = js.native
  /**
