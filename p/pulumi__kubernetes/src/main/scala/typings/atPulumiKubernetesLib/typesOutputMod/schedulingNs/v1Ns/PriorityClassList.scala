package typings
package atPulumiKubernetesLib.typesOutputMod.schedulingNs.v1Ns
...
trait PriorityClassList extends js.Object {
  /**
    ...
    */
  val apiVersion: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`schedulingDOTk8sDOTio/v1`
  /**
...
object PriorityClassList {
  @scala.inline
  def apply(
    apiVersion: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`schedulingDOTk8sDOTio/v1`,
