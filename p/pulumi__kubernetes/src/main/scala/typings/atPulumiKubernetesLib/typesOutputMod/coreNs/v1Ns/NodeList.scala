...
trait NodeList extends js.Object {
  ...
  /**
    ...
    */
  val kind: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.NodeList
  /**
...
object NodeList {
  ...
  def apply(
    ...
    items: js.Array[Node],
    kind: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.NodeList,
