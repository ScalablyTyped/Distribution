...
trait CSIDriverSpec extends js.Object {
  /**
    ...
    */
  val attachRequired: scala.Boolean
  /**
    ...
    * string(pod.UID)
    */
  val podInfoOnMount: scala.Boolean
}

object CSIDriverSpec {
  @scala.inline
  def apply(attachRequired: scala.Boolean, podInfoOnMount: scala.Boolean): CSIDriverSpec = {
    val __obj = js.Dynamic.literal(attachRequired = attachRequired, podInfoOnMount = podInfoOnMount)
