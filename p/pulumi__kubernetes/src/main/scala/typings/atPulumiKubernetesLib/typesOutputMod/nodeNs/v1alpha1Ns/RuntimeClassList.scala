...
trait RuntimeClassList extends js.Object {
  /**
    ...
    */
  val apiVersion: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`nodeDOTk8sDOTio/v1alpha1`
  /**
...
object RuntimeClassList {
  @scala.inline
  def apply(
    apiVersion: atPulumiKubernetesLib.atPulumiKubernetesLibStrings.`nodeDOTk8sDOTio/v1alpha1`,
