...
trait ObjectMeta extends js.Object {
  ...
  /**
    ...
    */
  val creationTimestamp: java.lang.String
  /**
    ...
    * Read-only.
    */
  val deletionGracePeriodSeconds: scala.Double
  /**
    ...
    * https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata
    */
  val deletionTimestamp: java.lang.String
  /**
