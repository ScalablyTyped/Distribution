package typings
package atPulumiKubernetesLib.storageV1beta1CSINodeListMod
...
class CSINodeList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.storageNs.v1beta1Ns.CSINode]] = js.native
  /**
    ...
    */
  val kind: atPulumiPulumiLib.outputMod.Output[atPulumiKubernetesLib.atPulumiKubernetesLibStrings.CSINodeList] = js.native
  /**
  ...
  def getInputs(): atPulumiKubernetesLib.typesInputMod.storageNs.v1beta1Ns.CSINodeList = js.native
}
