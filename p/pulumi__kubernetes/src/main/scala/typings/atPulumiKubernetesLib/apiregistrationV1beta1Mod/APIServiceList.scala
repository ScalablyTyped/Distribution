package typings
package atPulumiKubernetesLib.apiregistrationV1beta1Mod
...
class APIServiceList protected ()
  extends atPulumiKubernetesLib.apiregistrationV1beta1APIServiceListMod.APIServiceList {
  /**
...
object APIServiceList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apiregistration/v1beta1/APIServiceList.APIServiceList */ scala.Boolean = js.native
}
