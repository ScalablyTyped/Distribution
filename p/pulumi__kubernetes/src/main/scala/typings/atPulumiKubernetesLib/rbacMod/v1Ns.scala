...
object v1Ns extends js.Object {
  ...
  class ClusterRole protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.ClusterRole {
    /**
  ...
  class ClusterRoleBinding protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.ClusterRoleBinding {
    /**
  ...
  class ClusterRoleBindingList protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.ClusterRoleBindingList {
    /**
  ...
  class ClusterRoleList protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.ClusterRoleList {
    /**
  ...
  class Role protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.Role {
    /**
  ...
  class RoleBinding protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.RoleBinding {
    /**
  ...
  class RoleBindingList protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.RoleBindingList {
    /**
  ...
  class RoleList protected ()
    extends atPulumiKubernetesLib.rbacV1Mod.RoleList {
    /**
