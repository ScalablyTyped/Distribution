package typings
package atPulumiKubernetesLib.networkingV1beta1IngressListMod
...
class IngressList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.networkingNs.v1beta1Ns.Ingress]] = js.native
  /**
  ...
  def getInputs(): atPulumiKubernetesLib.typesInputMod.networkingNs.v1beta1Ns.IngressList = js.native
}
