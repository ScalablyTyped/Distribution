package typings
package atPulumiKubernetesLib.admissionregistrationV1beta1Mod
...
class ValidatingWebhookConfiguration protected ()
  extends atPulumiKubernetesLib.admissionregistrationV1beta1ValidatingWebhookConfigurationMod.ValidatingWebhookConfiguration {
  /**
