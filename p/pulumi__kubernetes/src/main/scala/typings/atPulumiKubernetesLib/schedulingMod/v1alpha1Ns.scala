package typings
package atPulumiKubernetesLib.schedulingMod
...
object v1alpha1Ns extends js.Object {
  ...
  class PriorityClass protected ()
    extends atPulumiKubernetesLib.schedulingV1alpha1Mod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends atPulumiKubernetesLib.schedulingV1alpha1Mod.PriorityClassList {
    /**
