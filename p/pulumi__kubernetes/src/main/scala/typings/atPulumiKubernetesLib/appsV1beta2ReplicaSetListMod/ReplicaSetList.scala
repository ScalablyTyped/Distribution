package typings
package atPulumiKubernetesLib.appsV1beta2ReplicaSetListMod
...
class ReplicaSetList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.appsNs.v1beta2Ns.ReplicaSet]] = js.native
  /**
...
object ReplicaSetList extends js.Object {
  ...
  /**
    ...
    */
  def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1beta2/ReplicaSetList.ReplicaSetList */ scala.Boolean = js.native
}
