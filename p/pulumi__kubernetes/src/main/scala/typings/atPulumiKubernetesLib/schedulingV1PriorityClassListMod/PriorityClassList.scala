package typings
package atPulumiKubernetesLib.schedulingV1PriorityClassListMod
...
class PriorityClassList protected ()
  ...
  /**
    ...
    */
  val items: atPulumiPulumiLib.outputMod.Output[js.Array[atPulumiKubernetesLib.typesOutputMod.schedulingNs.v1Ns.PriorityClass]] = js.native
  /**
  ...
  def getInputs(): atPulumiKubernetesLib.typesInputMod.schedulingNs.v1Ns.PriorityClassList = js.native
}
