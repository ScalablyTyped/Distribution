package typings
package atPulumiKubernetesLib.policyMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("@pulumi/kubernetes/policy", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class PodDisruptionBudget protected ()
    extends atPulumiKubernetesLib.policyV1beta1Mod.PodDisruptionBudget {
    /**
  ...
  class PodDisruptionBudgetList protected ()
    extends atPulumiKubernetesLib.policyV1beta1Mod.PodDisruptionBudgetList {
    /**
  ...
  class PodSecurityPolicy protected ()
    extends atPulumiKubernetesLib.policyV1beta1Mod.PodSecurityPolicy {
    /**
  ...
  class PodSecurityPolicyList protected ()
    extends atPulumiKubernetesLib.policyV1beta1Mod.PodSecurityPolicyList {
    /**
