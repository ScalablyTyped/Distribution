...
@JSImport("@pulumi/kubernetes/admissionregistration/v1alpha1", "InitializerConfigurationList")
@js.native
class InitializerConfigurationList protected ()
  extends atPulumiKubernetesLib.admissionregistrationV1alpha1InitializerConfigurationListMod.InitializerConfigurationList {
  /**
