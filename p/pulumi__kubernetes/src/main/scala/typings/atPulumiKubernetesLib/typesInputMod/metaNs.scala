...
object metaNs extends js.Object {
  ...
  object v1Ns extends js.Object {
    ...
    def isAPIGroup(o: js.Any): /* is APIGroup */scala.Boolean = js.native
    def isAPIGroupList(o: js.Any): /* is APIGroupList */scala.Boolean = js.native
    def isAPIResourceList(o: js.Any): /* is APIResourceList */scala.Boolean = js.native
    def isAPIVersions(o: js.Any): /* is APIVersions */scala.Boolean = js.native
    def isDeleteOptions(o: js.Any): /* is DeleteOptions */scala.Boolean = js.native
    def isOwnerReference(o: js.Any): /* is OwnerReference */scala.Boolean = js.native
    def isStatus(o: js.Any): /* is Status */scala.Boolean = js.native
  }
