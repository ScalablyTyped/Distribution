  ...
  object v1beta1Ns extends js.Object {
    ...
    trait LeaseList extends js.Object {
      ...
      /**
                   ...
                   */
      var items: atPulumiPulumiLib.resourceMod.Input[js.Array[Lease]]
      /**
                   * Kind is a string value representing the REST resource this object represents. Servers may
                   * infer this from the endpoint the client submits requests to. Cannot be updated. In
                   * CamelCase. More info:
    ...
    def isLease(o: js.Any): /* is Lease */scala.Boolean = js.native
    def isLeaseList(o: js.Any): /* is LeaseList */scala.Boolean = js.native
  }
