...
object v1IngressClassListMod {
  ...
  trait IngressClassListArgs extends StObject {
    ...
    /**
      * Items is the list of IngressClasses.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressClass]]]
  ...
  object IngressClassListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressClass]]]): IngressClassListArgs = {
    ...
    extension [Self <: IngressClassListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressClass]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
