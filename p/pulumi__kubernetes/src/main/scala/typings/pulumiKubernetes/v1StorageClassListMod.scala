...
object v1StorageClassListMod {
  ...
  trait StorageClassListArgs extends StObject {
    ...
    /**
      * Items is the list of StorageClasses
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.StorageClass]]] = js.native
  ...
  object StorageClassListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.StorageClass]]]): StorageClassListArgs = {
    ...
    implicit class StorageClassListArgsMutableBuilder[Self <: StorageClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.StorageClass]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.StorageClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
