...
object v1ReplicaSetListMod {
  ...
  object ReplicaSetList {
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1/replicaSetList.ReplicaSetList */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1/replicaSetList.ReplicaSetList */ Boolean]
  }
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      * List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]
  ...
  object ReplicaSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): ReplicaSetListArgs = {
    ...
    implicit class ReplicaSetListArgsMutableBuilder[Self <: ReplicaSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
