...
object v1ReplicaSetListMod {
  ...
  object ReplicaSetList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/replicaSetList", "ReplicaSetList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/replicaSetList", "ReplicaSetList.isInstance")
    @js.native
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      * List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]] = js.native
