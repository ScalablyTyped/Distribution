...
object v1ReplicaSetListMod {
  ...
  object ReplicaSetListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): ReplicaSetListArgs = {
    ...
    extension [Self <: ReplicaSetListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
