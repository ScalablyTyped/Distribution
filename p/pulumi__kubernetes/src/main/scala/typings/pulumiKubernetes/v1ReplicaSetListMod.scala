...
@JSImport("@pulumi/kubernetes/apps/v1/ReplicaSetList", JSImport.Namespace)
@js.native
object v1ReplicaSetListMod extends js.Object {
  @js.native
  class ReplicaSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSetList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSetList,
