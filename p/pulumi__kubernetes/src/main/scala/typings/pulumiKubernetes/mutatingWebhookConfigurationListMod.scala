...
@JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/MutatingWebhookConfigurationList", JSImport.Namespace)
@js.native
object mutatingWebhookConfigurationListMod extends js.Object {
  @js.native
