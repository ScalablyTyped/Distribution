package typings.pulumiKubernetes.v1ValidatingWebhookConfigurationMod

import typings.pulumiKubernetes.inputMod.admissionregistration.v1.ValidatingWebhook
