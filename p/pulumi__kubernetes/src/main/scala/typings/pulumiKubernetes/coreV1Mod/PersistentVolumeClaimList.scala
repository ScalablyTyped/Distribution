...
object PersistentVolumeClaimList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.persistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.persistentVolumeClaimListMod.PersistentVolumeClaimList = js.native
  /**
