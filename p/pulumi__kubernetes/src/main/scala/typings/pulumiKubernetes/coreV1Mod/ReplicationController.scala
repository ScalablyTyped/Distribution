...
class ReplicationController protected ()
  extends typings.pulumiKubernetes.replicationControllerMod.ReplicationController {
  /**
...
object ReplicationController {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.replicationControllerMod.ReplicationController = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.replicationControllerMod.ReplicationController]
  @scala.inline
