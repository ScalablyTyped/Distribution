...
object ReplicationControllerList {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.replicationControllerListMod.ReplicationControllerList]
