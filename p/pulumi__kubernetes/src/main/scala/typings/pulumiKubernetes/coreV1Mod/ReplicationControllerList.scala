...
class ReplicationControllerList protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerList,
