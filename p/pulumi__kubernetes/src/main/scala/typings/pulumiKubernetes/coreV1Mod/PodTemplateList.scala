...
object PodTemplateList {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.podTemplateListMod.PodTemplateList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.podTemplateListMod.PodTemplateList]
  @scala.inline
