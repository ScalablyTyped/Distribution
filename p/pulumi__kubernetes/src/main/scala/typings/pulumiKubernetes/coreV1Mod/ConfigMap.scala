...
class ConfigMap protected ()
  extends typings.pulumiKubernetes.configMapMod.ConfigMap {
  /**
...
object ConfigMap {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.configMapMod.ConfigMap = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.configMapMod.ConfigMap]
  inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.configMapMod.ConfigMap = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.configMapMod.ConfigMap]
