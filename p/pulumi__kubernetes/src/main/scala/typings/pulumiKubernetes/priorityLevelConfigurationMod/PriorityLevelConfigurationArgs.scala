...
import typings.pulumiKubernetes.inputMod.flowcontrol.v1alpha1.PriorityLevelConfigurationSpec
...
@js.native
trait PriorityLevelConfigurationArgs extends js.Object {
  ...
  /**
    ...
    */
  val spec: js.UndefOr[Input[PriorityLevelConfigurationSpec]] = js.native
}
object PriorityLevelConfigurationArgs {
  ...
  @scala.inline
  implicit class PriorityLevelConfigurationArgsOps[Self <: PriorityLevelConfigurationArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfiguration]): Self = this.set("kind", value.asInstanceOf[js.Any])
