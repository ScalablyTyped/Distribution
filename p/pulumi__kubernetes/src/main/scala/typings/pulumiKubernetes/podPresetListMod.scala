...
object podPresetListMod {
  ...
  object PodPresetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset]]]): PodPresetListArgs = {
    ...
    implicit class PodPresetListArgsMutableBuilder[Self <: PodPresetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.settings.v1alpha1.PodPreset]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodPresetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
