...
object storageClassMod extends js.Object {
  ...
  class StorageClass protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.StorageClass,
