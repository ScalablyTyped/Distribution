...
object namespaceListMod {
  ...
  object NamespaceList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): NamespaceList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[NamespaceList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): NamespaceList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[NamespaceList]
  ...
  object NamespaceListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.Namespace]]]): NamespaceListArgs = {
    ...
    implicit class NamespaceListArgsMutableBuilder[Self <: NamespaceListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.Namespace]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.core.v1.Namespace]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NamespaceList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
