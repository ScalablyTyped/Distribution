...
@JSImport("@pulumi/kubernetes/core/v1/SecretList", JSImport.Namespace)
@js.native
object secretListMod extends js.Object {
  @js.native
  class SecretList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.SecretList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.core.v1.SecretList,
