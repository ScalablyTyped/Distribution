...
object certificatesMod {
  ...
  object v1 {
    ...
    class CertificateSigningRequest protected ()
      extends typings.pulumiKubernetes.certificatesV1Mod.CertificateSigningRequest {
      /**
    ...
    class CertificateSigningRequestList protected ()
      extends typings.pulumiKubernetes.certificatesV1Mod.CertificateSigningRequestList {
      /**
  ...
  object v1beta1 {
    ...
    @js.native
    class CertificateSigningRequest protected ()
      extends typings.pulumiKubernetes.certificatesV1beta1Mod.CertificateSigningRequest {
      /**
        * Create a CertificateSigningRequest resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
    ...
    @js.native
    class CertificateSigningRequestList protected ()
      extends typings.pulumiKubernetes.certificatesV1beta1Mod.CertificateSigningRequestList {
      /**
        * Create a CertificateSigningRequestList resource with the given unique name, arguments, and options.
        *
        * @param name The _unique_ name of the resource.
