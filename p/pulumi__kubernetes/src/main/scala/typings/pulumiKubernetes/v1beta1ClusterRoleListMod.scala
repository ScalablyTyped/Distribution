...
@js.native
object v1beta1ClusterRoleListMod extends js.Object {
  @js.native
  class ClusterRoleList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRoleList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRoleList,
