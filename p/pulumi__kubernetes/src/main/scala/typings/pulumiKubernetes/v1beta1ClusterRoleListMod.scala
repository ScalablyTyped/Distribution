...
object v1beta1ClusterRoleListMod {
  ...
  object ClusterRoleList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): ClusterRoleList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ClusterRoleList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): ClusterRoleList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ClusterRoleList]
  ...
  trait ClusterRoleListArgs extends StObject {
    ...
    /**
      * Items is a list of ClusterRoles
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRole]]]
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList]] = js.undefined
  ...
  object ClusterRoleListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRole]]]): ClusterRoleListArgs = {
    ...
    implicit class ClusterRoleListArgsMutableBuilder[Self <: ClusterRoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRole]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRole]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
