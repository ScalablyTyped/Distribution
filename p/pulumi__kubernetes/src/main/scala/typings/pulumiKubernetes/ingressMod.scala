...
object ingressMod {
  ...
  object Ingress {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/ingress", "Ingress.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/extensions/v1beta1/ingress", "Ingress.isInstance")
    @js.native
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.IngressSpec]] = js.native
  }
  object IngressArgs {
    ...
    implicit class IngressArgsMutableBuilder[Self <: IngressArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
