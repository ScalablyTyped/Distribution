...
object ingressMod {
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.IngressSpec]] = js.undefined
  }
  object IngressArgs {
    ...
    extension [Self <: IngressArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
