...
object v1LeaseMod {
  ...
  trait LeaseArgs extends StObject {
    ...
    /**
      * Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.coordination.v1.LeaseSpec]] = js.native
  }
  object LeaseArgs {
    ...
    implicit class LeaseArgsMutableBuilder[Self <: LeaseArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.coordination.v1.LeaseSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
