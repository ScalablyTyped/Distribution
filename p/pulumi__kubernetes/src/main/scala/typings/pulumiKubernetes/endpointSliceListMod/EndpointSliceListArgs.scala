...
import typings.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice
...
@js.native
trait EndpointSliceListArgs extends js.Object {
  ...
  /**
    ...
    */
  val items: Input[js.Array[Input[EndpointSlice]]] = js.native
...
object EndpointSliceListArgs {
  ...
  @scala.inline
  def apply(items: Input[js.Array[Input[EndpointSlice]]]): EndpointSliceListArgs = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[EndpointSliceListArgs]
  }
  
  @scala.inline
  implicit class EndpointSliceListArgsOps[Self <: EndpointSliceListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Input[EndpointSlice]*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: Input[js.Array[Input[EndpointSlice]]]): Self = this.set("items", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList]): Self = this.set("kind", value.asInstanceOf[js.Any])
