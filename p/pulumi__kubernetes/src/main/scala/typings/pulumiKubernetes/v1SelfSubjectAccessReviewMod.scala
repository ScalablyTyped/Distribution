...
object v1SelfSubjectAccessReviewMod {
  ...
  object SelfSubjectAccessReview {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): SelfSubjectAccessReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectAccessReview]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): SelfSubjectAccessReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectAccessReview]
  ...
  object SelfSubjectAccessReviewArgs {
    ...
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectAccessReviewSpec]): SelfSubjectAccessReviewArgs = {
    ...
    implicit class SelfSubjectAccessReviewArgsMutableBuilder[Self <: SelfSubjectAccessReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectAccessReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectAccessReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
