...
object v1ClusterRoleBindingListMod {
  ...
  object ClusterRoleBindingList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/clusterRoleBindingList", "ClusterRoleBindingList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/clusterRoleBindingList", "ClusterRoleBindingList.isInstance")
    @js.native
  ...
  trait ClusterRoleBindingListArgs extends StObject {
    ...
    /**
      * Items is a list of ClusterRoleBindings
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.ClusterRoleBinding]]] = js.native
