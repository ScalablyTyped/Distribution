...
object resourceQuotaMod {
  ...
  object ResourceQuota {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/resourceQuota", "ResourceQuota.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/resourceQuota", "ResourceQuota.isInstance")
    @js.native
  ...
  trait ResourceQuotaArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota]] = js.native
    ...
    /**
      * Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]] = js.native
  }
