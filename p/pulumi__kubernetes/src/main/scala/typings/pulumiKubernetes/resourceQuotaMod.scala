...
object resourceQuotaMod {
  ...
  object ResourceQuota {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): ResourceQuota = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ResourceQuota]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): ResourceQuota = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ResourceQuota]
  ...
  object ResourceQuotaArgs {
    ...
    inline def apply(): ResourceQuotaArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ResourceQuotaArgs]
    }
    
    extension [Self <: ResourceQuotaArgs](x: Self) {
      
      inline def setApiVersion(value: Input[v1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
      
      inline def setApiVersionUndefined: Self = StObject.set(x, "apiVersion", js.undefined)
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
