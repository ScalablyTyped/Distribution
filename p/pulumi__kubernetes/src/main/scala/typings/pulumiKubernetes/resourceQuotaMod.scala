...
object resourceQuotaMod {
  ...
  object ResourceQuota {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): ResourceQuota = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ResourceQuota]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): ResourceQuota = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ResourceQuota]
  ...
  trait ResourceQuotaArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota]] = js.undefined
    ...
    /**
      * Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]] = js.undefined
  }
  object ResourceQuotaArgs {
    ...
    @scala.inline
    implicit class ResourceQuotaArgsMutableBuilder[Self <: ResourceQuotaArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
