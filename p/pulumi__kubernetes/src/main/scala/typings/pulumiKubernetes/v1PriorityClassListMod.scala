...
object v1PriorityClassListMod {
  ...
  object PriorityClassList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): PriorityClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PriorityClassList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): PriorityClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PriorityClassList]
  ...
  object PriorityClassListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.scheduling.v1.PriorityClass]]]): PriorityClassListArgs = {
    ...
    implicit class PriorityClassListArgsMutableBuilder[Self <: PriorityClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.scheduling.v1.PriorityClass]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.scheduling.v1.PriorityClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
