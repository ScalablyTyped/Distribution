...
object v1PriorityClassListMod {
  ...
  object PriorityClassList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1/priorityClassList", "PriorityClassList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/scheduling/v1/priorityClassList", "PriorityClassList.isInstance")
    @js.native
  ...
  trait PriorityClassListArgs extends StObject {
    ...
    /**
      * items is the list of PriorityClasses
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.scheduling.v1.PriorityClass]]] = js.native
