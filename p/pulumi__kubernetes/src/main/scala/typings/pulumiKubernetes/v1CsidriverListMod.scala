...
object v1CsidriverListMod {
  ...
  object CSIDriverListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSIDriver]]]): CSIDriverListArgs = {
    ...
    extension [Self <: CSIDriverListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSIDriver]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSIDriver]*): Self = StObject.set(x, "items", js.Array(value :_*))
