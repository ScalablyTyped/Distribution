package typings.pulumiKubernetes.controllerRevisionListMod

import typings.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision
...
object ControllerRevisionListArgs {
  ...
  implicit class ControllerRevisionListArgsOps[Self <: ControllerRevisionListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: Input[appsSlashv1beta1]): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
