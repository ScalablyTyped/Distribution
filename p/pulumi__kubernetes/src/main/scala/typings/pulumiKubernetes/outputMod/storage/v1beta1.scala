...
object v1beta1 {
  ...
  object VolumeAttachment {
    ...
    inline def apply(metadata: ObjectMeta, spec: VolumeAttachmentSpec, status: VolumeAttachmentStatus): VolumeAttachment = {
      val __obj = js.Dynamic.literal(apiVersion = "storage.k8s.io/v1beta1", kind = "VolumeAttachment", metadata = metadata.asInstanceOf[js.Any], spec = spec.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any])
