...
object ControllerRevision {
  ...
  inline def apply(data: js.Any, metadata: ObjectMeta, revision: Double): ControllerRevision = {
    val __obj = js.Dynamic.literal(apiVersion = "apps/v1", data = data.asInstanceOf[js.Any], kind = "ControllerRevision", metadata = metadata.asInstanceOf[js.Any], revision = revision.asInstanceOf[js.Any])
