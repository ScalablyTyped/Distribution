...
trait HorizontalPodAutoscaler extends StObject {
  ...
  /**
    ...
    */
  var apiVersion: autoscalingSlashv2beta1 = js.native
...
object HorizontalPodAutoscaler {
  ...
  implicit class HorizontalPodAutoscalerMutableBuilder[Self <: HorizontalPodAutoscaler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: autoscalingSlashv2beta1): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
