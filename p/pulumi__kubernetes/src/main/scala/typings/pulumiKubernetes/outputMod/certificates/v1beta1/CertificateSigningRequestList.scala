...
trait CertificateSigningRequestList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequestList
...
object CertificateSigningRequestList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.CertificateSigningRequestList,
    metadata: ListMeta
