...
object v1 {
  ...
  trait ClusterRole extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: rbacDotauthorizationDotk8sDotioSlashv1
  ...
  object ClusterRole {
    ...
    inline def apply(aggregationRule: AggregationRule, metadata: ObjectMeta, rules: js.Array[PolicyRule]): ClusterRole = {
      val __obj = js.Dynamic.literal(aggregationRule = aggregationRule.asInstanceOf[js.Any], apiVersion = "rbac.authorization.k8s.io/v1", kind = "ClusterRole", metadata = metadata.asInstanceOf[js.Any], rules = rules.asInstanceOf[js.Any])
    ...
    extension [Self <: ClusterRole](x: Self) {
      ...
      inline def setApiVersion(value: rbacDotauthorizationDotk8sDotioSlashv1): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
  ...
  object ClusterRoleBinding {
    ...
    inline def apply(metadata: ObjectMeta, roleRef: RoleRef, subjects: js.Array[Subject]): ClusterRoleBinding = {
      val __obj = js.Dynamic.literal(apiVersion = "rbac.authorization.k8s.io/v1", kind = "ClusterRoleBinding", metadata = metadata.asInstanceOf[js.Any], roleRef = roleRef.asInstanceOf[js.Any], subjects = subjects.asInstanceOf[js.Any])
  ...
  object Role {
    ...
    inline def apply(metadata: ObjectMeta, rules: js.Array[PolicyRule]): Role = {
      val __obj = js.Dynamic.literal(apiVersion = "rbac.authorization.k8s.io/v1", kind = "Role", metadata = metadata.asInstanceOf[js.Any], rules = rules.asInstanceOf[js.Any])
  ...
  object RoleBinding {
    ...
    inline def apply(metadata: ObjectMeta, roleRef: RoleRef, subjects: js.Array[Subject]): RoleBinding = {
      val __obj = js.Dynamic.literal(apiVersion = "rbac.authorization.k8s.io/v1", kind = "RoleBinding", metadata = metadata.asInstanceOf[js.Any], roleRef = roleRef.asInstanceOf[js.Any], subjects = subjects.asInstanceOf[js.Any])
