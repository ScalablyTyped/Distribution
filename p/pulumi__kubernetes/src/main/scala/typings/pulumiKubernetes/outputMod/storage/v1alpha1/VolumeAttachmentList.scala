...
trait VolumeAttachmentList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList
  /**
...
object VolumeAttachmentList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList,
    metadata: ListMeta
