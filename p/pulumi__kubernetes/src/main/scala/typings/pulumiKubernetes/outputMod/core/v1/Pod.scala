...
object Pod {
  ...
  inline def apply(metadata: ObjectMeta, spec: PodSpec, status: PodStatus): Pod = {
  ...
  extension [Self <: Pod](x: Self) {
    ...
    inline def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.Pod): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    
    inline def setMetadata(value: ObjectMeta): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
    
    inline def setSpec(value: PodSpec): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setStatus(value: PodStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
  }
}
