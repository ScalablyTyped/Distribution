...
trait PodDisruptionBudgetList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList
...
object PodDisruptionBudgetList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList,
    metadata: ListMeta
