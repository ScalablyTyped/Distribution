...
object PodPreset {
  ...
  implicit class PodPresetOps[Self <: PodPreset] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: settingsDotk8sDotioSlashv1alpha1): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.PodPreset): Self = this.set("kind", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetadata(value: ObjectMeta): Self = this.set("metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpec(value: PodPresetSpec): Self = this.set("spec", value.asInstanceOf[js.Any])
  }
}
