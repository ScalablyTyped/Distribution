...
object CSIDriver {
  ...
  implicit class CSIDriverOps[Self <: CSIDriver] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.CSIDriver): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
    def setMetadata(value: ObjectMeta): Self = this.set("metadata", value.asInstanceOf[js.Any])
    @scala.inline
    def setSpec(value: CSIDriverSpec): Self = this.set("spec", value.asInstanceOf[js.Any])
  }
