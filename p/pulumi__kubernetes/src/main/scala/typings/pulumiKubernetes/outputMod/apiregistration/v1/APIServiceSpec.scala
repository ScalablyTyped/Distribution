...
object APIServiceSpec {
  ...
  implicit class APIServiceSpecOps[Self <: APIServiceSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGroupPriorityMinimum(value: Double): Self = this.set("groupPriorityMinimum", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setVersionPriority(value: Double): Self = this.set("versionPriority", value.asInstanceOf[js.Any])
  }
}
