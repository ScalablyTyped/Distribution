...
object discovery {
  ...
  object v1beta1 {
    ...
    object EndpointConditions {
      ...
      inline def apply(ready: Boolean): EndpointConditions = {
    ...
    object EndpointSlice {
      ...
      extension [Self <: EndpointSlice](x: Self) {
        ...
        inline def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointSlice): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
