...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList
  /**
...
object PodSecurityPolicyList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList,
    metadata: ListMeta
