...
trait ReplicationControllerList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList
  /**
...
object ReplicationControllerList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList,
    metadata: ListMeta
