...
trait SelfSubjectRulesReview extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview
...
object SelfSubjectRulesReview {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview,
    metadata: ObjectMeta,
