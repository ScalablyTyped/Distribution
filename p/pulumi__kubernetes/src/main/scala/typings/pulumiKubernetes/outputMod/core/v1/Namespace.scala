...
trait Namespace extends StObject {
  ...
  /**
    ...
    */
  var kind: typings.pulumiKubernetes.pulumiKubernetesStrings.Namespace = js.native
...
object Namespace {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.Namespace,
    metadata: ObjectMeta,
    spec: NamespaceSpec,
  ...
  implicit class NamespaceMutableBuilder[Self <: Namespace] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.Namespace): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
