...
object v1beta1 {
  ...
  trait MutatingWebhookConfiguration extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: admissionregistrationDotk8sDotioSlashv1beta1
  ...
  object MutatingWebhookConfiguration {
    ...
    inline def apply(metadata: ObjectMeta, webhooks: js.Array[MutatingWebhook]): MutatingWebhookConfiguration = {
      val __obj = js.Dynamic.literal(apiVersion = "admissionregistration.k8s.io/v1beta1", kind = "MutatingWebhookConfiguration", metadata = metadata.asInstanceOf[js.Any], webhooks = webhooks.asInstanceOf[js.Any])
      __obj.asInstanceOf[MutatingWebhookConfiguration]
    }
    
    extension [Self <: MutatingWebhookConfiguration](x: Self) {
      
      inline def setApiVersion(value: admissionregistrationDotk8sDotioSlashv1beta1): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
  ...
  object ValidatingWebhookConfiguration {
    ...
    inline def apply(metadata: ObjectMeta, webhooks: js.Array[ValidatingWebhook]): ValidatingWebhookConfiguration = {
      val __obj = js.Dynamic.literal(apiVersion = "admissionregistration.k8s.io/v1beta1", kind = "ValidatingWebhookConfiguration", metadata = metadata.asInstanceOf[js.Any], webhooks = webhooks.asInstanceOf[js.Any])
