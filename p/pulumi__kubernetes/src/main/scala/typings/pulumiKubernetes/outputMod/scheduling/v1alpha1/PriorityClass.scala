package typings.pulumiKubernetes.outputMod.scheduling.v1alpha1
...
trait PriorityClass extends js.Object {
  ...
  /**
    ...
    */
  var apiVersion: schedulingDotk8sDotioSlashv1alpha1 = js.native
...
object PriorityClass {
  ...
  @scala.inline
  def apply(
    apiVersion: schedulingDotk8sDotioSlashv1alpha1,
    description: String,
  ...
  implicit class PriorityClassOps[Self <: PriorityClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: schedulingDotk8sDotioSlashv1alpha1): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
