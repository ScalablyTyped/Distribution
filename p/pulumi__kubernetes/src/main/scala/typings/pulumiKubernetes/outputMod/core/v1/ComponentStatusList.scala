...
trait ComponentStatusList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList
  /**
...
object ComponentStatusList {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatusList,
    metadata: ListMeta
  ): ComponentStatusList = {
