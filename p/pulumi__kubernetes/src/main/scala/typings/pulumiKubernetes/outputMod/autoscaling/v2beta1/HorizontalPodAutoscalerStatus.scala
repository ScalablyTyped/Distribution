...
object HorizontalPodAutoscalerStatus {
  ...
  extension [Self <: HorizontalPodAutoscalerStatus](x: Self) {
    ...
    inline def setConditionsVarargs(value: HorizontalPodAutoscalerCondition*): Self = StObject.set(x, "conditions", js.Array(value :_*))
    
    inline def setCurrentMetrics(value: js.Array[MetricStatus]): Self = StObject.set(x, "currentMetrics", value.asInstanceOf[js.Any])
    
    inline def setCurrentMetricsVarargs(value: MetricStatus*): Self = StObject.set(x, "currentMetrics", js.Array(value :_*))
