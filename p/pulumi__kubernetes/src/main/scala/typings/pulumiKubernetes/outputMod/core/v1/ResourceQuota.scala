...
trait ResourceQuota extends StObject {
  ...
  /**
    ...
    */
  var kind: typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota = js.native
  ...
  /**
    ...
    */
  var spec: ResourceQuotaSpec = js.native
  
  /**
    * Status defines the actual enforced quota and its current usage. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  var status: ResourceQuotaStatus = js.native
}
object ResourceQuota {
  ...
  implicit class ResourceQuotaMutableBuilder[Self <: ResourceQuota] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetadata(value: ObjectMeta): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpec(value: ResourceQuotaSpec): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setStatus(value: ResourceQuotaStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
  }
}
