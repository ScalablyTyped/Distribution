...
trait NetworkPolicy extends js.Object {
  ...
  /**
    ...
    */
  var kind: typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy = js.native
...
object NetworkPolicy {
  ...
  def apply(
    ...
    kind: typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy,
    metadata: ObjectMeta,
  ...
  implicit class NetworkPolicyOps[Self <: NetworkPolicy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicy): Self = this.set("kind", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMetadata(value: ObjectMeta): Self = this.set("metadata", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpec(value: NetworkPolicySpec): Self = this.set("spec", value.asInstanceOf[js.Any])
  }
}
