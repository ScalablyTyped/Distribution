...
object persistentVolumeMod {
  ...
  object PersistentVolume {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): PersistentVolume = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PersistentVolume]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): PersistentVolume = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PersistentVolume]
  ...
  object PersistentVolumeArgs {
    ...
    @scala.inline
    implicit class PersistentVolumeArgsMutableBuilder[Self <: PersistentVolumeArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolume]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.PersistentVolumeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
