...
object persistentVolumeMod {
  ...
  object PersistentVolume {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/persistentVolume", "PersistentVolume.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/persistentVolume", "PersistentVolume.isInstance")
    @js.native
  ...
  trait PersistentVolumeArgs extends StObject {
    ...
    /**
      * Spec defines a specification of a persistent volume owned by the cluster. Provisioned by an administrator. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.core.v1.PersistentVolumeSpec]] = js.native
  }
