...
object clusterRoleListMod {
  ...
  trait ClusterRoleListArgs extends StObject {
    ...
    /**
      * Items is a list of ClusterRoles
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]]]
  ...
  object ClusterRoleListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]]]): ClusterRoleListArgs = {
    ...
    extension [Self <: ClusterRoleListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.ClusterRole]*): Self = StObject.set(x, "items", js.Array(value :_*))
