...
object v1beta2ControllerRevisionListMod {
  ...
  object ControllerRevisionListArgs {
    ...
    extension [Self <: ControllerRevisionListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
