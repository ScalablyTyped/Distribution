...
object v1beta2ControllerRevisionListMod {
  ...
  object ControllerRevisionList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/controllerRevisionList", "ControllerRevisionList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/controllerRevisionList", "ControllerRevisionList.isInstance")
    @js.native
