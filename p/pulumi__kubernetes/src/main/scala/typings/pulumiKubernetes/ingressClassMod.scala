...
object ingressClassMod {
  ...
  trait IngressClassArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the IngressClass. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClassSpec]] = js.undefined
  }
  object IngressClassArgs {
    ...
    extension [Self <: IngressClassArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClassSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
