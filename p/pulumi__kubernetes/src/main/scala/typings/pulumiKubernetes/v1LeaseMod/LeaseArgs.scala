...
import typings.pulumiKubernetes.inputMod.coordination.v1.LeaseSpec
...
trait LeaseArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Lease]] = js.native
  /**
