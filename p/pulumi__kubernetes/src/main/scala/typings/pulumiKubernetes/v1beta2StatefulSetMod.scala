...
object v1beta2StatefulSetMod {
  ...
  trait StatefulSetArgs extends StObject {
    ...
    /**
      * Spec defines the desired identities of pods in this set.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSetSpec]] = js.undefined
  }
  object StatefulSetArgs {
    ...
    implicit class StatefulSetArgsMutableBuilder[Self <: StatefulSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
