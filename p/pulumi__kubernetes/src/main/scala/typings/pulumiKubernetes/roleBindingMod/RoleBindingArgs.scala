package typings.pulumiKubernetes.roleBindingMod

import typings.pulumiKubernetes.inputMod.meta.v1.ObjectMeta
import typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef
import typings.pulumiKubernetes.inputMod.rbac.v1alpha1.Subject
