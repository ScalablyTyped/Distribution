...
object podTemplateListMod {
  ...
  object PodTemplateList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PodTemplateList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PodTemplateList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): PodTemplateList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PodTemplateList]
  ...
  object PodTemplateListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.PodTemplate]]]): PodTemplateListArgs = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
      __obj.asInstanceOf[PodTemplateListArgs]
    }
    
    extension [Self <: PodTemplateListArgs](x: Self) {
      
      inline def setApiVersion(value: Input[v1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
      
      inline def setApiVersionUndefined: Self = StObject.set(x, "apiVersion", js.undefined)
      
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.PodTemplate]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.core.v1.PodTemplate]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
