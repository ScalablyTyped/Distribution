...
object serviceMod {
  ...
  object Service {
    ...
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): Service = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Service]
  ...
  object ServiceArgs {
    ...
    implicit class ServiceArgsMutableBuilder[Self <: ServiceArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.ServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
