...
object networkPolicyListMod {
  ...
  object NetworkPolicyList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): NetworkPolicyList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[NetworkPolicyList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): NetworkPolicyList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[NetworkPolicyList]
  ...
  trait NetworkPolicyListArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]] = js.undefined
  ...
  object NetworkPolicyListArgs {
    ...
    extension [Self <: NetworkPolicyListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
