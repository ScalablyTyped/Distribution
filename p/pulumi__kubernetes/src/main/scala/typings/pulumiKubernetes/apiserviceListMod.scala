...
object apiserviceListMod {
  ...
  object APIServiceListArgs {
    ...
    extension [Self <: APIServiceListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIService]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.APIServiceList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
