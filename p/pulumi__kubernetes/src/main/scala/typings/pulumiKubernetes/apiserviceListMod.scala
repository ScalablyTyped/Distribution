...
object apiserviceListMod {
  ...
  object APIServiceList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1beta1/apiserviceList", "APIServiceList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apiregistration/v1beta1/apiserviceList", "APIServiceList.isInstance")
    @js.native
