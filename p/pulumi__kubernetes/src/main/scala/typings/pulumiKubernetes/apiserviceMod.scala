...
object apiserviceMod {
  ...
  trait APIServiceArgs extends StObject {
    ...
    /**
      * Spec contains information for locating and communicating with a server
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceSpec]] = js.undefined
  }
  object APIServiceArgs {
    ...
    extension [Self <: APIServiceArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
