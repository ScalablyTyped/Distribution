...
object v1beta1PodSecurityPolicyListMod {
  ...
  object PodSecurityPolicyList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyList", "PodSecurityPolicyList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/policy/v1beta1/podSecurityPolicyList", "PodSecurityPolicyList.isInstance")
    @js.native
