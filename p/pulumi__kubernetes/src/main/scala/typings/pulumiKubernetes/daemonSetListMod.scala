...
object daemonSetListMod {
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      * A list of daemon sets.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]]
  ...
  object DaemonSetListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]]): DaemonSetListArgs = {
    ...
    extension [Self <: DaemonSetListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
