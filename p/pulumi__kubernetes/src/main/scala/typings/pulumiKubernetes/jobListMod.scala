...
object jobListMod {
  ...
  object JobList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): JobList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[JobList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): JobList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[JobList]
  ...
  object JobListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1.Job]]]): JobListArgs = {
    ...
    implicit class JobListArgsMutableBuilder[Self <: JobListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1.Job]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.batch.v1.Job]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.JobList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
