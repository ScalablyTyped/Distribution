...
object metaV1Mod {
  ...
  class Status protected ()
    extends typings.pulumiKubernetes.statusMod.Status {
    /**
  ...
  object Status {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.statusMod.Status = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.statusMod.Status]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.statusMod.Status = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.statusMod.Status]
