...
object metaV1Mod extends js.Object {
  ...
  class Status protected ()
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.meta.v1.Status) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.meta.v1.Status, opts: CustomResourceOptions) = this()
  }
