...
object ingressClassListMod {
  ...
  object IngressClassList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClassList", "IngressClassList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingressClassList", "IngressClassList.isInstance")
    @js.native
