...
object ingressClassListMod {
  ...
  object IngressClassList {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): IngressClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[IngressClassList]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): IngressClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[IngressClassList]
  ...
  trait IngressClassListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass]]
      ]
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]] = js.undefined
  ...
  object IngressClassListArgs {
    ...
    extension [Self <: IngressClassListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
