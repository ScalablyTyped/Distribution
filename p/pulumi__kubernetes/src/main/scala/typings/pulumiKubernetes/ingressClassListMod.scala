...
object ingressClassListMod {
  ...
  object IngressClassList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): IngressClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[IngressClassList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): IngressClassList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[IngressClassList]
  ...
  object IngressClassListArgs {
    ...
    implicit class IngressClassListArgsMutableBuilder[Self <: IngressClassListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
