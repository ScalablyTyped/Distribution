...
import typings.pulumiKubernetes.inputMod.settings.v1alpha1.PodPresetSpec
...
trait PodPresetArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodPreset]] = js.native
