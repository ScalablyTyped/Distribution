...
object endpointsMod {
  ...
  object EndpointsArgs {
    ...
    implicit class EndpointsArgsMutableBuilder[Self <: EndpointsArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSubsets(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.EndpointSubset]]]): Self = StObject.set(x, "subsets", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubsetsUndefined: Self = StObject.set(x, "subsets", js.undefined)
      
      @scala.inline
      def setSubsetsVarargs(value: Input[typings.pulumiKubernetes.inputMod.core.v1.EndpointSubset]*): Self = StObject.set(x, "subsets", js.Array(value :_*))
    }
  }
}
