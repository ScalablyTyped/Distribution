...
class Event protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.Event) = this()
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.Event, opts: CustomResourceOptions) = this()
}
