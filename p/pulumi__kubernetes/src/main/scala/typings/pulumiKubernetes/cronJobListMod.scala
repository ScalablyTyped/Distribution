...
object cronJobListMod {
  ...
  object CronJobListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): CronJobListArgs = {
    ...
    extension [Self <: CronJobListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]*): Self = StObject.set(x, "items", js.Array(value :_*))
