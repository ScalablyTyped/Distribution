...
object cronJobListMod {
  ...
  trait CronJobListArgs extends StObject {
    ...
    /**
      * items is the list of CronJobs.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]
  ...
  object CronJobListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): CronJobListArgs = {
    ...
    implicit class CronJobListArgsMutableBuilder[Self <: CronJobListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJob]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.CronJobList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
