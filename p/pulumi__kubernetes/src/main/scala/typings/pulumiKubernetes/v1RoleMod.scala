...
object v1RoleMod {
  ...
  trait RoleArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Role]] = js.undefined
    ...
    /**
      * Rules holds all the PolicyRules for this Role
      */
    val rules: js.UndefOr[Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]]]] = js.undefined
  }
  object RoleArgs {
    ...
    extension [Self <: RoleArgs](x: Self) {
      ...
      inline def setRules(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]]]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      inline def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      inline def setRulesVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.PolicyRule]*): Self = StObject.set(x, "rules", js.Array(value :_*))
    }
  }
}
