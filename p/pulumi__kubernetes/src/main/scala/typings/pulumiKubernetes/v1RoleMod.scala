...
object v1RoleMod {
  ...
  object Role {
    ...
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): Role = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Role]
