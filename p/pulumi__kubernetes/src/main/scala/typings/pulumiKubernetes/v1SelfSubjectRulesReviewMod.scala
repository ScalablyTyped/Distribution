...
object v1SelfSubjectRulesReviewMod {
  ...
  object SelfSubjectRulesReviewArgs {
    ...
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec]): SelfSubjectRulesReviewArgs = {
    ...
    extension [Self <: SelfSubjectRulesReviewArgs](x: Self) {
      ...
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
