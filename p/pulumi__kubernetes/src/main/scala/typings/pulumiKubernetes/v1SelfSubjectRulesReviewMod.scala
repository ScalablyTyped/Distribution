...
object v1SelfSubjectRulesReviewMod {
  ...
  object SelfSubjectRulesReview {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): SelfSubjectRulesReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectRulesReview]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): SelfSubjectRulesReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[SelfSubjectRulesReview]
  ...
  trait SelfSubjectRulesReviewArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview]] = js.undefined
    ...
    /**
      * Spec holds information about the request being evaluated.
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec]
  }
  object SelfSubjectRulesReviewArgs {
    
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec]): SelfSubjectRulesReviewArgs = {
    ...
    implicit class SelfSubjectRulesReviewArgsMutableBuilder[Self <: SelfSubjectRulesReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
