...
object v1SelfSubjectRulesReviewMod {
  ...
  object SelfSubjectRulesReview {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/selfSubjectRulesReview", "SelfSubjectRulesReview.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/selfSubjectRulesReview", "SelfSubjectRulesReview.isInstance")
    @js.native
  ...
  trait SelfSubjectRulesReviewArgs extends StObject {
    ...
    /**
      * Spec holds information about the request being evaluated.
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SelfSubjectRulesReviewSpec] = js.native
  }
