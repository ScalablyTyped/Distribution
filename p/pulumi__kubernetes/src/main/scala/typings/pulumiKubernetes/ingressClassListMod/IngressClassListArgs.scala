...
import typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressClass
...
object IngressClassListArgs {
  ...
  implicit class IngressClassListArgsOps[Self <: IngressClassListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.IngressClassList]): Self = this.set("kind", value.asInstanceOf[js.Any])
