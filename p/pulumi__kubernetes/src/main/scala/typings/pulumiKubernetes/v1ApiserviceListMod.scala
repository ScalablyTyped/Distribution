...
object v1ApiserviceListMod {
  ...
  trait APIServiceListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]] = js.native
  ...
  object APIServiceListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]]): APIServiceListArgs = {
    ...
    implicit class APIServiceListArgsMutableBuilder[Self <: APIServiceListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]*): Self = StObject.set(x, "items", js.Array(value :_*))
