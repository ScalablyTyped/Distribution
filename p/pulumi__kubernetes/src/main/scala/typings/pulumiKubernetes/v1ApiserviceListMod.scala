...
object v1ApiserviceListMod {
  ...
  trait APIServiceListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]]
  ...
  object APIServiceListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]]): APIServiceListArgs = {
    ...
    extension [Self <: APIServiceListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService]*): Self = StObject.set(x, "items", js.Array(value :_*))
