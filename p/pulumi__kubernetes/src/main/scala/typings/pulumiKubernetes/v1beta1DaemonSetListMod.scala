...
object v1beta1DaemonSetListMod {
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      * A list of daemon sets.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]]]
  ...
  object DaemonSetListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]]]): DaemonSetListArgs = {
    ...
    extension [Self <: DaemonSetListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
