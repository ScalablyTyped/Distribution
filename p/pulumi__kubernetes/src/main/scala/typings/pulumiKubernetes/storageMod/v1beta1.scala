...
object v1beta1 extends js.Object {
  ...
  class CSIDriver protected ()
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriver,
  ...
  class CSIDriverList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class VolumeAttachment protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachment,
      opts: CustomResourceOptions
    ) = this()
  }
