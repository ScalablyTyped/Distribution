package typings.pulumiKubernetes.v1RoleBindingMod

import typings.pulumiKubernetes.inputMod.meta.v1.ObjectMeta
import typings.pulumiKubernetes.inputMod.rbac.v1.RoleRef
import typings.pulumiKubernetes.inputMod.rbac.v1.Subject
