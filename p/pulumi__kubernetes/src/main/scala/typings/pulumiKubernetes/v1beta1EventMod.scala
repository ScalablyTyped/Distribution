...
object v1beta1EventMod {
  ...
  trait EventArgs extends StObject {
    ...
    /**
      * series is data about the Event series this event represents or nil if it's a singleton Event.
      */
    val series: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.events.v1beta1.EventSeries]] = js.undefined
  ...
  object EventArgs {
    ...
    extension [Self <: EventArgs](x: Self) {
      ...
      inline def setSeries(value: Input[typings.pulumiKubernetes.inputMod.events.v1beta1.EventSeries]): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
