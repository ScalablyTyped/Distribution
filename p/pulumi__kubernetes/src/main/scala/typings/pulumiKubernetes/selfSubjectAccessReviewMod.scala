...
import typings.pulumiKubernetes.outputMod.authorization.v1beta1.SelfSubjectAccessReviewSpec
...
object selfSubjectAccessReviewMod {
  ...
  trait SelfSubjectAccessReviewArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: Input[
        typings.pulumiKubernetes.inputMod.authorization.v1beta1.SelfSubjectAccessReviewSpec
      ]
  }
