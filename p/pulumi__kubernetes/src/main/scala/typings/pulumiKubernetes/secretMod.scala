...
object secretMod {
  ...
  object Secret {
    ...
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): Secret = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Secret]
