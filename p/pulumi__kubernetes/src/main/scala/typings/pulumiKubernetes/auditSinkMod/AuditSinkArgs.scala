...
import typings.pulumiKubernetes.inputMod.auditregistration.v1alpha1.AuditSinkSpec
...
object AuditSinkArgs {
  ...
  implicit class AuditSinkArgsOps[Self <: AuditSinkArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.AuditSink]): Self = this.set("kind", value.asInstanceOf[js.Any])
