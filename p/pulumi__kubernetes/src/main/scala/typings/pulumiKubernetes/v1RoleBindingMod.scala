...
object v1RoleBindingMod {
  ...
  object RoleBinding {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/roleBinding", "RoleBinding.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1/roleBinding", "RoleBinding.isInstance")
    @js.native
  ...
  trait RoleBindingArgs extends StObject {
    ...
    /**
      * RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
      */
    val roleRef: Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleRef] = js.native
    
    /**
      * Subjects holds references to the objects the role applies to.
      */
    val subjects: js.UndefOr[Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Subject]]]] = js.native
  }
  object RoleBindingArgs {
    
    @scala.inline
    def apply(roleRef: Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleRef]): RoleBindingArgs = {
    ...
    implicit class RoleBindingArgsMutableBuilder[Self <: RoleBindingArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRoleRef(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleRef]): Self = StObject.set(x, "roleRef", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubjects(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Subject]]]): Self = StObject.set(x, "subjects", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSubjectsUndefined: Self = StObject.set(x, "subjects", js.undefined)
      
      @scala.inline
      def setSubjectsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.Subject]*): Self = StObject.set(x, "subjects", js.Array(value :_*))
    }
  }
}
