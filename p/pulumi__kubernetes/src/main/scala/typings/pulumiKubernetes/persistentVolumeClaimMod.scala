...
object persistentVolumeClaimMod {
  ...
  object PersistentVolumeClaim {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): PersistentVolumeClaim = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[PersistentVolumeClaim]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): PersistentVolumeClaim = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[PersistentVolumeClaim]
  ...
  object PersistentVolumeClaimArgs {
    ...
    inline def apply(): PersistentVolumeClaimArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PersistentVolumeClaimArgs]
    }
    
    extension [Self <: PersistentVolumeClaimArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.PersistentVolumeClaimSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
