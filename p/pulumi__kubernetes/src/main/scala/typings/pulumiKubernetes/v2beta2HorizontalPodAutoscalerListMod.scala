...
object v2beta2HorizontalPodAutoscalerListMod {
  ...
  object HorizontalPodAutoscalerList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v2beta2/horizontalPodAutoscalerList", "HorizontalPodAutoscalerList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v2beta2/horizontalPodAutoscalerList", "HorizontalPodAutoscalerList.isInstance")
    @js.native
