...
object v1EventListMod {
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1.Event]]]
  ...
  object EventListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1.Event]]]): EventListArgs = {
    ...
    extension [Self <: EventListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1.Event]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.events.v1.Event]*): Self = StObject.set(x, "items", js.Array(value :_*))
