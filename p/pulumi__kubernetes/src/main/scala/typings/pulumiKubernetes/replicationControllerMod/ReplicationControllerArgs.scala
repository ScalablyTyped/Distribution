...
import typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerSpec
...
object ReplicationControllerArgs {
  ...
  implicit class ReplicationControllerArgsOps[Self <: ReplicationControllerArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]): Self = this.set("kind", value.asInstanceOf[js.Any])
