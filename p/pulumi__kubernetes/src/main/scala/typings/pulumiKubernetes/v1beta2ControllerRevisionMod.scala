...
object v1beta2ControllerRevisionMod {
  ...
  object ControllerRevision {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/controllerRevision", "ControllerRevision.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/controllerRevision", "ControllerRevision.isInstance")
    @js.native
