...
object v2alpha1CronJobListMod {
  ...
  object CronJobListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v2alpha1.CronJob]]]): CronJobListArgs = {
    ...
    implicit class CronJobListArgsMutableBuilder[Self <: CronJobListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.batch.v2alpha1.CronJob]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.batch.v2alpha1.CronJob]*): Self = StObject.set(x, "items", js.Array(value :_*))
