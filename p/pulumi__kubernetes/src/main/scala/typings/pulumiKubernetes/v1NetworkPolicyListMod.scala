...
object v1NetworkPolicyListMod {
  ...
  trait NetworkPolicyListArgs extends StObject {
    ...
    /**
      * Items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]]
  ...
  object NetworkPolicyListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]]): NetworkPolicyListArgs = {
    ...
    extension [Self <: NetworkPolicyListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
