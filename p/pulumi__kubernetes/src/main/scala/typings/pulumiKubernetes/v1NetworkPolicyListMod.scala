...
object v1NetworkPolicyListMod {
  ...
  trait NetworkPolicyListArgs extends StObject {
    ...
    /**
      * Items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]] = js.native
  ...
  object NetworkPolicyListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]]): NetworkPolicyListArgs = {
    ...
    implicit class NetworkPolicyListArgsMutableBuilder[Self <: NetworkPolicyListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
