package typings.pulumiKubernetes.eventMod

import typings.pulumiKubernetes.inputMod.core.v1.EventSeries
...
trait EventArgs extends js.Object {
  ...
  /**
    ...
    */
  val involvedObject: Input[ObjectReference] = js.native
  /**
  ...
  /**
    ...
    */
  val metadata: Input[ObjectMeta] = js.native
  /**
  ...
  /**
    ...
    */
  val source: js.UndefOr[Input[EventSource]] = js.native
  /**
...
object EventArgs {
  @scala.inline
  def apply(involvedObject: Input[ObjectReference], metadata: Input[ObjectMeta]): EventArgs = {
