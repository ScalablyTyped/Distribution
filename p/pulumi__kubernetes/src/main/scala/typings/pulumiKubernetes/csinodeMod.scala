...
object csinodeMod extends js.Object {
  ...
  class CSINode protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSINode) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.CSINode,
