...
object v1beta1ClusterRoleBindingListMod {
  ...
  object ClusterRoleBindingList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingList", "ClusterRoleBindingList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1beta1/clusterRoleBindingList", "ClusterRoleBindingList.isInstance")
    @js.native
  ...
  trait ClusterRoleBindingListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRoleBinding]]
      ] = js.native
  ...
  object ClusterRoleBindingListArgs {
    ...
    implicit class ClusterRoleBindingListArgsMutableBuilder[Self <: ClusterRoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
