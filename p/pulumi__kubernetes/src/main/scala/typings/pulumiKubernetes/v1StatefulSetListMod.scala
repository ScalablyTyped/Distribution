...
@js.native
object v1StatefulSetListMod extends js.Object {
  @js.native
  class StatefulSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.StatefulSetList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.StatefulSetList,
