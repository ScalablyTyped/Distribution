...
object v1StatefulSetListMod {
  ...
  object StatefulSetListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSet]]]): StatefulSetListArgs = {
    ...
    extension [Self <: StatefulSetListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.StatefulSetList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
