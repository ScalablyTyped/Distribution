...
object v1ControllerRevisionMod extends js.Object {
  ...
  class ControllerRevision protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision,
