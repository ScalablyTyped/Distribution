...
object tokenRequestMod {
  ...
  object TokenRequest {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): TokenRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[TokenRequest]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): TokenRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[TokenRequest]
  ...
  object TokenRequestArgs {
    ...
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec]): TokenRequestArgs = {
      val __obj = js.Dynamic.literal(spec = spec.asInstanceOf[js.Any])
      __obj.asInstanceOf[TokenRequestArgs]
    }
    
    @scala.inline
    implicit class TokenRequestArgsMutableBuilder[Self <: TokenRequestArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
