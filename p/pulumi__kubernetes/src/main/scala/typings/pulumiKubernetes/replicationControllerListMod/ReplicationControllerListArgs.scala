package typings.pulumiKubernetes.replicationControllerListMod

import typings.pulumiKubernetes.inputMod.core.v1.ReplicationController
...
object ReplicationControllerListArgs {
  ...
  implicit class ReplicationControllerListArgsOps[Self <: ReplicationControllerListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationControllerList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
