...
object v1RoleBindingListMod {
  ...
  object RoleBindingList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): RoleBindingList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[RoleBindingList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): RoleBindingList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RoleBindingList]
  ...
  object RoleBindingListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): RoleBindingListArgs = {
    ...
    implicit class RoleBindingListArgsMutableBuilder[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
