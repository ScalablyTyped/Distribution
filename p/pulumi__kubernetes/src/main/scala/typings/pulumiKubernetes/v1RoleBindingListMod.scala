...
object v1RoleBindingListMod {
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      * Items is a list of RoleBindings
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList]] = js.undefined
  ...
  object RoleBindingListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): RoleBindingListArgs = {
    ...
    extension [Self <: RoleBindingListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RoleBindingList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
