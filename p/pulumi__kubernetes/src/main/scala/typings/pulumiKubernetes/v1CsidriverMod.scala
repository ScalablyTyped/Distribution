...
object v1CsidriverMod {
  ...
  object CSIDriverArgs {
    ...
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSIDriverSpec]): CSIDriverArgs = {
    ...
    extension [Self <: CSIDriverArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSIDriverSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
