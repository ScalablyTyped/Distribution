...
class DaemonSet protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSet,
