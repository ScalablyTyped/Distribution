...
object v1IngressListMod {
  ...
  trait IngressListArgs extends StObject {
    ...
    /**
      * Items is the list of Ingress.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.Ingress]]]
  ...
  object IngressListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.Ingress]]]): IngressListArgs = {
    ...
    extension [Self <: IngressListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.networking.v1.Ingress]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.networking.v1.Ingress]*): Self = StObject.set(x, "items", js.Array(value :_*))
