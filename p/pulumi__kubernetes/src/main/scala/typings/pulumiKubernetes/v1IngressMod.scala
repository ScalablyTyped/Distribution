...
object v1IngressMod {
  ...
  object Ingress {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1/ingress", "Ingress.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1/ingress", "Ingress.isInstance")
    @js.native
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressSpec]] = js.native
  }
  object IngressArgs {
