...
object v1IngressMod {
  ...
  object Ingress {
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/networking/v1/ingress.Ingress */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/networking/v1/ingress.Ingress */ Boolean]
  }
  ...
  object IngressArgs {
    ...
    implicit class IngressArgsMutableBuilder[Self <: IngressArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.networking.v1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
