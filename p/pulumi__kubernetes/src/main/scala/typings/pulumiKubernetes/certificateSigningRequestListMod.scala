...
object certificateSigningRequestListMod {
  ...
  object CertificateSigningRequestListArgs {
    ...
    extension [Self <: CertificateSigningRequestListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.certificates.v1beta1.CertificateSigningRequest]*): Self = StObject.set(x, "items", js.Array(value :_*))
