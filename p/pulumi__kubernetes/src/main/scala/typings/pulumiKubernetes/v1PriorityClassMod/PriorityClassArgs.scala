...
trait PriorityClassArgs extends js.Object {
  /**
    ...
    */
  val apiVersion: js.UndefOr[Input[schedulingDotk8sDotioSlashv1]] = js.native
  /**
...
object PriorityClassArgs {
  ...
  implicit class PriorityClassArgsOps[Self <: PriorityClassArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setApiVersion(value: Input[schedulingDotk8sDotioSlashv1]): Self = this.set("apiVersion", value.asInstanceOf[js.Any])
    @scala.inline
