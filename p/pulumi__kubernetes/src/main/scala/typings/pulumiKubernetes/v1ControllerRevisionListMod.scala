...
object v1ControllerRevisionListMod {
  ...
  trait ControllerRevisionListArgs extends StObject {
    ...
    /**
      * Items is the list of ControllerRevisions
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]]]
  ...
  object ControllerRevisionListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]]]): ControllerRevisionListArgs = {
    ...
    extension [Self <: ControllerRevisionListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value :_*))
