...
object mutatingWebhookConfigurationMod {
  ...
  object MutatingWebhookConfigurationArgs {
    ...
    extension [Self <: MutatingWebhookConfigurationArgs](x: Self) {
      ...
      inline def setWebhooksVarargs(value: Input[typings.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhook]*): Self = StObject.set(x, "webhooks", js.Array(value :_*))
    }
  }
}
