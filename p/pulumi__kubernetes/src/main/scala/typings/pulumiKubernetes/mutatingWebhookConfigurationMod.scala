...
@JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/MutatingWebhookConfiguration", JSImport.Namespace)
@js.native
object mutatingWebhookConfigurationMod extends js.Object {
  @js.native
