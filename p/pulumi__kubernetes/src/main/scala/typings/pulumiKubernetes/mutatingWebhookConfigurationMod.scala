...
object mutatingWebhookConfigurationMod {
  ...
  object MutatingWebhookConfiguration {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/mutatingWebhookConfiguration", "MutatingWebhookConfiguration.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/admissionregistration/v1beta1/mutatingWebhookConfiguration", "MutatingWebhookConfiguration.isInstance")
    @js.native
  ...
  trait MutatingWebhookConfigurationArgs extends StObject {
    ...
    val webhooks: js.UndefOr[
        Input[
          js.Array[
            Input[typings.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhook]
          ]
        ]
      ] = js.native
  }
  object MutatingWebhookConfigurationArgs {
    ...
    implicit class MutatingWebhookConfigurationArgsMutableBuilder[Self <: MutatingWebhookConfigurationArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setWebhooksVarargs(value: Input[typings.pulumiKubernetes.inputMod.admissionregistration.v1beta1.MutatingWebhook]*): Self = StObject.set(x, "webhooks", js.Array(value :_*))
    }
  }
}
