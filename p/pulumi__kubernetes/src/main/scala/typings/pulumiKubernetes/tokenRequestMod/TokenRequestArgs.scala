package typings.pulumiKubernetes.tokenRequestMod

import typings.pulumiKubernetes.inputMod.authentication.v1.TokenRequestSpec
...
trait TokenRequestArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest]] = js.native
...
object TokenRequestArgs {
  ...
  implicit class TokenRequestArgsOps[Self <: TokenRequestArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.TokenRequest]): Self = this.set("kind", value.asInstanceOf[js.Any])
