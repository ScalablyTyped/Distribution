...
object v1beta1RuntimeClassListMod {
  ...
  object RuntimeClassListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass]]]): RuntimeClassListArgs = {
    ...
    extension [Self <: RuntimeClassListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.node.v1beta1.RuntimeClass]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RuntimeClassList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
