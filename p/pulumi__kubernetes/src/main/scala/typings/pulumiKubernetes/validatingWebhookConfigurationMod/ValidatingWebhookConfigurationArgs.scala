package typings.pulumiKubernetes.validatingWebhookConfigurationMod

import typings.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhook
