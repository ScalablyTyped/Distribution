...
import typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet
...
object ReplicaSetListArgs {
  ...
  implicit class ReplicaSetListArgsOps[Self <: ReplicaSetListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSetList]): Self = this.set("kind", value.asInstanceOf[js.Any])
