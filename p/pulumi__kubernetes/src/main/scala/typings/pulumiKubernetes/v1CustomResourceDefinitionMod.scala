...
object v1CustomResourceDefinitionMod {
  ...
  trait CustomResourceDefinitionArgs extends StObject {
    ...
    /**
      * spec describes how the user wants the resources to appear
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.apiextensions.v1.CustomResourceDefinitionSpec] = js.native
  }
  object CustomResourceDefinitionArgs {
    
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.apiextensions.v1.CustomResourceDefinitionSpec]): CustomResourceDefinitionArgs = {
    ...
    implicit class CustomResourceDefinitionArgsMutableBuilder[Self <: CustomResourceDefinitionArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.apiextensions.v1.CustomResourceDefinitionSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
