...
class NetworkPolicyList protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicyList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicyList,
