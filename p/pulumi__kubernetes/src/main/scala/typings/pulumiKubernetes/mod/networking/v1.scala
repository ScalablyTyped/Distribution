...
object v1 extends js.Object {
  ...
  class Ingress protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.Ingress {
    /**
  ...
  class IngressClass protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.IngressClass {
    /**
  ...
  class IngressClassList protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.IngressClassList {
    /**
  ...
  class IngressList protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.IngressList {
    /**
  ...
  class NetworkPolicy protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.NetworkPolicy {
    /**
  ...
  class NetworkPolicyList protected ()
    extends typings.pulumiKubernetes.networkingMod.v1.NetworkPolicyList {
    /**
