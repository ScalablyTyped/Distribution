...
class EventList protected ()
  extends typings.pulumiKubernetes.coreMod.v1.EventList {
  /**
...
object EventList {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.eventListMod.EventList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.eventListMod.EventList]
  inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.eventListMod.EventList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.eventListMod.EventList]
