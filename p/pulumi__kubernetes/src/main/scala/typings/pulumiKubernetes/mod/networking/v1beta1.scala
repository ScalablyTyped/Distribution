package typings.pulumiKubernetes.mod.networking
...
object v1beta1 extends js.Object {
  ...
  class Ingress protected ()
    extends typings.pulumiKubernetes.networkingMod.v1beta1.Ingress {
    /**
  ...
  class IngressClass protected ()
    extends typings.pulumiKubernetes.networkingMod.v1beta1.IngressClass {
    /**
  ...
  class IngressClassList protected ()
    extends typings.pulumiKubernetes.networkingMod.v1beta1.IngressClassList {
    /**
  ...
  class IngressList protected ()
    extends typings.pulumiKubernetes.networkingMod.v1beta1.IngressList {
    /**
