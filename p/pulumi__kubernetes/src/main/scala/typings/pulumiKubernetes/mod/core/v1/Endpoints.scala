...
class Endpoints protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.Endpoints) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.core.v1.Endpoints,
...
object Endpoints extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.endpointsMod.Endpoints = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.endpointsMod.Endpoints = js.native
  /**
