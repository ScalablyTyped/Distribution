...
import typings.pulumiKubernetes.endpointsMod.EndpointsArgs
...
class Endpoints protected ()
  extends typings.pulumiKubernetes.coreMod.v1.Endpoints {
  /**
...
object Endpoints {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.endpointsMod.Endpoints = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.endpointsMod.Endpoints]
  inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.endpointsMod.Endpoints = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.endpointsMod.Endpoints]
