...
object Secret extends js.Object {
  ...
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.secretMod.Secret = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.secretMod.Secret = js.native
