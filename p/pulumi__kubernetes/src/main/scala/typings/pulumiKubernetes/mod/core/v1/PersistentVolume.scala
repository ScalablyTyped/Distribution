...
class PersistentVolume protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.PersistentVolume) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.core.v1.PersistentVolume,
