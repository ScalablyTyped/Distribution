...
object v1 extends js.Object {
  ...
  class ControllerRevisionList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevisionList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.ControllerRevisionList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class DaemonSet protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class DaemonSetList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.DaemonSetList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.DaemonSetList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class ReplicaSet protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1.ReplicaSet,
      opts: CustomResourceOptions
    ) = this()
  }
