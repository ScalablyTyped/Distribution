package typings.pulumiKubernetes.mod.storage
...
object v1alpha1 extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typings.pulumiKubernetes.storageMod.v1alpha1.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typings.pulumiKubernetes.storageMod.v1alpha1.VolumeAttachmentList {
    /**
