...
class DaemonSetList protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DaemonSetList,
