...
class Node protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.Node) = this()
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.Node, opts: CustomResourceOptions) = this()
}
...
object Node extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.nodeMod.Node = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.nodeMod.Node = js.native
  /**
