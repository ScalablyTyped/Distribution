...
class PersistentVolumeList protected ()
  extends typings.pulumiKubernetes.coreMod.v1.PersistentVolumeList {
  /**
...
object PersistentVolumeList {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList]
  inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.persistentVolumeListMod.PersistentVolumeList]
