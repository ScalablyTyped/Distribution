...
class PersistentVolumeList protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.core.v1.PersistentVolumeList,
