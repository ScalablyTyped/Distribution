...
object ResourceQuotaList {
  ...
  /**
    ...
    */
  @scala.inline
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList]
  @scala.inline
