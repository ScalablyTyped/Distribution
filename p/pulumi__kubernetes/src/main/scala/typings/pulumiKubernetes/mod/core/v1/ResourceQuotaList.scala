...
import typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaListArgs
...
class ResourceQuotaList protected ()
  extends typings.pulumiKubernetes.coreMod.v1.ResourceQuotaList {
  /**
...
object ResourceQuotaList {
  ...
  /**
    ...
    */
  inline def get(name: String, id: Input[ID]): typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList]
  inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList]
