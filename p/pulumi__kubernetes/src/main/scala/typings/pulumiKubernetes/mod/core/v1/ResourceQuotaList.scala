...
class ResourceQuotaList protected ()
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.core.v1.ResourceQuotaList,
...
object ResourceQuotaList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.resourceQuotaListMod.ResourceQuotaList = js.native
  /**
