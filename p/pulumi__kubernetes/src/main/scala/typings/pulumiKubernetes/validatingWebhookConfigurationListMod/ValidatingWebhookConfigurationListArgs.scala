...
import typings.pulumiKubernetes.inputMod.admissionregistration.v1beta1.ValidatingWebhookConfiguration
...
@js.native
trait ValidatingWebhookConfigurationListArgs extends js.Object {
  ...
  /**
    ...
    */
  val items: Input[js.Array[Input[ValidatingWebhookConfiguration]]] = js.native
...
object ValidatingWebhookConfigurationListArgs {
  ...
  @scala.inline
  def apply(items: Input[js.Array[Input[ValidatingWebhookConfiguration]]]): ValidatingWebhookConfigurationListArgs = {
    val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
    __obj.asInstanceOf[ValidatingWebhookConfigurationListArgs]
  }
  
  @scala.inline
  implicit class ValidatingWebhookConfigurationListArgsOps[Self <: ValidatingWebhookConfigurationListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: Input[ValidatingWebhookConfiguration]*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: Input[js.Array[Input[ValidatingWebhookConfiguration]]]): Self = this.set("items", value.asInstanceOf[js.Any])
