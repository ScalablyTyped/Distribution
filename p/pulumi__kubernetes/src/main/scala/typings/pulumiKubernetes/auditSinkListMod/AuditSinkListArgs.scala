...
import typings.pulumiKubernetes.inputMod.auditregistration.v1alpha1.AuditSink
...
object AuditSinkListArgs {
  ...
  implicit class AuditSinkListArgsOps[Self <: AuditSinkListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
