...
@JSImport("@pulumi/kubernetes/extensions/v1beta1/NetworkPolicy", JSImport.Namespace)
@js.native
object networkPolicyMod extends js.Object {
  @js.native
  class NetworkPolicy protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.NetworkPolicy,
