...
object deploymentListMod {
  ...
  object DeploymentList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/deploymentList", "DeploymentList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/deploymentList", "DeploymentList.isInstance")
    @js.native
  ...
  trait DeploymentListArgs extends StObject {
    ...
    /**
      * Items is the list of Deployments.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.Deployment]]] = js.native
