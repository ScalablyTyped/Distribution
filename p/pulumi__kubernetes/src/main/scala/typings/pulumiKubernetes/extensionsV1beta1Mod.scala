...
object extensionsV1beta1Mod {
  ...
  class DaemonSetList protected ()
    extends typings.pulumiKubernetes.v1beta1DaemonSetListMod.DaemonSetList {
    /**
  ...
  class IngressList protected ()
    extends typings.pulumiKubernetes.ingressListMod.IngressList {
    /**
  ...
  class NetworkPolicy protected ()
    extends typings.pulumiKubernetes.networkPolicyMod.NetworkPolicy {
    /**
  ...
  class NetworkPolicyList protected ()
    extends typings.pulumiKubernetes.networkPolicyListMod.NetworkPolicyList {
    /**
  ...
  class PodSecurityPolicy protected ()
    extends typings.pulumiKubernetes.podSecurityPolicyMod.PodSecurityPolicy {
    /**
  ...
  class ReplicaSetList protected ()
    extends typings.pulumiKubernetes.v1beta1ReplicaSetListMod.ReplicaSetList {
    /**
