...
object v1LeaseListMod {
  ...
  object LeaseList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/coordination/v1/leaseList", "LeaseList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/coordination/v1/leaseList", "LeaseList.isInstance")
    @js.native
  ...
  trait LeaseListArgs extends StObject {
    ...
    /**
      * Items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.coordination.v1.Lease]]] = js.native
