...
object v1LeaseListMod {
  ...
  object LeaseListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.coordination.v1.Lease]]]): LeaseListArgs = {
    ...
    extension [Self <: LeaseListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.coordination.v1.Lease]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.coordination.v1.Lease]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.LeaseList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
