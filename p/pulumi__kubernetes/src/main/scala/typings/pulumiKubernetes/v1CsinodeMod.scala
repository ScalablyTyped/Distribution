...
object v1CsinodeMod {
  ...
  object CSINodeArgs {
    ...
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINodeSpec]): CSINodeArgs = {
    ...
    extension [Self <: CSINodeArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINodeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
