...
object replicationControllerMod {
  ...
  class ReplicationController protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output_[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController] = js.native
  ...
  object ReplicationController {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): ReplicationController = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ReplicationController]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): ReplicationController = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ReplicationController]
  ...
  trait ReplicationControllerArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]] = js.undefined
    ...
    /**
      * Spec defines the specification of the desired behavior of the replication controller. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerSpec]] = js.undefined
  }
  object ReplicationControllerArgs {
    
    inline def apply(): ReplicationControllerArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ReplicationControllerArgs]
    }
    
    extension [Self <: ReplicationControllerArgs](x: Self) {
      
      inline def setApiVersion(value: Input[v1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
      
      inline def setApiVersionUndefined: Self = StObject.set(x, "apiVersion", js.undefined)
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
