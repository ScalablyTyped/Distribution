...
object replicationControllerMod {
  ...
  object ReplicationController {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): ReplicationController = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[ReplicationController]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): ReplicationController = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[ReplicationController]
  ...
  object ReplicationControllerArgs {
    ...
    implicit class ReplicationControllerArgsMutableBuilder[Self <: ReplicationControllerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicationController]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.ReplicationControllerSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
