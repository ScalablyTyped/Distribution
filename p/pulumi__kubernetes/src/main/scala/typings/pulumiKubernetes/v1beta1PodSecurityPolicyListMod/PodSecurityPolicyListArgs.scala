...
import typings.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicy
...
trait PodSecurityPolicyListArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]] = js.native
...
object PodSecurityPolicyListArgs {
  ...
  implicit class PodSecurityPolicyListArgsOps[Self <: PodSecurityPolicyListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]): Self = this.set("kind", value.asInstanceOf[js.Any])
