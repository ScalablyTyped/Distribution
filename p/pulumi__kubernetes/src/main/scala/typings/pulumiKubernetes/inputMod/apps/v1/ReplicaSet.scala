...
object ReplicaSet {
  ...
  extension [Self <: ReplicaSet](x: Self) {
    ...
    inline def setSpec(value: Input[ReplicaSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    inline def setStatus(value: Input[ReplicaSetStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
