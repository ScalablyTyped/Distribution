...
trait ReplicaSet extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSet]] = js.native
  ...
  /**
    ...
    */
  var spec: js.UndefOr[Input[ReplicaSetSpec]] = js.native
  
  /**
    * Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  var status: js.UndefOr[Input[ReplicaSetStatus]] = js.native
}
object ReplicaSet {
  
  @scala.inline
  def apply(): ReplicaSet = {
  ...
  implicit class ReplicaSetMutableBuilder[Self <: ReplicaSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: Input[ReplicaSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    @scala.inline
    def setStatus(value: Input[ReplicaSetStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
