...
trait ResourceQuota extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota]] = js.undefined
  /**
...
object ResourceQuota {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ResourceQuota] = null,
