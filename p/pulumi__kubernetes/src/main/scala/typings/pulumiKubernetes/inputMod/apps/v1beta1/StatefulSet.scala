...
object StatefulSet {
  ...
  implicit class StatefulSetMutableBuilder[Self <: StatefulSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpec(value: Input[StatefulSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    @scala.inline
    def setStatus(value: Input[StatefulSetStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
