...
trait EndpointSliceList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList]] = js.undefined
  /**
...
object EndpointSliceList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList] = null,
