...
object LimitRange {
  ...
  extension [Self <: LimitRange](x: Self) {
    ...
    inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSpec(value: Input[LimitRangeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
