...
trait PodList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodList]] = js.undefined
  /**
...
object PodList {
  @scala.inline
  def apply(
    items: Input[js.Array[Input[Pod]]],
    apiVersion: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.v1] = null,
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodList] = null,
