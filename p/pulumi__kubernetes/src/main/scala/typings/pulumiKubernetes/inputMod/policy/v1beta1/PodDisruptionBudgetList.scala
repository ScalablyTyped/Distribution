...
trait PodDisruptionBudgetList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList]] = js.undefined
...
object PodDisruptionBudgetList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudgetList] = null,
