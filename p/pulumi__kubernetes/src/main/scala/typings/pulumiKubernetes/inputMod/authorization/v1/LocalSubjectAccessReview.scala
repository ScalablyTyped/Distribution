...
trait LocalSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.LocalSubjectAccessReview]] = js.undefined
...
object LocalSubjectAccessReview {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.LocalSubjectAccessReview] = null,
