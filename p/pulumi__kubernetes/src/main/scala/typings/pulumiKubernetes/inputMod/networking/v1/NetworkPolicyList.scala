...
trait NetworkPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList]] = js.undefined
  /**
...
object NetworkPolicyList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NetworkPolicyList] = null,
