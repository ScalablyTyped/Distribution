...
trait HorizontalPodAutoscalerSpec extends js.Object {
  /**
    ...
    */
  var behavior: js.UndefOr[Input[HorizontalPodAutoscalerBehavior]] = js.native
  /**
...
object HorizontalPodAutoscalerSpec {
  ...
  implicit class HorizontalPodAutoscalerSpecOps[Self <: HorizontalPodAutoscalerSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBehavior(value: Input[HorizontalPodAutoscalerBehavior]): Self = this.set("behavior", value.asInstanceOf[js.Any])
    @scala.inline
