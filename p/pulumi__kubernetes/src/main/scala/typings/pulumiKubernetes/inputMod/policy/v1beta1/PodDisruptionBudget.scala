...
object PodDisruptionBudget {
  ...
  implicit class PodDisruptionBudgetOps[Self <: PodDisruptionBudget] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setStatus(value: Input[PodDisruptionBudgetStatus]): Self = this.set("status", value.asInstanceOf[js.Any])
    @scala.inline
