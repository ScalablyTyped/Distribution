...
object PodDisruptionBudget {
  ...
  extension [Self <: PodDisruptionBudget](x: Self) {
    ...
    inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodDisruptionBudget]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
