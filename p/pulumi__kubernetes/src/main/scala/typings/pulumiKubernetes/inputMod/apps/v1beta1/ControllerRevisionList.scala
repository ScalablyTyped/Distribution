...
trait ControllerRevisionList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList]] = js.undefined
  /**
    * More info:
...
object ControllerRevisionList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ControllerRevisionList] = null,
