...
trait SelfSubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectAccessReview]] = js.undefined
...
object SelfSubjectAccessReview {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectAccessReview] = null,
