...
trait VolumeAttachmentList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList]] = js.undefined
  /**
...
object VolumeAttachmentList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.VolumeAttachmentList] = null,
