...
object Namespace {
  ...
  extension [Self <: Namespace](x: Self) {
    ...
    inline def setSpec(value: Input[NamespaceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    inline def setStatus(value: Input[NamespaceStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
