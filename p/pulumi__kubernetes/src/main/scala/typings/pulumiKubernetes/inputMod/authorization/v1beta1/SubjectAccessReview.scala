...
trait SubjectAccessReview extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview]] = js.undefined
...
object SubjectAccessReview {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SubjectAccessReview] = null,
