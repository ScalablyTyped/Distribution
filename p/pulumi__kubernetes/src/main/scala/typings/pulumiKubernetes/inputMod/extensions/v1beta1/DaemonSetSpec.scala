...
trait DaemonSetSpec extends js.Object {
  ...
  /**
    ...
    */
  var templateGeneration: js.UndefOr[Input[Double]] = js.native
  /**
...
object DaemonSetSpec {
  ...
  implicit class DaemonSetSpecOps[Self <: DaemonSetSpec] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTemplateGeneration(value: Input[Double]): Self = this.set("templateGeneration", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteTemplateGeneration: Self = this.set("templateGeneration", js.undefined)
    @scala.inline
