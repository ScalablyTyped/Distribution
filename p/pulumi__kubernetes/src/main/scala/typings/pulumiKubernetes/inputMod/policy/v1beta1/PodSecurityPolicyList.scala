...
trait PodSecurityPolicyList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList]] = js.undefined
  /**
...
object PodSecurityPolicyList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodSecurityPolicyList] = null,
