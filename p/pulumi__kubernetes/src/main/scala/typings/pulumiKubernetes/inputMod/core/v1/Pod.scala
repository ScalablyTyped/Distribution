...
object Pod {
  ...
  extension [Self <: Pod](x: Self) {
    ...
    inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Pod]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setStatus(value: Input[PodStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
