...
object Pod {
  ...
  implicit class PodMutableBuilder[Self <: Pod] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Pod]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setStatus(value: Input[PodStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
