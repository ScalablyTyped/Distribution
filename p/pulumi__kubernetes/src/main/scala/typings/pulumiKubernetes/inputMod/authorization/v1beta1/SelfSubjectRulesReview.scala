...
trait SelfSubjectRulesReview extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview]] = js.undefined
...
object SelfSubjectRulesReview {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.SelfSubjectRulesReview] = null,
