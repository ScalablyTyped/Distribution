...
trait RoleBinding extends js.Object {
  /**
    ...
    */
  var apiVersion: js.UndefOr[Input[rbacDotauthorizationDotk8sDotioSlashv1]] = js.native
  /**
    * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RoleBinding]] = js.native
  /**
...
object RoleBinding {
  ...
  implicit class RoleBindingOps[Self <: RoleBinding] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RoleBinding]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
