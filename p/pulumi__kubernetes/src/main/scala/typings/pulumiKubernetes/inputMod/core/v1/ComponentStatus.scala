...
trait ComponentStatus extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatus]] = js.native
  /**
...
object ComponentStatus {
  ...
  implicit class ComponentStatusOps[Self <: ComponentStatus] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConditionsVarargs(value: Input[ComponentCondition]*): Self = this.set("conditions", js.Array(value :_*))
    @scala.inline
    def setConditions(value: Input[js.Array[Input[ComponentCondition]]]): Self = this.set("conditions", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteConditions: Self = this.set("conditions", js.undefined)
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ComponentStatus]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
