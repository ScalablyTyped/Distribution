package typings.pulumiKubernetes.inputMod.scheduling.v1beta1
...
trait PriorityClassList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList]] = js.undefined
  /**
...
object PriorityClassList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList] = null,
