...
trait EndpointsList extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList]] = js.undefined
  /**
...
object EndpointsList {
  ...
  def apply(
    ...
    kind: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointsList] = null,
