...
object Service {
  ...
  implicit class ServiceOps[Self <: Service] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Service]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSpec(value: Input[ServiceSpec]): Self = this.set("spec", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSpec: Self = this.set("spec", js.undefined)
    @scala.inline
    def setStatus(value: Input[ServiceStatus]): Self = this.set("status", value.asInstanceOf[js.Any])
    @scala.inline
