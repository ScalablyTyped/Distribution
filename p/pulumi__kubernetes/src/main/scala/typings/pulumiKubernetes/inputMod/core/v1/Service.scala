...
trait Service extends StObject {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Service]] = js.undefined
...
object Service {
  ...
  extension [Self <: Service](x: Self) {
    ...
    inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Service]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
    ...
    inline def setSpec(value: Input[ServiceSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    
    inline def setSpecUndefined: Self = StObject.set(x, "spec", js.undefined)
    
    inline def setStatus(value: Input[ServiceStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
