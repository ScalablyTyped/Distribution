...
object storageClassListMod extends js.Object {
  ...
  class StorageClassList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.StorageClassList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.StorageClassList,
