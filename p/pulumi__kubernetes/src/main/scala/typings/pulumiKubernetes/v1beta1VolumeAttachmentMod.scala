...
object v1beta1VolumeAttachmentMod {
  ...
  trait VolumeAttachmentArgs extends StObject {
    ...
    /**
      * Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec]
  }
  object VolumeAttachmentArgs {
    
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec]): VolumeAttachmentArgs = {
    ...
    extension [Self <: VolumeAttachmentArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
