...
import typings.pulumiKubernetes.outputMod.policy.v1beta1.PodSecurityPolicySpec
...
object v1beta1PodSecurityPolicyMod {
  ...
  trait PodSecurityPolicyArgs extends StObject {
    ...
    /**
      * spec defines the policy enforced.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicySpec]] = js.undefined
  }
  object PodSecurityPolicyArgs {
    ...
    extension [Self <: PodSecurityPolicyArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.policy.v1beta1.PodSecurityPolicySpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
