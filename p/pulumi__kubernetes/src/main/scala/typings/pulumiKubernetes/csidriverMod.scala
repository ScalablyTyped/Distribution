...
object csidriverMod {
  ...
  trait CSIDriverArgs extends StObject {
    ...
    /**
      * Specification of the CSI Driver.
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec] = js.native
  }
  object CSIDriverArgs {
    
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec]): CSIDriverArgs = {
    ...
    implicit class CSIDriverArgsMutableBuilder[Self <: CSIDriverArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.storage.v1beta1.CSIDriverSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
