...
object v1beta1EventListMod {
  ...
  object EventListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1beta1.Event]]]): EventListArgs = {
    ...
    implicit class EventListArgsMutableBuilder[Self <: EventListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1beta1.Event]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.events.v1beta1.Event]*): Self = StObject.set(x, "items", js.Array(value :_*))
