...
object v1beta1EventListMod {
  ...
  object EventList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/events/v1beta1/eventList", "EventList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/events/v1beta1/eventList", "EventList.isInstance")
    @js.native
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * items is a list of schema objects.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.events.v1beta1.Event]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EventList]] = js.native
