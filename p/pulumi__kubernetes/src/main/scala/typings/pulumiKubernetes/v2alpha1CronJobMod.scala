...
object v2alpha1CronJobMod {
  ...
  trait CronJobArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.batch.v2alpha1.CronJobSpec]] = js.undefined
  }
  object CronJobArgs {
    ...
    extension [Self <: CronJobArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.batch.v2alpha1.CronJobSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
