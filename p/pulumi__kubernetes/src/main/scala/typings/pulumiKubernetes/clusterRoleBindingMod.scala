...
object clusterRoleBindingMod {
  ...
  object ClusterRoleBindingArgs {
    ...
    inline def apply(roleRef: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef]): ClusterRoleBindingArgs = {
    ...
    extension [Self <: ClusterRoleBindingArgs](x: Self) {
      ...
      inline def setRoleRef(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef]): Self = StObject.set(x, "roleRef", value.asInstanceOf[js.Any])
      
      inline def setSubjects(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.Subject]]]): Self = StObject.set(x, "subjects", value.asInstanceOf[js.Any])
      
      inline def setSubjectsUndefined: Self = StObject.set(x, "subjects", js.undefined)
      
      inline def setSubjectsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.Subject]*): Self = StObject.set(x, "subjects", js.Array(value :_*))
    }
  }
}
