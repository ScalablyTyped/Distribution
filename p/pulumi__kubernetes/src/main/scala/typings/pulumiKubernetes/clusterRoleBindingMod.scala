...
object clusterRoleBindingMod {
  ...
  trait ClusterRoleBindingArgs extends StObject {
    ...
    /**
      * RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.
      */
    val roleRef: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef] = js.native
    
    /**
      * Subjects holds references to the objects the role applies to.
      */
    val subjects: js.UndefOr[Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.Subject]]]] = js.native
  }
  object ClusterRoleBindingArgs {
    
    @scala.inline
    def apply(roleRef: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleRef]): ClusterRoleBindingArgs = {
