...
import typings.pulumiKubernetes.outputMod.storage.v1alpha1.VolumeAttachment
...
object volumeAttachmentListMod {
  ...
  object VolumeAttachmentList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1alpha1/volumeAttachmentList", "VolumeAttachmentList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1alpha1/volumeAttachmentList", "VolumeAttachmentList.isInstance")
    @js.native
