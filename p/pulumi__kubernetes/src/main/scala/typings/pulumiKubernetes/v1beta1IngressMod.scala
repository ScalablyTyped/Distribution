...
import typings.pulumiKubernetes.outputMod.networking.v1beta1.IngressSpec
import typings.pulumiKubernetes.outputMod.networking.v1beta1.IngressStatus
...
object v1beta1IngressMod {
  ...
  object Ingress {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): Ingress = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[Ingress]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): Ingress = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Ingress]
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      */
    val apiVersion: js.UndefOr[Input[networkingDotk8sDotioSlashv1beta1]] = js.undefined
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressSpec]] = js.undefined
  }
  object IngressArgs {
    
    @scala.inline
    def apply(): IngressArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[IngressArgs]
    }
    
    @scala.inline
    implicit class IngressArgsMutableBuilder[Self <: IngressArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
