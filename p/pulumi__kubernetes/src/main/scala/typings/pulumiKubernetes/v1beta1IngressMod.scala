...
object v1beta1IngressMod {
  ...
  object Ingress {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingress", "Ingress.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1beta1/ingress", "Ingress.isInstance")
    @js.native
  ...
  trait IngressArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.Ingress]] = js.native
    ...
    /**
      * Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.networking.v1beta1.IngressSpec]] = js.native
  }
  object IngressArgs {
