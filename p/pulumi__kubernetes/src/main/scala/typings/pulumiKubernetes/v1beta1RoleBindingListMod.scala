...
object v1beta1RoleBindingListMod {
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      * Items is a list of RoleBindings
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]]]
  ...
  object RoleBindingListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]]]): RoleBindingListArgs = {
    ...
    extension [Self <: RoleBindingListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
