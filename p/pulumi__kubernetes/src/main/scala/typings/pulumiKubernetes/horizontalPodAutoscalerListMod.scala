...
object horizontalPodAutoscalerListMod {
  ...
  object HorizontalPodAutoscalerList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v1/horizontalPodAutoscalerList", "HorizontalPodAutoscalerList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v1/horizontalPodAutoscalerList", "HorizontalPodAutoscalerList.isInstance")
    @js.native
  ...
  object HorizontalPodAutoscalerListArgs {
    ...
    implicit class HorizontalPodAutoscalerListArgsMutableBuilder[Self <: HorizontalPodAutoscalerListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscaler]*): Self = StObject.set(x, "items", js.Array(value :_*))
