...
import typings.pulumiKubernetes.inputMod.core.v1.PodTemplate
...
object PodTemplateListArgs {
  ...
  implicit class PodTemplateListArgsOps[Self <: PodTemplateListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodTemplateList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
