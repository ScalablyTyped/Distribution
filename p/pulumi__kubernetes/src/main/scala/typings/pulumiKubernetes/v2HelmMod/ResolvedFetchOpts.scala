...
object ResolvedFetchOpts {
  ...
  def apply(
    ...
    if (!js.isUndefined(devel)) __obj.updateDynamic("devel")(devel.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(prov)) __obj.updateDynamic("prov")(prov.get.asInstanceOf[js.Any])
    if (repo != null) __obj.updateDynamic("repo")(repo.asInstanceOf[js.Any])
    if (!js.isUndefined(untar)) __obj.updateDynamic("untar")(untar.get.asInstanceOf[js.Any])
