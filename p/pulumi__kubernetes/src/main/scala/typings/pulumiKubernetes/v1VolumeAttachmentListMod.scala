...
object v1VolumeAttachmentListMod {
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    /**
      * Items is the list of VolumeAttachments
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]]
  ...
  object VolumeAttachmentListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]]): VolumeAttachmentListArgs = {
    ...
    extension [Self <: VolumeAttachmentListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value :_*))
