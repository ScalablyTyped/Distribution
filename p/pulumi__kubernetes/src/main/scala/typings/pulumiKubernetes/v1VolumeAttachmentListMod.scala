...
object v1VolumeAttachmentListMod {
  ...
  trait VolumeAttachmentListArgs extends StObject {
    ...
    /**
      * Items is the list of VolumeAttachments
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]] = js.native
  ...
  object VolumeAttachmentListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]]): VolumeAttachmentListArgs = {
    ...
    implicit class VolumeAttachmentListArgsMutableBuilder[Self <: VolumeAttachmentListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.VolumeAttachment]*): Self = StObject.set(x, "items", js.Array(value :_*))
