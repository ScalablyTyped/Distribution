...
object leaseMod {
  ...
  trait LeaseArgs extends StObject {
    ...
    /**
      * Specification of the Lease. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseSpec]] = js.undefined
  }
  object LeaseArgs {
    ...
    extension [Self <: LeaseArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.coordination.v1beta1.LeaseSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
