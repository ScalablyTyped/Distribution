...
object nodeListMod {
  ...
  object NodeList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/nodeList", "NodeList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/nodeList", "NodeList.isInstance")
    @js.native
  ...
  trait NodeListArgs extends StObject {
    ...
    /**
      * List of nodes
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.Node]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.NodeList]] = js.native
