...
@JSImport("@pulumi/kubernetes/core/v1/NodeList", JSImport.Namespace)
@js.native
object nodeListMod extends js.Object {
  ...
  class NodeList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.NodeList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.core.v1.NodeList,
