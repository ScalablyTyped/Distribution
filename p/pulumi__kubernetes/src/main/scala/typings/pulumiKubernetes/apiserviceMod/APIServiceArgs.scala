...
import typings.pulumiKubernetes.inputMod.apiregistration.v1beta1.APIServiceSpec
...
trait APIServiceArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.APIService]] = js.native
...
object APIServiceArgs {
  ...
  implicit class APIServiceArgsOps[Self <: APIServiceArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.APIService]): Self = this.set("kind", value.asInstanceOf[js.Any])
