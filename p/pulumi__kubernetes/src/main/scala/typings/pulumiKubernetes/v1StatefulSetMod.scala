...
object v1StatefulSetMod {
  ...
  object StatefulSet {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): StatefulSet = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[StatefulSet]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): StatefulSet = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[StatefulSet]
    ...
    /**
      ...
      */
    @scala.inline
    def isInstance(obj: js.Any): /* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1/statefulSet.StatefulSet */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstance")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is @pulumi/kubernetes.@pulumi/kubernetes/apps/v1/statefulSet.StatefulSet */ Boolean]
  }
  ...
  trait StatefulSetArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.StatefulSet]] = js.undefined
    ...
    /**
      * Spec defines the desired identities of pods in this set.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSetSpec]] = js.undefined
  }
  object StatefulSetArgs {
    ...
    implicit class StatefulSetArgsMutableBuilder[Self <: StatefulSetArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
