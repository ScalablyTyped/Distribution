...
object v1StatefulSetMod {
  ...
  object StatefulSet {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/statefulSet", "StatefulSet.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1/statefulSet", "StatefulSet.isInstance")
    @js.native
  ...
  trait StatefulSetArgs extends StObject {
    ...
    /**
      * Spec defines the desired identities of pods in this set.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.apps.v1.StatefulSetSpec]] = js.native
  }
