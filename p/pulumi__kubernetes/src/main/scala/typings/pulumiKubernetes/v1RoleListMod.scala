...
object v1RoleListMod {
  ...
  object RoleListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]]]): RoleListArgs = {
    ...
    extension [Self <: RoleListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]*): Self = StObject.set(x, "items", js.Array(value :_*))
