...
object v1RoleListMod {
  ...
  object RoleList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): RoleList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[RoleList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): RoleList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[RoleList]
  ...
  trait RoleListArgs extends StObject {
    ...
    /**
      * Items is a list of Roles
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]]]
  ...
  object RoleListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]]]): RoleListArgs = {
    ...
    implicit class RoleListArgsMutableBuilder[Self <: RoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1.Role]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.RoleList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
