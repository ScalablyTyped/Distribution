...
object v1CsinodeListMod {
  ...
  object CSINodeList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): CSINodeList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[CSINodeList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): CSINodeList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[CSINodeList]
  ...
  trait CSINodeListArgs extends StObject {
    ...
    /**
      * items is the list of CSINode
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]]
  ...
  object CSINodeListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): CSINodeListArgs = {
    ...
    implicit class CSINodeListArgsMutableBuilder[Self <: CSINodeListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
