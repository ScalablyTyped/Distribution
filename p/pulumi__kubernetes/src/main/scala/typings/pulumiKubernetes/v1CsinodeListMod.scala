...
object v1CsinodeListMod {
  ...
  object CSINodeListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): CSINodeListArgs = {
    ...
    extension [Self <: CSINodeListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]*): Self = StObject.set(x, "items", js.Array(value :_*))
