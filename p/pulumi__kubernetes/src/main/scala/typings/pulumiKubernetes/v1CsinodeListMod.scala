...
object v1CsinodeListMod {
  ...
  object CSINodeList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/csinodeList", "CSINodeList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/storage/v1/csinodeList", "CSINodeList.isInstance")
    @js.native
  ...
  trait CSINodeListArgs extends StObject {
    ...
    /**
      * items is the list of CSINode
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.storage.v1.CSINode]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.CSINodeList]] = js.native
