...
import typings.pulumiKubernetes.outputMod.networking.v1.NetworkPolicySpec
...
object v1NetworkPolicyMod {
  
  @JSImport("@pulumi/kubernetes/networking/v1/networkPolicy", "NetworkPolicy")
  @js.native
  ...
  object NetworkPolicy {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1/networkPolicy", "NetworkPolicy.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/networking/v1/networkPolicy", "NetworkPolicy.isInstance")
    @js.native
  ...
  trait NetworkPolicyArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior for this NetworkPolicy.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.networking.v1.NetworkPolicySpec]] = js.native
  }
