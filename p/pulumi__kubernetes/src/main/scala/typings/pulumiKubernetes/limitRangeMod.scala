...
object limitRangeMod {
  ...
  object LimitRange {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): LimitRange = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[LimitRange]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): LimitRange = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[LimitRange]
