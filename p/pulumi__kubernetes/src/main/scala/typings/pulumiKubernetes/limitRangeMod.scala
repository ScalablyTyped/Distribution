...
object limitRangeMod {
  ...
  object LimitRange {
    ...
    /**
      ...
      */
    inline def get(name: String, id: Input[ID]): LimitRange = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[LimitRange]
    inline def get(name: String, id: Input[ID], opts: CustomResourceOptions): LimitRange = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[LimitRange]
  ...
  trait LimitRangeArgs extends StObject {
    ...
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.LimitRange]] = js.undefined
    ...
    /**
      * Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.core.v1.LimitRangeSpec]] = js.undefined
  }
  object LimitRangeArgs {
    
    inline def apply(): LimitRangeArgs = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LimitRangeArgs]
    }
    
    extension [Self <: LimitRangeArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.core.v1.LimitRangeSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
