...
object v1DeploymentMod {
  ...
  trait DeploymentArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of the Deployment.
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.apps.v1.DeploymentSpec]] = js.undefined
  }
  object DeploymentArgs {
    ...
    extension [Self <: DeploymentArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.DeploymentSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
