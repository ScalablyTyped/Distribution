...
object horizontalPodAutoscalerMod {
  ...
  trait HorizontalPodAutoscalerArgs extends StObject {
    ...
    /**
      ...
      */
    val spec: js.UndefOr[
        Input[typings.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscalerSpec]
      ] = js.undefined
  }
  object HorizontalPodAutoscalerArgs {
    ...
    extension [Self <: HorizontalPodAutoscalerArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscalerSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
