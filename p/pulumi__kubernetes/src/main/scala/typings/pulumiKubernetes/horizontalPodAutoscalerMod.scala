...
object horizontalPodAutoscalerMod {
  ...
  object HorizontalPodAutoscalerArgs {
    ...
    implicit class HorizontalPodAutoscalerArgsMutableBuilder[Self <: HorizontalPodAutoscalerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.autoscaling.v1.HorizontalPodAutoscalerSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
