...
object v1beta2StatefulSetListMod {
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSet]]] = js.native
  ...
  object StatefulSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSet]]]): StatefulSetListArgs = {
    ...
    implicit class StatefulSetListArgsMutableBuilder[Self <: StatefulSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
