package typings.pulumiKubernetes.v2beta1HorizontalPodAutoscalerListMod

import typings.pulumiKubernetes.inputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
