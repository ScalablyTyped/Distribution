...
object endpointSliceListMod {
  ...
  object EndpointSliceListArgs {
    ...
    implicit class EndpointSliceListArgsMutableBuilder[Self <: EndpointSliceListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      @scala.inline
      def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.EndpointSliceList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
