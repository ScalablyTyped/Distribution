...
object v1SubjectAccessReviewMod {
  ...
  trait SubjectAccessReviewArgs extends StObject {
    ...
    /**
      * Spec holds information about the request being evaluated
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec] = js.native
  }
  object SubjectAccessReviewArgs {
    
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): SubjectAccessReviewArgs = {
    ...
    implicit class SubjectAccessReviewArgsMutableBuilder[Self <: SubjectAccessReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
