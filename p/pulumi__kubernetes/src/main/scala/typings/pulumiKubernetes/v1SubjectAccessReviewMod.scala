...
object v1SubjectAccessReviewMod {
  ...
  trait SubjectAccessReviewArgs extends StObject {
    ...
    /**
      * Spec holds information about the request being evaluated
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]
  }
  object SubjectAccessReviewArgs {
    
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): SubjectAccessReviewArgs = {
    ...
    extension [Self <: SubjectAccessReviewArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
