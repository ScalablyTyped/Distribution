...
object v1beta1RoleListMod {
  ...
  object RoleListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.Role]]]): RoleListArgs = {
    ...
    implicit class RoleListArgsMutableBuilder[Self <: RoleListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.Role]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1beta1.Role]*): Self = StObject.set(x, "items", js.Array(value :_*))
