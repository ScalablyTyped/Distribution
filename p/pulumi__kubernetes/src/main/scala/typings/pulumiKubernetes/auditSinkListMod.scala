...
object auditSinkListMod {
  ...
  object AuditSinkListArgs {
    ...
    extension [Self <: AuditSinkListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.auditregistration.v1alpha1.AuditSink]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.AuditSinkList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
