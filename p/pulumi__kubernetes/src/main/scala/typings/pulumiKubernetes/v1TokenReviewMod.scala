...
object v1TokenReviewMod {
  ...
  object TokenReviewArgs {
    ...
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authentication.v1.TokenReviewSpec]): TokenReviewArgs = {
    ...
    implicit class TokenReviewArgsMutableBuilder[Self <: TokenReviewArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.authentication.v1.TokenReviewSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
