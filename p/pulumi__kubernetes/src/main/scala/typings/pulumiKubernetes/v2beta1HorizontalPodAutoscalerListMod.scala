...
import typings.pulumiKubernetes.outputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
...
object v2beta1HorizontalPodAutoscalerListMod {
  ...
  trait HorizontalPodAutoscalerListArgs extends StObject {
    ...
    val items: Input[
        js.Array[
          Input[typings.pulumiKubernetes.inputMod.autoscaling.v2beta1.HorizontalPodAutoscaler]
        ]
      ]
  ...
  object HorizontalPodAutoscalerListArgs {
    ...
    extension [Self <: HorizontalPodAutoscalerListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.autoscaling.v2beta1.HorizontalPodAutoscaler]*): Self = StObject.set(x, "items", js.Array(value :_*))
