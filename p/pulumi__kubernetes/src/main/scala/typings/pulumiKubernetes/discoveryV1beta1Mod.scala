...
object discoveryV1beta1Mod extends js.Object {
  ...
  class EndpointSlice protected ()
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.discovery.v1beta1.EndpointSlice,
