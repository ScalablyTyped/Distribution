...
object statefulSetListMod {
  ...
  object StatefulSetList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/statefulSetList", "StatefulSetList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta1/statefulSetList", "StatefulSetList.isInstance")
    @js.native
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]] = js.native
  ...
  object StatefulSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]]): StatefulSetListArgs = {
    ...
    implicit class StatefulSetListArgsMutableBuilder[Self <: StatefulSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
