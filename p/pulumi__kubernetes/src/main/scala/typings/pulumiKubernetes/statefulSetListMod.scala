...
object statefulSetListMod {
  ...
  trait StatefulSetListArgs extends StObject {
    ...
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]]
  ...
  object StatefulSetListArgs {
    ...
    inline def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]]): StatefulSetListArgs = {
    ...
    extension [Self <: StatefulSetListArgs](x: Self) {
      ...
      inline def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.StatefulSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
