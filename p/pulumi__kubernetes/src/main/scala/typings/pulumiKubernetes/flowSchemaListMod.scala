...
object flowSchemaListMod {
  ...
  object FlowSchemaListArgs {
    ...
    extension [Self <: FlowSchemaListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.flowcontrol.v1alpha1.FlowSchema]*): Self = StObject.set(x, "items", js.Array(value :_*))
      
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.FlowSchemaList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
