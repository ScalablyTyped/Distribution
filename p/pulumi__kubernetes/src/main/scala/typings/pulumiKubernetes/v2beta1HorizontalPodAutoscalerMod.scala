...
import typings.pulumiKubernetes.outputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
import typings.pulumiKubernetes.outputMod.autoscaling.v2beta1.HorizontalPodAutoscalerStatus
...
object v2beta1HorizontalPodAutoscalerMod {
  ...
  object HorizontalPodAutoscaler {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): HorizontalPodAutoscaler = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[HorizontalPodAutoscaler]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): HorizontalPodAutoscaler = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[HorizontalPodAutoscaler]
  ...
  trait HorizontalPodAutoscalerArgs extends StObject {
    ...
    /**
      * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      */
    val apiVersion: js.UndefOr[Input[autoscalingSlashv2beta1]] = js.undefined
    ...
    val spec: js.UndefOr[
        Input[
          typings.pulumiKubernetes.inputMod.autoscaling.v2beta1.HorizontalPodAutoscalerSpec
        ]
      ] = js.undefined
  }
  object HorizontalPodAutoscalerArgs {
    ...
    implicit class HorizontalPodAutoscalerArgsMutableBuilder[Self <: HorizontalPodAutoscalerArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setApiVersion(value: Input[autoscalingSlashv2beta1]): Self = StObject.set(x, "apiVersion", value.asInstanceOf[js.Any])
