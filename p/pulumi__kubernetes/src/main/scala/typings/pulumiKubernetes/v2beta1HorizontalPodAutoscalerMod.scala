...
object v2beta1HorizontalPodAutoscalerMod {
  ...
  object HorizontalPodAutoscaler {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v2beta1/horizontalPodAutoscaler", "HorizontalPodAutoscaler.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/autoscaling/v2beta1/horizontalPodAutoscaler", "HorizontalPodAutoscaler.isInstance")
    @js.native
  ...
  trait HorizontalPodAutoscalerArgs extends StObject {
    ...
    /**
      * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
      */
    val apiVersion: js.UndefOr[Input[autoscalingSlashv2beta1]] = js.native
