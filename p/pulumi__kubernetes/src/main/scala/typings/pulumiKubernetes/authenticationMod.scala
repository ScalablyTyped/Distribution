  ...
  object v1beta1 {
    ...
    object TokenReview {
      ...
      /**
        ...
        */
      @scala.inline
      def get(name: String, id: Input[ID]): typings.pulumiKubernetes.tokenReviewMod.TokenReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.tokenReviewMod.TokenReview]
      @scala.inline
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.pulumiKubernetes.tokenReviewMod.TokenReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[typings.pulumiKubernetes.tokenReviewMod.TokenReview]
