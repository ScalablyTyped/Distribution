...
@JSImport("@pulumi/kubernetes/core/v1/PodTemplate", JSImport.Namespace)
@js.native
object podTemplateMod extends js.Object {
  @js.native
  class PodTemplate protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.core.v1.PodTemplate) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.core.v1.PodTemplate,
