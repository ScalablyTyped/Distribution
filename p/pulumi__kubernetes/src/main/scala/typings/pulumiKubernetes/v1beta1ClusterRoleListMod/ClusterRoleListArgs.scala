...
import typings.pulumiKubernetes.inputMod.rbac.v1beta1.ClusterRole
...
object ClusterRoleListArgs {
  ...
  implicit class ClusterRoleListArgsOps[Self <: ClusterRoleListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ClusterRoleList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
