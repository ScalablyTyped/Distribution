...
import typings.pulumiKubernetes.inputMod.core.v1.PersistentVolume
...
object PersistentVolumeListArgs {
  ...
  implicit class PersistentVolumeListArgsOps[Self <: PersistentVolumeListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PersistentVolumeList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
