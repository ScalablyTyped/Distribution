...
@js.native
trait PodTemplateArgs extends js.Object {
  ...
  /**
    ...
    */
  val template: js.UndefOr[Input[PodTemplateSpec]] = js.native
}
object PodTemplateArgs {
  ...
  @scala.inline
  implicit class PodTemplateArgsOps[Self <: PodTemplateArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PodTemplate]): Self = this.set("kind", value.asInstanceOf[js.Any])
