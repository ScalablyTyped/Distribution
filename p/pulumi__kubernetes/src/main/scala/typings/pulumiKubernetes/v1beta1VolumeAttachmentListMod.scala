...
object v1beta1VolumeAttachmentListMod extends js.Object {
  ...
  class VolumeAttachmentList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.storage.v1beta1.VolumeAttachmentList,
