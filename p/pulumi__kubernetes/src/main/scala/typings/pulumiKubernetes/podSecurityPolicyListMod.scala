...
object podSecurityPolicyListMod {
  ...
  trait PodSecurityPolicyListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy]]
      ]
  ...
  object PodSecurityPolicyListArgs {
    ...
    extension [Self <: PodSecurityPolicyListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicy]*): Self = StObject.set(x, "items", js.Array(value :_*))
