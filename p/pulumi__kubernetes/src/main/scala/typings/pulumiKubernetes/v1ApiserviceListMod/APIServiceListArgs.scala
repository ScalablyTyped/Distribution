...
import typings.pulumiKubernetes.inputMod.apiregistration.v1.APIService
...
trait APIServiceListArgs extends js.Object {
  ...
  /**
    ...
    */
  val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.APIServiceList]] = js.native
...
object APIServiceListArgs {
  ...
  implicit class APIServiceListArgsOps[Self <: APIServiceListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.APIServiceList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
