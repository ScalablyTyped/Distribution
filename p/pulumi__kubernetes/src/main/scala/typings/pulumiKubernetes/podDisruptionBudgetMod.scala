...
object podDisruptionBudgetMod {
  ...
  object PodDisruptionBudgetArgs {
    ...
    extension [Self <: PodDisruptionBudgetArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.policy.v1beta1.PodDisruptionBudgetSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
