...
import typings.pulumiKubernetes.outputMod.core.v1.Event
...
object eventListMod {
  ...
  object EventList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/eventList", "EventList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/core/v1/eventList", "EventList.isInstance")
    @js.native
  ...
  trait EventListArgs extends StObject {
    ...
    /**
      * List of events
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.core.v1.Event]]] = js.native
