package typings.pulumiKubernetes.selfSubjectRulesReviewMod

import typings.pulumiKubernetes.outputMod.authorization.v1beta1.SelfSubjectRulesReviewSpec
import typings.pulumiKubernetes.outputMod.authorization.v1beta1.SubjectRulesReviewStatus
