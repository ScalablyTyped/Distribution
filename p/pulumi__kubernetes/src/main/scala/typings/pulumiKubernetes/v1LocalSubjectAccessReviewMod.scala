...
object v1LocalSubjectAccessReviewMod {
  ...
  object LocalSubjectAccessReview {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): LocalSubjectAccessReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[LocalSubjectAccessReview]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): LocalSubjectAccessReview = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[LocalSubjectAccessReview]
  ...
  object LocalSubjectAccessReviewArgs {
    ...
    @scala.inline
    def apply(spec: Input[typings.pulumiKubernetes.inputMod.authorization.v1.SubjectAccessReviewSpec]): LocalSubjectAccessReviewArgs = {
