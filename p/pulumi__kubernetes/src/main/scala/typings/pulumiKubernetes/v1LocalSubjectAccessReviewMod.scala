...
object v1LocalSubjectAccessReviewMod {
  ...
  object LocalSubjectAccessReview {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/localSubjectAccessReview", "LocalSubjectAccessReview.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/authorization/v1/localSubjectAccessReview", "LocalSubjectAccessReview.isInstance")
    @js.native
