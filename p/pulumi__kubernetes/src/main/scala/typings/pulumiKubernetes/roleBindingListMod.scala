...
object roleBindingListMod {
  ...
  object RoleBindingList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/roleBindingList", "RoleBindingList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/rbac/v1alpha1/roleBindingList", "RoleBindingList.isInstance")
    @js.native
  ...
  trait RoleBindingListArgs extends StObject {
    ...
    /**
      * Items is a list of RoleBindings
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]]] = js.native
  ...
  object RoleBindingListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]]]): RoleBindingListArgs = {
    ...
    implicit class RoleBindingListArgsMutableBuilder[Self <: RoleBindingListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.RoleBinding]*): Self = StObject.set(x, "items", js.Array(value :_*))
