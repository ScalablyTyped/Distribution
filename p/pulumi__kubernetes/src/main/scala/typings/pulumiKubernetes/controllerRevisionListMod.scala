...
object controllerRevisionListMod {
  ...
  trait ControllerRevisionListArgs extends StObject {
    ...
    /**
      ...
      */
    val items: Input[
        js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision]]
      ]
  ...
  object ControllerRevisionListArgs {
    ...
    extension [Self <: ControllerRevisionListArgs](x: Self) {
      ...
      inline def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1beta1.ControllerRevision]*): Self = StObject.set(x, "items", js.Array(value :_*))
