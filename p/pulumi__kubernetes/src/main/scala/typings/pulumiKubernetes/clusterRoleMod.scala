...
object clusterRoleMod {
  ...
  object ClusterRoleArgs {
    ...
    extension [Self <: ClusterRoleArgs](x: Self) {
      ...
      inline def setAggregationRule(value: Input[typings.pulumiKubernetes.inputMod.rbac.v1alpha1.AggregationRule]): Self = StObject.set(x, "aggregationRule", value.asInstanceOf[js.Any])
