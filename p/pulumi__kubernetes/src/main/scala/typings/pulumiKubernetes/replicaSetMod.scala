...
object replicaSetMod extends js.Object {
  ...
  class ReplicaSet protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet,
