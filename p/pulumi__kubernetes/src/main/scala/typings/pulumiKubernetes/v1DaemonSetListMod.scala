...
object v1DaemonSetListMod {
  ...
  object DaemonSetList {
    ...
    /**
      ...
      */
    @scala.inline
    def get(name: String, id: Input[ID]): DaemonSetList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any])).asInstanceOf[DaemonSetList]
    @scala.inline
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): DaemonSetList = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(name.asInstanceOf[js.Any], id.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[DaemonSetList]
  ...
  trait DaemonSetListArgs extends StObject {
    ...
    /**
      * A list of daemon sets.
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]]
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.DaemonSetList]] = js.undefined
  ...
  object DaemonSetListArgs {
    ...
    @scala.inline
    def apply(items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]]): DaemonSetListArgs = {
    ...
    implicit class DaemonSetListArgsMutableBuilder[Self <: DaemonSetListArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItems(value: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet]]]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsVarargs(value: Input[typings.pulumiKubernetes.inputMod.apps.v1.DaemonSet]*): Self = StObject.set(x, "items", js.Array(value :_*))
