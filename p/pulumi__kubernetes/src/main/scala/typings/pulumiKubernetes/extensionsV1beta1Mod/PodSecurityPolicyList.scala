...
class PodSecurityPolicyList protected ()
  extends typings.pulumiKubernetes.podSecurityPolicyListMod.PodSecurityPolicyList {
  /**
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.PodSecurityPolicyList,
