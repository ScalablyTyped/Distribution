...
class DeploymentList protected ()
  extends typings.pulumiKubernetes.v1beta1DeploymentListMod.DeploymentList {
  /**
  ...
  def this(name: String, args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DeploymentList) = this()
  def this(
    name: String,
    args: typings.pulumiKubernetes.inputMod.extensions.v1beta1.DeploymentList,
