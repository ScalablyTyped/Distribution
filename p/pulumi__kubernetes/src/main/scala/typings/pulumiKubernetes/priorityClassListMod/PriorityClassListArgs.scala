...
import typings.pulumiKubernetes.inputMod.scheduling.v1alpha1.PriorityClass
...
object PriorityClassListArgs {
  ...
  implicit class PriorityClassListArgsOps[Self <: PriorityClassListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PriorityClassList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
