...
object v1CertificateSigningRequestMod {
  ...
  trait CertificateSigningRequestArgs extends StObject {
    ...
    /**
      * spec contains the certificate request, and is immutable after creation. Only the request, signerName, and usages fields can be set on creation. Other fields are derived by Kubernetes and cannot be modified by users.
      */
    val spec: Input[typings.pulumiKubernetes.inputMod.certificates.v1.CertificateSigningRequestSpec]
  }
  object CertificateSigningRequestArgs {
    
    inline def apply(spec: Input[typings.pulumiKubernetes.inputMod.certificates.v1.CertificateSigningRequestSpec]): CertificateSigningRequestArgs = {
    ...
    extension [Self <: CertificateSigningRequestArgs](x: Self) {
      ...
      inline def setSpec(value: Input[typings.pulumiKubernetes.inputMod.certificates.v1.CertificateSigningRequestSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
    }
  }
}
