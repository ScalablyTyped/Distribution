...
object priorityLevelConfigurationListMod {
  ...
  object PriorityLevelConfigurationListArgs {
    ...
    extension [Self <: PriorityLevelConfigurationListArgs](x: Self) {
      ...
      inline def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.PriorityLevelConfigurationList]): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
