...
object priorityLevelConfigurationListMod {
  ...
  object PriorityLevelConfigurationList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/flowcontrol/v1alpha1/priorityLevelConfigurationList", "PriorityLevelConfigurationList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/flowcontrol/v1alpha1/priorityLevelConfigurationList", "PriorityLevelConfigurationList.isInstance")
    @js.native
