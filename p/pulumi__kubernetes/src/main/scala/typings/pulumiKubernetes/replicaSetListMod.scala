...
object replicaSetListMod {
  ...
  object ReplicaSetList {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/replicaSetList", "ReplicaSetList.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/apps/v1beta2/replicaSetList", "ReplicaSetList.isInstance")
    @js.native
  ...
  trait ReplicaSetListArgs extends StObject {
    ...
    /**
      * List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller
      */
    val items: Input[js.Array[Input[typings.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSet]]] = js.native
    
    /**
      * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
      */
    val kind: js.UndefOr[Input[typings.pulumiKubernetes.pulumiKubernetesStrings.ReplicaSetList]] = js.native
