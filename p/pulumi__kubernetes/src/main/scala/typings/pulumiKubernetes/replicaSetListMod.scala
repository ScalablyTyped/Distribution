...
@JSImport("@pulumi/kubernetes/apps/v1beta2/ReplicaSetList", JSImport.Namespace)
@js.native
object replicaSetListMod extends js.Object {
  @js.native
  class ReplicaSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetList) = this()
    def this(
      name: String,
      args: typings.pulumiKubernetes.inputMod.apps.v1beta2.ReplicaSetList,
