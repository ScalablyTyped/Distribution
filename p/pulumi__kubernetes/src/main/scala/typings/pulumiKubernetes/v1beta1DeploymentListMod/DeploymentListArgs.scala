...
import typings.pulumiKubernetes.inputMod.extensions.v1beta1.Deployment
...
object DeploymentListArgs {
  ...
  implicit class DeploymentListArgsOps[Self <: DeploymentListArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: Input[typings.pulumiKubernetes.pulumiKubernetesStrings.DeploymentList]): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
