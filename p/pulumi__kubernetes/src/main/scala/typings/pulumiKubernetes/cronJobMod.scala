...
object cronJobMod {
  ...
  object CronJob {
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v1beta1/cronJob", "CronJob.get")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("@pulumi/kubernetes/batch/v1beta1/cronJob", "CronJob.isInstance")
    @js.native
  ...
  trait CronJobArgs extends StObject {
    ...
    /**
      * Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
      */
    val spec: js.UndefOr[Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJobSpec]] = js.native
  }
  object CronJobArgs {
    ...
    implicit class CronJobArgsMutableBuilder[Self <: CronJobArgs] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpec(value: Input[typings.pulumiKubernetes.inputMod.batch.v1beta1.CronJobSpec]): Self = StObject.set(x, "spec", value.asInstanceOf[js.Any])
