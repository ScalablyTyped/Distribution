package typings.atPulumiKubernetes.schedulingV1alpha1PriorityClassListMod
...
import typings.atPulumiKubernetes.typesOutputMod.schedulingNs.v1alpha1Ns.PriorityClass
