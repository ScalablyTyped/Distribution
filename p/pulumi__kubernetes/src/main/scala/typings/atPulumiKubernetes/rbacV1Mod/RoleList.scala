package typings.atPulumiKubernetes.rbacV1Mod
...
class RoleList protected ()
  extends typings.atPulumiKubernetes.rbacV1RoleListMod.RoleList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.RoleList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.RoleList,
...
object RoleList extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1RoleListMod.RoleList = js.native
  /**
