...
class Role protected ()
  extends typings.atPulumiKubernetes.rbacV1RoleMod.Role {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.Role) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.Role,
...
object Role extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1RoleMod.Role = js.native
  /**
