...
class ClusterRoleBinding protected ()
  extends typings.atPulumiKubernetes.rbacV1ClusterRoleBindingMod.ClusterRoleBinding {
  /**
...
object ClusterRoleBinding extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1ClusterRoleBindingMod.ClusterRoleBinding = js.native
  /**
