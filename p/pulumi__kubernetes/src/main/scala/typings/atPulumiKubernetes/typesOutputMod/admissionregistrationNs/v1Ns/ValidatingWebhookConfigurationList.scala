package typings.atPulumiKubernetes.typesOutputMod.admissionregistrationNs.v1Ns
...
trait ValidatingWebhookConfigurationList extends js.Object {
  /**
    ...
    */
  val apiVersion: `admissionregistrationDOTk8sDOTio/v1`
  /**
...
object ValidatingWebhookConfigurationList {
  @scala.inline
  def apply(
    apiVersion: `admissionregistrationDOTk8sDOTio/v1`,
