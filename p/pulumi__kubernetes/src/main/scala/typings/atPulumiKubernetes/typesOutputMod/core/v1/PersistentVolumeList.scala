...
trait PersistentVolumeList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolumeList
  /**
...
object PersistentVolumeList {
  ...
  def apply(
    ...
    kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolumeList,
    metadata: ListMeta
