...
trait PodTemplateList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PodTemplateList
  /**
...
object PodTemplateList {
  ...
  def apply(
    ...
    kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PodTemplateList,
    metadata: ListMeta
  ): PodTemplateList = {
