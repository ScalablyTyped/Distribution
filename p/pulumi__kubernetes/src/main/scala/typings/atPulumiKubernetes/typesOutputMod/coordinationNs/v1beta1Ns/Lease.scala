package typings.atPulumiKubernetes.typesOutputMod.coordinationNs.v1beta1Ns
...
trait Lease extends js.Object {
  /**
    ...
    */
  val apiVersion: `coordinationDOTk8sDOTio/v1beta1`
  /**
...
object Lease {
  @scala.inline
  def apply(
    apiVersion: `coordinationDOTk8sDOTio/v1beta1`,
