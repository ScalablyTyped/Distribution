...
trait PersistentVolumeClaimList extends js.Object {
  ...
  /**
    ...
    */
  val kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolumeClaimList
  /**
...
object PersistentVolumeClaimList {
  ...
  def apply(
    ...
    kind: typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolumeClaimList,
    metadata: ListMeta
