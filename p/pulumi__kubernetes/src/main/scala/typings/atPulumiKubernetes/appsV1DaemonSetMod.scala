...
import typings.atPulumiKubernetes.appsV1DaemonSetMod.DaemonSet
...
@JSImport("@pulumi/kubernetes/apps/v1/DaemonSet", JSImport.Namespace)
@js.native
object appsV1DaemonSetMod extends js.Object {
  @js.native
