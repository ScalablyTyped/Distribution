package typings.atPulumiKubernetes.networkingV1beta1IngressListMod
...
import typings.atPulumiKubernetes.typesOutputMod.networkingNs.v1beta1Ns.Ingress
...
class IngressList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val items: Output[js.Array[Ingress]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.IngressList] = js.native
  /**
