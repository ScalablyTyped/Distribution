...
@JSImport("@pulumi/kubernetes/rbac/v1alpha1", JSImport.Namespace)
@js.native
object rbacV1alpha1Mod extends js.Object {
  @js.native
  class ClusterRole protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleMod.ClusterRole {
    /**
  ...
  class ClusterRoleBinding protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleBindingMod.ClusterRoleBinding {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBinding) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBinding,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class ClusterRoleBindingList protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleBindingListMod.ClusterRoleBindingList {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBindingList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleBindingList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class ClusterRoleList protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleListMod.ClusterRoleList {
    /**
  ...
  class Role protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1RoleMod.Role {
    /**
  ...
  class RoleBinding protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1RoleBindingMod.RoleBinding {
    /**
  ...
  class RoleBindingList protected ()
    ...
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleBindingList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleBindingList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class RoleList protected ()
    extends typings.atPulumiKubernetes.rbacV1alpha1RoleListMod.RoleList {
    /**
