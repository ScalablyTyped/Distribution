...
class ComponentStatusList protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.ComponentStatusList {
  /**
...
object ComponentStatusList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1ComponentStatusListMod.ComponentStatusList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1ComponentStatusListMod.ComponentStatusList = js.native
  /**
