...
class ConfigMap protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.ConfigMap {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.ConfigMap) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.ConfigMap,
