...
class Event protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.Event {
  /**
...
object Event extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1EventMod.Event = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1EventMod.Event = js.native
  /**
