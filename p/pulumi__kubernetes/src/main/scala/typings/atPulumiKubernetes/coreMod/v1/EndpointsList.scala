...
class EndpointsList protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.EndpointsList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.EndpointsList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.EndpointsList,
...
object EndpointsList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1EndpointsListMod.EndpointsList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1EndpointsListMod.EndpointsList = js.native
  /**
