...
class PodTemplate protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.PodTemplate {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.PodTemplate) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.PodTemplate,
...
object PodTemplate extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1PodTemplateMod.PodTemplate = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1PodTemplateMod.PodTemplate = js.native
  /**
