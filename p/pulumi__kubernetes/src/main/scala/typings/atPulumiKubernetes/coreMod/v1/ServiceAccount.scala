...
class ServiceAccount protected ()
  extends typings.atPulumiKubernetes.coreV1Mod.ServiceAccount {
  /**
...
object ServiceAccount extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1ServiceAccountMod.ServiceAccount = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1ServiceAccountMod.ServiceAccount = js.native
  /**
