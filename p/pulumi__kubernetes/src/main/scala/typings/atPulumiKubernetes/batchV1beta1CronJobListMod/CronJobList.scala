package typings.atPulumiKubernetes.batchV1beta1CronJobListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`batch/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.batchNs.v1beta1Ns.CronJob
...
@JSImport("@pulumi/kubernetes/batch/v1beta1/CronJobList", "CronJobList")
@js.native
class CronJobList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val apiVersion: Output[`batch/v1beta1`] = js.native
  /**
