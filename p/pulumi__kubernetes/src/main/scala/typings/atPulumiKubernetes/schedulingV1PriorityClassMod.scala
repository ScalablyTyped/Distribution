...
import typings.atPulumiKubernetes.schedulingV1PriorityClassMod.PriorityClass
...
@JSImport("@pulumi/kubernetes/scheduling/v1/PriorityClass", JSImport.Namespace)
@js.native
object schedulingV1PriorityClassMod extends js.Object {
  @js.native
  class PriorityClass protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClass] = js.native
    /**
