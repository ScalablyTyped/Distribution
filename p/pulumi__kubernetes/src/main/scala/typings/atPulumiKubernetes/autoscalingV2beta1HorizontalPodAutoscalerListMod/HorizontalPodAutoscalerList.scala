package typings.atPulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`autoscaling/v2beta1`
import typings.atPulumiKubernetes.typesOutputMod.autoscalingNs.v2beta1Ns.HorizontalPodAutoscaler
