package typings.atPulumiKubernetes.authorizationV1beta1Mod
...
class SubjectAccessReview protected ()
  extends typings.atPulumiKubernetes.authorizationV1beta1SubjectAccessReviewMod.SubjectAccessReview {
  /**
