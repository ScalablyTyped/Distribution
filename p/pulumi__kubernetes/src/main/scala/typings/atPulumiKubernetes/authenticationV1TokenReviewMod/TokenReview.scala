package typings.atPulumiKubernetes.authenticationV1TokenReviewMod
...
class TokenReview protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.authenticationNs.v1Ns.TokenReview) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.authenticationNs.v1Ns.TokenReview,
