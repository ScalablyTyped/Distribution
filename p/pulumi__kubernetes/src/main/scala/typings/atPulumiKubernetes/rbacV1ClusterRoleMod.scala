...
@JSImport("@pulumi/kubernetes/rbac/v1/ClusterRole", JSImport.Namespace)
@js.native
object rbacV1ClusterRoleMod extends js.Object {
  @js.native
  class ClusterRole protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.ClusterRole) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.ClusterRole,
