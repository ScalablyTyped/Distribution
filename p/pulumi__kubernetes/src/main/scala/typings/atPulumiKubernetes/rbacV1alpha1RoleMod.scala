...
import typings.atPulumiKubernetes.rbacV1alpha1RoleMod.Role
...
@js.native
object rbacV1alpha1RoleMod extends js.Object {
  @js.native
  class Role protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.Role) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.Role,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.Role] = js.native
    /**
