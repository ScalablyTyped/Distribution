...
import typings.atPulumiKubernetes.coreV1ServiceListMod.ServiceList
...
@js.native
object coreV1ServiceListMod extends js.Object {
  @js.native
  class ServiceList protected () extends CustomResource {
    ...
    /**
      * List of services
      */
    val items: Output[js.Array[Service]] = js.native
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.ServiceList] = js.native
    /**
