...
object settingsV1alpha1Mod extends js.Object {
  ...
  class PodPreset protected ()
    extends typings.atPulumiKubernetes.settingsV1alpha1PodPresetMod.PodPreset {
    /**
  ...
  class PodPresetList protected ()
    extends typings.atPulumiKubernetes.settingsV1alpha1PodPresetListMod.PodPresetList {
    /**
