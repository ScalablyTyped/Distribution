...
@JSImport("@pulumi/kubernetes/node/v1alpha1/RuntimeClassList", JSImport.Namespace)
@js.native
object nodeV1alpha1RuntimeClassListMod extends js.Object {
  @js.native
  class RuntimeClassList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.node.v1alpha1.RuntimeClassList,
