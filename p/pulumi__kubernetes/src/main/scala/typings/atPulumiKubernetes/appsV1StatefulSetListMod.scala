...
import typings.atPulumiKubernetes.appsV1StatefulSetListMod.StatefulSetList
...
@JSImport("@pulumi/kubernetes/apps/v1/StatefulSetList", JSImport.Namespace)
@js.native
object appsV1StatefulSetListMod extends js.Object {
  @js.native
  class StatefulSetList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.StatefulSetList] = js.native
