package typings.atPulumiKubernetes.coreV1LimitRangeMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.LimitRangeSpec
...
class LimitRange protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.LimitRange] = js.native
  /**
