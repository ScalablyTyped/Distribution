...
class Ingress protected ()
  extends typings.atPulumiKubernetes.extensionsV1beta1IngressMod.Ingress {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.Ingress,
...
object Ingress extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1IngressMod.Ingress = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1IngressMod.Ingress = js.native
  /**
