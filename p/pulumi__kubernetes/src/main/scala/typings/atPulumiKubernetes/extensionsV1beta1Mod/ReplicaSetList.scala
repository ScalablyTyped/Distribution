...
class ReplicaSetList protected ()
  extends typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.ReplicaSetList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.ReplicaSetList,
...
object ReplicaSetList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList = js.native
  /**
