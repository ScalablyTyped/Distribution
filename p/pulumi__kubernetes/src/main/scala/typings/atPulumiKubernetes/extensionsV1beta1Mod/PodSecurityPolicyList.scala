...
class PodSecurityPolicyList protected ()
  extends typings.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList {
  /**
...
object PodSecurityPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList = js.native
  /**
