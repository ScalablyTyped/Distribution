...
object authorizationMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class LocalSubjectAccessReview protected ()
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.LocalSubjectAccessReview
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.LocalSubjectAccessReview,
    ...
    class SubjectAccessReview protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SubjectAccessReview) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SubjectAccessReview,
        opts: CustomResourceOptions
      ) = this()
    }
  ...
  object v1beta1 extends js.Object {
    @js.native
    class LocalSubjectAccessReview protected ()
      extends typings.atPulumiKubernetes.authorizationV1beta1Mod.LocalSubjectAccessReview {
      /**
    ...
    @js.native
    class SelfSubjectAccessReview protected ()
      extends typings.atPulumiKubernetes.authorizationV1beta1Mod.SelfSubjectAccessReview {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SelfSubjectAccessReview
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SelfSubjectAccessReview,
    ...
    @js.native
    class SelfSubjectRulesReview protected ()
      extends typings.atPulumiKubernetes.authorizationV1beta1Mod.SelfSubjectRulesReview {
      /**
    ...
    @js.native
    class SubjectAccessReview protected ()
      extends typings.atPulumiKubernetes.authorizationV1beta1Mod.SubjectAccessReview {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SubjectAccessReview
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SubjectAccessReview,
