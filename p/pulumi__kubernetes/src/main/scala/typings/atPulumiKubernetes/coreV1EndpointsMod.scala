...
import typings.atPulumiKubernetes.coreV1EndpointsMod.Endpoints
...
object coreV1EndpointsMod extends js.Object {
  ...
  class Endpoints protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.Endpoints) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.core.v1.Endpoints,
