package typings.atPulumiKubernetes.autoscalingV1HorizontalPodAutoscalerListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`autoscaling/v1`
import typings.atPulumiKubernetes.typesOutputMod.autoscalingNs.v1Ns.HorizontalPodAutoscaler
...
class HorizontalPodAutoscalerList protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v1Ns.HorizontalPodAutoscalerList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v1Ns.HorizontalPodAutoscalerList,
