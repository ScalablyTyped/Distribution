...
import typings.atPulumiKubernetes.appsV1beta1StatefulSetListMod.StatefulSetList
import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta1.StatefulSet
