package typings.atPulumiKubernetes.coreV1PodTemplateMod
...
class PodTemplate protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PodTemplate] = js.native
  /**
  ...
  /**
    ...
    */
  val template: Output[PodTemplateSpec] = js.native
}
