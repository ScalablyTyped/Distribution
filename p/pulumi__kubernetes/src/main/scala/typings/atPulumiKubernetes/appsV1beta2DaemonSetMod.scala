...
import typings.atPulumiKubernetes.appsV1beta2DaemonSetMod.DaemonSet
import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DaemonSetSpec
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DaemonSetStatus
