...
import typings.atPulumiKubernetes.flowcontrolV1alpha1PriorityLevelConfigurationListMod.PriorityLevelConfigurationList
...
@js.native
object flowcontrolV1alpha1PriorityLevelConfigurationListMod extends js.Object {
  @js.native
  class PriorityLevelConfigurationList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val items: Output[js.Array[PriorityLevelConfiguration]] = js.native
    /**
