...
import typings.atPulumiKubernetes.appsV1beta2ControllerRevisionListMod.ControllerRevisionList
import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta2.ControllerRevision
...
object appsV1beta2ControllerRevisionListMod extends js.Object {
  ...
  class ControllerRevisionList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.apps.v1beta2.ControllerRevisionList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.apps.v1beta2.ControllerRevisionList,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.ControllerRevisionList] = js.native
    /**
      * More info:
