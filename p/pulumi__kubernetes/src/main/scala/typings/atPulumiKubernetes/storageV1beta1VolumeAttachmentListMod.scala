...
import typings.atPulumiKubernetes.storageV1beta1VolumeAttachmentListMod.VolumeAttachmentList
import typings.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typings.atPulumiKubernetes.typesOutputMod.storage.v1beta1.VolumeAttachment
...
@JSImport("@pulumi/kubernetes/storage/v1beta1/VolumeAttachmentList", JSImport.Namespace)
@js.native
object storageV1beta1VolumeAttachmentListMod extends js.Object {
  @js.native
  class VolumeAttachmentList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.storage.v1beta1.VolumeAttachmentList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.storage.v1beta1.VolumeAttachmentList,
