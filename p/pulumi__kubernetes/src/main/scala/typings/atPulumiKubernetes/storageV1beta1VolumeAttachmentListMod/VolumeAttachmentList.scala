package typings.atPulumiKubernetes.storageV1beta1VolumeAttachmentListMod
...
import typings.atPulumiKubernetes.typesOutputMod.storageNs.v1beta1Ns.VolumeAttachment
