...
import typings.atPulumiKubernetes.coordinationV1beta1LeaseListMod.LeaseList
import typings.atPulumiKubernetes.typesOutputMod.coordination.v1beta1.Lease
...
object coordinationV1beta1LeaseListMod extends js.Object {
  ...
  class LeaseList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coordination.v1beta1.LeaseList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.coordination.v1beta1.LeaseList,
