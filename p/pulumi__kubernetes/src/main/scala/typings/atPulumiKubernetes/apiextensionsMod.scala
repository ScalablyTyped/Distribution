...
object apiextensionsMod extends js.Object {
  ...
  object v1 extends js.Object {
    ...
    class CustomResourceDefinition protected ()
      extends typings.atPulumiKubernetes.apiextensionsV1Mod.CustomResourceDefinition {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiextensions.v1.CustomResourceDefinition
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiextensions.v1.CustomResourceDefinition,
    ...
    class CustomResourceDefinitionList protected ()
      extends typings.atPulumiKubernetes.apiextensionsV1Mod.CustomResourceDefinitionList {
      /**
    ...
    object CustomResourceDefinition extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
      /**
    ...
    object CustomResourceDefinitionList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionListMod.CustomResourceDefinitionList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionListMod.CustomResourceDefinitionList = js.native
      /**
  ...
  object v1beta1 extends js.Object {
    @js.native
    class CustomResourceDefinition protected ()
      extends typings.atPulumiKubernetes.apiextensionsV1beta1Mod.CustomResourceDefinition {
      /**
    ...
    @js.native
    class CustomResourceDefinitionList protected ()
      extends typings.atPulumiKubernetes.apiextensionsV1beta1Mod.CustomResourceDefinitionList {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinitionList
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiextensions.v1beta1.CustomResourceDefinitionList,
    ...
    object CustomResourceDefinition extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition = js.native
      /**
        * Returns true if the given object is an instance of CustomResourceDefinition.  This is designed to work even
        * when multiple copies of the Pulumi SDK have been loaded into the same process.
        */
