...
import typings.atPulumiKubernetes.settingsV1alpha1PodPresetMod.PodPreset
...
@js.native
object settingsV1alpha1PodPresetMod extends js.Object {
  @js.native
  class PodPreset protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.settings.v1alpha1.PodPreset,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PodPreset] = js.native
    val metadata: Output[ObjectMeta] = js.native
    val spec: Output[PodPresetSpec] = js.native
  }
