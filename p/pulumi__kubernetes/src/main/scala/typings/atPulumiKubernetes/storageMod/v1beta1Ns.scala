...
@JSImport("@pulumi/kubernetes/storage", "v1beta1")
@js.native
object v1beta1Ns extends js.Object {
  @js.native
  class CSIDriver protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.CSIDriver {
    /**
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.CSIDriver) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.CSIDriver,
  ...
  class CSIDriverList protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.CSIDriverList {
    /**
  ...
  class CSINode protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.CSINode {
    /**
  ...
  class CSINodeList protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.CSINodeList {
    /**
  ...
  class StorageClass protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.StorageClass {
    /**
  ...
  class StorageClassList protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.StorageClassList {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.StorageClassList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.StorageClassList,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  class VolumeAttachment protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typings.atPulumiKubernetes.storageV1beta1Mod.VolumeAttachmentList {
    /**
    ...
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeAttachmentList
    ) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeAttachmentList,
  ...
  object CSIDriver extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1CSIDriverMod.CSIDriver = js.native
    /**
  ...
  object CSINode extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1CSINodeMod.CSINode = js.native
    /**
  ...
  object CSINodeList extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1CSINodeListMod.CSINodeList = js.native
    /**
  ...
  object StorageClass extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1StorageClassMod.StorageClass = js.native
    /**
  ...
  object StorageClassList extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1StorageClassListMod.StorageClassList = js.native
    /**
  ...
  object VolumeAttachmentList extends js.Object {
    ...
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1beta1VolumeAttachmentListMod.VolumeAttachmentList = js.native
    /**
