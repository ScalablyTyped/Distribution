package typings.atPulumiKubernetes.extensionsV1beta1DeploymentListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`extensions/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.extensionsNs.v1beta1Ns.Deployment
...
class DeploymentList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.DeploymentList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.DeploymentList,
