...
@JSImport("@pulumi/kubernetes/scheduling", "v1alpha1")
@js.native
object v1alpha1Ns extends js.Object {
  @js.native
  class PriorityClass protected ()
    extends typings.atPulumiKubernetes.schedulingV1alpha1Mod.PriorityClass {
    /**
  ...
  class PriorityClassList protected ()
    extends typings.atPulumiKubernetes.schedulingV1alpha1Mod.PriorityClassList {
    /**
