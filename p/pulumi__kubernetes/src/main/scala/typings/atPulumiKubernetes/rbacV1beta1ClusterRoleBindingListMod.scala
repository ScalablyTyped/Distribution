...
import typings.atPulumiKubernetes.rbacV1beta1ClusterRoleBindingListMod.ClusterRoleBindingList
import typings.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typings.atPulumiKubernetes.typesOutputMod.rbac.v1beta1.ClusterRoleBinding
...
@JSImport("@pulumi/kubernetes/rbac/v1beta1/ClusterRoleBindingList", JSImport.Namespace)
@js.native
object rbacV1beta1ClusterRoleBindingListMod extends js.Object {
  @js.native
  class ClusterRoleBindingList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1beta1.ClusterRoleBindingList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1beta1.ClusterRoleBindingList,
    ...
    /**
      ...
      */
    val items: Output[js.Array[ClusterRoleBinding]] = js.native
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.ClusterRoleBindingList] = js.native
    /**
