...
class NodeList protected ()
  extends typings.atPulumiKubernetes.coreV1NodeListMod.NodeList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.NodeList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.NodeList,
...
object NodeList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1NodeListMod.NodeList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1NodeListMod.NodeList = js.native
  /**
