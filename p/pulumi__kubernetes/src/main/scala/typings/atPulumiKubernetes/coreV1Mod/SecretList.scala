...
class SecretList protected ()
  extends typings.atPulumiKubernetes.coreV1SecretListMod.SecretList {
  /**
...
object SecretList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1SecretListMod.SecretList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1SecretListMod.SecretList = js.native
  /**
