...
class ComponentStatus protected ()
  extends typings.atPulumiKubernetes.coreV1ComponentStatusMod.ComponentStatus {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ComponentStatus) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ComponentStatus,
...
object ComponentStatus extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1ComponentStatusMod.ComponentStatus = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1ComponentStatusMod.ComponentStatus = js.native
  /**
