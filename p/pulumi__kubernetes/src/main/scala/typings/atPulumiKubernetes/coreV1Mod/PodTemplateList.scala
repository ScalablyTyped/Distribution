...
class PodTemplateList protected ()
  extends typings.atPulumiKubernetes.coreV1PodTemplateListMod.PodTemplateList {
  /**
...
object PodTemplateList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1PodTemplateListMod.PodTemplateList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1PodTemplateListMod.PodTemplateList = js.native
  /**
