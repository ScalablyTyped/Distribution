...
class LimitRange protected ()
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.LimitRange) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.LimitRange,
