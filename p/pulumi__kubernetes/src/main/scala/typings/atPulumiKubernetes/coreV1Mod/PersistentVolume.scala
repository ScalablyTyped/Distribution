...
class PersistentVolume protected ()
  extends typings.atPulumiKubernetes.coreV1PersistentVolumeMod.PersistentVolume {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.PersistentVolume) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.PersistentVolume,
...
object PersistentVolume extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1PersistentVolumeMod.PersistentVolume = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1PersistentVolumeMod.PersistentVolume = js.native
  /**
