...
class ReplicationController protected ()
  extends typings.atPulumiKubernetes.coreV1ReplicationControllerMod.ReplicationController {
  /**
...
object ReplicationController extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1ReplicationControllerMod.ReplicationController = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1ReplicationControllerMod.ReplicationController = js.native
  /**
