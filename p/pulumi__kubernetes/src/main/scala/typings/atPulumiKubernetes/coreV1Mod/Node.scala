...
class Node protected ()
  extends typings.atPulumiKubernetes.coreV1NodeMod.Node {
  /**
...
object Node extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1NodeMod.Node = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1NodeMod.Node = js.native
  /**
