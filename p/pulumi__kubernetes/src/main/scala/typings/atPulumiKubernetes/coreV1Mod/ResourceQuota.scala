...
class ResourceQuota protected ()
  extends typings.atPulumiKubernetes.coreV1ResourceQuotaMod.ResourceQuota {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ResourceQuota) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ResourceQuota,
...
object ResourceQuota extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1ResourceQuotaMod.ResourceQuota = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1ResourceQuotaMod.ResourceQuota = js.native
  /**
