package typings.atPulumiKubernetes.rbacV1beta1ClusterRoleMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.AggregationRule
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.PolicyRule
...
class ClusterRole protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.ClusterRole) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.ClusterRole,
