...
class StatefulSet protected ()
  extends typings.atPulumiKubernetes.appsV1beta2StatefulSetMod.StatefulSet {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta2Ns.StatefulSet) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta2Ns.StatefulSet,
...
object StatefulSet extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.appsV1beta2StatefulSetMod.StatefulSet = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.appsV1beta2StatefulSetMod.StatefulSet = js.native
  /**
