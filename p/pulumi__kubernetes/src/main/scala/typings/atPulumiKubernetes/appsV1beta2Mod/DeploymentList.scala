...
class DeploymentList protected ()
  extends typings.atPulumiKubernetes.appsV1beta2DeploymentListMod.DeploymentList {
  /**
...
object DeploymentList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.appsV1beta2DeploymentListMod.DeploymentList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.appsV1beta2DeploymentListMod.DeploymentList = js.native
  /**
