...
class ReplicaSet protected ()
  extends typings.atPulumiKubernetes.appsV1beta2ReplicaSetMod.ReplicaSet {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta2Ns.ReplicaSet) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta2Ns.ReplicaSet,
