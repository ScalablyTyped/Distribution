...
class Deployment protected ()
  extends typings.atPulumiKubernetes.appsV1beta2DeploymentMod.Deployment {
  /**
...
object Deployment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.appsV1beta2DeploymentMod.Deployment = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.appsV1beta2DeploymentMod.Deployment = js.native
  /**
