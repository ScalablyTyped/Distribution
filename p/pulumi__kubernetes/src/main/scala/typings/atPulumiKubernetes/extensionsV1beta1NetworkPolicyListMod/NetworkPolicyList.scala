package typings.atPulumiKubernetes.extensionsV1beta1NetworkPolicyListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`extensions/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.extensionsNs.v1beta1Ns.NetworkPolicy
...
class NetworkPolicyList protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.NetworkPolicyList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.NetworkPolicyList,
