package typings.atPulumiKubernetes.authorizationV1beta1SelfSubjectAccessReviewMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`authorizationDOTk8sDOTio/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.authorizationNs.v1beta1Ns.SelfSubjectAccessReviewSpec
