package typings.atPulumiKubernetes.policyV1beta1PodSecurityPolicyMod
...
import typings.atPulumiKubernetes.typesOutputMod.policyNs.v1beta1Ns.PodSecurityPolicySpec
