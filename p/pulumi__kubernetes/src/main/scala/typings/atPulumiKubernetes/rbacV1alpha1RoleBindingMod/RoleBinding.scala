package typings.atPulumiKubernetes.rbacV1alpha1RoleBindingMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1alpha1Ns.RoleRef
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1alpha1Ns.Subject
...
class RoleBinding protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1alpha1Ns.RoleBinding) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1alpha1Ns.RoleBinding,
