package typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod
...
class CustomResourceDefinition protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.apiextensionsNs.v1Ns.CustomResourceDefinition
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.apiextensionsNs.v1Ns.CustomResourceDefinition,
