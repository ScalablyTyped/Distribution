...
class CustomResourceDefinition protected ()
  extends typings.atPulumiKubernetes.apiextensionsV1beta1CustomResourceDefinitionMod.CustomResourceDefinition {
  /**
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.apiextensionsNs.v1beta1Ns.CustomResourceDefinition
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.apiextensionsNs.v1beta1Ns.CustomResourceDefinition,
