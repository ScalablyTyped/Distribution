...
@JSImport("@pulumi/kubernetes/authorization/v1/SelfSubjectRulesReview", JSImport.Namespace)
@js.native
object authorizationV1SelfSubjectRulesReviewMod extends js.Object {
  @js.native
  class SelfSubjectRulesReview protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SelfSubjectRulesReview
    ) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SelfSubjectRulesReview,
