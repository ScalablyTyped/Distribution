package typings.atPulumiKubernetes.coreV1NamespaceListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.Namespace
...
class NamespaceList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.NamespaceList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.NamespaceList,
  ...
  /**
    ...
    */
  val items: Output[js.Array[Namespace]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.NamespaceList] = js.native
  /**
