  ...
  object v1alpha1 extends js.Object {
    ...
    class EndpointSliceList protected ()
      ...
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.discovery.v1alpha1.EndpointSliceList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.discovery.v1alpha1.EndpointSliceList,
        opts: CustomResourceOptions
      ) = this()
    }
