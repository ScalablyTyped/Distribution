package typings.atPulumiKubernetes.appsV1beta1StatefulSetMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta1Ns.StatefulSetSpec
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta1Ns.StatefulSetStatus
...
class StatefulSet protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.StatefulSet) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.StatefulSet,
