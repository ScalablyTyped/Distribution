package typings.atPulumiKubernetes.coordinationMod
...
@JSImport("@pulumi/kubernetes/coordination", "v1")
@js.native
object v1Ns extends js.Object {
  @js.native
  class Lease protected ()
    extends typings.atPulumiKubernetes.coordinationV1Mod.Lease {
    /**
  ...
  class LeaseList protected ()
    extends typings.atPulumiKubernetes.coordinationV1Mod.LeaseList {
    /**
