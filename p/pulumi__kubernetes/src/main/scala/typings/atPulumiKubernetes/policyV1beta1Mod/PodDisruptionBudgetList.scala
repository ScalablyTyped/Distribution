package typings.atPulumiKubernetes.policyV1beta1Mod
...
class PodDisruptionBudgetList protected ()
  extends typings.atPulumiKubernetes.policyV1beta1PodDisruptionBudgetListMod.PodDisruptionBudgetList {
  /**
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodDisruptionBudgetList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodDisruptionBudgetList,
