package typings.atPulumiKubernetes.eventsMod
...
object v1beta1Ns extends js.Object {
  ...
  class Event protected ()
    extends typings.atPulumiKubernetes.eventsV1beta1Mod.Event {
    /**
  ...
  class EventList protected ()
    extends typings.atPulumiKubernetes.eventsV1beta1Mod.EventList {
    /**
