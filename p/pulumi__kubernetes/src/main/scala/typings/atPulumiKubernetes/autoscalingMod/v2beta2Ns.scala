...
object v2beta2Ns extends js.Object {
  ...
  class HorizontalPodAutoscaler protected ()
    extends typings.atPulumiKubernetes.autoscalingV2beta2Mod.HorizontalPodAutoscaler {
    /**
    ...
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v2beta2Ns.HorizontalPodAutoscaler
    ) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v2beta2Ns.HorizontalPodAutoscaler,
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typings.atPulumiKubernetes.autoscalingV2beta2Mod.HorizontalPodAutoscalerList {
    /**
