...
import typings.atPulumiKubernetes.rbacV1ClusterRoleBindingListMod.ClusterRoleBindingList
...
@js.native
object rbacV1ClusterRoleBindingListMod extends js.Object {
  @js.native
  class ClusterRoleBindingList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.ClusterRoleBindingList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.ClusterRoleBindingList,
