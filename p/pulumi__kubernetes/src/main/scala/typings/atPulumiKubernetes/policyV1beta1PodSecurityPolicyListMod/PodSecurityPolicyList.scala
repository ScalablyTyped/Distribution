package typings.atPulumiKubernetes.policyV1beta1PodSecurityPolicyListMod
...
import typings.atPulumiKubernetes.typesOutputMod.policyNs.v1beta1Ns.PodSecurityPolicy
