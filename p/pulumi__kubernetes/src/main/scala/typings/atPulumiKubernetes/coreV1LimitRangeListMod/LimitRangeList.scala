package typings.atPulumiKubernetes.coreV1LimitRangeListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.LimitRange
...
class LimitRangeList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.LimitRangeList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.LimitRangeList,
  ...
  /**
    ...
    */
  val items: Output[js.Array[LimitRange]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.LimitRangeList] = js.native
  /**
