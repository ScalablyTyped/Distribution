package typings.atPulumiKubernetes.coordinationV1LeaseListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`coordinationDOTk8sDOTio/v1`
import typings.atPulumiKubernetes.typesOutputMod.coordinationNs.v1Ns.Lease
...
class LeaseList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.LeaseList] = js.native
  /**
