package typings.atPulumiKubernetes.apiregistrationMod
...
object v1Ns extends js.Object {
  ...
  class APIService protected ()
    extends typings.atPulumiKubernetes.apiregistrationV1Mod.APIService {
    /**
  ...
  class APIServiceList protected ()
    extends typings.atPulumiKubernetes.apiregistrationV1Mod.APIServiceList {
    /**
