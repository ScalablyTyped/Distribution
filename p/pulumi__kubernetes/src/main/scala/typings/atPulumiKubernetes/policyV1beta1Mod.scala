...
object policyV1beta1Mod extends js.Object {
  ...
  class PodSecurityPolicy protected ()
    extends typings.atPulumiKubernetes.policyV1beta1PodSecurityPolicyMod.PodSecurityPolicy {
    /**
  ...
  class PodSecurityPolicyList protected ()
    extends typings.atPulumiKubernetes.policyV1beta1PodSecurityPolicyListMod.PodSecurityPolicyList {
    /**
