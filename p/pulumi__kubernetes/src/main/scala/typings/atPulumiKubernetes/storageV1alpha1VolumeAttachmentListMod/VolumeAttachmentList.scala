package typings.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod
...
import typings.atPulumiKubernetes.typesOutputMod.storageNs.v1alpha1Ns.VolumeAttachment
...
class VolumeAttachmentList protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeAttachmentList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeAttachmentList,
