...
import typings.atPulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList
import typings.atPulumiKubernetes.typesOutputMod.autoscaling.v2beta1.HorizontalPodAutoscaler
