package typings.atPulumiKubernetes.coreV1PersistentVolumeClaimListMod
...
class PersistentVolumeClaimList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolumeClaimList] = js.native
  /**
