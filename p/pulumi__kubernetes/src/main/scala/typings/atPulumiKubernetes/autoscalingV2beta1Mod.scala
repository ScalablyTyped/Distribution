...
@js.native
object autoscalingV2beta1Mod extends js.Object {
  @js.native
  class HorizontalPodAutoscaler protected ()
    extends typings.atPulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerMod.HorizontalPodAutoscaler {
    /**
  ...
  class HorizontalPodAutoscalerList protected ()
    extends typings.atPulumiKubernetes.autoscalingV2beta1HorizontalPodAutoscalerListMod.HorizontalPodAutoscalerList {
    /**
