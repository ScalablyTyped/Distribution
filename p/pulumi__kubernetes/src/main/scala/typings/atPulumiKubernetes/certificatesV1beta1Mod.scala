...
object certificatesV1beta1Mod extends js.Object {
  ...
  class CertificateSigningRequest protected ()
    extends typings.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestMod.CertificateSigningRequest {
    /**
  ...
  class CertificateSigningRequestList protected ()
    extends typings.atPulumiKubernetes.certificatesV1beta1CertificateSigningRequestListMod.CertificateSigningRequestList {
    /**
