package typings.atPulumiKubernetes.autoscalingV1HorizontalPodAutoscalerMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`autoscaling/v1`
import typings.atPulumiKubernetes.typesOutputMod.autoscalingNs.v1Ns.HorizontalPodAutoscalerSpec
import typings.atPulumiKubernetes.typesOutputMod.autoscalingNs.v1Ns.HorizontalPodAutoscalerStatus
...
class HorizontalPodAutoscaler protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v1Ns.HorizontalPodAutoscaler
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.autoscalingNs.v1Ns.HorizontalPodAutoscaler,
