...
import typings.atPulumiKubernetes.coreV1NamespaceListMod.NamespaceList
...
@js.native
object coreV1NamespaceListMod extends js.Object {
  @js.native
  class NamespaceList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.NamespaceList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.core.v1.NamespaceList,
