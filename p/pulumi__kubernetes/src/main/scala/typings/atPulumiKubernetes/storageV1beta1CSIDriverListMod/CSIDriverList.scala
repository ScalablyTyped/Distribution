package typings.atPulumiKubernetes.storageV1beta1CSIDriverListMod
...
import typings.atPulumiKubernetes.typesOutputMod.storageNs.v1beta1Ns.CSIDriver
...
class CSIDriverList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val items: Output[js.Array[CSIDriver]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.CSIDriverList] = js.native
  /**
