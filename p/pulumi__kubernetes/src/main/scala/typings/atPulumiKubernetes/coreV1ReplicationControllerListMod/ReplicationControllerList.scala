package typings.atPulumiKubernetes.coreV1ReplicationControllerListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.ReplicationController
...
@JSImport("@pulumi/kubernetes/core/v1/ReplicationControllerList", "ReplicationControllerList")
@js.native
class ReplicationControllerList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ReplicationControllerList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.ReplicationControllerList,
