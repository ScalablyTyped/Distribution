...
object v1beta1 extends js.Object {
  ...
  class ControllerRevision protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.ControllerRevision {
    /**
  ...
  class ControllerRevisionList protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.ControllerRevisionList {
    /**
  ...
  class Deployment protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.Deployment {
    /**
  ...
  class DeploymentList protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.DeploymentList {
    /**
  ...
  class StatefulSet protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.StatefulSet {
    /**
  ...
  class StatefulSetList protected ()
    extends typings.atPulumiKubernetes.appsV1beta1Mod.StatefulSetList {
    /**
