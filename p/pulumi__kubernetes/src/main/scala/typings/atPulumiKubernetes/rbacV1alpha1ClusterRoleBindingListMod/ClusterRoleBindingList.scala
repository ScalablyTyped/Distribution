package typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleBindingListMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1alpha1Ns.ClusterRoleBinding
