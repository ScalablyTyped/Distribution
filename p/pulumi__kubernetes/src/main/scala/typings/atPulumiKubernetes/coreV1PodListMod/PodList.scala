package typings.atPulumiKubernetes.coreV1PodListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.Pod
...
class PodList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val items: Output[js.Array[Pod]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PodList] = js.native
  /**
