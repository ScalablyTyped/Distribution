...
object apiextensionsV1Mod extends js.Object {
  ...
  class CustomResourceDefinition protected ()
    extends typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionMod.CustomResourceDefinition {
    /**
  ...
  class CustomResourceDefinitionList protected ()
    extends typings.atPulumiKubernetes.apiextensionsV1CustomResourceDefinitionListMod.CustomResourceDefinitionList {
    /**
