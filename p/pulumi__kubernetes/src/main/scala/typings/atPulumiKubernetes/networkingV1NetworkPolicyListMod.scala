...
@JSImport("@pulumi/kubernetes/networking/v1/NetworkPolicyList", JSImport.Namespace)
@js.native
object networkingV1NetworkPolicyListMod extends js.Object {
  @js.native
  class NetworkPolicyList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.networking.v1.NetworkPolicyList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.networking.v1.NetworkPolicyList,
    ...
    /**
      ...
      */
    val items: Output[js.Array[NetworkPolicy]] = js.native
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.NetworkPolicyList] = js.native
    /**
