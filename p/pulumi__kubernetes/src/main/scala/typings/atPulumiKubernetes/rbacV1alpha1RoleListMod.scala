...
import typings.atPulumiKubernetes.rbacV1alpha1RoleListMod.RoleList
import typings.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typings.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.Role
...
@js.native
object rbacV1alpha1RoleListMod extends js.Object {
  @js.native
  class RoleList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.RoleList,
