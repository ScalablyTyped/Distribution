...
import typings.atPulumiKubernetes.admissionregistrationV1beta1MutatingWebhookConfigurationMod.MutatingWebhookConfiguration
import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`admissionregistrationDOTk8sDOTio/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.admissionregistration.v1beta1.MutatingWebhook
