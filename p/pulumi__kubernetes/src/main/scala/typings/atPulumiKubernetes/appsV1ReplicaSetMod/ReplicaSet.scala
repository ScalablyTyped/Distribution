package typings.atPulumiKubernetes.appsV1ReplicaSetMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1Ns.ReplicaSetSpec
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1Ns.ReplicaSetStatus
...
class ReplicaSet protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ReplicaSet) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ReplicaSet,
