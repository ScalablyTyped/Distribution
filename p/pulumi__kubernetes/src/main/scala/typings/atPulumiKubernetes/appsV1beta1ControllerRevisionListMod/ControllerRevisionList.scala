package typings.atPulumiKubernetes.appsV1beta1ControllerRevisionListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta1Ns.ControllerRevision
...
@JSImport("@pulumi/kubernetes/apps/v1beta1/ControllerRevisionList", "ControllerRevisionList")
@js.native
class ControllerRevisionList protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.ControllerRevisionList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.ControllerRevisionList,
