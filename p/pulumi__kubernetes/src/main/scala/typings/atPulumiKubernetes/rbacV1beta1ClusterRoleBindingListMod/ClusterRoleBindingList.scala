package typings.atPulumiKubernetes.rbacV1beta1ClusterRoleBindingListMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.ClusterRoleBinding
