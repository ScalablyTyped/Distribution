package typings.atPulumiKubernetes.appsV1beta1StatefulSetListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta1Ns.StatefulSet
...
class StatefulSetList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.StatefulSetList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.StatefulSetList,
