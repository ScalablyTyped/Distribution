...
import typings.atPulumiKubernetes.appsV1beta2DeploymentMod.Deployment
import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentSpec
import typings.atPulumiKubernetes.typesOutputMod.apps.v1beta2.DeploymentStatus
