...
import typings.atPulumiKubernetes.extensionsV1beta1DeploymentListMod.DeploymentList
import typings.atPulumiKubernetes.typesOutputMod.extensions.v1beta1.Deployment
