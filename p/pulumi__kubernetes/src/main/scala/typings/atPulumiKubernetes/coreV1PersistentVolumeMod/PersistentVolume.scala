package typings.atPulumiKubernetes.coreV1PersistentVolumeMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.PersistentVolumeSpec
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.PersistentVolumeStatus
...
class PersistentVolume protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PersistentVolume] = js.native
  /**
