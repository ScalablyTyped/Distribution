package typings.atPulumiKubernetes.authenticationV1beta1TokenReviewMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`authenticationDOTk8sDOTio/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.authenticationNs.v1beta1Ns.TokenReviewSpec
import typings.atPulumiKubernetes.typesOutputMod.authenticationNs.v1beta1Ns.TokenReviewStatus
...
class TokenReview protected () extends CustomResource {
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.authenticationNs.v1beta1Ns.TokenReview
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.authenticationNs.v1beta1Ns.TokenReview,
