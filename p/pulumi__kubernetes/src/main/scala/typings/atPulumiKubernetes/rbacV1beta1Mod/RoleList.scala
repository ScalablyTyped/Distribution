...
class RoleList protected ()
  extends typings.atPulumiKubernetes.rbacV1beta1RoleListMod.RoleList {
  /**
...
object RoleList extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1beta1RoleListMod.RoleList = js.native
  /**
