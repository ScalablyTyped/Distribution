...
class RoleBindingList protected ()
  extends typings.atPulumiKubernetes.rbacV1beta1RoleBindingListMod.RoleBindingList {
  /**
...
object RoleBindingList extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1beta1RoleBindingListMod.RoleBindingList = js.native
  /**
