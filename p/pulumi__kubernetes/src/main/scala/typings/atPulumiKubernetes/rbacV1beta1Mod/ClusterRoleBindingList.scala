...
class ClusterRoleBindingList protected ()
  extends typings.atPulumiKubernetes.rbacV1beta1ClusterRoleBindingListMod.ClusterRoleBindingList {
  /**
  ...
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.ClusterRoleBindingList
  ) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.ClusterRoleBindingList,
...
object ClusterRoleBindingList extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1beta1ClusterRoleBindingListMod.ClusterRoleBindingList = js.native
  /**
