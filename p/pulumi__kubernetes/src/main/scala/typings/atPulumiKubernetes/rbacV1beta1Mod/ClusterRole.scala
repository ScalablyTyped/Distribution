...
class ClusterRole protected ()
  extends typings.atPulumiKubernetes.rbacV1beta1ClusterRoleMod.ClusterRole {
  /**
...
object ClusterRole extends js.Object {
  ...
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.rbacV1beta1ClusterRoleMod.ClusterRole = js.native
  /**
