...
import typings.atPulumiKubernetes.rbacV1RoleBindingMod.RoleBinding
...
@JSImport("@pulumi/kubernetes/rbac/v1/RoleBinding", JSImport.Namespace)
@js.native
object rbacV1RoleBindingMod extends js.Object {
  @js.native
  class RoleBinding protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.RoleBinding) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.RoleBinding,
