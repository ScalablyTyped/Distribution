...
import typings.atPulumiKubernetes.rbacV1alpha1ClusterRoleListMod.ClusterRoleList
import typings.atPulumiKubernetes.typesOutputMod.meta.v1.ListMeta
import typings.atPulumiKubernetes.typesOutputMod.rbac.v1alpha1.ClusterRole
...
@js.native
object rbacV1alpha1ClusterRoleListMod extends js.Object {
  @js.native
  class ClusterRoleList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1alpha1.ClusterRoleList,
