package typings.atPulumiKubernetes.discoveryMod
...
@JSImport("@pulumi/kubernetes/discovery", "v1alpha1")
@js.native
object v1alpha1Ns extends js.Object {
  @js.native
  class EndpointSlice protected ()
    extends typings.atPulumiKubernetes.discoveryV1alpha1Mod.EndpointSlice {
    /**
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.discoveryNs.v1alpha1Ns.EndpointSlice) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.discoveryNs.v1alpha1Ns.EndpointSlice,
  ...
  class EndpointSliceList protected ()
    extends typings.atPulumiKubernetes.discoveryV1alpha1Mod.EndpointSliceList {
    /**
  ...
  object EndpointSlice extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.discoveryV1alpha1EndpointSliceMod.EndpointSlice = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.discoveryV1alpha1EndpointSliceMod.EndpointSlice = js.native
    /**
