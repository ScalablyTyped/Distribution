package typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`extensions/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.extensionsNs.v1beta1Ns.ReplicaSet
