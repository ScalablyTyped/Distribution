package typings.atPulumiKubernetes.auditregistrationV1alpha1AuditSinkMod
...
class AuditSink protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.AuditSink] = js.native
