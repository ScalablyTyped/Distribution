...
@js.native
object appsV1beta2Mod extends js.Object {
  @js.native
  class ControllerRevision protected ()
    extends typings.atPulumiKubernetes.appsV1beta2ControllerRevisionMod.ControllerRevision {
    /**
  ...
  class ControllerRevisionList protected ()
    extends typings.atPulumiKubernetes.appsV1beta2ControllerRevisionListMod.ControllerRevisionList {
    /**
  ...
  class DaemonSet protected ()
    extends typings.atPulumiKubernetes.appsV1beta2DaemonSetMod.DaemonSet {
    /**
  ...
  class ReplicaSetList protected ()
    extends typings.atPulumiKubernetes.appsV1beta2ReplicaSetListMod.ReplicaSetList {
    /**
  ...
  class StatefulSetList protected ()
    extends typings.atPulumiKubernetes.appsV1beta2StatefulSetListMod.StatefulSetList {
    /**
