package typings.atPulumiKubernetes.rbacV1beta1ClusterRoleBindingMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.RoleRef
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.Subject
