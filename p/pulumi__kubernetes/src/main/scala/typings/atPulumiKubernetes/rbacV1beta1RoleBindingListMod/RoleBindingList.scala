package typings.atPulumiKubernetes.rbacV1beta1RoleBindingListMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1beta1Ns.RoleBinding
...
class RoleBindingList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.RoleBindingList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1beta1Ns.RoleBindingList,
  ...
  /**
    ...
    */
  val items: Output[js.Array[RoleBinding]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.RoleBindingList] = js.native
  /**
