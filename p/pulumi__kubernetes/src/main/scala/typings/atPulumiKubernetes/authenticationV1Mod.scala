...
object authenticationV1Mod extends js.Object {
  ...
  class TokenReview protected ()
    extends typings.atPulumiKubernetes.authenticationV1TokenReviewMod.TokenReview {
    /**
      ...
      */
    def this(name: String) = this()
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.authentication.v1.TokenReview) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authentication.v1.TokenReview,
      opts: CustomResourceOptions
    ) = this()
  }
  ...
  object TokenReview extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.authenticationV1TokenReviewMod.TokenReview = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.authenticationV1TokenReviewMod.TokenReview = js.native
    /**
