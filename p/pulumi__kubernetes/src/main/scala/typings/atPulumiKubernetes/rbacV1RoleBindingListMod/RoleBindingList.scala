package typings.atPulumiKubernetes.rbacV1RoleBindingListMod
...
import typings.atPulumiKubernetes.typesOutputMod.rbacNs.v1Ns.RoleBinding
...
class RoleBindingList protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.RoleBindingList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.rbacNs.v1Ns.RoleBindingList,
