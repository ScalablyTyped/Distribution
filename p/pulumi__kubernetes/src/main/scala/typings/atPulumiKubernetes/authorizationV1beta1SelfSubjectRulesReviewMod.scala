...
import typings.atPulumiKubernetes.authorizationV1beta1SelfSubjectRulesReviewMod.SelfSubjectRulesReview
import typings.atPulumiKubernetes.typesOutputMod.authorization.v1beta1.SelfSubjectRulesReviewSpec
import typings.atPulumiKubernetes.typesOutputMod.authorization.v1beta1.SubjectRulesReviewStatus
...
@js.native
object authorizationV1beta1SelfSubjectRulesReviewMod extends js.Object {
  @js.native
  class SelfSubjectRulesReview protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SelfSubjectRulesReview
    ) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1beta1.SelfSubjectRulesReview,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectRulesReview] = js.native
    val metadata: Output[ObjectMeta] = js.native
    /**
      * Spec holds information about the request being evaluated.
      */
    val spec: Output[SelfSubjectRulesReviewSpec] = js.native
    /**
      * Status is filled in by the server and indicates the set of actions a user can perform.
      */
    val status: Output[SubjectRulesReviewStatus] = js.native
  }
