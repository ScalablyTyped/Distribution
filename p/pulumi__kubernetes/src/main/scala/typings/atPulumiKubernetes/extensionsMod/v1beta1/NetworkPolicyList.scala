...
class NetworkPolicyList protected ()
  extends typings.atPulumiKubernetes.extensionsV1beta1Mod.NetworkPolicyList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicyList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.NetworkPolicyList,
...
object NetworkPolicyList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1NetworkPolicyListMod.NetworkPolicyList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1NetworkPolicyListMod.NetworkPolicyList = js.native
  /**
