package typings.atPulumiKubernetes.extensionsMod
...
object v1beta1Ns extends js.Object {
  ...
  class DaemonSet protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.DaemonSet {
    /**
  ...
  class Deployment protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.Deployment {
    /**
  ...
  class Ingress protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.Ingress {
    /**
  ...
  class NetworkPolicy protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.NetworkPolicy {
    /**
  ...
  class PodSecurityPolicy protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.PodSecurityPolicy {
    /**
  ...
  class ReplicaSet protected ()
    extends typings.atPulumiKubernetes.extensionsV1beta1Mod.ReplicaSet {
    /**
