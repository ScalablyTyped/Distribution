...
class DaemonSetList protected ()
  extends typings.atPulumiKubernetes.extensionsV1beta1Mod.DaemonSetList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DaemonSetList,
...
object DaemonSetList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1DaemonSetListMod.DaemonSetList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1DaemonSetListMod.DaemonSetList = js.native
  /**
