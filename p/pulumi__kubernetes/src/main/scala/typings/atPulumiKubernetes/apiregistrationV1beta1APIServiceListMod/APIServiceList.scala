package typings.atPulumiKubernetes.apiregistrationV1beta1APIServiceListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apiregistrationDOTk8sDOTio/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.apiregistrationNs.v1beta1Ns.APIService
