...
import typings.atPulumiKubernetes.rbacV1ClusterRoleBindingMod.ClusterRoleBinding
...
@JSImport("@pulumi/kubernetes/rbac/v1/ClusterRoleBinding", JSImport.Namespace)
@js.native
object rbacV1ClusterRoleBindingMod extends js.Object {
  @js.native
