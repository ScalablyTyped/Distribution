...
import typings.atPulumiKubernetes.typesInputMod.coreNs.v1Ns.TopologySelectorTerm
...
import typings.atPulumiKubernetes.typesInputMod.storageNs.v1Ns.StorageClass
...
object storageNs extends js.Object {
  ...
  object v1alpha1Ns extends js.Object {
    ...
    trait VolumeAttachmentList extends js.Object {
      ...
      var items: Input[
            js.Array[
              Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeAttachment]
            ]
          ]
      /**
        * Kind is a string value representing the REST resource this object represents. Servers may
    ...
    trait VolumeAttachmentSpec extends js.Object {
      ...
      /**
        ...
        */
      var source: Input[
            typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeAttachmentSource
          ]
    }
    ...
    trait VolumeAttachmentStatus extends js.Object {
      /**
        ...
        * the entity completing the attach operation, i.e. the external-attacher.
        */
      var attachError: js.UndefOr[Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeError]] = js.undefined
      /**
        * Indicates the volume is successfully attached. This field must only be set by the entity
        * completing the attach operation, i.e. the external-attacher.
        */
      ...
      /**
        ...
        * the entity completing the detach operation, i.e. the external-attacher.
        */
      var detachError: js.UndefOr[Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1alpha1Ns.VolumeError]] = js.undefined
    }
  ...
  object v1beta1Ns extends js.Object {
    ...
    trait StorageClassList extends js.Object {
      ...
      /**
        ...
        */
      var items: Input[
            js.Array[Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.StorageClass]]
          ]
      /**
        * Kind is a string value representing the REST resource this object represents. Servers may
        * infer this from the endpoint the client submits requests to. Cannot be updated. In
    ...
    trait VolumeAttachmentList extends js.Object {
      ...
      var items: Input[
            js.Array[
              Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeAttachment]
            ]
          ]
      /**
        * Kind is a string value representing the REST resource this object represents. Servers may
    ...
    trait VolumeAttachmentSpec extends js.Object {
      ...
      /**
        ...
        */
      var source: Input[
            typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeAttachmentSource
          ]
    }
    ...
    trait VolumeAttachmentStatus extends js.Object {
      /**
        ...
        * the entity completing the attach operation, i.e. the external-attacher.
        */
      var attachError: js.UndefOr[Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeError]] = js.undefined
      /**
        * Indicates the volume is successfully attached. This field must only be set by the entity
        * completing the attach operation, i.e. the external-attacher.
        */
      ...
      /**
        ...
        * the entity completing the detach operation, i.e. the external-attacher.
        */
      var detachError: js.UndefOr[Input[typings.atPulumiKubernetes.typesInputMod.storageNs.v1beta1Ns.VolumeError]] = js.undefined
    }
