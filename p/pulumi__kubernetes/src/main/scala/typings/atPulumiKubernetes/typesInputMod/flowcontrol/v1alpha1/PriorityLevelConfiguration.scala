...
trait PriorityLevelConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[
    Input[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfiguration]
  ] = js.undefined
  /**
...
object PriorityLevelConfiguration {
  ...
  def apply(
    ...
    kind: Input[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityLevelConfiguration] = null,
