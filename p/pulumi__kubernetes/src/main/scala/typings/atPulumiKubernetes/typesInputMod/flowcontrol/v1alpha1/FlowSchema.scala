...
trait FlowSchema extends js.Object {
  ...
  /**
    ...
    */
  var kind: js.UndefOr[Input[typings.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchema]] = js.undefined
  /**
...
object FlowSchema {
  ...
  def apply(
    ...
    kind: Input[typings.atPulumiKubernetes.atPulumiKubernetesStrings.FlowSchema] = null,
