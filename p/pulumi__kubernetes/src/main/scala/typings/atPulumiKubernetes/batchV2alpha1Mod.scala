...
@js.native
object batchV2alpha1Mod extends js.Object {
  @js.native
  class CronJob protected ()
    extends typings.atPulumiKubernetes.batchV2alpha1CronJobMod.CronJob {
    /**
  ...
  class CronJobList protected ()
    extends typings.atPulumiKubernetes.batchV2alpha1CronJobListMod.CronJobList {
    /**
