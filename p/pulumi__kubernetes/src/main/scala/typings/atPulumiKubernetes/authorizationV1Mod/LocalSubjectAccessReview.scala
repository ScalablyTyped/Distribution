package typings.atPulumiKubernetes.authorizationV1Mod
...
class LocalSubjectAccessReview protected ()
  extends typings.atPulumiKubernetes.authorizationV1LocalSubjectAccessReviewMod.LocalSubjectAccessReview {
  /**
