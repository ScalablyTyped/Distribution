...
import typings.atPulumiKubernetes.storageV1StorageClassListMod.StorageClassList
...
@JSImport("@pulumi/kubernetes/storage/v1/StorageClassList", JSImport.Namespace)
@js.native
object storageV1StorageClassListMod extends js.Object {
  @js.native
  class StorageClassList protected () extends CustomResource {
    ...
    /**
      ...
      */
    val items: Output[js.Array[StorageClass]] = js.native
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.StorageClassList] = js.native
    /**
