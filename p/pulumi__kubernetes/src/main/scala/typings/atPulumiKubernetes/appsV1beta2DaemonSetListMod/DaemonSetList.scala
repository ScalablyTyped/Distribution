package typings.atPulumiKubernetes.appsV1beta2DaemonSetListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta2Ns.DaemonSet
...
class DaemonSetList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val items: Output[js.Array[DaemonSet]] = js.native
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.DaemonSetList] = js.native
  /**
