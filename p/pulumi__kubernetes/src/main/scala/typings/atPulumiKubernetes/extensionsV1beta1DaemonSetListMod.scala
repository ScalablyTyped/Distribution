...
import typings.atPulumiKubernetes.extensionsV1beta1DaemonSetListMod.DaemonSetList
import typings.atPulumiKubernetes.typesOutputMod.extensions.v1beta1.DaemonSet
