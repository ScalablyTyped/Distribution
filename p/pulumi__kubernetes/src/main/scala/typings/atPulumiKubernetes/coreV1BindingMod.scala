...
@js.native
object coreV1BindingMod extends js.Object {
  @js.native
  class Binding protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.Binding) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.core.v1.Binding,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.Binding] = js.native
    /**
    ...
    /**
      ...
      */
    val target: Output[ObjectReference] = js.native
  }
