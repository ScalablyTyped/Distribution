package typings.atPulumiKubernetes.coreV1NodeMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.NodeSpec
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.NodeStatus
...
class Node protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.Node] = js.native
  /**
