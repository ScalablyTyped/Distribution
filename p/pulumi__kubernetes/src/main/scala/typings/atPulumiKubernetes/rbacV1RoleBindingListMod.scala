...
import typings.atPulumiKubernetes.rbacV1RoleBindingListMod.RoleBindingList
...
@js.native
object rbacV1RoleBindingListMod extends js.Object {
  @js.native
  class RoleBindingList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.RoleBindingList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.rbac.v1.RoleBindingList,
