package typings.atPulumiKubernetes.appsV1beta1ControllerRevisionMod
...
class ControllerRevision protected () extends CustomResource {
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.ControllerRevision) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1beta1Ns.ControllerRevision,
