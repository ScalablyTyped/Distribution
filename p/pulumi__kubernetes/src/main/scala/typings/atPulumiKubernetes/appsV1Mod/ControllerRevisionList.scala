...
class ControllerRevisionList protected ()
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ControllerRevisionList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ControllerRevisionList,
