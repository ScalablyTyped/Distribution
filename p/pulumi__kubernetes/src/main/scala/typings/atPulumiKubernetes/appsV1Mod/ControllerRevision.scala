...
class ControllerRevision protected ()
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ControllerRevision) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.appsNs.v1Ns.ControllerRevision,
