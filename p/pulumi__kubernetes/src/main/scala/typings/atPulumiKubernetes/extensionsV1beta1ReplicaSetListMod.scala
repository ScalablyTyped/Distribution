...
import typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetListMod.ReplicaSetList
import typings.atPulumiKubernetes.typesOutputMod.extensions.v1beta1.ReplicaSet
...
@js.native
object extensionsV1beta1ReplicaSetListMod extends js.Object {
  @js.native
  class ReplicaSetList protected () extends CustomResource {
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetList) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.ReplicaSetList,
    ...
    /**
      ...
      */
    val items: Output[js.Array[ReplicaSet]] = js.native
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.ReplicaSetList] = js.native
    /**
