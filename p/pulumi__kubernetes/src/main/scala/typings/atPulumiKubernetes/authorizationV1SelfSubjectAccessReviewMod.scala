...
import typings.atPulumiKubernetes.authorizationV1SelfSubjectAccessReviewMod.SelfSubjectAccessReview
...
@js.native
object authorizationV1SelfSubjectAccessReviewMod extends js.Object {
  @js.native
  class SelfSubjectAccessReview protected () extends CustomResource {
    ...
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SelfSubjectAccessReview
    ) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.authorization.v1.SelfSubjectAccessReview,
    ...
    /**
      ...
      */
    val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.SelfSubjectAccessReview] = js.native
    val metadata: Output[ObjectMeta] = js.native
    /**
      * Spec holds information about the request being evaluated.  user and groups must be empty
      */
    val spec: Output[SelfSubjectAccessReviewSpec] = js.native
    /**
