...
object discoveryV1beta1Mod extends js.Object {
  ...
  class EndpointSlice protected ()
    extends typings.atPulumiKubernetes.discoveryV1beta1EndpointSliceMod.EndpointSlice {
    /**
  ...
  class EndpointSliceList protected ()
    extends typings.atPulumiKubernetes.discoveryV1beta1EndpointSliceListMod.EndpointSliceList {
    /**
