package typings.atPulumiKubernetes.appsV1beta1DeploymentListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta1`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta1Ns.Deployment
...
@JSImport("@pulumi/kubernetes/apps/v1beta1/DeploymentList", "DeploymentList")
@js.native
