...
class PodSecurityPolicy protected ()
  extends typings.atPulumiKubernetes.extensionsMod.v1beta1.PodSecurityPolicy {
  /**
...
object PodSecurityPolicy extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1PodSecurityPolicyMod.PodSecurityPolicy = js.native
  /**
