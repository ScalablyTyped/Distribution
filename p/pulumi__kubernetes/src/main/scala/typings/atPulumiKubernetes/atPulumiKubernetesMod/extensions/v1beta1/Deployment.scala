...
class Deployment protected ()
  extends typings.atPulumiKubernetes.extensionsMod.v1beta1.Deployment {
  /**
...
object Deployment extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1DeploymentMod.Deployment = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1DeploymentMod.Deployment = js.native
  /**
