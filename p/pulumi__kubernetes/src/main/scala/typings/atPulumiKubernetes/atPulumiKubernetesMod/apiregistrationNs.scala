...
object apiregistrationNs extends js.Object {
  ...
  object v1Ns extends js.Object {
    ...
    class APIService protected ()
      extends typings.atPulumiKubernetes.apiregistrationMod.v1Ns.APIService {
      /**
    ...
    class APIServiceList protected ()
      extends typings.atPulumiKubernetes.apiregistrationMod.v1Ns.APIServiceList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1Ns.APIServiceList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1Ns.APIServiceList,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    object APIService extends js.Object {
      /**
        ...
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiregistrationV1APIServiceMod.APIService = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiregistrationV1APIServiceMod.APIService = js.native
      /**
    ...
    object APIServiceList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiregistrationV1APIServiceListMod.APIServiceList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiregistrationV1APIServiceListMod.APIServiceList = js.native
      /**
  ...
  object v1beta1Ns extends js.Object {
    @js.native
    class APIService protected ()
      extends typings.atPulumiKubernetes.apiregistrationMod.v1beta1Ns.APIService {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1beta1Ns.APIService
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1beta1Ns.APIService,
    ...
    @js.native
    class APIServiceList protected ()
      extends typings.atPulumiKubernetes.apiregistrationMod.v1beta1Ns.APIServiceList {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1beta1Ns.APIServiceList
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.apiregistrationNs.v1beta1Ns.APIServiceList,
    ...
    object APIService extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiregistrationV1beta1APIServiceMod.APIService = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiregistrationV1beta1APIServiceMod.APIService = js.native
      /**
        * Returns true if the given object is an instance of APIService.  This is designed to work even
        * when multiple copies of the Pulumi SDK have been loaded into the same process.
        */
    ...
    object APIServiceList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.apiregistrationV1beta1APIServiceListMod.APIServiceList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.apiregistrationV1beta1APIServiceListMod.APIServiceList = js.native
      /**
        * Returns true if the given object is an instance of APIServiceList.  This is designed to work even
        * when multiple copies of the Pulumi SDK have been loaded into the same process.
        */
