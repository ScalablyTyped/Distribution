...
object eventsNs extends js.Object {
  ...
  object v1beta1Ns extends js.Object {
    ...
    class Event protected ()
      extends typings.atPulumiKubernetes.eventsMod.v1beta1Ns.Event {
      /**
      ...
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.eventsNs.v1beta1Ns.Event) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.eventsNs.v1beta1Ns.Event,
    ...
    class EventList protected ()
      extends typings.atPulumiKubernetes.eventsMod.v1beta1Ns.EventList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.eventsNs.v1beta1Ns.EventList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.eventsNs.v1beta1Ns.EventList,
        opts: CustomResourceOptions
      ) = this()
    }
