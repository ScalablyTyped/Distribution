...
class DeploymentList protected ()
  extends typings.atPulumiKubernetes.extensionsMod.v1beta1.DeploymentList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DeploymentList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.extensions.v1beta1.DeploymentList,
...
object DeploymentList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1DeploymentListMod.DeploymentList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1DeploymentListMod.DeploymentList = js.native
  /**
