...
object certificates extends js.Object {
  ...
  object v1beta1 extends js.Object {
    ...
    class CertificateSigningRequest protected ()
      extends typings.atPulumiKubernetes.certificatesMod.v1beta1.CertificateSigningRequest {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequest
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequest,
    ...
    class CertificateSigningRequestList protected ()
      extends typings.atPulumiKubernetes.certificatesMod.v1beta1.CertificateSigningRequestList {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequestList
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.certificates.v1beta1.CertificateSigningRequestList,
