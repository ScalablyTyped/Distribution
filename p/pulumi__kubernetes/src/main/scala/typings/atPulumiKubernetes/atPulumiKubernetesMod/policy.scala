...
object policy extends js.Object {
  ...
  object v1beta1 extends js.Object {
    ...
    class PodDisruptionBudget protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1.PodDisruptionBudget {
      /**
    ...
    class PodDisruptionBudgetList protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1.PodDisruptionBudgetList {
      /**
    ...
    class PodSecurityPolicy protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1.PodSecurityPolicy {
      /**
    ...
    class PodSecurityPolicyList protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1.PodSecurityPolicyList {
      /**
