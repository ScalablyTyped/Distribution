...
class ServiceAccountList protected ()
  extends typings.atPulumiKubernetes.coreMod.v1.ServiceAccountList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.ServiceAccountList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.ServiceAccountList,
