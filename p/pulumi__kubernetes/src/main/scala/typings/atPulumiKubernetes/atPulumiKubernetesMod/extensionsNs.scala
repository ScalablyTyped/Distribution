...
object extensionsNs extends js.Object {
  ...
  object v1beta1Ns extends js.Object {
    ...
    class DaemonSet protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.DaemonSet {
      /**
    ...
    class DaemonSetList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.DaemonSetList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.DaemonSetList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.DaemonSetList,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    class Deployment protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.Deployment {
      /**
    ...
    class DeploymentList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.DeploymentList {
      /**
    ...
    class Ingress protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.Ingress {
      /**
    ...
    class IngressList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.IngressList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.IngressList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.extensionsNs.v1beta1Ns.IngressList,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    class NetworkPolicy protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.NetworkPolicy {
      /**
    ...
    class NetworkPolicyList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.NetworkPolicyList {
      /**
    ...
    class PodSecurityPolicy protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.PodSecurityPolicy {
      /**
    ...
    class PodSecurityPolicyList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.PodSecurityPolicyList {
      /**
    ...
    class ReplicaSet protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.ReplicaSet {
      /**
    ...
    class ReplicaSetList protected ()
      extends typings.atPulumiKubernetes.extensionsMod.v1beta1Ns.ReplicaSetList {
      /**
    ...
    object ReplicaSet extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetMod.ReplicaSet = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.extensionsV1beta1ReplicaSetMod.ReplicaSet = js.native
      /**
