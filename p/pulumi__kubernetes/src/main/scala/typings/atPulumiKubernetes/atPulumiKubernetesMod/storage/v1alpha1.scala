...
object v1alpha1 extends js.Object {
  ...
  class VolumeAttachment protected ()
    extends typings.atPulumiKubernetes.storageMod.v1alpha1.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typings.atPulumiKubernetes.storageMod.v1alpha1.VolumeAttachmentList {
    /**
  ...
  object VolumeAttachment extends js.Object {
    /**
      ...
      */
    def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1alpha1VolumeAttachmentMod.VolumeAttachment = js.native
    /**
  ...
  object VolumeAttachmentList extends js.Object {
    /**
      ...
      * @param opts Uniquely specifies a CustomResource to select.
      */
    def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod.VolumeAttachmentList = js.native
    def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.storageV1alpha1VolumeAttachmentListMod.VolumeAttachmentList = js.native
    /**
