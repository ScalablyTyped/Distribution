...
object auditregistrationNs extends js.Object {
  ...
  object v1alpha1Ns extends js.Object {
    ...
    class AuditSink protected ()
      extends typings.atPulumiKubernetes.auditregistrationMod.v1alpha1Ns.AuditSink {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.auditregistrationNs.v1alpha1Ns.AuditSink
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.auditregistrationNs.v1alpha1Ns.AuditSink,
    ...
    class AuditSinkList protected ()
      extends typings.atPulumiKubernetes.auditregistrationMod.v1alpha1Ns.AuditSinkList {
      /**
