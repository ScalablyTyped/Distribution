...
class LimitRangeList protected ()
  extends typings.atPulumiKubernetes.coreMod.v1.LimitRangeList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.LimitRangeList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.LimitRangeList,
...
object LimitRangeList extends js.Object {
  /**
    ...
    */
  def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.coreV1LimitRangeListMod.LimitRangeList = js.native
  def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.coreV1LimitRangeListMod.LimitRangeList = js.native
  /**
