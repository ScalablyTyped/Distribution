...
object yamlNs extends js.Object {
  ...
  abstract class CollectionComponentResource protected ()
    extends typings.atPulumiKubernetes.yamlMod.CollectionComponentResource {
  ...
  class ConfigFile protected ()
    extends typings.atPulumiKubernetes.yamlMod.ConfigFile {
  ...
  class ConfigGroup protected ()
    extends typings.atPulumiKubernetes.yamlMod.ConfigGroup {
