...
object policyNs extends js.Object {
  ...
  object v1beta1Ns extends js.Object {
    ...
    class PodDisruptionBudget protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1Ns.PodDisruptionBudget {
      /**
    ...
    class PodDisruptionBudgetList protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1Ns.PodDisruptionBudgetList {
      /**
    ...
    class PodSecurityPolicy protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1Ns.PodSecurityPolicy {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodSecurityPolicy) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodSecurityPolicy,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    class PodSecurityPolicyList protected ()
      extends typings.atPulumiKubernetes.policyMod.v1beta1Ns.PodSecurityPolicyList {
      /**
      ...
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodSecurityPolicyList
      ) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.policyNs.v1beta1Ns.PodSecurityPolicyList,
