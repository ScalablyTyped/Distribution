...
object nodeNs extends js.Object {
  ...
  object v1alpha1Ns extends js.Object {
    ...
    class RuntimeClass protected ()
      extends typings.atPulumiKubernetes.nodeMod.v1alpha1Ns.RuntimeClass {
      /**
    ...
    class RuntimeClassList protected ()
      extends typings.atPulumiKubernetes.nodeMod.v1alpha1Ns.RuntimeClassList {
      /**
    ...
    object RuntimeClassList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.nodeV1alpha1RuntimeClassListMod.RuntimeClassList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.nodeV1alpha1RuntimeClassListMod.RuntimeClassList = js.native
      /**
  ...
  object v1beta1Ns extends js.Object {
    @js.native
    class RuntimeClass protected ()
      extends typings.atPulumiKubernetes.nodeMod.v1beta1Ns.RuntimeClass {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.nodeNs.v1beta1Ns.RuntimeClass) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.nodeNs.v1beta1Ns.RuntimeClass,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    @js.native
    class RuntimeClassList protected ()
      extends typings.atPulumiKubernetes.nodeMod.v1beta1Ns.RuntimeClassList {
      /**
        ...
        */
      def this(name: String) = this()
      def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.nodeNs.v1beta1Ns.RuntimeClassList) = this()
      def this(
        name: String,
        args: typings.atPulumiKubernetes.typesInputMod.nodeNs.v1beta1Ns.RuntimeClassList,
        opts: CustomResourceOptions
      ) = this()
    }
    ...
    object RuntimeClass extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.nodeV1beta1RuntimeClassMod.RuntimeClass = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.nodeV1beta1RuntimeClassMod.RuntimeClass = js.native
      /**
        * Returns true if the given object is an instance of RuntimeClass.  This is designed to work even
        * when multiple copies of the Pulumi SDK have been loaded into the same process.
        */
    ...
    object RuntimeClassList extends js.Object {
      /**
        ...
        * @param opts Uniquely specifies a CustomResource to select.
        */
      def get(name: String, id: Input[ID]): typings.atPulumiKubernetes.nodeV1beta1RuntimeClassListMod.RuntimeClassList = js.native
      def get(name: String, id: Input[ID], opts: CustomResourceOptions): typings.atPulumiKubernetes.nodeV1beta1RuntimeClassListMod.RuntimeClassList = js.native
      /**
        * Returns true if the given object is an instance of RuntimeClassList.  This is designed to work even
        * when multiple copies of the Pulumi SDK have been loaded into the same process.
        */
