...
class EventList protected ()
  extends typings.atPulumiKubernetes.coreMod.v1.EventList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.EventList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.EventList,
