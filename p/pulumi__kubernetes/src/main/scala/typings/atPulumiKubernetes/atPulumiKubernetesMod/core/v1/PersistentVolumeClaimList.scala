...
class PersistentVolumeClaimList protected ()
  extends typings.atPulumiKubernetes.coreMod.v1.PersistentVolumeClaimList {
  /**
  ...
  def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolumeClaimList) = this()
  def this(
    name: String,
    args: typings.atPulumiKubernetes.typesInputMod.core.v1.PersistentVolumeClaimList,
