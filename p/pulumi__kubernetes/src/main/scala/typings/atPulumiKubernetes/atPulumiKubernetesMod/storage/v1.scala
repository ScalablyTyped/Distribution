package typings.atPulumiKubernetes.atPulumiKubernetesMod.storage
...
object v1 extends js.Object {
  ...
  class CSINode protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.CSINode {
    /**
  ...
  class CSINodeList protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.CSINodeList {
    /**
  ...
  class StorageClass protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.StorageClass {
    /**
  ...
  class StorageClassList protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.StorageClassList {
    /**
  ...
  class VolumeAttachment protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.VolumeAttachment {
    /**
  ...
  class VolumeAttachmentList protected ()
    extends typings.atPulumiKubernetes.storageMod.v1.VolumeAttachmentList {
    /**
