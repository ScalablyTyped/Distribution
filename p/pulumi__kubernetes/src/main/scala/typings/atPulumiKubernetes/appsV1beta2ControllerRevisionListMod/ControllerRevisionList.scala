package typings.atPulumiKubernetes.appsV1beta2ControllerRevisionListMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.`apps/v1beta2`
import typings.atPulumiKubernetes.typesOutputMod.appsNs.v1beta2Ns.ControllerRevision
