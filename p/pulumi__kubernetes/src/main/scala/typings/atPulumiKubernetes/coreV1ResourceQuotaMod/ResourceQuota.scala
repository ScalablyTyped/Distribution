package typings.atPulumiKubernetes.coreV1ResourceQuotaMod

import typings.atPulumiKubernetes.atPulumiKubernetesStrings.v1
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.ResourceQuotaSpec
import typings.atPulumiKubernetes.typesOutputMod.coreNs.v1Ns.ResourceQuotaStatus
...
class ResourceQuota protected () extends CustomResource {
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.ResourceQuota] = js.native
  /**
  ...
  /**
    ...
    */
  val spec: Output[ResourceQuotaSpec] = js.native
  /**
    * Status defines the actual enforced quota and its current usage.
    * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
    */
  val status: Output[ResourceQuotaStatus] = js.native
}
