...
object batchV1Mod extends js.Object {
  @js.native
  class Job protected ()
    extends typings.atPulumiKubernetes.batchV1JobMod.Job {
    /**
    ...
    def this(name: String, args: typings.atPulumiKubernetes.typesInputMod.batch.v1.Job) = this()
    def this(
      name: String,
      args: typings.atPulumiKubernetes.typesInputMod.batch.v1.Job,
  ...
  class JobList protected ()
    extends typings.atPulumiKubernetes.batchV1JobListMod.JobList {
    /**
