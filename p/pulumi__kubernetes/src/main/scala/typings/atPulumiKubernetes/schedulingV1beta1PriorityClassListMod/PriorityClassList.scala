package typings.atPulumiKubernetes.schedulingV1beta1PriorityClassListMod
...
import typings.atPulumiKubernetes.typesOutputMod.schedulingNs.v1beta1Ns.PriorityClass
...
class PriorityClassList protected () extends CustomResource {
  ...
  /**
    ...
    */
  val apiVersion: Output[`schedulingDOTk8sDOTio/v1beta1`] = js.native
  /**
  ...
  /**
    ...
    */
  val kind: Output[typings.atPulumiKubernetes.atPulumiKubernetesStrings.PriorityClassList] = js.native
  /**
