...
version := "v0.17.2-a359fb"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "arrify" % "1.0-dt-20180910Z-acd933",
  "com.scalablytyped" %%% "buffer-from" % "1.1-dt-20180910Z-60d755",
  ...
  "com.scalablytyped" %%% "grpc" % "1.15.1-874ced",
