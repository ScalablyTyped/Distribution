...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "buffer-from" % "1.1-dt-20180616Z-9bccf3",
  ...
  "org.scalablytyped" %%% "pulumi__pulumi" % "0.17.1-ddcfac",
  ...
  "org.scalablytyped" %%% "ts-node" % "7.0.1-587fa1",
