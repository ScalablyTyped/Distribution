...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "buffer-from" % "1.1-dt-20180616Z-47a9d8",
  ...
  "org.scalablytyped" %%% "pulumi__pulumi" % "0.16.14-e91d6a",
  ...
  "org.scalablytyped" %%% "ts-node" % "7.0.1-2816a4",
