...
object PathItem extends js.Object {
  /**
    ...
    */
  def create(`object`: js.Any): typings.paper.paper.Path | typings.paper.paper.CompoundPath = js.native
  /**
  ...
  /**
    ...
    */
  def create(segments: js.Array[_ | Double]): typings.paper.paper.Path | typings.paper.paper.CompoundPath = js.native
}
