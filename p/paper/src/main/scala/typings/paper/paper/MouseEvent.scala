...
object MouseEvent {
  ...
  implicit class MouseEventOps[Self <: MouseEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentTarget(value: Item): Self = this.set("currentTarget", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTarget(value: Item): Self = this.set("target", value.asInstanceOf[js.Any])
