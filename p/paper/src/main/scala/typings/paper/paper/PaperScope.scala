...
class PaperScope () extends Base {
  ...
  var CompoundPath: Instantiable1[/* object */ js.Any, typings.paper.paper.CompoundPath] = js.native
  ...
  var PlacedSymbol: Instantiable2[/* symbol */ Symbol, js.UndefOr[/* point */ Point], typings.paper.paper.PlacedSymbol] = js.native
  var Point: TypeofClassPoint = js.native
  var PointText: Instantiable1[/* point */ Point, typings.paper.paper.PointText] = js.native
  var Project: Instantiable1[/* element */ HTMLCanvasElement | String, typings.paper.paper.Project] = js.native
  ...
  var Style: Instantiable0[typings.paper.paper.Style] = js.native
  var Symbol: Instantiable2[/* item */ Item, js.UndefOr[/* dontCenter */ Boolean], typings.paper.paper.Symbol] = js.native
