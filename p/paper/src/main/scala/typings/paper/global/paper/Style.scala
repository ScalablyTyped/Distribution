...
class Style protected ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var fillColor: typings.paper.paper.Color | Null = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var selectedColor: typings.paper.paper.Color | Null = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var shadowColor: typings.paper.paper.Color | Null = js.native
  /** 
    * The shadow's offset.
    */
  /* CompleteClass */
  override var shadowOffset: typings.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var strokeColor: typings.paper.paper.Color | Null = js.native
  /** 
