...
class ToolEvent ()
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var downPoint: typings.paper.paper.Point = js.native
  /** 
  ...
  /** 
    ...
    */
  /* CompleteClass */
  override var lastPoint: typings.paper.paper.Point = js.native
  /** 
    ...
    */
  /* CompleteClass */
  override var middlePoint: typings.paper.paper.Point = js.native
  /** 
