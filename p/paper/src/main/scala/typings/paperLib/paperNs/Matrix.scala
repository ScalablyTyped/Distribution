...
class Matrix protected () extends Base {
  ...
  /**
    ...
    */
  @JSName("apply")
  def apply(recursively: scala.Boolean): scala.Boolean = js.native
  /**
    * Applies this matrix to the specified Canvas Context.
    * @param ctx -
    */
  def applyToContext(ctx: stdLib.CanvasRenderingContext2D): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def isInvertible(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def rotate(angle: scala.Double, center: Point): Matrix = js.native
  /**
    * Concatenates this transform with a rotation transformation around an anchor point.
    * @param angle - the angle of rotation measured in degrees
    ...
    */
  def rotate(angle: scala.Double, x: scala.Double, y: scala.Double): Matrix = js.native
  /**
    ...
    */
  def scale(hor: scala.Double, ver: scala.Double): Matrix = js.native
  def scale(hor: scala.Double, ver: scala.Double, center: Point): Matrix = js.native
  /**
    * Concatenates this transform with a scaling transformation.
  ...
  def scale(scale: scala.Double, center: Point): Matrix = js.native
  /**
  ...
  /**
    ...
    */
  def set(values: js.Array[scala.Double]): Matrix = js.native
  /**
    ...
    */
  def shear(hor: scala.Double, ver: scala.Double): Matrix = js.native
  def shear(hor: scala.Double, ver: scala.Double, center: Point): Matrix = js.native
  /**
    * Concatenates this transform with a shear transformation.
  ...
  /**
    ...
    */
  def skew(hor: scala.Double, ver: scala.Double): Matrix = js.native
  def skew(hor: scala.Double, ver: scala.Double, center: Point): Matrix = js.native
  /**
    * Concatenates this transform with a skew transformation.
  ...
  /**
    ...
    */
  def transform(src: js.Array[scala.Double], dst: js.Array[scala.Double], count: scala.Double): js.Array[scala.Double] = js.native
  /**
    * Concatenates this transform with a translate transformation.
    * @param dx - the distance to translate in the x direction
    * @param dy - the distance to translate in the y direction
    */
  def translate(dx: scala.Double, dy: scala.Double): Matrix = js.native
  /**
    * Concatenates this transform with a translate transformation.
