...
class View () extends Base {
  ...
  /**
    ...
    * Read Only.
    */
  val element: stdLib.HTMLCanvasElement = js.native
  /**
  ...
  /**
    ...
    */
  def onResize(event: Event): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def scrollBy(point: Point): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param center [optional] - default: view.center
    */
  def shear(shear: Point): scala.Unit = js.native
  def shear(shear: Point, center: Point): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def translate(delta: Point): scala.Unit = js.native
  /**
