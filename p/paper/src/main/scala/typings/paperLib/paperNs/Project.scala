...
class Project protected () extends js.Object {
  ...
  def importSVG(svg: java.lang.String, options: paperLib.Anon_ApplyMatrixExpandShapesInsert): Item = js.native
  /**
  ...
  def importSVG(svg: stdLib.SVGElement, options: paperLib.Anon_ApplyMatrixExpandShapesInsert): Item = js.native
  /**
