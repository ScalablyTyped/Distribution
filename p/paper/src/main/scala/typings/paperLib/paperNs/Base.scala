...
class Base () extends js.Object {
  ...
  def exportJSON(options: paperLib.Anon_AsStringFalse): js.Object | js.Array[_] = js.native
  def exportJSON(options: paperLib.Anon_AsStringPrecision): java.lang.String = js.native
  /**
