...
class Size protected () extends js.Object {
  ...
  def add(size: js.Array[scala.Double]): Size = js.native
  /*
    * Returns a new size
    * @param size - The size you want to add with
    */
  def add(size: Size): Size = js.native
  def add(size: scala.Double): Size = js.native
  /**
