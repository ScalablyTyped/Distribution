...
class Rectangle protected () extends Base {
  ...
  /**
    ...
    */
  def contains(rect: Rectangle): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def expand(amount: scala.Double): Rectangle = js.native
  /**
    ...
    */
  def expand(hor: scala.Double, ver: scala.Double): Rectangle = js.native
  /**
  ...
  def intersects(rect: Rectangle, epsilon: scala.Double): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def scale(amount: scala.Double): Rectangle = js.native
  /**
    ...
    */
  def scale(hor: scala.Double, ver: scala.Double): Rectangle = js.native
  /**
  ...
  /**
    ...
    * @param height - the height
    */
  def set(x: scala.Double, y: scala.Double, width: scala.Double, height: scala.Double): Rectangle = js.native
  /**
