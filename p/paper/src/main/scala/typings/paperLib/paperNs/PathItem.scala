...
class PathItem () extends Item {
  ...
  /**
    ...
    */
  var pathData: java.lang.String = js.native
  /**
    ...
    */
  def arcBy(through: Point, to: Point): scala.Unit = js.native
  /**
    ...
    */
  def arcBy(to: Point): scala.Unit = js.native
  def arcBy(to: Point, clockwise: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def arcTo(through: Point, to: Point): scala.Unit = js.native
  /**
    ...
    * @param clockwise [optional] - specifies whether the arc should be drawn in clockwise direction. default: true
    */
  def arcTo(to: Point): scala.Unit = js.native
  def arcTo(to: Point, clockwise: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def closePath(tolerance: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def compare(path: PathItem): scala.Boolean = js.native
  /**
    ...
    */
  def cubicCurveBy(handle1: Point, handle2: Point, to: Point): scala.Unit = js.native
  /**
    ...
    */
  def cubicCurveTo(handle1: Point, handle2: Point, to: Point): scala.Unit = js.native
  /**
    ...
    */
  def curveBy(through: Point, to: Point): scala.Unit = js.native
  def curveBy(through: Point, to: Point, time: scala.Double): scala.Unit = js.native
  /**
    ...
    * @param time [optional] - the curve-time parameter at which the through point is to be located. default: 0.5
    */
  def curveTo(through: Point, to: Point): scala.Unit = js.native
  def curveTo(through: Point, to: Point, time: scala.Double): scala.Unit = js.native
  /**
  ...
  def divide(path: PathItem, options: paperLib.Anon_InsertTrace): PathItem = js.native
  /**
  ...
  /**
    ...
    */
  def flatten(): scala.Unit = js.native
  def flatten(flatness: scala.Double): scala.Unit = js.native
  /**
  ...
  def getIntersections(path: PathItem, include: js.Function1[/* location */ CurveLocation, scala.Boolean]): js.Array[CurveLocation] = js.native
  /**
  ...
  /**
    ...
    */
  def interpolate(from: PathItem, to: PathItem, factor: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def lineBy(point: Point): scala.Unit = js.native
  /**
    * Draw a line from the current point to the given point
    * @param point - the end point of the line
    */
  def lineTo(point: Point): scala.Unit = js.native
  /**
    ...
    * @param to -
    */
  def moveBy(to: Point): scala.Unit = js.native
  /**
    ...
    */
  def moveTo(point: Point): scala.Unit = js.native
  /**
    ...
    * @param to - the destination point of the newly added curve
    */
  def quadraticCurveBy(handle: Point, to: Point): scala.Unit = js.native
  /**
    * Adds a quadratic bezier curve to the path, defined by a handle and a to point.
    * @param handle - The control point for the curve
    * @param to - The end control point of the curve
    */
  def quadraticCurveTo(handle: Point, to: Point): scala.Unit = js.native
  /**
  ...
  def reorient(nonZero: scala.Boolean): PathItem = js.native
  def reorient(nonZero: scala.Boolean, clockwise: scala.Boolean): PathItem = js.native
  /**
  ...
  /**
    ...
    */
  def simplify(): scala.Boolean = js.native
  def simplify(tolerance: scala.Double): scala.Boolean = js.native
  /**
