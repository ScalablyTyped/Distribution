...
class Raster () extends Item {
  ...
  /**
           ...
           * @param position [optional] - the center position at which the raster item is placed
           */
  def this(source: java.lang.String, position: Point) = this()
  /**
           * Creates a new raster item from the passed argument, and places it in the active layer. object can either be a DOM Image, a Canvas, or a string describing the URL to load the image from, or the ID of a DOM element to get the image from (either a DOM Image or a Canvas).
           * @param source [optional] - the source of the raster
           * @param position [optional] - the center position at which the raster item is placed
           */
  def this(source: stdLib.HTMLCanvasElement, position: Point) = this()
  /**
           * Creates a new raster item from the passed argument, and places it in the active layer. object can either be a DOM Image, a Canvas, or a string describing the URL to load the image from, or the ID of a DOM element to get the image from (either a DOM Image or a Canvas).
           * @param source [optional] - the source of the raster
           * @param position [optional] - the center position at which the raster item is placed
           */
  def this(source: stdLib.HTMLImageElement, position: Point) = this()
  /**
  ...
  /**
           ...
           */
  var source: stdLib.HTMLImageElement | stdLib.HTMLCanvasElement | java.lang.String = js.native
  /**
  ...
  /**
           ...
           * @param size
           */
  def createImageData(size: Size): stdLib.ImageData = js.native
  /**
           * Draws an image on the raster.
           * @param image - the image to draw
           * @param point - the offset of the image as a point in pixel coordinates
           */
  def drawImage(image: stdLib.HTMLCanvasElement, point: Point): scala.Unit = js.native
  /**
           * Draws an image on the raster.
           * @param image - the image to draw
           * @param point - the offset of the image as a point in pixel coordinates
           */
  def drawImage(image: stdLib.HTMLImageElement, point: Point): scala.Unit = js.native
  /**
  ...
  /**
           ...
           * @param rect
           */
  def getImageData(rect: Rectangle): stdLib.ImageData = js.native
  /**
  ...
  /**
           ...
           */
  def getPixel(x: scala.Double, y: scala.Double): Color = js.native
  /**
           ...
           */
  def getSubCanvas(rect: Rectangle): stdLib.HTMLCanvasElement = js.native
  /**
  ...
  /**
           ...
           * @param point
           */
  def setImageData(data: stdLib.ImageData, point: Point): scala.Unit = js.native
  /**
           * Sets the color of the specified pixel to the specified color.
           * @param point - the offset of the pixel as a point in pixel coordinates
           * @param color - the color that the pixel will be set to
           */
  def setPixel(point: Point, color: Color): scala.Unit = js.native
  /**
           * Sets the color of the specified pixel to the specified color
           * @param x - the x offset of the pixel in pixel coordinates
           * @param y - the y offset of the pixel in pixel coordinates
           * @param color - the color that the pixel will be set to
           */
  def setPixel(x: scala.Double, y: scala.Double, color: Color): scala.Unit = js.native
  /**
