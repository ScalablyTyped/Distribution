...
import typings.atPhosphorAlgorithm.libArrayMod.ArrayExt.MutableArrayLike
import typings.atPhosphorAlgorithm.libArrayMod.ArrayExt.slice.IOptions
...
import typings.atPhosphorAlgorithm.libStringMod.StringExt.IMatchResult
...
@js.native
object atPhosphorAlgorithmMod extends js.Object {
  @js.native
  ...
  class EmptyIterator[T] ()
    extends typings.atPhosphorAlgorithm.libEmptyMod.EmptyIterator[T]
  ...
  class KeyIterator protected ()
    extends typings.atPhosphorAlgorithm.libIterMod.KeyIterator {
    /**
  ...
  class RangeIterator protected ()
    extends typings.atPhosphorAlgorithm.libRangeMod.RangeIterator {
    /**
  ...
  class RepeatIterator[T] protected ()
    extends typings.atPhosphorAlgorithm.libRepeatMod.RepeatIterator[T] {
    /**
  ...
  class RetroArrayIterator[T] protected ()
    extends typings.atPhosphorAlgorithm.libRetroMod.RetroArrayIterator[T] {
    /**
  ...
  object ArrayExt extends js.Object {
    ...
    /**
      ...
      * ```
      */
    def removeFirstWhere[T](array: js.Array[T], fn: js.Function2[/* value */ T, /* index */ Double, Boolean]): Anon_Index[T] = js.native
    def removeFirstWhere[T](array: js.Array[T], fn: js.Function2[/* value */ T, /* index */ Double, Boolean], start: Double): Anon_Index[T] = js.native
    ...
    /**
      ...
      * ```
      */
    def removeLastWhere[T](array: js.Array[T], fn: js.Function2[/* value */ T, /* index */ Double, Boolean]): Anon_Index[T] = js.native
    def removeLastWhere[T](array: js.Array[T], fn: js.Function2[/* value */ T, /* index */ Double, Boolean], start: Double): Anon_Index[T] = js.native
