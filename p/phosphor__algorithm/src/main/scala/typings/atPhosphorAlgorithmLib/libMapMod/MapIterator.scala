...
@JSImport("@phosphor/algorithm/lib/map", "MapIterator")
@js.native
class MapIterator[T, U] protected ()
  extends atPhosphorAlgorithmLib.libIterMod.IIterator[U] {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def iter(): atPhosphorAlgorithmLib.libIterMod.IIterator[U] = js.native
  /**
