...
@JSImport("@phosphor/algorithm", "ArrayExt")
@js.native
object ArrayExtNs extends js.Object {
  /**
    ...
    * ```
    */
  def fill[T](array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T], value: T): scala.Unit = js.native
  def fill[T](
    array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T],
    value: T,
    start: scala.Double
  ...
  /**
    ...
    * ```
    */
  def reverse[T](array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T]): scala.Unit = js.native
  def reverse[T](array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T], start: scala.Double): scala.Unit = js.native
  def reverse[T](
    array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T],
    start: scala.Double,
    stop: scala.Double
  ...
  /**
    ...
    * ```
    */
  def rotate[T](array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T], delta: scala.Double): scala.Unit = js.native
  def rotate[T](
    array: atPhosphorAlgorithmLib.libArrayMod.ArrayExtNs.MutableArrayLike[T],
    delta: scala.Double,
    start: scala.Double
