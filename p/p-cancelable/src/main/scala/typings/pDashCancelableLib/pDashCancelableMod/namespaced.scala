...
@js.native
class namespaced[ValueType] protected () extends PCancelable[ValueType] {
  /**
  ...
  def this(executor: js.Function3[
      ...
      /* onCancel */ pDashCancelableLib.pDashCancelableMod.PCancelableNs.OnCancelFunction, 
      scala.Unit
    ]) = this()
}
...
object namespaced extends js.Object {
  /**
  	...
  	*/
  var CancelError: org.scalablytyped.runtime.Instantiable1[
    /* reason */ js.UndefOr[/* reason */ java.lang.String], 
    pDashCancelableLib.pDashCancelableMod.CancelErrorClass
  ] = js.native
  def fn[ReturnType](userFn: js.Function1[/* repeated */ js.Any, js.Thenable[ReturnType]]): js.Function1[
    /* repeated */ js.Any, 
    pDashCancelableLib.pDashCancelableMod.PCancelable[ReturnType]
  ] = js.native
  ...
  ): js.Function0[pDashCancelableLib.pDashCancelableMod.PCancelable[ReturnType]] = js.native
}
