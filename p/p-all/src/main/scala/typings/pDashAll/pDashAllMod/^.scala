...
import typings.pDashAll.Anon_Default
...
object ^ extends js.Object {
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[TAll](tasks: Iterable[PromiseFactory[TAll]]): js.Promise[js.Array[TAll]] = js.native
  def default[TAll](tasks: Iterable[PromiseFactory[TAll]], options: Options): js.Promise[js.Array[TAll]] = js.native
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
