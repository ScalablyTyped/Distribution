package typings
package pDashAllLib.pDashAllMod
...
object ^ extends js.Object {
  ...
  @JSName("default")
  var default_Original: pDashAllLib.Anon_Default = js.native
  ...
  def apply[TAll](tasks: stdLib.Iterable[PromiseFactory[TAll]]): js.Promise[js.Array[TAll]] = js.native
  def apply[TAll](tasks: stdLib.Iterable[PromiseFactory[TAll]], options: Options): js.Promise[js.Array[TAll]] = js.native
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1](tasks: js.Array[PromiseFactory[Result1]]): js.Promise[js.Array[Result1]] = js.native
  def default[Result1](tasks: js.Array[PromiseFactory[Result1]], options: Options): js.Promise[js.Array[Result1]] = js.native
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[TAll](tasks: stdLib.Iterable[PromiseFactory[TAll]]): js.Promise[js.Array[TAll]] = js.native
  def default[TAll](tasks: stdLib.Iterable[PromiseFactory[TAll]], options: Options): js.Promise[js.Array[TAll]] = js.native
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2](tasks: js.Tuple2[PromiseFactory[Result1], PromiseFactory[Result2]]): js.Promise[js.Tuple2[Result1, Result2]] = js.native
  def default[Result1, Result2](tasks: js.Tuple2[PromiseFactory[Result1], PromiseFactory[Result2]], options: Options): js.Promise[js.Tuple2[Result1, Result2]] = js.native
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3](tasks: js.Tuple3[PromiseFactory[Result1], PromiseFactory[Result2], PromiseFactory[Result3]]): js.Promise[js.Tuple3[Result1, Result2, Result3]] = js.native
  def default[Result1, Result2, Result3](
    tasks: js.Tuple3[PromiseFactory[Result1], PromiseFactory[Result2], PromiseFactory[Result3]],
    options: Options
  ): js.Promise[js.Tuple3[Result1, Result2, Result3]] = js.native
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4](
    tasks: js.Tuple4[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5](
    tasks: js.Tuple5[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5, Result6](
    tasks: js.Tuple6[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5, Result6, Result7](
    tasks: js.Tuple7[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5, Result6, Result7, Result8](
    tasks: js.Tuple8[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5, Result6, Result7, Result8, Result9](
    tasks: js.Tuple9[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  // TODO: Remove this for the next major release, refactor the whole definition back to multiple overloaded functions
  def default[Result1, Result2, Result3, Result4, Result5, Result6, Result7, Result8, Result9, Result10](
    tasks: js.Tuple10[
      PromiseFactory[Result1], 
      PromiseFactory[Result2], 
      PromiseFactory[Result3], 
  ...
  @JSName("default")
  def default_TAll[TAll](tasks: js.Array[PromiseFactory[TAll]]): js.Promise[js.Array[TAll]] = js.native
  @JSName("default")
  def default_TAll[TAll](tasks: js.Array[PromiseFactory[TAll]], options: Options): js.Promise[js.Array[TAll]] = js.native
}
