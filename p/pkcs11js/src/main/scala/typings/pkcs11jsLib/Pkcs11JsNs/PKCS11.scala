...
class PKCS11 () extends js.Object {
  /**
    * Library path
    */
  var libPath: java.lang.String = js.native
  /**
    * Closes all sessions with a token
    *
    * @param {Handle} slot The token's slot
    */
  def C_CloseAllSessions(slot: Handle): scala.Unit = js.native
  /**
    * Closes a session between an application and a token
    *
    * @param {Handle} session The session's handle
    */
  def C_CloseSession(session: Handle): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def C_Decrypt(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    * Decrypts encrypted data in a single part
    *
    * @param {Handle} session Session's handle
  ...
  /**
    ...
    */
  def C_DecryptFinal(session: Handle, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    ...
    */
  def C_DecryptInit(session: Handle, mechanism: Mechanism, key: Handle): scala.Unit = js.native
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_DecryptUpdate(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
  ...
  /**
    ...
    * @param {Handle} object The object's handle
    */
  def C_DestroyObject(session: Handle, `object`: Handle): scala.Unit = js.native
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_Digest(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    * Digests data in a single part
    *
    * @param {Handle} session Session's handle
  ...
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_DigestFinal(session: Handle, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /* Message digesting */
  /**
    ...
    */
  def C_DigestInit(session: Handle, mechanism: Mechanism): scala.Unit = js.native
  /**
    ...
    * @param {Buffer} inData Incoming data
    */
  def C_DigestUpdate(session: Handle, inData: nodeLib.Buffer): scala.Unit = js.native
  /**
    ...
    * @returns {Buffer}
    */
  def C_Encrypt(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    * Encrypts single-part data
    *
    * @param {Handle} session Session's handle
  ...
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_EncryptFinal(session: Handle, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  //#endregion
  ...
  /**
    ...
    */
  def C_EncryptInit(session: Handle, mechanism: Mechanism, key: Handle): scala.Unit = js.native
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_EncryptUpdate(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    * Indicates that an application is done with the Cryptoki library
    */
  def C_Finalize(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param {Handle} session The session's handle
    */
  def C_FindObjectsFinal(session: Handle): scala.Unit = js.native
  /**
    ...
    */
  def C_FindObjectsInit(session: Handle, template: Template): scala.Unit = js.native
  // C_VerifyRecoverInit();
  // C_VerifyRecover();
  //#endregion
  ...
  /**
    ...
    */
  def C_GenerateRandom(session: Handle, buf: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
  ...
  /**
    ...
    */
  def C_GetMechanismInfo(slot: Handle, mech: scala.Double): MechanismInfo = js.native
  /**
    ...
    */
  def C_GetMechanismList(slot: Handle): js.Array[scala.Double] = js.native
  /**
    ...
    */
  def C_GetObjectSize(session: Handle, `object`: Handle): scala.Double = js.native
  /**
  ...
  def C_GetSlotList(tokenPresent: scala.Boolean): js.Array[Handle] = js.native
  /**
  ...
  /**
    ...
    */
  def C_InitPIN(session: Handle): scala.Unit = js.native
  def C_InitPIN(session: Handle, pin: java.lang.String): scala.Unit = js.native
  /**
    * Initializes a token
    *
    * @param {Handle} slot ID of the token's slot
    ...
    */
  def C_InitToken(slot: Handle): java.lang.String = js.native
  def C_InitToken(slot: Handle, pin: java.lang.String): java.lang.String = js.native
  def C_InitToken(slot: Handle, pin: java.lang.String, label: java.lang.String): java.lang.String = js.native
  /**
    ...
    */
  def C_Initialize(): scala.Unit = js.native
  def C_Initialize(options: InitializationOptions): scala.Unit = js.native
  /**
    ...
    */
  def C_Login(session: Handle, userType: scala.Double): scala.Unit = js.native
  def C_Login(session: Handle, userType: scala.Double, pin: java.lang.String): scala.Unit = js.native
  /**
    * Logs a user out from a token
    *
    * @param {Handle} session The session's handle
    */
  def C_Logout(session: Handle): scala.Unit = js.native
  //#endregion
  ...
  /**
    ...
    */
  def C_OpenSession(slot: Handle, flags: scala.Double): Handle = js.native
  /**
    ...
    */
  def C_SeedRandom(session: Handle, buf: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    ...
    */
  def C_SetAttributeValue(session: Handle, `object`: Handle, template: Template): scala.Unit = js.native
  /**
    ...
    */
  def C_SetPIN(session: Handle, oldPin: java.lang.String, newPin: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_Sign(session: Handle, inData: nodeLib.Buffer, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  /**
    * Signs (encrypts with private key) data in a single
    * part, where the signature is (will be) an appendix to the
    * data, and plaintext cannot be recovered from the signature
  ...
  /**
    ...
    * @returns {Buffer} Sliced coming data
    */
  def C_SignFinal(session: Handle, outData: nodeLib.Buffer): nodeLib.Buffer = js.native
  // C_DigestKey();
  //#endregion
  ...
  /**
    ...
    */
  def C_SignInit(session: Handle, mechanism: Mechanism, key: Handle): scala.Unit = js.native
  /**
    ...
    * @param {Buffer} inData Incoming data
    */
  def C_SignUpdate(session: Handle, inData: nodeLib.Buffer): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def C_Verify(session: Handle, inData: nodeLib.Buffer, signature: nodeLib.Buffer): scala.Boolean = js.native
  /**
    * Verifies a signature in a single-part operation,
    * where the signature is an appendix to the data, and plaintext
    * cannot be recovered from the signature
  ...
  /**
    ...
    * @returns {boolean}
    */
  def C_VerifyFinal(session: Handle, signature: nodeLib.Buffer): scala.Boolean = js.native
  // C_SignRecoverInit();
  // C_SignRecover();
  //#endregion
  ...
  /**
    ...
    */
  def C_VerifyInit(session: Handle, mechanism: Mechanism, key: Handle): scala.Unit = js.native
  /**
    ...
    * @param {Buffer} inData Incoming data
    */
  def C_VerifyUpdate(session: Handle, inData: nodeLib.Buffer): scala.Unit = js.native
  /**
