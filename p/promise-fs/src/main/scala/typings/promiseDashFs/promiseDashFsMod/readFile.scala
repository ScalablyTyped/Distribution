...
import typings.promiseDashFs.Anon_EncodingFlag
import typings.promiseDashFs.Anon_EncodingFlagNull
...
object readFile extends js.Object {
  ...
  def apply(
    path: Double,
    options: typings.node.Anon_EncodingFlagNull,
  ...
  def __promisify__(path: Double, options: typings.node.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  ...
  def __promisify__(path: PathLike, options: typings.node.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  /**
    * Asynchronously reads the entire contents of a file.
    * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
    * URL support is _experimental_.
