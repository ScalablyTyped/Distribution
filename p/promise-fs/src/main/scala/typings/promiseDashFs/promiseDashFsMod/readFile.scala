...
import typings.promiseDashFs.Anon_Encoding
...
object readFile extends js.Object {
  ...
  def apply(path: Double, options: typings.promiseDashFs.Anon_EncodingFlag): js.Promise[String] = js.native
  def apply(path: Double, options: typings.promiseDashFs.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
  ...
  def apply(path: PathLike, options: typings.promiseDashFs.Anon_EncodingFlag): js.Promise[String] = js.native
  def apply(path: PathLike, options: typings.promiseDashFs.Anon_EncodingFlagNull): js.Promise[String | Buffer] = js.native
