...
import typings.promiseFs.Anon0
import typings.promiseFs.Anon1
...
object readlink extends js.Object {
  ...
  def apply(path: PathLike, options: typings.promiseFs.Anon2): js.Promise[String | Buffer] = js.native
