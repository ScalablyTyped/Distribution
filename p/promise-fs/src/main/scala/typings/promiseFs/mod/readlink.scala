...
object readlink extends js.Object {
  ...
  def apply(path: PathLike, options: AnonBuffer): js.Promise[Buffer] = js.native
  def apply(path: PathLike, options: typings.promiseFs.AnonEncodingBufferEncoding): js.Promise[String] = js.native
  def apply(path: PathLike, options: typings.promiseFs.AnonEncodingNull): js.Promise[String | Buffer] = js.native
