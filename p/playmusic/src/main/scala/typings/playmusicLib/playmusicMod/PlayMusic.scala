...
trait PlayMusic extends js.Object {
  ...
  def addPlayList(
    ...
    callback: js.Function2[/* error */ stdLib.Error, /* mutateResponses */ MutateResponses, scala.Unit]
  ...
  def changeTrackMetadata(
    song: js.Any,
    callback: js.Function2[/* error */ stdLib.Error, /* success */ MutateResponses, scala.Unit]
  ): scala.Unit = js.native
  /**
    * Deletes a playlist
    *
  ...
  def deletePlaylist(
    playlistId: java.lang.String,
    callback: js.Function2[/* error */ stdLib.Error, /* mutationStatus */ MutateResponses, scala.Unit]
  ): scala.Unit = js.native
  /**
    ...
    */
  def getLibrary(callback: js.Function2[/* error */ stdLib.Error, /* response */ LibraryResponse, scala.Unit]): scala.Unit = js.native
  /**
    * Returns list of all tracks.
    *
  ...
  def getLibrary(
    ...
    callback: js.Function2[/* error */ stdLib.Error, /* response */ LibraryResponse, scala.Unit]
  ): scala.Unit = js.native
  /**
    ...
    * @param callback function(error, response) - success callback
    */
  def getPlayListEntries(callback: js.Function2[/* error */ stdLib.Error, /* response */ PlaylistResponse, scala.Unit]): scala.Unit = js.native
  /**
    * Returns tracks on all playlists.
    *
    * @param options object - parameters
  ...
  def getPlayListEntries(
    ...
    callback: js.Function2[/* error */ stdLib.Error, /* response */ PlaylistResponse, scala.Unit]
  ): scala.Unit = js.native
  /**
    ...
    */
  def getPlayLists(callback: js.Function2[/* error */ stdLib.Error, /* response */ PlaylistListResponse, scala.Unit]): scala.Unit = js.native
  /**
    * Returns settings / device ids authorized for account.
    *
    * @param callback function(error, response) - success callback
    */
  def getSettings(callback: js.Function2[/* error */ stdLib.Error, /* response */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
  ...
  def getStream(
    id: java.lang.String,
    callback: js.Function2[/* error */ stdLib.Error, /* stream */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def getStreamUrl(
    id: java.lang.String,
    callback: js.Function2[/* error */ stdLib.Error, /* streamUrl */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def init(options: InitOptions, callback: js.Function1[/* error */ stdLib.Error, scala.Unit]): scala.Unit = js.native
  def login(
    options: LoginOptions,
    callback: js.Function2[/* error */ stdLib.Error, /* response */ LoginResponse, scala.Unit]
  ): scala.Unit = js.native
  /**
  ...
  def search(
    ...
    callback: js.Function2[/* error */ stdLib.Error, /* searchResults */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  /**
