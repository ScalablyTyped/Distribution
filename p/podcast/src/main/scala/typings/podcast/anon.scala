...
object anon {
  ...
  object FeedUrl_ {
    ...
    @scala.inline
    implicit class FeedUrl_MutableBuilder[Self <: FeedUrl_] (val x: Self) extends AnyVal {
  ...
  object Feedurl {
    ...
    @scala.inline
    implicit class FeedurlMutableBuilder[Self <: Feedurl] (val x: Self) extends AnyVal {
  ...
  object ImageUrl_ {
    ...
    @scala.inline
    implicit class ImageUrl_MutableBuilder[Self <: ImageUrl_] (val x: Self) extends AnyVal {
  ...
  object SiteUrl_ {
    ...
    @scala.inline
    implicit class SiteUrl_MutableBuilder[Self <: SiteUrl_] (val x: Self) extends AnyVal {
  ...
  object Siteurl {
    ...
    @scala.inline
    implicit class SiteurlMutableBuilder[Self <: Siteurl] (val x: Self) extends AnyVal {
