...
object ^ extends js.Object {
  ...
  def isChecked(element: protractorDashHelpersLib.protractorDashHelpersMod.Global.protractorNs.ElementFinder): js.Any = js.native
  def isDisabled(element: protractorDashHelpersLib.protractorDashHelpersMod.Global.protractorNs.ElementFinder): js.Any = js.native
  ...
  def translate(translationId: java.lang.String): js.Any = js.native
  def translate(translationId: java.lang.String, interpolateParams: js.Any): js.Any = js.native
  def translate(translationId: js.Array[java.lang.String]): js.Any = js.native
  def translate(translationId: js.Array[java.lang.String], interpolateParams: js.Any): js.Any = js.native
