...
package object parsimmonMod {
  ...
  type Language = org.scalablytyped.runtime.StringDictionary[Parser[js.Any]]
  type ParseFunctionType[U] = js.Function2[/* stream */ StreamType, /* index */ scala.Double, Reply[U]]
  type Rule = org.scalablytyped.runtime.StringDictionary[js.Function1[/* r */ Language, Parser[js.Any]]]
