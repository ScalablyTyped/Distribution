...
object ^ extends js.Object {
  ...
  /**
  	 ...
  	 */
  def Parser[T](fn: js.Function2[/* input */ String, /* i */ Double, Reply[T]]): typings.parsimmon.parsimmonMod.Parser[T] = js.native
  ...
  def lookahead(arg: String): Parser[Empty] = js.native
  /**
  	 * Parses using arg, but does not consume what it parses. Yields an empty string.
  	 */
  def lookahead(arg: Parser[_]): Parser[Empty] = js.native
  def lookahead(arg: RegExp): Parser[Empty] = js.native
  /**
