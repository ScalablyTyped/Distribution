...
/* RemoveMultipleInheritance: Dropped parents List(postmanDashCollectionLib.postmanDashCollectionMod.HeaderDefinition because Would inherit conflicting mutable fields List(description, name, disabled, id))*/
