...
class UrlMatchPattern protected () extends js.Object {
  ...
  def createMatchPattern(): js.UndefOr[postmanDashCollectionLib.Anon_Protocols] = js.native
  ...
  def matchAbsoluteHostPattern(matchRegexObject: postmanDashCollectionLib.Anon_Protocols, remote: java.lang.String): scala.Boolean = js.native
  def matchAnyHost(matchRegexObject: postmanDashCollectionLib.Anon_Protocols): scala.Boolean = js.native
  def matchSuffixHostPattern(matchRegexObject: postmanDashCollectionLib.Anon_Protocols, remote: java.lang.String): scala.Boolean = js.native
