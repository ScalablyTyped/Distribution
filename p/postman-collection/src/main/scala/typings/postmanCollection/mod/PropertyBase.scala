...
import typings.postmanCollection.AnonInfo
import typings.postmanCollection.AnonWithRoot
...
class PropertyBase[TDefinition /* <: js.Object */] () extends PropertyBaseDefinition {
  ...
  def this(definition: AnonInfo) = this()
  ...
  def forEachParent(options: AnonWithRoot, iterator: js.Function1[/* item */ js.Any, Unit]): Unit = js.native
