...
object mod {
  ...
  */
  ...
  type FindProxyForURLCallback = js.Function2[/* err */ js.UndefOr[Error | Null], /* result */ js.UndefOr[String], Unit]
  
  type GMT = typings.pacResolver.pacResolverStrings.GMT
  
  /* Rewritten from type alias, can be one of: 
    - typings.pacResolver.pacResolverNumbers.`0`
    - typings.pacResolver.pacResolverNumbers.`1`
    - typings.pacResolver.pacResolverNumbers.`2`
    - typings.pacResolver.pacResolverNumbers.`3`
    - typings.pacResolver.pacResolverNumbers.`4`
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.pacResolver.pacResolverStrings.JAN
    - typings.pacResolver.pacResolverStrings.FEB
    - typings.pacResolver.pacResolverStrings.MAR
    - typings.pacResolver.pacResolverStrings.APR
    - typings.pacResolver.pacResolverStrings.MAY
    - typings.pacResolver.pacResolverStrings.JUN
    - typings.pacResolver.pacResolverStrings.JUL
    - typings.pacResolver.pacResolverStrings.AUG
    - typings.pacResolver.pacResolverStrings.SEP
    - typings.pacResolver.pacResolverStrings.OCT
    - typings.pacResolver.pacResolverStrings.NOV
    - typings.pacResolver.pacResolverStrings.DEC
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.pacResolver.pacResolverStrings.SUN
    - typings.pacResolver.pacResolverStrings.MON
    - typings.pacResolver.pacResolverStrings.TUE
    - typings.pacResolver.pacResolverStrings.WED
    - typings.pacResolver.pacResolverStrings.THU
    - typings.pacResolver.pacResolverStrings.FRI
    - typings.pacResolver.pacResolverStrings.SAT
  */
