...
object global {
  ...
  object ZalgoPromise {
    ...
    open class ZalgoPromise[R] ()
      extends typings.zalgoPromise.mod.ZalgoPromise[R] {
    ...
    object ZalgoPromise {
      ...
      inline def try_YA_ArrayAny[Y, A /* <: js.Array[Any] */](method: js.Function1[/* args */ A, Y]): typings.zalgoPromise.promiseMod.ZalgoPromise[Y] = ^.asInstanceOf[js.Dynamic].applyDynamic("try")(method.asInstanceOf[js.Any]).asInstanceOf[typings.zalgoPromise.promiseMod.ZalgoPromise[Y]]
      inline def try_YA_ArrayAny[Y, A /* <: js.Array[Any] */](method: js.Function1[/* args */ A, Y], context: Any): typings.zalgoPromise.promiseMod.ZalgoPromise[Y] = (^.asInstanceOf[js.Dynamic].applyDynamic("try")(method.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[typings.zalgoPromise.promiseMod.ZalgoPromise[Y]]
      inline def try_YA_ArrayAny[Y, A /* <: js.Array[Any] */](method: js.Function1[/* args */ A, Y], context: Any, args: Partial[A]): typings.zalgoPromise.promiseMod.ZalgoPromise[Y] = (^.asInstanceOf[js.Dynamic].applyDynamic("try")(method.asInstanceOf[js.Any], context.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typings.zalgoPromise.promiseMod.ZalgoPromise[Y]]
      inline def try_YA_ArrayAny[Y, A /* <: js.Array[Any] */](method: js.Function1[/* args */ A, Y], context: Unit, args: Partial[A]): typings.zalgoPromise.promiseMod.ZalgoPromise[Y] = (^.asInstanceOf[js.Dynamic].applyDynamic("try")(method.asInstanceOf[js.Any], context.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typings.zalgoPromise.promiseMod.ZalgoPromise[Y]]
    }
  }
}
