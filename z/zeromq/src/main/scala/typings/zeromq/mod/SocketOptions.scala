...
object SocketOptions {
  ...
  implicit class SocketOptionsOps[Self <: SocketOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurve_publickey(value: Double): Self = this.set("curve_publickey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurve_secretkey(value: Double): Self = this.set("curve_secretkey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurve_server(value: Double): Self = this.set("curve_server", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setCurve_serverkey(value: Double): Self = this.set("curve_serverkey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPlain_password(value: Double): Self = this.set("plain_password", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlain_server(value: Double): Self = this.set("plain_server", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPlain_username(value: Double): Self = this.set("plain_username", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setZap_domain(value: Double): Self = this.set("zap_domain", value.asInstanceOf[js.Any])
  }
}
