...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthItems extends js.Object {
  /**
  ...
  var items: js.UndefOr[js.Array[AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle]] = js.undefined
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthItems {
  @scala.inline
  def apply(
    ...
    items: js.Array[AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle] = null,
    `line-style`: String = null,
    size: Int | Double = null
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthItems = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthItems]
  }
}
