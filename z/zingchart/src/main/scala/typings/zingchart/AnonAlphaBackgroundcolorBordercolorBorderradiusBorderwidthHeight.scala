...
trait AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight]
  }
}
