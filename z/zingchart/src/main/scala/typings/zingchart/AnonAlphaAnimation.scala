...
trait AnonAlphaAnimation extends js.Object {
  /**
  ...
  var goal: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight] = js.undefined
  /**
  ...
  var `highlight-marker`: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor] = js.undefined
  ...
  var trend: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth] = js.undefined
  /**
  ...
  var `value-box`: js.UndefOr[
    AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBorderalpha
  ] = js.undefined
  /**
...
object AnonAlphaAnimation {
  ...
  def apply(
    ...
    goal: AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthHeight = null,
    goals: js.Any = null,
    ...
    `highlight-marker`: AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor = null,
    ...
    trend: AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth = null,
    url: String = null,
    `value-box`: AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBorderalpha = null,
    ...
    __obj.asInstanceOf[AnonAlphaAnimation]
  }
}
