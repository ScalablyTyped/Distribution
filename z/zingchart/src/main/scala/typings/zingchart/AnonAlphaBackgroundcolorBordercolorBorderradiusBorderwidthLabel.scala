...
trait AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthLabel extends js.Object {
  /**
  ...
  var label: js.UndefOr[AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth] = js.undefined
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthLabel {
  @scala.inline
  def apply(
    ...
    label: AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth = null,
    ...
    range: js.Any = null,
    `type`: String = null
  ): AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthLabel = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthLabel]
  }
}
