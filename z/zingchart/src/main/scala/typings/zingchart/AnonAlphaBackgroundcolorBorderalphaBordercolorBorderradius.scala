...
trait AnonAlphaBackgroundcolorBorderalphaBordercolorBorderradius extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderalphaBordercolorBorderradius {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBorderalphaBordercolorBorderradius = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderalphaBordercolorBorderradius]
  }
}
