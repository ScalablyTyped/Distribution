...
trait AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundfit extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundfit {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundfit = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundfit]
  }
}
