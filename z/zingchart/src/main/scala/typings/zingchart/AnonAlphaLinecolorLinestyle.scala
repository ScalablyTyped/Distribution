...
trait AnonAlphaLinecolorLinestyle extends js.Object {
  /**
...
object AnonAlphaLinecolorLinestyle {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinestyle]
  }
}
