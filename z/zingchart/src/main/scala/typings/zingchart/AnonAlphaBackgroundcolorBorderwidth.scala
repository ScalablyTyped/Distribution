...
trait AnonAlphaBackgroundcolorBorderwidth extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderwidth {
  @scala.inline
  def apply(
    ...
    x: js.Any = null,
    y: js.Any = null
  ): AnonAlphaBackgroundcolorBorderwidth = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderwidth]
  }
}
