...
trait AnonAlphaLinecolorLinestyleLinewidthVisibleAny extends js.Object {
  /**
...
object AnonAlphaLinecolorLinestyleLinewidthVisibleAny {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaLinecolorLinestyleLinewidthVisibleAny = {
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinestyleLinewidthVisibleAny]
  }
}
