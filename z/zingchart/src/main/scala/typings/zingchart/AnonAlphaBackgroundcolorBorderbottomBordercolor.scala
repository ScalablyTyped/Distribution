...
trait AnonAlphaBackgroundcolorBorderbottomBordercolor extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderbottomBordercolor {
  @scala.inline
  def apply(
    ...
    height: js.Any = null,
    width: js.Any = null
  ): AnonAlphaBackgroundcolorBorderbottomBordercolor = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderbottomBordercolor]
  }
}
