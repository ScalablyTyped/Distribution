...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthLabel extends js.Object {
  /**
  ...
  var label: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily] = js.undefined
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthLabel {
  @scala.inline
  def apply(
    ...
    label: AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily = null,
    `preserve-zoom`: js.UndefOr[Boolean] = js.undefined
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthLabel = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthLabel]
  }
}
