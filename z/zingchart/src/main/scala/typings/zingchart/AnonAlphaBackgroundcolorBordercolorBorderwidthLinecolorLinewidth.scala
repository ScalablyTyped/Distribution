...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolorLinewidth]
  }
}
