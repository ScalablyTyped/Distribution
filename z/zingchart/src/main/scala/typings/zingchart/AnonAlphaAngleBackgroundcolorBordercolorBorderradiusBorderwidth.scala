...
trait AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidth]
  }
}
