...
trait AnonAlphaLinecolorLinestyleLinewidthNumber extends js.Object {
  /**
...
object AnonAlphaLinecolorLinestyleLinewidthNumber {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaLinecolorLinestyleLinewidthNumber = {
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinestyleLinewidthNumber]
  }
}
