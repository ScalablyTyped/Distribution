...
trait AnonAlphaBackgroundcolorBordercolorBorderradius extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderradius {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderradius = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderradius]
  }
}
