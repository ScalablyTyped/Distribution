...
trait AnonAlphaBackgroundcolorBorderbottomBorderleft extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderbottomBorderleft {
  @scala.inline
  def apply(
    ...
    height: js.Any = null,
    width: js.Any = null
  ): AnonAlphaBackgroundcolorBorderbottomBorderleft = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderbottomBorderleft]
  }
}
