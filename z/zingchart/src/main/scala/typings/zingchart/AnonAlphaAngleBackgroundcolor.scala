...
trait AnonAlphaAngleBackgroundcolor extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolor {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolor]
  }
}
