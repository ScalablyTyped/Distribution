...
trait AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidth extends js.Object {
  /**
  ...
  var `hover-state`: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderradius] = js.undefined
  /**
  ...
  var tooltip: js.UndefOr[AnonAlphaBackgroundcolorBorderalphaBordercolor] = js.undefined
}

object AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidth {
  @scala.inline
  def apply(
    ...
    `hover-state`: AnonAlphaBackgroundcolorBordercolorBorderradius = null,
    `line-style`: String = null,
    padding: Int | Double = null,
    `text-alpha`: Int | Double = null,
    tooltip: AnonAlphaBackgroundcolorBorderalphaBordercolor = null
  ): AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidth = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidth]
  }
}
