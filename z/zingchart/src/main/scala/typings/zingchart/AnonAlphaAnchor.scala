...
trait AnonAlphaAnchor extends js.Object {
  /**
  ...
  var `callout-tip`: js.UndefOr[AnonAlphaBackgroundcolorBordercolor] = js.undefined
  /**
...
object AnonAlphaAnchor {
  ...
  def apply(
    ...
    `callout-tip`: AnonAlphaBackgroundcolorBordercolor = null,
    ...
    if (`callout-tip` != null) __obj.updateDynamic("callout-tip")(`callout-tip`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonAlphaAnchor]
  }
}
