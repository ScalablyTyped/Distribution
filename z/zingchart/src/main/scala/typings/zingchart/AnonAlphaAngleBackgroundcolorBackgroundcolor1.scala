...
trait AnonAlphaAngleBackgroundcolorBackgroundcolor1 extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBackgroundcolor1 {
  @scala.inline
  def apply(
    ...
    x: js.Any = null,
    y: js.Any = null
  ): AnonAlphaAngleBackgroundcolorBackgroundcolor1 = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBackgroundcolor1]
  }
}
