...
trait AnonAlphaLinecolorLinegapsizeLinesegmentsizeLinestyleLinewidth extends js.Object {
  /**
...
object AnonAlphaLinecolorLinegapsizeLinesegmentsizeLinestyleLinewidth {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaLinecolorLinegapsizeLinesegmentsizeLinestyleLinewidth = {
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinegapsizeLinesegmentsizeLinestyleLinewidth]
  }
}
