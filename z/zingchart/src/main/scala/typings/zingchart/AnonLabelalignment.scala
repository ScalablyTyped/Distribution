...
trait AnonLabelalignment extends js.Object {
  /**
  ...
  var label: js.UndefOr[AnonTextalpha] = js.undefined
  /**
...
object AnonLabelalignment {
  ...
  def apply(
    ...
    label: AnonTextalpha = null,
    `label-alignment`: String = null,
    `label-placement`: String = null,
    ...
    `type`: String = null,
    `value-range`: js.UndefOr[Boolean] = js.undefined,
    ...
    if (`label-alignment` != null) __obj.updateDynamic("label-alignment")(`label-alignment`.asInstanceOf[js.Any])
    if (`label-placement` != null) __obj.updateDynamic("label-placement")(`label-placement`.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`value-range`)) __obj.updateDynamic("value-range")(`value-range`.asInstanceOf[js.Any])
    if (!js.isUndefined(visible)) __obj.updateDynamic("visible")(visible.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonLabelalignment]
  }
}
