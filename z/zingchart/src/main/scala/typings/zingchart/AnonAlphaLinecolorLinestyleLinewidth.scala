...
trait AnonAlphaLinecolorLinestyleLinewidth extends js.Object {
  /**
...
object AnonAlphaLinecolorLinestyleLinewidth {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaLinecolorLinestyleLinewidth = {
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinestyleLinewidth]
  }
}
