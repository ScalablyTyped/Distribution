...
trait AnonAlphaBackgroundcolorBorderalphaBordercolor extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderalphaBordercolor {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBorderalphaBordercolor = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderalphaBordercolor]
  }
}
