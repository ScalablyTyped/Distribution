...
trait AnonAlphaLinecolorLinegapsize extends js.Object {
  /**
...
object AnonAlphaLinecolorLinegapsize {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinegapsize]
  }
}
