...
trait AnonAlphaBackgroundcolorBorderbottom extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderbottom {
  @scala.inline
  def apply(
    ...
    width: js.Any = null
  ): AnonAlphaBackgroundcolorBorderbottom = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderbottom]
  }
}
