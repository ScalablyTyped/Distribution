...
trait AnonAdjustlayoutAlphaBackgroundcolor extends js.Object {
  /**
...
object AnonAdjustlayoutAlphaBackgroundcolor {
  @scala.inline
  def apply(
  ...
  ): AnonAdjustlayoutAlphaBackgroundcolor = {
    ...
    __obj.asInstanceOf[AnonAdjustlayoutAlphaBackgroundcolor]
  }
}
