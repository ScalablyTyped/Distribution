...
trait AnonAlphaAsync extends js.Object {
  /**
  ...
  var tooltip: js.UndefOr[AnonAlphaAngle] = js.undefined
}

object AnonAlphaAsync {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaAsync]
  }
}
