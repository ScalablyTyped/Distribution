...
trait AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundposition extends js.Object {
  /**
  ...
  var `highlight-state`: js.UndefOr[AnonAlphaBackgroundcolorBordercolorBorderwidth] = js.undefined
  /**
...
object AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundposition {
  @scala.inline
  def apply(
    ...
    `highlight-state`: AnonAlphaBackgroundcolorBordercolorBorderwidth = null,
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundposition]
  }
}
