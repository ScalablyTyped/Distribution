...
trait AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundimage extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundimage {
  @scala.inline
  def apply(
    ...
    x: js.Any = null,
    y: js.Any = null
  ): AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundimage = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2Backgroundimage]
  }
}
