...
trait AnonAlphaAngleAngleend extends js.Object {
  /**
...
object AnonAlphaAngleAngleend {
  @scala.inline
  def apply(
    alpha: Int | Double = null,
    angle: Int | Double = null,
    `angle-end`: Int | Double = null,
    `angle-start`: Int | Double = null,
  ...
  ): AnonAlphaAngleAngleend = {
    val __obj = js.Dynamic.literal()
    if (alpha != null) __obj.updateDynamic("alpha")(alpha.asInstanceOf[js.Any])
    if (angle != null) __obj.updateDynamic("angle")(angle.asInstanceOf[js.Any])
    if (`angle-end` != null) __obj.updateDynamic("angle-end")(`angle-end`.asInstanceOf[js.Any])
    if (`angle-start` != null) __obj.updateDynamic("angle-start")(`angle-start`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonAlphaAngleAngleend]
  }
}
