...
trait AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBoldBorderbottom extends js.Object {
  /**
  ...
  /**
    ...
    */
  var `lock-rotation`: js.UndefOr[Boolean] = js.undefined
  /**
...
object AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBoldBorderbottom {
  @scala.inline
  def apply(
    ...
    `lock-rotation`: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(`lock-rotation`)) __obj.updateDynamic("lock-rotation")(`lock-rotation`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBoldBorderbottom]
  }
}
