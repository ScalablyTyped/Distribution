...
trait AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor {
  @scala.inline
  def apply(
    ...
    text: String = null
  ): AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor]
  }
}
