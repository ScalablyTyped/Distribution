...
trait AnonAlphaBackgroundcolorBorderradius extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBorderradius {
  @scala.inline
  def apply(
    ...
    height: js.Any = null,
    width: js.Any = null
  ): AnonAlphaBackgroundcolorBorderradius = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBorderradius]
  }
}
