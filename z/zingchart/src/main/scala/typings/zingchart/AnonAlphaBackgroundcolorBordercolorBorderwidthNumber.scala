...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthNumber extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthNumber {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthNumber = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthNumber]
  }
}
