...
trait AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBordercolorBorderradiusBorderwidthFontcolor]
  }
}
