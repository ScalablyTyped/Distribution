...
trait AnonAlphaAngleBackgroundcolorBordercolor extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBordercolor {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaAngleBackgroundcolorBordercolor = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBordercolor]
  }
}
