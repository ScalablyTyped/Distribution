...
object Fillangle {
  ...
  inline def apply(): Fillangle = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Fillangle]
  }
  
  extension [Self <: Fillangle](x: Self) {
    ...
    inline def `setHighlight-state`(value: Borderwidth): Self = StObject.set(x, "highlight-state", value.asInstanceOf[js.Any])
