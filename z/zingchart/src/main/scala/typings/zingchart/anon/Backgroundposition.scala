...
@js.native
trait Backgroundposition extends js.Object {
...
object Backgroundposition {
  ...
  @scala.inline
  def apply(): Backgroundposition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Backgroundposition]
  }
  
  @scala.inline
  implicit class BackgroundpositionOps[Self <: Backgroundposition] (val x: Self) extends AnyVal {
