...
trait BorderRadius_ extends StObject {
...
object BorderRadius_ {
  
  inline def apply(): BorderRadius_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BorderRadius_]
  }
  
  extension [Self <: BorderRadius_](x: Self) {
