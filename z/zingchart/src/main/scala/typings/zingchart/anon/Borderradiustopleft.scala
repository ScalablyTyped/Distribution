...
@js.native
trait Borderradiustopleft extends js.Object {
...
object Borderradiustopleft {
  ...
  @scala.inline
  implicit class BorderradiustopleftOps[Self <: Borderradiustopleft] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setLock-rotation`(value: Boolean): Self = this.set("lock-rotation", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `deleteLock-rotation`: Self = this.set("lock-rotation", js.undefined)
