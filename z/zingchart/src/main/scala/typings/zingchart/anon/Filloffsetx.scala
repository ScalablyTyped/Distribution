...
@js.native
trait Filloffsetx extends StObject {
...
object Filloffsetx {
  ...
  @scala.inline
  def apply(): Filloffsetx = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Filloffsetx]
  }
  
  @scala.inline
  implicit class FilloffsetxMutableBuilder[Self <: Filloffsetx] (val x: Self) extends AnyVal {
