...
trait BackgroundColor2_ extends StObject {
  ...
  var items: js.UndefOr[js.Array[AlphaBackgroundColor_]] = js.undefined
...
object BackgroundColor2_ {
  
  inline def apply(): BackgroundColor2_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundColor2_]
  }
  
  extension [Self <: BackgroundColor2_](x: Self) {
    ...
    inline def setItems(value: js.Array[AlphaBackgroundColor_]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: AlphaBackgroundColor_ *): Self = StObject.set(x, "items", js.Array(value*))
