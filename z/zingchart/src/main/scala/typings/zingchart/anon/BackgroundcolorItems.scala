...
@js.native
trait BackgroundcolorItems extends js.Object {
...
object BackgroundcolorItems {
  ...
  @scala.inline
  implicit class BackgroundcolorItemsOps[Self <: BackgroundcolorItems] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsVarargs(value: `0`*): Self = this.set("items", js.Array(value :_*))
    
    @scala.inline
    def setItems(value: js.Array[`0`]): Self = this.set("items", value.asInstanceOf[js.Any])
