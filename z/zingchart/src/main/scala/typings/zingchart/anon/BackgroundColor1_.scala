...
trait BackgroundColor1_ extends StObject {
...
object BackgroundColor1_ {
  
  inline def apply(): BackgroundColor1_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundColor1_]
  }
  
  extension [Self <: BackgroundColor1_](x: Self) {
