...
trait BackgroundFit_ extends StObject {
...
object BackgroundFit_ {
  
  inline def apply(): BackgroundFit_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundFit_]
  }
  
  extension [Self <: BackgroundFit_](x: Self) {
