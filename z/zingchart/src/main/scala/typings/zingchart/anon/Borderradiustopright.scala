...
@js.native
trait Borderradiustopright extends StObject {
...
object Borderradiustopright {
  ...
  @scala.inline
  def apply(): Borderradiustopright = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Borderradiustopright]
  }
  
  @scala.inline
  implicit class BorderradiustoprightMutableBuilder[Self <: Borderradiustopright] (val x: Self) extends AnyVal {
