...
trait BackgroundPosition_ extends StObject {
...
object BackgroundPosition_ {
  
  inline def apply(): BackgroundPosition_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackgroundPosition_]
  }
  
  extension [Self <: BackgroundPosition_](x: Self) {
