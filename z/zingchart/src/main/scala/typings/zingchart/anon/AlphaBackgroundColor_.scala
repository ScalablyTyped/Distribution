...
trait AlphaBackgroundColor_ extends StObject {
...
object AlphaBackgroundColor_ {
  
  inline def apply(): AlphaBackgroundColor_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AlphaBackgroundColor_]
  }
  
  extension [Self <: AlphaBackgroundColor_](x: Self) {
