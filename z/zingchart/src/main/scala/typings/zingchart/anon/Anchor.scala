...
trait Anchor extends StObject {
  ...
  var `callout-tip`: js.UndefOr[Bordercolor] = js.undefined
...
object Anchor {
  ...
  extension [Self <: Anchor](x: Self) {
    ...
    inline def `setCallout-tip`(value: Bordercolor): Self = StObject.set(x, "callout-tip", value.asInstanceOf[js.Any])
    
    inline def `setCallout-tipUndefined`: Self = StObject.set(x, "callout-tip", js.undefined)
