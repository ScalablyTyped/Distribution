...
object Anchor {
  ...
  implicit class AnchorMutableBuilder[Self <: Anchor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setCallout-tip`(value: Bordercolor): Self = StObject.set(x, "callout-tip", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setCallout-tipUndefined`: Self = StObject.set(x, "callout-tip", js.undefined)
