...
@js.native
trait Borderleft extends js.Object {
  /**
...
object Borderleft {
  ...
  def apply(): Borderleft = {
    ...
    __obj.asInstanceOf[Borderleft]
  }
  @scala.inline
  implicit class BorderleftOps[Self <: Borderleft] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `setShow-marker`(value: Boolean): Self = this.set("show-marker", value.asInstanceOf[js.Any])
    @scala.inline
    def `deleteShow-marker`: Self = this.set("show-marker", js.undefined)
    @scala.inline
