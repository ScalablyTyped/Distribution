...
object Borderleft {
  ...
  @scala.inline
  implicit class BorderleftMutableBuilder[Self <: Borderleft] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setShow-marker`(value: Boolean): Self = StObject.set(x, "show-marker", value.asInstanceOf[js.Any])
    
    @scala.inline
    def `setShow-markerUndefined`: Self = StObject.set(x, "show-marker", js.undefined)
