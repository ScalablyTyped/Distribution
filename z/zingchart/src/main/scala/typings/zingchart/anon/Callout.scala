...
trait Callout extends js.Object {
  ...
  var connector: js.UndefOr[AlphaLinecolor] = js.native
  /**
  ...
  var joined: js.UndefOr[Padding] = js.native
  /**
  ...
  var shared: js.UndefOr[Padding] = js.native
  /**
...
object Callout {
  ...
  implicit class CalloutOps[Self <: Callout] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConnector(value: AlphaLinecolor): Self = this.set("connector", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setJoined(value: Padding): Self = this.set("joined", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setShared(value: Padding): Self = this.set("shared", value.asInstanceOf[js.Any])
    @scala.inline
