...
object Hoverstate {
  ...
  extension [Self <: Hoverstate](x: Self) {
    ...
    inline def `setHover-state`(value: Linestyle): Self = StObject.set(x, "hover-state", value.asInstanceOf[js.Any])
    ...
    inline def setTooltip(value: Fontangle): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
