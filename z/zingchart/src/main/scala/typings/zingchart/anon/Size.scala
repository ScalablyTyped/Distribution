...
trait Size extends StObject {
  ...
  var items: js.UndefOr[js.Array[Linestyle]] = js.undefined
...
object Size {
  ...
  extension [Self <: Size](x: Self) {
    ...
    inline def setItems(value: js.Array[Linestyle]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Linestyle*): Self = StObject.set(x, "items", js.Array(value*))
