...
object Borderradiusbottomright {
  ...
  def apply(
    ...
    `mask-tolerance`: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(`mask-tolerance`)) __obj.updateDynamic("mask-tolerance")(`mask-tolerance`.get.asInstanceOf[js.Any])
