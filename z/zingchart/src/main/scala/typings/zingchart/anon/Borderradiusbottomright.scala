...
object Borderradiusbottomright {
  ...
  inline def apply(): Borderradiusbottomright = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Borderradiusbottomright]
  }
  
  extension [Self <: Borderradiusbottomright](x: Self) {
    ...
    inline def `setMargin-bottom-offset`(value: js.Any): Self = StObject.set(x, "margin-bottom-offset", value.asInstanceOf[js.Any])
    ...
    inline def `setMargin-left-offset`(value: js.Any): Self = StObject.set(x, "margin-left-offset", value.asInstanceOf[js.Any])
    ...
    inline def `setMargin-right-offset`(value: js.Any): Self = StObject.set(x, "margin-right-offset", value.asInstanceOf[js.Any])
    ...
    inline def `setMargin-top-offset`(value: js.Any): Self = StObject.set(x, "margin-top-offset", value.asInstanceOf[js.Any])
