...
trait AnonAlphaAngleBackgroundcolorBordercolorBorderradius extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBordercolorBorderradius {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaAngleBackgroundcolorBordercolorBorderradius = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBordercolorBorderradius]
  }
}
