...
trait AnonBarHandle extends js.Object {
  var bar: js.UndefOr[AnonAlphaBackgroundcolorBorderradius] = js.undefined
  var handle: js.UndefOr[AnonAlphaBackgroundcolorBorderbottomBorderleft] = js.undefined
  /**
...
object AnonBarHandle {
  @scala.inline
  def apply(
    bar: AnonAlphaBackgroundcolorBorderradius = null,
    handle: AnonAlphaBackgroundcolorBorderbottomBorderleft = null,
    ...
    __obj.asInstanceOf[AnonBarHandle]
  }
}
