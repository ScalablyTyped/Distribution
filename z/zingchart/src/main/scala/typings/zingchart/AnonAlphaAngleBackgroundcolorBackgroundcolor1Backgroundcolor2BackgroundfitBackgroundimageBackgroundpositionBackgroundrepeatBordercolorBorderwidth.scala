...
trait AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBordercolorBorderwidth extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBordercolorBorderwidth {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBackgroundcolor1Backgroundcolor2BackgroundfitBackgroundimageBackgroundpositionBackgroundrepeatBordercolorBorderwidth]
  }
}
