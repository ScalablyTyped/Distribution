...
trait AnonAlphaBackgroundcolorBordercolor extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolor {
  @scala.inline
  def apply(
    ...
    `type`: String = null
  ): AnonAlphaBackgroundcolorBordercolor = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolor]
  }
}
