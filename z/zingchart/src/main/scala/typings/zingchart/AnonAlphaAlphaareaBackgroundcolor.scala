...
trait AnonAlphaAlphaareaBackgroundcolor extends js.Object {
  /**
...
object AnonAlphaAlphaareaBackgroundcolor {
  @scala.inline
  def apply(
    ...
    `type`: String = null
  ): AnonAlphaAlphaareaBackgroundcolor = {
    ...
    __obj.asInstanceOf[AnonAlphaAlphaareaBackgroundcolor]
  }
}
