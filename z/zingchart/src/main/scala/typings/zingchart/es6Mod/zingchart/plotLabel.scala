...
trait plotLabel extends StObject {
  ...
  var clipText: js.UndefOr[Boolean] = js.undefined
...
object plotLabel {
  ...
  inline def apply(): plotLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[plotLabel]
  }
  
  extension [Self <: plotLabel](x: Self) {
    ...
    inline def setClipText(value: Boolean): Self = StObject.set(x, "clipText", value.asInstanceOf[js.Any])
