...
trait backgroundMarker extends StObject {
...
object backgroundMarker {
  
  inline def apply(): backgroundMarker = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[backgroundMarker]
  }
  
  extension [Self <: backgroundMarker](x: Self) {
