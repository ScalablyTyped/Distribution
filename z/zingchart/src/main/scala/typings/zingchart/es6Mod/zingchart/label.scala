...
trait label extends StObject {
  ...
  var `callout-tip`: js.UndefOr[calloutTip] = js.undefined
  ...
  var calloutTip: js.UndefOr[typings.zingchart.es6Mod.zingchart.calloutTip] = js.undefined
...
object label {
  ...
  extension [Self <: label](x: Self) {
    ...
    inline def `setCallout-tip`(value: calloutTip): Self = StObject.set(x, "callout-tip", value.asInstanceOf[js.Any])
    ...
    inline def setCalloutTip(value: calloutTip): Self = StObject.set(x, "calloutTip", value.asInstanceOf[js.Any])
    
    inline def setCalloutTipUndefined: Self = StObject.set(x, "calloutTip", js.undefined)
