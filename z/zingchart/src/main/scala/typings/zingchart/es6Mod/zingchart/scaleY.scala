...
trait scaleY extends StObject {
  ...
  var guide: js.UndefOr[Backgroundcolor1] = js.undefined
  ...
  var sizeFactor: js.UndefOr[String] = js.undefined
  ...
  var transform: js.UndefOr[All] = js.undefined
...
object scaleY {
  ...
  inline def apply(): scaleY = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[scaleY]
  }
  
  extension [Self <: scaleY](x: Self) {
    ...
    inline def setGuide(value: Backgroundcolor1): Self = StObject.set(x, "guide", value.asInstanceOf[js.Any])
    ...
    inline def setSizeFactor(value: String): Self = StObject.set(x, "sizeFactor", value.asInstanceOf[js.Any])
    ...
    inline def setTransform(value: All): Self = StObject.set(x, "transform", value.asInstanceOf[js.Any])
