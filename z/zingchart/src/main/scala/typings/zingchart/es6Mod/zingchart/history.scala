...
import typings.zingchart.anon.FillAngle
...
trait history extends StObject {
  ...
  var item: js.UndefOr[FillAngle] = js.undefined
...
object history {
  ...
  extension [Self <: history](x: Self) {
    ...
    inline def setItem(value: FillAngle): Self = StObject.set(x, "item", value.asInstanceOf[js.Any])
