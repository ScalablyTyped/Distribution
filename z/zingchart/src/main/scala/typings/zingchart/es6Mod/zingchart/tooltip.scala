...
trait tooltip extends StObject {
  ...
  /**
    ...
    */
  var `html-mode`: js.UndefOr[Boolean] = js.undefined
  
  var htmlMode: js.UndefOr[Boolean] = js.undefined
  ...
  var rules: js.UndefOr[js.Array[tooltipRules]] = js.undefined
...
object tooltip {
  ...
  extension [Self <: tooltip](x: Self) {
    ...
    inline def `setHtml-mode`(value: Boolean): Self = StObject.set(x, "html-mode", value.asInstanceOf[js.Any])
    
    inline def `setHtml-modeUndefined`: Self = StObject.set(x, "html-mode", js.undefined)
    
    inline def setHtmlMode(value: Boolean): Self = StObject.set(x, "htmlMode", value.asInstanceOf[js.Any])
    
    inline def setHtmlModeUndefined: Self = StObject.set(x, "htmlMode", js.undefined)
    ...
    inline def setRules(value: js.Array[tooltipRules]): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
    
    inline def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
    
    inline def setRulesVarargs(value: tooltipRules*): Self = StObject.set(x, "rules", js.Array(value*))
