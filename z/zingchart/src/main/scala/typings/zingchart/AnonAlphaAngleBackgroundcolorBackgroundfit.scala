...
trait AnonAlphaAngleBackgroundcolorBackgroundfit extends js.Object {
  /**
...
object AnonAlphaAngleBackgroundcolorBackgroundfit {
  @scala.inline
  def apply(
    ...
    x: js.Any = null,
    y: js.Any = null
  ): AnonAlphaAngleBackgroundcolorBackgroundfit = {
    ...
    __obj.asInstanceOf[AnonAlphaAngleBackgroundcolorBackgroundfit]
  }
}
