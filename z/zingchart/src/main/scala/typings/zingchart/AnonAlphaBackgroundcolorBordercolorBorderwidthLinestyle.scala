...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthLinestyle]
  }
}
