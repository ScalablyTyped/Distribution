...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthFontcolorFontfamily]
  }
}
