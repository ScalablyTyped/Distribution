...
trait AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor extends js.Object {
  /**
...
object AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor = {
    ...
    __obj.asInstanceOf[AnonAlphaBackgroundcolorBordercolorBorderwidthLinecolor]
  }
}
