...
trait AnonAlphaLinecolorLinestyleLinewidthVisible extends js.Object {
  /**
...
object AnonAlphaLinecolorLinestyleLinewidthVisible {
  @scala.inline
  def apply(
  ...
  ): AnonAlphaLinecolorLinestyleLinewidthVisible = {
    ...
    __obj.asInstanceOf[AnonAlphaLinecolorLinestyleLinewidthVisible]
  }
}
