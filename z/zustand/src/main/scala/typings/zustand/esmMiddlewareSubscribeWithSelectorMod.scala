...
object esmMiddlewareSubscribeWithSelectorMod {
  
  @JSImport("zustand/esm/middleware/subscribeWithSelector", "subscribeWithSelector")
  @js.native
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    S extends {getState (): infer T} ? zustand.zustand/esm/middleware/subscribeWithSelector.Write<S, zustand.zustand/esm/middleware/subscribeWithSelector.StoreSubscribeWithSelector<T>> : never
    }}}
    */
  @js.native
