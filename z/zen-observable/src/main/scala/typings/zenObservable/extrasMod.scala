...
object extrasMod {
  ...
  inline def combineLatest[T](observables: ObservableLike[T]*): typings.zenObservable.mod.^[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("combineLatest")(observables.asInstanceOf[js.Any]).asInstanceOf[typings.zenObservable.mod.^[js.Array[T]]]
  ...
  inline def merge[T](observables: ObservableLike[T]*): typings.zenObservable.mod.^[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("merge")(observables.asInstanceOf[js.Any]).asInstanceOf[typings.zenObservable.mod.^[T]]
  ...
  inline def zip[T](observables: ObservableLike[T]*): typings.zenObservable.mod.^[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zip")(observables.asInstanceOf[js.Any]).asInstanceOf[typings.zenObservable.mod.^[js.Array[T]]]
