...
object Span {
  ...
  def apply(
    ...
    __obj.updateDynamic("addAnnotation")(addAnnotation)
    __obj.updateDynamic("annotations")(annotations)
    __obj.updateDynamic("debug")(debug)
    __obj.updateDynamic("id")(id)
    __obj.updateDynamic("putTag")(putTag)
    __obj.updateDynamic("setDebug")(setDebug)
    __obj.updateDynamic("setDuration")(setDuration)
    __obj.updateDynamic("setKind")(setKind)
    __obj.updateDynamic("setLocalEndpoint")(setLocalEndpoint)
    __obj.updateDynamic("setName")(setName)
    __obj.updateDynamic("setRemoteEndpoint")(setRemoteEndpoint)
    __obj.updateDynamic("setShared")(setShared)
