...
object EventListenerObject {
  ...
  @scala.inline
  implicit class EventListenerObjectOps[Self <: EventListenerObject[_], /* <: typings.zeroclipboard.ZC.ZeroClipboardEvent */ T] (val x: Self with EventListenerObject[T]) extends AnyVal {
    @scala.inline
