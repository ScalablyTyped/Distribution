...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.zchatBrowser.mod.ChatQueuePositionChatEventData
  ...
  - typings.zchatBrowser.mod.TypingChatEventData
  - typings.zchatBrowser.mod.LastReadChatEventData
*/
...
object ChatEventData {
  ...
  inline def ChatQueuePositionChatEventData(nick: String, queue_position: Double): typings.zchatBrowser.mod.ChatQueuePositionChatEventData = {
    ...
    __obj.asInstanceOf[typings.zchatBrowser.mod.ChatQueuePositionChatEventData]
  }
  ...
  inline def LastReadChatEventData(nick: String, timestamp: Double): typings.zchatBrowser.mod.LastReadChatEventData = {
    ...
    __obj.asInstanceOf[typings.zchatBrowser.mod.LastReadChatEventData]
  }
  
  inline def TypingChatEventData(nick: String, typing: Boolean): typings.zchatBrowser.mod.TypingChatEventData = {
    ...
    __obj.asInstanceOf[typings.zchatBrowser.mod.TypingChatEventData]
  }
}
