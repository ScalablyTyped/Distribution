...
package object mod {
  ...
  @scala.inline
  def sendChatRating(rating: js.UndefOr[scala.Nothing], callback: js.Function1[/* err */ typings.std.Error, scala.Unit]): scala.Unit = (typings.zchatBrowser.mod.^.asInstanceOf[js.Dynamic].applyDynamic("sendChatRating")(rating.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
