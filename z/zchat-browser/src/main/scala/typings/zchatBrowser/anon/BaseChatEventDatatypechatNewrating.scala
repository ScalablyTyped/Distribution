...
object BaseChatEventDatatypechatNewrating {
  ...
  inline def apply(display_name: String, nick: String, time_stamp: Double): BaseChatEventDatatypechatNewrating = {
  ...
  extension [Self <: BaseChatEventDatatypechatNewrating](x: Self) {
