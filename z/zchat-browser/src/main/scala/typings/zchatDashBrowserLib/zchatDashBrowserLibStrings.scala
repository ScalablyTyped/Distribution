...
object zchatDashBrowserLibStrings {
  @js.native
  sealed trait CONN_ERROR
    extends zchatDashBrowserLib.zchatDashBrowserMod.SendFileErrorMessage
  ...
  sealed trait account_status
    extends zchatDashBrowserLib.zchatDashBrowserMod.EventName
