...
import typings.zxcvbn.mod.ZXCVBNFeedbackWarning
...
object zxcvbnStrings {
  ...
  @js.native
  sealed trait `Repeats like QuotationmarkabcabcabcQuotationmark are only slightly harder to guess than QuotationmarkabcQuotationmark`
    extends StObject
       with ZXCVBNFeedbackWarning
  inline def `Repeats like QuotationmarkabcabcabcQuotationmark are only slightly harder to guess than QuotationmarkabcQuotationmark`: `Repeats like QuotationmarkabcabcabcQuotationmark are only slightly harder to guess than QuotationmarkabcQuotationmark` = ("Repeats like \"abcabcabc\" are only slightly harder to guess than \"abc\"").asInstanceOf[`Repeats like QuotationmarkabcabcabcQuotationmark are only slightly harder to guess than QuotationmarkabcQuotationmark`]
