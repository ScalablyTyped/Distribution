...
trait ZeptoStatic extends js.Object {
  ...
  /**
  	...
  	* @param element
  	**/
  def apply(element: stdLib.HTMLElement): ZeptoCollection = js.native
  /**
  	* @see ZeptoStatic();
  	* @param object
  	**/
  ...
  /**
  	...
  	* @param attributes
  	**/
  def apply(selector: java.lang.String, context: js.Any): ZeptoCollection = js.native
  /**
  	* Event
  	**/
  ...
  /**
  	...
  	* @return
  	**/
  def Event(`type`: java.lang.String, properties: js.Any): stdLib.Event = js.native
  /**
  	* Ajax
  	**/
  ...
  /**
  	...
  	* @return
  	**/
  def ajax(options: ZeptoAjaxSettings): stdLib.XMLHttpRequest = js.native
  /**
  	...
  	**/
  def ajaxJSONP(options: ZeptoAjaxSettings): stdLib.XMLHttpRequest = js.native
  ...
  /**
  	...
  	* @return
  	**/
  def contains(parent: stdLib.HTMLElement, node: stdLib.HTMLElement): scala.Boolean = js.native
  /**
  	* @see ZeptoStatic.each
  	**/
  def each(
    collection: js.Any,
    fn: js.Function2[/* key */ java.lang.String, /* value */ js.Any, scala.Boolean]
  ...
  def each(
    ...
    fn: js.Function2[/* index */ scala.Double, /* item */ js.Any, scala.Boolean]
  ): scala.Unit = js.native
  /**
  	* @see ZeptoStatic.extend
  	* @param deep
  	**/
  def extend(deep: scala.Boolean, target: js.Any, sources: js.Any*): js.Any = js.native
  /**
  ...
  /**
  	...
  	* @return
  	**/
  def grep(items: js.Array[_], fn: js.Function1[/* item */ js.Any, scala.Boolean]): js.Array[_] = js.native
  /**
  ...
  /**
  	...
  	* @return
  	**/
  def isPlainObject(`object`: js.Any): scala.Boolean = js.native
  /**
  	...
  	* @return
  	**/
  def isWindow(`object`: js.Any): scala.Boolean = js.native
  /**
  ...
  /**
  	...
  	* @return
  	**/
  def `type`(`object`: js.Any): java.lang.String = js.native
}
