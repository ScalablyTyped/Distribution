...
object cjsCodersEucKrEuckrdecoderMod {
  
  @JSImport("@zxing/text-encoding/cjs/coders/euc-kr/EUCKRDecoder", "EUCKRDecoder")
  @js.native
  open class EUCKRDecoder protected () extends StObject {
    def this(options: Fatal) = this()
    
    var euckr_lead: Double = js.native
