...
object es2015CodersBig5Big5DecoderMod {
  
  @JSImport("@zxing/text-encoding/es2015/coders/big5/Big5Decoder", "Big5Decoder")
  @js.native
  open class Big5Decoder protected () extends StObject {
    def this(options: Fatal) = this()
    
    var Big5_lead: Double = js.native
