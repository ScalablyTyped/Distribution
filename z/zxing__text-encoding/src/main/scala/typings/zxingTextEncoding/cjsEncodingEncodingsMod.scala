...
object cjsEncodingEncodingsMod {
  
  @JSImport("@zxing/text-encoding/cjs/encoding/encodings", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    *        }>}
    */
  @JSImport("@zxing/text-encoding/cjs/encoding/encodings", "encodings")
  @js.native
