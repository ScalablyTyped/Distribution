...
object esmEncodingTerminologyMod {
  
  @JSImport("@zxing/text-encoding/esm/encoding/terminology", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@zxing/text-encoding/esm/encoding/terminology", "end_of_stream")
  @js.native
  ...
  @JSImport("@zxing/text-encoding/esm/encoding/terminology", "isASCIICodePoint")
  @js.native
