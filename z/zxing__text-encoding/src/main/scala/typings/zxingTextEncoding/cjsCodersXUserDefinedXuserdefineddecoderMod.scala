...
object cjsCodersXUserDefinedXuserdefineddecoderMod {
  
  @JSImport("@zxing/text-encoding/cjs/coders/x-user-defined/XUserDefinedDecoder", "XUserDefinedDecoder")
  @js.native
  open class XUserDefinedDecoder protected () extends StObject {
