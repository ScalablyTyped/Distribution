...
object esmEncodingEncodingsMod {
  
  @JSImport("@zxing/text-encoding/esm/encoding/encodings", JSImport.Namespace)
  @js.native
  ...
  /**
    ...
    *        }>}
    */
  @JSImport("@zxing/text-encoding/esm/encoding/encodings", "encodings")
  @js.native
