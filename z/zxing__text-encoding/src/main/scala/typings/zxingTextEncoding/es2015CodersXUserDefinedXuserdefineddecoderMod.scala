...
object es2015CodersXUserDefinedXuserdefineddecoderMod {
  
  @JSImport("@zxing/text-encoding/es2015/coders/x-user-defined/XUserDefinedDecoder", "XUserDefinedDecoder")
  @js.native
