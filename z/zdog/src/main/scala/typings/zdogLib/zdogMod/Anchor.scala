...
class Anchor () extends js.Object {
  ...
  /**
    ...
    */
  def addChild(anchor: Anchor): scala.Unit = js.native
  /**
    * Copy an item.
  ...
  /**
    ...
    */
  def normalizeRotate(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def removeChild(anchor: Anchor): scala.Unit = js.native
  /**
    ...
    */
  def renderGraphCanvas(ctx: stdLib.CanvasRenderingContext2D): scala.Unit = js.native
  /**
    * Renders the item and all its descendant items to an SVG element.
    * Useful for {@link https://zzz.dog/extras#rendering-without-illustration rendering without `Illustration`}.
    * @see {@link https://zzz.dog/api#anchor-rendergraphsvg Zdog API}
    */
  def renderGraphSvg(svg: stdLib.SVGSVGElement): scala.Unit = js.native
  /**
    ...
    */
  def updateGraph(): scala.Unit = js.native
}
