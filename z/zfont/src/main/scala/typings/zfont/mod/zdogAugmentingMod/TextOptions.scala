...
object TextOptions {
  @scala.inline
  def apply[/* <: typings.zfont.mod.zdogAugmentingMod.MultilineText */ T](font: Font): TextOptions[T] = {
    val __obj = js.Dynamic.literal(font = font.asInstanceOf[js.Any])
    __obj.asInstanceOf[TextOptions[T]]
  }
  @scala.inline
  implicit class TextOptionsOps[Self <: TextOptions[_], /* <: typings.zfont.mod.zdogAugmentingMod.MultilineText */ T] (val x: Self with TextOptions[T]) extends AnyVal {
    @scala.inline
