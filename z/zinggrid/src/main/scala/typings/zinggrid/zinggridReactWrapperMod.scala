...
object zinggridReactWrapperMod {
  
  @JSImport("zinggrid-react-wrapper", JSImport.Namespace)
  @js.native
  open class ^ ()
    extends StObject
  ...
  /**
    ...
    * </ul>
    */
  inline def customizeDialog(`type`: String, config: Any): ZingGrid = (^.asInstanceOf[js.Dynamic].applyDynamic("customizeDialog")(`type`.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[ZingGrid]
