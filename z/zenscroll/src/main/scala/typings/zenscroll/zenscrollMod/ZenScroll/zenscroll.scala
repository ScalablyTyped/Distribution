...
trait zenscroll extends js.Object {
  ...
  def createScroller(scrollContainer: HTMLElement): typings.zenscroll.zenscrollMod.ZenScroll.zenscroll = js.native
  def createScroller(scrollContainer: HTMLElement, defaultDuration: Double): typings.zenscroll.zenscrollMod.ZenScroll.zenscroll = js.native
  def createScroller(scrollContainer: HTMLElement, defaultDuration: Double, edgeOffset: Double): typings.zenscroll.zenscrollMod.ZenScroll.zenscroll = js.native
