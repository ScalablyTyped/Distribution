...
version := "0.0-dt-20190321Z-eb2014"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190709Z-89382d",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190629Z-1e76a5",
  "org.scalablytyped" %%% "node" % "12.6-dt-20190717Z-e46800",
  "org.scalablytyped" %%% "node-fetch" % "2.5-dt-20190723Z-32cfab",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190417Z-c6e514",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190703Z-55594c",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-b5c631",
