...
version := "0.0-dt-20190321Z-4daedd"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190709Z-ec9b4b",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190629Z-12eb74",
  "org.scalablytyped" %%% "node" % "12.11-dt-20191015Z-4f243e",
  "org.scalablytyped" %%% "node-fetch" % "2.5-dt-20190923Z-a0de4a",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190924Z-08cc8a",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191015Z-baf60f",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20191014Z-27fa28",
