...
version := "0.0-dt-20190321Z-cad86a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190318Z-70f07c",
  "org.scalablytyped" %%% "next-server" % "8.0-dt-20190408Z-fd5c0f",
  "org.scalablytyped" %%% "node" % "11.13-dt-20190417Z-002402",
  "org.scalablytyped" %%% "node-fetch" % "2.3-dt-20190411Z-91933d",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190417Z-7e744c",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190403Z-26e47b",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-84afcc",
