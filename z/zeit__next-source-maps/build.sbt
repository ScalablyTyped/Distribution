...
version := "0.0-dt-20190321Z-0da518"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190501Z-296d6d",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190501Z-b96864",
  ...
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-0c08a0",
