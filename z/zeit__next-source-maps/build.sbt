...
version := "0.0-dt-20190321Z-170dd8"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190423Z-ede0c4",
  "org.scalablytyped" %%% "next-server" % "8.0-dt-20190408Z-869ab6",
  ...
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-fb0ba2",
