...
version := "0.0-dt-20190321Z-bf2e6b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190709Z-ebcf45",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190629Z-150997",
  "org.scalablytyped" %%% "node" % "12.11-dt-20191022Z-f18ffd",
  "org.scalablytyped" %%% "node-fetch" % "2.5-dt-20190923Z-674c61",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190924Z-08cc8a",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191016Z-462cf8",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20191014Z-ba7b0c",
