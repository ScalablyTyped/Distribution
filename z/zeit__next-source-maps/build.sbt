...
version := "0.0-dt-20190321Z-b91909"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190709Z-78f13f",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190629Z-f136a2",
  "org.scalablytyped" %%% "node" % "12.11-dt-20191024Z-c10572",
  "org.scalablytyped" %%% "node-fetch" % "2.5-dt-20190923Z-29b3b8",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190924Z-08cc8a",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191025Z-9e835e",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20191014Z-d8a6a5",
