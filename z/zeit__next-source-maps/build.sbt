...
version := "0.0-dt-20190321Z-67755a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190318Z-105e6f",
  "org.scalablytyped" %%% "next-server" % "8.0-dt-20190408Z-1c56c8",
  ...
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-8aa398",
