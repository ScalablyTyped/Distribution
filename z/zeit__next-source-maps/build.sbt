...
version := "0.0-dt-20190321Z-65d80e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190423Z-f7cef6",
  "org.scalablytyped" %%% "next-server" % "8.0-dt-20190408Z-78c52d",
  ...
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-7f62f9",
