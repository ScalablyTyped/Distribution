...
version := "0.0-dt-20190321Z-7bb0bb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "next" % "8.0-dt-20190501Z-b7fbbd",
  "org.scalablytyped" %%% "next-server" % "8.1-dt-20190501Z-450c7e",
  "org.scalablytyped" %%% "node" % "12.0-dt-20190517Z-07594f",
  "org.scalablytyped" %%% "node-fetch" % "2.3-dt-20190516Z-956c34",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190417Z-ff94fb",
  "org.scalablytyped" %%% "react" % "16.8-dt-20190508Z-56dde3",
  "org.scalablytyped" %%% "react-loadable" % "5.5-dt-20190131Z-b98a80",
  ...
  "org.scalablytyped" %%% "webpack" % "4.4-dt-20190506Z-89e48a")
