...
trait Bundle[InputData] extends js.Object {
  ...
  var cleanedRequest: js.UndefOr[stdLib.Partial[zapierDashPlatformDashCoreLib.Anon_ContentHeaders]] = js.undefined
  var inputData: InputData
  var inputDataRaw: org.scalablytyped.runtime.StringDictionary[java.lang.String]
  var meta: zapierDashPlatformDashCoreLib.Anon_Firstpoll
...
object Bundle {
  ...
  def apply[InputData](
    ...
    meta: zapierDashPlatformDashCoreLib.Anon_Firstpoll,
    cleanedRequest: stdLib.Partial[zapierDashPlatformDashCoreLib.Anon_ContentHeaders] = null,
    ...
    if (cleanedRequest != null) __obj.updateDynamic("cleanedRequest")(cleanedRequest)
