...
class Suite () extends js.Object {
  ...
  def this(name: java.lang.String, options: Options) = this()
  ...
  def push(benchmark: Benchmark): scala.Double = js.native
  ...
  def unshift(benchmark: Benchmark): scala.Double = js.native
}
