...
class ^ protected () extends Benchmark {
  ...
  def this(fn: java.lang.String, options: Options) = this()
  ...
  def this(name: java.lang.String, fn: java.lang.String, options: Options) = this()
  def this(name: java.lang.String, fn: js.Function, options: Options) = this()
}
...
object ^ extends js.Object {
  ...
  def invoke(benches: js.Array[Benchmark], name: java.lang.String, args: js.Any*): js.Array[_] = js.native
