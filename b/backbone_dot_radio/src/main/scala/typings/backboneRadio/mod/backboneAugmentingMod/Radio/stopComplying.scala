...
object stopComplying extends js.Object {
  ...
  def apply(channelName: String, commandName: String): Commands = js.native
  def apply(channelName: String, commandName: String, callback: js.UndefOr[scala.Nothing], context: js.Any): Commands = js.native
