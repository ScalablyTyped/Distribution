...
trait Radio extends js.Object {
  def channel(channelName: String): Channel
...
object Radio extends js.Object {
  ...
  def channel(channelName: String): Channel = js.native
  // Proxy functions for Commands
  def command(channelName: String, commandName: String, args: js.Any*): Unit = js.native
  def comply(channelName: String, commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): Commands = js.native
  def comply(
    channelName: String,
    commandName: String,
  ...
  def comply(channelName: String, commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): Commands = js.native
  def comply(
    channelName: String,
    commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]],
    context: js.Any
  ): Commands = js.native
  def complyOnce(channelName: String, commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): Commands = js.native
  def complyOnce(
    channelName: String,
    commandName: String,
    callback: js.Function1[/* repeated */ js.Any, Unit],
  ...
  def complyOnce(channelName: String, commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): Commands = js.native
  def complyOnce(
    channelName: String,
    commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]],
    context: js.Any
  ...
  def reply(channelName: String, commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): Requests = js.native
  def reply(
    channelName: String,
    commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]],
    context: js.Any
  ): Requests = js.native
  def reply(channelName: String, requestName: String, callback: js.Function1[/* repeated */ js.Any, _]): Requests = js.native
  def reply(
    channelName: String,
    requestName: String,
  ...
  def replyOnce(channelName: String, commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): Requests = js.native
  def replyOnce(
    channelName: String,
    commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]],
    context: js.Any
  ): Requests = js.native
  def replyOnce(channelName: String, requestName: String, callback: js.Function1[/* repeated */ js.Any, _]): Requests = js.native
  def replyOnce(
    channelName: String,
    requestName: String,
    callback: js.Function1[/* repeated */ js.Any, _],
  ...
  def stopComplying(channelName: String): Commands = js.native
  def stopComplying(channelName: String, commandName: String): Commands = js.native
  def stopComplying(channelName: String, commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): Commands = js.native
  def stopComplying(
    channelName: String,
    commandName: String,
    callback: js.Function1[/* repeated */ js.Any, Unit],
  ...
  def stopReplying(channelName: String): Requests = js.native
  def stopReplying(channelName: String, commandName: String): Requests = js.native
  def stopReplying(channelName: String, commandName: String, callback: js.Function1[/* repeated */ js.Any, _]): Requests = js.native
  def stopReplying(
    channelName: String,
    commandName: String,
    callback: js.Function1[/* repeated */ js.Any, _],
