...
object RadioNs extends js.Object {
  ...
  - typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests because Inheritance from two classes. Inlined request, reply, reply, reply, reply, replyOnce, replyOnce, replyOnce, replyOnce, stopReplying, stopReplying, stopReplying, stopReplying- typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands because Inheritance from two classes. Inlined command, comply, comply, comply, comply, complyOnce, complyOnce, complyOnce, complyOnce, stopComplying, stopComplying, stopComplying, stopComplying */ @js.native
  class Channel ()
    extends EventsMixin
       with Events {
    ...
    def comply(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def comply(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def comply(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def comply(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def complyOnce(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def complyOnce(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def complyOnce(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def complyOnce(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    /**
    ...
    def reply(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def reply(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def reply(requestName: String, callback: js.Function1[/* repeated */ js.Any, _]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def reply(requestName: String, callback: js.Function1[/* repeated */ js.Any, _], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def replyOnce(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def replyOnce(commands: StringDictionary[js.Function1[/* repeated */ js.Any, _]], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def replyOnce(requestName: String, callback: js.Function1[/* repeated */ js.Any, _]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def replyOnce(requestName: String, callback: js.Function1[/* repeated */ js.Any, _], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    // Radio.Requests
    def request(requestName: String, args: js.Any*): js.Any = js.native
    def reset(): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Channel = js.native
    def stopComplying(): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def stopComplying(commandName: String): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def stopComplying(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def stopComplying(commandName: String, callback: js.Function1[/* repeated */ js.Any, Unit], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Commands = js.native
    def stopReplying(): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def stopReplying(commandName: String): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def stopReplying(commandName: String, callback: js.Function1[/* repeated */ js.Any, _]): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
    def stopReplying(commandName: String, callback: js.Function1[/* repeated */ js.Any, _], context: js.Any): typings.backboneDotRadio.backboneDotRadioMod.backboneMod.RadioNs.Requests = js.native
  }
