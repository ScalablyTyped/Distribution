...
object libEsmContextMenu2Mod {
  ...
  trait ContextMenu2Props extends StObject {
    ...
    /**
      ...
      */
    var popoverProps: js.UndefOr[ContextMenu2PopoverOptions] = js.undefined
  ...
  object ContextMenu2Props {
    ...
    implicit open class MutableBuilder[Self <: ContextMenu2Props] (val x: Self) extends AnyVal {
      ...
      inline def setPopoverProps(value: ContextMenu2PopoverOptions): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
