...
import typings.blueprintjsPopover2.anon.IOverlayLifecyclePropsPic
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`additions removals`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`additions text`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`inline`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`removals additions`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`removals text`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`text additions`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.`text removals`
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.additions
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.all
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.ascending
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.assertive
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.both
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.copy
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.date
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.decimal
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.descending
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.dialog
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.email
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.execute
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.grammar
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.grid
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.horizontal
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.inherit
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.link
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.list
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.listbox
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.location
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.menu
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.mixed
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.move
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.no
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.none
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.numeric
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.off
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.on
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.other
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.page
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.polite
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.popup
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.removals
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.search
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.spelling
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.step
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.tel
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.text
import typings.blueprintjsPopover2.blueprintjsPopover2Strings.time
...
object contextMenu2Mod {
  
  @JSImport("@blueprintjs/popover2/lib/esm/contextMenu2", "ContextMenu2")
  @js.native
  val ContextMenu2: FC[ContextMenu2Props] = js.native
  
  trait ContextMenu2ChildrenProps extends StObject {
    
    /** Context menu container element class */
    var className: String
    
    /** Render props relevant to the content of this context menu */
    var contentProps: ContextMenu2ContentProps
    
    /** Context menu handler which implements the custom context menu interaction */
    var onContextMenu: MouseEventHandler[HTMLElement]
  ...
  object ContextMenu2ChildrenProps {
    
    inline def apply(
      className: String,
      contentProps: ContextMenu2ContentProps,
      onContextMenu: MouseEvent[HTMLElement, NativeMouseEvent] => Unit
    ): ContextMenu2ChildrenProps = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], contentProps = contentProps.asInstanceOf[js.Any], onContextMenu = js.Any.fromFunction1(onContextMenu), ref = null)
    ...
    extension [Self <: ContextMenu2ChildrenProps](x: Self) {
      ...
      inline def setContentProps(value: ContextMenu2ContentProps): Self = StObject.set(x, "contentProps", value.asInstanceOf[js.Any])
      ...
      inline def setPopover(value: Element): Self = StObject.set(x, "popover", value.asInstanceOf[js.Any])
  ...
  trait ContextMenu2ContentProps extends StObject {
    
    /** Whether the context menu is currently open. */
    var isOpen: Boolean
    
    /** The context menu click event. If isOpen is false, this will be undefined. */
    var mouseEvent: js.UndefOr[MouseEvent[HTMLElement, NativeMouseEvent]] = js.undefined
  ...
  object ContextMenu2ContentProps {
    
    inline def apply(isOpen: Boolean): ContextMenu2ContentProps = {
    ...
    extension [Self <: ContextMenu2ContentProps](x: Self) {
      ...
      inline def setMouseEvent(value: MouseEvent[HTMLElement, NativeMouseEvent]): Self = StObject.set(x, "mouseEvent", value.asInstanceOf[js.Any])
  ...
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'children' | 'className' | 'onContextMenu'> */
  /* Inlined parent react.react.RefAttributes<any> */
  /* Inlined parent @blueprintjs/core.@blueprintjs/core.Props */
  trait ContextMenu2Props extends StObject {
    ...
    /**
      ...
      */
    var children: ReactNode | (js.Function1[/* props */ ContextMenu2ChildrenProps, ReactElement])
    ...
    var content: js.UndefOr[
        Element | (js.Function1[/* props */ ContextMenu2ContentProps, js.UndefOr[Element]])
      ] = js.undefined
    ...
    /**
      ...
      */
    var popoverProps: js.UndefOr[IOverlayLifecyclePropsPic] = js.undefined
  ...
  object ContextMenu2Props {
    
    inline def apply(): ContextMenu2Props = {
    ...
    extension [Self <: ContextMenu2Props](x: Self) {
      ...
      inline def setChildren(value: ReactNode | (js.Function1[/* props */ ContextMenu2ChildrenProps, ReactElement])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ ContextMenu2ChildrenProps => ReactElement): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
      ...
      inline def setContent(value: Element | (js.Function1[/* props */ ContextMenu2ContentProps, js.UndefOr[Element]])): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      
      inline def setContentEditable(value: Booleanish | inherit): Self = StObject.set(x, "contentEditable", value.asInstanceOf[js.Any])
      
      inline def setContentEditableUndefined: Self = StObject.set(x, "contentEditable", js.undefined)
      
      inline def setContentFunction1(value: /* props */ ContextMenu2ContentProps => js.UndefOr[Element]): Self = StObject.set(x, "content", js.Any.fromFunction1(value))
      ...
      inline def setPopoverProps(value: IOverlayLifecyclePropsPic): Self = StObject.set(x, "popoverProps", value.asInstanceOf[js.Any])
  ...
  type ContextMenu2RenderProps = ContextMenu2ContentProps
