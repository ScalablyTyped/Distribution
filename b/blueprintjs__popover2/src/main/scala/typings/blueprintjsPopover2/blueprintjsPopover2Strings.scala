...
object blueprintjsPopover2Strings {
  ...
  inline def RESET_DISABLED_STATE: RESET_DISABLED_STATE = "RESET_DISABLED_STATE".asInstanceOf[RESET_DISABLED_STATE]
  ...
  @js.native
  sealed trait matchReferenceWidth extends StObject
  inline def matchReferenceWidth: matchReferenceWidth = "matchReferenceWidth".asInstanceOf[matchReferenceWidth]
