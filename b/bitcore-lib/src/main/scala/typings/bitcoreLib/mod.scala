...
object mod {
  ...
  object Unit {
    ...
    @scala.inline
    def fromBTC(amount: Double): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBTC")(amount.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object crypto {
    ...
    object ECDSA {
      ...
      @JSImport("bitcore-lib", "crypto.ECDSA")
      @js.native
      val ^ : js.Any = js.native
    ...
    object Hash {
      ...
      @JSImport("bitcore-lib", "crypto.Hash")
      @js.native
      val ^ : js.Any = js.native
    ...
    object Random {
      ...
      @JSImport("bitcore-lib", "crypto.Random")
      @js.native
      val ^ : js.Any = js.native
