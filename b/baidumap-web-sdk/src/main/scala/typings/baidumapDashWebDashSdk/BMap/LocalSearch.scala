...
import typings.baidumapDashWebDashSdk.Anon_CustomData
...
class LocalSearch protected () extends js.Object {
  ...
  def searchInBounds(keyword: String, bounds: Bounds, option: Anon_CustomData): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds): Unit = js.native
  def searchInBounds(keyword: js.Array[String], bounds: Bounds, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: String, center: String, radius: Double): Unit = js.native
  def searchNearby(keyword: String, center: String, radius: Double, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: String, center: LocalResultPoi, radius: Double): Unit = js.native
  def searchNearby(keyword: String, center: LocalResultPoi, radius: Double, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: String, center: Point, radius: Double): Unit = js.native
  def searchNearby(keyword: String, center: Point, radius: Double, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: String, radius: Double): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: String, radius: Double, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: LocalResultPoi, radius: Double): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: LocalResultPoi, radius: Double, option: Anon_CustomData): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: Point, radius: Double): Unit = js.native
  def searchNearby(keyword: js.Array[String], center: Point, radius: Double, option: Anon_CustomData): Unit = js.native
