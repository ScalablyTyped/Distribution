...
trait DragAndZoomTool extends StObject {
  ...
  def ondrawend(event: typings.baidumapWebSdk.anon.Bounds): Unit = js.native
...
object DragAndZoomTool {
  ...
  implicit class DragAndZoomToolMutableBuilder[Self <: DragAndZoomTool] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOndrawend(value: typings.baidumapWebSdk.anon.Bounds => Unit): Self = StObject.set(x, "ondrawend", js.Any.fromFunction1(value))
