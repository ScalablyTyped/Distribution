...
object PointCollectionOption {
  ...
  @scala.inline
  implicit class PointCollectionOptionOps[Self <: PointCollectionOption] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShape(value: ShapeType): Self = this.set("shape", value.asInstanceOf[js.Any])
