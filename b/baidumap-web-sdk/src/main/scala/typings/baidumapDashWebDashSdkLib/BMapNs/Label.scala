...
class Label protected () extends Overlay {
  ...
  def onmousedown(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  ...
  def onmouseup(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  ...
  def setStyle(styles: js.Object): scala.Unit = js.native
