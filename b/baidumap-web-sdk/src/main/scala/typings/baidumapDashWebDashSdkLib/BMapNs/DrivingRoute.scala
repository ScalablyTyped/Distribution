...
class DrivingRoute protected () extends js.Object {
  ...
  def search(start: LocalResultPoi, end: LocalResultPoi, opts: js.Object): scala.Unit = js.native
  def search(start: LocalResultPoi, end: Point): scala.Unit = js.native
  def search(start: LocalResultPoi, end: Point, opts: js.Object): scala.Unit = js.native
  def search(start: LocalResultPoi, end: java.lang.String): scala.Unit = js.native
  def search(start: LocalResultPoi, end: java.lang.String, opts: js.Object): scala.Unit = js.native
  def search(start: Point, end: LocalResultPoi): scala.Unit = js.native
  def search(start: Point, end: LocalResultPoi, opts: js.Object): scala.Unit = js.native
  def search(start: Point, end: Point): scala.Unit = js.native
  def search(start: Point, end: Point, opts: js.Object): scala.Unit = js.native
  def search(start: Point, end: java.lang.String): scala.Unit = js.native
  def search(start: Point, end: java.lang.String, opts: js.Object): scala.Unit = js.native
  def search(start: java.lang.String, end: LocalResultPoi): scala.Unit = js.native
  def search(start: java.lang.String, end: LocalResultPoi, opts: js.Object): scala.Unit = js.native
  def search(start: java.lang.String, end: Point): scala.Unit = js.native
  def search(start: java.lang.String, end: Point, opts: js.Object): scala.Unit = js.native
  def search(start: java.lang.String, end: java.lang.String): scala.Unit = js.native
  def search(start: java.lang.String, end: java.lang.String, opts: js.Object): scala.Unit = js.native
