...
class WalkingRoute protected () extends js.Object {
  ...
  def this(location: java.lang.String, opts: WalkingRouteOptions) = this()
  ...
  def setSearchCompleteCallback(callback: js.Function1[/* result */ WalkingRouteResult, scala.Unit]): scala.Unit = js.native
}
