...
class Map protected () extends js.Object {
  ...
  def onclick(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
  def ondblclick(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def ondragend(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def ondragging(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def ondragstart(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  ...
  def onload(event: baidumapDashWebDashSdkLib.Anon_PointPixel): scala.Unit = js.native
  def onlongpress(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def onmaptypechange(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def onmousemove(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
  ...
  def onrightclick(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
  def onrightdblclick(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
  def ontilesloaded(event: baidumapDashWebDashSdkLib.Anon_TypeTarget): scala.Unit = js.native
  def ontouchend(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def ontouchmove(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
  def ontouchstart(event: baidumapDashWebDashSdkLib.Anon_TypeTargetPixel): scala.Unit = js.native
