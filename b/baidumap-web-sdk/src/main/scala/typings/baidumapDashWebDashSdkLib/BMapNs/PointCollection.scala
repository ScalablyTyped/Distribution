...
class PointCollection protected () extends Overlay {
  ...
  def onmouseout(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
  def onmouseover(event: baidumapDashWebDashSdkLib.Anon_Point): scala.Unit = js.native
