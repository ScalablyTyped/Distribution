...
object blissfuljsStrings {
  
  @js.native
  sealed trait MSContentZoom extends StObject
  ...
  @js.native
  sealed trait ariarequest extends StObject
  inline def ariarequest: ariarequest = "ariarequest".asInstanceOf[ariarequest]
  ...
  @js.native
  sealed trait beforeactivate extends StObject
  inline def beforeactivate: beforeactivate = "beforeactivate".asInstanceOf[beforeactivate]
  ...
  @js.native
  sealed trait beforedeactivate extends StObject
  inline def beforedeactivate: beforedeactivate = "beforedeactivate".asInstanceOf[beforedeactivate]
  ...
  @js.native
  sealed trait embeded extends StObject
  inline def embeded: embeded = "embeded".asInstanceOf[embeded]
  ...
  @js.native
  sealed trait webkitfullscreenchange extends StObject
  inline def webkitfullscreenchange: webkitfullscreenchange = "webkitfullscreenchange".asInstanceOf[webkitfullscreenchange]
  
  @js.native
  sealed trait webkitfullscreenerror extends StObject
  inline def webkitfullscreenerror: webkitfullscreenerror = "webkitfullscreenerror".asInstanceOf[webkitfullscreenerror]
