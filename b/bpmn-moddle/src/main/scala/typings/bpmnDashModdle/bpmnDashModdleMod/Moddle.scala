...
trait Moddle extends js.Object {
  ...
  /**
    ...
    */
  def create[T, K /* <: String */](descriptor: K): /* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any = js.native
  def create[T, K /* <: String */](descriptor: K, attrs: js.Any): /* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any = js.native
  /**
