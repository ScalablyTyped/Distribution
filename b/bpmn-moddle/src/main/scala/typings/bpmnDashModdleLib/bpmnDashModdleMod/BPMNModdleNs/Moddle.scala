...
trait Moddle extends js.Object {
  ...
  /**
           ...
           */
  def create[T, K /* <: java.lang.String */](descriptor: K): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
  /**
           * Create an instance of the specified type.
           *
           * @example
           ...
           * @return model instance
           */
  def create[T, K /* <: java.lang.String */](descriptor: K, attrs: js.Any): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
  /**
