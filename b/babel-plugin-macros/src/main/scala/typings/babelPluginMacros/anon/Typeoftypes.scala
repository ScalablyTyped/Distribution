...
trait Typeoftypes extends js.Object {
  ...
  def catchClause(param: js.UndefOr[ArrayPattern_ | Identifier_ | Null | ObjectPattern_], body: BlockStatement_): CatchClause_ = js.native
  def classBody(
    body: js.Array[
  ...
  def classProperty(key: Expression): ClassProperty_ = js.native
  def classProperty(key: Expression, value: Expression): ClassProperty_ = js.native
  def classProperty(key: Expression, value: Expression, typeAnnotation: Noop_): ClassProperty_ = js.native
  def classProperty(key: Expression, value: Expression, typeAnnotation: Noop_, decorators: js.Array[Decorator_]): ClassProperty_ = js.native
  def classProperty(
    key: Expression,
    value: Expression,
    typeAnnotation: Noop_,
    decorators: js.Array[Decorator_],
    computed: Boolean
  ...
  def classProperty(key: Expression, value: Expression, typeAnnotation: TSTypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: Expression,
    value: Expression,
  ...
  def classProperty(key: Expression, value: Expression, typeAnnotation: TypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: Expression,
    value: Expression,
  ...
  def classProperty(key: Identifier_, value: Expression, typeAnnotation: Noop_): ClassProperty_ = js.native
  def classProperty(key: Identifier_, value: Expression, typeAnnotation: Noop_, decorators: js.Array[Decorator_]): ClassProperty_ = js.native
  def classProperty(
    key: Identifier_,
    value: Expression,
    typeAnnotation: Noop_,
  ...
  def classProperty(key: Identifier_, value: Expression, typeAnnotation: TSTypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: Identifier_,
    value: Expression,
    typeAnnotation: TSTypeAnnotation_,
  ...
  def classProperty(key: NumericLiteral_): ClassProperty_ = js.native
  def classProperty(key: NumericLiteral_, value: Expression): ClassProperty_ = js.native
  def classProperty(key: NumericLiteral_, value: Expression, typeAnnotation: Noop_): ClassProperty_ = js.native
  def classProperty(key: NumericLiteral_, value: Expression, typeAnnotation: Noop_, decorators: js.Array[Decorator_]): ClassProperty_ = js.native
  def classProperty(
    key: NumericLiteral_,
    value: Expression,
    typeAnnotation: Noop_,
  ...
  def classProperty(key: NumericLiteral_, value: Expression, typeAnnotation: TSTypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: NumericLiteral_,
    value: Expression,
    typeAnnotation: TSTypeAnnotation_,
  ...
  def classProperty(key: NumericLiteral_, value: Expression, typeAnnotation: TypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: NumericLiteral_,
    value: Expression,
    typeAnnotation: TypeAnnotation_,
  ...
  def classProperty(key: StringLiteral_): ClassProperty_ = js.native
  def classProperty(key: StringLiteral_, value: Expression): ClassProperty_ = js.native
  def classProperty(key: StringLiteral_, value: Expression, typeAnnotation: Noop_): ClassProperty_ = js.native
  def classProperty(key: StringLiteral_, value: Expression, typeAnnotation: Noop_, decorators: js.Array[Decorator_]): ClassProperty_ = js.native
  def classProperty(
    key: StringLiteral_,
    value: Expression,
    typeAnnotation: Noop_,
  ...
  def classProperty(key: StringLiteral_, value: Expression, typeAnnotation: TSTypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: StringLiteral_,
    value: Expression,
    typeAnnotation: TSTypeAnnotation_,
  ...
  def classProperty(key: StringLiteral_, value: Expression, typeAnnotation: TypeAnnotation_): ClassProperty_ = js.native
  def classProperty(
    key: StringLiteral_,
    value: Expression,
    typeAnnotation: TypeAnnotation_,
  ...
  def declareTypeAlias(id: Identifier_, typeParameters: js.UndefOr[Null | TypeParameterDeclaration_], right: FlowType): DeclareTypeAlias_ = js.native
  ...
  def functionTypeParam(name: js.UndefOr[Identifier_ | Null], typeAnnotation: FlowType): FunctionTypeParam_ = js.native
  ...
  def interfaceTypeAnnotation(_extends: js.UndefOr[js.Array[InterfaceExtends_] | Null], body: ObjectTypeAnnotation_): InterfaceTypeAnnotation_ = js.native
  ...
  @JSName("is")
  def is_P_Node[P /* <: Node */](`type`: String, n: js.UndefOr[Node | Null], required: Partial[P]): /* is P */ Boolean = js.native
  ...
  def matchesPattern(node: js.UndefOr[Node | Null], `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
  ...
  def objectTypeIndexer(id: js.UndefOr[Identifier_ | Null], key: FlowType, value: FlowType): ObjectTypeIndexer_ = js.native
  def objectTypeIndexer(id: js.UndefOr[Identifier_ | Null], key: FlowType, value: FlowType, variance: Variance_): ObjectTypeIndexer_ = js.native
  ...
  def switchCase(test: js.UndefOr[Expression | Null], consequent: js.Array[Statement]): SwitchCase_ = js.native
  ...
  def tsTupleType(elementTypes: js.Array[TSType]): TSTupleType_ = js.native
  ...
  def tsTypeParameter(constraint: js.UndefOr[Null | TSType], _default: js.UndefOr[Null | TSType], name: String): TSTypeParameter_ = js.native
