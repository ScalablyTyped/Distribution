...
import typings.babelPluginMacros.babelPluginMacrosStrings.VerticallineGreaterthansign
...
import typings.babelPluginMacros.babelPluginMacrosStrings.`await using`
...
import typings.babelPluginMacros.babelPluginMacrosStrings.`using`
...
object anon {
  ...
  trait Typeoftraverse extends StObject {
    ...
    def hasType(
      ...
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    def hasType(
      tree: typings.babelTypes.mod.Node,
      `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any,
  ...
  trait Typeoftypes extends StObject {
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typings.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typings.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelPluginMacros.babelPluginMacrosStrings.ClassAccessorProperty, typings.babelPluginMacros.babelPluginMacrosStrings.AnyTypeAnnotation, typings.babelPluginMacros.babelPluginMacrosStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
    ...
    def placeholder(
      expectedNode: Identifier | StringLiteral | typings.babelPluginMacros.babelPluginMacrosStrings.Expression | typings.babelPluginMacros.babelPluginMacrosStrings.Statement | typings.babelPluginMacros.babelPluginMacrosStrings.Declaration | BlockStatement | ClassBody | typings.babelPluginMacros.babelPluginMacrosStrings.Pattern,
      name: Identifier_
  ...
  trait defaultArrayNodePathNodeR
    extends StObject
       with /* key */ StringDictionary[js.Array[NodePath[typings.babelTypes.mod.Node]]] {
    
    var default: js.Array[NodePath[typings.babelTypes.mod.Node]]
  }
  object defaultArrayNodePathNodeR {
    ...
    implicit open class MutableBuilder[Self <: defaultArrayNodePathNodeR] (val x: Self) extends AnyVal {
      ...
      inline def setDefaultVarargs(value: NodePath[typings.babelTypes.mod.Node]*): Self = StObject.set(x, "default", js.Array(value*))
    }
  }
}
