...
object mod {
  ...
  @JSImport("biguintle", JSImport.Namespace)
  @js.native
  ...
  object decode {
    ...
    /**
      ...
      */
    @JSImport("biguintle", "decode.bytes")
    @js.native
  ...
  object encode {
    ...
    /**
      ...
      */
    @JSImport("biguintle", "encode.bytes")
    @js.native
    val bytes: Double = js.native
  }
