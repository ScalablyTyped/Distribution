...
class HasOne () extends Relation {
  ...
  def handleAddition(
    model: typings.backbone.mod.Model[_, ModelSetOptions],
    coll: Collection[typings.backbone.mod.Model[_, ModelSetOptions]],
    options: js.Any
  ): Unit = js.native
  def handleRemoval(
    model: typings.backbone.mod.Model[_, ModelSetOptions],
  ...
  def handleReset(coll: Collection[typings.backbone.mod.Model[_, ModelSetOptions]], options: js.Any): Unit = js.native
  ...
  def setKeyContents(keyContents: Collection[typings.backbone.mod.Model[_, ModelSetOptions]]): Unit = js.native
