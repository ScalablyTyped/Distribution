...
object ModuleSpecifier {
  ...
  @scala.inline
  def ExportDefaultSpecifier_(end: Double, exported: Identifier_, loc: SourceLocation, start: Double): typings.babelTypes.ts36Mod.ExportDefaultSpecifier_ = {
  ...
  @scala.inline
  def ExportNamespaceSpecifier_(end: Double, exported: Identifier_, loc: SourceLocation, start: Double): typings.babelTypes.ts36Mod.ExportNamespaceSpecifier_ = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], exported = exported.asInstanceOf[js.Any], loc = loc.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
  ...
  @scala.inline
  def ImportDefaultSpecifier_(end: Double, loc: SourceLocation, local: Identifier_, start: Double): typings.babelTypes.ts36Mod.ImportDefaultSpecifier_ = {
  ...
  @scala.inline
  def ImportNamespaceSpecifier_(end: Double, loc: SourceLocation, local: Identifier_, start: Double): typings.babelTypes.ts36Mod.ImportNamespaceSpecifier_ = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], loc = loc.asInstanceOf[js.Any], local = local.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
  ...
  @scala.inline
  def ImportSpecifier_(end: Double, imported: Identifier_, loc: SourceLocation, local: Identifier_, start: Double): typings.babelTypes.ts36Mod.ImportSpecifier_ = {
