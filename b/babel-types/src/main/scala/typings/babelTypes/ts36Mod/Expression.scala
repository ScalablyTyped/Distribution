...
object Expression {
  ...
  @scala.inline
  def DoExpression_(body: BlockStatement_, end: Double, loc: SourceLocation, start: Double, `type`: DoExpression): typings.babelTypes.ts36Mod.DoExpression_ = {
  ...
  @scala.inline
  def ThisExpression_(end: Double, loc: SourceLocation, start: Double, `type`: ThisExpression): typings.babelTypes.ts36Mod.ThisExpression_ = {
    val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], loc = loc.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
