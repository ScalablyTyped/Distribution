...
@JSImport("babel-types/ts3.6", "declareInterface")
@js.native
object declareInterface extends js.Object {
  ...
  def apply(id: js.UndefOr[scala.Nothing], typeParameters: TypeParameterDeclaration_): DeclareInterface_ = js.native
  def apply(
    id: js.UndefOr[scala.Nothing],
  ...
  def apply(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], _extends: js.Array[InterfaceExtends_]): DeclareInterface_ = js.native
  def apply(
    id: Identifier_,
    typeParameters: js.UndefOr[scala.Nothing],
    _extends: js.Array[InterfaceExtends_],
