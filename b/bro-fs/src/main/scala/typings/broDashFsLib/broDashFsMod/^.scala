...
object ^ extends js.Object {
  ...
  def init(options: broDashFsLib.broDashFsMod.FSOptions): js.Promise[filesystemLib.FileSystem] = js.native
  ...
  def stat(path: filesystemLib.FileEntry): js.Promise[broDashFsLib.broDashFsMod.StatObject] = js.native
  def stat(path: java.lang.String): js.Promise[broDashFsLib.broDashFsMod.StatObject] = js.native
  ...
  def usage(): js.Promise[broDashFsLib.broDashFsMod.UsageObject] = js.native
