...
object mod {
  ...
  */
  ...
  object TextType {
    ...
    inline def BinaryString: typings.broFs.broFsStrings.BinaryString = "BinaryString".asInstanceOf[typings.broFs.broFsStrings.BinaryString]
    
    inline def DataURL: typings.broFs.broFsStrings.DataURL = "DataURL".asInstanceOf[typings.broFs.broFsStrings.DataURL]
    
    inline def Text: typings.broFs.broFsStrings.Text = "Text".asInstanceOf[typings.broFs.broFsStrings.Text]
  }
