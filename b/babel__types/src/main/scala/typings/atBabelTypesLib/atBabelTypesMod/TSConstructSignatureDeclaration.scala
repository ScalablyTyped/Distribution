...
- atBabelTypesLib.atBabelTypesMod._Node because Already inherited */ trait TSConstructSignatureDeclaration
  ...
  @JSName("type")
  var type_TSConstructSignatureDeclaration: atBabelTypesLib.atBabelTypesLibStrings.TSConstructSignatureDeclaration
}
...
object TSConstructSignatureDeclaration {
  ...
  def apply(
    ...
    `type`: atBabelTypesLib.atBabelTypesLibStrings.TSConstructSignatureDeclaration,
