...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ExportSpecifier
  extends ModuleSpecifier
     with BaseNode {
  var exported: Identifier
  var local: Identifier
  @JSName("type")
  var type_ExportSpecifier: typings.atBabelTypes.atBabelTypesStrings.ExportSpecifier
}
