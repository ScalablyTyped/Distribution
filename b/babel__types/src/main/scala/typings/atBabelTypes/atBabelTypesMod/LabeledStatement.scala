...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait LabeledStatement
  extends Statement
     with BaseNode {
  var body: Statement
  var label: Identifier
  @JSName("type")
  var type_LabeledStatement: typings.atBabelTypes.atBabelTypesStrings.LabeledStatement
}
