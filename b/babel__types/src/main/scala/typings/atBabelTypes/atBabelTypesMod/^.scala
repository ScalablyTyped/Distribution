...
object ^ extends js.Object {
  ...
  def is(`type`: String, n: Node, opts: js.Object): Boolean = js.native
  ...
  def isImmutable(node: Node): Boolean = js.native
  ...
  def isLet(node: Node): Boolean = js.native
  ...
  def isScope(node: Node, parent: Node): Boolean = js.native
  ...
  def isVar(node: Node): Boolean = js.native
