...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait TSNonNullExpression
  extends Expression
     with BaseNode {
  var expression: Expression
  @JSName("type")
  var type_TSNonNullExpression: typings.atBabelTypes.atBabelTypesStrings.TSNonNullExpression
}
