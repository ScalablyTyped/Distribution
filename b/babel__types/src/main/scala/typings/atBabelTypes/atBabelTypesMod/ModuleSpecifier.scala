...
object ModuleSpecifier {
  ...
  def ExportNamespaceSpecifier(
    exported: Identifier,
    `type`: typings.atBabelTypes.atBabelTypesStrings.ExportNamespaceSpecifier,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
  ...
  def ExportSpecifier(
    exported: Identifier,
    local: Identifier,
    `type`: typings.atBabelTypes.atBabelTypesStrings.ExportSpecifier,
    end: Int | Double = null,
    innerComments: js.Array[Comment] = null,
    leadingComments: js.Array[Comment] = null,
    loc: SourceLocation = null,
  ...
  def ImportSpecifier(
    imported: Identifier,
    local: Identifier,
    `type`: typings.atBabelTypes.atBabelTypesStrings.ImportSpecifier,
    end: Int | Double = null,
