...
- typings.atBabelTypes.atBabelTypesMod._Node because Already inherited */ trait ImportSpecifier
  ...
  @JSName("type")
  var type_ImportSpecifier: typings.atBabelTypes.atBabelTypesStrings.ImportSpecifier
}
