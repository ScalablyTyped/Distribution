...
object getBindingIdentifiers {
  ...
  inline def apply(node: Node): Record[String, Identifier_] = ^.asInstanceOf[js.Dynamic].apply(node.asInstanceOf[js.Any]).asInstanceOf[Record[String, Identifier_]]
  ...
  inline def apply(node: Node, duplicates: Unit, outerOnly: Boolean): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].apply(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any], outerOnly.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
