...
trait TSImportType
  ...
  @JSName("type")
  var type_TSImportType: typings.babelTypes.babelTypesStrings.TSImportType
}
object TSImportType {
  
  inline def apply(argument: StringLiteral_): TSImportType = {
  ...
  extension [Self <: TSImportType](x: Self) {
    ...
    inline def setType(value: typings.babelTypes.babelTypesStrings.TSImportType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
