...
trait Aliases extends StObject {
  ...
  var Accessor: typings.babelTypes.libMod.Accessor
  
  var Binary: typings.babelTypes.libMod.Binary
  
  var Block: typings.babelTypes.libMod.Block
  
  var BlockParent: typings.babelTypes.libMod.BlockParent
  
  var Class: typings.babelTypes.libMod.Class
  
  var CompletionStatement: typings.babelTypes.libMod.CompletionStatement
  
  var Conditional: typings.babelTypes.libMod.Conditional
  
  var Declaration: typings.babelTypes.libMod.Declaration
  
  var EnumBody: typings.babelTypes.libMod.EnumBody
  
  var EnumMember: typings.babelTypes.libMod.EnumMember
  
  var ExportDeclaration: typings.babelTypes.libMod.ExportDeclaration
  
  var Expression: typings.babelTypes.libMod.Expression
  
  var ExpressionWrapper: typings.babelTypes.libMod.ExpressionWrapper
  
  var Flow: typings.babelTypes.libMod.Flow
  
  var FlowBaseAnnotation: typings.babelTypes.libMod.FlowBaseAnnotation
  
  var FlowDeclaration: typings.babelTypes.libMod.FlowDeclaration
  
  var FlowPredicate: typings.babelTypes.libMod.FlowPredicate
  
  var FlowType: typings.babelTypes.libMod.FlowType
  
  var For: typings.babelTypes.libMod.For
  
  var ForXStatement: typings.babelTypes.libMod.ForXStatement
  
  var Function: typings.babelTypes.libMod.Function
  
  var FunctionParent: typings.babelTypes.libMod.FunctionParent
  
  var Immutable: typings.babelTypes.libMod.Immutable
  
  var ImportOrExportDeclaration: typings.babelTypes.libMod.ImportOrExportDeclaration
  
  var JSX: typings.babelTypes.libMod.JSX
  
  var LVal: typings.babelTypes.libMod.LVal
  
  var Literal: typings.babelTypes.libMod.Literal
  
  var Loop: typings.babelTypes.libMod.Loop
  
  var Method: typings.babelTypes.libMod.Method
  
  var Miscellaneous: typings.babelTypes.libMod.Miscellaneous
  
  var ModuleDeclaration: typings.babelTypes.libMod.ModuleDeclaration
  
  var ModuleSpecifier: typings.babelTypes.libMod.ModuleSpecifier
  
  var ObjectMember: typings.babelTypes.libMod.ObjectMember
  
  var Pattern: typings.babelTypes.libMod.Pattern
  
  var PatternLike: typings.babelTypes.libMod.PatternLike
  
  var Private: typings.babelTypes.libMod.Private
  
  var Property: typings.babelTypes.libMod.Property
  
  var Pureish: typings.babelTypes.libMod.Pureish
  
  var Scopable: typings.babelTypes.libMod.Scopable
  
  var Standardized: typings.babelTypes.libMod.Standardized
  
  var Statement: typings.babelTypes.libMod.Statement
  
  var TSBaseType: typings.babelTypes.libMod.TSBaseType
  
  var TSEntityName: typings.babelTypes.libMod.TSEntityName
  
  var TSType: typings.babelTypes.libMod.TSType
  
  var TSTypeElement: typings.babelTypes.libMod.TSTypeElement
  
  var Terminatorless: typings.babelTypes.libMod.Terminatorless
  
  var TypeScript: typings.babelTypes.libMod.TypeScript
  
  var UnaryLike: typings.babelTypes.libMod.UnaryLike
  
  var UserWhitespacable: typings.babelTypes.libMod.UserWhitespacable
  
  var While: typings.babelTypes.libMod.While
}
object Aliases {
