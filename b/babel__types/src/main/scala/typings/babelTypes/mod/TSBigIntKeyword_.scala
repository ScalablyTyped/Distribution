...
- typings.babelTypes.mod._Node because Already inherited */ trait TSBigIntKeyword_
  extends StObject
     with BaseNode
     with TSBaseType
     with TSType
...
object TSBigIntKeyword_ {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TSBigIntKeyword_] (val x: Self) extends AnyVal {
