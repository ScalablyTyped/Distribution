...
- typings.babelTypes.mod._Node because Already inherited */ trait TSSymbolKeyword_
  extends StObject
     with BaseNode
     with TSBaseType
     with TSType
...
object TSSymbolKeyword_ {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TSSymbolKeyword_] (val x: Self) extends AnyVal {
