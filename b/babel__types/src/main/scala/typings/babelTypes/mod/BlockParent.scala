...
object BlockParent {
  ...
  @scala.inline
  def CatchClause_(body: BlockStatement_, `type`: CatchClause): typings.babelTypes.mod.CatchClause_ = {
  ...
  @scala.inline
  def StaticBlock_(body: js.Array[Statement], `type`: StaticBlock): typings.babelTypes.mod.StaticBlock_ = {
    val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
