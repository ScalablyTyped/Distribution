...
object BaseNode {
  ...
  inline def apply(`type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 242 */ js.Any): BaseNode = {
  ...
  extension [Self <: BaseNode](x: Self) {
    ...
    inline def setExtra(value: Record[String, js.Any]): Self = StObject.set(x, "extra", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 242 */ js.Any): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
