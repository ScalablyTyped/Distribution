...
object TSUnknownKeyword_ {
  ...
  @scala.inline
  implicit class TSUnknownKeyword_Ops[Self <: TSUnknownKeyword_] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: TSUnknownKeyword): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
