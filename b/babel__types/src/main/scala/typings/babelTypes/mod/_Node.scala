...
object _Node {
  ...
  @scala.inline
  def TSTypeParameterDeclaration_(
  ...
  @scala.inline
  def TSTypeParameterInstantiation_(
  ...
  @scala.inline
  def TSExternalModuleReference_(
