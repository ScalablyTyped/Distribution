...
- typings.babelTypes.mod._Node because Already inherited */ trait TSOptionalType_
  extends StObject
     with BaseNode
     with TSType
     with TypeScript {
...
object TSOptionalType_ {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TSOptionalType_] (val x: Self) extends AnyVal {
