...
@JSImport("@babel/types/lib/index-ts3.7", "tsImportType")
@js.native
object tsImportType extends js.Object {
  ...
  def apply(argument: StringLiteral_, qualifier: Null, typeParameters: TSTypeParameterInstantiation_): TSImportType_ = js.native
