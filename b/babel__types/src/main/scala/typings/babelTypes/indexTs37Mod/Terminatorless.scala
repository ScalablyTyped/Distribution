...
object Terminatorless {
  ...
  @scala.inline
  def AwaitExpression_(argument: Expression): typings.babelTypes.indexTs37Mod.AwaitExpression_ = {
  ...
  @scala.inline
  def YieldExpression_(delegate: Boolean): typings.babelTypes.indexTs37Mod.YieldExpression_ = {
