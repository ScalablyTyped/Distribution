...
- typings.babelTypes.indexTs37Mod._Node because Already inherited */ trait TSMethodSignature_
  extends StObject
     with BaseNode
     with TSTypeElement {
...
object TSMethodSignature_ {
  ...
  inline def apply(key: Expression, parameters: js.Array[Identifier_ | RestElement_]): TSMethodSignature_ = {
