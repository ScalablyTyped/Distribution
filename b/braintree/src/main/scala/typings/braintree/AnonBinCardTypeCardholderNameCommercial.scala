...
trait AnonBinCardTypeCardholderNameCommercial extends js.Object {
  var bin: String
  var cardType: String
...
object AnonBinCardTypeCardholderNameCommercial {
  @scala.inline
  def apply(
    bin: String,
    cardType: String,
    ...
    productId: String,
    token: String
  ): AnonBinCardTypeCardholderNameCommercial = {
    ...
    __obj.asInstanceOf[AnonBinCardTypeCardholderNameCommercial]
  }
}
