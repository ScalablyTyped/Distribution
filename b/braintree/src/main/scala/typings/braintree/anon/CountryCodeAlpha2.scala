...
object CountryCodeAlpha2 {
  ...
  @scala.inline
  implicit class CountryCodeAlpha2Ops[Self <: CountryCodeAlpha2] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOptions(value: UpdateExisting): Self = this.set("options", value.asInstanceOf[js.Any])
    @scala.inline
