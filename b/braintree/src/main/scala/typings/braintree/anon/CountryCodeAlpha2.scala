...
object CountryCodeAlpha2 {
  ...
  @scala.inline
  def apply(): CountryCodeAlpha2 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CountryCodeAlpha2]
  }
  
  @scala.inline
  implicit class CountryCodeAlpha2MutableBuilder[Self <: CountryCodeAlpha2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOptions(value: UpdateExisting): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
