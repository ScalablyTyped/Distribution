...
trait AnonCompanyCustomFieldsEmail extends js.Object {
...
object AnonCompanyCustomFieldsEmail {
  @scala.inline
  def apply(
    company: String = null,
    ...
    __obj.asInstanceOf[AnonCompanyCustomFieldsEmail]
  }
}
