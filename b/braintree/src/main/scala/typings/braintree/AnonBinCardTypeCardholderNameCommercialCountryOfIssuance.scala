...
trait AnonBinCardTypeCardholderNameCommercialCountryOfIssuance extends js.Object {
  var bin: String
  var cardType: String
...
object AnonBinCardTypeCardholderNameCommercialCountryOfIssuance {
  @scala.inline
  def apply(
    bin: String,
    cardType: String,
    ...
    token: String
  ): AnonBinCardTypeCardholderNameCommercialCountryOfIssuance = {
    ...
    __obj.asInstanceOf[AnonBinCardTypeCardholderNameCommercialCountryOfIssuance]
  }
}
