...
object SubscriptionRequest {
  ...
  inline def apply(paymentMethodToken: String, planId: String): SubscriptionRequest = {
  ...
  extension [Self <: SubscriptionRequest](x: Self) {
    ...
    inline def setFirstBillingDate(value: Date): Self = StObject.set(x, "firstBillingDate", value.asInstanceOf[js.Any])
