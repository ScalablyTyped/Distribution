...
object CustomerUpdateRequest {
  ...
  implicit class CustomerUpdateRequestOps[Self <: CustomerUpdateRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCreditCard(value: CreditCardUpdateRequest): Self = this.set("creditCard", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefaultPaymentMethodToken(value: String): Self = this.set("defaultPaymentMethodToken", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDefaultPaymentMethodToken: Self = this.set("defaultPaymentMethodToken", js.undefined)
