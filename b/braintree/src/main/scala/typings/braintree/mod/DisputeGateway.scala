...
import typings.braintree.AnonCategoryContent
...
trait DisputeGateway extends js.Object {
  ...
  def addTextEvidence(disputeId: String, evidence: AnonCategoryContent): js.Promise[ValidatedResponse[Evidence]]
...
object DisputeGateway {
  ...
  def apply(
    ...
    addTextEvidence: (String, AnonCategoryContent) => js.Promise[ValidatedResponse[Evidence]],
