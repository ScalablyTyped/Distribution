...
object GatewayConfig {
  ...
  inline def AccessTokenGatewayConfig(accessToken: String): typings.braintree.mod.AccessTokenGatewayConfig = {
    val __obj = js.Dynamic.literal(accessToken = accessToken.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.braintree.mod.AccessTokenGatewayConfig]
  }
  
  inline def ClientGatewayConfig(clientId: String, clientSecret: String): typings.braintree.mod.ClientGatewayConfig = {
    val __obj = js.Dynamic.literal(clientId = clientId.asInstanceOf[js.Any], clientSecret = clientSecret.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.braintree.mod.ClientGatewayConfig]
  }
  
  inline def KeyGatewayConfig(environment: Environment, merchantId: String, privateKey: String, publicKey: String): typings.braintree.mod.KeyGatewayConfig = {
