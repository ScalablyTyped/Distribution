...
/* Inlined parent std.Partial<braintree.braintree.SubscriptionRequest> */
trait SubscriptionUpdateRequest extends StObject {
...
object SubscriptionUpdateRequest {
  ...
  inline def apply(): SubscriptionUpdateRequest = {
