...
import typings.braintree.Anon_AllowVaulting
...
trait PaymentMethodGateway extends js.Object {
  ...
  def grant(sharedPaymentMethodToken: String, options: Anon_AllowVaulting): js.Promise[String]
...
object PaymentMethodGateway {
  ...
  def apply(
    ...
    grant: (String, Anon_AllowVaulting) => js.Promise[String],
