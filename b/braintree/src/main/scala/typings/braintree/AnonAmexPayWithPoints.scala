...
trait AnonAmexPayWithPoints extends js.Object {
  ...
  var CardTypeIndicators: AnonCommercial
  var Dispute: AnonChargeback
}

object AnonAmexPayWithPoints {
  @scala.inline
  def apply(AmexPayWithPoints: AnonIneligibleCard, CardTypeIndicators: AnonCommercial, Dispute: AnonChargeback): AnonAmexPayWithPoints = {
