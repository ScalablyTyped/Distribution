...
trait AnonBinCardTypeCardholderName extends js.Object {
  var bin: String
  var cardType: String
...
object AnonBinCardTypeCardholderName {
  @scala.inline
  def apply(
    bin: String,
    cardType: String,
    ...
    __obj.asInstanceOf[AnonBinCardTypeCardholderName]
  }
}
