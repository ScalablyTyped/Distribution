...
trait AnonFailOnDuplicatePaymentMethodMakeDefault extends js.Object {
...
object AnonFailOnDuplicatePaymentMethodMakeDefault {
  @scala.inline
  def apply(
  ...
  ): AnonFailOnDuplicatePaymentMethodMakeDefault = {
    ...
    __obj.asInstanceOf[AnonFailOnDuplicatePaymentMethodMakeDefault]
  }
}
