...
trait BinData extends js.Object {
  ...
  var countryOfIssuance: js.UndefOr[java.lang.String] = js.undefined
  ...
  var issuingBank: js.UndefOr[java.lang.String] = js.undefined
...
object BinData {
  ...
  def apply(
    ...
    countryOfIssuance: java.lang.String = null,
    debit: Debit = null,
    durbinRegulated: DurbinRegulated = null,
    healthcare: HealthCare = null,
    issuingBank: java.lang.String = null,
