...
trait HTMLAttributes[T]
  ...
  var hidden: js.UndefOr[Boolean | String] = js.native
  ...
  var itemscope: js.UndefOr[Boolean | String] = js.native
  ...
  var results: js.UndefOr[Double | String] = js.native
...
object HTMLAttributes {
  ...
  implicit class HTMLAttributesMutableBuilder[Self <: HTMLAttributes[_], T] (val x: Self with HTMLAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setHidden(value: Boolean | String): Self = StObject.set(x, "hidden", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setResults(value: Double | String): Self = StObject.set(x, "results", value.asInstanceOf[js.Any])
