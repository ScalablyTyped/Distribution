...
object AllHTMLAttributes {
  ...
  extension [Self <: AllHTMLAttributes[?], T](x: Self & AllHTMLAttributes[T]) {
    ...
    inline def setCols(value: Double | String): Self = StObject.set(x, "cols", value.asInstanceOf[js.Any])
    ...
    inline def setControls(value: Boolean | String): Self = StObject.set(x, "controls", value.asInstanceOf[js.Any])
    ...
    inline def setLoop(value: Boolean | String): Self = StObject.set(x, "loop", value.asInstanceOf[js.Any])
    ...
    inline def setMuted(value: Boolean | String): Self = StObject.set(x, "muted", value.asInstanceOf[js.Any])
    ...
    inline def setSelected(value: Boolean | String): Self = StObject.set(x, "selected", value.asInstanceOf[js.Any])
    ...
    inline def setSpan(value: Double | String): Self = StObject.set(x, "span", value.asInstanceOf[js.Any])
