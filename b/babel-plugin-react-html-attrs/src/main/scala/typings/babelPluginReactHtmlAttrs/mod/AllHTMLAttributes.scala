...
object AllHTMLAttributes {
  ...
  implicit class AllHTMLAttributesMutableBuilder[Self <: AllHTMLAttributes[_], T] (val x: Self with AllHTMLAttributes[T]) extends AnyVal {
    ...
    @scala.inline
    def setCols(value: Double | String): Self = StObject.set(x, "cols", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDefer(value: Boolean | String): Self = StObject.set(x, "defer", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMultiple(value: Boolean | String): Self = StObject.set(x, "multiple", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRequired(value: Boolean | String): Self = StObject.set(x, "required", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSeamless(value: Boolean | String): Self = StObject.set(x, "seamless", value.asInstanceOf[js.Any])
