...
trait ComponentElement[P, T /* <: Component[P, ComponentState, js.Any] */]
  extends StObject
     with ReactElement[P, ComponentClass[P, ComponentState]] {
...
object ComponentElement {
  ...
  @scala.inline
  def apply[P, T /* <: Component[P, ComponentState, js.Any] */](props: P, `type`: ComponentClass[P, ComponentState]): ComponentElement[P, T] = {
