...
trait Options extends CustomOptions {
  ...
  var insertGlobalVars: js.UndefOr[insertDashModuleDashGlobalsLib.insertDashModuleDashGlobalsMod.VarsOption] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    insertGlobalVars: insertDashModuleDashGlobalsLib.insertDashModuleDashGlobalsMod.VarsOption = null,
