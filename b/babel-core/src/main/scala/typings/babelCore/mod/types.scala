...
object types extends js.Object {
  ...
  def TSCallSignatureDeclaration(typeParameters: js.UndefOr[scala.Nothing], parameters: js.Array[Identifier_ | RestElement_]): typings.babelTypes.mod.TSCallSignatureDeclaration = js.native
  def TSCallSignatureDeclaration(
    typeParameters: js.UndefOr[scala.Nothing],
  ...
  def TSConstructorType(typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSTypeAnnotation): typings.babelTypes.mod.TSConstructorType = js.native
  ...
  def TSFunctionType(typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSTypeAnnotation): typings.babelTypes.mod.TSFunctionType = js.native
  ...
  def TSPropertySignature(key: Expression, typeAnnotation: js.UndefOr[scala.Nothing], initializer: Expression): typings.babelTypes.mod.TSPropertySignature = js.native
  ...
  def TSTypeParameter(constraint: js.UndefOr[scala.Nothing], default_ : TSType): typings.babelTypes.mod.TSTypeParameter = js.native
