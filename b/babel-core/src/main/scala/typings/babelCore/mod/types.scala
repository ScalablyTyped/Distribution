...
object types extends js.Object {
  ...
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  ...
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Null, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: Noop_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: js.UndefOr[scala.Nothing], typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Null, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: Noop_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Null, typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: Null, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: Noop_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareFunction(id: Identifier_, typeParameters: TypeParameterDeclaration_, params: js.Array[LVal]): typings.babelTypes.mod.TSDeclareFunction = js.native
  def TSDeclareMethod(
  ...
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], extends_ : Null, body: TSInterfaceBody): typings.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(id: Identifier_, typeParameters: Null, extends_ : js.UndefOr[scala.Nothing], body: TSInterfaceBody): typings.babelTypes.mod.TSInterfaceDeclaration = js.native
  def TSInterfaceDeclaration(
    id: Identifier_,
    typeParameters: Null,
    extends_ : js.Array[TSExpressionWithTypeArguments],
  ...
  def TSTypeAliasDeclaration(id: Identifier_, typeParameters: js.UndefOr[scala.Nothing], typeAnnotation: TSType): typings.babelTypes.mod.TSTypeAliasDeclaration = js.native
