...
object PluginObj {
  ...
  implicit class PluginObjOps[Self <: PluginObj[_], S] (val x: Self with PluginObj[S]) extends AnyVal {
    ...
    @scala.inline
    def setPost(value: js.ThisFunction1[/* this */ S, /* state */ js.Any, Unit]): Self = this.set("post", value.asInstanceOf[js.Any])
    @scala.inline
    def deletePost: Self = this.set("post", js.undefined)
    @scala.inline
    def setPre(value: js.ThisFunction1[/* this */ S, /* state */ js.Any, Unit]): Self = this.set("pre", value.asInstanceOf[js.Any])
    @scala.inline
