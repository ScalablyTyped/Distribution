...
object ^ extends js.Object {
  def abs(n: bignumLib.bignumMod.BigNumNs.BigNumCompatible): BigNum = js.native
  def add(
  ...
  def gcd(left: bignumLib.bignumMod.BigNumNs.BigNumCompatible, right: BigNum): BigNum = js.native
  def ge(
    left: bignumLib.bignumMod.BigNumNs.BigNumCompatible,
    right: bignumLib.bignumMod.BigNumNs.BigNumCompatible
  ): scala.Boolean = js.native
  ...
  def invertm(n: bignumLib.bignumMod.BigNumNs.BigNumCompatible, m: bignumLib.bignumMod.BigNumNs.BigNumCompatible): BigNum = js.native
  def jacobi(a: bignumLib.bignumMod.BigNumNs.BigNumCompatible, n: BigNum): scala.Double = js.native
  def le(
    left: bignumLib.bignumMod.BigNumNs.BigNumCompatible,
    right: bignumLib.bignumMod.BigNumNs.BigNumCompatible
  ): scala.Boolean = js.native
  ...
  def neg(n: bignumLib.bignumMod.BigNumNs.BigNumCompatible): BigNum = js.native
  def or(
    left: bignumLib.bignumMod.BigNumNs.BigNumCompatible,
    right: bignumLib.bignumMod.BigNumNs.BigNumCompatible
  ): BigNum = js.native
  ...
  def rand(n: bignumLib.bignumMod.BigNumNs.BigNumCompatible): BigNum = js.native
  def rand(
