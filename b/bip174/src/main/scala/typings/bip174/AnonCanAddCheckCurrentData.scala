...
trait AnonCanAddCheckCurrentData extends js.Object {
  var expected: String
...
object AnonCanAddCheckCurrentData {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCanAddCheckCurrentData]
  }
}
