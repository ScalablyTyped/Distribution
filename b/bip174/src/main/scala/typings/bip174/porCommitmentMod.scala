...
object porCommitmentMod {
  ...
  inline def check(data: js.Any): /* is bip174.bip174/src/lib/interfaces.PorCommitment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("check")(data.asInstanceOf[js.Any]).asInstanceOf[/* is bip174.bip174/src/lib/interfaces.PorCommitment */ Boolean]
