...
object entityMod {
  ...
  object File {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.backlogJs.entityMod.File.NodeFileData
      - typings.backlogJs.entityMod.File.BrowserFileData
    */
    trait FileData extends StObject
    object FileData {
      
      inline def BrowserFileData(body: Any, url: String): typings.backlogJs.entityMod.File.BrowserFileData = {
        val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.backlogJs.entityMod.File.BrowserFileData]
      }
      
      inline def NodeFileData(body: PassThrough, filename: String, url: String): typings.backlogJs.entityMod.File.NodeFileData = {
        ...
        __obj.asInstanceOf[typings.backlogJs.entityMod.File.NodeFileData]
      }
    }
