...
object Entity {
  ...
  object File {
    ...
    object BrowserFileData {
      ...
      inline def apply(body: js.Any, url: String): BrowserFileData = {
    ...
    */
    ...
    object FileData {
      ...
      inline def BrowserFileData(body: js.Any, url: String): typings.backlogJs.mod.Entity.File.BrowserFileData = {
        val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
        __obj.asInstanceOf[typings.backlogJs.mod.Entity.File.BrowserFileData]
      }
      
      inline def NodeFileData(body: PassThrough, filename: String, url: String): typings.backlogJs.mod.Entity.File.NodeFileData = {
