...
trait BlocksArray extends BlocksObservable {
  ...
  /**
  	 ...
  	 */
  def add(value: js.Any, index: scala.Double): BlocksArray = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def addMany(value: js.Array[_], index: scala.Double): BlocksArray = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def move(sourceIndex: scala.Double, targetIndex: scala.Double): BlocksArray = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def removeAt(index: scala.Double): BlocksArray = js.native
  /**
  	 * @param index The index location of the item that will be removed
  	 * @param count Optional parameter that if specified will remove the next items starting from the specified index
  	 */
  def removeAt(index: scala.Double, count: scala.Double): BlocksArray = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def slice(start: scala.Double): js.Array[_] = js.native
  /**
  	 * @param start An integer that specifies where to start the selection (The first element has an index of 0)
  ...
  /**
  	 ...
  	 */
  def splice(index: scala.Double, howMany: scala.Double, items: js.Any*): js.Array[_] = js.native
  /**
  	 ...
  	 */
  def swap(indexA: scala.Double, indexB: scala.Double): BlocksArray = js.native
  /**
