...
trait Exchange extends js.Object {
  /**
    ...
    * @return {string} - 订单ID
    */
  def Buy(Price: scala.Double, Amount: scala.Double, args: js.Any*): java.lang.String = js.native
  /**
    ...
    * @return {boolean}
    */
  def CancelOrder(orderId: java.lang.String): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @return {string}
    */
  def GetBaseCurrency(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @return {number}
    */
  def GetMinPrice(): scala.Double = js.native
  /**
    * 返回币最小交易数量
    *
    * @return {number}
    */
  def GetMinStock(): scala.Double = js.native
  /**
    * 返回交易所名称(string)
    *
    * @return {string}
  ...
  /**
    ...
    * @return {botvs.Order}
    */
  def GetOrder(orderId: java.lang.String): Order = js.native
  /**
  ...
  /**
    ...
    * @return {string}
    */
  def GetRawJSON(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @return {number}
    */
  def GetUSDCNY(): scala.Double = js.native
  /**
    ...
    */
  def Go[T](Method: java.lang.String, Args: js.Any*): AsyncJob[T] = js.native
  def IO[T](Api: java.lang.String): T = js.native
  def IO[T](Api: java.lang.String, ApiName: java.lang.String): T = js.native
  def IO[T](Api: java.lang.String, ApiName: java.lang.String, Args: java.lang.String): T = js.native
  /**
    * 调用交易所其它功能接口
    *
    * 支持所有数字货币交易所
    ...
    */
  @JSName("IO")
  def IO_api[T](Api: botvsLib.botvsLibStrings.api): T = js.native
  @JSName("IO")
  def IO_api[T](Api: botvsLib.botvsLibStrings.api, ApiName: java.lang.String): T = js.native
  @JSName("IO")
  def IO_api[T](Api: botvsLib.botvsLibStrings.api, ApiName: java.lang.String, Args: java.lang.String): T = js.native
  @JSName("IO")
  def IO_cny[T](Api: botvsLib.botvsLibStrings.cny): T = js.native
  @JSName("IO")
  def IO_cny[T](Api: botvsLib.botvsLibStrings.cny, ApiName: java.lang.String): T = js.native
  @JSName("IO")
  def IO_cny[T](Api: botvsLib.botvsLibStrings.cny, ApiName: java.lang.String, Args: java.lang.String): T = js.native
  @JSName("IO")
  def IO_currency[T](Api: botvsLib.botvsLibStrings.currency): T = js.native
  @JSName("IO")
  def IO_currency[T](Api: botvsLib.botvsLibStrings.currency, ApiName: java.lang.String): T = js.native
  @JSName("IO")
  def IO_currency[T](Api: botvsLib.botvsLibStrings.currency, ApiName: java.lang.String, Args: java.lang.String): T = js.native
  @JSName("IO")
  def IO_usd[T](Api: botvsLib.botvsLibStrings.usd): T = js.native
  @JSName("IO")
  def IO_usd[T](Api: botvsLib.botvsLibStrings.usd, ApiName: java.lang.String): T = js.native
  @JSName("IO")
  def IO_usd[T](Api: botvsLib.botvsLibStrings.usd, ApiName: java.lang.String, Args: java.lang.String): T = js.native
  /**
    ...
    * @param {number} amount
    */
  def Log(logType: VLogType, orderId: java.lang.String, price: scala.Double, amount: scala.Double): scala.Unit = js.native
  /**
    ...
    * @return {string}
    */
  def Sell(Price: scala.Double, Amount: scala.Double): java.lang.String = js.native
  /**
    * 设置合约类型
    *
    ...
    */
  def SetContractType(ContractType: java.lang.String): scala.Unit = js.native
  /**
    * 设置Buy或者Sell下单类型
    *
    ...
    */
  @JSName("SetDirection")
  def SetDirection_buy(Direction: botvsLib.botvsLibStrings.buy): scala.Unit = js.native
  @JSName("SetDirection")
  ...
  /**
    ...
    */
  def SetMarginLevel(MarginLevel: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def SetPrecision(PricePrecision: scala.Double, AmountPrecision: scala.Double): scala.Unit = js.native
  /**
    ...
    * @param {number} rate
    */
  def SetRate(): scala.Unit = js.native
