...
trait Anon_BottomText extends js.Object {
...
object Anon_BottomText {
  ...
  def apply(
    ...
    if (!js.isUndefined(closeOnConfirm)) __obj.updateDynamic("closeOnConfirm")(closeOnConfirm)
    if (confirmText != null) __obj.updateDynamic("confirmText")(confirmText)
    if (!js.isUndefined(confirmable)) __obj.updateDynamic("confirmable")(confirmable)
    ...
    if (!js.isUndefined(showConfirm)) __obj.updateDynamic("showConfirm")(showConfirm)
    if (!js.isUndefined(showFooter)) __obj.updateDynamic("showFooter")(showFooter)
    if (title != null) __obj.updateDynamic("title")(title)
    if (width != null) __obj.updateDynamic("width")(width.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_BottomText]
  }
}
