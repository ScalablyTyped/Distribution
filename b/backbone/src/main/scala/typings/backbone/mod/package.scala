...
package object mod {
  ...
  @scala.inline
  def Events: typings.backbone.mod.Events = typings.backbone.mod.^.asInstanceOf[js.Dynamic].selectDynamic("Events").asInstanceOf[typings.backbone.mod.Events]
  ...
  def sync(
    ...
    model: typings.backbone.mod.Collection[typings.backbone.mod.Model[_, typings.backbone.mod.ModelSetOptions, js.Object]]
  ...
  def sync(
    method: java.lang.String,
    model: typings.backbone.mod.Model[_, typings.backbone.mod.ModelSetOptions, js.Object]
  ): js.Any = (typings.backbone.mod.^.asInstanceOf[js.Dynamic].applyDynamic("sync")(method.asInstanceOf[js.Any], model.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def sync(
    method: java.lang.String,
