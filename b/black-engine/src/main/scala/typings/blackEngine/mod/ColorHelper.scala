...
open class ColorHelper ()
  extends typings.blackEngine.colorHelperMod.ColorHelper
/* static members */
object ColorHelper {
  ...
  inline def hex2rgb(hex: Double): typings.blackEngine.colorHelperMod.RGB = ^.asInstanceOf[js.Dynamic].applyDynamic("hex2rgb")(hex.asInstanceOf[js.Any]).asInstanceOf[typings.blackEngine.colorHelperMod.RGB]
  ...
  inline def hsv2rgb(hsv: typings.blackEngine.colorHelperMod.HSV): typings.blackEngine.colorHelperMod.RGB = ^.asInstanceOf[js.Dynamic].applyDynamic("hsv2rgb")(hsv.asInstanceOf[js.Any]).asInstanceOf[typings.blackEngine.colorHelperMod.RGB]
  ...
  inline def rgb2hex(rgb: typings.blackEngine.colorHelperMod.RGB): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("rgb2hex")(rgb.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  inline def rgb2hsv(rgb: typings.blackEngine.colorHelperMod.RGB): typings.blackEngine.colorHelperMod.HSV = ^.asInstanceOf[js.Dynamic].applyDynamic("rgb2hsv")(rgb.asInstanceOf[js.Any]).asInstanceOf[typings.blackEngine.colorHelperMod.HSV]
}
