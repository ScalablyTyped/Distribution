...
open class Rectangle ()
  extends typings.blackEngine.rectangleMod.Rectangle {
...
object Rectangle {
  ...
  @js.native
  val cache: typings.blackEngine.rectangleMod.Rectangle = js.native
  
  inline def fromPoints(points: js.Array[typings.blackEngine.vectorMod.Vector]): typings.blackEngine.rectangleMod.Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(points.asInstanceOf[js.Any]).asInstanceOf[typings.blackEngine.rectangleMod.Rectangle]
  
  inline def fromPointsXY(points: js.Array[Double]): typings.blackEngine.rectangleMod.Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPointsXY")(points.asInstanceOf[js.Any]).asInstanceOf[typings.blackEngine.rectangleMod.Rectangle]
