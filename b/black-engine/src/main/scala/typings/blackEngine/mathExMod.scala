...
object mathExMod {
  ...
  @JSImport("black-engine/math/MathEx", "MathEx")
  @js.native
  open class MathEx () extends StObject
  /* static members */
  object MathEx {
    ...
    @JSImport("black-engine/math/MathEx", "MathEx.DEG2RAD")
    @js.native
    val DEG2RAD: Double = js.native
    
    @JSImport("black-engine/math/MathEx", "MathEx.PI2")
    @js.native
    val PI2: Double = js.native
    
    @JSImport("black-engine/math/MathEx", "MathEx.PI_Q")
    @js.native
    val PI_Q: Double = js.native
    
    @JSImport("black-engine/math/MathEx", "MathEx.RAD2DEG")
    @js.native
