...
@js.native
class EditableText ()
  extends atBlueprintjsCoreLib.libEsmComponentsEditableDashTextEditableTextMod.EditableText {
  def this(props: atBlueprintjsCoreLib.libEsmComponentsEditableDashTextEditableTextMod.IEditableTextProps) = this()
