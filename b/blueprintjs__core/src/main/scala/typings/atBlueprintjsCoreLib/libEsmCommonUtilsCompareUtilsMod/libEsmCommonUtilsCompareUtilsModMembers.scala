...
object libEsmCommonUtilsCompareUtilsModMembers extends js.Object {
  ...
  def getShallowUnequalKeyValues[T /* <: js.Object */](objA: T, objB: T, keys: IKeyBlacklist[T]): js.Array[atBlueprintjsCoreLib.Anon_ValueA] = js.native
  def getShallowUnequalKeyValues[T /* <: js.Object */](objA: T, objB: T, keys: IKeyWhitelist[T]): js.Array[atBlueprintjsCoreLib.Anon_ValueA] = js.native
