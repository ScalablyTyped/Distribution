...
@js.native
trait Anon_ComponentDidMountComponentWillReceiveProps extends js.Object {
  ...
  def renderContextMenu(e: reactLib.reactMod.ReactNs.MouseEvent[reactLib.HTMLElement]): reactLib.reactMod.Global.JSXNs.Element = js.native
