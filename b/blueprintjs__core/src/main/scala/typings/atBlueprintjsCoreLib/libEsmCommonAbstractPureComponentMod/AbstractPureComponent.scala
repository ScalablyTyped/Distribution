package typings
package atBlueprintjsCoreLib.libEsmCommonAbstractPureComponentMod
...
abstract class AbstractPureComponent[P, S] ()
  ...
  def componentWillReceiveProps_MAbstractPureComponent(nextProps: P with atBlueprintjsCoreLib.Anon_Children): scala.Unit = js.native
  @JSName("componentWillUnmount")
  def componentWillUnmount_MAbstractPureComponent(): scala.Unit = js.native
  /**
