...
object atBlueprintjsCoreLibStrings {
  ...
  @js.native
  sealed trait auto
    extends atBlueprintjsCoreLib.libEsmComponentsPopoverPopoverSharedPropsMod.PopoverPosition
  ...
  sealed trait bottom
    extends atBlueprintjsCoreLib.libEsmComponentsPopoverPopoverSharedPropsMod.PopoverPosition
       with atBlueprintjsCoreLib.libEsmCommonPositionMod.Position
       with atBlueprintjsCoreLib.libEsmComponentsToastToasterMod.ToasterPosition
  ...
  @js.native
  sealed trait click
    extends atBlueprintjsCoreLib.libEsmComponentsPopoverPopoverMod.PopoverInteractionKind
  ...
  @js.native
  sealed trait danger
    extends atBlueprintjsCoreLib.libEsmCommonIntentMod.Intent
  ...
  @js.native
  sealed trait end
    extends atBlueprintjsCoreLib.libEsmCommonBoundaryMod.Boundary
       with atBlueprintjsCoreLib.libEsmComponentsSliderHandlePropsMod.HandleType
  ...
  @js.native
  sealed trait full
    extends atBlueprintjsCoreLib.libEsmComponentsSliderHandlePropsMod.HandleType
  ...
  @js.native
  sealed trait lock
    extends atBlueprintjsCoreLib.libEsmComponentsSliderHandlePropsMod.HandleInteractionKind
  ...
  sealed trait none
    extends atBlueprintjsCoreLib.libEsmComponentsSliderHandlePropsMod.HandleInteractionKind
       with atBlueprintjsCoreLib.libEsmCommonIntentMod.Intent
