...
@js.native
class PanelStack ()
  extends atBlueprintjsCoreLib.libEsmCommonAbstractPureComponentMod.AbstractPureComponent[IPanelStackProps, IPanelStackState] {
  var handlePanelClose: js.Any = js.native
  var handlePanelOpen: js.Any = js.native
  @JSName("componentWillReceiveProps")
  def componentWillReceiveProps_MPanelStack(nextProps: IPanelStackProps): scala.Unit = js.native
