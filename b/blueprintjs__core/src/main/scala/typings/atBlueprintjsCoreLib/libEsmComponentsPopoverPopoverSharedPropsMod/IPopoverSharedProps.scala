...
trait IPopoverSharedProps
  ...
  /**
       ...
       * @default "span"
       */
  var targetTagName: js.UndefOr[/* LimitUnionLength: was union type with length 170 */java.lang.String] = js.undefined
  /**
       * HTML tag name for the wrapper element, which also receives the
       * `className` prop.
       * @default "span"
       */
  var wrapperTagName: js.UndefOr[/* LimitUnionLength: was union type with length 170 */java.lang.String] = js.undefined
}
