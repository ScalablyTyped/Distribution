...
import typings.atBlueprintjsCore.libEsmComponentsSliderMultiSliderMod.IChildrenProps
...
@js.native
class MultiSlider ()
  extends typings.atBlueprintjsCore.libEsmComponentsSliderMultiSliderMod.MultiSlider
