...
import typings.atBlueprintjsCore.libEsmComponentsFormsNumericInputMod.INumericInputState
...
@js.native
class NumericInput ()
  extends typings.atBlueprintjsCore.libEsmComponentsFormsNumericInputMod.NumericInput
