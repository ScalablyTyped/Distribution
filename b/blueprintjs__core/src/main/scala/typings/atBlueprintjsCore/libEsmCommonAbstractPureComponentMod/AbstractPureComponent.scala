package typings.atBlueprintjsCore.libEsmCommonAbstractPureComponentMod
...
abstract class AbstractPureComponent[P, S] ()
  ...
  def componentWillReceiveProps_MAbstractPureComponent(nextProps: P with Anon_Children): Unit = js.native
