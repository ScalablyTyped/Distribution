...
- typings.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait ITextAreaProps
...
object ITextAreaProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(growVertically)) __obj.updateDynamic("growVertically")(growVertically.get.asInstanceOf[js.Any])
