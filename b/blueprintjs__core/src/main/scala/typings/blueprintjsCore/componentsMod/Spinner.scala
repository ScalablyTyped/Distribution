...
class Spinner protected ()
  extends typings.blueprintjsCore.spinnerMod.Spinner {
...
object Spinner {
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "Spinner.SIZE_LARGE")
  @js.native
  val SIZE_LARGE: /* 100 */ Double = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/components", "Spinner.SIZE_SMALL")
  @js.native
  val SIZE_SMALL: /* 20 */ Double = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/components", "Spinner.SIZE_STANDARD")
  @js.native
