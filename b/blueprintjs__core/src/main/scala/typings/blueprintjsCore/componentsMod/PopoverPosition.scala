...
object PopoverPosition {
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.AUTO")
  @js.native
  def AUTO: auto = js.native
  inline def AUTO_=(x: auto): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AUTO")(x.asInstanceOf[js.Any])
  
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.AUTO_END")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.AUTO_START")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.BOTTOM")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.BOTTOM_LEFT")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.BOTTOM_RIGHT")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.LEFT")
  @js.native
  def LEFT: left = js.native
  inline def LEFT_=(x: left): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LEFT")(x.asInstanceOf[js.Any])
  
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.LEFT_BOTTOM")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.LEFT_TOP")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.RIGHT")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.RIGHT_BOTTOM")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.RIGHT_TOP")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.TOP")
  @js.native
  def TOP: top = js.native
  inline def TOP_=(x: top): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOP")(x.asInstanceOf[js.Any])
  
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.TOP_LEFT")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/components", "PopoverPosition.TOP_RIGHT")
  @js.native
