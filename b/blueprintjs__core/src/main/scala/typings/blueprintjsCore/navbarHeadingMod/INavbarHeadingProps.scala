package typings.blueprintjsCore.navbarHeadingMod
...
- typings.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarHeadingProps extends HTMLAttributes[HTMLDivElement]
