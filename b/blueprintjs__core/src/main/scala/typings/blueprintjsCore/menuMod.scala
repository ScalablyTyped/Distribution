...
object menuMod {
  ...
  object IMenuProps {
    ...
    implicit class IMenuPropsMutableBuilder[Self <: IMenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setUlRef(value: /* ref */ HTMLUListElement | Null => js.Any): Self = StObject.set(x, "ulRef", js.Any.fromFunction1(value))
