...
object navbarDividerMod {
  ...
  object INavbarDividerProps {
    ...
    @scala.inline
    implicit class INavbarDividerPropsMutableBuilder[Self <: INavbarDividerProps] (val x: Self) extends AnyVal {
