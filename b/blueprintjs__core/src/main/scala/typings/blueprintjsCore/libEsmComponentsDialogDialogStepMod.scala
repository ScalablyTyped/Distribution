...
object libEsmComponentsDialogDialogStepMod {
  ...
  object IDialogStepProps {
    ...
    inline def apply(id: DialogStepId, panel: Element): IDialogStepProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], panel = panel.asInstanceOf[js.Any])
      __obj.asInstanceOf[IDialogStepProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: IDialogStepProps] (val x: Self) extends AnyVal {
