...
object IElementRefProps {
  @scala.inline
  def apply[/* <: typings.std.HTMLElement */ E](): IElementRefProps[E] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IElementRefProps[E]]
  }
  @scala.inline
  implicit class IElementRefPropsOps[Self <: IElementRefProps[_], /* <: typings.std.HTMLElement */ E] (val x: Self with IElementRefProps[E]) extends AnyVal {
    @scala.inline
