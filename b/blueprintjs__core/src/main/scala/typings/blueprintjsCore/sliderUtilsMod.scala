...
object sliderUtilsMod {
  ...
  inline def argMin[T](values: js.Array[T], argFn: js.Function1[/* value */ T, js.Any]): js.UndefOr[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("argMin")(values.asInstanceOf[js.Any], argFn.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[T]]
