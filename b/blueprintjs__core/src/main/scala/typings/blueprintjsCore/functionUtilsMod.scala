...
object functionUtilsMod {
  ...
  @JSImport("@blueprintjs/core/lib/esm/common/utils/functionUtils", "isFunction")
  @js.native
  def isFunction(value: js.Any): /* is std.Function */ Boolean = js.native
  
  @JSImport("@blueprintjs/core/lib/esm/common/utils/functionUtils", "safeInvoke")
  @js.native
  ...
  @JSImport("@blueprintjs/core/lib/esm/common/utils/functionUtils", "safeInvokeOrValue")
  @js.native
