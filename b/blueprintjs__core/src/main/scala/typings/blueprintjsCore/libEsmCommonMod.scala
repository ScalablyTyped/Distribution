...
object libEsmCommonMod {
  ...
  open class AbstractComponent[P, S] protected ()
    extends typings.blueprintjsCore.libEsmCommonAbstractComponentMod.AbstractComponent[P, S] {
  ...
  open class AbstractComponent2[P, S, SS] protected ()
    extends typings.blueprintjsCore.libEsmCommonAbstractComponent2Mod.AbstractComponent2[P, S, SS] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
  ...
  open class AbstractPureComponent[P, S] protected ()
    extends typings.blueprintjsCore.libEsmCommonAbstractPureComponentMod.AbstractPureComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
  ...
  open class AbstractPureComponent2[P, S, SS] protected ()
    extends typings.blueprintjsCore.libEsmCommonAbstractPureComponent2Mod.AbstractPureComponent2[P, S, SS] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
  }
