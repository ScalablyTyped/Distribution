...
object libEsmCommonAbstractPureComponentMod {
  
  /* note: abstract class */ @JSImport("@blueprintjs/core/lib/esm/common/abstractPureComponent", "AbstractPureComponent")
  @js.native
  open class AbstractPureComponent[P, S] protected () extends PureComponent[P, S, Any] {
