...
- typings.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarProps extends HTMLAttributes[HTMLDivElement] {
  /**
...
object INavbarProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(fixedToTop)) __obj.updateDynamic("fixedToTop")(fixedToTop.get.asInstanceOf[js.Any])
