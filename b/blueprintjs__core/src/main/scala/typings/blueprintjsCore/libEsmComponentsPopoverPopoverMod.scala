...
import typings.blueprintjsCore.libEsmComponentsPopoverPopoverSharedPropsMod.IPopoverSharedProps
...
object libEsmComponentsPopoverPopoverMod {
  ...
  */
  ...
  object IPopoverProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IPopoverProps] (val x: Self) extends AnyVal {
  ...
  object IPopoverState {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: IPopoverState] (val x: Self) extends AnyVal {
