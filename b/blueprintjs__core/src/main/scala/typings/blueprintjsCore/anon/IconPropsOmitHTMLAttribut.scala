...
/* Inlined @blueprintjs/core.@blueprintjs/core/lib/esm/components/icon/icon.IconProps & std.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'title'> */
trait IconPropsOmitHTMLAttribut extends StObject {
