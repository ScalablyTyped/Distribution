...
trait About extends StObject {
  ...
  var inputMode: js.UndefOr[search | none | text | tel | url | email | numeric | decimal] = js.undefined
...
object About {
  ...
  extension [Self <: About](x: Self) {
    ...
    inline def setInputMode(value: search | none | text | tel | url | email | numeric | decimal): Self = StObject.set(x, "inputMode", value.asInstanceOf[js.Any])
