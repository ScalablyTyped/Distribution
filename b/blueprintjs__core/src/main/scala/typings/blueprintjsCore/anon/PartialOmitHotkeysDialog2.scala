...
/* Inlined std.Partial<std.Omit<@blueprintjs/core.@blueprintjs/core/lib/esm/components/hotkeys/hotkeysDialog2.HotkeysDialog2Props, 'hotkeys'>> */
trait PartialOmitHotkeysDialog2 extends StObject {
...
object PartialOmitHotkeysDialog2 {
  
  inline def apply(): PartialOmitHotkeysDialog2 = {
