...
/* Inlined @blueprintjs/core.@blueprintjs/core/lib/esm/components/text/text.TextProps & std.Omit<react.react.HTMLAttributes<std.HTMLElement>, 'title'> */
trait TextPropsOmitHTMLAttribut extends StObject {
...
object TextPropsOmitHTMLAttribut {
  
  inline def apply(): TextPropsOmitHTMLAttribut = {
