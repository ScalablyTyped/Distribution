...
/* Inlined react.react.HTMLProps<std.HTMLLabelElement> & @blueprintjs/core.@blueprintjs/core/lib/esm/common.IElementRefProps<std.HTMLLabelElement> & {  children :react.react.ReactNode | undefined} */
trait HTMLPropsHTMLLabelElement extends StObject {
  ...
  var elementRef: js.UndefOr[Ref[HTMLLabelElement]] = js.undefined
...
object HTMLPropsHTMLLabelElement {
  
  inline def apply(): HTMLPropsHTMLLabelElement = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLPropsHTMLLabelElement]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HTMLPropsHTMLLabelElement] (val x: Self) extends AnyVal {
    ...
    inline def setElementRef(value: Ref[HTMLLabelElement]): Self = StObject.set(x, "elementRef", value.asInstanceOf[js.Any])
    
    inline def setElementRefFunction1(value: /* instance */ HTMLLabelElement | Null => Unit): Self = StObject.set(x, "elementRef", js.Any.fromFunction1(value))
