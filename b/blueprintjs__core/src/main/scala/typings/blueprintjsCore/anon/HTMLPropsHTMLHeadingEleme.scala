...
/* Inlined react.react.HTMLProps<std.HTMLHeadingElement> & @blueprintjs/core.@blueprintjs/core/lib/esm/common.IElementRefProps<std.HTMLHeadingElement> & {  children :react.react.ReactNode | undefined} */
trait HTMLPropsHTMLHeadingEleme extends StObject {
  ...
  var elementRef: js.UndefOr[Ref[HTMLHeadingElement]] = js.undefined
...
object HTMLPropsHTMLHeadingEleme {
  
  inline def apply(): HTMLPropsHTMLHeadingEleme = {
  ...
  extension [Self <: HTMLPropsHTMLHeadingEleme](x: Self) {
    ...
    inline def setElementRef(value: Ref[HTMLHeadingElement]): Self = StObject.set(x, "elementRef", value.asInstanceOf[js.Any])
    
    inline def setElementRefFunction1(value: /* instance */ HTMLHeadingElement | Null => Unit): Self = StObject.set(x, "elementRef", js.Any.fromFunction1(value))
