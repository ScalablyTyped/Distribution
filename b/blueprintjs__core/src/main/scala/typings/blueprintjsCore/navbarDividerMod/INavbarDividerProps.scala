package typings.blueprintjsCore.navbarDividerMod
...
- typings.blueprintjsCore.propsMod.IProps because var conflicts: className. Inlined  */ trait INavbarDividerProps extends HTMLAttributes[HTMLDivElement]
