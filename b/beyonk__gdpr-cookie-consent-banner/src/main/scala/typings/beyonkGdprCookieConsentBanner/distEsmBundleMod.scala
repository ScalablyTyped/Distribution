...
/* augmented module */
object distEsmBundleMod extends Shortcut {
  
  @JSImport("@beyonk/gdpr-cookie-consent-banner/dist/esm/bundle", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distEsmBundleMod.foo` */
