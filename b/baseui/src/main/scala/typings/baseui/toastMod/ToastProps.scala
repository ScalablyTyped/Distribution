...
import typings.baseui.Anon_Dismiss
...
trait ToastProps extends js.Object {
  ...
  var children: js.UndefOr[(js.Function1[/* args */ Anon_Dismiss, ReactNode]) | ReactNode] = js.undefined
...
object ToastProps {
  ...
  def apply(
    ...
    children: (js.Function1[/* args */ Anon_Dismiss, ReactNode]) | ReactNode = null,
