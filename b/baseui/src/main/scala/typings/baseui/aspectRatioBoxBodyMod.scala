...
object aspectRatioBoxBodyMod extends Shortcut {
  ...
  trait AspectRatioBoxBodyComponentType[D /* <: ElementType[Any] */] extends StObject {
    ...
    def apply[C /* <: ElementType[Any] */](
      props: BlockProps[C] & (Omit[
          ...
          /* keyof baseui.baseui/block/types.BlockProps<react.react.ElementType<any>> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 68 */ Any
        ])
    ): Element = js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `aspectRatioBoxBodyMod.foo` */
