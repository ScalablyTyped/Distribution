...
object styled_td extends js.Object {
  def apply[P /* <: js.Object */, T](component: td_, styledFn: js.Function1[/* props */ AnonTheme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[td_], 
      Exclude[/* keyof react.react.ComponentProps<'td'> */ String, AnonClassName]
    ]) with P
  ] = js.native
  def apply[P /* <: js.Object */, T](component: td_, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[td_], 
      Exclude[/* keyof react.react.ComponentProps<'td'> */ String, AnonClassName]
    ]) with P
