...
object phoneInputConstantsMod {
  
  object COUNTRIES {
    
    @JSImport("baseui/phone-input/constants", "COUNTRIES.AD")
    @js.native
  ...
  @JSImport("baseui/phone-input/constants", "DEFAULT_MAX_DROPDOWN_WIDTH")
  @js.native
  val DEFAULT_MAX_DROPDOWN_WIDTH: /* "400px" */ String = js.native
  
  object SIZE extends Shortcut {
    
    @JSImport("baseui/phone-input/constants", "SIZE.default")
    @js.native
    val default: default_ = js.native
    
    @JSImport("baseui/phone-input/constants", "SIZE.compact")
    @js.native
    val compact: typings.baseui.baseuiStrings.compact = js.native
    
    @JSImport("baseui/phone-input/constants", "SIZE.large")
    @js.native
    val large: large_ = js.native
    
    @JSImport("baseui/phone-input/constants", "SIZE.mini")
    @js.native
  ...
  object STATE_CHANGE_TYPE {
    ...
    @JSImport("baseui/phone-input/constants", "STATE_CHANGE_TYPE.countryChange")
    @js.native
    val countryChange: typings.baseui.baseuiStrings.countryChange = js.native
    
    @JSImport("baseui/phone-input/constants", "STATE_CHANGE_TYPE.textChange")
    @js.native
