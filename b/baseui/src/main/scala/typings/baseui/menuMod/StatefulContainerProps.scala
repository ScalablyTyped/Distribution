...
object StatefulContainerProps {
  ...
  inline def apply(items: ItemsT): StatefulContainerProps = {
  ...
  extension [Self <: StatefulContainerProps](x: Self) {
    ...
    inline def setAddMenuToNesting(value: /* ref */ Ref[HTMLElement] => Unit): Self = StObject.set(x, "addMenuToNesting", js.Any.fromFunction1(value))
    ...
    inline def setGetChildMenu(value: /* ref */ Ref[HTMLElement] => Unit): Self = StObject.set(x, "getChildMenu", js.Any.fromFunction1(value))
    
    inline def setGetChildMenuUndefined: Self = StObject.set(x, "getChildMenu", js.undefined)
    
    inline def setGetParentMenu(value: /* ref */ Ref[HTMLElement] => Unit): Self = StObject.set(x, "getParentMenu", js.Any.fromFunction1(value))
    ...
    inline def setRemoveMenuFromNesting(value: /* ref */ Ref[HTMLElement] => Unit): Self = StObject.set(x, "removeMenuFromNesting", js.Any.fromFunction1(value))
