...
object snackbarStyledComponentsMod {
  
  @JSImport("baseui/snackbar/styled-components", "StyledActionButtonContainer")
  @js.native
  val StyledActionButtonContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledContent")
  @js.native
  val StyledContent: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledMessage")
  @js.native
  val StyledMessage: StyletronComponent[p, HasSuffix] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledPlacementContainer")
  @js.native
  val StyledPlacementContainer: StyletronComponent[div, Animating] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledSpinner")
  @js.native
  val StyledSpinner: StyletronComponent[i, heightnumberwidthnumberSp] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledStartEnhancerContainer")
  @js.native
  val StyledStartEnhancerContainer: StyletronComponent[span, js.Object] = js.native
  
  @JSImport("baseui/snackbar/styled-components", "StyledWrapActionButtonContainer")
  @js.native
