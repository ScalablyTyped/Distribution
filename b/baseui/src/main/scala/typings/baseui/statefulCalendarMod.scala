...
object statefulCalendarMod {
  ...
  trait DatepickerProps[T] extends StObject {
    ...
    var onChange: js.UndefOr[js.Function1[/* a */ `7`, Any]] = js.undefined
    ...
    var onMonthChange: js.UndefOr[js.Function1[/* a */ `9`[T], Any]] = js.undefined
    
    var onQuickSelectChange: js.UndefOr[js.Function1[/* option */ js.UndefOr[QuickSelectOption[T]], Any]] = js.undefined
    
    var onRangeChange: js.UndefOr[js.Function1[/* a */ `8`, Any]] = js.undefined
    
    var onYearChange: js.UndefOr[js.Function1[/* a */ `9`[T], Any]] = js.undefined
  ...
  object DatepickerProps {
    ...
    extension [Self <: DatepickerProps[?], T](x: Self & DatepickerProps[T]) {
      ...
      inline def setOnChange(value: /* a */ `7` => Any): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnMonthChange(value: /* a */ `9`[T] => Any): Self = StObject.set(x, "onMonthChange", js.Any.fromFunction1(value))
      ...
      inline def setOnRangeChange(value: /* a */ `8` => Any): Self = StObject.set(x, "onRangeChange", js.Any.fromFunction1(value))
      
      inline def setOnRangeChangeUndefined: Self = StObject.set(x, "onRangeChange", js.undefined)
      
      inline def setOnYearChange(value: /* a */ `9`[T] => Any): Self = StObject.set(x, "onYearChange", js.Any.fromFunction1(value))
