...
object ratingStyledComponentsMod {
  
  @JSImport("baseui/rating/styled-components", "StyledEmoticon")
  @js.native
  val StyledEmoticon: StyletronComponent[li_, StyledRatingItemProps] = js.native
  
  @JSImport("baseui/rating/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[ul, StyledRootProps] = js.native
  
  @JSImport("baseui/rating/styled-components", "StyledStar")
  @js.native
