...
object accordionTypesMod {
  ...
  - typings.baseui.accordionTypesMod.SharedPanelProps because var conflicts: onChange. Inlined children, disabled, `aria-controls`, key, onClick, onKeyDown, overrides, title, renderPanelContent, renderAll */ trait StatefulPanelProps
    extends StObject
       with SharedStatefulPanelContainerProps {
