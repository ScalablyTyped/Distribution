...
object phoneInputPhoneInputNextMod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.aria-describedby")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.aria-label")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.aria-labelledby")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.clearable")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.countries")
      @js.native
      def countries: AD = js.native
      inline def countries_=(x: AD): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("countries")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.country")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.disabled")
      @js.native
      def disabled: Boolean = js.native
      inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.error")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.focusLock")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.id")
      @js.native
      def id: Any = js.native
      inline def id_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.maxDropdownHeight")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.maxDropdownWidth")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.name")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.positive")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.required")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.size")
      @js.native
      ...
      @JSImport("baseui/phone-input/phone-input-next", "default.defaultProps.text")
      @js.native
