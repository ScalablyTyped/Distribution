...
object phoneInputBaseCountryPickerMod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.disabled")
      @js.native
      def disabled: Boolean = js.native
      inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.error")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.inputRef")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.maxDropdownHeight")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.maxDropdownWidth")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.positive")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.required")
      @js.native
      ...
      @JSImport("baseui/phone-input/base-country-picker", "default.defaultProps.size")
      @js.native
