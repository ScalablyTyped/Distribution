...
object statefulPinCodeMod {
  ...
  object default {
    ...
    @JSImport("baseui/pin-code/stateful-pin-code", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object defaultProps {
      
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.aria-describedby")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.aria-label")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.aria-labelledby")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.autoComplete")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.autoFocus")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.disabled")
      @js.native
      def disabled: Boolean = js.native
      inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.error")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.id")
      @js.native
      def id: Any = js.native
      inline def id_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.manageFocus")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.mask")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.name")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.placeholder")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.positive")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.required")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.size")
      @js.native
      ...
      @JSImport("baseui/pin-code/stateful-pin-code", "default.defaultProps.values")
      @js.native
