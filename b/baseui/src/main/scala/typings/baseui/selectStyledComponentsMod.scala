...
object selectStyledComponentsMod {
  ...
  @js.native
  val StyledLoadingIndicator: StyletronComponent[i, SpinnerProps] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledOptionContent")
  @js.native
  val StyledOptionContent: StyletronComponent[div, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledPlaceholder")
  @js.native
  val StyledPlaceholder: StyletronComponent[div, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[div, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledSearchIconContainer")
  @js.native
  val StyledSearchIconContainer: StyletronComponent[div, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledSelectArrow")
  @js.native
  val StyledSelectArrow: StyletronComponent[svg, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledSingleValue")
  @js.native
  val StyledSingleValue: StyletronComponent[div, SharedStylePropsArg] = js.native
  
  @JSImport("baseui/select/styled-components", "StyledValueContainer")
  @js.native
