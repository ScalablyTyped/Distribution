...
trait Anon7DialCode extends js.Object {
  var dialCode: Plussign7
  var id: RU
  var label: `Russia LeftparenthesisРоссияRightparenthesis`
}

object Anon7DialCode {
  @scala.inline
  def apply(dialCode: Plussign7, id: RU, label: `Russia LeftparenthesisРоссияRightparenthesis`): Anon7DialCode = {
    val __obj = js.Dynamic.literal(dialCode = dialCode.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon7DialCode]
  }
}
