...
/* Inlined baseui.baseui/menu/styled-components.StyledProps & {  item :any | undefined} */
trait StyledPropsitemanyundefin extends StObject {
...
object StyledPropsitemanyundefin {
  
  inline def apply(): StyledPropsitemanyundefin = {
