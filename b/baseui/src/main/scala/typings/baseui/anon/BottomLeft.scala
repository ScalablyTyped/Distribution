...
trait BottomLeft extends StObject {
  ...
  val bottomLeft: typings.baseui.baseuiStrings.bottomLeft
  
  val bottomRight: typings.baseui.baseuiStrings.bottomRight
  
  val left: typings.baseui.baseuiStrings.left
  
  val leftBottom: typings.baseui.baseuiStrings.leftBottom
  
  val leftTop: typings.baseui.baseuiStrings.leftTop
  
  val right: typings.baseui.baseuiStrings.right
  
  val rightBottom: typings.baseui.baseuiStrings.rightBottom
  
  val rightTop: typings.baseui.baseuiStrings.rightTop
  
  val top: typings.baseui.baseuiStrings.top
  
  val topLeft: typings.baseui.baseuiStrings.topLeft
  
  val topRight: typings.baseui.baseuiStrings.topRight
}
object BottomLeft {
