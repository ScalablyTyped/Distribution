...
/* Inlined baseui.baseui/input/types.SharedProps & {  $theme :baseui.baseui/styles/types.Theme} */
trait SharedPropsthemeTheme extends StObject {
...
object SharedPropsthemeTheme {
  
  inline def apply(
    $adjoined: typings.baseui.inputTypesMod.Adjoined,
    $size: typings.baseui.inputTypesMod.Size,
    $theme: typings.baseui.stylesTypesMod.Theme
  ): SharedPropsthemeTheme = {
