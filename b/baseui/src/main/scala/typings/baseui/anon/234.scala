...
object `234` {
  ...
  implicit class `234Ops`[Self <: `234`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDialCode(value: Plussign263): Self = this.set("dialCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: ZW): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabel(value: Zimbabwe): Self = this.set("label", value.asInstanceOf[js.Any])
  }
}
