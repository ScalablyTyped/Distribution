...
object StatefulDatepickerPropsDa {
  ...
  inline def apply(): StatefulDatepickerPropsDa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StatefulDatepickerPropsDa]
  }
  
  extension [Self <: StatefulDatepickerPropsDa](x: Self) {
    ...
    inline def setChildren(value: /* args */ DatepickerProps => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    ...
    inline def setExcludeDates(value: js.Array[typings.std.Date]): Self = StObject.set(x, "excludeDates", value.asInstanceOf[js.Any])
    
    inline def setExcludeDatesUndefined: Self = StObject.set(x, "excludeDates", js.undefined)
    
    inline def setExcludeDatesVarargs(value: typings.std.Date*): Self = StObject.set(x, "excludeDates", js.Array(value :_*))
    
    inline def setFilterDate(value: /* day */ typings.std.Date => Boolean): Self = StObject.set(x, "filterDate", js.Any.fromFunction1(value))
    ...
    inline def setHighlightedDate(value: typings.std.Date): Self = StObject.set(x, "highlightedDate", value.asInstanceOf[js.Any])
    
    inline def setHighlightedDateUndefined: Self = StObject.set(x, "highlightedDate", js.undefined)
    
    inline def setIncludeDates(value: js.Array[typings.std.Date]): Self = StObject.set(x, "includeDates", value.asInstanceOf[js.Any])
    
    inline def setIncludeDatesUndefined: Self = StObject.set(x, "includeDates", js.undefined)
    
    inline def setIncludeDatesVarargs(value: typings.std.Date*): Self = StObject.set(x, "includeDates", js.Array(value :_*))
    ...
    inline def setValue(value: typings.std.Date | js.Array[typings.std.Date]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    
    inline def setValueNull: Self = StObject.set(x, "value", null)
    
    inline def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
    
    inline def setValueVarargs(value: typings.std.Date*): Self = StObject.set(x, "value", js.Array(value :_*))
  }
}
