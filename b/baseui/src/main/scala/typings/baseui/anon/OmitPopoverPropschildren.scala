...
object OmitPopoverPropschildren {
  ...
  inline def apply(isOpen: Boolean, placement: TetherPlacement, triggerType: TriggerType): OmitPopoverPropschildren = {
  ...
  extension [Self <: OmitPopoverPropschildren](x: Self) {
