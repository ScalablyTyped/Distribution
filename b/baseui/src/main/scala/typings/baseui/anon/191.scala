...
object `191` {
  ...
  implicit class `191Ops`[Self <: `191`] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDialCode(value: Plussign677): Self = this.set("dialCode", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setId(value: SB): Self = this.set("id", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLabel(value: `Solomon Islands`): Self = this.set("label", value.asInstanceOf[js.Any])
  }
}
