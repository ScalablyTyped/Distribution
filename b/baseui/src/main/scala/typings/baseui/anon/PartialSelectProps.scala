...
import typings.baseui.selectTypesMod.ControlRef
import typings.baseui.selectTypesMod.OnChangeParams
import typings.baseui.selectTypesMod.Options
import typings.baseui.selectTypesMod.SelectOverrides
...
trait PartialSelectProps extends StObject {
  ...
  var filterOptions: js.UndefOr[
    (js.Function4[
      /* options */ typings.baseui.selectTypesMod.Value, 
      /* filterValue */ String, 
      /* excludeOptions */ js.UndefOr[typings.baseui.selectTypesMod.Value | Null], 
      /* a */ LabelKey, 
      typings.baseui.selectTypesMod.Value
    ]) | Null
  ] = js.undefined
  
  var filterOutSelected: js.UndefOr[Boolean] = js.undefined
  
  var getOptionLabel: js.UndefOr[(js.Function1[/* a */ Option, ReactNode]) | Null] = js.undefined
  ...
  var onFocus: js.UndefOr[js.Function1[/* e */ SyntheticEvent[HTMLElement, typings.std.Event], Any]] = js.undefined
  ...
  var size: js.UndefOr[typings.baseui.selectTypesMod.Size] = js.undefined
  
  var startOpen: js.UndefOr[Boolean] = js.undefined
  
  var `type`: js.UndefOr[Type] = js.undefined
  
  var value: js.UndefOr[typings.baseui.selectTypesMod.Value] = js.undefined
...
object PartialSelectProps {
  ...
  implicit open class MutableBuilder[Self <: PartialSelectProps] (val x: Self) extends AnyVal {
    ...
    inline def setFilterOptions(
      value: (/* options */ typings.baseui.selectTypesMod.Value, /* filterValue */ String, /* excludeOptions */ js.UndefOr[typings.baseui.selectTypesMod.Value | Null], /* a */ LabelKey) => typings.baseui.selectTypesMod.Value
    ...
    inline def setGetOptionLabel(value: /* a */ Option => ReactNode): Self = StObject.set(x, "getOptionLabel", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: /* e */ SyntheticEvent[HTMLElement, typings.std.Event] => Any): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
    ...
    inline def setOptionsVarargs(value: typings.baseui.selectTypesMod.Option*): Self = StObject.set(x, "options", js.Array(value*))
    ...
    inline def setSize(value: typings.baseui.selectTypesMod.Size): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
