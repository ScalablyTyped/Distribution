...
/* Inlined {  size :baseui.baseui/icon.IconProps['size']} & baseui.baseui/icon.IconProps */
trait sizeIconPropssizeIconProp extends StObject {
...
object sizeIconPropssizeIconProp {
  
  inline def apply(): sizeIconPropssizeIconProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[sizeIconPropssizeIconProp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: sizeIconPropssizeIconProp] (val x: Self) extends AnyVal {
