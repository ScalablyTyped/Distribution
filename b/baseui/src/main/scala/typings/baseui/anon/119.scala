...
object `119` {
  ...
  extension [Self <: `119`](x: Self) {
    ...
    inline def setLabel(value: `Macedonia LeftparenthesisFYROMRightparenthesis LeftparenthesisМакедонијаRightparenthesis`): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
  }
}
