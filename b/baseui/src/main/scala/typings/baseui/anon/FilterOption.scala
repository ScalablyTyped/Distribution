...
object FilterOption {
  ...
  extension [Self <: FilterOption](x: Self) {
    ...
    inline def setFilterOption(value: (/* option */ typings.baseui.selectMod.Option, /* filterValue */ String) => Boolean): Self = StObject.set(x, "filterOption", js.Any.fromFunction2(value))
