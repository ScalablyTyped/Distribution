...
trait ReadonlyToastPropskeyKey extends js.Object {
  ...
  val key: js.UndefOr[typings.react.mod.Key] with typings.react.mod.Key = js.native
...
object ReadonlyToastPropskeyKey {
  @scala.inline
  def apply(key: js.UndefOr[typings.react.mod.Key] with typings.react.mod.Key): ReadonlyToastPropskeyKey = {
