...
trait PopoverPropschildrennever extends js.Object {
  ...
  var onClick: js.UndefOr[js.Function1[/* e */ typings.std.Event, _]] = js.native
  ...
  var overrides: js.UndefOr[typings.baseui.popoverMod.Overrides] = js.native
...
object PopoverPropschildrennever {
  ...
  implicit class PopoverPropschildrenneverOps[Self <: PopoverPropschildrennever] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOverrides(value: typings.baseui.popoverMod.Overrides): Self = this.set("overrides", value.asInstanceOf[js.Any])
    @scala.inline
