...
object StatefulDatepickerPropsCa {
  ...
  inline def apply(): StatefulDatepickerPropsCa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StatefulDatepickerPropsCa]
  }
  
  extension [Self <: StatefulDatepickerPropsCa](x: Self) {
    ...
    inline def setChildren(value: /* args */ CalendarProps => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
