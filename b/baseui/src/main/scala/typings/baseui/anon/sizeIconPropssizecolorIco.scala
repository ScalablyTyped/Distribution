...
/* Inlined {  size :baseui.baseui/icon.IconProps['size'],   color :baseui.baseui/icon.IconProps['color']} & baseui.baseui/icon.IconProps */
trait sizeIconPropssizecolorIco extends StObject {
...
object sizeIconPropssizecolorIco {
  
  inline def apply(): sizeIconPropssizecolorIco = {
  ...
  extension [Self <: sizeIconPropssizecolorIco](x: Self) {
    ...
    inline def setColor(value: typings.baseui.iconTypesMod.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
