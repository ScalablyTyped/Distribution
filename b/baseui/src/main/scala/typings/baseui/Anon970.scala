...
trait Anon970 extends js.Object {
...
object Anon970 {
  @scala.inline
  def apply(dialCode: Plussign970, id: PS, label: `Palestine Leftparenthesis‫فلسطين‬‎Rightparenthesis`): Anon970 = {
    val __obj = js.Dynamic.literal(dialCode = dialCode.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon970]
  }
}
