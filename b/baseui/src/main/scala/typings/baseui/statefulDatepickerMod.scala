...
object statefulDatepickerMod {
  ...
  trait Props[T] extends StObject {
    ...
    var onRangeChange: js.UndefOr[js.Function1[/* a */ `11`[T], Any]] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props[?], T](x: Self & Props[T]) {
      ...
      inline def setOnRangeChange(value: /* a */ `11`[T] => Any): Self = StObject.set(x, "onRangeChange", js.Any.fromFunction1(value))
