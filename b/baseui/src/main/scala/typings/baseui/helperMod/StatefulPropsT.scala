...
object StatefulPropsT {
  ...
  implicit class StatefulPropsTOps[Self <: StatefulPropsT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setContentFunction1(value: /* args */ Close => ReactNode): Self = this.set("content", js.Any.fromFunction1(value))
    
    @scala.inline
    def setContent(value: ReactNode | (js.Function1[/* args */ Close, ReactNode])): Self = this.set("content", value.asInstanceOf[js.Any])
