...
object statefulPhoneInputMod {
  ...
  object default {
    ...
    @JSImport("baseui/phone-input/stateful-phone-input", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    object defaultProps {
      
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.aria-describedby")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.aria-label")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.aria-labelledby")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.clearable")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.country")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.disabled")
      @js.native
      def disabled: Boolean = js.native
      inline def disabled_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("disabled")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.error")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.focusLock")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.id")
      @js.native
      def id: Any = js.native
      inline def id_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
      
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.maxDropdownHeight")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.maxDropdownWidth")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.name")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.positive")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.required")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.size")
      @js.native
      ...
      @JSImport("baseui/phone-input/stateful-phone-input", "default.defaultProps.text")
      @js.native
