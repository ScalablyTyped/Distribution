...
object tableGridStyledComponentsMod {
  
  @JSImport("baseui/table-grid/styled-components", "StyledBodyCell")
  @js.native
  val StyledBodyCell: StyletronComponent[div, GridColumn] = js.native
  
  @JSImport("baseui/table-grid/styled-components", "StyledHeadCell")
  @js.native
  val StyledHeadCell: StyletronComponent[div, Cursor] = js.native
  
  @JSImport("baseui/table-grid/styled-components", "StyledTable")
  @js.native
