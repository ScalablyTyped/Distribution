...
trait Anon_239 extends js.Object {
  var dialCode: Plussign239
  var id: ST
  var label: `São Tomé and Príncipe LeftparenthesisSão Tomé e PríncipeRightparenthesis`
}
