...
object messageCardStyledComponentsMod {
  
  @JSImport("baseui/message-card/styled-components", "StyledContentContainer")
  @js.native
  val StyledContentContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/message-card/styled-components", "StyledHeadingContainer")
  @js.native
  val StyledHeadingContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/message-card/styled-components", "StyledImage")
  @js.native
  val StyledImage: StyletronComponent[div, BackgroundPosition] = js.native
  
  @JSImport("baseui/message-card/styled-components", "StyledParagraphContainer")
  @js.native
  val StyledParagraphContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/message-card/styled-components", "StyledRoot")
  @js.native
