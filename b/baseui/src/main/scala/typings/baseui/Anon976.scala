...
trait Anon976 extends js.Object {
...
object Anon976 {
  @scala.inline
  def apply(dialCode: Plussign976, id: MN, label: `Mongolia LeftparenthesisМонголRightparenthesis`): Anon976 = {
    val __obj = js.Dynamic.literal(dialCode = dialCode.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon976]
  }
}
