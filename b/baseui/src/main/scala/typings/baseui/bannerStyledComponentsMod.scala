...
object bannerStyledComponentsMod {
  
  @JSImport("baseui/banner/styled-components", "StyledBelowContent")
  @js.native
  val StyledBelowContent: StyletronComponent[div, ActionPosition] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledLeadingContent")
  @js.native
  val StyledLeadingContent: StyletronComponent[div, IncludesArtwork] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledMessage")
  @js.native
  val StyledMessage: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledMessageContent")
  @js.native
  val StyledMessageContent: StyletronComponent[div, ActionPosition] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[div, BackgroundColor] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledTitle")
  @js.native
  val StyledTitle: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledTrailingButtonContainer")
  @js.native
  val StyledTrailingButtonContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledTrailingContent")
  @js.native
  val StyledTrailingContent: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/banner/styled-components", "StyledTrailingIconButton")
  @js.native
