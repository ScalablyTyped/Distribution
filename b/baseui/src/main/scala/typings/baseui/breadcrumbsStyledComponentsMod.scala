...
object breadcrumbsStyledComponentsMod {
  
  @JSImport("baseui/breadcrumbs/styled-components", "StyledList")
  @js.native
  val StyledList: StyletronComponent[ol, js.Object] = js.native
  
  @JSImport("baseui/breadcrumbs/styled-components", "StyledListItem")
  @js.native
  val StyledListItem: StyletronComponent[li_, js.Object] = js.native
  
  @JSImport("baseui/breadcrumbs/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[nav, js.Object] = js.native
  
  @JSImport("baseui/breadcrumbs/styled-components", "StyledSeparator")
  @js.native
