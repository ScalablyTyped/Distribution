...
trait Anon47DialCode extends js.Object {
  var dialCode: Plussign47
  var id: SJ
  var label: `Svalbard and Jan Mayen`
}

object Anon47DialCode {
  @scala.inline
  def apply(dialCode: Plussign47, id: SJ, label: `Svalbard and Jan Mayen`): Anon47DialCode = {
    val __obj = js.Dynamic.literal(dialCode = dialCode.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon47DialCode]
  }
}
