...
object mod {
  ...
  @js.native
  def styled[P /* <: js.Object */, C /* <: (ComponentClass[_, ComponentState]) | FunctionComponent[_] */, T](component: C, styledFn: js.Function1[/* props */ Theme[T] with P, StyleObject]): StyletronComponent[
    (Pick[
      ComponentProps[C], 
  ...
  @JSImport("baseui", "styled")
  @js.native
  def styled[P /* <: js.Object */, C /* <: (ComponentClass[_, ComponentState]) | FunctionComponent[_] */, T](component: C, styledFn: StyleObject): StyletronComponent[
    (Pick[
      ComponentProps[C], 
      Exclude[/* keyof react.react.ComponentProps<C> */ String, ClassName]
    ]) with P
  ...
  @js.native
  trait WithStyleFn[T]
    extends typings.styletronReact.mod.WithStyleFn
}
