...
object styled_polygon extends js.Object {
  def apply[P /* <: js.Object */, T](component: polygon, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[polygon], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: polygon, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[polygon], Exclude[String, Anon_ClassName]]) with P] = js.native
}
