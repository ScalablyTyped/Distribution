...
object styled_small extends js.Object {
  def apply[P /* <: js.Object */, T](component: small, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[small], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: small, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[small], Exclude[String, Anon_ClassName]]) with P] = js.native
}
