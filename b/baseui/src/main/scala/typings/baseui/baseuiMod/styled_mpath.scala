...
object styled_mpath extends js.Object {
  def apply[P /* <: js.Object */, T](component: mpath, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[mpath], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: mpath, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[mpath], Exclude[String, Anon_ClassName]]) with P] = js.native
}
