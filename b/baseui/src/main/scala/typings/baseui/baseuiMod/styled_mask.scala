...
object styled_mask extends js.Object {
  def apply[P /* <: js.Object */, T](component: mask, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[mask], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: mask, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[mask], Exclude[String, Anon_ClassName]]) with P] = js.native
}
