...
object styled_dl extends js.Object {
  def apply[P /* <: js.Object */, T](component: dl, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[dl], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: dl, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[dl], Exclude[String, Anon_ClassName]]) with P] = js.native
}
