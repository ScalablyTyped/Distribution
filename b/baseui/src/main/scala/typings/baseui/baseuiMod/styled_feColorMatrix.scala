...
object styled_feColorMatrix extends js.Object {
  def apply[P /* <: js.Object */, T](component: feColorMatrix, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feColorMatrix], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feColorMatrix, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feColorMatrix], Exclude[String, Anon_ClassName]]) with P] = js.native
}
