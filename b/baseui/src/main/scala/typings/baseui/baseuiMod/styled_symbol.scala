...
object styled_symbol extends js.Object {
  def apply[P /* <: js.Object */, T](component: symbol, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[symbol], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: symbol, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[symbol], Exclude[String, Anon_ClassName]]) with P] = js.native
}
