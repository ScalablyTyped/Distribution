...
object styled_head extends js.Object {
  def apply[P /* <: js.Object */, T](component: head, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[head], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: head, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[head], Exclude[String, Anon_ClassName]]) with P] = js.native
}
