...
object styled_a extends js.Object {
  def apply[P /* <: js.Object */, T](component: a, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[a], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: a, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[a], Exclude[String, Anon_ClassName]]) with P] = js.native
}
