...
object styled_blockquote extends js.Object {
  def apply[P /* <: js.Object */, T](component: blockquote, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[blockquote], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: blockquote, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[blockquote], Exclude[String, Anon_ClassName]]) with P] = js.native
}
