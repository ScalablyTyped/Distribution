...
object styled_track extends js.Object {
  def apply[P /* <: js.Object */, T](component: track, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[track], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: track, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[track], Exclude[String, Anon_ClassName]]) with P] = js.native
}
