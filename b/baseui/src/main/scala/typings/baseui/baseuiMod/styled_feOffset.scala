...
object styled_feOffset extends js.Object {
  def apply[P /* <: js.Object */, T](component: feOffset, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feOffset], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feOffset, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feOffset], Exclude[String, Anon_ClassName]]) with P] = js.native
}
