...
object styled_h3 extends js.Object {
  def apply[P /* <: js.Object */, T](component: h3, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[h3], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: h3, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[h3], Exclude[String, Anon_ClassName]]) with P] = js.native
}
