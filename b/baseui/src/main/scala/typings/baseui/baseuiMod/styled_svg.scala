...
object styled_svg extends js.Object {
  def apply[P /* <: js.Object */, T](component: svg, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[svg], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: svg, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[svg], Exclude[String, Anon_ClassName]]) with P] = js.native
}
