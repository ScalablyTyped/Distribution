...
object styled_use extends js.Object {
  def apply[P /* <: js.Object */, T](component: use, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[use], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: use, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[use], Exclude[String, Anon_ClassName]]) with P] = js.native
}
