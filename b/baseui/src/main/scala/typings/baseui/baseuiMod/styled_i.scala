...
object styled_i extends js.Object {
  def apply[P /* <: js.Object */, T](component: i, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[i], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: i, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[i], Exclude[String, Anon_ClassName]]) with P] = js.native
}
