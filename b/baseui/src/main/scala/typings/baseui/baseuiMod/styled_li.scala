...
object styled_li extends js.Object {
  def apply[P /* <: js.Object */, T](component: li, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[li], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: li, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[li], Exclude[String, Anon_ClassName]]) with P] = js.native
}
