...
object styled_th extends js.Object {
  def apply[P /* <: js.Object */, T](component: th, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[th], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: th, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[th], Exclude[String, Anon_ClassName]]) with P] = js.native
}
