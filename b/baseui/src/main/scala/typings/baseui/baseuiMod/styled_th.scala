...
object styled_th extends js.Object {
  def apply[P /* <: js.Object */, T](component: th_, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[th_], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: th_, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[th_], Exclude[String, Anon_ClassName]]) with P] = js.native
}
