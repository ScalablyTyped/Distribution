...
object styled_script extends js.Object {
  def apply[P /* <: js.Object */, T](component: script, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[script], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: script, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[script], Exclude[String, Anon_ClassName]]) with P] = js.native
}
