...
object styled_image extends js.Object {
  def apply[P /* <: js.Object */, T](component: image, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[image], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: image, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[image], Exclude[String, Anon_ClassName]]) with P] = js.native
}
