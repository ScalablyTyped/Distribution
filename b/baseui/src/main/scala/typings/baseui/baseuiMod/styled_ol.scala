...
object styled_ol extends js.Object {
  def apply[P /* <: js.Object */, T](component: ol, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[ol], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: ol, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[ol], Exclude[String, Anon_ClassName]]) with P] = js.native
}
