...
object styled_canvas extends js.Object {
  def apply[P /* <: js.Object */, T](component: canvas, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[canvas], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: canvas, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[canvas], Exclude[String, Anon_ClassName]]) with P] = js.native
}
