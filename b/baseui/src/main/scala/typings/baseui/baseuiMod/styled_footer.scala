...
object styled_footer extends js.Object {
  def apply[P /* <: js.Object */, T](component: footer, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[footer], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: footer, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[footer], Exclude[String, Anon_ClassName]]) with P] = js.native
}
