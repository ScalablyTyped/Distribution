...
object styled_ellipse extends js.Object {
  def apply[P /* <: js.Object */, T](component: ellipse, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[ellipse], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: ellipse, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[ellipse], Exclude[String, Anon_ClassName]]) with P] = js.native
}
