...
object styled_strong extends js.Object {
  def apply[P /* <: js.Object */, T](component: strong, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[strong], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: strong, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[strong], Exclude[String, Anon_ClassName]]) with P] = js.native
}
