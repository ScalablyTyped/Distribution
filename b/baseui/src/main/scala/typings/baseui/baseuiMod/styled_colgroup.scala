...
object styled_colgroup extends js.Object {
  def apply[P /* <: js.Object */, T](component: colgroup, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[colgroup], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: colgroup, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[colgroup], Exclude[String, Anon_ClassName]]) with P] = js.native
}
