...
object styled_fePointLight extends js.Object {
  def apply[P /* <: js.Object */, T](component: fePointLight, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[fePointLight], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: fePointLight, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[fePointLight], Exclude[String, Anon_ClassName]]) with P] = js.native
}
