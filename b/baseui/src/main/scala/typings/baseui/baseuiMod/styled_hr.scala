...
object styled_hr extends js.Object {
  def apply[P /* <: js.Object */, T](component: hr, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[hr], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: hr, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[hr], Exclude[String, Anon_ClassName]]) with P] = js.native
}
