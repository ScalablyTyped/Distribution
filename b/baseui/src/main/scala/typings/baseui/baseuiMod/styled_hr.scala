...
object styled_hr extends js.Object {
  def apply[P /* <: js.Object */, T](component: hr_, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[hr_], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: hr_, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[hr_], Exclude[String, Anon_ClassName]]) with P] = js.native
}
