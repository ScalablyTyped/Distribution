...
object styled_summary extends js.Object {
  def apply[P /* <: js.Object */, T](component: summary, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[summary], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: summary, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[summary], Exclude[String, Anon_ClassName]]) with P] = js.native
}
