...
object styled_line extends js.Object {
  def apply[P /* <: js.Object */, T](component: line, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[line], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: line, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[line], Exclude[String, Anon_ClassName]]) with P] = js.native
}
