...
object styled_feMerge extends js.Object {
  def apply[P /* <: js.Object */, T](component: feMerge, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feMerge], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feMerge, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feMerge], Exclude[String, Anon_ClassName]]) with P] = js.native
}
