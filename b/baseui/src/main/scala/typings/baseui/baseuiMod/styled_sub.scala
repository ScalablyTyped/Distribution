...
object styled_sub extends js.Object {
  def apply[P /* <: js.Object */, T](component: sub, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[sub], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: sub, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[sub], Exclude[String, Anon_ClassName]]) with P] = js.native
}
