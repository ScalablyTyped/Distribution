...
object styled_button extends js.Object {
  def apply[P /* <: js.Object */, T](component: button, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[button], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: button, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[button], Exclude[String, Anon_ClassName]]) with P] = js.native
}
