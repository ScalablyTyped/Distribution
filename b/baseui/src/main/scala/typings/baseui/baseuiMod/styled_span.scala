...
object styled_span extends js.Object {
  def apply[P /* <: js.Object */, T](component: span, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[span], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: span, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[span], Exclude[String, Anon_ClassName]]) with P] = js.native
}
