...
object styled_path extends js.Object {
  def apply[P /* <: js.Object */, T](component: path, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[path], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: path, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[path], Exclude[String, Anon_ClassName]]) with P] = js.native
}
