...
object styled_switch extends js.Object {
  def apply[P /* <: js.Object */, T](component: switch, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[switch], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: switch, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[switch], Exclude[String, Anon_ClassName]]) with P] = js.native
}
