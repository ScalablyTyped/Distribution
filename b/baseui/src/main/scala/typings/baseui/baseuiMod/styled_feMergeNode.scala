...
object styled_feMergeNode extends js.Object {
  def apply[P /* <: js.Object */, T](component: feMergeNode, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feMergeNode], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feMergeNode, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feMergeNode], Exclude[String, Anon_ClassName]]) with P] = js.native
}
