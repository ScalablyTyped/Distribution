...
object styled_metadata extends js.Object {
  def apply[P /* <: js.Object */, T](component: metadata, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[metadata], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: metadata, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[metadata], Exclude[String, Anon_ClassName]]) with P] = js.native
}
