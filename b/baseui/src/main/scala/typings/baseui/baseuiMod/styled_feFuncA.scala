...
object styled_feFuncA extends js.Object {
  def apply[P /* <: js.Object */, T](component: feFuncA, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feFuncA], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feFuncA, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feFuncA], Exclude[String, Anon_ClassName]]) with P] = js.native
}
