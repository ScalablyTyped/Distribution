...
object styled_tbody extends js.Object {
  def apply[P /* <: js.Object */, T](component: tbody, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[tbody], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: tbody, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[tbody], Exclude[String, Anon_ClassName]]) with P] = js.native
}
