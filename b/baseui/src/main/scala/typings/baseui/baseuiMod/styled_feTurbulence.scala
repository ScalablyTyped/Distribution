...
object styled_feTurbulence extends js.Object {
  def apply[P /* <: js.Object */, T](component: feTurbulence, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feTurbulence], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feTurbulence, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feTurbulence], Exclude[String, Anon_ClassName]]) with P] = js.native
}
