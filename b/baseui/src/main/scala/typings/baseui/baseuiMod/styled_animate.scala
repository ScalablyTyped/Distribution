...
object styled_animate extends js.Object {
  def apply[P /* <: js.Object */, T](component: animate, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[animate], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: animate, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[animate], Exclude[String, Anon_ClassName]]) with P] = js.native
}
