...
object styled_object extends js.Object {
  def apply[P /* <: js.Object */, T](component: `object`, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[`object`], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: `object`, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[`object`], Exclude[String, Anon_ClassName]]) with P] = js.native
}
