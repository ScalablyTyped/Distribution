...
object styled_audio extends js.Object {
  def apply[P /* <: js.Object */, T](component: audio, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[audio], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: audio, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[audio], Exclude[String, Anon_ClassName]]) with P] = js.native
}
