...
object styled_linearGradient extends js.Object {
  def apply[P /* <: js.Object */, T](component: linearGradient, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[linearGradient], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: linearGradient, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[linearGradient], Exclude[String, Anon_ClassName]]) with P] = js.native
}
