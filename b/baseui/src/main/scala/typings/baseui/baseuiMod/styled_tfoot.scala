...
object styled_tfoot extends js.Object {
  def apply[P /* <: js.Object */, T](component: tfoot, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[tfoot], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: tfoot, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[tfoot], Exclude[String, Anon_ClassName]]) with P] = js.native
}
