...
object styled_feFuncR extends js.Object {
  def apply[P /* <: js.Object */, T](component: feFuncR, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feFuncR], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feFuncR, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feFuncR], Exclude[String, Anon_ClassName]]) with P] = js.native
}
