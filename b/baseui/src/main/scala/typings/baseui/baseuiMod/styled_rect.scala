...
object styled_rect extends js.Object {
  def apply[P /* <: js.Object */, T](component: rect, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[rect], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: rect, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[rect], Exclude[String, Anon_ClassName]]) with P] = js.native
}
