...
object styled_input extends js.Object {
  def apply[P /* <: js.Object */, T](component: input, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[input], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: input, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[input], Exclude[String, Anon_ClassName]]) with P] = js.native
}
