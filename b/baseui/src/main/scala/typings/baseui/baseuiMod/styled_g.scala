...
object styled_g extends js.Object {
  def apply[P /* <: js.Object */, T](component: g, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[g], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: g, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[g], Exclude[String, Anon_ClassName]]) with P] = js.native
}
