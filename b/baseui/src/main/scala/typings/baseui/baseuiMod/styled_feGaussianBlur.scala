...
object styled_feGaussianBlur extends js.Object {
  def apply[P /* <: js.Object */, T](component: feGaussianBlur, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[feGaussianBlur], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: feGaussianBlur, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[feGaussianBlur], Exclude[String, Anon_ClassName]]) with P] = js.native
}
