...
object styled_tspan extends js.Object {
  def apply[P /* <: js.Object */, T](component: tspan, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[tspan], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: tspan, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[tspan], Exclude[String, Anon_ClassName]]) with P] = js.native
}
