...
object styled_bdi extends js.Object {
  def apply[P /* <: js.Object */, T](component: bdi, styledFn: js.Function1[/* props */ Anon_Theme[T] with P, StyleObject]): StyletronComponent[(Pick[ComponentProps[bdi], Exclude[String, Anon_ClassName]]) with P] = js.native
  def apply[P /* <: js.Object */, T](component: bdi, styledFn: StyleObject): StyletronComponent[(Pick[ComponentProps[bdi], Exclude[String, Anon_ClassName]]) with P] = js.native
}
