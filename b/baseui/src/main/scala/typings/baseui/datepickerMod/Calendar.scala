...
import typings.baseui.Anon_DateEvent_746967094
import typings.baseui.Anon_Date_1450110798
...
class Calendar ()
  ...
  def changeMonth(hasDate: Anon_Date_1450110798): Unit = js.native
  def changeYear(hasDate: Anon_Date_1450110798): Unit = js.native
  ...
  def onDayMouseLeave(data: Anon_DateEvent_746967094): Unit = js.native
  def onDayMouseOver(data: Anon_DateEvent_746967094): Unit = js.native
