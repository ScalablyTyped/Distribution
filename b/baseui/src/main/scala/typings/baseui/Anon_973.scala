...
trait Anon_973 extends js.Object {
...
object Anon_973 {
  @scala.inline
  def apply(dialCode: Plussign973, id: BH, label: `Bahrain Leftparenthesis‫البحرين‬‎Rightparenthesis`): Anon_973 = {
    val __obj = js.Dynamic.literal(dialCode = dialCode.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
  
    __obj.asInstanceOf[Anon_973]
  }
}
