...
object appNavBarStyledComponentsMod {
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledAppName")
  @js.native
  val StyledAppName: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledDesktopMenu")
  @js.native
  val StyledDesktopMenu: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledDesktopMenuContainer")
  @js.native
  val StyledDesktopMenuContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledMainMenuItem")
  @js.native
  val StyledMainMenuItem: StyletronComponent[div, Active] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledPrimaryMenuContainer")
  @js.native
  val StyledPrimaryMenuContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledSecondaryMenuContainer")
  @js.native
  val StyledSecondaryMenuContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledSideMenuButton")
  @js.native
  val StyledSideMenuButton: StyletronComponent[button, IsFocusVisible] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledSpacing")
  @js.native
  val StyledSpacing: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledSubnavContainer")
  @js.native
  val StyledSubnavContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledUserMenuButton")
  @js.native
  val StyledUserMenuButton: StyletronComponent[button, IsFocusVisible] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledUserMenuProfileListItem")
  @js.native
  val StyledUserMenuProfileListItem: StyletronComponent[li_, Disabled] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledUserProfileInfoContainer")
  @js.native
  val StyledUserProfileInfoContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledUserProfilePictureContainer")
  @js.native
  val StyledUserProfilePictureContainer: StyletronComponent[div, js.Object] = js.native
  
  @JSImport("baseui/app-nav-bar/styled-components", "StyledUserProfileTileContainer")
  @js.native
