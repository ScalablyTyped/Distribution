...
object sideNavigationStyledComponentsMod {
  
  @JSImport("baseui/side-navigation/styled-components", "StyledNavItem")
  @js.native
  val StyledNavItem: StyletronComponent[div, SharedPropsitemanyundefin] = js.native
  
  @JSImport("baseui/side-navigation/styled-components", "StyledNavItemContainer")
  @js.native
  val StyledNavItemContainer: StyletronComponent[li_, js.Object] = js.native
  
  @JSImport("baseui/side-navigation/styled-components", "StyledNavItemElement")
  @js.native
  val StyledNavItemElement: StyletronComponent[div, SharedProps] = js.native
  
  @JSImport("baseui/side-navigation/styled-components", "StyledNavLink")
  @js.native
  val StyledNavLink: StyletronComponent[a, IsFocusVisible] = js.native
  
  @JSImport("baseui/side-navigation/styled-components", "StyledRoot")
  @js.native
  val StyledRoot: StyletronComponent[nav, SharedProps] = js.native
  
  @JSImport("baseui/side-navigation/styled-components", "StyledSubNavContainer")
  @js.native
