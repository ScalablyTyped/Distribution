...
object paginationStyledComponentsMod {
  
  @JSImport("baseui/pagination/styled-components", "StyledDropdownContainer")
  @js.native
  val StyledDropdownContainer: StyletronComponent[div, IsFocusVisible] = js.native
  
  @JSImport("baseui/pagination/styled-components", "StyledMaxLabel")
  @js.native
  val StyledMaxLabel: StyletronComponent[span, js.Object] = js.native
  
  @JSImport("baseui/pagination/styled-components", "StyledRoot")
  @js.native
