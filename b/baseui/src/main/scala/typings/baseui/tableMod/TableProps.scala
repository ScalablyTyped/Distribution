...
object TableProps {
  ...
  implicit class TablePropsOps[Self <: TableProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumnsVarargs(value: (String | ReactNode)*): Self = this.set("columns", js.Array(value :_*))
    
    @scala.inline
    def setColumns(value: js.Array[String | ReactNode]): Self = this.set("columns", value.asInstanceOf[js.Any])
