...
class ToasterContainer ()
  extends reactLib.reactMod.Component[stdLib.Readonly[ToasterProps], ToasterContainerState, js.Any] {
  ...
  def getToastProps(props: ToastProps): stdLib.Readonly[ToastProps] with baseuiLib.Anon_Key = js.native
