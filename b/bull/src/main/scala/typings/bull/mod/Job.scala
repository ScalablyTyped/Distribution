...
import typings.bull.bullStrings.stuck
...
trait Job[T] extends StObject {
  ...
  /**
    ...
    */
  def finished(): js.Promise[Any] = js.native
  ...
  /**
    ...
    */
  def getState(): js.Promise[JobStatus | stuck] = js.native
  ...
  /**
    ...
    */
  def log(row: String): js.Promise[Any] = js.native
  ...
  /**
    ...
    */
  def moveToCompleted(): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: String): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: String, ignoreLock: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: String, ignoreLock: Boolean, notFetch: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: String, ignoreLock: Unit, notFetch: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: Unit, ignoreLock: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: Unit, ignoreLock: Boolean, notFetch: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToCompleted(returnValue: Unit, ignoreLock: Unit, notFetch: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  
  /**
    * Moves a job to the `failed` queue. Pulls a job from 'waiting' to 'active'
    * and returns a tuple containing the next jobs data and id. If no job is in the `waiting` queue, returns null.
    */
  def moveToFailed(errorInfo: Message): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  def moveToFailed(errorInfo: Message, ignoreLock: Boolean): js.Promise[(js.Tuple2[Any, JobId]) | Null] = js.native
  ...
  /**
    ...
    */
  def progress(): Any = js.native
  /**
    * Report progress on a job
    */
  def progress(value: Any): js.Promise[Unit] = js.native
