...
import typings.bull.Anon_Count
import typings.bull.Anon_JobId
...
trait Queue[T] extends EventEmitter {
  ...
  /**
    ...
    */
  def getJobLogs(jobId: String): js.Promise[Anon_Count] = js.native
  def getJobLogs(jobId: String, start: Double): js.Promise[Anon_Count] = js.native
  def getJobLogs(jobId: String, start: Double, end: Double): js.Promise[Anon_Count] = js.native
  /**
  ...
  /**
    ...
    */
  def removeRepeatable(name: String, repeat: (CronRepeatOptions | EveryRepeatOptions) with Anon_JobId): js.Promise[Unit] = js.native
  /**
    * Removes a given repeatable job. The RepeatOptions and JobId needs to be the same as the ones
    * used for the job when it was added.
    */
  def removeRepeatable(repeat: (CronRepeatOptions | EveryRepeatOptions) with Anon_JobId): js.Promise[Unit] = js.native
  /**
