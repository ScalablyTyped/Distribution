...
trait Job[T] extends js.Object {
  ...
  /**
       ...
       */
  def discard(): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       ...
       */
  def finished(): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  /**
       ...
       */
  def getState(): bluebirdLib.bluebirdMod.namespaced[JobStatus] = js.native
  /**
  ...
  /**
       ...
       */
  def moveToCompleted(): bluebirdLib.bluebirdMod.namespaced[(js.Tuple2[_, JobId]) | scala.Null] = js.native
  /**
       * Moves a job to the `completed` queue. Pulls a job from 'waiting' to 'active'
       * and returns a tuple containing the next jobs data and id. If no job is in the `waiting` queue, returns null.
       */
  def moveToCompleted(returnValue: java.lang.String): bluebirdLib.bluebirdMod.namespaced[(js.Tuple2[_, JobId]) | scala.Null] = js.native
  /**
       * Moves a job to the `completed` queue. Pulls a job from 'waiting' to 'active'
       * and returns a tuple containing the next jobs data and id. If no job is in the `waiting` queue, returns null.
       */
  def moveToCompleted(returnValue: java.lang.String, ignoreLock: scala.Boolean): bluebirdLib.bluebirdMod.namespaced[(js.Tuple2[_, JobId]) | scala.Null] = js.native
  /**
       * Moves a job to the `failed` queue. Pulls a job from 'waiting' to 'active'
       * and returns a tuple containing the next jobs data and id. If no job is in the `waiting` queue, returns null.
       */
  def moveToFailed(errorInfo: bullLib.Anon_Message): bluebirdLib.bluebirdMod.namespaced[(js.Tuple2[_, JobId]) | scala.Null] = js.native
  /**
       * Moves a job to the `failed` queue. Pulls a job from 'waiting' to 'active'
       * and returns a tuple containing the next jobs data and id. If no job is in the `waiting` queue, returns null.
       */
  def moveToFailed(errorInfo: bullLib.Anon_Message, ignoreLock: scala.Boolean): bluebirdLib.bluebirdMod.namespaced[(js.Tuple2[_, JobId]) | scala.Null] = js.native
  /**
       * Report progress on a job
       */
  def progress(value: js.Any): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       * Promotes a job that is currently "delayed" to the "waiting" state and executed as soon as possible.
       */
  def promote(): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       * Releases the lock on the job. Only locks owned by the queue instance can be released.
       */
  def releaseLock(): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       ...
       */
  def remove(): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       * Re-run a job that has failed. The returned promise resolves when the job
       * has been scheduled for retry.
       */
  def retry(): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  /**
       * Takes a lock for this job so that no other queue worker can process it at the same time.
       */
  def takeLock(): bluebirdLib.bluebirdMod.namespaced[scala.Double | bullLib.bullLibNumbers.`false`] = js.native
  /**
       * Update a specific job's data. Promise resolves when the job has been updated.
       */
  def update(data: js.Any): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
}
