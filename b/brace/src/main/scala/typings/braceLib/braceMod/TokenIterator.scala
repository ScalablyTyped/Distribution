...
class TokenIteratorCls protected ()
  extends braceLib.braceMod.AceAjaxNs.TokenIterator {
  /**
    ...
    **/
  def this(session: braceLib.braceMod.AceAjaxNs.IEditSession, initialRow: scala.Double, initialColumn: scala.Double) = this()
  /**
    * Returns the current tokenized string.
    **/
  /* CompleteClass */
  override def getCurrentToken(): braceLib.braceMod.AceAjaxNs.TokenInfo = js.native
  /**
