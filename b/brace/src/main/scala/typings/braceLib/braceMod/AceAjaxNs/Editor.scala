...
trait Editor extends js.Object {
  ...
  def addEventListener_change(ev: braceLib.braceLibStrings.change, callback: js.Function1[/* ev */ EditorChangeEvent, _]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    **/
  def setOption(optionName: js.Any, optionValue: js.Any): scala.Unit = js.native
  /**
    * Sets Configuration Options
    **/
  def setOptions(keyValueTuples: js.Any): scala.Unit = js.native
  /**
