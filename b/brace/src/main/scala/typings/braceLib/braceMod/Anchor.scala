...
class AnchorCls protected ()
  extends braceLib.braceMod.AceAjaxNs.Anchor {
  /**
    ...
    **/
  def this(doc: braceLib.braceMod.AceAjaxNs.Document, row: scala.Double, column: scala.Double) = this()
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getDocument(): braceLib.braceMod.AceAjaxNs.Document = js.native
  /**
    * Returns an object identifying the `row` and `column` position of the current anchor.
    **/
  /* CompleteClass */
  override def getPosition(): braceLib.braceMod.AceAjaxNs.Position = js.native
  /* CompleteClass */
