...
class BackgroundTokenizerCls protected ()
  extends braceLib.braceMod.AceAjaxNs.BackgroundTokenizer {
  /**
    * Creates a new `BackgroundTokenizer` object.
    * @param tokenizer The tokenizer to use
    * @param editor The editor to associate with
    **/
  def this(tokenizer: braceLib.braceMod.AceAjaxNs.Tokenizer, editor: braceLib.braceMod.AceAjaxNs.Editor) = this()
  /* CompleteClass */
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getTokens(row: scala.Double): js.Array[braceLib.braceMod.AceAjaxNs.TokenInfo] = js.native
  /**
    * Sets a new document to associate with this object.
    * @param doc The new document to associate with
    **/
  /* CompleteClass */
  override def setDocument(doc: braceLib.braceMod.AceAjaxNs.Document): scala.Unit = js.native
  /**
    * Sets a new tokenizer for this object.
    * @param tokenizer The new tokenizer to use
    **/
  /* CompleteClass */
  override def setTokenizer(tokenizer: braceLib.braceMod.AceAjaxNs.Tokenizer): scala.Unit = js.native
  /**
