...
import typings.backboneAssociations.backboneMod.Associations.IRelation
...
object backboneMod {
  ...
  object Associations {
    ...
    trait IRelation extends StObject {
      ...
      var relatedModel: String | Instantiable0[typings.backboneAssociations.backboneMod.Associations.AssociatedModel]
    ...
    object IRelation {
      ...
      inline def apply(
        key: String,
        relatedModel: String | Instantiable0[typings.backboneAssociations.backboneMod.Associations.AssociatedModel],
        `type`: String
      ): IRelation = {
      ...
      implicit open class MutableBuilder[Self <: IRelation] (val x: Self) extends AnyVal {
        ...
        inline def setRelatedModel(
          value: String | Instantiable0[typings.backboneAssociations.backboneMod.Associations.AssociatedModel]
