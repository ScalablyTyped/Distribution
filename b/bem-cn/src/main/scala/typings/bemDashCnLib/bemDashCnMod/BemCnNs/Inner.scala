...
trait Inner extends js.Object {
  ...
  def has(states: ScalablyTyped.runtime.StringDictionary[scala.Boolean]): Inner = js.native
  def is(states: ScalablyTyped.runtime.StringDictionary[scala.Boolean]): Inner = js.native
  ...
  def state(states: ScalablyTyped.runtime.StringDictionary[scala.Boolean]): Inner = js.native
}
