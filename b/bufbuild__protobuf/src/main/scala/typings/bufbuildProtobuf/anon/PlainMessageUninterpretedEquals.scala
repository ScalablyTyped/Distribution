...
trait PlainMessageUninterpretedEquals extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageUninterpretedEquals: PlainField[js.Function0[UninterpretedOptionNamePart]]
  ...
  @JSName("equals")
  var equals_FPlainMessageUninterpretedEquals: PlainField[
    js.Function1[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart
    ]
  ]
...
object PlainMessageUninterpretedEquals {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart,
  ...
  ): PlainMessageUninterpretedEquals = {
    ...
    __obj.asInstanceOf[PlainMessageUninterpretedEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUninterpretedEquals] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UninterpretedOptionNamePart
