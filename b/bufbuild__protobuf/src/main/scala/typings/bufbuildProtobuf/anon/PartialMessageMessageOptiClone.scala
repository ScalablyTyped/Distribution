...
trait PartialMessageMessageOptiClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMessageOptiClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMessageOptiClone: js.UndefOr[
    PartialField[
...
object PartialMessageMessageOptiClone {
  
  inline def apply(): PartialMessageMessageOptiClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMessageOptiClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMessageOptiClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageMessageOptiClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageMessageOptiClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageMessageOptiClone | PlainMessage[PartialMessageMessageOptiClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageMessageOptiClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMessageOptiClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMessageOptiClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageMessageOptiClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
