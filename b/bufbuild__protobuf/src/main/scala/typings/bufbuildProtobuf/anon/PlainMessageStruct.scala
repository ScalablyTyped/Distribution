...
trait PlainMessageStruct extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageStruct: PlainField[js.Function0[Struct]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Struct]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageStruct: PlainField[
...
object PlainMessageStruct {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Struct,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Struct,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Struct,
    ...
    __obj.asInstanceOf[PlainMessageStruct]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageStruct] (val x: Self) extends AnyVal {
