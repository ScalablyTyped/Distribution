...
trait PartialMessageApiClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageApiClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageApiClone: js.UndefOr[
    PartialField[
...
object PartialMessageApiClone {
  
  inline def apply(): PartialMessageApiClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageApiClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageApiClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageApiClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageApiClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageApiClone | PlainMessage[PartialMessageApiClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageApiClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageApiClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageApiClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageApiClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
