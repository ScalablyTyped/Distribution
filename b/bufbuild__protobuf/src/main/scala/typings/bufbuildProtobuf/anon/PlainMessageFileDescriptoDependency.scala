...
trait PlainMessageFileDescriptoDependency extends StObject {
  
  @JSName("package")
  var _package: js.UndefOr[PlainField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageFileDescriptoDependency: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageFileDescripDependency], Any]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFileDescriptoDependency: PlainField[
...
object PlainMessageFileDescriptoDependency {
  
  inline def apply(
    clone_ : () => PlainMessageFileDescriptoDependency,
    constructor: /* data */ js.UndefOr[PartialMessageFileDescripDependency] => Any,
    dependency: PlainField[js.Array[String]],
    enumType: PlainField[js.Array[EnumDescriptorProto]],
    equals_ : /* other */ js.UndefOr[
      PlainMessageFileDescriptoDependency | PlainMessage[PlainMessageFileDescriptoDependency] | Null
    ] => Boolean,
    `extension`: PlainField[js.Array[FieldDescriptorProto]],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFileDescriptoDependency,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileDescriptoDependency,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileDescriptoDependency,
    getType: () => MessageType[PlainMessageFileDescriptoDependency],
  ...
  ): PlainMessageFileDescriptoDependency = {
    ...
    __obj.asInstanceOf[PlainMessageFileDescriptoDependency]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileDescriptoDependency] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageFileDescriptoDependency): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageFileDescripDependency] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFileDescriptoDependency
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileDescriptoDependency
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileDescriptoDependency
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageFileDescriptoDependency]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
