...
trait Default[T /* <: fiScalar | fiMap | fiEnum | fiMessage */] extends StObject {
...
object Default {
  ...
  inline def apply[T /* <: fiScalar | fiMap | fiEnum | fiMessage */](oneof: Unit): Default[T] = {
    val __obj = js.Dynamic.literal(oneof = oneof.asInstanceOf[js.Any])
    __obj.asInstanceOf[Default[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Default[?], T /* <: fiScalar | fiMap | fiEnum | fiMessage */] (val x: Self & Default[T]) extends AnyVal {
