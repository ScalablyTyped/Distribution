...
trait PlainMessageApiClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageApiClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageApiClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageApiClone: PlainField[
...
object PlainMessageApiClone {
  
  inline def apply(
    clone_ : () => PlainMessageApiClone,
    constructor: /* data */ js.UndefOr[PartialMessageApiClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageApiClone | PlainMessage[PlainMessageApiClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageApiClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageApiClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageApiClone,
    getType: () => MessageType[PlainMessageApiClone],
    ...
    __obj.asInstanceOf[PlainMessageApiClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageApiClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageApiClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageApiClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageApiClone | PlainMessage[PlainMessageApiClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageApiClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageApiClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageApiClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageApiClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
