...
trait PartialMessageOptionClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageOptionClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageOptionClone: js.UndefOr[
    PartialField[
...
object PartialMessageOptionClone {
  
  inline def apply(): PartialMessageOptionClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageOptionClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageOptionClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageOptionClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageOptionClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageOptionClone | PlainMessage[PartialMessageOptionClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageOptionClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageOptionClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageOptionClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageOptionClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
