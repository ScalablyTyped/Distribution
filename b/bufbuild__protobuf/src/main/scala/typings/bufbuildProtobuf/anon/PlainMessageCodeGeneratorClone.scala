...
trait PlainMessageCodeGeneratorClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageCodeGeneratorClone: PlainField[js.Function0[this.type]]
  
  var compilerVersion: js.UndefOr[PlainField[js.UndefOr[Version]]] = js.undefined
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageCodeGeneratClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageCodeGeneratorClone: PlainField[
...
object PlainMessageCodeGeneratorClone {
  
  inline def apply(
    clone_ : () => PlainMessageCodeGeneratorClone,
    constructor: /* data */ js.UndefOr[PartialMessageCodeGeneratClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageCodeGeneratorClone | PlainMessage[PlainMessageCodeGeneratorClone] | Null
    ] => Boolean,
    fileToGenerate: PlainField[js.Array[String]],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageCodeGeneratorClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageCodeGeneratorClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageCodeGeneratorClone,
    getType: () => MessageType[PlainMessageCodeGeneratorClone],
  ...
  ): PlainMessageCodeGeneratorClone = {
    ...
    __obj.asInstanceOf[PlainMessageCodeGeneratorClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageCodeGeneratorClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageCodeGeneratorClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    ...
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageCodeGeneratClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageCodeGeneratorClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageCodeGeneratorClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageCodeGeneratorClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageCodeGeneratorClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
