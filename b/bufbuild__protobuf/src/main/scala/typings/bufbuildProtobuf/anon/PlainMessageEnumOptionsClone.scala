...
trait PlainMessageEnumOptionsClone extends StObject {
  
  var allowAlias: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageEnumOptionsClone: PlainField[js.Function0[EnumOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumOptionsClone: PlainField[
...
object PlainMessageEnumOptionsClone {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions,
    ...
    __obj.asInstanceOf[PlainMessageEnumOptionsClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumOptionsClone] (val x: Self) extends AnyVal {
