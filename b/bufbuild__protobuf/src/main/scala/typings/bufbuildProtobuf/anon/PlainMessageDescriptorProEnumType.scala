...
trait PlainMessageDescriptorProEnumType extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDescriptorProEnumType: PlainField[js.Function0[DescriptorProto]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[DescriptorProto]], Any]]
  
  var enumType: PlainField[js.Array[EnumDescriptorProto]]
  
  @JSName("equals")
  var equals_FPlainMessageDescriptorProEnumType: PlainField[
    js.Function1[
      /* other */ js.UndefOr[DescriptorProto | PlainMessage[DescriptorProto] | Null], 
      Boolean
    ]
  ]
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.DescriptorProto
    ]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[DescriptorProto]]]
...
object PlainMessageDescriptorProEnumType {
  
  inline def apply(
    clone_ : () => DescriptorProto,
    constructor: /* data */ js.UndefOr[PartialMessage[DescriptorProto]] => Any,
    enumType: PlainField[js.Array[EnumDescriptorProto]],
    equals_ : /* other */ js.UndefOr[DescriptorProto | PlainMessage[DescriptorProto] | Null] => Boolean,
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto,
    getType: () => MessageType[DescriptorProto],
  ...
  ): PlainMessageDescriptorProEnumType = {
    ...
    __obj.asInstanceOf[PlainMessageDescriptorProEnumType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDescriptorProEnumType] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => DescriptorProto): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[DescriptorProto]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[DescriptorProto | PlainMessage[DescriptorProto] | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProto
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[DescriptorProto]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
