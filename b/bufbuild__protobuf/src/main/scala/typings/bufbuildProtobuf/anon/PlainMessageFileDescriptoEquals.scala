...
trait PlainMessageFileDescriptoEquals extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFileDescriptoEquals: PlainField[js.Function0[FileDescriptorSet]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[FileDescriptorSet]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageFileDescriptoEquals: PlainField[
    js.Function1[
...
object PlainMessageFileDescriptoEquals {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet,
  ...
  ): PlainMessageFileDescriptoEquals = {
    ...
    __obj.asInstanceOf[PlainMessageFileDescriptoEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileDescriptoEquals] (val x: Self) extends AnyVal {
