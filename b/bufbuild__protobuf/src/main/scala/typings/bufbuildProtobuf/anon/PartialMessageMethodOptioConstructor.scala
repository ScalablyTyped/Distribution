...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.MethodOptions> */
trait PartialMessageMethodOptioConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMethodOptioConstructor: js.UndefOr[PartialField[js.Function0[MethodOptions]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[MethodOptions]], Any]]
  ] = js.undefined
  
  var deprecated: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageMethodOptioConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[MethodOptions | PlainMessageMethodOptionsConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.MethodOptions
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[MethodOptions]]]] = js.undefined
  
  var idempotencyLevel: js.UndefOr[PartialField[js.UndefOr[MethodOptionsIdempotencyLevel]]] = js.undefined
...
object PartialMessageMethodOptioConstructor {
  
  inline def apply(): PartialMessageMethodOptioConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodOptioConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodOptioConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[MethodOptions | PlainMessageMethodOptionsConstructor | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions
    ...
    inline def setIdempotencyLevel(value: PartialField[js.UndefOr[MethodOptionsIdempotencyLevel]]): Self = StObject.set(x, "idempotencyLevel", value.asInstanceOf[js.Any])
