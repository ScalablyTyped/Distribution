...
trait PartialMessageUInt64ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageUInt64ValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageUInt64ValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageUInt64ValueClone {
  
  inline def apply(): PartialMessageUInt64ValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageUInt64ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageUInt64ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageUInt64ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageUInt64ValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageUInt64ValueClone | PlainMessage[PartialMessageUInt64ValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageUInt64ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageUInt64ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageUInt64ValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageUInt64ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
