...
trait PartialMessageEnumDescripClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumDescripClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumDescripClone: js.UndefOr[
    PartialField[
...
object PartialMessageEnumDescripClone {
  
  inline def apply(): PartialMessageEnumDescripClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumDescripClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumDescripClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageEnumDescripClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumDescripClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageEnumDescripClone | PlainMessage[PartialMessageEnumDescripClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumDescripClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumDescripClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumDescripClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumDescripClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
