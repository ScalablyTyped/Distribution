...
trait JsonNameOneof[T /* <: fiScalar | fiMap | fiEnum | fiMessage */] extends StObject {
...
object JsonNameOneof {
  
  inline def apply[T /* <: fiScalar | fiMap | fiEnum | fiMessage */](oneof: String): JsonNameOneof[T] = {
    val __obj = js.Dynamic.literal(oneof = oneof.asInstanceOf[js.Any])
    __obj.asInstanceOf[JsonNameOneof[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: JsonNameOneof[?], T /* <: fiScalar | fiMap | fiEnum | fiMessage */] (val x: Self & JsonNameOneof[T]) extends AnyVal {
