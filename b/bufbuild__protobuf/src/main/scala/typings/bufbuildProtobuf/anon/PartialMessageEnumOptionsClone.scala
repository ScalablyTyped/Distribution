...
trait PartialMessageEnumOptionsClone extends StObject {
  
  var allowAlias: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageEnumOptionsClone: js.UndefOr[PartialField[js.Function0[EnumOptions]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[EnumOptions]], Any]]
  ] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumOptionsClone: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[EnumOptions | PlainMessageEnumOptionsClone | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.EnumOptions
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[EnumOptions]]]] = js.undefined
...
object PartialMessageEnumOptionsClone {
  
  inline def apply(): PartialMessageEnumOptionsClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumOptionsClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumOptionsClone] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[EnumOptions | PlainMessageEnumOptionsClone | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumOptions
