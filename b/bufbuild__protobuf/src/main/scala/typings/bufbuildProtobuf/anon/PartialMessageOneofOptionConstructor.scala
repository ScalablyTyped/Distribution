...
trait PartialMessageOneofOptionConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageOneofOptionConstructor: js.UndefOr[PartialField[js.Function0[OneofOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageOneofOptionConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[OneofOptions | PlainMessageOneofOptionsConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageOneofOptionConstructor {
  
  inline def apply(): PartialMessageOneofOptionConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageOneofOptionConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageOneofOptionConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[OneofOptions | PlainMessageOneofOptionsConstructor | Null] => Boolean
