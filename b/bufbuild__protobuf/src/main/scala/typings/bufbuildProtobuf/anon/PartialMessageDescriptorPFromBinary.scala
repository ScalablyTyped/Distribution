...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.DescriptorProto_ExtensionRange> */
trait PartialMessageDescriptorPFromBinary extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorPFromBinary: js.UndefOr[PartialField[js.Function0[DescriptorProtoExtensionRange]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDescriptorPFromBinary: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[DescriptorProtoExtensionRange | PlainMessageDescriptorProFromBinary | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[DescriptorProtoExtensionRange]]]] = js.undefined
  
  var options: js.UndefOr[PartialField[js.UndefOr[ExtensionRangeOptions]]] = js.undefined
...
object PartialMessageDescriptorPFromBinary {
  
  inline def apply(): PartialMessageDescriptorPFromBinary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorPFromBinary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorPFromBinary] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[DescriptorProtoExtensionRange | PlainMessageDescriptorProFromBinary | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange
    ...
    inline def setOptions(value: PartialField[js.UndefOr[ExtensionRangeOptions]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
