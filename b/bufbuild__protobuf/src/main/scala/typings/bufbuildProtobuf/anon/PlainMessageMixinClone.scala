...
trait PlainMessageMixinClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMixinClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageMixinClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMixinClone: PlainField[
...
object PlainMessageMixinClone {
  
  inline def apply(
    clone_ : () => PlainMessageMixinClone,
    constructor: /* data */ js.UndefOr[PartialMessageMixinClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageMixinClone | PlainMessage[PlainMessageMixinClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMixinClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMixinClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMixinClone,
    getType: () => MessageType[PlainMessageMixinClone],
    ...
    __obj.asInstanceOf[PlainMessageMixinClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMixinClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageMixinClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageMixinClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageMixinClone | PlainMessage[PlainMessageMixinClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMixinClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMixinClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMixinClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageMixinClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
