...
trait PlainMessageEnumDescriptoEquals extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumDescriptoEquals: PlainField[js.Function0[EnumDescriptorProto]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[EnumDescriptorProto]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageEnumDescriptoEquals: PlainField[
    js.Function1[
...
object PlainMessageEnumDescriptoEquals {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.EnumDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumDescriptorProto,
  ...
  ): PlainMessageEnumDescriptoEquals = {
    ...
    __obj.asInstanceOf[PlainMessageEnumDescriptoEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumDescriptoEquals] (val x: Self) extends AnyVal {
