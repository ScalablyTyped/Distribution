...
trait PlainMessageEnumValueDesc extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValueDesc: PlainField[js.Function0[EnumValueDescriptorProto]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumValueDesc: PlainField[
    js.Function1[
...
object PlainMessageEnumValueDesc {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumValueDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueDescriptorProto,
    ...
    __obj.asInstanceOf[PlainMessageEnumValueDesc]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValueDesc] (val x: Self) extends AnyVal {
