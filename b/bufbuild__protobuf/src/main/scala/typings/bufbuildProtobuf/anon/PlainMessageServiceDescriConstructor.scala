...
trait PlainMessageServiceDescriConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageServiceDescriConstructor: PlainField[js.Function0[ServiceDescriptorProto]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[ServiceDescriptorProto]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageServiceDescriConstructor: PlainField[
    js.Function1[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.ServiceDescriptorProto
    ]
  ]
...
object PlainMessageServiceDescriConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto,
  ...
  ): PlainMessageServiceDescriConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageServiceDescriConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageServiceDescriConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceDescriptorProto
