...
trait PlainMessageOptionConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageOptionConstructor: PlainField[js.Function0[Option]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Option]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageOptionConstructor: PlainField[
...
object PlainMessageOptionConstructor {
  
  inline def apply(
    clone_ : () => Option,
    constructor: /* data */ js.UndefOr[PartialMessage[Option]] => Any,
    equals_ : /* other */ js.UndefOr[Option | PlainMessage[Option] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Option,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Option,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Option,
    ...
    __obj.asInstanceOf[PlainMessageOptionConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageOptionConstructor] (val x: Self) extends AnyVal {
