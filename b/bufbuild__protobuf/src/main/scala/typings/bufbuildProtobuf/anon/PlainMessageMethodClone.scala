...
trait PlainMessageMethodClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMethodClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageMethodClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMethodClone: PlainField[
...
object PlainMessageMethodClone {
  
  inline def apply(
    clone_ : () => PlainMessageMethodClone,
    constructor: /* data */ js.UndefOr[PartialMessageMethodClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageMethodClone | PlainMessage[PlainMessageMethodClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMethodClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodClone,
    getType: () => MessageType[PlainMessageMethodClone],
    ...
    __obj.asInstanceOf[PlainMessageMethodClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageMethodClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageMethodClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageMethodClone | PlainMessage[PlainMessageMethodClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMethodClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageMethodClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
