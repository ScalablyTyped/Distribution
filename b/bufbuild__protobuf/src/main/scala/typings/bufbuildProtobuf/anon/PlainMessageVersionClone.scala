...
trait PlainMessageVersionClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageVersionClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageVersionClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageVersionClone: PlainField[
...
object PlainMessageVersionClone {
  
  inline def apply(
    clone_ : () => PlainMessageVersionClone,
    constructor: /* data */ js.UndefOr[PartialMessageVersionClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageVersionClone | PlainMessage[PlainMessageVersionClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageVersionClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageVersionClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageVersionClone,
    getType: () => MessageType[PlainMessageVersionClone],
    ...
    __obj.asInstanceOf[PlainMessageVersionClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageVersionClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageVersionClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageVersionClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageVersionClone | PlainMessage[PlainMessageVersionClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageVersionClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageVersionClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageVersionClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageVersionClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
