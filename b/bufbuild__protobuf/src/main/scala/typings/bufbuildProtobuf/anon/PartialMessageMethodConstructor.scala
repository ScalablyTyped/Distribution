...
trait PartialMessageMethodConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMethodConstructor: js.UndefOr[PartialField[js.Function0[Method]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Method]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageMethodConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Method | PlainMessageMethodConstructor | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageMethodConstructor {
  
  inline def apply(): PartialMessageMethodConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Method | PlainMessageMethodConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
