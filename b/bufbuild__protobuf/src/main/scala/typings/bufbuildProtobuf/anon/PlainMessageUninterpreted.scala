...
trait PlainMessageUninterpreted extends StObject {
  
  var aggregateValue: js.UndefOr[PlainField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageUninterpreted: PlainField[js.Function0[UninterpretedOption]]
  ...
  @JSName("equals")
  var equals_FPlainMessageUninterpreted: PlainField[
    js.Function1[
...
object PlainMessageUninterpreted {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => UninterpretedOption,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => UninterpretedOption,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => UninterpretedOption,
    ...
    __obj.asInstanceOf[PlainMessageUninterpreted]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUninterpreted] (val x: Self) extends AnyVal {
