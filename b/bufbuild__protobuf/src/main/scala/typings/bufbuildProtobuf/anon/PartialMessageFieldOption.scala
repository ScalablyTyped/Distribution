...
trait PartialMessageFieldOption extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldOption: js.UndefOr[PartialField[js.Function0[FieldOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldOption: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[FieldOptions | PlainMessageFieldOptions | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageFieldOption {
  
  inline def apply(): PartialMessageFieldOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldOption] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[FieldOptions | PlainMessageFieldOptions | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
