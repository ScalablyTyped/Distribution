...
trait PartialMessageStringValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageStringValueConstructor: js.UndefOr[PartialField[js.Function0[StringValue]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageStringValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[StringValue | PlainMessageStringValueConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageStringValueConstructor {
  
  inline def apply(): PartialMessageStringValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageStringValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageStringValueConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[StringValue | PlainMessageStringValueConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
