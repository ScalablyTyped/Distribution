...
trait PlainMessageListValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageListValueConstructor: PlainField[js.Function0[ListValue]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[ListValue]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageListValueConstructor: PlainField[
...
object PlainMessageListValueConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ListValue,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ListValue,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ListValue,
  ...
  ): PlainMessageListValueConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageListValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageListValueConstructor] (val x: Self) extends AnyVal {
