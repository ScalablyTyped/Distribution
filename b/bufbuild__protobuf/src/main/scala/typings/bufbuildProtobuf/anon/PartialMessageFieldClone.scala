...
trait PartialMessageFieldClone extends StObject {
  
  var cardinality: js.UndefOr[PartialField[FieldCardinality]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageFieldClone: js.UndefOr[PartialField[js.Function0[Field]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldClone: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Field | PlainMessageFieldClone | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageFieldClone {
  
  inline def apply(): PartialMessageFieldClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldClone] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Field | PlainMessageFieldClone | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
