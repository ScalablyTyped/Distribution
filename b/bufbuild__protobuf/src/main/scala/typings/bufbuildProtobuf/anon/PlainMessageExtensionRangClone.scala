...
trait PlainMessageExtensionRangClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageExtensionRangClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageExtensionRaClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageExtensionRangClone: PlainField[
...
object PlainMessageExtensionRangClone {
  
  inline def apply(
    clone_ : () => PlainMessageExtensionRangClone,
    constructor: /* data */ js.UndefOr[PartialMessageExtensionRaClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageExtensionRangClone | PlainMessage[PlainMessageExtensionRangClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageExtensionRangClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageExtensionRangClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageExtensionRangClone,
    getType: () => MessageType[PlainMessageExtensionRangClone],
  ...
  ): PlainMessageExtensionRangClone = {
    ...
    __obj.asInstanceOf[PlainMessageExtensionRangClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageExtensionRangClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageExtensionRangClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageExtensionRaClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageExtensionRangClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageExtensionRangClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageExtensionRangClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageExtensionRangClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
