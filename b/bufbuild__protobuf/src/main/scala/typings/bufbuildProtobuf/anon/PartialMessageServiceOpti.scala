...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.ServiceOptions> */
trait PartialMessageServiceOpti extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageServiceOpti: js.UndefOr[PartialField[js.Function0[ServiceOptions]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[ServiceOptions]], Any]]
  ] = js.undefined
  
  var deprecated: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageServiceOpti: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[ServiceOptions | PlainMessageServiceOption | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[ServiceOptions]]]] = js.undefined
...
object PartialMessageServiceOpti {
  
  inline def apply(): PartialMessageServiceOpti = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageServiceOpti]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageServiceOpti] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[ServiceOptions | PlainMessageServiceOption | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
