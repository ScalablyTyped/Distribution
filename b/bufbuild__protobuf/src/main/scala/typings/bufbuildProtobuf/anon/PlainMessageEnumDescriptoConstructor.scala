...
trait PlainMessageEnumDescriptoConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumDescriptoConstructor: PlainField[js.Function0[EnumDescriptorProtoEnumReservedRange]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumDescriptoConstructor: PlainField[
    js.Function1[
      /* other */ js.UndefOr[
        EnumDescriptorProtoEnumReservedRange | PlainMessage[EnumDescriptorProtoEnumReservedRange] | Null
      ], 
      Boolean
    ]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[EnumDescriptorProtoEnumReservedRange]]]
...
object PlainMessageEnumDescriptoConstructor {
  
  inline def apply(
    clone_ : () => EnumDescriptorProtoEnumReservedRange,
    constructor: /* data */ js.UndefOr[PartialMessage[EnumDescriptorProtoEnumReservedRange]] => Any,
    equals_ : /* other */ js.UndefOr[
      EnumDescriptorProtoEnumReservedRange | PlainMessage[EnumDescriptorProtoEnumReservedRange] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumDescriptorProtoEnumReservedRange,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumDescriptorProtoEnumReservedRange,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumDescriptorProtoEnumReservedRange,
    getType: () => MessageType[EnumDescriptorProtoEnumReservedRange],
  ...
  ): PlainMessageEnumDescriptoConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageEnumDescriptoConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumDescriptoConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumDescriptorProtoEnumReservedRange
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumDescriptorProtoEnumReservedRange
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumDescriptorProtoEnumReservedRange
