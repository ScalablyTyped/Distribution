...
trait PartialMessageInt32ValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageInt32ValueConstructor: js.UndefOr[PartialField[js.Function0[Int32Value]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Int32Value]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageInt32ValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[Int32Value | PlainMessageInt32ValueConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Int32Value]]]] = js.undefined
...
object PartialMessageInt32ValueConstructor {
  
  inline def apply(): PartialMessageInt32ValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageInt32ValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageInt32ValueConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Int32Value | PlainMessageInt32ValueConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
