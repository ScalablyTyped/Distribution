...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescFieldEnum & @bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescFieldCommon & {  kind :'field',  readonly parent :@bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescMessage} */
trait DescFieldEnumDescFieldCom
  extends StObject
     with DescField {
...
object DescFieldEnumDescFieldCom {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DescFieldEnumDescFieldCom]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescFieldEnumDescFieldCom] (val x: Self) extends AnyVal {
