...
trait PlainMessageDoubleValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDoubleValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageDoubleValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageDoubleValueClone: PlainField[
...
object PlainMessageDoubleValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageDoubleValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageDoubleValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageDoubleValueClone | PlainMessage[PlainMessageDoubleValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageDoubleValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageDoubleValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageDoubleValueClone,
    getType: () => MessageType[PlainMessageDoubleValueClone],
    ...
    __obj.asInstanceOf[PlainMessageDoubleValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDoubleValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageDoubleValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageDoubleValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageDoubleValueClone | PlainMessage[PlainMessageDoubleValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageDoubleValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageDoubleValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageDoubleValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageDoubleValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
