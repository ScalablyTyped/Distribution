...
trait PlainMessageSourceCodeInfConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceCodeInfConstructor: PlainField[js.Function0[SourceCodeInfoLocation]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[SourceCodeInfoLocation]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceCodeInfConstructor: PlainField[
    js.Function1[
...
object PlainMessageSourceCodeInfConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => SourceCodeInfoLocation,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceCodeInfoLocation,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceCodeInfoLocation,
  ...
  ): PlainMessageSourceCodeInfConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageSourceCodeInfConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceCodeInfConstructor] (val x: Self) extends AnyVal {
