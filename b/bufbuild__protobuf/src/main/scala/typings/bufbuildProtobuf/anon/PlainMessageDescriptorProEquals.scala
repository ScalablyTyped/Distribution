...
trait PlainMessageDescriptorProEquals extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDescriptorProEquals: PlainField[js.Function0[DescriptorProtoReservedRange]]
  
  var constructor: PlainField[
    js.Function1[/* data */ js.UndefOr[PartialMessage[DescriptorProtoReservedRange]], Any]
  ]
  
  var end: js.UndefOr[PlainField[js.UndefOr[Double]]] = js.undefined
  
  @JSName("equals")
  var equals_FPlainMessageDescriptorProEquals: PlainField[
    js.Function1[
      /* other */ js.UndefOr[DescriptorProtoReservedRange | PlainMessage[DescriptorProtoReservedRange] | Null], 
      Boolean
    ]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[DescriptorProtoReservedRange]]]
...
object PlainMessageDescriptorProEquals {
  
  inline def apply(
    clone_ : () => DescriptorProtoReservedRange,
    constructor: /* data */ js.UndefOr[PartialMessage[DescriptorProtoReservedRange]] => Any,
    equals_ : /* other */ js.UndefOr[DescriptorProtoReservedRange | PlainMessage[DescriptorProtoReservedRange] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => DescriptorProtoReservedRange,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProtoReservedRange,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProtoReservedRange,
    getType: () => MessageType[DescriptorProtoReservedRange],
  ...
  ): PlainMessageDescriptorProEquals = {
    ...
    __obj.asInstanceOf[PlainMessageDescriptorProEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDescriptorProEquals] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => DescriptorProtoReservedRange): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[DescriptorProtoReservedRange]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[DescriptorProtoReservedRange | PlainMessage[DescriptorProtoReservedRange] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => DescriptorProtoReservedRange
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProtoReservedRange
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProtoReservedRange
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[DescriptorProtoReservedRange]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
