...
trait PlainMessageInt32Value extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageInt32Value: PlainField[js.Function0[Int32Value]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Int32Value]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageInt32Value: PlainField[
  ...
  var fromJson: PlainField[
    js.Function2[/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], Int32Value]
  ]
...
object PlainMessageInt32Value {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Int32Value,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Int32Value,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Int32Value,
    ...
    __obj.asInstanceOf[PlainMessageInt32Value]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageInt32Value] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Int32Value
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Int32Value): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Int32Value): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
