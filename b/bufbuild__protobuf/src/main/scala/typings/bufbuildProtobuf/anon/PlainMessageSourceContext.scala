...
trait PlainMessageSourceContext extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceContext: PlainField[js.Function0[SourceContext]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[SourceContext]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceContext: PlainField[
    js.Function1[
...
object PlainMessageSourceContext {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => SourceContext,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceContext,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceContext,
    ...
    __obj.asInstanceOf[PlainMessageSourceContext]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceContext] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => SourceContext
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceContext
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceContext
