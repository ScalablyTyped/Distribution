...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/type_pb.Type> */
trait PartialMessageTypeConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageTypeConstructor: js.UndefOr[PartialField[js.Function0[Type]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Type]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageTypeConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Type | PlainMessageTypeConstructor | Null], Boolean]
    ]
  ] = js.undefined
  
  var fields: js.UndefOr[PartialField[js.Array[Field]]] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.Type
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Type]]]] = js.undefined
  
  var name: js.UndefOr[PartialField[String]] = js.undefined
  
  var oneofs: js.UndefOr[PartialField[js.Array[String]]] = js.undefined
...
object PartialMessageTypeConstructor {
  
  inline def apply(): PartialMessageTypeConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageTypeConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageTypeConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Type | PlainMessageTypeConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    
    inline def setEquals_Undefined: Self = StObject.set(x, "equals", js.undefined)
    
    inline def setFields(value: PartialField[js.Array[Field]]): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Type
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Type
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Type
    ...
    inline def setOneofs(value: PartialField[js.Array[String]]): Self = StObject.set(x, "oneofs", value.asInstanceOf[js.Any])
