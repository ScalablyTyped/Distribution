...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PlainMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.BytesValue> */
trait PlainMessageBytesValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageBytesValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageBytesValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageBytesValueClone: PlainField[
...
object PlainMessageBytesValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageBytesValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageBytesValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageBytesValueClone | PlainMessage[PlainMessageBytesValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageBytesValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageBytesValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageBytesValueClone,
    getType: () => MessageType[PlainMessageBytesValueClone],
    ...
    __obj.asInstanceOf[PlainMessageBytesValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageBytesValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageBytesValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageBytesValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageBytesValueClone | PlainMessage[PlainMessageBytesValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageBytesValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageBytesValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageBytesValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageBytesValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
