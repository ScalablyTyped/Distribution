...
trait PlainMessageGeneratedCode extends StObject {
  
  var annotation: PlainField[js.Array[GeneratedCodeInfoAnnotation]]
  
  @JSName("clone")
  var clone_FPlainMessageGeneratedCode: PlainField[js.Function0[GeneratedCodeInfo]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[GeneratedCodeInfo]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageGeneratedCode: PlainField[
    js.Function1[
...
object PlainMessageGeneratedCode {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => GeneratedCodeInfo,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfo,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfo,
    ...
    __obj.asInstanceOf[PlainMessageGeneratedCode]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageGeneratedCode] (val x: Self) extends AnyVal {
