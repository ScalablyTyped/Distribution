...
trait PlainMessageServiceOptionConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageServiceOptionConstructor: PlainField[js.Function0[ServiceOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageServiceOptionConstructor: PlainField[
    js.Function1[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.ServiceOptions
    ]
  ]
...
object PlainMessageServiceOptionConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions,
  ...
  ): PlainMessageServiceOptionConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageServiceOptionConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageServiceOptionConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ServiceOptions
