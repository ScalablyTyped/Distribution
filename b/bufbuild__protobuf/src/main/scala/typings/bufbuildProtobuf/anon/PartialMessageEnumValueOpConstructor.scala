...
trait PartialMessageEnumValueOpConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueOpConstructor: js.UndefOr[PartialField[js.Function0[EnumValueOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueOpConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[EnumValueOptions | PlainMessageEnumValueOptiConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageEnumValueOpConstructor {
  
  inline def apply(): PartialMessageEnumValueOpConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueOpConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueOpConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[EnumValueOptions | PlainMessageEnumValueOptiConstructor | Null] => Boolean
