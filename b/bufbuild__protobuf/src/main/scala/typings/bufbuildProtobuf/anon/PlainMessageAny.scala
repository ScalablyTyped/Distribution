...
trait PlainMessageAny extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageAny: PlainField[js.Function0[Any]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Any]], scala.Any]]
  
  @JSName("equals")
  var equals_FPlainMessageAny: PlainField[js.Function1[/* other */ js.UndefOr[Any | PlainMessage[Any] | Null], Boolean]]
...
object PlainMessageAny {
  
  inline def apply(
    clone_ : () => Any,
    constructor: /* data */ js.UndefOr[PartialMessage[Any]] => scala.Any,
    equals_ : /* other */ js.UndefOr[Any | PlainMessage[Any] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Any,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Any,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Any,
    ...
    __obj.asInstanceOf[PlainMessageAny]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageAny] (val x: Self) extends AnyVal {
