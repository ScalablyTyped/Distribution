...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.DoubleValue> */
trait PartialMessageDoubleValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDoubleValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDoubleValueClone: js.UndefOr[
    PartialField[
  ...
  var value: js.UndefOr[PartialField[Double]] = js.undefined
}
object PartialMessageDoubleValueClone {
  
  inline def apply(): PartialMessageDoubleValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDoubleValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDoubleValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageDoubleValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageDoubleValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageDoubleValueClone | PlainMessage[PartialMessageDoubleValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageDoubleValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDoubleValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDoubleValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageDoubleValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
    ...
    inline def setValue(value: PartialField[Double]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
