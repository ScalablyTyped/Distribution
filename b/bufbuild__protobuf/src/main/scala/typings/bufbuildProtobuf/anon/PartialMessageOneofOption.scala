...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.OneofOptions> */
trait PartialMessageOneofOption extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageOneofOption: js.UndefOr[PartialField[js.Function0[OneofOptions]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[OneofOptions]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageOneofOption: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[OneofOptions | PlainMessageOneofOptions | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[OneofOptions]]]] = js.undefined
...
object PartialMessageOneofOption {
  
  inline def apply(): PartialMessageOneofOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageOneofOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageOneofOption] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[OneofOptions | PlainMessageOneofOptions | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => OneofOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => OneofOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => OneofOptions): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
