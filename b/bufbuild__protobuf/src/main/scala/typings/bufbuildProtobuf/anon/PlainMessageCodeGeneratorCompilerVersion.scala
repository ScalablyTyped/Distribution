...
trait PlainMessageCodeGeneratorCompilerVersion extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageCodeGeneratorCompilerVersion: PlainField[js.Function0[CodeGeneratorRequest]]
  ...
  @JSName("equals")
  var equals_FPlainMessageCodeGeneratorCompilerVersion: PlainField[
    js.Function1[
...
object PlainMessageCodeGeneratorCompilerVersion {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.CodeGeneratorRequest,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.CodeGeneratorRequest,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.CodeGeneratorRequest,
  ...
  ): PlainMessageCodeGeneratorCompilerVersion = {
    ...
    __obj.asInstanceOf[PlainMessageCodeGeneratorCompilerVersion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageCodeGeneratorCompilerVersion] (val x: Self) extends AnyVal {
