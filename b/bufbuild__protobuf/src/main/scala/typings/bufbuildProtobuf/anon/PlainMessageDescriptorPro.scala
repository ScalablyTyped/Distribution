...
trait PlainMessageDescriptorPro extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDescriptorPro: PlainField[js.Function0[DescriptorProto]]
  ...
  @JSName("equals")
  var equals_FPlainMessageDescriptorPro: PlainField[
    js.Function1[
...
object PlainMessageDescriptorPro {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => DescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProto,
    ...
    __obj.asInstanceOf[PlainMessageDescriptorPro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDescriptorPro] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => DescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => DescriptorProto
