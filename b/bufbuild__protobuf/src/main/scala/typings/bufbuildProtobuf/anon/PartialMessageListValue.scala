...
trait PartialMessageListValue extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageListValue: js.UndefOr[PartialField[js.Function0[ListValue]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageListValue: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[ListValue | PlainMessageListValue | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageListValue {
  
  inline def apply(): PartialMessageListValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageListValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageListValue] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[ListValue | PlainMessageListValue | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
