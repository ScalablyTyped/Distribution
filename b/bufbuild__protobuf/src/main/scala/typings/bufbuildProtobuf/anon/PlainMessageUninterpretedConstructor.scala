...
trait PlainMessageUninterpretedConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageUninterpretedConstructor: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageUninterpretConstructor], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageUninterpretedConstructor: PlainField[
...
object PlainMessageUninterpretedConstructor {
  
  inline def apply(
    clone_ : () => PlainMessageUninterpretedConstructor,
    constructor: /* data */ js.UndefOr[PartialMessageUninterpretConstructor] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageUninterpretedConstructor | PlainMessage[PlainMessageUninterpretedConstructor] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUninterpretedConstructor,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedConstructor,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedConstructor,
    getType: () => MessageType[PlainMessageUninterpretedConstructor],
  ...
  ): PlainMessageUninterpretedConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageUninterpretedConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUninterpretedConstructor] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageUninterpretedConstructor): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageUninterpretConstructor] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUninterpretedConstructor
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedConstructor
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedConstructor
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageUninterpretedConstructor]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
