...
trait PlainMessageMethodOptionsClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMethodOptionsClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageMethodOptioClone], Any]]
  
  var deprecated: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("equals")
  var equals_FPlainMessageMethodOptionsClone: PlainField[
...
object PlainMessageMethodOptionsClone {
  
  inline def apply(
    clone_ : () => PlainMessageMethodOptionsClone,
    constructor: /* data */ js.UndefOr[PartialMessageMethodOptioClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageMethodOptionsClone | PlainMessage[PlainMessageMethodOptionsClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMethodOptionsClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodOptionsClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodOptionsClone,
    getType: () => MessageType[PlainMessageMethodOptionsClone],
  ...
  ): PlainMessageMethodOptionsClone = {
    ...
    __obj.asInstanceOf[PlainMessageMethodOptionsClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodOptionsClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageMethodOptionsClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageMethodOptioClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageMethodOptionsClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodOptionsClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageMethodOptionsClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageMethodOptionsClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
