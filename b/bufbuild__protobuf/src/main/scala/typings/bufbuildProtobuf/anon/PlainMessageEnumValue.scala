...
trait PlainMessageEnumValue extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValue: PlainField[js.Function0[EnumValue]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[EnumValue]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageEnumValue: PlainField[
...
object PlainMessageEnumValue {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumValue,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValue,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValue,
    ...
    __obj.asInstanceOf[PlainMessageEnumValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValue] (val x: Self) extends AnyVal {
