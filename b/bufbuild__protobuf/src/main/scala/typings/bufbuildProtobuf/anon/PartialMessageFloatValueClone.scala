...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.FloatValue> */
trait PartialMessageFloatValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFloatValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFloatValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageFloatValueClone {
  
  inline def apply(): PartialMessageFloatValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFloatValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFloatValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageFloatValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFloatValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageFloatValueClone | PlainMessage[PartialMessageFloatValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFloatValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFloatValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFloatValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFloatValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
