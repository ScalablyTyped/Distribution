...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.UInt32Value> */
trait PartialMessageUInt32ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageUInt32ValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageUInt32ValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageUInt32ValueClone {
  
  inline def apply(): PartialMessageUInt32ValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageUInt32ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageUInt32ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageUInt32ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageUInt32ValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageUInt32ValueClone | PlainMessage[PartialMessageUInt32ValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageUInt32ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageUInt32ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageUInt32ValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageUInt32ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
