...
trait PlainMessageFileOptionsCcGenericServices extends StObject {
  ...
  @JSName("clone")
  var clone_FPlainMessageFileOptionsCcGenericServices: PlainField[js.Function0[FileOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFileOptionsCcGenericServices: PlainField[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.FileOptions
    ]
  ]
...
object PlainMessageFileOptionsCcGenericServices {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions,
  ...
  ): PlainMessageFileOptionsCcGenericServices = {
    ...
    __obj.asInstanceOf[PlainMessageFileOptionsCcGenericServices]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileOptionsCcGenericServices] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileOptions
