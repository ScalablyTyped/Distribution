...
trait PartialMessageMethodDescrClientStreaming extends StObject {
  
  var clientStreaming: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageMethodDescrClientStreaming: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMethodDescrClientStreaming: js.UndefOr[
    PartialField[
...
object PartialMessageMethodDescrClientStreaming {
  
  inline def apply(): PartialMessageMethodDescrClientStreaming = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodDescrClientStreaming]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodDescrClientStreaming] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => PartialMessageMethodDescrClientStreaming): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageMethodDescrClientStreaming]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageMethodDescrClientStreaming | PlainMessage[PartialMessageMethodDescrClientStreaming] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageMethodDescrClientStreaming
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMethodDescrClientStreaming
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMethodDescrClientStreaming
    ...
    inline def setGetType(value: () => MessageType[PartialMessageMethodDescrClientStreaming]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
