...
trait PlainMessageGeneratedCodeBegin extends StObject {
  
  var begin: js.UndefOr[PlainField[js.UndefOr[Double]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageGeneratedCodeBegin: PlainField[js.Function0[GeneratedCodeInfoAnnotation]]
  ...
  @JSName("equals")
  var equals_FPlainMessageGeneratedCodeBegin: PlainField[
    js.Function1[
...
object PlainMessageGeneratedCodeBegin {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => GeneratedCodeInfoAnnotation,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfoAnnotation,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfoAnnotation,
  ...
  ): PlainMessageGeneratedCodeBegin = {
    ...
    __obj.asInstanceOf[PlainMessageGeneratedCodeBegin]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageGeneratedCodeBegin] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => GeneratedCodeInfoAnnotation
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfoAnnotation
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfoAnnotation
