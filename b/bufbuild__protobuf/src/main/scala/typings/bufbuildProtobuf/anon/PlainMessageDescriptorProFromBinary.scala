...
trait PlainMessageDescriptorProFromBinary extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDescriptorProFromBinary: PlainField[js.Function0[DescriptorProtoExtensionRange]]
  ...
  @JSName("equals")
  var equals_FPlainMessageDescriptorProFromBinary: PlainField[
    js.Function1[
      /* other */ js.UndefOr[
...
object PlainMessageDescriptorProFromBinary {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DescriptorProtoExtensionRange,
  ...
  ): PlainMessageDescriptorProFromBinary = {
    ...
    __obj.asInstanceOf[PlainMessageDescriptorProFromBinary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDescriptorProFromBinary] (val x: Self) extends AnyVal {
