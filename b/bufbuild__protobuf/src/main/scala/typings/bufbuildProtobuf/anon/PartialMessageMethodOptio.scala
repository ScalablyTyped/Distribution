...
trait PartialMessageMethodOptio extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMethodOptio: js.UndefOr[PartialField[js.Function0[MethodOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMethodOptio: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[MethodOptions | PlainMessageMethodOptions | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageMethodOptio {
  
  inline def apply(): PartialMessageMethodOptio = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodOptio]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodOptio] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[MethodOptions | PlainMessageMethodOptions | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
