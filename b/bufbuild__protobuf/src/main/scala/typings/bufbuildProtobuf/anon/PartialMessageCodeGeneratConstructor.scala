...
trait PartialMessageCodeGeneratConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGeneratConstructor: js.UndefOr[PartialField[js.Function0[CodeGeneratorResponse]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageCodeGeneratConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[CodeGeneratorResponse | PlainMessageCodeGeneratorConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageCodeGeneratConstructor {
  
  inline def apply(): PartialMessageCodeGeneratConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGeneratConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGeneratConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[CodeGeneratorResponse | PlainMessageCodeGeneratorConstructor | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => CodeGeneratorResponse
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponse
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponse
