...
trait PartialMessageInt64ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageInt64ValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageInt64ValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageInt64ValueClone {
  
  inline def apply(): PartialMessageInt64ValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageInt64ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageInt64ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageInt64ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageInt64ValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageInt64ValueClone | PlainMessage[PartialMessageInt64ValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageInt64ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageInt64ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageInt64ValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageInt64ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
