...
trait PlainMessageFloatValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFloatValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageFloatValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageFloatValueClone: PlainField[
...
object PlainMessageFloatValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageFloatValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageFloatValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageFloatValueClone | PlainMessage[PlainMessageFloatValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFloatValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFloatValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFloatValueClone,
    getType: () => MessageType[PlainMessageFloatValueClone],
    ...
    __obj.asInstanceOf[PlainMessageFloatValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFloatValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageFloatValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageFloatValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageFloatValueClone | PlainMessage[PlainMessageFloatValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFloatValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFloatValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFloatValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageFloatValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
