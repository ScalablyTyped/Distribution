...
trait PartialMessageDuration extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDuration: js.UndefOr[PartialField[js.Function0[Duration]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Duration]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageDuration: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Duration | PlainMessageDuration | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var fromJson: js.UndefOr[
    PartialField[
      js.Function2[/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], Duration]
    ]
  ] = js.undefined
  
  var fromJsonString: js.UndefOr[
    PartialField[
      js.Function2[/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions], Duration]
    ]
  ] = js.undefined
...
object PartialMessageDuration {
  
  inline def apply(): PartialMessageDuration = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDuration]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDuration] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Duration | PlainMessageDuration | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Duration
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Duration): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Duration): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
