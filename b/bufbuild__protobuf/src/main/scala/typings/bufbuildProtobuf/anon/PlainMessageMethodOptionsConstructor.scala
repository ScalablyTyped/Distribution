...
trait PlainMessageMethodOptionsConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMethodOptionsConstructor: PlainField[js.Function0[MethodOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageMethodOptionsConstructor: PlainField[
    js.Function1[
...
object PlainMessageMethodOptionsConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodOptions,
  ...
  ): PlainMessageMethodOptionsConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageMethodOptionsConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodOptionsConstructor] (val x: Self) extends AnyVal {
