...
trait PartialMessageFieldMask extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldMask: js.UndefOr[PartialField[js.Function0[FieldMask]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldMask: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[FieldMask | PlainMessageFieldMask | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageFieldMask {
  
  inline def apply(): PartialMessageFieldMask = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldMask]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldMask] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[FieldMask | PlainMessageFieldMask | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
