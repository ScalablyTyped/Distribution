...
trait PartialMessageEnumValueDeClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueDeClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueDeClone: js.UndefOr[
    PartialField[
...
object PartialMessageEnumValueDeClone {
  
  inline def apply(): PartialMessageEnumValueDeClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueDeClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueDeClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageEnumValueDeClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumValueDeClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageEnumValueDeClone | PlainMessage[PartialMessageEnumValueDeClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumValueDeClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueDeClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueDeClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumValueDeClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
