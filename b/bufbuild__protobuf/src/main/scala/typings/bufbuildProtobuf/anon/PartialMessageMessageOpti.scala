...
trait PartialMessageMessageOpti extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMessageOpti: js.UndefOr[PartialField[js.Function0[MessageOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMessageOpti: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[MessageOptions | PlainMessageMessageOption | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageMessageOpti {
  
  inline def apply(): PartialMessageMessageOpti = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMessageOpti]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMessageOpti] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[MessageOptions | PlainMessageMessageOption | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
