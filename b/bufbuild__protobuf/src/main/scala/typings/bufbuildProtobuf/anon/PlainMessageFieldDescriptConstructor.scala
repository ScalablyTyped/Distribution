...
trait PlainMessageFieldDescriptConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFieldDescriptConstructor: PlainField[js.Function0[FieldDescriptorProto]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFieldDescriptConstructor: PlainField[
    js.Function1[
...
object PlainMessageFieldDescriptConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FieldDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FieldDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FieldDescriptorProto,
  ...
  ): PlainMessageFieldDescriptConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageFieldDescriptConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFieldDescriptConstructor] (val x: Self) extends AnyVal {
