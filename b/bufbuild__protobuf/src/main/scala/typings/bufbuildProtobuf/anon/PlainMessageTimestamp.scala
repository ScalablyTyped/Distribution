...
trait PlainMessageTimestamp extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageTimestamp: PlainField[js.Function0[Timestamp]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Timestamp]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageTimestamp: PlainField[
...
object PlainMessageTimestamp {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Timestamp,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Timestamp,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Timestamp,
    ...
    __obj.asInstanceOf[PlainMessageTimestamp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageTimestamp] (val x: Self) extends AnyVal {
