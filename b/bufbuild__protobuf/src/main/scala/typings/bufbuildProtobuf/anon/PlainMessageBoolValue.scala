...
trait PlainMessageBoolValue extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageBoolValue: PlainField[
  ...
  @JSName("equals")
  var equals_FPlainMessageBoolValue: PlainField[
    js.Function1[
      /* other */ js.UndefOr[
...
object PlainMessageBoolValue {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.distTypesGoogleProtobufWrappersPbMod.BoolValue,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.distTypesGoogleProtobufWrappersPbMod.BoolValue,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.distTypesGoogleProtobufWrappersPbMod.BoolValue,
    ...
    __obj.asInstanceOf[PlainMessageBoolValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageBoolValue] (val x: Self) extends AnyVal {
