...
trait PlainMessageFieldMaskClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFieldMaskClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageFieldMaskClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageFieldMaskClone: PlainField[
...
object PlainMessageFieldMaskClone {
  
  inline def apply(
    clone_ : () => PlainMessageFieldMaskClone,
    constructor: /* data */ js.UndefOr[PartialMessageFieldMaskClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageFieldMaskClone | PlainMessage[PlainMessageFieldMaskClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFieldMaskClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldMaskClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldMaskClone,
    getType: () => MessageType[PlainMessageFieldMaskClone],
    ...
    __obj.asInstanceOf[PlainMessageFieldMaskClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFieldMaskClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageFieldMaskClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageFieldMaskClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageFieldMaskClone | PlainMessage[PlainMessageFieldMaskClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFieldMaskClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldMaskClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldMaskClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageFieldMaskClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
