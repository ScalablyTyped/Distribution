...
object DescFieldEnumDescFieldComDeclarationString {
  ...
  inline def apply(
    ...
    scalar: Unit,
    typeName: String
  ): DescFieldEnumDescFieldComDeclarationString = {
    ...
    __obj.asInstanceOf[DescFieldEnumDescFieldComDeclarationString]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescFieldEnumDescFieldComDeclarationString] (val x: Self) extends AnyVal {
