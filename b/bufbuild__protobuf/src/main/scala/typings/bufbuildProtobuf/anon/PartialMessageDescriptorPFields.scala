...
trait PartialMessageDescriptorPFields extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorPFields: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDescriptorPFields: js.UndefOr[
    PartialField[
...
object PartialMessageDescriptorPFields {
  
  inline def apply(): PartialMessageDescriptorPFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorPFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorPFields] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageDescriptorPFields): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageDescriptorPFields]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageDescriptorPFields | PlainMessage[PartialMessageDescriptorPFields] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageDescriptorPFields
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDescriptorPFields
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDescriptorPFields
    ...
    inline def setGetType(value: () => MessageType[PartialMessageDescriptorPFields]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
