...
trait PlainMessageMethodDescrip extends StObject {
  
  var clientStreaming: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageMethodDescrip: PlainField[js.Function0[MethodDescriptorProto]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[MethodDescriptorProto]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMethodDescrip: PlainField[
    js.Function1[
      /* other */ js.UndefOr[MethodDescriptorProto | PlainMessage[MethodDescriptorProto] | Null], 
      Boolean
    ]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[MethodDescriptorProto]]]
...
object PlainMessageMethodDescrip {
  
  inline def apply(
    clone_ : () => MethodDescriptorProto,
    constructor: /* data */ js.UndefOr[PartialMessage[MethodDescriptorProto]] => Any,
    equals_ : /* other */ js.UndefOr[MethodDescriptorProto | PlainMessage[MethodDescriptorProto] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => MethodDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => MethodDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => MethodDescriptorProto,
    getType: () => MessageType[MethodDescriptorProto],
    ...
    __obj.asInstanceOf[PlainMessageMethodDescrip]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodDescrip] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[MethodDescriptorProto | PlainMessage[MethodDescriptorProto] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => MethodDescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => MethodDescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => MethodDescriptorProto
