...
trait PlainMessageCodeGeneratorContent extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageCodeGeneratorContent: PlainField[js.Function0[CodeGeneratorResponseFile]]
  ...
  @JSName("equals")
  var equals_FPlainMessageCodeGeneratorContent: PlainField[
    js.Function1[
...
object PlainMessageCodeGeneratorContent {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => CodeGeneratorResponseFile,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponseFile,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponseFile,
  ...
  ): PlainMessageCodeGeneratorContent = {
    ...
    __obj.asInstanceOf[PlainMessageCodeGeneratorContent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageCodeGeneratorContent] (val x: Self) extends AnyVal {
