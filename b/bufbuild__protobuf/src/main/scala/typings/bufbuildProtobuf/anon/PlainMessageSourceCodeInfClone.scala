...
trait PlainMessageSourceCodeInfClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceCodeInfClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageSourceCodeIClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceCodeInfClone: PlainField[
...
object PlainMessageSourceCodeInfClone {
  
  inline def apply(
    clone_ : () => PlainMessageSourceCodeInfClone,
    constructor: /* data */ js.UndefOr[PartialMessageSourceCodeIClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageSourceCodeInfClone | PlainMessage[PlainMessageSourceCodeInfClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceCodeInfClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfClone,
    getType: () => MessageType[PlainMessageSourceCodeInfClone],
  ...
  ): PlainMessageSourceCodeInfClone = {
    ...
    __obj.asInstanceOf[PlainMessageSourceCodeInfClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceCodeInfClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageSourceCodeInfClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageSourceCodeIClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceCodeInfClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageSourceCodeInfClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
