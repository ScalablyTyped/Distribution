...
trait PartialMessageCodeGeneratContent extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGeneratContent: js.UndefOr[PartialField[js.Function0[CodeGeneratorResponseFile]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageCodeGeneratContent: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[CodeGeneratorResponseFile | PlainMessageCodeGeneratorContent | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[CodeGeneratorResponseFile]]]] = js.undefined
...
object PartialMessageCodeGeneratContent {
  
  inline def apply(): PartialMessageCodeGeneratContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGeneratContent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGeneratContent] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[CodeGeneratorResponseFile | PlainMessageCodeGeneratorContent | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => CodeGeneratorResponseFile
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponseFile
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponseFile
