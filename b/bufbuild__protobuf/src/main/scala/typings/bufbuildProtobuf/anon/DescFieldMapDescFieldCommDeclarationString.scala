...
object DescFieldMapDescFieldCommDeclarationString {
  ...
  inline def apply(
    ...
    scalar: Unit,
    typeName: String
  ): DescFieldMapDescFieldCommDeclarationString = {
    ...
    __obj.asInstanceOf[DescFieldMapDescFieldCommDeclarationString]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescFieldMapDescFieldCommDeclarationString] (val x: Self) extends AnyVal {
