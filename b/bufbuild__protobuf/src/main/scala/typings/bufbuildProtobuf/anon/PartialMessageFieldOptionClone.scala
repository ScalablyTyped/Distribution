...
trait PartialMessageFieldOptionClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldOptionClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldOptionClone: js.UndefOr[
    PartialField[
...
object PartialMessageFieldOptionClone {
  
  inline def apply(): PartialMessageFieldOptionClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldOptionClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldOptionClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageFieldOptionClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFieldOptionClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageFieldOptionClone | PlainMessage[PartialMessageFieldOptionClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFieldOptionClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldOptionClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldOptionClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFieldOptionClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
