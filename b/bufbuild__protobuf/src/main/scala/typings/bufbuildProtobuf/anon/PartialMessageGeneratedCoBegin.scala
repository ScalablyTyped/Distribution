...
trait PartialMessageGeneratedCoBegin extends StObject {
  
  var begin: js.UndefOr[PartialField[js.UndefOr[Double]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageGeneratedCoBegin: js.UndefOr[PartialField[js.Function0[GeneratedCodeInfoAnnotation]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageGeneratedCoBegin: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[GeneratedCodeInfoAnnotation | PlainMessageGeneratedCodeBegin | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageGeneratedCoBegin {
  
  inline def apply(): PartialMessageGeneratedCoBegin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageGeneratedCoBegin]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageGeneratedCoBegin] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[GeneratedCodeInfoAnnotation | PlainMessageGeneratedCodeBegin | Null] => Boolean
