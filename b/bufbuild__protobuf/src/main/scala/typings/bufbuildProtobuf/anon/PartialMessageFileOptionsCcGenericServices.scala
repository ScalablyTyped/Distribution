...
trait PartialMessageFileOptionsCcGenericServices extends StObject {
  ...
  @JSName("clone")
  var clone_FPartialMessageFileOptionsCcGenericServices: js.UndefOr[PartialField[js.Function0[FileOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileOptionsCcGenericServices: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[FileOptions | PlainMessageFileOptionsCcGenericServices | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageFileOptionsCcGenericServices {
  
  inline def apply(): PartialMessageFileOptionsCcGenericServices = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileOptionsCcGenericServices]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileOptionsCcGenericServices] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[FileOptions | PlainMessageFileOptionsCcGenericServices | Null] => Boolean
