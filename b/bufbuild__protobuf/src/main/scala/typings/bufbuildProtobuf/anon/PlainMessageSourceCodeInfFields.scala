...
trait PlainMessageSourceCodeInfFields extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceCodeInfFields: PlainField[js.Function0[SourceCodeInfo]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[SourceCodeInfo]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceCodeInfFields: PlainField[
    js.Function1[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.SourceCodeInfo
    ]
  ]
...
object PlainMessageSourceCodeInfFields {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo,
  ...
  ): PlainMessageSourceCodeInfFields = {
    ...
    __obj.asInstanceOf[PlainMessageSourceCodeInfFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceCodeInfFields] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.SourceCodeInfo
