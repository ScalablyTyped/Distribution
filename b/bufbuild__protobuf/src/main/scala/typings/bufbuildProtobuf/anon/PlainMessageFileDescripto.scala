...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PlainMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.FileDescriptorSet> */
trait PlainMessageFileDescripto extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFileDescripto: PlainField[js.Function0[FileDescriptorSet]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[FileDescriptorSet]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageFileDescripto: PlainField[
    js.Function1[
      /* other */ js.UndefOr[FileDescriptorSet | PlainMessage[FileDescriptorSet] | Null], 
      Boolean
    ]
  ]
  ...
  var file: PlainField[js.Array[FileDescriptorProto]]
  ...
  var getType: PlainField[js.Function0[MessageType[FileDescriptorSet]]]
...
object PlainMessageFileDescripto {
  
  inline def apply(
    clone_ : () => FileDescriptorSet,
    constructor: /* data */ js.UndefOr[PartialMessage[FileDescriptorSet]] => Any,
    equals_ : /* other */ js.UndefOr[FileDescriptorSet | PlainMessage[FileDescriptorSet] | Null] => Boolean,
    file: PlainField[js.Array[FileDescriptorProto]],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => FileDescriptorSet,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => FileDescriptorSet,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => FileDescriptorSet,
    getType: () => MessageType[FileDescriptorSet],
    ...
    __obj.asInstanceOf[PlainMessageFileDescripto]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileDescripto] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[FileDescriptorSet | PlainMessage[FileDescriptorSet] | Null] => Boolean
    ...
    inline def setFile(value: PlainField[js.Array[FileDescriptorProto]]): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
