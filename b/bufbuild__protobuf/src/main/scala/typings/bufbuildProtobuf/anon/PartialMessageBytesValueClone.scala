...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.BytesValue> */
trait PartialMessageBytesValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageBytesValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageBytesValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageBytesValueClone {
  
  inline def apply(): PartialMessageBytesValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageBytesValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageBytesValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageBytesValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageBytesValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageBytesValueClone | PlainMessage[PartialMessageBytesValueClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageBytesValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageBytesValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageBytesValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageBytesValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
