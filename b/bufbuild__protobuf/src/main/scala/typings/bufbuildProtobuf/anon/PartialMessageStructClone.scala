...
trait PartialMessageStructClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageStructClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageStructClone: js.UndefOr[
    PartialField[
...
object PartialMessageStructClone {
  
  inline def apply(): PartialMessageStructClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageStructClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageStructClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageStructClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageStructClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageStructClone | PlainMessage[PartialMessageStructClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageStructClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageStructClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageStructClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageStructClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
