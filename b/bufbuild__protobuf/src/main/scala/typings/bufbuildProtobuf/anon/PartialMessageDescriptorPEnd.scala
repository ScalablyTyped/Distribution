...
trait PartialMessageDescriptorPEnd extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorPEnd: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDescriptorPEnd: js.UndefOr[
    PartialField[
...
object PartialMessageDescriptorPEnd {
  
  inline def apply(): PartialMessageDescriptorPEnd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorPEnd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorPEnd] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageDescriptorPEnd): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageDescriptorPEnd]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageDescriptorPEnd | PlainMessage[PartialMessageDescriptorPEnd] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageDescriptorPEnd
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDescriptorPEnd
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageDescriptorPEnd
    ...
    inline def setGetType(value: () => MessageType[PartialMessageDescriptorPEnd]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
