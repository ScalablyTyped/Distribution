...
trait PartialMessageFieldDescriClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldDescriClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldDescriClone: js.UndefOr[
    PartialField[
...
object PartialMessageFieldDescriClone {
  
  inline def apply(): PartialMessageFieldDescriClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldDescriClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldDescriClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageFieldDescriClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFieldDescriClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageFieldDescriClone | PlainMessage[PartialMessageFieldDescriClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFieldDescriClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldDescriClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldDescriClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFieldDescriClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
