...
trait PlainMessageValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageValueConstructor: PlainField[js.Function0[typings.bufbuildProtobuf.distTypesGoogleProtobufStructPbMod.Value]]
  ...
  @JSName("equals")
  var equals_FPlainMessageValueConstructor: PlainField[
    js.Function1[
      /* other */ js.UndefOr[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.Value
    ]
  ]
...
object PlainMessageValueConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Value,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Value,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Value,
    ...
    __obj.asInstanceOf[PlainMessageValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageValueConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Value
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Value
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Value
