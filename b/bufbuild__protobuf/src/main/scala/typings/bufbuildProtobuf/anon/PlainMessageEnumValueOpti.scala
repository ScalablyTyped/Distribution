...
trait PlainMessageEnumValueOpti extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValueOpti: PlainField[js.Function0[EnumValueOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumValueOpti: PlainField[
    js.Function1[
...
object PlainMessageEnumValueOpti {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumValueOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueOptions,
    ...
    __obj.asInstanceOf[PlainMessageEnumValueOpti]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValueOpti] (val x: Self) extends AnyVal {
