...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/source_context_pb.SourceContext> */
trait PartialMessageSourceConteConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageSourceConteConstructor: js.UndefOr[PartialField[js.Function0[SourceContext]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[SourceContext]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageSourceConteConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[SourceContext | PlainMessageSourceContextConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fileName: js.UndefOr[PartialField[String]] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[SourceContext]]]] = js.undefined
...
object PartialMessageSourceConteConstructor {
  
  inline def apply(): PartialMessageSourceConteConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageSourceConteConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageSourceConteConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[SourceContext | PlainMessageSourceContextConstructor | Null] => Boolean
    ...
    inline def setFileName(value: PartialField[String]): Self = StObject.set(x, "fileName", value.asInstanceOf[js.Any])
