...
trait PartialMessageVersion extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageVersion: js.UndefOr[PartialField[js.Function0[Version]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Version]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageVersion: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Version | PlainMessageVersion | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageVersion {
  
  inline def apply(): PartialMessageVersion = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageVersion]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageVersion] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Version | PlainMessageVersion | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
