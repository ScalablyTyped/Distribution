...
trait PartialMessageFileDescripEquals extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFileDescripEquals: js.UndefOr[PartialField[js.Function0[FileDescriptorSet]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileDescripEquals: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[FileDescriptorSet | PlainMessageFileDescriptoEquals | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.FileDescriptorSet
      ]
    ]
  ] = js.undefined
...
object PartialMessageFileDescripEquals {
  
  inline def apply(): PartialMessageFileDescripEquals = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileDescripEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileDescripEquals] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[FileDescriptorSet | PlainMessageFileDescriptoEquals | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorSet
