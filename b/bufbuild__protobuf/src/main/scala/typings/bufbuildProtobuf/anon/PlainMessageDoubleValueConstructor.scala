...
trait PlainMessageDoubleValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDoubleValueConstructor: PlainField[js.Function0[DoubleValue]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[DoubleValue]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageDoubleValueConstructor: PlainField[
...
object PlainMessageDoubleValueConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue,
  ...
  ): PlainMessageDoubleValueConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageDoubleValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDoubleValueConstructor] (val x: Self) extends AnyVal {
