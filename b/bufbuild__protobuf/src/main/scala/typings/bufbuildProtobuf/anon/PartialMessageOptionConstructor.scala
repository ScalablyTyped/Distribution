...
trait PartialMessageOptionConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageOptionConstructor: js.UndefOr[PartialField[js.Function0[Option]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Option]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageOptionConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Option | PlainMessageOptionConstructor | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.Option
      ]
    ]
  ] = js.undefined
...
object PartialMessageOptionConstructor {
  
  inline def apply(): PartialMessageOptionConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageOptionConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageOptionConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Option | PlainMessageOptionConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Option
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Option
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Option
