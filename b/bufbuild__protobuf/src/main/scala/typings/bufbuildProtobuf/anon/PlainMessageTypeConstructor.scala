...
trait PlainMessageTypeConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageTypeConstructor: PlainField[js.Function0[Type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Type]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageTypeConstructor: PlainField[js.Function1[/* other */ js.UndefOr[Type | PlainMessage[Type] | Null], Boolean]]
...
object PlainMessageTypeConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Type,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Type,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Type,
    ...
    __obj.asInstanceOf[PlainMessageTypeConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageTypeConstructor] (val x: Self) extends AnyVal {
