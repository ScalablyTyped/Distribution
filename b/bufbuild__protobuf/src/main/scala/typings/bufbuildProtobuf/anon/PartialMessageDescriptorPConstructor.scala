...
trait PartialMessageDescriptorPConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorPConstructor: js.UndefOr[PartialField[js.Function0[DescriptorProtoExtensionRange]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDescriptorPConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[DescriptorProtoExtensionRange | PlainMessageDescriptorProConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageDescriptorPConstructor {
  
  inline def apply(): PartialMessageDescriptorPConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorPConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorPConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[DescriptorProtoExtensionRange | PlainMessageDescriptorProConstructor | Null] => Boolean
