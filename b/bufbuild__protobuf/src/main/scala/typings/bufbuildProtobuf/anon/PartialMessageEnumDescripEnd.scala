...
trait PartialMessageEnumDescripEnd extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumDescripEnd: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumDescripEnd: js.UndefOr[
    PartialField[
...
object PartialMessageEnumDescripEnd {
  
  inline def apply(): PartialMessageEnumDescripEnd = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumDescripEnd]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumDescripEnd] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageEnumDescripEnd): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumDescripEnd]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageEnumDescripEnd | PlainMessage[PartialMessageEnumDescripEnd] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumDescripEnd
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumDescripEnd
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumDescripEnd
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumDescripEnd]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
