...
trait PartialMessageServiceOptiConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageServiceOptiConstructor: js.UndefOr[PartialField[js.Function0[ServiceOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageServiceOptiConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[ServiceOptions | PlainMessageServiceOptionConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageServiceOptiConstructor {
  
  inline def apply(): PartialMessageServiceOptiConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageServiceOptiConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageServiceOptiConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[ServiceOptions | PlainMessageServiceOptionConstructor | Null] => Boolean
