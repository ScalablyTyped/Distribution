...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PlainMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.EnumOptions> */
trait PlainMessageEnumOptionsAllowAlias extends StObject {
  
  var allowAlias: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageEnumOptionsAllowAlias: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageEnumOptionsAllowAlias], Any]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumOptionsAllowAlias: PlainField[
...
object PlainMessageEnumOptionsAllowAlias {
  
  inline def apply(
    clone_ : () => PlainMessageEnumOptionsAllowAlias,
    constructor: /* data */ js.UndefOr[PartialMessageEnumOptionsAllowAlias] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageEnumOptionsAllowAlias | PlainMessage[PlainMessageEnumOptionsAllowAlias] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumOptionsAllowAlias,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumOptionsAllowAlias,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumOptionsAllowAlias,
    getType: () => MessageType[PlainMessageEnumOptionsAllowAlias],
  ...
  ): PlainMessageEnumOptionsAllowAlias = {
    ...
    __obj.asInstanceOf[PlainMessageEnumOptionsAllowAlias]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumOptionsAllowAlias] (val x: Self) extends AnyVal {
    
    inline def setAllowAlias(value: PlainField[js.UndefOr[Boolean]]): Self = StObject.set(x, "allowAlias", value.asInstanceOf[js.Any])
    
    inline def setAllowAliasUndefined: Self = StObject.set(x, "allowAlias", js.undefined)
    
    inline def setClone_(value: () => PlainMessageEnumOptionsAllowAlias): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageEnumOptionsAllowAlias] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumOptionsAllowAlias
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumOptionsAllowAlias
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumOptionsAllowAlias
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageEnumOptionsAllowAlias]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
