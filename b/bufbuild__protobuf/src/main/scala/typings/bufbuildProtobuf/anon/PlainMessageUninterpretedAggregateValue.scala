...
trait PlainMessageUninterpretedAggregateValue extends StObject {
  
  var aggregateValue: js.UndefOr[PlainField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageUninterpretedAggregateValue: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[
    js.Function1[/* data */ js.UndefOr[PartialMessageUninterpretAggregateValue], Any]
  ]
  
  var doubleValue: js.UndefOr[PlainField[js.UndefOr[Double]]] = js.undefined
  
  @JSName("equals")
  var equals_FPlainMessageUninterpretedAggregateValue: PlainField[
...
object PlainMessageUninterpretedAggregateValue {
  
  inline def apply(
    clone_ : () => PlainMessageUninterpretedAggregateValue,
    constructor: /* data */ js.UndefOr[PartialMessageUninterpretAggregateValue] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageUninterpretedAggregateValue | PlainMessage[PlainMessageUninterpretedAggregateValue] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUninterpretedAggregateValue,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedAggregateValue,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedAggregateValue,
    getType: () => MessageType[PlainMessageUninterpretedAggregateValue],
  ...
  ): PlainMessageUninterpretedAggregateValue = {
    ...
    __obj.asInstanceOf[PlainMessageUninterpretedAggregateValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUninterpretedAggregateValue] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => PlainMessageUninterpretedAggregateValue): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageUninterpretAggregateValue] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUninterpretedAggregateValue
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedAggregateValue
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUninterpretedAggregateValue
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageUninterpretedAggregateValue]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
