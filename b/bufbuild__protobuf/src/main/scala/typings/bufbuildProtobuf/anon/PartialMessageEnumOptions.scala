...
trait PartialMessageEnumOptions extends StObject {
  
  var allowAlias: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageEnumOptions: js.UndefOr[PartialField[js.Function0[EnumOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumOptions: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[EnumOptions | PlainMessageEnumOptions | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageEnumOptions {
  
  inline def apply(): PartialMessageEnumOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumOptions] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[EnumOptions | PlainMessageEnumOptions | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
