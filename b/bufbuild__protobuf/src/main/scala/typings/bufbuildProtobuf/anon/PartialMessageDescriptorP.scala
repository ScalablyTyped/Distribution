...
trait PartialMessageDescriptorP extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorP: js.UndefOr[PartialField[js.Function0[DescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDescriptorP: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[DescriptorProto | PlainMessageDescriptorPro | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageDescriptorP {
  
  inline def apply(): PartialMessageDescriptorP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorP] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[DescriptorProto | PlainMessageDescriptorPro | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
