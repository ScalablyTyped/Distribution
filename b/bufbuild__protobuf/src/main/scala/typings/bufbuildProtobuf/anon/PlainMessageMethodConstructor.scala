...
trait PlainMessageMethodConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMethodConstructor: PlainField[js.Function0[Method]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Method]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMethodConstructor: PlainField[
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.Method
    ]
  ]
...
object PlainMessageMethodConstructor {
  
  inline def apply(
    clone_ : () => Method,
    constructor: /* data */ js.UndefOr[PartialMessage[Method]] => Any,
    equals_ : /* other */ js.UndefOr[Method | PlainMessage[Method] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Method,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Method,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Method,
    ...
    __obj.asInstanceOf[PlainMessageMethodConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Method
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Method
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Method
