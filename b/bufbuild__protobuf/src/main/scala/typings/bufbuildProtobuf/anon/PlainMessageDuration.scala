...
trait PlainMessageDuration extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDuration: PlainField[js.Function0[Duration]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Duration]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageDuration: PlainField[
...
object PlainMessageDuration {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Duration,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Duration,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Duration,
    ...
    __obj.asInstanceOf[PlainMessageDuration]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDuration] (val x: Self) extends AnyVal {
