...
trait PartialMessageFileDescripEdition extends StObject {
  
  @JSName("package")
  var _package: js.UndefOr[PartialField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageFileDescripEdition: js.UndefOr[PartialField[js.Function0[FileDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileDescripEdition: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[FileDescriptorProto | PlainMessageFileDescriptoEdition | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.FileDescriptorProto
      ]
    ]
  ] = js.undefined
...
object PartialMessageFileDescripEdition {
  
  inline def apply(): PartialMessageFileDescripEdition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileDescripEdition]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileDescripEdition] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[FileDescriptorProto | PlainMessageFileDescriptoEdition | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto
