...
trait PartialMessageEnum extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnum: js.UndefOr[PartialField[js.Function0[Enum]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnum: js.UndefOr[
    PartialField[js.Function1[/* other */ js.UndefOr[Enum | PlainMessageEnum | Null], Boolean]]
  ] = js.undefined
...
object PartialMessageEnum {
  
  inline def apply(): PartialMessageEnum = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnum]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnum] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Enum | PlainMessageEnum | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
