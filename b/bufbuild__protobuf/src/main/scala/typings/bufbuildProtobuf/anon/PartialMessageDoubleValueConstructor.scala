...
trait PartialMessageDoubleValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDoubleValueConstructor: js.UndefOr[PartialField[js.Function0[DoubleValue]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[DoubleValue]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageDoubleValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[DoubleValue | PlainMessageDoubleValueConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.DoubleValue
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[DoubleValue]]]] = js.undefined
...
object PartialMessageDoubleValueConstructor {
  
  inline def apply(): PartialMessageDoubleValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDoubleValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDoubleValueConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[DoubleValue | PlainMessageDoubleValueConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.DoubleValue
