...
trait PartialMessageValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageValueConstructor: js.UndefOr[
  ...
  @JSName("equals")
  var equals_FPartialMessageValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[
          typings.bufbuildProtobuf.distTypesGoogleProtobufStructPbMod.Value | PlainMessageValueConstructor | Null
        ], 
        Boolean
      ]
    ]
...
object PartialMessageValueConstructor {
  
  inline def apply(): PartialMessageValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageValueConstructor] (val x: Self) extends AnyVal {
