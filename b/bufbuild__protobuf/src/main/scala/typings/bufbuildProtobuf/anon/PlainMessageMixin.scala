...
trait PlainMessageMixin extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMixin: PlainField[js.Function0[Mixin]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Mixin]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMixin: PlainField[
...
object PlainMessageMixin {
  
  inline def apply(
    clone_ : () => Mixin,
    constructor: /* data */ js.UndefOr[PartialMessage[Mixin]] => Any,
    equals_ : /* other */ js.UndefOr[Mixin | PlainMessage[Mixin] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Mixin,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Mixin,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Mixin,
    ...
    __obj.asInstanceOf[PlainMessageMixin]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMixin] (val x: Self) extends AnyVal {
