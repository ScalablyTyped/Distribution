...
trait PartialMessageMethodDescr extends StObject {
  
  var clientStreaming: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageMethodDescr: js.UndefOr[PartialField[js.Function0[MethodDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMethodDescr: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[MethodDescriptorProto | PlainMessageMethodDescrip | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageMethodDescr {
  
  inline def apply(): PartialMessageMethodDescr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodDescr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodDescr] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[MethodDescriptorProto | PlainMessageMethodDescrip | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
