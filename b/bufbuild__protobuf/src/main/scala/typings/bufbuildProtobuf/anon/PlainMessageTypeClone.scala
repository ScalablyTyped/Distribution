...
trait PlainMessageTypeClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageTypeClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageTypeClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageTypeClone: PlainField[
...
object PlainMessageTypeClone {
  
  inline def apply(
    clone_ : () => PlainMessageTypeClone,
    constructor: /* data */ js.UndefOr[PartialMessageTypeClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageTypeClone | PlainMessage[PlainMessageTypeClone] | Null] => Boolean,
    fields: PlainField[js.Array[Field]],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageTypeClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTypeClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTypeClone,
    getType: () => MessageType[PlainMessageTypeClone],
    ...
    __obj.asInstanceOf[PlainMessageTypeClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageTypeClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageTypeClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageTypeClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageTypeClone | PlainMessage[PlainMessageTypeClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageTypeClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTypeClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTypeClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageTypeClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
