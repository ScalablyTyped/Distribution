...
trait PartialMessageMethodOptioClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMethodOptioClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageMethodOptioClone: js.UndefOr[
    PartialField[
...
object PartialMessageMethodOptioClone {
  
  inline def apply(): PartialMessageMethodOptioClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethodOptioClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethodOptioClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageMethodOptioClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageMethodOptioClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageMethodOptioClone | PlainMessage[PartialMessageMethodOptioClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageMethodOptioClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMethodOptioClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageMethodOptioClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageMethodOptioClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
