...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.GeneratedCodeInfo> */
trait PartialMessageGeneratedCo extends StObject {
  
  var annotation: js.UndefOr[PartialField[js.Array[GeneratedCodeInfoAnnotation]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageGeneratedCo: js.UndefOr[PartialField[js.Function0[GeneratedCodeInfo]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[GeneratedCodeInfo]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageGeneratedCo: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[GeneratedCodeInfo | PlainMessageGeneratedCode | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[GeneratedCodeInfo]]]] = js.undefined
...
object PartialMessageGeneratedCo {
  
  inline def apply(): PartialMessageGeneratedCo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageGeneratedCo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageGeneratedCo] (val x: Self) extends AnyVal {
    
    inline def setAnnotation(value: PartialField[js.Array[GeneratedCodeInfoAnnotation]]): Self = StObject.set(x, "annotation", value.asInstanceOf[js.Any])
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[GeneratedCodeInfo | PlainMessageGeneratedCode | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => GeneratedCodeInfo
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfo
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => GeneratedCodeInfo
