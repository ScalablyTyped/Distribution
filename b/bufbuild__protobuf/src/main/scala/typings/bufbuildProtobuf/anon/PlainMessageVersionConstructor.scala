...
trait PlainMessageVersionConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageVersionConstructor: PlainField[js.Function0[Version]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Version]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageVersionConstructor: PlainField[
...
object PlainMessageVersionConstructor {
  
  inline def apply(
    clone_ : () => Version,
    constructor: /* data */ js.UndefOr[PartialMessage[Version]] => Any,
    equals_ : /* other */ js.UndefOr[Version | PlainMessage[Version] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Version,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Version,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Version,
  ...
  ): PlainMessageVersionConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageVersionConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageVersionConstructor] (val x: Self) extends AnyVal {
