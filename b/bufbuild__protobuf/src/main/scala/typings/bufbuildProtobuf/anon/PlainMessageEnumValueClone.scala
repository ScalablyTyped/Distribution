...
trait PlainMessageEnumValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageEnumValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageEnumValueClone: PlainField[
...
object PlainMessageEnumValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageEnumValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageEnumValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageEnumValueClone | PlainMessage[PlainMessageEnumValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumValueClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueClone,
    getType: () => MessageType[PlainMessageEnumValueClone],
    ...
    __obj.asInstanceOf[PlainMessageEnumValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageEnumValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageEnumValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageEnumValueClone | PlainMessage[PlainMessageEnumValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageEnumValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
