...
trait PlainMessageEnumClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageEnumClone], Any]]
  
  var enumvalue: PlainField[js.Array[EnumValue]]
  
  @JSName("equals")
  var equals_FPlainMessageEnumClone: PlainField[
...
object PlainMessageEnumClone {
  
  inline def apply(
    clone_ : () => PlainMessageEnumClone,
    constructor: /* data */ js.UndefOr[PartialMessageEnumClone] => Any,
    enumvalue: PlainField[js.Array[EnumValue]],
    equals_ : /* other */ js.UndefOr[PlainMessageEnumClone | PlainMessage[PlainMessageEnumClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumClone,
    getType: () => MessageType[PlainMessageEnumClone],
    ...
    __obj.asInstanceOf[PlainMessageEnumClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageEnumClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageEnumClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageEnumClone | PlainMessage[PlainMessageEnumClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageEnumClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
