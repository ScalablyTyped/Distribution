...
trait PlainMessageCodeGeneratorConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageCodeGeneratorConstructor: PlainField[js.Function0[CodeGeneratorResponse]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[CodeGeneratorResponse]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageCodeGeneratorConstructor: PlainField[
    js.Function1[
...
object PlainMessageCodeGeneratorConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => CodeGeneratorResponse,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponse,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => CodeGeneratorResponse,
  ...
  ): PlainMessageCodeGeneratorConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageCodeGeneratorConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageCodeGeneratorConstructor] (val x: Self) extends AnyVal {
