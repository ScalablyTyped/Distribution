...
trait PlainMessageInt32ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageInt32ValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageInt32ValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageInt32ValueClone: PlainField[
...
object PlainMessageInt32ValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageInt32ValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageInt32ValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageInt32ValueClone | PlainMessage[PlainMessageInt32ValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageInt32ValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt32ValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt32ValueClone,
    getType: () => MessageType[PlainMessageInt32ValueClone],
    ...
    __obj.asInstanceOf[PlainMessageInt32ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageInt32ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageInt32ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageInt32ValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageInt32ValueClone | PlainMessage[PlainMessageInt32ValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageInt32ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt32ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt32ValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageInt32ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
