...
trait PartialMessageFieldDescri extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldDescri: js.UndefOr[PartialField[js.Function0[FieldDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldDescri: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[FieldDescriptorProto | PlainMessageFieldDescript | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageFieldDescri {
  
  inline def apply(): PartialMessageFieldDescri = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldDescri]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldDescri] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[FieldDescriptorProto | PlainMessageFieldDescript | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
