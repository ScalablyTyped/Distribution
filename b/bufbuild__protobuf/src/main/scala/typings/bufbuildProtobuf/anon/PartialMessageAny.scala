...
trait PartialMessageAny extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageAny: js.UndefOr[PartialField[js.Function0[Any]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageAny: js.UndefOr[
    PartialField[js.Function1[/* other */ js.UndefOr[Any | PlainMessageAny | Null], Boolean]]
  ] = js.undefined
  ...
  var fromJson: js.UndefOr[
    PartialField[
      js.Function2[/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], Any]
    ]
  ] = js.undefined
  
  var fromJsonString: js.UndefOr[
    PartialField[
      js.Function2[/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions], Any]
    ]
  ] = js.undefined
...
object PartialMessageAny {
  
  inline def apply(): PartialMessageAny = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageAny]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageAny] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Any | PlainMessageAny | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Any
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Any): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Any): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
