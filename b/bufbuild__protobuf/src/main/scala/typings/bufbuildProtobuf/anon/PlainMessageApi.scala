...
trait PlainMessageApi extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageApi: PlainField[js.Function0[Api]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Api]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageApi: PlainField[js.Function1[/* other */ js.UndefOr[Api | PlainMessage[Api] | Null], Boolean]]
...
object PlainMessageApi {
  
  inline def apply(
    clone_ : () => Api,
    constructor: /* data */ js.UndefOr[PartialMessage[Api]] => Any,
    equals_ : /* other */ js.UndefOr[Api | PlainMessage[Api] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Api,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Api,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Api,
    ...
    __obj.asInstanceOf[PlainMessageApi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageApi] (val x: Self) extends AnyVal {
