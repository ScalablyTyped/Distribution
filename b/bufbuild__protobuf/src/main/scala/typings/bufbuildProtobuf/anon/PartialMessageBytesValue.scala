...
trait PartialMessageBytesValue extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageBytesValue: js.UndefOr[PartialField[js.Function0[BytesValue]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[BytesValue]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageBytesValue: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[BytesValue | PlainMessageBytesValue | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[BytesValue]]]] = js.undefined
...
object PartialMessageBytesValue {
  
  inline def apply(): PartialMessageBytesValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageBytesValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageBytesValue] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[BytesValue | PlainMessageBytesValue | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
