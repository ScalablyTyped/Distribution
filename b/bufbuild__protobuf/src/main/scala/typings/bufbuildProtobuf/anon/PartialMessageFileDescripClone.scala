...
trait PartialMessageFileDescripClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFileDescripClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileDescripClone: js.UndefOr[
    PartialField[
...
object PartialMessageFileDescripClone {
  
  inline def apply(): PartialMessageFileDescripClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileDescripClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileDescripClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageFileDescripClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFileDescripClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageFileDescripClone | PlainMessage[PartialMessageFileDescripClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFileDescripClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFileDescripClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFileDescripClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFileDescripClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
