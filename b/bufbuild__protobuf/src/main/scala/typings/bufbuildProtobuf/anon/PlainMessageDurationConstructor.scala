...
trait PlainMessageDurationConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageDurationConstructor: PlainField[js.Function0[Duration]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[Duration]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageDurationConstructor: PlainField[
    js.Function1[/* other */ js.UndefOr[Duration | PlainMessage[Duration] | Null], Boolean]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[Duration]]]
...
object PlainMessageDurationConstructor {
  
  inline def apply(
    clone_ : () => Duration,
    constructor: /* data */ js.UndefOr[PartialMessage[Duration]] => Any,
    equals_ : /* other */ js.UndefOr[Duration | PlainMessage[Duration] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.Duration,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Duration,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.Duration,
    getType: () => MessageType[Duration],
  ...
  ): PlainMessageDurationConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageDurationConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageDurationConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Duration | PlainMessage[Duration] | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
