...
trait PartialMessageServiceOptiClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageServiceOptiClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageServiceOptiClone: js.UndefOr[
    PartialField[
...
object PartialMessageServiceOptiClone {
  
  inline def apply(): PartialMessageServiceOptiClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageServiceOptiClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageServiceOptiClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageServiceOptiClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageServiceOptiClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageServiceOptiClone | PlainMessage[PartialMessageServiceOptiClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageServiceOptiClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageServiceOptiClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageServiceOptiClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageServiceOptiClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
