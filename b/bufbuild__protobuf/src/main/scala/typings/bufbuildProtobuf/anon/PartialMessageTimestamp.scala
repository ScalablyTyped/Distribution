...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/timestamp_pb.Timestamp> */
trait PartialMessageTimestamp extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageTimestamp: js.UndefOr[PartialField[js.Function0[Timestamp]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Timestamp]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageTimestamp: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Timestamp | PlainMessageTimestamp | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var fromDate: js.UndefOr[PartialField[js.UndefOr[Any]]] = js.undefined
  
  var fromJson: js.UndefOr[
    PartialField[
      js.Function2[/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], Timestamp]
    ]
  ] = js.undefined
  
  var fromJsonString: js.UndefOr[
    PartialField[
      js.Function2[/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions], Timestamp]
    ]
  ] = js.undefined
  
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Timestamp]]]] = js.undefined
  
  var nanos: js.UndefOr[PartialField[Double]] = js.undefined
  
  var now: js.UndefOr[PartialField[js.UndefOr[Any]]] = js.undefined
  ...
  var toDate: js.UndefOr[PartialField[js.Function0[js.Date]]] = js.undefined
...
object PartialMessageTimestamp {
  
  inline def apply(): PartialMessageTimestamp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageTimestamp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageTimestamp] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Timestamp | PlainMessageTimestamp | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Timestamp
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromDate(value: PartialField[js.UndefOr[Any]]): Self = StObject.set(x, "fromDate", value.asInstanceOf[js.Any])
    
    inline def setFromDateUndefined: Self = StObject.set(x, "fromDate", js.undefined)
    
    inline def setFromJson(value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Timestamp): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Timestamp): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    ...
    inline def setNow(value: PartialField[js.UndefOr[Any]]): Self = StObject.set(x, "now", value.asInstanceOf[js.Any])
