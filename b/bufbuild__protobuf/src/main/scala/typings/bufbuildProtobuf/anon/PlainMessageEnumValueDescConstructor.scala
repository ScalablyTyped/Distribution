...
trait PlainMessageEnumValueDescConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValueDescConstructor: PlainField[js.Function0[EnumValueDescriptorProto]]
  
  var constructor: PlainField[
    js.Function1[/* data */ js.UndefOr[PartialMessage[EnumValueDescriptorProto]], Any]
  ]
  
  @JSName("equals")
  var equals_FPlainMessageEnumValueDescConstructor: PlainField[
    js.Function1[
      /* other */ js.UndefOr[EnumValueDescriptorProto | PlainMessage[EnumValueDescriptorProto] | Null], 
      Boolean
    ]
  ]
  ...
  var fromBinary: PlainField[
    js.Function2[
      ...
      typings.bufbuildProtobuf.mod.EnumValueDescriptorProto
    ]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[EnumValueDescriptorProto]]]
...
object PlainMessageEnumValueDescConstructor {
  
  inline def apply(
    clone_ : () => EnumValueDescriptorProto,
    constructor: /* data */ js.UndefOr[PartialMessage[EnumValueDescriptorProto]] => Any,
    equals_ : /* other */ js.UndefOr[EnumValueDescriptorProto | PlainMessage[EnumValueDescriptorProto] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto,
    getType: () => MessageType[EnumValueDescriptorProto],
  ...
  ): PlainMessageEnumValueDescConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageEnumValueDescConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValueDescConstructor] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => EnumValueDescriptorProto): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[EnumValueDescriptorProto]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[EnumValueDescriptorProto | PlainMessage[EnumValueDescriptorProto] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.EnumValueDescriptorProto
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[EnumValueDescriptorProto]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
