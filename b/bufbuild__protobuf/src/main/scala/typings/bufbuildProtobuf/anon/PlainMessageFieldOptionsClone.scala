...
trait PlainMessageFieldOptionsClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFieldOptionsClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageFieldOptionClone], Any]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFieldOptionsClone: PlainField[
...
object PlainMessageFieldOptionsClone {
  
  inline def apply(
    clone_ : () => PlainMessageFieldOptionsClone,
    constructor: /* data */ js.UndefOr[PartialMessageFieldOptionClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageFieldOptionsClone | PlainMessage[PlainMessageFieldOptionsClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFieldOptionsClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldOptionsClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldOptionsClone,
    getType: () => MessageType[PlainMessageFieldOptionsClone],
    ...
    __obj.asInstanceOf[PlainMessageFieldOptionsClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFieldOptionsClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageFieldOptionsClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageFieldOptionClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFieldOptionsClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldOptionsClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFieldOptionsClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageFieldOptionsClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
