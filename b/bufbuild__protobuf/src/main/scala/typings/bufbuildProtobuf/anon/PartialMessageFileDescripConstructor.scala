...
trait PartialMessageFileDescripConstructor extends StObject {
  
  @JSName("package")
  var _package: js.UndefOr[PartialField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageFileDescripConstructor: js.UndefOr[PartialField[js.Function0[FileDescriptorProto]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[FileDescriptorProto]], Any]]
  ] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileDescripConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[FileDescriptorProto | PlainMessageFileDescriptoConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[FileDescriptorProto]]]] = js.undefined
...
object PartialMessageFileDescripConstructor {
  
  inline def apply(): PartialMessageFileDescripConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileDescripConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileDescripConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[FileDescriptorProto | PlainMessageFileDescriptoConstructor | Null] => Boolean
