...
trait PlainMessageTimestampClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageTimestampClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageTimestampClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageTimestampClone: PlainField[
...
object PlainMessageTimestampClone {
  
  inline def apply(
    clone_ : () => PlainMessageTimestampClone,
    constructor: /* data */ js.UndefOr[PartialMessageTimestampClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageTimestampClone | PlainMessage[PlainMessageTimestampClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageTimestampClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTimestampClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTimestampClone,
    getType: () => MessageType[PlainMessageTimestampClone],
    ...
    __obj.asInstanceOf[PlainMessageTimestampClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageTimestampClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageTimestampClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageTimestampClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageTimestampClone | PlainMessage[PlainMessageTimestampClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageTimestampClone
    ...
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTimestampClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageTimestampClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageTimestampClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
