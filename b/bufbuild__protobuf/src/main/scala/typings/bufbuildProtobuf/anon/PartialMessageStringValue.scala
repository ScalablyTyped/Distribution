...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/wrappers_pb.StringValue> */
trait PartialMessageStringValue extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageStringValue: js.UndefOr[PartialField[js.Function0[StringValue]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[StringValue]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageStringValue: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[StringValue | PlainMessageStringValue | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[StringValue]]]] = js.undefined
  ...
  var value: js.UndefOr[PartialField[String]] = js.undefined
}
object PartialMessageStringValue {
  
  inline def apply(): PartialMessageStringValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageStringValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageStringValue] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[StringValue | PlainMessageStringValue | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setValue(value: PartialField[String]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
