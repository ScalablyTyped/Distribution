...
trait PlainMessageFieldOptionsConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageFieldOptionsConstructor: PlainField[js.Function0[FieldOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFieldOptionsConstructor: PlainField[
...
object PlainMessageFieldOptionsConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FieldOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FieldOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FieldOptions,
  ...
  ): PlainMessageFieldOptionsConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageFieldOptionsConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFieldOptionsConstructor] (val x: Self) extends AnyVal {
