...
trait DescFieldScalarDescFieldCDeclarationString
  extends StObject
     with DescExtension {
...
object DescFieldScalarDescFieldCDeclarationString {
  ...
  inline def apply(
    ...
    scalar: ScalarType,
    typeName: String
  ): DescFieldScalarDescFieldCDeclarationString = {
    ...
    __obj.asInstanceOf[DescFieldScalarDescFieldCDeclarationString]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescFieldScalarDescFieldCDeclarationString] (val x: Self) extends AnyVal {
