...
trait PartialMessageBoolValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageBoolValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageBoolValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageBoolValueClone {
  
  inline def apply(): PartialMessageBoolValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageBoolValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageBoolValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageBoolValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageBoolValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageBoolValueClone | PlainMessage[PartialMessageBoolValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageBoolValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageBoolValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageBoolValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageBoolValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
