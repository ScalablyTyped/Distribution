...
trait PartialMessageSourceCodeIConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageSourceCodeIConstructor: js.UndefOr[PartialField[js.Function0[SourceCodeInfoLocation]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageSourceCodeIConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[SourceCodeInfoLocation | PlainMessageSourceCodeInfConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageSourceCodeIConstructor {
  
  inline def apply(): PartialMessageSourceCodeIConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageSourceCodeIConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageSourceCodeIConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[SourceCodeInfoLocation | PlainMessageSourceCodeInfConstructor | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => SourceCodeInfoLocation
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceCodeInfoLocation
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => SourceCodeInfoLocation
