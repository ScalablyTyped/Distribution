...
trait PlainMessageInt64ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageInt64ValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageInt64ValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageInt64ValueClone: PlainField[
...
object PlainMessageInt64ValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageInt64ValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageInt64ValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageInt64ValueClone | PlainMessage[PlainMessageInt64ValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageInt64ValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt64ValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt64ValueClone,
    getType: () => MessageType[PlainMessageInt64ValueClone],
    ...
    __obj.asInstanceOf[PlainMessageInt64ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageInt64ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageInt64ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageInt64ValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageInt64ValueClone | PlainMessage[PlainMessageInt64ValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageInt64ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt64ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageInt64ValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageInt64ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
