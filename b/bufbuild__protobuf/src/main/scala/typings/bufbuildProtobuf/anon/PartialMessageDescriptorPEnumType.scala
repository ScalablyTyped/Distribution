...
trait PartialMessageDescriptorPEnumType extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDescriptorPEnumType: js.UndefOr[PartialField[js.Function0[DescriptorProto]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[DescriptorProto]], Any]]
  ] = js.undefined
  
  var enumType: js.UndefOr[PartialField[js.Array[EnumDescriptorProto]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageDescriptorPEnumType: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[DescriptorProto | PlainMessageDescriptorProEnumType | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[DescriptorProto]]]] = js.undefined
  
  var name: js.UndefOr[PartialField[js.UndefOr[String]]] = js.undefined
  
  var nestedType: js.UndefOr[PartialField[js.Array[DescriptorProto]]] = js.undefined
...
object PartialMessageDescriptorPEnumType {
  
  inline def apply(): PartialMessageDescriptorPEnumType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDescriptorPEnumType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDescriptorPEnumType] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[DescriptorProto | PlainMessageDescriptorProEnumType | Null] => Boolean
    ...
    inline def setNestedType(value: PartialField[js.Array[DescriptorProto]]): Self = StObject.set(x, "nestedType", value.asInstanceOf[js.Any])
