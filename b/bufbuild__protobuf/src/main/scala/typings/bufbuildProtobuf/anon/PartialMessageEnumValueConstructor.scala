...
trait PartialMessageEnumValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueConstructor: js.UndefOr[PartialField[js.Function0[EnumValue]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[EnumValue | PlainMessageEnumValueConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageEnumValueConstructor {
  
  inline def apply(): PartialMessageEnumValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[EnumValue | PlainMessageEnumValueConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
