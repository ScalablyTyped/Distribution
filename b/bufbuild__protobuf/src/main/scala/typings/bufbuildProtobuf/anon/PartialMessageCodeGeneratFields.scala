...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/compiler/plugin_pb.CodeGeneratorResponse_File> */
trait PartialMessageCodeGeneratFields extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGeneratFields: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[this.type]], Any]]
  ] = js.undefined
  
  var content: js.UndefOr[PartialField[js.UndefOr[String]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageCodeGeneratFields: js.UndefOr[
    PartialField[
  ...
  var generatedCodeInfo: js.UndefOr[PartialField[js.UndefOr[GeneratedCodeInfo]]] = js.undefined
  
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[this.type]]]] = js.undefined
  
  var insertionPoint: js.UndefOr[PartialField[js.UndefOr[String]]] = js.undefined
...
object PartialMessageCodeGeneratFields {
  
  inline def apply(): PartialMessageCodeGeneratFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGeneratFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGeneratFields] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageCodeGeneratFields): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageCodeGeneratFields]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setContent(value: PartialField[js.UndefOr[String]]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageCodeGeneratFields | PlainMessage[PartialMessageCodeGeneratFields] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageCodeGeneratFields
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageCodeGeneratFields
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageCodeGeneratFields
    ...
    inline def setGeneratedCodeInfo(value: PartialField[js.UndefOr[GeneratedCodeInfo]]): Self = StObject.set(x, "generatedCodeInfo", value.asInstanceOf[js.Any])
    
    inline def setGeneratedCodeInfoUndefined: Self = StObject.set(x, "generatedCodeInfo", js.undefined)
    
    inline def setGetType(value: () => MessageType[PartialMessageCodeGeneratFields]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
    
    inline def setGetTypeUndefined: Self = StObject.set(x, "getType", js.undefined)
    
    inline def setInsertionPoint(value: PartialField[js.UndefOr[String]]): Self = StObject.set(x, "insertionPoint", value.asInstanceOf[js.Any])
