...
trait PlainMessageFileDescriptoEdition extends StObject {
  
  @JSName("package")
  var _package: js.UndefOr[PlainField[js.UndefOr[String]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageFileDescriptoEdition: PlainField[js.Function0[FileDescriptorProto]]
  ...
  @JSName("equals")
  var equals_FPlainMessageFileDescriptoEdition: PlainField[
    js.Function1[
...
object PlainMessageFileDescriptoEdition {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.FileDescriptorProto,
  ...
  ): PlainMessageFileDescriptoEdition = {
    ...
    __obj.asInstanceOf[PlainMessageFileDescriptoEdition]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileDescriptoEdition] (val x: Self) extends AnyVal {
