...
trait PartialMessageSourceCodeIEquals extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageSourceCodeIEquals: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageSourceCodeIEquals: js.UndefOr[
    PartialField[
...
object PartialMessageSourceCodeIEquals {
  
  inline def apply(): PartialMessageSourceCodeIEquals = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageSourceCodeIEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageSourceCodeIEquals] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageSourceCodeIEquals): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageSourceCodeIEquals]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageSourceCodeIEquals | PlainMessage[PartialMessageSourceCodeIEquals] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageSourceCodeIEquals
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageSourceCodeIEquals
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageSourceCodeIEquals
    ...
    inline def setGetType(value: () => MessageType[PartialMessageSourceCodeIEquals]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
