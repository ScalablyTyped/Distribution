...
trait PartialMessageGeneratedCoConstructor extends StObject {
  
  var annotation: js.UndefOr[PartialField[js.Array[GeneratedCodeInfoAnnotation]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageGeneratedCoConstructor: js.UndefOr[PartialField[js.Function0[GeneratedCodeInfo]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageGeneratedCoConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[GeneratedCodeInfo | PlainMessageGeneratedCodeConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageGeneratedCoConstructor {
  
  inline def apply(): PartialMessageGeneratedCoConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageGeneratedCoConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageGeneratedCoConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[GeneratedCodeInfo | PlainMessageGeneratedCodeConstructor | Null] => Boolean
