...
trait PlainMessageFileOptionsCcEnableArenas extends StObject {
  ...
  @JSName("clone")
  var clone_FPlainMessageFileOptionsCcEnableArenas: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[
    js.Function1[/* data */ js.UndefOr[PartialMessageFileOptionsCcEnableArenas], Any]
  ]
  ...
  @JSName("equals")
  var equals_FPlainMessageFileOptionsCcEnableArenas: PlainField[
...
object PlainMessageFileOptionsCcEnableArenas {
  
  inline def apply(
    clone_ : () => PlainMessageFileOptionsCcEnableArenas,
    constructor: /* data */ js.UndefOr[PartialMessageFileOptionsCcEnableArenas] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageFileOptionsCcEnableArenas | PlainMessage[PlainMessageFileOptionsCcEnableArenas] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFileOptionsCcEnableArenas,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileOptionsCcEnableArenas,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileOptionsCcEnableArenas,
    getType: () => MessageType[PlainMessageFileOptionsCcEnableArenas],
  ...
  ): PlainMessageFileOptionsCcEnableArenas = {
    ...
    __obj.asInstanceOf[PlainMessageFileOptionsCcEnableArenas]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageFileOptionsCcEnableArenas] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => PlainMessageFileOptionsCcEnableArenas): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageFileOptionsCcEnableArenas] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageFileOptionsCcEnableArenas
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileOptionsCcEnableArenas
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageFileOptionsCcEnableArenas
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageFileOptionsCcEnableArenas]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
