...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescFieldScalar & @bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescFieldCommon & {  kind :'field',  readonly parent :@bufbuild/protobuf.@bufbuild/protobuf/dist/types/descriptor-set.DescMessage} */
trait DescFieldScalarDescFieldC
  extends StObject
     with DescField {
...
object DescFieldScalarDescFieldC {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DescFieldScalarDescFieldC]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescFieldScalarDescFieldC] (val x: Self) extends AnyVal {
