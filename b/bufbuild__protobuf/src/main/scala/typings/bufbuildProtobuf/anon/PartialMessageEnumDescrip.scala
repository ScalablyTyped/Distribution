...
trait PartialMessageEnumDescrip extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumDescrip: js.UndefOr[PartialField[js.Function0[EnumDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumDescrip: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[EnumDescriptorProto | PlainMessageEnumDescripto | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageEnumDescrip {
  
  inline def apply(): PartialMessageEnumDescrip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumDescrip]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumDescrip] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[EnumDescriptorProto | PlainMessageEnumDescripto | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
