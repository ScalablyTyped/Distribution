...
trait PartialMessageGeneratedCoAnnotation extends StObject {
  
  var annotation: js.UndefOr[PartialField[js.Array[GeneratedCodeInfoAnnotation]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageGeneratedCoAnnotation: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageGeneratedCoAnnotation: js.UndefOr[
    PartialField[
...
object PartialMessageGeneratedCoAnnotation {
  
  inline def apply(): PartialMessageGeneratedCoAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageGeneratedCoAnnotation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageGeneratedCoAnnotation] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => PartialMessageGeneratedCoAnnotation): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageGeneratedCoAnnotation]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageGeneratedCoAnnotation | PlainMessage[PartialMessageGeneratedCoAnnotation] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageGeneratedCoAnnotation
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageGeneratedCoAnnotation
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageGeneratedCoAnnotation
    ...
    inline def setGetType(value: () => MessageType[PartialMessageGeneratedCoAnnotation]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
