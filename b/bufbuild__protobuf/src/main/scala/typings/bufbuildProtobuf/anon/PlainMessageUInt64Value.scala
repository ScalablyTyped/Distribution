...
trait PlainMessageUInt64Value extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageUInt64Value: PlainField[js.Function0[UInt64Value]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[UInt64Value]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageUInt64Value: PlainField[
    js.Function1[/* other */ js.UndefOr[UInt64Value | PlainMessage[UInt64Value] | Null], Boolean]
  ]
  ...
  var fromJson: PlainField[
    js.Function2[/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], UInt64Value]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[UInt64Value]]]
...
object PlainMessageUInt64Value {
  
  inline def apply(
    clone_ : () => UInt64Value,
    constructor: /* data */ js.UndefOr[PartialMessage[UInt64Value]] => Any,
    equals_ : /* other */ js.UndefOr[UInt64Value | PlainMessage[UInt64Value] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => UInt64Value,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => UInt64Value,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => UInt64Value,
    getType: () => MessageType[UInt64Value],
    ...
    __obj.asInstanceOf[PlainMessageUInt64Value]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUInt64Value] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[UInt64Value | PlainMessage[UInt64Value] | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => UInt64Value
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => UInt64Value): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => UInt64Value): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
