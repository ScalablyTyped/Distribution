...
trait PartialMessageCodeGenerat extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGenerat: js.UndefOr[PartialField[js.Function0[CodeGeneratorRequest]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageCodeGenerat: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[CodeGeneratorRequest | PlainMessageCodeGenerator | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageCodeGenerat {
  
  inline def apply(): PartialMessageCodeGenerat = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGenerat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGenerat] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[CodeGeneratorRequest | PlainMessageCodeGenerator | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
