...
trait PartialMessageExtensionRa extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageExtensionRa: js.UndefOr[PartialField[js.Function0[ExtensionRangeOptions]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageExtensionRa: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[ExtensionRangeOptions | PlainMessageExtensionRang | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageExtensionRa {
  
  inline def apply(): PartialMessageExtensionRa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageExtensionRa]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageExtensionRa] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[ExtensionRangeOptions | PlainMessageExtensionRang | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
