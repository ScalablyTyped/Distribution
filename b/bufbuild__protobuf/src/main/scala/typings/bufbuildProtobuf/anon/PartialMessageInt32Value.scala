...
trait PartialMessageInt32Value extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageInt32Value: js.UndefOr[PartialField[js.Function0[Int32Value]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageInt32Value: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Int32Value | PlainMessageInt32Value | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageInt32Value {
  
  inline def apply(): PartialMessageInt32Value = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageInt32Value]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageInt32Value] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Int32Value | PlainMessageInt32Value | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
