...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.EnumOptions> */
trait PartialMessageEnumOptionsAllowAlias extends StObject {
  
  var allowAlias: js.UndefOr[PartialField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPartialMessageEnumOptionsAllowAlias: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumOptionsAllowAlias: js.UndefOr[
    PartialField[
...
object PartialMessageEnumOptionsAllowAlias {
  
  inline def apply(): PartialMessageEnumOptionsAllowAlias = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumOptionsAllowAlias]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumOptionsAllowAlias] (val x: Self) extends AnyVal {
    
    inline def setAllowAlias(value: PartialField[js.UndefOr[Boolean]]): Self = StObject.set(x, "allowAlias", value.asInstanceOf[js.Any])
    
    inline def setAllowAliasUndefined: Self = StObject.set(x, "allowAlias", js.undefined)
    
    inline def setClone_(value: () => PartialMessageEnumOptionsAllowAlias): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumOptionsAllowAlias]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageEnumOptionsAllowAlias | PlainMessage[PartialMessageEnumOptionsAllowAlias] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumOptionsAllowAlias
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumOptionsAllowAlias
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumOptionsAllowAlias
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumOptionsAllowAlias]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
