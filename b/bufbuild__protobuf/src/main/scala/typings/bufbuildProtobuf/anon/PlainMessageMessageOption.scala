...
trait PlainMessageMessageOption extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageMessageOption: PlainField[js.Function0[MessageOptions]]
  ...
  @JSName("equals")
  var equals_FPlainMessageMessageOption: PlainField[
    js.Function1[
...
object PlainMessageMessageOption {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => MessageOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => MessageOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => MessageOptions,
    ...
    __obj.asInstanceOf[PlainMessageMessageOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMessageOption] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => MessageOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => MessageOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => MessageOptions
