...
trait PartialMessageValue extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageValue: js.UndefOr[
    PartialField[js.Function0[typings.bufbuildProtobuf.distTypesGoogleProtobufStructPbMod.Value]]
  ] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageValue: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[
          typings.bufbuildProtobuf.distTypesGoogleProtobufStructPbMod.Value | PlainMessageValue | Null
        ], 
        Boolean
      ]
    ]
...
object PartialMessageValue {
  
  inline def apply(): PartialMessageValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageValue] (val x: Self) extends AnyVal {
