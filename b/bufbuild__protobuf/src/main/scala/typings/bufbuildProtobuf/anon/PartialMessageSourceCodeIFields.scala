...
trait PartialMessageSourceCodeIFields extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageSourceCodeIFields: js.UndefOr[PartialField[js.Function0[SourceCodeInfo]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageSourceCodeIFields: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[SourceCodeInfo | PlainMessageSourceCodeInfFields | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageSourceCodeIFields {
  
  inline def apply(): PartialMessageSourceCodeIFields = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageSourceCodeIFields]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageSourceCodeIFields] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[SourceCodeInfo | PlainMessageSourceCodeInfFields | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
