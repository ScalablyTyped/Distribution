...
trait PartialMessageFieldMaskClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageFieldMaskClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFieldMaskClone: js.UndefOr[
    PartialField[
...
object PartialMessageFieldMaskClone {
  
  inline def apply(): PartialMessageFieldMaskClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFieldMaskClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFieldMaskClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageFieldMaskClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFieldMaskClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageFieldMaskClone | PlainMessage[PartialMessageFieldMaskClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFieldMaskClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldMaskClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFieldMaskClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFieldMaskClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
