...
trait PlainMessageStructClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageStructClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageStructClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageStructClone: PlainField[
...
object PlainMessageStructClone {
  
  inline def apply(
    clone_ : () => PlainMessageStructClone,
    constructor: /* data */ js.UndefOr[PartialMessageStructClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageStructClone | PlainMessage[PlainMessageStructClone] | Null] => Boolean,
    fields: PlainField[
      StringDictionary[typings.bufbuildProtobuf.distTypesGoogleProtobufStructPbMod.Value]
    ],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageStructClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageStructClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageStructClone,
    getType: () => MessageType[PlainMessageStructClone],
    ...
    __obj.asInstanceOf[PlainMessageStructClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageStructClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageStructClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageStructClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageStructClone | PlainMessage[PlainMessageStructClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageStructClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageStructClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageStructClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageStructClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
