...
trait PartialMessageApiConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageApiConstructor: js.UndefOr[PartialField[js.Function0[Api]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Api]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageApiConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Api | PlainMessageApiConstructor | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageApiConstructor {
  
  inline def apply(): PartialMessageApiConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageApiConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageApiConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Api | PlainMessageApiConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
