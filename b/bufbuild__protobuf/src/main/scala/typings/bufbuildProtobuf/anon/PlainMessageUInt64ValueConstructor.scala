...
trait PlainMessageUInt64ValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageUInt64ValueConstructor: PlainField[js.Function0[UInt64Value]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[UInt64Value]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageUInt64ValueConstructor: PlainField[
...
object PlainMessageUInt64ValueConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.UInt64Value,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UInt64Value,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.UInt64Value,
  ...
  ): PlainMessageUInt64ValueConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageUInt64ValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUInt64ValueConstructor] (val x: Self) extends AnyVal {
