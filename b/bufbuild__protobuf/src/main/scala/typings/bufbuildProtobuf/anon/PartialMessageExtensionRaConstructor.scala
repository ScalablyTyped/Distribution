...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.ExtensionRangeOptions> */
trait PartialMessageExtensionRaConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageExtensionRaConstructor: js.UndefOr[PartialField[js.Function0[ExtensionRangeOptions]]] = js.undefined
  
  var constructor: js.UndefOr[
    PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[ExtensionRangeOptions]], Any]]
  ] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageExtensionRaConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[ExtensionRangeOptions | PlainMessageExtensionRangConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var fromBinary: js.UndefOr[
    PartialField[
      js.Function2[
        ...
        typings.bufbuildProtobuf.mod.ExtensionRangeOptions
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[ExtensionRangeOptions]]]] = js.undefined
...
object PartialMessageExtensionRaConstructor {
  
  inline def apply(): PartialMessageExtensionRaConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageExtensionRaConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageExtensionRaConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[ExtensionRangeOptions | PlainMessageExtensionRangConstructor | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions
