...
trait PlainMessageExtensionRangConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageExtensionRangConstructor: PlainField[js.Function0[ExtensionRangeOptions]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[ExtensionRangeOptions]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageExtensionRangConstructor: PlainField[
    js.Function1[
...
object PlainMessageExtensionRangConstructor {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.ExtensionRangeOptions,
  ...
  ): PlainMessageExtensionRangConstructor = {
    ...
    __obj.asInstanceOf[PlainMessageExtensionRangConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageExtensionRangConstructor] (val x: Self) extends AnyVal {
