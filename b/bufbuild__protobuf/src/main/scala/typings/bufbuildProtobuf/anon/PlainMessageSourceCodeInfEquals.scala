...
trait PlainMessageSourceCodeInfEquals extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceCodeInfEquals: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageSourceCodeIEquals], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceCodeInfEquals: PlainField[
...
object PlainMessageSourceCodeInfEquals {
  
  inline def apply(
    clone_ : () => PlainMessageSourceCodeInfEquals,
    constructor: /* data */ js.UndefOr[PartialMessageSourceCodeIEquals] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageSourceCodeInfEquals | PlainMessage[PlainMessageSourceCodeInfEquals] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceCodeInfEquals,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfEquals,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfEquals,
    getType: () => MessageType[PlainMessageSourceCodeInfEquals],
  ...
  ): PlainMessageSourceCodeInfEquals = {
    ...
    __obj.asInstanceOf[PlainMessageSourceCodeInfEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceCodeInfEquals] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageSourceCodeInfEquals): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageSourceCodeIEquals] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceCodeInfEquals
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfEquals
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceCodeInfEquals
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageSourceCodeInfEquals]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
