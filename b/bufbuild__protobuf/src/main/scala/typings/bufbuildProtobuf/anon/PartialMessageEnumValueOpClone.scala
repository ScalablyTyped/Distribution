...
trait PartialMessageEnumValueOpClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueOpClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueOpClone: js.UndefOr[
    PartialField[
...
object PartialMessageEnumValueOpClone {
  
  inline def apply(): PartialMessageEnumValueOpClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueOpClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueOpClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageEnumValueOpClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumValueOpClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageEnumValueOpClone | PlainMessage[PartialMessageEnumValueOpClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumValueOpClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueOpClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueOpClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumValueOpClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
