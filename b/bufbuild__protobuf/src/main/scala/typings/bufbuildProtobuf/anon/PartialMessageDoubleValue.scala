...
trait PartialMessageDoubleValue extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageDoubleValue: js.UndefOr[PartialField[js.Function0[DoubleValue]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageDoubleValue: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[DoubleValue | PlainMessageDoubleValue | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageDoubleValue {
  
  inline def apply(): PartialMessageDoubleValue = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageDoubleValue]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageDoubleValue] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[DoubleValue | PlainMessageDoubleValue | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
