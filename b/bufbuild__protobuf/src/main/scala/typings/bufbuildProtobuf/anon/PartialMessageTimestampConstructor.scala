...
trait PartialMessageTimestampConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageTimestampConstructor: js.UndefOr[PartialField[js.Function0[Timestamp]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageTimestampConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[Timestamp | PlainMessageTimestampConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageTimestampConstructor {
  
  inline def apply(): PartialMessageTimestampConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageTimestampConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageTimestampConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Timestamp | PlainMessageTimestampConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
