...
trait PartialMessageEnumValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueClone: js.UndefOr[
    PartialField[
...
object PartialMessageEnumValueClone {
  
  inline def apply(): PartialMessageEnumValueClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageEnumValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageEnumValueClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageEnumValueClone | PlainMessage[PartialMessageEnumValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageEnumValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageEnumValueClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageEnumValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
