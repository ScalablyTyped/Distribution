...
trait PartialMessageServiceDescConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageServiceDescConstructor: js.UndefOr[PartialField[js.Function0[ServiceDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageServiceDescConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[ServiceDescriptorProto | PlainMessageServiceDescriConstructor | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageServiceDescConstructor {
  
  inline def apply(): PartialMessageServiceDescConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageServiceDescConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageServiceDescConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[ServiceDescriptorProto | PlainMessageServiceDescriConstructor | Null] => Boolean
