...
trait PartialMessageType extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageType: js.UndefOr[PartialField[js.Function0[Type]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Type]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageType: js.UndefOr[
    PartialField[js.Function1[/* other */ js.UndefOr[Type | PlainMessageType | Null], Boolean]]
  ] = js.undefined
...
object PartialMessageType {
  
  inline def apply(): PartialMessageType = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageType] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Type | PlainMessageType | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
