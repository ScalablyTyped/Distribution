...
trait PartialMessageMixinConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMixinConstructor: js.UndefOr[PartialField[js.Function0[Mixin]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Mixin]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageMixinConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Mixin | PlainMessageMixinConstructor | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageMixinConstructor {
  
  inline def apply(): PartialMessageMixinConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMixinConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMixinConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Mixin | PlainMessageMixinConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
