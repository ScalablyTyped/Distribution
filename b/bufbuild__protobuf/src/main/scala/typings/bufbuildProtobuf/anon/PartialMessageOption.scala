...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/type_pb.Option> */
trait PartialMessageOption extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageOption: js.UndefOr[PartialField[js.Function0[Option]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Option]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageOption: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Option | PlainMessageOption | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Option]]]] = js.undefined
  ...
  var value: js.UndefOr[
    PartialField[js.UndefOr[typings.bufbuildProtobuf.distTypesGoogleProtobufAnyPbMod.Any]]
  ] = js.undefined
}
object PartialMessageOption {
  
  inline def apply(): PartialMessageOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageOption] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Option | PlainMessageOption | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setValue(value: PartialField[js.UndefOr[typings.bufbuildProtobuf.distTypesGoogleProtobufAnyPbMod.Any]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
