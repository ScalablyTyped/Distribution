...
trait PartialMessageEnumConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumConstructor: js.UndefOr[PartialField[js.Function0[Enum]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Enum]], Any]]] = js.undefined
  
  var enumvalue: js.UndefOr[PartialField[js.Array[EnumValue]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageEnumConstructor: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Enum | PlainMessageEnumConstructor | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Enum]]]] = js.undefined
...
object PartialMessageEnumConstructor {
  
  inline def apply(): PartialMessageEnumConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumConstructor] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Enum | PlainMessageEnumConstructor | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
