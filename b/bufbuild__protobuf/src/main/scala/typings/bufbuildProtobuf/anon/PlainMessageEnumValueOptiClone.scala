...
trait PlainMessageEnumValueOptiClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnumValueOptiClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageEnumValueOpClone], Any]]
  
  var deprecated: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("equals")
  var equals_FPlainMessageEnumValueOptiClone: PlainField[
...
object PlainMessageEnumValueOptiClone {
  
  inline def apply(
    clone_ : () => PlainMessageEnumValueOptiClone,
    constructor: /* data */ js.UndefOr[PartialMessageEnumValueOpClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageEnumValueOptiClone | PlainMessage[PlainMessageEnumValueOptiClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumValueOptiClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueOptiClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueOptiClone,
    getType: () => MessageType[PlainMessageEnumValueOptiClone],
  ...
  ): PlainMessageEnumValueOptiClone = {
    ...
    __obj.asInstanceOf[PlainMessageEnumValueOptiClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumValueOptiClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageEnumValueOptiClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageEnumValueOpClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageEnumValueOptiClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueOptiClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageEnumValueOptiClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageEnumValueOptiClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
