...
trait PlainMessageMethodDescripClone extends StObject {
  
  var clientStreaming: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageMethodDescripClone: PlainField[js.Function0[MethodDescriptorProto]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[MethodDescriptorProto]], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageMethodDescripClone: PlainField[
    js.Function1[
...
object PlainMessageMethodDescripClone {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => typings.bufbuildProtobuf.mod.MethodDescriptorProto,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodDescriptorProto,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => typings.bufbuildProtobuf.mod.MethodDescriptorProto,
  ...
  ): PlainMessageMethodDescripClone = {
    ...
    __obj.asInstanceOf[PlainMessageMethodDescripClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageMethodDescripClone] (val x: Self) extends AnyVal {
