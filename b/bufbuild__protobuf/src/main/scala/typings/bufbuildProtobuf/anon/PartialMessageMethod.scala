...
trait PartialMessageMethod extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageMethod: js.UndefOr[PartialField[js.Function0[Method]]] = js.undefined
  
  var constructor: js.UndefOr[PartialField[js.Function1[/* data */ js.UndefOr[PartialMessage[Method]], Any]]] = js.undefined
  
  @JSName("equals")
  var equals_FPartialMessageMethod: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[Method | PlainMessageMethod | Null], Boolean]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[Method]]]] = js.undefined
...
object PartialMessageMethod {
  
  inline def apply(): PartialMessageMethod = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageMethod]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageMethod] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[Method | PlainMessageMethod | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
