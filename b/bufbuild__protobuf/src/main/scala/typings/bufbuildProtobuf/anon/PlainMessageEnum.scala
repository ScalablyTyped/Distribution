...
trait PlainMessageEnum extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageEnum: PlainField[js.Function0[Enum]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnum: PlainField[js.Function1[/* other */ js.UndefOr[Enum | PlainMessage[Enum] | Null], Boolean]]
  ...
  var fromJson: PlainField[
    js.Function2[/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions], Enum]
  ]
  
  var fromJsonString: PlainField[
    js.Function2[/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions], Enum]
  ]
...
object PlainMessageEnum {
  ...
  inline def apply(
    ...
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Enum,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Enum,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Enum,
    ...
    __obj.asInstanceOf[PlainMessageEnum]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnum] (val x: Self) extends AnyVal {
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => Enum
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => Enum): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => Enum): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
