...
trait PartialMessageTimestampClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageTimestampClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageTimestampClone: js.UndefOr[
    PartialField[
...
object PartialMessageTimestampClone {
  
  inline def apply(): PartialMessageTimestampClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageTimestampClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageTimestampClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageTimestampClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageTimestampClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PartialMessageTimestampClone | PlainMessage[PartialMessageTimestampClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageTimestampClone
    ...
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageTimestampClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageTimestampClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageTimestampClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
