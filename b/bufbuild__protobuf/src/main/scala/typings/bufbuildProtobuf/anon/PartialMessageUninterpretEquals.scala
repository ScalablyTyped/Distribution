...
trait PartialMessageUninterpretEquals extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageUninterpretEquals: js.UndefOr[PartialField[js.Function0[UninterpretedOptionNamePart]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageUninterpretEquals: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[UninterpretedOptionNamePart | PlainMessageUninterpretedEquals | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageUninterpretEquals {
  
  inline def apply(): PartialMessageUninterpretEquals = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageUninterpretEquals]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageUninterpretEquals] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[UninterpretedOptionNamePart | PlainMessageUninterpretedEquals | Null] => Boolean
