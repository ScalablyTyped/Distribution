...
trait PartialMessageBoolValueConstructor extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageBoolValueConstructor: js.UndefOr[
    PartialField[
  ...
  @JSName("equals")
  var equals_FPartialMessageBoolValueConstructor: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[
          typings.bufbuildProtobuf.distTypesGoogleProtobufWrappersPbMod.BoolValue | PlainMessageBoolValueConstructor | Null
        ], 
        Boolean
      ]
    ]
...
object PartialMessageBoolValueConstructor {
  
  inline def apply(): PartialMessageBoolValueConstructor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageBoolValueConstructor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageBoolValueConstructor] (val x: Self) extends AnyVal {
