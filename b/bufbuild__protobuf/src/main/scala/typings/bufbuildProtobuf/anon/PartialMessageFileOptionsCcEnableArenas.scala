...
trait PartialMessageFileOptionsCcEnableArenas extends StObject {
  ...
  @JSName("clone")
  var clone_FPartialMessageFileOptionsCcEnableArenas: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageFileOptionsCcEnableArenas: js.UndefOr[
    PartialField[
...
object PartialMessageFileOptionsCcEnableArenas {
  
  inline def apply(): PartialMessageFileOptionsCcEnableArenas = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageFileOptionsCcEnableArenas]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageFileOptionsCcEnableArenas] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => PartialMessageFileOptionsCcEnableArenas): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageFileOptionsCcEnableArenas]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageFileOptionsCcEnableArenas | PlainMessage[PartialMessageFileOptionsCcEnableArenas] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageFileOptionsCcEnableArenas
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFileOptionsCcEnableArenas
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageFileOptionsCcEnableArenas
    ...
    inline def setGetType(value: () => MessageType[PartialMessageFileOptionsCcEnableArenas]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
