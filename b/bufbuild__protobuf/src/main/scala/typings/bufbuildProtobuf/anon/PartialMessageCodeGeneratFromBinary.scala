...
trait PartialMessageCodeGeneratFromBinary extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGeneratFromBinary: js.UndefOr[PartialField[js.Function0[CodeGeneratorResponseFile]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageCodeGeneratFromBinary: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[CodeGeneratorResponseFile | PlainMessageCodeGeneratorFromBinary | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
...
object PartialMessageCodeGeneratFromBinary {
  
  inline def apply(): PartialMessageCodeGeneratFromBinary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGeneratFromBinary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGeneratFromBinary] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[CodeGeneratorResponseFile | PlainMessageCodeGeneratorFromBinary | Null] => Boolean
