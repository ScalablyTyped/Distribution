...
trait PlainMessageSourceContextClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageSourceContextClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageSourceConteClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageSourceContextClone: PlainField[
...
object PlainMessageSourceContextClone {
  
  inline def apply(
    clone_ : () => PlainMessageSourceContextClone,
    constructor: /* data */ js.UndefOr[PartialMessageSourceConteClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageSourceContextClone | PlainMessage[PlainMessageSourceContextClone] | Null
    ] => Boolean,
    fileName: PlainField[String],
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceContextClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceContextClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceContextClone,
    getType: () => MessageType[PlainMessageSourceContextClone],
  ...
  ): PlainMessageSourceContextClone = {
    ...
    __obj.asInstanceOf[PlainMessageSourceContextClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageSourceContextClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageSourceContextClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageSourceConteClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageSourceContextClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceContextClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageSourceContextClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageSourceContextClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
