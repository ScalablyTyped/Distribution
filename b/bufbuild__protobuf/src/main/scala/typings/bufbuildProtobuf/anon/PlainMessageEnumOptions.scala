...
trait PlainMessageEnumOptions extends StObject {
  
  var allowAlias: js.UndefOr[PlainField[js.UndefOr[Boolean]]] = js.undefined
  
  @JSName("clone")
  var clone_FPlainMessageEnumOptions: PlainField[js.Function0[EnumOptions]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessage[EnumOptions]], Any]]
  ...
  @JSName("equals")
  var equals_FPlainMessageEnumOptions: PlainField[
    js.Function1[/* other */ js.UndefOr[EnumOptions | PlainMessage[EnumOptions] | Null], Boolean]
  ]
  ...
  var getType: PlainField[js.Function0[MessageType[EnumOptions]]]
...
object PlainMessageEnumOptions {
  
  inline def apply(
    clone_ : () => EnumOptions,
    constructor: /* data */ js.UndefOr[PartialMessage[EnumOptions]] => Any,
    equals_ : /* other */ js.UndefOr[EnumOptions | PlainMessage[EnumOptions] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumOptions,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumOptions,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumOptions,
    getType: () => MessageType[EnumOptions],
    ...
    __obj.asInstanceOf[PlainMessageEnumOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageEnumOptions] (val x: Self) extends AnyVal {
    ...
    inline def setClone_(value: () => EnumOptions): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[EnumOptions]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[EnumOptions | PlainMessage[EnumOptions] | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumOptions
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumOptions
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumOptions): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[EnumOptions]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
