...
trait PartialMessageCodeGeneratClone extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageCodeGeneratClone: js.UndefOr[PartialField[js.Function0[this.type]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageCodeGeneratClone: js.UndefOr[
    PartialField[
...
object PartialMessageCodeGeneratClone {
  
  inline def apply(): PartialMessageCodeGeneratClone = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageCodeGeneratClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageCodeGeneratClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PartialMessageCodeGeneratClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    ...
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessage[PartialMessageCodeGeneratClone]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setConstructorUndefined: Self = StObject.set(x, "constructor", js.undefined)
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[
          PartialMessageCodeGeneratClone | PlainMessage[PartialMessageCodeGeneratClone] | Null
        ] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PartialMessageCodeGeneratClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageCodeGeneratClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PartialMessageCodeGeneratClone
    ...
    inline def setGetType(value: () => MessageType[PartialMessageCodeGeneratClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
