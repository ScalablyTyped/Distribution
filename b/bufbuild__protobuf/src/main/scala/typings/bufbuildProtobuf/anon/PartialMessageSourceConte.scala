...
trait PartialMessageSourceConte extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageSourceConte: js.UndefOr[PartialField[js.Function0[SourceContext]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageSourceConte: js.UndefOr[
    PartialField[
      js.Function1[/* other */ js.UndefOr[SourceContext | PlainMessageSourceContext | Null], Boolean]
    ]
  ] = js.undefined
...
object PartialMessageSourceConte {
  
  inline def apply(): PartialMessageSourceConte = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageSourceConte]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageSourceConte] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(value: /* other */ js.UndefOr[SourceContext | PlainMessageSourceContext | Null] => Boolean): Self = StObject.set(x, "equals", js.Any.fromFunction1(value))
