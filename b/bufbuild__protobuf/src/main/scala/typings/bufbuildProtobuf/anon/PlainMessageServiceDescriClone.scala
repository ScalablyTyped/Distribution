...
trait PlainMessageServiceDescriClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageServiceDescriClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageServiceDescClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageServiceDescriClone: PlainField[
...
object PlainMessageServiceDescriClone {
  
  inline def apply(
    clone_ : () => PlainMessageServiceDescriClone,
    constructor: /* data */ js.UndefOr[PartialMessageServiceDescClone] => Any,
    equals_ : /* other */ js.UndefOr[
      PlainMessageServiceDescriClone | PlainMessage[PlainMessageServiceDescriClone] | Null
    ] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageServiceDescriClone,
    fromJson: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageServiceDescriClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageServiceDescriClone,
    getType: () => MessageType[PlainMessageServiceDescriClone],
  ...
  ): PlainMessageServiceDescriClone = {
    ...
    __obj.asInstanceOf[PlainMessageServiceDescriClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageServiceDescriClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageServiceDescriClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageServiceDescClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageServiceDescriClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageServiceDescriClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageServiceDescriClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageServiceDescriClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
