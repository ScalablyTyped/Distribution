...
trait PlainMessageUInt32ValueClone extends StObject {
  
  @JSName("clone")
  var clone_FPlainMessageUInt32ValueClone: PlainField[js.Function0[this.type]]
  
  var constructor: PlainField[js.Function1[/* data */ js.UndefOr[PartialMessageUInt32ValueClone], Any]]
  
  @JSName("equals")
  var equals_FPlainMessageUInt32ValueClone: PlainField[
...
object PlainMessageUInt32ValueClone {
  
  inline def apply(
    clone_ : () => PlainMessageUInt32ValueClone,
    constructor: /* data */ js.UndefOr[PartialMessageUInt32ValueClone] => Any,
    equals_ : /* other */ js.UndefOr[PlainMessageUInt32ValueClone | PlainMessage[PlainMessageUInt32ValueClone] | Null] => Boolean,
    fromBinary: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUInt32ValueClone,
    fromJson: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUInt32ValueClone,
    fromJsonString: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUInt32ValueClone,
    getType: () => MessageType[PlainMessageUInt32ValueClone],
    ...
    __obj.asInstanceOf[PlainMessageUInt32ValueClone]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlainMessageUInt32ValueClone] (val x: Self) extends AnyVal {
    
    inline def setClone_(value: () => PlainMessageUInt32ValueClone): Self = StObject.set(x, "clone", js.Any.fromFunction0(value))
    
    inline def setConstructor(value: /* data */ js.UndefOr[PartialMessageUInt32ValueClone] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    
    inline def setEquals_(
      value: /* other */ js.UndefOr[PlainMessageUInt32ValueClone | PlainMessage[PlainMessageUInt32ValueClone] | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => PlainMessageUInt32ValueClone
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromJson(
      value: (/* json */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUInt32ValueClone
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => PlainMessageUInt32ValueClone
    ): Self = StObject.set(x, "fromJsonString", js.Any.fromFunction2(value))
    
    inline def setGetType(value: () => MessageType[PlainMessageUInt32ValueClone]): Self = StObject.set(x, "getType", js.Any.fromFunction0(value))
