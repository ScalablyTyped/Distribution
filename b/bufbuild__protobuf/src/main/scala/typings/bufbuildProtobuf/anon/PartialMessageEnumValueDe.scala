...
/* Inlined @bufbuild/protobuf.@bufbuild/protobuf/dist/types/message.PartialMessage<@bufbuild/protobuf.@bufbuild/protobuf/dist/types/google/protobuf/descriptor_pb.EnumValueDescriptorProto> */
trait PartialMessageEnumValueDe extends StObject {
  
  @JSName("clone")
  var clone_FPartialMessageEnumValueDe: js.UndefOr[PartialField[js.Function0[EnumValueDescriptorProto]]] = js.undefined
  ...
  @JSName("equals")
  var equals_FPartialMessageEnumValueDe: js.UndefOr[
    PartialField[
      js.Function1[
        /* other */ js.UndefOr[EnumValueDescriptorProto | PlainMessageEnumValueDesc | Null], 
        Boolean
      ]
    ]
  ] = js.undefined
  ...
  var getType: js.UndefOr[PartialField[js.Function0[MessageType[EnumValueDescriptorProto]]]] = js.undefined
  ...
  var options: js.UndefOr[PartialField[js.UndefOr[EnumValueOptions]]] = js.undefined
...
object PartialMessageEnumValueDe {
  
  inline def apply(): PartialMessageEnumValueDe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMessageEnumValueDe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialMessageEnumValueDe] (val x: Self) extends AnyVal {
    ...
    inline def setEquals_(
      value: /* other */ js.UndefOr[EnumValueDescriptorProto | PlainMessageEnumValueDesc | Null] => Boolean
    ...
    inline def setFromBinary(
      value: (/* bytes */ js.typedarray.Uint8Array, /* options */ js.UndefOr[PartialBinaryReadOptions]) => EnumValueDescriptorProto
    ): Self = StObject.set(x, "fromBinary", js.Any.fromFunction2(value))
    
    inline def setFromBinaryUndefined: Self = StObject.set(x, "fromBinary", js.undefined)
    
    inline def setFromJson(
      value: (/* jsonValue */ JsonValue, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueDescriptorProto
    ): Self = StObject.set(x, "fromJson", js.Any.fromFunction2(value))
    
    inline def setFromJsonString(
      value: (/* jsonString */ String, /* options */ js.UndefOr[PartialJsonReadOptions]) => EnumValueDescriptorProto
    ...
    inline def setOptions(value: PartialField[js.UndefOr[EnumValueOptions]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
