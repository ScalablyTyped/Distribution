...
object IScreenOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(autoPadding)) __obj.updateDynamic("autoPadding")(autoPadding)
    if (bottom != null) __obj.updateDynamic("bottom")(bottom.asInstanceOf[js.Any])
    if (children != null) __obj.updateDynamic("children")(children)
    if (cols != null) __obj.updateDynamic("cols")(cols.asInstanceOf[js.Any])
    if (cursor != null) __obj.updateDynamic("cursor")(cursor)
    if (!js.isUndefined(debug)) __obj.updateDynamic("debug")(debug)
    if (!js.isUndefined(dockBorders)) __obj.updateDynamic("dockBorders")(dockBorders)
    if (dump != null) __obj.updateDynamic("dump")(dump.asInstanceOf[js.Any])
    if (!js.isUndefined(fastCSR)) __obj.updateDynamic("fastCSR")(fastCSR)
    if (!js.isUndefined(focusable)) __obj.updateDynamic("focusable")(focusable)
    if (focused != null) __obj.updateDynamic("focused")(focused)
    if (!js.isUndefined(forceUnicode)) __obj.updateDynamic("forceUnicode")(forceUnicode)
    if (!js.isUndefined(fullUnicode)) __obj.updateDynamic("fullUnicode")(fullUnicode)
    if (grabKeys != null) __obj.updateDynamic("grabKeys")(grabKeys)
    if (height != null) __obj.updateDynamic("height")(height.asInstanceOf[js.Any])
    if (hover != null) __obj.updateDynamic("hover")(hover)
    if (!js.isUndefined(ignoreDockContrast)) __obj.updateDynamic("ignoreDockContrast")(ignoreDockContrast)
    if (!js.isUndefined(ignoreLocked)) __obj.updateDynamic("ignoreLocked")(ignoreLocked)
    if (input != null) __obj.updateDynamic("input")(input)
    if (left != null) __obj.updateDynamic("left")(left.asInstanceOf[js.Any])
    if (!js.isUndefined(lockKeys)) __obj.updateDynamic("lockKeys")(lockKeys)
    ...
    if (!js.isUndefined(sendFocus)) __obj.updateDynamic("sendFocus")(sendFocus)
    if (!js.isUndefined(smartCSR)) __obj.updateDynamic("smartCSR")(smartCSR)
    ...
    if (!js.isUndefined(useBCE)) __obj.updateDynamic("useBCE")(useBCE)
