...
import typings.blessed.blessedMod.Widgets.Types.ListbarCommand
...
object ListbarOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(autoCommandKeys = autoCommandKeys, commands = commands, items = items)
