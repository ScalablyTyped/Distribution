...
trait Anon_CreateLogger extends js.Object {
  ...
  {[ name in bunyan.bunyan.LogLevelString ]: number}
    */ browserDashBunyanLib.browserDashBunyanLibStrings.Anon_CreateLogger with js.Any
...
object Anon_CreateLogger {
  ...
  {[ name in bunyan.bunyan.LogLevelString ]: number}
    */ browserDashBunyanLib.browserDashBunyanLibStrings.Anon_CreateLogger with js.Any,
    ...
    __obj.asInstanceOf[Anon_CreateLogger]
  }
}
