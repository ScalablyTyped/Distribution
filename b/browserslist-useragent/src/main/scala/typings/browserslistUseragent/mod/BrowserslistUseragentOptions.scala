...
object BrowserslistUseragentOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowHigherVersions)) __obj.updateDynamic("allowHigherVersions")(allowHigherVersions.get.asInstanceOf[js.Any])
    if (browsers != null) __obj.updateDynamic("browsers")(browsers.asInstanceOf[js.Any])
    if (env != null) __obj.updateDynamic("env")(env.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreMinor)) __obj.updateDynamic("ignoreMinor")(ignoreMinor.get.asInstanceOf[js.Any])
