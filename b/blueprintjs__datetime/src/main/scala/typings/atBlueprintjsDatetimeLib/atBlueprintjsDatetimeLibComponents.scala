...
object atBlueprintjsDatetimeLibComponents {
  ...
  type IDatePickerProps = atBlueprintjsDatetimeLib.libEsmDatePickerMod.IDatePickerProps
  type IDateRangeInputProps = atBlueprintjsDatetimeLib.libEsmDateRangeInputMod.IDateRangeInputProps
  @scala.inline
  def IDateRangePickerProps: atBlueprintjsDatetimeLib.libEsmDateRangePickerMod.IDateRangePickerProps.type = atBlueprintjsDatetimeLib.libEsmDateRangePickerMod.IDateRangePickerProps
  type IDateRangePickerProps = atBlueprintjsDatetimeLib.libEsmDateRangePickerMod.IDateRangePickerProps
  @scala.inline
  def IDateTimePickerProps: atBlueprintjsDatetimeLib.libEsmDateTimePickerMod.IDateTimePickerProps.type = atBlueprintjsDatetimeLib.libEsmDateTimePickerMod.IDateTimePickerProps
  type IDateTimePickerProps = atBlueprintjsDatetimeLib.libEsmDateTimePickerMod.IDateTimePickerProps
  @scala.inline
  def IShortcutsProps: atBlueprintjsDatetimeLib.libEsmShortcutsMod.IShortcutsProps.type = atBlueprintjsDatetimeLib.libEsmShortcutsMod.IShortcutsProps
  type IShortcutsProps = atBlueprintjsDatetimeLib.libEsmShortcutsMod.IShortcutsProps
  @scala.inline
  def ITimePickerProps: atBlueprintjsDatetimeLib.libEsmTimePickerMod.ITimePickerProps.type = atBlueprintjsDatetimeLib.libEsmTimePickerMod.ITimePickerProps
  type ITimePickerProps = atBlueprintjsDatetimeLib.libEsmTimePickerMod.ITimePickerProps
}
