...
@js.native
class DateInput ()
  extends atBlueprintjsCoreLib.atBlueprintjsCoreMod.AbstractPureComponent[IDateInputProps, IDateInputState] {
  ...
  def componentWillUnmount_MDateInput(): scala.Unit = js.native
...
object DateInput extends js.Object {
  var defaultProps: stdLib.Partial[atBlueprintjsDatetimeLib.libEsmDateInputMod.IDateInputProps] = js.native
