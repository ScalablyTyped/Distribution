...
import typings.bulmaCalendar.AnonDate
...
trait BulmaCalendarOptions extends js.Object {
  ...
  /**
    ...
    * @default 'default'
    */
  var displayMode: js.UndefOr[typings.bulmaCalendar.bulmaCalendarStrings.default | dialog | `inline`] = js.undefined
  /**
...
object BulmaCalendarOptions {
  ...
  def apply(
    ...
    displayMode: typings.bulmaCalendar.bulmaCalendarStrings.default | dialog | `inline` = null,
