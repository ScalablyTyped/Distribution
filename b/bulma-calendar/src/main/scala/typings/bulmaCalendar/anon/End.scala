...
object End {
  ...
  implicit class EndOps[Self <: End] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEnd(value: typings.std.Date): Self = this.set("end", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteEnd: Self = this.set("end", js.undefined)
    @scala.inline
    def setStart(value: typings.std.Date): Self = this.set("start", value.asInstanceOf[js.Any])
    @scala.inline
