...
trait IItemRendererProps extends js.Object {
  ...
  @JSName("handleClick")
  var handleClick_Original: reactLib.reactMod.ReactNs.MouseEventHandler[stdLib.HTMLElement] = js.native
  ...
  /** Click event handler to select this item. */
  def handleClick(event: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLElement, reactLib.NativeMouseEvent]): scala.Unit = js.native
}
