...
trait IQueryListProps[T]
  ...
  /**
       ...
       */
  var onKeyDown: js.UndefOr[reactLib.reactMod.ReactNs.KeyboardEventHandler[reactLib.HTMLElement]] = js.native
  /**
       ...
       */
  var onKeyUp: js.UndefOr[reactLib.reactMod.ReactNs.KeyboardEventHandler[reactLib.HTMLElement]] = js.native
  /**
