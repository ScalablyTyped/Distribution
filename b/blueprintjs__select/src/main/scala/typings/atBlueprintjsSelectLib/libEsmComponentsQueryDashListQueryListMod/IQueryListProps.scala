...
trait IQueryListProps[T]
  ...
  /**
    ...
    */
  var onKeyDown: js.UndefOr[reactLib.reactMod.KeyboardEventHandler[stdLib.HTMLElement]] = js.native
  /**
    ...
    */
  var onKeyUp: js.UndefOr[reactLib.reactMod.KeyboardEventHandler[stdLib.HTMLElement]] = js.native
  /**
