...
object anon {
  ...
  object Disabled {
    ...
    inline def apply(disabled: Boolean, resetOnQuery: Boolean): Disabled = {
  ...
  object PartialIOverlayProps {
    ...
    inline def apply(): PartialIOverlayProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialIOverlayProps]
    }
    
    extension [Self <: PartialIOverlayProps](x: Self) {
  ...
  object PartialISuggestPropsany {
    ...
    inline def apply(): PartialISuggestPropsany = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialISuggestPropsany]
    }
    
    extension [Self <: PartialISuggestPropsany](x: Self) {
      
      inline def setActiveItem(value: js.Any | ICreateNewItem): Self = StObject.set(x, "activeItem", value.asInstanceOf[js.Any])
      ...
      inline def setCreateNewItemFromQuery(value: /* query */ String => js.Any): Self = StObject.set(x, "createNewItemFromQuery", js.Any.fromFunction1(value))
      ...
      inline def setDefaultSelectedItem(value: js.Any): Self = StObject.set(x, "defaultSelectedItem", value.asInstanceOf[js.Any])
      ...
      inline def setInputValueRenderer(value: /* item */ js.Any => String): Self = StObject.set(x, "inputValueRenderer", js.Any.fromFunction1(value))
      
      inline def setInputValueRendererUndefined: Self = StObject.set(x, "inputValueRenderer", js.undefined)
      
      inline def setItemDisabled(value: (/* keyof any */ String) | (js.Function2[/* item */ js.Any, /* index */ Double, Boolean])): Self = StObject.set(x, "itemDisabled", value.asInstanceOf[js.Any])
      
      inline def setItemDisabledFunction2(value: (/* item */ js.Any, /* index */ Double) => Boolean): Self = StObject.set(x, "itemDisabled", js.Any.fromFunction2(value))
      
      inline def setItemDisabledUndefined: Self = StObject.set(x, "itemDisabled", js.undefined)
      
      inline def setItemListPredicate(value: (/* query */ String, /* items */ js.Array[js.Any]) => js.Array[js.Any]): Self = StObject.set(x, "itemListPredicate", js.Any.fromFunction2(value))
      
      inline def setItemListPredicateUndefined: Self = StObject.set(x, "itemListPredicate", js.undefined)
      
      inline def setItemListRenderer(value: /* itemListProps */ IItemListRendererProps[js.Any] => Element | Null): Self = StObject.set(x, "itemListRenderer", js.Any.fromFunction1(value))
      ...
      inline def setItemRenderer(value: (js.Any, /* itemProps */ IItemRendererProps) => Element | Null): Self = StObject.set(x, "itemRenderer", js.Any.fromFunction2(value))
      
      inline def setItemRendererUndefined: Self = StObject.set(x, "itemRenderer", js.undefined)
      
      inline def setItems(value: js.Array[js.Any]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsEqual(value: ItemsEqualProp[js.Any]): Self = StObject.set(x, "itemsEqual", value.asInstanceOf[js.Any])
      
      inline def setItemsEqualFunction2(value: (js.Any, js.Any) => Boolean): Self = StObject.set(x, "itemsEqual", js.Any.fromFunction2(value))
      ...
      inline def setOnActiveItemChange(value: (/* activeItem */ js.Any | Null, /* isCreateNewItem */ Boolean) => Unit): Self = StObject.set(x, "onActiveItemChange", js.Any.fromFunction2(value))
      
      inline def setOnActiveItemChangeUndefined: Self = StObject.set(x, "onActiveItemChange", js.undefined)
      
      inline def setOnItemSelect(value: (/* item */ js.Any, /* event */ js.UndefOr[SyntheticEvent[HTMLElement, Event]]) => Unit): Self = StObject.set(x, "onItemSelect", js.Any.fromFunction2(value))
      
      inline def setOnItemSelectUndefined: Self = StObject.set(x, "onItemSelect", js.undefined)
      
      inline def setOnItemsPaste(value: /* items */ js.Array[js.Any] => Unit): Self = StObject.set(x, "onItemsPaste", js.Any.fromFunction1(value))
  ...
  object PartialITagInputProps {
    ...
    inline def apply(): PartialITagInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialITagInputProps]
    }
    
    extension [Self <: PartialITagInputProps](x: Self) {
