...
/* Inlined std.Partial<std.Omit<@blueprintjs/core.@blueprintjs/core.TagInputProps, 'inputValue' | 'onInputChange'>> */
trait PartialOmitTagInputPropsi extends StObject {
...
object PartialOmitTagInputPropsi {
  
  inline def apply(): PartialOmitTagInputPropsi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOmitTagInputPropsi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialOmitTagInputPropsi] (val x: Self) extends AnyVal {
