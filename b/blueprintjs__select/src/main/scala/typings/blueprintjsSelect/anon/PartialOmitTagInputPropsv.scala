...
/* Inlined std.Partial<std.Omit<@blueprintjs/core.@blueprintjs/core.TagInputProps, 'value' | 'onChange'>> */
trait PartialOmitTagInputPropsv extends StObject {
...
object PartialOmitTagInputPropsv {
  
  inline def apply(): PartialOmitTagInputPropsv = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOmitTagInputPropsv]
  }
  
  extension [Self <: PartialOmitTagInputPropsv](x: Self) {
