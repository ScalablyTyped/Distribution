...
/* Inlined std.Partial<std.Omit<@blueprintjs/popover2.@blueprintjs/popover2.Popover2Props<react.react.HTMLProps<std.HTMLElement>>, 'content' | 'defaultIsOpen' | 'disabled' | 'fill' | 'renderTarget'>> */
