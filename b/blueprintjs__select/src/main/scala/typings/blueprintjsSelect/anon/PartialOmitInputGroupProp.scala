...
/* Inlined std.Partial<std.Omit<@blueprintjs/core.@blueprintjs/core.InputGroupProps2, 'value' | 'onChange'>> */
trait PartialOmitInputGroupProp extends StObject {
...
object PartialOmitInputGroupProp {
  
  inline def apply(): PartialOmitInputGroupProp = {
