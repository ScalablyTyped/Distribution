...
object blueprintjsSelectStrings {
  ...
  @js.native
  sealed trait `blueprint-create-new-item` extends StObject
  inline def `blueprint-create-new-item`: `blueprint-create-new-item` = "blueprint-create-new-item".asInstanceOf[`blueprint-create-new-item`]
