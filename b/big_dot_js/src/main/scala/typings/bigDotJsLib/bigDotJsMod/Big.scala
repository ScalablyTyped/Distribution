...
trait Big extends js.Object {
  /**
    ...
    */
  var c: js.Array[scala.Double] = js.native
  /**
  ...
  /**
    ...
    */
  def pow(exp: scala.Double): Big = js.native
  /**
  ...
  def round(dp: scala.Double): Big = js.native
  def round(dp: scala.Double, rm: RoundingMode): Big = js.native
  /**
  ...
  def toExponential(dp: scala.Double): java.lang.String = js.native
  /**
  ...
  def toFixed(dp: scala.Double): java.lang.String = js.native
  /**
  ...
  def toPrecision(sd: scala.Double): java.lang.String = js.native
}
