...
import typings.bytestreamjs.buildTypesByteStreamMod.FindFirstInResult
import typings.bytestreamjs.buildTypesByteStreamMod.FindFirstNotInResult
import typings.bytestreamjs.buildTypesByteStreamMod.FindFirstSequenceResult
import typings.bytestreamjs.buildTypesByteStreamMod.FindPairedArraysResult
import typings.bytestreamjs.buildTypesByteStreamMod.FindPairedPatternsResult
import typings.bytestreamjs.buildTypesByteStreamMod.FindResult
import typings.bytestreamjs.buildTypesByteStreamMod.ReplacePatternResult
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildTypesSeqStreamMod {
  ...
  - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamBufferParameters
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamLengthParameters
    extends StObject
       with SeqStreamBaseParameters {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters
    - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters
  */
  trait SeqStreamParameters extends StObject
  object SeqStreamParameters {
    
    inline def SeqStreamBaseParameters(): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBaseParameters]
    }
    
    inline def SeqStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamBufferParameters]
    }
    
    inline def SeqStreamHexParameters(hexstring: String): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters = {
      val __obj = js.Dynamic.literal(hexstring = hexstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamHexParameters]
    }
    
    inline def SeqStreamLengthParameters(length: Double): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamLengthParameters]
    }
    
    inline def SeqStreamStreamParameters(stream: ByteStream): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters = {
      val __obj = js.Dynamic.literal(stream = stream.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStreamParameters]
    }
    
    inline def SeqStreamStringParameters(string: String): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamStringParameters]
    }
    
    inline def SeqStreamViewParameters(view: js.typedarray.Uint8Array): typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamViewParameters]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamStreamParameters
    extends StObject
       with SeqStreamBaseParameters {
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.bytestreamjs.buildTypesSeqStreamMod.SeqStreamParameters because Already inherited */ trait SeqStreamViewParameters
    extends StObject
       with SeqStreamBaseParameters {
