...
object buildTypesByteStreamMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamEmptyParameters
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters
    - typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters
  */
  trait ByteStreamParameters extends StObject
  object ByteStreamParameters {
    
    inline def ByteStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamBufferParameters]
    }
    
    inline def ByteStreamHexParameters(hexstring: String): typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters = {
      val __obj = js.Dynamic.literal(hexstring = hexstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamHexParameters]
    }
    
    inline def ByteStreamLengthParameters(length: Double): typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamLengthParameters]
    }
    
    inline def ByteStreamStringParameters(string: String): typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamStringParameters]
    }
    
    inline def ByteStreamViewParameters(view: js.typedarray.Uint8Array): typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesByteStreamMod.ByteStreamViewParameters]
    }
  }
