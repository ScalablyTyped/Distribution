...
object buildTypesBitStreamMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters
    - typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters
    - typings.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters
    - typings.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters
    - typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters
  */
  trait BitStreamParameters extends StObject
  object BitStreamParameters {
    
    inline def BitStreamBufferParameters(buffer: js.typedarray.ArrayBuffer): typings.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters = {
      val __obj = js.Dynamic.literal(buffer = buffer.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesBitStreamMod.BitStreamBufferParameters]
    }
    
    inline def BitStreamStreamParameters(byteStream: ByteStream): typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters = {
      val __obj = js.Dynamic.literal(byteStream = byteStream.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStreamParameters]
    }
    
    inline def BitStreamStringParameters(string: String): typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters = {
      val __obj = js.Dynamic.literal(string = string.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesBitStreamMod.BitStreamStringParameters]
    }
    
    inline def BitStreamUint32Parameters(uint32: Double): typings.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters = {
      val __obj = js.Dynamic.literal(uint32 = uint32.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesBitStreamMod.BitStreamUint32Parameters]
    }
    
    inline def BitStreamViewParameters(view: js.typedarray.Uint8Array): typings.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters = {
      val __obj = js.Dynamic.literal(view = view.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.bytestreamjs.buildTypesBitStreamMod.BitStreamViewParameters]
    }
  }
