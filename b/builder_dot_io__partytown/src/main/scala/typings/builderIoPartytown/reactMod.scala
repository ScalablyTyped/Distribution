...
object reactMod {
  ...
  @JSImport("@builder.io/partytown/react", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def Partytown(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Partytown")().asInstanceOf[Any]
  inline def Partytown(props: PartytownProps): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Partytown")(props.asInstanceOf[js.Any]).asInstanceOf[Any]
