...
trait IPropertyValidationRule[T] extends js.Object {
  ...
  def ValidateAsync(context: IValidationContext[T]): qLib.qMod.Promise[js.Array[IValidationFailure]]
}
...
object IPropertyValidationRule {
  ...
  def apply[T](
    ...
    ValidateAsync: IValidationContext[T] => qLib.qMod.Promise[js.Array[IValidationFailure]],
