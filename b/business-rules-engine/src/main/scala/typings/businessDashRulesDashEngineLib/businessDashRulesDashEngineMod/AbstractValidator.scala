...
class AbstractValidator[T] () extends IAbstractValidator[T] {
  var AbstractValidators: ScalablyTyped.runtime.StringDictionary[IAbstractValidator[_]] = js.native
  /* CompleteClass */
  override var ForList: scala.Boolean = js.native
  var ValidationFunctions: ScalablyTyped.runtime.StringDictionary[js.Array[IValidatorFce]] = js.native
  var Validators: ScalablyTyped.runtime.StringDictionary[js.Array[IPropertyValidator]] = js.native
  /* CompleteClass */
