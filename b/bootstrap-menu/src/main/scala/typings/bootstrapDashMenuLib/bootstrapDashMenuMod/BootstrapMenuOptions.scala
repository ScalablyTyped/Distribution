...
trait BootstrapMenuOptions extends js.Object {
  /**
    ...
    */
  var _actionSelectEvent: js.UndefOr[java.lang.String] = js.undefined
  /**
    * Array or object containing the list of actions to be rendered in the context menu.
    */
  var actions: org.scalablytyped.runtime.StringDictionary[BootstrapMenuActions] | js.Array[BootstrapMenuActions]
  /**
    * Array to group actions to render them next to each other, with a separator between each group.
    */
  var actionsGroups: js.UndefOr[js.Array[js.Array[java.lang.String]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var fetchElementData: js.UndefOr[
    js.Function1[/* jqueryElement */ jqueryLib.JQuery[stdLib.HTMLElement], BootstrapMenuRowElement]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var noActionsMessage: js.UndefOr[java.lang.String] = js.undefined
}

object BootstrapMenuOptions {
  @scala.inline
  def apply(
    actions: org.scalablytyped.runtime.StringDictionary[BootstrapMenuActions] | js.Array[BootstrapMenuActions],
    _actionSelectEvent: java.lang.String = null,
    actionsGroups: js.Array[js.Array[java.lang.String]] = null,
    container: java.lang.String = null,
    fetchElementData: /* jqueryElement */ jqueryLib.JQuery[stdLib.HTMLElement] => BootstrapMenuRowElement = null,
    menuEvent: BootstrapMenuEvent = null,
    menuPosition: BootstrapMenuPosition = null,
    menuSource: BootstrapMenuSource = null,
    noActionsMessage: java.lang.String = null
