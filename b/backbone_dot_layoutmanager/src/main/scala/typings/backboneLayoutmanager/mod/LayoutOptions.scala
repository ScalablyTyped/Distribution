...
object LayoutOptions {
  @scala.inline
  def apply[/* <: typings.backbone.mod.Model[_, typings.backbone.mod.ModelSetOptions] */ TModel](): LayoutOptions[TModel] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LayoutOptions[TModel]]
  }
  @scala.inline
  implicit class LayoutOptionsOps[Self <: LayoutOptions[_], /* <: typings.backbone.mod.Model[_, typings.backbone.mod.ModelSetOptions] */ TModel] (val x: Self with LayoutOptions[TModel]) extends AnyVal {
    @scala.inline
