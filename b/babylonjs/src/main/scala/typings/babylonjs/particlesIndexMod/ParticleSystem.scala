...
object ParticleSystem extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedParticleSystem: js.Any, scene: Scene, rootUrl: String): typings.babylonjs.particleSystemMod.ParticleSystem = js.native
  def Parse(parsedParticleSystem: js.Any, scene: Scene, rootUrl: String, doNotStart: Boolean): typings.babylonjs.particleSystemMod.ParticleSystem = js.native
  /** @hidden */
