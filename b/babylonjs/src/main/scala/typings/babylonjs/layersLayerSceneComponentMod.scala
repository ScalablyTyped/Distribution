...
object layersLayerSceneComponentMod {
  ...
  object babylonjsAbstractSceneAugmentingMod {
    ...
    object AbstractScene {
      ...
      inline def apply(layers: js.Array[Layer]): typings.babylonjs.layersLayerSceneComponentMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
