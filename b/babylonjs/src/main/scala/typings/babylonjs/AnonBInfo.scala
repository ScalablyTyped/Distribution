...
trait AnonBInfo extends js.Object {
...
object AnonBInfo {
  ...
  def apply(
    ...
    if (!js.isUndefined(depthSort)) __obj.updateDynamic("depthSort")(depthSort.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useRightHandedSystem)) __obj.updateDynamic("useRightHandedSystem")(useRightHandedSystem.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonBInfo]
  }
}
