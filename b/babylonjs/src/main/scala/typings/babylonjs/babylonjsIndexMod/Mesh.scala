...
object Mesh extends js.Object {
  ...
  def CreateBox(name: String, size: Double, scene: Nullable[Scene], updatable: Boolean): typings.babylonjs.meshMod.Mesh = js.native
  def CreateBox(name: String, size: Double, scene: Nullable[Scene], updatable: Boolean, sideOrientation: Double): typings.babylonjs.meshMod.Mesh = js.native
  /**
  ...
  def CreateDisc(name: String, radius: Double, tessellation: Double, scene: Nullable[Scene], updatable: Boolean): typings.babylonjs.meshMod.Mesh = js.native
  def CreateDisc(
    name: String,
    radius: Double,
    tessellation: Double,
  ...
  /**
    ...
    */
  def CreateIcoSphere(name: String, options: AnonUpdatable, scene: Scene): typings.babylonjs.meshMod.Mesh = js.native
  /**
    * Creates lathe mesh.
  ...
  def CreateLines(name: String, points: js.Array[Vector3], scene: Nullable[Scene], updatable: Boolean): typings.babylonjs.linesMeshMod.LinesMesh = js.native
  def CreateLines(
    name: String,
    points: js.Array[Vector3],
    scene: Nullable[Scene],
  ...
  /**
    ...
    * @returns a new Mesh
    */
  def CreatePolyhedron(name: String, options: AnonFaceColors, scene: Scene): typings.babylonjs.meshMod.Mesh = js.native
  /**
