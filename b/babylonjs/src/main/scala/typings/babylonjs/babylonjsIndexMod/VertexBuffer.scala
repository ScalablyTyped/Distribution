...
object VertexBuffer {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "VertexBuffer.DeduceStride")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "VertexBuffer.ForEach")
  @js.native
  def ForEach(
    data: DataArray,
    byteOffset: Double,
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Meshes/index", "VertexBuffer.GetTypeByteLength")
  @js.native
