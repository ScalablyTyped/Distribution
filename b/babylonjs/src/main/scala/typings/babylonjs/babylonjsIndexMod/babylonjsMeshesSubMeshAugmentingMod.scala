...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typings.babylonjs.babylonjsIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typings.babylonjs.babylonjsIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    extension [Self <: typings.babylonjs.babylonjsIndexMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh](x: Self) {
