...
import typings.babylonjs.materialsEffectRendererMod.EffectWrapper
...
object renderingFluidRendererFluidRenderingObjectMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Rendering/fluidRenderer/fluidRenderingObject", "FluidRenderingObject")
  @js.native
  open class FluidRenderingObject protected () extends StObject {
    /**
    ...
    /**
      ...
      */
    def vertexBuffers: StringDictionary[VertexBuffer] = js.native
  }
}
