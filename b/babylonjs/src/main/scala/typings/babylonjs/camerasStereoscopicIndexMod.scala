...
object camerasStereoscopicIndexMod {
  ...
  open class AnaglyphArcRotateCamera protected ()
    extends typings.babylonjs.camerasStereoscopicAnaglyphArcRotateCameraMod.AnaglyphArcRotateCamera {
    /**
  ...
  open class AnaglyphFreeCamera protected ()
    extends typings.babylonjs.camerasStereoscopicAnaglyphFreeCameraMod.AnaglyphFreeCamera {
    /**
  ...
  open class AnaglyphGamepadCamera protected ()
    extends typings.babylonjs.camerasStereoscopicAnaglyphGamepadCameraMod.AnaglyphGamepadCamera {
    /**
  ...
  open class AnaglyphUniversalCamera protected ()
    extends typings.babylonjs.camerasStereoscopicAnaglyphUniversalCameraMod.AnaglyphUniversalCamera {
    /**
  ...
  open class StereoscopicArcRotateCamera protected ()
    extends typings.babylonjs.camerasStereoscopicStereoscopicArcRotateCameraMod.StereoscopicArcRotateCamera {
    /**
  ...
  open class StereoscopicFreeCamera protected ()
    extends typings.babylonjs.camerasStereoscopicStereoscopicFreeCameraMod.StereoscopicFreeCamera {
    /**
  ...
  open class StereoscopicGamepadCamera protected ()
    extends typings.babylonjs.camerasStereoscopicStereoscopicGamepadCameraMod.StereoscopicGamepadCamera {
    /**
  ...
  open class StereoscopicScreenUniversalCamera protected ()
    extends typings.babylonjs.camerasStereoscopicStereoscopicScreenUniversalCameraMod.StereoscopicScreenUniversalCamera {
    /**
  ...
  open class StereoscopicUniversalCamera protected ()
    extends typings.babylonjs.camerasStereoscopicStereoscopicUniversalCameraMod.StereoscopicUniversalCamera {
    /**
