...
object lightsShadowsIndexMod {
  
  @JSImport("babylonjs/Lights/Shadows/index", "CascadedShadowGenerator")
  @js.native
  open class CascadedShadowGenerator protected ()
    extends typings.babylonjs.lightsShadowsCascadedShadowGeneratorMod.CascadedShadowGenerator {
    /**
  ...
  open class ShadowGenerator protected ()
    extends typings.babylonjs.lightsShadowsShadowGeneratorMod.ShadowGenerator {
    /**
  ...
  open class ShadowGeneratorSceneComponent protected ()
    extends typings.babylonjs.lightsShadowsShadowGeneratorSceneComponentMod.ShadowGeneratorSceneComponent {
    /**
