...
@JSImport("babylonjs/index", "MipmapFilterMode")
@js.native
object MipmapFilterMode extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.MipmapFilterMode & String] = js.native
