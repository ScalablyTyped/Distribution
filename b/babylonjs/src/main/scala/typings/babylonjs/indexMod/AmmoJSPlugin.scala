...
object AmmoJSPlugin {
  ...
  @JSImport("babylonjs/index", "AmmoJSPlugin._DISABLE_COLLISION_FLAG")
  @js.native
  val _DISABLE_COLLISION_FLAG: Any = js.native
  
  @JSImport("babylonjs/index", "AmmoJSPlugin._DISABLE_DEACTIVATION_FLAG")
  @js.native
  val _DISABLE_DEACTIVATION_FLAG: Any = js.native
  
  @JSImport("babylonjs/index", "AmmoJSPlugin._KINEMATIC_FLAG")
  @js.native
