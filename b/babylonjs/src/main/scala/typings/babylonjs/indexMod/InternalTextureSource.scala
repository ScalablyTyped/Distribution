...
@JSImport("babylonjs/index", "InternalTextureSource")
@js.native
object InternalTextureSource extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.internalTextureMod.InternalTextureSource & Double] = js.native
  ...
  /* 14 */ val Depth: typings.babylonjs.internalTextureMod.InternalTextureSource.Depth & Double = js.native
  
  /* 12 */ val DepthStencil: typings.babylonjs.internalTextureMod.InternalTextureSource.DepthStencil & Double = js.native
