...
@JSImport("babylonjs/index", "DynamicTexture")
@js.native
open class DynamicTexture protected ()
  extends typings.babylonjs.materialsIndexMod.DynamicTexture {
  /**
  ...
  def this(name: String, options: Any, scene: Nullable[typings.babylonjs.sceneMod.Scene]) = this()
...
object DynamicTexture {
  ...
  @JSImport("babylonjs/index", "DynamicTexture._IsCanvasElement")
  @js.native
