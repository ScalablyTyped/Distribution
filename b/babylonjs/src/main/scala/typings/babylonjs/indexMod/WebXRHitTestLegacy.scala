...
class WebXRHitTestLegacy protected ()
  extends typings.babylonjs.xRIndexMod.WebXRHitTestLegacy {
  /**
...
object WebXRHitTestLegacy {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "WebXRHitTestLegacy.XRHitTestWithRay")
  @js.native
  ...
  /**
    ...
    * @returns a promise that resolves with an array of native XR hit result in xr coordinates system
    */
  @JSImport("babylonjs/index", "WebXRHitTestLegacy.XRHitTestWithSelectEvent")
  @js.native
