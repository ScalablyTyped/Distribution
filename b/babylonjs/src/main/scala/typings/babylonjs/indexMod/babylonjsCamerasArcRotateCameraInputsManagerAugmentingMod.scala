...
object babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod {
  ...
  object ArcRotateCameraInputsManager {
    ...
    @scala.inline
    implicit class ArcRotateCameraInputsManagerMutableBuilder[Self <: typings.babylonjs.indexMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager] (val x: Self) extends AnyVal {
