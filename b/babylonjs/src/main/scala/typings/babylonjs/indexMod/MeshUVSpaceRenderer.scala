...
@JSImport("babylonjs/index", "MeshUVSpaceRenderer")
@js.native
open class MeshUVSpaceRenderer protected ()
  extends typings.babylonjs.meshesIndexMod.MeshUVSpaceRenderer {
  /**
...
object MeshUVSpaceRenderer {
  ...
  @JSImport("babylonjs/index", "MeshUVSpaceRenderer._GetShader")
  @js.native
  ...
  @JSImport("babylonjs/index", "MeshUVSpaceRenderer._IsRenderTargetTexture")
  @js.native
