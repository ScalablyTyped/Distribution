...
open class GoldbergMesh protected ()
  extends typings.babylonjs.babylonjsIndexMod.GoldbergMesh {
  /**
    * @constructor
...
object GoldbergMesh {
  ...
  /**
    ...
    */
  inline def Parse(parsedMesh: Any, scene: typings.babylonjs.sceneMod.Scene): typings.babylonjs.goldbergMeshMod.GoldbergMesh = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedMesh.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.goldbergMeshMod.GoldbergMesh]
}
