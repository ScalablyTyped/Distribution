...
object HDRTools {
  ...
  @JSImport("babylonjs/index", "HDRTools._RGBEReadPixelsRLE")
  @js.native
  ...
  @JSImport("babylonjs/index", "HDRTools._ReadStringLine")
  @js.native
  ...
  @JSImport("babylonjs/index", "HDRTools._Rgbe2float")
  @js.native
