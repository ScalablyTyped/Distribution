...
object ParticleHelper {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ParticleHelper.BaseAssetsUrl")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ParticleHelper.CreateAsync")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ParticleHelper.CreateDefault")
  @js.native
  def CreateDefault(
    emitter: Nullable[
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "ParticleHelper.ExportSet")
  @js.native
  ...
  /**
    ...
    * @returns a promise that will resolve to the new particle system
    */
  @JSImport("babylonjs/index", "ParticleHelper.ParseFromFileAsync")
  @js.native
