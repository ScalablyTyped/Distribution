...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    inline def apply(forceSphericalPolynomialsRecompute: () => Unit): typings.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
      ...
      __obj.asInstanceOf[typings.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.babylonjs.indexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture] (val x: Self) extends AnyVal {
