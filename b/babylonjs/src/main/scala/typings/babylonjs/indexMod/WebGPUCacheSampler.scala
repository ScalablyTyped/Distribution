...
@JSImport("babylonjs/index", "WebGPUCacheSampler")
@js.native
open class WebGPUCacheSampler protected ()
  extends typings.babylonjs.enginesIndexMod.WebGPUCacheSampler {
...
object WebGPUCacheSampler {
  ...
  @JSImport("babylonjs/index", "WebGPUCacheSampler._GetSamplerDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheSampler._GetSamplerFilterDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheSampler._GetSamplerWrappingDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/index", "WebGPUCacheSampler._GetWrappingMode")
  @js.native
