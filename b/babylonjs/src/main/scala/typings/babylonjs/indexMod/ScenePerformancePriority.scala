...
@JSImport("babylonjs/index", "ScenePerformancePriority")
@js.native
object ScenePerformancePriority extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.sceneMod.ScenePerformancePriority & Double] = js.native
