...
@JSImport("babylonjs/index", "DumpTools")
@js.native
open class DumpTools ()
  extends typings.babylonjs.miscIndexMod.DumpTools
/* static members */
object DumpTools {
  ...
  @JSImport("babylonjs/index", "DumpTools._CreateDumpRenderer")
  @js.native
  ...
  @JSImport("babylonjs/index", "DumpTools._DumpToolsEngine")
  @js.native
