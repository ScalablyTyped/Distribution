...
object ColorCorrectionPostProcess {
  ...
  /** @hidden */
  @JSImport("babylonjs/index", "ColorCorrectionPostProcess._Parse")
  @js.native
  def _Parse(
    ...
    rootUrl: String
  ): Nullable[typings.babylonjs.colorCorrectionPostProcessMod.ColorCorrectionPostProcess] = js.native
}
