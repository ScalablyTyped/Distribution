...
object SceneLoaderFlags {
  ...
  @JSImport("babylonjs/index", "SceneLoaderFlags._CleanBoneMatrixWeights")
  @js.native
  ...
  @JSImport("babylonjs/index", "SceneLoaderFlags._ForceFullSceneLoadingForIncremental")
  @js.native
  ...
  @JSImport("babylonjs/index", "SceneLoaderFlags._ShowLoadingScreen")
  @js.native
  ...
  @JSImport("babylonjs/index", "SceneLoaderFlags._loggingLevel")
  @js.native
