...
@JSImport("babylonjs/index", "MaterialPluginManager")
@js.native
open class MaterialPluginManager protected ()
  extends typings.babylonjs.materialsIndexMod.MaterialPluginManager {
  /**
...
object MaterialPluginManager {
  ...
  @JSImport("babylonjs/index", "MaterialPluginManager._MaterialPluginClassToMainDefine")
  @js.native
  ...
  @JSImport("babylonjs/index", "MaterialPluginManager._MaterialPluginCounter")
  @js.native
