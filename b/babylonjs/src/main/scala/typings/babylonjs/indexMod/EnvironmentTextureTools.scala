...
class EnvironmentTextureTools ()
  extends typings.babylonjs.miscIndexMod.EnvironmentTextureTools
...
object EnvironmentTextureTools extends js.Object {
  ...
  /**
    ...
    */
  def CreateEnvTextureAsync(texture: typings.babylonjs.cubeTextureMod.CubeTexture): js.Promise[ArrayBuffer] = js.native
  /**
