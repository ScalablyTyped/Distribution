...
object Vector4 {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.Center")
  @js.native
  def Center(
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.Distance")
  @js.native
  def Distance(
    value1: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4],
    value2: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.DistanceSquared")
  @js.native
  def DistanceSquared(
    value1: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4],
    value2: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.FromArray")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.FromArrayToRef")
  @js.native
  def FromArrayToRef(
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/index", "Vector4.FromFloatArrayToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.FromFloatsToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.FromVector3")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.Maximize")
  @js.native
  def Maximize(
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.Minimize")
  @js.native
  def Minimize(
    left: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4],
    right: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4]
  ...
  /**
    ...
    * @returns the vector
    */
  @JSImport("babylonjs/index", "Vector4.Normalize")
  @js.native
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/index", "Vector4.NormalizeToRef")
  @js.native
  def NormalizeToRef(
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/index", "Vector4.One")
  @js.native
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/index", "Vector4.TransformNormal")
  @js.native
  def TransformNormal(
    vector: DeepImmutable[typings.babylonjs.mathVectorMod.Vector4],
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Vector4.TransformNormalFromFloatsToRef")
  @js.native
  ...
  /**
    ...
    * @param result the vector to store the result in
    */
  @JSImport("babylonjs/index", "Vector4.TransformNormalToRef")
  @js.native
  ...
  /**
    ...
    * @returns the new vector
    */
  @JSImport("babylonjs/index", "Vector4.Zero")
  @js.native
