...
object AndOrNotEvaluator {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "AndOrNotEvaluator.Eval")
  @js.native
  def Eval(query: String, evaluateCallback: js.Function1[/* val */ js.Any, Boolean]): Boolean = js.native
  
  @JSImport("babylonjs/index", "AndOrNotEvaluator._HandleParenthesisContent")
  @js.native
  ...
  @JSImport("babylonjs/index", "AndOrNotEvaluator._SimplifyNegation")
  @js.native
