...
@JSImport("babylonjs/index", "TrigonometryBlockOperations")
@js.native
object TrigonometryBlockOperations extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.trigonometryBlockMod.TrigonometryBlockOperations & Double] = js.native
