...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    ): typings.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.babylonjs.indexMod.babylonjsCamerasCameraAugmentingMod.Camera] (val x: Self) extends AnyVal {
