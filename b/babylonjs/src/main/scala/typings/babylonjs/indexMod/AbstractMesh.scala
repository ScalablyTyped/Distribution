...
class AbstractMesh protected ()
  extends typings.babylonjs.babylonjsIndexMod.AbstractMesh {
  /**
...
object AbstractMesh {
  ...
  /** Culling strategy : Bounding Sphere Only.
    ...
    */
  @JSImport("babylonjs/index", "AbstractMesh.CULLINGSTRATEGY_BOUNDINGSPHERE_ONLY")
  @js.native
  ...
  /** Culling strategy : Optimistic Inclusion.
    ...
    */
  @JSImport("babylonjs/index", "AbstractMesh.CULLINGSTRATEGY_OPTIMISTIC_INCLUSION")
  @js.native
  ...
  /** Culling strategy : Optimistic Inclusion then Bounding Sphere Only.
    ...
    */
  @JSImport("babylonjs/index", "AbstractMesh.CULLINGSTRATEGY_OPTIMISTIC_INCLUSION_THEN_BSPHERE_ONLY")
  @js.native
  ...
  /** Default culling strategy : this is an exclusion test and it's the more accurate.
    ...
    */
  @JSImport("babylonjs/index", "AbstractMesh.CULLINGSTRATEGY_STANDARD")
  @js.native
