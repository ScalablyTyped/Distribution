...
object SerializationHelper {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "SerializationHelper.AllowLoadingUniqueId")
  @js.native
  ...
  /**
    ...
    */
  inline def Parse[T](creationFunction: js.Function0[T], source: Any, scene: Nullable[typings.babylonjs.sceneMod.Scene]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(creationFunction.asInstanceOf[js.Any], source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def Parse[T](
