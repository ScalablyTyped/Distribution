...
object Texture {
  ...
  @js.native
  def OnTextureLoadErrorObservable: typings.babylonjs.miscObservableMod.Observable[typings.babylonjs.materialsTexturesBaseTextureMod.BaseTexture] = js.native
  inline def OnTextureLoadErrorObservable_=(
    x: typings.babylonjs.miscObservableMod.Observable[typings.babylonjs.materialsTexturesBaseTextureMod.BaseTexture]
  ): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OnTextureLoadErrorObservable")(x.asInstanceOf[js.Any])
