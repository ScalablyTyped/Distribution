...
object Texture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Texture.CreateFromBase64String")
  @js.native
  ...
  /**
    ...
    * @returns the created texture
    */
  @JSImport("babylonjs/index", "Texture.LoadFromDataString")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "Texture.Parse")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/index", "Texture._CreateMirror")
  @js.native
  def _CreateMirror(
    name: String,
  ...
  /** @hidden */
  @JSImport("babylonjs/index", "Texture._CreateRenderTargetTexture")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/index", "Texture._CubeTextureParser")
  @js.native
