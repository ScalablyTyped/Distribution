...
/* augmented module */
@JSImport("babylonjs/index", "babylonjs/scene")
@js.native
object babylonjsSceneAugmentingMod extends js.Object {
  ...
  trait Scene extends js.Object {
    ...
    /** @hidden */
    def _processLateAnimationBindingsForQuaternions(holder: OriginalValue, refQuaternion: typings.babylonjs.mathVectorMod.Quaternion): typings.babylonjs.mathVectorMod.Quaternion = js.native
    /** @hidden */
