...
@JSImport("babylonjs/index", "ConditionalBlockConditions")
@js.native
object ConditionalBlockConditions extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.conditionalBlockMod.ConditionalBlockConditions & Double] = js.native
