...
object babylonjsAbstractSceneAugmentingMod {
  ...
  object AbstractScene {
    ...
    def apply(
    ...
    ): typings.babylonjs.indexMod.babylonjsAbstractSceneAugmentingMod.AbstractScene = {
      ...
      __obj.asInstanceOf[typings.babylonjs.indexMod.babylonjsAbstractSceneAugmentingMod.AbstractScene]
    }
    
    @scala.inline
    implicit class AbstractSceneMutableBuilder[Self <: typings.babylonjs.indexMod.babylonjsAbstractSceneAugmentingMod.AbstractScene] (val x: Self) extends AnyVal {
