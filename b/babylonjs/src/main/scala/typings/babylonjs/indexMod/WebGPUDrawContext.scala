...
@JSImport("babylonjs/index", "WebGPUDrawContext")
@js.native
open class WebGPUDrawContext protected ()
  extends typings.babylonjs.enginesIndexMod.WebGPUDrawContext {
...
object WebGPUDrawContext {
  ...
  @JSImport("babylonjs/index", "WebGPUDrawContext._Counter")
  @js.native
