...
object MeshBuilder extends js.Object {
  /**
    ...
    */
  def CreateBox(name: String, options: BackUVsDepth): typings.babylonjs.meshMod.Mesh = js.native
  def CreateBox(name: String, options: BackUVsDepth, scene: Nullable[typings.babylonjs.sceneMod.Scene]): typings.babylonjs.meshMod.Mesh = js.native
  /**
