...
class BaseTexture protected ()
  extends typings.babylonjs.materialsIndexMod.BaseTexture {
  /**
...
object BaseTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "BaseTexture.DEFAULT_ANISOTROPIC_FILTERING_LEVEL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/index", "BaseTexture.WhenAllReady")
  @js.native
  ...
  @JSImport("babylonjs/index", "BaseTexture._isScene")
  @js.native
