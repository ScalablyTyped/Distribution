...
@JSImport("babylonjs/index", "MeshoptCompression")
@js.native
/**
  * Constructor
  */
...
object MeshoptCompression {
  ...
  /**
    ...
    * ```
    */
  @JSImport("babylonjs/index", "MeshoptCompression.Configuration")
  @js.native
  ...
  @JSImport("babylonjs/index", "MeshoptCompression._Default")
  @js.native
