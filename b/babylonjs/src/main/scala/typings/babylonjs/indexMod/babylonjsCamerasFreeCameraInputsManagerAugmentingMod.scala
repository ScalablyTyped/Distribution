...
object babylonjsCamerasFreeCameraInputsManagerAugmentingMod {
  ...
  object FreeCameraInputsManager {
    ...
    def apply(
    ...
    ): typings.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager = {
      ...
      __obj.asInstanceOf[typings.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager]
    }
    
    @scala.inline
    implicit class FreeCameraInputsManagerMutableBuilder[Self <: typings.babylonjs.indexMod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager] (val x: Self) extends AnyVal {
