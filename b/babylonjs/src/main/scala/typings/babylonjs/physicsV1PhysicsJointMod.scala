...
object physicsV1PhysicsJointMod {
  
  @JSImport("babylonjs/Physics/v1/physicsJoint", "DistanceJoint")
  @js.native
  ...
  @JSImport("babylonjs/Physics/v1/physicsJoint", "Hinge2Joint")
  @js.native
  ...
  @JSImport("babylonjs/Physics/v1/physicsJoint", "HingeJoint")
  @js.native
  ...
  - typings.babylonjs.physicsV1PhysicsJointMod.IMotorEnabledJoint because var conflicts: physicsJoint. Inlined setMotor, setMotor, setMotor, setMotor, setMotor, setMotor, setMotor, setMotor, setLimit, setLimit, setLimit, setLimit */ @JSImport("babylonjs/Physics/v1/physicsJoint", "MotorEnabledJoint")
  @js.native
  ...
  @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint")
  @js.native
  ...
  object PhysicsJoint {
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.BallAndSocketJoint")
    @js.native
    ...
    /**
      * Distance-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.DistanceJoint")
    @js.native
    ...
    /**
      * Hinge-Joint 2 type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.Hinge2Joint")
    @js.native
    ...
    /**
      * Hinge-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.HingeJoint")
    @js.native
    ...
    /**
      * Lock-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.LockJoint")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.PointToPointJoint")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.PrismaticJoint")
    @js.native
    ...
    /**
      * Slider-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.SliderJoint")
    @js.native
    ...
    /**
      * Spring-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.SpringJoint")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.UniversalJoint")
    @js.native
    ...
    /**
      * Wheel-Joint type
      */
    @JSImport("babylonjs/Physics/v1/physicsJoint", "PhysicsJoint.WheelJoint")
    @js.native
