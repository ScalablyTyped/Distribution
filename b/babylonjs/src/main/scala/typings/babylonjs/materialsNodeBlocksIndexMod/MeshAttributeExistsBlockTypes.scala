...
@JSImport("babylonjs/Materials/Node/Blocks/index", "MeshAttributeExistsBlockTypes")
@js.native
object MeshAttributeExistsBlockTypes extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typings.babylonjs.materialsNodeBlocksMeshAttributeExistsBlockMod.MeshAttributeExistsBlockTypes & Double
  ] = js.native
