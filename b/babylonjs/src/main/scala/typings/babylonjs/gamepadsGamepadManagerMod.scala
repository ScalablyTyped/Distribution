...
object gamepadsGamepadManagerMod {
  ...
  open class GamepadManager () extends StObject {
    ...
    /**
      ...
      */
    def gamepads: js.Array[typings.babylonjs.gamepadsGamepadMod.Gamepad] = js.native
    ...
    /**
      ...
      */
    def getGamepadByType(): Nullable[typings.babylonjs.gamepadsGamepadMod.Gamepad] = js.native
    def getGamepadByType(`type`: Double): Nullable[typings.babylonjs.gamepadsGamepadMod.Gamepad] = js.native
    
    /**
      * observable to be triggered when the gamepad controller has been connected
      */
    var onGamepadConnectedObservable: Observable[typings.babylonjs.gamepadsGamepadMod.Gamepad] = js.native
    
    /**
      * observable to be triggered when the gamepad controller has been disconnected
      */
    var onGamepadDisconnectedObservable: Observable[typings.babylonjs.gamepadsGamepadMod.Gamepad] = js.native
  }
}
