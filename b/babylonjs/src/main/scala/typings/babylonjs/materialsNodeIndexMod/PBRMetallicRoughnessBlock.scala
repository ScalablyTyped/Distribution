...
open class PBRMetallicRoughnessBlock protected ()
  extends typings.babylonjs.materialsNodeBlocksIndexMod.PBRMetallicRoughnessBlock {
  /**
...
object PBRMetallicRoughnessBlock {
  ...
  @JSImport("babylonjs/Materials/Node/index", "PBRMetallicRoughnessBlock._OnGenerateOnlyFragmentCodeChanged")
  @js.native
