...
@JSImport("babylonjs/Materials/Node/index", "LightBlock")
@js.native
open class LightBlock protected ()
  extends typings.babylonjs.materialsNodeBlocksIndexMod.LightBlock {
  /**
...
object LightBlock {
  ...
  @JSImport("babylonjs/Materials/Node/index", "LightBlock._OnGenerateOnlyFragmentCodeChanged")
  @js.native
