...
object WebGPUCacheBindGroups {
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups.NumBindGroupsCreatedLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups.NumBindGroupsCreatedTotal")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups.NumBindGroupsLookupLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups.NumBindGroupsNoLookupLastFrame")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups._Cache")
  @js.native
  def _Cache: Any = js.native
  inline def _Cache_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_Cache")(x.asInstanceOf[js.Any])
  
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups._NumBindGroupsCreatedCurrentFrame")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups._NumBindGroupsLookupCurrentFrame")
  @js.native
  ...
  @JSImport("babylonjs/Engines/index", "WebGPUCacheBindGroups._NumBindGroupsNoLookupCurrentFrame")
  @js.native
