...
@JSImport("babylonjs/Engines/index", "BufferMapState")
@js.native
object BufferMapState extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.BufferMapState & String] = js.native
