...
class AbstractMesh protected ()
  ...
  def onCollisionPositionChange(callback: js.Function0[Unit]): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def skeleton(value: Nullable[Skeleton]): js.Any = js.native
  ...
  /**
    * Gets or sets mesh visibility between 0 and 1 (default is 1)
    */
  def visibility(value: Double): js.Any = js.native
}
