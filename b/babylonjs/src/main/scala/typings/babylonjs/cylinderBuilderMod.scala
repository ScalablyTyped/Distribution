...
@js.native
object cylinderBuilderMod extends js.Object {
  @js.native
  class CylinderBuilder () extends js.Object
  ...
  object CylinderBuilder extends js.Object {
    /**
      ...
      */
    def CreateCylinder(name: String, options: AnonCap, scene: js.Any): Mesh = js.native
  }
