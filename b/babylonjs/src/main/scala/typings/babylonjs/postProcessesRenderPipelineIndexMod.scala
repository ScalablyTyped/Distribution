...
object postProcessesRenderPipelineIndexMod {
  ...
  @JSImport("babylonjs/PostProcesses/RenderPipeline/index", "SSRRenderingPipeline")
  @js.native
  open class SSRRenderingPipeline protected ()
    extends typings.babylonjs.postProcessesRenderPipelinePipelinesIndexMod.SSRRenderingPipeline {
    /**
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      implicit open class MutableBuilder[Self <: typings.babylonjs.postProcessesRenderPipelineIndexMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
