...
class SphericalHarmonics ()
  extends typings.babylonjs.indexMod.SphericalHarmonics
/* static members */
object SphericalHarmonics {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SphericalHarmonics.FromArray")
  @js.native
  ...
  /**
    ...
    * @returns the spherical harmonics
    */
  @JSImport("babylonjs/Legacy/legacy", "SphericalHarmonics.FromPolynomial")
  @js.native
