...
object babylonjsMaterialsMaterialAugmentingMod {
  ...
  object Material {
    ...
    inline def apply(): typings.babylonjs.legacyMod.babylonjsMaterialsMaterialAugmentingMod.Material = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.babylonjs.legacyMod.babylonjsMaterialsMaterialAugmentingMod.Material]
    }
    
    extension [Self <: typings.babylonjs.legacyMod.babylonjsMaterialsMaterialAugmentingMod.Material](x: Self) {
