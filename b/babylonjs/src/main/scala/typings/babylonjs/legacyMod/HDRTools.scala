...
object HDRTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.GetCubeMapTextureData")
  @js.native
  def GetCubeMapTextureData(buffer: ArrayBuffer, size: Double): CubeMapInfo = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.Ldexp")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.RGBE_ReadHeader")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.RGBE_ReadPixels")
  @js.native
  def RGBE_ReadPixels(uint8array: Uint8Array, hdrInfo: HDRInfo): Float32Array = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.RGBE_ReadPixels_NOT_RLE")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.RGBE_ReadPixels_RLE")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.Rgbe2float")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "HDRTools.readStringLine")
  @js.native
