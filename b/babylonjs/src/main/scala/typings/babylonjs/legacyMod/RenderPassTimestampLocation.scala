...
@JSImport("babylonjs/Legacy/legacy", "RenderPassTimestampLocation")
@js.native
object RenderPassTimestampLocation extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.webgpuConstantsMod.RenderPassTimestampLocation & String] = js.native
