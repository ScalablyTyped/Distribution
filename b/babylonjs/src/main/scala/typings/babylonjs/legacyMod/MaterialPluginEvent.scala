...
@JSImport("babylonjs/Legacy/legacy", "MaterialPluginEvent")
@js.native
object MaterialPluginEvent extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.materialPluginEventMod.MaterialPluginEvent & Double] = js.native
