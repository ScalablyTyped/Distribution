...
object ShapeBuilder extends js.Object {
  ...
  def ExtrudeShape(name: String, options: AnonInvertUV, scene: Nullable[typings.babylonjs.sceneMod.Scene]): typings.babylonjs.meshMod.Mesh = js.native
  /**
  ...
  def ExtrudeShapeCustom(name: String, options: AnonPath, scene: Nullable[typings.babylonjs.sceneMod.Scene]): typings.babylonjs.meshMod.Mesh = js.native
}
