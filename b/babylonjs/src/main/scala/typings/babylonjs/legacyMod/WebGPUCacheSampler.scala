...
@JSImport("babylonjs/Legacy/legacy", "WebGPUCacheSampler")
@js.native
open class WebGPUCacheSampler protected ()
  extends typings.babylonjs.indexMod.WebGPUCacheSampler {
...
object WebGPUCacheSampler {
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUCacheSampler._GetSamplerDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUCacheSampler._GetSamplerFilterDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUCacheSampler._GetSamplerWrappingDescriptor")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUCacheSampler._GetWrappingMode")
  @js.native
