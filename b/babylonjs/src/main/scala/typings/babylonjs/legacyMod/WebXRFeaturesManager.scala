...
object WebXRFeaturesManager {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.AddWebXRFeature")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.ConstructFeature")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.GetAvailableFeatures")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.GetAvailableVersions")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.GetLatestVersionOfFeature")
  @js.native
  ...
  /**
    ...
    * @returns the version number. if not found will return -1
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager.GetStableVersionOfFeature")
  @js.native
  def GetStableVersionOfFeature(featureName: String): Double = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "WebXRFeaturesManager._AvailableFeatures")
  @js.native
