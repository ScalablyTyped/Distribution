...
object DeviceInputSystem {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "DeviceInputSystem.Create")
  @js.native
  def Create(engine: typings.babylonjs.engineMod.Engine): typings.babylonjs.deviceInputSystemMod.DeviceInputSystem = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "DeviceInputSystem._MAX_KEYCODES")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "DeviceInputSystem._MAX_POINTER_INPUTS")
  @js.native
