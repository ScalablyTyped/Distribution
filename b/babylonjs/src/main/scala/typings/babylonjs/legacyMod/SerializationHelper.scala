...
object SerializationHelper {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper.AppendSerializedAnimations")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper.Clone")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper.Instanciate")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper.Parse")
  @js.native
  def Parse[T](
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper.Serialize")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper._ColorCurvesParser")
  @js.native
  def _ColorCurvesParser(sourceProperty: js.Any): typings.babylonjs.colorCurvesMod.ColorCurves = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper._FresnelParametersParser")
  @js.native
  def _FresnelParametersParser(sourceProperty: js.Any): typings.babylonjs.fresnelParametersMod.FresnelParameters = js.native
  
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper._ImageProcessingConfigurationParser")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "SerializationHelper._TextureParser")
  @js.native
