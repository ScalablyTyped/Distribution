...
abstract class AbstractScene ()
  extends typings.babylonjs.indexMod.AbstractScene
/* static members */
object AbstractScene {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "AbstractScene.AddIndividualParser")
  @js.native
  ...
  /**
    ...
    * @param parser Defines the parser to add
    */
  @JSImport("babylonjs/Legacy/legacy", "AbstractScene.AddParser")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "AbstractScene.GetIndividualParser")
  @js.native
  ...
  /**
    ...
    * @returns the requested parser or null
    */
  @JSImport("babylonjs/Legacy/legacy", "AbstractScene.GetParser")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "AbstractScene.Parse")
  @js.native
  def Parse(
    jsonData: js.Any,
