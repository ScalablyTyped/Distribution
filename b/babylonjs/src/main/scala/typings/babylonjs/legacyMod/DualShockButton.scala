...
@JSImport("babylonjs/Legacy/legacy", "DualShockButton")
@js.native
object DualShockButton extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.dualShockGamepadMod.DualShockButton & Double] = js.native
