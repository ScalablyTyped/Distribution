...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typings.babylonjs.legacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typings.babylonjs.legacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    extension [Self <: typings.babylonjs.legacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh](x: Self) {
