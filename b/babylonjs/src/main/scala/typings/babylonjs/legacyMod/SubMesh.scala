...
@JSImport("babylonjs/Legacy/legacy", "SubMesh")
@js.native
class SubMesh protected ()
  extends typings.babylonjs.indexMod.SubMesh {
  /**
...
object SubMesh {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SubMesh.AddToMesh")
  @js.native
  def AddToMesh(
    materialIndex: Double,
    verticesStart: Double,
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "SubMesh.CreateFromIndices")
  @js.native
