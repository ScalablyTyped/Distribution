...
object babylonjsAbstractSceneAugmentingMod {
  ...
  trait AbstractScene extends StObject {
    ...
    /**
      ...
      */
    var sounds: Nullable[js.Array[typings.babylonjs.soundMod.Sound]] = js.native
  ...
  object AbstractScene {
    ...
    @scala.inline
    implicit class AbstractSceneMutableBuilder[Self <: typings.babylonjs.legacyMod.babylonjsAbstractSceneAugmentingMod.AbstractScene] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSounds(value: Nullable[js.Array[typings.babylonjs.soundMod.Sound]]): Self = StObject.set(x, "sounds", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSoundsNull: Self = StObject.set(x, "sounds", null)
      
      @scala.inline
      def setSoundsVarargs(value: typings.babylonjs.soundMod.Sound*): Self = StObject.set(x, "sounds", js.Array(value :_*))
