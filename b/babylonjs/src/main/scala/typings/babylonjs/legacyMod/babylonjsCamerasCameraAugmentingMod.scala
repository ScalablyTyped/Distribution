...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    inline def apply(_resizeOrCreateMultiviewTexture: (Double, Double) => Unit, _useMultiviewToSingleView: Boolean): typings.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera = {
    ...
    extension [Self <: typings.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera](x: Self) {
