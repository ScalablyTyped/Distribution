...
object babylonjsCamerasCameraAugmentingMod {
  ...
  object Camera {
    ...
    @scala.inline
    def apply(_resizeOrCreateMultiviewTexture: (Double, Double) => Unit, _useMultiviewToSingleView: Boolean): typings.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera = {
      ...
      __obj.asInstanceOf[typings.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera]
    }
    
    @scala.inline
    implicit class CameraMutableBuilder[Self <: typings.babylonjs.legacyMod.babylonjsCamerasCameraAugmentingMod.Camera] (val x: Self) extends AnyVal {
