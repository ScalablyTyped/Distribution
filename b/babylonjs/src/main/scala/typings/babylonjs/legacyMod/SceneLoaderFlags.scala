...
@JSImport("babylonjs/Legacy/legacy", "SceneLoaderFlags")
@js.native
open class SceneLoaderFlags ()
  extends typings.babylonjs.indexMod.SceneLoaderFlags
/* static members */
object SceneLoaderFlags {
  ...
  @JSImport("babylonjs/Legacy/legacy", "SceneLoaderFlags._CleanBoneMatrixWeights")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "SceneLoaderFlags._ForceFullSceneLoadingForIncremental")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "SceneLoaderFlags._LoggingLevel")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "SceneLoaderFlags._ShowLoadingScreen")
  @js.native
