...
object VirtualJoystick {
  ...
  @JSImport("babylonjs/Legacy/legacy", "VirtualJoystick._HalfWidth")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "VirtualJoystick._VJCanvasContext")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "VirtualJoystick._VJCanvasHeight")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "VirtualJoystick._VJCanvasWidth")
  @js.native
