...
object CascadedShadowGenerator {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "CascadedShadowGenerator.CLASSNAME")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "CascadedShadowGenerator.DEFAULT_CASCADES_COUNT")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "CascadedShadowGenerator.Parse")
  @js.native
  ...
  /** @hidden */
  @JSImport("babylonjs/Legacy/legacy", "CascadedShadowGenerator._SceneComponentInitialization")
  @js.native
  def _SceneComponentInitialization(scene: typings.babylonjs.sceneMod.Scene): Unit = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "CascadedShadowGenerator.frustumCornersNDCSpace")
  @js.native
