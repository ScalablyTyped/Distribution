...
object WebXRHandTracking {
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking.DEFAULT_HAND_MODEL_BASE_URL")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking.DEFAULT_HAND_MODEL_LEFT_FILENAME")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking.DEFAULT_HAND_MODEL_RIGHT_FILENAME")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking.DEFAULT_HAND_MODEL_SHADER_URL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._GenerateDefaultHandMeshRigMapping")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._GenerateDefaultHandMeshesAsync")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._GenerateTrackedJointMeshes")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._ICOSPHERE_PARAMS")
  @js.native
  val _ICOSPHERE_PARAMS: Any = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._LeftHandGLB")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebXRHandTracking._RightHandGLB")
  @js.native
