...
@JSImport("babylonjs/Legacy/legacy", "ThinTexture")
@js.native
open class ThinTexture protected ()
  extends typings.babylonjs.indexMod.ThinTexture {
  /**
...
object ThinTexture {
  ...
  @JSImport("babylonjs/Legacy/legacy", "ThinTexture._IsRenderTargetWrapper")
  @js.native
