...
@JSImport("babylonjs/Legacy/legacy", "ShaderLanguage")
@js.native
object ShaderLanguage extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.materialsShaderLanguageMod.ShaderLanguage & Double] = js.native
