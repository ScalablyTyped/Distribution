...
@JSImport("babylonjs/Legacy/legacy", "NodeMaterialSystemValues")
@js.native
object NodeMaterialSystemValues extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[
    typings.babylonjs.materialsNodeEnumsNodeMaterialSystemValuesMod.NodeMaterialSystemValues & Double
  ] = js.native
