...
@JSImport("babylonjs/Legacy/legacy", "ProceduralTexture")
@js.native
open class ProceduralTexture protected ()
  extends typings.babylonjs.indexMod.ProceduralTexture {
  /**
    ...
    */
  def this(name: String, size: TextureSize, fragment: Any, scene: Nullable[typings.babylonjs.sceneMod.Scene]) = this()
  def this(
    name: String,
    size: TextureSize,
    fragment: Any,
