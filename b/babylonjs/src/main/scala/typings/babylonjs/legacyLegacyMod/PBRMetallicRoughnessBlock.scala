...
open class PBRMetallicRoughnessBlock protected ()
  extends typings.babylonjs.indexMod.PBRMetallicRoughnessBlock {
  /**
...
object PBRMetallicRoughnessBlock {
  ...
  @JSImport("babylonjs/Legacy/legacy", "PBRMetallicRoughnessBlock._OnGenerateOnlyFragmentCodeChanged")
  @js.native
