...
@JSImport("babylonjs/Legacy/legacy", "BufferUsage")
@js.native
object BufferUsage extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.BufferUsage & Double] = js.native
