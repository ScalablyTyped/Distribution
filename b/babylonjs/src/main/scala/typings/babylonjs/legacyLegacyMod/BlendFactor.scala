...
@JSImport("babylonjs/Legacy/legacy", "BlendFactor")
@js.native
object BlendFactor extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.BlendFactor & String] = js.native
