...
@JSImport("babylonjs/Legacy/legacy", "PipelineErrorReason")
@js.native
object PipelineErrorReason extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.PipelineErrorReason & String] = js.native
