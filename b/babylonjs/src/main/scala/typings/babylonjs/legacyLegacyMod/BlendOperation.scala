...
@JSImport("babylonjs/Legacy/legacy", "BlendOperation")
@js.native
object BlendOperation extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.babylonjs.enginesWebGPUWebgpuConstantsMod.BlendOperation & String] = js.native
