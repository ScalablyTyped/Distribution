...
open class SSAO2RenderingPipeline protected ()
  extends typings.babylonjs.indexMod.SSAO2RenderingPipeline {
  /**
    * @constructor
...
object SSAO2RenderingPipeline {
  ...
  @JSImport("babylonjs/Legacy/legacy", "SSAO2RenderingPipeline.ORTHO_DEPTH_PROJECTION")
  @js.native
  val ORTHO_DEPTH_PROJECTION: Any = js.native
  
  @JSImport("babylonjs/Legacy/legacy", "SSAO2RenderingPipeline.PERSPECTIVE_DEPTH_PROJECTION")
  @js.native
