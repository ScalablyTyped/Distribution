...
open class WebXRHitTestLegacy protected ()
  extends typings.babylonjs.indexMod.WebXRHitTestLegacy {
  /**
...
object WebXRHitTestLegacy {
  ...
  /**
    * The module's name
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRHitTestLegacy.Name")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WebXRHitTestLegacy.Version")
  @js.native
