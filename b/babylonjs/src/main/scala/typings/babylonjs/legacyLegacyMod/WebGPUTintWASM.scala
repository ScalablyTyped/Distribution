...
object WebGPUTintWASM {
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUTintWASM.DisableUniformityAnalysis")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUTintWASM.ShowWGSLShaderCode")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUTintWASM._twgsl")
  @js.native
