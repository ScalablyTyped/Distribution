...
@JSImport("babylonjs/Legacy/legacy", "PerfCollectionStrategy")
@js.native
open class PerfCollectionStrategy ()
  extends typings.babylonjs.indexMod.PerfCollectionStrategy
/* static members */
object PerfCollectionStrategy {
  ...
  @JSImport("babylonjs/Legacy/legacy", "PerfCollectionStrategy._PressureStrategy")
  @js.native
