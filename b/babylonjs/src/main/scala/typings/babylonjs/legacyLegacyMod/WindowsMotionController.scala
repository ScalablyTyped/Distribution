...
open class WindowsMotionController protected ()
  extends typings.babylonjs.indexMod.WindowsMotionController {
  /**
...
object WindowsMotionController {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WindowsMotionController.GAMEPAD_ID_PATTERN")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "WindowsMotionController.GAMEPAD_ID_PREFIX")
  @js.native
