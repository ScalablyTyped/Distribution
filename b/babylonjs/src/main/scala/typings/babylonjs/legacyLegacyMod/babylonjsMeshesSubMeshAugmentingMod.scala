...
object babylonjsMeshesSubMeshAugmentingMod {
  ...
  object SubMesh {
    ...
    inline def apply(
    ...
    ): typings.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh = {
      ...
      __obj.asInstanceOf[typings.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.babylonjs.legacyLegacyMod.babylonjsMeshesSubMeshAugmentingMod.SubMesh] (val x: Self) extends AnyVal {
