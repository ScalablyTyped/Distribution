...
@JSImport("babylonjs/Legacy/legacy", "ComputeEffect")
@js.native
open class ComputeEffect protected ()
  extends typings.babylonjs.indexMod.ComputeEffect {
  /**
...
object ComputeEffect {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Legacy/legacy", "ComputeEffect.LogShaderCodeOnCompilationError")
  @js.native
  ...
  @JSImport("babylonjs/Legacy/legacy", "ComputeEffect._UniqueIdSeed")
  @js.native
