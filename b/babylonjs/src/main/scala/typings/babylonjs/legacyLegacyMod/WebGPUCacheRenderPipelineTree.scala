...
@JSImport("babylonjs/Legacy/legacy", "WebGPUCacheRenderPipelineTree")
@js.native
open class WebGPUCacheRenderPipelineTree protected ()
  extends typings.babylonjs.indexMod.WebGPUCacheRenderPipelineTree {
  def this(
    device: GPUDevice,
...
object WebGPUCacheRenderPipelineTree {
  ...
  @JSImport("babylonjs/Legacy/legacy", "WebGPUCacheRenderPipelineTree._Cache")
  @js.native
