...
object debugLayerMod {
  ...
  object IExplorerExtensibilityOption {
    ...
    inline def apply(action: js.Any => Unit, label: String): IExplorerExtensibilityOption = {
    ...
    extension [Self <: IExplorerExtensibilityOption](x: Self) {
      ...
      inline def setAction(value: js.Any => Unit): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
