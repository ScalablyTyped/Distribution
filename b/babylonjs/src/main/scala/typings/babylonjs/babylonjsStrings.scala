...
import typings.babylonjs.webXRHandTrackingMod.HandPart
...
object babylonjsStrings {
  ...
  sealed trait default
    extends MotionControllerComponentStateType
       with typings.babylonjs.BABYLON.MotionControllerComponentStateType
  ...
  sealed trait index
    extends HandPart
       with typings.babylonjs.BABYLON.HandPart
  ...
  @js.native
  sealed trait vrdisplayconnected extends js.Object
  
  @js.native
  sealed trait vrdisplaydisconnected extends js.Object
  ...
  @js.native
  sealed trait `xr-standard` extends js.Object
