...
trait IGPUParticleSystemPlatform extends StObject {
  ...
  def createVertexBuffers(
    updateBuffer: Buffer,
    renderVertexBuffers: org.scalablytyped.runtime.StringDictionary[VertexBuffer]
  ): Unit
...
object IGPUParticleSystemPlatform {
  ...
  implicit open class MutableBuilder[Self <: IGPUParticleSystemPlatform] (val x: Self) extends AnyVal {
    ...
    inline def setCreateVertexBuffers(value: (Buffer, org.scalablytyped.runtime.StringDictionary[VertexBuffer]) => Unit): Self = StObject.set(x, "createVertexBuffers", js.Any.fromFunction2(value))
