...
import typings.babylonjs.AnonMaxMin
import typings.babylonjs.AnonReport
import typings.babylonjs.AnonSizeY
import typings.babylonjs.AnonSizes
...
class Mesh protected () extends AbstractMesh {
  ...
  /** @hidden */
  var _userInstancedBuffersStorage: AnonSizes = js.native
  /**
...
object Mesh extends js.Object {
  ...
  /**
    ...
    * @returns a vector3
    */
  def Center(meshesOrMinMaxVector: AnonMaxMin): Vector3 = js.native
  /**
  ...
  /**
    ...
    * @returns a new Mesh
    */
  def CreatePolyhedron(name: String, options: AnonSizeY, scene: Scene): Mesh = js.native
  /**
  ...
  /**
    ...
    */
  def MinMax(meshes: js.Array[AbstractMesh]): AnonMaxMin = js.native
  /**
