...
trait PBRBRDFConfiguration extends StObject {
  ...
  /** @hidden */
  /* private */ var _internalMarkAllSubMeshesAsMiscDirty: js.Any
  
  /** @hidden */
  def _markAllSubMeshesAsMiscDirty(): Unit
  
  /* private */ var _useEnergyConservation: js.Any
  
  /* private */ var _useSmithVisibilityHeightCorrelated: js.Any
  
  /* private */ var _useSpecularGlossinessInputEnergyConservation: js.Any
  
  /* private */ var _useSphericalHarmonics: js.Any
...
object PBRBRDFConfiguration {
  ...
  extension [Self <: PBRBRDFConfiguration](x: Self) {
    
    inline def setCopyTo(value: PBRBRDFConfiguration => Unit): Self = StObject.set(x, "copyTo", js.Any.fromFunction1(value))
    
    inline def setGetClassName(value: () => String): Self = StObject.set(x, "getClassName", js.Any.fromFunction0(value))
    
    inline def setParse(value: (js.Any, Scene, String) => Unit): Self = StObject.set(x, "parse", js.Any.fromFunction3(value))
    
    inline def setPrepareDefines(value: IMaterialBRDFDefines => Unit): Self = StObject.set(x, "prepareDefines", js.Any.fromFunction1(value))
    
    inline def setSerialize(value: () => js.Any): Self = StObject.set(x, "serialize", js.Any.fromFunction0(value))
    
    inline def setUseEnergyConservation(value: Boolean): Self = StObject.set(x, "useEnergyConservation", value.asInstanceOf[js.Any])
    
    inline def setUseSmithVisibilityHeightCorrelated(value: Boolean): Self = StObject.set(x, "useSmithVisibilityHeightCorrelated", value.asInstanceOf[js.Any])
    
    inline def setUseSpecularGlossinessInputEnergyConservation(value: Boolean): Self = StObject.set(x, "useSpecularGlossinessInputEnergyConservation", value.asInstanceOf[js.Any])
    
    inline def setUseSphericalHarmonics(value: Boolean): Self = StObject.set(x, "useSphericalHarmonics", value.asInstanceOf[js.Any])
    
    inline def set_internalMarkAllSubMeshesAsMiscDirty(value: js.Any): Self = StObject.set(x, "_internalMarkAllSubMeshesAsMiscDirty", value.asInstanceOf[js.Any])
    
    inline def set_markAllSubMeshesAsMiscDirty(value: () => Unit): Self = StObject.set(x, "_markAllSubMeshesAsMiscDirty", js.Any.fromFunction0(value))
    
    inline def set_useEnergyConservation(value: js.Any): Self = StObject.set(x, "_useEnergyConservation", value.asInstanceOf[js.Any])
    
    inline def set_useSmithVisibilityHeightCorrelated(value: js.Any): Self = StObject.set(x, "_useSmithVisibilityHeightCorrelated", value.asInstanceOf[js.Any])
    
    inline def set_useSpecularGlossinessInputEnergyConservation(value: js.Any): Self = StObject.set(x, "_useSpecularGlossinessInputEnergyConservation", value.asInstanceOf[js.Any])
    
    inline def set_useSphericalHarmonics(value: js.Any): Self = StObject.set(x, "_useSphericalHarmonics", value.asInstanceOf[js.Any])
  }
}
