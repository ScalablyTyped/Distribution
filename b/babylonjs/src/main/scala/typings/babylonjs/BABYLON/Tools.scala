...
import typings.babylonjs.AnonHandlerName
...
object Tools extends js.Object {
  ...
  /**
    ...
    */
  def RegisterTopRootEvents(windowElement: Window, events: js.Array[AnonHandlerName]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def UnregisterTopRootEvents(windowElement: Window, events: js.Array[AnonHandlerName]): Unit = js.native
  /**
