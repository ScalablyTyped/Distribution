...
class StandardRenderingPipeline protected ()
  ...
  /**
    ...
    */
  def hdrAutoExposure(value: Boolean): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def motionStrength(strength: Double): js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def objectBasedMotionBlur(value: Boolean): js.Any = js.native
  /**
