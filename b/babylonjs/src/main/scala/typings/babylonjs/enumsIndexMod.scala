...
object enumsIndexMod extends js.Object {
  ...
  object NodeMaterialBlockConnectionPointMode extends js.Object {
    ...
    def apply(value: Double): js.UndefOr[
        typings.babylonjs.nodeMaterialBlockConnectionPointModeMod.NodeMaterialBlockConnectionPointMode with Double
      ] = js.native
  }
  ...
  object NodeMaterialBlockTargets extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typings.babylonjs.nodeMaterialBlockTargetsMod.NodeMaterialBlockTargets with Double
      ] = js.native
  }
