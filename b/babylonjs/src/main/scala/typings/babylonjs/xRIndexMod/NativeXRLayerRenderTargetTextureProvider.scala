...
@JSImport("babylonjs/XR/index", "NativeXRLayerRenderTargetTextureProvider")
@js.native
open class NativeXRLayerRenderTargetTextureProvider protected ()
  extends typings.babylonjs.xRNativeIndexMod.NativeXRLayerRenderTargetTextureProvider {
  def this(
