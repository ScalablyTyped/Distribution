...
@js.native
class Frustum ()
  extends typings.babylonjs.mathFrustumMod.Frustum
/* static members */
object Frustum {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetBottomPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetFarPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetLeftPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetNearPlaneToRef")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetPlanes")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetPlanesToRef")
  @js.native
  def GetPlanesToRef(
    transform: DeepImmutable[typings.babylonjs.mathVectorMod.Matrix],
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetRightPlaneToRef")
  @js.native
  ...
  /**
    ...
    * @param frustumPlane the resuling frustum plane
    */
  @JSImport("babylonjs/Maths/math", "Frustum.GetTopPlaneToRef")
  @js.native
