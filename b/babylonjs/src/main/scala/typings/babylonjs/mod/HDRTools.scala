...
@js.native
open class HDRTools ()
  extends typings.babylonjs.legacyLegacyMod.HDRTools
/* static members */
object HDRTools {
  ...
  @JSImport("babylonjs", "HDRTools._RGBEReadPixelsRLE")
  @js.native
  ...
  @JSImport("babylonjs", "HDRTools._ReadStringLine")
  @js.native
  ...
  @JSImport("babylonjs", "HDRTools._Rgbe2float")
  @js.native
