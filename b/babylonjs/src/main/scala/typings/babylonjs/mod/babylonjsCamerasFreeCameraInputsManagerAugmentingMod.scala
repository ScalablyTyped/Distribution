...
object babylonjsCamerasFreeCameraInputsManagerAugmentingMod {
  ...
  object FreeCameraInputsManager {
    ...
    @scala.inline
    implicit class FreeCameraInputsManagerMutableBuilder[Self <: typings.babylonjs.mod.babylonjsCamerasFreeCameraInputsManagerAugmentingMod.FreeCameraInputsManager] (val x: Self) extends AnyVal {
