...
open class CubeMapToSphericalPolynomialTools ()
  extends typings.babylonjs.legacyLegacyMod.CubeMapToSphericalPolynomialTools
/* static members */
object CubeMapToSphericalPolynomialTools {
  ...
  /** @internal */
  @JSImport("babylonjs", "CubeMapToSphericalPolynomialTools.MAX_HDRI_VALUE")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs", "CubeMapToSphericalPolynomialTools.PRESERVE_CLAMPED_COLORS")
  @js.native
  ...
  /**
    ...
    * @param y
    */
  @JSImport("babylonjs", "CubeMapToSphericalPolynomialTools._AreaElement")
  @js.native
  ...
  @JSImport("babylonjs", "CubeMapToSphericalPolynomialTools._FileFaces")
  @js.native
