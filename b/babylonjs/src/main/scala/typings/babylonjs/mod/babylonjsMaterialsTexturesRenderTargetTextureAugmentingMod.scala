...
object babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod {
  ...
  object RenderTargetTexture {
    ...
    inline def apply(noPrePassRenderer: Boolean): typings.babylonjs.mod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture = {
      val __obj = js.Dynamic.literal(noPrePassRenderer = noPrePassRenderer.asInstanceOf[js.Any], _prePassRenderTarget = null)
      __obj.asInstanceOf[typings.babylonjs.mod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.babylonjs.mod.babylonjsMaterialsTexturesRenderTargetTextureAugmentingMod.RenderTargetTexture] (val x: Self) extends AnyVal {
