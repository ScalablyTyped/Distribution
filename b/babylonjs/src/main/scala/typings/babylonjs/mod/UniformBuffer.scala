...
open class UniformBuffer protected ()
  extends typings.babylonjs.legacyLegacyMod.UniformBuffer {
  /**
...
object UniformBuffer {
  ...
  @JSImport("babylonjs", "UniformBuffer._TempBufferInt32View")
  @js.native
  ...
  @JSImport("babylonjs", "UniformBuffer._TempBufferUInt32View")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs", "UniformBuffer._UpdatedUbosInFrame")
  @js.native
