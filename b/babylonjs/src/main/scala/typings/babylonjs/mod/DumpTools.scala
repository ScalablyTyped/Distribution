...
@JSImport("babylonjs", "DumpTools")
@js.native
open class DumpTools ()
  extends typings.babylonjs.legacyLegacyMod.DumpTools
/* static members */
object DumpTools {
  ...
  @JSImport("babylonjs", "DumpTools._CreateDumpRenderer")
  @js.native
  ...
  @JSImport("babylonjs", "DumpTools._DumpToolsEngine")
  @js.native
