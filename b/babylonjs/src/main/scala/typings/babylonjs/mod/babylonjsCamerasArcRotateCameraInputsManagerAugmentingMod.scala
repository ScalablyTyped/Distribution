...
object babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod {
  ...
  object ArcRotateCameraInputsManager {
    ...
    @scala.inline
    implicit class ArcRotateCameraInputsManagerMutableBuilder[Self <: typings.babylonjs.mod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager] (val x: Self) extends AnyVal {
