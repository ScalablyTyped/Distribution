...
object NodeMaterial {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "NodeMaterial.CreateDefault")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "NodeMaterial.Parse")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "NodeMaterial.ParseFromFileAsync")
  @js.native
  ...
  /**
    ...
    * @returns a promise that will resolve to the new node material
    */
  @JSImport("babylonjs", "NodeMaterial.ParseFromSnippetAsync")
  @js.native
