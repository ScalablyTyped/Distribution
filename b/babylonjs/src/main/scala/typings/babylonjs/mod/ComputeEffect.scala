...
@JSImport("babylonjs", "ComputeEffect")
@js.native
open class ComputeEffect protected ()
  extends typings.babylonjs.legacyLegacyMod.ComputeEffect {
  /**
...
object ComputeEffect {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "ComputeEffect.LogShaderCodeOnCompilationError")
  @js.native
  ...
  @JSImport("babylonjs", "ComputeEffect._UniqueIdSeed")
  @js.native
