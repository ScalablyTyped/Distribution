...
object DomManagement {
  ...
  @JSImport("babylonjs", "DomManagement")
  @js.native
  ...
  /**
    ...
    * @returns a string
    */
  @JSImport("babylonjs", "DomManagement.GetDOMTextContent")
  @js.native
  ...
  /**
    ...
    * @returns true if the document object exists
    */
  @JSImport("babylonjs", "DomManagement.IsDocumentAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the navigator object exists
    */
  @JSImport("babylonjs", "DomManagement.IsNavigatorAvailable")
  @js.native
  ...
  /**
    ...
    * @returns true if the window object exists
    */
  @JSImport("babylonjs", "DomManagement.IsWindowObjectExist")
  @js.native
