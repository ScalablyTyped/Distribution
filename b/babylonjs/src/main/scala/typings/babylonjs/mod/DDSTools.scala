...
object DDSTools {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "DDSTools.GetDDSInfo")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "DDSTools.StoreLODInAlphaChannel")
  @js.native
  ...
  /**
    ...
    * @hidden
    */
  @JSImport("babylonjs", "DDSTools.UploadDDSLevels")
  @js.native
  def UploadDDSLevels(
  ...
  @JSImport("babylonjs", "DDSTools._ExtractLongWordOrder")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._FloatView")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._FromHalfFloat")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetFloatAsUIntRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetFloatRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetHalfFloatAsFloatRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetHalfFloatAsUIntRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetHalfFloatRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetLuminanceArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetRGBAArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._GetRGBArrayBuffer")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._Int32View")
  @js.native
  ...
  @JSImport("babylonjs", "DDSTools._ToHalfFloat")
  @js.native
