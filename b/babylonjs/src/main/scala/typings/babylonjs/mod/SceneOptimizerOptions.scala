...
class SceneOptimizerOptions ()
  extends typings.babylonjs.legacyMod.SceneOptimizerOptions {
  def this(/**
...
object SceneOptimizerOptions {
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "SceneOptimizerOptions.HighDegradationAllowed")
  @js.native
  ...
  /**
    ...
    * @returns a SceneOptimizerOptions object
    */
  @JSImport("babylonjs", "SceneOptimizerOptions.LowDegradationAllowed")
  @js.native
  ...
  /**
    ...
    * @returns a SceneOptimizerOptions object
    */
  @JSImport("babylonjs", "SceneOptimizerOptions.ModerateDegradationAllowed")
  @js.native
