...
class ScreenSpaceCurvaturePostProcess protected ()
  extends typings.babylonjs.legacyMod.ScreenSpaceCurvaturePostProcess {
  /**
...
object ScreenSpaceCurvaturePostProcess {
  ...
  /** @hidden */
  @JSImport("babylonjs", "ScreenSpaceCurvaturePostProcess._Parse")
  @js.native
  def _Parse(
    ...
    scene: typings.babylonjs.sceneMod.Scene,
    rootUrl: String
  ): typings.babylonjs.screenSpaceCurvaturePostProcessMod.ScreenSpaceCurvaturePostProcess = js.native
}
