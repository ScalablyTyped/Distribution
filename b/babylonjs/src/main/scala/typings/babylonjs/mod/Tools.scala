...
object Tools {
  ...
  /**
    ...
    */
  inline def GetPointerPrefix(engine: typings.babylonjs.engineMod.Engine): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPointerPrefix")(engine.asInstanceOf[js.Any]).asInstanceOf[String]
