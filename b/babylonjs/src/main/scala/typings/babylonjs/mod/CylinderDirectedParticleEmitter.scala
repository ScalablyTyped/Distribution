...
open class CylinderDirectedParticleEmitter ()
  extends typings.babylonjs.legacyLegacyMod.CylinderDirectedParticleEmitter {
  ...
  def this(
    ...
    */
  direction1: typings.babylonjs.mathsMathDotvectorMod.Vector3
  ) = this()
  def this(
    radius: Double,
    height: Double,
  ...
  direction1: Unit,
    ...
    */
  direction2: typings.babylonjs.mathsMathDotvectorMod.Vector3
  ) = this()
  def this(
    radius: Double,
    height: Double,
