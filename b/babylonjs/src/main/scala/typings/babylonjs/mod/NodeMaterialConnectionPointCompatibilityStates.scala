...
@JSImport("babylonjs", "NodeMaterialConnectionPointCompatibilityStates")
@js.native
object NodeMaterialConnectionPointCompatibilityStates extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typings.babylonjs.nodeMaterialBlockConnectionPointMod.NodeMaterialConnectionPointCompatibilityStates with Double
  ] = js.native
}
