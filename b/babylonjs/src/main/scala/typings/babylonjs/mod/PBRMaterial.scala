...
object PBRMaterial {
  ...
  /**
    ...
    * @returns - PBRMaterial
    */
  @JSImport("babylonjs", "PBRMaterial.Parse")
  @js.native
  def Parse(source: js.Any, scene: typings.babylonjs.sceneMod.Scene, rootUrl: String): typings.babylonjs.pbrMaterialMod.PBRMaterial = js.native
}
