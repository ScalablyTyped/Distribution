...
class StandardRenderingPipeline protected ()
  extends typings.babylonjs.legacyMod.StandardRenderingPipeline {
  /**
...
object StandardRenderingPipeline {
  ...
  /**
    * Luminance steps
    */
  @JSImport("babylonjs", "StandardRenderingPipeline.LuminanceSteps")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs", "StandardRenderingPipeline.Parse")
  @js.native
