...
object renderingFluidRendererFluidRenderingTexturesMod {
  
  @JSImport("babylonjs/Rendering/fluidRenderer/fluidRenderingTextures", "FluidRenderingTextures")
  @js.native
  open class FluidRenderingTextures protected () extends StObject {
    def this(
      name: String,
      scene: Scene,
      width: Double,
