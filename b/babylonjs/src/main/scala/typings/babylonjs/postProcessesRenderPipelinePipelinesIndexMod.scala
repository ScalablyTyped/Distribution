...
object postProcessesRenderPipelinePipelinesIndexMod {
  ...
  @JSImport("babylonjs/PostProcesses/RenderPipeline/Pipelines/index", "SSRRenderingPipeline")
  @js.native
  open class SSRRenderingPipeline protected ()
    extends typings.babylonjs.postProcessesRenderPipelinePipelinesSsrRenderingPipelineMod.SSRRenderingPipeline {
    /**
