...
object PartialIShaderMaterialOpt {
  ...
  def apply(
    ...
    if (!js.isUndefined(needAlphaBlending)) __obj.updateDynamic("needAlphaBlending")(needAlphaBlending.asInstanceOf[js.Any])
    if (!js.isUndefined(needAlphaTesting)) __obj.updateDynamic("needAlphaTesting")(needAlphaTesting.asInstanceOf[js.Any])
