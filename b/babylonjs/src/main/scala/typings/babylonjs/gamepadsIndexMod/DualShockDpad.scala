...
@JSImport("babylonjs/Gamepads/index", "DualShockDpad")
@js.native
object DualShockDpad extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.dualShockGamepadMod.DualShockDpad with Double] = js.native
