...
object miscPerformanceViewerPerformanceViewerCollectionStrategiesMod {
  ...
  object PerfCollectionStrategy {
    ...
    @JSImport("babylonjs/Misc/PerformanceViewer/performanceViewerCollectionStrategies", "PerfCollectionStrategy._PressureStrategy")
    @js.native
