...
object Camera extends js.Object {
  ...
  /**
    ...
    */
  def Parse(parsedCamera: js.Any, scene: Scene): typings.babylonjs.cameraMod.Camera = js.native
  /** @hidden */
  def _createDefaultParsedCamera(name: String, scene: Scene): typings.babylonjs.cameraMod.Camera = js.native
  /** @hidden */
