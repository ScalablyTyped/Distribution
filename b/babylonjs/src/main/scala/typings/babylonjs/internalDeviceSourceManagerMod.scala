...
object internalDeviceSourceManagerMod {
  ...
  object babylonjsEnginesEngineAugmentingMod {
    ...
    object Engine {
      ...
      inline def apply(): typings.babylonjs.internalDeviceSourceManagerMod.babylonjsEnginesEngineAugmentingMod.Engine = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typings.babylonjs.internalDeviceSourceManagerMod.babylonjsEnginesEngineAugmentingMod.Engine]
      }
      
      extension [Self <: typings.babylonjs.internalDeviceSourceManagerMod.babylonjsEnginesEngineAugmentingMod.Engine](x: Self) {
