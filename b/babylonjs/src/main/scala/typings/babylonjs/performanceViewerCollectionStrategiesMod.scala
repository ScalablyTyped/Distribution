...
object performanceViewerCollectionStrategiesMod {
  
  @JSImport("babylonjs/Misc/PerformanceViewer/performanceViewerCollectionStrategies", "PerfCollectionStrategy")
  @js.native
  open class PerfCollectionStrategy () extends StObject
  /* static members */
