...
object miscLoggerMod {
  ...
  object Logger {
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Misc/logger", "Logger.MessageLimitReached")
    @js.native
    ...
    @JSImport("babylonjs/Misc/logger", "Logger._CheckLimit")
    @js.native
    ...
    @JSImport("babylonjs/Misc/logger", "Logger._GenerateLimitMessage")
    @js.native
    ...
    @JSImport("babylonjs/Misc/logger", "Logger._Levels")
    @js.native
    ...
    @JSImport("babylonjs/Misc/logger", "Logger._LogLimitOutputs")
    @js.native
