...
object xRMotionControllerIndexMod {
  ...
  open class WebXRAbstractMotionController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRAbstractMotionControllerMod.WebXRAbstractMotionController {
    /**
  ...
  open class WebXRControllerComponent protected ()
    extends typings.babylonjs.xRMotionControllerWebXRControllerComponentMod.WebXRControllerComponent {
    /**
  ...
  open class WebXRGenericHandController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRGenericHandControllerMod.WebXRGenericHandController {
    /**
  ...
  open class WebXRGenericTriggerMotionController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRGenericMotionControllerMod.WebXRGenericTriggerMotionController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRHTCViveMotionController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRHTCViveMotionControllerMod.WebXRHTCViveMotionController {
    /**
  ...
  open class WebXRMicrosoftMixedRealityController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRMicrosoftMixedRealityControllerMod.WebXRMicrosoftMixedRealityController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRMotionControllerManager ()
    extends typings.babylonjs.xRMotionControllerWebXRMotionControllerManagerMod.WebXRMotionControllerManager
  /* static members */
  ...
  open class WebXROculusTouchMotionController protected ()
    extends typings.babylonjs.xRMotionControllerWebXROculusTouchMotionControllerMod.WebXROculusTouchMotionController {
    def this(
      scene: Scene,
      gamepadObject: IMinimalMotionControllerObject,
      handedness: MotionControllerHandedness
  ...
  open class WebXRProfiledMotionController protected ()
    extends typings.babylonjs.xRMotionControllerWebXRProfiledMotionControllerMod.WebXRProfiledMotionController {
