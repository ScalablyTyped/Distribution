...
object miscDumpToolsMod {
  
  @JSImport("babylonjs/Misc/dumpTools", "DumpTools")
  @js.native
  open class DumpTools () extends StObject
  /* static members */
  object DumpTools {
    ...
    @JSImport("babylonjs/Misc/dumpTools", "DumpTools._CreateDumpRenderer")
    @js.native
    ...
    @JSImport("babylonjs/Misc/dumpTools", "DumpTools._DumpToolsEngine")
    @js.native
