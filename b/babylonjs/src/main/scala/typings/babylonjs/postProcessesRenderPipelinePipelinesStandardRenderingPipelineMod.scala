...
import typings.babylonjs.lightsSpotLightMod.SpotLight
import typings.babylonjs.materialsTexturesTextureMod.Texture
import typings.babylonjs.postProcessesBlurPostProcessMod.BlurPostProcess
...
import typings.babylonjs.postProcessesScreenSpaceReflectionPostProcessMod.ScreenSpaceReflectionPostProcess
