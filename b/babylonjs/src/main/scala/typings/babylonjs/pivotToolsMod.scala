...
object pivotToolsMod {
  ...
  object PivotTools {
    ...
    /** @hidden */
    inline def _RemoveAndStorePivotPoint(mesh: AbstractMesh): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_RemoveAndStorePivotPoint")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    /** @hidden */
    inline def _RestorePivotPoint(mesh: AbstractMesh): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_RestorePivotPoint")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
}
