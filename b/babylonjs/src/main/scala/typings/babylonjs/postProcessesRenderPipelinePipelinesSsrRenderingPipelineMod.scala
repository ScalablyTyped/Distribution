...
object postProcessesRenderPipelinePipelinesSsrRenderingPipelineMod {
  
  @JSImport("babylonjs/PostProcesses/RenderPipeline/Pipelines/ssrRenderingPipeline", "SSRRenderingPipeline")
  @js.native
  open class SSRRenderingPipeline protected () extends PostProcessRenderPipeline {
    /**
  ...
  object SSRRenderingPipeline {
    ...
    /**
      ...
      */
    inline def Parse(source: Any, scene: Scene, rootUrl: String): SSRRenderingPipeline = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(source.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[SSRRenderingPipeline]
  }
}
