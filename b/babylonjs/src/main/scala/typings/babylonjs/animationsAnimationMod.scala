...
import typings.babylonjs.animationsAnimationEventMod.AnimationEvent
import typings.babylonjs.animationsAnimationKeyMod.IAnimationKey
...
import typings.babylonjs.animationsEasingMod.IEasingFunction
