...
object iShaderProcessorMod {
  ...
  trait IShaderProcessor extends StObject {
    ...
    var attributeProcessor: js.UndefOr[
        js.Function3[
          /* attribute */ String, 
          /* preProcessors */ StringDictionary[String], 
  ...
  object IShaderProcessor {
    ...
    extension [Self <: IShaderProcessor](x: Self) {
      ...
      inline def setTextureProcessor(
        value: (/* texture */ String, /* isFragment */ Boolean, /* preProcessors */ StringDictionary[String], /* processingContext */ Nullable[ShaderProcessingContext]) => String
      ...
      inline def setUniformProcessor(
        value: (/* uniform */ String, /* isFragment */ Boolean, /* preProcessors */ StringDictionary[String], /* processingContext */ Nullable[ShaderProcessingContext]) => String
