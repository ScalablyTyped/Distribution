...
object audioIndexMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      @scala.inline
      implicit class SceneMutableBuilder[Self <: typings.babylonjs.audioIndexMod.babylonjsSceneAugmentingMod.Scene] (val x: Self) extends AnyVal {
        ...
        @scala.inline
        def setGetSoundByName(value: String => Nullable[typings.babylonjs.soundMod.Sound]): Self = StObject.set(x, "getSoundByName", js.Any.fromFunction1(value))
        
        @scala.inline
        def setHeadphone(value: Boolean): Self = StObject.set(x, "headphone", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setMainSoundTrack(value: typings.babylonjs.soundTrackMod.SoundTrack): Self = StObject.set(x, "mainSoundTrack", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setSoundTracks(value: Nullable[js.Array[typings.babylonjs.soundTrackMod.SoundTrack]]): Self = StObject.set(x, "soundTracks", value.asInstanceOf[js.Any])
        
        @scala.inline
        def setSoundTracksNull: Self = StObject.set(x, "soundTracks", null)
        
        @scala.inline
        def setSoundTracksVarargs(value: typings.babylonjs.soundTrackMod.SoundTrack*): Self = StObject.set(x, "soundTracks", js.Array(value :_*))
        
        @scala.inline
        def set_mainSoundTrack(value: typings.babylonjs.soundTrackMod.SoundTrack): Self = StObject.set(x, "_mainSoundTrack", value.asInstanceOf[js.Any])
      }
    }
  }
}
