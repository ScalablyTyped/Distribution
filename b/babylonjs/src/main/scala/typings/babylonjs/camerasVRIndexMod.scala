...
object camerasVRIndexMod {
  ...
  open class OnAfterEnteringVRObservableEvent ()
    extends typings.babylonjs.camerasVRVrExperienceHelperMod.OnAfterEnteringVRObservableEvent
  
  @JSImport("babylonjs/Cameras/VR/index", "VRCameraMetrics")
  @js.native
  open class VRCameraMetrics ()
    extends typings.babylonjs.camerasVRVrCameraMetricsMod.VRCameraMetrics
  /* static members */
  ...
  open class VRDeviceOrientationArcRotateCamera protected ()
    extends typings.babylonjs.camerasVRVrDeviceOrientationArcRotateCameraMod.VRDeviceOrientationArcRotateCamera {
    /**
  ...
  open class VRDeviceOrientationFreeCamera protected ()
    extends typings.babylonjs.camerasVRVrDeviceOrientationFreeCameraMod.VRDeviceOrientationFreeCamera {
    /**
  ...
  open class VRDeviceOrientationGamepadCamera protected ()
    extends typings.babylonjs.camerasVRVrDeviceOrientationGamepadCameraMod.VRDeviceOrientationGamepadCamera {
    /**
  ...
  open class VRExperienceHelper protected ()
    extends typings.babylonjs.camerasVRVrExperienceHelperMod.VRExperienceHelper {
    /**
  ...
  open class WebVRFreeCamera protected ()
    extends typings.babylonjs.camerasVRWebVRCameraMod.WebVRFreeCamera {
    /**
