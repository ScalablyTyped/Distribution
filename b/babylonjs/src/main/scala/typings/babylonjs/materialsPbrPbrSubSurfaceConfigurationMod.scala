...
object materialsPbrPbrSubSurfaceConfigurationMod {
  
  @JSImport("babylonjs/Materials/PBR/pbrSubSurfaceConfiguration", "MaterialSubSurfaceDefines")
  @js.native
  /**
    * Creates a new instance
    * @param externalProperties list of external properties to inject into the object
    */
  open class MaterialSubSurfaceDefines () extends MaterialDefines {
    def this(externalProperties: StringDictionary[Default]) = this()
    
    var SS_ALBEDOFORREFRACTIONTINT: Boolean = js.native
    
    var SS_ALBEDOFORTRANSLUCENCYTINT: Boolean = js.native
    
    var SS_GAMMAREFRACTION: Boolean = js.native
    
    var SS_HAS_THICKNESS: Boolean = js.native
    ...
    var SS_REFRACTIONINTENSITY_TEXTURE: Boolean = js.native
    
    var SS_REFRACTIONINTENSITY_TEXTUREDIRECTUV: Double = js.native
    
    var SS_REFRACTIONMAP_3D: Boolean = js.native
    
    var SS_REFRACTIONMAP_OPPOSITEZ: Boolean = js.native
    
    var SS_REFRACTION_USE_INTENSITY_FROM_TEXTURE: Boolean = js.native
    ...
    var SS_TRANSLUCENCYINTENSITY_TEXTURE: Boolean = js.native
    
    var SS_TRANSLUCENCYINTENSITY_TEXTUREDIRECTUV: Double = js.native
    
    var SS_TRANSLUCENCY_USE_INTENSITY_FROM_TEXTURE: Boolean = js.native
    
    var SS_USE_GLTF_TEXTURES: Boolean = js.native
    
    var SS_USE_LOCAL_REFRACTIONMAP_CUBIC: Boolean = js.native
    
    var SS_USE_THICKNESS_AS_DEPTH: Boolean = js.native
  ...
  @js.native
  open class PBRSubSurfaceConfiguration protected () extends MaterialPluginBase {
