...
object miscHighDynamicRangeCubemapToSphericalPolynomialMod {
  ...
  object CubeMapToSphericalPolynomialTools {
    ...
    /** @internal */
    @JSImport("babylonjs/Misc/HighDynamicRange/cubemapToSphericalPolynomial", "CubeMapToSphericalPolynomialTools.MAX_HDRI_VALUE")
    @js.native
    ...
    /** @internal */
    @JSImport("babylonjs/Misc/HighDynamicRange/cubemapToSphericalPolynomial", "CubeMapToSphericalPolynomialTools.PRESERVE_CLAMPED_COLORS")
    @js.native
