...
import typings.babylonjs.xRFeaturesWebXRHitTestLegacyMod.IWebXRLegacyHitResult
...
object xRFeaturesWebXRHitTestMod {
  ...
  - typings.babylonjs.xRFeaturesWebXRHitTestLegacyMod.IWebXRHitTestFeature because var conflicts: attached, dependsOn, disableAutoAttach, getXRSessionInitExtension, isDisposed, xrNativeFeatureName. Inlined onHitTestResultObservable */ @JSImport("babylonjs/XR/features/WebXRHitTest", "WebXRHitTest")
  @js.native
