...
import typings.babylonjs.mathsMathDotlikeMod.IQuaternionLike
import typings.babylonjs.mathsMathDotlikeMod.IVector2Like
...
object enginesIpipelinecontextMod {
