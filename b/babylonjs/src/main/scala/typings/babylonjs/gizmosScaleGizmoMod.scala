...
object gizmosScaleGizmoMod {
  ...
  - typings.babylonjs.gizmosScaleGizmoMod.IScaleGizmo because var conflicts: _rootMesh, attachedMesh, attachedNode, customRotationQuaternion, gizmoLayer, isHovered, scaleRatio, updateGizmoPositionToMatchAttachedMesh, updateGizmoRotationToMatchAttachedMesh, updateScale. Inlined xGizmo, yGizmo, zGizmo, uniformScaleGizmo, onDragStartObservable, onDragEndObservable, snapDistance, sensitivity, addToAxisCache */ @JSImport("babylonjs/Gizmos/scaleGizmo", "ScaleGizmo")
  @js.native
  /**
