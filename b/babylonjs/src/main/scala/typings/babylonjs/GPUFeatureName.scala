...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.babylonjs.babylonjsStrings.`texture-compression-astc`
...
object GPUFeatureName {
  ...
  inline def `bgra8unorm-storage`: typings.babylonjs.babylonjsStrings.`bgra8unorm-storage` = "bgra8unorm-storage".asInstanceOf[typings.babylonjs.babylonjsStrings.`bgra8unorm-storage`]
  ...
  inline def `texture-compression-astc`: typings.babylonjs.babylonjsStrings.`texture-compression-astc` = "texture-compression-astc".asInstanceOf[typings.babylonjs.babylonjsStrings.`texture-compression-astc`]
  
  inline def `texture-compression-bc`: typings.babylonjs.babylonjsStrings.`texture-compression-bc` = "texture-compression-bc".asInstanceOf[typings.babylonjs.babylonjsStrings.`texture-compression-bc`]
  
  inline def `texture-compression-etc2`: typings.babylonjs.babylonjsStrings.`texture-compression-etc2` = "texture-compression-etc2".asInstanceOf[typings.babylonjs.babylonjsStrings.`texture-compression-etc2`]
  
  inline def `timestamp-query`: typings.babylonjs.babylonjsStrings.`timestamp-query` = "timestamp-query".asInstanceOf[typings.babylonjs.babylonjsStrings.`timestamp-query`]
}
