...
object materialsPbrPbrMaterialMod {
  ...
  object PBRMaterial {
    ...
    /**
      ...
      * (point spot...).
      */
    @JSImport("babylonjs/Materials/PBR/pbrMaterial", "PBRMaterial.DEFAULT_AO_ON_ANALYTICAL_LIGHTS")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Materials/PBR/pbrMaterial", "PBRMaterial.PBRMATERIAL_ALPHABLEND")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Materials/PBR/pbrMaterial", "PBRMaterial.PBRMATERIAL_ALPHATEST")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Materials/PBR/pbrMaterial", "PBRMaterial.PBRMATERIAL_ALPHATESTANDBLEND")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Materials/PBR/pbrMaterial", "PBRMaterial.PBRMATERIAL_OPAQUE")
    @js.native
