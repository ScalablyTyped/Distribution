...
open class Camera protected ()
  extends typings.babylonjs.camerasCameraMod.Camera {
  /**
...
object Camera {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.FOVMODE_HORIZONTAL_FIXED")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.FOVMODE_VERTICAL_FIXED")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.ForceAttachControlToAlwaysPreventDefault")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.ORTHOGRAPHIC_CAMERA")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.PERSPECTIVE_CAMERA")
  @js.native
  ...
  /**
    ...
    */
  inline def Parse(parsedCamera: Any, scene: Scene): typings.babylonjs.camerasCameraMod.Camera = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedCamera.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.camerasCameraMod.Camera]
  
  /**
    * Custom rig mode allowing rig cameras to be populated manually with any number of cameras
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_CUSTOM")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_STEREOSCOPIC_ANAGLYPH")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_STEREOSCOPIC_INTERLACED")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_STEREOSCOPIC_OVERUNDER")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_STEREOSCOPIC_SIDEBYSIDE_CROSSEYED")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_STEREOSCOPIC_SIDEBYSIDE_PARALLEL")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_VR")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Cameras/index", "Camera.RIG_MODE_WEBVR")
  @js.native
  ...
  /**
    * @internal
    */
  inline def _CreateDefaultParsedCamera(name: String, scene: Scene): typings.babylonjs.camerasCameraMod.Camera = (^.asInstanceOf[js.Dynamic].applyDynamic("_CreateDefaultParsedCamera")(name.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.camerasCameraMod.Camera]
}
