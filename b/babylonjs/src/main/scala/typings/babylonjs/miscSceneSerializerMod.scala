...
object miscSceneSerializerMod {
  
  @JSImport("babylonjs/Misc/sceneSerializer", "SceneSerializer")
  @js.native
  open class SceneSerializer () extends StObject
  /* static members */
  object SceneSerializer {
    ...
    @JSImport("babylonjs/Misc/sceneSerializer", "SceneSerializer._CollectPromises")
    @js.native
    ...
    @JSImport("babylonjs/Misc/sceneSerializer", "SceneSerializer._Serialize")
    @js.native
