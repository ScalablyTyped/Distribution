...
object materialsTexturesPackerIndexMod {
  
  @JSImport("babylonjs/Materials/Textures/Packer/index", "TexturePacker")
  @js.native
  open class TexturePacker protected ()
    extends typings.babylonjs.materialsTexturesPackerPackerMod.TexturePacker {
    /**
  ...
  open class TexturePackerFrame protected ()
    extends typings.babylonjs.materialsTexturesPackerFrameMod.TexturePackerFrame {
    /**
