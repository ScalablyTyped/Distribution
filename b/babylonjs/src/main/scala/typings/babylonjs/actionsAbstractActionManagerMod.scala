...
import typings.babylonjs.actionsActionEventMod.IActionEvent
import typings.babylonjs.actionsActionMod.IAction
...
object actionsAbstractActionManagerMod {
  
  /* note: abstract class */ @JSImport("babylonjs/Actions/abstractActionManager", "AbstractActionManager")
  @js.native
