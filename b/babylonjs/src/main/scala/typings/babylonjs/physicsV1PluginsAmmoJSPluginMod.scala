...
object physicsV1PluginsAmmoJSPluginMod {
  
  @JSImport("babylonjs/Physics/v1/Plugins/ammoJSPlugin", "AmmoJSPlugin")
  @js.native
  /**
  ...
  object AmmoJSPlugin {
    ...
    @JSImport("babylonjs/Physics/v1/Plugins/ammoJSPlugin", "AmmoJSPlugin._DISABLE_COLLISION_FLAG")
    @js.native
    val _DISABLE_COLLISION_FLAG: Any = js.native
    
    @JSImport("babylonjs/Physics/v1/Plugins/ammoJSPlugin", "AmmoJSPlugin._DISABLE_DEACTIVATION_FLAG")
    @js.native
    val _DISABLE_DEACTIVATION_FLAG: Any = js.native
    
    @JSImport("babylonjs/Physics/v1/Plugins/ammoJSPlugin", "AmmoJSPlugin._KINEMATIC_FLAG")
    @js.native
