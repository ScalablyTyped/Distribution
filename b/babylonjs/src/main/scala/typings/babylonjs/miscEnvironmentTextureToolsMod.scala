...
object miscEnvironmentTextureToolsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1
    - typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2
  */
  trait EnvironmentTextureInfo extends StObject
  object EnvironmentTextureInfo {
    
    inline def EnvironmentTextureInfoV1(irradiance: Any, specular: Any, width: Double): typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1 = {
      ...
      __obj.asInstanceOf[typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV1]
    }
    
    inline def EnvironmentTextureInfoV2(imageType: String, irradiance: Any, specular: Any, width: Double): typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2 = {
      ...
      __obj.asInstanceOf[typings.babylonjs.miscEnvironmentTextureToolsMod.EnvironmentTextureInfoV2]
    }
  }
