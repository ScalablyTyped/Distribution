...
import typings.babylonjs.camerasVRWebVRCameraMod.DevicePose
import typings.babylonjs.camerasVRWebVRCameraMod.PoseControlled
...
object gamepadsControllersPoseEnabledControllerMod {
  ...
  trait GamePadFactory extends StObject {
    ...
    /**
      ...
      */
    def create(gamepadInfo: Any): typings.babylonjs.gamepadsGamepadMod.Gamepad
  }
  object GamePadFactory {
    
    inline def apply(canCreate: Any => Boolean, create: Any => typings.babylonjs.gamepadsGamepadMod.Gamepad): GamePadFactory = {
    ...
    implicit open class MutableBuilder[Self <: GamePadFactory] (val x: Self) extends AnyVal {
      ...
      inline def setCreate(value: Any => typings.babylonjs.gamepadsGamepadMod.Gamepad): Self = StObject.set(x, "create", js.Any.fromFunction1(value))
    }
  }
