...
import typings.babylonjs.materialsNodeBlocksInputAnimatedInputBlockTypesMod.AnimatedInputBlockTypes
...
import typings.babylonjs.materialsNodeEnumsNodeMaterialSystemValuesMod.NodeMaterialSystemValues
