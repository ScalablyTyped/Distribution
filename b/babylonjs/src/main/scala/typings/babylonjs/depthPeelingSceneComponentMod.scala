...
object depthPeelingSceneComponentMod {
  ...
  object babylonjsSceneAugmentingMod {
    ...
    object Scene {
      ...
      inline def apply(_useOrderIndependentTransparency: Boolean, useOrderIndependentTransparency: Boolean): typings.babylonjs.depthPeelingSceneComponentMod.babylonjsSceneAugmentingMod.Scene = {
        ...
        __obj.asInstanceOf[typings.babylonjs.depthPeelingSceneComponentMod.babylonjsSceneAugmentingMod.Scene]
      }
      
      extension [Self <: typings.babylonjs.depthPeelingSceneComponentMod.babylonjsSceneAugmentingMod.Scene](x: Self) {
