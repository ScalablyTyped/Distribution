...
object performanceViewerIndexMod {
  ...
  open class PerfCollectionStrategy ()
    extends typings.babylonjs.performanceViewerCollectionStrategiesMod.PerfCollectionStrategy
  /* static members */
  ...
  open class PerformanceViewerCollector protected ()
    extends typings.babylonjs.performanceViewerCollectorMod.PerformanceViewerCollector {
    /**
