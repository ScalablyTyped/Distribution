...
object camerasArcRotateCameraInputsManagerMod {
  ...
  open class ArcRotateCameraInputsManager protected () extends CameraInputsManager[ArcRotateCamera] {
    ...
    /**
      ...
      */
    def addGamepad(): typings.babylonjs.gamepadsGamepadSceneComponentMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager = js.native
    ...
    /**
      ...
      * @returns the current input manager
      */
    def addVRDeviceOrientation(): typings.babylonjs.camerasInputsArcRotateCameraVRDeviceOrientationInputMod.babylonjsCamerasArcRotateCameraInputsManagerAugmentingMod.ArcRotateCameraInputsManager = js.native
  }
}
