...
trait CloseArray extends StObject {
...
object CloseArray {
  ...
  inline def apply(pathArray: js.Array[js.Array[Vector3]]): CloseArray = {
    val __obj = js.Dynamic.literal(pathArray = pathArray.asInstanceOf[js.Any])
    __obj.asInstanceOf[CloseArray]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CloseArray] (val x: Self) extends AnyVal {
