...
/* Inlined std.Partial<babylonjs.babylonjs/XR/webXREnterExitUI.WebXREnterExitUIOptions> */
trait PartialWebXREnterExitUIOp extends StObject {
...
object PartialWebXREnterExitUIOp {
  
  inline def apply(): PartialWebXREnterExitUIOp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialWebXREnterExitUIOp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialWebXREnterExitUIOp] (val x: Self) extends AnyVal {
