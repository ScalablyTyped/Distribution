...
/* Inlined std.Partial<babylonjs.BABYLON.IWebXRTeleportationOptions> */
trait PartialIWebXRTeleportatioCustomUtilityLayerScene extends StObject {
...
object PartialIWebXRTeleportatioCustomUtilityLayerScene {
  
  inline def apply(): PartialIWebXRTeleportatioCustomUtilityLayerScene = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIWebXRTeleportatioCustomUtilityLayerScene]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIWebXRTeleportatioCustomUtilityLayerScene] (val x: Self) extends AnyVal {
