...
trait BackUVsBottomBaseAt extends StObject {
...
object BackUVsBottomBaseAt {
  
  inline def apply(): BackUVsBottomBaseAt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackUVsBottomBaseAt]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BackUVsBottomBaseAt] (val x: Self) extends AnyVal {
