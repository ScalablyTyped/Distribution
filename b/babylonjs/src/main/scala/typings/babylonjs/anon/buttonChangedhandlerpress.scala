...
import typings.babylonjs.xRMotionControllerWebXRControllerComponentMod.IWebXRMotionControllerComponentChangesValues
...
object buttonChangedhandlerpress {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: buttonChangedhandlerpress] (val x: Self) extends AnyVal {
