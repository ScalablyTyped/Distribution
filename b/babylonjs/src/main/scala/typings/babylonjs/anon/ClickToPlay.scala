...
trait ClickToPlay extends StObject {
  ...
  var mesh: js.UndefOr[typings.babylonjs.BABYLON.Mesh] = js.undefined
...
object ClickToPlay {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ClickToPlay] (val x: Self) extends AnyVal {
    ...
    inline def setMesh(value: typings.babylonjs.BABYLON.Mesh): Self = StObject.set(x, "mesh", value.asInstanceOf[js.Any])
