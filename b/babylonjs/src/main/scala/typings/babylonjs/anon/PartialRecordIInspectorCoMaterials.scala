...
import typings.babylonjs.BABYLON.IInspectorContextMenuItem
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<std.Record<babylonjs.BABYLON.IInspectorContextMenuType, std.Array<babylonjs.BABYLON.IInspectorContextMenuItem>>> */
trait PartialRecordIInspectorCoMaterials extends StObject {
...
object PartialRecordIInspectorCoMaterials {
  
  inline def apply(): PartialRecordIInspectorCoMaterials = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRecordIInspectorCoMaterials]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialRecordIInspectorCoMaterials] (val x: Self) extends AnyVal {
