...
trait DiameterDiameterX extends StObject {
...
object DiameterDiameterX {
  
  inline def apply(): DiameterDiameterX = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiameterDiameterX]
  }
  
  extension [Self <: DiameterDiameterX](x: Self) {
