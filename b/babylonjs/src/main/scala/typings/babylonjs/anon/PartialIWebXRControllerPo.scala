...
/* Inlined std.Partial<babylonjs.babylonjs/XR/features/WebXRControllerPointerSelection.IWebXRControllerPointerSelectionOptions> */
trait PartialIWebXRControllerPo extends StObject {
...
object PartialIWebXRControllerPo {
  
  inline def apply(): PartialIWebXRControllerPo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIWebXRControllerPo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIWebXRControllerPo] (val x: Self) extends AnyVal {
