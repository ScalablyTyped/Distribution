...
@js.native
trait GapSizeInstance extends js.Object {
...
object GapSizeInstance {
  ...
  @scala.inline
  def apply(points: js.Array[Vector3]): GapSizeInstance = {
    val __obj = js.Dynamic.literal(points = points.asInstanceOf[js.Any])
    __obj.asInstanceOf[GapSizeInstance]
  }
  
  @scala.inline
  implicit class GapSizeInstanceOps[Self <: GapSizeInstance] (val x: Self) extends AnyVal {
