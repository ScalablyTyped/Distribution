...
trait DiameterZ extends StObject {
...
object DiameterZ {
  ...
  inline def apply(): DiameterZ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiameterZ]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DiameterZ] (val x: Self) extends AnyVal {
