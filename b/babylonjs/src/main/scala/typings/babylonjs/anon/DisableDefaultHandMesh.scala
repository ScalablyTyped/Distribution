...
trait DisableDefaultHandMesh extends StObject {
  ...
  /**
    ...
    */
  var handMeshes: js.UndefOr[Left] = js.undefined
  ...
  var onHandJointMeshGenerated: js.UndefOr[
    js.Function3[
      ...
      /* jointId */ Double, 
      /* controllerId */ String, 
      js.UndefOr[typings.babylonjs.meshMod.Mesh]
    ]
  ] = js.undefined
...
object DisableDefaultHandMesh {
  ...
  inline def apply(): DisableDefaultHandMesh = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisableDefaultHandMesh]
  }
  
  extension [Self <: DisableDefaultHandMesh](x: Self) {
    ...
    inline def setHandMeshes(value: Left): Self = StObject.set(x, "handMeshes", value.asInstanceOf[js.Any])
