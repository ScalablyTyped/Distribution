...
/* Inlined std.Partial<babylonjs.BABYLON.IWebXRInputOptions> */
trait PartialIWebXRInputOptionsControllerOptions extends StObject {
...
object PartialIWebXRInputOptionsControllerOptions {
  
  inline def apply(): PartialIWebXRInputOptionsControllerOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIWebXRInputOptionsControllerOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIWebXRInputOptionsControllerOptions] (val x: Self) extends AnyVal {
