...
trait DeepImmutableObjectQuaterAsArray extends StObject {
  ...
  @JSName("clone")
  val clone_FDeepImmutableObjectQuaterAsArray: DeepImmutable[js.Function0[this.type]]
  ...
  @JSName("equals")
  val equals_FDeepImmutableObjectQuaterAsArray: DeepImmutable[js.Function1[/* otherQuaternion */ DeepImmutable[this.type], Boolean]]
  ...
  @JSName("toString")
  val toString_FDeepImmutableObjectQuaterAsArray: DeepImmutable[js.Function0[String]]
...
object DeepImmutableObjectQuaterAsArray {
  ...
  inline def apply(
    ...
    add: DeepImmutable[
      js.Function1[
        /* other */ DeepImmutable[DeepImmutableObjectQuaterAsArray], 
        DeepImmutableObjectQuaterAsArray
      ]
    ],
    ...
    clone_ : DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    conjugate: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    conjugateInPlace: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    conjugateToRef: DeepImmutable[js.Function1[DeepImmutableObjectQuaterAsArray, DeepImmutableObjectQuaterAsArray]],
    ...
    equalsWithEpsilon: DeepImmutable[
      js.Function2[
        /* otherQuaternion */ DeepImmutable[DeepImmutableObjectQuaterAsArray], 
        /* epsilon */ js.UndefOr[Double], 
        Boolean
      ]
    ],
    equals_ : DeepImmutable[
      js.Function1[/* otherQuaternion */ DeepImmutable[DeepImmutableObjectQuaterAsArray], Boolean]
    ],
    fromRotationMatrix: DeepImmutable[
      js.Function1[/* matrix */ DeepImmutable[Matrix], DeepImmutableObjectQuaterAsArray]
    ],
    getClassName: DeepImmutable[js.Function0[String]],
    getHashCode: DeepImmutable[js.Function0[Double]],
    invert: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    invertInPlace: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    length: DeepImmutable[js.Function0[Double]],
    lengthSquared: DeepImmutable[js.Function0[Double]],
    multiply: DeepImmutable[
      js.Function1[
        /* q1 */ DeepImmutable[DeepImmutableObjectQuaterAsArray], 
        DeepImmutableObjectQuaterAsArray
      ]
    ],
    ...
    normalize: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    normalizeToNew: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]],
    scale: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAsArray]],
    ...
    scaleInPlace: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAsArray]],
    ...
    subtract: DeepImmutable[js.Function1[DeepImmutableObjectQuaterAsArray, DeepImmutableObjectQuaterAsArray]],
    ...
    __obj.asInstanceOf[DeepImmutableObjectQuaterAsArray]
  }
  
  extension [Self <: DeepImmutableObjectQuaterAsArray](x: Self) {
    ...
    inline def setClone_(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "clone", value.asInstanceOf[js.Any])
    
    inline def setConjugate(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "conjugate", value.asInstanceOf[js.Any])
    
    inline def setConjugateInPlace(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "conjugateInPlace", value.asInstanceOf[js.Any])
    
    inline def setConjugateToRef(
      value: DeepImmutable[js.Function1[DeepImmutableObjectQuaterAsArray, DeepImmutableObjectQuaterAsArray]]
    ): Self = StObject.set(x, "conjugateToRef", value.asInstanceOf[js.Any])
    ...
    inline def setInvert(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "invert", value.asInstanceOf[js.Any])
    
    inline def setInvertInPlace(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "invertInPlace", value.asInstanceOf[js.Any])
    ...
    inline def setNormalize(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "normalize", value.asInstanceOf[js.Any])
    
    inline def setNormalizeToNew(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "normalizeToNew", value.asInstanceOf[js.Any])
    
    inline def setScale(value: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "scale", value.asInstanceOf[js.Any])
    ...
    inline def setScaleInPlace(value: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAsArray]]): Self = StObject.set(x, "scaleInPlace", value.asInstanceOf[js.Any])
    ...
    inline def setSubtract(
      value: DeepImmutable[js.Function1[DeepImmutableObjectQuaterAsArray, DeepImmutableObjectQuaterAsArray]]
    ): Self = StObject.set(x, "subtract", value.asInstanceOf[js.Any])
