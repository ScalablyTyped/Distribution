...
trait DeepImmutableObjectQuaterAdd extends StObject {
  ...
  @JSName("clone")
  val clone_FDeepImmutableObjectQuaterAdd: DeepImmutable[js.Function0[this.type]]
  ...
  @JSName("equals")
  val equals_FDeepImmutableObjectQuaterAdd: DeepImmutable[js.Function1[/* otherQuaternion */ DeepImmutable[Quaternion], Boolean]]
  ...
  @JSName("toString")
  val toString_FDeepImmutableObjectQuaterAdd: DeepImmutable[js.Function0[String]]
...
object DeepImmutableObjectQuaterAdd {
  ...
  inline def apply(
    ...
    add: DeepImmutable[
      js.Function1[/* other */ DeepImmutable[Quaternion], DeepImmutableObjectQuaterAdd]
    ],
    addInPlace: DeepImmutable[
      js.Function1[/* other */ DeepImmutable[Quaternion], DeepImmutableObjectQuaterAdd]
    ],
    asArray: DeepImmutable[js.Function0[js.Array[Double]]],
    clone_ : DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    conjugate: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    conjugateInPlace: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    ...
    fromRotationMatrix: DeepImmutable[js.Function1[/* matrix */ DeepImmutable[Matrix], DeepImmutableObjectQuaterAdd]],
    getClassName: DeepImmutable[js.Function0[String]],
    getHashCode: DeepImmutable[js.Function0[Double]],
    invert: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    invertInPlace: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    length: DeepImmutable[js.Function0[Double]],
    lengthSquared: DeepImmutable[js.Function0[Double]],
    multiply: DeepImmutable[js.Function1[/* q1 */ DeepImmutable[Quaternion], DeepImmutableObjectQuaterAdd]],
    multiplyInPlace: DeepImmutable[js.Function1[/* q1 */ DeepImmutable[Quaternion], DeepImmutableObjectQuaterAdd]],
    multiplyToRef: DeepImmutable[
      js.Function2[/* q1 */ DeepImmutable[Quaternion], /* result */ Quaternion, Quaternion]
    ],
    normalize: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    normalizeToNew: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]],
    scale: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAdd]],
    scaleAndAddToRef: DeepImmutable[js.Function2[/* scale */ Double, /* result */ Quaternion, Quaternion]],
    scaleInPlace: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAdd]],
    ...
    subtract: DeepImmutable[js.Function1[/* other */ Quaternion, DeepImmutableObjectQuaterAdd]],
    ...
    __obj.asInstanceOf[DeepImmutableObjectQuaterAdd]
  }
  
  extension [Self <: DeepImmutableObjectQuaterAdd](x: Self) {
    ...
    inline def setClone_(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "clone", value.asInstanceOf[js.Any])
    
    inline def setConjugate(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "conjugate", value.asInstanceOf[js.Any])
    
    inline def setConjugateInPlace(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "conjugateInPlace", value.asInstanceOf[js.Any])
    ...
    inline def setInvert(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "invert", value.asInstanceOf[js.Any])
    
    inline def setInvertInPlace(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "invertInPlace", value.asInstanceOf[js.Any])
    ...
    inline def setMultiply(
      value: DeepImmutable[js.Function1[/* q1 */ DeepImmutable[Quaternion], DeepImmutableObjectQuaterAdd]]
    ...
    inline def setNormalize(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "normalize", value.asInstanceOf[js.Any])
    
    inline def setNormalizeToNew(value: DeepImmutable[js.Function0[DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "normalizeToNew", value.asInstanceOf[js.Any])
    ...
    inline def setScale(value: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "scale", value.asInstanceOf[js.Any])
    ...
    inline def setScaleInPlace(value: DeepImmutable[js.Function1[/* value */ Double, DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "scaleInPlace", value.asInstanceOf[js.Any])
    ...
    inline def setSubtract(value: DeepImmutable[js.Function1[/* other */ Quaternion, DeepImmutableObjectQuaterAdd]]): Self = StObject.set(x, "subtract", value.asInstanceOf[js.Any])
