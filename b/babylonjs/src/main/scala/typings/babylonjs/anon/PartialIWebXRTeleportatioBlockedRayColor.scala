...
trait PartialIWebXRTeleportatioBlockedRayColor extends StObject {
...
object PartialIWebXRTeleportatioBlockedRayColor {
  
  inline def apply(): PartialIWebXRTeleportatioBlockedRayColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialIWebXRTeleportatioBlockedRayColor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialIWebXRTeleportatioBlockedRayColor] (val x: Self) extends AnyVal {
