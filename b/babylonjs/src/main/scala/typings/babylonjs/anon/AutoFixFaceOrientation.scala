...
trait AutoFixFaceOrientation extends StObject {
  
  var autoFixFaceOrientation: js.UndefOr[Boolean] = js.undefined
  
  var bSphereRadiusFactor: js.UndefOr[Double] = js.undefined
  
  var boundingSphereOnly: js.UndefOr[Boolean] = js.undefined
  
  var computeBoundingBox: js.UndefOr[Boolean] = js.undefined
...
object AutoFixFaceOrientation {
  
  inline def apply(): AutoFixFaceOrientation = {
  ...
  extension [Self <: AutoFixFaceOrientation](x: Self) {
    ...
    inline def setAutoFixFaceOrientationUndefined: Self = StObject.set(x, "autoFixFaceOrientation", js.undefined)
    ...
    inline def setComputeBoundingBox(value: Boolean): Self = StObject.set(x, "computeBoundingBox", value.asInstanceOf[js.Any])
    
    inline def setComputeBoundingBoxUndefined: Self = StObject.set(x, "computeBoundingBox", js.undefined)
