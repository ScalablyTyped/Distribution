...
object miscCopyToolsMod {
  ...
  object CopyTools {
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Misc/copyTools", "CopyTools.GenerateBase64StringFromPixelData")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("babylonjs/Misc/copyTools", "CopyTools.GenerateBase64StringFromTextureAsync")
    @js.native
