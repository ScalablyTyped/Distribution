...
class FileTools ()
  extends StObject
     with typings.babylonjs.BABYLON.FileTools
/* static members */
object FileTools {
  ...
  /**
    ...
    */
  inline def DefaultRetryStrategy(url: String, request: typings.babylonjs.BABYLON.WebRequest, retryIndex: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("DefaultRetryStrategy")(url.asInstanceOf[js.Any], request.asInstanceOf[js.Any], retryIndex.asInstanceOf[js.Any])).asInstanceOf[Double]
