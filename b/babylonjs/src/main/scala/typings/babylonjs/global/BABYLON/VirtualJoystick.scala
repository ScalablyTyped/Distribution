...
object VirtualJoystick {
  ...
  @JSGlobal("BABYLON.VirtualJoystick.halfWidth")
  @js.native
  ...
  @JSGlobal("BABYLON.VirtualJoystick.vjCanvasContext")
  @js.native
  ...
  @JSGlobal("BABYLON.VirtualJoystick.vjCanvasHeight")
  @js.native
  ...
  @JSGlobal("BABYLON.VirtualJoystick.vjCanvasWidth")
  @js.native
