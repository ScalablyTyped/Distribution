...
object PropertyTypeForEdition extends StObject {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.BABYLON.PropertyTypeForEdition & Double] = js.native
  
  /* 0 */ val Boolean: typings.babylonjs.BABYLON.PropertyTypeForEdition.Boolean & Double = js.native
