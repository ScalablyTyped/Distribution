...
object shadowMapFragmentDeclaration {
  
  @JSGlobal("BABYLON.shadowMapFragmentDeclaration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.shadowMapFragmentDeclaration.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.shadowMapFragmentDeclaration.shader")
  @js.native
