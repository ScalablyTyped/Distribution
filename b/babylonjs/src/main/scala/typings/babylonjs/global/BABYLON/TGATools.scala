...
class TGATools ()
  extends StObject
     with typings.babylonjs.BABYLON.TGATools
/* static members */
object TGATools {
  ...
  /**
    ...
    * @hidden
    */
  inline def UploadContent(texture: typings.babylonjs.BABYLON.InternalTexture, data: Uint8Array): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("UploadContent")(texture.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
