...
object Color3 {
  ...
  /**
    ...
    * @returns a new Color3 object
    */
  inline def FromHSV(hue: Double, saturation: Double, value: Double): typings.babylonjs.BABYLON.Color3 = (^.asInstanceOf[js.Dynamic].applyDynamic("FromHSV")(hue.asInstanceOf[js.Any], saturation.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.BABYLON.Color3]
  ...
  /**
    ...
    */
  inline def Hermite(
    value1: DeepImmutable[typings.babylonjs.BABYLON.Color3],
    tangent1: DeepImmutable[typings.babylonjs.BABYLON.Color3],
    value2: DeepImmutable[typings.babylonjs.BABYLON.Color3],
    tangent2: DeepImmutable[typings.babylonjs.BABYLON.Color3],
    amount: Double
  ): typings.babylonjs.BABYLON.Color3 = (^.asInstanceOf[js.Dynamic].applyDynamic("Hermite")(value1.asInstanceOf[js.Any], tangent1.asInstanceOf[js.Any], value2.asInstanceOf[js.Any], tangent2.asInstanceOf[js.Any], amount.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.BABYLON.Color3]
  ...
  inline def Hermite1stDerivative(
    ...
    tangent2: DeepImmutable[typings.babylonjs.BABYLON.Color3],
    time: Double
  ): typings.babylonjs.BABYLON.Color3 = (^.asInstanceOf[js.Dynamic].applyDynamic("Hermite1stDerivative")(value1.asInstanceOf[js.Any], tangent1.asInstanceOf[js.Any], value2.asInstanceOf[js.Any], tangent2.asInstanceOf[js.Any], time.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.BABYLON.Color3]
