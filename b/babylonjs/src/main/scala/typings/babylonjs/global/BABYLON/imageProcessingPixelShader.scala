...
object imageProcessingPixelShader {
  
  @JSGlobal("BABYLON.imageProcessingPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.imageProcessingPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.imageProcessingPixelShader.shader")
  @js.native
