...
class WebXRMotionControllerManager ()
  extends StObject
     with typings.babylonjs.BABYLON.WebXRMotionControllerManager
/* static members */
object WebXRMotionControllerManager {
  ...
  /**
    ...
    */
  inline def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typings.babylonjs.BABYLON.Scene): js.Promise[typings.babylonjs.BABYLON.WebXRAbstractMotionController] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetMotionControllerWithXRInput")(xrInput.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.babylonjs.BABYLON.WebXRAbstractMotionController]]
  inline def GetMotionControllerWithXRInput(xrInput: XRInputSource, scene: typings.babylonjs.BABYLON.Scene, forceProfile: String): js.Promise[typings.babylonjs.BABYLON.WebXRAbstractMotionController] = (^.asInstanceOf[js.Dynamic].applyDynamic("GetMotionControllerWithXRInput")(xrInput.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], forceProfile.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.babylonjs.BABYLON.WebXRAbstractMotionController]]
