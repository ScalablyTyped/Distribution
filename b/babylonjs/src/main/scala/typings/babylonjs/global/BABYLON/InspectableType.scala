...
object InspectableType extends StObject {
  ...
  /* 6 */ val Button: typings.babylonjs.BABYLON.InspectableType.Button & Double = js.native
  ...
  /* 9 */ val FileButton: typings.babylonjs.BABYLON.InspectableType.FileButton & Double = js.native
  
  /* 7 */ val Options: typings.babylonjs.BABYLON.InspectableType.Options & Double = js.native
