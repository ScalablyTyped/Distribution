...
open class Sound protected ()
  ...
  def this(name: String, urlOrArrayBuffer: Any, scene: Nullable[typings.babylonjs.BABYLON.Scene]) = this()
  def this(
    name: String,
...
object Sound {
  ...
  /**
    ...
    */
  inline def Parse(parsedSound: Any, scene: typings.babylonjs.BABYLON.Scene, rootUrl: String): typings.babylonjs.BABYLON.Sound = (^.asInstanceOf[js.Dynamic].applyDynamic("Parse")(parsedSound.asInstanceOf[js.Any], scene.asInstanceOf[js.Any], rootUrl.asInstanceOf[js.Any])).asInstanceOf[typings.babylonjs.BABYLON.Sound]
  inline def Parse(
    parsedSound: Any,
