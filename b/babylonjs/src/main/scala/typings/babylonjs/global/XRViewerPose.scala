...
open class XRViewerPose ()
  extends StObject
     with typings.babylonjs.XRViewerPose {
  
  /* CompleteClass */
  override val emulatedPosition: Boolean = js.native
  
  /* CompleteClass */
  override val transform: typings.babylonjs.XRRigidTransform = js.native
  
  /* CompleteClass */
  override val views: js.Array[typings.babylonjs.XRView] = js.native
}
