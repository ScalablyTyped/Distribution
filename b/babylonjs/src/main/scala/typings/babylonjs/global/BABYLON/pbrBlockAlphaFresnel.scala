...
object pbrBlockAlphaFresnel {
  
  @JSGlobal("BABYLON.pbrBlockAlphaFresnel")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrBlockAlphaFresnel.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrBlockAlphaFresnel.shader")
  @js.native
