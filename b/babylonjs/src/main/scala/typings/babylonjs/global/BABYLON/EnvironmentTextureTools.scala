...
class EnvironmentTextureTools ()
  extends StObject
     with typings.babylonjs.BABYLON.EnvironmentTextureTools
/* static members */
object EnvironmentTextureTools {
  ...
  /**
    ...
    */
  inline def CreateEnvTextureAsync(texture: typings.babylonjs.BABYLON.BaseTexture): js.Promise[ArrayBuffer] = ^.asInstanceOf[js.Dynamic].applyDynamic("CreateEnvTextureAsync")(texture.asInstanceOf[js.Any]).asInstanceOf[js.Promise[ArrayBuffer]]
  ...
  /**
    ...
    * @returns a promise
    */
  inline def UploadLevelsAsync(texture: typings.babylonjs.BABYLON.InternalTexture, imageData: js.Array[js.Array[ArrayBufferView]]): js.Promise[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("UploadLevelsAsync")(texture.asInstanceOf[js.Any], imageData.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Unit]]
