...
object boundingBoxRendererPixelShader {
  ...
  @JSGlobal("BABYLON.boundingBoxRendererPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.boundingBoxRendererPixelShader.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.boundingBoxRendererPixelShader.shader")
  @js.native
