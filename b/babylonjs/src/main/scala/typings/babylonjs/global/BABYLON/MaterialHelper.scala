...
open class MaterialHelper ()
  extends StObject
     with typings.babylonjs.BABYLON.MaterialHelper
/* static members */
object MaterialHelper {
  ...
  inline def BindBonesParameters(mesh: Unit, effect: Unit, prePassConfiguration: typings.babylonjs.BABYLON.PrePassConfiguration): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any], prePassConfiguration.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def BindBonesParameters(mesh: Unit, effect: typings.babylonjs.BABYLON.Effect): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def BindBonesParameters(mesh: typings.babylonjs.BABYLON.AbstractMesh): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def BindBonesParameters(
    mesh: typings.babylonjs.BABYLON.AbstractMesh,
    effect: Unit,
    prePassConfiguration: typings.babylonjs.BABYLON.PrePassConfiguration
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any], prePassConfiguration.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def BindBonesParameters(mesh: typings.babylonjs.BABYLON.AbstractMesh, effect: typings.babylonjs.BABYLON.Effect): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindBonesParameters")(mesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def BindBonesParameters(
    mesh: typings.babylonjs.BABYLON.AbstractMesh,
    effect: typings.babylonjs.BABYLON.Effect,
    prePassConfiguration: typings.babylonjs.BABYLON.PrePassConfiguration
  ...
  /**
    ...
    */
  inline def BindClipPlane(effect: typings.babylonjs.BABYLON.Effect, scene: typings.babylonjs.BABYLON.Scene): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindClipPlane")(effect.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def BindLogDepth(defines: Any, effect: typings.babylonjs.BABYLON.Effect, scene: typings.babylonjs.BABYLON.Scene): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindLogDepth")(defines.asInstanceOf[js.Any], effect.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param effect The effect we are binding the data to
    */
  inline def BindMorphTargetParameters(abstractMesh: typings.babylonjs.BABYLON.AbstractMesh, effect: typings.babylonjs.BABYLON.Effect): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindMorphTargetParameters")(abstractMesh.asInstanceOf[js.Any], effect.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def BindSceneUniformBuffer(effect: typings.babylonjs.BABYLON.Effect, sceneUbo: typings.babylonjs.BABYLON.UniformBuffer): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("BindSceneUniformBuffer")(effect.asInstanceOf[js.Any], sceneUbo.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def GetFogState(mesh: typings.babylonjs.BABYLON.AbstractMesh, scene: typings.babylonjs.BABYLON.Scene): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("GetFogState")(mesh.asInstanceOf[js.Any], scene.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def HandleFallbacksForShadows(defines: Any, fallbacks: typings.babylonjs.BABYLON.EffectFallbacks): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("HandleFallbacksForShadows")(defines.asInstanceOf[js.Any], fallbacks.asInstanceOf[js.Any])).asInstanceOf[Double]
  inline def HandleFallbacksForShadows(defines: Any, fallbacks: typings.babylonjs.BABYLON.EffectFallbacks, maxSimultaneousLights: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("HandleFallbacksForShadows")(defines.asInstanceOf[js.Any], fallbacks.asInstanceOf[js.Any], maxSimultaneousLights.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def PrepareAttributesForInstances(attribs: js.Array[String], defines: typings.babylonjs.BABYLON.MaterialDefines): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareAttributesForInstances")(attribs.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The current Defines of the effect
    */
  inline def PrepareAttributesForMorphTargets(attribs: js.Array[String], mesh: typings.babylonjs.BABYLON.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareAttributesForMorphTargets")(attribs.asInstanceOf[js.Any], mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def PrepareAttributesForMorphTargetsInfluencers(attribs: js.Array[String], mesh: typings.babylonjs.BABYLON.AbstractMesh, influencers: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareAttributesForMorphTargetsInfluencers")(attribs.asInstanceOf[js.Any], mesh.asInstanceOf[js.Any], influencers.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForBakedVertexAnimation(mesh: typings.babylonjs.BABYLON.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForBakedVertexAnimation")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForBones(mesh: typings.babylonjs.BABYLON.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForBones")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param key The channel key "diffuse", "specular"... used in the shader
    */
  inline def PrepareDefinesForMergedUV(texture: typings.babylonjs.BABYLON.BaseTexture, defines: Any, key: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMergedUV")(texture.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForMorphTargets(mesh: typings.babylonjs.BABYLON.AbstractMesh, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMorphTargets")(mesh.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    * @param defines The defines to update
    */
  inline def PrepareDefinesForMultiview(scene: typings.babylonjs.BABYLON.Scene, defines: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForMultiview")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def PrepareDefinesForOIT(scene: typings.babylonjs.BABYLON.Scene, defines: Any, needAlphaBlending: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForOIT")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], needAlphaBlending.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def PrepareDefinesForPrePass(scene: typings.babylonjs.BABYLON.Scene, defines: Any, canRenderToMRT: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("PrepareDefinesForPrePass")(scene.asInstanceOf[js.Any], defines.asInstanceOf[js.Any], canRenderToMRT.asInstanceOf[js.Any])).asInstanceOf[Unit]
