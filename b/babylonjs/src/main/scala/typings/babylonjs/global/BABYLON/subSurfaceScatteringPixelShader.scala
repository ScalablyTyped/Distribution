...
object subSurfaceScatteringPixelShader {
  ...
  @JSGlobal("BABYLON.subSurfaceScatteringPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.subSurfaceScatteringPixelShader.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.subSurfaceScatteringPixelShader.shader")
  @js.native
