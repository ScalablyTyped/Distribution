...
class DefaultRenderingPipeline ()
  ...
  def this(name: js.UndefOr[scala.Nothing], hdr: Boolean, scene: typings.babylonjs.BABYLON.Scene) = this()
  def this(name: String, hdr: js.UndefOr[scala.Nothing], scene: typings.babylonjs.BABYLON.Scene) = this()
