...
object pbrBlockAmbientOcclusion {
  
  @JSGlobal("BABYLON.pbrBlockAmbientOcclusion")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrBlockAmbientOcclusion.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrBlockAmbientOcclusion.shader")
  @js.native
