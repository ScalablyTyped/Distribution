...
object pbrVertexDeclaration {
  
  @JSGlobal("BABYLON.pbrVertexDeclaration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrVertexDeclaration.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrVertexDeclaration.shader")
  @js.native
