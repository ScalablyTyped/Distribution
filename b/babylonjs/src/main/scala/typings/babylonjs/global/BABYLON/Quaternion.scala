...
import typings.babylonjs.anon.DeepImmutableObjectQuaterAsArray
...
object Quaternion {
  ...
  /**
    ...
    */
  inline def FromArrayToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](array: DeepImmutable[ArrayLike[Double]], offset: Double, result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("FromArrayToRef")(array.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    */
  inline def FromEulerAnglesToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](x: Double, y: Double, z: Double, result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("FromEulerAnglesToRef")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    * @returns the updated quaternion
    */
  inline def FromEulerVectorToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](vec: DeepImmutable[typings.babylonjs.BABYLON.Vector3], result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("FromEulerVectorToRef")(vec.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    * @returns result input
    */
  inline def FromLookDirectionLHToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
    forward: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    up: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    ref: T
  ...
  /**
    ...
    * @returns result input
    */
  inline def FromLookDirectionRHToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
    forward: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    up: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    ref: T
  ...
  /**
    ...
    * @returns result input
    */
  inline def FromRotationMatrixToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](matrix: DeepImmutable[typings.babylonjs.BABYLON.Matrix], result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("FromRotationMatrixToRef")(matrix.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    * @returns the updated quaternion
    */
  inline def FromUnitVectorsToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
  ...
  /**
    ...
    */
  inline def Hermite[T /* <: typings.babylonjs.BABYLON.Quaternion */](
  ...
  /**
    ...
    */
  inline def Hermite1stDerivative[T /* <: typings.babylonjs.BABYLON.Quaternion */](
    value1: DeepImmutable[T],
    tangent1: DeepImmutable[typings.babylonjs.BABYLON.Quaternion],
    value2: DeepImmutable[typings.babylonjs.BABYLON.Quaternion],
    tangent2: DeepImmutable[typings.babylonjs.BABYLON.Quaternion],
  ...
  /**
    ...
    * @returns result input
    */
  inline def Hermite1stDerivativeToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
  ...
  /**
    ...
    */
  inline def Inverse[T /* <: typings.babylonjs.BABYLON.Quaternion */](q: DeepImmutable[T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("Inverse")(q.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  /**
    ...
    */
  inline def InverseToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](q: typings.babylonjs.BABYLON.Quaternion, result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("InverseToRef")(q.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    */
  inline def RotationAxisToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](axis: DeepImmutable[typings.babylonjs.BABYLON.Vector3], angle: Double, result: T): T = (^.asInstanceOf[js.Dynamic].applyDynamic("RotationAxisToRef")(axis.asInstanceOf[js.Any], angle.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  /**
    ...
    * @returns result input
    */
  inline def RotationQuaternionFromAxisToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
    axis1: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    axis2: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    axis3: DeepImmutable[typings.babylonjs.BABYLON.Vector3],
    ref: T
  ...
  ): DeepImmutableObjectQuaterAsArray = (^.asInstanceOf[js.Dynamic].applyDynamic("RotationQuaternionFromOnto")(fromVector.asInstanceOf[js.Any], toVector.asInstanceOf[js.Any])).asInstanceOf[DeepImmutableObjectQuaterAsArray]
  ...
  ): DeepImmutableObjectQuaterAsArray = (^.asInstanceOf[js.Dynamic].applyDynamic("RotationQuaternionFromOntoToRef")(fromVector.asInstanceOf[js.Any], toVector.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[DeepImmutableObjectQuaterAsArray]
  ...
  /**
    ...
    * @returns result input
    */
  inline def SlerpToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
    left: DeepImmutable[typings.babylonjs.BABYLON.Quaternion],
    right: DeepImmutable[typings.babylonjs.BABYLON.Quaternion],
    amount: Double,
    result: T
  ...
  /**
    ...
    */
  inline def SmoothToRef[T /* <: typings.babylonjs.BABYLON.Quaternion */](
