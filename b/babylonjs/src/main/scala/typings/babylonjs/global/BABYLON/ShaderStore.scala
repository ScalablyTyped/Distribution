...
open class ShaderStore ()
  extends StObject
     with typings.babylonjs.BABYLON.ShaderStore
/* static members */
object ShaderStore {
  ...
  inline def GetIncludesShadersStore(shaderLanguage: typings.babylonjs.BABYLON.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetIncludesShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
  ...
  inline def GetShadersRepository(shaderLanguage: typings.babylonjs.BABYLON.ShaderLanguage): String = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersRepository")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def GetShadersStore(shaderLanguage: typings.babylonjs.BABYLON.ShaderLanguage): org.scalablytyped.runtime.StringDictionary[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("GetShadersStore")(shaderLanguage.asInstanceOf[js.Any]).asInstanceOf[org.scalablytyped.runtime.StringDictionary[String]]
