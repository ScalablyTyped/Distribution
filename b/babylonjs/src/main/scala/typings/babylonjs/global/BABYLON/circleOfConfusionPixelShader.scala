...
object circleOfConfusionPixelShader {
  
  @JSGlobal("BABYLON.circleOfConfusionPixelShader")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.circleOfConfusionPixelShader.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.circleOfConfusionPixelShader.shader")
  @js.native
