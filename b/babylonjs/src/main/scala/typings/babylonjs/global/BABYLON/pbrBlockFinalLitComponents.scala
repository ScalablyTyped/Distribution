...
object pbrBlockFinalLitComponents {
  
  @JSGlobal("BABYLON.pbrBlockFinalLitComponents")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrBlockFinalLitComponents.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrBlockFinalLitComponents.shader")
  @js.native
