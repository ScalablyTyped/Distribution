...
object pbrBlockFinalColorComposition {
  ...
  @JSGlobal("BABYLON.pbrBlockFinalColorComposition")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrBlockFinalColorComposition.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrBlockFinalColorComposition.shader")
  @js.native
