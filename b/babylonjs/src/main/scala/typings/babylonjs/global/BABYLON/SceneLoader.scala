...
object SceneLoader extends js.Object {
  ...
  def Append(
    ...
    onProgress: js.UndefOr[
      Nullable[
        js.Function1[/* event */ typings.babylonjs.BABYLON.SceneLoaderProgressEvent, Unit]
      ]
    ],
    onError: js.UndefOr[
      Nullable[
        js.Function3[/* scene */ typings.babylonjs.BABYLON.Scene, /* message */ String, js.UndefOr[_], Unit]
      ]
    ],
