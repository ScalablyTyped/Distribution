...
object pbrFragmentSamplersDeclaration {
  
  @JSGlobal("BABYLON.pbrFragmentSamplersDeclaration")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("BABYLON.pbrFragmentSamplersDeclaration.name")
  @js.native
  def name: String = js.native
  @scala.inline
  def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  @JSGlobal("BABYLON.pbrFragmentSamplersDeclaration.shader")
  @js.native
