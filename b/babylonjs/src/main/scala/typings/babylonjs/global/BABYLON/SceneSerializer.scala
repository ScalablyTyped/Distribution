...
object SceneSerializer {
  ...
  /**
    ...
    */
  inline def Serialize(scene: typings.babylonjs.BABYLON.Scene): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("Serialize")(scene.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  /**
    ...
    */
  inline def SerializeAsync(scene: typings.babylonjs.BABYLON.Scene): js.Promise[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("SerializeAsync")(scene.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Any]]
