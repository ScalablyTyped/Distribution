...
@JSGlobal("BABYLON.DumpTools")
@js.native
open class DumpTools ()
  extends StObject
     with typings.babylonjs.BABYLON.DumpTools
/* static members */
object DumpTools {
  ...
  @JSGlobal("BABYLON.DumpTools._CreateDumpRenderer")
  @js.native
  ...
  @JSGlobal("BABYLON.DumpTools._DumpToolsEngine")
  @js.native
