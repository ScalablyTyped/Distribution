...
open class Geometry protected ()
  extends typings.babylonjs.meshesGeometryMod.Geometry {
  /**
  ...
  def this(id: String, scene: Scene, vertexData: typings.babylonjs.meshesMeshDotvertexDataMod.VertexData) = this()
