...
import typings.babylonjs.renderingFluidRendererFluidRenderingTexturesMod.FluidRenderingTextures
...
object renderingFluidRendererFluidRenderingTargetRendererMod {
  
  @js.native
  sealed trait FluidRenderingDebug extends StObject
  @JSImport("babylonjs/Rendering/fluidRenderer/fluidRenderingTargetRenderer", "FluidRenderingDebug")
  @js.native
  object FluidRenderingDebug extends StObject {
    
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[FluidRenderingDebug & Double] = js.native
    
    @js.native
    sealed trait DepthBlurredTexture
      extends StObject
         with FluidRenderingDebug
    ...
    @js.native
    sealed trait ThicknessBlurredTexture
      extends StObject
         with FluidRenderingDebug
  ...
  @JSImport("babylonjs/Rendering/fluidRenderer/fluidRenderingTargetRenderer", "FluidRenderingTargetRenderer")
  @js.native
  open class FluidRenderingTargetRenderer protected () extends StObject {
    /**
