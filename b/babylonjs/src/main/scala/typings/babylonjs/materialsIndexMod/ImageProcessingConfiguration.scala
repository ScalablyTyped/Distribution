...
object ImageProcessingConfiguration {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "ImageProcessingConfiguration.TONEMAPPING_ACES")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "ImageProcessingConfiguration.TONEMAPPING_STANDARD")
  @js.native
