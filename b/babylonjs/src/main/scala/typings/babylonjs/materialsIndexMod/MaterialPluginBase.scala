...
@JSImport("babylonjs/Materials/index", "MaterialPluginBase")
@js.native
open class MaterialPluginBase protected ()
  extends typings.babylonjs.materialsMaterialPluginBaseMod.MaterialPluginBase {
  /**
