...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    @scala.inline
    def apply(): typings.babylonjs.materialsIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
    ...
    @scala.inline
    implicit class BaseTextureMutableBuilder[Self <: typings.babylonjs.materialsIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture] (val x: Self) extends AnyVal {
