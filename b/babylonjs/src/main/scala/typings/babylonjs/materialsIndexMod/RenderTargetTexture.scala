...
object RenderTargetTexture {
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "RenderTargetTexture.REFRESHRATE_RENDER_ONCE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("babylonjs/Materials/index", "RenderTargetTexture.REFRESHRATE_RENDER_ONEVERYTWOFRAMES")
  @js.native
