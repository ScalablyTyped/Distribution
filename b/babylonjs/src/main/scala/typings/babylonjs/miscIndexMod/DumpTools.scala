...
@JSImport("babylonjs/Misc/index", "DumpTools")
@js.native
open class DumpTools ()
  extends typings.babylonjs.miscDumpToolsMod.DumpTools
/* static members */
object DumpTools {
  ...
  @JSImport("babylonjs/Misc/index", "DumpTools._CreateDumpRenderer")
  @js.native
  ...
  @JSImport("babylonjs/Misc/index", "DumpTools._DumpToolsEngine")
  @js.native
