...
object ErrorCodes {
  ...
  @JSImport("babylonjs/Misc/index", "ErrorCodes.GLTFLoaderUnexpectedMagicError")
  @js.native
  val GLTFLoaderUnexpectedMagicError: `2000` = js.native
  
  /** Load file error */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.LoadFileError")
  @js.native
  val LoadFileError: `4000` = js.native
  
  /** Invalid or empty mesh vertex positions. */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.MeshInvalidPositionsError")
  @js.native
  val MeshInvalidPositionsError: `0` = js.native
  
  /** Read file error */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.ReadFileError")
  @js.native
  val ReadFileError: `4002` = js.native
  
  /** Request file error */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.RequestFileError")
  @js.native
  val RequestFileError: `4001` = js.native
  
  /** SceneLoader generic error code. Ideally wraps the inner exception. */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.SceneLoaderError")
  @js.native
  val SceneLoaderError: `3000` = js.native
  
  /** Unsupported texture found. */
  @JSImport("babylonjs/Misc/index", "ErrorCodes.UnsupportedTextureError")
  @js.native
