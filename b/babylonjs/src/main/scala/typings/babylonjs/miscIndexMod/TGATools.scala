...
@js.native
class TGATools ()
  extends typings.babylonjs.tgaMod.TGATools
/* static members */
object TGATools {
  ...
  /**
    ...
    * @hidden
    */
  inline def UploadContent(texture: InternalTexture, data: Uint8Array): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("UploadContent")(texture.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
