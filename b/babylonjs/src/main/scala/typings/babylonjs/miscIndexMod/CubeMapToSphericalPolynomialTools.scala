...
object CubeMapToSphericalPolynomialTools {
  ...
  /** @internal */
  @JSImport("babylonjs/Misc/index", "CubeMapToSphericalPolynomialTools.MAX_HDRI_VALUE")
  @js.native
  ...
  /** @internal */
  @JSImport("babylonjs/Misc/index", "CubeMapToSphericalPolynomialTools.PRESERVE_CLAMPED_COLORS")
  @js.native
