...
@JSImport("babylonjs/Misc/index", "InspectableType")
@js.native
object InspectableType extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.babylonjs.iInspectableMod.InspectableType & Double] = js.native
  
  /* 6 */ val Button: typings.babylonjs.iInspectableMod.InspectableType.Button & Double = js.native
  ...
  /* 9 */ val FileButton: typings.babylonjs.iInspectableMod.InspectableType.FileButton & Double = js.native
  
  /* 7 */ val Options: typings.babylonjs.iInspectableMod.InspectableType.Options & Double = js.native
  ...
  /* 8 */ val Tab: typings.babylonjs.iInspectableMod.InspectableType.Tab & Double = js.native
