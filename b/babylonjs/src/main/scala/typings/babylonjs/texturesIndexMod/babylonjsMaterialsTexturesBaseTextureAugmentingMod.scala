...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    inline def apply(forceSphericalPolynomialsRecompute: () => Unit): typings.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
