...
object babylonjsMaterialsTexturesBaseTextureAugmentingMod {
  ...
  object BaseTexture {
    ...
    @scala.inline
    def apply(): typings.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture = {
    ...
    @scala.inline
    implicit class BaseTextureMutableBuilder[Self <: typings.babylonjs.texturesIndexMod.babylonjsMaterialsTexturesBaseTextureAugmentingMod.BaseTexture] (val x: Self) extends AnyVal {
