...
class SphereGeometry protected ()
  extends babylonjsLib.BABYLONNs.SphereGeometry {
  /**
  ...
  segments: scala.Double, /**
           * Defines the diameter of the sphere
           */
  diameter: scala.Double, canBeRegenerated: scala.Boolean, mesh: babylonjsLib.BABYLONNs.Nullable[babylonjsLib.BABYLONNs.Mesh]) = this()
  /**
           * Create a new sphere geometry
           * @param id defines the unique ID of the geometry
           * @param scene defines the hosting scene
  ...
  segments: scala.Double, /**
           * Defines the diameter of the sphere
           */
  diameter: scala.Double, canBeRegenerated: scala.Boolean, mesh: babylonjsLib.BABYLONNs.Nullable[babylonjsLib.BABYLONNs.Mesh], /**
