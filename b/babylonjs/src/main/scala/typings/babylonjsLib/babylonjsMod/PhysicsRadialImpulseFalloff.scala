...
object PhysicsRadialImpulseFalloff extends js.Object {
  /* 0 */ val Constant: babylonjsLib.BABYLONNs.PhysicsRadialImpulseFalloff.Constant with scala.Double = js.native
  /* 1 */ val Linear: babylonjsLib.BABYLONNs.PhysicsRadialImpulseFalloff.Linear with scala.Double = js.native
  @JSBracketAccess
