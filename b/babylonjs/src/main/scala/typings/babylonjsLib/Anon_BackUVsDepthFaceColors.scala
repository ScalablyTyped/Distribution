...
trait Anon_BackUVsDepthFaceColors extends js.Object {
...
object Anon_BackUVsDepthFaceColors {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_BackUVsDepthFaceColors]
  }
}
