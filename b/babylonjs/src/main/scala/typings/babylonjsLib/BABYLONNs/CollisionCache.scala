...
class CollisionCache () extends js.Object {
  ...
  def getGeometries(): ScalablyTyped.runtime.NumberDictionary[SerializedGeometry] = js.native
  def getGeometry(id: java.lang.String): SerializedGeometry = js.native
  def getMesh(id: js.Any): SerializedMesh = js.native
  def getMeshes(): ScalablyTyped.runtime.NumberDictionary[SerializedMesh] = js.native
