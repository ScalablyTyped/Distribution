...
object IAudioEngine {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(WarnedWebAudioUnsupported = WarnedWebAudioUnsupported, audioContext = audioContext.asInstanceOf[js.Any], canUseWebAudio = canUseWebAudio, dispose = js.Any.fromFunction0(dispose), isMP3supported = isMP3supported, isOGGsupported = isOGGsupported, lock = js.Any.fromFunction0(lock), masterGain = masterGain, onAudioLockedObservable = onAudioLockedObservable, onAudioUnlockedObservable = onAudioUnlockedObservable, unlock = js.Any.fromFunction0(unlock), unlocked = unlocked, useCustomUnlockedButton = useCustomUnlockedButton)
