...
class DracoCompression () extends IDisposable {
  def decodeMeshAsync(data: stdLib.ArrayBufferView, attributes: org.scalablytyped.runtime.StringDictionary[scala.Double]): js.Promise[VertexData] = js.native
  /**
    ...
    */
  def decodeMeshAsync(data: stdLib.ArrayBuffer, attributes: org.scalablytyped.runtime.StringDictionary[scala.Double]): js.Promise[VertexData] = js.native
  /**
