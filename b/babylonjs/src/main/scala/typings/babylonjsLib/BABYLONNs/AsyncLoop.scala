...
class AsyncLoop protected () extends js.Object {
  ...
  def this(/**
    ...
    */
  iterations: scala.Double, func: js.Function1[/* asyncLoop */ AsyncLoop, scala.Unit], successCallback: js.Function0[scala.Unit]) = this()
  def this(/**
    * Defines the number of iterations for the loop
    */
  iterations: scala.Double, func: js.Function1[/* asyncLoop */ AsyncLoop, scala.Unit], successCallback: js.Function0[scala.Unit], offset: scala.Double) = this()
  ...
  /**
    ...
    */
  def breakLoop(): scala.Unit = js.native
  /**
