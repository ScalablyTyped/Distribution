...
trait Anon_BackUVsCustomFaceColors extends js.Object {
...
object Anon_BackUVsCustomFaceColors {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_BackUVsCustomFaceColors]
  }
}
