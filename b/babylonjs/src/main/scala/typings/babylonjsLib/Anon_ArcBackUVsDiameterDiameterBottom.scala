...
trait Anon_ArcBackUVsDiameterDiameterBottom extends js.Object {
...
object Anon_ArcBackUVsDiameterDiameterBottom {
  @scala.inline
  def apply(
  ...
  ): Anon_ArcBackUVsDiameterDiameterBottom = {
    ...
    __obj.asInstanceOf[Anon_ArcBackUVsDiameterDiameterBottom]
  }
}
