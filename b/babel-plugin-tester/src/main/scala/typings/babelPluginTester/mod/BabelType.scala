...
trait BabelType extends js.Object {
  ...
  def traverse(
    ...
    parentPath: js.UndefOr[NodePath[typings.babelTypes.mod.Node]]
  ): Unit = js.native
  def traverse[S](
  ...
  def traverse[S](
    ...
    scope: js.UndefOr[scala.Nothing],
    state: S,
    parentPath: NodePath[typings.babelTypes.mod.Node]
  ): Unit = js.native
  def traverse[S](parent: js.UndefOr[typings.babelTypes.mod.Node], opts: TraverseOptions[S], scope: Scope, state: S): Unit = js.native
  def traverse[S](
    parent: js.UndefOr[typings.babelTypes.mod.Node],
    opts: TraverseOptions[S],
    scope: Scope,
  ...
  def traverse[S](parent: js.Array[typings.babelTypes.mod.Node], opts: TraverseOptions[S], scope: Scope, state: S): Unit = js.native
  def traverse[S](
    parent: js.Array[typings.babelTypes.mod.Node],
    opts: TraverseOptions[S],
    scope: Scope,
