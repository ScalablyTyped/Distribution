...
object Model extends js.Object {
  var NoRowsDeletedError: Error[typings.std.Error] = js.native
  var NoRowsUpdatedError: Error[typings.std.Error] = js.native
  ...
  var NotFoundError: Error[typings.std.Error] = js.native
