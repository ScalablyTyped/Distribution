...
abstract class CollectionBase[T /* <: Model[_] */] () extends Events[T] {
  ...
  def countBy(predicate: String): js.Any = js.native
  def countBy(predicate: String, thisArg: js.Any): js.Any = js.native
  def countBy(
    predicate: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Lodash.ListIterator<T, boolean> */ js.Any
  ): js.Any = js.native
  def countBy(
  ...
  @JSName("countBy")
  def countBy_R_Object[R /* <: js.Object */](): js.Any = js.native
  ...
  def groupBy(predicate: String): js.Any = js.native
  def groupBy(predicate: String, thisArg: js.Any): js.Any = js.native
  def groupBy(
    predicate: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify Lodash.ListIterator<T, boolean> */ js.Any
  ): js.Any = js.native
  def groupBy(
  ...
  @JSName("groupBy")
  def groupBy_R_Object[R /* <: js.Object */](): js.Any = js.native
