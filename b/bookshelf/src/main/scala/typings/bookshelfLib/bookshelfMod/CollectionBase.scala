...
abstract class CollectionBase[T /* <: Model[_] */] () extends Events[T] {
  ...
  def all(
    predicate: (lodashLib.lodashMod.DictionaryIterator[T, scala.Boolean]) | (lodashLib.lodashMod.ListIterator[T, scala.Boolean])
  ...
  def chain(): lodashLib.lodashMod.LoDashExplicitObjectWrapper[T] = js.native
  ...
  def countBy(): lodashLib.lodashMod.Dictionary[scala.Double] = js.native
  def countBy(
    predicate: (lodashLib.lodashMod.DictionaryIterator[T, scala.Boolean]) | (lodashLib.lodashMod.ListIterator[T, scala.Boolean])
  ...
  def countBy(predicate: java.lang.String): lodashLib.lodashMod.Dictionary[scala.Double] = js.native
  def countBy(predicate: java.lang.String, thisArg: js.Any): lodashLib.lodashMod.Dictionary[scala.Double] = js.native
  def countBy[R /* <: js.Object */](predicate: R): lodashLib.lodashMod.Dictionary[scala.Double] = js.native
  @JSName("countBy")
  def countBy_RObject[R /* <: js.Object */](): lodashLib.lodashMod.Dictionary[scala.Double] = js.native
  ...
  def each(callback: lodashLib.lodashMod.ObjectIterator[T, scala.Unit]): T = js.native
  def each(callback: lodashLib.lodashMod.ObjectIterator[T, scala.Unit], thisArg: js.Any): T = js.native
  @JSName("each")
  def each_Dictionary(): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("each")
  def each_Dictionary(callback: lodashLib.lodashMod.DictionaryIterator[T, scala.Unit]): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("each")
  def each_Dictionary(callback: lodashLib.lodashMod.DictionaryIterator[T, scala.Unit], thisArg: js.Any): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("each")
  def each_List(): lodashLib.lodashMod.List[T] = js.native
  @JSName("each")
  def each_List(callback: lodashLib.lodashMod.ListIterator[T, scala.Unit]): lodashLib.lodashMod.List[T] = js.native
  @JSName("each")
  def each_List(callback: lodashLib.lodashMod.ListIterator[T, scala.Unit], thisArg: js.Any): lodashLib.lodashMod.List[T] = js.native
  ...
  def foldl[R](callback: lodashLib.lodashMod.MemoIterator[T, R]): R = js.native
  def foldl[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R): R = js.native
  def foldl[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R, thisArg: js.Any): R = js.native
  def foldr[R](): R = js.native
  def foldr[R](callback: lodashLib.lodashMod.MemoIterator[T, R]): R = js.native
  def foldr[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R): R = js.native
  def foldr[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R, thisArg: js.Any): R = js.native
  def forEach(): T = js.native
  def forEach(callback: lodashLib.lodashMod.ObjectIterator[T, scala.Unit]): T = js.native
  def forEach(callback: lodashLib.lodashMod.ObjectIterator[T, scala.Unit], thisArg: js.Any): T = js.native
  @JSName("forEach")
  def forEach_Dictionary(): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("forEach")
  def forEach_Dictionary(callback: lodashLib.lodashMod.DictionaryIterator[T, scala.Unit]): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("forEach")
  def forEach_Dictionary(callback: lodashLib.lodashMod.DictionaryIterator[T, scala.Unit], thisArg: js.Any): lodashLib.lodashMod.Dictionary[T] = js.native
  @JSName("forEach")
  def forEach_List(): lodashLib.lodashMod.List[T] = js.native
  @JSName("forEach")
  def forEach_List(callback: lodashLib.lodashMod.ListIterator[T, scala.Unit]): lodashLib.lodashMod.List[T] = js.native
  @JSName("forEach")
  def forEach_List(callback: lodashLib.lodashMod.ListIterator[T, scala.Unit], thisArg: js.Any): lodashLib.lodashMod.List[T] = js.native
  def get(id: js.Any): T = js.native
  def groupBy(): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  def groupBy(
    predicate: (lodashLib.lodashMod.DictionaryIterator[T, scala.Boolean]) | (lodashLib.lodashMod.ListIterator[T, scala.Boolean])
  ): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  def groupBy(
    predicate: (lodashLib.lodashMod.DictionaryIterator[T, scala.Boolean]) | (lodashLib.lodashMod.ListIterator[T, scala.Boolean]),
    thisArg: js.Any
  ): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  def groupBy(predicate: java.lang.String): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  def groupBy(predicate: java.lang.String, thisArg: js.Any): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  def groupBy[R /* <: js.Object */](predicate: R): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  @JSName("groupBy")
  def groupBy_RObject[R /* <: js.Object */](): lodashLib.lodashMod.Dictionary[js.Array[T]] = js.native
  ...
  def inject[R](callback: lodashLib.lodashMod.MemoIterator[T, R]): R = js.native
  def inject[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R): R = js.native
  def inject[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R, thisArg: js.Any): R = js.native
  ...
  def map[U](
    predicate: (lodashLib.lodashMod.DictionaryIterator[T, U]) | (lodashLib.lodashMod.ListIterator[T, U])
  ...
  def max(predicate: lodashLib.lodashMod.ListIterator[T, scala.Boolean]): T = js.native
  def max(predicate: lodashLib.lodashMod.ListIterator[T, scala.Boolean], thisArg: js.Any): T = js.native
  ...
  def min(predicate: lodashLib.lodashMod.ListIterator[T, scala.Boolean]): T = js.native
  def min(predicate: lodashLib.lodashMod.ListIterator[T, scala.Boolean], thisArg: js.Any): T = js.native
  ...
  def reduce[R](callback: lodashLib.lodashMod.MemoIterator[T, R]): R = js.native
  def reduce[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R): R = js.native
  def reduce[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R, thisArg: js.Any): R = js.native
  def reduceRight[R](): R = js.native
  def reduceRight[R](callback: lodashLib.lodashMod.MemoIterator[T, R]): R = js.native
  def reduceRight[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R): R = js.native
  def reduceRight[R](callback: lodashLib.lodashMod.MemoIterator[T, R], accumulator: R, thisArg: js.Any): R = js.native
  def reduceThen[R](
