...
trait Collection[T /* <: Model[_] */] extends CollectionBase[T] {
  ...
  def create(model: org.scalablytyped.runtime.StringDictionary[js.Any]): bluebirdLib.bluebirdMod.namespaced[T] = js.native
  def create(model: org.scalablytyped.runtime.StringDictionary[js.Any], options: CollectionCreateOptions): bluebirdLib.bluebirdMod.namespaced[T] = js.native
