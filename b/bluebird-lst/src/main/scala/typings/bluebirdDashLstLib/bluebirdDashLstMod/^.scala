...
object ^ extends js.Object {
  /**
    ...
    * If promise cancellation is enabled, passed in function will receive one more function argument `onCancel` that allows to register an optional cancellation callback.
    */
  var Promise: bluebirdDashLstLib.TypeofClassBluebird = js.native
  /**
  ...
  /**
    ...
    */
  def getNewLibraryCopy(): bluebirdDashLstLib.TypeofClassBluebird = js.native
  /**
  ...
  /**
    ...
    */
  def noConflict(): bluebirdDashLstLib.TypeofClassBluebird = js.native
  /**
  ...
  def props[T](`object`: js.Thenable[ResolvableProps[T]]): Bluebird[T] = js.native
   // tslint:disable-line:unified-signatures
  // map
  def props[K, V](map: stdLib.Map[K, js.Thenable[V] | V]): Bluebird[stdLib.Map[K, V]] = js.native
  /**
  ...
  @JSName("props")
  def props_KV[K, V](map: js.Thenable[stdLib.Map[K, js.Thenable[V] | V]]): Bluebird[stdLib.Map[K, V]] = js.native
  ...
  def some[R](values: js.Array[js.Thenable[R] | R], count: scala.Double): Bluebird[js.Array[R]] = js.native
  /**
    ...
    * *The original array is not modified.*
    */
  def some[R](values: js.Thenable[js.Array[js.Thenable[R] | R]], count: scala.Double): Bluebird[js.Array[R]] = js.native
  /**
