...
trait Anon_TimeoutError extends js.Object {
  ...
  /**
     ...
     */
  def getNewLibraryCopy(): /* import warning: Failed type conversion: TsTypeQuery(TsQIdent(List(TsIdentLibrarySimple(bluebird-lst), TsIdentModule(None,List(bluebird-lst)), TsIdentNamespace(Bluebird)))) */js.Any
  /**
     * This is relevant to browser environments with no module loader.
     *
     * Release control of the Promise namespace to whatever it was before this library was loaded. Returns a reference to the library namespace so you can attach it to something else.
     */
  def noConflict(): /* import warning: Failed type conversion: TsTypeQuery(TsQIdent(List(TsIdentLibrarySimple(bluebird-lst), TsIdentModule(None,List(bluebird-lst)), TsIdentNamespace(Bluebird)))) */js.Any
  /**
