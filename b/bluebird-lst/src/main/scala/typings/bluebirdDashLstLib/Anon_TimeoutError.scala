...
trait Anon_TimeoutError extends js.Object {
  ...
  var Disposer: org.scalablytyped.runtime.Instantiable0[
    bluebirdDashLstLib.bluebirdDashLstMod.BluebirdNs.Disposer[
  ...
  /**
    ...
    */
  def getNewLibraryCopy(): /* import warning: ImportType.apply Failed type conversion: typeof bluebird-lst.bluebird-lst.Bluebird */ js.Any
  /**
    * This is relevant to browser environments with no module loader.
    *
    * Release control of the Promise namespace to whatever it was before this library was loaded. Returns a reference to the library namespace so you can attach it to something else.
    */
  def noConflict(): /* import warning: ImportType.apply Failed type conversion: typeof bluebird-lst.bluebird-lst.Bluebird */ js.Any
  /**
