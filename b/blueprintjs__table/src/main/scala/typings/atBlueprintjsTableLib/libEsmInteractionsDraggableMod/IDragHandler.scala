...
trait IDragHandler extends js.Object {
  /**
    ...
    */
  var onActivate: js.UndefOr[js.Function1[/* event */ stdLib.MouseEvent, scala.Boolean]] = js.undefined
  /**
  ...
  /**
    ...
    * event.
    */
  var onDoubleClick: js.UndefOr[js.Function1[/* event */ stdLib.MouseEvent, scala.Unit]] = js.undefined
  /**
    * Called when the mouse is released iff the mouse was dragged after
    * activation.
    */
  var onDragEnd: js.UndefOr[
    js.Function2[/* event */ stdLib.MouseEvent, /* coords */ ICoordinateData, scala.Unit]
  ] = js.undefined
  /**
