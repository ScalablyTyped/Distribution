...
class Table protected ()
  extends atBlueprintjsTableLib.libEsmTableMod.Table {
  def this(props: atBlueprintjsTableLib.libEsmTableMod.ITableProps) = this()
  def this(props: atBlueprintjsTableLib.libEsmTableMod.ITableProps, context: js.Any) = this()
}
