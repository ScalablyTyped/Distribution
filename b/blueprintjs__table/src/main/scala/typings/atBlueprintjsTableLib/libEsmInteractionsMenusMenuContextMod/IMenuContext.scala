...
trait IMenuContext extends js.Object {
  /**
    ...
    */
  def getRegions(): js.Array[atBlueprintjsTableLib.libEsmRegionsMod.IRegion]
  /**
    ...
    */
  def getSelectedRegions(): js.Array[atBlueprintjsTableLib.libEsmRegionsMod.IRegion]
  /**
    * Returns a region containing the single cell that was clicked to launch
    * this context menu.
    */
  def getTarget(): atBlueprintjsTableLib.libEsmRegionsMod.IRegion
  /**
    ...
    */
  def getUniqueCells(): js.Array[atBlueprintjsTableLib.libEsmRegionsMod.ICellCoordinate]
}

object IMenuContext {
  @scala.inline
  def apply(
    getRegions: () => js.Array[atBlueprintjsTableLib.libEsmRegionsMod.IRegion],
    getSelectedRegions: () => js.Array[atBlueprintjsTableLib.libEsmRegionsMod.IRegion],
    getTarget: () => atBlueprintjsTableLib.libEsmRegionsMod.IRegion,
    getUniqueCells: () => js.Array[atBlueprintjsTableLib.libEsmRegionsMod.ICellCoordinate]
  ): IMenuContext = {
