...
object atBlueprintjsTableComponents extends atBlueprintjsTableProps {
  @scala.inline
  def Cell: ComponentType[CellProps] = js.constructorOf[typings.atBlueprintjsTable.libEsmCellCellMod.Cell].asInstanceOf[typings.react.reactMod.ComponentType[CellProps]]
  @scala.inline
  def Column: ComponentType[ColumnProps] = js.constructorOf[typings.atBlueprintjsTable.libEsmColumnMod.Column].asInstanceOf[typings.react.reactMod.ComponentType[ColumnProps]]
  @scala.inline
  def ColumnHeader: ComponentType[ColumnHeaderProps] = js.constructorOf[typings.atBlueprintjsTable.libEsmHeadersColumnHeaderMod.ColumnHeader].asInstanceOf[typings.react.reactMod.ComponentType[ColumnHeaderProps]]
  @scala.inline
  ...
  @scala.inline
  def DragSelectable: ComponentType[DragSelectableProps] = js.constructorOf[typings.atBlueprintjsTable.atBlueprintjsTableMod.DragSelectable].asInstanceOf[typings.react.reactMod.ComponentType[DragSelectableProps]]
  @scala.inline
  def Draggable: ComponentType[DraggableProps] = js.constructorOf[typings.atBlueprintjsTable.atBlueprintjsTableMod.Draggable].asInstanceOf[typings.react.reactMod.ComponentType[DraggableProps]]
  @scala.inline
  def EditableCell: ComponentType[EditableCellProps] = js.constructorOf[typings.atBlueprintjsTable.atBlueprintjsTableMod.EditableCell].asInstanceOf[typings.react.reactMod.ComponentType[EditableCellProps]]
  @scala.inline
  ...
  @scala.inline
  def ResizeHandle: ComponentType[ResizeHandleProps] = js.constructorOf[typings.atBlueprintjsTable.atBlueprintjsTableMod.ResizeHandle].asInstanceOf[typings.react.reactMod.ComponentType[ResizeHandleProps]]
  @scala.inline
  def RowHeader: ComponentType[RowHeaderProps] = js.constructorOf[typings.atBlueprintjsTable.libEsmHeadersRowHeaderMod.RowHeader].asInstanceOf[typings.react.reactMod.ComponentType[RowHeaderProps]]
  @scala.inline
