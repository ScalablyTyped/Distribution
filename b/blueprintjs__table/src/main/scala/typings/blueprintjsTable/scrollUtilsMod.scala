...
object scrollUtilsMod {
  ...
  inline def measureScrollBarThickness_horizontal(element: HTMLElement, direction: horizontal): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("measureScrollBarThickness")(element.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[Double]
  
  inline def measureScrollBarThickness_vertical(element: HTMLElement, direction: vertical): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("measureScrollBarThickness")(element.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[Double]
}
