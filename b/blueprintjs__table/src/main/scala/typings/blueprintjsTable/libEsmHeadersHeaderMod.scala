...
import typings.blueprintjsTable.libEsmCommonMod.Grid
import typings.blueprintjsTable.libEsmInteractionsDragTypesMod.IClientCoordinates
import typings.blueprintjsTable.libEsmInteractionsReorderableMod.IReorderableProps
...
object libEsmHeadersHeaderMod {
  ...
  - typings.blueprintjsTable.libEsmInteractionsSelectableMod.ISelectableProps because var conflicts: selectedRegions. Inlined enableMultipleSelection, focusedCell, onSelectionEnd, selectedRegionTransform */ @js.native
  trait IHeaderProps
    extends StObject
