...
/* Inlined std.Omit<@blueprintjs/popover2.@blueprintjs/popover2.Popover2Props<@blueprintjs/popover2.@blueprintjs/popover2/lib/esm/popover2SharedProps.DefaultPopover2TargetHTMLProps>, 'content' | keyof @blueprintjs/core.@blueprintjs/core.OverlayLifecycleProps> */
trait OmitPopover2PropsDefaultP extends StObject {
  ...
  var targetTagName: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.blueprintjsTable.blueprintjsTableStrings.a, typings.blueprintjsTable.blueprintjsTableStrings.abbr, typings.blueprintjsTable.blueprintjsTableStrings.address */ Any
  ] = js.undefined
...
object OmitPopover2PropsDefaultP {
  
  inline def apply(): OmitPopover2PropsDefaultP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitPopover2PropsDefaultP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitPopover2PropsDefaultP] (val x: Self) extends AnyVal {
    ...
    inline def setTargetTagName(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.blueprintjsTable.blueprintjsTableStrings.a, typings.blueprintjsTable.blueprintjsTableStrings.abbr, typings.blueprintjsTable.blueprintjsTableStrings.address */ Any
