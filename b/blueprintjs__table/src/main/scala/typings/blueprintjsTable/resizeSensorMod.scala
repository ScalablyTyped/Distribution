...
object resizeSensorMod {
  ...
  object ResizeSensor {
    ...
    inline def RESIZE_SENSOR_HTML_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RESIZE_SENSOR_HTML")(x.asInstanceOf[js.Any])
    ...
    inline def RESIZE_SENSOR_STYLE_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RESIZE_SENSOR_STYLE")(x.asInstanceOf[js.Any])
    ...
    inline def debounce_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("debounce")(x.asInstanceOf[js.Any])
  }
}
