...
import typings.blueprintjsTable.anon.NextScrollTop
...
import typings.blueprintjsTable.libEsmResizeRowsMod.IResizeRowsByApproximateHeightOptions
import typings.blueprintjsTable.libEsmTablePropsMod.TableProps
...
import typings.blueprintjsTable.libEsmTableStateMod.TableSnapshot
...
object libEsmTableMod {
  
  @JSImport("@blueprintjs/table/lib/esm/table", "Table")
  @js.native
  open class Table protected () extends AbstractComponent2[TableProps, TableState, TableSnapshot] {
    ...
    def componentDidUpdate_MTable(prevProps: TableProps, prevState: TableState, snapshot: TableSnapshot): Unit = js.native
    ...
    def getChildContext(): ColumnInteractionBarContextTypes_ = js.native
    ...
    def getSnapshotBeforeUpdate_MTable(): NextScrollLeft | NextScrollTop = js.native
    ...
    /* private */ var maybeRenderCopyHotkey: Any = js.native
    
    /* private */ var maybeRenderFocusHotkeys: Any = js.native
    ...
    /* private */ var maybeRenderSelectAllHotkey: Any = js.native
    
    /* private */ var maybeRenderSelectionResizeHotkeys: Any = js.native
    ...
    def shouldComponentUpdate_MTable(nextProps: TableProps, nextState: TableState): Boolean = js.native
