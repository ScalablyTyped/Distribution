...
object Validator extends js.Object {
  ...
  def byte(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def creditCard(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def double(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def emailAddress(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def int16(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  def int32(): typings.breeze.breeze.Validator = js.native
  def int32(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  def int64(): typings.breeze.breeze.Validator = js.native
  def int64(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  /** Same as int64 */
  def integer(): typings.breeze.breeze.Validator = js.native
  def integer(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def maxLength(context: Anon_MaxLength): typings.breeze.breeze.Validator = js.native
  /** Always returns true */
  def none(): typings.breeze.breeze.Validator = js.native
  /** Validators number, double, and single are all the same */
  def number(): typings.breeze.breeze.Validator = js.native
  def number(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def phone(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  ...
  def regularExpression(context: Anon_Expression): typings.breeze.breeze.Validator = js.native
  def required(): typings.breeze.breeze.Validator = js.native
  def required(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  /** Validators number, double, and single are all the same */
  def single(): typings.breeze.breeze.Validator = js.native
  def single(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
  def string(): typings.breeze.breeze.Validator = js.native
  def stringLength(context: Anon_MaxLengthMessageTemplate): typings.breeze.breeze.Validator = js.native
  /** Returns the URL (protocol required) validator */
  def url(): typings.breeze.breeze.Validator = js.native
  def url(context: Anon_MessageTemplate): typings.breeze.breeze.Validator = js.native
}
