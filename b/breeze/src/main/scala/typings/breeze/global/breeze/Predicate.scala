...
object Predicate {
  ...
  inline def and(predicates: typings.breeze.breeze.Predicate*): typings.breeze.breeze.Predicate = ^.asInstanceOf[js.Dynamic].applyDynamic("and")(predicates.asInstanceOf[js.Any]).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def and(property: String, operator: String, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("and")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def and(property: String, operator: typings.breeze.breeze.FilterQueryOpSymbol, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("and")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  inline def and(
    property: String,
    operator: typings.breeze.breeze.FilterQueryOpSymbol,
    value: js.Any,
  ...
  inline def create(predicates: typings.breeze.breeze.Predicate*): typings.breeze.breeze.Predicate = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(predicates.asInstanceOf[js.Any]).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def create(property: String, operator: String, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def create(property: String, operator: typings.breeze.breeze.FilterQueryOpSymbol, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  inline def create(
    property: String,
    operator: typings.breeze.breeze.FilterQueryOpSymbol,
    value: js.Any,
  ...
  inline def isPredicate(o: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPredicate")(o.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def or(predicates: typings.breeze.breeze.Predicate*): typings.breeze.breeze.Predicate = ^.asInstanceOf[js.Dynamic].applyDynamic("or")(predicates.asInstanceOf[js.Any]).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def or(property: String, operator: String, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("or")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  ...
  inline def or(property: String, operator: typings.breeze.breeze.FilterQueryOpSymbol, value: js.Any): typings.breeze.breeze.Predicate = (^.asInstanceOf[js.Dynamic].applyDynamic("or")(property.asInstanceOf[js.Any], operator.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.breeze.breeze.Predicate]
  inline def or(
    property: String,
    operator: typings.breeze.breeze.FilterQueryOpSymbol,
    value: js.Any,
