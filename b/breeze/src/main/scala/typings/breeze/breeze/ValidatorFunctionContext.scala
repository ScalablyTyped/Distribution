...
object ValidatorFunctionContext {
  ...
  inline def apply(displayName: String, messageTemplate: String, validatorName: String, value: js.Any): ValidatorFunctionContext = {
  ...
  extension [Self <: ValidatorFunctionContext](x: Self) {
    ...
    inline def setValidatorName(value: String): Self = StObject.set(x, "validatorName", value.asInstanceOf[js.Any])
