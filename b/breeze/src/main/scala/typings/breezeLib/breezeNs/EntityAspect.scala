...
class EntityAspect () extends js.Object {
  ...
  def loadNavigationProperty(navigationProperty: java.lang.String): js.Promise[QueryResult] = js.native
  def loadNavigationProperty(navigationProperty: java.lang.String, callback: js.Function): js.Promise[QueryResult] = js.native
  def loadNavigationProperty(navigationProperty: java.lang.String, callback: js.Function, errorCallback: js.Function): js.Promise[QueryResult] = js.native
