...
class Pushpin protected () extends IPrimitive {
  ...
  /**
           ...
           */
  def getClickedStyleEnabled(): scala.Boolean = js.native
  /**
           * Gets the color option of the pushpin.
           * @returns The color option of the pushpin.
           */
  def getColor(): java.lang.String | Color = js.native
  /**
  ...
  /**
           ...
           */
  def getHoverStyleEnabled(): scala.Boolean = js.native
  /**
  ...
  /**
           ...
           */
  def getRoundClickableArea(): scala.Boolean = js.native
  /**
  ...
  /**
           ...
           */
  def setLocation(location: Location): scala.Unit = js.native
  /**
  ...
  /**
           ...
           */
  def setOptions(options: IPushpinOptions): scala.Unit = js.native
}
