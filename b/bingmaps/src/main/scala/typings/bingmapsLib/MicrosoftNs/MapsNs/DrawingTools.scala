...
@js.native
class DrawingTools protected () extends js.Object {
  /**
    * @constructor
  ...
  /**
    ...
    */
  def create(shapeType: bingmapsLib.MicrosoftNs.MapsNs.DrawingToolsNs.ShapeType): scala.Unit = js.native
  def create(
    shapeType: bingmapsLib.MicrosoftNs.MapsNs.DrawingToolsNs.ShapeType,
    created: js.Function1[/* shape */ IPrimitive, scala.Unit]
  ...
  /**
    ...
    */
  def edit(shape: IPrimitive): scala.Unit = js.native
  /**
  ...
  def finish(finished: js.Function1[/* shape */ IPrimitive, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def showDrawingBar(): scala.Unit = js.native
  def showDrawingBar(options: IDrawingToolOptions): scala.Unit = js.native
  /**
    ...
    */
  def showDrawingManager(): scala.Unit = js.native
  def showDrawingManager(callback: js.Function1[/* manager */ DrawingManager, scala.Unit]): scala.Unit = js.native
}
