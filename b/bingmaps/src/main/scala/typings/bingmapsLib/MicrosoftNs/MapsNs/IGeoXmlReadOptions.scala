...
trait IGeoXmlReadOptions extends js.Object {
  ...
  var allowKmlScreenOverlays: js.UndefOr[scala.Boolean] = js.undefined
  /**
          ...
          */
  var captureGpxPathWaypoints: js.UndefOr[scala.Boolean] = js.undefined
  ...
  var ignoreVisibility: js.UndefOr[scala.Boolean] = js.undefined
  /**
           ...
           */
  var maxNetworkLinkDepth: js.UndefOr[scala.Double] = js.undefined
  /**
          * The maximium number of network links that a single KML file can have. Default: 10.
          */
  var maxNetworkLinks: js.UndefOr[scala.Double] = js.undefined
