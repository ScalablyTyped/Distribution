...
object Events {
  ...
  @scala.inline
  def addHandler(target: js.Any, eventName: String, handler: js.Function1[/* eventArg */ js.UndefOr[js.Any], Unit]): IHandlerId = (^.asInstanceOf[js.Dynamic].applyDynamic("addHandler")(target.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[IHandlerId]
  @scala.inline
  def addHandler(
  ...
  @scala.inline
  def addOne(target: js.Any, eventName: String, handler: js.Function1[/* eventArg */ js.UndefOr[js.Any], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addOne")(target.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def addOne(
    target: DirectionsManager,
    eventName: String,
  ...
  @scala.inline
  def hasHandler(target: js.Any, eventName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("hasHandler")(target.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  
  @scala.inline
  def invoke(target: js.Any, evenName: String, args: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("invoke")(target.asInstanceOf[js.Any], evenName.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  @scala.inline
  def removeHandler(handlerId: IHandlerId): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeHandler")(handlerId.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
