...
object RouteResponseCode extends js.Object {
  ...
  /* 15 */ val atleastTwoWaypointRequired: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.atleastTwoWaypointRequired with Double = js.native
  /* 2 */ val cannotFindNearbyRoad: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.cannotFindNearbyRoad with Double = js.native
  /* 5 */ val dataSourceNotFound: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.dataSourceNotFound with Double = js.native
  /* 14 */ val exceedMaxWaypointLimit: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.exceedMaxWaypointLimit with Double = js.native
  /* 16 */ val firstOrLastStoppointIsVia: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.firstOrLastStoppointIsVia with Double = js.native
  /* 13 */ val hasEmptyWaypoint: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.hasEmptyWaypoint with Double = js.native
  /* 18 */ val invalidCredentials: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.invalidCredentials with Double = js.native
  /* 7 */ val noAvailableTransitTrip: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.noAvailableTransitTrip with Double = js.native
  /* 4 */ val noSolution: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.noSolution with Double = js.native
  /* 10 */ val outOfTransitBounds: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.outOfTransitBounds with Double = js.native
  /* 17 */ val searchServiceFailed: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.searchServiceFailed with Double = js.native
  /* 0 */ val success: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.success with Double = js.native
  /* 11 */ val timeOut: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.timeOut with Double = js.native
  /* 3 */ val tooFar: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.tooFar with Double = js.native
  /* 8 */ val transitStopsTooClose: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.transitStopsTooClose with Double = js.native
  /* 1 */ val unknownError: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.unknownError with Double = js.native
  /* 9 */ val walkingBestAlternative: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.walkingBestAlternative with Double = js.native
  /* 12 */ val waypointDisambiguation: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.RouteResponseCode.waypointDisambiguation with Double = js.native
  @JSBracketAccess
