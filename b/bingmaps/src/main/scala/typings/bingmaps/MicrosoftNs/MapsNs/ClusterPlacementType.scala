...
object ClusterPlacementType extends js.Object {
  ...
  /* 1 */ val FirstLocation: typings.bingmaps.MicrosoftNs.MapsNs.ClusterPlacementType.FirstLocation with Double = js.native
  /* 0 */ val MeanAverage: typings.bingmaps.MicrosoftNs.MapsNs.ClusterPlacementType.MeanAverage with Double = js.native
  @JSBracketAccess
