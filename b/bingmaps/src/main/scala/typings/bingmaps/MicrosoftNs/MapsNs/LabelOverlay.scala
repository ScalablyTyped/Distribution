...
object LabelOverlay extends js.Object {
  ...
  /* 0 */ val hidden: typings.bingmaps.MicrosoftNs.MapsNs.LabelOverlay.hidden with Double = js.native
  /* 1 */ val visible: typings.bingmaps.MicrosoftNs.MapsNs.LabelOverlay.visible with Double = js.native
  @JSBracketAccess
