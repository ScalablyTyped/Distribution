...
object TimeType extends js.Object {
  ...
  /* 0 */ val arrival: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.TimeType.arrival with Double = js.native
  /* 1 */ val departure: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.TimeType.departure with Double = js.native
  /* 2 */ val firstAvailable: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.TimeType.firstAvailable with Double = js.native
  /* 3 */ val lastAvailable: typings.bingmaps.MicrosoftNs.MapsNs.DirectionsNs.TimeType.lastAvailable with Double = js.native
  @JSBracketAccess
