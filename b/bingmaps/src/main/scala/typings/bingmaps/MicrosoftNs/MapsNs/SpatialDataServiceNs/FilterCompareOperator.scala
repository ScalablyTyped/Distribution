...
import typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.equals
...
object FilterCompareOperator extends js.Object {
  ...
  /* 0 */ val endsWith: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.endsWith with Double = js.native
  /* 1 */ @JSName("equals")
  val equals_FFilterCompareOperator: equals with Double = js.native
  /* 2 */ val greaterThan: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.greaterThan with Double = js.native
  /* 3 */ val greaterThanOrEqual: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.greaterThanOrEqual with Double = js.native
  /* 4 */ val isIn: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.isIn with Double = js.native
  /* 5 */ val lessThan: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.lessThan with Double = js.native
  /* 6 */ val lessThanOrEqual: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.lessThanOrEqual with Double = js.native
  /* 7 */ val notEndsWith: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.notEndsWith with Double = js.native
  /* 8 */ val notEquals: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.notEquals with Double = js.native
  /* 9 */ val notStartsWith: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.notStartsWith with Double = js.native
  /* 10 */ val startsWith: typings.bingmaps.MicrosoftNs.MapsNs.SpatialDataServiceNs.FilterCompareOperator.startsWith with Double = js.native
  @JSBracketAccess
