...
object DataBinType extends js.Object {
  ...
  /* 0 */ val circle: typings.bingmaps.MicrosoftNs.MapsNs.DataBinType.circle with Double = js.native
  /* 2 */ val hexCircle: typings.bingmaps.MicrosoftNs.MapsNs.DataBinType.hexCircle with Double = js.native
  /* 1 */ val hexagon: typings.bingmaps.MicrosoftNs.MapsNs.DataBinType.hexagon with Double = js.native
  /* 3 */ val pointyHexagon: typings.bingmaps.MicrosoftNs.MapsNs.DataBinType.pointyHexagon with Double = js.native
  /* 4 */ val square: typings.bingmaps.MicrosoftNs.MapsNs.DataBinType.square with Double = js.native
  @JSBracketAccess
