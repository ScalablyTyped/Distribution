...
object MapTypeId extends js.Object {
  ...
  /* 0 */ val aerial: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.aerial with Double = js.native
  /* 1 */ val birdseye: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.birdseye with Double = js.native
  /* 2 */ val canvasDark: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.canvasDark with Double = js.native
  /* 3 */ val canvasLight: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.canvasLight with Double = js.native
  /* 4 */ val grayscale: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.grayscale with Double = js.native
  /* 5 */ val mercator: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.mercator with Double = js.native
  /* 6 */ val ordnanceSurvey: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.ordnanceSurvey with Double = js.native
  /* 7 */ val road: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.road with Double = js.native
  /* 8 */ val streetside: typings.bingmaps.MicrosoftNs.MapsNs.MapTypeId.streetside with Double = js.native
  @JSBracketAccess
