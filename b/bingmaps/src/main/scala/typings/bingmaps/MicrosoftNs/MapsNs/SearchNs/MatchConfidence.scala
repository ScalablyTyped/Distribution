...
object MatchConfidence extends js.Object {
  ...
  /* 0 */ val high: typings.bingmaps.MicrosoftNs.MapsNs.SearchNs.MatchConfidence.high with Double = js.native
  /* 2 */ val low: typings.bingmaps.MicrosoftNs.MapsNs.SearchNs.MatchConfidence.low with Double = js.native
  /* 1 */ val medium: typings.bingmaps.MicrosoftNs.MapsNs.SearchNs.MatchConfidence.medium with Double = js.native
  /* 3 */ val unknown: typings.bingmaps.MicrosoftNs.MapsNs.SearchNs.MatchConfidence.unknown with Double = js.native
  @JSBracketAccess
