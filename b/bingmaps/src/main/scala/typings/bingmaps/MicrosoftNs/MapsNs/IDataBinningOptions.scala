...
import typings.bingmaps.MicrosoftNs.MapsNs.SpatialMathNs.DistanceUnits
...
object IDataBinningOptions {
  ...
  def apply(
    ...
    colorCallback: (/* binInfo */ IDataBinInfo, /* min */ IDataBinMetrics, /* max */ IDataBinMetrics) => String | Color = null,
