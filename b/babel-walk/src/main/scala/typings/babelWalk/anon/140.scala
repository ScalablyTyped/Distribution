...
@js.native
trait `140`[TState] extends js.Object {
...
object `140` {
  ...
  @scala.inline
  implicit class `140Ops`[Self <: `140`[_], TState] (val x: Self with `140`[TState]) extends AnyVal {
    ...
    @scala.inline
    def setExit(value: (/* node */ NodeType[Pureish], TState) => Unit): Self = this.set("exit", js.Any.fromFunction2(value))
