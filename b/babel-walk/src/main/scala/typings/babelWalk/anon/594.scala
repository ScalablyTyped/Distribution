...
trait `594`[TState] extends StObject {
...
object `594` {
  ...
  inline def apply[TState](): `594`[TState] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[`594`[TState]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `594`[?], TState] (val x: Self & `594`[TState]) extends AnyVal {
