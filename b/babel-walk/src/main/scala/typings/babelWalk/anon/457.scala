...
@js.native
trait `457`[TState] extends js.Object {
  
  var enter: js.UndefOr[AncestorFunction[TSCallSignatureDeclaration, TState]] = js.native
  
  var exit: js.UndefOr[AncestorFunction[TSCallSignatureDeclaration, TState]] = js.native
}
object `457` {
  ...
  @scala.inline
  implicit class `457Ops`[Self <: `457`[_], TState] (val x: Self with `457`[TState]) extends AnyVal {
