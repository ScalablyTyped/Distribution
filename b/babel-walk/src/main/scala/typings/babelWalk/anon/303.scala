...
trait `303`[TState] extends StObject {
  ...
  var enter: js.UndefOr[AncestorFunction[TSSatisfiesExpression, TState]] = js.undefined
  
  var exit: js.UndefOr[AncestorFunction[TSSatisfiesExpression, TState]] = js.undefined
}
object `303` {
  ...
  implicit open class MutableBuilder[Self <: `303`[?], TState] (val x: Self & `303`[TState]) extends AnyVal {
    ...
    inline def setEnter(
      value: (/* node */ NodeType[TSSatisfiesExpression], TState, /* ancestors */ js.Array[Node]) => Unit
