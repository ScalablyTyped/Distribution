...
@js.native
trait `374`[TState] extends js.Object {
  
  var enter: js.UndefOr[AncestorFunction[ExportDefaultDeclaration, TState]] = js.native
  
  var exit: js.UndefOr[AncestorFunction[ExportDefaultDeclaration, TState]] = js.native
}
object `374` {
  ...
  @scala.inline
  implicit class `374Ops`[Self <: `374`[_], TState] (val x: Self with `374`[TState]) extends AnyVal {
