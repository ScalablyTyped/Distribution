...
object typingsBabelParserDotsourceMod {
  
  @JSImport("@babel/parser/typings/babel-parser.source", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def parse(input: String): ParseResultFileComments = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any]).asInstanceOf[ParseResultFileComments]
  inline def parse(input: String, options: ParserOptions): ParseResultFileComments = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(input.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ParseResultFileComments]
  ...
  type ParseResult[Result] = Result & ErrorsArray
  ...
  type ParserPlugin = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_typings.PluginConfig */ Any
}
