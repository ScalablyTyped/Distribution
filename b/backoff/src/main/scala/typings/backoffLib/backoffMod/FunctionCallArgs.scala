...
object FunctionCallArgs {
  ...
  def apply[E, R1, R2, R3](
    addListener_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3],
    emit_callback: (backoffLib.backoffLibStrings.callback, js.Tuple4[E, R1, R2, R3]) => scala.Boolean,
    getLastResult: () => js.Tuple4[E, R1, R2, R3],
    listeners_callback: backoffLib.backoffLibStrings.callback => js.Array[js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]],
    on_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3],
    once_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3],
    prependListener_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3],
    prependOnceListener_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3],
    removeListener_callback: (backoffLib.backoffLibStrings.callback, js.Function1[/* results */ js.Tuple4[E, R1, R2, R3], scala.Unit]) => FunctionCallArgs[E, R1, R2, R3]
