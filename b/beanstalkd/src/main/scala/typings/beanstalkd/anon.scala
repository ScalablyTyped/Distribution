...
object anon {
  ...
  object RequiredBeanstalkdClient {
    ...
    inline def apply(
      ...
      on: (/* event */ String, /* repeated */ js.Function1[/* repeated */ Any, Unit]) => Unit,
    ...
    implicit open class MutableBuilder[Self <: RequiredBeanstalkdClient] (val x: Self) extends AnyVal {
      ...
      inline def setOn(value: (/* event */ String, /* repeated */ js.Function1[/* repeated */ Any, Unit]) => Unit): Self = StObject.set(x, "on", js.Any.fromFunction2(value))
