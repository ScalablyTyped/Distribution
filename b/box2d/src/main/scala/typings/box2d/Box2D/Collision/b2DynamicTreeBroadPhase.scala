...
object b2DynamicTreeBroadPhase {
  ...
  inline def apply(
    ...
    UpdatePairs: js.Function2[/* userDataA */ Any, /* userDataB */ Any, Unit] => Unit,
    Validate: () => Unit
  ...
  implicit open class MutableBuilder[Self <: b2DynamicTreeBroadPhase] (val x: Self) extends AnyVal {
    ...
    inline def setUpdatePairs(value: js.Function2[/* userDataA */ Any, /* userDataB */ Any, Unit] => Unit): Self = StObject.set(x, "UpdatePairs", js.Any.fromFunction1(value))
