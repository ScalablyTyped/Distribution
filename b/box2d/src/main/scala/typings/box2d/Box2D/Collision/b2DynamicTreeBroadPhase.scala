...
class b2DynamicTreeBroadPhase () extends IBroadPhase {
  ...
  /**
  		...
  		**/
  /* CompleteClass */
  override def DestroyProxy(proxy: b2DynamicTreeNode): Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  /* CompleteClass */
  override def MoveProxy(proxy: b2DynamicTreeNode, aabb: b2AABB, displacement: b2Vec2): Unit = js.native
  /**
  		...
  		**/
  /* CompleteClass */
  override def Query(callback: js.Function1[/* proxy */ b2DynamicTreeNode, Boolean], aabb: b2AABB): Unit = js.native
  /**
