...
class b2Body () extends js.Object {
  /**
  		...
  		**/
  def ApplyForce(force: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2, point: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): scala.Unit = js.native
  /**
  		* Apply an impulse at a point. This immediately modifies the velocity. It also modifies the angular velocity if the point of application is not at the center of mass. This wakes up the body.
  		* @param impules The world impulse vector, usually in N-seconds or kg-m/s.
  		* @param point The world position of the point of application.
  		**/
  def ApplyImpulse(impulse: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2, point: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): scala.Unit = js.native
  /**
  		* Apply a torque. This affects the angular velocity without affecting the linear velocity of the center of mass. This wakes up the body.
  		* @param torque Force applied about the z-axis (out of the screen), usually in N-m.
  		**/
  def ApplyTorque(torque: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def DestroyFixture(fixture: b2Fixture): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetAngularDamping(): scala.Double = js.native
  /**
  		* Get the angular velocity.
  		* @return The angular velocity in radians/second.
  		**/
  def GetAngularVelocity(): scala.Double = js.native
  /**
  		* Get the list of all contacts attached to this body.
  		* @return List of all contacts attached to this body.
  		**/
  def GetContactList(): box2dLib.Box2DNs.DynamicsNs.ContactsNs.b2ContactEdge = js.native
  /**
  		* Get the list of all controllers attached to this body.
  		* @return List of all controllers attached to this body.
  		**/
  def GetControllerList(): box2dLib.Box2DNs.DynamicsNs.ControllersNs.b2ControllerEdge = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetInertia(): scala.Double = js.native
  /**
  		* Get the list of all joints attached to this body.
  		* @return List of all joints attached to this body.
  		**/
  def GetJointList(): box2dLib.Box2DNs.DynamicsNs.JointsNs.b2JointEdge = js.native
  /**
  		* Get the linear damping of the body.
  		* @return The linear damping of the body.
  		**/
  def GetLinearDamping(): scala.Double = js.native
  /**
  		* Get the linear velocity of the center of mass.
  		* @return The linear velocity of the center of mass.
  		**/
  def GetLinearVelocity(): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Get the world velocity of a local point.
  		* @param localPoint Point in local coordinates.
  		* @return The world velocity of the point.
  		**/
  def GetLinearVelocityFromLocalPoint(localPoint: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Get the world linear velocity of a world point attached to this body.
  		* @param worldPoint Point in world coordinates.
  		* @return The world velocity of the point.
  		**/
  def GetLinearVelocityFromWorldPoint(worldPoint: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Get the local position of the center of mass.
  		* @return Local position of the center of mass.
  		**/
  def GetLocalCenter(): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Gets a local point relative to the body's origin given a world point.
  		* @param worldPoint Pointin world coordinates.
  		* @return The corresponding local point relative to the body's origin.
  		**/
  def GetLocalPoint(worldPoint: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Gets a local vector given a world vector.
  		* @param worldVector World vector.
  		* @return The corresponding local vector.
  		**/
  def GetLocalVector(worldVector: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetMassData(data: box2dLib.Box2DNs.CollisionNs.ShapesNs.b2MassData): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetPosition(): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Get the body transform for the body's origin.
  		* @return World transform of the body's origin.
  		**/
  def GetTransform(): box2dLib.Box2DNs.CommonNs.MathNs.b2Transform = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetWorldCenter(): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		...
  		**/
  def GetWorldPoint(localPoint: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  		* Get the world coordinates of a vector given the local coordinates.
  		* @param localVector Vector fixed in the body.
  		* @return localVector expressed in world coordinates.
  		**/
  def GetWorldVector(localVector: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2 = js.native
  /**
  ...
  /**
  		...
  		**/
  def IsAwake(): scala.Boolean = js.native
  /**
  ...
  /**
  		...
  		**/
  def ResetMassData(): scala.Unit = js.native
  /**
  		...
  		**/
  def SetActive(flag: scala.Boolean): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def SetAngularDamping(angularDamping: scala.Double): scala.Unit = js.native
  /**
  		* Set the angular velocity.
  		* @param omega New angular velocity in radians/second.
  		**/
  def SetAngularVelocity(omega: scala.Double): scala.Unit = js.native
  /**
  		...
  		**/
  def SetAwake(flag: scala.Boolean): scala.Unit = js.native
  /**
  		* Should this body be treated like a bullet for continuous collision detection?
  		* @param flag True for bullet, false for normal.
  		**/
  def SetBullet(flag: scala.Boolean): scala.Unit = js.native
  /**
  		* Set this body to have fixed rotation. This causes the mass to be reset.
  		* @param fixed True for no rotation, false to allow for rotation.
  		**/
  def SetFixedRotation(fixed: scala.Boolean): scala.Unit = js.native
  /**
  		* Set the linear damping of the body.
  		* @param linearDamping The new linear damping for this body.
  		**/
  def SetLinearDamping(linearDamping: scala.Double): scala.Unit = js.native
  /**
  		* Set the linear velocity of the center of mass.
  		* @param v New linear velocity of the center of mass.
  		**/
  def SetLinearVelocity(v: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): scala.Unit = js.native
  /**
  		...
  		**/
  def SetMassData(massData: box2dLib.Box2DNs.CollisionNs.ShapesNs.b2MassData): scala.Unit = js.native
  /**
  		* Set the world body origin position.
  		* @param position New world body origin position.
  		**/
  def SetPosition(position: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): scala.Unit = js.native
  /**
  		...
  		**/
  def SetPositionAndAngle(position: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2, angle: scala.Double): scala.Unit = js.native
  /**
  		* Is this body allowed to sleep
  		* @param flag True if the body can sleep, false if not.
  		**/
  def SetSleepingAllowed(flag: scala.Boolean): scala.Unit = js.native
  /**
  		...
  		**/
  def SetTransform(xf: box2dLib.Box2DNs.CommonNs.MathNs.b2Transform): scala.Unit = js.native
  /**
...
object b2Body extends js.Object {
  /**
  		* Dynamic Body
  		**/
  var b2_dynamicBody: scala.Double = js.native
  /**
  		* Kinematic Body
  		**/
  var b2_kinematicBody: scala.Double = js.native
  /**
  		* Static Body
  		**/
  var b2_staticBody: scala.Double = js.native
}
