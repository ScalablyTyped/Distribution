...
class b2Mat33 protected () extends js.Object {
  ...
  /**
  		...
  		**/
  def AddM(m: b2Mat33): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def SetM(m: b2Mat33): scala.Unit = js.native
  /**
  		...
  		**/
  def SetVVV(c1: b2Vec3, c2: b2Vec3, c3: b2Vec3): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def Solve22(out: b2Vec2, bX: scala.Double, bY: scala.Double): b2Vec2 = js.native
  /**
  		* TODO, has something to do with the determinant
  		* @param out Solved vector
  		* @param bX
  		...
  		* @return Solved vector
  		**/
  def Solve33(out: b2Vec3, bX: scala.Double, bY: scala.Double, bZ: scala.Double): b2Vec3 = js.native
}
