...
class b2Mat22 () extends js.Object {
  ...
  /**
  		...
  		**/
  def AddM(m: b2Mat22): scala.Unit = js.native
  /**
...
object b2Mat22 extends js.Object {
  /**
  		...
  		* @return 2x2 matrix.
  		**/
  def FromAngle(angle: scala.Double): box2dLib.Box2DNs.CommonNs.MathNs.b2Mat22 = js.native
  /**
  		...
  		* @return 2x2 matrix.
  		**/
  def FromVV(c1: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2, c2: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2): box2dLib.Box2DNs.CommonNs.MathNs.b2Mat22 = js.native
}
