...
class b2Segment () extends js.Object {
  ...
  /**
  		...
  		**/
  def TestSegment(
    lambda: js.Array[scala.Double],
    normal: box2dLib.Box2DNs.CommonNs.MathNs.b2Vec2,
    segment: b2Segment,
    maxLambda: scala.Double
