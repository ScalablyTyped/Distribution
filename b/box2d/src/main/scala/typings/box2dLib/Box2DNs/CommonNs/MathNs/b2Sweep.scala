...
class b2Sweep () extends js.Object {
  ...
  /**
  		...
  		**/
  def Advance(t: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
  		...
  		**/
  def GetTransform(xf: b2Transform, alpha: scala.Double): scala.Unit = js.native
  /**
  		* Sets the sweep from a sweep.
  		* @param other Sweep values to copy from.
  		**/
  def Set(other: b2Sweep): scala.Unit = js.native
}
