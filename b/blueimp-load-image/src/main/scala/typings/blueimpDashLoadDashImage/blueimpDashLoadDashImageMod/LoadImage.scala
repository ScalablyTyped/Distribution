...
trait LoadImage extends js.Object {
  ...
  def blobSlice(file: Blob): Blob = js.native
  def blobSlice(file: Blob, start: Double): Blob = js.native
  def blobSlice(file: Blob, start: Double, end: Double): Blob = js.native
