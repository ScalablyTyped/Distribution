package typings.babelImportUtil

import typings.babelImportUtil.babelImportUtilBooleans.`false`
import typings.babelImportUtil.babelImportUtilBooleans.`true`
import typings.babelImportUtil.babelImportUtilStrings.Ampersand
import typings.babelImportUtil.babelImportUtilStrings.AmpersandAmpersand
import typings.babelImportUtil.babelImportUtilStrings.Asterisk
import typings.babelImportUtil.babelImportUtilStrings.AsteriskAsterisk
import typings.babelImportUtil.babelImportUtilStrings.BlockStatement
import typings.babelImportUtil.babelImportUtilStrings.ClassBody
import typings.babelImportUtil.babelImportUtilStrings.CommonJS
import typings.babelImportUtil.babelImportUtilStrings.ES
import typings.babelImportUtil.babelImportUtilStrings.EqualssignEqualssign
import typings.babelImportUtil.babelImportUtilStrings.EqualssignEqualssignEqualssign
import typings.babelImportUtil.babelImportUtilStrings.Exclamationmark
import typings.babelImportUtil.babelImportUtilStrings.ExclamationmarkEqualssign
import typings.babelImportUtil.babelImportUtilStrings.ExclamationmarkEqualssignEqualssign
import typings.babelImportUtil.babelImportUtilStrings.Greaterthansign
import typings.babelImportUtil.babelImportUtilStrings.GreaterthansignEqualssign
import typings.babelImportUtil.babelImportUtilStrings.GreaterthansignGreaterthansign
import typings.babelImportUtil.babelImportUtilStrings.GreaterthansignGreaterthansignGreaterthansign
import typings.babelImportUtil.babelImportUtilStrings.Identifier
import typings.babelImportUtil.babelImportUtilStrings.Lessthansign
import typings.babelImportUtil.babelImportUtilStrings.LessthansignEqualssign
import typings.babelImportUtil.babelImportUtilStrings.LessthansignLessthansign
import typings.babelImportUtil.babelImportUtilStrings.Percentsign
import typings.babelImportUtil.babelImportUtilStrings.Plussign
import typings.babelImportUtil.babelImportUtilStrings.PlussignPlussign
import typings.babelImportUtil.babelImportUtilStrings.QuestionmarkQuestionmark
import typings.babelImportUtil.babelImportUtilStrings.Slash
import typings.babelImportUtil.babelImportUtilStrings.StringLiteral
import typings.babelImportUtil.babelImportUtilStrings.Tilde
import typings.babelImportUtil.babelImportUtilStrings.Verticalline
import typings.babelImportUtil.babelImportUtilStrings.VerticallineGreaterthansign
import typings.babelImportUtil.babelImportUtilStrings.VerticallineVerticalline
...
import typings.babelImportUtil.babelImportUtilStrings.`var`
import typings.babelImportUtil.babelImportUtilStrings.boolean
import typings.babelImportUtil.babelImportUtilStrings.const
import typings.babelImportUtil.babelImportUtilStrings.constructor
import typings.babelImportUtil.babelImportUtilStrings.delete
import typings.babelImportUtil.babelImportUtilStrings.function
import typings.babelImportUtil.babelImportUtilStrings.get
import typings.babelImportUtil.babelImportUtilStrings.in
import typings.babelImportUtil.babelImportUtilStrings.instanceof
import typings.babelImportUtil.babelImportUtilStrings.let
import typings.babelImportUtil.babelImportUtilStrings.method
import typings.babelImportUtil.babelImportUtilStrings.minus
import typings.babelImportUtil.babelImportUtilStrings.module
import typings.babelImportUtil.babelImportUtilStrings.number
import typings.babelImportUtil.babelImportUtilStrings.plus
import typings.babelImportUtil.babelImportUtilStrings.script
import typings.babelImportUtil.babelImportUtilStrings.set
import typings.babelImportUtil.babelImportUtilStrings.string
import typings.babelImportUtil.babelImportUtilStrings.symbol
import typings.babelImportUtil.babelImportUtilStrings.typeof
import typings.babelImportUtil.babelImportUtilStrings.undefined
import typings.babelImportUtil.babelImportUtilStrings.void
...
object srcMod {
  ...
  @JSImport("babel-import-util/src", "ImportUtil")
  @js.native
  open class ImportUtil protected () extends StObject {
    def this(t: BabelTypes, program: NodePath[Program_]) = this()
    
    /* private */ var addSpecifier: Any = js.native
    
    /* private */ var buildSpecifier: Any = js.native
    
    /* private */ var findImportFrom: Any = js.native
    
    def `import`(target: NodePath[Node], moduleSpecifier: String, exportedName: String): Identifier_ = js.native
    def `import`(target: NodePath[Node], moduleSpecifier: String, exportedName: String, nameHint: String): Identifier_ = js.native
    
    def importForSideEffect(moduleSpecifier: String): Unit = js.native
    
    /* private */ var program: Any = js.native
    
    def removeAllImports(moduleSpecifier: String): Unit = js.native
    
    def removeImport(moduleSpecifier: String, exportedName: String): Unit = js.native
    
    /* private */ var t: Any = js.native
  }
  
  @js.native
  trait BabelTypes extends StObject {
    
    def addComment[T /* <: Node */](node: T, `type`: CommentTypeShorthand, content: String): T = js.native
    ...
    def cloneNode[T /* <: Node */](n: T, deep: Unit, withoutLoc: Boolean): T = js.native
    ...
    def getBindingIdentifiers(node: Node): Record[String, Identifier_] = js.native
    def getBindingIdentifiers(node: Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    def getBindingIdentifiers(node: Node, duplicates: Boolean, outerOnly: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    def getBindingIdentifiers(node: Node, duplicates: Unit, outerOnly: Boolean): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: Node, duplicates: `false`): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_false(node: Node, duplicates: `false`, outerOnly: Boolean): Record[String, Identifier_] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = js.native
    @JSName("getBindingIdentifiers")
    def getBindingIdentifiers_true(node: Node, duplicates: `true`, outerOnly: Boolean): Record[String, js.Array[Identifier_]] = js.native
    
    def getOuterBindingIdentifiers(node: Node): Record[String, Identifier_] = js.native
    def getOuterBindingIdentifiers(node: Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = js.native
    ...
    def inheritInnerComments(node: Node, parent: Node): Unit = js.native
    
    def inheritLeadingComments(node: Node, parent: Node): Unit = js.native
    
    def inheritTrailingComments(node: Node, parent: Node): Unit = js.native
    
    def inherits[T /* <: js.UndefOr[Node | Null] */](child: T): T = js.native
    def inherits[T /* <: js.UndefOr[Node | Null] */](child: T, parent: Node): T = js.native
    
    def inheritsComments[T /* <: Node */](node: T, parent: Node): Unit = js.native
    ...
    def is(`type`: String, n: Unit, required: Partial[Node]): /* is @babel/types.@babel/types.Node */ Boolean = js.native
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */](`type`: T, n: Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[P /* <: Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[P /* <: Node */](`type`: String, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[P /* <: Node */](`type`: String, n: Node, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Node, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isBinding(node: Node, parent: Node): Boolean = js.native
    def isBinding(node: Node, parent: Node, grandparent: Node): Boolean = js.native
    ...
    def isBlockScoped(node: Node): Boolean = js.native
    ...
    def isImmutable(node: Node): /* is @babel/types.@babel/types.Immutable */ Boolean = js.native
    ...
    def isLet(node: Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    def isNodesEquivalent_T[T /* <: Partial[Node] */](a: T, b: Any): /* is T */ Boolean = js.native
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isScope(node: Node, parent: Node): /* is @babel/types.@babel/types.Scopable */ Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelImportUtil.babelImportUtilStrings.ClassAccessorProperty, typings.babelImportUtil.babelImportUtilStrings.AnyTypeAnnotation, typings.babelImportUtil.babelImportUtilStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
    ...
    def isVar(node: Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = js.native
    ...
    def matchesPattern(node: Node, `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: Node, `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: Node, `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    def matchesPattern(node: Node, `match`: js.Array[String], allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = js.native
    ...
    def placeholder(
      expectedNode: Identifier | StringLiteral | typings.babelImportUtil.babelImportUtilStrings.Expression | typings.babelImportUtil.babelImportUtilStrings.Statement | typings.babelImportUtil.babelImportUtilStrings.Declaration | BlockStatement | ClassBody | typings.babelImportUtil.babelImportUtilStrings.Pattern,
      name: Identifier_
    ...
    def removePropertiesDeep[T /* <: Node */](n: T, opts: PreserveComments): T = js.native
    ...
    def toComputedKey[T /* <: Extract[Node, Computed] */](node: T): Expression = js.native
    def toComputedKey[T /* <: Extract[Node, Computed] */](node: T, key: Expression): Expression = js.native
    def toComputedKey[T /* <: Extract[Node, Computed] */](node: T, key: Identifier_): Expression = js.native
    ...
    def toKeyAlias(node: Method, key: Node): String = js.native
    ...
    def validate(n: Node, key: String, value: Any): Unit = js.native
