...
import typings.broccoliPersistentFilter.dependenciesMod.FSFacade
import typings.broccoliPersistentFilter.strategyMod.Context
import typings.broccoliPersistentFilter.strategyMod.InstrumentationSchema
import typings.broccoliPersistentFilter.strategyMod.Strategy
...
object defaultMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def initialDependencies(rootFS: FSFacade, inputEncoding: String): typings.broccoliPersistentFilter.dependenciesMod.^ = js.native
    ...
    /* CompleteClass */
    override def sealDependencies(dependencies: typings.broccoliPersistentFilter.dependenciesMod.^): Unit = js.native
  }
  ...
  object DefaultStrategy {
    ...
    inline def apply(
      init: () => Unit,
      initialDependencies: (FSFacade, String) => typings.broccoliPersistentFilter.dependenciesMod.^,
      processString: (Context, String, String) => js.Promise[String],
      sealDependencies: typings.broccoliPersistentFilter.dependenciesMod.^ => Unit
    ): DefaultStrategy = {
