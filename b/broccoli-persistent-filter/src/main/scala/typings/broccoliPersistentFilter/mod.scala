...
object mod {
  ...
  @js.native
  abstract class ^ protected () extends Filter {
  ...
  trait Filter
    ...
    var dependencies: typings.broccoliPersistentFilter.dependenciesMod.^ | Null = js.native
    ...
    var processor: typings.broccoliPersistentFilter.processorMod.^ = js.native
  ...
  type ProcessStringResult[Data] = typings.broccoliPersistentFilter.strategyMod.ProcessStringResult[Data]
}
