...
trait Bucks extends js.Object {
  /**
    ...
    */
  def add(task: TaskWithNext): typings.bucks.BucksNs.Bucks = js.native
  /**
    * Add delay execution.
    * @param ms number millisecond for delaying
    */
  def delay(ms: Double): typings.bucks.BucksNs.Bucks = js.native
  /**
    ...
    */
  def destroy(): typings.bucks.BucksNs.Bucks = js.native
  def destroy(err: Error): typings.bucks.BucksNs.Bucks = js.native
  /**
  ...
  /**
    * Add a empty task.
    */
  def empty(): typings.bucks.BucksNs.Bucks = js.native
  /**
  ...
  /**
    ...
    */
  def error(onError: js.Function2[/* err */ Error, /* next */ js.UndefOr[Task], _]): typings.bucks.BucksNs.Bucks = js.native
  /**
    ...
    */
  def parallel(tasks: js.Array[TaskWithNext]): typings.bucks.BucksNs.Bucks = js.native
  /**
    * Add a task called only in case of success.
    * @param onSuccess Function called only in case of success
    */
  def `then`(onSuccess: js.Function2[/* res */ js.Any, /* next */ js.UndefOr[Task], _]): typings.bucks.BucksNs.Bucks = js.native
  /**
    * Add tasks in asynchronous way and join their results.
    * @param tasks Functions added async chain
    */
  def waterfall(tasks: js.Array[TaskWithNext]): typings.bucks.BucksNs.Bucks = js.native
}
