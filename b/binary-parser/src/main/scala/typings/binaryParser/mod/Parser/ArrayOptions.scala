...
trait ArrayOptions extends Options {
  ...
  var `type`: String | typings.binaryParser.mod.Parser[_]
}

object ArrayOptions {
  @scala.inline
  def apply(
    `type`: String | typings.binaryParser.mod.Parser[_],
    ...
    lengthInBytes: Double | String | (js.ThisFunction0[/* this */ typings.binaryParser.mod.Parser[_], Double]) = null,
