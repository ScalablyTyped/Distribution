...
trait ArrayOptions extends Options {
  ...
  var lengthInBytes: js.UndefOr[Double | String | (js.ThisFunction0[/* this */ Parser[_], Double])] = js.undefined
  var readUntil: js.UndefOr[String | (js.Function2[/* item */ Double, /* buffer */ Buffer, Boolean])] = js.undefined
  var `type`: String | Parser[_]
}

object ArrayOptions {
  @scala.inline
  def apply(
    `type`: String | Parser[_],
    ...
    lengthInBytes: Double | String | (js.ThisFunction0[/* this */ Parser[_], Double]) = null,
