...
object compassMod extends Shortcut {
  ...
  @JSImport("@blueprintjs/icons/lib/esm/generated/16px/paths/compass", JSImport.Default)
  @js.native
  val default: js.Array[String] = js.native
  
  type _To = js.Array[String]
  
  /* This means you don't have to write `default`, but can instead just say `compassMod.foo` */
