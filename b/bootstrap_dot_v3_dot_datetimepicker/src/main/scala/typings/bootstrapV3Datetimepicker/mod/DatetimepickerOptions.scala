...
object DatetimepickerOptions {
  ...
  def apply(
    ...
    widgetParent: js.UndefOr[Null | String | JQuery] = js.undefined,
    ...
    if (!js.isUndefined(widgetParent)) __obj.updateDynamic("widgetParent")(widgetParent.asInstanceOf[js.Any])
