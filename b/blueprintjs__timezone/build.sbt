...
version := "3.3.0-dd8e33"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "blueprintjs__core" % "3.12.0-438d80",
  "org.scalablytyped" %%% "blueprintjs__icons" % "3.5.1-0d65b4",
  "org.scalablytyped" %%% "blueprintjs__select" % "3.6.0-581fb5",
  ...
  "org.scalablytyped" %%% "moment-timezone" % "0.5-dt-20181231Z-d3b602",
