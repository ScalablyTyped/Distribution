...
version := "3.6.8-b83db7"
scalaVersion := "2.13.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "blueprintjs__core" % "3.29.0-270ae2",
  "org.scalablytyped" %%% "blueprintjs__icons" % "3.19.0-801f2e",
  ...
  "org.scalablytyped" %%% "react-popper" % "1.3.7-614371",
