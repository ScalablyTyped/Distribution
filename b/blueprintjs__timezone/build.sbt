...
version := "4.5.11-d82bff"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "blueprintjs__core" % "4.12.0-cf2671",
  "org.scalablytyped" %%% "blueprintjs__icons" % "4.10.1-7a934f",
  "org.scalablytyped" %%% "csstype" % "3.1.1-ab3df7",
  "org.scalablytyped" %%% "popper_dot_js" % "1.16.1-4194ce",
  "org.scalablytyped" %%% "popperjs__core" % "2.11.6-2bc718",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20220407Z-53873f",
  "org.scalablytyped" %%% "react" % "18.0-dt-20221104Z-9ff1b2",
  "org.scalablytyped" %%% "react-popper" % "2.3.0-8f18ab",
