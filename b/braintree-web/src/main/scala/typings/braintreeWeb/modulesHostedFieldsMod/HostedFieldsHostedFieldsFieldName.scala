...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.braintreeWeb.braintreeWebStrings.cardholderName
*/
trait HostedFieldsHostedFieldsFieldName extends StObject
object HostedFieldsHostedFieldsFieldName {
  
  inline def cardholderName: typings.braintreeWeb.braintreeWebStrings.cardholderName = "cardholderName".asInstanceOf[typings.braintreeWeb.braintreeWebStrings.cardholderName]
