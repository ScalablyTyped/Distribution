...
class NodePath[T] protected () extends js.Object {
  ...
  def getFunctionParent(): NodePath[atBabelTypesLib.typesMod.Function] = js.native
  // ------------------------- family -------------------------
  ...
  def getStatementParent(): NodePath[atBabelTypesLib.typesMod.Statement] = js.native
  // ------------------------- inference -------------------------
  /** Infer the type of the current `NodePath`. */
  def getTypeAnnotation(): atBabelTypesLib.typesMod.FlowType = js.native
  /**
