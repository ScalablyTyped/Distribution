...
class Scope protected () extends js.Object {
  ...
  def generateDeclaredUidIdentifier(): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  def generateDeclaredUidIdentifier(name: java.lang.String): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  /** Generate a unique `_id1` binding. */
  def generateUid(): java.lang.String = js.native
  def generateUid(name: java.lang.String): java.lang.String = js.native
  /** Generate a unique identifier. */
  def generateUidIdentifier(): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  def generateUidIdentifier(name: java.lang.String): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  /** Generate a unique identifier based on a node. */
  def generateUidIdentifierBasedOnNode(parent: Node): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  def generateUidIdentifierBasedOnNode(parent: Node, defaultName: java.lang.String): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  ...
  def getBindingIdentifier(name: java.lang.String): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  ...
  def getOwnBindingIdentifier(name: java.lang.String): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  ...
  def maybeGenerateMemoised(node: Node): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
  def maybeGenerateMemoised(node: Node, dontPush: scala.Boolean): atBabelTypesLib.atBabelTypesMod.Identifier = js.native
