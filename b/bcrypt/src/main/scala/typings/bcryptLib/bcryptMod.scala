...
object bcryptMod extends js.Object {
  def compare(data: js.Any, encrypted: java.lang.String): js.Promise[scala.Boolean] = js.native
  def compare(
    data: js.Any,
  ...
  def genSalt(callback: js.Function2[/* err */ stdLib.Error, /* salt */ java.lang.String, scala.Unit]): js.Promise[java.lang.String] = js.native
  ...
  def genSalt(rounds: scala.Double, minor: java.lang.String): js.Promise[java.lang.String] = js.native
  def genSalt(
    rounds: scala.Double,
  ...
  def hash(data: js.Any, saltOrRounds: java.lang.String): js.Promise[java.lang.String] = js.native
  def hash(
    data: js.Any,
    saltOrRounds: java.lang.String,
    callback: js.Function2[/* err */ stdLib.Error, /* encrypted */ java.lang.String, scala.Unit]
  ): js.Promise[java.lang.String] = js.native
  def hash(data: js.Any, saltOrRounds: scala.Double): js.Promise[java.lang.String] = js.native
  def hash(
    data: js.Any,
