...
trait Parser extends js.Object {
  ...
  /**
    ...
    */
  def getBrowserName(): java.lang.String = js.native
  /**
    * Get browser's version
    * @return {String} version of browser
    */
  def getBrowserVersion(): java.lang.String = js.native
  /**
    * Get parsed engine
  ...
  def getOSName(toLowerCase: scala.Boolean): java.lang.String = js.native
  /**
    * Get OS version
    * @return {String} full version with dots ('10.11.12', '5.6', etc)
    */
  def getOSVersion(): java.lang.String = js.native
  /**
    * Get parsed platform
  ...
  /**
    ...
    */
  def getPlatformType(): java.lang.String = js.native
  def getPlatformType(toLowerCase: scala.Boolean): java.lang.String = js.native
  /**
    * Get parsed result
    * @return {ParsedResult}
    */
  ...
  /**
    ...
    * @returns {Boolean}
    */
  def is(anything: js.Any): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def satisfies(checkTree: checkTree): js.UndefOr[scala.Boolean] = js.native
  /**
    ...
    */
  def some(anythings: js.Array[java.lang.String]): js.UndefOr[scala.Boolean] = js.native
  /**
    * Test a UA string for a regexp
    * @param regex
    * @returns {boolean} true if the regex matches the UA, false otherwise.
    */
  def test(regex: stdLib.RegExp): scala.Boolean = js.native
}
