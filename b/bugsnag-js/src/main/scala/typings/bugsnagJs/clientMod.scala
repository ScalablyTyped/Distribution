...
object clientMod {
  ...
  open class Client () extends StObject {
    ...
    var BugsnagReport: (Instantiable4[
        ...
        typings.bugsnagJs.reportMod.default
  ...
  object INotifyOpts {
    ...
    extension [Self <: INotifyOpts](x: Self) {
      ...
      inline def setBeforeSend(value: /* report */ typings.bugsnagJs.reportMod.default => Boolean | Unit): Self = StObject.set(x, "beforeSend", js.Any.fromFunction1(value))
  ...
  object IReportPayload {
    ...
    inline def apply(apiKey: String, events: js.Array[typings.bugsnagJs.reportMod.default], notifier: Name): IReportPayload = {
    ...
    extension [Self <: IReportPayload](x: Self) {
      ...
      inline def setEvents(value: js.Array[typings.bugsnagJs.reportMod.default]): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
      
      inline def setEventsVarargs(value: typings.bugsnagJs.reportMod.default*): Self = StObject.set(x, "events", js.Array(value*))
