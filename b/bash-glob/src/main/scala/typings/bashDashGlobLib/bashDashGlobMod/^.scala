...
object ^ extends js.Object {
  ...
  def apply(pattern: bashDashGlobLib.Patterns, options: Options, callback: bashDashGlobLib.Callback): scala.Unit = js.native
  def each(patterns: bashDashGlobLib.Patterns, callback: bashDashGlobLib.Callback): scala.Unit = js.native
  def each(patterns: bashDashGlobLib.Patterns, options: Options, callback: bashDashGlobLib.Callback): scala.Unit = js.native
  @JSName("on")
  def on_end(
  ...
  def promise(patterns: bashDashGlobLib.Patterns, options: Options): js.Promise[js.Array[java.lang.String]] = js.native
  def sync(patterns: bashDashGlobLib.Patterns): js.Array[java.lang.String] = js.native
  def sync(patterns: bashDashGlobLib.Patterns, options: Options): js.Array[java.lang.String] = js.native
}
