...
trait TransformOptions extends js.Object {
  ...
  /**
       ...
       * Default: `{}`
       */
  var generatorOpts: js.UndefOr[atBabelGeneratorLib.generatorMod.GeneratorOptions | scala.Null] = js.undefined
  /**
  ...
  /**
       ...
       * Default: `{}`
       */
  var parserOpts: js.UndefOr[atBabelParserLib.parserMod.ParserOptions | scala.Null] = js.undefined
  /**
  ...
  var wrapPluginVisitorMethod: js.UndefOr[
    (js.Function3[
      ...
      /* callback */ js.Function2[
        /* path */ atBabelTraverseLib.traverseMod.NodePath[atBabelTraverseLib.traverseMod.Node], 
        /* state */ js.Any, 
        scala.Unit
      ], 
      js.Function2[
