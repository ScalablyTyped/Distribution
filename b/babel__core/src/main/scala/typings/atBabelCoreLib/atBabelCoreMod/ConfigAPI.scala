...
trait ConfigAPI extends js.Object {
  ...
  def assertVersion(versionRange: java.lang.String): scala.Boolean = js.native
  /**
    ...
    */
  def assertVersion(versionRange: scala.Double): scala.Boolean = js.native
  ...
  /**
    * @see https://babeljs.io/docs/en/next/config-files#apienv
    */
  def env(): java.lang.String = js.native
  /**
  ...
  /**
    * @see https://babeljs.io/docs/en/next/config-files#apienv
    */
  def env(envName: java.lang.String): scala.Boolean = js.native
  def env(envName: js.Array[java.lang.String]): scala.Boolean = js.native
  ...
  /**
    * @see https://babeljs.io/docs/en/next/config-files#apienv
    */
  def env[T /* <: SimpleCacheKey */](envCallback: js.Function1[/* envName */ stdLib.NonNullable[js.UndefOr[java.lang.String]], T]): T = js.native
}
