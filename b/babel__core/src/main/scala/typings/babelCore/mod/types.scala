...
object types {
  ...
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any]).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typings.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  ...
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typings.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  ...
  inline def isPlaceholderType(
    placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any,
    targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any
  ...
  inline def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 248, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isType")(nodetype.asInstanceOf[js.Any], targetType.asInstanceOf[js.Any])).asInstanceOf[/* is T */ Boolean]
