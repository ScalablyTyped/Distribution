...
object types {
  ...
  inline def addComment[T /* <: typings.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComment")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], content.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def addComment[T /* <: typings.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, content: String, line: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComment")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], content.asInstanceOf[js.Any], line.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def addComments[T /* <: typings.babelTypes.mod.Node */](node: T, `type`: CommentTypeShorthand, comments: js.Array[Comment]): T = (^.asInstanceOf[js.Dynamic].applyDynamic("addComments")(node.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], comments.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def cloneDeep[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneDeep")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def cloneDeepWithoutLoc[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneDeepWithoutLoc")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def cloneNode[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def cloneNode[T /* <: typings.babelTypes.mod.Node */](n: T, deep: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def cloneNode[T /* <: typings.babelTypes.mod.Node */](n: T, deep: Boolean, withoutLoc: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any], withoutLoc.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def cloneNode[T /* <: typings.babelTypes.mod.Node */](n: T, deep: Unit, withoutLoc: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(n.asInstanceOf[js.Any], deep.asInstanceOf[js.Any], withoutLoc.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def cloneWithoutLoc[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneWithoutLoc")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def clone_[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  inline def ensureBlock(node: Extract[typings.babelTypes.mod.Node, Body]): BlockStatement_ = ^.asInstanceOf[js.Dynamic].applyDynamic("ensureBlock")(node.asInstanceOf[js.Any]).asInstanceOf[BlockStatement_]
  ...
  inline def getBindingIdentifiers(node: typings.babelTypes.mod.Node): Record[String, Identifier_] = ^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any]).asInstanceOf[Record[String, Identifier_]]
  inline def getBindingIdentifiers(node: typings.babelTypes.mod.Node, duplicates: Boolean): Record[String, Identifier_ | js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_ | js.Array[Identifier_]]]
  ...
  inline def getBindingIdentifiers_false(node: typings.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  ...
  inline def getBindingIdentifiers_true(node: typings.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Array[Identifier_]]]
  ...
  inline def getOuterBindingIdentifiers(node: typings.babelTypes.mod.Node): Record[String, Identifier_] = ^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any]).asInstanceOf[Record[String, Identifier_]]
  ...
  inline def getOuterBindingIdentifiers_false(node: typings.babelTypes.mod.Node, duplicates: `false`): Record[String, Identifier_] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, Identifier_]]
  
  inline def getOuterBindingIdentifiers_true(node: typings.babelTypes.mod.Node, duplicates: `true`): Record[String, js.Array[Identifier_]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getOuterBindingIdentifiers")(node.asInstanceOf[js.Any], duplicates.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Array[Identifier_]]]
  ...
  inline def inheritInnerComments(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritInnerComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inheritLeadingComments(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritLeadingComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inheritTrailingComments(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritTrailingComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def inherits[T /* <: js.UndefOr[typings.babelTypes.mod.Node | Null] */](child: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("inherits")(child.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def inherits[T /* <: js.UndefOr[typings.babelTypes.mod.Node | Null] */](child: T, parent: typings.babelTypes.mod.Node): T = (^.asInstanceOf[js.Dynamic].applyDynamic("inherits")(child.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def inheritsComments[T /* <: typings.babelTypes.mod.Node */](node: T, parent: typings.babelTypes.mod.Node): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("inheritsComments")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def is(`type`: String, n: Null, required: Partial[typings.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is(`type`: String, n: Unit, required: Partial[typings.babelTypes.mod.Node]): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  inline def is(`type`: String, n: typings.babelTypes.mod.Node): /* is @babel/types.@babel/types.Node */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Node */ Boolean]
  ...
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any]).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typings.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any])).asInstanceOf[/* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean]
  inline def is[P /* <: typings.babelTypes.mod.Node */](`type`: String, n: Null, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[P /* <: typings.babelTypes.mod.Node */](`type`: String, n: Unit, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[P /* <: typings.babelTypes.mod.Node */](`type`: String, n: typings.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  inline def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typings.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("is")(`type`.asInstanceOf[js.Any], n.asInstanceOf[js.Any], required.asInstanceOf[js.Any])).asInstanceOf[/* is P */ Boolean]
  ...
  inline def isBinding(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isBinding")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isBlockScoped(node: typings.babelTypes.mod.Node): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isBlockScoped")(node.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def isImmutable(node: typings.babelTypes.mod.Node): /* is @babel/types.@babel/types.Immutable */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isImmutable")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.Immutable */ Boolean]
  ...
  inline def isLet(node: typings.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isLet")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.VariableDeclaration */ Boolean]
  ...
  inline def isNodesEquivalent_T[T /* <: Partial[typings.babelTypes.mod.Node] */](a: T, b: Any): /* is T */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isNodesEquivalent")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[/* is T */ Boolean]
  ...
  inline def isPlaceholderType(
    placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any,
    targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any
  ...
  inline def isReferenced(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isReferenced")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isScope(node: typings.babelTypes.mod.Node, parent: typings.babelTypes.mod.Node): /* is @babel/types.@babel/types.Scopable */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isScope")(node.asInstanceOf[js.Any], parent.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.Scopable */ Boolean]
  ...
  inline def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.babelCore.babelCoreStrings.ClassAccessorProperty, typings.babelCore.babelCoreStrings.AnyTypeAnnotation, typings.babelCore.babelCoreStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isType")(nodetype.asInstanceOf[js.Any], targetType.asInstanceOf[js.Any])).asInstanceOf[/* is T */ Boolean]
  ...
  inline def isVar(node: typings.babelTypes.mod.Node): /* is @babel/types.@babel/types.VariableDeclaration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isVar")(node.asInstanceOf[js.Any]).asInstanceOf[/* is @babel/types.@babel/types.VariableDeclaration */ Boolean]
  ...
  inline def matchesPattern(node: typings.babelTypes.mod.Node, `match`: String): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  inline def matchesPattern(node: typings.babelTypes.mod.Node, `match`: String, allowPartial: Boolean): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any], allowPartial.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  inline def matchesPattern(node: typings.babelTypes.mod.Node, `match`: js.Array[String]): /* is @babel/types.@babel/types.MemberExpression */ Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("matchesPattern")(node.asInstanceOf[js.Any], `match`.asInstanceOf[js.Any])).asInstanceOf[/* is @babel/types.@babel/types.MemberExpression */ Boolean]
  ...
  inline def removeComments[T /* <: typings.babelTypes.mod.Node */](node: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("removeComments")(node.asInstanceOf[js.Any]).asInstanceOf[T]
  
  inline def removeProperties(n: typings.babelTypes.mod.Node): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProperties")(n.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def removeProperties(n: typings.babelTypes.mod.Node, opts: PreserveComments): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("removeProperties")(n.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def removePropertiesDeep[T /* <: typings.babelTypes.mod.Node */](n: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("removePropertiesDeep")(n.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def removePropertiesDeep[T /* <: typings.babelTypes.mod.Node */](n: T, opts: PreserveComments): T = (^.asInstanceOf[js.Dynamic].applyDynamic("removePropertiesDeep")(n.asInstanceOf[js.Any], opts.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def toComputedKey[T /* <: Extract[typings.babelTypes.mod.Node, Computed] */](node: T): Expression = ^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any]).asInstanceOf[Expression]
  inline def toComputedKey[T /* <: Extract[typings.babelTypes.mod.Node, Computed] */](node: T, key: Expression): Expression = (^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Expression]
  inline def toComputedKey[T /* <: Extract[typings.babelTypes.mod.Node, Computed] */](node: T, key: Identifier_): Expression = (^.asInstanceOf[js.Dynamic].applyDynamic("toComputedKey")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[Expression]
  ...
  inline def toKeyAlias(node: Method, key: typings.babelTypes.mod.Node): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toKeyAlias")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def toKeyAlias(node: Property, key: typings.babelTypes.mod.Node): String = (^.asInstanceOf[js.Dynamic].applyDynamic("toKeyAlias")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[String]
  
  inline def toSequenceExpression(nodes: js.Array[typings.babelTypes.mod.Node], scope: BuildUndefinedNode): js.UndefOr[SequenceExpression_] = (^.asInstanceOf[js.Dynamic].applyDynamic("toSequenceExpression")(nodes.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[SequenceExpression_]]
  ...
  inline def traverse[T](n: typings.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typings.babelTypes.mod.Node, h: TraversalHandlers[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typings.babelTypes.mod.Node, h: TraversalHandlers[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverse[T](n: typings.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverse")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def traverseFast[T](n: typings.babelTypes.mod.Node, h: TraversalHandler[T]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverseFast")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def traverseFast[T](n: typings.babelTypes.mod.Node, h: TraversalHandler[T], state: T): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverseFast")(n.asInstanceOf[js.Any], h.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def validate(n: typings.babelTypes.mod.Node, key: String, value: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("validate")(n.asInstanceOf[js.Any], key.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def validate[T /* <: typings.babelTypes.mod.Node */, K /* <: /* keyof T */ String */](
    n: Null,
    key: K,
