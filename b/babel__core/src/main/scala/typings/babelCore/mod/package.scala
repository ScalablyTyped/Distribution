...
inline def DEFAULT_EXTENSIONS: js.Tuple5[
...
inline def createConfigItem(value: js.Tuple2[typings.babelCore.mod.PluginTarget, typings.babelCore.mod.PluginOptions]): typings.babelCore.mod.ConfigItem = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createConfigItem")(value.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.ConfigItem]
...
inline def createConfigItem(value: typings.babelCore.mod.PluginTarget): typings.babelCore.mod.ConfigItem = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createConfigItem")(value.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.ConfigItem]
...
inline def loadOptions(): js.Object | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("loadOptions")().asInstanceOf[js.Object | scala.Null]
inline def loadOptions(options: typings.babelCore.mod.TransformOptions): js.Object | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("loadOptions")(options.asInstanceOf[js.Any]).asInstanceOf[js.Object | scala.Null]

inline def loadPartialConfig(): typings.babelCore.anon.ReadonlyPartialConfig | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("loadPartialConfig")().asInstanceOf[typings.babelCore.anon.ReadonlyPartialConfig | scala.Null]
inline def loadPartialConfig(options: typings.babelCore.mod.TransformOptions): typings.babelCore.anon.ReadonlyPartialConfig | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("loadPartialConfig")(options.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.anon.ReadonlyPartialConfig | scala.Null]

inline def parse(code: java.lang.String): typings.babelCore.mod.ParseResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parse")(code.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.ParseResult | scala.Null]
inline def parse(code: java.lang.String, callback: typings.babelCore.mod.FileParseCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parse")(code.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
inline def parse(code: java.lang.String, options: scala.Unit, callback: typings.babelCore.mod.FileParseCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parse")(code.asInstanceOf[js.Any], options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
inline def parse(code: java.lang.String, options: typings.babelCore.mod.TransformOptions): typings.babelCore.mod.ParseResult | scala.Null = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parse")(code.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.babelCore.mod.ParseResult | scala.Null]
inline def parse(
...
inline def parseAsync(code: java.lang.String): js.Promise[typings.babelCore.mod.ParseResult | scala.Null] = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parseAsync")(code.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.babelCore.mod.ParseResult | scala.Null]]
...
inline def parseSync(code: java.lang.String): typings.babelCore.mod.ParseResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("parseSync")(code.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.ParseResult | scala.Null]
...
inline def resolvePlugin(name: java.lang.String, dirname: java.lang.String): java.lang.String | scala.Null = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("resolvePlugin")(name.asInstanceOf[js.Any], dirname.asInstanceOf[js.Any])).asInstanceOf[java.lang.String | scala.Null]

inline def resolvePreset(name: java.lang.String, dirname: java.lang.String): java.lang.String | scala.Null = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("resolvePreset")(name.asInstanceOf[js.Any], dirname.asInstanceOf[js.Any])).asInstanceOf[java.lang.String | scala.Null]

inline def template: typings.babelTemplate.mod.DefaultTemplateBuilder = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].selectDynamic("template").asInstanceOf[typings.babelTemplate.mod.DefaultTemplateBuilder]

inline def transform(code: java.lang.String): typings.babelCore.mod.BabelFileResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transform")(code.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.BabelFileResult | scala.Null]
inline def transform(code: java.lang.String, callback: typings.babelCore.mod.FileResultCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transform")(code.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
inline def transform(code: java.lang.String, opts: scala.Unit, callback: typings.babelCore.mod.FileResultCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transform")(code.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
inline def transformAsync(code: java.lang.String): js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null] = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformAsync")(code.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null]]
...
inline def transformFile(filename: java.lang.String, callback: typings.babelCore.mod.FileResultCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFile")(filename.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
inline def transformFile(filename: java.lang.String, opts: scala.Unit, callback: typings.babelCore.mod.FileResultCallback): scala.Unit = (typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFile")(filename.asInstanceOf[js.Any], opts.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
inline def transformFileAsync(filename: java.lang.String): js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null] = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFileAsync")(filename.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null]]
...
inline def transformFileSync(filename: java.lang.String): typings.babelCore.mod.BabelFileResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFileSync")(filename.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.BabelFileResult | scala.Null]
...
inline def transformFromAstAsync(ast: typings.babelCore.mod.Node): js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null] = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFromAstAsync")(ast.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typings.babelCore.mod.BabelFileResult | scala.Null]]
...
inline def transformFromAstAsync(
  ast: typings.babelCore.mod.Node,
  code: java.lang.String,
  opts: typings.babelCore.mod.TransformOptions
...
inline def transformFromAstSync(ast: typings.babelCore.mod.Node): typings.babelCore.mod.BabelFileResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformFromAstSync")(ast.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.BabelFileResult | scala.Null]
...
inline def transformSync(code: java.lang.String): typings.babelCore.mod.BabelFileResult | scala.Null = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("transformSync")(code.asInstanceOf[js.Any]).asInstanceOf[typings.babelCore.mod.BabelFileResult | scala.Null]
...
inline def version: java.lang.String = typings.babelCore.mod.^.asInstanceOf[js.Dynamic].selectDynamic("version").asInstanceOf[java.lang.String]
