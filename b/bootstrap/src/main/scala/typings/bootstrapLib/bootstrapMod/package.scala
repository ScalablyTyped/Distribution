...
package object bootstrapMod {
  type AlertEvent = bootstrapLib.bootstrapLibStrings.closeDOTbsDOTalert | bootstrapLib.bootstrapLibStrings.closedDOTbsDOTalert
  type CarouselEvent = bootstrapLib.bootstrapLibStrings.slideDOTbsDOTcarousel | bootstrapLib.bootstrapLibStrings.slidDOTbsDOTcarousel
  type CollapseEvent = bootstrapLib.bootstrapLibStrings.showDOTbsDOTcollapse | bootstrapLib.bootstrapLibStrings.shownDOTbsDOTcollapse | bootstrapLib.bootstrapLibStrings.hideDOTbsDOTcollapse | bootstrapLib.bootstrapLibStrings.hiddenDOTbsDOTcollapse
  type DropdownEvent = bootstrapLib.bootstrapLibStrings.showDOTbsDOTdropdown | bootstrapLib.bootstrapLibStrings.shownDOTbsDOTdropdown | bootstrapLib.bootstrapLibStrings.hideDOTbsDOTdropdown | bootstrapLib.bootstrapLibStrings.hiddenDOTbsDOTdropdown
  type ModalEvent = bootstrapLib.bootstrapLibStrings.showDOTbsDOTmodal | bootstrapLib.bootstrapLibStrings.shownDOTbsDOTmodal | bootstrapLib.bootstrapLibStrings.hideDOTbsDOTmodal | bootstrapLib.bootstrapLibStrings.hiddenDOTbsDOTmodal
  type Placement = bootstrapLib.bootstrapLibStrings.auto | bootstrapLib.bootstrapLibStrings.top | bootstrapLib.bootstrapLibStrings.bottom | bootstrapLib.bootstrapLibStrings.left | bootstrapLib.bootstrapLibStrings.right
