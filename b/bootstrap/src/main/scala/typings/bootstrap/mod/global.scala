...
import typings.bootstrap.carouselMod.Carousel.Events
import typings.bootstrap.modalMod.Modal.Event
...
object global {
  ...
  trait Element extends StObject {
    ...
    def addEventListener(
      ...
      listener: js.ThisFunction1[
          /* this */ this.type, 
          (/* ev */ Event) | (/* ev */ typings.bootstrap.carouselMod.Carousel.Event), 
          Any
        ]
    ): Unit = js.native
    def addEventListener(
    ...
    def addEventListener(
      `type`: Events,
      listener: js.ThisFunction1[/* this */ this.type, /* ev */ typings.bootstrap.carouselMod.Carousel.Event, Any]
    ): Unit = js.native
    def addEventListener(
      `type`: Events,
      listener: js.ThisFunction1[/* this */ this.type, /* ev */ typings.bootstrap.carouselMod.Carousel.Event, Any],
    ...
    def addEventListener(
      `type`: typings.bootstrap.modalMod.Modal.Events,
  ...
  trait JQuery extends StObject {
    ...
    @JSName("button")
    var button_Original: typings.bootstrap.buttonMod.Button.jQueryInterface = js.native
    ...
    @JSName("carousel")
    var carousel_Original: typings.bootstrap.carouselMod.Carousel.jQueryInterface = js.native
    ...
    @JSName("collapse")
    var collapse_Original: typings.bootstrap.collapseMod.Collapse.jQueryInterface = js.native
    ...
    @JSName("dropdown")
    var dropdown_Original: typings.bootstrap.dropdownMod.Dropdown.jQueryInterface = js.native
    ...
    @JSName("modal")
    var modal_Original: typings.bootstrap.modalMod.Modal.jQueryInterface = js.native
    
    def offcanvas(): JQuery = js.native
    def offcanvas(config: toggle | show | hide): JQuery = js.native
    @JSName("offcanvas")
    var offcanvas_Original: typings.bootstrap.offcanvasMod.Offcanvas.jQueryInterface = js.native
    ...
    @JSName("scrollspy")
    var scrollspy_Original: typings.bootstrap.scrollspyMod.ScrollSpy.jQueryInterface = js.native
    
    def tab(): JQuery = js.native
    def tab(config: show | dispose): JQuery = js.native
    @JSName("tab")
    var tab_Original: typings.bootstrap.tabMod.Tab.jQueryInterface = js.native
    ...
    @JSName("toast")
    var toast_Original: typings.bootstrap.toastMod.Toast.jQueryInterface = js.native
  }
}
