...
object anon {
  ...
  trait RecordkeyofHTMLElementTag extends StObject {
    ...
    var search: js.Array[String | js.RegExp]
  ...
  object RecordkeyofHTMLElementTag {
    ...
    inline def apply(
      ...
      search: js.Array[String | js.RegExp],
    ...
    implicit open class MutableBuilder[Self <: RecordkeyofHTMLElementTag] (val x: Self) extends AnyVal {
      ...
      inline def setSearch(value: js.Array[String | js.RegExp]): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
      
      inline def setSearchVarargs(value: (String | js.RegExp)*): Self = StObject.set(x, "search", js.Array(value*))
