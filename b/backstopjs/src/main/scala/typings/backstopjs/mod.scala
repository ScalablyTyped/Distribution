...
object mod {
  ...
  */
  ...
  object Viewport {
    ...
    inline def ViewportLegacy(height: Double, name: phone | tablet | desktop, width: Double): typings.backstopjs.mod.ViewportLegacy = {
    ...
    inline def ViewportNext(height: Double, label: String, width: Double): typings.backstopjs.mod.ViewportNext = {
