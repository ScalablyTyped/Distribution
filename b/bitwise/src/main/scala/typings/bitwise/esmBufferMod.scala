...
object esmBufferMod {
  ...
  inline def create(bits: typings.bitwise.esmTypesMod.Bits): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(bits.asInstanceOf[js.Any]).asInstanceOf[Buffer]
  
  inline def modify(buffer: Buffer, bits: typings.bitwise.esmTypesMod.Bits): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modify")(buffer.asInstanceOf[js.Any], bits.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def modify(buffer: Buffer, bits: typings.bitwise.esmTypesMod.Bits, offset: Double): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modify")(buffer.asInstanceOf[js.Any], bits.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def read(buffer: Buffer): typings.bitwise.esmTypesMod.Bits = ^.asInstanceOf[js.Dynamic].applyDynamic("read")(buffer.asInstanceOf[js.Any]).asInstanceOf[typings.bitwise.esmTypesMod.Bits]
  inline def read(buffer: Buffer, offset: Double): typings.bitwise.esmTypesMod.Bits = (^.asInstanceOf[js.Dynamic].applyDynamic("read")(buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any])).asInstanceOf[typings.bitwise.esmTypesMod.Bits]
  inline def read(buffer: Buffer, offset: Double, length: Double): typings.bitwise.esmTypesMod.Bits = (^.asInstanceOf[js.Dynamic].applyDynamic("read")(buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.bitwise.esmTypesMod.Bits]
  inline def read(buffer: Buffer, offset: Unit, length: Double): typings.bitwise.esmTypesMod.Bits = (^.asInstanceOf[js.Dynamic].applyDynamic("read")(buffer.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.bitwise.esmTypesMod.Bits]
