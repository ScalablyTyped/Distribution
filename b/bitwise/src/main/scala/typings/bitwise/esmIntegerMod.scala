...
object esmIntegerMod {
  ...
  inline def getBit(int32: Double, position: Double): typings.bitwise.esmTypesMod.Bit = (^.asInstanceOf[js.Dynamic].applyDynamic("getBit")(int32.asInstanceOf[js.Any], position.asInstanceOf[js.Any])).asInstanceOf[typings.bitwise.esmTypesMod.Bit]
  
  inline def setBit(int32: Double, position: Double, value: typings.bitwise.esmTypesMod.Bit): typings.bitwise.esmTypesMod.Bit = (^.asInstanceOf[js.Dynamic].applyDynamic("setBit")(int32.asInstanceOf[js.Any], position.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.bitwise.esmTypesMod.Bit]
