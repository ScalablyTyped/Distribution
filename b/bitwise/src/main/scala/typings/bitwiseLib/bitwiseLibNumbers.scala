...
object bitwiseLibNumbers {
  @js.native
  sealed trait `0`
    extends bitwiseLib.typesMod.Bit
       with bitwiseLib.typesMod.UInt4
       with bitwiseLib.typesMod.UInt8
  ...
  @js.native
  sealed trait `10`
    extends bitwiseLib.typesMod.UInt4
       with bitwiseLib.typesMod.UInt8
  
  @js.native
  sealed trait `100`
    extends bitwiseLib.typesMod.UInt8
