...
object bufferMod extends js.Object {
  ...
  def create(bits: js.Array[_]): nodeLib.Buffer = js.native
  def modify(buffer: nodeLib.Buffer, bits: js.Array[_]): scala.Unit = js.native
  def modify(buffer: nodeLib.Buffer, bits: js.Array[_], offset: scala.Double): scala.Unit = js.native
  ...
  def read(buffer: nodeLib.Buffer): js.Array[_] = js.native
  def read(buffer: nodeLib.Buffer, offset: scala.Double): js.Array[_] = js.native
  def read(buffer: nodeLib.Buffer, offset: scala.Double, length: scala.Double): js.Array[_] = js.native
