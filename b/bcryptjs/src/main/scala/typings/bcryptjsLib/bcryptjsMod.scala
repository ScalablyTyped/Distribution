...
object bcryptjsMod extends js.Object {
  def compare(s: java.lang.String, hash: java.lang.String): scala.Unit = js.native
  def compare(
    s: java.lang.String,
  ...
  @JSName("compare")
  def compare_Promise(s: java.lang.String, hash: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  ...
  def hash(s: java.lang.String, salt: java.lang.String): scala.Unit = js.native
  def hash(
    s: java.lang.String,
  ...
  def hash(s: java.lang.String, salt: scala.Double): scala.Unit = js.native
  def hash(
    s: java.lang.String,
    salt: scala.Double,
    callback: js.Function2[/* err */ stdLib.Error, /* hash */ java.lang.String, scala.Unit]
  ...
  @JSName("hash")
  def hash_Promise(s: java.lang.String, salt: java.lang.String): stdLib.Promise[java.lang.String] = js.native
  @JSName("hash")
  def hash_Promise(s: java.lang.String, salt: scala.Double): stdLib.Promise[java.lang.String] = js.native
