...
object transactionBuilderMod {
  ...
  class TransactionBuilder () extends StObject {
    ...
    /* private */ var __INPUTS: js.Any = js.native
    
    /* private */ var __PREV_TX_SET: js.Any = js.native
    
    /* private */ var __TX: js.Any = js.native
    
    /* private */ var __USE_LOW_R: js.Any = js.native
    
    /* private */ var __addInputUnsafe: js.Any = js.native
    
    /* private */ var __build: js.Any = js.native
    
    /* private */ var __canModifyInputs: js.Any = js.native
    
    /* private */ var __canModifyOutputs: js.Any = js.native
    
    /* private */ var __needsOutputs: js.Any = js.native
    
    /* private */ var __overMaximumFees: js.Any = js.native
    ...
    def addInput(txHash: String, vout: Double, sequence: Unit, prevOutScript: Buffer): Double = js.native
    ...
    def addInput(txHash: Transaction, vout: Double, sequence: Unit, prevOutScript: Buffer): Double = js.native
    ...
    def addInput(txHash: Buffer, vout: Double, sequence: Unit, prevOutScript: Buffer): Double = js.native
  ...
  object TransactionBuilder {
    ...
    inline def fromTransaction(transaction: Transaction): TransactionBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTransaction")(transaction.asInstanceOf[js.Any]).asInstanceOf[TransactionBuilder]
    inline def fromTransaction(transaction: Transaction, network: Network): TransactionBuilder = (^.asInstanceOf[js.Dynamic].applyDynamic("fromTransaction")(transaction.asInstanceOf[js.Any], network.asInstanceOf[js.Any])).asInstanceOf[TransactionBuilder]
  }
  ...
  object TxbSignArg {
    ...
    inline def apply(keyPair: Signer, prevOutScriptType: String, vin: Double): TxbSignArg = {
    ...
    extension [Self <: TxbSignArg](x: Self) {
      ...
      inline def setKeyPair(value: Signer): Self = StObject.set(x, "keyPair", value.asInstanceOf[js.Any])
      
      inline def setPrevOutScriptType(value: String): Self = StObject.set(x, "prevOutScriptType", value.asInstanceOf[js.Any])
      
      inline def setRedeemScript(value: Buffer): Self = StObject.set(x, "redeemScript", value.asInstanceOf[js.Any])
      
      inline def setRedeemScriptUndefined: Self = StObject.set(x, "redeemScript", js.undefined)
      
      inline def setVin(value: Double): Self = StObject.set(x, "vin", value.asInstanceOf[js.Any])
      
      inline def setWitnessScript(value: Buffer): Self = StObject.set(x, "witnessScript", value.asInstanceOf[js.Any])
      
      inline def setWitnessScriptUndefined: Self = StObject.set(x, "witnessScript", js.undefined)
      
      inline def setWitnessValue(value: Double): Self = StObject.set(x, "witnessValue", value.asInstanceOf[js.Any])
      
      inline def setWitnessValueUndefined: Self = StObject.set(x, "witnessValue", js.undefined)
    }
  }
}
