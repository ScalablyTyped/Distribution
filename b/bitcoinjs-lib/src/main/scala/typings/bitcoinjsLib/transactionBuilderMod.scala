...
object transactionBuilderMod {
  ...
  object TransactionBuilder {
    ...
    @scala.inline
    def fromTransaction(transaction: Transaction): TransactionBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("fromTransaction")(transaction.asInstanceOf[js.Any]).asInstanceOf[TransactionBuilder]
    @scala.inline
    def fromTransaction(transaction: Transaction, network: Network): TransactionBuilder = (^.asInstanceOf[js.Dynamic].applyDynamic("fromTransaction")(transaction.asInstanceOf[js.Any], network.asInstanceOf[js.Any])).asInstanceOf[TransactionBuilder]
  }
