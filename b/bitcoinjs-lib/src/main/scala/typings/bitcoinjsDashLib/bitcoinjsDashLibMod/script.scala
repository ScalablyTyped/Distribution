...
import typings.bitcoinjsDashLib.bitcoinjsDashLibStrings.multisig
...
object script extends js.Object {
  def classifyInput(script: js.Array[Buffer | Double]): pubkeyhash | scripthash | multisig | pubkey | nonstandard = js.native
  def classifyInput(script: js.Array[Buffer | Double], allowIncomplete: Boolean): pubkeyhash | scripthash | multisig | pubkey | nonstandard = js.native
  def classifyInput(script: Buffer): pubkeyhash | scripthash | multisig | pubkey | nonstandard = js.native
  def classifyInput(script: Buffer, allowIncomplete: Boolean): pubkeyhash | scripthash | multisig | pubkey | nonstandard = js.native
  def classifyOutput(script: js.Array[Buffer | Double]): witnesspubkeyhash | witnessscripthash | pubkeyhash | scripthash | multisig | pubkey | witnesscommitment | nulldata | nonstandard = js.native
  def classifyOutput(script: Buffer): witnesspubkeyhash | witnessscripthash | pubkeyhash | scripthash | multisig | pubkey | witnesscommitment | nulldata | nonstandard = js.native
