...
@js.native
trait Fn_Bfsutils extends js.Object {
  ...
  def apply(module: path): /* import warning: importer.ImportType#apply Failed type conversion: typeof path */ js.Any = js.native
  def apply(module: process): /* import warning: importer.ImportType#apply Failed type conversion: typeof process */ js.Any = js.native
}
