...
object distNodeBackendHtml5fsMod {
  ...
  open class HTML5FSFile protected ()
    extends typings.browserfs.distNodeGenericPreloadFileMod.default[HTML5FS]
       with File {
    def this(
      fs: HTML5FS,
      entry: FileEntry,
      path: String,
      flag: FileFlag,
      stat: typings.browserfs.distNodeCoreNodeFsStatsMod.default
    ) = this()
    def this(
      fs: HTML5FS,
      entry: FileEntry,
