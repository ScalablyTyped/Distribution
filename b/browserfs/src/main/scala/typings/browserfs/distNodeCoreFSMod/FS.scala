...
import typings.browserfs.Anon_AutoClose
import typings.browserfs.Anon_Encoding
import typings.browserfs.Anon_EncodingFd
import typings.browserfs.Anon_EncodingFlag
import typings.browserfs.Anon_EncodingFlagMode
import typings.browserfs.Anon_Flag
import typings.browserfs.Anon_Interval
import typings.browserfs.Anon_Persistent
...
trait FS extends js.Object {
  ...
  def appendFile(filename: String, data: js.Any, options: Anon_EncodingFlagMode): Unit = js.native
  def appendFile(filename: String, data: js.Any, options: Anon_EncodingFlagMode, cb: BFSOneArgCallback): Unit = js.native
  /**
    * Asynchronously append data to a file, creating the file if it not yet
    * exists.
    *
  ...
  def appendFileSync(filename: String, data: js.Any, options: Anon_EncodingFlagMode): Unit = js.native
  ...
  def createWriteStream(path: String, options: Anon_EncodingFd): WriteStream = js.native
  /**
  ...
  /**
    ...
    */
  def fstatSync(fd: Double): typings.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default = js.native
  /**
    * Asynchronous fsync.
    * @param fd
    * @param callback
  ...
  /**
    ...
    * @return [BrowserFS.node.fs.Stats]
    */
  def lstatSync(path: String): typings.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default = js.native
  /**
    * Asynchronous `mkdir`.
    * @param path
  ...
  def readFile(filename: String, options: Anon_Encoding, callback: BFSCallback[String]): Unit = js.native
  def readFile(filename: String, options: Anon_Flag, callback: BFSCallback[Buffer]): Unit = js.native
  /**
  ...
  def readFileSync(filename: String, options: Anon_Encoding): String = js.native
  def readFileSync(filename: String, options: Anon_Flag): Buffer = js.native
  ...
  /**
    ...
    * @return [BrowserFS.node.fs.Stats]
    */
  def statSync(path: String): typings.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default = js.native
  /**
  ...
  def unwatchFile(
    ...
    listener: js.Function2[
      /* curr */ typings.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default, 
      /* prev */ typings.browserfs.distNodeCoreNodeUnderscoreFsUnderscoreStatsMod.default, 
      Unit
    ]
  ): Unit = js.native
  /**
  ...
  def writeFile(filename: String, data: js.Any, options: Anon_EncodingFlag): Unit = js.native
  def writeFile(filename: String, data: js.Any, options: Anon_EncodingFlag, cb: BFSOneArgCallback): Unit = js.native
  /**
  ...
  def writeFileSync(filename: String, data: js.Any, options: Anon_EncodingFlagMode): Unit = js.native
  /**
    * Write buffer to the file specified by `fd`.
    * Note that it is unsafe to use fs.write multiple times on the same file
