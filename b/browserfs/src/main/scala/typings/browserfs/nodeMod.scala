...
object nodeMod {
  ...
  @JSImport("browserfs/dist/node", "BFSRequire")
  @js.native
  ...
  object Errors {
    ...
    object ApiError {
      ...
      /**
        ...
        */
      @JSImport("browserfs/dist/node", "Errors.ApiError.fromBuffer")
      @js.native
      ...
      @JSImport("browserfs/dist/node", "Errors.ApiError.fromJSON")
      @js.native
