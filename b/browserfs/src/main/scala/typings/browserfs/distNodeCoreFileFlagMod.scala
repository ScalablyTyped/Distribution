...
object distNodeCoreFileFlagMod {
  ...
  object ActionType extends StObject {
    ...
    sealed trait CREATE_FILE
      extends StObject
         with ActionType
    /* 3 */ val CREATE_FILE: typings.browserfs.distNodeCoreFileFlagMod.ActionType.CREATE_FILE & Double = js.native
    
    @js.native
    sealed trait NOP
      extends StObject
         with ActionType
    /* 0 */ val NOP: typings.browserfs.distNodeCoreFileFlagMod.ActionType.NOP & Double = js.native
    
    @js.native
    sealed trait THROW_EXCEPTION
      extends StObject
         with ActionType
    /* 1 */ val THROW_EXCEPTION: typings.browserfs.distNodeCoreFileFlagMod.ActionType.THROW_EXCEPTION & Double = js.native
    
    @js.native
    sealed trait TRUNCATE_FILE
      extends StObject
         with ActionType
    /* 2 */ val TRUNCATE_FILE: typings.browserfs.distNodeCoreFileFlagMod.ActionType.TRUNCATE_FILE & Double = js.native
  }
