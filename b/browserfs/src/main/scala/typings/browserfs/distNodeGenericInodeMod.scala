...
object distNodeGenericInodeMod {
  ...
  trait Inode extends StObject {
    ...
    /**
      ...
      */
    def toStats(): typings.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    /**
      ...
      */
    def update(stats: typings.browserfs.distNodeCoreNodeFsStatsMod.default): Boolean = js.native
  }
}
