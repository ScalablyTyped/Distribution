...
object distNodeCoreFSMod {
  ...
  trait FS extends StObject {
    ...
    def fstat(fd: Double, cb: BFSCallback[typings.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      */
    def fstatSync(fd: Double): typings.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def lstat(path: String, cb: BFSCallback[typings.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def lstatSync(path: String): typings.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def stat(path: String, cb: BFSCallback[typings.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    ...
    /**
      ...
      * @return [BrowserFS.node.fs.Stats]
      */
    def statSync(path: String): typings.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
    ...
    def unwatchFile(
      ...
      listener: js.Function2[
          /* curr */ typings.browserfs.distNodeCoreNodeFsStatsMod.default, 
          /* prev */ typings.browserfs.distNodeCoreNodeFsStatsMod.default, 
          Unit
        ]
    ): Unit = js.native
