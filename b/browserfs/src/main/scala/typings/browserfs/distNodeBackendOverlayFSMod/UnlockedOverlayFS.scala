...
class UnlockedOverlayFS protected ()
  ...
  def _syncAsync(
    file: typings.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[UnlockedOverlayFS],
    cb: BFSOneArgCallback
  ): Unit = js.native
  def _syncSync(file: typings.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[UnlockedOverlayFS]): Unit = js.native
