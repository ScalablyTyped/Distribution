...
object distNodeGenericPreloadFileMod {
  ...
  trait PreloadFile[T /* <: FileSystem */] extends BaseFile {
    ...
    /**
      ...
      * @param [Function(BrowserFS.ApiError, BrowserFS.node.fs.Stats)] cb
      */
    def stat(cb: BFSCallback[typings.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    
    /**
      * Synchronous `stat`.
      */
    def statSync(): typings.browserfs.distNodeCoreNodeFsStatsMod.default = js.native
