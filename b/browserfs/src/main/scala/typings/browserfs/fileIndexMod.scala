...
object fileIndexMod {
  ...
  class DirInode[T] ()
    ...
    /* private */ var _ls: js.Any = js.native
  ...
  object FileIndex {
    ...
    /**
      ...
      */
    inline def fromListing[T](listing: js.Any): FileIndex[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromListing")(listing.asInstanceOf[js.Any]).asInstanceOf[FileIndex[T]]
  }
  ...
  object Inode {
    ...
    inline def apply(isDir: () => Boolean, isFile: () => Boolean): Inode = {
