...
object fileIndexMod {
  ...
  object FileIndex {
    ...
    /**
      ...
      */
    @scala.inline
    def fromListing[T](listing: js.Any): FileIndex[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromListing")(listing.asInstanceOf[js.Any]).asInstanceOf[FileIndex[T]]
  }
  
  @JSImport("browserfs/dist/node/generic/file_index", "FileInode")
  @js.native
  class FileInode[T] protected ()
    extends StObject
       with Inode {
    def this(data: T) = this()
  ...
  @scala.inline
  def isDirInode[T](): /* is browserfs.browserfs/dist/node/generic/file_index.DirInode<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirInode")().asInstanceOf[/* is browserfs.browserfs/dist/node/generic/file_index.DirInode<T> */ Boolean]
  @scala.inline
  def isDirInode[T](inode: Inode): /* is browserfs.browserfs/dist/node/generic/file_index.DirInode<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirInode")(inode.asInstanceOf[js.Any]).asInstanceOf[/* is browserfs.browserfs/dist/node/generic/file_index.DirInode<T> */ Boolean]
  
  @scala.inline
  def isFileInode[T](): /* is browserfs.browserfs/dist/node/generic/file_index.FileInode<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFileInode")().asInstanceOf[/* is browserfs.browserfs/dist/node/generic/file_index.FileInode<T> */ Boolean]
  @scala.inline
  def isFileInode[T](inode: Inode): /* is browserfs.browserfs/dist/node/generic/file_index.FileInode<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFileInode")(inode.asInstanceOf[js.Any]).asInstanceOf[/* is browserfs.browserfs/dist/node/generic/file_index.FileInode<T> */ Boolean]
