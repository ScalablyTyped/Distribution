package typings.browserfs.distNodeBackendAsyncMirrorMod
...
trait AsyncMirror
  ...
  def _syncSync(fd: typings.browserfs.distNodeGenericPreloadUnderscoreFileMod.default[_]): Unit = js.native
