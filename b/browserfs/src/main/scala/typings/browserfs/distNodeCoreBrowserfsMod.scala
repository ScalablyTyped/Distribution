...
import typings.browserfs.distNodeGenericEmscriptenFsMod.default
...
object distNodeCoreBrowserfsMod {
  ...
  open class EmscriptenFS () extends default {
    ...
    def this(_FS: Any, _PATH: Any, _ERRNO_CODES: Any, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Any, _PATH: Any, _ERRNO_CODES: Unit, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Any, _PATH: Unit, _ERRNO_CODES: Any, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Any, _PATH: Unit, _ERRNO_CODES: Unit, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Unit, _PATH: Any, _ERRNO_CODES: Any, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Unit, _PATH: Any, _ERRNO_CODES: Unit, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Unit, _PATH: Unit, _ERRNO_CODES: Any, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
    def this(_FS: Unit, _PATH: Unit, _ERRNO_CODES: Unit, nodefs: typings.browserfs.distNodeCoreFSMod.default) = this()
  }
  ...
  object Errors {
    ...
    open class ApiError protected ()
      extends typings.browserfs.distNodeCoreApiErrorMod.ApiError {
      /**
