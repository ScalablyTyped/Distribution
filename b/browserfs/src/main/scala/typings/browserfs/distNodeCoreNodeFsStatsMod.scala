...
object distNodeCoreNodeFsStatsMod {
  ...
  object FileType extends StObject {
    ...
    sealed trait DIRECTORY
      extends StObject
         with FileType
    /* 16384 */ val DIRECTORY: typings.browserfs.distNodeCoreNodeFsStatsMod.FileType.DIRECTORY & Double = js.native
    
    @js.native
    sealed trait FILE
      extends StObject
         with FileType
    /* 32768 */ val FILE: typings.browserfs.distNodeCoreNodeFsStatsMod.FileType.FILE & Double = js.native
    
    @js.native
    sealed trait SYMLINK
      extends StObject
         with FileType
    /* 40960 */ val SYMLINK: typings.browserfs.distNodeCoreNodeFsStatsMod.FileType.SYMLINK & Double = js.native
  }
