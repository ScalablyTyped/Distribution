...
object distNodeBackendOverlayFSMod {
  ...
  open class UnlockedOverlayFS protected ()
    ...
    def _syncAsync(
      file: typings.browserfs.distNodeGenericPreloadFileMod.default[UnlockedOverlayFS],
      cb: BFSOneArgCallback
    ): Unit = js.native
    
    def _syncSync(file: typings.browserfs.distNodeGenericPreloadFileMod.default[UnlockedOverlayFS]): Unit = js.native
    ...
    def mkdir(p: String, mode: Double, cb: BFSCallback[typings.browserfs.distNodeCoreNodeFsStatsMod.default]): Unit = js.native
    /* InferMemberOverrides */
  ...
  @js.native
  trait OverlayFS
    extends typings.browserfs.distNodeGenericLockedFsMod.default[UnlockedOverlayFS] {
