...
trait LongLike[T] extends js.Object {
  ...
  def greaterThan(other: T): scala.Boolean = js.native
  /** Return whether `this` is greater than or equal to the `other`. */
  def greaterThanOrEqual(other: T): scala.Boolean = js.native
  ...
  def lessThan(other: T): scala.Boolean = js.native
  /** Return whether `this` is less than or equal to the `other`. */
  def lessThanOrEqual(other: T): scala.Boolean = js.native
  ...
  def notEquals(other: T): scala.Boolean = js.native
