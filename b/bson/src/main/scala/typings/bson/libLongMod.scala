...
import typings.bson.libTimestampMod.Timestamp
...
object libLongMod {
  ...
  open class Long () extends BSONValue {
    ...
    def comp(other: Double): `0` | `1` | `-1` = js.native
    ...
    def compare(other: Double): `0` | `1` | `-1` = js.native
    ...
    def mod(divisor: Double): Long = js.native
    ...
    def modulo(divisor: Double): Long = js.native
    ...
    def rem(divisor: Double): Long = js.native
    ...
    def toExtendedJSON(options: EJSONOptions): Double | LongExtended = js.native
  ...
  object Long {
    ...
    @JSImport("bson/lib/long", "Long.MAX_UNSIGNED_VALUE")
    @js.native
    ...
    @JSImport("bson/lib/long", "Long.MAX_VALUE")
    @js.native
    ...
    @JSImport("bson/lib/long", "Long.MIN_VALUE")
    @js.native
    ...
    /** Signed negative one. */
    @JSImport("bson/lib/long", "Long.NEG_ONE")
    @js.native
    ...
    inline def fromExtendedJSON(doc: NumberLong): Double | Long | js.BigInt = ^.asInstanceOf[js.Dynamic].applyDynamic("fromExtendedJSON")(doc.asInstanceOf[js.Any]).asInstanceOf[Double | Long | js.BigInt]
    inline def fromExtendedJSON(doc: NumberLong, options: EJSONOptions): Double | Long | js.BigInt = (^.asInstanceOf[js.Dynamic].applyDynamic("fromExtendedJSON")(doc.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double | Long | js.BigInt]
