...
object libBsonMod {
  ...
  @JSImport("bson/lib/bson", JSImport.Namespace)
  @js.native
  ...
  open class BSONError protected ()
    extends typings.bson.libErrorMod.BSONError {
  ...
  open class BSONRegExp protected ()
    extends typings.bson.libRegexpMod.BSONRegExp {
    /**
  ...
  open class BSONRuntimeError protected ()
    extends typings.bson.libErrorMod.BSONRuntimeError {
    def this(message: String) = this()
  }
  ...
  open class BSONSymbol protected ()
    extends typings.bson.libSymbolMod.BSONSymbol {
    /**
  ...
  open class BSONValue ()
    extends typings.bson.libBsonValueMod.BSONValue
  
  @JSImport("bson/lib/bson", "BSONVersionError")
  @js.native
  open class BSONVersionError ()
    extends typings.bson.libErrorMod.BSONVersionError
  ...
  /**
    ...
    */
  open class Binary ()
    extends typings.bson.libBinaryMod.Binary {
  ...
  open class Code protected ()
    extends typings.bson.libCodeMod.Code {
    /**
  ...
  open class DBRef protected ()
    extends typings.bson.libDbRefMod.DBRef {
    /**
  ...
  open class Decimal128 protected ()
    extends typings.bson.libDecimal128Mod.Decimal128 {
  ...
  open class Double protected ()
    extends typings.bson.libDoubleMod.Double {
    /**
  ...
  open class Int32 protected ()
    extends typings.bson.libInt32Mod.Int32 {
    def this(value: String) = this()
    /**
  ...
  /**
    ...
    */
  open class Long ()
    extends typings.bson.libLongMod.Long {
  ...
  @js.native
  open class MaxKey ()
    extends typings.bson.libMaxKeyMod.MaxKey
  /* static members */
  object MaxKey {
  ...
  @js.native
  open class MinKey ()
    extends typings.bson.libMinKeyMod.MinKey
  /* static members */
  object MinKey {
  ...
  /**
    ...
    */
  open class ObjectId ()
    extends typings.bson.libObjectidMod.ObjectId {
  ...
  open class Timestamp protected ()
    extends typings.bson.libTimestampMod.Timestamp {
    /**
  ...
  /**
    ...
    */
  open class UUID ()
    extends typings.bson.libBinaryMod.UUID {
  ...
  /* Inlined std.Pick</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SerializeOptions * / any, 'serializeFunctions' | 'ignoreUndefined'> */
  trait CalculateObjectSizeOptions extends StObject {
    
    var ignoreUndefined: js.UndefOr[Any] = js.undefined
    
    var serializeFunctions: js.UndefOr[Any] = js.undefined
  }
  object CalculateObjectSizeOptions {
    ...
    implicit open class MutableBuilder[Self <: CalculateObjectSizeOptions] (val x: Self) extends AnyVal {
      ...
      inline def setIgnoreUndefined(value: Any): Self = StObject.set(x, "ignoreUndefined", value.asInstanceOf[js.Any])
      
      inline def setIgnoreUndefinedUndefined: Self = StObject.set(x, "ignoreUndefined", js.undefined)
      
      inline def setSerializeFunctions(value: Any): Self = StObject.set(x, "serializeFunctions", value.asInstanceOf[js.Any])
