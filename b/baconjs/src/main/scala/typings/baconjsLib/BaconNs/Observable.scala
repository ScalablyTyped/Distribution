...
trait Observable[E, A] extends js.Object {
  /**
    ...
    * {
    	 ...
    	 * }
    */
  def awaiting[B](otherObservable: Observable[E, B]): Property[E, scala.Boolean] = js.native
  /**
    * @method
    ...
    */
  def bufferingThrottle(minimumInterval: scala.Double): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    */
  def onEnd(f: js.Function0[scala.Unit]): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def onError(f: js.Function1[/* error */ E, scala.Unit]): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def onValue(f: js.Function1[/* value */ A, scala.Unit]): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def slidingWindow(max: scala.Double): Property[E, js.Array[A]] = js.native
  def slidingWindow(max: scala.Double, min: scala.Double): Property[E, js.Array[A]] = js.native
  /**
