...
object updatebarrierMod {
  ...
  object default {
    ...
    @scala.inline
    def afterTransaction(obs: Observable, f: Call): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("afterTransaction")(obs.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    ...
    @scala.inline
    def currentEventId(): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("currentEventId")().asInstanceOf[js.UndefOr[Double]]
    ...
    @scala.inline
    def hasWaiters(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("hasWaiters")().asInstanceOf[Boolean]
    ...
    @scala.inline
    def inTransaction(event: Unit, context: js.Any, f: js.Function, args: js.Array[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("inTransaction")(event.asInstanceOf[js.Any], context.asInstanceOf[js.Any], f.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    @scala.inline
    def inTransaction(event: Event[js.Any], context: js.Any, f: js.Function, args: js.Array[js.Any]): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("inTransaction")(event.asInstanceOf[js.Any], context.asInstanceOf[js.Any], f.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    @scala.inline
    def inTransaction_=(
      x: js.Function4[
          /* event */ js.UndefOr[Event[js.Any]], 
    ...
    @scala.inline
    def soonButNotYet(obs: Observable, f: Call): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("soonButNotYet")(obs.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    ...
    @scala.inline
    def whenDoneWith(obs: Observable, f: Call): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("whenDoneWith")(obs.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[js.Any]
    @scala.inline
    ...
    @scala.inline
    def wrappedSubscribe[V](obs: Observable, subscribe: Subscribe[V], sink: EventSink[V]): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("wrappedSubscribe")(obs.asInstanceOf[js.Any], subscribe.asInstanceOf[js.Any], sink.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    @scala.inline
