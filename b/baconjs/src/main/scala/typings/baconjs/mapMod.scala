...
object mapMod {
  ...
  inline def default[V, V2](src: typings.baconjs.observableMod.default[V], f: V2): typings.baconjs.observableMod.default[V2] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(src.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.default[V2]]
  inline def default[V, V2](src: typings.baconjs.observableMod.default[V], f: js.Function1[/* value */ V, V2]): typings.baconjs.observableMod.default[V2] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(src.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.default[V2]]
  inline def default[V, V2](src: typings.baconjs.observableMod.default[V], f: Property[V2]): typings.baconjs.observableMod.default[V2] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(src.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.default[V2]]
