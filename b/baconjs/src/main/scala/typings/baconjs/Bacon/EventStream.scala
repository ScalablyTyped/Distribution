...
trait EventStream[E, A] extends Observable[E, A] {
  /**
    ...
    */
  def bufferWithCount(count: Double): EventStream[E, js.Array[A]] = js.native
  /**
    * @method
    ...
    */
  def bufferWithTime(delay: Double): EventStream[E, js.Array[A]] = js.native
  /**
  ...
  /**
    ...
    */
  def bufferWithTime(f: js.Function1[/* defer */ js.Function1[/* repeated */ js.Any, Unit], Unit]): EventStream[E, js.Array[A]] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A[]>}
    */
  def bufferWithTimeOrCount(delay: Double, count: Double): EventStream[E, js.Array[A]] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def debounce(delay: Double): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def debounceImmediate(delay: Double): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def delay(delay: Double): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def doAction(f: js.Function1[/* value */ A, Unit]): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def doAction(propertyExtractor: String): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def doError(f: js.Function1[/* error */ E, Unit]): EventStream[E, A] = js.native
  /**
  ...
  def doLog(label: String): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def endOnError(f: js.Function1[/* error */ E, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def filter(bool: Boolean): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def filter(f: js.Function1[/* value */ A, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def filter(propertyExtractor: String): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def filter(property: Property[E, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
  ...
  def log(label: String): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, B>}
    * */
  def map[B](propertyExtractor: String): EventStream[E, B] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def skip(n: Double): EventStream[E, A] = js.native
  /**
  ...
  def skipDuplicates(isEqual: js.Function2[/* oldValue */ A, /* newValue */ A, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def skipWhile(f: js.Function1[/* value */ A, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    */
  def subscribe(f: js.Function1[/* event */ Event[A], Unit | NoMore]): js.Function0[Unit] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def take(n: Double): EventStream[E, A] = js.native
  /**
    * @method
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def takeWhile(f: js.Function1[/* value */ A, Boolean]): EventStream[E, A] = js.native
  /**
    * @method
    ...
    * @returns {EventStream<E, A>}
    */
  def takeWhile(property: Property[E, Boolean]): EventStream[E, A] = js.native
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def throttle(delay: Double): EventStream[E, A] = js.native
  /**
