...
object mod {
  ...
  @scala.inline
  def combine[R](fn: js.Function, observables: js.Array[typings.baconjs.observableMod.default[js.Any]]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combine")(fn.asInstanceOf[js.Any], observables.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combine[R](fn: Function0[R]): typings.baconjs.observableMod.Property[R] = ^.asInstanceOf[js.Dynamic].applyDynamic("combine")(fn.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combine[R](observables: js.Array[typings.baconjs.observableMod.default[js.Any]], fn: js.Function): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combine")(observables.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combine[V, R](a: typings.baconjs.observableMod.default[V], fn: Function1[V, R]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combine")(a.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combine[V, R](fn: Function1[V, R], a: typings.baconjs.observableMod.default[V]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combine")(fn.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combine[V, V2, R](
  ...
  ): typings.baconjs.observableMod.Property[js.Array[V]] = ^.asInstanceOf[js.Dynamic].applyDynamic("combineAsArray")(streams.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.Property[js.Array[V]]]
  
  @scala.inline
  def combineTemplate[T](template: T): typings.baconjs.observableMod.Property[CombinedTemplate[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("combineTemplate")(template.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.Property[CombinedTemplate[T]]]
  ...
  @scala.inline
  def combineWith[R](fn: js.Function, observables: js.Array[typings.baconjs.observableMod.default[js.Any]]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combineWith")(fn.asInstanceOf[js.Any], observables.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combineWith[R](fn: Function0[R]): typings.baconjs.observableMod.Property[R] = ^.asInstanceOf[js.Dynamic].applyDynamic("combineWith")(fn.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combineWith[R](observables: js.Array[typings.baconjs.observableMod.default[js.Any]], fn: js.Function): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combineWith")(observables.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combineWith[V, R](a: typings.baconjs.observableMod.default[V], fn: Function1[V, R]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combineWith")(a.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  def combineWith[V, R](fn: Function1[V, R], a: typings.baconjs.observableMod.default[V]): typings.baconjs.observableMod.Property[R] = (^.asInstanceOf[js.Dynamic].applyDynamic("combineWith")(fn.asInstanceOf[js.Any], a.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[R]]
  @scala.inline
  ...
  ): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("concatAll")(streams_.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def constant[V](x: V): typings.baconjs.observableMod.Property[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("constant")(x.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.Property[V]]
  
  @scala.inline
  def fromArray[T](values: js.Array[T | typings.baconjs.eventMod.Event[T]]): typings.baconjs.observableMod.EventStream[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromArray")(values.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[T]]
  
  @scala.inline
  def fromBinder[V](binder: Binder[V]): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBinder")(binder.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromBinder[V](binder: Binder[V], eventTransformer: EventTransformer[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromBinder")(binder.asInstanceOf[js.Any], eventTransformer.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromCallback[V](f: js.Function, args: js.Any*): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCallback")(f.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromESObservable[V](_observable: js.Any): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromESObservable")(_observable.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromEvent[V](target: js.Any, eventSource: String): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEvent[V](target: js.Any, eventSource: String, eventTransformer: EventTransformer[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any], eventTransformer.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEvent[V](target: js.Any, eventSource: EventSourceFn): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEvent[V](target: js.Any, eventSource: EventSourceFn, eventTransformer: EventTransformer[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEvent")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any], eventTransformer.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromEventTarget[V](target: js.Any, eventSource: String): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEventTarget")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEventTarget[V](target: js.Any, eventSource: String, eventTransformer: EventTransformer[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEventTarget")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any], eventTransformer.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEventTarget[V](target: js.Any, eventSource: EventSourceFn): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEventTarget")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromEventTarget[V](target: js.Any, eventSource: EventSourceFn, eventTransformer: EventTransformer[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromEventTarget")(target.asInstanceOf[js.Any], eventSource.asInstanceOf[js.Any], eventTransformer.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromNodeCallback[V](f: js.Function, args: js.Any*): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromNodeCallback")(f.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromPoll[V](delay: Double, poll: PollFunction[V]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoll")(delay.asInstanceOf[js.Any], poll.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def fromPromise[V](promise: js.Promise[V]): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPromise")(promise.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def fromPromise[V](promise: js.Promise[V], abort: Boolean): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPromise")(promise.asInstanceOf[js.Any], abort.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  ...
  def groupSimultaneous[V](
    streams: (typings.baconjs.observableMod.default[V] | js.Array[typings.baconjs.observableMod.default[V]])*
  ): typings.baconjs.observableMod.EventStream[js.Array[js.Array[V]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("groupSimultaneous")(streams.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[js.Array[js.Array[V]]]]
  
  @scala.inline
  def hasValue[V](e: typings.baconjs.eventMod.Event[V]): /* is baconjs.baconjs/types/event.Value<V> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("hasValue")(e.asInstanceOf[js.Any]).asInstanceOf[/* is baconjs.baconjs/types/event.Value<V> */ Boolean]
  
  @scala.inline
  def interval[V](delay: Double, value: V): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("interval")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def isEnd[V](e: typings.baconjs.eventMod.Event[V]): /* is baconjs.baconjs/types/event.End */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEnd")(e.asInstanceOf[js.Any]).asInstanceOf[/* is baconjs.baconjs/types/event.End */ Boolean]
  
  @scala.inline
  def isError[V](e: typings.baconjs.eventMod.Event[V]): /* is baconjs.baconjs/types/event.Error */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isError")(e.asInstanceOf[js.Any]).asInstanceOf[/* is baconjs.baconjs/types/event.Error */ Boolean]
  ...
  @scala.inline
  def isInitial[V](e: typings.baconjs.eventMod.Event[V]): /* is baconjs.baconjs/types/event.Initial<V> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInitial")(e.asInstanceOf[js.Any]).asInstanceOf[/* is baconjs.baconjs/types/event.Initial<V> */ Boolean]
  
  @scala.inline
  def isNext[V](e: typings.baconjs.eventMod.Event[V]): /* is baconjs.baconjs/types/event.Next<V> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNext")(e.asInstanceOf[js.Any]).asInstanceOf[/* is baconjs.baconjs/types/event.Next<V> */ Boolean]
  
  @scala.inline
  def later[V](delay: Double, value: V): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("later")(delay.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def mergeAll[V](
    streams: (typings.baconjs.observableMod.default[V] | js.Array[typings.baconjs.observableMod.default[V]])*
  ): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeAll")(streams.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  ...
  @scala.inline
  def never[V](): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("never")().asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  ...
  @scala.inline
  def onValues(args: js.Any*): Unsub = ^.asInstanceOf[js.Dynamic].applyDynamic("onValues")(args.asInstanceOf[js.Any]).asInstanceOf[Unsub]
  
  @scala.inline
  def once[V](value: V): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("once")(value.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  @scala.inline
  def once[V](value: typings.baconjs.eventMod.Event[V]): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("once")(value.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  ...
  @scala.inline
  def repeatedly[V](delay: Double, values: js.Array[V | typings.baconjs.eventMod.Event[V]]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("repeatedly")(delay.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def retry[V](options: RetryOptions[V]): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("retry")(options.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def sequentially[V](delay: Double, values: js.Array[V | typings.baconjs.eventMod.Event[V]]): typings.baconjs.observableMod.EventStream[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("sequentially")(delay.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  ...
  @scala.inline
  def silence[V](duration: Double): typings.baconjs.observableMod.EventStream[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("silence")(duration.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[V]]
  
  @scala.inline
  def spy(spy: Spy_): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("spy")(spy.asInstanceOf[js.Any]).asInstanceOf[Double]
  
  @scala.inline
  def `try`[In, Out](f: js.Function1[/* value */ In, Out]): js.Function1[/* value */ In, typings.baconjs.observableMod.EventStream[Out]] = ^.asInstanceOf[js.Dynamic].applyDynamic("try")(f.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* value */ In, typings.baconjs.observableMod.EventStream[Out]]]
  
  @scala.inline
  def update[Out](initial: Out, patterns: UpdatePattern[Out]*): typings.baconjs.observableMod.Property[Out] = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(initial.asInstanceOf[js.Any], patterns.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.Property[Out]]
  ...
  @scala.inline
  def when[O](patterns: Pattern[O]*): typings.baconjs.observableMod.EventStream[O] = ^.asInstanceOf[js.Dynamic].applyDynamic("when")(patterns.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.EventStream[O]]
  
  @scala.inline
  def zipAsArray[V](
    args: (typings.baconjs.observableMod.default[V] | js.Array[typings.baconjs.observableMod.default[V]])*
  ): typings.baconjs.observableMod.default[js.Array[V]] = ^.asInstanceOf[js.Dynamic].applyDynamic("zipAsArray")(args.asInstanceOf[js.Any]).asInstanceOf[typings.baconjs.observableMod.default[js.Array[V]]]
  
  @scala.inline
  def zipWith[Out](
    f: js.Function1[/* repeated */ js.Any, Out],
    streams: typings.baconjs.observableMod.default[js.Any]*
  ): typings.baconjs.observableMod.EventStream[Out] = (^.asInstanceOf[js.Dynamic].applyDynamic("zipWith")(f.asInstanceOf[js.Any], streams.asInstanceOf[js.Any])).asInstanceOf[typings.baconjs.observableMod.EventStream[Out]]
}
