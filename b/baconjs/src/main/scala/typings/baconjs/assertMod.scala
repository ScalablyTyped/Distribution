...
object assertMod {
  ...
  inline def assertArray(xs: js.Array[js.Any]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assertArray")(xs.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def assertEventStream(event: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assertEventStream")(event.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def assertObservable(observable: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assertObservable")(observable.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def assertObservableIsProperty(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("assertObservableIsProperty")(x.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
