...
import typings.baconjs.decodeMod.DecodedValueOf
import typings.baconjs.describeMod.Desc
import typings.baconjs.diffMod.Differ
import typings.baconjs.groupbyMod.GroupTransformer
...
import typings.baconjs.skipduplicatesMod.Equals
...
import typings.baconjs.withstatemachineMod.StateF
...
object observableMod {
  ...
  @js.native
  abstract class Observable[V] protected () extends StObject {
    def this(desc: Desc) = this()
  ...
  @js.native
  def isProperty[V](x: js.Any): /* is baconjs.baconjs/types/observable.Property<V> */ Boolean = js.native
  
  @JSImport("baconjs/types/observable", "newEventStream")
  @js.native
  def newEventStream[V](description: Desc, subscribe: Subscribe[V]): EventStream[V] = js.native
  
  @JSImport("baconjs/types/observable", "newEventStreamAllowSync")
  @js.native
  def newEventStreamAllowSync[V](description: Desc, subscribe: Subscribe[V]): EventStream[V] = js.native
