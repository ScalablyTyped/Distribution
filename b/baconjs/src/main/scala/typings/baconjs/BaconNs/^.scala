...
object ^ extends js.Object {
  ...
  /**
    ...
    * });
    */
  def fromCallback[E, A](f: js.Function1[/* callback */ js.Function1[/* repeated */ js.Any, Unit], Unit]): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    */
  def fromCallback[E, A](f: js.Function1[/* repeated */ js.Any, Unit], args: js.Any*): EventStream[E, A] = js.native
  /**
    * @function
    ...
    * @returns {EventStream<E, A>}
    */
  def fromCallback[E, A](`object`: js.Object, methodName: String, args: js.Any*): EventStream[E, A] = js.native
  def fromEvent[E, A](target: JQuery, eventName: String): EventStream[E, A] = js.native
  def fromEvent[E, A](target: EventEmitter, eventName: String): EventStream[E, A] = js.native
  /**
    * @function
    ...
    * });
    */
  def fromEvent[E, A](target: EventTarget, eventName: String): EventStream[E, A] = js.native
  def fromEvent[E, A, B](target: JQuery, eventName: String, eventTransformer: js.Function1[/* event */ A, B]): EventStream[E, B] = js.native
  def fromEvent[E, A, B](target: EventEmitter, eventName: String, eventTransformer: js.Function1[/* event */ A, B]): EventStream[E, B] = js.native
  /**
  ...
  /**
    ...
    * });
    */
  def fromEvent[E, A, B](target: EventTarget, eventName: String, eventTransformer: js.Function1[/* event */ A, B]): EventStream[E, B] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def fromNodeCallback[E, A](`object`: js.Object, methodName: String, args: js.Any*): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def fromPoll[E, A](interval: Double, f: js.Function0[Next[A] | End[A]]): EventStream[E, A] = js.native
  /**
    * @function
  ...
  def fromPromise[E, A](promise: js.Thenable[A], abort: Boolean): EventStream[E, A] = js.native
  def fromPromise[E, A](promise: JQueryXHR): EventStream[E, A] = js.native
  def fromPromise[E, A](promise: JQueryXHR, abort: Boolean): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def interval[E, A](interval: Double, value: A): EventStream[E, A] = js.native
  /**
    * @function
    ...
    * @returns {EventStream<E, A>}
    */
  def later[E, A](delay: Double, value: A): EventStream[E, A] = js.native
  /**
    * @function
  ...
  /**
    ...
    * }).log();
    */
  def repeat[E, A](f: js.Function1[/* iteration */ Double, Boolean | (Observable[E, A])]): EventStream[E, A] = js.native
  /**
    * @function
    ...
    * Bacon.fromArray([1, new Bacon.Error("")]);
    */
  def repeatedly[E, A](interval: Double, values: js.Array[A]): EventStream[E, A] = js.native
  /**
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def retry[E, A](options: Anon_Context[E, A]): EventStream[E, A] = js.native
  /**
    * @callback Bacon.retry1~source
  ...
  /**
    ...
    * @returns {EventStream<E, A>}
    */
  def sequentially[E, A](interval: Double, values: js.Array[A]): EventStream[E, A] = js.native
  /**
