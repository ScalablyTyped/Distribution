...
@js.native
trait NavigationControl3DOptions extends js.Object {
...
object NavigationControl3DOptions {
  ...
  @scala.inline
  implicit class NavigationControl3DOptionsOps[Self <: NavigationControl3DOptions] (val x: Self) extends AnyVal {
