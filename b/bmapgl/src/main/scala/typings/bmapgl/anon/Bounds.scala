...
trait Bounds extends js.Object {
  ...
  var bounds: js.Array[typings.bmapgl.BMapGL.Bounds] = js.native
...
object Bounds {
  ...
  implicit class BoundsOps[Self <: Bounds] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBoundsVarargs(value: typings.bmapgl.BMapGL.Bounds*): Self = this.set("bounds", js.Array(value :_*))
    
    @scala.inline
    def setBounds(value: js.Array[typings.bmapgl.BMapGL.Bounds]): Self = this.set("bounds", value.asInstanceOf[js.Any])
