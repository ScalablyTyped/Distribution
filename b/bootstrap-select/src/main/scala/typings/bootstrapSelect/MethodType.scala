...
/* Rewritten from type alias, can be one of: 
  - typings.bootstrapSelect.bootstrapSelectStrings.`val`
  - typings.bootstrapSelect.bootstrapSelectStrings.selectAll
  - typings.bootstrapSelect.bootstrapSelectStrings.deselectAll
  - typings.bootstrapSelect.bootstrapSelectStrings.render
  - typings.bootstrapSelect.bootstrapSelectStrings.mobile
  - typings.bootstrapSelect.bootstrapSelectStrings.setStyle
  - typings.bootstrapSelect.bootstrapSelectStrings.refresh
  - typings.bootstrapSelect.bootstrapSelectStrings.toggle
  - typings.bootstrapSelect.bootstrapSelectStrings.hide
