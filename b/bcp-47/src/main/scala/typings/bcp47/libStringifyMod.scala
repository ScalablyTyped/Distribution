...
object libStringifyMod {
  ...
  trait Schema extends StObject {
    ...
    var extensions: js.UndefOr[js.Array[typings.bcp47.libParseMod.Extension]] = js.undefined
  ...
  object Schema {
    ...
    implicit open class MutableBuilder[Self <: Schema] (val x: Self) extends AnyVal {
      ...
      inline def setExtensions(value: js.Array[typings.bcp47.libParseMod.Extension]): Self = StObject.set(x, "extensions", value.asInstanceOf[js.Any])
      
      inline def setExtensionsUndefined: Self = StObject.set(x, "extensions", js.undefined)
      
      inline def setExtensionsVarargs(value: typings.bcp47.libParseMod.Extension*): Self = StObject.set(x, "extensions", js.Array(value*))
