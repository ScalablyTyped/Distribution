...
trait PromiseConstructor
  extends ScalablyTyped.runtime.Instantiable1[
      /* callback */ js.Function3[
        /* resolve */ js.Function1[
          /* thenableOrResult */ js.UndefOr[js.Object | stdLib.PromiseLike[js.Object]], 
          scala.Unit
        ], 
  ...
  def all[T](values: js.Array[T | stdLib.PromiseLike[T]]): Promise[js.Array[T]] = js.native
  def all[T1, T2](values: js.Tuple2[T1 | stdLib.PromiseLike[T1], T2 | stdLib.PromiseLike[T2]]): Promise[js.Tuple2[T1, T2]] = js.native
  def all[T1, T2, T3](
    values: js.Tuple3[
  ...
  ): Promise[js.Tuple3[T1, T2, T3]] = js.native
  def all[T1, T2, T3, T4](
    values: js.Tuple4[
      T1 | stdLib.PromiseLike[T1], 
      T2 | stdLib.PromiseLike[T2], 
  ...
  def race[T](values: js.Array[T | stdLib.PromiseLike[T]]): Promise[T] = js.native
  def race[T1, T2](values: js.Tuple2[T1 | stdLib.PromiseLike[T1], T2 | stdLib.PromiseLike[T2]]): Promise[T1 | T2] = js.native
  def race[T1, T2, T3](
    values: js.Tuple3[
      T1 | stdLib.PromiseLike[T1], 
      T2 | stdLib.PromiseLike[T2], 
  ...
  def resolve[T](value: stdLib.PromiseLike[T]): Promise[T] = js.native
}
