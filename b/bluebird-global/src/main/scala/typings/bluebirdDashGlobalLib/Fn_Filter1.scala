...
@js.native
trait Fn_Filter1[T] extends js.Object {
  def apply[U](
  ...
  def apply[U](filter1: bluebirdLib.bluebirdMod.Constructor[stdLib.Error], value: U): bluebirdLib.bluebirdMod.Bluebird[T | U] = js.native
  def apply[U](value: U): bluebirdLib.bluebirdMod.Bluebird[T | U] = js.native
}
