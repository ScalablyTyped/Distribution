...
class Tick () extends js.Object {
  /**
           ...
           */
  def _closeNode(node: js.Any): scala.Unit = js.native
  /**
           * Called when entering a node (called by BaseNode).
           */
  def _enterNode(node: js.Any): scala.Unit = js.native
  /**
           * Callback when exiting a node (called by BaseNode).
           */
  def _exitNode(node: js.Any): scala.Unit = js.native
  /**
           * Callback when opening a node (called by BaseNode).
           */
  def _openNode(node: js.Any): scala.Unit = js.native
  /**
           * Callback when ticking a node (called by BaseNode).
           */
  def _tickNode(node: js.Any): scala.Unit = js.native
}
