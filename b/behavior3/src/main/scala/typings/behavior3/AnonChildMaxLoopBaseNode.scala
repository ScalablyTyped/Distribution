...
trait AnonChildMaxLoopBaseNode extends js.Object {
  var child: js.UndefOr[BaseNode] = js.undefined
  var maxLoop: js.UndefOr[Double] = js.undefined
}

object AnonChildMaxLoopBaseNode {
  @scala.inline
  def apply(child: BaseNode = null, maxLoop: Int | Double = null): AnonChildMaxLoopBaseNode = {
    val __obj = js.Dynamic.literal()
    if (child != null) __obj.updateDynamic("child")(child.asInstanceOf[js.Any])
    if (maxLoop != null) __obj.updateDynamic("maxLoop")(maxLoop.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonChildMaxLoopBaseNode]
  }
}
