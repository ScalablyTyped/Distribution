...
object BdApiModuleNs extends js.Object {
  ...
  object React extends js.Object {
    ...
    @JSName("createElement")
    def createElement_P_HTMLAttributesTT_HTMLElement_DetailedReactHTMLElement[P /* <: HTMLAttributes[T] */, T /* <: typings.react.HTMLElement */](`type`: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 115 */ js.Any): DetailedReactHTMLElement[P, T] = js.native
    @JSName("createElement")
    ...
    // DOM Elements
    @JSName("createFactory")
    def createFactory_T_HTMLElement_HTMLFactory[T /* <: typings.react.HTMLElement */](`type`: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 115 */ js.Any): HTMLFactory[T] = js.native
