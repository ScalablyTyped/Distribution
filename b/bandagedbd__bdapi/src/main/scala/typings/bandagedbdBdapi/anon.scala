...
import typings.bandagedbdBdapi.mod.CancelPatch
import typings.bandagedbdBdapi.mod.ConfirmationModalOptions
import typings.bandagedbdBdapi.mod.MonkeyPatchOptions
import typings.bandagedbdBdapi.mod.ToastOptions
...
object anon {
  ...
  @js.native
  trait TypeofBdApiModule extends StObject {
    ...
    /**
      ...
      */
    def findAllModules(filter: js.Function1[/* module */ Any, Boolean]): js.Array[Any] | Null = js.native
    ...
    /**
      ...
      * @returns The modules found or null if none were found.
      */
    def findModule(filter: js.Function1[/* module */ Any, Boolean]): Any = js.native
    ...
    /**
      ...
      * @returns The modules found or null if none were found.
      */
    def findModuleByDisplayName(name: String): Any = js.native
    ...
    /**
      ...
      * @returns The modules found or null if none were found.
      */
    def findModuleByProps(props: String*): Any = js.native
    ...
    /**
      ...
      * @returns The modules found or null if none were found..
      */
    def findModuleByPrototypes(props: String*): Any = js.native
    ...
    /**
      ...
      */
    def getData(pluginName: String, key: String): Any = js.native
    ...
    /**
      ...
      * @returns The information that was saved previously, or null otherwise.
      */
    def loadData(pluginName: String, key: String): Any = js.native
    ...
    /**
      ...
      */
    def saveData(pluginName: String, key: String, data: Any): Unit = js.native
    ...
    /**
      ...
      * @param data Data to save.
      */
    def setData(pluginName: String, key: String, data: Any): Unit = js.native
