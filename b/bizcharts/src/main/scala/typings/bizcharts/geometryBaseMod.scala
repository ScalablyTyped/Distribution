...
object geometryBaseMod {
  
  @JSImport("bizcharts/lib/geometry/Base", JSImport.Default)
  @js.native
  abstract class default[T /* <: IBaseGemoProps */] protected () extends BaseGeom[T] {
  ...
  trait GeomHelper extends StObject {
    ...
    var geom: typings.antvG2.geometryBaseMod.default[ShapePoint]
  ...
  object GeomHelper {
    ...
    inline def apply(
      ...
      destroy: () => Unit,
      geom: typings.antvG2.geometryBaseMod.default[ShapePoint],
    ...
    extension [Self <: GeomHelper](x: Self) {
      ...
      inline def setGeom(value: typings.antvG2.geometryBaseMod.default[ShapePoint]): Self = StObject.set(x, "geom", value.asInstanceOf[js.Any])
