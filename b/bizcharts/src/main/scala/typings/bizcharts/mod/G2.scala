...
object G2 {
  ...
  @JSImport("bizcharts", "G2.BRUSH_FILTER_EVENTS")
  @js.native
  ...
  @JSImport("bizcharts", "G2.DIRECTION")
  @js.native
  ...
  object Util {
    ...
    @JSImport("bizcharts", "G2.Util")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("bizcharts", "G2.Util.getAngle")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getDelegationObject")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getMappingValue")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getPath")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getPathPoints")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getSectorPath")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.getTooltipItems")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.polarToCartesian")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.rotate")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.translate")
    @js.native
    ...
    @JSImport("bizcharts", "G2.Util.zoom")
    @js.native
  ...
  @JSImport("bizcharts", "G2.VERSION")
  @js.native
  val VERSION: /* "4.2.8" */ String = js.native
  
  @JSImport("bizcharts", "G2.VIEW_LIFE_CIRCLE")
  @js.native
