...
import typings.antvG2plot.anon.MappingOptionsPickPointGe
...
object libPlotsTinyLineChartMod extends Shortcut {
  
  @JSImport("bizcharts/lib/plots/TinyLineChart", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[TinyLineOptions & RefAttributes[Any]] = js.native
  
  /* Inlined std.Omit<@antv/g2plot.@antv/g2plot/lib/plots/tiny-line.TinyLineOptions, 'data'> */
  ...
  object TinyLineOptions {
    
    inline def apply(data: js.Array[Double | (Record[String, Any])]): TinyLineOptions = {
  ...
  type _To = ForwardRefExoticComponent[TinyLineOptions & RefAttributes[Any]]
  
  /* This means you don't have to write `default`, but can instead just say `libPlotsTinyLineChartMod.foo` */
  override def _to: ForwardRefExoticComponent[TinyLineOptions & RefAttributes[Any]] = default
}
