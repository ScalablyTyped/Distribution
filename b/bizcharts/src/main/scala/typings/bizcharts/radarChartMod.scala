...
object radarChartMod extends Shortcut {
  ...
  trait RadarOptions
    extends StObject
       with typings.antvG2plot.radarTypesMod.RadarOptions
  ...
  /* This means you don't have to write `default`, but can instead just say `radarChartMod.foo` */
