...
object viewHelperMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    var chart: typings.antvG2.chartChartMod.default = js.native
  ...
  trait ViewHelper extends StObject {
    ...
    var chart: typings.antvG2.chartChartMod.default
  ...
  object ViewHelper {
    ...
    inline def apply(
      chart: typings.antvG2.chartChartMod.default,
    ...
    extension [Self <: ViewHelper](x: Self) {
      ...
      inline def setChart(value: typings.antvG2.chartChartMod.default): Self = StObject.set(x, "chart", value.asInstanceOf[js.Any])
