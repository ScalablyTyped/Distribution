...
object bulletChartMod extends Shortcut {
  ...
  trait BulletOptions
    extends StObject
       with typings.antvG2plot.bulletTypesMod.BulletOptions
  ...
  /* This means you don't have to write `default`, but can instead just say `bulletChartMod.foo` */
