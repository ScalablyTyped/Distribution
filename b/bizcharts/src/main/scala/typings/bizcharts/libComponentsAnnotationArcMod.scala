...
object libComponentsAnnotationArcMod {
  ...
  object AnnotationArcProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: AnnotationArcProps] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait Arc
    extends typings.bizcharts.libComponentsAnnotationBaseMod.default[AnnotationArcProps]
}
