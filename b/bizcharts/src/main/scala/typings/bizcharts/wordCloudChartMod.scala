...
import typings.antvG2plot.wordCloudTypesMod.WordStyle
...
import typings.bizcharts.createPlotMod.VisibleText
...
object wordCloudChartMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `wordCloudChartMod.foo` */
