...
object libInterfaceMod {
  ...
  open class Chart protected ()
    extends typings.antvG2.libChartMod.Chart {
  ...
  - Dropped 'ref' extends keyof any ? any extends {  ref :infer R | undefined} ? string extends R ? react.react.PropsWithoutRef<any> & {  ref :std.Exclude<R, string> | undefined} : any : any : any */ trait IBaseGemoProps
    extends StObject
  ...
  trait IEvent
    ...
    var view: js.UndefOr[typings.antvG2.libChartViewMod.View] = js.undefined
  ...
  object IEvent {
    ...
    extension [Self <: IEvent](x: Self) {
      ...
      inline def setView(value: typings.antvG2.libChartViewMod.View): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
  ...
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped any extends new (props : infer P): react.react.Component<any, any, any> ? react.react.PropsWithoutRef<P> & react.react.RefAttributes<std.InstanceType<any>> : react.react.PropsWithRef<react.react.ComponentProps<any>> */ trait IViewProps
    extends StObject
       with /* key */ StringDictionary[Any] {
