...
import typings.bizcharts.componentMod.ReactElementAnnotationCfg
...
object reactElementMod {
  ...
  @js.native
  trait Html
    extends typings.bizcharts.baseMod.default[HtmlAnnotationProps]
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.bizcharts.reactElementMod.BaseProps because var conflicts: animate, animateOption, offsetY, `type`. Inlined chartIns, top */ trait HtmlAnnotationProps
    extends StObject
