...
object libCoreMod {
  ...
  /* note: abstract class */ @JSImport("bizcharts/lib/core", "ComponentController")
  @js.native
  ...
  /* note: abstract class */ @JSImport("bizcharts/lib/core", "Facet")
  @js.native
  ...
  /**
    * Action 的基类
    */
  /* note: abstract class */ @JSImport("bizcharts/lib/core", "InteractionAction")
  @js.native
