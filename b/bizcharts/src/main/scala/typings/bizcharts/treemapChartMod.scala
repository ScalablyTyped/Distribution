...
object treemapChartMod extends Shortcut {
  ...
  trait TreemapOptions
    extends StObject
       with typings.antvG2plot.treemapTypesMod.TreemapOptions
  ...
  /* This means you don't have to write `default`, but can instead just say `treemapChartMod.foo` */
