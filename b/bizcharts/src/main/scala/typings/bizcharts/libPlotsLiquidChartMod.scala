...
import typings.antvG2plot.libPlotsLiquidTypesMod.Outline
import typings.antvG2plot.libPlotsLiquidTypesMod.ShapeCallback
import typings.antvG2plot.libPlotsLiquidTypesMod.Wave
...
object libPlotsLiquidChartMod extends Shortcut {
  
  @JSImport("bizcharts/lib/plots/LiquidChart", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[LiquidOptions & RefAttributes[Any]] = js.native
  ...
  object LiquidOptions {
    ...
    inline def apply(): LiquidOptions = {
  ...
  /* Inlined std.Omit<@antv/g2plot.@antv/g2plot/lib/plots/liquid.LiquidOptions, 'percent'> */
  ...
  type _To = ForwardRefExoticComponent[LiquidOptions & RefAttributes[Any]]
  
  /* This means you don't have to write `default`, but can instead just say `libPlotsLiquidChartMod.foo` */
  override def _to: ForwardRefExoticComponent[LiquidOptions & RefAttributes[Any]] = default
}
