...
object libG2AllMod {
  ...
  open class ComponentController[O] protected ()
    extends typings.antvG2.mod.ComponentController[O] {
  ...
  open class Coordinate ()
    extends typings.antvG2.mod.Coordinate {
  ...
  open class Element protected ()
    extends typings.antvG2.mod.Element {
  ...
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typings.antvG2.mod.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typings.antvG2.mod.Geometry[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  open class GeometryLabel protected ()
    extends typings.antvG2.mod.GeometryLabel {
  ...
  open class InteractionAction[T] protected ()
    extends typings.antvG2.mod.InteractionAction[T] {
  ...
  open class TooltipController ()
    extends typings.antvG2.mod.TooltipController
