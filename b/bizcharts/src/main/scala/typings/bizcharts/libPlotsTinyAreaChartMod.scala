...
object libPlotsTinyAreaChartMod extends Shortcut {
  
  @JSImport("bizcharts/lib/plots/TinyAreaChart", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[TinyAreaOptions & RefAttributes[Any]] = js.native
  
  /* Inlined std.Omit<@antv/g2plot.@antv/g2plot/lib/plots/tiny-area.TinyAreaOptions, 'data'> */
  ...
  object TinyAreaOptions {
    ...
    inline def apply(data: js.Array[Double | (Record[String, Any])]): TinyAreaOptions = {
  ...
  type _To = ForwardRefExoticComponent[TinyAreaOptions & RefAttributes[Any]]
  
  /* This means you don't have to write `default`, but can instead just say `libPlotsTinyAreaChartMod.foo` */
  override def _to: ForwardRefExoticComponent[TinyAreaOptions & RefAttributes[Any]] = default
}
