...
import typings.antvG2plot.tooltipMod.TooltipOptions
...
object coreInterfaceMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bizcharts.bizchartsBooleans.`false`
    - typings.bizcharts.coreInterfaceMod.LabelOptions
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bizcharts.bizchartsBooleans.`false`
    - typings.bizcharts.coreInterfaceMod.LengendOptions
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.bizcharts.bizchartsBooleans.`false`
    - typings.bizcharts.coreInterfaceMod.TooltipCfg
  */
