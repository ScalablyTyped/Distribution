...
object histogramChartMod extends Shortcut {
  ...
  trait HistogramOptions
    extends StObject
       with typings.antvG2plot.histogramTypesMod.HistogramOptions
  ...
  /* This means you don't have to write `default`, but can instead just say `histogramChartMod.foo` */
