...
object LivePlayerContext {
  ...
  implicit class LivePlayerContextMutableBuilder[Self <: LivePlayerContext] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPause(value: BaseOptions[js.Any, js.Any] => Unit): Self = StObject.set(x, "pause", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setResume(value: BaseOptions[js.Any, js.Any] => Unit): Self = StObject.set(x, "resume", js.Any.fromFunction1(value))
