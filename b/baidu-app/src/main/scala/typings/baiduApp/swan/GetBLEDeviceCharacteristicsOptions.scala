...
object GetBLEDeviceCharacteristicsOptions {
  ...
  inline def apply(deviceId: String, serviceId: String, success: characteristicsArrayuuids => Unit): GetBLEDeviceCharacteristicsOptions = {
  ...
  extension [Self <: GetBLEDeviceCharacteristicsOptions](x: Self) {
    ...
    inline def setSuccess(value: characteristicsArrayuuids => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
  }
}
