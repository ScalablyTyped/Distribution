...
trait OpenSettingOptions
  ...
  @JSName("success")
  var success_OpenSettingOptions: js.UndefOr[js.Function1[/* res */ typings.baiduApp.anon.AuthSetting, Unit]] = js.undefined
}
object OpenSettingOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OpenSettingOptions] (val x: Self) extends AnyVal {
