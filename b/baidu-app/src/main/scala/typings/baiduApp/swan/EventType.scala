...
/* Rewritten from type alias, can be one of: 
  - typings.baiduApp.baiduAppStrings.input
  - typings.baiduApp.baiduAppStrings.form
  - typings.baiduApp.baiduAppStrings.submit
  - typings.baiduApp.baiduAppStrings.scroll
  - typings.baiduApp.baiduAppStrings.tap
  - typings.baiduApp.baiduAppStrings.longpress
