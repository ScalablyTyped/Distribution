...
object PartialaddGlobalClassbool {
  ...
  def apply(
    ...
    if (!js.isUndefined(addGlobalClass)) __obj.updateDynamic("addGlobalClass")(addGlobalClass.get.asInstanceOf[js.Any])
    if (!js.isUndefined(multipleSlots)) __obj.updateDynamic("multipleSlots")(multipleSlots.get.asInstanceOf[js.Any])
