...
object global {
  ...
  /**
    ...
    */
  inline def Page[T /* <: PageOptions & js.Object */](page: T & (ThisType[T & (typings.baiduApp.swan.Page[js.Object, js.Object])])): Unit = js.Dynamic.global.applyDynamic("Page")(page.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object swan {
    ...
    inline def createIntersectionObserver(context: Component[js.Any, js.Any]): IntersectionObserver = ^.asInstanceOf[js.Dynamic].applyDynamic("createIntersectionObserver")(context.asInstanceOf[js.Any]).asInstanceOf[IntersectionObserver]
    inline def createIntersectionObserver(context: Component[js.Any, js.Any], options: CreateIntersectionObserverOption): IntersectionObserver = (^.asInstanceOf[js.Dynamic].applyDynamic("createIntersectionObserver")(context.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[IntersectionObserver]
    ...
    /** 监听WebSocket关闭。 */
    inline def onSocketClose(callback: js.Function1[/* res */ js.Any, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onSocketClose")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    /** 监听WebSocket连接打开事件。 */
    inline def onSocketOpen(callback: js.Function1[/* res */ js.Any, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onSocketOpen")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
