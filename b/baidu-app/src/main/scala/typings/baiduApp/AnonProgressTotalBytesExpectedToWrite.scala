...
trait AnonProgressTotalBytesExpectedToWrite extends js.Object {
  /** 下载进度百分比 */
  var progress: Double
...
object AnonProgressTotalBytesExpectedToWrite {
  @scala.inline
  def apply(progress: Double, totalBytesExpectedToWrite: Double, totalBytesWritten: Double): AnonProgressTotalBytesExpectedToWrite = {
    ...
    __obj.asInstanceOf[AnonProgressTotalBytesExpectedToWrite]
  }
}
