...
import typings.baiduDashApp.Anon_ScrollTop
...
trait PageOptions extends js.Object {
  ...
  /**
  		 ...
  		 * 参数为 Object，包含以下字段：
  		 */
  var onPageScroll: js.UndefOr[js.Function1[/* option */ Anon_ScrollTop, Unit]] = js.undefined
  /**
  		 * 下拉刷新
...
object PageOptions {
  ...
  def apply(
    ...
    onPageScroll: /* option */ Anon_ScrollTop => Unit = null,
