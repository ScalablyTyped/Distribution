...
import typings.baiduDashApp.Anon_IsConnected
import typings.baiduDashApp.Anon_Level
import typings.baiduDashApp.Anon_Title
...
object ^ extends js.Object {
  ...
  /**
  	 ...
  	 */
  def canvasToTempFilePath(options: Partial[CanvasToTempFilePathOptions]): Unit = js.native
  /**
  ...
  def setDocumentTitle(options: Anon_Title): Unit = js.native
