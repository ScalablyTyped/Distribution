...
object InnerAudioContext {
  ...
  def apply(
    ...
    offCanplay: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offEnded: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offError: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offPause: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offPlay: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offSeeked: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offSeeking: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offStop: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offTimeUpdate: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    offWaiting: js.Function1[/* res */ ErrCodeResponse, scala.Unit] => scala.Unit,
    ...
    play: () => scala.Unit,
    seek: baiduDashAppLib.Anon_Position => scala.Unit,
    stop: () => scala.Unit,
