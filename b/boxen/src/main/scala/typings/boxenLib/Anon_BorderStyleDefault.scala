...
@js.native
trait Anon_BorderStyleDefault extends js.Object {
  /**
  ...
  @JSName("default")
  var default_Original: Anon_BorderStyle = js.native
  /**
  ...
  def default(text: java.lang.String, options: boxenLib.boxenMod.boxenNs.Options): java.lang.String = js.native
}
