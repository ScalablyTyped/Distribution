...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "camelcase" % "5.2.0-c770f4",
  "org.scalablytyped" %%% "chalk" % "2.4.2-6d01d0",
  "org.scalablytyped" %%% "cli-boxes" % "1.0-dt-20181231Z-c2e1be",
  ...
  "org.scalablytyped" %%% "term-size" % "1.2-dt-20181215Z-16a53d")
