...
| 28892 | [commander](./c/commander) | the complete solution for node.js command-line pro
...
| 21748 | [async](./a/async) | Higher-order functions and common patterns for asy
| 21694 | [debug](./d/debug) | small debugging utility
| 19924 | [fs-extra](./f/fs-extra) | fs-extra contains methods that aren't included in 
...
| 17649 | [bluebird](./b/bluebird) | Full featured Promises/A+ implementation with exce
...
| 11079 | [webpack](./w/webpack) | Packs CommonJs/AMD modules for the browser. Allows
...
| 9386 | [yeoman-generator](./y/yeoman-generator) | Rails-inspired generator system that provides scaf
| 9278 | [babel-core](./b/babel-core) | Babel compiler core.
| 9210 | [through2](./t/through2) | A tiny wrapper around Node.js streams.Transform (S
...
| 6144 | [file-loader](./f/file-loader) | A file loader module for webpack
...
| 4985 | [node-fetch](./n/node-fetch) | A light-weight module that brings window.fetch to 
| 4968 | [ora](./o/ora) | Elegant terminal spinner
| 4853 | [angular__http](./a/angular__http) | Angular - the http service
| 4798 | [webpack-dev-server](./w/webpack-dev-server) | Serves a webpack app. Updates the browser on chang
| 4726 | [ws](./w/ws) | Simple to use, blazing fast and thoroughly tested 
| 4675 | [html-webpack-plugin](./h/html-webpack-plugin) | Simplifies creation of HTML files to serve your we
...
| 4300 | [request-promise](./r/request-promise) | The simplified HTTP request client 'request' with 
| 4290 | [mongoose](./m/mongoose) | Mongoose MongoDB ODM
| 4229 | [xml2js](./x/xml2js) | Simple XML to JavaScript object converter.
| 4218 | [chai](./c/chai) | BDD/TDD assertion library for node.js and the brow
| 4026 | [bootstrap](./b/bootstrap) | The most popular front-end framework for developin
| 3999 | [redis](./r/redis) | Redis client library
| 3984 | [optimist](./o/optimist) | Light-weight option parsing with an argv hash. No 
...
| 3858 | [chokidar](./c/chokidar) | A neat wrapper around node.js fs.watch / fs.watchF
| 3837 | [babel__core](./b/babel__core) | Babel compiler core.
| 3801 | [co](./c/co) | generator async control flow goodness
| 3663 | [babel-jest](./b/babel-jest) | Jest plugin to use babel for transformation.
...
| 3608 | [extract-text-webpack-plug](./e/extract-text-webpack-plugin) | Extract text from bundle into a file.
...
| 3137 | [jsonwebtoken](./j/jsonwebtoken) | JSON Web Token implementation (symmetric and asymm
| 3114 | [mysql](./m/mysql) | A node.js driver for mysql. It is written in JavaS
| 3108 | [reflect-metadata](./r/reflect-metadata) | Polyfill for Metadata Reflection API
| 3073 | [es6-promise](./e/es6-promise) | A lightweight library that provides tools for orga
| 3049 | [minimatch](./m/minimatch) | a glob matcher in javascript
| 3048 | [resolve](./r/resolve) | resolve like require.resolve() on behalf of files 
| 3046 | [uglify-js](./u/uglify-js) | JavaScript parser, mangler/compressor and beautifi
...
| 2783 | [jade](./j/jade) | A clean, whitespace-sensitive template language fo
| 2749 | [case-sensitive-paths-webp](./c/case-sensitive-paths-webpack-plugin) | Enforces module path case sensitivity in Webpack
...
| 2435 | [deepmerge](./d/deepmerge) | A library for deep (recursive) merging of Javascri
| 2434 | [underscore_dot_string](./u/underscore_dot_string) | String manipulation extensions for Underscore.js j
...
| 2241 | [graphql](./g/graphql) | A Query Language and Runtime which can target any 
...
| 2074 | [globby](./g/globby) | Extends glob with support for multiple patterns an
| 2070 | [pg](./p/pg) | PostgreSQL client - pure javascript & libpq with t
| 2068 | [execa](./e/execa) | A better child_process
| 2059 | [nodemailer](./n/nodemailer) | Easy as cake e-mail sending from your Node.js appl
...
| 1904 | [inherits](./i/inherits) | Browser-friendly inheritance fully compatible with
...
| 1840 | [readable-stream](./r/readable-stream) | Streams3, a user-land copy of the stream library f
...
| 1716 | [request-promise-native](./r/request-promise-native) | The simplified HTTP request client 'request' with 
| 1708 | [open](./o/open) | Open stuff like URLs, files, executables. Cross-pl
| 1697 | [lodash_dot_merge](./l/lodash_dot_merge) | The Lodash method _.merge exported as a module.
| 1693 | [lru-cache](./l/lru-cache) | A cache object that deletes the least-recently-use
...
| 1683 | [koa-router](./k/koa-router) | Router middleware for koa. Provides RESTful resour
...
| 1599 | [readline-sync](./r/readline-sync) | Synchronous Readline for interactively running to 
...
| 1519 | [shortid](./s/shortid) | Amazingly short non-sequential url-friendly unique
| 1518 | [concat-stream](./c/concat-stream) | writable stream that concatenates strings or binar
| 1509 | [esprima](./e/esprima) | ECMAScript parsing infrastructure for multipurpose
| 1499 | [config](./c/config) | Configuration control for production node deployme
| 1498 | [pug](./p/pug) | A clean, whitespace-sensitive template language fo
| 1490 | [graceful-fs](./g/graceful-fs) | A drop-in replacement for fs, making various impro
| 1484 | [webpack-merge](./w/webpack-merge) | Variant of merge that's useful for webpack configu
| 1477 | [tslint](./t/tslint) | An extensible static analysis linter for the TypeS
| 1470 | [bindings](./b/bindings) | Helper module for loading your native module's .no
...
| 1378 | [puppeteer](./p/puppeteer) | A high-level API to control headless Chrome over t
...
| 1253 | [form-data](./f/form-data) | A library to create readable "multipart/form-data"
...
| 1227 | [webpack-hot-middleware](./w/webpack-hot-middleware) | Webpack hot reloading you can attach to your own s
| 1223 | [gulp-sass](./g/gulp-sass) | Gulp plugin for sass
| 1223 | [recompose](./r/recompose) | A React utility belt for function components and h
| 1222 | [which](./w/which) | Like which(1) unix command. Find the first instanc
| 1220 | [bignumber_dot_js](./b/bignumber_dot_js) | A library for arbitrary-precision decimal and non-
| 1218 | [jest-resolve](./j/jest-resolve) | -
...
| 1171 | [xmldom](./x/xmldom) | A W3C Standard XML DOM(Level2 CORE) implementation
| 1163 | [web3](./w/web3) | Ethereum JavaScript API
| 1162 | [nconf](./n/nconf) | Hierarchical node.js configuration with files, env
...
| 1102 | [html-minifier](./h/html-minifier) | Highly configurable, well-tested, JavaScript-based
| 1101 | [recursive-readdir](./r/recursive-readdir) | Get an array of all files in a directory and subdi
...
| 1059 | [log-symbols](./l/log-symbols) | Colored symbols for various log levels. Example: ✔
...
| 1032 | [color](./c/color) | Color conversion and manipulation with CSS string 
...
| 1003 | [yamljs](./y/yamljs) | Standalone JavaScript YAML 1.2 Parser & Encoder. W
| 998 | [nopt](./n/nopt) | Option parsing for Node, supporting types, shortha
| 994 | [ms](./m/ms) | Tiny millisecond conversion utility
| 987 | [ioredis](./i/ioredis) | A robust, performance-focused and full-featured Re
...
| 951 | [eventemitter2](./e/eventemitter2) | A Node.js event emitter implementation with namesp
...
| 938 | [react-router-redux](./r/react-router-redux) | Ruthlessly simple bindings to keep react-router an
| 934 | [run-sequence](./r/run-sequence) | Run a series of dependent gulp tasks in order
| 933 | [camelcase](./c/camelcase) | Convert a dash/dot/underscore/space separated stri
...
| 931 | [knex](./k/knex) | A batteries-included SQL query & schema builder fo
| 927 | [cssnano](./c/cssnano) | A modular minifier, built on top of the PostCSS ec
...
| 857 | [jszip](./j/jszip) | Create, read and edit .zip files with JavaScript h
| 852 | [js-cookie](./j/js-cookie) | A simple, lightweight JavaScript API for handling 
| 850 | [change-case](./c/change-case) | Convert a string between camelCase, PascalCase, Ti
| 847 | [create-react-class](./c/create-react-class) | Legacy API for creating React components.
| 842 | [app-root-path](./a/app-root-path) | Determine an app's root path from anywhere inside 
| 833 | [pump](./p/pump) | pipe streams together and close all of them if one
...
| 821 | [adm-zip](./a/adm-zip) | Javascript implementation of zip for nodejs with s
...
| 809 | [istanbul](./i/istanbul) | Yet another JS code coverage tool that computes st
...
| 798 | [string](./s/string) | string contains methods that aren't included in th
| 796 | [webpack-bundle-analyzer](./w/webpack-bundle-analyzer) | Webpack plugin and CLI utility that represents bun
| 786 | [elasticsearch](./e/elasticsearch) | The official low-level Elasticsearch client for No
| 784 | [numeral](./n/numeral) | Format and manipulate numbers.
| 779 | [clean-webpack-plugin](./c/clean-webpack-plugin) | A webpack plugin to remove/clean your build folder
| 778 | [formidable](./f/formidable) | A node.js module for parsing form data, especially
| 774 | [sprintf-js](./s/sprintf-js) | JavaScript sprintf implementation
| 773 | [rsvp](./r/rsvp) | A lightweight library that provides tools for orga
...
| 765 | [traverse](./t/traverse) | traverse and transform objects by visiting every n
| 762 | [argparse](./a/argparse) | Very powerful CLI arguments parser. Native port of
| 762 | [workbox-webpack-plugin](./w/workbox-webpack-plugin) | A plugin for your Webpack build process, helping y
...
| 749 | [bcryptjs](./b/bcryptjs) | Optimized bcrypt in plain JavaScript with zero dep
| 746 | [protobufjs](./p/protobufjs) | Protocol Buffers for JavaScript (& TypeScript).
| 745 | [connect-history-api-fallb](./c/connect-history-api-fallback) | Provides a fallback for non-existing directories s
| 741 | [systemjs](./s/systemjs) | Dynamic ES module loader
| 740 | [url-parse](./u/url-parse) | Small footprint URL parser that works seamlessly a
| 736 | [websocket](./w/websocket) | Websocket Client & Server Library implementing the
| 735 | [json-stringify-safe](./j/json-stringify-safe) | Like JSON.stringify, but doesn't blow up on circul
| 731 | [unzip](./u/unzip) | Unzip cross-platform streaming API compatible with
...
| 719 | [requirejs](./r/requirejs) | Node adapter for RequireJS, for loading AMD module
...
| 701 | [dayjs](./d/dayjs) | 2KB immutable date time library alternative to Mom
| 699 | [configstore](./c/configstore) | Easily load and save config without having to thin
...
| 686 | [json-stable-stringify](./j/json-stable-stringify) | deterministic JSON.stringify() with custom sorting
| 686 | [rollup-plugin-node-resolv](./r/rollup-plugin-node-resolve) | Bundle third-party dependencies in node_modules
...
| 683 | [rx](./r/rx) | Library for composing asynchronous and event-based
| 679 | [babel-types](./b/babel-types) | Babel Types is a Lodash-esque utility library for 
| 678 | [elliptic](./e/elliptic) | EC cryptography
| 674 | [xmlbuilder](./x/xmlbuilder) | An XML builder for node.js
| 672 | [wrench](./w/wrench) | Recursive filesystem (and other) operations that N
| 671 | [metalsmith](./m/metalsmith) | An extremely simple, pluggable static site generat
| 668 | [cron](./c/cron) | Cron jobs for your node
| 665 | [escape-html](./e/escape-html) | Escape string for use in HTML
| 665 | [ssh2](./s/ssh2) | SSH2 client and server modules written in pure Jav
| 658 | [xlsx](./x/xlsx) | SheetJS Spreadsheet data parser and writer
| 656 | [sharp](./s/sharp) | High performance Node.js image processing, the fas
| 655 | [find-up](./f/find-up) | Find a file or directory by walking up parent dire
| 655 | [lodash-es](./l/lodash-es) | Lodash exported as ES modules.
| 655 | [portfinder](./p/portfinder) | A simple tool to find an open port on the current 
...
| 642 | [send](./s/send) | Better streaming static file server with Range and
| 641 | [es6-shim](./e/es6-shim) | ECMAScript 6 (Harmony) compatibility shims for leg
...
| 625 | [echarts](./e/echarts) | A powerful charting and visualization library for 
| 621 | [image-size](./i/image-size) | get dimensions of any image file
| 621 | [jimp](./j/jimp) | An image processing library written entirely in Ja
| 621 | [sax](./s/sax) | An evented streaming XML parser in JavaScript
| 609 | [graphql-tools](./g/graphql-tools) | Useful tools to create and manipulate GraphQL sche
| 605 | [methods](./m/methods) | HTTP methods that node supports
| 605 | [micromatch](./m/micromatch) | Glob matching for javascript/node.js. A replacemen
...
| 590 | [swig](./s/swig) | A simple, powerful, and extendable templating engi
| 589 | [parse5](./p/parse5) | HTML parser and serializer.
| 588 | [jest-pnp-resolver](./j/jest-pnp-resolver) | plug'n'play resolver for Webpack
...
| 574 | [flat](./f/flat) | Take a nested Javascript object and flatten it, or
...
| 557 | [react-addons-css-transiti](./r/react-addons-css-transition-group) | The code in this package has moved. We recommend y
| 555 | [gulp-install](./g/gulp-install) | Automatically install npm, bower, tsd, and pip pac
| 554 | [deasync](./d/deasync) | Turns async function into sync via JavaScript wrap
| 553 | [d3-scale](./d/d3-scale) | Encodings that map abstract data to visual represe
...
| 551 | [friendly-errors-webpack-p](./f/friendly-errors-webpack-plugin) | Recognizes certain classes of webpack errors and c
| 550 | [electron](./e/electron) | Build cross platform desktop apps with JavaScript,
| 550 | [object-hash](./o/object-hash) | Generate hashes from javascript objects in node an
| 550 | [throttle-debounce](./t/throttle-debounce) | Throttle and debounce functions.
| 549 | [react-intl](./r/react-intl) | Internationalize React apps. This library provides
...
| 539 | [blessed](./b/blessed) | A high-level terminal interface library for node.j
...
| 530 | [node-schedule](./n/node-schedule) | A cron-like and not-cron-like job scheduler for No
...
| 524 | [levelup](./l/levelup) | Fast & simple storage - a Node.js-style LevelDB wr
| 523 | [polished](./p/polished) | A lightweight toolset for writing styles in Javasc
| 522 | [plist](./p/plist) | Mac OS X Plist parser/builder for Node.js and brow
| 521 | [lodash_dot_set](./l/lodash_dot_set) | The lodash method _.set exported as a module.
| 521 | [strip-json-comments](./s/strip-json-comments) | Strip comments from JSON. Lets you use comments in
...
| 510 | [on-finished](./o/on-finished) | Execute a callback when a request closes, finishes
| 509 | [command-line-usage](./c/command-line-usage) | Generates command-line usage information
| 509 | [gulp-load-plugins](./g/gulp-load-plugins) | Automatically load any gulp plugins in your packag
...
| 495 | [is-plain-object](./i/is-plain-object) | Returns true if an object was created by the Objec
| 494 | [react-motion](./r/react-motion) | A spring that solves your animation problems.
| 493 | [babel-traverse](./b/babel-traverse) | The Babel Traverse module maintains the overall tr
| 493 | [react-tap-event-plugin](./r/react-tap-event-plugin) | Facebook's TapEventPlugin, temporarily available o
| 492 | [node-forge](./n/node-forge) | JavaScript implementations of network transports, 
| 492 | [raw-body](./r/raw-body) | Get and validate the raw body of a readable stream
| 488 | [touch](./t/touch) | like touch(1) in node
| 488 | [urijs](./u/urijs) | URI.js is a Javascript library for working with UR
...
| 485 | [loglevel](./l/loglevel) | Minimal lightweight logging for JavaScript, adding
| 485 | [multimatch](./m/multimatch) | Extends minimatch.match() with support for multipl
...
| 475 | [he](./h/he) | A robust HTML entities encoder/decoder with full U
| 472 | [emotion](./e/emotion) | The Next Generation of CSS-in-JS.
| 472 | [phantomjs](./p/phantomjs) | Headless WebKit with JS API
| 471 | [redux-form](./r/redux-form) | A higher order component decorator for forms using
...
| 459 | [memory-fs](./m/memory-fs) | A simple in-memory filesystem. Holds data in a jav
| 459 | [slugify](./s/slugify) | Slugifies a String
...
| 450 | [mathjs](./m/mathjs) | Math.js is an extensive math library for JavaScrip
...
| 440 | [needle](./n/needle) | The leanest and most handsome HTTP client in the N
| 439 | [rc-util](./r/rc-util) | Common Utils For React Component
| 438 | [gulp-minify-css](./g/gulp-minify-css) | Minify css with clean-css.
| 438 | [tar-fs](./t/tar-fs) | filesystem bindings for tar-stream
| 437 | [file-type](./f/file-type) | Detect the file type of a Buffer/Uint8Array/ArrayB
| 437 | [inversify](./i/inversify) | A powerful and lightweight inversion of control co
| 436 | [pino](./p/pino) | super fast, all natural json logger
| 436 | [react-icons](./r/react-icons) | SVG React icons of popular icon packs using ES6 im
| 435 | [convert-source-map](./c/convert-source-map) | Converts a source-map from/to  different formats a
| 435 | [rxjs-compat](./r/rxjs-compat) |  RxJS: Reactive Extensions For JavaScript ========
| 434 | [cosmiconfig](./c/cosmiconfig) | Find and load configuration from a package.json pr
...
| 432 | [ethers](./e/ethers) | Ethereum wallet library.
| 431 | [cross-fetch](./c/cross-fetch) | Universal WHATWG Fetch API for Node, Browsers and 
| 431 | [jwt-decode](./j/jwt-decode) | Decode JWT tokens, mostly useful for browser appli
| 430 | [gulp-filter](./g/gulp-filter) | Filter files in a Vinyl stream
| 429 | [keycode](./k/keycode) | Convert between keyboard keycodes and keynames and
...
| 427 | [stack-trace](./s/stack-trace) | Get v8 stack traces as an array of CallSite object
| 426 | [opener](./o/opener) | Opens stuff, like webpages and files and executabl
...
| 419 | [vorpal](./v/vorpal) | Node's first framework for building immersive CLI 
| 417 | [https-proxy-agent](./h/https-proxy-agent) | An HTTP(s) proxy http.Agent implementation for HTT
| 415 | [chai-as-promised](./c/chai-as-promised) | Extends Chai with assertions about promises.
| 415 | [fork-ts-checker-webpack-p](./f/fork-ts-checker-webpack-plugin) | Runs typescript type checker and linter on separat
| 415 | [node-cache](./n/node-cache) | Simple and fast NodeJS internal caching. Node inte
...
| 413 | [selenium-webdriver](./s/selenium-webdriver) | The official WebDriver JavaScript bindings from th
| 413 | [sha1](./s/sha1) | native js function for hashing messages with SHA-1
| 412 | [base-64](./b/base-64) | A robust base64 encoder/decoder that is fully comp
...
| 402 | [long](./l/long) | A Long class for representing a 64-bit two's-compl
...
| 400 | [make-dir](./m/make-dir) | Make a directory and its parents if needed - Think
| 400 | [promise-polyfill](./p/promise-polyfill) | Lightweight promise polyfill. A+ compliant
| 399 | [http-server](./h/http-server) | A simple zero-configuration command-line http serv
| 398 | [depd](./d/depd) | Deprecate all the things
| 396 | [columnify](./c/columnify) | Render data in text columns. Supports in-column te
| 396 | [passport-strategy](./p/passport-strategy) | An abstract class implementing Passport's strategy
| 396 | [serialize-javascript](./s/serialize-javascript) | Serialize JavaScript to a superset of JSON that in
...
| 391 | [lowdb](./l/lowdb) | Small JSON database for Node, Electron and the bro
| 389 | [deep-diff](./d/deep-diff) | Javascript utility for calculating deep difference
| 389 | [findup-sync](./f/findup-sync) | Find the first file matching a given pattern in th
| 389 | [gulp-typescript](./g/gulp-typescript) | A typescript compiler for gulp with incremental co
...
| 387 | [node-dir](./n/node-dir) | asynchronous file and directory operations for Nod
| 387 | [react-native-vector-icons](./r/react-native-vector-icons) | Customizable Icons for React Native with support f
| 386 | [babel__types](./b/babel__types) | Babel Types is a Lodash-esque utility library for 
| 384 | [koa-logger](./k/koa-logger) | Logging middleware for koa
| 384 | [preact](./p/preact) | Fast 3kb React alternative with the same modern AP
| 383 | [dom-helpers](./d/dom-helpers) | tiny modular DOM lib for ie8+
| 382 | [argv](./a/argv) | CLI Argument Parser
| 382 | [cli-table2](./c/cli-table2) | Pretty unicode tables for the command line. Based 
| 382 | [secp256k1](./s/secp256k1) | This module provides native bindings to ecdsa secp
| 382 | [tildify](./t/tildify) | Convert an absolute path to a tilde path: /Users/s
| 382 | [utils-merge](./u/utils-merge) | merge() utility function
| 380 | [d3-shape](./d/d3-shape) | Graphical primitives for visualization, such as li
| 380 | [node-static](./n/node-static) | simple, compliant file streaming module for node
| 380 | [react-virtualized](./r/react-virtualized) | React components for efficiently rendering large, 
| 380 | [utf8](./u/utf8) | A well-tested UTF-8 encoder/decoder written in Jav
...
| 379 | [tweetnacl](./t/tweetnacl) | Port of TweetNaCl cryptographic library to JavaScr
| 377 | [bl](./b/bl) | Buffer List: collect buffers and access with a sta
...
| 370 | [split2](./s/split2) | split a Text Stream into a Line Stream, using Stre
| 370 | [uglify-es](./u/uglify-es) | JavaScript parser, mangler/compressor and beautifi
| 369 | [inert](./i/inert) | Static file and directory handlers plugin for hapi
...
| 354 | [react-color](./r/react-color) | A Collection of Color Pickers from Sketch, Photosh
| 351 | [babel-plugin-macros](./b/babel-plugin-macros) | Allows you to build compile-time libraries
| 351 | [postcss-nested](./p/postcss-nested) | PostCSS plugin to unwrap nested rules like how Sas
...
| 350 | [tv4](./t/tv4) | A public domain JSON Schema validator for JavaScri
| 348 | [http-status-codes](./h/http-status-codes) | Constants enumerating the HTTP status codes. Based
...
| 344 | [sinon-chai](./s/sinon-chai) | Extends Chai with assertions for the Sinon.JS mock
| 343 | [ethereumjs-tx](./e/ethereumjs-tx) | An simple module for creating, manipulating and si
| 343 | [flux](./f/flux) | An application architecture based on a unidirectio
| 343 | [iniparser](./i/iniparser) | a simple .ini parser
| 343 | [nanoid](./n/nanoid) | A tiny (141 bytes), secure URL-friendly unique str
...
| 339 | [web3-utils](./w/web3-utils) | Collection of utility functions used in web3.js.
...
| 335 | [sanitize-html](./s/sanitize-html) | Clean up user-submitted HTML, preserving whitelist
| 334 | [react-addons-shallow-comp](./r/react-addons-shallow-compare) | >**Note:** >This is a legacy React addon, and is n
| 333 | [normalize-url](./n/normalize-url) | Normalize a URL
| 333 | [radium](./r/radium) | A set of tools to manage inline styles on React el
| 332 | [dot](./d/dot) | Concise and fast javascript templating compatible 
| 332 | [extract-zip](./e/extract-zip) | unzip a zip file into a directory using 100% javas
| 331 | [nprogress](./n/nprogress) | Simple slim progress bars
| 331 | [raven](./r/raven) | A standalone (Node.js) client for Sentry
| 331 | [setimmediate](./s/setimmediate) | A shim for the setImmediate efficient script yield
...
| 329 | [yeoman-environment](./y/yeoman-environment) | Handles the lifecyle and bootstrapping of generato
| 328 | [babel__traverse](./b/babel__traverse) | The Babel Traverse module maintains the overall tr
| 328 | [deep-assign](./d/deep-assign) | Recursive Object.assign()
| 328 | [is](./i/is) | the definitive JavaScript type testing library
| 328 | [nock](./n/nock) | HTTP server mocking and expectations library for N
| 328 | [resolve-from](./r/resolve-from) | Resolve the path of a module like require.resolve(
| 327 | [base64-js](./b/base64-js) | Base64 encoding/decoding in pure JS
| 327 | [decamelize](./d/decamelize) | Convert a camelized string into a lowercased one w
| 326 | [intl](./i/intl) | Polyfill the ECMA-402 Intl API (except collation)
| 326 | [sockjs-client](./s/sockjs-client) | SockJS-client is a browser JavaScript library that
| 326 | [xhr](./x/xhr) | small xhr abstraction
| 326 | [xpath](./x/xpath) | DOM 3 XPath implemention and helper for node.js.
...
| 323 | [gh-pages](./g/gh-pages) | Publish to a gh-pages branch on GitHub (or any oth
| 323 | [memoize-one](./m/memoize-one) | A memoization library which only remembers the lat
| 322 | [copy-paste](./c/copy-paste) | A command line utility that allows read/write (i.e
| 322 | [phosphor__widgets](./p/phosphor__widgets) | PhosphorJS - Widgets
| 322 | [semantic-ui-react](./s/semantic-ui-react) | The official Semantic-UI-React integration.
| 321 | [concurrently](./c/concurrently) | Run commands concurrently
| 321 | [phantom](./p/phantom) | PhantomJS integration module for NodeJS
| 319 | [fastclick](./f/fastclick) | Polyfill to remove click delays on browsers with t
...
| 317 | [atob](./a/atob) | atob for Node.JS and Linux / Mac / Windows CLI (it
| 317 | [big_dot_js](./b/big_dot_js) | A small, fast, easy-to-use library for arbitrary-p
| 317 | [react-loadable](./r/react-loadable) | A higher order component for loading components wi
| 315 | [jsonpath](./j/jsonpath) | Query JavaScript objects with JSONPath expressions
| 314 | [callsite](./c/callsite) | access to v8's CallSites
| 314 | [cookies](./c/cookies) | Cookies, optionally signed using Keygrip.
| 314 | [multiparty](./m/multiparty) | multipart/form-data parser which supports streamin
| 313 | [pretty-ms](./p/pretty-ms) | Convert milliseconds to a human readable string: 1
| 312 | [react-datepicker](./r/react-datepicker) | A simple and reusable datepicker component for Rea
...
| 303 | [mv](./m/mv) | fs.rename but works across devices. same as the un
| 301 | [isobject](./i/isobject) | Returns true if the value is an object and not an 
...
| 299 | [keymirror](./k/keymirror) | A simple utility for creating an object with value
| 299 | [on-headers](./o/on-headers) | Execute a listener when a response is about to wri
...
| 297 | [wordwrap](./w/wordwrap) | Wrap those words. Show them at what columns to sta
| 296 | [duplexify](./d/duplexify) | Turn a writable and readable stream into a streams
...
| 294 | [end-of-stream](./e/end-of-stream) | Call a callback when a readable/writable/duplex st
...
| 284 | [dot-prop](./d/dot-prop) | Get, set, or delete a property from a nested objec
...
| 284 | [require-directory](./r/require-directory) | Recursively iterates over specified directory, req
| 283 | [json2csv](./j/json2csv) | Convert JSON to CSV
| 283 | [retry](./r/retry) | Abstraction for exponential and custom retry strat
...
| 281 | [video_dot_js](./v/video_dot_js) | An HTML5 and Flash video player with a common API 
| 281 | [walk-sync](./w/walk-sync) | Get an array of recursive directory contents
...
| 280 | [natural](./n/natural) | General natural language (tokenizing, stemming (En
...
| 279 | [ansi-colors](./a/ansi-colors) | Easily add ANSI colors to your text and symbols in
| 279 | [js-sha3](./j/js-sha3) | A simple SHA-3 / Keccak / Shake hash function for 
| 279 | [jupyterlab__application](./j/jupyterlab__application) | JupyterLab - Application
| 278 | [browserslist](./b/browserslist) | Share target browsers between different front-end 
| 278 | [camel-case](./c/camel-case) | Camel case a string
| 278 | [cookie-signature](./c/cookie-signature) | Sign and unsign cookies
| 278 | [string-width](./s/string-width) | Get the visual width of a string - the number of c
| 277 | [address](./a/address) | Get current machine IP, MAC and DNS servers.
| 277 | [bitcoinjs-lib](./b/bitcoinjs-lib) | Client-side Bitcoin JavaScript library
| 277 | [denodeify](./d/denodeify) | Tool to turn functions with Node-style callback AP
...
| 276 | [pkg-dir](./p/pkg-dir) | Find the root directory of a Node.js project or np
...
| 272 | [google-auth-library](./g/google-auth-library) | Google APIs Authentication Client Library for Node
...
| 269 | [xml](./x/xml) | Fast and simple xml generator. Supports attributes
| 268 | [koa-compress](./k/koa-compress) | Compress middleware for koa
| 268 | [sugar](./s/sugar) | A Javascript utility library for working with nati
| 267 | [ftp](./f/ftp) | An FTP client module for node.js
| 266 | [compression-webpack-plugi](./c/compression-webpack-plugin) | Prepare compressed versions of assets to serve the
| 266 | [luxon](./l/luxon) | Immutable date wrapper
| 266 | [material-ui__styles](./m/material-ui__styles) | Material-UI Styles - The styling solution of Mater
...
| 263 | [xml-js](./x/xml-js) | A convertor between XML text and Javascript object
| 262 | [dedent](./d/dedent) | An ES6 string tag that strips indentation from mul
| 262 | [merge-descriptors](./m/merge-descriptors) | Merge objects using descriptors
| 262 | [readdirp](./r/readdirp) | Recursive version of fs.readdir with streaming api
| 261 | [express-handlebars](./e/express-handlebars) | A Handlebars view engine for Express which doesn't
| 261 | [i18n](./i/i18n) | lightweight translation module with dynamic json s
| 261 | [twilio](./t/twilio) | A Twilio helper library
| 261 | [untildify](./u/untildify) | Convert a tilde path to an absolute path: ~/dev =>
| 260 | [koa-convert](./k/koa-convert) | convert koa legacy generator-based middleware to p
| 260 | [sortablejs](./s/sortablejs) | JavaScript library for reorderable drag-and-drop l
| 259 | [archy](./a/archy) | render nested hierarchies npm ls style with unicod
| 259 | [ecurve](./e/ecurve) | Elliptic curve cryptography
| 259 | [store](./s/store) | A localStorage wrapper for all browsers without us
| 258 | [apollo-server-express](./a/apollo-server-express) | Production-ready Node.js GraphQL server for Expres
| 258 | [tar-stream](./t/tar-stream) | tar-stream is a streaming tar parser and generator
...
| 256 | [qiniu](./q/qiniu) | Node wrapper for Qiniu Resource (Cloud) Storage AP
| 255 | [docopt](./d/docopt) | a command line option parser that will make you sm
| 255 | [node-localstorage](./n/node-localstorage) | A drop-in substitute for the browser native localS
| 255 | [styled-system](./s/styled-system) | Responsive, theme-based style props for building d
| 255 | [wreck](./w/wreck) | HTTP Client Utilities
| 254 | [jsrsasign](./j/jsrsasign) | opensource free pure JavaScript cryptographic libr
| 254 | [tether](./t/tether) | A client-side library to make absolutely positione
| 253 | [amqp](./a/amqp) | AMQP driver for node
| 253 | [delay](./d/delay) | Delay a promise a specified amount of time
| 253 | [lodash_dot_defaultsdeep](./l/lodash_dot_defaultsdeep) | The lodash method _.defaultsDeep exported as a mod
| 253 | [react-portal](./r/react-portal) | To make your life with React Portals easier.
| 252 | [gsap](./g/gsap) | GSAP is a JavaScript library for creating high-per
| 252 | [react-overlays](./r/react-overlays) | Utilities for creating robust overlay components
| 251 | [humps](./h/humps) | Underscore-to-camelCase converter (and vice versa)
| 251 | [toposort](./t/toposort) | Topological sort of directed ascyclic graphs (like
| 251 | [yaml](./y/yaml) | JavaScript parser and stringifier for YAML
| 250 | [fast-deep-equal](./f/fast-deep-equal) | Fast deep equal
| 250 | [gulp-rev](./g/gulp-rev) | Static asset revisioning by appending content hash
| 249 | [fast-csv](./f/fast-csv) | CSV parser and writer
...
| 248 | [knockout](./k/knockout) | Knockout makes it easier to create rich, responsiv
| 248 | [string-template](./s/string-template) | A simple string template function based on named o
| 247 | [noble](./n/noble) | A Node.js BLE (Bluetooth Low Energy) central libra
| 247 | [normalizr](./n/normalizr) | Normalizes and denormalizes JSON according to sche
...
| 239 | [is-glob](./i/is-glob) | Returns true if the given string looks like a glob
...
| 238 | [swagger-parser](./s/swagger-parser) | Swagger 2.0 and OpenAPI 3.0 parser and validator f
| 237 | [interpret](./i/interpret) | A dictionary of file extensions and associated mod
...
| 235 | [csvtojson](./c/csvtojson) | A tool concentrating on converting csv data to JSO
...
| 234 | [gulp-debug](./g/gulp-debug) | Debug Vinyl file streams to see what files are run
...
| 232 | [tedious](./t/tedious) | A TDS driver, for connecting to MS SQLServer datab
...
| 228 | [server-destroy](./s/server-destroy) | Enable destroying a server, and all currently open
| 228 | [uniqid](./u/uniqid) | Unique ID Generator
| 227 | [circular-json](./c/circular-json) | JSON does not handle circular references. This ver
| 227 | [convict](./c/convict) | Featureful configuration management library for No
...
| 227 | [useragent](./u/useragent) | Fastest, most accurate & effecient user agent stri
| 226 | [co-body](./c/co-body) | request body parsing for co
| 226 | [continuation-local-storag](./c/continuation-local-storage) | userland implementation of https://github.com/joye
...
| 224 | [merge2](./m/merge2) | Merge multiple streams into one stream in sequence
...
| 223 | [compare-versions](./c/compare-versions) | Compare semver version strings to find greater, eq
| 223 | [gl-matrix](./g/gl-matrix) | Javascript Matrix and Vector library for High Perf
| 223 | [remarkable](./r/remarkable) | Markdown parser, done right. 100% Commonmark suppo
| 223 | [serialize-error](./s/serialize-error) | Serialize an error into a plain object
| 223 | [sockjs](./s/sockjs) | SockJS-node is a server counterpart of SockJS-clie
| 221 | [ink](./i/ink) | React for CLI
| 221 | [is-buffer](./i/is-buffer) | Determine if an object is a Buffer
| 221 | [jupyterlab__apputils](./j/jupyterlab__apputils) | JupyterLab - Application Utilities
...
| 218 | [core-decorators](./c/core-decorators) | Library of JavaScript stage-0 decorators (aka ES20
| 218 | [react-event-listener](./r/react-event-listener) | A React component that allow to bind events on the
...
| 215 | [cli-progress](./c/cli-progress) | Easy to use Progress-Bar for Command-Line/Terminal
| 215 | [express-graphql](./e/express-graphql) | Production ready GraphQL HTTP middleware.
| 215 | [passport-jwt](./p/passport-jwt) | Passport authentication strategy using JSON Web To
| 215 | [react-fontawesome](./r/react-fontawesome) | A React component for the font-awesome icon librar
...
| 213 | [normalize-path](./n/normalize-path) | Normalize slashes in a file path to be posix/unix-
...
| 212 | [write-file-atomic](./w/write-file-atomic) | Write files in an atomic fashion w/configurable ow
| 211 | [babel-code-frame](./b/babel-code-frame) | Generate errors that contain a code frame that poi
| 211 | [passport-twitter](./p/passport-twitter) | Twitter authentication strategy for Passport.
| 211 | [pg-promise](./p/pg-promise) | Promises interface for PostgreSQL
| 211 | [punycode](./p/punycode) | A robust Punycode converter that fully complies to
| 211 | [string-hash](./s/string-hash) | fast string hashing function
| 211 | [subscriptions-transport-w](./s/subscriptions-transport-ws) | A websocket transport for GraphQL subscriptions
| 211 | [swiper](./s/swiper) | Most modern mobile touch slider and framework with
| 210 | [anymatch](./a/anymatch) | Matches strings against configurable strings, glob
...
| 210 | [react-immutable-proptypes](./r/react-immutable-proptypes) | PropType validators that work with Immutable.js.
...
| 209 | [insert-css](./i/insert-css) | insert a string of css into the 
| 209 | [markdown-it-container](./m/markdown-it-container) | Plugin to create block-level custom containers for
| 209 | [papaparse](./p/papaparse) | Fast and powerful CSV parser for the browser that 
| 209 | [q-io](./q/q-io) | IO using Q promises
| 209 | [qrcode](./q/qrcode) | QRCode / 2d Barcode api with both server side and 
| 208 | [angular-ui-bootstrap](./a/angular-ui-bootstrap) | Native AngularJS (Angular) directives for Bootstra
| 207 | [ipaddr_dot_js](./i/ipaddr_dot_js) | A library for manipulating IPv4 and IPv6 addresses
| 207 | [npm-package-arg](./n/npm-package-arg) | Parse the things that can be arguments to npm inst
| 206 | [email-validator](./e/email-validator) | Provides a fast, pretty robust e-mail validator. O
| 206 | [jssha](./j/jssha) | jsSHA is a JavaScript implementation of the comple
| 205 | [enhanced-resolve](./e/enhanced-resolve) | Offers a async require.resolve function. It's high
| 205 | [eventsource](./e/eventsource) | W3C compliant EventSource client for Node.js and b
| 205 | [passport-http](./p/passport-http) | HTTP Basic and Digest authentication strategies fo
| 205 | [phosphor__coreutils](./p/phosphor__coreutils) | PhosphorJS - Core Utilities
| 204 | [better-scroll](./b/better-scroll) | inspired by iscroll, and it has a better scroll pe
| 204 | [gulp-zip](./g/gulp-zip) | ZIP compress files
| 204 | [js-string-escape](./j/js-string-escape) | Escape strings for use as JavaScript string litera
| 204 | [parcel-bundler](./p/parcel-bundler) | Blazing fast, zero configuration web application b
| 204 | [pem](./p/pem) | Create private keys and certificates with node.js 
| 204 | [prelude-ls](./p/prelude-ls) | prelude.ls is a functionally oriented utility libr
| 203 | [detect-node](./d/detect-node) | Detect Node.JS (as opposite to browser environment
| 203 | [is-root](./i/is-root) | Check if the process is running as root user, for 
| 202 | [d3-format](./d/d3-format) | Format numbers for human consumption.
| 202 | [dataloader](./d/dataloader) | A data loading utility to reduce requests to a bac
| 202 | [mkpath](./m/mkpath) | Make all directories in a path, like mkdir -p
| 202 | [msgpack-lite](./m/msgpack-lite) | Fast Pure JavaScript MessagePack Encoder and Decod
| 201 | [backoff](./b/backoff) | Fibonacci and exponential backoffs.
| 201 | [lokijs](./l/lokijs) | Fast document oriented javascript in-memory databa
| 201 | [react-addons-pure-render-](./r/react-addons-pure-render-mixin) | >**Note:** >This is a legacy React addon, and is n
| 201 | [uppercamelcase](./u/uppercamelcase) | Convert a dash/dot/underscore/space separated stri
...
| 200 | [rc-table](./r/rc-table) | table ui component for react
| 199 | [consola](./c/consola) | Elegant Console Logger for Node.js and Browser
| 199 | [dustjs-linkedin](./d/dustjs-linkedin) | Asynchronous templates for the browser and server 
| 199 | [isbinaryfile](./i/isbinaryfile) | Detects if a file is binary in Node.js. Similar to
| 199 | [node-persist](./n/node-persist) | Super-easy (and fast) persistent data structures i
| 199 | [sleep](./s/sleep) | Add sleep() and usleep() to nodejs
| 199 | [stringify-object](./s/stringify-object) | Stringify an object/array like JSON.stringify just
| 199 | [web-animations-js](./w/web-animations-js) | JavaScript implementation of the Web Animations AP
| 198 | [app-module-path](./a/app-module-path) | Simple module to add additional directories to the
| 198 | [global-modules](./g/global-modules) | The directory used by npm for globally installed n
| 198 | [imagemagick](./i/imagemagick) | A wrapper around the imagemagick cli
| 198 | [klaw-sync](./k/klaw-sync) | Recursive, synchronous, and fast file system walke
...
| 196 | [uws](./u/uws) | -
| 195 | [memcached](./m/memcached) | A fully featured Memcached API client, supporting 
| 195 | [react-addons-update](./r/react-addons-update) | >**Note:** >This is a legacy React addon, and is n
...
| 193 | [imagemin-mozjpeg](./i/imagemin-mozjpeg) | Imagemin plugin for mozjpeg
| 193 | [lodash_dot_difference](./l/lodash_dot_difference) | The lodash method _.difference exported as a modul
...
| 190 | [koa-session](./k/koa-session) | Koa cookie session middleware with external store 
| 190 | [promise-retry](./p/promise-retry) | Retries a function that returns a promise, leverag
| 190 | [rc-dialog](./r/rc-dialog) | dialog ui component for react
| 190 | [react-textarea-autosize](./r/react-textarea-autosize) | textarea component for React which grows with cont
| 190 | [seamless-immutable](./s/seamless-immutable) | Immutable data structures for JavaScript which are
...
| 189 | [signal-exit](./s/signal-exit) | when you want to fire an event no matter how a pro
| 189 | [uid2](./u/uid2) | strong uid
...
| 188 | [object_dot_omit](./o/object_dot_omit) | Return a copy of an object excluding the given key
| 188 | [react-click-outside](./r/react-click-outside) | A component wrapper that provides click outside de
| 188 | [url-pattern](./u/url-pattern) | easier than regex string matching patterns for url
| 187 | [is-my-json-valid](./i/is-my-json-valid) | A JSONSchema validator that uses code generation t
...
| 186 | [ajv-keywords](./a/ajv-keywords) | Custom JSON-Schema keywords for Ajv validator
| 186 | [angular-route](./a/angular-route) | AngularJS router module
| 186 | [cli-table3](./c/cli-table3) | Pretty unicode tables for the command line. Based 
...
| 184 | [js-md5](./j/js-md5) | A simple MD5 hash function for JavaScript supports
| 184 | [js-sha256](./j/js-sha256) | A simple SHA-256 / SHA-224 hash function for JavaS
...
| 184 | [pretty](./p/pretty) | Some tweaks for beautifying HTML with js-beautify 
| 184 | [replacestream](./r/replacestream) | A node.js through stream that does basic streaming
...
| 181 | [react-syntax-highlighter](./r/react-syntax-highlighter) | syntax highlighting component for react with prism
| 181 | [terminal-kit](./t/terminal-kit) | 256 colors, keys and mouse, input field, progress 
...
| 179 | [buffer-crc32](./b/buffer-crc32) | A pure javascript CRC32 algorithm that plays nice 
| 179 | [jasmine-node](./j/jasmine-node) | DOM-less simple JavaScript BDD testing framework f
| 179 | [mri](./m/mri) | Quickly scan for CLI flags and arguments
| 179 | [react-mixin](./r/react-mixin) | -
| 178 | [aphrodite](./a/aphrodite) | Framework-agnostic CSS-in-JS with support for serv
...
| 176 | [screenfull](./s/screenfull) | Simple wrapper for cross-browser usage of the Java
| 176 | [webfontloader](./w/webfontloader) | Web Font Loader gives you added control when using
| 176 | [xstream](./x/xstream) | An extremely intuitive, small, and fast functional
...
| 174 | [is-number](./i/is-number) | Returns true if a number or string value is a fini
| 174 | [react-day-picker](./r/react-day-picker) | Flexible date picker component for React
| 174 | [redux-immutable](./r/redux-immutable) | redux-immutable is used to create an equivalent fu
...
| 172 | [angular-material](./a/angular-material) | This repository is used for publishing the Angular
...
| 169 | [capitalize](./c/capitalize) | capitalize the first letter of a string, or all wo
| 169 | [formik](./f/formik) | Forms in React, without tears
| 169 | [gulp-inject](./g/gulp-inject) | A javascript, stylesheet and webcomponent injectio
...
| 169 | [react-document-title](./r/react-document-title) | A declarative, nested, stateful document.title for
...
| 168 | [hosted-git-info](./h/hosted-git-info) | Provides metadata and conversions from repository 
...
| 165 | [react-sortable-hoc](./r/react-sortable-hoc) | Set of higher-order components to turn any list in
| 165 | [rss](./r/rss) | RSS feed generator. Add RSS feeds to any project. 
| 164 | [d3-time-format](./d/d3-time-format) | A JavaScript time formatter and parser inspired by
| 164 | [node-hid](./n/node-hid) | USB HID device access library
| 164 | [rc-select](./r/rc-select) | React Select
| 164 | [strip-indent](./s/strip-indent) | Strip leading whitespace from each line in a strin
| 163 | [consul](./c/consul) | Consul client
| 163 | [eyes](./e/eyes) | a customizable value inspector
| 163 | [from2](./f/from2) | Convenience wrapper for ReadableStream, with an AP
| 163 | [gulp-nodemon](./g/gulp-nodemon) | it's gulp + nodemon + convenience
| 163 | [hasha](./h/hasha) | Hashing made simple. Get the hash of a buffer/stri
| 163 | [json2mq](./j/json2mq) | Generate media query string from JSON or javascrip
...
| 162 | [array-unique](./a/array-unique) | Remove duplicate values from an array. Fastest ES5
| 162 | [elementtree](./e/elementtree) | XML Serialization and Parsing module based on Pyth
| 162 | [imagemin-svgo](./i/imagemin-svgo) | SVGO imagemin plugin
| 162 | [slate](./s/slate) | A completely customizable framework for building r
| 162 | [websocket-stream](./w/websocket-stream) | Use websockets with the node streams API. Works in
...
| 160 | [openurl](./o/openurl) | Open a URL via the operating system (http: in defa
| 159 | [aws4](./a/aws4) | Signs and prepares requests using AWS Signature Ve
| 159 | [encodeurl](./e/encodeurl) | Encode a URL to a percent-encoded form, excluding 
| 159 | [ps-tree](./p/ps-tree) | Get all children of a pid
| 159 | [string-length](./s/string-length) | Get the real length of a string - by correctly cou
| 159 | [wallpaper](./w/wallpaper) | Manage the desktop wallpaper
| 158 | [enzyme-to-json](./e/enzyme-to-json) | convert enzyme wrapper to a format compatible with
| 158 | [media-typer](./m/media-typer) | Simple RFC 6838 media type parser and formatter
| 158 | [proxyquire](./p/proxyquire) | Proxies nodejs require in order to allow overridin
| 158 | [ref-struct](./r/ref-struct) | Create ABI-compliant "struct" instances on top of 
| 158 | [util-deprecate](./u/util-deprecate) | The Node.js util.deprecate() function with browser
| 157 | [os-locale](./o/os-locale) | Get the system locale
| 157 | [proj4](./p/proj4) | Proj4js is a JavaScript library to transform point
...
| 156 | [react-table](./r/react-table) | A fast, lightweight, opinionated table and datagri
| 156 | [repeat-string](./r/repeat-string) | Repeat the given string n times. Fastest implement
| 156 | [wif](./w/wif) | Bitcoin Wallet Import Format (WIF) decoding/encodi
| 155 | [pdfkit](./p/pdfkit) | A PDF generation library for Node.js
| 155 | [sw-toolbox](./s/sw-toolbox) | Service Worker Toolbox provides some simple helper
| 155 | [throat](./t/throat) | Throttle the parallelism of an asynchronous (promi
| 154 | [angular-resource](./a/angular-resource) | AngularJS module for interacting with RESTful serv
...
| 152 | [phosphor__messaging](./p/phosphor__messaging) | PhosphorJS - Message Passing
| 152 | [rc-tree](./r/rc-tree) | tree ui component for react
| 152 | [window-size](./w/window-size) | Reliable way to get the height and width of termin
| 151 | [expo](./e/expo) | The Expo SDK
| 151 | [fecha](./f/fecha) | Date formatting and parsing
| 151 | [intl-messageformat](./i/intl-messageformat) | Formats ICU Message strings with number, date, plu
| 151 | [isstream](./i/isstream) | Determine if an object is a Stream
...
| 149 | [downshift](./d/downshift) | A set of primitives to build simple, flexible, WAI
...
| 146 | [p-limit](./p/p-limit) | Run multiple promise-returning & async functions w
...
| 145 | [kefir](./k/kefir) | Reactive Programming library for JavaScript inspir
...
| 145 | [select2](./s/select2) | Select2 is a jQuery based replacement for select b
| 145 | [term-img](./t/term-img) | Display images in iTerm
| 144 | [browser-resolve](./b/browser-resolve) | resolve which handles browser field support in pac
| 144 | [coffeeify](./c/coffeeify) | browserify plugin for coffeescript with support fo
| 144 | [gulp-ng-annotate](./g/gulp-ng-annotate) | Add angularjs dependency injection annotations wit
...
| 143 | [git-config](./g/git-config) | A simple way to extract out all the contents of a 
| 143 | [glob-parent](./g/glob-parent) | Extract the non-magic parent path from a glob stri
...
| 142 | [stream-to-array](./s/stream-to-array) | Concatenate a readable stream's data into a single
...
| 141 | [express-fileupload](./e/express-fileupload) | Simple express file upload middleware that wraps a
| 141 | [express-ws](./e/express-ws) | WebSocket endpoints for Express applications
| 141 | [jsonld](./j/jsonld) | A JSON-LD Processor and API implementation in Java
...
| 140 | [handlebars-helpers](./h/handlebars-helpers) | More than 130 Handlebars helpers in ~20 categories
| 140 | [requestretry](./r/requestretry) | request-retry wrap nodejs request to retry http(s)
| 140 | [spark-md5](./s/spark-md5) | Lightning fast normal and incremental md5 for java
...
| 139 | [clone-deep](./c/clone-deep) | Recursively (deep) clone JavaScript native types, 
| 139 | [fast-json-patch](./f/fast-json-patch) | Fast implementation of JSON-Patch (RFC-6902) with 
...
| 138 | [node-ipc](./n/node-ipc) | A nodejs module for local and remote Inter Process
...
| 137 | [parse-link-header](./p/parse-link-header) | Parses a link header and returns paging informatio
| 137 | [react-ace](./r/react-ace) | A react component for Ace Editor
| 137 | [react-addons-create-fragm](./r/react-addons-create-fragment) | -
| 137 | [worker-farm](./w/worker-farm) | Distribute processing tasks to child processes wit
| 136 | [aes-js](./a/aes-js) | A pure JavaScript implementation of the AES block 
| 136 | [ast-types](./a/ast-types) | Esprima-compatible implementation of the Mozilla J
...
| 136 | [jsbn](./j/jsbn) | The jsbn library is a fast, portable implementatio
...
| 133 | [hashids](./h/hashids) | Generate YouTube-like ids from numbers. Use Hashid
| 133 | [jss-preset-default](./j/jss-preset-default) | Default preset for JSS with selected plugins.
| 133 | [koa__cors](./k/koa__cors) | Cross-Origin Resource Sharing(CORS) for koa
| 133 | [object-keys](./o/object-keys) | An Object.keys replacement, in case Object.keys is
| 133 | [route-parser](./r/route-parser) | A isomorphic, bullet-proof, ninja-ready route pars
| 133 | [shell-escape](./s/shell-escape) | Escape and stringify an array of arguments to be e
| 133 | [simple-oauth2](./s/simple-oauth2) | Node.js client for OAuth2
| 132 | [benchmark](./b/benchmark) | A benchmarking library that supports high-resoluti
| 132 | [fast-levenshtein](./f/fast-levenshtein) | Efficient implementation of Levenshtein algorithm 
...
| 131 | [gulp-rev-replace](./g/gulp-rev-replace) | Rewrite occurences of filenames which have been re
| 131 | [inquirer-npm-name](./i/inquirer-npm-name) | Helper function using inquirer to validate a value
...
| 130 | [xss](./x/xss) | Sanitize untrusted HTML (to prevent XSS) with a co
| 129 | [apollo-utilities](./a/apollo-utilities) | Utilities for working with GraphQL ASTs
| 129 | [json-pointer](./j/json-pointer) | Some utilities for JSON pointers described by RFC 
...
| 129 | [swagger-tools](./s/swagger-tools) | Various tools for using and integrating with Swagg
...
| 127 | [lazypipe](./l/lazypipe) | Use to create an immutable, lazily initialized pip
...
| 126 | [function-bind](./f/function-bind) | Implementation of Function.prototype.bind
...
| 125 | [jupyterlab__coreutils](./j/jupyterlab__coreutils) | JupyterLab - Core Utilities
| 125 | [marked-terminal](./m/marked-terminal) | A custom render for marked to output to the Termin
...
| 124 | [lodash_dot_flattendeep](./l/lodash_dot_flattendeep) | The lodash method _.flattenDeep exported as a modu
| 124 | [mobile-detect](./m/mobile-detect) | Device detection (phone, tablet, desktop, mobile g
| 124 | [phosphor__algorithm](./p/phosphor__algorithm) | PhosphorJS - Algorithms and Iterators
| 124 | [progress-stream](./p/progress-stream) | Read the progress of a stream
| 124 | [slate-react](./s/slate-react) | A set of React components for building completely 
...
| 123 | [git-url-parse](./g/git-url-parse) | A high level git url parser for common git provide
| 123 | [inflected](./i/inflected) | A port of ActiveSupport's inflector to Node.js
| 123 | [json3](./j/json3) | A modern JSON implementation compatible with nearl
...
| 123 | [suncalc](./s/suncalc) | A tiny JavaScript library for calculating sun/moon
| 122 | [apollo-link-error](./a/apollo-link-error) | Error Apollo Link for GraphQL Network Stack
| 122 | [baconjs](./b/baconjs) | A small functional reactive programming lib for Ja
| 122 | [buble](./b/buble) | The blazing fast, batteries-included ES2015 compil
| 122 | [buffers](./b/buffers) | Treat a collection of Buffers as a single contiguo
...
| 121 | [dargs](./d/dargs) | Reverse minimist. Convert an object of options int
| 121 | [dva](./d/dva) | React and redux based, lightweight and elm-style f
...
| 121 | [sqlite](./s/sqlite) | SQLite client for Node.js applications with SQL-ba
...
| 120 | [dottie](./d/dottie) | Fast and safe nested object access and manipulatio
...
| 120 | [loud-rejection](./l/loud-rejection) | Make unhandled promise rejections fail loudly inst
| 120 | [node-polyglot](./n/node-polyglot) | Give your JavaScript the ability to speak many lan
...
| 119 | [humanize-url](./h/humanize-url) | Humanize a URL: https://sindresorhus.com → sindres
...
| 119 | [mandrill-api](./m/mandrill-api) | The official API client for the Mandrill email as 
| 119 | [slack-node](./s/slack-node) | Slack API library for node
| 119 | [swagger-ui-express](./s/swagger-ui-express) | Swagger UI Express
| 119 | [toastr](./t/toastr) | ToastrJS is a JavaScript library for Gnome / Growl
...
| 118 | [graphql-relay](./g/graphql-relay) | A library to help construct a graphql-js server su
...
| 117 | [pkgcloud](./p/pkgcloud) | An infrastructure-as-a-service agnostic cloud libr
| 117 | [sane](./s/sane) | Sane aims to be fast, small, and reliable file sys
| 117 | [varint](./v/varint) | protobuf-style varint bytes - use msb to create in
...
| 116 | [foundation-sites](./f/foundation-sites) | The most advanced responsive front-end framework i
| 116 | [insight](./i/insight) | Understand how your tool is being used by anonymou
| 116 | [leven](./l/leven) | Measure the difference between two strings using t
| 116 | [line-by-line](./l/line-by-line) | A NodeJS module that helps you reading large text 
| 116 | [n3](./n/n3) | Lightning fast, asynchronous, streaming Turtle / N
| 116 | [node](./n/node) | node
| 116 | [parse-git-config](./p/parse-git-config) | Parse .git/config into a JavaScript object. sync o
...
| 115 | [imap](./i/imap) | An IMAP module for node.js that makes communicatin
| 115 | [parse-filepath](./p/parse-filepath) | Pollyfill for node.js path.parse, parses a filepat
| 115 | [phosphor__disposable](./p/phosphor__disposable) | PhosphorJS - Disposable
| 115 | [pidusage](./p/pidusage) | Cross-platform process cpu % and memory usage of a
...
| 114 | [aurelia-dependency-inject](./a/aurelia-dependency-injection) | A lightweight, extensible dependency injection con
| 114 | [aurelia-pal](./a/aurelia-pal) | Aurelia's platform abstraction layer (PAL).
| 114 | [base-x](./b/base-x) | Fast base encoding / decoding of any given alphabe
| 114 | [couchbase](./c/couchbase) | The official Couchbase Node.js Client Library.
| 114 | [death](./d/death) | Gracefully cleanup when termination signals are se
| 114 | [exceljs](./e/exceljs) | Excel Workbook Manager - Read and Write xlsx and c
| 114 | [is-windows](./i/is-windows) | Returns true if the platform is windows. UMD modul
| 114 | [object_dot_pick](./o/object_dot_pick) | Returns a filtered copy of an object with only the
| 114 | [restify-errors](./r/restify-errors) | Collection of Error objects shared across restify 
...
| 113 | [email-templates](./e/email-templates) | Create, preview, and send custom email templates f
| 113 | [hexo-util](./h/hexo-util) | Utilities for Hexo.
| 113 | [type-detect](./t/type-detect) | Improved typeof detection for node.js and the brow
| 113 | [vinyl-paths](./v/vinyl-paths) | Get the file paths in a vinyl stream
| 112 | [commonmark](./c/commonmark) | a strongly specified, highly compatible variant of
...
| 112 | [rx-lite](./r/rx-lite) | Lightweight library for composing asynchronous and
| 112 | [to-camel-case](./t/to-camel-case) | Convert a string to camel case.
| 111 | [core-object](./c/core-object) | A lightweight implementation of OOP Class in JavaS
| 111 | [cp-file](./c/cp-file) | Copy a file
| 111 | [lodash_dot_range](./l/lodash_dot_range) | The lodash method _.range exported as a module.
| 111 | [pikaday](./p/pikaday) | A refreshing JavaScript Datepicker — lightweight, 
| 110 | [cpx](./c/cpx) | Copy file globs, watching for changes.
| 110 | [dompurify](./d/dompurify) | DOMPurify is a DOM-only, super-fast, uber-tolerant
...
| 108 | [express-rate-limit](./e/express-rate-limit) | Basic IP rate-limiting middleware for Express. Use
| 108 | [is-hotkey](./i/is-hotkey) | Check whether a browser event matches a hotkey.
| 108 | [istextorbinary](./i/istextorbinary) | Determine if a filename and/or buffer is text or b
...
| 108 | [msgpack5](./m/msgpack5) | A msgpack v5 implementation for node.js and the br
| 108 | [signals](./s/signals) | Custom Event/Messaging System
| 107 | [apollo-server](./a/apollo-server) | Production ready GraphQL Server
| 107 | [collections](./c/collections) | data structures with idiomatic JavaScript collecti
...
| 107 | [johnny-five](./j/johnny-five) | The JavaScript Robotics and Hardware Programming F
| 107 | [lodash_dot_findindex](./l/lodash_dot_findindex) | The lodash method _.findIndex exported as a module
| 107 | [pkg-conf](./p/pkg-conf) | Get namespaced config from the closest package.jso
| 107 | [randomcolor](./r/randomcolor) | A tiny script for generating attractive random col
...
| 107 | [universal-analytics](./u/universal-analytics) | A node module for Google's Universal Analytics tra
| 107 | [url-regex](./u/url-regex) | Regular expression for matching URLs
| 106 | [ansicolors](./a/ansicolors) | Functions that surround a string with ansicolor co
| 106 | [apn](./a/apn) | An interface to the Apple Push Notification servic
...
| 105 | [subleveldown](./s/subleveldown) | Split a levelup database into sublevels with their
...
| 103 | [expand-tilde](./e/expand-tilde) | Bash-like tilde expansion for node.js. Expands a l
| 103 | [find-parent-dir](./f/find-parent-dir) | Finds the first parent directory that contains a g
| 103 | [hyperscript](./h/hyperscript) | Create HyperText with JavaScript, on client or ser
| 103 | [node-int64](./n/node-int64) | Support for representing 64-bit integers in JavaSc
...
| 102 | [loopback-boot](./l/loopback-boot) | Convention-based bootstrapper for LoopBack applica
| 102 | [npm-name](./n/npm-name) | Check whether a package name is available on npm
| 102 | [pg-connection-string](./p/pg-connection-string) | Functions for dealing with a PostgresSQL connectio
| 102 | [terminal-image](./t/terminal-image) | Display images in the terminal
| 102 | [varuint-bitcoin](./v/varuint-bitcoin) | encode/decode number as bitcoin variable length in
| 101 | [bezier-easing](./b/bezier-easing) | BezierEasing provides Cubic Bezier Curve easing wh
| 101 | [geoip-lite](./g/geoip-lite) | A light weight native JavaScript implementation of
| 101 | [imagesloaded](./i/imagesloaded) | JavaScript is all like _You images done yet or wha
| 101 | [later](./l/later) | Determine later (or previous) occurrences of recur
| 101 | [lodash_dot_chunk](./l/lodash_dot_chunk) | The lodash method _.chunk exported as a module.
| 101 | [lodash_dot_escaperegexp](./l/lodash_dot_escaperegexp) | The lodash method _.escapeRegExp exported as a mod
| 101 | [module-alias](./m/module-alias) | Create aliases of directories and register custom 
| 101 | [parse-github-url](./p/parse-github-url) | Parse a github URL into an object.
| 101 | [ping](./p/ping) | a simple wrapper for ping
| 101 | [react-beautiful-dnd](./r/react-beautiful-dnd) | Beautiful and accessible drag and drop for lists w
| 101 | [react-native-svg](./r/react-native-svg) | SVG library for react-native
| 101 | [set-value](./s/set-value) | Create nested values and any intermediaries using 
| 101 | [simple-statistics](./s/simple-statistics) | Simple Statistics
| 100 | [lodash_dot_upperfirst](./l/lodash_dot_upperfirst) | The lodash method _.upperFirst exported as a modul
| 100 | [resolve-cwd](./r/resolve-cwd) | Resolve the path of a module like require.resolve(
| 100 | [selenium-standalone](./s/selenium-standalone) | installs a selenium-standalone command line to ins
| 100 | [stacktrace-js](./s/stacktrace-js) | Framework-agnostic, micro-library for getting stac
| 99 | [angular-translate](./a/angular-translate) | A translation module for AngularJS
| 99 | [pubnub](./p/pubnub) | Publish & Subscribe Real-time Messaging with PubNu
...
| 98 | [linkify-it](./l/linkify-it) | Links recognition library with FULL unicode suppor
| 98 | [nearley](./n/nearley) | Simple, fast, powerful parser toolkit for JavaScri
| 98 | [repeating](./r/repeating) | Repeat a string - fast
| 98 | [require-relative](./r/require-relative) | require and resolve modules relative to a path of 
| 98 | [snabbdom](./s/snabbdom) | A virtual DOM library with focus on simplicity, mo
| 98 | [vscode-uri](./v/vscode-uri) | The URI implementation that is used by VS Code and
| 97 | [callsites](./c/callsites) | Get callsites from the V8 stack trace API
| 97 | [ckeditor__ckeditor5-core](./c/ckeditor__ckeditor5-core) | The core architecture of CKEditor 5 – the best bro
...
| 97 | [lodash_dot_intersection](./l/lodash_dot_intersection) | The lodash method _.intersection exported as a mod
...
| 96 | [junk](./j/junk) | Filter out system junk files like .DS_Store and Th
| 96 | [opentype_dot_js](./o/opentype_dot_js) | OpenType font parser
| 96 | [pacote](./p/pacote) | JavaScript package downloader
...
| 96 | [syntax-error](./s/syntax-error) | detect and report syntax errors in source code str
| 96 | [tunnel](./t/tunnel) | Node HTTP/HTTPS Agents for tunneling proxies
| 95 | [bonjour](./b/bonjour) | A Bonjour/Zeroconf implementation in pure JavaScri
| 95 | [circular-dependency-plugi](./c/circular-dependency-plugin) | Detect modules with circular dependencies when bun
| 95 | [env-paths](./e/env-paths) | Get paths for storing things like data, config, ca
| 95 | [images](./i/images) | Cross-platform image decoder(webp/png/jpeg/gif) an
| 95 | [javascript-stringify](./j/javascript-stringify) | Stringify is to eval as JSON.stringify is to JSON.
| 95 | [jupyterlab__services](./j/jupyterlab__services) | Client APIs for the Jupyter services REST APIs
...
| 94 | [detect-browser](./d/detect-browser) | Unpack a browser type and version from the userage
...
| 94 | [gulp-help](./g/gulp-help) | Adds a default help task to gulp and provides the 
| 94 | [hard-source-webpack-plugi](./h/hard-source-webpack-plugin) | Hard cache the source of modules in webpack.
...
| 94 | [nouislider](./n/nouislider) | noUiSlider is a lightweight JavaScript range slide
| 94 | [phosphor__signaling](./p/phosphor__signaling) | PhosphorJS - Signals and Slots
...
| 93 | [cls-hooked](./c/cls-hooked) | CLS using AsynWrap instead of async-listener - Nod
| 93 | [cpy](./c/cpy) | Copy files
| 93 | [d3-force](./d/d3-force) | Force-directed graph layout using velocity Verlet 
| 93 | [di](./d/di) | Dependency Injection for Node.js. Heavily inspired
...
| 93 | [url-template](./u/url-template) | This is a simple URI template implementation follo
| 92 | [asn1](./a/asn1) | Contains parsers and serializers for ASN.1 (curren
...
| 92 | [chai-http](./c/chai-http) | Extend Chai Assertion library with tests for http 
| 92 | [emojione](./e/emojione) | EmojiOne is a complete set of emojis designed for 
| 92 | [imurmurhash](./i/imurmurhash) | An incremental implementation of MurmurHash3
| 92 | [multistream](./m/multistream) | A stream that emits multiple other streams one aft
...
| 92 | [string-similarity](./s/string-similarity) | Finds degree of similarity between strings, based 
...
| 91 | [git-rev](./g/git-rev) | get the current git commit hash, tag or branch in 
...
| 91 | [mmmagic](./m/mmmagic) | An async libmagic binding for node.js for detectin
| 91 | [nightwatch](./n/nightwatch) | Easy to use Node.js based End-to-End testing solut
| 91 | [react-native-animatable](./r/react-native-animatable) | Easy to use declarative transitions and animations
...
| 90 | [axon](./a/axon) | High-level messaging & socket patterns implemented
...
| 90 | [typestyle](./t/typestyle) | TypeSafe CSS
| 89 | [bootstrap-datepicker](./b/bootstrap-datepicker) | A datepicker for Bootstrap
| 89 | [casperjs](./c/casperjs) | A navigation scripting & testing utility for Phant
| 89 | [datatables_dot_net](./d/datatables_dot_net) | DataTables for jQuery
| 89 | [i18next-browser-languaged](./i/i18next-browser-languagedetector) | language detector used in browser environment for 
| 89 | [node-ssdp](./n/node-ssdp) | A node.js SSDP client and server library.
| 89 | [passport-oauth2-client-pa](./p/passport-oauth2-client-password) | OAuth 2.0 client password authentication strategy 
...
| 88 | [jsdom-global](./j/jsdom-global) | Enable DOM in Node.js
| 88 | [jupyterlab__notebook](./j/jupyterlab__notebook) | JupyterLab - Notebook
| 88 | [jwk-to-pem](./j/jwk-to-pem) | Convert a JSON Web Key to a PEM
...
| 87 | [cytoscape](./c/cytoscape) | Graph theory (a.k.a. network) library for analysis
...
| 86 | [cli-truncate](./c/cli-truncate) | Truncate a string to a specific width in the termi
| 86 | [freeport](./f/freeport) | Find a free port.
| 86 | [hdkey](./h/hdkey) | Bitcoin BIP32 hierarchical deterministic keys
| 86 | [jupyterlab__docregistry](./j/jupyterlab__docregistry) | JupyterLab - Document Registry
| 86 | [make-error](./m/make-error) | Make your own error types
| 86 | [mem](./m/mem) | Memoize functions - An optimization used to speed 
...
| 85 | [material-components-web](./m/material-components-web) | Modular and customizable Material Design UI compon
| 85 | [mjml](./m/mjml) | MJML: the only framework that makes responsive-ema
...
| 83 | [ltx](./l/ltx) | -
| 83 | [material__ripple](./m/material__ripple) | The Material Components for the web Ink Ripple eff
| 83 | [memorystream](./m/memorystream) | This is lightweight memory stream module for node.
| 83 | [module-deps](./m/module-deps) | walk the dependency graph to generate json output 
...
| 83 | [redux-devtools-dock-monit](./r/redux-devtools-dock-monitor) | A resizable and movable dock for Redux DevTools mo
| 83 | [symlink-or-copy](./s/symlink-or-copy) | Symlink files or directories, falling back to copy
...
| 82 | [htmlescape](./h/htmlescape) | Properly escape JSON for usage as an object litera
| 82 | [jsdoc-to-markdown](./j/jsdoc-to-markdown) | Generates markdown API documentation from jsdoc an
...
| 81 | [humanize-duration](./h/humanize-duration) | Convert millisecond durations to English and many 
| 81 | [is-empty](./i/is-empty) | Check whether a value is "empty".
| 81 | [is-function](./i/is-function) | is that thing a function? Use this module to find 
...
| 81 | [postcss-modules-scope](./p/postcss-modules-scope) | A CSS Modules transform to extract export statemen
| 81 | [react-clone-referenced-el](./r/react-clone-referenced-element) | Clones a React element while preserving its origin
| 81 | [react-split-pane](./r/react-split-pane) | React split-pane component
| 81 | [redux-mock-store](./r/redux-mock-store) | A mock store for testing your redux async action c
...
| 79 | [emoji-regex](./e/emoji-regex) | A regular expression to match all Emoji-only symbo
| 79 | [exorcist](./e/exorcist) | Externalizes the source map found inside a stream 
...
| 79 | [parse-color](./p/parse-color) | parse a css color string (plus hsv and cmyk) into 
...
| 79 | [react-waypoint](./r/react-waypoint) | A React component to execute a function whenever y
| 79 | [stream-to-string](./s/stream-to-string) | Pipe a stream into a string, collect value with ca
| 78 | [browser-pack](./b/browser-pack) | pack node-style source files from a json stream in
| 78 | [d3-drag](./d/d3-drag) | Drag and drop SVG, HTML or Canvas using mouse or t
| 78 | [draftjs-to-html](./d/draftjs-to-html) | A library for draftjs to html conversion.
| 78 | [express-flash](./e/express-flash) | Flash Messages for your Express Application
| 78 | [graphql-iso-date](./g/graphql-iso-date) | A set of RFC 3339 compliant date/time GraphQL scal
| 78 | [gulp-istanbul](./g/gulp-istanbul) | Istanbul unit test coverage plugin for gulp.
| 78 | [heap](./h/heap) | binary heap (priority queue) algorithms (ported fr
| 78 | [http-proxy-agent](./h/http-proxy-agent) | An HTTP(s) proxy http.Agent implementation for HTT
...
| 78 | [object-merge](./o/object-merge) | Merges JavaScript objects recursively without alte
| 78 | [react-player](./r/react-player) | A React component for playing a variety of URLs, i
| 78 | [react-swipeable](./r/react-swipeable) | Swipe and touch handlers for react
| 78 | [registry-url](./r/registry-url) | Get the set npm registry URL
| 78 | [script-ext-html-webpack-p](./s/script-ext-html-webpack-plugin) | Enhances html-webpack-plugin functionality with as
...
| 78 | [ssf](./s/ssf) | Format data using ECMA-376 spreadsheet Format Code
| 78 | [tcp-port-used](./t/tcp-port-used) | A simple Node.js module to check if a TCP port is 
...
| 77 | [bluebird-retry](./b/bluebird-retry) | utility for retrying a bluebird promise until it s
...
| 77 | [scryptsy](./s/scryptsy) | Pure JavaScript implementation of the scrypt key d
| 77 | [type-check](./t/type-check) | type-check allows you to check the types of JavaSc
...
| 76 | [express-useragent](./e/express-useragent) | ExpressJS/Connect/TrinteJS user-agent middleware e
| 76 | [filenamify](./f/filenamify) | Convert a string to a valid safe filename
| 76 | [into-stream](./i/into-stream) | Convert a string/promise/array/iterable/buffer/typ
| 76 | [jest-haste-map](./j/jest-haste-map) | -
| 76 | [lodash_dot_capitalize](./l/lodash_dot_capitalize) | The lodash method _.capitalize exported as a modul
| 76 | [lodash_dot_last](./l/lodash_dot_last) | The modern build of lodash’s _.last as a module.
| 76 | [openpgp](./o/openpgp) | OpenPGP.js is a Javascript implementation of the O
| 76 | [passport-google-oauth20](./p/passport-google-oauth20) | Google (OAuth 2.0) authentication strategy for Pas
| 76 | [pbkdf2](./p/pbkdf2) | This library provides the functionality of PBKDF2 
| 76 | [postcss-modules-extract-i](./p/postcss-modules-extract-imports) | A CSS Modules transform to extract local aliases f
| 76 | [xdg-basedir](./x/xdg-basedir) | Get XDG Base Directory paths
| 75 | [d3-dispatch](./d/d3-dispatch) | Register named callbacks and call them with argume
...
| 75 | [react-router-bootstrap](./r/react-router-bootstrap) | Integration between React Router and React-Bootstr
| 75 | [supercluster](./s/supercluster) | A very fast geospatial point clustering library.
| 74 | [asciify](./a/asciify) | Plain text awesomizer. A hybrid npm module and CLI
...
| 74 | [html-to-draftjs](./h/html-to-draftjs) | A library for converting plain HTML to DraftJS Edi
| 74 | [lwip](./l/lwip) | Comprehensive, fast, and simple image processing a
| 74 | [parse-torrent](./p/parse-torrent) | Parse a torrent identifier (magnet uri, .torrent f
...
| 73 | [esquery](./e/esquery) | A query library for ECMAScript AST using a CSS sel
| 73 | [git-remote-origin-url](./g/git-remote-origin-url) | Get the remote origin url of a Git repository
| 73 | [keygrip](./k/keygrip) | Key signing and verification for rotated credentia
| 73 | [lodash_dot_orderby](./l/lodash_dot_orderby) | The lodash method _.orderBy exported as a module.
| 73 | [lorem-ipsum](./l/lorem-ipsum) | Generates passages of lorem ipsum text suitable fo
| 73 | [modernizr](./m/modernizr) | Modernizr is a JavaScript library that detects HTM
| 73 | [oboe](./o/oboe) | Oboe.js reads json, giving you the objects as they
| 73 | [random-seed](./r/random-seed) | GRC's UHE PRNG in node (Ultra-High Entropy Pseudo-
...
| 72 | [abab](./a/abab) | WHATWG spec-compliant implementations of window.at
| 72 | [dom-align](./d/dom-align) | Align DOM Node Flexibly
...
| 72 | [resolve-pkg](./r/resolve-pkg) | Resolve the path of a package regardless of it hav
| 72 | [rpio](./r/rpio) | High performance GPIO/i2c/PWM/SPI module for Raspb
...
| 71 | [airbnb-prop-types](./a/airbnb-prop-types) | Custom React PropType validators that we use at Ai
| 71 | [compare-func](./c/compare-func) | Get a compare function for array to sort
| 71 | [css-tree](./c/css-tree) | CSSTree is a tool set to work with CSS, including 
| 71 | [d3-brush](./d/d3-brush) | Select a one- or two-dimensional region using the 
| 71 | [h2o2](./h/h2o2) | Proxy handler plugin for hapi.js
| 71 | [hostile](./h/hostile) | Simple /etc/hosts manipulation
| 71 | [is-fullwidth-code-point](./i/is-fullwidth-code-point) | Check if the character represented by a given Unic
...
| 71 | [pirates](./p/pirates) | Properly hijack require
| 71 | [react-grid-layout](./r/react-grid-layout) | A draggable and resizable grid layout with respons
| 71 | [react-side-effect](./r/react-side-effect) | Create components whose prop changes map to a glob
| 71 | [revalidator](./r/revalidator) | A cross-browser / node.js validator powered by JSO
| 71 | [safe-json-stringify](./s/safe-json-stringify) | Prevent defined property getters from throwing err
| 71 | [serve-handler](./s/serve-handler) | The routing foundation of serve and static deploym
| 71 | [session-file-store](./s/session-file-store) | Session file store is a provision for storing sess
| 71 | [webpack-notifier](./w/webpack-notifier) | webpack + node-notifier = build status system noti
...
| 70 | [dashify](./d/dashify) | Convert a camelcase or space-separated string to a
| 70 | [didyoumean](./d/didyoumean) | Match human-quality input to potential matches by 
...
| 70 | [gitlab](./g/gitlab) | Full NodeJS implementation of the GitLab API. Supp
| 70 | [iltorb](./i/iltorb) | Brotli compression/decompression with native bindi
| 70 | [ip-address](./i/ip-address) | A library for parsing IPv4 and IPv6 IP addresses i
| 70 | [jest-util](./j/jest-util) | -
| 70 | [jsoneditor](./j/jsoneditor) | A web-based tool to view, edit, format, and valida
| 70 | [koa-generic-session](./k/koa-generic-session) | koa generic session store by memory, redis or othe
| 70 | [node-jose](./n/node-jose) | A JavaScript implementation of the JSON Object Sig
| 70 | [object-assign-deep](./o/object-assign-deep) | Allows deep cloning of plain objects that contain 
| 70 | [promise_dot_prototype_dot](./p/promise_dot_prototype_dot_finally) | ES Proposal spec-compliant shim for Promise.protot
| 70 | [prosemirror-model](./p/prosemirror-model) | ProseMirror's document model
| 70 | [react-relay](./r/react-relay) | A framework for building GraphQL-driven React appl
| 70 | [through2-concurrent](./t/through2-concurrent) | Like through2 except runs in parallel with limited
| 70 | [typescript-collections](./t/typescript-collections) | A complete, fully tested data structure library wr
...
| 70 | [zepto](./z/zepto) | Zepto is a minimalist JavaScript library for moder
| 69 | [aurelia-binding](./a/aurelia-binding) | A modern databinding library for JavaScript and HT
| 69 | [colorette](./c/colorette) | Node.js library for colorizing text using ANSI esc
...
| 69 | [tiny-warning](./t/tiny-warning) | A tiny warning function
| 69 | [utility-types](./u/utility-types) | Utility Types Collection for TypeScript
| 68 | [get-folder-size](./g/get-folder-size) | Get the size of a folder by recursively iterating 
...
| 68 | [react-live](./r/react-live) | A production-focused playground for live editing R
| 68 | [string-argv](./s/string-argv) | string-argv parses a string into an argument array
| 68 | [tween_dot_js](./t/tween_dot_js) | Super simple, fast and easy to use tweening engine
| 68 | [youtube-dl](./y/youtube-dl) | youtube-dl driver for node
| 67 | [bip38](./b/bip38) | BIP38 is a standard process to encrypt Bitcoin and
...
| 67 | [md5-hex](./m/md5-hex) | Create a MD5 hash with hex encoding
...
| 67 | [redlock](./r/redlock) | A node.js redlock implementation for distributed r
...
| 67 | [string-replace-webpack-pl](./s/string-replace-webpack-plugin) | Replace string tokens in the contents of a file.
...
| 66 | [analytics-node](./a/analytics-node) | The hassle-free way to integrate analytics into an
| 66 | [arr-diff](./a/arr-diff) | Returns an array with only the unique values from 
| 66 | [aurelia-logging](./a/aurelia-logging) | A minimal but effective logging mechanism with sup
| 66 | [fabric](./f/fabric) | Object model for HTML5 canvas, and SVG-to-canvas p
...
| 66 | [mongoose-unique-validator](./m/mongoose-unique-validator) | mongoose-unique-validator is a plugin which adds p
...
| 65 | [bluebird-lst](./b/bluebird-lst) | Bluebird — longStackTraces: true, cancellation: tr
| 65 | [cwd](./c/cwd) | Easily get the CWD (current working directory) of 
| 65 | [define-properties](./d/define-properties) | Define multiple non-enumerable properties at once.
...
| 65 | [json-query](./j/json-query) | Retrieves values from JSON objects for data bindin
...
| 65 | [react-json-view](./r/react-json-view) | Interactive react component for displaying javascr
| 65 | [read-package-tree](./r/read-package-tree) | Read the contents of node_modules.
| 65 | [scroll](./s/scroll) | animates the scroll top/left position of an elemen
| 65 | [stream-array](./s/stream-array) | Pipe an Array through Node.js streams
| 65 | [yn](./y/yn) | Parse yes/no like values
| 64 | [array-union](./a/array-union) | Create an array of unique values, in order, from t
| 64 | [braces](./b/braces) | Bash-like brace expansion, implemented in JavaScri
...
| 64 | [gulp-copy](./g/gulp-copy) | Plugin copying files to a new destination and usin
| 64 | [hex-rgb](./h/hex-rgb) | Convert HEX color to RGBA
| 64 | [jest-environment-node](./j/jest-environment-node) | -
| 64 | [jupyterlab__mainmenu](./j/jupyterlab__mainmenu) | JupyterLab - Main Menu
...
| 64 | [react-lazyload](./r/react-lazyload) | Lazyload your components, images or anything where
...
| 64 | [socks](./s/socks) | Fully featured SOCKS proxy client supporting SOCKS
| 64 | [tern](./t/tern) | A JavaScript code analyzer for deep, cross-editor 
...
| 63 | [os-name](./o/os-name) | Get the name of the current operating system. Exam
...
| 62 | [iframe-resizer](./i/iframe-resizer) | Keep same and cross domain iFrames sized to their 
| 62 | [inputmask](./i/inputmask) | Inputmask is a javascript library which creates an
| 62 | [koa-multer](./k/koa-multer) | Middleware for handling multipart/form-data for ko
| 62 | [koa-qs](./k/koa-qs) | qs for koa
| 62 | [mermaid](./m/mermaid) | Markdownish syntax for generating flowcharts, sequ
| 62 | [react-addons-perf](./r/react-addons-perf) | This package provides the React Perf add-on.
| 62 | [react-toggle](./r/react-toggle) | An elegant, accessible toggle component for React.
| 62 | [statsd-client](./s/statsd-client) | Yet another client for Etsy's statsd
| 62 | [svg-sprite](./s/svg-sprite) | SVG sprites & stacks galore — A low-level Node.js 
| 62 | [uri-templates](./u/uri-templates) | URI Templates (RFC6570) including de-substitution
| 62 | [y18n](./y/y18n) | the bare-bones internationalization library used b
| 61 | [ant-design__icons](./a/ant-design__icons) | Ant Design Icons
| 61 | [astring](./a/astring) | JavaScript code generator from an ESTree-compliant
...
| 61 | [ckeditor__ckeditor5-engin](./c/ckeditor__ckeditor5-engine) | The editing engine of CKEditor 5 – the best browse
...
| 61 | [github-url-to-object](./g/github-url-to-object) | Extract user, repo, and other interesting properti
| 61 | [glob-base](./g/glob-base) | Returns an object with the (non-glob) base path an
| 61 | [hapi-auth-jwt2](./h/hapi-auth-jwt2) | Hapi.js Authentication Plugin/Scheme using JSON We
| 61 | [hooker](./h/hooker) | Monkey-patch (hook) functions for debugging and st
| 61 | [jju](./j/jju) | a set of utilities to work with JSON / JSON5 docum
...
| 60 | [duplicate-package-checker](./d/duplicate-package-checker-webpack-plugin) | Webpack plugin that warns you when multiple versio
| 60 | [fs-finder](./f/fs-finder) | -
| 60 | [intercept-stdout](./i/intercept-stdout) | Hooking Node.js stdout
| 60 | [ip-regex](./i/ip-regex) | Regular expression for matching IP addresses (IPv4
...
| 60 | [os-utils](./o/os-utils) | an operating-system utility library
| 60 | [parse-domain](./p/parse-domain) | Splits an url into sub-domain, domain and effectiv
...
| 60 | [web3-core](./w/web3-core) | Web3 core tools for sub packages. This is an inter
| 60 | [webpack-chunk-hash](./w/webpack-chunk-hash) | Plugin to replace a standard webpack chunk hashing
| 59 | [adal-angular](./a/adal-angular) | Windows Azure Active Directory Client Library for 
| 59 | [antv__g2](./a/antv__g2) | the Grammar of Graphics in Javascript
...
| 59 | [google__maps](./g/google__maps) | Node.js client library for Google Maps API Web Ser
| 59 | [is-ip](./i/is-ip) | Check if a string is an IP address
| 59 | [matcher](./m/matcher) | Simple wildcard matching
| 59 | [material__animation](./m/material__animation) | Animation Variables and Mixins used by Material Co
| 59 | [minimalistic-assert](./m/minimalistic-assert) | minimalistic-assert ===
...
| 59 | [re-resizable](./r/re-resizable) | Resizable component for React.
...
| 59 | [rmc-date-picker](./r/rmc-date-picker) | React Mobile DatePicker Component for web and reac
| 59 | [victory](./v/victory) | Data viz for React
| 59 | [vis](./v/vis) | A dynamic, browser-based visualization library.
| 59 | [void-elements](./v/void-elements) | Array of "void elements" defined by the HTML speci
...
| 58 | [intersperse](./i/intersperse) | Add an object to an array between each element
...
| 57 | [favicons-webpack-plugin](./f/favicons-webpack-plugin) | Let webpack generate all your favicons and icons f
| 57 | [getos](./g/getos) | Get the OS/Distribution name of the environment yo
| 57 | [git-user-name](./g/git-user-name) | Get a user's name from git config at the project o
| 57 | [gulp-strip-debug](./g/gulp-strip-debug) | Strip console and debugger statements from JavaScr
| 57 | [is-absolute](./i/is-absolute) | Returns true if a file path is absolute. Does not 
...
| 57 | [material-ui__lab](./m/material-ui__lab) | Material-UI Lab - Incubator for Material-UI React 
...
| 56 | [match-sorter](./m/match-sorter) | Simple, expected, and deterministic best-match sor
...
| 56 | [object-inspect](./o/object-inspect) | string representations of objects in node and the 
| 56 | [p-reduce](./p/p-reduce) | Reduce a list of values using promises into a prom
| 56 | [pngquant-bin](./p/pngquant-bin) | pngquant wrapper that makes it seamlessly availabl
| 56 | [pouchdb-core](./p/pouchdb-core) | The core of PouchDB as a standalone package.
| 56 | [rc-swipeout](./r/rc-swipeout) | swipe out ui component for react(web and react-nat
...
| 56 | [xstate](./x/xstate) | Finite State Machines and Statecharts for the Mode
...
| 55 | [locate-path](./l/locate-path) | Get the first path that exists on disk of multiple
| 55 | [locutus](./l/locutus) | Locutus other languages' stadard libraries to Java
| 55 | [lodash_dot_identity](./l/lodash_dot_identity) | The modern build of lodash’s _.identity as a modul
...
| 55 | [react-images](./r/react-images) | A simple, responsive lightbox component for displa
| 55 | [react-native-collapsible](./r/react-native-collapsible) | Animated collapsible component for React Native us
...
| 55 | [scrypt-js](./s/scrypt-js) | The scrypt password-based key derivation function 
| 55 | [shebang-regex](./s/shebang-regex) | Regular expression for matching a shebang line
| 55 | [terminal-menu](./t/terminal-menu) | retro ansi terminal menus for serious 80s technico
| 55 | [throttleit](./t/throttleit) | Throttle a function
| 55 | [toobusy-js](./t/toobusy-js) | Don't fall over when your Node.JS server is too bu
...
| 54 | [google-closure-compiler](./g/google-closure-compiler) | Check, compile, optimize and compress Javascript w
...
| 54 | [intl-format-cache](./i/intl-format-cache) | A memoizer factory for Intl format constructors.
...
| 54 | [react-frame-component](./r/react-frame-component) | React component to wrap your application or compon
...
| 54 | [xhr2-cookies](./x/xhr2-cookies) | XMLHttpRequest polyfill for node.js
| 54 | [xxhashjs](./x/xxhashjs) | xxHash in Javascript
| 53 | [assertion-error](./a/assertion-error) | Error constructor for test and validation framewor
| 53 | [buffer-xor](./b/buffer-xor) | A simple module for bitwise-xor on buffers
| 53 | [cbor](./c/cbor) | Encode and parse data in the Concise Binary Object
...
| 53 | [gray-percentage](./g/gray-percentage) | Convenience function to get a gray value by percen
...
| 53 | [point-in-polygon](./p/point-in-polygon) | determine if a point is inside a polygon with a ra
| 53 | [react-hammerjs](./r/react-hammerjs) | ReactJS / HammerJS integration. Support touch even
| 53 | [react-visibility-sensor](./r/react-visibility-sensor) | Sensor component for React that notifies you when 
...
| 53 | [stdin](./s/stdin) | Because stdin with node is annoying
| 53 | [stompjs](./s/stompjs) | STOMP for JavaScript apps (Web browser & node.js)
| 53 | [uikit](./u/uikit) | UIkit is a lightweight and modular front-end frame
| 53 | [uuid-js](./u/uuid-js) | A js library to generate and parse UUIDs,TimeUUIDs
| 52 | [acl](./a/acl) | An Access Control List module, based on Redis with
| 52 | [babylon-walk](./b/babylon-walk) | Lightweight Babylon AST traversal
| 52 | [country-data](./c/country-data) | Data about countries - like their ISO codes and cu
| 52 | [dom-to-image](./d/dom-to-image) | Generates an image from a DOM node using HTML5 can
...
| 52 | [morphdom](./m/morphdom) | Morph a DOM tree to another DOM tree (no virtual D
| 52 | [node-geocoder](./n/node-geocoder) | Node Geocoder, node geocoding library, supports go
| 52 | [node-slack](./n/node-slack) | Send and receive Slack Webhooks easily
| 52 | [oauth2-server](./o/oauth2-server) | Complete, framework-agnostic, compliant and well t
| 52 | [p-event](./p/p-event) | Promisify an event by waiting for it to be emitted
| 52 | [react-collapse](./r/react-collapse) | Component-wrapper for collapse animation with reac
| 52 | [react-sticky](./r/react-sticky) | Sticky component for React
| 52 | [scroll-into-view-if-neede](./s/scroll-into-view-if-needed) | Ponyfill for upcoming Element.scrollIntoView() API
| 52 | [season](./s/season) | CSON utilities
| 52 | [shuffle-array](./s/shuffle-array) | Randomize the order of the elements in a given arr
| 52 | [stellar-sdk](./s/stellar-sdk) | stellar-sdk is a library for working with the Stel
| 52 | [strong-error-handler](./s/strong-error-handler) | Error handler for use in development and productio
...
| 52 | [webidl-conversions](./w/webidl-conversions) | Implements the WebIDL algorithms for converting to
| 52 | [xdate](./x/xdate) | A Modern JavaScript Date Library
| 51 | [ansi-escape-sequences](./a/ansi-escape-sequences) | A simple library containing all known terminal ans
| 51 | [ant-design__icons-react](./a/ant-design__icons-react) |  Ant Design Icons for React 
| 51 | [anyproxy](./a/anyproxy) | A fully configurable HTTP/HTTPS proxy in Node.js
| 51 | [arr-union](./a/arr-union) | Combines a list of arrays, returning a single arra
...
| 51 | [electron-store](./e/electron-store) | Simple data persistence for your Electron app or m
| 51 | [gulp-task-listing](./g/gulp-task-listing) | Adds the ability to provide a task listing for you
...
| 51 | [sticky-session](./s/sticky-session) | Sticky session balancer based on a cluster module
...
| 50 | [fetch-mock](./f/fetch-mock) | Mock http requests made using fetch (or isomorphic
...
| 50 | [i18next-node-fs-backend](./i/i18next-node-fs-backend) | node.js backend layer for i18next using fs module 
| 50 | [is-in-browser](./i/is-in-browser) | Simple check to see if current app is running in b
| 50 | [ismobilejs](./i/ismobilejs) | A simple JS library that detects mobile devices.
| 50 | [jest-matcher-utils](./j/jest-matcher-utils) | A set of utility functions for expect and related 
| 50 | [jupyterlab__filebrowser](./j/jupyterlab__filebrowser) | JupyterLab - FileBrowser Widget
...
| 50 | [markdown-to-jsx](./m/markdown-to-jsx) | Convert markdown to JSX with ease for React and Re
| 50 | [node-red](./n/node-red) | A visual tool for wiring the Internet of Things
| 50 | [raf-schd](./r/raf-schd) | A scheduler based on requestAnimationFrame
...
| 49 | [graphql-config](./g/graphql-config) | The easiest way to configure your development envi
...
| 49 | [handsontable](./h/handsontable) | Handsontable is a JavaScript Spreadsheet Component
| 49 | [jsonata](./j/jsonata) | JSON query and transformation language
| 49 | [jsontoxml](./j/jsontoxml) | This is a library designed to render js objects as
| 49 | [jupyterlab__docmanager](./j/jupyterlab__docmanager) | JupyterLab - Document Manager
...
| 49 | [object-path-immutable](./o/object-path-immutable) | Modify deep object properties without modifying th
| 49 | [random-int](./r/random-int) | Generate a random integer
| 49 | [react-faux-dom](./r/react-faux-dom) | DOM like data structure to be mutated by D3 et al,
| 49 | [react-tagsinput](./r/react-tagsinput) | Highly customizable React component for inputing t
| 49 | [safe-regex](./s/safe-regex) | detect possibly catastrophic, exponential-time reg
| 49 | [sindresorhus__slugify](./s/sindresorhus__slugify) | Slugify a string
| 49 | [snappy](./s/snappy) | Nodejs bindings to Google's Snappy compression lib
| 49 | [sntp](./s/sntp) | SNTP Client
| 49 | [stat-mode](./s/stat-mode) | Offers convenient getters and setters for the stat
| 49 | [window-or-global](./w/window-or-global) | Use either the window object in the browser or the
...
| 48 | [musicmetadata](./m/musicmetadata) | Streaming music metadata parser for node and the b
| 48 | [nodemailer-stub-transport](./n/nodemailer-stub-transport) | Stub transport for Nodemailer
| 48 | [passport-local-mongoose](./p/passport-local-mongoose) | Mongoose plugin that simplifies building username 
| 48 | [react-scrollbar](./r/react-scrollbar) | ScrollArea component for react
| 48 | [relay-runtime](./r/relay-runtime) | A core runtime for building GraphQL-driven applica
| 48 | [repeat-element](./r/repeat-element) | Create an array by repeating the given value n tim
| 48 | [simplecrawler](./s/simplecrawler) | Very straightforward, event driven web crawler. Fe
| 48 | [stack-utils](./s/stack-utils) | Captures and cleans stack traces
| 48 | [term-size](./t/term-size) | Reliably get the terminal window size (columns & r
| 48 | [webpack-hot-client](./w/webpack-hot-client) | A client for enabling, and interacting with, webpa
| 47 | [aframe](./a/aframe) | A web framework for building virtual reality exper
| 47 | [constantinople](./c/constantinople) | Determine whether a JavaScript expression evaluate
| 47 | [electron-window-state](./e/electron-window-state) | Simple module that helps to save and restore size 
| 47 | [frctl__fractal](./f/frctl__fractal) | A tool to help you build and document web componen
| 47 | [git-config-path](./g/git-config-path) | Resolve the path to the user's local or global .gi
...
| 47 | [popmotion](./p/popmotion) | A functional, reactive motion library.
| 47 | [react-media](./r/react-media) | CSS media queries for React
| 47 | [react-native-communicatio](./r/react-native-communications) | Open a web address or call, email, text or iMessag
| 47 | [redux-immutable-state-inv](./r/redux-immutable-state-invariant) | Redux middleware that detects mutations between an
...
| 47 | [sdp-transform](./s/sdp-transform) | A simple parser/writer for the Session Description
| 47 | [superstruct](./s/superstruct) | A simple, expressive way to validate data in JavaS
...
| 46 | [jest-snapshot](./j/jest-snapshot) | -
...
| 45 | [is-callable](./i/is-callable) | Is this JS value callable? Works with Functions an
...
| 45 | [react-s-alert](./r/react-s-alert) | Alerts / Notifications for React with rich configu
| 45 | [react-toolbox](./r/react-toolbox) | A set of React components implementing Google's Ma
| 45 | [reconnect-core](./r/reconnect-core) | Generic stream reconnection module.
| 45 | [rollup-plugin-sourcemaps](./r/rollup-plugin-sourcemaps) | Rollup plugin for grabbing source maps from source
| 45 | [scoped-http-client](./s/scoped-http-client) | http client request wrapper
| 45 | [sha](./s/sha) | Check and get file hashes
| 45 | [shallow-equals](./s/shallow-equals) | Determine if an array or object is equivalent with
...
| 44 | [autolinker](./a/autolinker) | Utility to automatically link the URLs, email addr
| 44 | [beeper](./b/beeper) | Make your terminal beep
| 44 | [blob-to-buffer](./b/blob-to-buffer) | Convert a Blob to a Buffer
| 44 | [bootstrap-select](./b/bootstrap-select) | The jQuery plugin that brings select elements into
| 44 | [css-modules-loader-core](./c/css-modules-loader-core) | A loader-agnostic CSS Modules implementation, base
...
| 44 | [i18next-express-middlewar](./i/i18next-express-middleware) | express middleware for i18next
...
| 44 | [puppeteer-core](./p/puppeteer-core) | A high-level API to control headless Chrome over t
| 44 | [qiniu-js](./q/qiniu-js) | Javascript SDK for Qiniu Resource (Cloud) Storage 
...
| 43 | [caniuse-api](./c/caniuse-api) | request the caniuse data to check browsers compati
| 43 | [cryptr](./c/cryptr) | a simple encrypt and decrypt module for node.js
| 43 | [cssesc](./c/cssesc) | A JavaScript library for escaping CSS strings and 
| 43 | [dat_dot_gui](./d/dat_dot_gui) | A lightweight graphical user interface for changin
| 43 | [drivelist](./d/drivelist) | List all connected drives in your computer, in all
| 43 | [eases](./e/eases) | grab bag of easing equations
| 43 | [express-partials](./e/express-partials) | Express 3.x Layout & Partial support.
| 43 | [fixed-data-table](./f/fixed-data-table) | A React table component designed to allow presenti
| 43 | [jest-message-util](./j/jest-message-util) | -
...
| 43 | [p-locate](./p/p-locate) | Get the first fulfilled promise that satisfies the
| 43 | [pause](./p/pause) | Pause a stream's data events
| 43 | [react-blessed](./r/react-blessed) | A react renderer for blessed.
| 43 | [react-highlight-words](./r/react-highlight-words) | React component to highlight words within a larger
| 43 | [react-native-safe-area-vi](./r/react-native-safe-area-view) | JS only version of SafeAreaView for supporting iPh
...
| 42 | [autosuggest-highlight](./a/autosuggest-highlight) | Utilities for highlighting text in autosuggest and
...
| 42 | [electron-devtools-install](./e/electron-devtools-installer) | An easy way to install Dev Tools extensions into E
...
| 42 | [material__switch](./m/material__switch) | The Material Components for the web switch compone
...
| 42 | [omelette](./o/omelette) | Omelette.js Simple Autocompletion Helper for Node
...
| 42 | [styled-system__theme-get](./s/styled-system__theme-get) | The themeGet function is an existential getter fun
...
| 41 | [async-cache](./a/async-cache) | Cache your async lookups and don't fetch the same 
...
| 41 | [ledgerhq__hw-transport](./l/ledgerhq__hw-transport) | Ledger Hardware Wallet common interface of the com
...
| 41 | [rrule](./r/rrule) | JavaScript library for working with recurrence rul
...
| 41 | [sylvester](./s/sylvester) | node.js implementation of James Coglan's "Sylveste
| 41 | [twemoji](./t/twemoji) | A Unicode 11.0 standard based way to implement emo
| 41 | [upper-case](./u/upper-case) | Upper case a string
| 41 | [web3-eth](./w/web3-eth) | Web3 module to interact with the Ethereum blockcha
...
| 40 | [react-native-video](./r/react-native-video) | A  element for react-native
| 40 | [react-svg-inline](./r/react-svg-inline) | A React component to inline your SVGs.
| 40 | [rtlcss](./r/rtlcss) | Framework for transforming cascading style sheets 
...
| 39 | [fs-tree-diff](./f/fs-tree-diff) | Backs out file tree changes
| 39 | [getpass](./g/getpass) | getpass for node.js
| 39 | [hapi-auth-basic](./h/hapi-auth-basic) | Basic authentication plugin
| 39 | [hpp](./h/hpp) | Express middleware to protect against HTTP Paramet
| 39 | [insert-module-globals](./i/insert-module-globals) | insert implicit module globals into a module-deps 
...
| 39 | [jquery_dot_cookie](./j/jquery_dot_cookie) | A simple, lightweight jQuery plugin for reading, w
| 39 | [js-sha512](./j/js-sha512) | This is a simple SHA-512, SHA-384, SHA-512/224, SH
...
| 39 | [material__form-field](./m/material__form-field) | Material Components for the web wrapper for laying
| 39 | [mpromise](./m/mpromise) | Promises A+ conformant implementation
| 39 | [notp](./n/notp) | Node One Time Password library, supports HOTP, TOT
| 39 | [pouchdb-adapter-http](./p/pouchdb-adapter-http) | PouchDB adapter using HTTP (e.g. a remote CouchDB)
...
| 39 | [react-cookies](./r/react-cookies) | Load and save cookies with React
...
| 39 | [skatejs](./s/skatejs) | Skate is a library built on top of the W3C web com
| 39 | [ts-custom-error](./t/ts-custom-error) | Extend native Error to create custom errors
...
| 38 | [accept-language-parser](./a/accept-language-parser) | Parse the accept-language header from a HTTP reque
...
| 38 | [blob-util](./b/blob-util) | Utilities for working with Blob objects in the bro
| 38 | [chai-subset](./c/chai-subset) | Object properties matcher for Chai
| 38 | [constant-case](./c/constant-case) | Constant case a string
| 38 | [express-brute](./e/express-brute) | A brute-force protection middleware for express ro
| 38 | [firmata](./f/firmata) | Firmata protocol implementation for programmatic i
| 38 | [flush-write-stream](./f/flush-write-stream) | A write stream constructor that supports a flush f
| 38 | [gulp-protractor](./g/gulp-protractor) | A helper for protactor and gulp
| 38 | [icss-utils](./i/icss-utils) | ICSS utils for postcss ast
| 38 | [inline-css](./i/inline-css) | Inline css into an html file.
| 38 | [inversify-binding-decorat](./i/inversify-binding-decorators) | An utility that allows developers to declare Inver
...
| 38 | [material__icon-button](./m/material__icon-button) | The Material Components for the web icon button co
| 38 | [one-time](./o/one-time) | Run the supplied function exactly one time (once)
| 38 | [owl_dot_carousel](./o/owl_dot_carousel) | Touch enabled jQuery plugin that lets you create b
| 38 | [path-key](./p/path-key) | Get the PATH environment variable key cross-platfo
| 38 | [quick-lru](./q/quick-lru) | Simple "Least Recently Used" (LRU) cache
| 38 | [react-content-loader](./r/react-content-loader) | SVG component to create placeholder loading, like 
| 38 | [react-flip-move](./r/react-flip-move) | Effortless animation between DOM changes (eg. list
...
| 38 | [sql_dot_js](./s/sql_dot_js) | SQLite library with support for opening and writin
| 38 | [typography-breakpoint-con](./t/typography-breakpoint-constants) | Provide helpful constants for setting responsive b
| 38 | [web3-core-method](./w/web3-core-method) | Creates the methods on the web3 modules. This is a
...
| 37 | [pg-escape](./p/pg-escape) | escape postgres queries which do not support store
| 37 | [postmark](./p/postmark) | Official Node.js client library for the Postmark H
| 37 | [prosemirror-keymap](./p/prosemirror-keymap) | Keymap plugin for ProseMirror
| 37 | [react-broadcast](./r/react-broadcast) | Reliably communicate state changes to deeply neste
| 37 | [react-maskedinput](./r/react-maskedinput) | Masked  React component
| 37 | [react-sortable-tree](./r/react-sortable-tree) | Drag-and-drop sortable component for nested data a
| 37 | [react-widgets](./r/react-widgets) | An à la carte set of polished, extensible, and acc
...
| 36 | [hexo](./h/hexo) | A fast, simple & powerful blog framework, powered 
...
| 36 | [jest-environment-jsdom](./j/jest-environment-jsdom) | -
| 36 | [jest-validate](./j/jest-validate) | Generic configuration validation tool that helps y
| 36 | [jpegtran-bin](./j/jpegtran-bin) | jpegtran (part of libjpeg-turbo) bin-wrapper that 
...
| 36 | [multi-progress](./m/multi-progress) | Multiple progress bars based on the "progress" pac
...
| 36 | [pg-format](./p/pg-format) | Node.js implementation of PostgreSQL's format() to
| 36 | [phoenix](./p/phoenix) | The official JavaScript client for the Phoenix web
| 36 | [phosphor__domutils](./p/phosphor__domutils) | PhosphorJS - DOM Utilities
| 36 | [pouchdb-adapter-memory](./p/pouchdb-adapter-memory) | PouchDB adapter using in-memory as its data store.
| 36 | [promise-sequential](./p/promise-sequential) | Simple like Promise.all(), but sequentially
| 36 | [react-slider](./r/react-slider) | Slider component for React
| 36 | [simpl-schema](./s/simpl-schema) | A schema validation package that supports direct v
| 36 | [standard-error](./s/standard-error) | Tiny library that simplifies subclassing and inher
...
| 35 | [d3-sankey](./d/d3-sankey) | Visualize flow between nodes in a directed acyclic
| 35 | [d3-selection-multi](./d/d3-selection-multi) | Multi-value map syntax for D3 selections.
| 35 | [date-and-time](./d/date-and-time) | A Minimalist DateTime utility for Node.js and the 
...
| 35 | [jspath](./j/jspath) | DSL that enables you to navigate and find data wit
...
| 35 | [natural-compare](./n/natural-compare) | Compare strings containing a mix of letters and nu
...
| 35 | [remote-origin-url](./r/remote-origin-url) | Get the git remote origin URL from your local git 
...
| 35 | [webpack-assets-manifest](./w/webpack-assets-manifest) | This Webpack plugin will generate a JSON file that
| 34 | [angular-local-storage](./a/angular-local-storage) | An Angular module that gives you access to the bro
...
| 34 | [js-search](./j/js-search) | JS Search is an efficient, client-side search libr
...
| 34 | [lodash_dot_isarguments](./l/lodash_dot_isarguments) | The lodash method _.isArguments exported as a modu
...
| 34 | [omggif](./o/omggif) | omggif is a JavaScript implementation of a GIF 89a
| 34 | [passport-facebook-token](./p/passport-facebook-token) | Facebook token authentication strategy for Passpor
...
| 34 | [react-scrollbar-size](./r/react-scrollbar-size) | React component to calculate the size of browser s
| 34 | [round-to](./r/round-to) | Round a number to a specific number of decimal pla
| 34 | [rsmq](./r/rsmq) | A really simple message queue based on Redis
| 34 | [safer-buffer](./s/safer-buffer) | Modern Buffer API polyfill without footguns
| 34 | [scheduler](./s/scheduler) | Cooperative scheduler for the browser environment.
| 34 | [seed-random](./s/seed-random) | Generate random numbers with a seed, useful for re
| 34 | [sheetify](./s/sheetify) | Modular CSS bundler
| 34 | [sloc](./s/sloc) | sloc is a simple tool to count SLOC (source lines 
| 34 | [strip-color](./s/strip-color) | Strip ANSI color codes from a string. No dependenc
...
| 34 | [uslug](./u/uslug) | A permissive slug generator that works with unicod
| 34 | [x2js](./x/x2js) | Transforms between XML string and JavaScript objec
| 33 | [chmodr](./c/chmodr) | like chmod -R
| 33 | [deglob](./d/deglob) | Take a list of glob patterns and return an array o
| 33 | [emittery](./e/emittery) | Simple and modern async event emitter
| 33 | [feathersjs__authenticatio](./f/feathersjs__authentication) | Add Authentication to your FeathersJS app.
...
| 33 | [format-number](./f/format-number) | Formats numbers with separators every 3 digits and
| 33 | [gaussian](./g/gaussian) | A JavaScript model of a Gaussian distribution
| 33 | [geojson](./g/geojson) | Turn your geo data into GeoJSON
| 33 | [humanize-plus](./h/humanize-plus) | A simple utility library for making the web more h
| 33 | [istanbul-reports](./i/istanbul-reports) | istanbul reports
| 33 | [jest-runtime](./j/jest-runtime) | -
...
| 33 | [solr-client](./s/solr-client) | A Solr client library for indexing, adding, deleti
...
| 32 | [append-query](./a/append-query) | Append querystring params to a URL.
...
| 32 | [async-eventemitter](./a/async-eventemitter) | Just like EventEmitter, but with support for callb
...
| 32 | [react-avatar-editor](./r/react-avatar-editor) | Avatar / profile picture component. Resize and cro
| 32 | [react-dnd-touch-backend](./r/react-dnd-touch-backend) | Touch backend for react-dnd
| 32 | [rechoir](./r/rechoir) | Prepare a node environment to require files with d
...
| 32 | [rollup-plugin-size-snapsh](./r/rollup-plugin-size-snapshot) | -
...
| 31 | [esri-leaflet](./e/esri-leaflet) | Leaflet plugins for consuming ArcGIS Online and Ar
...
| 31 | [interface-datastore](./i/interface-datastore) | datastore interface
...
| 31 | [npm-registry-fetch](./n/npm-registry-fetch) | Fetch-based http client for use with npm registry 
...
| 31 | [web3-eth-contract](./w/web3-eth-contract) | Web3 module to interact with Ethereum smart contra
| 31 | [wepy](./w/wepy) | -
...
| 30 | [colorbrewer](./c/colorbrewer) | A shim module of colorbrewer2 by Cythina Brewer fo
| 30 | [dependency-tree](./d/dependency-tree) | Get the dependency tree of a module
| 30 | [electron-settings](./e/electron-settings) | A simple persistent user settings framework for El
| 30 | [emissary](./e/emissary) | Utility mixins for subscribing to and emitting eve
...
| 30 | [is-generator-fn](./i/is-generator-fn) | Check if something is a generator function
| 30 | [jira-client](./j/jira-client) | Wrapper for the JIRA API
| 30 | [kdbush](./k/kdbush) | A very fast static 2D index for points based on kd
| 30 | [linkifyjs](./l/linkifyjs) | Intelligent link recognition, made easy
| 30 | [lodash_dot_clonedeepwith](./l/lodash_dot_clonedeepwith) | The lodash method _.cloneDeepWith exported as a mo
...
| 30 | [material__tab-bar](./m/material__tab-bar) | The Material Components for the web tab bar compon
...
| 30 | [pretty-time](./p/pretty-time) | Easily format the time from node.js process.hrtime
| 30 | [ps-list](./p/ps-list) | Get running processes
| 30 | [random-number](./r/random-number) | Generate pseudo-randum numbers
| 30 | [react-date-range](./r/react-date-range) | A React component for choosing dates and date rang
| 30 | [react-loader](./r/react-loader) | React component that displays a spinner via spin.j
| 30 | [react-numeric-input](./r/react-numeric-input) | Number input component that can replace the native
| 30 | [react-outside-click-handl](./r/react-outside-click-handler) | A React component for dealing with clicks outside 
| 30 | [react-toastr](./r/react-toastr) | React.js toastr component
| 30 | [realm](./r/realm) | Realm is a mobile database: an alternative to SQLi
| 30 | [redux-batched-actions](./r/redux-batched-actions) | redux higher order reducer + action creator to red
| 30 | [sparkpost](./s/sparkpost) | A Node.js wrapper for interfacing with your favori
| 30 | [split_dot_js](./s/split_dot_js) | 2kb unopinionated utility for resizeable split vie
| 30 | [sudo-block](./s/sudo-block) | Block users from running your app with root permis
| 30 | [timeago](./t/timeago) | jQuery plugin that makes it easy to support automa
| 30 | [tmi_dot_js](./t/tmi_dot_js) | Javascript library for the Twitch Messaging Interf
| 30 | [undertaker](./u/undertaker) | Task registry that allows composition through seri
...
| 30 | [zipkin-context-cls](./z/zipkin-context-cls) | A Context API implementation that uses continuatio
| 29 | [ace](./a/ace) | ace
...
| 29 | [crossfilter](./c/crossfilter) | Fast multidimensional filtering for coordinated vi
| 29 | [deps-sort](./d/deps-sort) | sort module-deps output for deterministic browseri
| 29 | [dnd-core](./d/dnd-core) | Drag and drop sans the GUI
| 29 | [edge-js](./e/edge-js) | Edge.js: run .NET and Node.js in-process on Window
...
| 29 | [mariasql](./m/mariasql) | A node.js binding to MariaDB's non-blocking (MySQL
| 29 | [material__linear-progress](./m/material__linear-progress) | The Material Components for the web linear progres
...
| 29 | [node-gettext](./n/node-gettext) | A JavaScript implementation of gettext, a localiza
...
| 29 | [plupload](./p/plupload) | Plupload is a JavaScript API for dealing with file
...
| 29 | [react-burger-menu](./r/react-burger-menu) | An off-canvas sidebar component with a collection 
...
| 28 | [icheck](./i/icheck) | Highly customizable checkboxes and radio buttons (
...
| 28 | [jupyterlab__codemirror](./j/jupyterlab__codemirror) | JupyterLab - CodeMirror Editor Provider
| 28 | [kuromoji](./k/kuromoji) | JavaScript implementation of Japanese morphologica
| 28 | [level-ttl](./l/level-ttl) | Adds a 'ttl' option to LevelUP for puts and batche
| 28 | [locks](./l/locks) | Mutex locks, Read/Write locks, Condition variables
| 28 | [lodash_dot_indexof](./l/lodash_dot_indexof) | The lodash method _.indexOf exported as a module.
| 28 | [logform](./l/logform) | An mutable object-based log format designed for ch
| 28 | [mixpanel-browser](./m/mixpanel-browser) | The official Mixpanel JavaScript browser client li
| 28 | [node-zopfli](./n/node-zopfli) | Bindings for Zopfli compressing lib. Compress gzip
| 28 | [otplib](./o/otplib) | HMAC-based (HOTP) and Time-based (TOTP) One-Time P
...
| 27 | [chunk](./c/chunk) | Chunk converts arrays like 
...
| 27 | [hapi-auth-bearer-token](./h/hapi-auth-bearer-token) | Simple Bearer authentication scheme plugin for hap
| 27 | [hapi__boom](./h/hapi__boom) | HTTP-friendly error objects
| 27 | [jstimezonedetect](./j/jstimezonedetect) | This script gives you the zone info key representi
...
| 27 | [menubar](./m/menubar) | high level way to create menubar desktop applicati
| 27 | [millisecond](./m/millisecond) | Convert time strings to milliseconds
| 27 | [mozjpeg](./m/mozjpeg) | mozjpeg wrapper that makes it seamlessly available
| 27 | [no-case](./n/no-case) | Remove case from a string
| 27 | [orientjs](./o/orientjs) | Official node.js driver for OrientDB. Fast, lightw
| 27 | [p-filter](./p/p-filter) | Filter promises concurrently
| 27 | [phin](./p/phin) | The ultra-lightweight Node.js HTTP client
| 27 | [pigpio](./p/pigpio) | Fast GPIO, PWM, servo control, state change notifi
...
| 27 | [react-collapsible](./r/react-collapsible) | React component to wrap content in Collapsible ele
| 27 | [react-native-flip-card](./r/react-native-flip-card) | The card component which has a motion of flip for 
| 27 | [react-window](./r/react-window) | React components for efficiently rendering large, 
...
| 27 | [sql-formatter](./s/sql-formatter) | Formats whitespaces in a SQL query to make it more
...
| 26 | [condense-whitespace](./c/condense-whitespace) | Remove leading, trailing, and repeated whitespace 
| 26 | [connect-mongodb-session](./c/connect-mongodb-session) | MongoDB session store for connect/express built by
...
| 26 | [i18next-sprintf-postproce](./i/i18next-sprintf-postprocessor) | backend layer for i18next using browsers xhr
| 26 | [intro_dot_js](./i/intro_dot_js) | Better introductions for websites and features wit
| 26 | [inversify-inject-decorato](./i/inversify-inject-decorators) | Lazy evaluated property injection decorators for I
| 26 | [is-mobile](./i/is-mobile) | Check if mobile browser.
| 26 | [is-path-in-cwd](./i/is-path-in-cwd) | Check if a path is in the current working director
| 26 | [jest-regex-util](./j/jest-regex-util) | -
...
| 26 | [ledgerhq__hw-transport-no](./l/ledgerhq__hw-transport-node-hid) | Ledger Hardware Wallet Node implementation of the 
...
| 26 | [react-loader-spinner](./r/react-loader-spinner) | react-spinner-loader provides simple React.js spin
...
| 26 | [realpath-native](./r/realpath-native) | Use the system's native realpath
...
| 26 | [socketcluster](./s/socketcluster) | SocketCluster - A Highly parallelized WebSocket se
| 26 | [steam-totp](./s/steam-totp) | Generate Steam-style TOTP codes given a secret
| 26 | [waypoints](./w/waypoints) | Easily execute a function when you scroll to an el
| 26 | [whatwg-mimetype](./w/whatwg-mimetype) | Parses, serializes, and manipulates MIME types, ac
| 25 | [abort-controller](./a/abort-controller) | An implementation of WHATWG AbortController interf
| 25 | [amp-message](./a/amp-message) | Higher level Message object for the AMP protocol
| 25 | [array_dot_from](./a/array_dot_from) | A robust & optimized Array.from polyfill, based on
| 25 | [backbone_dot_radio](./b/backbone_dot_radio) | Messaging patterns for Backbone applications.
| 25 | [carlo](./c/carlo) | Carlo is a framework for rendering Node data struc
| 25 | [chalk-pipe](./c/chalk-pipe) | Apply a color scheme in a style pipe
| 25 | [cryptojs](./c/cryptojs) | Following googlecode project crypto-js, provide st
...
| 25 | [hark](./h/hark) | Converts an audio stream to speech events in the b
| 25 | [instagram-private-api](./i/instagram-private-api) | Instagram private API wrapper for full access to i
| 25 | [iron](./i/iron) | Encapsulated tokens (encrypted and mac'ed objects)
| 25 | [jest-changed-files](./j/jest-changed-files) | A module used internally by Jest to check which fi
...
| 25 | [omit-empty](./o/omit-empty) | Recursively omit empty properties from an object. 
...
| 25 | [smooth-scrollbar](./s/smooth-scrollbar) | Customize scrollbar in modern browsers with smooth
| 25 | [uifabric__styling](./u/uifabric__styling) | Defines the core Office UI Fabric styles through a
| 25 | [web3-core-subscriptions](./w/web3-core-subscriptions) | Manages web3 subscriptions. This is an internal pa
| 25 | [zeit__next-typescript](./z/zeit__next-typescript) | Use 
| 25 | [zeroclipboard](./z/zeroclipboard) | The ZeroClipboard library provides an easy way to 
...
| 24 | [express-list-endpoints](./e/express-list-endpoints) | A express package to list all registered endoints 
...
| 24 | [lzma-native](./l/lzma-native) | Provides bindings to the native liblzma library (.
| 24 | [material__toolbar](./m/material__toolbar) | The Material Components for the web toolbar compon
...
| 24 | [p-pipe](./p/p-pipe) | Compose promise-returning & async functions into a
...
| 24 | [password-hash-and-salt](./p/password-hash-and-salt) | Simple, safe and straight-forward password hashing
| 24 | [purifycss-webpack](./p/purifycss-webpack) | PurifyCSS for webpack
| 24 | [react-linkify](./r/react-linkify) | React component to parse links (urls, emails, etc.
...
| 24 | [run-parallel-limit](./r/run-parallel-limit) | Run an array of functions in parallel, but limit t
...
| 23 | [jdataview](./j/jdataview) | A unique way to work with a binary file in the bro
| 23 | [jest-runner](./j/jest-runner) | -
...
| 23 | [nodemailer-direct-transpo](./n/nodemailer-direct-transport) | Direct transport for Nodemailer
...
| 23 | [promise-fs](./p/promise-fs) | Wraps FS methods using Promise
...
| 23 | [steam](./s/steam) | Lets you interface with Steam without running an a
| 23 | [storybook__addon-viewport](./s/storybook__addon-viewport) | Storybook addon to change the viewport size to mob
| 23 | [storybook__client-logger](./s/storybook__client-logger) | Any client-side logging that is done through story
| 23 | [triplesec](./t/triplesec) | A CommonJS-compliant system for secure encryption 
...
| 22 | [cordova-plugin-inappbrows](./c/cordova-plugin-inappbrowser) | Cordova InAppBrowser Plugin
...
| 22 | [hard-rejection](./h/hard-rejection) | Make unhandled promise rejections fail hard right 
...
| 22 | [i18n-js](./i/i18n-js) | A javascript library similar to Ruby on Rails i18n
| 22 | [is-natural-number](./i/is-natural-number) | Check if a value is a natural number
| 22 | [is-npm](./i/is-npm) | Check if your code is running as an npm script
...
| 22 | [libsodium-wrappers-sumo](./l/libsodium-wrappers-sumo) | The Sodium cryptographic library compiled to pure 
...
| 22 | [massive](./m/massive) | A small query tool for Postgres that embraces json
| 22 | [move-concurrently](./m/move-concurrently) | Promises of moves of files or directories with ren
| 22 | [node-mailjet](./n/node-mailjet) | Mailjet NodeJS API client
| 22 | [object_dot_getownproperty](./o/object_dot_getownpropertydescriptors) | ES2017 spec-compliant shim for Object.getOwnProper
| 22 | [oniguruma](./o/oniguruma) | oniguruma regular expression library
| 22 | [p-settle](./p/p-settle) | Settle promises concurrently and get their fulfill
| 22 | [packery](./p/packery) | Gapless, draggable grid layouts
| 22 | [pathfinding](./p/pathfinding) | Comprehensive pathfinding library for grid based g
| 22 | [project-name](./p/project-name) | Get the name of a project, from package.json, git 
| 22 | [prosemirror-gapcursor](./p/prosemirror-gapcursor) | ProseMirror plugin for cursors at normally impossi
...
| 22 | [readdir-enhanced](./r/readdir-enhanced) | fs.readdir with sync, async, and streaming APIs + 
| 22 | [relateurl](./r/relateurl) | Minify URLs by converting them from absolute to re
| 22 | [restify-cookies](./r/restify-cookies) | Adds cookie parsing/setting to restify
| 22 | [rfdc](./r/rfdc) | Really Fast Deep Clone
| 22 | [rheostat](./r/rheostat) | Rheostat is a www, mobile, and accessible slider c
| 22 | [rsmq-worker](./r/rsmq-worker) | RSMQ helper to simply implement a worker around th
| 22 | [semver-sort](./s/semver-sort) | Sort array of semver string even which is exist in
...
| 22 | [xml-formatter](./x/xml-formatter) | Converts XML into a human readable format (pretty 
...
| 21 | [chess_dot_js](./c/chess_dot_js) | A Javascript chess library for chess move generati
| 21 | [color-diff](./c/color-diff) | Implemets the CIEDE2000 color difference algorithm
| 21 | [connect-pg-simple](./c/connect-pg-simple) | A simple, minimal PostgreSQL session store for Con
...
| 21 | [datatables_dot_net-button](./d/datatables_dot_net-buttons) | Buttons for DataTables
...
| 21 | [material__slider](./m/material__slider) | The Material Components for the web slider compone
| 21 | [material__tabs](./m/material__tabs) | The Material Components for the web tabs component
| 21 | [microsoft__load-themed-st](./m/microsoft__load-themed-styles) | Loads themed styles.
...
| 21 | [phosphor__dragdrop](./p/phosphor__dragdrop) | PhosphorJS - Drag and Drop
| 21 | [phosphor__properties](./p/phosphor__properties) | PhosphorJS - Attached Properties
...
| 21 | [zenscroll](./z/zenscroll) | A module to smooth-scroll web pages and scrollable
| 21 | [zipkin-instrumentation-ex](./z/zipkin-instrumentation-express) | Express middleware for instrumentation with Zipkin
| 21 | [zookeeper](./z/zookeeper) | apache zookeeper client (zookeeper async API >= 3.
...
| 20 | [bent](./b/bent) | Functional HTTP client for Node.js w/ async/await.
| 20 | [blue-tape](./b/blue-tape) | Tape test runner with promise support
| 20 | [btoa-lite](./b/btoa-lite) | Smallest/simplest possible means of using btoa wit
...
| 20 | [es-to-primitive](./e/es-to-primitive) | ECMAScript “ToPrimitive” algorithm. Provides ES5 a
| 20 | [first-mate](./f/first-mate) | TextMate helpers
| 20 | [fuzzyset_dot_js](./f/fuzzyset_dot_js) | A fuzzy string set for JavaScript
| 20 | [git-repo-name](./g/git-repo-name) | Get the repository name from the git remote origin
| 20 | [google-cloud__promisify](./g/google-cloud__promisify) | A simple utility for promisifying functions and cl
| 20 | [graphql-upload](./g/graphql-upload) | Middleware and an Upload scalar to add support for
...
| 20 | [jsrender](./j/jsrender) | Best-of-breed templating in browser or on Node.js 
...
| 20 | [material__top-app-bar](./m/material__top-app-bar) | The Material Components for the web top app bar co
...
| 20 | [react-aria-menubutton](./r/react-aria-menubutton) | A fully accessible and flexible React-powered menu
| 20 | [react-native-modalbox](./r/react-native-modalbox) | A  component for react-native
...
| 19 | [lscache](./l/lscache) | A simple library that emulates memcache functions 
| 19 | [luaparse](./l/luaparse) | A Lua parser in JavaScript
| 19 | [mapbox__shelf-pack](./m/mapbox__shelf-pack) | A 2D rectangular bin packing data structure that u
| 19 | [mark_dot_js](./m/mark_dot_js) | Highlight keywords using JavaScript. Intended for 
| 19 | [material__icon-toggle](./m/material__icon-toggle) | The Material Components for the web icon toggle co
| 19 | [mongoose-deep-populate](./m/mongoose-deep-populate) | Mongoose plugin to enable deep population of neste
...
| 19 | [nivo__colors](./n/nivo__colors) | -
| 19 | [node-resque](./n/node-resque) | an opinionated implementation of resque in node
| 19 | [original](./o/original) | Generate the origin from an URL or check if two UR
| 19 | [owasp-password-strength-t](./o/owasp-password-strength-test) | A password-strength tester based upon the OWASP gu
...
| 19 | [react-highlight_dot_js](./r/react-highlight_dot_js) | A lightweight React wrapper around the Highlight.j
| 19 | [react-native-navigation](./r/react-native-navigation) | React Native Navigation - truly native navigation 
...
| 19 | [sc-errors](./s/sc-errors) | Error types for use throughout SocketCluster
| 19 | [sort-object-keys](./s/sort-object-keys) | Sort an object's keys, including an optional key l
...
| 19 | [structured-source](./s/structured-source) | Provides StructuredSource and functionality for co
...
| 18 | [amphtml-validator](./a/amphtml-validator) | Official validator for AMP HTML (www.ampproject.or
...
| 18 | [babel-plugin-jest-hoist](./b/babel-plugin-jest-hoist) | Babel plugin to hoist jest.disableAutomock, jest.e
...
| 18 | [docker-file-parser](./d/docker-file-parser) | Parses a Dockerfile and returns an array of comman
| 18 | [elv](./e/elv) | Elvis operator functionality for JavaScript.
| 18 | [emotion__utils](./e/emotion__utils) | internal utils for emotion
| 18 | [express-minify](./e/express-minify) | Automatically minify and cache your javascript and
...
| 18 | [futoin-hkdf](./f/futoin-hkdf) | RFC5869: HMAC-based Extract-and-Expand Key Derivat
...
| 18 | [http-link-header](./h/http-link-header) | Parse & format HTTP link headers according to RFC 
| 18 | [jest-jasmine2](./j/jest-jasmine2) | -
| 18 | [jquery_dot_scrollto](./j/jquery_dot_scrollto) | Lightweight, cross-browser and highly customizable
| 18 | [js-levenshtein](./j/js-levenshtein) | The most efficient JS implementation calculating t
| 18 | [js-quantities](./j/js-quantities) | JavaScript library for quantity calculation and un
...
| 18 | [p-lazy](./p/p-lazy) | Create a lazy promise that defers execution until 
| 18 | [package-info](./p/package-info) | Get the information of a npm package
...
| 18 | [resource-loader](./r/resource-loader) | A generic asset loader, made with web games in min
...
| 18 | [socket_dot_io-emitter](./s/socket_dot_io-emitter) | -
...
| 17 | [credential](./c/credential) | Easy password hashing and verification in Node. Pr
...
| 17 | [emotion__hash](./e/emotion__hash) | A MurmurHash2 implementation
...
| 17 | [jest__test-result](./j/jest__test-result) | -
...
| 17 | [leaflet_dot_gridlayer_dot](./l/leaflet_dot_gridlayer_dot_googlemutant) | A plugin for LeafletJS to use Google maps basemaps
| 17 | [lockr](./l/lockr) | A minimal API wrapper for localStorage
| 17 | [lodash_dot_differencewith](./l/lodash_dot_differencewith) | The lodash method _.differenceWith exported as a m
| 17 | [lodash_dot_head](./l/lodash_dot_head) | The lodash method _.head exported as a module.
| 17 | [lodash_dot_partialright](./l/lodash_dot_partialright) | The lodash method _.partialRight exported as a mod
...
| 17 | [markdownlint](./m/markdownlint) | A Node.js style checker and lint tool for Markdown
...
| 17 | [protobufjs__inquire](./p/protobufjs__inquire) | Requires a module only if available and hides the 
| 17 | [raygun](./r/raygun) | Raygun.io plugin for Node
| 17 | [react-aria-modal](./r/react-aria-modal) | A fully accessible and flexible React modal built 
| 17 | [react-mdl](./r/react-mdl) | React Components for Material Design Lite
| 17 | [react-native-tab-navigato](./r/react-native-tab-navigator) | A tab bar that switches between scenes, written in
...
| 17 | [sip_dot_js](./s/sip_dot_js) | A simple, intuitive, and powerful JavaScript signa
...
| 17 | [subscribe-ui-event](./s/subscribe-ui-event) | A single, throttle built-in solution to subscribe 
...
| 16 | [blockies](./b/blockies) | npm package for blockies https://github.com/alexva
| 16 | [bpmn-moddle](./b/bpmn-moddle) | A moddle wrapper for BPMN 2.0
| 16 | [cordova-plugin-file-trans](./c/cordova-plugin-file-transfer) | Cordova File Transfer Plugin
| 16 | [create-emotion](./c/create-emotion) | The Next Generation of CSS-in-JS.
| 16 | [express-mung](./e/express-mung) | Transform an express response (or make until no go
| 16 | [firebase__util](./f/firebase__util) | _NOTE: This is specifically tailored for Firebase 
...
| 16 | [ion-rangeslider](./i/ion-rangeslider) | Cool, comfortable and easily customizable range sl
| 16 | [iso8601-duration](./i/iso8601-duration) | Node/Js-module for parsing and making sense of ISO
...
| 16 | [ledgerhq__hw-transport-we](./l/ledgerhq__hw-transport-webusb) | Ledger Hardware Wallet WebUSB implementation of th
...
| 16 | [material__notched-outline](./m/material__notched-outline) | The Material Components for the web notched-outlin
...
| 16 | [pangu](./p/pangu) | Paranoid text spacing for good readability, to aut
| 16 | [paralleljs](./p/paralleljs) | parallel.js enables easy multi-thread processing i
...
| 15 | [bricks_dot_js](./b/bricks_dot_js) | A blazing fast masonry layout generator for fixed 
...
| 15 | [devcert-san](./d/devcert-san) | Generate trusted local SSL/TLS certificates for lo
...
| 15 | [extract-files](./e/extract-files) | Clones a value, recursively extracting File, Blob 
...
| 15 | [is-lite](./i/is-lite) | A tiny javascript type testing tool
| 15 | [jasminewd2](./j/jasminewd2) | WebDriverJS adapter for Jasmine2.
| 15 | [jest-serializer](./j/jest-serializer) | Module for serializing and deserializing object in
...
| 15 | [keyboardjs](./k/keyboardjs) | A library for binding to keys and key combos witho
...
| 15 | [libnpmsearch](./l/libnpmsearch) | Programmatic API for searching in npm and compatib
...
| 15 | [material__dom](./m/material__dom) | DOM manipulation utilities for Material Components
...
| 15 | [rollup-plugin-visualizer](./r/rollup-plugin-visualizer) | -
...
| 15 | [transducers_dot_js](./t/transducers_dot_js) | A small library for generalized transformation of 
| 15 | [tree-changes](./t/tree-changes) | Helpers function to get tree changes between two d
| 15 | [trezor-connect](./t/trezor-connect) | High-level javascript interface for Trezor hardwar
| 15 | [url-assembler](./u/url-assembler) | Assemble urls from route-like templates (/path/:pa
| 15 | [web3-providers-ws](./w/web3-providers-ws) | Module to handle web3 RPC connections over WebSock
...
| 15 | [wordpress__data](./w/wordpress__data) | Data module for WordPress.
...
| 14 | [graphql-compose](./g/graphql-compose) | GraphQL schema builder from different data sources
...
| 14 | [material__floating-label](./m/material__floating-label) | The Material Components for the web floating-label
| 14 | [material__line-ripple](./m/material__line-ripple) | The Material Components for the web line-ripple co
| 14 | [min-document](./m/min-document) | A minimal DOM implementation
| 14 | [p-forever](./p/p-forever) | Run promise-returning & async functions repeatedly
| 14 | [p2](./p/p2) | A JavaScript 2D physics engine.
| 14 | [parse-passwd](./p/parse-passwd) | Parse a passwd file into a list of users.
| 14 | [phonegap](./p/phonegap) | PhoneGap command-line interface and node.js librar
| 14 | [pickadate](./p/pickadate) | The mobile-friendly, responsive, and lightweight j
| 14 | [pkcs11js](./p/pkcs11js) | A Node.js implementation of the PKCS
| 14 | [pvutils](./p/pvutils) | Common utilities for products from Peculiar Ventur
| 14 | [react-dotdotdot](./r/react-dotdotdot) | Multiline text ellipsis for react
| 14 | [react-floater](./r/react-floater) | Floaters everywhere
| 14 | [react-gravatar](./r/react-gravatar) | React component for rendering a gravatar profile i
...
| 14 | [web3-providers-http](./w/web3-providers-http) | Module to handle web3 RPC connections over HTTP.
| 14 | [web3-shh](./w/web3-shh) | Web3 module to interact with the Whisper messaging
| 14 | [zopflipng-bin](./z/zopflipng-bin) | zopflipng wrapper that makes it seamlessly availab
...
| 13 | [bitwise-xor](./b/bitwise-xor) | Bitwise XOR between two Buffers or Strings, return
| 13 | [blazy](./b/blazy) | A fast lightweight pure JavaScript script for lazy
...
| 13 | [ecdsa-sig-formatter](./e/ecdsa-sig-formatter) | Translate ECDSA signatures between ASN.1/DER and J
...
| 13 | [free-style](./f/free-style) | Make CSS easier and more maintainable by using Jav
| 13 | [fscreen](./f/fscreen) | fullscreen spec api in a vendor agnostic wrapper
| 13 | [generate-json-webpack-plu](./g/generate-json-webpack-plugin) | Webpack plugin to generate a custom JSON asset
...
| 13 | [graphql-fields](./g/graphql-fields) | Turns GraphQLResolveInfo into a map of the request
...
| 13 | [level-codec](./l/level-codec) | Encode keys, values and range options, with built-
| 13 | [lifeomic__attempt](./l/lifeomic__attempt) | Library that can be used to retry functions that r
| 13 | [lodash_dot_castarray](./l/lodash_dot_castarray) | The lodash method _.castArray exported as a module
| 13 | [lodash_dot_findlastindex](./l/lodash_dot_findlastindex) | The lodash method _.findLastIndex exported as a mo
...
| 13 | [react-tag-input](./r/react-tag-input) | React tags is a fantastically simple tagging compo
| 13 | [react-widgets-moment](./r/react-widgets-moment) | A moment.js localizer for react-widgets
| 13 | [recluster](./r/recluster) | Clustering library with support for zero-downtime 
...
| 13 | [resumablejs](./r/resumablejs) | A JavaScript library for providing multiple simult
...
| 12 | [anchor-js](./a/anchor-js) | A JavaScript utility for adding deep anchor links 
| 12 | [angular-file-upload](./a/angular-file-upload) | Angular File Upload is a module for the AngularJS 
| 12 | [bootstrap-touchspin](./b/bootstrap-touchspin) | A mobile and touch friendly input spinner componen
...
| 12 | [cli-interact](./c/cli-interact) | Simple helper tools for interacting synchronously 
| 12 | [clipboard-js](./c/clipboard-js) | A web shim to handle clipboard APIs across browser
| 12 | [datadog-metrics](./d/datadog-metrics) | Buffered metrics reporting via the DataDog HTTP AP
...
| 12 | [graylog2](./g/graylog2) | Graylog2 client library for node.js
...
| 12 | [lodash_dot_intersectionwi](./l/lodash_dot_intersectionwith) | The lodash method _.intersectionWith exported as a
| 12 | [lodash_dot_isobjectlike](./l/lodash_dot_isobjectlike) | The lodash method _.isObjectLike exported as a mod
...
| 12 | [polylabel](./p/polylabel) | A JS library for finding optimal label position in
| 12 | [postgres-interval](./p/postgres-interval) | Parse Postgres interval columns
| 12 | [procfs-stats](./p/procfs-stats) | get detailed information (more than ps, top etc) a
| 12 | [prosemirror-markdown](./p/prosemirror-markdown) | ProseMirror Markdown integration
| 12 | [protobufjs__float](./p/protobufjs__float) | Reads / writes floats / doubles from / to buffers 
| 12 | [protobufjs__path](./p/protobufjs__path) | A minimal path module to resolve Unix, Windows and
...
| 12 | [react-axe](./r/react-axe) | Dynamic accessibility analysis for React using axe
| 12 | [react-dnd-multi-backend](./r/react-dnd-multi-backend) | Multi Backend system compatible with React DnD
| 12 | [react-native-platform-tou](./r/react-native-platform-touchable) | Uses TouchableNativeFeedback where possible and fa
| 12 | [react-native-snap-carouse](./r/react-native-snap-carousel) | Swiper/carousel component for React Native with pr
...
| 12 | [react-svg-pan-zoom](./r/react-svg-pan-zoom) | A React component that adds pan and zoom features 
...
| 12 | [tti-polyfill](./t/tti-polyfill) | Polyfill for Time to Interactive. See https://goo.
| 12 | [typed_dot_js](./t/typed_dot_js) | A JavaScript Typing Animation Library
| 12 | [uirouter__core](./u/uirouter__core) | UI-Router Core: Framework agnostic, State-based ro
...
| 11 | [authenticator](./a/authenticator) | Two- / Multi- Factor Authenication (2FA / MFA) for
...
| 11 | [is-elevated](./i/is-elevated) | Check if the process is running with elevated priv
| 11 | [jasmine-ajax](./j/jasmine-ajax) | A library for faking Ajax responses in your Jasmin
| 11 | [jest-leak-detector](./j/jest-leak-detector) | Module for verifying whether an object has been ga
| 11 | [jest-watcher](./j/jest-watcher) | Delightful JavaScript Testing.
...
| 11 | [jss-plugin-global](./j/jss-plugin-global) | Global styles for JSS
| 11 | [jss-plugin-props-sort](./j/jss-plugin-props-sort) | JSS plugin that ensures style properties extend ea
| 11 | [jss-plugin-rule-value-fun](./j/jss-plugin-rule-value-function) | JSS plugin for function value and rule syntax
| 11 | [jupyterlab__outputarea](./j/jupyterlab__outputarea) | JupyterLab - Notebook Output Area
...
| 11 | [knockout_dot_validation](./k/knockout_dot_validation) | A KnockoutJS Plugin for model and property validat
| 11 | [koa-pino-logger](./k/koa-pino-logger) | pino logging koa middleware
| 11 | [koa-pug](./k/koa-pug) | A Pug middleware for Koa
| 11 | [koa-session-minimal](./k/koa-session-minimal) | Minimal implementation of session middleware for K
| 11 | [leaflet_dot_locatecontrol](./l/leaflet_dot_locatecontrol) | A useful control to geolocate the user with many o
| 11 | [libxslt](./l/libxslt) | Node.js bindings for libxslt compatible with libxm
| 11 | [list-stream](./l/list-stream) | Collect chunks / objects from a readable stream, w
...
| 11 | [memoizerific](./m/memoizerific) | Fast, small, efficient JavaScript memoization lib 
| 11 | [mini-signals](./m/mini-signals) | signals, in JavaScript, fast
...
| 11 | [passport-azure-ad](./p/passport-azure-ad) | OIDC and Bearer Passport strategies for Azure Acti
| 11 | [pg-types](./p/pg-types) | Query result type converters for node-postgres
| 11 | [phosphor__application](./p/phosphor__application) | PhosphorJS - Pluggable Application
| 11 | [polymer](./p/polymer) | Pre-processor for the Harp APF
| 11 | [postcss-icss-values](./p/postcss-icss-values) | PostCSS plugin for CSS Modules to pass arbitrary v
...
| 11 | [rebass__grid](./r/rebass__grid) | Responsive React grid system built with styled-sys
...
| 11 | [sourcemapped-stacktrace](./s/sourcemapped-stacktrace) | A simple module for applying source maps to JS sta
...
| 10 | [apollo__react-common](./a/apollo__react-common) | React Apollo common utilities.
...
| 10 | [firebase__component](./f/firebase__component) | Firebase Component Platform
...
| 10 | [jest__transform](./j/jest__transform) | -
| 10 | [jquery_dot_fancytree](./j/jquery_dot_fancytree) | JavaScript tree view / tree grid plugin with suppo
| 10 | [jquery_dot_nicescroll](./j/jquery_dot_nicescroll) | Nicescroll is a jquery plugin, for nice customizab
| 10 | [jss-plugin-camel-case](./j/jss-plugin-camel-case) | JSS plugin that allows to write camel cased rule p
| 10 | [jss-plugin-default-unit](./j/jss-plugin-default-unit) | JSS plugin that adds default custom unit to numeri
| 10 | [jssip](./j/jssip) | the Javascript SIP library
...
| 10 | [localforage-cordovasqlite](./l/localforage-cordovasqlitedriver) | SQLite driver for Cordova apps using localForage.
| 10 | [lodash_dot_replace](./l/lodash_dot_replace) | The lodash method _.replace exported as a module.
| 10 | [lodash_dot_samplesize](./l/lodash_dot_samplesize) | The lodash method _.sampleSize exported as a modul
...
| 10 | [macos-release](./m/macos-release) | Get the name and version of a macOS release from t
...
| 10 | [react-bootstrap-daterange](./r/react-bootstrap-daterangepicker) | A date/time picker for react (using bootstrap). Th
| 10 | [react-file-reader-input](./r/react-file-reader-input) | React file input component for complete control ov
| 10 | [react-infinite-calendar](./r/react-infinite-calendar) | Infinite scrolling date-picker built with React, w
| 10 | [react-native-keep-awake](./r/react-native-keep-awake) | Keep the screen from going to sleep. iOS and Andro
...
| 10 | [react-timeout](./r/react-timeout) | HOC for React and React Native providing versions 
| 10 | [react-virtualized-auto-si](./r/react-virtualized-auto-sizer) | Standalone version of the AutoSizer component from
| 10 | [redux-debounced](./r/redux-debounced) | Debounce middleware for Redux
| 10 | [redux-saga-routines](./r/redux-saga-routines) | Routines for redux-saga also useful with redux-for
| 10 | [ref-napi](./r/ref-napi) | Turn Buffer instances into "pointers"
| 10 | [retry-axios](./r/retry-axios) | Retry HTTP requests with Axios.
| 10 | [rison](./r/rison) | URI friendly encoding for JSON structures
| 10 | [sentry__webpack-plugin](./s/sentry__webpack-plugin) | Official webpack plugin for Sentry
| 10 | [shpjs](./s/shpjs) | A binary shapefile loader, for javascript. Not man
| 10 | [siema](./s/siema) | Lightweight and simple carousel with no dependenci
...
| 10 | [theme-ui__components](./t/theme-ui__components) | Primitive layout, typographic, and other component
...
| 9 | [d3-delaunay](./d/d3-delaunay) | Compute the Voronoi diagram of a set of two-dimens
...
| 9 | [diff-sequences](./d/diff-sequences) | Compare items in two sequences to find a longest c
| 9 | [ebml](./e/ebml) | ebml parser
...
| 9 | [jupyterlab__completer](./j/jupyterlab__completer) | JupyterLab - Completer
| 9 | [koa-useragent](./k/koa-useragent) | Koa.js middleware for useragent detection
| 9 | [load-google-maps-api](./l/load-google-maps-api) | A thin, Promise-returning helper for loading the G
...
| 9 | [muicss](./m/muicss) | Lightweight CSS framework based on Google's Materi
| 9 | [named-routes](./n/named-routes) | Named routes for node.js. Works with express and i
| 9 | [natural-compare-lite](./n/natural-compare-lite) | Compare strings containing a mix of letters and nu
...
| 9 | [npm-paths](./n/npm-paths) | Returns an array of NPM directory paths based on t
...
| 9 | [optional-js](./o/optional-js) | Optionals for JS - wrapper for possibly undefined 
| 9 | [parent-package-json](./p/parent-package-json) | Find, read and parse the package.json of the paren
...
| 9 | [postcss-modules-resolve-i](./p/postcss-modules-resolve-imports) | Resolves ICSS imports
| 9 | [promise-ftp-common](./p/promise-ftp-common) | error classes and other common code used in promis
...
| 9 | [react-leaflet-markerclust](./r/react-leaflet-markercluster) | React wrapper of Leaflet.markercluster for react-l
| 9 | [react-native-fbsdk](./r/react-native-fbsdk) | Facebook SDK support for React Native apps.
| 9 | [react-native-material-dro](./r/react-native-material-dropdown) | Material dropdown
| 9 | [react-native-uuid](./r/react-native-uuid) | Rigorous implementation of RFC4122 (v1 and v4) UUI
...
| 9 | [safe-compare](./s/safe-compare) | Constant-time comparison algorithm to prevent timi
| 9 | [scanf](./s/scanf) | C like scanf/sscanf module for node.js.
| 9 | [setasap](./s/setasap) | setImmediate polyfill for the browser and node
| 9 | [shopify-buy](./s/shopify-buy) | The JS Buy SDK is a lightweight library that allow
...
| 9 | [use-deep-compare-effect](./u/use-deep-compare-effect) | It's react's useEffect hook, except using deep com
...
| 9 | [webcrypto](./w/webcrypto) | Use the Node.js crypto module API without having t
| 9 | [webdriver-js-extender](./w/webdriver-js-extender) | A plugin which adds additional commands to seleniu
| 9 | [webpack-blocks](./w/webpack-blocks) | Convenience package that includes all the most com
...
| 9 | [zipkin-instrumentation-fe](./z/zipkin-instrumentation-fetch) | Interceptor for HTTP clients using the 'fetch' API
| 8 | [angular-block-ui](./a/angular-block-ui) | An AngularJS module that allows you to block user 
...
| 8 | [apollo__react-hooks](./a/apollo__react-hooks) | React Apollo Hooks.
...
| 8 | [cfn-response](./c/cfn-response) | A module for sending responses from lambda-funcito
| 8 | [chai-fuzzy](./c/chai-fuzzy) | fuzzy matchers for chai
| 8 | [chosen-js](./c/chosen-js) | Chosen is a JavaScript plugin that makes select bo
...
| 8 | [emotion__memoize](./e/emotion__memoize) | emotion's memoize utility
...
| 8 | [framesync](./f/framesync) | A Unity-inspired render loop for JavaScript
...
| 8 | [jest__fake-timers](./j/jest__fake-timers) | -
...
| 8 | [jss-plugin-vendor-prefixe](./j/jss-plugin-vendor-prefixer) | JSS plugin that handles vendor prefixes in the bro
| 8 | [karma-fixture](./k/karma-fixture) | A plugin for the Karma test runner that loads .htm
| 8 | [koa-html-minifier](./k/koa-html-minifier) | minify HTML responses like some crazy guy
| 8 | [latest-semver](./l/latest-semver) | Get the latest stable semver version from an array
...
| 8 | [money-math](./m/money-math) | jsbn-based arbitrary precision operations on curre
...
| 8 | [nodemailer-pickup-transpo](./n/nodemailer-pickup-transport) | Pickup transport for Nodemailer
...
| 8 | [p-some](./p/p-some) | Wait for a specified number of promises to be fulf
...
| 8 | [pdfobject](./p/pdfobject) | An open-source standards-friendly JavaScript utili
...
| 8 | [pino-multi-stream](./p/pino-multi-stream) | A wrapper for the Pino logger that provides Bunyan
| 8 | [pkg-versions](./p/pkg-versions) | Get the version numbers of a package from the npm 
| 8 | [popmotion__easing](./p/popmotion__easing) | Easing functions, modifiers and generators compati
...
| 8 | [rolling-rate-limiter](./r/rolling-rate-limiter) | Rate limiter that supports a rolling window, eithe
| 8 | [rosie](./r/rosie) | factory for building JavaScript objects, mostly us
...
| 8 | [ts-invariant](./t/ts-invariant) | TypeScript implementation of invariant(condition, 
...
| 8 | [worker-plugin](./w/worker-plugin) | Webpack plugin to bundle Workers automagically.
...
| 7 | [apollo-tracing](./a/apollo-tracing) | Collect and expose trace data for GraphQL requests
...
| 7 | [clownface](./c/clownface) | Simple but powerful graph traversing library
...
| 7 | [enigma_dot_js](./e/enigma_dot_js) | JavaScript library for consuming Qlik backend serv
...
| 7 | [filter-invalid-dom-props](./f/filter-invalid-dom-props) | a function to filter props that are not valid dom 
...
| 7 | [freshy](./f/freshy) | A node module (unre)loader.
...
| 7 | [json-rules-engine](./j/json-rules-engine) | Rules Engine expressed in simple json
| 7 | [jsqrcode](./j/jsqrcode) | a node port of Lazar Laszlo's jsqrcode qr code dec
| 7 | [jupyterlab__terminal](./j/jupyterlab__terminal) | JupyterLab - Terminal Emulator Widget
...
| 7 | [lodash_dot_flattendepth](./l/lodash_dot_flattendepth) | The lodash method _.flattenDepth exported as a mod
...
| 7 | [lodash_dot_lowerfirst](./l/lodash_dot_lowerfirst) | The lodash method _.lowerFirst exported as a modul
...
| 7 | [merge-images](./m/merge-images) | Easily compose images together without messing aro
| 7 | [modesl](./m/modesl) | FreeSWITCH ESL Node.js Implementation
| 7 | [moji](./m/moji) | 半角全角変換・特定文字抽出など日本語を便利に扱うJavaScriptライブラリ。
| 7 | [moment-business](./m/moment-business) | Methods to work with week days and weekends in mom
...
| 7 | [p-times](./p/p-times) | Run promise-returning & async functions a specific
| 7 | [parse5-htmlparser2-tree-a](./p/parse5-htmlparser2-tree-adapter) | htmlparser2 tree adapter for parse5.
| 7 | [pinkyswear](./p/pinkyswear) | Minimalistic Promises/A+ implementation, <500 byte
| 7 | [pleasejs](./p/pleasejs) | JS library to generate random pleasing colors/colo
...
| 7 | [proper-url-join](./p/proper-url-join) | Like path.join but for a URL
...
| 7 | [shipit-cli](./s/shipit-cli) | Universal automation and deployment tool written i
| 7 | [shot](./s/shot) | Injects a fake HTTP request/response into a node H
| 7 | [sindresorhus__df](./s/sindresorhus__df) | Get free disk space info from df -kP
| 7 | [sns-validator](./s/sns-validator) | A standalone validator for inbound SNS HTTP messag
| 7 | [sonic-boom](./s/sonic-boom) | Extremely fast utf8 only stream implementation
| 7 | [sort-array](./s/sort-array) | Sort an array of objects by any property value, at
...
| 7 | [svg-injector](./s/svg-injector) | Fast, caching, dynamic inline SVG DOM injection li
...
| 7 | [trianglify](./t/trianglify) | Trianglify is a javascript library for generating 
| 7 | [tweezer_dot_js](./t/tweezer_dot_js) | A small, dependency-free, ES6 tweening library for
| 7 | [ungap__create-content](./u/ungap__create-content) | A cross browser utility to create HTML or SVG runt
| 7 | [unsplash-js](./u/unsplash-js) | A Universal JavaScript wrapper for the Unsplash AP
...
| 6 | [apollo-engine-reporting](./a/apollo-engine-reporting) | Send reports about your GraphQL services to Apollo
...
| 6 | [blake2](./b/blake2) | All four BLAKE2 variants (blake2b, blake2bp, blake
| 6 | [browserslist-useragent](./b/browserslist-useragent) | A utility to match a browselist query to browser u
| 6 | [bull-arena](./b/bull-arena) | An interactive UI dashboard for Bee Queue
| 6 | [canvas-gauges](./c/canvas-gauges) | Minimalist HTML5 Canvas Gauges
| 6 | [carbon__layout](./c/carbon__layout) | Layout helpers for digital and software products u
| 6 | [chai-jest-snapshot](./c/chai-jest-snapshot) | Chai assertion that provides Jest's snapshot testi
...
| 6 | [critters-webpack-plugin](./c/critters-webpack-plugin) | Webpack plugin to inline critical CSS and lazy-loa
| 6 | [cross-storage](./c/cross-storage) | Cross domain local storage
| 6 | [datatables_dot_net-scroll](./d/datatables_dot_net-scroller) | Scroller for DataTables
...
| 6 | [delaunator](./d/delaunator) | An incredibly fast JavaScript library for Delaunay
...
| 6 | [express-debug](./e/express-debug) | debug toolbar middleware for developing applicatio
...
| 6 | [forge-apis](./f/forge-apis) | The Forge Platform contains an expanding collectio
| 6 | [frac](./f/frac) | Rational approximation with bounded denominator
| 6 | [frisby](./f/frisby) | Frisby.js v2.0: REST API Endpoint Testing built on
...
| 6 | [http-codes](./h/http-codes) | Map of HTTP status messages to codes based on Node
...
| 6 | [jest-environment-puppetee](./j/jest-environment-puppeteer) | Puppeteer environment for Jest.
| 6 | [jest__console](./j/jest__console) | -
| 6 | [jquery-deparam](./j/jquery-deparam) | Inverse of jQuery's $.param method to convert a qu
...
| 6 | [just-clone](./j/just-clone) | deep copies objects and arrays
| 6 | [keypress_dot_js](./k/keypress_dot_js) | a robust keyboard input capturing Javascript utili
| 6 | [keystonejs__session](./k/keystonejs__session) | Tools to assist with setting up session management
| 6 | [leaflet-providers](./l/leaflet-providers) | An extension to Leaflet that contains configuratio
...
| 6 | [milliseconds](./m/milliseconds) | Insanely lightweight module for converting times t
| 6 | [mimos](./m/mimos) | Mime database interface
| 6 | [mirrorx](./m/mirrorx) | A React framework with minimal API and zero boiler
| 6 | [mongoose-geojson-schema](./m/mongoose-geojson-schema) | Schema definitions for GeoJSON types for use with 
| 6 | [named-regexp-groups](./n/named-regexp-groups) | Regular expressions with named capture groups and 
...
| 6 | [node-pg-migrate](./n/node-pg-migrate) | Postgresql database migration management tool for 
| 6 | [node-sprite-generator](./n/node-sprite-generator) | Generates image sprites and their spritesheets (cs
| 6 | [npm-license-crawler](./n/npm-license-crawler) | Analyzes license information for multiple node.js 
...
| 6 | [react-mic](./r/react-mic) | Record audio from your microphone and display as a
| 6 | [react-native-autocomplete](./r/react-native-autocomplete-input) | Pure javascript autocomplete input for react-nativ
| 6 | [react-native-google-signi](./r/react-native-google-signin) | Google Signin for your react native applications
...
| 6 | [saml](./s/saml) | Create SAML assertions.
...
| 6 | [torrent-search-api](./t/torrent-search-api) | Yet another node torrent scraper based on x-ray. (
...
| 6 | [uint32](./u/uint32) | a javascript library for dealing with (bitwise) ui
| 6 | [ungap__url-search-params](./u/ungap__url-search-params) | The URLSearchParams polyfill.
| 6 | [valid-data-url](./v/valid-data-url) | Detect if a string is a data URL
...
| 6 | [welldone-software__why-di](./w/welldone-software__why-did-you-render) | Monkey patches React to notify you about avoidable
...
| 5 | [dispatchr](./d/dispatchr) | A Flux dispatcher for applications that run on the
| 5 | [egg-mock](./e/egg-mock) | mock server for egg
| 5 | [egg-multipart](./e/egg-multipart) | multipart plugin for egg
...
| 5 | [emotion__weak-memoize](./e/emotion__weak-memoize) | A memoization function that uses a WeakMap
...
| 5 | [events_dot_once](./e/events_dot_once) | Polyfill for Node core events.once
...
| 5 | [globalthis](./g/globalthis) | ECMAScript spec-compliant polyfill/shim for global
...
| 5 | [graphql-query-complexity](./g/graphql-query-complexity) | Validation rule for GraphQL query complexity analy
...
| 5 | [hashtag-regex](./h/hashtag-regex) | A regular expression to match hashtag identifiers 
...
| 5 | [jest__core](./j/jest__core) | Delightful JavaScript Testing.
| 5 | [jest__reporters](./j/jest__reporters) | Jest's reporters
...
| 5 | [json-patch](./j/json-patch) | A JavaScript implementation of the JSON Object Not
| 5 | [jsonquery](./j/jsonquery) | MongoDB query language implemented as a node.js St
| 5 | [jsreport-html-to-xlsx](./j/jsreport-html-to-xlsx) | jsreport recipe capable of converting html into ex
| 5 | [jsreport-xlsx](./j/jsreport-xlsx) | jsreport recipe rendering excels directly from ope
| 5 | [jupyterlab__csvviewer](./j/jupyterlab__csvviewer) | JupyterLab - CSV Widget
| 5 | [jupyterlab__inspector](./j/jupyterlab__inspector) | JupyterLab - Code Inspector
| 5 | [jupyterlab__ui-components](./j/jupyterlab__ui-components) | JupyterLab - UI components written in React
...
| 5 | [kiwicom__orbit-design-tok](./k/kiwicom__orbit-design-tokens) | Design tokens for Kiwi.com.
...
| 5 | [lodash_dot_issafeinteger](./l/lodash_dot_issafeinteger) | The lodash method _.isSafeInteger exported as a mo
...
| 5 | [lozad](./l/lozad) | A light-weight JS library to lazy load any HTML el
| 5 | [mali-onerror](./m/mali-onerror) | On error middleware for Mali
| 5 | [markerclustererplus](./m/markerclustererplus) | -
| 5 | [material__data-table](./m/material__data-table) | The Material Components Web data table component
...
| 5 | [mini-create-react-context](./m/mini-create-react-context) | Smaller Polyfill for the proposed React context AP
...
| 5 | [parse-columns](./p/parse-columns) | Parse text columns, like the output of unix comman
| 5 | [phonegap-plugin-barcodesc](./p/phonegap-plugin-barcodescanner) | You can use the BarcodeScanner plugin to scan diff
...
| 5 | [react-google-maps-loader](./r/react-google-maps-loader) | React component to use google maps services into y
...
| 5 | [react-native-community__v](./r/react-native-community__viewpager) | React Native ViewPager native view
...
| 5 | [react-stars](./r/react-stars) | Simple star rating component for your React projec
...
| 5 | [redux-test-utils](./r/redux-test-utils) | Test utils to simplify testing of containers in re
| 5 | [responselike](./r/responselike) | A response-like object for mocking a Node.js HTTP 
...
| 5 | [sindresorhus__jimp](./s/sindresorhus__jimp) | -
...
| 5 | [svg-intersections](./s/svg-intersections) | A library of intersection algorithms covering all 
...
| 5 | [test-listen](./t/test-listen) | Produce URLs to test HTTP servers with ephemeral p
| 5 | [topojson-server](./t/topojson-server) | Convert GeoJSON to TopoJSON for smaller files and 
...
| 4 | [ajv-pack](./a/ajv-pack) | Produces a compact module exporting JSON-schema va
...
| 4 | [cachefactory](./c/cachefactory) | CacheFactory is a very simple and useful cache for
...
| 4 | [dnssd](./d/dnssd) | Bonjour/Avahi-like service discovery in pure JavaS
...
| 4 | [get-own-enumerable-proper](./g/get-own-enumerable-property-symbols) | Returns an array of all enumerable symbol properti
| 4 | [get-res](./g/get-res) | Get ten most popular screen resolutions
| 4 | [github-username-regex](./g/github-username-regex) | A regular expression that only matches a valid Git
| 4 | [globalize-compiler](./g/globalize-compiler) | Globalize.js runtime compiler for your formatters 
| 4 | [googleapis-common](./g/googleapis-common) | A common tooling library used by the googleapis np
| 4 | [graphql-bigint](./g/graphql-bigint) | A 53-bit wide implementation of integers for Graph
| 4 | [graphql-depth-limit](./g/graphql-depth-limit) | Limit the complexity of your GraphQL queries based
...
| 4 | [humanparser](./h/humanparser) | Parse a human name string into salutation, first n
...
| 4 | [is-reference](./i/is-reference) | Determine whether an AST node is a reference
...
| 4 | [koa-requestid](./k/koa-requestid) | A middleware that adds a request id to a koa appli
...
| 4 | [multisort](./m/multisort) | Sort an array using any number of separate, ranked
...
| 4 | [node-os-utils](./n/node-os-utils) | An operating system utility library.
...
| 4 | [react-photoswipe](./r/react-photoswipe) | PhotoSwipe, PhotoSwipeGallery component for ReactJ
...
| 4 | [redux-persist-transform-e](./r/redux-persist-transform-encrypt) | Encrypt your Redux store.
...
| 4 | [to-json-schema](./t/to-json-schema) | Convert JS object to JSON Schema
...
| 4 | [ungap__global-this](./u/ungap__global-this) | A cross engine globalThis.
...
| 4 | [xstyled__system](./x/xstyled__system) | Modern style system for styled-components & emotio
...
| 3 | [ant-design__icons-react-n](./a/ant-design__icons-react-native) |  Ant Design Icons for React Native 
| 3 | [ant-design__react-native](./a/ant-design__react-native) | 基于蚂蚁金服移动设计规范的 React Native 组件库
| 3 | [anydb-sql](./a/anydb-sql) | Minimal ORM for mysql, postgresql and sqlite with 
| 3 | [apollo-graphql](./a/apollo-graphql) | Apollo GraphQL utility library
| 3 | [apollo__react-ssr](./a/apollo__react-ssr) | React Apollo server-side rendering utilities
...
| 3 | [gyronorm](./g/gyronorm) | Accesses the gyroscope and accelerometer data from
...
| 3 | [ipcheck](./i/ipcheck) | Super-efficient module to parse and check if an IP
...
| 3 | [issue-parser](./i/issue-parser) | Parser for Github, GitLab, Bitbucket and Waffle is
| 3 | [it-all](./i/it-all) | Collects all values from an async iterator and ret
| 3 | [it-pushable](./i/it-pushable) | Pushable iterable
...
| 3 | [jimp__custom](./j/jimp__custom) | Interface to customize jimp configuration
| 3 | [jquery-backstretch](./j/jquery-backstretch) | A simple jQuery plugin that allows you to add a dy
...
| 3 | [jss-plugin-expand](./j/jss-plugin-expand) | JSS plugin that gives you a better syntax than CSS
| 3 | [jss-plugin-extend](./j/jss-plugin-extend) | JSS plugin that enables mixing in styles.
...
| 3 | [jupyterlab__mathjax2](./j/jupyterlab__mathjax2) | A MathJax 2 Typesetting provider for JupyterLab
| 3 | [jupyterlab__running](./j/jupyterlab__running) | JupyterLab - Running Sessions Panel
...
| 3 | [leaflet_dot_pm](./l/leaflet_dot_pm) | A Leaflet Plugin For Editing Geometry Layers in Le
| 3 | [leakage](./l/leakage) | Memory leak testing for node. Javascript memory fo
...
| 3 | [lodash_dot_isarraylikeobj](./l/lodash_dot_isarraylikeobject) | The lodash method _.isArrayLikeObject exported as 
...
| 3 | [lodash_dot_reduceright](./l/lodash_dot_reduceright) | The lodash method _.reduceRight exported as a modu
...
| 3 | [node-memwatch](./n/node-memwatch) | Keep an eye on your memory usage, and discover and
...
| 3 | [react-cartographer](./r/react-cartographer) | Generic React component for displaying static maps
| 3 | [react-dragtastic](./r/react-dragtastic) | A simple drag and drop library for React which use
...
| 3 | [react-router-navigation-c](./r/react-router-navigation-core) | -
...
| 3 | [rebass__forms](./r/rebass__forms) | Accessible and themeable form components for use w
...
| 3 | [search-params](./s/search-params) | A module to manipulate search part of URLs (querys
...
| 3 | [snowball-stemmers](./s/snowball-stemmers) | JS Port from Snowball Stemmers http://snowball.tar
| 3 | [square-connect](./s/square-connect) | JavaScript client library for the Square Connect v
...
| 3 | [storybook__polymer](./s/storybook__polymer) | Storybook for Polymer: Develop Polymer components 
...
| 2 | [apollo__react-components](./a/apollo__react-components) | React Apollo Query, Mutation and Subscription comp
...
| 2 | [bootstrap-validator](./b/bootstrap-validator) | A user-friendly HTML5 Form validator for Bootstrap
| 2 | [broccoli-node-api](./b/broccoli-node-api) | Broccoli Plugin API Types
| 2 | [bunyan-blackhole](./b/bunyan-blackhole) | create a fully functional bunyan logger that doesn
...
| 2 | [carbon__motion](./c/carbon__motion) | Motion helpers for digital and software products u
...
| 2 | [cordova-plugin-badge](./c/cordova-plugin-badge) | Shows the count of unread messages as a badge on t
| 2 | [cordova-plugin-media-capt](./c/cordova-plugin-media-capture) | Cordova Media Capture Plugin
...
| 2 | [express-to-koa](./e/express-to-koa) | Use express middlewares in Koa2, the one that real
...
| 2 | [formatjs__intl-unified-nu](./f/formatjs__intl-unified-numberformat) | Ponyfill for intl unified numberformat proposal
...
| 2 | [google-cloud__kms](./g/google-cloud__kms) | Google Cloud Key Management Service (KMS) API clie
...
| 2 | [hapi__shot](./h/hapi__shot) | Injects a fake HTTP request/response into a node H
| 2 | [has-emoji](./h/has-emoji) | Check whether a string has any emoji
| 2 | [hibp](./h/hibp) | A Promise-based API for querying the 'Have I been 
| 2 | [history_dot_js](./h/history_dot_js) | History.js gracefully supports the HTML5 History/S
...
| 2 | [jcanvas](./j/jcanvas) | jCanvas brings jQuery's powerful syntax and capabi
| 2 | [jest-dev-server](./j/jest-dev-server) | Starts a server before your Jest tests and tears i
...
| 2 | [jimp__jpeg](./j/jimp__jpeg) | Default Jimp jpeg encoder/decoder.
| 2 | [jimp__plugin-crop](./j/jimp__plugin-crop) | crop an image.
| 2 | [jimp__plugin-resize](./j/jimp__plugin-resize) | Resize an image.
| 2 | [jimp__png](./j/jimp__png) | Default Jimp png encoder/decoder.
| 2 | [jose](./j/jose) | JSON Object Signing and Encryption (JOSE) library 
...
| 2 | [jquery_dot_appear](./j/jquery_dot_appear) | jQuery plugin to call a function when an element a
...
| 2 | [jquery_dot_uniform](./j/jquery_dot_uniform) | A jQuery plugin to make your form controls look ho
...
| 2 | [jupyterlab__theme-light-e](./j/jupyterlab__theme-light-extension) | JupyterLab - Default Light Theme
| 2 | [jupyterlab__ui-components](./j/jupyterlab__ui-components-extension) | JupyterLab - UI component plugins
...
| 2 | [leaflet_dot_fullscreen](./l/leaflet_dot_fullscreen) | Simple plugin for Leaflet that adds fullscreen but
...
| 2 | [lingui__macro](./l/lingui__macro) | Macro for generating messages in ICU MessageFormat
...
| 2 | [lodash_dot_isarraybuffer](./l/lodash_dot_isarraybuffer) | The lodash method _.isArrayBuffer exported as a mo
...
| 2 | [lodash_dot_sortedlastinde](./l/lodash_dot_sortedlastindex) | The lodash method _.sortedLastIndex exported as a 
| 2 | [lodash_dot_sorteduniq](./l/lodash_dot_sorteduniq) | The lodash method _.sortedUniq exported as a modul
...
| 2 | [lyricist](./l/lyricist) | Fetches song lyrics using the Genius.com API and w
...
| 2 | [mongoose-paginate-v2](./m/mongoose-paginate-v2) | A cursor based custom pagination library for Mongo
...
| 2 | [mysql-import](./m/mysql-import) | Import .sql into a MySQL database with Node.
...
| 2 | [new-github-issue-url](./n/new-github-issue-url) | Generate a URL for opening a new GitHub issue with
| 2 | [nivo__calendar](./n/nivo__calendar) | -
| 2 | [nivo__chord](./n/nivo__chord) | -
...
| 2 | [react-add-to-calendar](./r/react-add-to-calendar) | A simple and reusable add to calendar button compo
...
| 2 | [react-sortable-pane](./r/react-sortable-pane) | -
...
| 2 | [redux-optimistic-ui](./r/redux-optimistic-ui) | a reducer enhancer to enable type-agnostic optimis
...
| 2 | [sasl-anonymous](./s/sasl-anonymous) | JavaScript implementation of ANONYMOUS SASL mechan
...
| 2 | [split-on-first](./s/split-on-first) | Split a string on the first occurance of a given s
...
| 2 | [trashable](./t/trashable) | A wrapper to make promises cancellable and garbage
...
| 2 | [zeit__next-source-maps](./z/zeit__next-source-maps) | Generate source maps during production build in yo
...
| 1 | [angular-deferred-bootstra](./a/angular-deferred-bootstrap) | Initialize your AngularJS app with constants loade
...
| 1 | [apollo__react-hoc](./a/apollo__react-hoc) | React Apollo graphql higher-order component.
| 1 | [apple-mapkit-js](./a/apple-mapkit-js) | An NPM installable package of Apple's Mapkit JS
...
| 1 | [connect-sequence](./c/connect-sequence) | A node.js module to run connect-like middlewares i
...
| 1 | [file-path-filter](./f/file-path-filter) | Filters file paths using globs, regular expression
...
| 1 | [firebase__auth-interop-ty](./f/firebase__auth-interop-types) | @firebase/auth interop Types
...
| 1 | [jimp__types](./j/jimp__types) | Default Jimp encoder/decoders.
| 1 | [josa](./j/josa) | Handles josa selection for dynamically generated s
...
| 1 | [jstorage](./j/jstorage) | jStorage is a cross-browser key-value store databa
...
| 1 | [jupyterlab__apputils-exte](./j/jupyterlab__apputils-extension) | JupyterLab - Application Utilities Extension
...
| 1 | [jwt-express](./j/jwt-express) | Climb aboard the JWT Express and use JWTs in your 
...
| 1 | [localized-strings](./l/localized-strings) | Simple module to localize the strings of any JS ba
...
| 1 | [lodash_dot_pullallwith](./l/lodash_dot_pullallwith) | The lodash method _.pullAllWith exported as a modu
...
| 1 | [nestdb](./n/nestdb) | The JavaScript Database for Node.js, nwjs, Electro
| 1 | [new-github-release-url](./n/new-github-release-url) | Generate a URL for opening a new GitHub release wi
...
| 1 | [phosphor__collections](./p/phosphor__collections) | PhosphorJS - Generic Collections
...
| 1 | [pollyjs__adapter-node-htt](./p/pollyjs__adapter-node-http) | Node HTTP adapter for @pollyjs
...
| 1 | [react-kawaii](./r/react-kawaii) | React Kawaii is a library of cute SVG illustration
...
| 1 | [react-sortable-tree-theme](./r/react-sortable-tree-theme-file-explorer) | File explorer theme for react-sortable-tree
| 1 | [react-tabs-redux](./r/react-tabs-redux) | Simple, fully customizable React tabs component th
...
| 1 | [readline-transform](./r/readline-transform) | Transform stream to read line-by-line and write a 
...
| 1 | [requirejs-domready](./r/requirejs-domready) | An AMD loader plugin for detecting DOM ready. An A
...
| 1 | [rox-node](./r/rox-node) | Rollout.io ROX JS SDK Node
...
| 1 | [stardust-ui__react-compon](./s/stardust-ui__react-component-ref) | A set of components and utils to deal with React r
...
| 1 | [w2ui](./w/w2ui) | JavaScript UI library. Includes grid, layout, tool
...
| 1 | [zipkin-javascript-opentra](./z/zipkin-javascript-opentracing) | An opentracing implementation for zipkin
...
| 0 | [ace-diff](./a/ace-diff) | A diff/merging wrapper for Ace Editor built on goo
...
| 0 | [angular-locker](./a/angular-locker) | A simple & configurable abstraction for local/sess
...
| 0 | [ant-design__dark-theme](./a/ant-design__dark-theme) | Dark theme variables for Ant Design
...
| 0 | [apollo__protobufjs](./a/apollo__protobufjs) | Protocol Buffers for JavaScript (& TypeScript).
...
| 0 | [atlaskit__inline-edit](./a/atlaskit__inline-edit) | A base component used to build inline-editable com
...
| 0 | [ethereum-bloom-filters](./e/ethereum-bloom-filters) | Ability to test bloom filters for ethereum.
...
| 0 | [express-slow-down](./e/express-slow-down) | Basic IP rate-limiting middleware for Express that
...
| 0 | [gijgo](./g/gijgo) | Gijgo is a set of free open source javascript cont
...
| 0 | [internal-slot](./i/internal-slot) | ES spec-like internal slots
...
| 0 | [is-interactive](./i/is-interactive) | Check if stdout or stderr is interactive
...
| 0 | [jotform-css_dot_js](./j/jotform-css_dot_js) | A lightweight, battle tested, fast, CSS parser in 
...
| 0 | [mocha-prepare](./m/mocha-prepare) | Add prepare/unprepare async hooks to your Mocha te
...
| 0 | [native-url](./n/native-url) | Brings the node url api layer to whatwg-url class
...
| 0 | [nodejs-license-file](./n/nodejs-license-file) | A lightweight License file generator and parser fo
...
| 0 | [persona](./p/persona) | The official web client library for the Persona AP
...
| 0 | [preloadjs](./p/preloadjs) | PreloadJS makes it easy to preload your assets: im
...
| 0 | [react-email-editor](./r/react-email-editor) | Unlayer's Email Editor Component for React.js
...
| 0 | [react-native-easy-upgrade](./r/react-native-easy-upgrade) | Easy to upgrade your react-native app
...
| 0 | [react-native-text-input-m](./r/react-native-text-input-mask) | Text input mask for React Native.
...
| 0 | [react-vertical-timeline-c](./r/react-vertical-timeline-component) | Vertical timeline for React.js
...
| 0 | [redux-state-sync](./r/redux-state-sync) | A middleware for redux to sync state in different 
...
| 0 | [relay-config](./r/relay-config) | Config parser for Relay applications.
| 0 | [relay-test-utils](./r/relay-test-utils) | Utilities for testing Relay applications.
...
| 0 | [rox-browser](./r/rox-browser) | Rollout.io ROX JS SDK Client
| 0 | [rox-react-native](./r/rox-react-native) | Rollout.io ROX JS SDK Client
| 0 | [rword](./r/rword) | A cryptographically secure random generator for re
...
| 0 | [scalike](./s/scalike) | -
| 0 | [secure-random-password](./s/secure-random-password) | Generate passwords using a cryptographically-stron
...
| 0 | [use-global-hook](./u/use-global-hook) | Easy state management for react using hooks in les
| 0 | [use-merge-value](./u/use-merge-value) | Easier to write a controlled component
