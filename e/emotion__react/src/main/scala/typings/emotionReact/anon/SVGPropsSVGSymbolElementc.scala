...
object SVGPropsSVGSymbolElementc {
  ...
  extension [Self <: SVGPropsSVGSymbolElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGSymbolElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGSymbolElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
