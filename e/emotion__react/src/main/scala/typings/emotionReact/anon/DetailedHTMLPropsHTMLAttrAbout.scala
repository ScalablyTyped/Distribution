...
@js.native
trait DetailedHTMLPropsHTMLAttrAbout extends js.Object {
...
object DetailedHTMLPropsHTMLAttrAbout {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsHTMLAttrAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAbout]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsHTMLAttrAboutOps[Self <: DetailedHTMLPropsHTMLAttrAbout] (val x: Self) extends AnyVal {
