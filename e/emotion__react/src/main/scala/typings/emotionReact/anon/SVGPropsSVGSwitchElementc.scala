...
object SVGPropsSVGSwitchElementc {
  ...
  extension [Self <: SVGPropsSVGSwitchElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGSwitchElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGSwitchElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
