...
/* Inlined react.react.DetailedHTMLProps<react.react.MenuHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsMenuHTML extends js.Object {
...
object DetailedHTMLPropsMenuHTML {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsMenuHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsMenuHTML]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsMenuHTMLOps[Self <: DetailedHTMLPropsMenuHTML] (val x: Self) extends AnyVal {
