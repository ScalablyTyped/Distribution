...
object SVGPropsSVGTextElementcss {
  ...
  extension [Self <: SVGPropsSVGTextElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGTextElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGTextElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
