...
object SVGPropsSVGViewElementcss {
  ...
  extension [Self <: SVGPropsSVGViewElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGViewElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGViewElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
