...
/* Inlined react.react.SVGLineElementAttributes<std.SVGLineElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
trait SVGLineElementAttributesS extends StObject {
...
object SVGLineElementAttributesS {
  
  inline def apply(): SVGLineElementAttributesS = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGLineElementAttributesS]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGLineElementAttributesS] (val x: Self) extends AnyVal {
