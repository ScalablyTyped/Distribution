...
/* Inlined react.react.DetailedHTMLProps<react.react.BlockquoteHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsBlockquo extends js.Object {
...
object DetailedHTMLPropsBlockquo {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsBlockquo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsBlockquo]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsBlockquoOps[Self <: DetailedHTMLPropsBlockquo] (val x: Self) extends AnyVal {
