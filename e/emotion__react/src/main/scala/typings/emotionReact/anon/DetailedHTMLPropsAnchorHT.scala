...
/* Inlined react.react.DetailedHTMLProps<react.react.AnchorHTMLAttributes<std.HTMLAnchorElement>, std.HTMLAnchorElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsAnchorHT extends StObject {
...
object DetailedHTMLPropsAnchorHT {
  
  @scala.inline
  def apply(): DetailedHTMLPropsAnchorHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsAnchorHT]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsAnchorHTMutableBuilder[Self <: DetailedHTMLPropsAnchorHT] (val x: Self) extends AnyVal {
