...
object SVGPropsSVGFEFuncAElement {
  ...
  extension [Self <: SVGPropsSVGFEFuncAElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEFuncAElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEFuncAElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
