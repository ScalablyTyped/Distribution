...
object SVGPropsSVGFilterElementc {
  ...
  extension [Self <: SVGPropsSVGFilterElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFilterElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFilterElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
