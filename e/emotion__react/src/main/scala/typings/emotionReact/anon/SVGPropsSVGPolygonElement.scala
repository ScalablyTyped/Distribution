...
object SVGPropsSVGPolygonElement {
  ...
  extension [Self <: SVGPropsSVGPolygonElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGPolygonElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGPolygonElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
