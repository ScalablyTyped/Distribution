...
object SVGPropsSVGCircleElementc {
  ...
  extension [Self <: SVGPropsSVGCircleElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGCircleElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGCircleElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
