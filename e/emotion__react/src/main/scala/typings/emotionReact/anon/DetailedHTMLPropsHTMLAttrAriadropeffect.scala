...
object DetailedHTMLPropsHTMLAttrAriadropeffect {
  ...
  inline def apply(): DetailedHTMLPropsHTMLAttrAriadropeffect = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriadropeffect]
  }
  
  extension [Self <: DetailedHTMLPropsHTMLAttrAriadropeffect](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[HTMLUListElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[HTMLUListElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
    ...
    inline def setRefFunction1(value: /* instance */ HTMLUListElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
