...
object SVGPropsSVGRectElementcss {
  ...
  extension [Self <: SVGPropsSVGRectElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGRectElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGRectElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
