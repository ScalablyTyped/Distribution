...
object SVGPropsSVGFETileElementc {
  ...
  extension [Self <: SVGPropsSVGFETileElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFETileElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFETileElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
