...
object SVGPropsSVGTextPathElemen {
  ...
  extension [Self <: SVGPropsSVGTextPathElemen](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGTextPathElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGTextPathElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
