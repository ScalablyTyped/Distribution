...
/* Inlined react.react.DetailedHTMLProps<react.react.LabelHTMLAttributes<std.HTMLLabelElement>, std.HTMLLabelElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsLabelHTM extends js.Object {
...
object DetailedHTMLPropsLabelHTM {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsLabelHTM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsLabelHTM]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsLabelHTMOps[Self <: DetailedHTMLPropsLabelHTM] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLLabelElement | Null => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: LegacyRef[HTMLLabelElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
