...
object SVGPropsSVGLineElementcss {
  ...
  extension [Self <: SVGPropsSVGLineElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGLineElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGLineElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
