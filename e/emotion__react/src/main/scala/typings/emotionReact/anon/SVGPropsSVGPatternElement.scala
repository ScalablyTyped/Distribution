...
object SVGPropsSVGPatternElement {
  ...
  extension [Self <: SVGPropsSVGPatternElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGPatternElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGPatternElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
