...
object SVGPropsSVGFEBlendElement {
  ...
  extension [Self <: SVGPropsSVGFEBlendElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEBlendElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEBlendElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
