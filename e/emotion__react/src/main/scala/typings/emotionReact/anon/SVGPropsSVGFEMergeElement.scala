...
object SVGPropsSVGFEMergeElement {
  ...
  extension [Self <: SVGPropsSVGFEMergeElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEMergeElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEMergeElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
