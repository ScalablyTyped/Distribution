...
@js.native
trait DetailedHTMLPropsLiHTMLAt extends StObject {
...
object DetailedHTMLPropsLiHTMLAt {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsLiHTMLAtMutableBuilder[Self <: DetailedHTMLPropsLiHTMLAt] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLLIElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLLIElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
