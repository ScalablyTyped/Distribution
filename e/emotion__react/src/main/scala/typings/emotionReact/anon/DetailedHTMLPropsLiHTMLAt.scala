...
/* Inlined react.react.DetailedHTMLProps<react.react.LiHTMLAttributes<std.HTMLLIElement>, std.HTMLLIElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsLiHTMLAt extends js.Object {
...
object DetailedHTMLPropsLiHTMLAt {
  
  @scala.inline
  def apply(): DetailedHTMLPropsLiHTMLAt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsLiHTMLAt]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsLiHTMLAtOps[Self <: DetailedHTMLPropsLiHTMLAt] (val x: Self) extends AnyVal {
