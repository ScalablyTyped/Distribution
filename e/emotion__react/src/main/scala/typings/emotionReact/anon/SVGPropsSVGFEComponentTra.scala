...
object SVGPropsSVGFEComponentTra {
  ...
  extension [Self <: SVGPropsSVGFEComponentTra](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEComponentTransferElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEComponentTransferElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
