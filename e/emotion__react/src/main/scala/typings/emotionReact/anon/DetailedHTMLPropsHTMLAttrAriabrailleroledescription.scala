...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLHeadingElement>, std.HTMLHeadingElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
trait DetailedHTMLPropsHTMLAttrAriabrailleroledescription extends StObject {
...
object DetailedHTMLPropsHTMLAttrAriabrailleroledescription {
  
  inline def apply(): DetailedHTMLPropsHTMLAttrAriabrailleroledescription = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriabrailleroledescription]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAriabrailleroledescription] (val x: Self) extends AnyVal {
    ...
    inline def setRef(value: LegacyRef[HTMLHeadingElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ HTMLHeadingElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
