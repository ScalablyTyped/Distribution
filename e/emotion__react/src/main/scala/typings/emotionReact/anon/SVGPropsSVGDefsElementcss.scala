...
object SVGPropsSVGDefsElementcss {
  ...
  extension [Self <: SVGPropsSVGDefsElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGDefsElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGDefsElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
