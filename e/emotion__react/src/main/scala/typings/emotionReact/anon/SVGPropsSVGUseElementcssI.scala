...
object SVGPropsSVGUseElementcssI {
  ...
  extension [Self <: SVGPropsSVGUseElementcssI](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGUseElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGUseElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
