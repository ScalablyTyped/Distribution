...
object SVGPropsSVGMaskElementcss {
  ...
  extension [Self <: SVGPropsSVGMaskElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGMaskElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGMaskElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
