...
object SVGPropsSVGFEFuncBElement {
  ...
  extension [Self <: SVGPropsSVGFEFuncBElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEFuncBElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEFuncBElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
