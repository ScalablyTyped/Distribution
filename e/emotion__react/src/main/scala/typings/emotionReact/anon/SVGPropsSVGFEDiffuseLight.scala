...
object SVGPropsSVGFEDiffuseLight {
  ...
  extension [Self <: SVGPropsSVGFEDiffuseLight](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEDiffuseLightingElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEDiffuseLightingElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
