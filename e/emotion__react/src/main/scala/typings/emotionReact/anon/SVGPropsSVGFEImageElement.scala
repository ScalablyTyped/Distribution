...
object SVGPropsSVGFEImageElement {
  ...
  extension [Self <: SVGPropsSVGFEImageElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEImageElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEImageElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
