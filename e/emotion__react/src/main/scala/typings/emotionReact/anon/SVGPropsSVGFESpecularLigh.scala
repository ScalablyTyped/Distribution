...
object SVGPropsSVGFESpecularLigh {
  ...
  extension [Self <: SVGPropsSVGFESpecularLigh](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFESpecularLightingElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFESpecularLightingElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
