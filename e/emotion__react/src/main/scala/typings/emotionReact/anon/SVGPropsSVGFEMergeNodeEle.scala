...
object SVGPropsSVGFEMergeNodeEle {
  ...
  extension [Self <: SVGPropsSVGFEMergeNodeEle](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEMergeNodeElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEMergeNodeElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
