...
object SVGPropsSVGClipPathElemen {
  ...
  extension [Self <: SVGPropsSVGClipPathElemen](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGClipPathElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGClipPathElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
