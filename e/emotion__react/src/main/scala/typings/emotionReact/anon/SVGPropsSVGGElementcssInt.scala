...
object SVGPropsSVGGElementcssInt {
  ...
  extension [Self <: SVGPropsSVGGElementcssInt](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGGElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGGElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
