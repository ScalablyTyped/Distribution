...
object SVGPropsSVGPolylineElemen {
  ...
  extension [Self <: SVGPropsSVGPolylineElemen](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGPolylineElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGPolylineElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
