...
/* Inlined react.react.DetailedHTMLProps<react.react.DelHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsDelHTMLA extends js.Object {
...
object DetailedHTMLPropsDelHTMLA {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsDelHTMLA = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsDelHTMLA]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsDelHTMLAOps[Self <: DetailedHTMLPropsDelHTMLA] (val x: Self) extends AnyVal {
