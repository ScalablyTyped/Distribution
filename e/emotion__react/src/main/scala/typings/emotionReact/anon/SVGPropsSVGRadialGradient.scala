...
object SVGPropsSVGRadialGradient {
  ...
  extension [Self <: SVGPropsSVGRadialGradient](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGRadialGradientElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGRadialGradientElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
