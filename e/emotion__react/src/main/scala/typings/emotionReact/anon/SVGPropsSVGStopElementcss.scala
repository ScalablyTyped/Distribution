...
object SVGPropsSVGStopElementcss {
  ...
  extension [Self <: SVGPropsSVGStopElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGStopElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGStopElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
