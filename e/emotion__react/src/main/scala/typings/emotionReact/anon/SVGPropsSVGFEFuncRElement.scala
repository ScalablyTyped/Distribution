...
object SVGPropsSVGFEFuncRElement {
  ...
  extension [Self <: SVGPropsSVGFEFuncRElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEFuncRElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEFuncRElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
