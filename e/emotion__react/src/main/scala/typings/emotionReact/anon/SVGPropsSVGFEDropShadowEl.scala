...
object SVGPropsSVGFEDropShadowEl {
  ...
  extension [Self <: SVGPropsSVGFEDropShadowEl](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEDropShadowElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEDropShadowElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
