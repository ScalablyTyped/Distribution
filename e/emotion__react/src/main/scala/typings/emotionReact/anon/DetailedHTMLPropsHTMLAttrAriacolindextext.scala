...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLSpanElement>, std.HTMLSpanElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
trait DetailedHTMLPropsHTMLAttrAriacolindextext extends StObject {
...
object DetailedHTMLPropsHTMLAttrAriacolindextext {
  
  inline def apply(): DetailedHTMLPropsHTMLAttrAriacolindextext = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriacolindextext]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAriacolindextext] (val x: Self) extends AnyVal {
