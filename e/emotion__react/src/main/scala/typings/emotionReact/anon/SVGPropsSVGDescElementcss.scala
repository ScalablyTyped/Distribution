...
object SVGPropsSVGDescElementcss {
  ...
  extension [Self <: SVGPropsSVGDescElementcss](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGDescElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGDescElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
