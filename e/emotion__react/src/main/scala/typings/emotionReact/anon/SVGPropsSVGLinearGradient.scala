...
object SVGPropsSVGLinearGradient {
  ...
  extension [Self <: SVGPropsSVGLinearGradient](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGLinearGradientElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGLinearGradientElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
