...
/* Inlined react.react.DetailedHTMLProps<react.react.OutputHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsOutputHT extends js.Object {
  ...
  var ref: js.UndefOr[LegacyRef[HTMLElement]] = js.native
...
object DetailedHTMLPropsOutputHT {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsOutputHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsOutputHT]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsOutputHTOps[Self <: DetailedHTMLPropsOutputHT] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: LegacyRef[HTMLElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
