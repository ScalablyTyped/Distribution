...
object SVGPropsSVGImageElementcs {
  ...
  extension [Self <: SVGPropsSVGImageElementcs](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGImageElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGImageElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
