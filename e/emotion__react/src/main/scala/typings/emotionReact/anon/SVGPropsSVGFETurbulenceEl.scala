...
object SVGPropsSVGFETurbulenceEl {
  ...
  extension [Self <: SVGPropsSVGFETurbulenceEl](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFETurbulenceElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFETurbulenceElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
