...
object SVGPropsSVGEllipseElement {
  ...
  extension [Self <: SVGPropsSVGEllipseElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGEllipseElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGEllipseElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
