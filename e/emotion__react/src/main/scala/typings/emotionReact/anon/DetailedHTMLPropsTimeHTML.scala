...
/* Inlined react.react.DetailedHTMLProps<react.react.TimeHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsTimeHTML extends js.Object {
...
object DetailedHTMLPropsTimeHTML {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsTimeHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsTimeHTML]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsTimeHTMLOps[Self <: DetailedHTMLPropsTimeHTML] (val x: Self) extends AnyVal {
