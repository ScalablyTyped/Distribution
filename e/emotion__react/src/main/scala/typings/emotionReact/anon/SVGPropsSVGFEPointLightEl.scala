...
object SVGPropsSVGFEPointLightEl {
  ...
  extension [Self <: SVGPropsSVGFEPointLightEl](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEPointLightElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEPointLightElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
