...
object SVGPropsSVGMarkerElementc {
  ...
  extension [Self <: SVGPropsSVGMarkerElementc](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGMarkerElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGMarkerElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
