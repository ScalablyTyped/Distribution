...
object SVGPropsSVGFESpotLightEle {
  ...
  extension [Self <: SVGPropsSVGFESpotLightEle](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFESpotLightElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFESpotLightElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
