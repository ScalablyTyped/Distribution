...
object SVGPropsSVGFEDisplacement {
  ...
  extension [Self <: SVGPropsSVGFEDisplacement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEDisplacementMapElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEDisplacementMapElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
