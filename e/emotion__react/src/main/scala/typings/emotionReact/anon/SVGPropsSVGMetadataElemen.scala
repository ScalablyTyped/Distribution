...
object SVGPropsSVGMetadataElemen {
  ...
  extension [Self <: SVGPropsSVGMetadataElemen](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGMetadataElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGMetadataElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
