...
object SVGPropsSVGFEColorMatrixE {
  ...
  extension [Self <: SVGPropsSVGFEColorMatrixE](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEColorMatrixElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEColorMatrixElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
