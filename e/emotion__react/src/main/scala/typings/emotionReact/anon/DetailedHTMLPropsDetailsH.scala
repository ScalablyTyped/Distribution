...
/* Inlined react.react.DetailedHTMLProps<react.react.DetailsHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsDetailsH extends js.Object {
  ...
  var onToggle: js.UndefOr[ReactEventHandler[HTMLElement]] = js.native
...
object DetailedHTMLPropsDetailsH {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsDetailsH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsDetailsH]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsDetailsHOps[Self <: DetailedHTMLPropsDetailsH] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnToggle(value: SyntheticEvent[HTMLElement, Event] => Unit): Self = this.set("onToggle", js.Any.fromFunction1(value))
