...
trait DetailedHTMLPropsDetailsH extends StObject {
  ...
  var onToggle: js.UndefOr[ReactEventHandler[HTMLElement]] = js.undefined
...
object DetailedHTMLPropsDetailsH {
  ...
  @scala.inline
  implicit class DetailedHTMLPropsDetailsHMutableBuilder[Self <: DetailedHTMLPropsDetailsH] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnToggle(value: SyntheticEvent[HTMLElement, Event] => Unit): Self = StObject.set(x, "onToggle", js.Any.fromFunction1(value))
