...
object SVGPropsSVGForeignObjectE {
  ...
  extension [Self <: SVGPropsSVGForeignObjectE](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGForeignObjectElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGForeignObjectElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
