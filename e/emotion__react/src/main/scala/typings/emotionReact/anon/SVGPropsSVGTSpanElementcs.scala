...
object SVGPropsSVGTSpanElementcs {
  ...
  extension [Self <: SVGPropsSVGTSpanElementcs](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGTSpanElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGTSpanElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
