...
object SVGPropsSVGFEFloodElement {
  ...
  extension [Self <: SVGPropsSVGFEFloodElement](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEFloodElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEFloodElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
