...
object SVGPropsSVGFEConvolveMatr {
  ...
  extension [Self <: SVGPropsSVGFEConvolveMatr](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEConvolveMatrixElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEConvolveMatrixElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
