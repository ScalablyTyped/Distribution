...
object SVGPropsSVGFEOffsetElemen {
  ...
  extension [Self <: SVGPropsSVGFEOffsetElemen](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEOffsetElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEOffsetElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
