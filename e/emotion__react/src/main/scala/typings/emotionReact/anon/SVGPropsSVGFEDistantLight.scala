...
object SVGPropsSVGFEDistantLight {
  ...
  extension [Self <: SVGPropsSVGFEDistantLight](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEDistantLightElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEDistantLightElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
