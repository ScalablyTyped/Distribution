...
object SVGPropsSVGFEMorphologyEl {
  ...
  extension [Self <: SVGPropsSVGFEMorphologyEl](x: Self) {
    ...
    inline def setOnBlur(value: FocusEvent[SVGFEMorphologyElement] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
    ...
    inline def setOnFocus(value: FocusEvent[SVGFEMorphologyElement] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
