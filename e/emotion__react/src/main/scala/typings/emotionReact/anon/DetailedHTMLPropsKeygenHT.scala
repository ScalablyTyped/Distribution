...
/* Inlined react.react.DetailedHTMLProps<react.react.KeygenHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@emotion/serialize.@emotion/serialize.Interpolation<@emotion/react.@emotion/react.Theme> | undefined} */
@js.native
trait DetailedHTMLPropsKeygenHT extends js.Object {
...
object DetailedHTMLPropsKeygenHT {
  ...
  @scala.inline
  def apply(): DetailedHTMLPropsKeygenHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsKeygenHT]
  }
  
  @scala.inline
  implicit class DetailedHTMLPropsKeygenHTOps[Self <: DetailedHTMLPropsKeygenHT] (val x: Self) extends AnyVal {
