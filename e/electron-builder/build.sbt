...
version := "21.2.0-0a2f35"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "app-builder-lib" % "21.2.0-f2a8a2",
  "org.scalablytyped" %%% "builder-util" % "21.2.0-94515f",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.3.0-f653ec",
  "org.scalablytyped" %%% "debug" % "4.1-dt-20190808Z-3d3404",
  "org.scalablytyped" %%% "electron-publish" % "21.2.0-5fccbc",
  "org.scalablytyped" %%% "fs-extra" % "8.0-dt-20190626Z-106bdf",
