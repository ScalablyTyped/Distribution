...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "app-builder-lib" % "20.39.0-38b15d",
  "org.scalablytyped" %%% "bluebird" % "3.5-dt-20190225Z-cc7043",
  "org.scalablytyped" %%% "bluebird-lst" % "1.0.7-2ef8e1",
  "org.scalablytyped" %%% "builder-util" % "9.7.0-dcf79f",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.2.0-149475",
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.6.0-b60d15",
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-f82bc8",
  "org.scalablytyped" %%% "electron-publish" % "20.39.0-85fb98",
  ...
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-158ebc",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.2-1841c1",
  ...
  "org.scalablytyped" %%% "temp-file" % "3.3.2-2fd72b",
