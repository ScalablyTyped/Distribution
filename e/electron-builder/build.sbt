...
version := "21.2.0-f64fad"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "app-builder-lib" % "21.2.0-c53d6e",
  "org.scalablytyped" %%% "builder-util" % "21.2.0-53f2b8",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.3.0-989e53",
  "org.scalablytyped" %%% "debug" % "4.1-dt-20190808Z-ca3bb7",
  "org.scalablytyped" %%% "electron-publish" % "21.2.0-134725",
  "org.scalablytyped" %%% "fs-extra" % "8.0-dt-20191016Z-33accb",
