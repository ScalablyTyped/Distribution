...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.5.4-7609b1",
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-6bfa53",
  "org.scalablytyped" %%% "electron-publish" % "20.38.5-7f1f6f",
  ...
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-4ac946",
  ...
  "org.scalablytyped" %%% "plist" % "3.0-dt-20181029Z-3e5a9c",
  "org.scalablytyped" %%% "punycode" % "2.1-dt-20181205Z-2503b8",
  "org.scalablytyped" %%% "read-config-file" % "3.2.1-319619",
