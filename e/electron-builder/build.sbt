...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "app-builder-lib" % "20.38.5-19985d",
  "org.scalablytyped" %%% "bluebird" % "3.5-dt-20181213Z-ef7d03",
  "org.scalablytyped" %%% "bluebird-lst" % "1.0.6-053f79",
  "org.scalablytyped" %%% "builder-util" % "9.6.2-c38152",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.1.1-181043",
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.5.4-7738bc",
  "org.scalablytyped" %%% "dotenv" % "6.1-dt-20181101Z-8a2111",
  "org.scalablytyped" %%% "dotenv-expand" % "4.2.0-f94605",
  "org.scalablytyped" %%% "ejs" % "2.6-dt-20181126Z-54a509",
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-66d9fc",
  "org.scalablytyped" %%% "electron-publish" % "20.38.5-48151f",
  ...
  "org.scalablytyped" %%% "iconv-lite" % "0.4.24-75fe1d",
  "org.scalablytyped" %%% "is-ci" % "1.1-dt-20180416Z-0ebd09",
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-d036de",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.1-444369",
  ...
  "org.scalablytyped" %%% "temp-file" % "3.3.2-5fae2f",
