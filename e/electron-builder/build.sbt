...
version := "21.2.0-bd6e70"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "app-builder-lib" % "21.2.0-ccd81f",
  "org.scalablytyped" %%% "builder-util" % "21.2.0-2e78e2",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.3.0-dade91",
  "org.scalablytyped" %%% "debug" % "4.1-dt-20190808Z-3d3404",
  "org.scalablytyped" %%% "electron-publish" % "21.2.0-21de80",
  "org.scalablytyped" %%% "fs-extra" % "8.0-dt-20191016Z-6e8f3c",
