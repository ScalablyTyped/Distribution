...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "app-builder-lib" % "20.39.0-f5d45a",
  "org.scalablytyped" %%% "bluebird" % "3.5-dt-20190225Z-cc7043",
  "org.scalablytyped" %%% "bluebird-lst" % "1.0.7-2ef8e1",
  "org.scalablytyped" %%% "builder-util" % "9.7.0-d04eba",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.2.0-c068ff",
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.6.0-016800",
  "org.scalablytyped" %%% "dotenv" % "6.1-dt-20181101Z-463bfd",
  "org.scalablytyped" %%% "dotenv-expand" % "4.2.0-c07106",
  "org.scalablytyped" %%% "ejs" % "2.6-dt-20190223Z-c20989",
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-c07ce7",
  "org.scalablytyped" %%% "electron-publish" % "20.39.0-4758ac",
  ...
  "org.scalablytyped" %%% "fs-extra-p" % "7.0.1-31a050",
  "org.scalablytyped" %%% "hosted-git-info" % "2.7-dt-20181031Z-7f61fb",
  "org.scalablytyped" %%% "iconv-lite" % "0.4.24-d9658c",
  "org.scalablytyped" %%% "is-ci" % "1.1-dt-20180416Z-d085df",
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-ea4d14",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.2-f118c0",
  ...
  "org.scalablytyped" %%% "temp-file" % "3.3.2-915f71",
  ...
  "org.scalablytyped" %%% "yargs" % "12.0-dt-20190212Z-8083b9")
