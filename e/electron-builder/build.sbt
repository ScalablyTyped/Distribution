...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "app-builder-lib" % "20.38.5-4b3c7f",
  "org.scalablytyped" %%% "bluebird" % "3.5-dt-20181213Z-f01776",
  "org.scalablytyped" %%% "bluebird-lst" % "1.0.6-9deb1a",
  "org.scalablytyped" %%% "builder-util" % "9.6.2-6c60c2",
  "org.scalablytyped" %%% "builder-util-runtime" % "8.1.1-729301",
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.5.4-c5a91a",
  "org.scalablytyped" %%% "dotenv" % "6.1-dt-20181101Z-cbc2b6",
  "org.scalablytyped" %%% "dotenv-expand" % "4.2.0-bd88ec",
  "org.scalablytyped" %%% "ejs" % "2.6-dt-20190212Z-945834",
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-5bdf9d",
  "org.scalablytyped" %%% "electron-publish" % "20.38.5-0ed862",
  ...
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-1fffc5",
  ...
  "org.scalablytyped" %%% "plist" % "3.0-dt-20181029Z-50fd74",
  "org.scalablytyped" %%% "punycode" % "2.1-dt-20181205Z-0009b8",
  "org.scalablytyped" %%% "read-config-file" % "3.2.1-4bc188",
  ...
  "org.scalablytyped" %%% "temp-file" % "3.3.2-57d43f",
