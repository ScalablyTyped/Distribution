...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.5.4-6dacf1",
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-439ac0",
  "org.scalablytyped" %%% "electron-publish" % "20.38.5-2d32ee",
  ...
  "org.scalablytyped" %%% "isbinaryfile" % "4.0.0-312414",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.1-e2e630",
