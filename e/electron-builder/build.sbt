...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "dmg-builder" % "6.5.4-8ec62e",
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-a7a861",
  "org.scalablytyped" %%% "electron-publish" % "20.38.5-1299fa",
  ...
  "org.scalablytyped" %%% "iconv-lite" % "0.4.24-f95677",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.1-f9e8cc",
