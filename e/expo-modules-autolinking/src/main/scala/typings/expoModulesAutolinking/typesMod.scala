...
import typings.expoModulesAutolinking.expoModuleConfigMod.ExpoModuleConfig
...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.expoModulesAutolinking.typesMod.ModuleDescriptorAndroid
    - typings.expoModulesAutolinking.typesMod.ModuleDescriptorIos
  */
  trait ModuleDescriptor extends StObject
  object ModuleDescriptor {
    
    inline def ModuleDescriptorAndroid(modules: js.Array[String], packageName: String, projects: js.Array[ModuleAndroidProjectInfo]): typings.expoModulesAutolinking.typesMod.ModuleDescriptorAndroid = {
      ...
      __obj.asInstanceOf[typings.expoModulesAutolinking.typesMod.ModuleDescriptorAndroid]
    }
    ...
    inline def ModuleDescriptorIos(
      ...
      __obj.asInstanceOf[typings.expoModulesAutolinking.typesMod.ModuleDescriptorIos]
    }
  }
