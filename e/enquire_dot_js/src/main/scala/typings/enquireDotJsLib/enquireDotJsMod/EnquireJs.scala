...
trait EnquireJs extends js.Object {
  def register(mediaQuery: java.lang.String, options: enquireDotJsLib.Callback): EnquireJs = js.native
  def register(mediaQuery: java.lang.String, options: enquireDotJsLib.Callback, shouldDegrade: scala.Boolean): EnquireJs = js.native
  ...
  def unregister(mediaQuery: java.lang.String, handler: enquireDotJsLib.Callback): scala.Unit = js.native
