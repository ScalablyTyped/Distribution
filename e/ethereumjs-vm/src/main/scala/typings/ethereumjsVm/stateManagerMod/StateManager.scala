...
object StateManager {
  ...
  implicit class StateManagerOps[Self <: StateManager] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def set_cache(value: typings.ethereumjsVm.cacheMod.default): Self = this.set("_cache", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPutAccount(value: (Buffer, typings.ethereumjsAccount.mod.default, js.Any) => Unit): Self = this.set("putAccount", js.Any.fromFunction3(value))
