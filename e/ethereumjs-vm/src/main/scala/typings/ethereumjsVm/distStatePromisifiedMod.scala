...
import typings.ethereumjsVm.distStateStateManagerMod.StorageDump
...
object distStatePromisifiedMod {
  ...
  open class default protected ()
    extends StObject
       with PStateManager {
    def this(wrapped: typings.ethereumjsVm.distStateStateManagerMod.default) = this()
    
    /* CompleteClass */
    var _wrapped: typings.ethereumjsVm.distStateStateManagerMod.default = js.native
  ...
  trait PStateManager extends StObject {
    ...
    var _wrapped: typings.ethereumjsVm.distStateStateManagerMod.default
  ...
  object PStateManager {
    ...
    inline def apply(
      _wrapped: typings.ethereumjsVm.distStateStateManagerMod.default,
    ...
    implicit open class MutableBuilder[Self <: PStateManager] (val x: Self) extends AnyVal {
      ...
      inline def set_wrapped(value: typings.ethereumjsVm.distStateStateManagerMod.default): Self = StObject.set(x, "_wrapped", value.asInstanceOf[js.Any])
    }
  }
}
