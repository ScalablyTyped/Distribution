...
object distStateStateManagerMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var _cache: typings.ethereumjsVm.distStateCacheMod.default = js.native
  ...
  trait StateManager extends StObject {
    ...
    var _cache: typings.ethereumjsVm.distStateCacheMod.default
  ...
  object StateManager {
    ...
    inline def apply(
      _cache: typings.ethereumjsVm.distStateCacheMod.default,
    ...
    implicit open class MutableBuilder[Self <: StateManager] (val x: Self) extends AnyVal {
      ...
      inline def set_cache(value: typings.ethereumjsVm.distStateCacheMod.default): Self = StObject.set(x, "_cache", value.asInstanceOf[js.Any])
