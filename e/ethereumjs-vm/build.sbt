...
name := "ethereumjs-vm"
version := "4.2.0-65a44c"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.0",
  "org.scalablytyped" %%% "bn_dot_js" % "4.11-dt-20200515Z-c652d8",
  "org.scalablytyped" %%% "ethereumjs-account" % "3.0.0-5db47e",
  "org.scalablytyped" %%% "ethereumjs-blockchain" % "4.0.4-95c336",
  "org.scalablytyped" %%% "ethereumjs-common" % "1.5.2-df68f2",
  "org.scalablytyped" %%% "ethereumjs-tx" % "2.1.2-64e8b0",
