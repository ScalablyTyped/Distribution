...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ethereumjs-account" % "3.0.0-f613f6",
  "org.scalablytyped" %%% "ethereumjs-blockchain" % "4.0.4-c53c3f",
  "org.scalablytyped" %%% "ethereumjs-common" % "1.5.2-4e4dc6",
  "org.scalablytyped" %%% "ethereumjs-tx" % "2.1.2-314396",
