...
trait Taggable extends js.Object {
  ...
  def setTag(name: java.lang.String, value: TagValue): scala.Boolean
}

object Taggable {
  @scala.inline
  def apply(addTags: Tags => scala.Boolean, setTag: (java.lang.String, TagValue) => scala.Boolean): Taggable = {
