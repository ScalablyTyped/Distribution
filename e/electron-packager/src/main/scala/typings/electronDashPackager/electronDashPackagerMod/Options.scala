...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var arch: js.UndefOr[
    typings.electronDashPackager.electronDashPackagerMod.arch | js.Array[typings.electronDashPackager.electronDashPackagerMod.arch]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var platform: js.UndefOr[typings.electronDashPackager.electronDashPackagerMod.platform] = js.undefined
  /**
    * The path to a prebuilt ASAR file.
    */
  var prebuiltAsar: js.UndefOr[String] = js.undefined
  /** The URL protocol schemes the app supports. */
  var protocols: js.UndefOr[js.Array[Anon_Name]] = js.undefined
  /**
...
object Options {
  ...
  def apply(
    ...
    protocols: js.Array[Anon_Name] = null,
