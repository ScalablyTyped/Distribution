...
version := "17.1.1-37f044"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "debug" % "4.1-dt-20211202Z-03d2f5",
  "org.scalablytyped" %%% "electron__asar" % "3.2.1-e325bf",
  "org.scalablytyped" %%% "electron__notarize" % "1.2.3-ae468e",
  "org.scalablytyped" %%% "electron__osx-sign" % "1.0.1-c8723e",
