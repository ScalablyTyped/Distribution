...
version := "17.1.1-fbe4eb"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "debug" % "4.1-dt-20211202Z-00fd1d",
  "org.scalablytyped" %%% "electron__asar" % "3.2.1-0170cf",
  "org.scalablytyped" %%% "electron__notarize" % "1.2.3-2d5b2d",
  "org.scalablytyped" %%% "electron__osx-sign" % "1.0.1-8e54e4",
