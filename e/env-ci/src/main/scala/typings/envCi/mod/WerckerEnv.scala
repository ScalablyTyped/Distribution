...
object WerckerEnv {
  ...
  @scala.inline
  implicit class WerckerEnvOps[Self <: WerckerEnv] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: Wercker): Self = this.set("name", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRoot(value: String): Self = this.set("root", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setService(value: wercker_): Self = this.set("service", value.asInstanceOf[js.Any])
