...
| ------------------ | :-------------: |
| Full name          | env-ci |
| Keywords           | appveyor, bamboo, bitbucket, bitrise, buddy, buildkite, ci, circle, cirrus, codebuild, codefresh, codeship, drone, environment, git, gitlab, jenkins, sail, semaphore, shippable, teamcity, travis, variable, vsts, wercker |
| # releases         | 37 |
| # dependents       | 30 |
| # downloads        | 4905991 |
| # stars            | 0 |
