...
@js.native
class Model ()
  extends typings.emberDashData.emberDashDataMod.DS.Model
...
object Model extends js.Object {
  ...
  /**
    ...
    */
  def inverseFor[K /* <: String */](name: K, store: typings.emberDashData.emberDashDataMod.DS.Store): js.Object = js.native
  /**
    * For a given relationship name, returns the model type of the relationship.
    */
  def typeForRelationship[K /* <: String */](name: K, store: typings.emberDashData.emberDashDataMod.DS.Store): /* import warning: ImportType.apply Failed type conversion: ember-data.ember-data/types/registries/model.ModelRegistry[K] */ js.Any = js.native
}
