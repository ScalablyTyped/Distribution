...
class Store () extends js.Object {
  ...
  /**
    ...
    * `App.PersonAdapter`.
    */
  def adapterFor[K /* <: String */](modelName: K): /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify AdapterRegistry * / any[K] */ js.Any = js.native
  /**
    * Create a new record in the current store. The properties passed
    * to this method are set on the newly created record.
    */
  def createRecord[K /* <: String */](modelName: K): /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any = js.native
  def createRecord[K /* <: String */](modelName: K, inputProperties: js.Object): /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any = js.native
  /**
  ...
  def findRecord[K /* <: String */](modelName: K, id: String): (PromiseObject[
    /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any
  ]) with (/* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any) = js.native
  ...
  /**
    ...
    */
  def modelFor[K /* <: String */](modelName: K): /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any = js.native
  /**
  ...
  /**
    ...
    */
  def peekRecord[K /* <: String */](modelName: K, id: String): (/* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any) | Null = js.native
  def peekRecord[K /* <: String */](modelName: K, id: Double): (/* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ModelRegistry * / any[K] */ js.Any) | Null = js.native
  /**
  ...
  /**
    ...
    */
  def serializerFor[K /* <: String */](modelName: K): /* import warning: importer.ImportType#apply Failed type conversion: / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify SerializerRegistry * / any[K] */ js.Any = js.native
  /**
