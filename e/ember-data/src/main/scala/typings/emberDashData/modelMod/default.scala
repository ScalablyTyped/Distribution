package typings.emberDashData.modelMod
...
import typings.emberDashData.TypeofClassModelAttributes
...
import typings.emberDashData.emberDashDataMod.defaultNs.Model
