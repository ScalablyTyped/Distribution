...
object global {
  ...
  object Reflect {
    ...
    inline def enumerate(target: Any): IterableIteratorShim[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("enumerate")(target.asInstanceOf[js.Any]).asInstanceOf[IterableIteratorShim[Any]]
