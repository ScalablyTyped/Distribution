...
import typings.eggDashCore.Anon_PathType
...
class EggLoader[T, Config] protected () extends js.Object {
  ...
  var ContextLoader: typings.eggDashCore.eggDashCoreMod.ContextLoader = js.native
  var FileLoader: typings.eggDashCore.eggDashCoreMod.FileLoader = js.native
  var app: T = js.native
  ...
  /**
    ...
    * @since 1.0.0
    */
  def getLoadUnits(): js.Array[Anon_PathType] = js.native
