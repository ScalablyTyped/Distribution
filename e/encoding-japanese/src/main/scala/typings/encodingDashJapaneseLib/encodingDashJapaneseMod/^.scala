...
object ^ extends js.Object {
  ...
  def convert(data: RawType, options: ConvertOptions): java.lang.String | stdLib.ArrayBuffer | js.Array[scala.Double] = js.native
  def convert(data: RawType, to: Encoding): js.Array[scala.Double] = js.native
  def convert(data: RawType, to: Encoding, from: Encoding): js.Array[scala.Double] = js.native
