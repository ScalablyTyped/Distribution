...
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.AddOptions
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.EventData
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.EventDefinition
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.EventType
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.Listener
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.Mode
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.PickEvent
import typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTarget.RemoveOptions
