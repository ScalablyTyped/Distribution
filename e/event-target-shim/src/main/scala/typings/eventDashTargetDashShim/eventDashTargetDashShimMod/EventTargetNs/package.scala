...
package object EventTargetNs {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTargetNs.NonStandardEvent
    - (typings.std.Pick[
  ...
  typings.std.Exclude[
    ...
    typings.eventDashTargetDashShim.eventDashTargetDashShimMod.EventTargetNs.OmittableEventKeys
