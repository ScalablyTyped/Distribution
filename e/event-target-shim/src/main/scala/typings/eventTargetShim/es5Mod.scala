...
import typings.eventTargetShim.anon.PartialOmitEventstringtyp
...
object es5Mod {
  ...
  object defineEventAttribute {
    ...
    {[ P in string & keyof TEventMap as 'on${P}' ]: event-target-shim.event-target-shim/es5.EventTarget.CallbackFunction<TEventTarget, TEventMap[P]> | null}
