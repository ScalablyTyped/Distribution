...
object anon {
  ...
  object PartialPickEventOmittable {
    ...
    inline def apply[TEvents /* <: EventDefinition */](): PartialPickEventOmittable[TEvents] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialPickEventOmittable[TEvents]]
    }
    
    extension [Self <: PartialPickEventOmittable[?], TEvents /* <: EventDefinition */](x: Self & PartialPickEventOmittable[TEvents]) {
      ...
      inline def setComposedPath(value: () => js.Array[EventTargetstandardAddEventListener[TEvents]]): Self = StObject.set(x, "composedPath", js.Any.fromFunction0(value))
      ...
      inline def setCurrentTarget(value: EventTargetstandardAddEventListener[TEvents]): Self = StObject.set(x, "currentTarget", value.asInstanceOf[js.Any])
      ...
      inline def setSrcElement(value: js.Any): Self = StObject.set(x, "srcElement", value.asInstanceOf[js.Any])
      ...
      inline def setTarget(value: EventTargetstandardAddEventListener[TEvents]): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
