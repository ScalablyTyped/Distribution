...
object mod {
  ...
  object EventTarget {
    ...
    type EventData[TEventMap /* <: Record[String, Event[String]] */, TMode /* <: standard | strict */, TEventType /* <: String */] = ExplicitType[TEventType] & (Omit[
      ...
      ]) & (/* import warning: importer.ImportType#apply Failed type conversion: / * Inlined std.Partial<std.Omit<event-target-shim.event-target-shim.Event<string>, 'type'>> * /
    {  target :(): event-target-shim.event-target-shim.EventTarget<std.Record<string, event-target-shim.event-target-shim.Event<string>>, 'standard'> | null | undefined,   eventPhase :(): number | undefined,   composed :(): boolean | undefined,   CAPTURING_PHASE :(): number | undefined,   stopImmediatePropagation :(): void | undefined,   timeStamp :(): number | undefined,   stopPropagation :(): void | undefined,   defaultPrevented :(): boolean | undefined,   AT_TARGET :(): number | undefined,   NONE :(): number | undefined,   cancelable :(): boolean | undefined,   returnValue :(): boolean | undefined,   isTrusted :(): boolean | undefined,   constructor :(type : string, eventInitDict : event-target-shim.event-target-shim.Event.EventInit | undefined) | undefined,   bubbles :(): boolean | undefined,   initEvent :(type : string, bubbles : boolean | undefined, cancelable : boolean | undefined): void | undefined,   srcElement :(): event-target-shim.event-target-shim.EventTarget<std.Record<string, event-target-shim.event-target-shim.Event<string>>, 'standard'> | null | undefined,   preventDefault :(): void | undefined,   cancelBubble :(): boolean | undefined,   composedPath :(): std.Array<event-target-shim.event-target-shim.EventTarget<std.Record<string, event-target-shim.event-target-shim.Event<string>>, 'standard'>> | undefined,   currentTarget :(): event-target-shim.event-target-shim.EventTarget<std.Record<string, event-target-shim.event-target-shim.Event<string>>, 'standard'> | null | undefined,   BUBBLING_PHASE :(): number | undefined} */ js.Any)
