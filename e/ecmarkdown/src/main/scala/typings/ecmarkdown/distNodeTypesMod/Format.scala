...
/* Rewritten from type alias, can be one of: 
  - typings.ecmarkdown.ecmarkdownStrings.star
  - typings.ecmarkdown.ecmarkdownStrings.underscore
  - typings.ecmarkdown.ecmarkdownStrings.tick
  - typings.ecmarkdown.ecmarkdownStrings.pipe
  - typings.ecmarkdown.ecmarkdownStrings.tilde
*/
