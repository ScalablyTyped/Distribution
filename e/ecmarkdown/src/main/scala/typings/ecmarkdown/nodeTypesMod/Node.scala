...
object Node {
  ...
  @scala.inline
  def AlgorithmNode(contents: OrderedListNode, location: LocationRange): typings.ecmarkdown.nodeTypesMod.AlgorithmNode = {
  ...
  @scala.inline
  def OrderedListItemNode(contents: js.Array[FragmentNode], location: LocationRange): typings.ecmarkdown.nodeTypesMod.OrderedListItemNode = {
  ...
  @scala.inline
  def UnorderedListItemNode(contents: js.Array[FragmentNode], location: LocationRange): typings.ecmarkdown.nodeTypesMod.UnorderedListItemNode = {
