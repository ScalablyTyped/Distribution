...
object ecmarkdownStrings {
  ...
  @js.native
  sealed trait opaqueTag extends js.Object
  
  @js.native
  sealed trait `ordered-list-item` extends js.Object
  
  @js.native
  sealed trait parabreak extends js.Object
  ...
  @js.native
  sealed trait `unordered-list-item` extends js.Object
  ...
  @scala.inline
  def opaqueTag: opaqueTag = "opaqueTag".asInstanceOf[opaqueTag]
  @scala.inline
