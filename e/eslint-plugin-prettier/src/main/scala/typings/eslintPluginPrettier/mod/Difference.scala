package typings.eslintPluginPrettier.mod

import typings.eslintPluginPrettier.eslintPluginPrettierStrings.delete
import typings.eslintPluginPrettier.eslintPluginPrettierStrings.insert
import typings.eslintPluginPrettier.eslintPluginPrettierStrings.replace
