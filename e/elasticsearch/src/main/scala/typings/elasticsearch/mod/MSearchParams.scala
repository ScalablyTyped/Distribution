...
object MSearchParams {
  ...
  def apply(
    ...
    index: NameList = null,
    maxConcurrentSearches: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(maxConcurrentSearches)) __obj.updateDynamic("maxConcurrentSearches")(maxConcurrentSearches.get.asInstanceOf[js.Any])
