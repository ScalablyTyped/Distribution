...
class Client protected () extends StObject {
  ...
  def bulk(params: BulkIndexDocumentsParams): js.Promise[js.Any] = js.native
  def bulk(
  ...
  def clearScroll(params: ClearScrollParams): js.Promise[js.Any] = js.native
  ...
  def deleteScript(params: DeleteScriptParams): js.Promise[js.Any] = js.native
  def deleteScript(
    params: DeleteScriptParams,
    callback: js.Function2[/* error */ js.Any, /* response */ js.Any, Unit]
  ): Unit = js.native
  
  def deleteTemplate(params: DeleteTemplateParams): js.Promise[js.Any] = js.native
  def deleteTemplate(
  ...
  def info(params: InfoParams): js.Promise[js.Any] = js.native
  ...
  def mtermvectors(params: MTermVectorsParams): js.Promise[js.Any] = js.native
  def mtermvectors(
  ...
  def ping(params: PingParams): js.Promise[js.Any] = js.native
  def ping(
    params: PingParams,
    callback: js.Function3[/* err */ js.Any, /* response */ js.Any, /* status */ js.Any, Unit]
  ): Unit = js.native
  
  def putScript(params: PutScriptParams): js.Promise[js.Any] = js.native
  def putScript(
    params: PutScriptParams,
    callback: js.Function3[/* err */ js.Any, /* response */ js.Any, /* status */ js.Any, Unit]
  ): Unit = js.native
  
  def putTemplate(params: PutTemplateParams): js.Promise[js.Any] = js.native
  def putTemplate(
  ...
  def reindexRethrottle(params: ReindexRethrottleParams): js.Promise[js.Any] = js.native
  def reindexRethrottle(
    params: ReindexRethrottleParams,
    callback: js.Function2[/* error */ js.Any, /* response */ js.Any, Unit]
  ): Unit = js.native
  
  def renderSearchTemplate(params: RenderSearchTemplateParams): js.Promise[js.Any] = js.native
  ...
  def searchTemplate(params: SearchTemplateParams): js.Promise[js.Any] = js.native
  def searchTemplate(
  ...
  def suggest(params: SuggestParams): js.Promise[js.Any] = js.native
  ...
  def termvectors(params: TermvectorsParams): js.Promise[js.Any] = js.native
  def termvectors(params: TermvectorsParams, callback: js.Function2[/* error */ js.Any, /* response */ js.Any, Unit]): Unit = js.native
  
  def update(params: UpdateDocumentParams): js.Promise[js.Any] = js.native
  def update(
