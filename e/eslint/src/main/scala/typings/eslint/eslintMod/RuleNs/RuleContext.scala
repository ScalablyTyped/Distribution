...
import typings.eslint.eslintMod.ScopeNs.Scope
import typings.eslint.eslintMod.ScopeNs.Variable
import typings.eslint.eslintMod.SourceCode
import typings.eslint.eslintMod.SourceCodeNs.ParserServices
