...
trait Scope extends js.Object {
  var block: Node
  var childScopes: js.Array[typings.eslint.mod.Scope.Scope]
  ...
  var upper: typings.eslint.mod.Scope.Scope | Null
  var variableScope: typings.eslint.mod.Scope.Scope
...
object Scope {
  ...
  def apply(
    ...
    upper: typings.eslint.mod.Scope.Scope = null
  ): Scope = {
