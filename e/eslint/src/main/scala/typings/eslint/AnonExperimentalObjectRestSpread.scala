...
trait AnonExperimentalObjectRestSpread
...
object AnonExperimentalObjectRestSpread {
  @scala.inline
  def apply(
  ...
  ): AnonExperimentalObjectRestSpread = {
    ...
    __obj.asInstanceOf[AnonExperimentalObjectRestSpread]
  }
}
