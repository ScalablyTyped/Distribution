...
object RSVP extends js.Object {
  ...
  ): js.Function1[/* arg1 */ A, typings.rsvp.mod.RSVP.Promise[^  with TopLevel[js.Any]]] = js.native
  ...
  def map[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U], label: java.lang.String): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon8] = js.native
