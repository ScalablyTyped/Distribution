...
object RSVP extends js.Object {
  ...
  ): js.Function1[/* arg1 */ A, typings.rsvp.mod.RSVP.Promise[^  with js.Any]] = js.native
  ...
  def map[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U]): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon1] = js.native
  def map[T, U](entries: js.Array[Arg[T]], mapFn: js.Function1[/* item */ T, U], label: java.lang.String): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon1] = js.native
  def map[T1, T2, U](entries: js.Tuple2[Arg[T1], Arg[T2]], mapFn: js.Function1[/* item */ T1 | T2, U]): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon2] = js.native
  def map[T1, T2, U](
    entries: js.Tuple2[Arg[T1], Arg[T2]],
    mapFn: js.Function1[/* item */ T1 | T2, U],
    label: java.lang.String
  ): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon2] = js.native
  def map[T1, T2, T3, U](entries: js.Tuple3[Arg[T1], Arg[T2], Arg[T3]], mapFn: js.Function1[/* item */ T1 | T2 | T3, U]): typings.rsvp.mod.RSVP.Promise[js.Array[U] with Anon3] = js.native
  def map[T1, T2, T3, U](
    entries: js.Tuple3[Arg[T1], Arg[T2], Arg[T3]],
