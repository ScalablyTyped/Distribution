...
object Test extends js.Object {
  ...
  class Promise[T] protected ()
    extends typings.ember.emberMod.Ember.Test.Promise[T] {
  ...
  /**
    ...
    * is called.
    */
  def onInjectHelpers(callback: js.Function1[/* app */ typings.ember.emberMod.Ember.Application, Unit]): Unit = js.native
  /**
