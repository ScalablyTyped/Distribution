...
object LocationTaskOptions {
  ...
  def apply(
    ...
    if (foregroundService != null) __obj.updateDynamic("foregroundService")(foregroundService)
    if (!js.isUndefined(pausesUpdatesAutomatically)) __obj.updateDynamic("pausesUpdatesAutomatically")(pausesUpdatesAutomatically)
    if (!js.isUndefined(showsBackgroundLocationIndicator)) __obj.updateDynamic("showsBackgroundLocationIndicator")(showsBackgroundLocationIndicator)
