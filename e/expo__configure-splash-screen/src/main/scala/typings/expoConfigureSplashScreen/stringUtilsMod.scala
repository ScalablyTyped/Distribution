...
object stringUtilsMod {
  ...
  inline def insert(content: String, hasInsertContentInsertPattern: InsertContent): js.Tuple2[Boolean, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(content.asInstanceOf[js.Any], hasInsertContentInsertPattern.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[Boolean, String]]
  ...
  inline def replace(content: String, hasReplaceContentReplacePattern: ReplaceContent): js.Tuple2[Boolean, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("replace")(content.asInstanceOf[js.Any], hasReplaceContentReplacePattern.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[Boolean, String]]
}
