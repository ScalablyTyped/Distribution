...
object validatorsMod {
  ...
  inline def validateAndroidConfig(config: AndroidSplashScreenConfigJSON): js.Promise[AndroidSplashScreenConfig] = ^.asInstanceOf[js.Dynamic].applyDynamic("validateAndroidConfig")(config.asInstanceOf[js.Any]).asInstanceOf[js.Promise[AndroidSplashScreenConfig]]
  ...
  inline def validateIosConfig(config: IosSplashScreenConfigJSON): js.Promise[IosSplashScreenConfig] = ^.asInstanceOf[js.Dynamic].applyDynamic("validateIosConfig")(config.asInstanceOf[js.Any]).asInstanceOf[js.Promise[IosSplashScreenConfig]]
}
