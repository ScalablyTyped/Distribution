...
object utilsMod {
  ...
  inline def ensurePropertyExists[T /* <: js.Object */, TK1 /* <: NonPrimitiveAndNonArrayKeys[DeepRequired[T]] */, TK2 /* <: NonPrimitiveAndNonArrayKeys[
  ...
  inline def generateValidateEnumValue[T /* <: Record[String, String] */](availableValues: T): js.Function1[
    /* value */ String, 
  ...
  inline def validateColor(value: String): Color = ^.asInstanceOf[js.Dynamic].applyDynamic("validateColor")(value.asInstanceOf[js.Any]).asInstanceOf[Color]
  ...
  inline def validateFileExists(filePath: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("validateFileExists")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  
  inline def validateFileIsPng(filePath: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("validateFileIsPng")(filePath.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
}
