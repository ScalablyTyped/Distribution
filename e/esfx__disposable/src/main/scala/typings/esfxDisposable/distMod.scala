...
object distMod {
  ...
  object AsyncDisposable {
    ...
    /**
      ...
      */
    @scala.inline
    def create(dispose: js.Function0[Unit | js.Thenable[Unit]]): AsyncDisposable = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(dispose.asInstanceOf[js.Any]).asInstanceOf[AsyncDisposable]
    ...
    /**
      ...
      */
    @scala.inline
    def from(resources: Iterable[js.UndefOr[AsyncDisposable | Disposable | Null]]): AsyncDisposable = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(resources.asInstanceOf[js.Any]).asInstanceOf[AsyncDisposable]
  ...
  object Disposable {
    ...
    /**
      ...
      */
    @scala.inline
    def create(dispose: js.Function0[Unit]): Disposable = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(dispose.asInstanceOf[js.Any]).asInstanceOf[Disposable]
    ...
    /**
      ...
      */
    @scala.inline
    def from(disposables: Iterable[js.UndefOr[Disposable | Null]]): Disposable = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(disposables.asInstanceOf[js.Any]).asInstanceOf[Disposable]
    ...
    /**
      ...
      */
    @scala.inline
    def use[T /* <: js.UndefOr[Disposable | Null] */, U](resource: T, callback: js.Function1[/* resource */ T, U]): U = (^.asInstanceOf[js.Dynamic].applyDynamic("use")(resource.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[U]
  }
}
