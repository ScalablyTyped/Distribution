...
trait EmscriptenModule extends js.Object {
  ...
  var environment: emscriptenLib.EmscriptenNs.EnvironmentType = js.native
  ...
  def instantiateWasm(
    imports: emscriptenLib.EmscriptenNs.WebAssemblyImports,
    successCallback: js.Function1[/* module */ emscriptenLib.WebAssemblyNs.Module, scala.Unit]
  ): emscriptenLib.EmscriptenNs.WebAssemblyExports = js.native
  // Tools
