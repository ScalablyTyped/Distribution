...
trait Request
  ...
  def range(size: scala.Double): js.UndefOr[
    rangeDashParserLib.rangeDashParserMod.RangeParserNs.Ranges | rangeDashParserLib.rangeDashParserMod.RangeParserNs.Result
  ] = js.native
  /**
       * Parse Range header field, capping to the given `size`.
       *
       ...
       *
       */
  def range(size: scala.Double, options: rangeDashParserLib.rangeDashParserMod.RangeParserNs.Options): js.UndefOr[
    rangeDashParserLib.rangeDashParserMod.RangeParserNs.Ranges | rangeDashParserLib.rangeDashParserMod.RangeParserNs.Result
  ] = js.native
}
