...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.electronAsar.electronAsarStrings.directory
    - typings.electronAsar.electronAsarStrings.file
    - typings.electronAsar.electronAsarStrings.link
  */
  trait InputMetadataType extends StObject
  object InputMetadataType {
    
    inline def directory: typings.electronAsar.electronAsarStrings.directory = "directory".asInstanceOf[typings.electronAsar.electronAsarStrings.directory]
    
    inline def file: typings.electronAsar.electronAsarStrings.file = "file".asInstanceOf[typings.electronAsar.electronAsarStrings.file]
    
    inline def link: typings.electronAsar.electronAsarStrings.link = "link".asInstanceOf[typings.electronAsar.electronAsarStrings.link]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.electronAsar.mod.DirectoryMetadata
    - typings.electronAsar.mod.FileMetadata
    - typings.electronAsar.mod.LinkMetadata
  */
  trait Metadata extends StObject
  object Metadata {
    
    inline def DirectoryMetadata(files: StringDictionary[EntryMetadata], unpacked: Boolean): typings.electronAsar.mod.DirectoryMetadata = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronAsar.mod.DirectoryMetadata]
    }
    
    inline def FileMetadata(unpacked: Boolean): typings.electronAsar.mod.FileMetadata = {
      val __obj = js.Dynamic.literal(unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronAsar.mod.FileMetadata]
    }
    
    inline def LinkMetadata(link: String): typings.electronAsar.mod.LinkMetadata = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronAsar.mod.LinkMetadata]
    }
  }
}
