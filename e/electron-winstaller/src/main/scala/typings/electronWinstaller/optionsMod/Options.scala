...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(fixUpPaths)) __obj.updateDynamic("fixUpPaths")(fixUpPaths.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(noDelta)) __obj.updateDynamic("noDelta")(noDelta.get.asInstanceOf[js.Any])
    if (!js.isUndefined(noMsi)) __obj.updateDynamic("noMsi")(noMsi.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(skipUpdateIcon)) __obj.updateDynamic("skipUpdateIcon")(skipUpdateIcon.get.asInstanceOf[js.Any])
