...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(fixUpPaths)) __obj.updateDynamic("fixUpPaths")(fixUpPaths)
    ...
    if (!js.isUndefined(skipUpdateIcon)) __obj.updateDynamic("skipUpdateIcon")(skipUpdateIcon)
