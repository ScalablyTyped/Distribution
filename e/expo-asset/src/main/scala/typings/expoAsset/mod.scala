...
import typings.expoAsset.assetSourcesMod.AssetMetadata
...
object mod {
  ...
  inline def useAssets(moduleIds: js.Array[Double]): js.Tuple2[js.UndefOr[js.Array[typings.expoAsset.assetMod.Asset]], js.UndefOr[js.Error]] = ^.asInstanceOf[js.Dynamic].applyDynamic("useAssets")(moduleIds.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[js.UndefOr[js.Array[typings.expoAsset.assetMod.Asset]], js.UndefOr[js.Error]]]
  inline def useAssets(moduleIds: Double): js.Tuple2[js.UndefOr[js.Array[typings.expoAsset.assetMod.Asset]], js.UndefOr[js.Error]] = ^.asInstanceOf[js.Dynamic].applyDynamic("useAssets")(moduleIds.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[js.UndefOr[js.Array[typings.expoAsset.assetMod.Asset]], js.UndefOr[js.Error]]]
}
