...
name := "egg-mock"
version := "3.x-dt-20181017Z-49f8dd"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.20.1-bb44a8",
  "org.scalablytyped" %%% "egg-cookies" % "2.2.6-23ecf5",
  "org.scalablytyped" %%% "egg-core" % "4.15.0-cf9c51",
  "org.scalablytyped" %%% "egg-logger" % "2.3.2-b0b337",
  "org.scalablytyped" %%% "egg-view" % "2.1.2-290a04",
  ...
  "org.scalablytyped" %%% "koa-bodyparser" % "4.2-dt-20190212Z-3227e6",
  ...
  "org.scalablytyped" %%% "on-finished" % "2.3-dt-20180214Z-285b72",
