...
name := "egg-mock"
version := "3.x-dt-20190327Z-7122b8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.26.0-ea0592",
  "org.scalablytyped" %%% "egg-cookies" % "2.3.0-06e518",
  "org.scalablytyped" %%% "egg-core" % "4.17.4-326a01",
  ...
  "org.scalablytyped" %%% "urllib" % "2.34.1-cbbfdf")
