...
name := "egg-mock"
version := "3.x-dt-20200304Z-9615d9"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.26.0-056daf",
  "org.scalablytyped" %%% "egg-cookies" % "2.3.2-412e73",
  "org.scalablytyped" %%% "egg-core" % "4.17.4-486bb6",
  ...
  "org.scalablytyped" %%% "urllib" % "2.34.2-ed06e1")
