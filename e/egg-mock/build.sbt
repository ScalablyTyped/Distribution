...
name := "egg-mock"
version := "3.x-dt-20201028Z-35bc22"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.29.1-d6846e",
  "org.scalablytyped" %%% "egg-cookies" % "2.4.2-552fdf",
  "org.scalablytyped" %%% "egg-core" % "4.20.0-a33554",
  ...
  "org.scalablytyped" %%% "urllib" % "2.36.1-9838fb")
