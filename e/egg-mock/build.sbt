...
name := "egg-mock"
version := "3.x-dt-20190327Z-5eaf6d"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.26.0-1ad4d6",
  "org.scalablytyped" %%% "egg-cookies" % "2.3.0-3658ed",
  "org.scalablytyped" %%% "egg-core" % "4.17.4-99ce58",
  ...
  "org.scalablytyped" %%% "urllib" % "2.34.2-c6f60a")
