...
name := "egg-mock"
version := "3.x-dt-20200515Z-b5c94e"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.26.1-cf989c",
  "org.scalablytyped" %%% "egg-cookies" % "2.3.3-518d96",
  "org.scalablytyped" %%% "egg-core" % "4.17.4-abda2f",
  ...
  "org.scalablytyped" %%% "urllib" % "2.35.0-a40579")
