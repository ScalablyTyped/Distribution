...
name := "egg-mock"
version := "3.x-dt-20200515Z-992c24"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.27.0-2a041d",
  "org.scalablytyped" %%% "egg-cookies" % "2.4.2-0607aa",
  "org.scalablytyped" %%% "egg-core" % "4.17.4-23a1d0",
  ...
  "org.scalablytyped" %%% "urllib" % "2.36.1-41fcb4")
