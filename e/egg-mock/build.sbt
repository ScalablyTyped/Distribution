...
name := "egg-mock"
version := "3.x-dt-20201028Z-ef371a"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "egg" % "2.29.1-92c59e",
  "org.scalablytyped" %%% "egg-cookies" % "2.4.2-daded9",
  "org.scalablytyped" %%% "egg-core" % "4.20.0-c72332",
  ...
  "org.scalablytyped" %%% "urllib" % "2.36.1-d86cb4")
