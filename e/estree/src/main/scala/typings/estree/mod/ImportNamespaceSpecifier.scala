...
object ImportNamespaceSpecifier {
  ...
  @scala.inline
  implicit class ImportNamespaceSpecifierOps[Self <: ImportNamespaceSpecifier] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setType(value: typings.estree.estreeStrings.ImportNamespaceSpecifier): Self = this.set("type", value.asInstanceOf[js.Any])
  }
