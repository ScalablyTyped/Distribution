...
class HistogramFacet protected () extends Facet {
  ...
  /*
    ...
    */
  def cacheFilter(trueFalse: scala.Boolean): HistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def field(fieldName: java.lang.String): HistogramFacet = js.native
  /*
    ...
    of 1000.
    */
  def from(from: stdLib.Number): HistogramFacet = js.native
  /*
    Computes values across the entire index
    */
  def global(trueFalse: scala.Boolean): HistogramFacet = js.native
  /*
    Sets the bucket interval used to calculate the distribution.
    */
  def interval(numericInterval: stdLib.Number): HistogramFacet = js.native
  /*
    Allows you to specify a different key field to be used to group intervals.
    */
  def keyField(fieldName: java.lang.String): HistogramFacet = js.native
  /*
    Allows you modify the key field using a script. The modified value
    is then used to generate the interval.
    */
  def keyScript(scriptCode: java.lang.String): HistogramFacet = js.native
  /*
    The script language being used. Currently supported values are
    javascript, groovy, and mvel.
    */
  def lang(language: java.lang.String): HistogramFacet = js.native
  /*
    Sets the mode the facet will use.
    collector
    post
    */
  def mode(m: java.lang.String): HistogramFacet = js.native
  /*
    Sets the path to the nested document if faceting against a
    nested field.
    */
  def nested(path: java.lang.String): HistogramFacet = js.native
  /*
    ...
    */
  def order(o: java.lang.String): HistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def scope(scope: java.lang.String): HistogramFacet = js.native
  /*
    Sets the bucket interval used to calculate the distribution based
    on a time value such as "1d", "1w", etc.
    */
  def timeInterval(timeInterval: stdLib.Number): HistogramFacet = js.native
  /*
    ...
    of 1000.
    */
  def to(to: stdLib.Number): HistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def valueField(fieldName: java.lang.String): HistogramFacet = js.native
  /*
    Allows you modify the value field using a script. The modified value
    is then used to compute the statistical data.
    */
  def valueScript(scriptCode: java.lang.String): HistogramFacet = js.native
}
