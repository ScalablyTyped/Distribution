...
class GeoDistanceFilter protected () extends Filter {
  ...
  /*
    ...
    */
  def cache(trueFalse: scala.Boolean): GeoDistanceFilter = js.native
  /*
    Sets the cache key.
    */
  def cacheKey(key: java.lang.String): GeoDistanceFilter = js.native
  /*
    ...
    */
  def distance(numericDistance: stdLib.Number): GeoDistanceFilter = js.native
  /*
    How to compute the distance. Can either be arc (better precision)
    or plane (faster). Defaults to arc.
    */
  def distanceType(`type`: java.lang.String): GeoDistanceFilter = js.native
  /*
    Sets the fields to filter against.
    */
  def field(f: java.lang.String): GeoDistanceFilter = js.native
  /*
    Sets the filter name.
    */
  def name(name: java.lang.String): GeoDistanceFilter = js.native
  /*
    ...
    */
  def normalize(trueFalse: java.lang.String): GeoDistanceFilter = js.native
  /*
    ...
    */
  def optimizeBbox(t: java.lang.String): GeoDistanceFilter = js.native
  /*
  ...
  /*
    ...
    */
  def unit(unit: java.lang.String): GeoDistanceFilter = js.native
}
