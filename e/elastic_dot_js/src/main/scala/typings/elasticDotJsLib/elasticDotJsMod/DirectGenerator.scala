...
class DirectGenerator () extends Generator {
  ...
  /*
    ...
    */
  def preFilter(analyzer: java.lang.String): DirectGenerator = js.native
  /*
    Sets the number of suggestions returned for each token.
    */
  def size(s: scala.Double): DirectGenerator = js.native
  /*
    ...
    */
  def sort(s: java.lang.String): DirectGenerator = js.native
  /*
    ...
    */
  def stringDistance(s: java.lang.String): DirectGenerator = js.native
  /*
    ...
    */
  def suggestMode(m: java.lang.String): DirectGenerator = js.native
  /*
