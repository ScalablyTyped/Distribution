...
class DecayScoreFunction protected () extends ScoreFunction {
  ...
  /*
    ...
    given at scale.
    */
  def decay(d: scala.Double): DecayScoreFunction = js.native
  /*
  ...
  /*
    ...
    */
  def field(f: java.lang.String): DecayScoreFunction = js.native
  /*
  ...
  /*
    ...
    The default is 0.
    */
  def offset(o: java.lang.String): DecayScoreFunction = js.native
  /*
    Sets the origin which is the “central point” from which the distance is
    calculated.
    */
  def origin(o: java.lang.String): DecayScoreFunction = js.native
  /*
    Sets the scale/rate of decay.
    */
  def scale(s: java.lang.String): DecayScoreFunction = js.native
  /*
