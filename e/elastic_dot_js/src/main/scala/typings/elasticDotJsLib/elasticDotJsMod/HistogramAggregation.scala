...
class HistogramAggregation protected () extends Aggregation {
  ...
  /*
    ...
    documents.
    */
  def extendedBounds(min: scala.Double, max: scala.Double): HistogramAggregation = js.native
  /*
    Sets the field to gather terms from.
    */
  def field(field: java.lang.String): HistogramAggregation = js.native
  /*
    Sets the format expression for the terms.  Use for number or date
    formatting
    */
  def format(f: java.lang.String): HistogramAggregation = js.native
  /*
    Sets the histogram interval.  Buckets are generated based on this interval
    value.
    */
  def interval(i: scala.Double): HistogramAggregation = js.native
  /*
    Enable the response to be returned as a keyed object where the key is the
    bucket interval.
    */
  def keyed(trueFalse: scala.Boolean): HistogramAggregation = js.native
  /*
    The script language being used.
    */
  def lang(language: java.lang.String): HistogramAggregation = js.native
  /*
    Only return terms that match more than a configured number of hits.
    */
  def minDocCount(num: scala.Double): HistogramAggregation = js.native
  /*
    Sets order for the aggregated values.
    */
  def order(order: java.lang.String, direction: java.lang.String): HistogramAggregation = js.native
  /*
  ...
  /*
    ...
    */
  def script(scriptCode: java.lang.String): HistogramAggregation = js.native
  /*
    Set to true to assume script values are sorted.
    */
  def scriptValuesSorted(trueFalse: scala.Boolean): HistogramAggregation = js.native
  /*
