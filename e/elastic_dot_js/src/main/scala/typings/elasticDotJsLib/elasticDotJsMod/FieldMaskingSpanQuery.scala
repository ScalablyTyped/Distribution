...
class FieldMaskingSpanQuery protected () extends Query {
  /*
    ...
    */
  def this(spanQry: Query, field: scala.Double) = this()
  /*
  ...
  /*
    ...
    */
  def boost(boost: scala.Double): FieldMaskingSpanQuery = js.native
  /*
    Sets the value of the "masked" field.
    */
  def field(f: java.lang.String): FieldMaskingSpanQuery = js.native
  /*
