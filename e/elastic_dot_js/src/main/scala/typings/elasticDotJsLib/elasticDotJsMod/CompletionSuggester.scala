...
class CompletionSuggester protected () extends Suggest {
  ...
  /*
    ...
    */
  def analyzer(analyzer: java.lang.String): CompletionSuggester = js.native
  /*
    Maximum edit distance (fuzziness), defaults to 1.  Automatically
    enables fuzzy suggestions when set to any value.
    */
  def editDistance(d: scala.Double): CompletionSuggester = js.native
  /*
    Sets the field used to generate suggestions from.
    */
  def field(field: java.lang.String): CompletionSuggester = js.native
  /*
    Enable fuzzy completions which means a can spell a word
    incorrectly and still get a suggestion.
    */
  def fuzzy(trueFalse: scala.Boolean): CompletionSuggester = js.native
  /*
    ...
    */
  def minLength(m: scala.Double): CompletionSuggester = js.native
  /*
    ...
    */
  def prefixLength(l: scala.Double): CompletionSuggester = js.native
  /*
    Sets the maximum number of suggestions to be retrieved from
    each individual shard.
    */
  def shardSize(s: scala.Double): CompletionSuggester = js.native
  /*
    Sets the number of suggestions returned for each token.
    */
  def size(s: scala.Double): CompletionSuggester = js.native
  /*
    Sets the text to get suggestions for.  If not set, the global
    suggestion text will be used.
    */
  def text(txt: java.lang.String): CompletionSuggester = js.native
  /*
  ...
  /*
    ...
    */
  def transpositions(trueFalse: scala.Boolean): CompletionSuggester = js.native
  /*
    ...
    enables fuzzy suggestions when set to any value.
    */
  def unicodeAware(trueFalse: scala.Boolean): CompletionSuggester = js.native
}
