...
class HasParentFilter protected () extends Filter {
  ...
  /*
    ...
    */
  def cache(trueFalse: scala.Boolean): HasParentFilter = js.native
  /*
    Sets the cache key.
    */
  def cacheKey(key: java.lang.String): HasParentFilter = js.native
  /*
    Sets the filter
    */
  ...
  /*
    ...
    */
  def name(name: java.lang.String): HasParentFilter = js.native
  /*
    Sets the child document type to search against
    */
  def parentType(t: java.lang.String): HasParentFilter = js.native
  /*
    Sets the query
    */
  ...
  /*
    ...
    */
  def scope(s: java.lang.String): HasParentFilter = js.native
  /*
