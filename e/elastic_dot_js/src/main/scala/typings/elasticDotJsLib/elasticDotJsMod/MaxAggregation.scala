...
class MaxAggregation protected () extends Aggregation {
  ...
  /*
    ...
    */
  def field(field: java.lang.String): MaxAggregation = js.native
  /*
    The script language being used.
    */
  def lang(language: java.lang.String): MaxAggregation = js.native
  /*
  ...
  /*
    ...
    */
  def script(scriptCode: java.lang.String): MaxAggregation = js.native
  /*
    Set to true to assume script values are sorted.
    */
  def scriptValuesSorted(trueFalse: scala.Boolean): MaxAggregation = js.native
  /*
