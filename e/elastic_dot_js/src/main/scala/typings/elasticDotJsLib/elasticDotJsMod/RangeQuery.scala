...
class RangeQuery protected () extends Query {
  ...
  /*
    ...
    */
  def boost(boost: scala.Double): RangeQuery = js.native
  /*
    The field to run the query against.
    */
  def field(f: java.lang.String): RangeQuery = js.native
  /*
  ...
  /*
    ...
    Defaults to true
    */
  def includeLower(trueFalse: scala.Boolean): RangeQuery = js.native
  /*
    Should the last to (if set) be inclusive or not. Defaults to true.
    */
  def includeUpper(trueFalse: scala.Boolean): RangeQuery = js.native
  /*
