...
class FunctionScoreQuery () extends Query {
  ...
  /*
    ...
    */
  def boost(boost: scala.Double): FunctionScoreQuery = js.native
  /*
    ...
    avg, max, and min.
    */
  def boostMode(mode: java.lang.String): FunctionScoreQuery = js.native
  /*
  ...
  /*
    ...
    */
  def scoreMode(mode: java.lang.String): FunctionScoreQuery = js.native
  /*
