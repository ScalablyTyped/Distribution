...
class HasParentQuery protected () extends Query {
  ...
  /*
    ...
    */
  def boost(boost: scala.Double): HasParentQuery = js.native
  /*
    Sets the child document type to search against
    */
  def parentType(t: java.lang.String): HasParentQuery = js.native
  /*
    Sets the query
    */
  ...
  /*
    ...
    */
  def scope(s: java.lang.String): HasParentQuery = js.native
  /*
    ...
    */
  def scoreMode(s: java.lang.String): HasParentQuery = js.native
  /*
    Sets the scoring method.  Valid values are:
    none - the default, no scoring
    score - the score of the parent is used in all child documents.
    */
  def scoreType(s: java.lang.String): HasParentQuery = js.native
  /*
