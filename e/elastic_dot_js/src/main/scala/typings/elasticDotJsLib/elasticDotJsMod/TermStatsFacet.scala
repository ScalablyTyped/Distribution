...
class TermStatsFacet protected () extends Facet {
  ...
  /*
    ...
    */
  def allTerms(trueFalse: java.lang.String): TermStatsFacet = js.native
  /*
    Enables caching of the facetFilter
    */
  def cacheFilter(trueFalse: scala.Boolean): TermStatsFacet = js.native
  /*
  ...
  /*
    ...
    */
  def global(trueFalse: scala.Boolean): TermStatsFacet = js.native
  /*
    Sets the field which will be used to pivot on (group-by).
    */
  def keyField(fieldName: java.lang.String): TermStatsFacet = js.native
  /*
    The script language being used. Currently supported values are
    javascript, groovy, and mvel.
    */
  def lang(language: java.lang.String): TermStatsFacet = js.native
  /*
    Sets the mode the facet will use.
    collector
    post
    */
  def mode(m: java.lang.String): TermStatsFacet = js.native
  /*
    Sets the path to the nested document if faceting against a
    nested field.
    */
  def nested(path: java.lang.String): TermStatsFacet = js.native
  /*
    ...
    */
  def order(o: java.lang.String): TermStatsFacet = js.native
  /*
  ...
  /*
    ...
    */
  def scope(scope: java.lang.String): TermStatsFacet = js.native
  /*
    Sets a script that will provide the terms for a given document.
    */
  def scriptField(script: java.lang.String): TermStatsFacet = js.native
  /*
    ...
    */
  def size(facetSize: scala.Double): TermStatsFacet = js.native
  /*
  ...
  /*
    ...
    */
  def valueField(fieldName: java.lang.String): TermStatsFacet = js.native
  /*
    Define a script to evaluate of which the result will be used to generate
    the statistical information.
    */
  def valueScript(code: java.lang.String): TermStatsFacet = js.native
}
