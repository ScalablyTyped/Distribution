...
class BoolQuery () extends Query {
  ...
  /*
    ...
    */
  def adjustPureNegative(trueFalse: java.lang.String): BoolQuery = js.native
  /*
    Sets the boost value for documents matching the Query.
    */
  def boost(boost: scala.Double): BoolQuery = js.native
  /*
    Enables or disables similarity coordinate scoring of documents
    matching the Query. Default: false.
    */
  def disableCoord(trueFalse: java.lang.String): BoolQuery = js.native
  /*
    ...
    */
  def minimumNumberShouldMatch(minMatch: scala.Double): BoolQuery = js.native
  /*
