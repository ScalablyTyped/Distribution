...
class DirectSettingsMixin () extends js.Object {
  ...
  /*
    ...
    */
  def sort(s: java.lang.String): DirectSettingsMixin = js.native
  /*
    ...
    */
  def stringDistance(s: java.lang.String): DirectSettingsMixin = js.native
  /*
    ...
    */
  def suggestMode(m: java.lang.String): DirectSettingsMixin = js.native
}
