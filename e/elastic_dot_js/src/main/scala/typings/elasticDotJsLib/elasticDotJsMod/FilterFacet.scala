...
class FilterFacet protected () extends Facet {
  ...
  /*
    ...
    */
  def cacheFilter(trueFalse: scala.Boolean): FilterFacet = js.native
  /*
  ...
  /*
    ...
    */
  def global(trueFalse: scala.Boolean): FilterFacet = js.native
  /*
    Sets the mode the facet will use.
    collector
    post
    */
  def mode(m: java.lang.String): FilterFacet = js.native
  /*
    Sets the path to the nested document if faceting against a
    nested field.
    */
  def nested(path: java.lang.String): FilterFacet = js.native
  /*
    Computes values across the the specified scope
    */
  def scope(scope: java.lang.String): FilterFacet = js.native
  /*
