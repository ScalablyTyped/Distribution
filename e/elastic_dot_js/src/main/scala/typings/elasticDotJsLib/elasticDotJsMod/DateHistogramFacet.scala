...
class DateHistogramFacet protected () extends Facet {
  ...
  /*
    ...
    */
  def cacheFilter(trueFalse: scala.Boolean): DateHistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def factor(f: scala.Double): DateHistogramFacet = js.native
  /*
    Sets the field to be used to construct the this facet.
    */
  def field(fieldName: java.lang.String): DateHistogramFacet = js.native
  /*
    Computes values across the entire index
    */
  def global(trueFalse: scala.Boolean): DateHistogramFacet = js.native
  /*
    Sets the bucket interval used to calculate the distribution.
    */
  def interval(timeInterval: java.lang.String): DateHistogramFacet = js.native
  /*
    Allows you to specify a different key field to be used to group intervals.
    */
  def keyField(fieldName: java.lang.String): DateHistogramFacet = js.native
  /*
    The script language being used. Currently supported values are
    javascript, groovy, and mvel.
    */
  def lang(language: java.lang.String): DateHistogramFacet = js.native
  /*
    Sets the mode the facet will use.
    collector
    post
    */
  def mode(m: java.lang.String): DateHistogramFacet = js.native
  /*
    Sets the path to the nested document if faceting against a
    nested field.
    */
  def nested(path: java.lang.String): DateHistogramFacet = js.native
  /*
    ...
    */
  def order(o: java.lang.String): DateHistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def postOffset(offset: java.lang.String): DateHistogramFacet = js.native
  /*
    ...
    */
  def postZone(tz: scala.Double): DateHistogramFacet = js.native
  /*
    Set's a specific pre-rounding offset.  Format is 1d, 1h, etc.
    */
  def preOffset(offset: java.lang.String): DateHistogramFacet = js.native
  /*
    By default, time values are stored in UTC format.
    ...
    For example, to use EST you would set the value to -5.
    */
  def preZone(tz: scala.Double): DateHistogramFacet = js.native
  /*
    ...
    */
  def preZoneAdjustLargeInterval(trueFalse: scala.Boolean): DateHistogramFacet = js.native
  /*
    Computes values across the the specified scope
    */
  def scope(scope: java.lang.String): DateHistogramFacet = js.native
  /*
    By default, time values are stored in UTC format.
    ...
    For example, to use EST you would set the value to -5.
    */
  def timeZone(tz: scala.Double): DateHistogramFacet = js.native
  /*
  ...
  /*
    ...
    */
  def valueField(fieldName: java.lang.String): DateHistogramFacet = js.native
  /*
    Allows you modify the value field using a script. The modified value
    is then used to compute the statistical data.
    */
  def valueScript(scriptCode: java.lang.String): DateHistogramFacet = js.native
}
