...
class GeoBboxFilter protected () extends Filter {
  ...
  /*
    ...
    */
  def cache(trueFalse: scala.Boolean): GeoBboxFilter = js.native
  /*
    Sets the cache key.
    */
  def cacheKey(key: java.lang.String): GeoBboxFilter = js.native
  /*
    Sets the fields to filter against.
    */
  def field(f: java.lang.String): GeoBboxFilter = js.native
  /*
    Sets the filter name.
    */
  def name(name: java.lang.String): GeoBboxFilter = js.native
  /*
    ...
    */
  def normalize(trueFalse: java.lang.String): GeoBboxFilter = js.native
  /*
  ...
  /*
    ...
    */
  def `type`(`type`: java.lang.String): GeoBboxFilter = js.native
}
