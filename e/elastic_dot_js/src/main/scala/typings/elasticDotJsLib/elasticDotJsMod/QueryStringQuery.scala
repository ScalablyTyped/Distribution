...
class QueryStringQuery protected () extends Query {
  ...
  /*
    ...
    */
  def allowLeadingWildcard(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    ...
    */
  def analyzeWildcard(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    Sets the analyzer name used to analyze the Query object.
    */
  def analyzer(analyzer: java.lang.String): QueryStringQuery = js.native
  /*
    Sets whether or not we should auto generate phrase queries *if* the
    analyzer returns more than one term. Default: false.
    */
  def autoGeneratePhraseQueries(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    Sets the boost value for documents matching the Query.
    */
  def boost(boost: scala.Double): QueryStringQuery = js.native
  /*
    Sets the default field/property this query should execute against.
    */
  def defaultField(fieldName: java.lang.String): QueryStringQuery = js.native
  /*
    ...
    Defaults to OR.
    */
  def defaultOperator(op: java.lang.String): QueryStringQuery = js.native
  /*
    Sets whether or not position increments will be used in the
    Query. Default: true.
    */
  def enablePositionIncrements(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    If they query string should be escaped or not.
    */
  def escape(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
  ...
  /*
    ...
    */
  def fuzzyMaxExpansions(max: scala.Double): QueryStringQuery = js.native
  /*
    Set the minimum similarity for fuzzy queries.  Default: 0.5.
    */
  def fuzzyMinSim(minSim: scala.Double): QueryStringQuery = js.native
  /*
    Sets the prefix length for fuzzy queries.  Default: 0.
    */
  def fuzzyPrefixLength(fuzzLen: scala.Double): QueryStringQuery = js.native
  /*
    ...
    */
  def fuzzyRewrite(m: java.lang.String): QueryStringQuery = js.native
  /*
    Enables lenient parsing of the query string.
    */
  def lenient(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    ...
    */
  def lowercaseExpandedTerms(trueFalse: scala.Boolean): QueryStringQuery = js.native
  /*
    Sets a percent value controlling how many "should" clauses in the
    resulting Query should match.
    */
  def minimumShouldMatch(minMatch: scala.Double): QueryStringQuery = js.native
  /*
    Sets the default slop for phrases. If zero, then exact phrase matches
    are required.  Default: 0.
    */
  def phraseSlop(slop: scala.Double): QueryStringQuery = js.native
  /*
    Sets the query string on this Query object.
    */
  def query(qstr: java.lang.String): QueryStringQuery = js.native
  /*
    Sets the quote analyzer name used to analyze the query
    when in quoted text.
    */
  def quoteAnalyzer(analyzer: java.lang.String): QueryStringQuery = js.native
  /*
    Sets the suffix to automatically add to the field name when
    performing a quoted search.
    */
  def quoteFieldSuffix(s: java.lang.String): QueryStringQuery = js.native
  /*
    ...
    This is an advanced option, use with care.
    */
  def rewrite(m: java.lang.String): QueryStringQuery = js.native
  /*
    ...
    */
  def tieBreaker(tieBreaker: scala.Double): QueryStringQuery = js.native
  /*
  ...
  /*
    ...
    DisjunctionMaxQuery
    */
  def useDisMax(trueFalse: java.lang.String): QueryStringQuery = js.native
}
