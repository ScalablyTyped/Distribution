...
object SetOptions {
  ...
  def apply(
    ...
    disabledDates: js.Array[DateComparable] | scala.Boolean = null,
    disabledHours: js.Array[scala.Double] | scala.Boolean = null,
    disabledTimeIntervals: scala.Boolean | js.Array[FromTo] = null,
    enabledDates: js.Array[DateComparable] | scala.Boolean = null,
    enabledHours: js.Array[scala.Double] | scala.Boolean = null,
