...
@js.native
object GeocodingNsMembers extends js.Object {
  ...
  def geocode(options: esriDashLeafletLib.esriDashLeafletMod.Service): Geocode = js.native
  def geocode(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.TaskOptions): Geocode = js.native
  ...
  def geosearch(): Geosearch = js.native
  def geosearch(options: GeosearchObject): Geosearch = js.native
  ...
  def reverseGeocode(options: esriDashLeafletLib.esriDashLeafletMod.Service): ReverseGeocode = js.native
  def reverseGeocode(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.TaskOptions): ReverseGeocode = js.native
  def suggest(): Suggest = js.native
  def suggest(options: esriDashLeafletLib.esriDashLeafletMod.Service): Suggest = js.native
  def suggest(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.TaskOptions): Suggest = js.native
}
