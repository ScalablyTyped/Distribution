...
object Options {
  @scala.inline
  def apply(
    badrequest: (/* req */ Request[ParamsDictionary, js.Any, js.Any, ParsedQs], /* res */ Response[js.Any], /* next */ NextFunction) => js.Any = null,
    debug: (/* prefix */ String, /* message */ String) => Unit = null,
    domain: String = null,
    domaincontroller: String = null,
    forbidden: (/* req */ Request[ParamsDictionary, js.Any, js.Any, ParsedQs], /* res */ Response[js.Any], /* next */ NextFunction) => js.Any = null,
    internalservererror: (/* req */ Request[ParamsDictionary, js.Any, js.Any, ParsedQs], /* res */ Response[js.Any], /* next */ NextFunction) => js.Any = null,
    prefix: String = null,
    tlsOptions: ConnectionOptions = null,
    unauthorized: (/* req */ Request[ParamsDictionary, js.Any, js.Any, ParsedQs], /* res */ Response[js.Any], /* next */ NextFunction) => js.Any = null
  ): Options = {
