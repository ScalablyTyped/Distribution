...
object StageGL {
  ...
  @scala.inline
  def COVER_UV_=(x: Float32Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COVER_UV")(x.asInstanceOf[js.Any])
  
  @JSGlobal("createjs.StageGL.COVER_UV_FLIP")
  @js.native
  def COVER_UV_FLIP: Float32Array = js.native
  @scala.inline
  def COVER_UV_FLIP_=(x: Float32Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COVER_UV_FLIP")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def COVER_VERT_=(x: Float32Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COVER_VERT")(x.asInstanceOf[js.Any])
