...
import typings.egjsAxes.typesMod.ExtendedEvent
...
object eventInputMod {
  
  @JSImport("@egjs/axes/declaration/eventInput/EventInput", "EventInput")
  @js.native
  abstract class EventInput () extends StObject {
