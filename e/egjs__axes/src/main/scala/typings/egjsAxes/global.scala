...
import typings.egjsAxes.mod.default
...
object global {
  ...
  @JSGlobal("eg")
  @js.native
  class eg protected () extends default {
  ...
  object eg {
    ...
    @JSGlobal("eg.DIRECTION_HORIZONTAL")
    @js.native
    ...
    @JSGlobal("eg.DIRECTION_VERTICAL")
    @js.native
