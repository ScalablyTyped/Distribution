...
object indexCjsMod {
  ...
  @JSImport("@egjs/axes/declaration/index.cjs", JSImport.Default)
  @js.native
  open class default ()
    extends typings.egjsAxes.mod.default {
  ...
  object default {
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_ALL")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_DOWN")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_HORIZONTAL")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_LEFT")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_NONE")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_RIGHT")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_UP")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.DIRECTION_VERTICAL")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.MoveKeyInput")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.PanInput")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.PinchInput")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.RotatePanInput")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.TRANSFORM")
    @js.native
    ...
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.VERSION")
    @js.native
    def VERSION: String = js.native
    inline def VERSION_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VERSION")(x.asInstanceOf[js.Any])
    
    /* static member */
    @JSImport("@egjs/axes/declaration/index.cjs", "default.WheelInput")
    @js.native
  ...
  @JSImport("@egjs/axes/declaration/index.cjs", "AXES_EVENTS")
  @js.native
  val AXES_EVENTS: js.Tuple6[hold, release, change, animationStart, animationEnd, finish] = js.native
  
  @JSImport("@egjs/axes/declaration/index.cjs", "AXES_METHODS")
  @js.native
  ...
  @JSImport("@egjs/axes/declaration/index.cjs", "MoveKeyInput")
  @js.native
  open class MoveKeyInput protected ()
    extends typings.egjsAxes.mod.MoveKeyInput {
    def this(el: ElementType) = this()
    def this(el: ElementType, options: MoveKeyInputOption) = this()
  }
  
  @JSImport("@egjs/axes/declaration/index.cjs", "PanInput")
  @js.native
  open class PanInput protected ()
    extends typings.egjsAxes.mod.PanInput {
    def this(el: ElementType) = this()
    def this(el: ElementType, options: PanInputOption) = this()
  }
  
  @JSImport("@egjs/axes/declaration/index.cjs", "PinchInput")
  @js.native
  open class PinchInput protected ()
    extends typings.egjsAxes.mod.PinchInput {
    def this(el: ElementType) = this()
    def this(el: ElementType, options: PinchInputOption) = this()
  }
  
  @JSImport("@egjs/axes/declaration/index.cjs", "REACTIVE_AXES")
  @js.native
  ...
  @JSImport("@egjs/axes/declaration/index.cjs", "RotatePanInput")
  @js.native
  open class RotatePanInput protected ()
    extends typings.egjsAxes.mod.RotatePanInput {
    def this(el: ElementType) = this()
    def this(el: ElementType, options: PanInputOption) = this()
  }
  
  @JSImport("@egjs/axes/declaration/index.cjs", "WheelInput")
  @js.native
  open class WheelInput protected ()
    extends typings.egjsAxes.mod.WheelInput {
    def this(el: ElementType) = this()
