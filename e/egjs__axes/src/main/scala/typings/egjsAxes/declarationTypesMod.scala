...
object declarationTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.egjsAxes.declarationEventInputMouseEventInputMod.MouseEventInput
    - typings.egjsAxes.declarationEventInputTouchEventInputMod.TouchEventInput
    - typings.egjsAxes.declarationEventInputTouchMouseEventInputMod.TouchMouseEventInput
    - typings.egjsAxes.declarationEventInputPointerEventInputMod.PointerEventInput
  */
