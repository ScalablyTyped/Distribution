...
class namespaced protected () extends EmailTemplate {
  ...
  /**
       ...
       */
  /* CompleteClass */
  override def juiceResources(html: java.lang.String): stdLib.Promise[java.lang.String] = js.native
  /**
       *
       ...
       */
  /* CompleteClass */
  override def render(view: java.lang.String, locals: js.Any): stdLib.Promise[java.lang.String] = js.native
  /**
       * Send the Email
       */
  /* CompleteClass */
