...
/* Inlined esbuild-wasm.esbuild-wasm.BuildOptions & {  incremental :true} */
trait BuildOptionsincrementaltrAllowOverwrite extends StObject {
...
object BuildOptionsincrementaltrAllowOverwrite {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BuildOptionsincrementaltrAllowOverwrite] (val x: Self) extends AnyVal {
