...
import typings.esbuildWasm.mod.BuildInvalidate
import typings.esbuildWasm.mod.Message
import typings.esbuildWasm.mod.Metafile
import typings.esbuildWasm.mod.OutputFile
...
object BuildIncrementalmetafileMErrors {
  ...
  inline def apply(errors: js.Array[Message], rebuild: BuildInvalidate, warnings: js.Array[Message]): BuildIncrementalmetafileMErrors = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BuildIncrementalmetafileMErrors] (val x: Self) extends AnyVal {
