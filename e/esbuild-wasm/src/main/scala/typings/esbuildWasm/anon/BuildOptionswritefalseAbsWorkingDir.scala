...
/* Inlined esbuild-wasm.esbuild-wasm.BuildOptions & {  write :false} */
trait BuildOptionswritefalseAbsWorkingDir extends StObject {
...
object BuildOptionswritefalseAbsWorkingDir {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BuildOptionswritefalseAbsWorkingDir] (val x: Self) extends AnyVal {
