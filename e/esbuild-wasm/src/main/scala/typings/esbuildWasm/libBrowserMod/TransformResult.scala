...
trait TransformResult[ProvidedOptions /* <: TransformOptions */] extends StObject {
  
  var code: String
  
  /** Only when "legalComments" is "external" */
  var legalComments: String | (/* import warning: importer.ImportType#apply Failed type conversion: ProvidedOptions['legalComments'] extends 'external' ? never : undefined */ js.Any)
...
object TransformResult {
  ...
  inline def apply[ProvidedOptions /* <: TransformOptions */](
    code: String,
    legalComments: String | (/* import warning: importer.ImportType#apply Failed type conversion: ProvidedOptions['legalComments'] extends 'external' ? never : undefined */ js.Any),
    ...
    __obj.asInstanceOf[TransformResult[ProvidedOptions]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TransformResult[?], ProvidedOptions /* <: TransformOptions */] (val x: Self & TransformResult[ProvidedOptions]) extends AnyVal {
    
    inline def setCode(value: String): Self = StObject.set(x, "code", value.asInstanceOf[js.Any])
    
    inline def setLegalComments(
      value: String | (/* import warning: importer.ImportType#apply Failed type conversion: ProvidedOptions['legalComments'] extends 'external' ? never : undefined */ js.Any)
