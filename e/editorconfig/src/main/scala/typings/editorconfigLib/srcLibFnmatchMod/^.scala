...
object ^ extends js.Object {
  var Minimatch: editorconfigLib.srcLibFnmatchMod.MNs.IMinimatchStatic = js.native
  def apply(target: java.lang.String, pattern: java.lang.String): scala.Boolean = js.native
  def apply(
    target: java.lang.String,
    pattern: java.lang.String,
    options: editorconfigLib.srcLibFnmatchMod.MNs.IOptions
  ...
  def filter(pattern: java.lang.String, options: editorconfigLib.srcLibFnmatchMod.MNs.IOptions): js.Function3[
    /* element */ java.lang.String, 
    /* indexed */ scala.Double, 
    /* array */ js.Array[java.lang.String], 
    scala.Boolean
  ...
  def makeRe(pattern: java.lang.String, options: editorconfigLib.srcLibFnmatchMod.MNs.IOptions): stdLib.RegExp = js.native
  /**
