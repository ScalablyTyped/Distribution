...
class ^ protected () extends ExpressBrute {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getMiddleware(options: Middleware): expressLib.expressMod.RequestHandler = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def reset(ip: java.lang.String, key: java.lang.String, next: js.Function): expressLib.expressMod.RequestHandler = js.native
}
