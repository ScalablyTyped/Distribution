...
package object mod {
  ...
  type FormatObject = org.scalablytyped.runtime.StringDictionary[typings.easyTable.mod.ColumnFormat[js.Any]]
  type ReduceFunction[T] = js.Function4[/* acc */ T, /* val */ T, /* idx */ scala.Double, /* length */ scala.Double, T]
  type TablePostProcessing = js.Function1[/* result */ typings.easyTable.mod.EasyTable, java.lang.String]
}
