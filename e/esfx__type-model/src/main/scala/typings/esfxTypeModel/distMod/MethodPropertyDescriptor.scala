...
object MethodPropertyDescriptor {
  ...
  @scala.inline
  implicit class MethodPropertyDescriptorOps[Self <: MethodPropertyDescriptor[_], T /* <: js.Function1[/* repeated */ js.Any, _] */] (val x: Self with MethodPropertyDescriptor[T]) extends AnyVal {
