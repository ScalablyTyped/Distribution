...
object buildIosCocoaPodsPackageManagerMod {
  
  @JSImport("@expo/package-manager/build/ios/CocoaPodsPackageManager", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@expo/package-manager/build/ios/CocoaPodsPackageManager", "CocoaPodsError")
  @js.native
  ...
  @JSImport("@expo/package-manager/build/ios/CocoaPodsPackageManager", "CocoaPodsPackageManager")
  @js.native
  open class CocoaPodsPackageManager protected () extends StObject {
    ...
    def addAsync(): Unit = js.native
    def addAsync(names: js.Array[String]): Unit = js.native
    
    def addDevAsync(): Unit = js.native
    def addDevAsync(names: js.Array[String]): Unit = js.native
    
    def addGlobalAsync(): Unit = js.native
    def addGlobalAsync(names: js.Array[String]): Unit = js.native
    
    def addWithParametersAsync(names: js.Array[String], parameters: js.Array[String]): js.Promise[Unit] = js.native
    
    def configAsync(key: String): js.Promise[String] = js.native
    ...
    def removeAsync(): Unit = js.native
    def removeAsync(names: js.Array[String]): Unit = js.native
    
    def removeDevAsync(): Unit = js.native
    def removeDevAsync(names: js.Array[String]): Unit = js.native
    
    def removeGlobalAsync(): Unit = js.native
    def removeGlobalAsync(names: js.Array[String]): Unit = js.native
    ...
    def uninstallAsync(): js.Promise[Unit] = js.native
