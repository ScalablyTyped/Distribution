...
import typings.expressWinston.anon.Error
...
trait BaseLoggerOptions extends js.Object {
  ...
  var statusLevels: js.UndefOr[Error] = js.undefined
}
...
object BaseLoggerOptions {
  ...
  def apply(
    ...
    dynamicMeta: (/* req */ Request_[ParamsDictionary, js.Any, js.Any, Query], /* res */ Response_[js.Any], /* err */ typings.std.Error) => js.Object = null,
