...
@js.native
object electronDashJsonDashStorageModMembers extends js.Object {
  def clear(callback: js.Function1[/* error */ js.Any, scala.Unit]): scala.Unit = js.native
  def clear(options: DataOptions, callback: js.Function1[/* error */ js.Any, scala.Unit]): scala.Unit = js.native
  def get(
  ...
  def getAll(options: DataOptions, callback: js.Function2[/* error */ js.Any, /* data */ js.Object, scala.Unit]): scala.Unit = js.native
