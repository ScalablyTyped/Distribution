...
import typings.embroiderMacros.embroiderMacrosStrings.Ampersand
import typings.embroiderMacros.embroiderMacrosStrings.AmpersandAmpersand
import typings.embroiderMacros.embroiderMacrosStrings.Asterisk
import typings.embroiderMacros.embroiderMacrosStrings.AsteriskAsterisk
import typings.embroiderMacros.embroiderMacrosStrings.ClassBody
import typings.embroiderMacros.embroiderMacrosStrings.CommonJS
import typings.embroiderMacros.embroiderMacrosStrings.ES
import typings.embroiderMacros.embroiderMacrosStrings.EqualssignEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.EqualssignEqualssignEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.Exclamationmark
import typings.embroiderMacros.embroiderMacrosStrings.ExclamationmarkEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.ExclamationmarkEqualssignEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.Greaterthansign
import typings.embroiderMacros.embroiderMacrosStrings.GreaterthansignEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.GreaterthansignGreaterthansign
import typings.embroiderMacros.embroiderMacrosStrings.GreaterthansignGreaterthansignGreaterthansign
import typings.embroiderMacros.embroiderMacrosStrings.Identifier
import typings.embroiderMacros.embroiderMacrosStrings.Lessthansign
import typings.embroiderMacros.embroiderMacrosStrings.LessthansignEqualssign
import typings.embroiderMacros.embroiderMacrosStrings.LessthansignLessthansign
import typings.embroiderMacros.embroiderMacrosStrings.Percentsign
import typings.embroiderMacros.embroiderMacrosStrings.Plussign
import typings.embroiderMacros.embroiderMacrosStrings.PlussignPlussign
import typings.embroiderMacros.embroiderMacrosStrings.QuestionmarkQuestionmark
import typings.embroiderMacros.embroiderMacrosStrings.Slash
import typings.embroiderMacros.embroiderMacrosStrings.StringLiteral
import typings.embroiderMacros.embroiderMacrosStrings.Tilde
import typings.embroiderMacros.embroiderMacrosStrings.Verticalline
import typings.embroiderMacros.embroiderMacrosStrings.VerticallineGreaterthansign
import typings.embroiderMacros.embroiderMacrosStrings.VerticallineVerticalline
import typings.embroiderMacros.embroiderMacrosStrings.^
import typings.embroiderMacros.embroiderMacrosStrings.`--`
import typings.embroiderMacros.embroiderMacrosStrings.`-_`
import typings.embroiderMacros.embroiderMacrosStrings.`object`
import typings.embroiderMacros.embroiderMacrosStrings.`throw`
import typings.embroiderMacros.embroiderMacrosStrings.`using`
import typings.embroiderMacros.embroiderMacrosStrings.`var`
import typings.embroiderMacros.embroiderMacrosStrings.boolean
import typings.embroiderMacros.embroiderMacrosStrings.const
import typings.embroiderMacros.embroiderMacrosStrings.constructor
import typings.embroiderMacros.embroiderMacrosStrings.delete
import typings.embroiderMacros.embroiderMacrosStrings.function
import typings.embroiderMacros.embroiderMacrosStrings.get
import typings.embroiderMacros.embroiderMacrosStrings.in
import typings.embroiderMacros.embroiderMacrosStrings.instanceof
import typings.embroiderMacros.embroiderMacrosStrings.let
import typings.embroiderMacros.embroiderMacrosStrings.method
import typings.embroiderMacros.embroiderMacrosStrings.minus
import typings.embroiderMacros.embroiderMacrosStrings.module
import typings.embroiderMacros.embroiderMacrosStrings.number
import typings.embroiderMacros.embroiderMacrosStrings.plus
import typings.embroiderMacros.embroiderMacrosStrings.script
import typings.embroiderMacros.embroiderMacrosStrings.set
import typings.embroiderMacros.embroiderMacrosStrings.string
import typings.embroiderMacros.embroiderMacrosStrings.symbol
import typings.embroiderMacros.embroiderMacrosStrings.typeof
import typings.embroiderMacros.embroiderMacrosStrings.undefined
import typings.embroiderMacros.embroiderMacrosStrings.void
...
trait Typeoftypes extends StObject {
  ...
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */](`type`: T, n: Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
  ...
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
  def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[Node, Type[T]] */](`type`: T, n: Node, required: Partial[P]): /* is P */ Boolean = js.native
  ...
  def isPlaceholderType(
    placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any,
    targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any
  ): Boolean = js.native
  ...
  def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.embroiderMacros.embroiderMacrosStrings.ClassAccessorProperty, typings.embroiderMacros.embroiderMacrosStrings.AnyTypeAnnotation, typings.embroiderMacros.embroiderMacrosStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
  ...
  def placeholder(
    expectedNode: Identifier | StringLiteral | typings.embroiderMacros.embroiderMacrosStrings.Expression | typings.embroiderMacros.embroiderMacrosStrings.Statement | typings.embroiderMacros.embroiderMacrosStrings.Declaration | typings.embroiderMacros.embroiderMacrosStrings.BlockStatement | ClassBody | typings.embroiderMacros.embroiderMacrosStrings.Pattern,
    name: Identifier_
