...
object ComponentMgr extends js.Object {
  ...
  def create(config: js.Any, defaultType: java.lang.String): extjsLib.ExtNs.IComponent = js.native
  ...
  def registerType(`type`: js.Any): scala.Unit = js.native
  def registerType(`type`: js.Any, cls: js.Any): scala.Unit = js.native
