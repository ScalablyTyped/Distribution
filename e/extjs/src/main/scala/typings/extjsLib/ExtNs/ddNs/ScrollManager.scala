...
object ScrollManager extends js.Object {
  /** [Property] (Number) */
  var animDuration: scala.Double = js.native
  /** [Property] (Boolean) */
  ...
  def register(el: js.Any): scala.Unit = js.native
