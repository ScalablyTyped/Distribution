...
trait IFit extends IContainer {
  /** [Method] Called to perform the calculations for this layout
  		...
  		*/
  @JSName("calculate")
  var calculate_IFit: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
...
object IFit {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IFit] = null,
