...
object ImageExporter extends js.Object {
  ...
  /** [Property] (Array) */
  var supportedTypes: extjsLib.ExtNs.Array = js.native
  /** [Property] (String) */
  ...
  /** [Method] Exports the surface to an image
  		...
  		*/
  def generate(): scala.Boolean = js.native
  def generate(surface: extjsLib.ExtNs.drawNs.ISurface): scala.Boolean = js.native
  def generate(surface: extjsLib.ExtNs.drawNs.ISurface, config: js.Any): scala.Boolean = js.native
