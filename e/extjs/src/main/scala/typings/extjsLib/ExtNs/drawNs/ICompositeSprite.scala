...
object ICompositeSprite {
  ...
  def apply(
    ...
    hide: js.Function1[/* redraw */ js.UndefOr[scala.Boolean], ICompositeSprite] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], ICompositeSprite] = null,
    ...
    setAttributes: js.Function2[
      /* attrs */ js.UndefOr[js.Any], 
      /* redraw */ js.UndefOr[scala.Boolean], 
      ICompositeSprite
    ] = null,
    setStyle: js.Function1[/* style */ js.UndefOr[java.lang.String], scala.Unit] = null,
    show: js.Function1[/* redraw */ js.UndefOr[scala.Boolean], ICompositeSprite] = null,
