...
object ICompositeSprite {
  ...
  def apply(
    ...
    hide: /* redraw */ js.UndefOr[scala.Boolean] => ICompositeSprite = null,
    ...
    sequenceFx: () => _ = null,
    setAttributes: (/* attrs */ js.UndefOr[js.Any], /* redraw */ js.UndefOr[scala.Boolean]) => ICompositeSprite = null,
    setStyle: /* style */ js.UndefOr[java.lang.String] => scala.Unit = null,
    show: /* redraw */ js.UndefOr[scala.Boolean] => ICompositeSprite = null,
