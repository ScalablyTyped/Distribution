...
trait IView
  ...
  /** [Property] (Boolean) */
  var isLockingView: js.UndefOr[scala.Boolean] = js.undefined
}
...
object IView {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IView] = null,
    isLockingView: js.UndefOr[scala.Boolean] = js.undefined,
