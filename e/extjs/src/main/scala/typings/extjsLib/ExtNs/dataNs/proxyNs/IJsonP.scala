...
object IJsonP {
  ...
  def apply(
    ...
    encodeRecords: js.Function1[/* records */ js.UndefOr[extjsLib.ExtNs.Array], extjsLib.ExtNs.Array] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IJsonP] = null,
    ...
    if (encodeRecords != null) __obj.updateDynamic("encodeRecords")(encodeRecords)
