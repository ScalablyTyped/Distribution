...
object Color extends js.Object {
  ...
  def fromHSL(h: scala.Double): js.Any = js.native
  def fromHSL(h: scala.Double, s: scala.Double): js.Any = js.native
  def fromHSL(h: scala.Double, s: scala.Double, l: scala.Double): js.Any = js.native
