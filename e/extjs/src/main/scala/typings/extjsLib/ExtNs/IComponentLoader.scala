...
object IComponentLoader {
  ...
  def apply(
    ...
    isAutoRefreshing: () => scala.Boolean = null,
    ...
    self: IClass = null,
    setTarget: /* target */ js.UndefOr[js.Any] => scala.Unit = null,
    singleton: js.UndefOr[scala.Boolean] = js.undefined,
    startAutoRefresh: (/* interval */ js.UndefOr[scala.Double], /* options */ js.UndefOr[js.Any]) => scala.Unit = null,
    statics: js.Any = null,
    stopAutoRefresh: () => scala.Unit = null,
    success: js.Any = null,
