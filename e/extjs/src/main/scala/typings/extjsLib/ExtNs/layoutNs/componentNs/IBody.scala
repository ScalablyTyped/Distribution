...
trait IBody extends IAuto {
  /** [Method] Called before any calculation cycles to prepare for layout
  		...
  		*/
  @JSName("beginLayout")
  var beginLayout_IBody: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object IBody {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IBody] = null,
