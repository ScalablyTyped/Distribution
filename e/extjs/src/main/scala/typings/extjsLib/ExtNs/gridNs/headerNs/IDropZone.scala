...
object IDropZone {
  ...
  def apply(
    ...
    notifyOut: (/* source */ js.UndefOr[extjsLib.ExtNs.ddNs.IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    onContainerDrop: (/* source */ js.UndefOr[extjsLib.ExtNs.ddNs.IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Boolean = null,
    onContainerOver: (/* source */ js.UndefOr[extjsLib.ExtNs.ddNs.IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => java.lang.String = null,
    ...
    onNodeDrop: (/* node */ js.UndefOr[js.Any], /* dragZone */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any], /* data */ js.UndefOr[js.Any]) => scala.Boolean = null,
