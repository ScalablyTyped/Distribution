...
object IBinaryXhr {
  ...
  def apply(
    ...
    getAllResponseHeaders: () => scala.Unit = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    getResponseHeader: /* header */ js.UndefOr[js.Any] => scala.Unit = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => IBinaryXhr = null,
    mixins: js.Any = null,
    onreadystatechange: () => scala.Unit = null,
    open: (/* method */ js.UndefOr[js.Any], /* url */ js.UndefOr[js.Any], /* async */ js.UndefOr[js.Any], /* user */ js.UndefOr[js.Any], /* password */ js.UndefOr[js.Any]) => scala.Unit = null,
    overrideMimeType: /* mimeType */ js.UndefOr[js.Any] => scala.Unit = null,
    readyState: scala.Int | scala.Double = null,
    requires: extjsLib.ExtNs.Array = null,
    responseBytes: extjsLib.ExtNs.Array = null,
    self: extjsLib.ExtNs.IClass = null,
    send: /* body */ js.UndefOr[extjsLib.ExtNs.Array] => scala.Unit = null,
    setRequestHeader: (/* header */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any]) => scala.Unit = null,
