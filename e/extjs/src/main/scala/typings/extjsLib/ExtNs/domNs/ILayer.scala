...
trait ILayer
  extends extjsLib.ExtNs.IElement {
...
object ILayer {
  ...
  def apply(
    ...
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    alias: extjsLib.ExtNs.Array = null,
    alternateClassName: js.Any = null,
    animate: /* config */ js.UndefOr[js.Any] => ILayer = null,
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[scala.Boolean]) => ILayer = null,
    ...
    blur: () => ILayer = null,
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => ILayer = null,
    ...
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => ILayer = null,
    clip: () => ILayer = null,
    cls: java.lang.String = null,
    config: js.Any = null,
    constrain: js.UndefOr[scala.Boolean] = js.undefined,
    contains: /* el */ js.UndefOr[js.Any] => scala.Boolean = null,
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[stdLib.HTMLElement], /* returnDom */ js.UndefOr[scala.Boolean]) => ILayer = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[scala.Boolean]) => ILayer = null,
    ...
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => ILayer = null,
    ...
    focus: /* defer */ js.UndefOr[scala.Double] => ILayer = null,
    focusable: () => scala.Boolean = null,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[scala.Double], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[scala.Boolean]) => ILayer = null,
    ...
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => ILayer = null,
    mixins: js.Any = null,
    monitorMouseLeave: (/* delay */ js.UndefOr[scala.Double], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    moveTo: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => ILayer = null,
    needsTabIndex: () => scala.Unit = null,
    next: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[scala.Boolean]) => _ = null,
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    pause: /* seconds */ js.UndefOr[scala.Double] => ILayer = null,
    ...
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ILayer = null,
    repaint: () => IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => ILayer = null,
    replaceCls: (/* oldClassName */ js.UndefOr[java.lang.String], /* newClassName */ js.UndefOr[java.lang.String]) => IElement = null,
    replaceWith: /* el */ js.UndefOr[js.Any] => ILayer = null,
    requires: extjsLib.ExtNs.Array = null,
    scale: (/* width */ js.UndefOr[scala.Double], /* height */ js.UndefOr[scala.Double], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[scala.Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[scala.Boolean]) => ILayer = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => ILayer = null,
    ...
    set: (/* o */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[scala.Boolean]) => IElement = null,
    ...
    setLocation: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => ILayer = null,
    setOpacity: (/* opacity */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => ILayer = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => ILayer = null,
    setRight: /* right */ js.UndefOr[js.Any] => ILayer = null,
    setScrollLeft: /* left */ js.UndefOr[scala.Double] => ILayer = null,
    setScrollTop: /* top */ js.UndefOr[scala.Double] => ILayer = null,
    ...
    setZIndex: /* zindex */ js.UndefOr[scala.Double] => ILayer = null,
    shadow: js.Any = null,
    ...
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => ILayer = null,
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[scala.Boolean]) => ILayer = null,
    ...
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ILayer = null,
    unclip: () => ILayer = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[scala.Boolean], /* callback */ js.UndefOr[js.Any]) => ILayer = null,
