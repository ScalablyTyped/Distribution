...
trait IContainer
  extends extjsLib.ExtNs.containerNs.IAbstractContainer {
  ...
  var getChildByElement: js.UndefOr[
    js.Function2[/* el */ js.UndefOr[js.Any], /* deep */ js.UndefOr[scala.Boolean], IComponent]
  ] = js.undefined
}
...
object IContainer {
  ...
  def apply(
    ...
    getChildByElement: (/* el */ js.UndefOr[js.Any], /* deep */ js.UndefOr[scala.Boolean]) => IComponent = null
  ): IContainer = {
