...
object IErrors {
  ...
  def apply(
    ...
    clone: () => extjsLib.ExtNs.utilNs.IMixedCollection = null,
    ...
    filter: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any], /* anyMatch */ js.UndefOr[scala.Boolean], /* caseSensitive */ js.UndefOr[scala.Boolean]) => extjsLib.ExtNs.utilNs.IMixedCollection = null,
    filterBy: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => extjsLib.ExtNs.utilNs.IMixedCollection = null,
    ...
    getByField: /* fieldName */ js.UndefOr[java.lang.String] => extjsLib.ExtNs.Array = null,
    ...
    removeAll: /* items */ js.UndefOr[extjsLib.ExtNs.Array] => extjsLib.ExtNs.utilNs.IMixedCollection = null,
