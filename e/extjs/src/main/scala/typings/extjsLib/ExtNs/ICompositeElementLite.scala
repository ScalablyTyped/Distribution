...
object ICompositeElementLite {
  @scala.inline
  def apply(
    add: /* els */ js.UndefOr[js.Any] => extjsLib.ExtNs.domNs.ICompositeElement = null,
    alias: Array = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.ICompositeElement = null,
    elements: Array = null,
    extend: java.lang.String = null,
    fill: /* els */ js.UndefOr[js.Any] => extjsLib.ExtNs.domNs.ICompositeElement = null,
    filter: /* selector */ js.UndefOr[js.Any] => extjsLib.ExtNs.domNs.ICompositeElement = null,
    first: () => extjsLib.ExtNs.domNs.IElement = null,
    ...
    item: /* index */ js.UndefOr[scala.Double] => extjsLib.ExtNs.domNs.IElement = null,
    last: () => extjsLib.ExtNs.domNs.IElement = null,
    mixins: js.Any = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[scala.Boolean]) => extjsLib.ExtNs.domNs.ICompositeElement = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[scala.Boolean]) => extjsLib.ExtNs.domNs.ICompositeElement = null,
    requires: Array = null,
    self: IClass = null,
    singleton: js.UndefOr[scala.Boolean] = js.undefined,
    slice: (/* start */ js.UndefOr[scala.Double], /* end */ js.UndefOr[scala.Double]) => Array = null,
    statics: js.Any = null,
    uses: Array = null
