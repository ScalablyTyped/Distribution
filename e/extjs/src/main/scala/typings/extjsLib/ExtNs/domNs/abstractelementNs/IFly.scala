package typings
package extjsLib.ExtNs.domNs.abstractelementNs
...
object IFly {
  ...
  def apply(
    ...
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[scala.Boolean]) => IFly = null,
    ...
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[stdLib.HTMLElement], /* returnDom */ js.UndefOr[scala.Boolean]) => IFly = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[scala.Boolean]) => IFly = null,
    ...
    focus: /* defer */ js.UndefOr[scala.Double] => IFly = null,
    focusable: () => scala.Boolean = null,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[scala.Double], /* options */ js.UndefOr[js.Any]) => IFly = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[scala.Boolean]) => IFly = null,
    is: /* selector */ js.UndefOr[java.lang.String] => scala.Boolean = null,
    isBorderBox: () => scala.Boolean = null,
    isDisplayed: () => scala.Boolean = null,
    isFly: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    moveTo: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    ...
    pause: /* seconds */ js.UndefOr[scala.Double] => IFly = null,
    ...
    scale: (/* width */ js.UndefOr[scala.Double], /* height */ js.UndefOr[scala.Double], /* options */ js.UndefOr[js.Any]) => IFly = null,
    ...
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[scala.Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[scala.Boolean]) => IFly = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    ...
    setBounds: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    ...
    setLocation: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    setOpacity: (/* opacity */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => IFly = null,
    setRight: /* right */ js.UndefOr[js.Any] => IFly = null,
    setScrollLeft: /* left */ js.UndefOr[scala.Double] => IFly = null,
    setScrollTop: /* top */ js.UndefOr[scala.Double] => IFly = null,
    ...
    setVisible: (/* visible */ js.UndefOr[scala.Boolean], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    ...
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[scala.Boolean]) => IFly = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[scala.Boolean], /* callback */ js.UndefOr[js.Any]) => IFly = null,
