...
object ICellEditing {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], ICellEditing] = null,
    ...
    startEditByPosition: js.Function1[/* position */ js.UndefOr[js.Any], scala.Unit] = null,
    statics: js.Any = null,
    ...
    if (startEditByPosition != null) __obj.updateDynamic("startEditByPosition")(startEditByPosition)
