...
object IDragTracker {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IDragTracker] = null,
    ...
    onBeforeStart: js.Function1[/* e */ js.UndefOr[extjsLib.ExtNs.IEventObject], scala.Unit] = null,
    onDrag: js.Function1[/* e */ js.UndefOr[extjsLib.ExtNs.IEventObject], scala.Unit] = null,
    onEnd: js.Function1[/* e */ js.UndefOr[extjsLib.ExtNs.IEventObject], scala.Unit] = null,
    onStart: js.Function1[/* e */ js.UndefOr[extjsLib.ExtNs.IEventObject], scala.Unit] = null,
