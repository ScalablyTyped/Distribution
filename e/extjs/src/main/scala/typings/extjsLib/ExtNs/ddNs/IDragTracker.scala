...
object IDragTracker {
  ...
  def apply(
    ...
    onDrag: /* e */ js.UndefOr[extjsLib.ExtNs.IEventObject] => scala.Unit = null,
    onEnd: /* e */ js.UndefOr[extjsLib.ExtNs.IEventObject] => scala.Unit = null,
    onStart: /* e */ js.UndefOr[extjsLib.ExtNs.IEventObject] => scala.Unit = null,
