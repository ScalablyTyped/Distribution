...
object ICheckboxModel {
  ...
  def apply(
    ...
    getCurrentPosition: () => scala.Unit = null,
    getHeaderConfig: () => scala.Unit = null,
    ...
    isFocused: /* record */ js.UndefOr[ICheckboxModel] => scala.Unit = null,
    ...
    onHeaderClick: (/* headerCt */ js.UndefOr[js.Any], /* header */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    renderer: (/* value */ js.UndefOr[js.Any], /* metaData */ js.UndefOr[js.Any], /* record */ js.UndefOr[js.Any], /* rowIndex */ js.UndefOr[js.Any], /* colIndex */ js.UndefOr[js.Any], /* store */ js.UndefOr[js.Any], /* view */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    selectNext: (/* keepExisting */ js.UndefOr[scala.Boolean], /* suppressEvent */ js.UndefOr[scala.Boolean]) => scala.Boolean = null,
    selectPrevious: (/* keepExisting */ js.UndefOr[scala.Boolean], /* suppressEvent */ js.UndefOr[scala.Boolean]) => scala.Boolean = null,
    ...
    setLastFocused: /* record */ js.UndefOr[ICheckboxModel] => scala.Unit = null,
