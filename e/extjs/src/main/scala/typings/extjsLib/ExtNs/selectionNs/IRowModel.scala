...
object IRowModel {
  ...
  def apply(
    ...
    getLastSelected: js.Function0[IRowModel] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IRowModel] = null,
    isFocused: js.Function1[/* record */ js.UndefOr[IRowModel], scala.Unit] = null,
    ...
    setLastFocused: js.Function1[/* record */ js.UndefOr[IRowModel], scala.Unit] = null,
