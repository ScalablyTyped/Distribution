...
object FocusMgr extends js.Object {
  ...
  var focusedCmp: extjsLib.ExtNs.IComponent = js.native
  /** [Property] (Object) */
  ...
  /** [Property] (String[]) */
  var whitelist: extjsLib.ExtNs.Array = js.native
  ...
  /** [Method] Adds the specified xtype to the whitelist
  		...
  		*/
  def addXTypeToWhitelist(): scala.Unit = js.native
  def addXTypeToWhitelist(xtype: js.Any): scala.Unit = js.native
  ...
  def enable(options: js.Any): scala.Unit = js.native
  ...
  /** [Method] Removes the specified xtype from the whitelist
  		...
  		*/
  def removeXTypeFromWhitelist(): scala.Unit = js.native
  def removeXTypeFromWhitelist(xtype: js.Any): scala.Unit = js.native
