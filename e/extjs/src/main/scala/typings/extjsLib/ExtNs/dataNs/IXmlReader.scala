...
object IXmlReader {
  ...
  def apply(
    ...
    getData: js.Function1[/* data */ js.UndefOr[js.Any], _] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IXmlReader] = null,
    ...
    readRecords: js.Function1[/* doc */ js.UndefOr[js.Any], IResultSet] = null,
