...
object ExtNsMembers extends js.Object {
  ...
  def callback(callback: js.Any, scope: js.Any, args: Array, delay: scala.Double): js.Any = js.native
  ...
  def query(path: java.lang.String, root: stdLib.HTMLElement): Array = js.native
  def query(path: java.lang.String, root: stdLib.HTMLElement, `type`: java.lang.String): Array = js.native
  def query(path: java.lang.String, root: stdLib.HTMLElement, `type`: java.lang.String, single: scala.Boolean): Array = js.native
  ...
  def select(selector: java.lang.String, unique: scala.Boolean): ICompositeElement = js.native
