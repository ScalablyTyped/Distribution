...
trait IColorPalette extends IComponent {
  ...
  @JSName("onRender")
  var onRender_IColorPalette: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
...
object IColorPalette {
  ...
  def apply(
    ...
    scope: js.Any = null,
    select: (/* color */ js.UndefOr[java.lang.String], /* suppressEvent */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
