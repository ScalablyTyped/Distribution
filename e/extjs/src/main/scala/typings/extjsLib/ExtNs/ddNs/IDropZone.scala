...
object IDropZone {
  ...
  def apply(
    ...
    getTargetFromEvent: /* e */ js.UndefOr[stdLib.Event] => _ = null,
    groups: js.Any = null,
    ...
    onContainerDrop: (/* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Boolean = null,
    onContainerOver: (/* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => java.lang.String = null,
    ...
    onNodeDrop: (/* nodeData */ js.UndefOr[js.Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Boolean = null,
    onNodeEnter: (/* nodeData */ js.UndefOr[js.Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Unit = null,
    onNodeOut: (/* nodeData */ js.UndefOr[js.Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => scala.Unit = null,
    onNodeOver: (/* nodeData */ js.UndefOr[js.Any], /* source */ js.UndefOr[IDragSource], /* e */ js.UndefOr[stdLib.Event], /* data */ js.UndefOr[js.Any]) => java.lang.String = null,
