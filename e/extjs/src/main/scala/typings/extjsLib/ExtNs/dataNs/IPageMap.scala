...
object IPageMap {
  ...
  def apply(
    ...
    clear: /* initial */ js.UndefOr[js.Any] => extjsLib.ExtNs.utilNs.IHashMap = null,
    clearListeners: () => scala.Unit = null,
    clearManagedListeners: () => scala.Unit = null,
    clone: () => extjsLib.ExtNs.utilNs.IHashMap = null,
    config: js.Any = null,
    contains: /* value */ js.UndefOr[js.Any] => scala.Boolean = null,
    containsKey: /* key */ js.UndefOr[java.lang.String] => scala.Boolean = null,
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* reverse */ js.UndefOr[scala.Boolean]) => IPageMap = null,
    enableBubble: /* eventNames */ js.UndefOr[js.Any] => scala.Unit = null,
    extend: java.lang.String = null,
    findBy: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    findIndexBy: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Double = null,
