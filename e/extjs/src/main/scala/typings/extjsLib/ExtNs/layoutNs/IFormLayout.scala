...
object IFormLayout {
  ...
  def apply(
    ...
    calculateOverflow: (/* ownerContext */ js.UndefOr[IContextItem], /* containerSize */ js.UndefOr[js.Any], /* dimensions */ js.UndefOr[scala.Double]) => scala.Unit = null,
    ...
    getContainerSize: (/* ownerContext */ js.UndefOr[IContextItem], /* inDom */ js.UndefOr[scala.Boolean], /* ignoreOverflow */ js.UndefOr[scala.Boolean]) => _ = null,
