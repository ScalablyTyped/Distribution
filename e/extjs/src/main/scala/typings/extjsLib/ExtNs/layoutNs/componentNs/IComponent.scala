...
object IComponent {
  ...
  def apply(
    ...
    calculate: js.Function1[/* ownerContext */ js.UndefOr[extjsLib.ExtNs.layoutNs.IContextItem], scala.Unit] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IComponent] = null,
