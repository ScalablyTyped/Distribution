...
object Region extends js.Object {
  ...
  /** [Method] Creates a Region from a box Object which contains four numeric properties top right bottom and left
  		...
  		*/
  def from(): extjsLib.ExtNs.utilNs.IRegion = js.native
  def from(o: js.Any): extjsLib.ExtNs.utilNs.IRegion = js.native
  ...
  def getRegion(el: js.Any): extjsLib.ExtNs.utilNs.IRegion = js.native
