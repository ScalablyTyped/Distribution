...
object CSS extends js.Object {
  ...
  /** [Method] Creates a rule
  		...
  		*/
  def createRule(): stdLib.CSSStyleRule = js.native
  def createRule(styleSheet: stdLib.CSSStyleSheet): stdLib.CSSStyleRule = js.native
  def createRule(styleSheet: stdLib.CSSStyleSheet, selector: java.lang.String): stdLib.CSSStyleRule = js.native
  def createRule(styleSheet: stdLib.CSSStyleSheet, selector: java.lang.String, property: java.lang.String): stdLib.CSSStyleRule = js.native
  /** [Method] Creates a stylesheet from a text blob of rules
  		...
  		*/
  def createStyleSheet(): stdLib.CSSStyleSheet = js.native
  def createStyleSheet(cssText: java.lang.String): stdLib.CSSStyleSheet = js.native
  def createStyleSheet(cssText: java.lang.String, id: java.lang.String): stdLib.CSSStyleSheet = js.native
  ...
  /** [Method] Gets an an individual CSS rule by selector s
  		...
  		*/
  def getRule(): stdLib.CSSStyleRule = js.native
  def getRule(selector: js.Any): stdLib.CSSStyleRule = js.native
  def getRule(selector: js.Any, refreshCache: scala.Boolean): stdLib.CSSStyleRule = js.native
  ...
  def getRules(refreshCache: scala.Boolean): js.Any = js.native
  ...
  /** [Method] Removes a style or link tag by id
  		...
  		*/
  def removeStyleSheet(): scala.Unit = js.native
  def removeStyleSheet(id: java.lang.String): scala.Unit = js.native
  ...
  /** [Method] Dynamically swaps an existing stylesheet reference for a new one
  		...
  		*/
  def swapStyleSheet(): scala.Unit = js.native
  def swapStyleSheet(id: java.lang.String): scala.Unit = js.native
  def swapStyleSheet(id: java.lang.String, url: java.lang.String): scala.Unit = js.native
  /** [Method] Updates a rule property
  		...
  		*/
  def updateRule(): scala.Boolean = js.native
  def updateRule(selector: js.Any): scala.Boolean = js.native
  def updateRule(selector: js.Any, property: java.lang.String): scala.Boolean = js.native
  def updateRule(selector: js.Any, property: java.lang.String, value: java.lang.String): scala.Boolean = js.native
}
