...
trait IBasicForm
  ...
  /** [Method] Resets all fields in this form
  		...
  		* @returns Ext.form.Basic this
  		*/
  var reset: js.UndefOr[js.Function1[/* resetRecord */ js.UndefOr[scala.Boolean], IBasic]] = js.undefined
...
object IBasicForm {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IBasicForm] = null,
