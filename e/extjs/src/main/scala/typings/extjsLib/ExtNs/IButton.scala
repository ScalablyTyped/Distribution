...
object IButton {
  ...
  def apply(
    ...
    handler: js.Any = null,
    hasVisibleMenu: js.Function0[scala.Boolean] = null,
    hidden: js.UndefOr[scala.Boolean] = js.undefined,
    hideMenu: js.Function0[IButton] = null,
    ...
    scale: js.Any = null,
    scope: js.Any = null,
    setGlyph: js.Function1[/* glyph */ js.UndefOr[js.Any], IButton] = null,
    setHandler: js.Function2[/* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], IButton] = null,
    setHref: js.Function1[/* href */ js.UndefOr[java.lang.String], scala.Unit] = null,
    setIcon: js.Function1[/* icon */ js.UndefOr[java.lang.String], IButton] = null,
    setIconCls: js.Function1[/* cls */ js.UndefOr[java.lang.String], IButton] = null,
    setParams: js.Function1[/* params */ js.UndefOr[js.Any], scala.Unit] = null,
    setScale: js.Function1[/* scale */ js.UndefOr[java.lang.String], scala.Unit] = null,
    setText: js.Function1[/* text */ js.UndefOr[java.lang.String], IButton] = null,
    setTextAlign: js.Function1[/* align */ js.UndefOr[java.lang.String], scala.Unit] = null,
    setTooltip: js.Function1[/* tooltip */ js.UndefOr[js.Any], IButton] = null,
    setUI: js.Function1[/* ui */ js.UndefOr[js.Any], scala.Unit] = null,
    showEmptyMenu: js.UndefOr[scala.Boolean] = js.undefined,
    showMenu: js.Function1[/* fromEvent */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (hasVisibleMenu != null) __obj.updateDynamic("hasVisibleMenu")(hasVisibleMenu)
    ...
    if (setHref != null) __obj.updateDynamic("setHref")(setHref)
    ...
    if (setTextAlign != null) __obj.updateDynamic("setTextAlign")(setTextAlign)
