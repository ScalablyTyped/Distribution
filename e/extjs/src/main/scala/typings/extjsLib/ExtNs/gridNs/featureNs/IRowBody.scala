...
object IRowBody {
  ...
  def apply(
    ...
    getAdditionalData: js.Function4[
      /* data */ js.UndefOr[js.Any], 
      /* idx */ js.UndefOr[scala.Double], 
      /* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel], 
      /* orig */ js.UndefOr[js.Any], 
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IRowBody] = null,
    ...
    if (getAdditionalData != null) __obj.updateDynamic("getAdditionalData")(getAdditionalData)
