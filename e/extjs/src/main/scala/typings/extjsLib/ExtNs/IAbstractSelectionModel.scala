...
- extjsLib.ExtNs.utilNs.IBindable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined bindStore, bindStoreListeners, getStore, getStoreListeners, onBindStore, onUnbindStore, unbindStoreListeners */ trait IAbstractSelectionModel
  ...
  /** [Method]
  		...
  		*/
  var getLastSelected: js.UndefOr[js.Function0[extjsLib.ExtNs.dataNs.IModel]] = js.undefined
  ...
  /** [Method] Determines if this record is currently focused
  		...
  		*/
  var isFocused: js.UndefOr[js.Function1[/* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets a record as the last focused record
  		* @param record Ext.data.Model
  		*/
  var setLastFocused: js.UndefOr[js.Function1[/* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel], scala.Unit]] = js.undefined
...
object IAbstractSelectionModel {
  ...
  def apply(
    ...
    getLastSelected: js.Function0[extjsLib.ExtNs.dataNs.IModel] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IAbstractSelectionModel] = null,
    isFocused: js.Function1[/* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel], scala.Unit] = null,
    ...
    self: IClass = null,
    setLastFocused: js.Function1[/* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel], scala.Unit] = null,
