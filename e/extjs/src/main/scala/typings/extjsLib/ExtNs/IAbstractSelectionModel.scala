...
object IAbstractSelectionModel {
  ...
  def apply(
    ...
    getLastSelected: () => extjsLib.ExtNs.dataNs.IModel = null,
    ...
    isFocused: /* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel] => scala.Unit = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel] => scala.Unit = null,
