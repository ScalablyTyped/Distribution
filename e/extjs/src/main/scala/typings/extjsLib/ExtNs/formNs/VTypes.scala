...
object VTypes extends js.Object {
  /** [Property] (RegExp) */
  var alphaMask: stdLib.RegExp = js.native
  /** [Property] (String) */
  var alphaText: java.lang.String = js.native
  /** [Property] (RegExp) */
  var alphanumMask: stdLib.RegExp = js.native
  /** [Property] (String) */
  var alphanumText: java.lang.String = js.native
  /** [Property] (RegExp) */
  var emailMask: stdLib.RegExp = js.native
  /** [Property] (String) */
  ...
  /** [Method] The function used to validate alpha values
  		...
  		*/
  def alpha(): scala.Boolean = js.native
  def alpha(value: java.lang.String): scala.Boolean = js.native
  /** [Method] The function used to validate alphanumeric values
  		* @param value String The value
  		* @returns Boolean true if the RegExp test passed, and false if not.
  		*/
  def alphanum(): scala.Boolean = js.native
  def alphanum(value: java.lang.String): scala.Boolean = js.native
  ...
  def email(value: java.lang.String): scala.Boolean = js.native
  ...
  /** [Method] The function used to validate URLs
  		...
  		* @returns Boolean true if the RegExp test passed, and false if not.
  		*/
  def url(): scala.Boolean = js.native
  def url(value: java.lang.String): scala.Boolean = js.native
}
