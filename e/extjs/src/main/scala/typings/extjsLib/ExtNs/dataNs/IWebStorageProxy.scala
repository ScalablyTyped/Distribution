...
object IWebStorageProxy {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IWebStorageProxy] = null,
    ...
    setRecord: js.Function2[/* record */ js.UndefOr[IModel], /* id */ js.UndefOr[java.lang.String], scala.Unit] = null,
