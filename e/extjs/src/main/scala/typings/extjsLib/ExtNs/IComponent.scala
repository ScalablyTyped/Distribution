...
object IComponent {
  ...
  def apply(
    ...
    afterHide: (/* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    afterRender: () => scala.Unit = null,
    afterSetPosition: (/* ax */ js.UndefOr[js.Any], /* ay */ js.UndefOr[js.Any]) => scala.Unit = null,
    afterShow: (/* animateTarget */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    findParentBy: /* fn */ js.UndefOr[js.Any] => extjsLib.ExtNs.containerNs.IContainer = null,
    findParentByType: /* xtype */ js.UndefOr[js.Any] => extjsLib.ExtNs.containerNs.IContainer = null,
    floatParent: IContainer = null,
    floating: js.UndefOr[scala.Boolean] = js.undefined,
    focus: (/* selectText */ js.UndefOr[scala.Boolean], /* delay */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IComponent = null,
    formBind: js.UndefOr[scala.Boolean] = js.undefined,
    getEl: () => extjsLib.ExtNs.domNs.IElement = null,
    getId: () => java.lang.String = null,
    getPosition: /* local */ js.UndefOr[scala.Boolean] => Array = null,
    ...
    onHide: (/* animateTarget */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    onShow: (/* animateTarget */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    onShowComplete: (/* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    overflowX: java.lang.String = null,
    overflowY: java.lang.String = null,
    region: js.Any = null,
    resizable: js.Any = null,
    resizeHandles: java.lang.String = null,
    scrollBy: (/* deltaX */ js.UndefOr[js.Any], /* deltaY */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => scala.Unit = null,
    scrollFlags: js.Any = null,
    setActive: (/* active */ js.UndefOr[scala.Boolean], /* newActive */ js.UndefOr[IComponent]) => scala.Unit = null,
    setAutoScroll: /* scroll */ js.UndefOr[scala.Boolean] => IComponent = null,
    setBorderRegion: /* region */ js.UndefOr[java.lang.String] => java.lang.String = null,
    setLoading: (/* load */ js.UndefOr[js.Any], /* targetEl */ js.UndefOr[scala.Boolean]) => ILoadMask = null,
    setOverflowXY: (/* overflowX */ js.UndefOr[java.lang.String], /* overflowY */ js.UndefOr[java.lang.String]) => IComponent = null,
    setPagePosition: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IComponent = null,
    setPosition: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IComponent = null,
    setRegionWeight: /* weight */ js.UndefOr[scala.Double] => scala.Double = null,
    show: (/* animateTarget */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IComponent = null,
    showAt: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[scala.Double], /* animate */ js.UndefOr[js.Any]) => IComponent = null,
