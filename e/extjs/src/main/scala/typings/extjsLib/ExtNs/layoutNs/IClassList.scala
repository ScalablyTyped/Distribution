...
object IClassList {
  @scala.inline
  def apply(
    add: /* cls */ js.UndefOr[js.Any] => scala.Unit = null,
    addMany: /* classes */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    mixins: js.Any = null,
    remove: /* cls */ js.UndefOr[js.Any] => scala.Unit = null,
    removeMany: /* classes */ js.UndefOr[js.Any] => scala.Unit = null,
