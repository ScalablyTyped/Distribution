...
object ITreeModel {
  ...
  def apply(
    ...
    getLastSelected: js.Function0[ITreeModel] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], ITreeModel] = null,
    isFocused: js.Function1[/* record */ js.UndefOr[ITreeModel], scala.Unit] = null,
    ...
    setLastFocused: js.Function1[/* record */ js.UndefOr[ITreeModel], scala.Unit] = null,
