...
object ILocalStorageProvider {
  ...
  def apply(
    ...
    clear: /* name */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => ILocalStorageProvider = null,
    ...
    set: (/* name */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    if (decodeValue != null) __obj.updateDynamic("decodeValue")(js.Any.fromFunction1(decodeValue))
    if (enableBubble != null) __obj.updateDynamic("enableBubble")(js.Any.fromFunction1(enableBubble))
    if (encodeValue != null) __obj.updateDynamic("encodeValue")(js.Any.fromFunction1(encodeValue))
