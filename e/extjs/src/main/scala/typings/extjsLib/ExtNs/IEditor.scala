...
object IEditor {
  ...
  def apply(
    ...
    afterRender: (/* ct */ js.UndefOr[js.Any], /* position */ js.UndefOr[js.Any]) => scala.Unit = null,
    alignment: java.lang.String = null,
    allowBlur: js.UndefOr[scala.Boolean] = js.undefined,
    autoSize: js.Any = null,
    baseCls: java.lang.String = null,
    cancelEdit: /* remainVisible */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    cancelOnEsc: js.UndefOr[scala.Boolean] = js.undefined,
    completeEdit: /* remainVisible */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    ...
    realign: /* autoSize */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    revertInvalid: js.UndefOr[scala.Boolean] = js.undefined,
    setValue: /* value */ js.UndefOr[js.Any] => scala.Unit = null,
    shadow: js.Any = null,
    startEdit: (/* el */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => scala.Unit = null,
