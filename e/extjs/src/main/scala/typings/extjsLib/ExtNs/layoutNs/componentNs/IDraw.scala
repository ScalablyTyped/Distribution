...
object IDraw {
  ...
  def apply(
    ...
    beginLayout: js.Function1[/* ownerContext */ js.UndefOr[extjsLib.ExtNs.layoutNs.IContextItem], scala.Unit] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IDraw] = null,
