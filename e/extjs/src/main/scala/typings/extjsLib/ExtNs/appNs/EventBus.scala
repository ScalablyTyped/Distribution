...
object EventBus extends js.Object {
  ...
  /** [Method] Adds a set of component event listeners for a controller
  		...
  		*/
  def control(): scala.Unit = js.native
  def control(selectors: js.Any): scala.Unit = js.native
  def control(selectors: js.Any, controller: extjsLib.ExtNs.appNs.IController): scala.Unit = js.native
  ...
  def listen(to: js.Any): scala.Unit = js.native
  def listen(to: js.Any, controller: extjsLib.ExtNs.appNs.IController): scala.Unit = js.native
  ...
  def unlisten(controllerId: java.lang.String): scala.Unit = js.native
}
