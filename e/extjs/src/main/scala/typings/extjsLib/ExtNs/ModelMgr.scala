...
@js.native
class ModelMgr () extends js.Object
...
object ModelMgr extends js.Object {
  ...
  var associationStack: extjsLib.ExtNs.Array = js.native
  /** [Property] (Ext.Class) */
  ...
  def create(data: js.Any, name: java.lang.String): scala.Unit = js.native
  def create(data: js.Any, name: java.lang.String, id: scala.Double): scala.Unit = js.native
  ...
  /** [Method] Returns the Ext data Model class for a given model name
  		...
  		*/
  def getModel(): extjsLib.ExtNs.dataNs.IModel = js.native
  def getModel(id: js.Any): extjsLib.ExtNs.dataNs.IModel = js.native
