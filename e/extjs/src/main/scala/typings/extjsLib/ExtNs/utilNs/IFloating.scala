...
object IFloating {
  ...
  def apply(
    ...
    center: () => extjsLib.ExtNs.IComponent = null,
    config: js.Any = null,
    ...
    setActive: (/* active */ js.UndefOr[scala.Boolean], /* newActive */ js.UndefOr[extjsLib.ExtNs.IComponent]) => scala.Unit = null,
    shadow: js.Any = null,
    shadowOffset: scala.Int | scala.Double = null,
    singleton: js.UndefOr[scala.Boolean] = js.undefined,
    statics: js.Any = null,
    toBack: () => extjsLib.ExtNs.IComponent = null,
    toFront: /* preventFocus */ js.UndefOr[scala.Boolean] => extjsLib.ExtNs.IComponent = null,
