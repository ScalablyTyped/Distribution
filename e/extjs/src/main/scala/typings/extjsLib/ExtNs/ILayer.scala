...
object ILayer {
  ...
  def apply(
    ...
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[scala.Boolean]) => ICompositeElement = null,
    ...
    setBounds: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    setDisplayed: /* value */ js.UndefOr[js.Any] => ILayer = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => IElement = null,
    setHeight: (/* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    setLeft: /* left */ js.UndefOr[js.Any] => extjsLib.ExtNs.domNs.IElement = null,
    setLeftTop: (/* left */ js.UndefOr[js.Any], /* top */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    ...
    setSize: (/* w */ js.UndefOr[js.Any], /* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => extjsLib.ExtNs.domNs.IElement = null,
    setTop: /* top */ js.UndefOr[js.Any] => extjsLib.ExtNs.domNs.IElement = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => ILayer = null,
    setVisible: (/* visible */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    setWidth: (/* w */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => extjsLib.ExtNs.domNs.IElement = null,
    ...
    up: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[scala.Boolean]) => IElement = null,
