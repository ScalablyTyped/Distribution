...
object IDragZone {
  ...
  def apply(
    ...
    getRepairXY: js.Function2[/* e */ js.UndefOr[js.Any], /* data */ js.UndefOr[js.Any], extjsLib.ExtNs.Array] = null,
    groups: js.Any = null,
    ...
    onInitDrag: js.Function2[/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], scala.Boolean] = null,
