...
object IDragZone {
  ...
  def apply(
    ...
    getRepairXY: (/* e */ js.UndefOr[js.Any], /* data */ js.UndefOr[js.Any]) => extjsLib.ExtNs.Array = null,
    groups: js.Any = null,
    ...
    init: (/* id */ js.UndefOr[js.Any], /* sGroup */ js.UndefOr[js.Any], /* config */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    onInitDrag: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any]) => scala.Boolean = null,
