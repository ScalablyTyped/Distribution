...
object ICellModel {
  ...
  def apply(
    ...
    config: js.Any = null,
    deselect: js.Function2[/* record */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    getLastSelected: js.Function0[ICellModel] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], ICellModel] = null,
    isFocused: js.Function1[/* record */ js.UndefOr[ICellModel], scala.Unit] = null,
    ...
    preventWrap: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    setCurrentPosition: js.Function2[
      /* position */ js.UndefOr[js.Any], 
      /* suppressEvent */ js.UndefOr[scala.Boolean], 
      scala.Unit
    ] = null,
    setLastFocused: js.Function1[/* record */ js.UndefOr[ICellModel], scala.Unit] = null,
    ...
    if (!js.isUndefined(preventWrap)) __obj.updateDynamic("preventWrap")(preventWrap)
    ...
    if (setCurrentPosition != null) __obj.updateDynamic("setCurrentPosition")(setCurrentPosition)
