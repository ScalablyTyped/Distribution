...
object ICellModel {
  ...
  def apply(
    ...
    config: js.Any = null,
    deselect: (/* record */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    isFocused: /* record */ js.UndefOr[ICellModel] => scala.Unit = null,
    ...
    select: (/* pos */ js.UndefOr[js.Any], /* keepExisting */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    setCurrentPosition: (/* position */ js.UndefOr[js.Any], /* suppressEvent */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
    setLastFocused: /* record */ js.UndefOr[ICellModel] => scala.Unit = null,
