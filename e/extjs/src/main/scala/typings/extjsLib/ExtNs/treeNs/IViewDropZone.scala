...
object IViewDropZone {
  ...
  def apply(
    ...
    allowContainerDrop: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    onNodeOut: (/* n */ js.UndefOr[js.Any], /* dd */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any], /* data */ js.UndefOr[js.Any]) => scala.Unit = null,
