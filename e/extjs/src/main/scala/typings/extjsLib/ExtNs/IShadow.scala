...
object IShadow {
  ...
  def apply(
    ...
    isVisible: () => scala.Unit = null,
    mixins: js.Any = null,
    mode: java.lang.String = null,
    offset: scala.Int | scala.Double = null,
    realign: (/* left */ js.UndefOr[scala.Double], /* top */ js.UndefOr[scala.Double], /* width */ js.UndefOr[scala.Double], /* height */ js.UndefOr[scala.Double]) => scala.Unit = null,
    requires: Array = null,
    self: IClass = null,
    setOpacity: /* opacity */ js.UndefOr[scala.Double] => scala.Unit = null,
    setZIndex: /* zindex */ js.UndefOr[scala.Double] => scala.Unit = null,
    show: /* targetEl */ js.UndefOr[js.Any] => scala.Unit = null,
