...
trait IProgressBar extends IAuto {
  /** [Method] Called before any calculation cycles to prepare for layout
  		...
  		*/
  @JSName("beginLayout")
  var beginLayout_IProgressBar: js.UndefOr[js.Function1[/* ownerContext */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object IProgressBar {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IProgressBar] = null,
