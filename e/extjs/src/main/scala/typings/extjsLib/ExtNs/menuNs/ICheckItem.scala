...
object ICheckItem {
  ...
  def apply(
    ...
    disableCheckChange: () => scala.Unit = null,
    enableCheckChange: () => scala.Unit = null,
    ...
    scope: js.Any = null,
    setChecked: (/* checked */ js.UndefOr[scala.Boolean], /* suppressEvents */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
