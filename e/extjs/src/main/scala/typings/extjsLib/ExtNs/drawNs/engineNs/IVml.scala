...
trait IVml
  ...
  var setText_IVml: js.UndefOr[
    js.Function2[/* sprite */ js.UndefOr[js.Any], /* text */ js.UndefOr[js.Any], scala.Unit]
  ] = js.undefined
}
...
object IVml {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IVml] = null,
    ...
    setText: js.Function2[/* sprite */ js.UndefOr[js.Any], /* text */ js.UndefOr[js.Any], scala.Unit] = null,
