...
trait IBarChart
  ...
  var highlightItem_IBarChart: js.UndefOr[js.Function1[/* item */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Config Option] (Boolean) */
  ...
  var unHighlightItem_IBarChart: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
...
object IBarChart {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IBarChart = null,
