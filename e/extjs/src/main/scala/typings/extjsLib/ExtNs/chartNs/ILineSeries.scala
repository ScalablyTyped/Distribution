...
trait ILineSeries
  ...
  /** [Config Option] (Boolean) */
  var showMarkers: js.UndefOr[scala.Boolean] = js.undefined
...
object ILineSeries {
  ...
  def apply(
    ...
    getLegendColor: /* index */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => ILineSeries = null,
    ...
    showMarkers: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (markerConfig != null) __obj.updateDynamic("markerConfig")(markerConfig)
    ...
    if (!js.isUndefined(showMarkers)) __obj.updateDynamic("showMarkers")(showMarkers)
