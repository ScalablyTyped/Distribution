...
object IPropertyStore {
  ...
  def apply(
    ...
    addSorted: /* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IRecord] => scala.Unit = null,
    ...
    findRecord: (/* fieldName */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[js.Any], /* startIndex */ js.UndefOr[scala.Double], /* anyMatch */ js.UndefOr[scala.Boolean], /* caseSensitive */ js.UndefOr[scala.Boolean], /* exactMatch */ js.UndefOr[scala.Boolean]) => extjsLib.ExtNs.dataNs.IModel = null,
    ...
    getAt: /* index */ js.UndefOr[scala.Double] => extjsLib.ExtNs.dataNs.IModel = null,
    getById: /* id */ js.UndefOr[js.Any] => extjsLib.ExtNs.dataNs.IModel = null,
    ...
    indexOf: /* record */ js.UndefOr[extjsLib.ExtNs.dataNs.IModel] => scala.Double = null,
    ...
    sync: /* options */ js.UndefOr[js.Any] => extjsLib.ExtNs.dataNs.IStore = null,
