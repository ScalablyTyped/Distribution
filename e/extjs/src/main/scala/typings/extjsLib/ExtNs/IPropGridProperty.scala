...
object IPropGridProperty {
  ...
  def apply(
    ...
    commit: (/* silent */ js.UndefOr[scala.Boolean], /* modifiedFieldNames */ js.UndefOr[Array]) => scala.Unit = null,
    config: js.Any = null,
    ...
    endEdit: (/* silent */ js.UndefOr[scala.Boolean], /* modifiedFieldNames */ js.UndefOr[Array]) => scala.Unit = null,
