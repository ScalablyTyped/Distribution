...
trait IPropGridProperty
  ...
  @JSName("fields")
  var fields_IPropGridProperty: js.UndefOr[extjsLib.ExtNs.utilNs.IMixedCollection] = js.undefined
}
...
object IPropGridProperty {
  ...
  def apply(
    ...
    commit: js.Function2[
      ...
      /* modifiedFieldNames */ js.UndefOr[Array], 
      scala.Unit
    ] = null,
    config: js.Any = null,
    copy: js.Function1[/* id */ js.UndefOr[java.lang.String], IPropGridProperty] = null,
    defaultProxyType: java.lang.String = null,
    destroy: js.Function1[/* options */ js.UndefOr[js.Any], IPropGridProperty] = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IPropGridProperty] = null,
    ...
    save: js.Function1[/* options */ js.UndefOr[js.Any], IPropGridProperty] = null,
    self: IClass = null,
    set: js.Function2[/* fieldName */ js.UndefOr[js.Any], /* newValue */ js.UndefOr[js.Any], Array] = null,
