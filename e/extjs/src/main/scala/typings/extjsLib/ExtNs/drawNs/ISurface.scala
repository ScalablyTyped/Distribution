...
object ISurface {
  ...
  def apply(
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], ISurface] = null,
    ...
    setSize: js.Function2[/* w */ js.UndefOr[scala.Double], /* h */ js.UndefOr[scala.Double], scala.Unit] = null,
    setStyle: js.Function2[/* sprite */ js.UndefOr[js.Any], /* styles */ js.UndefOr[js.Any], scala.Unit] = null,
    setText: js.Function2[/* sprite */ js.UndefOr[js.Any], /* text */ js.UndefOr[java.lang.String], scala.Unit] = null,
