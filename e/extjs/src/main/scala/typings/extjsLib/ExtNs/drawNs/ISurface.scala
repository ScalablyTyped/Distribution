...
object ISurface {
  ...
  def apply(
    ...
    remove: (/* sprite */ js.UndefOr[ISprite], /* destroySprite */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
    ...
    setSize: (/* w */ js.UndefOr[scala.Double], /* h */ js.UndefOr[scala.Double]) => scala.Unit = null,
    setStyle: (/* sprite */ js.UndefOr[js.Any], /* styles */ js.UndefOr[js.Any]) => scala.Unit = null,
    setText: (/* sprite */ js.UndefOr[js.Any], /* text */ js.UndefOr[java.lang.String]) => scala.Unit = null,
