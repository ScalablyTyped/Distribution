...
object IDragZone {
  ...
  def apply(
    ...
    getDragData: js.Function1[/* e */ js.UndefOr[stdLib.Event], _] = null,
    ...
    getRepairXY: js.Function1[/* e */ js.UndefOr[stdLib.Event], extjsLib.ExtNs.Array] = null,
    groups: js.Any = null,
    ...
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IDragZone] = null,
    ...
    onInitDrag: js.Function2[/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], scala.Boolean] = null,
    ...
    if (getRepairXY != null) __obj.updateDynamic("getRepairXY")(getRepairXY)
    ...
    if (onInitDrag != null) __obj.updateDynamic("onInitDrag")(onInitDrag)
