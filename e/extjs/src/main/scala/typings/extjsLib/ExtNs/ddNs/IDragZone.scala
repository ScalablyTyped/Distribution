...
object IDragZone {
  ...
  def apply(
    ...
    getDragData: /* e */ js.UndefOr[stdLib.Event] => _ = null,
    getDragEl: () => stdLib.HTMLElement = null,
    getEl: () => stdLib.HTMLElement = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    getProxy: () => IStatusProxy = null,
    getRepairXY: /* e */ js.UndefOr[stdLib.Event] => extjsLib.ExtNs.Array = null,
    groups: js.Any = null,
    ...
    onInitDrag: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double]) => scala.Boolean = null,
