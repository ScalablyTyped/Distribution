...
object SvgExporter extends js.Object {
  ...
  def generate(surface: extjsLib.ExtNs.drawNs.ISurface): java.lang.String = js.native
  def generate(surface: extjsLib.ExtNs.drawNs.ISurface, config: js.Any): java.lang.String = js.native
