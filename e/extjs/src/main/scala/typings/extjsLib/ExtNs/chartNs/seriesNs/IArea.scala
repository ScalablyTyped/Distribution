...
object IArea {
  ...
  def apply(
    ...
    highlightSeries: js.Function1[/* item */ js.UndefOr[js.Any], scala.Unit] = null,
    inheritableStatics: js.Any = null,
    initConfig: js.Function1[/* config */ js.UndefOr[js.Any], IArea] = null,
    ...
    unHighlightSeries: js.Function1[/* item */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (highlightSeries != null) __obj.updateDynamic("highlightSeries")(highlightSeries)
    ...
    if (unHighlightSeries != null) __obj.updateDynamic("unHighlightSeries")(unHighlightSeries)
