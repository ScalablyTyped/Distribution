package typings.extjs.ExtNs.dataNs.proxyNs

import typings.extjs.ExtNs.Array
import typings.extjs.ExtNs.IClass
import typings.extjs.ExtNs.dataNs.IBatch
import typings.extjs.ExtNs.dataNs.IModel
import typings.extjs.ExtNs.dataNs.IOperation
...
trait IProxy extends IObservable {
  ...
  /** [Method] Returns the reader currently attached to this proxy instance
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typings.extjs.ExtNs.dataNs.readerNs.IReader]] = js.undefined
  /** [Method] Returns the writer currently attached to this proxy instance
  		* @returns Ext.data.writer.Writer The Writer instance
  		*/
  var getWriter: js.UndefOr[js.Function0[typings.extjs.ExtNs.dataNs.writerNs.IWriter]] = js.undefined
  /** [Property] (Boolean) */
  ...
  var setReader: js.UndefOr[
    js.Function1[/* reader */ js.UndefOr[js.Any], typings.extjs.ExtNs.dataNs.readerNs.IReader]
  ] = js.undefined
  ...
  var setWriter: js.UndefOr[
    js.Function1[/* writer */ js.UndefOr[js.Any], typings.extjs.ExtNs.dataNs.writerNs.IWriter]
  ] = js.undefined
...
object IProxy {
  ...
  def apply(
    ...
    getWriter: () => typings.extjs.ExtNs.dataNs.writerNs.IWriter = null,
    hasListener: /* eventName */ js.UndefOr[java.lang.String] => Boolean = null,
    hasListeners: js.Any = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.proxyNs.IProxy = null,
    ...
    setReader: /* reader */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.readerNs.IReader = null,
    setWriter: /* writer */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.writerNs.IWriter = null,
