...
- typings.extjs.ExtNs.utilNs.IElementContainer because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined addChildEls, removeChildEls */ trait IContainer extends ILayout {
...
object IContainer {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.layoutNs.containerNs.IContainer = null,
