package typings.extjs.ExtNs.windowNs

import typings.extjs.ExtNs.utilNs.IComponentDragger
...
object IWindow {
  ...
  def apply(
    ...
    maximize: /* animate */ js.UndefOr[Boolean] => typings.extjs.ExtNs.windowNs.IWindow = null,
    maximized: js.UndefOr[Boolean] = js.undefined,
    minHeight: Int | Double = null,
    minWidth: Int | Double = null,
    minimizable: js.UndefOr[Boolean] = js.undefined,
    minimize: () => typings.extjs.ExtNs.windowNs.IWindow = null,
    ...
    restore: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.windowNs.IWindow = null,
    toggleMaximize: () => typings.extjs.ExtNs.windowNs.IWindow = null,
    x: Int | Double = null,
    y: Int | Double = null
  ): IWindow = {
