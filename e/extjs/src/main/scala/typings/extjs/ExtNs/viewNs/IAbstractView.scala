...
import typings.extjs.ExtNs.utilNs.IBindable
...
- typings.extjs.ExtNs.utilNs.IBindable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined bindStore, bindStoreListeners, getStore, getStoreListeners, onBindStore, onUnbindStore, unbindStoreListeners */ trait IAbstractView extends IComponent {
  ...
  /** [Method] Gets the selection model for this view
  		...
  		*/
  var getSelectionModel: js.UndefOr[js.Function0[typings.extjs.ExtNs.selectionNs.IModel]] = js.undefined
...
object IAbstractView {
  ...
  def apply(
    ...
    getSelectionModel: () => typings.extjs.ExtNs.selectionNs.IModel = null,
