package typings.extjs.ExtNs.dataNs.readerNs

import typings.extjs.ExtNs.Array
import typings.extjs.ExtNs.IClass
import typings.extjs.ExtNs.dataNs.IResultSet
...
object IReader {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.readerNs.IReader = null,
