...
trait IMessageBox
  extends typings.extjs.ExtNs.windowNs.IWindow {
  /** [Property] (Number) */
...
object IMessageBox {
  ...
  def apply(
    ...
    IWindow: typings.extjs.ExtNs.windowNs.IWindow = null,
    NO: Int | Double = null,
    OK: Int | Double = null,
    ...
    alert: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    buttonText: js.Any = null,
    closeAction: java.lang.String = null,
    cls: java.lang.String = null,
    confirm: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    ...
    onShow: () => Unit = null,
    progress: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* progressText */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    prompt: (/* title */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* multiline */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    resizable: js.Any = null,
    setIcon: (/* icon */ js.UndefOr[java.lang.String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    show: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    shrinkWrapDock: js.Any = null,
    title: java.lang.String = null,
    updateProgress: (/* value */ js.UndefOr[Double], /* progressText */ js.UndefOr[java.lang.String], /* msg */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.windowNs.IMessageBox = null,
    wait: (/* msg */ js.UndefOr[java.lang.String], /* title */ js.UndefOr[java.lang.String], /* config */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.windowNs.IMessageBox = null
  ): IMessageBox = {
