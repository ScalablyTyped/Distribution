...
package object ExtNs {
  ...
  type ICompositeElement = typings.extjs.ExtNs.domNs.ICompositeElementLite
  type IDomHelper = IHelper
  type IMessageBox = typings.extjs.ExtNs.windowNs.IMessageBox
  type IModelManager = IAbstractManager
  type IModelMgr = IAbstractManager
  type IMsg = typings.extjs.ExtNs.windowNs.IMessageBox
  type IPerf = IBase
