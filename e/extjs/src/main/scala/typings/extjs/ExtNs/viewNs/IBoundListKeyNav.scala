...
trait IBoundListKeyNav
  extends typings.extjs.ExtNs.utilNs.IKeyNav {
  /** [Config Option] (Ext.view.BoundList) */
  var boundList: js.UndefOr[typings.extjs.ExtNs.viewNs.IBoundList] = js.undefined
...
object IBoundListKeyNav {
  ...
  def apply(
    ...
    boundList: typings.extjs.ExtNs.viewNs.IBoundList = null,
