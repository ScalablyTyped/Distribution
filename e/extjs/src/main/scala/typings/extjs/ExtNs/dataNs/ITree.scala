...
object ITree {
  ...
  def apply(
    ...
    getNodeById: /* id */ js.UndefOr[java.lang.String] => INodeInterface = null,
    getRootNode: () => INodeInterface = null,
    hasListener: /* eventName */ js.UndefOr[java.lang.String] => Boolean = null,
    hasListeners: js.Any = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => ITree = null,
    ...
    removeRootNode: () => INodeInterface = null,
    requires: Array = null,
    resumeEvent: /* repeated */ js.Any => Unit = null,
    resumeEvents: () => Unit = null,
    root: INodeInterface = null,
    self: IClass = null,
    setRootNode: /* node */ js.UndefOr[INodeInterface] => INodeInterface = null,
    ...
    if (removeRootNode != null) __obj.updateDynamic("removeRootNode")(js.Any.fromFunction0(removeRootNode))
