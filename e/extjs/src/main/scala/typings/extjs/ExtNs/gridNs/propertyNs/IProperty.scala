...
import typings.extjs.ExtNs.dataNs.IErrors
...
object IProperty {
  ...
  def apply(
    ...
    join: /* store */ js.UndefOr[typings.extjs.ExtNs.dataNs.IStore] => Unit = null,
