...
import typings.extjs.ExtNs.enumsNs.IWidget
import typings.extjs.ExtNs.stateNs.IStateful
import typings.extjs.ExtNs.utilNs.IAnimate
import typings.extjs.ExtNs.utilNs.IElementContainer
import typings.extjs.ExtNs.utilNs.IPositionable
import typings.extjs.ExtNs.utilNs.IRegion
import typings.extjs.ExtNs.utilNs.IRenderable
...
- typings.extjs.ExtNs.utilNs.IRenderable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined afterRender, doAutoRender, ensureAttachedToBody, getInsertPosition, initRenderData, onRender, render- typings.extjs.ExtNs.utilNs.IElementContainer because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined addChildEls, removeChildEls- typings.extjs.ExtNs.utilNs.IAnimate because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined animate, getActiveAnimation, hasActiveFx, sequenceFx, stopAnimation, stopFx, syncFx- typings.extjs.ExtNs.utilNs.IPositionable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined alignTo, anchorTo, calculateConstrainedPosition, getAlignToXY, getAnchorXY, getBox, getConstrainVector, getLocalX, getLocalXY, getLocalY, getOffsetsTo, getRegion, getViewRegion, getX, getXY, getY, move, removeAnchor, setBox, setLocalX, setLocalXY, setLocalY, setRegion, setX, setXY, setY, translatePoints */ trait IAbstractComponent extends IStateful {
  /** [Property] (Boolean) */
  ...
  /** [Method] This method needs to be called whenever you change something on this component that requires the Component s layout t
  		...
  		*/
  var doComponentLayout: js.UndefOr[js.Function0[typings.extjs.ExtNs.containerNs.IContainer]] = js.undefined
  /** [Config Option] (Boolean) */
  ...
  /** [Method] Provides the link for Observable s fireEvent method to bubble up the ownership hierarchy
  		...
  		*/
  var getBubbleTarget: js.UndefOr[js.Function0[typings.extjs.ExtNs.containerNs.IContainer]] = js.undefined
  ...
  /** [Method] Retrieves the top level element representing this component
  		...
  		*/
  var getEl: js.UndefOr[js.Function0[typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  ...
  var onAdded: js.UndefOr[
    js.Function2[
      /* container */ js.UndefOr[typings.extjs.ExtNs.containerNs.IContainer], 
  ...
  var onRender: js.UndefOr[
    js.Function2[js.UndefOr[typings.extjs.ExtNs.coreNs.IElement], js.UndefOr[Double], Unit]
  ] = js.undefined
  ...
  var up: js.UndefOr[
    js.Function2[
      ...
      typings.extjs.ExtNs.containerNs.IContainer
    ]
  ] = js.undefined
...
object IAbstractComponent {
  @scala.inline
  def apply(
    IAnimate: IAnimate = null,
    IElementContainer: IElementContainer = null,
    IPositionable: IPositionable = null,
    IRenderable: IRenderable = null,
    IStateful: IStateful = null,
    ...
    getBubbleTarget: () => typings.extjs.ExtNs.containerNs.IContainer = null,
    ...
    onAdded: (/* container */ js.UndefOr[typings.extjs.ExtNs.containerNs.IContainer], /* pos */ js.UndefOr[Double]) => Unit = null,
    onDisable: () => Unit = null,
    onEnable: () => Unit = null,
    onPosition: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double]) => Unit = null,
    onRemoved: /* destroying */ js.UndefOr[Boolean] => Unit = null,
    onRender: (/* parentNode */ js.UndefOr[typings.extjs.ExtNs.coreNs.IElement], /* containerIdx */ js.UndefOr[Double]) => Unit = null,
    ...
    setLocalX: /* x */ js.UndefOr[js.Any] => IPositionable = null,
    setLocalXY: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any]) => IPositionable = null,
    setLocalY: /* y */ js.UndefOr[js.Any] => IPositionable = null,
    ...
    setX: (/* x */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => IPositionable = null,
    setXY: (/* xy */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => IPositionable = null,
    setY: (/* y */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => IPositionable = null,
    ...
    up: (/* selector */ js.UndefOr[js.Any], /* limit */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.containerNs.IContainer = null,
