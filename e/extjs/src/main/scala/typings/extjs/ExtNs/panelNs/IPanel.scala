...
object IPanel {
  ...
  def apply(
    ...
    collapse: (/* direction */ js.UndefOr[java.lang.String], /* animate */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.panelNs.IPanel = null,
    ...
    expand: /* animate */ js.UndefOr[Boolean] => typings.extjs.ExtNs.panelNs.IPanel = null,
    fbar: js.Any = null,
    ...
    toggleCollapse: () => typings.extjs.ExtNs.panelNs.IPanel = null,
    tools: js.Any = null
  ): IPanel = {
