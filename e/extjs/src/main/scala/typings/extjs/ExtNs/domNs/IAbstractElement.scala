package typings.extjs.ExtNs.domNs
...
trait IAbstractElement extends IBase {
  ...
  var addCls: js.UndefOr[
    js.Function1[/* className */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var applyStyles: js.UndefOr[
    js.Function1[/* styles */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  /** [Method] Hide this element  Uses display mode to determine whether to use display or visibility
  		...
  		*/
  var hide: js.UndefOr[
    js.Function1[/* animate */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
  /** [Property] (String) */
  ...
  /** [Method] Forces the browser to repaint this element Defined in override Ext dom AbstractElement_style
  		* @returns Ext.dom.Element this
  		*/
  var repaint: js.UndefOr[js.Function0[typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  ...
  var replaceCls: js.UndefOr[
    js.Function2[
      ...
      typings.extjs.ExtNs.domNs.IElement
    ]
  ] = js.undefined
  ...
  var select: js.UndefOr[
    js.Function2[
      ...
      typings.extjs.ExtNs.ICompositeElement
    ]
  ] = js.undefined
  ...
  var setHTML: js.UndefOr[
    js.Function1[/* html */ js.UndefOr[java.lang.String], typings.extjs.ExtNs.IElement]
  ] = js.undefined
  ...
  var setHeight: js.UndefOr[
    js.Function1[/* height */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  /** [Method] Set the width of this Element
  		...
  		* @returns Ext.dom.Element this
  		*/
  var setWidth: js.UndefOr[js.Function1[/* width */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  ...
  var toggleCls: js.UndefOr[
    js.Function1[/* className */ js.UndefOr[java.lang.String], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var update: js.UndefOr[
    js.Function1[/* html */ js.UndefOr[java.lang.String], typings.extjs.ExtNs.domNs.IElement]
  ] = js.undefined
...
object IAbstractElement {
  ...
  def apply(
    ...
    addCls: /* className */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    alias: Array = null,
    ...
    applyStyles: /* styles */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    ...
    hide: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    ...
    radioCls: /* className */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    remove: () => Unit = null,
    removeCls: /* className */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    repaint: () => typings.extjs.ExtNs.domNs.IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => IAbstractElement = null,
    replaceCls: (/* oldClassName */ js.UndefOr[java.lang.String], /* newClassName */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.domNs.IElement = null,
    replaceWith: /* el */ js.UndefOr[js.Any] => IAbstractElement = null,
    requires: Array = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.ICompositeElement = null,
    self: IClass = null,
    serializeForm: /* form */ js.UndefOr[js.Any] => java.lang.String = null,
    set: (/* o */ js.UndefOr[js.Any], /* useSet */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.IElement = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.IElement = null,
    setHeight: /* height */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    setSize: (/* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.domNs.IElement = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => IAbstractElement = null,
    setVisible: (/* visible */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setWidth: /* width */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    show: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    statics: js.Any = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.IElement = null,
    unmask: () => Unit = null,
    up: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.IElement = null,
    update: /* html */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.IElement = null,
    uses: Array = null,
