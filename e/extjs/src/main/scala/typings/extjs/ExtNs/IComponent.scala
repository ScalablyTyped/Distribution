...
- typings.extjs.ExtNs.utilNs.IFloating because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined constrain, fixed, focusOnToFront, shadow, shadowOffset, center, doConstrain, setActive, toBack, toFront */ trait IComponent extends IAbstractComponent {
  ...
  var findParentBy: js.UndefOr[
    js.Function1[/* fn */ js.UndefOr[js.Any], typings.extjs.ExtNs.containerNs.IContainer]
  ] = js.undefined
  ...
  var findParentByType: js.UndefOr[
    js.Function1[/* xtype */ js.UndefOr[js.Any], typings.extjs.ExtNs.containerNs.IContainer]
  ] = js.undefined
  /** [Config Option] (Boolean) */
...
object IComponent {
  ...
  def apply(
    ...
    findParentBy: /* fn */ js.UndefOr[js.Any] => typings.extjs.ExtNs.containerNs.IContainer = null,
    findParentByType: /* xtype */ js.UndefOr[js.Any] => typings.extjs.ExtNs.containerNs.IContainer = null,
    ...
    getEl: () => typings.extjs.ExtNs.domNs.IElement = null,
