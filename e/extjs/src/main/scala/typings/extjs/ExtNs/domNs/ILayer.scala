...
import typings.extjs.ExtNs.IElementLoader
...
trait ILayer
  extends typings.extjs.ExtNs.IElement {
  ...
  /** [Method] overridden Element method
  		...
  		*/
  @JSName("setLeft")
  var setLeft_ILayer: js.UndefOr[js.Function1[/* left */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  /** [Method] overridden Element method
  		* @param w Object
  		* @param h Object
  		* @param animate Object
  ...
  /** [Method] Sets the element s top position directly using CSS style instead of setY
  		...
  		*/
  @JSName("setTop")
  var setTop_ILayer: js.UndefOr[js.Function1[/* top */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  /** [Method] overridden Element method
...
object ILayer {
  ...
  def apply(
    ...
    addClsOnClick: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    addClsOnFocus: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    alias: Array = null,
    alternateClassName: js.Any = null,
    animate: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    appendTo: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    blur: () => typings.extjs.ExtNs.domNs.ILayer = null,
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    clearListeners: () => typings.extjs.ExtNs.domNs.ILayer = null,
    clearOpacity: () => typings.extjs.ExtNs.domNs.ILayer = null,
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.ILayer = null,
    clip: () => typings.extjs.ExtNs.domNs.ILayer = null,
    cls: java.lang.String = null,
    config: js.Any = null,
    constrain: js.UndefOr[Boolean] = js.undefined,
    contains: /* el */ js.UndefOr[js.Any] => Boolean = null,
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    createShim: () => typings.extjs.ExtNs.domNs.ILayer = null,
    defaultUnit: java.lang.String = null,
    destroy: () => Unit = null,
    dh: js.Any = null,
    dom: HTMLElement = null,
    down: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.ILayer = null,
    extend: java.lang.String = null,
    fadeIn: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    fadeOut: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    focus: /* defer */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.ILayer = null,
    focusable: () => Boolean = null,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    getXY: () => Array = null,
    getY: () => Double = null,
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    hasCls: /* className */ js.UndefOr[java.lang.String] => Boolean = null,
    hide: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    hideMode: java.lang.String = null,
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    hover: (/* overFn */ js.UndefOr[js.Any], /* outFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    id: java.lang.String = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    insertAfter: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    insertBefore: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    insertFirst: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    insertHtml: (/* where */ js.UndefOr[java.lang.String], /* html */ js.UndefOr[java.lang.String], /* returnEl */ js.UndefOr[Boolean]) => _ = null,
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    load: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.domNs.ILayer = null,
    mixins: js.Any = null,
    monitorMouseLeave: (/* delay */ js.UndefOr[Double], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    moveTo: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    needsTabIndex: () => Unit = null,
    next: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    originalDisplay: java.lang.String = null,
    parent: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    pause: /* seconds */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    puff: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    purgeAllListeners: () => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    remove: () => Unit = null,
    removeAllListeners: () => typings.extjs.ExtNs.domNs.ILayer = null,
    removeCls: /* className */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    repaint: () => typings.extjs.ExtNs.domNs.IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    replaceWith: /* el */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    requires: Array = null,
    scale: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    scroll: (/* direction */ js.UndefOr[java.lang.String], /* distance */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => Boolean = null,
    scrollBy: (/* deltaX */ js.UndefOr[js.Any], /* deltaY */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.ICompositeElement = null,
    selectable: () => typings.extjs.ExtNs.domNs.ILayer = null,
    self: IClass = null,
    ...
    setBottom: /* bottom */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    setBounds: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setDisplayed: /* value */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    setHTML: /* html */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.IElement = null,
    setHeight: (/* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setLeft: /* left */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    setLeftTop: (/* left */ js.UndefOr[js.Any], /* top */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setLocation: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    setOpacity: (/* opacity */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    setRight: /* right */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    setScrollLeft: /* left */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.ILayer = null,
    setScrollTop: /* top */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.ILayer = null,
    setSize: (/* w */ js.UndefOr[js.Any], /* h */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setStyle: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.domNs.IElement = null,
    setTop: /* top */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.IElement = null,
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    setVisible: (/* visible */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setWidth: (/* w */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any], /* duration */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* easing */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.IElement = null,
    setZIndex: /* zindex */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.ILayer = null,
    shadow: js.Any = null,
    shadowOffset: Int | Double = null,
    shift: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    shim: js.UndefOr[Boolean] = js.undefined,
    show: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ILayer = null,
    switchOff: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    toggle: /* animate */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ILayer = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.domNs.IElement = null,
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
    unclip: () => typings.extjs.ExtNs.domNs.ILayer = null,
    unmask: () => Unit = null,
    unselectable: () => typings.extjs.ExtNs.domNs.ILayer = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ILayer = null,
