...
trait IRecord extends IObservable {
  ...
  /** [Method] Returns the configured Proxy for this Model
  		...
  		*/
  var getProxy: js.UndefOr[js.Function0[typings.extjs.ExtNs.dataNs.proxyNs.IProxy]] = js.undefined
  /** [Config Option] (String/Object/String[]/Object[]) */
  ...
  var setProxy: js.UndefOr[
    js.Function1[/* proxy */ js.UndefOr[js.Any], typings.extjs.ExtNs.dataNs.proxyNs.IProxy]
  ] = js.undefined
