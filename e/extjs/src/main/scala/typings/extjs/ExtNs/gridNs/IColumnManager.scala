...
trait IColumnManager extends IBase {
  ...
  var getHeaderAtIndex: js.UndefOr[
    js.Function1[/* index */ js.UndefOr[Double], typings.extjs.ExtNs.gridNs.columnNs.IColumn]
  ] = js.undefined
  /** [Method] Get a leaf level header by index regardless of what the nesting structure is
  ...
  var getHeaderById: js.UndefOr[
    js.Function1[/* id */ js.UndefOr[java.lang.String], typings.extjs.ExtNs.gridNs.columnNs.IColumn]
  ] = js.undefined
  ...
  var getHeaderIndex: js.UndefOr[
    js.Function1[/* header */ js.UndefOr[typings.extjs.ExtNs.gridNs.columnNs.IColumn], Double]
  ] = js.undefined
...
object IColumnManager {
  ...
  def apply(
    ...
    getHeaderAtIndex: /* index */ js.UndefOr[Double] => typings.extjs.ExtNs.gridNs.columnNs.IColumn = null,
    getHeaderById: /* id */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.gridNs.columnNs.IColumn = null,
    getHeaderIndex: /* header */ js.UndefOr[typings.extjs.ExtNs.gridNs.columnNs.IColumn] => Double = null,
