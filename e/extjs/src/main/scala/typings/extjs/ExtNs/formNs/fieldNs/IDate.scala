...
trait IDate
  extends typings.extjs.ExtNs.formNs.fieldNs.IPicker {
...
object IDate {
  @scala.inline
  def apply(
    IPicker: typings.extjs.ExtNs.formNs.fieldNs.IPicker = null,
    ...
    setValue: /* date */ js.UndefOr[js.Any] => typings.extjs.ExtNs.formNs.fieldNs.IDate = null,
