package typings.extjs.ExtNs.gridNs.propertyNs

import typings.extjs.ExtNs.Array
import typings.extjs.ExtNs.IClass
import typings.extjs.ExtNs.dataNs.IModel
import typings.extjs.ExtNs.dataNs.IRecord
import typings.extjs.ExtNs.dataNs.proxyNs.IProxy
...
trait IStore
  extends typings.extjs.ExtNs.dataNs.IStore
...
object IStore {
  ...
  def apply(
    ...
    sync: /* options */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.IStore = null,
