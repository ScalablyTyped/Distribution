package typings.extjs.ExtNs.gridNs.lockingNs
...
object IView {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.gridNs.lockingNs.IView = null,
    isLockingView: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(isLockingView)) __obj.updateDynamic("isLockingView")(isLockingView)
