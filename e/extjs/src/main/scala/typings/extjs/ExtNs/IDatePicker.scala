...
trait IDatePicker extends IComponent {
  ...
  var hideMonthPicker: js.UndefOr[
    js.Function1[/* animate */ js.UndefOr[Boolean], typings.extjs.ExtNs.pickerNs.IDate]
  ] = js.undefined
  ...
  /** [Method] Sets the current value to today
  		* @returns Ext.picker.Date this
  		*/
  var selectToday: js.UndefOr[js.Function0[typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Config Option] (String) */
  ...
  var setDisabledDates: js.UndefOr[
    js.Function1[/* disabledDates */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]
  ] = js.undefined
  ...
  var setDisabledDays: js.UndefOr[
    js.Function1[/* disabledDays */ js.UndefOr[Array], typings.extjs.ExtNs.pickerNs.IDate]
  ] = js.undefined
  /** [Method] Replaces any existing maxDate with the new value and refreshes the DatePicker
  		...
  		* @returns Ext.picker.Date this
  		*/
  var setMaxDate: js.UndefOr[js.Function1[/* value */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Method] Replaces any existing minDate with the new value and refreshes the DatePicker
  		...
  		* @returns Ext.picker.Date this
  		*/
  var setMinDate: js.UndefOr[js.Function1[/* value */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Method] Sets the value of the date field
  		* @param value Date The date to set
  		* @returns Ext.picker.Date this
  		*/
  var setValue: js.UndefOr[js.Function1[/* value */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  ...
  /** [Method] Show the next month
  		...
  		* @returns Ext.picker.Date this
  		*/
  var showNextMonth: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Method] Show the next year
  		* @returns Ext.picker.Date this
  		*/
  var showNextYear: js.UndefOr[js.Function0[typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Method] Show the previous month
  		* @param e Object
  		* @returns Ext.picker.Date this
  		*/
  var showPrevMonth: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Method] Show the previous year
  		* @returns Ext.picker.Date this
  		*/
  var showPrevYear: js.UndefOr[js.Function0[typings.extjs.ExtNs.pickerNs.IDate]] = js.undefined
  /** [Config Option] (Boolean) */
...
object IDatePicker {
  ...
  def apply(
    ...
    getValue: () => _ = null,
    handler: js.Any = null,
    hideMonthPicker: /* animate */ js.UndefOr[Boolean] => typings.extjs.ExtNs.pickerNs.IDate = null,
    ...
    scope: js.Any = null,
    selectToday: () => typings.extjs.ExtNs.pickerNs.IDate = null,
    selectedCls: java.lang.String = null,
    setDisabledDates: /* disabledDates */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    setDisabledDays: /* disabledDays */ js.UndefOr[Array] => typings.extjs.ExtNs.pickerNs.IDate = null,
    setMaxDate: /* value */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    setMinDate: /* value */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    setValue: /* value */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    showMonthPicker: /* animate */ js.UndefOr[Boolean] => typings.extjs.ExtNs.pickerNs.IDate = null,
    showNextMonth: /* e */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    showNextYear: () => typings.extjs.ExtNs.pickerNs.IDate = null,
    showPrevMonth: /* e */ js.UndefOr[js.Any] => typings.extjs.ExtNs.pickerNs.IDate = null,
    showPrevYear: () => typings.extjs.ExtNs.pickerNs.IDate = null,
