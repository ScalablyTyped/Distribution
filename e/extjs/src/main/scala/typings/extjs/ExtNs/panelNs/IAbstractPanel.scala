...
- typings.extjs.ExtNs.containerNs.IDockingContainer because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined defaultDockWeights, addDocked, getDockedComponent, getDockedItems, insertDocked, onDockedAdd, onDockedRemove, removeDocked */ trait IAbstractPanel
  ...
  var addBodyCls: js.UndefOr[
    js.Function1[/* cls */ js.UndefOr[java.lang.String], typings.extjs.ExtNs.panelNs.IPanel]
  ] = js.undefined
  ...
  var body: js.UndefOr[typings.extjs.ExtNs.domNs.IElement] = js.undefined
  ...
  var setBodyStyle: js.UndefOr[
    js.Function2[
      ...
      typings.extjs.ExtNs.panelNs.IPanel
    ]
  ] = js.undefined
...
object IAbstractPanel {
  ...
  def apply(
    ...
    IDockingContainer: IDockingContainer = null,
    addBodyCls: /* cls */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.panelNs.IPanel = null,
    ...
    body: typings.extjs.ExtNs.domNs.IElement = null,
    ...
    removeBodyCls: /* cls */ js.UndefOr[java.lang.String] => typings.extjs.ExtNs.panelNs.IPanel = null,
    ...
    setBodyStyle: (/* style */ js.UndefOr[js.Any], /* value */ js.UndefOr[java.lang.String]) => typings.extjs.ExtNs.panelNs.IPanel = null,
