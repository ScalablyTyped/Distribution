package typings.extjs.ExtNs.dataNs.writerNs
...
import typings.extjs.ExtNs.dataNs.IRequest
...
object IWriter {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.writerNs.IWriter = null,
    mixins: js.Any = null,
