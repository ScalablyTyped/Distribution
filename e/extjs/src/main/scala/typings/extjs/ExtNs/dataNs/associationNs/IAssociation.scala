...
trait IAssociation extends IBase {
  ...
  var reader: js.UndefOr[typings.extjs.ExtNs.dataNs.readerNs.IReader] = js.undefined
}
...
object IAssociation {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.dataNs.associationNs.IAssociation = null,
    mixins: js.Any = null,
