...
import typings.extjs.ExtNs.formNs.ILabelable
...
object IBase {
  ...
  def apply(
    ...
    IField: typings.extjs.ExtNs.formNs.fieldNs.IField = null,
    ...
    doComponentLayout: () => typings.extjs.ExtNs.containerNs.IContainer = null,
