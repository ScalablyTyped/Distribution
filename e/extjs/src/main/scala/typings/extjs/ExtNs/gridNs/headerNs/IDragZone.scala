package typings.extjs.ExtNs.gridNs.headerNs

import typings.extjs.ExtNs.Array
import typings.extjs.ExtNs.IClass
import typings.extjs.ExtNs.ddNs.IDragDrop
import typings.extjs.ExtNs.ddNs.IStatusProxy
...
trait IDragZone
  extends typings.extjs.ExtNs.ddNs.IDragZone {
