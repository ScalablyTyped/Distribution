...
import typings.extjs.ExtNs.utilNs.IQueue
...
trait IContext extends IBase {
  ...
  var getEl: js.UndefOr[
    js.Function2[
      ...
      /* el */ js.UndefOr[typings.extjs.ExtNs.domNs.IElement], 
      Unit
    ]
  ] = js.undefined
...
object IContext {
  ...
  def apply(
    ...
    getEl: (/* parent */ js.UndefOr[IContextItem], /* el */ js.UndefOr[typings.extjs.ExtNs.domNs.IElement]) => Unit = null,
    ...
    mixins: js.Any = null,
    removeEl: (/* parent */ js.UndefOr[IContextItem], /* el */ js.UndefOr[typings.extjs.ExtNs.domNs.IElement]) => Unit = null,
    requires: Array = null,
