...
import typings.extjs.ExtNs.chartNs.seriesNs.IBar
...
trait IColumnChart extends IBar {
  ...
  @JSName("axis")
  var axis_IColumnChart: js.UndefOr[java.lang.String] = js.undefined
}
...
object IColumnChart {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IColumnChart = null,
