...
object Record extends js.Object {
  ...
  /** [Method] Returns the configured Proxy for this Model
  		...
  		*/
  def getProxy(): typings.extjs.ExtNs.dataNs.proxyNs.IProxy = js.native
  ...
  /** [Method] Sets the Proxy to use for this model
  		...
  		*/
  def setProxy(): typings.extjs.ExtNs.dataNs.proxyNs.IProxy = js.native
  def setProxy(proxy: js.Any): typings.extjs.ExtNs.dataNs.proxyNs.IProxy = js.native
}
