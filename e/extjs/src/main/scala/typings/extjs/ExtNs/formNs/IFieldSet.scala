...
- typings.extjs.ExtNs.formNs.IFieldAncestor because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined fieldDefaults, initFieldAncestor, onFieldErrorChange, onFieldValidityChange */ trait IFieldSet
  ...
  var onFieldValidityChange: js.UndefOr[
    js.Function2[js.UndefOr[typings.extjs.ExtNs.formNs.fieldNs.IField], js.UndefOr[Boolean], Unit]
  ] = js.undefined
...
object IFieldSet {
  ...
  def apply(
    ...
    checkboxCmp: typings.extjs.ExtNs.formNs.fieldNs.ICheckbox = null,
