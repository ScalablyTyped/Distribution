...
trait ICompositeElementLite extends IBase {
  /** [Method] Adds elements to this Composite object
  		...
  		*/
  var add: js.UndefOr[
    js.Function1[/* els */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.ICompositeElement]
  ] = js.undefined
  ...
  var each: js.UndefOr[
    js.Function2[
      ...
      typings.extjs.ExtNs.domNs.ICompositeElement
    ]
  ] = js.undefined
  ...
  var filter: js.UndefOr[
    js.Function1[/* selector */ js.UndefOr[js.Any], typings.extjs.ExtNs.domNs.ICompositeElement]
  ] = js.undefined
  /** [Method] Returns the first Element
  		* @returns Ext.dom.Element
  		*/
  var first: js.UndefOr[js.Function0[typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  ...
  /** [Method] Returns a flyweight Element of the dom element object at the specified index
  		...
  		* @returns Ext.dom.Element
  		*/
  var item: js.UndefOr[js.Function1[/* index */ js.UndefOr[Double], typings.extjs.ExtNs.domNs.IElement]] = js.undefined
  /** [Method] Returns the last Element
  		* @returns Ext.dom.Element
  		*/
  var last: js.UndefOr[js.Function0[typings.extjs.ExtNs.domNs.IElement]] = js.undefined
...
object ICompositeElementLite {
  @scala.inline
  def apply(
    add: /* els */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    alias: Array = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    elements: Array = null,
    extend: java.lang.String = null,
    fill: /* els */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    filter: /* selector */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    first: () => typings.extjs.ExtNs.domNs.IElement = null,
    getCount: () => Double = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    indexOf: /* el */ js.UndefOr[js.Any] => Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.domNs.ICompositeElementLite = null,
    isComposite: js.UndefOr[Boolean] = js.undefined,
    item: /* index */ js.UndefOr[Double] => typings.extjs.ExtNs.domNs.IElement = null,
    last: () => typings.extjs.ExtNs.domNs.IElement = null,
    mixins: js.Any = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typings.extjs.ExtNs.domNs.ICompositeElement = null,
    requires: Array = null,
    self: IClass = null,
