...
import typings.extjs.ExtNs.ddNs.IDD
import typings.extjs.ExtNs.ddNs.IDDProxy
import typings.extjs.ExtNs.ddNs.IDDTarget
import typings.extjs.ExtNs.domNs.IAbstractElement
...
trait IElement extends IAbstractElement {
  ...
  var addKeyListener: js.UndefOr[
    js.Function3[
      ...
      /* scope */ js.UndefOr[js.Any], 
      typings.extjs.ExtNs.utilNs.IKeyMap
    ]
  ] = js.undefined
  ...
  var addKeyMap: js.UndefOr[
    js.Function1[/* config */ js.UndefOr[js.Any], typings.extjs.ExtNs.utilNs.IKeyMap]
  ] = js.undefined
...
object IElement {
  ...
  def apply(
    ...
    addKeyListener: (/* key */ js.UndefOr[js.Any], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.ExtNs.utilNs.IKeyMap = null,
    addKeyMap: /* config */ js.UndefOr[js.Any] => typings.extjs.ExtNs.utilNs.IKeyMap = null,
    ...
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => IElement = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => IElement = null,
    ...
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => IElement = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => ICompositeElement = null,
    ...
    setHTML: /* html */ js.UndefOr[java.lang.String] => IElement = null,
    ...
    up: (/* selector */ js.UndefOr[java.lang.String], /* limit */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => IElement = null,
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => IElement = null,
    uses: Array = null,
