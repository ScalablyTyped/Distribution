package typings.extjs.ExtNs.enumsNs
...
object IWidget {
  ...
  def apply(
    ...
    if (actioncolumn != null) __obj.updateDynamic("actioncolumn")(actioncolumn)
    if (booleancolumn != null) __obj.updateDynamic("booleancolumn")(booleancolumn)
    ...
    if (checkboxfield != null) __obj.updateDynamic("checkboxfield")(checkboxfield)
    if (checkboxgroup != null) __obj.updateDynamic("checkboxgroup")(checkboxgroup)
    if (checkcolumn != null) __obj.updateDynamic("checkcolumn")(checkcolumn)
    if (colormenu != null) __obj.updateDynamic("colormenu")(colormenu)
    if (colorpicker != null) __obj.updateDynamic("colorpicker")(colorpicker)
    if (combo != null) __obj.updateDynamic("combo")(combo)
    if (combobox != null) __obj.updateDynamic("combobox")(combobox)
    if (component != null) __obj.updateDynamic("component")(component)
    if (container != null) __obj.updateDynamic("container")(container)
    if (cycle != null) __obj.updateDynamic("cycle")(cycle)
    if (dataview != null) __obj.updateDynamic("dataview")(dataview)
    if (datecolumn != null) __obj.updateDynamic("datecolumn")(datecolumn)
    if (datefield != null) __obj.updateDynamic("datefield")(datefield)
    if (datemenu != null) __obj.updateDynamic("datemenu")(datemenu)
    ...
    if (fieldcontainer != null) __obj.updateDynamic("fieldcontainer")(fieldcontainer)
    if (fieldset != null) __obj.updateDynamic("fieldset")(fieldset)
    if (filebutton != null) __obj.updateDynamic("filebutton")(filebutton)
    if (filefield != null) __obj.updateDynamic("filefield")(filefield)
    if (fileuploadfield != null) __obj.updateDynamic("fileuploadfield")(fileuploadfield)
    ...
    if (gridpanel != null) __obj.updateDynamic("gridpanel")(gridpanel)
    if (gridview != null) __obj.updateDynamic("gridview")(gridview)
    if (header != null) __obj.updateDynamic("header")(header)
    if (headercontainer != null) __obj.updateDynamic("headercontainer")(headercontainer)
    if (hidden != null) __obj.updateDynamic("hidden")(hidden)
    if (hiddenfield != null) __obj.updateDynamic("hiddenfield")(hiddenfield)
    if (htmleditor != null) __obj.updateDynamic("htmleditor")(htmleditor)
    if (image != null) __obj.updateDynamic("image")(image)
    if (imagecomponent != null) __obj.updateDynamic("imagecomponent")(imagecomponent)
    if (jsonpstore != null) __obj.updateDynamic("jsonpstore")(jsonpstore)
    if (label != null) __obj.updateDynamic("label")(label)
    if (loadmask != null) __obj.updateDynamic("loadmask")(loadmask)
    if (menu != null) __obj.updateDynamic("menu")(menu)
    if (menucheckitem != null) __obj.updateDynamic("menucheckitem")(menucheckitem)
    if (menuitem != null) __obj.updateDynamic("menuitem")(menuitem)
    if (menuseparator != null) __obj.updateDynamic("menuseparator")(menuseparator)
    if (messagebox != null) __obj.updateDynamic("messagebox")(messagebox)
    if (multislider != null) __obj.updateDynamic("multislider")(multislider)
    if (numbercolumn != null) __obj.updateDynamic("numbercolumn")(numbercolumn)
    if (numberfield != null) __obj.updateDynamic("numberfield")(numberfield)
    if (pagingtoolbar != null) __obj.updateDynamic("pagingtoolbar")(pagingtoolbar)
    if (panel != null) __obj.updateDynamic("panel")(panel)
    if (pickerfield != null) __obj.updateDynamic("pickerfield")(pickerfield)
    if (progressbar != null) __obj.updateDynamic("progressbar")(progressbar)
    if (propertygrid != null) __obj.updateDynamic("propertygrid")(propertygrid)
    if (quicktip != null) __obj.updateDynamic("quicktip")(quicktip)
    if (radio != null) __obj.updateDynamic("radio")(radio)
    if (radiofield != null) __obj.updateDynamic("radiofield")(radiofield)
    if (radiogroup != null) __obj.updateDynamic("radiogroup")(radiogroup)
    if (rownumberer != null) __obj.updateDynamic("rownumberer")(rownumberer)
    if (slider != null) __obj.updateDynamic("slider")(slider)
    if (sliderfield != null) __obj.updateDynamic("sliderfield")(sliderfield)
    if (slidertip != null) __obj.updateDynamic("slidertip")(slidertip)
    if (spinnerfield != null) __obj.updateDynamic("spinnerfield")(spinnerfield)
    if (splitbutton != null) __obj.updateDynamic("splitbutton")(splitbutton)
    if (splitter != null) __obj.updateDynamic("splitter")(splitter)
    if (tab != null) __obj.updateDynamic("tab")(tab)
    if (tabbar != null) __obj.updateDynamic("tabbar")(tabbar)
    if (tablepanel != null) __obj.updateDynamic("tablepanel")(tablepanel)
    if (tableview != null) __obj.updateDynamic("tableview")(tableview)
    if (tabpanel != null) __obj.updateDynamic("tabpanel")(tabpanel)
    if (tbfill != null) __obj.updateDynamic("tbfill")(tbfill)
    if (tbitem != null) __obj.updateDynamic("tbitem")(tbitem)
    if (tbseparator != null) __obj.updateDynamic("tbseparator")(tbseparator)
    if (tbspacer != null) __obj.updateDynamic("tbspacer")(tbspacer)
    if (tbtext != null) __obj.updateDynamic("tbtext")(tbtext)
    if (templatecolumn != null) __obj.updateDynamic("templatecolumn")(templatecolumn)
    if (text != null) __obj.updateDynamic("text")(text)
    if (textarea != null) __obj.updateDynamic("textarea")(textarea)
    if (textareafield != null) __obj.updateDynamic("textareafield")(textareafield)
    if (textfield != null) __obj.updateDynamic("textfield")(textfield)
    if (timefield != null) __obj.updateDynamic("timefield")(timefield)
    ...
    if (treepanel != null) __obj.updateDynamic("treepanel")(treepanel)
    if (treeview != null) __obj.updateDynamic("treeview")(treeview)
    if (trigger != null) __obj.updateDynamic("trigger")(trigger)
    if (triggerfield != null) __obj.updateDynamic("triggerfield")(triggerfield)
