...
- typings.extjs.ExtNs.IQueryable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, extend, getInitialConfig, inheritableStatics, initConfig, mixins, requires, self, singleton, statics, uses. Inlined child, down, query, queryBy, queryById */ trait IAbstractContainer extends IComponent {
  ...
  var afterLayout: js.UndefOr[
    js.Function1[/* layout */ js.UndefOr[typings.extjs.ExtNs.layoutNs.containerNs.IContainer], Unit]
  ] = js.undefined
  ...
  var cascade: js.UndefOr[
    js.Function3[
      ...
      typings.extjs.ExtNs.IContainer
    ]
  ] = js.undefined
  ...
  /** [Method] Manually force this container s layout to be recalculated
  		...
  		*/
  var doLayout: js.UndefOr[js.Function0[typings.extjs.ExtNs.containerNs.IContainer]] = js.undefined
  ...
  /** [Method] Returns the layout instance currently associated with this Container
  		...
  		*/
  var getLayout: js.UndefOr[js.Function0[typings.extjs.ExtNs.layoutNs.containerNs.IContainer]] = js.undefined
...
object IAbstractContainer {
  ...
  def apply(
    ...
    afterLayout: /* layout */ js.UndefOr[typings.extjs.ExtNs.layoutNs.containerNs.IContainer] => Unit = null,
    autoDestroy: js.UndefOr[Boolean] = js.undefined,
    baseCls: java.lang.String = null,
    bubbleEvents: Array = null,
    cascade: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* args */ js.UndefOr[Array]) => typings.extjs.ExtNs.IContainer = null,
    ...
    doLayout: () => typings.extjs.ExtNs.containerNs.IContainer = null,
