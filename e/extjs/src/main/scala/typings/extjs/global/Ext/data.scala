...
object data {
  ...
  object AbstractStore {
    ...
    /** [Method] Creates a store from config object
      ...
      */
    @scala.inline
    def create(): IAbstractStore = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[IAbstractStore]
    @scala.inline
    def create(store: js.Any): IAbstractStore = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(store.asInstanceOf[js.Any]).asInstanceOf[IAbstractStore]
  ...
  object IdGenerator {
    ...
    /** [Method] Returns the IdGenerator given its config description
      ...
      */
    @scala.inline
    def get(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("get")().asInstanceOf[Unit]
    @scala.inline
    def get(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object Model {
    ...
    /** [Method] Returns an Array of Field definitions which define this Model s structure Fields are sorted upon Model class definit
      ...
      */
    @scala.inline
    def getFields(): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getFields")().asInstanceOf[typings.extjs.Ext.Array]
    ...
    /** [Method] Returns the configured Proxy for this Model
      ...
      */
    @scala.inline
    def getProxy(): IProxy = ^.asInstanceOf[js.Dynamic].applyDynamic("getProxy")().asInstanceOf[IProxy]
    ...
    /** [Method] Generates a sequential id
      ...
      */
    @scala.inline
    def id(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("id")().asInstanceOf[java.lang.String]
    @scala.inline
    def id(rec: IModel): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("id")(rec.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    @scala.inline
    def load(id: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any]).asInstanceOf[Unit]
    @scala.inline
    def load(id: js.Any, config: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def load(id: Unit, config: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /** [Method] Apply a new set of field and or property definitions to the existing model
      ...
      */
    @scala.inline
    def setFields(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setFields")().asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any]).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: js.Any, idProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: js.Any, idProperty: js.Any, clientIdProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any], clientIdProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: js.Any, idProperty: Unit, clientIdProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any], clientIdProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: Unit, idProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: Unit, idProperty: js.Any, clientIdProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any], clientIdProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def setFields(fields: Unit, idProperty: Unit, clientIdProperty: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFields")(fields.asInstanceOf[js.Any], idProperty.asInstanceOf[js.Any], clientIdProperty.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /** [Method] Sets the Proxy to use for this model
      ...
      */
    @scala.inline
    def setProxy(): IProxy = ^.asInstanceOf[js.Dynamic].applyDynamic("setProxy")().asInstanceOf[IProxy]
    @scala.inline
    def setProxy(proxy: js.Any): IProxy = ^.asInstanceOf[js.Dynamic].applyDynamic("setProxy")(proxy.asInstanceOf[js.Any]).asInstanceOf[IProxy]
  }
  ...
  object NodeInterface {
    ...
    /** [Method] This method allows you to decorate a Model s class to implement the NodeInterface
      ...
      */
    @scala.inline
    def decorate(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("decorate")().asInstanceOf[Unit]
    @scala.inline
    def decorate(modelClass: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("decorate")(modelClass.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object SortTypes {
    ...
    /** [Method] Date sorting
      ...
      */
    @scala.inline
    def asDate(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asDate")().asInstanceOf[Double]
    @scala.inline
    def asDate(s: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asDate")(s.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    /** [Method] Float sorting
      ...
      */
    @scala.inline
    def asFloat(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asFloat")().asInstanceOf[Double]
    @scala.inline
    def asFloat(s: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asFloat")(s.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    /** [Method] Integer sorting
      ...
      */
    @scala.inline
    def asInt(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asInt")().asInstanceOf[Double]
    @scala.inline
    def asInt(s: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asInt")(s.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    /** [Method] Strips all HTML tags to sort on text only
      ...
      */
    @scala.inline
    def asText(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asText")().asInstanceOf[java.lang.String]
    @scala.inline
    def asText(s: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asText")(s.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    /** [Method] Case insensitive string
      ...
      */
    @scala.inline
    def asUCString(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCString")().asInstanceOf[java.lang.String]
    @scala.inline
    def asUCString(s: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCString")(s.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    /** [Method] Strips all HTML tags to sort on text only  Case insensitive
      ...
      */
    @scala.inline
    def asUCText(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCText")().asInstanceOf[java.lang.String]
    @scala.inline
    def asUCText(s: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCText")(s.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    /** [Method] Default sort that does nothing
      ...
      */
    @scala.inline
    def none(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("none")().asInstanceOf[js.Any]
    @scala.inline
    def none(s: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("none")(s.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  object Validations {
    ...
    @scala.inline
    def email(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("email")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def email(config: js.Any, email: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("email")(config.asInstanceOf[js.Any], email.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def email(config: Unit, email: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("email")(config.asInstanceOf[js.Any], email.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /** [Method] Validates that the given value is not present in the configured list
      ...
      */
    @scala.inline
    def exclusion(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("exclusion")().asInstanceOf[Boolean]
    @scala.inline
    def exclusion(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("exclusion")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def exclusion(config: js.Any, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("exclusion")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def exclusion(config: Unit, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("exclusion")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /** [Method] Returns true if the given value passes validation against the configured matcher regex
      ...
      */
    @scala.inline
    def format(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("format")().asInstanceOf[Boolean]
    @scala.inline
    def format(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("format")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def format(config: js.Any, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def format(config: Unit, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /** [Method] Validates that the given value is present in the configured list
      ...
      */
    @scala.inline
    def inclusion(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("inclusion")().asInstanceOf[Boolean]
    @scala.inline
    def inclusion(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("inclusion")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def inclusion(config: js.Any, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("inclusion")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def inclusion(config: Unit, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("inclusion")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /** [Method] Returns true if the given value is between the configured min and max values
      ...
      */
    @scala.inline
    def length(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("length")().asInstanceOf[Boolean]
    @scala.inline
    def length(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("length")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def length(config: js.Any, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("length")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def length(config: Unit, value: java.lang.String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("length")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    /** [Method] Validates that the given value is present
      ...
      */
    @scala.inline
    def presence(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("presence")().asInstanceOf[Boolean]
    @scala.inline
    def presence(config: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("presence")(config.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    @scala.inline
    def presence(config: js.Any, value: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("presence")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    @scala.inline
    def presence(config: Unit, value: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("presence")(config.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Boolean]
