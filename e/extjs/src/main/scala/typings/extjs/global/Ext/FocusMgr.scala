...
object FocusMgr {
  ...
  /** [Method] Adds the specified xtype to the whitelist
    ...
    */
  @scala.inline
  def addXTypeToWhitelist(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addXTypeToWhitelist")().asInstanceOf[Unit]
  @scala.inline
  def addXTypeToWhitelist(xtype: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addXTypeToWhitelist")(xtype.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @scala.inline
  def enable(options: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("enable")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Removes the specified xtype from the whitelist
    ...
    */
  @scala.inline
  def removeXTypeFromWhitelist(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeXTypeFromWhitelist")().asInstanceOf[Unit]
  @scala.inline
  def removeXTypeFromWhitelist(xtype: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeXTypeFromWhitelist")(xtype.asInstanceOf[js.Any]).asInstanceOf[Unit]
