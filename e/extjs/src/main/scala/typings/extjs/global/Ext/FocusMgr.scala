...
object FocusMgr {
  ...
  inline def addXTypeToWhitelist(xtype: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addXTypeToWhitelist")(xtype.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def enable(options: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("enable")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def removeXTypeFromWhitelist(xtype: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeXTypeFromWhitelist")(xtype.asInstanceOf[js.Any]).asInstanceOf[Unit]
