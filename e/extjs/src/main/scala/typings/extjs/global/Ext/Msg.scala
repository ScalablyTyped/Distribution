...
object Msg extends js.Object {
  ...
  def afterLayout(layout: typings.extjs.Ext.layout.container.IContainer): Unit = js.native
  ...
  /** [Method] Returns the layout instance currently associated with this Container
    ...
    */
  def getLayout(): typings.extjs.Ext.layout.container.IContainer = js.native
