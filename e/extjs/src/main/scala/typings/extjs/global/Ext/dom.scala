...
object dom {
  ...
  object AbstractElement_ {
    ...
    /** [Method] Gets the singleton flyweight element with the passed node as the active element
      ...
      */
    @scala.inline
    def fly(): IFly = ^.asInstanceOf[js.Dynamic].applyDynamic("fly")().asInstanceOf[IFly]
    @scala.inline
    def fly(dom: js.Any): IFly = ^.asInstanceOf[js.Dynamic].applyDynamic("fly")(dom.asInstanceOf[js.Any]).asInstanceOf[IFly]
    @scala.inline
    def fly(dom: js.Any, named: java.lang.String): IFly = (^.asInstanceOf[js.Dynamic].applyDynamic("fly")(dom.asInstanceOf[js.Any], named.asInstanceOf[js.Any])).asInstanceOf[IFly]
    @scala.inline
    def fly(dom: Unit, named: java.lang.String): IFly = (^.asInstanceOf[js.Dynamic].applyDynamic("fly")(dom.asInstanceOf[js.Any], named.asInstanceOf[js.Any])).asInstanceOf[IFly]
