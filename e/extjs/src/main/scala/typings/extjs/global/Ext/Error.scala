...
object Error {
  ...
  /** [Method] Globally handle any Ext errors that may be raised optionally providing custom logic to handle different errors indiv
    ...
    */
  @scala.inline
  def handle(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("handle")().asInstanceOf[Unit]
  @scala.inline
  def handle(err: IError): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("handle")(err.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Raise an error that can include additional data and supports automatic console logging if available
    ...
    */
  @scala.inline
  def raise(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("raise")().asInstanceOf[Unit]
  @scala.inline
  def raise(err: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("raise")(err.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
