...
object Object {
  ...
  inline def equals(object1: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(object1.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals(object1: js.Any, object2: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(object1.asInstanceOf[js.Any], object2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals(object1: Unit, object2: js.Any): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(object1.asInstanceOf[js.Any], object2.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def getKeys(`object`: js.Any): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeys")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  ...
  inline def getValues(`object`: js.Any): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getValues")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  ...
  inline def isEmpty(`object`: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isEmpty")(`object`.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /** [Method] Merges any number of objects recursively without referencing them or their children
    ...
    */
  inline def merge(destination: js.Any, `object`: js.Any*): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("merge")(destination.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def toQueryObjects(name: java.lang.String, value: js.Any): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  inline def toQueryObjects(name: java.lang.String, value: js.Any, recursive: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  ...
  inline def toQueryObjects(name: Unit, value: js.Any): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  inline def toQueryObjects(name: Unit, value: js.Any, recursive: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
