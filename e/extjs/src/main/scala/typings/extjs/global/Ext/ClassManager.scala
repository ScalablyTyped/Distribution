...
object ClassManager {
  ...
  inline def create(className: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def create(className: js.Any, data: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def create(className: js.Any, data: js.Any, createdFn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any], createdFn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def create(className: js.Any, data: Unit, createdFn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any], createdFn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def create(className: Unit, data: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def create(className: Unit, data: js.Any, createdFn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any], createdFn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def create(className: Unit, data: Unit, createdFn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(className.asInstanceOf[js.Any], data.asInstanceOf[js.Any], createdFn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def getDisplayName(`object`: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("getDisplayName")(`object`.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
