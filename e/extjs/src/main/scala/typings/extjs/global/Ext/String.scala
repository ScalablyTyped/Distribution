...
object String {
  ...
  /** [Method] Adds a set of character entity definitions to the set used by htmlEncode and htmlDecode
    ...
    */
  @scala.inline
  def addCharacterEntities(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addCharacterEntities")().asInstanceOf[Unit]
  @scala.inline
  def addCharacterEntities(entities: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addCharacterEntities")(entities.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Converts a string of characters into a legal parse able JavaScript var name as long as the passed string contains at
    ...
    */
  @scala.inline
  def createVarName(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("createVarName")().asInstanceOf[java.lang.String]
  @scala.inline
  def createVarName(s: java.lang.String): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("createVarName")(s.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
  ...
  /** [Method] Checks if a string ends with a substring
    ...
    */
  @scala.inline
  def endsWith(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")().asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: java.lang.String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: java.lang.String, start: java.lang.String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: java.lang.String, start: java.lang.String, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: java.lang.String, start: Unit, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: Unit, start: java.lang.String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: Unit, start: java.lang.String, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def endsWith(s: Unit, start: Unit, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("endsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /** [Method] Inserts a substring into a string
    ...
    */
  @scala.inline
  def insert(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("insert")().asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: java.lang.String): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: java.lang.String, value: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: java.lang.String, value: java.lang.String, index: Double): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: java.lang.String, value: Unit, index: Double): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: Unit, value: java.lang.String): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: Unit, value: java.lang.String, index: Double): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
  def insert(s: Unit, value: Unit, index: Double): java.lang.String = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(s.asInstanceOf[js.Any], value.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  ...
  @scala.inline
  def resetCharacterEntities(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("resetCharacterEntities")().asInstanceOf[Unit]
  
  /** [Method] Splits a string of space separated words into an array trimming as needed
    * @param words String/Array
    */
  @scala.inline
  def splitWords(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("splitWords")().asInstanceOf[Unit]
  @scala.inline
  def splitWords(words: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("splitWords")(words.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Checks if a string starts with a substring
    ...
    */
  @scala.inline
  def startsWith(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")().asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: java.lang.String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: java.lang.String, start: java.lang.String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: java.lang.String, start: java.lang.String, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: java.lang.String, start: Unit, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: Unit, start: java.lang.String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: Unit, start: java.lang.String, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def startsWith(s: Unit, start: Unit, ignoreCase: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("startsWith")(s.asInstanceOf[js.Any], start.asInstanceOf[js.Any], ignoreCase.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /** [Method] Uncapitalize the given string
    ...
    */
  @scala.inline
  def uncapitalize(): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("uncapitalize")().asInstanceOf[java.lang.String]
  @scala.inline
  def uncapitalize(string: java.lang.String): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("uncapitalize")(string.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
