...
object WindowManager {
  ...
  /** [Method] Brings the specified Component to the front of any other active Components in this ZIndexManager
    ...
    */
  @scala.inline
  def bringToFront(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("bringToFront")().asInstanceOf[Boolean]
  @scala.inline
  def bringToFront(comp: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("bringToFront")(comp.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /** [Method] Executes the specified function once for every Component in this ZIndexManager passing each Component as the only pa
    ...
    */
  @scala.inline
  def eachBottomUp(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("eachBottomUp")().asInstanceOf[Unit]
  @scala.inline
  def eachBottomUp(fn: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("eachBottomUp")(fn.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def eachBottomUp(fn: js.Any, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("eachBottomUp")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def eachBottomUp(fn: Unit, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("eachBottomUp")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /** [Method] Executes the specified function once for every Component in this ZIndexManager passing each Component as the only pa
    ...
    */
  @scala.inline
  def eachTopDown(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("eachTopDown")().asInstanceOf[Unit]
  @scala.inline
  def eachTopDown(fn: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("eachTopDown")(fn.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def eachTopDown(fn: js.Any, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("eachTopDown")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def eachTopDown(fn: Unit, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("eachTopDown")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /** [Method] Gets a registered Component by id
    ...
    */
  @scala.inline
  def get(): IComponent = ^.asInstanceOf[js.Dynamic].applyDynamic("get")().asInstanceOf[IComponent]
  @scala.inline
  def get(id: js.Any): IComponent = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(id.asInstanceOf[js.Any]).asInstanceOf[IComponent]
  
  /** [Method] Gets the currently active Component in this ZIndexManager
    * @returns Ext.Component The active Component
    */
  @scala.inline
  def getActive(): IComponent = ^.asInstanceOf[js.Dynamic].applyDynamic("getActive")().asInstanceOf[IComponent]
  ...
  /** [Method] Returns zero or more Components in this ZIndexManager using the custom search function passed to this method
    ...
    */
  @scala.inline
  def getBy(): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getBy")().asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getBy(fn: js.Any): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getBy(fn: js.Any, scope: js.Any): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getBy(fn: Unit, scope: js.Any): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getBy")(fn.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  ...
  @scala.inline
  def register(comp: IComponent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("register")(comp.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Sends the specified Component to the back of other active Components in this ZIndexManager
    ...
    */
  @scala.inline
  def sendToBack(): IComponent = ^.asInstanceOf[js.Dynamic].applyDynamic("sendToBack")().asInstanceOf[IComponent]
  @scala.inline
  def sendToBack(comp: js.Any): IComponent = ^.asInstanceOf[js.Dynamic].applyDynamic("sendToBack")(comp.asInstanceOf[js.Any]).asInstanceOf[IComponent]
  ...
  @scala.inline
  def unregister(comp: IComponent): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("unregister")(comp.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
