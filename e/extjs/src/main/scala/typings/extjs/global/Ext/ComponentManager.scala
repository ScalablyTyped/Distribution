...
class ComponentManager ()
  extends StObject
     with typings.extjs.Ext.ComponentManager
/* static members */
object ComponentManager {
  ...
  inline def create(config: js.Any, defaultType: java.lang.String): IComponent = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], defaultType.asInstanceOf[js.Any])).asInstanceOf[IComponent]
  ...
  inline def registerType(`type`: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerType")(`type`.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def registerType(`type`: js.Any, cls: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("registerType")(`type`.asInstanceOf[js.Any], cls.asInstanceOf[js.Any])).asInstanceOf[Unit]
