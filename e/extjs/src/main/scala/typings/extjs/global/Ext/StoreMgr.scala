...
class StoreMgr ()
  extends StObject
     with typings.extjs.Ext.StoreMgr
/* static members */
object StoreMgr {
  ...
  @scala.inline
  def add(key: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("add")(key.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  @scala.inline
  def add(key: js.Any, obj: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(key.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def add(key: Unit, obj: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(key.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  @scala.inline
  def addAll(objs: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addAll")(objs.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Collects unique values of a particular property in this MixedCollection
    ...
    */
  @scala.inline
  def collect(): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("collect")().asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: java.lang.String): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: java.lang.String, root: java.lang.String): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: java.lang.String, root: java.lang.String, allowBlank: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], allowBlank.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: java.lang.String, root: Unit, allowBlank: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], allowBlank.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: Unit, root: java.lang.String): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: Unit, root: java.lang.String, allowBlank: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], allowBlank.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def collect(property: Unit, root: Unit, allowBlank: Boolean): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("collect")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], allowBlank.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  ...
  @scala.inline
  def contains(o: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("contains")(o.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /** [Method] Filters the objects in this collection by a set of Filters or by a single property value pair with optional paramete
    ...
    */
  @scala.inline
  def filter(): IMixedCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")().asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any): IMixedCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any]).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: js.Any): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: js.Any, anyMatch: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: js.Any, anyMatch: Boolean, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: js.Any, anyMatch: Unit, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: Unit, anyMatch: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: Unit, anyMatch: Boolean, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: js.Any, value: Unit, anyMatch: Unit, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: js.Any): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: js.Any, anyMatch: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: js.Any, anyMatch: Boolean, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: js.Any, anyMatch: Unit, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: Unit, anyMatch: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: Unit, anyMatch: Boolean, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  @scala.inline
  def filter(property: Unit, value: Unit, anyMatch: Unit, caseSensitive: Boolean): IMixedCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("filter")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any], caseSensitive.asInstanceOf[js.Any])).asInstanceOf[IMixedCollection]
  ...
  @scala.inline
  def find(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("find")().asInstanceOf[Unit]
  ...
  /** [Method] Finds the index of the first matching object in this collection by a specific property value
    ...
    */
  @scala.inline
  def findIndex(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")().asInstanceOf[Double]
  @scala.inline
  def findIndex(property: java.lang.String): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any]).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: java.lang.String, value: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: java.lang.String, value: js.Any, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: java.lang.String, value: js.Any, start: Double, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(
  ...
  @scala.inline
  def findIndex(property: java.lang.String, value: js.Any, start: Unit, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: java.lang.String, value: Unit, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: java.lang.String, value: Unit, start: Double, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: java.lang.String, value: Unit, start: Unit, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: Unit, value: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: Unit, value: js.Any, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: Unit, value: js.Any, start: Double, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: Unit, value: js.Any, start: Unit, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: Unit, value: Unit, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findIndex(property: Unit, value: Unit, start: Double, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findIndex(property: Unit, value: Unit, start: Unit, anyMatch: Boolean): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findIndex")(property.asInstanceOf[js.Any], value.asInstanceOf[js.Any], start.asInstanceOf[js.Any], anyMatch.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  ...
  @scala.inline
  def findInsertionIndex(newItem: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("findInsertionIndex")(newItem.asInstanceOf[js.Any]).asInstanceOf[Double]
  @scala.inline
  def findInsertionIndex(newItem: js.Any, sorterFn: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findInsertionIndex")(newItem.asInstanceOf[js.Any], sorterFn.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def findInsertionIndex(newItem: Unit, sorterFn: js.Any): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("findInsertionIndex")(newItem.asInstanceOf[js.Any], sorterFn.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  @scala.inline
  def generateComparator(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("generateComparator")().asInstanceOf[Unit]
  ...
  /** [Method] Gets the first sorter from the sorters collection excluding any groupers that may be in place
    ...
    */
  @scala.inline
  def getFirstSorter(): ISorter = ^.asInstanceOf[js.Dynamic].applyDynamic("getFirstSorter")().asInstanceOf[ISorter]
  ...
  /** [Method] Returns a range of items in this collection
    ...
    */
  @scala.inline
  def getRange(): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getRange")().asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getRange(startIndex: Double): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getRange")(startIndex.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getRange(startIndex: Double, endIndex: Double): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getRange")(startIndex.asInstanceOf[js.Any], endIndex.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def getRange(startIndex: Unit, endIndex: Double): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("getRange")(startIndex.asInstanceOf[js.Any], endIndex.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  ...
  @scala.inline
  def indexOf(o: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("indexOf")(o.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  @scala.inline
  def initSortable(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initSortable")().asInstanceOf[Unit]
  ...
  @scala.inline
  def insert(index: Double, key: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def insert(index: Double, key: js.Any, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def insert(index: Double, key: Unit, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def insert(index: Unit, key: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def insert(index: Unit, key: js.Any, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def insert(index: Unit, key: Unit, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("insert")(index.asInstanceOf[js.Any], key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  @scala.inline
  def remove(o: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("remove")(o.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  @scala.inline
  def removeAll(items: typings.extjs.Ext.Array): IMixedCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAll")(items.asInstanceOf[js.Any]).asInstanceOf[IMixedCollection]
  ...
  /** [Method] Remove a range of items starting at a specified index in the collection
    ...
    */
  @scala.inline
  def removeRange(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeRange")().asInstanceOf[js.Any]
  @scala.inline
  def removeRange(index: Double): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeRange")(index.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  @scala.inline
  def removeRange(index: Double, removeCount: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("removeRange")(index.asInstanceOf[js.Any], removeCount.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def removeRange(index: Unit, removeCount: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("removeRange")(index.asInstanceOf[js.Any], removeCount.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  /** [Method] Reorders each of the items based on a mapping from old index to new index
    ...
    */
  @scala.inline
  def reorder(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("reorder")().asInstanceOf[Unit]
  @scala.inline
  def reorder(mapping: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("reorder")(mapping.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @scala.inline
  def replace(key: java.lang.String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("replace")(key.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  @scala.inline
  def replace(key: java.lang.String, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("replace")(key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  @scala.inline
  def replace(key: Unit, o: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("replace")(key.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  @scala.inline
  def sort(sorters: js.Any): typings.extjs.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("sort")(sorters.asInstanceOf[js.Any]).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def sort(sorters: js.Any, direction: java.lang.String): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("sort")(sorters.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  @scala.inline
  def sort(sorters: Unit, direction: java.lang.String): typings.extjs.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("sort")(sorters.asInstanceOf[js.Any], direction.asInstanceOf[js.Any])).asInstanceOf[typings.extjs.Ext.Array]
  
  /** [Method] Sorts the collection by a single sorter function
    * @param sorterFn Function The function to sort by
    */
  @scala.inline
  def sortBy(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("sortBy")().asInstanceOf[Unit]
  @scala.inline
  def sortBy(sorterFn: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("sortBy")(sorterFn.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Sorts this collection by keys
    ...
    */
  @scala.inline
  def sortByKey(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("sortByKey")().asInstanceOf[Unit]
  @scala.inline
  def sortByKey(direction: java.lang.String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("sortByKey")(direction.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def sortByKey(direction: java.lang.String, fn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("sortByKey")(direction.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def sortByKey(direction: Unit, fn: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("sortByKey")(direction.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  @scala.inline
  def sum(property: java.lang.String): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any]).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: java.lang.String): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: java.lang.String, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: java.lang.String, start: Double, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: java.lang.String, start: Unit, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: Unit, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: Unit, start: Double, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: java.lang.String, root: Unit, start: Unit, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: java.lang.String): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: java.lang.String, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: java.lang.String, start: Double, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: java.lang.String, start: Unit, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: Unit, start: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: Unit, start: Double, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  @scala.inline
  def sum(property: Unit, root: Unit, start: Unit, end: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("sum")(property.asInstanceOf[js.Any], root.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /** [Method] Change the key for an existing item in the collection
    ...
    */
  @scala.inline
  def updateKey(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("updateKey")().asInstanceOf[Unit]
  @scala.inline
  def updateKey(oldKey: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("updateKey")(oldKey.asInstanceOf[js.Any]).asInstanceOf[Unit]
  @scala.inline
  def updateKey(oldKey: js.Any, newKey: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("updateKey")(oldKey.asInstanceOf[js.Any], newKey.asInstanceOf[js.Any])).asInstanceOf[Unit]
  @scala.inline
  def updateKey(oldKey: Unit, newKey: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("updateKey")(oldKey.asInstanceOf[js.Any], newKey.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
