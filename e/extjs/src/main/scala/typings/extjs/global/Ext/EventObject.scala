...
object EventObject {
  ...
  @scala.inline
  def WHEEL_SCALE_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WHEEL_SCALE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def altKey_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("altKey")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def ctrlKey_=(x: Boolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ctrlKey")(x.asInstanceOf[js.Any])
