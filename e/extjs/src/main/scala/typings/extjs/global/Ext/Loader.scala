...
@js.native
class Loader ()
  extends typings.extjs.Ext.Loader
/* static members */
object Loader {
  ...
  @JSGlobal("Ext.Loader.addClassPathMappings")
  @js.native
  def addClassPathMappings(paths: typings.extjs.Ext.Object): ILoader = js.native
  ...
  @JSGlobal("Ext.Loader.exclude")
  @js.native
  def exclude(excludes: typings.extjs.Ext.Array): js.Any = js.native
