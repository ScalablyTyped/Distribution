...
import typings.extjs.Ext.ILoader
...
object Loader {
  ...
  @scala.inline
  def addClassPathMappings(paths: typings.extjs.Ext.Object): ILoader = ^.asInstanceOf[js.Dynamic].applyDynamic("addClassPathMappings")(paths.asInstanceOf[js.Any]).asInstanceOf[ILoader]
  ...
  @scala.inline
  def exclude(excludes: typings.extjs.Ext.Array): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("exclude")(excludes.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  @js.native
  def history: typings.extjs.Ext.Array = js.native
  @scala.inline
  def history_=(x: typings.extjs.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("history")(x.asInstanceOf[js.Any])
  ...
  /** [Method] Loads the specified script URL and calls the supplied callbacks
    ...
    */
  @scala.inline
  def loadScript(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadScript")().asInstanceOf[Unit]
  @scala.inline
  def loadScript(options: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadScript")(options.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  @scala.inline
  def setConfig(config: js.Any): ILoader = ^.asInstanceOf[js.Dynamic].applyDynamic("setConfig")(config.asInstanceOf[js.Any]).asInstanceOf[ILoader]
