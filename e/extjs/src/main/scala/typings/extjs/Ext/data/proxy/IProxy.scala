...
object IProxy {
  ...
  implicit class IProxyOps[Self <: IProxy] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetWriter(value: () => IWriter): Self = this.set("getWriter", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setSetReader(value: /* reader */ js.UndefOr[js.Any] => IReader): Self = this.set("setReader", js.Any.fromFunction1(value))
    @scala.inline
    def deleteSetReader: Self = this.set("setReader", js.undefined)
    @scala.inline
    def setSetWriter(value: /* writer */ js.UndefOr[js.Any] => IWriter): Self = this.set("setWriter", js.Any.fromFunction1(value))
    @scala.inline
