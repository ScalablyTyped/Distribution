...
object ILegendItem {
  ...
  def apply(
    ...
    addCls: /* cls */ js.UndefOr[String] => Unit = null,
    ...
    createLegend: /* config */ js.UndefOr[js.Any] => Unit = null,
    ...
    hide: /* redraw */ js.UndefOr[Boolean] => ILegendItem = null,
    indexOf: /* o */ js.UndefOr[js.Any] => Double = null,
    indexOfKey: /* key */ js.UndefOr[String] => Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => ILegendItem = null,
    ...
    removeCls: /* cls */ js.UndefOr[String] => Unit = null,
    ...
    self: IClass = null,
    sequenceFx: () => _ = null,
    setAttributes: (/* attrs */ js.UndefOr[js.Any], /* redraw */ js.UndefOr[Boolean]) => ILegendItem = null,
    setStyle: /* style */ js.UndefOr[String] => Unit = null,
    show: /* redraw */ js.UndefOr[Boolean] => ILegendItem = null,
    ...
    updatePosition: /* relativeTo */ js.UndefOr[js.Any] => Unit = null,
    uses: Array = null
  ): ILegendItem = {
    ...
    if (createLegend != null) __obj.updateDynamic("createLegend")(js.Any.fromFunction1(createLegend))
    ...
    if (updatePosition != null) __obj.updateDynamic("updatePosition")(js.Any.fromFunction1(updatePosition))
