...
object IDirect {
  ...
  def apply(
    ...
    doRequest: (/* operation */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => Unit = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.Ext.data.proxy.IDirect = null,
