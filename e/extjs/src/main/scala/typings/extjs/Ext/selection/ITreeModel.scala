...
object ITreeModel {
  ...
  def apply(
    ...
    getLastSelected: () => ITreeModel = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => ITreeModel = null,
    isFocused: /* record */ js.UndefOr[ITreeModel] => Unit = null,
    ...
    self: IClass = null,
    setLastFocused: /* record */ js.UndefOr[ITreeModel] => Unit = null,
