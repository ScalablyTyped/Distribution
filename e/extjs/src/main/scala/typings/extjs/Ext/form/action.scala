...
object action {
  ...
  object IAction {
    ...
    inline def apply(): typings.extjs.Ext.form.action.IAction = {
  ...
  object IDirectSubmit {
    ...
    inline def apply(): IDirectSubmit = {
      val __obj = js.Dynamic.literal()
  ...
  object IStandardSubmit {
    ...
    inline def apply(): IStandardSubmit = {
      val __obj = js.Dynamic.literal()
  ...
  object ISubmit {
    ...
    extension [Self <: ISubmit](x: Self) {
      ...
      inline def setClientValidationUndefined: Self = StObject.set(x, "clientValidation", js.undefined)
    }
  }
}
