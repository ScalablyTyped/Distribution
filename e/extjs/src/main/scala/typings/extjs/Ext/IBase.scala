...
trait IBase
  ...
  /** [Method] Initialize configuration for this class
    ...
    */
  var initConfig: js.UndefOr[js.Function1[/* config */ js.UndefOr[Any], this.type]] = js.undefined
...
object IBase {
  ...
  extension [Self <: IBase](x: Self) {
    ...
    inline def setInitConfig(value: /* config */ js.UndefOr[Any] => IBase): Self = StObject.set(x, "initConfig", js.Any.fromFunction1(value))
