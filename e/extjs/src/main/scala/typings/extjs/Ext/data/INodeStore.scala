...
object INodeStore {
  ...
  def apply(
    ...
    isExpandingOrCollapsing: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(isExpandingOrCollapsing)) __obj.updateDynamic("isExpandingOrCollapsing")(isExpandingOrCollapsing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isNodeStore)) __obj.updateDynamic("isNodeStore")(isNodeStore.get.asInstanceOf[js.Any])
    ...
    if (treeStore != null) __obj.updateDynamic("treeStore")(treeStore.asInstanceOf[js.Any])
