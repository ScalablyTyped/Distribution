...
@js.native
trait IStackedBarChart extends ICartesian {
  ...
  var highlightItem_IStackedBarChart: js.UndefOr[js.Function1[/* item */ js.UndefOr[js.Any], Unit]] = js.native
  /** [Config Option] (Boolean) */
  ...
  var unHighlightItem_IStackedBarChart: js.UndefOr[js.Function0[Unit]] = js.native
...
object IStackedBarChart {
  ...
  @scala.inline
  implicit class IStackedBarChartOps[Self <: IStackedBarChart] (val x: Self) extends AnyVal {
    @scala.inline
