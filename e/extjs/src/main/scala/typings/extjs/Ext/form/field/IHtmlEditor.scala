...
object IHtmlEditor {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableAlignments)) __obj.updateDynamic("enableAlignments")(enableAlignments.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableColors)) __obj.updateDynamic("enableColors")(enableColors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableFont)) __obj.updateDynamic("enableFont")(enableFont.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableFontSize)) __obj.updateDynamic("enableFontSize")(enableFontSize.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableFormat)) __obj.updateDynamic("enableFormat")(enableFormat.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableLinks)) __obj.updateDynamic("enableLinks")(enableLinks.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableLists)) __obj.updateDynamic("enableLists")(enableLists.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableSourceEdit)) __obj.updateDynamic("enableSourceEdit")(enableSourceEdit.get.asInstanceOf[js.Any])
