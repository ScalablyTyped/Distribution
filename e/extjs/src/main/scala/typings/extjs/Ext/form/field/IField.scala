...
object IField {
  ...
  implicit open class MutableBuilder[Self <: IField] (val x: Self) extends AnyVal {
    ...
    inline def setExtractFileInput(value: () => Any): Self = StObject.set(x, "extractFileInput", js.Any.fromFunction0(value))
    ...
    inline def setIsDirty(value: () => Any): Self = StObject.set(x, "isDirty", js.Any.fromFunction0(value))
    ...
    inline def setIsFileUpload(value: () => Any): Self = StObject.set(x, "isFileUpload", js.Any.fromFunction0(value))
    ...
    inline def setIsValid(value: () => Any): Self = StObject.set(x, "isValid", js.Any.fromFunction0(value))
    
    inline def setIsValidUndefined: Self = StObject.set(x, "isValid", js.undefined)
    
    inline def setMarkInvalid(value: /* errors */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "markInvalid", js.Any.fromFunction1(value))
