...
object Record extends js.Object {
  ...
  /** [Method] Returns the configured Proxy for this Model
  		...
  		*/
  def getProxy(): typings.extjs.Ext.data.proxy.IProxy = js.native
  ...
  /** [Method] Sets the Proxy to use for this model
  		...
  		*/
  def setProxy(): typings.extjs.Ext.data.proxy.IProxy = js.native
  def setProxy(proxy: js.Any): typings.extjs.Ext.data.proxy.IProxy = js.native
}
