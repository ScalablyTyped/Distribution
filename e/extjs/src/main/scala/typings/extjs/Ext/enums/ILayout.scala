...
object ILayout {
  ...
  def apply(
    ...
    if (autocomponent != null) __obj.updateDynamic("autocomponent")(autocomponent)
    if (autocontainer != null) __obj.updateDynamic("autocontainer")(autocontainer)
    ...
    if (hbox != null) __obj.updateDynamic("hbox")(hbox)
    if (table != null) __obj.updateDynamic("table")(table)
    if (vbox != null) __obj.updateDynamic("vbox")(vbox)
