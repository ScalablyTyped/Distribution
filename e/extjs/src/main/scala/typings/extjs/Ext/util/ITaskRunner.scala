...
trait ITaskRunner
  ...
  /** [Method] Creates a new Task instance
    ...
    */
  var newTask: js.UndefOr[js.Function1[/* config */ js.UndefOr[Any], Unit]] = js.undefined
  
  /** [Method] Starts a new task
    * @param task Object A config object that supports the following properties:
    * @returns Object The task
    */
  var start: js.UndefOr[js.Function1[/* task */ js.UndefOr[Any], Any]] = js.undefined
  
  /** [Method] Stops an existing running task
    * @param task Object The task to stop
    * @returns Object The task
    */
  var stop: js.UndefOr[js.Function1[/* task */ js.UndefOr[Any], Any]] = js.undefined
...
object ITaskRunner {
  ...
  extension [Self <: ITaskRunner](x: Self) {
    ...
    inline def setNewTask(value: /* config */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "newTask", js.Any.fromFunction1(value))
    
    inline def setNewTaskUndefined: Self = StObject.set(x, "newTask", js.undefined)
    
    inline def setStart(value: /* task */ js.UndefOr[Any] => Any): Self = StObject.set(x, "start", js.Any.fromFunction1(value))
    
    inline def setStartUndefined: Self = StObject.set(x, "start", js.undefined)
    
    inline def setStop(value: /* task */ js.UndefOr[Any] => Any): Self = StObject.set(x, "stop", js.Any.fromFunction1(value))
