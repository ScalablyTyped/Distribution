...
import typings.extjs.Ext.form.ILabelable
...
object IFormPanel {
  ...
  implicit open class MutableBuilder[Self <: IFormPanel] (val x: Self) extends AnyVal {
    ...
    inline def setOnFieldErrorChange(value: (js.UndefOr[ILabelable], js.UndefOr[java.lang.String]) => Unit): Self = StObject.set(x, "onFieldErrorChange", js.Any.fromFunction2(value))
    
    inline def setOnFieldErrorChangeUndefined: Self = StObject.set(x, "onFieldErrorChange", js.undefined)
    
    inline def setOnFieldValidityChange(value: (js.UndefOr[IField], js.UndefOr[Boolean]) => Unit): Self = StObject.set(x, "onFieldValidityChange", js.Any.fromFunction2(value))
