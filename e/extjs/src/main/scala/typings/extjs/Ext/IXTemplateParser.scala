...
object IXTemplateParser {
  ...
  extension [Self <: IXTemplateParser](x: Self) {
    ...
    inline def setDoForEach(value: (/* action */ js.UndefOr[java.lang.String], /* actions */ js.UndefOr[js.Any]) => Unit): Self = StObject.set(x, "doForEach", js.Any.fromFunction2(value))
