...
object IXTemplateParser {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IXTemplateParser] (val x: Self) extends AnyVal {
    ...
    inline def setDoForEach(value: (/* action */ js.UndefOr[java.lang.String], /* actions */ js.UndefOr[Any]) => Unit): Self = StObject.set(x, "doForEach", js.Any.fromFunction2(value))
    ...
    inline def setDoTag(value: () => Unit): Self = StObject.set(x, "doTag", js.Any.fromFunction0(value))
