...
object IXTemplateParser {
  ...
  def apply(
    ...
    doForEach: (/* action */ js.UndefOr[java.lang.String], /* actions */ js.UndefOr[js.Any]) => Unit = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IXTemplateParser = null,
    ...
    if (doTag != null) __obj.updateDynamic("doTag")(js.Any.fromFunction0(doTag))
