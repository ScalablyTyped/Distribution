...
object IElement {
  ...
  def apply(
    ...
    addClsOnClick: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    addClsOnFocus: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    addClsOnOver: (/* className */ js.UndefOr[java.lang.String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    ...
    addListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    alias: Array = null,
    alternateClassName: js.Any = null,
    animate: /* config */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    appendChild: (/* el */ js.UndefOr[js.Any], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    appendTo: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    applyStyles: /* styles */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    autoBoxAdjust: js.UndefOr[Boolean] = js.undefined,
    blur: () => typings.extjs.Ext.dom.IElement = null,
    boxWrap: /* clazz */ js.UndefOr[java.lang.String] => typings.extjs.Ext.dom.IElement = null,
    ...
    clearListeners: () => typings.extjs.Ext.dom.IElement = null,
    clearOpacity: () => typings.extjs.Ext.dom.IElement = null,
    clearPositioning: /* value */ js.UndefOr[java.lang.String] => typings.extjs.Ext.dom.IElement = null,
    clip: () => typings.extjs.Ext.dom.IElement = null,
    config: js.Any = null,
    contains: /* el */ js.UndefOr[js.Any] => Boolean = null,
    createChild: (/* config */ js.UndefOr[js.Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    createProxy: (/* config */ js.UndefOr[js.Any], /* renderTo */ js.UndefOr[js.Any], /* matchBox */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    createShim: () => typings.extjs.Ext.dom.IElement = null,
    defaultUnit: java.lang.String = null,
    destroy: () => Unit = null,
    dom: HTMLElement = null,
    down: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    enableDisplayMode: /* display */ js.UndefOr[java.lang.String] => typings.extjs.Ext.dom.IElement = null,
    extend: java.lang.String = null,
    fadeIn: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    fadeOut: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    ...
    focus: /* defer */ js.UndefOr[Double] => typings.extjs.Ext.dom.IElement = null,
    focusable: () => Boolean = null,
    frame: (/* color */ js.UndefOr[java.lang.String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    ...
    getXY: () => Array = null,
    getY: () => Double = null,
    ghost: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    ...
    highlight: (/* color */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    hover: (/* overFn */ js.UndefOr[js.Any], /* outFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    id: java.lang.String = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    ...
    insertAfter: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    insertBefore: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    insertFirst: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    insertHtml: (/* where */ js.UndefOr[java.lang.String], /* html */ js.UndefOr[java.lang.String], /* returnEl */ js.UndefOr[Boolean]) => _ = null,
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    ...
    load: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    mask: (/* msg */ js.UndefOr[java.lang.String], /* msgCls */ js.UndefOr[java.lang.String]) => typings.extjs.Ext.dom.IElement = null,
    mixins: js.Any = null,
    monitorMouseLeave: (/* delay */ js.UndefOr[Double], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    moveTo: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    needsTabIndex: () => Unit = null,
    next: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    on: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    originalDisplay: java.lang.String = null,
    parent: (/* selector */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => _ = null,
    pause: /* seconds */ js.UndefOr[Double] => typings.extjs.Ext.dom.IElement = null,
    ...
    puff: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    purgeAllListeners: () => typings.extjs.Ext.dom.IElement = null,
    ...
    remove: () => Unit = null,
    removeAllListeners: () => typings.extjs.Ext.dom.IElement = null,
    removeCls: /* className */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    removeListener: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    repaint: () => typings.extjs.Ext.dom.IElement = null,
    replace: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    ...
    replaceWith: /* el */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    requires: Array = null,
    scale: (/* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    scroll: (/* direction */ js.UndefOr[java.lang.String], /* distance */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => Boolean = null,
    scrollBy: (/* deltaX */ js.UndefOr[js.Any], /* deltaY */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    scrollIntoView: (/* container */ js.UndefOr[js.Any], /* hscroll */ js.UndefOr[Boolean], /* animate */ js.UndefOr[js.Any], /* highlight */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    scrollTo: (/* side */ js.UndefOr[java.lang.String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    select: (/* selector */ js.UndefOr[java.lang.String], /* unique */ js.UndefOr[Boolean]) => typings.extjs.Ext.ICompositeElement = null,
    selectable: () => typings.extjs.Ext.dom.IElement = null,
    self: IClass = null,
    ...
    setBottom: /* bottom */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    setBounds: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* width */ js.UndefOr[js.Any], /* height */ js.UndefOr[js.Any], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    setDisplayed: /* value */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    ...
    setLocation: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    setOpacity: (/* opacity */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    setPositioning: /* posCfg */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    setRight: /* right */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    setScrollLeft: /* left */ js.UndefOr[Double] => typings.extjs.Ext.dom.IElement = null,
    setScrollTop: /* top */ js.UndefOr[Double] => typings.extjs.Ext.dom.IElement = null,
    ...
    setVisibilityMode: /* mode */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    ...
    shift: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    show: /* animate */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    slideIn: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    slideOut: (/* anchor */ js.UndefOr[java.lang.String], /* options */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    statics: js.Any = null,
    swallowEvent: (/* eventName */ js.UndefOr[js.Any], /* preventDefault */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.IElement = null,
    switchOff: /* options */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    toggle: /* animate */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.IElement = null,
    toggleCls: /* className */ js.UndefOr[java.lang.String] => typings.extjs.Ext.dom.IElement = null,
    un: (/* eventName */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    unclip: () => typings.extjs.Ext.dom.IElement = null,
    unmask: () => Unit = null,
    unselectable: () => typings.extjs.Ext.dom.IElement = null,
    ...
    update: (/* html */ js.UndefOr[java.lang.String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.IElement = null,
    uses: Array = null,
