...
object ICheckboxGroup {
  ...
  implicit class ICheckboxGroupMutableBuilder[Self <: ICheckboxGroup] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetErrors(value: js.Function0[Array] | (js.Function1[/* value */ js.UndefOr[js.Any], js.Any])): Self = StObject.set(x, "getErrors", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGetErrorsFunction0(value: () => Array): Self = StObject.set(x, "getErrors", js.Any.fromFunction0(value))
    
    @scala.inline
    def setGetErrorsFunction1(value: /* value */ js.UndefOr[js.Any] => js.Any): Self = StObject.set(x, "getErrors", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setGetValue(value: () => js.Any | Unit): Self = StObject.set(x, "getValue", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setSetValue(value: js.UndefOr[js.Any] => ICheckboxGroup | js.Any): Self = StObject.set(x, "setValue", js.Any.fromFunction1(value))
