...
object ISvg {
  ...
  def apply(
    ...
    applyZIndex: /* sprite */ js.UndefOr[ISprite] => Unit = null,
    ...
    hasCls: (/* sprite */ js.UndefOr[ISprite], /* className */ js.UndefOr[java.lang.String]) => Boolean = null,
    ...
    setText: (/* sprite */ js.UndefOr[js.Any], /* textString */ js.UndefOr[js.Any]) => Unit = null,
