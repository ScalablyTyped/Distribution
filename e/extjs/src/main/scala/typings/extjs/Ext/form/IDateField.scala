...
trait IDateField
  ...
  /** [Method] Sets the value of the date field
    ...
    */
  @JSName("setValue")
  var setValue_IDateField: js.UndefOr[js.Function1[/* date */ js.UndefOr[js.Any], typings.extjs.Ext.form.field.IDate]] = js.undefined
...
object IDateField {
  ...
  extension [Self <: IDateField](x: Self) {
    ...
    inline def setSetValue(value: /* date */ js.UndefOr[js.Any] => typings.extjs.Ext.form.field.IDate): Self = StObject.set(x, "setValue", js.Any.fromFunction1(value))
