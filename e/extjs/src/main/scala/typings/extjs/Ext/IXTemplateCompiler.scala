...
object IXTemplateCompiler {
  ...
  implicit class IXTemplateCompilerOps[Self <: IXTemplateCompiler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDoForEach(value: (/* action */ js.UndefOr[js.Any], /* actions */ js.UndefOr[js.Any]) => Unit): Self = this.set("doForEach", js.Any.fromFunction2(value))
    
    @scala.inline
    def deleteDoForEach: Self = this.set("doForEach", js.undefined)
