...
trait IXTemplateCompiler
  ...
  /** [Method] This method is called to process lt tpl foreach action gt
    ...
    */
  @JSName("doForEach")
  var doForEach_IXTemplateCompiler: js.UndefOr[js.Function2[/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any], Unit]] = js.undefined
...
object IXTemplateCompiler {
  ...
  extension [Self <: IXTemplateCompiler](x: Self) {
    ...
    inline def setDoForEach(value: (/* action */ js.UndefOr[Any], /* actions */ js.UndefOr[Any]) => Unit): Self = StObject.set(x, "doForEach", js.Any.fromFunction2(value))
