...
object Draw extends js.Object {
  ...
  def snapEndsByDateAndStep(from: js.Any, to: js.Any, step: Array): js.Any = js.native
  def snapEndsByDateAndStep(from: js.Any, to: js.Any, step: Array, lockEnds: Boolean): js.Any = js.native
