...
object ICompositeElementLite {
  @scala.inline
  def apply(
    add: /* els */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.ICompositeElement = null,
    alias: Array = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.extjs.Ext.dom.ICompositeElement = null,
    elements: Array = null,
    extend: java.lang.String = null,
    fill: /* els */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.ICompositeElement = null,
    filter: /* selector */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.ICompositeElement = null,
    first: () => typings.extjs.Ext.dom.IElement = null,
    getCount: () => Double = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    indexOf: /* el */ js.UndefOr[js.Any] => Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* config */ js.UndefOr[js.Any] => typings.extjs.Ext.dom.ICompositeElementLite = null,
    isComposite: js.UndefOr[Boolean] = js.undefined,
    item: /* index */ js.UndefOr[Double] => typings.extjs.Ext.dom.IElement = null,
    last: () => typings.extjs.Ext.dom.IElement = null,
    mixins: js.Any = null,
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.ICompositeElement = null,
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typings.extjs.Ext.dom.ICompositeElement = null,
    requires: Array = null,
    self: IClass = null,
