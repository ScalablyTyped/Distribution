...
trait ICompositeElementLite extends IBase {
  /** [Method] Adds elements to this Composite object
    ...
    */
  var add: js.UndefOr[js.Function1[/* els */ js.UndefOr[js.Any], ICompositeElement]] = js.native
  ...
  /** [Method] Clears this Composite and adds the elements passed
    ...
    * @returns Ext.dom.CompositeElement this
    */
  var fill: js.UndefOr[js.Function1[/* els */ js.UndefOr[js.Any], ICompositeElement]] = js.native
  /** [Method] Filters this composite to only elements that match the passed selector
    ...
    * @returns Ext.dom.CompositeElement this
    */
  var filter: js.UndefOr[js.Function1[/* selector */ js.UndefOr[js.Any], ICompositeElement]] = js.native
  /** [Method] Returns the first Element
    * @returns Ext.dom.Element
    */
  var first: js.UndefOr[js.Function0[IElement]] = js.native
  ...
  /** [Method] Returns a flyweight Element of the dom element object at the specified index
    ...
    * @returns Ext.dom.Element
    */
  var item: js.UndefOr[js.Function1[/* index */ js.UndefOr[Double], IElement]] = js.native
  /** [Method] Returns the last Element
    * @returns Ext.dom.Element
    */
  var last: js.UndefOr[js.Function0[IElement]] = js.native
...
object ICompositeElementLite {
  ...
  implicit class ICompositeElementLiteOps[Self <: ICompositeElementLite] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(value: /* els */ js.UndefOr[js.Any] => ICompositeElement): Self = this.set("add", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setEach(value: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => ICompositeElement): Self = this.set("each", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setFill(value: /* els */ js.UndefOr[js.Any] => ICompositeElement): Self = this.set("fill", js.Any.fromFunction1(value))
    @scala.inline
    def deleteFill: Self = this.set("fill", js.undefined)
    @scala.inline
    def setFilter(value: /* selector */ js.UndefOr[js.Any] => ICompositeElement): Self = this.set("filter", js.Any.fromFunction1(value))
    @scala.inline
    def deleteFilter: Self = this.set("filter", js.undefined)
    @scala.inline
    def setFirst(value: () => IElement): Self = this.set("first", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setItem(value: /* index */ js.UndefOr[Double] => IElement): Self = this.set("item", js.Any.fromFunction1(value))
    @scala.inline
    def deleteItem: Self = this.set("item", js.undefined)
    @scala.inline
    def setLast(value: () => IElement): Self = this.set("last", js.Any.fromFunction0(value))
    @scala.inline
    def deleteLast: Self = this.set("last", js.undefined)
    @scala.inline
    def setRemoveElement(value: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => ICompositeElement): Self = this.set("removeElement", js.Any.fromFunction2(value))
    @scala.inline
    def deleteRemoveElement: Self = this.set("removeElement", js.undefined)
    @scala.inline
    def setReplaceElement(
      value: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => ICompositeElement
