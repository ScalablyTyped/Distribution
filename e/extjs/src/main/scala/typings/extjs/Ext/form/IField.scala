...
trait IField extends IComponent {
  ...
  var initRenderData_IField: js.UndefOr[js.Function0[_]] = js.native
  ...
  /** [Method] private */
  @JSName("onRender")
  var onRender_IField: js.UndefOr[js.Function0[Unit]] = js.native
