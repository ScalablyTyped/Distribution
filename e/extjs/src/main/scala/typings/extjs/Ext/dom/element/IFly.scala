package typings.extjs.Ext.dom.element
...
object IFly {
  ...
  def apply(
    ...
    addClsOnOver: (/* className */ js.UndefOr[String], /* testFn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IFly = null,
    ...
    addListener: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => IFly = null,
    alias: Array = null,
    ...
    blur: () => IFly = null,
    boxWrap: /* clazz */ js.UndefOr[String] => IFly = null,
    ...
    clearPositioning: /* value */ js.UndefOr[String] => IFly = null,
    clip: () => IFly = null,
    config: js.Any = null,
    ...
    enableDisplayMode: /* display */ js.UndefOr[String] => IFly = null,
    extend: String = null,
    ...
    frame: (/* color */ js.UndefOr[String], /* count */ js.UndefOr[Double], /* options */ js.UndefOr[js.Any]) => IFly = null,
    ...
    getXY: () => Array = null,
    getY: () => Double = null,
    ghost: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IFly = null,
    hasCls: /* className */ js.UndefOr[String] => Boolean = null,
    hide: /* animate */ js.UndefOr[js.Any] => IFly = null,
    highlight: (/* color */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IFly = null,
    ...
    insertSibling: (/* el */ js.UndefOr[js.Any], /* where */ js.UndefOr[String], /* returnDom */ js.UndefOr[Boolean]) => IFly = null,
    ...
    mask: (/* msg */ js.UndefOr[String], /* msgCls */ js.UndefOr[String]) => IFly = null,
    mixins: js.Any = null,
    ...
    on: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* options */ js.UndefOr[js.Any]) => IFly = null,
    ...
    removeListener: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IFly = null,
    ...
    scrollTo: (/* side */ js.UndefOr[String], /* value */ js.UndefOr[Double], /* animate */ js.UndefOr[js.Any]) => IFly = null,
    ...
    slideIn: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IFly = null,
    slideOut: (/* anchor */ js.UndefOr[String], /* options */ js.UndefOr[js.Any]) => IFly = null,
    statics: js.Any = null,
    ...
    un: (/* eventName */ js.UndefOr[String], /* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => IFly = null,
    unclip: () => IFly = null,
    unmask: () => Unit = null,
    ...
    update: (/* html */ js.UndefOr[String], /* loadScripts */ js.UndefOr[Boolean], /* callback */ js.UndefOr[js.Any]) => IFly = null,
    uses: Array = null,
