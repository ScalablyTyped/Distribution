...
object IBorder {
  ...
  def apply(
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IBorder = null,
    ...
    if (!js.isUndefined(splitterResize)) __obj.updateDynamic("splitterResize")(splitterResize.get.asInstanceOf[js.Any])
