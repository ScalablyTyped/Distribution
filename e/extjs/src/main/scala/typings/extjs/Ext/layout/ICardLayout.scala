...
object ICardLayout {
  ...
  def apply(
    ...
    requires: Array = null,
    self: IClass = null,
    setActiveItem: /* newCard */ js.UndefOr[js.Any] => IComponent = null,
