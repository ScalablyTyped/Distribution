...
- typings.extjs.Ext.util.IObservable because var conflicts: addEvents, addListener, addManagedListener, clearListeners, clearManagedListeners, enableBubble, fireEvent, fireEventArgs, hasListener, mon, mun, on, relayEvents, removeListener, removeManagedListener, resumeEvent, resumeEvents, suspendEvent, suspendEvents, un. Inlined listeners, hasListeners, isObservable
...
- typings.extjs.Ext.util.IAbstractMixedCollection because var conflicts: allowFunctions, clone. Inlined isMixedCollection, add, addAll, addEvents, addListener, addManagedListener, clear, clearListeners, clearManagedListeners, collect, contains, containsKey, each, eachKey, enableBubble, filter, filterBy, find, findBy, findIndex, findIndexBy, fireEvent, fireEventArgs, first, get, getAt, getByKey, getCount, getKey, getRange, hasListener, indexOf, indexOfKey, insert, last, mon, mun, on, relayEvents, remove, removeAll, removeAt, removeAtKey, removeListener, removeManagedListener, removeRange, replace, resumeEvent, resumeEvents, sum, suspendEvent, suspendEvents, un, updateKey
- typings.extjs.Ext.util.IMixedCollection because var conflicts: clone. Inlined allowFunctions, findInsertionIndex, generateComparator, getFirstSorter, initSortable, reorder, sort, sortBy, sortByKey */ trait IErrors
  extends StObject
     with IBase {
...
object IErrors {
  ...
  extension [Self <: IErrors](x: Self) {
    ...
    inline def setAdd(value: (/* key */ js.UndefOr[js.Any], /* obj */ js.UndefOr[js.Any]) => js.Any): Self = StObject.set(x, "add", js.Any.fromFunction2(value))
