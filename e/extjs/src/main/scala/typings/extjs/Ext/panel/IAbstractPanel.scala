...
object IAbstractPanel {
  ...
  def apply(
    ...
    if (!js.isUndefined(bodyBorder)) __obj.updateDynamic("bodyBorder")(bodyBorder.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(isPanel)) __obj.updateDynamic("isPanel")(isPanel.get.asInstanceOf[js.Any])
