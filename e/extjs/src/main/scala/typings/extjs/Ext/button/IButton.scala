...
object IButton {
  ...
  def apply(
    ...
    if (!js.isUndefined(isAction)) __obj.updateDynamic("isAction")(isAction.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showEmptyMenu)) __obj.updateDynamic("showEmptyMenu")(showEmptyMenu.get.asInstanceOf[js.Any])
