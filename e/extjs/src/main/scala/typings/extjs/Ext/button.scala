...
object button {
  ...
  object IButton {
    ...
    inline def apply(): typings.extjs.Ext.button.IButton = {
    ...
    extension [Self <: typings.extjs.Ext.button.IButton](x: Self) {
      ...
      inline def setHideMenu(value: () => typings.extjs.Ext.button.IButton): Self = StObject.set(x, "hideMenu", js.Any.fromFunction0(value))
      ...
      inline def setSetIcon(value: /* icon */ js.UndefOr[java.lang.String] => typings.extjs.Ext.button.IButton): Self = StObject.set(x, "setIcon", js.Any.fromFunction1(value))
      
      inline def setSetIconCls(value: /* cls */ js.UndefOr[java.lang.String] => typings.extjs.Ext.button.IButton): Self = StObject.set(x, "setIconCls", js.Any.fromFunction1(value))
      ...
      inline def setSetText(value: /* text */ js.UndefOr[java.lang.String] => typings.extjs.Ext.button.IButton): Self = StObject.set(x, "setText", js.Any.fromFunction1(value))
