...
@js.native
trait IBasic extends IObservable {
  ...
  /** [Method] Calls Ext applyIf for all field in this form with the passed object
    ...
    */
  var applyIfToFields: js.UndefOr[js.Function1[/* obj */ js.UndefOr[js.Any], this.type]] = js.native
  
  /** [Method] Calls Ext apply for all fields in this form with the passed object
    * @param obj Object The object to be applied
    * @returns Ext.form.Basic this
    */
  var applyToFields: js.UndefOr[js.Function1[/* obj */ js.UndefOr[js.Any], this.type]] = js.native
  ...
  /** [Method] Clears all invalid field messages in this form
    * @returns Ext.form.Basic this
    */
  var clearInvalid: js.UndefOr[js.Function0[this.type]] = js.native
  ...
  /** [Method] Mark fields in this form invalid in bulk
    ...
    * @returns Ext.form.Basic this
    */
  var markInvalid: js.UndefOr[js.Function1[/* errors */ js.UndefOr[js.Any], this.type]] = js.native
  ...
  /** [Method] Resets all fields in this form
    ...
    * @returns Ext.form.Basic this
    */
  var reset: js.UndefOr[js.Function1[/* resetRecord */ js.UndefOr[Boolean], this.type]] = js.native
  ...
  /** [Method] Shortcut to do a submit action
    ...
    * @returns Ext.form.Basic this
    */
  var submit: js.UndefOr[js.Function1[/* options */ js.UndefOr[js.Any], this.type]] = js.native
  ...
  /** [Method] Persists the values in this form into the passed Ext data Model object in a beginEdit endEdit block
    ...
    * @returns Ext.form.Basic this
    */
  var updateRecord: js.UndefOr[js.Function1[/* record */ js.UndefOr[IModel], this.type]] = js.native
...
object IBasic {
  ...
  @scala.inline
  implicit class IBasicMutableBuilder[Self <: IBasic] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFindField(value: /* id */ js.UndefOr[String] => _): Self = StObject.set(x, "findField", js.Any.fromFunction1(value))
    
    @scala.inline
    def setFindFieldUndefined: Self = StObject.set(x, "findField", js.undefined)
    
    @scala.inline
    def setGetFieldValues(value: /* dirtyOnly */ js.UndefOr[Boolean] => _): Self = StObject.set(x, "getFieldValues", js.Any.fromFunction1(value))
