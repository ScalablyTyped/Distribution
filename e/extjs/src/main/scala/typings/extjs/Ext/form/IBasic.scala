...
trait IBasic
  ...
  /** [Method] Calls Ext applyIf for all field in this form with the passed object
    ...
    */
  var applyIfToFields: js.UndefOr[js.Function1[/* obj */ js.UndefOr[Any], this.type]] = js.undefined
  
  /** [Method] Calls Ext apply for all fields in this form with the passed object
    * @param obj Object The object to be applied
    * @returns Ext.form.Basic this
    */
  var applyToFields: js.UndefOr[js.Function1[/* obj */ js.UndefOr[Any], this.type]] = js.undefined
  ...
  var doAction: js.UndefOr[
    js.Function2[/* action */ js.UndefOr[Any], /* options */ js.UndefOr[Any], this.type]
  ] = js.undefined
  ...
  /** [Method] Mark fields in this form invalid in bulk
    ...
    * @returns Ext.form.Basic this
    */
  var markInvalid: js.UndefOr[js.Function1[/* errors */ js.UndefOr[Any], this.type]] = js.undefined
  ...
  /** [Method] Resets all fields in this form
    ...
    * @returns Ext.form.Basic this
    */
  var reset: js.UndefOr[js.Function1[/* resetRecord */ js.UndefOr[Boolean], this.type]] = js.undefined
  ...
  /** [Method] Set values for fields in this form in bulk
    ...
    * @returns Ext.form.Basic this
    */
  var setValues: js.UndefOr[js.Function1[/* values */ js.UndefOr[Any], this.type]] = js.undefined
  ...
  /** [Method] Shortcut to do a submit action
    ...
    * @returns Ext.form.Basic this
    */
  var submit: js.UndefOr[js.Function1[/* options */ js.UndefOr[Any], this.type]] = js.undefined
