...
trait IPieSeries extends ISeries {
  ...
  var highlightItem_IPieSeries: js.UndefOr[js.Function1[/* item */ js.UndefOr[js.Any], Unit]] = js.native
  /** [Config Option] (String) */
  ...
  var unHighlightItem_IPieSeries: js.UndefOr[js.Function1[/* item */ js.UndefOr[js.Any], Unit]] = js.native
  /** [Config Option] (String) */
...
object IPieSeries {
  ...
  @scala.inline
  implicit class IPieSeriesOps[Self <: IPieSeries] (val x: Self) extends AnyVal {
    @scala.inline
