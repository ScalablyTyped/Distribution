...
object IAbstractComponent {
  ...
  extension [Self <: IAbstractComponent](x: Self) {
    ...
    inline def setAddUIClsToElement(value: /* ui */ js.UndefOr[java.lang.String] => Unit): Self = StObject.set(x, "addUIClsToElement", js.Any.fromFunction1(value))
    ...
    inline def setAfterSetPosition(value: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "afterSetPosition", js.Any.fromFunction2(value))
    ...
    inline def setBeforeBlur(value: /* e */ js.UndefOr[IEventObject] => Unit): Self = StObject.set(x, "beforeBlur", js.Any.fromFunction1(value))
    
    inline def setBeforeBlurUndefined: Self = StObject.set(x, "beforeBlur", js.undefined)
    
    inline def setBeforeComponentLayout(value: (/* adjWidth */ js.UndefOr[Double], /* adjHeight */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "beforeComponentLayout", js.Any.fromFunction2(value))
    ...
    inline def setBeforeFocus(value: /* e */ js.UndefOr[IEventObject] => Unit): Self = StObject.set(x, "beforeFocus", js.Any.fromFunction1(value))
    
    inline def setBeforeFocusUndefined: Self = StObject.set(x, "beforeFocus", js.undefined)
    
    inline def setBeforeLayout(value: () => Unit): Self = StObject.set(x, "beforeLayout", js.Any.fromFunction0(value))
    ...
    inline def setDisable(value: /* silent */ js.UndefOr[Boolean] => Unit): Self = StObject.set(x, "disable", js.Any.fromFunction1(value))
    ...
    inline def setDoComponentLayout(value: () => typings.extjs.Ext.container.IContainer): Self = StObject.set(x, "doComponentLayout", js.Any.fromFunction0(value))
    ...
    inline def setEnsureAttachedToBody(value: js.UndefOr[Boolean] => Unit): Self = StObject.set(x, "ensureAttachedToBody", js.Any.fromFunction1(value))
    ...
    inline def setForceComponentLayout(value: () => Unit): Self = StObject.set(x, "forceComponentLayout", js.Any.fromFunction0(value))
    ...
    inline def setGetBubbleTarget(value: () => typings.extjs.Ext.container.IContainer): Self = StObject.set(x, "getBubbleTarget", js.Any.fromFunction0(value))
    
    inline def setGetBubbleTargetUndefined: Self = StObject.set(x, "getBubbleTarget", js.undefined)
    
    inline def setGetEl(value: () => typings.extjs.Ext.dom.IElement): Self = StObject.set(x, "getEl", js.Any.fromFunction0(value))
    ...
    inline def setGetLoader(value: () => IComponentLoader): Self = StObject.set(x, "getLoader", js.Any.fromFunction0(value))
    ...
    inline def setHasUICls(value: /* cls */ js.UndefOr[java.lang.String] => Unit): Self = StObject.set(x, "hasUICls", js.Any.fromFunction1(value))
    ...
    inline def setIsDroppable(value: () => Boolean): Self = StObject.set(x, "isDroppable", js.Any.fromFunction0(value))
    ...
    inline def setIsLayoutRoot(value: () => Unit): Self = StObject.set(x, "isLayoutRoot", js.Any.fromFunction0(value))
    
    inline def setIsLayoutRootUndefined: Self = StObject.set(x, "isLayoutRoot", js.undefined)
    
    inline def setIsLayoutSuspended(value: () => Boolean): Self = StObject.set(x, "isLayoutSuspended", js.Any.fromFunction0(value))
    ...
    inline def setOnPosition(value: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "onPosition", js.Any.fromFunction2(value))
    
    inline def setOnPositionUndefined: Self = StObject.set(x, "onPosition", js.undefined)
    
    inline def setOnRemoved(value: /* destroying */ js.UndefOr[Boolean] => Unit): Self = StObject.set(x, "onRemoved", js.Any.fromFunction1(value))
    
    inline def setOnRemovedUndefined: Self = StObject.set(x, "onRemoved", js.undefined)
    
    inline def setOnRender(value: (js.UndefOr[typings.extjs.Ext.core.IElement], js.UndefOr[Double]) => Unit): Self = StObject.set(x, "onRender", js.Any.fromFunction2(value))
    ...
    inline def setPostBlur(value: /* e */ js.UndefOr[IEventObject] => Unit): Self = StObject.set(x, "postBlur", js.Any.fromFunction1(value))
    ...
    inline def setRemoveUIClsFromElement(value: /* ui */ js.UndefOr[java.lang.String] => Unit): Self = StObject.set(x, "removeUIClsFromElement", js.Any.fromFunction1(value))
