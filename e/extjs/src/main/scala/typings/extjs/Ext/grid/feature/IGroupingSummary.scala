...
object IGroupingSummary {
  ...
  def apply(
    ...
    getFireEventArgs: (/* type */ js.UndefOr[js.Any], /* view */ js.UndefOr[js.Any], /* targetEl */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any]) => Unit = null,
    ...
    initConfig: /* config */ js.UndefOr[js.Any] => IGroupingSummary = null,
