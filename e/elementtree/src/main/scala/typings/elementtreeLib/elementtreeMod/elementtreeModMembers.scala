...
@js.native
object elementtreeModMembers extends js.Object {
  ...
  def Element(ElementTag: java.lang.String): Element = js.native
  def Element(ElementTag: java.lang.String, attrib: Attributes): Element = js.native
