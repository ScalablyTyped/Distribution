...
import typings.ethereumjsUtil.distTypesMod.AddressLike
...
object distTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ethereumjsTx.distLegacyTransactionMod.Transaction
    - typings.ethereumjsTx.distEip2930TransactionMod.AccessListEIP2930Transaction
    - typings.ethereumjsTx.distEip1559TransactionMod.FeeMarketEIP1559Transaction
  */
