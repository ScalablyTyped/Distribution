...
import typings.ethereumjsTx.typesMod.Capability
...
import typings.ethereumjsTx.typesMod.JsonTx
...
object baseTransactionMod {
  
  @JSImport("@ethereumjs/tx/dist/baseTransaction", "BaseTransaction")
  @js.native
  abstract class BaseTransaction[TransactionObject] protected () extends StObject {
