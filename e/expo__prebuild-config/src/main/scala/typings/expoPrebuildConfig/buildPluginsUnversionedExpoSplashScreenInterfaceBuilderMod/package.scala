...
import typings.expoPrebuildConfig.anon.ContentModeImageName
...
inline def applyImageToSplashScreenXML(xml: IBSplashScreenDocument, param1: ContentModeImageName): IBSplashScreenDocument = (^.asInstanceOf[js.Dynamic].applyDynamic("applyImageToSplashScreenXML")(xml.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[IBSplashScreenDocument]
...
inline def removeImageFromSplashScreen(xml: IBSplashScreenDocument, param1: ImageName): IBSplashScreenDocument = (^.asInstanceOf[js.Dynamic].applyDynamic("removeImageFromSplashScreen")(xml.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[IBSplashScreenDocument]
