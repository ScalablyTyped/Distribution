...
import typings.expoPrebuildConfig.interfaceBuilderMod.^
...
inline def applyImageToSplashScreenXML(xml: IBSplashScreenDocument, hasImageNameContentMode: ContentModeImageName): IBSplashScreenDocument = (^.asInstanceOf[js.Dynamic].applyDynamic("applyImageToSplashScreenXML")(xml.asInstanceOf[js.Any], hasImageNameContentMode.asInstanceOf[js.Any])).asInstanceOf[IBSplashScreenDocument]
...
inline def removeImageFromSplashScreen(xml: IBSplashScreenDocument, hasImageName: ImageName): IBSplashScreenDocument = (^.asInstanceOf[js.Dynamic].applyDynamic("removeImageFromSplashScreen")(xml.asInstanceOf[js.Any], hasImageName.asInstanceOf[js.Any])).asInstanceOf[IBSplashScreenDocument]
