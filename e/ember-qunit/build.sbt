...
name := "ember-qunit"
version := "3.4-dt-20190307Z-c24c86"
scalaVersion := "2.12.9"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "ember" % "3.1-dt-20190717Z-0fdf69",
  "org.scalablytyped" %%% "ember-test-helpers" % "1.0-dt-20190717Z-9edb63",
  ...
  "org.scalablytyped" %%% "qunit" % "v2.9.2-dt-20190429Z-c89a9b",
