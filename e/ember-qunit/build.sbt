...
name := "ember-qunit"
version := "3.4-dt-20191003Z-776d16"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "ember" % "3.1-dt-20191003Z-fb3f0f",
  "org.scalablytyped" %%% "ember-test-helpers" % "1.0-dt-20191003Z-d201bc",
  ...
  "org.scalablytyped" %%% "qunit" % "v2.9.2-dt-20190429Z-b13c32",
