...
name := "ember-qunit"
version := "3.4-dt-20191003Z-5b83ea"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "ember" % "3.1-dt-20191015Z-818dfa",
  "org.scalablytyped" %%% "ember-test-helpers" % "1.0-dt-20191003Z-e78b93",
  "org.scalablytyped" %%% "ember__application" % "3.0-dt-20190301Z-664c0f",
  ...
  "org.scalablytyped" %%% "ember__debug" % "3.0-dt-20191025Z-0b8b38",
  ...
  "org.scalablytyped" %%% "ember__test" % "3.0-dt-20190307Z-05e05e",
  "org.scalablytyped" %%% "ember__utils" % "3.0-dt-20191003Z-29aa86",
  "org.scalablytyped" %%% "jquery" % "3.3-dt-20190815Z-cc3e42",
  "org.scalablytyped" %%% "qunit" % "v2.9.2-dt-20190429Z-66a4cf",
