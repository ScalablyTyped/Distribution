...
name := "ember-qunit"
version := "3.4-dt-20191003Z-812c13"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "ember" % "3.1-dt-20191015Z-b91ee5",
  "org.scalablytyped" %%% "ember-test-helpers" % "1.0-dt-20191003Z-9d1e16",
  ...
  "org.scalablytyped" %%% "ember__test" % "3.0-dt-20191126Z-08734d",
