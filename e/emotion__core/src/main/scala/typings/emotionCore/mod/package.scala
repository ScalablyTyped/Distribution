...
package object mod {
  type ClassNamesArg = js.UndefOr[
    scala.Null | java.lang.String | scala.Boolean | (org.scalablytyped.runtime.StringDictionary[js.UndefOr[scala.Boolean | scala.Null]]) | typings.emotionCore.mod.ArrayClassNamesArg
  ]
