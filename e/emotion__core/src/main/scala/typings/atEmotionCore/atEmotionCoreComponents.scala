...
object atEmotionCoreComponents extends atEmotionCoreProps {
  ...
  @scala.inline
  def `jsx<apply>`[P /* <: js.Object */]: ComponentType[String] = typings.atEmotionCore.atEmotionCoreMod.jsx.asInstanceOf[js.Dynamic].selectDynamic("<apply>").asInstanceOf[typings.react.reactMod.ComponentType[java.lang.String]]
}
