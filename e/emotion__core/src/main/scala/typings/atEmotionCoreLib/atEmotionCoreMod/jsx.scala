...
object jsx extends js.Object {
  def apply(`type`: atEmotionCoreLib.atEmotionCoreLibStrings.input): reactLib.reactMod.DetailedReactHTMLElement[
    reactLib.reactMod.InputHTMLAttributes[reactLib.HTMLInputElement], 
    reactLib.HTMLInputElement
  ] = js.native
  def apply(
    `type`: atEmotionCoreLib.atEmotionCoreLibStrings.input,
