package typings.atEsfxCancelable.atEsfxCancelableMod

import typings.atEsfxCancelable.atEsfxCancelableStrings.CancelableSource
...
object CancelableSourceNs extends js.Object {
  ...
  val name: CancelableSource = js.native
  /**
