...
import typings.atEsfxCancelable.atEsfxCancelableStrings.Cancelable
import typings.atEsfxCancelable.distMod.CancelSubscription
import typings.atEsfxCancelable.distMod.CancelableCancelSignal
...
object CancelableNs extends js.Object {
  ...
  /**
    ...
    */
  def isSignaled(cancelable: typings.atEsfxCancelable.distMod.Cancelable): Boolean = js.native
  ...
  /**
    ...
    */
  def subscribe(cancelable: typings.atEsfxCancelable.distMod.Cancelable, onSignaled: js.Function0[Unit]): CancelSubscription = js.native
  def throwIfSignaled(): Unit = js.native
  /**
    * Throws a `CancelError` exception if the provided `cancelable` is in the signaled state.
    */
  def throwIfSignaled(cancelable: typings.atEsfxCancelable.distMod.Cancelable): Unit = js.native
}
