package typings.atEsfxCancelable
...
object atEsfxCancelableMod extends js.Object {
  @js.native
  class CancelError ()
    extends typings.atEsfxCancelable.distMod.CancelError {
  ...
  object CancelSubscription extends js.Object {
    /**
      ...
      */
    def create(unsubscribe: js.Function0[Unit]): typings.atEsfxCancelable.distMod.CancelSubscription = js.native
  }
