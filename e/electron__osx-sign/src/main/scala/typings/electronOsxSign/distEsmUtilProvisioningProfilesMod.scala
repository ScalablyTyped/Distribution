...
import typings.electronOsxSign.distEsmTypesMod.ElectronMacPlatform
...
object distEsmUtilProvisioningProfilesMod {
  
  @JSImport("@electron/osx-sign/dist/esm/util-provisioning-profiles", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@electron/osx-sign/dist/esm/util-provisioning-profiles", "ProvisioningProfile")
  @js.native
