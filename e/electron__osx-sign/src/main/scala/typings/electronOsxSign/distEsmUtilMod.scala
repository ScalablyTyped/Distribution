...
import typings.electronOsxSign.distEsmTypesMod.BaseSignOptions
...
object distEsmUtilMod {
  
  @JSImport("@electron/osx-sign/dist/esm/util", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@electron/osx-sign/dist/esm/util", "debugLog")
  @js.native
  val debugLog: Debugger = js.native
  
  @JSImport("@electron/osx-sign/dist/esm/util", "debugWarn")
  @js.native
  ...
  {{{
  type DeepListItem = null | T | std.Array<@electron/osx-sign.@electron/osx-sign/dist/esm/util.DeepListItem<T>>
  }}}
  to avoid circular code involving: 
  - @electron/osx-sign.@electron/osx-sign/dist/esm/util.DeepList
  - @electron/osx-sign.@electron/osx-sign/dist/esm/util.DeepListItem
  */
