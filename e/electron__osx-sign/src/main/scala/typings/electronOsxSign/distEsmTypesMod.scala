...
object distEsmTypesMod {
  ...
  /* Inlined std.Readonly<{  app :string,   identity :string | undefined,   platform :@electron/osx-sign.@electron/osx-sign/dist/esm/types.ElectronMacPlatform | undefined,   keychain :string | undefined}> */
  ...
  */
  ...
  /* Inlined std.Readonly<@electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlyFlatOptions & @electron/osx-sign.@electron/osx-sign/dist/esm/types.BaseSignOptions> */
  ...
  /* Inlined std.Readonly<@electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlySignOptions & @electron/osx-sign.@electron/osx-sign/dist/esm/types.BaseSignOptions> */
  ...
  */
  ...
  /* Inlined std.Readonly<@electron/osx-sign.@electron/osx-sign/dist/esm/types.ValidatedForm<@electron/osx-sign.@electron/osx-sign/dist/esm/types.BaseSignOptions, @electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlyValidatedBaseSignOptions>> */
  ...
  /* Inlined std.Readonly<@electron/osx-sign.@electron/osx-sign/dist/esm/types.ValidatedForm<@electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlyFlatOptions, @electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlyValidatedFlatOptions> & @electron/osx-sign.@electron/osx-sign/dist/esm/types.ValidatedBaseSignOptions> */
  ...
  /* Inlined std.Readonly<@electron/osx-sign.@electron/osx-sign/dist/esm/types.ValidatedForm<@electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlySignOptions, @electron/osx-sign.@electron/osx-sign/dist/esm/types.OnlyValidatedSignOptions> & @electron/osx-sign.@electron/osx-sign/dist/esm/types.ValidatedBaseSignOptions> */
