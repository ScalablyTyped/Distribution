...
@js.native
class Scope ()
  extends typings.eslint.mod.Scope.Scope {
  /* CompleteClass */
  override var block: Node = js.native
  /* CompleteClass */
  override var childScopes: js.Array[typings.eslint.mod.Scope.Scope] = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var set: Map[String, typings.eslint.mod.Scope.Variable] = js.native
  /* CompleteClass */
  override var through: js.Array[typings.eslint.mod.Scope.Reference] = js.native
  /* CompleteClass */
  override var `type`: block | `catch` | `class` | `for` | function | `function-expression-name` | global | module | switch | `with` | TDZ = js.native
  /* CompleteClass */
  override var upper: typings.eslint.mod.Scope.Scope | Null = js.native
  /* CompleteClass */
  override var variableScope: typings.eslint.mod.Scope.Scope = js.native
  /* CompleteClass */
  override var variables: js.Array[typings.eslint.mod.Scope.Variable] = js.native
}
