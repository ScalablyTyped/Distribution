...
import typings.evernote.Anon_Accounting
import typings.evernote.Anon_Active
import typings.evernote.Anon_ActiveAttributes
import typings.evernote.Anon_AllowPreview
import typings.evernote.Anon_Altitude
...
import typings.evernote.Anon_Attributes
import typings.evernote.Anon_AuthenticationToken
import typings.evernote.Anon_Body
import typings.evernote.Anon_BusinessAddress
import typings.evernote.Anon_BusinessId
...
import typings.evernote.Anon_ChunkHighUSN
import typings.evernote.Anon_ContactName
import typings.evernote.Anon_ContainingNotebooks
import typings.evernote.Anon_CurrentTime
import typings.evernote.Anon_ErrorCode
import typings.evernote.Anon_ErrorCodeMessage
import typings.evernote.Anon_ExpungeWhichSharedNotebookRestrictions
import typings.evernote.Anon_Filter
import typings.evernote.Anon_Format
import typings.evernote.Anon_FullMap
...
import typings.evernote.Anon_IncludeContainingNotebooks
import typings.evernote.Anon_IncludeExpunged
import typings.evernote.Anon_K
import typings.evernote.Anon_Name
import typings.evernote.Anon_NoteStoreUrl
...
import typings.evernote.evernoteMod.EvernoteNs.AuthenticationResult
import typings.evernote.evernoteMod.EvernoteNs.BootstrapInfo
...
import typings.evernote.evernoteMod.EvernoteNs.Callback
import typings.evernote.evernoteMod.EvernoteNs.Client
import typings.evernote.evernoteMod.EvernoteNs.ClientConfig
import typings.evernote.evernoteMod.EvernoteNs.ClientUsageMetrics
import typings.evernote.evernoteMod.EvernoteNs.Data
import typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode
import typings.evernote.evernoteMod.EvernoteNs.EDAMNotFoundException
import typings.evernote.evernoteMod.EvernoteNs.EDAMSystemException
import typings.evernote.evernoteMod.EvernoteNs.EDAMUserException
import typings.evernote.evernoteMod.EvernoteNs.LazyMap
import typings.evernote.evernoteMod.EvernoteNs.LinkedNotebook
import typings.evernote.evernoteMod.EvernoteNs.Note
import typings.evernote.evernoteMod.EvernoteNs.NoteAttributes
import typings.evernote.evernoteMod.EvernoteNs.NoteCollectionCounts
import typings.evernote.evernoteMod.EvernoteNs.NoteEmailParameters
import typings.evernote.evernoteMod.EvernoteNs.NoteFilter
import typings.evernote.evernoteMod.EvernoteNs.NoteList
import typings.evernote.evernoteMod.EvernoteNs.NoteMetadata
import typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder
import typings.evernote.evernoteMod.EvernoteNs.NoteStoreClient
import typings.evernote.evernoteMod.EvernoteNs.NoteVersionId
...
import typings.evernote.evernoteMod.EvernoteNs.NotesMetadataList
import typings.evernote.evernoteMod.EvernoteNs.NotesMetadataResultSpec
...
import typings.evernote.evernoteMod.EvernoteNs.RelatedQuery
import typings.evernote.evernoteMod.EvernoteNs.RelatedResult
import typings.evernote.evernoteMod.EvernoteNs.RelatedResultSpec
...
import typings.evernote.evernoteMod.EvernoteNs.SavedSearch
...
import typings.evernote.evernoteMod.EvernoteNs.SponsoredGroupRole
import typings.evernote.evernoteMod.EvernoteNs.SyncChunk
import typings.evernote.evernoteMod.EvernoteNs.SyncChunkFilter
import typings.evernote.evernoteMod.EvernoteNs.SyncState
...
import typings.evernote.evernoteMod.EvernoteNs.UserStoreClient
...
object EvernoteNs extends js.Object {
  ...
  class Accounting () extends js.Object {
    def this(args: Anon_BusinessId) = this()
  ...
  class Note () extends js.Object {
    def this(args: Anon_ActiveAttributes) = this()
  ...
  class NoteMetadata () extends js.Object {
    def this(args: Anon_Attributes) = this()
    var attributes: NoteAttributes = js.native
    var contentLength: Double = js.native
    var created: Double = js.native
    var deleted: Double = js.native
  ...
  class NotebookDescriptor () extends js.Object {
    def this(args: Anon_ContactName) = this()
  ...
  class PublicUserInfo () extends js.Object {
    def this(args: Anon_NoteStoreUrl) = this()
    var noteStoreUrl: String = js.native
  ...
  class RelatedResult () extends js.Object {
    def this(args: Anon_ContainingNotebooks) = this()
  ...
  class RelatedResultSpec () extends js.Object {
    def this(args: Anon_IncludeContainingNotebooks) = this()
  ...
  class SyncChunk () extends js.Object {
    def this(args: Anon_ChunkHighUSN) = this()
  ...
  object BusinessUserRole extends js.Object {
    ...
    /* 1 */ val ADMIN: typings.evernote.evernoteMod.EvernoteNs.BusinessUserRole.ADMIN with Double = js.native
    /* 2 */ val NORMAL: typings.evernote.evernoteMod.EvernoteNs.BusinessUserRole.NORMAL with Double = js.native
    @JSBracketAccess
  ...
  object EDAMErrorCode extends js.Object {
    ...
    /* 9 */ val AUTH_EXPIRED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.AUTH_EXPIRED with Double = js.native
    /* 2 */ val BAD_DATA_FORMAT: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.BAD_DATA_FORMAT with Double = js.native
    /* 10 */ val DATA_CONFLICT: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.DATA_CONFLICT with Double = js.native
    /* 5 */ val DATA_REQUIRED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.DATA_REQUIRED with Double = js.native
    /* 11 */ val ENML_VALIDATION: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.ENML_VALIDATION with Double = js.native
    /* 4 */ val INTERNAL_ERROR: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.INTERNAL_ERROR with Double = js.native
    /* 8 */ val INVALID_AUTH: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.INVALID_AUTH with Double = js.native
    /* 14 */ val LEN_TOO_LONG: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.LEN_TOO_LONG with Double = js.native
    /* 13 */ val LEN_TOO_SHORT: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.LEN_TOO_SHORT with Double = js.native
    /* 6 */ val LIMIT_REACHED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.LIMIT_REACHED with Double = js.native
    /* 3 */ val PERMISSION_DENIED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.PERMISSION_DENIED with Double = js.native
    /* 7 */ val QUOTA_REACHED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.QUOTA_REACHED with Double = js.native
    /* 19 */ val RATE_LIMIT_REACHED: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.RATE_LIMIT_REACHED with Double = js.native
    /* 12 */ val SHARD_UNAVAILABLE: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.SHARD_UNAVAILABLE with Double = js.native
    /* 18 */ val TAKEN_DOWN: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.TAKEN_DOWN with Double = js.native
    /* 15 */ val TOO_FEW: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.TOO_FEW with Double = js.native
    /* 16 */ val TOO_MANY: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.TOO_MANY with Double = js.native
    /* 1 */ val UNKNOWN: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.UNKNOWN with Double = js.native
    /* 17 */ val UNSUPPORTED_OPERATION: typings.evernote.evernoteMod.EvernoteNs.EDAMErrorCode.UNSUPPORTED_OPERATION with Double = js.native
    @JSBracketAccess
  ...
  object NoteSortOrder extends js.Object {
    ...
    /* 1 */ val CREATED: typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder.CREATED with Double = js.native
    /* 3 */ val RELEVANCE: typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder.RELEVANCE with Double = js.native
    /* 5 */ val TITLE: typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder.TITLE with Double = js.native
    /* 2 */ val UPDATED: typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder.UPDATED with Double = js.native
    /* 4 */ val UPDATE_SEQUENCE_NUMBER: typings.evernote.evernoteMod.EvernoteNs.NoteSortOrder.UPDATE_SEQUENCE_NUMBER with Double = js.native
    @JSBracketAccess
  ...
  object PremiumOrderStatus extends js.Object {
    ...
    /* 2 */ val ACTIVE: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.ACTIVE with Double = js.native
    /* 5 */ val CANCELED: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.CANCELED with Double = js.native
    /* 4 */ val CANCELLATION_PENDING: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.CANCELLATION_PENDING with Double = js.native
    /* 3 */ val FAILED: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.FAILED with Double = js.native
    /* 0 */ val NONE: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.NONE with Double = js.native
    /* 1 */ val PENDING: typings.evernote.evernoteMod.EvernoteNs.PremiumOrderStatus.PENDING with Double = js.native
    @JSBracketAccess
  ...
  object PrivilegeLevel extends js.Object {
    ...
    /* 9 */ val ADMIN: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.ADMIN with Double = js.native
    /* 7 */ val MANAGER: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.MANAGER with Double = js.native
    /* 1 */ val NORMAL: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.NORMAL with Double = js.native
    /* 3 */ val PREMIUM: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.PREMIUM with Double = js.native
    /* 8 */ val SUPPORT: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.SUPPORT with Double = js.native
    /* 5 */ val VIP: typings.evernote.evernoteMod.EvernoteNs.PrivilegeLevel.VIP with Double = js.native
    @JSBracketAccess
  ...
  object QueryFormat extends js.Object {
    ...
    /* 2 */ val SEXP: typings.evernote.evernoteMod.EvernoteNs.QueryFormat.SEXP with Double = js.native
    /* 1 */ val USER: typings.evernote.evernoteMod.EvernoteNs.QueryFormat.USER with Double = js.native
    @JSBracketAccess
  ...
  object ReminderEmailConfig extends js.Object {
    ...
    /* 1 */ val DO_NOT_SEND: typings.evernote.evernoteMod.EvernoteNs.ReminderEmailConfig.DO_NOT_SEND with Double = js.native
    /* 2 */ val SEND_DAILY_EMAIL: typings.evernote.evernoteMod.EvernoteNs.ReminderEmailConfig.SEND_DAILY_EMAIL with Double = js.native
    @JSBracketAccess
  ...
  object SharedNotebookInstanceRestrictions extends js.Object {
    ...
    /* 2 */ val NO_SHARED_NOTEBOOKS: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookInstanceRestrictions.NO_SHARED_NOTEBOOKS with Double = js.native
    /* 1 */ val ONLY_JOINED_OR_PREVIEW: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookInstanceRestrictions.ONLY_JOINED_OR_PREVIEW with Double = js.native
    @JSBracketAccess
  ...
  object SharedNotebookPrivilegeLevel extends js.Object {
    ...
    /* 5 */ val BUSINESS_FULL_ACCESS: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.BUSINESS_FULL_ACCESS with Double = js.native
    /* 4 */ val FULL_ACCESS: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.FULL_ACCESS with Double = js.native
    /* 3 */ val GROUP: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.GROUP with Double = js.native
    /* 1 */ val MODIFY_NOTEBOOK_PLUS_ACTIVITY: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.MODIFY_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
    /* 0 */ val READ_NOTEBOOK: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.READ_NOTEBOOK with Double = js.native
    /* 2 */ val READ_NOTEBOOK_PLUS_ACTIVITY: typings.evernote.evernoteMod.EvernoteNs.SharedNotebookPrivilegeLevel.READ_NOTEBOOK_PLUS_ACTIVITY with Double = js.native
    @JSBracketAccess
  ...
  object SponsoredGroupRole extends js.Object {
    ...
    /* 2 */ val GROUP_ADMIN: typings.evernote.evernoteMod.EvernoteNs.SponsoredGroupRole.GROUP_ADMIN with Double = js.native
    /* 1 */ val GROUP_MEMBER: typings.evernote.evernoteMod.EvernoteNs.SponsoredGroupRole.GROUP_MEMBER with Double = js.native
    /* 3 */ val GROUP_OWNER: typings.evernote.evernoteMod.EvernoteNs.SponsoredGroupRole.GROUP_OWNER with Double = js.native
    @JSBracketAccess
