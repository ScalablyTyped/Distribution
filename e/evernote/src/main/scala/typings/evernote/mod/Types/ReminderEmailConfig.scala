...
object ReminderEmailConfig extends StObject {
  ...
  /* 1 */ val DO_NOT_SEND: typings.evernote.mod.Types.ReminderEmailConfig.DO_NOT_SEND with Double = js.native
  
  @js.native
  sealed trait SEND_DAILY_EMAIL extends ReminderEmailConfig
  /* 2 */ val SEND_DAILY_EMAIL: typings.evernote.mod.Types.ReminderEmailConfig.SEND_DAILY_EMAIL with Double = js.native
}
