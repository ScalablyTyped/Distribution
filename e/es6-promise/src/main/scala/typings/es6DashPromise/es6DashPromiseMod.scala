package typings.es6DashPromise

import typings.es6DashPromise.es6DashPromiseMod.Promise
import typings.es6DashPromise.es6DashPromiseMod.Thenable
...
@js.native
object es6DashPromiseMod extends js.Object {
  @js.native
