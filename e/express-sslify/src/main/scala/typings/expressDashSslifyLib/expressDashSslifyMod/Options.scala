package typings
package expressDashSslifyLib.expressDashSslifyMod
...
trait Options extends js.Object {
  /**
    ...
    * @default false
    */
  var trustAzureHeader: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    * @default false
    */
  var trustProtoHeader: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    * @default false
    */
  var trustXForwardedHostHeader: js.UndefOr[scala.Boolean] = js.undefined
}

object Options {
  @scala.inline
  def apply(
    trustAzureHeader: js.UndefOr[scala.Boolean] = js.undefined,
    trustProtoHeader: js.UndefOr[scala.Boolean] = js.undefined,
    trustXForwardedHostHeader: js.UndefOr[scala.Boolean] = js.undefined
  ): Options = {
