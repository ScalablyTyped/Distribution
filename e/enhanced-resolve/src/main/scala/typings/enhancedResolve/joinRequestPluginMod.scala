...
object joinRequestPluginMod {
  ...
  object JoinRequestPlugin {
    ...
    inline def apply(apply: typings.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): JoinRequestPlugin = {
    ...
    extension [Self <: JoinRequestPlugin](x: Self) {
