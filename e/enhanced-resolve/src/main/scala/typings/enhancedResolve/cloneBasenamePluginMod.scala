...
object cloneBasenamePluginMod {
  ...
  object CloneBasenamePlugin {
    ...
    inline def apply(apply: typings.enhancedResolve.resolverMod.^ => Unit, source: String, target: String): CloneBasenamePlugin = {
    ...
    extension [Self <: CloneBasenamePlugin](x: Self) {
