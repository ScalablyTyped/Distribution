...
object esmFileUtilsMod {
  ...
  object AppFileType extends StObject {
    ...
    sealed trait APP_CODE
      extends StObject
         with AppFileType
    /* 4 */ val APP_CODE: typings.electronUniversal.esmFileUtilsMod.AppFileType.APP_CODE & Double = js.native
    
    @js.native
    sealed trait INFO_PLIST
      extends StObject
         with AppFileType
    /* 2 */ val INFO_PLIST: typings.electronUniversal.esmFileUtilsMod.AppFileType.INFO_PLIST & Double = js.native
    
    @js.native
    sealed trait MACHO
      extends StObject
         with AppFileType
    /* 0 */ val MACHO: typings.electronUniversal.esmFileUtilsMod.AppFileType.MACHO & Double = js.native
    
    @js.native
    sealed trait PLAIN
      extends StObject
         with AppFileType
    /* 1 */ val PLAIN: typings.electronUniversal.esmFileUtilsMod.AppFileType.PLAIN & Double = js.native
    
    @js.native
    sealed trait SNAPSHOT
      extends StObject
         with AppFileType
    /* 3 */ val SNAPSHOT: typings.electronUniversal.esmFileUtilsMod.AppFileType.SNAPSHOT & Double = js.native
  }
