...
object distEsmAsarUtilsMod {
  ...
  object AsarMode extends StObject {
    ...
    sealed trait HAS_ASAR
      extends StObject
         with AsarMode
    /* 1 */ val HAS_ASAR: typings.electronUniversal.distEsmAsarUtilsMod.AsarMode.HAS_ASAR & Double = js.native
    
    @js.native
    sealed trait NO_ASAR
      extends StObject
         with AsarMode
    /* 0 */ val NO_ASAR: typings.electronUniversal.distEsmAsarUtilsMod.AsarMode.NO_ASAR & Double = js.native
  }
