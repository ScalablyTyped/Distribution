...
object esmAsarUtilsMod {
  
  @JSImport("@electron/universal/dist/esm/asar-utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @js.native
  sealed trait AsarMode extends StObject
  @JSImport("@electron/universal/dist/esm/asar-utils", "AsarMode")
  @js.native
  object AsarMode extends StObject {
    ...
    sealed trait HAS_ASAR
      extends StObject
         with AsarMode
    /* 1 */ val HAS_ASAR: typings.electronUniversal.esmAsarUtilsMod.AsarMode.HAS_ASAR & Double = js.native
    
    @js.native
    sealed trait NO_ASAR
      extends StObject
         with AsarMode
    /* 0 */ val NO_ASAR: typings.electronUniversal.esmAsarUtilsMod.AsarMode.NO_ASAR & Double = js.native
  }
