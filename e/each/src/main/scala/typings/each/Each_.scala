...
trait Each_ extends js.Object {
  ...
  @JSName("on")
  def on_both(eventName: both, onBoth: js.Function1[/* error */ js.UndefOr[js.Array[Error]], Unit]): Each_ = js.native
  @JSName("on")
  def on_end(eventName: end, onEnd: js.Function0[Unit]): Each_ = js.native
  @JSName("on")
  def on_error(eventName: error, onError: js.Function1[(/* error */ js.Array[Error]) | (/* error */ Error), Unit]): Each_ = js.native
  @JSName("on")
  def on_item(
    eventName: item,
    onItem: js.Function2[
