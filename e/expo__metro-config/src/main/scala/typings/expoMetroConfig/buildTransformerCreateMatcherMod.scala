...
object buildTransformerCreateMatcherMod {
  ...
  inline def createExpoMatcher(param0: `0`): js.RegExp = ^.asInstanceOf[js.Dynamic].applyDynamic("createExpoMatcher")(param0.asInstanceOf[js.Any]).asInstanceOf[js.RegExp]
  ...
  inline def createReactNativeMatcher(param0: `0`): js.RegExp = ^.asInstanceOf[js.Dynamic].applyDynamic("createReactNativeMatcher")(param0.asInstanceOf[js.Any]).asInstanceOf[js.RegExp]
}
