...
object UnhandledOptions {
  ...
  implicit class UnhandledOptionsOps[Self <: UnhandledOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLogger(value: /* error */ Error => Unit): Self = this.set("logger", js.Any.fromFunction1(value))
    @scala.inline
    def deleteLogger: Self = this.set("logger", js.undefined)
    @scala.inline
    def setReportButton(value: /* error */ Error => Unit): Self = this.set("reportButton", js.Any.fromFunction1(value))
    @scala.inline
