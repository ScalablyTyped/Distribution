...
trait UnhandledOptions extends js.Object {
  /**
  		...
  		*/
  val logger: js.UndefOr[js.Function1[/* error */ stdLib.Error, scala.Unit]] = js.undefined
  /**
  		...
  		```
  		*/
  val reportButton: js.UndefOr[js.Function1[/* error */ stdLib.Error, scala.Unit]] = js.undefined
  /**
  		Present an error dialog to the user.
  		Default: [Only in production](https://github.com/sindresorhus/electron-is-dev).
  		*/
  val showDialog: js.UndefOr[scala.Boolean] = js.undefined
}

object UnhandledOptions {
  @scala.inline
  def apply(
    logger: /* error */ stdLib.Error => scala.Unit = null,
    reportButton: /* error */ stdLib.Error => scala.Unit = null,
