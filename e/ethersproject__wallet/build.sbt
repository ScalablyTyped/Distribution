...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ethersproject__hdnode" % "5.7.0-610a92",
  "org.scalablytyped" %%% "ethersproject__json-wallets" % "5.7.0-e6790e",
  ...
  "org.scalablytyped" %%% "ethersproject__signing-key" % "5.7.0-05f5dd",
