...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ethersproject__hdnode" % "5.7.0-97c543",
  "org.scalablytyped" %%% "ethersproject__json-wallets" % "5.7.0-4fc6f1",
  "org.scalablytyped" %%% "ethersproject__logger" % "5.7.0-1e9880",
  "org.scalablytyped" %%% "ethersproject__networks" % "5.7.1-8dafae",
  "org.scalablytyped" %%% "ethersproject__properties" % "5.7.0-7ecc05",
  "org.scalablytyped" %%% "ethersproject__signing-key" % "5.7.0-4aac64",
  "org.scalablytyped" %%% "ethersproject__transactions" % "5.7.0-2b2d61",
  "org.scalablytyped" %%% "ethersproject__web" % "5.7.1-034ded",
  "org.scalablytyped" %%% "ethersproject__wordlists" % "5.7.0-b4e225",
