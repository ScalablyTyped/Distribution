...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ethersproject__hdnode" % "5.7.0-4baa70",
  "org.scalablytyped" %%% "ethersproject__json-wallets" % "5.7.0-e50207",
  "org.scalablytyped" %%% "ethersproject__logger" % "5.7.0-03b90c",
  "org.scalablytyped" %%% "ethersproject__networks" % "5.7.1-02c7be",
  "org.scalablytyped" %%% "ethersproject__properties" % "5.7.0-7d4eac",
  "org.scalablytyped" %%% "ethersproject__signing-key" % "5.7.0-36fbee",
  "org.scalablytyped" %%% "ethersproject__transactions" % "5.7.0-b76f9e",
  "org.scalablytyped" %%% "ethersproject__web" % "5.7.1-7e1817",
  "org.scalablytyped" %%% "ethersproject__wordlists" % "5.7.0-095e00",
