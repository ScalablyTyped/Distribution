...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.esFeatureDetection.esFeatureDetectionStrings.Atomics
  - typings.esFeatureDetection.esFeatureDetectionStrings.ObjectDotvalues
  - typings.esFeatureDetection.esFeatureDetectionStrings.ObjectDotentries
  - typings.esFeatureDetection.esFeatureDetectionStrings.ObjectDotgetOwnPropertyDescriptors
  - typings.esFeatureDetection.esFeatureDetectionStrings.StringDotprototypeDotpadEnd
  - typings.esFeatureDetection.esFeatureDetectionStrings.StringDotprototypeDotpadStart
  - typings.esFeatureDetection.esFeatureDetectionStrings.SharedArrayBuffer
*/
