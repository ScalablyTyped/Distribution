...
object esDashFeatureDashDetectionLibStrings {
  @js.native
  ...
  sealed trait ArrayDOTprototypeDOTincludes
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2016Builtins
  ...
  sealed trait `Arrow function`
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2015Syntax
  
  @js.native
  sealed trait Atomics
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2017Builtins
  ...
  sealed trait `Exponentiation operator`
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2016Syntax
  ...
  sealed trait `Trailing parameter commas`
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2017Syntax
  ...
  sealed trait __all
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2015Builtins
       with esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2015Syntax
       with esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2016Builtins
       with esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2016Syntax
       with esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2017Builtins
       with esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2017Syntax
  
  @js.native
  sealed trait `async/await`
    extends esDashFeatureDashDetectionLib.esDashFeatureDashDetectionMod.ES2017Syntax
