...
object ES2015Syntax {
  @scala.inline
  def `Arrow function`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Arrow function` = this.cast("Arrow function")
  @scala.inline
  def `Binary literals`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Binary literals` = this.cast("Binary literals")
  @scala.inline
  def `Block level function declaration`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Block level function declaration` = this.cast("Block level function declaration")
  @scala.inline
  def `Computed property`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Computed property` = this.cast("Computed property")
  @scala.inline
  def `Default parameters`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Default parameters` = this.cast("Default parameters")
  @scala.inline
  def Destructuring: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.Destructuring = this.cast("Destructuring")
  @scala.inline
  def `Generator function`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Generator function` = this.cast("Generator function")
  @scala.inline
  ...
  @scala.inline
  def `Shorthand method`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Shorthand method` = this.cast("Shorthand method")
  @scala.inline
  def `Shorthand property`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Shorthand property` = this.cast("Shorthand property")
  @scala.inline
  def `Spread Array`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Spread Array` = this.cast("Spread Array")
  @scala.inline
  def `Spread Function call`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Spread Function call` = this.cast("Spread Function call")
  @scala.inline
  def `Template Strings`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`Template Strings` = this.cast("Template Strings")
  @scala.inline
  def __all: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.__all = this.cast("__all")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def `class`: typings.esDashFeatureDashDetection.esDashFeatureDashDetectionStrings.`class` = this.cast("class")
  @scala.inline
