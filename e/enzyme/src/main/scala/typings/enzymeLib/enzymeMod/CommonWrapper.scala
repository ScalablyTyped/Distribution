...
trait CommonWrapper[P, S, C] extends js.Object {
  ...
  /**
       ...
       * NOTE: can only be called on a wrapper of a single node.
       */
  def prop[K /* <: java.lang.String */](key: K): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(P))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
  ...
  def state[K /* <: java.lang.String */](key: K): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(S))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
