...
object ReturnTypePaginationFragment {
  ...
  @scala.inline
  implicit class ReturnTypePaginationFragmentOps[Self <: ReturnTypePaginationFragment[_, _, _], TQuery /* <: OperationType */, TKey, TFragmentData] (val x: Self with (ReturnTypePaginationFragment[TQuery, TKey, TFragmentData])) extends AnyVal {
