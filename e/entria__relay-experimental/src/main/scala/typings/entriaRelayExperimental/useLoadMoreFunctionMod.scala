...
object useLoadMoreFunctionMod {
  ...
  inline def useLoadMoreFunction(args: UseLoadMoreFunctionArgs): js.Tuple3[LoadMoreFn, Boolean, js.Function0[Unit]] = ^.asInstanceOf[js.Dynamic].applyDynamic("useLoadMoreFunction")(args.asInstanceOf[js.Any]).asInstanceOf[js.Tuple3[LoadMoreFn, Boolean, js.Function0[Unit]]]
  ...
  */
  ...
  object Direction {
    ...
    inline def backward: typings.entriaRelayExperimental.entriaRelayExperimentalStrings.backward = "backward".asInstanceOf[typings.entriaRelayExperimental.entriaRelayExperimentalStrings.backward]
    
    inline def forward: typings.entriaRelayExperimental.entriaRelayExperimentalStrings.forward = "forward".asInstanceOf[typings.entriaRelayExperimental.entriaRelayExperimentalStrings.forward]
  }
  ...
  object UseLoadMoreFunctionArgs {
    ...
    extension [Self <: UseLoadMoreFunctionArgs](x: Self) {
      ...
      inline def setFragmentOwner(value: RequestDescriptor | (js.Array[RequestDescriptor | Null])): Self = StObject.set(x, "fragmentOwner", value.asInstanceOf[js.Any])
      
      inline def setFragmentOwnerNull: Self = StObject.set(x, "fragmentOwner", null)
      
      inline def setFragmentOwnerVarargs(value: (RequestDescriptor | Null)*): Self = StObject.set(x, "fragmentOwner", js.Array(value :_*))
      ...
      inline def setFragmentRefPathInResponseVarargs(value: (String | Double)*): Self = StObject.set(x, "fragmentRefPathInResponse", js.Array(value :_*))
