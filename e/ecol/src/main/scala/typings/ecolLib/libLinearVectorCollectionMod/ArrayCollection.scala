...
- ecolLib.libBasicICollectionMod.ICollection because var conflicts: iterator, iterator_IContainer. Inlined refresh, refresh, refresh */ @JSImport("ecol/lib/linear/VectorCollection", "ArrayCollection")
@js.native
