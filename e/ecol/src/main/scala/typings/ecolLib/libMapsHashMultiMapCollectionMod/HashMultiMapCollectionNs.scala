...
@JSImport("ecol/lib/maps/HashMultiMapCollection", "HashMultiMapCollection")
@js.native
object HashMultiMapCollectionNs extends js.Object {
  ...
  type Event[Key, T] = ecolLib.libBasicCollectionEventMod.CollectionEvent[
    ...
    tstlLib.containerHashMultiMapMod.HashMultiMap[Key, T], 
  ...
  type Iterator[Key, T] = tstlLib.baseContainerMapElementListMod.MapElementListNs.Iterator[
    Key, 
    T, 
  ...
  type ReverseIterator[Key, T] = tstlLib.baseContainerMapElementListMod.MapElementListNs.ReverseIterator[
    Key, 
    T, 
    ecolLib.ecolLibNumbers.`false`, 
    tstlLib.containerHashMultiMapMod.HashMultiMap[Key, T]
