...
object libMapsTreeMapCollectionMod extends js.Object {
  ...
  class TreeMapCollection[Key, T] ()
    ...
    override def begin(): typings.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], TreeMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
    ...
    /* CompleteClass */
    /* InferMemberOverrides */
    override def end(): typings.tstl.baseIteratorIteratorMod.Iterator[Entry[Key, T], TreeMap[Key, T], Iterator[Key, T], ReverseIterator[Key, T], IPair[Key, T]] = js.native
    /* CompleteClass */
  ...
  object TreeMapCollection extends js.Object {
    ...
    type Iterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementList.Iterator[Key, T, `true`, TreeMap[Key, T]]
    ...
    type ReverseIterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementList.ReverseIterator[Key, T, `true`, TreeMap[Key, T]]
  }
