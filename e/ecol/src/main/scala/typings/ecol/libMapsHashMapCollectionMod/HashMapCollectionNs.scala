...
object HashMapCollectionNs extends js.Object {
  ...
  type Event[Key, T] = CollectionEvent[
    Entry[Key, T], 
    HashMap[Key, T], 
    typings.tstl.containerHashMapMod.HashMapNs.Iterator[Key, T], 
    typings.tstl.containerHashMapMod.HashMapNs.ReverseIterator[Key, T]
  ]
  type Iterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementListNs.Iterator[Key, T, `true`, HashMap[Key, T]]
  ...
  type ReverseIterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementListNs.ReverseIterator[Key, T, `true`, HashMap[Key, T]]
}
