...
import typings.tstl.treeSetMod.TreeSet
...
- typings.ecol.icollectionMod.ICollection because var conflicts: iterator, iterator_IContainer_. Inlined refresh, refresh, refresh */ @JSImport("ecol/lib/sets/TreeSetCollection", "TreeSetCollection")
@js.native
class TreeSetCollection_[T] ()
  extends TreeSet[T]
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def begin(): typings.tstl.icontainerMod.IContainer.Iterator[T, TreeSet[T], Iterator[T], ReverseIterator[T], T] = js.native
  /**
    * @inheritDoc
    */
  /* InferMemberOverrides */
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def end(): typings.tstl.icontainerMod.IContainer.Iterator[T, TreeSet[T], Iterator[T], ReverseIterator[T], T] = js.native
  /**
  ...
  /* InferMemberOverrides */
  override def insert(key: T): InsertRet[T, `true`, TreeSet[T], Iterator[T], ReverseIterator[T]] = js.native
  /* InferMemberOverrides */
  @JSName("insert")
