package typings.ecol.hashMultiMapCollectionMod.HashMultiMapCollection
...
@JSImport("ecol/lib/maps/HashMultiMapCollection", "HashMultiMapCollection.Iterator")
@js.native
...
typings.tstl.mapElementListMod.MapElementList.ReverseIterator[
  ...
  extends typings.tstl.mapElementListMod.MapElementList.Iterator[Key, T, Unique, Source]
