...
- typings.ecol.icollectionMod.ICollection because var conflicts: iterator, iterator_IContainer_. Inlined refresh, refresh, refresh */ @JSImport("ecol/lib/maps/TreeMapCollection", "TreeMapCollection")
@js.native
class TreeMapCollection_[Key, T] ()
