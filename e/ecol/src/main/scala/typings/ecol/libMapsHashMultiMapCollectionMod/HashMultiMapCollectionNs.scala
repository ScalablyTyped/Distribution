...
object HashMultiMapCollectionNs extends js.Object {
  ...
  type Event[Key, T] = CollectionEvent[
    Entry[Key, T], 
    HashMultiMap[Key, T], 
    typings.tstl.containerHashMultiMapMod.HashMultiMapNs.Iterator[Key, T], 
    typings.tstl.containerHashMultiMapMod.HashMultiMapNs.ReverseIterator[Key, T]
  ]
  type Iterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementListNs.Iterator[Key, T, `false`, HashMultiMap[Key, T]]
  ...
  type ReverseIterator[Key, T] = typings.tstl.baseContainerMapElementListMod.MapElementListNs.ReverseIterator[Key, T, `false`, HashMultiMap[Key, T]]
}
