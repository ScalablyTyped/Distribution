package typings.ecol.hashMultiSetCollectionMod.HashMultiSetCollection
...
@JSImport("ecol/lib/sets/HashMultiSetCollection", "HashMultiSetCollection.ReverseIterator")
@js.native
