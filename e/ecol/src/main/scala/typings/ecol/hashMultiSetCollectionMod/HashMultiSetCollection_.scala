...
- typings.ecol.icollectionMod.ICollection because var conflicts: iterator, iterator_IContainer_. Inlined refresh, refresh, refresh */ @JSImport("ecol/lib/sets/HashMultiSetCollection", "HashMultiSetCollection")
@js.native
class HashMultiSetCollection_[T] ()
  ...
  /* protected */ override def _Handle_erase(
    first: Iterator[T] | (typings.tstl.ihashsetMod.IHashSet.Iterator[T, `false`, HashMultiSet[T]]),
    last: Iterator[T] | (typings.tstl.ihashsetMod.IHashSet.Iterator[T, `false`, HashMultiSet[T]])
  ): Unit = js.native
  /* InferMemberOverrides */
  ...
  /* protected */ override def _Insert_by_hint_Iterator(hint: Iterator[T], key: T): Iterator[T] = js.native
  /* InferMemberOverrides */
  ...
  /* protected */ override def _Insert_by_key_InsertRet(key: T): InsertRet[
    ...
    `false`, 
    HashMultiSet[T], 
    typings.tstl.ihashsetMod.IHashSet.Iterator[T, `false`, HashMultiSet[T]], 
    typings.tstl.ihashsetMod.IHashSet.ReverseIterator[T, `false`, HashMultiSet[T]]
  ] = js.native
  /* InferMemberOverrides */
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def begin(index: Double): typings.tstl.ihashsetMod.IHashSet.Iterator[T, `false`, HashMultiSet[T]] = js.native
  /**
    * @inheritDoc
    */
  /* InferMemberOverrides */
  @JSName("begin")
  override def begin_Iterator(): Iterator[T] = js.native
  /**
    * @inheritDoc
    */
  /* InferMemberOverrides */
  @JSName("begin")
  override def begin_Iterator(index: Double): Iterator[T] = js.native
  /**
    * @inheritDoc
    */
  /**
  ...
  /**
    ...
    */
  /* InferMemberOverrides */
  override def end(index: Double): typings.tstl.ihashsetMod.IHashSet.Iterator[T, `false`, HashMultiSet[T]] = js.native
  /**
    * @inheritDoc
    */
  /* InferMemberOverrides */
  @JSName("end")
  override def end_Iterator(): Iterator[T] = js.native
  /**
    * @inheritDoc
    */
  /* InferMemberOverrides */
  @JSName("end")
  override def end_Iterator(index: Double): Iterator[T] = js.native
  /**
  ...
  /* InferMemberOverrides */
  @JSName("find")
  override def find_Iterator(key: T): Iterator[T] = js.native
  /**
    * @inheritDoc
    */
  /**
