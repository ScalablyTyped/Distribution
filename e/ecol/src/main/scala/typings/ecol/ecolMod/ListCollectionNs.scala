...
object ListCollectionNs extends js.Object {
  ...
  class Iterator[T] protected ()
    extends typings.ecol.libLinearListCollectionMod.ListCollectionNs.Iterator[T]
  ...
  class ReverseIterator[T] ()
    extends typings.ecol.libLinearListCollectionMod.ListCollectionNs.ReverseIterator[T]
