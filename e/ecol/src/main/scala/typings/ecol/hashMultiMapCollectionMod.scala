...
object hashMultiMapCollectionMod extends js.Object {
  ...
  object HashMultiMapCollection extends js.Object {
    ...
    /**
      ...
      */
    type Iterator[Key, T] = typings.tstl.mapElementListMod.MapElementList.Iterator[Key, T, typings.ecol.ecolBooleans.`false`, HashMultiMap[Key, T]]
    ...
    /**
      ...
      */
    type ReverseIterator[Key, T] = typings.tstl.mapElementListMod.MapElementList.ReverseIterator[Key, T, typings.ecol.ecolBooleans.`false`, HashMultiMap[Key, T]]
  }
