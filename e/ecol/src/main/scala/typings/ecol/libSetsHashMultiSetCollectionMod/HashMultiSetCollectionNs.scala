...
object HashMultiSetCollectionNs extends js.Object {
  ...
  type Event[T] = CollectionEvent[
    T, 
    HashMultiSet[T], 
    typings.tstl.containerHashMultiSetMod.HashMultiSetNs.Iterator[T], 
    typings.tstl.containerHashMultiSetMod.HashMultiSetNs.ReverseIterator[T]
  ]
  type Iterator[Key] = typings.tstl.baseContainerSetElementListMod.SetElementListNs.Iterator[Key, `false`, HashMultiSet[Key]]
  ...
  type ReverseIterator[Key] = typings.tstl.baseContainerSetElementListMod.SetElementListNs.ReverseIterator[Key, `false`, HashMultiSet[Key]]
}
