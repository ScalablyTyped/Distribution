...
- typings.ecol.libBasicICollectionMod.ICollection because Inheritance from two classes. Inlined refresh, refresh, refresh */ @JSImport("ecol/lib/sets/HashMultiSetCollection", "HashMultiSetCollection")
@js.native
