...
/* Inlined {  platform  :string,   arch  :string,   artifactSuffix ? :string,   isGeneric ? :false} & @electron/get.@electron/get/dist/esm/types.ElectronDownloadRequest & @electron/get.@electron/get/dist/esm/types.ElectronDownloadRequestOptions */
