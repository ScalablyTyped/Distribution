...
object esmTypesMod {
  ...
  */
  ...
  object ElectronArtifactDetails {
    ...
    inline def ElectronGenericArtifactDetails(artifactName: String, version: String): typings.electronGet.esmTypesMod.ElectronGenericArtifactDetails = {
    ...
    inline def ElectronPlatformArtifactDetails(arch: String, artifactName: String, platform: String, version: String): typings.electronGet.esmTypesMod.ElectronPlatformArtifactDetails = {
  ...
  */
  ...
  object ElectronPlatformArtifactDetailsWithDefaults {
    ...
    inline def OmitElectronPlatformArtifArch(artifactName: String, version: String): typings.electronGet.anon.OmitElectronPlatformArtifArch = {
      val __obj = js.Dynamic.literal(artifactName = artifactName.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
