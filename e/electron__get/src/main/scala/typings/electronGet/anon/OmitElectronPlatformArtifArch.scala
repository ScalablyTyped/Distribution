...
import typings.electronGet.esmTypesMod.DownloadOptions
import typings.electronGet.esmTypesMod.ElectronPlatformArtifactDetailsWithDefaults
import typings.electronGet.esmTypesMod.MirrorOptions
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* Inlined @electron/get.@electron/get/dist/esm/types.Omit<@electron/get.@electron/get/dist/esm/types.ElectronPlatformArtifactDetails, 'platform' | 'arch'> & {  platform ? :string,   arch ? :string} */
trait OmitElectronPlatformArtifArch extends ElectronPlatformArtifactDetailsWithDefaults {
