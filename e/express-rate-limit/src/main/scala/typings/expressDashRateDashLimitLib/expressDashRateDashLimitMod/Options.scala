...
object Options {
  @scala.inline
  def apply(
    handler: (/* req */ expressLib.expressMod.Request, /* res */ expressLib.expressMod.Response, /* next */ expressLib.expressMod.NextFunction) => _ = null,
    ...
    onLimitReached: (/* req */ expressLib.expressMod.Request, /* res */ expressLib.expressMod.Response, Options) => scala.Unit = null,
