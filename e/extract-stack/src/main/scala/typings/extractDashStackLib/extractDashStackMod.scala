...
@js.native
object extractDashStackMod extends js.Object {
  def apply(): java.lang.String = js.native
  def apply(error: java.lang.String): java.lang.String = js.native
  /**
  	...
  	```
  	 */
  def apply(error: stdLib.Error): java.lang.String = js.native
  def lines(): js.Array[java.lang.String] = js.native
  def lines(error: java.lang.String): js.Array[java.lang.String] = js.native
  /**
  	...
  	```
  	 */
  def lines(error: stdLib.Error): js.Array[java.lang.String] = js.native
}
