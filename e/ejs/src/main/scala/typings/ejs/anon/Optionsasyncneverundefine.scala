...
@js.native
trait Optionsasyncneverundefine extends js.Object {
...
object Optionsasyncneverundefine {
  ...
  @scala.inline
  implicit class OptionsasyncneverundefineOps[Self <: Optionsasyncneverundefine] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAsync(value: js.UndefOr[Boolean] with js.UndefOr[scala.Nothing]): Self = this.set("async", value.asInstanceOf[js.Any])
