...
object renderFile extends js.Object {
  def apply[T](path: String): js.Promise[T] = js.native
  def apply[T](path: String, cb: RenderFileCallback[T]): T = js.native
  def apply[T](path: String, data: Data): js.Promise[T] = js.native
  def apply[T](path: String, data: Data, cb: RenderFileCallback[T]): T = js.native
  def apply[T](path: String, data: Data, opts: Options): js.Promise[T] = js.native
