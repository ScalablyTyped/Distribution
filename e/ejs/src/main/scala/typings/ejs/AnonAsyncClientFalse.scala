...
trait AnonAsyncClientFalse extends js.Object {
  var async: js.UndefOr[`false`] = js.undefined
  var client: js.UndefOr[`false`] = js.undefined
}

object AnonAsyncClientFalse {
  @scala.inline
  def apply(async: `false` = null, client: `false` = null): AnonAsyncClientFalse = {
    val __obj = js.Dynamic.literal()
    if (async != null) __obj.updateDynamic("async")(async.asInstanceOf[js.Any])
    if (client != null) __obj.updateDynamic("client")(client.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonAsyncClientFalse]
  }
}
