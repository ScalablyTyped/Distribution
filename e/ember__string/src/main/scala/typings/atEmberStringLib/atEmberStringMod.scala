...
object atEmberStringMod extends js.Object {
  ...
  def htmlSafe(str: java.lang.String): handlebarsLib.handlebarsMod.SafeString = js.native
  def isHTMLSafe(str: js.Any): /* is handlebars.handlebars.SafeString */ scala.Boolean = js.native
