...
import typings.escpos.Anon
import typings.escpos.Anon0
import typings.escpos.Anon12
...
object command extends js.Object {
  ...
  object BARCODE_FORMAT extends js.Object {
    ...
    // Barcode Width  [2-6]
    var BARCODE_WIDTH: Anon12 = js.native
