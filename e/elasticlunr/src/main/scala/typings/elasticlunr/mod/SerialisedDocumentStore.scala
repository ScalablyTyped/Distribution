...
trait SerialisedDocumentStore[T] extends StObject {
  ...
  var docInfo: StringDictionary[typings.elasticlunr.elasticlunrStrings.SerialisedDocumentStore & TopLevel[Any]]
...
object SerialisedDocumentStore {
  ...
  inline def apply[T](
    docInfo: StringDictionary[typings.elasticlunr.elasticlunrStrings.SerialisedDocumentStore & TopLevel[Any]],
  ...
  extension [Self <: SerialisedDocumentStore[?], T](x: Self & SerialisedDocumentStore[T]) {
    ...
    inline def setDocInfo(
      value: StringDictionary[typings.elasticlunr.elasticlunrStrings.SerialisedDocumentStore & TopLevel[Any]]
