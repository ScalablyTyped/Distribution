package typings.emberRouting.transitionMod
...
object Transition {
  ...
  def apply(abort: () => Transition, retry: () => Transition, to: RouteInfo, from: RouteInfo = null): Transition = {
    val __obj = js.Dynamic.literal(abort = js.Any.fromFunction0(abort), retry = js.Any.fromFunction0(retry), to = to.asInstanceOf[js.Any], from = from.asInstanceOf[js.Any])
