...
trait JSXNamespacedName extends BaseNode {
  @JSName("type")
  var type_JSXNamespacedName: typings.estreeDashJsx.estreeDashJsxStrings.JSXNamespacedName
}

object JSXNamespacedName {
  @scala.inline
  def apply(
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXNamespacedName,
