...
trait JSXClosingFragment extends BaseNode {
  @JSName("type")
  var type_JSXClosingFragment: typings.estreeDashJsx.estreeDashJsxStrings.JSXClosingFragment
}

object JSXClosingFragment {
  @scala.inline
  def apply(
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXClosingFragment,
