...
trait JSXExpressionContainer extends BaseNode {
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typings.estreeDashJsx.estreeDashJsxStrings.JSXExpressionContainer
}
...
object JSXExpressionContainer {
  ...
  def apply(
    ...
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXExpressionContainer,
