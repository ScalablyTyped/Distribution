...
trait JSXSpreadAttribute extends BaseNode {
  ...
  @JSName("type")
  var type_JSXSpreadAttribute: typings.estreeDashJsx.estreeDashJsxStrings.JSXSpreadAttribute
}
...
object JSXSpreadAttribute {
  ...
  def apply(
    argument: Expression,
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXSpreadAttribute,
