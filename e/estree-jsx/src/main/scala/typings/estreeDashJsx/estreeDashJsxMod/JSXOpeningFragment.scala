...
trait JSXOpeningFragment extends BaseNode {
  @JSName("type")
  var type_JSXOpeningFragment: typings.estreeDashJsx.estreeDashJsxStrings.JSXOpeningFragment
}

object JSXOpeningFragment {
  @scala.inline
  def apply(
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXOpeningFragment,
