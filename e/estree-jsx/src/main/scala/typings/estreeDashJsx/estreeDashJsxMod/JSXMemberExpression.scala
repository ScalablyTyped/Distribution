...
trait JSXMemberExpression extends BaseNode {
  @JSName("type")
  var type_JSXMemberExpression: typings.estreeDashJsx.estreeDashJsxStrings.JSXMemberExpression
}

object JSXMemberExpression {
  @scala.inline
  def apply(
    `type`: typings.estreeDashJsx.estreeDashJsxStrings.JSXMemberExpression,
