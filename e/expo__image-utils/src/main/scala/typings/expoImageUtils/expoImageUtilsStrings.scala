...
object expoImageUtilsStrings {
  ...
  sealed trait entropy
    extends StObject
       with Position
  inline def entropy: entropy = "entropy".asInstanceOf[entropy]
  ...
  @js.native
  sealed trait removeAlpha extends StObject
  inline def removeAlpha: removeAlpha = "removeAlpha".asInstanceOf[removeAlpha]
