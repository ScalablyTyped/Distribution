...
object buildSharpDottypesMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.expoImageUtils.buildSharpDottypesMod.RemoveAlphaOptions
    - typings.expoImageUtils.buildSharpDottypesMod.ResizeOptions
    - typings.expoImageUtils.buildSharpDottypesMod.FlattenOptions
  */
  trait SharpCommandOptions extends StObject
  object SharpCommandOptions {
    
    inline def FlattenOptions(background: String): typings.expoImageUtils.buildSharpDottypesMod.FlattenOptions = {
      val __obj = js.Dynamic.literal(background = background.asInstanceOf[js.Any], operation = "flatten")
      __obj.asInstanceOf[typings.expoImageUtils.buildSharpDottypesMod.FlattenOptions]
    }
    
    inline def RemoveAlphaOptions(): typings.expoImageUtils.buildSharpDottypesMod.RemoveAlphaOptions = {
      val __obj = js.Dynamic.literal(operation = "removeAlpha")
      __obj.asInstanceOf[typings.expoImageUtils.buildSharpDottypesMod.RemoveAlphaOptions]
    }
    
    inline def ResizeOptions(width: Double): typings.expoImageUtils.buildSharpDottypesMod.ResizeOptions = {
      val __obj = js.Dynamic.literal(operation = "resize", width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.expoImageUtils.buildSharpDottypesMod.ResizeOptions]
    }
  }
