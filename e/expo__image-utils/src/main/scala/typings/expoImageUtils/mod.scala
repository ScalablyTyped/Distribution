...
import typings.expoImageUtils.jimpMod.JimpGlobalOptions
import typings.expoImageUtils.sharpTypesMod.SharpCommandOptions
import typings.expoImageUtils.sharpTypesMod.SharpGlobalOptions
