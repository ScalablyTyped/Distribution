...
import typings.esbuild.esbuildStrings.eof
import typings.esbuild.esbuildStrings.external
import typings.esbuild.esbuildStrings.linked
import typings.esbuild.esbuildStrings.none
import typings.esbuild.esbuildStrings.preserve
import typings.esbuild.esbuildStrings.transform
...
import typings.esbuild.mod.WatchMode
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined esbuild.esbuild.BuildOptions & {  incremental :true,   metafile :true} */
trait BuildOptionsincrementaltrAbsWorkingDir extends StObject {
...
object BuildOptionsincrementaltrAbsWorkingDir {
  
  inline def apply(incremental: js.UndefOr[Boolean] & `true`, metafile: js.UndefOr[Boolean] & `true`): BuildOptionsincrementaltrAbsWorkingDir = {
    val __obj = js.Dynamic.literal(incremental = incremental.asInstanceOf[js.Any], metafile = metafile.asInstanceOf[js.Any])
    __obj.asInstanceOf[BuildOptionsincrementaltrAbsWorkingDir]
  }
  
  extension [Self <: BuildOptionsincrementaltrAbsWorkingDir](x: Self) {
