...
import typings.esbuild.mod.BuildInvalidate
import typings.esbuild.mod.Message
import typings.esbuild.mod.Metafile
import typings.esbuild.mod.OutputFile
import typings.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined esbuild.esbuild.BuildResult & {  outputFiles :std.Array<esbuild.esbuild.OutputFile>} */
