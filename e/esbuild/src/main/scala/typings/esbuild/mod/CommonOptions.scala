...
trait CommonOptions extends StObject {
  ...
  var jsx: js.UndefOr[typings.esbuild.esbuildStrings.transform | preserve | automatic] = js.undefined
...
object CommonOptions {
  ...
  implicit open class MutableBuilder[Self <: CommonOptions] (val x: Self) extends AnyVal {
    ...
    inline def setJsx(value: typings.esbuild.esbuildStrings.transform | preserve | automatic): Self = StObject.set(x, "jsx", value.asInstanceOf[js.Any])
