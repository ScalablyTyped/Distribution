...
import typings.emberTestWaiters.packageTypesMod.PendingWaiterState
import typings.emberTestWaiters.packageTypesMod.TestWaiter
import typings.emberTestWaiters.packageTypesMod.Token
import typings.emberTestWaiters.packageTypesMod.Waiter
import typings.emberTestWaiters.packageWaitForMod.AsyncFunction
import typings.emberTestWaiters.packageWaitForMod.CoroutineFunction
...
object packageMod {
  ...
  @JSImport("@ember/test-waiters/package", JSImport.Namespace)
  @js.native
