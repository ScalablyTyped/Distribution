...
import typings.emberTestWaiters.packagePackageWaitForMod.AsyncFunction
import typings.emberTestWaiters.packagePackageWaitForMod.CoroutineFunction
import typings.rsvp.mod.default.Promise
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object packagePackageMod {
  
  @JSImport("@ember/test-waiters/package/package", JSImport.Namespace)
  @js.native
  ...
  inline def waitFor(fn: CoroutineFunction[js.Array[Any], Any]): CoroutineFunction[js.Array[Any], Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(fn.asInstanceOf[js.Any]).asInstanceOf[CoroutineFunction[js.Array[Any], Any]]
  inline def waitFor(fn: CoroutineFunction[js.Array[Any], Any], label: String): CoroutineFunction[js.Array[Any], Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(fn.asInstanceOf[js.Any], label.asInstanceOf[js.Any])).asInstanceOf[CoroutineFunction[js.Array[Any], Any]]
  ...
  inline def waitFor_Function(fn: AsyncFunction[js.Array[Any], Any]): js.Function = ^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(fn.asInstanceOf[js.Any]).asInstanceOf[js.Function]
  inline def waitFor_Function(fn: AsyncFunction[js.Array[Any], Any], label: String): js.Function = (^.asInstanceOf[js.Dynamic].applyDynamic("waitFor")(fn.asInstanceOf[js.Any], label.asInstanceOf[js.Any])).asInstanceOf[js.Function]
}
