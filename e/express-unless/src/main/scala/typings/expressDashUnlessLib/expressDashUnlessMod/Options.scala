...
trait Options extends js.Object {
  var custom: js.UndefOr[js.Function1[/* req */ expressLib.expressMod.Request, scala.Boolean]] = js.undefined
...
object Options {
  @scala.inline
  def apply(
    custom: /* req */ expressLib.expressMod.Request => scala.Boolean = null,
