...
@js.native
sealed trait Hardfork extends StObject
@JSImport("@ethereumjs/common/dist/enums", "Hardfork")
@js.native
object Hardfork extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[Hardfork & String] = js.native
  
  @js.native
  sealed trait ArrowGlacier
    extends StObject
       with Hardfork
  ...
  @js.native
  sealed trait MergeForkIdTransition
    extends StObject
       with Hardfork
