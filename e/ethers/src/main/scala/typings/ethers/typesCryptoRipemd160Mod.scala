...
object typesCryptoRipemd160Mod {
  
  object ripemd160 {
    
    inline def apply(_data: BytesLike): String = ^.asInstanceOf[js.Dynamic].apply(_data.asInstanceOf[js.Any]).asInstanceOf[String]
    
    @JSImport("ethers/types/crypto/ripemd160", "ripemd160")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/ripemd160", "ripemd160._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/ripemd160", "ripemd160.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/ripemd160", "ripemd160.register")
    @js.native
