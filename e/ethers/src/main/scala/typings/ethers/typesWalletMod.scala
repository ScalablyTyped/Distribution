...
object typesWalletMod {
  
  @JSImport("ethers/types/wallet", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers/types/wallet", "BaseWallet")
  @js.native
  open class BaseWallet protected ()
    extends typings.ethers.typesWalletBaseWalletMod.BaseWallet {
    /**
  ...
  @JSImport("ethers/types/wallet", "HDNodeVoidWallet")
  @js.native
  open class HDNodeVoidWallet protected ()
    extends typings.ethers.typesWalletHdwalletMod.HDNodeVoidWallet {
    def this(
      guard: Any,
      address: String,
      publicKey: String,
  ...
  @JSImport("ethers/types/wallet", "HDNodeWallet")
  @js.native
  open class HDNodeWallet protected ()
    extends typings.ethers.typesWalletHdwalletMod.HDNodeWallet {
    def this(
      guard: Any,
  ...
  @JSImport("ethers/types/wallet", "Mnemonic")
  @js.native
  open class Mnemonic protected ()
    extends typings.ethers.typesWalletMnemonicMod.Mnemonic {
    /**
      *  @private
      */
  ...
  @JSImport("ethers/types/wallet", "Wallet")
  @js.native
  open class Wallet protected ()
    extends typings.ethers.typesWalletWalletMod.Wallet {
    /**
  ...
  @JSImport("ethers/types/wallet", "defaultPath")
  @js.native
