...
object libUtilsMod {
  ...
  @js.native
  open class AbiCoder ()
    extends typings.ethersprojectAbi.mod.AbiCoder {
  ...
  open class ConstructorFragment protected ()
    extends typings.ethersprojectAbi.mod.ConstructorFragment {
  ...
  open class ErrorFragment protected ()
    extends typings.ethersprojectAbi.mod.ErrorFragment {
    def this(constructorGuard: Any, params: Any) = this()
  }
  /* static members */
  ...
  open class Fragment protected ()
    extends typings.ethersprojectAbi.mod.Fragment {
    def this(constructorGuard: Any, params: Any) = this()
  }
  /* static members */
  object Fragment {
  ...
  object HDNode {
    ...
    inline def fromMnemonic(mnemonic: String, password: Unit, wordlist: Wordlist): typings.ethersprojectHdnode.mod.HDNode = (^.asInstanceOf[js.Dynamic].applyDynamic("fromMnemonic")(mnemonic.asInstanceOf[js.Any], password.asInstanceOf[js.Any], wordlist.asInstanceOf[js.Any])).asInstanceOf[typings.ethersprojectHdnode.mod.HDNode]
  ...
  open class Indexed protected ()
    extends typings.ethersprojectAbi.mod.Indexed {
  ...
  open class Interface protected ()
    extends typings.ethersprojectAbi.mod.Interface {
  ...
  open class LogDescription protected ()
    extends typings.ethersprojectAbi.mod.LogDescription {
  ...
  open class TransactionDescription protected ()
    extends typings.ethersprojectAbi.mod.TransactionDescription {
