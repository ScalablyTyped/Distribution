...
object typesCryptoRandomMod {
  ...
  object randomBytes {
    ...
    @JSImport("ethers/types/crypto/random", "randomBytes")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/random", "randomBytes._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/random", "randomBytes.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/random", "randomBytes.register")
    @js.native
