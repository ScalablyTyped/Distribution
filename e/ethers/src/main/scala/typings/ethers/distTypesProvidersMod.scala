...
object distTypesProvidersMod extends js.Object {
  ...
  class EtherscanProvider ()
    extends typings.ethers.distTypesProvidersEtherscanDashProviderMod.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typings.ethers.distTypesProvidersFallbackDashProviderMod.FallbackProvider {
    def this(providers: js.Array[typings.ethers.distTypesProvidersProviderMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typings.ethers.distTypesProvidersInfuraDashProviderMod.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typings.ethers.distTypesProvidersIpcDashProviderMod.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typings.ethers.distTypesProvidersJsonDashRpcDashProviderMod.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typings.ethers.distTypesProvidersJsonDashRpcDashProviderMod.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typings.ethers.distTypesProvidersProviderMod.Provider {
  ...
  class Web3Provider protected ()
    extends typings.ethers.distTypesProvidersWeb3DashProviderMod.Web3Provider {
