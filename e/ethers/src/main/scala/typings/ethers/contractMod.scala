...
import typings.ethers.interfaceMod.Interface
import typings.ethers.typesMod.BigNumber
import typings.ethers.typesMod.ContractFunction
import typings.ethers.typesMod.EventFilter
import typings.ethers.typesMod.Listener
