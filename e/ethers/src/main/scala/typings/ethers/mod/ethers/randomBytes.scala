...
object randomBytes {
  ...
  @JSImport("ethers", "ethers.randomBytes")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers", "ethers.randomBytes._")
  @js.native
  ...
  @JSImport("ethers", "ethers.randomBytes.lock")
  @js.native
  ...
  @JSImport("ethers", "ethers.randomBytes.register")
  @js.native
