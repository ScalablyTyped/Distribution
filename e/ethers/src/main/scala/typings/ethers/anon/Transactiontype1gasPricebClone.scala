...
/**
  ...
  */
trait Transactiontype1gasPricebClone extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontype1gasPricebClone: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontype1gasPricebClone: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontype1gasPricebClone: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontype1gasPricebClone: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isLegacy(): /* is ethers.anon.Transactiontype0gasPricebClone */ Boolean = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isLondon(): /* is ethers.anon.Transactiontype2accessLisClone */ Boolean = js.native
  ...
  /**
    ...
    */
  def isSigned(): /* is ethers.anon.TransactiontypenumbertypeClone */ Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontype1gasPricebClone: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontype1gasPricebClone: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontype1gasPricebClone: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontype1gasPricebClone: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontype1gasPricebClone: js.UndefOr[Null | BigNumberish] = js.native
}
