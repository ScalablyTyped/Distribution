...
/* Inlined ethers.ethers/types/transaction/transaction.Transaction & {  type :0,   gasPrice :bigint} */
@js.native
/**
  *  Creates a new Transaction with default values.
  */
trait Transactiontype0gasPricebChainId extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontype0gasPricebChainId: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontype0gasPricebChainId: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontype0gasPricebChainId: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontype0gasPricebChainId: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isBerlin(): /* is ethers.anon.Transactiontype1gasPricebChainId */ Boolean = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isLondon(): /* is ethers.anon.Transactiontype2accessLisChainId */ Boolean = js.native
  ...
  /**
    ...
    */
  def isSigned(): /* is ethers.anon.TransactiontypenumbertypeAccessList */ Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontype0gasPricebChainId: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontype0gasPricebChainId: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontype0gasPricebChainId: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontype0gasPricebChainId: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontype0gasPricebChainId: js.UndefOr[Null | BigNumberish] = js.native
}
