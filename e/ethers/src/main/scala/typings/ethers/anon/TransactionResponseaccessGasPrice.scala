...
/* Inlined ethers.ethers/types/providers/provider.TransactionResponse & {  accessList :null,   maxFeePerGas :null,   maxPriorityFeePerGas :null} */
@js.native
trait TransactionResponseaccessGasPrice extends StObject {
  ...
  /**
    ...
    */
  def isBerlin(): /* is ethers.anon.TransactionResponseaccessBlockHash */ Boolean = js.native
