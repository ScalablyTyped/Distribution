...
/**
  ...
  */
trait Transactiontype0gasPricebConstructor extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontype0gasPricebConstructor: js.UndefOr[Null | BigNumberish] = js.native
}
