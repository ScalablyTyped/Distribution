...
@js.native
trait ParamTypeindexedbooleanBaseType extends StObject {
  ...
  /**
    ...
    */
  def isArray(): /* is ethers.anon.ParamTypearrayChildrenParBaseType */ Boolean = js.native
  ...
  /**
    ...
    *  is non-null.
    */
  def isTuple(): /* is ethers.anon.ParamTypecomponentsReadonBaseType */ Boolean = js.native
