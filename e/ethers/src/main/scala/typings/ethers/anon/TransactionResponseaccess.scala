...
/* Inlined ethers.ethers/types/providers/provider.TransactionResponse & {  accessList :ethers.ethers/types/transaction.AccessList,   maxFeePerGas :bigint,   maxPriorityFeePerGas :bigint} */
@js.native
trait TransactionResponseaccess extends StObject {
