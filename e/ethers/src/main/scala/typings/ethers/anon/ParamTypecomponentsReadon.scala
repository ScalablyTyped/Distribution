...
/* Inlined ethers.ethers/types/abi/fragments.ParamType & {  components :std.ReadonlyArray<ethers.ethers/types/abi/fragments.ParamType>} */
@js.native
trait ParamTypecomponentsReadon extends StObject {
  ...
  /**
    ...
    *  is non-null.
    */
  def isIndexable(): /* is ethers.anon.ParamTypeindexedboolean */ Boolean = js.native
