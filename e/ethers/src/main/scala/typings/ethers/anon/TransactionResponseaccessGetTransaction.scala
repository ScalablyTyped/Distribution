...
@js.native
trait TransactionResponseaccessGetTransaction extends StObject {
  ...
  /**
    ...
    */
  def isBerlin(): /* is ethers.anon.TransactionResponseaccessGetBlock */ Boolean = js.native
  ...
  /**
    ...
    *  the ``null``-ness for hardfork-specific properties set correctly.
    */
  def isLegacy(): /* is ethers.anon.TransactionResponseaccessGasPrice */ Boolean = js.native
