...
/* Inlined ethers.ethers/types/abi/fragments.ParamType & {  indexed :boolean} */
@js.native
trait ParamTypeindexedbooleanArrayLength extends StObject {
  ...
  /**
    ...
    */
  def isArray(): /* is ethers.anon.ParamTypearrayChildrenParArrayLength */ Boolean = js.native
