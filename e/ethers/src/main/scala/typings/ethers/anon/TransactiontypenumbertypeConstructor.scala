...
/**
  ...
  */
trait TransactiontypenumbertypeConstructor extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | String] = js.native
  ...
  @JSName("typeName")
  var typeName_FTransactiontypenumbertypeConstructor: String = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontypenumbertypeConstructor: js.UndefOr[Null | BigNumberish] = js.native
}
