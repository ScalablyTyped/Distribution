...
@js.native
trait TransactionResponseaccessGasLimit extends StObject {
  ...
  /**
    ...
    *  the ``null``-ness for hardfork-specific properties set correctly.
    */
  def isLegacy(): /* is ethers.anon.TransactionResponseaccessConstructor */ Boolean = js.native
  ...
  /**
    ...
    *  the ``null``-ness for hardfork-specific properties set correctly.
    */
  def isLondon(): /* is ethers.anon.TransactionResponseaccessFrom */ Boolean = js.native
