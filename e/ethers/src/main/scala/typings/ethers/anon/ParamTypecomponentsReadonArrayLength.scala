...
@js.native
trait ParamTypecomponentsReadonArrayLength extends StObject {
  ...
  /**
    ...
    */
  def isArray(): /* is ethers.anon.ParamTypearrayChildrenParArrayChildren */ Boolean = js.native
  ...
  /**
    ...
    *  is non-null.
    */
  def isIndexable(): /* is ethers.anon.ParamTypeindexedbooleanArrayLength */ Boolean = js.native
