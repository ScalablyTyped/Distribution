...
@js.native
trait TransactionResponseaccessChainId extends StObject {
  ...
  /**
    ...
    */
  def isBerlin(): /* is ethers.anon.TransactionResponseaccessAccessList */ Boolean = js.native
  ...
  /**
    ...
    *  the ``null``-ness for hardfork-specific properties set correctly.
    */
  def isLondon(): /* is ethers.anon.TransactionResponseaccessBlockNumber */ Boolean = js.native
