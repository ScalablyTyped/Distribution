...
/**
  ...
  */
trait Transactiontypenumbertype extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontypenumbertype: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontypenumbertype: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontypenumbertype: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontypenumbertype: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isBerlin(): /* is ethers.anon.Transactiontype1gasPricebAccessList */ Boolean = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isLegacy(): /* is ethers.anon.Transactiontype0gasPriceb */ Boolean = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isLondon(): /* is ethers.anon.Transactiontype2accessLisAccessList */ Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontypenumbertype: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontypenumbertype: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontypenumbertype: js.UndefOr[Null | String] = js.native
  ...
  @JSName("typeName")
  var typeName_FTransactiontypenumbertype: String = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontypenumbertype: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontypenumbertype: js.UndefOr[Null | BigNumberish] = js.native
}
