...
/* Inlined ethers.ethers/types/transaction/transaction.Transaction & {  type :number,   typeName :string,   from :string,   signature :ethers.ethers/types/crypto.Signature} */
@js.native
/**
  *  Creates a new Transaction with default values.
  */
trait TransactiontypenumbertypeAccessList extends StObject {
  ...
  /**
    ...
    */
  @JSName("accessList")
  var accessList_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | AccessListish] = js.native
  ...
  /**
    ...
    */
  @JSName("chainId")
  var chainId_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("data")
  var data_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("from")
  var from_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    */
  @JSName("gasLimit")
  var gasLimit_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("gasPrice")
  var gasPrice_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("hash")
  var hash_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | String] = js.native
  ...
  /**
    ...
    *  non-null.
    */
  def isBerlin(): /* is ethers.anon.Transactiontype1gasPriceb */ Boolean = js.native
  ...
  /**
    ...
    */
  @JSName("maxFeePerGas")
  var maxFeePerGas_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
  ...
  var maxPriorityFeePerGas_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
  ...
  /**
    ...
    */
  @JSName("nonce")
  var nonce_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("signature")
  var signature_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | SignatureLike] = js.native
  ...
  /**
    ...
    */
  @JSName("to")
  var to_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | String] = js.native
  ...
  @JSName("typeName")
  var typeName_FTransactiontypenumbertypeAccessList: String = js.native
  ...
  /**
    ...
    */
  @JSName("type")
  var type_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | Double] = js.native
  ...
  /**
    ...
    */
  @JSName("value")
  var value_FTransactiontypenumbertypeAccessList: js.UndefOr[Null | BigNumberish] = js.native
}
