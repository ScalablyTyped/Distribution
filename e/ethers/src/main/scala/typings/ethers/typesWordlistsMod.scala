...
object typesWordlistsMod {
  ...
  @JSImport("ethers/types/wordlists", "LangEn")
  @js.native
  /**
    ...
    */
  open class LangEn ()
    extends typings.ethers.typesWordlistsLangEnMod.LangEn
  /* static members */
  object LangEn {
  ...
  /* note: abstract class */ @JSImport("ethers/types/wordlists", "Wordlist")
  @js.native
  open class Wordlist protected ()
    extends typings.ethers.typesWordlistsWordlistMod.Wordlist {
    /**
  ...
  @JSImport("ethers/types/wordlists", "WordlistOwl")
  @js.native
  open class WordlistOwl protected ()
    extends typings.ethers.typesWordlistsWordlistOwlMod.WordlistOwl {
    /**
  ...
  @JSImport("ethers/types/wordlists", "WordlistOwlA")
  @js.native
  open class WordlistOwlA protected ()
    extends typings.ethers.typesWordlistsWordlistOwlaMod.WordlistOwlA {
    def this(locale: String, data: String, accent: String, checksum: String) = this()
  }
  
  @JSImport("ethers/types/wordlists", "wordlists")
  @js.native
