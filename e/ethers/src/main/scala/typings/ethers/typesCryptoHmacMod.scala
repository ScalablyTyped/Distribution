...
object typesCryptoHmacMod {
  ...
  object computeHmac {
    ...
    @JSImport("ethers/types/crypto/hmac", "computeHmac")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/hmac", "computeHmac._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/hmac", "computeHmac.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/hmac", "computeHmac.register")
    @js.native
