...
object typesUtilsMod {
  ...
  @JSImport("ethers/types/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers/types/utils", "EventPayload")
  @js.native
  open class EventPayload[T] protected ()
    extends typings.ethers.typesUtilsEventsMod.EventPayload[T] {
    /**
  ...
  @JSImport("ethers/types/utils", "FetchCancelSignal")
  @js.native
  open class FetchCancelSignal protected ()
    extends typings.ethers.typesUtilsFetchMod.FetchCancelSignal {
    def this(request: typings.ethers.typesUtilsFetchMod.FetchRequest) = this()
  }
  
  @JSImport("ethers/types/utils", "FetchRequest")
  @js.native
  open class FetchRequest protected ()
    extends typings.ethers.typesUtilsFetchMod.FetchRequest {
    /**
  ...
  @JSImport("ethers/types/utils", "FetchResponse")
  @js.native
  open class FetchResponse protected ()
    extends typings.ethers.typesUtilsFetchMod.FetchResponse {
  ...
  @JSImport("ethers/types/utils", "FixedNumber")
  @js.native
  open class FixedNumber protected ()
    extends typings.ethers.typesUtilsFixednumberMod.FixedNumber {
    /**
      *  @private
      */
  ...
  object Utf8ErrorFuncs {
    ...
    @JSImport("ethers/types/utils", "Utf8ErrorFuncs")
    @js.native
    val ^ : js.Any = js.native
