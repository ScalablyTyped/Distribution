...
object typesCryptoScryptMod {
  ...
  object scrypt {
    ...
    @JSImport("ethers/types/crypto/scrypt", "scrypt")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/scrypt", "scrypt._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/scrypt", "scrypt.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/scrypt", "scrypt.register")
    @js.native
  ...
  object scryptSync {
    ...
    @JSImport("ethers/types/crypto/scrypt", "scryptSync")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/scrypt", "scryptSync._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/scrypt", "scryptSync.lock")
    @js.native
    def lock: js.Function0[Unit] = js.native
    inline def lock_=(x: js.Function0[Unit]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("lock")(x.asInstanceOf[js.Any])
    
    @JSImport("ethers/types/crypto/scrypt", "scryptSync.register")
    @js.native
    def register: js.Function1[
        /* func */ js.Function6[
          /* passwd */ js.typedarray.Uint8Array, 
