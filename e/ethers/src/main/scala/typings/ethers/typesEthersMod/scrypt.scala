...
object scrypt {
  ...
  @JSImport("ethers/types/ethers", "scrypt")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers/types/ethers", "scrypt._")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "scrypt.lock")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "scrypt.register")
  @js.native
