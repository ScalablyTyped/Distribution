...
object randomBytes {
  ...
  @JSImport("ethers/types/ethers", "randomBytes")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers/types/ethers", "randomBytes._")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "randomBytes.lock")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "randomBytes.register")
  @js.native
