...
object scryptSync {
  ...
  @JSImport("ethers/types/ethers", "scryptSync")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("ethers/types/ethers", "scryptSync._")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "scryptSync.lock")
  @js.native
  ...
  @JSImport("ethers/types/ethers", "scryptSync.register")
  @js.native
