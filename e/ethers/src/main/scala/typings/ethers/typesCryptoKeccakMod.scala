...
object typesCryptoKeccakMod {
  
  object keccak256 {
    
    inline def apply(_data: BytesLike): String = ^.asInstanceOf[js.Dynamic].apply(_data.asInstanceOf[js.Any]).asInstanceOf[String]
    
    @JSImport("ethers/types/crypto/keccak", "keccak256")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/keccak", "keccak256._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/keccak", "keccak256.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/keccak", "keccak256.register")
    @js.native
