...
object typesCryptoPbkdf2Mod {
  ...
  object pbkdf2 {
    ...
    @JSImport("ethers/types/crypto/pbkdf2", "pbkdf2")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ethers/types/crypto/pbkdf2", "pbkdf2._")
    @js.native
    ...
    @JSImport("ethers/types/crypto/pbkdf2", "pbkdf2.lock")
    @js.native
    ...
    @JSImport("ethers/types/crypto/pbkdf2", "pbkdf2.register")
    @js.native
