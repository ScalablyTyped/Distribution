...
object typesContractMod {
  
  @JSImport("ethers/types/contract", "BaseContract")
  @js.native
  open class BaseContract protected ()
    extends typings.ethers.typesContractContractMod.BaseContract {
  ...
  @JSImport("ethers/types/contract", "Contract")
  @js.native
  open class Contract ()
    extends typings.ethers.typesContractContractMod.Contract
  
  @JSImport("ethers/types/contract", "ContractEventPayload")
  @js.native
  open class ContractEventPayload protected ()
    extends typings.ethers.typesContractWrappersMod.ContractEventPayload {
    def this(
  ...
  @JSImport("ethers/types/contract", "ContractFactory")
  @js.native
  open class ContractFactory[A /* <: js.Array[Any] */, I] protected ()
    extends typings.ethers.typesContractFactoryMod.ContractFactory[A, I] {
  ...
  @JSImport("ethers/types/contract", "ContractTransactionReceipt")
  @js.native
  open class ContractTransactionReceipt protected ()
    extends typings.ethers.typesContractWrappersMod.ContractTransactionReceipt {
    def this(iface: Interface, provider: Provider, tx: TransactionReceipt) = this()
  }
  
  @JSImport("ethers/types/contract", "ContractTransactionResponse")
  @js.native
  open class ContractTransactionResponse protected ()
    extends typings.ethers.typesContractWrappersMod.ContractTransactionResponse {
    def this(iface: Interface, provider: Provider, tx: TransactionResponse) = this()
  }
  
  @JSImport("ethers/types/contract", "ContractUnknownEventPayload")
  @js.native
  open class ContractUnknownEventPayload protected ()
    extends typings.ethers.typesContractWrappersMod.ContractUnknownEventPayload {
    def this(
      contract: typings.ethers.typesContractContractMod.BaseContract,
      listener: Null,
      filter: ContractEventName,
  ...
  @JSImport("ethers/types/contract", "EventLog")
  @js.native
  open class EventLog protected ()
    extends typings.ethers.typesContractWrappersMod.EventLog {
