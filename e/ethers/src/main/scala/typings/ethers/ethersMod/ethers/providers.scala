...
object providers extends js.Object {
  ...
  class EtherscanProvider ()
    extends typings.ethers.distTypesEthersMod.providers.EtherscanProvider {
  ...
  class FallbackProvider protected ()
    extends typings.ethers.distTypesEthersMod.providers.FallbackProvider {
    def this(providers: js.Array[typings.ethers.distTypesProvidersProviderMod.Provider]) = this()
  }
  
  @js.native
  class InfuraProvider ()
    extends typings.ethers.distTypesEthersMod.providers.InfuraProvider {
    def this(network: Networkish) = this()
  ...
  class IpcProvider protected ()
    extends typings.ethers.distTypesEthersMod.providers.IpcProvider {
  ...
  class JsonRpcProvider ()
    extends typings.ethers.distTypesEthersMod.providers.JsonRpcProvider {
  ...
  class JsonRpcSigner protected ()
    extends typings.ethers.distTypesEthersMod.providers.JsonRpcSigner {
  ...
  class Provider protected ()
    extends typings.ethers.distTypesEthersMod.providers.Provider {
  ...
  class Web3Provider protected ()
    extends typings.ethers.distTypesEthersMod.providers.Web3Provider {
