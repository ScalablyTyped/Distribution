...
object Anon_Abs {
  ...
  def apply(
    ...
    if (!js.isUndefined(assignment)) __obj.updateDynamic("assignment")(assignment)
    if (!js.isUndefined(atan)) __obj.updateDynamic("atan")(atan)
    if (!js.isUndefined(atanh)) __obj.updateDynamic("atanh")(atanh)
    if (!js.isUndefined(cbrt)) __obj.updateDynamic("cbrt")(cbrt)
    ...
    if (!js.isUndefined(expm1)) __obj.updateDynamic("expm1")(expm1)
    ...
    if (!js.isUndefined(fndef)) __obj.updateDynamic("fndef")(fndef)
    ...
    if (!js.isUndefined(log1p)) __obj.updateDynamic("log1p")(log1p)
    if (!js.isUndefined(log2)) __obj.updateDynamic("log2")(log2)
