...
import typings.emberAutoImport.emberAutoImportBooleans.`false`
import typings.emberAutoImport.emberAutoImportBooleans.`true`
import typings.emberAutoImport.emberAutoImportStrings.Ampersand
import typings.emberAutoImport.emberAutoImportStrings.AmpersandAmpersand
import typings.emberAutoImport.emberAutoImportStrings.Asterisk
import typings.emberAutoImport.emberAutoImportStrings.AsteriskAsterisk
import typings.emberAutoImport.emberAutoImportStrings.BlockStatement
import typings.emberAutoImport.emberAutoImportStrings.ClassBody
import typings.emberAutoImport.emberAutoImportStrings.CommonJS
import typings.emberAutoImport.emberAutoImportStrings.Dotes
import typings.emberAutoImport.emberAutoImportStrings.Dotes6
import typings.emberAutoImport.emberAutoImportStrings.Dotjs
import typings.emberAutoImport.emberAutoImportStrings.Dotjsx
import typings.emberAutoImport.emberAutoImportStrings.Dotmjs
import typings.emberAutoImport.emberAutoImportStrings.ES
import typings.emberAutoImport.emberAutoImportStrings.EqualssignEqualssign
import typings.emberAutoImport.emberAutoImportStrings.EqualssignEqualssignEqualssign
import typings.emberAutoImport.emberAutoImportStrings.Exclamationmark
import typings.emberAutoImport.emberAutoImportStrings.ExclamationmarkEqualssign
import typings.emberAutoImport.emberAutoImportStrings.ExclamationmarkEqualssignEqualssign
import typings.emberAutoImport.emberAutoImportStrings.Greaterthansign
import typings.emberAutoImport.emberAutoImportStrings.GreaterthansignEqualssign
import typings.emberAutoImport.emberAutoImportStrings.GreaterthansignGreaterthansign
import typings.emberAutoImport.emberAutoImportStrings.GreaterthansignGreaterthansignGreaterthansign
import typings.emberAutoImport.emberAutoImportStrings.Identifier
import typings.emberAutoImport.emberAutoImportStrings.Lessthansign
import typings.emberAutoImport.emberAutoImportStrings.LessthansignEqualssign
import typings.emberAutoImport.emberAutoImportStrings.LessthansignLessthansign
import typings.emberAutoImport.emberAutoImportStrings.Percentsign
import typings.emberAutoImport.emberAutoImportStrings.Plussign
import typings.emberAutoImport.emberAutoImportStrings.PlussignPlussign
import typings.emberAutoImport.emberAutoImportStrings.QuestionmarkQuestionmark
import typings.emberAutoImport.emberAutoImportStrings.Slash
import typings.emberAutoImport.emberAutoImportStrings.StringLiteral
import typings.emberAutoImport.emberAutoImportStrings.Tilde
import typings.emberAutoImport.emberAutoImportStrings.Verticalline
import typings.emberAutoImport.emberAutoImportStrings.VerticallineGreaterthansign
import typings.emberAutoImport.emberAutoImportStrings.VerticallineVerticalline
import typings.emberAutoImport.emberAutoImportStrings.^
import typings.emberAutoImport.emberAutoImportStrings.`--`
import typings.emberAutoImport.emberAutoImportStrings.`-_`
import typings.emberAutoImport.emberAutoImportStrings.`object`
import typings.emberAutoImport.emberAutoImportStrings.`throw`
import typings.emberAutoImport.emberAutoImportStrings.`using`
import typings.emberAutoImport.emberAutoImportStrings.`var`
import typings.emberAutoImport.emberAutoImportStrings.boolean
import typings.emberAutoImport.emberAutoImportStrings.const
import typings.emberAutoImport.emberAutoImportStrings.constructor
import typings.emberAutoImport.emberAutoImportStrings.delete
import typings.emberAutoImport.emberAutoImportStrings.function
import typings.emberAutoImport.emberAutoImportStrings.get
import typings.emberAutoImport.emberAutoImportStrings.in
import typings.emberAutoImport.emberAutoImportStrings.instanceof
import typings.emberAutoImport.emberAutoImportStrings.let
import typings.emberAutoImport.emberAutoImportStrings.method
import typings.emberAutoImport.emberAutoImportStrings.minus
import typings.emberAutoImport.emberAutoImportStrings.module
import typings.emberAutoImport.emberAutoImportStrings.number
import typings.emberAutoImport.emberAutoImportStrings.plus
import typings.emberAutoImport.emberAutoImportStrings.script
import typings.emberAutoImport.emberAutoImportStrings.set
import typings.emberAutoImport.emberAutoImportStrings.string
import typings.emberAutoImport.emberAutoImportStrings.symbol
import typings.emberAutoImport.emberAutoImportStrings.typeof
import typings.emberAutoImport.emberAutoImportStrings.undefined
import typings.emberAutoImport.emberAutoImportStrings.void
import typings.emberAutoImport.jsAnalyzerPluginMod.State
...
object anon {
  ...
  trait CallExpression extends StObject {
    ...
    def CallExpression(path: NodePath[CallExpression_], state: State): Unit
    
    def ExportAllDeclaration(path: NodePath[ExportAllDeclaration_], state: State): Unit
    
    def ExportNamedDeclaration(path: NodePath[ExportNamedDeclaration_], state: State): Unit
    
    def ImportDeclaration(path: NodePath[ImportDeclaration_], state: State): Unit
  ...
  object CallExpression {
    ...
    inline def apply(
      CallExpression: (NodePath[CallExpression_], State) => Unit,
      ExportAllDeclaration: (NodePath[ExportAllDeclaration_], State) => Unit,
      ExportNamedDeclaration: (NodePath[ExportNamedDeclaration_], State) => Unit,
      ImportDeclaration: (NodePath[ImportDeclaration_], State) => Unit,
      Program: Enter
    ): CallExpression = {
      val __obj = js.Dynamic.literal(CallExpression = js.Any.fromFunction2(CallExpression), ExportAllDeclaration = js.Any.fromFunction2(ExportAllDeclaration), ExportNamedDeclaration = js.Any.fromFunction2(ExportNamedDeclaration), ImportDeclaration = js.Any.fromFunction2(ImportDeclaration), Program = Program.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: CallExpression] (val x: Self) extends AnyVal {
      ...
      inline def setCallExpression(value: (NodePath[CallExpression_], State) => Unit): Self = StObject.set(x, "CallExpression", js.Any.fromFunction2(value))
      
      inline def setExportAllDeclaration(value: (NodePath[ExportAllDeclaration_], State) => Unit): Self = StObject.set(x, "ExportAllDeclaration", js.Any.fromFunction2(value))
      ...
      inline def setImportDeclaration(value: (NodePath[ImportDeclaration_], State) => Unit): Self = StObject.set(x, "ImportDeclaration", js.Any.fromFunction2(value))
  ...
  object Css {
    ...
    inline def apply(css: String, js_ : String): Css = {
  ...
  trait Enter extends StObject {
    ...
    def enter(_path: NodePath[Program_], state: State): Unit
  ...
  trait Import extends StObject {
    ...
    def CallExpression(path: NodePath[CallExpression_]): Unit
    
    def Import(path: NodePath[Import_]): Unit
  }
  object Import {
    
    inline def apply(CallExpression: NodePath[CallExpression_] => Unit, Import: NodePath[Import_] => Unit): Import = {
      val __obj = js.Dynamic.literal(CallExpression = js.Any.fromFunction1(CallExpression), Import = js.Any.fromFunction1(Import))
    ...
    implicit open class MutableBuilder[Self <: Import] (val x: Self) extends AnyVal {
      ...
      inline def setCallExpression(value: NodePath[CallExpression_] => Unit): Self = StObject.set(x, "CallExpression", js.Any.fromFunction1(value))
      
      inline def setImport(value: NodePath[Import_] => Unit): Self = StObject.set(x, "Import", js.Any.fromFunction1(value))
    }
  }
  
  trait Imports extends StObject {
    
    var imports: js.UndefOr[js.Array[ImportSyntax]] = js.undefined
  }
  object Imports {
  ...
  object Inherits {
    ...
    inline def apply(inherits: Any, visitor: Import): Inherits = {
      val __obj = js.Dynamic.literal(inherits = inherits.asInstanceOf[js.Any], visitor = visitor.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Inherits] (val x: Self) extends AnyVal {
      ...
      inline def setVisitor(value: Import): Self = StObject.set(x, "visitor", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Typeoftypes extends StObject {
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */](`type`: T): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */](`type`: T, n: typings.babelTypes.mod.Node): /* is std.Extract<@babel/types.@babel/types.Node, @babel/types.anon.Type<T>> */ Boolean = js.native
    ...
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Null, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: Unit, required: Partial[P]): /* is P */ Boolean = js.native
    def is[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */, P /* <: Extract[typings.babelTypes.mod.Node, Type[T]] */](`type`: T, n: typings.babelTypes.mod.Node, required: Partial[P]): /* is P */ Boolean = js.native
    ...
    def isPlaceholderType(
      placeholderType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any,
      targetType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any
    ): Boolean = js.native
    ...
    def isType[T /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 249, starting with typings.emberAutoImport.emberAutoImportStrings.ClassAccessorProperty, typings.emberAutoImport.emberAutoImportStrings.AnyTypeAnnotation, typings.emberAutoImport.emberAutoImportStrings.ArgumentPlaceholder */ Any */](nodetype: String, targetType: T): /* is T */ Boolean = js.native
    ...
    def placeholder(
      expectedNode: Identifier | StringLiteral | typings.emberAutoImport.emberAutoImportStrings.Expression | typings.emberAutoImport.emberAutoImportStrings.Statement | typings.emberAutoImport.emberAutoImportStrings.Declaration | BlockStatement | ClassBody | typings.emberAutoImport.emberAutoImportStrings.Pattern,
      name: Identifier_
  ...
  trait Visitor extends StObject {
    ...
    var visitor: CallExpression
  }
  object Visitor {
    
    inline def apply(visitor: CallExpression): Visitor = {
    ...
    implicit open class MutableBuilder[Self <: Visitor] (val x: Self) extends AnyVal {
      ...
      inline def setVisitor(value: CallExpression): Self = StObject.set(x, "visitor", value.asInstanceOf[js.Any])
    }
  }
}
