...
trait EarcutStatic extends js.Object {
  ...
  /**
  	 ...
  	 */
  def apply(vertices: stdLib.ArrayLike[scala.Double]): js.Array[scala.Double] = js.native
  def apply(vertices: stdLib.ArrayLike[scala.Double], holes: stdLib.ArrayLike[scala.Double]): js.Array[scala.Double] = js.native
  def apply(
    vertices: stdLib.ArrayLike[scala.Double],
    holes: stdLib.ArrayLike[scala.Double],
    dimensions: scala.Double
  ...
  /**
  	 ...
  	 * @example with 3d coords: earcut([10,0,1, 0,50,2, 60,60,3, 70,10,4], null, 3); // [1,0,3, 3,2,1]
  	 */
  def default(vertices: stdLib.ArrayLike[scala.Double]): js.Array[scala.Double] = js.native
  def default(vertices: stdLib.ArrayLike[scala.Double], holes: stdLib.ArrayLike[scala.Double]): js.Array[scala.Double] = js.native
  def default(
    vertices: stdLib.ArrayLike[scala.Double],
    holes: stdLib.ArrayLike[scala.Double],
    dimensions: scala.Double
  ...
  def deviation(
    ...
    dimensions: scala.Double,
    triangles: stdLib.ArrayLike[scala.Double]
