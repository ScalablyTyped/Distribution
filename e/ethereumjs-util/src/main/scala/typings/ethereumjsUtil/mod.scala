...
object mod {
  ...
  object Address {
    ...
    /**
      ...
      */
    inline def generate(from: typings.ethereumjsUtil.addressMod.Address, nonce: typings.bnJs.mod.^): typings.ethereumjsUtil.addressMod.Address = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(from.asInstanceOf[js.Any], nonce.asInstanceOf[js.Any])).asInstanceOf[typings.ethereumjsUtil.addressMod.Address]
