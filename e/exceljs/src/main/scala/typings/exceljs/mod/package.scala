...
type WorksheetView = typings.exceljs.mod.WorksheetViewCommon & (typings.exceljs.mod.WorksheetViewNormal | typings.exceljs.mod.WorksheetViewFrozen | typings.exceljs.mod.WorksheetViewSplit)
