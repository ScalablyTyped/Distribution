...
object _CellValue {
  ...
  inline def CellFormulaValue(date1904: Boolean, formula: String): typings.exceljs.mod.CellFormulaValue = {
  ...
  inline def CellHyperlinkValue(hyperlink: String, text: String): typings.exceljs.mod.CellHyperlinkValue = {
  ...
  inline def CellRichTextValue(richText: js.Array[RichText]): typings.exceljs.mod.CellRichTextValue = {
  ...
  inline def CellSharedFormulaValue(date1904: Boolean, sharedFormula: String): typings.exceljs.mod.CellSharedFormulaValue = {
