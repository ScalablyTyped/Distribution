...
import typings.egjsAgent.declarationTypesMod.NavigatorUABrandVersion
import typings.egjsAgent.declarationTypesMod.PresetInfo
import typings.egjsAgent.declarationTypesMod.PresetResult
