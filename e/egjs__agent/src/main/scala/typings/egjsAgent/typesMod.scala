...
object typesMod {
  ...
  trait NavigatorUAData extends StObject {
    ...
    {[ key in 'architecture' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
    @JSName("getHighEntropyValues")
    def getHighEntropyValues_fullVersionList(hints: js.Array[fullVersionList]): js.Promise[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ key in 'fullVersionList' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
    @JSName("getHighEntropyValues")
    def getHighEntropyValues_model(hints: js.Array[model]): js.Promise[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ key in 'model' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
    @JSName("getHighEntropyValues")
    def getHighEntropyValues_platform(hints: js.Array[platform]): js.Promise[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ key in 'platform' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
    @JSName("getHighEntropyValues")
    def getHighEntropyValues_platformVersion(hints: js.Array[platformVersion]): js.Promise[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ key in 'platformVersion' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
    @JSName("getHighEntropyValues")
    def getHighEntropyValues_uaFullVersion(hints: js.Array[uaFullVersion]): js.Promise[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ key in 'uaFullVersion' ]: @egjs/agent.@egjs/agent/declaration/types.UADataValues[key]}
      */ typings.egjsAgent.egjsAgentStrings.NavigatorUAData & TopLevel[UADataValues]
      ] = js.native
