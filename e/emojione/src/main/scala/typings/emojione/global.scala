...
object global {
  ...
  object emojione {
    ...
    @JSGlobal("emojione.cacheBustParam")
    @js.native
    ...
    @JSGlobal("emojione.imagePathPNG")
    @js.native
    ...
    @JSGlobal("emojione.imagePathSVG")
    @js.native
    def imagePathSVG: String = js.native
    
    @JSGlobal("emojione.imagePathSVGSprites")
    @js.native
    ...
    @JSGlobal("emojione.unicodeRegexp")
    @js.native
