...
object esmMod {
  ...
  object DecodingMode extends StObject {
    ...
    sealed trait Legacy
      extends StObject
         with DecodingMode
    /* 0 */ val Legacy: typings.entities.esmMod.DecodingMode.Legacy & Double = js.native
    ...
    sealed trait Strict
      extends StObject
         with DecodingMode
    /* 1 */ val Strict: typings.entities.esmMod.DecodingMode.Strict & Double = js.native
  }
  ...
  object EncodingMode extends StObject {
    ...
    sealed trait ASCII
      extends StObject
         with EncodingMode
    /* 1 */ val ASCII: typings.entities.esmMod.EncodingMode.ASCII & Double = js.native
    ...
    sealed trait Attribute
      extends StObject
         with EncodingMode
    /* 3 */ val Attribute: typings.entities.esmMod.EncodingMode.Attribute & Double = js.native
    ...
    sealed trait Extensive
      extends StObject
         with EncodingMode
    /* 2 */ val Extensive: typings.entities.esmMod.EncodingMode.Extensive & Double = js.native
    ...
    sealed trait Text
      extends StObject
         with EncodingMode
    /* 4 */ val Text: typings.entities.esmMod.EncodingMode.Text & Double = js.native
    ...
    sealed trait UTF8
      extends StObject
         with EncodingMode
    /* 0 */ val UTF8: typings.entities.esmMod.EncodingMode.UTF8 & Double = js.native
  }
  ...
  object EntityLevel extends StObject {
    ...
    sealed trait HTML
      extends StObject
         with EntityLevel
    /* 1 */ val HTML: typings.entities.esmMod.EntityLevel.HTML & Double = js.native
    ...
    sealed trait XML
      extends StObject
         with EntityLevel
    /* 0 */ val XML: typings.entities.esmMod.EntityLevel.XML & Double = js.native
  }
