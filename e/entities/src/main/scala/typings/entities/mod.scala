...
import typings.entities.libDecodeMod.DecodingMode
import typings.entities.libDecodeMod.EntityErrorProducer
...
object mod {
  ...
  @JSImport("entities", "DecodingMode")
  @js.native
  object DecodingMode extends StObject {
    
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.entities.libDecodeMod.DecodingMode & Double] = js.native
  ...
  @JSImport("entities", "EncodingMode")
  @js.native
  object EncodingMode extends StObject {
    ...
    sealed trait ASCII
      extends StObject
         with EncodingMode
    /* 1 */ val ASCII: typings.entities.mod.EncodingMode.ASCII & Double = js.native
    ...
    sealed trait Attribute
      extends StObject
         with EncodingMode
    /* 3 */ val Attribute: typings.entities.mod.EncodingMode.Attribute & Double = js.native
    ...
    sealed trait Extensive
      extends StObject
         with EncodingMode
    /* 2 */ val Extensive: typings.entities.mod.EncodingMode.Extensive & Double = js.native
    ...
    sealed trait Text
      extends StObject
         with EncodingMode
    /* 4 */ val Text: typings.entities.mod.EncodingMode.Text & Double = js.native
    ...
    sealed trait UTF8
      extends StObject
         with EncodingMode
    /* 0 */ val UTF8: typings.entities.mod.EncodingMode.UTF8 & Double = js.native
  }
  
  @JSImport("entities", "EntityDecoder")
  @js.native
  open class EntityDecoder protected ()
    extends typings.entities.libDecodeMod.EntityDecoder {
    def this(
  ...
  object EntityLevel extends StObject {
    ...
    sealed trait HTML
      extends StObject
         with EntityLevel
    /* 1 */ val HTML: typings.entities.mod.EntityLevel.HTML & Double = js.native
    ...
    sealed trait XML
      extends StObject
         with EntityLevel
    /* 0 */ val XML: typings.entities.mod.EntityLevel.XML & Double = js.native
  }
