...
object decodeMod {
  ...
  object BinTrieFlags extends StObject {
    ...
    sealed trait BRANCH_LENGTH
      extends StObject
         with BinTrieFlags
    /* 16256 */ val BRANCH_LENGTH: typings.entities.decodeMod.BinTrieFlags.BRANCH_LENGTH & Double = js.native
    
    @js.native
    sealed trait JUMP_TABLE
      extends StObject
         with BinTrieFlags
    /* 127 */ val JUMP_TABLE: typings.entities.decodeMod.BinTrieFlags.JUMP_TABLE & Double = js.native
    
    @js.native
    sealed trait VALUE_LENGTH
      extends StObject
         with BinTrieFlags
    /* 49152 */ val VALUE_LENGTH: typings.entities.decodeMod.BinTrieFlags.VALUE_LENGTH & Double = js.native
  }
