...
import typings.elliptic.ellipticMod.curve.edwards
import typings.elliptic.ellipticMod.eddsa.Bytes
import typings.elliptic.ellipticMod.eddsa.KeyPair
import typings.elliptic.ellipticMod.eddsa.Point
import typings.elliptic.ellipticMod.eddsa.Signature
