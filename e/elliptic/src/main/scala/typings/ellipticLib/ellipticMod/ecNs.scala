...
object ecNs extends js.Object {
  ...
  class KeyPair protected () extends js.Object {
    ...
    def derive(pub: js.Any): js.Any = js.native
     // ?
    def getPrivate(): nodeLib.Buffer | js.Any | java.lang.String = js.native
     // ?
    @JSName("getPrivate")
    def getPrivate_hex(enc: ellipticLib.ellipticLibStrings.hex): nodeLib.Buffer | js.Any | java.lang.String = js.native
     // ?
  ...
  trait SignOptions extends js.Object {
    ...
    var k: js.UndefOr[js.Any] = js.undefined
    var pers: js.Any
    var persEnc: js.UndefOr[java.lang.String] = js.undefined
  }
