...
trait Anon_IdIgnoreInfoInvisibleNameOriginPositionRotation extends js.Object {
  /**
...
object Anon_IdIgnoreInfoInvisibleNameOriginPositionRotation {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_IdIgnoreInfoInvisibleNameOriginPositionRotation]
  }
}
