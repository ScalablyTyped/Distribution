...
trait Anon_NameSilentStyleScaleInvisibleRotationInfoZ2IdOriginStyleEmphasis extends js.Object {
  /**
  ...
  /**
    ...
    */
  var style: js.UndefOr[Anon_XShadowOffsetXImage] = js.undefined
  /**
