...
trait ECharts extends js.Object {
  ...
  /**
           ...
           */
  def getOption(): EChartOption = js.native
  /**
  ...
  /**
           ...
           *     immediately
           */
  def setOption(option: EChartOption): scala.Unit = js.native
  /**
           * Configuration item, data, universal interface, all parameters and
           *     data can all be modified through `setOption`. ECharts will merge
           *     new parameters and data, and then refresh chart.
           ...
           *     immediately
           */
  def setOption(option: EChartOption, notMerge: scala.Boolean): scala.Unit = js.native
  /**
           * Configuration item, data, universal interface, all parameters and
           *     data can all be modified through `setOption`. ECharts will merge
           *     new parameters and data, and then refresh chart.
           ...
           *     immediately
           */
  def setOption(option: EChartOption, notMerge: scala.Boolean, lazyUpdate: scala.Boolean): scala.Unit = js.native
  /**
           * Configuration item, data, universal interface, all parameters and
           *     data can all be modified through `setOption`. ECharts will merge
           *     new parameters and data, and then refresh chart.
           ...
           */
  def setOption(option: EChartOption, opts: EChartsOptionConfig): scala.Unit = js.native
  /**
