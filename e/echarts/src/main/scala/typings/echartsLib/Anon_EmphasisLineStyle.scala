...
trait Anon_EmphasisLineStyle extends js.Object {
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_LineStyleAnonColorCurvenessOpacityShadowBlurShadowColorShadowOffsetX] = js.native
  /**
    ...
    */
  var lineStyle: js.UndefOr[Anon_ColorCurvenessOpacityShadowBlurShadowColorShadowOffsetX] = js.native
  /**
    * The
