...
@js.native
trait Anon_ShadowOffsetXBackgroundColorShowAlignTextBorderWidthVerticalAlignShadowBlurHeight extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowAlign] = js.native
  /**
    * font family
    *
