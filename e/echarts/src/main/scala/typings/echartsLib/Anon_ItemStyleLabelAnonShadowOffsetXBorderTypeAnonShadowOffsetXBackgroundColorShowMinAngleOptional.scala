...
@js.native
trait Anon_ItemStyleLabelAnonShadowOffsetXBorderTypeAnonShadowOffsetXBackgroundColorShowMinAngleOptional extends js.Object {
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowMinAngle] = js.native
}
