...
@js.native
trait Anon_VisualMax extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_UpperLabel] = js.native
  /**
    *
    ...
    */
  var itemStyle: js.UndefOr[Anon_BorderColorSaturation] = js.native
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowEllipsisAlignTextBorderWidth] = js.native
  /**
    ...
    */
  var upperLabel: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowEllipsisAlign] = js.native
  /**
