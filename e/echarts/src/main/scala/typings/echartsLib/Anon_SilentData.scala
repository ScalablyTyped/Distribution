...
@js.native
trait Anon_SilentData extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon_XName] = js.native
  /**
    * Mark point style.
    *
    *
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowAlignTextBorderWidth] = js.native
  /**
