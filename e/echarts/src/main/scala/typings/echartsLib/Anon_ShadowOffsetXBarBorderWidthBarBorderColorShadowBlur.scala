...
@js.native
trait Anon_ShadowOffsetXBarBorderWidthBarBorderColorShadowBlur extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_ShadowOffsetXBarBorderWidthBarBorderColor] = js.native
  /**
