...
trait Anon_ShadowOffsetXBackgroundColorShowAlignTextBorderWidth extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowAlign] = js.undefined
  /**
    * font family
    *
