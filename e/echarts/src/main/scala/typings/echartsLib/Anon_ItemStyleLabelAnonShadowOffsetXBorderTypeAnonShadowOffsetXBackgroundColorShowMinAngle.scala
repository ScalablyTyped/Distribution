...
trait Anon_ItemStyleLabelAnonShadowOffsetXBorderTypeAnonShadowOffsetXBackgroundColorShowMinAngle extends js.Object {
  /**
  ...
  /**
    ...
    */
  var label: js.UndefOr[Anon_ShadowOffsetXBackgroundColorShowMinAngle] = js.undefined
}
