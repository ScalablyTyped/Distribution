...
trait AnonIdIgnoreInfoInvisibleName extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonCx] = js.undefined
  /**
...
object AnonIdIgnoreInfoInvisibleName {
  @scala.inline
  def apply(
    id: String = null,
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisibleName]
  }
}
