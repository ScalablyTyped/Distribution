...
trait Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon_ItemStyleLabelName] = js.undefined
  /**
    * Mark point style.
    *
    *
...
object Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate {
  @scala.inline
  def apply(
    ...
    data: Anon_ItemStyleLabelName = null,
    ...
    __obj.asInstanceOf[Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate]
  }
}
