...
trait AnonCoordLabelLineStyleName extends js.Object {
  /**
...
object AnonCoordLabelLineStyleName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCoordLabelLineStyleName]
  }
}
