...
trait AnonBorderColorBorderColor0 extends js.Object {
  /**
...
object AnonBorderColorBorderColor0 {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBorderColorBorderColor0]
  }
}
