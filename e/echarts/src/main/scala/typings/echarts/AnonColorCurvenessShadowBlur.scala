...
trait AnonColorCurvenessShadowBlur extends js.Object {
  /**
...
object AnonColorCurvenessShadowBlur {
  @scala.inline
  def apply(
    color: String = null,
    ...
    __obj.asInstanceOf[AnonColorCurvenessShadowBlur]
  }
}
