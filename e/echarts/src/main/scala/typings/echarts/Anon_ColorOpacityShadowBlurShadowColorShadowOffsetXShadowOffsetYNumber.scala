...
object Anon_ColorOpacityShadowBlurShadowColorShadowOffsetXShadowOffsetYNumber {
  @scala.inline
  def apply(
    color: String = null,
  ...
  ): Anon_ColorOpacityShadowBlurShadowColorShadowOffsetXShadowOffsetYNumber = {
    ...
    __obj.asInstanceOf[Anon_ColorOpacityShadowBlurShadowColorShadowOffsetXShadowOffsetYNumber]
  }
}
