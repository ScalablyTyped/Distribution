...
trait AnonCoordLabelLineStyle extends js.Object {
  /**
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[AnonColorCurvenessEmphasisOpacityShadowBlur] = js.undefined
  /**
...
object AnonCoordLabelLineStyle {
  @scala.inline
  def apply(
    coord: js.Array[_] = null,
    label: AnonEmphasis = null,
    lineStyle: AnonColorCurvenessEmphasisOpacityShadowBlur = null,
    name: String = null,
    symbol: String = null,
    ...
    __obj.asInstanceOf[AnonCoordLabelLineStyle]
  }
}
