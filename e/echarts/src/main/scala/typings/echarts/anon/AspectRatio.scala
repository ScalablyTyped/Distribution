...
object AspectRatio {
  ...
  implicit open class MutableBuilder[Self <: AspectRatio] (val x: Self) extends AnyVal {
    ...
    inline def setMaxAspectRatio(value: Double): Self = StObject.set(x, "maxAspectRatio", value.asInstanceOf[js.Any])
    ...
    inline def setMinAspectRatio(value: Double): Self = StObject.set(x, "minAspectRatio", value.asInstanceOf[js.Any])
