...
@js.native
trait CurvenessEmphasis extends js.Object {
  /**
    * Line color.
    *
...
object CurvenessEmphasis {
  @scala.inline
  def apply(): CurvenessEmphasis = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CurvenessEmphasis]
  }
  @scala.inline
  implicit class CurvenessEmphasisOps[Self <: CurvenessEmphasis] (val x: Self) extends AnyVal {
    @scala.inline
