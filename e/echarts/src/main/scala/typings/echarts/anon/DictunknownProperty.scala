...
object DictunknownProperty {
  
  @scala.inline
  def apply(): DictunknownProperty = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DictunknownProperty]
  }
  
  @scala.inline
  implicit class DictunknownPropertyMutableBuilder[Self <: DictunknownProperty] (val x: Self) extends AnyVal {
