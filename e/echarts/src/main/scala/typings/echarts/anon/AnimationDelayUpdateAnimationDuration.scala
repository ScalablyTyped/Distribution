...
@js.native
trait AnimationDelayUpdateAnimationDuration extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[`14`] = js.native
  /**
...
object AnimationDelayUpdateAnimationDuration {
  @scala.inline
  def apply(): AnimationDelayUpdateAnimationDuration = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnimationDelayUpdateAnimationDuration]
  }
  @scala.inline
  implicit class AnimationDelayUpdateAnimationDurationOps[Self <: AnimationDelayUpdateAnimationDuration] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setData(value: `14`): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
