...
trait AnimationDelayUpdateAnimationDuration extends StObject {
...
object AnimationDelayUpdateAnimationDuration {
  ...
  inline def apply(): AnimationDelayUpdateAnimationDuration = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AnimationDelayUpdateAnimationDuration]
  }
  
  extension [Self <: AnimationDelayUpdateAnimationDuration](x: Self) {
