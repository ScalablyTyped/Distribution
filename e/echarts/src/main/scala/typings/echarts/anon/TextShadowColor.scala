...
trait TextShadowColor extends StObject {
...
object TextShadowColor {
  ...
  @scala.inline
  def apply(): TextShadowColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextShadowColor]
  }
  
  @scala.inline
  implicit class TextShadowColorMutableBuilder[Self <: TextShadowColor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOffset(value: js.Array[js.Any]): Self = StObject.set(x, "offset", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPosition(value: js.Array[js.Any] | String): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
