...
trait AnonBorderColorBorderTypeBorderWidthColor extends js.Object {
  /**
...
object AnonBorderColorBorderTypeBorderWidthColor {
  @scala.inline
  def apply(
  ...
  ): AnonBorderColorBorderTypeBorderWidthColor = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderTypeBorderWidthColor]
  }
}
