...
trait Anon01AnonLabel extends js.Object {
  /**
...
object Anon01AnonLabel {
  @scala.inline
  def apply(`0`: AnonLabel = null, `1`: AnonLabel = null): Anon01AnonLabel = {
    val __obj = js.Dynamic.literal()
    if (`0` != null) __obj.updateDynamic("0")(`0`.asInstanceOf[js.Any])
    if (`1` != null) __obj.updateDynamic("1")(`1`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon01AnonLabel]
  }
}
