...
trait AnonColorCurvenessOpacity extends js.Object {
  /**
    * Line color.
    *
...
object AnonColorCurvenessOpacity {
  @scala.inline
  def apply(
    color: String = null,
    ...
    __obj.asInstanceOf[AnonColorCurvenessOpacity]
  }
}
