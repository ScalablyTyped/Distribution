...
trait AnonColorCurvenessEmphasis extends js.Object {
  /**
    * Line color.
    *
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonColorCurvenessOpacity] = js.undefined
  /**
...
object AnonColorCurvenessEmphasis {
  @scala.inline
  def apply(
    color: String = null,
    curveness: Int | Double = null,
    emphasis: AnonColorCurvenessOpacity = null,
    ...
    __obj.asInstanceOf[AnonColorCurvenessEmphasis]
  }
}
