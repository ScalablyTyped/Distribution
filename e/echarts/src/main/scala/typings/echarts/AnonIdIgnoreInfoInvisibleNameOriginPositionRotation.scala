...
trait AnonIdIgnoreInfoInvisibleNameOriginPositionRotation extends js.Object {
  /**
...
object AnonIdIgnoreInfoInvisibleNameOriginPositionRotation {
  @scala.inline
  def apply(
    id: String = null,
    ...
    `type`: String = null,
    z2: Int | Double = null
  ): AnonIdIgnoreInfoInvisibleNameOriginPositionRotation = {
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisibleNameOriginPositionRotation]
  }
}
