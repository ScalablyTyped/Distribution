...
trait Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon_01AnonCoordLabelLineStyleName] = js.undefined
  /**
    * Mark line text.
    *
    *
...
object Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel {
  @scala.inline
  def apply(
    ...
    data: Anon_01AnonCoordLabelLineStyleName = null,
    ...
    __obj.asInstanceOf[Anon_AnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel]
  }
}
