...
trait AnonBackgroundColorBorderColorBorderRadiusBorderWidth extends js.Object {
  /**
...
object AnonBackgroundColorBorderColorBorderRadiusBorderWidth {
  @scala.inline
  def apply(
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonBackgroundColorBorderColorBorderRadiusBorderWidth = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderColorBorderRadiusBorderWidth]
  }
}
