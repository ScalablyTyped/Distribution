...
trait AnonBorderColorBorderTypeBorderWidthColorOpacityShadowBlur extends js.Object {
  /**
...
object AnonBorderColorBorderTypeBorderWidthColorOpacityShadowBlur {
  @scala.inline
  def apply(
    ...
    textStyle: AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorFontFamilyFontSizeFontStyleFontWeightHeight = null
  ): AnonBorderColorBorderTypeBorderWidthColorOpacityShadowBlur = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderTypeBorderWidthColorOpacityShadowBlur]
  }
}
