...
trait AnonBackgroundColorBorderColorBorderRadiusBorderWidthColor extends js.Object {
  /**
...
object AnonBackgroundColorBorderColorBorderRadiusBorderWidthColor {
  @scala.inline
  def apply(
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonBackgroundColorBorderColorBorderRadiusBorderWidthColor = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderColorBorderRadiusBorderWidthColor]
  }
}
