...
trait AnonIdIgnoreInfoInvisible extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonHeight] = js.undefined
  /**
...
object AnonIdIgnoreInfoInvisible {
  @scala.inline
  def apply(
    id: String = null,
    ...
    shape: AnonHeight = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    style: AnonFill = null,
    styleEmphasis: js.Object = null,
    `type`: String = null,
    z2: Int | Double = null
  ): AnonIdIgnoreInfoInvisible = {
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisible]
  }
}
