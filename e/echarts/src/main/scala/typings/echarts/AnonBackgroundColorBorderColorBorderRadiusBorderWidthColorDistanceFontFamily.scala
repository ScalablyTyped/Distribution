...
trait AnonBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily extends js.Object {
  /**
...
object AnonBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily {
  @scala.inline
  def apply(
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily]
  }
}
