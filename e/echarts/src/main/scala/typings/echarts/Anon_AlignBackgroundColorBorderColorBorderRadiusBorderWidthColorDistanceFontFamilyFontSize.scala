...
object Anon_AlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamilyFontSize {
  @scala.inline
  def apply(
    align: String = null,
  ...
  StringDictionary[Anon_Align] = null,
    ...
    __obj.asInstanceOf[Anon_AlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamilyFontSize]
  }
}
