...
trait AnonAlignBackgroundColorBorderColor extends js.Object {
  /**
...
object AnonAlignBackgroundColorBorderColor {
  @scala.inline
  def apply(
    align: String = null,
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonAlignBackgroundColorBorderColor = {
    ...
    __obj.asInstanceOf[AnonAlignBackgroundColorBorderColor]
  }
}
