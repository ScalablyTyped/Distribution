...
trait AnonItemStyleLabelNameValue extends js.Object {
  /**
    * Style of the item.
...
object AnonItemStyleLabelNameValue {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonItemStyleLabelNameValue]
  }
}
