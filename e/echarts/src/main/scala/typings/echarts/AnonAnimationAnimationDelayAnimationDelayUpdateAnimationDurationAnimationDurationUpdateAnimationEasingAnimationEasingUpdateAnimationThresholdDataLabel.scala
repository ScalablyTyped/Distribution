...
trait AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon01AnonCoordLabelLineStyleName] = js.undefined
  /**
    * Mark line text.
    *
    *
...
object AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel {
  @scala.inline
  def apply(
    ...
    data: Anon01AnonCoordLabelLineStyleName = null,
    ...
    __obj.asInstanceOf[AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdDataLabel]
  }
}
