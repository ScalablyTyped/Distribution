...
trait AnonColorCurvenessEmphasisOpacity extends js.Object {
  /**
    * Line color.
    *
...
object AnonColorCurvenessEmphasisOpacity {
  @scala.inline
  def apply(
    color: Color = null,
  ...
  ): AnonColorCurvenessEmphasisOpacity = {
    ...
    __obj.asInstanceOf[AnonColorCurvenessEmphasisOpacity]
  }
}
