...
trait AnonBarBorderColorBarBorderWidth extends js.Object {
  /**
...
object AnonBarBorderColorBarBorderWidth {
  @scala.inline
  def apply(
  ...
  ): AnonBarBorderColorBarBorderWidth = {
    ...
    __obj.asInstanceOf[AnonBarBorderColorBarBorderWidth]
  }
}
