...
trait AnonBorderColorBorderColorSaturation extends js.Object {
  /**
...
object AnonBorderColorBorderColorSaturation {
  @scala.inline
  def apply(
  ...
  ): AnonBorderColorBorderColorSaturation = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderColorSaturation]
  }
}
