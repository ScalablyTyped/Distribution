...
trait Anon_IdIgnore extends js.Object {
  /**
  ...
  /**
    ...
    */
  var style: js.UndefOr[Anon_FillHeight] = js.undefined
  /**
...
object Anon_IdIgnore {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Anon_IdIgnore]
  }
}
