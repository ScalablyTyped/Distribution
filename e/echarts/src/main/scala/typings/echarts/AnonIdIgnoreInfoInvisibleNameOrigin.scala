...
trait AnonIdIgnoreInfoInvisibleNameOrigin extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonCxCy] = js.undefined
  /**
...
object AnonIdIgnoreInfoInvisibleNameOrigin {
  @scala.inline
  def apply(
    id: String = null,
    ...
    `type`: String = null,
    z2: Int | Double = null
  ): AnonIdIgnoreInfoInvisibleNameOrigin = {
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisibleNameOrigin]
  }
}
