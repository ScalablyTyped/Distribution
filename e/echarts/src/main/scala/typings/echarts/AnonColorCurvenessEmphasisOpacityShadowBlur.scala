...
trait AnonColorCurvenessEmphasisOpacityShadowBlur extends js.Object {
  /**
    * Line color.
    *
...
object AnonColorCurvenessEmphasisOpacityShadowBlur {
  @scala.inline
  def apply(
    color: Color = null,
  ...
  ): AnonColorCurvenessEmphasisOpacityShadowBlur = {
    ...
    __obj.asInstanceOf[AnonColorCurvenessEmphasisOpacityShadowBlur]
  }
}
