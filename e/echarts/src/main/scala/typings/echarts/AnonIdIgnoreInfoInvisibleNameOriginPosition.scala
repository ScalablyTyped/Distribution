...
trait AnonIdIgnoreInfoInvisibleNameOriginPosition extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[AnonClockwise] = js.undefined
  /**
...
object AnonIdIgnoreInfoInvisibleNameOriginPosition {
  @scala.inline
  def apply(
    id: String = null,
    ...
    shape: AnonClockwise = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    style: AnonFill = null,
    styleEmphasis: js.Object = null,
    `type`: String = null,
    z2: Int | Double = null
  ): AnonIdIgnoreInfoInvisibleNameOriginPosition = {
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisibleNameOriginPosition]
  }
}
