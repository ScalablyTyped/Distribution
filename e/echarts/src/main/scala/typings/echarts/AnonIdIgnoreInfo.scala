...
trait AnonIdIgnoreInfo extends js.Object {
  /**
  ...
  /**
    ...
    */
  var style: js.UndefOr[AnonFillFont] = js.undefined
  /**
...
object AnonIdIgnoreInfo {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfo]
  }
}
