...
trait AnonBorderColorBorderTypeBorderWidth extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonBorderColorBorderType] = js.undefined
  /**
...
object AnonBorderColorBorderTypeBorderWidth {
  @scala.inline
  def apply(
    ...
    color: String = null,
    emphasis: AnonBorderColorBorderType = null,
    opacity: Int | Double = null,
    shadowBlur: Int | Double = null,
    shadowColor: String = null,
    shadowOffsetX: Int | Double = null,
    shadowOffsetY: Int | Double = null
  ): AnonBorderColorBorderTypeBorderWidth = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderTypeBorderWidth]
  }
}
