...
trait AnonCoordItemStyleLabelName extends js.Object {
  /**
...
object AnonCoordItemStyleLabelName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCoordItemStyleLabelName]
  }
}
