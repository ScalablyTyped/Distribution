...
trait AnonItemStyleLabelAnonAreaColor extends js.Object {
  /**
...
object AnonItemStyleLabelAnonAreaColor {
  @scala.inline
  def apply(
    itemStyle: AnonAreaColor = null,
    label: AnonBackgroundColorBorderColorBorderRadiusBorderWidthColorDistance = null
  ): AnonItemStyleLabelAnonAreaColor = {
    val __obj = js.Dynamic.literal()
    if (itemStyle != null) __obj.updateDynamic("itemStyle")(itemStyle.asInstanceOf[js.Any])
    if (label != null) __obj.updateDynamic("label")(label.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonItemStyleLabelAnonAreaColor]
  }
}
