...
trait Anon_IdIgnoreInfoInvisibleNameOriginPosition extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[Anon_Clockwise] = js.undefined
  /**
...
object Anon_IdIgnoreInfoInvisibleNameOriginPosition {
  @scala.inline
  def apply(
    id: String = null,
    ...
    shape: Anon_Clockwise = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    style: Anon_Fill = null,
    styleEmphasis: js.Object = null,
    `type`: String = null,
    z2: Int | Double = null
  ): Anon_IdIgnoreInfoInvisibleNameOriginPosition = {
    ...
    __obj.asInstanceOf[Anon_IdIgnoreInfoInvisibleNameOriginPosition]
  }
}
