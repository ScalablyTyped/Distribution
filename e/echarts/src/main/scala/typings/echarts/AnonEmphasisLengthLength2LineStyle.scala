...
trait AnonEmphasisLengthLength2LineStyle extends js.Object {
  /**
...
object AnonEmphasisLengthLength2LineStyle {
  @scala.inline
  def apply(
  ...
  ): AnonEmphasisLengthLength2LineStyle = {
    ...
    __obj.asInstanceOf[AnonEmphasisLengthLength2LineStyle]
  }
}
