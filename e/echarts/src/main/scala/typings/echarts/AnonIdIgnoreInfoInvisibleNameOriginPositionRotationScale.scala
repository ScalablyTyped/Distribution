...
trait AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale extends js.Object {
  /**
...
object AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale {
  @scala.inline
  def apply(
    id: String = null,
    ...
    `type`: String = null,
    z2: Int | Double = null
  ): AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale = {
    ...
    __obj.asInstanceOf[AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale]
  }
}
