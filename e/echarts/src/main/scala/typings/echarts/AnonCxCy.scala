...
trait AnonCxCy extends js.Object {
  /**
...
object AnonCxCy {
  @scala.inline
  def apply(cx: Int | Double = null, cy: Int | Double = null, r: Int | Double = null, r0: Int | Double = null): AnonCxCy = {
    val __obj = js.Dynamic.literal()
    if (cx != null) __obj.updateDynamic("cx")(cx.asInstanceOf[js.Any])
    if (cy != null) __obj.updateDynamic("cy")(cy.asInstanceOf[js.Any])
    if (r != null) __obj.updateDynamic("r")(r.asInstanceOf[js.Any])
    if (r0 != null) __obj.updateDynamic("r0")(r0.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonCxCy]
  }
}
