...
trait AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDuration extends js.Object {
  /**
...
object AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDuration {
  @scala.inline
  def apply(
  ...
  ): AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDuration = {
    ...
    __obj.asInstanceOf[AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDuration]
  }
}
