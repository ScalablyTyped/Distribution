...
trait AnonBackgroundColorExcludeComponents extends js.Object {
...
object AnonBackgroundColorExcludeComponents {
  @scala.inline
  def apply(
  ...
  ): AnonBackgroundColorExcludeComponents = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorExcludeComponents]
  }
}
