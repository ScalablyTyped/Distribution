...
trait AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThreshold extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[Anon01AnonCoordLabelLineStyle] = js.undefined
  /**
    * Mark line text.
    *
    *
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[AnonColorCurvenessEmphasisOpacity] = js.undefined
  /**
...
object AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThreshold {
  @scala.inline
  def apply(
    ...
    data: Anon01AnonCoordLabelLineStyle = null,
    label: AnonEmphasis = null,
    lineStyle: AnonColorCurvenessEmphasisOpacity = null,
    precision: Int | Double = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    symbol: js.Array[_] | String = null,
    symbolSize: js.Array[_] | Double = null
  ): AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThreshold = {
    ...
    __obj.asInstanceOf[AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThreshold]
  }
}
