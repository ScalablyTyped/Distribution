...
trait AnonBackgroundColorBorderColorBorderRadius extends js.Object {
  /**
...
object AnonBackgroundColorBorderColorBorderRadius {
  @scala.inline
  def apply(
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonBackgroundColorBorderColorBorderRadius = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderColorBorderRadius]
  }
}
