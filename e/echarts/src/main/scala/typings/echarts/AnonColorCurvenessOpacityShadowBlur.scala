...
trait AnonColorCurvenessOpacityShadowBlur extends js.Object {
  /**
...
object AnonColorCurvenessOpacityShadowBlur {
  @scala.inline
  def apply(
    color: String = null,
  ...
  ): AnonColorCurvenessOpacityShadowBlur = {
    ...
    __obj.asInstanceOf[AnonColorCurvenessOpacityShadowBlur]
  }
}
