...
trait AnonAnimationDelayUpdateAnimationDuration extends js.Object {
  /**
...
object AnonAnimationDelayUpdateAnimationDuration {
  @scala.inline
  def apply(
  ...
  ): AnonAnimationDelayUpdateAnimationDuration = {
    ...
    __obj.asInstanceOf[AnonAnimationDelayUpdateAnimationDuration]
  }
}
