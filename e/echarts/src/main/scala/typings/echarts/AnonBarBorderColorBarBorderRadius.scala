...
trait AnonBarBorderColorBarBorderRadius extends js.Object {
  /**
  ...
  /**
    ...
    */
  var emphasis: js.UndefOr[AnonBarBorderColorBarBorderWidth] = js.undefined
  /**
...
object AnonBarBorderColorBarBorderRadius {
  @scala.inline
  def apply(
    ...
    color: String = null,
    emphasis: AnonBarBorderColorBarBorderWidth = null,
    opacity: Int | Double = null,
    shadowBlur: Int | Double = null,
    shadowColor: String = null,
    shadowOffsetX: Int | Double = null,
    shadowOffsetY: Int | Double = null
  ): AnonBarBorderColorBarBorderRadius = {
    ...
    __obj.asInstanceOf[AnonBarBorderColorBarBorderRadius]
  }
}
