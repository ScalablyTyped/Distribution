...
import typings.echarts.echartsNs.EChartOptionNs.CalendarNs.DayLabel
import typings.echarts.echartsNs.EChartOptionNs.CalendarNs.MonthLabel
import typings.echarts.echartsNs.EChartOptionNs.CalendarNs.YearLabel
...
object Calendar {
  ...
  def apply(
    ...
    if (dayLabel != null) __obj.updateDynamic("dayLabel")(dayLabel)
    if (height != null) __obj.updateDynamic("height")(height.asInstanceOf[js.Any])
    if (id != null) __obj.updateDynamic("id")(id)
    if (itemStyle != null) __obj.updateDynamic("itemStyle")(itemStyle)
    if (left != null) __obj.updateDynamic("left")(left.asInstanceOf[js.Any])
    if (monthLabel != null) __obj.updateDynamic("monthLabel")(monthLabel)
    ...
    if (yearLabel != null) __obj.updateDynamic("yearLabel")(yearLabel)
