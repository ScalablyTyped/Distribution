...
import typings.echarts.echartsNs.EChartOptionNs.SeriesSankeyNs.DataObject
...
trait SeriesSankey extends Series {
  ...
  /**
    ...
    */
  var lineStyle: js.UndefOr[Anon_ColorCurvenessOpacityShadowBlurShadowColor] = js.undefined
  /**
...
object SeriesSankey {
  ...
  def apply(
    ...
    lineStyle: Anon_ColorCurvenessOpacityShadowBlurShadowColor = null,
