...
trait AxisPointer extends js.Object {
  ...
  var shadowStyle: js.UndefOr[Anon_ColorOpacityShadowBlurShadowColorShadowOffsetXShadowOffsetY] = js.undefined
...
object AxisPointer {
  ...
  def apply(
    ...
    shadowStyle: Anon_ColorOpacityShadowBlurShadowColorShadowOffsetXShadowOffsetY = null,
