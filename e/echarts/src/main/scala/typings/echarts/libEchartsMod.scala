...
import typings.echarts.echartsNs.ECharts
import typings.echarts.echartsNs.Graphic
import typings.echarts.echartsNs.MapObj
...
@JSImport("echarts/lib/echarts", JSImport.Namespace)
@js.native
object libEchartsMod extends js.Object {
  /**
  ...
  def init(dom: HTMLCanvasElement, theme: String, opts: Anon_DevicePixelRatio): ECharts = js.native
  def init(dom: HTMLCanvasElement, theme: js.Object): ECharts = js.native
  def init(dom: HTMLCanvasElement, theme: js.Object, opts: Anon_DevicePixelRatio): ECharts = js.native
  /**
  ...
  def init(dom: HTMLDivElement, theme: String, opts: Anon_DevicePixelRatio): ECharts = js.native
  def init(dom: HTMLDivElement, theme: js.Object): ECharts = js.native
  def init(dom: HTMLDivElement, theme: js.Object, opts: Anon_DevicePixelRatio): ECharts = js.native
  /**
