...
trait AnonBorderColorBorderType extends js.Object {
  /**
...
object AnonBorderColorBorderType {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBorderColorBorderType]
  }
}
