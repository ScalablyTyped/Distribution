...
trait AnonColorOpacityShadowBlur extends js.Object {
  /**
    * Line color.
    *
...
object AnonColorOpacityShadowBlur {
  @scala.inline
  def apply(
    color: String = null,
    ...
    __obj.asInstanceOf[AnonColorOpacityShadowBlur]
  }
}
