...
trait Anon_IdIgnoreInfoInvisibleNameOrigin extends js.Object {
  /**
  ...
  /**
    ...
    */
  var shape: js.UndefOr[Anon_CxCy] = js.undefined
  /**
...
object Anon_IdIgnoreInfoInvisibleNameOrigin {
  @scala.inline
  def apply(
    id: String = null,
    ...
    shape: Anon_CxCy = null,
    silent: js.UndefOr[Boolean] = js.undefined,
    style: Anon_Fill = null,
    styleEmphasis: js.Object = null,
    `type`: String = null,
    z2: Int | Double = null
  ): Anon_IdIgnoreInfoInvisibleNameOrigin = {
    ...
    __obj.asInstanceOf[Anon_IdIgnoreInfoInvisibleNameOrigin]
  }
}
