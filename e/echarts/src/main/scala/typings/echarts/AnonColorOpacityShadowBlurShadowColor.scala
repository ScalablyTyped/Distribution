...
trait AnonColorOpacityShadowBlurShadowColor extends js.Object {
  /**
...
object AnonColorOpacityShadowBlurShadowColor {
  @scala.inline
  def apply(
  ...
  ): AnonColorOpacityShadowBlurShadowColor = {
    ...
    __obj.asInstanceOf[AnonColorOpacityShadowBlurShadowColor]
  }
}
