...
trait AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdData extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[AnonCoordItemStyleLabel] = js.undefined
  /**
    * Mark point style.
    *
    *
...
object AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdData {
  @scala.inline
  def apply(
    ...
    data: AnonCoordItemStyleLabel = null,
    ...
    __obj.asInstanceOf[AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdateAnimationEasingAnimationEasingUpdateAnimationThresholdData]
  }
}
