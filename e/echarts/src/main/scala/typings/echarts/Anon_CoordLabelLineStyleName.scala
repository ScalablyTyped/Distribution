...
trait Anon_CoordLabelLineStyleName extends js.Object {
  /**
...
object Anon_CoordLabelLineStyleName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_CoordLabelLineStyleName]
  }
}
