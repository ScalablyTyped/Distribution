...
trait AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate extends js.Object {
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[AnonItemStyleLabelName] = js.undefined
  /**
    * Mark point style.
    *
    *
...
object AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate {
  @scala.inline
  def apply(
    ...
    data: AnonItemStyleLabelName = null,
    ...
    __obj.asInstanceOf[AnonAnimationAnimationDelayAnimationDelayUpdateAnimationDurationAnimationDurationUpdate]
  }
}
