...
trait Anon_BackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily extends js.Object {
  /**
...
object Anon_BackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily {
  @scala.inline
  def apply(
  ...
  StringDictionary[Anon_Align] = null,
  ...
  ): Anon_BackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily = {
    ...
    __obj.asInstanceOf[Anon_BackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceFontFamily]
  }
}
