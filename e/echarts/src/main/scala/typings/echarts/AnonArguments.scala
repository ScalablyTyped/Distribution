...
trait AnonArguments extends js.Object {
  ...
  /**
    ...
    */
  var return_arc: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPosition] = js.undefined
  /**
    ...
    */
  var return_bezierCurve: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScaleShape] = js.undefined
  /**
    * Circle element.
    *
    *
    ...
    */
  var return_circle: js.UndefOr[AnonIdIgnoreInfoInvisibleName] = js.undefined
  /**
  ...
  /**
    ...
    */
  var return_image: js.UndefOr[AnonIdIgnore] = js.undefined
  /**
    * Line element.
    *
    *
    ...
    */
  var return_line: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale] = js.undefined
  /**
    * Use
  ...
  /**
    ...
    */
  var return_polygon: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPositionRotation] = js.undefined
  /**
    * Polyline element.
    *
    *
    ...
    */
  var return_polyline: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPositionRotation] = js.undefined
  /**
    * Rectangle element.
    *
    *
    ...
    */
  var return_rect: js.UndefOr[AnonIdIgnoreInfoInvisible] = js.undefined
  /**
    * Ring element.
    *
    *
    ...
    */
  var return_ring: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOrigin] = js.undefined
  /**
    * Sector element.
    *
    *
    ...
    */
  var return_sector: js.UndefOr[AnonIdIgnoreInfoInvisibleNameOriginPosition] = js.undefined
  /**
    * Text block.
    *
    *
    ...
    */
  var return_text: js.UndefOr[AnonIdIgnoreInfo] = js.undefined
}
...
object AnonArguments {
  ...
  def apply(
    ...
    return_arc: AnonIdIgnoreInfoInvisibleNameOriginPosition = null,
    return_bezierCurve: AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScaleShape = null,
    return_circle: AnonIdIgnoreInfoInvisibleName = null,
    return_group: AnonChildren = null,
    return_image: AnonIdIgnore = null,
    return_line: AnonIdIgnoreInfoInvisibleNameOriginPositionRotationScale = null,
    return_path: AnonId = null,
    return_polygon: AnonIdIgnoreInfoInvisibleNameOriginPositionRotation = null,
    return_polyline: AnonIdIgnoreInfoInvisibleNameOriginPositionRotation = null,
    return_rect: AnonIdIgnoreInfoInvisible = null,
    return_ring: AnonIdIgnoreInfoInvisibleNameOrigin = null,
    return_sector: AnonIdIgnoreInfoInvisibleNameOriginPosition = null,
    return_text: AnonIdIgnoreInfo = null
  ): AnonArguments = {
