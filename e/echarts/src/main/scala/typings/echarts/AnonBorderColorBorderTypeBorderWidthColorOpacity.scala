...
trait AnonBorderColorBorderTypeBorderWidthColorOpacity
  extends /**
...
object AnonBorderColorBorderTypeBorderWidthColorOpacity {
  @scala.inline
  def apply(
    StringDictionary: /**
    * Some properties like "normal" or "emphasis" are not documented.
  ...
  /* unknownProperty */ StringDictionary[js.Any] = null,
  ...
  ): AnonBorderColorBorderTypeBorderWidthColorOpacity = {
    ...
    __obj.asInstanceOf[AnonBorderColorBorderTypeBorderWidthColorOpacity]
  }
}
