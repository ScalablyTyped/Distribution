...
trait AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsisFontFamily extends js.Object {
  /**
...
object AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsisFontFamily {
  @scala.inline
  def apply(
    align: String = null,
  ...
  StringDictionary[AnonAlign] = null,
    ...
    __obj.asInstanceOf[AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsisFontFamily]
  }
}
