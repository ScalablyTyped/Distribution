...
import typings.echarts.anon.Percent
...
/**
  ...
  */
@js.native
trait RenderItemReturnLine extends js.Object {
...
object RenderItemReturnLine {
  ...
  @scala.inline
  implicit class RenderItemReturnLineOps[Self <: RenderItemReturnLine] (val x: Self) extends AnyVal {
