...
import typings.echarts.anon.Points
...
/**
  ...
  */
@js.native
trait RenderItemReturnPolyline extends js.Object {
...
object RenderItemReturnPolyline {
  ...
  @scala.inline
  implicit class RenderItemReturnPolylineOps[Self <: RenderItemReturnPolyline] (val x: Self) extends AnyVal {
