...
/**
  ...
  */
@js.native
trait RenderItemReturnBezierCurve extends js.Object {
...
object RenderItemReturnBezierCurve {
  ...
  @scala.inline
  implicit class RenderItemReturnBezierCurveOps[Self <: RenderItemReturnBezierCurve] (val x: Self) extends AnyVal {
