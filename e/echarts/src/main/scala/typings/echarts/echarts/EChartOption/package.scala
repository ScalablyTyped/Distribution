...
package object EChartOption {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.echarts.echarts.EChartOption.LinearGradient
    - typings.echarts.echarts.EChartOption.RadialGradient
    - typings.echarts.echarts.EChartOption.Texture
  */
  type Color = typings.echarts.echarts.EChartOption._Color | java.lang.String
  
  type ColorStops = js.Array[typings.echarts.anon.Offset]
