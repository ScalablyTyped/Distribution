...
/**
  ...
  */
@js.native
trait RenderItemReturnRect extends js.Object {
...
object RenderItemReturnRect {
  ...
  @scala.inline
  implicit class RenderItemReturnRectOps[Self <: RenderItemReturnRect] (val x: Self) extends AnyVal {
