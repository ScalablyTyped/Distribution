...
/**
  ...
  */
@js.native
trait RenderItemReturnPath extends js.Object {
...
object RenderItemReturnPath {
  ...
  @scala.inline
  implicit class RenderItemReturnPathOps[Self <: RenderItemReturnPath] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setShape(value: D): Self = this.set("shape", value.asInstanceOf[js.Any])
