...
/**
  ...
  */
@js.native
trait RenderItemReturnImage extends js.Object {
...
object RenderItemReturnImage {
  ...
  @scala.inline
  implicit class RenderItemReturnImageOps[Self <: RenderItemReturnImage] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStyle(value: Height): Self = this.set("style", value.asInstanceOf[js.Any])
