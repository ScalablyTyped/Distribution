...
trait AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsis extends js.Object {
  /**
...
object AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsis {
  @scala.inline
  def apply(
    align: String = null,
  ...
  StringDictionary[AnonAlign] = null,
  ...
  ): AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsis = {
    ...
    __obj.asInstanceOf[AnonAlignBackgroundColorBorderColorBorderRadiusBorderWidthColorDistanceEllipsis]
  }
}
