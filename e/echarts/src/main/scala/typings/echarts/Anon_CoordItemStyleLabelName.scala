...
trait Anon_CoordItemStyleLabelName extends js.Object {
  /**
...
object Anon_CoordItemStyleLabelName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_CoordItemStyleLabelName]
  }
}
