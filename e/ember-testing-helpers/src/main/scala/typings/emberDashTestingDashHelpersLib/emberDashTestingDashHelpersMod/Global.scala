...
object Global extends js.Object {
  ...
  def fillIn(selector: java.lang.String, context: js.Object, text: java.lang.String): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  ...
  def keyEvent(
    ...
    `type`: emberDashTestingDashHelpersLib.KeyEventType,
    keyCode: scala.Double
  ): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  ...
  def triggerEvent(selector: java.lang.String, context: js.Object, `type`: java.lang.String): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  // https://github.com/emberjs/ember.js/blob/master/packages/ember-testing/lib/helpers/trigger_event.js
  def triggerEvent(selector: java.lang.String, context: js.Object, `type`: java.lang.String, options: js.Object): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  def triggerEvent(selector: java.lang.String, `type`: java.lang.String): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  def triggerEvent(selector: java.lang.String, `type`: java.lang.String, options: js.Object): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  // https://github.com/emberjs/ember.js/blob/master/packages/ember-testing/lib/helpers/visit.js
  def visit[T](route: java.lang.String): emberDashTestingDashHelpersLib.WaitResult[scala.Unit] = js.native
  // https://github.com/emberjs/ember.js/blob/master/packages/ember-testing/lib/helpers/wait.js
  def wait[T](value: T): emberDashTestingDashHelpersLib.WaitResult[T] = js.native
}
