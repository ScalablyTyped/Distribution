...
import typings.expoConfigPlugins.iosUpdatesMod.ShellScriptBuildPhase
import typings.expoConfigPlugins.localesMod.ExpoConfigLocales
import typings.expoConfigPlugins.localesMod.LocaleJson
import typings.expoConfigPlugins.localesMod.ResolvedLocalesJson
import typings.expoConfigPlugins.pluginTypesMod.ConfigPlugin
import typings.expoConfigPlugins.pluginTypesMod.ModProps
import typings.expoConfigPlugins.provisioningProfileMod.ProvisioningProfileSettings
import typings.expoConfigPlugins.targetMod.TargetType
import typings.expoConfigPlugins.utilsUpdatesMod.ExpoConfigUpdates
import typings.expoConfigPlugins.xcodeprojMod.ConfigurationListEntry
import typings.expoConfigPlugins.xcodeprojMod.ConfigurationSectionEntry
import typings.expoConfigPlugins.xcodeprojMod.NativeTargetSectionEntry
import typings.expoConfigPlugins.xcodeprojMod.ProjectSectionEntry
...
object iosMod {
  ...
  object Bitcode {
    ...
    inline def getBitcode(config: PickExpoConfigios): typings.expoConfigPlugins.bitcodeMod.Bitcode = ^.asInstanceOf[js.Dynamic].applyDynamic("getBitcode")(config.asInstanceOf[js.Any]).asInstanceOf[typings.expoConfigPlugins.bitcodeMod.Bitcode]
    
    inline def setBitcode(bitcode: typings.expoConfigPlugins.bitcodeMod.Bitcode, hasProject: ProjectAny): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setBitcode")(bitcode.asInstanceOf[js.Any], hasProject.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    @js.native
    val withCustomBitcode: ConfigPlugin[typings.expoConfigPlugins.bitcodeMod.Bitcode] = js.native
  }
  ...
  object Swift {
    ...
    inline def createBridgingHeaderFile(hasProjectRootProjectNameProjectBridgingHeader: ProjectName): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createBridgingHeaderFile")(hasProjectRootProjectNameProjectBridgingHeader.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    inline def getDesignatedSwiftBridgingHeaderFileReference(hasProject: ProjectAny): String | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("getDesignatedSwiftBridgingHeaderFileReference")(hasProject.asInstanceOf[js.Any]).asInstanceOf[String | Null]
    
    inline def linkBridgingHeaderFile(hasProjectBridgingHeader: BridgingHeader): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("linkBridgingHeaderFile")(hasProjectBridgingHeader.asInstanceOf[js.Any]).asInstanceOf[Any]
  ...
  object Target {
    ...
    object TargetType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typings.expoConfigPlugins.targetMod.TargetType & String] = js.native
    ...
    inline def findApplicationTargetWithDependenciesAsync(projectRoot: String, scheme: String): js.Promise[typings.expoConfigPlugins.targetMod.Target] = (^.asInstanceOf[js.Dynamic].applyDynamic("findApplicationTargetWithDependenciesAsync")(projectRoot.asInstanceOf[js.Any], scheme.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typings.expoConfigPlugins.targetMod.Target]]
  ...
  object Updates {
    ...
    object Config extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typings.expoConfigPlugins.iosUpdatesMod.Config & String] = js.native
  ...
  object XcodeUtils {
    ...
    inline def addBuildSourceFileToGroup(hasFilepathGroupNameProjectVerboseTargetUuid: GroupName): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addBuildSourceFileToGroup")(hasFilepathGroupNameProjectVerboseTargetUuid.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    inline def addResourceFileToGroup(hasFilepathGroupNameIsBuildFileProjectVerboseTargetUuid: Filepath): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addResourceFileToGroup")(hasFilepathGroupNameIsBuildFileProjectVerboseTargetUuid.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    inline def getApplicationNativeTarget(hasProjectProjectName: Project): Target = ^.asInstanceOf[js.Dynamic].applyDynamic("getApplicationNativeTarget")(hasProjectProjectName.asInstanceOf[js.Any]).asInstanceOf[Target]
