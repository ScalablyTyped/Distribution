...
object pluginResolverMod {
  ...
  inline def resolveConfigPluginExport(hasPluginPluginFilePluginReferenceIsPluginFile: PluginReference): ConfigPlugin[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveConfigPluginExport")(hasPluginPluginFilePluginReferenceIsPluginFile.asInstanceOf[js.Any]).asInstanceOf[ConfigPlugin[Any]]
