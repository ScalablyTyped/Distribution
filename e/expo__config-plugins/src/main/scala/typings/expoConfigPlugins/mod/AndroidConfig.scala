...
import typings.expoConfigPlugins.intentFiltersMod.AndroidIntentFilters
import typings.expoConfigPlugins.manifestMod.AndroidManifest
import typings.expoConfigPlugins.manifestMod.ManifestActivity
...
import typings.expoConfigPlugins.resourcesMod.ResourceGroupXML
...
object AndroidConfig {
  ...
  object Updates {
    ...
    object Config extends StObject {
      ...
      @JSBracketAccess
      def apply(value: String): js.UndefOr[typings.expoConfigPlugins.updatesMod.Config & String] = js.native
