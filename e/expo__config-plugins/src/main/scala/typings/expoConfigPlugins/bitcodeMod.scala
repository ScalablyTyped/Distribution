...
object bitcodeMod {
  ...
  inline def setBitcode(bitcode: Bitcode, hasProject: ProjectAny): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setBitcode")(bitcode.asInstanceOf[js.Any], hasProject.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  inline def setBitcodeWithConfig(config: PickExpoConfigios, hasProject: ProjectAny): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setBitcodeWithConfig")(config.asInstanceOf[js.Any], hasProject.asInstanceOf[js.Any])).asInstanceOf[Any]
