...
object deviceFamilyMod {
  ...
  inline def setDeviceFamily(config: PickExpoConfigios, hasProject: ProjectAny): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("setDeviceFamily")(config.asInstanceOf[js.Any], hasProject.asInstanceOf[js.Any])).asInstanceOf[Any]
