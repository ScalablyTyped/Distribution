...
import typings.expoConfigPlugins.xcodeprojMod.NativeTargetSectionEntry
...
object targetMod {
  ...
  object TargetType extends StObject {
    ...
    sealed trait APPLICATION
      extends StObject
         with TargetType
    /* "com.apple.product-type.application" */ val APPLICATION: typings.expoConfigPlugins.targetMod.TargetType.APPLICATION & String = js.native
    
    @js.native
    sealed trait APP_CLIP
      extends StObject
         with TargetType
    /* "com.apple.product-type.application.on-demand-install-capable" */ val APP_CLIP: typings.expoConfigPlugins.targetMod.TargetType.APP_CLIP & String = js.native
    
    @js.native
    sealed trait EXTENSION
      extends StObject
         with TargetType
    /* "com.apple.product-type.app-extension" */ val EXTENSION: typings.expoConfigPlugins.targetMod.TargetType.EXTENSION & String = js.native
    
    @js.native
    sealed trait OTHER
      extends StObject
         with TargetType
    /* "other" */ val OTHER: typings.expoConfigPlugins.targetMod.TargetType.OTHER & String = js.native
    
    @js.native
    sealed trait STICKER_PACK_EXTENSION
      extends StObject
         with TargetType
    /* "com.apple.product-type.app-extension.messages-sticker-pack" */ val STICKER_PACK_EXTENSION: typings.expoConfigPlugins.targetMod.TargetType.STICKER_PACK_EXTENSION & String = js.native
    
    @js.native
    sealed trait WATCH
      extends StObject
         with TargetType
    /* "com.apple.product-type.application.watchapp" */ val WATCH: typings.expoConfigPlugins.targetMod.TargetType.WATCH & String = js.native
  }
