...
name := "expo-font"
version := "11.0.1-06cc82"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "csstype" % "3.1.1-f779a1",
  "org.scalablytyped" %%% "expo-asset" % "8.6.2-15f089",
  "org.scalablytyped" %%% "expo-constants" % "14.0.2-e97733",
  "org.scalablytyped" %%% "expo-modules-core" % "1.0.2-2e7be1",
  "org.scalablytyped" %%% "expo__config-types" % "47.0.0-be915c",
