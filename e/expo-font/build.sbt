...
name := "expo-font"
version := "10.2.1-57cd38"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "csstype" % "3.1.1-0912f8",
  "org.scalablytyped" %%% "expo-asset" % "8.6.1-54d79d",
  "org.scalablytyped" %%% "expo-constants" % "13.2.4-adbbf5",
  "org.scalablytyped" %%% "expo-modules-core" % "0.11.5-035841",
  "org.scalablytyped" %%% "expo__config-types" % "46.0.2-4d2765",
