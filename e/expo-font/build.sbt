...
name := "expo-font"
version := "11.0.1-7de70e"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "csstype" % "3.1.1-4db30e",
  "org.scalablytyped" %%% "expo-asset" % "8.6.2-68abdd",
  "org.scalablytyped" %%% "expo-constants" % "14.0.2-e6959c",
  "org.scalablytyped" %%% "expo-modules-core" % "1.0.3-8a16ef",
  "org.scalablytyped" %%% "expo__config-types" % "47.0.0-29fa96",
