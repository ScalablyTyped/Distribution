...
name := "expo-font"
version := "11.0.1-104237"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "csstype" % "3.1.1-9b270c",
  "org.scalablytyped" %%% "expo-asset" % "8.6.2-7b1dc1",
  "org.scalablytyped" %%% "expo-constants" % "14.0.2-ecb9f5",
  "org.scalablytyped" %%% "expo-modules-core" % "1.0.3-64d452",
  "org.scalablytyped" %%% "expo__config-types" % "47.0.0-9b2e55",
