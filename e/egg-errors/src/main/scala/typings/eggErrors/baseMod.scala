...
object baseMod {
  ...
  @js.native
  open class default[T /* <: typings.eggErrors.errorOptionsMod.default */] ()
    extends StObject
       with BaseError[T] {
    ...
    inline def from[S /* <: Instantiable1[
        ...
        InstanceType[
          TypeofBaseError & (Instantiable1[
            ...
            BaseError[typings.eggErrors.errorOptionsMod.default]
          ])
        ]
  ...
  trait BaseError[T /* <: typings.eggErrors.errorOptionsMod.default */]
    extends StObject
       with Error
  ...
  object BaseError {
    ...
    inline def apply[T /* <: typings.eggErrors.errorOptionsMod.default */](code: String, message: String, name: String): BaseError[T] = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[BaseError[T]]
    }
    
    extension [Self <: BaseError[?], T /* <: typings.eggErrors.errorOptionsMod.default */](x: Self & BaseError[T]) {
