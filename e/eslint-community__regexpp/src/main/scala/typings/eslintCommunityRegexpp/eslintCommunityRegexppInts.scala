...
object eslintCommunityRegexppInts {
  ...
  sealed trait `2016`
    extends StObject
       with EcmaVersion
  inline def `2016`: `2016` = 2016.asInstanceOf[`2016`]
  
  @js.native
  sealed trait `2017`
    extends StObject
       with EcmaVersion
  inline def `2017`: `2017` = 2017.asInstanceOf[`2017`]
  
  @js.native
  sealed trait `2018`
    extends StObject
       with EcmaVersion
  inline def `2018`: `2018` = 2018.asInstanceOf[`2018`]
  
  @js.native
  sealed trait `2019`
    extends StObject
       with EcmaVersion
  inline def `2019`: `2019` = 2019.asInstanceOf[`2019`]
