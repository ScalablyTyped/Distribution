...
import typings.eslintCommunityRegexpp.astMod.Alternative
import typings.eslintCommunityRegexpp.astMod.Assertion
import typings.eslintCommunityRegexpp.astMod.Backreference
import typings.eslintCommunityRegexpp.astMod.CapturingGroup
import typings.eslintCommunityRegexpp.astMod.Character
import typings.eslintCommunityRegexpp.astMod.CharacterClass
import typings.eslintCommunityRegexpp.astMod.CharacterClassRange
import typings.eslintCommunityRegexpp.astMod.CharacterSet
import typings.eslintCommunityRegexpp.astMod.Flags
import typings.eslintCommunityRegexpp.astMod.Group
import typings.eslintCommunityRegexpp.astMod.Node
import typings.eslintCommunityRegexpp.astMod.Pattern
import typings.eslintCommunityRegexpp.astMod.Quantifier
...
object visitorMod {
  ...
  @JSImport("@eslint-community/regexpp/visitor", "RegExpVisitor")
  @js.native
