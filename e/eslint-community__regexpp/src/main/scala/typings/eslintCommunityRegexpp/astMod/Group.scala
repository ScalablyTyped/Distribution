...
trait Group
  ...
  @JSName("type")
  var type_Group: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Group
}
object Group {
  ...
  implicit open class MutableBuilder[Self <: Group] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Group): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
