...
trait RegExpLiteral
  ...
  @JSName("type")
  var type_RegExpLiteral: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.RegExpLiteral
}
object RegExpLiteral {
  ...
  implicit open class MutableBuilder[Self <: RegExpLiteral] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.RegExpLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
