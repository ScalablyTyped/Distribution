...
trait Flags
  ...
  @JSName("type")
  var type_Flags: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Flags
...
object Flags {
  ...
  implicit open class MutableBuilder[Self <: Flags] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Flags): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
