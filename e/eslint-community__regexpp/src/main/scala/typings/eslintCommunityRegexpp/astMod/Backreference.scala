...
trait Backreference
  ...
  @JSName("type")
  var type_Backreference: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Backreference
}
object Backreference {
  ...
  implicit open class MutableBuilder[Self <: Backreference] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Backreference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
