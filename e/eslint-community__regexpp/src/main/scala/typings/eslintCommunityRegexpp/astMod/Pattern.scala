...
trait Pattern
  ...
  @JSName("type")
  var type_Pattern: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Pattern
}
object Pattern {
  ...
  implicit open class MutableBuilder[Self <: Pattern] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.Pattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
