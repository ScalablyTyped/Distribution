...
trait CharacterClass
  ...
  @JSName("type")
  var type_CharacterClass: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.CharacterClass
}
object CharacterClass {
  ...
  implicit open class MutableBuilder[Self <: CharacterClass] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.CharacterClass): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
