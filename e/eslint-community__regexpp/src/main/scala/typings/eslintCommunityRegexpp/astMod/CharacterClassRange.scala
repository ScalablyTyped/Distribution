...
trait CharacterClassRange
  ...
  @JSName("type")
  var type_CharacterClassRange: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.CharacterClassRange
}
object CharacterClassRange {
  ...
  implicit open class MutableBuilder[Self <: CharacterClassRange] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.CharacterClassRange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
