...
trait UnicodePropertyCharacterSet
  ...
  @JSName("parent")
  var parent_UnicodePropertyCharacterSet: Alternative | CharacterClass | Quantifier
  
  @JSName("type")
  var type_UnicodePropertyCharacterSet: typings.eslintCommunityRegexpp.eslintCommunityRegexppStrings.CharacterSet
