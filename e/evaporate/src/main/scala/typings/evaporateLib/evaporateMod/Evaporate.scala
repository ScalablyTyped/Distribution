...
trait Evaporate extends js.Object {
  ...
  def add(config: AddConfig): js.Promise[java.lang.String] = js.native
  def add(config: AddConfig, options: AddOverrideOptions): js.Promise[java.lang.String] = js.native
