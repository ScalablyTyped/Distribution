...
object mod {
  ...
  inline def parse(source: String): js.Tuple2[js.Array[ImportSpecifier], js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(source.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[js.Array[ImportSpecifier], js.Array[String]]]
  inline def parse(source: String, name: String): js.Tuple2[js.Array[ImportSpecifier], js.Array[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(source.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[js.Array[ImportSpecifier], js.Array[String]]]
  ...
  object ImportSpecifier {
    ...
    inline def apply(d: Double, e: Double, s: Double, se: Double, ss: Double): ImportSpecifier = {
