...
object emptyDashDirMod extends js.Object {
  def apply(dir: java.lang.String): js.Promise[scala.Boolean] = js.native
  def apply(
    dir: java.lang.String,
    cb: js.Function2[/* err */ nodeLib.NodeJSNs.ErrnoException, /* isEmpty */ scala.Boolean, scala.Unit]
  ): scala.Unit = js.native
  def apply(dir: java.lang.String, filter: js.Function1[/* path */ java.lang.String, scala.Boolean]): js.Promise[scala.Boolean] = js.native
  def apply(
    dir: java.lang.String,
