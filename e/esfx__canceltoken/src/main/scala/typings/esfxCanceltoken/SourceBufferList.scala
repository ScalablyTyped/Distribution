...
import typings.esfxCanceltoken.esfxCanceltokenStrings.addsourcebuffer
import typings.esfxCanceltoken.esfxCanceltokenStrings.removesourcebuffer
...
@js.native
trait SourceBufferList extends StObject {
