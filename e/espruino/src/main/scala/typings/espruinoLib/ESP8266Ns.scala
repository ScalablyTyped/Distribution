...
@JSGlobal("ESP8266")
@js.native
object ESP8266Ns extends js.Object {
  /**
    * 
    * @param arrayOfData 
    * @return  
  ...
  /**
    ...
    */
  def deepSleep(micros: js.Any, option: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def dumpSocketInfo(): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def logDebug(enable: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def neopixelWrite(pin: espruinoLib.Pin, arrayOfData: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setCPUFreq(freq: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def setLog(mode: scala.Double): scala.Unit = js.native
}
