...
object ^ extends js.Object {
  /**
    ...
    */
  def capSense(tx: espruinoLib.Pin, rx: espruinoLib.Pin): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def light(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def magOff(): scala.Unit = js.native
  /**
    ...
    */
  def magTemp(): scala.Double = js.native
  /**
