...
org.scalablytyped.runtime.Instantiable1[/* value */ js.Any, js.Any] {
  ...
  /**
    ...
    */
  def mode(mode: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def write(value: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def writeAtTime(value: scala.Boolean, time: scala.Double): scala.Unit = js.native
}
