...
@JSGlobal("E")
@js.native
object ENsMembers extends js.Object {
  /**
       ...
       */
  def clip(x: scala.Double, min: scala.Double, max: scala.Double): scala.Double = js.native
  /**
       ...
       */
  def convolve(arr1: js.Any, arr2: js.Any, offset: scala.Double): scala.Double = js.native
  /**
       ...
       */
  def dumpLockedVars(): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def getAnalogVRef(): scala.Double = js.native
  /**
  ...
  /**
       ...
       */
  def getTemperature(): scala.Double = js.native
  /**
       ...
       */
  def hwRand(): scala.Double = js.native
  /**
       ...
       */
  def interpolate(array: js.Any, index: scala.Double): scala.Double = js.native
  /**
       ...
       */
  def interpolate2d(array: js.Any, width: scala.Double, x: scala.Double, y: scala.Double): scala.Double = js.native
  /**
       ...
       */
  def kickWatchdog(): scala.Unit = js.native
  /**
       ...
       */
  def lockConsole(): scala.Unit = js.native
  /**
       ...
       */
  def mapInPlace(from: js.Any, to: js.Any, map: js.Any, bits: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def memoryArea(addr: scala.Double, len: scala.Double): java.lang.String = js.native
  /**
       ...
       */
  def nativeCall(addr: scala.Double, sig: js.Any, data: js.Any): js.Any = js.native
  /**
       * <p>Open a file</p>
       * 
       * @param path 
       ...
       */
  def openFile(path: js.Any, mode: js.Any): espruinoLib.File = js.native
  /**
       ...
       */
  def reverseByte(x: scala.Double): scala.Double = js.native
  /**
       * 
       * @param data 
       * @return  
       ...
       */
  def sendUSBHID(data: js.Any): scala.Boolean = js.native
  /**
       ...
       */
  def setBootCode(code: js.Any, alwaysExec: scala.Boolean): scala.Unit = js.native
  /**
       ...
       */
  def setClock(options: js.Any): scala.Double = js.native
  /**
       ...
       */
  def setFlags(flags: js.Any): scala.Unit = js.native
  /**
       ...
       */
  def setPassword(password: js.Any): scala.Unit = js.native
  /**
       ...
       */
  def setTimeZone(zone: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def setUSBHID(opts: js.Any): scala.Unit = js.native
  /**
       ...
       */
  def srand(v: scala.Double): scala.Unit = js.native
  /**
       ...
       */
  def sum(arr: js.Any): scala.Double = js.native
  /**
       ...
       */
  def toArrayBuffer(str: js.Any): stdLib.ArrayBuffer = js.native
  /**
       ...
       */
  def toUint8Array(args: js.Any): stdLib.Uint8Array = js.native
  /**
       ...
       */
  def unmountSD(): scala.Unit = js.native
  /**
       ...
       */
  def variance(arr: js.Any, mean: scala.Double): scala.Double = js.native
}
