...
object fsNs extends js.Object {
  /**
       ...
       */
  def appendFile(path: js.Any, data: js.Any): scala.Boolean = js.native
  /**
       * <p>Append the data to the given file, created a new file if it doesn&#39;t exist</p>
       * 
       * @param path 
       ...
       */
  def appendFileSync(path: js.Any, data: js.Any): scala.Boolean = js.native
  /**
       ...
       */
  def mkdir(path: js.Any): scala.Boolean = js.native
  /**
       * <p>Create the directory</p>
       * 
       * @param path 
       ...
       */
  def mkdirSync(path: js.Any): scala.Boolean = js.native
  /**
       * 
       * @param source 
       * @param destination 
       ...
       */
  def pipe(source: js.Any, destination: js.Any, options: js.Any): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def unlink(path: js.Any): scala.Boolean = js.native
  /**
       * <p>Delete the given file</p>
       * 
       * @param path 
       ...
       */
  def unlinkSync(path: js.Any): scala.Boolean = js.native
  /**
       ...
       */
  def writeFile(path: js.Any, data: js.Any): scala.Boolean = js.native
  /**
       * <p>Write the data to the given file</p>
       * 
       * @param path 
       ...
       */
  def writeFileSync(path: js.Any, data: js.Any): scala.Boolean = js.native
}
