...
object NRFNs extends js.Object {
  ...
  /**
    ...
    */
  def getBattery(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def sendHIDReport(data: js.Any, callback: js.Any): scala.Unit = js.native
  /**
    ...
    */
  def setLowPowerConnection(lowPower: scala.Boolean): scala.Unit = js.native
  /**
    ...
    */
  def setTxPower(power: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def setWhitelist(whitelisting: scala.Boolean): scala.Unit = js.native
  /**
