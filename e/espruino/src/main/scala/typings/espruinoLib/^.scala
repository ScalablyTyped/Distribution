...
object ^ extends js.Object {
  ...
  */
  def acceleration(): js.Any = js.native
  /**
  ...
  */
  def atob(binaryData: js.Any): js.Any = js.native
  /**
  ...
  */
  def btoa(binaryData: js.Any): js.Any = js.native
  /**
  ...
  */
  def changeInterval(id: js.Any, time: scala.Double): scala.Unit = js.native
  /**
  ...
  */
  def clearWatch(id: js.Any): scala.Unit = js.native
  /**
  * <p><strong>Note:</strong> This function is only available on the <a href="/MicroBit">BBC micro:bit</a> board</p>
  ...
  */
  def decodeURIComponent(str: js.Any): js.Any = js.native
  /**
  ...
  */
  def edit(funcName: js.Any): scala.Unit = js.native
  /**
  ...
  */
  def encodeURIComponent(str: js.Any): js.Any = js.native
  /**
  ...
  */
  def eval(code: js.Any): js.Any = js.native
  /**
  ...
  */
  def getSerial(): js.Any = js.native
  /**
  ...
  */
  def hashlib(): scala.Unit = js.native
  /**
  ...
  */
  def neopixel(): scala.Unit = js.native
  /**
  ...
  */
  def parseFloat(string: js.Any): scala.Double = js.native
  /**
  ...
  */
  def parseInt(string: js.Any, radix: js.Any): js.Any = js.native
  /**
  ...
  */
  def peek16(addr: scala.Double, count: scala.Double): js.Any = js.native
  /**
  ...
  */
  def peek32(addr: scala.Double, count: scala.Double): js.Any = js.native
  /**
  ...
  */
  def peek8(addr: scala.Double, count: scala.Double): js.Any = js.native
  /**
  ...
  */
  def poke16(addr: scala.Double, value: js.Any): scala.Unit = js.native
  /**
  ...
  */
  def poke32(addr: scala.Double, value: js.Any): scala.Unit = js.native
  /**
  ...
  */
  def poke8(addr: scala.Double, value: js.Any): scala.Unit = js.native
  /**
  ...
  */
  def print(text: js.Any): scala.Unit = js.native
  /**
  ...
  */
  def reset(clearFlash: scala.Boolean): scala.Unit = js.native
  /**
  ...
  */
  def setDeepSleep(sleep: scala.Boolean): scala.Unit = js.native
  /**
  ...
  */
  def trace(root: js.Any): scala.Unit = js.native
  /**
