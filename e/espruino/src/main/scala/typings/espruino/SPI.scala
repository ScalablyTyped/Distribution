...
Instantiable0[SPI] {
  ...
  /**
    ...
    */
  def send4bit(data: js.Any, bit0: Double, bit1: Double, nss_pin: Pin): Unit = js.native
  /**
    ...
    */
  def send8bit(data: js.Any, bit0: Double, bit1: Double, nss_pin: Pin): Unit = js.native
  /**
    ...
    */
  def setup(options: js.Any): Unit = js.native
  /**
