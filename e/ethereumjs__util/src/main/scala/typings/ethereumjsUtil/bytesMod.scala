...
object bytesMod {
  ...
  */
  ...
  object _ToBufferInputTypes {
    ...
    inline def TransformableToArray(toArray: () => js.typedarray.Uint8Array): typings.ethereumjsUtil.typesMod.TransformableToArray = {
      val __obj = js.Dynamic.literal(toArray = js.Any.fromFunction0(toArray))
      __obj.asInstanceOf[typings.ethereumjsUtil.typesMod.TransformableToArray]
    }
    
    inline def TransformableToBuffer(toBuffer: () => Buffer): typings.ethereumjsUtil.typesMod.TransformableToBuffer = {
      val __obj = js.Dynamic.literal(toBuffer = js.Any.fromFunction0(toBuffer))
      __obj.asInstanceOf[typings.ethereumjsUtil.typesMod.TransformableToBuffer]
    }
  }
}
