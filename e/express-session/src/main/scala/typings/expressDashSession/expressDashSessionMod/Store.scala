...
abstract class Store () extends EventEmitter {
  ...
  def createSession(req: Request[ParamsDictionary], sess: SessionData): Unit = js.native
  ...
  def regenerate(req: Request[ParamsDictionary], fn: js.Function1[/* err */ js.UndefOr[js.Any], _]): Unit = js.native
