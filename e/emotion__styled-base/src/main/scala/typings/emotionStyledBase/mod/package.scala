...
package object mod {
  ...
  type CreateStyledComponentIntrinsic[Tag /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 */ js.Any */, ExtraProps, Theme /* <: js.Object */] = typings.emotionStyledBase.mod.CreateStyledComponentBase[
