...
object MaterialIcons
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIcons] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIcons].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIcons] = {
