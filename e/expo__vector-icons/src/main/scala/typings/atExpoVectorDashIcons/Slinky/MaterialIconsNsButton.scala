...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.Button
...
object MaterialIconsNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.Button].asInstanceOf[String | js.Object]
  def apply(
