...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.TabBarItem
...
object SimpleLineIconsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
