...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.TabBarItem
...
object FeatherNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
