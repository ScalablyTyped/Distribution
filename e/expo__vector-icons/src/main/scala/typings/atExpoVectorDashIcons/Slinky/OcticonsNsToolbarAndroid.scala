...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.ToolbarAndroid
import typings.reactDashNativeDashVectorDashIcons.iconMod.ToolbarAndroidProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object OcticonsNsToolbarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, ToolbarAndroid] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.ToolbarAndroid].asInstanceOf[String | js.Object]
  def apply(
    iconColor: String,
    iconSize: Double,
    logoName: String,
