...
object FontAwesome
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesome] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesome].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesome] = {
