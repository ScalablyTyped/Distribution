...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.ToolbarAndroid
import typings.reactDashNativeDashVectorDashIcons.iconMod.ToolbarAndroidProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

object MaterialCommunityIconsNsToolbarAndroid
  extends ExternalComponentWithAttributesWithRefType[tag.type, ToolbarAndroid] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.ToolbarAndroid].asInstanceOf[String | js.Object]
  def apply(
    iconColor: String,
    iconSize: Double,
    logoName: String,
