...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.TabBarItem
...
object IoniconsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
