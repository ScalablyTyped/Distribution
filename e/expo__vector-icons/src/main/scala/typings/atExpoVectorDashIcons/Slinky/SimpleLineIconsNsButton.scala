...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.Button
...
object SimpleLineIconsNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.Button].asInstanceOf[String | js.Object]
  def apply(
