...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.TabBarItemIOS
...
object OcticonsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
