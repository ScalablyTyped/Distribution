...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.TabBarItemIOS
...
object MaterialCommunityIconsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
