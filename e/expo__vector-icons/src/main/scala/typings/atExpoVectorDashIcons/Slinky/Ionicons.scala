...
object Ionicons
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Ionicons] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Ionicons].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Ionicons] = {
