...
object MaterialCommunityIcons
  extends ExternalComponentWithAttributesWithRefType[
      tag.type, 
      typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIcons
    ] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIcons].asInstanceOf[String | js.Object]
  def apply(
