...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.ZocialNs.Button
...
object ZocialNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.ZocialNs.Button].asInstanceOf[String | js.Object]
  def apply(
