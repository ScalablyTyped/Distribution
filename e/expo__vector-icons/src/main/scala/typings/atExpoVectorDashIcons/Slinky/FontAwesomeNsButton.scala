...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesomeNs.Button
...
object FontAwesomeNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesomeNs.Button].asInstanceOf[String | js.Object]
  def apply(
