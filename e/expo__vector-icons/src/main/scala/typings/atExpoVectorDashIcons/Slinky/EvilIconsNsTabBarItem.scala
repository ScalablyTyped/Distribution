...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.TabBarItem
...
object EvilIconsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
