...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.TabBarItemIOS
...
object SimpleLineIconsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.SimpleLineIconsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
