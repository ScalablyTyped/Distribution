...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.TabBarItemIOS
...
object IoniconsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
