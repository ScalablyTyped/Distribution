...
object Octicons
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Octicons] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Octicons].asInstanceOf[String | js.Object]
  def apply(
  ...
  ): BuildingComponent[tag.type, typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.Octicons] = {
