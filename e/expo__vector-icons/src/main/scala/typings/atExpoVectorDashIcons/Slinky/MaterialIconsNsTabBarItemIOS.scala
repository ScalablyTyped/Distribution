...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.TabBarItemIOS
...
object MaterialIconsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
