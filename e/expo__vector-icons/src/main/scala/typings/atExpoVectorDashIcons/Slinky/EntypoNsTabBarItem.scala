...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EntypoNs.TabBarItem
...
object EntypoNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EntypoNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
