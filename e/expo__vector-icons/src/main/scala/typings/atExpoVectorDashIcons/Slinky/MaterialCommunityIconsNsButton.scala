...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.Button
...
object MaterialCommunityIconsNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.Button].asInstanceOf[String | js.Object]
  def apply(
