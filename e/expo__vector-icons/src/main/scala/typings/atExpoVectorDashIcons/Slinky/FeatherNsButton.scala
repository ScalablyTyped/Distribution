...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.Button
...
object FeatherNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.Button].asInstanceOf[String | js.Object]
  def apply(
