...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.TabBarItemIOS
...
object EvilIconsNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
