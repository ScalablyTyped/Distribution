...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.TabBarItem
...
object MaterialCommunityIconsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialCommunityIconsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
