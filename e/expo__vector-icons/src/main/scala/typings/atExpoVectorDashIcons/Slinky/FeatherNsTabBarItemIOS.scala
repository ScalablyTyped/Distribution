...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.TabBarItemIOS
...
object FeatherNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FeatherNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
