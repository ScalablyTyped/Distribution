...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.Button
...
object EvilIconsNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EvilIconsNs.Button].asInstanceOf[String | js.Object]
  def apply(
