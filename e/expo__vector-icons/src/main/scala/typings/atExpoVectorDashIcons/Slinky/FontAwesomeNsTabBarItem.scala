...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesomeNs.TabBarItem
...
object FontAwesomeNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FontAwesomeNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
