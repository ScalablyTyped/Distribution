...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.TabBarItem
...
object MaterialIconsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.MaterialIconsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
  ...
  ): BuildingComponent[tag.type, TabBarItem] = {
