...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.Button
...
object IoniconsNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.IoniconsNs.Button].asInstanceOf[String | js.Object]
  def apply(
