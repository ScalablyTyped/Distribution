...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FoundationNs.Button
...
object FoundationNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FoundationNs.Button].asInstanceOf[String | js.Object]
  def apply(
