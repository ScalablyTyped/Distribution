...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EntypoNs.Button
...
object EntypoNsButton
  extends ExternalComponentWithAttributesWithRefType[tag.type, Button] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.EntypoNs.Button].asInstanceOf[String | js.Object]
  def apply(
