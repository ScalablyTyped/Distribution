...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.ZocialNs.TabBarItemIOS
...
object ZocialNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.ZocialNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
