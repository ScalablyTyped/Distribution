...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.TabBarItem
...
object OcticonsNsTabBarItem
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItem] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.OcticonsNs.TabBarItem].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
