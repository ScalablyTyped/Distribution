...
import typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FoundationNs.TabBarItemIOS
...
object FoundationNsTabBarItemIOS
  extends ExternalComponentWithAttributesWithRefType[tag.type, TabBarItemIOS] {
  override val component: String | js.Object = js.constructorOf[typings.atExpoVectorDashIcons.atExpoVectorDashIconsMod.FoundationNs.TabBarItemIOS].asInstanceOf[String | js.Object]
  def apply(
    iconName: String,
