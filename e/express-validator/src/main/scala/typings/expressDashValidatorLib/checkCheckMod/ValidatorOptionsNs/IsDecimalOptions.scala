...
trait IsDecimalOptions extends js.Object {
  ...
  var locale: js.UndefOr[expressDashValidatorLib.checkCheckMod.AlphanumericLocale] = js.undefined
}
...
object IsDecimalOptions {
  ...
  def apply(
    ...
    locale: expressDashValidatorLib.checkCheckMod.AlphanumericLocale = null
  ): IsDecimalOptions = {
