package typings
package expressDashValidatorLib.filterSanitizeMod.OptionsNs
...
trait NormalizeEmailOptions extends js.Object {
  ...
  var gmail_lowercase: js.UndefOr[scala.Boolean] = js.undefined
  var gmail_remove_dots: js.UndefOr[scala.Boolean] = js.undefined
  var gmail_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined
  var icloud_lowercase: js.UndefOr[scala.Boolean] = js.undefined
  var icloud_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined
  var outlookdotcom_lowercase: js.UndefOr[scala.Boolean] = js.undefined
  var outlookdotcom_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined
  var yahoo_lowercase: js.UndefOr[scala.Boolean] = js.undefined
  var yahoo_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined
}

object NormalizeEmailOptions {
  @scala.inline
  def apply(
    all_lowercase: js.UndefOr[scala.Boolean] = js.undefined,
    gmail_convert_googlemaildotcom: js.UndefOr[scala.Boolean] = js.undefined,
    gmail_lowercase: js.UndefOr[scala.Boolean] = js.undefined,
    gmail_remove_dots: js.UndefOr[scala.Boolean] = js.undefined,
    gmail_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined,
    icloud_lowercase: js.UndefOr[scala.Boolean] = js.undefined,
    icloud_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined,
    outlookdotcom_lowercase: js.UndefOr[scala.Boolean] = js.undefined,
    outlookdotcom_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined,
    yahoo_lowercase: js.UndefOr[scala.Boolean] = js.undefined,
    yahoo_remove_subaddress: js.UndefOr[scala.Boolean] = js.undefined
