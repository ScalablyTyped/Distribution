...
object validationChainBuildersMod {
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "body")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "buildCheckFunction")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "check")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "cookie")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "header")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "param")
  @js.native
  ...
  @JSImport("express-validator/src/middlewares/validation-chain-builders", "query")
  @js.native
