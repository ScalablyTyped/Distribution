...
object mod {
  ...
  inline def mountWithIntl_C_ComponentObjectObjectAnyPS[C /* <: Component[js.Object, js.Object, Any] */, P, S](node: ReactElement): ReactWrapper[P, S, C] = ^.asInstanceOf[js.Dynamic].applyDynamic("mountWithIntl")(node.asInstanceOf[js.Any]).asInstanceOf[ReactWrapper[P, S, C]]
  inline def mountWithIntl_C_ComponentObjectObjectAnyPS[C /* <: Component[js.Object, js.Object, Any] */, P, S](node: ReactElement, options: MountRendererProps): ReactWrapper[P, S, C] = (^.asInstanceOf[js.Dynamic].applyDynamic("mountWithIntl")(node.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ReactWrapper[P, S, C]]
  ...
  inline def shallowWithIntl_C_ComponentObjectObjectAnyPS[C /* <: Component[js.Object, js.Object, Any] */, P, S](node: ReactElement): ShallowWrapper[P, S, C] = ^.asInstanceOf[js.Dynamic].applyDynamic("shallowWithIntl")(node.asInstanceOf[js.Any]).asInstanceOf[ShallowWrapper[P, S, C]]
  inline def shallowWithIntl_C_ComponentObjectObjectAnyPS[C /* <: Component[js.Object, js.Object, Any] */, P, S](node: ReactElement, options: ShallowRendererProps): ShallowWrapper[P, S, C] = (^.asInstanceOf[js.Dynamic].applyDynamic("shallowWithIntl")(node.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ShallowWrapper[P, S, C]]
