...
trait ElectronStore[T]
  ...
  /**
       ...
       */
  def get[K /* <: java.lang.String */](key: K): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
  /**
       * Get an item or defaultValue if the item does not exist.
       */
  def get[K /* <: java.lang.String */](key: K, defaultValue: electronDashStoreLib.JSONValue): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) */js.Any = js.native
  /**
  ...
  def onDidChange[K /* <: java.lang.String */](
    key: K,
    callback: js.Function2[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) *//* newValue */ js.Any, 
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(K))) *//* oldValue */ js.Any, 
      scala.Unit
    ]
  ): scala.Unit = js.native
  /**
