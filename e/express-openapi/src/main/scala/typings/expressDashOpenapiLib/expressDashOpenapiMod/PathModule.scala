...
trait PathModule extends js.Object {
  ...
  var parameters: js.UndefOr[expressDashOpenapiLib.expressDashOpenapiMod.OpenApiNs.Parameters] = js.undefined
...
object PathModule {
  ...
  def apply(
    ...
    parameters: expressDashOpenapiLib.expressDashOpenapiMod.OpenApiNs.Parameters = null,
