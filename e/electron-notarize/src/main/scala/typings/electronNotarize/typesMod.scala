...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.electronNotarize.typesMod.LegacyNotarizePasswordCredentials
    - typings.electronNotarize.typesMod.LegacyNotarizeApiKeyCredentials
  */
  ...
  object LegacyNotarizeCredentials {
    ...
    inline def LegacyNotarizeApiKeyCredentials(appleApiIssuer: String, appleApiKey: String): typings.electronNotarize.typesMod.LegacyNotarizeApiKeyCredentials = {
      val __obj = js.Dynamic.literal(appleApiIssuer = appleApiIssuer.asInstanceOf[js.Any], appleApiKey = appleApiKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronNotarize.typesMod.LegacyNotarizeApiKeyCredentials]
    }
    
    inline def LegacyNotarizePasswordCredentials(appleId: String, appleIdPassword: String): typings.electronNotarize.typesMod.LegacyNotarizePasswordCredentials = {
      val __obj = js.Dynamic.literal(appleId = appleId.asInstanceOf[js.Any], appleIdPassword = appleIdPassword.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronNotarize.typesMod.LegacyNotarizePasswordCredentials]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.electronNotarize.typesMod.LegacyNotarizeCredentials
    - typings.electronNotarize.typesMod.NotaryToolCredentials
  */
  ...
  object NotarizeCredentials {
    ...
    inline def NotaryToolApiKeyCredentials(appleApiIssuer: String, appleApiKey: String, appleApiKeyId: String): typings.electronNotarize.typesMod.NotaryToolApiKeyCredentials = {
      ...
      __obj.asInstanceOf[typings.electronNotarize.typesMod.NotaryToolApiKeyCredentials]
    }
    
    inline def NotaryToolKeychainCredentials(keychainProfile: String): typings.electronNotarize.typesMod.NotaryToolKeychainCredentials = {
      val __obj = js.Dynamic.literal(keychainProfile = keychainProfile.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.electronNotarize.typesMod.NotaryToolKeychainCredentials]
    }
    
    inline def NotaryToolPasswordCredentials(appleId: String, appleIdPassword: String, teamId: String): typings.electronNotarize.typesMod.NotaryToolPasswordCredentials = {
      ...
      __obj.asInstanceOf[typings.electronNotarize.typesMod.NotaryToolPasswordCredentials]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.electronNotarize.typesMod.NotaryToolPasswordCredentials
    - typings.electronNotarize.typesMod.NotaryToolApiKeyCredentials
    - typings.electronNotarize.typesMod.NotaryToolKeychainCredentials
  */
