...
import typings.electronNotarize.typesMod.LegacyNotarizeStartOptions
import typings.electronNotarize.typesMod.LegacyNotarizeWaitOptions
import typings.electronNotarize.typesMod.NotarizeResult
