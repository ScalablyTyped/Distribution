...
object evalConfigMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.expoConfig.configTypesMod.AppJSONConfig
  ...
  */
  ...
  object _RawDynamicConfig {
    ...
    inline def AppJSONConfig(expo: ExpoConfig): typings.expoConfig.configTypesMod.AppJSONConfig = {
      val __obj = js.Dynamic.literal(expo = expo.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.expoConfig.configTypesMod.AppJSONConfig]
    }
