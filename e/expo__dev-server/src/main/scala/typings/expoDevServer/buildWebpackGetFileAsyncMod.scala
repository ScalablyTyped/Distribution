...
object buildWebpackGetFileAsyncMod {
  ...
  inline def createGetFileNameFromUrl(compiler: AnyCompiler): js.Function1[/* param0 */ Url, String] = ^.asInstanceOf[js.Dynamic].applyDynamic("createGetFileNameFromUrl")(compiler.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* param0 */ Url, String]]
  inline def createGetFileNameFromUrl(compiler: AnyCompiler, publicPath: String): js.Function1[/* param0 */ Url, String] = (^.asInstanceOf[js.Dynamic].applyDynamic("createGetFileNameFromUrl")(compiler.asInstanceOf[js.Any], publicPath.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* param0 */ Url, String]]
  ...
  inline def getFileFromCompilerAsync(compiler: AnyCompiler, param1: FileName): js.Promise[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getFileFromCompilerAsync")(compiler.asInstanceOf[js.Any], param1.asInstanceOf[js.Any])).asInstanceOf[js.Promise[String]]
