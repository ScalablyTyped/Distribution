...
object distEsUtilsEmojiIndexNimbleEmojiIndexMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.BaseEmoji
    - typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.CustomEmoji
  */
  trait EmojiData
    extends StObject
       with EmojiEntry
  object EmojiData {
    ...
    inline def BaseEmoji(
      ...
      val __obj = js.Dynamic.literal(colons = colons.asInstanceOf[js.Any], emoticons = emoticons.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], native = native.asInstanceOf[js.Any], unified = unified.asInstanceOf[js.Any], skin = null)
      __obj.asInstanceOf[typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.BaseEmoji]
    }
    
    inline def CustomEmoji(imageUrl: String, name: String, short_names: js.Array[String]): typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.CustomEmoji = {
      val __obj = js.Dynamic.literal(imageUrl = imageUrl.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], short_names = short_names.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.CustomEmoji]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.emojiMart.distEsUtilsEmojiIndexNimbleEmojiIndexMod.EmojiData
