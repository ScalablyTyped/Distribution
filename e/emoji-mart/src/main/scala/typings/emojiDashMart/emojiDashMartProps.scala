...
trait emojiDashMartProps {
  ...
  @scala.inline
  def NimbleDashPickerProps: typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps.type = typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps
  type NimbleDashPickerProps = typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps
  @scala.inline
  def NimblePickerProps: typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps.type = typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps
  type NimblePickerProps = typings.emojiDashMart.distDashEsComponentsPickerNimbleDashPickerMod.NimblePickerProps
  @scala.inline
