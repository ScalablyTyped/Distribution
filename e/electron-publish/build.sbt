...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "builder-util" % "6.1.3-b831d0",
  "com.scalablytyped" %%% "builder-util-runtime" % "4.4.1-8ecb25",
  ...
  "com.scalablytyped" %%% "temp-file" % "3.1.3-0dba71",
