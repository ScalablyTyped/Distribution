...
import typings.eventemitter3.eventemitter3Strings.`_backtick^_backtick`
...
@js.native
class ^[EventTypes /* <: String | js.Symbol | (/* import warning: ImportType.apply c Unsupported type mapping: 
