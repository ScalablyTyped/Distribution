package typings.atEmberDebug.dataDashAdapterMod

import typings.atEmberDebug.dataDashAdapterMod.DataAdapterNs.Column
import typings.atEmberDebug.dataDashAdapterMod.DataAdapterNs.WrappedRecord
import typings.atEmberDebug.dataDashAdapterMod.DataAdapterNs.WrappedType
...
trait DataAdapter
  ...
  /**
    ...
    * to list all models.
    */
  var containerDebugAdapter: typings.atEmberDebug.containerDashDebugDashAdapterMod.default = js.native
  /**
