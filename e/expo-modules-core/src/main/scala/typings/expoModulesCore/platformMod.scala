...
object platformMod {
  ...
  {[ platform in expo-modules-core.expo-modules-core/build/Platform.PlatformSelectOSType ]:? any}
    */ /* specifics */ typings.expoModulesCore.expoModulesCoreStrings.PlatformSelect & TopLevel[Any], 
    Any
  ]
