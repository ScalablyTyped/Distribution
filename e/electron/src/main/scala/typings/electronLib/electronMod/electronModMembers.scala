...
object electronModMembers extends js.Object {
  ...
  val nativeImage: ScalablyTyped.runtime.Instantiable0[electronLib.ElectronNs.NativeImage] = js.native
  ...
  val session: ScalablyTyped.runtime.Instantiable0[electronLib.ElectronNs.Session] = js.native
  val shell: electronLib.ElectronNs.Shell = js.native
  val systemPreferences: electronLib.ElectronNs.SystemPreferences = js.native
  val webContents: ScalablyTyped.runtime.Instantiable0[electronLib.ElectronNs.WebContents] = js.native
