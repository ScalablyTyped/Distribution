...
trait Dialog extends EventEmitter {
  ...
  /**
       ...
       */
  def showCertificateTrustDialog(browserWindow: BrowserWindow, options: CertificateTrustDialogOptions, callback: js.Function): scala.Unit = js.native
  /**
       * On macOS, this displays a modal dialog that shows a message and certificate
       * information, and gives the user the option of trusting/importing the
       * certificate. If you provide a browserWindow argument the dialog will be attached
       ...
       * due to the Win32 APIs used:
       */
  def showCertificateTrustDialog(options: CertificateTrustDialogOptions, callback: js.Function): scala.Unit = js.native
  /**
       ...
       */
  def showErrorBox(title: java.lang.String, content: java.lang.String): scala.Unit = js.native
  /**
