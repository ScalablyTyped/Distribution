...
trait Protocol extends EventEmitter {
  ...
  def isProtocolHandled(scheme: java.lang.String): js.Promise[scala.Boolean] = js.native
  /**
    * The callback will be called with a boolean that indicates whether there is
    * already a handler for scheme. Deprecated Soon
    */
  def isProtocolHandled(scheme: java.lang.String, callback: js.Function1[/* handled */ scala.Boolean, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def registerSchemesAsPrivileged(customSchemes: js.Array[CustomScheme]): scala.Unit = js.native
  /**
