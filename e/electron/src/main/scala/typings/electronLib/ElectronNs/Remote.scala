...
object Remote {
  ...
  def apply(
    ...
    __obj.updateDynamic("getCurrentWebContents")(getCurrentWebContents)
    __obj.updateDynamic("getCurrentWindow")(getCurrentWindow)
    __obj.updateDynamic("getGlobal")(getGlobal)
