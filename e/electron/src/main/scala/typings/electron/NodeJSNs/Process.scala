package typings.electron.NodeJSNs

import typings.electron.ElectronNs.CPUUsage
import typings.electron.ElectronNs.HeapStatistics
import typings.electron.ElectronNs.IOCounters
import typings.electron.ElectronNs.ProcessMemoryInfo
import typings.electron.ElectronNs.SystemMemoryInfo
