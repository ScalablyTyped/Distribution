...
@js.native
trait Clipboard_ extends EventEmitter {
  ...
  @JSName("readImage")
  def readImage_clipboard(`type`: typings.electron.electronStrings.clipboard): NativeImage_ = js.native
  @JSName("readImage")
  ...
  @JSName("writeImage")
  def writeImage_clipboard(image: NativeImage_, `type`: typings.electron.electronStrings.clipboard): Unit = js.native
  @JSName("writeImage")
