...
import typings.electron.electronStrings.dragexit
...
trait WebviewTag_ extends HTMLElement {
  ...
  @JSName("removeEventListener")
  def removeEventListener_input(`type`: input, listener: js.ThisFunction1[/* this */ HTMLElement, /* ev */ Event_, _]): Unit = js.native
  @JSName("removeEventListener")
