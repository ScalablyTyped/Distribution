...
object MessageEvent {
  ...
  inline def apply(data: js.Any, ports: js.Array[MessagePortMain]): MessageEvent = {
  ...
  extension [Self <: MessageEvent](x: Self) {
    ...
    inline def setPortsVarargs(value: MessagePortMain*): Self = StObject.set(x, "ports", js.Array(value :_*))
  }
}
