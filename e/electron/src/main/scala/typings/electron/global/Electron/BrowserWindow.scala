...
object BrowserWindow {
  ...
  **Note:** This method is deprecated. Instead, use `ses.loadExtension(path)`.
    ...
    */
  /* static member */
  inline def addDevToolsExtension(path: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addDevToolsExtension")(path.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  **Note:** This method is deprecated. Instead, use `ses.loadExtension(path)`.
    ...
    */
  /* static member */
  inline def addExtension(path: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addExtension")(path.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  **Note:** This method is deprecated. Instead, use `ses.getAllExtensions()`.
    ...
    */
  /* static member */
  inline def getDevToolsExtensions(): Record[String, ExtensionInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDevToolsExtensions")().asInstanceOf[Record[String, ExtensionInfo]]
  ...
  **Note:** This method is deprecated. Instead, use `ses.getAllExtensions()`.
    ...
    */
  /* static member */
  inline def getExtensions(): Record[String, ExtensionInfo] = ^.asInstanceOf[js.Dynamic].applyDynamic("getExtensions")().asInstanceOf[Record[String, ExtensionInfo]]
  ...
  /**
    ...
    */
  /* static member */
  inline def removeDevToolsExtension(name: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("removeDevToolsExtension")(name.asInstanceOf[js.Any]).asInstanceOf[Unit]
