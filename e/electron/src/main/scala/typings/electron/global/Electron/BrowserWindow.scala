...
object BrowserWindow {
  ...
  **Note:** This method is deprecated. Instead, use `ses.loadExtension(path)`.
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.addDevToolsExtension")
  @js.native
  ...
  **Note:** This method is deprecated. Instead, use `ses.loadExtension(path)`.
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.addExtension")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.fromBrowserView")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.fromId")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.fromWebContents")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.getAllWindows")
  @js.native
  ...
  **Note:** This method is deprecated. Instead, use `ses.getAllExtensions()`.
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.getDevToolsExtensions")
  @js.native
  ...
  **Note:** This method is deprecated. Instead, use `ses.getAllExtensions()`.
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.getExtensions")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.getFocusedWindow")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.removeDevToolsExtension")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  @JSGlobal("Electron.BrowserWindow.removeExtension")
  @js.native
