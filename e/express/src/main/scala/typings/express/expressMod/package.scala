...
package object expressMod {
  ...
  type IRouter[T] = typings.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.IRouter
  type IRouterHandler[T] = typings.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.IRouterHandler[T]
