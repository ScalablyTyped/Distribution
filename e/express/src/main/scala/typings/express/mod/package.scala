...
package object mod {
  type Application_ = typings.expressServeStaticCore.mod.Application
  ...
  type ErrorRequestHandler[P /* <: typings.expressServeStaticCore.mod.Params */, ResBody, ReqBody, ReqQuery] = typings.expressServeStaticCore.mod.ErrorRequestHandler[P, ResBody, ReqBody, ReqQuery]
  ...
  type RequestHandler[P /* <: typings.expressServeStaticCore.mod.Params */, ResBody, ReqBody, ReqQuery] = typings.expressServeStaticCore.mod.RequestHandler[P, ResBody, ReqBody, ReqQuery]
  type RequestParamHandler = typings.expressServeStaticCore.mod.RequestParamHandler
  type Request_[P /* <: typings.expressServeStaticCore.mod.Params */, ResBody, ReqBody, ReqQuery] = typings.expressServeStaticCore.mod.Request[P, ResBody, ReqBody, ReqQuery]
