...
object ^ extends js.Object {
  ...
  var settings: easyDashXDashHeadersLib.clusterMod.ClusterSettings = js.native
  var worker: easyDashXDashHeadersLib.clusterMod.Worker = js.native
  var workers: js.Array[easyDashXDashHeadersLib.clusterMod.Worker] = js.native
  ...
  def fork(): easyDashXDashHeadersLib.clusterMod.Worker = js.native
  def fork(env: js.Any): easyDashXDashHeadersLib.clusterMod.Worker = js.native
  ...
  def setupMaster(settings: easyDashXDashHeadersLib.clusterMod.ClusterSettings): scala.Unit = js.native
}
