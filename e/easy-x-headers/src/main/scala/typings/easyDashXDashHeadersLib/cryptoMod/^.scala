...
object ^ extends js.Object {
  ...
  def pbkdf2(
    ...
    keylen: scala.Double,
    callback: js.Function2[/* err */ stdLib.Error, /* derivedKey */ easyDashXDashHeadersLib.Buffer, _]
  ...
  def pseudoRandomBytes(
    size: scala.Double,
    callback: js.Function2[/* err */ stdLib.Error, /* buf */ easyDashXDashHeadersLib.Buffer, scala.Unit]
  ): scala.Unit = js.native
