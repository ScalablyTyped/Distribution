...
object serveDashStaticMod extends js.Object {
  /**
    ...
    */
  def apply(root: java.lang.String): easyDashXDashHeadersLib.expressMod.Handler = js.native
  def apply(root: java.lang.String, options: easyDashXDashHeadersLib.Anon_Dotfiles): easyDashXDashHeadersLib.expressMod.Handler = js.native
  @js.native
