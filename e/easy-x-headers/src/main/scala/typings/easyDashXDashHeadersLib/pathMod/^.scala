...
object ^ extends js.Object {
  ...
  def format(pathObject: easyDashXDashHeadersLib.pathMod.ParsedPath): java.lang.String = js.native
  ...
  def parse(pathString: java.lang.String): easyDashXDashHeadersLib.pathMod.ParsedPath = js.native
