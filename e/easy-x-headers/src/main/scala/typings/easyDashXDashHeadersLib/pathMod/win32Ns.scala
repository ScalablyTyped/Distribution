...
object win32Ns extends js.Object {
  ...
  def format(pP: easyDashXDashHeadersLib.pathMod.ParsedPath): java.lang.String = js.native
  ...
  def parse(p: java.lang.String): easyDashXDashHeadersLib.pathMod.ParsedPath = js.native
