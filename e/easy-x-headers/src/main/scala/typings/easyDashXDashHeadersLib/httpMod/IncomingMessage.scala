...
trait IncomingMessage
  extends easyDashXDashHeadersLib.streamMod.Readable {
  ...
  var socket: easyDashXDashHeadersLib.netMod.Socket = js.native
  /**
  ...
  def setTimeout(msecs: scala.Double, callback: js.Function): easyDashXDashHeadersLib.NodeJSNs.Timer = js.native
}
