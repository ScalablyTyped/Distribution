...
object netModMembers extends js.Object {
  var Socket: easyDashXDashHeadersLib.Anon_Options = js.native
  def connect(options: easyDashXDashHeadersLib.Anon_AllowHalfOpen): Socket = js.native
  def connect(options: easyDashXDashHeadersLib.Anon_AllowHalfOpen, connectionListener: js.Function): Socket = js.native
  ...
  def createConnection(options: easyDashXDashHeadersLib.Anon_AllowHalfOpen): Socket = js.native
  def createConnection(options: easyDashXDashHeadersLib.Anon_AllowHalfOpen, connectionListener: js.Function): Socket = js.native
  ...
  def createServer(options: easyDashXDashHeadersLib.Anon_AllowHalfOpen): Server = js.native
  def createServer(
    options: easyDashXDashHeadersLib.Anon_AllowHalfOpen,
