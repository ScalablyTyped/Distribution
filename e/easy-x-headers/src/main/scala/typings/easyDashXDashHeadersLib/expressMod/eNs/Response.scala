...
@js.native
trait Response
  extends easyDashXDashHeadersLib.httpMod.ServerResponse
     with easyDashXDashHeadersLib.ExpressNs.Response {
  ...
  /**
    ...
    *     res.json(404, 'I dont have that');
    */
  def json(status: scala.Double): Response = js.native
  def json(status: scala.Double, body: js.Any): Response = js.native
  /**
    * Send JSON response with JSONP callback support.
    *
    * Examples:
  ...
  /**
    ...
    *     res.jsonp(404, 'I dont have that');
    */
  def jsonp(status: scala.Double): Response = js.native
  def jsonp(status: scala.Double, body: js.Any): Response = js.native
  /**
  ...
  /**
    ...
    *     res.send(404);
    */
  def send(status: scala.Double): Response = js.native
  def send(status: scala.Double, body: js.Any): Response = js.native
  /**
