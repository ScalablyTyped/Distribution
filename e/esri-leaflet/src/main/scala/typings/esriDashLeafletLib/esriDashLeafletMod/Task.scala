...
class Task protected ()
  extends esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.Task {
  def this(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.Service) = this()
