...
class FeatureLayerService protected ()
  extends esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.FeatureLayerService {
  def this(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.FeatureLayerServiceOptions) = this()
}
