...
class ImageService protected ()
  extends esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.ImageService {
  def this(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.ImageServiceOptions) = this()
}
