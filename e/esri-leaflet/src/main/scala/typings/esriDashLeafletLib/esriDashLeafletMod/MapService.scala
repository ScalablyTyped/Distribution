...
class MapService protected ()
  extends esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.MapService {
  def this(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.MapServiceOptions) = this()
}
