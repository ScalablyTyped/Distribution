...
class FeatureLayer protected ()
  extends esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.FeatureLayer {
  def this(options: esriDashLeafletLib.esriDashLeafletMod.leafletMod.esriNs.FeatureLayerOptions) = this()
}
