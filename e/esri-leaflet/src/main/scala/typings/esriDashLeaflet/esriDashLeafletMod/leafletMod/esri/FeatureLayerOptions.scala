...
object FeatureLayerOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(cacheLayers)) __obj.updateDynamic("cacheLayers")(cacheLayers)
    if (fields != null) __obj.updateDynamic("fields")(fields)
    if (from != null) __obj.updateDynamic("from")(from)
    if (!js.isUndefined(ignoreRenderer)) __obj.updateDynamic("ignoreRenderer")(ignoreRenderer)
    if (!js.isUndefined(isModern)) __obj.updateDynamic("isModern")(isModern)
