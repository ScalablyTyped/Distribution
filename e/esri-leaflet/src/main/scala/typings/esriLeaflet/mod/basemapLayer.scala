...
object basemapLayer extends js.Object {
  /**
    ...
    */
  def apply(key: Basemaps): typings.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_ = js.native
  def apply(key: Basemaps, options: BasemapLayerOptions): typings.esriLeaflet.mod.leafletAugmentingMod.esri.BasemapLayer_ = js.native
}
