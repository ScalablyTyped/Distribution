...
object TiledMapLayerOptions {
  ...
  def apply(
    ...
    zoomOffsetAllowance: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(zoomOffsetAllowance)) __obj.updateDynamic("zoomOffsetAllowance")(zoomOffsetAllowance.get.asInstanceOf[js.Any])
