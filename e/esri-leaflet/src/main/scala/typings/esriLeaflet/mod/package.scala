...
/**
  ...
  */
inline def find(options: typings.esriLeaflet.mod.leafletAugmentingMod.esri.FindOptions): typings.esriLeaflet.mod.leafletAugmentingMod.esri.Find_ = typings.esriLeaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("find")(options.asInstanceOf[js.Any]).asInstanceOf[typings.esriLeaflet.mod.leafletAugmentingMod.esri.Find_]
inline def find(options: typings.esriLeaflet.mod.leafletAugmentingMod.esri.MapService_): typings.esriLeaflet.mod.leafletAugmentingMod.esri.Find_ = typings.esriLeaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("find")(options.asInstanceOf[js.Any]).asInstanceOf[typings.esriLeaflet.mod.leafletAugmentingMod.esri.Find_]
...
inline def task(options: typings.esriLeaflet.mod.leafletAugmentingMod.esri.Service): typings.esriLeaflet.mod.leafletAugmentingMod.esri.Task_ = typings.esriLeaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("task")(options.asInstanceOf[js.Any]).asInstanceOf[typings.esriLeaflet.mod.leafletAugmentingMod.esri.Task_]
/**
  ...
  */
inline def task(options: typings.esriLeaflet.mod.leafletAugmentingMod.esri.TaskOptions): typings.esriLeaflet.mod.leafletAugmentingMod.esri.Task_ = typings.esriLeaflet.mod.^.asInstanceOf[js.Dynamic].applyDynamic("task")(options.asInstanceOf[js.Any]).asInstanceOf[typings.esriLeaflet.mod.leafletAugmentingMod.esri.Task_]
