...
object anon {
  ...
  object Clone {
    ...
    inline def apply[TFile](clone_ : js.Any, files: Map[TFile, js.Array[String]]): Clone[TFile] = {
    ...
    extension [Self <: Clone[?], TFile](x: Self & Clone[TFile]) {
      ...
      inline def setClone_(value: js.Any): Self = StObject.set(x, "clone", value.asInstanceOf[js.Any])
