...
name := "expo"
version := "38.0.9-a7a655"
scalaVersion := "2.13.3"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "csstype" % "3.0.2-b0fb5c",
  "org.scalablytyped" %%% "expo-constants" % "9.1.1-f8d0ee",
  "org.scalablytyped" %%% "expo-linking" % "1.0.3-3cc3b0",
  "org.scalablytyped" %%% "fbemitter" % "2.0.0-dt-20200515Z-166464",
