...
trait SvgTSpanProps extends SvgTextProps {
  var dx: js.UndefOr[java.lang.String] = js.undefined
  var dy: js.UndefOr[java.lang.String] = js.undefined
}

object SvgTSpanProps {
  @scala.inline
  def apply(
    ...
    dx: java.lang.String = null,
    dy: java.lang.String = null,
    ...
    if (dx != null) __obj.updateDynamic("dx")(dx)
    ...
    __obj.asInstanceOf[SvgTSpanProps]
  }
}
