...
object PublisherBannerProperties {
  ...
  def apply(
    ...
    onAdMobDispatchAppEvent: js.Function1[/* event */ AdMobAppEvent, scala.Unit] = null,
    ...
    if (onAdMobDispatchAppEvent != null) __obj.updateDynamic("onAdMobDispatchAppEvent")(onAdMobDispatchAppEvent)
