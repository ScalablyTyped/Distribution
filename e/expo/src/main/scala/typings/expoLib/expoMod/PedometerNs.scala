...
object PedometerNs extends js.Object {
  def getStepCountAsync(start: stdLib.Date, end: stdLib.Date): js.Promise[expoLib.Anon_Steps] = js.native
  def isAvailableAsync(): js.Promise[scala.Boolean] = js.native
