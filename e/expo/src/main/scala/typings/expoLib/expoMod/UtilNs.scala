...
object UtilNs extends js.Object {
  ...
  def getCurrentDeviceCountryAsync(): js.Promise[java.lang.String] = js.native
  /** Returns the current device locale as a string. */
  def getCurrentLocaleAsync(): js.Promise[java.lang.String] = js.native
  /** Returns the current device time zone name. */
  def getCurrentTimeZoneAsync(): js.Promise[java.lang.String] = js.native
