...
object SvgSymbolProps {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(height = height.asInstanceOf[js.Any], viewBox = viewBox, width = width.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[SvgSymbolProps]
  }
}
