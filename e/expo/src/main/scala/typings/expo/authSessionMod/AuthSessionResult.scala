...
/* Rewritten from type alias, can be one of: 
  - typings.expo.AnonCancel
  - typings.expo.AnonError
*/
trait AuthSessionResult extends js.Object

object AuthSessionResult {
  @scala.inline
  def AnonCancel(`type`: cancel | dismiss | locked): AuthSessionResult = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[AuthSessionResult]
  }
  @scala.inline
  def AnonError(params: StringDictionary[String], `type`: error | success, url: String, errorCode: String = null): AuthSessionResult = {
