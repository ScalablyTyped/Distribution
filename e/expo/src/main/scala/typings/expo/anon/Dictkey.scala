...
object Dictkey {
  ...
  implicit class DictkeyOps[Self <: Dictkey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setErrorRecovery(value: js.Any): Self = this.set("errorRecovery", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteErrorRecovery: Self = this.set("errorRecovery", js.undefined)
    @scala.inline
