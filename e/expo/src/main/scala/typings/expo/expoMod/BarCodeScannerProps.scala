...
import typings.expo.expoStrings.back
import typings.expo.expoStrings.front
import typings.expo.expoStrings.off
import typings.expo.expoStrings.on
...
trait BarCodeScannerProps extends ViewProps {
  var barCodeTypes: js.UndefOr[js.Array[String]] = js.undefined
  var onBarCodeScanned: js.UndefOr[BarCodeScannedCallback] = js.undefined
  var torchMode: js.UndefOr[on | off] = js.undefined
  var `type`: js.UndefOr[front | back] = js.undefined
}
...
object BarCodeScannerProps {
  ...
  def apply(
    ...
    barCodeTypes: js.Array[String] = null,
