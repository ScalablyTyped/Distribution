...
import typings.expo.Anon_CancelledSaved
import typings.expo.expoMod.MailComposerNs.ComposeOptions
...
object MailComposerNs extends js.Object {
  ...
  options: ComposeOptions): js.Promise[Anon_CancelledSaved] = js.native
}
