...
import typings.expo.Anon_ToleranceMillisAfter
...
class PlaybackObject () extends js.Object {
  ...
  positionMillis: Double): js.Promise[PlaybackStatus] = js.native
  ...
  tolerances: Anon_ToleranceMillisAfter
  ): js.Promise[PlaybackStatus] = js.native
  /**
  ...
  isMuted: Boolean): js.Promise[PlaybackStatus] = js.native
  /**
    ...
    */
  def setOnPlaybackStatusUpdate(): Unit = js.native
  ...
  def setPositionAsync(positionMillis: Double): js.Promise[PlaybackStatus] = js.native
  ...
  progressUpdateIntervalMillis: Double
  ): js.Promise[PlaybackStatus] = js.native
  ...
  volume: Double): js.Promise[PlaybackStatus] = js.native
