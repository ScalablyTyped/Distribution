...
trait PublisherBannerProperties extends AdMobBannerProperties {
  var onAdMobDispatchAppEvent: js.UndefOr[js.Function1[/* event */ AdMobAppEvent, Unit]] = js.undefined
}
...
object PublisherBannerProperties {
  ...
  def apply(
    ...
    adViewDidDismissScreen: () => Unit = null,
    adViewDidReceiveAd: () => Unit = null,
    adViewWillDismissScreen: () => Unit = null,
    adViewWillLeaveApplication: () => Unit = null,
    adViewWillPresentScreen: () => Unit = null,
    bannerSize: AdMobBannerSize = null,
    collapsable: js.UndefOr[Boolean] = js.undefined,
    didFailToReceiveAdWithError: /* errorDescription */ String => Unit = null,
    ...
    onAdMobDispatchAppEvent: /* event */ AdMobAppEvent => Unit = null,
