...
trait PictureOptions extends js.Object {
  ...
  var onPictureSaved: js.UndefOr[js.Function1[/* data */ PictureResponse, Unit]] = js.undefined
...
object PictureOptions {
  ...
  def apply(
    ...
    exif: js.UndefOr[Boolean] = js.undefined,
    onPictureSaved: /* data */ PictureResponse => Unit = null,
