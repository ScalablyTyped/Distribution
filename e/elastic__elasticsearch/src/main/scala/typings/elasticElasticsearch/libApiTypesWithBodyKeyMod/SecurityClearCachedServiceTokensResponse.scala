...
trait SecurityClearCachedServiceTokensResponse extends StObject {
...
object SecurityClearCachedServiceTokensResponse {
  
  inline def apply(_nodes: NodeStatistics, cluster_name: Name, nodes: Record[String, SecurityClusterNode]): SecurityClearCachedServiceTokensResponse = {
    ...
    __obj.asInstanceOf[SecurityClearCachedServiceTokensResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SecurityClearCachedServiceTokensResponse] (val x: Self) extends AnyVal {
