...
trait IngestUppercaseProcessor
  extends StObject
...
object IngestUppercaseProcessor {
  
  inline def apply(field: Field): IngestUppercaseProcessor = {
    val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any])
    __obj.asInstanceOf[IngestUppercaseProcessor]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IngestUppercaseProcessor] (val x: Self) extends AnyVal {
