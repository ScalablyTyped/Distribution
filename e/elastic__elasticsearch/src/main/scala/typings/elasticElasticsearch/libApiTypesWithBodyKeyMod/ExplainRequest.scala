...
import typings.elasticElasticsearch.anon.Query
...
trait ExplainRequest
  ...
  var body: js.UndefOr[Query] = js.undefined
...
object ExplainRequest {
  ...
  implicit open class MutableBuilder[Self <: ExplainRequest] (val x: Self) extends AnyVal {
    ...
    inline def setBody(value: Query): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
