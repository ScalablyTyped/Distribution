...
object IndicesSegmentsRequest {
  
  inline def apply(): IndicesSegmentsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IndicesSegmentsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IndicesSegmentsRequest] (val x: Self) extends AnyVal {
