...
trait DanglingIndicesDeleteDanglingIndexRequest
  extends StObject
...
object DanglingIndicesDeleteDanglingIndexRequest {
  
  inline def apply(accept_data_loss: Boolean, index_uuid: Uuid): DanglingIndicesDeleteDanglingIndexRequest = {
