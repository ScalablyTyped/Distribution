...
trait MsearchTemplateRequest
  ...
  var body: js.UndefOr[js.Array[MsearchTemplateRequestItem]] = js.undefined
...
object MsearchTemplateRequest {
  ...
  implicit open class MutableBuilder[Self <: MsearchTemplateRequest] (val x: Self) extends AnyVal {
    ...
    inline def setBodyVarargs(value: MsearchTemplateRequestItem*): Self = StObject.set(x, "body", js.Array(value*))
