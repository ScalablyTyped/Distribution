...
trait MlAnalysisConfig extends StObject {
  ...
  var detectors: js.Array[MlDetector]
  
  var influencers: js.UndefOr[js.Array[Field]] = js.undefined
...
object MlAnalysisConfig {
  
  inline def apply(bucket_span: Duration, detectors: js.Array[MlDetector]): MlAnalysisConfig = {
    val __obj = js.Dynamic.literal(bucket_span = bucket_span.asInstanceOf[js.Any], detectors = detectors.asInstanceOf[js.Any])
    __obj.asInstanceOf[MlAnalysisConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MlAnalysisConfig] (val x: Self) extends AnyVal {
