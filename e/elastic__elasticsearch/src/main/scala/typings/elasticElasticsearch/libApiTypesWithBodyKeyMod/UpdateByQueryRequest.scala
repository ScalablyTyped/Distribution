...
import typings.elasticElasticsearch.anon.Slice
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait UpdateByQueryRequest
  extends StObject
  ...
  var body: js.UndefOr[Slice] = js.undefined
...
object UpdateByQueryRequest {
  ...
  inline def apply(index: Indices): UpdateByQueryRequest = {
  ...
  implicit open class MutableBuilder[Self <: UpdateByQueryRequest] (val x: Self) extends AnyVal {
    ...
    inline def setBody(value: Slice): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
