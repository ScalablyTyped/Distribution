...
trait AsyncSearchAsyncSearch[TDocument, TAggregations] extends StObject {
...
object AsyncSearchAsyncSearch {
  
  inline def apply[TDocument, TAggregations](_shards: ShardStatistics, hits: SearchHitsMetadata[TDocument], timed_out: Boolean, took: long): AsyncSearchAsyncSearch[TDocument, TAggregations] = {
    ...
    __obj.asInstanceOf[AsyncSearchAsyncSearch[TDocument, TAggregations]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AsyncSearchAsyncSearch[?, ?], TDocument, TAggregations] (val x: Self & (AsyncSearchAsyncSearch[TDocument, TAggregations])) extends AnyVal {
