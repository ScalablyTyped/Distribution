...
trait MlUpdateDataFrameAnalyticsResponse extends StObject {
...
object MlUpdateDataFrameAnalyticsResponse {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[MlUpdateDataFrameAnalyticsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MlUpdateDataFrameAnalyticsResponse] (val x: Self) extends AnyVal {
