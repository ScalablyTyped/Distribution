...
trait MlUpdateJobResponse extends StObject {
  ...
  var custom_settings: js.UndefOr[Record[String, String]] = js.undefined
  ...
  var finished_time: js.UndefOr[EpochTime[UnitMillis]] = js.undefined
...
object MlUpdateJobResponse {
  ...
  extension [Self <: MlUpdateJobResponse](x: Self) {
    ...
    inline def setCustom_settings(value: Record[String, String]): Self = StObject.set(x, "custom_settings", value.asInstanceOf[js.Any])
    ...
    inline def setFinished_time(value: EpochTime[UnitMillis]): Self = StObject.set(x, "finished_time", value.asInstanceOf[js.Any])
