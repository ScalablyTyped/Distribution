...
trait DanglingIndicesDeleteDanglingIndex
  extends StObject
     with Generic {
...
object DanglingIndicesDeleteDanglingIndex {
  ...
  inline def apply(index_uuid: String): DanglingIndicesDeleteDanglingIndex = {
  ...
  extension [Self <: DanglingIndicesDeleteDanglingIndex](x: Self) {
