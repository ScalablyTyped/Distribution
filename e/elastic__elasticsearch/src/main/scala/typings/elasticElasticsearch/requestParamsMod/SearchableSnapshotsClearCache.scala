...
trait SearchableSnapshotsClearCache
  extends StObject
     with Generic {
...
object SearchableSnapshotsClearCache {
  ...
  inline def apply(): SearchableSnapshotsClearCache = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SearchableSnapshotsClearCache]
  }
  
  extension [Self <: SearchableSnapshotsClearCache](x: Self) {
    ...
    inline def setExpand_wildcards(value: open | closed | none | all): Self = StObject.set(x, "expand_wildcards", value.asInstanceOf[js.Any])
