...
object Scroll {
  ...
  inline def apply[T](): Scroll[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Scroll[T]]
  }
  
  extension [Self <: Scroll[?], T](x: Self & Scroll[T]) {
    ...
    inline def setScroll_id(value: String): Self = StObject.set(x, "scroll_id", value.asInstanceOf[js.Any])
