...
type AutoscalingGetAutoscalingDecision = typings.elasticElasticsearch.requestParamsMod.Generic
...
type DanglingIndicesListDanglingIndices = typings.elasticElasticsearch.requestParamsMod.Generic
...
type Info = typings.elasticElasticsearch.requestParamsMod.Generic

type IngestProcessorGrok = typings.elasticElasticsearch.requestParamsMod.Generic
...
type SecurityGetBuiltinPrivileges = typings.elasticElasticsearch.requestParamsMod.Generic
