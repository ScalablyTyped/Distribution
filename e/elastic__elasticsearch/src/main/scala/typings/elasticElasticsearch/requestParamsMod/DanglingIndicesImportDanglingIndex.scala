...
object DanglingIndicesImportDanglingIndex {
  ...
  @scala.inline
  def apply(index_uuid: String): DanglingIndicesImportDanglingIndex = {
  ...
  @scala.inline
  implicit class DanglingIndicesImportDanglingIndexMutableBuilder[Self <: DanglingIndicesImportDanglingIndex] (val x: Self) extends AnyVal {
