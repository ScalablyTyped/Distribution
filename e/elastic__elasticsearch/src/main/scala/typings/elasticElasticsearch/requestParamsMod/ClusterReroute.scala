...
object ClusterReroute {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(dry_run)) __obj.updateDynamic("dry_run")(dry_run.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(retry_failed)) __obj.updateDynamic("retry_failed")(retry_failed.get.asInstanceOf[js.Any])
