...
trait IndicesReloadSearchAnalyzers
  extends StObject
     with Generic {
...
object IndicesReloadSearchAnalyzers {
  ...
  inline def apply(index: String | js.Array[String]): IndicesReloadSearchAnalyzers = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
    __obj.asInstanceOf[IndicesReloadSearchAnalyzers]
  }
  
  extension [Self <: IndicesReloadSearchAnalyzers](x: Self) {
