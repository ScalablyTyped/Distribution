...
@js.native
trait ClusterGetComponentTemplate extends Generic {
...
object ClusterGetComponentTemplate {
  ...
  @scala.inline
  implicit class ClusterGetComponentTemplateOps[Self <: ClusterGetComponentTemplate] (val x: Self) extends AnyVal {
    @scala.inline
