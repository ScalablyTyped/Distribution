...
object IlmExplainLifecycle {
  ...
  def apply(
    ...
    if (!js.isUndefined(only_errors)) __obj.updateDynamic("only_errors")(only_errors.get.asInstanceOf[js.Any])
    if (!js.isUndefined(only_managed)) __obj.updateDynamic("only_managed")(only_managed.get.asInstanceOf[js.Any])
