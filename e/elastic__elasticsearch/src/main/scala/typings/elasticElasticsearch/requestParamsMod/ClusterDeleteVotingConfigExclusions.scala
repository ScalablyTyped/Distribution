...
object ClusterDeleteVotingConfigExclusions {
  ...
  def apply(
    ...
    source: String = null,
    wait_for_removal: js.UndefOr[Boolean] = js.undefined
    ...
    if (!js.isUndefined(wait_for_removal)) __obj.updateDynamic("wait_for_removal")(wait_for_removal.get.asInstanceOf[js.Any])
