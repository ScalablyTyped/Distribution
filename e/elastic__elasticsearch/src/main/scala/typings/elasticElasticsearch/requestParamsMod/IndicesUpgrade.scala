...
trait IndicesUpgrade
  ...
  var only_ancient_segments: js.UndefOr[Boolean] = js.undefined
...
object IndicesUpgrade {
  ...
  @scala.inline
  def apply(): IndicesUpgrade = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IndicesUpgrade]
  }
  
  @scala.inline
  implicit class IndicesUpgradeMutableBuilder[Self <: IndicesUpgrade] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnly_ancient_segments(value: Boolean): Self = StObject.set(x, "only_ancient_segments", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOnly_ancient_segmentsUndefined: Self = StObject.set(x, "only_ancient_segments", js.undefined)
