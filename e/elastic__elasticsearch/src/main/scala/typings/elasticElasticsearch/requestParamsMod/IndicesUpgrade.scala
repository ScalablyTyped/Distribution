...
object IndicesUpgrade {
  ...
  inline def apply(): IndicesUpgrade = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IndicesUpgrade]
  }
  
  extension [Self <: IndicesUpgrade](x: Self) {
    ...
    inline def setOnly_ancient_segments(value: Boolean): Self = StObject.set(x, "only_ancient_segments", value.asInstanceOf[js.Any])
    
    inline def setOnly_ancient_segmentsUndefined: Self = StObject.set(x, "only_ancient_segments", js.undefined)
