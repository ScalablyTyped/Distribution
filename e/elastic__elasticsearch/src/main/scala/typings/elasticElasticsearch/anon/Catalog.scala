...
trait Catalog extends StObject {
  ...
  var page_timeout: js.UndefOr[typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
  
  var params: js.UndefOr[Record[String, Any]] = js.undefined
  
  var query: js.UndefOr[String] = js.undefined
  
  var request_timeout: js.UndefOr[typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
...
object Catalog {
  ...
  extension [Self <: Catalog](x: Self) {
    ...
    inline def setPage_timeout(value: typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "page_timeout", value.asInstanceOf[js.Any])
    ...
    inline def setRequest_timeout(value: typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "request_timeout", value.asInstanceOf[js.Any])
