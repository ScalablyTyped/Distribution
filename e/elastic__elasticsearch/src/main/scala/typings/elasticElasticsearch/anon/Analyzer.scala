...
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisCharFilter
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisTokenFilter
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.AnalysisTokenizer
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Field
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.IndicesAnalyzeTextToAnalyze
...
object Analyzer {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Analyzer] (val x: Self) extends AnyVal {
