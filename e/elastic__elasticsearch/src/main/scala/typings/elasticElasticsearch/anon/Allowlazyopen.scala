...
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlCustomSettings
...
object Allowlazyopen {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Allowlazyopen] (val x: Self) extends AnyVal {
