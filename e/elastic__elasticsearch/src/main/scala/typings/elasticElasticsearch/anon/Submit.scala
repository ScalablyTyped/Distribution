...
trait Submit extends StObject {
  ...
  def submit[TResponse, TRequestBody /* <: RequestBody[Record[String, js.Any]] */, TContext](callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  ...
  def submit[TResponse, TRequestBody /* <: RequestBody[Record[String, js.Any]] */, TContext](params: AsyncSearchSubmit[TRequestBody], callback: callbackFn[TResponse, TContext]): TransportRequestCallback = js.native
  ...
  def submit[TResponse, TRequestBody /* <: RequestBody[Record[String, js.Any]] */, TContext](
