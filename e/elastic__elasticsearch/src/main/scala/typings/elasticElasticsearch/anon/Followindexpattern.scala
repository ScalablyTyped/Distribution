...
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.ByteSize
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.IndexPattern
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.IndexPatterns
...
object Followindexpattern {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Followindexpattern] (val x: Self) extends AnyVal {
