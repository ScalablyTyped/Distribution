...
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherScheduleTriggerEvent
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherSimulatedActions
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.WatcherWatch
