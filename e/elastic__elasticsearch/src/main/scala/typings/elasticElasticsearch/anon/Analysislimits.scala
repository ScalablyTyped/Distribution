...
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlAnalysisMemoryLimit
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlDetector
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlModelPlotConfig
import typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.MlPerPartitionCategorization
...
trait Analysislimits extends StObject {
  ...
  var background_persist_interval: js.UndefOr[typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration] = js.undefined
...
object Analysislimits {
  ...
  implicit open class MutableBuilder[Self <: Analysislimits] (val x: Self) extends AnyVal {
    ...
    inline def setBackground_persist_interval(value: typings.elasticElasticsearch.libApiTypesWithBodyKeyMod.Duration): Self = StObject.set(x, "background_persist_interval", value.asInstanceOf[js.Any])
