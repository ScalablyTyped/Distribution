...
object IndicesDeleteRequest {
  ...
  inline def apply(index: Indices): IndicesDeleteRequest = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
    __obj.asInstanceOf[IndicesDeleteRequest]
  }
  
  extension [Self <: IndicesDeleteRequest](x: Self) {
