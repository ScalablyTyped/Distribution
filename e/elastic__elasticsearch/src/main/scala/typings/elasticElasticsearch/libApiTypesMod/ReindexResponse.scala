...
trait ReindexResponse extends StObject {
  
  var batches: js.UndefOr[long] = js.undefined
  
  var created: js.UndefOr[long] = js.undefined
  ...
  var throttled_millis: js.UndefOr[EpochTime[UnitMillis]] = js.undefined
  
  var throttled_until_millis: js.UndefOr[EpochTime[UnitMillis]] = js.undefined
...
object ReindexResponse {
  ...
  inline def apply(): ReindexResponse = {
  ...
  extension [Self <: ReindexResponse](x: Self) {
    ...
    inline def setThrottled_millis(value: EpochTime[UnitMillis]): Self = StObject.set(x, "throttled_millis", value.asInstanceOf[js.Any])
    
    inline def setThrottled_millisUndefined: Self = StObject.set(x, "throttled_millis", js.undefined)
    
    inline def setThrottled_until_millis(value: EpochTime[UnitMillis]): Self = StObject.set(x, "throttled_until_millis", value.asInstanceOf[js.Any])
