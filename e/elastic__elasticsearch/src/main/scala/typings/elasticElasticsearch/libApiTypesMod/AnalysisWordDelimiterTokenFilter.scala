...
import typings.elasticElasticsearch.elasticElasticsearchStrings.word_delimiter
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AnalysisWordDelimiterTokenFilter
  extends StObject
  ...
  var `type`: word_delimiter
  
  var type_table: js.UndefOr[js.Array[String]] = js.undefined
  
  var type_table_path: js.UndefOr[String] = js.undefined
}
object AnalysisWordDelimiterTokenFilter {
  
  inline def apply(): AnalysisWordDelimiterTokenFilter = {
  ...
  extension [Self <: AnalysisWordDelimiterTokenFilter](x: Self) {
    ...
    inline def setType(value: word_delimiter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
