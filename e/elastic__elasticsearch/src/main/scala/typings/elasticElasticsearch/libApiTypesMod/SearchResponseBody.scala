...
object SearchResponseBody {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchResponseBody[?, ?], TDocument, TAggregations] (val x: Self & (SearchResponseBody[TDocument, TAggregations])) extends AnyVal {
