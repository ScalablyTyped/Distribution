...
import typings.elasticElasticsearch.anon.PartialRecordWatcherCondi
...
trait WatcherConditionContainer extends StObject {
  ...
  var compare: js.UndefOr[Partial[Record[String, PartialRecordWatcherCondi]]] = js.undefined
...
object WatcherConditionContainer {
  ...
  extension [Self <: WatcherConditionContainer](x: Self) {
    ...
    inline def setCompare(value: Partial[Record[String, PartialRecordWatcherCondi]]): Self = StObject.set(x, "compare", value.asInstanceOf[js.Any])
