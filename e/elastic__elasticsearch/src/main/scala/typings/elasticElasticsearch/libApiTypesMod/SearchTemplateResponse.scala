...
trait SearchTemplateResponse[TDocument] extends StObject {
...
object SearchTemplateResponse {
  ...
  inline def apply[TDocument](_shards: ShardStatistics, hits: SearchHitsMetadata[TDocument], timed_out: Boolean, took: long): SearchTemplateResponse[TDocument] = {
    ...
    __obj.asInstanceOf[SearchTemplateResponse[TDocument]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchTemplateResponse[?], TDocument] (val x: Self & SearchTemplateResponse[TDocument]) extends AnyVal {
