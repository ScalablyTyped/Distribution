...
/* Rewritten from type alias, can be one of: 
  - typings.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteSniffInfo
  - typings.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteProxyInfo
*/
...
object ClusterRemoteInfoClusterRemoteInfo {
  ...
  inline def ClusterRemoteInfoClusterRemoteProxyInfo(
    ...
    __obj.asInstanceOf[typings.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteProxyInfo]
  }
  ...
  inline def ClusterRemoteInfoClusterRemoteSniffInfo(
    ...
    __obj.asInstanceOf[typings.elasticElasticsearch.libApiTypesMod.ClusterRemoteInfoClusterRemoteSniffInfo]
  }
}
