...
trait IndicesReloadSearchAnalyzersRequest
  extends StObject
...
object IndicesReloadSearchAnalyzersRequest {
  
  inline def apply(index: Indices): IndicesReloadSearchAnalyzersRequest = {
    val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any])
    __obj.asInstanceOf[IndicesReloadSearchAnalyzersRequest]
  }
  
  extension [Self <: IndicesReloadSearchAnalyzersRequest](x: Self) {
