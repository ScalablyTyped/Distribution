...
object MlPutJobRequest {
  ...
  inline def apply(analysis_config: MlAnalysisConfig, data_description: MlDataDescription, job_id: Id): MlPutJobRequest = {
    val __obj = js.Dynamic.literal(analysis_config = analysis_config.asInstanceOf[js.Any], data_description = data_description.asInstanceOf[js.Any], job_id = job_id.asInstanceOf[js.Any])
