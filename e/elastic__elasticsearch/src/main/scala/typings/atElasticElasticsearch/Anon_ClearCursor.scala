...
import typings.atElasticElasticsearch.apiRequestParamsMod.SqlClearCursor
import typings.atElasticElasticsearch.apiRequestParamsMod.SqlQuery
import typings.atElasticElasticsearch.apiRequestParamsMod.SqlTranslate
...
@js.native
trait Anon_ClearCursor extends js.Object {
  @JSName("clearCursor")
