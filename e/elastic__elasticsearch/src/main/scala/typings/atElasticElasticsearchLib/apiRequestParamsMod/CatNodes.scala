...
trait CatNodes extends Generic {
  ...
  var full_id: js.UndefOr[scala.Boolean] = js.undefined
...
object CatNodes {
  ...
  def apply(
    ...
    full_id: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(full_id)) __obj.updateDynamic("full_id")(full_id)
