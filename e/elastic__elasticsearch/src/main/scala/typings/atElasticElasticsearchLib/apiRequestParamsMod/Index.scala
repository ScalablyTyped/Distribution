...
trait Index[T] extends Generic {
  ...
  var op_type: js.UndefOr[
    atElasticElasticsearchLib.atElasticElasticsearchLibStrings.index | atElasticElasticsearchLib.atElasticElasticsearchLibStrings.create
  ] = js.undefined
...
object Index {
  ...
  def apply[T](
    ...
    op_type: atElasticElasticsearchLib.atElasticElasticsearchLibStrings.index | atElasticElasticsearchLib.atElasticElasticsearchLibStrings.create = null,
