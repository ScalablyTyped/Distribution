package typings.expectPuppeteer.mod._Global_

import org.scalablytyped.runtime.StringDictionary
import typings.expectPuppeteer.mod.ExpectTimingActions
import typings.expectPuppeteer.mod.ExpectToClickOptions
