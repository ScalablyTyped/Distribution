...
trait Options extends CommonOptions {
  /**
    ...
    */
  var input: js.UndefOr[java.lang.String | nodeLib.Buffer | nodeLib.streamMod.Stream] = js.undefined
}
...
object Options {
  ...
  def apply(
    ...
    input: java.lang.String | nodeLib.Buffer | nodeLib.streamMod.Stream = null,
