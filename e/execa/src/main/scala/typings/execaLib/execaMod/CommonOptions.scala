...
trait CommonOptions[EncodingType] extends js.Object {
  /**
  		...
  		*/
  val argv0: js.UndefOr[java.lang.String] = js.undefined
  /**
  		Buffer the output from the spawned process. When buffering is disabled you must consume the output of the `stdout` and `stderr` streams because the promise will not be resolved/rejected until they have completed.
  		If the spawned process fails, `error.stdout`, `error.stderr`, and `error.all` will contain the buffered data.
  		@default true
  		*/
  val buffer: js.UndefOr[scala.Boolean] = js.undefined
  /**
  		...
  		@default true
  		*/
  val cleanup: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
  		...
  		@default false
  		*/
  val detached: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
  		...
  		@default process.env
  		*/
  val env: js.UndefOr[nodeLib.NodeJSNs.ProcessEnv] = js.undefined
  /**
  		Set to `false` if you don't want to extend the environment variables when providing the `env` property.
  		@default true
  		*/
  val extendEnv: js.UndefOr[scala.Boolean] = js.undefined
  /**
  		Sets the group identity of the process.
  		*/
  val gid: js.UndefOr[scala.Double] = js.undefined
  /**
  		Signal value to be used when the spawned process will be killed.
  		@default 'SIGTERM'
  		*/
  val killSignal: js.UndefOr[java.lang.String | scala.Double] = js.undefined
  /**
  		Preferred path to find locally installed binaries in (use with `preferLocal`).
  		@default process.cwd()
  		*/
  val localDir: js.UndefOr[java.lang.String] = js.undefined
  /**
  ...
  /**
  		...
  		@default false
  		*/
  val preferLocal: js.UndefOr[scala.Boolean] = js.undefined
  /**
  		Setting this to `false` resolves the promise with the error instead of rejecting it.
  		@default true
  		*/
  val reject: js.UndefOr[scala.Boolean] = js.undefined
  /**
  		...
  		@default false
  		*/
  val shell: js.UndefOr[scala.Boolean | java.lang.String] = js.undefined
  /**
  ...
  /**
  		...
  		@default true
  		*/
  val stripFinalNewline: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
  		...
  		@default false
  		*/
  val windowsVerbatimArguments: js.UndefOr[scala.Boolean] = js.undefined
}
