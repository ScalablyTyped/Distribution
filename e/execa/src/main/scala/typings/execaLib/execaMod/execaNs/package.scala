...
package object execaNs {
  type ExecaChildProcess = nodeLib.childUnderscoreProcessMod.ChildProcess with ExecaChildPromise with stdLib.Promise[ExecaReturns]
  type ExecaError = nodeLib.Error with ExecaReturns
