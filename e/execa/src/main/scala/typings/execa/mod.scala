...
object mod {
  ...
  inline def execaCommand(command: String): ExecaChildProcess[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("execaCommand")(command.asInstanceOf[js.Any]).asInstanceOf[ExecaChildProcess[String]]
  inline def execaCommand(command: String, options: Options[Null | String]): ExecaChildProcess[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaCommand")(command.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[String]]
  
  inline def execaCommandSync(command: String): ExecaSyncReturnValue[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("execaCommandSync")(command.asInstanceOf[js.Any]).asInstanceOf[ExecaSyncReturnValue[String]]
  inline def execaCommandSync(command: String, options: SyncOptions[Null | String]): ExecaSyncReturnValue[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaCommandSync")(command.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaSyncReturnValue[String]]
  
  inline def execaNode(scriptPath: String): ExecaChildProcess[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any]).asInstanceOf[ExecaChildProcess[String]]
  inline def execaNode(scriptPath: String, arguments: js.Array[String]): ExecaChildProcess[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[String]]
  inline def execaNode(scriptPath: String, arguments: js.Array[String], options: NodeOptions[String]): ExecaChildProcess[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[String]]
  inline def execaNode(scriptPath: String, arguments: js.Array[String], options: Options[Null]): ExecaChildProcess[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[Buffer]]
  inline def execaNode(scriptPath: String, arguments: Unit, options: NodeOptions[String]): ExecaChildProcess[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[String]]
  inline def execaNode(scriptPath: String, arguments: Unit, options: Options[Null]): ExecaChildProcess[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[Buffer]]
  inline def execaNode(scriptPath: String, options: Options[Null | String]): ExecaChildProcess[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaNode")(scriptPath.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaChildProcess[String]]
  
  inline def execaSync(file: String): ExecaSyncReturnValue[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("execaSync")(file.asInstanceOf[js.Any]).asInstanceOf[ExecaSyncReturnValue[String]]
  inline def execaSync(file: String, arguments: js.Array[String]): ExecaSyncReturnValue[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaSync")(file.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any])).asInstanceOf[ExecaSyncReturnValue[String]]
  inline def execaSync(file: String, arguments: js.Array[String], options: SyncOptions[Null | String]): ExecaSyncReturnValue[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaSync")(file.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaSyncReturnValue[String]]
  inline def execaSync(file: String, arguments: Unit, options: SyncOptions[Null | String]): ExecaSyncReturnValue[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaSync")(file.asInstanceOf[js.Any], arguments.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaSyncReturnValue[String]]
  inline def execaSync(file: String, options: SyncOptions[Null | String]): ExecaSyncReturnValue[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("execaSync")(file.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[ExecaSyncReturnValue[String]]
  ...
  trait CommonOptions[EncodingType] extends StObject {
    ...
    /**
    	...
    	@default process.cwd()
    	*/
    val localDir: js.UndefOr[String | URL] = js.undefined
  ...
  object CommonOptions {
    ...
    extension [Self <: CommonOptions[?], EncodingType](x: Self & CommonOptions[EncodingType]) {
      ...
      inline def setLocalDir(value: String | URL): Self = StObject.set(x, "localDir", value.asInstanceOf[js.Any])
      ...
      inline def setStdioVarargs(value: StdioOption*): Self = StObject.set(x, "stdio", js.Array(value*))
  ...
  object ExecaReturnBase {
    ...
    inline def apply[StdoutStderrType](
      ...
      val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], escapedCommand = escapedCommand.asInstanceOf[js.Any], exitCode = exitCode.asInstanceOf[js.Any], failed = failed.asInstanceOf[js.Any], killed = killed.asInstanceOf[js.Any], stderr = stderr.asInstanceOf[js.Any], stdout = stdout.asInstanceOf[js.Any], timedOut = timedOut.asInstanceOf[js.Any])
    ...
    extension [Self <: ExecaReturnBase[?], StdoutStderrType](x: Self & ExecaReturnBase[StdoutStderrType]) {
      ...
      inline def setEscapedCommand(value: String): Self = StObject.set(x, "escapedCommand", value.asInstanceOf[js.Any])
  ...
  object ExecaSyncError {
    ...
    inline def apply[StdoutErrorType](
      ...
      val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], escapedCommand = escapedCommand.asInstanceOf[js.Any], exitCode = exitCode.asInstanceOf[js.Any], failed = failed.asInstanceOf[js.Any], killed = killed.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], shortMessage = shortMessage.asInstanceOf[js.Any], stderr = stderr.asInstanceOf[js.Any], stdout = stdout.asInstanceOf[js.Any], timedOut = timedOut.asInstanceOf[js.Any])
