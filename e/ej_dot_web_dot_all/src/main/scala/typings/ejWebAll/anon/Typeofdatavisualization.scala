...
object Typeofdatavisualization {
  ...
  inline def apply(
    ...
    CircularGauge: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], CircularGauge]) & TypeofCircularGauge,
    Diagram: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], Diagram]) & TypeofDiagram,
    DigitalGauge: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], DigitalGauge]) & TypeofDigitalGauge,
    HeatMap: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], HeatMap]) & TypeofHeatMap,
    HeatMapLegend: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], HeatMapLegend]) & TypeofHeatMapLegend,
    LinearGauge: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], LinearGauge]) & TypeofLinearGauge,
    Map: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], Map]) & TypeofMap,
    Overview: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], Overview]) & TypeofOverview,
    RangeNavigator: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], RangeNavigator]) & TypeofRangeNavigator,
    ...
    SymbolPalette: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], SymbolPalette]) & TypeofSymbolPalette,
    TreeMap: (Instantiable2[/* element */ JQuery | Element, /* options */ js.UndefOr[Model], TreeMap]) & TypeofTreeMap
