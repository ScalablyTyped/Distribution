...
object TypeofWidget_ {
  ...
  inline def apply(extend: Widget_ => js.Any, fn: Widget_): TypeofWidget_ = {
  ...
  extension [Self <: TypeofWidget_](x: Self) {
    ...
    inline def setExtend(value: Widget_ => js.Any): Self = StObject.set(x, "extend", js.Any.fromFunction1(value))
