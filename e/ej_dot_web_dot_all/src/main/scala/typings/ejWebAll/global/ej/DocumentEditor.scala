...
@js.native
open class DocumentEditor protected ()
  extends StObject
...
object DocumentEditor {
  ...
  inline def fn_=(x: typings.ejWebAll.ej.DocumentEditor): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
