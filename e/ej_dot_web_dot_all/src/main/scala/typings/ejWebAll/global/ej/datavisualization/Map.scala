...
object Map {
  ...
  /* static member */
  @JSGlobal("ej.datavisualization.Map.Locale")
  @js.native
  ...
  /* static member */
  @JSGlobal("ej.datavisualization.Map.fn")
  @js.native
  def fn: typings.ejWebAll.ej.datavisualization.Map = js.native
  inline def fn_=(x: typings.ejWebAll.ej.datavisualization.Map): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
