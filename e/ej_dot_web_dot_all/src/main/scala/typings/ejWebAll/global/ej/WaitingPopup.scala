...
@js.native
open class WaitingPopup protected ()
  extends StObject
...
object WaitingPopup {
  ...
  inline def fn_=(x: typings.ejWebAll.ej.WaitingPopup): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
