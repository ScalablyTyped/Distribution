...
object SeriesTooltip {
  ...
  @scala.inline
  implicit class SeriesTooltipOps[Self <: SeriesTooltip] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: SeriesTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
