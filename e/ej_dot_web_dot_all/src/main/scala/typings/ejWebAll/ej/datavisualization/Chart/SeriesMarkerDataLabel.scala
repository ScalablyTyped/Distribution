...
object SeriesMarkerDataLabel {
  ...
  @scala.inline
  implicit class SeriesMarkerDataLabelOps[Self <: SeriesMarkerDataLabel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: SeriesMarkerDataLabelBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteBorder: Self = this.set("border", js.undefined)
    @scala.inline
    def setConnectorLine(value: SeriesMarkerDataLabelConnectorLine): Self = this.set("connectorLine", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFont(value: SeriesMarkerDataLabelFont): Self = this.set("font", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMargin(value: SeriesMarkerDataLabelMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOffset(value: SeriesMarkerDataLabelOffset): Self = this.set("offset", value.asInstanceOf[js.Any])
    @scala.inline
