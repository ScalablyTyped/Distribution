...
@js.native
trait CommonSeriesOptionsHighlightSettingsBorder extends js.Object {
...
object CommonSeriesOptionsHighlightSettingsBorder {
  ...
  @scala.inline
  implicit class CommonSeriesOptionsHighlightSettingsBorderOps[Self <: CommonSeriesOptionsHighlightSettingsBorder] (val x: Self) extends AnyVal {
