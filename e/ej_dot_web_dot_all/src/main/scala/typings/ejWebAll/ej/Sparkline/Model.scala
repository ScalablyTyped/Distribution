...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typings.ejWebAll.ej.datavisualization.Sparkline.Theme | String] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typings.ejWebAll.ej.datavisualization.Sparkline.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    seriesRendering: /* e */ SeriesRenderingEventArgs => Unit = null,
    size: Size = null,
    sparklineMouseLeave: /* e */ SparklineMouseLeaveEventArgs => Unit = null,
    sparklineMouseMove: /* e */ SparklineMouseMoveEventArgs => Unit = null,
    startPointColor: String = null,
    stroke: String = null,
    theme: typings.ejWebAll.ej.datavisualization.Sparkline.Theme | String = null,
    ...
    if (sparklineMouseLeave != null) __obj.updateDynamic("sparklineMouseLeave")(js.Any.fromFunction1(sparklineMouseLeave))
    if (sparklineMouseMove != null) __obj.updateDynamic("sparklineMouseMove")(js.Any.fromFunction1(sparklineMouseMove))
