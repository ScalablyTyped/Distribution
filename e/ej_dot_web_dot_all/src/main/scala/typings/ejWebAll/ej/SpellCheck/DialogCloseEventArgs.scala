...
object DialogCloseEventArgs {
  ...
  @scala.inline
  implicit class DialogCloseEventArgsOps[Self <: DialogCloseEventArgs] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setUpdatedText(value: String): Self = this.set("updatedText", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteUpdatedText: Self = this.set("updatedText", js.undefined)
  }
