...
object DrawCustomLabelEventArgs {
  ...
  def apply(
    ...
    customLabelIndex: js.UndefOr[Double] = js.undefined,
    model: js.Any = null,
    `object`: js.Any = null,
    ...
    if (!js.isUndefined(customLabelIndex)) __obj.updateDynamic("customLabelIndex")(customLabelIndex.get.asInstanceOf[js.Any])
