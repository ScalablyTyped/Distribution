...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(circularMode)) __obj.updateDynamic("circularMode")(circularMode.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableAutoPlay)) __obj.updateDynamic("enableAutoPlay")(enableAutoPlay.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showNavigateButton)) __obj.updateDynamic("showNavigateButton")(showNavigateButton.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showThumbnail)) __obj.updateDynamic("showThumbnail")(showThumbnail.get.asInstanceOf[js.Any])
