...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowExternalDragAndDrop)) __obj.updateDynamic("allowExternalDragAndDrop")(allowExternalDragAndDrop.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowFiltering)) __obj.updateDynamic("allowFiltering")(allowFiltering.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowHover)) __obj.updateDynamic("allowHover")(allowHover.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(allowTitle)) __obj.updateDynamic("allowTitle")(allowTitle.get.asInstanceOf[js.Any])
    if (!js.isUndefined(allowToggleColumn)) __obj.updateDynamic("allowToggleColumn")(allowToggleColumn.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableTotalCount)) __obj.updateDynamic("enableTotalCount")(enableTotalCount.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showColumnWhenEmpty)) __obj.updateDynamic("showColumnWhenEmpty")(showColumnWhenEmpty.get.asInstanceOf[js.Any])
