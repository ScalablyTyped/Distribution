...
object ToolbarIconSettings {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableAddReport)) __obj.updateDynamic("enableAddReport")(enableAddReport.asInstanceOf[js.Any])
    if (!js.isUndefined(enableCalculatedMember)) __obj.updateDynamic("enableCalculatedMember")(enableCalculatedMember.asInstanceOf[js.Any])
    if (!js.isUndefined(enableChartTypes)) __obj.updateDynamic("enableChartTypes")(enableChartTypes.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDBManipulation)) __obj.updateDynamic("enableDBManipulation")(enableDBManipulation.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDeferUpdate)) __obj.updateDynamic("enableDeferUpdate")(enableDeferUpdate.asInstanceOf[js.Any])
    if (!js.isUndefined(enableExcelExport)) __obj.updateDynamic("enableExcelExport")(enableExcelExport.asInstanceOf[js.Any])
    if (!js.isUndefined(enableFullScreen)) __obj.updateDynamic("enableFullScreen")(enableFullScreen.asInstanceOf[js.Any])
    if (!js.isUndefined(enableMDXQuery)) __obj.updateDynamic("enableMDXQuery")(enableMDXQuery.asInstanceOf[js.Any])
    if (!js.isUndefined(enableNewReport)) __obj.updateDynamic("enableNewReport")(enableNewReport.asInstanceOf[js.Any])
    if (!js.isUndefined(enablePdfExport)) __obj.updateDynamic("enablePdfExport")(enablePdfExport.asInstanceOf[js.Any])
    if (!js.isUndefined(enableRemoveReport)) __obj.updateDynamic("enableRemoveReport")(enableRemoveReport.asInstanceOf[js.Any])
    if (!js.isUndefined(enableRenameReport)) __obj.updateDynamic("enableRenameReport")(enableRenameReport.asInstanceOf[js.Any])
    if (!js.isUndefined(enableSortOrFilterColumn)) __obj.updateDynamic("enableSortOrFilterColumn")(enableSortOrFilterColumn.asInstanceOf[js.Any])
    if (!js.isUndefined(enableSortOrFilterRow)) __obj.updateDynamic("enableSortOrFilterRow")(enableSortOrFilterRow.asInstanceOf[js.Any])
    if (!js.isUndefined(enableToggleAxis)) __obj.updateDynamic("enableToggleAxis")(enableToggleAxis.asInstanceOf[js.Any])
    if (!js.isUndefined(enableWordExport)) __obj.updateDynamic("enableWordExport")(enableWordExport.asInstanceOf[js.Any])
