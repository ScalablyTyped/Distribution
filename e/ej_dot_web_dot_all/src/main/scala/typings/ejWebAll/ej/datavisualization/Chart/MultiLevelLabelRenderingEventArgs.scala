...
@js.native
trait MultiLevelLabelRenderingEventArgs extends js.Object {
...
object MultiLevelLabelRenderingEventArgs {
  ...
  @scala.inline
  implicit class MultiLevelLabelRenderingEventArgsOps[Self <: MultiLevelLabelRenderingEventArgs] (val x: Self) extends AnyVal {
    @scala.inline
