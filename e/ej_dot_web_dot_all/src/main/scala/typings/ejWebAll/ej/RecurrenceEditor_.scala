...
class RecurrenceEditor_ protected () extends Widget_ {
  ...
  def this(element: JQuery, options: typings.ejWebAll.ej.RecurrenceEditor.Model) = this()
  def this(element: Element, options: typings.ejWebAll.ej.RecurrenceEditor.Model) = this()
