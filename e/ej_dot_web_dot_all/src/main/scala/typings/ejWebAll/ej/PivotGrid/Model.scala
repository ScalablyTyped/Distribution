...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableCellContext)) __obj.updateDynamic("enableCellContext")(enableCellContext.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableCellEditing)) __obj.updateDynamic("enableCellEditing")(enableCellEditing.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableCollapseByDefault)) __obj.updateDynamic("enableCollapseByDefault")(enableCollapseByDefault.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableColumnGrandTotal)) __obj.updateDynamic("enableColumnGrandTotal")(enableColumnGrandTotal.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableConditionalFormatting)) __obj.updateDynamic("enableConditionalFormatting")(enableConditionalFormatting.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableGrandTotal)) __obj.updateDynamic("enableGrandTotal")(enableGrandTotal.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableGroupingBar)) __obj.updateDynamic("enableGroupingBar")(enableGroupingBar.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableJSONRendering)) __obj.updateDynamic("enableJSONRendering")(enableJSONRendering.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enablePivotFieldList)) __obj.updateDynamic("enablePivotFieldList")(enablePivotFieldList.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableRTL)) __obj.updateDynamic("enableRTL")(enableRTL.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableRowGrandTotal)) __obj.updateDynamic("enableRowGrandTotal")(enableRowGrandTotal.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableToolTip)) __obj.updateDynamic("enableToolTip")(enableToolTip.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableToolTipAnimation)) __obj.updateDynamic("enableToolTipAnimation")(enableToolTipAnimation.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(resizeColumnsToFit)) __obj.updateDynamic("resizeColumnsToFit")(resizeColumnsToFit.get.asInstanceOf[js.Any])
