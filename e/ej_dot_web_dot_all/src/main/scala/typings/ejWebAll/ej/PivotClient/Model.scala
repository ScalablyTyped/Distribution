...
object Model {
  ...
  def apply(
    ...
    locale: String = null,
    maxNodeLimitInMemberEditor: js.UndefOr[Double] = js.undefined,
    memberEditorPageSize: js.UndefOr[Double] = js.undefined,
    ...
    if (!js.isUndefined(collapseCubeBrowserByDefault)) __obj.updateDynamic("collapseCubeBrowserByDefault")(collapseCubeBrowserByDefault.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableCellClick)) __obj.updateDynamic("enableCellClick")(enableCellClick.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableCellDoubleClick)) __obj.updateDynamic("enableCellDoubleClick")(enableCellDoubleClick.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableCompleteDataExport)) __obj.updateDynamic("enableCompleteDataExport")(enableCompleteDataExport.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDeferUpdate)) __obj.updateDynamic("enableDeferUpdate")(enableDeferUpdate.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDrillThrough)) __obj.updateDynamic("enableDrillThrough")(enableDrillThrough.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableKPI)) __obj.updateDynamic("enableKPI")(enableKPI.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableLocalStorage)) __obj.updateDynamic("enableLocalStorage")(enableLocalStorage.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableMeasureGroups)) __obj.updateDynamic("enableMeasureGroups")(enableMeasureGroups.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableMemberEditorPaging)) __obj.updateDynamic("enableMemberEditorPaging")(enableMemberEditorPaging.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableMemberEditorSorting)) __obj.updateDynamic("enableMemberEditorSorting")(enableMemberEditorSorting.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablePaging)) __obj.updateDynamic("enablePaging")(enablePaging.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enablePivotTreeMap)) __obj.updateDynamic("enablePivotTreeMap")(enablePivotTreeMap.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableRTL)) __obj.updateDynamic("enableRTL")(enableRTL.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableSplitter)) __obj.updateDynamic("enableSplitter")(enableSplitter.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableVirtualScrolling)) __obj.updateDynamic("enableVirtualScrolling")(enableVirtualScrolling.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(maxNodeLimitInMemberEditor)) __obj.updateDynamic("maxNodeLimitInMemberEditor")(maxNodeLimitInMemberEditor.get.asInstanceOf[js.Any])
    if (!js.isUndefined(memberEditorPageSize)) __obj.updateDynamic("memberEditorPageSize")(memberEditorPageSize.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showReportCollection)) __obj.updateDynamic("showReportCollection")(showReportCollection.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showUniqueNameOnPivotButton)) __obj.updateDynamic("showUniqueNameOnPivotButton")(showUniqueNameOnPivotButton.get.asInstanceOf[js.Any])
