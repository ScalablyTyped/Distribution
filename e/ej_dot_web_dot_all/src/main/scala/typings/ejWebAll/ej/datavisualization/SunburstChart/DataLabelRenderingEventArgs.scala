...
@js.native
trait DataLabelRenderingEventArgs extends js.Object {
...
object DataLabelRenderingEventArgs {
  ...
  @scala.inline
  implicit class DataLabelRenderingEventArgsOps[Self <: DataLabelRenderingEventArgs] (val x: Self) extends AnyVal {
    @scala.inline
