...
object NodeUncheckEventArgs {
  ...
  implicit class NodeUncheckEventArgsOps[Self <: NodeUncheckEventArgs] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCurrentNode(value: String): Self = this.set("currentNode", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCurrentNode: Self = this.set("currentNode", js.undefined)
    @scala.inline
    def setCurrentUncheckedNodesVarargs(value: js.Any*): Self = this.set("currentUncheckedNodes", js.Array(value :_*))
    @scala.inline
    def setCurrentUncheckedNodes(value: js.Array[_]): Self = this.set("currentUncheckedNodes", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCurrentUncheckedNodes: Self = this.set("currentUncheckedNodes", js.undefined)
    @scala.inline
