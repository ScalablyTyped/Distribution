...
object Model {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowNextValue)) __obj.updateDynamic("allowNextValue")(allowNextValue.asInstanceOf[js.Any])
    if (!js.isUndefined(allowSnapping)) __obj.updateDynamic("allowSnapping")(allowSnapping.asInstanceOf[js.Any])
    if (border != null) __obj.updateDynamic("border")(border.asInstanceOf[js.Any])
    if (dataSource != null) __obj.updateDynamic("dataSource")(dataSource.asInstanceOf[js.Any])
    if (doubleClick != null) __obj.updateDynamic("doubleClick")(js.Any.fromFunction1(doubleClick))
    if (!js.isUndefined(enableAutoResizing)) __obj.updateDynamic("enableAutoResizing")(enableAutoResizing.asInstanceOf[js.Any])
    if (!js.isUndefined(enableDeferredUpdate)) __obj.updateDynamic("enableDeferredUpdate")(enableDeferredUpdate.asInstanceOf[js.Any])
