...
object Theme extends js.Object {
  ...
  @js.native
  sealed trait Azure
    extends ejDotWebDotAllLib.ejNs.datavisualizationNs.ChartNs.Theme
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[ejDotWebDotAllLib.ejNs.datavisualizationNs.ChartNs.Theme with java.lang.String] = js.native
}
