...
class JsonAdaptor () extends Adaptor {
  ...
  def insert(dm: DataManager, data: js.Any, tableName: java.lang.String): js.Any = js.native
  ...
  def processQuery(ds: js.Any, query: Query): java.lang.String = js.native
  def remove(dm: DataManager, keyField: java.lang.String, value: js.Any, tableName: java.lang.String): js.Any = js.native
  def update(dm: DataManager, keyField: java.lang.String, value: js.Any, tableName: java.lang.String): js.Any = js.native
}
