...
object FontWeight extends js.Object {
  ...
  @js.native
  sealed trait Bold
    extends ejDotWebDotAllLib.ejNs.datavisualizationNs.MapNs.FontWeight
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[ejDotWebDotAllLib.ejNs.datavisualizationNs.MapNs.FontWeight with scala.Double] = js.native
}
