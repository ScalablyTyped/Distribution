...
object TaskbarEditedEventArgs {
  ...
  def apply(
    ...
    leftResizing: js.UndefOr[scala.Boolean] = js.undefined,
    model: js.Any = null,
    previousData: js.Any = null,
    progressResizing: js.UndefOr[scala.Boolean] = js.undefined,
    rightResizing: js.UndefOr[scala.Boolean] = js.undefined
