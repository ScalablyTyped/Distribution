...
class DateTimePicker_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.DateTimePicker.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.DateTimePicker.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.DateTimePicker.Model = js.native
  @JSName("model")
  var model_DateTimePicker_ : typings.ejDotWebDotAll.ej.DateTimePicker.Model = js.native
