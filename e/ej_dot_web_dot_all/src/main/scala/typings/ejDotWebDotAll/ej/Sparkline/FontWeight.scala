...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Bold: typings.ejDotWebDotAll.ej.Sparkline.FontWeight.Bold with Double = js.native
  /* 2 */ val Lighter: typings.ejDotWebDotAll.ej.Sparkline.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typings.ejDotWebDotAll.ej.Sparkline.FontWeight.Regular with Double = js.native
  @JSBracketAccess
