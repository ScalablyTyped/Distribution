...
class PivotChart_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.PivotChart.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.PivotChart.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.PivotChart.Model = js.native
  @JSName("model")
  var model_PivotChart_ : typings.ejDotWebDotAll.ej.PivotChart.Model = js.native
