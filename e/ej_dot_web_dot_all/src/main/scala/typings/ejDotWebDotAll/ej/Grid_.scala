...
class Grid_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Grid.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Grid.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Grid.Model = js.native
  @JSName("model")
  var model_Grid_ : typings.ejDotWebDotAll.ej.Grid.Model = js.native
