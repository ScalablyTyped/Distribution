...
class DropDownList_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.DropDownList.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.DropDownList.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.DropDownList.Model = js.native
  @JSName("model")
  var model_DropDownList_ : typings.ejDotWebDotAll.ej.DropDownList.Model = js.native
