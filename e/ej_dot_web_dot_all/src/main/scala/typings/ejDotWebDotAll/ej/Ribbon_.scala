...
class Ribbon_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Ribbon.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Ribbon.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Ribbon.Model = js.native
  @JSName("model")
  var model_Ribbon_ : typings.ejDotWebDotAll.ej.Ribbon.Model = js.native
