...
import typings.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ClientSide
import typings.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ServerSide
