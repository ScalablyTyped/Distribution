...
object ExportingMode extends js.Object {
  ...
  /* 1 */ val ClientSide: typings.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ClientSide with Double = js.native
  /* 0 */ val ServerSide: typings.ejDotWebDotAll.ej.datavisualization.DigitalGauge.ExportingMode.ServerSide with Double = js.native
  @JSBracketAccess
