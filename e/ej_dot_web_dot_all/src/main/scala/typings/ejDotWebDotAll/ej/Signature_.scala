...
@js.native
class Signature_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Signature.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Signature.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Signature.Model = js.native
  @JSName("model")
  var model_Signature_ : typings.ejDotWebDotAll.ej.Signature.Model = js.native
