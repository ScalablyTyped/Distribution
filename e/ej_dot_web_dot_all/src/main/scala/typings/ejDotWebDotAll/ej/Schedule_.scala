...
@js.native
class Schedule_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Schedule.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Schedule.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Schedule.Model = js.native
  @JSName("model")
  var model_Schedule_ : typings.ejDotWebDotAll.ej.Schedule.Model = js.native
