...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Bold: typings.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Bold with Double = js.native
  /* 2 */ val Lighter: typings.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typings.ejDotWebDotAll.ej.datavisualization.Sparkline.FontWeight.Regular with Double = js.native
  @JSBracketAccess
