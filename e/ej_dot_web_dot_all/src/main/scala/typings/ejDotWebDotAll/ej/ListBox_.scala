...
@JSGlobal("ej.ListBox")
@js.native
class ListBox_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.ListBox.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.ListBox.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.ListBox.Model = js.native
  @JSName("model")
  var model_ListBox_ : typings.ejDotWebDotAll.ej.ListBox.Model = js.native
