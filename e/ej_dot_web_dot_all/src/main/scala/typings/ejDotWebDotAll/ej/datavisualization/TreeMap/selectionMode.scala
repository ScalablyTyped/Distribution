...
import typings.ejDotWebDotAll.ej.datavisualization.TreeMap.selectionMode.Default
import typings.ejDotWebDotAll.ej.datavisualization.TreeMap.selectionMode.Multiple
