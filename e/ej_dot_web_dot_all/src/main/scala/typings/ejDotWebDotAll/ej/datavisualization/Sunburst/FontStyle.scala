...
import typings.ejDotWebDotAll.ej.datavisualization.Sunburst.FontStyle.Italic
import typings.ejDotWebDotAll.ej.datavisualization.Sunburst.FontStyle.Normal
