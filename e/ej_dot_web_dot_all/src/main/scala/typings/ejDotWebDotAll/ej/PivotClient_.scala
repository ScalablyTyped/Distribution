...
@js.native
class PivotClient_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.PivotClient.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.PivotClient.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.PivotClient.Model = js.native
  @JSName("model")
  var model_PivotClient_ : typings.ejDotWebDotAll.ej.PivotClient.Model = js.native
