...
class RadialMenu_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.RadialMenu.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.RadialMenu.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.RadialMenu.Model = js.native
  @JSName("model")
  var model_RadialMenu_ : typings.ejDotWebDotAll.ej.RadialMenu.Model = js.native
