...
import typings.ejDotWebDotAll.ej.TreeGrid.EjPredicate
...
@js.native
class TreeGrid_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.TreeGrid.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.TreeGrid.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.TreeGrid.Model = js.native
  @JSName("model")
  var model_TreeGrid_ : typings.ejDotWebDotAll.ej.TreeGrid.Model = js.native
