...
object VerticalAlignment extends js.Object {
  ...
  /* 2 */ val Bottom: typings.ejDotWebDotAll.ej.datavisualization.Diagram.VerticalAlignment.Bottom with Double = js.native
  /* 1 */ val Center: typings.ejDotWebDotAll.ej.datavisualization.Diagram.VerticalAlignment.Center with Double = js.native
  /* 0 */ val Top: typings.ejDotWebDotAll.ej.datavisualization.Diagram.VerticalAlignment.Top with Double = js.native
  @JSBracketAccess
