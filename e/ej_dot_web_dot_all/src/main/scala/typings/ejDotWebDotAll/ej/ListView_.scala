...
class ListView_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.ListView.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.ListView.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.ListView.Model = js.native
  @JSName("model")
  var model_ListView_ : typings.ejDotWebDotAll.ej.ListView.Model = js.native
