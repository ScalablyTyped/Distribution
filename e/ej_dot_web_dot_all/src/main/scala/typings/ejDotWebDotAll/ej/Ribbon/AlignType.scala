...
object AlignType extends js.Object {
  ...
  /* 1 */ val Columns: typings.ejDotWebDotAll.ej.Ribbon.AlignType.Columns with Double = js.native
  /* 0 */ val Rows: typings.ejDotWebDotAll.ej.Ribbon.AlignType.Rows with Double = js.native
  @JSBracketAccess
