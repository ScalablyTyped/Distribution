...
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.Themes.FlatDark
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.Themes.FlatLight
