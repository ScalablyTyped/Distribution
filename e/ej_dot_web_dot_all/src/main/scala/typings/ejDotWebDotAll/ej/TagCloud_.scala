...
@js.native
class TagCloud_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.TagCloud.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.TagCloud.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.TagCloud.Model = js.native
  @JSName("model")
  var model_TagCloud_ : typings.ejDotWebDotAll.ej.TagCloud.Model = js.native
