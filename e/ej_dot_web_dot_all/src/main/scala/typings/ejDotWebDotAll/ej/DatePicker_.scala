...
class DatePicker_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.DatePicker.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.DatePicker.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.DatePicker.Model = js.native
  @JSName("model")
  var model_DatePicker_ : typings.ejDotWebDotAll.ej.DatePicker.Model = js.native
