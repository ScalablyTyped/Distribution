...
object SelectionType extends js.Object {
  ...
  /* 1 */ val Multiple: typings.ejDotWebDotAll.ej.Gantt.SelectionType.Multiple with Double = js.native
  /* 0 */ val Single: typings.ejDotWebDotAll.ej.Gantt.SelectionType.Single with Double = js.native
  @JSBracketAccess
