...
import typings.ejDotWebDotAll.ej.Grid.ClipMode.Clip
import typings.ejDotWebDotAll.ej.Grid.ClipMode.Ellipsis
import typings.ejDotWebDotAll.ej.Grid.ClipMode.EllipsisWithTooltip
