...
object AnimationType extends js.Object {
  ...
  /* 0 */ val Default: typings.ejDotWebDotAll.ej.AnimationType.Default with Double = js.native
  /* 1 */ val None: typings.ejDotWebDotAll.ej.AnimationType.None with Double = js.native
  @JSBracketAccess
