...
@js.native
class ComboBox_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.ComboBox.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.ComboBox.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.ComboBox.Model = js.native
  @JSName("model")
  var model_ComboBox_ : typings.ejDotWebDotAll.ej.ComboBox.Model = js.native
