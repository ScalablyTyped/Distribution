...
object ExportingMode extends js.Object {
  ...
  /* 1 */ val ClientSide: typings.ejDotWebDotAll.ej.datavisualization.Chart.ExportingMode.ClientSide with Double = js.native
  /* 0 */ val ServerSide: typings.ejDotWebDotAll.ej.datavisualization.Chart.ExportingMode.ServerSide with Double = js.native
  @JSBracketAccess
