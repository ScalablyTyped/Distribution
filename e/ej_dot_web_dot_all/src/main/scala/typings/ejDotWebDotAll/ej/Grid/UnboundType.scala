...
object UnboundType extends js.Object {
  ...
  /* 3 */ val Cancel: typings.ejDotWebDotAll.ej.Grid.UnboundType.Cancel with Double = js.native
  /* 2 */ val Delete: typings.ejDotWebDotAll.ej.Grid.UnboundType.Delete with Double = js.native
  /* 0 */ val Edit: typings.ejDotWebDotAll.ej.Grid.UnboundType.Edit with Double = js.native
  /* 1 */ val Save: typings.ejDotWebDotAll.ej.Grid.UnboundType.Save with Double = js.native
  @JSBracketAccess
