...
@js.native
class PivotGrid_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.PivotGrid.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.PivotGrid.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.PivotGrid.Model = js.native
  @JSName("model")
  var model_PivotGrid_ : typings.ejDotWebDotAll.ej.PivotGrid.Model = js.native
