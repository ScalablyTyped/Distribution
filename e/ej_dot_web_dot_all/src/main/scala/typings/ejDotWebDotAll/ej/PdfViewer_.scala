...
import typings.ejDotWebDotAll.ej.PdfViewer.AnnotationType
...
@js.native
class PdfViewer_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.PdfViewer.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.PdfViewer.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.PdfViewer.Model = js.native
  @JSName("model")
  var model_PdfViewer_ : typings.ejDotWebDotAll.ej.PdfViewer.Model = js.native
