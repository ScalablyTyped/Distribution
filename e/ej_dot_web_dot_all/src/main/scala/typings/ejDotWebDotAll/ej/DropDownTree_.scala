...
@js.native
class DropDownTree_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.DropDownTree.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.DropDownTree.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.DropDownTree.Model = js.native
  @JSName("model")
  var model_DropDownTree_ : typings.ejDotWebDotAll.ej.DropDownTree.Model = js.native
