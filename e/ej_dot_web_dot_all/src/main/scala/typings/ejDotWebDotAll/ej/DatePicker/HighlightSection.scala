...
import typings.ejDotWebDotAll.ej.DatePicker.HighlightSection.None
import typings.ejDotWebDotAll.ej.DatePicker.HighlightSection.Week
import typings.ejDotWebDotAll.ej.DatePicker.HighlightSection.WorkDays
