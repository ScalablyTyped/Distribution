...
object LayerType extends js.Object {
  ...
  /* 2 */ val Bing: typings.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Bing with Double = js.native
  /* 0 */ val Geometry: typings.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Geometry with Double = js.native
  /* 1 */ val Osm: typings.ejDotWebDotAll.ej.datavisualization.Map.LayerType.Osm with Double = js.native
  @JSBracketAccess
