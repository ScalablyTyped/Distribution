...
object SunburstLegendPosition extends js.Object {
  ...
  /* 3 */ val Bottom: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Bottom with Double = js.native
  /* 0 */ val Left: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Left with Double = js.native
  /* 1 */ val Right: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Right with Double = js.native
  /* 2 */ val Top: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstLegendPosition.Top with Double = js.native
  @JSBracketAccess
