...
@js.native
class DateRangePicker_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.DateRangePicker.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.DateRangePicker.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.DateRangePicker.Model = js.native
  @JSName("model")
  var model_DateRangePicker_ : typings.ejDotWebDotAll.ej.DateRangePicker.Model = js.native
