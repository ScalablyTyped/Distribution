...
@JSGlobal("ej.Tab")
@js.native
class Tab_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Tab.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Tab.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Tab.Model = js.native
  @JSName("model")
  var model_Tab_ : typings.ejDotWebDotAll.ej.Tab.Model = js.native
