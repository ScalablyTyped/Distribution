...
object SunburstClickAction extends js.Object {
  ...
  /* 0 */ val None: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstClickAction.None with Double = js.native
  /* 2 */ val ToggleSegmentSelection: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstClickAction.ToggleSegmentSelection with Double = js.native
  /* 1 */ val ToggleSegmentVisibility: typings.ejDotWebDotAll.ej.datavisualization.Sunburst.SunburstClickAction.ToggleSegmentVisibility with Double = js.native
  @JSBracketAccess
