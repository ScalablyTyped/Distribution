...
object ExportingType extends js.Object {
  ...
  /* 1 */ val JPG: typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.JPG with Double = js.native
  /* 0 */ val PNG: typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.PNG with Double = js.native
  @JSBracketAccess
