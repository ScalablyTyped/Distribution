...
import typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.JPG
import typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.ExportingType.PNG
