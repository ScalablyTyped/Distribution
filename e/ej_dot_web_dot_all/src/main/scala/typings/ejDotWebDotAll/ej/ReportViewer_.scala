...
@js.native
class ReportViewer_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.ReportViewer.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.ReportViewer.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.ReportViewer.Model = js.native
  @JSName("model")
  var model_ReportViewer_ : typings.ejDotWebDotAll.ej.ReportViewer.Model = js.native
