...
@js.native
class Splitter_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Splitter.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Splitter.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Splitter.Model = js.native
  @JSName("model")
  var model_Splitter_ : typings.ejDotWebDotAll.ej.Splitter.Model = js.native
