...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typings.ejDotWebDotAll.ej.datavisualization.Sparkline.Theme | String] = js.undefined
  /** Options to customize the tooltip.
    */
  var tooltip: js.UndefOr[typings.ejDotWebDotAll.ej.Sparkline.Tooltip] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typings.ejDotWebDotAll.ej.datavisualization.Sparkline.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    stroke: String = null,
    theme: typings.ejDotWebDotAll.ej.datavisualization.Sparkline.Theme | String = null,
    tooltip: typings.ejDotWebDotAll.ej.Sparkline.Tooltip = null,
    tooltipInitialize: /* e */ TooltipInitializeEventArgs => Unit = null,
    `type`: typings.ejDotWebDotAll.ej.datavisualization.Sparkline.Type | String = null,
