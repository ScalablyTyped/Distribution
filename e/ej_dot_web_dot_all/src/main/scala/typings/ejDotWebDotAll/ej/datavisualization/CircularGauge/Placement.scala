...
object Placement extends js.Object {
  ...
  /* 1 */ val Far: typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.Placement.Far with Double = js.native
  /* 0 */ val Near: typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.Placement.Near with Double = js.native
  @JSBracketAccess
