...
object SunburstHighlightType extends js.Object {
  ...
  /* 1 */ val Color: typings.ejDotWebDotAll.ej.Sunburst.SunburstHighlightType.Color with Double = js.native
  /* 0 */ val Opacity: typings.ejDotWebDotAll.ej.Sunburst.SunburstHighlightType.Opacity with Double = js.native
  @JSBracketAccess
