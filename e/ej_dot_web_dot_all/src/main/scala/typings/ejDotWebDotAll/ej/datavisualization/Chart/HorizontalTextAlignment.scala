...
object HorizontalTextAlignment extends js.Object {
  ...
  /* 0 */ val Center: typings.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Center with Double = js.native
  /* 2 */ val Far: typings.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Far with Double = js.native
  /* 1 */ val Near: typings.ejDotWebDotAll.ej.datavisualization.Chart.HorizontalTextAlignment.Near with Double = js.native
  @JSBracketAccess
