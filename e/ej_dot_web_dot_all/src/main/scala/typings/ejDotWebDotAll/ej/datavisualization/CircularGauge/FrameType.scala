...
import typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.FrameType.FullCircle
import typings.ejDotWebDotAll.ej.datavisualization.CircularGauge.FrameType.HalfCircle
