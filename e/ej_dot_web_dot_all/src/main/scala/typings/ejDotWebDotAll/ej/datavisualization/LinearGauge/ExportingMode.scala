...
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.ExportingMode.ClientSide
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.ExportingMode.ServerSide
