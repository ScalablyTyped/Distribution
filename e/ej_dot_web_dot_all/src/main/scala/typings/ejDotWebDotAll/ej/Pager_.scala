...
class Pager_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Pager.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Pager.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Pager.Model = js.native
  @JSName("model")
  var model_Pager_ : typings.ejDotWebDotAll.ej.Pager.Model = js.native
