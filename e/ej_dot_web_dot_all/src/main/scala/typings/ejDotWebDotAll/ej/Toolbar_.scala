...
@JSGlobal("ej.Toolbar")
@js.native
class Toolbar_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Toolbar.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Toolbar.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Toolbar.Model = js.native
  @JSName("model")
  var model_Toolbar_ : typings.ejDotWebDotAll.ej.Toolbar.Model = js.native
