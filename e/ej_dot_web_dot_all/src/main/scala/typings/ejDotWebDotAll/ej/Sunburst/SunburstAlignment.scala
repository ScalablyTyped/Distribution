...
object SunburstAlignment extends js.Object {
  ...
  /* 0 */ val Center: typings.ejDotWebDotAll.ej.Sunburst.SunburstAlignment.Center with Double = js.native
  /* 2 */ val Far: typings.ejDotWebDotAll.ej.Sunburst.SunburstAlignment.Far with Double = js.native
  /* 1 */ val Near: typings.ejDotWebDotAll.ej.Sunburst.SunburstAlignment.Near with Double = js.native
  @JSBracketAccess
