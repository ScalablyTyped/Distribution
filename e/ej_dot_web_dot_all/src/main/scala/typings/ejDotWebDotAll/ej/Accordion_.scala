...
class Accordion_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Accordion.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Accordion.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Accordion.Model = js.native
  @JSName("model")
  var model_Accordion_ : typings.ejDotWebDotAll.ej.Accordion.Model = js.native
