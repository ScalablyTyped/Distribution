...
import typings.ejDotWebDotAll.ej.datavisualization.Chart.TickLinesPosition.Inside
import typings.ejDotWebDotAll.ej.datavisualization.Chart.TickLinesPosition.Outside
