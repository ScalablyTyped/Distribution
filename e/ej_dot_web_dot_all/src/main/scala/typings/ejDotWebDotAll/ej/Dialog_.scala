...
class Dialog_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.Dialog.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.Dialog.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.Dialog.Model = js.native
  @JSName("model")
  var model_Dialog_ : typings.ejDotWebDotAll.ej.Dialog.Model = js.native
