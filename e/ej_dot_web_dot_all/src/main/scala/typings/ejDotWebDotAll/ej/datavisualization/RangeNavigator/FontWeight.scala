...
import typings.ejDotWebDotAll.ej.datavisualization.RangeNavigator.FontWeight.Lighter
import typings.ejDotWebDotAll.ej.datavisualization.RangeNavigator.FontWeight.Regular
