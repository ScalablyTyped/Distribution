...
class MaskEdit_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.MaskEdit.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.MaskEdit.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.MaskEdit.Model = js.native
  @JSName("model")
  var model_MaskEdit_ : typings.ejDotWebDotAll.ej.MaskEdit.Model = js.native
