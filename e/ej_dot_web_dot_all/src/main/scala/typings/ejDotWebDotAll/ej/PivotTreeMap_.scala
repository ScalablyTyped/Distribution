...
class PivotTreeMap_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.PivotTreeMap.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.PivotTreeMap.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.PivotTreeMap.Model = js.native
  @JSName("model")
  var model_PivotTreeMap_ : typings.ejDotWebDotAll.ej.PivotTreeMap.Model = js.native
