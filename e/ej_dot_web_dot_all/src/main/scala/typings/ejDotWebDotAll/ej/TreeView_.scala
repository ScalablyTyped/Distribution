...
@js.native
class TreeView_ protected () extends Widget {
  def this(element: JQuery) = this()
  def this(element: Element) = this()
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.TreeView.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.TreeView.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.TreeView.Model = js.native
  @JSName("model")
  var model_TreeView_ : typings.ejDotWebDotAll.ej.TreeView.Model = js.native
