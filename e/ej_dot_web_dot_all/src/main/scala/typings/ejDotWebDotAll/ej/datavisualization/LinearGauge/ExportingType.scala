...
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.ExportingType.JPG
import typings.ejDotWebDotAll.ej.datavisualization.LinearGauge.ExportingType.PNG
