...
class ColorPicker_ protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ej.ColorPicker.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ej.ColorPicker.Model) = this()
  var defaults: typings.ejDotWebDotAll.ej.ColorPicker.Model = js.native
  @JSName("model")
  var model_ColorPicker_ : typings.ejDotWebDotAll.ej.ColorPicker.Model = js.native
