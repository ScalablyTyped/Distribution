...
import typings.ejDotWebDotAll.ej.DataManager
import typings.ejDotWebDotAll.ej.Query
import typings.ejDotWebDotAll.ej.browserInfoOptions
import typings.ejDotWebDotAll.ej.culture
...
trait Typeofej extends js.Object {
  ...
  var WidgetBase: Instantiable0[typings.ejDotWebDotAll.ej.WidgetBase] = js.native
  val cssUA: String = js.native
  val cultures: culture = js.native
  val dataUtil: typings.ejDotWebDotAll.ej.dataUtil = js.native
  val datavisualization: Typeofdatavisualization = js.native
  val device: Typeofdevice = js.native
  val globalize: typings.ejDotWebDotAll.ej.globalize = js.native
  var remoteSaveAdaptor: Instantiable0[typings.ejDotWebDotAll.ej.remoteSaveAdaptor] = js.native
