...
trait Model extends js.Object {
  ...
  var groupSelectionMode: js.UndefOr[
    typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.groupSelectionMode | String
  ] = js.undefined
  ...
  /** Specifies the selection mode of treemap item. Accepted selection mode values are Default and Multiple.
    * @Default {default}
    */
  var selectionMode: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.selectionMode | String] = js.undefined
