...
object BPMNAnnotationDirection extends js.Object {
  ...
  /* 3 */ val Bottom: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNAnnotationDirection.Bottom with Double = js.native
  /* 0 */ val Left: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNAnnotationDirection.Left with Double = js.native
  /* 1 */ val Right: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNAnnotationDirection.Right with Double = js.native
  /* 2 */ val Top: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNAnnotationDirection.Top with Double = js.native
  @JSBracketAccess
