...
object CustomItemType extends js.Object {
  ...
  /* 0 */ val Button: typings.ejDotWebDotAll.ejNs.RibbonNs.CustomItemType.Button with Double = js.native
  /* 1 */ val Menu: typings.ejDotWebDotAll.ejNs.RibbonNs.CustomItemType.Menu with Double = js.native
  @JSBracketAccess
