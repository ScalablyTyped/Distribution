...
object Alignment extends js.Object {
  ...
  /* 2 */ val After: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.Alignment.After with Double = js.native
  /* 0 */ val Before: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.Alignment.Before with Double = js.native
  /* 1 */ val Center: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.Alignment.Center with Double = js.native
  @JSBracketAccess
