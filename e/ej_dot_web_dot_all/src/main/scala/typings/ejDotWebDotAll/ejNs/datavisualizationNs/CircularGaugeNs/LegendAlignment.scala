...
object LegendAlignment extends js.Object {
  ...
  /* 0 */ val Center: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.LegendAlignment.Center with Double = js.native
  /* 2 */ val Far: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.LegendAlignment.Far with Double = js.native
  /* 1 */ val Near: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.LegendAlignment.Near with Double = js.native
  @JSBracketAccess
