...
trait FilterSettings extends js.Object {
  ...
  /** Specifies the type of column filtering.
    ...
    */
  var filterType: js.UndefOr[typings.ejDotWebDotAll.ejNs.TreeGridNs.FilterType | String] = js.undefined
...
object FilterSettings {
  ...
  def apply(
    ...
    filterType: typings.ejDotWebDotAll.ejNs.TreeGridNs.FilterType | String = null,
