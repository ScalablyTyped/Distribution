...
object CustomCellType extends js.Object {
  ...
  /* 0 */ val Button: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.CustomCellType.Button with Double = js.native
  /* 1 */ val CheckBox: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.CustomCellType.CheckBox with Double = js.native
  /* 2 */ val DatePicker: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.CustomCellType.DatePicker with Double = js.native
  /* 3 */ val DropDownList: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.CustomCellType.DropDownList with Double = js.native
  @JSBracketAccess
