...
object TickAlignment extends js.Object {
  ...
  /* 0 */ val LeftOrTop: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.TickAlignment.LeftOrTop with Double = js.native
  /* 1 */ val RightOrBottom: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.TickAlignment.RightOrBottom with Double = js.native
  @JSBracketAccess
