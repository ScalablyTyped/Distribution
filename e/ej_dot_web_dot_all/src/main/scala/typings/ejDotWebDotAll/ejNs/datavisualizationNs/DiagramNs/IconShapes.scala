...
object IconShapes extends js.Object {
  ...
  /* 1 */ val Arrow: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Arrow with Double = js.native
  /* 6 */ val Image: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Image with Double = js.native
  /* 3 */ val Minus: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Minus with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.None with Double = js.native
  /* 4 */ val Path: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Path with Double = js.native
  /* 2 */ val Plus: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Plus with Double = js.native
  /* 5 */ val Template: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.IconShapes.Template with Double = js.native
  @JSBracketAccess
