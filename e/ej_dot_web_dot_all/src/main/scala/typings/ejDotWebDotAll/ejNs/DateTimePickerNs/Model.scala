...
import typings.ejDotWebDotAll.ejNs.DatePickerNs.Header
import typings.ejDotWebDotAll.ejNs.DatePickerNs.Level
import typings.ejDotWebDotAll.ejNs.popupPosition
...
trait Model extends js.Object {
  ...
  /** Specifies the popup position of DateTimePicker.See below to know available popup positions
    ...
    */
  var popupPosition: js.UndefOr[String | typings.ejDotWebDotAll.ejNs.popupPosition] = js.undefined
