...
class RTE protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.RTENs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.RTENs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.RTENs.Model = js.native
  @JSName("model")
  var model_RTE: typings.ejDotWebDotAll.ejNs.RTENs.Model = js.native
