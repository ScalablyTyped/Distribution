...
object ContentType extends js.Object {
  ...
  /* 2 */ val ImageBoth: typings.ejDotWebDotAll.ejNs.ContentType.ImageBoth with Double = js.native
  /* 1 */ val ImageOnly: typings.ejDotWebDotAll.ejNs.ContentType.ImageOnly with Double = js.native
  /* 4 */ val ImageTextImage: typings.ejDotWebDotAll.ejNs.ContentType.ImageTextImage with Double = js.native
  /* 3 */ val TextAndImage: typings.ejDotWebDotAll.ejNs.ContentType.TextAndImage with Double = js.native
  /* 0 */ val TextOnly: typings.ejDotWebDotAll.ejNs.ContentType.TextOnly with Double = js.native
  @JSBracketAccess
