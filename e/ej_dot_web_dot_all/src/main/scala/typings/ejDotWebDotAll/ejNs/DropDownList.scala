...
class DropDownList protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.DropDownListNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.DropDownListNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.DropDownListNs.Model = js.native
  @JSName("model")
  var model_DropDownList: typings.ejDotWebDotAll.ejNs.DropDownListNs.Model = js.native
