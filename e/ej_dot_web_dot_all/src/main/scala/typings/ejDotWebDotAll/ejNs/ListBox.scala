...
class ListBox protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.ListBoxNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.ListBoxNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.ListBoxNs.Model = js.native
  @JSName("model")
  var model_ListBox: typings.ejDotWebDotAll.ejNs.ListBoxNs.Model = js.native
