...
object EdgeLabelPlacement extends js.Object {
  ...
  /* 2 */ val Hide: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.EdgeLabelPlacement.Hide with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.EdgeLabelPlacement.None with Double = js.native
  /* 1 */ val Shift: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.EdgeLabelPlacement.Shift with Double = js.native
  @JSBracketAccess
