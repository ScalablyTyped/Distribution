...
object UnitTextPlacement extends js.Object {
  ...
  /* 0 */ val Back: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.UnitTextPlacement.Back with Double = js.native
  /* 1 */ val From: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.UnitTextPlacement.From with Double = js.native
  @JSBracketAccess
