...
object AxisOrientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.AxisOrientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.AxisOrientation.Vertical with Double = js.native
  @JSBracketAccess
