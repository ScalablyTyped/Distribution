...
object Header extends js.Object {
  ...
  /* 2 */ val Min: typings.ejDotWebDotAll.ejNs.DatePickerNs.Header.Min with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.DatePickerNs.Header.None with Double = js.native
  /* 1 */ val Short: typings.ejDotWebDotAll.ejNs.DatePickerNs.Header.Short with Double = js.native
  @JSBracketAccess
