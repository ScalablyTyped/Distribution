...
class Grid protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.GridNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.GridNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.GridNs.Model = js.native
  @JSName("model")
  var model_Grid: typings.ejDotWebDotAll.ejNs.GridNs.Model = js.native
