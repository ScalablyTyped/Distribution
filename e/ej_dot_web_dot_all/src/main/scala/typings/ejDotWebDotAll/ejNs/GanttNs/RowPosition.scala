...
object RowPosition extends js.Object {
  ...
  /* 2 */ val AboveSelectedRow: typings.ejDotWebDotAll.ejNs.GanttNs.RowPosition.AboveSelectedRow with Double = js.native
  /* 3 */ val BelowSelectedRow: typings.ejDotWebDotAll.ejNs.GanttNs.RowPosition.BelowSelectedRow with Double = js.native
  /* 1 */ val Bottom: typings.ejDotWebDotAll.ejNs.GanttNs.RowPosition.Bottom with Double = js.native
  /* 4 */ val Child: typings.ejDotWebDotAll.ejNs.GanttNs.RowPosition.Child with Double = js.native
  /* 0 */ val Top: typings.ejDotWebDotAll.ejNs.GanttNs.RowPosition.Top with Double = js.native
  @JSBracketAccess
