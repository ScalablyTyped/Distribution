...
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.BorderOptions
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.CellIndex
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.DataOptions
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.ImportingOptions
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.LinkOptions
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.RangeOptions
import typings.ejDotWebDotAll.ejNs.SpreadsheetNs.UndoRedoOptions
...
class Spreadsheet protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.Model) = this()
  var XLCFormat: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLCFormat = js.native
  var XLCMenu: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLCMenu = js.native
  var XLCellType: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLCellType = js.native
  var XLChart: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLChart = js.native
  var XLClipboard: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLClipboard = js.native
  var XLComment: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLComment = js.native
  var XLDragDrop: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLDragDrop = js.native
  var XLDragFill: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLDragFill = js.native
  var XLEdit: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLEdit = js.native
  var XLExport: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLExport = js.native
  var XLFilter: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLFilter = js.native
  var XLFormat: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLFormat = js.native
  var XLFreeze: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLFreeze = js.native
  var XLPivot: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLPivot = js.native
  var XLPrint: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLPrint = js.native
  var XLResize: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLResize = js.native
  var XLRibbon: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLRibbon = js.native
  var XLScroll: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLScroll = js.native
  var XLSearch: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLSearch = js.native
  var XLSelection: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLSelection = js.native
  var XLShape: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLShape = js.native
  var XLSort: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLSort = js.native
  var XLSparkline: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLSparkline = js.native
  var XLValidate: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.XLValidate = js.native
  var defaults: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.Model = js.native
  @JSName("model")
  var model_Spreadsheet: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.Model = js.native
