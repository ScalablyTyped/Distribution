...
import typings.ejDotWebDotAll.ejNs.TextAlign
import typings.ejDotWebDotAll.ejNs.Type
import typings.ejDotWebDotAll.ejNs.filterType
...
trait MultiColumnSettingsColumn extends js.Object {
  ...
  /** Specifies the search filter type. There are several types of search filter available such as â€˜startswithâ€™, â€˜containsâ€™, â€˜endswithâ€™, â€˜lessthanâ€™,
    ...
    */
  var filterType: js.UndefOr[typings.ejDotWebDotAll.ejNs.filterType | String] = js.undefined
