...
object ExportingOrientation extends js.Object {
  ...
  /* 1 */ val Landscape: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ExportingOrientation.Landscape with Double = js.native
  /* 0 */ val Portrait: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ExportingOrientation.Portrait with Double = js.native
  @JSBracketAccess
