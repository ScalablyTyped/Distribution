...
trait Scale extends js.Object {
  ...
  /** Specifies the scale Direction of the Scale. See
    ...
    */
  var direction: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.Direction | String] = js.undefined
...
object Scale {
  ...
  def apply(
    ...
    direction: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.Direction | String = null,
