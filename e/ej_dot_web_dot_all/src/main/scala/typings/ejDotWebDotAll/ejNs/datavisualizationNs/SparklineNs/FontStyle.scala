...
object FontStyle extends js.Object {
  ...
  /* 1 */ val Italic: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.FontStyle.Italic with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.FontStyle.Normal with Double = js.native
  @JSBracketAccess
