...
object ClipMode extends js.Object {
  ...
  /* 1 */ val Clip: typings.ejDotWebDotAll.ejNs.TreeGridNs.ClipMode.Clip with Double = js.native
  /* 0 */ val Ellipsis: typings.ejDotWebDotAll.ejNs.TreeGridNs.ClipMode.Ellipsis with Double = js.native
  @JSBracketAccess
