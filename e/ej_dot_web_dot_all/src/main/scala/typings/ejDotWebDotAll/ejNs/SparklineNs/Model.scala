...
trait Model extends js.Object {
  ...
  /** Specifies the theme for Sparkline.
    ...
    */
  var theme: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.Theme | String] = js.undefined
  /** Options to customize the tooltip.
    */
  var tooltip: js.UndefOr[typings.ejDotWebDotAll.ejNs.SparklineNs.Tooltip] = js.undefined
  ...
  /** Specifies the type of the series to render in sparkline.
    ...
    */
  var `type`: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.Type | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    stroke: String = null,
    theme: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.Theme | String = null,
    tooltip: typings.ejDotWebDotAll.ejNs.SparklineNs.Tooltip = null,
    tooltipInitialize: /* e */ TooltipInitializeEventArgs => Unit = null,
    `type`: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SparklineNs.Type | String = null,
