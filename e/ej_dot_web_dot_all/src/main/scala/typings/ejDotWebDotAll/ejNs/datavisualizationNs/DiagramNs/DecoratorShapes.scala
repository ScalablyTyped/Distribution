...
object DecoratorShapes extends js.Object {
  ...
  /* 1 */ val Arrow: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.Arrow with Double = js.native
  /* 3 */ val Circle: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.Circle with Double = js.native
  /* 4 */ val Diamond: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.Diamond with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.None with Double = js.native
  /* 2 */ val OpenArrow: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.OpenArrow with Double = js.native
  /* 5 */ val Path: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.DecoratorShapes.Path with Double = js.native
  @JSBracketAccess
