...
object BeginEditAction extends js.Object {
  ...
  /* 1 */ val Click: typings.ejDotWebDotAll.ejNs.TreeGridNs.BeginEditAction.Click with Double = js.native
  /* 0 */ val DblClick: typings.ejDotWebDotAll.ejNs.TreeGridNs.BeginEditAction.DblClick with Double = js.native
  @JSBracketAccess
