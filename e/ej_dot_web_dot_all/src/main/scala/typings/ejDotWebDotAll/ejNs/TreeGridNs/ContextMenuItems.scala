...
object ContextMenuItems extends js.Object {
  ...
  /* 0 */ val Add: typings.ejDotWebDotAll.ejNs.TreeGridNs.ContextMenuItems.Add with Double = js.native
  /* 2 */ val Delete: typings.ejDotWebDotAll.ejNs.TreeGridNs.ContextMenuItems.Delete with Double = js.native
  /* 1 */ val Edit: typings.ejDotWebDotAll.ejNs.TreeGridNs.ContextMenuItems.Edit with Double = js.native
  @JSBracketAccess
