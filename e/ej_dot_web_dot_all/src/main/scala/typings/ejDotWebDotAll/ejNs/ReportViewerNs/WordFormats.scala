...
object WordFormats extends js.Object {
  ...
  /* 20 */ val Automatic: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Automatic with Double = js.native
  /* 2 */ val DOCX: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.DOCX with Double = js.native
  /* 0 */ val Doc: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Doc with Double = js.native
  /* 1 */ val Dot: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Dot with Double = js.native
  /* 17 */ val EPUB: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.EPUB with Double = js.native
  /* 18 */ val HTML: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.HTML with Double = js.native
  /* 15 */ val RTF: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.RTF with Double = js.native
  /* 16 */ val Txt: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Txt with Double = js.native
  /* 3 */ val Word2007: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2007 with Double = js.native
  /* 9 */ val Word2007Docm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2007Docm with Double = js.native
  /* 12 */ val Word2007Dotm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2007Dotm with Double = js.native
  /* 6 */ val Word2007Dotx: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2007Dotx with Double = js.native
  /* 4 */ val Word2010: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2010 with Double = js.native
  /* 10 */ val Word2010Docm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2010Docm with Double = js.native
  /* 13 */ val Word2010Dotm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2010Dotm with Double = js.native
  /* 7 */ val Word2010Dotx: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2010Dotx with Double = js.native
  /* 5 */ val Word2013: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2013 with Double = js.native
  /* 11 */ val Word2013Docm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2013Docm with Double = js.native
  /* 14 */ val Word2013Dotm: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2013Dotm with Double = js.native
  /* 8 */ val Word2013Dotx: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.Word2013Dotx with Double = js.native
  /* 19 */ val XML: typings.ejDotWebDotAll.ejNs.ReportViewerNs.WordFormats.XML with Double = js.native
  @JSBracketAccess
