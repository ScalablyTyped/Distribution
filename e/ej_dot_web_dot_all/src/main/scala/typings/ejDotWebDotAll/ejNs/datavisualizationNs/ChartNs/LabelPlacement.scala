...
object LabelPlacement extends js.Object {
  ...
  /* 1 */ val BetweenTicks: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.LabelPlacement.BetweenTicks with Double = js.native
  /* 0 */ val OnTicks: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.LabelPlacement.OnTicks with Double = js.native
  @JSBracketAccess
