...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the Tab control.
    */
  var ajaxSettings: js.UndefOr[typings.ejDotWebDotAll.ejNs.TabNs.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typings.ejDotWebDotAll.ejNs.TabNs.AjaxSettings = null,
