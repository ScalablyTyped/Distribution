...
object RangeZOrderPlacement extends js.Object {
  ...
  /* 1 */ val Front: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.RangeZOrderPlacement.Front with Double = js.native
  /* 0 */ val Rear: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.RangeZOrderPlacement.Rear with Double = js.native
  @JSBracketAccess
