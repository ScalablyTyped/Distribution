...
class ListView protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.ListViewNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.ListViewNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.ListViewNs.Model = js.native
  @JSName("model")
  var model_ListView: typings.ejDotWebDotAll.ejNs.ListViewNs.Model = js.native
