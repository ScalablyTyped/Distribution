...
object BoundaryConstraints extends js.Object {
  ...
  /* 1 */ val Diagram: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BoundaryConstraints.Diagram with Double = js.native
  /* 0 */ val Infinite: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BoundaryConstraints.Infinite with Double = js.native
  /* 2 */ val Page: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BoundaryConstraints.Page with Double = js.native
  @JSBracketAccess
