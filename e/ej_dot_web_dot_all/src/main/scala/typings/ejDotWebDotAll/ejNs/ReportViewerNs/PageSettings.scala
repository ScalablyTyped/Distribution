...
trait PageSettings extends js.Object {
  /** Specifies the print layout orientation.
    * @Default {null}
    */
  var orientation: js.UndefOr[typings.ejDotWebDotAll.ejNs.ReportViewerNs.Orientation | String] = js.undefined
...
object PageSettings {
  @scala.inline
  def apply(
    orientation: typings.ejDotWebDotAll.ejNs.ReportViewerNs.Orientation | String = null,
