...
trait FilterSettings extends js.Object {
  ...
  /** This specifies the grid to show the filterBar or filterMenu to the grid records. See filterType
    ...
    */
  var filterType: js.UndefOr[typings.ejDotWebDotAll.ejNs.GridNs.FilterType | String] = js.undefined
...
object FilterSettings {
  ...
  def apply(
    ...
    filterType: typings.ejDotWebDotAll.ejNs.GridNs.FilterType | String = null,
