...
class PivotTreeMap protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.PivotTreeMapNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.PivotTreeMapNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.PivotTreeMapNs.Model = js.native
  @JSName("model")
  var model_PivotTreeMap: typings.ejDotWebDotAll.ejNs.PivotTreeMapNs.Model = js.native
