...
object CellVisibility extends js.Object {
  ...
  /* 1 */ val Hidden: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.CellVisibility.Hidden with Double = js.native
  /* 0 */ val Visible: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.CellVisibility.Visible with Double = js.native
  @JSBracketAccess
