package typings.ejDotWebDotAll.ejNs.SignatureNs
...
object SaveImageFormat extends js.Object {
  ...
  /* 2 */ val BMP: typings.ejDotWebDotAll.ejNs.SignatureNs.SaveImageFormat.BMP with Double = js.native
  /* 1 */ val JPG: typings.ejDotWebDotAll.ejNs.SignatureNs.SaveImageFormat.JPG with Double = js.native
  /* 0 */ val PNG: typings.ejDotWebDotAll.ejNs.SignatureNs.SaveImageFormat.PNG with Double = js.native
  /* 3 */ val TIFF: typings.ejDotWebDotAll.ejNs.SignatureNs.SaveImageFormat.TIFF with Double = js.native
  @JSBracketAccess
