...
class FileExplorer protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.FileExplorerNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.FileExplorerNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.FileExplorerNs.Model = js.native
  @JSName("model")
  var model_FileExplorer: typings.ejDotWebDotAll.ejNs.FileExplorerNs.Model = js.native
