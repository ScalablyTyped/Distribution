...
object SelectionUnit extends js.Object {
  ...
  /* 2 */ val MultiRange: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.SelectionUnit.MultiRange with Double = js.native
  /* 1 */ val Range: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.SelectionUnit.Range with Double = js.native
  /* 0 */ val Single: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.SelectionUnit.Single with Double = js.native
  @JSBracketAccess
