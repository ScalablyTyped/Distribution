...
object PortConstraints extends js.Object {
  ...
  /* 1 */ val Connect: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.PortConstraints.Connect with Double = js.native
  /* 2 */ val ConnectOnDrag: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.PortConstraints.ConnectOnDrag with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.PortConstraints.None with Double = js.native
  @JSBracketAccess
