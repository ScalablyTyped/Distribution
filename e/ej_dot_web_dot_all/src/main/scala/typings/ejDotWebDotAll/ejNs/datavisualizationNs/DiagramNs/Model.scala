...
trait Model extends js.Object {
  ...
  /** An object that defines the description, appearance and alignments of tooltips
    * @Default {null}
    */
  var tooltip: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.Tooltip] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    tooltip: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.Tooltip = null,
    width: String = null,
