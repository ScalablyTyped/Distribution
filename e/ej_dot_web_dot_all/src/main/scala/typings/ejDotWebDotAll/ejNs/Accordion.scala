...
class Accordion protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.AccordionNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.AccordionNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.AccordionNs.Model = js.native
  @JSName("model")
  var model_Accordion: typings.ejDotWebDotAll.ejNs.AccordionNs.Model = js.native
