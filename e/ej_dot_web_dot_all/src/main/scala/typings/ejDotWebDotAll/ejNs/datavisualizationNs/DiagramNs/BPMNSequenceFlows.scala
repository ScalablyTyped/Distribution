...
object BPMNSequenceFlows extends js.Object {
  ...
  /* 1 */ val Conditional: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSequenceFlows.Conditional with Double = js.native
  /* 2 */ val Default: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSequenceFlows.Default with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSequenceFlows.Normal with Double = js.native
  @JSBracketAccess
