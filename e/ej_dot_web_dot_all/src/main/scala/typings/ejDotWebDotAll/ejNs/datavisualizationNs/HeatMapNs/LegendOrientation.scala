...
object LegendOrientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendOrientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendOrientation.Vertical with Double = js.native
  @JSBracketAccess
