...
import typings.ejDotWebDotAll.ejNs.GanttNs.EjPredicate
...
class Gantt protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.GanttNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.GanttNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.GanttNs.Model = js.native
  @JSName("model")
  var model_Gantt: typings.ejDotWebDotAll.ejNs.GanttNs.Model = js.native
