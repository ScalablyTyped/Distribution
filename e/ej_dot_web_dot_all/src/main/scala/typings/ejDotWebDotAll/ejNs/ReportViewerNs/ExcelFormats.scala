...
object ExcelFormats extends js.Object {
  ...
  /* 1 */ val Excel2007: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ExcelFormats.Excel2007 with Double = js.native
  /* 2 */ val Excel2010: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ExcelFormats.Excel2010 with Double = js.native
  /* 3 */ val Excel2013: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ExcelFormats.Excel2013 with Double = js.native
  /* 0 */ val Excel97to2003: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ExcelFormats.Excel97to2003 with Double = js.native
  @JSBracketAccess
