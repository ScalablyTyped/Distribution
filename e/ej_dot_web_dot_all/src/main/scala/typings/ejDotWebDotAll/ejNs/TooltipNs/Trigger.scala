...
object Trigger extends js.Object {
  ...
  /* 0 */ val Click: typings.ejDotWebDotAll.ejNs.TooltipNs.Trigger.Click with Double = js.native
  /* 2 */ val Focus: typings.ejDotWebDotAll.ejNs.TooltipNs.Trigger.Focus with Double = js.native
  /* 1 */ val Hover: typings.ejDotWebDotAll.ejNs.TooltipNs.Trigger.Hover with Double = js.native
  @JSBracketAccess
