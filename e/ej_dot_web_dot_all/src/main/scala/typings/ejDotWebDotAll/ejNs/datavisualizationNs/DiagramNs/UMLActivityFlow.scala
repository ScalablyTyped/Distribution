...
object UMLActivityFlow extends js.Object {
  ...
  /* 1 */ val Control: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.UMLActivityFlow.Control with Double = js.native
  /* 2 */ val Exception: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.UMLActivityFlow.Exception with Double = js.native
  /* 0 */ val Object: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.UMLActivityFlow.Object with Double = js.native
  @JSBracketAccess
