...
object CheckboxSize extends js.Object {
  ...
  /* 0 */ val Medium: typings.ejDotWebDotAll.ejNs.CheckboxSize.Medium with Double = js.native
  /* 1 */ val Small: typings.ejDotWebDotAll.ejNs.CheckboxSize.Small with Double = js.native
  @JSBracketAccess
