...
object PointerType extends js.Object {
  ...
  /* 1 */ val Marker: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.PointerType.Marker with Double = js.native
  /* 0 */ val Needle: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.PointerType.Needle with Double = js.native
  @JSBracketAccess
