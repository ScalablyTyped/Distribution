...
object SunburstHighlightType extends js.Object {
  ...
  /* 1 */ val Color: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightType.Color with Double = js.native
  /* 0 */ val Opacity: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightType.Opacity with Double = js.native
  @JSBracketAccess
