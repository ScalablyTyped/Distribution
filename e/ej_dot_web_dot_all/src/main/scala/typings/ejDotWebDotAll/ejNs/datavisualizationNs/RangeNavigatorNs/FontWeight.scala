...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Lighter: typings.ejDotWebDotAll.ejNs.datavisualizationNs.RangeNavigatorNs.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typings.ejDotWebDotAll.ejNs.datavisualizationNs.RangeNavigatorNs.FontWeight.Regular with Double = js.native
  @JSBracketAccess
