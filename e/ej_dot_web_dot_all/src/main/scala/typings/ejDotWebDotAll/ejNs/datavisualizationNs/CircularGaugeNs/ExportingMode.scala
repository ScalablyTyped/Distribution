...
object ExportingMode extends js.Object {
  ...
  /* 1 */ val ClientSide: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.ExportingMode.ClientSide with Double = js.native
  /* 0 */ val ServerSide: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.ExportingMode.ServerSide with Double = js.native
  @JSBracketAccess
