...
object ColumnFacet extends js.Object {
  ...
  /* 1 */ val Cylinder: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ColumnFacet.Cylinder with Double = js.native
  /* 0 */ val Rectangle: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ColumnFacet.Rectangle with Double = js.native
  @JSBracketAccess
