...
object SunburstHorizontalAlignment extends js.Object {
  ...
  /* 0 */ val Center: typings.ejDotWebDotAll.ejNs.SunburstNs.SunburstHorizontalAlignment.Center with Double = js.native
  /* 1 */ val Left: typings.ejDotWebDotAll.ejNs.SunburstNs.SunburstHorizontalAlignment.Left with Double = js.native
  /* 2 */ val Right: typings.ejDotWebDotAll.ejNs.SunburstNs.SunburstHorizontalAlignment.Right with Double = js.native
  @JSBracketAccess
