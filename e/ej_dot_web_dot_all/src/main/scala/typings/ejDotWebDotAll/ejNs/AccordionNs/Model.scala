...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the content to the accordion control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typings.ejDotWebDotAll.ejNs.AccordionNs.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typings.ejDotWebDotAll.ejNs.AccordionNs.AjaxSettings = null,
