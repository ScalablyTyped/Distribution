...
object FontWeight extends js.Object {
  ...
  /* 1 */ val Bold: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.FontWeight.Bold with Double = js.native
  /* 2 */ val Lighter: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.FontWeight.Lighter with Double = js.native
  /* 0 */ val Regular: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.FontWeight.Regular with Double = js.native
  @JSBracketAccess
