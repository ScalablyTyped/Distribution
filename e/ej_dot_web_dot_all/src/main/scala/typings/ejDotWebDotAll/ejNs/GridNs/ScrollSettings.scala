...
trait ScrollSettings extends js.Object {
  ...
  /** This is used to define the mode of virtual scrolling in grid. See virtualScrollMode
    ...
    */
  var virtualScrollMode: js.UndefOr[typings.ejDotWebDotAll.ejNs.GridNs.VirtualScrollMode | String] = js.undefined
...
object ScrollSettings {
  ...
  def apply(
    ...
    virtualScrollMode: typings.ejDotWebDotAll.ejNs.GridNs.VirtualScrollMode | String = null,
