...
class PivotClient protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.PivotClientNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.PivotClientNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.PivotClientNs.Model = js.native
  @JSName("model")
  var model_PivotClient: typings.ejDotWebDotAll.ejNs.PivotClientNs.Model = js.native
