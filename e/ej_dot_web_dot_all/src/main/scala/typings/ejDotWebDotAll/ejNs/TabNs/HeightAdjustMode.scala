...
object HeightAdjustMode extends js.Object {
  ...
  /* 2 */ val Auto: typings.ejDotWebDotAll.ejNs.TabNs.HeightAdjustMode.Auto with Double = js.native
  /* 1 */ val Content: typings.ejDotWebDotAll.ejNs.TabNs.HeightAdjustMode.Content with Double = js.native
  /* 3 */ val Fill: typings.ejDotWebDotAll.ejNs.TabNs.HeightAdjustMode.Fill with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.TabNs.HeightAdjustMode.None with Double = js.native
  @JSBracketAccess
