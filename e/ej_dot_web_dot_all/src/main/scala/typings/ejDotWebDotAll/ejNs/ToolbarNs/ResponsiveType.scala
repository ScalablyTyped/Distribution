...
object ResponsiveType extends js.Object {
  ...
  /* 1 */ val Inline: typings.ejDotWebDotAll.ejNs.ToolbarNs.ResponsiveType.Inline with Double = js.native
  /* 0 */ val Popup: typings.ejDotWebDotAll.ejNs.ToolbarNs.ResponsiveType.Popup with Double = js.native
  @JSBracketAccess
