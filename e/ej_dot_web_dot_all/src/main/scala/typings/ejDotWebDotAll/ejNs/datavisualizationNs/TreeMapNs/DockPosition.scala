...
object DockPosition extends js.Object {
  ...
  /* 1 */ val Bottom: typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.DockPosition.Bottom with Double = js.native
  /* 3 */ val Left: typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.DockPosition.Left with Double = js.native
  /* 2 */ val Right: typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.DockPosition.Right with Double = js.native
  /* 0 */ val Top: typings.ejDotWebDotAll.ejNs.datavisualizationNs.TreeMapNs.DockPosition.Top with Double = js.native
  @JSBracketAccess
