...
object ActiveTool extends js.Object {
  ...
  /* 1 */ val Drag: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.ActiveTool.Drag with Double = js.native
  /* 2 */ val Draw: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.ActiveTool.Draw with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.ActiveTool.None with Double = js.native
  @JSBracketAccess
