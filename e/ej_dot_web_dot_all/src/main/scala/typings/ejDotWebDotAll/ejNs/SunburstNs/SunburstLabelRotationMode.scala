...
object SunburstLabelRotationMode extends js.Object {
  ...
  /* 0 */ val Angle: typings.ejDotWebDotAll.ejNs.SunburstNs.SunburstLabelRotationMode.Angle with Double = js.native
  /* 1 */ val Normal: typings.ejDotWebDotAll.ejNs.SunburstNs.SunburstLabelRotationMode.Normal with Double = js.native
  @JSBracketAccess
