...
object AutoFillOptions extends js.Object {
  ...
  /* 0 */ val CopyCells: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.AutoFillOptions.CopyCells with Double = js.native
  /* 2 */ val FillFormattingOnly: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.AutoFillOptions.FillFormattingOnly with Double = js.native
  /* 1 */ val FillSeries: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.AutoFillOptions.FillSeries with Double = js.native
  /* 3 */ val FillWithoutFormatting: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.AutoFillOptions.FillWithoutFormatting with Double = js.native
  /* 4 */ val FlashFill: typings.ejDotWebDotAll.ejNs.SpreadsheetNs.AutoFillOptions.FlashFill with Double = js.native
  @JSBracketAccess
