...
class Tooltip protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.TooltipNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.TooltipNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.TooltipNs.Model = js.native
  @JSName("model")
  var model_Tooltip: typings.ejDotWebDotAll.ejNs.TooltipNs.Model = js.native
