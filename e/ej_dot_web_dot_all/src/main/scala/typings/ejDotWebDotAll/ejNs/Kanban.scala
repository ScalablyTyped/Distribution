...
class Kanban protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.KanbanNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.KanbanNs.Model) = this()
  var KanbanEdit: typings.ejDotWebDotAll.ejNs.KanbanNs.KanbanEdit = js.native
  var KanbanFilter: typings.ejDotWebDotAll.ejNs.KanbanNs.KanbanFilter = js.native
  var KanbanSelection: typings.ejDotWebDotAll.ejNs.KanbanNs.KanbanSelection = js.native
  var KanbanSwimlane: typings.ejDotWebDotAll.ejNs.KanbanNs.KanbanSwimlane = js.native
  var defaults: typings.ejDotWebDotAll.ejNs.KanbanNs.Model = js.native
  @JSName("model")
  var model_Kanban: typings.ejDotWebDotAll.ejNs.KanbanNs.Model = js.native
