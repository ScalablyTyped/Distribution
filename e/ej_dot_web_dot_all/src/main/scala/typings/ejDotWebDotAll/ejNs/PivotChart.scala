...
class PivotChart protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.PivotChartNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.PivotChartNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.PivotChartNs.Model = js.native
  @JSName("model")
  var model_PivotChart: typings.ejDotWebDotAll.ejNs.PivotChartNs.Model = js.native
