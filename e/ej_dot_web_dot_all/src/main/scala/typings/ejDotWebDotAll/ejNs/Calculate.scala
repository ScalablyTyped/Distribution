...
class Calculate protected () extends js.Object {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.CalculateNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.CalculateNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.CalculateNs.Model = js.native
  var model: typings.ejDotWebDotAll.ejNs.CalculateNs.Model = js.native
