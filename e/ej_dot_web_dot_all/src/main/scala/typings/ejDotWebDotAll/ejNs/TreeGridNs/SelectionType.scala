...
object SelectionType extends js.Object {
  ...
  /* 2 */ val Checkbox: typings.ejDotWebDotAll.ejNs.TreeGridNs.SelectionType.Checkbox with Double = js.native
  /* 1 */ val Multiple: typings.ejDotWebDotAll.ejNs.TreeGridNs.SelectionType.Multiple with Double = js.native
  /* 0 */ val Single: typings.ejDotWebDotAll.ejNs.TreeGridNs.SelectionType.Single with Double = js.native
  @JSBracketAccess
