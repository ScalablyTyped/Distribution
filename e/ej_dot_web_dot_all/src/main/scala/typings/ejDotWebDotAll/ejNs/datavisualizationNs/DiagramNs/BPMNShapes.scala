...
object BPMNShapes extends js.Object {
  ...
  /* 5 */ val Activity: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.Activity with Double = js.native
  /* 3 */ val DataObject: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.DataObject with Double = js.native
  /* 4 */ val DataSource: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.DataSource with Double = js.native
  /* 0 */ val Event: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.Event with Double = js.native
  /* 1 */ val Gateway: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.Gateway with Double = js.native
  /* 6 */ val Group: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.Group with Double = js.native
  /* 2 */ val Message: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNShapes.Message with Double = js.native
  @JSBracketAccess
