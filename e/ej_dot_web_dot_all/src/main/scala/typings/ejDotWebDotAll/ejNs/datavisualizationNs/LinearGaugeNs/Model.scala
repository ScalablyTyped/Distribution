...
trait Model extends js.Object {
  ...
  /** Specify tooltip options of linear gauge
    * @Default {false}
    */
  var tooltip: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.Tooltip] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    tooltip: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.Tooltip = null,
