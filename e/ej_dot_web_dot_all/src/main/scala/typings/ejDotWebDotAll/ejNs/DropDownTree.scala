...
class DropDownTree protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.DropDownTreeNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.DropDownTreeNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.DropDownTreeNs.Model = js.native
  @JSName("model")
  var model_DropDownTree: typings.ejDotWebDotAll.ejNs.DropDownTreeNs.Model = js.native
