...
object ExportingType extends js.Object {
  ...
  /* 1 */ val JPG: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.ExportingType.JPG with Double = js.native
  /* 0 */ val PNG: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.ExportingType.PNG with Double = js.native
  @JSBracketAccess
