...
object Orientation extends js.Object {
  ...
  /* 0 */ val Horizontal: typings.ejDotWebDotAll.ejNs.Orientation.Horizontal with Double = js.native
  /* 1 */ val Vertical: typings.ejDotWebDotAll.ejNs.Orientation.Vertical with Double = js.native
  @JSBracketAccess
