...
class ComboBox protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.ComboBoxNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.ComboBoxNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.ComboBoxNs.Model = js.native
  @JSName("model")
  var model_ComboBox: typings.ejDotWebDotAll.ejNs.ComboBoxNs.Model = js.native
