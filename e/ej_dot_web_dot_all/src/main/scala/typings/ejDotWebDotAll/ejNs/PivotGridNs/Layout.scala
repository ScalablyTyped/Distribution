...
object Layout extends js.Object {
  ...
  /* 3 */ val ExcelLikeLayout: typings.ejDotWebDotAll.ejNs.PivotGridNs.Layout.ExcelLikeLayout with Double = js.native
  /* 2 */ val NoSummaries: typings.ejDotWebDotAll.ejNs.PivotGridNs.Layout.NoSummaries with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.PivotGridNs.Layout.Normal with Double = js.native
  /* 1 */ val NormalTopSummary: typings.ejDotWebDotAll.ejNs.PivotGridNs.Layout.NormalTopSummary with Double = js.native
  @JSBracketAccess
