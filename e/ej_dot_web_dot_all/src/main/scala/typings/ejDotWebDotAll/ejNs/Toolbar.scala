...
class Toolbar protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.ToolbarNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.ToolbarNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.ToolbarNs.Model = js.native
  @JSName("model")
  var model_Toolbar: typings.ejDotWebDotAll.ejNs.ToolbarNs.Model = js.native
