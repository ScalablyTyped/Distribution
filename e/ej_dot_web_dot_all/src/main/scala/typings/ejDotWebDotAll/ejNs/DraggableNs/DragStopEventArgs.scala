package typings.ejDotWebDotAll.ejNs.DraggableNs
...
trait DragStopEventArgs extends js.Object {
  ...
  /** returns the draggable model
    */
  var model: js.UndefOr[typings.ejDotWebDotAll.ejNs.DraggableNs.Model] = js.undefined
...
object DragStopEventArgs {
  ...
  def apply(
    ...
    event: js.Any = null,
    model: typings.ejDotWebDotAll.ejNs.DraggableNs.Model = null,
    target: js.Any = null,
    `type`: String = null
  ): DragStopEventArgs = {
