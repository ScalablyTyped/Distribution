...
object DockPosition extends js.Object {
  ...
  /* 1 */ val Bottom: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.DockPosition.Bottom with Double = js.native
  /* 3 */ val Left: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.DockPosition.Left with Double = js.native
  /* 2 */ val Right: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.DockPosition.Right with Double = js.native
  /* 0 */ val Top: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.DockPosition.Top with Double = js.native
  @JSBracketAccess
