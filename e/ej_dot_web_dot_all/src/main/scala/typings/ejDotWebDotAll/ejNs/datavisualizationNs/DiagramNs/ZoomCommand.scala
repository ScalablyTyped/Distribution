...
object ZoomCommand extends js.Object {
  ...
  /* 0 */ val ZoomIn: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.ZoomCommand.ZoomIn with Double = js.native
  /* 1 */ val ZoomOut: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.ZoomCommand.ZoomOut with Double = js.native
  @JSBracketAccess
