...
trait Model extends js.Object {
  ...
  /** Specifies the ajaxSettings option to load the items to the ListView control.
    * @Default {null}
    */
  var ajaxSettings: js.UndefOr[typings.ejDotWebDotAll.ejNs.ListViewNs.AjaxSettings] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    ajaxSettings: typings.ejDotWebDotAll.ejNs.ListViewNs.AjaxSettings = null,
