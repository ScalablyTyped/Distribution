...
trait DataSourceRow extends js.Object {
  ...
  /** Allows you to set the sorting order of members of the field.
    ...
    */
  var sortOrder: js.UndefOr[typings.ejDotWebDotAll.ejNs.PivotAnalysisNs.SortOrder | String] = js.undefined
}
...
object DataSourceRow {
  ...
  def apply(
    ...
    sortOrder: typings.ejDotWebDotAll.ejNs.PivotAnalysisNs.SortOrder | String = null
  ): DataSourceRow = {
