...
object HorizontalAlignment extends js.Object {
  ...
  /* 1 */ val Left: typings.ejDotWebDotAll.ejNs.datavisualizationNs.RangeNavigatorNs.HorizontalAlignment.Left with Double = js.native
  /* 0 */ val Middle: typings.ejDotWebDotAll.ejNs.datavisualizationNs.RangeNavigatorNs.HorizontalAlignment.Middle with Double = js.native
  /* 2 */ val Right: typings.ejDotWebDotAll.ejNs.datavisualizationNs.RangeNavigatorNs.HorizontalAlignment.Right with Double = js.native
  @JSBracketAccess
