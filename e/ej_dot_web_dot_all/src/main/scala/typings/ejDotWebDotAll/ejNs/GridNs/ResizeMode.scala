...
object ResizeMode extends js.Object {
  ...
  /* 2 */ val Control: typings.ejDotWebDotAll.ejNs.GridNs.ResizeMode.Control with Double = js.native
  /* 1 */ val NextColumn: typings.ejDotWebDotAll.ejNs.GridNs.ResizeMode.NextColumn with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.GridNs.ResizeMode.Normal with Double = js.native
  @JSBracketAccess
