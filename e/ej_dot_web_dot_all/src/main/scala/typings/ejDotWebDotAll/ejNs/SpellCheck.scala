...
class SpellCheck protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.SpellCheckNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.SpellCheckNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.SpellCheckNs.Model = js.native
  @JSName("model")
  var model_SpellCheck: typings.ejDotWebDotAll.ejNs.SpellCheckNs.Model = js.native
