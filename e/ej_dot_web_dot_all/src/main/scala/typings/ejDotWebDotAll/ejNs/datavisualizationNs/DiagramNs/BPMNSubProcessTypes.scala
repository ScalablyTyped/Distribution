...
object BPMNSubProcessTypes extends js.Object {
  ...
  /* 2 */ val Event: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSubProcessTypes.Event with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSubProcessTypes.None with Double = js.native
  /* 1 */ val Transaction: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNSubProcessTypes.Transaction with Double = js.native
  @JSBracketAccess
