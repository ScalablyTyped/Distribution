...
object SelectionType extends js.Object {
  ...
  /* 1 */ val Multiple: typings.ejDotWebDotAll.ejNs.GridNs.SelectionType.Multiple with Double = js.native
  /* 0 */ val Single: typings.ejDotWebDotAll.ejNs.GridNs.SelectionType.Single with Double = js.native
  @JSBracketAccess
