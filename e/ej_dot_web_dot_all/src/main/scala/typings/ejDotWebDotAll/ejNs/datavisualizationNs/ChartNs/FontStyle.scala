...
object FontStyle extends js.Object {
  ...
  /* 1 */ val Italic: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.FontStyle.Italic with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.FontStyle.Normal with Double = js.native
  @JSBracketAccess
