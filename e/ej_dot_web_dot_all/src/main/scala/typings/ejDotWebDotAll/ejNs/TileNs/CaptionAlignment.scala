...
object CaptionAlignment extends js.Object {
  ...
  /* 3 */ val Center: typings.ejDotWebDotAll.ejNs.TileNs.CaptionAlignment.Center with Double = js.native
  /* 1 */ val Left: typings.ejDotWebDotAll.ejNs.TileNs.CaptionAlignment.Left with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.TileNs.CaptionAlignment.Normal with Double = js.native
  /* 2 */ val Right: typings.ejDotWebDotAll.ejNs.TileNs.CaptionAlignment.Right with Double = js.native
  @JSBracketAccess
