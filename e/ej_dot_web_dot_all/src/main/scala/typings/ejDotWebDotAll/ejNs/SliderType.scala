...
object SliderType extends js.Object {
  ...
  /* 0 */ val Default: typings.ejDotWebDotAll.ejNs.SliderType.Default with Double = js.native
  /* 1 */ val MinRange: typings.ejDotWebDotAll.ejNs.SliderType.MinRange with Double = js.native
  /* 2 */ val Range: typings.ejDotWebDotAll.ejNs.SliderType.Range with Double = js.native
  @JSBracketAccess
