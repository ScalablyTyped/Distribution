...
object ExportingType extends js.Object {
  ...
  /* 1 */ val JPG: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.ExportingType.JPG with Double = js.native
  /* 0 */ val PNG: typings.ejDotWebDotAll.ejNs.datavisualizationNs.LinearGaugeNs.ExportingType.PNG with Double = js.native
  @JSBracketAccess
