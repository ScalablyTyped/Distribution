...
class Ribbon protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.RibbonNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.RibbonNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.RibbonNs.Model = js.native
  @JSName("model")
  var model_Ribbon: typings.ejDotWebDotAll.ejNs.RibbonNs.Model = js.native
