...
object CurrentView extends js.Object {
  ...
  /* 4 */ val Agenda: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.Agenda with Double = js.native
  /* 5 */ val CustomView: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.CustomView with Double = js.native
  /* 0 */ val Day: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.Day with Double = js.native
  /* 3 */ val Month: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.Month with Double = js.native
  /* 1 */ val Week: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.Week with Double = js.native
  /* 2 */ val Workweek: typings.ejDotWebDotAll.ejNs.ScheduleNs.CurrentView.Workweek with Double = js.native
  @JSBracketAccess
