...
object AssociationFlows extends js.Object {
  ...
  /* 2 */ val BiDirectional: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.AssociationFlows.BiDirectional with Double = js.native
  /* 0 */ val Default: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.AssociationFlows.Default with Double = js.native
  /* 1 */ val Directional: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.AssociationFlows.Directional with Double = js.native
  @JSBracketAccess
