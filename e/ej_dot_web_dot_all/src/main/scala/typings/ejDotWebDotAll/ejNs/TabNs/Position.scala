...
object Position extends js.Object {
  ...
  /* 1 */ val Bottom: typings.ejDotWebDotAll.ejNs.TabNs.Position.Bottom with Double = js.native
  /* 2 */ val Left: typings.ejDotWebDotAll.ejNs.TabNs.Position.Left with Double = js.native
  /* 3 */ val Right: typings.ejDotWebDotAll.ejNs.TabNs.Position.Right with Double = js.native
  /* 0 */ val Top: typings.ejDotWebDotAll.ejNs.TabNs.Position.Top with Double = js.native
  @JSBracketAccess
