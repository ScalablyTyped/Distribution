...
object OverflowType extends js.Object {
  ...
  /* 1 */ val Clip: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.OverflowType.Clip with Double = js.native
  /* 0 */ val Ellipsis: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.OverflowType.Ellipsis with Double = js.native
  @JSBracketAccess
