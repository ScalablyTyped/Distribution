...
import typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHorizontalAlignment
import typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstVerticalAlignment
