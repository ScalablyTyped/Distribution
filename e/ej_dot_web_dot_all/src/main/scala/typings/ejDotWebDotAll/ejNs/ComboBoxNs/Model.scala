...
trait Model extends js.Object {
  ...
  /** Specifies the sortOrder to sort the data source. The available type of sort orders are
    ...
    */
  var sortOrder: js.UndefOr[typings.ejDotWebDotAll.ejNs.ComboBoxNs.SortOrder | String] = js.undefined
...
object Model {
  ...
  def apply(
    ...
    sortOrder: typings.ejDotWebDotAll.ejNs.ComboBoxNs.SortOrder | String = null,
    text: String = null,
