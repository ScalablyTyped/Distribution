...
class Schedule protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.ScheduleNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.ScheduleNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.ScheduleNs.Model = js.native
  @JSName("model")
  var model_Schedule: typings.ejDotWebDotAll.ejNs.ScheduleNs.Model = js.native
