...
object SelectionType extends js.Object {
  ...
  /* 1 */ val Multiple: typings.ejDotWebDotAll.ejNs.KanbanNs.SelectionType.Multiple with Double = js.native
  /* 0 */ val Single: typings.ejDotWebDotAll.ejNs.KanbanNs.SelectionType.Single with Double = js.native
  @JSBracketAccess
