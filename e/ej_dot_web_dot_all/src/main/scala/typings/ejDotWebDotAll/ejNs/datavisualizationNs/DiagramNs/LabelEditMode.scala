...
object LabelEditMode extends js.Object {
  ...
  /* 0 */ val Edit: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LabelEditMode.Edit with Double = js.native
  /* 1 */ val View: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LabelEditMode.View with Double = js.native
  @JSBracketAccess
