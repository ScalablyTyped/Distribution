...
object ExportingMode extends js.Object {
  ...
  /* 1 */ val ClientSide: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ExportingMode.ClientSide with Double = js.native
  /* 0 */ val ServerSide: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.ExportingMode.ServerSide with Double = js.native
  @JSBracketAccess
