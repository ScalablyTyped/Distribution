...
object ProcessingMode extends js.Object {
  ...
  /* 1 */ val Local: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ProcessingMode.Local with Double = js.native
  /* 0 */ val Remote: typings.ejDotWebDotAll.ejNs.ReportViewerNs.ProcessingMode.Remote with Double = js.native
  @JSBracketAccess
