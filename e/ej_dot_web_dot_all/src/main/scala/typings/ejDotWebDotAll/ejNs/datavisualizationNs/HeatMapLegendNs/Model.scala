package typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapLegendNs

import typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendMode
import typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendOrientation
