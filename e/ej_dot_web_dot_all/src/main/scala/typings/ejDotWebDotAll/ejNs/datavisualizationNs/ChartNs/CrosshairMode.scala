...
object CrosshairMode extends js.Object {
  ...
  /* 0 */ val Float: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.CrosshairMode.Float with Double = js.native
  /* 1 */ val Grouping: typings.ejDotWebDotAll.ejNs.datavisualizationNs.ChartNs.CrosshairMode.Grouping with Double = js.native
  @JSBracketAccess
