...
object SunburstHighlightMode extends js.Object {
  ...
  /* 3 */ val All: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightMode.All with Double = js.native
  /* 2 */ val Child: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightMode.Child with Double = js.native
  /* 1 */ val Parent: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightMode.Parent with Double = js.native
  /* 0 */ val Point: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightMode.Point with Double = js.native
  @JSBracketAccess
