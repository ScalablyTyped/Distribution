...
object FontStyle extends js.Object {
  ...
  /* 1 */ val Italic: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.FontStyle.Italic with Double = js.native
  /* 0 */ val Normal: typings.ejDotWebDotAll.ejNs.datavisualizationNs.MapNs.FontStyle.Normal with Double = js.native
  @JSBracketAccess
