...
trait Scale extends js.Object {
  ...
  var direction: js.UndefOr[
    typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.Direction | String
  ] = js.undefined
...
object Scale {
  ...
  def apply(
    ...
    direction: typings.ejDotWebDotAll.ejNs.datavisualizationNs.CircularGaugeNs.Direction | String = null,
