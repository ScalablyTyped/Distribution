...
object EditingType extends js.Object {
  ...
  /* 1 */ val Boolean: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.Boolean with Double = js.native
  /* 4 */ val DatePicker: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.DatePicker with Double = js.native
  /* 5 */ val DateTimePicker: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.DateTimePicker with Double = js.native
  /* 3 */ val Dropdown: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.Dropdown with Double = js.native
  /* 2 */ val Numeric: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.Numeric with Double = js.native
  /* 0 */ val String: typings.ejDotWebDotAll.ejNs.GridNs.EditingType.String with Double = js.native
  @JSBracketAccess
