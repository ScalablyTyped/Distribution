...
object BPMNFlows extends js.Object {
  ...
  /* 1 */ val Association: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNFlows.Association with Double = js.native
  /* 2 */ val Message: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNFlows.Message with Double = js.native
  /* 0 */ val Sequence: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.BPMNFlows.Sequence with Double = js.native
  @JSBracketAccess
