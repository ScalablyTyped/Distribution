...
object Textmode extends js.Object {
  ...
  /* 1 */ val FullPath: typings.ejDotWebDotAll.ejNs.Textmode.FullPath with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.Textmode.None with Double = js.native
  @JSBracketAccess
