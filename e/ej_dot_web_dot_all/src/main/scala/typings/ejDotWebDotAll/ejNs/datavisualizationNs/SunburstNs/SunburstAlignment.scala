...
object SunburstAlignment extends js.Object {
  ...
  /* 0 */ val Center: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstAlignment.Center with Double = js.native
  /* 2 */ val Far: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstAlignment.Far with Double = js.native
  /* 1 */ val Near: typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstAlignment.Near with Double = js.native
  @JSBracketAccess
