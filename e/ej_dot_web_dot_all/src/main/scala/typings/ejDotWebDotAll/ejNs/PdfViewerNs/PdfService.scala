...
object PdfService extends js.Object {
  ...
  /* 0 */ val Local: typings.ejDotWebDotAll.ejNs.PdfViewerNs.PdfService.Local with Double = js.native
  /* 1 */ val Remote: typings.ejDotWebDotAll.ejNs.PdfViewerNs.PdfService.Remote with Double = js.native
  @JSBracketAccess
