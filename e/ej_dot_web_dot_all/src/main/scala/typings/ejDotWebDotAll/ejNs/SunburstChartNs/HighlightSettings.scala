...
import typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightMode
import typings.ejDotWebDotAll.ejNs.datavisualizationNs.SunburstNs.SunburstHighlightType
