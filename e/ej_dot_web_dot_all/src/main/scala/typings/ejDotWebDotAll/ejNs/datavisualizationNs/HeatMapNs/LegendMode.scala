...
object LegendMode extends js.Object {
  ...
  /* 0 */ val Gradient: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendMode.Gradient with Double = js.native
  /* 1 */ val List: typings.ejDotWebDotAll.ejNs.datavisualizationNs.HeatMapNs.LegendMode.List with Double = js.native
  @JSBracketAccess
