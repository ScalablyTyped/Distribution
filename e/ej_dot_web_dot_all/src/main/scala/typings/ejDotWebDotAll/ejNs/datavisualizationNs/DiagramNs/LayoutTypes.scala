...
object LayoutTypes extends js.Object {
  ...
  /* 1 */ val HierarchicalTree: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutTypes.HierarchicalTree with Double = js.native
  /* 0 */ val None: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutTypes.None with Double = js.native
  /* 2 */ val OrganizationalChart: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutTypes.OrganizationalChart with Double = js.native
  /* 3 */ val RadialTree: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutTypes.RadialTree with Double = js.native
  /* 4 */ val SymmetricLayout: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutTypes.SymmetricLayout with Double = js.native
  @JSBracketAccess
