...
class Menu protected () extends Widget {
  ...
  def this(element: JQuery, options: typings.ejDotWebDotAll.ejNs.MenuNs.Model) = this()
  def this(element: Element, options: typings.ejDotWebDotAll.ejNs.MenuNs.Model) = this()
  var defaults: typings.ejDotWebDotAll.ejNs.MenuNs.Model = js.native
  @JSName("model")
  var model_Menu: typings.ejDotWebDotAll.ejNs.MenuNs.Model = js.native
