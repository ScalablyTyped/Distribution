...
object LayoutOrientations extends js.Object {
  ...
  /* 1 */ val BottomToTop: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutOrientations.BottomToTop with Double = js.native
  /* 2 */ val LeftToRight: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutOrientations.LeftToRight with Double = js.native
  /* 3 */ val RightToLeft: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutOrientations.RightToLeft with Double = js.native
  /* 0 */ val TopToBottom: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.LayoutOrientations.TopToBottom with Double = js.native
  @JSBracketAccess
