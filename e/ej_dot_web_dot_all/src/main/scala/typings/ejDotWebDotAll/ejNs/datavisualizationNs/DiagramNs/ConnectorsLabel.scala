...
trait ConnectorsLabel extends js.Object {
  ...
  /** Defines how to align the text inside the label.
    ...
    */
  var textAlign: js.UndefOr[typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.TextAlign | String] = js.undefined
...
object ConnectorsLabel {
  ...
  def apply(
    ...
    text: String = null,
    textAlign: typings.ejDotWebDotAll.ejNs.datavisualizationNs.DiagramNs.TextAlign | String = null,
