...
object nativeLinearGradientTypesMod {
  
  type NativeLinearGradientPoint = js.Tuple2[Double, Double]
  
  /* Inlined react-native.react-native.ViewProps & react.react.PropsWithChildren<{  colors :std.Array<number>,   locations :std.Array<number> | null | undefined,   startPoint :expo-linear-gradient.expo-linear-gradient/build/NativeLinearGradient.types.NativeLinearGradientPoint | null | undefined,   endPoint :expo-linear-gradient.expo-linear-gradient/build/NativeLinearGradient.types.NativeLinearGradientPoint | null | undefined}> */
  trait NativeLinearGradientProps extends StObject {
  ...
  object NativeLinearGradientProps {
    
    inline def apply(colors: js.Array[Double]): NativeLinearGradientProps = {
