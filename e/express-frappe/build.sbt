...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "cors" % "2.8-dt-20180910Z-d499aa",
  "com.scalablytyped" %%% "express" % "4.16-dt-20180910Z-1b16d7",
  "com.scalablytyped" %%% "express-promise-router" % "2.0-dt-20180910Z-9816f5",
  "com.scalablytyped" %%% "express-routers" % "1.0.1-55d8eb",
  "com.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20180910Z-bec6af",
  "com.scalablytyped" %%% "mime" % "2.0-dt-20180910Z-c023cc",
  "com.scalablytyped" %%% "morgan" % "1.7-dt-20180910Z-17c376",
