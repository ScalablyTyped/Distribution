...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "cors" % "2.8-dt-20180910Z-420f62",
  "com.scalablytyped" %%% "express" % "4.16-dt-20180910Z-4d8764",
  "com.scalablytyped" %%% "express-promise-router" % "2.0-dt-20180910Z-3ed258",
  "com.scalablytyped" %%% "express-routers" % "1.0.1-831c69",
  "com.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20180910Z-43b19a",
  "com.scalablytyped" %%% "mime" % "2.0-dt-20180910Z-f9ab87",
  "com.scalablytyped" %%% "morgan" % "1.7-dt-20180910Z-14c869",
