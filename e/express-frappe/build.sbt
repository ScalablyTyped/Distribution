...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "express-promise-router" % "2.0-dt-20180910Z-a1d83e",
  "org.scalablytyped" %%% "express-routers" % "1.0.1-eee9ca",
  "org.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20180910Z-a3aa42",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20180910Z-08f14a",
  "org.scalablytyped" %%% "morgan" % "1.7-dt-20180910Z-dfa593",
