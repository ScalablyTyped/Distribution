...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "express-promise-router" % "2.0-dt-20181102Z-70ecb8",
  "com.scalablytyped" %%% "express-routers" % "1.0.1-463677",
  "com.scalablytyped" %%% "express-serve-static-core" % "4.16-dt-20181102Z-8da2fa",
  "com.scalablytyped" %%% "mime" % "2.0-dt-20181102Z-16ee55",
  "com.scalablytyped" %%% "morgan" % "1.7-dt-20181102Z-00ed87",
