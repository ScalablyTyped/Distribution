...
import typings.eggDashLogger.eggDashLoggerMod.EggLoggers
...
class EggApplication ()
  ...
  var Service: Instantiable0[typings.egg.eggMod.Service] = js.native
  var Subscription: Instantiable0[typings.egg.eggMod.Subscription] = js.native
  /**
