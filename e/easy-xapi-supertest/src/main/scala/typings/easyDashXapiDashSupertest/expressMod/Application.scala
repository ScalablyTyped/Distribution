...
import typings.easyDashXapiDashSupertest.Fn_Handlers
import typings.easyDashXapiDashSupertest.httpMod.Server
...
trait Application
  extends IRouter[Application]
     with typings.easyDashXapiDashSupertest.ExpressNs.Application {
  @JSName("get")
