...
import typings.easyXapiSupertest.httpMod.Server
import typings.easyXapiSupertest.httpMod.ServerRequest
import typings.easyXapiSupertest.httpMod.ServerResponse
...
object expressMod {
  ...
  inline def apply(): typings.easyXapiSupertest.expressMod.Express = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.easyXapiSupertest.expressMod.Express]
  ...
  */
  ...
  inline def static_=(x: js.Function2[/* root */ String, /* options */ js.UndefOr[Dotfiles], Handler]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("static")(x.asInstanceOf[js.Any])
  
  @js.native
  trait Application
    extends IRouter[Application]
       with typings.easyXapiSupertest.Express.Application {
  ...
  trait Request
    extends ServerRequest
       with typings.easyXapiSupertest.Express.Request {
  ...
  trait Response
    extends ServerResponse
       with typings.easyXapiSupertest.Express.Response {
