...
object ^ extends js.Object {
  ...
  def format(pathObject: easyDashXapiDashSupertestLib.pathMod.ParsedPath): java.lang.String = js.native
  ...
  def parse(pathString: java.lang.String): easyDashXapiDashSupertestLib.pathMod.ParsedPath = js.native
