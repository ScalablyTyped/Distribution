...
trait ReplOptions extends js.Object {
  ...
  var input: js.UndefOr[easyDashXapiDashSupertestLib.NodeJSNs.ReadableStream] = js.undefined
  var output: js.UndefOr[easyDashXapiDashSupertestLib.NodeJSNs.WritableStream] = js.undefined
...
object ReplOptions {
  ...
  def apply(
    ...
    input: easyDashXapiDashSupertestLib.NodeJSNs.ReadableStream = null,
    output: easyDashXapiDashSupertestLib.NodeJSNs.WritableStream = null,
