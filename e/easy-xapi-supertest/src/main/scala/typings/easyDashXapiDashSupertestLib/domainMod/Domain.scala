package typings
package easyDashXapiDashSupertestLib.domainMod
...
class Domain ()
  ...
  def add(emitter: easyDashXapiDashSupertestLib.eventsMod.EventEmitter): scala.Unit = js.native
  ...
  def remove(emitter: easyDashXapiDashSupertestLib.eventsMod.EventEmitter): scala.Unit = js.native
