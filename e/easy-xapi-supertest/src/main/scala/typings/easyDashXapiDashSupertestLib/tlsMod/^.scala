...
object ^ extends js.Object {
  ...
  def createSecurePair(credentials: easyDashXapiDashSupertestLib.cryptoMod.Credentials): SecurePair = js.native
  def createSecurePair(credentials: easyDashXapiDashSupertestLib.cryptoMod.Credentials, isServer: scala.Boolean): SecurePair = js.native
