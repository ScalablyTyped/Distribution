...
trait Global extends js.Object {
  ...
  var Buffer: easyDashXapiDashSupertestLib.Anon_Array = js.native
  ...
  var Intl: easyDashXapiDashSupertestLib.TypeofIntl = js.native
  ...
  var encodeURIComponent_Original: easyDashXapiDashSupertestLib.Fn_UriComponent = js.native
  @JSName("encodeURI")
  ...
  @JSName("parseInt")
  var parseInt_Original: easyDashXapiDashSupertestLib.Fn_Radix = js.native
