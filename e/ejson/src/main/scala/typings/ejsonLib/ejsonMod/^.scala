...
object ^ extends js.Object {
  ...
  def equals(a: js.Any, b: js.Any, options: ejsonLib.ejsonMod.CloneOptions): scala.Boolean = js.native
  ...
  def stringify(obj: js.Any, options: ejsonLib.ejsonMod.StringifyOptions): java.lang.String = js.native
