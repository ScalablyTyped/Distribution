...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typings.calDashHeatmap.calDashHeatmapMod.Global.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typings.calDashHeatmap.calDashHeatmapMod.Global.CalHeatMap.CalHeatMap = js.native
  /**
