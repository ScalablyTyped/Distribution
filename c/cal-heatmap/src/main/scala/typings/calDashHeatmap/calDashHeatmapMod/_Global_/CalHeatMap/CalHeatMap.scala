...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typings.calDashHeatmap.calDashHeatmapMod._Global_.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typings.calDashHeatmap.calDashHeatmapMod._Global_.CalHeatMap.CalHeatMap = js.native
  /**
