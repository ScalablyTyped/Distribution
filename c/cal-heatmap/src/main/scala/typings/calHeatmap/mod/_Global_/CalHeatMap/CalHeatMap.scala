...
trait CalHeatMap extends js.Object {
  ...
  /**
  			 ...
  			 */
  def destroy(): typings.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  def destroy(callback: js.Function): typings.calHeatmap.mod._Global_.CalHeatMap.CalHeatMap = js.native
  /**
