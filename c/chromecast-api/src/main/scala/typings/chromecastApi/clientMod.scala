...
object clientMod {
  ...
  trait Client extends EventEmitter {
    ...
    /**
      ...
      */
    var devices: js.Array[typings.chromecastApi.deviceMod.^] = js.native
    
    /**
      * The device event is emitted each time a new device has been found.
      */
    @JSName("on")
    def on_device(event: device, listener: js.Function1[/* d */ typings.chromecastApi.deviceMod.^, Unit]): this.type = js.native
