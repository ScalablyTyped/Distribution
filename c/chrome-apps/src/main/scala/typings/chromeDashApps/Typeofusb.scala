...
trait Typeofusb extends js.Object {
  ...
  /**
    ...
    * @param callback
    */
  def findDevices(options: Anon_InterfaceId, callback: js.Function1[/* handles */ js.Array[ConnectionHandle], Unit]): Unit = js.native
  /**
    * Finds USB devices specified by the vendor, product and (optionally) interface IDs and if permissions allow opens them for use.
    * If the access request is rejected or the device fails to be opened a connection handle will not be created or returned.
    * Calling this method is equivalent to calling *getDevices* followed by *openDevice* for each device.
    ...
    * @param callback
    */
  def findDevices(options: Anon_ProductId, callback: js.Function1[/* handles */ js.Array[ConnectionHandle], Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback
    */
  def getDevices(options: Anon_FiltersArray, callback: js.Function1[/* devices */ js.Array[Device], Unit]): Unit = js.native
  /**
    ...
    */
  def getUserSelectedDevices(options: Anon_FiltersMultiple, callback: js.Function1[/* devices */ js.Array[Device], Unit]): Unit = js.native
  /**
