...
trait TypeoffileSystemProvider extends js.Object {
  ...
  /**
    ...
    */
  val CommonActionId: Anon_OFFLINENOTNECESSARY = js.native
  /** Mode of opening a file. Used by onOpenFileRequested. */
  val OpenFileMode: Anon_READ = js.native
  /**
    ...
    js.Function3[
      ...
      /* errorCallback */ js.Function1[
        /* error */ ToStringLiteral[
          /* import warning: ImportType.apply Failed type conversion: typeof ProviderError */ js.Any, 
          String, 
          Exclude[
            String, 
            /* import warning: ImportType.apply Failed type conversion: typeof ProviderError[keyof typeof ProviderError] */ js.Any
          ]
        ], 
        Unit
      ], 
