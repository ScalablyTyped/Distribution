...
import typings.chromeDashApps.chromeDashAppsStrings.system
...
object powerNs extends js.Object {
  ...
  /**
    ...
    */
  def requestKeepAwake(level: ToStringLiteral[Anon_DISPLAY, String, Exclude[String, system | display]]): Unit = js.native
  /**
    * @enum
