...
object ^ extends js.Object {
  /**
    ...
    * @since Chrome 52.
    */
  val onCharacteristicReadRequest: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* characteristic */ Characteristic, Unit]] = js.native
  /**
    ...
    */
  val onCharacteristicValueChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* characteristic */ Characteristic, Unit]] = js.native
  /**
    ...
    * @since Chrome 52.
    */
  val onCharacteristicWriteRequest: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* characteristic */ Characteristic, Unit]] = js.native
  /**
    * Fired when a connected central device requests to read the value of
    ...
    * @since Chrome 52.
    */
  val onDescriptorReadRequest: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* descriptor */ Descriptor, Unit]] = js.native
  /**
    ...
    */
  val onDescriptorValueChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* descriptor */ Descriptor, Unit]] = js.native
  /**
    * Fired when a connected central device requests to write the value of
    *   a descriptor registered on the local GATT server.
    * Not responding to this request for a long time may lead to a disconnection.
    ...
    * The peripheral permission may not be available to all apps.
    */
  val onDescriptorWriteRequest: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* descriptor */ Descriptor, Unit]] = js.native
  /** Fired whan a new GATT service has been discovered on a remote device. */
  val onServiceAdded: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* service */ Service, Unit]] = js.native
  /**
    ...
    */
  val onServiceChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* service */ Service, Unit]] = js.native
  /** Fired when a GATT service that was previously discovered on a remote device has been removed. */
  val onServiceRemoved: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* service */ Service, Unit]] = js.native
  /**
