...
object ^ extends js.Object {
  ...
  val onButtonClicked: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function2[/* notificationId */ String, /* buttonIndex */ integer, Unit]] = js.native
  /** The user clicked in a non-button area of the notification. */
  val onClicked: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* notificationId */ String, Unit]] = js.native
  /** The notification closed, either by the system or by user action. */
  val onClosed: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function2[/* notificationId */ String, /* byUser */ Boolean, Unit]] = js.native
  /**
    * The user changes the permission level.
    * @since Chrome 32.
    */
  val onPermissionLevelChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* level */ String, Unit]] = js.native
  /**
    ...
    */
  val onShowSettings: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function0[Unit]] = js.native
  /**
