...
object LaunchSource extends js.Object {
  var ABOUT_PAGE: about_page = js.native
  var APP_LAUNCHER: app_launcher = js.native
  var BACKGROUND: background = js.native
  var CHROME_INTERNAL: chrome_internal = js.native
  var COMMAND_LINE: command_line = js.native
  var CONTEXT_MENU: context_menu = js.native
  var EPHEMERAL_APP: ephemeral_app = js.native
  var EXTENSIONS_PAGE: extensions_page = js.native
  var FILE_HANDLER: file_handler = js.native
  var INSTALLED_NOTIFICATION: installed_notification = js.native
  var KEYBOARD: keyboard = js.native
  var KIOSK: kiosk = js.native
  var LOAD_AND_LAUNCH: load_and_launch = js.native
  var MANAGEMENT_API: management_api = js.native
  var NEW_TAB_PAGE: new_tab_page = js.native
  var RELOAD: reload = js.native
  var RESTART: restart = js.native
  var SYSTEM_TRAY: system_tray = js.native
  var TEST: test = js.native
  var UNTRACKED: untracked = js.native
  var URL_HANDLER: url_handler = js.native
}
