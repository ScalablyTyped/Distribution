...
object PowerSourceType extends js.Object {
  ...
  /* "mains" */ val mains: typings.chromeDashApps.chromeNs.systemNs.powerSourceNs.PowerSourceType.mains with String = js.native
  /* "unknown" */ val unknown: typings.chromeDashApps.chromeNs.systemNs.powerSourceNs.PowerSourceType.unknown with String = js.native
  /* "usb" */ val usb: typings.chromeDashApps.chromeNs.systemNs.powerSourceNs.PowerSourceType.usb with String = js.native
  @JSBracketAccess
