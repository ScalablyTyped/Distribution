...
trait CellularProperties[M /* <: ManagedObject */] extends CellularBase {
  ...
  var PaymentPortal: js.UndefOr[
    typings.chromeDashApps.chromeNs.networkingNs.oncNs.PaymentPortal | PaymentPortalPost
  ] = js.undefined
  /** The state of SIM lock for GSM family networks. */
  var SIMLockStatus: js.UndefOr[typings.chromeDashApps.chromeNs.networkingNs.oncNs.SIMLockStatus] = js.undefined
  /**
    * @since Chrome 63.
...
object CellularProperties {
  ...
  def apply[M /* <: ManagedObject */](
    ...
    PRLVersion: js.UndefOr[integer] = js.undefined,
