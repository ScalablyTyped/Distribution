...
object ^ extends js.Object {
  /**
    ...
    */
  val onDeviceStateListChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function0[Unit]] = js.native
  /**
    * Fired when the list of networks has changed. Sends a complete list of GUIDs for all the current networks.
    */
  val onNetworkListChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
  //
  // EVENTS
  //
  /**
    ...
    */
  val onNetworksChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* changes */ js.Array[String], Unit]] = js.native
  /**
    ...
    */
  val onPortalDetectionCompleted: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function2[/* networkGuid */ String, /* status */ CaptivePortalStatus, Unit]] = js.native
  /**
