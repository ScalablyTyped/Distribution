...
object ^ extends js.Object {
  ...
  val onInstalled: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* details */ InstalledDetails, Unit]] = js.native
  /**
  ...
  /**
    ...
    * @since Chrome 29.
    */
  val onRestartRequired: typings.chromeDashApps.chromeNs.eventsNs.Event[
    js.Function1[
  ...
  /**
    ...
    * @since Chrome 25.
    */
  val onUpdateAvailable: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* details */ UpdateAvailableDetails, Unit]] = js.native
  /**
