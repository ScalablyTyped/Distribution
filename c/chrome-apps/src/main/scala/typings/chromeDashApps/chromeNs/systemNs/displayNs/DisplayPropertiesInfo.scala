...
import typings.chromeDashApps.chromeDashAppsNumbers.`180`
import typings.chromeDashApps.chromeDashAppsNumbers.`270`
import typings.chromeDashApps.chromeDashAppsNumbers.`90`
...
object DisplayPropertiesInfo {
  ...
  def apply(
    ...
    boundsOriginX: js.UndefOr[integer] = js.undefined,
