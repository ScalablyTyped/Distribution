...
trait FileStatusChangedDetail extends js.Object {
  /**
    ...
    * @see SyncAction
    */
  var action: js.UndefOr[ToStringLiteral[Anon_ADDED, String, Exclude[String, added | updated | deleted]]] = js.undefined
  /**
...
object FileStatusChangedDetail {
  ...
  def apply(
    ...
    action: ToStringLiteral[Anon_ADDED, String, Exclude[String, added | updated | deleted]] = null,
