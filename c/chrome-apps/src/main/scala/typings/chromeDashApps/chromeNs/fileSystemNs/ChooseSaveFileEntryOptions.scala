...
- typings.chromeDashApps.chromeNs.fileSystemNs.ChooseEntryOptions because Already inherited */ trait ChooseSaveFileEntryOptions extends ChooseEntryOptionsBase {
  var `type`: saveFile
}
