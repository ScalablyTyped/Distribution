...
@js.native
object udpNs extends js.Object {
  /**
    ...
    */
  val onReceive: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* args */ ReceiveEventArgs, Unit]] = js.native
  /**
    ...
    */
  val onReceiveError: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* args */ ReceiveErrorEventArgs, Unit]] = js.native
  /**
