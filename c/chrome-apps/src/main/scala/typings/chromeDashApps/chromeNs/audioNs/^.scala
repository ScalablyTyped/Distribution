...
object ^ extends js.Object {
  /**
    ...
    */
  val onDeviceListChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function1[/* devices */ js.Array[AudioDeviceInfo], Unit]] = js.native
  /** Fired when sound level changes for an active audio device. */
  val onLevelChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function2[/* deviceId */ String, /* level */ integer, Unit]] = js.native
  /**
    ...
    */
  val onMuteChanged: typings.chromeDashApps.chromeNs.eventsNs.Event[js.Function2[/* streamType */ js.Array[StreamType], /* isMuted */ Boolean, Unit]] = js.native
