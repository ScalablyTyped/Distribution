...
object desktopCapture extends js.Object {
  ...
  def chooseDesktopMedia(
    sources: js.Array[
      ToStringLiteral[
        Anon_AUDIO, 
        String, 
        Exclude[String, screen | window | tab | typings.chromeDashApps.chromeDashAppsStrings.audio]
      ]
    ],
  ...
  object DesktopCaptureSourceType extends js.Object {
    var AUDIO: typings.chromeDashApps.chromeDashAppsStrings.audio = js.native
