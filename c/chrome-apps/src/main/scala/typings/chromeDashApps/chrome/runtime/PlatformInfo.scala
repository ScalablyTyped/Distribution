...
trait PlatformInfo extends js.Object {
  /**
    ...
    */
  var arch: ToStringLiteral[Anon_ARM, String, Exclude[String, mips64 | arm | `x86-64` | `x86-32` | mips]]
  /**
  ...
  /**
    ...
    * @see enum PlatformOs
    */
  var os: ToStringLiteral[Anon_ANDROID, String, Exclude[String, linux | openbsd | android | win | cros | mac]]
}

object PlatformInfo {
  @scala.inline
  def apply(
    arch: ToStringLiteral[Anon_ARM, String, Exclude[String, mips64 | arm | `x86-64` | `x86-32` | mips]],
    nacl_arch: ToStringLiteral[Anon_ARM, String, Exclude[String, mips64 | arm | `x86-64` | `x86-32` | mips]],
    os: ToStringLiteral[Anon_ANDROID, String, Exclude[String, linux | openbsd | android | win | cros | mac]]
  ): PlatformInfo = {
