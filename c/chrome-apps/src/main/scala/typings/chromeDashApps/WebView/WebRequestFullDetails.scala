...
- typings.chromeDashApps.WebView.ResourceRequest because Already inherited
- typings.chromeDashApps.WebView.WebRequestDetails because Already inherited
- typings.chromeDashApps.WebView.WebRequestBodyDetails because var conflicts: frameId, initiator, method, parentFrameId, requestId, tabId, timeStamp, `type`, url. Inlined requestBody */ trait WebRequestFullDetails extends WebRequestHeadersDetails {
  /**
