...
object WebViewElementEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("consolemessage")(consolemessage)
    __obj.updateDynamic("contentload")(contentload)
    ...
    __obj.updateDynamic("findupdate")(findupdate)
    ...
    __obj.updateDynamic("loadabort")(loadabort)
    __obj.updateDynamic("loadcommit")(loadcommit)
    ...
    __obj.updateDynamic("loadredirect")(loadredirect)
    __obj.updateDynamic("loadstart")(loadstart)
    __obj.updateDynamic("loadstop")(loadstop)
    ...
    __obj.updateDynamic("permissionrequest")(permissionrequest)
    ...
    __obj.updateDynamic("sizechanged")(sizechanged)
