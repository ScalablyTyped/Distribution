...
trait Anon_AccessibilityFeatures extends js.Object {
  ...
  /**
    ...
    */
  val bluetoothLowEnergyNs: Anon_Advertisement
  // #endregion
  ...
  /**
    ...
    */
  val bluetoothNs: Anon_AdapterInfo
  /**
    * @since Chrome 37
    * @requires Manifest: 'bluetooth': {...}
    ...
    */
  val bluetoothSocketNs: Anon_Address
  // #endregion
  ...
  /**
    ...
    */
  val browserNs: Anon_CallbackOpenTab
  // #endregion
  ...
  /**
    ...
    */
  val certificateProviderNs: Anon_CallbackCertificates
  // #endregion
  ...
  /**
    ...
    */
  val clipboardNs: Anon_AdditionalItems
  // #endregion
  ...
  /**
    ...
    */
  val diagnosticsNs: Anon_CallbackOptions
  // #endregion
  ...
  /**
    ...
    */
  val displaySourceNs: Anon_AuthenticationMethod
  // #endregion
  // #region chrome.dns
  /////////
  // DNS //
  ...
  /**
    ...
    */
  val dnsNs: Anon_CallbackHostname
  // #endregion
  ...
  /**
    ...
    * @requires Important: This API works only on Chrome OS.
    */
  val documentScanNs: Anon_CallbackOptionsResult
  ...
  /**
    ...
    */
  val fileBrowserHandlerNs: Anon_CallbackDetails
  // #endregion
  ...
  /**
    ...
    */
  val fileSystemNs: Anon_CallbackChildChangeType
  // #endregion
  ...
  /**
    ...
    */
  val fileSystemProviderNs: Anon_ActionsCallback
  // #endregion
  // #region chrome.gcm
  ////////////////////////////
  ...
  /**
    ...
    * @since Chrome 38.
    */
  val hidNs: Anon_CallbackConnect
  // #endregion
  // #region chrome.i18n
  /////////////////////////////////
  ...
  /**
    ...
    * @since Chrome 46
    */
  val instanceIDNs: Anon_CallbackCreationTime
  // #endregion
  ...
  /**
    ...
    */
  val managementNs: Anon_CallbackExtensionDisabledReason
  // #endregion
  // #region chrome.mdns
  //////////
  // mDNS //
  ...
  /**
    ...
    * @since Chrome 31
    */
  val mdnsNs: Anon_CallbackForceDiscovery
  // #endregion
  ...
  /**
    ...
    */
  val mediaGalleriesNs: Anon_AddGalleryWatch
  ...
  /**
    ...
    */
  val platformKeysNs: Anon_CallbackCertificateClientCertificateType
  // #endregion
  // #region chrome.power
  ///////////
  // Power //
  ...
  /**
    ...
    * @since Chrome 44.
    */
  val printerProviderNs: Anon_Capabilities
  // #endregion
  ...
  /**
    ...
    */
  val signedInDevicesNs: Anon_CallbackDevices
  // #endregion
  ...
  /**
    ...
    * @since Chrome 27
    */
  val syncFileSystemNs: Anon_CallbackConflictResolutionPolicy
  ...
  /**
    ...
    */
  val usbNs: Anon_AlternateSetting
  // #endregion
  ...
  /**
    ...
    */
  val virtualKeyboardNs: Anon_CallbackRestrictFeatures
  // #endregion
  ...
  /**
    ...
    */
  val webViewRequestNs: Anon_AddRequestCookie
  // #endregion
  // #region methods
  /////////////
  // METHODS //
