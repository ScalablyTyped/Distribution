  ...
  def getPermissionLevel(
    callback: js.Function1[
      /* level */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_DENIED))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
      scala.Unit
    ]
