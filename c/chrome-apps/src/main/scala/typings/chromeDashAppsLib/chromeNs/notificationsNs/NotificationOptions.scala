...
trait NotificationOptions extends js.Object {
  ...
  var `type`: chromeDashAppsLib.chromeNs.ToStringLiteral[
    ...
    stdLib.Exclude[
      java.lang.String, 
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_IMAGE))),List()),Left(TsIdentSimple(K))) */js.Any
    ]
  ]
}
