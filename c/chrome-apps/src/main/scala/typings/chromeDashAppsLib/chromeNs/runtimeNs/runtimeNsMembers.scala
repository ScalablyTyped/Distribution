  ...
  val onRestartRequired: chromeDashAppsLib.chromeNs.eventsNs.Event[
    js.Function1[
      /* reason */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_APPUPDATE))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
      scala.Unit
    ]
  ...
  def requestUpdateCheck(
    callback: js.Function2[
      /* status */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_NOUPDATE))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
