    ...
    js.Function3[
      ...
      /* errorCallback */ js.Function1[
        /* error */ chromeDashAppsLib.chromeNs.ToStringLiteral[
          ...
          stdLib.Exclude[
            java.lang.String, 
            /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_INUSE))),List()),Left(TsIdentSimple(K))) */js.Any
          ]
        ], 
        scala.Unit
      ], 
