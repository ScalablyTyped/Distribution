...
object InvalidManifest {
  ...
  def apply(
    ...
    browser_action: js.UndefOr[scala.Nothing] = js.undefined,
    chrome_url_overrides: js.UndefOr[scala.Nothing] = js.undefined,
    commands: org.scalablytyped.runtime.StringDictionary[chromeDashAppsLib.Anon_Description] = null,
    content_security_policy: js.UndefOr[scala.Nothing] = js.undefined,
    ...
    if (!js.isUndefined(browser_action)) __obj.updateDynamic("browser_action")(browser_action)
    if (!js.isUndefined(chrome_url_overrides)) __obj.updateDynamic("chrome_url_overrides")(chrome_url_overrides)
    if (commands != null) __obj.updateDynamic("commands")(commands)
    if (!js.isUndefined(content_security_policy)) __obj.updateDynamic("content_security_policy")(content_security_policy)
    ...
    if (!js.isUndefined(options_page)) __obj.updateDynamic("options_page")(options_page)
    if (!js.isUndefined(options_ui)) __obj.updateDynamic("options_ui")(options_ui)
