...
object configNsMembers extends js.Object {
  ...
  def finishAuthentication(
    ...
    result: chromeDashAppsLib.chromeNs.ToStringLiteral[
      ...
      stdLib.Exclude[
        java.lang.String, 
        /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_FAILED))),List()),Left(TsIdentSimple(K))) */js.Any
      ]
    ]
