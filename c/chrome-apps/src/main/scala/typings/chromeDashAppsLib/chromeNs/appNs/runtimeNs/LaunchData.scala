...
trait LaunchData extends js.Object {
  ...
  var source: js.UndefOr[
    chromeDashAppsLib.chromeNs.ToStringLiteral[
      ...
      stdLib.Exclude[
        java.lang.String, 
        /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_NEWTABPAGE))),List()),Left(TsIdentSimple(K))) */js.Any
      ]
    ]
  ] = js.undefined
  /**
