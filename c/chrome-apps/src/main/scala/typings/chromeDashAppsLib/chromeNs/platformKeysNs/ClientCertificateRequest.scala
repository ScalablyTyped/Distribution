...
trait ClientCertificateRequest extends js.Object {
  ...
  var certificateTypes: js.Array[
    chromeDashAppsLib.chromeNs.ToStringLiteral[
      ...
      stdLib.Exclude[
        java.lang.String, 
        /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_ECDSASIGN))),List()),Left(TsIdentSimple(K))) */js.Any
      ]
    ]
  ]
}
