...
trait ExtensionInfo extends js.Object {
  ...
  var availableLaunchTypes: js.UndefOr[
    js.Array[
      chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_OPENASWINDOW))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ]
    ]
  ] = js.undefined
  ...
  var disabledReason: js.UndefOr[
    chromeDashAppsLib.chromeNs.ToStringLiteral[
      ...
      stdLib.Exclude[
        java.lang.String, 
        /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_PERMISSIONSINCREASE))),List()),Left(TsIdentSimple(K))) */js.Any
      ]
    ]
  ] = js.undefined
  ...
  var installType: chromeDashAppsLib.chromeNs.ToStringLiteral[
    ...
    stdLib.Exclude[
      java.lang.String, 
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_OTHEROther))),List()),Left(TsIdentSimple(K))) */js.Any
    ]
  ]
  /**
