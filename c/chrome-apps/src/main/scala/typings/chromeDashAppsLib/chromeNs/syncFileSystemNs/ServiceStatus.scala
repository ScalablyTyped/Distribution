...
object ServiceStatus extends js.Object {
  var AUTHENTICATION_REQUIRED: chromeDashAppsLib.chromeDashAppsLibStrings.authentication_required = js.native
  var DISABLED: chromeDashAppsLib.chromeDashAppsLibStrings.disabled = js.native
  var INITIALIZING: chromeDashAppsLib.chromeDashAppsLibStrings.initializing = js.native
  var RUNNING: chromeDashAppsLib.chromeDashAppsLibStrings.running = js.native
  var TEMPORARY_UNAVAILABLE: chromeDashAppsLib.chromeDashAppsLibStrings.temporary_unavailable = js.native
}
