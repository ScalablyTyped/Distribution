  ...
  def ejectDevice(
    ...
    callback: js.Function1[
      /* result */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_SUCCESS))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
      scala.Unit
    ]
