  ...
  def getConflictResolutionPolicy(
    callback: js.Function1[
      /* policy */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_LASTWRITEWIN))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
      scala.Unit
    ]
