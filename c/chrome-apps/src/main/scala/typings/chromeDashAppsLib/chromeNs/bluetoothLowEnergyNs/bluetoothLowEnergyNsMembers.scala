...
@js.native
object bluetoothLowEnergyNsMembers extends js.Object {
  /**
  ...
  /**
    ...
    */
  def connect(deviceAddress: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    * Establishes a connection between the application and the device with the given address. A device may be already connected and its GATT services available without calling connect, however, an app that wants to access GATT services of a device should call this function to make sure that a connection to the device is maintained. If the device is not connected, all GATT services of the device will be discovered after a successful call to connect.
    * @param deviceAddress The Bluetooth address of the remote device to which a GATT connection should be opened.
  ...
  /**
    ...
    */
  def disconnect(deviceAddress: java.lang.String): scala.Unit = js.native
  def disconnect(deviceAddress: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def registerService(serviceId: java.lang.String, callback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def removeService(serviceId: java.lang.String): scala.Unit = js.native
  def removeService(serviceId: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def resetAdvertising(callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setAdvertisingInterval(
    minInterval: chromeDashAppsLib.chromeNs.integer,
    maxInterval: chromeDashAppsLib.chromeNs.integer,
    callback: js.Function0[scala.Unit]
  ): scala.Unit = js.native
  /**
    ...
    */
  def startCharacteristicNotifications(characteristicId: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    * Enable value notifications/indications from the specified characteristic. Once enabled, an application can listen to notifications using the onCharacteristicValueChanged event.
    * @see onCharacteristicValueChanged
    * @param characteristicId The instance ID of the GATT characteristic that notifications should be enabled on.
  ...
  /**
    ...
    */
  def stopCharacteristicNotifications(characteristicId: java.lang.String): scala.Unit = js.native
  def stopCharacteristicNotifications(characteristicId: java.lang.String, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def unregisterAdvertisement(advertisementId: chromeDashAppsLib.chromeNs.integer, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @param callback Callback with the result of the register operation.
    */
  def unregisterService(serviceId: java.lang.String, callback: js.Function1[/* result */ js.Any, scala.Unit]): scala.Unit = js.native
  /**
    ...
    */
  def writeCharacteristicValue(characteristicId: java.lang.String, value: stdLib.ArrayBuffer, callback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    ...
    * @param callback Called when the write request has completed.
    */
  def writeDescriptorValue(descriptorId: java.lang.String, value: stdLib.ArrayBuffer, callback: js.Function0[scala.Unit]): scala.Unit = js.native
}
