...
object vpnProviderNsMembers extends js.Object {
  ...
  val onPlatformMessage: chromeDashAppsLib.chromeNs.eventsNs.Event[
    js.Function3[
      ...
      /* message */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_LINKCHANGED))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
  ...
  val onUIEvent: chromeDashAppsLib.chromeNs.eventsNs.Event[
    js.Function2[
      /* event */ chromeDashAppsLib.chromeNs.ToStringLiteral[
        ...
        stdLib.Exclude[
          java.lang.String, 
          /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_SHOWADDDIALOG))),List()),Left(TsIdentSimple(K))) */js.Any
        ]
      ], 
  ...
  def notifyConnectionStateChanged(
    state: chromeDashAppsLib.chromeNs.ToStringLiteral[
      ...
      stdLib.Exclude[
        java.lang.String, 
        /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentLibrarySimple(chrome-apps), TsIdentSimple(Anon_FAILURE))),List()),Left(TsIdentSimple(K))) */js.Any
      ]
    ]
