...
object ^ extends js.Object {
  ...
  def getAdapterState(callback: js.Function1[/* adapterInfo */ AdapterState, scala.Unit]): scala.Unit = js.native
  /** Get information about a Bluetooth device known to the system. */
  def getDevice(deviceAddress: java.lang.String, callback: js.Function1[/* deviceInfo */ Device, scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param callback Called when the search is completed.
    */
  def getDevices(filter: DeviceFilter, callback: js.Function1[/* devices */ js.Array[Device], scala.Unit]): scala.Unit = js.native
  /**
