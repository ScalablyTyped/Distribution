...
trait TypeoffileSystemProvider extends js.Object {
  ...
  val ChangeType: AnonCHANGED = js.native
  /**
    ...
    */
  val CommonActionId: AnonOFFLINENOTNECESSARY = js.native
  /** Mode of opening a file. Used by onOpenFileRequested. */
  val OpenFileMode: AnonREAD = js.native
  /**
    ...
    * */
  val ProviderError: AnonABORT = js.native
  /**
