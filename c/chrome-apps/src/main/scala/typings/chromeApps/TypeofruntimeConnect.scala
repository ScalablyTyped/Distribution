...
import typings.chromeApps.chrome.runtime.LastError_
...
trait TypeofruntimeConnect extends js.Object {
  val OnInstalledReason: AnonCHROMEUPDATE = js.native
  val OnRestartRequiredReason: AnonAPPUPDATE = js.native
  val PlatformArch: AnonARM = js.native
  val PlatformOs: AnonANDROID = js.native
  val RequestUpdateCheckStatus: AnonNOUPDATE = js.native
  /** The ID of the app. */
  val id: String = js.native
  /** This will be defined during an API method callback if there was an error */
  val lastError: js.UndefOr[LastError_] = js.native
  /**
