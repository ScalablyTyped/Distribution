...
object ContextMenuCreateProperties {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ContextMenuCreateProperties] (val x: Self) extends AnyVal {
    ...
    inline def setOnclick(value: /* info */ Any => Unit): Self = StObject.set(x, "onclick", js.Any.fromFunction1(value))
