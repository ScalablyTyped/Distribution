...
object contextMenus {
  ...
  object ContextType {
    ...
    inline def ALL_=(x: all__): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ALL")(x.asInstanceOf[js.Any])
    ...
    inline def BROWSER_ACTION_=(x: browser_action_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BROWSER_ACTION")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.EDITABLE")
    @js.native
    def EDITABLE: editable_ = js.native
    inline def EDITABLE_=(x: editable_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EDITABLE")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.FRAME")
    @js.native
    def FRAME: frame_ = js.native
    inline def FRAME_=(x: frame_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FRAME")(x.asInstanceOf[js.Any])
    ...
    inline def LAUNCHER_=(x: launcher_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LAUNCHER")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.LINK")
    @js.native
    def LINK: link_ = js.native
    inline def LINK_=(x: link_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LINK")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.PAGE")
    @js.native
    def PAGE: page_ = js.native
    inline def PAGE_=(x: page_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PAGE")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.PAGE_ACTION")
    @js.native
    def PAGE_ACTION: page_action_ = js.native
    inline def PAGE_ACTION_=(x: page_action_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PAGE_ACTION")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.SELECTION")
    @js.native
    def SELECTION: selection_ = js.native
    inline def SELECTION_=(x: selection_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SELECTION")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ContextType.VIDEO")
    @js.native
    def VIDEO: video_ = js.native
    inline def VIDEO_=(x: video_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("VIDEO")(x.asInstanceOf[js.Any])
  }
  ...
  object ItemType {
    ...
    inline def CHECKBOX_=(x: checkbox_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CHECKBOX")(x.asInstanceOf[js.Any])
    ...
    inline def RADIO_=(x: radio_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RADIO")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.contextMenus.ItemType.SEPARATOR")
    @js.native
    def SEPARATOR: separator_ = js.native
    inline def SEPARATOR_=(x: separator_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SEPARATOR")(x.asInstanceOf[js.Any])
  }
  ...
  /**
    ...
    */
  inline def remove(menuItemId: integer): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("remove")(menuItemId.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def remove(menuItemId: integer, callback: js.Function0[Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("remove")(menuItemId.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def update(id: integer, updateProperties: UpdateProperties): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(id.asInstanceOf[js.Any], updateProperties.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def update(id: integer, updateProperties: UpdateProperties, callback: js.Function0[Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("update")(id.asInstanceOf[js.Any], updateProperties.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
