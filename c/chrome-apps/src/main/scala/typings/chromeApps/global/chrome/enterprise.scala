...
import typings.chromeApps.chrome.enterprise.platformKeys.ChallengeKeyOptions
...
object enterprise {
  ...
  object platformKeys {
    ...
    /**
      ...
      */
    inline def challengeKey(
      options: ChallengeKeyOptions,
      callback: js.Function1[/* repsonse */ js.typedarray.ArrayBuffer, Unit]
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("challengeKey")(options.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
