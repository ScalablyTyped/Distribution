...
object app {
  ...
  object State {
    ...
    inline def FULLSCREEN_=(x: fullscreen_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FULLSCREEN")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.app._State.MAXIMIZED")
    @js.native
    def MAXIMIZED: maximized_ = js.native
    inline def MAXIMIZED_=(x: maximized_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MAXIMIZED")(x.asInstanceOf[js.Any])
    
    @JSGlobal("chrome.app._State.MINIMIZED")
    @js.native
    def MINIMIZED: minimized_ = js.native
    inline def MINIMIZED_=(x: minimized_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MINIMIZED")(x.asInstanceOf[js.Any])
  ...
  object runtime {
    ...
    object LaunchSource {
      ...
      inline def ABOUT_PAGE_=(x: about_page_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ABOUT_PAGE")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.APP_LAUNCHER")
      @js.native
      def APP_LAUNCHER: app_launcher_ = js.native
      inline def APP_LAUNCHER_=(x: app_launcher_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("APP_LAUNCHER")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.BACKGROUND")
      @js.native
      def BACKGROUND: background_ = js.native
      inline def BACKGROUND_=(x: background_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BACKGROUND")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.CHROME_INTERNAL")
      @js.native
      def CHROME_INTERNAL: chrome_internal_ = js.native
      inline def CHROME_INTERNAL_=(x: chrome_internal_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CHROME_INTERNAL")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.COMMAND_LINE")
      @js.native
      def COMMAND_LINE: command_line_ = js.native
      inline def COMMAND_LINE_=(x: command_line_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COMMAND_LINE")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.CONTEXT_MENU")
      @js.native
      def CONTEXT_MENU: context_menu_ = js.native
      inline def CONTEXT_MENU_=(x: context_menu_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CONTEXT_MENU")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.EPHEMERAL_APP")
      @js.native
      def EPHEMERAL_APP: ephemeral_app_ = js.native
      inline def EPHEMERAL_APP_=(x: ephemeral_app_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EPHEMERAL_APP")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.EXTENSIONS_PAGE")
      @js.native
      def EXTENSIONS_PAGE: extensions_page_ = js.native
      inline def EXTENSIONS_PAGE_=(x: extensions_page_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EXTENSIONS_PAGE")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.FILE_HANDLER")
      @js.native
      def FILE_HANDLER: file_handler_ = js.native
      inline def FILE_HANDLER_=(x: file_handler_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FILE_HANDLER")(x.asInstanceOf[js.Any])
      ...
      inline def INSTALLED_NOTIFICATION_=(x: installed_notification_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INSTALLED_NOTIFICATION")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.KEYBOARD")
      @js.native
      def KEYBOARD: keyboard_ = js.native
      inline def KEYBOARD_=(x: keyboard_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("KEYBOARD")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.KIOSK")
      @js.native
      def KIOSK: kiosk_ = js.native
      inline def KIOSK_=(x: kiosk_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("KIOSK")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.LOAD_AND_LAUNCH")
      @js.native
      def LOAD_AND_LAUNCH: load_and_launch_ = js.native
      inline def LOAD_AND_LAUNCH_=(x: load_and_launch_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("LOAD_AND_LAUNCH")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.MANAGEMENT_API")
      @js.native
      def MANAGEMENT_API: management_api_ = js.native
      inline def MANAGEMENT_API_=(x: management_api_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MANAGEMENT_API")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.NEW_TAB_PAGE")
      @js.native
      def NEW_TAB_PAGE: new_tab_page_ = js.native
      inline def NEW_TAB_PAGE_=(x: new_tab_page_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NEW_TAB_PAGE")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.RELOAD")
      @js.native
      def RELOAD: reload_ = js.native
      inline def RELOAD_=(x: reload_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RELOAD")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.RESTART")
      @js.native
      def RESTART: restart_ = js.native
      inline def RESTART_=(x: restart_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RESTART")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.SYSTEM_TRAY")
      @js.native
      def SYSTEM_TRAY: system_tray_ = js.native
      inline def SYSTEM_TRAY_=(x: system_tray_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SYSTEM_TRAY")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.TEST")
      @js.native
      def TEST: test_ = js.native
      inline def TEST_=(x: test_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TEST")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.LaunchSource.UNTRACKED")
      @js.native
      def UNTRACKED: untracked_ = js.native
      inline def UNTRACKED_=(x: untracked_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNTRACKED")(x.asInstanceOf[js.Any])
    ...
    object PlayStoreStatus {
      ...
      inline def AVAILABLE_=(x: available): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AVAILABLE")(x.asInstanceOf[js.Any])
      
      @JSGlobal("chrome.app.runtime.PlayStoreStatus.ENABLED")
      @js.native
      def ENABLED: enabled_ = js.native
      inline def ENABLED_=(x: enabled_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ENABLED")(x.asInstanceOf[js.Any])
