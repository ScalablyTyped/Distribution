...
object Entries {
  ...
  implicit class EntriesOps[Self <: Entries] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntriesVarargs(value: FileEntry*): Self = this.set("entries", js.Array(value :_*))
    @scala.inline
    def setEntries(value: js.Array[FileEntry]): Self = this.set("entries", value.asInstanceOf[js.Any])
  }
