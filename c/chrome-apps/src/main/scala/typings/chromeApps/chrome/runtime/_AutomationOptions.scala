...
object _AutomationOptions {
  ...
  @scala.inline
  def AutomationDesktop(): typings.chromeApps.chrome.runtime.AutomationDesktop = {
    val __obj = js.Dynamic.literal(desktop = true)
    __obj.asInstanceOf[typings.chromeApps.chrome.runtime.AutomationDesktop]
  }
  
  @scala.inline
  def AutomationNonInteractive(): typings.chromeApps.chrome.runtime.AutomationNonInteractive = {
