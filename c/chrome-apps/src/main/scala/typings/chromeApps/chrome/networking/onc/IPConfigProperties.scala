...
object IPConfigProperties {
  @scala.inline
  def apply[/* <: typings.chromeApps.chrome.networking.onc.ManagedObject */ M, B, S, SL, L](): IPConfigProperties[M, B, S, SL, L] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IPConfigProperties[M, B, S, SL, L]]
  }
  @scala.inline
  implicit class IPConfigPropertiesOps[Self <: IPConfigProperties[_, _, _, _, _], /* <: typings.chromeApps.chrome.networking.onc.ManagedObject */ M, B, S, SL, L] (val x: Self with (IPConfigProperties[M, B, S, SL, L])) extends AnyVal {
    @scala.inline
