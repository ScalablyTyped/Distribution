...
object tts {
  ...
  object SpeakOptions {
    ...
    implicit open class MutableBuilder[Self <: SpeakOptions] (val x: Self) extends AnyVal {
      ...
      inline def setPitch(value: integer): Self = StObject.set(x, "pitch", value.asInstanceOf[js.Any])
      
      inline def setPitchUndefined: Self = StObject.set(x, "pitch", js.undefined)
      
      inline def setRate(value: integer): Self = StObject.set(x, "rate", value.asInstanceOf[js.Any])
      ...
      inline def setVolume(value: integer): Self = StObject.set(x, "volume", value.asInstanceOf[js.Any])
  ...
  object TtsVoice {
    ...
    implicit open class MutableBuilder[Self <: TtsVoice] (val x: Self) extends AnyVal {
      ...
      inline def setExtensionsId(value: String): Self = StObject.set(x, "extensionsId", value.asInstanceOf[js.Any])
      
      inline def setExtensionsIdUndefined: Self = StObject.set(x, "extensionsId", js.undefined)
