...
object Manifest {
  ...
  @scala.inline
  def InvalidManifest(app: Background, externally_connectable: Accepttlschannelid, name: String, version: String): typings.chromeApps.chrome.runtime.InvalidManifest = {
  ...
  @scala.inline
  def ValidKioskManifest(app: Background, externally_connectable: Accepttlschannelid, name: String, version: String): typings.chromeApps.chrome.runtime.ValidKioskManifest = {
  ...
  @scala.inline
  def ValidNonKioskManifest(app: Background, externally_connectable: Accepttlschannelid, name: String, version: String): typings.chromeApps.chrome.runtime.ValidNonKioskManifest = {
    val __obj = js.Dynamic.literal(app = app.asInstanceOf[js.Any], externally_connectable = externally_connectable.asInstanceOf[js.Any], manifest_version = 2, name = name.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
