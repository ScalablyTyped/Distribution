...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.chromeApps.chrome.runtime.ChromeOSOnlyPermissions
  - typings.chromeApps.chrome.runtime.KioskOnlyPermissions
  - typings.chromeApps.chrome.runtime.MediaGalleriesPermission
  - typings.chromeApps.chrome.runtime.SocketPermission
  - / **
