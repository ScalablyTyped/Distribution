...
object VPNProperties {
  @scala.inline
  def apply[/* <: typings.chromeApps.chrome.networking.onc.ManagedObject */ M, B, S](): VPNProperties[M, B, S] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VPNProperties[M, B, S]]
  }
  @scala.inline
  implicit class VPNPropertiesOps[Self <: VPNProperties[_, _, _], /* <: typings.chromeApps.chrome.networking.onc.ManagedObject */ M, B, S] (val x: Self with (VPNProperties[M, B, S])) extends AnyVal {
    @scala.inline
