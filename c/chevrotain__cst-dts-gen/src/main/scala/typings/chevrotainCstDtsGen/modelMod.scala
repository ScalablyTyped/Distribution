...
object modelMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.chevrotainCstDtsGen.modelMod.TokenArrayType
    - typings.chevrotainCstDtsGen.modelMod.RuleArrayType
    - js.Array[
  typings.chevrotainCstDtsGen.modelMod.TokenArrayType | typings.chevrotainCstDtsGen.modelMod.RuleArrayType]
  */
  ...
  object _PropertyArrayType {
    ...
    inline def RuleArrayType(name: String): typings.chevrotainCstDtsGen.modelMod.RuleArrayType = {
      val __obj = js.Dynamic.literal(kind = "rule", name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.chevrotainCstDtsGen.modelMod.RuleArrayType]
    }
    
    inline def TokenArrayType(): typings.chevrotainCstDtsGen.modelMod.TokenArrayType = {
      val __obj = js.Dynamic.literal(kind = "token")
      __obj.asInstanceOf[typings.chevrotainCstDtsGen.modelMod.TokenArrayType]
    }
  }
}
