...
trait Called extends js.Object {
  ...
  /**
           ...
           * ```
           */
  var once: chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.twice
           ...
           * ```
           */
  var twice: chaiDashSpiesLib.ChaiNs.Assertion = js.native
  @JSName("with")
  ...
  /**
           ...
           * ```
           */
  def above(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.below(n) / .lt(n)
           ...
           * ```
           */
  def below(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.exactly(n)
           ...
           * ```
           */
  def exactly(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.above(n) / .gt(n)
           * Assert that a spy has been called more than ```n``` times.
           * ```ts
           ...
           * ```
           */
  def gt(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.below(n) / .lt(n)
           * Assert that a spy has been called fewer than ```n``` times.
           * ```ts
           ...
           * ```
           */
  def lt(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.max(n) / .at.most(n)
           ...
           * ```
           */
  def max(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.min(n) / .at.least(n)
           ...
           * ```
           */
  def min(n: scala.Double): chaiDashSpiesLib.ChaiNs.Assertion = js.native
  /**
           * ####.with
