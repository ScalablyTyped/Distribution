...
import typings.cathoQuantum.AnonBaseFontSizeColorsComponents
...
trait IconButtonProps extends js.Object {
  ...
  var theme: js.UndefOr[AnonBaseFontSizeColorsComponents] = js.undefined
}
...
object IconButtonProps {
  ...
  def apply(
    ...
    theme: AnonBaseFontSizeColorsComponents = null
  ): IconButtonProps = {
