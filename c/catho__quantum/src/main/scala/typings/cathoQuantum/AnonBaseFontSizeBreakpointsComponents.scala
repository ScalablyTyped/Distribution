...
trait AnonBaseFontSizeBreakpointsComponents extends js.Object {
...
object AnonBaseFontSizeBreakpointsComponents {
  @scala.inline
  def apply(
  ...
  ): AnonBaseFontSizeBreakpointsComponents = {
    ...
    __obj.asInstanceOf[AnonBaseFontSizeBreakpointsComponents]
  }
}
