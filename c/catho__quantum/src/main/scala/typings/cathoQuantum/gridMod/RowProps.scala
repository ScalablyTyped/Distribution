...
import typings.cathoQuantum.AnonBreakpointsObjectOptional
...
trait RowProps extends js.Object {
  ...
  var theme: js.UndefOr[AnonBreakpointsObjectOptional] = js.undefined
}
...
object RowProps {
  ...
  def apply(
    ...
    theme: AnonBreakpointsObjectOptional = null
  ): RowProps = {
