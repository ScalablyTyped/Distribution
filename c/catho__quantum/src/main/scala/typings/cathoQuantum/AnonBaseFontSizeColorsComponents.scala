...
trait AnonBaseFontSizeColorsComponents extends js.Object {
...
object AnonBaseFontSizeColorsComponents {
  @scala.inline
  def apply(
  ...
  ): AnonBaseFontSizeColorsComponents = {
    ...
    __obj.asInstanceOf[AnonBaseFontSizeColorsComponents]
  }
}
