...
object colorsMod {
  ...
  object default {
    ...
    inline def error_=(x: ColorsTones): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("error")(x.asInstanceOf[js.Any])
    
    @JSImport("@catho/quantum/Colors", "default.neutral")
    @js.native
    def neutral: ColorsTones0string1000str = js.native
    inline def neutral_=(x: ColorsTones0string1000str): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("neutral")(x.asInstanceOf[js.Any])
    
    @JSImport("@catho/quantum/Colors", "default.primary")
    @js.native
    def primary: ColorsTones = js.native
    inline def primary_=(x: ColorsTones): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("primary")(x.asInstanceOf[js.Any])
    
    @JSImport("@catho/quantum/Colors", "default.secondary")
    @js.native
    def secondary: ColorsTones = js.native
    inline def secondary_=(x: ColorsTones): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("secondary")(x.asInstanceOf[js.Any])
    
    @JSImport("@catho/quantum/Colors", "default.success")
    @js.native
    def success: ColorsTones = js.native
    inline def success_=(x: ColorsTones): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("success")(x.asInstanceOf[js.Any])
    
    @JSImport("@catho/quantum/Colors", "default.warning")
    @js.native
    def warning: ColorsTones = js.native
    inline def warning_=(x: ColorsTones): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("warning")(x.asInstanceOf[js.Any])
  }
  ...
  object ColorsTones {
    ...
    inline def apply(`100`: String, `300`: String, `500`: String, `700`: String, `900`: String): ColorsTones = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ColorsTones] (val x: Self) extends AnyVal {
