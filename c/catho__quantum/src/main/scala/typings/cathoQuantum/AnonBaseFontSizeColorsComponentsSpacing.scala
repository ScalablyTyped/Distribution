...
trait AnonBaseFontSizeColorsComponentsSpacing extends js.Object {
...
object AnonBaseFontSizeColorsComponentsSpacing {
  @scala.inline
  def apply(
  ...
  ): AnonBaseFontSizeColorsComponentsSpacing = {
    ...
    __obj.asInstanceOf[AnonBaseFontSizeColorsComponentsSpacing]
  }
}
