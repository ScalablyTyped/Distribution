...
import typings.cheerio.loadMod.CheerioAPI
...
object slimMod {
  ...
  @JSImport("cheerio/lib/esm/slim", "Cheerio")
  @js.native
  abstract class Cheerio[T] protected ()
    extends typings.cheerio.esmCheerioMod.Cheerio[T] {
    def this(elements: Unit, root: Null, options: InternalOptions) = this()
    def this(
      elements: Unit,
      root: typings.cheerio.esmCheerioMod.Cheerio[typings.domhandler.mod.Document],
  ...
  open class Document protected ()
    extends typings.cheerio.esmMod.Document {
    /**
  ...
  open class Element protected ()
    extends typings.cheerio.esmMod.Element {
    /**
  ...
  @JSImport("cheerio/lib/esm/slim", "Node")
  @js.native
  abstract class Node ()
    extends typings.cheerio.esmMod.Node
