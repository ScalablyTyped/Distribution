...
object libEsmOptionsMod {
  
  @JSImport("cheerio/lib/esm/options", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("cheerio/lib/esm/options", JSImport.Default)
  @js.native
  ...
  /* Inlined parent std.Omit<cheerio.cheerio/lib/esm/options.CheerioOptions, 'xml'> */
