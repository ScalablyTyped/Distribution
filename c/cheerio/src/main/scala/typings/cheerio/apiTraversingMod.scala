...
object apiTraversingMod {
  
  @JSImport("cheerio/lib/esm/api/traversing", JSImport.Namespace)
  @js.native
  ...
  inline def filter[T](`match`: String): Cheerio[T | Element] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(`match`.asInstanceOf[js.Any]).asInstanceOf[Cheerio[T | Element]]
  inline def filter[T](`match`: Cheerio[T]): Cheerio[T | Element] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(`match`.asInstanceOf[js.Any]).asInstanceOf[Cheerio[T | Element]]
  inline def filter[T, S /* <: (js.ThisFunction2[/* this */ T, /* i */ Double, /* el */ T, Boolean]) | T */](`match`: S): Cheerio[T | Element] = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(`match`.asInstanceOf[js.Any]).asInstanceOf[Cheerio[T | Element]]
