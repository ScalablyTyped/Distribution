...
object libEsmSlimMod {
  
  @JSImport("cheerio/lib/esm/slim", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* note: abstract class */ @JSImport("cheerio/lib/esm/slim", "Cheerio")
  @js.native
  open class Cheerio[T] protected ()
    extends typings.cheerio.libEsmCheerioMod.Cheerio[T] {
    def this(elements: Unit, root: Null, options: InternalOptions) = this()
    def this(
      elements: Unit,
      root: typings.cheerio.libEsmCheerioMod.Cheerio[typings.domhandler.mod.Document],
  ...
  @JSImport("cheerio/lib/esm/slim", "Document")
  @js.native
  open class Document protected ()
    extends typings.cheerio.libEsmMod.Document {
    /**
  ...
  @JSImport("cheerio/lib/esm/slim", "Element")
  @js.native
  open class Element protected ()
    extends typings.cheerio.libEsmMod.Element {
    /**
  ...
  /* note: abstract class */ @JSImport("cheerio/lib/esm/slim", "Node")
  @js.native
  open class Node ()
    extends typings.cheerio.libEsmMod.Node
