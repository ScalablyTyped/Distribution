...
import typings.cheerio.libEsmTypesMod.LowercaseLetters
import typings.cheerio.libEsmTypesMod.SelectorSpecial
...
object cheerioStrings {
  ...
  sealed trait a
    extends StObject
       ...
       with typings.cheerio.libTypesMod.LowercaseLetters
