...
object libUtilsMod {
  ...
  @JSImport("cheerio/lib/utils", JSImport.Namespace)
  @js.native
  ...
  inline def isCheerio[T](maybeCheerio: Any): /* is cheerio.cheerio/lib/cheerio.Cheerio<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCheerio")(maybeCheerio.asInstanceOf[js.Any]).asInstanceOf[/* is cheerio.cheerio/lib/cheerio.Cheerio<T> */ Boolean]
