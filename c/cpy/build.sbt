...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "cp-file" % "6.1.0-472337",
  ...
  "org.scalablytyped" %%% "graceful-fs" % "4.1-dt-20190212Z-d2bc6d",
  "org.scalablytyped" %%% "ignore" % "3.3.10-bb014f",
  "org.scalablytyped" %%% "is-glob" % "4.0-dt-20180214Z-399c7b",
  "org.scalablytyped" %%% "make-dir" % "2.1.0-a964de",
