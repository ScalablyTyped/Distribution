...
import typings.cryptoDashJs.Anon_AES
import typings.cryptoDashJs.Anon_AnsiX923
import typings.cryptoDashJs.Anon_Base64
import typings.cryptoDashJs.Anon_CBC
import typings.cryptoDashJs.Anon_Hex
import typings.cryptoDashJs.Anon_WordArray
...
trait Hashes extends js.Object {
  ...
  var algo: Anon_AES = js.native
  var enc: Anon_Base64 = js.native
  var format: Anon_Hex = js.native
  var lib: Anon_WordArray = js.native
  var mode: Anon_CBC = js.native
  var pad: Anon_AnsiX923 = js.native
