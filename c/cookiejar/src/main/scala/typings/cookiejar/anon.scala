...
object anon {
  ...
  /* Inlined {[ K in keyof std.Array<any> ]:? boolean} */
  trait KinkeyofArrayanyboolean extends StObject {
    ...
    var toLocaleString_FKinkeyofArrayanyboolean: js.UndefOr[Boolean] = js.undefined
    
    @JSName("toString")
    var toString_FKinkeyofArrayanyboolean: js.UndefOr[Boolean] = js.undefined
    
    var unshift: js.UndefOr[Boolean] = js.undefined
    
    var values: js.UndefOr[Boolean] = js.undefined
  }
  object KinkeyofArrayanyboolean {
    
    inline def apply(): KinkeyofArrayanyboolean = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[KinkeyofArrayanyboolean]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: KinkeyofArrayanyboolean] (val x: Self) extends AnyVal {
  ...
  /* n */ NumberDictionary[Cookie] {
    ...
    def findLast(predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* array */ js.Array[Cookie], Any]): js.UndefOr[Cookie] = js.native
    def findLast(
      predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* array */ js.Array[Cookie], Any],
      thisArg: Any
    ): js.UndefOr[Cookie] = js.native
    ...
    /**
      ...
      */
    /* standard es2023.array */
    def findLastIndex(predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* array */ js.Array[Cookie], Any]): Double = js.native
    def findLastIndex(
      predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* array */ js.Array[Cookie], Any],
      thisArg: Any
    ): Double = js.native
    ...
    @JSName("find")
    def find_S[S /* <: Cookie */](
      predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* obj */ js.Array[Cookie], /* is S */ Boolean]
    ): js.UndefOr[S] = js.native
    @JSName("find")
    def find_S[S /* <: Cookie */](
      predicate: js.Function3[/* value */ Cookie, /* index */ Double, /* obj */ js.Array[Cookie], /* is S */ Boolean],
    ...
    val unscopables: KinkeyofArrayanyboolean = js.native
