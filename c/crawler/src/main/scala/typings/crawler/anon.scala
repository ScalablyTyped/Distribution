...
object anon {
  ...
  object Log {
    ...
    inline def apply(log: (String, /* repeated */ js.Any) => Unit): Log = {
  ...
  object OmitCrawlerRequestOptions {
    ...
    inline def apply(callback: (Error, CrawlerRequestResponse) => Unit): OmitCrawlerRequestOptions = {
    ...
    extension [Self <: OmitCrawlerRequestOptions](x: Self) {
      ...
      inline def setCallback(value: (Error, CrawlerRequestResponse) => Unit): Self = StObject.set(x, "callback", js.Any.fromFunction2(value))
