...
object anon {
  ...
  object `0` {
    ...
    extension [Self <: `0`[?], T /* <: js.Array[js.Any] */](x: Self & `0`[T]) {
      ...
      inline def set1(value: Head[T]): Self = StObject.set(x, "1", value.asInstanceOf[js.Any])
    }
  }
  ...
  object `01` {
    ...
    inline def apply[R /* <: js.Array[js.Any] */](
    ...
    extension [Self <: `01`[?], R /* <: js.Array[js.Any] */](x: Self & `01`[R]) {
      ...
      inline def set1(value: R): Self = StObject.set(x, "1", value.asInstanceOf[js.Any])
    }
  }
  ...
  object `0Object` {
    ...
    inline def apply[TN /* <: js.Array[js.Any] */, I /* <: js.Array[js.Any] */, T2 /* <: js.Array[js.Any] */](
    ...
    extension [Self <: `0Object`[?, ?, ?], TN /* <: js.Array[js.Any] */, I /* <: js.Array[js.Any] */, T2 /* <: js.Array[js.Any] */](x: Self & (`0Object`[TN, I, T2])) {
      ...
      inline def set1(value: Concat[TN, Cast[js.Any, js.Array[js.Any]]]): Self = StObject.set(x, "1", value.asInstanceOf[js.Any])
    }
  }
