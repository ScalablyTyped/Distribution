...
/**
  ...
  */
@scala.inline
def defineMode(id: java.lang.String, modefactory: typings.codemirror.mod.ModeFactory[js.Any]): scala.Unit = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("defineMode")(id.asInstanceOf[js.Any], modefactory.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def extendMode(name: java.lang.String, properties: typings.codemirror.mod.Mode[js.Any]): scala.Unit = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("extendMode")(name.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def innerMode(mode: typings.codemirror.mod.Mode[js.Any], state: js.Any): typings.codemirror.anon.Mode = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("innerMode")(mode.asInstanceOf[js.Any], state.asInstanceOf[js.Any])).asInstanceOf[typings.codemirror.anon.Mode]
...
/**
  ...
  */
@scala.inline
def overlayMode[T, S](base: typings.codemirror.mod.Mode[T], overlay: typings.codemirror.mod.Mode[S]): typings.codemirror.mod.Mode[js.Any] = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("overlayMode")(base.asInstanceOf[js.Any], overlay.asInstanceOf[js.Any])).asInstanceOf[typings.codemirror.mod.Mode[js.Any]]
@scala.inline
def overlayMode[T, S](
...
@scala.inline
def startState(mode: typings.codemirror.mod.Mode[js.Any]): js.Any | scala.Boolean = typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("startState")(mode.asInstanceOf[js.Any]).asInstanceOf[js.Any | scala.Boolean]
@scala.inline
def startState(mode: typings.codemirror.mod.Mode[js.Any], a1: js.Any): js.Any | scala.Boolean = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("startState")(mode.asInstanceOf[js.Any], a1.asInstanceOf[js.Any])).asInstanceOf[js.Any | scala.Boolean]
@scala.inline
def startState(mode: typings.codemirror.mod.Mode[js.Any], a1: js.Any, a2: js.Any): js.Any | scala.Boolean = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("startState")(mode.asInstanceOf[js.Any], a1.asInstanceOf[js.Any], a2.asInstanceOf[js.Any])).asInstanceOf[js.Any | scala.Boolean]
@scala.inline
def startState(mode: typings.codemirror.mod.Mode[js.Any], a1: scala.Unit, a2: js.Any): js.Any | scala.Boolean = (typings.codemirror.mod.^.asInstanceOf[js.Dynamic].applyDynamic("startState")(mode.asInstanceOf[js.Any], a1.asInstanceOf[js.Any], a2.asInstanceOf[js.Any])).asInstanceOf[js.Any | scala.Boolean]
