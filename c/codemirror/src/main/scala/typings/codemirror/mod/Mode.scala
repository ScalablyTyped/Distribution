...
object Mode {
  ...
  @scala.inline
  implicit class ModeMutableBuilder[Self <: Mode[?], T] (val x: Self & Mode[T]) extends AnyVal {
    ...
    @scala.inline
    def setToken(value: (/* stream */ StringStream, /* state */ T) => String | Null): Self = StObject.set(x, "token", js.Any.fromFunction2(value))
