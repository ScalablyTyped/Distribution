...
object Hint {
  ...
  inline def apply(text: String): Hint = {
  ...
  extension [Self <: Hint](x: Self) {
    ...
    inline def setHint(value: (/* cm */ Editor, /* data */ Hints, Hint) => Unit): Self = StObject.set(x, "hint", js.Any.fromFunction3(value))
    
    inline def setHintUndefined: Self = StObject.set(x, "hint", js.undefined)
    
    inline def setRender(value: (/* element */ HTMLLIElement, /* data */ Hints, Hint) => Unit): Self = StObject.set(x, "render", js.Any.fromFunction3(value))
