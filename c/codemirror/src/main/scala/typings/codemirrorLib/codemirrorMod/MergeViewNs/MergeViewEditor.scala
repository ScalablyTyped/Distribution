...
trait MergeViewEditor
  extends codemirrorLib.codemirrorMod.Editor {
  /**
  ...
  /**
    ...
    */
  def editor(): codemirrorLib.codemirrorMod.Editor = js.native
  def leftChunks(): js.Array[MergeViewDiffChunk] = js.native
  def leftOriginal(): codemirrorLib.codemirrorMod.Editor = js.native
  def rightChunks(): js.Array[MergeViewDiffChunk] = js.native
  def rightOriginal(): codemirrorLib.codemirrorMod.Editor = js.native
  /**
