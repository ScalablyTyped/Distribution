...
trait MergeViewEditorConfiguration
  extends codemirrorLib.codemirrorMod.EditorConfiguration {
  /**
  ...
  var onCollapse: js.UndefOr[
    js.Function4[
      ...
      /* line */ scala.Double, 
      /* size */ scala.Double, 
      /* mark */ codemirrorLib.codemirrorMod.TextMarker, 
      scala.Unit
    ]
  ] = js.undefined
  /**
...
object MergeViewEditorConfiguration {
  ...
  def apply(
    ...
    extraKeys: java.lang.String | codemirrorLib.codemirrorMod.KeyMap = null,
    ...
    highlightSelectionMatches: codemirrorLib.codemirrorMod.HighlightSelectionMatches | scala.Boolean = null,
    hintOptions: codemirrorLib.codemirrorMod.ShowHintOptions = null,
    ...
    inputStyle: codemirrorLib.codemirrorMod.InputStyle = null,
    ...
    lint: scala.Boolean | codemirrorLib.codemirrorMod.LintOptions = null,
    matchBrackets: codemirrorLib.codemirrorMod.MatchBrackets | scala.Boolean = null,
    matchTags: codemirrorLib.codemirrorMod.MatchTags | scala.Boolean = null,
    maxHighlightLength: scala.Int | scala.Double = null,
    mode: js.Any = null,
    onCollapse: (/* mergeView */ MergeViewEditor, /* line */ scala.Double, /* size */ scala.Double, /* mark */ codemirrorLib.codemirrorMod.TextMarker) => scala.Unit = null,
    onDragEvent: (/* instance */ codemirrorLib.codemirrorMod.Editor, /* event */ stdLib.Event) => scala.Boolean = null,
    onKeyEvent: (/* instance */ codemirrorLib.codemirrorMod.Editor, /* event */ stdLib.Event) => scala.Boolean = null,
    ...
    styleActiveLine: codemirrorLib.codemirrorMod.StyleActiveLine | scala.Boolean = null,
