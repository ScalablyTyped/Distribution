...
trait Values[T] extends js.Object {
  ...
  def about(value: scala.Double, delta: scala.Double): AssertionChain[T] = js.native
  ...
  def endWith(value: java.lang.String): AssertionChain[T] = js.native
  /** Asserts that the reference value (a string) ends with the provided value. */
  ...
  /** Asserts that the reference value equals the provided value. */
  def equals(value: T): AssertionChain[T] = js.native
  ...
  def length(size: scala.Double): AssertionChain[T] = js.native
  /** Asserts that the reference value is less than (<) the provided value. */
  ...
  def `match`(regex: stdLib.RegExp): AssertionChain[T] = js.native
  /** Asserts that the reference value's toString() representation matches the provided regular expression. */
  def matches(regex: stdLib.RegExp): AssertionChain[T] = js.native
  ...
  /** Asserts that the reference value satisfies the provided validator function. */
  def satisfy(validator: js.Function1[/* value */ T, scala.Boolean]): AssertionChain[T] = js.native
  /** Asserts that the reference value (a string) starts with the provided value. */
  def startWith(value: java.lang.String): AssertionChain[T] = js.native
  /** Asserts that the reference value (a string) starts with the provided value. */
