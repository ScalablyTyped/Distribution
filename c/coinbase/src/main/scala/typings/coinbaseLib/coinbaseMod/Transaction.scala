...
class Transaction () extends Resource {
  ...
  /**
       ...
       */
  var from: js.UndefOr[ResourceRef | java.lang.String] = js.native
  /**
       * Indicator if the transaction was instant exchanged (received into a bitcoin address for a fiat account)
       */
  var instant_exchange: scala.Boolean = js.native
  /**
  ...
  /**
       ...
       */
  @JSName("resource")
  var resource_Transaction: coinbaseLib.coinbaseLibStrings.transaction = js.native
  /**
       * Transaction status
       */
  ...
  /**
       ...
       * Only available for certain types of transactions
       */
  var to: js.UndefOr[ResourceRef | java.lang.String] = js.native
  /**
       * Transaction type
       */
