...
object doNot02Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/do-not--02", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `doNot02Mod.foo` */
