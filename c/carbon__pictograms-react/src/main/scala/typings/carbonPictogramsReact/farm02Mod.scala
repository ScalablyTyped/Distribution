...
object farm02Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/farm--02", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `farm02Mod.foo` */
