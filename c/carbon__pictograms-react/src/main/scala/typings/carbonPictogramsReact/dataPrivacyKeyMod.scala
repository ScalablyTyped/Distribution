...
object dataPrivacyKeyMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/data--privacy--key", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `dataPrivacyKeyMod.foo` */
