...
object libPerson08Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/person--08", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libPerson08Mod.foo` */
