...
object ibmZ16Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/ibm--z16", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `ibmZ16Mod.foo` */
