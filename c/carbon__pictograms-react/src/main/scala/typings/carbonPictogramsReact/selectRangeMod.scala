...
object selectRangeMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/select--range", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `selectRangeMod.foo` */
