...
object libNetworking04Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/networking--04", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libNetworking04Mod.foo` */
