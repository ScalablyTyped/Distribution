...
object digitalMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/digital", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `digitalMod.foo` */
