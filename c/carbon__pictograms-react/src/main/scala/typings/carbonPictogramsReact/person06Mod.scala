...
object person06Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/person--06", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `person06Mod.foo` */
