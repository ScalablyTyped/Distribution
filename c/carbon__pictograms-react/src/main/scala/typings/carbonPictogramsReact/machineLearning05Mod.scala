...
object machineLearning05Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/machine--learning--05", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `machineLearning05Mod.foo` */
