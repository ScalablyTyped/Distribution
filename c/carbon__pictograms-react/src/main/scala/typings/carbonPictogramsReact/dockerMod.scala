...
object dockerMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/docker", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `dockerMod.foo` */
