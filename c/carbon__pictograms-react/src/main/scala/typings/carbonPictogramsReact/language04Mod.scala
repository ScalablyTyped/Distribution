...
object language04Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/language--04", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `language04Mod.foo` */
