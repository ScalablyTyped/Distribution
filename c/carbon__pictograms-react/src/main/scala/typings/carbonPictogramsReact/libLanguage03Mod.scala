...
object libLanguage03Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/language--03", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libLanguage03Mod.foo` */
