...
object socialWork01Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/social--work--01", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `socialWork01Mod.foo` */
