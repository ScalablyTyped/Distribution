...
object libPerson06Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/person--06", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libPerson06Mod.foo` */
