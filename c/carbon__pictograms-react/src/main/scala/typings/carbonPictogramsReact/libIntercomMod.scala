...
object libIntercomMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/intercom", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libIntercomMod.foo` */
