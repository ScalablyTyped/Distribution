...
object language03Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/language--03", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `language03Mod.foo` */
