...
object transparency01Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/transparency--01", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `transparency01Mod.foo` */
