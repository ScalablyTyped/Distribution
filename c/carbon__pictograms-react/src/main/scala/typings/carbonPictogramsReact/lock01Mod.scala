...
object lock01Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/lock--01", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `lock01Mod.foo` */
