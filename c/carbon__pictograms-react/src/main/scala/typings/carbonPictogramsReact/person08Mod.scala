...
object person08Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/person--08", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `person08Mod.foo` */
