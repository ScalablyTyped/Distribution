...
object libStemLeafPlotMod extends Shortcut {
  ...
  @JSImport("@carbon/pictograms-react/lib/stem--leaf--plot", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libStemLeafPlotMod.foo` */
