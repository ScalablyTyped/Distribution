...
object transform02Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/transform--02", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `transform02Mod.foo` */
