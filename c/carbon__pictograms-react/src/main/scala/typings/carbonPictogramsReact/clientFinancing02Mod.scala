...
object clientFinancing02Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/client--financing--02", JSImport.Default)
  @js.native
  val default: CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `default`, but can instead just say `clientFinancing02Mod.foo` */
