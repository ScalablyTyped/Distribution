...
object libJavaMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/java", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libJavaMod.foo` */
