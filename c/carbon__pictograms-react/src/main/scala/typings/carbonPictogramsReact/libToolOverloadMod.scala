...
object libToolOverloadMod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/tool--overload", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libToolOverloadMod.foo` */
