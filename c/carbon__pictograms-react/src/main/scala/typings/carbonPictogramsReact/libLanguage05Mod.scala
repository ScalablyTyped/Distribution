...
object libLanguage05Mod extends Shortcut {
  
  @JSImport("@carbon/pictograms-react/lib/language--05", JSImport.Namespace)
  @js.native
  val ^ : CarbonPictogramType = js.native
  
  type _To = CarbonPictogramType
  
  /* This means you don't have to write `^`, but can instead just say `libLanguage05Mod.foo` */
