...
object ClownfaceInit {
  @scala.inline
  def apply[/* <: typings.rdfJs.mod.DatasetCore[typings.rdfJs.mod.Quad, typings.rdfJs.mod.Quad] */ D](): ClownfaceInit[D] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClownfaceInit[D]]
  }
  @scala.inline
  implicit class ClownfaceInitOps[Self <: ClownfaceInit[_], /* <: typings.rdfJs.mod.DatasetCore[typings.rdfJs.mod.Quad, typings.rdfJs.mod.Quad] */ D] (val x: Self with ClownfaceInit[D]) extends AnyVal {
    @scala.inline
