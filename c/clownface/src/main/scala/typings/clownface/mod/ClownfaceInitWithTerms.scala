...
object ClownfaceInitWithTerms {
  @scala.inline
  def apply[/* <: typings.rdfJs.mod.Term | js.Array[typings.rdfJs.mod.Term] */ T, /* <: typings.rdfJs.mod.DatasetCore[typings.rdfJs.mod.Quad, typings.rdfJs.mod.Quad] */ D](term: T, _context: js.Array[Context[D, Term]] = null, dataset: D = null, graph: QuadGraph = null): ClownfaceInitWithTerms[T, D] = {
