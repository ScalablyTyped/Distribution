...
object ClownfaceInitWithValues {
  ...
  @scala.inline
  implicit class ClownfaceInitWithValuesOps[Self <: ClownfaceInitWithValues[_], D /* <: DatasetCore[Quad, Quad] */] (val x: Self with ClownfaceInitWithValues[D]) extends AnyVal {
