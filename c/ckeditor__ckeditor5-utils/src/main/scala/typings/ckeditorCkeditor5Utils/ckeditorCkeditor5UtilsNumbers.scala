...
object ckeditorCkeditor5UtilsNumbers {
  ...
  @scala.inline
  def `0x110000`: `0x110000` = 0x110000.asInstanceOf[`0x110000`]
  
  @js.native
  sealed trait `0x220000` extends StObject
  @scala.inline
  def `0x220000`: `0x220000` = 0x220000.asInstanceOf[`0x220000`]
  
  @js.native
  sealed trait `0x440000` extends StObject
  @scala.inline
  def `0x440000`: `0x440000` = 0x440000.asInstanceOf[`0x440000`]
