...
object ckeditorCkeditor5UtilsNumbers {
  
  @js.native
  sealed trait `0x110000` extends StObject
  inline def `0x110000`: `0x110000` = 0x110000.asInstanceOf[`0x110000`]
  
  @js.native
  sealed trait `0x220000` extends StObject
  inline def `0x220000`: `0x220000` = 0x220000.asInstanceOf[`0x220000`]
  
  @js.native
  sealed trait `0x440000` extends StObject
  inline def `0x440000`: `0x440000` = 0x440000.asInstanceOf[`0x440000`]
