...
object mod {
  ...
  inline def apply[Result](f1: js.Function1[/* a */ Any, Result], functions: js.Function*): js.Function1[/* a */ Any, Result] = ^.asInstanceOf[js.Dynamic].apply(List(f1.asInstanceOf[js.Any]).`++`(functions.asInstanceOf[Seq[js.Any]])*).asInstanceOf[js.Function1[/* a */ Any, Result]]
