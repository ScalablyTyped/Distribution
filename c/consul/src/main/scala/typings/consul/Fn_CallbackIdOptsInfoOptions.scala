...
import typings.consul.consulMod.SessionNs.InfoOptions
...
trait Fn_CallbackIdOptsInfoOptions extends js.Object {
  ...
  def apply[TData](opts: InfoOptions): Thenable[TData] = js.native
  def apply[TData](opts: InfoOptions, callback: Callback[TData]): Unit = js.native
}
