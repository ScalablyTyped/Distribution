package typings.consul.consulMod.CatalogNs
...
trait Node extends js.Object {
  ...
  /**
    * Lists the services provided by a node
    */
  def services[TData](opts: typings.consul.consulMod.CatalogNs.NodeNs.ServicesOptions): Thenable[TData] = js.native
  /**
    * Lists the services provided by a node
    */
  def services[TData](opts: typings.consul.consulMod.CatalogNs.NodeNs.ServicesOptions, callback: Callback[TData]): Unit = js.native
}
