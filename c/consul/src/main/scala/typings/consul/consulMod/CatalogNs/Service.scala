...
trait Service extends js.Object {
  ...
  /**
    * Lists the nodes in a given service
    */
  def nodes[TData](opts: typings.consul.consulMod.CatalogNs.ServiceNs.NodesOptions): Thenable[TData] = js.native
  /**
    * Lists the nodes in a given service
    */
  def nodes[TData](opts: typings.consul.consulMod.CatalogNs.ServiceNs.NodesOptions, callback: Callback[TData]): Unit = js.native
  /**
    * Lists the nodes in a given service
    */
