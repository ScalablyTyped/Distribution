...
@js.native
trait Anon_CallbackDcOpts extends js.Object {
  ...
  def apply[TData](opts: consulLib.consulMod.ConsulNs.CatalogNs.ServiceNs.ListOptions): consulLib.consulMod.ConsulNs.Thenable[TData] = js.native
  def apply[TData](
