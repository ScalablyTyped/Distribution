...
trait Fn_CallbackDcOptsNodesOptions extends js.Object {
  ...
  def apply[TData](opts: consulLib.consulMod.CatalogNs.NodesOptions): consulLib.consulMod.Thenable[TData] = js.native
  def apply[TData](opts: consulLib.consulMod.CatalogNs.NodesOptions, callback: consulLib.consulMod.Callback[TData]): scala.Unit = js.native
}
