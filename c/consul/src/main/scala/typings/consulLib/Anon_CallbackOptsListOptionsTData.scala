...
@js.native
trait Anon_CallbackOptsListOptionsTData extends js.Object {
  ...
  def apply[TData](opts: consulLib.consulMod.AgentNs.CheckNs.ListOptions): consulLib.consulMod.Thenable[TData] = js.native
  def apply[TData](
