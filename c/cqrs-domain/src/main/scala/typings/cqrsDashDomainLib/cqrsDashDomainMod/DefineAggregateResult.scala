...
trait DefineAggregateResult extends js.Object {
  /**
    ...
    */
  def defineAggregateIdGenerator(cb: js.Function0[java.lang.String]): DefineAggregateResult = js.native
  def defineAggregateIdGenerator(cb: js.Function1[/* callback */ generateIdCallback, java.lang.String]): DefineAggregateResult = js.native
  /**
    ...
    */
  def defineCommandAwareAggregateIdGenerator(
    cb: js.Function2[/* cmd */ Command, /* callback */ js.UndefOr[generateIdCallback], java.lang.String]
  ...
  def defineIgnoreSnapshot(version: AggregateVersion, cb: js.Function1[/* data */ js.Any, scala.Boolean]): DefineAggregateResult = js.native
  def defineIgnoreSnapshot(version: AggregateVersion, cb: scala.Boolean): DefineAggregateResult = js.native
  /**
  ...
  def defineSnapshotConversion(
    ...
    cb: js.Function2[/* data */ js.Any, /* aggregate */ AggregateModel, scala.Unit]
  ): DefineAggregateResult = js.native
  /**
