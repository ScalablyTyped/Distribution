...
class CrossStorageClient protected () extends js.Object {
  ...
  /**
    ...
    */
  def del(keys: java.lang.String*): js.Promise[scala.Unit] = js.native
  /**
  ...
  def get(keys: java.lang.String*): js.Promise[js.Array[_]] = js.native
  /**
    * Returns a promise that, when resolved, passes an array of keys currently in storage.
    */
  def getKeys(): js.Promise[js.Array[java.lang.String]] = js.native
  /**
    ...
    */
  def onConnect(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def set(key: java.lang.String, value: js.Any): js.Promise[scala.Unit] = js.native
  def set(key: java.lang.String, value: js.Any, ttl: scala.Double): js.Promise[scala.Unit] = js.native
}
