package typings
package checkDashMoreDashTypesLib.checkDashMoreDashTypesMod
...
trait Predicates extends js.Object {
  ...
  def defined(s: js.Any): scala.Boolean = js.native
  def empty(s: js.Any): scala.Boolean = js.native
  def fn(s: js.Any): scala.Boolean = js.native
  def number(s: js.Any): scala.Boolean = js.native
  def `object`(s: js.Any): scala.Boolean = js.native
  def unemptyString(s: js.Any): scala.Boolean = js.native
  def webUrl(s: js.Any): scala.Boolean = js.native
}
