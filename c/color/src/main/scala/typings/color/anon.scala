...
import typings.color.colorStrings.g16
...
import typings.color.colorStrings.r16
...
object anon {
  ...
  trait Typeofansi16 extends StObject {
    ...
    var keyword: typings.colorConvert.anon.`1` = js.native
  ...
  trait Typeofapple extends StObject {
    ...
    val channels: typings.color.colorInts.`3` = js.native
  ...
  trait Typeofcmyk extends StObject {
    ...
    val channels: typings.color.colorInts.`4` = js.native
