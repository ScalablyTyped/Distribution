...
object Typeofconvert {
  @scala.inline
  def apply(
    ansi16: Typeofansi16 with ansi16 with typings.color.colorStrings.Typeofconvert,
    ansi256: Typeofansi256 with ansi256 with typings.color.colorStrings.Typeofconvert,
    apple: Typeofapple with apple with typings.color.colorStrings.Typeofconvert,
    cmyk: Typeofcmyk with cmyk with typings.color.colorStrings.Typeofconvert,
    gray: Typeofgray with gray with typings.color.colorStrings.Typeofconvert,
    hcg: Typeofhcg with hcg with typings.color.colorStrings.Typeofconvert,
    hex: Typeofhex with hex with typings.color.colorStrings.Typeofconvert,
    hsl: Typeofhsl with hsl with typings.color.colorStrings.Typeofconvert,
    hsv: Typeofhsv with hsv with typings.color.colorStrings.Typeofconvert,
    hwb: Typeofhwb with hwb with typings.color.colorStrings.Typeofconvert,
    keyword: Typeofkeyword with keyword with typings.color.colorStrings.Typeofconvert,
    lab: Typeoflab with lab with typings.color.colorStrings.Typeofconvert,
    lch: Typeoflch with lch with typings.color.colorStrings.Typeofconvert,
    rgb: Typeofrgb with rgb with typings.color.colorStrings.Typeofconvert,
    xyz: Typeofxyz with xyz with typings.color.colorStrings.Typeofconvert
  ): Typeofconvert = {
