...
trait BezierEdges extends js.Object {
  ...
  /**
    ...
    */
  var `control-point-weight`: Double
  /**
...
object BezierEdges {
  @scala.inline
  def apply(
    `control-point-distance`: Double,
    `control-point-step-size`: Double,
    `control-point-weight`: Double,
    `edge-distances`: Double
  ): BezierEdges = {
