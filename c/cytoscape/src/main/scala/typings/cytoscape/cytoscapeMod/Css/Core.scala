...
trait Core extends js.Object {
  ...
  /**
    ...
    */
  var `active-bg-opacity`: Double
  /**
    * The size of the active background indicator.
    */
  var `active-bg-size`: Double
  /**
  ...
  /**
    ...
    */
  var `outside-texture-bg-opacity`: Double
  /**
  ...
  /**
    ...
    */
  var `selection-box-border-width`: Double
  /**
    * Selection box:
    */
  /**
  ...
  /**
    ...
    */
  var `selection-box-opacity`: Double
}
...
object Core {
  ...
  def apply(
    ...
    `active-bg-opacity`: Double,
    `active-bg-size`: Double,
    `outside-texture-bg-color`: Colour,
    `outside-texture-bg-opacity`: Double,
    `selection-box-border-color`: Colour,
    `selection-box-border-width`: Double,
    `selection-box-color`: Colour,
    `selection-box-opacity`: Double
  ): Core = {
