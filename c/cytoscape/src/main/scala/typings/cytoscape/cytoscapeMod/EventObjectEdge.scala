...
- typings.cytoscape.cytoscapeMod.LayoutEventObject because var conflicts: cy, namespace, target, timeStamp, `type`. Inlined layout */ trait EventObjectEdge extends InputEventObject {
  /**
