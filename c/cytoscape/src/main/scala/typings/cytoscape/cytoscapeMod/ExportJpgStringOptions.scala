...
- typings.cytoscape.cytoscapeMod.ExportOptions because Already inherited
- typings.cytoscape.cytoscapeMod.ExportStringOptions because var conflicts: bg, full, maxHeight, maxWidth, scale. Inlined output */ trait ExportJpgStringOptions extends ExportJpgOptions {
  /**
