...
import typings.cytoscape.Anon_Parent
import typings.cytoscape.Anon_Source
...
trait CollectionGraphManipulation extends js.Object {
  ...
  /**
    ...
    */
  def move(location: Anon_Parent): NodeCollection = js.native
  /**
    * Effectively move edges to different nodes. The modified (actually new) elements are returned.
    * http://js.cytoscape.org/#eles.move
    */
  def move(location: Anon_Source): EdgeCollection = js.native
  /**
