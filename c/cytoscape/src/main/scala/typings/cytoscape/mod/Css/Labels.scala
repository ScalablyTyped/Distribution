...
object Labels {
  ...
  @scala.inline
  implicit class LabelsOps[Self <: Labels[_], /* <: typings.cytoscape.mod.NodeSingular | typings.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Labels[SingularType]) extends AnyVal {
    @scala.inline
