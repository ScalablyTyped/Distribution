...
object Visibility {
  ...
  @scala.inline
  implicit class VisibilityOps[Self <: Visibility[_], /* <: typings.cytoscape.mod.NodeSingular | typings.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Visibility[SingularType]) extends AnyVal {
    @scala.inline
