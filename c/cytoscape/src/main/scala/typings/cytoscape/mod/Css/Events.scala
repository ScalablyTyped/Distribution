...
object Events {
  ...
  @scala.inline
  implicit class EventsOps[Self <: Events[_], /* <: typings.cytoscape.mod.NodeSingular | typings.cytoscape.mod.EdgeSingular */ SingularType] (val x: Self with Events[SingularType]) extends AnyVal {
    @scala.inline
