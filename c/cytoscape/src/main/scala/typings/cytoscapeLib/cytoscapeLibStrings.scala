...
object cytoscapeLibStrings {
  ...
  @js.native
  sealed trait ractangle extends js.Object
  ...
  @scala.inline
  def ractangle: ractangle = "ractangle".asInstanceOf[ractangle]
  @scala.inline
  ...
  @scala.inline
  def unbundled: unbundled = "unbundled".asInstanceOf[unbundled]
  @scala.inline
