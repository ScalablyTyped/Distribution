...
trait CollectionData extends js.Object {
  /**
    ...
    */
  def jsons(): js.Array[java.lang.String] = js.native
  def removeAttr(): CollectionReturnValue = js.native
  def removeAttr(names: java.lang.String): CollectionReturnValue = js.native
  /**
  ...
  def removeData(names: java.lang.String): CollectionReturnValue = js.native
}
