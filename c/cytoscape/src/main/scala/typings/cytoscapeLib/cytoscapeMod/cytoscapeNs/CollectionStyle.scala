...
trait CollectionStyle extends js.Object {
  ...
  /**
    ...
    */
  def css(name: java.lang.String): js.Any = js.native
  /**
    ...
    */
  def css(name: java.lang.String, value: js.Any): this.type = js.native
  /**
  ...
  def flashClass(classes: ClassNames, duration: scala.Double): this.type = js.native
  /**
  ...
  def removeStyle(names: java.lang.String): this.type = js.native
  /**
    * Get a name-value pair object containing visual style properties and their values for the element.
    */
  ...
  /**
    ...
    * @param value The value to which the property is set.
    */
  def style(name: java.lang.String, value: js.Any): this.type = js.native
  /**
    * Set several particular style property values.
    * @param obj An object of style property name-value pairs to set.
    */
  ...
  def toggleClass(classes: ClassNames, toggle: scala.Boolean): this.type = js.native
}
