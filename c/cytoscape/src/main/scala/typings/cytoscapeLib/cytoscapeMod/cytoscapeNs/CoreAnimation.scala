...
trait CoreAnimation extends js.Object {
  ...
  /**
    ...
    */
  def delay(duration: scala.Double): Core = js.native
  def delay(duration: scala.Double, complete: js.Function0[scala.Unit]): Core = js.native
  /**
  ...
  def stop(clearQueue: scala.Boolean): Core = js.native
  def stop(clearQueue: scala.Boolean, jumpToEnd: scala.Boolean): Core = js.native
}
