...
- cytoscapeLib.cytoscapeMod.cytoscapeNs.NodeCollection because Already inherited / **
  * Get an element at a particular index in the collection.
  *
  * @param index The index of the element to get.
  * /
/ * index * / org.scalablytyped.runtime.NumberDictionary[cytoscapeLib.cytoscapeMod.cytoscapeNs.NodeSingular] */ @js.native
trait NodeSingular
