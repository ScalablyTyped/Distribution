...
object CoseLayoutOptions {
  ...
  def apply(
    ...
    __obj.updateDynamic("componentSpacing")(componentSpacing)
    __obj.updateDynamic("coolingFactor")(coolingFactor)
    __obj.updateDynamic("edgeElasticity")(edgeElasticity)
    __obj.updateDynamic("fit")(fit)
    __obj.updateDynamic("gravity")(gravity)
    __obj.updateDynamic("idealEdgeLength")(idealEdgeLength)
    __obj.updateDynamic("initialTemp")(initialTemp)
    __obj.updateDynamic("minTemp")(minTemp)
    __obj.updateDynamic("name")(name)
    __obj.updateDynamic("nestingFactor")(nestingFactor)
    __obj.updateDynamic("nodeDimensionsIncludeLabels")(nodeDimensionsIncludeLabels)
    __obj.updateDynamic("nodeOverlap")(nodeOverlap)
    __obj.updateDynamic("nodeRepulsion")(nodeRepulsion)
    __obj.updateDynamic("numIter")(numIter)
    __obj.updateDynamic("randomize")(randomize)
    __obj.updateDynamic("refresh")(refresh)
    __obj.updateDynamic("weaver")(weaver)
