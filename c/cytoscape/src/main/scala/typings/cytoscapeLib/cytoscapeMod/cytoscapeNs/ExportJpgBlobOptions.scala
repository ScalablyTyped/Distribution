...
- cytoscapeLib.cytoscapeMod.cytoscapeNs.ExportBlobOptions because var conflicts: bg, full, maxHeight, maxWidth, scale. Inlined output */ trait ExportJpgBlobOptions extends ExportJpgOptions {
  /**
