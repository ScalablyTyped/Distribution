...
- cytoscapeLib.cytoscapeMod.cytoscapeNs.EdgeCollection because Already inherited / **
  * Get an element at a particular index in the collection.
  *
  * @param index The index of the element to get.
  * /
/ * index * / org.scalablytyped.runtime.NumberDictionary[cytoscapeLib.cytoscapeMod.cytoscapeNs.EdgeSingular] */ @js.native
trait EdgeSingular
