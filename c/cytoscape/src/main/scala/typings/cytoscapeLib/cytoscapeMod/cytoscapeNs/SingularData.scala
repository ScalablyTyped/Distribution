...
trait SingularData extends js.Object {
  ...
  /**
    ...
    */
  def isEdge(): /* is cytoscape.cytoscape.cytoscape.EdgeSingular */ scala.Boolean = js.native
  /**
    * Get whether the element is a node.
    * http://js.cytoscape.org/#ele.isNode
    */
  def isNode(): /* is cytoscape.cytoscape.cytoscape.NodeSingular */ scala.Boolean = js.native
  /**
    * Get the element's plain JavaScript object representation.
    * http://js.cytoscape.org/#ele.json
    */
  def json(): java.lang.String = js.native
  /**
