...
trait CashStatic extends js.Object {
  ...
  def apply(elementArray: js.Array[stdLib.Element]): Cash = js.native
  def apply(element: stdLib.Element): Cash = js.native
  /**
     * selector declaration for Cash to use $(<argument>)
     */
  def apply(selector: java.lang.String): Cash = js.native
  /**
     * selector declaration for Cash to use $(<argument>)
     */
  def apply(selector: java.lang.String, context: Cash): Cash = js.native
  /**
     * selector declaration for Cash to use $(<argument>)
     */
  def apply(selector: java.lang.String, context: stdLib.Element): Cash = js.native
  /**
     * each
  ...
  /**
     ...
     * @return boolean
     */
  def isArray(n: js.Any): scala.Boolean = js.native
  /**
     * isFunction
     ...
     * @return boolean
     */
  def isFunction(n: js.Any): scala.Boolean = js.native
  /**
     * isNumeric
  ...
  /**
     ...
     * @return boolean
     */
  def matches(element: Cash, selector: java.lang.String): scala.Boolean = js.native
  /**
     * parseHTML
     ...
     * @return Cash
     */
  def parseHTML(htmlString: java.lang.String): Cash = js.native
}
