...
import typings.cesiumEngine.mod.Cesium3DTile
import typings.cesiumEngine.mod.Cesium3DTileColorBlendMode
import typings.cesiumEngine.mod.Cesium3DTileFeature
...
@JSImport("@cesium/widgets", "Cesium3DTilesInspectorViewModel")
@js.native
