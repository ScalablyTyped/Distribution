...
import typings.cesiumWidgets.anon.Scene
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/widgets", "PerformanceWatchdogViewModel")
@js.native
open class PerformanceWatchdogViewModel () extends StObject {
  def this(options: Scene) = this()
  ...
  /**
    ...
    */
  var scene: typings.cesiumEngine.mod.Scene = js.native
