...
object cswDashAasDashJsComponents extends cswDashAasDashJsProps {
  @scala.inline
  def AuthContextProvider: ComponentType[AuthContextProps] = typings.cswDashAasDashJs.cswDashAasDashJsMod.asInstanceOf[js.Dynamic].selectDynamic("AuthContextProvider").asInstanceOf[typings.react.reactMod.ComponentType[
  ...
  ] = typings.cswDashAasDashJs.cswDashAasDashJsMod.asInstanceOf[js.Dynamic].selectDynamic("CheckLogin").asInstanceOf[typings.react.reactMod.ComponentType[
  typings.cswDashAasDashJs.distComponentsAuthenticationCheckLoginMod.CheckLoginProps]]
  @scala.inline
  ...
  @scala.inline
  def RealmRole: ComponentType[typings.cswDashAasDashJs.distComponentsAuthorizationRealmRoleMod.RealmRoleProps] = typings.cswDashAasDashJs.cswDashAasDashJsMod.asInstanceOf[js.Dynamic].selectDynamic("RealmRole").asInstanceOf[typings.react.reactMod.ComponentType[typings.cswDashAasDashJs.distComponentsAuthorizationRealmRoleMod.RealmRoleProps]]
}
