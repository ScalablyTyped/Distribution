...
object mod {
  ...
  @scala.inline
  def apply(styles: CSSObject): String = ^.asInstanceOf[js.Dynamic].apply(styles.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  @scala.inline
  def css(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("css")().asInstanceOf[String]
  
  /** Sets a custom className prefix */
  @scala.inline
  def prefix(`val`: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("prefix")(`val`.asInstanceOf[js.Any]).asInstanceOf[Unit]
