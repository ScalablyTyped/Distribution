...
@JSImport("chart.js/dist", "PointElement")
@js.native
...
object PointElement {
  ...
  /**
    * @type {any}
    */
  @JSImport("chart.js/dist", "PointElement.defaultRoutes")
  @js.native
  ...
  /**
    * @type {any}
    */
  @JSImport("chart.js/dist", "PointElement.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist", "PointElement.id")
  @js.native
