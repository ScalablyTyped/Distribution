...
@JSImport("chart.js/dist", "BarController")
@js.native
open class BarController ()
  extends typings.chartJs.distControllersMod.BarController
/* static members */
object BarController {
  ...
  @JSImport("chart.js/dist", "BarController.id")
  @js.native
  ...
  /**
    * @type {any}
    */
  @JSImport("chart.js/dist", "BarController.overrides")
  @js.native
