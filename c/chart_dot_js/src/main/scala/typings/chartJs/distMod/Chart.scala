...
@JSImport("chart.js/dist", "Chart")
@js.native
open class Chart protected ()
  extends typings.chartJs.distCoreMod.Chart {
...
object Chart {
  ...
  /* static member */
  @JSImport("chart.js/dist", "Chart.defaults")
  @js.native
  ...
  /* static member */
  @JSImport("chart.js/dist", "Chart.getChart")
  @js.native
  ...
  /* static member */
  @JSImport("chart.js/dist", "Chart.overrides")
  @js.native
  ...
  /* static member */
  @JSImport("chart.js/dist", "Chart.registry")
  @js.native
  ...
  /* static member */
  @JSImport("chart.js/dist", "Chart.version")
  @js.native
