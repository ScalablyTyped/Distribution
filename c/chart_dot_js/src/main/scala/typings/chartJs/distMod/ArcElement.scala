...
@JSImport("chart.js/dist", "ArcElement")
@js.native
...
object ArcElement {
  ...
  @JSImport("chart.js/dist", "ArcElement.defaultRoutes")
  @js.native
  ...
  @JSImport("chart.js/dist", "ArcElement.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist", "ArcElement.descriptors")
  @js.native
  ...
  @JSImport("chart.js/dist", "ArcElement.id")
  @js.native
