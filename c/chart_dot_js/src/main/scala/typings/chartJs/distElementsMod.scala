...
object distElementsMod {
  
  @JSImport("chart.js/dist/elements", "ArcElement")
  @js.native
  ...
  object ArcElement {
    ...
    @JSImport("chart.js/dist/elements", "ArcElement.defaultRoutes")
    @js.native
    ...
    @JSImport("chart.js/dist/elements", "ArcElement.defaults")
    @js.native
    ...
    @JSImport("chart.js/dist/elements", "ArcElement.descriptors")
    @js.native
    ...
    @JSImport("chart.js/dist/elements", "ArcElement.id")
    @js.native
    def id: String = js.native
    inline def id_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("chart.js/dist/elements", "BarElement")
  @js.native
  open class BarElement protected ()
    extends typings.chartJs.distElementsElementDotbarMod.default {
    def this(cfg: Any) = this()
  }
  /* static members */
  object BarElement {
    ...
    /**
      * @type {any}
      */
    @JSImport("chart.js/dist/elements", "BarElement.defaults")
    @js.native
    ...
    @JSImport("chart.js/dist/elements", "BarElement.id")
    @js.native
    def id: String = js.native
    inline def id_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("chart.js/dist/elements", "LineElement")
  @js.native
  open class LineElement protected ()
    extends typings.chartJs.distElementsElementDotlineMod.default {
    def this(cfg: Any) = this()
  }
  /* static members */
  object LineElement {
    ...
    /**
      * @type {any}
      */
    @JSImport("chart.js/dist/elements", "LineElement.defaults")
    @js.native
    def defaults: Any = js.native
    inline def defaults_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaults")(x.asInstanceOf[js.Any])
    
    @JSImport("chart.js/dist/elements", "LineElement.descriptors")
    @js.native
    def descriptors: Indexable = js.native
    inline def descriptors_=(x: Indexable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("descriptors")(x.asInstanceOf[js.Any])
    
    @JSImport("chart.js/dist/elements", "LineElement.id")
    @js.native
    def id: String = js.native
    inline def id_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("chart.js/dist/elements", "PointElement")
  @js.native
  open class PointElement protected ()
    extends typings.chartJs.distElementsElementDotpointMod.default {
    def this(cfg: Any) = this()
  }
  /* static members */
  object PointElement {
    ...
    /**
      * @type {any}
      */
    @JSImport("chart.js/dist/elements", "PointElement.defaultRoutes")
    @js.native
    ...
    /**
      * @type {any}
      */
    @JSImport("chart.js/dist/elements", "PointElement.defaults")
    @js.native
    ...
    @JSImport("chart.js/dist/elements", "PointElement.id")
    @js.native
    def id: String = js.native
    inline def id_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("id")(x.asInstanceOf[js.Any])
  }
