...
object TimeSeriesScale {
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.afterRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.afterUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.beforeRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.beforeUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.defaultRoutes")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "TimeSeriesScale.id")
  @js.native
