...
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.PointOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'bubble'>> */
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.PointHoverOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'bubble'>> */
trait BubbleControllerDatasetOptions extends StObject {
  
  var backgroundColor: ScriptableAndArray[Color, ScriptableContext[bubble]]
  
  var borderColor: ScriptableAndArray[Color, ScriptableContext[bubble]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[bubble]]
  
  var hoverBorderColor: ScriptableAndArray[Color, ScriptableContext[bubble]]
  ...
  var pointStyle: ScriptableAndArray[PointStyle, ScriptableContext[bubble]]
...
object BubbleControllerDatasetOptions {
  ...
  implicit open class MutableBuilder[Self <: BubbleControllerDatasetOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColorFunction2(value: (ScriptableContext[bubble], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    
    inline def setBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "backgroundColor", js.Array(value*))
    
    inline def setBorderColor(value: ScriptableAndArray[Color, ScriptableContext[bubble]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    
    inline def setBorderColorFunction2(value: (ScriptableContext[bubble], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "borderColor", js.Any.fromFunction2(value))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[bubble]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(value: (ScriptableContext[bubble], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    
    inline def setHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[bubble]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(value: (ScriptableContext[bubble], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
    ...
    inline def setPointStyle(value: ScriptableAndArray[PointStyle, ScriptableContext[bubble]]): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
    
    inline def setPointStyleFunction2(value: (ScriptableContext[bubble], /* options */ AnyObject) => js.UndefOr[PointStyle]): Self = StObject.set(x, "pointStyle", js.Any.fromFunction2(value))
