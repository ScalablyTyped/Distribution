...
trait ChartMetaCommon[TElement /* <: default[AnyObject, AnyObject] */, TDatasetElement /* <: default[AnyObject, AnyObject] */] extends StObject {
...
object ChartMetaCommon {
  ...
  inline def apply[TElement /* <: default[AnyObject, AnyObject] */, TDatasetElement /* <: default[AnyObject, AnyObject] */](
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartMetaCommon[?, ?], TElement /* <: default[AnyObject, AnyObject] */, TDatasetElement /* <: default[AnyObject, AnyObject] */] (val x: Self & (ChartMetaCommon[TElement, TDatasetElement])) extends AnyVal {
