...
/* Inlined std.Omit<chart.js.chart.js/dist/types/index.CartesianScaleOptions, 'min' | 'max'> & {  min :string | number,   max :string | number,   labels :std.Array<string> | std.Array<std.Array<string>>} */
