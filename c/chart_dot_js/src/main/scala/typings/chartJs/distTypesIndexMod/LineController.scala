...
/* Inlined chart.js.chart.js/dist/types/index.ChartComponent & {  prototype :chart.js.chart.js/dist/types/index.LineController, new (chart : chart.js.chart.js/dist/types/index.Chart<chart.js.chart.js/dist/types/index.ChartType, chart.js.chart.js/dist/types/index.DefaultDataPoint<chart.js.chart.js/dist/types/index.ChartType>, unknown>, datasetIndex : number): chart.js.chart.js/dist/types/index.LineController} */
object LineController {
  
  @JSImport("chart.js/dist/types/index", "LineController")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chart.js/dist/types/index", "LineController.afterRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.afterUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.beforeRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.beforeUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.defaultRoutes")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "LineController.id")
  @js.native
