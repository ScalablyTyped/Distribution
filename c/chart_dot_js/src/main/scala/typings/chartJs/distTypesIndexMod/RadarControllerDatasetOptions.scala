...
/* Inlined parent chart.js.chart.js/dist/types/index.ControllerDatasetOptions */
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.PointOptions & chart.js.chart.js/dist/types/index.PointHoverOptions & chart.js.chart.js/dist/types/index.PointPrefixedOptions & chart.js.chart.js/dist/types/index.PointPrefixedHoverOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'radar'>> */
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.LineOptions & chart.js.chart.js/dist/types/index.LineHoverOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'radar'>> */
/* Inlined parent chart.js.chart.js/dist/types/index.AnimationOptions<'radar'> */
trait RadarControllerDatasetOptions extends StObject {
  
  var animation: `false` | AnimationSpecradaronProgr
  
  var animations: AnimationsSpec[radar]
  
  var backgroundColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  
  var borderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext[radar]]
  
  var borderColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  
  var hoverBorderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext[radar]]
  
  var hoverBorderColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  ...
  var pointBackgroundColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  
  var pointBorderColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  ...
  var pointHoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  
  var pointHoverBorderColor: ScriptableAndArray[Color, ScriptableContext[radar]]
  ...
  var pointStyle: ScriptableAndArray[PointStyle, ScriptableContext[radar]]
  ...
  var segment: ScriptableAndArray[BorderCapStyle, ScriptableContext[radar]]
...
object RadarControllerDatasetOptions {
  ...
  inline def apply(
    ...
    segment: ScriptableAndArray[BorderCapStyle, ScriptableContext[radar]],
    showLine: Boolean,
  ...
  implicit open class MutableBuilder[Self <: RadarControllerDatasetOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    
    inline def setBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "backgroundColor", js.Array(value*))
    ...
    inline def setBorderColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    
    inline def setBorderColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "borderColor", js.Any.fromFunction2(value))
    
    inline def setBorderColorVarargs(value: Color*): Self = StObject.set(x, "borderColor", js.Array(value*))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    ...
    inline def setHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
    
    inline def setHoverBorderColorVarargs(value: Color*): Self = StObject.set(x, "hoverBorderColor", js.Array(value*))
    ...
    inline def setPointBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "pointBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointBackgroundColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "pointBackgroundColor", js.Array(value*))
    
    inline def setPointBorderColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "pointBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointBorderColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointBorderColor", js.Any.fromFunction2(value))
    
    inline def setPointBorderColorVarargs(value: Color*): Self = StObject.set(x, "pointBorderColor", js.Array(value*))
    ...
    inline def setPointHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "pointHoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBackgroundColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointHoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "pointHoverBackgroundColor", js.Array(value*))
    
    inline def setPointHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[radar]]): Self = StObject.set(x, "pointHoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBorderColorFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointHoverBorderColor", js.Any.fromFunction2(value))
    
    inline def setPointHoverBorderColorVarargs(value: Color*): Self = StObject.set(x, "pointHoverBorderColor", js.Array(value*))
    ...
    inline def setPointStyle(value: ScriptableAndArray[PointStyle, ScriptableContext[radar]]): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
    
    inline def setPointStyleFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[PointStyle]): Self = StObject.set(x, "pointStyle", js.Any.fromFunction2(value))
    
    inline def setPointStyleVarargs(value: PointStyle*): Self = StObject.set(x, "pointStyle", js.Array(value*))
    ...
    inline def setSegment(value: ScriptableAndArray[BorderCapStyle, ScriptableContext[radar]]): Self = StObject.set(x, "segment", value.asInstanceOf[js.Any])
    
    inline def setSegmentFunction2(value: (ScriptableContext[radar], /* options */ AnyObject) => js.UndefOr[BorderCapStyle]): Self = StObject.set(x, "segment", js.Any.fromFunction2(value))
    
    inline def setSegmentVarargs(value: BorderCapStyle*): Self = StObject.set(x, "segment", js.Array(value*))
