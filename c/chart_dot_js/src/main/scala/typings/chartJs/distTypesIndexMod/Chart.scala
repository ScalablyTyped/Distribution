...
@JSImport("chart.js/dist/types/index", "Chart")
@js.native
open class Chart[TType /* <: ChartType */, TData, TLabel] protected () extends StObject {
  ...
  def getContext(): typings.chartJs.anon.ChartType = js.native
  
  def getDataVisibility(index: Double): Boolean = js.native
  
  def getDatasetMeta(datasetIndex: Double): ChartMeta[ChartType, default[AnyObject, AnyObject], default[AnyObject, AnyObject]] = js.native
  ...
  def getSortedVisibleDatasetMetas(): js.Array[
    ChartMeta[ChartType, default[AnyObject, AnyObject], default[AnyObject, AnyObject]]
  ] = js.native
...
object Chart {
  ...
  @JSImport("chart.js/dist/types/index", "Chart.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "Chart.instances")
  @js.native
  val instances: StringDictionary[Chart[ChartType, DefaultDataPoint[ChartType], Any]] = js.native
  
  @JSImport("chart.js/dist/types/index", "Chart.overrides")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "Chart.registry")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "Chart.version")
  @js.native
