...
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.BarOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'bar'>> */
/* Inlined parent chart.js.chart.js/dist/types/index.ScriptableAndArrayOptions<chart.js.chart.js/dist/types/index.CommonHoverOptions, chart.js.chart.js/dist/types/index.ScriptableContext<'bar'>> */
/* Inlined parent chart.js.chart.js/dist/types/index.AnimationOptions<'bar'> */
trait BarControllerDatasetOptions extends StObject {
  ...
  var borderWidth: ScriptableAndArray[Double | Top, ScriptableContext[bar]]
...
object BarControllerDatasetOptions {
  ...
  inline def apply(
    ...
    borderWidth: ScriptableAndArray[Double | Top, ScriptableContext[bar]],
  ...
  implicit open class MutableBuilder[Self <: BarControllerDatasetOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBorderWidth(value: ScriptableAndArray[Double | Top, ScriptableContext[bar]]): Self = StObject.set(x, "borderWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderWidthFunction2(value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Double | Top]): Self = StObject.set(x, "borderWidth", js.Any.fromFunction2(value))
    
    inline def setBorderWidthVarargs(value: (Double | Top)*): Self = StObject.set(x, "borderWidth", js.Array(value*))
