...
@JSImport("chart.js/dist/types/index", "DatasetController")
@js.native
open class DatasetController[TType /* <: ChartType */, TElement /* <: default[AnyObject, AnyObject] */, TDatasetElement /* <: default[AnyObject, AnyObject] */, TParsedData] protected () extends StObject {
  def this(chart: Chart[ChartType, DefaultDataPoint[ChartType], Any], datasetIndex: Double) = this()
  
  val _cachedMeta: ChartMeta[TType, TElement, TDatasetElement] = js.native
  ...
  /* protected */ def getLabelAndValue(index: Double): LabelValue = js.native
  
  /* protected */ def getMaxOverflow(): Boolean | Double = js.native
  
  def getMeta(): ChartMeta[TType, TElement, TDatasetElement] = js.native
