...
import typings.chartJs.anon.CancelableIndex
...
import typings.chartJs.distTypesBasicMod.EmptyObject
...
object Plugin {
  ...
  implicit open class MutableBuilder[Self <: Plugin[?, ?], TType /* <: ChartType */, O] (val x: Self & (Plugin[TType, O])) extends AnyVal {
    ...
    inline def setAfterDatasetUpdate(
      value: (/* chart */ Chart[ChartType, DefaultDataPoint[ChartType], Any], /* args */ CancelableIndex, /* options */ O) => Unit
    ...
    inline def setBeforeDatasetUpdate(
      value: (/* chart */ Chart[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Meta, /* options */ O) => Boolean | Unit
