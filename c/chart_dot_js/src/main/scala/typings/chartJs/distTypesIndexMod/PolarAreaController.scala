...
object PolarAreaController {
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chart.js/dist/types/index", "PolarAreaController.afterRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.afterUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.beforeRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.beforeUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.defaultRoutes")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "PolarAreaController.id")
  @js.native
