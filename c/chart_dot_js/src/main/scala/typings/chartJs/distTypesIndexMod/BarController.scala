...
/* Inlined chart.js.chart.js/dist/types/index.ChartComponent & {  prototype :chart.js.chart.js/dist/types/index.BarController, new (chart : chart.js.chart.js/dist/types/index.Chart<chart.js.chart.js/dist/types/index.ChartType, chart.js.chart.js/dist/types/index.DefaultDataPoint<chart.js.chart.js/dist/types/index.ChartType>, unknown>, datasetIndex : number): chart.js.chart.js/dist/types/index.BarController} */
object BarController {
  
  @JSImport("chart.js/dist/types/index", "BarController")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chart.js/dist/types/index", "BarController.afterRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.afterUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.beforeRegister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.beforeUnregister")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.defaultRoutes")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.defaults")
  @js.native
  ...
  @JSImport("chart.js/dist/types/index", "BarController.id")
  @js.native
