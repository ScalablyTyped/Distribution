...
import typings.chartJs.distScalesScaleDotcategoryMod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distScalesMod {
  
  @JSImport("chart.js/dist/scales", "CategoryScale")
  @js.native
  open class CategoryScale () extends default
  /* static members */
  ...
  open class LinearScale ()
    extends typings.chartJs.distScalesScaleDotlinearMod.default
  /* static members */
  object LinearScale {
  ...
  open class LogarithmicScale ()
    extends typings.chartJs.distScalesScaleDotlogarithmicMod.default
  /* static members */
  ...
  open class RadialLinearScale ()
    extends typings.chartJs.distScalesScaleDotradialLinearMod.default
  /* static members */
  ...
  open class TimeSeriesScale ()
    extends typings.chartJs.distScalesScaleDottimeseriesMod.default
}
