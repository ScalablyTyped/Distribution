...
import typings.chartJs.anon.AnimationSpeclineonProgre
...
/* Inlined parent chart.js.chart.js.ControllerDatasetOptions */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.PointPrefixedOptions, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.PointPrefixedHoverOptions, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.ScriptableOptions<std.Omit<chart.js.chart.js.LineOptions, keyof chart.js.chart.js.CommonElementOptions>, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.CommonElementOptions, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.ScriptableOptions<std.Omit<chart.js.chart.js.LineHoverOptions, keyof chart.js.chart.js.CommonHoverOptions>, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.CommonHoverOptions, chart.js.chart.js.ScriptableContext<'line'>> */
/* Inlined parent chart.js.chart.js.AnimationOptions<'line'> */
trait LineControllerDatasetOptions extends StObject {
  
  var animation: `false` | AnimationSpeclineonProgre
  
  var animations: AnimationsSpec[line]
  
  var backgroundColor: ScriptableAndArray[Color, ScriptableContext[line]]
  
  var borderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]]
  
  var borderColor: ScriptableAndArray[Color, ScriptableContext[line]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[line]]
  
  var hoverBorderCapStyle: Scriptable[CanvasLineCap, ScriptableContext[line]]
  
  var hoverBorderColor: ScriptableAndArray[Color, ScriptableContext[line]]
  ...
  var pointBackgroundColor: ScriptableAndArray[Color, ScriptableContext[line]]
  
  var pointBorderColor: ScriptableAndArray[Color, ScriptableContext[line]]
  ...
  var pointHoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[line]]
  
  var pointHoverBorderColor: ScriptableAndArray[Color, ScriptableContext[line]]
  ...
  var pointStyle: ScriptableAndArray[PointStyle, ScriptableContext[line]]
...
object LineControllerDatasetOptions {
  ...
  extension [Self <: LineControllerDatasetOptions](x: Self) {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    ...
    inline def setBorderColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    
    inline def setBorderColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "borderColor", js.Any.fromFunction2(value))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    ...
    inline def setHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
    ...
    inline def setPointBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "pointBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointBackgroundColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "pointBackgroundColor", js.Array(value*))
    
    inline def setPointBorderColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "pointBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointBorderColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointBorderColor", js.Any.fromFunction2(value))
    ...
    inline def setPointHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "pointHoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBackgroundColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointHoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setPointHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "pointHoverBackgroundColor", js.Array(value*))
    
    inline def setPointHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[line]]): Self = StObject.set(x, "pointHoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setPointHoverBorderColorFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "pointHoverBorderColor", js.Any.fromFunction2(value))
    ...
    inline def setPointStyle(value: ScriptableAndArray[PointStyle, ScriptableContext[line]]): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
    
    inline def setPointStyleFunction2(value: (ScriptableContext[line], /* options */ AnyObject) => js.UndefOr[PointStyle]): Self = StObject.set(x, "pointStyle", js.Any.fromFunction2(value))
