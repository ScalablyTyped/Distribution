...
trait TooltipCallbacks[TType /* <: ChartType */, Model, Item] extends StObject {
  ...
  def labelPointStyle(tooltipItem: Item): typings.chartJs.anon.PointStyle
...
object TooltipCallbacks {
  ...
  inline def apply[TType /* <: ChartType */, Model, Item](
    ...
    labelPointStyle: Item => typings.chartJs.anon.PointStyle,
  ...
  extension [Self <: TooltipCallbacks[?, ?, ?], TType /* <: ChartType */, Model, Item](x: Self & (TooltipCallbacks[TType, Model, Item])) {
    ...
    inline def setLabelPointStyle(value: Item => typings.chartJs.anon.PointStyle): Self = StObject.set(x, "labelPointStyle", js.Any.fromFunction1(value))
