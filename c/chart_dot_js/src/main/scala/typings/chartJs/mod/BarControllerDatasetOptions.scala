...
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.BarOptions, chart.js.chart.js.ScriptableContext<'bar'>> */
/* Inlined parent chart.js.chart.js.ScriptableAndArrayOptions<chart.js.chart.js.CommonHoverOptions, chart.js.chart.js.ScriptableContext<'bar'>> */
/* Inlined parent chart.js.chart.js.AnimationOptions<'bar'> */
trait BarControllerDatasetOptions extends StObject {
  
  var animation: `false` | AnimationSpecbaronProgres
  
  var animations: AnimationsSpec[bar]
  
  var backgroundColor: ScriptableAndArray[Color, ScriptableContext[bar]]
  ...
  var borderColor: ScriptableAndArray[Color, ScriptableContext[bar]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[Color, ScriptableContext[bar]]
  
  var hoverBorderColor: ScriptableAndArray[Color, ScriptableContext[bar]]
...
object BarControllerDatasetOptions {
  ...
  extension [Self <: BarControllerDatasetOptions](x: Self) {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[bar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    ...
    inline def setBorderColor(value: ScriptableAndArray[Color, ScriptableContext[bar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    
    inline def setBorderColorFunction2(value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "borderColor", js.Any.fromFunction2(value))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setHoverBackgroundColorVarargs(value: Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    
    inline def setHoverBorderColor(value: ScriptableAndArray[Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Color]): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
