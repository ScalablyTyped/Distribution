...
trait ScriptableLineSegmentContext extends StObject {
  ...
  var p0: PointElement[PointProps, PointOptions]
  
  var p0DataIndex: Double
  
  var p1: PointElement[PointProps, PointOptions]
...
object ScriptableLineSegmentContext {
  ...
  extension [Self <: ScriptableLineSegmentContext](x: Self) {
    ...
    inline def setP0(value: PointElement[PointProps, PointOptions]): Self = StObject.set(x, "p0", value.asInstanceOf[js.Any])
    
    inline def setP0DataIndex(value: Double): Self = StObject.set(x, "p0DataIndex", value.asInstanceOf[js.Any])
    
    inline def setP1(value: PointElement[PointProps, PointOptions]): Self = StObject.set(x, "p1", value.asInstanceOf[js.Any])
