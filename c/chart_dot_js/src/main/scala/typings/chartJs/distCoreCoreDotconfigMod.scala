...
object distCoreCoreDotconfigMod {
  
  @JSImport("chart.js/dist/core/core.config", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chart.js/dist/core/core.config", JSImport.Default)
  @js.native
  ...
  inline def determineAxis(id: Any, scaleOptions: Any*): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("determineAxis")(scala.List(id.asInstanceOf[js.Any]).`++`(scaleOptions.asInstanceOf[Seq[js.Any]])*).asInstanceOf[Any]
  
  inline def getIndexAxis(`type`: Any, options: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("getIndexAxis")(`type`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Any]
