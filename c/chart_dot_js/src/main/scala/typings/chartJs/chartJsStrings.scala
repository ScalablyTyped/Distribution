...
object chartJsStrings {
  ...
  sealed trait bottom
    extends StObject
       with TooltipYAlignment
       with _LayoutPosition
  ...
  @js.native
  sealed trait chartArea
    extends StObject
       with _LayoutPosition
  inline def chartArea: chartArea = "chartArea".asInstanceOf[chartArea]
  ...
  sealed trait crossRot
    extends StObject
       with _PointStyle
  inline def crossRot: crossRot = "crossRot".asInstanceOf[crossRot]
  ...
  @js.native
  sealed trait far extends StObject
  ...
  @js.native
  sealed trait isoWeek extends StObject
  ...
  sealed trait lttb
    extends StObject
       with DecimationAlgorithm
  inline def lttb: lttb = "lttb".asInstanceOf[lttb]
  ...
  sealed trait polarArea
    extends StObject
       with ChartType
  inline def polarArea: polarArea = "polarArea".asInstanceOf[polarArea]
  ...
  sealed trait radialLinear
    extends StObject
       with ScaleType
  inline def radialLinear: radialLinear = "radialLinear".asInstanceOf[radialLinear]
  ...
  sealed trait rectRot
    extends StObject
       with _PointStyle
  inline def rectRot: rectRot = "rectRot".asInstanceOf[rectRot]
  
  @js.native
  sealed trait rectRounded
    extends StObject
       with _PointStyle
  inline def rectRounded: rectRounded = "rectRounded".asInstanceOf[rectRounded]
