...
import typings.chartJs.mod.BorderAlignment
import typings.chartJs.mod.ChartType
import typings.chartJs.mod.Easing
import typings.chartJs.mod.InteractionMode
import typings.chartJs.mod.PointStyle
import typings.chartJs.mod.PositionType
import typings.chartJs.mod.ScaleType
import typings.chartJs.mod.TextAlignment
import typings.chartJs.mod.TimeUnit
