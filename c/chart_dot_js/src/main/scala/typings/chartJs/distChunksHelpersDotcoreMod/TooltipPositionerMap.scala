...
trait TooltipPositionerMap extends StObject {
  ...
  def average(items: js.Array[ActiveElement], eventPosition: Point1): TooltipPosition | false
  @JSName("average")
  var average_Original: TooltipPositionerFunction[ChartType]
  
  def nearest(items: js.Array[ActiveElement], eventPosition: Point1): TooltipPosition | false
  @JSName("nearest")
