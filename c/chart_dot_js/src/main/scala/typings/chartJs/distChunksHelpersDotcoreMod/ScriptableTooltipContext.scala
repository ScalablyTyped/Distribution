...
trait ScriptableTooltipContext[TType /* <: ChartType */] extends StObject {
  ...
  var chart: UnionToIntersection[Chart4[TType, DefaultDataPoint[TType], Any]]
...
object ScriptableTooltipContext {
  ...
  inline def apply[TType /* <: ChartType */](
    chart: UnionToIntersection[Chart4[TType, DefaultDataPoint[TType], Any]],
  ...
  extension [Self <: ScriptableTooltipContext[?], TType /* <: ChartType */](x: Self & ScriptableTooltipContext[TType]) {
    ...
    inline def setChart(value: UnionToIntersection[Chart4[TType, DefaultDataPoint[TType], Any]]): Self = StObject.set(x, "chart", value.asInstanceOf[js.Any])
