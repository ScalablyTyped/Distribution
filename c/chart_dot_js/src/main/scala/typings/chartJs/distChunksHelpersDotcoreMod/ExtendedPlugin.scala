...
object ExtendedPlugin {
  ...
  extension [Self <: ExtendedPlugin[?, ?, ?], TType /* <: ChartType */, O, Model](x: Self & (ExtendedPlugin[TType, O, Model])) {
    ...
    inline def setAfterTooltipDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ typings.chartJs.anon.Tooltip[Model], /* options */ O) => Unit
    ...
    inline def setBeforeTooltipDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Cancelable[Model], /* options */ O) => Boolean | Unit
