...
/* Inlined std.Omit<chart.js.chart.js/dist/chunks/helpers.core.CartesianScaleOptions, 'min' | 'max'> & {  min :string | number,   max :string | number,   suggestedMin :string | number,   suggestedMax :string | number,   bounds :'ticks' | 'data',   offsetAfterAutoskip :boolean,   adapters :{  date :unknown},   time :{  parser :string | (v : unknown): number,   round :false | chart.js.chart.js/dist/chunks/helpers.core.TimeUnit,   isoWeekday :boolean | number,   displayFormats :{[key: string] : string},   tooltipFormat :string,   unit :false | chart.js.chart.js/dist/chunks/helpers.core.TimeUnit,   minUnit :chart.js.chart.js/dist/chunks/helpers.core.TimeUnit},   ticks :{  source :'labels' | 'auto' | 'data'}} */
