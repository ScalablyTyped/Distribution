...
@js.native
trait Scale2[O /* <: CoreScaleOptions */]
  extends StObject
     with Element[Any, O]
     with LayoutItem {
  ...
  def buildTicks(): js.Array[Tick1] = js.native
  
  def calculateLabelRotation(): Unit = js.native
  
  val chart: Chart4[ChartType, DefaultDataPoint[ChartType], Any] = js.native
  ...
  def generateTickLabels(ticks: js.Array[Tick1]): Unit = js.native
  ...
  def getTicks(): js.Array[Tick1] = js.native
  ...
  var ticks: js.Array[Tick1] = js.native
