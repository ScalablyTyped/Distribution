...
trait ChartMetaCommon[TElement /* <: Element[AnyObject, AnyObject] */, TDatasetElement /* <: Element[AnyObject, AnyObject] */] extends StObject {
  ...
  var controller: DatasetController1[
    ChartType, 
  ...
  var iScale: js.UndefOr[Scale2[CoreScaleOptions]] = js.undefined
  ...
  var rScale: js.UndefOr[Scale2[CoreScaleOptions]] = js.undefined
  ...
  var vScale: js.UndefOr[Scale2[CoreScaleOptions]] = js.undefined
  
  var visible: Boolean
  
  var xAxisID: js.UndefOr[String] = js.undefined
  
  var xScale: js.UndefOr[Scale2[CoreScaleOptions]] = js.undefined
  
  var yAxisID: js.UndefOr[String] = js.undefined
  
  var yScale: js.UndefOr[Scale2[CoreScaleOptions]] = js.undefined
}
object ChartMetaCommon {
  ...
  extension [Self <: ChartMetaCommon[?, ?], TElement /* <: Element[AnyObject, AnyObject] */, TDatasetElement /* <: Element[AnyObject, AnyObject] */](x: Self & (ChartMetaCommon[TElement, TDatasetElement])) {
    ...
    inline def setIScale(value: Scale2[CoreScaleOptions]): Self = StObject.set(x, "iScale", value.asInstanceOf[js.Any])
    ...
    inline def setRScale(value: Scale2[CoreScaleOptions]): Self = StObject.set(x, "rScale", value.asInstanceOf[js.Any])
    ...
    inline def setVScale(value: Scale2[CoreScaleOptions]): Self = StObject.set(x, "vScale", value.asInstanceOf[js.Any])
    ...
    inline def setXScale(value: Scale2[CoreScaleOptions]): Self = StObject.set(x, "xScale", value.asInstanceOf[js.Any])
    ...
    inline def setYScale(value: Scale2[CoreScaleOptions]): Self = StObject.set(x, "yScale", value.asInstanceOf[js.Any])
