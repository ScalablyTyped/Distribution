...
import typings.chartJs.anon.ModeUpdateMode
...
trait Plugin[TType /* <: ChartType */, O]
  ...
  /**
    ...
    */
  var defaults: js.UndefOr[Partial[O]] = js.undefined
...
object Plugin {
  ...
  extension [Self <: Plugin[?, ?], TType /* <: ChartType */, O](x: Self & (Plugin[TType, O])) {
    ...
    inline def setAfterBuildTicks(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ typings.chartJs.anon.Scale, /* options */ O) => Unit
    ...
    inline def setAfterDatasetDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ IndexMeta, /* options */ O) => Unit
    ...
    inline def setAfterDatasetUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Meta, /* options */ O) => Unit
    ...
    inline def setAfterDatasetsDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ EmptyObject, /* options */ O, /* cancelable */ false) => Unit
    ...
    inline def setAfterDatasetsUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Mode, /* options */ O) => Unit
    ...
    inline def setAfterDestroy(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ EmptyObject, /* options */ O) => Unit
    ...
    inline def setAfterEvent(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Changed, /* options */ O) => Unit
    ...
    inline def setAfterUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ ModeUpdateMode, /* options */ O) => Unit
    ...
    inline def setBeforeDatasetDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ IndexMeta, /* options */ O) => Boolean | Unit
    ...
    inline def setBeforeDatasetUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Index, /* options */ O) => Boolean | Unit
    ...
    inline def setBeforeDatasetsDraw(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ `2`, /* options */ O) => Boolean | Unit
    ...
    inline def setBeforeDatasetsUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ ModeUpdateMode, /* options */ O) => Boolean | Unit
    ...
    inline def setBeforeEvent(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Event, /* options */ O) => Boolean | Unit
    ...
    inline def setBeforeUpdate(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Mode, /* options */ O) => Boolean | Unit
    ...
    inline def setDefaults(value: Partial[O]): Self = StObject.set(x, "defaults", value.asInstanceOf[js.Any])
    ...
    inline def setResize(
      value: (/* chart */ Chart4[ChartType, DefaultDataPoint[ChartType], Any], /* args */ Size, /* options */ O) => Unit
