...
trait TooltipOptions[TType /* <: ChartType */]
  ...
  var animation: AnimationSpec[TType] | false
  
  var animations: AnimationsSpec[TType] | false
  ...
  /**
    ...
    */
  def external(args: typings.chartJs.anon.Chart[TType]): Unit
  ...
  /**
    ...
    * @default 6
    */
  var padding: Scriptable[Padding, ScriptableTooltipContext[TType]]
...
object TooltipOptions {
  ...
  inline def apply[TType /* <: ChartType */](
    ...
    external: typings.chartJs.anon.Chart[TType] => Unit,
  ...
  extension [Self <: TooltipOptions[?], TType /* <: ChartType */](x: Self & TooltipOptions[TType]) {
    ...
    inline def setAnimation(value: AnimationSpec[TType] | false): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    
    inline def setAnimations(value: AnimationsSpec[TType] | false): Self = StObject.set(x, "animations", value.asInstanceOf[js.Any])
    ...
    inline def setExternal(value: typings.chartJs.anon.Chart[TType] => Unit): Self = StObject.set(x, "external", js.Any.fromFunction1(value))
    ...
    inline def setPadding(value: Scriptable[Padding, ScriptableTooltipContext[TType]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    inline def setPaddingFunction2(value: (ScriptableTooltipContext[TType], /* options */ AnyObject) => js.UndefOr[Padding]): Self = StObject.set(x, "padding", js.Any.fromFunction2(value))
