...
trait TickOptions extends StObject {
  ...
  def callback(tickValue: String, index: Double, ticks: js.Array[Tick1]): js.UndefOr[String | (js.Array[Double | String]) | Double | Null] = js.native
  /**
    * Returns the string representation of the tick value as it should be displayed on the chart. See callback.
    */
  def callback(tickValue: Double, index: Double, ticks: js.Array[Tick1]): js.UndefOr[String | (js.Array[Double | String]) | Double | Null] = js.native
