...
@js.native
trait DatasetController1[TType /* <: ChartType */, TElement /* <: Element[AnyObject, AnyObject] */, TDatasetElement /* <: Element[AnyObject, AnyObject] */, TParsedData] extends StObject {
  
  val _cachedMeta: ChartMeta[TType, TElement, TDatasetElement] = js.native
  
  def addElements(): Unit = js.native
  
  /* protected */ def applyStack(scale: Scale2[CoreScaleOptions], parsed: js.Array[Any]): Double = js.native
  ...
  def getAllParsedValues(scale: Scale2[CoreScaleOptions]): js.Array[Double] = js.native
  ...
  /* protected */ def getMinMax(scale: Scale2[CoreScaleOptions]): Max = js.native
  /* protected */ def getMinMax(scale: Scale2[CoreScaleOptions], canStack: Boolean): Max = js.native
  
  /* protected */ def getParsed(index: Double): TParsedData = js.native
  
  def getScaleForId(scaleID: String): js.UndefOr[Scale2[CoreScaleOptions]] = js.native
  ...
  /* protected */ def updateRangeFromParsed(range: Max, scale: Scale2[CoreScaleOptions], parsed: js.Array[Any], stack: String): Unit = js.native
  /* protected */ def updateRangeFromParsed(range: Max, scale: Scale2[CoreScaleOptions], parsed: js.Array[Any], stack: Boolean): Unit = js.native
