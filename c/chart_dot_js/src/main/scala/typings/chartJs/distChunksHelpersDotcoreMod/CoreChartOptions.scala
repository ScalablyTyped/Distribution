...
trait CoreChartOptions[TType /* <: ChartType */]
  ...
  /**
    ...
    */
  def onResize(chart: Chart4[ChartType, DefaultDataPoint[ChartType], Any], size: Height): Unit
...
object CoreChartOptions {
  ...
  inline def apply[TType /* <: ChartType */](
    ...
    normalized: Boolean,
    onClick: (ChartEvent1, js.Array[ActiveElement], Chart4[ChartType, DefaultDataPoint[ChartType], Any]) => Unit,
    onHover: (ChartEvent1, js.Array[ActiveElement], Chart4[ChartType, DefaultDataPoint[ChartType], Any]) => Unit,
    onResize: (Chart4[ChartType, DefaultDataPoint[ChartType], Any], Height) => Unit,
  ...
  extension [Self <: CoreChartOptions[?], TType /* <: ChartType */](x: Self & CoreChartOptions[TType]) {
    ...
    inline def setOnClick(
      value: (ChartEvent1, js.Array[ActiveElement], Chart4[ChartType, DefaultDataPoint[ChartType], Any]) => Unit
    ...
    inline def setOnResize(value: (Chart4[ChartType, DefaultDataPoint[ChartType], Any], Height) => Unit): Self = StObject.set(x, "onResize", js.Any.fromFunction2(value))
