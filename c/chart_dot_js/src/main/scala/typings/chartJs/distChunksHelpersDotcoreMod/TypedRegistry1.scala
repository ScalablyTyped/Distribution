...
trait TypedRegistry1[T] extends StObject {
...
object TypedRegistry1 {
  ...
  inline def apply[T](
    ...
    __obj.asInstanceOf[TypedRegistry1[T]]
  }
  
  extension [Self <: TypedRegistry1[?], T](x: Self & TypedRegistry1[T]) {
