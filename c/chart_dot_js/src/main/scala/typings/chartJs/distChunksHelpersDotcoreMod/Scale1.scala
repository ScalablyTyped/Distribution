...
trait Scale1
  extends StObject
     with Element[AnyObject, AnyObject] {
  ...
  def _getYAxisLabelAlignment(tl: Any): typings.chartJs.anon.TextAlign = js.native
  ...
  /**
    ...
    */
  def update(maxWidth: Double, maxHeight: Double, margins: Right): Unit = js.native
