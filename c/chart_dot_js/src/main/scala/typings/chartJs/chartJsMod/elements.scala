...
object elements {
  ...
  open class ArcElement protected ()
    extends typings.chartJs.mod.elements.ArcElement {
  ...
  open class BarElement protected ()
    extends typings.chartJs.mod.elements.BarElement {
    def this(cfg: Any) = this()
  }
  /* static members */
  object BarElement {
  ...
  open class LineElement protected ()
    extends typings.chartJs.mod.elements.LineElement {
    def this(cfg: Any) = this()
  }
  /* static members */
  object LineElement {
  ...
  open class PointElement protected ()
    extends typings.chartJs.mod.elements.PointElement {
    def this(cfg: Any) = this()
  }
  /* static members */
  object PointElement {
