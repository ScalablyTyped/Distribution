...
object plugins {
  ...
  object Colors {
    ...
    @JSImport("chart/js", "plugins.Colors")
    @js.native
    ...
    @JSImport("chart/js", "plugins.Colors.defaults")
    @js.native
    ...
    @JSImport("chart/js", "plugins.Colors.id")
    @js.native
  ...
  object Decimation {
    ...
    @JSImport("chart/js", "plugins.Decimation")
    @js.native
    val ^ : js.Any = js.native
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.Decimation.defaults.algorithm")
      @js.native
      val algorithm: String = js.native
      
      @JSImport("chart/js", "plugins.Decimation.defaults.enabled")
      @js.native
    ...
    @JSImport("chart/js", "plugins.Decimation.id")
    @js.native
  ...
  object Filler {
    ...
    @JSImport("chart/js", "plugins.Filler")
    @js.native
    val ^ : js.Any = js.native
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.Filler.defaults.drawTime")
      @js.native
      val drawTime: String = js.native
      
      @JSImport("chart/js", "plugins.Filler.defaults.propagate")
      @js.native
      val propagate: Boolean = js.native
    }
    
    @JSImport("chart/js", "plugins.Filler.id")
    @js.native
    val id: String = js.native
  }
  ...
  object Legend {
    ...
    @JSImport("chart/js", "plugins.Legend")
    @js.native
    val ^ : js.Any = js.native
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.Legend.defaults")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.align")
      @js.native
      val align: String = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.display")
      @js.native
      val display: Boolean = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.fullSize")
      @js.native
      val fullSize: Boolean = js.native
      
      object labels {
        
        @JSImport("chart/js", "plugins.Legend.defaults.labels")
        @js.native
        val ^ : js.Any = js.native
        
        @JSImport("chart/js", "plugins.Legend.defaults.labels.boxWidth")
        @js.native
        ...
        @JSImport("chart/js", "plugins.Legend.defaults.labels.padding")
        @js.native
      ...
      @JSImport("chart/js", "plugins.Legend.defaults.onHover")
      @js.native
      val onHover: Any = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.onLeave")
      @js.native
      val onLeave: Any = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.position")
      @js.native
      val position: String = js.native
      
      @JSImport("chart/js", "plugins.Legend.defaults.reverse")
      @js.native
      val reverse: Boolean = js.native
      
      object title {
        
        @JSImport("chart/js", "plugins.Legend.defaults.title")
        @js.native
        val ^ : js.Any = js.native
        
        inline def color1(ctx: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("color_1")(ctx.asInstanceOf[js.Any]).asInstanceOf[Any]
        
        @JSImport("chart/js", "plugins.Legend.defaults.title.display_1")
        @js.native
        val display1: Boolean = js.native
        
        @JSImport("chart/js", "plugins.Legend.defaults.title.position_1")
        @js.native
        val position1: String = js.native
        
        @JSImport("chart/js", "plugins.Legend.defaults.title.text")
        @js.native
        val text: String = js.native
      }
      
      @JSImport("chart/js", "plugins.Legend.defaults.weight")
      @js.native
    ...
    object descriptors {
      ...
      @JSImport("chart/js", "plugins.Legend.descriptors")
      @js.native
      val ^ : js.Any = js.native
      
      object labels1 {
        
        @JSImport("chart/js", "plugins.Legend.descriptors.labels_1")
        @js.native
        val ^ : js.Any = js.native
    ...
    @JSImport("chart/js", "plugins.Legend.id")
    @js.native
    val id: String = js.native
  ...
  object SubTitle {
    ...
    @JSImport("chart/js", "plugins.SubTitle")
    @js.native
    val ^ : js.Any = js.native
    ...
    object defaultRoutes {
      ...
      @JSImport("chart/js", "plugins.SubTitle.defaultRoutes.color")
      @js.native
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.SubTitle.defaults.align")
      @js.native
      val align: String = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.display")
      @js.native
      val display: Boolean = js.native
      
      object font {
        
        @JSImport("chart/js", "plugins.SubTitle.defaults.font.weight")
        @js.native
        val weight: String = js.native
      }
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.fullSize")
      @js.native
      val fullSize: Boolean = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.padding")
      @js.native
      val padding: Double = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.position")
      @js.native
      val position: String = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.text")
      @js.native
      val text: String = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.defaults.weight_1")
      @js.native
    ...
    object descriptors {
      ...
      @JSImport("chart/js", "plugins.SubTitle.descriptors._indexable")
      @js.native
      val indexable: Boolean = js.native
      
      @JSImport("chart/js", "plugins.SubTitle.descriptors._scriptable")
      @js.native
      val scriptable: Boolean = js.native
    }
    
    @JSImport("chart/js", "plugins.SubTitle.id")
    @js.native
    val id: String = js.native
  ...
  object Title {
    ...
    @JSImport("chart/js", "plugins.Title")
    @js.native
    val ^ : js.Any = js.native
    ...
    object defaultRoutes {
      ...
      @JSImport("chart/js", "plugins.Title.defaultRoutes.color")
      @js.native
      val color: String = js.native
    }
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.Title.defaults.align")
      @js.native
      val align: String = js.native
      
      @JSImport("chart/js", "plugins.Title.defaults.display")
      @js.native
      val display: Boolean = js.native
      
      object font {
        
        @JSImport("chart/js", "plugins.Title.defaults.font.weight")
        @js.native
        val weight: String = js.native
      }
      
      @JSImport("chart/js", "plugins.Title.defaults.fullSize")
      @js.native
      val fullSize: Boolean = js.native
      
      @JSImport("chart/js", "plugins.Title.defaults.padding")
      @js.native
      val padding: Double = js.native
      
      @JSImport("chart/js", "plugins.Title.defaults.position")
      @js.native
      val position: String = js.native
      
      @JSImport("chart/js", "plugins.Title.defaults.text")
      @js.native
      val text: String = js.native
      
      @JSImport("chart/js", "plugins.Title.defaults.weight_1")
      @js.native
      val weight1: Double = js.native
    }
    ...
    object descriptors {
      ...
      @JSImport("chart/js", "plugins.Title.descriptors._indexable")
      @js.native
      val indexable: Boolean = js.native
      
      @JSImport("chart/js", "plugins.Title.descriptors._scriptable")
      @js.native
      val scriptable: Boolean = js.native
    }
    
    @JSImport("chart/js", "plugins.Title.id")
    @js.native
    val id: String = js.native
  ...
  object Tooltip {
    ...
    @JSImport("chart/js", "plugins.Tooltip")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("chart/js", "plugins.Tooltip.additionalOptionScopes")
    @js.native
    ...
    object defaultRoutes {
      ...
      @JSImport("chart/js", "plugins.Tooltip.defaultRoutes.bodyFont_1")
      @js.native
      val bodyFont1: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaultRoutes.footerFont_1")
      @js.native
      val footerFont1: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaultRoutes.titleFont_1")
      @js.native
    ...
    object defaults {
      ...
      @JSImport("chart/js", "plugins.Tooltip.defaults")
      @js.native
      val ^ : js.Any = js.native
      
      object animation {
        
        @JSImport("chart/js", "plugins.Tooltip.defaults.animation.duration")
        @js.native
        val duration: Double = js.native
        
        @JSImport("chart/js", "plugins.Tooltip.defaults.animation.easing")
        @js.native
      ...
      object animations {
        ...
        object numbers {
          ...
          @JSImport("chart/js", "plugins.Tooltip.defaults.animations.numbers.properties")
          @js.native
          val properties: js.Array[String] = js.native
          
          @JSImport("chart/js", "plugins.Tooltip.defaults.animations.numbers.type")
          @js.native
        ...
        object opacity {
          ...
          @JSImport("chart/js", "plugins.Tooltip.defaults.animations.opacity.duration_1")
          @js.native
          val duration1: Double = js.native
          
          @JSImport("chart/js", "plugins.Tooltip.defaults.animations.opacity.easing_1")
          @js.native
          val easing1: String = js.native
        }
      }
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.backgroundColor")
      @js.native
      val backgroundColor: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.bodyAlign")
      @js.native
      val bodyAlign: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.bodyColor")
      @js.native
      val bodyColor: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.bodySpacing")
      @js.native
      val bodySpacing: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.borderColor")
      @js.native
      val borderColor: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.borderWidth")
      @js.native
      ...
      @JSImport("chart/js", "plugins.Tooltip.defaults.boxPadding")
      @js.native
      ...
      @JSImport("chart/js", "plugins.Tooltip.defaults.caretPadding")
      @js.native
      val caretPadding: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.caretSize")
      @js.native
      val caretSize: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.cornerRadius")
      @js.native
      val cornerRadius: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.displayColors")
      @js.native
      val displayColors: Boolean = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.enabled")
      @js.native
      val enabled: Boolean = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.external")
      @js.native
      val external: Any = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.footerAlign")
      @js.native
      val footerAlign: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.footerColor")
      @js.native
      val footerColor: String = js.native
      
      object footerFont {
        
        @JSImport("chart/js", "plugins.Tooltip.defaults.footerFont.weight_1")
        @js.native
        val weight1: String = js.native
      }
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.footerMarginTop")
      @js.native
      val footerMarginTop: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.footerSpacing")
      @js.native
      val footerSpacing: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.multiKeyBackground")
      @js.native
      val multiKeyBackground: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.padding")
      @js.native
      val padding: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.position")
      @js.native
      val position: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.titleAlign")
      @js.native
      val titleAlign: String = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.titleColor")
      @js.native
      val titleColor: String = js.native
      
      object titleFont {
        
        @JSImport("chart/js", "plugins.Tooltip.defaults.titleFont.weight")
        @js.native
        val weight: String = js.native
      }
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.titleMarginBottom")
      @js.native
      val titleMarginBottom: Double = js.native
      
      @JSImport("chart/js", "plugins.Tooltip.defaults.titleSpacing")
      @js.native
    ...
    object descriptors {
      ...
      @JSImport("chart/js", "plugins.Tooltip.descriptors")
      @js.native
      val ^ : js.Any = js.native
      
      object animation1 {
        
        @JSImport("chart/js", "plugins.Tooltip.descriptors.animation_1._fallback")
        @js.native
      ...
      object animations1 {
        ...
        @JSImport("chart/js", "plugins.Tooltip.descriptors.animations_1._fallback_1")
        @js.native
      ...
      object callbacks {
        ...
        @JSImport("chart/js", "plugins.Tooltip.descriptors.callbacks._indexable_1")
        @js.native
        val indexable1: Boolean = js.native
        
        @JSImport("chart/js", "plugins.Tooltip.descriptors.callbacks._scriptable_1")
        @js.native
        val scriptable1: Boolean = js.native
      }
      
      @JSImport("chart/js", "plugins.Tooltip.descriptors._indexable")
      @js.native
      val indexable: Boolean = js.native
    ...
    @JSImport("chart/js", "plugins.Tooltip.id")
    @js.native
    val id: String = js.native
