...
object scales {
  ...
  open class CategoryScale ()
    extends typings.chartJs.mod.scales.CategoryScale
  /* static members */
  ...
  open class LinearScale ()
    extends typings.chartJs.mod.scales.LinearScale
  /* static members */
  object LinearScale {
  ...
  open class LogarithmicScale ()
    extends typings.chartJs.mod.scales.LogarithmicScale
  /* static members */
  ...
  open class RadialLinearScale ()
    extends typings.chartJs.mod.scales.RadialLinearScale
  /* static members */
  ...
  open class TimeScale protected ()
    extends typings.chartJs.mod.scales.TimeScale {
    /**
      * @param {object} props
      */
  ...
  open class TimeSeriesScale ()
    extends typings.chartJs.mod.scales.TimeSeriesScale
}
