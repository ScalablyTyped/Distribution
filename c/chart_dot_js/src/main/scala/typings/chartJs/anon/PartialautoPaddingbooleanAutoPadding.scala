...
/* Inlined std.Partial<{  autoPadding :boolean,   padding :chart.js.chart.js/dist/types/index.Scriptable<chart.js.chart.js/dist/types/geometric.Padding, chart.js.chart.js/dist/types/index.ScriptableContext<'doughnut'>>}> */
trait PartialautoPaddingbooleanAutoPadding extends StObject {
  
  var autoPadding: js.UndefOr[Boolean] = js.undefined
  
  var padding: js.UndefOr[
    typings.chartJs.distTypesIndexMod.Scriptable[Padding, ScriptableContext[doughnut]]
  ] = js.undefined
}
object PartialautoPaddingbooleanAutoPadding {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialautoPaddingbooleanAutoPadding] (val x: Self) extends AnyVal {
    ...
    inline def setPadding(value: typings.chartJs.distTypesIndexMod.Scriptable[Padding, ScriptableContext[doughnut]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
