...
trait AnimationSpeclineonProgre extends StObject {
  ...
  /**
    ...
    * @default 0
    */
  var delay: js.UndefOr[typings.chartJs.distTypesIndexMod.Scriptable[Double, ScriptableContext[line]]] = js.undefined
  
  /**
    * The number of milliseconds an animation takes.
    * @default 1000
    */
  var duration: js.UndefOr[typings.chartJs.distTypesIndexMod.Scriptable[Double, ScriptableContext[line]]] = js.undefined
  ...
  var easing: js.UndefOr[
    typings.chartJs.distTypesIndexMod.Scriptable[EasingFunction, ScriptableContext[line]]
  ] = js.undefined
  ...
  /**
    ...
    * @default false
    */
  var loop: js.UndefOr[typings.chartJs.distTypesIndexMod.Scriptable[Boolean, ScriptableContext[line]]] = js.undefined
...
object AnimationSpeclineonProgre {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AnimationSpeclineonProgre] (val x: Self) extends AnyVal {
    
    inline def setDelay(value: typings.chartJs.distTypesIndexMod.Scriptable[Double, ScriptableContext[line]]): Self = StObject.set(x, "delay", value.asInstanceOf[js.Any])
    ...
    inline def setDuration(value: typings.chartJs.distTypesIndexMod.Scriptable[Double, ScriptableContext[line]]): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
    ...
    inline def setEasing(value: typings.chartJs.distTypesIndexMod.Scriptable[EasingFunction, ScriptableContext[line]]): Self = StObject.set(x, "easing", value.asInstanceOf[js.Any])
    ...
    inline def setLoop(value: typings.chartJs.distTypesIndexMod.Scriptable[Boolean, ScriptableContext[line]]): Self = StObject.set(x, "loop", value.asInstanceOf[js.Any])
