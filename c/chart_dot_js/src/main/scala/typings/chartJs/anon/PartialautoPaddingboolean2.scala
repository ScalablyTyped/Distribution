...
/* Inlined std.Partial<{  autoPadding :boolean,   padding :chart.js.chart.js/dist/chunks/helpers.core.Scriptable<chart.js.chart.js/dist/chunks/helpers.core.Padding, chart.js.chart.js/dist/chunks/helpers.core.ScriptableContext<'line'>>}> */
trait PartialautoPaddingboolean2 extends StObject {
  
  var autoPadding: js.UndefOr[Boolean] = js.undefined
  
  var padding: js.UndefOr[Scriptable[Padding, ScriptableContext["line"]]] = js.undefined
}
object PartialautoPaddingboolean2 {
  ...
  extension [Self <: PartialautoPaddingboolean2](x: Self) {
    ...
    inline def setPadding(value: Scriptable[Padding, ScriptableContext["line"]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
