...
/* Inlined chart.js.chart.js/dist/chunks/helpers.core.CoreChartOptions<'pie'> & chart.js.chart.js/dist/chunks/helpers.core.ElementChartOptions<'pie'> & chart.js.chart.js/dist/chunks/helpers.core.PluginChartOptions<'pie'> & chart.js.chart.js/dist/chunks/helpers.core.DatasetChartOptions<chart.js.chart.js/dist/chunks/helpers.core.ChartType> & chart.js.chart.js/dist/chunks/helpers.core.ScaleChartOptions<'pie'> & chart.js.chart.js/dist/chunks/helpers.core.PieControllerChartOptions */
trait CoreChartOptionspieElemen extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]
...
object CoreChartOptionspieElemen {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    circumference: Double,
    clip: Double | ChartArea | false,
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]],
  ...
  extension [Self <: CoreChartOptionspieElemen](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["pie"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["pie"]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
