...
/* Inlined {  type :'radar'} & chart.js.chart.js/dist/chunks/helpers.core.RadarControllerDatasetOptions & chart.js.chart.js/dist/chunks/helpers.core.FillerControllerDatasetOptions */
trait typeradarRadarControllerD extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  
  var borderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext["radar"]]
  
  var borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  
  var hoverBorderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext["radar"]]
  
  var hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  var pointBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  
  var pointBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  var pointHoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  
  var pointHoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  var pointStyle: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.PointStyle, ScriptableContext["radar"]]
...
object typeradarRadarControllerD {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    borderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext["radar"]],
    borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    ...
    hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    hoverBorderCapStyle: ScriptableAndArray[CanvasLineCap, ScriptableContext["radar"]],
    hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    ...
    pointBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    pointBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    ...
    pointHoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    pointHoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    ...
    pointStyle: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.PointStyle, ScriptableContext["radar"]],
  ...
  extension [Self <: typeradarRadarControllerD](x: Self) {
    ...
    inline def setBackgroundColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["radar"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ...
    inline def setPointStyle(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.PointStyle, ScriptableContext["radar"]]
    ): Self = StObject.set(x, "pointStyle", value.asInstanceOf[js.Any])
    
    inline def setPointStyleFunction2(
      value: (ScriptableContext["radar"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.PointStyle]
