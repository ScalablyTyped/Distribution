...
import typings.chartJs.distChunksHelpersDotcoreMod.BarControllerChartOptions
import typings.chartJs.distChunksHelpersDotcoreMod.BarControllerDatasetOptions
import typings.chartJs.distChunksHelpersDotcoreMod.BarParsedData
