...
import typings.chartJs.distChunksHelpersDotcoreMod.PolarAreaAnimationOptions
...
/* Inlined chart.js.chart.js/dist/chunks/helpers.core.CoreChartOptions<'polarArea'> & chart.js.chart.js/dist/chunks/helpers.core.ElementChartOptions<'polarArea'> & chart.js.chart.js/dist/chunks/helpers.core.PluginChartOptions<'polarArea'> & chart.js.chart.js/dist/chunks/helpers.core.DatasetChartOptions<chart.js.chart.js/dist/chunks/helpers.core.ChartType> & chart.js.chart.js/dist/chunks/helpers.core.ScaleChartOptions<'polarArea'> & chart.js.chart.js/dist/chunks/helpers.core.PolarAreaControllerChartOptions */
trait CoreChartOptionspolarArea extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]]
...
object CoreChartOptionspolarArea {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | false,
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]],
  ...
  extension [Self <: CoreChartOptionspolarArea](x: Self) {
    ...
    inline def setBackgroundColor(
      value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["polarArea"]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["polarArea"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
