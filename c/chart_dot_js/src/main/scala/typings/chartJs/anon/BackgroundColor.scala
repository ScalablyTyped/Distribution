...
import typings.chartJs.distChunksHelpersDotcoreMod.ScriptableLineSegmentContext
...
trait BackgroundColor extends StObject {
  ...
  var backgroundColor: Scriptable[
    js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color], 
    ScriptableLineSegmentContext
  ]
  
  var borderCapStyle: Scriptable[js.UndefOr[CanvasLineCap], ScriptableLineSegmentContext]
  
  var borderColor: Scriptable[
    js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color], 
    ScriptableLineSegmentContext
  ]
...
object BackgroundColor {
  ...
  extension [Self <: BackgroundColor](x: Self) {
    ...
    inline def setBackgroundColorFunction2(
      value: (ScriptableLineSegmentContext, /* options */ AnyObject) => js.UndefOr[js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]]
