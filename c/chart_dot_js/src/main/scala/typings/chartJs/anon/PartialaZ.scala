...
/* Inlined std.Partial<chart.js.chart.js/dist/chunks/helpers.core.aZ> */
trait PartialaZ extends StObject {
...
object PartialaZ {
  ...
  inline def apply(): PartialaZ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialaZ]
  }
  
  extension [Self <: PartialaZ](x: Self) {
