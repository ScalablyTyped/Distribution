...
/* Inlined std.Record<'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight', number> */
trait RecordtopLefttopRightbott extends StObject {
...
object RecordtopLefttopRightbott {
  
  inline def apply(bottomLeft: Double, bottomRight: Double, topLeft: Double, topRight: Double): RecordtopLefttopRightbott = {
    ...
    __obj.asInstanceOf[RecordtopLefttopRightbott]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RecordtopLefttopRightbott] (val x: Self) extends AnyVal {
