...
import typings.chartJs.distChunksHelpersDotcoreMod.ScriptableAndArray
import typings.chartJs.distChunksHelpersDotcoreMod.ScriptableContext
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined {  type :'bubble'} & chart.js.chart.js/dist/chunks/helpers.core.BubbleControllerDatasetOptions */
trait typebubbleBubbleControlle extends StObject {
  
  var backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
  
  var borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
  
  var hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
  ...
  var pointStyle: ScriptableAndArray[
    typings.chartJs.distChunksHelpersDotcoreMod.PointStyle, 
...
object typebubbleBubbleControlle {
  ...
  inline def apply(
    backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]],
    borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]],
    ...
    hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]],
    hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]],
  ...
  extension [Self <: typebubbleBubbleControlle](x: Self) {
    ...
    inline def setBackgroundColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["bubble"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ): Self = StObject.set(x, "backgroundColor", js.Any.fromFunction2(value))
    
    inline def setBackgroundColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "backgroundColor", js.Array(value*))
    ...
    inline def setBorderColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "borderColor", js.Array(value*))
    ...
    inline def setHoverBackgroundColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
    ): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBackgroundColorFunction2(
      value: (ScriptableContext["bubble"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ): Self = StObject.set(x, "hoverBackgroundColor", js.Any.fromFunction2(value))
    
    inline def setHoverBackgroundColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "hoverBackgroundColor", js.Array(value*))
    
    inline def setHoverBorderColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bubble"]]
    ): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
    
    inline def setHoverBorderColorFunction2(
      value: (ScriptableContext["bubble"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ): Self = StObject.set(x, "hoverBorderColor", js.Any.fromFunction2(value))
    
    inline def setHoverBorderColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "hoverBorderColor", js.Array(value*))
    ...
    inline def setPointStyleFunction2(
      value: (ScriptableContext["bubble"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.PointStyle]
    ): Self = StObject.set(x, "pointStyle", js.Any.fromFunction2(value))
    
    inline def setPointStyleVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.PointStyle*): Self = StObject.set(x, "pointStyle", js.Array(value*))
