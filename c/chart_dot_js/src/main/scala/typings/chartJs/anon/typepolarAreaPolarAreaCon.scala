...
import typings.chartJs.distChunksHelpersDotcoreMod.ArcBorderRadius
...
/* Inlined {  type :'polarArea'} & chart.js.chart.js/dist/chunks/helpers.core.PolarAreaControllerDatasetOptions */
trait typepolarAreaPolarAreaCon extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]]
  
  var borderAlign: ScriptableAndArray["center" | "inner", ScriptableContext["doughnut"]]
  
  var borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]]
  
  var hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]]
...
object typepolarAreaPolarAreaCon {
  
  inline def apply(
    angle: Double,
    animation: false | AnimationSpecdoughnutonPr,
    animations: AnimationsSpec["doughnut"],
    backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]],
    borderAlign: ScriptableAndArray["center" | "inner", ScriptableContext["doughnut"]],
    borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]],
    ...
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]],
    hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]],
    ...
    __obj.updateDynamic("type")("polarArea")
  ...
  extension [Self <: typepolarAreaPolarAreaCon](x: Self) {
    ...
    inline def setBackgroundColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["doughnut"]]
    ...
    inline def setType(value: "polarArea"): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
