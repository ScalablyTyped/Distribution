...
trait TypeofSubTitle extends StObject {
...
object TypeofSubTitle {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TypeofSubTitle]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeofSubTitle] (val x: Self) extends AnyVal {
