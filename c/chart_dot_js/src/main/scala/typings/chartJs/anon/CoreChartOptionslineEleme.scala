...
trait CoreChartOptionslineEleme extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]
...
object CoreChartOptionslineEleme {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]],
  ...
  extension [Self <: CoreChartOptionslineEleme](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setBorderColor(value: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typings.chartJs.colorMod.Color, ScriptableContext[line]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
