...
/* Inlined std.Partial<{  autoPadding :boolean,   padding :chart.js.chart.js.Scriptable<number | std.Partial<chart.js.chart.js/types/geometric.ChartArea>, chart.js.chart.js.ScriptableContext<'polarArea'>>}> */
trait PartialautoPaddingboolean1 extends StObject {
  
  var autoPadding: js.UndefOr[Boolean] = js.undefined
  
  var padding: js.UndefOr[Scriptable[Double | PartialChartArea, ScriptableContext[polarArea]]] = js.undefined
}
object PartialautoPaddingboolean1 {
  ...
  extension [Self <: PartialautoPaddingboolean1](x: Self) {
    ...
    inline def setPadding(value: Scriptable[Double | PartialChartArea, ScriptableContext[polarArea]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    inline def setPaddingFunction2(
      value: (ScriptableContext[polarArea], /* options */ AnyObject) => js.UndefOr[Double | PartialChartArea]
