...
/* Inlined std.Partial<{  autoPadding :boolean,   padding :chart.js.chart.js/dist/chunks/helpers.core.Scriptable<chart.js.chart.js/dist/chunks/helpers.core.Padding, chart.js.chart.js/dist/chunks/helpers.core.ScriptableContext<'polarArea'>>}> */
trait PartialautoPaddingboolean1 extends StObject {
  
  var autoPadding: js.UndefOr[Boolean] = js.undefined
  
  var padding: js.UndefOr[Scriptable[Padding, ScriptableContext["polarArea"]]] = js.undefined
}
object PartialautoPaddingboolean1 {
  ...
  extension [Self <: PartialautoPaddingboolean1](x: Self) {
    ...
    inline def setPadding(value: Scriptable[Padding, ScriptableContext["polarArea"]]): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
