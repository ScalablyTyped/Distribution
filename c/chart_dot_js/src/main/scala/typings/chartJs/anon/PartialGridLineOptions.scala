...
/* Inlined std.Partial<chart.js.chart.js/dist/chunks/helpers.core.GridLineOptions> */
trait PartialGridLineOptions extends StObject {
  
  var circular: js.UndefOr[Boolean] = js.undefined
  
  var color: js.UndefOr[
    ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableScaleContext]
  ] = js.undefined
  ...
  var tickBorderDashOffset: js.UndefOr[Scriptable[Double, ScriptableScaleContext]] = js.undefined
...
object PartialGridLineOptions {
  ...
  extension [Self <: PartialGridLineOptions](x: Self) {
    ...
    inline def setColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableScaleContext]
    ...
    inline def setColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "color", js.Array(value*))
    ...
    inline def setTickColorVarargs(value: typings.chartJs.distChunksHelpersDotcoreMod.Color*): Self = StObject.set(x, "tickColor", js.Array(value*))
