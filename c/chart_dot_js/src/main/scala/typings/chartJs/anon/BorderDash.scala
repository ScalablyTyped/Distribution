...
import typings.chartJs.distChunksHelpersDotcoreMod.ScriptableScaleContext
...
trait BorderDash extends StObject {
  ...
  /**
    ...
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableScaleContext]
...
object BorderDash {
  ...
  inline def apply(
    ...
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableScaleContext],
    display: Boolean,
  ...
  extension [Self <: BorderDash](x: Self) {
    ...
    inline def setColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableScaleContext]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorFunction2(
      value: (ScriptableScaleContext, /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
