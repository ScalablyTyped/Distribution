...
/* Inlined chart.js.chart.js/dist/chunks/helpers.core.CoreChartOptions<'radar'> & chart.js.chart.js/dist/chunks/helpers.core.ElementChartOptions<'radar'> & chart.js.chart.js/dist/chunks/helpers.core.PluginChartOptions<'radar'> & chart.js.chart.js/dist/chunks/helpers.core.DatasetChartOptions<chart.js.chart.js/dist/chunks/helpers.core.ChartType> & chart.js.chart.js/dist/chunks/helpers.core.ScaleChartOptions<'radar'> & chart.js.chart.js/dist/chunks/helpers.core.RadarControllerChartOptions */
trait CoreChartOptionsradarElem extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]
...
object CoreChartOptionsradarElem {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | false,
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]],
  ...
  extension [Self <: CoreChartOptionsradarElem](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setBorderColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["radar"]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
