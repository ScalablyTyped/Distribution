...
/* Inlined chart.js.chart.js/dist/types/index.CoreChartOptions<'radar'> & chart.js.chart.js/dist/types/index.ElementChartOptions<'radar'> & chart.js.chart.js/dist/types/index.PluginChartOptions<'radar'> & chart.js.chart.js/dist/types/index.DatasetChartOptions<chart.js.chart.js/dist/types/index.ChartType> & chart.js.chart.js/dist/types/index.ScaleChartOptions<'radar'> & chart.js.chart.js/dist/types/index.RadarControllerChartOptions */
trait CoreChartOptionsradarElem extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]]
  ...
  /**
    ...
    */
  var borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]]
...
object CoreChartOptionsradarElem {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]],
    bar: Datasets,
    borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]],
  ...
  implicit open class MutableBuilder[Self <: CoreChartOptionsradarElem] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(
      value: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[radar]]
