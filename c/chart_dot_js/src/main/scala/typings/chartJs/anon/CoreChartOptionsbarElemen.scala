...
/* Inlined chart.js.chart.js/dist/chunks/helpers.core.CoreChartOptions<'bar'> & chart.js.chart.js/dist/chunks/helpers.core.ElementChartOptions<'bar'> & chart.js.chart.js/dist/chunks/helpers.core.PluginChartOptions<'bar'> & chart.js.chart.js/dist/chunks/helpers.core.DatasetChartOptions<chart.js.chart.js/dist/chunks/helpers.core.ChartType> & chart.js.chart.js/dist/chunks/helpers.core.ScaleChartOptions<'bar'> & chart.js.chart.js/dist/chunks/helpers.core.BarControllerChartOptions */
trait CoreChartOptionsbarElemen extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
...
object CoreChartOptionsbarElemen {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | false,
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
  ...
  extension [Self <: CoreChartOptionsbarElemen](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setBorderColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
