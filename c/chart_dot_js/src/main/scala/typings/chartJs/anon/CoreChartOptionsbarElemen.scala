...
/* Inlined chart.js.chart.js/dist/types/index.CoreChartOptions<'bar'> & chart.js.chart.js/dist/types/index.ElementChartOptions<'bar'> & chart.js.chart.js/dist/types/index.PluginChartOptions<'bar'> & chart.js.chart.js/dist/types/index.DatasetChartOptions<chart.js.chart.js/dist/types/index.ChartType> & chart.js.chart.js/dist/types/index.ScaleChartOptions<'bar'> & chart.js.chart.js/dist/types/index.BarControllerChartOptions */
trait CoreChartOptionsbarElemen extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
  ...
  /**
    ...
    */
  var borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
...
object CoreChartOptionsbarElemen {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
    bar: Datasets,
    borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
  ...
  implicit open class MutableBuilder[Self <: CoreChartOptionsbarElemen] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(
      value: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
