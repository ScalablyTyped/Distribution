...
trait Fn[TType /* <: typings.chartJs.distTypesIndexMod.ChartType */] extends StObject {
  ...
  /**
    ...
    */
  var from: typings.chartJs.distTypesIndexMod.Scriptable[
    typings.chartJs.distTypesColorMod.Color | Double | Boolean, 
  ...
  /**
    *
    */
  var to: typings.chartJs.distTypesIndexMod.Scriptable[
    typings.chartJs.distTypesColorMod.Color | Double | Boolean, 
    ScriptableContext[TType]
  ]
...
object Fn {
  ...
  inline def apply[TType /* <: typings.chartJs.distTypesIndexMod.ChartType */](
    ...
    from: typings.chartJs.distTypesIndexMod.Scriptable[
      typings.chartJs.distTypesColorMod.Color | Double | Boolean, 
      ScriptableContext[TType]
    ],
    properties: js.Array[String],
    to: typings.chartJs.distTypesIndexMod.Scriptable[
      typings.chartJs.distTypesColorMod.Color | Double | Boolean, 
      ScriptableContext[TType]
    ],
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Fn[?], TType /* <: typings.chartJs.distTypesIndexMod.ChartType */] (val x: Self & Fn[TType]) extends AnyVal {
    ...
    inline def setFromFunction2(
      value: (ScriptableContext[TType], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distTypesColorMod.Color | Double | Boolean]
