...
object ChartOptionsChartFontOpti {
  ...
  implicit class ChartOptionsChartFontOptiOps[Self <: ChartOptionsChartFontOpti] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLegendCallback(value: /* chart */ typings.chartJs.mod.Chart => String): Self = this.set("legendCallback", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnResize(value: js.ThisFunction1[/* this */ typings.chartJs.mod.Chart, /* newSize */ ChartSize, Unit]): Self = this.set("onResize", value.asInstanceOf[js.Any])
    @scala.inline
