...
/* Inlined chart.js.chart.js/dist/chunks/helpers.core.CoreChartOptions<'scatter'> & chart.js.chart.js/dist/chunks/helpers.core.ElementChartOptions<'scatter'> & chart.js.chart.js/dist/chunks/helpers.core.PluginChartOptions<'scatter'> & chart.js.chart.js/dist/chunks/helpers.core.DatasetChartOptions<chart.js.chart.js/dist/chunks/helpers.core.ChartType> & chart.js.chart.js/dist/chunks/helpers.core.ScaleChartOptions<'scatter'> & chart.js.chart.js/dist/chunks/helpers.core.ScatterControllerChartOptions */
trait CoreChartOptionsscatterEl extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]
  ...
  /**
    ...
    */
  var borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]
...
object CoreChartOptionsscatterEl {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]],
    bar: Datasets,
    borderColor: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | false,
    color: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]],
  ...
  extension [Self <: CoreChartOptionsscatterEl](x: Self) {
    ...
    inline def setBackgroundColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["scatter"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ...
    inline def setBorderColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setColor(value: Scriptable[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["scatter"]]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
