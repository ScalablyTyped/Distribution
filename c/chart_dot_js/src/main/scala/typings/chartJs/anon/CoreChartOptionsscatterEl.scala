...
/* Inlined chart.js.chart.js/dist/types/index.CoreChartOptions<'scatter'> & chart.js.chart.js/dist/types/index.ElementChartOptions<'scatter'> & chart.js.chart.js/dist/types/index.PluginChartOptions<'scatter'> & chart.js.chart.js/dist/types/index.DatasetChartOptions<chart.js.chart.js/dist/types/index.ChartType> & chart.js.chart.js/dist/types/index.ScaleChartOptions<'scatter'> & chart.js.chart.js/dist/types/index.ScatterControllerChartOptions */
trait CoreChartOptionsscatterEl extends StObject {
  ...
  /**
    ...
    */
  var backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]]
  ...
  /**
    ...
    */
  var borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]]
  ...
  /**
    ...
    * @see Defaults.color
    */
  var color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]]
...
object CoreChartOptionsscatterEl {
  ...
  inline def apply(
    ...
    aspectRatio: Double,
    backgroundColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]],
    bar: Datasets,
    borderColor: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]],
    bubble: DatasetsBubbleControllerDatasetOptions,
    clip: Double | ChartArea | `false`,
    color: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]],
  ...
  implicit open class MutableBuilder[Self <: CoreChartOptionsscatterEl] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(
      value: typings.chartJs.distTypesIndexMod.Scriptable[typings.chartJs.distTypesColorMod.Color, ScriptableContext[scatter]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[scatter], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distTypesColorMod.Color]
