...
/* Inlined {  type :'bar'} & chart.js.chart.js/dist/types/index.BarControllerDatasetOptions */
trait typebarBarControllerDatas extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
  ...
  var borderColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
  
  var borderRadius: ScriptableAndArray[Double | typings.chartJs.distTypesIndexMod.BorderRadius, ScriptableContext[bar]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
  
  var hoverBorderColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]
...
object typebarBarControllerDatas {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
    barPercentage: Double,
    barThickness: Double | flex,
    base: ScriptableAndArray[Double, ScriptableContext[bar]],
    borderColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
    borderRadius: ScriptableAndArray[Double | typings.chartJs.distTypesIndexMod.BorderRadius, ScriptableContext[bar]],
    ...
    grouped: Boolean,
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
    hoverBorderColor: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]],
  ...
  implicit open class MutableBuilder[Self <: typebarBarControllerDatas] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(value: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distTypesColorMod.Color]
    ...
    inline def setBorderColor(value: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "borderColor", value.asInstanceOf[js.Any])
    ...
    inline def setBorderRadius(
      value: ScriptableAndArray[Double | typings.chartJs.distTypesIndexMod.BorderRadius, ScriptableContext[bar]]
    ): Self = StObject.set(x, "borderRadius", value.asInstanceOf[js.Any])
    
    inline def setBorderRadiusFunction2(
      value: (ScriptableContext[bar], /* options */ AnyObject) => js.UndefOr[Double | typings.chartJs.distTypesIndexMod.BorderRadius]
    ): Self = StObject.set(x, "borderRadius", js.Any.fromFunction2(value))
    
    inline def setBorderRadiusVarargs(value: (Double | typings.chartJs.distTypesIndexMod.BorderRadius)*): Self = StObject.set(x, "borderRadius", js.Array(value*))
    ...
    inline def setHoverBackgroundColor(value: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBackgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setHoverBorderColor(value: ScriptableAndArray[typings.chartJs.distTypesColorMod.Color, ScriptableContext[bar]]): Self = StObject.set(x, "hoverBorderColor", value.asInstanceOf[js.Any])
