...
/* Inlined {  type :'bar'} & chart.js.chart.js/dist/chunks/helpers.core.BarControllerDatasetOptions */
trait typebarBarControllerDatas extends StObject {
  ...
  var backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
  ...
  var borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
  
  var borderRadius: ScriptableAndArray[
  ...
  var borderWidth: ScriptableAndArray[Double | Bottom, ScriptableContext["bar"]]
  ...
  var hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
  
  var hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
...
object typebarBarControllerDatas {
  ...
  inline def apply(
    ...
    backgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
    barPercentage: Double,
    barThickness: Double | "flex",
    base: ScriptableAndArray[Double, ScriptableContext["bar"]],
    borderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
    ...
    borderWidth: ScriptableAndArray[Double | Bottom, ScriptableContext["bar"]],
    categoryPercentage: Double,
    clip: Double | ChartArea | false,
    grouped: Boolean,
    hidden: Boolean,
    hoverBackgroundColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
    hoverBorderColor: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]],
  ...
  extension [Self <: typebarBarControllerDatas](x: Self) {
    ...
    inline def setBackgroundColor(
      value: ScriptableAndArray[typings.chartJs.distChunksHelpersDotcoreMod.Color, ScriptableContext["bar"]]
    ): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    
    inline def setBackgroundColorFunction2(
      value: (ScriptableContext["bar"], /* options */ AnyObject) => js.UndefOr[typings.chartJs.distChunksHelpersDotcoreMod.Color]
    ...
    inline def setBorderRadiusFunction2(
      value: (ScriptableContext["bar"], /* options */ AnyObject) => js.UndefOr[Double | typings.chartJs.distChunksHelpersDotcoreMod.BorderRadius]
    ): Self = StObject.set(x, "borderRadius", js.Any.fromFunction2(value))
    
    inline def setBorderRadiusVarargs(value: (Double | typings.chartJs.distChunksHelpersDotcoreMod.BorderRadius)*): Self = StObject.set(x, "borderRadius", js.Array(value*))
    ...
    inline def setBorderWidth(value: ScriptableAndArray[Double | Bottom, ScriptableContext["bar"]]): Self = StObject.set(x, "borderWidth", value.asInstanceOf[js.Any])
    
    inline def setBorderWidthFunction2(value: (ScriptableContext["bar"], /* options */ AnyObject) => js.UndefOr[Double | Bottom]): Self = StObject.set(x, "borderWidth", js.Any.fromFunction2(value))
    
    inline def setBorderWidthVarargs(value: (Double | Bottom)*): Self = StObject.set(x, "borderWidth", js.Array(value*))
