...
trait CrossRoadsStatic extends js.Object {
  ...
  /**
           ...
           */
  var greedyEnabled: scala.Boolean = js.native
  /**
           ...
           */
  var ignoreState: scala.Boolean = js.native
  /**
  ...
  /**
           ...
           */
  var shouldTypecast: scala.Boolean = js.native
  /**
  ...
  /**
           ...
           * @param priority Route execution priority.
           */
  def addRoute(pattern: js.Any, handler: js.Function, priority: scala.Double): Route = js.native
  /**
  ...
  /**
           ...
           */
  def parse(request: java.lang.String, defaultArgs: js.Any*): scala.Unit = js.native
  /**
           * Pipe routers, so all crossroads.parse() calls will be forwarded to the other router as well.
           */
  def pipe(router: CrossRoadsStatic): scala.Unit = js.native
  /**
           * Remove all routes from crossroads collection.
           */
  def removeAllRoutes(): scala.Unit = js.native
  /**
           ...
           */
  def removeRoute(route: Route): scala.Unit = js.native
  /**
  ...
  /**
           ...
           */
  def unpipe(router: CrossRoadsStatic): scala.Unit = js.native
}
