...
import typings.cucumberCucumberExpressions.parameterTypeMod.default
...
object typesMod {
  ...
  trait Expression extends StObject {
    ...
    def `match`(text: String): js.Array[typings.cucumberCucumberExpressions.argumentMod.default] | Null
  ...
  object Expression {
    ...
    inline def apply(
      `match`: String => js.Array[typings.cucumberCucumberExpressions.argumentMod.default] | Null,
      source: String
    ): Expression = {
    ...
    extension [Self <: Expression](x: Self) {
      ...
      inline def setMatch(value: String => js.Array[typings.cucumberCucumberExpressions.argumentMod.default] | Null): Self = StObject.set(x, "match", js.Any.fromFunction1(value))
