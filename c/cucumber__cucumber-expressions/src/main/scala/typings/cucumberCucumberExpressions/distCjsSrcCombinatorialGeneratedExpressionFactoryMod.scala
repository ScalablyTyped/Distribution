...
object distCjsSrcCombinatorialGeneratedExpressionFactoryMod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      parameterTypeCombinations: js.Array[
            js.Array[typings.cucumberCucumberExpressions.distCjsSrcParameterTypeMod.default[Any]]
          ]
    ) = this()
    ...
    /* CompleteClass */
    override def generateExpressions(): js.Array[typings.cucumberCucumberExpressions.distCjsSrcGeneratedExpressionMod.default] = js.native
  ...
  trait CombinatorialGeneratedExpressionFactory extends StObject {
    ...
    def generateExpressions(): js.Array[typings.cucumberCucumberExpressions.distCjsSrcGeneratedExpressionMod.default]
  ...
  object CombinatorialGeneratedExpressionFactory {
    ...
    inline def apply(
      ...
      generateExpressions: () => js.Array[typings.cucumberCucumberExpressions.distCjsSrcGeneratedExpressionMod.default],
    ...
    extension [Self <: CombinatorialGeneratedExpressionFactory](x: Self) {
      ...
      inline def setGenerateExpressions(
        value: () => js.Array[typings.cucumberCucumberExpressions.distCjsSrcGeneratedExpressionMod.default]
      ): Self = StObject.set(x, "generateExpressions", js.Any.fromFunction0(value))
