...
object cucumberExpressionGeneratorMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def generateExpressions(text: String): js.Array[typings.cucumberCucumberExpressions.generatedExpressionMod.default] = js.native
  ...
  trait CucumberExpressionGenerator extends StObject {
    ...
    def generateExpressions(text: String): js.Array[typings.cucumberCucumberExpressions.generatedExpressionMod.default]
  ...
  object CucumberExpressionGenerator {
    ...
    inline def apply(
      ...
      generateExpressions: String => js.Array[typings.cucumberCucumberExpressions.generatedExpressionMod.default],
      parameterTypes: Any
    ...
    extension [Self <: CucumberExpressionGenerator](x: Self) {
      ...
      inline def setGenerateExpressions(value: String => js.Array[typings.cucumberCucumberExpressions.generatedExpressionMod.default]): Self = StObject.set(x, "generateExpressions", js.Any.fromFunction1(value))
