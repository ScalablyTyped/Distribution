...
- Dropped {[ P in keyof cli-table3.cli-table3.CliTable3.TableOptions ]:? cli-table3.cli-table3.CliTable3.TableOptions[P]} */ trait TableConstructorOptions extends js.Object {
