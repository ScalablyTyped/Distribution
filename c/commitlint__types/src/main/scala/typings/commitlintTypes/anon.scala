...
import typings.commitlintTypes.parseMod.CommitNote
import typings.commitlintTypes.parseMod.CommitReference
...
import typings.commitlintTypes.rulesMod.RuleConfigQuality.User
