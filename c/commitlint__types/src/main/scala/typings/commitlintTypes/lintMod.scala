...
import typings.commitlintTypes.isIgnoredMod.Matcher
import typings.commitlintTypes.loadMod.PluginRecords
import typings.commitlintTypes.parseMod.ParserOptions
