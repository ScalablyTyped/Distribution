...
object promptMod {
  ...
  {[ P in keyof T ]:? {[ K in keyof T[P] ]:? T[P][K]}}
    */ typings.commitlintTypes.commitlintTypesStrings.DeepPartial & TopLevel[T]
  ...
  */
  ...
  trait UserPromptConfig extends StObject {
    ...
    {[ K in any | undefined ]:? @commitlint/types.@commitlint/types/lib/prompt.PromptMessages[K]}
      */ typings.commitlintTypes.commitlintTypesStrings.UserPromptConfig & TopLevel[PromptMessages]
      ] = js.undefined
    
    var questions: js.UndefOr[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in any | undefined ]:? / * Inlined std.Partial<std.Record<@commitlint/types.@commitlint/types/lib/prompt.PromptName, {  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined}>> * /
    {  isBreaking :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   issuesBody :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   breakingBody :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   issues :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   header :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   scope :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   isIssueAffected :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   body :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   subject :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   breaking :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   type :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined,   footer :{  description :string | undefined,   messages :{[K: string] : string} | undefined,   enum :{[enumName: string] : {  description :string | undefined,   title :string | undefined,   emoji :string | undefined}} | undefined} | undefined}[K]}
      */ typings.commitlintTypes.commitlintTypesStrings.UserPromptConfig & TopLevel[Any]
      ] = js.undefined
    
    var settings: js.UndefOr[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in any | undefined ]:? {  scopeEnumSeparator :string,   enableMultipleScopes :boolean}[K]}
      */ typings.commitlintTypes.commitlintTypesStrings.UserPromptConfig & TopLevel[Any]
      ] = js.undefined
  }
