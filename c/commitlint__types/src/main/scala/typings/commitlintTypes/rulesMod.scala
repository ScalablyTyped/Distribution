...
import typings.commitlintTypes.parseMod.Commit
...
object rulesMod {
  ...
  type BaseRule[Value, Type /* <: RuleType */] = js.Function3[
    ...
    RuleOutcome | js.Promise[RuleOutcome]
  ]
  ...
  type RuleConfig[V, T] = QualifiedRuleConfig[T] | RuleConfigTuple[T]
  ...
  */
  ...
  type RuleConfigTuple[T] = js.Array[Disabled] | (js.Tuple3[RuleConfigSeverity, RuleConfigCondition, T]) | (js.Tuple2[RuleConfigSeverity, RuleConfigCondition])
