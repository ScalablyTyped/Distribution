...
object mod {
  ...
  */
  ...
  object _ColorValue {
    ...
    @scala.inline
    def HSL(h: Double, l: Double, s: Double): typings.colorRgba.mod.HSL = {
      val __obj = js.Dynamic.literal(h = h.asInstanceOf[js.Any], l = l.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.colorRgba.mod.HSL]
    }
    
    @scala.inline
    def RGBColor(b: Double, g: Double, r: Double): typings.colorRgba.mod.RGBColor = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.colorRgba.mod.RGBColor]
    }
    
    @scala.inline
    def RGBKeyedColor(blue: Double, green: Double, red: Double): typings.colorRgba.mod.RGBKeyedColor = {
      val __obj = js.Dynamic.literal(blue = blue.asInstanceOf[js.Any], green = green.asInstanceOf[js.Any], red = red.asInstanceOf[js.Any])
