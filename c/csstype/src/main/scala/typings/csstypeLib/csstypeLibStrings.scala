...
object csstypeLibStrings {
  ...
  sealed trait `-moz-crisp-edges`
    extends csstypeLib.csstypeMod.ImageRenderingProperty
  ...
  sealed trait `-moz-none`
    extends csstypeLib.csstypeMod.UserSelectProperty
  ...
  sealed trait `-moz-pre-wrap`
    extends csstypeLib.csstypeMod.WhiteSpaceProperty
  ...
  sealed trait `-webkit-auto`
    extends csstypeLib.csstypeMod._FlexBasisProperty[js.Any]
  ...
  sealed trait `::cue`
    extends csstypeLib.csstypeMod.AdvancedPseudos
       with csstypeLib.csstypeMod.SimplePseudos
  ...
  sealed trait `[class]`
    extends csstypeLib.csstypeMod.HtmlAttributes
       with csstypeLib.csstypeMod.SvgAttributes
  ...
  @js.native
  sealed trait above
    extends csstypeLib.csstypeMod._WebkitBoxReflectProperty[js.Any]
  ...
  @js.native
  sealed trait after
    extends csstypeLib.csstypeMod.MsImeAlignProperty
  ...
  sealed trait all
    extends csstypeLib.csstypeMod._SingleTransition
       ...
       with csstypeLib.csstypeMod._TransitionPropertyProperty
  ...
  sealed trait auto
    extends csstypeLib.csstypeMod._TrackBreadth[js.Any]
       ...
       with csstypeLib.csstypeMod.ImageRenderingProperty
       with csstypeLib.csstypeMod.ImeModeProperty
       with csstypeLib.csstypeMod.IsolationProperty
       with csstypeLib.csstypeMod.LineBreakProperty
       with csstypeLib.csstypeMod.MozUserInputProperty
       with csstypeLib.csstypeMod.MsHighContrastAdjustProperty
       ...
       with csstypeLib.csstypeMod.PageBreakBeforeProperty
       with csstypeLib.csstypeMod.PageBreakInsideProperty
       with csstypeLib.csstypeMod.PointerEventsProperty
       ...
       with csstypeLib.csstypeMod._GlyphOrientationVerticalProperty
       ...
       with csstypeLib.csstypeMod._MarginRightProperty[js.Any]
       with csstypeLib.csstypeMod._MarginTopProperty[js.Any]
       with csstypeLib.csstypeMod._MaskBorderWidthProperty[js.Any]
       ...
       with csstypeLib.csstypeMod._MozImageRegionProperty
       ...
       with csstypeLib.csstypeMod._TouchActionProperty
       with csstypeLib.csstypeMod._WidthProperty[js.Any]
       with csstypeLib.csstypeMod._WillChangeProperty
       with csstypeLib.csstypeMod._ZIndexProperty
  ...
  sealed trait balance
    extends csstypeLib.csstypeMod.ColumnFillProperty
  ...
  sealed trait baseline
    extends csstypeLib.csstypeMod.AlignmentBaselineProperty
       ...
       with csstypeLib.csstypeMod._AlignContentProperty
       with csstypeLib.csstypeMod._AlignItemsProperty
       with csstypeLib.csstypeMod._AlignSelfProperty
       with csstypeLib.csstypeMod._BaselineShiftProperty[js.Any]
       with csstypeLib.csstypeMod._JustifyItemsProperty
       with csstypeLib.csstypeMod._JustifySelfProperty
       with csstypeLib.csstypeMod._PlaceContentProperty
       with csstypeLib.csstypeMod._PlaceItemsProperty
       with csstypeLib.csstypeMod._PlaceSelfProperty
  ...
  @js.native
  sealed trait bevel
    extends csstypeLib.csstypeMod.StrokeLinejoinProperty
  ...
  @js.native
  sealed trait blink
    extends csstypeLib.csstypeMod.MozTextBlinkProperty
  ...
  @js.native
  sealed trait border
    extends csstypeLib.csstypeMod._WebkitMaskClipProperty
       with csstypeLib.csstypeMod._WebkitMaskOriginProperty
       with csstypeLib.csstypeMod._WebkitMaskProperty[js.Any]
  ...
  @js.native
  sealed trait butt
    extends csstypeLib.csstypeMod.StrokeLinecapProperty
  ...
  sealed trait caption
    extends csstypeLib.csstypeMod._FontProperty
  ...
  sealed trait chained
    extends csstypeLib.csstypeMod.MsContentZoomChainingProperty
  ...
  @js.native
  sealed trait circle
    extends csstypeLib.csstypeMod._TextEmphasisProperty
  ...
  sealed trait collapse
    extends csstypeLib.csstypeMod.BorderCollapseProperty
       with csstypeLib.csstypeMod.RubyMergeProperty
  ...
  sealed trait column
    extends csstypeLib.csstypeMod.BreakAfterProperty
       with csstypeLib.csstypeMod.BreakBeforeProperty
       with csstypeLib.csstypeMod.FlexDirectionProperty
       with csstypeLib.csstypeMod._FlexFlowProperty
       with csstypeLib.csstypeMod._GridAutoFlowProperty
  
  @js.native
  sealed trait `column-reverse`
    extends csstypeLib.csstypeMod.FlexDirectionProperty
       with csstypeLib.csstypeMod._FlexFlowProperty
  ...
  sealed trait content
    extends csstypeLib.csstypeMod._ContainProperty
       with csstypeLib.csstypeMod._FlexBasisProperty[js.Any]
       with csstypeLib.csstypeMod._FlexProperty[js.Any]
       with csstypeLib.csstypeMod._WebkitMaskClipProperty
       with csstypeLib.csstypeMod._WebkitMaskOriginProperty
       with csstypeLib.csstypeMod._WebkitMaskProperty[js.Any]
  ...
  @js.native
  sealed trait default
    extends csstypeLib.csstypeMod.MozWindowShadowProperty
       with csstypeLib.csstypeMod.WebkitTouchCalloutProperty
       with csstypeLib.csstypeMod._CursorProperty
  ...
  @js.native
  sealed trait drag
    extends csstypeLib.csstypeMod.MozWindowDraggingProperty
  ...
  sealed trait element
    extends csstypeLib.csstypeMod.MsUserSelectProperty
       with csstypeLib.csstypeMod.UserSelectProperty
  
  @js.native
  sealed trait ellipsis
    extends csstypeLib.csstypeMod._BlockOverflowProperty
       with csstypeLib.csstypeMod._TextOverflowProperty
  ...
  @js.native
  sealed trait enabled
    extends csstypeLib.csstypeMod.MozUserInputProperty
  ...
  sealed trait end
    extends csstypeLib.csstypeMod.SelfPosition
       ...
       with csstypeLib.csstypeMod.TextAlignLastProperty
       with csstypeLib.csstypeMod.TextAlignProperty
       with csstypeLib.csstypeMod.TextAnchorProperty
       with csstypeLib.csstypeMod._ScrollSnapAlignProperty
  
  @js.native
  sealed trait evenodd
    extends csstypeLib.csstypeMod.ClipRuleProperty
       with csstypeLib.csstypeMod.FillRuleProperty
  ...
  @js.native
  sealed trait fill
    extends csstypeLib.csstypeMod.ObjectFitProperty
       with csstypeLib.csstypeMod.PointerEventsProperty
       with csstypeLib.csstypeMod._MozContextPropertiesProperty
       with csstypeLib.csstypeMod._PaintOrderProperty
  
  @js.native
  sealed trait `fill-available`
    extends csstypeLib.csstypeMod._MaxBlockSizeProperty[js.Any]
  ...
  @js.native
  sealed trait `fill-opacity`
    extends csstypeLib.csstypeMod._MozContextPropertiesProperty
  ...
  @js.native
  sealed trait hide
    extends csstypeLib.csstypeMod.EmptyCellsProperty
  ...
  sealed trait `ideograph-alpha`
    extends csstypeLib.csstypeMod.MsTextAutospaceProperty
  ...
  @js.native
  sealed trait ignore
    extends csstypeLib.csstypeMod.MozStackSizingProperty
  ...
  @js.native
  sealed trait inside
    extends csstypeLib.csstypeMod.ListStylePositionProperty
       with csstypeLib.csstypeMod._ListStyleProperty
  ...
  sealed trait isolate
    extends csstypeLib.csstypeMod.IsolationProperty
  ...
  sealed trait justify
    extends csstypeLib.csstypeMod.BoxPackProperty
       with csstypeLib.csstypeMod.TextAlignLastProperty
       with csstypeLib.csstypeMod.TextAlignProperty
  ...
  sealed trait left
    extends csstypeLib.csstypeMod._Position[js.Any]
       ...
       with csstypeLib.csstypeMod._TextUnderlinePositionProperty
       with csstypeLib.csstypeMod._TransformOriginProperty[js.Any]
       with csstypeLib.csstypeMod._WebkitBoxReflectProperty[js.Any]
       with csstypeLib.csstypeMod._WebkitMaskPositionXProperty[js.Any]
  ...
  sealed trait `line-through`
    extends csstypeLib.csstypeMod._TextDecorationLineProperty
       with csstypeLib.csstypeMod._TextDecorationProperty
  ...
  @js.native
  sealed trait loose
    extends csstypeLib.csstypeMod.LineBreakProperty
  ...
  @js.native
  sealed trait ltr
    extends csstypeLib.csstypeMod.DirectionProperty
  ...
  sealed trait mandatory
    extends csstypeLib.csstypeMod.MsContentZoomSnapTypeProperty
       with csstypeLib.csstypeMod.MsScrollSnapTypeProperty
  ...
  @js.native
  sealed trait manual
    extends csstypeLib.csstypeMod.HyphensProperty
  ...
  sealed trait maximum
    extends csstypeLib.csstypeMod.MsWrapFlowProperty
  ...
  sealed trait menu
    extends csstypeLib.csstypeMod.MozWindowShadowProperty
       with csstypeLib.csstypeMod._FontProperty
  ...
  sealed trait `no-change`
    extends csstypeLib.csstypeMod.DominantBaselineProperty
  ...
  sealed trait none
    extends csstypeLib.csstypeMod.LineStyle
       ...
       with csstypeLib.csstypeMod.MozTextBlinkProperty
       with csstypeLib.csstypeMod.MozUserFocusProperty
       with csstypeLib.csstypeMod.MozUserInputProperty
       with csstypeLib.csstypeMod.MozWindowShadowProperty
       with csstypeLib.csstypeMod.MsContentZoomChainingProperty
       with csstypeLib.csstypeMod.MsContentZoomSnapTypeProperty
       with csstypeLib.csstypeMod.MsContentZoomingProperty
       with csstypeLib.csstypeMod.MsHighContrastAdjustProperty
       with csstypeLib.csstypeMod.MsOverflowStyleProperty
       with csstypeLib.csstypeMod.MsScrollChainingProperty
       with csstypeLib.csstypeMod.MsScrollRailsProperty
       with csstypeLib.csstypeMod.MsScrollSnapTypeProperty
       with csstypeLib.csstypeMod.MsScrollTranslationProperty
       with csstypeLib.csstypeMod.MsTextAutospaceProperty
       with csstypeLib.csstypeMod.MsTouchSelectProperty
       with csstypeLib.csstypeMod.MsUserSelectProperty
       with csstypeLib.csstypeMod.MsWrapThroughProperty
       with csstypeLib.csstypeMod.ObjectFitProperty
       with csstypeLib.csstypeMod.OverflowAnchorProperty
       with csstypeLib.csstypeMod.OverscrollBehaviorXProperty
       with csstypeLib.csstypeMod.OverscrollBehaviorYProperty
       ...
       with csstypeLib.csstypeMod.UserSelectProperty
       with csstypeLib.csstypeMod.VectorEffectProperty
       with csstypeLib.csstypeMod.WebkitAppearanceProperty
       with csstypeLib.csstypeMod.WebkitTouchCalloutProperty
       with csstypeLib.csstypeMod._AnimationNameProperty
       with csstypeLib.csstypeMod._BackdropFilterProperty
       with csstypeLib.csstypeMod._BackgroundImageProperty
       with csstypeLib.csstypeMod._BorderImageProperty
       with csstypeLib.csstypeMod._BorderImageSourceProperty
       with csstypeLib.csstypeMod._BoxShadowProperty
       with csstypeLib.csstypeMod._ClipPathProperty
       with csstypeLib.csstypeMod._ContainProperty
       ...
       with csstypeLib.csstypeMod._FontVariantLigaturesProperty
       with csstypeLib.csstypeMod._FontVariantProperty
       with csstypeLib.csstypeMod._GridProperty
       with csstypeLib.csstypeMod._GridTemplateAreasProperty
       with csstypeLib.csstypeMod._GridTemplateColumnsProperty[js.Any]
       with csstypeLib.csstypeMod._GridTemplateProperty
       with csstypeLib.csstypeMod._GridTemplateRowsProperty[js.Any]
       with csstypeLib.csstypeMod._HangingPunctuationProperty
       with csstypeLib.csstypeMod._LineClampProperty
       with csstypeLib.csstypeMod._ListStyleImageProperty
       with csstypeLib.csstypeMod._ListStyleProperty
       with csstypeLib.csstypeMod._ListStyleTypeProperty
       with csstypeLib.csstypeMod._MarkerEndProperty
       with csstypeLib.csstypeMod._MarkerMidProperty
       with csstypeLib.csstypeMod._MarkerProperty
       with csstypeLib.csstypeMod._MarkerStartProperty
       with csstypeLib.csstypeMod._MaskBorderProperty
       ...
       with csstypeLib.csstypeMod._MaxHeightProperty[js.Any]
       with csstypeLib.csstypeMod._MaxInlineSizeProperty[js.Any]
       with csstypeLib.csstypeMod._MaxLinesProperty
       with csstypeLib.csstypeMod._MaxWidthProperty[js.Any]
       with csstypeLib.csstypeMod._MozBindingProperty
       ...
       with csstypeLib.csstypeMod._MozContextPropertiesProperty
       with csstypeLib.csstypeMod._MsContentZoomSnapProperty
       with csstypeLib.csstypeMod._MsFlowFromProperty
       with csstypeLib.csstypeMod._MsFlowIntoProperty
       ...
       with csstypeLib.csstypeMod._ScaleProperty
       with csstypeLib.csstypeMod._ScrollSnapAlignProperty
       with csstypeLib.csstypeMod._ScrollSnapCoordinateProperty[js.Any]
       with csstypeLib.csstypeMod._ScrollSnapPointsXProperty
       ...
       with csstypeLib.csstypeMod._TextDecorationLineProperty
       with csstypeLib.csstypeMod._TextDecorationProperty
       with csstypeLib.csstypeMod._TextDecorationSkipProperty
       with csstypeLib.csstypeMod._TextEmphasisProperty
       with csstypeLib.csstypeMod._TextEmphasisStyleProperty
       with csstypeLib.csstypeMod._TextShadowProperty
       with csstypeLib.csstypeMod._TextSizeAdjustProperty
       with csstypeLib.csstypeMod._TouchActionProperty
       with csstypeLib.csstypeMod._TransformProperty
       with csstypeLib.csstypeMod._TransitionPropertyProperty
       with csstypeLib.csstypeMod._TranslateProperty[js.Any]
       with csstypeLib.csstypeMod._WebkitLineClampProperty
       with csstypeLib.csstypeMod._WebkitMaskImageProperty
       with csstypeLib.csstypeMod._WebkitMaskProperty[js.Any]
  ...
  sealed trait normal
    extends csstypeLib.csstypeMod.SingleAnimationDirection
       ...
       with csstypeLib.csstypeMod.FontVariantPositionProperty
       with csstypeLib.csstypeMod.ImeModeProperty
       with csstypeLib.csstypeMod.LineBreakProperty
       with csstypeLib.csstypeMod.MozUserFocusProperty
       ...
       with csstypeLib.csstypeMod._JustifyItemsProperty
       with csstypeLib.csstypeMod._JustifySelfProperty
       with csstypeLib.csstypeMod._LetterSpacingProperty[js.Any]
       with csstypeLib.csstypeMod._LineHeightProperty[js.Any]
       with csstypeLib.csstypeMod._PaintOrderProperty
       with csstypeLib.csstypeMod._PlaceContentProperty
       with csstypeLib.csstypeMod._PlaceItemsProperty
       with csstypeLib.csstypeMod._PlaceSelfProperty
       with csstypeLib.csstypeMod._RowGapProperty[js.Any]
       with csstypeLib.csstypeMod._WordSpacingProperty[js.Any]
       with csstypeLib.csstypeMod._ZoomProperty
  ...
  @js.native
  sealed trait nowrap
    extends csstypeLib.csstypeMod.FlexWrapProperty
       with csstypeLib.csstypeMod.WhiteSpaceProperty
       with csstypeLib.csstypeMod._FlexFlowProperty
  ...
  sealed trait optimizeLegibility
    extends csstypeLib.csstypeMod.TextRenderingProperty
  
  @js.native
  sealed trait optimizeQuality
    extends csstypeLib.csstypeMod.ColorRenderingProperty
  ...
  @js.native
  sealed trait railed
    extends csstypeLib.csstypeMod.MsScrollRailsProperty
  ...
  sealed trait `read-only`
    extends csstypeLib.csstypeMod.MozUserModifyProperty
       with csstypeLib.csstypeMod.WebkitUserModifyProperty
  ...
  sealed trait repeat
    extends csstypeLib.csstypeMod._RepeatStyle
       ...
       with csstypeLib.csstypeMod.WebkitMaskRepeatYProperty
       with csstypeLib.csstypeMod._BorderImageProperty
       with csstypeLib.csstypeMod._BorderImageRepeatProperty
       with csstypeLib.csstypeMod._MaskBorderProperty
  ...
  @js.native
  sealed trait reset
    extends csstypeLib.csstypeMod._ZoomProperty
  ...
  @js.native
  sealed trait sub
    extends csstypeLib.csstypeMod.FontVariantPositionProperty
       with csstypeLib.csstypeMod._BaselineShiftProperty[js.Any]
       with csstypeLib.csstypeMod._VerticalAlignProperty[js.Any]
  ...
  sealed trait `text-bottom`
    extends csstypeLib.csstypeMod._VerticalAlignProperty[js.Any]
  ...
  sealed trait `vertical-to-horizontal`
    extends csstypeLib.csstypeMod.MsScrollTranslationProperty
  ...
  @js.native
  sealed trait wavy
    extends csstypeLib.csstypeMod.TextDecorationStyleProperty
       with csstypeLib.csstypeMod._TextDecorationProperty
