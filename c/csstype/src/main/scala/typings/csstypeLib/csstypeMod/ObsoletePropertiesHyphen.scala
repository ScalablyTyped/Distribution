...
object ObsoletePropertiesHyphen {
  ...
  def apply[TLength](
    ...
    `-moz-resize`: ResizeProperty = null,
    ...
    if (`-moz-outline-color` != null) __obj.updateDynamic("-moz-outline-color")(`-moz-outline-color`)
    ...
    if (`-moz-outline-width` != null) __obj.updateDynamic("-moz-outline-width")(`-moz-outline-width`)
    if (`-moz-resize` != null) __obj.updateDynamic("-moz-resize")(`-moz-resize`)
    ...
    if (`-moz-text-decoration-color` != null) __obj.updateDynamic("-moz-text-decoration-color")(`-moz-text-decoration-color`)
    ...
    if (`-ms-scrollbar-3dlight-color` != null) __obj.updateDynamic("-ms-scrollbar-3dlight-color")(`-ms-scrollbar-3dlight-color`)
    if (`-ms-scrollbar-arrow-color` != null) __obj.updateDynamic("-ms-scrollbar-arrow-color")(`-ms-scrollbar-arrow-color`)
    if (`-ms-scrollbar-base-color` != null) __obj.updateDynamic("-ms-scrollbar-base-color")(`-ms-scrollbar-base-color`)
    if (`-ms-scrollbar-darkshadow-color` != null) __obj.updateDynamic("-ms-scrollbar-darkshadow-color")(`-ms-scrollbar-darkshadow-color`)
    if (`-ms-scrollbar-face-color` != null) __obj.updateDynamic("-ms-scrollbar-face-color")(`-ms-scrollbar-face-color`)
    if (`-ms-scrollbar-highlight-color` != null) __obj.updateDynamic("-ms-scrollbar-highlight-color")(`-ms-scrollbar-highlight-color`)
    if (`-ms-scrollbar-shadow-color` != null) __obj.updateDynamic("-ms-scrollbar-shadow-color")(`-ms-scrollbar-shadow-color`)
    if (`-ms-scrollbar-track-color` != null) __obj.updateDynamic("-ms-scrollbar-track-color")(`-ms-scrollbar-track-color`)
    ...
    if (`scroll-snap-destination` != null) __obj.updateDynamic("scroll-snap-destination")(`scroll-snap-destination`)
