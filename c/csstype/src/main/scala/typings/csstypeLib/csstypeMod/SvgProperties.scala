...
object SvgProperties {
  ...
  def apply[TLength](
    ...
    stopOpacity: csstypeLib.GlobalsNumber = null,
    ...
    strokeMiterlimit: csstypeLib.GlobalsNumber = null,
    strokeOpacity: csstypeLib.GlobalsNumber = null,
