...
object SvgPropertiesHyphen {
  ...
  def apply[TLength](
    ...
    `stop-opacity`: csstypeLib.GlobalsNumber = null,
    ...
    `stroke-miterlimit`: csstypeLib.GlobalsNumber = null,
    `stroke-opacity`: csstypeLib.GlobalsNumber = null,
    ...
    if (`white-space` != null) __obj.updateDynamic("white-space")(`white-space`)
