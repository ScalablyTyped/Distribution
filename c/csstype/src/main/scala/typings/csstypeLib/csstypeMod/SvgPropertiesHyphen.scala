...
trait SvgPropertiesHyphen[TLength] extends js.Object {
  ...
  var `fill-opacity`: js.UndefOr[csstypeLib.GlobalsNumber] = js.undefined
  ...
  var `flood-opacity`: js.UndefOr[csstypeLib.GlobalsNumber] = js.undefined
  ...
  var `stop-opacity`: js.UndefOr[csstypeLib.GlobalsNumber] = js.undefined
  ...
  var `stroke-miterlimit`: js.UndefOr[csstypeLib.GlobalsNumber] = js.undefined
  var `stroke-opacity`: js.UndefOr[csstypeLib.GlobalsNumber] = js.undefined
