...
object SvgPropertiesHyphenFallback {
  ...
  def apply[TLength](
    ...
    `fill-opacity`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    ...
    `flood-opacity`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    ...
    `stop-opacity`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    ...
    `stroke-miterlimit`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
    `stroke-opacity`: csstypeLib.GlobalsNumber | js.Array[csstypeLib.GlobalsNumber] = null,
