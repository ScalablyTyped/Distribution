...
object TextJustifyProperty {
  ...
  @scala.inline
  def `inter-character`: typings.csstype.csstypeStrings.`inter-character` = this.cast("inter-character")
  @scala.inline
  def `inter-word`: typings.csstype.csstypeStrings.`inter-word` = this.cast("inter-word")
  @scala.inline
