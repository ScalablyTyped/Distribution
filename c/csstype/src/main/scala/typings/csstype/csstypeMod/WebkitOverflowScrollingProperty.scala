...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.touch
...
*/
trait WebkitOverflowScrollingProperty extends js.Object

object WebkitOverflowScrollingProperty {
  @scala.inline
  ...
  @scala.inline
  def touch: typings.csstype.csstypeStrings.touch = this.cast("touch")
  @scala.inline
