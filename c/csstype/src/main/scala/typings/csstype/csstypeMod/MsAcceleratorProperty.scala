...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.`false`
  - typings.csstype.csstypeStrings.`true`
...
*/
trait MsAcceleratorProperty extends js.Object

object MsAcceleratorProperty {
  @scala.inline
  def `-moz-initial`: typings.csstype.csstypeStrings.`-moz-initial` = this.cast("-moz-initial")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def `false`: typings.csstype.csstypeStrings.`false` = this.cast("false")
  @scala.inline
  ...
  @scala.inline
  def `true`: typings.csstype.csstypeStrings.`true` = this.cast("true")
  @scala.inline
