...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.manual
...
*/
trait HyphensProperty extends js.Object

object HyphensProperty {
  @scala.inline
  ...
  @scala.inline
  def manual: typings.csstype.csstypeStrings.manual = this.cast("manual")
  @scala.inline
