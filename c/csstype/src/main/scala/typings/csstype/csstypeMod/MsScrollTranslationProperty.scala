...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.`vertical-to-horizontal`
...
*/
trait MsScrollTranslationProperty extends js.Object

object MsScrollTranslationProperty {
  @scala.inline
  ...
  @scala.inline
  def `vertical-to-horizontal`: typings.csstype.csstypeStrings.`vertical-to-horizontal` = this.cast("vertical-to-horizontal")
}
