...
*/
trait MsContentZoomSnapTypeProperty extends js.Object

object MsContentZoomSnapTypeProperty {
  @scala.inline
  ...
  @scala.inline
  def mandatory: typings.csstype.csstypeStrings.mandatory = this.cast("mandatory")
  @scala.inline
  def none: typings.csstype.csstypeStrings.none = this.cast("none")
  @scala.inline
  def proximity: typings.csstype.csstypeStrings.proximity = this.cast("proximity")
  @scala.inline
