...
object WebkitMaskRepeatYProperty {
  ...
  inline def `no-repeat`: typings.csstype.csstypeStrings.`no-repeat` = "no-repeat".asInstanceOf[typings.csstype.csstypeStrings.`no-repeat`]
  
  inline def repeat: typings.csstype.csstypeStrings.repeat = "repeat".asInstanceOf[typings.csstype.csstypeStrings.repeat]
  
  inline def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  
  inline def round: typings.csstype.csstypeStrings.round = "round".asInstanceOf[typings.csstype.csstypeStrings.round]
  
  inline def space: typings.csstype.csstypeStrings.space = "space".asInstanceOf[typings.csstype.csstypeStrings.space]
