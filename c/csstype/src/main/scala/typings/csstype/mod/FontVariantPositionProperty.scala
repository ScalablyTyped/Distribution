...
*/
trait FontVariantPositionProperty extends StObject
object FontVariantPositionProperty {
  ...
  inline def sub: typings.csstype.csstypeStrings.sub = "sub".asInstanceOf[typings.csstype.csstypeStrings.sub]
  
  inline def `super`: typings.csstype.csstypeStrings.`super` = "super".asInstanceOf[typings.csstype.csstypeStrings.`super`]
