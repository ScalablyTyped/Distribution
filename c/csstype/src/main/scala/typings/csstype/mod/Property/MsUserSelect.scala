...
object MsUserSelect {
  ...
  inline def element: typings.csstype.csstypeStrings.element = "element".asInstanceOf[typings.csstype.csstypeStrings.element]
  ...
  inline def text: typings.csstype.csstypeStrings.text = "text".asInstanceOf[typings.csstype.csstypeStrings.text]
