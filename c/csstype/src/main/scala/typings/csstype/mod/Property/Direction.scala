...
object Direction {
  ...
  @scala.inline
  def ltr: typings.csstype.csstypeStrings.ltr = "ltr".asInstanceOf[typings.csstype.csstypeStrings.ltr]
  @scala.inline
  def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  @scala.inline
  def rtl: typings.csstype.csstypeStrings.rtl = "rtl".asInstanceOf[typings.csstype.csstypeStrings.rtl]
  @scala.inline
