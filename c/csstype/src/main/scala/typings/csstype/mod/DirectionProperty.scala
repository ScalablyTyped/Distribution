...
object DirectionProperty {
  ...
  inline def ltr: typings.csstype.csstypeStrings.ltr = "ltr".asInstanceOf[typings.csstype.csstypeStrings.ltr]
  
  inline def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  
  inline def rtl: typings.csstype.csstypeStrings.rtl = "rtl".asInstanceOf[typings.csstype.csstypeStrings.rtl]
