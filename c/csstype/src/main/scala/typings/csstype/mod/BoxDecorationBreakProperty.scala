...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.clone
  - typings.csstype.csstypeStrings.slice
...
object BoxDecorationBreakProperty {
  ...
  inline def slice: typings.csstype.csstypeStrings.slice = "slice".asInstanceOf[typings.csstype.csstypeStrings.slice]
