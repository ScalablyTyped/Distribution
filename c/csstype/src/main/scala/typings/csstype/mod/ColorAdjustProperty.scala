...
object ColorAdjustProperty {
  ...
  @scala.inline
  def economy: typings.csstype.csstypeStrings.economy = "economy".asInstanceOf[typings.csstype.csstypeStrings.economy]
  
  @scala.inline
  def exact: typings.csstype.csstypeStrings.exact = "exact".asInstanceOf[typings.csstype.csstypeStrings.exact]
