...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.`block-axis`
  - typings.csstype.csstypeStrings.horizontal
  - typings.csstype.csstypeStrings.inherit
  - typings.csstype.csstypeStrings.`inline-axis`
...
*/
trait BoxOrient extends StObject
object BoxOrient {
  ...
  inline def `block-axis`: typings.csstype.csstypeStrings.`block-axis` = "block-axis".asInstanceOf[typings.csstype.csstypeStrings.`block-axis`]
  
  inline def horizontal: typings.csstype.csstypeStrings.horizontal = "horizontal".asInstanceOf[typings.csstype.csstypeStrings.horizontal]
  ...
  inline def `inline-axis`: typings.csstype.csstypeStrings.`inline-axis` = "inline-axis".asInstanceOf[typings.csstype.csstypeStrings.`inline-axis`]
  ...
  inline def vertical: typings.csstype.csstypeStrings.vertical = "vertical".asInstanceOf[typings.csstype.csstypeStrings.vertical]
}
