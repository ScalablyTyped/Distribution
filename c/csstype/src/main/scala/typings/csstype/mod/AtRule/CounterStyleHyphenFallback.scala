...
/* Inlined csstype.csstype.Fallback<csstype.csstype.AtRule.CounterStyleHyphen<TLength, TTime>> */
trait CounterStyleHyphenFallback[TLength, TTime] extends StObject {
  
  var `additive-symbols`: js.UndefOr[String | js.Array[NonNullable[js.UndefOr[String]]]] = js.undefined
  ...
  var `speak-as`: js.UndefOr[SpeakAs | js.Array[NonNullable[js.UndefOr[SpeakAs]]]] = js.undefined
...
object CounterStyleHyphenFallback {
  ...
  inline def apply[TLength, TTime](): CounterStyleHyphenFallback[TLength, TTime] = {
  ...
  implicit open class MutableBuilder[Self <: CounterStyleHyphenFallback[?, ?], TLength, TTime] (val x: Self & (CounterStyleHyphenFallback[TLength, TTime])) extends AnyVal {
    ...
    inline def `setAdditive-symbolsVarargs`(value: NonNullable[js.UndefOr[String]]*): Self = StObject.set(x, "additive-symbols", js.Array(value*))
    ...
    inline def `setSpeak-as`(value: SpeakAs | js.Array[NonNullable[js.UndefOr[SpeakAs]]]): Self = StObject.set(x, "speak-as", value.asInstanceOf[js.Any])
    
    inline def `setSpeak-asUndefined`: Self = StObject.set(x, "speak-as", js.undefined)
    
    inline def `setSpeak-asVarargs`(value: NonNullable[js.UndefOr[SpeakAs]]*): Self = StObject.set(x, "speak-as", js.Array(value*))
