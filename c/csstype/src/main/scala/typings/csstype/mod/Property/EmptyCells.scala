...
object EmptyCells {
  ...
  inline def hide: typings.csstype.csstypeStrings.hide = "hide".asInstanceOf[typings.csstype.csstypeStrings.hide]
  ...
  inline def show: typings.csstype.csstypeStrings.show = "show".asInstanceOf[typings.csstype.csstypeStrings.show]
