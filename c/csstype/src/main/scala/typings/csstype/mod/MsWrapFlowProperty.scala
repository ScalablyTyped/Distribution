...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.maximum
...
object MsWrapFlowProperty {
  ...
  inline def both: typings.csstype.csstypeStrings.both = "both".asInstanceOf[typings.csstype.csstypeStrings.both]
  
  inline def clear: typings.csstype.csstypeStrings.clear = "clear".asInstanceOf[typings.csstype.csstypeStrings.clear]
  ...
  inline def maximum: typings.csstype.csstypeStrings.maximum = "maximum".asInstanceOf[typings.csstype.csstypeStrings.maximum]
