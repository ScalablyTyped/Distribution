...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.`scale-down`
...
object ObjectFitProperty {
  ...
  inline def contain: typings.csstype.csstypeStrings.contain = "contain".asInstanceOf[typings.csstype.csstypeStrings.contain]
  
  inline def cover: typings.csstype.csstypeStrings.cover = "cover".asInstanceOf[typings.csstype.csstypeStrings.cover]
  ...
  inline def `scale-down`: typings.csstype.csstypeStrings.`scale-down` = "scale-down".asInstanceOf[typings.csstype.csstypeStrings.`scale-down`]
