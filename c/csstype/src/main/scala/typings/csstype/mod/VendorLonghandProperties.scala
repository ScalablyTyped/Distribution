...
@js.native
trait VendorLonghandProperties[TLength, TTime] extends js.Object {
  /**
    ...
    * **Initial value**: `0s`
    */
  var MozAnimationDelay: js.UndefOr[AnimationDelay[TTime]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0s`
    */
  var MozAnimationDuration: js.UndefOr[AnimationDuration[TTime]] = js.native
  /**
  ...
  /**
    ...
    */
  var MozAppearance: js.UndefOr[typings.csstype.mod.Property.MozAppearance] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderBottomColors: js.UndefOr[typings.csstype.mod.Property.MozBorderBottomColors] = js.native
  /**
  ...
  /**
    ...
    */
  var MozBorderEndWidth: js.UndefOr[BorderInlineEndWidth[TLength]] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderLeftColors: js.UndefOr[typings.csstype.mod.Property.MozBorderLeftColors] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderRightColors: js.UndefOr[typings.csstype.mod.Property.MozBorderRightColors] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozBorderTopColors: js.UndefOr[typings.csstype.mod.Property.MozBorderTopColors] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `normal`
    */
  var MozColumnGap: js.UndefOr[ColumnGap[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `medium`
    */
  var MozColumnRuleWidth: js.UndefOr[ColumnRuleWidth[TLength]] = js.native
  /**
    ...
    * **Initial value**: `auto`
    */
  var MozColumnWidth: js.UndefOr[ColumnWidth[TLength]] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var MozContextProperties: js.UndefOr[typings.csstype.mod.Property.MozContextProperties] = js.native
  /**
    ...
    * **Initial value**: `content-box`
    */
  var MozFloatEdge: js.UndefOr[typings.csstype.mod.Property.MozFloatEdge] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var MozForceBrokenImageIcon: js.UndefOr[typings.csstype.mod.Property.MozForceBrokenImageIcon] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var MozImageRegion: js.UndefOr[typings.csstype.mod.Property.MozImageRegion] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozMarginEnd: js.UndefOr[MarginInlineEnd[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozMarginStart: js.UndefOr[MarginInlineStart[TLength]] = js.native
  /**
    ...
    */
  var MozOrient: js.UndefOr[typings.csstype.mod.Property.MozOrient] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozOutlineRadiusBottomleft: js.UndefOr[typings.csstype.mod.Property.MozOutlineRadiusBottomleft[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozOutlineRadiusBottomright: js.UndefOr[typings.csstype.mod.Property.MozOutlineRadiusBottomright[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozOutlineRadiusTopleft: js.UndefOr[typings.csstype.mod.Property.MozOutlineRadiusTopleft[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozOutlineRadiusTopright: js.UndefOr[typings.csstype.mod.Property.MozOutlineRadiusTopright[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozPaddingEnd: js.UndefOr[PaddingInlineEnd[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var MozPaddingStart: js.UndefOr[PaddingInlineStart[TLength]] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var MozPerspective: js.UndefOr[Perspective[TLength]] = js.native
  /**
    ...
    * **Initial value**: `50% 50%`
    */
  var MozPerspectiveOrigin: js.UndefOr[PerspectiveOrigin[TLength]] = js.native
  /**
    ...
    */
  var MozStackSizing: js.UndefOr[typings.csstype.mod.Property.MozStackSizing] = js.native
  /**
    ...
    * **Initial value**: `8`
    */
  var MozTabSize: js.UndefOr[TabSize[TLength]] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var MozTextBlink: js.UndefOr[typings.csstype.mod.Property.MozTextBlink] = js.native
  /**
  ...
  /**
    ...
    */
  var MozTransformOrigin: js.UndefOr[TransformOrigin[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0s`
    */
  var MozTransitionDelay: js.UndefOr[TransitionDelay[TTime]] = js.native
  /**
    ...
    * **Initial value**: `0s`
    */
  var MozTransitionDuration: js.UndefOr[TransitionDuration[TTime]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var MozUserFocus: js.UndefOr[typings.csstype.mod.Property.MozUserFocus] = js.native
  /**
    ...
    */
  var MozUserModify: js.UndefOr[typings.csstype.mod.Property.MozUserModify] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `drag`
    */
  var MozWindowDragging: js.UndefOr[typings.csstype.mod.Property.MozWindowDragging] = js.native
  /**
    ...
    */
  var MozWindowShadow: js.UndefOr[typings.csstype.mod.Property.MozWindowShadow] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `50% 50%`
    */
  var OObjectPosition: js.UndefOr[ObjectPosition[TLength]] = js.native
  /**
    * The **`tab-size`** CSS property is used to customize the width of a tab (`U+0009`) character.
    *
    * **Syntax**: `<integer> | <length>`
    ...
    * **Initial value**: `8`
    */
  var OTabSize: js.UndefOr[TabSize[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var OTransformOrigin: js.UndefOr[TransformOrigin[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0s`
    */
  var WebkitAnimationDelay: js.UndefOr[AnimationDelay[TTime]] = js.native
  /**
    * The **`animation-direction`** CSS property sets whether an animation should play forwards, backwards, or alternating back and forth.
    *
    * **Syntax**: `<single-animation-direction>#`
  ...
  /**
    ...
    * **Initial value**: `0s`
    */
  var WebkitAnimationDuration: js.UndefOr[AnimationDuration[TTime]] = js.native
  /**
    * The **`animation-fill-mode`** CSS property sets how a CSS animation applies styles to its target before and after its execution.
    *
    * **Syntax**: `<single-animation-fill-mode>#`
  ...
  /**
    ...
    * **Initial value**: `none` (but this value is overridden in the user agent CSS)
    */
  var WebkitAppearance: js.UndefOr[typings.csstype.mod.Property.WebkitAppearance] = js.native
  /**
  ...
  /**
    ...
    */
  var WebkitBackgroundSize: js.UndefOr[BackgroundSize[TLength]] = js.native
  /**
    * **Syntax**: `<'color'>`
    *
    * **Initial value**: `currentcolor`
    */
  var WebkitBorderBeforeColor: js.UndefOr[typings.csstype.mod.Property.WebkitBorderBeforeColor] = js.native
  /**
    * **Syntax**: `<'border-style'>`
    *
    * **Initial value**: `none`
    */
  var WebkitBorderBeforeStyle: js.UndefOr[typings.csstype.mod.Property.WebkitBorderBeforeStyle] = js.native
  /**
    * **Syntax**: `<'border-width'>`
    *
    * **Initial value**: `medium`
    */
  var WebkitBorderBeforeWidth: js.UndefOr[typings.csstype.mod.Property.WebkitBorderBeforeWidth[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderBottomLeftRadius: js.UndefOr[BorderBottomLeftRadius[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderBottomRightRadius: js.UndefOr[BorderBottomRightRadius[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderTopLeftRadius: js.UndefOr[BorderTopLeftRadius[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitBorderTopRightRadius: js.UndefOr[BorderTopRightRadius[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var WebkitBoxReflect: js.UndefOr[typings.csstype.mod.Property.WebkitBoxReflect[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `normal`
    */
  var WebkitColumnGap: js.UndefOr[ColumnGap[TLength]] = js.native
  /**
    * The **`column-rule-color`** CSS property sets the color of the line drawn between columns in a multi-column layout.
    *
    * **Syntax**: `<color>`
  ...
  /**
    ...
    * **Initial value**: `medium`
    */
  var WebkitColumnRuleWidth: js.UndefOr[ColumnRuleWidth[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitColumnWidth: js.UndefOr[ColumnWidth[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitFlexBasis: js.UndefOr[FlexBasis[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `none`
    */
  var WebkitLineClamp: js.UndefOr[typings.csstype.mod.Property.WebkitLineClamp] = js.native
  /**
    * The **`margin-inline-end`** CSS property defines the logical inline end margin of an element, which maps to a physical margin depending on the element's writing mode, directionality, and text orientation. In other words, it corresponds to the `margin-top`, `margin-right`, `margin-bottom` or `margin-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
    *
    * **Syntax**: `<'margin-left'>`
    ...
    * **Initial value**: `0`
    */
  var WebkitMarginEnd: js.UndefOr[MarginInlineEnd[TLength]] = js.native
  /**
    * The **`margin-inline-start`** CSS property defines the logical inline start margin of an element, which maps to a physical margin depending on the element's writing mode, directionality, and text orientation. It corresponds to the `margin-top`, `margin-right`, `margin-bottom`, or `margin-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
    *
    * **Syntax**: `<'margin-left'>`
    ...
    * **Initial value**: `0`
    */
  var WebkitMarginStart: js.UndefOr[MarginInlineStart[TLength]] = js.native
  /**
    ...
    */
  var WebkitMaskAttachment: js.UndefOr[typings.csstype.mod.Property.WebkitMaskAttachment] = js.native
  /**
    ...
    */
  var WebkitMaskClip: js.UndefOr[typings.csstype.mod.Property.WebkitMaskClip] = js.native
  /**
    ...
    */
  var WebkitMaskComposite: js.UndefOr[typings.csstype.mod.Property.WebkitMaskComposite] = js.native
  /**
    ...
    * **Initial value**: `none`
    */
  var WebkitMaskImage: js.UndefOr[typings.csstype.mod.Property.WebkitMaskImage] = js.native
  /**
    ...
    */
  var WebkitMaskOrigin: js.UndefOr[typings.csstype.mod.Property.WebkitMaskOrigin] = js.native
  /**
    ...
    * **Initial value**: `0% 0%`
    */
  var WebkitMaskPosition: js.UndefOr[typings.csstype.mod.Property.WebkitMaskPosition[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0%`
    */
  var WebkitMaskPositionX: js.UndefOr[typings.csstype.mod.Property.WebkitMaskPositionX[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0%`
    */
  var WebkitMaskPositionY: js.UndefOr[typings.csstype.mod.Property.WebkitMaskPositionY[TLength]] = js.native
  /**
    ...
    */
  var WebkitMaskRepeat: js.UndefOr[typings.csstype.mod.Property.WebkitMaskRepeat] = js.native
  /**
    ...
    * **Initial value**: `repeat`
    */
  var WebkitMaskRepeatX: js.UndefOr[typings.csstype.mod.Property.WebkitMaskRepeatX] = js.native
  /**
    ...
    * **Initial value**: `repeat`
    */
  var WebkitMaskRepeatY: js.UndefOr[typings.csstype.mod.Property.WebkitMaskRepeatY] = js.native
  /**
    ...
    * **Initial value**: `auto auto`
    */
  var WebkitMaskSize: js.UndefOr[typings.csstype.mod.Property.WebkitMaskSize[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitMaxInlineSize: js.UndefOr[MaxInlineSize[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var WebkitOverflowScrolling: js.UndefOr[typings.csstype.mod.Property.WebkitOverflowScrolling] = js.native
  /**
    * The **`padding-inline-end`** CSS property defines the logical inline end padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation. It corresponds to the `padding-top`, `padding-right`, `padding-bottom`, or `padding-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
    *
    * **Syntax**: `<'padding-left'>`
    ...
    * **Initial value**: `0`
    */
  var WebkitPaddingEnd: js.UndefOr[PaddingInlineEnd[TLength]] = js.native
  /**
    * The **`padding-inline-start`** CSS property defines the logical inline start padding of an element, which maps to a physical padding depending on the element's writing mode, directionality, and text orientation. It corresponds to the `padding-top`, `padding-right`, `padding-bottom`, or `padding-left` property depending on the values defined for `writing-mode`, `direction`, and `text-orientation`.
    *
    * **Syntax**: `<'padding-left'>`
    ...
    * **Initial value**: `0`
    */
  var WebkitPaddingStart: js.UndefOr[PaddingInlineStart[TLength]] = js.native
  /**
    * The **`perspective`** CSS property determines the distance between the z=0 plane and the user in order to give a 3D-positioned element some perspective. Each 3D element with z>0 becomes larger; each 3D-element with z<0 becomes smaller. The strength of the effect is determined by the value of this property.
    *
    * **Syntax**: `none | <length>`
    ...
    * **Initial value**: `none`
    */
  var WebkitPerspective: js.UndefOr[Perspective[TLength]] = js.native
  /**
    * The **`perspective-origin`** CSS property determines the position at which the viewer is looking. It is used as the _vanishing point_ by the `perspective` property.
    *
    * **Syntax**: `<position>`
    ...
    * **Initial value**: `50% 50%`
    */
  var WebkitPerspectiveOrigin: js.UndefOr[PerspectiveOrigin[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitShapeMargin: js.UndefOr[ShapeMargin[TLength]] = js.native
  /**
    ...
    * **Initial value**: `black`
    */
  var WebkitTapHighlightColor: js.UndefOr[typings.csstype.mod.Property.WebkitTapHighlightColor] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `currentcolor`
    */
  var WebkitTextFillColor: js.UndefOr[typings.csstype.mod.Property.WebkitTextFillColor] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `currentcolor`
    */
  var WebkitTextStrokeColor: js.UndefOr[typings.csstype.mod.Property.WebkitTextStrokeColor] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var WebkitTextStrokeWidth: js.UndefOr[typings.csstype.mod.Property.WebkitTextStrokeWidth[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `default`
    */
  var WebkitTouchCallout: js.UndefOr[typings.csstype.mod.Property.WebkitTouchCallout] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var WebkitTransformOrigin: js.UndefOr[TransformOrigin[TLength]] = js.native
  /**
    * The **`transform-style`** CSS property sets whether children of an element are positioned in the 3D space or are flattened in the plane of the element.
    *
    * **Syntax**: `flat | preserve-3d`
  ...
  /**
    ...
    * **Initial value**: `0s`
    */
  var WebkitTransitionDelay: js.UndefOr[TransitionDelay[TTime]] = js.native
  /**
    * The **`transition-duration`** CSS property sets the length of time a transition animation should take to complete. By default, the value is `0s`, meaning that no animation will occur.
    *
    * **Syntax**: `<time>#`
    ...
    * **Initial value**: `0s`
    */
  var WebkitTransitionDuration: js.UndefOr[TransitionDuration[TTime]] = js.native
  /**
    * The **`transition-property`** CSS property sets the CSS properties to which a transition effect should be applied.
    *
    * **Syntax**: `none | <single-transition-property>#`
  ...
  /**
    ...
    * **Initial value**: `read-only`
    */
  var WebkitUserModify: js.UndefOr[typings.csstype.mod.Property.WebkitUserModify] = js.native
  /**
    * The `**user-select**` CSS property controls whether the user can select text. This doesn't have any effect on content loaded as chrome, except in textboxes.
    *
    * **Syntax**: `auto | text | none | contain | all`
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msGridColumns: js.UndefOr[GridAutoColumns[TLength]] = js.native
  /**
    ...
    * **Initial value**: `auto`
    */
  var msGridRows: js.UndefOr[GridAutoRows[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msHyphenateLimitZone: js.UndefOr[MsHyphenateLimitZone[TLength]] = js.native
  /**
    * The **`hyphens`** CSS property specifies how words should be hyphenated when text wraps across multiple lines. You can prevent hyphenation entirely, use hyphenation in manually-specified points within the text, or let the browser automatically insert hyphens where appropriate.
    *
    * **Syntax**: `none | manual | auto`
  ...
  /**
    ...
    * **Initial value**: `auto`
    */
  var msScrollLimitXMax: js.UndefOr[MsScrollLimitXMax[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var msScrollLimitXMin: js.UndefOr[MsScrollLimitXMin[TLength]] = js.native
  /**
    ...
    * **Initial value**: `auto`
    */
  var msScrollLimitYMax: js.UndefOr[MsScrollLimitYMax[TLength]] = js.native
  /**
    ...
    * **Initial value**: `0`
    */
  var msScrollLimitYMin: js.UndefOr[MsScrollLimitYMin[TLength]] = js.native
  /**
  ...
  /**
    ...
    * **Initial value**: `50% 50% 0`
    */
  var msTransformOrigin: js.UndefOr[TransformOrigin[TLength]] = js.native
  /**
    * The **`transition-delay`** CSS property specifies the duration to wait before starting a property's transition effect when its value changes.
    *
    * **Syntax**: `<time>#`
    ...
    * **Initial value**: `0s`
    */
  var msTransitionDelay: js.UndefOr[TransitionDelay[TTime]] = js.native
  /**
    * The **`transition-duration`** CSS property sets the length of time a transition animation should take to complete. By default, the value is `0s`, meaning that no animation will occur.
    *
    * **Syntax**: `<time>#`
    ...
    * **Initial value**: `0s`
    */
  var msTransitionDuration: js.UndefOr[TransitionDuration[TTime]] = js.native
  /**
    * The **`transition-property`** CSS property sets the CSS properties to which a transition effect should be applied.
    *
    * **Syntax**: `none | <single-transition-property>#`
  ...
  /**
    ...
    * **Initial value**: `0`
    */
  var msWrapMargin: js.UndefOr[MsWrapMargin[TLength]] = js.native
  /**
...
object VendorLonghandProperties {
  @scala.inline
  def apply[TLength, TTime](): VendorLonghandProperties[TLength, TTime] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VendorLonghandProperties[TLength, TTime]]
  }
  @scala.inline
  implicit class VendorLonghandPropertiesOps[Self <: VendorLonghandProperties[_, _], TLength, TTime] (val x: Self with (VendorLonghandProperties[TLength, TTime])) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMozAnimationDelay(value: AnimationDelay[TTime]): Self = this.set("MozAnimationDelay", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozAnimationDuration(value: AnimationDuration[TTime]): Self = this.set("MozAnimationDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozBorderEndWidth(value: BorderInlineEndWidth[TLength]): Self = this.set("MozBorderEndWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozColumnGap(value: ColumnGap[TLength]): Self = this.set("MozColumnGap", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozColumnRuleWidth(value: ColumnRuleWidth[TLength]): Self = this.set("MozColumnRuleWidth", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozColumnRuleWidth: Self = this.set("MozColumnRuleWidth", js.undefined)
    @scala.inline
    def setMozColumnWidth(value: ColumnWidth[TLength]): Self = this.set("MozColumnWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozMarginEnd(value: MarginInlineEnd[TLength]): Self = this.set("MozMarginEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozMarginEnd: Self = this.set("MozMarginEnd", js.undefined)
    @scala.inline
    def setMozMarginStart(value: MarginInlineStart[TLength]): Self = this.set("MozMarginStart", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozOutlineRadiusBottomleft(value: MozOutlineRadiusBottomleft[TLength]): Self = this.set("MozOutlineRadiusBottomleft", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozOutlineRadiusBottomleft: Self = this.set("MozOutlineRadiusBottomleft", js.undefined)
    @scala.inline
    def setMozOutlineRadiusBottomright(value: MozOutlineRadiusBottomright[TLength]): Self = this.set("MozOutlineRadiusBottomright", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozOutlineRadiusBottomright: Self = this.set("MozOutlineRadiusBottomright", js.undefined)
    @scala.inline
    def setMozOutlineRadiusTopleft(value: MozOutlineRadiusTopleft[TLength]): Self = this.set("MozOutlineRadiusTopleft", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozOutlineRadiusTopleft: Self = this.set("MozOutlineRadiusTopleft", js.undefined)
    @scala.inline
    def setMozOutlineRadiusTopright(value: MozOutlineRadiusTopright[TLength]): Self = this.set("MozOutlineRadiusTopright", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozOutlineRadiusTopright: Self = this.set("MozOutlineRadiusTopright", js.undefined)
    @scala.inline
    def setMozPaddingEnd(value: PaddingInlineEnd[TLength]): Self = this.set("MozPaddingEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozPaddingEnd: Self = this.set("MozPaddingEnd", js.undefined)
    @scala.inline
    def setMozPaddingStart(value: PaddingInlineStart[TLength]): Self = this.set("MozPaddingStart", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozPaddingStart: Self = this.set("MozPaddingStart", js.undefined)
    @scala.inline
    def setMozPerspective(value: Perspective[TLength]): Self = this.set("MozPerspective", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozPerspective: Self = this.set("MozPerspective", js.undefined)
    @scala.inline
    def setMozPerspectiveOrigin(value: PerspectiveOrigin[TLength]): Self = this.set("MozPerspectiveOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozTabSize(value: TabSize[TLength]): Self = this.set("MozTabSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozTransformOrigin(value: TransformOrigin[TLength]): Self = this.set("MozTransformOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMozTransitionDelay(value: TransitionDelay[TTime]): Self = this.set("MozTransitionDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMozTransitionDelay: Self = this.set("MozTransitionDelay", js.undefined)
    @scala.inline
    def setMozTransitionDuration(value: TransitionDuration[TTime]): Self = this.set("MozTransitionDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOObjectPosition(value: ObjectPosition[TLength]): Self = this.set("OObjectPosition", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteOObjectPosition: Self = this.set("OObjectPosition", js.undefined)
    @scala.inline
    def setOTabSize(value: TabSize[TLength]): Self = this.set("OTabSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOTransformOrigin(value: TransformOrigin[TLength]): Self = this.set("OTransformOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitAnimationDelay(value: AnimationDelay[TTime]): Self = this.set("WebkitAnimationDelay", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitAnimationDuration(value: AnimationDuration[TTime]): Self = this.set("WebkitAnimationDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitBackgroundSize(value: BackgroundSize[TLength]): Self = this.set("WebkitBackgroundSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitBorderBeforeWidth(value: WebkitBorderBeforeWidth[TLength]): Self = this.set("WebkitBorderBeforeWidth", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitBorderBeforeWidth: Self = this.set("WebkitBorderBeforeWidth", js.undefined)
    @scala.inline
    def setWebkitBorderBottomLeftRadius(value: BorderBottomLeftRadius[TLength]): Self = this.set("WebkitBorderBottomLeftRadius", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitBorderBottomLeftRadius: Self = this.set("WebkitBorderBottomLeftRadius", js.undefined)
    @scala.inline
    def setWebkitBorderBottomRightRadius(value: BorderBottomRightRadius[TLength]): Self = this.set("WebkitBorderBottomRightRadius", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitBorderTopLeftRadius(value: BorderTopLeftRadius[TLength]): Self = this.set("WebkitBorderTopLeftRadius", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitBorderTopLeftRadius: Self = this.set("WebkitBorderTopLeftRadius", js.undefined)
    @scala.inline
    def setWebkitBorderTopRightRadius(value: BorderTopRightRadius[TLength]): Self = this.set("WebkitBorderTopRightRadius", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitBoxReflect(value: WebkitBoxReflect[TLength]): Self = this.set("WebkitBoxReflect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitColumnGap(value: ColumnGap[TLength]): Self = this.set("WebkitColumnGap", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitColumnRuleWidth(value: ColumnRuleWidth[TLength]): Self = this.set("WebkitColumnRuleWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitColumnWidth(value: ColumnWidth[TLength]): Self = this.set("WebkitColumnWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitFlexBasis(value: FlexBasis[TLength]): Self = this.set("WebkitFlexBasis", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitMarginEnd(value: MarginInlineEnd[TLength]): Self = this.set("WebkitMarginEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitMarginEnd: Self = this.set("WebkitMarginEnd", js.undefined)
    @scala.inline
    def setWebkitMarginStart(value: MarginInlineStart[TLength]): Self = this.set("WebkitMarginStart", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitMaskPosition(value: WebkitMaskPosition[TLength]): Self = this.set("WebkitMaskPosition", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitMaskPosition: Self = this.set("WebkitMaskPosition", js.undefined)
    @scala.inline
    def setWebkitMaskPositionX(value: WebkitMaskPositionX[TLength]): Self = this.set("WebkitMaskPositionX", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitMaskPositionX: Self = this.set("WebkitMaskPositionX", js.undefined)
    @scala.inline
    def setWebkitMaskPositionY(value: WebkitMaskPositionY[TLength]): Self = this.set("WebkitMaskPositionY", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitMaskSize(value: WebkitMaskSize[TLength]): Self = this.set("WebkitMaskSize", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitMaskSize: Self = this.set("WebkitMaskSize", js.undefined)
    @scala.inline
    def setWebkitMaxInlineSize(value: MaxInlineSize[TLength]): Self = this.set("WebkitMaxInlineSize", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitPaddingEnd(value: PaddingInlineEnd[TLength]): Self = this.set("WebkitPaddingEnd", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitPaddingEnd: Self = this.set("WebkitPaddingEnd", js.undefined)
    @scala.inline
    def setWebkitPaddingStart(value: PaddingInlineStart[TLength]): Self = this.set("WebkitPaddingStart", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitPaddingStart: Self = this.set("WebkitPaddingStart", js.undefined)
    @scala.inline
    def setWebkitPerspective(value: Perspective[TLength]): Self = this.set("WebkitPerspective", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitPerspective: Self = this.set("WebkitPerspective", js.undefined)
    @scala.inline
    def setWebkitPerspectiveOrigin(value: PerspectiveOrigin[TLength]): Self = this.set("WebkitPerspectiveOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitShapeMargin(value: ShapeMargin[TLength]): Self = this.set("WebkitShapeMargin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitTextStrokeWidth(value: WebkitTextStrokeWidth[TLength]): Self = this.set("WebkitTextStrokeWidth", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitTransformOrigin(value: TransformOrigin[TLength]): Self = this.set("WebkitTransformOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setWebkitTransitionDelay(value: TransitionDelay[TTime]): Self = this.set("WebkitTransitionDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteWebkitTransitionDelay: Self = this.set("WebkitTransitionDelay", js.undefined)
    @scala.inline
    def setWebkitTransitionDuration(value: TransitionDuration[TTime]): Self = this.set("WebkitTransitionDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsGridColumns(value: GridAutoColumns[TLength]): Self = this.set("msGridColumns", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsGridColumns: Self = this.set("msGridColumns", js.undefined)
    @scala.inline
    def setMsGridRows(value: GridAutoRows[TLength]): Self = this.set("msGridRows", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsHyphenateLimitZone(value: MsHyphenateLimitZone[TLength]): Self = this.set("msHyphenateLimitZone", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsScrollLimitXMax(value: MsScrollLimitXMax[TLength]): Self = this.set("msScrollLimitXMax", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsScrollLimitXMax: Self = this.set("msScrollLimitXMax", js.undefined)
    @scala.inline
    def setMsScrollLimitXMin(value: MsScrollLimitXMin[TLength]): Self = this.set("msScrollLimitXMin", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsScrollLimitXMin: Self = this.set("msScrollLimitXMin", js.undefined)
    @scala.inline
    def setMsScrollLimitYMax(value: MsScrollLimitYMax[TLength]): Self = this.set("msScrollLimitYMax", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsScrollLimitYMax: Self = this.set("msScrollLimitYMax", js.undefined)
    @scala.inline
    def setMsScrollLimitYMin(value: MsScrollLimitYMin[TLength]): Self = this.set("msScrollLimitYMin", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsTransformOrigin(value: TransformOrigin[TLength]): Self = this.set("msTransformOrigin", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsTransformOrigin: Self = this.set("msTransformOrigin", js.undefined)
    @scala.inline
    def setMsTransitionDelay(value: TransitionDelay[TTime]): Self = this.set("msTransitionDelay", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMsTransitionDelay: Self = this.set("msTransitionDelay", js.undefined)
    @scala.inline
    def setMsTransitionDuration(value: TransitionDuration[TTime]): Self = this.set("msTransitionDuration", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMsWrapMargin(value: MsWrapMargin[TLength]): Self = this.set("msWrapMargin", value.asInstanceOf[js.Any])
    @scala.inline
