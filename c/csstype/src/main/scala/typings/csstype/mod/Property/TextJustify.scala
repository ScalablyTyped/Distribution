...
object TextJustify {
  ...
  inline def `inter-character`: typings.csstype.csstypeStrings.`inter-character` = "inter-character".asInstanceOf[typings.csstype.csstypeStrings.`inter-character`]
  
  inline def `inter-word`: typings.csstype.csstypeStrings.`inter-word` = "inter-word".asInstanceOf[typings.csstype.csstypeStrings.`inter-word`]
