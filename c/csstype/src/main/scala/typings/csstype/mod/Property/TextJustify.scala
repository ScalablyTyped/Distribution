...
object TextJustify {
  ...
  @scala.inline
  def `inter-character`: typings.csstype.csstypeStrings.`inter-character` = "inter-character".asInstanceOf[typings.csstype.csstypeStrings.`inter-character`]
  @scala.inline
  def `inter-word`: typings.csstype.csstypeStrings.`inter-word` = "inter-word".asInstanceOf[typings.csstype.csstypeStrings.`inter-word`]
  @scala.inline
