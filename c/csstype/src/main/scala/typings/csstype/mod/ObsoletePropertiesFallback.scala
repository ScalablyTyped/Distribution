...
object ObsoletePropertiesFallback {
  ...
  @scala.inline
  implicit class ObsoletePropertiesFallbackMutableBuilder[Self <: ObsoletePropertiesFallback[?], TLength] (val x: Self & ObsoletePropertiesFallback[TLength]) extends AnyVal {
