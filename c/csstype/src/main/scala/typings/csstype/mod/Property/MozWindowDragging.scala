...
object MozWindowDragging {
  ...
  inline def drag: typings.csstype.csstypeStrings.drag = "drag".asInstanceOf[typings.csstype.csstypeStrings.drag]
  ...
  inline def `no-drag`: typings.csstype.csstypeStrings.`no-drag` = "no-drag".asInstanceOf[typings.csstype.csstypeStrings.`no-drag`]
