...
object StrokeLinecapProperty {
  ...
  inline def butt: typings.csstype.csstypeStrings.butt = "butt".asInstanceOf[typings.csstype.csstypeStrings.butt]
  ...
  inline def square: typings.csstype.csstypeStrings.square = "square".asInstanceOf[typings.csstype.csstypeStrings.square]
