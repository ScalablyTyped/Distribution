...
*/
trait ScrollSnapTypeYProperty extends js.Object
object ScrollSnapTypeYProperty {
  ...
  @scala.inline
  def mandatory: typings.csstype.csstypeStrings.mandatory = "mandatory".asInstanceOf[typings.csstype.csstypeStrings.mandatory]
  
  @scala.inline
  def none: typings.csstype.csstypeStrings.none = "none".asInstanceOf[typings.csstype.csstypeStrings.none]
  
  @scala.inline
  def proximity: typings.csstype.csstypeStrings.proximity = "proximity".asInstanceOf[typings.csstype.csstypeStrings.proximity]
