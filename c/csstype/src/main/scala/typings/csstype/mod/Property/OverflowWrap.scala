...
*/
trait OverflowWrap extends js.Object
...
object OverflowWrap {
  ...
  @scala.inline
  def anywhere: typings.csstype.csstypeStrings.anywhere = "anywhere".asInstanceOf[typings.csstype.csstypeStrings.anywhere]
  @scala.inline
  def `break-word`: typings.csstype.csstypeStrings.`break-word` = "break-word".asInstanceOf[typings.csstype.csstypeStrings.`break-word`]
  @scala.inline
