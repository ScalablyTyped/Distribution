...
*/
trait OverflowWrap extends StObject
object OverflowWrap {
  ...
  inline def anywhere: typings.csstype.csstypeStrings.anywhere = "anywhere".asInstanceOf[typings.csstype.csstypeStrings.anywhere]
