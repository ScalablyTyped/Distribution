...
*/
trait MsTouchSelectProperty extends js.Object
...
object MsTouchSelectProperty {
  ...
  @scala.inline
  def grippers: typings.csstype.csstypeStrings.grippers = "grippers".asInstanceOf[typings.csstype.csstypeStrings.grippers]
  @scala.inline
