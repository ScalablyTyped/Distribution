...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.grippers
...
*/
trait MsTouchSelectProperty extends StObject
object MsTouchSelectProperty {
  ...
  inline def grippers: typings.csstype.csstypeStrings.grippers = "grippers".asInstanceOf[typings.csstype.csstypeStrings.grippers]
