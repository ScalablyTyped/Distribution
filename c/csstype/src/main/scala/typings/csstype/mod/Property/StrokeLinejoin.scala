...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.bevel
  - typings.csstype.csstypeStrings.miter
...
object StrokeLinejoin {
  ...
  inline def bevel: typings.csstype.csstypeStrings.bevel = "bevel".asInstanceOf[typings.csstype.csstypeStrings.bevel]
  ...
  inline def miter: typings.csstype.csstypeStrings.miter = "miter".asInstanceOf[typings.csstype.csstypeStrings.miter]
