...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.`read-write-plaintext-only`
...
object WebkitUserModifyProperty {
  ...
  @scala.inline
  def `read-write-plaintext-only`: typings.csstype.csstypeStrings.`read-write-plaintext-only` = "read-write-plaintext-only".asInstanceOf[typings.csstype.csstypeStrings.`read-write-plaintext-only`]
