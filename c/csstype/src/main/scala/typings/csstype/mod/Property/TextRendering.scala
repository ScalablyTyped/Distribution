...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.geometricPrecision
  - typings.csstype.csstypeStrings.optimizeLegibility
  - typings.csstype.csstypeStrings.optimizeSpeed
...
*/
trait TextRendering extends js.Object
...
object TextRendering {
  ...
  @scala.inline
  def geometricPrecision: typings.csstype.csstypeStrings.geometricPrecision = "geometricPrecision".asInstanceOf[typings.csstype.csstypeStrings.geometricPrecision]
  @scala.inline
  ...
  @scala.inline
  def optimizeLegibility: typings.csstype.csstypeStrings.optimizeLegibility = "optimizeLegibility".asInstanceOf[typings.csstype.csstypeStrings.optimizeLegibility]
  @scala.inline
  def optimizeSpeed: typings.csstype.csstypeStrings.optimizeSpeed = "optimizeSpeed".asInstanceOf[typings.csstype.csstypeStrings.optimizeSpeed]
  @scala.inline
