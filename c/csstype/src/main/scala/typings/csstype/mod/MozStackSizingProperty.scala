...
object MozStackSizingProperty {
  @scala.inline
  def `-moz-initial`: typings.csstype.csstypeStrings.`-moz-initial` = this.cast("-moz-initial")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def ignore: typings.csstype.csstypeStrings.ignore = this.cast("ignore")
  @scala.inline
  ...
  @scala.inline
  def `stretch-to-fit`: typings.csstype.csstypeStrings.`stretch-to-fit` = this.cast("stretch-to-fit")
  @scala.inline
