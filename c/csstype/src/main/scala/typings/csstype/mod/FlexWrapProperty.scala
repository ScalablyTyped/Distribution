...
*/
trait FlexWrapProperty extends StObject
object FlexWrapProperty {
  ...
  inline def `wrap-reverse`: typings.csstype.csstypeStrings.`wrap-reverse` = "wrap-reverse".asInstanceOf[typings.csstype.csstypeStrings.`wrap-reverse`]
}
