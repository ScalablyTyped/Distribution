...
object VendorLonghandPropertiesHyphen {
  ...
  extension [Self <: VendorLonghandPropertiesHyphen[?], TLength](x: Self & VendorLonghandPropertiesHyphen[TLength]) {
    ...
    inline def `set-moz-osx-font-smoothing`(value: FontSmoothProperty[TLength]): Self = StObject.set(x, "-moz-osx-font-smoothing", value.asInstanceOf[js.Any])
    ...
    inline def `set-ms-grid-columns`(value: MsGridColumnsProperty[TLength]): Self = StObject.set(x, "-ms-grid-columns", value.asInstanceOf[js.Any])
    
    inline def `set-ms-grid-columnsUndefined`: Self = StObject.set(x, "-ms-grid-columns", js.undefined)
    
    inline def `set-ms-grid-rows`(value: MsGridRowsProperty[TLength]): Self = StObject.set(x, "-ms-grid-rows", value.asInstanceOf[js.Any])
    ...
    inline def `set-ms-justify-self`(value: JustifySelfProperty): Self = StObject.set(x, "-ms-justify-self", value.asInstanceOf[js.Any])
    ...
    inline def `set-webkit-font-smoothing`(value: FontSmoothProperty[TLength]): Self = StObject.set(x, "-webkit-font-smoothing", value.asInstanceOf[js.Any])
    ...
    inline def `set-webkit-ruby-position`(value: RubyPositionProperty): Self = StObject.set(x, "-webkit-ruby-position", value.asInstanceOf[js.Any])
