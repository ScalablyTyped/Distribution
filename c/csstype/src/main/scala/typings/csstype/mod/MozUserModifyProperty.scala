...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.`write-only`
...
object MozUserModifyProperty {
  ...
  inline def `read-only`: typings.csstype.csstypeStrings.`read-only` = "read-only".asInstanceOf[typings.csstype.csstypeStrings.`read-only`]
  
  inline def `read-write`: typings.csstype.csstypeStrings.`read-write` = "read-write".asInstanceOf[typings.csstype.csstypeStrings.`read-write`]
  ...
  inline def `write-only`: typings.csstype.csstypeStrings.`write-only` = "write-only".asInstanceOf[typings.csstype.csstypeStrings.`write-only`]
}
