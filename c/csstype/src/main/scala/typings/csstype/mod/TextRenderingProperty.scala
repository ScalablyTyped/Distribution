...
object TextRenderingProperty {
  ...
  @scala.inline
  def geometricPrecision: typings.csstype.csstypeStrings.geometricPrecision = this.cast("geometricPrecision")
  @scala.inline
  ...
  @scala.inline
  def optimizeLegibility: typings.csstype.csstypeStrings.optimizeLegibility = this.cast("optimizeLegibility")
  @scala.inline
  def optimizeSpeed: typings.csstype.csstypeStrings.optimizeSpeed = this.cast("optimizeSpeed")
  @scala.inline
