...
object TextRenderingProperty {
  ...
  inline def optimizeLegibility: typings.csstype.csstypeStrings.optimizeLegibility = "optimizeLegibility".asInstanceOf[typings.csstype.csstypeStrings.optimizeLegibility]
