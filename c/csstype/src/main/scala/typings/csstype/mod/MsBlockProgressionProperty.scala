...
*/
trait MsBlockProgressionProperty extends js.Object
object MsBlockProgressionProperty {
  ...
  @scala.inline
  def bt: typings.csstype.csstypeStrings.bt = "bt".asInstanceOf[typings.csstype.csstypeStrings.bt]
  ...
  @scala.inline
  def lr: typings.csstype.csstypeStrings.lr = "lr".asInstanceOf[typings.csstype.csstypeStrings.lr]
  
  @scala.inline
  def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  
  @scala.inline
  def rl: typings.csstype.csstypeStrings.rl = "rl".asInstanceOf[typings.csstype.csstypeStrings.rl]
  
  @scala.inline
  def tb: typings.csstype.csstypeStrings.tb = "tb".asInstanceOf[typings.csstype.csstypeStrings.tb]
