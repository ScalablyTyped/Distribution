...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.balance
  - typings.csstype.csstypeStrings.`balance-all`
...
object ColumnFill {
  ...
  inline def balance: typings.csstype.csstypeStrings.balance = "balance".asInstanceOf[typings.csstype.csstypeStrings.balance]
  
  inline def `balance-all`: typings.csstype.csstypeStrings.`balance-all` = "balance-all".asInstanceOf[typings.csstype.csstypeStrings.`balance-all`]
