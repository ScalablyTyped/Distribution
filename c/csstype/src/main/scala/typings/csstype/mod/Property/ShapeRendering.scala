...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.crispEdges
...
*/
trait ShapeRendering extends js.Object
...
object ShapeRendering {
  ...
  @scala.inline
  def crispEdges: typings.csstype.csstypeStrings.crispEdges = "crispEdges".asInstanceOf[typings.csstype.csstypeStrings.crispEdges]
  @scala.inline
