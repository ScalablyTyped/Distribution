...
object ShapeRendering {
  ...
  inline def crispEdges: typings.csstype.csstypeStrings.crispEdges = "crispEdges".asInstanceOf[typings.csstype.csstypeStrings.crispEdges]
  
  inline def geometricPrecision: typings.csstype.csstypeStrings.geometricPrecision = "geometricPrecision".asInstanceOf[typings.csstype.csstypeStrings.geometricPrecision]
  ...
  inline def optimizeSpeed: typings.csstype.csstypeStrings.optimizeSpeed = "optimizeSpeed".asInstanceOf[typings.csstype.csstypeStrings.optimizeSpeed]
