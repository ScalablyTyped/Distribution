...
object FontFaceFallback {
  ...
  extension [Self <: FontFaceFallback](x: Self) {
    ...
    inline def setFontDisplayVarargs(value: FontFaceFontDisplayProperty*): Self = StObject.set(x, "fontDisplay", js.Array(value :_*))
    ...
    inline def setFontFeatureSettingsVarargs(value: FontFaceFontFeatureSettingsProperty*): Self = StObject.set(x, "fontFeatureSettings", js.Array(value :_*))
    ...
    inline def setFontStretchVarargs(value: FontFaceFontStretchProperty*): Self = StObject.set(x, "fontStretch", js.Array(value :_*))
    ...
    inline def setFontStyleVarargs(value: FontFaceFontStyleProperty*): Self = StObject.set(x, "fontStyle", js.Array(value :_*))
    ...
    inline def setFontVariantVarargs(value: FontFaceFontVariantProperty*): Self = StObject.set(x, "fontVariant", js.Array(value :_*))
    ...
    inline def setFontVariationSettingsVarargs(value: FontFaceFontVariationSettingsProperty*): Self = StObject.set(x, "fontVariationSettings", js.Array(value :_*))
    ...
    inline def setFontWeightVarargs(value: FontFaceFontWeightProperty*): Self = StObject.set(x, "fontWeight", js.Array(value :_*))
    ...
    inline def setMozFontFeatureSettingsVarargs(value: FontFaceFontFeatureSettingsProperty*): Self = StObject.set(x, "MozFontFeatureSettings", js.Array(value :_*))
    ...
    inline def setUnicodeRangeVarargs(value: String*): Self = StObject.set(x, "unicodeRange", js.Array(value :_*))
  }
}
