...
*/
trait MozWindowShadow extends StObject
object MozWindowShadow {
  
  inline def default: typings.csstype.csstypeStrings.default = "default".asInstanceOf[typings.csstype.csstypeStrings.default]
