...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.collapse
...
*/
trait VisibilityProperty extends js.Object
...
object VisibilityProperty {
  ...
  @scala.inline
  def collapse: typings.csstype.csstypeStrings.collapse = "collapse".asInstanceOf[typings.csstype.csstypeStrings.collapse]
  @scala.inline
  ...
  @scala.inline
  def visible: typings.csstype.csstypeStrings.visible = "visible".asInstanceOf[typings.csstype.csstypeStrings.visible]
}
