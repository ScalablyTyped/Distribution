...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.linearRGB
  - typings.csstype.csstypeStrings.sRGB
...
*/
trait ColorInterpolationProperty extends StObject
object ColorInterpolationProperty {
  ...
  inline def linearRGB: typings.csstype.csstypeStrings.linearRGB = "linearRGB".asInstanceOf[typings.csstype.csstypeStrings.linearRGB]
  
  inline def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  
  inline def sRGB: typings.csstype.csstypeStrings.sRGB = "sRGB".asInstanceOf[typings.csstype.csstypeStrings.sRGB]
