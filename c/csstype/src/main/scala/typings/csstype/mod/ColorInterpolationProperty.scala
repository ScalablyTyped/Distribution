...
*/
trait ColorInterpolationProperty extends js.Object
...
object ColorInterpolationProperty {
  ...
  @scala.inline
  def linearRGB: typings.csstype.csstypeStrings.linearRGB = "linearRGB".asInstanceOf[typings.csstype.csstypeStrings.linearRGB]
  @scala.inline
  def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  @scala.inline
  def sRGB: typings.csstype.csstypeStrings.sRGB = "sRGB".asInstanceOf[typings.csstype.csstypeStrings.sRGB]
  @scala.inline
