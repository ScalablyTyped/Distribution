...
object StandardLonghandPropertiesHyphen {
  ...
  def apply[TLength](
    ...
    `aspect-ratio`: AspectRatioProperty = null,
    ...
    `overscroll-behavior-block`: OverscrollBehaviorBlockProperty = null,
    `overscroll-behavior-inline`: OverscrollBehaviorInlineProperty = null,
    ...
    if (`overscroll-behavior-block` != null) __obj.updateDynamic("overscroll-behavior-block")(`overscroll-behavior-block`.asInstanceOf[js.Any])
    if (`overscroll-behavior-inline` != null) __obj.updateDynamic("overscroll-behavior-inline")(`overscroll-behavior-inline`.asInstanceOf[js.Any])
