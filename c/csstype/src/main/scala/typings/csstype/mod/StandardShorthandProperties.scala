...
object StandardShorthandProperties {
  ...
  @scala.inline
  implicit class StandardShorthandPropertiesMutableBuilder[Self <: StandardShorthandProperties[?], TLength] (val x: Self & StandardShorthandProperties[TLength]) extends AnyVal {
