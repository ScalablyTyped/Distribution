...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.bt
  - typings.csstype.csstypeStrings.lr
  - typings.csstype.csstypeStrings.rl
  - typings.csstype.csstypeStrings.tb
...
object MsBlockProgression {
  ...
  inline def bt: typings.csstype.csstypeStrings.bt = "bt".asInstanceOf[typings.csstype.csstypeStrings.bt]
  ...
  inline def lr: typings.csstype.csstypeStrings.lr = "lr".asInstanceOf[typings.csstype.csstypeStrings.lr]
  ...
  inline def rl: typings.csstype.csstypeStrings.rl = "rl".asInstanceOf[typings.csstype.csstypeStrings.rl]
  
  inline def tb: typings.csstype.csstypeStrings.tb = "tb".asInstanceOf[typings.csstype.csstypeStrings.tb]
