...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.economy
  - typings.csstype.csstypeStrings.exact
...
*/
trait PrintColorAdjust extends StObject
object PrintColorAdjust {
  ...
  inline def economy: typings.csstype.csstypeStrings.economy = "economy".asInstanceOf[typings.csstype.csstypeStrings.economy]
  
  inline def exact: typings.csstype.csstypeStrings.exact = "exact".asInstanceOf[typings.csstype.csstypeStrings.exact]
