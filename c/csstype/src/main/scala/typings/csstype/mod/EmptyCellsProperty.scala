...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.hide
  - typings.csstype.csstypeStrings.show
...
*/
trait EmptyCellsProperty extends js.Object
object EmptyCellsProperty {
  ...
  @scala.inline
  def hide: typings.csstype.csstypeStrings.hide = "hide".asInstanceOf[typings.csstype.csstypeStrings.hide]
  ...
  @scala.inline
  def show: typings.csstype.csstypeStrings.show = "show".asInstanceOf[typings.csstype.csstypeStrings.show]
