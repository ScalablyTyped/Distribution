...
object OverflowXProperty {
  ...
  @scala.inline
  def `-moz-hidden-unscrollable`: typings.csstype.csstypeStrings.`-moz-hidden-unscrollable` = "-moz-hidden-unscrollable".asInstanceOf[typings.csstype.csstypeStrings.`-moz-hidden-unscrollable`]
