...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.evenodd
  - typings.csstype.csstypeStrings.nonzero
...
object FillRule {
  ...
  inline def evenodd: typings.csstype.csstypeStrings.evenodd = "evenodd".asInstanceOf[typings.csstype.csstypeStrings.evenodd]
  ...
  inline def nonzero: typings.csstype.csstypeStrings.nonzero = "nonzero".asInstanceOf[typings.csstype.csstypeStrings.nonzero]
