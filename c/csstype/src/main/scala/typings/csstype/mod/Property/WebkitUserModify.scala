...
object WebkitUserModify {
  ...
  inline def `read-write-plaintext-only`: typings.csstype.csstypeStrings.`read-write-plaintext-only` = "read-write-plaintext-only".asInstanceOf[typings.csstype.csstypeStrings.`read-write-plaintext-only`]
