...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.flat
  - typings.csstype.csstypeStrings.`preserve-3d`
...
object TransformStyle {
  ...
  inline def flat: typings.csstype.csstypeStrings.flat = "flat".asInstanceOf[typings.csstype.csstypeStrings.flat]
  ...
  inline def `preserve-3d`: typings.csstype.csstypeStrings.`preserve-3d` = "preserve-3d".asInstanceOf[typings.csstype.csstypeStrings.`preserve-3d`]
