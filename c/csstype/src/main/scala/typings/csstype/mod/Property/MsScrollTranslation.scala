...
*/
trait MsScrollTranslation extends js.Object
...
object MsScrollTranslation {
  ...
  @scala.inline
  def `vertical-to-horizontal`: typings.csstype.csstypeStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typings.csstype.csstypeStrings.`vertical-to-horizontal`]
}
