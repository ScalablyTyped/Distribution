...
object MsScrollTranslation {
  ...
  inline def `vertical-to-horizontal`: typings.csstype.csstypeStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typings.csstype.csstypeStrings.`vertical-to-horizontal`]
}
