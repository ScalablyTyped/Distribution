...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.inactive
...
object ImeMode {
  ...
  inline def active: typings.csstype.csstypeStrings.active = "active".asInstanceOf[typings.csstype.csstypeStrings.active]
  ...
  inline def inactive: typings.csstype.csstypeStrings.inactive = "inactive".asInstanceOf[typings.csstype.csstypeStrings.inactive]
