...
*/
trait MozStackSizing extends js.Object
...
object MozStackSizing {
  ...
  @scala.inline
  def `stretch-to-fit`: typings.csstype.csstypeStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[typings.csstype.csstypeStrings.`stretch-to-fit`]
  @scala.inline
