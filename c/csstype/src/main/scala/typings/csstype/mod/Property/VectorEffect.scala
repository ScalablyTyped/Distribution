...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.`non-scaling-stroke`
...
*/
trait VectorEffect extends StObject
object VectorEffect {
  ...
  inline def `non-scaling-stroke`: typings.csstype.csstypeStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[typings.csstype.csstypeStrings.`non-scaling-stroke`]
