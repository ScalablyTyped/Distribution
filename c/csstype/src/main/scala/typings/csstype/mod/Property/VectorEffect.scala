...
*/
trait VectorEffect extends js.Object
...
object VectorEffect {
  ...
  @scala.inline
  def `non-scaling-stroke`: typings.csstype.csstypeStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[typings.csstype.csstypeStrings.`non-scaling-stroke`]
  @scala.inline
