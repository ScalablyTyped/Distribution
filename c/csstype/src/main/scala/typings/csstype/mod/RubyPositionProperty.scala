...
object RubyPositionProperty {
  ...
  @scala.inline
  def over: typings.csstype.csstypeStrings.over = "over".asInstanceOf[typings.csstype.csstypeStrings.over]
  
  @scala.inline
  def revert: typings.csstype.csstypeStrings.revert = "revert".asInstanceOf[typings.csstype.csstypeStrings.revert]
  
  @scala.inline
  def under: typings.csstype.csstypeStrings.under = "under".asInstanceOf[typings.csstype.csstypeStrings.under]
