...
*/
trait MsScrollChainingProperty extends js.Object
...
object MsScrollChainingProperty {
  ...
  @scala.inline
  def chained: typings.csstype.csstypeStrings.chained = "chained".asInstanceOf[typings.csstype.csstypeStrings.chained]
  @scala.inline
