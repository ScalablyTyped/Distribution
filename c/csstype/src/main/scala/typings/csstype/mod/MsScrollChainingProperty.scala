...
/* Rewritten from type alias, can be one of: 
  - typings.csstype.csstypeStrings.chained
...
*/
trait MsScrollChainingProperty extends StObject
object MsScrollChainingProperty {
  ...
  inline def chained: typings.csstype.csstypeStrings.chained = "chained".asInstanceOf[typings.csstype.csstypeStrings.chained]
