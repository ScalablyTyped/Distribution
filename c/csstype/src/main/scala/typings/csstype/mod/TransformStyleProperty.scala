...
object TransformStyleProperty {
  ...
  @scala.inline
  def flat: typings.csstype.csstypeStrings.flat = "flat".asInstanceOf[typings.csstype.csstypeStrings.flat]
  ...
  @scala.inline
  def `preserve-3d`: typings.csstype.csstypeStrings.`preserve-3d` = "preserve-3d".asInstanceOf[typings.csstype.csstypeStrings.`preserve-3d`]
