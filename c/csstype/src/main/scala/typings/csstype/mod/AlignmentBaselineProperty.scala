...
object AlignmentBaselineProperty {
  ...
  @scala.inline
  def `after-edge`: typings.csstype.csstypeStrings.`after-edge` = this.cast("after-edge")
  @scala.inline
  ...
  @scala.inline
  def baseline: typings.csstype.csstypeStrings.baseline = this.cast("baseline")
  @scala.inline
  def `before-edge`: typings.csstype.csstypeStrings.`before-edge` = this.cast("before-edge")
  @scala.inline
