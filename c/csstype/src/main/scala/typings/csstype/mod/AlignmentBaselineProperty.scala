...
object AlignmentBaselineProperty {
  ...
  @scala.inline
  def `after-edge`: typings.csstype.csstypeStrings.`after-edge` = "after-edge".asInstanceOf[typings.csstype.csstypeStrings.`after-edge`]
  ...
  @scala.inline
  def baseline: typings.csstype.csstypeStrings.baseline = "baseline".asInstanceOf[typings.csstype.csstypeStrings.baseline]
  
  @scala.inline
  def `before-edge`: typings.csstype.csstypeStrings.`before-edge` = "before-edge".asInstanceOf[typings.csstype.csstypeStrings.`before-edge`]
