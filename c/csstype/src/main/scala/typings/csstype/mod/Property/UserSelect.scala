...
*/
trait UserSelect extends js.Object
...
object UserSelect {
  ...
  @scala.inline
  def `-moz-none`: typings.csstype.csstypeStrings.`-moz-none` = "-moz-none".asInstanceOf[typings.csstype.csstypeStrings.`-moz-none`]
  @scala.inline
  ...
  @scala.inline
  def element: typings.csstype.csstypeStrings.element = "element".asInstanceOf[typings.csstype.csstypeStrings.element]
  @scala.inline
