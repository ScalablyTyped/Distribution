...
object LineBreakProperty {
  ...
  @scala.inline
  def loose: typings.csstype.csstypeStrings.loose = "loose".asInstanceOf[typings.csstype.csstypeStrings.loose]
  ...
  @scala.inline
  def strict: typings.csstype.csstypeStrings.strict = "strict".asInstanceOf[typings.csstype.csstypeStrings.strict]
