...
object LineBreakProperty {
  ...
  inline def loose: typings.csstype.csstypeStrings.loose = "loose".asInstanceOf[typings.csstype.csstypeStrings.loose]
  ...
  inline def strict: typings.csstype.csstypeStrings.strict = "strict".asInstanceOf[typings.csstype.csstypeStrings.strict]
