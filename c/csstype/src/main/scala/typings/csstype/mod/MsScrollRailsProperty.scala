...
*/
trait MsScrollRailsProperty extends js.Object
object MsScrollRailsProperty {
  ...
  @scala.inline
  def railed: typings.csstype.csstypeStrings.railed = "railed".asInstanceOf[typings.csstype.csstypeStrings.railed]
