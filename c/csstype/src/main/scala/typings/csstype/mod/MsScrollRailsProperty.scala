...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.railed
...
*/
trait MsScrollRailsProperty extends StObject
object MsScrollRailsProperty {
  ...
  inline def railed: typings.csstype.csstypeStrings.railed = "railed".asInstanceOf[typings.csstype.csstypeStrings.railed]
