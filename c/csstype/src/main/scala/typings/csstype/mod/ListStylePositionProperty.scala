...
object ListStylePositionProperty {
  ...
  inline def inside: typings.csstype.csstypeStrings.inside = "inside".asInstanceOf[typings.csstype.csstypeStrings.inside]
  
  inline def outside: typings.csstype.csstypeStrings.outside = "outside".asInstanceOf[typings.csstype.csstypeStrings.outside]
