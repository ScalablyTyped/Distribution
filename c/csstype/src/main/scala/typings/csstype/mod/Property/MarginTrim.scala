...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.`in-flow`
...
*/
trait MarginTrim extends StObject
object MarginTrim {
  ...
  inline def `in-flow`: typings.csstype.csstypeStrings.`in-flow` = "in-flow".asInstanceOf[typings.csstype.csstypeStrings.`in-flow`]
