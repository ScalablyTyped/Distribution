...
object HtmlAttributes {
  ...
  @scala.inline
  def `[sandbox-allow-downloads]`: typings.csstype.csstypeStrings.`[sandbox-allow-downloads]` = "[sandbox-allow-downloads]".asInstanceOf[typings.csstype.csstypeStrings.`[sandbox-allow-downloads]`]
