...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.optimizeQuality
...
object ColorRendering {
  ...
  inline def optimizeQuality: typings.csstype.csstypeStrings.optimizeQuality = "optimizeQuality".asInstanceOf[typings.csstype.csstypeStrings.optimizeQuality]
