...
object WordBreak {
  ...
  @scala.inline
  def `break-all`: typings.csstype.csstypeStrings.`break-all` = "break-all".asInstanceOf[typings.csstype.csstypeStrings.`break-all`]
  @scala.inline
  ...
  @scala.inline
  def `keep-all`: typings.csstype.csstypeStrings.`keep-all` = "keep-all".asInstanceOf[typings.csstype.csstypeStrings.`keep-all`]
  @scala.inline
