...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.csstype.csstypeStrings.smooth
...
object ScrollBehavior {
  ...
  inline def smooth: typings.csstype.csstypeStrings.smooth = "smooth".asInstanceOf[typings.csstype.csstypeStrings.smooth]
