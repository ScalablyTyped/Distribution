...
object Complex {
  ...
  def apply(
    ...
    __obj.updateDynamic("acot")(acot)
    __obj.updateDynamic("acoth")(acoth)
    __obj.updateDynamic("acsc")(acsc)
    __obj.updateDynamic("acsch")(acsch)
    __obj.updateDynamic("add")(add)
    __obj.updateDynamic("arg")(arg)
    __obj.updateDynamic("asec")(asec)
    __obj.updateDynamic("asech")(asech)
    ...
    __obj.updateDynamic("cot")(cot)
    __obj.updateDynamic("coth")(coth)
    __obj.updateDynamic("csc")(csc)
    __obj.updateDynamic("csch")(csch)
    ...
    __obj.updateDynamic("isFinite")(isFinite)
    __obj.updateDynamic("isInfinite")(isInfinite)
    __obj.updateDynamic("isNaN")(isNaN)
    ...
    __obj.updateDynamic("toVector")(toVector)
