...
object modelMod {
  ...
  @JSImport("@chevrotain/gast/lib/src/model", "AbstractProduction")
  @js.native
  abstract class AbstractProduction[T /* <: IProduction */] protected ()
    extends StObject
       with IProduction {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.chevrotainGast.modelMod.ISerializedBasic
    - typings.chevrotainGast.modelMod.ISerializedGastRule
    - typings.chevrotainGast.modelMod.ISerializedNonTerminal
    - typings.chevrotainGast.modelMod.ISerializedTerminal
    - typings.chevrotainGast.modelMod.ISerializedTerminalWithSeparator
  */
  ...
  object ISerializedGastAny {
    ...
    inline def ISerializedBasic(
      ...
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.chevrotainGast.modelMod.ISerializedBasic]
    }
    
    inline def ISerializedGastRule(name: String, orgText: String): typings.chevrotainGast.modelMod.ISerializedGastRule = {
      ...
      __obj.asInstanceOf[typings.chevrotainGast.modelMod.ISerializedGastRule]
    }
    
    inline def ISerializedNonTerminal(idx: Double, name: String): typings.chevrotainGast.modelMod.ISerializedNonTerminal = {
      ...
      __obj.asInstanceOf[typings.chevrotainGast.modelMod.ISerializedNonTerminal]
    }
    
    inline def ISerializedTerminal(idx: Double, name: String): typings.chevrotainGast.modelMod.ISerializedTerminal = {
      val __obj = js.Dynamic.literal(idx = idx.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Terminal")
      __obj.asInstanceOf[typings.chevrotainGast.modelMod.ISerializedTerminal]
    }
    ...
    inline def ISerializedTerminalWithSeparator(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.chevrotainGast.modelMod.ISerializedTerminalWithSeparator]
    }
  }
