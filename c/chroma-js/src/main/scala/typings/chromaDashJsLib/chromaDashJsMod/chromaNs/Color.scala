...
trait Color extends js.Object {
  ...
  /**
           * Get and set the color opacity.
           */
  def alpha(a: scala.Double): Color = js.native
  def brighten(): Color = js.native
  def brighten(f: scala.Double): Color = js.native
  /**
           ...
           */
  def cmyk(): js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double] = js.native
  /**
  ...
  def darken(f: scala.Double): Color = js.native
  /**
  ...
  /**
           * Similar to saturate, but the opposite direction.
           */
  def desaturate(s: scala.Double): Color = js.native
  /**
  ...
  /**
           ...
           */
  def gl(): js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           */
  def hcl(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
  ...
  /**
           ...
           */
  def hsi(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           */
  def hsl(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           */
  def hsv(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           */
  def lab(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           */
  def lch(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
  ...
  /**
           ...
           */
  def luminance(l: scala.Double): Color = js.native
  /**
           * Set luminance of color. The source color will be interpolated with black or white until the correct luminance is found.
           * The color space used defaults to RGB.
           */
  ...
  /**
           ...
           */
  def rgb(): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           * Returns an array with the red, green, and blue component, each as
           * number within the range 0..255. Chroma internally stores RGB
           * channels as floats but rounds the numbers before returning them.
           ...
           * chroma('orange').darken().rgb(false) === [198.05,118.11,0]
           */
  def rgb(round: scala.Boolean): js.Tuple3[scala.Double, scala.Double, scala.Double] = js.native
  /**
           ...
           * chroma('hsla(20, 100%, 40%, 0.5)').rgba() === [204,68,0,0.5]
           */
  def rgba(): js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double] = js.native
  /**
           * Just like color.rgb but adds the alpha channel to the returned array.
           *
           * @example
           ...
           * chroma('hsla(20, 100%, 40%, 0.5)').rgba() === [204,68,0,0.5]
           */
  def rgba(round: scala.Boolean): js.Tuple4[scala.Double, scala.Double, scala.Double, scala.Double] = js.native
  /**
  ...
  /**
           * Changes the saturation of a color by manipulating the Lch chromacity.
           */
  def saturate(s: scala.Double): Color = js.native
  /**
           ...
           */
  def set(modechan: java.lang.String, v: java.lang.String): Color = js.native
  /**
           * Changes a single channel and returns the result a new chroma object.
           * @example
           * // half Lab lightness
           ...
           * chroma('darkseagreen').set('lch.c', '*2')
           */
  def set(modechan: java.lang.String, v: scala.Double): Color = js.native
  /**
