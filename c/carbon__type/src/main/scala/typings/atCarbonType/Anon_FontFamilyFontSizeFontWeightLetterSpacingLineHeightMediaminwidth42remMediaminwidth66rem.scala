...
trait Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 42remRightparenthesis`: Anon_FontFamily
  @JSName("@media (min-width: 66rem)")
  var `@media Leftparenthesismin-widthColon 66remRightparenthesis`: Anon_FontFamily
  @JSName("@media (min-width: 82rem)")
  var `@media Leftparenthesismin-widthColon 82remRightparenthesis`: Anon_FontFamily
  @JSName("@media (min-width: 99rem)")
  var `@media Leftparenthesismin-widthColon 99remRightparenthesis`: Anon_FontFamily
...
object Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem {
  @scala.inline
  def apply(
    `@media Leftparenthesismin-widthColon 42remRightparenthesis`: Anon_FontFamily,
    `@media Leftparenthesismin-widthColon 66remRightparenthesis`: Anon_FontFamily,
    `@media Leftparenthesismin-widthColon 82remRightparenthesis`: Anon_FontFamily,
    `@media Leftparenthesismin-widthColon 99remRightparenthesis`: Anon_FontFamily,
    fontFamily: String,
    fontSize: String,
    fontWeight: Double,
    letterSpacing: Double,
    lineHeight: String
  ): Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem = {
    ...
    __obj.asInstanceOf[Anon_FontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem]
  }
}
