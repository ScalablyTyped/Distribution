...
trait AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem extends js.Object {
...
object AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem {
  @scala.inline
  def apply(
    ...
    lineHeight: String
  ): AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem = {
    ...
    __obj.asInstanceOf[AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42remMediaminwidth66rem]
  }
}
