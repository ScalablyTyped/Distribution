...
trait LineHeightMediaminwidth42rem extends StObject {
...
object LineHeightMediaminwidth42rem {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[LineHeightMediaminwidth42rem]
  }
  
  extension [Self <: LineHeightMediaminwidth42rem](x: Self) {
