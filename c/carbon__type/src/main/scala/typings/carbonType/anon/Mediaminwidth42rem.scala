...
object Mediaminwidth42rem {
  ...
  extension [Self <: Mediaminwidth42rem](x: Self) {
    ...
    inline def `set@media Leftparenthesismin-widthColon 66remRightparenthesis`(value: FontSize): Self = StObject.set(x, "@media (min-width: 66rem)", value.asInstanceOf[js.Any])
    ...
    inline def `set@media Leftparenthesismin-widthColon 99remRightparenthesis`(value: LineHeight): Self = StObject.set(x, "@media (min-width: 99rem)", value.asInstanceOf[js.Any])
