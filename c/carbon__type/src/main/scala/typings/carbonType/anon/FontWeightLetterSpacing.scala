...
object FontWeightLetterSpacing {
  ...
  @scala.inline
  implicit class FontWeightLetterSpacingMutableBuilder[Self <: FontWeightLetterSpacing] (val x: Self) extends AnyVal {
    
    @scala.inline
    def `set@media Leftparenthesismin-widthColon 42remRightparenthesis`(value: FontWeight): Self = StObject.set(x, "@media (min-width: 42rem)", value.asInstanceOf[js.Any])
