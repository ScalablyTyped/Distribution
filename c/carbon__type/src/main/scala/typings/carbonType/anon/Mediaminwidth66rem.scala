...
@js.native
trait Mediaminwidth66rem extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 66remRightparenthesis`: LetterSpacing = js.native
  ...
  var `@media Leftparenthesismin-widthColon 99remRightparenthesis`: LetterSpacing = js.native
...
object Mediaminwidth66rem {
  ...
  @scala.inline
  implicit class Mediaminwidth66remOps[Self <: Mediaminwidth66rem] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `set@media Leftparenthesismin-widthColon 66remRightparenthesis`(value: LetterSpacing): Self = this.set("@media (min-width: 66rem)", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def `set@media Leftparenthesismin-widthColon 99remRightparenthesis`(value: LetterSpacing): Self = this.set("@media (min-width: 99rem)", value.asInstanceOf[js.Any])
    @scala.inline
