...
object LetterSpacingLineHeight {
  ...
  @scala.inline
  implicit class LetterSpacingLineHeightMutableBuilder[Self <: LetterSpacingLineHeight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `set@media Leftparenthesismin-widthColon 66remRightparenthesis`(value: LineHeight): Self = StObject.set(x, "@media (min-width: 66rem)", value.asInstanceOf[js.Any])
