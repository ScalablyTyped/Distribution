...
@js.native
trait Mediaminwidth82rem extends js.Object {
...
object Mediaminwidth82rem {
  ...
  @scala.inline
  implicit class Mediaminwidth82remOps[Self <: Mediaminwidth82rem] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `set@media Leftparenthesismin-widthColon 82remRightparenthesis`(value: LetterSpacing): Self = this.set("@media (min-width: 82rem)", value.asInstanceOf[js.Any])
