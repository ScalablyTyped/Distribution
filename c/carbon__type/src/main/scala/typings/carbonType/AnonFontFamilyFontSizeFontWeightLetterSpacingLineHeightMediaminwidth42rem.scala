...
trait AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42rem extends js.Object {
  ...
  var `@media Leftparenthesismin-widthColon 82remRightparenthesis`: AnonFontSizeLetterSpacing
...
object AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42rem {
  @scala.inline
  def apply(
    ...
    `@media Leftparenthesismin-widthColon 82remRightparenthesis`: AnonFontSizeLetterSpacing,
    ...
    lineHeight: String
  ): AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42rem = {
    ...
    __obj.asInstanceOf[AnonFontFamilyFontSizeFontWeightLetterSpacingLineHeightMediaminwidth42rem]
  }
}
