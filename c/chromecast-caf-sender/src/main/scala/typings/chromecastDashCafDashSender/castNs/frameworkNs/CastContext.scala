...
import typings.chromecastDashCafDashSender.castNs.frameworkNs.CastContextEventType.CAST_STATE_CHANGED
import typings.chromecastDashCafDashSender.castNs.frameworkNs.CastContextEventType.SESSION_STATE_CHANGED
