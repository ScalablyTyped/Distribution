...
object viewNs extends js.Object {
  ...
  class Document ()
    ...
    val roots: atCkeditorCkeditor5DashUtilsLib.ckeditor5DashUtilsMod.Collection[RootEditableElement] = js.native
  ...
  object observerNs extends js.Object {
    ...
    class FakeSelectionObserver protected () extends Observer {
      def this(view: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.View) = this()
    ...
    class KeyEventData ()
      extends DomEventData
         with atCkeditorCkeditor5DashUtilsLib.ckeditor5DashUtilsMod.KeystrokeInfo {
      /* CompleteClass */
    ...
    trait MutatedText extends js.Object {
      ...
      var node: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.Text
    ...
    class MutationObserver () extends Observer {
      var domConverter: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.DomConverter = js.native
      var renderer: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.Renderer = js.native
    }
    ...
    class Observer protected () extends js.Object {
      def this(view: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.View) = this()
      val document: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.Document = js.native
    ...
    class SelectionObserver () extends Observer {
      val domConverter: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.DomConverter = js.native
      val mutationObserver: MutationObserver = js.native
      val selection: atCkeditorCkeditor5DashEngineLib.ckeditor5DashEngineMod.viewNs.DocumentSelection = js.native
    }
