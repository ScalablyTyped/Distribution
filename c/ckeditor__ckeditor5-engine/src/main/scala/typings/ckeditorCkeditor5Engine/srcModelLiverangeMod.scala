...
object srcModelLiverangeMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.ckeditorCkeditor5Engine.srcModelSelectionMod._Selectable because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/liverange", JSImport.Default)
  @js.native
  open class default () extends LiveRange
  /* static members */
  object default {
    
    @JSImport("@ckeditor/ckeditor5-engine/src/model/liverange", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    inline def fromRange(range: typings.ckeditorCkeditor5Engine.srcModelRangeMod.default): LiveRange = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRange")(range.asInstanceOf[js.Any]).asInstanceOf[LiveRange]
  }
  ...
  trait LiveRange
    ...
    def toRange(): typings.ckeditorCkeditor5Engine.srcModelRangeMod.default = js.native
  }
}
