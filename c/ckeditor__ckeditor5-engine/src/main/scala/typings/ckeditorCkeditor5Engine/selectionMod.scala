...
object selectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ckeditorCkeditor5Engine.selectionMod.Selection
    - typings.ckeditorCkeditor5Engine.documentselectionMod.default
    - typings.ckeditorCkeditor5Engine.positionMod.default
    - typings.ckeditorCkeditor5Engine.livepositionMod.default
    - typings.ckeditorCkeditor5Engine.rangeMod.default
    - typings.ckeditorCkeditor5Engine.liverangeMod.default
    - typings.ckeditorCkeditor5Engine.nodeMod.default
    - typings.ckeditorCkeditor5Engine.elementMod.default
    - typings.ckeditorCkeditor5Engine.rootelementMod.default
    - typings.ckeditorCkeditor5Engine.textMod.default
    - scala.Null
    - js.Iterable[typings.ckeditorCkeditor5Engine.rangeMod.default]
  */
  type Selectable = _Selectable | js.Iterable[typings.ckeditorCkeditor5Engine.rangeMod.default] | Null
  ...
  trait Selection
    ...
    val anchor: typings.ckeditorCkeditor5Engine.positionMod.default | Null = js.native
    
    def containsEntireContent(element: typings.ckeditorCkeditor5Engine.elementMod.default): Boolean = js.native
    ...
    val focus: typings.ckeditorCkeditor5Engine.positionMod.default | Null = js.native
    ...
    def getFirstPosition(): typings.ckeditorCkeditor5Engine.positionMod.default | Null = js.native
    
    def getFirstRange(): typings.ckeditorCkeditor5Engine.rangeMod.default | Null = js.native
    
    def getLastPosition(): typings.ckeditorCkeditor5Engine.positionMod.default | Null = js.native
    
    def getLastRange(): typings.ckeditorCkeditor5Engine.rangeMod.default | Null = js.native
    
    def getRanges(): Generator[typings.ckeditorCkeditor5Engine.rangeMod.default, Any, Any] = js.native
    
    def getSelectedBlocks(): Generator[typings.ckeditorCkeditor5Engine.elementMod.default, Any, Any] = js.native
    
    def getSelectedElement(): typings.ckeditorCkeditor5Engine.elementMod.default | Null = js.native
    ...
    def isEqual(otherSelection: typings.ckeditorCkeditor5Engine.documentselectionMod.default): Boolean = js.native
    ...
    def setFocus(itemOrPosition: typings.ckeditorCkeditor5Engine.positionMod.default): Unit = js.native
