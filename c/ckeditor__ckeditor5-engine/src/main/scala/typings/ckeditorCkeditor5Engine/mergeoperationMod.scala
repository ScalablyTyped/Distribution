...
object mergeoperationMod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      howMany: Double,
      targetPosition: typings.ckeditorCkeditor5Engine.positionMod.default,
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val deletionPosition: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
    ...
    /* CompleteClass */
    @JSName("getReversed")
    override def getReversed_MMergeOperation(): typings.ckeditorCkeditor5Engine.splitoperationMod.default = js.native
    
    /**
      * Position in graveyard to which the merged element will be moved.
      */
    /* CompleteClass */
    override val graveyardPosition: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
    
    /**
      * Position which the nodes from the merged elements will be moved to.
      */
    /* CompleteClass */
    var targetPosition: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: GraveyardPosition, document: typings.ckeditorCkeditor5Engine.documentMod.default): MergeOperation = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[MergeOperation]
  }
  ...
  trait MergeOperation
    ...
    /**
      * Position before the merged element (which will be deleted).
      */
    val deletionPosition: typings.ckeditorCkeditor5Engine.positionMod.default
    
    /**
      * See {@link module:engine/model/operation/operation~Operation#getReversed `Operation#getReversed()`}.
      */
    @JSName("getReversed")
    def getReversed_MMergeOperation(): typings.ckeditorCkeditor5Engine.splitoperationMod.default
    
    /**
      * Position in graveyard to which the merged element will be moved.
      */
    val graveyardPosition: typings.ckeditorCkeditor5Engine.positionMod.default
    ...
    /**
      * Position inside the merged element. All nodes from that element after that position will be moved to {@link ~#targetPosition}.
      */
    var sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default
    
    /**
      * Position which the nodes from the merged elements will be moved to.
      */
    var targetPosition: typings.ckeditorCkeditor5Engine.positionMod.default
  ...
  object MergeOperation {
    ...
    inline def apply(
      ...
      deletionPosition: typings.ckeditorCkeditor5Engine.positionMod.default,
      getReversed: () => typings.ckeditorCkeditor5Engine.splitoperationMod.default,
      graveyardPosition: typings.ckeditorCkeditor5Engine.positionMod.default,
      howMany: Double,
    ...
    extension [Self <: MergeOperation](x: Self) {
      ...
      inline def setDeletionPosition(value: typings.ckeditorCkeditor5Engine.positionMod.default): Self = StObject.set(x, "deletionPosition", value.asInstanceOf[js.Any])
      
      inline def setGetReversed(value: () => typings.ckeditorCkeditor5Engine.splitoperationMod.default): Self = StObject.set(x, "getReversed", js.Any.fromFunction0(value))
      ...
      inline def setTargetPosition(value: typings.ckeditorCkeditor5Engine.positionMod.default): Self = StObject.set(x, "targetPosition", value.asInstanceOf[js.Any])
