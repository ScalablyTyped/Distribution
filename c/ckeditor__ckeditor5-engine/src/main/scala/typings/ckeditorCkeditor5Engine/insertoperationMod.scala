...
object insertoperationMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    @JSName("getReversed")
    override def getReversed_MInsertOperation(): typings.ckeditorCkeditor5Engine.moveoperationMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val nodes: typings.ckeditorCkeditor5Engine.nodelistMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: BaseVersion, document: typings.ckeditorCkeditor5Engine.documentMod.default): InsertOperation = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[InsertOperation]
  }
  ...
  trait InsertOperation
    ...
    /**
      ...
      */
    @JSName("getReversed")
    def getReversed_MInsertOperation(): typings.ckeditorCkeditor5Engine.moveoperationMod.default
    ...
    /**
      * List of nodes to insert.
      */
    val nodes: typings.ckeditorCkeditor5Engine.nodelistMod.default
  ...
  object InsertOperation {
    ...
    inline def apply(
      ...
      getReversed: () => typings.ckeditorCkeditor5Engine.moveoperationMod.default,
      howMany: Double,
      isDocumentOperation: Boolean,
      nodes: typings.ckeditorCkeditor5Engine.nodelistMod.default,
    ...
    extension [Self <: InsertOperation](x: Self) {
      ...
      inline def setGetReversed(value: () => typings.ckeditorCkeditor5Engine.moveoperationMod.default): Self = StObject.set(x, "getReversed", js.Any.fromFunction0(value))
      
      inline def setHowMany(value: Double): Self = StObject.set(x, "howMany", value.asInstanceOf[js.Any])
      
      inline def setNodes(value: typings.ckeditorCkeditor5Engine.nodelistMod.default): Self = StObject.set(x, "nodes", value.asInstanceOf[js.Any])
