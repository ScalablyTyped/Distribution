...
object srcViewMatcherMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def `match`(element: typings.ckeditorCkeditor5Engine.srcViewElementMod.default*): Match | Null = js.native
    
    /* CompleteClass */
    override def matchAll(element: typings.ckeditorCkeditor5Engine.srcViewElementMod.default*): js.Array[ElementMatch] | Null = js.native
  }
  ...
  trait Matcher extends StObject {
    ...
    def `match`(element: typings.ckeditorCkeditor5Engine.srcViewElementMod.default*): Match | Null
    
    def matchAll(element: typings.ckeditorCkeditor5Engine.srcViewElementMod.default*): js.Array[ElementMatch] | Null
  }
  object Matcher {
    ...
    inline def apply(
      ...
      `match`: /* repeated */ typings.ckeditorCkeditor5Engine.srcViewElementMod.default => Match | Null,
      matchAll: /* repeated */ typings.ckeditorCkeditor5Engine.srcViewElementMod.default => js.Array[ElementMatch] | Null
    ): Matcher = {
    ...
    extension [Self <: Matcher](x: Self) {
      ...
      inline def setMatch(value: /* repeated */ typings.ckeditorCkeditor5Engine.srcViewElementMod.default => Match | Null): Self = StObject.set(x, "match", js.Any.fromFunction1(value))
      
      inline def setMatchAll(
        value: /* repeated */ typings.ckeditorCkeditor5Engine.srcViewElementMod.default => js.Array[ElementMatch] | Null
