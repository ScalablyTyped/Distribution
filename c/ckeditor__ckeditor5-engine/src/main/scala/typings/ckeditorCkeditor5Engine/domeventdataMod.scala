...
object domeventdataMod {
  
  @JSImport("@ckeditor/ckeditor5-engine/src/view/observer/domeventdata", JSImport.Default)
  @js.native
  open class default[V /* <: /* Couldn't translate: 'key not found: IArray(TsIdentLibraryScoped(ckeditor,ckeditor5-engine), TsIdentModule(Some(ckeditor),List(ckeditor5-engine, src, view, view)))' */ Any */, K /* <: InputEvent | ClipboardEvent | TransitionEvent | AnimationEvent | CompositionEvent | FormDataEvent | WheelEvent | ErrorEvent | DragEvent | KeyboardEvent | MouseEvent | SubmitEvent | UIEvent | PointerEvent | TouchEvent | FocusEvent | Event | ProgressEvent[EventTarget] | SecurityPolicyViolationEvent */, L /* <: /* keyof K */ String */] protected ()
    extends StObject
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val document: typings.ckeditorCkeditor5Engine.viewDocumentMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val target: typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
  ...
  trait DomEventData[V /* <: /* Couldn't translate: 'key not found: IArray(TsIdentLibraryScoped(ckeditor,ckeditor5-engine), TsIdentModule(Some(ckeditor),List(ckeditor5-engine, src, view, view)))' */ Any */, K /* <: InputEvent | ClipboardEvent | TransitionEvent | AnimationEvent | CompositionEvent | FormDataEvent | WheelEvent | ErrorEvent | DragEvent | KeyboardEvent | MouseEvent | SubmitEvent | UIEvent | PointerEvent | TouchEvent | FocusEvent | Event | ProgressEvent[EventTarget] | SecurityPolicyViolationEvent */, L /* <: /* keyof K */ String */] extends StObject {
    
    /**
      * The instance of the document.
      */
    val document: typings.ckeditorCkeditor5Engine.viewDocumentMod.default
    ...
    /**
      * The tree view element representing the target.
      */
    val target: typings.ckeditorCkeditor5Engine.viewElementMod.default
  ...
  object DomEventData {
    ...
    inline def apply[V /* <: /* Couldn't translate: 'key not found: IArray(TsIdentLibraryScoped(ckeditor,ckeditor5-engine), TsIdentModule(Some(ckeditor),List(ckeditor5-engine, src, view, view)))' */ Any */, K /* <: InputEvent | ClipboardEvent | TransitionEvent | AnimationEvent | CompositionEvent | FormDataEvent | WheelEvent | ErrorEvent | DragEvent | KeyboardEvent | MouseEvent | SubmitEvent | UIEvent | PointerEvent | TouchEvent | FocusEvent | Event | ProgressEvent[EventTarget] | SecurityPolicyViolationEvent */, L /* <: /* keyof K */ String */](
      ...
      target: typings.ckeditorCkeditor5Engine.viewElementMod.default,
      view: V
    ): DomEventData[V, K, L] = {
    ...
    extension [Self <: DomEventData[?, ?, ?], V /* <: /* Couldn't translate: 'key not found: IArray(TsIdentLibraryScoped(ckeditor,ckeditor5-engine), TsIdentModule(Some(ckeditor),List(ckeditor5-engine, src, view, view)))' */ Any */, K /* <: InputEvent | ClipboardEvent | TransitionEvent | AnimationEvent | CompositionEvent | FormDataEvent | WheelEvent | ErrorEvent | DragEvent | KeyboardEvent | MouseEvent | SubmitEvent | UIEvent | PointerEvent | TouchEvent | FocusEvent | Event | ProgressEvent[EventTarget] | SecurityPolicyViolationEvent */, L /* <: /* keyof K */ String */](x: Self & (DomEventData[V, K, L])) {
      
      inline def setDocument(value: typings.ckeditorCkeditor5Engine.viewDocumentMod.default): Self = StObject.set(x, "document", value.asInstanceOf[js.Any])
      ...
      inline def setTarget(value: typings.ckeditorCkeditor5Engine.viewElementMod.default): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
