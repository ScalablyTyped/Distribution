...
object livepositionMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.ckeditorCkeditor5Engine.selectionMod._Selectable because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/liveposition", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    inline def fromPosition(position: typings.ckeditorCkeditor5Engine.positionMod.default): LivePosition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPosition")(position.asInstanceOf[js.Any]).asInstanceOf[LivePosition]
    inline def fromPosition(position: typings.ckeditorCkeditor5Engine.positionMod.default, stickiness: PositionStickiness): LivePosition = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPosition")(position.asInstanceOf[js.Any], stickiness.asInstanceOf[js.Any])).asInstanceOf[LivePosition]
  }
  ...
  trait LivePosition
    extends typings.ckeditorCkeditor5Engine.positionMod.default {
    ...
    def toPosition(): typings.ckeditorCkeditor5Engine.positionMod.default = js.native
  }
}
