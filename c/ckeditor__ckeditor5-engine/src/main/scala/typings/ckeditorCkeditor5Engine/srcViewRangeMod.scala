...
object srcViewRangeMod {
  ...
  open class default protected ()
    extends StObject
       with Range
       with _Selectable {
    def this(start: typings.ckeditorCkeditor5Engine.srcViewPositionMod.default) = this()
    def this(
  ...
  trait Range
    ...
    def containsPosition(position: typings.ckeditorCkeditor5Engine.srcViewPositionMod.default): Boolean = js.native
    
    def containsRange(otherRange: Range): Boolean = js.native
    def containsRange(otherRange: Range, loose: Boolean): Boolean = js.native
    
    val end: typings.ckeditorCkeditor5Engine.srcViewPositionMod.default = js.native
    
    def getCommonAncestor(): typings.ckeditorCkeditor5Engine.srcViewNodeMod.default | typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default | Null = js.native
    
    def getContainedElement(): typings.ckeditorCkeditor5Engine.srcViewElementMod.default | Null = js.native
    ...
    def getPositions(): js.Iterable[typings.ckeditorCkeditor5Engine.srcViewPositionMod.default] = js.native
    def getPositions(options: StartPosition): js.Iterable[typings.ckeditorCkeditor5Engine.srcViewPositionMod.default] = js.native
    ...
    var root: typings.ckeditorCkeditor5Engine.srcViewElementMod.default | typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default = js.native
    
    val start: typings.ckeditorCkeditor5Engine.srcViewPositionMod.default = js.native
  }
}
