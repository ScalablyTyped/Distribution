...
object textproxyMod {
  ...
  open class default protected ()
    extends StObject
       ...
       with Item
       with _NodeSet {
    def this(text: typings.ckeditorCkeditor5Engine.textMod.default, offsetInText: Double, length: Double) = this()
  }
  ...
  trait TextProxy extends StObject {
    ...
    val root: typings.ckeditorCkeditor5Engine.nodeMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    val startOffset: Double = js.native
    
    val textNode: typings.ckeditorCkeditor5Engine.textMod.default = js.native
  }
}
