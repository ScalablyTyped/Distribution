...
object upcastwriterMod {
  ...
  trait UpcastWriter extends StObject {
    ...
    def appendChild(items: js.Iterable[Item], element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Double = js.native
    def appendChild(items: Item, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Double = js.native
    
    def clone(element: typings.ckeditorCkeditor5Engine.viewElementMod.default): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def clone(element: typings.ckeditorCkeditor5Engine.viewElementMod.default, deep: Boolean): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    
    def createDocumentFragment(): typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
    ...
    def createElement(name: String): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(name: String, attrs: js.Array[js.Tuple2[String, String]]): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(
      name: String,
      attrs: js.Array[js.Tuple2[String, String]],
      children: js.Iterable[typings.ckeditorCkeditor5Engine.viewNodeMod.default]
    ): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(
      name: String,
      attrs: js.Array[js.Tuple2[String, String]],
      children: typings.ckeditorCkeditor5Engine.viewNodeMod.default
    ): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(
      name: String,
      attrs: Unit,
    ...
    def createElement(name: String, attrs: Unit, children: typings.ckeditorCkeditor5Engine.viewNodeMod.default): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(name: String, attrs: Record[String, String]): typings.ckeditorCkeditor5Engine.viewElementMod.default = js.native
    def createElement(
      name: String,
    ...
    def createRange(start: typings.ckeditorCkeditor5Engine.viewPositionMod.default): Range = js.native
    def createRange(
      start: typings.ckeditorCkeditor5Engine.viewPositionMod.default,
      end: typings.ckeditorCkeditor5Engine.viewPositionMod.default
    ): Range = js.native
    
    def createRangeIn(element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Range = js.native
    ...
    def insertChild(index: Double, items: Item, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Double = js.native
    
    def remove(element: typings.ckeditorCkeditor5Engine.viewElementMod.default): js.Array[typings.ckeditorCkeditor5Engine.viewNodeMod.default] = js.native
    
    def removeAttribute(key: String, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Unit = js.native
    
    def removeChildren(index: Double, howMany: Double, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): js.Array[typings.ckeditorCkeditor5Engine.viewNodeMod.default] = js.native
    
    def removeClass(className: String, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Unit = js.native
    def removeClass(className: js.Array[String], element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Unit = js.native
    ...
    def removeStyle(property: js.Array[String], element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Unit = js.native
    
    def rename(newName: String, element: typings.ckeditorCkeditor5Engine.viewElementMod.default): typings.ckeditorCkeditor5Engine.viewElementMod.default | Null = js.native
    
    def replace(
      oldElement: typings.ckeditorCkeditor5Engine.viewElementMod.default,
      newElement: typings.ckeditorCkeditor5Engine.viewElementMod.default
    ): Boolean = js.native
    ...
    def unwrapElement(element: typings.ckeditorCkeditor5Engine.viewElementMod.default): Unit = js.native
  }
}
