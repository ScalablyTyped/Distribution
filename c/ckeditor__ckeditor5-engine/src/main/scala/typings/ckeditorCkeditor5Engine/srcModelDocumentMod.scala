...
import typings.ckeditorCkeditor5Engine.anon.ModelSelection
...
object srcModelDocumentMod {
  ...
  trait Document extends StObject {
    ...
    def createRoot(): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default = js.native
    def createRoot(elementName: String): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default = js.native
    def createRoot(elementName: String, rootName: String): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default = js.native
    def createRoot(elementName: Unit, rootName: String): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default = js.native
    
    def delegate(events: String*): Any = js.native
    
    def destroy(): Unit = js.native
    
    val differ: typings.ckeditorCkeditor5Engine.srcModelDifferMod.default = js.native
    ...
    def getRoot(): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default | Null = js.native
    def getRoot(name: String): typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default | Null = js.native
    
    def getRootNames(): js.Array[String] = js.native
    
    val graveyard: typings.ckeditorCkeditor5Engine.srcModelRootelementMod.default = js.native
    ...
    def registerPostFixer(
      postFixer: js.Function1[/* writer */ typings.ckeditorCkeditor5Engine.srcModelWriterMod.default, Unit]
    ): Unit = js.native
    ...
    val selection: typings.ckeditorCkeditor5Engine.srcModelDocumentselectionMod.default = js.native
    ...
    def toJSON(): (Omit[
        this.type, 
        typings.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.selection | typings.ckeditorCkeditor5Engine.ckeditorCkeditor5EngineStrings.model
