...
object srcModelTreewalkerMod {
  ...
  trait TreeWalker
    ...
    /**
      ...
      */
    val boundaries: typings.ckeditorCkeditor5Engine.srcModelRangeMod.default | Null = js.native
    ...
    /**
      ...
      */
    val position: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
  ...
  */
  ...
  object TreeWalkerOptions {
    ...
    inline def IgnoreElementEnd(boundaries: typings.ckeditorCkeditor5Engine.srcModelRangeMod.default): typings.ckeditorCkeditor5Engine.anon.IgnoreElementEnd = {
    ...
    inline def Shallow(startPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): typings.ckeditorCkeditor5Engine.anon.Shallow = {
  ...
  */
  ...
  object TreeWalkerValue {
    ...
    inline def NextPosition(
      item: typings.ckeditorCkeditor5Engine.srcModelTextproxyMod.default,
      length: Double,
    ...
    inline def PreviousPosition(
      item: typings.ckeditorCkeditor5Engine.srcModelElementMod.default,
      length: Double,
      nextPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default,
      previousPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default,
