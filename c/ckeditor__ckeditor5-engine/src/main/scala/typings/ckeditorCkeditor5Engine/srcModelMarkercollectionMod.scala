...
object srcModelMarkercollectionMod {
  
  @JSImport("@ckeditor/ckeditor5-engine/src/model/markercollection", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter * / any */ @JSImport("@ckeditor/ckeditor5-engine/src/model/markercollection", "Marker")
  @js.native
  open class Marker protected () extends StObject {
    def this(
      name: String,
      liveRange: typings.ckeditorCkeditor5Engine.srcModelLiverangeMod.default,
  ...
  trait MarkerCollection
    extends StObject
       with Iterable[Marker] {
    ...
    def get(markerName: String): Marker | Null = js.native
    
    def getMarkersAtPosition(position: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): Generator[Marker, Any, Any] = js.native
    
    def getMarkersGroup(prefix: String): Generator[Marker, Any, Any] = js.native
    
    def getMarkersIntersectingRange(range: typings.ckeditorCkeditor5Engine.srcModelRangeMod.default): Generator[Marker, Any, Any] = js.native
    
    def has(markerName: String): Boolean = js.native
    def has(markerName: Marker): Boolean = js.native
