...
object moveoperationMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getMovedRangeStart(): typings.ckeditorCkeditor5Engine.positionMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: SourcePosition, document: typings.ckeditorCkeditor5Engine.documentMod.default): MoveOperation = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[MoveOperation]
  }
  ...
  trait MoveOperation
    ...
    /**
      ...
      *         offset 6  offset 4
      */
    def getMovedRangeStart(): typings.ckeditorCkeditor5Engine.positionMod.default
  ...
  object MoveOperation {
    ...
    inline def apply(
      ...
      getMovedRangeStart: () => typings.ckeditorCkeditor5Engine.positionMod.default,
    ...
    extension [Self <: MoveOperation](x: Self) {
      ...
      inline def setGetMovedRangeStart(value: () => typings.ckeditorCkeditor5Engine.positionMod.default): Self = StObject.set(x, "getMovedRangeStart", js.Any.fromFunction0(value))
