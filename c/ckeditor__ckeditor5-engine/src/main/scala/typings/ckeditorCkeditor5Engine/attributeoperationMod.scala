...
object attributeoperationMod {
  ...
  open class default[O /* <: js.UndefOr[String | Double | Boolean] */, N /* <: js.UndefOr[String | Double | Boolean] */] protected ()
    ...
    /**
      ...
      */
    def this(range: typings.ckeditorCkeditor5Engine.rangeMod.default, key: String, oldValue: O, newValue: N) = this()
    def this(
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val newValue: N | Null = js.native
    
    /**
      * Old value of the attribute with given key or `null`, if attribute was not set before.
      */
    /* CompleteClass */
    override val oldValue: O | Null = js.native
    
    /**
      * Range on which operation should be applied.
      */
    /* CompleteClass */
    override val range: typings.ckeditorCkeditor5Engine.rangeMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: NewValue, document: typings.ckeditorCkeditor5Engine.documentMod.default): AttributeOperation[Any, Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[AttributeOperation[Any, Any]]
  }
  ...
  trait AttributeOperation[O /* <: js.UndefOr[String | Double | Boolean] */, N /* <: js.UndefOr[String | Double | Boolean] */]
    ...
    /**
      * Range on which operation should be applied.
      */
    val range: typings.ckeditorCkeditor5Engine.rangeMod.default
  ...
  object AttributeOperation {
    ...
    inline def apply[O /* <: js.UndefOr[String | Double | Boolean] */, N /* <: js.UndefOr[String | Double | Boolean] */](
      ...
      val __obj = js.Dynamic.literal(getReversed = js.Any.fromFunction0(getReversed), isDocumentOperation = isDocumentOperation.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], range = range.asInstanceOf[js.Any], toJSON = js.Any.fromFunction0(toJSON), baseVersion = null, batch = null, newValue = null, oldValue = null)
