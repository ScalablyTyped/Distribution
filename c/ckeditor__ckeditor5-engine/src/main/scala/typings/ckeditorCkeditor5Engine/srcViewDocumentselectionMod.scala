...
object srcViewDocumentselectionMod {
  ...
  trait DocumentSelection extends StObject {
    ...
    def isEqual(otherSelection: typings.ckeditorCkeditor5Engine.srcViewSelectionMod.default): Boolean = js.native
    
    val isFake: Boolean = js.native
    
    def isSimilar(otherSelection: DocumentSelection): Boolean = js.native
    def isSimilar(otherSelection: typings.ckeditorCkeditor5Engine.srcViewSelectionMod.default): Boolean = js.native
