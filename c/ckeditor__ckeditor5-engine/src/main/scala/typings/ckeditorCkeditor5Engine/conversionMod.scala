...
object conversionMod {
  ...
  open class default protected ()
    extends StObject
       with Conversion {
    def this(
      downcastDispatchers: js.Array[typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object]],
      upcastDispatchers: js.Array[typings.ckeditorCkeditor5Engine.upcastdispatcherMod.default]
    ) = this()
    def this(
      downcastDispatchers: js.Array[typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object]],
      upcastDispatchers: typings.ckeditorCkeditor5Engine.upcastdispatcherMod.default
    ) = this()
    def this(
      downcastDispatchers: typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object],
      upcastDispatchers: js.Array[typings.ckeditorCkeditor5Engine.upcastdispatcherMod.default]
    ) = this()
    def this(
      downcastDispatchers: typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object],
  ...
  trait Conversion extends StObject {
    ...
    def addAlias(
      alias: String,
      dispatcher: typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object]
    ): Unit = js.native
    def addAlias(alias: String, dispatcher: typings.ckeditorCkeditor5Engine.upcastdispatcherMod.default): Unit = js.native
    ...
    def `for`(groupName: upcast | downcast | dataDowncast | editingDowncast): typings.ckeditorCkeditor5Engine.upcasthelpersMod.default | typings.ckeditorCkeditor5Engine.downcasthelpersMod.default = js.native
    @JSName("for")
    def for_default(groupName: dataDowncast | editingDowncast | downcast): typings.ckeditorCkeditor5Engine.downcasthelpersMod.default = js.native
    @JSName("for")
    def for_upcast(groupName: upcast): typings.ckeditorCkeditor5Engine.upcasthelpersMod.default = js.native
  }
  ...
  object ConverterDefinition {
    ...
    extension [Self <: ConverterDefinition](x: Self) {
      ...
      inline def setUpcastAlsoFunction1(
        value: /* element */ typings.ckeditorCkeditor5Engine.viewElementMod.default => Unit | Null | Attribute
