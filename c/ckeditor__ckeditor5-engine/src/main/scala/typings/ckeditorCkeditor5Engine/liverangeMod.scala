...
object liverangeMod {
  ...
  - typings.ckeditorCkeditor5Engine.selectionMod._Selectable because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/liverange", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    inline def fromRange(range: typings.ckeditorCkeditor5Engine.rangeMod.default): LiveRange = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRange")(range.asInstanceOf[js.Any]).asInstanceOf[LiveRange]
  }
  ...
  trait LiveRange
    ...
    def toRange(): typings.ckeditorCkeditor5Engine.rangeMod.default = js.native
  }
}
