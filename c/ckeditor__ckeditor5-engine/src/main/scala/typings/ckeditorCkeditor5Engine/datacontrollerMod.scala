...
object datacontrollerMod {
  ...
  trait DataController extends StObject {
    ...
    /**
      ...
      */
    val downcastDispatcher: typings.ckeditorCkeditor5Engine.downcastdispatcherMod.default[js.Object] = js.native
    ...
    /**
      ...
      */
    val htmlProcessor: typings.ckeditorCkeditor5Engine.htmldataprocessorMod.default = js.native
    ...
    /**
      ...
      */
    val mapper: typings.ckeditorCkeditor5Engine.mapperMod.default = js.native
    ...
    /**
      ...
      */
    def parse(data: String): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    def parse(data: String, context: SchemaContextDefinition): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    /**
      * Data processor used during the conversion.
      * Same instance as {@link #htmlProcessor} by default. Can be replaced at run time to handle different format, e.g. XML or Markdown.
      */
    var processor: typings.ckeditorCkeditor5Engine.htmldataprocessorMod.default = js.native
    ...
    def stringify(modelElementOrFragment: typings.ckeditorCkeditor5Engine.documentfragmentMod.default): String = js.native
    def stringify(
      modelElementOrFragment: typings.ckeditorCkeditor5Engine.documentfragmentMod.default,
    ...
    /**
      ...
      */
    def stringify(modelElementOrFragment: typings.ckeditorCkeditor5Engine.elementMod.default): String = js.native
    def stringify(
      modelElementOrFragment: typings.ckeditorCkeditor5Engine.elementMod.default,
      options: Record[String, Any]
    ): String = js.native
    ...
    def toModel(viewElementOrFragment: typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    def toModel(
      viewElementOrFragment: typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default,
      context: SchemaContextDefinition
    ): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    /**
      ...
      */
    def toModel(viewElementOrFragment: typings.ckeditorCkeditor5Engine.viewElementMod.default): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    def toModel(
      viewElementOrFragment: typings.ckeditorCkeditor5Engine.viewElementMod.default,
      context: SchemaContextDefinition
    ): typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    def toView(modelElementOrFragment: typings.ckeditorCkeditor5Engine.documentfragmentMod.default): typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
    def toView(
      modelElementOrFragment: typings.ckeditorCkeditor5Engine.documentfragmentMod.default,
      options: Record[String, Any]
    ...
    /**
      ...
      */
    def toView(modelElementOrFragment: typings.ckeditorCkeditor5Engine.elementMod.default): typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
    def toView(
      modelElementOrFragment: typings.ckeditorCkeditor5Engine.elementMod.default,
      options: Record[String, Any]
    ): typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
    ...
    /**
      ...
      */
    val upcastDispatcher: typings.ckeditorCkeditor5Engine.upcastdispatcherMod.default = js.native
    
    /**
      * The view document used by the data controller.
      */
    val viewDocument: typings.ckeditorCkeditor5Engine.viewDocumentMod.default = js.native
  }
}
