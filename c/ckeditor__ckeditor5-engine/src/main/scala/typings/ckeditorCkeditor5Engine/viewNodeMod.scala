...
object viewNodeMod {
  ...
  @JSImport("@ckeditor/ckeditor5-engine/src/view/node", JSImport.Default)
  @js.native
  ...
  trait Node extends StObject {
    ...
    def getCommonAncestor(node: Node): typings.ckeditorCkeditor5Engine.viewElementMod.default | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default | Null = js.native
    def getCommonAncestor(node: Node, options: IncludeSelf): typings.ckeditorCkeditor5Engine.viewElementMod.default | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default | Null = js.native
    ...
    val root: Node | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
