...
object detachoperationMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    def this(sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default, howMany: Double) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
  ...
  trait DetachOperation
    ...
    /**
      * Position before the first {@link module:engine/model/item~Item model item} to detach.
      */
    val sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default
  ...
  object DetachOperation {
    ...
    inline def apply(
      ...
      sourcePosition: typings.ckeditorCkeditor5Engine.positionMod.default,
      toJSON: () => `12`
    ): DetachOperation = {
    ...
    extension [Self <: DetachOperation](x: Self) {
      ...
      inline def setSourcePosition(value: typings.ckeditorCkeditor5Engine.positionMod.default): Self = StObject.set(x, "sourcePosition", value.asInstanceOf[js.Any])
