...
object srcModelOperationOperationMod {
  ...
  trait Operation extends StObject {
    ...
    /**
      ...
      * added to any batch yet.
      */
    var batch: typings.ckeditorCkeditor5Engine.srcModelBatchMod.default | Null
  ...
  object Operation {
    ...
    extension [Self <: Operation](x: Self) {
      ...
      inline def setBatch(value: typings.ckeditorCkeditor5Engine.srcModelBatchMod.default): Self = StObject.set(x, "batch", value.asInstanceOf[js.Any])
