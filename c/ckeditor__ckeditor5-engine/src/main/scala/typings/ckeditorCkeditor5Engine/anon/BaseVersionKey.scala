...
trait BaseVersionKey extends StObject {
...
object BaseVersionKey {
  
  inline def apply(key: String, newValue: Any, oldValue: Any, root: String): BaseVersionKey = {
    ...
    __obj.asInstanceOf[BaseVersionKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BaseVersionKey] (val x: Self) extends AnyVal {
