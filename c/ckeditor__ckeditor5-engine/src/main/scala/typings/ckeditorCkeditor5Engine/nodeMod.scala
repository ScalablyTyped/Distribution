...
import typings.ckeditorCkeditor5Engine.selectionMod._Selectable
...
object nodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ckeditorCkeditor5Engine.nodeMod.Node
    - typings.ckeditorCkeditor5Engine.textproxyMod.default
    - java.lang.String
    - typings.ckeditorCkeditor5Engine.nodelistMod.default
    - typings.ckeditorCkeditor5Engine.documentfragmentMod.default
