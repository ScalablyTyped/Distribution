...
object markercollectionMod {
  ...
  open class Marker protected () extends StObject {
    def this(
      name: String,
      liveRange: typings.ckeditorCkeditor5Engine.liverangeMod.default,
    ...
    def getEnd(): typings.ckeditorCkeditor5Engine.positionMod.default = js.native
    
    def getRange(): typings.ckeditorCkeditor5Engine.rangeMod.default = js.native
    
    def getStart(): typings.ckeditorCkeditor5Engine.positionMod.default = js.native
  ...
  trait MarkerCollection
    ...
    def getMarkersAtPosition(position: typings.ckeditorCkeditor5Engine.positionMod.default): Generator[Marker, Any, Any] = js.native
    
    def getMarkersGroup(prefix: String): Generator[Marker, Any, Any] = js.native
    
    def getMarkersIntersectingRange(range: typings.ckeditorCkeditor5Engine.rangeMod.default): Generator[Marker, Any, Any] = js.native
