...
object elementMod {
  ...
  - typings.ckeditorCkeditor5Engine.itemMod.Item because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/model/element", JSImport.Default)
  @js.native
  open class default protected () extends Element {
    ...
    def this(
      ...
      children: js.Iterable[typings.ckeditorCkeditor5Engine.nodeMod.default]
    ) = this()
    def this(
      name: String,
      attrs: js.Tuple2[String, String],
      children: typings.ckeditorCkeditor5Engine.nodeMod.default
    ) = this()
    def this(name: String, attrs: Unit, children: js.Iterable[typings.ckeditorCkeditor5Engine.nodeMod.default]) = this()
    def this(name: String, attrs: Unit, children: typings.ckeditorCkeditor5Engine.nodeMod.default) = this()
    def this(
      name: String,
  ...
  trait Element
    ...
    def getChild(index: Double): Element | typings.ckeditorCkeditor5Engine.textMod.default = js.native
    
    def getChildIndex(node: typings.ckeditorCkeditor5Engine.nodeMod.default): Double = js.native
    
    def getChildStartOffset(node: typings.ckeditorCkeditor5Engine.nodeMod.default): Double = js.native
    
    def getChildren(): IterableIterator[Element | typings.ckeditorCkeditor5Engine.textMod.default] = js.native
    
    def getNodeByPath(relativePath: js.Array[Double]): Element | typings.ckeditorCkeditor5Engine.textMod.default = js.native
