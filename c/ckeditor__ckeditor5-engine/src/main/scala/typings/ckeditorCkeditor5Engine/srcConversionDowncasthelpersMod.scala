...
import typings.ckeditorCkeditor5Engine.srcConversionDowncastdispatcherMod.DowncastDispatcherCallback
...
object srcConversionDowncasthelpersMod {
  ...
  ): typings.ckeditorCkeditor5Engine.srcViewAttributeelementMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("createViewElementFromHighlightDescriptor")(writer.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[typings.ckeditorCkeditor5Engine.srcViewAttributeelementMod.default]
  
  inline def insertElement(
    elementCreator: js.Function2[
      /* modelItem */ typings.ckeditorCkeditor5Engine.srcModelElementMod.default, 
      /* conversionApi */ DowncastConversionApi[Any], 
      typings.ckeditorCkeditor5Engine.srcViewElementMod.default | Unit | Null
    ]
  ...
  inline def insertUIElement(
    elementOrElementCreator: js.Function2[
      ...
      /* conversionApi */ DowncastConversionApi[Any], 
      typings.ckeditorCkeditor5Engine.srcViewUielementMod.default | Unit | Null
    ]
  ): DowncastDispatcherCallback[
  ...
  inline def insertUIElement(elementOrElementCreator: typings.ckeditorCkeditor5Engine.srcViewUielementMod.default): DowncastDispatcherCallback[
    addMarker | (/* template literal string: addMarker:${string} */ String), 
    js.Object, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter */ Any
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("insertUIElement")(elementOrElementCreator.asInstanceOf[js.Any]).asInstanceOf[DowncastDispatcherCallback[
  ...
  trait DowncastHelpers
    extends typings.ckeditorCkeditor5Engine.srcConversionConversionhelpersMod.default[DowncastHelpers] {
