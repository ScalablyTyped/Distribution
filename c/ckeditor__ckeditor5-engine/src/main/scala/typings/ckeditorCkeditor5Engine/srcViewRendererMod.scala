...
object srcViewRendererMod {
  ...
  trait Renderer extends StObject {
    ...
    /**
      ...
      * @see #markedTexts
      */
    def markToSync(`type`: ChangeType, node: typings.ckeditorCkeditor5Engine.srcViewNodeMod.default): Unit = js.native
    
    val markedAttributes: Set[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] = js.native
    
    val markedChildren: Set[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] = js.native
    
    val markedTexts: Set[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] = js.native
