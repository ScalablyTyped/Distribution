...
import typings.ckeditorCkeditor5Engine.schemaMod._SchemaContextDefinition
...
object positionMod {
  ...
  open class default protected ()
    extends StObject
       ...
       with _Selectable {
    def this(root: typings.ckeditorCkeditor5Engine.documentfragmentMod.default, path: js.Array[Double]) = this()
    def this(root: typings.ckeditorCkeditor5Engine.elementMod.default, path: js.Array[Double]) = this()
    def this(
  ...
  inline def getNodeAfterPosition(position: Position, positionParent: typings.ckeditorCkeditor5Engine.documentfragmentMod.default): typings.ckeditorCkeditor5Engine.nodeMod.default | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getNodeAfterPosition")(position.asInstanceOf[js.Any], positionParent.asInstanceOf[js.Any])).asInstanceOf[typings.ckeditorCkeditor5Engine.nodeMod.default | Null]
  inline def getNodeAfterPosition(
    position: Position,
    positionParent: typings.ckeditorCkeditor5Engine.documentfragmentMod.default,
    textNode: typings.ckeditorCkeditor5Engine.textMod.default
  ): typings.ckeditorCkeditor5Engine.nodeMod.default | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getNodeAfterPosition")(position.asInstanceOf[js.Any], positionParent.asInstanceOf[js.Any], textNode.asInstanceOf[js.Any])).asInstanceOf[typings.ckeditorCkeditor5Engine.nodeMod.default | Null]
  inline def getNodeAfterPosition(position: Position, positionParent: typings.ckeditorCkeditor5Engine.elementMod.default): typings.ckeditorCkeditor5Engine.nodeMod.default | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getNodeAfterPosition")(position.asInstanceOf[js.Any], positionParent.asInstanceOf[js.Any])).asInstanceOf[typings.ckeditorCkeditor5Engine.nodeMod.default | Null]
  inline def getNodeAfterPosition(
    position: Position,
    positionParent: typings.ckeditorCkeditor5Engine.elementMod.default,
    textNode: typings.ckeditorCkeditor5Engine.textMod.default
  ): typings.ckeditorCkeditor5Engine.nodeMod.default | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getNodeAfterPosition")(position.asInstanceOf[js.Any], positionParent.asInstanceOf[js.Any], textNode.asInstanceOf[js.Any])).asInstanceOf[typings.ckeditorCkeditor5Engine.nodeMod.default | Null]
  ...
  trait Position extends StObject {
    ...
    def findAncestor(parentName: String): typings.ckeditorCkeditor5Engine.elementMod.default | Null = js.native
    
    def getAncestors(): js.Array[Item] = js.native
    
    def getCommonAncestor(position: Position): typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default | Null = js.native
    ...
    val nodeAfter: typings.ckeditorCkeditor5Engine.nodeMod.default | Null = js.native
    
    val nodeBefore: typings.ckeditorCkeditor5Engine.nodeMod.default | Null = js.native
    
    var offset: Double = js.native
    
    val parent: typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    val path: js.Array[Double] = js.native
    
    val root: typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    var stickiness: PositionStickiness = js.native
    
    val textNode: typings.ckeditorCkeditor5Engine.textMod.default | Null = js.native
