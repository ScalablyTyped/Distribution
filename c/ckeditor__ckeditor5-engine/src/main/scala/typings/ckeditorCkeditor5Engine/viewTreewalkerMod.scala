...
object viewTreewalkerMod {
  ...
  trait TreeWalker
    ...
    val boundaries: typings.ckeditorCkeditor5Engine.viewRangeMod.default = js.native
    ...
    val position: typings.ckeditorCkeditor5Engine.viewPositionMod.default = js.native
  ...
  */
  ...
  object TreeWalkerValue {
    ...
    inline def ItemLength(
      item: typings.ckeditorCkeditor5Engine.viewTextproxyMod.default,
      length: Double,
    ...
    inline def LengthNextPosition(
      item: typings.ckeditorCkeditor5Engine.viewElementMod.default,
      length: Double,
      nextPosition: typings.ckeditorCkeditor5Engine.viewPositionMod.default,
      previousPosition: typings.ckeditorCkeditor5Engine.viewPositionMod.default,
