...
object srcViewDocumentfragmentMod {
  ...
  trait DocumentFragment
    extends StObject
       with Iterable[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] {
    ...
    def _removeChildren(index: Double): js.Array[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] = js.native
    def _removeChildren(index: Double, howMany: Double): js.Array[typings.ckeditorCkeditor5Engine.srcViewNodeMod.default] = js.native
