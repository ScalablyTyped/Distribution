...
object documentfragmentMod {
  ...
  trait DocumentFragment
    extends StObject
       with Iterable[
          typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.textMod.default
        ] {
    
    val childCount: Double = js.native
    
    def getChild(index: Double): typings.ckeditorCkeditor5Engine.nodeMod.default | Null = js.native
    
    def getChildIndex(node: typings.ckeditorCkeditor5Engine.nodeMod.default): Double | Null = js.native
    
    def getChildStartOffset(node: typings.ckeditorCkeditor5Engine.nodeMod.default): Double | Null = js.native
    
    def getChildren(): IterableIterator[
        typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.textMod.default
      ] = js.native
    
    def getNodeByPath(relativePath: js.Array[Double]): typings.ckeditorCkeditor5Engine.nodeMod.default | DocumentFragment = js.native
    ...
    val markers: Map[String, typings.ckeditorCkeditor5Engine.rangeMod.default] = js.native
