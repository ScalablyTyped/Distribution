...
object rootattributeoperationMod {
  ...
  open class default[O, N] protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val root: typings.ckeditorCkeditor5Engine.rootelementMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: BaseVersionKey, document: typings.ckeditorCkeditor5Engine.documentMod.default): RootAttributeOperation[Any, Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[RootAttributeOperation[Any, Any]]
  }
  ...
  trait RootAttributeOperation[O, N]
    ...
    /**
      * Root element to change.
      */
    val root: typings.ckeditorCkeditor5Engine.rootelementMod.default
  ...
  object RootAttributeOperation {
    ...
    extension [Self <: RootAttributeOperation[?, ?], O, N](x: Self & (RootAttributeOperation[O, N])) {
      ...
      inline def setRoot(value: typings.ckeditorCkeditor5Engine.rootelementMod.default): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
