...
object viewElementMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.ckeditorCkeditor5Engine.viewSelectionMod._Selectable because Already inherited
  - typings.ckeditorCkeditor5Engine.viewItemMod.Item because Already inherited */ @JSImport("@ckeditor/ckeditor5-engine/src/view/element", JSImport.Default)
  @js.native
  ...
  trait Element
    ...
    def getChild(index: Double): typings.ckeditorCkeditor5Engine.viewNodeMod.default = js.native
    
    def getChildIndex(node: typings.ckeditorCkeditor5Engine.viewNodeMod.default): Double = js.native
    
    def getChildren(): IterableIterator[typings.ckeditorCkeditor5Engine.viewNodeMod.default] = js.native
