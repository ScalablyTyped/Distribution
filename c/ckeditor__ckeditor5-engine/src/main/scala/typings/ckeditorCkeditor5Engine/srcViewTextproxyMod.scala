...
object srcViewTextproxyMod {
  ...
  open class default protected ()
    extends StObject
       ...
       with Item {
    def this(
      textNode: typings.ckeditorCkeditor5Engine.srcViewTextMod.default,
      offsetInText: Double,
      length: Double
    ) = this()
  }
  ...
  trait TextProxy extends StObject {
    ...
    val document: typings.ckeditorCkeditor5Engine.srcViewDocumentMod.default | Null = js.native
    ...
    val textNode: typings.ckeditorCkeditor5Engine.srcViewTextMod.default = js.native
  }
}
