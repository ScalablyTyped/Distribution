...
object viewPositionMod {
  ...
  open class default protected ()
    extends StObject
       with Position
       with _Selectable {
    def this(parent: typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default, offset: js.Array[Double]) = this()
    def this(parent: typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default, offset: Double) = this()
    def this(parent: typings.ckeditorCkeditor5Engine.viewNodeMod.default, offset: js.Array[Double]) = this()
    def this(parent: typings.ckeditorCkeditor5Engine.viewNodeMod.default, offset: Double) = this()
  }
  ...
  trait Position extends StObject {
    ...
    var editableElement: typings.ckeditorCkeditor5Engine.editableelementMod.default | Null = js.native
    
    def getAncestors(): js.Array[
        typings.ckeditorCkeditor5Engine.viewNodeMod.default | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default
      ] = js.native
    
    def getCommonAncestor(position: Position): typings.ckeditorCkeditor5Engine.viewNodeMod.default | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default | Null = js.native
    ...
    def getWalker(): typings.ckeditorCkeditor5Engine.viewTreewalkerMod.default = js.native
    def getWalker(options: BoundariesIgnoreElementEnd): typings.ckeditorCkeditor5Engine.viewTreewalkerMod.default = js.native
    ...
    val nodeAfter: typings.ckeditorCkeditor5Engine.viewNodeMod.default | Null = js.native
    
    val nodeBefore: typings.ckeditorCkeditor5Engine.viewNodeMod.default | Null = js.native
    
    val offset: Double = js.native
    
    val parent: typings.ckeditorCkeditor5Engine.viewNodeMod.default | typings.ckeditorCkeditor5Engine.viewDocumentfragmentMod.default = js.native
