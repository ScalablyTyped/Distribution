...
import typings.ckeditorCkeditor5Engine.srcViewObserverBubblingemittermixinMod.BubblingEmitter
  ...
  */
  ...
  trait Document
    ...
    /**
      ...
      */
    def getRoot(): typings.ckeditorCkeditor5Engine.srcViewRooteditableelementMod.default | Null = js.native
    def getRoot(name: String): typings.ckeditorCkeditor5Engine.srcViewRooteditableelementMod.default | Null = js.native
    ...
    def registerPostFixer(
      postFixer: js.Function1[
          /* writer */ typings.ckeditorCkeditor5Engine.srcViewDowncastwriterMod.default[default], 
          Boolean | Unit
        ]
    ): Unit = js.native
