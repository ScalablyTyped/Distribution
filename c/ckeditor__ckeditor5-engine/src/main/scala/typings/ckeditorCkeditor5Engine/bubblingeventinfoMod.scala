...
object bubblingeventinfoMod {
  ...
  open class default[S /* <: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter */ Any) | Node | Window */] protected ()
    ...
    def this(source: S, name: String, startRange: typings.ckeditorCkeditor5Engine.viewRangeMod.default) = this()
    
    /**
      * The current bubbling target.
      */
    /* CompleteClass */
    override val currentTarget: typings.ckeditorCkeditor5Engine.viewDocumentMod.default | typings.ckeditorCkeditor5Engine.viewNodeMod.default | Null = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val startRange: typings.ckeditorCkeditor5Engine.viewRangeMod.default = js.native
  }
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify EventInfo * / any */ trait BubblingEventInfo[S /* <: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter */ Any) | Node | Window */] extends StObject {
    ...
    /**
      * The current bubbling target.
      */
    val currentTarget: typings.ckeditorCkeditor5Engine.viewDocumentMod.default | typings.ckeditorCkeditor5Engine.viewNodeMod.default | Null
    ...
    /**
      * The view range that the bubbling should start from.
      */
    val startRange: typings.ckeditorCkeditor5Engine.viewRangeMod.default
  }
  object BubblingEventInfo {
    ...
    inline def apply[S /* <: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter */ Any) | Node | Window */](
      ...
      startRange: typings.ckeditorCkeditor5Engine.viewRangeMod.default
    ): BubblingEventInfo[S] = {
    ...
    extension [Self <: BubblingEventInfo[?], S /* <: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Emitter */ Any) | Node | Window */](x: Self & BubblingEventInfo[S]) {
      ...
      inline def setCurrentTarget(
        value: typings.ckeditorCkeditor5Engine.viewDocumentMod.default | typings.ckeditorCkeditor5Engine.viewNodeMod.default
      ...
      inline def setStartRange(value: typings.ckeditorCkeditor5Engine.viewRangeMod.default): Self = StObject.set(x, "startRange", value.asInstanceOf[js.Any])
    }
  }
}
