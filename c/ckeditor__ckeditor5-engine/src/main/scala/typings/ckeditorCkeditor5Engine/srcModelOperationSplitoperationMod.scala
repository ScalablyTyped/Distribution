...
object srcModelOperationSplitoperationMod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      howMany: Double,
      insertionPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default,
    ...
    /* CompleteClass */
    @JSName("getReversed")
    override def getReversed_MSplitOperation(): typings.ckeditorCkeditor5Engine.srcModelOperationMergeoperationMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var graveyardPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default | Null = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val insertionPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val moveTargetPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var splitPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default = js.native
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: InsertionPosition, document: typings.ckeditorCkeditor5Engine.srcModelDocumentMod.default): SplitOperation = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[SplitOperation]
    
    /**
      * Helper function that returns a default insertion position basing on given `splitPosition`. The default insertion
      * position is after the split element.
      */
    inline def getInsertionPosition(splitPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): typings.ckeditorCkeditor5Engine.srcModelPositionMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("getInsertionPosition")(splitPosition.asInstanceOf[js.Any]).asInstanceOf[typings.ckeditorCkeditor5Engine.srcModelPositionMod.default]
  }
  ...
  trait SplitOperation
    ...
    /**
      ...
      */
    @JSName("getReversed")
    def getReversed_MSplitOperation(): typings.ckeditorCkeditor5Engine.srcModelOperationMergeoperationMod.default
    ...
    /**
      ...
      * The default behavior is to clone the split element. Element from graveyard is used during undo.
      */
    var graveyardPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default | Null
    ...
    /**
      * Position at which the clone of split element (or element from graveyard) will be inserted.
      */
    val insertionPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default
    ...
    /**
      ...
      * This is a position where nodes that are after the split position will be moved to.
      */
    val moveTargetPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default
    ...
    /**
      * Position at which an element should be split.
      */
    var splitPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default
  ...
  object SplitOperation {
    ...
    inline def apply(
      ...
      getReversed: () => typings.ckeditorCkeditor5Engine.srcModelOperationMergeoperationMod.default,
      howMany: Double,
      insertionPosition: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default,
    ...
    extension [Self <: SplitOperation](x: Self) {
      ...
      inline def setGetReversed(value: () => typings.ckeditorCkeditor5Engine.srcModelOperationMergeoperationMod.default): Self = StObject.set(x, "getReversed", js.Any.fromFunction0(value))
      ...
      inline def setInsertionPosition(value: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): Self = StObject.set(x, "insertionPosition", value.asInstanceOf[js.Any])
      
      inline def setMoveTargetPosition(value: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): Self = StObject.set(x, "moveTargetPosition", value.asInstanceOf[js.Any])
      ...
      inline def setSplitPosition(value: typings.ckeditorCkeditor5Engine.srcModelPositionMod.default): Self = StObject.set(x, "splitPosition", value.asInstanceOf[js.Any])
