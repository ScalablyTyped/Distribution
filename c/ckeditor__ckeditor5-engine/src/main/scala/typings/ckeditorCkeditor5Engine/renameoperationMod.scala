...
object renameoperationMod {
  ...
  open class default protected ()
    ...
    /**
      ...
      */
    def this(position: typings.ckeditorCkeditor5Engine.positionMod.default, oldName: String, newName: String) = this()
    def this(
  ...
  object default {
    ...
    /**
      ...
      */
    inline def fromJSON(json: NewName, document: typings.ckeditorCkeditor5Engine.documentMod.default): RenameOperation = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any], document.asInstanceOf[js.Any])).asInstanceOf[RenameOperation]
  }
