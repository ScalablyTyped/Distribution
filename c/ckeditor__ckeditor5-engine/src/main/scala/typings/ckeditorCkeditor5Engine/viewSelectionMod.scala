...
object viewSelectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.ckeditorCkeditor5Engine.viewSelectionMod.Selection
    - typings.ckeditorCkeditor5Engine.viewDocumentselectionMod.default
    - typings.ckeditorCkeditor5Engine.viewPositionMod.default
    - js.Iterable[typings.ckeditorCkeditor5Engine.viewRangeMod.default]
    - typings.ckeditorCkeditor5Engine.viewRangeMod.default
    - typings.ckeditorCkeditor5Engine.viewItemMod.Item
  */
  type Selectable = _Selectable | js.Iterable[typings.ckeditorCkeditor5Engine.viewRangeMod.default]
  ...
  trait Selection
    ...
    def setFocus(itemOrPosition: typings.ckeditorCkeditor5Engine.viewPositionMod.default): Unit = js.native
