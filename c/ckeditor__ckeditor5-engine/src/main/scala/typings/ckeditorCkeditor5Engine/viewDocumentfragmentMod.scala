...
object viewDocumentfragmentMod {
  ...
  trait DocumentFragment
    extends StObject
       with Iterable[typings.ckeditorCkeditor5Engine.viewNodeMod.default] {
    ...
    def _removeChildren(index: Double): js.Array[typings.ckeditorCkeditor5Engine.viewNodeMod.default] = js.native
    def _removeChildren(index: Double, howMany: Double): js.Array[typings.ckeditorCkeditor5Engine.viewNodeMod.default] = js.native
