...
object rangeMod {
  ...
  open class default protected ()
    extends StObject
       with Range
       with _Selectable {
    def this(start: typings.ckeditorCkeditor5Engine.positionMod.default) = this()
    def this(
  ...
  trait Range
    ...
    def containsPosition(position: typings.ckeditorCkeditor5Engine.positionMod.default): Boolean = js.native
    
    def containsRange(otherRange: Range): Boolean = js.native
    def containsRange(otherRange: Range, loose: Boolean): Boolean = js.native
    
    val end: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
    
    def getCommonAncestor(): typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default | Null = js.native
    
    def getContainedElement(): typings.ckeditorCkeditor5Engine.elementMod.default | Null = js.native
    ...
    def getPositions(): Generator[typings.ckeditorCkeditor5Engine.positionMod.default, Any, Any] = js.native
    def getPositions(options: RangeTreeWalkerOptions): Generator[typings.ckeditorCkeditor5Engine.positionMod.default, Any, Any] = js.native
    ...
    def getWalker(): typings.ckeditorCkeditor5Engine.treewalkerMod.default = js.native
    def getWalker(options: RangeTreeWalkerOptions): typings.ckeditorCkeditor5Engine.treewalkerMod.default = js.native
    ...
    var root: typings.ckeditorCkeditor5Engine.elementMod.default | typings.ckeditorCkeditor5Engine.documentfragmentMod.default = js.native
    
    val start: typings.ckeditorCkeditor5Engine.positionMod.default = js.native
