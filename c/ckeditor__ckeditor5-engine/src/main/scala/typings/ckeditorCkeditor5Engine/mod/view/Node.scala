...
import typings.ckeditorCkeditor5Engine.AnonIncludeSelfBooleanOptional
import typings.ckeditorCkeditor5Engine.AnonIncludeSelfParentFirstBoolean
...
class Node () extends Item {
  ...
  def getAncestors(options: AnonIncludeSelfParentFirstBoolean): js.Array[Element | DocumentFragment] = js.native
  def getCommonAncestor(node: Node, options: AnonIncludeSelfBooleanOptional): Element | DocumentFragment | Null = js.native
