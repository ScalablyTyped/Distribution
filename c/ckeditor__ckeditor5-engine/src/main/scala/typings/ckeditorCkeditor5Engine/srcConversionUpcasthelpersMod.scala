...
import typings.ckeditorCkeditor5Engine.srcConversionUpcastdispatcherMod.UpcastDispatcherCallback
...
object srcConversionUpcasthelpersMod {
  ...
  @js.native
  trait UpcastHelpers
    extends typings.ckeditorCkeditor5Engine.srcConversionConversionhelpersMod.default[UpcastHelpers] {
