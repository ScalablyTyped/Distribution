...
object keyobserverMod {
  ...
  @js.native
  open class KeyEventData[V /* <: /* Couldn't translate: 'key not found: IArray(TsIdentLibraryScoped(ckeditor,ckeditor5-engine), TsIdentModule(Some(ckeditor),List(ckeditor5-engine, src, view, view)))' */ Any */] protected ()
    extends typings.ckeditorCkeditor5Engine.domeventdataMod.default[
          V, 
          KeyboardEvent, 
  ...
  object ckeditorCkeditor5EngineSrcViewViewAugmentingMod {
    ...
    trait Observers extends StObject {
      ...
      var KeyObserver: typings.ckeditorCkeditor5Engine.keyobserverMod.KeyObserver
    }
    object Observers {
