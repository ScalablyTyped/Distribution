  ...
  */
  ...
  trait DomConverter extends StObject {
    ...
    def bindDocumentFragments(
      ...
      viewFragment: typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default
    ): Unit = js.native
    
    def bindElements(domElement: HTMLElement, viewElement: typings.ckeditorCkeditor5Engine.srcViewElementMod.default): Unit = js.native
    
    def bindFakeSelection(
      domElement: HTMLElement,
      viewDocumentSelection: typings.ckeditorCkeditor5Engine.srcViewDocumentselectionMod.default
    ): Unit = js.native
    ...
    def domPositionToView(domParent: Node): typings.ckeditorCkeditor5Engine.srcViewPositionMod.default = js.native
    def domPositionToView(domParent: Node, domOffset: Double): typings.ckeditorCkeditor5Engine.srcViewPositionMod.default = js.native
    
    def domRangeToView(domRange: Range): typings.ckeditorCkeditor5Engine.srcViewRangeMod.default | Null = js.native
    
    def domSelectionToView(domSelection: Selection): typings.ckeditorCkeditor5Engine.srcViewSelectionMod.default = js.native
    
    def domToView(domNode: DocumentFragment): typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default = js.native
    def domToView(domNode: DocumentFragment, options: KeepOriginalCase): typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default = js.native
    def domToView(domNode: Node): typings.ckeditorCkeditor5Engine.srcViewNodeMod.default | Null = js.native
    def domToView(domNode: Node, options: KeepOriginalCase): typings.ckeditorCkeditor5Engine.srcViewNodeMod.default | Null = js.native
    
    def fakeSelectionToView(domElement: HTMLElement): js.UndefOr[typings.ckeditorCkeditor5Engine.srcViewSelectionMod.default] = js.native
    
    def findCorrespondingDomText(viewText: typings.ckeditorCkeditor5Engine.srcViewTextMod.default): Text | Null = js.native
    
    def findCorrespondingViewText(domText: Text): typings.ckeditorCkeditor5Engine.srcViewTextMod.default | Null = js.native
    
    def focus(viewEditable: typings.ckeditorCkeditor5Engine.srcViewEditableelementMod.default): Unit = js.native
    
    def getHostViewElement(domNode: Node): typings.ckeditorCkeditor5Engine.srcViewUielementMod.default | typings.ckeditorCkeditor5Engine.srcViewRawelementMod.default | Null = js.native
    ...
    def mapDomToView(domElementOrDocumentFragment: typings.ckeditorCkeditor5Engine.srcModelElementMod.default): js.UndefOr[
    ...
    def mapViewToDom(viewNode: typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default): js.UndefOr[Node | DocumentFragment] = js.native
    def mapViewToDom(viewNode: typings.ckeditorCkeditor5Engine.srcViewElementMod.default): js.UndefOr[Node | DocumentFragment] = js.native
    ...
    def setDomElementAttribute(
      ...
      key: String,
      value: String,
      relatedViewElement: typings.ckeditorCkeditor5Engine.srcViewElementMod.default
    ): Unit = js.native
    ...
    def viewChildrenToDom(
      viewElement: typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default,
    ...
    def viewChildrenToDom(viewElement: typings.ckeditorCkeditor5Engine.srcViewElementMod.default, domDocument: Document): Generator[Node, Any, Any] = js.native
    def viewChildrenToDom(
      viewElement: typings.ckeditorCkeditor5Engine.srcViewElementMod.default,
      domDocument: Document,
      options: WithChildren
    ): Generator[Node, Any, Any] = js.native
    
    def viewPositionToDom(viewPosition: typings.ckeditorCkeditor5Engine.srcViewPositionMod.default): Offset | Null = js.native
    
    def viewRangeToDom(viewRange: typings.ckeditorCkeditor5Engine.srcViewRangeMod.default): Range = js.native
    ...
    /**
      ...
      */
    def viewToDom(
      viewNode: typings.ckeditorCkeditor5Engine.srcViewDocumentfragmentMod.default,
      domDocument: Document
    ...
    /**
      ...
      * be created. For bound elements and document fragments the method will return corresponding items.
      */
    def viewToDom(viewNode: typings.ckeditorCkeditor5Engine.srcViewNodeMod.default, domDocument: Document): Node = js.native
    def viewToDom(
      viewNode: typings.ckeditorCkeditor5Engine.srcViewNodeMod.default,
      domDocument: Document,
      options: WithChildren
    ): Node = js.native
  }
