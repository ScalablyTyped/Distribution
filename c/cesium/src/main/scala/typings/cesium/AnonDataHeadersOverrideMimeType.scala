...
trait AnonDataHeadersOverrideMimeType extends js.Object {
...
object AnonDataHeadersOverrideMimeType {
  @scala.inline
  def apply(
    url: String,
    data: js.Any = null,
  ...
  ): AnonDataHeadersOverrideMimeType = {
    ...
    __obj.asInstanceOf[AnonDataHeadersOverrideMimeType]
  }
}
