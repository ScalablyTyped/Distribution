...
trait AnonColorDisableDepthTestDistance extends js.Object {
...
object AnonColorDisableDepthTestDistance {
  @scala.inline
  def apply(
    color: Color = null,
  ...
  ): AnonColorDisableDepthTestDistance = {
    ...
    __obj.asInstanceOf[AnonColorDisableDepthTestDistance]
  }
}
