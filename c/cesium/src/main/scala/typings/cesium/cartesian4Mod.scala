...
object cartesian4Mod {
  
  @JSImport("cesium/Source/Core/Cartesian4", JSImport.Default)
  @js.native
  open class default () extends Cartesian4 {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.ONE")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.UNIT_W")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.UNIT_X")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.UNIT_Y")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.UNIT_Z")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.ZERO")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartesian4", "default.packedLength")
    @js.native
