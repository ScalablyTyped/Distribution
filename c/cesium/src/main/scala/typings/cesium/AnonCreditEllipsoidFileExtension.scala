...
trait AnonCreditEllipsoidFileExtension extends js.Object {
...
object AnonCreditEllipsoidFileExtension {
  @scala.inline
  def apply(
    ...
    url: String = null
  ): AnonCreditEllipsoidFileExtension = {
    ...
    __obj.asInstanceOf[AnonCreditEllipsoidFileExtension]
  }
}
