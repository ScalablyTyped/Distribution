...
object sourceCoreQuaternionMod {
  
  @JSImport("cesium/Source/Core/Quaternion", JSImport.Default)
  @js.native
  open class default () extends Quaternion {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Quaternion", "default.IDENTITY")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Quaternion", "default.ZERO")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Quaternion", "default.packedInterpolationLength")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Quaternion", "default.packedLength")
    @js.native
