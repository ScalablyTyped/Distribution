...
import typings.cesium.mod.FullscreenButtonViewModel
import typings.std.Element
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceWidgetsFullscreenButtonFullscreenButtonViewModelMod {
  
  @JSImport("cesium/Source/Widgets/FullscreenButton/FullscreenButtonViewModel", JSImport.Default)
  @js.native
  open class default () extends FullscreenButtonViewModel {
