...
trait AnonClosedFaceForwardFlat extends js.Object {
...
object AnonClosedFaceForwardFlat {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonClosedFaceForwardFlat]
  }
}
