...
import typings.cesium.mod.TimeStandard
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreJulianDateMod {
  
  @JSImport("cesium/Source/Core/JulianDate", JSImport.Default)
  @js.native
  open class default () extends JulianDate {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/JulianDate", "default.leapSeconds")
    @js.native
