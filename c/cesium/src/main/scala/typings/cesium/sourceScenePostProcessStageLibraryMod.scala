...
import typings.cesium.mod.PostProcessStage
import typings.cesium.mod.PostProcessStageComposite
import typings.cesium.mod.Scene
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceScenePostProcessStageLibraryMod {
  
  object default {
    
    @JSImport("cesium/Source/Scene/PostProcessStageLibrary", JSImport.Default)
    @js.native
