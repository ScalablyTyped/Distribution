...
trait AnonCreditEllipsoidMetadata extends js.Object {
...
object AnonCreditEllipsoidMetadata {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCreditEllipsoidMetadata]
  }
}
