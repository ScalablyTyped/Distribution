...
trait AnonInnerRadiiMaximumClock extends js.Object {
...
object AnonInnerRadiiMaximumClock {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonInnerRadiiMaximumClock]
  }
}
