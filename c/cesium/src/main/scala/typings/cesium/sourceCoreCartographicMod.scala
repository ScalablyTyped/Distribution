...
object sourceCoreCartographicMod {
  
  @JSImport("cesium/Source/Core/Cartographic", JSImport.Default)
  @js.native
  open class default () extends Cartographic {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Cartographic", "default.ZERO")
    @js.native
