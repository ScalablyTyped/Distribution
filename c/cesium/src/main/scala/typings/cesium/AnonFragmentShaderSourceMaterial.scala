...
trait AnonFragmentShaderSourceMaterial extends js.Object {
...
object AnonFragmentShaderSourceMaterial {
  @scala.inline
  def apply(
  ...
  ): AnonFragmentShaderSourceMaterial = {
    ...
    __obj.asInstanceOf[AnonFragmentShaderSourceMaterial]
  }
}
