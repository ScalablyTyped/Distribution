...
trait AnonAllowPickingAppearance extends js.Object {
...
object AnonAllowPickingAppearance {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAllowPickingAppearance]
  }
}
