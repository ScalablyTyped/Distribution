...
trait AnonAllowPickingAsynchronous extends js.Object {
...
object AnonAllowPickingAsynchronous {
  @scala.inline
  def apply(
    url: String,
    ...
    __obj.asInstanceOf[AnonAllowPickingAsynchronous]
  }
}
