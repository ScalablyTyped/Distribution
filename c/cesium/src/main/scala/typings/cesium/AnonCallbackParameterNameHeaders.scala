...
trait AnonCallbackParameterNameHeaders extends js.Object {
...
object AnonCallbackParameterNameHeaders {
  @scala.inline
  def apply(
    url: String,
  ...
  ): AnonCallbackParameterNameHeaders = {
    ...
    __obj.asInstanceOf[AnonCallbackParameterNameHeaders]
  }
}
