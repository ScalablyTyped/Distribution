...
object sourceCoreRequestSchedulerMod {
  
  object default {
    
    @JSImport("cesium/Source/Core/RequestScheduler", JSImport.Default)
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/RequestScheduler", "default.maximumRequests")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/RequestScheduler", "default.maximumRequestsPerServer")
    @js.native
    ...
    /**
      ...
      * };
      */
    @JSImport("cesium/Source/Core/RequestScheduler", "default.requestsByServer")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/RequestScheduler", "default.throttleRequests")
    @js.native
