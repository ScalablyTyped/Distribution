...
trait AnonCornerTypeExtrudedHeight extends js.Object {
...
object AnonCornerTypeExtrudedHeight {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonCornerTypeExtrudedHeight]
  }
}
