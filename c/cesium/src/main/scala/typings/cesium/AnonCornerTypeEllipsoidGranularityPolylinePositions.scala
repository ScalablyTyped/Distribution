...
trait AnonCornerTypeEllipsoidGranularityPolylinePositions extends js.Object {
...
object AnonCornerTypeEllipsoidGranularityPolylinePositions {
  @scala.inline
  def apply(
  ...
  ): AnonCornerTypeEllipsoidGranularityPolylinePositions = {
    ...
    __obj.asInstanceOf[AnonCornerTypeEllipsoidGranularityPolylinePositions]
  }
}
