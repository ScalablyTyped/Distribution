...
trait AnonAllowPickingAppearanceAsynchronousClassificationType extends js.Object {
...
object AnonAllowPickingAppearanceAsynchronousClassificationType {
  @scala.inline
  def apply(
  ...
  ): AnonAllowPickingAppearanceAsynchronousClassificationType = {
    ...
    __obj.asInstanceOf[AnonAllowPickingAppearanceAsynchronousClassificationType]
  }
}
