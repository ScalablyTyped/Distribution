...
trait ClampAnimations extends StObject {
...
object ClampAnimations {
  
  inline def apply(resource: Resource): ClampAnimations = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ClampAnimations]
  }
  
  extension [Self <: ClampAnimations](x: Self) {
