...
object NumberOfVerticalLines {
  ...
  inline def apply(center: Cartesian3, semiMajorAxis: Double, semiMinorAxis: Double): NumberOfVerticalLines = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NumberOfVerticalLines] (val x: Self) extends AnyVal {
