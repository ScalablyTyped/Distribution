...
object Articulations {
  ...
  def apply(
    ...
    color: Property | typings.cesium.mod.Color = null,
    colorBlendAmount: Property | Double = null,
    colorBlendMode: Property | ColorBlendMode = null,
    distanceDisplayCondition: Property | typings.cesium.mod.DistanceDisplayCondition = null,
    ...
    silhouetteColor: Property | typings.cesium.mod.Color = null,
