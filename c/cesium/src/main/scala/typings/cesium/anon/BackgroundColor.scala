...
trait BackgroundColor extends StObject {
  ...
  var backgroundColor: js.UndefOr[typings.cesium.mod.Color] = js.undefined
  ...
  var strokeColor: js.UndefOr[typings.cesium.mod.Color] = js.undefined
...
object BackgroundColor {
  ...
  implicit open class MutableBuilder[Self <: BackgroundColor] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(value: typings.cesium.mod.Color): Self = StObject.set(x, "backgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setStrokeColor(value: typings.cesium.mod.Color): Self = StObject.set(x, "strokeColor", value.asInstanceOf[js.Any])
