...
import typings.cesium.Anon_EllipsoidNumberOfLevelZeroTilesXNumberOfLevelZeroTilesY
...
class WebMercatorTilingScheme () extends js.Object {
  def this(options: Anon_EllipsoidNumberOfLevelZeroTilesXNumberOfLevelZeroTilesY) = this()
