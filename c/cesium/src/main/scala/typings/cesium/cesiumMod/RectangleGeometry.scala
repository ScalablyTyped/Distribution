...
import typings.cesium.Anon_EllipsoidExtrudedHeightGranularityHeightRectangle
...
class RectangleGeometry protected () extends Packable {
  def this(options: Anon_EllipsoidExtrudedHeightGranularityHeightRectangle) = this()
}
