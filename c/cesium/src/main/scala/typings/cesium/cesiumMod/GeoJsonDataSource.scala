...
import typings.cesium.Anon_ClampToGround
...
class GeoJsonDataSource () extends DataSource {
  ...
  def load(data: String, options: Anon_ClampToGround): js.Promise[GeoJsonDataSource] = js.native
  def load(data: js.Object): js.Promise[GeoJsonDataSource] = js.native
  def load(data: js.Object, options: Anon_ClampToGround): js.Promise[GeoJsonDataSource] = js.native
  def load(data: Resource): js.Promise[GeoJsonDataSource] = js.native
  def load(data: Resource, options: Anon_ClampToGround): js.Promise[GeoJsonDataSource] = js.native
}
