...
trait AnonHeadersPreserveQueryParametersProxy extends js.Object {
...
object AnonHeadersPreserveQueryParametersProxy {
  @scala.inline
  def apply(
    headers: js.Any = null,
    ...
    url: String = null
  ): AnonHeadersPreserveQueryParametersProxy = {
    ...
    __obj.asInstanceOf[AnonHeadersPreserveQueryParametersProxy]
  }
}
