...
trait AnonCornerTypeEllipsoidGranularity extends js.Object {
...
object AnonCornerTypeEllipsoidGranularity {
  @scala.inline
  def apply(
  ...
  ): AnonCornerTypeEllipsoidGranularity = {
    ...
    __obj.asInstanceOf[AnonCornerTypeEllipsoidGranularity]
  }
}
