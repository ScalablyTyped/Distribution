...
trait AnonColorsColorsPerVertex extends js.Object {
...
object AnonColorsColorsPerVertex {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonColorsColorsPerVertex]
  }
}
