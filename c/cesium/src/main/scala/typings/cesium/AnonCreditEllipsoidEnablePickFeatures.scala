...
trait AnonCreditEllipsoidEnablePickFeatures extends js.Object {
...
object AnonCreditEllipsoidEnablePickFeatures {
  @scala.inline
  def apply(
    url: String,
  ...
  ): AnonCreditEllipsoidEnablePickFeatures = {
    ...
    __obj.asInstanceOf[AnonCreditEllipsoidEnablePickFeatures]
  }
}
