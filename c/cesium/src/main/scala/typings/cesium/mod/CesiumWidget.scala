...
import typings.cesium.AnonClockContextOptions
...
class CesiumWidget protected () extends js.Object {
  ...
  def this(container: String, options: AnonClockContextOptions) = this()
  def this(container: Element, options: AnonClockContextOptions) = this()
