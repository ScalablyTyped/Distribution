...
object EllipseGeometry {
  ...
  /**
    ...
    */
  inline def computeRectangle(options: typings.cesium.anon.Rotation): Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any]).asInstanceOf[Rectangle]
  inline def computeRectangle(options: typings.cesium.anon.Rotation, result: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
