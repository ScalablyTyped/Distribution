...
object BoundingSphere {
  ...
  /* static member */
  inline def clone_(sphere: BoundingSphere): BoundingSphere = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(sphere.asInstanceOf[js.Any]).asInstanceOf[BoundingSphere]
  inline def clone_(sphere: BoundingSphere, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(sphere.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  ...
  inline def equals_(left: Unit, right: BoundingSphere): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: BoundingSphere): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: BoundingSphere, right: BoundingSphere): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def fromCornerPoints(corner: Double): BoundingSphere = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any]).asInstanceOf[BoundingSphere]
  inline def fromCornerPoints(corner: Double, oppositeCorner: Double): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any], oppositeCorner.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromCornerPoints(corner: Double, oppositeCorner: Double, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any], oppositeCorner.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromCornerPoints(corner: Double, oppositeCorner: Unit, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any], oppositeCorner.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromCornerPoints(corner: Unit, oppositeCorner: Double): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any], oppositeCorner.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromCornerPoints(corner: Unit, oppositeCorner: Double, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCornerPoints")(corner.asInstanceOf[js.Any], oppositeCorner.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  ...
  inline def fromRectangle2D(rectangle: Rectangle, projection: js.Any): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRectangle2D")(rectangle.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromRectangle2D(rectangle: Rectangle, projection: js.Any, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRectangle2D")(rectangle.asInstanceOf[js.Any], projection.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  ...
  inline def fromRectangleWithHeights2D(rectangle: Rectangle, projection: js.Any): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRectangleWithHeights2D")(rectangle.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromRectangleWithHeights2D(rectangle: Rectangle, projection: js.Any, minimumHeight: Double): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRectangleWithHeights2D")(rectangle.asInstanceOf[js.Any], projection.asInstanceOf[js.Any], minimumHeight.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  ...
  /* static member */
  inline def fromVertices(positions: js.Array[Cartesian3]): BoundingSphere = ^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any]).asInstanceOf[BoundingSphere]
  inline def fromVertices(positions: js.Array[Cartesian3], center: Unit, stride: Double): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any], center.asInstanceOf[js.Any], stride.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromVertices(positions: js.Array[Cartesian3], center: Unit, stride: Double, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any], center.asInstanceOf[js.Any], stride.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromVertices(positions: js.Array[Cartesian3], center: Unit, stride: Unit, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any], center.asInstanceOf[js.Any], stride.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromVertices(positions: js.Array[Cartesian3], center: Cartesian3): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any], center.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def fromVertices(positions: js.Array[Cartesian3], center: Cartesian3, stride: Double): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("fromVertices")(positions.asInstanceOf[js.Any], center.asInstanceOf[js.Any], stride.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  ...
  /* static member */
  inline def intersect(sphere: BoundingSphere, plane: Cartesian4): Intersect = (^.asInstanceOf[js.Dynamic].applyDynamic("intersect")(sphere.asInstanceOf[js.Any], plane.asInstanceOf[js.Any])).asInstanceOf[Intersect]
  ...
  inline def projectTo2D(sphere: BoundingSphere, projection: js.Any): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("projectTo2D")(sphere.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
  inline def projectTo2D(sphere: BoundingSphere, projection: js.Any, result: BoundingSphere): BoundingSphere = (^.asInstanceOf[js.Dynamic].applyDynamic("projectTo2D")(sphere.asInstanceOf[js.Any], projection.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[BoundingSphere]
