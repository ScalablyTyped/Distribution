...
@JSImport("cesium", "ArcGISTiledElevationTerrainProvider")
@js.native
...
object ArcGISTiledElevationTerrainProvider {
  ...
  inline def fromUrl(url: String, options: typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions): js.Promise[ArcGISTiledElevationTerrainProvider] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromUrl")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[ArcGISTiledElevationTerrainProvider]]
  ...
  inline def fromUrl(
    ...
    options: typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions
  ...
  inline def fromUrl(url: Resource, options: typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions): js.Promise[ArcGISTiledElevationTerrainProvider] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromUrl")(url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[ArcGISTiledElevationTerrainProvider]]
  ...
  object ConstructorOptions {
    ...
    inline def apply(): typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: typings.cesium.mod.ArcGISTiledElevationTerrainProvider.ConstructorOptions] (val x: Self) extends AnyVal {
