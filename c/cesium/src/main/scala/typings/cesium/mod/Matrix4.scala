...
object Matrix4 {
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN0ROW0")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN0ROW1")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN0ROW2")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN0ROW3")
  @js.native
  def COLUMN0ROW3: Double = js.native
  inline def COLUMN0ROW3_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN0ROW3")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN1ROW0")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN1ROW1")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN1ROW2")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN1ROW3")
  @js.native
  def COLUMN1ROW3: Double = js.native
  inline def COLUMN1ROW3_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN1ROW3")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN2ROW0")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN2ROW1")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN2ROW2")
  @js.native
  ...
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN2ROW3")
  @js.native
  def COLUMN2ROW3: Double = js.native
  inline def COLUMN2ROW3_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN2ROW3")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN3ROW0")
  @js.native
  def COLUMN3ROW0: Double = js.native
  inline def COLUMN3ROW0_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN3ROW0")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN3ROW1")
  @js.native
  def COLUMN3ROW1: Double = js.native
  inline def COLUMN3ROW1_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN3ROW1")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN3ROW2")
  @js.native
  def COLUMN3ROW2: Double = js.native
  inline def COLUMN3ROW2_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN3ROW2")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.COLUMN3ROW3")
  @js.native
  def COLUMN3ROW3: Double = js.native
  inline def COLUMN3ROW3_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("COLUMN3ROW3")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Matrix4.IDENTITY")
  @js.native
  def IDENTITY: Matrix4 = js.native
  inline def IDENTITY_=(x: Matrix4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IDENTITY")(x.asInstanceOf[js.Any])
  ...
  /* static member */
  inline def clone_(matrix: Matrix4): Matrix4 = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(matrix.asInstanceOf[js.Any]).asInstanceOf[Matrix4]
  inline def clone_(matrix: Matrix4, result: Matrix4): Matrix4 = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(matrix.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix4]
  
  /* static member */
  inline def computeInfinitePerspectiveOffCenter(
    left: Double,
    right: Double,
    bottom: Double,
    top: Double,
  ...
  inline def equals_(left: Unit, right: Matrix4): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Matrix4): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Matrix4, right: Matrix4): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  inline def setColumn(matrix: Matrix4, index: Double, cartesian: Cartesian4, result: Cartesian4): Matrix4 = (^.asInstanceOf[js.Dynamic].applyDynamic("setColumn")(matrix.asInstanceOf[js.Any], index.asInstanceOf[js.Any], cartesian.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix4]
  
  /* static member */
  inline def setRow(matrix: Matrix4, index: Double, cartesian: Cartesian4, result: Cartesian4): Matrix4 = (^.asInstanceOf[js.Dynamic].applyDynamic("setRow")(matrix.asInstanceOf[js.Any], index.asInstanceOf[js.Any], cartesian.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix4]
