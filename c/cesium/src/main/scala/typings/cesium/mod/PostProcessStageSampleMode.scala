...
object PostProcessStageSampleMode extends StObject {
  ...
  /* 1 */ val LINEAR: typings.cesium.mod.PostProcessStageSampleMode.LINEAR & Double = js.native
  ...
  sealed trait NEAREST
    extends StObject
       with PostProcessStageSampleMode
  /* 0 */ val NEAREST: typings.cesium.mod.PostProcessStageSampleMode.NEAREST & Double = js.native
}
