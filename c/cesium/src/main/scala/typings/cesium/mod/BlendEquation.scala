...
object BlendEquation extends StObject {
  ...
  sealed trait ADD
    extends StObject
       with BlendEquation
  /* WebGLConstants.FUNC_ADD */ val ADD: typings.cesium.mod.BlendEquation.ADD & scala.Nothing = js.native
  ...
  sealed trait MAX
    extends StObject
       with BlendEquation
  /* WebGLConstants.MAX */ val MAX: typings.cesium.mod.BlendEquation.MAX & scala.Nothing = js.native
  ...
  sealed trait MIN
    extends StObject
       with BlendEquation
  /* WebGLConstants.MIN */ val MIN: typings.cesium.mod.BlendEquation.MIN & scala.Nothing = js.native
  ...
  sealed trait REVERSE_SUBTRACT
    extends StObject
       with BlendEquation
  /* WebGLConstants.FUNC_REVERSE_SUBTRACT */ val REVERSE_SUBTRACT: typings.cesium.mod.BlendEquation.REVERSE_SUBTRACT & scala.Nothing = js.native
  ...
  sealed trait SUBTRACT
    extends StObject
       with BlendEquation
  /* WebGLConstants.FUNC_SUBTRACT */ val SUBTRACT: typings.cesium.mod.BlendEquation.SUBTRACT & scala.Nothing = js.native
}
