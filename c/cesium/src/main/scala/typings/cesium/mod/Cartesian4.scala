...
object Cartesian4 {
  ...
  inline def UNIT_W_=(x: Cartesian4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNIT_W")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Cartesian4.UNIT_X")
  @js.native
  def UNIT_X: Cartesian4 = js.native
  inline def UNIT_X_=(x: Cartesian4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNIT_X")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Cartesian4.UNIT_Y")
  @js.native
  def UNIT_Y: Cartesian4 = js.native
  inline def UNIT_Y_=(x: Cartesian4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNIT_Y")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Cartesian4.UNIT_Z")
  @js.native
  def UNIT_Z: Cartesian4 = js.native
  inline def UNIT_Z_=(x: Cartesian4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNIT_Z")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Cartesian4.ZERO")
  @js.native
  def ZERO: Cartesian4 = js.native
  inline def ZERO_=(x: Cartesian4): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
  ...
  /* static member */
  inline def clone_(cartesian: Cartesian4): Cartesian4 = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(cartesian.asInstanceOf[js.Any]).asInstanceOf[Cartesian4]
  inline def clone_(cartesian: Cartesian4, result: Cartesian4): Cartesian4 = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(cartesian.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Cartesian4]
  ...
  inline def equals_(left: Unit, right: Cartesian4): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Cartesian4): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Cartesian4, right: Cartesian4): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
