...
object GeometryPipeline {
  ...
  inline def computeBinormalAndTangent(geometry: Geometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("computeBinormalAndTangent")(geometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
  ...
  inline def createAttributeLocations(geometry: Geometry): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createAttributeLocations")(geometry.asInstanceOf[js.Any]).asInstanceOf[js.Any]
