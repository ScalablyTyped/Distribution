...
import typings.cesium.anon.DataHeaders
...
import typings.cesium.anon.RetryCallback
...
class Resource () extends StObject {
  ...
  def delete(options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
  
  val `extension`: String = js.native
  
  def fetch(): js.UndefOr[js.Promise[js.Any]] = js.native
  def fetch(options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
  ...
  def getDerivedResource(options: RetryCallback): Resource = js.native
  ...
  def head(options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
  ...
  def options(options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
  
  def patch(data: js.Any): js.UndefOr[js.Promise[js.Any]] = js.native
  def patch(data: js.Any, options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
  
  def post(data: js.Any): js.UndefOr[js.Promise[js.Any]] = js.native
  def post(data: js.Any, options: DataHeaders): js.UndefOr[js.Promise[js.Any]] = js.native
  
  var proxy: DefaultProxy = js.native
  
  def put(data: js.Any): js.UndefOr[js.Promise[js.Any]] = js.native
  def put(data: js.Any, options: ResponseType): js.UndefOr[js.Promise[js.Any]] = js.native
...
object Resource {
  ...
  inline def fetch(options: typings.cesium.anon.Request): js.UndefOr[js.Promise[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("fetch")(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[js.Promise[js.Any]]]
  ...
  inline def head(options: typings.cesium.anon.Request): js.UndefOr[js.Promise[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("head")(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[js.Promise[js.Any]]]
  ...
  inline def options(options: typings.cesium.anon.Request): js.UndefOr[js.Promise[js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("options")(options.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[js.Promise[js.Any]]]
