...
object Quaternion {
  ...
  /* static member */
  inline def clone_(quaternion: Quaternion): Quaternion = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(quaternion.asInstanceOf[js.Any]).asInstanceOf[Quaternion]
  inline def clone_(quaternion: Quaternion, result: Quaternion): Quaternion = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(quaternion.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Quaternion]
  ...
  inline def equals_(left: Unit, right: Quaternion): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Quaternion): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Quaternion, right: Quaternion): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  inline def fastSquad(q0: Quaternion, q1: Quaternion, s0: Quaternion, s1: Quaternion, t: Double): Quaternion = (^.asInstanceOf[js.Dynamic].applyDynamic("fastSquad")(q0.asInstanceOf[js.Any], q1.asInstanceOf[js.Any], s0.asInstanceOf[js.Any], s1.asInstanceOf[js.Any], t.asInstanceOf[js.Any])).asInstanceOf[Quaternion]
  ...
  inline def unpackInterpolationResult(array: js.Array[Double], sourceArray: js.Array[Double], startingIndex: Double): Quaternion = (^.asInstanceOf[js.Dynamic].applyDynamic("unpackInterpolationResult")(array.asInstanceOf[js.Any], sourceArray.asInstanceOf[js.Any], startingIndex.asInstanceOf[js.Any])).asInstanceOf[Quaternion]
