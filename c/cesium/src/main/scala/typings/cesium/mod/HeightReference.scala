...
object HeightReference extends StObject {
  ...
  /* 1 */ val CLAMP_TO_GROUND: typings.cesium.mod.HeightReference.CLAMP_TO_GROUND & Double = js.native
  ...
  sealed trait NONE
    extends StObject
       with HeightReference
  /* 0 */ val NONE: typings.cesium.mod.HeightReference.NONE & Double = js.native
