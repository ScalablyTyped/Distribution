...
object Cartographic {
  ...
  inline def ZERO_=(x: Cartographic): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ZERO")(x.asInstanceOf[js.Any])
  
  /* static member */
  inline def clone_(cartographic: Cartographic): Cartographic = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(cartographic.asInstanceOf[js.Any]).asInstanceOf[Cartographic]
  inline def clone_(cartographic: Cartographic, result: Cartographic): Cartographic = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(cartographic.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Cartographic]
  ...
  inline def equals_(left: Unit, right: Cartographic): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Cartographic): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Cartographic, right: Cartographic): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
