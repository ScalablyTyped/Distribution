...
object CorridorOutlineGeometry {
  ...
  /* static member */
  inline def createGeometry(corridorOutlineGeometry: CorridorOutlineGeometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("createGeometry")(corridorOutlineGeometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
