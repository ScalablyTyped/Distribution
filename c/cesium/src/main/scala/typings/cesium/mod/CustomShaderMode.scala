...
object CustomShaderMode extends StObject {
  ...
  /* "MODIFY_MATERIAL" */ val MODIFY_MATERIAL: typings.cesium.mod.CustomShaderMode.MODIFY_MATERIAL & String = js.native
  ...
  sealed trait REPLACE_MATERIAL
    extends StObject
       with CustomShaderMode
  /* "REPLACE_MATERIAL" */ val REPLACE_MATERIAL: typings.cesium.mod.CustomShaderMode.REPLACE_MATERIAL & String = js.native
}
