...
object PolylineVolumeGeometry {
  ...
  /* static member */
  inline def createGeometry(polylineVolumeGeometry: PolylineVolumeGeometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("createGeometry")(polylineVolumeGeometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
