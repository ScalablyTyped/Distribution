...
object BoxGeometry {
  ...
  /* static member */
  inline def createGeometry(boxGeometry: BoxGeometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("createGeometry")(boxGeometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
