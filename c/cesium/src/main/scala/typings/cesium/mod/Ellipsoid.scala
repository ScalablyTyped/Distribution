...
object Ellipsoid {
  ...
  inline def MOON_=(x: Ellipsoid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MOON")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Ellipsoid.UNIT_SPHERE")
  @js.native
  def UNIT_SPHERE: Ellipsoid = js.native
  inline def UNIT_SPHERE_=(x: Ellipsoid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNIT_SPHERE")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("cesium", "Ellipsoid.WGS84")
  @js.native
  def WGS84: Ellipsoid = js.native
  inline def WGS84_=(x: Ellipsoid): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WGS84")(x.asInstanceOf[js.Any])
  
  /* static member */
  inline def clone_(ellipsoid: Ellipsoid): Ellipsoid = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(ellipsoid.asInstanceOf[js.Any]).asInstanceOf[Ellipsoid]
  inline def clone_(ellipsoid: Ellipsoid, result: Ellipsoid): Ellipsoid = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(ellipsoid.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Ellipsoid]
  
  /* static member */
  inline def fromCartesian3(): Ellipsoid = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCartesian3")().asInstanceOf[Ellipsoid]
  inline def fromCartesian3(radii: Cartesian3): Ellipsoid = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCartesian3")(radii.asInstanceOf[js.Any]).asInstanceOf[Ellipsoid]
