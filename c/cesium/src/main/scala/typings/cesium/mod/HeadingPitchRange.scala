...
class HeadingPitchRange () extends StObject {
  ...
  def this(heading: js.UndefOr[scala.Nothing], pitch: js.UndefOr[scala.Nothing], range: Double) = this()
  def this(heading: js.UndefOr[scala.Nothing], pitch: Double, range: Double) = this()
  def this(heading: Double, pitch: js.UndefOr[scala.Nothing], range: Double) = this()
