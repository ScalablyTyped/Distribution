...
object Matrix3 {
  ...
  inline def IDENTITY_=(x: Matrix3): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IDENTITY")(x.asInstanceOf[js.Any])
  ...
  /* static member */
  inline def clone_(matrix: Matrix3): Matrix3 = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(matrix.asInstanceOf[js.Any]).asInstanceOf[Matrix3]
  inline def clone_(matrix: Matrix3, result: Matrix3): Matrix3 = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(matrix.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix3]
  
  /* static member */
  inline def computeEigenDecomposition(matrix: Matrix3): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("computeEigenDecomposition")(matrix.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  inline def computeEigenDecomposition(matrix: Matrix3, result: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("computeEigenDecomposition")(matrix.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  ...
  inline def equals_(left: Unit, right: Matrix3): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Matrix3): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Matrix3, right: Matrix3): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  inline def fromCrossProduct(the: Cartesian3): Matrix3 = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCrossProduct")(the.asInstanceOf[js.Any]).asInstanceOf[Matrix3]
  inline def fromCrossProduct(the: Cartesian3, result: Matrix3): Matrix3 = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCrossProduct")(the.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix3]
  ...
  /* static member */
  inline def setColumn(matrix: Matrix3, index: Double, cartesian: Cartesian3, result: Cartesian3): Matrix3 = (^.asInstanceOf[js.Dynamic].applyDynamic("setColumn")(matrix.asInstanceOf[js.Any], index.asInstanceOf[js.Any], cartesian.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix3]
  
  /* static member */
  inline def setRow(matrix: Matrix3, index: Double, cartesian: Cartesian3, result: Cartesian3): Matrix3 = (^.asInstanceOf[js.Dynamic].applyDynamic("setRow")(matrix.asInstanceOf[js.Any], index.asInstanceOf[js.Any], cartesian.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Matrix3]
