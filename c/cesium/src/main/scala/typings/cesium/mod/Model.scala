...
open class Model () extends StObject {
  ...
  /**
    ...
    * </p>
    */
  val readyEvent: Event[js.Function1[/* repeated */ Any, Unit]] = js.native
  ...
  /**
    ...
    * are passed an instance of the {@link Model}.
    */
  val texturesReadyEvent: Event[js.Function1[/* repeated */ Any, Unit]] = js.native
...
object Model {
  ...
  /**
    ...
    */
  inline def fromGltfAsync(options: BackFaceCulling): js.Promise[Model] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromGltfAsync")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Model]]
  
  /**
    * Interface for the function that is called with the loaded gltf object once loaded.
    * @param gltf - The gltf object
    */
  type GltfCallback = js.Function1[/* gltf */ Any, Unit]
}
