...
object Rectangle {
  ...
  inline def MAX_VALUE_=(x: Rectangle): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MAX_VALUE")(x.asInstanceOf[js.Any])
  ...
  /* static member */
  inline def clone_(rectangle: Rectangle): Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(rectangle.asInstanceOf[js.Any]).asInstanceOf[Rectangle]
  inline def clone_(rectangle: Rectangle, result: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("clone")(rectangle.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
  ...
  inline def equals_(left: Unit, right: Rectangle): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def equals_(left: Rectangle): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  inline def equals_(left: Rectangle, right: Rectangle): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("equals")(left.asInstanceOf[js.Any], right.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /* static member */
  inline def intersection(rectangle: Rectangle, otherRectangle: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(rectangle.asInstanceOf[js.Any], otherRectangle.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
  inline def intersection(rectangle: Rectangle, otherRectangle: Rectangle, result: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("intersection")(rectangle.asInstanceOf[js.Any], otherRectangle.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
