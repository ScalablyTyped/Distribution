...
object BoxOutlineGeometry {
  ...
  /* static member */
  inline def createGeometry(boxGeometry: BoxOutlineGeometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("createGeometry")(boxGeometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
