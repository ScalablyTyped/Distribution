...
object EllipseOutlineGeometry {
  ...
  /* static member */
  inline def createGeometry(ellipseGeometry: EllipseOutlineGeometry): Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("createGeometry")(ellipseGeometry.asInstanceOf[js.Any]).asInstanceOf[Geometry]
