...
class RequestErrorEvent () extends js.Object {
  ...
  def this(statusCode: js.UndefOr[scala.Nothing], response: js.Any, responseHeaders: String) = this()
  def this(statusCode: js.UndefOr[scala.Nothing], response: js.Any, responseHeaders: js.Object) = this()
  def this(statusCode: Double, response: js.UndefOr[scala.Nothing], responseHeaders: String) = this()
