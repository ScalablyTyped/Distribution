...
import typings.cesium.mod.CylinderOutlineGeometry
import typings.cesium.mod.Geometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCoreCylinderOutlineGeometryMod {
  
  @JSImport("cesium/Source/Core/CylinderOutlineGeometry", JSImport.Default)
  @js.native
  open class default protected () extends CylinderOutlineGeometry {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/CylinderOutlineGeometry", "default.packedLength")
    @js.native
