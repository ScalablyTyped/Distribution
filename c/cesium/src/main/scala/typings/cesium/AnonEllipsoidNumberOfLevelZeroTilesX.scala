...
trait AnonEllipsoidNumberOfLevelZeroTilesX extends js.Object {
...
object AnonEllipsoidNumberOfLevelZeroTilesX {
  @scala.inline
  def apply(
  ...
  ): AnonEllipsoidNumberOfLevelZeroTilesX = {
    ...
    __obj.asInstanceOf[AnonEllipsoidNumberOfLevelZeroTilesX]
  }
}
