...
object packableForInterpolationMod {
  
  object default {
    
    @JSImport("cesium/Source/Core/PackableForInterpolation", JSImport.Default)
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/PackableForInterpolation", "default.packedInterpolationLength")
    @js.native
