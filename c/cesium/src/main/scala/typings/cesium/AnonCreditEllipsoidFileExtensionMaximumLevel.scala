...
trait AnonCreditEllipsoidFileExtensionMaximumLevel extends js.Object {
...
object AnonCreditEllipsoidFileExtensionMaximumLevel {
  @scala.inline
  def apply(
    ...
    url: String = null
  ): AnonCreditEllipsoidFileExtensionMaximumLevel = {
    ...
    __obj.asInstanceOf[AnonCreditEllipsoidFileExtensionMaximumLevel]
  }
}
