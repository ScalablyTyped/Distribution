...
import typings.cesium.mod.PolylineVolumeGeometry
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sourceCorePolylineVolumeGeometryMod {
  
  @JSImport("cesium/Source/Core/PolylineVolumeGeometry", JSImport.Default)
  @js.native
  open class default protected () extends PolylineVolumeGeometry {
