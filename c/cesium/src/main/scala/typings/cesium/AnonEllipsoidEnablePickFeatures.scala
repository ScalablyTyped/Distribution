...
trait AnonEllipsoidEnablePickFeatures extends js.Object {
...
object AnonEllipsoidEnablePickFeatures {
  @scala.inline
  def apply(
    url: String,
  ...
  ): AnonEllipsoidEnablePickFeatures = {
    ...
    __obj.asInstanceOf[AnonEllipsoidEnablePickFeatures]
  }
}
