...
object sourceCoreFullscreenMod {
  
  object default {
    
    @JSImport("cesium/Source/Core/Fullscreen", JSImport.Default)
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Fullscreen", "default.changeEventName")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Fullscreen", "default.element")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Fullscreen", "default.enabled")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Fullscreen", "default.errorEventName")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/Fullscreen", "default.fullscreen")
    @js.native
