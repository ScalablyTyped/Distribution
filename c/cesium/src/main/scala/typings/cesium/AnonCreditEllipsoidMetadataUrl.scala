...
trait AnonCreditEllipsoidMetadataUrl extends js.Object {
...
object AnonCreditEllipsoidMetadataUrl {
  @scala.inline
  def apply(
  ...
  ): AnonCreditEllipsoidMetadataUrl = {
    ...
    __obj.asInstanceOf[AnonCreditEllipsoidMetadataUrl]
  }
}
