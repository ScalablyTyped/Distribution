...
object sourceCoreBoundingSphereMod {
  
  @JSImport("cesium/Source/Core/BoundingSphere", JSImport.Default)
  @js.native
  open class default () extends BoundingSphere {
  ...
  object default {
    ...
    /**
      ...
      */
    @JSImport("cesium/Source/Core/BoundingSphere", "default.packedLength")
    @js.native
