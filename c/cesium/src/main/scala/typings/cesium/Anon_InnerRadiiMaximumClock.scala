...
trait Anon_InnerRadiiMaximumClock extends js.Object {
...
object Anon_InnerRadiiMaximumClock {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[Anon_InnerRadiiMaximumClock]
  }
}
