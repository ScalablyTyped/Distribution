...
trait Anon_DisableCheckIfAllPixelsAreTransparent extends js.Object {
  ...
  var missingImageUrl: cesiumLib.cesiumMod.Resource | java.lang.String
  var pixelsToCheck: js.Array[cesiumLib.cesiumMod.Cartesian2]
}

object Anon_DisableCheckIfAllPixelsAreTransparent {
  @scala.inline
  def apply(
    missingImageUrl: cesiumLib.cesiumMod.Resource | java.lang.String,
    pixelsToCheck: js.Array[cesiumLib.cesiumMod.Cartesian2],
