...
trait Scene extends js.Object {
  ...
  val postRender: Event = js.native
  val preRender: Event = js.native
  val preUpdate: Event = js.native
  val primitives: PrimitiveCollection = js.native
  val renderError: Event = js.native
  ...
  val terrainProviderChanged: Event = js.native
