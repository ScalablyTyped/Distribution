...
trait TerrainProvider extends js.Object {
  ...
  val readyPromise: stdLib.Promise[scala.Boolean] = js.native
  ...
  def requestTileGeometry(x: scala.Double, y: scala.Double, level: scala.Double): stdLib.Promise[TerrainData] = js.native
  def requestTileGeometry(x: scala.Double, y: scala.Double, level: scala.Double, throttleRequests: scala.Boolean): stdLib.Promise[TerrainData] = js.native
}
