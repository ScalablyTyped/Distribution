...
@js.native
class PolylineGeometryUpdater protected ()
  extends cesiumLib.cesiumMod.CesiumNs.PolylineGeometryUpdater {
  ...
  /* CompleteClass */
  override val depthFailMaterialProperty: cesiumLib.cesiumMod.CesiumNs.MaterialProperty = js.native
  /* CompleteClass */
  override val distanceDisplayConditionProperty: cesiumLib.cesiumMod.CesiumNs.Property = js.native
  /* CompleteClass */
