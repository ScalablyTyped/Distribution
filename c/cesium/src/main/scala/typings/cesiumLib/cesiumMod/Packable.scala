...
object Packable extends js.Object {
  ...
  def unpack(array: js.Array[scala.Double]): cesiumLib.cesiumMod.Packable = js.native
  def unpack(array: js.Array[scala.Double], startingIndex: scala.Double): cesiumLib.cesiumMod.Packable = js.native
  def unpack(array: js.Array[scala.Double], startingIndex: scala.Double, result: js.Any): cesiumLib.cesiumMod.Packable = js.native
}
