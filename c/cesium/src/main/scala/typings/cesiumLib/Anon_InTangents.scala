...
trait Anon_InTangents extends js.Object {
  var inTangents: js.Array[cesiumLib.cesiumMod.Cartesian3]
  var outTangents: js.Array[cesiumLib.cesiumMod.Cartesian3]
...
object Anon_InTangents {
  @scala.inline
  def apply(
    inTangents: js.Array[cesiumLib.cesiumMod.Cartesian3],
    outTangents: js.Array[cesiumLib.cesiumMod.Cartesian3],
