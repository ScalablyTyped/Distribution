...
object encoderMod {
  ...
  /**
    ...
    */
  /* static member */
  inline def pushTypedArray(
    gen: Encoder,
    obj: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify NodeJS.TypedArray */ Any
  ): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("_pushTypedArray")(gen.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[Boolean]
