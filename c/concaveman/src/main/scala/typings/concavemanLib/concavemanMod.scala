...
@js.native
object concavemanMod extends js.Object {
  /**
       ...
       * //=hull
       */
  def apply(points: js.Array[js.Array[scala.Double]]): js.Array[js.Array[scala.Double]] = js.native
  /**
       * A very fast 2D concave hull algorithm in JavaScript (generates a general outline of a point set).
       *
       * @name concaveman
       ...
       * //=hull
       */
  def apply(points: js.Array[js.Array[scala.Double]], concavity: scala.Double): js.Array[js.Array[scala.Double]] = js.native
  /**
       * A very fast 2D concave hull algorithm in JavaScript (generates a general outline of a point set).
       *
       * @name concaveman
       ...
       * //=hull
       */
  def apply(points: js.Array[js.Array[scala.Double]], concavity: scala.Double, lengthThreshold: scala.Double): js.Array[js.Array[scala.Double]] = js.native
}
