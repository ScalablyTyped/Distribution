package typings.cordovaDashPluginDashOuralabs.OuralabsPluginNs

import typings.cordovaDashPluginDashOuralabs.Anon_DEBUG
...
trait OuralabsStatic extends js.Object {
  /**
    ...
    */
  var LogLevel: Anon_DEBUG = js.native
  /**
