...
object toolsNs extends js.Object {
  ...
  def clone(source: ScalablyTyped.runtime.StringDictionary[js.Any]): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def copy(source: ScalablyTyped.runtime.StringDictionary[js.Any]): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def createClass(definition: ScalablyTyped.runtime.StringDictionary[js.Any]): js.Any = js.native
  def cssStyleToDomStyle(cssName: java.lang.String): java.lang.String = js.native
  def cssVendorPrefix(property: java.lang.String, value: java.lang.String): ScalablyTyped.runtime.StringDictionary[java.lang.String | scala.Double] = js.native
  def cssVendorPrefix(property: java.lang.String, value: java.lang.String, asString: scala.Boolean): ScalablyTyped.runtime.StringDictionary[java.lang.String | scala.Double] = js.native
  ...
  def extend(
    ...
    source: ScalablyTyped.runtime.StringDictionary[js.Any],
  ...
  def isEmpty(`object`: ScalablyTyped.runtime.StringDictionary[js.Any]): scala.Boolean = js.native
  def keystrokeToArray(lang: ScalablyTyped.runtime.StringDictionary[js.Any], keystroke: scala.Double): ckeditorLib.Anon_AriaDisplay = js.native
  def keystrokeToString(lang: ScalablyTyped.runtime.StringDictionary[js.Any], keystroke: scala.Double): ckeditorLib.Anon_Aria = js.native
  ...
  def objectCompare(
    left: ScalablyTyped.runtime.StringDictionary[js.Any],
    right: ScalablyTyped.runtime.StringDictionary[js.Any]
  ...
  def objectKeys(obj: ScalablyTyped.runtime.StringDictionary[js.Any]): js.Array[java.lang.String] = js.native
  def `override`[T /* <: js.Function */](originalFunction: T, functionBuilder: js.Function1[/* originalFunction */ T, T]): T = js.native
  def parseCssText(styleText: java.lang.String): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def parseCssText(styleText: java.lang.String, normalize: scala.Boolean): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def parseCssText(styleText: java.lang.String, normalize: scala.Boolean, nativeNormalize: scala.Boolean): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  def prototypedCopy(source: ScalablyTyped.runtime.StringDictionary[js.Any]): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  ...
  def writeCssText(styles: ScalablyTyped.runtime.StringDictionary[js.Any]): java.lang.String = js.native
  def writeCssText(styles: ScalablyTyped.runtime.StringDictionary[js.Any], sort: scala.Boolean): java.lang.String = js.native
  @JSName("array")
  @js.native
  object arrayNs extends js.Object {
    ...
    def every[T](
      array: js.Array[T],
      fn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ js.Array[T], scala.Boolean],
      thisArg: ScalablyTyped.runtime.StringDictionary[js.Any]
    ): scala.Boolean = js.native
    def filter[T](
      array: js.Array[T],
      fn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ js.Array[T], scala.Boolean]
  ...
  object objectNs extends js.Object {
    def findKey(obj: ScalablyTyped.runtime.StringDictionary[js.Any], value: js.Any): java.lang.String = js.native
    def merge(
      obj1: ScalablyTyped.runtime.StringDictionary[js.Any],
      obj2: ScalablyTyped.runtime.StringDictionary[js.Any]
    ): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  }
