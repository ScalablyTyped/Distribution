...
class node protected () extends domObject {
  ...
  def getNextSourceNode(startFromSibling: scala.Boolean, nodeType: scala.Double, guard: node): scala.Unit = js.native
  ...
  def getPreviousSourceNode(startFromSibling: scala.Boolean, nodeType: scala.Double, guard: node): scala.Unit = js.native
