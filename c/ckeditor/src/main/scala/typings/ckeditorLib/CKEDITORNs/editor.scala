...
class editor () extends event {
  ...
  var dataProcessor: ckeditorLib.CKEDITORNs.dataProcessor = js.native
  ...
  val focusManager: ckeditorLib.CKEDITORNs.focusManager = js.native
  val id: java.lang.String = js.native
  val keystrokeHandler: ckeditorLib.CKEDITORNs.keystrokeHandler = js.native
  ...
  val ui: ckeditorLib.CKEDITORNs.ui = js.native
  ...
  def editable(): ckeditorLib.CKEDITORNs.editable = js.native
  def editable(elementOrEditable: ckeditorLib.CKEDITORNs.domNs.element): ckeditorLib.CKEDITORNs.editable = js.native
  def editable(elementOrEditable: editable): ckeditorLib.CKEDITORNs.editable = js.native
