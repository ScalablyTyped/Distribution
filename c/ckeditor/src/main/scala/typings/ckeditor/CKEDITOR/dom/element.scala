...
class element protected () extends node {
  ...
  def getDocumentPosition(refDocument: typings.ckeditor.CKEDITOR.dom.document): position = js.native
  ...
  def getFrameDocument(): typings.ckeditor.CKEDITOR.dom.document = js.native
