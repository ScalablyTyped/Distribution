...
object feature {
  ...
  extension [Self <: feature](x: Self) {
    ...
    inline def setContentForms(value: js.Any): Self = StObject.set(x, "contentForms", value.asInstanceOf[js.Any])
    
    inline def setContentFormsUndefined: Self = StObject.set(x, "contentForms", js.undefined)
    
    inline def setContentTransformations(value: js.Any): Self = StObject.set(x, "contentTransformations", value.asInstanceOf[js.Any])
