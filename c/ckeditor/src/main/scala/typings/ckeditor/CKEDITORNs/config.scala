...
import typings.ckeditor.CKEDITORNs.configNs.styleObject
import typings.ckeditor.CKEDITORNs.domNs.element
import typings.ckeditor.CKEDITORNs.editorNs.eventObject
...
trait config extends js.Object {
  ...
  var fillEmptyBlocks: js.UndefOr[
    Boolean | (js.Function1[/* element */ typings.ckeditor.CKEDITORNs.htmlParserNs.element, Boolean])
  ] = js.undefined
  ...
  var toolbarGroups: js.UndefOr[js.Array[typings.ckeditor.CKEDITORNs.toolbarGroups | String]] = js.undefined
...
object config {
  ...
  def apply(
    ...
    fillEmptyBlocks: Boolean | (js.Function1[/* element */ typings.ckeditor.CKEDITORNs.htmlParserNs.element, Boolean]) = null,
