package typings.ckeditor.CKEDITORNs.dialogNs

import typings.ckeditor.CKEDITORNs.dialogNs.definitionNs.button
import typings.ckeditor.CKEDITORNs.dialogNs.definitionNs.content
