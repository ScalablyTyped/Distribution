...
import typings.ckeditor.CKEDITORNs.domNs.documentFragment
import typings.ckeditor.CKEDITORNs.domNs.node
import typings.ckeditor.CKEDITORNs.domNs.range
import typings.ckeditor.CKEDITORNs.domNs.selection
import typings.ckeditor.CKEDITORNs.pluginsNs.copyformattingNs.state
...
import typings.ckeditor.CKEDITORNs.pluginsNs.widgetNs.repository
...
class editor () extends event {
  def this(instanceConfig: typings.ckeditor.CKEDITORNs.config) = this()
  def this(
    instanceConfig: typings.ckeditor.CKEDITORNs.config,
  ...
  val container: typings.ckeditor.CKEDITORNs.domNs.element = js.native
  val contextMenu: typings.ckeditor.CKEDITORNs.pluginsNs.contextMenu = js.native
  var copyFormatting: state = js.native
  var dataProcessor: typings.ckeditor.CKEDITORNs.dataProcessor = js.native
  ...
  val focusManager: typings.ckeditor.CKEDITORNs.focusManager = js.native
  val id: String = js.native
  val keystrokeHandler: typings.ckeditor.CKEDITORNs.keystrokeHandler = js.native
  val lang: js.Any = js.native
  val langCode: String = js.native
  val mode: String = js.native
  val name: String = js.native
  val pasteFilter: typings.ckeditor.CKEDITORNs.filter = js.native
  ...
  val ui: typings.ckeditor.CKEDITORNs.ui = js.native
  val widgets: repository = js.native
  val window: typings.ckeditor.CKEDITORNs.domNs.window = js.native
  ...
  def addRemoveFormatFilter(func: js.Function1[/* element */ typings.ckeditor.CKEDITORNs.domNs.element, Boolean]): Unit = js.native
  ...
  def createFakeElement(
    realElement: typings.ckeditor.CKEDITORNs.domNs.element,
    className: String,
  ...
  def editable(): typings.ckeditor.CKEDITORNs.editable = js.native
  def editable(elementOrEditable: typings.ckeditor.CKEDITORNs.domNs.element): typings.ckeditor.CKEDITORNs.editable = js.native
  def editable(elementOrEditable: typings.ckeditor.CKEDITORNs.editable): typings.ckeditor.CKEDITORNs.editable = js.native
  def elementPath(): typings.ckeditor.CKEDITORNs.domNs.elementPath = js.native
  def elementPath(startNode: node): typings.ckeditor.CKEDITORNs.domNs.elementPath = js.native
  ...
  def getResizable(forContents: Boolean): typings.ckeditor.CKEDITORNs.domNs.element = js.native
  ...
  def insertElement(element: typings.ckeditor.CKEDITORNs.domNs.element): Unit = js.native
  ...
  def restoreRealElement(fakeElement: typings.ckeditor.CKEDITORNs.domNs.element): typings.ckeditor.CKEDITORNs.domNs.element = js.native
  ...
  def setActiveFilter(filter: typings.ckeditor.CKEDITORNs.filter): Unit = js.native
