...
trait vbox extends uiElement {
  var children: js.UndefOr[js.Array[typings.ckeditor.CKEDITORNs.uiNs.dialogNs.uiElement]] = js.undefined
...
object vbox {
  ...
  def apply(
    align: String = null,
    children: js.Array[typings.ckeditor.CKEDITORNs.uiNs.dialogNs.uiElement] = null,
