...
object htmlParser {
  ...
  object fragment {
    ...
    /* static member */
    @scala.inline
    def fromBBCode(source: String): typings.ckeditor.CKEDITOR.htmlParser.fragment = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBBCode")(source.asInstanceOf[js.Any]).asInstanceOf[typings.ckeditor.CKEDITOR.htmlParser.fragment]
