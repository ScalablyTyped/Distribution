...
object dialog {
  ...
  /* static member */
  inline def getCurrent(): typings.ckeditor.CKEDITOR.dialog = ^.asInstanceOf[js.Dynamic].applyDynamic("getCurrent")().asInstanceOf[typings.ckeditor.CKEDITOR.dialog]
  
  /* static member */
  inline def isTabEnabled(editor: typings.ckeditor.CKEDITOR.editor, dialogName: String, tabName: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isTabEnabled")(editor.asInstanceOf[js.Any], dialogName.asInstanceOf[js.Any], tabName.asInstanceOf[js.Any])).asInstanceOf[Boolean]
