...
object libModelsTestCaseHookDefinitionMod {
  
  @JSImport("@cucumber/cucumber/lib/models/test_case_hook_definition", JSImport.Default)
  @js.native
  open class default protected () extends TestCaseHookDefinition {
