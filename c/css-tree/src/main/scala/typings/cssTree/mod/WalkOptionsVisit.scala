...
object WalkOptionsVisit {
  ...
  @scala.inline
  implicit class WalkOptionsVisitOps[Self <: WalkOptionsVisit[_], /* <: typings.cssTree.mod.CssNode */ NodeType] (val x: Self with WalkOptionsVisit[NodeType]) extends AnyVal {
    @scala.inline
