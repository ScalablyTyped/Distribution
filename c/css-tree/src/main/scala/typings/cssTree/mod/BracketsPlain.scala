...
trait BracketsPlain
  ...
  @JSName("type")
  var type_BracketsPlain: typings.cssTree.cssTreeStrings.Brackets = js.native
}

object BracketsPlain {
  @scala.inline
  def apply(children: js.Array[CssNodePlain], `type`: typings.cssTree.cssTreeStrings.Brackets): BracketsPlain = {
  ...
  implicit class BracketsPlainOps[Self <: BracketsPlain] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.cssTree.cssTreeStrings.Brackets): Self = this.set("type", value.asInstanceOf[js.Any])
  }
