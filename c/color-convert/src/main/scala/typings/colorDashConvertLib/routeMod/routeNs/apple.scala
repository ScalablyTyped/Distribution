...
object apple {
  @scala.inline
  def apply(
    ansi16: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.ANSI16,
    ansi256: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.ANSI256,
    cmyk: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.CMYK,
    gray: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.GRAY,
    hcg: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.HCG,
    hex: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.HEX,
    hsl: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.HSL,
    hsv: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.HSV,
    hwb: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.HWB,
    keyword: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.KEYWORD,
    lab: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.LAB,
    lch: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.LCH,
    rgb: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.RGB,
    xyz: colorDashConvertLib.conversionsMod.APPLE => colorDashConvertLib.conversionsMod.XYZ
  ): apple = {
