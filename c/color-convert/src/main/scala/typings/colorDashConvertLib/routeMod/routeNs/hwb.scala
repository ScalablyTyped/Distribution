...
object hwb {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ansi16 = ansi16, ansi256 = ansi256, apple = apple, cmyk = cmyk, gray = gray, hcg = hcg, hex = hex, hsl = hsl, hsv = hsv, keyword = keyword, lab = lab, lch = lch, rgb = rgb, xyz = xyz)
