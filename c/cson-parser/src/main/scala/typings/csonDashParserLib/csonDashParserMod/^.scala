...
object ^ extends js.Object {
  ...
  def stringify(value: js.Any, replacer: csonDashParserLib.csonDashParserMod.ReplacerFunction): java.lang.String = js.native
  def stringify(
    value: js.Any,
    replacer: csonDashParserLib.csonDashParserMod.ReplacerFunction,
    space: java.lang.String
  ): java.lang.String = js.native
  def stringify(value: js.Any, replacer: csonDashParserLib.csonDashParserMod.ReplacerFunction, space: scala.Double): java.lang.String = js.native
