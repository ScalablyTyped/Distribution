...
class Casper protected () extends js.Object {
  ...
  def waitForResource(testFx: js.Function1[/* resource */ Anon_Url, Boolean]): Casper = js.native
  def waitForResource(testFx: js.Function1[/* resource */ Anon_Url, Boolean], `then`: FunctionThen): Casper = js.native
  def waitForResource(
    testFx: js.Function1[/* resource */ Anon_Url, Boolean],
    `then`: FunctionThen,
