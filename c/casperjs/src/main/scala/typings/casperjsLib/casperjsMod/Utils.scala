...
object Utils {
  ...
  def apply(
    ...
    dump: js.Any => js.Any,
    fileExt: java.lang.String => js.Any,
    fillBlanks: (java.lang.String, scala.Double) => js.Any,
    format: (java.lang.String, /* repeated */ js.Any) => js.Any,
    getPropertyPath: (js.Any, java.lang.String) => js.Any,
    ...
    isJsFile: java.lang.String => js.Any,
