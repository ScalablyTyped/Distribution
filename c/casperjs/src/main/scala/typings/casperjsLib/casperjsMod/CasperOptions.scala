...
object CasperOptions {
  ...
  def apply(
    ...
    page: phantomjsLib.WebPage = null,
    pageSettings: js.Any = null,
    remoteScripts: js.Array[_] = null,
    retryTimeout: scala.Int | scala.Double = null,
    safeLogs: js.UndefOr[scala.Boolean] = js.undefined,
    silentErrors: js.UndefOr[scala.Boolean] = js.undefined,
    stepTimeout: scala.Int | scala.Double = null,
