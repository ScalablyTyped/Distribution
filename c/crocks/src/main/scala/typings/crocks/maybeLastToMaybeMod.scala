...
object maybeLastToMaybeMod {
  ...
  /**
    ...
    */
  inline def default(`val`: typings.crocks.lastMod.default): typings.crocks.maybeMaybeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(`val`.asInstanceOf[js.Any]).asInstanceOf[typings.crocks.maybeMaybeMod.default]
}
