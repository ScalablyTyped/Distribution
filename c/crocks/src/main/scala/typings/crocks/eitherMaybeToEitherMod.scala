...
object eitherMaybeToEitherMod {
  ...
  /**
    ...
    */
  inline def default(`val`: typings.crocks.maybeMod.default): typings.crocks.eitherEitherMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(`val`.asInstanceOf[js.Any]).asInstanceOf[typings.crocks.eitherEitherMod.default]
}
