...
object firstToMaybeMod {
  ...
  /**
    ...
    */
  inline def default(`val`: typings.crocks.crocksFirstMod.default): typings.crocks.maybeMaybeMod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(`val`.asInstanceOf[js.Any]).asInstanceOf[typings.crocks.maybeMaybeMod.default]
}
