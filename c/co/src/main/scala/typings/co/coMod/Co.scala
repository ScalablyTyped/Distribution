...
trait Co extends js.Object {
  ...
  def apply[F /* <: js.Function1[/* repeated */ js.Any, Iterator[_]] */](
    fn: F,
  ...
  def co[F /* <: js.Function1[/* repeated */ js.Any, Iterator[_]] */](
    fn: F,
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Parameters<F> is not an array type */ args: Parameters[F]
  ): js.Promise[ExtractType[ReturnType[F]]] = js.native
  def default[F /* <: js.Function1[/* repeated */ js.Any, Iterator[_]] */](
    fn: F,
    /* import warning: parser.TsParser#functionParam $anonfun Dropping repeated marker of param args because its type Parameters<F> is not an array type */ args: Parameters[F]
  ): js.Promise[ExtractType[ReturnType[F]]] = js.native
  def wrap[F /* <: js.Function1[/* repeated */ js.Any, Iterator[_]] */](fn: F): js.Function1[/* args */ Parameters[F], js.Promise[ExtractType[ReturnType[F]]]] = js.native
}
