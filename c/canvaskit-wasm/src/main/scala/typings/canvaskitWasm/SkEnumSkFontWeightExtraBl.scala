...
trait SkEnumSkFontWeightExtraBl extends js.Object {
  val Black: SkFontWeight
  val Bold: SkFontWeight
  val ExtraBlack: SkFontWeight
  val ExtraBold: SkFontWeight
  val ExtraLight: SkFontWeight
  val Light: SkFontWeight
  val Medium: SkFontWeight
  val Normal: SkFontWeight
  val SemiBold: SkFontWeight
  val Thin: SkFontWeight
  val values: js.Array[SkFontWeight]
}
