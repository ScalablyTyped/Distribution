...
object SkRuntimeEffectFactory {
  ...
  inline def apply(Make: String => SkRuntimeEffect | Null): SkRuntimeEffectFactory = {
    val __obj = js.Dynamic.literal(Make = js.Any.fromFunction1(Make))
    __obj.asInstanceOf[SkRuntimeEffectFactory]
  }
  
  extension [Self <: SkRuntimeEffectFactory](x: Self) {
    
    inline def setMake(value: String => SkRuntimeEffect | Null): Self = StObject.set(x, "Make", js.Any.fromFunction1(value))
  }
}
