...
object modalWrapperModalWrapperMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onRequestSubmit
    - typings.carbonComponentsReact.carbonComponentsReactStrings.open
  */
  trait ExcludedModalProps extends StObject
  object ExcludedModalProps {
    
    @scala.inline
    def onRequestClose: typings.carbonComponentsReact.carbonComponentsReactStrings.onRequestClose = "onRequestClose".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onRequestClose]
    
    @scala.inline
    def onRequestSubmit: typings.carbonComponentsReact.carbonComponentsReactStrings.onRequestSubmit = "onRequestSubmit".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onRequestSubmit]
    
    @scala.inline
    def open: typings.carbonComponentsReact.carbonComponentsReactStrings.open = "open".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.open]
  }
  ...
  trait ModalWrapperProps extends StObject {
    ...
    var buttonTriggerClassName: js.UndefOr[String] = js.undefined
    ...
    var handleOpen: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]] = js.undefined
    
    def handleSubmit(): Boolean
    
    var hasForm: js.UndefOr[Boolean] = js.undefined
    
    var hasScrollingContent: js.UndefOr[Boolean] = js.undefined
    ...
    var modalAriaLabel: js.UndefOr[String] = js.undefined
    
    var modalHeading: js.UndefOr[ReactNode] = js.undefined
    
    var modalLabel: js.UndefOr[ReactNode] = js.undefined
    ...
    var onSecondarySubmit: js.UndefOr[
        js.Function1[
          /* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | KeyboardEvent[HTMLDivElement], 
          Unit
        ]
      ] = js.undefined
    ...
    var passiveModal: js.UndefOr[Boolean] = js.undefined
    
    var placeholder: js.UndefOr[String] = js.undefined
    
    var prefix: js.UndefOr[String] = js.undefined
    
    var preventCloseOnClickOutside: js.UndefOr[Boolean] = js.undefined
    ...
    var shouldCloseAfterSubmit: js.UndefOr[Boolean] = js.undefined
    ...
    var triggerButtonKind: js.UndefOr[ButtonKind] = js.undefined
  ...
  object ModalWrapperProps {
    
    @scala.inline
    def apply(handleSubmit: () => Boolean): ModalWrapperProps = {
      val __obj = js.Dynamic.literal(handleSubmit = js.Any.fromFunction0(handleSubmit))
      __obj.asInstanceOf[ModalWrapperProps]
    }
    
    @scala.inline
    implicit class ModalWrapperPropsMutableBuilder[Self <: ModalWrapperProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setButtonTriggerClassName(value: String): Self = StObject.set(x, "buttonTriggerClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonTriggerClassNameUndefined: Self = StObject.set(x, "buttonTriggerClassName", js.undefined)
      
      @scala.inline
      def setButtonTriggerText(value: ReactNode): Self = StObject.set(x, "buttonTriggerText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonTriggerTextUndefined: Self = StObject.set(x, "buttonTriggerText", js.undefined)
      ...
      @scala.inline
      def setHandleOpen(value: /* e */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "handleOpen", js.Any.fromFunction1(value))
      
      @scala.inline
      def setHandleOpenUndefined: Self = StObject.set(x, "handleOpen", js.undefined)
      
      @scala.inline
      def setHandleSubmit(value: () => Boolean): Self = StObject.set(x, "handleSubmit", js.Any.fromFunction0(value))
      
      @scala.inline
      def setHasForm(value: Boolean): Self = StObject.set(x, "hasForm", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHasFormUndefined: Self = StObject.set(x, "hasForm", js.undefined)
      
      @scala.inline
      def setHasScrollingContent(value: Boolean): Self = StObject.set(x, "hasScrollingContent", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHasScrollingContentUndefined: Self = StObject.set(x, "hasScrollingContent", js.undefined)
      ...
      @scala.inline
      def setModalAriaLabel(value: String): Self = StObject.set(x, "modalAriaLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModalAriaLabelUndefined: Self = StObject.set(x, "modalAriaLabel", js.undefined)
      
      @scala.inline
      def setModalHeading(value: ReactNode): Self = StObject.set(x, "modalHeading", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModalHeadingUndefined: Self = StObject.set(x, "modalHeading", js.undefined)
      
      @scala.inline
      def setModalLabel(value: ReactNode): Self = StObject.set(x, "modalLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setModalLabelUndefined: Self = StObject.set(x, "modalLabel", js.undefined)
      ...
      @scala.inline
      def setOnSecondarySubmit(
        value: /* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | KeyboardEvent[HTMLDivElement] => Unit
      ): Self = StObject.set(x, "onSecondarySubmit", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnSecondarySubmitUndefined: Self = StObject.set(x, "onSecondarySubmit", js.undefined)
      ...
      @scala.inline
      def setPassiveModal(value: Boolean): Self = StObject.set(x, "passiveModal", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPassiveModalUndefined: Self = StObject.set(x, "passiveModal", js.undefined)
      ...
      @scala.inline
      def setPreventCloseOnClickOutside(value: Boolean): Self = StObject.set(x, "preventCloseOnClickOutside", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPreventCloseOnClickOutsideUndefined: Self = StObject.set(x, "preventCloseOnClickOutside", js.undefined)
      
      @scala.inline
      def setPrimaryButtonDisabled(value: Boolean): Self = StObject.set(x, "primaryButtonDisabled", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPrimaryButtonDisabledUndefined: Self = StObject.set(x, "primaryButtonDisabled", js.undefined)
      ...
      @scala.inline
      def setRenderTriggerButtonIcon(value: js.Any): Self = StObject.set(x, "renderTriggerButtonIcon", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderTriggerButtonIconUndefined: Self = StObject.set(x, "renderTriggerButtonIcon", js.undefined)
      ...
      @scala.inline
      def setSelectorsFloatingMenus(value: js.Array[String]): Self = StObject.set(x, "selectorsFloatingMenus", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectorsFloatingMenusUndefined: Self = StObject.set(x, "selectorsFloatingMenus", js.undefined)
      
      @scala.inline
      def setSelectorsFloatingMenusVarargs(value: String*): Self = StObject.set(x, "selectorsFloatingMenus", js.Array(value :_*))
      
      @scala.inline
      def setShouldCloseAfterSubmit(value: Boolean): Self = StObject.set(x, "shouldCloseAfterSubmit", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShouldCloseAfterSubmitUndefined: Self = StObject.set(x, "shouldCloseAfterSubmit", js.undefined)
      
      @scala.inline
      def setShouldSubmitOnEnter(value: Boolean): Self = StObject.set(x, "shouldSubmitOnEnter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShouldSubmitOnEnterUndefined: Self = StObject.set(x, "shouldSubmitOnEnter", js.undefined)
      
      @scala.inline
      def setSize(value: CarbonSize): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTriggerButtonIconDescription(value: String): Self = StObject.set(x, "triggerButtonIconDescription", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTriggerButtonIconDescriptionUndefined: Self = StObject.set(x, "triggerButtonIconDescription", js.undefined)
      
      @scala.inline
      def setTriggerButtonKind(value: ButtonKind): Self = StObject.set(x, "triggerButtonKind", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTriggerButtonKindUndefined: Self = StObject.set(x, "triggerButtonKind", js.undefined)
