...
object toolbarSearchToolbarSearchMod {
  
  /**
    * @deprecated
    */
  @JSImport("carbon-components-react/lib/components/ToolbarSearch/ToolbarSearch", JSImport.Default)
  @js.native
  class default ()
    extends Component[ToolbarSearchProps, js.Object, js.Any]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, 'placeholder'> */
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.SizingProps */
  trait InheritedProps extends StObject {
  ...
  object InheritedProps {
    
    @scala.inline
    def apply(): InheritedProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InheritedProps]
    }
    
    @scala.inline
    implicit class InheritedPropsMutableBuilder[Self <: InheritedProps] (val x: Self) extends AnyVal {
  ...
  /**
    * @deprecated
    */
  type ToolbarSearch = Component[ToolbarSearchProps, js.Object, js.Any]
  
  trait ToolbarSearchProps
    extends StObject
       with InheritedProps {
    
    var labelId: js.UndefOr[String] = js.undefined
    
    var labelText: js.UndefOr[ReactNode] = js.undefined
    
    var placeHolderText: js.UndefOr[String] = js.undefined
  }
  object ToolbarSearchProps {
    
    @scala.inline
    def apply(): ToolbarSearchProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ToolbarSearchProps]
    }
    
    @scala.inline
    implicit class ToolbarSearchPropsMutableBuilder[Self <: ToolbarSearchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelText(value: ReactNode): Self = StObject.set(x, "labelText", value.asInstanceOf[js.Any])
