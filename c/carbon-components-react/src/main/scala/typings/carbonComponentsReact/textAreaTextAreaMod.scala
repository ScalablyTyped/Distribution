...
object textAreaTextAreaMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-placeholder`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-placeholder` = "aria-placeholder".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-placeholder`]
