...
object libComponentsLoadingLoadingMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/Loading/Loading", JSImport.Default)
  @js.native
  val default: FC[LoadingProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-atomic`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-labelledby`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-live`
  */
  trait ExcludedAttributes extends StObject
  object ExcludedAttributes {
    
    inline def `aria-atomic`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-atomic` = "aria-atomic".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-atomic`]
    ...
    inline def `aria-live`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-live` = "aria-live".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-live`]
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/Loading/Loading.ExcludedAttributes> */
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsLoadingLoadingMod.foo` */
