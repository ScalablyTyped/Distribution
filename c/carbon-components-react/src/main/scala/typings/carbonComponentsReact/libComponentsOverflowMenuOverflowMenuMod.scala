...
object libComponentsOverflowMenuOverflowMenuMod extends Shortcut {
  ...
  */
  ...
  object OverflowMenuProps {
    ...
    inline def apply(): OverflowMenuProps = {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsOverflowMenuOverflowMenuMod.foo` */
