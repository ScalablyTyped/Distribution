...
object tableToolbarActionMod {
  ...
  */
  ...
  object AllTableToolbarActionProps {
    ...
    inline def TableToolbarActionAnchorProps(href: String): typings.carbonComponentsReact.tableToolbarActionMod.TableToolbarActionAnchorProps = {
      val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.carbonComponentsReact.tableToolbarActionMod.TableToolbarActionAnchorProps]
    }
    
    inline def TableToolbarActionButtonProps(): typings.carbonComponentsReact.tableToolbarActionMod.TableToolbarActionButtonProps = {
  ...
  object TableToolbarActionAnchorProps {
    ...
    inline def apply(href: String): TableToolbarActionAnchorProps = {
      val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
  ...
  object TableToolbarActionButtonProps {
    ...
    inline def apply(): TableToolbarActionButtonProps = {
      val __obj = js.Dynamic.literal()
