...
object tableToolbarActionMod {
  ...
  */
  ...
  object AllTableToolbarActionProps {
    ...
    inline def TableToolbarActionAnchorProps(children: NonNullable[ReactNode], href: String): typings.carbonComponentsReact.tableToolbarActionMod.TableToolbarActionAnchorProps = {
    ...
    inline def TableToolbarActionButtonProps(children: NonNullable[ReactNode]): typings.carbonComponentsReact.tableToolbarActionMod.TableToolbarActionButtonProps = {
  ...
  object TableToolbarActionAnchorProps {
    ...
    inline def apply(children: NonNullable[ReactNode], href: String): TableToolbarActionAnchorProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], href = href.asInstanceOf[js.Any])
    ...
    extension [Self <: TableToolbarActionAnchorProps](x: Self) {
      ...
      inline def setIsDelete(value: Boolean): Self = StObject.set(x, "isDelete", value.asInstanceOf[js.Any])
      
      inline def setIsDeleteUndefined: Self = StObject.set(x, "isDelete", js.undefined)
      ...
      inline def setItemText(value: ReactNode): Self = StObject.set(x, "itemText", value.asInstanceOf[js.Any])
      ...
      inline def setPrimaryFocus(value: Boolean): Self = StObject.set(x, "primaryFocus", value.asInstanceOf[js.Any])
      
      inline def setPrimaryFocusUndefined: Self = StObject.set(x, "primaryFocus", js.undefined)
      ...
      inline def setRequireTitle(value: Boolean): Self = StObject.set(x, "requireTitle", value.asInstanceOf[js.Any])
      
      inline def setRequireTitleUndefined: Self = StObject.set(x, "requireTitle", js.undefined)
  ...
  object TableToolbarActionButtonProps {
    ...
    inline def apply(children: NonNullable[ReactNode]): TableToolbarActionButtonProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
