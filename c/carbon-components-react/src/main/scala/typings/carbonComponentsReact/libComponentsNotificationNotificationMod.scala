...
import typings.carbonComponentsReact.carbonComponentsReactStrings.reset
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.submit
...
import typings.carbonComponentsReact.libComponentsButtonButtonMod.ButtonProps
...
object libComponentsNotificationNotificationMod {
  
  @JSImport("carbon-components-react/lib/components/Notification/Notification", "InlineNotification")
  @js.native
  val InlineNotification: FC[InlineNotificationProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/Notification/Notification", "NotificationActionButton")
  @js.native
  val NotificationActionButton: FC[NotificationActionButtonProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/Notification/Notification", "NotificationButton")
  @js.native
  val NotificationButton: FC[NotificationButtonProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/Notification/Notification", "NotificationTextDetails")
  @js.native
  val NotificationTextDetails: FC[NotificationTextDetailsProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/Notification/Notification", "ToastNotification")
  @js.native
  val ToastNotification: FC[ToastNotificationProps] = js.native
  
  // NotificationTextDetail
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.className
    - typings.carbonComponentsReact.carbonComponentsReactStrings.title
  */
  trait ExcludedDetailDivAttributes extends StObject
  object ExcludedDetailDivAttributes {
    
    inline def className: typings.carbonComponentsReact.carbonComponentsReactStrings.className = "className".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.className]
    
    inline def title: typings.carbonComponentsReact.carbonComponentsReactStrings.title = "title".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.title]
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'title'> */
  trait InlineNotificationProps extends StObject {
    ...
    var lowContrast: js.UndefOr[Boolean] = js.undefined
    ...
    var onClose: js.UndefOr[js.Function1[/* evt */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Boolean]] = js.undefined
    
    var onCloseButtonClick: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
    ...
    var statusIconDescription: js.UndefOr[String] = js.undefined
  ...
  object InlineNotificationProps {
    
    inline def apply(kind: NotificationKind): InlineNotificationProps = {
    ...
    implicit open class MutableBuilder[Self <: InlineNotificationProps] (val x: Self) extends AnyVal {
      ...
      inline def setKind(value: NotificationKind): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      
      inline def setLang(value: String): Self = StObject.set(x, "lang", value.asInstanceOf[js.Any])
      
      inline def setLangUndefined: Self = StObject.set(x, "lang", js.undefined)
      
      inline def setLowContrast(value: Boolean): Self = StObject.set(x, "lowContrast", value.asInstanceOf[js.Any])
      
      inline def setLowContrastUndefined: Self = StObject.set(x, "lowContrast", js.undefined)
      ...
      inline def setOnClose(value: /* evt */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Boolean): Self = StObject.set(x, "onClose", js.Any.fromFunction1(value))
      
      inline def setOnCloseButtonClick(value: /* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onCloseButtonClick", js.Any.fromFunction1(value))
      ...
      inline def setStatusIconDescription(value: String): Self = StObject.set(x, "statusIconDescription", value.asInstanceOf[js.Any])
      
      inline def setStatusIconDescriptionUndefined: Self = StObject.set(x, "statusIconDescription", js.undefined)
  ...
  type NotificationActionButtonProps = ButtonProps
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, 'title'> */
  trait NotificationButtonProps extends StObject {
  ...
  object NotificationButtonProps {
    
    inline def apply(): NotificationButtonProps = {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.info
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`info-square`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.success
    - typings.carbonComponentsReact.carbonComponentsReactStrings.warning
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`warning-alt`
  */
  trait NotificationKind extends StObject
  object NotificationKind {
    ...
    inline def info: typings.carbonComponentsReact.carbonComponentsReactStrings.info = "info".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.info]
    
    inline def `info-square`: typings.carbonComponentsReact.carbonComponentsReactStrings.`info-square` = "info-square".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`info-square`]
    
    inline def success: typings.carbonComponentsReact.carbonComponentsReactStrings.success = "success".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.success]
    
    inline def warning: typings.carbonComponentsReact.carbonComponentsReactStrings.warning = "warning".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.warning]
    
    inline def `warning-alt`: typings.carbonComponentsReact.carbonComponentsReactStrings.`warning-alt` = "warning-alt".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`warning-alt`]
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/Notification/Notification.ExcludedDetailDivAttributes> */
  trait NotificationTextDetailsProps extends StObject {
  ...
  object NotificationTextDetailsProps {
    
    inline def apply(): NotificationTextDetailsProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`inline`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.toast
  */
  ...
  object NotificationType {
    ...
    inline def toast: typings.carbonComponentsReact.carbonComponentsReactStrings.toast = "toast".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.toast]
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'title'> */
  trait ToastNotificationProps extends StObject {
    ...
    var kind: js.UndefOr[NotificationKind] = js.undefined
    ...
    var onCloseButtonClick: js.UndefOr[js.Function1[/* evt */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
  ...
  object ToastNotificationProps {
    
    inline def apply(): ToastNotificationProps = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: ToastNotificationProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnCloseButtonClick(value: /* evt */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onCloseButtonClick", js.Any.fromFunction1(value))
