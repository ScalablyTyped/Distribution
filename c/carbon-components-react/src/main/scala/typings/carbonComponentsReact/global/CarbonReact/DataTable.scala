...
@JSGlobal("CarbonReact.DataTable")
@js.native
class DataTable[R /* <: DataTableRow[String] */, H /* <: DataTableHeader[String] */] ()
  extends typings.carbonComponentsReact.mod.DataTable[R, H]
object DataTable {
  ...
  /* static member */
  /* was `typeof Table` */
  @JSGlobal("CarbonReact.DataTable.Table")
  @js.native
  val Table: FC[TableProps] = js.native
  
  /* static member */
  /* was `typeof TableActionList` */
  @JSGlobal("CarbonReact.DataTable.TableActionList")
  @js.native
