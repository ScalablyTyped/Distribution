...
object libComponentsUishellSkipToContentMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/UIShell/SkipToContent", JSImport.Default)
  @js.native
  val default: FC[SkipToContentProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAnchorAttr<std.HTMLAnchorElement>, 'children'> */
  trait SkipToContentProps extends StObject {
  ...
  object SkipToContentProps {
    
    inline def apply(): SkipToContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SkipToContentProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SkipToContentProps] (val x: Self) extends AnyVal {
  ...
  type _To = FC[SkipToContentProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsUishellSkipToContentMod.foo` */
  override def _to: FC[SkipToContentProps] = default
}
