...
object libComponentsNumberInputNumberInputMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/NumberInput/NumberInput", JSImport.Default)
  @js.native
  ...
  */
  ...
  object NumberInputProps {
    ...
    inline def apply(id: String, value: Double | _empty): NumberInputProps = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.decrementDotnumber
    - typings.carbonComponentsReact.carbonComponentsReactStrings.incrementDotnumber
  */
  trait NumberInputTranslationKey
    extends StObject
       with _CarbonTranslationKey
  object NumberInputTranslationKey {
    
    inline def decrementDotnumber: typings.carbonComponentsReact.carbonComponentsReactStrings.decrementDotnumber = "decrement.number".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.decrementDotnumber]
    
    inline def incrementDotnumber: typings.carbonComponentsReact.carbonComponentsReactStrings.incrementDotnumber = "increment.number".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.incrementDotnumber]
  }
  
  type _To = ForwardRefReturn[HTMLInputElement, NumberInputProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsNumberInputNumberInputMod.foo` */
