...
object libComponentsStructuredListStructuredListMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListLabelRowProps
    - typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListDivRowProps
  */
  trait AllStructuredListRowProps extends StObject
  object AllStructuredListRowProps {
    
    inline def StructuredListDivRowProps(): typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListDivRowProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListDivRowProps]
    }
    
    inline def StructuredListLabelRowProps(): typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListLabelRowProps = {
      val __obj = js.Dynamic.literal(label = true)
      __obj.asInstanceOf[typings.carbonComponentsReact.libComponentsStructuredListStructuredListMod.StructuredListLabelRowProps]
    }
  }
  ...
  */
  trait ExcludedListInputPropKeys extends StObject
  object ExcludedListInputPropKeys {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/StructuredList/StructuredList.ExcludedListInputPropKeys> */
  ...
  trait StructuredListWrapperProps
    extends StObject
    ...
    var isCondensed: js.UndefOr[Boolean] = js.undefined
    
    var isFlush: js.UndefOr[Boolean] = js.undefined
    
    var selection: js.UndefOr[Boolean] = js.undefined
  }
  object StructuredListWrapperProps {
    
    inline def apply(): StructuredListWrapperProps = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: StructuredListWrapperProps] (val x: Self) extends AnyVal {
      ...
      inline def setIsCondensed(value: Boolean): Self = StObject.set(x, "isCondensed", value.asInstanceOf[js.Any])
      
      inline def setIsCondensedUndefined: Self = StObject.set(x, "isCondensed", js.undefined)
      
      inline def setIsFlush(value: Boolean): Self = StObject.set(x, "isFlush", value.asInstanceOf[js.Any])
      
      inline def setIsFlushUndefined: Self = StObject.set(x, "isFlush", js.undefined)
