...
object libComponentsDataTableTableContainerMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/DataTable/TableContainer", JSImport.Default)
  @js.native
  val default: FC[TableContainerProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'title'> */
  trait TableContainerProps extends StObject {
  ...
  object TableContainerProps {
    
    inline def apply(): TableContainerProps = {
  ...
  type _To = FC[TableContainerProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsDataTableTableContainerMod.foo` */
  override def _to: FC[TableContainerProps] = default
}
