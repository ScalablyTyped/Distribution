...
object propsMod {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def defaultValue: typings.carbonComponentsReact.carbonComponentsReactStrings.defaultValue = "defaultValue".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.defaultValue]
    
    @scala.inline
    def id: typings.carbonComponentsReact.carbonComponentsReactStrings.id = "id".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.id]
    
    @scala.inline
    def size: typings.carbonComponentsReact.carbonComponentsReactStrings.size = "size".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.size]
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/TextInput/props.ExcludedAttributes> */
  trait TextInputSharedProps extends StObject {
    ...
    var labelText: NonNullable[ReactNode]
  ...
  object TextInputSharedProps {
    
    @scala.inline
    def apply(id: String): TextInputSharedProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[TextInputSharedProps]
    }
    
    @scala.inline
    implicit class TextInputSharedPropsMutableBuilder[Self <: TextInputSharedProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelText(value: NonNullable[ReactNode]): Self = StObject.set(x, "labelText", value.asInstanceOf[js.Any])
