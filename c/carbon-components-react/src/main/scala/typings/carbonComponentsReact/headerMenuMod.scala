...
object headerMenuMod {
  ...
  inline def default[RP](props: HeaderMenuForwardRefProps[RP]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  
  type HeaderMenu = Component[HeaderMenuProps[js.Object], js.Object, Any]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/UIShell/HeaderMenu.HeaderMenuProps<RP>, 'focusRef' | 'ref'> */
  trait HeaderMenuForwardRefProps[RP] extends StObject {
  ...
  object HeaderMenuForwardRefProps {
    
    inline def apply[RP](menuLinkName: String): HeaderMenuForwardRefProps[RP] = {
  ...
  trait HeaderMenuProps[RP]
    extends StObject
       with LiHTMLAttributes[HTMLLIElement] {
    
    var focusRef: js.UndefOr[js.Function1[/* element */ HTMLElement, Unit]] = js.undefined
  ...
  object HeaderMenuProps {
    ...
    extension [Self <: HeaderMenuProps[?], RP](x: Self & HeaderMenuProps[RP]) {
      ...
      inline def setFocusRefUndefined: Self = StObject.set(x, "focusRef", js.undefined)
