...
object libComponentsTreeViewTreeNodeMod extends Shortcut {
  ...
  object TreeNodeStandaloneProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TreeNodeStandaloneProps] (val x: Self) extends AnyVal {
  ...
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsTreeViewTreeNodeMod.foo` */
