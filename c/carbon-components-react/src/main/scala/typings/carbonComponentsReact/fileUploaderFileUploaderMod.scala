...
object fileUploaderFileUploaderMod {
  ...
  @js.native
  open class default protected () extends FileUploader {
  ...
  open class FileUploader protected ()
    extends Component[FileUploaderProps, js.Object, Any] {
    def this(props: FileUploaderProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  object FileUploaderProps {
    ...
    extension [Self <: FileUploaderProps](x: Self) {
      ...
      inline def setButtonKind(value: ButtonKind): Self = StObject.set(x, "buttonKind", value.asInstanceOf[js.Any])
      ...
      inline def setFilenameStatus(value: FileStatus): Self = StObject.set(x, "filenameStatus", value.asInstanceOf[js.Any])
      
      inline def setFilenameStatusUndefined: Self = StObject.set(x, "filenameStatus", js.undefined)
      ...
      inline def setLabelDescription(value: String): Self = StObject.set(x, "labelDescription", value.asInstanceOf[js.Any])
      ...
      inline def setLabelTitle(value: String): Self = StObject.set(x, "labelTitle", value.asInstanceOf[js.Any])
      ...
      inline def setOnDelete(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
