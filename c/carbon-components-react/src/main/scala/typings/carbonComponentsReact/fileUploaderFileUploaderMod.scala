...
object fileUploaderFileUploaderMod {
  ...
  @JSImport("carbon-components-react/lib/components/FileUploader/FileUploader", JSImport.Default)
  @js.native
  ...
  @JSImport("carbon-components-react/lib/components/FileUploader/FileUploader", "FileUploader")
  @js.native
  class FileUploader protected ()
    extends Component[FileUploaderProps, js.Object, js.Any] {
    def this(props: FileUploaderProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
  ...
  trait FileUploaderProps extends StObject {
    ...
    var buttonKind: js.UndefOr[ButtonKind] = js.undefined
    ...
    var filenameStatus: js.UndefOr[FileStatus] = js.undefined
    ...
    var labelDescription: js.UndefOr[String] = js.undefined
    
    var labelText: js.UndefOr[ReactNode] = js.undefined
    
    var labelTitle: js.UndefOr[String] = js.undefined
    ...
    var onDelete: js.UndefOr[js.Function1[/* event */ MouseEvent[HTMLElement, NativeMouseEvent], Unit]] = js.undefined
  ...
  object FileUploaderProps {
    ...
    implicit class FileUploaderPropsMutableBuilder[Self <: FileUploaderProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setButtonKind(value: ButtonKind): Self = StObject.set(x, "buttonKind", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setButtonKindUndefined: Self = StObject.set(x, "buttonKind", js.undefined)
      ...
      @scala.inline
      def setFilenameStatus(value: FileStatus): Self = StObject.set(x, "filenameStatus", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFilenameStatusUndefined: Self = StObject.set(x, "filenameStatus", js.undefined)
      ...
      @scala.inline
      def setLabelDescription(value: String): Self = StObject.set(x, "labelDescription", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelDescriptionUndefined: Self = StObject.set(x, "labelDescription", js.undefined)
      ...
      @scala.inline
      def setLabelTitle(value: String): Self = StObject.set(x, "labelTitle", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnDelete(value: /* event */ MouseEvent[HTMLElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onDelete", js.Any.fromFunction1(value))
