...
object tabContentTabContentMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/TabContent/TabContent", JSImport.Default)
  @js.native
  val default: FC[TabContentProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'hidden'> */
  ...
  /* This means you don't have to write `default`, but can instead just say `tabContentTabContentMod.foo` */
