...
object libComponentsListBoxNextListBoxTriggerMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ListBox/next/ListBoxTrigger", JSImport.Default)
  @js.native
  val default: FC[ListBoxTriggerProps] = js.native
  ...
  */
  trait ExcludedButtonPropKeys extends StObject
  object ExcludedButtonPropKeys {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, carbon-components-react.carbon-components-react/lib/components/ListBox/next/ListBoxTrigger.ExcludedButtonPropKeys> */
  ...
  trait ListBoxTriggerProps extends StObject {
  ...
  object ListBoxTriggerProps {
    
    inline def apply(isOpen: Boolean): ListBoxTriggerProps = {
      val __obj = js.Dynamic.literal(isOpen = isOpen.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListBoxTriggerProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListBoxTriggerProps] (val x: Self) extends AnyVal {
  ...
  type _To = FC[ListBoxTriggerProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsListBoxNextListBoxTriggerMod.foo` */
  override def _to: FC[ListBoxTriggerProps] = default
}
