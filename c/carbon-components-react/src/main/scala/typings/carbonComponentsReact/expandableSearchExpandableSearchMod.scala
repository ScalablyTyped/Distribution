...
object expandableSearchExpandableSearchMod extends Shortcut {
  ...
  */
  ...
  object ExpandableSearchProps {
    ...
    inline def apply(labelText: NonNullable[ReactNode]): ExpandableSearchProps = {
      val __obj = js.Dynamic.literal(labelText = labelText.asInstanceOf[js.Any])
      __obj.asInstanceOf[ExpandableSearchProps]
    }
    
    extension [Self <: ExpandableSearchProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `expandableSearchExpandableSearchMod.foo` */
