...
object copyCopyMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/Copy/Copy", JSImport.Default)
  @js.native
  val default: FC[CopyProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, 'aria-live'> */
  /* Inlined parent carbon-components-react.carbon-components-react/lib/components/Copy/Copy.FeedbackProps */
  trait CopyProps extends StObject {
  ...
  object CopyProps {
    ...
    @scala.inline
    implicit class CopyPropsMutableBuilder[Self <: CopyProps] (val x: Self) extends AnyVal {
  ...
  trait FeedbackProps extends StObject {
    
    var feedback: js.UndefOr[String] = js.undefined
    
    var feedbackTimeout: js.UndefOr[Double] = js.undefined
  }
  object FeedbackProps {
    
    @scala.inline
    def apply(): FeedbackProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FeedbackProps]
    }
    
    @scala.inline
    implicit class FeedbackPropsMutableBuilder[Self <: FeedbackProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `copyCopyMod.foo` */
