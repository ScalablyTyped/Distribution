...
object listBoxMenuMod extends Shortcut {
  ...
  object ListBoxMenuProps {
    ...
    @scala.inline
    def apply(id: String): ListBoxMenuProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListBoxMenuProps]
    }
    
    @scala.inline
    implicit class ListBoxMenuPropsMutableBuilder[Self <: ListBoxMenuProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `listBoxMenuMod.foo` */
