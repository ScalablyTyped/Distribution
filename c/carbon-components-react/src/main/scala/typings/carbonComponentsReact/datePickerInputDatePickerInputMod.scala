...
import typings.carbonComponentsReact.carbonComponentsReactStrings.range
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.simple
import typings.carbonComponentsReact.carbonComponentsReactStrings.single
...
object datePickerInputDatePickerInputMod {
  ...
  trait DatePickerInputProps extends StObject {
    ...
    var datePickerType: js.UndefOr[range | simple | single] = js.undefined
  ...
  object DatePickerInputProps {
    ...
    @scala.inline
    def apply(id: String): DatePickerInputProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[DatePickerInputProps]
    }
    
    @scala.inline
    implicit class DatePickerInputPropsMutableBuilder[Self <: DatePickerInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDatePickerType(value: range | simple | single): Self = StObject.set(x, "datePickerType", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDatePickerTypeUndefined: Self = StObject.set(x, "datePickerType", js.undefined)
      ...
      @scala.inline
      def setOpenCalendar(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "openCalendar", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOpenCalendarUndefined: Self = StObject.set(x, "openCalendar", js.undefined)
