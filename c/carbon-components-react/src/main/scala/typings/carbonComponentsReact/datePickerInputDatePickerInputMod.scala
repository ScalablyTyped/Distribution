...
object datePickerInputDatePickerInputMod {
  ...
  object DatePickerInputProps {
    ...
    extension [Self <: DatePickerInputProps](x: Self) {
      ...
      inline def setDatePickerType(value: range | simple | single): Self = StObject.set(x, "datePickerType", value.asInstanceOf[js.Any])
      ...
      inline def setOpenCalendar(value: MouseEvent[Element, NativeMouseEvent] => Unit): Self = StObject.set(x, "openCalendar", js.Any.fromFunction1(value))
      
      inline def setOpenCalendarUndefined: Self = StObject.set(x, "openCalendar", js.undefined)
