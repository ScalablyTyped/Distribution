...
object dropdownDropdownMod {
  ...
  @JSImport("carbon-components-react/lib/components/Dropdown/Dropdown", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'id' | 'onChange'> */
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.InternationalProps<carbon-components-react.carbon-components-react/lib/components/ListBox/ListBoxMenuIcon.ListBoxMenuIconTranslationKey> */
  trait DropdownProps[ItemType] extends StObject {
    ...
    var itemToElement: js.UndefOr[ComponentType[ItemType]] = js.undefined
    ...
    var onChange: js.UndefOr[js.Function1[/* data */ OnChangeData[ItemType], Unit]] = js.undefined
    ...
    var titleText: NonNullable[ReactNode]
    
    var translate: js.UndefOr[yes | no] = js.undefined
    
    var translateWithId: js.UndefOr[js.Function1[/* messageId */ ListBoxMenuIconTranslationKey, String]] = js.undefined
  ...
  object DropdownProps {
    ...
    @scala.inline
    def apply[ItemType](id: String, items: js.Array[ItemType]): DropdownProps[ItemType] = {
    ...
    @scala.inline
    implicit class DropdownPropsMutableBuilder[Self <: DropdownProps[?], ItemType] (val x: Self & DropdownProps[ItemType]) extends AnyVal {
      ...
      @scala.inline
      def setDirection(value: bottom | top): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setInitialSelectedItem(value: ItemType): Self = StObject.set(x, "initialSelectedItem", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setItemToElement(value: ComponentType[ItemType]): Self = StObject.set(x, "itemToElement", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemToElementUndefined: Self = StObject.set(x, "itemToElement", js.undefined)
      ...
      @scala.inline
      def setLabel(value: NonNullable[ReactNode]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: /* data */ OnChangeData[ItemType] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTitleText(value: NonNullable[ReactNode]): Self = StObject.set(x, "titleText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ ListBoxMenuIconTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  trait OnChangeData[ItemType] extends StObject {
  ...
  object OnChangeData {
    ...
    @scala.inline
    def apply[ItemType](): OnChangeData[ItemType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OnChangeData[ItemType]]
    }
    
    @scala.inline
    implicit class OnChangeDataMutableBuilder[Self <: OnChangeData[?], ItemType] (val x: Self & OnChangeData[ItemType]) extends AnyVal {
