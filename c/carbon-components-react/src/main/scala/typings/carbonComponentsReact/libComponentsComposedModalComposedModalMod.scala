...
object libComponentsComposedModalComposedModalMod {
  ...
  trait ComposedModalProps extends StObject {
    ...
    var onClose: js.UndefOr[js.Function0[Boolean | Unit]] = js.undefined
  ...
  object ComposedModalProps {
    
    inline def apply(): ComposedModalProps = {
    ...
    implicit open class MutableBuilder[Self <: ComposedModalProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnClose(value: () => Boolean | Unit): Self = StObject.set(x, "onClose", js.Any.fromFunction0(value))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onTransitionEnd
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def onTransitionEnd: typings.carbonComponentsReact.carbonComponentsReactStrings.onTransitionEnd = "onTransitionEnd".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onTransitionEnd]
  ...
  trait ModalFooterProps
    ...
    var closeModal: js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.undefined
    ...
    var onRequestSubmit: js.UndefOr[MouseEventHandler[HTMLButtonElement]] = js.undefined
  ...
  object ModalFooterProps {
    ...
    implicit open class MutableBuilder[Self <: ModalFooterProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnRequestClose(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onRequestClose", js.Any.fromFunction1(value))
      
      inline def setOnRequestCloseUndefined: Self = StObject.set(x, "onRequestClose", js.undefined)
      
      inline def setOnRequestSubmit(value: MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onRequestSubmit", js.Any.fromFunction1(value))
      
      inline def setOnRequestSubmitUndefined: Self = StObject.set(x, "onRequestSubmit", js.undefined)
      ...
      inline def setPrimaryClassName(value: String): Self = StObject.set(x, "primaryClassName", value.asInstanceOf[js.Any])
      
      inline def setPrimaryClassNameUndefined: Self = StObject.set(x, "primaryClassName", js.undefined)
  ...
  object ModalFooterSecondaryButtonConfig {
    ...
    inline def apply(): ModalFooterSecondaryButtonConfig = {
      val __obj = js.Dynamic.literal()
  ...
  trait ModalHeaderProps extends StObject {
    ...
    var buttonOnClick: js.UndefOr[js.Function1[/* event */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
    ...
    var closeIconClassName: js.UndefOr[String] = js.undefined
    
    var closeModal: js.UndefOr[js.Function0[Unit]] = js.undefined
  ...
  object ModalHeaderProps {
    ...
    implicit open class MutableBuilder[Self <: ModalHeaderProps] (val x: Self) extends AnyVal {
      ...
      inline def setButtonOnClick(value: /* event */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "buttonOnClick", js.Any.fromFunction1(value))
      
      inline def setButtonOnClickUndefined: Self = StObject.set(x, "buttonOnClick", js.undefined)
      ...
      inline def setCloseIconClassNameUndefined: Self = StObject.set(x, "closeIconClassName", js.undefined)
