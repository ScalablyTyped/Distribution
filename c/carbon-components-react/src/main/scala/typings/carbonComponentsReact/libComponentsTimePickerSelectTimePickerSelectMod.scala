...
object libComponentsTimePickerSelectTimePickerSelectMod {
  
  @JSImport("carbon-components-react/lib/components/TimePickerSelect/TimePickerSelect", JSImport.Default)
  @js.native
  open class default ()
    extends Component[TimePickerSelectProps, js.Object, Any]
  
  type TimePickerSelect = Component[TimePickerSelectProps, js.Object, Any]
  
  /* Inlined parent std.Omit<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, 'id'> */
  trait TimePickerSelectProps extends StObject {
  ...
  object TimePickerSelectProps {
    
    inline def apply(id: String): TimePickerSelectProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[TimePickerSelectProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TimePickerSelectProps] (val x: Self) extends AnyVal {
