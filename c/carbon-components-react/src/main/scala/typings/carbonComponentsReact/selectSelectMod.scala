...
object selectSelectMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-invalid`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-invalid` = "aria-invalid".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-invalid`]
  ...
  object SelectProps {
    ...
    @scala.inline
    def apply(id: String): SelectProps = {
    ...
    implicit class SelectPropsMutableBuilder[Self <: SelectProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setNoLabel(value: Boolean): Self = StObject.set(x, "noLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setNoLabelUndefined: Self = StObject.set(x, "noLabel", js.undefined)
