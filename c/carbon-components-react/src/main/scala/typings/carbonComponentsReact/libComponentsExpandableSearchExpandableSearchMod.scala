...
object libComponentsExpandableSearchExpandableSearchMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ExpandableSearch/ExpandableSearch", JSImport.Default)
  @js.native
  ...
  */
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/Search.SearchProps, carbon-components-react.carbon-components-react/lib/components/ExpandableSearch/ExpandableSearch.ExcludedPropKeys> */
  trait ExpandableSearchProps extends StObject {
  ...
  object ExpandableSearchProps {
    
    inline def apply(): ExpandableSearchProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExpandableSearchProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ExpandableSearchProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsExpandableSearchExpandableSearchMod.foo` */
