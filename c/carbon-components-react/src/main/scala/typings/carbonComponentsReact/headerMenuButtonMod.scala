...
object headerMenuButtonMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/UIShell/HeaderMenuButton", JSImport.Default)
  @js.native
  val default: FC[HeaderMenuButtonProps] = js.native
  ...
  */
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, carbon-components-react.carbon-components-react/lib/components/UIShell/HeaderMenuButton.ExcludedAttributes> */
  trait HeaderMenuButtonProps extends StObject {
    ...
    var renderCloseIcon: js.UndefOr[ReactNode] = js.undefined
    
    var renderMenuIcon: js.UndefOr[ReactNode] = js.undefined
  ...
  object HeaderMenuButtonProps {
    
    inline def apply(): HeaderMenuButtonProps = {
    ...
    extension [Self <: HeaderMenuButtonProps](x: Self) {
      ...
      inline def setRenderCloseIcon(value: ReactNode): Self = StObject.set(x, "renderCloseIcon", value.asInstanceOf[js.Any])
      
      inline def setRenderCloseIconUndefined: Self = StObject.set(x, "renderCloseIcon", js.undefined)
      
      inline def setRenderMenuIcon(value: ReactNode): Self = StObject.set(x, "renderMenuIcon", value.asInstanceOf[js.Any])
      
      inline def setRenderMenuIconUndefined: Self = StObject.set(x, "renderMenuIcon", js.undefined)
  ...
  type _To = FC[HeaderMenuButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `headerMenuButtonMod.foo` */
  override def _to: FC[HeaderMenuButtonProps] = default
}
