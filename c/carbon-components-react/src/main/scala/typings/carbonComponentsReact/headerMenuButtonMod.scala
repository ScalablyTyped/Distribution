...
object headerMenuButtonMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def title: typings.carbonComponentsReact.carbonComponentsReactStrings.title = "title".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.title]
  ...
  object HeaderMenuButtonProps {
    ...
    @scala.inline
    def apply(): HeaderMenuButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HeaderMenuButtonProps]
    }
    
    @scala.inline
    implicit class HeaderMenuButtonPropsMutableBuilder[Self <: HeaderMenuButtonProps] (val x: Self) extends AnyVal {
