...
import typings.carbonComponentsReact.carbonComponentsReactStrings.multi
...
object codeSnippetCodeSnippetMod {
  
  @JSImport("carbon-components-react/lib/components/CodeSnippet/CodeSnippet", JSImport.Namespace)
  @js.native
  ...
  trait CodeSnippetDivProps
    extends StObject
       with SharedProps
       with InheritedDivProps {
    
    var `type`: js.UndefOr[single | multi | Null] = js.undefined
  }
  object CodeSnippetDivProps {
    
    @scala.inline
    def apply(): CodeSnippetDivProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CodeSnippetDivProps]
    }
    
    @scala.inline
    implicit class CodeSnippetDivPropsMutableBuilder[Self <: CodeSnippetDivProps] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setType(value: single | multi): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  - typings.carbonComponentsReact.codeSnippetCodeSnippetMod.InheritedInlineProps because var conflicts: feedback. Inlined translate, inlist, formAction, `aria-activedescendant`, onMouseEnter, onLoadedData, unselectable, placeholder, `aria-multiselectable`, title, slot, onClick, className, onTouchStart, onDrop, `aria-grabbed`, onDragOver, autoSave, onAnimationIteration, spellCheck, role, `aria-multiline`, about, dir, onPlaying, `aria-current`, itemType, disabled, `aria-relevant`, `aria-placeholder`, autoCorrect, onPointerMove, `aria-label`, `aria-rowcount`, onPaste, `aria-busy`, resource, onSeeked, tabIndex, onError, onTimeUpdate, `aria-roledescription`, color, onEnded, onPointerCancel, autoCapitalize, inputMode, onCompositionUpdate, onMouseMove, onSelect, onStalled, onPointerOut, onAuxClick, `aria-autocomplete`, onCopy, `aria-keyshortcuts`, value, onDurationChange, `aria-orientation`, onVolumeChange, lang, `aria-owns`, `aria-atomic`, `aria-dropeffect`, property, style, is, onLoadedMetadata, `aria-labelledby`, formMethod, onTransitionEnd, onMouseOver, onChange, datatype, onDragStart, onSeeking, `aria-flowto`, onAnimationEnd, onCanPlay, `aria-readonly`, onMouseOut, onKeyDown, `aria-pressed`, onMouseLeave, contextMenu, onProgress, `aria-level`, contentEditable, onPointerLeave, onMouseUp, onInput, itemRef, autoFocus, results, accessKey, `aria-haspopup`, `aria-posinset`, onInvalid, `aria-required`, vocab, `aria-describedby`, onSuspend, formEncType, onLoad, onTouchCancel, formNoValidate, onAnimationStart, onTouchMove, onPointerEnter, `aria-controls`, feedbackTimeout, `aria-modal`, onDragEnter, formTarget, onPointerOver, onWaiting, onReset, `aria-selected`, onPlay, onKeyUp, onMouseDown, radioGroup, onSubmit, onBeforeInput, `aria-disabled`, `aria-sort`, onCompositionStart, itemProp, security, `aria-valuemin`, dangerouslySetInnerHTML, `aria-colcount`, onFocus, onCanPlayThrough, `aria-invalid`, onBlur, onDoubleClick, `aria-valuemax`, `aria-details`, onContextMenu, defaultValue, suppressHydrationWarning, `aria-setsize`, onDragLeave, onTouchEnd, onPause, `aria-checked`, defaultChecked, `aria-valuetext`, prefix, onEmptied, name, form, onPointerUp, onCompositionEnd, `aria-colspan`, hidden, `aria-errormessage`, onScroll, onPointerDown, `aria-colindex`, onCut, suppressContentEditableWarning, `aria-hidden`, onAbort, onDragExit, `aria-valuenow`, id, onWheel, typeof, onDrag, `aria-expanded`, draggable, onEncrypted, onDragEnd, `aria-rowindex`, itemScope, onRateChange, onKeyPress, onLoadStart, itemID, `aria-rowspan` */ trait CodeSnippetInlineProps
    extends StObject
       with SharedProps {
    ...
    var feedbackTimeout: js.UndefOr[Double] = js.undefined
  ...
  object CodeSnippetInlineProps {
    
    @scala.inline
    def apply(): CodeSnippetInlineProps = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("inline")
      __obj.asInstanceOf[CodeSnippetInlineProps]
    }
    
    @scala.inline
    implicit class CodeSnippetInlinePropsMutableBuilder[Self <: CodeSnippetInlineProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFeedbackTimeout(value: Double): Self = StObject.set(x, "feedbackTimeout", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setFeedbackTimeoutUndefined: Self = StObject.set(x, "feedbackTimeout", js.undefined)
      ...
      @scala.inline
      def setType(value: `inline`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.single
    - typings.carbonComponentsReact.carbonComponentsReactStrings.multi
    - scala.Null
    - scala.Unit
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`inline`
  */
  type CodeSnippetType = js.UndefOr[_CodeSnippetType | Null]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'children'> */
  trait InheritedDivProps extends StObject {
  ...
  object InheritedDivProps {
    
    @scala.inline
    def apply(): InheritedDivProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InheritedDivProps]
    }
    
    @scala.inline
    implicit class InheritedDivPropsMutableBuilder[Self <: InheritedDivProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/Copy.CopyProps, 'children' | 'type'> */
  trait InheritedInlineProps extends StObject {
    ...
    var feedback: js.UndefOr[String] = js.undefined
  ...
  object InheritedInlineProps {
    
    @scala.inline
    def apply(): InheritedInlineProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InheritedInlineProps]
    }
    
    @scala.inline
    implicit class InheritedInlinePropsMutableBuilder[Self <: InheritedInlineProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFeedback(value: String): Self = StObject.set(x, "feedback", value.asInstanceOf[js.Any])
  ...
  trait SharedProps extends StObject {
    ...
    var copyButtonDescription: js.UndefOr[String] = js.undefined
    
    var copyLabel: js.UndefOr[String] = js.undefined
    ...
    var showLessText: js.UndefOr[String] = js.undefined
    
    var showMoreText: js.UndefOr[String] = js.undefined
  ...
  object SharedProps {
    ...
    implicit class SharedPropsMutableBuilder[Self <: SharedProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCopyButtonDescription(value: String): Self = StObject.set(x, "copyButtonDescription", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCopyButtonDescriptionUndefined: Self = StObject.set(x, "copyButtonDescription", js.undefined)
      
      @scala.inline
      def setCopyLabel(value: String): Self = StObject.set(x, "copyLabel", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCopyLabelUndefined: Self = StObject.set(x, "copyLabel", js.undefined)
      ...
      @scala.inline
      def setShowLessText(value: String): Self = StObject.set(x, "showLessText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShowLessTextUndefined: Self = StObject.set(x, "showLessText", js.undefined)
      
      @scala.inline
      def setShowMoreText(value: String): Self = StObject.set(x, "showMoreText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setShowMoreTextUndefined: Self = StObject.set(x, "showMoreText", js.undefined)
  ...
  trait _CodeSnippetType extends StObject
}
