...
object codeSnippetSkeletonMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/CodeSnippet/CodeSnippet.Skeleton", JSImport.Default)
  @js.native
  val default: FC[CodeSnippetSkeletonProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'children'> */
  trait CodeSnippetSkeletonProps extends StObject {
    ...
    var `type`: js.UndefOr[multi | single] = js.undefined
  ...
  object CodeSnippetSkeletonProps {
    
    @scala.inline
    def apply(): CodeSnippetSkeletonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[CodeSnippetSkeletonProps]
    }
    
    @scala.inline
    implicit class CodeSnippetSkeletonPropsMutableBuilder[Self <: CodeSnippetSkeletonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setType(value: multi | single): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  ...
  type _To = FC[CodeSnippetSkeletonProps]
  
  /* This means you don't have to write `default`, but can instead just say `codeSnippetSkeletonMod.foo` */
  override def _to: FC[CodeSnippetSkeletonProps] = default
}
