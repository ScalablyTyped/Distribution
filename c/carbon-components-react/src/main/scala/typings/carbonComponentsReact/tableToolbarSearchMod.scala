...
object tableToolbarSearchMod extends Shortcut {
  ...
  object TableToolbarSearchProps {
    ...
    @scala.inline
    def apply(): TableToolbarSearchProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TableToolbarSearchProps]
    }
    
    @scala.inline
    implicit class TableToolbarSearchPropsMutableBuilder[Self <: TableToolbarSearchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCloseButtonLabelText(value: String): Self = StObject.set(x, "closeButtonLabelText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setCloseButtonLabelTextUndefined: Self = StObject.set(x, "closeButtonLabelText", js.undefined)
      ...
      @scala.inline
      def setPersistant(value: Boolean): Self = StObject.set(x, "persistant", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPersistantUndefined: Self = StObject.set(x, "persistant", js.undefined)
      ...
      @scala.inline
      def setSearchContainerClass(value: String): Self = StObject.set(x, "searchContainerClass", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSearchContainerClassUndefined: Self = StObject.set(x, "searchContainerClass", js.undefined)
      ...
      @scala.inline
      def setSize(value: CarbonInputSize): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ TableToolbarTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  */
  ...
  object TableToolbarTranslationKey {
    ...
    @scala.inline
    def carbonDottableDottoolbarDotsearchDotlabel: typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotlabel = "carbon.table.toolbar.search.label".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotlabel]
  ...
  /* This means you don't have to write `default`, but can instead just say `tableToolbarSearchMod.foo` */
