...
import typings.carbonComponentsReact.listBoxFieldMod.ListBoxFieldComponent
import typings.carbonComponentsReact.listBoxMenuIconMod.ListBoxMenuIconComponent
import typings.carbonComponentsReact.listBoxMenuItemMod.ListBoxMenuItemComponent
import typings.carbonComponentsReact.listBoxMenuMod.ListBoxMenuComponent
...
import typings.carbonComponentsReact.listBoxSelectionMod.ListBoxSelectionComponent
...
object listBoxListBoxMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ListBox/ListBox", JSImport.Default)
  @js.native
  val default: ListBoxComponent = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyDown
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyPress
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def onKeyDown: typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyDown = "onKeyDown".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyDown]
    
    @scala.inline
    def onKeyPress: typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyPress = "onKeyPress".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyPress]
  ...
  trait ListBoxComponent
    extends StObject
       with ForwardRefExoticComponent[ForwardRefProps[HTMLDivElement, ListBoxProps]] {
    
    val Field: ListBoxFieldComponent = js.native
    
    val Menu: ListBoxMenuComponent = js.native
    
    val MenuIcon: ListBoxMenuIconComponent = js.native
    
    val MenuItem: ListBoxMenuItemComponent = js.native
    
    val Selection: ListBoxSelectionComponent = js.native
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/ListBox/ListBox.ExcludedAttributes> */
  ...
  type _To = ListBoxComponent
  
  /* This means you don't have to write `default`, but can instead just say `listBoxListBoxMod.foo` */
  override def _to: ListBoxComponent = default
}
