...
import typings.carbonComponentsReact.listBoxListBoxSelectionMod.ListBoxSelectionComponent
...
object listBoxListBoxMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def onKeyPress: typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyPress = "onKeyPress".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyPress]
