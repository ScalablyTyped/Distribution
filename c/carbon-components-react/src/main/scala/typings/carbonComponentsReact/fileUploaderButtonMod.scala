...
object fileUploaderButtonMod extends Shortcut {
  ...
  object FileUploaderButtonProps {
    ...
    inline def apply(): FileUploaderButtonProps = {
    ...
    extension [Self <: FileUploaderButtonProps](x: Self) {
      ...
      inline def setDisableLabelChanges(value: Boolean): Self = StObject.set(x, "disableLabelChanges", value.asInstanceOf[js.Any])
      
      inline def setDisableLabelChangesUndefined: Self = StObject.set(x, "disableLabelChanges", js.undefined)
