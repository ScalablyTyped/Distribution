...
object fileUploaderButtonMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/FileUploader/FileUploaderButton", JSImport.Default)
  @js.native
  val default: FC[FileUploaderButtonProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLabelAttr<std.HTMLLabelElement>, 'onChange'> */
  trait FileUploaderButtonProps extends StObject {
    ...
    var disableLabelChanges: js.UndefOr[Boolean] = js.undefined
  ...
  object FileUploaderButtonProps {
    
    @scala.inline
    def apply(): FileUploaderButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[FileUploaderButtonProps]
    }
    
    @scala.inline
    implicit class FileUploaderButtonPropsMutableBuilder[Self <: FileUploaderButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setDisableLabelChanges(value: Boolean): Self = StObject.set(x, "disableLabelChanges", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisableLabelChangesUndefined: Self = StObject.set(x, "disableLabelChanges", js.undefined)
      ...
      @scala.inline
      def setListFiles(value: Boolean): Self = StObject.set(x, "listFiles", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setListFilesUndefined: Self = StObject.set(x, "listFiles", js.undefined)
  ...
  type _To = FC[FileUploaderButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `fileUploaderButtonMod.foo` */
  override def _to: FC[FileUploaderButtonProps] = default
}
