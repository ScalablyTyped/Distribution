...
object contentSwitcherContentSwitcherMod {
  ...
  @js.native
  class default ()
    extends Component[ContentSwitcherProps, js.Object, js.Any]
  
  type ContentSwitcher = Component[ContentSwitcherProps, js.Object, js.Any]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'role'> */
  ...
  object ContentSwitcherProps {
    ...
    @scala.inline
    def apply(): ContentSwitcherProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ContentSwitcherProps]
    }
    
    @scala.inline
    implicit class ContentSwitcherPropsMutableBuilder[Self <: ContentSwitcherProps] (val x: Self) extends AnyVal {
