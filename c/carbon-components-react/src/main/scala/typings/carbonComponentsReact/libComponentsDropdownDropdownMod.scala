...
object libComponentsDropdownDropdownMod {
  ...
  trait DropdownProps[ItemType] extends StObject {
    ...
    var itemToElement: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: ItemType extends object ? react.react.JSXElementConstructor<ItemType> : never | undefined */ js.Any
      ] = js.undefined
  ...
  object DropdownProps {
    ...
    extension [Self <: DropdownProps[?], ItemType](x: Self & DropdownProps[ItemType]) {
      ...
      inline def setItemToElement(
        value: /* import warning: importer.ImportType#apply Failed type conversion: ItemType extends object ? react.react.JSXElementConstructor<ItemType> : never | undefined */ js.Any
