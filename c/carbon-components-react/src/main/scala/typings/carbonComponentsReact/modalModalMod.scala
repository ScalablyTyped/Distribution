...
object modalModalMod {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def onTransitionEnd: typings.carbonComponentsReact.carbonComponentsReactStrings.onTransitionEnd = "onTransitionEnd".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onTransitionEnd]
  ...
  object ModalProps {
    ...
    implicit class ModalPropsMutableBuilder[Self <: ModalProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnRequestSubmit(
        value: /* event */ (MouseEvent[HTMLButtonElement, NativeMouseEvent]) | KeyboardEvent[HTMLDivElement] => Unit
      ): Self = StObject.set(x, "onRequestSubmit", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnRequestSubmitUndefined: Self = StObject.set(x, "onRequestSubmit", js.undefined)
