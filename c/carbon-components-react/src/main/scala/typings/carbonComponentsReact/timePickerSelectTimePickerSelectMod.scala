...
object timePickerSelectTimePickerSelectMod {
  
  @JSImport("carbon-components-react/lib/components/TimePickerSelect/TimePickerSelect", JSImport.Default)
  @js.native
  class default ()
    extends Component[TimePickerSelectProps, js.Object, js.Any]
  
  type TimePickerSelect = Component[TimePickerSelectProps, js.Object, js.Any]
  ...
  object TimePickerSelectProps {
    ...
    @scala.inline
    def apply(id: String): TimePickerSelectProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[TimePickerSelectProps]
    }
    
    @scala.inline
    implicit class TimePickerSelectPropsMutableBuilder[Self <: TimePickerSelectProps] (val x: Self) extends AnyVal {
