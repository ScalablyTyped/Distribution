...
object comboBoxComboBoxMod {
  ...
  object ComboBoxProps {
    ...
    extension [Self <: ComboBoxProps[?, ?], ItemType, CustomElementProps](x: Self & (ComboBoxProps[ItemType, CustomElementProps])) {
      ...
      inline def setOnChange(value: /* data */ SelectedItem[ItemType] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnInputChange(value: /* inputValue */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onInputChange", js.Any.fromFunction1(value))
      ...
      inline def setShouldFilterItem(value: /* data */ InputValue[ItemType] => Unit): Self = StObject.set(x, "shouldFilterItem", js.Any.fromFunction1(value))
      
      inline def setShouldFilterItemUndefined: Self = StObject.set(x, "shouldFilterItem", js.undefined)
