...
import typings.carbonComponentsReact.anon.InputValue
import typings.carbonComponentsReact.anon.SelectedItem
...
object comboBoxComboBoxMod {
  ...
  trait ComboBoxProps[ItemType, CustomElementProps] extends StObject {
    ...
    var onChange: js.UndefOr[js.Function1[/* data */ SelectedItem[ItemType], Unit]] = js.undefined
    ...
    var onInputChange: js.UndefOr[js.Function1[/* inputValue */ js.UndefOr[String], Unit]] = js.undefined
    ...
    var shouldFilterItem: js.UndefOr[js.Function1[/* data */ InputValue[ItemType], Unit]] = js.undefined
  ...
  object ComboBoxProps {
    ...
    @scala.inline
    def apply[ItemType, CustomElementProps](id: String, items: js.Array[ItemType], placeholder: String): ComboBoxProps[ItemType, CustomElementProps] = {
    ...
    @scala.inline
    implicit class ComboBoxPropsMutableBuilder[Self <: ComboBoxProps[?, ?], ItemType, CustomElementProps] (val x: Self & (ComboBoxProps[ItemType, CustomElementProps])) extends AnyVal {
      ...
      @scala.inline
      def setItemToElement(value: ComponentType[CustomElementProps]): Self = StObject.set(x, "itemToElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: /* data */ SelectedItem[ItemType] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnInputChange(value: /* inputValue */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onInputChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setShouldFilterItem(value: /* data */ InputValue[ItemType] => Unit): Self = StObject.set(x, "shouldFilterItem", js.Any.fromFunction1(value))
      
      @scala.inline
      def setShouldFilterItemUndefined: Self = StObject.set(x, "shouldFilterItem", js.undefined)
      ...
      @scala.inline
      def setTitleText(value: ReactNode): Self = StObject.set(x, "titleText", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ ListBoxMenuIconTranslationKey | ListBoxSelectionTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def placeholder: typings.carbonComponentsReact.carbonComponentsReactStrings.placeholder = "placeholder".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.placeholder]
