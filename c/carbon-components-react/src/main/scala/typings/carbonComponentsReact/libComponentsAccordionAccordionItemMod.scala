...
object libComponentsAccordionAccordionItemMod {
  
  @JSImport("carbon-components-react/lib/components/Accordion/AccordionItem", JSImport.Default)
  @js.native
  open class default ()
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLIAttr<std.HTMLLIElement>, 'title'> */
  trait AccordionItemProps extends StObject {
    ...
    var onHeadingClick: js.UndefOr[js.Function1[/* data */ HeadingClickData, Unit]] = js.undefined
    ...
    /**
      ...
      */
    var renderExpando: js.UndefOr[ReactNode] = js.undefined
    
    var renderToggle: js.UndefOr[ReactNode] = js.undefined
  ...
  object AccordionItemProps {
    ...
    implicit open class MutableBuilder[Self <: AccordionItemProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnHeadingClick(value: /* data */ HeadingClickData => Unit): Self = StObject.set(x, "onHeadingClick", js.Any.fromFunction1(value))
      
      inline def setOnHeadingClickUndefined: Self = StObject.set(x, "onHeadingClick", js.undefined)
      ...
      inline def setRenderExpando(value: ReactNode): Self = StObject.set(x, "renderExpando", value.asInstanceOf[js.Any])
      
      inline def setRenderExpandoUndefined: Self = StObject.set(x, "renderExpando", js.undefined)
      
      inline def setRenderToggle(value: ReactNode): Self = StObject.set(x, "renderToggle", value.asInstanceOf[js.Any])
  ...
  trait HeadingClickData extends StObject {
    
    var event: MouseEvent[HTMLElement, NativeMouseEvent]
    
    var isOpen: Boolean
  }
  object HeadingClickData {
    
    inline def apply(event: MouseEvent[HTMLElement, NativeMouseEvent], isOpen: Boolean): HeadingClickData = {
