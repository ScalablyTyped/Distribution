...
import typings.carbonComponentsReact.carbonComponentsReactStrings.hasIconOnly
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.iconDescription
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.renderIcon
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.size
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.tooltipAlignment
import typings.carbonComponentsReact.carbonComponentsReactStrings.tooltipPosition
...
object libComponentsButtonButtonMod {
  
  @JSImport("carbon-components-react/lib/components/Button/Button", JSImport.Namespace)
  @js.native
  ...
  //
  inline def default(props: ForwardRefProps[HTMLButtonElement, ButtonDefaultProps & ButtonKindProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  // tslint:disable:unified-signatures breaks certain usages
  inline def default(props: ForwardRefProps[HTMLAnchorElement, ButtonAnchorProps & ButtonKindProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  inline def default[T /* <: ReactComponentConstructor[scala.Nothing] */, R](props: ForwardRefProps[R, ButtonCustomComponentProps[T] & ButtonKindProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  inline def default_search[R /* <: HTMLElement */](props: ForwardRefProps[R, ButtonIntrinsicProps[search] & ButtonKindProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/lib/components/Button/Button.ButtonBaseProps */
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAnchorAttr<std.HTMLAnchorElement>, 'href'> */
  trait ButtonAnchorProps extends StObject {
  ...
  object ButtonAnchorProps {
    
    inline def apply(as: Unit, href: String): ButtonAnchorProps = {
  ...
  object ButtonBaseIsolatedProps {
    
    inline def apply(): ButtonBaseIsolatedProps = {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    C extends carbon-components-react.carbon-components-react/typings/shared.ReactComponentConstructor<infer P> ? carbon-components-react.carbon-components-react/lib/components/Button/Button.ButtonBaseProps & carbon-components-react.carbon-components-react/lib/components/Button/Button.SafeProps<P> & {  as :C} : never
    }}}
    */
  @js.native
  trait ButtonCustomComponentProps[C /* <: ReactComponentConstructor[scala.Nothing] */] extends StObject
  ...
  - typings.react.mod.ButtonHTMLAttributes because var conflicts: children, className, disabled. Inlined formAction, formEncType, form, value, name, formMethod, formTarget, `type`, formNoValidate */ trait ButtonDefaultProps
    extends StObject
    ...
    var contentEditable: js.UndefOr[Booleanish | typings.react.reactStrings.inherit] = js.undefined
    ...
    var inputMode: js.UndefOr[
        none | typings.react.reactStrings.text | typings.react.reactStrings.tel | typings.react.reactStrings.url | typings.react.reactStrings.email | typings.react.reactStrings.numeric | typings.react.reactStrings.decimal | typings.react.reactStrings.search
      ] = js.undefined
    ...
    var translate: js.UndefOr[typings.react.reactStrings.yes | typings.react.reactStrings.no] = js.undefined
    
    var `type`: js.UndefOr[submit | reset | typings.react.reactStrings.button] = js.undefined
    
    var typeof: js.UndefOr[String] = js.undefined
    
    var unselectable: js.UndefOr[typings.react.reactStrings.on | typings.react.reactStrings.off] = js.undefined
    
    var value: js.UndefOr[String | js.Array[String] | Double] = js.undefined
    
    var vocab: js.UndefOr[String] = js.undefined
  }
  object ButtonDefaultProps {
    
    inline def apply(as: Unit, href: Unit): ButtonDefaultProps = {
      val __obj = js.Dynamic.literal(as = as.asInstanceOf[js.Any], href = href.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: ButtonDefaultProps] (val x: Self) extends AnyVal {
      ...
      inline def setContentEditable(value: Booleanish | typings.react.reactStrings.inherit): Self = StObject.set(x, "contentEditable", value.asInstanceOf[js.Any])
      ...
      inline def setInputMode(
        value: none | typings.react.reactStrings.text | typings.react.reactStrings.tel | typings.react.reactStrings.url | typings.react.reactStrings.email | typings.react.reactStrings.numeric | typings.react.reactStrings.decimal | typings.react.reactStrings.search
      ...
      inline def setTranslate(value: typings.react.reactStrings.yes | typings.react.reactStrings.no): Self = StObject.set(x, "translate", value.asInstanceOf[js.Any])
      
      inline def setTranslateUndefined: Self = StObject.set(x, "translate", js.undefined)
      
      inline def setType(value: submit | reset | typings.react.reactStrings.button): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
      ...
      inline def setUnselectable(value: typings.react.reactStrings.on | typings.react.reactStrings.off): Self = StObject.set(x, "unselectable", value.asInstanceOf[js.Any])
  ...
  type ButtonIntrinsicProps[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.carbonComponentsReact.carbonComponentsReactStrings.a, typings.carbonComponentsReact.carbonComponentsReactStrings.abbr, typings.carbonComponentsReact.carbonComponentsReactStrings.address */ Any */] = ButtonBaseProps & (SafeProps[JSXIntrinsicElementProps[K, `false`]]) & As[K]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.tertiary
  */
  trait ButtonKind extends StObject
  object ButtonKind {
    ...
    inline def primary: typings.carbonComponentsReact.carbonComponentsReactStrings.primary = "primary".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.primary]
    
    inline def secondary: typings.carbonComponentsReact.carbonComponentsReactStrings.secondary = "secondary".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.secondary]
    
    inline def tertiary: typings.carbonComponentsReact.carbonComponentsReactStrings.tertiary = "tertiary".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.tertiary]
  }
  
  trait ButtonKindProps extends StObject {
    
    var kind: js.UndefOr[ButtonKind] = js.undefined
  }
  object ButtonKindProps {
    
    inline def apply(): ButtonKindProps = {
      val __obj = js.Dynamic.literal()
  ...
  trait ButtonRenderIconRenderProps extends StObject {
  ...
  object ButtonRenderIconRenderProps {
    
    inline def apply(): ButtonRenderIconRenderProps = {
      val __obj = js.Dynamic.literal()
