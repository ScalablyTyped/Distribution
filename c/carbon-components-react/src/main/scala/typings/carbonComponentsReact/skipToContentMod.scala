...
object skipToContentMod extends Shortcut {
  ...
  object SkipToContentProps {
    ...
    @scala.inline
    def apply(): SkipToContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SkipToContentProps]
    }
    
    @scala.inline
    implicit class SkipToContentPropsMutableBuilder[Self <: SkipToContentProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `skipToContentMod.foo` */
