...
object inlineCheckboxInlineCheckboxMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/InlineCheckbox/InlineCheckbox", JSImport.Default)
  @js.native
  val default: ForwardRefReturn[HTMLInputElement, InlineCheckboxProps] = js.native
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-label`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-label` = "aria-label".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-label`]
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/InlineCheckbox/InlineCheckbox.ExcludedAttributes> */
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.RequiresIdProps<carbon-components-react.carbon-components-react/typings/shared.ReactAttr<std.HTMLElement>['id']> */
  trait InlineCheckboxProps extends StObject {
    ...
    var id: NonNullable[js.UndefOr[String]]
  ...
  object InlineCheckboxProps {
    
    @scala.inline
    def apply(): InlineCheckboxProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InlineCheckboxProps]
    }
    
    @scala.inline
    implicit class InlineCheckboxPropsMutableBuilder[Self <: InlineCheckboxProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setId(value: NonNullable[js.UndefOr[String]]): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnChange(value: (/* checked */ Boolean, /* id */ String, /* event */ ChangeEvent[HTMLInputElement]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction3(value))
  ...
  type _To = ForwardRefReturn[HTMLInputElement, InlineCheckboxProps]
  
  /* This means you don't have to write `default`, but can instead just say `inlineCheckboxInlineCheckboxMod.foo` */
  override def _to: ForwardRefReturn[HTMLInputElement, InlineCheckboxProps] = default
}
