...
object inlineCheckboxInlineCheckboxMod extends Shortcut {
  ...
  */
  ...
  object InlineCheckboxProps {
    ...
    inline def apply(id: NonNullable[js.UndefOr[String]]): InlineCheckboxProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[InlineCheckboxProps]
    }
    
    extension [Self <: InlineCheckboxProps](x: Self) {
      ...
      inline def setId(value: NonNullable[js.UndefOr[String]]): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
