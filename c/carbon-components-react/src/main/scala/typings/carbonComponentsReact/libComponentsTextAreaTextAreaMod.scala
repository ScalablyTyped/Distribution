...
object libComponentsTextAreaTextAreaMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/TextArea/TextArea", JSImport.Default)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-placeholder`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-describedby`
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def `aria-describedby`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-describedby` = "aria-describedby".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-describedby`]
    ...
    inline def `aria-placeholder`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-placeholder` = "aria-placeholder".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-placeholder`]
  ...
  /* Inlined parent std.Omit<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, carbon-components-react.carbon-components-react/lib/components/TextArea/TextArea.ExcludedAttributes> */
  trait TextAreaProps extends StObject {
    ...
    var enableCounter: js.UndefOr[Boolean] = js.undefined
  ...
  object TextAreaProps {
    ...
    implicit open class MutableBuilder[Self <: TextAreaProps] (val x: Self) extends AnyVal {
      ...
      inline def setEnableCounter(value: Boolean): Self = StObject.set(x, "enableCounter", value.asInstanceOf[js.Any])
      
      inline def setEnableCounterUndefined: Self = StObject.set(x, "enableCounter", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsTextAreaTextAreaMod.foo` */
