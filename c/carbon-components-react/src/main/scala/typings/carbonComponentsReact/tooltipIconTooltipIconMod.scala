...
object tooltipIconTooltipIconMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-describedby`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-describedby` = "aria-describedby".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-describedby`]
  ...
  object TooltipIconProps {
    ...
    @scala.inline
    def apply(tooltipText: String): TooltipIconProps = {
      val __obj = js.Dynamic.literal(tooltipText = tooltipText.asInstanceOf[js.Any])
      __obj.asInstanceOf[TooltipIconProps]
    }
    
    @scala.inline
    implicit class TooltipIconPropsMutableBuilder[Self <: TooltipIconProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `tooltipIconTooltipIconMod.foo` */
