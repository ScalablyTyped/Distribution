...
object tooltipIconTooltipIconMod extends Shortcut {
  ...
  */
  ...
  object TooltipIconProps {
    ...
    inline def apply(children: NonNullable[ReactNode], tooltipText: NonNullable[ReactNode]): TooltipIconProps = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], tooltipText = tooltipText.asInstanceOf[js.Any])
