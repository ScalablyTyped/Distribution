...
import typings.carbonComponentsReact.libComponentsMultiSelectMultiSelectPropTypesMod.MultiSelectSortingProps
...
object libComponentsMultiSelectMultiSelectMod {
  ...
  trait MultiSelectProps[T /* <: ListBoxBaseItemType */]
    ...
    def onChange(param0: SelectedItems[T]): Unit
