...
object sideNavDividerMod extends Shortcut {
  ...
  object SideNavDividerProps {
    ...
    extension [Self <: SideNavDividerProps](x: Self) {
  ...
  /* This means you don't have to write `default`, but can instead just say `sideNavDividerMod.foo` */
