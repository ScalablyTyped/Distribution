...
object accordionItemMod {
  ...
  object AccordionItemProps {
    ...
    implicit class AccordionItemPropsMutableBuilder[Self <: AccordionItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnHeadingClick(value: /* data */ HeadingClickData => Unit): Self = StObject.set(x, "onHeadingClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnHeadingClickUndefined: Self = StObject.set(x, "onHeadingClick", js.undefined)
      ...
      @scala.inline
      def setRenderExpando(value: ReactNode): Self = StObject.set(x, "renderExpando", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderExpandoUndefined: Self = StObject.set(x, "renderExpando", js.undefined)
  ...
  object HeadingClickData {
    ...
    @scala.inline
    def apply(event: MouseEvent[HTMLElement, NativeMouseEvent], isOpen: Boolean): HeadingClickData = {
    ...
    @scala.inline
    implicit class HeadingClickDataMutableBuilder[Self <: HeadingClickData] (val x: Self) extends AnyVal {
