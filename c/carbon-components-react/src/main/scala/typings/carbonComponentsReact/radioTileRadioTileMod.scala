...
object radioTileRadioTileMod extends Shortcut {
  ...
  */
  ...
  object RadioTileProps {
    ...
    @scala.inline
    def apply(value: RadioButtonValue): RadioTileProps = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[RadioTileProps]
    }
    
    @scala.inline
    implicit class RadioTilePropsMutableBuilder[Self <: RadioTileProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `radioTileRadioTileMod.foo` */
