...
object libComponentsTooltipDefinitionTooltipDefinitionMod extends Shortcut {
  ...
  */
  ...
  object TooltipDefinitionProps {
    ...
    inline def apply(): TooltipDefinitionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TooltipDefinitionProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TooltipDefinitionProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsTooltipDefinitionTooltipDefinitionMod.foo` */
