...
import typings.carbonComponentsReact.anon.Page
...
object libComponentsPaginationPaginationMod {
  
  @JSImport("carbon-components-react/lib/components/Pagination/Pagination", JSImport.Default)
  @js.native
  open class default ()
  ...
  */
  ...
  trait PaginationPageSize extends StObject {
    
    var text: String
    
    var value: String
  }
  object PaginationPageSize {
    
    inline def apply(text: String, value: String): PaginationPageSize = {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/Pagination/Pagination.ExcludedAttributes> */
  trait PaginationProps extends StObject {
    ...
    var isLastPage: js.UndefOr[Boolean] = js.undefined
    ...
    var pageInputDisabled: js.UndefOr[Boolean] = js.undefined
    
    var pageNumberText: js.UndefOr[String] = js.undefined
    
    var pageRangeText: js.UndefOr[js.Function2[/* current */ Double, /* total */ Double, String]] = js.undefined
    
    var pageSize: js.UndefOr[Double] = js.undefined
    
    var pageSizeInputDisabled: js.UndefOr[Boolean] = js.undefined
    
    var pageSizes: js.Array[Double | PaginationPageSize]
    
    var pageText: js.UndefOr[js.Function1[/* page */ Double, String]] = js.undefined
  ...
  object PaginationProps {
    ...
    inline def apply(onChange: Page => Unit, pageSizes: js.Array[Double | PaginationPageSize]): PaginationProps = {
      val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1(onChange), pageSizes = pageSizes.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      inline def setIsLastPageUndefined: Self = StObject.set(x, "isLastPage", js.undefined)
      ...
      inline def setOnChange(value: Page => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setPageInputDisabled(value: Boolean): Self = StObject.set(x, "pageInputDisabled", value.asInstanceOf[js.Any])
      
      inline def setPageInputDisabledUndefined: Self = StObject.set(x, "pageInputDisabled", js.undefined)
      
      inline def setPageNumberText(value: String): Self = StObject.set(x, "pageNumberText", value.asInstanceOf[js.Any])
      
      inline def setPageNumberTextUndefined: Self = StObject.set(x, "pageNumberText", js.undefined)
      
      inline def setPageRangeText(value: (/* current */ Double, /* total */ Double) => String): Self = StObject.set(x, "pageRangeText", js.Any.fromFunction2(value))
      
      inline def setPageRangeTextUndefined: Self = StObject.set(x, "pageRangeText", js.undefined)
      
      inline def setPageSize(value: Double): Self = StObject.set(x, "pageSize", value.asInstanceOf[js.Any])
      
      inline def setPageSizeInputDisabled(value: Boolean): Self = StObject.set(x, "pageSizeInputDisabled", value.asInstanceOf[js.Any])
      
      inline def setPageSizeInputDisabledUndefined: Self = StObject.set(x, "pageSizeInputDisabled", js.undefined)
      
      inline def setPageSizeUndefined: Self = StObject.set(x, "pageSize", js.undefined)
      
      inline def setPageSizes(value: js.Array[Double | PaginationPageSize]): Self = StObject.set(x, "pageSizes", value.asInstanceOf[js.Any])
      
      inline def setPageSizesVarargs(value: (Double | PaginationPageSize)*): Self = StObject.set(x, "pageSizes", js.Array(value*))
      
      inline def setPageText(value: /* page */ Double => String): Self = StObject.set(x, "pageText", js.Any.fromFunction1(value))
