...
object libComponentsListBoxListBoxFieldMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ListBox/ListBoxField", JSImport.Default)
  @js.native
  val default: ListBoxFieldComponent = js.native
  
  type ListBoxFieldComponent = FC[ListBoxFieldProps]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'id'> */
  trait ListBoxFieldProps extends StObject {
  ...
  object ListBoxFieldProps {
    
    inline def apply(id: String): ListBoxFieldProps = {
  ...
  type _To = ListBoxFieldComponent
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsListBoxListBoxFieldMod.foo` */
  override def _to: ListBoxFieldComponent = default
}
