...
object switchSwitchMod extends Shortcut {
  ...
  object SwitchProps {
    ...
    @scala.inline
    def apply(onClick: Index => Unit, onKeyDown: Text => Unit, text: String): SwitchProps = {
    ...
    implicit class SwitchPropsMutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: Index => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnKeyDown(value: Text => Unit): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1(value))
