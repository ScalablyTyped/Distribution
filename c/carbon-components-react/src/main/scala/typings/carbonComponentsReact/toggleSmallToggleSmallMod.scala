...
object toggleSmallToggleSmallMod extends Shortcut {
  ...
  */
  ...
  object ToggleSmallProps {
    ...
    inline def apply(`aria-label`: String, id: String): ToggleSmallProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-label")(`aria-label`.asInstanceOf[js.Any])
      __obj.asInstanceOf[ToggleSmallProps]
    }
    
    extension [Self <: ToggleSmallProps](x: Self) {
      ...
      inline def setOnChange(value: /* e */ KeyboardEvent[HTMLInputElement] | ChangeEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
