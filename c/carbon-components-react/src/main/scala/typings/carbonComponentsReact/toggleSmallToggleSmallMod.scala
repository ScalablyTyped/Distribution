...
object toggleSmallToggleSmallMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ToggleSmall/ToggleSmall", JSImport.Default)
  @js.native
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def onKeyUp: typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyUp = "onKeyUp".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyUp]
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/ToggleSmall/ToggleSmall.ExcludedAttributes> */
  trait ToggleSmallProps extends StObject {
    ...
    var onChange: js.UndefOr[
        js.Function1[/* e */ KeyboardEvent[HTMLInputElement] | ChangeEvent[HTMLInputElement], Unit]
      ] = js.undefined
    ...
    // this looks to be required because the built-in onKeyUp handler calls it unguarded
  ...
  object ToggleSmallProps {
    
    @scala.inline
    def apply(`aria-label`: String, id: String): ToggleSmallProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-label")(`aria-label`.asInstanceOf[js.Any])
      __obj.asInstanceOf[ToggleSmallProps]
    }
    
    @scala.inline
    implicit class ToggleSmallPropsMutableBuilder[Self <: ToggleSmallProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelA(value: String): Self = StObject.set(x, "labelA", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelAUndefined: Self = StObject.set(x, "labelA", js.undefined)
      
      @scala.inline
      def setLabelB(value: String): Self = StObject.set(x, "labelB", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLabelBUndefined: Self = StObject.set(x, "labelB", js.undefined)
      ...
      @scala.inline
      def setOnChange(value: /* e */ KeyboardEvent[HTMLInputElement] | ChangeEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
  ...
  /* This means you don't have to write `default`, but can instead just say `toggleSmallToggleSmallMod.foo` */
