...
object overflowMenuOverflowMenuMod extends Shortcut {
  ...
  @js.native
  val getMenuOffset: GetMenuOffsetFn = js.native
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-expanded`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-expanded` = "aria-expanded".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-expanded`]
    
    @scala.inline
    def `aria-haspopup`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-haspopup` = "aria-haspopup".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-haspopup`]
  ...
  type GetMenuOffsetFn = js.Function4[
    ...
    /* direction */ Direction, 
    /* trigger */ js.UndefOr[HTMLElement], 
    /* flip */ js.UndefOr[Boolean], 
    js.UndefOr[MenuOffsetData]
  ]
  ...
  object OverflowMenuProps {
    
    @scala.inline
    def apply(): OverflowMenuProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OverflowMenuProps]
    }
    
    @scala.inline
    implicit class OverflowMenuPropsMutableBuilder[Self <: OverflowMenuProps] (val x: Self) extends AnyVal {
  ...
  type _To = ForwardRefReturn[HTMLButtonElement, OverflowMenuProps]
  
  /* This means you don't have to write `default`, but can instead just say `overflowMenuOverflowMenuMod.foo` */
  override def _to: ForwardRefReturn[HTMLButtonElement, OverflowMenuProps] = default
}
