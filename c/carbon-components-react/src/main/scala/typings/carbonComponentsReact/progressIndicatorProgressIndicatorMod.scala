...
object progressIndicatorProgressIndicatorMod {
  ...
  class ProgressIndicator protected ()
    extends Component[ProgressIndicatorProps, js.Object, js.Any] {
  ...
  object ProgressIndicatorProps {
    ...
    @scala.inline
    def apply(): ProgressIndicatorProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ProgressIndicatorProps]
    }
    
    @scala.inline
    implicit class ProgressIndicatorPropsMutableBuilder[Self <: ProgressIndicatorProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSpaceEqually(value: Boolean): Self = StObject.set(x, "spaceEqually", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSpaceEquallyUndefined: Self = StObject.set(x, "spaceEqually", js.undefined)
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.InternationalProps<carbon-components-react.carbon-components-react/lib/components/ProgressIndicator/ProgressIndicator.ProgressStepTranslationKey> */
  trait ProgressStepProps extends StObject {
    ...
    var translateWithId: js.UndefOr[js.Function1[/* messageId */ ProgressStepTranslationKey, String]] = js.undefined
  ...
  object ProgressStepProps {
    ...
    @scala.inline
    def apply(): ProgressStepProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ProgressStepProps]
    }
    
    @scala.inline
    implicit class ProgressStepPropsMutableBuilder[Self <: ProgressStepProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnClick(value: /* e */ js.UndefOr[MouseEvent[HTMLButtonElement, NativeMouseEvent]] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOverflowTooltipProps(value: js.Object): Self = StObject.set(x, "overflowTooltipProps", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOverflowTooltipPropsUndefined: Self = StObject.set(x, "overflowTooltipProps", js.undefined)
      ...
      @scala.inline
      def setRenderLabel(value: FC[RenderLabelProps]): Self = StObject.set(x, "renderLabel", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ ProgressStepTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  */
  ...
  object ProgressStepTranslationKey {
    ...
    @scala.inline
    def `carbonDotprogress-stepDotcomplete`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcomplete` = "carbon.progress-step.complete".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcomplete`]
    
    @scala.inline
    def `carbonDotprogress-stepDotcurrent`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcurrent` = "carbon.progress-step.current".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcurrent`]
    
    @scala.inline
    def `carbonDotprogress-stepDotincomplete`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotincomplete` = "carbon.progress-step.incomplete".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotincomplete`]
    
    @scala.inline
    def `carbonDotprogress-stepDotinvalid`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotinvalid` = "carbon.progress-step.invalid".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotinvalid`]
  }
  ...
  object RenderLabelProps {
    ...
    @scala.inline
    def apply(): RenderLabelProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[RenderLabelProps]
    }
    
    @scala.inline
    implicit class RenderLabelPropsMutableBuilder[Self <: RenderLabelProps] (val x: Self) extends AnyVal {
