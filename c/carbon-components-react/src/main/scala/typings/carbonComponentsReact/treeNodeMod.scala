...
import typings.carbonComponentsReact.anon.IsExpanded
import typings.carbonComponentsReact.anon.Label
...
object treeNodeMod extends Shortcut {
  ...
  @JSImport("carbon-components-react/lib/components/TreeView/TreeNode", JSImport.Default)
  @js.native
  val default: FC[TreeNodeProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/TreeView/TreeNode.TreeNodeStandaloneProps, carbon-components-react.carbon-components-react/lib/components/TreeView/TreeNode.TreeViewProvidedProps> */
  trait TreeNodeProps extends StObject {
    ...
    var onClick: js.UndefOr[
        js.Function1[
          /* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], 
          Unit
        ]
      ] = js.undefined
  ...
  object TreeNodeProps {
    ...
    extension [Self <: TreeNodeProps](x: Self) {
      ...
      inline def setOnClick(
        value: /* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement] => Unit
      ...
      inline def setOnSelect(
        value: (/* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], /* node */ Label) => Unit
      ...
      inline def setOnToggle(
        value: (/* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], /* node */ IsExpanded) => Unit
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLIAttr<std.HTMLLIElement>, 'aria-expanded' | 'onClick' | 'onSelect'> */
  trait TreeNodeStandaloneProps extends StObject {
    
    var about: js.UndefOr[String] = js.undefined
    
    var accessKey: js.UndefOr[String] = js.undefined
    
    var active: js.UndefOr[Double | String] = js.undefined
    ...
    var onNodeFocusEvent: js.UndefOr[js.Function1[/* event */ FocusEvent[HTMLLIElement, Element], Unit]] = js.undefined
  ...
  object TreeNodeStandaloneProps {
    
    inline def apply(): TreeNodeStandaloneProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TreeNodeStandaloneProps]
    }
    
    extension [Self <: TreeNodeStandaloneProps](x: Self) {
      ...
      inline def setActive(value: Double | String): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
      ...
      inline def setOnNodeFocusEvent(value: /* event */ FocusEvent[HTMLLIElement, Element] => Unit): Self = StObject.set(x, "onNodeFocusEvent", js.Any.fromFunction1(value))
      
      inline def setOnNodeFocusEventUndefined: Self = StObject.set(x, "onNodeFocusEvent", js.undefined)
      ...
      inline def setOnTreeSelect(
        value: (/* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], /* node */ Label) => Unit
      ): Self = StObject.set(x, "onTreeSelect", js.Any.fromFunction2(value))
      
      inline def setOnTreeSelectUndefined: Self = StObject.set(x, "onTreeSelect", js.undefined)
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.depth
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onNodeFocusEvent
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onTreeSelect
  ...
  */
  trait TreeViewProvidedProps extends StObject
  object TreeViewProvidedProps {
    ...
    inline def depth: typings.carbonComponentsReact.carbonComponentsReactStrings.depth = "depth".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.depth]
    
    inline def onNodeFocusEvent: typings.carbonComponentsReact.carbonComponentsReactStrings.onNodeFocusEvent = "onNodeFocusEvent".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onNodeFocusEvent]
    
    inline def onTreeSelect: typings.carbonComponentsReact.carbonComponentsReactStrings.onTreeSelect = "onTreeSelect".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onTreeSelect]
