...
object treeNodeMod extends Shortcut {
  ...
  object TreeNodeStandaloneProps {
    ...
    @scala.inline
    def apply(): TreeNodeStandaloneProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TreeNodeStandaloneProps]
    }
    
    @scala.inline
    implicit class TreeNodeStandalonePropsMutableBuilder[Self <: TreeNodeStandaloneProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setActive(value: Double | String): Self = StObject.set(x, "active", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnNodeFocusEvent(value: /* event */ FocusEvent[HTMLLIElement] => Unit): Self = StObject.set(x, "onNodeFocusEvent", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnNodeFocusEventUndefined: Self = StObject.set(x, "onNodeFocusEvent", js.undefined)
      ...
      @scala.inline
      def setOnTreeSelectUndefined: Self = StObject.set(x, "onTreeSelect", js.undefined)
  ...
  */
  ...
  object TreeViewProvidedProps {
    ...
    @scala.inline
    def depth: typings.carbonComponentsReact.carbonComponentsReactStrings.depth = "depth".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.depth]
    
    @scala.inline
    def onNodeFocusEvent: typings.carbonComponentsReact.carbonComponentsReactStrings.onNodeFocusEvent = "onNodeFocusEvent".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onNodeFocusEvent]
    
    @scala.inline
    def onTreeSelect: typings.carbonComponentsReact.carbonComponentsReactStrings.onTreeSelect = "onTreeSelect".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onTreeSelect]
