...
object treeNodeMod extends Shortcut {
  ...
  object TreeNodeProps {
    ...
    extension [Self <: TreeNodeProps](x: Self) {
      ...
      inline def setOnSelect(
        value: (/* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], /* node */ Id) => Unit
  ...
  trait TreeNodeStandaloneProps extends StObject {
    ...
    var onNodeFocusEvent: js.UndefOr[js.Function1[/* event */ FocusEvent[HTMLLIElement], Unit]] = js.undefined
  ...
  object TreeNodeStandaloneProps {
    ...
    extension [Self <: TreeNodeStandaloneProps](x: Self) {
      ...
      inline def setOnNodeFocusEvent(value: /* event */ FocusEvent[HTMLLIElement] => Unit): Self = StObject.set(x, "onNodeFocusEvent", js.Any.fromFunction1(value))
