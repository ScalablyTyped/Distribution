...
object columnMod {
  ...
  inline def default[T /* <: JSXElementConstructor[js.Any] */](props: ColumnCustomComponentProps[T]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  type ColumnCustomComponentProps[C /* <: JSXElementConstructor[js.Any] */] = ColumnBaseProps & SafeProps[js.Any] & AsC[C]
  ...
  type ColumnIntrinsicProps[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 175 */ js.Any */] = ColumnBaseProps & (SafeProps[JSXIntrinsicElementProps[K, `false`]]) & As[K]
