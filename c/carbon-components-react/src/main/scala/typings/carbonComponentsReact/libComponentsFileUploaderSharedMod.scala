...
object libComponentsFileUploaderSharedMod {
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.complete
    - typings.carbonComponentsReact.carbonComponentsReactStrings.edit
    - typings.carbonComponentsReact.carbonComponentsReactStrings.uploading
  */
