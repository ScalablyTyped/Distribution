...
object listBoxFieldMod extends Shortcut {
  ...
  object ListBoxFieldProps {
    ...
    @scala.inline
    def apply(id: String): ListBoxFieldProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListBoxFieldProps]
    }
    
    @scala.inline
    implicit class ListBoxFieldPropsMutableBuilder[Self <: ListBoxFieldProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `listBoxFieldMod.foo` */
