...
object overflowMenuItemOverflowMenuItemMod {
  ...
  @js.native
  class default ()
    extends Component[AllOverflowMenuItemProps, js.Object, js.Any]
  ...
  */
  ...
  object AllOverflowMenuItemProps {
    ...
    @scala.inline
    def OverflowMenuItemAnchorProps(href: String): typings.carbonComponentsReact.overflowMenuItemOverflowMenuItemMod.OverflowMenuItemAnchorProps = {
    ...
    @scala.inline
    def OverflowMenuItemButtonProps(): typings.carbonComponentsReact.overflowMenuItemOverflowMenuItemMod.OverflowMenuItemButtonProps = {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def disabled: typings.carbonComponentsReact.carbonComponentsReactStrings.disabled = "disabled".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.disabled]
    
    @scala.inline
    def href: typings.carbonComponentsReact.carbonComponentsReactStrings.href = "href".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.href]
  ...
  type OverflowMenuItem = Component[AllOverflowMenuItemProps, js.Object, js.Any]
  ...
  object OverflowMenuItemAnchorProps {
    ...
    @scala.inline
    def apply(href: String): OverflowMenuItemAnchorProps = {
      val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
      __obj.asInstanceOf[OverflowMenuItemAnchorProps]
    }
    
    @scala.inline
    implicit class OverflowMenuItemAnchorPropsMutableBuilder[Self <: OverflowMenuItemAnchorProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemText(value: NonNullable[ReactNode]): Self = StObject.set(x, "itemText", value.asInstanceOf[js.Any])
  ...
  object OverflowMenuItemButtonProps {
    ...
    @scala.inline
    def apply(): OverflowMenuItemButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OverflowMenuItemButtonProps]
    }
    
    @scala.inline
    implicit class OverflowMenuItemButtonPropsMutableBuilder[Self <: OverflowMenuItemButtonProps] (val x: Self) extends AnyVal {
