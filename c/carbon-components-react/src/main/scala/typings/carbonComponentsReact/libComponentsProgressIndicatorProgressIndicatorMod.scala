...
object libComponentsProgressIndicatorProgressIndicatorMod {
  
  @JSImport("carbon-components-react/lib/components/ProgressIndicator/ProgressIndicator", "ProgressIndicator")
  @js.native
  open class ProgressIndicator protected ()
    extends Component[ProgressIndicatorProps, js.Object, Any] {
  ...
  @JSImport("carbon-components-react/lib/components/ProgressIndicator/ProgressIndicator", "ProgressStep")
  @js.native
  val ProgressStep: FC[ProgressStepProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAttr<std.HTMLUListElement>, 'onChange'> */
  trait ProgressIndicatorProps extends StObject {
    ...
    var spaceEqually: js.UndefOr[Boolean] = js.undefined
  ...
  object ProgressIndicatorProps {
    
    inline def apply(): ProgressIndicatorProps = {
    ...
    implicit open class MutableBuilder[Self <: ProgressIndicatorProps] (val x: Self) extends AnyVal {
      ...
      inline def setSpaceEqually(value: Boolean): Self = StObject.set(x, "spaceEqually", value.asInstanceOf[js.Any])
      
      inline def setSpaceEquallyUndefined: Self = StObject.set(x, "spaceEqually", js.undefined)
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, 'onClick'> */
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.InternationalProps<carbon-components-react.carbon-components-react/lib/components/ProgressIndicator/ProgressIndicator.ProgressStepTranslationKey, std.Record<string, unknown>> */
  trait ProgressStepProps extends StObject {
    ...
    var label: NonNullable[ReactNode]
    ...
    var onClick: js.UndefOr[
        js.Function1[/* e */ js.UndefOr[MouseEvent[HTMLButtonElement, NativeMouseEvent]], Unit]
      ] = js.undefined
    ...
    // provided by parent
    var overflowTooltipProps: js.UndefOr[js.Object] = js.undefined
    ...
    var renderLabel: js.UndefOr[FC[RenderLabelProps]] = js.undefined
    ...
    var translateWithId: js.UndefOr[
        js.Function2[
          /* messageId */ ProgressStepTranslationKey, 
  ...
  object ProgressStepProps {
    
    inline def apply(): ProgressStepProps = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: ProgressStepProps] (val x: Self) extends AnyVal {
      ...
      inline def setLabel(value: NonNullable[ReactNode]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      ...
      inline def setOnClick(value: /* e */ js.UndefOr[MouseEvent[HTMLButtonElement, NativeMouseEvent]] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      ...
      inline def setOverflowTooltipProps(value: js.Object): Self = StObject.set(x, "overflowTooltipProps", value.asInstanceOf[js.Any])
      
      inline def setOverflowTooltipPropsUndefined: Self = StObject.set(x, "overflowTooltipProps", js.undefined)
      ...
      inline def setRenderLabel(value: FC[RenderLabelProps]): Self = StObject.set(x, "renderLabel", value.asInstanceOf[js.Any])
      ...
      inline def setTranslateWithId(
        value: (/* messageId */ ProgressStepTranslationKey, /* args */ js.UndefOr[Record[String, Any]]) => String
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcomplete`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotincomplete`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcurrent`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotinvalid`
  */
  trait ProgressStepTranslationKey
    extends StObject
       with _CarbonTranslationKey
  object ProgressStepTranslationKey {
    
    inline def `carbonDotprogress-stepDotcomplete`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcomplete` = "carbon.progress-step.complete".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcomplete`]
    
    inline def `carbonDotprogress-stepDotcurrent`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcurrent` = "carbon.progress-step.current".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotcurrent`]
    
    inline def `carbonDotprogress-stepDotincomplete`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotincomplete` = "carbon.progress-step.incomplete".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotincomplete`]
    
    inline def `carbonDotprogress-stepDotinvalid`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotinvalid` = "carbon.progress-step.invalid".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotprogress-stepDotinvalid`]
  }
  
  trait RenderLabelProps extends StObject {
    
    var className: js.UndefOr[String] = js.undefined
  }
  object RenderLabelProps {
    
    inline def apply(): RenderLabelProps = {
      val __obj = js.Dynamic.literal()
