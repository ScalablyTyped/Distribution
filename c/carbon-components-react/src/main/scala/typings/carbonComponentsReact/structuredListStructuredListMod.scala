...
import typings.carbonComponentsReact.carbonComponentsReactStrings.next
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.previous
...
object structuredListStructuredListMod {
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListBody")
  @js.native
  class StructuredListBody protected ()
    extends Component[StructuredListBodyProps, js.Object, js.Any] {
    def this(props: StructuredListBodyProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: StructuredListBodyProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListCell")
  @js.native
  class StructuredListCell protected ()
    extends Component[StructuredListCellProps, js.Object, js.Any] {
    def this(props: StructuredListCellProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: StructuredListCellProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListHead")
  @js.native
  class StructuredListHead protected ()
    extends Component[StructuredListHeadProps, js.Object, js.Any] {
    def this(props: StructuredListHeadProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: StructuredListHeadProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListInput")
  @js.native
  class StructuredListInput protected ()
    extends Component[StructuredListInputProps, js.Object, js.Any] {
    def this(props: StructuredListInputProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: StructuredListInputProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListRow")
  @js.native
  class StructuredListRow protected ()
    extends Component[AllStructuredListRowProps, js.Object, js.Any] {
    def this(props: AllStructuredListRowProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: AllStructuredListRowProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/StructuredList/StructuredList", "StructuredListWrapper")
  @js.native
  class StructuredListWrapper protected ()
    extends Component[StructuredListProps, js.Object, js.Any] {
    def this(props: StructuredListProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: StructuredListProps, context: js.Any) = this()
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListLabelRowProps
    - typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListDivRowProps
  */
  trait AllStructuredListRowProps extends StObject
  object AllStructuredListRowProps {
    
    @scala.inline
    def StructuredListDivRowProps(): typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListDivRowProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListDivRowProps]
    }
    
    @scala.inline
    def StructuredListLabelRowProps(): typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListLabelRowProps = {
      val __obj = js.Dynamic.literal(label = true)
      __obj.asInstanceOf[typings.carbonComponentsReact.structuredListStructuredListMod.StructuredListLabelRowProps]
    }
  }
  ...
  */
  trait ExcludedListInputProps extends StObject
  object ExcludedListInputProps {
    ...
    @scala.inline
    def `type`: typings.carbonComponentsReact.carbonComponentsReactStrings.`type` = "type".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`type`]
    
    @scala.inline
    def value: typings.carbonComponentsReact.carbonComponentsReactStrings.value = "value".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.value]
  }
  
  type StructuredListBodyProps = ReactDivAttr
  
  trait StructuredListCellProps
    extends StObject
  ...
  object StructuredListCellProps {
    
    @scala.inline
    def apply(): StructuredListCellProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StructuredListCellProps]
    }
    
    @scala.inline
    implicit class StructuredListCellPropsMutableBuilder[Self <: StructuredListCellProps] (val x: Self) extends AnyVal {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'onKeyDown' | 'tabIndex'> */
  trait StructuredListDivRowProps
    extends StObject
       with AllStructuredListRowProps {
    ...
    var label: js.UndefOr[`false`] = js.undefined
  ...
  object StructuredListDivRowProps {
    
    @scala.inline
    def apply(): StructuredListDivRowProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StructuredListDivRowProps]
    }
    
    @scala.inline
    implicit class StructuredListDivRowPropsMutableBuilder[Self <: StructuredListDivRowProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabel(value: `false`): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
  ...
  type StructuredListHeadProps = ReactDivAttr
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/StructuredList/StructuredList.ExcludedListInputProps> */
  trait StructuredListInputProps extends StObject {
  ...
  object StructuredListInputProps {
    
    @scala.inline
    def apply(value: String | Double): StructuredListInputProps = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[StructuredListInputProps]
    }
    
    @scala.inline
    implicit class StructuredListInputPropsMutableBuilder[Self <: StructuredListInputProps] (val x: Self) extends AnyVal {
  ...
  trait StructuredListLabelRowProps
    extends StObject
  ...
  object StructuredListLabelRowProps {
    
    @scala.inline
    def apply(): StructuredListLabelRowProps = {
      val __obj = js.Dynamic.literal(label = true)
      __obj.asInstanceOf[StructuredListLabelRowProps]
    }
    
    @scala.inline
    implicit class StructuredListLabelRowPropsMutableBuilder[Self <: StructuredListLabelRowProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabel(value: `true`): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    }
  }
  
  trait StructuredListProps
    extends StObject
  ...
  object StructuredListProps {
    
    @scala.inline
    def apply(): StructuredListProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StructuredListProps]
    }
    
    @scala.inline
    implicit class StructuredListPropsMutableBuilder[Self <: StructuredListProps] (val x: Self) extends AnyVal {
