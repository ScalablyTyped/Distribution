...
object paginationNavPaginationNavMod extends Shortcut {
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.InternationalProps<carbon-components-react.carbon-components-react/lib/components/PaginationNav/PaginationNav.PaginationNavTranslationKey, std.Record<string, unknown>> */
  trait PaginationNavProps extends StObject {
    ...
    var translateWithId: js.UndefOr[
        js.Function2[
          /* messageId */ PaginationNavTranslationKey, 
  ...
  object PaginationNavProps {
    ...
    extension [Self <: PaginationNavProps](x: Self) {
      ...
      inline def setTranslateWithId(
        value: (/* messageId */ PaginationNavTranslationKey, /* args */ js.UndefOr[Record[String, Any]]) => String
