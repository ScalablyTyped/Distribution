...
object paginationNavPaginationNavMod extends Shortcut {
  ...
  object PaginationNavProps {
    ...
    inline def apply(): PaginationNavProps = {
    ...
    extension [Self <: PaginationNavProps](x: Self) {
      ...
      inline def setItemsShown(value: Double): Self = StObject.set(x, "itemsShown", value.asInstanceOf[js.Any])
      
      inline def setItemsShownUndefined: Self = StObject.set(x, "itemsShown", js.undefined)
      ...
      inline def setTranslateWithId(value: /* messageId */ PaginationNavTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  */
  ...
  object PaginationNavTranslationKey {
    ...
    inline def `carbonDotpagination-navDotactive`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotactive` = "carbon.pagination-nav.active".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotactive`]
    
    inline def `carbonDotpagination-navDotitem`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotitem` = "carbon.pagination-nav.item".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotitem`]
    
    inline def `carbonDotpagination-navDotnext`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotnext` = "carbon.pagination-nav.next".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotnext`]
    
    inline def `carbonDotpagination-navDotof`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotof` = "carbon.pagination-nav.of".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotof`]
    
    inline def `carbonDotpagination-navDotprevious`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotprevious` = "carbon.pagination-nav.previous".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotprevious`]
  }
