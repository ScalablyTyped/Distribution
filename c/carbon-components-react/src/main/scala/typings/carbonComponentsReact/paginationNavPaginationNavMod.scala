...
object paginationNavPaginationNavMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/PaginationNav/PaginationNav", JSImport.Default)
  @js.native
  val default: ForwardRefReturn[HTMLElement, PaginationNavProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAttr<std.HTMLElement>, 'onChange'> */
  /* Inlined parent carbon-components-react.carbon-components-react/typings/shared.InternationalProps<carbon-components-react.carbon-components-react/lib/components/PaginationNav/PaginationNav.PaginationNavTranslationKey> */
  trait PaginationNavProps extends StObject {
    ...
    var itemsShown: js.UndefOr[Double] = js.undefined
    ...
    var translateWithId: js.UndefOr[js.Function1[/* messageId */ PaginationNavTranslationKey, String]] = js.undefined
  ...
  object PaginationNavProps {
    
    @scala.inline
    def apply(): PaginationNavProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PaginationNavProps]
    }
    
    @scala.inline
    implicit class PaginationNavPropsMutableBuilder[Self <: PaginationNavProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setItemsShown(value: Double): Self = StObject.set(x, "itemsShown", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setItemsShownUndefined: Self = StObject.set(x, "itemsShown", js.undefined)
      ...
      @scala.inline
      def setOnChange(value: /* page */ Double => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ PaginationNavTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotnext`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotprevious`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotitem`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotactive`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotof`
  */
  trait PaginationNavTranslationKey
    extends StObject
       with _CarbonTranslationKey
  object PaginationNavTranslationKey {
    
    @scala.inline
    def `carbonDotpagination-navDotactive`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotactive` = "carbon.pagination-nav.active".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotactive`]
    
    @scala.inline
    def `carbonDotpagination-navDotitem`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotitem` = "carbon.pagination-nav.item".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotitem`]
    
    @scala.inline
    def `carbonDotpagination-navDotnext`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotnext` = "carbon.pagination-nav.next".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotnext`]
    
    @scala.inline
    def `carbonDotpagination-navDotof`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotof` = "carbon.pagination-nav.of".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotof`]
    
    @scala.inline
    def `carbonDotpagination-navDotprevious`: typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotprevious` = "carbon.pagination-nav.previous".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`carbonDotpagination-navDotprevious`]
  }
  
  type _To = ForwardRefReturn[HTMLElement, PaginationNavProps]
  
  /* This means you don't have to write `default`, but can instead just say `paginationNavPaginationNavMod.foo` */
  override def _to: ForwardRefReturn[HTMLElement, PaginationNavProps] = default
}
