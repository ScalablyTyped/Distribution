...
object libComponentsListBoxListBoxMenuMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ListBox/ListBoxMenu", JSImport.Default)
  @js.native
  val default: ListBoxMenuComponent = js.native
  
  type ListBoxMenuComponent = ForwardRefReturn[HTMLDivElement, ListBoxMenuProps]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'id'> */
  trait ListBoxMenuProps extends StObject {
  ...
  object ListBoxMenuProps {
    
    inline def apply(id: String): ListBoxMenuProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListBoxMenuProps]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ListBoxMenuProps] (val x: Self) extends AnyVal {
  ...
  type _To = ListBoxMenuComponent
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsListBoxListBoxMenuMod.foo` */
  override def _to: ListBoxMenuComponent = default
}
