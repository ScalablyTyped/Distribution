...
object libComponentsToggleSmallToggleSmallMod extends Shortcut {
  ...
  */
  ...
  object ToggleSmallProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ToggleSmallProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsToggleSmallToggleSmallMod.foo` */
