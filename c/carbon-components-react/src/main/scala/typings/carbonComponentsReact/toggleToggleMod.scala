...
object toggleToggleMod {
  ...
  */
  ...
  object ToggleProps {
    ...
    @scala.inline
    def apply(id: String): ToggleProps = {
    ...
    implicit class TogglePropsMutableBuilder[Self <: ToggleProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChange(value: /* event */ ChangeEvent[HTMLInputElement] | KeyboardEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
