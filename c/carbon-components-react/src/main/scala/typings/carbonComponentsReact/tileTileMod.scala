...
object tileTileMod {
  ...
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "ClickableTile")
  @js.native
  class ClickableTile protected ()
    extends Component[ClickableTileProps, js.Object, js.Any] {
    def this(props: ClickableTileProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: ClickableTileProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "ExpandableTile")
  @js.native
  class ExpandableTile protected ()
    extends Component[ExpandableTileProps, js.Object, js.Any] {
    def this(props: ExpandableTileProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: ExpandableTileProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "SelectableTile")
  @js.native
  class SelectableTile protected ()
    extends Component[SelectableTileProps, js.Object, js.Any] {
    def this(props: SelectableTileProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: SelectableTileProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "Tile")
  @js.native
  ...
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "TileAboveTheFoldContent")
  @js.native
  class TileAboveTheFoldContent protected ()
    extends Component[TileAboveTheFoldContentProps, js.Object, js.Any] {
    def this(props: TileAboveTheFoldContentProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: TileAboveTheFoldContentProps, context: js.Any) = this()
  }
  
  @JSImport("carbon-components-react/lib/components/Tile/Tile", "TileBelowTheFoldContent")
  @js.native
  class TileBelowTheFoldContent protected ()
    extends Component[TileBelowTheFoldContentProps, js.Object, js.Any] {
    def this(props: TileBelowTheFoldContentProps) = this()
    /**
      * @deprecated
      * @see https://reactjs.org/docs/legacy-context.html
      */
    def this(props: TileBelowTheFoldContentProps, context: js.Any) = this()
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAnchorAttr<std.HTMLAnchorElement>, 'onClick' | 'onKeyDown'> */
  trait ClickableTileProps extends StObject {
    ...
    var handleClick: js.UndefOr[MouseEventHandler[HTMLAnchorElement]] = js.undefined
    
    var handleKeyDown: js.UndefOr[KeyboardEventHandler[HTMLAnchorElement]] = js.undefined
  ...
  object ClickableTileProps {
    
    @scala.inline
    def apply(): ClickableTileProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ClickableTileProps]
    }
    
    @scala.inline
    implicit class ClickableTilePropsMutableBuilder[Self <: ClickableTileProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHandleClick(value: MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "handleClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setHandleClickUndefined: Self = StObject.set(x, "handleClick", js.undefined)
      
      @scala.inline
      def setHandleKeyDown(value: KeyboardEvent[HTMLAnchorElement] => Unit): Self = StObject.set(x, "handleKeyDown", js.Any.fromFunction1(value))
  ...
  trait ExpandableTileProps extends StObject {
    ...
    var handleClick: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
    ...
    var onBeforeClick: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
    ...
    var tileCollapsedIconText: js.UndefOr[String] = js.undefined
    
    var tileExpandedIconText: js.UndefOr[String] = js.undefined
    
    var tileMaxHeight: js.UndefOr[Double] = js.undefined
    
    var tilePadding: js.UndefOr[Double] = js.undefined
  ...
  object ExpandableTileProps {
    
    @scala.inline
    def apply(): ExpandableTileProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ExpandableTileProps]
    }
    
    @scala.inline
    implicit class ExpandableTilePropsMutableBuilder[Self <: ExpandableTileProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHandleClick(value: /* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "handleClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnBeforeClick(value: /* e */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onBeforeClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnBeforeClickUndefined: Self = StObject.set(x, "onBeforeClick", js.undefined)
      ...
      @scala.inline
      def setTileCollapsedIconText(value: String): Self = StObject.set(x, "tileCollapsedIconText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTileCollapsedIconTextUndefined: Self = StObject.set(x, "tileCollapsedIconText", js.undefined)
      
      @scala.inline
      def setTileExpandedIconText(value: String): Self = StObject.set(x, "tileExpandedIconText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTileExpandedIconTextUndefined: Self = StObject.set(x, "tileExpandedIconText", js.undefined)
      
      @scala.inline
      def setTileMaxHeight(value: Double): Self = StObject.set(x, "tileMaxHeight", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTileMaxHeightUndefined: Self = StObject.set(x, "tileMaxHeight", js.undefined)
      
      @scala.inline
      def setTilePadding(value: Double): Self = StObject.set(x, "tilePadding", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTilePaddingUndefined: Self = StObject.set(x, "tilePadding", js.undefined)
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLabelAttr<std.HTMLLabelElement>, carbon-components-react.carbon-components-react/lib/components/Tile/Tile.SelectedTileExcludedAttributes> */
  @js.native
  trait SelectableTileProps extends StObject {
    ...
    var handleClick: js.UndefOr[js.Function1[/* e */ MouseEvent[HTMLLabelElement, NativeMouseEvent], Unit]] = js.native
    
    var handleKeyDown: js.UndefOr[js.Function1[/* e */ KeyboardEvent[HTMLLabelElement], Unit]] = js.native
    ...
    /**
      * @deprecated
      */
    var iconDescription: js.UndefOr[String] = js.native
    ...
    def onChange(e: KeyboardEvent[HTMLLabelElement]): Unit = js.native
    def onChange(e: MouseEvent[HTMLLabelElement, NativeMouseEvent]): Unit = js.native
  ...
  */
  trait SelectedTileExcludedAttributes extends StObject
  object SelectedTileExcludedAttributes {
    ...
    @scala.inline
    def onClick: typings.carbonComponentsReact.carbonComponentsReactStrings.onClick = "onClick".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onClick]
  ...
  trait TileAboveTheFoldContentProps extends StObject {
    
    var children: js.UndefOr[ReactNode] = js.undefined
  }
  object TileAboveTheFoldContentProps {
    
    @scala.inline
    def apply(): TileAboveTheFoldContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TileAboveTheFoldContentProps]
    }
    
    @scala.inline
    implicit class TileAboveTheFoldContentPropsMutableBuilder[Self <: TileAboveTheFoldContentProps] (val x: Self) extends AnyVal {
  ...
  trait TileBelowTheFoldContentProps extends StObject {
    
    var children: js.UndefOr[ReactNode] = js.undefined
  }
  object TileBelowTheFoldContentProps {
    
    @scala.inline
    def apply(): TileBelowTheFoldContentProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TileBelowTheFoldContentProps]
    }
    
    @scala.inline
    implicit class TileBelowTheFoldContentPropsMutableBuilder[Self <: TileBelowTheFoldContentProps] (val x: Self) extends AnyVal {
