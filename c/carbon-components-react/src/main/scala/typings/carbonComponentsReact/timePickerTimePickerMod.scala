...
object timePickerTimePickerMod {
  ...
  @JSImport("carbon-components-react/lib/components/TimePicker/TimePicker", JSImport.Default)
  @js.native
  class default ()
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, 'id' | 'size'> */
  ...
  object TimePickerProps {
    ...
    @scala.inline
    def apply(id: String): TimePickerProps = {
    ...
    implicit class TimePickerPropsMutableBuilder[Self <: TimePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSize(value: sm | xl): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
