...
object datePickerDatePickerMod {
  ...
  trait DatePickerProps extends StObject {
    ...
    var locale: js.UndefOr[key] = js.undefined
  ...
  object DatePickerProps {
    ...
    implicit class DatePickerPropsMutableBuilder[Self <: DatePickerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAppendTo(value: String | HTMLElement): Self = StObject.set(x, "appendTo", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setDatePickerType(value: range | single | simple): Self = StObject.set(x, "datePickerType", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setLocale(value: key): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValue(value: DateOption | js.Array[DateOption]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      @scala.inline
      def setValueVarargs(value: DateOption*): Self = StObject.set(x, "value", js.Array(value :_*))
