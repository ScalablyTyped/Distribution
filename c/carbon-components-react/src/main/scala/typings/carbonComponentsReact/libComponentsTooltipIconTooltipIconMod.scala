...
object libComponentsTooltipIconTooltipIconMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/TooltipIcon/TooltipIcon", JSImport.Default)
  @js.native
  val default: FC[TooltipIconProps] = js.native
  ...
  */
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, carbon-components-react.carbon-components-react/lib/components/TooltipIcon/TooltipIcon.ExcludedAttributes> */
  trait TooltipIconProps extends StObject {
    ...
    // required but has default value, should be bottom/top but the prop type has left/right
    ...
    var tooltipText: NonNullable[ReactNode]
  ...
  object TooltipIconProps {
    
    inline def apply(): TooltipIconProps = {
    ...
    implicit open class MutableBuilder[Self <: TooltipIconProps] (val x: Self) extends AnyVal {
      ...
      inline def setTooltipText(value: NonNullable[ReactNode]): Self = StObject.set(x, "tooltipText", value.asInstanceOf[js.Any])
  ...
  type _To = FC[TooltipIconProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsTooltipIconTooltipIconMod.foo` */
  override def _to: FC[TooltipIconProps] = default
}
