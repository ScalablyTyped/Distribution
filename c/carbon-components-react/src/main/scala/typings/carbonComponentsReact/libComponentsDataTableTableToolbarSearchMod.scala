...
import typings.carbonComponentsReact.libComponentsSearchSearchMod.SearchSpreadElement
...
object libComponentsDataTableTableToolbarSearchMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/DataTable/TableToolbarSearch", JSImport.Default)
  @js.native
  ...
  */
  ...
  trait TableToolbarSearchProps extends StObject {
    ...
    /**
      * @deprecated
      */
    var persistant: js.UndefOr[Boolean] = js.undefined
  ...
  object TableToolbarSearchProps {
    
    inline def apply(): TableToolbarSearchProps = {
    ...
    implicit open class MutableBuilder[Self <: TableToolbarSearchProps] (val x: Self) extends AnyVal {
      ...
      inline def setPersistant(value: Boolean): Self = StObject.set(x, "persistant", value.asInstanceOf[js.Any])
      
      inline def setPersistantUndefined: Self = StObject.set(x, "persistant", js.undefined)
      ...
      inline def setSearchContainerClass(value: String): Self = StObject.set(x, "searchContainerClass", value.asInstanceOf[js.Any])
      
      inline def setSearchContainerClassUndefined: Self = StObject.set(x, "searchContainerClass", js.undefined)
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotlabel
    - typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotplaceholder
  */
  trait TableToolbarTranslationKey
    extends StObject
       with _CarbonTranslationKey
  object TableToolbarTranslationKey {
    
    inline def carbonDottableDottoolbarDotsearchDotlabel: typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotlabel = "carbon.table.toolbar.search.label".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotlabel]
    
    inline def carbonDottableDottoolbarDotsearchDotplaceholder: typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotplaceholder = "carbon.table.toolbar.search.placeholder".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.carbonDottableDottoolbarDotsearchDotplaceholder]
  }
  
  type _To = FC[TableToolbarSearchProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsDataTableTableToolbarSearchMod.foo` */
  override def _to: FC[TableToolbarSearchProps] = default
}
