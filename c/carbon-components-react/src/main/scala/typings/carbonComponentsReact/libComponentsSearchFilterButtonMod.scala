...
object libComponentsSearchFilterButtonMod extends Shortcut {
  
  /**
    * @deprecated
    */
  @JSImport("carbon-components-react/lib/components/SearchFilterButton", JSImport.Default)
  @js.native
  val default: FC[SearchFilterButtonProps] = js.native
  
  type _To = FC[SearchFilterButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsSearchFilterButtonMod.foo` */
