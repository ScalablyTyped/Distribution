...
import typings.carbonComponentsReact.overflowMenuOverflowMenuMod.MenuOffsetValue
...
object tableToolbarMenuMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/DataTable/TableToolbarMenu", JSImport.Default)
  @js.native
  val default: FC[TableToolbarMenuProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/OverflowMenu.OverflowMenuProps, 'children'> */
  ...
  trait TableToolbarMenuProps extends StObject {
    ...
    var menuOffsetFlip: js.UndefOr[MenuOffsetValue] = js.undefined
    
    var menuOptionsClass: js.UndefOr[String] = js.undefined
  ...
  object TableToolbarMenuProps {
    
    @scala.inline
    def apply(): TableToolbarMenuProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TableToolbarMenuProps]
    }
    
    @scala.inline
    implicit class TableToolbarMenuPropsMutableBuilder[Self <: TableToolbarMenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMenuOffset(value: MenuOffsetValue): Self = StObject.set(x, "menuOffset", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMenuOffsetFlip(value: MenuOffsetValue): Self = StObject.set(x, "menuOffsetFlip", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMenuOffsetFlipFunction4(
        value: (/* menuBody */ HTMLElement, /* direction */ Direction, /* trigger */ js.UndefOr[HTMLElement], /* flip */ js.UndefOr[Boolean]) => js.UndefOr[MenuOffsetData]
      ): Self = StObject.set(x, "menuOffsetFlip", js.Any.fromFunction4(value))
      
      @scala.inline
      def setMenuOffsetFlipUndefined: Self = StObject.set(x, "menuOffsetFlip", js.undefined)
      
      @scala.inline
      def setMenuOffsetFunction4(
        value: (/* menuBody */ HTMLElement, /* direction */ Direction, /* trigger */ js.UndefOr[HTMLElement], /* flip */ js.UndefOr[Boolean]) => js.UndefOr[MenuOffsetData]
      ): Self = StObject.set(x, "menuOffset", js.Any.fromFunction4(value))
      
      @scala.inline
      def setMenuOffsetUndefined: Self = StObject.set(x, "menuOffset", js.undefined)
      
      @scala.inline
      def setMenuOptionsClass(value: String): Self = StObject.set(x, "menuOptionsClass", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMenuOptionsClassUndefined: Self = StObject.set(x, "menuOptionsClass", js.undefined)
  ...
  type _To = FC[TableToolbarMenuProps]
  
  /* This means you don't have to write `default`, but can instead just say `tableToolbarMenuMod.foo` */
  override def _to: FC[TableToolbarMenuProps] = default
}
