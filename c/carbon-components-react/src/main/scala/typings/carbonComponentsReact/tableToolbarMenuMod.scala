...
object tableToolbarMenuMod extends Shortcut {
  ...
  object TableToolbarMenuProps {
    ...
    inline def apply(children: NonNullable[ReactNode]): TableToolbarMenuProps = {
    ...
    extension [Self <: TableToolbarMenuProps](x: Self) {
      ...
      inline def setMenuOffset(value: MenuOffsetValue): Self = StObject.set(x, "menuOffset", value.asInstanceOf[js.Any])
      
      inline def setMenuOffsetFlip(value: MenuOffsetValue): Self = StObject.set(x, "menuOffsetFlip", value.asInstanceOf[js.Any])
      
      inline def setMenuOffsetFlipFunction4(
      ...
      inline def setMenuOffsetFlipUndefined: Self = StObject.set(x, "menuOffsetFlip", js.undefined)
      
      inline def setMenuOffsetFunction4(
        value: (/* menuBody */ HTMLElement, /* direction */ Direction, /* trigger */ js.UndefOr[HTMLElement], /* flip */ js.UndefOr[Boolean]) => js.UndefOr[MenuOffsetData]
      ...
      inline def setMenuOptionsClass(value: String): Self = StObject.set(x, "menuOptionsClass", value.asInstanceOf[js.Any])
      
      inline def setMenuOptionsClassUndefined: Self = StObject.set(x, "menuOptionsClass", js.undefined)
