...
object libComponentsGridColumnMod {
  ...
  inline def default_center(props: ColumnIntrinsicProps[center]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  inline def default_search(props: ColumnIntrinsicProps[search]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    C extends carbon-components-react.carbon-components-react/typings/shared.ReactComponentConstructor<infer P> ? carbon-components-react.carbon-components-react/lib/components/Grid/Column.ColumnBaseProps & carbon-components-react.carbon-components-react/lib/components/Grid/Column.SafeProps<P> & {  as :C} : never
    }}}
    */
  @js.native
  trait ColumnCustomComponentProps[C /* <: ReactComponentConstructor[scala.Nothing] */] extends StObject
  ...
  type ColumnIntrinsicProps[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.carbonComponentsReact.carbonComponentsReactStrings.a, typings.carbonComponentsReact.carbonComponentsReactStrings.abbr, typings.carbonComponentsReact.carbonComponentsReactStrings.address */ Any */] = ColumnBaseProps & (SafeProps[JSXIntrinsicElementProps[K, `false`]]) & As[K]
