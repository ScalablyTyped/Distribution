...
object libComponentsCodeSnippetCodeSnippetMod {
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/lib/components/CodeSnippet/CodeSnippet.SharedProps */
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'children'> */
  trait CodeSnippetDivProps extends StObject {
    ...
    var copyText: js.UndefOr[String] = js.undefined
    ...
    var `type`: js.UndefOr[single | Null] = js.undefined
  ...
  object CodeSnippetDivProps {
    ...
    extension [Self <: CodeSnippetDivProps](x: Self) {
      ...
      inline def setCopyText(value: String): Self = StObject.set(x, "copyText", value.asInstanceOf[js.Any])
      
      inline def setCopyTextUndefined: Self = StObject.set(x, "copyText", js.undefined)
  ...
  trait CodeSnippetInlineProps extends StObject {
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/lib/components/CodeSnippet/CodeSnippet.SharedProps */
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'children'> */
  trait CodeSnippetMultiProps extends StObject {
    ...
    var maxCollapsedNumberOfRows: js.UndefOr[Double] = js.undefined
    
    var maxExpandedNumberOfRows: js.UndefOr[Double] = js.undefined
    
    var minCollapsedNumberOfRows: js.UndefOr[Double] = js.undefined
    
    var minExpandedNumberOfRows: js.UndefOr[Double] = js.undefined
  ...
  object CodeSnippetMultiProps {
    
    inline def apply(): CodeSnippetMultiProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: CodeSnippetMultiProps](x: Self) {
      ...
      inline def setMaxCollapsedNumberOfRows(value: Double): Self = StObject.set(x, "maxCollapsedNumberOfRows", value.asInstanceOf[js.Any])
      
      inline def setMaxCollapsedNumberOfRowsUndefined: Self = StObject.set(x, "maxCollapsedNumberOfRows", js.undefined)
      
      inline def setMaxExpandedNumberOfRows(value: Double): Self = StObject.set(x, "maxExpandedNumberOfRows", value.asInstanceOf[js.Any])
      
      inline def setMaxExpandedNumberOfRowsUndefined: Self = StObject.set(x, "maxExpandedNumberOfRows", js.undefined)
      
      inline def setMinCollapsedNumberOfRows(value: Double): Self = StObject.set(x, "minCollapsedNumberOfRows", value.asInstanceOf[js.Any])
      
      inline def setMinCollapsedNumberOfRowsUndefined: Self = StObject.set(x, "minCollapsedNumberOfRows", js.undefined)
      
      inline def setMinExpandedNumberOfRows(value: Double): Self = StObject.set(x, "minExpandedNumberOfRows", value.asInstanceOf[js.Any])
      
      inline def setMinExpandedNumberOfRowsUndefined: Self = StObject.set(x, "minExpandedNumberOfRows", js.undefined)
