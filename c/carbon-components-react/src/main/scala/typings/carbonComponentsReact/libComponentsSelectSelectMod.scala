...
object libComponentsSelectSelectMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/Select/Select", JSImport.Default)
  @js.native
  val default: ForwardRefReturn[HTMLSelectElement, SelectProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-invalid`
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def `aria-invalid`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-invalid` = "aria-invalid".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-invalid`]
  ...
  /* Inlined parent std.Omit<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, carbon-components-react.carbon-components-react/lib/components/Select/Select.ExcludedAttributes> */
  trait SelectProps extends StObject {
    ...
    var noLabel: js.UndefOr[Boolean] = js.undefined
  ...
  object SelectProps {
    ...
    inline def apply(id: String): SelectProps = {
    ...
    implicit open class MutableBuilder[Self <: SelectProps] (val x: Self) extends AnyVal {
      ...
      inline def setLabelText(value: ReactNode): Self = StObject.set(x, "labelText", value.asInstanceOf[js.Any])
      ...
      inline def setNoLabelUndefined: Self = StObject.set(x, "noLabel", js.undefined)
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsSelectSelectMod.foo` */
