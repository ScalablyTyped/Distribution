...
object loadingLoadingMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-atomic`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-atomic` = "aria-atomic".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-atomic`]
    ...
    @scala.inline
    def `aria-live`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-live` = "aria-live".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-live`]
  }
  ...
  object LoadingProps {
    ...
    @scala.inline
    def apply(): LoadingProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[LoadingProps]
    }
    
    @scala.inline
    implicit class LoadingPropsMutableBuilder[Self <: LoadingProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `loadingLoadingMod.foo` */
