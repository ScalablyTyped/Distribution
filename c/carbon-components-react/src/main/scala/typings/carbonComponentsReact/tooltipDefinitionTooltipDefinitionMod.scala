...
object tooltipDefinitionTooltipDefinitionMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/TooltipDefinition/TooltipDefinition", JSImport.Default)
  @js.native
  val default: FC[TooltipDefinitionProps] = js.native
  ...
  */
  trait ExcludedPropsKeys extends StObject
  object ExcludedPropsKeys {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAttr<std.HTMLSpanElement>, carbon-components-react.carbon-components-react/lib/components/TooltipDefinition/TooltipDefinition.ExcludedPropsKeys> */
  trait TooltipDefinitionProps extends StObject {
    ...
    var onBlur: js.UndefOr[js.Function1[/* event */ FocusEvent[HTMLButtonElement, Element], Unit]] = js.undefined
    ...
    var onFocus: js.UndefOr[js.Function1[/* event */ FocusEvent[HTMLButtonElement, Element], Unit]] = js.undefined
  ...
  object TooltipDefinitionProps {
    
    inline def apply(tooltipText: NonNullable[ReactNode]): TooltipDefinitionProps = {
      val __obj = js.Dynamic.literal(tooltipText = tooltipText.asInstanceOf[js.Any])
      __obj.asInstanceOf[TooltipDefinitionProps]
    }
    
    extension [Self <: TooltipDefinitionProps](x: Self) {
      ...
      inline def setOnBlur(value: /* event */ FocusEvent[HTMLButtonElement, Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: /* event */ FocusEvent[HTMLButtonElement, Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
  ...
  type _To = FC[TooltipDefinitionProps]
  
  /* This means you don't have to write `default`, but can instead just say `tooltipDefinitionTooltipDefinitionMod.foo` */
  override def _to: FC[TooltipDefinitionProps] = default
}
