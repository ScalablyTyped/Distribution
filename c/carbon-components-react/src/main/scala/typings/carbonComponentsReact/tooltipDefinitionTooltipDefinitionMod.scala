...
object tooltipDefinitionTooltipDefinitionMod extends Shortcut {
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'onFocus'> */
  trait TooltipDefinitionProps extends StObject {
    ...
    var onFocus: js.UndefOr[js.Function1[/* event */ MouseEvent[HTMLButtonElement, NativeMouseEvent], Unit]] = js.undefined
  ...
  object TooltipDefinitionProps {
    ...
    @scala.inline
    def apply(): TooltipDefinitionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TooltipDefinitionProps]
    }
    
    @scala.inline
    implicit class TooltipDefinitionPropsMutableBuilder[Self <: TooltipDefinitionProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlign(value: TooltipAlignment): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnFocus(value: /* event */ MouseEvent[HTMLButtonElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setTooltipText(value: NonNullable[ReactNode]): Self = StObject.set(x, "tooltipText", value.asInstanceOf[js.Any])
