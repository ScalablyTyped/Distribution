...
object libComponentsSearchSearchMod {
  ...
  */
  ...
  trait SearchProps extends StObject {
    ...
    var closeButtonLabelText: js.UndefOr[String] = js.undefined
  ...
  object SearchProps {
    ...
    extension [Self <: SearchProps](x: Self) {
      ...
      inline def setCloseButtonLabelText(value: String): Self = StObject.set(x, "closeButtonLabelText", value.asInstanceOf[js.Any])
      
      inline def setCloseButtonLabelTextUndefined: Self = StObject.set(x, "closeButtonLabelText", js.undefined)
