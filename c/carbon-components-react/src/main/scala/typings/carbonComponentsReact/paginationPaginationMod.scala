...
object paginationPaginationMod {
  ...
  */
  ...
  object PaginationPageSize {
    ...
    @scala.inline
    def apply(text: String, value: String): PaginationPageSize = {
      val __obj = js.Dynamic.literal(text = text.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[PaginationPageSize]
    }
    
    @scala.inline
    implicit class PaginationPageSizeMutableBuilder[Self <: PaginationPageSize] (val x: Self) extends AnyVal {
  ...
  object PaginationProps {
    ...
    @scala.inline
    def apply(onChange: Page => Unit, pageSizes: js.Array[Double | PaginationPageSize]): PaginationProps = {
    ...
    implicit class PaginationPropsMutableBuilder[Self <: PaginationProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setIsLastPageUndefined: Self = StObject.set(x, "isLastPage", js.undefined)
      ...
      @scala.inline
      def setOnChange(value: Page => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setPageInputDisabled(value: Boolean): Self = StObject.set(x, "pageInputDisabled", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPageInputDisabledUndefined: Self = StObject.set(x, "pageInputDisabled", js.undefined)
      
      @scala.inline
      def setPageNumberText(value: String): Self = StObject.set(x, "pageNumberText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPageNumberTextUndefined: Self = StObject.set(x, "pageNumberText", js.undefined)
      
      @scala.inline
      def setPageRangeText(value: (/* current */ Double, /* total */ Double) => String): Self = StObject.set(x, "pageRangeText", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setPageSizes(value: js.Array[Double | PaginationPageSize]): Self = StObject.set(x, "pageSizes", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setPageSizesVarargs(value: (Double | PaginationPageSize)*): Self = StObject.set(x, "pageSizes", js.Array(value :_*))
      
      @scala.inline
      def setPageText(value: /* page */ Double => String): Self = StObject.set(x, "pageText", js.Any.fromFunction1(value))
