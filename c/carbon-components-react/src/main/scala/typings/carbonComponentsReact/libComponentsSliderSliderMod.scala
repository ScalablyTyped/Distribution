...
import typings.carbonComponentsReact.anon.ValueNumber
...
object libComponentsSliderSliderMod {
  ...
  @JSImport("carbon-components-react/lib/components/Slider/Slider", JSImport.Default)
  @js.native
  open class default ()
  ...
  trait SliderOnChangeArg extends StObject {
    
    var value: Double
  }
  object SliderOnChangeArg {
    
    inline def apply(value: Double): SliderOnChangeArg = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[SliderOnChangeArg]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SliderOnChangeArg] (val x: Self) extends AnyVal {
  ...
  trait SliderProps extends StObject {
    ...
    var ariaLabelInput: js.UndefOr[String] = js.undefined
    ...
    var formatLabel: js.UndefOr[js.Function2[/* value */ Double, /* minOrMaxLabel */ String, String]] = js.undefined
    
    var hidden: js.UndefOr[Boolean] = js.undefined
    
    var hideTextInput: js.UndefOr[Boolean] = js.undefined
    ...
    var inputType: js.UndefOr[HTMLInputTypeAttribute] = js.undefined
    ...
    def onChange(value: SliderOnChangeArg): Unit
    ...
    var onRelease: js.UndefOr[js.Function1[/* data */ ValueNumber, Unit]] = js.undefined
  ...
  object SliderProps {
    ...
    inline def apply(max: Double, min: Double, onChange: SliderOnChangeArg => Unit, value: Double): SliderProps = {
      val __obj = js.Dynamic.literal(max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], onChange = js.Any.fromFunction1(onChange), value = value.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: SliderProps] (val x: Self) extends AnyVal {
      ...
      inline def setAriaLabelInput(value: String): Self = StObject.set(x, "ariaLabelInput", value.asInstanceOf[js.Any])
      
      inline def setAriaLabelInputUndefined: Self = StObject.set(x, "ariaLabelInput", js.undefined)
      ...
      inline def setFormatLabel(value: (/* value */ Double, /* minOrMaxLabel */ String) => String): Self = StObject.set(x, "formatLabel", js.Any.fromFunction2(value))
      ...
      inline def setHideTextInput(value: Boolean): Self = StObject.set(x, "hideTextInput", value.asInstanceOf[js.Any])
      
      inline def setHideTextInputUndefined: Self = StObject.set(x, "hideTextInput", js.undefined)
      ...
      inline def setInputType(value: HTMLInputTypeAttribute): Self = StObject.set(x, "inputType", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: SliderOnChangeArg => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnRelease(value: /* data */ ValueNumber => Unit): Self = StObject.set(x, "onRelease", js.Any.fromFunction1(value))
