...
object libComponentsComboBoxComboBoxMod {
  ...
  trait ComboBoxProps[ItemType, CustomElementProps] extends StObject {
    ...
    var itemToElement: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: CustomElementProps extends object ? react.react.JSXElementConstructor<CustomElementProps> : never | undefined */ js.Any
      ] = js.undefined
  ...
  object ComboBoxProps {
    ...
    implicit open class MutableBuilder[Self <: ComboBoxProps[?, ?], ItemType, CustomElementProps] (val x: Self & (ComboBoxProps[ItemType, CustomElementProps])) extends AnyVal {
      ...
      inline def setItemToElement(
        value: /* import warning: importer.ImportType#apply Failed type conversion: CustomElementProps extends object ? react.react.JSXElementConstructor<CustomElementProps> : never | undefined */ js.Any
      ): Self = StObject.set(x, "itemToElement", value.asInstanceOf[js.Any])
