...
object libComponentsToggleToggleMod {
  
  @JSImport("carbon-components-react/lib/components/Toggle/Toggle", JSImport.Default)
  @js.native
  open class default ()
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyUp
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def onKeyUp: typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyUp = "onKeyUp".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onKeyUp]
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/Toggle/Toggle.ExcludedAttributes> */
  trait ToggleProps extends StObject {
    ...
    var labelA: js.UndefOr[String] = js.undefined
    
    // required but has default value
    var labelB: js.UndefOr[String] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function1[/* event */ ChangeEvent[HTMLInputElement] | KeyboardEvent[HTMLInputElement], Unit]
      ] = js.undefined
  ...
  object ToggleProps {
    ...
    inline def apply(id: String): ToggleProps = {
    ...
    implicit open class MutableBuilder[Self <: ToggleProps] (val x: Self) extends AnyVal {
      ...
      inline def setLabelA(value: String): Self = StObject.set(x, "labelA", value.asInstanceOf[js.Any])
      
      inline def setLabelAUndefined: Self = StObject.set(x, "labelA", js.undefined)
      
      inline def setLabelB(value: String): Self = StObject.set(x, "labelB", value.asInstanceOf[js.Any])
      
      inline def setLabelBUndefined: Self = StObject.set(x, "labelB", js.undefined)
      ...
      inline def setOnChange(value: /* event */ ChangeEvent[HTMLInputElement] | KeyboardEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnToggle(
        value: (/* checked */ Boolean, /* id */ String, /* event */ ChangeEvent[HTMLInputElement] | KeyboardEvent[HTMLInputElement]) => Unit
