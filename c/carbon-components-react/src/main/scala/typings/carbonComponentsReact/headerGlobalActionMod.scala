...
object headerGlobalActionMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/UIShell/HeaderGlobalAction", JSImport.Default)
  @js.native
  ...
  object HeaderGlobalActionProps {
    ...
    @scala.inline
    def apply(): HeaderGlobalActionProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HeaderGlobalActionProps]
    }
    
    @scala.inline
    implicit class HeaderGlobalActionPropsMutableBuilder[Self <: HeaderGlobalActionProps] (val x: Self) extends AnyVal {
  ...
  type _To = ForwardRefReturn[HTMLButtonElement, HeaderGlobalActionProps]
  
  /* This means you don't have to write `default`, but can instead just say `headerGlobalActionMod.foo` */
  override def _to: ForwardRefReturn[HTMLButtonElement, HeaderGlobalActionProps] = default
}
