...
object radioButtonRadioButtonMod extends Shortcut {
  ...
  @JSImport("carbon-components-react/lib/components/RadioButton/RadioButton", JSImport.Default)
  @js.native
  val default: ForwardRefReturn[HTMLInputElement, RadioButtonProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/RadioButton/RadioButton", "RadioButton")
  @js.native
  ...
  */
  ...
  type RadioButtonComponent = Component[RadioButtonProps, js.Object, Any]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/RadioButton/RadioButton.ExcludedAttributes> */
  trait RadioButtonProps extends StObject {
    ...
    /**
      ...
      */
    var labelPosition: js.UndefOr[bottom | left | right | top] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function3[
          /* value */ js.UndefOr[RadioButtonValue], 
    ...
    // required but has default value
    var value: js.UndefOr[RadioButtonValue] = js.undefined
  ...
  object RadioButtonProps {
    ...
    extension [Self <: RadioButtonProps](x: Self) {
      ...
      inline def setLabelPosition(value: bottom | left | right | top): Self = StObject.set(x, "labelPosition", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(
        value: (/* value */ js.UndefOr[RadioButtonValue], /* name */ js.UndefOr[String], /* event */ ChangeEvent[HTMLInputElement]) => Unit
  ...
  type RadioButtonValue = String | Double
  
  type _To = ForwardRefReturn[HTMLInputElement, RadioButtonProps]
  
  /* This means you don't have to write `default`, but can instead just say `radioButtonRadioButtonMod.foo` */
  override def _to: ForwardRefReturn[HTMLInputElement, RadioButtonProps] = default
}
