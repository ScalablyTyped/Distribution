  ...
  */
  ...
  object RadioButtonProps {
    ...
    implicit class RadioButtonPropsMutableBuilder[Self <: RadioButtonProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setLabelPosition(value: bottom | left | right | top): Self = StObject.set(x, "labelPosition", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setValue(value: RadioButtonValue): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
