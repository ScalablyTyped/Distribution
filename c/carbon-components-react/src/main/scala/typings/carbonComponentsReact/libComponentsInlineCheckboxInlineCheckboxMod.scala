...
object libComponentsInlineCheckboxInlineCheckboxMod extends Shortcut {
  ...
  */
  ...
  object InlineCheckboxProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InlineCheckboxProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsInlineCheckboxInlineCheckboxMod.foo` */
