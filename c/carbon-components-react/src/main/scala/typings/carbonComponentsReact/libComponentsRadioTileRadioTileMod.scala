...
object libComponentsRadioTileRadioTileMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/RadioTile/RadioTile", JSImport.Default)
  @js.native
  val default: FC[RadioTileProps] = js.native
  ...
  */
  ...
  type RadioTileChangeEvent = ChangeEvent[HTMLInputElement] | KeyboardEvent[HTMLLabelElement]
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactInputAttr<std.HTMLInputElement>, carbon-components-react.carbon-components-react/lib/components/RadioTile/RadioTile.ExcludedAttributes> */
  trait RadioTileProps extends StObject {
  ...
  object RadioTileProps {
    
    inline def apply(value: RadioButtonValue): RadioTileProps = {
    ...
    extension [Self <: RadioTileProps](x: Self) {
      ...
      inline def setOnChange(
        value: (/* value */ RadioButtonValue, /* name */ js.UndefOr[String], /* event */ RadioTileChangeEvent) => Unit
      ...
      inline def setValue(value: RadioButtonValue): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  type _To = FC[RadioTileProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsRadioTileRadioTileMod.foo` */
  override def _to: FC[RadioTileProps] = default
}
