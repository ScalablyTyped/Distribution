...
import typings.carbonComponentsReact.carbonComponentsReactStrings.danger
...
object libComponentsMenuMenuOptionMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/Menu/MenuOption", JSImport.Default)
  @js.native
  val default: FC[MenuOptionProps] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-haspopup`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-expanded`
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseEnter
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseLeave
  ...
  */
  trait ExcludedPropKeys extends StObject
  object ExcludedPropKeys {
    ...
    inline def `aria-expanded`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-expanded` = "aria-expanded".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-expanded`]
    
    inline def `aria-haspopup`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-haspopup` = "aria-haspopup".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-haspopup`]
    ...
    inline def onMouseEnter: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseEnter = "onMouseEnter".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseEnter]
    
    inline def onMouseLeave: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseLeave = "onMouseLeave".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseLeave]
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLIAttr<std.HTMLLIElement>, carbon-components-react.carbon-components-react/lib/components/Menu/MenuOption.ExcludedPropKeys> */
  trait MenuOptionProps extends StObject {
    ...
    var indented: js.UndefOr[Boolean] = js.undefined
    ...
    // set by context menu parent component
    var kind: js.UndefOr[danger | typings.carbonComponentsReact.carbonComponentsReactStrings.default] = js.undefined
    ...
    var onClick: js.UndefOr[
        js.Function1[
          /* evt */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], 
          Unit
        ]
      ] = js.undefined
    ...
    var shortcut: js.UndefOr[ReactNode] = js.undefined
  ...
  object MenuOptionProps {
    
    inline def apply(label: String): MenuOptionProps = {
    ...
    implicit open class MutableBuilder[Self <: MenuOptionProps] (val x: Self) extends AnyVal {
      ...
      inline def setIndented(value: Boolean): Self = StObject.set(x, "indented", value.asInstanceOf[js.Any])
      
      inline def setIndentedUndefined: Self = StObject.set(x, "indented", js.undefined)
      ...
      inline def setKind(value: danger | typings.carbonComponentsReact.carbonComponentsReactStrings.default): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
      ...
      inline def setOnClick(
        value: /* evt */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement] => Unit
      ...
      inline def setShortcut(value: ReactNode): Self = StObject.set(x, "shortcut", value.asInstanceOf[js.Any])
  ...
  type _To = FC[MenuOptionProps]
  
  /* This means you don't have to write `default`, but can instead just say `libComponentsMenuMenuOptionMod.foo` */
  override def _to: FC[MenuOptionProps] = default
}
