...
object libComponentsDatePickerDatePickerMod {
  
  @JSImport("carbon-components-react/lib/components/DatePicker/DatePicker", JSImport.Default)
  @js.native
  open class default ()
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, 'onChange'> */
  trait DatePickerProps extends StObject {
    ...
    var datePickerType: js.UndefOr[range | single | simple] = js.undefined
    ...
    var value: js.UndefOr[DateOption | js.Array[DateOption]] = js.undefined
  ...
  object DatePickerProps {
    ...
    implicit open class MutableBuilder[Self <: DatePickerProps] (val x: Self) extends AnyVal {
      ...
      inline def setDatePickerType(value: range | single | simple): Self = StObject.set(x, "datePickerType", value.asInstanceOf[js.Any])
      
      inline def setDatePickerTypeUndefined: Self = StObject.set(x, "datePickerType", js.undefined)
      ...
      inline def setValue(value: DateOption | js.Array[DateOption]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      inline def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      inline def setValueVarargs(value: DateOption*): Self = StObject.set(x, "value", js.Array(value*))
