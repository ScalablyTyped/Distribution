...
object textDirectionMod {
  ...
  trait TextDirectionProps extends StObject {
    ...
    var dir: js.UndefOr[typings.carbonComponentsReact.textDirectionContextMod.TextDirection] = js.undefined
    
    var getTextDirection: js.UndefOr[
        js.Function1[
          /* repeated */ Any, 
          js.UndefOr[typings.carbonComponentsReact.textDirectionContextMod.TextDirection | Null]
        ]
      ] = js.undefined
  }
  object TextDirectionProps {
    ...
    extension [Self <: TextDirectionProps](x: Self) {
      ...
      inline def setDir(value: typings.carbonComponentsReact.textDirectionContextMod.TextDirection): Self = StObject.set(x, "dir", value.asInstanceOf[js.Any])
      
      inline def setDirUndefined: Self = StObject.set(x, "dir", js.undefined)
      
      inline def setGetTextDirection(
        value: /* repeated */ Any => js.UndefOr[typings.carbonComponentsReact.textDirectionContextMod.TextDirection | Null]
