...
object libComponentsCopyCopyMod extends Shortcut {
  ...
  object FeedbackProps {
    ...
    inline def apply(): FeedbackProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsCopyCopyMod.foo` */
