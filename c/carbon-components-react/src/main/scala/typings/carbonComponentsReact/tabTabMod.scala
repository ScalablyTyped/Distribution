...
object tabTabMod {
  ...
  @JSImport("carbon-components-react/lib/components/Tab/Tab", JSImport.Default)
  @js.native
  open class default ()
    extends Component[TabProps, js.Object, Any]
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-controls`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-selected`
    - typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled`
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def `aria-controls`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-controls` = "aria-controls".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-controls`]
    
    inline def `aria-disabled`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled` = "aria-disabled".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled`]
    
    inline def `aria-selected`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-selected` = "aria-selected".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-selected`]
  ...
  type TabCustomAnchorProviderProps = TabCustomButtonProvidedProps
  
  trait TabCustomButtonProvidedProps extends StObject {
    
    var `aria-controls`: String
    
    var `aria-disabled`: js.UndefOr[Boolean] = js.undefined
    
    var `aria-selected`: Boolean
    ...
    def ref(element: Any): Unit
    
    var tabIndex: Double
  }
  object TabCustomButtonProvidedProps {
    ...
    inline def apply(
      ...
      ref: Any => Unit,
      tabIndex: Double
    ): TabCustomButtonProvidedProps = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], ref = js.Any.fromFunction1(ref), tabIndex = tabIndex.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-controls")(`aria-controls`.asInstanceOf[js.Any])
      __obj.updateDynamic("aria-selected")(`aria-selected`.asInstanceOf[js.Any])
  ...
  trait TabCustomContentProvidedProps extends StObject {
    
    var `aria-hidden`: Boolean
  ...
  object TabCustomContentProvidedProps {
    
    inline def apply(`aria-hidden`: Boolean, className: String, hidden: Boolean, selected: Boolean): TabCustomContentProvidedProps = {
      val __obj = js.Dynamic.literal(className = className.asInstanceOf[js.Any], hidden = hidden.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any])
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/lib/components/Tab/Tab.TabStandaloneProps, carbon-components-react.carbon-components-react/lib/components/Tab/Tab.TabsProvidedPropKeys> */
  trait TabProps extends StObject {
    ...
    var renderAnchor: js.UndefOr[js.Function1[/* props */ TabCustomButtonProvidedProps, ReactNode]] = js.undefined
    
    var renderButton: js.UndefOr[js.Function1[/* props */ TabCustomButtonProvidedProps, ReactNode]] = js.undefined
    ...
    var renderContent: js.UndefOr[ComponentType[TabCustomContentProvidedProps]] = js.undefined
  ...
  object TabProps {
    ...
    extension [Self <: TabProps](x: Self) {
      ...
      inline def setRenderAnchor(value: /* props */ TabCustomButtonProvidedProps => ReactNode): Self = StObject.set(x, "renderAnchor", js.Any.fromFunction1(value))
      
      inline def setRenderAnchorUndefined: Self = StObject.set(x, "renderAnchor", js.undefined)
      
      inline def setRenderButton(value: /* props */ TabCustomButtonProvidedProps => ReactNode): Self = StObject.set(x, "renderButton", js.Any.fromFunction1(value))
      
      inline def setRenderButtonUndefined: Self = StObject.set(x, "renderButton", js.undefined)
      
      inline def setRenderContent(value: ComponentType[TabCustomContentProvidedProps]): Self = StObject.set(x, "renderContent", value.asInstanceOf[js.Any])
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactLIAttr<std.HTMLLIElement>, carbon-components-react.carbon-components-react/lib/components/Tab/Tab.ExcludedAttributes> */
  trait TabStandaloneProps extends StObject {
    ...
    var handleTabClick: js.UndefOr[
        js.Function2[
          /* index */ js.UndefOr[Double], 
          /* event */ MouseEvent[HTMLLIElement, NativeMouseEvent], 
          Unit
        ]
      ] = js.undefined
    
    var handleTabKeyDown: js.UndefOr[
        js.Function2[/* index */ js.UndefOr[Double], /* event */ KeyboardEvent[HTMLLIElement], Unit]
      ] = js.undefined
    ...
    // marked as required, but render code overwrites it currently, also has default
    var selected: Boolean
  ...
  object TabStandaloneProps {
    
    inline def apply(selected: Boolean): TabStandaloneProps = {
    ...
    extension [Self <: TabStandaloneProps](x: Self) {
      ...
      inline def setHandleTabClick(
        value: (/* index */ js.UndefOr[Double], /* event */ MouseEvent[HTMLLIElement, NativeMouseEvent]) => Unit
      ): Self = StObject.set(x, "handleTabClick", js.Any.fromFunction2(value))
      
      inline def setHandleTabClickUndefined: Self = StObject.set(x, "handleTabClick", js.undefined)
      
      inline def setHandleTabKeyDown(value: (/* index */ js.UndefOr[Double], /* event */ KeyboardEvent[HTMLLIElement]) => Unit): Self = StObject.set(x, "handleTabKeyDown", js.Any.fromFunction2(value))
      
      inline def setHandleTabKeyDownUndefined: Self = StObject.set(x, "handleTabKeyDown", js.undefined)
  ...
  // see Tabs.js
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.carbonComponentsReactStrings.index
    - typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabClick
    - typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabKeyDown
    - typings.carbonComponentsReact.carbonComponentsReactStrings.ref
    - typings.carbonComponentsReact.carbonComponentsReactStrings.selected
    - typings.carbonComponentsReact.carbonComponentsReactStrings.tabIndex
  */
  trait TabsProvidedPropKeys extends StObject
  object TabsProvidedPropKeys {
    
    inline def handleTabClick: typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabClick = "handleTabClick".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabClick]
    
    inline def handleTabKeyDown: typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabKeyDown = "handleTabKeyDown".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabKeyDown]
    
    inline def index: typings.carbonComponentsReact.carbonComponentsReactStrings.index = "index".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.index]
    ...
    inline def selected: typings.carbonComponentsReact.carbonComponentsReactStrings.selected = "selected".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.selected]
