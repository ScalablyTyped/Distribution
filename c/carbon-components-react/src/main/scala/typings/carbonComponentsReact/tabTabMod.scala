...
object tabTabMod {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-controls`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-controls` = "aria-controls".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-controls`]
    
    @scala.inline
    def `aria-disabled`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled` = "aria-disabled".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-disabled`]
    
    @scala.inline
    def `aria-selected`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-selected` = "aria-selected".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-selected`]
  ...
  object TabCustomButtonProvidedProps {
    ...
    @scala.inline
    implicit class TabCustomButtonProvidedPropsMutableBuilder[Self <: TabCustomButtonProvidedProps] (val x: Self) extends AnyVal {
  ...
  object TabCustomContentProvidedProps {
    ...
    @scala.inline
    def apply(`aria-hidden`: Boolean, className: String, hidden: Boolean, selected: Boolean): TabCustomContentProvidedProps = {
    ...
    @scala.inline
    implicit class TabCustomContentProvidedPropsMutableBuilder[Self <: TabCustomContentProvidedProps] (val x: Self) extends AnyVal {
  ...
  trait TabProps extends StObject {
    ...
    var renderAnchor: js.UndefOr[FC[TabCustomButtonProvidedProps]] = js.undefined
  ...
  object TabProps {
    ...
    implicit class TabPropsMutableBuilder[Self <: TabProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRenderAnchor(value: FC[TabCustomButtonProvidedProps]): Self = StObject.set(x, "renderAnchor", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setRenderAnchorUndefined: Self = StObject.set(x, "renderAnchor", js.undefined)
      
      @scala.inline
      def setRenderContent(value: ComponentType[TabCustomContentProvidedProps]): Self = StObject.set(x, "renderContent", value.asInstanceOf[js.Any])
  ...
  object TabStandaloneProps {
    ...
    @scala.inline
    def apply(selected: Boolean): TabStandaloneProps = {
      val __obj = js.Dynamic.literal(selected = selected.asInstanceOf[js.Any])
      __obj.asInstanceOf[TabStandaloneProps]
    }
    
    @scala.inline
    implicit class TabStandalonePropsMutableBuilder[Self <: TabStandaloneProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setHandleTabClickUndefined: Self = StObject.set(x, "handleTabClick", js.undefined)
      
      @scala.inline
      def setHandleTabKeyDown(value: (/* index */ js.UndefOr[Double], /* event */ KeyboardEvent[HTMLLIElement]) => Unit): Self = StObject.set(x, "handleTabKeyDown", js.Any.fromFunction2(value))
      
      @scala.inline
      def setHandleTabKeyDownUndefined: Self = StObject.set(x, "handleTabKeyDown", js.undefined)
  ...
  */
  ...
  object TabsProvidedPropKeys {
    ...
    @scala.inline
    def handleTabClick: typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabClick = "handleTabClick".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabClick]
    
    @scala.inline
    def handleTabKeyDown: typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabKeyDown = "handleTabKeyDown".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.handleTabKeyDown]
    
    @scala.inline
    def index: typings.carbonComponentsReact.carbonComponentsReactStrings.index = "index".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.index]
    ...
    @scala.inline
    def selected: typings.carbonComponentsReact.carbonComponentsReactStrings.selected = "selected".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.selected]
