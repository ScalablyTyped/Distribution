...
object numberInputNumberInputMod extends Shortcut {
  ...
  */
  ...
  object NumberInputProps {
    ...
    @scala.inline
    def apply(id: String, value: Double | _empty): NumberInputProps = {
    ...
    implicit class NumberInputPropsMutableBuilder[Self <: NumberInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setTranslateWithId(value: /* messageId */ NumberInputTranslationKey => String): Self = StObject.set(x, "translateWithId", js.Any.fromFunction1(value))
  ...
  */
  ...
  object NumberInputTranslationKey {
    ...
    @scala.inline
    def decrementDotnumber: typings.carbonComponentsReact.carbonComponentsReactStrings.decrementDotnumber = "decrement.number".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.decrementDotnumber]
    
    @scala.inline
    def incrementDotnumber: typings.carbonComponentsReact.carbonComponentsReactStrings.incrementDotnumber = "increment.number".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.incrementDotnumber]
  }
  
  type _To = ForwardRefReturn[HTMLInputElement, NumberInputProps]
  
  /* This means you don't have to write `default`, but can instead just say `numberInputNumberInputMod.foo` */
