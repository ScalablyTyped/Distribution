...
import typings.carbonComponentsReact.anon.IdLabel
...
object treeViewTreeViewMod extends Shortcut {
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def onSelect: typings.carbonComponentsReact.carbonComponentsReactStrings.onSelect = "onSelect".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onSelect]
  ...
  object TreeViewProps {
    ...
    inline def apply(label: String, selected: js.Array[Double | String]): TreeViewProps = {
    ...
    extension [Self <: TreeViewProps](x: Self) {
      ...
      inline def setOnSelect(
        value: (/* event */ (MouseEvent[HTMLLIElement, NativeMouseEvent]) | KeyboardEvent[HTMLLIElement], /* node */ IdLabel) => Unit
      ...
      inline def setSize(value: compact | typings.carbonComponentsReact.carbonComponentsReactStrings.default): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
