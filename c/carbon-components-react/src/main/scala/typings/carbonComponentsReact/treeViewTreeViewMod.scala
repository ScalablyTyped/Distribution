...
import typings.carbonComponentsReact.carbonComponentsReactStrings.compact
...
object treeViewTreeViewMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/TreeView/TreeView", JSImport.Default)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onSelect
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def `aria-labelledby`: typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-labelledby` = "aria-labelledby".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.`aria-labelledby`]
    
    @scala.inline
    def onSelect: typings.carbonComponentsReact.carbonComponentsReactStrings.onSelect = "onSelect".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onSelect]
  ...
  trait TreeViewFC
    extends StObject
       with FunctionComponent[TreeViewProps] {
    
    val TreeNode: FC[TreeNodeProps] = js.native
  }
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactAttr<std.HTMLUListElement>, carbon-components-react.carbon-components-react/lib/components/TreeView/TreeView.ExcludedAttributes> */
  trait TreeViewProps extends StObject {
    ...
    var selected: js.Array[Double | String]
    
    var size: js.UndefOr[compact | typings.carbonComponentsReact.carbonComponentsReactStrings.default] = js.undefined
  ...
  object TreeViewProps {
    ...
    @scala.inline
    def apply(label: String, selected: js.Array[Double | String]): TreeViewProps = {
    ...
    implicit class TreeViewPropsMutableBuilder[Self <: TreeViewProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSize(value: compact | typings.carbonComponentsReact.carbonComponentsReactStrings.default): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `treeViewTreeViewMod.foo` */
