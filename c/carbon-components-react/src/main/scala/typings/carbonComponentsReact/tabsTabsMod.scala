...
object tabsTabsMod {
  ...
  object TabsProps {
    ...
    implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnSelectionChange(value: /* index */ Double => Unit): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setSelectionMode(value: automatic | manual): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setTabContentClassName(value: String): Self = StObject.set(x, "tabContentClassName", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTabContentClassNameUndefined: Self = StObject.set(x, "tabContentClassName", js.undefined)
      ...
      @scala.inline
      def setType(value: container | typings.carbonComponentsReact.carbonComponentsReactStrings.default): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
