...
object libComponentsGridRowMod {
  ...
  inline def default_center(props: RowIntrinsicProps[center]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  inline def default_search(props: RowIntrinsicProps[search]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  ...
  object RowBaseIsolatedProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RowBaseIsolatedProps] (val x: Self) extends AnyVal {
  ...
  object RowBaseProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RowBaseProps] (val x: Self) extends AnyVal {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    C extends carbon-components-react.carbon-components-react/typings/shared.ReactComponentConstructor<infer P> ? carbon-components-react.carbon-components-react/lib/components/Grid/Row.RowBaseProps & carbon-components-react.carbon-components-react/lib/components/Grid/Row.SafeProps<P> & {  as :C} : never
    }}}
    */
  @js.native
  trait RowCustomComponentProps[C /* <: ReactComponentConstructor[scala.Nothing] */] extends StObject
  ...
  object RowDefaultProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RowDefaultProps] (val x: Self) extends AnyVal {
  ...
  type RowIntrinsicProps[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typings.carbonComponentsReact.carbonComponentsReactStrings.a, typings.carbonComponentsReact.carbonComponentsReactStrings.abbr, typings.carbonComponentsReact.carbonComponentsReactStrings.address */ Any */] = RowBaseProps & (SafeProps[JSXIntrinsicElementProps[K, `false`]]) & As[K]
