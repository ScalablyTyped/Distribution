...
object libComponentsUishellSideNavItemMod extends Shortcut {
  ...
  object SideNavItemProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SideNavItemProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsUishellSideNavItemMod.foo` */
