...
object libComponentsDataTableTableToolbarActionMod {
  ...
  inline def default(props: ForwardRefProps[HTMLButtonElement, TableToolbarActionButtonProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  inline def default(props: ForwardRefProps[HTMLAnchorElement, TableToolbarActionAnchorProps]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
  
  /* Rewritten from type alias, can be one of: 
    - typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionAnchorProps
    - typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionButtonProps
  */
  trait AllTableToolbarActionProps extends StObject
  object AllTableToolbarActionProps {
    
    inline def TableToolbarActionAnchorProps(href: String): typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionAnchorProps = {
      val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionAnchorProps]
    }
    
    inline def TableToolbarActionButtonProps(): typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionButtonProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.carbonComponentsReact.libComponentsDataTableTableToolbarActionMod.TableToolbarActionButtonProps]
    }
  }
