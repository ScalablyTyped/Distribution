...
object tooltipTooltipMod extends Shortcut {
  ...
  @JSImport("carbon-components-react/lib/components/Tooltip/Tooltip", "Tooltip")
  @js.native
  open class Tooltip ()
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    inline def onContextMenu: typings.carbonComponentsReact.carbonComponentsReactStrings.onContextMenu = "onContextMenu".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onContextMenu]
    ...
    inline def onMouseOut: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOut = "onMouseOut".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOut]
    
    inline def onMouseOver: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOver = "onMouseOver".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOver]
  ...
  type TooltipComponent = Component[TooltipProps, js.Object, Any]
  
  type TooltipOnChangeEvent[T /* <: Element */] = (FocusEvent[T, Element]) | KeyboardEvent[T] | (MouseEvent[T, NativeMouseEvent])
  ...
  trait TooltipProps extends StObject {
    ...
    var align: js.UndefOr[TooltipAlignment] = js.undefined
  ...
  object TooltipProps {
    ...
    extension [Self <: TooltipProps](x: Self) {
      ...
      inline def setAlign(value: TooltipAlignment): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
      ...
      inline def setMenuOffsetFunction2(
      ...
      inline def setMenuOffsetUndefined: Self = StObject.set(x, "menuOffset", js.undefined)
      ...
      inline def setOnChange(value: (/* event */ TooltipOnChangeEvent[HTMLDivElement], /* data */ Open) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      inline def setTooltipBodyId(value: String): Self = StObject.set(x, "tooltipBodyId", value.asInstanceOf[js.Any])
      
      inline def setTooltipBodyIdUndefined: Self = StObject.set(x, "tooltipBodyId", js.undefined)
      ...
      inline def setTriggerText(value: ReactNode): Self = StObject.set(x, "triggerText", value.asInstanceOf[js.Any])
