...
import typings.carbonComponentsReact.anon.Open
import typings.carbonComponentsReact.anon.RequiredMenuOffsetData
...
import typings.carbonComponentsReact.typingsSharedMod.MenuOffsetData
...
object tooltipTooltipMod extends Shortcut {
  ...
  @JSImport("carbon-components-react/lib/components/Tooltip/Tooltip", JSImport.Default)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onContextMenu
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onFocus
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOut
    - typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOver
  ...
  */
  ...
  object ExcludedAttributes {
    ...
    @scala.inline
    def onBlur: typings.carbonComponentsReact.carbonComponentsReactStrings.onBlur = "onBlur".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onBlur]
    
    @scala.inline
    def onChange: typings.carbonComponentsReact.carbonComponentsReactStrings.onChange = "onChange".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onChange]
    
    @scala.inline
    def onContextMenu: typings.carbonComponentsReact.carbonComponentsReactStrings.onContextMenu = "onContextMenu".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onContextMenu]
    
    @scala.inline
    def onFocus: typings.carbonComponentsReact.carbonComponentsReactStrings.onFocus = "onFocus".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onFocus]
    
    @scala.inline
    def onMouseOut: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOut = "onMouseOut".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOut]
    
    @scala.inline
    def onMouseOver: typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOver = "onMouseOver".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.onMouseOver]
    
    @scala.inline
    def role: typings.carbonComponentsReact.carbonComponentsReactStrings.role = "role".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.role]
  }
  
  type TooltipOnChangeEvent[T /* <: Element */] = FocusEvent[T] | KeyboardEvent[T] | (MouseEvent[T, NativeMouseEvent])
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/Tooltip/Tooltip.ExcludedAttributes> */
  trait TooltipProps extends StObject {
    ...
    var menuOffset: js.UndefOr[
        MenuOffsetData | (js.Function2[
          /* menuBody */ HTMLElement, 
          /* menuDirection */ js.UndefOr[Direction], 
          js.UndefOr[RequiredMenuOffsetData]
        ])
      ] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ TooltipOnChangeEvent[HTMLDivElement], /* data */ Open, Unit]
      ] = js.undefined
    ...
    // optional/required depending on static carbon lib config
    ...
    var renderIcon: js.UndefOr[ForwardRefReturn[js.Any, js.Any]] = js.undefined
    ...
    var tooltipBodyId: js.UndefOr[String] = js.undefined
    ...
    var triggerText: js.UndefOr[ReactNode] = js.undefined
  ...
  object TooltipProps {
    ...
    implicit class TooltipPropsMutableBuilder[Self <: TooltipProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setFocusTrap(value: Boolean): Self = StObject.set(x, "focusTrap", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMenuOffset(
        value: MenuOffsetData | (js.Function2[
              /* menuBody */ HTMLElement, 
              /* menuDirection */ js.UndefOr[Direction], 
              js.UndefOr[RequiredMenuOffsetData]
            ])
      ): Self = StObject.set(x, "menuOffset", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMenuOffsetFunction2(
        value: (/* menuBody */ HTMLElement, /* menuDirection */ js.UndefOr[Direction]) => js.UndefOr[RequiredMenuOffsetData]
      ): Self = StObject.set(x, "menuOffset", js.Any.fromFunction2(value))
      
      @scala.inline
      def setMenuOffsetUndefined: Self = StObject.set(x, "menuOffset", js.undefined)
      ...
      @scala.inline
      def setOnChange(value: (/* event */ TooltipOnChangeEvent[HTMLDivElement], /* data */ Open) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setRenderIcon(value: ForwardRefReturn[js.Any, js.Any]): Self = StObject.set(x, "renderIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setSelectorPrimaryFocus(value: String): Self = StObject.set(x, "selectorPrimaryFocus", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setSelectorPrimaryFocusUndefined: Self = StObject.set(x, "selectorPrimaryFocus", js.undefined)
      ...
      @scala.inline
      def setTooltipBodyId(value: String): Self = StObject.set(x, "tooltipBodyId", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTooltipBodyIdUndefined: Self = StObject.set(x, "tooltipBodyId", js.undefined)
      ...
      @scala.inline
      def setTriggerText(value: ReactNode): Self = StObject.set(x, "triggerText", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setTriggerTextUndefined: Self = StObject.set(x, "triggerText", js.undefined)
