...
object textInputPasswordInputMod extends Shortcut {
  ...
  object PasswordInputProps {
    ...
    inline def apply(id: String, labelText: NonNullable[ReactNode]): PasswordInputProps = {
  ...
  /* This means you don't have to write `default`, but can instead just say `textInputPasswordInputMod.foo` */
