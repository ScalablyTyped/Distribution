...
object listBoxSelectionMod extends Shortcut {
  
  @JSImport("carbon-components-react/lib/components/ListBox/next/ListBoxSelection", JSImport.Default)
  @js.native
  val default: FC[ListBoxSelectionNextProps] = js.native
  ...
  */
  ...
  /* Inlined parent carbon-components-react.carbon-components-react/lib/components/ListBox/ListBoxSelection.ListBoxSelectionProps */
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, carbon-components-react.carbon-components-react/lib/components/ListBox/next/ListBoxSelection.ExcludedButtonPropKeys> */
  @js.native
  trait ListBoxSelectionNextProps extends StObject {
    ...
    var `aria-autocomplete`: js.UndefOr[none_ | `inline` | list | both] = js.native
    ...
    var `aria-dropeffect`: js.UndefOr[none_ | copy | execute | link | move | popup] = js.native
    ...
    var `aria-sort`: js.UndefOr[none_ | ascending | descending | other] = js.native
    ...
    var inputMode: js.UndefOr[none_ | text | tel | url | email | numeric | decimal | search] = js.native
    ...
    var translateWithId: js.UndefOr[
        js.Function2[
          /* messageId */ ListBoxSelectionTranslationKey, 
  ...
  type _To = FC[ListBoxSelectionNextProps]
  
  /* This means you don't have to write `default`, but can instead just say `listBoxSelectionMod.foo` */
  override def _to: FC[ListBoxSelectionNextProps] = default
}
