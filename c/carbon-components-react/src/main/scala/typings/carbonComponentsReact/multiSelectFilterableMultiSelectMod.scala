...
object multiSelectFilterableMultiSelectMod {
  ...
  object FilterItemsExtra {
    ...
    inline def apply[T](inputValue: String, itemToString: NonNullable[js.UndefOr[js.Function1[/* item */ T, String]]]): FilterItemsExtra[T] = {
      val __obj = js.Dynamic.literal(inputValue = inputValue.asInstanceOf[js.Any], itemToString = itemToString.asInstanceOf[js.Any])
    ...
    extension [Self <: FilterItemsExtra[?], T](x: Self & FilterItemsExtra[T]) {
      ...
      inline def setItemToString(value: NonNullable[js.UndefOr[js.Function1[/* item */ T, String]]]): Self = StObject.set(x, "itemToString", value.asInstanceOf[js.Any])
    }
  }
