...
import typings.carbonComponentsReact.anon.SelectedIndex
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.automatic
...
import typings.carbonComponentsReact.carbonComponentsReactStrings.manual
...
object libComponentsContentSwitcherNextMod {
  
  @JSImport("carbon-components-react/lib/components/ContentSwitcher/next", "ContentPanel")
  @js.native
  val ContentPanel: ForwardRefReturn[HTMLDivElement, ContentPanelProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/ContentSwitcher/next", "ContentPanels")
  @js.native
  val ContentPanels: FC[ContentPanelsProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/ContentSwitcher/next", "ContentSwitcher")
  @js.native
  val ContentSwitcher: FC[ContentSwitcherNextProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/ContentSwitcher/next", "ContentTab")
  @js.native
  val ContentTab: ForwardRefReturn[HTMLButtonElement, ContentTabProps] = js.native
  
  @JSImport("carbon-components-react/lib/components/ContentSwitcher/next", "ContentTabs")
  @js.native
  val ContentTabs: FC[ContentTabsProps] = js.native
  
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/ContentSwitcher/next.ExcludedContentPanelPropKeys> */
  trait ContentPanelProps extends StObject {
  ...
  object ContentPanelProps {
    
    inline def apply(): ContentPanelProps = {
  ...
  trait ContentPanelsProps extends StObject {
    
    var children: js.UndefOr[ReactNode] = js.undefined
  }
  object ContentPanelsProps {
    
    inline def apply(): ContentPanelsProps = {
      val __obj = js.Dynamic.literal()
  ...
  trait ContentSwitcherNextProps extends StObject {
    
    var children: js.UndefOr[ReactNode] = js.undefined
    
    var defaultSelectedIndex: js.UndefOr[Double] = js.undefined
    
    var onChange: js.UndefOr[js.Function1[/* data */ SelectedIndex, Unit]] = js.undefined
    
    var selectedIndex: js.UndefOr[Double] = js.undefined
  }
  object ContentSwitcherNextProps {
    
    inline def apply(): ContentSwitcherNextProps = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: ContentSwitcherNextProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: /* data */ SelectedIndex => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactButtonAttr<std.HTMLButtonElement>, carbon-components-react.carbon-components-react/lib/components/ContentSwitcher/next.ExcludedContentTabPropKeys> */
  trait ContentTabProps extends StObject {
  ...
  object ContentTabProps {
    
    inline def apply(): ContentTabProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* Inlined parent std.Omit<carbon-components-react.carbon-components-react/typings/shared.ReactDivAttr, carbon-components-react.carbon-components-react/lib/components/ContentSwitcher/next.ExcludedContentTabsPropsKeys> */
  trait ContentTabsProps extends StObject {
    
    var about: js.UndefOr[String] = js.undefined
    
    var accessKey: js.UndefOr[String] = js.undefined
    
    var activation: js.UndefOr[automatic | manual] = js.undefined
  ...
  object ContentTabsProps {
    
    inline def apply(`aria-label`: String): ContentTabsProps = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: ContentTabsProps] (val x: Self) extends AnyVal {
      ...
      inline def setActivation(value: automatic | manual): Self = StObject.set(x, "activation", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.hidden
  ...
  */
  trait ExcludedContentPanelPropKeys extends StObject
  object ExcludedContentPanelPropKeys {
    ...
    inline def hidden: typings.carbonComponentsReact.carbonComponentsReactStrings.hidden = "hidden".asInstanceOf[typings.carbonComponentsReact.carbonComponentsReactStrings.hidden]
  ...
  */
  trait ExcludedContentTabPropKeys extends StObject
  object ExcludedContentTabPropKeys {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.carbonComponentsReact.carbonComponentsReactStrings.role
  */
  trait ExcludedContentTabsPropsKeys extends StObject
  object ExcludedContentTabsPropsKeys {
