...
object libComponentsGridGridMod {
  ...
  inline def default_center(props: GridIntrinsicProps[center]): FCReturn = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[FCReturn]
