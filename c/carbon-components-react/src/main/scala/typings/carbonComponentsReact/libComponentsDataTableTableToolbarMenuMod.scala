...
import typings.carbonComponentsReact.libComponentsOverflowMenuOverflowMenuMod.MenuOffsetValue
...
object libComponentsDataTableTableToolbarMenuMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `libComponentsDataTableTableToolbarMenuMod.foo` */
