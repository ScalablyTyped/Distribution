...
object libBindingsHttpReceiverBinaryMod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    var receiver: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_receiver_binary_1 */ Any = js.native
  }
  ...
  trait BinaryHTTPReceiver extends StObject {
    ...
    var receiver: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_receiver_binary_1 */ Any
  }
  object BinaryHTTPReceiver {
    ...
    inline def apply(
      ...
      receiver: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_receiver_binary_1 */ Any
    ): BinaryHTTPReceiver = {
    ...
    implicit open class MutableBuilder[Self <: BinaryHTTPReceiver] (val x: Self) extends AnyVal {
      ...
      inline def setReceiver(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_receiver_binary_1 */ Any
