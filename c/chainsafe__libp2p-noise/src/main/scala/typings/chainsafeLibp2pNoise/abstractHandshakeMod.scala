...
import typings.chainsafeLibp2pNoise.handshakeMod.SymmetricState
...
object abstractHandshakeMod {
  ...
  @JSImport("@chainsafe/libp2p-noise/dist/src/handshakes/abstract-handshake", "AbstractHandshake")
  @js.native
  abstract class AbstractHandshake protected () extends StObject {
