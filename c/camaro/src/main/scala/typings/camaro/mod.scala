...
object mod {
  ...
  inline def toJson(xml: String): js.Promise[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toJson")(xml.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Any]]
  
  inline def transform(xml: String, template: js.Object): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("transform")(xml.asInstanceOf[js.Any], template.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
}
