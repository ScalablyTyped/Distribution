...
object RadialGaugeOptions {
  ...
  def apply(
    ...
    needleCircleSize: Int | Double = null,
    ...
    if (animationTarget != null) __obj.updateDynamic("animationTarget")(animationTarget)
    ...
    if (colorNeedleCircleInner != null) __obj.updateDynamic("colorNeedleCircleInner")(colorNeedleCircleInner)
    if (colorNeedleCircleInnerEnd != null) __obj.updateDynamic("colorNeedleCircleInnerEnd")(colorNeedleCircleInnerEnd)
    if (colorNeedleCircleOuter != null) __obj.updateDynamic("colorNeedleCircleOuter")(colorNeedleCircleOuter)
    if (colorNeedleCircleOuterEnd != null) __obj.updateDynamic("colorNeedleCircleOuterEnd")(colorNeedleCircleOuterEnd)
    ...
    if (!js.isUndefined(needleCircleInner)) __obj.updateDynamic("needleCircleInner")(needleCircleInner)
    if (!js.isUndefined(needleCircleOuter)) __obj.updateDynamic("needleCircleOuter")(needleCircleOuter)
    if (needleCircleSize != null) __obj.updateDynamic("needleCircleSize")(needleCircleSize.asInstanceOf[js.Any])
    ...
    if (ticksAngle != null) __obj.updateDynamic("ticksAngle")(ticksAngle.asInstanceOf[js.Any])
    if (title != null) __obj.updateDynamic("title")(title.asInstanceOf[js.Any])
    if (units != null) __obj.updateDynamic("units")(units.asInstanceOf[js.Any])
    if (!js.isUndefined(useMinPath)) __obj.updateDynamic("useMinPath")(useMinPath)
