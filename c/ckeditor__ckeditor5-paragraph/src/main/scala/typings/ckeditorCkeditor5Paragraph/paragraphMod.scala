...
object paragraphMod {
  ...
  object ckeditorCkeditor5CoreSrcCommandcollectionAugmentingMod {
    ...
    trait Commands extends StObject {
      ...
      var insertParagraph: typings.ckeditorCkeditor5Paragraph.insertparagraphcommandMod.default
      
      var paragraph: typings.ckeditorCkeditor5Paragraph.paragraphcommandMod.default
    }
    object Commands {
      
      inline def apply(
        insertParagraph: typings.ckeditorCkeditor5Paragraph.insertparagraphcommandMod.default,
        paragraph: typings.ckeditorCkeditor5Paragraph.paragraphcommandMod.default
      ): Commands = {
      ...
      extension [Self <: Commands](x: Self) {
        ...
        inline def setInsertParagraph(value: typings.ckeditorCkeditor5Paragraph.insertparagraphcommandMod.default): Self = StObject.set(x, "insertParagraph", value.asInstanceOf[js.Any])
        
        inline def setParagraph(value: typings.ckeditorCkeditor5Paragraph.paragraphcommandMod.default): Self = StObject.set(x, "paragraph", value.asInstanceOf[js.Any])
      }
    }
  }
