package typings.cloudflareDashApps

import typings.cloudflareDashApps.CloudflareAppsNs.InstallOptions
import typings.cloudflareDashApps.CloudflareAppsNs.InstallProduct
import typings.cloudflareDashApps.CloudflareAppsNs.InstallScope
...
object ^ extends js.Object {
  /**
    ...
    */
  val CloudflareApps: typings.cloudflareDashApps.CloudflareAppsNs.CloudflareApps = js.native
  /**
    ...
    * ```
    */
  val INSTALL: typings.cloudflareDashApps.CloudflareAppsNs.CloudflareApps = js.native
  /**
