...
trait Window extends js.Object {
  /**
    ...
    */
  def addEventListener(`type`: batteryEvent, listener: js.Function1[/* ev */ BatteryStatusEvent, _]): scala.Unit = js.native
  ...
  /**
    ...
    * @param useCapture - A Boolean indicating whether events of this type will be dispatched to the registered listener before being dispatched to any EventTarget beneath it in the DOM tree.
    */
  def removeEventListener(`type`: batteryEvent, listener: js.Function1[/* ev */ BatteryStatusEvent, _]): scala.Unit = js.native
