...
trait TypeofHDNode
  ...
  def fromMnemonic(mnemonic: String, password: Unit, wordlist: String): typings.ethersprojectHdnode.mod.HDNode = js.native
  def fromMnemonic(mnemonic: String, password: Unit, wordlist: Wordlist): typings.ethersprojectHdnode.mod.HDNode = js.native
