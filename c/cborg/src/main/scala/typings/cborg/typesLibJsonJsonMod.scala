...
import typings.cborg.typesInterfaceMod.EncodeOptions
import typings.cborg.typesLibJsonDecodeMod.DecodeOptions
...
object typesLibJsonJsonMod {
  ...
  open class Tokenizer protected ()
    extends typings.cborg.typesLibJsonDecodeMod.Tokenizer {
    /**
