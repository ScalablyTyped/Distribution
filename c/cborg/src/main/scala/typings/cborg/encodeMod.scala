...
object encodeMod {
  ...
  open class Ref protected ()
    extends StObject
       with typings.cborg.interfaceMod.Reference {
  ...
  inline def objectToTokens(obj: Any, options: Unit, refStack: typings.cborg.interfaceMod.Reference): TokenOrNestedTokens = (^.asInstanceOf[js.Dynamic].applyDynamic("objectToTokens")(obj.asInstanceOf[js.Any], options.asInstanceOf[js.Any], refStack.asInstanceOf[js.Any])).asInstanceOf[TokenOrNestedTokens]
  inline def objectToTokens(obj: Any, options: typings.cborg.interfaceMod.EncodeOptions): TokenOrNestedTokens = (^.asInstanceOf[js.Dynamic].applyDynamic("objectToTokens")(obj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[TokenOrNestedTokens]
  inline def objectToTokens(
    obj: Any,
    options: typings.cborg.interfaceMod.EncodeOptions,
    refStack: typings.cborg.interfaceMod.Reference
  ...
  type OptionalTypeEncoder = typings.cborg.interfaceMod.OptionalTypeEncoder
  
  type Reference = typings.cborg.interfaceMod.Reference
  
  @js.native
  trait StrictTypeEncoder
    extends StObject
       with typings.cborg.interfaceMod.StrictTypeEncoder
