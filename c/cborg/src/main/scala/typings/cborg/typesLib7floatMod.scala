...
object typesLib7floatMod {
  ...
  object encodeFloat {
    ...
    /**
      ...
      * @returns {number}
      */
    inline def encodedSize(token: Token, options: typings.cborg.typesInterfaceMod.EncodeOptions): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("encodedSize")(token.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  }
