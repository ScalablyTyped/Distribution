...
object typesLib3stringMod {
  ...
  object encodeString {
    ...
    inline def apply(buf: typings.cborg.typesLib2bytesMod.Bl, token: Token): Unit = (^.asInstanceOf[js.Dynamic].apply(buf.asInstanceOf[js.Any], token.asInstanceOf[js.Any])).asInstanceOf[Unit]
