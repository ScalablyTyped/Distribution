...
import typings.c3.Anon_D
import typings.c3.Anon_FormatFormatFunction
import typings.c3.Anon_FormatKey
import typings.c3.Anon_Label
import typings.c3.Anon_Value
...
trait Data extends js.Object {
  ...
  /**
    ...
    */
  var color: js.UndefOr[js.Function2[/* color */ String, /* d */ js.Any, String | RGBColor | HSLColor]] = js.undefined
  /**
    * Set color for each data.
    */
  var colors: js.UndefOr[
    StringDictionary[
      String | RGBColor | HSLColor | (js.Function1[/* d */ js.Any, String | RGBColor | HSLColor])
    ]
  ] = js.undefined
  /*
  ...
  /**
    ...
    */
  var empty: js.UndefOr[Anon_Label] = js.undefined
  /**
  ...
  /**
    ...
    */
  var labels: js.UndefOr[Boolean | Anon_FormatFormatFunction | Anon_FormatKey] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onclick: js.UndefOr[js.Function2[/* d */ js.Any, /* element */ js.Any, Unit]] = js.undefined
  /**
    ...
    */
  var onmouseout: js.UndefOr[js.Function2[/* d */ js.Any, /* element */ js.UndefOr[js.Any], Unit]] = js.undefined
  /**
    ...
    */
  var onmouseover: js.UndefOr[js.Function2[/* d */ js.Any, /* element */ js.UndefOr[js.Any], Unit]] = js.undefined
  var onselected: js.UndefOr[js.Function2[/* d */ js.Any, /* element */ js.UndefOr[js.Any], Unit]] = js.undefined
  var onunselected: js.UndefOr[js.Function2[/* d */ js.Any, /* element */ js.UndefOr[js.Any], Unit]] = js.undefined
  /**
    ...
    */
  var order: js.UndefOr[String | (js.Function1[/* repeated */ String, Unit]) | Null] = js.undefined
  /**
    ...
    */
  var regions: js.UndefOr[StringDictionary[js.Any]] = js.undefined
  /**
    * Load data from a multidimensional array, with the first element containing the data names, the following containing related data in that order.
    */
  var rows: js.UndefOr[js.Array[PrimitiveArray]] = js.undefined
  var selection: js.UndefOr[Anon_D] = js.undefined
  /**
...
object Data {
  ...
  def apply(
    ...
    color: (/* color */ String, /* d */ js.Any) => String | RGBColor | HSLColor = null,
    colors: StringDictionary[
      String | RGBColor | HSLColor | (js.Function1[/* d */ js.Any, String | RGBColor | HSLColor])
    ] = null,
    columns: js.Array[PrimitiveArray] = null,
    empty: Anon_Label = null,
    groups: js.Array[js.Array[String]] = null,
    hide: Boolean | js.Array[String] = null,
    json: js.Object = null,
    keys: Anon_Value = null,
    labels: Boolean | Anon_FormatFormatFunction | Anon_FormatKey = null,
    mimeType: String = null,
    names: StringDictionary[String] = null,
    onclick: (/* d */ js.Any, /* element */ js.Any) => Unit = null,
    onmouseout: (/* d */ js.Any, /* element */ js.UndefOr[js.Any]) => Unit = null,
    onmouseover: (/* d */ js.Any, /* element */ js.UndefOr[js.Any]) => Unit = null,
    onselected: (/* d */ js.Any, /* element */ js.UndefOr[js.Any]) => Unit = null,
    onunselected: (/* d */ js.Any, /* element */ js.UndefOr[js.Any]) => Unit = null,
    order: String | (js.Function1[/* repeated */ String, Unit]) = null,
    regions: StringDictionary[js.Any] = null,
    rows: js.Array[PrimitiveArray] = null,
    selection: Anon_D = null,
    `type`: String = null,
