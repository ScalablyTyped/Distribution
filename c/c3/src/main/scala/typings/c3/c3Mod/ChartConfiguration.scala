...
import typings.c3.Anon_Auto
import typings.c3.Anon_Bottom
import typings.c3.Anon_ConnectNull
import typings.c3.Anon_Duration
import typings.c3.Anon_Enabled
import typings.c3.Anon_Expand
import typings.c3.Anon_ExpandFullCircle
import typings.c3.Anon_ExpandLabel
import typings.c3.Anon_Height
import typings.c3.Anon_Interpolation
import typings.c3.Anon_Pattern
import typings.c3.Anon_Space
import typings.c3.Anon_Zerobased
...
trait ChartConfiguration extends js.Object {
  var area: js.UndefOr[Anon_Zerobased] = js.undefined
  var axis: js.UndefOr[Axis] = js.undefined
  var bar: js.UndefOr[Anon_Space] = js.undefined
  /**
    ...
    */
  var bindto: js.UndefOr[String | HTMLElement | (Selection[_, _, _, _]) | Null] = js.undefined
  var color: js.UndefOr[Anon_Pattern] = js.undefined
  var data: Data
  var donut: js.UndefOr[Anon_ExpandLabel] = js.undefined
  var gauge: js.UndefOr[Anon_ExpandFullCircle] = js.undefined
  var grid: js.UndefOr[Grid] = js.undefined
  var interaction: js.UndefOr[Anon_Enabled] = js.undefined
  var legend: js.UndefOr[LegendOptions] = js.undefined
  var line: js.UndefOr[Anon_ConnectNull] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onmouseout: js.UndefOr[js.Function0[Unit]] = js.undefined
  /**
    * Set a callback to execute when mouse enters the chart.
    */
  var onmouseover: js.UndefOr[js.Function0[Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var onresized: js.UndefOr[js.Function0[Unit]] = js.undefined
  var padding: js.UndefOr[Anon_Bottom] = js.undefined
  var pie: js.UndefOr[Anon_Expand] = js.undefined
  ...
  var resize: js.UndefOr[Anon_Auto] = js.undefined
  var size: js.UndefOr[Anon_Height] = js.undefined
  var spline: js.UndefOr[Anon_Interpolation] = js.undefined
  var subchart: js.UndefOr[SubchartOptions] = js.undefined
  var tooltip: js.UndefOr[TooltipOptions] = js.undefined
  var transition: js.UndefOr[Anon_Duration] = js.undefined
...
object ChartConfiguration {
  ...
  def apply(
    data: Data,
    area: Anon_Zerobased = null,
    axis: Axis = null,
    bar: Anon_Space = null,
    bindto: String | HTMLElement | (Selection[_, _, _, _]) = null,
    color: Anon_Pattern = null,
    donut: Anon_ExpandLabel = null,
    gauge: Anon_ExpandFullCircle = null,
    grid: Grid = null,
    interaction: Anon_Enabled = null,
    legend: LegendOptions = null,
    line: Anon_ConnectNull = null,
    oninit: () => Unit = null,
    ...
    onresize: () => Unit = null,
    onresized: () => Unit = null,
    padding: Anon_Bottom = null,
    pie: Anon_Expand = null,
    point: PointOptions = null,
    regions: js.Array[RegionOptions] = null,
    resize: Anon_Auto = null,
    size: Anon_Height = null,
    spline: Anon_Interpolation = null,
    subchart: SubchartOptions = null,
    tooltip: TooltipOptions = null,
    transition: Anon_Duration = null,
