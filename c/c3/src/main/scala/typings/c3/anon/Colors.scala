...
object Colors {
  ...
  def apply(
    ...
    lines: js.Array[Class] = null,
    padding: typings.c3.mod.Padding = null,
    regions: js.Array[Opacity] = null,
    scaleFormat: pow10 | (js.Function1[/* arg0 */ Double, String]) = null,
    scaleMax: js.UndefOr[Double] = js.undefined,
    scaleMin: js.UndefOr[Double] = js.undefined,
    scaleValues: (/* minValue */ Double, /* maxValue */ Double) => js.Array[Double] = null,
    texts: js.Array[Content] = null
  ): Colors = {
    ...
    if (!js.isUndefined(scaleMax)) __obj.updateDynamic("scaleMax")(scaleMax.get.asInstanceOf[js.Any])
    if (!js.isUndefined(scaleMin)) __obj.updateDynamic("scaleMin")(scaleMin.get.asInstanceOf[js.Any])
