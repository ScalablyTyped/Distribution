...
import typings.csstoolsPostcssLogicalFloatAndClear.distLibTypesMod.Axes
...
object distUtilsDirectionFlowToAxesMod {
  ...
  @JSImport("@csstools/postcss-logical-float-and-clear/dist/utils/direction-flow-to-axes", JSImport.Namespace)
  @js.native
