...
trait ClearBladeInt extends js.Object {
  ...
  def Code(): typings.clearbladejsDashServer.CbServerNs.Code = js.native
  def Collection(options: String): typings.clearbladejsDashServer.CbServerNs.Collection = js.native
  def Collection(options: CollectionOptionsWithCollection): typings.clearbladejsDashServer.CbServerNs.Collection = js.native
  def Collection(options: CollectionOptionsWithID): typings.clearbladejsDashServer.CbServerNs.Collection = js.native
  def Collection(options: CollectionOptionsWithName): typings.clearbladejsDashServer.CbServerNs.Collection = js.native
  def Deployment(): typings.clearbladejsDashServer.CbServerNs.Deployment = js.native
  def Device(): typings.clearbladejsDashServer.CbServerNs.Device = js.native
  def Item(data: js.Object, options: String): typings.clearbladejsDashServer.CbServerNs.Item = js.native
  def Item(data: js.Object, options: ItemOptions): typings.clearbladejsDashServer.CbServerNs.Item = js.native
  def Messaging(options: MessagingOptions, callback: CbCallback): typings.clearbladejsDashServer.CbServerNs.Messaging = js.native
