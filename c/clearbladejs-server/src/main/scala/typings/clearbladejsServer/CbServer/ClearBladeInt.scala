...
trait ClearBladeInt extends StObject {
  ...
  def Code(): typings.clearbladejsServer.CbServer.Code = js.native
  
  def Collection(options: String): typings.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithCollection): typings.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithID): typings.clearbladejsServer.CbServer.Collection = js.native
  def Collection(options: CollectionOptionsWithName): typings.clearbladejsServer.CbServer.Collection = js.native
  
  def Deployment(): typings.clearbladejsServer.CbServer.Deployment = js.native
  
  def Device(): typings.clearbladejsServer.CbServer.Device = js.native
  
  def Item(data: js.Object, options: String): typings.clearbladejsServer.CbServer.Item = js.native
  def Item(data: js.Object, options: ItemOptions): typings.clearbladejsServer.CbServer.Item = js.native
  
  def Messaging(options: MessagingOptions, callback: CbCallback): typings.clearbladejsServer.CbServer.Messaging = js.native
