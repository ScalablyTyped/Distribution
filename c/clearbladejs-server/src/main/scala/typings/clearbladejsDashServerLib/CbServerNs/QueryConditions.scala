...
object QueryConditions extends js.Object {
  ...
  sealed trait QUERY_EQUAL
    extends clearbladejsDashServerLib.CbServerNs.QueryConditions
  ...
  @JSBracketAccess
  def apply(value: java.lang.String): js.UndefOr[clearbladejsDashServerLib.CbServerNs.QueryConditions with java.lang.String] = js.native
}
