...
import typings.csvParse.csvParseBooleans.`false`
...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.csvParse.csvParseStrings.CSV_INVALID_OPTION_GROUP_COLUMNS_BY_NAME
    ...
    - typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_FIELDS_LENGTH
    - typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_COLUMNS
  ...
  */
  ...
  object CsvErrorCode {
    ...
    inline def CSV_INVALID_OPTION_GROUP_COLUMNS_BY_NAME: typings.csvParse.csvParseStrings.CSV_INVALID_OPTION_GROUP_COLUMNS_BY_NAME = "CSV_INVALID_OPTION_GROUP_COLUMNS_BY_NAME".asInstanceOf[typings.csvParse.csvParseStrings.CSV_INVALID_OPTION_GROUP_COLUMNS_BY_NAME]
    ...
    inline def CSV_RECORD_INCONSISTENT_COLUMNS: typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_COLUMNS = "CSV_RECORD_INCONSISTENT_COLUMNS".asInstanceOf[typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_COLUMNS]
    
    inline def CSV_RECORD_INCONSISTENT_FIELDS_LENGTH: typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_FIELDS_LENGTH = "CSV_RECORD_INCONSISTENT_FIELDS_LENGTH".asInstanceOf[typings.csvParse.csvParseStrings.CSV_RECORD_INCONSISTENT_FIELDS_LENGTH]
