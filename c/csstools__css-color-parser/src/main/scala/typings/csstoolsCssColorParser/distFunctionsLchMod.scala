...
object distFunctionsLchMod {
  
  @JSImport("@csstools/css-color-parser/dist/functions/lch", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def lch(lchNode: FunctionNode, colorParser: ColorParser): ColorData | `false` = (^.asInstanceOf[js.Dynamic].applyDynamic("lch")(lchNode.asInstanceOf[js.Any], colorParser.asInstanceOf[js.Any])).asInstanceOf[ColorData | `false`]
}
