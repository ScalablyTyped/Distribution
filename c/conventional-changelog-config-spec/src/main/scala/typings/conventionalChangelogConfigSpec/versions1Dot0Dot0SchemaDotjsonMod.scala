...
import typings.conventionalChangelogConfigSpec.versions1Dot0Dot0SchemaDotjsonMod.Config.Type
...
object versions1Dot0Dot0SchemaDotjsonMod extends Shortcut {
  ...
  object Config {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.conventionalChangelogConfigSpec.versions1Dot0Dot0SchemaDotjsonMod.Config.Type.WithSection
      - typings.conventionalChangelogConfigSpec.versions1Dot0Dot0SchemaDotjsonMod.Config.Type.WithHidden
    */
