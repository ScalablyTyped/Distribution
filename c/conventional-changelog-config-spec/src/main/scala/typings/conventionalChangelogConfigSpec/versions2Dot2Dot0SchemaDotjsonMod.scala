...
import typings.conventionalChangelogConfigSpec.versions2Dot2Dot0SchemaDotjsonMod.Config.Type
import typings.jsonSchema.mod.JSONSchema7
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object versions2Dot2Dot0SchemaDotjsonMod extends Shortcut {
  
  @JSImport("conventional-changelog-config-spec/versions/2.2.0/schema.json", JSImport.Namespace)
  @js.native
  ...
  object Config {
    ...
    /* Rewritten from type alias, can be one of: 
      - typings.conventionalChangelogConfigSpec.versions2Dot2Dot0SchemaDotjsonMod.Config.Type.WithSection
      - typings.conventionalChangelogConfigSpec.versions2Dot2Dot0SchemaDotjsonMod.Config.Type.WithHidden
    */
  ...
  /* This means you don't have to write `^`, but can instead just say `versions2Dot2Dot0SchemaDotjsonMod.foo` */
