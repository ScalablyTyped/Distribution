...
object Lg {
  ...
  inline def apply(lg: `1`, max: FontSizeLineHeight, md: FontSize, xlg: LineHeight): Lg = {
  ...
  extension [Self <: Lg](x: Self) {
    ...
    inline def setXlg(value: LineHeight): Self = StObject.set(x, "xlg", value.asInstanceOf[js.Any])
  }
}
