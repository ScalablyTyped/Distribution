package typings.containsPath.mod
...
object Options {
  ...
  implicit class OptionsOps[Self <: Options] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPartialMatch(value: Boolean): Self = this.set("partialMatch", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deletePartialMatch: Self = this.set("partialMatch", js.undefined)
  }
}
