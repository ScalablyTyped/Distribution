...
object distConversionsMod {
  
  @JSImport("@csstools/color-helpers/dist/conversions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@csstools/color-helpers/dist/conversions", "D50")
  @js.native
  ...
  @JSImport("@csstools/color-helpers/dist/conversions", "D65")
  @js.native
