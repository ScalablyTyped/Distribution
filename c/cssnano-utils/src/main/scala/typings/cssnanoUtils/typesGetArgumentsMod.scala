...
object typesGetArgumentsMod {
  ...
  ] = ^.asInstanceOf[js.Dynamic].apply(node.asInstanceOf[js.Any]).asInstanceOf[js.Array[
    js.Array[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_postcss-value-parser.Node */ Any
    ]
  ]]
  
  @JSImport("cssnano-utils/types/getArguments", JSImport.Namespace)
  @js.native
