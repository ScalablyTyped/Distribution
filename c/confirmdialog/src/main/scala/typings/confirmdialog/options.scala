...
object options {
  ...
  object confirmOptions {
    ...
    implicit open class MutableBuilder[Self <: confirmOptions] (val x: Self) extends AnyVal {
      ...
      inline def setOnAction(value: () => Unit): Self = StObject.set(x, "onAction", js.Any.fromFunction0(value))
      ...
      inline def setOnOpenBefore(value: () => Unit): Self = StObject.set(x, "onOpenBefore", js.Any.fromFunction0(value))
