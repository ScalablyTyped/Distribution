...
@js.native
trait MetaSysPropsspacesysMetaLArchivedVersion extends js.Object {
...
object MetaSysPropsspacesysMetaLArchivedVersion {
  ...
  @scala.inline
  implicit class MetaSysPropsspacesysMetaLArchivedVersionOps[Self <: MetaSysPropsspacesysMetaLArchivedVersion] (val x: Self) extends AnyVal {
