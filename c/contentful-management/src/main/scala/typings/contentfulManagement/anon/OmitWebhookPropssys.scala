...
object OmitWebhookPropssys {
  ...
  inline def apply(headers: js.Array[WebhookHeader], name: String, topics: js.Array[String], url: String): OmitWebhookPropssys = {
  ...
  extension [Self <: OmitWebhookPropssys](x: Self) {
