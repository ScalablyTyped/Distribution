...
object MetaSysPropsorganizations {
  ...
  @scala.inline
  implicit class MetaSysPropsorganizationsMutableBuilder[Self <: MetaSysPropsorganizations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrganization(value: Sys): Self = StObject.set(x, "organization", value.asInstanceOf[js.Any])
