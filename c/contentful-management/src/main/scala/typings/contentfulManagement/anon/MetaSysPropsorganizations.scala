...
@js.native
trait MetaSysPropsorganizations extends js.Object {
  ...
  var organization: js.UndefOr[Sys] = js.native
...
object MetaSysPropsorganizations {
  ...
  @scala.inline
  def apply(createdAt: String, id: String, `type`: String, updatedAt: String, version: Double): MetaSysPropsorganizations = {
  ...
  @scala.inline
  implicit class MetaSysPropsorganizationsOps[Self <: MetaSysPropsorganizations] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrganization(value: Sys): Self = this.set("organization", value.asInstanceOf[js.Any])
