...
object distIndexDotbasicMod {
  
  @JSImport("consola/dist/index.basic", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("consola/dist/index.basic", JSImport.Default)
  @js.native
  val default: ConsolaInstance = js.native
  
  @JSImport("consola/dist/index.basic", "consola")
  @js.native
