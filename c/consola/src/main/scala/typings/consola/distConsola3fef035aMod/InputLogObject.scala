...
trait InputLogObject extends StObject {
...
object InputLogObject {
  
  inline def apply(): InputLogObject = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputLogObject]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputLogObject] (val x: Self) extends AnyVal {
