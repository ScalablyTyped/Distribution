...
object mod {
  ...
  object CoffeeOpt {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CoffeeOpt[?], T] (val x: Self & CoffeeOpt[T]) extends AnyVal {
  ...
  object RuleOpt {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: RuleOpt] (val x: Self) extends AnyVal {
