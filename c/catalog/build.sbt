...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "extract-text-webpack-plugin" % "3.0-dt-20190212Z-32f7a9",
  "org.scalablytyped" %%% "friendly-errors-webpack-plugin" % "0.1-dt-20180214Z-9877ec",
  ...
  "org.scalablytyped" %%% "react-dev-utils" % "7.0-dt-20190128Z-0b9008",
