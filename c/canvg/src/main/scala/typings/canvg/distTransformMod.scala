...
object distTransformMod {
  ...
  open class Matrix protected ()
    extends typings.canvg.distTransformMatrixMod.Matrix {
    def this(
  ...
  open class Rotate protected ()
    extends typings.canvg.distTransformRotateMod.Rotate {
  ...
  open class Scale protected ()
    extends typings.canvg.distTransformScaleMod.Scale {
    def this(
      _underscore: Document,
      scale: String,
      transformOrigin: js.Tuple2[Property[String], Property[String]]
  ...
  open class Skew protected ()
    extends typings.canvg.distTransformSkewMod.Skew {
  ...
  open class SkewX protected ()
    extends typings.canvg.distTransformSkewXMod.SkewX {
    def this(document: Document, skew: String, transformOrigin: js.Tuple2[Property[String], Property[String]]) = this()
  }
  ...
  open class SkewY protected ()
    extends typings.canvg.distTransformSkewYMod.SkewY {
    def this(document: Document, skew: String, transformOrigin: js.Tuple2[Property[String], Property[String]]) = this()
  }
  ...
  open class Transform protected ()
    extends typings.canvg.distTransformTransformMod.Transform {
    def this(
      document: Document,
      transform: String,
      transformOrigin: js.Tuple2[Property[String], Property[String]]
  ...
  object Transform {
    ...
    inline def fromElement(document: Document, element: Element): typings.canvg.distTransformTransformMod.Transform = (^.asInstanceOf[js.Dynamic].applyDynamic("fromElement")(document.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[typings.canvg.distTransformTransformMod.Transform]
  ...
  open class Translate protected ()
    extends typings.canvg.distTransformTranslateMod.Translate {
