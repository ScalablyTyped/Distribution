...
@JSImport("canvg/dist/Document", "RadialGradientElement")
@js.native
open class RadialGradientElement protected ()
  extends typings.canvg.distDocumentElementsMod.RadialGradientElement {
