...
@JSImport("canvg/dist/Document/elements", "PatternElement")
@js.native
open class PatternElement protected ()
  extends typings.canvg.distDocumentPatternElementMod.PatternElement {
