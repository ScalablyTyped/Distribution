...
import typings.canvg.parserMod.Parser
import typings.canvg.screenMod.IScreenStartOptions
...
object canvgMod {
  ...
  - typings.canvg.screenMod.IScreenOptions because var conflicts: fetch. Inlined window */ trait IOptions
    extends StObject
       with IParserOptions
