...
object offscreenMod {
  ...
  inline def offscreen(hasDOMParserFallback: IConfig): CreateCanvas = ^.asInstanceOf[js.Dynamic].applyDynamic("offscreen")(hasDOMParserFallback.asInstanceOf[js.Any]).asInstanceOf[CreateCanvas]
  ...
  trait IConfig extends StObject {
    ...
    /**
      ...
      */
    var DOMParser: js.UndefOr[typings.canvg.typesMod.DOMParser] = js.undefined
  }
  object IConfig {
