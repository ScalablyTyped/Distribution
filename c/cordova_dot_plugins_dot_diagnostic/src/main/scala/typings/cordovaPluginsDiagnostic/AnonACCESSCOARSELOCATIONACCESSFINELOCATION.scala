...
trait AnonACCESSCOARSELOCATIONACCESSFINELOCATION extends js.Object {
...
object AnonACCESSCOARSELOCATIONACCESSFINELOCATION {
  @scala.inline
  def apply(
  ...
  ): AnonACCESSCOARSELOCATIONACCESSFINELOCATION = {
    ...
    __obj.asInstanceOf[AnonACCESSCOARSELOCATIONACCESSFINELOCATION]
  }
}
