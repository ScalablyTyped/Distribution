...
trait AnonAuthorizedDENIEDALWAYS extends js.Object {
...
object AnonAuthorizedDENIEDALWAYS {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAuthorizedDENIEDALWAYS]
  }
}
