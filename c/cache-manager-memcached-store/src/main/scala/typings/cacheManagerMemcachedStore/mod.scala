...
object mod extends Shortcut {
  ...
  object cacheManagerAugmentingMod {
    ...
    inline def caching(IConfig: CacheManagerMemcachedStoreConfig | (StoreConfig & CacheOptions)): Cache = ^.asInstanceOf[js.Dynamic].applyDynamic("caching")(IConfig.asInstanceOf[js.Any]).asInstanceOf[Cache]
  }
