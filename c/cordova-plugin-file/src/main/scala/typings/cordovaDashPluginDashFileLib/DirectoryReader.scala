...
trait DirectoryReader extends js.Object {
  /**
    ...
    */
  def readEntries(successCallback: js.Function1[/* entries */ js.Array[Entry], scala.Unit]): scala.Unit = js.native
  def readEntries(
    successCallback: js.Function1[/* entries */ js.Array[Entry], scala.Unit],
