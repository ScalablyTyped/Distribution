...
import typings.csvtojson.anon.OnCompleted
import typings.csvtojson.anon.Onfulfilled
import typings.csvtojson.converterMod.Converter
import typings.csvtojson.converterMod.PreFileLineCallback
...
object parseRuntimeMod {
  
  @JSImport("csvtojson/v2/ParseRuntime", JSImport.Namespace)
  @js.native
