...
object mjsCalculatorsCrcjamMod extends Shortcut {
  
  @JSImport("crc/mjs/calculators/crcjam", JSImport.Default)
  @js.native
  val default: CRCCalculator[js.typedarray.Uint8Array] = js.native
  
  type _To = CRCCalculator[js.typedarray.Uint8Array]
  
  /* This means you don't have to write `default`, but can instead just say `mjsCalculatorsCrcjamMod.foo` */
