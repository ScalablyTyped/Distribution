...
object mjsCalculatorsCrc8dvbs2Mod extends Shortcut {
  
  @JSImport("crc/mjs/calculators/crc8dvbs2", JSImport.Default)
  @js.native
  val default: CRCCalculator[js.typedarray.Uint8Array] = js.native
  
  type _To = CRCCalculator[js.typedarray.Uint8Array]
  
  /* This means you don't have to write `default`, but can instead just say `mjsCalculatorsCrc8dvbs2Mod.foo` */
