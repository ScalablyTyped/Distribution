...
object mjsCalculatorsCrc16xmodemMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `mjsCalculatorsCrc16xmodemMod.foo` */
