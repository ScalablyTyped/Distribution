...
object global {
  ...
  object chevrotain {
    ...
    open class Alternation protected ()
      extends typings.chevrotain.mod.Alternation {
    ...
    open class Alternative protected ()
      extends typings.chevrotain.mod.Alternative {
    ...
    open class CstParser ()
      extends typings.chevrotain.mod.CstParser
    ...
    open class EarlyExitException protected ()
      extends typings.chevrotain.mod.EarlyExitException {
    ...
    open class EmbeddedActionsParser ()
      extends typings.chevrotain.mod.EmbeddedActionsParser
    
    @JSGlobal("chevrotain.GAstVisitor")
    @js.native
    abstract class GAstVisitor ()
      extends typings.chevrotain.mod.GAstVisitor
    
    @JSGlobal("chevrotain.Lexer")
    @js.native
    open class Lexer protected ()
      extends typings.chevrotain.mod.Lexer {
      /**
    ...
    open class MismatchedTokenException protected ()
      extends typings.chevrotain.mod.MismatchedTokenException {
      def this(message: String, token: IToken, previousToken: IToken) = this()
    }
    ...
    open class NoViableAltException protected ()
      extends typings.chevrotain.mod.NoViableAltException {
      def this(message: String, token: IToken, previousToken: IToken) = this()
    }
    ...
    open class NonTerminal protected ()
      extends typings.chevrotain.mod.NonTerminal {
    ...
    open class NotAllInputParsedException protected ()
      extends typings.chevrotain.mod.NotAllInputParsedException {
    ...
    open class Option protected ()
      extends typings.chevrotain.mod.Option {
    ...
    open class Repetition protected ()
      extends typings.chevrotain.mod.Repetition {
      def this(options: Name) = this()
    }
    ...
    open class RepetitionMandatory protected ()
      extends typings.chevrotain.mod.RepetitionMandatory {
      def this(options: Name) = this()
    }
    ...
    open class RepetitionMandatoryWithSeparator protected ()
      extends typings.chevrotain.mod.RepetitionMandatoryWithSeparator {
    ...
    open class RepetitionWithSeparator protected ()
      extends typings.chevrotain.mod.RepetitionWithSeparator {
      def this(options: Separator) = this()
    }
    ...
    open class Rule protected ()
      extends typings.chevrotain.mod.Rule {
    ...
    open class Terminal protected ()
      extends typings.chevrotain.mod.Terminal {
