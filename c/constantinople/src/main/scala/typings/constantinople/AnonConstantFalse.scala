...
trait AnonConstantFalse extends js.Object {
  var constant: `false`
  var result: js.UndefOr[Unit] = js.undefined
}

object AnonConstantFalse {
  @scala.inline
  def apply(constant: `false`, result: js.UndefOr[Unit] = js.undefined): AnonConstantFalse = {
    ...
    __obj.asInstanceOf[AnonConstantFalse]
  }
}
