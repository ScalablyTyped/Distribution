...
trait `85` extends StObject {
  ...
  var c: js.Array[typings.countriesAndTimezones.countriesAndTimezonesStrings.CU]
...
object `85` {
  ...
  inline def apply(c: js.Array[typings.countriesAndTimezones.countriesAndTimezonesStrings.CU]): `85` = {
  ...
  implicit open class MutableBuilder[Self <: `85`] (val x: Self) extends AnyVal {
    ...
    inline def setC(value: js.Array[typings.countriesAndTimezones.countriesAndTimezonesStrings.CU]): Self = StObject.set(x, "c", value.asInstanceOf[js.Any])
    
    inline def setCVarargs(value: typings.countriesAndTimezones.countriesAndTimezonesStrings.CU*): Self = StObject.set(x, "c", js.Array(value*))
