...
trait StringifyOpts extends js.Object {
  /**
    ...
    */
  var columns: js.UndefOr[StringDictionary[String] | js.Array[String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var lineBreaks: js.UndefOr[String] = js.undefined
  /**
  ...
  /**
    ...
    */
  var quotedEmpty: js.UndefOr[Boolean] = js.undefined
  /**
    * Boolean, default to false, quote all fields of type string even if not required.
    */
  var quotedString: js.UndefOr[Boolean] = js.undefined
  /**
    * String used to delimit record rows or a special value;
    * special values are 'auto', 'unix', 'mac', 'windows', 'unicode'; defaults to 'auto' (discovered in source or 'unix' if no source is specified).
    */
...
object StringifyOpts {
  @scala.inline
  def apply(
    columns: StringDictionary[String] | js.Array[String] = null,
    delimiter: String = null,
    eof: js.UndefOr[Boolean] = js.undefined,
    escape: js.UndefOr[Boolean] = js.undefined,
    formatters: FormatterOpts = null,
    header: js.UndefOr[Boolean] = js.undefined,
    lineBreaks: String = null,
    quote: String = null,
    quoted: js.UndefOr[Boolean] = js.undefined,
    quotedEmpty: js.UndefOr[Boolean] = js.undefined,
    quotedString: js.UndefOr[Boolean] = js.undefined,
