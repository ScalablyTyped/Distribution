...
object ^ extends js.Object {
  ...
  def generateAppForLink(
    ...
    callback: js.Function1[/* result */ ExtensionInfo, scala.Unit]
  ): scala.Unit = js.native
  def get(id: java.lang.String): scala.Unit = js.native
  def get(id: java.lang.String, callback: js.Function1[/* result */ ExtensionInfo, scala.Unit]): scala.Unit = js.native
  def getAll(): scala.Unit = js.native
  def getAll(callback: js.Function1[/* result */ js.Array[ExtensionInfo], scala.Unit]): scala.Unit = js.native
  ...
  def uninstall(id: java.lang.String, options: UninstallOptions): scala.Unit = js.native
  def uninstall(id: java.lang.String, options: UninstallOptions, callback: js.Function0[scala.Unit]): scala.Unit = js.native
