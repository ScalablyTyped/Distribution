...
object ReceiverAction extends js.Object {
  ...
  /* "cast" */ val CAST: typings.chrome.chromeNs.castNs.ReceiverAction.CAST with String = js.native
  /* "stop" */ val STOP: typings.chrome.chromeNs.castNs.ReceiverAction.STOP with String = js.native
  @JSBracketAccess
