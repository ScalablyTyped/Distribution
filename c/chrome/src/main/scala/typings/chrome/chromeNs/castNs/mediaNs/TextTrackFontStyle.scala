...
object TextTrackFontStyle extends js.Object {
  ...
  /* "BOLD" */ val BOLD: typings.chrome.chromeNs.castNs.mediaNs.TextTrackFontStyle.BOLD with String = js.native
  /* "BOLD_ITALIC" */ val BOLD_ITALIC: typings.chrome.chromeNs.castNs.mediaNs.TextTrackFontStyle.BOLD_ITALIC with String = js.native
  /* "ITALIC" */ val ITALIC: typings.chrome.chromeNs.castNs.mediaNs.TextTrackFontStyle.ITALIC with String = js.native
  /* "NORMAL" */ val NORMAL: typings.chrome.chromeNs.castNs.mediaNs.TextTrackFontStyle.NORMAL with String = js.native
  @JSBracketAccess
