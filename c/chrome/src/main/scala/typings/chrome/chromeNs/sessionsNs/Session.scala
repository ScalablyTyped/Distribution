...
trait Session extends js.Object {
  ...
  /**
    ...
    */
  var window: js.UndefOr[typings.chrome.chromeNs.windowsNs.Window] = js.undefined
}

object Session {
  @scala.inline
  def apply(lastModified: Double, tab: Tab = null, window: typings.chrome.chromeNs.windowsNs.Window = null): Session = {
