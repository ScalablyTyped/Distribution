...
object DefaultActionPolicy extends js.Object {
  ...
  /* "cast_this_tab" */ val CAST_THIS_TAB: typings.chrome.chromeNs.castNs.DefaultActionPolicy.CAST_THIS_TAB with String = js.native
  /* "create_session" */ val CREATE_SESSION: typings.chrome.chromeNs.castNs.DefaultActionPolicy.CREATE_SESSION with String = js.native
  @JSBracketAccess
