...
trait Typeoftabs extends StObject {
  ...
  def create(createProperties: CreateProperties): js.Promise[Tab] = js.native
  ...
  def discard(): js.Promise[Tab] = js.native
  def discard(callback: js.Function1[/* tab */ Tab, Unit]): Unit = js.native
  def discard(tabId: Double): js.Promise[Tab] = js.native
  ...
  def group(options: GroupOptions): js.Promise[Double] = js.native
  def group(options: GroupOptions, callback: js.Function1[/* groupId */ Double, Unit]): Unit = js.native
  
  def highlight(highlightInfo: HighlightInfo): js.Promise[Window] = js.native
  ...
  def move(tabId: Double, moveProperties: MoveProperties): js.Promise[Tab] = js.native
  def move(tabId: Double, moveProperties: MoveProperties, callback: js.Function1[/* tab */ Tab, Unit]): Unit = js.native
  def move(tabIds: js.Array[Double], moveProperties: MoveProperties): js.Promise[js.Array[Tab]] = js.native
  def move(
  ...
  def reload(reloadProperties: ReloadProperties): js.Promise[Unit] = js.native
  ...
  def remove(tabId: Double): js.Promise[Unit] = js.native
  ...
  def ungroup(tabIds: js.Array[Double]): js.Promise[Unit] = js.native
  def ungroup(tabIds: js.Array[Double], callback: js.Function0[Unit]): Unit = js.native
  def ungroup(tabIds: Double): js.Promise[Unit] = js.native
  def ungroup(tabIds: Double, callback: js.Function0[Unit]): Unit = js.native
  
  def update(tabId: Double, updateProperties: UpdateProperties): js.Promise[Tab] = js.native
  def update(
    tabId: Double,
    updateProperties: UpdateProperties,
    callback: js.Function1[/* tab */ js.UndefOr[Tab], Unit]
  ): Unit = js.native
  def update(updateProperties: UpdateProperties): js.Promise[Tab] = js.native
