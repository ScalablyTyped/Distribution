...
import typings.chrome.chromeNs.tabsNs.CaptureVisibleTabOptions
import typings.chrome.chromeNs.tabsNs.ConnectInfo
import typings.chrome.chromeNs.tabsNs.CreateProperties
import typings.chrome.chromeNs.tabsNs.HighlightInfo
import typings.chrome.chromeNs.tabsNs.InjectDetails
import typings.chrome.chromeNs.tabsNs.MessageSendOptions
import typings.chrome.chromeNs.tabsNs.MoveProperties
import typings.chrome.chromeNs.tabsNs.QueryInfo
import typings.chrome.chromeNs.tabsNs.ReloadProperties
import typings.chrome.chromeNs.tabsNs.Tab
import typings.chrome.chromeNs.tabsNs.TabActivatedEvent
import typings.chrome.chromeNs.tabsNs.TabAttachedEvent
import typings.chrome.chromeNs.tabsNs.TabCreatedEvent
import typings.chrome.chromeNs.tabsNs.TabDetachedEvent
import typings.chrome.chromeNs.tabsNs.TabHighlightedEvent
import typings.chrome.chromeNs.tabsNs.TabMovedEvent
import typings.chrome.chromeNs.tabsNs.TabRemovedEvent
import typings.chrome.chromeNs.tabsNs.TabReplacedEvent
import typings.chrome.chromeNs.tabsNs.TabSelectedEvent
import typings.chrome.chromeNs.tabsNs.TabUpdatedEvent
import typings.chrome.chromeNs.tabsNs.TabZoomChangeEvent
import typings.chrome.chromeNs.tabsNs.UpdateProperties
import typings.chrome.chromeNs.tabsNs.ZoomSettings
