...
object browsingData {
  ...
  inline def settings(callback: js.Function1[/* result */ SettingsCallback, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("settings")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
