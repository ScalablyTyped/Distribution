...
object fontSettings {
  ...
  inline def clearDefaultFixedFontSize(details: js.Object): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearDefaultFixedFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def clearDefaultFontSize(): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearDefaultFontSize")().asInstanceOf[js.Promise[Unit]]
  inline def clearDefaultFontSize(callback: js.Function): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("clearDefaultFontSize")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def clearDefaultFontSize(details: js.Object): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearDefaultFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def clearFont(details: FontDetails): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearFont")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def clearMinimumFontSize(): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearMinimumFontSize")().asInstanceOf[js.Promise[Unit]]
  inline def clearMinimumFontSize(callback: js.Function): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("clearMinimumFontSize")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def clearMinimumFontSize(details: js.Object): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("clearMinimumFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def getDefaultFixedFontSize(): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFixedFontSize")().asInstanceOf[js.Promise[FontSizeDetails]]
  inline def getDefaultFixedFontSize(callback: js.Function1[/* details */ FontSizeDetails, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFixedFontSize")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def getDefaultFixedFontSize(details: js.Object): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFixedFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[FontSizeDetails]]
  ...
  inline def getDefaultFontSize(): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFontSize")().asInstanceOf[js.Promise[FontSizeDetails]]
  inline def getDefaultFontSize(callback: js.Function1[/* options */ FontSizeDetails, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFontSize")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def getDefaultFontSize(details: js.Object): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[FontSizeDetails]]
  ...
  inline def getFont(details: FontDetails): js.Promise[FontDetailsResult] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFont")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[FontDetailsResult]]
  ...
  inline def getFontList(): js.Promise[js.Array[FontName]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFontList")().asInstanceOf[js.Promise[js.Array[FontName]]]
  ...
  inline def getMinimumFontSize(): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getMinimumFontSize")().asInstanceOf[js.Promise[FontSizeDetails]]
  inline def getMinimumFontSize(callback: js.Function1[/* options */ FontSizeDetails, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getMinimumFontSize")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def getMinimumFontSize(details: js.Object): js.Promise[FontSizeDetails] = ^.asInstanceOf[js.Dynamic].applyDynamic("getMinimumFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[FontSizeDetails]]
  ...
  inline def setDefaultFixedFontSize(details: SetFontSizeDetails): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultFixedFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def setDefaultFontSize(details: DefaultFontSizeDetails): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def setFont(details: SetFontDetails): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setFont")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  ...
  inline def setMinimumFontSize(details: SetFontSizeDetails): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setMinimumFontSize")(details.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
