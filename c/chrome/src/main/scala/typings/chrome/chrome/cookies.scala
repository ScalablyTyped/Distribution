...
object cookies {
  ...
  */
  ...
  object SameSiteStatus {
    ...
    inline def lax: typings.chrome.chromeStrings.lax = "lax".asInstanceOf[typings.chrome.chromeStrings.lax]
    
    inline def no_restriction: typings.chrome.chromeStrings.no_restriction = "no_restriction".asInstanceOf[typings.chrome.chromeStrings.no_restriction]
    
    inline def strict: typings.chrome.chromeStrings.strict = "strict".asInstanceOf[typings.chrome.chromeStrings.strict]
    
    inline def unspecified: typings.chrome.chromeStrings.unspecified = "unspecified".asInstanceOf[typings.chrome.chromeStrings.unspecified]
  }
