...
object Port {
  ...
  implicit class PortOps[Self <: Port] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnDisconnect(value: PortDisconnectEvent): Self = this.set("onDisconnect", value.asInstanceOf[js.Any])
    @scala.inline
    def setOnMessage(value: PortMessageEvent): Self = this.set("onMessage", value.asInstanceOf[js.Any])
    @scala.inline
