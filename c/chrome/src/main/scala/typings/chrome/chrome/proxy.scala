...
object proxy {
  ...
  object ProxyConfig {
    ...
    extension [Self <: ProxyConfig](x: Self) {
      ...
      inline def setPacScript(value: PacScript): Self = StObject.set(x, "pacScript", value.asInstanceOf[js.Any])
      
      inline def setPacScriptUndefined: Self = StObject.set(x, "pacScript", js.undefined)
      
      inline def setRules(value: ProxyRules): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
  ...
  object ProxyRules {
    ...
    extension [Self <: ProxyRules](x: Self) {
      ...
      inline def setFallbackProxy(value: ProxyServer): Self = StObject.set(x, "fallbackProxy", value.asInstanceOf[js.Any])
      
      inline def setFallbackProxyUndefined: Self = StObject.set(x, "fallbackProxy", js.undefined)
      
      inline def setProxyForFtp(value: ProxyServer): Self = StObject.set(x, "proxyForFtp", value.asInstanceOf[js.Any])
      
      inline def setProxyForFtpUndefined: Self = StObject.set(x, "proxyForFtp", js.undefined)
      
      inline def setProxyForHttp(value: ProxyServer): Self = StObject.set(x, "proxyForHttp", value.asInstanceOf[js.Any])
      
      inline def setProxyForHttpUndefined: Self = StObject.set(x, "proxyForHttp", js.undefined)
      
      inline def setProxyForHttps(value: ProxyServer): Self = StObject.set(x, "proxyForHttps", value.asInstanceOf[js.Any])
      
      inline def setProxyForHttpsUndefined: Self = StObject.set(x, "proxyForHttps", js.undefined)
      
      inline def setSingleProxy(value: ProxyServer): Self = StObject.set(x, "singleProxy", value.asInstanceOf[js.Any])
