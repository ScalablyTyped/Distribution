...
import typings.chrome.chromeNs.serialNs.ConnectionInfo
import typings.chrome.chromeNs.serialNs.ConnectionOptions
import typings.chrome.chromeNs.serialNs.DeviceInfo
...
trait Typeofserial extends js.Object {
  ...
  val onReceiveErrorNs: TypeofonReceiveError
  val onReceiveNs: TypeofonReceive
...
object Typeofserial {
  ...
  def apply(
    ...
    onReceiveErrorNs: TypeofonReceiveError,
    onReceiveNs: TypeofonReceive,
