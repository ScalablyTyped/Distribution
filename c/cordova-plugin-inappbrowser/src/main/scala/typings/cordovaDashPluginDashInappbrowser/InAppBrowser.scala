...
trait InAppBrowser extends Window {
  ...
  /**
    ...
    */
  def executeScript(script: Anon_Code, callback: js.Function1[/* result */ js.Any, Unit]): Unit = js.native
  def executeScript(script: Anon_File, callback: js.Function1[/* result */ js.Any, Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def insertCSS(css: Anon_Code, callback: js.Function0[Unit]): Unit = js.native
  def insertCSS(css: Anon_File, callback: js.Function0[Unit]): Unit = js.native
