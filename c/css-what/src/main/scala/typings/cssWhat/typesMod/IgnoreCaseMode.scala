...
object IgnoreCaseMode {
  ...
  @JSImport("css-what/lib/es/types", "IgnoreCaseMode.CaseSensitive")
  @js.native
  val CaseSensitive: `false` = js.native
  
  @JSImport("css-what/lib/es/types", "IgnoreCaseMode.IgnoreCase")
  @js.native
  val IgnoreCase: `true` = js.native
  
  @JSImport("css-what/lib/es/types", "IgnoreCaseMode.QuirksMode")
  @js.native
  val QuirksMode: quirks = js.native
  
  @JSImport("css-what/lib/es/types", "IgnoreCaseMode.Unknown")
  @js.native
