...
import typings.cleanCss.AnonAllMergeAdjacentRules
...
trait OptimizationsOptions extends js.Object {
  ...
  var `2`: js.UndefOr[AnonAllMergeAdjacentRules] = js.undefined
}

object OptimizationsOptions {
  @scala.inline
  def apply(`1`: AnonAll = null, `2`: AnonAllMergeAdjacentRules = null): OptimizationsOptions = {
