...
trait FieldValueQueryBuilder[T] extends js.Object {
  ...
  def bigint[K /* <: java.lang.String */](columnName: K): TypeMatchedValue[T, K, longLib.longMod.^, this.type]
  ...
  def counter[K /* <: java.lang.String */](columnName: K): TypeMatchedValue[T, K, longLib.longMod.^, this.type]
  ...
  def double[K /* <: java.lang.String */](columnName: K): TypeMatchedValue[T, K, longLib.longMod.^, this.type]
...
object FieldValueQueryBuilder {
  ...
  def apply[T](
    ...
    bigint: js.Any => TypeMatchedValue[T, js.Any, longLib.longMod.^, FieldValueQueryBuilder[T]],
    ...
    counter: js.Any => TypeMatchedValue[T, js.Any, longLib.longMod.^, FieldValueQueryBuilder[T]],
    ...
    double: js.Any => TypeMatchedValue[T, js.Any, longLib.longMod.^, FieldValueQueryBuilder[T]],
