...
object sourceVendorAnsiStylesMod {
  ...
  @JSImport("chalk/source/vendor/ansi-styles", "backgroundColorNames")
  @js.native
  val backgroundColorNames: js.Array[BackgroundColorName] = js.native
  
  @JSImport("chalk/source/vendor/ansi-styles", "colorNames")
  @js.native
  val colorNames: js.Array[ColorName] = js.native
  
  @JSImport("chalk/source/vendor/ansi-styles", "foregroundColorNames")
  @js.native
  val foregroundColorNames: js.Array[ForegroundColorName] = js.native
  
  @JSImport("chalk/source/vendor/ansi-styles", "modifierNames")
  @js.native
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.chalk.sourceVendorAnsiStylesMod.ForegroundColorName
    - typings.chalk.sourceVendorAnsiStylesMod.BackgroundColorName
  */
