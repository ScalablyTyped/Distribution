...
trait Assertion
  ...
  def change(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("change")
  ...
  def changes(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("changes")
  ...
  def decrease(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("decrease")
  ...
  def decreases(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("decreases")
  ...
  def increase(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("increase")
  ...
  def increases(`object`: Object, property: Unit, message: String): Assertion = js.native
  @JSName("increases")
  ...
  def oneOf(list: js.Array[js.Any]): Assertion = js.native
  def oneOf(list: js.Array[js.Any], message: String): Assertion = js.native
