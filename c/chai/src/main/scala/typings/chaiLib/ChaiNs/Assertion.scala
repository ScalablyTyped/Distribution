...
trait Assertion
  ...
  def changes(`object`: chaiLib.Object, property: java.lang.String, message: java.lang.String): Assertion = js.native
  ...
  def contain(value: chaiLib.Object): Assertion = js.native
  def contain(value: chaiLib.Object, message: java.lang.String): Assertion = js.native
  ...
  def contains(value: chaiLib.Object): Assertion = js.native
  def contains(value: chaiLib.Object, message: java.lang.String): Assertion = js.native
  ...
  def decrease(`object`: chaiLib.Object, property: java.lang.String): Assertion = js.native
  ...
  def includes(value: chaiLib.Object): Assertion = js.native
  def includes(value: chaiLib.Object, message: java.lang.String): Assertion = js.native
  ...
  def increase(`object`: chaiLib.Object, property: java.lang.String): Assertion = js.native
