...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "execa" % "0.9-dt-20190228Z-64db69",
  ...
  "org.scalablytyped" %%% "listr" % "0.13-dt-20180306Z-189f0d",
  ...
  "org.scalablytyped" %%% "ramda" % "0.26-dt-20190330Z-f40bca",
  ...
  "org.scalablytyped" %%% "yauzl" % "2.9-dt-20181229Z-66d942")
