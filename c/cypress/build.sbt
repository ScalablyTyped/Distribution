...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "execa" % "0.9-dt-20180310Z-fa5bf1",
  ...
  "org.scalablytyped" %%% "listr" % "0.13-dt-20180306Z-2c79f2",
  ...
  "org.scalablytyped" %%% "mocha" % "5.2-dt-20180806Z-1708d5",
  ...
  "org.scalablytyped" %%% "yauzl" % "2.9-dt-20181229Z-d96ee9")
