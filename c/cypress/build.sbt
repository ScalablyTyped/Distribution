...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "commander" % "2.19.0-74aff3",
  ...
  "com.scalablytyped" %%% "execa" % "0.9-dt-20180910Z-615f03",
  ...
  "com.scalablytyped" %%% "listr" % "0.13-dt-20180910Z-bfa724",
  ...
  "com.scalablytyped" %%% "yauzl" % "2.9-dt-20180910Z-34728e",
