...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "execa" % "0.9-dt-20180910Z-fe5824",
  ...
  "com.scalablytyped" %%% "listr" % "0.13-dt-20180910Z-bd308b",
  ...
  "com.scalablytyped" %%% "mocha" % "5.2-dt-20180910Z-3bf0e7",
  ...
  "com.scalablytyped" %%% "yauzl" % "2.9-dt-20180910Z-b41e0b",
