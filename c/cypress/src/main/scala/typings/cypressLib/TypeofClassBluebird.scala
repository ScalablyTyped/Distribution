...
trait TypeofClassBluebird
  ...
  def all[R](values: Iterable[js.Thenable[R] | R]): cypressLib.typesBluebirdMod.Bluebird[js.Array[R]] = js.native
  def all[T1](values: js.Array[js.Thenable[T1] | T1]): cypressLib.typesBluebirdMod.Bluebird[js.Array[T1]] = js.native
  // array with values
  def all[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): cypressLib.typesBluebirdMod.Bluebird[js.Array[R]] = js.native
  ...
  def any[R](values: Iterable[js.Thenable[R] | R]): cypressLib.typesBluebirdMod.Bluebird[R] = js.native
   // tslint:disable-line:unified-signatures
  /**
    * Like `Promise.some()`, with 1 as `count`. However, if the promise fulfills, the fulfillment value is not an array of 1 but the value directly.
    */
  def any[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): cypressLib.typesBluebirdMod.Bluebird[R] = js.native
  ...
  def race[R](values: Iterable[js.Thenable[R] | R]): cypressLib.typesBluebirdMod.Bluebird[R] = js.native
  /**
    * Given an array, or a promise of an array, which contains promises (or a mix of promises and values) return a promise that is fulfilled or rejected as soon as a promise in the array is fulfilled or rejected with the respective rejection reason or fulfillment value.
    *
    * **Note** If you pass empty array or a sparse array with no values, or a promise/thenable for such, it will be forever pending.
    */
  def race[R](values: js.Thenable[Iterable[js.Thenable[R] | R]]): cypressLib.typesBluebirdMod.Bluebird[R] = js.native
  def reduce[R, U](
    values: Iterable[js.Thenable[R] | R],
  ...
  /**
    ...
    * *The original array is not modified.*
    */
  def some[R](values: js.Thenable[Iterable[js.Thenable[R] | R]], count: scala.Double): cypressLib.typesBluebirdMod.Bluebird[js.Array[R]] = js.native
  /**
