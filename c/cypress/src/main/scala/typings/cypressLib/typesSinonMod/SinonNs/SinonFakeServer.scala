...
trait SinonFakeServer extends SinonFakeServerOptions {
  ...
  /**
    ...
    * @param request
    */
  def getHTTPMethod(request: SinonFakeXMLHttpRequest): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def respondWith(body: java.lang.String): scala.Unit = js.native
  /**
    * Causes the server to respond to any request not matched by another response with the provided data. The default catch-all response is [404, {}, ""].
    * Default status is 200 and default headers are none.
    * When the response is a Function, it will be passed the request object. You must manually call respond on it to complete the request.
    * @param fn A Function.
    */
  def respondWith(fn: js.Function1[/* xhr */ SinonFakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
    * Responds to all method requests to the given URL with the given response.
    * method is an HTTP verb.
    */
  def respondWith(method: java.lang.String, url: java.lang.String, body: java.lang.String): scala.Unit = js.native
  /**
    * Responds to all method requests to the given URL with the given response.
    * method is an HTTP verb.
    */
  def respondWith(
    ...
    fn: js.Function1[/* xhr */ SinonFakeXMLHttpRequest, scala.Unit]
  ): scala.Unit = js.native
  /**
    * Responds to all method requests to the given URL with the given response.
    * method is an HTTP verb.
    */
  def respondWith(method: java.lang.String, url: java.lang.String, response: js.Array[_]): scala.Unit = js.native
  /**
    * Responds to all method requests to URLs matching the regular expression.
    */
  def respondWith(method: java.lang.String, url: stdLib.RegExp, body: java.lang.String): scala.Unit = js.native
  /**
    * Responds to all method requests to URLs matching the regular expression.
    */
  def respondWith(
  ...
  /**
    * Responds to all method requests to URLs matching the regular expression.
    */
  def respondWith(method: java.lang.String, url: stdLib.RegExp, response: js.Array[_]): scala.Unit = js.native
  /**
    * Causes the server to respond to any request not matched by another response with the provided data. The default catch-all response is [404, {}, ""].
    * Default status is 200 and default headers are none.
    * When the response is a Function, it will be passed the request object. You must manually call respond on it to complete the request.
    ...
    */
  def respondWith(response: js.Array[_]): scala.Unit = js.native
  /**
    * Responds to all requests to given URL, e.g. /posts/1.
    */
  def respondWith(url: java.lang.String, body: java.lang.String): scala.Unit = js.native
  /**
    * Responds to all requests to given URL, e.g. /posts/1.
    */
  def respondWith(url: java.lang.String, fn: js.Function1[/* xhr */ SinonFakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
    * Responds to all requests to given URL, e.g. /posts/1.
    */
  def respondWith(url: java.lang.String, response: js.Array[_]): scala.Unit = js.native
  /**
    ...
    */
  def respondWith(url: stdLib.RegExp, body: java.lang.String): scala.Unit = js.native
  /**
    * URL may be a regular expression, e.g. /\\/post\\//\\d+
    * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
    */
  def respondWith(url: stdLib.RegExp, fn: js.Function1[/* xhr */ SinonFakeXMLHttpRequest, scala.Unit]): scala.Unit = js.native
  /**
    * URL may be a regular expression, e.g. /\\/post\\//\\d+
    * If the response is a Function, it will be passed any capture groups from the regular expression along with the XMLHttpRequest object:
    */
  def respondWith(url: stdLib.RegExp, response: js.Array[_]): scala.Unit = js.native
