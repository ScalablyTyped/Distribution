...
trait AjaxSettingsBase[TContext] extends js.Object {
  /**
    ...
    */
  var accepts: js.UndefOr[cypressLib.JQueryNs.PlainObject[java.lang.String]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var complete: js.UndefOr[cypressLib.JQueryNs.TypeOrArray[CompleteCallback[TContext]]] = js.undefined
  /**
    ...
    */
  var contentType: js.UndefOr[java.lang.String | cypressLib.cypressLibNumbers.`false`] = js.undefined
  /**
    * An object of string/regular-expression pairs that determine how jQuery will parse the response,
    * given its content type.
    */
  var contents: js.UndefOr[cypressLib.JQueryNs.PlainObject[stdLib.RegExp]] = js.undefined
  /**
  ...
  var converters: js.UndefOr[
    cypressLib.JQueryNs.PlainObject[(js.Function1[/* value */ _, _]) | cypressLib.cypressLibNumbers.`true`]
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var data: js.UndefOr[cypressLib.JQueryNs.PlainObject[_] | java.lang.String] = js.undefined
  /**
  ...
  var dataType: js.UndefOr[
    cypressLib.cypressLibStrings.xml | cypressLib.cypressLibStrings.html | cypressLib.cypressLibStrings.script | cypressLib.cypressLibStrings.json | cypressLib.cypressLibStrings.jsonp | cypressLib.cypressLibStrings.text | java.lang.String
  ] = js.undefined
  /**
    ...
    */
  var error: js.UndefOr[cypressLib.JQueryNs.TypeOrArray[ErrorCallback[TContext]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var headers: js.UndefOr[cypressLib.JQueryNs.PlainObject[js.UndefOr[java.lang.String | scala.Null]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var jsonp: js.UndefOr[java.lang.String | cypressLib.cypressLibNumbers.`false`] = js.undefined
  /**
  ...
  /**
    ...
    */
  var success: js.UndefOr[cypressLib.JQueryNs.TypeOrArray[SuccessCallback[TContext]]] = js.undefined
  /**
...
object AjaxSettingsBase {
  @scala.inline
  def apply[TContext](
    accepts: cypressLib.JQueryNs.PlainObject[java.lang.String] = null,
    ...
    complete: cypressLib.JQueryNs.TypeOrArray[CompleteCallback[TContext]] = null,
    contentType: java.lang.String | cypressLib.cypressLibNumbers.`false` = null,
    contents: cypressLib.JQueryNs.PlainObject[stdLib.RegExp] = null,
    context: TContext = null,
    converters: cypressLib.JQueryNs.PlainObject[(js.Function1[/* value */ _, _]) | cypressLib.cypressLibNumbers.`true`] = null,
    crossDomain: js.UndefOr[scala.Boolean] = js.undefined,
    data: cypressLib.JQueryNs.PlainObject[_] | java.lang.String = null,
    ...
    error: cypressLib.JQueryNs.TypeOrArray[ErrorCallback[TContext]] = null,
    global: js.UndefOr[scala.Boolean] = js.undefined,
    headers: cypressLib.JQueryNs.PlainObject[js.UndefOr[java.lang.String | scala.Null]] = null,
    ...
    success: cypressLib.JQueryNs.TypeOrArray[SuccessCallback[TContext]] = null,
