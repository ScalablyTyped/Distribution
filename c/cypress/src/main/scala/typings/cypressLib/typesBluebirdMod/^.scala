...
object ^ extends js.Object {
  /**
    ...
    * If promise cancellation is enabled, passed in function will receive one more function argument `onCancel` that allows to register an optional cancellation callback.
    */
  var Promise: cypressLib.TypeofClassBluebird = js.native
  /**
    * The version number of the library
    */
  var version: java.lang.String = js.native
  def all[R](values: cypressLib.Iterable[js.Thenable[R] | R]): Bluebird[js.Array[R]] = js.native
  def all[T1](values: js.Array[js.Thenable[T1] | T1]): Bluebird[js.Array[T1]] = js.native
  // array with values
  def all[R](values: js.Thenable[cypressLib.Iterable[js.Thenable[R] | R]]): Bluebird[js.Array[R]] = js.native
  ...
  def any[R](values: cypressLib.Iterable[js.Thenable[R] | R]): Bluebird[R] = js.native
   // tslint:disable-line:unified-signatures
  /**
    * Like `Promise.some()`, with 1 as `count`. However, if the promise fulfills, the fulfillment value is not an array of 1 but the value directly.
    */
  def any[R](values: js.Thenable[cypressLib.Iterable[js.Thenable[R] | R]]): Bluebird[R] = js.native
  ...
  /**
    ...
    */
  def delay[R](ms: scala.Double, value: R): Bluebird[R] = js.native
  def delay[R](ms: scala.Double, value: js.Thenable[R]): Bluebird[R] = js.native
  def each[R, U](
  ...
  /**
    ...
    */
  def getNewLibraryCopy(): cypressLib.TypeofClassBluebird = js.native
  /**
  ...
  /**
    ...
    */
  def noConflict(): cypressLib.TypeofClassBluebird = js.native
  /**
  ...
  def props[K, V](map: cypressLib.typesLodashMod.Global.Map[K, js.Thenable[V] | V]): Bluebird[cypressLib.typesLodashMod.Global.Map[K, V]] = js.native
  /**
  ...
  // map
  @JSName("props")
  def props_KV[K, V](map: js.Thenable[cypressLib.typesLodashMod.Global.Map[K, js.Thenable[V] | V]]): Bluebird[cypressLib.typesLodashMod.Global.Map[K, V]] = js.native
  def race[R](values: cypressLib.Iterable[js.Thenable[R] | R]): Bluebird[R] = js.native
  /**
    * Given an array, or a promise of an array, which contains promises (or a mix of promises and values) return a promise that is fulfilled or rejected as soon as a promise in the array is fulfilled or rejected with the respective rejection reason or fulfillment value.
    *
    * **Note** If you pass empty array or a sparse array with no values, or a promise/thenable for such, it will be forever pending.
    */
  def race[R](values: js.Thenable[cypressLib.Iterable[js.Thenable[R] | R]]): Bluebird[R] = js.native
  def reduce[R, U](
    values: cypressLib.Iterable[js.Thenable[R] | R],
  ...
  def some[R](values: cypressLib.Iterable[js.Thenable[R] | R], count: scala.Double): Bluebird[js.Array[R]] = js.native
  /**
    ...
    * *The original array is not modified.*
    */
  def some[R](values: js.Thenable[cypressLib.Iterable[js.Thenable[R] | R]], count: scala.Double): Bluebird[js.Array[R]] = js.native
  /**
