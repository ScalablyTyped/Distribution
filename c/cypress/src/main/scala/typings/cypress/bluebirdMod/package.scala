...
package object bluebirdMod {
  ...
  type IterateFunction[T, R] = js.Function3[
    ...
    typings.cypress.bluebirdMod.Resolvable[R]
  ]
  type Resolvable[R] = R | js.Thenable[R]
  type ResolvableProps[T] = js.Object with typings.cypress.cypressStrings.ResolvableProps with org.scalablytyped.runtime.TopLevel[T]
