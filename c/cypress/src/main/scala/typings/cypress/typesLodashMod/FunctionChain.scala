...
trait FunctionChain[T]
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T2](arg2: T2, plc3: __, plc4: __): FunctionChain[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T3](arg3: T3): FunctionChain[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T1, T2](arg1: T1, arg2: T2, plc3: __): FunctionChain[
  ...
  /**
    * @see _.partialRight
    */
  def partialRight[T2, T4](arg2: T2, plc3: __, arg4: T4): FunctionChain[
    /* import warning: importer.ImportType#apply Failed type conversion: T extends cypress.cypress/types/lodash.Function4<infer T1, T2, infer T3, T4, infer R> ? cypress.cypress/types/lodash.Function2<T1, T3, R> : any */ js.Any
  ] = js.native
  /**
    * @see _.partialRight
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T1[T1](arg1: T1, plc2: __, plc3: __): FunctionChain[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T1T3[T1, T3](arg1: T1, plc2: __, arg3: T3): FunctionChain[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T2T3[T2, T3](arg2: T2, arg3: T3, plc4: __): FunctionChain[
  ...
  /**
    ...
    */
  @JSName("partialRight")
  def partialRight_T4[T4](arg4: T4): FunctionChain[
