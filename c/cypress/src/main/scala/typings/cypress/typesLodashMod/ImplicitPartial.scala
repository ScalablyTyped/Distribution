...
trait ImplicitPartial extends js.Object {
  ...
  def apply[T1, T2, R](`this`: LoDashImplicitWrapper[Function2[T1, T2, R]], plc1: __, arg2: T2): LoDashImplicitWrapper[Function1[T1, R]] = js.native
  ...
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], plc1: __, arg2: T2, arg3: T3): LoDashImplicitWrapper[Function1[T1, R]] = js.native
  def apply[T1, T2, T3, R](`this`: LoDashImplicitWrapper[Function3[T1, T2, T3, R]], plc1: __, plc2: __, arg3: T3): LoDashImplicitWrapper[Function2[T1, T2, R]] = js.native
