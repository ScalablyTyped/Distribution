...
trait LoDashImplicitWrapper[TValue] extends LoDashWrapper[TValue] {
  ...
  /**
    * @see _.flatMap
    */
  def flatMap[T /* <: js.Object */, TResult](`this`: LoDashImplicitWrapper[js.UndefOr[T | Null]], iteratee: ObjectIterator[T, Many[TResult]]): LoDashImplicitWrapper[js.Array[TResult]] = js.native
  /**
    * @see _.flatMapDeep
    */
  ...
  /**
    ...
    */
  def intersectionBy[T](`this`: LoDashImplicitWrapper[js.UndefOr[List[T] | Null]], values: List[T]*): LoDashImplicitWrapper[js.Array[T]] = js.native
  /**
    * @see _.intersectionBy
    */
  ...
  /**
    * @see _.map
    */
  def map[T /* <: js.Object */, TResult](`this`: LoDashImplicitWrapper[js.UndefOr[T | Null]], iteratee: ObjectIterator[T, TResult]): LoDashImplicitWrapper[js.Array[TResult]] = js.native
  /**
    * @see _.mapKeys
    */
