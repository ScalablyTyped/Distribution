...
trait LoDashImplicitWrapper[TValue] extends StObject {
  ...
  /**
    ...
    */
  @JSName("defaultTo")
  def defaultTo_TDefault_Any[TDefault](defaultValue: TDefault): /* import warning: importer.ImportType#apply Failed type conversion: TValue extends null | undefined ? TDefault : TValue | TDefault */ js.Any = js.native
  ...
  /**
    * @see _.toPairs
    */
  def toPairs(): Collection[
    js.Tuple2[
      java.lang.String, 
      /* import warning: importer.ImportType#apply Failed type conversion: TValue extends cypress.cypress/types/lodash.Dictionary<infer U> ? U : TValue extends cypress.cypress/types/lodash.NumericDictionary<infer V> ? V : any */ js.Any
    ]
  ] = js.native
  ...
  def words(pattern: js.RegExp): js.Array[java.lang.String] = js.native
