...
object cyBluebirdMod extends js.Object {
  ...
  trait BluebirdStatic
    extends Instantiable1[
          ...
          typings.cypress.bluebirdMod.^[js.Object]
        ] {
    /**
      ...
      */
    var AggregateError: Instantiable0[typings.cypress.bluebirdMod.AggregateError] = js.native
    /**
      * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
      */
    var CancellationError: Instantiable0[typings.cypress.bluebirdMod.CancellationError] = js.native
    /**
      * returned by `Bluebird.disposer()`.
      */
    var Disposer: Instantiable0[typings.cypress.bluebirdMod.Disposer[js.Object]] = js.native
    /**
      ...
      */
    var OperationalError: Instantiable0[typings.cypress.bluebirdMod.OperationalError] = js.native
    /**
      * Signals that an operation has timed out. Used as a custom cancellation reason in `.timeout`.
      */
    var TimeoutError: Instantiable0[typings.cypress.bluebirdMod.TimeoutError] = js.native
    /**
