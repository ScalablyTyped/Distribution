...
import typings.cypress.BrowserMocha
import typings.cypress.Chai.AssertStatic
import typings.cypress.Chai.ExpectStatic
...
inline def cy: typings.cypress.Cypress.cy & CyEventEmitter = js.Dynamic.global.selectDynamic("cy").asInstanceOf[typings.cypress.Cypress.cy & CyEventEmitter]
