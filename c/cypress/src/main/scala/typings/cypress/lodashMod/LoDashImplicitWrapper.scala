...
trait LoDashImplicitWrapper[TValue] extends LoDashWrapper[TValue] {
  ...
  /**
    * @see _.get
    */
  def get[T](path: Double): js.UndefOr[T] = js.native
  /**
    * @see _.get
    */
  ...
  /**
    ...
    */
  @JSName("get")
  def get_T_T[T](path: Double): T = js.native
  /**
    * @see _.groupBy
    */
  ...
  /**
    * @see _.reduce
    **/
  def reduce[T](callback: MemoListIterator[T, T, js.Array[T] | List[T]]): js.UndefOr[T] = js.native
  /**
    * @see _.reduce
    **/
  ...
  /**
    * @see _.reduceRight
    **/
  def reduceRight[T](callback: MemoListIterator[T, T, js.Array[T] | List[T]]): js.UndefOr[T] = js.native
  /**
    * @see _.reduceRight
    **/
