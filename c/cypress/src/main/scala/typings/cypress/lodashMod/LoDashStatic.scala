...
import typings.cypress.anon.FnCallArray
import typings.cypress.anon.FnCallCollectionIteratee
import typings.cypress.anon.FnCallValue
...
trait LoDashStatic extends js.Object {
  ...
  /**
    * @see _.mapValues
    */
  def mapValues[T /* <: js.Object */](obj: js.UndefOr[Null | T], iteratee: String): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ typings.cypress.cypressStrings.LoDashStatic with TopLevel[js.Any] = js.native
  /**
    * @see _.mapValues
    */
  def mapValues[T /* <: js.Object */](obj: js.UndefOr[Null | T], iteratee: js.Object): /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  ...
  /**
    ...
    */
  @JSName("mapValues")
  def mapValues_T_Dictionary[T](obj: js.UndefOr[Dictionary[T] | Null | NumericDictionary[T]], iteratee: String): Dictionary[_] = js.native
  /**
    * @see _.mapValues
    * TODO: This would be better if we had a separate overload for obj: NumericDictionary that returned a NumericDictionary,
    *       but TypeScript cannot select overload signatures based on number vs string index key type.
    */
  @JSName("mapValues")
  def mapValues_T_Dictionary[T](obj: js.UndefOr[Dictionary[T] | Null | NumericDictionary[T]], iteratee: js.Object): Dictionary[Boolean] = js.native
  /**
    * @see _.mapValues
    */
  @JSName("mapValues")
