...
import typings.cypress.JQueryNs.CoordinatesPartial
import typings.cypress.JQueryNs.Duration
import typings.cypress.JQueryNs.EffectsOptions
import typings.cypress.JQueryNs.Event
import typings.cypress.JQueryNs.EventHandler
import typings.cypress.JQueryNs.EventHandlerBase
import typings.cypress.JQueryNs.NameValuePair
import typings.cypress.JQueryNs.Node
