...
object ResolvedConfigOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResolvedConfigOptions[?], ComponentDevServerOpts] (val x: Self & ResolvedConfigOptions[ComponentDevServerOpts]) extends AnyVal {
