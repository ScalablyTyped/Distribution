...
trait EnqueuedCommandAttributes extends StObject {
...
object EnqueuedCommandAttributes {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnqueuedCommandAttributes]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnqueuedCommandAttributes] (val x: Self) extends AnyVal {
