...
trait Chainer[Subject] extends js.Object {
  ...
  def apply(
    chainer: haveDotalwaysDotthrown,
    value: ErrorConstructor with Instantiable0[typings.std.global.Error]
  ...
  def apply(chainer: haveDotthrown, value: ErrorConstructor with Instantiable0[typings.std.global.Error]): Chainable[Subject] = js.native
  ...
  def apply(
    chainer: notDothaveDotalwaysDotthrown,
    value: ErrorConstructor with Instantiable0[typings.std.global.Error]
  ): Chainable[Subject] = js.native
  ...
  def apply(chainer: notDothaveDotthrown, value: ErrorConstructor with Instantiable0[typings.std.global.Error]): Chainable[Subject] = js.native
