...
/* Inlined parent cypress.Cypress.Omit<cypress.Cypress.CoreConfigOptions, 'indexHtmlFile'> */
trait EndToEndConfigOptions extends StObject {
  ...
  /**
    ...
    * @default false
    */
  var experimentalOriginDependencies: js.UndefOr[Boolean] = js.undefined
  
  /**
    * Enables the "Run All Specs" UI feature, allowing the execution of multiple specs sequentially.
    * @default false
    */
  var experimentalRunAllSpecs: js.UndefOr[Boolean] = js.undefined
...
object EndToEndConfigOptions {
  
  inline def apply(): EndToEndConfigOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EndToEndConfigOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EndToEndConfigOptions] (val x: Self) extends AnyVal {
    ...
    inline def setExperimentalOriginDependencies(value: Boolean): Self = StObject.set(x, "experimentalOriginDependencies", value.asInstanceOf[js.Any])
    
    inline def setExperimentalOriginDependenciesUndefined: Self = StObject.set(x, "experimentalOriginDependencies", js.undefined)
    
    inline def setExperimentalRunAllSpecs(value: Boolean): Self = StObject.set(x, "experimentalRunAllSpecs", value.asInstanceOf[js.Any])
    
    inline def setExperimentalRunAllSpecsUndefined: Self = StObject.set(x, "experimentalRunAllSpecs", js.undefined)
