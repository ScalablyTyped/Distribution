...
object ComponentConfigOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ComponentConfigOptions[?], ComponentDevServerOpts] (val x: Self & ComponentConfigOptions[ComponentDevServerOpts]) extends AnyVal {
