...
trait PartialResolvedConfigOpti extends js.Object {
...
object PartialResolvedConfigOpti {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PartialResolvedConfigOpti]
  }
}
