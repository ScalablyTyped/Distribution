...
trait SinonStub extends SinonSpy {
  ...
  /**
    ...
    */
  def callsArg(index: Double): SinonStub = js.native
  /**
    ...
    * @param index
    */
  def callsArgAsync(index: Double): SinonStub = js.native
  /**
    * Like stub.callsArg(index); but with an additional parameter to pass the this context.
    * @param index
    * @param context
    */
  def callsArgOn(index: Double, context: js.Any): SinonStub = js.native
  /**
    * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
    * In Node environment the callback is deferred with process.nextTick.
    * In a browser the callback is deferred with setTimeout(callback, 0).
    ...
    * @param context
    */
  def callsArgOnAsync(index: Double, context: js.Any): SinonStub = js.native
  /**
    ...
    * @param args
    */
  def callsArgOnWith(index: Double, context: js.Any, args: js.Any*): SinonStub = js.native
  /**
    * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
    * In Node environment the callback is deferred with process.nextTick.
    * In a browser the callback is deferred with setTimeout(callback, 0).
    */
  def callsArgOnWithAsync(index: Double, context: js.Any, args: js.Any*): SinonStub = js.native
  /**
    * Like callsArg, but with arguments to pass to the callback.
    * @param index
    * @param args
    */
  def callsArgWith(index: Double, args: js.Any*): SinonStub = js.native
  /**
    * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
    * In Node environment the callback is deferred with process.nextTick.
    * In a browser the callback is deferred with setTimeout(callback, 0).
    */
  def callsArgWithAsync(index: Double, args: js.Any*): SinonStub = js.native
  /**
  ...
  /**
    ...
    * @param n
    */
  def onCall(n: Double): SinonStub = js.native
  /**
  ...
  /**
    ...
    * Since sinon@2.0.0
    */
  def rejects(errorType: String): SinonStub = js.native
  /**
  ...
  /**
    ...
    */
  def resolvesArg(index: Double): SinonStub = js.native
  /**
  ...
  /**
    ...
    * @param index
    */
  def returnsArg(index: Double): SinonStub = js.native
  /**
  ...
  /**
    ...
    * @param func
    */
  def set(func: js.Function1[/* v */ js.Any, Unit]): SinonStub = js.native
  /**
  ...
  def throws(`type`: String): SinonStub = js.native
  /**
    ...
    * @param index
    */
  def throwsArg(index: Double): SinonStub = js.native
  def throwsException(): SinonStub = js.native
  def throwsException(obj: js.Any): SinonStub = js.native
  def throwsException(`type`: String): SinonStub = js.native
  /**
  ...
  /**
    ...
    * @param args
    */
  def yieldsTo(property: String, args: js.Any*): SinonStub = js.native
  /**
    * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
    * In Node environment the callback is deferred with process.nextTick.
    * In a browser the callback is deferred with setTimeout(callback, 0).
    ...
    * @param args
    */
  def yieldsToAsync(property: String, args: js.Any*): SinonStub = js.native
  /**
    * Like above but with an additional parameter to pass the this context.
    */
  def yieldsToOn(property: String, context: js.Any, args: js.Any*): SinonStub = js.native
  /**
    * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
    * In Node environment the callback is deferred with process.nextTick.
    * In a browser the callback is deferred with setTimeout(callback, 0).
    ...
    * @param args
    */
  def yieldsToOnAsync(property: String, context: js.Any, args: js.Any*): SinonStub = js.native
}
