...
trait SinonStubStatic extends StObject {
  ...
  /**
    ...
    */
  def apply[T, K /* <: /* keyof T */ String */](obj: T, method: K): /* import warning: importer.ImportType#apply Failed type conversion: T[K] extends (args : infer TArgs): infer TReturnValue ? cypress.cypress/types/sinon.SinonStub<TArgs, TReturnValue> : cypress.cypress/types/sinon.SinonStub<std.Array<any>, any> */ js.Any = js.native
}
