...
- typings.cypress.typesSinonMod.SinonApi because var conflicts: clock. Inlined expectation, FakeXMLHttpRequest, fakeServer, fakeServerWithClock, createSandbox, createSandbox, defaultConfig, addBehavior, setFormatter */ @js.native
trait SinonStatic
  extends StObject
     with SinonSandbox {
