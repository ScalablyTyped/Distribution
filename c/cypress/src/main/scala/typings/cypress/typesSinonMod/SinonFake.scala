...
trait SinonFake extends StObject {
  ...
  /**
    ...
    */
  def apply(fn: js.Function): SinonSpy[js.Array[Any], Any] = js.native
  ...
  /**
    ...
    */
  def rejects(`val`: Any): SinonSpy[js.Array[Any], Any] = js.native
  
  /**
    * Creates a fake that returns a resolved Promise for the passed value.
    * @param val Resolved promise
    */
  def resolves(`val`: Any): SinonSpy[js.Array[Any], Any] = js.native
  
  /**
    * Creates a fake that returns the val argument
    * @param val Returned value
    */
  def returns(`val`: Any): SinonSpy[js.Array[Any], Any] = js.native
  
  def throws(`val`: String): SinonSpy[js.Array[Any], Any] = js.native
  /**
