...
trait SinonSandbox extends StObject {
  ...
  def createStubInstance[TType](
    ...
    overrides: /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof TType ]:? cypress.cypress/types/sinon.SinonStubbedMember<TType[K]> | TType[K] extends (args : ...any): infer R? R : TType[K]} */ js.Any
  ): SinonStubbedInstance[TType] = js.native
  
  /**
    * Creates a basic fake, with no behavior
    */
  def fake(): SinonSpy[js.Array[Any], Any] = js.native
  /**
    ...
    */
  def fake(fn: js.Function): SinonSpy[js.Array[Any], Any] = js.native
  @JSName("fake")
  ...
  /**
    * Works exactly like sinon.spy
    */
  def spy[T, K /* <: /* keyof T */ String */](obj: T, method: K): /* import warning: importer.ImportType#apply Failed type conversion: T[K] extends (args : infer TArgs): infer TReturnValue ? cypress.cypress/types/sinon.SinonSpy<TArgs, TReturnValue> : cypress.cypress/types/sinon.SinonSpy<std.Array<any>, any> */ js.Any = js.native
  /**
    * Works exactly like sinon.spy
    */
  def spy[T, K /* <: /* keyof T */ String */](obj: T, method: K, types: js.Array[get_ | set]): js.PropertyDescriptor & (Get[T, K]) = js.native
  /**
    * Works exactly like sinon.spy
    */
  @JSName("spy")
  ...
  /**
    * Works exactly like sinon.stub.
    */
  def stub[T, K /* <: /* keyof T */ String */](obj: T, method: K): /* import warning: importer.ImportType#apply Failed type conversion: T[K] extends (args : infer TArgs): infer TReturnValue ? cypress.cypress/types/sinon.SinonStub<TArgs, TReturnValue> : cypress.cypress/types/sinon.SinonStub<std.Array<any>, any> */ js.Any = js.native
  /**
    * Works exactly like sinon.stub.
    */
  @JSName("stub")
