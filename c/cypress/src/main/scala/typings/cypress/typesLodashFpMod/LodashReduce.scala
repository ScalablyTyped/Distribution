...
trait LodashReduce extends StObject {
  ...
  def apply[T](callback: __, accumulator: __, collection: typings.cypress.typesLodashMod.List[T]): LodashReduce2x4[T] = js.native
  ...
  def apply[T, TResult](callback: __, accumulator: TResult, collection: typings.cypress.typesLodashMod.List[T]): LodashReduce2x6[T, TResult] = js.native
}
