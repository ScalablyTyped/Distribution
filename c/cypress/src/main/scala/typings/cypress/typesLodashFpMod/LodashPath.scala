...
trait LodashPath extends js.Object {
  def apply(path: Double): LodashPath3x1 = js.native
  def apply(path: PropertyPath): js.UndefOr[scala.Nothing] = js.native
  def apply(path: PropertyPath, `object`: js.Any): js.Any = js.native
  def apply(path: __): LodashPath5x2 = js.native
  def apply(path: __, `object`: js.Any): LodashPath6x2 = js.native
  ...
  def apply[T](path: __, `object`: NumericDictionary[T]): LodashPath4x2[T] = js.native
