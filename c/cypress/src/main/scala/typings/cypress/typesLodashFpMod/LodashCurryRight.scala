...
trait LodashCurryRight extends StObject {
  ...
  def placeholder[T](value: typings.cypress.typesLodashMod.List[T]): Collection[T] = js.native
  @JSName("placeholder")
  ...
  /**
    ...
    **/
  @JSName("placeholder")
  def placeholder_TrapAny_Intersection[TrapAny /* <: typings.cypress.anon.TrapAny */](value: TrapAny): Collection[Any] & Function[Any] & Object[Any] & Primitive[Any] & String = js.native
}
