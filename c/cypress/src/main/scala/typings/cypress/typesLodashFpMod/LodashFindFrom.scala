...
trait LodashFindFrom extends StObject {
  ...
  def apply[T](predicate: __, fromIndex: Double, collection: typings.cypress.typesLodashMod.List[T]): LodashFindFrom1x6[T] = js.native
  ...
  def apply[T](predicate: __, fromIndex: __, collection: typings.cypress.typesLodashMod.List[T]): LodashFindFrom1x4[T] = js.native
