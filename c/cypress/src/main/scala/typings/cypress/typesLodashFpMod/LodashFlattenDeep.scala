...
{{{
type LodashFlattenDeep = <T>(array : cypress.cypress/types/lodash.ListOfRecursiveArraysOrValues<T> | null | undefined): std.Array<T>
}}}
to avoid circular code involving: 
- cypress.cypress/types/lodash.ListOfRecursiveArraysOrValues
- cypress.cypress/types/lodash.RecursiveArray
- cypress.cypress/types/lodash/fp.LodashFlattenDeep
*/
@js.native
