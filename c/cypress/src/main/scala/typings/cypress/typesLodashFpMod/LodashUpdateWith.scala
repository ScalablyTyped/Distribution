...
trait LodashUpdateWith extends StObject {
  ...
  def apply(customizer: __, path: PropertyPath, updater: js.Function1[/* oldValue */ Any, Any]): LodashUpdateWith1x6 = js.native
  def apply(customizer: __, path: __, updater: js.Function1[/* oldValue */ Any, Any]): LodashUpdateWith1x4 = js.native
  ...
  def apply[T /* <: js.Object */](customizer: SetWithCustomizer[T], path: __, updater: js.Function1[/* oldValue */ Any, Any]): LodashUpdateWith1x5[T] = js.native
  def apply[T /* <: js.Object */](
    customizer: SetWithCustomizer[T],
    path: __,
    updater: js.Function1[/* oldValue */ Any, Any],
  ...
  def apply[T /* <: js.Object */](customizer: __, path: PropertyPath, updater: js.Function1[/* oldValue */ Any, Any], `object`: T): LodashUpdateWith1x14[T] = js.native
  def apply[T /* <: js.Object */](customizer: __, path: PropertyPath, updater: __, `object`: T): LodashUpdateWith1x10[T] = js.native
  def apply[T /* <: js.Object */](customizer: __, path: __, updater: js.Function1[/* oldValue */ Any, Any], `object`: T): LodashUpdateWith1x12[T] = js.native
