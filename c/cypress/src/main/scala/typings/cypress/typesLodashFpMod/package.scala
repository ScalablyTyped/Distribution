...
package object typesLodashFpMod {
  ...
  type LodashIsMap = js.Function1[/* value */ js.Any, /* is std.Map<any, any> */ Boolean]
  ...
  type LodashIsSet = js.Function1[/* value */ js.Any, /* is std.Set<any> */ Boolean]
  ...
  type LodashIsWeakMap = js.Function1[/* value */ js.Any, /* is std.WeakMap<object, any> */ Boolean]
  type LodashIsWeakSet = js.Function1[/* value */ js.Any, /* is std.WeakSet<object> */ Boolean]
