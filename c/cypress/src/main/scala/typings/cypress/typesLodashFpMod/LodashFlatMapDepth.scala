...
trait LodashFlatMapDepth extends StObject {
  ...
  def apply[T](iteratee: __, depth: Double, collection: typings.cypress.typesLodashMod.List[T]): LodashFlatMapDepth1x6[T] = js.native
  def apply[T /* <: js.Object */](iteratee: __, depth: __, collection: T): LodashFlatMapDepth2x4[T] = js.native
  def apply[T](iteratee: __, depth: __, collection: typings.cypress.typesLodashMod.List[T]): LodashFlatMapDepth1x4[T] = js.native
