...
@js.native
trait LodashPropertyOf extends StObject {
  
  def apply(path: Double): LodashPropertyOf9x1 = js.native
  def apply(path: PropertyPath): Unit = js.native
  def apply(path: PropertyPath, `object`: Any): Any = js.native
  def apply(path: __): LodashPropertyOf11x2 = js.native
  def apply(path: __, `object`: Any): LodashPropertyOf12x2 = js.native
  def apply[T](path: Double, `object`: NumericDictionary[T]): js.UndefOr[T] = js.native
  def apply[T](path: __, `object`: NumericDictionary[T]): LodashPropertyOf9x2[T] = js.native
  def apply[TObject /* <: js.Object */, TKey /* <: /* keyof TObject */ String */](path: js.Array[TKey]): LodashPropertyOf1x1[TObject, TKey] = js.native
  ...
  def apply[TObject /* <: js.Object */, TKey1 /* <: /* keyof TObject */ String */, TKey2 /* <: /* import warning: importer.ImportType#apply Failed type conversion: keyof TObject[TKey1] */ js.Any */](path: js.Tuple2[TKey1, TKey2]): LodashPropertyOf3x1[TObject, TKey1, TKey2] = js.native
