...
import typings.cypress.JQuery.TypeEventHandler
import typings.cypress.JQuery.TypeEventHandlers
...
trait JQuery_[TElement]
  ...
  def trigger(eventType_event: typings.cypress.JQuery.Event): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery.Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery.Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery.Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery.Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery.Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery.Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
