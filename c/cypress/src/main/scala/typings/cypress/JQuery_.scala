...
trait JQuery_[TElement]
  ...
  def trigger(eventType_event: Event): this.type = js.native
  def trigger(eventType_event: Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: Event): js.Any = js.native
  def triggerHandler(eventType_event: Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
