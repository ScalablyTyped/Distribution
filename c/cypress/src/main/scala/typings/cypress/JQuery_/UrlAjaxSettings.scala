...
import typings.cypress.JQuery_.Ajax.AjaxSettingsBase
import typings.cypress.JQuery_.Ajax.CompleteCallback
import typings.cypress.JQuery_.Ajax.ErrorCallback
import typings.cypress.JQuery_.Ajax.StatusCodeCallbacks
import typings.cypress.JQuery_.Ajax.SuccessCallback
import typings.cypress.JQuery_.Ajax.XHRFields
