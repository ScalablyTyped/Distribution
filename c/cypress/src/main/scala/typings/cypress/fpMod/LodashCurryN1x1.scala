...
import typings.cypress.lodashMod.CurriedFunction2
import typings.cypress.lodashMod.CurriedFunction3
import typings.cypress.lodashMod.CurriedFunction4
import typings.cypress.lodashMod.CurriedFunction5
