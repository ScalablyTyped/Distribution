...
import typings.cypress.lodashMod.IsEqualCustomizer
...
trait LodashIsEqualWith extends js.Object {
  ...
  def apply(customizer: IsEqualCustomizer, value: __, other: js.Any): LodashIsEqualWith1x5 = js.native
  def apply(customizer: __, value: js.Any): LodashIsEqualWith1x2 = js.native
