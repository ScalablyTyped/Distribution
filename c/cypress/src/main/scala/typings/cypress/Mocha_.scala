...
trait Mocha_ extends js.Object {
  ...
  def reporter(reporter: typings.cypress.Mocha.ReporterConstructor): this.type = js.native
  def reporter(reporter: typings.cypress.Mocha.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
