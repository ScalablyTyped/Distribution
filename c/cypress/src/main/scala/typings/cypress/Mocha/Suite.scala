...
class Suite protected () extends EventEmitter {
  ...
  def addListener_postrequire(
    event: `post-require`,
    listener: js.Function3[/* context */ MochaGlobals, /* file */ String, /* mocha */ typings.cypress.Mocha, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  def addListener_require(
    event: require,
    listener: js.Function3[/* module */ js.Any, /* file */ String, /* mocha */ typings.cypress.Mocha, Unit]
  ): this.type = js.native
  @JSName("addListener")
  ...
  @JSName("addListener")
  def addListener_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  ...
  @JSName("emit")
  def emit_postrequire(name: `post-require`, context: MochaGlobals, file: String, mocha: typings.cypress.Mocha): Boolean = js.native
  @JSName("emit")
  def emit_prerequire(name: `pre-require`, context: MochaGlobals, file: String, mocha: typings.cypress.Mocha): Boolean = js.native
  @JSName("emit")
  def emit_require(name: require, module: js.Any, file: String, mocha: typings.cypress.Mocha): Boolean = js.native
  @JSName("emit")
  def emit_run(name: typings.cypress.cypressStrings.run): Boolean = js.native
  @JSName("emit")
  def emit_suite(name: typings.cypress.cypressStrings.suite, suite: Suite): Boolean = js.native
  @JSName("emit")
  def emit_test(name: typings.cypress.cypressStrings.test, test: Test): Boolean = js.native
  /**
  ...
  @JSName("on")
  def on_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  ...
  @JSName("once")
  def once_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  ...
  @JSName("prependListener")
  def prependListener_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  ...
  @JSName("prependOnceListener")
  def prependOnceListener_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  ...
  @JSName("removeListener")
  def removeListener_test(event: typings.cypress.cypressStrings.test, listener: js.Function1[/* test */ Test, Unit]): this.type = js.native
  /**
