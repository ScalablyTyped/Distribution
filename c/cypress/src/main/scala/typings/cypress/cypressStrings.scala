...
object cypressStrings {
  ...
  @js.native
  sealed trait ascii extends Encodings
  ...
  @js.native
  sealed trait bottomLeft extends PositionType
  
  @js.native
  sealed trait bottomRight extends PositionType
  ...
  @js.native
  sealed trait forward extends HistoryDirection
  ...
  @js.native
  sealed trait hex extends Encodings
  ...
  @js.native
  sealed trait `ipad-2` extends ViewportPreset
  
  @js.native
  sealed trait `ipad-mini` extends ViewportPreset
  
  @js.native
  sealed trait `iphone-3` extends ViewportPreset
  
  @js.native
  sealed trait `iphone-4` extends ViewportPreset
  
  @js.native
  sealed trait `iphone-5` extends ViewportPreset
  ...
  @js.native
  sealed trait latin1 extends Encodings
  ...
  @js.native
  sealed trait `macbook-11` extends ViewportPreset
  
  @js.native
  sealed trait `macbook-13` extends ViewportPreset
  
  @js.native
  sealed trait `macbook-15` extends ViewportPreset
  ...
  @js.native
  sealed trait portrait extends ViewportOrientation
  ...
  @js.native
  sealed trait topLeft extends PositionType
  
  @js.native
  sealed trait topRight extends PositionType
  ...
  @js.native
  sealed trait `ucs-2` extends Encodings
  
  @js.native
  sealed trait ucs2 extends Encodings
  ...
  @js.native
  sealed trait `utf-8` extends Encodings
  
  @js.native
  sealed trait utf16le extends Encodings
  
  @js.native
  sealed trait utf8 extends Encodings
