...
import typings.cypress.JQuery_.AjaxSettings
import typings.cypress.JQuery_.Coordinates
import typings.cypress.JQuery_.CoordinatesPartial
import typings.cypress.JQuery_.Duration
import typings.cypress.JQuery_.EffectsOptions
import typings.cypress.JQuery_.NameValuePair
import typings.cypress.JQuery_.Node
import typings.cypress.JQuery_.PlainObject
import typings.cypress.JQuery_.Promise
import typings.cypress.JQuery_.Queue
import typings.cypress.JQuery_.QueueFunction
import typings.cypress.JQuery_.Selector
import typings.cypress.JQuery_.TriggeredEvent
import typings.cypress.JQuery_.TypeEventHandler
import typings.cypress.JQuery_.TypeEventHandlers
import typings.cypress.JQuery_.TypeOrArray
import typings.cypress.JQuery_.htmlString
import typings.cypress.JQuery_.jqXHR
...
trait JQuery__[TElement]
  ...
  def add(selector_elements_html_selection: JQuery_[HTMLElement]): this.type = js.native
  /**
    * Create a new jQuery object with elements added to the set of matched elements.
  ...
  ```
    */
  def after(contents: (htmlString | (TypeOrArray[Node | JQuery_[Node]]))*): this.type = js.native
  /**
    * Insert content, specified by the parameter, after each element in the set of matched elements.
  ...
  def after(
    function_functionｰhtml: js.ThisFunction2[
      ...
      /* index */ Double, 
      /* html */ String, 
      htmlString | (TypeOrArray[Node | JQuery_[Node]])
    ]
  ): this.type = js.native
  /**
  ...
  def ajaxComplete_false(
    handler: js.ThisFunction3[
      /* this */ Document_, 
      /* event */ TriggeredEvent[Document_, js.UndefOr[scala.Nothing], Document_, Document_], 
      /* jqXHR */ jqXHR[_], 
  ...
  ```
    */
  @JSName("ajaxStart")
  def ajaxStart_false(handler: js.ThisFunction0[/* this */ Document_, Unit | `false`]): this.type = js.native
  /**
  ...
  ```
    */
  @JSName("ajaxStop")
  def ajaxStop_false(handler: js.ThisFunction0[/* this */ Document_, Unit | `false`]): this.type = js.native
  /**
  ...
  ```
    */
  def append(contents: (htmlString | (TypeOrArray[Node | JQuery_[Node]]))*): this.type = js.native
  /**
    * Insert content, specified by the parameter, to the end of each element in the set of matched elements.
  ...
  def appendTo(target: JQuery_[HTMLElement]): this.type = js.native
  ...
  ```
    */
  def before(contents: (htmlString | (TypeOrArray[Node | JQuery_[Node]]))*): this.type = js.native
  /**
    * Insert content, specified by the parameter, before each element in the set of matched elements.
    * @param function_functionｰhtml _&#x40;param_ `function_functionｰhtml`
    * <br>
  ...
  def closest(selector_selection_element: JQuery_[HTMLElement]): this.type = js.native
  /**
  ...
  ```
    */
  def contents(): JQuery_[TElement | Text | Comment | Document_] = js.native
  /**
  ...
  def filter(selector_elements_selection_function: JQuery_[HTMLElement]): this.type = js.native
  /**
  ...
  def index(selector_element: JQuery_[HTMLElement]): Double = js.native
  ...
  def insertAfter(target: JQuery_[typings.std.Node]): this.type = js.native
  /**
  ...
  def insertBefore(target: JQuery_[typings.std.Node]): this.type = js.native
  def is(
    selector_function_selection_elements: js.ThisFunction2[/* this */ TElement, /* index */ Double, /* element */ TElement, Boolean]
  ): Boolean = js.native
  def is(selector_function_selection_elements: JQuery_[HTMLElement]): Boolean = js.native
  /**
  ...
  def nextUntil(selector_element: JQuery_[HTMLElement]): this.type = js.native
  ...
  def nextUntil(selector_element: JQuery_[HTMLElement], filter: Selector): this.type = js.native
  ...
  def not(selector_function_selection: JQuery_[HTMLElement]): this.type = js.native
  /**
  ...
  def parentsUntil(selector_element: JQuery_[HTMLElement]): this.type = js.native
  ...
  def parentsUntil(selector_element: JQuery_[HTMLElement], filter: Selector): this.type = js.native
  ...
  ```
    */
  def prepend(contents: (htmlString | (TypeOrArray[Node | JQuery_[Node]]))*): this.type = js.native
  /**
    * Insert content, specified by the parameter, to the beginning of each element in the set of matched elements.
    * @param funсtion A function that returns an HTML string, DOM element(s), text node(s), or jQuery object to insert at
  ...
  def prependTo(target: JQuery_[HTMLElement]): this.type = js.native
  /**
  ...
  def prevUntil(selector_element: JQuery_[HTMLElement]): this.type = js.native
  ...
  def prevUntil(selector_element: JQuery_[HTMLElement], filter: Selector): this.type = js.native
  ...
  def replaceAll(target: JQuery_[HTMLElement]): this.type = js.native
  /**
  ...
  def replaceWith(
    newContent_function: js.ThisFunction2[
      ...
      /* index */ Double, 
      /* oldhtml */ htmlString, 
      htmlString | JQuery_[Node] | TypeOrArray[Element] | Node
    ]
  ): this.type = js.native
  def replaceWith(newContent_function: JQuery_[Node]): this.type = js.native
  /**
  ...
  def trigger(eventType_event: typings.cypress.JQuery_.Event): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery_.Event, extraParameters: String): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery_.Event, extraParameters: js.Array[_]): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery_.Event, extraParameters: Boolean): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery_.Event, extraParameters: Double): this.type = js.native
  def trigger(eventType_event: typings.cypress.JQuery_.Event, extraParameters: PlainObject[_]): this.type = js.native
  /**
  ...
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event, extraParameters: String): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event, extraParameters: js.Array[_]): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event, extraParameters: Boolean): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event, extraParameters: Double): js.Any = js.native
  def triggerHandler(eventType_event: typings.cypress.JQuery_.Event, extraParameters: PlainObject[_]): js.Any = js.native
  /**
  ...
  def wrap(
    wrappingElement_function: js.ThisFunction1[/* this */ TElement, /* index */ Double, String | JQuery_[HTMLElement]]
  ): this.type = js.native
  def wrap(wrappingElement_function: JQuery_[HTMLElement]): this.type = js.native
  ...
  def wrapAll(wrappingElement_function: js.ThisFunction0[/* this */ TElement, String | JQuery_[HTMLElement]]): this.type = js.native
  def wrapAll(wrappingElement_function: JQuery_[HTMLElement]): this.type = js.native
  ...
  def wrapInner(
    wrappingElement_function: js.ThisFunction1[/* this */ TElement, /* index */ Double, String | JQuery_[HTMLElement] | Element]
  ): this.type = js.native
  def wrapInner(wrappingElement_function: JQuery_[HTMLElement]): this.type = js.native
