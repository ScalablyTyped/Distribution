...
package object Cypress {
  type Agent[T /* <: typings.sinon.mod.SinonSpy */] = typings.cypress.mod.Cypress.SinonSpyAgent[T] with T
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type BrowserChannel = typings.cypress.mod.Cypress._BrowserChannel | java.lang.String
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type BrowserName = typings.cypress.mod.Cypress._BrowserName | java.lang.String
  ...
  type PluginConfig = js.Function2[
    /* on */ typings.cypress.mod.Cypress.PluginEvents, 
    /* config */ typings.cypress.mod.Cypress.PluginConfigOptions, 
  ...
  type Tasks = org.scalablytyped.runtime.StringDictionary[typings.cypress.mod.Cypress.Task]
  /**
    ...
    *
    ...
    ```
    */
  type cy = typings.cypress.mod.Cypress.Chainable[js.UndefOr[scala.Nothing]]
}
