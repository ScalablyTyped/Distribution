...
trait CommandQueue extends ObjectLike {
  ...
  def get[K /* <: logs | add | get_ | toJSON | create */](key: String): /* import warning: importer.ImportType#apply Failed type conversion: cypress.cypress.Cypress.CommandQueue[K] */ js.Any = js.native
