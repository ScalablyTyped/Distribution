...
import typings.cypress.Anon0
import typings.cypress.AnonAdd
import typings.cypress.AnonCalendarFormat
...
import typings.cypress.AnonInstantiable
...
import typings.cypress.TypeofimportedBlobUtil
...
trait Cypress extends js.Object {
  ...
  /**
    ...
    *    Cypress.Blob.method()
    */
  var Blob: TypeofimportedBlobUtil = js.native
  /**
    * @see https://on.cypress.io/api/commands
    */
  var Commands: AnonAdd = js.native
  /**
  ...
  /**
    ...
    */
  var LocalStorage: typings.cypress.mod.Cypress.LocalStorage = js.native
  /**
  ...
  /**
    ...
    */
  var Screenshot: Anon0 = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("minimatch")
  var minimatch_Original: AnonCall = js.native
  /**
    ...
    */
  @JSName("moment")
  var moment_Original: AnonCalendarFormat = js.native
  /**
  ...
  /**
    ...
    * @see https://on.cypress.io/minimatch
    */
  def minimatch(target: String, pattern: String, options: IOptions): Boolean = js.native
  /**
    * Cypress automatically includes moment.js and exposes it as Cypress.moment.
    *
    * @see https://on.cypress.io/moment
