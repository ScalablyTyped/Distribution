...
package object Chai_ {
  type AssertStatic = typings.cypress.Chai_.Assert
  ...
  type ChaiPlugin = js.Function2[
    /* chai */ typings.cypress.Chai_.ChaiStatic, 
    /* utils */ typings.cypress.Chai_.ChaiUtils, 
    scala.Unit
  ]
  type CloseTo = js.Function3[
    ...
    typings.cypress.Chai_.Assertion
  ]
