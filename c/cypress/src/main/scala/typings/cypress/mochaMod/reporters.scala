...
import typings.cypress.Mocha.reporters.Base_.ColorMap
import typings.cypress.Mocha.reporters.Base_.SymbolMap
...
object reporters {
  ...
  open class Base_ protected ()
    extends StObject
       with typings.cypress.Mocha.reporters.Base_ {
    ...
    /**
      ...
      */
    /* CompleteClass */
    var runner: typings.cypress.Mocha.Runner = js.native
  ...
  open class HTML_ ()
    extends StObject
       with typings.cypress.Mocha.reporters.HTML_ {
  ...
  open class Nyan_ ()
    extends StObject
       with typings.cypress.Mocha.reporters.Nyan_ {
  ...
  open class Progress_ protected ()
    ...
    def this(
      ...
      options: typings.cypress.Mocha.reporters.Progress_.MochaOptions
    ) = this()
  ...
  open class XUnit_ protected ()
    extends StObject
       with typings.cypress.Mocha.reporters.XUnit_ {
    def this(runner: typings.cypress.Mocha.Runner) = this()
    def this(runner: typings.cypress.Mocha.Runner, options: typings.cypress.Mocha.reporters.XUnit_.MochaOptions) = this()
