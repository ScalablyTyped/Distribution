...
import typings.cypress.Mocha_.IContext
...
class Suite_ protected ()
  extends typings.cypress.Mocha_.Suite_ {
  def this(title: String) = this()
  def this(title: String, parentContext: typings.cypress.Mocha_.Context) = this()
...
object Suite_ extends js.Object {
  ...
  def create(parent: ISuite, title: String): typings.cypress.Mocha_.Suite_ = js.native
  /**
    ...
    */
  def create(parent: typings.cypress.Mocha_.Suite_, title: String): typings.cypress.Mocha_.Suite_ = js.native
}
