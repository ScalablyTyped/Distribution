...
@js.native
open class HeaderSubmenu protected () extends default {
...
object HeaderSubmenu {
  ...
  object NAVIGATE {
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.NAVIGATE")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.NAVIGATE.BACKWARD")
    @js.native
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.NAVIGATE.FORWARD")
    @js.native
  ...
  object actions {
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.actions")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.actions.CLOSE_SUBMENU")
    @js.native
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.actions.DELEGATE_TO_FLYOUT_MENU")
    @js.native
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.actions.OPEN_SUBMENU")
    @js.native
    ...
    @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.actions.TOGGLE_SUBMENU_WITH_FOCUS")
    @js.native
  ...
  /* static member */
  @JSImport("carbon-components/globals/js/components", "HeaderSubmenu.components")
  @js.native
