...
import typings.carbonComponents.componentsContentSwitcherContentSwitcherMod.ContentSwitcherOptions
...
object componentsTabsTabsMod {
  ...
  @js.native
  trait Tab
    extends typings.carbonComponents.componentsContentSwitcherContentSwitcherMod.default {
