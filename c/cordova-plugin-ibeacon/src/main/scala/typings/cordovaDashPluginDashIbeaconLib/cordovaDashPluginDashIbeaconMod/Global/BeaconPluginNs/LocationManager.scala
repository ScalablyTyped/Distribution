...
object LocationManager {
  ...
  def apply(
    ...
    Region: Region,
    appendToDeviceLog: java.lang.String => qLib.qMod.QNs.Promise[java.lang.String],
    delegate: Delegate,
    disableBluetooth: () => qLib.qMod.QNs.Promise[scala.Unit],
    disableDebugLogs: () => qLib.qMod.QNs.Promise[scala.Unit],
    disableDebugNotifications: () => qLib.qMod.QNs.Promise[scala.Unit],
    enableBluetooth: () => qLib.qMod.QNs.Promise[scala.Unit],
    enableDebugLogs: () => qLib.qMod.QNs.Promise[scala.Unit],
    enableDebugNotifications: () => qLib.qMod.QNs.Promise[scala.Unit],
    getAuthorizationStatus: () => qLib.qMod.QNs.Promise[PluginResult],
    getMonitoredRegions: () => qLib.qMod.QNs.Promise[js.Array[Region]],
    getRangedRegions: () => qLib.qMod.QNs.Promise[js.Array[Region]],
    isAdvertising: () => qLib.qMod.QNs.Promise[scala.Boolean],
    isAdvertisingAvailable: () => qLib.qMod.QNs.Promise[scala.Boolean],
    isBluetoothEnabled: () => qLib.qMod.QNs.Promise[scala.Boolean],
    isMonitoringAvailableForClass: Region => qLib.qMod.QNs.Promise[scala.Boolean],
    isRangingAvailable: () => qLib.qMod.QNs.Promise[scala.Boolean],
    onDomDelegateReady: () => qLib.qMod.QNs.Promise[scala.Unit],
    requestAlwaysAuthorization: () => qLib.qMod.QNs.Promise[scala.Unit],
    requestStateForRegion: Region => qLib.qMod.QNs.Promise[scala.Unit],
    requestWhenInUseAuthorization: () => qLib.qMod.QNs.Promise[scala.Unit],
    startAdvertising: (Region, scala.Boolean) => qLib.qMod.QNs.Promise[scala.Unit],
    startMonitoringForRegion: Region => qLib.qMod.QNs.Promise[scala.Unit],
    startRangingBeaconsInRegion: Region => qLib.qMod.QNs.Promise[scala.Unit],
    stopAdvertising: () => qLib.qMod.QNs.Promise[scala.Unit],
    stopMonitoringForRegion: Region => qLib.qMod.QNs.Promise[scala.Unit],
    stopRangingBeaconsInRegion: Region => qLib.qMod.QNs.Promise[scala.Unit]
  ): LocationManager = {
