...
trait LocationManager extends js.Object {
  var BeaconRegion: typings.cordovaDashPluginDashIbeacon.cordovaDashPluginDashIbeaconMod._Global_.BeaconPlugin.BeaconRegion
  var Region: typings.cordovaDashPluginDashIbeacon.cordovaDashPluginDashIbeaconMod._Global_.BeaconPlugin.Region
