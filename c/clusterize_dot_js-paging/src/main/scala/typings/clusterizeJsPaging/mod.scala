package typings.clusterizeJsPaging
...
object mod {
  ...
  object Callbacks {
    ...
    extension [Self <: Callbacks](x: Self) {
      ...
      inline def setLoadRows(value: /* offset */ Double => Unit): Self = StObject.set(x, "loadRows", js.Any.fromFunction1(value))
      
      inline def setLoadRowsUndefined: Self = StObject.set(x, "loadRows", js.undefined)
      
      inline def setRowsLoaded(value: () => Unit): Self = StObject.set(x, "rowsLoaded", js.Any.fromFunction0(value))
