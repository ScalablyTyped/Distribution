...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def from(real: java.lang.String): Complex = js.native
  /**
    * A in line function like Number.from.
    * @param real The real part of the number
    * @param im The imaginary part of the number
    */
  def from(real: scala.Double): Complex = js.native
  def from(real: scala.Double, im: scala.Double): Complex = js.native
  /**
