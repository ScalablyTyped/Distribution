...
object sun16Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/sun/16", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `sun16Mod.foo` */
