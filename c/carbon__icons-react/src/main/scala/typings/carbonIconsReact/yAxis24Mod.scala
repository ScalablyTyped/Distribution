...
object yAxis24Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/y-axis/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `yAxis24Mod.foo` */
