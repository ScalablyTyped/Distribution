...
object table32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/table/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `table32Mod.foo` */
