...
object airport02Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Airport_02", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `airport02Mod.foo` */
