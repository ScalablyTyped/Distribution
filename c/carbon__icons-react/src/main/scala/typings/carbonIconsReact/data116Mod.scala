...
object data116Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/data--1/16", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `data116Mod.foo` */
