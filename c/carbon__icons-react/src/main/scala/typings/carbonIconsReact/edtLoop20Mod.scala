...
object edtLoop20Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/edt-loop/20", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `edtLoop20Mod.foo` */
