...
object libNumber7Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Number_7", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `libNumber7Mod.foo` */
