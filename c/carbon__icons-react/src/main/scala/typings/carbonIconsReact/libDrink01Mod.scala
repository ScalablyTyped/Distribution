...
object libDrink01Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Drink_01", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `libDrink01Mod.foo` */
