...
object pdf24Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/PDF/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `pdf24Mod.foo` */
