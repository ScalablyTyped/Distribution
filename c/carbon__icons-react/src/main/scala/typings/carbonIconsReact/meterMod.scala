...
object meterMod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Meter", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `meterMod.foo` */
