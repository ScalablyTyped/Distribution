...
object locked32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/locked/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `locked32Mod.foo` */
