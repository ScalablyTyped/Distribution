...
object CarbonIconProps {
  ...
  implicit class CarbonIconPropsOps[Self <: CarbonIconProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnError(value: SyntheticEvent[SVGElement, Event] => Unit): Self = this.set("onError", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnLoad(value: SyntheticEvent[SVGElement, Event] => Unit): Self = this.set("onLoad", js.Any.fromFunction1(value))
    @scala.inline
