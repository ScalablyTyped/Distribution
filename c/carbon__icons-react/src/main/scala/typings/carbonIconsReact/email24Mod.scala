...
object email24Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/email/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `email24Mod.foo` */
