...
object rewind30Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Rewind_30", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `rewind30Mod.foo` */
