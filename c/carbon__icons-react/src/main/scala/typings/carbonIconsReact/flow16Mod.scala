...
object flow16Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/flow/16", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `flow16Mod.foo` */
