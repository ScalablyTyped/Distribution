...
object roadmap32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/roadmap/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `roadmap32Mod.foo` */
