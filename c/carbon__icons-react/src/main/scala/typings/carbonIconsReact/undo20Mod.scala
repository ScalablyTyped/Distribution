...
object undo20Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/undo/20", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `undo20Mod.foo` */
