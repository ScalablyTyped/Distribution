...
object compass20Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/compass/20", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `compass20Mod.foo` */
