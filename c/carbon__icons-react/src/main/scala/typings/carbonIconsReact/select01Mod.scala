...
object select01Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Select_01", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `select01Mod.foo` */
