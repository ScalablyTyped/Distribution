...
object noImage32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/no-image/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `noImage32Mod.foo` */
