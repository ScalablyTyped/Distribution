...
object chatBot24Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/chat-bot/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `chatBot24Mod.foo` */
