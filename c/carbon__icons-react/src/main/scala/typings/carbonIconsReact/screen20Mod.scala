...
object screen20Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/screen/20", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `screen20Mod.foo` */
