...
object opacity32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/opacity/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `opacity32Mod.foo` */
