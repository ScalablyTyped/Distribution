...
object zoomIn16Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/zoom--in/16", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `zoomIn16Mod.foo` */
