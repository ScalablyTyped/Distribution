...
object zip32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/ZIP/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `zip32Mod.foo` */
