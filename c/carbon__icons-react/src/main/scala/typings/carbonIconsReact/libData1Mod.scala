...
object libData1Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Data_1", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `libData1Mod.foo` */
