...
object gif16Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/GIF/16", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `gif16Mod.foo` */
