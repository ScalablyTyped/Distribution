...
object sigma24Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/sigma/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `sigma24Mod.foo` */
