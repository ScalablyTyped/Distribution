...
object png32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/PNG/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `png32Mod.foo` */
