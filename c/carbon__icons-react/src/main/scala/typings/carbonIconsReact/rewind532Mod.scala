...
object rewind532Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/rewind--5/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `rewind532Mod.foo` */
