...
object rotate32Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/rotate/32", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `rotate32Mod.foo` */
