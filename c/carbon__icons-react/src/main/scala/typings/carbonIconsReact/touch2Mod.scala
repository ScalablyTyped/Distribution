...
object touch2Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/Touch_2", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `touch2Mod.foo` */
