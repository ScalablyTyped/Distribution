...
object data224Mod extends Shortcut {
  
  @JSImport("@carbon/icons-react/lib/data--2/24", JSImport.Default)
  @js.native
  val default: CarbonIconType = js.native
  
  type _To = CarbonIconType
  
  /* This means you don't have to write `default`, but can instead just say `data224Mod.foo` */
