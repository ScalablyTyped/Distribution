...
trait Anon_Verify extends js.Object {
  ...
  def hash(password: java.lang.String): stdLib.Promise[credentialLib.credentialMod.hashObject] = js.native
  def hash(password: java.lang.String, callback: HashCallback): scala.Unit = js.native
  def verify(hash: credentialLib.credentialMod.hashObject, password: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  ...
  def verify(hash: java.lang.String, password: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  // iterations(work: number, base): number;
