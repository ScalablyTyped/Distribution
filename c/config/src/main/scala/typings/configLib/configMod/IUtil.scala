...
trait IUtil extends js.Object {
  ...
  def cloneDeep(copyFrom: js.Any, depth: scala.Double): js.Any = js.native
  // Returns an object containing all elements that differ between two objects.
  def diffDeep(object1: js.Any, object2: js.Any): js.Any = js.native
  def diffDeep(object1: js.Any, object2: js.Any, depth: scala.Double): js.Any = js.native
  // Return true if two objects have equal contents.
  def equalsDeep(object1: js.Any, object2: js.Any): scala.Boolean = js.native
  def equalsDeep(object1: js.Any, object2: js.Any, dept: scala.Double): scala.Boolean = js.native
  ...
  def extendDeep(mergeInto: js.Any, mergeFrom: js.Any, depth: scala.Double): js.Any = js.native
  // Return the sources for the configurations
  def getConfigSources(): js.Array[IConfigSource] = js.native
  // Get the current value of a config environment variable
  def getEnv(varName: java.lang.String): java.lang.String = js.native
  // Return the config for the project based on directory param if not directory then return default one (config).
  def loadFileConfigs(configDir: java.lang.String): js.Any = js.native
  // Make an object property hidden so it doesn't appear when enumerating elements of the object.
  def makeHidden(`object`: js.Any, propertyName: java.lang.String): js.Any = js.native
  def makeHidden(`object`: js.Any, propertyName: java.lang.String, propertyValue: java.lang.String): js.Any = js.native
  ...
  def makeImmutable(`object`: js.Any, propertyName: java.lang.String): js.Any = js.native
  def makeImmutable(`object`: js.Any, propertyName: java.lang.String, propertyValue: java.lang.String): js.Any = js.native
  /**
    ...
    */
  def setModuleDefaults(moduleName: java.lang.String, defaults: js.Any): js.Any = js.native
