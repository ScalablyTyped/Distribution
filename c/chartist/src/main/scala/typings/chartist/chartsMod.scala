...
object chartsMod {
  ...
  open class BarChart protected ()
    extends typings.chartist.barChartMod.BarChart {
    /**
  ...
  @JSImport("chartist/dist/charts", "BaseChart")
  @js.native
  abstract class BaseChart[TEventsTypes] protected ()
    extends typings.chartist.baseChartMod.BaseChart[TEventsTypes] {
    def this(
      query: String,
  ...
  open class LineChart protected ()
    extends typings.chartist.lineChartMod.LineChart {
    /**
  ...
  open class PieChart protected ()
    extends typings.chartist.pieChartMod.PieChart {
    /**
