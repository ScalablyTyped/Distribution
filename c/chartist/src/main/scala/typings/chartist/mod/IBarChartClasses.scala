...
object IBarChartClasses {
  ...
  inline def apply(): IBarChartClasses = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IBarChartClasses]
  }
  
  extension [Self <: IBarChartClasses](x: Self) {
    ...
    inline def setHorizontalBars(value: String): Self = StObject.set(x, "horizontalBars", value.asInstanceOf[js.Any])
