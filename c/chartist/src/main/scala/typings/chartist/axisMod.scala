...
import typings.chartist.coreTypesMod.NormalizedSeriesPrimitiveValue
import typings.chartist.coreTypesMod.OptionsWithDefaults
...
object axisMod {
  ...
  @JSImport("chartist/dist/axes/Axis", "Axis")
  @js.native
  abstract class Axis protected () extends StObject {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.chartist.axisMod.XAxisUnits
    - typings.chartist.axisMod.YAxisUnits
  */
  trait AxisUnits_ extends StObject
  object AxisUnits_ {
    
    inline def XAxisUnits(): typings.chartist.axisMod.XAxisUnits = {
      val __obj = js.Dynamic.literal(dir = "horizontal", len = "width", pos = "x", rectEnd = "x2", rectOffset = "y2", rectStart = "x1")
      __obj.asInstanceOf[typings.chartist.axisMod.XAxisUnits]
    }
    
    inline def YAxisUnits(): typings.chartist.axisMod.YAxisUnits = {
      val __obj = js.Dynamic.literal(dir = "vertical", len = "height", pos = "y", rectEnd = "y1", rectOffset = "x1", rectStart = "y2")
      __obj.asInstanceOf[typings.chartist.axisMod.YAxisUnits]
    }
  }
