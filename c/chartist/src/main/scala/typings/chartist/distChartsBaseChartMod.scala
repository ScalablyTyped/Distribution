...
import typings.chartist.distEventEventEmitterMod.AllEventsListener
import typings.chartist.distEventEventEmitterMod.EventListener
...
object distChartsBaseChartMod {
  
  /* note: abstract class */ @JSImport("chartist/dist/charts/BaseChart", "BaseChart")
  @js.native
  open class BaseChart[TEventsTypes] protected () extends StObject {
    def this(
      query: String,
