...
import typings.chartist.barChartTypesMod.BarChartEventsTypes
import typings.chartist.barChartTypesMod.BarChartOptions
import typings.chartist.barChartTypesMod.BarChartOptionsWithDefaults
