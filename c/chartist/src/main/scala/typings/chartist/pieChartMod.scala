...
object pieChartMod {
  ...
  @JSImport("chartist/dist/charts/PieChart", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("chartist/dist/charts/PieChart", "PieChart")
  @js.native
  open class PieChart protected ()
    extends typings.chartist.pieChartPieChartMod.PieChart {
    /**
