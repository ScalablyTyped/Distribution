...
object svgTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.chartist.svgTypesMod.MoveParams
    - typings.chartist.svgTypesMod.LineParams
    - typings.chartist.svgTypesMod.CurveParams
    - typings.chartist.svgTypesMod.ArcParams
  */
  ...
  object _PathParams {
    ...
    inline def ArcParams(lAf: Double, rx: Double, ry: Double, sf: Double, x: Double, xAr: Double, y: Double): typings.chartist.svgTypesMod.ArcParams = {
      val __obj = js.Dynamic.literal(lAf = lAf.asInstanceOf[js.Any], rx = rx.asInstanceOf[js.Any], ry = ry.asInstanceOf[js.Any], sf = sf.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], xAr = xAr.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.chartist.svgTypesMod.ArcParams]
    }
    
    inline def CurveParams(x: Double, x1: Double, x2: Double, y: Double, y1: Double, y2: Double): typings.chartist.svgTypesMod.CurveParams = {
      val __obj = js.Dynamic.literal(x = x.asInstanceOf[js.Any], x1 = x1.asInstanceOf[js.Any], x2 = x2.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any], y1 = y1.asInstanceOf[js.Any], y2 = y2.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.chartist.svgTypesMod.CurveParams]
    }
  }
}
