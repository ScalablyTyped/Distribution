...
trait Anon_ArrayLike extends js.Object {
  def apply[T](arrayLike: nodeLib.Iterable[T]): Array[T] = js.native
  def apply[T](arrayLike: stdLib.ArrayLike[T]): Array[T] = js.native
  def apply[T, U](arrayLike: nodeLib.Iterable[T], mapfn: js.Function2[/* v */ T, /* k */ scala.Double, U]): Array[U] = js.native
  def apply[T, U](
