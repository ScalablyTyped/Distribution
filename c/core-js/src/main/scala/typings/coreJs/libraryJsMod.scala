...
object libraryJsMod {
  ...
  object Array {
    ...
    @JSImport("core-js/library/js", "Array.entries")
    @js.native
    def entries[T](array: ArrayLike[T]): IterableIterator[js.Tuple2[Double, T]] = js.native
    
    @JSImport("core-js/library/js", "Array.every")
    @js.native
    def every[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/js", "Array.fill")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.filter")
    @js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typings.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/library/js", "Array.find")
    @js.native
    def find[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/js", "Array.findIndex")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.forEach")
    @js.native
    def forEach[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/js", "Array.from")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.includes")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.indexOf")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.isArray")
    @js.native
    def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
    
    @JSImport("core-js/library/js", "Array.join")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.keys")
    @js.native
    def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
    
    @JSImport("core-js/library/js", "Array.lastIndexOf")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.map")
    @js.native
    def map[T, U](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/js", "Array.of")
    @js.native
    def of[T](items: T*): typings.coreJs.Array[T] = js.native
    
    @JSImport("core-js/library/js", "Array.pop")
    @js.native
    def pop[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/library/js", "Array.push")
    @js.native
    def push[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/library/js", "Array.reduce")
    @js.native
    def reduce[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/js", "Array.reduceRight")
    @js.native
    def reduceRight[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/library/js", "Array.reverse")
    @js.native
    def reverse[T](array: ArrayLike[T]): typings.coreJs.Array[T] = js.native
    
    @JSImport("core-js/library/js", "Array.shift")
    @js.native
    def shift[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/library/js", "Array.slice")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.some")
    @js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typings.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/library/js", "Array.sort")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.splice")
    @js.native
    ...
    @JSImport("core-js/library/js", "Array.turn")
    @js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/library/js", "Array.unshift")
    @js.native
    def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/library/js", "Array.values")
    @js.native
  ...
  object Date {
    ...
    @JSImport("core-js/library/js", "Date.format")
    @js.native
    ...
    @JSImport("core-js/library/js", "Date.formatUTC")
    @js.native
    ...
    @JSImport("core-js/library/js", "Date.now")
    @js.native
    def now(): Double = js.native
    
    @JSImport("core-js/library/js", "Date.toISOString")
    @js.native
  ...
  object Math {
    ...
    @JSImport("core-js/library/js", "Math.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/library/js", "Math.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Math.trunc")
    @js.native
  ...
  object Number {
    ...
    @JSImport("core-js/library/js", "Number.MIN_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/library/js", "Number.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/library/js", "Number.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.isFinite")
    @js.native
    def isFinite(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/js", "Number.isInteger")
    @js.native
    def isInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/js", "Number.isNaN")
    @js.native
    def isNaN(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/js", "Number.isSafeInteger")
    @js.native
    def isSafeInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/js", "Number.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.parseFloat")
    @js.native
    def parseFloat(string: java.lang.String): Double = js.native
    
    @JSImport("core-js/library/js", "Number.parseInt")
    @js.native
    ...
    @JSImport("core-js/library/js", "Number.random")
    @js.native
    ...
    @JSImport("core-js/library/js", "Number.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/js", "Number.trunc")
    @js.native
    def trunc(x: Double): Double = js.native
  }
  ...
  object Object {
    ...
    @JSImport("core-js/library/js", "Object.assign")
    @js.native
    def assign(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("core-js/library/js", "Object.classof")
    @js.native
    def classof(value: js.Any): java.lang.String = js.native
    
    @JSImport("core-js/library/js", "Object.create")
    @js.native
    ...
    @JSImport("core-js/library/js", "Object.preventExtensions")
    @js.native
    def preventExtensions[T](o: T): T = js.native
    
    @JSImport("core-js/library/js", "Object.seal")
    @js.native
    def seal[T](o: T): T = js.native
    
    @JSImport("core-js/library/js", "Object.setPrototypeOf")
    @js.native
    def setPrototypeOf(o: js.Any, proto: js.Any): js.Any = js.native
    
    @JSImport("core-js/library/js", "Object.values")
    @js.native
  ...
  object Reflect {
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.defineMetadata")
    @js.native
    ...
    @JSImport("core-js/library/js", "Reflect.defineProperty")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.deleteMetadata")
    @js.native
    ...
    @JSImport("core-js/library/js", "Reflect.deleteProperty")
    @js.native
    def deleteProperty(target: js.Any, propertyKey: PropertyKey): Boolean = js.native
    
    @JSImport("core-js/library/js", "Reflect.get")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.getMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.getMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.getOwnMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.getOwnMetadataKeys")
    @js.native
    ...
    @JSImport("core-js/library/js", "Reflect.getOwnPropertyDescriptor")
    @js.native
    def getOwnPropertyDescriptor(target: js.Any, propertyKey: PropertyKey): PropertyDescriptor = js.native
    
    @JSImport("core-js/library/js", "Reflect.getPrototypeOf")
    @js.native
    def getPrototypeOf(target: js.Any): js.Any = js.native
    
    @JSImport("core-js/library/js", "Reflect.has")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.hasMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.hasOwnMetadata")
    @js.native
    ...
    @JSImport("core-js/library/js", "Reflect.isExtensible")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/js", "Reflect.metadata")
    @js.native
    def metadata(metadataKey: js.Any, metadataValue: js.Any): FnCall = js.native
    
    @JSImport("core-js/library/js", "Reflect.ownKeys")
    @js.native
    def ownKeys(target: js.Any): Array[PropertyKey] = js.native
    
    @JSImport("core-js/library/js", "Reflect.preventExtensions")
    @js.native
    def preventExtensions(target: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/js", "Reflect.set")
    @js.native
    ...
    @JSImport("core-js/library/js", "Reflect.setPrototypeOf")
    @js.native
  ...
  object RegExp {
    ...
    @JSImport("core-js/library/js", "RegExp.escape")
    @js.native
  ...
  object String {
    ...
    @JSImport("core-js/library/js", "String.escapeHTML")
    @js.native
    def escapeHTML(text: java.lang.String): java.lang.String = js.native
    
    @JSImport("core-js/library/js", "String.fromCodePoint")
    @js.native
    def fromCodePoint(codePoints: Double*): java.lang.String = js.native
    
    @JSImport("core-js/library/js", "String.includes")
    @js.native
    ...
    @JSImport("core-js/library/js", "String.padEnd")
    @js.native
    ...
    @JSImport("core-js/library/js", "String.padStart")
    @js.native
    ...
    @JSImport("core-js/library/js", "String.unescapeHTML")
    @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/library/js", "WeakMap")
  @js.native
  ...
  @JSImport("core-js/library/js", "setImmediate")
  @js.native
  def setImmediate(expression: js.Any, args: js.Any*): Double = js.native
  
  @JSImport("core-js/library/js", "setInterval")
  @js.native
  ...
  @JSImport("core-js/library/js", "setTimeout")
  @js.native
  ...
  @JSImport("core-js/library/js", "version")
  @js.native
  val version: java.lang.String = js.native
  
  @JSImport("core-js/library/js", "$for")
  @js.native
