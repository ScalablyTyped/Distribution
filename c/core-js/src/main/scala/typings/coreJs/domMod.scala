...
object domMod {
  ...
  object Array {
    ...
    @JSImport("core-js/library/web/dom", "Array.concat")
    @js.native
    def concat[T](array: ArrayLike[T], items: (typings.coreJs.Array[T] | T)*): typings.coreJs.Array[T] = js.native
    
    @JSImport("core-js/library/web/dom", "Array.copyWithin")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.entries")
    @js.native
    def entries[T](array: ArrayLike[T]): IterableIterator[js.Tuple2[Double, T]] = js.native
    
    @JSImport("core-js/library/web/dom", "Array.every")
    @js.native
    def every[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/web/dom", "Array.fill")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.filter")
    @js.native
    def filter[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typings.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/library/web/dom", "Array.find")
    @js.native
    def find[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/web/dom", "Array.findIndex")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.forEach")
    @js.native
    def forEach[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/web/dom", "Array.from")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.includes")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.indexOf")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.isArray")
    @js.native
    def isArray(arg: js.Any): /* is core-js.Array<any> */ Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Array.join")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.keys")
    @js.native
    def keys[T](array: ArrayLike[T]): IterableIterator[Double] = js.native
    
    @JSImport("core-js/library/web/dom", "Array.lastIndexOf")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.map")
    @js.native
    def map[T, U](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/web/dom", "Array.of")
    @js.native
    def of[T](items: T*): typings.coreJs.Array[T] = js.native
    
    @JSImport("core-js/library/web/dom", "Array.pop")
    @js.native
    def pop[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/library/web/dom", "Array.push")
    @js.native
    def push[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Array.reduce")
    @js.native
    def reduce[T](
      array: ArrayLike[T],
    ...
    @JSImport("core-js/library/web/dom", "Array.reduceRight")
    @js.native
    def reduceRight[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/library/web/dom", "Array.reverse")
    @js.native
    def reverse[T](array: ArrayLike[T]): typings.coreJs.Array[T] = js.native
    
    @JSImport("core-js/library/web/dom", "Array.shift")
    @js.native
    def shift[T](array: ArrayLike[T]): T = js.native
    
    @JSImport("core-js/library/web/dom", "Array.slice")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.some")
    @js.native
    def some[T](
      array: ArrayLike[T],
      callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ typings.coreJs.Array[T], Boolean]
    ...
    @JSImport("core-js/library/web/dom", "Array.sort")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.splice")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Array.turn")
    @js.native
    def turn[T](
      array: ArrayLike[T],
      callbackfn: js.Function4[
    ...
    @JSImport("core-js/library/web/dom", "Array.unshift")
    @js.native
    def unshift[T](array: ArrayLike[T], items: T*): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Array.values")
    @js.native
  ...
  object Date {
    ...
    @JSImport("core-js/library/web/dom", "Date.format")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Date.formatUTC")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Date.now")
    @js.native
    def now(): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Date.toISOString")
    @js.native
    def toISOString(date: typings.coreJs.Date): java.lang.String = js.native
  }
  
  @JSImport("core-js/library/web/dom", "Dict")
  @js.native
  val Dict: DictConstructor = js.native
  
  object Function {
    
    @JSImport("core-js/library/web/dom", "Function.bind")
    @js.native
    def bind(target: typings.coreJs.Function, thisArg: js.Any, argArray: js.Any*): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Function.part")
    @js.native
  ...
  object Math {
    ...
    @JSImport("core-js/library/web/dom", "Math.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Math.trunc")
    @js.native
  ...
  object Number {
    ...
    @JSImport("core-js/library/web/dom", "Number.EPSILON")
    @js.native
    def EPSILON: Double = js.native
    @scala.inline
    def EPSILON_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("EPSILON")(x.asInstanceOf[js.Any])
    
    @JSImport("core-js/library/web/dom", "Number.MAX_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Number.MIN_SAFE_INTEGER")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Number.acosh")
    @js.native
    def acosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.asinh")
    @js.native
    def asinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.atanh")
    @js.native
    def atanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.cbrt")
    @js.native
    def cbrt(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.clz32")
    @js.native
    def clz32(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.cosh")
    @js.native
    def cosh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.expm1")
    @js.native
    def expm1(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.fround")
    @js.native
    def fround(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.hypot")
    @js.native
    def hypot(values: Double*): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.imul")
    @js.native
    def imul(x: Double, y: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.isFinite")
    @js.native
    def isFinite(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Number.isInteger")
    @js.native
    def isInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Number.isNaN")
    @js.native
    def isNaN(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Number.isSafeInteger")
    @js.native
    def isSafeInteger(number: Double): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Number.log10")
    @js.native
    def log10(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.log1p")
    @js.native
    def log1p(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.log2")
    @js.native
    def log2(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.parseFloat")
    @js.native
    def parseFloat(string: java.lang.String): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.parseInt")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Number.random")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Number.sign")
    @js.native
    def sign(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.sinh")
    @js.native
    def sinh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.tanh")
    @js.native
    def tanh(x: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "Number.trunc")
    @js.native
    def trunc(x: Double): Double = js.native
  }
  ...
  object Object {
    ...
    @JSImport("core-js/library/web/dom", "Object.assign")
    @js.native
    def assign(target: js.Any, sources: js.Any*): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Object.classof")
    @js.native
    def classof(value: js.Any): java.lang.String = js.native
    
    @JSImport("core-js/library/web/dom", "Object.create")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Object.define")
    @js.native
    def define[T](target: T, mixin: js.Any): T = js.native
    
    @JSImport("core-js/library/web/dom", "Object.defineProperties")
    @js.native
    def defineProperties(o: js.Any, properties: PropertyDescriptorMap): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Object.defineProperty")
    @js.native
    def defineProperty(o: js.Any, propertyKey: PropertyKey, attributes: PropertyDescriptor): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Object.entries")
    @js.native
    def entries(`object`: js.Any): Array[_] = js.native
    
    @JSImport("core-js/library/web/dom", "Object.freeze")
    @js.native
    def freeze[T](o: T): T = js.native
    
    @JSImport("core-js/library/web/dom", "Object.getOwnPropertyDescriptor")
    @js.native
    def getOwnPropertyDescriptor(o: js.Any, propertyKey: PropertyKey): PropertyDescriptor = js.native
    
    @JSImport("core-js/library/web/dom", "Object.getOwnPropertyDescriptors")
    @js.native
    def getOwnPropertyDescriptors(`object`: js.Any): PropertyDescriptorMap = js.native
    
    @JSImport("core-js/library/web/dom", "Object.getOwnPropertyNames")
    @js.native
    def getOwnPropertyNames(o: js.Any): Array[java.lang.String] = js.native
    
    @JSImport("core-js/library/web/dom", "Object.getOwnPropertySymbols")
    @js.native
    def getOwnPropertySymbols(o: js.Any): Array[js.Symbol] = js.native
    
    @JSImport("core-js/library/web/dom", "Object.getPrototypeOf")
    @js.native
    def getPrototypeOf(o: js.Any): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Object.is")
    @js.native
    def is(value1: js.Any, value2: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Object.isExtensible")
    @js.native
    def isExtensible(o: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Object.isFrozen")
    @js.native
    def isFrozen(o: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Object.isObject")
    @js.native
    def isObject(value: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Object.isSealed")
    @js.native
    def isSealed(o: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Object.keys")
    @js.native
    def keys(o: js.Any): Array[java.lang.String] = js.native
    
    @JSImport("core-js/library/web/dom", "Object.make")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Object.preventExtensions")
    @js.native
    def preventExtensions[T](o: T): T = js.native
    
    @JSImport("core-js/library/web/dom", "Object.seal")
    @js.native
    def seal[T](o: T): T = js.native
    
    @JSImport("core-js/library/web/dom", "Object.setPrototypeOf")
    @js.native
    def setPrototypeOf(o: js.Any, proto: js.Any): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Object.values")
    @js.native
  ...
  object Reflect {
    ...
    @JSImport("core-js/library/web/dom", "Reflect.apply")
    @js.native
    def apply(target: Function, thisArgument: js.Any, argumentsList: ArrayLike[_]): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.construct")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.defineMetadata")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Reflect.defineProperty")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.deleteMetadata")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Reflect.deleteProperty")
    @js.native
    def deleteProperty(target: js.Any, propertyKey: PropertyKey): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.get")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.getMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.getMetadataKeys")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.getOwnMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.getOwnMetadataKeys")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Reflect.getOwnPropertyDescriptor")
    @js.native
    def getOwnPropertyDescriptor(target: js.Any, propertyKey: PropertyKey): PropertyDescriptor = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.getPrototypeOf")
    @js.native
    def getPrototypeOf(target: js.Any): js.Any = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.has")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.hasMetadata")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.hasOwnMetadata")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Reflect.isExtensible")
    @js.native
    ...
    /**
      ...
      * ```
      */
    @JSImport("core-js/library/web/dom", "Reflect.metadata")
    @js.native
    def metadata(metadataKey: js.Any, metadataValue: js.Any): FnCall = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.ownKeys")
    @js.native
    def ownKeys(target: js.Any): Array[PropertyKey] = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.preventExtensions")
    @js.native
    def preventExtensions(target: js.Any): Boolean = js.native
    
    @JSImport("core-js/library/web/dom", "Reflect.set")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "Reflect.setPrototypeOf")
    @js.native
  ...
  object RegExp {
    ...
    @JSImport("core-js/library/web/dom", "RegExp.escape")
    @js.native
    def escape(str: java.lang.String): java.lang.String = js.native
  }
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("core-js/library/web/dom", "Set")
  @js.native
  class Set[T] ()
  ...
  object String {
    ...
    @JSImport("core-js/library/web/dom", "String.at")
    @js.native
    def at(text: java.lang.String, index: Double): java.lang.String = js.native
    
    @JSImport("core-js/library/web/dom", "String.codePointAt")
    @js.native
    def codePointAt(text: java.lang.String, pos: Double): Double = js.native
    
    @JSImport("core-js/library/web/dom", "String.endsWith")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "String.escapeHTML")
    @js.native
    def escapeHTML(text: java.lang.String): java.lang.String = js.native
    
    @JSImport("core-js/library/web/dom", "String.fromCodePoint")
    @js.native
    def fromCodePoint(codePoints: Double*): java.lang.String = js.native
    
    @JSImport("core-js/library/web/dom", "String.includes")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "String.padEnd")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "String.padStart")
    @js.native
    ...
    @JSImport("core-js/library/web/dom", "String.unescapeHTML")
    @js.native
  ...
  @JSImport("core-js/library/web/dom", "setImmediate")
  @js.native
  def setImmediate(expression: js.Any, args: js.Any*): Double = js.native
  
  @JSImport("core-js/library/web/dom", "setInterval")
  @js.native
  ...
  @JSImport("core-js/library/web/dom", "setTimeout")
  @js.native
  ...
  @JSImport("core-js/library/web/dom", "version")
  @js.native
  val version: java.lang.String = js.native
  
  @JSImport("core-js/library/web/dom", "$for")
  @js.native
