...
object Object extends js.Object {
  ...
  def entries(`object`: js.Any): typings.coreDashJs.Array[_] = js.native
  ...
  def getOwnPropertyNames(o: js.Any): typings.coreDashJs.Array[java.lang.String] = js.native
  def getOwnPropertySymbols(o: js.Any): typings.coreDashJs.Array[js.Symbol] = js.native
  ...
  def keys(o: js.Any): typings.coreDashJs.Array[java.lang.String] = js.native
  ...
  def values(`object`: js.Any): typings.coreDashJs.Array[_] = js.native
}
