...
object ^ extends js.Object {
  ...
  def capture(
    ...
    opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions,
  ...
  def capture(
    streams: nodeLib.NodeJSNs.WritableStream,
    opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions,
    exec: js.Function0[scala.Unit]
  ): js.Array[java.lang.String] = js.native
  def captureStderr(exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def captureStderr(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def captureStdio(exec: js.Function0[scala.Unit]): captureDashConsoleLib.Anon_Stderr = js.native
  def captureStdio(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): captureDashConsoleLib.Anon_Stderr = js.native
  def captureStdout(exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def captureStdout(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def hook(
  ...
  def interceptStderr(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def interceptStdio(exec: js.Function0[scala.Unit]): captureDashConsoleLib.Anon_Stderr = js.native
  def interceptStdio(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): captureDashConsoleLib.Anon_Stderr = js.native
  def interceptStdout(exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def interceptStdout(opts: captureDashConsoleLib.captureDashConsoleMod.CaptureOptions, exec: js.Function0[scala.Unit]): java.lang.String = js.native
  def startCapture(
    stream: nodeLib.NodeJSNs.WritableStream,
    exec: js.Function3[
      /* string */ java.lang.String, 
