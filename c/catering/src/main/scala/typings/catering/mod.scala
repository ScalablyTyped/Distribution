...
object mod {
  ...
  inline def fromCallback[T, S /* <: js.Symbol */](callback: Unit, symbol: S): Callback[T] & typings.catering.cateringStrings.fromCallback & TopLevel[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCallback")(callback.asInstanceOf[js.Any], symbol.asInstanceOf[js.Any])).asInstanceOf[Callback[T] & typings.catering.cateringStrings.fromCallback & TopLevel[Any]]
  inline def fromCallback[T, S /* <: js.Symbol */](callback: Callback[T], symbol: S): Callback[T] & typings.catering.cateringStrings.fromCallback & TopLevel[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCallback")(callback.asInstanceOf[js.Any], symbol.asInstanceOf[js.Any])).asInstanceOf[Callback[T] & typings.catering.cateringStrings.fromCallback & TopLevel[Any]]
