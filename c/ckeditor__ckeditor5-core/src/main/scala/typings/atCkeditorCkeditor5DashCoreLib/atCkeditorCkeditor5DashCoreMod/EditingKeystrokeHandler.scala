...
class EditingKeystrokeHandler protected ()
  extends atCkeditorCkeditor5DashUtilsLib.atCkeditorCkeditor5DashUtilsMod.KeystrokeHandler {
  ...
  def set(
    ...
    callback: js.Function2[
      /* keyEvtData */ atCkeditorCkeditor5DashEngineLib.atCkeditorCkeditor5DashEngineMod.viewNs.observerNs.KeyEventData, 
