...
@scala.inline
def formatDate(date: scala.Double, formatString: scala.Unit, culture: java.lang.String): scala.Unit = (typings.canvasjs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("formatDate")(date.asInstanceOf[js.Any], formatString.asInstanceOf[js.Any], culture.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
/**
...
@scala.inline
def formatDate(date: typings.std.Date, formatString: scala.Unit, culture: java.lang.String): scala.Unit = (typings.canvasjs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("formatDate")(date.asInstanceOf[js.Any], formatString.asInstanceOf[js.Any], culture.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def formatNumber(number: scala.Double, formatString: scala.Unit, culture: java.lang.String): java.lang.String = (typings.canvasjs.mod.^.asInstanceOf[js.Dynamic].applyDynamic("formatNumber")(number.asInstanceOf[js.Any], formatString.asInstanceOf[js.Any], culture.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
