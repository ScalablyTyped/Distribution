...
import typings.couchbase.couchbaseMod.SearchFacetNs.DateFacet
import typings.couchbase.couchbaseMod.SearchFacetNs.NumericFacet
import typings.couchbase.couchbaseMod.SearchFacetNs.TermFacet
