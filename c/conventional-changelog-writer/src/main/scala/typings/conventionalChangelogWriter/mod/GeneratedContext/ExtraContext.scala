...
object ExtraContext {
  ...
  @scala.inline
  implicit class ExtraContextOps[Self <: ExtraContext[_], /* <: typings.conventionalCommitsParser.mod.Commit[java.lang.String | scala.Double | js.Symbol] */ T] (val x: Self with ExtraContext[T]) extends AnyVal {
    @scala.inline
