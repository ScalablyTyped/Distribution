...
object Equation {
  ...
  extension [Self <: Equation](x: Self) {
    ...
    inline def setComputeC(value: () => Double): Self = StObject.set(x, "computeC", js.Any.fromFunction0(value))
    
    inline def setComputeGW(value: () => Double): Self = StObject.set(x, "computeGW", js.Any.fromFunction0(value))
    
    inline def setComputeGWlamda(value: () => Double): Self = StObject.set(x, "computeGWlamda", js.Any.fromFunction0(value))
    
    inline def setComputeGiMGt(value: () => Double): Self = StObject.set(x, "computeGiMGt", js.Any.fromFunction0(value))
    
    inline def setComputeGiMf(value: () => Double): Self = StObject.set(x, "computeGiMf", js.Any.fromFunction0(value))
    
    inline def setComputeGq(value: () => Double): Self = StObject.set(x, "computeGq", js.Any.fromFunction0(value))
    ...
    inline def setSetSpookParams(value: (Double, Double, Double) => Unit): Self = StObject.set(x, "setSpookParams", js.Any.fromFunction3(value))
  }
}
