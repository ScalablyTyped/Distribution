...
object anon {
  ...
  object ALLMEDIA {
    ...
    @scala.inline
    implicit class ALLMEDIAMutableBuilder[Self <: ALLMEDIA] (val x: Self) extends AnyVal {
  ...
  object ARROWANY {
    ...
    @scala.inline
    implicit class ARROWANYMutableBuilder[Self <: ARROWANY] (val x: Self) extends AnyVal {
