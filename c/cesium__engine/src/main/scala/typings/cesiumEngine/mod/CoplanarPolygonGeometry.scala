...
import typings.cesiumEngine.anon.Positions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "CoplanarPolygonGeometry")
@js.native
open class CoplanarPolygonGeometry protected () extends StObject {
  def this(options: typings.cesiumEngine.anon.PolygonHierarchy) = this()
...
/* static members */
object CoplanarPolygonGeometry {
