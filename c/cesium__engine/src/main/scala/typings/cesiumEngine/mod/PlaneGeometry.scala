...
@JSImport("@cesium/engine", "PlaneGeometry")
@js.native
open class PlaneGeometry () extends StObject {
  def this(options: typings.cesiumEngine.anon.VertexFormat) = this()
}
/* static members */
object PlaneGeometry {
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "PlaneGeometry.packedLength")
  @js.native
