...
object RequestScheduler {
  ...
  @JSImport("@cesium/engine", "RequestScheduler")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "RequestScheduler.maximumRequests")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "RequestScheduler.maximumRequestsPerServer")
  @js.native
  ...
  /**
    ...
    * };
    */
  @JSImport("@cesium/engine", "RequestScheduler.requestsByServer")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "RequestScheduler.throttleRequests")
  @js.native
