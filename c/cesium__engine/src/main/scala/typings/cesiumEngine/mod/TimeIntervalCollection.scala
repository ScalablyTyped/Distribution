...
import typings.cesiumEngine.anon.DataCallback
import typings.cesiumEngine.anon.Epoch
import typings.cesiumEngine.anon.Iso8601Dates
import typings.cesiumEngine.anon.Start
import typings.cesiumEngine.mod.TimeInterval.DataComparer
import typings.cesiumEngine.mod.TimeInterval.MergeCallback
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "TimeIntervalCollection")
@js.native
...
object TimeIntervalCollection {
  ...
  /**
    ...
    */
  inline def fromIso8601(options: typings.cesiumEngine.anon.Iso8601): TimeIntervalCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("fromIso8601")(options.asInstanceOf[js.Any]).asInstanceOf[TimeIntervalCollection]
  inline def fromIso8601(options: typings.cesiumEngine.anon.Iso8601, result: TimeIntervalCollection): TimeIntervalCollection = (^.asInstanceOf[js.Dynamic].applyDynamic("fromIso8601")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[TimeIntervalCollection]
