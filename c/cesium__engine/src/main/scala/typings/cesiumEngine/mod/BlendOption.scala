...
@JSImport("@cesium/engine", "BlendOption")
@js.native
object BlendOption extends StObject {
  ...
  sealed trait OPAQUE
    extends StObject
       with BlendOption
  /* 0 */ val OPAQUE: typings.cesiumEngine.mod.BlendOption.OPAQUE & Double = js.native
  ...
  sealed trait OPAQUE_AND_TRANSLUCENT
    extends StObject
       with BlendOption
  /* 2 */ val OPAQUE_AND_TRANSLUCENT: typings.cesiumEngine.mod.BlendOption.OPAQUE_AND_TRANSLUCENT & Double = js.native
  ...
  sealed trait TRANSLUCENT
    extends StObject
       with BlendOption
  /* 1 */ val TRANSLUCENT: typings.cesiumEngine.mod.BlendOption.TRANSLUCENT & Double = js.native
}
