...
import typings.cesiumEngine.mod.I3SDataProvider.ConstructorOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "I3SDataProvider")
@js.native
...
object I3SDataProvider {
  ...
  trait ConstructorOptions extends StObject {
    ...
    var cesium3dTilesetOptions: js.UndefOr[typings.cesiumEngine.mod.Cesium3DTileset.ConstructorOptions] = js.undefined
  ...
  object ConstructorOptions {
    ...
    implicit open class MutableBuilder[Self <: ConstructorOptions] (val x: Self) extends AnyVal {
      ...
      inline def setCesium3dTilesetOptions(value: typings.cesiumEngine.mod.Cesium3DTileset.ConstructorOptions): Self = StObject.set(x, "cesium3dTilesetOptions", value.asInstanceOf[js.Any])
