...
@JSImport("@cesium/engine", "CustomShaderTranslucencyMode")
@js.native
object CustomShaderTranslucencyMode extends StObject {
  ...
  /* 0 */ val INHERIT: typings.cesiumEngine.mod.CustomShaderTranslucencyMode.INHERIT & Double = js.native
  ...
  sealed trait OPAQUE
    extends StObject
       with CustomShaderTranslucencyMode
  /* 1 */ val OPAQUE: typings.cesiumEngine.mod.CustomShaderTranslucencyMode.OPAQUE & Double = js.native
  ...
  sealed trait TRANSLUCENT
    extends StObject
       with CustomShaderTranslucencyMode
  /* 2 */ val TRANSLUCENT: typings.cesiumEngine.mod.CustomShaderTranslucencyMode.TRANSLUCENT & Double = js.native
}
