...
@JSImport("@cesium/engine", "EllipsoidTerrainProvider")
@js.native
open class EllipsoidTerrainProvider () extends StObject {
  def this(options: typings.cesiumEngine.anon.TilingScheme) = this()
