...
object Plane {
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "Plane.ORIGIN_XY_PLANE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "Plane.ORIGIN_YZ_PLANE")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "Plane.ORIGIN_ZX_PLANE")
  @js.native
