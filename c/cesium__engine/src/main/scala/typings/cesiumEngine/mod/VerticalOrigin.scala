...
@JSImport("@cesium/engine", "VerticalOrigin")
@js.native
object VerticalOrigin extends StObject {
  ...
  sealed trait BASELINE
    extends StObject
       with VerticalOrigin
  /* 2 */ val BASELINE: typings.cesiumEngine.mod.VerticalOrigin.BASELINE & Double = js.native
  ...
  sealed trait BOTTOM
    extends StObject
       with VerticalOrigin
  /* 1 */ val BOTTOM: typings.cesiumEngine.mod.VerticalOrigin.BOTTOM & Double = js.native
  ...
  sealed trait CENTER
    extends StObject
       with VerticalOrigin
  /* 0 */ val CENTER: typings.cesiumEngine.mod.VerticalOrigin.CENTER & Double = js.native
  ...
  sealed trait TOP
    extends StObject
       with VerticalOrigin
  /* -1 */ val TOP: typings.cesiumEngine.mod.VerticalOrigin.TOP & Double = js.native
}
