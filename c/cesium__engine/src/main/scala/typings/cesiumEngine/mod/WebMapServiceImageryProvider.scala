...
import typings.cesiumEngine.mod.WebMapServiceImageryProvider.ConstructorOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "WebMapServiceImageryProvider")
@js.native
...
object WebMapServiceImageryProvider {
  ...
  /**
    ...
    *    format=image/jpeg
    */
  @JSImport("@cesium/engine", "WebMapServiceImageryProvider.DefaultParameters")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "WebMapServiceImageryProvider.GetFeatureInfoDefaultParameters")
  @js.native
