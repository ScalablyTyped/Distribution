...
import typings.cesiumEngine.cesiumEngineStrings.`high-performance`
import typings.cesiumEngine.cesiumEngineStrings.`low-power`
import typings.cesiumEngine.cesiumEngineStrings.default
