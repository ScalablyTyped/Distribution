...
import typings.cesiumEngine.anon.EllipsoidGranularity
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "RectangleGeometry")
@js.native
open class RectangleGeometry protected () extends StObject {
  def this(options: typings.cesiumEngine.anon.Rectangle) = this()
}
/* static members */
object RectangleGeometry {
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "RectangleGeometry.packedLength")
  @js.native
