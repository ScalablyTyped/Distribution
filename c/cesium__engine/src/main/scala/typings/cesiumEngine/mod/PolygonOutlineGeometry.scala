...
import typings.cesiumEngine.anon.EllipsoidExtrudedHeight
import typings.cesiumEngine.anon.PerPositionHeight
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "PolygonOutlineGeometry")
@js.native
