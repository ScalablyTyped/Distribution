...
@JSImport("@cesium/engine", "SplitDirection")
@js.native
object SplitDirection extends StObject {
  ...
  sealed trait LEFT
    extends StObject
       with SplitDirection
  /* -1 */ val LEFT: typings.cesiumEngine.mod.SplitDirection.LEFT & Double = js.native
  ...
  sealed trait NONE
    extends StObject
       with SplitDirection
  /* 0 */ val NONE: typings.cesiumEngine.mod.SplitDirection.NONE & Double = js.native
  ...
  sealed trait RIGHT
    extends StObject
       with SplitDirection
  /* 1 */ val RIGHT: typings.cesiumEngine.mod.SplitDirection.RIGHT & Double = js.native
}
