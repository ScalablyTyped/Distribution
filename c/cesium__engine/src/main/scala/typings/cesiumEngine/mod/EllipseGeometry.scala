...
import typings.cesiumEngine.anon.Granularity
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "EllipseGeometry")
@js.native
...
object EllipseGeometry {
  ...
  /**
    ...
    */
  inline def computeRectangle(options: typings.cesiumEngine.anon.Rotation): Rectangle = ^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any]).asInstanceOf[Rectangle]
  inline def computeRectangle(options: typings.cesiumEngine.anon.Rotation, result: Rectangle): Rectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("computeRectangle")(options.asInstanceOf[js.Any], result.asInstanceOf[js.Any])).asInstanceOf[Rectangle]
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "EllipseGeometry.packedLength")
  @js.native
