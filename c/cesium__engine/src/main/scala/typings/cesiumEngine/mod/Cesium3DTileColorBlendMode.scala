...
@JSImport("@cesium/engine", "Cesium3DTileColorBlendMode")
@js.native
object Cesium3DTileColorBlendMode extends StObject {
  ...
  /* 0 */ val HIGHLIGHT: typings.cesiumEngine.mod.Cesium3DTileColorBlendMode.HIGHLIGHT & Double = js.native
  ...
  sealed trait MIX
    extends StObject
       with Cesium3DTileColorBlendMode
  /* 2 */ val MIX: typings.cesiumEngine.mod.Cesium3DTileColorBlendMode.MIX & Double = js.native
  ...
  sealed trait REPLACE
    extends StObject
       with Cesium3DTileColorBlendMode
  /* 1 */ val REPLACE: typings.cesiumEngine.mod.Cesium3DTileColorBlendMode.REPLACE & Double = js.native
}
