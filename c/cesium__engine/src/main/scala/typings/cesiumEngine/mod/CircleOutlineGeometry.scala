...
@JSImport("@cesium/engine", "CircleOutlineGeometry")
@js.native
open class CircleOutlineGeometry protected () extends StObject {
  def this(options: typings.cesiumEngine.anon.Ellipsoid) = this()
}
/* static members */
object CircleOutlineGeometry {
  ...
  /**
    ...
    */
  @JSImport("@cesium/engine", "CircleOutlineGeometry.packedLength")
  @js.native
