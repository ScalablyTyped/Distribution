...
@JSImport("@cesium/engine", "CameraEventType")
@js.native
object CameraEventType extends StObject {
  ...
  /* 0 */ val LEFT_DRAG: typings.cesiumEngine.mod.CameraEventType.LEFT_DRAG & Double = js.native
  ...
  sealed trait MIDDLE_DRAG
    extends StObject
       with CameraEventType
  /* 2 */ val MIDDLE_DRAG: typings.cesiumEngine.mod.CameraEventType.MIDDLE_DRAG & Double = js.native
  ...
  sealed trait PINCH
    extends StObject
       with CameraEventType
  /* 4 */ val PINCH: typings.cesiumEngine.mod.CameraEventType.PINCH & Double = js.native
  ...
  sealed trait RIGHT_DRAG
    extends StObject
       with CameraEventType
  /* 1 */ val RIGHT_DRAG: typings.cesiumEngine.mod.CameraEventType.RIGHT_DRAG & Double = js.native
  ...
  sealed trait WHEEL
    extends StObject
       with CameraEventType
  /* 3 */ val WHEEL: typings.cesiumEngine.mod.CameraEventType.WHEEL & Double = js.native
}
