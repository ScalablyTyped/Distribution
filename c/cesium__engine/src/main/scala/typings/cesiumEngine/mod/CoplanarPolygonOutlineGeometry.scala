...
import typings.cesiumEngine.anon.PolygonHierarchyPolygonHierarchy
import typings.cesiumEngine.anon.PositionsArray
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@cesium/engine", "CoplanarPolygonOutlineGeometry")
@js.native
