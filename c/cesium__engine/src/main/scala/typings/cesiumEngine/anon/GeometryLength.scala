...
trait GeometryLength extends StObject {
  ...
  var geometry: typings.cesiumEngine.mod.Geometry
...
object GeometryLength {
  ...
  inline def apply(geometry: typings.cesiumEngine.mod.Geometry): GeometryLength = {
  ...
  implicit open class MutableBuilder[Self <: GeometryLength] (val x: Self) extends AnyVal {
    ...
    inline def setGeometry(value: typings.cesiumEngine.mod.Geometry): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
