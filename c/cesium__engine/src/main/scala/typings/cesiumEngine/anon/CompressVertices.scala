...
trait CompressVertices extends StObject {
  ...
  var depthFailAppearance: js.UndefOr[typings.cesiumEngine.mod.Appearance] = js.undefined
...
object CompressVertices {
  ...
  implicit open class MutableBuilder[Self <: CompressVertices] (val x: Self) extends AnyVal {
    ...
    inline def setDepthFailAppearance(value: typings.cesiumEngine.mod.Appearance): Self = StObject.set(x, "depthFailAppearance", value.asInstanceOf[js.Any])
