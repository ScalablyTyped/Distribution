...
trait OutlineColor extends StObject {
  ...
  var color: js.UndefOr[Property | typings.cesiumEngine.mod.Color] = js.undefined
  
  var outlineColor: js.UndefOr[Property | typings.cesiumEngine.mod.Color] = js.undefined
...
object OutlineColor {
  ...
  implicit open class MutableBuilder[Self <: OutlineColor] (val x: Self) extends AnyVal {
    ...
    inline def setColor(value: Property | typings.cesiumEngine.mod.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    inline def setOutlineColor(value: Property | typings.cesiumEngine.mod.Color): Self = StObject.set(x, "outlineColor", value.asInstanceOf[js.Any])
