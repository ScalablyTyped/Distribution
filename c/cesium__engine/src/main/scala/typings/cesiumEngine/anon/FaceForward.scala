...
trait FaceForward extends StObject {
  ...
  var materialSupport: js.UndefOr[MaterialSupportType] = js.undefined
...
object FaceForward {
  ...
  implicit open class MutableBuilder[Self <: FaceForward] (val x: Self) extends AnyVal {
    ...
    inline def setMaterialSupport(value: MaterialSupportType): Self = StObject.set(x, "materialSupport", value.asInstanceOf[js.Any])
