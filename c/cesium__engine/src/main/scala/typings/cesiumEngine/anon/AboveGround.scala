...
trait AboveGround extends StObject {
  ...
  var material: js.UndefOr[typings.cesiumEngine.mod.Material] = js.undefined
...
object AboveGround {
  ...
  implicit open class MutableBuilder[Self <: AboveGround] (val x: Self) extends AnyVal {
    ...
    inline def setMaterial(value: typings.cesiumEngine.mod.Material): Self = StObject.set(x, "material", value.asInstanceOf[js.Any])
