...
import typings.cesiumEngine.mod.CustomHeightmapTerrainProvider.GeometryCallback
...
trait Callback extends StObject {
  ...
  var tilingScheme: js.UndefOr[typings.cesiumEngine.mod.TilingScheme] = js.undefined
...
object Callback {
  ...
  implicit open class MutableBuilder[Self <: Callback] (val x: Self) extends AnyVal {
    ...
    inline def setTilingScheme(value: typings.cesiumEngine.mod.TilingScheme): Self = StObject.set(x, "tilingScheme", value.asInstanceOf[js.Any])
