...
import typings.cesiumEngine.mod.DirectionUp
import typings.cesiumEngine.mod.HeadingPitchRollValues
...
trait Convert extends StObject {
  ...
  var destination: js.UndefOr[Cartesian3 | typings.cesiumEngine.mod.Rectangle] = js.undefined
