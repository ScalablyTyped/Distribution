...
trait DebugShowBoundingVolume extends StObject {
  ...
  var blendOption: js.UndefOr[typings.cesiumEngine.mod.BlendOption] = js.undefined
...
object DebugShowBoundingVolume {
  ...
  implicit open class MutableBuilder[Self <: DebugShowBoundingVolume] (val x: Self) extends AnyVal {
    ...
    inline def setBlendOption(value: typings.cesiumEngine.mod.BlendOption): Self = StObject.set(x, "blendOption", value.asInstanceOf[js.Any])
