...
trait DashLength extends StObject {
  ...
  var gapColor: js.UndefOr[Property | typings.cesiumEngine.mod.Color] = js.undefined
}
object DashLength {
  ...
  implicit open class MutableBuilder[Self <: DashLength] (val x: Self) extends AnyVal {
    ...
    inline def setGapColor(value: Property | typings.cesiumEngine.mod.Color): Self = StObject.set(x, "gapColor", value.asInstanceOf[js.Any])
