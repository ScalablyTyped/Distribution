...
object mod {
  ...
  inline def inspect(obj: js.Any): String = ^.asInstanceOf[js.Dynamic].applyDynamic("inspect")(obj.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def putObject(level: String, `object`: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("putObject")(level.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def putObject(level: String, `object`: js.Any, rewriters: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("putObject")(level.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], rewriters.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def putObject(level: String, `object`: js.Any, rewriters: js.Any, padding: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("putObject")(level.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], rewriters.asInstanceOf[js.Any], padding.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def putObject(level: String, `object`: js.Any, rewriters: Unit, padding: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("putObject")(level.asInstanceOf[js.Any], `object`.asInstanceOf[js.Any], rewriters.asInstanceOf[js.Any], padding.asInstanceOf[js.Any])).asInstanceOf[Unit]
