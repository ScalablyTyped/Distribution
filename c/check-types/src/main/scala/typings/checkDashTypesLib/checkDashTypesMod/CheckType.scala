...
trait CheckType extends js.Object {
  ...
  def array(a: js.Any): /* is Array */scala.Boolean = js.native
  def arrayLike(a: js.Any): /* is ArrayLike */scala.Boolean = js.native
  ...
  def date(a: js.Any): /* is Date */scala.Boolean = js.native
  ...
  def iterable(a: js.Any): /* is Iterable */scala.Boolean = js.native
