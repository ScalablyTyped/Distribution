...
package object mod {
  ...
  type Overwrite[T, U] = typings.convict.convictStrings.Overwrite with org.scalablytyped.runtime.TopLevel[T] with U
  ...
  */
  ...
  {[ P in keyof T ]: / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias convict.convict.Schema<T[P]> * / object | convict.convict.SchemaObj<T[P]>}
    */ typings.convict.convictStrings.Schema with org.scalablytyped.runtime.TopLevel[T]
}
