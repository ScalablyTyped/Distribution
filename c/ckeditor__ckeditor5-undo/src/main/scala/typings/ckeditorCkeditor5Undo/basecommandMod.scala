...
object basecommandMod {
  
  @JSImport("@ckeditor/ckeditor5-undo/src/basecommand", JSImport.Default)
  @js.native
  abstract class default ()
    ...
    /* CompleteClass */
    override def addBatch(batch: typings.ckeditorCkeditor5Engine.batchMod.default): Unit = js.native
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Command * / any */ trait BaseCommand extends StObject {
    ...
    def addBatch(batch: typings.ckeditorCkeditor5Engine.batchMod.default): Unit
  ...
  object BaseCommand {
    ...
    inline def apply(
      addBatch: typings.ckeditorCkeditor5Engine.batchMod.default => Unit,
      clearStack: () => Unit,
      refresh: () => Unit
    ): BaseCommand = {
    ...
    extension [Self <: BaseCommand](x: Self) {
      ...
      inline def setAddBatch(value: typings.ckeditorCkeditor5Engine.batchMod.default => Unit): Self = StObject.set(x, "addBatch", js.Any.fromFunction1(value))
