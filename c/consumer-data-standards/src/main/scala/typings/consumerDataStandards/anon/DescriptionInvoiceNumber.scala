...
trait DescriptionInvoiceNumber
  extends StObject
...
object DescriptionInvoiceNumber {
  
  inline def apply(amount: String, description: String): DescriptionInvoiceNumber = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescriptionInvoiceNumber]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescriptionInvoiceNumber] (val x: Self) extends AnyVal {
