...
object PlanType {
  ...
  inline def apply(planType: METERED | UNMETERED | LIMITED | UNSUPPORTED): PlanType = {
    val __obj = js.Dynamic.literal(planType = planType.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlanType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlanType] (val x: Self) extends AnyVal {
