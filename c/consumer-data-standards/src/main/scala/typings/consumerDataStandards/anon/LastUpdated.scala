...
object LastUpdated {
  ...
  inline def apply(plans: js.Array[BillingType]): LastUpdated = {
    val __obj = js.Dynamic.literal(plans = plans.asInstanceOf[js.Any])
    __obj.asInstanceOf[LastUpdated]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LastUpdated] (val x: Self) extends AnyVal {
