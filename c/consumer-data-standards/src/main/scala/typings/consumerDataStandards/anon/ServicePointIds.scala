...
trait ServicePointIds
  ...
  /**
    ...
    */
  var planDetail: js.UndefOr[FuelType] = js.undefined
...
object ServicePointIds {
  
  inline def apply(servicePointIds: js.Array[String]): ServicePointIds = {
  ...
  implicit open class MutableBuilder[Self <: ServicePointIds] (val x: Self) extends AnyVal {
    ...
    inline def setPlanDetail(value: FuelType): Self = StObject.set(x, "planDetail", value.asInstanceOf[js.Any])
