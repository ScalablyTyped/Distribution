...
object ServiceIds {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(billingType = billingType.asInstanceOf[js.Any], planDetail = planDetail.asInstanceOf[js.Any], planOverview = planOverview.asInstanceOf[js.Any], serviceIds = serviceIds.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[ServiceIds]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ServiceIds] (val x: Self) extends AnyVal {
