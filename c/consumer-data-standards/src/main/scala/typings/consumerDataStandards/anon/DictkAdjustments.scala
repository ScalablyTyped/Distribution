...
object DictkAdjustments {
  
  inline def apply(amount: String, endDate: String, startDate: String): DictkAdjustments = {
    ...
    __obj.asInstanceOf[DictkAdjustments]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DictkAdjustments] (val x: Self) extends AnyVal {
