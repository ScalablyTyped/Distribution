...
object Roaming {
  ...
  inline def apply(amount: String, download: Double, upload: Double): Roaming = {
    ...
    __obj.asInstanceOf[Roaming]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Roaming] (val x: Self) extends AnyVal {
