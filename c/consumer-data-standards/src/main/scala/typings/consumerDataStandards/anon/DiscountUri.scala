...
object DiscountUri {
  ...
  inline def apply(displayName: String): DiscountUri = {
    val __obj = js.Dynamic.literal(displayName = displayName.asInstanceOf[js.Any])
    __obj.asInstanceOf[DiscountUri]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DiscountUri] (val x: Self) extends AnyVal {
