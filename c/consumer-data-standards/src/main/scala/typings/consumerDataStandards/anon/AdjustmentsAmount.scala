...
object AdjustmentsAmount {
  
  inline def apply(amount: String, description: String): AdjustmentsAmount = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any])
    __obj.asInstanceOf[AdjustmentsAmount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AdjustmentsAmount] (val x: Self) extends AnyVal {
