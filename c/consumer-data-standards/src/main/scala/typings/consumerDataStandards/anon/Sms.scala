...
object Sms {
  ...
  inline def apply(mms: DescriptionInternational, sms: DescriptionInternational): Sms = {
    val __obj = js.Dynamic.literal(mms = mms.asInstanceOf[js.Any], sms = sms.asInstanceOf[js.Any])
    __obj.asInstanceOf[Sms]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Sms] (val x: Self) extends AnyVal {
