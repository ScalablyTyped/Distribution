...
object AdditionalInfoUri {
  
  inline def apply(minimumValue: Double, name: String, unitOfMeasure: DAY | DOLLAR | MONTH | PERCENT): AdditionalInfoUri = {
    ...
    __obj.asInstanceOf[AdditionalInfoUri]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AdditionalInfoUri] (val x: Self) extends AnyVal {
