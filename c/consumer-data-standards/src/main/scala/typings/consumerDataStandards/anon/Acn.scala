...
object Acn {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(agentLastName = agentLastName.asInstanceOf[js.Any], agentRole = agentRole.asInstanceOf[js.Any], businessName = businessName.asInstanceOf[js.Any], organisationType = organisationType.asInstanceOf[js.Any])
    __obj.asInstanceOf[Acn]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Acn] (val x: Self) extends AnyVal {
