...
object IntervalReads {
  
  inline def apply(aggregateValue: Double): IntervalReads = {
    val __obj = js.Dynamic.literal(aggregateValue = aggregateValue.asInstanceOf[js.Any])
    __obj.asInstanceOf[IntervalReads]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IntervalReads] (val x: Self) extends AnyVal {
