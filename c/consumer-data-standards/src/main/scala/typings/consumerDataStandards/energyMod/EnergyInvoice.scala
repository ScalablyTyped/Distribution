...
import typings.consumerDataStandards.anon.OtherCharges
import typings.consumerDataStandards.anon.StartDate
import typings.consumerDataStandards.anon.TotalCharges
...
object EnergyInvoice {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyInvoice] (val x: Self) extends AnyVal {
