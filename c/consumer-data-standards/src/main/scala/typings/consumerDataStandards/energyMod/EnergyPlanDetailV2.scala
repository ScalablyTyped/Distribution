...
trait EnergyPlanDetailV2
  ...
  /**
    ...
    */
  var electricityContract: js.UndefOr[EnergyPlanContractFullV2] = js.undefined
  
  /**
    * The details of the terms for the supply of electricity under this plan.  Is mandatory if fuelType is set to GAS or DUAL
    */
  var gasContract: js.UndefOr[EnergyPlanContractFullV2] = js.undefined
...
object EnergyPlanDetailV2 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnergyPlanDetailV2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyPlanDetailV2] (val x: Self) extends AnyVal {
    
    inline def setElectricityContract(value: EnergyPlanContractFullV2): Self = StObject.set(x, "electricityContract", value.asInstanceOf[js.Any])
    
    inline def setElectricityContractUndefined: Self = StObject.set(x, "electricityContract", js.undefined)
    
    inline def setGasContract(value: EnergyPlanContractFullV2): Self = StObject.set(x, "gasContract", value.asInstanceOf[js.Any])
