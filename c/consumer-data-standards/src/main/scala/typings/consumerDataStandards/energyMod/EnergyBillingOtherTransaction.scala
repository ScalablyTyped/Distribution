...
trait EnergyBillingOtherTransaction
  extends StObject
...
object EnergyBillingOtherTransaction {
  
  inline def apply(amount: String, description: String): EnergyBillingOtherTransaction = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any])
    __obj.asInstanceOf[EnergyBillingOtherTransaction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyBillingOtherTransaction] (val x: Self) extends AnyVal {
