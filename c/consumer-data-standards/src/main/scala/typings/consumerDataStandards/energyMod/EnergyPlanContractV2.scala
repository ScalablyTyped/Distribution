...
trait EnergyPlanContractV2
  ...
  /**
    ...
    */
  var solarFeedInTariff: js.UndefOr[js.Array[EnergyPlanSolarFeedInTariffV2]] = js.undefined
...
object EnergyPlanContractV2 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[EnergyPlanContractV2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyPlanContractV2] (val x: Self) extends AnyVal {
    ...
    inline def setSolarFeedInTariff(value: js.Array[EnergyPlanSolarFeedInTariffV2]): Self = StObject.set(x, "solarFeedInTariff", value.asInstanceOf[js.Any])
    
    inline def setSolarFeedInTariffUndefined: Self = StObject.set(x, "solarFeedInTariff", js.undefined)
    
    inline def setSolarFeedInTariffVarargs(value: EnergyPlanSolarFeedInTariffV2*): Self = StObject.set(x, "solarFeedInTariff", js.Array(value*))
