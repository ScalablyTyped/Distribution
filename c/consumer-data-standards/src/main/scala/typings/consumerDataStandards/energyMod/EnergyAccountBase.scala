...
object EnergyAccountBase {
  
  inline def apply(accountId: String, creationDate: String): EnergyAccountBase = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], creationDate = creationDate.asInstanceOf[js.Any])
    __obj.asInstanceOf[EnergyAccountBase]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyAccountBase] (val x: Self) extends AnyVal {
