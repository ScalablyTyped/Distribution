...
import typings.consumerDataStandards.anon.ChargePeriod
import typings.consumerDataStandards.anon.GeneralUnitPrice
import typings.consumerDataStandards.anon.TimeOfUse
...
object EnergyPlanTariffPeriod {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EnergyPlanTariffPeriod] (val x: Self) extends AnyVal {
