...
import typings.consumerDataStandards.anon.DescriptionDuration
...
trait TelcoServiceBalanceVoice
  extends StObject
...
object TelcoServiceBalanceVoice {
  
  inline def apply(planType: METERED | UNMETERED | LIMITED | UNSUPPORTED): TelcoServiceBalanceVoice = {
    val __obj = js.Dynamic.literal(planType = planType.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoServiceBalanceVoice]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoServiceBalanceVoice] (val x: Self) extends AnyVal {
