...
trait TelcoServiceBalanceVoiceInternational
  extends StObject
...
object TelcoServiceBalanceVoiceInternational {
  
  inline def apply(): TelcoServiceBalanceVoiceInternational = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TelcoServiceBalanceVoiceInternational]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoServiceBalanceVoiceInternational] (val x: Self) extends AnyVal {
