...
trait TelcoAccountDetailResponseData
  extends StObject
...
object TelcoAccountDetailResponseData {
  
  inline def apply(plans: js.Array[BillingType]): TelcoAccountDetailResponseData = {
    val __obj = js.Dynamic.literal(plans = plans.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoAccountDetailResponseData]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoAccountDetailResponseData] (val x: Self) extends AnyVal {
