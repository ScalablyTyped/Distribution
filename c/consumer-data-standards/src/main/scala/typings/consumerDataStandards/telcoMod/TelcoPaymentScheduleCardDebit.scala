...
trait TelcoPaymentScheduleCardDebit
  extends StObject
...
object TelcoPaymentScheduleCardDebit {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TelcoPaymentScheduleCardDebit]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoPaymentScheduleCardDebit] (val x: Self) extends AnyVal {
