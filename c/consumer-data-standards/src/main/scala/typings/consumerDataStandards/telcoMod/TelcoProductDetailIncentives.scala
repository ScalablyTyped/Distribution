...
trait TelcoProductDetailIncentives
  extends StObject
...
object TelcoProductDetailIncentives {
  
  inline def apply(displayName: String): TelcoProductDetailIncentives = {
    val __obj = js.Dynamic.literal(displayName = displayName.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoProductDetailIncentives]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoProductDetailIncentives] (val x: Self) extends AnyVal {
