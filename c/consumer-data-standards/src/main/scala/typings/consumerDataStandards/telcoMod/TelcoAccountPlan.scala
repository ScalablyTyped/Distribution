...
import typings.consumerDataStandards.anon.DictkDisplayName
...
object TelcoAccountPlan {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TelcoAccountPlan]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoAccountPlan] (val x: Self) extends AnyVal {
