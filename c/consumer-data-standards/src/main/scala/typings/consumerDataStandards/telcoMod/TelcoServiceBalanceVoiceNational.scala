...
trait TelcoServiceBalanceVoiceNational
  extends StObject
...
object TelcoServiceBalanceVoiceNational {
  
  inline def apply(): TelcoServiceBalanceVoiceNational = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TelcoServiceBalanceVoiceNational]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoServiceBalanceVoiceNational] (val x: Self) extends AnyVal {
