...
trait TelcoServiceBalanceVoiceRoaming
  extends StObject
...
object TelcoServiceBalanceVoiceRoaming {
  
  inline def apply(): TelcoServiceBalanceVoiceRoaming = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TelcoServiceBalanceVoiceRoaming]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoServiceBalanceVoiceRoaming] (val x: Self) extends AnyVal {
