...
import typings.consumerDataStandards.anon.DictkAmountDescription
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TelcoInvoiceAccountCharges
  extends StObject
...
object TelcoInvoiceAccountCharges {
  
  inline def apply(totalDiscounts: String, totalOnceOffCharges: String, totalUsageCharges: String): TelcoInvoiceAccountCharges = {
    ...
    __obj.asInstanceOf[TelcoInvoiceAccountCharges]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoInvoiceAccountCharges] (val x: Self) extends AnyVal {
