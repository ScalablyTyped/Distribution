...
object TelcoContract {
  
  inline def apply(duration: Double, name: String): TelcoContract = {
    val __obj = js.Dynamic.literal(duration = duration.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoContract]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoContract] (val x: Self) extends AnyVal {
