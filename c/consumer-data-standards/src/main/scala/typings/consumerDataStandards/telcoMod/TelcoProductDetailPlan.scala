...
object TelcoProductDetailPlan {
  
  inline def apply(displayName: String): TelcoProductDetailPlan = {
    val __obj = js.Dynamic.literal(displayName = displayName.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoProductDetailPlan]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoProductDetailPlan] (val x: Self) extends AnyVal {
