...
object TelcoAccountBase {
  
  inline def apply(): TelcoAccountBase = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TelcoAccountBase]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoAccountBase] (val x: Self) extends AnyVal {
