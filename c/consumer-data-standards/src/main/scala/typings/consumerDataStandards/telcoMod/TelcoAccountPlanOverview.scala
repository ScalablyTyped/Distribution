...
trait TelcoAccountPlanOverview
  extends StObject
...
object TelcoAccountPlanOverview {
  
  inline def apply(startDate: String): TelcoAccountPlanOverview = {
    val __obj = js.Dynamic.literal(startDate = startDate.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoAccountPlanOverview]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoAccountPlanOverview] (val x: Self) extends AnyVal {
