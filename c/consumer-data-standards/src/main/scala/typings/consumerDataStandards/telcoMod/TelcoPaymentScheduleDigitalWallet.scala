...
trait TelcoPaymentScheduleDigitalWallet
  extends StObject
...
object TelcoPaymentScheduleDigitalWallet {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TelcoPaymentScheduleDigitalWallet]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoPaymentScheduleDigitalWallet] (val x: Self) extends AnyVal {
