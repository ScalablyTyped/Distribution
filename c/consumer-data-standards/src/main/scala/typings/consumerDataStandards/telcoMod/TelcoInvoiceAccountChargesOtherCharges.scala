...
trait TelcoInvoiceAccountChargesOtherCharges
  extends StObject
...
object TelcoInvoiceAccountChargesOtherCharges {
  
  inline def apply(amount: String, description: String): TelcoInvoiceAccountChargesOtherCharges = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoInvoiceAccountChargesOtherCharges]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoInvoiceAccountChargesOtherCharges] (val x: Self) extends AnyVal {
