...
import typings.consumerDataStandards.anon.AdjustmentsAmount
import typings.consumerDataStandards.anon.AmountMethod
import typings.consumerDataStandards.anon.DescriptionInvoiceNumber
import typings.consumerDataStandards.anon.DictkAdjustments
...
object TelcoBillingTransaction {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[TelcoBillingTransaction]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoBillingTransaction] (val x: Self) extends AnyVal {
