...
object TelcoUsageMessagingMms {
  
  inline def apply(amount: String, national: Double): TelcoUsageMessagingMms = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], national = national.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoUsageMessagingMms]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoUsageMessagingMms] (val x: Self) extends AnyVal {
