...
trait TelcoProductDetailFeature
  extends StObject
...
object TelcoProductDetailFeature {
  
  inline def apply(displayName: String): TelcoProductDetailFeature = {
    val __obj = js.Dynamic.literal(displayName = displayName.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoProductDetailFeature]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoProductDetailFeature] (val x: Self) extends AnyVal {
