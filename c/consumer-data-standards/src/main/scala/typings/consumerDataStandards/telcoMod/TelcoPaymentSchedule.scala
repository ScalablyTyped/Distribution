...
object TelcoPaymentSchedule {
  
  inline def apply(paymentScheduleUType: cardDebit | directDebit | manualPayment | digitalWallet): TelcoPaymentSchedule = {
    val __obj = js.Dynamic.literal(paymentScheduleUType = paymentScheduleUType.asInstanceOf[js.Any])
    __obj.asInstanceOf[TelcoPaymentSchedule]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoPaymentSchedule] (val x: Self) extends AnyVal {
