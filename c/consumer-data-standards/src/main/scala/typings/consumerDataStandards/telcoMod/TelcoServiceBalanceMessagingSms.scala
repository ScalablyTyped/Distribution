...
trait TelcoServiceBalanceMessagingSms
  extends StObject
...
object TelcoServiceBalanceMessagingSms {
  
  inline def apply(): TelcoServiceBalanceMessagingSms = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TelcoServiceBalanceMessagingSms]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TelcoServiceBalanceMessagingSms] (val x: Self) extends AnyVal {
