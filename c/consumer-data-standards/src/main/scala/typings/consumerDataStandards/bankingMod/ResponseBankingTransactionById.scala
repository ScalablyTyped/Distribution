...
import typings.consumerDataStandards.anon.ApcaNumber
import typings.consumerDataStandards.anon.Self
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResponseBankingTransactionById
  extends StObject
...
object ResponseBankingTransactionById {
  
  inline def apply(data: ApcaNumber, links: Self): ResponseBankingTransactionById = {
