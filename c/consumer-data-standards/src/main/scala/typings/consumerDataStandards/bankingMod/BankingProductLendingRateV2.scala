...
import typings.consumerDataStandards.anon.AdditionalInfoUri
...
trait BankingProductLendingRateV2
  extends StObject
...
object BankingProductLendingRateV2 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BankingProductLendingRateV2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingProductLendingRateV2] (val x: Self) extends AnyVal {
