...
import typings.consumerDataStandards.anon.DiscountEligibilityType
...
object BankingProductDiscount {
  
  inline def apply(description: String, discountType: BALANCE | DEPOSITS | ELIGIBILITY_ONLY | FEE_CAP | PAYMENTS): BankingProductDiscount = {
    val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], discountType = discountType.asInstanceOf[js.Any])
    __obj.asInstanceOf[BankingProductDiscount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingProductDiscount] (val x: Self) extends AnyVal {
