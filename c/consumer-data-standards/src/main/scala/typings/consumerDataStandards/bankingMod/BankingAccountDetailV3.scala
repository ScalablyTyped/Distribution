...
trait BankingAccountDetailV3
  ...
  /**
    ...
    */
  var addresses: js.UndefOr[js.Array[CommonPhysicalAddress]] = js.undefined
  ...
  var creditCard: js.UndefOr[BankingCreditCardAccount] = js.undefined
  ...
  /**
    ...
    */
  var depositRates: js.UndefOr[js.Array[BankingProductDepositRate]] = js.undefined
  ...
  /**
    ...
    */
  var features: js.UndefOr[js.Array[accV3DetailFeatureObj]] = js.undefined
  
  /**
    * Fees and charges applicable to the account based on the equivalent structure in Product Reference
    */
  var fees: js.UndefOr[js.Array[BankingProductFee]] = js.undefined
  ...
  /**
    * Fully described deposit rates for this account based on the equivalent structure in Product Reference
    */
  var lendingRates: js.UndefOr[js.Array[BankingProductLendingRateV2]] = js.undefined
  
  var loan: js.UndefOr[BankingLoanAccountV2] = js.undefined
  ...
  var termDeposit: js.UndefOr[js.Array[BankingTermDepositAccount]] = js.undefined
}
object BankingAccountDetailV3 {
  ...
  implicit open class MutableBuilder[Self <: BankingAccountDetailV3] (val x: Self) extends AnyVal {
    ...
    inline def setAddresses(value: js.Array[CommonPhysicalAddress]): Self = StObject.set(x, "addresses", value.asInstanceOf[js.Any])
    
    inline def setAddressesUndefined: Self = StObject.set(x, "addresses", js.undefined)
    
    inline def setAddressesVarargs(value: CommonPhysicalAddress*): Self = StObject.set(x, "addresses", js.Array(value*))
    ...
    inline def setCreditCard(value: BankingCreditCardAccount): Self = StObject.set(x, "creditCard", value.asInstanceOf[js.Any])
    ...
    inline def setDepositRates(value: js.Array[BankingProductDepositRate]): Self = StObject.set(x, "depositRates", value.asInstanceOf[js.Any])
    
    inline def setDepositRatesUndefined: Self = StObject.set(x, "depositRates", js.undefined)
    
    inline def setDepositRatesVarargs(value: BankingProductDepositRate*): Self = StObject.set(x, "depositRates", js.Array(value*))
    
    inline def setFeatures(value: js.Array[accV3DetailFeatureObj]): Self = StObject.set(x, "features", value.asInstanceOf[js.Any])
    
    inline def setFeaturesUndefined: Self = StObject.set(x, "features", js.undefined)
    
    inline def setFeaturesVarargs(value: accV3DetailFeatureObj*): Self = StObject.set(x, "features", js.Array(value*))
    
    inline def setFees(value: js.Array[BankingProductFee]): Self = StObject.set(x, "fees", value.asInstanceOf[js.Any])
    
    inline def setFeesUndefined: Self = StObject.set(x, "fees", js.undefined)
    
    inline def setFeesVarargs(value: BankingProductFee*): Self = StObject.set(x, "fees", js.Array(value*))
    ...
    inline def setLendingRates(value: js.Array[BankingProductLendingRateV2]): Self = StObject.set(x, "lendingRates", value.asInstanceOf[js.Any])
    
    inline def setLendingRatesUndefined: Self = StObject.set(x, "lendingRates", js.undefined)
    
    inline def setLendingRatesVarargs(value: BankingProductLendingRateV2*): Self = StObject.set(x, "lendingRates", js.Array(value*))
    
    inline def setLoan(value: BankingLoanAccountV2): Self = StObject.set(x, "loan", value.asInstanceOf[js.Any])
    ...
    inline def setTermDeposit(value: js.Array[BankingTermDepositAccount]): Self = StObject.set(x, "termDeposit", value.asInstanceOf[js.Any])
    
    inline def setTermDepositUndefined: Self = StObject.set(x, "termDeposit", js.undefined)
    
    inline def setTermDepositVarargs(value: BankingTermDepositAccount*): Self = StObject.set(x, "termDeposit", js.Array(value*))
  }
}
