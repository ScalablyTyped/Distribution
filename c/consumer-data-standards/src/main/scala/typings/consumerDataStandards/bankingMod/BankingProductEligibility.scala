...
trait BankingProductEligibility
  extends StObject
...
object BankingProductEligibility {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BankingProductEligibility]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingProductEligibility] (val x: Self) extends AnyVal {
