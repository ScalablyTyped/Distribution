...
import typings.consumerDataStandards.anon.Description
...
object BankingProductAdditionalInformationV2 {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingProductAdditionalInformationV2] (val x: Self) extends AnyVal {
