...
import typings.consumerDataStandards.anon.AccountId
import typings.consumerDataStandards.anon.Currency
import typings.consumerDataStandards.anon.EventBased
...
object BankingScheduledPayment {
