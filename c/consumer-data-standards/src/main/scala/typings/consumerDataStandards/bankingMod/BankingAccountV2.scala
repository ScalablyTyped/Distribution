...
object BankingAccountV2 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BankingAccountV2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingAccountV2] (val x: Self) extends AnyVal {
