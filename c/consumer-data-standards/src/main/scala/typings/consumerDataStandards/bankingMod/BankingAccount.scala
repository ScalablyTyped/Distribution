...
object BankingAccount {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[BankingAccount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BankingAccount] (val x: Self) extends AnyVal {
