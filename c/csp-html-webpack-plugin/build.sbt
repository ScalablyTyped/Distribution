...
version := "3.0-dt-20190926Z-524eb8"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "anymatch" % "1.3-dt-20190212Z-84e0a0",
  "org.scalablytyped" %%% "clean-css" % "4.2-dt-20190130Z-04cffc",
  "org.scalablytyped" %%% "html-minifier" % "3.5-dt-20190212Z-429905",
  "org.scalablytyped" %%% "html-webpack-plugin" % "3.2-dt-20190712Z-dfe9cb",
