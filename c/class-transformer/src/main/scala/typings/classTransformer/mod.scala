...
object mod {
  ...
  inline def classToClass[T](`object`: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("classToClass")(`object`.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def classToClass[T](`object`: T, options: ClassTransformOptions): T = (^.asInstanceOf[js.Dynamic].applyDynamic("classToClass")(`object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def classToClass[T](`object`: js.Array[T]): js.Array[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("classToClass")(`object`.asInstanceOf[js.Any]).asInstanceOf[js.Array[T]]
  inline def classToClass[T](`object`: js.Array[T], options: ClassTransformOptions): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToClass")(`object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  ...
  inline def classToPlain[T](`object`: T): Record[String, js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("classToPlain")(`object`.asInstanceOf[js.Any]).asInstanceOf[Record[String, js.Any]]
  inline def classToPlain[T](`object`: T, options: ClassTransformOptions): Record[String, js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToPlain")(`object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Any]]
  inline def classToPlain[T](`object`: js.Array[T]): js.Array[Record[String, js.Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("classToPlain")(`object`.asInstanceOf[js.Any]).asInstanceOf[js.Array[Record[String, js.Any]]]
  inline def classToPlain[T](`object`: js.Array[T], options: ClassTransformOptions): js.Array[Record[String, js.Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToPlain")(`object`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Record[String, js.Any]]]
  
  inline def classToPlainFromExist[T](`object`: T, plainObjects: js.Array[Record[String, js.Any]]): js.Array[Record[String, js.Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToPlainFromExist")(`object`.asInstanceOf[js.Any], plainObjects.asInstanceOf[js.Any])).asInstanceOf[js.Array[Record[String, js.Any]]]
  ...
  inline def classToPlainFromExist[T](`object`: T, plainObject: Record[String, js.Any]): Record[String, js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToPlainFromExist")(`object`.asInstanceOf[js.Any], plainObject.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Any]]
  inline def classToPlainFromExist[T](`object`: T, plainObject: Record[String, js.Any], options: ClassTransformOptions): Record[String, js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("classToPlainFromExist")(`object`.asInstanceOf[js.Any], plainObject.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Record[String, js.Any]]
  
  inline def deserialize[T](cls: ClassType[T], json: String): T = (^.asInstanceOf[js.Dynamic].applyDynamic("deserialize")(cls.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def deserialize[T](cls: ClassType[T], json: String, options: ClassTransformOptions): T = (^.asInstanceOf[js.Dynamic].applyDynamic("deserialize")(cls.asInstanceOf[js.Any], json.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def deserializeArray[T](cls: ClassType[T], json: String): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeArray")(cls.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  inline def deserializeArray[T](cls: ClassType[T], json: String, options: ClassTransformOptions): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("deserializeArray")(cls.asInstanceOf[js.Any], json.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  
  inline def plainToClass[T, V](cls: ClassType[T], plain: V): T = (^.asInstanceOf[js.Dynamic].applyDynamic("plainToClass")(cls.asInstanceOf[js.Any], plain.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def plainToClass[T, V](cls: ClassType[T], plain: V, options: ClassTransformOptions): T = (^.asInstanceOf[js.Dynamic].applyDynamic("plainToClass")(cls.asInstanceOf[js.Any], plain.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[T]
  inline def plainToClass[T, V](cls: ClassType[T], plain: js.Array[V]): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("plainToClass")(cls.asInstanceOf[js.Any], plain.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
  inline def plainToClass[T, V](cls: ClassType[T], plain: js.Array[V], options: ClassTransformOptions): js.Array[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("plainToClass")(cls.asInstanceOf[js.Any], plain.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[T]]
