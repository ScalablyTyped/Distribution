...
name := "customize-cra"
version := "1.0-dt-20220815Z-cf2637"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-bundle-analyzer" % "4.4-dt-20220815Z-f9ce05",
  "org.scalablytyped" %%% "workbox-webpack-plugin" % "5.1-dt-20211202Z-8fddbb")
