...
import typings.calidation.calidationStrings.`additions removals`
import typings.calidation.calidationStrings.`additions text`
import typings.calidation.calidationStrings.`inline`
import typings.calidation.calidationStrings.`removals additions`
import typings.calidation.calidationStrings.`removals text`
import typings.calidation.calidationStrings.`text additions`
import typings.calidation.calidationStrings.`text removals`
...
/* Inlined parent std.Omit<calidation.calidation.FormProps<T>, 'children'> */
/* Inlined parent calidation.calidation.ValidationProps<T> */
trait FormValidationProps[T /* <: js.Object */] extends StObject {
  ...
  var onSubmit: js.UndefOr[js.Function1[/* context */ FormContext[T], Unit]] = js.undefined
  ...
  var onUpdate: js.UndefOr[js.Function1[/* context */ FormContext[T], Unit]] = js.undefined
...
object FormValidationProps {
  ...
  implicit open class MutableBuilder[Self <: FormValidationProps[?], T /* <: js.Object */] (val x: Self & FormValidationProps[T]) extends AnyVal {
    ...
    inline def setOnChange(value: /* event */ ChangeEvent[HTMLFormElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    inline def setOnSubmit(value: /* context */ FormContext[T] => Unit): Self = StObject.set(x, "onSubmit", js.Any.fromFunction1(value))
    ...
    inline def setOnUpdate(value: /* context */ FormContext[T] => Unit): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1(value))
    ...
    inline def setRef(value: LegacyRef[HTMLFormElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ HTMLFormElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
