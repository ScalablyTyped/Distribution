...
trait FieldConfig extends js.Object {
  ...
  var isGreaterThan: js.UndefOr[ValueValidator[scala.Double]] = js.undefined
  var isLessThan: js.UndefOr[ValueValidator[scala.Double]] = js.undefined
...
object FieldConfig {
  ...
  def apply(
    ...
    isGreaterThan: ValueValidator[scala.Double] = null,
    isLessThan: ValueValidator[scala.Double] = null,
