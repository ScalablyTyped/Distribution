...
class TypeNotFoundException protected () extends BaseException {
  /**
    ...
    */
  def this(typeName: java.lang.String) = this()
  def this(typeName: java.lang.String, message: java.lang.String) = this()
  def this(typeName: java.lang.String, message: java.lang.String, component: java.lang.String) = this()
  /**
