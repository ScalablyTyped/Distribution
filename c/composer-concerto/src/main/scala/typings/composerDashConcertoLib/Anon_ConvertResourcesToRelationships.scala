...
trait Anon_ConvertResourcesToRelationships extends js.Object {
  var convertResourcesToRelationships: js.UndefOr[scala.Boolean] = js.undefined
  var deduplicateResources: js.UndefOr[scala.Boolean] = js.undefined
  var permitResourcesForRelationships: js.UndefOr[scala.Boolean] = js.undefined
...
object Anon_ConvertResourcesToRelationships {
  @scala.inline
  def apply(
    convertResourcesToRelationships: js.UndefOr[scala.Boolean] = js.undefined,
    deduplicateResources: js.UndefOr[scala.Boolean] = js.undefined,
    permitResourcesForRelationships: js.UndefOr[scala.Boolean] = js.undefined,
