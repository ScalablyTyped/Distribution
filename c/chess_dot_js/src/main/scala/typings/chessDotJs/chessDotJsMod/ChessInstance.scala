...
import typings.chessDotJs.Anon_B
import typings.chessDotJs.Anon_Error
import typings.chessDotJs.Anon_False
import typings.chessDotJs.Anon_FalseVerbose
import typings.chessDotJs.Anon_Maxwidth
import typings.chessDotJs.Anon_Newlinechar
import typings.chessDotJs.Anon_Sloppy
import typings.chessDotJs.Anon_Square
import typings.chessDotJs.Anon_SquareVerbose
import typings.chessDotJs.Anon_True
import typings.chessDotJs.Anon_Verbose
import typings.chessDotJs.chessDotJsStrings.b
import typings.chessDotJs.chessDotJsStrings.dark
import typings.chessDotJs.chessDotJsStrings.k
import typings.chessDotJs.chessDotJsStrings.light
...
trait ChessInstance extends js.Object {
  ...
  def history(options: Anon_FalseVerbose): js.Array[String] = js.native
  /**
    * Returns a list containing the moves of the current game.
    * Options is an optional parameter which may contain a 'verbose' flag.
    * See .moves() for a description of the verbose move fields.
    ...
    * if not passed the verbose flag.
    */
  def history(options: Anon_True): js.Array[Move] = js.native
  def history(options: Anon_Verbose): js.Array[Move | String] = js.native
  /**
  ...
  def load_pgn(pgn: String, options: Anon_Newlinechar): Boolean = js.native
  /**
  ...
  def move(move: String, options: Anon_Sloppy): Move | Null = js.native
  def move(move: ShortMove): Move | Null = js.native
  def move(move: ShortMove, options: Anon_Sloppy): Move | Null = js.native
  /**
  ...
  def moves(options: Anon_False): js.Array[String] = js.native
  /**
    * Returns a list of legal moves from the current position.
    * The function takes an optional parameter which controls the
    * single-square move generation and verbosity.
    ...
    * verbose objects.
    */
  def moves(options: Anon_Square): js.Array[Move] = js.native
  def moves(options: Anon_SquareVerbose): js.Array[Move | String] = js.native
  /**
  ...
  def pgn(options: Anon_Maxwidth): String = js.native
  /**
  ...
  /**
    ...
    */
  def validate_fen(fen: String): Anon_Error = js.native
}
