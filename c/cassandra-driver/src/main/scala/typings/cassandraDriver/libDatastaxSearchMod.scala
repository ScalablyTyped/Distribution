...
object libDatastaxSearchMod {
  ...
  object search {
    ...
    object dateRangePrecision extends StObject {
      ...
      /* 1 */ val day: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.day & Double = js.native
      
      @js.native
      sealed trait hour
        extends StObject
           with dateRangePrecision
      /* 2 */ val hour: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.hour & Double = js.native
      
      @js.native
      sealed trait millisecond
        extends StObject
           with dateRangePrecision
      /* 5 */ val millisecond: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.millisecond & Double = js.native
      
      @js.native
      sealed trait minute
        extends StObject
           with dateRangePrecision
      /* 3 */ val minute: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.minute & Double = js.native
      
      @js.native
      sealed trait month
        extends StObject
           with dateRangePrecision
      /* 0 */ val month: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.month & Double = js.native
      
      @js.native
      sealed trait second
        extends StObject
           with dateRangePrecision
      /* 4 */ val second: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.second & Double = js.native
      
      @js.native
      sealed trait year
        extends StObject
           with dateRangePrecision
      /* 0 */ val year: typings.cassandraDriver.libDatastaxSearchMod.search.dateRangePrecision.year & Double = js.native
    }
  }
}
