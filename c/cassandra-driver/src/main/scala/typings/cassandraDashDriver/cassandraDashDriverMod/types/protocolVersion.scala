...
object protocolVersion extends js.Object {
  /* 0x41 */ val dseV1: typings.cassandraDashDriver.libTypesMod.types.protocolVersion.dseV1 with Double = js.native
  /* 0x42 */ val dseV2: typings.cassandraDashDriver.libTypesMod.types.protocolVersion.dseV2 with Double = js.native
  /* 0x42 */ val maxSupported: typings.cassandraDashDriver.libTypesMod.types.protocolVersion.maxSupported with Double = js.native
