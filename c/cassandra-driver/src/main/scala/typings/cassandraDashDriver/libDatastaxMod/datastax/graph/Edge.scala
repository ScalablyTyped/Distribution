...
trait Edge
  ...
  var inV: js.UndefOr[typings.cassandraDashDriver.libDatastaxGraphMod.graph.Vertex] = js.undefined
  var inVLabel: js.UndefOr[String] = js.undefined
  var outV: js.UndefOr[typings.cassandraDashDriver.libDatastaxGraphMod.graph.Vertex] = js.undefined
...
object Edge {
  ...
  def apply(
    id: js.Any,
    label: String,
    inV: typings.cassandraDashDriver.libDatastaxGraphMod.graph.Vertex = null,
    inVLabel: String = null,
    outV: typings.cassandraDashDriver.libDatastaxGraphMod.graph.Vertex = null,
