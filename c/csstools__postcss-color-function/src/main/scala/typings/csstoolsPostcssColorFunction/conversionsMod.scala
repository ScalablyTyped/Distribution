...
object conversionsMod {
  ...
  @JSImport("@csstools/postcss-color-function/dist/css-color-4/conversions", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@csstools/postcss-color-function/dist/css-color-4/conversions", "D50")
  @js.native
  ...
  @JSImport("@csstools/postcss-color-function/dist/css-color-4/conversions", "D65")
  @js.native
