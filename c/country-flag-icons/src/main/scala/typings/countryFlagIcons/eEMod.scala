...
object eEMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/EE", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `eEMod.foo` */
