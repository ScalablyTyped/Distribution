...
object mEMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/ME", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `mEMod.foo` */
