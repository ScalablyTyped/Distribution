...
object react3x2EUMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/EU", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2EUMod.foo` */
