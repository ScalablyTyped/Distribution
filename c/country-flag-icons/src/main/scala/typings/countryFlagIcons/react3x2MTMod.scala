...
object react3x2MTMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/MT", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2MTMod.foo` */
