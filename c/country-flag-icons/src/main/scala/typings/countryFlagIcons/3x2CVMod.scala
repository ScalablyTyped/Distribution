...
object `3x2CVMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/CV", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2CVMod`.foo` */
