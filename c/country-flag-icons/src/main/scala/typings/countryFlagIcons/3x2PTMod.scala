...
object `3x2PTMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/PT", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2PTMod`.foo` */
