...
object react1x1MKMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/MK", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1MKMod.foo` */
