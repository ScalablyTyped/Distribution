...
object react1x1BWMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/BW", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1BWMod.foo` */
