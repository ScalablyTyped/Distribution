...
object `3x2GUMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/GU", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2GUMod`.foo` */
