...
object kWMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/KW", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `kWMod.foo` */
