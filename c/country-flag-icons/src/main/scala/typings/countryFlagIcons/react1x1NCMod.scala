...
object react1x1NCMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/NC", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1NCMod.foo` */
