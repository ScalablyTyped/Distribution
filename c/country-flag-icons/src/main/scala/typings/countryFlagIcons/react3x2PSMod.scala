...
object react3x2PSMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/PS", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2PSMod.foo` */
