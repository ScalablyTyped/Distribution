...
object react3x2ROMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/RO", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2ROMod.foo` */
