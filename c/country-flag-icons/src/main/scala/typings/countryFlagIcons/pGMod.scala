...
object pGMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/PG", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `pGMod.foo` */
