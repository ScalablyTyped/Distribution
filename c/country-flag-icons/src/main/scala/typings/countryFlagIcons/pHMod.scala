...
object pHMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/PH", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `pHMod.foo` */
