...
object `3x2INMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/IN", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2INMod`.foo` */
