...
object react3x2TTMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/TT", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react3x2TTMod.foo` */
