...
object `3x2PRMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/PR", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2PRMod`.foo` */
