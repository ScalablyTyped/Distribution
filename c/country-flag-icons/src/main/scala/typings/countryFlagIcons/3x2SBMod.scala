...
object `3x2SBMod` extends Shortcut {
  
  @JSImport("country-flag-icons/react/3x2/SB", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say ``3x2SBMod`.foo` */
