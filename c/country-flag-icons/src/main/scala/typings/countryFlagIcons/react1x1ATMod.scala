...
object react1x1ATMod extends Shortcut {
  
  @JSImport("country-flag-icons/react/1x1/AT", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `react1x1ATMod.foo` */
