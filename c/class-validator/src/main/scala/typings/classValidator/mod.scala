...
object mod {
  ...
  @JSImport("class-validator", "IS_BASE58")
  @js.native
  ...
  @JSImport("class-validator", "IS_ISO4217_CURRENCY_CODE")
  @js.native
  ...
  @JSImport("class-validator", "IS_STRONG_PASSWORD")
  @js.native
  ...
  @JSImport("class-validator", "IS_TAX_ID")
  @js.native
  val IS_TAX_ID: /* "isTaxId" */ String = js.native
  
  @JSImport("class-validator", "IS_TIMEZONE")
  @js.native
  ...
  inline def registerSchema(schema: ValidationSchema): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerSchema")(schema.asInstanceOf[js.Any]).asInstanceOf[Unit]
