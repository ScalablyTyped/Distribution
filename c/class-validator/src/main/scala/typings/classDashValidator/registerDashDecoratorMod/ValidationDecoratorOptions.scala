package typings.classDashValidator.registerDashDecoratorMod

import typings.classDashValidator.validationValidatorConstraintInterfaceMod.ValidatorConstraintInterface
