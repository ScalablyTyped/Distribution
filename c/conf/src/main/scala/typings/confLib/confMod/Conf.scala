...
trait Conf[T]
  ...
  var iterator: js.Function0[nodeLib.IterableIterator[js.Tuple2[java.lang.String, T]]] = js.native
  ...
  def onDidChange(
    ...
    callback: js.Function2[/* oldValue */ js.UndefOr[T], /* newValue */ js.UndefOr[T], scala.Unit]
