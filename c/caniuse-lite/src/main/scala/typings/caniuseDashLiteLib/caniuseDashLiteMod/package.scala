...
package object caniuseDashLiteMod {
  type AgentsByID = stdLib.Readonly[ScalablyTyped.runtime.StringDictionary[js.UndefOr[stdLib.Readonly[Agent]]]]
  ...
  type StatsByAgentID = stdLib.Readonly[ScalablyTyped.runtime.StringDictionary[SupportStatusByVersion]]
  ...
  type SupportStatusByVersion = stdLib.Readonly[ScalablyTyped.runtime.StringDictionary[SupportStatus]]
  type UsageByVersion = stdLib.Readonly[ScalablyTyped.runtime.StringDictionary[js.UndefOr[scala.Double]]]
}
