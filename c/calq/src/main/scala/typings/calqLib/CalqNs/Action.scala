...
trait Action extends js.Object {
  ...
  def setGlobalProperty(params: ScalablyTyped.runtime.StringDictionary[js.Any]): scala.Unit = js.native
  def track(action: java.lang.String): scala.Unit = js.native
  def track(action: java.lang.String, params: ScalablyTyped.runtime.StringDictionary[js.Any]): scala.Unit = js.native
  def trackHTMLLink(action: java.lang.String): scala.Unit = js.native
  def trackHTMLLink(action: java.lang.String, params: ScalablyTyped.runtime.StringDictionary[js.Any]): scala.Unit = js.native
