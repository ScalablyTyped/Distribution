...
object PartialNameOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(middle)) __obj.updateDynamic("middle")(middle.get.asInstanceOf[js.Any])
    if (!js.isUndefined(middle_initial)) __obj.updateDynamic("middle_initial")(middle_initial.get.asInstanceOf[js.Any])
