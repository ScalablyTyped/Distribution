...
object SourcesOrderType extends StObject {
  ...
  /* 0 */ val ORDER_OF_DEFINITION: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.SourcesOrderType.ORDER_OF_DEFINITION & Double = js.native
  
  @js.native
  sealed trait RANDOM
    extends StObject
       with SourcesOrderType
  /* 1 */ val RANDOM: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.SourcesOrderType.RANDOM & Double = js.native
}
