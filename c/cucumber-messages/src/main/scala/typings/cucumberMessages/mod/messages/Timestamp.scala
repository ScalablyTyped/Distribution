...
object Timestamp {
  ...
  @js.native
  def create(): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.create")
  @js.native
  def create(properties: ITimestamp): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  ...
  @js.native
  def decode(reader: Reader): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.decode")
  @js.native
  def decode(reader: Reader, length: Double): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.decode")
  @js.native
  def decode(reader: Uint8Array): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  ...
  @js.native
  def decodeDelimited(reader: Reader): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  ...
  @js.native
  def fromObject(`object`: StringDictionary[js.Any]): typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp = js.native
  ...
  @js.native
  def toObject(message: typings.cucumberMessages.cucumberMessagesMod.io.cucumber.messages.Timestamp): StringDictionary[js.Any] = js.native
  @JSImport("cucumber-messages", "messages.Timestamp.toObject")
  @js.native
  def toObject(
