...
import typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ITestResult
...
open class TestResult ()
  extends typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult {
...
object TestResult {
  ...
  object Status extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status & Double
      ] = js.native
    
    /* 5 */ val AMBIGUOUS: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.AMBIGUOUS & Double = js.native
    
    /* 6 */ val FAILED: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.FAILED & Double = js.native
    
    /* 1 */ val PASSED: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.PASSED & Double = js.native
    
    /* 3 */ val PENDING: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.PENDING & Double = js.native
    
    /* 2 */ val SKIPPED: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.SKIPPED & Double = js.native
    
    /* 4 */ val UNDEFINED: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.UNDEFINED & Double = js.native
    
    /* 0 */ val UNKNOWN: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult.Status.UNKNOWN & Double = js.native
  }
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  inline def create(properties: ITestResult): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  
  inline def decode(reader: js.typedarray.Uint8Array): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  ...
  /**
    ...
    */
  /* static member */
  inline def decode(reader: Reader): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult]
  ...
  /**
    ...
    */
  /* static member */
  inline def toObject(message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(
    message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.TestResult,
