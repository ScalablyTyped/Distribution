...
import typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ICommandRunBeforeTestRunHooks
...
open class CommandRunBeforeTestRunHooks ()
  extends typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks {
...
object CommandRunBeforeTestRunHooks {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks]
  inline def create(properties: ICommandRunBeforeTestRunHooks): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks]
  ...
  /* static member */
  inline def toObject(
    message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestRunHooks
