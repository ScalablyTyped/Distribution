...
import typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ICommandRunAfterTestCaseHook
...
open class CommandRunAfterTestCaseHook ()
  extends typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook {
...
object CommandRunAfterTestCaseHook {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook]
  inline def create(properties: ICommandRunAfterTestCaseHook): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook]
  ...
  /* static member */
  inline def toObject(
    message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunAfterTestCaseHook
