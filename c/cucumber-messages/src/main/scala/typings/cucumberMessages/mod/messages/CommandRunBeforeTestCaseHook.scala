...
import typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ICommandRunBeforeTestCaseHook
...
open class CommandRunBeforeTestCaseHook ()
  extends typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook {
...
object CommandRunBeforeTestCaseHook {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook]
  inline def create(properties: ICommandRunBeforeTestCaseHook): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook]
  ...
  /* static member */
  inline def toObject(
    message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandRunBeforeTestCaseHook
