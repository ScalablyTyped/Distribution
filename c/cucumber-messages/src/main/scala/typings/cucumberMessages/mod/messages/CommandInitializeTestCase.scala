...
import typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.ICommandInitializeTestCase
...
open class CommandInitializeTestCase ()
  extends typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase {
...
object CommandInitializeTestCase {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase]
  inline def create(properties: ICommandInitializeTestCase): typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase]
  ...
  /* static member */
  inline def toObject(
    message: typings.cucumberMessages.distSrcCucumberMessagesMod.io.cucumber.messages.CommandInitializeTestCase
