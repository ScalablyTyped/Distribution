...
object CommandStart {
  ...
  /* static member */
  @scala.inline
  def create(): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[CommandStart]
  @scala.inline
  def create(properties: ICommandStart): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  ...
  /* static member */
  @scala.inline
  def decode(reader: Reader): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  @scala.inline
  def decode(reader: Reader, length: Double): CommandStart = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[CommandStart]
  @scala.inline
  def decode(reader: Uint8Array): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): CommandStart = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[CommandStart]
  ...
  /* static member */
  @scala.inline
  def decodeDelimited(reader: Reader): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  ...
  /* static member */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): CommandStart = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[CommandStart]
  ...
  /* static member */
  @scala.inline
  def toObject(message: CommandStart): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: CommandStart, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
