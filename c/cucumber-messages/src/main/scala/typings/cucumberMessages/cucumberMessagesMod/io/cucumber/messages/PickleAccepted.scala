...
object PickleAccepted {
  ...
  /* static member */
  @scala.inline
  def create(): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[PickleAccepted]
  @scala.inline
  def create(properties: IPickleAccepted): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  ...
  /* static member */
  @scala.inline
  def decode(reader: Reader): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  @scala.inline
  def decode(reader: Reader, length: Double): PickleAccepted = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PickleAccepted]
  @scala.inline
  def decode(reader: Uint8Array): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): PickleAccepted = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PickleAccepted]
  ...
  /* static member */
  @scala.inline
  def decodeDelimited(reader: Reader): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  ...
  /* static member */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): PickleAccepted = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[PickleAccepted]
  ...
  /* static member */
  @scala.inline
  def toObject(message: PickleAccepted): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: PickleAccepted, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
