...
object TestStepFinished {
  ...
  /* static member */
  @scala.inline
  def create(): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[TestStepFinished]
  @scala.inline
  def create(properties: ITestStepFinished): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  ...
  /* static member */
  @scala.inline
  def decode(reader: Reader): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  @scala.inline
  def decode(reader: Reader, length: Double): TestStepFinished = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TestStepFinished]
  @scala.inline
  def decode(reader: Uint8Array): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): TestStepFinished = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TestStepFinished]
  ...
  /* static member */
  @scala.inline
  def decodeDelimited(reader: Reader): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  ...
  /* static member */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): TestStepFinished = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TestStepFinished]
  ...
  /* static member */
  @scala.inline
  def toObject(message: TestStepFinished): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: TestStepFinished, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
