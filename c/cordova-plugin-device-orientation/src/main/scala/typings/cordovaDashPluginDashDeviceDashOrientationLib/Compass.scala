...
trait Compass extends js.Object {
  /**
    ...
    */
  def clearWatch(id: scala.Double): scala.Unit = js.native
  /**
  ...
  def getCurrentHeading(
    onSuccess: js.Function1[/* heading */ CompassHeading, scala.Unit],
    onError: js.Function1[/* error */ CompassError, scala.Unit]
