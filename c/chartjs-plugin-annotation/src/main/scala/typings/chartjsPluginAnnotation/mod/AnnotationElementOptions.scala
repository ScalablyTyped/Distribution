...
object AnnotationElementOptions {
  ...
  @scala.inline
  implicit class AnnotationElementOptionsOps[Self <: AnnotationElementOptions[_], T /* <: AnnotationOptions */] (val x: Self with AnnotationElementOptions[T]) extends AnyVal {
