...
trait Id extends StObject {
  ...
  var references: js.UndefOr[js.Array[URL]] = js.undefined
...
object Id {
  ...
  inline def apply(`type`: defect | enhancement | security): Id = {
  ...
  implicit open class MutableBuilder[Self <: Id] (val x: Self) extends AnyVal {
    ...
    inline def setReferences(value: js.Array[URL]): Self = StObject.set(x, "references", value.asInstanceOf[js.Any])
    
    inline def setReferencesUndefined: Self = StObject.set(x, "references", js.undefined)
    
    inline def setReferencesVarargs(value: URL*): Self = StObject.set(x, "references", js.Array(value*))
