...
import typings.cyclonedx.mod.ComponentV14
...
/* Inlined cyclonedx.cyclonedx.MetadataBase<cyclonedx.cyclonedx.ToolV1_3, cyclonedx.cyclonedx.ComponentV1_4> & {  licenses :std.Array<cyclonedx.cyclonedx.LicenseOrExpression> | undefined,   properties :cyclonedx.cyclonedx.Properties | undefined} */
trait MetadataBaseToolV13ComponAuthors extends StObject {
  
  var authors: js.UndefOr[js.Array[ContactPerson]] = js.undefined
  
  var component: js.UndefOr[ComponentV14] = js.undefined
...
object MetadataBaseToolV13ComponAuthors {
  
  inline def apply(): MetadataBaseToolV13ComponAuthors = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MetadataBaseToolV13ComponAuthors]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MetadataBaseToolV13ComponAuthors] (val x: Self) extends AnyVal {
    ...
    inline def setComponent(value: ComponentV14): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
