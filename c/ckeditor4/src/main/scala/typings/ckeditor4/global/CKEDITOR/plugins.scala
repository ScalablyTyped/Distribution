...
import typings.ckeditor4.CKEDITOR.pluginDefinition
import typings.ckeditor4.CKEDITOR.plugins.balloontoolbar.contextDefinition
import typings.ckeditor4.CKEDITOR.plugins.embedBase.baseDefinition
import typings.ckeditor4.CKEDITOR.plugins.imagebase.imageWidgetDefinition
...
import typings.ckeditor4.anon.Filter
import typings.ckeditor4.anon.Removed
import typings.ckeditor4.anon.Set
...
object plugins {
  ...
  open class autoEmbed ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.autoEmbed {
    
    /* CompleteClass */
    override def getWidgetDefinition(editor: typings.ckeditor4.CKEDITOR.editor, url: String): definition = js.native
  }
  ...
  object balloontoolbar {
    ...
    open class context protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.balloontoolbar.context {
      def this(editor: typings.ckeditor4.CKEDITOR.editor, options: contextDefinition) = this()
    }
    ...
    open class contextManager protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.balloontoolbar.contextManager {
  ...
  object clipboard {
    ...
    inline def addPasteButton(editor: typings.ckeditor4.CKEDITOR.editor, name: String, definition: StringDictionary[Any]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addPasteButton")(editor.asInstanceOf[js.Any], name.asInstanceOf[js.Any], definition.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    inline def canClipboardApiBeTrusted(
      dataTransfer: typings.ckeditor4.CKEDITOR.plugins.clipboard.dataTransfer,
    ...
    open class dataTransfer ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.clipboard.dataTransfer {
      def this(nativeDataTransfer: DataTransfer) = this()
      def this(nativeDataTransfer: Unit, editor: typings.ckeditor4.CKEDITOR.editor) = this()
      def this(nativeDataTransfer: DataTransfer, editor: typings.ckeditor4.CKEDITOR.editor) = this()
    }
    ...
    open class fallbackDataTransfer protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.clipboard.fallbackDataTransfer {
      def this(dataTransfer: typings.ckeditor4.CKEDITOR.plugins.clipboard.dataTransfer) = this()
    }
    
    inline def getDropTarget(editor: typings.ckeditor4.CKEDITOR.editor): domObject = ^.asInstanceOf[js.Dynamic].applyDynamic("getDropTarget")(editor.asInstanceOf[js.Any]).asInstanceOf[domObject]
    
    inline def getRangeAtDropPosition(domEvent: Event, editor: typings.ckeditor4.CKEDITOR.editor): range = (^.asInstanceOf[js.Dynamic].applyDynamic("getRangeAtDropPosition")(domEvent.asInstanceOf[js.Any], editor.asInstanceOf[js.Any])).asInstanceOf[range]
    
    inline def initDragDataTransfer(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initDragDataTransfer")().asInstanceOf[Unit]
    inline def initDragDataTransfer(evt: Unit, editor: typings.ckeditor4.CKEDITOR.editor): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initDragDataTransfer")(evt.asInstanceOf[js.Any], editor.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def initDragDataTransfer(evt: typings.ckeditor4.CKEDITOR.dom.event): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initDragDataTransfer")(evt.asInstanceOf[js.Any]).asInstanceOf[Unit]
    inline def initDragDataTransfer(evt: typings.ckeditor4.CKEDITOR.dom.event, editor: typings.ckeditor4.CKEDITOR.editor): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initDragDataTransfer")(evt.asInstanceOf[js.Any], editor.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    inline def initPasteDataTransfer(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initPasteDataTransfer")().asInstanceOf[Unit]
    inline def initPasteDataTransfer(evt: Unit, sourceEditor: typings.ckeditor4.CKEDITOR.editor): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initPasteDataTransfer")(evt.asInstanceOf[js.Any], sourceEditor.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def initPasteDataTransfer(evt: typings.ckeditor4.CKEDITOR.dom.event): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initPasteDataTransfer")(evt.asInstanceOf[js.Any]).asInstanceOf[Unit]
    inline def initPasteDataTransfer(evt: typings.ckeditor4.CKEDITOR.dom.event, sourceEditor: typings.ckeditor4.CKEDITOR.editor): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("initPasteDataTransfer")(evt.asInstanceOf[js.Any], sourceEditor.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object cloudservices {
    ...
    open class cloudServicesLoader protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.cloudservices.cloudServicesLoader {
      ...
      def this(editor: typings.ckeditor4.CKEDITOR.editor, fileOrData: String, fileName: String, token: String) = this()
      def this(editor: typings.ckeditor4.CKEDITOR.editor, fileOrData: String, fileName: Unit, token: String) = this()
      def this(editor: typings.ckeditor4.CKEDITOR.editor, fileOrData: Blob, fileName: String, token: String) = this()
      def this(editor: typings.ckeditor4.CKEDITOR.editor, fileOrData: Blob, fileName: Unit, token: String) = this()
    }
  }
  ...
  object condesnippet {
    ...
    open class highlighter ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.condesnippet.highlighter {
    ...
    inline def setHighlighter(highlighter: typings.ckeditor4.CKEDITOR.plugins.condesnippet.highlighter): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setHighlighter")(highlighter.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  open class contextMenu protected ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.contextMenu {
    def this(editor: typings.ckeditor4.CKEDITOR.editor) = this()
  }
  ...
  object copyformatting {
    ...
    open class state protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.copyformatting.state {
      def this(editor: typings.ckeditor4.CKEDITOR.editor) = this()
    }
  }
  ...
  object embedBase {
    ...
    inline def createWidgetBaseDefinition(editor: typings.ckeditor4.CKEDITOR.editor): baseDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("createWidgetBaseDefinition")(editor.asInstanceOf[js.Any]).asInstanceOf[baseDefinition]
  }
  ...
  object imagebase {
    ...
    inline def addFeature(editor: typings.ckeditor4.CKEDITOR.editor, name: String, definition: imageWidgetDefinition): imageWidgetDefinition = (^.asInstanceOf[js.Dynamic].applyDynamic("addFeature")(editor.asInstanceOf[js.Any], name.asInstanceOf[js.Any], definition.asInstanceOf[js.Any])).asInstanceOf[imageWidgetDefinition]
    
    inline def addImageWidget(editor: typings.ckeditor4.CKEDITOR.editor, name: String, definition: imageWidgetDefinition): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addImageWidget")(editor.asInstanceOf[js.Any], name.asInstanceOf[js.Any], definition.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    @JSGlobal("CKEDITOR.plugins.imagebase.progressBar")
    @js.native
    open class progressBar ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.imagebase.progressBar {
    ...
    open class progressReporter ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.imagebase.progressReporter {
  ...
  object indent {
    ...
    open class genericDefinition ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.indent.genericDefinition
    
    inline def registerCommands(
      editor: typings.ckeditor4.CKEDITOR.editor,
      commands: StringDictionary[typings.ckeditor4.CKEDITOR.command]
    ...
    open class specificDefinition ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.indent.specificDefinition {
      ...
      /* CompleteClass */
      override def execJob(editor: typings.ckeditor4.CKEDITOR.editor, priority: Double): Boolean = js.native
      ...
      /* CompleteClass */
      override def refreshJob(editor: typings.ckeditor4.CKEDITOR.editor, priority: Double): Double = js.native
  ...
  object link {
    ...
    inline def getEditorAnchors(editor: typings.ckeditor4.CKEDITOR.editor): js.Array[element] = ^.asInstanceOf[js.Dynamic].applyDynamic("getEditorAnchors")(editor.asInstanceOf[js.Any]).asInstanceOf[js.Array[element]]
    
    inline def getLinkAttributes(editor: typings.ckeditor4.CKEDITOR.editor, data: StringDictionary[Any]): Set = (^.asInstanceOf[js.Dynamic].applyDynamic("getLinkAttributes")(editor.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Set]
    
    inline def getSelectedLink(editor: typings.ckeditor4.CKEDITOR.editor): element | js.Array[element] = ^.asInstanceOf[js.Dynamic].applyDynamic("getSelectedLink")(editor.asInstanceOf[js.Any]).asInstanceOf[element | js.Array[element]]
    inline def getSelectedLink(editor: typings.ckeditor4.CKEDITOR.editor, returnMultiple: Boolean): element | js.Array[element] = (^.asInstanceOf[js.Dynamic].applyDynamic("getSelectedLink")(editor.asInstanceOf[js.Any], returnMultiple.asInstanceOf[js.Any])).asInstanceOf[element | js.Array[element]]
    
    inline def parseLinkAttributes(editor: typings.ckeditor4.CKEDITOR.editor, element: element): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("parseLinkAttributes")(editor.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
    
    inline def showDisplayTextForElement(element: element, editor: typings.ckeditor4.CKEDITOR.editor): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("showDisplayTextForElement")(element.asInstanceOf[js.Any], editor.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    inline def tryRestoreFakeAnchor(editor: typings.ckeditor4.CKEDITOR.editor, element: element): element = (^.asInstanceOf[js.Dynamic].applyDynamic("tryRestoreFakeAnchor")(editor.asInstanceOf[js.Any], element.asInstanceOf[js.Any])).asInstanceOf[element]
  }
  ...
  open class list ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.list {
  ...
  open class notification protected ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.notification {
    def this(
      editor: typings.ckeditor4.CKEDITOR.editor,
      options: typings.ckeditor4.CKEDITOR.plugins.notification.options
    ) = this()
    
    /* CompleteClass */
    override val area: typings.ckeditor4.CKEDITOR.plugins.notification.area = js.native
    
    /* CompleteClass */
    override val duration: Double = js.native
    
    /* CompleteClass */
    override val editor: typings.ckeditor4.CKEDITOR.editor = js.native
    
    /* CompleteClass */
    override val element: typings.ckeditor4.CKEDITOR.dom.element = js.native
    ...
    /* CompleteClass */
    override val `type`: typings.ckeditor4.CKEDITOR.plugins.notification.`type` = js.native
  ...
  open class notificationAggregator protected ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.notificationAggregator {
    def this(editor: typings.ckeditor4.CKEDITOR.editor, message: String) = this()
    def this(editor: typings.ckeditor4.CKEDITOR.editor, message: String, singularMessage: String) = this()
  }
  object notificationAggregator {
    ...
    open class task ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.notificationAggregator.task {
  ...
  object pastefromword {
    ...
    open class lists ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.pastefromword.lists {
    ...
    object lists {
      ...
      open class numbering ()
        extends StObject
           with typings.ckeditor4.CKEDITOR.plugins.pastefromword.lists.numbering {
    ...
    open class styles ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.pastefromword.styles
  }
  ...
  open class widget protected ()
    extends StObject
       with typings.ckeditor4.CKEDITOR.plugins.widget {
    def this(
      widgetsRepo: typings.ckeditor4.CKEDITOR.plugins.widget.repository,
      id: Double,
      element: typings.ckeditor4.CKEDITOR.dom.element,
      widgetDef: typings.ckeditor4.CKEDITOR.plugins.widget.definition
    ) = this()
    def this(
      widgetsRepo: typings.ckeditor4.CKEDITOR.plugins.widget.repository,
      id: Double,
  ...
  object widget {
    ...
    open class nestedEditable protected ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.widget.nestedEditable {
      def this(
        editor: typings.ckeditor4.CKEDITOR.editor,
        element: typings.ckeditor4.CKEDITOR.dom.element,
        config: Filter
    ...
    open class repository ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.widget.repository
    
    @JSGlobal("CKEDITOR.plugins.widget.widgetselection")
    @js.native
    open class widgetselection ()
      extends StObject
         with typings.ckeditor4.CKEDITOR.plugins.widget.widgetselection {
      
      /* CompleteClass */
      override def addFillers(editable: typings.ckeditor4.CKEDITOR.editable): Boolean = js.native
      
      /* CompleteClass */
      override def removeFillers(editable: typings.ckeditor4.CKEDITOR.editable): Unit = js.native
    }
  }
}
