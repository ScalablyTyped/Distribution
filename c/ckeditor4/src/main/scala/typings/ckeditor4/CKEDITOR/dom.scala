...
import typings.ckeditor4.anon.Attributes
...
object dom {
  ...
  trait iterator extends StObject {
    ...
    val activeFilter: typings.ckeditor4.CKEDITOR.filter = js.native
    
    var enforceRealBlocks: Boolean = js.native
    
    var enlargeBr: Boolean = js.native
    
    val filter: typings.ckeditor4.CKEDITOR.filter = js.native
    ...
    val range: typings.ckeditor4.CKEDITOR.dom.range = js.native
  }
  ...
  trait range extends StObject {
    ...
    val document: typings.ckeditor4.CKEDITOR.dom.document = js.native
