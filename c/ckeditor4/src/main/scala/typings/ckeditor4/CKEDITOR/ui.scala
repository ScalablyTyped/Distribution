...
import typings.ckeditor4.CKEDITOR.ui.balloonPanel.parts
import typings.ckeditor4.CKEDITOR.ui.balloonPanel.rect
import typings.ckeditor4.CKEDITOR.ui.balloonPanel.templateDefinitions
import typings.ckeditor4.CKEDITOR.ui.balloonPanel.templates
import typings.ckeditor4.CKEDITOR.ui.panel.block
import typings.ckeditor4.anon.FocusElement
import typings.ckeditor4.anon.RemoveListenerListenerRegistration
import typings.ckeditor4.ckeditor4Strings.bottom
import typings.ckeditor4.ckeditor4Strings.horizontal
import typings.ckeditor4.ckeditor4Strings.left
import typings.ckeditor4.ckeditor4Strings.right
import typings.ckeditor4.ckeditor4Strings.top
import typings.ckeditor4.ckeditor4Strings.vertical
  ...
  object dialog {
    ...
    object button {
      ...
      inline def apply(
        ...
        getDialog: () => typings.ckeditor4.CKEDITOR.dialog,
        getElement: () => element,
        ...
        isFocusable: () => Boolean,
        isVisible: () => Boolean,
        registerEvents: typings.ckeditor4.CKEDITOR.dialog.definition.uiElement => uiElement,
        selectParentTab: () => uiElement,
        setValue: (Any, Boolean) => js.UndefOr[uiElement]
      ): typings.ckeditor4.CKEDITOR.ui.dialog.button = {
      ...
      implicit open class MutableBuilder[Self <: typings.ckeditor4.CKEDITOR.ui.dialog.button] (val x: Self) extends AnyVal {
        ...
        inline def setClick(value: () => Any): Self = StObject.set(x, "click", js.Any.fromFunction0(value))
      }
    }
    ...
    object checkbox {
      ...
      inline def apply(
        accessKeyDown: (typings.ckeditor4.CKEDITOR.dialog, String) => Unit,
        accessKeyUp: () => Unit,
        disable: () => Unit,
        enable: () => Unit,
        eventProcessors: Any,
    ...
    object definitions {
      ...
      object button {
        ...
        inline def apply(label: String): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.button = {
      ...
      object checkbox {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.checkbox = {
          val __obj = js.Dynamic.literal()
      ...
      object file {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.file = {
          val __obj = js.Dynamic.literal()
      ...
      object fileButton {
        ...
        inline def apply(`for`: String): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.fileButton = {
          val __obj = js.Dynamic.literal()
      ...
      object hbox {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.hbox = {
          val __obj = js.Dynamic.literal()
      ...
      object html {
        ...
        inline def apply(html: String): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.html = {
      ...
      object iframeElement {
        ...
        inline def apply(height: String, src: String, width: String): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.iframeElement = {
      ...
      object labeledElement {
        ...
        inline def apply(label: String): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.labeledElement = {
          val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any])
      ...
      object radio {
        ...
        inline def apply(default: Any, items: js.Array[(js.Tuple2[String, String]) | js.Array[String]]): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.radio = {
      ...
      object select {
        ...
        inline def apply(default: Any, items: js.Array[(js.Tuple2[String, String]) | js.Array[String]]): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.select = {
          val __obj = js.Dynamic.literal(default = default.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any])
      ...
      object textInput {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.textInput = {
          val __obj = js.Dynamic.literal()
      ...
      object textarea {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.textarea = {
          val __obj = js.Dynamic.literal()
      ...
      object uiElement {
        ...
        inline def apply(id: String, `type`: Double): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.uiElement = {
      ...
      object vbox {
        ...
        inline def apply(): typings.ckeditor4.CKEDITOR.ui.dialog.definitions.vbox = {
          val __obj = js.Dynamic.literal()
    ...
    object file {
      ...
      inline def apply(
        accessKeyDown: (typings.ckeditor4.CKEDITOR.dialog, String) => Unit,
        accessKeyUp: (typings.ckeditor4.CKEDITOR.dialog, String) => Unit,
        disable: () => Unit,
        enable: () => Unit,
        eventProcessors: Any,
        focus: () => js.UndefOr[uiElement],
    ...
    type fileButton = typings.ckeditor4.CKEDITOR.ui.dialog.button
    ...
    trait uiElement extends StObject {
      ...
      def accessKeyDown(dialog: typings.ckeditor4.CKEDITOR.dialog, key: String): Unit
      
      def accessKeyUp(dialog: typings.ckeditor4.CKEDITOR.dialog, key: String): Unit
      ...
      def getDialog(): typings.ckeditor4.CKEDITOR.dialog
      ...
      def registerEvents(definition: typings.ckeditor4.CKEDITOR.dialog.definition.uiElement): uiElement
    ...
    object uiElement {
      ...
      implicit open class MutableBuilder[Self <: uiElement] (val x: Self) extends AnyVal {
        ...
        inline def setAccessKeyUp(value: (typings.ckeditor4.CKEDITOR.dialog, String) => Unit): Self = StObject.set(x, "accessKeyUp", js.Any.fromFunction2(value))
        ...
        inline def setGetDialog(value: () => typings.ckeditor4.CKEDITOR.dialog): Self = StObject.set(x, "getDialog", js.Any.fromFunction0(value))
        ...
        inline def setRegisterEvents(value: typings.ckeditor4.CKEDITOR.dialog.definition.uiElement => uiElement): Self = StObject.set(x, "registerEvents", js.Any.fromFunction1(value))
