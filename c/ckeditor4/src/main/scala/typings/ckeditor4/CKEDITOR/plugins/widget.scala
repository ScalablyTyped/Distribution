...
import typings.ckeditor4.CKEDITOR.editable
import typings.ckeditor4.CKEDITOR.event
import typings.ckeditor4.CKEDITOR.eventInfo
...
import typings.ckeditor4.CKEDITOR.plugins.widget.nestedEditable
import typings.ckeditor4.CKEDITOR.style
import typings.ckeditor4.CKEDITOR.template
import typings.ckeditor4.anon.FocusInited
...
trait widget
  extends StObject
     with event
     with typings.ckeditor4.CKEDITOR.plugins.widget.definition {
  ...
  val definition: typings.ckeditor4.CKEDITOR.plugins.widget.definition = js.native
  ...
  def initEditable(
    editableName: String,
    definition: typings.ckeditor4.CKEDITOR.plugins.widget.nestedEditable.definition
  ): Boolean = js.native
  ...
  val repository: typings.ckeditor4.CKEDITOR.plugins.widget.repository = js.native
  ...
  val wrapper: typings.ckeditor4.CKEDITOR.dom.element = js.native
}
object widget {
  ...
  trait definition
    ...
    var template: js.UndefOr[String | typings.ckeditor4.CKEDITOR.template] = js.undefined
  ...
  object nestedEditable {
    ...
    object definition {
      ...
      inline def apply(): typings.ckeditor4.CKEDITOR.plugins.widget.nestedEditable.definition = {
        val __obj = js.Dynamic.literal()
  ...
  trait repository
    ...
    def initOn(element: typings.ckeditor4.CKEDITOR.dom.element): widget = js.native
    def initOn(element: typings.ckeditor4.CKEDITOR.dom.element, widgetDef: String): widget = js.native
    def initOn(
      element: typings.ckeditor4.CKEDITOR.dom.element,
      widgetDef: String,
    ...
    def initOn(element: typings.ckeditor4.CKEDITOR.dom.element, widgetDef: definition): widget = js.native
    def initOn(
      element: typings.ckeditor4.CKEDITOR.dom.element,
    ...
    def initOnAll(container: typings.ckeditor4.CKEDITOR.dom.element): js.Array[widget] = js.native
