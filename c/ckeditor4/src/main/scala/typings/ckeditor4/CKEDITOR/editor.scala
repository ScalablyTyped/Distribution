...
import typings.ckeditor4.CKEDITOR.dom.documentFragment
...
import typings.ckeditor4.CKEDITOR.plugins.copyformatting.state
import typings.ckeditor4.CKEDITOR.plugins.notification
import typings.ckeditor4.CKEDITOR.plugins.notification.`type`
import typings.ckeditor4.CKEDITOR.plugins.widget.repository
import typings.ckeditor4.CKEDITOR.style.definition
import typings.ckeditor4.anon.Callback
import typings.ckeditor4.anon.Title
import typings.ckeditor4.ckeditor4Booleans.`false`
import typings.ckeditor4.ckeditor4Booleans.`true`
...
trait editor
  ...
  def addRemoveFormatFilter(func: js.Function1[/* element */ typings.ckeditor4.CKEDITOR.dom.element, Boolean]): Unit = js.native
  ...
  val config: typings.ckeditor4.CKEDITOR.config = js.native
  
  val container: typings.ckeditor4.CKEDITOR.dom.element = js.native
  
  val contextMenu: typings.ckeditor4.CKEDITOR.plugins.contextMenu = js.native
  
  var copyFormatting: state = js.native
  
  def createFakeElement(
    realElement: typings.ckeditor4.CKEDITOR.dom.element,
    className: String,
  ...
  var dataProcessor: typings.ckeditor4.CKEDITOR.dataProcessor = js.native
  ...
  def editable(): typings.ckeditor4.CKEDITOR.editable = js.native
  def editable(elementOrEditable: typings.ckeditor4.CKEDITOR.dom.element): typings.ckeditor4.CKEDITOR.editable = js.native
  def editable(elementOrEditable: typings.ckeditor4.CKEDITOR.editable): typings.ckeditor4.CKEDITOR.editable = js.native
  
  val element: typings.ckeditor4.CKEDITOR.dom.element = js.native
  
  val elementMode: Double = js.native
  
  def elementPath(): typings.ckeditor4.CKEDITOR.dom.elementPath = js.native
  def elementPath(startNode: node): typings.ckeditor4.CKEDITOR.dom.elementPath = js.native
  ...
  val focusManager: typings.ckeditor4.CKEDITOR.focusManager = js.native
  ...
  def getResizable(forContents: Boolean): typings.ckeditor4.CKEDITOR.dom.element = js.native
  ...
  def insertElement(element: typings.ckeditor4.CKEDITOR.dom.element): Unit = js.native
  ...
  val keystrokeHandler: typings.ckeditor4.CKEDITOR.keystrokeHandler = js.native
  ...
  val pasteFilter: typings.ckeditor4.CKEDITOR.filter = js.native
  ...
  def restoreRealElement(fakeElement: typings.ckeditor4.CKEDITOR.dom.element): typings.ckeditor4.CKEDITOR.dom.element = js.native
  ...
  def setActiveFilter(filter: typings.ckeditor4.CKEDITOR.filter): Unit = js.native
  ...
  val ui: typings.ckeditor4.CKEDITOR.ui = js.native
  ...
  val window: typings.ckeditor4.CKEDITOR.dom.window = js.native
}
object editor {
