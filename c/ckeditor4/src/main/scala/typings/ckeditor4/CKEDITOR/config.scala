...
import typings.ckeditor4.CKEDITOR.config.styleObject
import typings.ckeditor4.CKEDITOR.dom.element
import typings.ckeditor4.CKEDITOR.editor.eventObject
...
import typings.ckeditor4.anon.Groups
import typings.ckeditor4.ckeditor4Strings.html
import typings.ckeditor4.ckeditor4Strings.text
...
trait config extends StObject {
  ...
  var fillEmptyBlocks: js.UndefOr[
    Boolean | (js.Function1[/* element */ typings.ckeditor4.CKEDITOR.htmlParser.element, Boolean])
  ] = js.undefined
  ...
  var toolbarGroups: js.UndefOr[js.Array[typings.ckeditor4.CKEDITOR.toolbarGroups | String]] = js.undefined
...
object config {
  ...
  extension [Self <: config](x: Self) {
    ...
    inline def setFillEmptyBlocks(
      value: Boolean | (js.Function1[/* element */ typings.ckeditor4.CKEDITOR.htmlParser.element, Boolean])
    ): Self = StObject.set(x, "fillEmptyBlocks", value.asInstanceOf[js.Any])
    
    inline def setFillEmptyBlocksFunction1(value: /* element */ typings.ckeditor4.CKEDITOR.htmlParser.element => Boolean): Self = StObject.set(x, "fillEmptyBlocks", js.Any.fromFunction1(value))
