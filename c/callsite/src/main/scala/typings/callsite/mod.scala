...
object mod {
  ...
  object CallSite {
    ...
    implicit open class MutableBuilder[Self <: CallSite] (val x: Self) extends AnyVal {
      ...
      inline def setGetEvalOrigin(value: () => String): Self = StObject.set(x, "getEvalOrigin", js.Any.fromFunction0(value))
      
      inline def setGetFileName(value: () => String): Self = StObject.set(x, "getFileName", js.Any.fromFunction0(value))
      
      inline def setGetFunction(value: () => js.Function): Self = StObject.set(x, "getFunction", js.Any.fromFunction0(value))
