...
object Contact {
  ...
  implicit class ContactOps[Self <: Contact] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRemove(value: (js.Function0[Unit], js.Function1[/* error */ Error, Unit]) => Unit): Self = this.set("remove", js.Any.fromFunction2(value))
    @scala.inline
    def setSave(value: (js.Function1[Contact, Unit], js.Function1[/* error */ Error, Unit]) => Unit): Self = this.set("save", js.Any.fromFunction2(value))
  }
