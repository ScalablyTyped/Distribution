...
object global {
  ...
  object crossDomainUtils {
    
    @JSGlobal("crossDomainUtils")
    @js.native
    val ^ : js.Any = js.native
    
    object PROTOCOL {
      
      @JSGlobal("crossDomainUtils.PROTOCOL")
      @js.native
      val ^ : js.Any = js.native
      
      @JSGlobal("crossDomainUtils.PROTOCOL.ABOUT")
      @js.native
      ...
      @JSGlobal("crossDomainUtils.PROTOCOL.FILE")
      @js.native
      ...
      @JSGlobal("crossDomainUtils.PROTOCOL.MOCK")
      @js.native
    ...
    @JSGlobal("crossDomainUtils.TYPES")
    @js.native
    val TYPES: /* true */ Boolean = js.native
    
    @JSGlobal("crossDomainUtils.WILDCARD")
    @js.native
    val WILDCARD: Asterisk = js.native
    
    object WINDOW_TYPE {
      
      @JSGlobal("crossDomainUtils.WINDOW_TYPE")
      @js.native
      val ^ : js.Any = js.native
      
      @JSGlobal("crossDomainUtils.WINDOW_TYPE.IFRAME")
      @js.native
      ...
      @JSGlobal("crossDomainUtils.WINDOW_TYPE.POPUP")
      @js.native
