...
trait tracker extends js.Object {
  ...
  def getCurrentPosition(): js.Array[clmtrackrLib.IPosition] | clmtrackrLib.clmtrackrLibNumbers.`false` = js.native
  ...
  def track(element: stdLib.HTMLCanvasElement): js.Array[clmtrackrLib.IPosition] | clmtrackrLib.clmtrackrLibNumbers.`false` = js.native
  def track(element: stdLib.HTMLVideoElement): js.Array[clmtrackrLib.IPosition] | clmtrackrLib.clmtrackrLibNumbers.`false` = js.native
}
