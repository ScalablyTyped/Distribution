...
@JSGlobal("CamlBuilder.DateRangesOverlapType")
@js.native
object DateRangesOverlapType extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[camljsLib.CamlBuilderNs.DateRangesOverlapType with scala.Double] = js.native
}
