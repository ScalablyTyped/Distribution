...
object IMembership {
  ...
  inline def apply(CurrentUserGroups: () => IExpression, SPGroup: Double => IExpression, SPWeb: IMembershipSPWeb): IMembership = {
  ...
  extension [Self <: IMembership](x: Self) {
    
    inline def setCurrentUserGroups(value: () => IExpression): Self = StObject.set(x, "CurrentUserGroups", js.Any.fromFunction0(value))
    
    inline def setSPGroup(value: Double => IExpression): Self = StObject.set(x, "SPGroup", js.Any.fromFunction1(value))
    
    inline def setSPWeb(value: IMembershipSPWeb): Self = StObject.set(x, "SPWeb", value.asInstanceOf[js.Any])
  }
}
