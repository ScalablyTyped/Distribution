...
object DateRangesOverlapType extends StObject {
  ...
  /* 1 */ val Day: typings.camljs.mod.DateRangesOverlapType.Day with Double = js.native
  ...
  /* 3 */ val Month: typings.camljs.mod.DateRangesOverlapType.Month with Double = js.native
  
  /** Returns events for today */
  @js.native
  sealed trait Now extends DateRangesOverlapType
  /* 0 */ val Now: typings.camljs.mod.DateRangesOverlapType.Now with Double = js.native
  
  /** Returns events for one week, specified by CalendarDate in QueryOptions */
  @js.native
  sealed trait Week extends DateRangesOverlapType
  /* 2 */ val Week: typings.camljs.mod.DateRangesOverlapType.Week with Double = js.native
  
  /** Returns events for one year, specified by CalendarDate in QueryOptions */
  @js.native
  sealed trait Year extends DateRangesOverlapType
  /* 4 */ val Year: typings.camljs.mod.DateRangesOverlapType.Year with Double = js.native
}
