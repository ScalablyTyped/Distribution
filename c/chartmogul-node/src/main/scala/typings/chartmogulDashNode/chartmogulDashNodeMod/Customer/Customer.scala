...
object Customer {
  ...
  def apply(
    ...
    if (`billing-system-type` != null) __obj.updateDynamic("billing-system-type")(`billing-system-type`)
    if (`billing-system-url` != null) __obj.updateDynamic("billing-system-url")(`billing-system-url`)
    if (`chartmogul-url` != null) __obj.updateDynamic("chartmogul-url")(`chartmogul-url`)
    if (city != null) __obj.updateDynamic("city")(city)
    if (company != null) __obj.updateDynamic("company")(company)
    if (country != null) __obj.updateDynamic("country")(country)
    if (currency != null) __obj.updateDynamic("currency")(currency)
    if (`currency-sign` != null) __obj.updateDynamic("currency-sign")(`currency-sign`)
    if (`customer-since` != null) __obj.updateDynamic("customer-since")(`customer-since`)
    if (data_source_uuid != null) __obj.updateDynamic("data_source_uuid")(data_source_uuid)
    if (data_source_uuids != null) __obj.updateDynamic("data_source_uuids")(data_source_uuids)
    if (email != null) __obj.updateDynamic("email")(email)
    if (external_id != null) __obj.updateDynamic("external_id")(external_id)
    if (external_ids != null) __obj.updateDynamic("external_ids")(external_ids)
