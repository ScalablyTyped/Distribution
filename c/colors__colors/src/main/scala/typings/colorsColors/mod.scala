...
object mod {
  ...
  object global {
    ...
    object String {
      ...
      inline def apply(
      ...
      ): typings.colorsColors.mod.global.String = {
        ...
        __obj.asInstanceOf[typings.colorsColors.mod.global.String]
      }
      
      @scala.inline
      implicit open class MutableBuilder[Self <: typings.colorsColors.mod.global.String] (val x: Self) extends AnyVal {
