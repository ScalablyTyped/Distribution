...
object distSrcScorePeerScoreParamsMod {
  
  @JSImport("@chainsafe/libp2p-gossipsub/dist/src/score/peer-score-params", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@chainsafe/libp2p-gossipsub/dist/src/score/peer-score-params", "defaultPeerScoreParams")
  @js.native
  val defaultPeerScoreParams: PeerScoreParams = js.native
  
  @JSImport("@chainsafe/libp2p-gossipsub/dist/src/score/peer-score-params", "defaultTopicScoreParams")
  @js.native
  ...
  object PeerScoreParams {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(IPColocationFactorThreshold = IPColocationFactorThreshold.asInstanceOf[js.Any], IPColocationFactorWeight = IPColocationFactorWeight.asInstanceOf[js.Any], IPColocationFactorWhitelist = IPColocationFactorWhitelist.asInstanceOf[js.Any], appSpecificScore = js.Any.fromFunction1(appSpecificScore), appSpecificWeight = appSpecificWeight.asInstanceOf[js.Any], behaviourPenaltyDecay = behaviourPenaltyDecay.asInstanceOf[js.Any], behaviourPenaltyThreshold = behaviourPenaltyThreshold.asInstanceOf[js.Any], behaviourPenaltyWeight = behaviourPenaltyWeight.asInstanceOf[js.Any], decayInterval = decayInterval.asInstanceOf[js.Any], decayToZero = decayToZero.asInstanceOf[js.Any], retainScore = retainScore.asInstanceOf[js.Any], topicScoreCap = topicScoreCap.asInstanceOf[js.Any], topics = topics.asInstanceOf[js.Any])
