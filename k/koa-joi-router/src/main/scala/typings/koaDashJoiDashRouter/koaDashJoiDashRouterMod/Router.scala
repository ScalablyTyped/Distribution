...
import typings.koaDashRouter.koaDashRouterMod.IParamMiddleware
...
trait Router extends js.Object {
  ...
  var param_Original: js.Function2[
    ...
    typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object]
  ] = js.native
  @JSName("patch")
  ...
  @JSName("prefix")
  var prefix_Original: js.Function1[/* prefix */ String, typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object]] = js.native
  @JSName("put")
  var put_Original: Method = js.native
  var routes: js.Array[Spec] = js.native
  @JSName("use")
  var use_Original: Fn_Middleware = js.native
  ...
  def param(param: String, middleware: IParamMiddleware): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  ...
  def prefix(prefix: String): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  ...
  def use(middleware: (IMiddleware[_, js.Object])*): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: String, middleware: (IMiddleware[_, js.Object])*): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: js.Array[String], middleware: (IMiddleware[_, js.Object])*): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: RegExp, middleware: (IMiddleware[_, js.Object])*): typings.koaDashRouter.koaDashRouterMod.Router[_, js.Object] = js.native
}
