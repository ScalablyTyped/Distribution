...
trait Anon_Failure extends js.Object {
  var body: js.UndefOr[
    joiLib.joiMod.AnySchema | ScalablyTyped.runtime.StringDictionary[joiLib.joiMod.AnySchema]
  ] = js.undefined
  ...
  var output: js.UndefOr[ScalablyTyped.runtime.NumberDictionary[joiLib.joiMod.AnySchema]] = js.undefined
