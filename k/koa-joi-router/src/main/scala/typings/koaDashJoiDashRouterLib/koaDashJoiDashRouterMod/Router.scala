...
trait Router extends js.Object {
  ...
  var param_Original: js.Function2[
    ...
    /* middleware */ koaDashRouterLib.koaDashRouterMod.IParamMiddleware, 
  ...
  def get(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def get(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def get(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def get(path: stdLib.RegExp, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def head(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def head(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def head(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def head(path: stdLib.RegExp, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def middleware(): koaLib.koaMod.Middleware[_, js.Object] = js.native
  def options(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def options(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def options(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def options(path: stdLib.RegExp, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def param(param: java.lang.String, middleware: koaDashRouterLib.koaDashRouterMod.IParamMiddleware): koaDashRouterLib.koaDashRouterMod.Router[_, js.Object] = js.native
  def patch(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def patch(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def patch(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def patch(path: stdLib.RegExp, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def post(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def post(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def post(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  ...
  def put(path: java.lang.String, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  def put(path: java.lang.String, handlerOrConfig: Handler, handlers: Handler*): Router = js.native
  def put(path: stdLib.RegExp, handlerOrConfig: Config, handlers: Handler*): Router = js.native
  ...
  def use(middleware: (koaDashRouterLib.koaDashRouterMod.IMiddleware[_, js.Object])*): koaDashRouterLib.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(path: java.lang.String, middleware: (koaDashRouterLib.koaDashRouterMod.IMiddleware[_, js.Object])*): koaDashRouterLib.koaDashRouterMod.Router[_, js.Object] = js.native
  def use(
  ...
  def use(path: stdLib.RegExp, middleware: (koaDashRouterLib.koaDashRouterMod.IMiddleware[_, js.Object])*): koaDashRouterLib.koaDashRouterMod.Router[_, js.Object] = js.native
}
