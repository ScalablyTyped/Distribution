...
trait Anon_Body extends js.Object {
  ...
  var formOptions: js.UndefOr[coDashBodyLib.coDashBodyMod.Options] = js.undefined
  var header: js.UndefOr[joiLib.joiMod.SchemaLike] = js.undefined
  var jsonOptions: js.UndefOr[coDashBodyLib.coDashBodyMod.Options] = js.undefined
  var maxBody: js.UndefOr[scala.Double] = js.undefined
  var multipartOptions: js.UndefOr[coDashBodyLib.coDashBodyMod.Options] = js.undefined
  var output: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[koaDashJoiDashRouterLib.koaDashJoiDashRouterMod.OutputValidation]
  ] = js.undefined
...
object Anon_Body {
  ...
  def apply(
    ...
    formOptions: coDashBodyLib.coDashBodyMod.Options = null,
    header: joiLib.joiMod.SchemaLike = null,
    jsonOptions: coDashBodyLib.coDashBodyMod.Options = null,
    maxBody: scala.Int | scala.Double = null,
    multipartOptions: coDashBodyLib.coDashBodyMod.Options = null,
    output: org.scalablytyped.runtime.StringDictionary[koaDashJoiDashRouterLib.koaDashJoiDashRouterMod.OutputValidation] = null,
