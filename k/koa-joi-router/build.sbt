...
name := "koa-joi-router"
version := "5.2-dt-20190209Z-2d5a95"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20180214Z-fd51ff",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190122Z-a3f308",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-54d3f4",
  "org.scalablytyped" %%% "node" % "11.9-dt-20190213Z-0d969a",
  "org.scalablytyped" %%% "qs" % "6.5.0-dt-20180214Z-e68ee6",
