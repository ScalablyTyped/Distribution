...
name := "koa-joi-router"
version := "5.2-dt-20190423Z-9ccafa"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-f9affa",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190627Z-9d636e",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-1c84be",
  "org.scalablytyped" %%% "node" % "12.6-dt-20190717Z-e46800",
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-adaa46",
