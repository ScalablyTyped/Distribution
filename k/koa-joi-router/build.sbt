...
name := "koa-joi-router"
version := "5.2-dt-20190423Z-c019be"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-38f9f5",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190627Z-80d78d",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-612693",
  "org.scalablytyped" %%% "node" % "12.7-dt-20191003Z-e91184",
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-db060e",
