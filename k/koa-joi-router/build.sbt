...
name := "koa-joi-router"
version := "5.2-dt-20190423Z-071040"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-b7d82a",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190627Z-823d18",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-c877f7",
  "org.scalablytyped" %%% "node" % "12.7-dt-20190820Z-2dc4df",
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-8cb90f",
