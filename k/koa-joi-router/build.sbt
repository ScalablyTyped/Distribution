...
name := "koa-joi-router"
version := "5.2-dt-20190423Z-f1d3c3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-a7e476",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190627Z-02c46a",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-51ab0c",
  "org.scalablytyped" %%% "node" % "12.7-dt-20191003Z-a35ed6",
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-257731",
