...
name := "koa-joi-router"
version := "5.2-dt-20190423Z-595783"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-56f83a",
  ...
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20190322Z-fe4872",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20190205Z-7c1445",
  "org.scalablytyped" %%% "node" % "11.13-dt-20190429Z-40b461",
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-952968",
