...
object BrowserifyOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(bundleExternal)) __obj.updateDynamic("bundleExternal")(bundleExternal.get.asInstanceOf[js.Any])
    if (!js.isUndefined(commondir)) __obj.updateDynamic("commondir")(commondir.get.asInstanceOf[js.Any])
    if (configure != null) __obj.updateDynamic("configure")(js.Any.fromFunction1(configure))
    if (!js.isUndefined(debug)) __obj.updateDynamic("debug")(debug.get.asInstanceOf[js.Any])
    if (!js.isUndefined(detectGlobals)) __obj.updateDynamic("detectGlobals")(detectGlobals.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(fullPaths)) __obj.updateDynamic("fullPaths")(fullPaths.get.asInstanceOf[js.Any])
    if (insertGlobalVars != null) __obj.updateDynamic("insertGlobalVars")(insertGlobalVars.asInstanceOf[js.Any])
    if (!js.isUndefined(insertGlobals)) __obj.updateDynamic("insertGlobals")(insertGlobals.get.asInstanceOf[js.Any])
