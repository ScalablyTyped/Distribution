...
trait Call extends js.Object {
  ...
  def deepEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String): Unit = js.native
  def deepEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def equal[T](a: T, b: T, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def notDeepEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String): Unit = js.native
  def notDeepEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def notEqual[T](a: T, b: T, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def notStrictEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String): Unit = js.native
  def notStrictEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def ok(a: js.Any, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  ...
  def strictEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String): Unit = js.native
  def strictEqual(a: js.Any, b: js.Any, status: js.UndefOr[scala.Nothing], msg: String, opts: js.Object): Unit = js.native
  def strictEqual(a: js.Any, b: js.Any, status: Double): Unit = js.native
  def strictEqual(a: js.Any, b: js.Any, status: Double, msg: js.UndefOr[scala.Nothing], opts: js.Object): Unit = js.native
