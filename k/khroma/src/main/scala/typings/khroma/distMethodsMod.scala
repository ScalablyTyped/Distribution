...
object distMethodsMod {
  
  @JSImport("khroma/dist/methods", JSImport.Namespace)
  @js.native
  ...
  @JSImport("khroma/dist/methods", "hex")
  @js.native
  ...
  @JSImport("khroma/dist/methods", "rgb")
  @js.native
  val rgb: IRgba = js.native
  
  @JSImport("khroma/dist/methods", "rgba")
  @js.native
