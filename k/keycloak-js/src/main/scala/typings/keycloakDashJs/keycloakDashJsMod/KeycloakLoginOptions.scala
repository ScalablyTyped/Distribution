...
import typings.keycloakDashJs.keycloakDashJsStrings.login
import typings.keycloakDashJs.keycloakDashJsStrings.none
import typings.keycloakDashJs.keycloakDashJsStrings.register
