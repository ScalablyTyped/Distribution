...
name := "koa-webpack"
version := "6.0-dt-20200831Z-931579"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20201002Z-55bd43",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "3.7-dt-20200818Z-decf2c",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.1-dt-20200225Z-64326c",
