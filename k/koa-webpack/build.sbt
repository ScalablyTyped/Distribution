...
name := "koa-webpack"
version := "5.0-dt-20180605Z-ededb7"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-ddd6c4",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-383b7f",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-55cc4a")
