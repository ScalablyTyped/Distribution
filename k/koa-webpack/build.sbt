...
name := "koa-webpack"
version := "5.0-dt-20180605Z-c10889"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-2bc2f8",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-453ed6",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-41b46f",
