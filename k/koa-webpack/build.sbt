...
name := "koa-webpack"
version := "5.0-dt-20180605Z-2005de"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-e7d444",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-f30d7d")
