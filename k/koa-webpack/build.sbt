...
name := "koa-webpack"
version := "5.0-dt-20180605Z-1858c9"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-f86f48",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-65ab75",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-6fb595")
