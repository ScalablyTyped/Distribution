...
name := "koa-webpack"
version := "5.0-dt-20180605Z-a25169"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-3d4ce3",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-69d0a8")
