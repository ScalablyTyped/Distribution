...
name := "koa-webpack"
version := "5.0-dt-20200515Z-68d2dc"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20200515Z-a923ec",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "3.7-dt-20200515Z-3b7057",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.1-dt-20200225Z-c77e7d",
