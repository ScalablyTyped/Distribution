...
name := "koa-webpack"
version := "5.0-dt-20180605Z-2497e5"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20191126Z-0b76c0",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-5a39bc",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-99ab18",
