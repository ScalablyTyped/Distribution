...
name := "koa-webpack"
version := "5.0-dt-20180910Z-34a152"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20180920Z-2f97cd",
  ...
  "com.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180910Z-6df7e5",
  "com.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180910Z-9027b8",
