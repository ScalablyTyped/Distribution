...
name := "koa-webpack"
version := "5.0-dt-20180605Z-b5ec2c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-1f19fe",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-e08b5d")
