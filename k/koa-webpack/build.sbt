...
name := "koa-webpack"
version := "5.0-dt-20180605Z-4dba14"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20180919Z-ee38e8",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-071161",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-cb1ed4")
