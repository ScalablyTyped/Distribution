...
name := "koa-webpack"
version := "5.0-dt-20180605Z-283fa0"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20180919Z-3c9a19",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-9b55eb",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-b850e9")
