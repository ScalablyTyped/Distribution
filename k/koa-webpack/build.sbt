...
name := "koa-webpack"
version := "5.0-dt-20180605Z-db5d47"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-7d3fa0",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-998ad2",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-ea63dc",
