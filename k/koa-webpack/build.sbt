...
name := "koa-webpack"
version := "5.0-dt-20180605Z-2efc73"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-cba51d",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-a8572f")
