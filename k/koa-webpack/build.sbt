...
name := "koa-webpack"
version := "5.0-dt-20180605Z-a555f3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-7a4ebd",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-3b0853",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-3c0979",
