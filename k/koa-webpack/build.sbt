...
name := "koa-webpack"
version := "5.0-dt-20180605Z-f33c97"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-599ebb",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-a1195c",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-a87df2",
