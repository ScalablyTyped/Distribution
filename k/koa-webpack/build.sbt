...
name := "koa-webpack"
version := "5.0-dt-20180605Z-277b09"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20180919Z-8bbb6d",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-bb9919",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-06d4db")
