...
name := "koa-webpack"
version := "5.0-dt-20180605Z-f5786c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-e5e6da",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-40450b",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-a09b88")
