...
name := "koa-webpack"
version := "5.0-dt-20180605Z-d3b967"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-e1a5d9",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-c4366e",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-615ce4",
