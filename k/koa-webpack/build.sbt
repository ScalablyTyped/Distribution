...
name := "koa-webpack"
version := "5.0-dt-20180605Z-bacb31"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-9c7f80",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-cc4e44",
