...
name := "koa-webpack"
version := "5.0-dt-20180605Z-291780"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-d2f190",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-4f3f03",
