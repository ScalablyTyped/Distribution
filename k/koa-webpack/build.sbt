...
name := "koa-webpack"
version := "5.0-dt-20180605Z-cfdd12"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-e5ae74",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-f35cc1")
