...
name := "koa-webpack"
version := "5.0-dt-20180605Z-86e19e"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-9e9875",
  ...
  "org.scalablytyped" %%% "cookies" % "0.7-dt-20180214Z-00bca0",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-9d0f51",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-a95bc6")
