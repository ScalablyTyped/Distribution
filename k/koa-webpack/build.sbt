...
name := "koa-webpack"
version := "5.0-dt-20180605Z-b8d84a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-74d8c5",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-15e679",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-da9ebf")
