...
name := "koa-webpack"
version := "5.0-dt-20180605Z-c6c406"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20191126Z-2b6c11",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-e7e87f",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-d6d790",
