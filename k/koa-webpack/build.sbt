...
name := "koa-webpack"
version := "5.0-dt-20180605Z-9f2a61"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-3d4373",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-8f56bd")
