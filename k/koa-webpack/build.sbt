...
name := "koa-webpack"
version := "5.0-dt-20180605Z-8f8057"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-37bfc6",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-e47d9f",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-9589a4",
