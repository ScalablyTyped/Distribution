...
name := "koa-webpack"
version := "5.0-dt-20180605Z-34f0a6"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-c8c351",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-9f9d35",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-478f39",
