...
name := "koa-webpack"
version := "5.0-dt-20180910Z-5e2808"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20180920Z-9d5693",
  ...
  "com.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180910Z-f5289e",
  "com.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180910Z-5ebf2d",
