...
name := "koa-webpack"
version := "5.0-dt-20180605Z-1fe7d1"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20190624Z-5bac7c",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-705409",
