...
name := "koa-webpack"
version := "5.0-dt-20180910Z-7e4812"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180910Z-d748a9",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180910Z-5dca78")
