...
name := "koa-webpack"
version := "5.0-dt-20180605Z-bad5e1"
scalaVersion := "2.12.8"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "1.0.0",
  "org.scala-js" %%% "scalajs-dom" % "0.9.6",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-204596",
  ...
  "org.scalablytyped" %%% "cookies" % "0.7-dt-20180214Z-51eb9a",
  ...
  "org.scalablytyped" %%% "koa" % "2.x-dt-20181231Z-0da900",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-8e895b",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-b42114")
