...
name := "koa-webpack"
version := "5.0-dt-20180605Z-3bf90f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "memory-fs" % "0.3.0-dt-20190322Z-a42dd0",
  ...
  "org.scalablytyped" %%% "webpack-dev-middleware" % "2.0-dt-20180709Z-93dbea",
  "org.scalablytyped" %%% "webpack-hot-client" % "4.0-dt-20180621Z-a968fc")
