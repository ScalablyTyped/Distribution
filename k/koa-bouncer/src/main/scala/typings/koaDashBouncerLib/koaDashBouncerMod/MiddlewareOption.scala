...
trait MiddlewareOption extends js.Object {
  var getBody: js.UndefOr[js.Function1[/* ctx */ koaLib.koaMod.Context, _]] = js.undefined
  var getParams: js.UndefOr[js.Function1[/* ctx */ koaLib.koaMod.Context, _]] = js.undefined
  var getQuery: js.UndefOr[js.Function1[/* ctx */ koaLib.koaMod.Context, _]] = js.undefined
}

object MiddlewareOption {
  @scala.inline
  def apply(
    getBody: /* ctx */ koaLib.koaMod.Context => _ = null,
    getParams: /* ctx */ koaLib.koaMod.Context => _ = null,
    getQuery: /* ctx */ koaLib.koaMod.Context => _ = null
  ): MiddlewareOption = {
