...
trait Validator extends js.Object {
  ...
  def gt(otherVal: java.lang.String): Validator = js.native
  def gt(otherVal: java.lang.String, tip: java.lang.String): Validator = js.native
  def gte(otherVal: java.lang.String): Validator = js.native
  def gte(otherVal: java.lang.String, tip: java.lang.String): Validator = js.native
  ...
  def lt(otherVal: java.lang.String): Validator = js.native
  def lt(otherVal: java.lang.String, tip: java.lang.String): Validator = js.native
  def lte(otherVal: java.lang.String): Validator = js.native
  def lte(otherVal: java.lang.String, tip: java.lang.String): Validator = js.native
