...
object CustomLauncher {
  ...
  implicit class CustomLauncherOps[Self <: CustomLauncher] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def `setX-ua-compatible`(value: String): Self = this.set("x-ua-compatible", value.asInstanceOf[js.Any])
    @scala.inline
    def `deleteX-ua-compatible`: Self = this.set("x-ua-compatible", js.undefined)
  }
