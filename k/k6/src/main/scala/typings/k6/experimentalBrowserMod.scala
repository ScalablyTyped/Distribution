...
import typings.k6.anon.Referer
...
object experimentalBrowserMod {
  
  @JSImport("k6/experimental/browser", "BrowserContext")
  @js.native
  open class BrowserContext () extends StObject
  
  @JSImport("k6/experimental/browser", "ElementHandle")
  @js.native
  open class ElementHandle () extends StObject
  
  @JSImport("k6/experimental/browser", "Frame")
  @js.native
  open class Frame () extends StObject
  
  @JSImport("k6/experimental/browser", "JSHandle")
  @js.native
  open class JSHandle[T] () extends StObject
  
  @JSImport("k6/experimental/browser", "Keyboard")
  @js.native
  open class Keyboard () extends StObject
  
  @JSImport("k6/experimental/browser", "Locator")
  @js.native
  open class Locator () extends StObject
  
  @JSImport("k6/experimental/browser", "Mouse")
  @js.native
  open class Mouse () extends StObject
  
  @JSImport("k6/experimental/browser", "Page")
  @js.native
  open class Page () extends StObject {
    ...
    def dblclick(selector: String, options: Delay): Unit = js.native
    ...
    def hover(selector: String, options: Modifiers): Unit = js.native
    ...
    def screenshot(options: Clip): js.typedarray.ArrayBuffer = js.native
    ...
    def tap(selector: String, options: Modifiers): Unit = js.native
  ...
  @JSImport("k6/experimental/browser", "Response")
  @js.native
  open class Response () extends StObject
  
  @JSImport("k6/experimental/browser", "Touchscreen")
  @js.native
  ...
  type EvaluationArgument = js.Object
  
  type PageFunction[Arg, R] = String | (js.Function1[/* arg */ Unboxed[Arg], R])
