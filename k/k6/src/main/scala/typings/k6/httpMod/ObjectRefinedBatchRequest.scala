...
object ObjectRefinedBatchRequest {
  ...
  @scala.inline
  implicit class ObjectRefinedBatchRequestOps[Self <: ObjectRefinedBatchRequest[_], RT /* <: js.UndefOr[ResponseType] */] (val x: Self with ObjectRefinedBatchRequest[RT]) extends AnyVal {
