...
trait NoWaitAfter extends StObject {
...
object NoWaitAfter {
  ...
  inline def apply(): NoWaitAfter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NoWaitAfter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NoWaitAfter] (val x: Self) extends AnyVal {
