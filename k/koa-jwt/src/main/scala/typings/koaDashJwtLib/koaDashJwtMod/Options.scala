...
trait Options extends js.Object {
  ...
  var getToken: js.UndefOr[
    js.Function2[/* ctx */ koaLib.koaMod.Context, /* opts */ this.type, java.lang.String]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    isRevoked: (/* ctx */ koaLib.koaMod.Context, /* decodedToken */ js.Object, /* token */ java.lang.String) => js.Promise[scala.Boolean] = null,
