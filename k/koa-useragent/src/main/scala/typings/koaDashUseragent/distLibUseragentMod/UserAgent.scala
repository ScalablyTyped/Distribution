package typings.koaDashUseragent.distLibUseragentMod
...
- Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify ExpressUseragent.UserAgent * / any */ trait UserAgent extends js.Object {
  ...
  val isAndroidTablet: Boolean
  val isAuthoritative: Boolean
  val isBada: Boolean
  val isBlackberry: Boolean
  val isBot: Boolean
  val isCaptive: Boolean
  val isChrome: Boolean
  val isChromeOS: Boolean
  val isCurl: Boolean
  val isDesktop: Boolean
  val isEdge: Boolean
  val isEpiphany: Boolean
  val isFacebook: Boolean
  val isFirefox: Boolean
  val isFlock: Boolean
  val isIE: Boolean
  val isIECompatibilityMode: Boolean
  val isKindleFire: Boolean
  val isKonqueror: Boolean
  val isLinux: Boolean
  val isLinux64: Boolean
  val isMac: Boolean
  val isMobile: Boolean
  val isOmniWeb: Boolean
  val isOpera: Boolean
  val isPhantomJS: Boolean
  val isRaspberry: Boolean
  val isSafari: Boolean
  val isSamsung: Boolean
  val isSeaMonkey: Boolean
  val isSilk: Boolean
  val isSmartTV: Boolean
  val isTablet: Boolean
  val isWebkit: Boolean
  val isWinJs: Boolean
  val isWindows: Boolean
  val isWindowsPhone: Boolean
  val isiPad: Boolean
