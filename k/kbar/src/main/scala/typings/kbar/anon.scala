...
import typings.kbar.kbarStrings._empty
...
import typings.kbar.kbarStrings.`removals additions`
import typings.kbar.kbarStrings.`removals text`
import typings.kbar.kbarStrings.`text additions`
import typings.kbar.kbarStrings.`text removals`
import typings.kbar.kbarStrings.`use-credentials`
import typings.kbar.kbarStrings.additions
import typings.kbar.kbarStrings.all
import typings.kbar.kbarStrings.anonymous
import typings.kbar.kbarStrings.ascending
import typings.kbar.kbarStrings.assertive
import typings.kbar.kbarStrings.both
import typings.kbar.kbarStrings.copy
import typings.kbar.kbarStrings.date
import typings.kbar.kbarStrings.decimal
import typings.kbar.kbarStrings.descending
import typings.kbar.kbarStrings.dialog
import typings.kbar.kbarStrings.done
import typings.kbar.kbarStrings.email
import typings.kbar.kbarStrings.enter
import typings.kbar.kbarStrings.environment
import typings.kbar.kbarStrings.execute
import typings.kbar.kbarStrings.go
import typings.kbar.kbarStrings.grammar
import typings.kbar.kbarStrings.grid
import typings.kbar.kbarStrings.horizontal
import typings.kbar.kbarStrings.inherit
import typings.kbar.kbarStrings.link
import typings.kbar.kbarStrings.list
import typings.kbar.kbarStrings.listbox
import typings.kbar.kbarStrings.location
import typings.kbar.kbarStrings.menu
import typings.kbar.kbarStrings.mixed
import typings.kbar.kbarStrings.move
import typings.kbar.kbarStrings.next
import typings.kbar.kbarStrings.no
import typings.kbar.kbarStrings.none
import typings.kbar.kbarStrings.numeric
import typings.kbar.kbarStrings.off
import typings.kbar.kbarStrings.on
import typings.kbar.kbarStrings.other
import typings.kbar.kbarStrings.page
import typings.kbar.kbarStrings.polite
import typings.kbar.kbarStrings.popup
import typings.kbar.kbarStrings.previous
import typings.kbar.kbarStrings.removals
import typings.kbar.kbarStrings.search
import typings.kbar.kbarStrings.send
import typings.kbar.kbarStrings.spelling
import typings.kbar.kbarStrings.step
import typings.kbar.kbarStrings.tel
import typings.kbar.kbarStrings.text
import typings.kbar.kbarStrings.time
import typings.kbar.kbarStrings.tree
import typings.kbar.kbarStrings.url
...
object anon {
  ...
  object OnClose {
    ...
    implicit open class MutableBuilder[Self <: OnClose] (val x: Self) extends AnyVal {
      ...
      inline def setOnQueryChange(value: /* searchQuery */ String => Unit): Self = StObject.set(x, "onQueryChange", js.Any.fromFunction1(value))
      
      inline def setOnQueryChangeUndefined: Self = StObject.set(x, "onQueryChange", js.undefined)
      
      inline def setOnSelectAction(value: /* action */ ActionImpl => Unit): Self = StObject.set(x, "onSelectAction", js.Any.fromFunction1(value))
  ...
  object Redo {
    ...
    inline def apply(redo: /* item */ js.UndefOr[HistoryItem] => Unit, undo: /* item */ js.UndefOr[HistoryItem] => Unit): Redo = {
      val __obj = js.Dynamic.literal(redo = js.Any.fromFunction1(redo), undo = js.Any.fromFunction1(undo))
    ...
    implicit open class MutableBuilder[Self <: Redo] (val x: Self) extends AnyVal {
      ...
      inline def setUndo(value: /* item */ js.UndefOr[HistoryItem] => Unit): Self = StObject.set(x, "undo", js.Any.fromFunction1(value))
    }
  }
