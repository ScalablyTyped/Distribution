...
trait SchemaBuilder extends ChainableInterface {
  ...
  def hasColumn(tableName: java.lang.String, columnName: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  def hasTable(tableName: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  def queryContext(context: js.Any): SchemaBuilder = js.native
  def raw(statement: java.lang.String): SchemaBuilder = js.native
  def renameTable(oldTableName: java.lang.String, newTableName: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def table(tableName: java.lang.String, callback: js.Function1[/* tableBuilder */ AlterTableBuilder, _]): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
