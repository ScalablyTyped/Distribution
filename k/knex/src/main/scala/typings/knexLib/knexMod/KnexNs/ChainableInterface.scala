...
trait ChainableInterface
  ...
  def options(options: ScalablyTyped.runtime.StringDictionary[js.Any]): this.type = js.native
  // tslint:disable-next-line no-unnecessary-generics
  def pipe[T /* <: nodeLib.NodeJSNs.WritableStream */](writable: T): nodeLib.streamMod.PassThrough = js.native
  // tslint:disable-next-line no-unnecessary-generics
  def pipe[T /* <: nodeLib.NodeJSNs.WritableStream */](writable: T, options: ScalablyTyped.runtime.StringDictionary[js.Any]): nodeLib.streamMod.PassThrough = js.native
  ...
  def stream(options: ScalablyTyped.runtime.StringDictionary[js.Any]): nodeLib.streamMod.PassThrough = js.native
  def stream(
