...
package object DeferredKeySelectionNs {
  ...
  type Any = knexLib.knexMod.DeferredKeySelection[js.Any, js.Any, js.Any, js.Any, js.Any]
  ...
  type ReplaceBase[TSelection, TBase] = TSelection | (js.Array[SetBase[js.Any | knexLib.knexMod.UnwrapArrayMember[TSelection], TBase]])
  ...
  ]) | (/* import warning: ImportType.apply Failed type conversion: any[any] */ js.Any)
  ...
  type SetSingle[TSelection, TSingle /* <: scala.Boolean */] = knexLib.knexMod.DeferredKeySelection[js.Any, js.Any, js.Any, js.Any, TSingle]
}
