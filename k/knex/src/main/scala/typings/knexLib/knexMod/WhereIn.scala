...
trait WhereIn extends js.Object {
  def apply(columnName: java.lang.String, values: js.Array[Value]): QueryBuilder = js.native
  ...
  def apply(columnNames: js.Array[java.lang.String], values: js.Array[js.Array[Value]]): QueryBuilder = js.native
