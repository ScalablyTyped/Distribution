...
- knexLib.knexMod.KnexNs.ChainableInterface because Inheritance from two classes. Inlined toQuery, options, connection, debug, transacting, stream, stream, stream, stream, pipe, pipe */ @js.native
trait Raw
