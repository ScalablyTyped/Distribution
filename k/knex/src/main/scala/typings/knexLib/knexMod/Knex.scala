...
trait Knex extends QueryInterface {
  ...
  def batchInsert(tableName: knexLib.TableName, data: js.Array[_]): QueryBuilder = js.native
  def batchInsert(tableName: knexLib.TableName, data: js.Array[_], chunkSize: scala.Double): QueryBuilder = js.native
  ...
  def raw(sql: java.lang.String, bindings: (knexLib.Value | QueryBuilder)*): Raw = js.native
  def raw(sql: java.lang.String, bindings: js.Array[knexLib.Value | QueryBuilder]): Raw = js.native
  def raw(sql: java.lang.String, bindings: knexLib.ValueMap): Raw = js.native
  def raw(value: knexLib.Value): Raw = js.native
  def transaction[T](
