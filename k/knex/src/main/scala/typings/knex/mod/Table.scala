...
trait Table[TRecord /* <: js.Object */, TResult /* <: js.Object */] extends js.Object {
  ...
  def apply[TRecord2, TResult2](callback: js.Function, options: TableOptions): QueryBuilder[TRecord2, TResult2] = js.native
  def apply[TRecord2, TResult2](raw: Raw[_]): QueryBuilder[TRecord2, TResult2] = js.native
  def apply[TRecord2, TResult2](raw: Raw[_], options: TableOptions): QueryBuilder[TRecord2, TResult2] = js.native
