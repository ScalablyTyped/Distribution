...
import typings.knex.Anon_Precision
...
trait TableBuilder extends js.Object {
  ...
  def dateTime(columnName: String, options: Anon_Precision): ColumnBuilder = js.native
  ...
  def timestamp(columnName: String, options: Anon_Precision): ColumnBuilder = js.native
