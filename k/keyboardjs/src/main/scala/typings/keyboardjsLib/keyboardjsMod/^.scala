...
object ^ extends js.Object {
  def bind(keyCombo: java.lang.String, pressed: Callback): scala.Unit = js.native
  def bind(keyCombo: java.lang.String, pressed: Callback, released: Callback): scala.Unit = js.native
  def bind(
  ...
  def bind(keyCombo: js.Array[java.lang.String], pressed: Callback): scala.Unit = js.native
  def bind(keyCombo: js.Array[java.lang.String], pressed: Callback, released: Callback): scala.Unit = js.native
  def bind(
  ...
  def pressKey(keyCombo: java.lang.String, event: KeyEvent): scala.Unit = js.native
  def pressKey(keyCombo: scala.Double): scala.Unit = js.native
  def pressKey(keyCombo: scala.Double, event: KeyEvent): scala.Unit = js.native
  def releaseAllKeys(): scala.Unit = js.native
  def releaseKey(keyCombo: java.lang.String): scala.Unit = js.native
  def releaseKey(keyCombo: java.lang.String, event: KeyEvent): scala.Unit = js.native
  def releaseKey(keyCombo: scala.Double): scala.Unit = js.native
  def releaseKey(keyCombo: scala.Double, event: KeyEvent): scala.Unit = js.native
  ...
  def unbind(keyCombo: java.lang.String, pressed: Callback): scala.Unit = js.native
  def unbind(keyCombo: java.lang.String, pressed: Callback, released: Callback): scala.Unit = js.native
  def unbind(keyCombo: js.Array[java.lang.String]): scala.Unit = js.native
  def unbind(keyCombo: js.Array[java.lang.String], pressed: Callback): scala.Unit = js.native
  def unbind(keyCombo: js.Array[java.lang.String], pressed: Callback, released: Callback): scala.Unit = js.native
