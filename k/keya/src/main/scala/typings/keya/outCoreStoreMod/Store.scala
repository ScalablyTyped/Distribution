package typings.keya.outCoreStoreMod

import org.scalablytyped.runtime.StringDictionary
import typings.keya.Anon_Key
...
trait Store extends js.Object {
  ...
  var version: Double
  def all(): js.Promise[js.Array[Anon_Key]]
  def clear(): js.Promise[Unit]
  def delete(key: String): js.Promise[Boolean]
  def find(finder: js.Function2[/* value */ js.Any, /* name */ String, js.Promise[Boolean] | Boolean]): js.Promise[js.Array[Anon_Key]]
...
object Store {
  @scala.inline
  def apply(
    all: () => js.Promise[js.Array[Anon_Key]],
    clear: () => js.Promise[Unit],
    delete: String => js.Promise[Boolean],
    find: js.Function2[/* value */ js.Any, /* name */ String, js.Promise[Boolean] | Boolean] => js.Promise[js.Array[Anon_Key]],
