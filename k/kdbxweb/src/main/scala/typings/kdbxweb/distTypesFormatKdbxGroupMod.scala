...
import typings.kdbxweb.distTypesFormatKdbxEntryMod.KdbxEntry
import typings.kdbxweb.distTypesFormatKdbxMod.MergeObjectMap
import typings.kdbxweb.distTypesFormatKdbxTimesMod.KdbxTimes
...
object distTypesFormatKdbxGroupMod {
