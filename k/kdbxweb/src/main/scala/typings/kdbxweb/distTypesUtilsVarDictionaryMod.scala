...
object distTypesUtilsVarDictionaryMod {
  ...
  object ValueType extends StObject {
    ...
    sealed trait Bool
      extends StObject
         with ValueType
    /* 8 */ val Bool: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Bool & Double = js.native
    
    @js.native
    sealed trait Bytes
      extends StObject
         with ValueType
    /* 66 */ val Bytes: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Bytes & Double = js.native
    
    @js.native
    sealed trait Int32
      extends StObject
         with ValueType
    /* 12 */ val Int32: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Int32 & Double = js.native
    
    @js.native
    sealed trait Int64
      extends StObject
         with ValueType
    /* 13 */ val Int64: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.Int64 & Double = js.native
    
    @js.native
    sealed trait String
      extends StObject
         with ValueType
    /* 24 */ val String: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.String & Double = js.native
    
    @js.native
    sealed trait UInt32
      extends StObject
         with ValueType
    /* 4 */ val UInt32: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.UInt32 & Double = js.native
    
    @js.native
    sealed trait UInt64
      extends StObject
         with ValueType
    /* 5 */ val UInt64: typings.kdbxweb.distTypesUtilsVarDictionaryMod.ValueType.UInt64 & Double = js.native
  }
