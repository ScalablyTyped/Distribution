...
import typings.kdbxweb.distTypesCryptoProtectSaltGeneratorMod.ProtectSaltGenerator
...
object distTypesUtilsXmlUtilsMod {
  
  @JSImport("kdbxweb/dist/types/utils/xml-utils", JSImport.Namespace)
  @js.native
  ...
  inline def getProtectedText(node: Node): js.UndefOr[ProtectedValue | String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getProtectedText")(node.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[ProtectedValue | String]]
  ...
  inline def getUuid(node: Node): js.UndefOr[KdbxUuid] = ^.asInstanceOf[js.Dynamic].applyDynamic("getUuid")(node.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[KdbxUuid]]
  ...
  inline def setProtectedText(node: Node, text: ProtectedValue): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setProtectedText")(node.asInstanceOf[js.Any], text.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def setProtectedValues(node: Node, protectSaltGenerator: ProtectSaltGenerator): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setProtectedValues")(node.asInstanceOf[js.Any], protectSaltGenerator.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def setUuid(node: Node, uuid: KdbxUuid): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setUuid")(node.asInstanceOf[js.Any], uuid.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def updateProtectedValuesSalt(node: Node, protectSaltGenerator: ProtectSaltGenerator): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("updateProtectedValuesSalt")(node.asInstanceOf[js.Any], protectSaltGenerator.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object global {
    ...
    trait Node extends StObject {
      ...
      var protectedValue: js.UndefOr[ProtectedValue] = js.undefined
    }
    object Node {
      ...
      implicit open class MutableBuilder[Self <: Node] (val x: Self) extends AnyVal {
        ...
        inline def setProtectedValue(value: ProtectedValue): Self = StObject.set(x, "protectedValue", value.asInstanceOf[js.Any])
        
        inline def setProtectedValueUndefined: Self = StObject.set(x, "protectedValue", js.undefined)
      }
    }
  }
}
