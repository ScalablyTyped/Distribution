...
object HmacBlockTransform {
  ...
  inline def getHmacKey(key: js.typedarray.ArrayBuffer, blockIndex: typings.kdbxweb.distTypesUtilsInt64Mod.Int64): js.Promise[js.typedarray.ArrayBuffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("getHmacKey")(key.asInstanceOf[js.Any], blockIndex.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.typedarray.ArrayBuffer]]
}
