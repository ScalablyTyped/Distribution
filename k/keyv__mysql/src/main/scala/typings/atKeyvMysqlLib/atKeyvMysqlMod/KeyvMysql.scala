package typings
package atKeyvMysqlLib.atKeyvMysqlMod
...
trait KeyvMysql
  extends nodeLib.eventsMod.EventEmitter
     with keyvLib.keyvMod.Store[js.UndefOr[java.lang.String]] {
  var namespace: js.UndefOr[java.lang.String] = js.native
  val ttlSupport: atKeyvMysqlLib.atKeyvMysqlLibNumbers.`false` = js.native
