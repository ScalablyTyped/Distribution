...
object ClientNs extends js.Object {
  ...
  class HostFrame () extends js.Object {
    ...
    /**
    			 ...
    			 */
    def setBackgroundColor(newColor: typings.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod.Global.ClientNs.Color): Unit = js.native
    def setBackgroundColor(
      newColor: typings.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod.Global.ClientNs.Color,
  ...
  object Color extends js.Object {
    /**
    			 ...
    			 */
    def fromHexString(colorString: java.lang.String): typings.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod.Global.ClientNs.Color = js.native
    /**
    			 * @see https://developer.knuddels.de/docs/classes/Client.Color.html#method_fromRGB
    			 */
    def fromRGB(red: Double, green: Double, blue: Double): typings.knuddelsDashUserappsDashApi.knuddelsDashUserappsDashApiMod.Global.ClientNs.Color = js.native
  }
