...
import typings.knuddelsDashUserappsDashApi.Anon_OnPotSealed
...
object KnuddelsServer extends js.Object {
  ...
  def createKnuddelPot(knuddelAmount: KnuddelAmount, params: Anon_OnPotSealed): KnuddelPot = js.native
  /**
