...
import typings.knuddelsUserappsApi.AnonData
...
object Client extends js.Object {
  ...
  class HostFrame () extends js.Object {
    ...
    /**
    			 ...
    			 */
    def setBackgroundColor(newColor: typings.knuddelsUserappsApi.mod._Global_.Client.Color): Unit = js.native
    def setBackgroundColor(newColor: typings.knuddelsUserappsApi.mod._Global_.Client.Color, durationMillis: Double): Unit = js.native
    /**
  ...
  object Color extends js.Object {
    /**
    			 ...
    			 */
    def fromHexString(colorString: java.lang.String): typings.knuddelsUserappsApi.mod._Global_.Client.Color = js.native
    /**
    			 * @see https://developer.knuddels.de/docs/classes/Client.Color.html#method_fromRGB
    			 */
    def fromRGB(red: Double, green: Double, blue: Double): typings.knuddelsUserappsApi.mod._Global_.Client.Color = js.native
  }
