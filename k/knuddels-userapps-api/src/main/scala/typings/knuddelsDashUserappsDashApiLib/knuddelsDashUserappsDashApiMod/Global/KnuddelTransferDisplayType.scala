...
object KnuddelTransferDisplayType extends js.Object {
  /**
  		 ...
  		 */
  val Post: knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.KnuddelTransferDisplayType = js.native
  /**
  		 * @see https://developer.knuddels.de/docs/classes/KnuddelTransferDisplayType.html#property_Private
  		 */
  val Private: knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.KnuddelTransferDisplayType = js.native
  /**
  		 * @see https://developer.knuddels.de/docs/classes/KnuddelTransferDisplayType.html#property_Public
  		 */
  val Public: knuddelsDashUserappsDashApiLib.knuddelsDashUserappsDashApiMod.Global.KnuddelTransferDisplayType = js.native
}
