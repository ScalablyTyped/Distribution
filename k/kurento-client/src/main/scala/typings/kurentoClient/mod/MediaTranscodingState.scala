...
/* Rewritten from type alias, can be one of: 
  - typings.kurentoClient.kurentoClientStrings.TRANSCODING
  - typings.kurentoClient.kurentoClientStrings.NOT_TRANSCODING
*/
trait MediaTranscodingState extends js.Object
