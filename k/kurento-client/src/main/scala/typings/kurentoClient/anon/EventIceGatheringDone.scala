...
object EventIceGatheringDone {
  ...
  @scala.inline
  def apply(source: String, tags: js.Array[Tag], timestamp: String, timestampMillis: String): EventIceGatheringDone = {
  ...
  @scala.inline
  implicit class EventIceGatheringDoneMutableBuilder[Self <: EventIceGatheringDone] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: IceGatheringDone): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
