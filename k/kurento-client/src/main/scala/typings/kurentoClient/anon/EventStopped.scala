...
object EventStopped {
  ...
  @scala.inline
  implicit class EventStoppedMutableBuilder[Self <: EventStopped] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: Stopped): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
