...
@js.native
trait EventStopped extends js.Object {
...
object EventStopped {
  ...
  @scala.inline
  implicit class EventStoppedOps[Self <: EventStopped] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: Stopped): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
