...
@js.native
trait EventIceCandidateFoundcan extends js.Object {
...
object EventIceCandidateFoundcan {
  ...
  @scala.inline
  implicit class EventIceCandidateFoundcanOps[Self <: EventIceCandidateFoundcan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCandidate(value: IceCandidate): Self = this.set("candidate", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: IceCandidateFound): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
