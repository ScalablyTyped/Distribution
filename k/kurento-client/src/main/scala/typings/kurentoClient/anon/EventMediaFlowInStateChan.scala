...
@js.native
trait EventMediaFlowInStateChan extends js.Object {
...
object EventMediaFlowInStateChan {
  ...
  @scala.inline
  implicit class EventMediaFlowInStateChanOps[Self <: EventMediaFlowInStateChan] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPadName(value: String): Self = this.set("padName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSource(value: String): Self = this.set("source", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setState(value: MediaFlowState): Self = this.set("state", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setType(value: MediaFlowInStateChange): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
