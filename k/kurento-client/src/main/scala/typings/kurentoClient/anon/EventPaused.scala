...
@js.native
trait EventPaused extends js.Object {
  ...
  var `type`: Paused = js.native
}
object EventPaused {
  
  @scala.inline
  def apply(source: String, tags: js.Array[Tag], timestamp: String, timestampMillis: String, `type`: Paused): EventPaused = {
  ...
  @scala.inline
  implicit class EventPausedOps[Self <: EventPaused] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: Paused): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
