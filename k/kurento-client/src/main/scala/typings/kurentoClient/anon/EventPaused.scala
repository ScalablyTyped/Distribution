...
/* Inlined kurento-client.kurento-client.Event<'Paused', {}> */
trait EventPaused extends StObject {
...
object EventPaused {
  ...
  @scala.inline
  def apply(source: String, tags: js.Array[Tag], timestamp: String, timestampMillis: String): EventPaused = {
    ...
    __obj.updateDynamic("type")("Paused")
    __obj.asInstanceOf[EventPaused]
  }
  
  @scala.inline
  implicit class EventPausedMutableBuilder[Self <: EventPaused] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: Paused): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
