...
@js.native
trait EventOnIceCandidatecandid extends js.Object {
...
object EventOnIceCandidatecandid {
  ...
  @scala.inline
  implicit class EventOnIceCandidatecandidOps[Self <: EventOnIceCandidatecandid] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: OnIceCandidate): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
