...
@js.native
trait IText extends IShape {
  def getAlign(): String = js.native
  def getBoxHeight(): Double = js.native
  def getBoxWidth(): Double = js.native
  ...
  def setAlign(align: String): js.Any = js.native
  ...
  def setLineHeight(lineHeight: Double): js.Any = js.native
  def setPadding(padding: Double): js.Any = js.native
