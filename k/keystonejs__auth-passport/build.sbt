...
name := "keystonejs__auth-passport"
version := "5.0-dt-20191115Z-8a880e"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "keystonejs__fields" % "5.1-dt-20191115Z-23b6e6",
  "org.scalablytyped" %%% "keystonejs__keystone" % "5.2-dt-20191115Z-b1f928",
