...
version := "5.0-dt-20191115Z-460a37"
scalaVersion := "2.13.3"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "keystonejs__fields" % "5.1-dt-20191115Z-64a1b4",
  "org.scalablytyped" %%% "keystonejs__keystone" % "6.0-dt-20200323Z-35092b",
