...
version := "5.0-dt-20191115Z-acb48e"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "keystonejs__fields" % "5.1-dt-20191115Z-9eb6d5",
  "org.scalablytyped" %%% "keystonejs__keystone" % "5.2-dt-20191231Z-15cd62",
