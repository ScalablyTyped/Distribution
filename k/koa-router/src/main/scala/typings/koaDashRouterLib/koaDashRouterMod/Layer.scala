...
class Layer protected () extends js.Object {
  def this(path: java.lang.String, methods: js.Array[java.lang.String], middleware: js.Array[IMiddleware[_, js.Object]]) = this()
  def this(path: java.lang.String, methods: js.Array[java.lang.String], middleware: IMiddleware[_, js.Object]) = this()
  def this(path: stdLib.RegExp, methods: js.Array[java.lang.String], middleware: js.Array[IMiddleware[_, js.Object]]) = this()
  def this(path: stdLib.RegExp, methods: js.Array[java.lang.String], middleware: IMiddleware[_, js.Object]) = this()
  def this(path: java.lang.String, methods: js.Array[java.lang.String], middleware: js.Array[IMiddleware[_, js.Object]], opts: ILayerOptions) = this()
  def this(path: java.lang.String, methods: js.Array[java.lang.String], middleware: IMiddleware[_, js.Object], opts: ILayerOptions) = this()
  def this(path: stdLib.RegExp, methods: js.Array[java.lang.String], middleware: js.Array[IMiddleware[_, js.Object]], opts: ILayerOptions) = this()
  def this(path: stdLib.RegExp, methods: js.Array[java.lang.String], middleware: IMiddleware[_, js.Object], opts: ILayerOptions) = this()
