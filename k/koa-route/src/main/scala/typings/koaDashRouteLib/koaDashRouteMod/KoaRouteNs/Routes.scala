...
trait Routes extends js.Object {
  ...
  def acl(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def acl(
    path: Path,
    fn: Handler,
  ...
  def all(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def all(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def bind(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def bind(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def checkout(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def checkout(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def connect(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def connect(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def copy(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def copy(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def del(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def del(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def delete(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def delete(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def get(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def get(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def head(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def head(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def link(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def link(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def lock(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def lock(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def merge(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def merge(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def mkactivity(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def mkactivity(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def mkcalendar(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def mkcalendar(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def mkcol(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def mkcol(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def move(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def move(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def msearch(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def msearch(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def notify(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def notify(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def options(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def options(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def patch(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def patch(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def post(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def post(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def propfind(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def propfind(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def proppatch(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def proppatch(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def purge(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def purge(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def put(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def put(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def rebind(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def rebind(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def report(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def report(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def search(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def search(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def subscribe(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def subscribe(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def trace(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def trace(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def unbind(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def unbind(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def unlink(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def unlink(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def unlock(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def unlock(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
  ...
  def unsubscribe(path: Path, fn: Handler): koaLib.koaMod.ApplicationNs.Middleware = js.native
  def unsubscribe(
    path: Path,
    fn: Handler,
    opts: pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.ParseOptions with pathDashToDashRegexpLib.pathDashToDashRegexpMod.pathToRegexpNs.RegExpOptions
