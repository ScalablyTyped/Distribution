...
import typings.khanacademySimpleMarkdown.distMod.ArrayNodeOutput
import typings.khanacademySimpleMarkdown.distMod.Output
import typings.khanacademySimpleMarkdown.distMod.ReactElements
import typings.khanacademySimpleMarkdown.distMod.SingleASTNode
...
object anon {
  ...
  /* Inlined std.Array<string> & {  index :number} */
  @js.native
  trait Arraystringindexnumber
    extends StObject
       with /* standard es5 */
  ...
  /* Inlined std.Array<string> & {  index :number | undefined} */
  @js.native
  trait Arraystringindexnumberund
    extends StObject
       with /* standard es5 */
  /* n */ NumberDictionary[String]
       with Capture {
  ...
  object Dictkey {
    ...
    inline def apply(source: String): Dictkey = {
  ...
  trait Html extends StObject {
    ...
    val html: ArrayNodeOutput[String]
    
    val react: ArrayNodeOutput[ReactElements]
  }
  object Html {
    
    inline def apply(
      html: (/* node */ js.Array[SingleASTNode], /* nestedOutput */ Output[String], /* state */ State) => String,
      react: (/* node */ js.Array[SingleASTNode], /* nestedOutput */ Output[ReactElements], /* state */ State) => ReactElements
    ): Html = {
      val __obj = js.Dynamic.literal(html = js.Any.fromFunction3(html), react = js.Any.fromFunction3(react))
  ...
  trait HtmlArrayNodeOutput extends StObject {
    
    val html: ArrayNodeOutput[String]
  }
  object HtmlArrayNodeOutput {
    
    inline def apply(
      html: (/* node */ js.Array[SingleASTNode], /* nestedOutput */ Output[String], /* state */ State) => String
    ): HtmlArrayNodeOutput = {
      val __obj = js.Dynamic.literal(html = js.Any.fromFunction3(html))
      __obj.asInstanceOf[HtmlArrayNodeOutput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: HtmlArrayNodeOutput] (val x: Self) extends AnyVal {
  ...
  object React {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[React]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: React] (val x: Self) extends AnyVal {
