...
object ConfigOptions {
  ...
  implicit class ConfigOptionsOps[Self <: ConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNyanReporter(value: NyanCatOptions): Self = this.set("nyanReporter", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteNyanReporter: Self = this.set("nyanReporter", js.undefined)
  }
}
