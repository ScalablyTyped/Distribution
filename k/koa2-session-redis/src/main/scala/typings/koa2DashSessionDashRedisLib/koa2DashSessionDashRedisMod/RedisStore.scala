...
@js.native
trait RedisStore
  extends koaDashSessionLib.koaDashSessionMod.stores {
  /**
  ...
  def set(
    ...
    sess: stdLib.Partial[koaDashSessionLib.koaDashSessionMod.Session] with koa2DashSessionDashRedisLib.Anon_Expire
  ): js.Any = js.native
  /**
