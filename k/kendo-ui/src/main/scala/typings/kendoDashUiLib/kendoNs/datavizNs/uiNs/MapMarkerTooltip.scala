...
trait MapMarkerTooltip extends js.Object {
  ...
  var content: js.UndefOr[java.lang.String | js.Function | MapMarkerTooltipContent] = js.undefined
...
object MapMarkerTooltip {
  ...
  def apply(
    ...
    content: java.lang.String | js.Function | MapMarkerTooltipContent = null,
