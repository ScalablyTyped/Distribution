...
class Text protected () extends Element {
  ...
  def fill(color: java.lang.String): Text = js.native
  def fill(color: java.lang.String, opacity: scala.Double): Text = js.native
  ...
  def stroke(color: java.lang.String): Text = js.native
  def stroke(color: java.lang.String, width: scala.Double): Text = js.native
  def stroke(color: java.lang.String, width: scala.Double, opacity: scala.Double): Text = js.native
}
