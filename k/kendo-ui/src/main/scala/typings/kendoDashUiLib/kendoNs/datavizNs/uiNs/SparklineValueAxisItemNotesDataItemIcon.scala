...
trait SparklineValueAxisItemNotesDataItemIcon extends js.Object {
...
object SparklineValueAxisItemNotesDataItemIcon {
  ...
  def apply(
    ...
    border: SparklineValueAxisItemNotesDataItemIconBorder = null,
    size: scala.Int | scala.Double = null,
    `type`: java.lang.String = null,
    visible: js.UndefOr[scala.Boolean] = js.undefined
  ): SparklineValueAxisItemNotesDataItemIcon = {
