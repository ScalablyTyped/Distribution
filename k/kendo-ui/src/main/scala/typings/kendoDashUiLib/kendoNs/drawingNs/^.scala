...
object ^ extends js.Object {
  ...
  def exportImage(group: Group, options: js.Any): kendoDashUiLib.JQueryPromise[_] = js.native
  def exportPDF(group: Group, options: PDFOptions): kendoDashUiLib.JQueryPromise[_] = js.native
  def exportSVG(group: Group, options: js.Any): kendoDashUiLib.JQueryPromise[_] = js.native
  def fit(element: Element, rect: kendoDashUiLib.kendoNs.geometryNs.Rect): scala.Unit = js.native
