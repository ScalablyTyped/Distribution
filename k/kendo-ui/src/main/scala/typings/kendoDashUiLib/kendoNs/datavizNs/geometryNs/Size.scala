...
class Size ()
  ...
  def equals(other: kendoDashUiLib.kendoNs.geometryNs.Size): scala.Boolean = js.native
  def getHeight(): scala.Double = js.native
  def getWidth(): scala.Double = js.native
  def setHeight(value: scala.Double): kendoDashUiLib.kendoNs.geometryNs.Size = js.native
