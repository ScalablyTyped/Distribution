...
object TabStrip {
  ...
  /* static member */
  inline def extend(proto: js.Object): typings.kendoUi.kendo.mobile.ui.TabStrip = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(proto.asInstanceOf[js.Any]).asInstanceOf[typings.kendoUi.kendo.mobile.ui.TabStrip]
  
  /* static member */
  @JSGlobal("kendo.mobile.ui.TabStrip.fn")
  @js.native
  def fn: typings.kendoUi.kendo.mobile.ui.TabStrip = js.native
  inline def fn_=(x: typings.kendoUi.kendo.mobile.ui.TabStrip): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
