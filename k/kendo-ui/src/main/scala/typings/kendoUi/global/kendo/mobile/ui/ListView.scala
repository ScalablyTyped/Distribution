...
object ListView {
  ...
  /* static member */
  inline def extend(proto: js.Object): typings.kendoUi.kendo.mobile.ui.ListView = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(proto.asInstanceOf[js.Any]).asInstanceOf[typings.kendoUi.kendo.mobile.ui.ListView]
  
  /* static member */
  @JSGlobal("kendo.mobile.ui.ListView.fn")
  @js.native
  def fn: typings.kendoUi.kendo.mobile.ui.ListView = js.native
  inline def fn_=(x: typings.kendoUi.kendo.mobile.ui.ListView): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
