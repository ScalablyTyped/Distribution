...
object Layout {
  ...
  /* static member */
  inline def extend(proto: js.Object): typings.kendoUi.kendo.mobile.ui.Layout = ^.asInstanceOf[js.Dynamic].applyDynamic("extend")(proto.asInstanceOf[js.Any]).asInstanceOf[typings.kendoUi.kendo.mobile.ui.Layout]
  
  /* static member */
  @JSGlobal("kendo.mobile.ui.Layout.fn")
  @js.native
  def fn: typings.kendoUi.kendo.mobile.ui.Layout = js.native
  inline def fn_=(x: typings.kendoUi.kendo.mobile.ui.Layout): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
}
