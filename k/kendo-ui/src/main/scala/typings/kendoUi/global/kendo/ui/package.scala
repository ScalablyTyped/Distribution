...
package object ui {
  ...
  @scala.inline
  def plugin(widget: js.Any, register: js.UndefOr[scala.Nothing], prefix: java.lang.String): scala.Unit = (typings.kendoUi.global.kendo.ui.^.asInstanceOf[js.Dynamic].applyDynamic("plugin")(widget.asInstanceOf[js.Any], register.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
  @scala.inline
