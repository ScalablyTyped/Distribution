...
object TypeofuiActionSheet {
  ...
  inline def apply(
    ...
    DetailButton: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[DetailButtonOptions], DetailButton]) & TypeofDetailButton,
    Drawer: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[DrawerOptions], Drawer]) & TypeofDrawerExtend,
    Layout: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[LayoutOptions], Layout]) & TypeofLayout,
    ListView: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[ListViewOptions], ListView]) & TypeofListViewExtend,
    Loader: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[LoaderOptions], Loader]) & TypeofLoaderExtend,
    ...
    Switch: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[SwitchOptions], Switch]) & TypeofSwitchExtend,
    TabStrip: (Instantiable2[/* element */ Element, /* options */ js.UndefOr[TabStripOptions], TabStrip]) & TypeofTabStripExtend,
