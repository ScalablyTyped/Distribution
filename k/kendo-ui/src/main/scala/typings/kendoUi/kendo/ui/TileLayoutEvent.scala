...
trait TileLayoutEvent extends js.Object {
  ...
  var sender: TileLayout = js.native
}
object TileLayoutEvent {
  ...
  @scala.inline
  implicit class TileLayoutEventOps[Self <: TileLayoutEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: TileLayout): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
