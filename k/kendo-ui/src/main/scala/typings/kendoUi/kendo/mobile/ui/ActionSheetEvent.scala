...
trait ActionSheetEvent extends js.Object {
  ...
  var sender: ActionSheet = js.native
...
object ActionSheetEvent {
  ...
  @scala.inline
  implicit class ActionSheetEventOps[Self <: ActionSheetEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ActionSheet): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
