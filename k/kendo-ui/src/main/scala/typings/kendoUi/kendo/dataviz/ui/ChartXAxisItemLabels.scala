...
object ChartXAxisItemLabels {
  ...
  @scala.inline
  implicit class ChartXAxisItemLabelsMutableBuilder[Self <: ChartXAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartXAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDateFormats(value: ChartXAxisItemLabelsDateFormats): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: Double | ChartXAxisItemLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPadding(value: Double | ChartXAxisItemLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaddingUndefined: Self = StObject.set(x, "padding", js.undefined)
    
    @scala.inline
    def setRotation(value: String | Double | ChartXAxisItemLabelsRotation): Self = StObject.set(x, "rotation", value.asInstanceOf[js.Any])
