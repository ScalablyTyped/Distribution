...
object StockChartEvent {
  ...
  @scala.inline
  implicit class StockChartEventOps[Self <: StockChartEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: StockChart): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
