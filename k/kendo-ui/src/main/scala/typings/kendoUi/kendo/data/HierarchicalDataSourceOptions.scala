...
object HierarchicalDataSourceOptions {
  ...
  @scala.inline
  implicit class HierarchicalDataSourceOptionsOps[Self <: HierarchicalDataSourceOptions] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSchema(value: HierarchicalDataSourceSchema): Self = this.set("schema", value.asInstanceOf[js.Any])
    @scala.inline
