...
object PDFViewerEvent {
  ...
  @scala.inline
  implicit class PDFViewerEventOps[Self <: PDFViewerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: PDFViewer): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
