...
object ColorPaletteEvent {
  ...
  @scala.inline
  implicit class ColorPaletteEventOps[Self <: ColorPaletteEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ColorPalette): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
