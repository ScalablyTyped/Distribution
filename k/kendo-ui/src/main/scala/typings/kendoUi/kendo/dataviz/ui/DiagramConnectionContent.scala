...
@js.native
trait DiagramConnectionContent extends StObject {
...
object DiagramConnectionContent {
  ...
  @scala.inline
  def apply(): DiagramConnectionContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramConnectionContent]
  }
  
  @scala.inline
  implicit class DiagramConnectionContentMutableBuilder[Self <: DiagramConnectionContent] (val x: Self) extends AnyVal {
