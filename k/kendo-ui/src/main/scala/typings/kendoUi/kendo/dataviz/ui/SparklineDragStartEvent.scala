...
object SparklineDragStartEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Sparkline): SparklineDragStartEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineDragStartEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineDragStartEvent] (val x: Self) extends AnyVal {
