...
object ChartTooltip {
  ...
  implicit class ChartTooltipOps[Self <: ChartTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setPadding(value: ChartTooltipPadding): Self = this.set("padding", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSharedTemplate(value: String | js.Function): Self = this.set("sharedTemplate", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSharedTemplate: Self = this.set("sharedTemplate", js.undefined)
    @scala.inline
