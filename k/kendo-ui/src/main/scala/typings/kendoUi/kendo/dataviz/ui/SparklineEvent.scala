...
object SparklineEvent {
  ...
  @scala.inline
  implicit class SparklineEventOps[Self <: SparklineEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Sparkline): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
