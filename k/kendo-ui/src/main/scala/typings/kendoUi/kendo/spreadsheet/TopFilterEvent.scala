...
object TopFilterEvent {
  ...
  @scala.inline
  implicit class TopFilterEventOps[Self <: TopFilterEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: TopFilter): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
