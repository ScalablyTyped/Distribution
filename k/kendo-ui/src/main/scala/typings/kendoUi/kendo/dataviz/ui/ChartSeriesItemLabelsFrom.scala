...
object ChartSeriesItemLabelsFrom {
  ...
  @scala.inline
  implicit class ChartSeriesItemLabelsFromOps[Self <: ChartSeriesItemLabelsFrom] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: ChartSeriesItemLabelsFromBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMargin(value: Double | ChartSeriesItemLabelsFromMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMargin: Self = this.set("margin", js.undefined)
    @scala.inline
    def setPadding(value: Double | ChartSeriesItemLabelsFromPadding): Self = this.set("padding", value.asInstanceOf[js.Any])
    @scala.inline
