...
object StockChartDragEndEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartDragEndEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartDragEndEvent]
  }
  
  @scala.inline
  implicit class StockChartDragEndEventMutableBuilder[Self <: StockChartDragEndEvent] (val x: Self) extends AnyVal {
