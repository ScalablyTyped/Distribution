...
object DateInputMessages {
  ...
  @scala.inline
  def apply(): DateInputMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DateInputMessages]
  }
  
  @scala.inline
  implicit class DateInputMessagesOps[Self <: DateInputMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDayperiod(value: String): Self = this.set("dayperiod", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDayperiod: Self = this.set("dayperiod", js.undefined)
