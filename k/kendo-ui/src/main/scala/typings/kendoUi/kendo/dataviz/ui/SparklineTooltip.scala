...
object SparklineTooltip {
  ...
  @scala.inline
  implicit class SparklineTooltipOps[Self <: SparklineTooltip] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: SparklineTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSharedTemplate(value: String): Self = this.set("sharedTemplate", value.asInstanceOf[js.Any])
    @scala.inline
