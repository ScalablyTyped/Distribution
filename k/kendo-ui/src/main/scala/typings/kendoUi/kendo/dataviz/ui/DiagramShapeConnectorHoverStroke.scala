...
object DiagramShapeConnectorHoverStroke {
  ...
  @scala.inline
  def apply(): DiagramShapeConnectorHoverStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeConnectorHoverStroke]
  }
  
  @scala.inline
  implicit class DiagramShapeConnectorHoverStrokeMutableBuilder[Self <: DiagramShapeConnectorHoverStroke] (val x: Self) extends AnyVal {
