...
@js.native
trait TextAreaEvent extends js.Object {
  
  def isDefaultPrevented(): Boolean = js.native
  
  var preventDefault: js.Function = js.native
  
  var sender: TextArea = js.native
}
object TextAreaEvent {
  ...
  @scala.inline
  implicit class TextAreaEventOps[Self <: TextAreaEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: TextArea): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
