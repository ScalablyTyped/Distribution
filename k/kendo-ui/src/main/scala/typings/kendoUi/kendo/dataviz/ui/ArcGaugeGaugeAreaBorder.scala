...
@js.native
trait ArcGaugeGaugeAreaBorder extends StObject {
...
object ArcGaugeGaugeAreaBorder {
  ...
  @scala.inline
  def apply(): ArcGaugeGaugeAreaBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ArcGaugeGaugeAreaBorder]
  }
  
  @scala.inline
  implicit class ArcGaugeGaugeAreaBorderMutableBuilder[Self <: ArcGaugeGaugeAreaBorder] (val x: Self) extends AnyVal {
