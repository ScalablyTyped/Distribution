...
object ChartYAxisItemCrosshairTooltip {
  ...
  @scala.inline
  implicit class ChartYAxisItemCrosshairTooltipOps[Self <: ChartYAxisItemCrosshairTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartYAxisItemCrosshairTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPadding(value: ChartYAxisItemCrosshairTooltipPadding): Self = this.set("padding", value.asInstanceOf[js.Any])
