...
object ChartSeriesItemLabelsTo {
  ...
  @scala.inline
  implicit class ChartSeriesItemLabelsToMutableBuilder[Self <: ChartSeriesItemLabelsTo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartSeriesItemLabelsToBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: Double | ChartSeriesItemLabelsToMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarginUndefined: Self = StObject.set(x, "margin", js.undefined)
    
    @scala.inline
    def setPadding(value: Double | ChartSeriesItemLabelsToPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
