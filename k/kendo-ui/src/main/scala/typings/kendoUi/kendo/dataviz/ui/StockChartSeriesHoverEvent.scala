...
object StockChartSeriesHoverEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartSeriesHoverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartSeriesHoverEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartSeriesHoverEvent] (val x: Self) extends AnyVal {
    ...
    inline def setSeries(value: StockChartSeriesHoverEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
