...
object ChartPaneEvent {
  ...
  @scala.inline
  implicit class ChartPaneEventOps[Self <: ChartPaneEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ChartPane): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
