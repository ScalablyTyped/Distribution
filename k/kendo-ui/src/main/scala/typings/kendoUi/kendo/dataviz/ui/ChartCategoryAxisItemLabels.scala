...
object ChartCategoryAxisItemLabels {
  ...
  inline def apply(): ChartCategoryAxisItemLabels = {
  ...
  extension [Self <: ChartCategoryAxisItemLabels](x: Self) {
    ...
    inline def setBorder(value: ChartCategoryAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setDateFormats(value: ChartCategoryAxisItemLabelsDateFormats): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
    ...
    inline def setMargin(value: Double | ChartCategoryAxisItemLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
