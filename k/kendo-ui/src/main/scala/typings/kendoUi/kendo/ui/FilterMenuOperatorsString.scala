...
trait FilterMenuOperatorsString extends js.Object {
  ...
  @JSName("eq")
  var eq_FFilterMenuOperatorsString: js.UndefOr[String] = js.native
...
object FilterMenuOperatorsString {
  ...
  @scala.inline
  implicit class FilterMenuOperatorsStringOps[Self <: FilterMenuOperatorsString] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setIsnotnullorempty(value: String): Self = this.set("isnotnullorempty", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsnotnullorempty: Self = this.set("isnotnullorempty", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setIsnullorempty(value: String): Self = this.set("isnullorempty", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteIsnullorempty: Self = this.set("isnullorempty", js.undefined)
    @scala.inline
