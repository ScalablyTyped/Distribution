...
object PathFillGradient {
  ...
  inline def apply(): PathFillGradient = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PathFillGradient]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PathFillGradient] (val x: Self) extends AnyVal {
    ...
    inline def setStops(value: js.Array[PathFillGradientStop]): Self = StObject.set(x, "stops", value.asInstanceOf[js.Any])
    
    inline def setStopsUndefined: Self = StObject.set(x, "stops", js.undefined)
    
    inline def setStopsVarargs(value: PathFillGradientStop*): Self = StObject.set(x, "stops", js.Array(value*))
