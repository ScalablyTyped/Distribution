...
object PathFillGradient {
  ...
  @scala.inline
  implicit class PathFillGradientOps[Self <: PathFillGradient] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStopsVarargs(value: PathFillGradientStop*): Self = this.set("stops", js.Array(value :_*))
    @scala.inline
    def setStops(value: js.Array[PathFillGradientStop]): Self = this.set("stops", value.asInstanceOf[js.Any])
    @scala.inline
