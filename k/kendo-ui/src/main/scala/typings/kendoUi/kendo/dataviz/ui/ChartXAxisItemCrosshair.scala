...
trait ChartXAxisItemCrosshair extends js.Object {
  ...
  var tooltip: js.UndefOr[ChartXAxisItemCrosshairTooltip] = js.native
...
object ChartXAxisItemCrosshair {
  ...
  @scala.inline
  implicit class ChartXAxisItemCrosshairOps[Self <: ChartXAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(value: ChartXAxisItemCrosshairTooltip): Self = this.set("tooltip", value.asInstanceOf[js.Any])
