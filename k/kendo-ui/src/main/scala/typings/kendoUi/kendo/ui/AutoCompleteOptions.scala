...
object AutoCompleteOptions {
  ...
  implicit class AutoCompleteOptionsOps[Self <: AutoCompleteOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAnimation(value: Boolean | AutoCompleteAnimation): Self = this.set("animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setChange(value: /* e */ AutoCompleteChangeEvent => Unit): Self = this.set("change", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setClose(value: /* e */ AutoCompleteCloseEvent => Unit): Self = this.set("close", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteClose: Self = this.set("close", js.undefined)
    
    @scala.inline
    def setDataBound(value: /* e */ AutoCompleteDataBoundEvent => Unit): Self = this.set("dataBound", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setFiltering(value: /* e */ AutoCompleteFilteringEvent => Unit): Self = this.set("filtering", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setOpen(value: /* e */ AutoCompleteOpenEvent => Unit): Self = this.set("open", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setSelect(value: /* e */ AutoCompleteSelectEvent => Unit): Self = this.set("select", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setVirtual(value: Boolean | AutoCompleteVirtual): Self = this.set("virtual", value.asInstanceOf[js.Any])
