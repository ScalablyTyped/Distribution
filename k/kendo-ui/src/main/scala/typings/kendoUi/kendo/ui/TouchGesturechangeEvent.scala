...
object TouchGesturechangeEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Touch): TouchGesturechangeEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[TouchGesturechangeEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TouchGesturechangeEvent] (val x: Self) extends AnyVal {
