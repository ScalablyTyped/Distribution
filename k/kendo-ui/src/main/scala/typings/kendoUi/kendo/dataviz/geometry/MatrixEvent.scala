...
object MatrixEvent {
  ...
  @scala.inline
  implicit class MatrixEventOps[Self <: MatrixEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: Matrix): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
