...
object SparklineValueAxisItemNotesDataItemLine {
  ...
  inline def apply(): SparklineValueAxisItemNotesDataItemLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineValueAxisItemNotesDataItemLine]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineValueAxisItemNotesDataItemLine] (val x: Self) extends AnyVal {
