...
object MapShapeMouseLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Map): MapShapeMouseLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[MapShapeMouseLeaveEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MapShapeMouseLeaveEvent] (val x: Self) extends AnyVal {
