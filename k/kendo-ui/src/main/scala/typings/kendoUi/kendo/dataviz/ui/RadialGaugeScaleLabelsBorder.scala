...
trait RadialGaugeScaleLabelsBorder extends StObject {
...
object RadialGaugeScaleLabelsBorder {
  ...
  @scala.inline
  implicit class RadialGaugeScaleLabelsBorderMutableBuilder[Self <: RadialGaugeScaleLabelsBorder] (val x: Self) extends AnyVal {
