...
object FilterField {
  ...
  @scala.inline
  implicit class FilterFieldOps[Self <: FilterField] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEditorTemplate(value: String | js.Function): Self = this.set("editorTemplate", value.asInstanceOf[js.Any])
