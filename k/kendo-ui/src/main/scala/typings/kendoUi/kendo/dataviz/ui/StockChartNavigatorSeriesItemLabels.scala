...
object StockChartNavigatorSeriesItemLabels {
  ...
  @scala.inline
  implicit class StockChartNavigatorSeriesItemLabelsOps[Self <: StockChartNavigatorSeriesItemLabels] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartNavigatorSeriesItemLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
