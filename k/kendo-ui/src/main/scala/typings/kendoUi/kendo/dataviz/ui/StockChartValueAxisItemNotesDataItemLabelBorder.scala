...
@js.native
trait StockChartValueAxisItemNotesDataItemLabelBorder extends js.Object {
...
object StockChartValueAxisItemNotesDataItemLabelBorder {
  ...
  @scala.inline
  implicit class StockChartValueAxisItemNotesDataItemLabelBorderOps[Self <: StockChartValueAxisItemNotesDataItemLabelBorder] (val x: Self) extends AnyVal {
    @scala.inline
