...
trait StockChartValueAxisItemNotesDataItemLabelBorder extends StObject {
...
object StockChartValueAxisItemNotesDataItemLabelBorder {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartValueAxisItemNotesDataItemLabelBorder] (val x: Self) extends AnyVal {
