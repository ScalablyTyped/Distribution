...
object MapShapeCreatedEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Map): MapShapeCreatedEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[MapShapeCreatedEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MapShapeCreatedEvent] (val x: Self) extends AnyVal {
