...
trait PivotGridV2Pdf extends StObject {
  ...
  var margin: js.UndefOr[PivotGridV2PdfMargin] = js.undefined
...
object PivotGridV2Pdf {
  
  inline def apply(): PivotGridV2Pdf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PivotGridV2Pdf]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PivotGridV2Pdf] (val x: Self) extends AnyVal {
    ...
    inline def setMargin(value: PivotGridV2PdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
