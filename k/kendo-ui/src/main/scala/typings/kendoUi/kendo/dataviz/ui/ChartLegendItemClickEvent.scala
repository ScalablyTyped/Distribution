...
object ChartLegendItemClickEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartLegendItemClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartLegendItemClickEvent]
  }
  
  @scala.inline
  implicit class ChartLegendItemClickEventMutableBuilder[Self <: ChartLegendItemClickEvent] (val x: Self) extends AnyVal {
