...
object DropDownListEvent {
  ...
  @scala.inline
  implicit class DropDownListEventMutableBuilder[Self <: DropDownListEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: DropDownList): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
