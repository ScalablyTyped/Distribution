...
trait SplitButtonItem extends StObject {
...
object SplitButtonItem {
  
  inline def apply(): SplitButtonItem = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SplitButtonItem]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SplitButtonItem] (val x: Self) extends AnyVal {
