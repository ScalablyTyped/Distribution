...
object FilterMenuMessages {
  ...
  inline def apply(): FilterMenuMessages = {
  ...
  extension [Self <: FilterMenuMessages](x: Self) {
    ...
    inline def setAdditionalOperatorUndefined: Self = StObject.set(x, "additionalOperator", js.undefined)
    ...
    inline def setSelectValue(value: String): Self = StObject.set(x, "selectValue", value.asInstanceOf[js.Any])
