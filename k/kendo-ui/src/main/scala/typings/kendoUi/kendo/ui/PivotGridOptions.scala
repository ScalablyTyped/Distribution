...
object PivotGridOptions {
  ...
  extension [Self <: PivotGridOptions](x: Self) {
    ...
    inline def setCollapseMember(value: /* e */ PivotGridCollapseMemberEvent => Unit): Self = StObject.set(x, "collapseMember", js.Any.fromFunction1(value))
    ...
    inline def setDataBinding(value: /* e */ PivotGridDataBindingEvent => Unit): Self = StObject.set(x, "dataBinding", js.Any.fromFunction1(value))
    
    inline def setDataBindingUndefined: Self = StObject.set(x, "dataBinding", js.undefined)
    
    inline def setDataBound(value: /* e */ PivotGridDataBoundEvent => Unit): Self = StObject.set(x, "dataBound", js.Any.fromFunction1(value))
    ...
    inline def setExcelExport(value: /* e */ PivotGridExcelExportEvent => Unit): Self = StObject.set(x, "excelExport", js.Any.fromFunction1(value))
    ...
    inline def setExpandMember(value: /* e */ PivotGridExpandMemberEvent => Unit): Self = StObject.set(x, "expandMember", js.Any.fromFunction1(value))
    ...
    inline def setPdfExport(value: /* e */ PivotGridPdfExportEvent => Unit): Self = StObject.set(x, "pdfExport", js.Any.fromFunction1(value))
