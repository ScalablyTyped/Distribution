...
object PointEvent {
  ...
  @scala.inline
  implicit class PointEventMutableBuilder[Self <: PointEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Point): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
