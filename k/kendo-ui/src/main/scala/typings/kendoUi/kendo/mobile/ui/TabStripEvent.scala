...
object TabStripEvent {
  ...
  @scala.inline
  implicit class TabStripEventOps[Self <: TabStripEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: TabStrip): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
