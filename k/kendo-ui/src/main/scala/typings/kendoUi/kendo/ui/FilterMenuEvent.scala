...
object FilterMenuEvent {
  ...
  @scala.inline
  implicit class FilterMenuEventOps[Self <: FilterMenuEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: FilterMenu): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
