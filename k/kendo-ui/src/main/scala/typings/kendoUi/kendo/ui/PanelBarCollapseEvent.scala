...
object PanelBarCollapseEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: PanelBar): PanelBarCollapseEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[PanelBarCollapseEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PanelBarCollapseEvent] (val x: Self) extends AnyVal {
