...
trait ColorPickerEvent extends js.Object {
  ...
  var sender: ColorPicker = js.native
...
object ColorPickerEvent {
  ...
  @scala.inline
  implicit class ColorPickerEventOps[Self <: ColorPickerEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ColorPicker): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
