...
object DateTimePickerEvent {
  ...
  @scala.inline
  implicit class DateTimePickerEventMutableBuilder[Self <: DateTimePickerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: DateTimePicker): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
