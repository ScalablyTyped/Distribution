...
object ButtonGroupEvent {
  ...
  @scala.inline
  implicit class ButtonGroupEventOps[Self <: ButtonGroupEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ButtonGroup): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
