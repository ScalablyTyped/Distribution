...
object ConnectionHover {
  ...
  @scala.inline
  implicit class ConnectionHoverOps[Self <: ConnectionHover] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStroke(value: ConnectionHoverStroke): Self = this.set("stroke", value.asInstanceOf[js.Any])
    @scala.inline
