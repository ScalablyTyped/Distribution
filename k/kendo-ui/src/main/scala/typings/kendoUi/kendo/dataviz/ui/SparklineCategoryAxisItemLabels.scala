...
trait SparklineCategoryAxisItemLabels extends StObject {
  ...
  var dateFormats: js.UndefOr[Any] = js.undefined
...
object SparklineCategoryAxisItemLabels {
  ...
  inline def apply(): SparklineCategoryAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineCategoryAxisItemLabels]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: SparklineCategoryAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setDateFormats(value: Any): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
