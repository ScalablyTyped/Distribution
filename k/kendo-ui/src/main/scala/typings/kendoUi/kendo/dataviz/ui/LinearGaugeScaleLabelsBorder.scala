...
trait LinearGaugeScaleLabelsBorder extends StObject {
...
object LinearGaugeScaleLabelsBorder {
  ...
  @scala.inline
  def apply(): LinearGaugeScaleLabelsBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LinearGaugeScaleLabelsBorder]
  }
  
  @scala.inline
  implicit class LinearGaugeScaleLabelsBorderMutableBuilder[Self <: LinearGaugeScaleLabelsBorder] (val x: Self) extends AnyVal {
