...
object StockChartNavigatorCategoryAxisCrosshairTooltip {
  ...
  inline def apply(): StockChartNavigatorCategoryAxisCrosshairTooltip = {
  ...
  implicit open class MutableBuilder[Self <: StockChartNavigatorCategoryAxisCrosshairTooltip] (val x: Self) extends AnyVal {
    ...
    inline def setBorder(value: StockChartNavigatorCategoryAxisCrosshairTooltipBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setPadding(value: StockChartNavigatorCategoryAxisCrosshairTooltipPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
