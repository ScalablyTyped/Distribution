...
object DiagramShapeDefaultsConnectorHoverStroke {
  ...
  @scala.inline
  def apply(): DiagramShapeDefaultsConnectorHoverStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeDefaultsConnectorHoverStroke]
  }
  
  @scala.inline
  implicit class DiagramShapeDefaultsConnectorHoverStrokeMutableBuilder[Self <: DiagramShapeDefaultsConnectorHoverStroke] (val x: Self) extends AnyVal {
