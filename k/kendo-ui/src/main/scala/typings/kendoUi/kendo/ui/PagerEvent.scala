...
object PagerEvent {
  ...
  @scala.inline
  implicit class PagerEventOps[Self <: PagerEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: Pager): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
