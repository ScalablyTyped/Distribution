...
object PivotConfiguratorV2Event {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: PivotConfiguratorV2): PivotConfiguratorV2Event = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[PivotConfiguratorV2Event]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PivotConfiguratorV2Event] (val x: Self) extends AnyVal {
