...
object FileManagerEvent {
  ...
  @scala.inline
  implicit class FileManagerEventOps[Self <: FileManagerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: FileManager): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
