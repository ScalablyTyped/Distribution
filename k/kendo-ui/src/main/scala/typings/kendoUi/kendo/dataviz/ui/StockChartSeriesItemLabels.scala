...
trait StockChartSeriesItemLabels extends StObject {
  ...
  var border: js.UndefOr[StockChartSeriesItemLabelsBorder] = js.native
...
object StockChartSeriesItemLabels {
  ...
  @scala.inline
  def apply(): StockChartSeriesItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartSeriesItemLabels]
  }
  
  @scala.inline
  implicit class StockChartSeriesItemLabelsMutableBuilder[Self <: StockChartSeriesItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartSeriesItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
