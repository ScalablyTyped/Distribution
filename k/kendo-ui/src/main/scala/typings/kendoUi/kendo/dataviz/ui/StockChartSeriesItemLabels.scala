...
object StockChartSeriesItemLabels {
  ...
  @scala.inline
  implicit class StockChartSeriesItemLabelsOps[Self <: StockChartSeriesItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartSeriesItemLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
