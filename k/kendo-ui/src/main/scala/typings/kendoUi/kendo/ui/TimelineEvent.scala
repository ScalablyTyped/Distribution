...
object TimelineEvent {
  ...
  @scala.inline
  implicit class TimelineEventMutableBuilder[Self <: TimelineEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Timeline): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
