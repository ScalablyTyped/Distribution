...
object ChartSeriesItemLabels {
  ...
  @scala.inline
  implicit class ChartSeriesItemLabelsMutableBuilder[Self <: ChartSeriesItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartSeriesItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setFrom(value: ChartSeriesItemLabelsFrom): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFromUndefined: Self = StObject.set(x, "from", js.undefined)
    
    @scala.inline
    def setMargin(value: Double | ChartSeriesItemLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMarginUndefined: Self = StObject.set(x, "margin", js.undefined)
    
    @scala.inline
    def setPadding(value: Double | ChartSeriesItemLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTo(value: ChartSeriesItemLabelsTo): Self = StObject.set(x, "to", value.asInstanceOf[js.Any])
