...
object ChartSeriesEvent {
  ...
  @scala.inline
  implicit class ChartSeriesEventOps[Self <: ChartSeriesEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ChartSeries): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
