...
object TextBlockEvent {
  ...
  @scala.inline
  implicit class TextBlockEventOps[Self <: TextBlockEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: TextBlock): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
