...
object StockChartLegendItemClickEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartLegendItemClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartLegendItemClickEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartLegendItemClickEvent] (val x: Self) extends AnyVal {
