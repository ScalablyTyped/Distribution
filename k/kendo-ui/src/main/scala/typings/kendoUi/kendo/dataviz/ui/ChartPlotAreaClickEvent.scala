...
object ChartPlotAreaClickEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartPlotAreaClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartPlotAreaClickEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartPlotAreaClickEvent] (val x: Self) extends AnyVal {
