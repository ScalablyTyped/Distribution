...
trait GanttPdfMargin extends StObject {
...
object GanttPdfMargin {
  
  @scala.inline
  def apply(): GanttPdfMargin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GanttPdfMargin]
  }
  
  @scala.inline
  implicit class GanttPdfMarginMutableBuilder[Self <: GanttPdfMargin] (val x: Self) extends AnyVal {
