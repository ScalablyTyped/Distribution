...
trait TreeListPdfMargin extends StObject {
...
object TreeListPdfMargin {
  
  @scala.inline
  def apply(): TreeListPdfMargin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TreeListPdfMargin]
  }
  
  @scala.inline
  implicit class TreeListPdfMarginMutableBuilder[Self <: TreeListPdfMargin] (val x: Self) extends AnyVal {
