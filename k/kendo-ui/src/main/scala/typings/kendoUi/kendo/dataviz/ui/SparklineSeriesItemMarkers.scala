...
object SparklineSeriesItemMarkers {
  ...
  inline def apply(): SparklineSeriesItemMarkers = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineSeriesItemMarkers]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineSeriesItemMarkers] (val x: Self) extends AnyVal {
    ...
    inline def setBorder(value: js.Function | SparklineSeriesItemMarkersBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
