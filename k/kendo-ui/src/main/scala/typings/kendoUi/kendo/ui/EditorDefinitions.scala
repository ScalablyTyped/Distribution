...
trait EditorDefinitions extends StObject {
  ...
  def kendoEditor(container: String, options: EditorDefinitionOptions): Unit
  def kendoEditor(container: JQuery, options: EditorDefinitionOptions): Unit
  def kendoEditor(container: Element, options: EditorDefinitionOptions): Unit
  @JSName("kendoEditor")
  var kendoEditor_Original: EditorDefinition
...
object EditorDefinitions {
  ...
  inline def apply(
    ...
    kendoEditor: (/* container */ JQuery | Element | String, /* options */ EditorDefinitionOptions) => Unit,
    ...
    val __obj = js.Dynamic.literal(boolean = js.Any.fromFunction2(boolean), date = js.Any.fromFunction2(date), kendoEditor = js.Any.fromFunction2(kendoEditor), number = js.Any.fromFunction2(number), string = js.Any.fromFunction2(string), values = js.Any.fromFunction2(values))
  ...
  implicit open class MutableBuilder[Self <: EditorDefinitions] (val x: Self) extends AnyVal {
    ...
    inline def setKendoEditor(value: (/* container */ JQuery | Element | String, /* options */ EditorDefinitionOptions) => Unit): Self = StObject.set(x, "kendoEditor", js.Any.fromFunction2(value))
