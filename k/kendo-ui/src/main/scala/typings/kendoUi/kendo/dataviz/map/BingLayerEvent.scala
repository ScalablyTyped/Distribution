...
object BingLayerEvent {
  ...
  @scala.inline
  implicit class BingLayerEventOps[Self <: BingLayerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: BingLayer): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
