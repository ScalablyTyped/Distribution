...
object ChartCategoryAxisItemTitle {
  ...
  implicit class ChartCategoryAxisItemTitleOps[Self <: ChartCategoryAxisItemTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartCategoryAxisItemTitleBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: Double | ChartCategoryAxisItemTitleMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMargin: Self = this.set("margin", js.undefined)
    
    @scala.inline
    def setPadding(value: ChartCategoryAxisItemTitlePadding): Self = this.set("padding", value.asInstanceOf[js.Any])
