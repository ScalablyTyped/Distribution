...
object TileLayerEvent {
  ...
  @scala.inline
  implicit class TileLayerEventOps[Self <: TileLayerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: TileLayer): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
