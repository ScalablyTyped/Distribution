...
object ChartSeriesLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartSeriesLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartSeriesLeaveEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartSeriesLeaveEvent] (val x: Self) extends AnyVal {
    ...
    inline def setSeries(value: ChartSeriesLeaveEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
