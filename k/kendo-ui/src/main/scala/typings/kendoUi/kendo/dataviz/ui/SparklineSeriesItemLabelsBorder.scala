...
object SparklineSeriesItemLabelsBorder {
  ...
  @scala.inline
  def apply(): SparklineSeriesItemLabelsBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineSeriesItemLabelsBorder]
  }
  
  @scala.inline
  implicit class SparklineSeriesItemLabelsBorderMutableBuilder[Self <: SparklineSeriesItemLabelsBorder] (val x: Self) extends AnyVal {
