...
trait ChartYAxisItemNotesDataItemLabelBorder extends StObject {
...
object ChartYAxisItemNotesDataItemLabelBorder {
  ...
  @scala.inline
  def apply(): ChartYAxisItemNotesDataItemLabelBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartYAxisItemNotesDataItemLabelBorder]
  }
  
  @scala.inline
  implicit class ChartYAxisItemNotesDataItemLabelBorderMutableBuilder[Self <: ChartYAxisItemNotesDataItemLabelBorder] (val x: Self) extends AnyVal {
