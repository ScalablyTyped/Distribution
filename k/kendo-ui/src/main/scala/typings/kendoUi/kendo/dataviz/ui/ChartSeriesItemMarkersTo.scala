...
object ChartSeriesItemMarkersTo {
  ...
  @scala.inline
  implicit class ChartSeriesItemMarkersToOps[Self <: ChartSeriesItemMarkersTo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: js.Function | ChartSeriesItemMarkersToBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
