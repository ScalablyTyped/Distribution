...
@js.native
trait ChartSeriesItemMarkersTo extends StObject {
  
  var background: js.UndefOr[String | js.Function] = js.native
  
  var border: js.UndefOr[js.Function | ChartSeriesItemMarkersToBorder] = js.native
...
object ChartSeriesItemMarkersTo {
  ...
  @scala.inline
  def apply(): ChartSeriesItemMarkersTo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartSeriesItemMarkersTo]
  }
  
  @scala.inline
  implicit class ChartSeriesItemMarkersToMutableBuilder[Self <: ChartSeriesItemMarkersTo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: js.Function | ChartSeriesItemMarkersToBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
