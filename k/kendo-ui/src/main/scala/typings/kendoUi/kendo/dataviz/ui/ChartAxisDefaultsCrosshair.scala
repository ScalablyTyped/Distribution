...
object ChartAxisDefaultsCrosshair {
  ...
  inline def apply(): ChartAxisDefaultsCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartAxisDefaultsCrosshair]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartAxisDefaultsCrosshair] (val x: Self) extends AnyVal {
    ...
    inline def setTooltip(value: ChartAxisDefaultsCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
