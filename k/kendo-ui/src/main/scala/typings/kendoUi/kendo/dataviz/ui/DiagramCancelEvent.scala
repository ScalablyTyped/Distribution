...
object DiagramCancelEvent {
  ...
  @scala.inline
  implicit class DiagramCancelEventOps[Self <: DiagramCancelEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConnection(value: Model): Self = this.set("connection", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setShape(value: Model): Self = this.set("shape", value.asInstanceOf[js.Any])
