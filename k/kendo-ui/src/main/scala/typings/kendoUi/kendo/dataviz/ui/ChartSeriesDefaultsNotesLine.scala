...
object ChartSeriesDefaultsNotesLine {
  ...
  @scala.inline
  def apply(): ChartSeriesDefaultsNotesLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartSeriesDefaultsNotesLine]
  }
  
  @scala.inline
  implicit class ChartSeriesDefaultsNotesLineMutableBuilder[Self <: ChartSeriesDefaultsNotesLine] (val x: Self) extends AnyVal {
