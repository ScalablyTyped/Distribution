...
object StockChartValueAxisItemMinorGridLines {
  ...
  @scala.inline
  def apply(): StockChartValueAxisItemMinorGridLines = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemMinorGridLines]
  }
  
  @scala.inline
  implicit class StockChartValueAxisItemMinorGridLinesMutableBuilder[Self <: StockChartValueAxisItemMinorGridLines] (val x: Self) extends AnyVal {
