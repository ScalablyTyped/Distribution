...
object SparklineSeriesItemTooltip {
  ...
  @scala.inline
  implicit class SparklineSeriesItemTooltipOps[Self <: SparklineSeriesItemTooltip] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: SparklineSeriesItemTooltipBorder): Self = this.set("border", value.asInstanceOf[js.Any])
