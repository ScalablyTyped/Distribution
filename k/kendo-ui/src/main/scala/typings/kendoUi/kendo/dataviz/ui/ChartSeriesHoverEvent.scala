...
object ChartSeriesHoverEvent {
  ...
  implicit class ChartSeriesHoverEventOps[Self <: ChartSeriesHoverEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCategoryPoints(value: js.Any): Self = this.set("categoryPoints", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteCategoryPoints: Self = this.set("categoryPoints", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: ChartSeriesHoverEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
