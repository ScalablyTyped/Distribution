...
object MapLayerDefaultsMarkerTooltipAnimationClose {
  ...
  inline def apply(): MapLayerDefaultsMarkerTooltipAnimationClose = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapLayerDefaultsMarkerTooltipAnimationClose]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MapLayerDefaultsMarkerTooltipAnimationClose] (val x: Self) extends AnyVal {
