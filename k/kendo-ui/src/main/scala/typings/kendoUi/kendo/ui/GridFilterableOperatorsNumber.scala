...
trait GridFilterableOperatorsNumber extends StObject {
...
object GridFilterableOperatorsNumber {
  ...
  inline def apply(): GridFilterableOperatorsNumber = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GridFilterableOperatorsNumber]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GridFilterableOperatorsNumber] (val x: Self) extends AnyVal {
