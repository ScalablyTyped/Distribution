...
@js.native
trait ChartXAxisItemNotesLabelBorder extends StObject {
...
object ChartXAxisItemNotesLabelBorder {
  ...
  @scala.inline
  def apply(): ChartXAxisItemNotesLabelBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartXAxisItemNotesLabelBorder]
  }
  
  @scala.inline
  implicit class ChartXAxisItemNotesLabelBorderMutableBuilder[Self <: ChartXAxisItemNotesLabelBorder] (val x: Self) extends AnyVal {
