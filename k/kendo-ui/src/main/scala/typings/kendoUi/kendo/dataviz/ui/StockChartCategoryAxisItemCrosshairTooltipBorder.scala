...
object StockChartCategoryAxisItemCrosshairTooltipBorder {
  ...
  @scala.inline
  implicit class StockChartCategoryAxisItemCrosshairTooltipBorderMutableBuilder[Self <: StockChartCategoryAxisItemCrosshairTooltipBorder] (val x: Self) extends AnyVal {
