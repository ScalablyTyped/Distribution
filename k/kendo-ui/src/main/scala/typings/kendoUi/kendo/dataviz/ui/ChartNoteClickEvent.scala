...
object ChartNoteClickEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartNoteClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartNoteClickEvent]
  }
  
  @scala.inline
  implicit class ChartNoteClickEventMutableBuilder[Self <: ChartNoteClickEvent] (val x: Self) extends AnyVal {
