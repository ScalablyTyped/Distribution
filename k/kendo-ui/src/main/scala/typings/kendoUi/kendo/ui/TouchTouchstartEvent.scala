...
object TouchTouchstartEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Touch): TouchTouchstartEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[TouchTouchstartEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TouchTouchstartEvent] (val x: Self) extends AnyVal {
