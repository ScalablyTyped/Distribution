...
@js.native
trait AppBarEvent extends js.Object {
  
  def isDefaultPrevented(): Boolean = js.native
  
  var preventDefault: js.Function = js.native
  
  var sender: AppBar = js.native
}
object AppBarEvent {
  ...
  @scala.inline
  implicit class AppBarEventOps[Self <: AppBarEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: AppBar): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
