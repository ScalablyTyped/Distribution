...
@js.native
trait SparklineValueAxisItemLine extends StObject {
...
object SparklineValueAxisItemLine {
  ...
  @scala.inline
  def apply(): SparklineValueAxisItemLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineValueAxisItemLine]
  }
  
  @scala.inline
  implicit class SparklineValueAxisItemLineMutableBuilder[Self <: SparklineValueAxisItemLine] (val x: Self) extends AnyVal {
