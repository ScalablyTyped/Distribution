...
object ArcGaugeScaleLabels {
  ...
  @scala.inline
  implicit class ArcGaugeScaleLabelsOps[Self <: ArcGaugeScaleLabels] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: ArcGaugeScaleLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setMargin(value: Double | ArcGaugeScaleLabelsMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteMargin: Self = this.set("margin", js.undefined)
    @scala.inline
    def setPadding(value: Double | ArcGaugeScaleLabelsPadding): Self = this.set("padding", value.asInstanceOf[js.Any])
    @scala.inline
