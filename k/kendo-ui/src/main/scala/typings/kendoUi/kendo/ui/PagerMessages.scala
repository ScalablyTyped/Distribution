...
object PagerMessages {
  ...
  @scala.inline
  implicit class PagerMessagesMutableBuilder[Self <: PagerMessages] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAllPages(value: String): Self = StObject.set(x, "allPages", value.asInstanceOf[js.Any])
