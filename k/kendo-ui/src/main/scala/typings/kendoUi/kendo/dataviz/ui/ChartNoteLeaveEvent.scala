...
object ChartNoteLeaveEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartNoteLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartNoteLeaveEvent]
  }
  
  @scala.inline
  implicit class ChartNoteLeaveEventMutableBuilder[Self <: ChartNoteLeaveEvent] (val x: Self) extends AnyVal {
