...
object MapLayerDefaultsMarkerTooltipAnimationOpen {
  ...
  @scala.inline
  def apply(): MapLayerDefaultsMarkerTooltipAnimationOpen = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapLayerDefaultsMarkerTooltipAnimationOpen]
  }
  
  @scala.inline
  implicit class MapLayerDefaultsMarkerTooltipAnimationOpenMutableBuilder[Self <: MapLayerDefaultsMarkerTooltipAnimationOpen] (val x: Self) extends AnyVal {
