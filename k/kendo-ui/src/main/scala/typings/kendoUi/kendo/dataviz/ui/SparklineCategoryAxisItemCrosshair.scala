...
object SparklineCategoryAxisItemCrosshair {
  ...
  inline def apply(): SparklineCategoryAxisItemCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SparklineCategoryAxisItemCrosshair]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineCategoryAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    inline def setTooltip(value: SparklineCategoryAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
