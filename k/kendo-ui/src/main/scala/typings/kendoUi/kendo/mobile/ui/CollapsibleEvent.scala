...
object CollapsibleEvent {
  ...
  @scala.inline
  implicit class CollapsibleEventOps[Self <: CollapsibleEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Collapsible): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
