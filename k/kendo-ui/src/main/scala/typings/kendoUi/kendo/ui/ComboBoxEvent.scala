...
object ComboBoxEvent {
  ...
  @scala.inline
  implicit class ComboBoxEventOps[Self <: ComboBoxEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: ComboBox): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
