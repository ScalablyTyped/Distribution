...
@js.native
trait MapMarkerDefaultsTooltipAnimationClose extends js.Object {
...
object MapMarkerDefaultsTooltipAnimationClose {
  @scala.inline
  def apply(): MapMarkerDefaultsTooltipAnimationClose = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapMarkerDefaultsTooltipAnimationClose]
  }
  @scala.inline
  implicit class MapMarkerDefaultsTooltipAnimationCloseOps[Self <: MapMarkerDefaultsTooltipAnimationClose] (val x: Self) extends AnyVal {
    @scala.inline
