...
@js.native
trait DiagramShapeConnectorDefaultsStroke extends StObject {
...
object DiagramShapeConnectorDefaultsStroke {
  ...
  @scala.inline
  def apply(): DiagramShapeConnectorDefaultsStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeConnectorDefaultsStroke]
  }
  
  @scala.inline
  implicit class DiagramShapeConnectorDefaultsStrokeMutableBuilder[Self <: DiagramShapeConnectorDefaultsStroke] (val x: Self) extends AnyVal {
