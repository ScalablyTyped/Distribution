...
object DiagramShapeConnectorDefaultsStroke {
  ...
  inline def apply(): DiagramShapeConnectorDefaultsStroke = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeConnectorDefaultsStroke]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DiagramShapeConnectorDefaultsStroke] (val x: Self) extends AnyVal {
