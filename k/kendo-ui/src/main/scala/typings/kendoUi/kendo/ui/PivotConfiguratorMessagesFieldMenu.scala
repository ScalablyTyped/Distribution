...
object PivotConfiguratorMessagesFieldMenu {
  ...
  inline def apply(): PivotConfiguratorMessagesFieldMenu = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PivotConfiguratorMessagesFieldMenu]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PivotConfiguratorMessagesFieldMenu] (val x: Self) extends AnyVal {
    ...
    inline def setOperators(value: PivotConfiguratorMessagesFieldMenuOperators): Self = StObject.set(x, "operators", value.asInstanceOf[js.Any])
