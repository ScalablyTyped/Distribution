...
object PivotConfiguratorMessagesFieldMenu {
  ...
  @scala.inline
  implicit class PivotConfiguratorMessagesFieldMenuMutableBuilder[Self <: PivotConfiguratorMessagesFieldMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperators(value: PivotConfiguratorMessagesFieldMenuOperators): Self = StObject.set(x, "operators", value.asInstanceOf[js.Any])
