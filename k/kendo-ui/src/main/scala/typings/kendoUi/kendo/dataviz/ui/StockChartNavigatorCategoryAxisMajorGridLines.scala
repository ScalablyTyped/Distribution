...
object StockChartNavigatorCategoryAxisMajorGridLines {
  ...
  inline def apply(): StockChartNavigatorCategoryAxisMajorGridLines = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorCategoryAxisMajorGridLines]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartNavigatorCategoryAxisMajorGridLines] (val x: Self) extends AnyVal {
