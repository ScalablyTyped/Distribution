...
trait MapMarkerDefaultsTooltip extends StObject {
  ...
  var animation: js.UndefOr[MapMarkerDefaultsTooltipAnimation] = js.native
  
  var autoHide: js.UndefOr[Boolean] = js.native
  
  var callout: js.UndefOr[Boolean] = js.native
  
  var content: js.UndefOr[String | js.Function | MapMarkerDefaultsTooltipContent] = js.native
...
object MapMarkerDefaultsTooltip {
  ...
  @scala.inline
  def apply(): MapMarkerDefaultsTooltip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapMarkerDefaultsTooltip]
  }
  
  @scala.inline
  implicit class MapMarkerDefaultsTooltipMutableBuilder[Self <: MapMarkerDefaultsTooltip] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAnimation(value: MapMarkerDefaultsTooltipAnimation): Self = StObject.set(x, "animation", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setContent(value: String | js.Function | MapMarkerDefaultsTooltipContent): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
