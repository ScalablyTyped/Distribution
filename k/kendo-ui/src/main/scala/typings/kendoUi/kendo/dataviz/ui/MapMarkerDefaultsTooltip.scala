...
object MapMarkerDefaultsTooltip {
  ...
  @scala.inline
  implicit class MapMarkerDefaultsTooltipOps[Self <: MapMarkerDefaultsTooltip] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setAnimation(value: MapMarkerDefaultsTooltipAnimation): Self = this.set("animation", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setContent(value: String | js.Function | MapMarkerDefaultsTooltipContent): Self = this.set("content", value.asInstanceOf[js.Any])
    @scala.inline
