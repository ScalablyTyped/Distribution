...
object StockChartNavigatorCategoryAxisLabelsDateFormats {
  ...
  @scala.inline
  def apply(): StockChartNavigatorCategoryAxisLabelsDateFormats = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorCategoryAxisLabelsDateFormats]
  }
  
  @scala.inline
  implicit class StockChartNavigatorCategoryAxisLabelsDateFormatsMutableBuilder[Self <: StockChartNavigatorCategoryAxisLabelsDateFormats] (val x: Self) extends AnyVal {
