...
trait ChartAxisDefaultsLine extends StObject {
...
object ChartAxisDefaultsLine {
  ...
  @scala.inline
  def apply(): ChartAxisDefaultsLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartAxisDefaultsLine]
  }
  
  @scala.inline
  implicit class ChartAxisDefaultsLineMutableBuilder[Self <: ChartAxisDefaultsLine] (val x: Self) extends AnyVal {
