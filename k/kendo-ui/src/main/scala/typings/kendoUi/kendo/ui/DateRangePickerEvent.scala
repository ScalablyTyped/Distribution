...
object DateRangePickerEvent {
  ...
  @scala.inline
  implicit class DateRangePickerEventOps[Self <: DateRangePickerEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: DateRangePicker): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
