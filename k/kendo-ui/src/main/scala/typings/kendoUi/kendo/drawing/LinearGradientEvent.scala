...
object LinearGradientEvent {
  ...
  @scala.inline
  implicit class LinearGradientEventOps[Self <: LinearGradientEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: LinearGradient): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
