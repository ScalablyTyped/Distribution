...
trait PivotGridMessagesFieldMenu extends StObject {
...
object PivotGridMessagesFieldMenu {
  ...
  @scala.inline
  implicit class PivotGridMessagesFieldMenuMutableBuilder[Self <: PivotGridMessagesFieldMenu] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOperators(value: PivotGridMessagesFieldMenuOperators): Self = StObject.set(x, "operators", value.asInstanceOf[js.Any])
