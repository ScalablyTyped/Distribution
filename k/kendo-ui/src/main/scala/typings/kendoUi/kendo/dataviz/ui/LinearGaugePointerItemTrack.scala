...
object LinearGaugePointerItemTrack {
  ...
  @scala.inline
  implicit class LinearGaugePointerItemTrackOps[Self <: LinearGaugePointerItemTrack] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: LinearGaugePointerItemTrackBorder): Self = this.set("border", value.asInstanceOf[js.Any])
