...
object SparklineValueAxisItemCrosshair {
  ...
  @scala.inline
  implicit class SparklineValueAxisItemCrosshairOps[Self <: SparklineValueAxisItemCrosshair] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDashType(value: Double): Self = this.set("dashType", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTooltip(value: SparklineValueAxisItemCrosshairTooltip): Self = this.set("tooltip", value.asInstanceOf[js.Any])
    @scala.inline
