...
object PanelBarEvent {
  ...
  @scala.inline
  implicit class PanelBarEventOps[Self <: PanelBarEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: PanelBar): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
