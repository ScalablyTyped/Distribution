...
object TreeListPageableMessages {
  ...
  inline def apply(): TreeListPageableMessages = {
  ...
  implicit open class MutableBuilder[Self <: TreeListPageableMessages] (val x: Self) extends AnyVal {
    ...
    inline def setMorePages(value: String): Self = StObject.set(x, "morePages", value.asInstanceOf[js.Any])
    
    inline def setMorePagesUndefined: Self = StObject.set(x, "morePages", js.undefined)
