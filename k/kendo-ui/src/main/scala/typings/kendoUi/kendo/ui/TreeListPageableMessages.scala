...
trait TreeListPageableMessages extends StObject {
...
object TreeListPageableMessages {
  ...
  @scala.inline
  def apply(): TreeListPageableMessages = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TreeListPageableMessages]
  }
  
  @scala.inline
  implicit class TreeListPageableMessagesMutableBuilder[Self <: TreeListPageableMessages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItemsPerPage(value: String): Self = StObject.set(x, "itemsPerPage", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMorePages(value: String): Self = StObject.set(x, "morePages", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMorePagesUndefined: Self = StObject.set(x, "morePages", js.undefined)
