...
object StockChartCategoryAxisItemLabels {
  ...
  inline def apply(): StockChartCategoryAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartCategoryAxisItemLabels]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartCategoryAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
