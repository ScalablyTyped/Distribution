...
object StockChartCategoryAxisItemLabels {
  ...
  @scala.inline
  implicit class StockChartCategoryAxisItemLabelsOps[Self <: StockChartCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartCategoryAxisItemLabelsBorder): Self = this.set("border", value.asInstanceOf[js.Any])
