...
@js.native
trait StockChartCategoryAxisItemLabels extends StObject {
  
  var background: js.UndefOr[String] = js.native
  
  var border: js.UndefOr[StockChartCategoryAxisItemLabelsBorder] = js.native
...
object StockChartCategoryAxisItemLabels {
  ...
  @scala.inline
  def apply(): StockChartCategoryAxisItemLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartCategoryAxisItemLabels]
  }
  
  @scala.inline
  implicit class StockChartCategoryAxisItemLabelsMutableBuilder[Self <: StockChartCategoryAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: StockChartCategoryAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
