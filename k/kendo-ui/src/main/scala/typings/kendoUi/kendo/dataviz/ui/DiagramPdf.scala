...
trait DiagramPdf extends StObject {
  ...
  var margin: js.UndefOr[DiagramPdfMargin] = js.native
...
object DiagramPdf {
  ...
  @scala.inline
  def apply(): DiagramPdf = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramPdf]
  }
  
  @scala.inline
  implicit class DiagramPdfMutableBuilder[Self <: DiagramPdf] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMargin(value: DiagramPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
