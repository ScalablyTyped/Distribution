...
object DiagramPdf {
  ...
  @scala.inline
  implicit class DiagramPdfOps[Self <: DiagramPdf] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMargin(value: DiagramPdfMargin): Self = this.set("margin", value.asInstanceOf[js.Any])
    @scala.inline
