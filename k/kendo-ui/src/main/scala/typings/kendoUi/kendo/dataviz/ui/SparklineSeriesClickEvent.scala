...
trait SparklineSeriesClickEvent
  extends StObject
     with SparklineEvent {
...
object SparklineSeriesClickEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Sparkline): SparklineSeriesClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineSeriesClickEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineSeriesClickEvent] (val x: Self) extends AnyVal {
    ...
    inline def setSeries(value: SparklineSeriesClickEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
