...
object ShapeFill {
  ...
  @scala.inline
  implicit class ShapeFillOps[Self <: ShapeFill] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGradient(value: ShapeFillGradient): Self = this.set("gradient", value.asInstanceOf[js.Any])
