...
trait ListViewPageable extends StObject {
  ...
  var messages: js.UndefOr[ListViewPageableMessages] = js.undefined
...
object ListViewPageable {
  
  inline def apply(): ListViewPageable = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListViewPageable]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListViewPageable] (val x: Self) extends AnyVal {
    ...
    inline def setMessages(value: ListViewPageableMessages): Self = StObject.set(x, "messages", value.asInstanceOf[js.Any])
