...
trait ChartValueAxisItemCrosshair extends StObject {
...
object ChartValueAxisItemCrosshair {
  ...
  inline def apply(): ChartValueAxisItemCrosshair = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartValueAxisItemCrosshair]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartValueAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    inline def setTooltip(value: ChartValueAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
