...
object ChartValueAxisItemCrosshair {
  ...
  @scala.inline
  implicit class ChartValueAxisItemCrosshairMutableBuilder[Self <: ChartValueAxisItemCrosshair] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(value: ChartValueAxisItemCrosshairTooltip): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
