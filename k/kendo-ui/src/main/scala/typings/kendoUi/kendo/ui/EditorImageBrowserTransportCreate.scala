...
@js.native
trait EditorImageBrowserTransportCreate extends StObject {
...
object EditorImageBrowserTransportCreate {
  ...
  @scala.inline
  implicit class EditorImageBrowserTransportCreateMutableBuilder[Self <: EditorImageBrowserTransportCreate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.Any | String | js.Function): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
