...
object ChartYAxisItemLabels {
  ...
  @scala.inline
  implicit class ChartYAxisItemLabelsMutableBuilder[Self <: ChartYAxisItemLabels] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBorder(value: ChartYAxisItemLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDateFormats(value: ChartYAxisItemLabelsDateFormats): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMargin(value: Double | ChartYAxisItemLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setPadding(value: Double | ChartYAxisItemLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPaddingUndefined: Self = StObject.set(x, "padding", js.undefined)
    
    @scala.inline
    def setRotation(value: Double | ChartYAxisItemLabelsRotation): Self = StObject.set(x, "rotation", value.asInstanceOf[js.Any])
