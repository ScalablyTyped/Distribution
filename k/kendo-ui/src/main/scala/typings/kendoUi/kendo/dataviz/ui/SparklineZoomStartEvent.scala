...
object SparklineZoomStartEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Sparkline): SparklineZoomStartEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklineZoomStartEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklineZoomStartEvent] (val x: Self) extends AnyVal {
