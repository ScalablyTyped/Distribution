...
object TimePickerEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: TimePicker): TimePickerEvent = {
  ...
  implicit open class MutableBuilder[Self <: TimePickerEvent] (val x: Self) extends AnyVal {
    ...
    inline def setSender(value: TimePicker): Self = StObject.set(x, "sender", value.asInstanceOf[js.Any])
  }
}
