...
object PromptEvent {
  ...
  @scala.inline
  implicit class PromptEventOps[Self <: PromptEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Prompt): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
