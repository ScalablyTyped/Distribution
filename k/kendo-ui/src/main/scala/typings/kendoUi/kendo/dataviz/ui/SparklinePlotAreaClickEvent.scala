...
object SparklinePlotAreaClickEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Sparkline): SparklinePlotAreaClickEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[SparklinePlotAreaClickEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SparklinePlotAreaClickEvent] (val x: Self) extends AnyVal {
