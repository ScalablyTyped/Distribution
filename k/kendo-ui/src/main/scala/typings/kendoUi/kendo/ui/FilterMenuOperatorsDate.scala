...
trait FilterMenuOperatorsDate extends StObject {
  ...
  @JSName("eq")
  var eq_FFilterMenuOperatorsDate: js.UndefOr[String] = js.native
...
object FilterMenuOperatorsDate {
  ...
  @scala.inline
  def apply(): FilterMenuOperatorsDate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FilterMenuOperatorsDate]
  }
  
  @scala.inline
  implicit class FilterMenuOperatorsDateMutableBuilder[Self <: FilterMenuOperatorsDate] (val x: Self) extends AnyVal {
