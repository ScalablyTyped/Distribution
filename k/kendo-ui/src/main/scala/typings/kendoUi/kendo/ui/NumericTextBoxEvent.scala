...
trait NumericTextBoxEvent extends js.Object {
  ...
  var sender: NumericTextBox = js.native
}
object NumericTextBoxEvent {
  ...
  @scala.inline
  implicit class NumericTextBoxEventOps[Self <: NumericTextBoxEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: NumericTextBox): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
