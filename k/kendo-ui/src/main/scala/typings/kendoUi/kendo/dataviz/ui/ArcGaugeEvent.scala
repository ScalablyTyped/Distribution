...
object ArcGaugeEvent {
  ...
  @scala.inline
  implicit class ArcGaugeEventOps[Self <: ArcGaugeEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ArcGauge): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
