...
object RadialGradientEvent {
  ...
  @scala.inline
  implicit class RadialGradientEventOps[Self <: RadialGradientEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: RadialGradient): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
