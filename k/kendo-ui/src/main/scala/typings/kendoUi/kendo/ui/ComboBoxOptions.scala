...
object ComboBoxOptions {
  ...
  implicit open class MutableBuilder[Self <: ComboBoxOptions] (val x: Self) extends AnyVal {
    ...
    inline def setCascade(value: /* e */ ComboBoxCascadeEvent => Unit): Self = StObject.set(x, "cascade", js.Any.fromFunction1(value))
    ...
    inline def setChange(value: /* e */ ComboBoxChangeEvent => Unit): Self = StObject.set(x, "change", js.Any.fromFunction1(value))
    ...
    inline def setClose(value: /* e */ ComboBoxCloseEvent => Unit): Self = StObject.set(x, "close", js.Any.fromFunction1(value))
    
    inline def setCloseUndefined: Self = StObject.set(x, "close", js.undefined)
    
    inline def setDataBound(value: /* e */ ComboBoxDataBoundEvent => Unit): Self = StObject.set(x, "dataBound", js.Any.fromFunction1(value))
    ...
    inline def setFiltering(value: /* e */ ComboBoxFilteringEvent => Unit): Self = StObject.set(x, "filtering", js.Any.fromFunction1(value))
    ...
    inline def setOpen(value: /* e */ ComboBoxOpenEvent => Unit): Self = StObject.set(x, "open", js.Any.fromFunction1(value))
