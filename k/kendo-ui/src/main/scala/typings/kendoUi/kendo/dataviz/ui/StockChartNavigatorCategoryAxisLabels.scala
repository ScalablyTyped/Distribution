...
object StockChartNavigatorCategoryAxisLabels {
  ...
  inline def apply(): StockChartNavigatorCategoryAxisLabels = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartNavigatorCategoryAxisLabels]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartNavigatorCategoryAxisLabels] (val x: Self) extends AnyVal {
    
    inline def setBackground(value: String): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    
    inline def setBackgroundUndefined: Self = StObject.set(x, "background", js.undefined)
    
    inline def setBorder(value: StockChartNavigatorCategoryAxisLabelsBorder): Self = StObject.set(x, "border", value.asInstanceOf[js.Any])
    ...
    inline def setDateFormats(value: StockChartNavigatorCategoryAxisLabelsDateFormats): Self = StObject.set(x, "dateFormats", value.asInstanceOf[js.Any])
    ...
    inline def setMargin(value: Double | StockChartNavigatorCategoryAxisLabelsMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    inline def setPadding(value: Double | StockChartNavigatorCategoryAxisLabelsPadding): Self = StObject.set(x, "padding", value.asInstanceOf[js.Any])
