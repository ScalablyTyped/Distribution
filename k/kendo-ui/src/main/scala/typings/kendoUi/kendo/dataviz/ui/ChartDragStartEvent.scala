...
object ChartDragStartEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: Chart): ChartDragStartEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChartDragStartEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ChartDragStartEvent] (val x: Self) extends AnyVal {
