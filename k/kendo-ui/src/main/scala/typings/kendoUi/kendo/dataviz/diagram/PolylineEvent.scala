...
object PolylineEvent {
  ...
  @scala.inline
  implicit class PolylineEventOps[Self <: PolylineEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: Polyline): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
