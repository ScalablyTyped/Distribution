...
object StockChartPane {
  ...
  @scala.inline
  implicit class StockChartPaneOps[Self <: StockChartPane] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBorder(value: StockChartPaneBorder): Self = this.set("border", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTitle(value: String | StockChartPaneTitle): Self = this.set("title", value.asInstanceOf[js.Any])
    @scala.inline
