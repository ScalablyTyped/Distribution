...
trait StockChartNoteHoverEvent
  extends StObject
...
object StockChartNoteHoverEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartNoteHoverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartNoteHoverEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartNoteHoverEvent] (val x: Self) extends AnyVal {
