...
trait Point
  ...
  def rotate(angle: Double, center: Any): typings.kendoUi.kendo.geometry.Point = js.native
  ...
  def translateWith(vector: Any): typings.kendoUi.kendo.geometry.Point = js.native
