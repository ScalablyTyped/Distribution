...
object StockChartNoteLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartNoteLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartNoteLeaveEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartNoteLeaveEvent] (val x: Self) extends AnyVal {
