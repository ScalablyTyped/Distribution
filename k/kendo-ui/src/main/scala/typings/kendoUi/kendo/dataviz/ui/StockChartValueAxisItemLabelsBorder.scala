...
object StockChartValueAxisItemLabelsBorder {
  ...
  inline def apply(): StockChartValueAxisItemLabelsBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemLabelsBorder]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartValueAxisItemLabelsBorder] (val x: Self) extends AnyVal {
