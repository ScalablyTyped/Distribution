...
trait StockChartValueAxisItemLabelsBorder extends StObject {
...
object StockChartValueAxisItemLabelsBorder {
  ...
  @scala.inline
  def apply(): StockChartValueAxisItemLabelsBorder = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StockChartValueAxisItemLabelsBorder]
  }
  
  @scala.inline
  implicit class StockChartValueAxisItemLabelsBorderMutableBuilder[Self <: StockChartValueAxisItemLabelsBorder] (val x: Self) extends AnyVal {
