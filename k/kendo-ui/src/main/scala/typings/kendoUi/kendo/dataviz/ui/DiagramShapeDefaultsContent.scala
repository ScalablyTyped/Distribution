...
object DiagramShapeDefaultsContent {
  ...
  @scala.inline
  def apply(): DiagramShapeDefaultsContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramShapeDefaultsContent]
  }
  
  @scala.inline
  implicit class DiagramShapeDefaultsContentMutableBuilder[Self <: DiagramShapeDefaultsContent] (val x: Self) extends AnyVal {
