...
trait DropDownButtonClickEvent
  extends StObject
     with DropDownButtonEvent {
...
object DropDownButtonClickEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: DropDownButton): DropDownButtonClickEvent = {
