...
trait StockChartLegendItemLeaveEvent
  extends StObject
...
object StockChartLegendItemLeaveEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartLegendItemLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartLegendItemLeaveEvent]
  }
  
  @scala.inline
  implicit class StockChartLegendItemLeaveEventMutableBuilder[Self <: StockChartLegendItemLeaveEvent] (val x: Self) extends AnyVal {
