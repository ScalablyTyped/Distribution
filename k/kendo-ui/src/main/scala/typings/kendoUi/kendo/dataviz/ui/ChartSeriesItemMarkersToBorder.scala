...
trait ChartSeriesItemMarkersToBorder extends StObject {
...
object ChartSeriesItemMarkersToBorder {
  ...
  @scala.inline
  implicit class ChartSeriesItemMarkersToBorderMutableBuilder[Self <: ChartSeriesItemMarkersToBorder] (val x: Self) extends AnyVal {
