...
@js.native
trait ChartYAxisItemLine extends js.Object {
...
object ChartYAxisItemLine {
  ...
  @scala.inline
  def apply(): ChartYAxisItemLine = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartYAxisItemLine]
  }
  
  @scala.inline
  implicit class ChartYAxisItemLineOps[Self <: ChartYAxisItemLine] (val x: Self) extends AnyVal {
