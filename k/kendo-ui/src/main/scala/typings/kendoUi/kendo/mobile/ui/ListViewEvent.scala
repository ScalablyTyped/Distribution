...
object ListViewEvent {
  ...
  @scala.inline
  implicit class ListViewEventOps[Self <: ListViewEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: ListView): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
