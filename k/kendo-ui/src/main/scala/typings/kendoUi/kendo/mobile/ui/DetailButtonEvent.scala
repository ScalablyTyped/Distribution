...
object DetailButtonEvent {
  ...
  @scala.inline
  implicit class DetailButtonEventOps[Self <: DetailButtonEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSender(value: DetailButton): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
