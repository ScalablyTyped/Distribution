...
trait DiagramShapeDefaultsConnectorStroke extends StObject {
...
object DiagramShapeDefaultsConnectorStroke {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DiagramShapeDefaultsConnectorStroke] (val x: Self) extends AnyVal {
