...
object SpreadsheetPdf {
  ...
  inline def apply(): SpreadsheetPdf = {
  ...
  extension [Self <: SpreadsheetPdf](x: Self) {
    ...
    inline def setGuidelines(value: Boolean): Self = StObject.set(x, "guidelines", value.asInstanceOf[js.Any])
    
    inline def setGuidelinesUndefined: Self = StObject.set(x, "guidelines", js.undefined)
    
    inline def setHCenter(value: Boolean): Self = StObject.set(x, "hCenter", value.asInstanceOf[js.Any])
    
    inline def setHCenterUndefined: Self = StObject.set(x, "hCenter", js.undefined)
    ...
    inline def setMargin(value: SpreadsheetPdfMargin): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    inline def setVCenter(value: Boolean): Self = StObject.set(x, "vCenter", value.asInstanceOf[js.Any])
    
    inline def setVCenterUndefined: Self = StObject.set(x, "vCenter", js.undefined)
  }
}
