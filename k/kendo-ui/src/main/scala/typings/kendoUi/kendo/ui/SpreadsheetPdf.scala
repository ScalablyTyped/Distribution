...
object SpreadsheetPdf {
  ...
  def apply(
    ...
    if (!js.isUndefined(guidelines)) __obj.updateDynamic("guidelines")(guidelines.asInstanceOf[js.Any])
    if (!js.isUndefined(hCenter)) __obj.updateDynamic("hCenter")(hCenter.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(vCenter)) __obj.updateDynamic("vCenter")(vCenter.asInstanceOf[js.Any])
