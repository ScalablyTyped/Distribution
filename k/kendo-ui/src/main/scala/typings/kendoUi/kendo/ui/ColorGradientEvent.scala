...
object ColorGradientEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: ColorGradient): ColorGradientEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[ColorGradientEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorGradientEvent] (val x: Self) extends AnyVal {
