...
object RectangleFill {
  ...
  inline def apply(): RectangleFill = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RectangleFill]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RectangleFill] (val x: Self) extends AnyVal {
    
    inline def setColor(value: String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    
    inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
    
    inline def setGradient(value: RectangleFillGradient): Self = StObject.set(x, "gradient", value.asInstanceOf[js.Any])
