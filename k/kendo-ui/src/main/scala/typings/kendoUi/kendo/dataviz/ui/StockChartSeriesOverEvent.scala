...
object StockChartSeriesOverEvent {
  ...
  @scala.inline
  implicit class StockChartSeriesOverEventOps[Self <: StockChartSeriesOverEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setSeries(value: StockChartSeriesOverEventSeries): Self = this.set("series", value.asInstanceOf[js.Any])
    @scala.inline
