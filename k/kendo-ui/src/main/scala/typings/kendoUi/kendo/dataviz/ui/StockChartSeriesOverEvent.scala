...
trait StockChartSeriesOverEvent extends StockChartEvent {
  ...
  var series: js.UndefOr[StockChartSeriesOverEventSeries] = js.native
...
object StockChartSeriesOverEvent {
  ...
  @scala.inline
  def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartSeriesOverEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartSeriesOverEvent]
  }
  
  @scala.inline
  implicit class StockChartSeriesOverEventMutableBuilder[Self <: StockChartSeriesOverEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSeries(value: StockChartSeriesOverEventSeries): Self = StObject.set(x, "series", value.asInstanceOf[js.Any])
