...
trait MultiColumnComboBoxEvent extends js.Object {
  ...
  var sender: MultiColumnComboBox = js.native
}
object MultiColumnComboBoxEvent {
  ...
  @scala.inline
  implicit class MultiColumnComboBoxEventOps[Self <: MultiColumnComboBoxEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSender(value: MultiColumnComboBox): Self = this.set("sender", value.asInstanceOf[js.Any])
  }
}
