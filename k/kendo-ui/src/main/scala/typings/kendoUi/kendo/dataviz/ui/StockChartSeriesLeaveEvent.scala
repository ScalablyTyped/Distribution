...
object StockChartSeriesLeaveEvent {
  ...
  inline def apply(isDefaultPrevented: () => Boolean, preventDefault: js.Function, sender: StockChart): StockChartSeriesLeaveEvent = {
    val __obj = js.Dynamic.literal(isDefaultPrevented = js.Any.fromFunction0(isDefaultPrevented), preventDefault = preventDefault.asInstanceOf[js.Any], sender = sender.asInstanceOf[js.Any])
    __obj.asInstanceOf[StockChartSeriesLeaveEvent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StockChartSeriesLeaveEvent] (val x: Self) extends AnyVal {
