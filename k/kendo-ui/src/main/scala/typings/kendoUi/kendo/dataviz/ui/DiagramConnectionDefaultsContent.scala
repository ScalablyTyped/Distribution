...
object DiagramConnectionDefaultsContent {
  ...
  @scala.inline
  def apply(): DiagramConnectionDefaultsContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiagramConnectionDefaultsContent]
  }
  
  @scala.inline
  implicit class DiagramConnectionDefaultsContentMutableBuilder[Self <: DiagramConnectionDefaultsContent] (val x: Self) extends AnyVal {
