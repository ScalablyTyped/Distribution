...
class Text protected ()
  ...
  def fill(color: String): typings.kendoDashUi.kendo.drawing.Text = js.native
  def fill(color: String, opacity: Double): typings.kendoDashUi.kendo.drawing.Text = js.native
  def position(): Point = js.native
  def position(value: Point): Unit = js.native
  def stroke(color: String): typings.kendoDashUi.kendo.drawing.Text = js.native
  def stroke(color: String, width: Double): typings.kendoDashUi.kendo.drawing.Text = js.native
  def stroke(color: String, width: Double, opacity: Double): typings.kendoDashUi.kendo.drawing.Text = js.native
}
