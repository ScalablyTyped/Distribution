...
trait TreeListFilterableOperatorsDate extends js.Object {
  @JSName("eq")
  var eq_FTreeListFilterableOperatorsDate: js.UndefOr[String] = js.undefined
...
object TreeListFilterableOperatorsDate {
  @scala.inline
  def apply(
    eq: String = null,
    gt: String = null,
    ...
    lte: String = null,
    neq: String = null
  ): TreeListFilterableOperatorsDate = {
