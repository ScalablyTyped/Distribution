...
object Layout extends js.Object {
  var fn: typings.kendoDashUi.kendoNs.mobileNs.uiNs.Layout = js.native
  def extend(proto: js.Object): typings.kendoDashUi.kendoNs.mobileNs.uiNs.Layout = js.native
}
