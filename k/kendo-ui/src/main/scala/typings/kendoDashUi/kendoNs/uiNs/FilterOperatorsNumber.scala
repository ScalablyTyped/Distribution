...
trait FilterOperatorsNumber extends js.Object {
  @JSName("eq")
  var eq_FFilterOperatorsNumber: js.UndefOr[String] = js.undefined
...
object FilterOperatorsNumber {
  ...
  def apply(
    ...
    __obj.asInstanceOf[FilterOperatorsNumber]
  }
}
