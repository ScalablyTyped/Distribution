...
class Scheduler protected () extends Widget {
  ...
  def editEvent(event: typings.kendoDashUi.kendoNs.dataNs.SchedulerEvent): Unit = js.native
  def items(): js.Any = js.native
  def occurrenceByUid(uid: String): typings.kendoDashUi.kendoNs.dataNs.SchedulerEvent = js.native
  def occurrencesInRange(start: Date, end: Date): js.Any = js.native
  def refresh(): Unit = js.native
  def removeEvent(event: String): Unit = js.native
  def removeEvent(event: typings.kendoDashUi.kendoNs.dataNs.SchedulerEvent): Unit = js.native
