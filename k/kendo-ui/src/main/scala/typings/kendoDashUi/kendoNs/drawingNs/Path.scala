...
object Path extends js.Object {
  def fromArc(arc: typings.kendoDashUi.kendoNs.geometryNs.Arc): Path = js.native
  def fromArc(arc: typings.kendoDashUi.kendoNs.geometryNs.Arc, options: js.Any): Path = js.native
  def fromPoints(points: js.Any): Path = js.native
  def fromPoints(points: js.Any, options: js.Any): Path = js.native
  def fromRect(rect: typings.kendoDashUi.kendoNs.geometryNs.Rect): Path = js.native
  def fromRect(rect: typings.kendoDashUi.kendoNs.geometryNs.Rect, options: js.Any): Path = js.native
