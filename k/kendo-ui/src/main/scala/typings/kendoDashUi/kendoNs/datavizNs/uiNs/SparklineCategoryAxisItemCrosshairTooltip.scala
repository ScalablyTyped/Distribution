...
trait SparklineCategoryAxisItemCrosshairTooltip extends js.Object {
...
object SparklineCategoryAxisItemCrosshairTooltip {
  ...
  def apply(
    ...
    border: SparklineCategoryAxisItemCrosshairTooltipBorder = null,
    color: String = null,
    font: String = null,
    format: String = null,
  ...
  ): SparklineCategoryAxisItemCrosshairTooltip = {
