...
@scala.inline
def getBindingHandler(handler: java.lang.String): typings.knockout.mod.BindingHandler[js.Any] = typings.knockout.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getBindingHandler")(handler.asInstanceOf[js.Any]).asInstanceOf[typings.knockout.mod.BindingHandler[js.Any]]

@scala.inline
def ignoreDependencies[Return, Target, Args /* <: js.Array[js.Any] */](callback: js.ThisFunction1[/* this */ Target, /* args */ Args, Return]): Return = typings.knockout.mod.^.asInstanceOf[js.Dynamic].applyDynamic("ignoreDependencies")(callback.asInstanceOf[js.Any]).asInstanceOf[Return]
@scala.inline
...
@scala.inline
def ignoreDependencies[Return, Target, Args /* <: js.Array[js.Any] */](
...
@scala.inline
def toJSON(rootObject: js.Any, replacer: scala.Unit, space: scala.Double): java.lang.String = (typings.knockout.mod.^.asInstanceOf[js.Dynamic].applyDynamic("toJSON")(rootObject.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any], space.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
