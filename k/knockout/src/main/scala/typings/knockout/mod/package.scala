...
inline def bindingHandlers: BindingHandlers_ = ^.asInstanceOf[js.Dynamic].selectDynamic("bindingHandlers").asInstanceOf[BindingHandlers_]
...
inline def computedContext: ComputedContext_ = ^.asInstanceOf[js.Dynamic].selectDynamic("computedContext").asInstanceOf[ComputedContext_]
...
inline def extenders: Extenders_[Any] = ^.asInstanceOf[js.Dynamic].selectDynamic("extenders").asInstanceOf[Extenders_[Any]]
...
inline def setTemplateEngine(templateEngine: templateEngine): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setTemplateEngine")(templateEngine.asInstanceOf[js.Any]).asInstanceOf[Unit]
...
/* parentContext */ BindingContext[T] | Null, 
/* dataItem */ T, 
Unit]

type BindingHandlerAddBinding = js.Function2[/* name */ String, /* value */ Any, Unit]
...
*/
type ComputedReadFunction[T, TTarget] = (_ComputedReadFunction[T, TTarget]) | Subscribable_[T] | (js.ThisFunction0[/* this */ TTarget, T])

type ComputedWriteFunction[T, TTarget] = js.ThisFunction1[/* this */ TTarget, /* val */ T, Unit]
...
type MaybeObservableArray[T] = js.Array[T] | ObservableArray_[T]

type MaybeSubscribable[T] = T | Subscribable_[T]

type PureComputed_[T] = Computed_[T]
