...
object ConfigOptions {
  ...
  implicit class ConfigOptionsOps[Self <: ConfigOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHtmlDetailed(value: HtmlDetailedOptions): Self = this.set("htmlDetailed", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHtmlDetailed: Self = this.set("htmlDetailed", js.undefined)
  }
