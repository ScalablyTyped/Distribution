...
class Consumer protected () extends js.Object {
  def this(client: Client, fetchRequests: js.Array[OffsetFetchRequest | String], options: ConsumerOptions) = this()
  ...
  def close(force: Boolean, cb: js.Function0[_]): Unit = js.native
