...
class Client protected () extends js.Object {
  ...
  def this(connectionString: String, clientId: String) = this()
  def this(connectionString: String, clientId: String, options: ZKOptions) = this()
  def this(connectionString: String, clientId: String, options: ZKOptions, noBatchOptions: AckBatchOptions) = this()
  def this(
