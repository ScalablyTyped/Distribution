...
object CoverageIstanbulReporter {
  ...
  def apply(
    ...
    if (!js.isUndefined(combineBrowserReports)) __obj.updateDynamic("combineBrowserReports")(combineBrowserReports)
    if (dir != null) __obj.updateDynamic("dir")(dir)
    if (!js.isUndefined(fixWebpackSourcePaths)) __obj.updateDynamic("fixWebpackSourcePaths")(fixWebpackSourcePaths)
    if (instrumentation != null) __obj.updateDynamic("instrumentation")(instrumentation)
    if (`report-config` != null) __obj.updateDynamic("report-config")(`report-config`)
    if (reports != null) __obj.updateDynamic("reports")(reports)
    if (!js.isUndefined(skipFilesWithNoCoverage)) __obj.updateDynamic("skipFilesWithNoCoverage")(skipFilesWithNoCoverage)
