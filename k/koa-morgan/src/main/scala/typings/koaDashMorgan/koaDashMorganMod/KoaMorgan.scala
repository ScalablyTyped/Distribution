...
trait KoaMorgan extends js.Object {
  /**
    ...
    */
  def apply(format: String): Middleware[_, js.Object] = js.native
  def apply(format: String, options: Options): Middleware[_, js.Object] = js.native
  /**
    ...
    */
  def apply(format: FormatFn): Middleware[_, js.Object] = js.native
  def apply(format: FormatFn, options: Options): Middleware[_, js.Object] = js.native
  /**
    * Standard Apache combined log output.
    * :remote-addr - :remote-user [:date] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":user-agent"
    */
  def apply(format: combined): Middleware[_, js.Object] = js.native
  def apply(format: combined, options: Options): Middleware[_, js.Object] = js.native
  /**
    * Standard Apache common log output.
    * :remote-addr - :remote-user [:date] ":method :url HTTP/:http-version" :status :res[content-length]
    */
  def apply(format: common): Middleware[_, js.Object] = js.native
  def apply(format: common, options: Options): Middleware[_, js.Object] = js.native
  /**
    ...
    */
  def apply(format: dev): Middleware[_, js.Object] = js.native
  def apply(format: dev, options: Options): Middleware[_, js.Object] = js.native
  /**
    * Shorter than default, also including response time.
    * :remote-addr :remote-user :method :url HTTP/:http-version :status :res[content-length] - :response-time ms
    */
  def apply(format: short): Middleware[_, js.Object] = js.native
  def apply(format: short, options: Options): Middleware[_, js.Object] = js.native
  /**
    * The minimal output.
    * :method :url :status :res[content-length] - :response-time ms
    */
  def apply(format: tiny): Middleware[_, js.Object] = js.native
  def apply(format: tiny, options: Options): Middleware[_, js.Object] = js.native
  /**
