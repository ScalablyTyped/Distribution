...
trait KoaMorgan extends js.Object {
  ...
  /**
    ...
    */
  def apply(format: FormatFn): koaLib.koaMod.Middleware[_, js.Object] = js.native
  def apply(format: FormatFn, options: Options): koaLib.koaMod.Middleware[_, js.Object] = js.native
  /**
