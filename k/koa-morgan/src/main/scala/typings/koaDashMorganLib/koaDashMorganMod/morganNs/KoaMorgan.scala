...
trait KoaMorgan extends js.Object {
  ...
  def apply(format: java.lang.String, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
  ...
  def apply(format: koaDashMorganLib.koaDashMorganLibStrings.combined, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
  ...
  def apply(format: koaDashMorganLib.koaDashMorganLibStrings.common, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
  ...
  def apply(format: koaDashMorganLib.koaDashMorganLibStrings.dev, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
  ...
  def apply(format: koaDashMorganLib.koaDashMorganLibStrings.short, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
    * The minimal output.
  ...
  def apply(format: koaDashMorganLib.koaDashMorganLibStrings.tiny, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
    ...
    */
  def apply(format: FormatFn): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  def apply(format: FormatFn, options: Options): koaLib.koaMod.ApplicationNs.Middleware[_, js.Object] = js.native
  /**
