...
trait Grant extends js.Object {
  ...
  def store(request: expressLib.expressMod.Request, response: expressLib.expressMod.Response): scala.Unit
...
object Grant {
  ...
  def apply(
    ...
    refresh_token: Token,
    store: (expressLib.expressMod.Request, expressLib.expressMod.Response) => scala.Unit,
