...
trait Keycloak extends js.Object {
  def accessDenied(request: Request_[ParamsDictionary], response: Response_[_]): Unit = js.native
  ...
  def getGrant(request: Request_[ParamsDictionary], response: Response_[_]): js.Promise[Grant] = js.native
  def getGrantFromCode(code: String, request: Request_[ParamsDictionary], response: Response_[_]): js.Promise[Grant] = js.native
  ...
  def storeGrant(grant: Grant, request: Request_[ParamsDictionary], response: Response_[_]): Grant = js.native
