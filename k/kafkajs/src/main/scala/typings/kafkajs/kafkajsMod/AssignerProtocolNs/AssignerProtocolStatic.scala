...
trait AssignerProtocolStatic extends js.Object {
  var MemberAssignment: typings.kafkajs.kafkajsMod.AssignerProtocolNs.MemberAssignment
  var MemberMetadata: typings.kafkajs.kafkajsMod.AssignerProtocolNs.MemberMetadata
}
