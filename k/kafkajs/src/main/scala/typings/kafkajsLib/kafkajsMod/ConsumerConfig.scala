...
trait ConsumerConfig extends js.Object {
  ...
  var rebalanceTimeout: js.UndefOr[scala.Double] = js.undefined
...
object ConsumerConfig {
  ...
  def apply(
    ...
    rebalanceTimeout: scala.Int | scala.Double = null,
    ...
    if (rebalanceTimeout != null) __obj.updateDynamic("rebalanceTimeout")(rebalanceTimeout.asInstanceOf[js.Any])
