...
name := "koa-docs"
version := "2.1-dt-20211202Z-be2122"
scalaVersion := "3.1.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "6.1-dt-20211202Z-da03c2",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "8.0-dt-20220106Z-6cca90",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20211202Z-c8140e",
