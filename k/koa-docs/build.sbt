...
name := "koa-docs"
version := "2.1-dt-20191104Z-66f83b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-16a90b",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20191107Z-1a34d7",
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20191016Z-0bd655",
