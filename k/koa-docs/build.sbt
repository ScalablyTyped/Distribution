...
name := "koa-docs"
version := "2.1-dt-20191104Z-5286bf"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-7fd1ef",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20191107Z-abca9f",
  "org.scalablytyped" %%% "koa-router" % "v7.x-dt-20191016Z-694e95",
