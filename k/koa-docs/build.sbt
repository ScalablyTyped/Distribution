...
name := "koa-docs"
version := "2.1-dt-20191104Z-3bd270"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-44b161",
