...
name := "koa-docs"
version := "2.1-dt-20211202Z-7636ae"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "6.1-dt-20211202Z-428d5d",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "8.0-dt-20220106Z-03992a",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20211202Z-632ab8",
