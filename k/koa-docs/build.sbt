...
name := "koa-docs"
version := "2.1-dt-20191104Z-6dd8f7"
scalaVersion := "2.13.2"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "5.1-dt-20200515Z-4ba5d3",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20200515Z-2b5361",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20200515Z-4ff344",
