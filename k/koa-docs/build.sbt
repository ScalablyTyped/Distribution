...
name := "koa-docs"
version := "2.1-dt-20191104Z-73516b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-9350ee",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20190423Z-2b35ca",
  ...
  "org.scalablytyped" %%% "qs" % "6.5-dt-20190409Z-2968d4",
