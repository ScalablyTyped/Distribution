...
name := "koa-docs"
version := "2.1-dt-20191104Z-701dab"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "0.0-unknown-dt-20190322Z-8d0105",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20191107Z-524b06",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20200109Z-2aa7ad",
  "org.scalablytyped" %%% "mime" % "2.0-dt-20191126Z-4fb0bc",
  "org.scalablytyped" %%% "node" % "13.7-dt-20200211Z-d6af7e",
  "org.scalablytyped" %%% "qs" % "6.9-dt-20200207Z-895c03",
