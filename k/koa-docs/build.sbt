...
name := "koa-docs"
version := "2.1-dt-20191104Z-d2e3e0"
scalaVersion := "3.0.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "5.1-dt-20200923Z-3a6610",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "5.2-dt-20201010Z-1b203a",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20201002Z-84fc5b",
