...
name := "koa-docs"
version := "2.1-dt-20211202Z-566017"
scalaVersion := "3.2.0"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "co-body" % "6.1-dt-20211202Z-748d29",
  ...
  "org.scalablytyped" %%% "koa-joi-router" % "8.0-dt-20220106Z-4c5252",
  "org.scalablytyped" %%% "koa-router" % "7.4-dt-20211202Z-b8340c",
