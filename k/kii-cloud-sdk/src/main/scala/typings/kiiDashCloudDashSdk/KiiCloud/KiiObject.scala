...
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringBodyBlob
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureObj
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureObjPublishedUrl
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheDeletedObject
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheObject
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureSuccessTheSrcObject
...
class KiiObject () extends js.Object {
  ...
  def publishBodyExpiresAt(expiresAt: Date, callbacks: Anon_AnErrorStringFailureObjPublishedUrl): js.Promise[js.Tuple2[KiiObject, String]] = js.native
  /**
