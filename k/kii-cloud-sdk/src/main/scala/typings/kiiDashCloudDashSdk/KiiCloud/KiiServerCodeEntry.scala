...
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringArgument
...
/**
  ...
  */
@JSGlobal("KiiCloud.KiiServerCodeEntry")
@js.native
class KiiServerCodeEntry () extends js.Object {
  /**
  ...
  def execute[T](argument: T, callbacks: Anon_AnErrorStringArgument[T]): js.Promise[js.Tuple3[KiiServerCodeEntry, T, KiiServerCodeExecResult]] = js.native
  /**
