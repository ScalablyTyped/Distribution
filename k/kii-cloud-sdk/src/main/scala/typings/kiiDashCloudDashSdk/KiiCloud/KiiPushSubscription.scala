...
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureIsSubscribed
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureIsSubscribedSubscription
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureSubscription
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureSubscriptionSuccess
...
class KiiPushSubscription () extends js.Object {
  ...
  def isSubscribed(target: KiiBucket, callbacks: Anon_ErrorFailureIsSubscribed): js.Promise[js.Tuple3[KiiPushSubscription, KiiBucket, Boolean]] = js.native
  def isSubscribed(target: KiiTopic): js.Promise[js.Tuple3[KiiPushSubscription, KiiTopic, Boolean]] = js.native
  def isSubscribed(target: KiiTopic, callbacks: Anon_ErrorFailureIsSubscribedSubscription): js.Promise[js.Tuple3[KiiPushSubscription, KiiTopic, Boolean]] = js.native
  /**
  ...
  def subscribe(target: KiiBucket, callbacks: Anon_ErrorFailureSubscription): js.Promise[js.Tuple2[KiiPushSubscription, KiiBucket]] = js.native
  def subscribe(target: KiiTopic): js.Promise[js.Tuple2[KiiPushSubscription, KiiTopic]] = js.native
  def subscribe(target: KiiTopic, callbacks: Anon_ErrorFailureSubscriptionSuccess): js.Promise[js.Tuple2[KiiPushSubscription, KiiTopic]] = js.native
  /**
  ...
  def unsubscribe(target: KiiBucket, callbacks: Anon_ErrorFailureSubscription): js.Promise[js.Tuple2[KiiPushSubscription, KiiBucket]] = js.native
  def unsubscribe(target: KiiTopic): js.Promise[js.Tuple2[KiiPushSubscription, KiiTopic]] = js.native
  def unsubscribe(target: KiiTopic, callbacks: Anon_ErrorFailureSubscriptionSuccess): js.Promise[js.Tuple2[KiiPushSubscription, KiiTopic]] = js.native
}
