...
import typings.kiiDashCloudDashSdk.Anon_ErrorExisted
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureMessage
import typings.kiiDashCloudDashSdk.Anon_ErrorFailureSuccessTopic
...
class KiiTopic () extends js.Object {
  ...
  def deleteTopic(callbacks: Anon_ErrorFailureSuccessTopic): js.Promise[KiiTopic] = js.native
  /**
  ...
  def exists(callbacks: Anon_ErrorExisted): js.Promise[Boolean] = js.native
  /**
  ...
  def save(callbacks: Anon_ErrorFailureSuccessTopic): js.Promise[KiiTopic] = js.native
  /**
  ...
  def sendMessage[T](message: T, callbacks: Anon_ErrorFailureMessage[T]): js.Promise[js.Tuple2[KiiTopic, T]] = js.native
}
