...
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringBucket
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringBucketToDelete
import typings.kiiDashCloudDashSdk.Anon_Bucket
...
class KiiBucket () extends js.Object {
  ...
  def count(callbacks: Anon_Bucket): js.Promise[js.Tuple3[KiiBucket, KiiQuery, Double]] = js.native
  /**
  ...
  def countWithQuery(query: KiiQuery, callbacks: Anon_Bucket): js.Promise[js.Tuple3[KiiBucket, KiiQuery, Double]] = js.native
  /**
  ...
  def delete(callbacks: Anon_AnErrorStringBucketToDelete): js.Promise[KiiBucket] = js.native
  /**
  ...
  def executeQuery[T](query: KiiQuery, callbacks: Anon_AnErrorStringBucket[T]): js.Promise[js.Tuple3[KiiQuery, js.Array[T], KiiQuery]] = js.native
  /**
