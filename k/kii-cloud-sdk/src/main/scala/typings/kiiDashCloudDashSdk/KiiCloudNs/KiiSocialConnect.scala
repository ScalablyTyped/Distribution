...
import typings.kiiDashCloudDashSdk.Anon_AnErrorStringFailureNetwork
...
object KiiSocialConnect extends js.Object {
  ...
  def linkCurrentUserWithNetwork(
    ...
    callbacks: Anon_AnErrorStringFailureNetwork
  ...
  def unLinkCurrentUserFromNetwork(networkName: KiiSocialNetworkName, callbacks: Anon_AnErrorStringFailureNetwork): js.Promise[js.Tuple2[KiiUser, KiiSocialNetworkName]] = js.native
}
