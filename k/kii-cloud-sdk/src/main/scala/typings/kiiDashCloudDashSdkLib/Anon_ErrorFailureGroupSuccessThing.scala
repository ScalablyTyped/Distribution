...
trait Anon_ErrorFailureGroupSuccessThing extends js.Object {
  ...
  def success(
    ...
    group: kiiDashCloudDashSdkLib.KiiCloudNs.KiiUser
  ): js.Any
}
...
object Anon_ErrorFailureGroupSuccessThing {
  ...
  def apply(
    ...
    success: (kiiDashCloudDashSdkLib.KiiCloudNs.KiiThing, kiiDashCloudDashSdkLib.KiiCloudNs.KiiUser) => js.Any
  ): Anon_ErrorFailureGroupSuccessThing = {
