...
class KiiUserBuilder () extends js.Object {
  ...
  /**
    ...
    *     proper format
    */
  def setEmailAddress(emailAddress: java.lang.String): KiiUserBuilder = js.native
  /**
    ...
    */
  def setGlobalPhoneNumber(phoneNumber: java.lang.String): KiiUserBuilder = js.native
  /**
    ...
    */
  def setLocalPhoneNumber(phoneNumber: java.lang.String, country: java.lang.String): KiiUserBuilder = js.native
  /**
    * Set user name.
    *
...
object KiiUserBuilder extends js.Object {
  /**
    ...
    *     proper format
    */
  def builderWithEmailAddress(emailAddress: java.lang.String, password: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiUserBuilder = js.native
  /**
    ...
    */
  def builderWithGlobalPhoneNumber(phoneNumber: java.lang.String, password: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiUserBuilder = js.native
  /**
    ...
    *     proper format
    */
  def builderWithIdentifier(identifier: java.lang.String, password: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiUserBuilder = js.native
  /**
    ...
    *     proper format
    */
  def builderWithLocalPhoneNumber(phoneNumber: java.lang.String, country: java.lang.String, password: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiUserBuilder = js.native
  /**
    ...
    *     proper format
    */
  def builderWithUsername(username: java.lang.String, password: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiUserBuilder = js.native
}
