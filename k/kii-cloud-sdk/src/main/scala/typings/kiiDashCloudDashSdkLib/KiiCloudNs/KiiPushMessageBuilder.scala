...
class KiiPushMessageBuilder protected () extends js.Object {
  ...
  /**
           ...
           */
  def apnsAlert(alert: java.lang.String): KiiPushMessageBuilder = js.native
  /**
           * Set alert for APNS subscribers.
           * If this method is not called, no alert is applied.
           * For details please refer to APNS document of alert.
  ...
  /**
           ...
           * @return builder instance.
           */
  def apnsBadge(badge: scala.Double): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def apnsCategory(category: java.lang.String): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def apnsContentAvailable(contentAvailable: scala.Double): KiiPushMessageBuilder = js.native
  /**
  ...
  /**
           ...
           * @return builder instance.
           */
  def apnsSound(sound: java.lang.String): KiiPushMessageBuilder = js.native
  /**
           * build push message.
           *
  ...
  /**
           ...
           * @return builder instance.
           */
  def enableApns(enable: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def enableGcm(enable: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def enableJpush(enable: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def enableMqtt(enable: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def gcmCollapseKey(collapseKey: java.lang.String): KiiPushMessageBuilder = js.native
  /**
  ...
  /**
           ...
           * @return builder instance.
           */
  def gcmDelayWhileIdle(delayWhileIdle: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def gcmRestrictedPackageName(restrictedPackageName: java.lang.String): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def gcmTimeToLive(timeToLive: scala.Double): KiiPushMessageBuilder = js.native
  /**
  ...
  /**
           ...
           * @return builder instance.
           */
  def setSendToDevelopment(flag: scala.Boolean): KiiPushMessageBuilder = js.native
  /**
           ...
           * @return builder instance.
           */
  def setSendToProduction(flag: scala.Boolean): KiiPushMessageBuilder = js.native
}
