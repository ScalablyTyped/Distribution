...
class KiiACLEntry () extends js.Object {
  ...
  /**
           ...
           *
           */
  def getGrant(): scala.Boolean = js.native
  /**
  ...
  /**
           ...
           */
  def setAction(value: KiiACLAction): scala.Unit = js.native
  /**
           ...
           */
  def setGrant(value: scala.Boolean): scala.Unit = js.native
  /**
...
object KiiACLEntry extends js.Object {
  /**
           ...
           */
  def entryWithSubject(
    Subject: kiiDashCloudDashSdkLib.KiiCloudNs.KiiACLSubject,
    action: kiiDashCloudDashSdkLib.KiiCloudNs.KiiACLAction
  ): kiiDashCloudDashSdkLib.KiiCloudNs.KiiACLEntry = js.native
}
