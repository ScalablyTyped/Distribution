...
object Kii extends js.Object {
  ...
  def authenticateAsAppAdmin(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_AdminContext
  ...
  def authenticateAsThing(
    ...
    callbacks: kiiDashCloudDashSdkLib.Anon_Error
  ...
  def authenticateAsThingWithToken(thingID: java.lang.String, token: java.lang.String, callbacks: kiiDashCloudDashSdkLib.Anon_Error): js.Promise[kiiDashCloudDashSdkLib.KiiCloudNs.KiiThingContext] = js.native
  /**
    ...
    */
  def bucketWithName(bucketName: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiBucket = js.native
  /**
    ...
    */
  def encryptedBucketWithName(bucketName: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiBucket = js.native
  /**
    ...
    */
  def getAccessTokenExpiration(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getBuildNumber(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    *     Kii.initialize("my-app-id", "my-app-key", {});
    */
  def initialize(appID: java.lang.String, appKey: java.lang.String): scala.Unit = js.native
  def initialize(appID: java.lang.String, appKey: java.lang.String, analyticsOption: js.Any): scala.Unit = js.native
  /**
    ...
    *     Kii.initializeWithSite("my-app-id", "my-app-key", KiiSite.JP, {});
    */
  def initializeWithSite(appID: java.lang.String, appKey: java.lang.String, site: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSite): scala.Unit = js.native
  def initializeWithSite(
    appID: java.lang.String,
    appKey: java.lang.String,
    site: kiiDashCloudDashSdkLib.KiiCloudNs.KiiSite,
    analyticsOption: js.Any
  ...
  def listTopics(callbacks: kiiDashCloudDashSdkLib.Anon_AnErrorString): js.Promise[
    js.Tuple2[js.Array[kiiDashCloudDashSdkLib.KiiCloudNs.KiiTopic], java.lang.String]
  ] = js.native
  def listTopics(callbacks: kiiDashCloudDashSdkLib.Anon_AnErrorString, paginationKey: java.lang.String): js.Promise[
    js.Tuple2[js.Array[kiiDashCloudDashSdkLib.KiiCloudNs.KiiTopic], java.lang.String]
  ] = js.native
  /**
    ...
    */
  def serverCodeEntry(entryName: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiServerCodeEntry = js.native
  /**
    ...
    */
  def serverCodeEntryWithVersion(entryName: java.lang.String, version: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiServerCodeEntry = js.native
  /**
    ...
    */
  def setAccessTokenExpiration(expiresIn: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def topicWithName(topicName: java.lang.String): kiiDashCloudDashSdkLib.KiiCloudNs.KiiTopic = js.native
}
