...
object Anon_ErrorFailureIsSubscribedSubscription {
  ...
  def apply(
    ...
    success: (kiiDashCloudDashSdkLib.KiiCloudNs.KiiPushSubscription, kiiDashCloudDashSdkLib.KiiCloudNs.KiiTopic, scala.Boolean) => js.Any
  ): Anon_ErrorFailureIsSubscribedSubscription = {
