...
trait AnonErrorFailureIsOwnerSuccess extends js.Object {
  def failure(error: Error): js.Any
  def success(thing: KiiThing, user: KiiGroup, isOwner: Boolean): js.Any
}

object AnonErrorFailureIsOwnerSuccess {
  @scala.inline
  def apply(failure: Error => js.Any, success: (KiiThing, KiiGroup, Boolean) => js.Any): AnonErrorFailureIsOwnerSuccess = {
    val __obj = js.Dynamic.literal(failure = js.Any.fromFunction1(failure), success = js.Any.fromFunction3(success))
  
    __obj.asInstanceOf[AnonErrorFailureIsOwnerSuccess]
  }
}
