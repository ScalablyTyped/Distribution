...
object `14` {
  ...
  inline def apply(failure: (KiiObject, String) => js.Any, success: (KiiObject, Blob) => js.Any): `14` = {
  ...
  extension [Self <: `14`](x: Self) {
    ...
    inline def setSuccess(value: (KiiObject, Blob) => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction2(value))
  }
}
