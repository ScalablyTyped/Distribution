...
object `25` {
  ...
  inline def apply(failure: Error => js.Any, success: (KiiThing, KiiUser, Boolean) => js.Any): `25` = {
  ...
  extension [Self <: `25`](x: Self) {
    ...
    inline def setSuccess(value: (KiiThing, KiiUser, Boolean) => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction3(value))
  }
}
