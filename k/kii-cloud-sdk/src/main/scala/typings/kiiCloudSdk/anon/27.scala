...
object `27` {
  ...
  inline def apply(failure: Error => js.Any, success: (KiiThing, KiiUser) => js.Any): `27` = {
  ...
  extension [Self <: `27`](x: Self) {
    ...
    inline def setSuccess(value: (KiiThing, KiiUser) => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction2(value))
  }
}
