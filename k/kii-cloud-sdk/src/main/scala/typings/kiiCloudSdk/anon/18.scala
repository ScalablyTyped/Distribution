...
object `18` {
  ...
  inline def apply(failure: Error => js.Any, success: KiiMqttEndpoint => js.Any): `18` = {
  ...
  extension [Self <: `18`](x: Self) {
    ...
    inline def setSuccess(value: KiiMqttEndpoint => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
  }
}
