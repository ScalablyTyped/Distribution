...
object `20` {
  ...
  inline def apply(failure: Error => js.Any, success: (KiiPushSubscription, KiiBucket) => js.Any): `20` = {
  ...
  extension [Self <: `20`](x: Self) {
    ...
    inline def setSuccess(value: (KiiPushSubscription, KiiBucket) => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction2(value))
  }
}
