...
object `35` {
  ...
  inline def apply(failure: Error => js.Any, success: KiiThingContext => js.Any): `35` = {
  ...
  extension [Self <: `35`](x: Self) {
    ...
    inline def setSuccess(value: KiiThingContext => js.Any): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
  }
}
