...
object KiiUser extends js.Object {
  ...
  /**
    ...
    */
  def getCurrentUser(): KiiUser = js.native
  /**
  ...
  /**
    ...
    */
  def userWithCredentials(emailAddress: String, phoneNumber: String, username: String, password: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    * <br><br>Creates an pre-filled user object for registration. This user will not be authenticated until the registration method is called on it. It can be treated as any other KiiUser before
    ...
    */
  def userWithEmailAddress(emailAddress: String, password: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    * <br><br>Creates an pre-filled user object for registration. This user will not be authenticated until the registration method is called on it. It can be treated as any other KiiUser before
    ...
    */
  def userWithEmailAddressAndPhoneNumber(emailAddress: String, phoneNumber: String, password: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    * <br><br>Creates an pre-filled user object for registration. This user will not be authenticated until the registration method is called on it. It can be treated as any other KiiUser before
    ...
    */
  def userWithEmailAddressAndUsername(emailAddress: String, username: String, password: String): KiiUser = js.native
  /**
    ...
    */
  def userWithID(userID: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    * <br><br>Creates an pre-filled user object for registration. This user will not be authenticated until the registration method is called on it. It can be treated as any other KiiUser before
    ...
    */
  def userWithPhoneNumber(phoneNumber: String, password: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    * <br><br>Creates an pre-filled user object for registration. This user will not be authenticated until the registration method is called on it. It can be treated as any other KiiUser before
    ...
    */
  def userWithPhoneNumberAndUsername(phoneNumber: String, username: String, password: String): KiiUser = js.native
  /**
    ...
    */
  def userWithURI(uri: String): KiiUser = js.native
  /**
    * Create a user object to prepare for registration with credentials pre-filled
    *
    ...
    *     var user = KiiUser.userWithUsername("myusername", "mypassword");
    */
  def userWithUsername(username: String, password: String): KiiUser = js.native
}
