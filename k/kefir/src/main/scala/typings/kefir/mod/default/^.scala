...
object ^ extends js.Object {
  ...
  def combine[T /* <: StringDictionary[Observable[_, _]] */, K /* <: StringDictionary[Observable[_, _]] */](obss: T, passiveObss: K): Stream_[typings.kefir.kefirStrings.^  with TopLevel[T] with TopLevel[K], _] = js.native
  ...
  var staticLand: typings.kefir.anon.Observable = js.native
