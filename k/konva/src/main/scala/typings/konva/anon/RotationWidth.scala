...
@js.native
trait RotationWidth extends js.Object {
...
object RotationWidth {
  ...
  @scala.inline
  implicit class RotationWidthOps[Self <: RotationWidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRotation(value: js.Any): Self = this.set("rotation", value.asInstanceOf[js.Any])
