...
object default {
  ...
  object Animation {
    ...
    inline def addAnimation(anim: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_addAnimation")(anim.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    inline def removeAnimation(anim: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_removeAnimation")(anim.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object Collection {
    ...
    inline def mapMethod(methodName: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("_mapMethod")(methodName.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    inline def toCollection[ChildNode /* <: Node[NodeConfig] */](arr: js.Array[ChildNode]): typings.konva.utilMod.Collection[ChildNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("toCollection")(arr.asInstanceOf[js.Any]).asInstanceOf[typings.konva.utilMod.Collection[ChildNode]]
  }
  ...
  object Node {
    ...
    inline def createNode(obj: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("_createNode")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Any]
    inline def createNode(obj: js.Any, container: js.Any): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("_createNode")(obj.asInstanceOf[js.Any], container.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  }
