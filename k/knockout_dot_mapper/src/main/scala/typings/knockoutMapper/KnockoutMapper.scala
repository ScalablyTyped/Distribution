...
trait KnockoutMapper extends js.Object {
  ...
  def fromJS(value: js.Any, options: js.UndefOr[scala.Nothing], target: js.Any): js.Any = js.native
  def fromJS(value: js.Any, options: js.UndefOr[scala.Nothing], target: js.Any, wrap: Boolean): js.Any = js.native
