...
/* Inlined koa2-ratelimit.koa2-ratelimit.RateLimitOptions & {  key :string,   ip :string,   user_id :any} */
@js.native
trait RateLimitOptionskeystring extends js.Object {
...
object RateLimitOptionskeystring {
  ...
  ): RateLimitOptionskeystring = {
    val __obj = js.Dynamic.literal(delayAfter = delayAfter.asInstanceOf[js.Any], getUserId = js.Any.fromFunction1(getUserId), handler = js.Any.fromFunction1(handler), headers = headers.asInstanceOf[js.Any], interval = interval.asInstanceOf[js.Any], ip = ip.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], keyGenerator = js.Any.fromFunction1(keyGenerator), max = max.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], onLimitReached = js.Any.fromFunction1(onLimitReached), prefixKey = prefixKey.asInstanceOf[js.Any], skip = js.Any.fromFunction1(skip), skipFailedRequests = skipFailedRequests.asInstanceOf[js.Any], statusCode = statusCode.asInstanceOf[js.Any], store = store.asInstanceOf[js.Any], timeWait = timeWait.asInstanceOf[js.Any], user_id = user_id.asInstanceOf[js.Any], weight = js.Any.fromFunction1(weight), whitelist = whitelist.asInstanceOf[js.Any])
    __obj.asInstanceOf[RateLimitOptionskeystring]
  }
  
  @scala.inline
  implicit class RateLimitOptionskeystringOps[Self <: RateLimitOptionskeystring] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUser_id(value: js.Any): Self = this.set("user_id", value.asInstanceOf[js.Any])
