package typings
package knexDashPostgisLib.knexDashPostgisMod.KnexPostgisNs
...
trait KnexPostgis extends js.Object {
  /**
           ...
           */
  def area(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def asEWKT(column: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Return the geometry as a GeoJSON element.
           *
           * @see {@link https://postgis.net/docs/ST_AsGeoJSON.html}
           */
  def asGeoJSON(column: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def asText(column: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def buffer(geom: knexDashPostgisLib.ColumnName, radius: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Returns the geometric center of a geometry.
           *
           * @see {@link https://postgis.net/docs/ST_Centroid.html}
           */
  def centroid(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def distance(geom1: knexDashPostgisLib.ColumnName, geom2: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def dwithin(geom1: knexDashPostgisLib.ColumnName, geom2: knexDashPostgisLib.ColumnName, distance: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Returns true if the geometries are within the specified distance of one another. For
           * geometry units are in those of spatial reference and For geography units are in meters
           * and measurement is defaulted to use_spheroid=true (measure around spheroid), for faster
  ...
  ): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Casts geometry to geography
           */
  def geography(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def geomFromGeoJSON(geojson: geojsonLib.geojsonMod.GeoJsonObject): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Takes as input a geojson representation of a geometry and outputs a PostGIS geometry object
           *
           * @see {@link https://postgis.net/docs/ST_GeomFromGeoJSON.html}
           */
  def geomFromGeoJSON(geojson: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Return a specified ST_Geometry value from Well-Known Text representation (WKT).
           *
           * @see {@link https://postgis.net/docs/ST_GeomFromText.html}
           */
  def geomFromText(wkt: java.lang.String): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Return a specified ST_Geometry value from Well-Known Text representation (WKT).
           *
           * @see {@link https://postgis.net/docs/ST_GeomFromText.html}
           */
  def geomFromText(wkt: java.lang.String, srid: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Casts geography to geometry
           */
  def geometry(geography: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def intersection(geom1: knexDashPostgisLib.ColumnName, geom2: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def intersects(geom1: knexDashPostgisLib.ColumnName, geom2: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def makeEnvelope(minlon: scala.Double, minlat: scala.Double, maxlon: scala.Double, maxlat: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Creates a rectangular Polygon formed from the given minimums and maximums. Input values
           * must be in SRS specified by the SRID.
           *
  ...
  /**
           ...
           */
  def makePoint(lon: scala.Double, lat: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Creates a 2D,3DZ or 4D point geometry.
           *
           * @see {@link https://postgis.net/docs/ST_MakePoint.html}
           */
  def makePoint(lon: scala.Double, lat: scala.Double, z: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Creates a 2D,3DZ or 4D point geometry.
           *
           * @see {@link https://postgis.net/docs/ST_MakePoint.html}
           */
  def makePoint(lon: scala.Double, lat: scala.Double, z: scala.Double, measure: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Attempts to make an invalid geometry valid without losing vertices.
           *
           * @see {@link https://postgis.net/docs/ST_MakeValid.html}
           */
  def makeValid(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def point(lon: scala.Double, lat: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           ...
           */
  def transform(geom: knexDashPostgisLib.ColumnName, srid: scala.Double): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Returns true if the geometry A is completely inside geometry B
           *
           * @see {@link https://postgis.net/docs/ST_Within.html}
           */
  def within(geom1: knexDashPostgisLib.ColumnName, geom2: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Return the X coordinate of the point, or NULL if not available. Input must be a point.
           *
           * @see {@link https://postgis.net/docs/ST_X.html}
           */
  def x(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
  /**
           * Return the Y coordinate of the point, or NULL if not available. Input must be a point.
           *
           * @see {@link https://postgis.net/docs/ST_Y.html}
           */
  def y(geom: knexDashPostgisLib.ColumnName): knexLib.knexMod.KnexNs.QueryBuilder = js.native
}
