...
import typings.knexDashPostgis.knexDashPostgisMod.ColumnName
import typings.knexDashPostgis.knexDashPostgisMod.KnexPostgis
...
@js.native
object knexDashPostgisMod extends js.Object {
  @js.native
  trait KnexPostgis extends js.Object {
    /**
      ...
      */
    def area(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def asEWKT(column: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Return the geometry as a GeoJSON element.
      *
      * @see {@link https://postgis.net/docs/ST_AsGeoJSON.html}
      */
    def asGeoJSON(column: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def asText(column: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def buffer(geom: ColumnName, radius: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Returns the geometric center of a geometry.
      *
      * @see {@link https://postgis.net/docs/ST_Centroid.html}
      */
    def centroid(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def distance(geom1: ColumnName, geom2: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def dwithin(geom1: ColumnName, geom2: ColumnName, distance: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def dwithin(geom1: ColumnName, geom2: ColumnName, distance: Double, spheroid: Boolean): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Casts geometry to geography
      */
    def geography(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def geomFromGeoJSON(geojson: GeoJsonObject): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def geomFromGeoJSON(geojson: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Return a specified ST_Geometry value from Well-Known Text representation (WKT).
      *
      * @see {@link https://postgis.net/docs/ST_GeomFromText.html}
      */
    def geomFromText(wkt: String): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def geomFromText(wkt: String, srid: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Casts geography to geometry
      */
    def geometry(geography: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def intersection(geom1: ColumnName, geom2: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def intersects(geom1: ColumnName, geom2: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def makeEnvelope(minlon: Double, minlat: Double, maxlon: Double, maxlat: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def makeEnvelope(minlon: Double, minlat: Double, maxlon: Double, maxlat: Double, srid: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Creates a 2D,3DZ or 4D point geometry.
      *
      * @see {@link https://postgis.net/docs/ST_MakePoint.html}
      */
    def makePoint(lon: Double, lat: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def makePoint(lon: Double, lat: Double, z: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    def makePoint(lon: Double, lat: Double, z: Double, measure: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Attempts to make an invalid geometry valid without losing vertices.
      *
      * @see {@link https://postgis.net/docs/ST_MakeValid.html}
      */
    def makeValid(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def point(lon: Double, lat: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      ...
      */
    def transform(geom: ColumnName, srid: Double): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Returns true if the geometry A is completely inside geometry B
      *
      * @see {@link https://postgis.net/docs/ST_Within.html}
      */
    def within(geom1: ColumnName, geom2: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Return the X coordinate of the point, or NULL if not available. Input must be a point.
      *
      * @see {@link https://postgis.net/docs/ST_X.html}
      */
    def x(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
    /**
      * Return the Y coordinate of the point, or NULL if not available. Input must be a point.
      *
      * @see {@link https://postgis.net/docs/ST_Y.html}
      */
    def y(geom: ColumnName): QueryBuilder[_, js.Array[SafePartial[_]]] = js.native
  }
