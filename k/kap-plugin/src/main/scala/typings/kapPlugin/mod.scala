...
object mod {
  ...
  object ConfigSchema {
    ...
    inline def apply[TValue](): ConfigSchema[TValue] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ConfigSchema[TValue]]
    }
    
    extension [Self <: ConfigSchema[?], TValue](x: Self & ConfigSchema[TValue]) {
      ...
      inline def setDefault(value: TValue): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object Format {
    ...
    inline def apng: typings.kapPlugin.kapPluginStrings.apng = "apng".asInstanceOf[typings.kapPlugin.kapPluginStrings.apng]
    
    inline def gif: typings.kapPlugin.kapPluginStrings.gif = "gif".asInstanceOf[typings.kapPlugin.kapPluginStrings.gif]
    
    inline def mp4: typings.kapPlugin.kapPluginStrings.mp4 = "mp4".asInstanceOf[typings.kapPlugin.kapPluginStrings.mp4]
    
    inline def webm: typings.kapPlugin.kapPluginStrings.webm = "webm".asInstanceOf[typings.kapPlugin.kapPluginStrings.webm]
  }
  ...
  object KapShareService {
    ...
    extension [Self <: KapShareService[?], T](x: Self & KapShareService[T]) {
      
      inline def setAction(value: KapContext[T] => js.Promise[Unit]): Self = StObject.set(x, "action", js.Any.fromFunction1(value))
      ...
      inline def setConfigDescription(value: String): Self = StObject.set(x, "configDescription", value.asInstanceOf[js.Any])
