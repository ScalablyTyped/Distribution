...
import typings.ky.hooksMod.AfterResponseHook
import typings.ky.hooksMod.BeforeErrorHook
import typings.ky.hooksMod.BeforeRequestHook
import typings.ky.hooksMod.BeforeRetryHook
...
import typings.ky.optionsMod.SearchParamsOption
