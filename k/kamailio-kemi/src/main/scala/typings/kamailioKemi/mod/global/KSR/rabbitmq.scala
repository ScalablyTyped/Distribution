...
object rabbitmq {
  ...
  @scala.inline
  def publish(exchange: String, routingkey: String, contenttype: String, messagebody: String): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("publish")(exchange.asInstanceOf[js.Any], routingkey.asInstanceOf[js.Any], contenttype.asInstanceOf[js.Any], messagebody.asInstanceOf[js.Any])).asInstanceOf[Double]
