...
object LocalizedObservable {
  ...
  inline def apply(destroy: () => js.Any, observedValue: js.Any => js.Any, resetToCurrent: () => js.Any): LocalizedObservable = {
  ...
  extension [Self <: LocalizedObservable](x: Self) {
    ...
    inline def setObservedValue(value: js.Any => js.Any): Self = StObject.set(x, "observedValue", js.Any.fromFunction1(value))
    
    inline def setResetToCurrent(value: () => js.Any): Self = StObject.set(x, "resetToCurrent", js.Any.fromFunction0(value))
  }
}
