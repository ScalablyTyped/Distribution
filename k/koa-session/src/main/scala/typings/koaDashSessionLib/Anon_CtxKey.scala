...
trait Anon_CtxKey extends js.Object {
  ...
  var value: js.UndefOr[stdLib.Partial[koaDashSessionLib.koaDashSessionMod.Session]] = js.undefined
}
...
object Anon_CtxKey {
  ...
  def apply(
    ...
    value: stdLib.Partial[koaDashSessionLib.koaDashSessionMod.Session] = null
  ): Anon_CtxKey = {
