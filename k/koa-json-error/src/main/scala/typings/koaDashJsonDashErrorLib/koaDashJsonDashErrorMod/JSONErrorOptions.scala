...
trait JSONErrorOptions extends js.Object {
  /**
    ...
    */
  var format: js.UndefOr[js.Function2[/* err */ stdLib.Error, /* obj */ js.Any, _]] = js.undefined
  /**
    ...
    */
  var postFormat: js.UndefOr[js.Function2[/* err */ stdLib.Error, /* obj */ js.Any, _]] = js.undefined
  /**
    * Perform some task before calling `options.format`. Must be a function with the original err as its only argument.
    */
  var preFormat: js.UndefOr[js.Function1[/* err */ stdLib.Error, _]] = js.undefined
}

object JSONErrorOptions {
  @scala.inline
  def apply(
    format: (/* err */ stdLib.Error, /* obj */ js.Any) => _ = null,
    postFormat: (/* err */ stdLib.Error, /* obj */ js.Any) => _ = null,
    preFormat: /* err */ stdLib.Error => _ = null
  ): JSONErrorOptions = {
