...
import typings.knuddelsUserappBackendApi.mod._KnuddelsSerializable
...
open class User ()
  ...
  def getAppContentSessions(appViewMode: AppViewMode): js.Array[AppContentSession] = js.native
  ...
  /**
    ...
    */
  def getLastOnlineTime(): js.Date = js.native
  ...
  /**
    ...
    */
  def getRegDate(): js.Date = js.native
  ...
  /**
    ...
    */
  def isConnectedWithK3Client(): Boolean = js.native
