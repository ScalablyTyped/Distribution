...
object Arbiter {
  @scala.inline
  def apply[/* <: typings.kBucket.mod.Contact */ T](): Arbiter[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Arbiter[T]]
  }
  @scala.inline
  implicit class ArbiterOps[Self <: Arbiter[_], /* <: typings.kBucket.mod.Contact */ T] (val x: Self with Arbiter[T]) extends AnyVal {
    @scala.inline
