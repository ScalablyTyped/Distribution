...
import typings.seleniumDashWebdriver.seleniumDashWebdriverMod.errorNs.IError
...
import typings.seleniumDashWebdriver.seleniumDashWebdriverMod.errorNs.WebDriverError
