...
object ICapability {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ACCEPT_SSL_CERTS = ACCEPT_SSL_CERTS.asInstanceOf[js.Any], BROWSER_NAME = BROWSER_NAME.asInstanceOf[js.Any], ELEMENT_SCROLL_BEHAVIOR = ELEMENT_SCROLL_BEHAVIOR.asInstanceOf[js.Any], HANDLES_ALERTS = HANDLES_ALERTS.asInstanceOf[js.Any], LOGGING_PREFS = LOGGING_PREFS.asInstanceOf[js.Any], NATIVE_EVENTS = NATIVE_EVENTS.asInstanceOf[js.Any], PLATFORM = PLATFORM.asInstanceOf[js.Any], PROXY = PROXY.asInstanceOf[js.Any], ROTATABLE = ROTATABLE.asInstanceOf[js.Any], SECURE_SSL = SECURE_SSL.asInstanceOf[js.Any], SUPPORTS_APPLICATION_CACHE = SUPPORTS_APPLICATION_CACHE.asInstanceOf[js.Any], SUPPORTS_CSS_SELECTORS = SUPPORTS_CSS_SELECTORS.asInstanceOf[js.Any], SUPPORTS_JAVASCRIPT = SUPPORTS_JAVASCRIPT.asInstanceOf[js.Any], SUPPORTS_LOCATION_CONTEXT = SUPPORTS_LOCATION_CONTEXT.asInstanceOf[js.Any], TAKES_SCREENSHOT = TAKES_SCREENSHOT.asInstanceOf[js.Any], UNEXPECTED_ALERT_BEHAVIOR = UNEXPECTED_ALERT_BEHAVIOR.asInstanceOf[js.Any], VERSION = VERSION.asInstanceOf[js.Any])
