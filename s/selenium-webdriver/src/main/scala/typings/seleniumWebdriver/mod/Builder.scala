...
class Builder () extends js.Object {
  ...
  /**
    ...
    *     for this builder.
    */
  def getChromeOptions(): typings.seleniumWebdriver.chromeMod.Options = js.native
  /**
    * @return {firefox.Options} the Firefox specific options currently configured
    *     for this instance.
    */
  def getFirefoxOptions(): typings.seleniumWebdriver.firefoxMod.Options = js.native
  /**
  ...
  /**
    ...
    *     for this instance.
    */
  def getSafariOptions(): typings.seleniumWebdriver.safariMod.Options = js.native
  /**
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setChromeOptions(options: typings.seleniumWebdriver.chromeMod.Options): Builder = js.native
  /**
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setEdgeOptions(options: typings.seleniumWebdriver.edgeMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setEdgeService(service: typings.seleniumWebdriver.edgeMod.ServiceBuilder): Builder = js.native
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setFirefoxOptions(options: typings.seleniumWebdriver.firefoxMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setFirefoxService(service: typings.seleniumWebdriver.firefoxMod.ServiceBuilder): Builder = js.native
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setIeOptions(options: typings.seleniumWebdriver.ieMod.Options): Builder = js.native
  /**
    ...
    * @return {!Builder} a self reference.
    */
  def setIeService(service: typings.seleniumWebdriver.ieMod.ServiceBuilder): Builder = js.native
  ...
  /**
    ...
    * @return {!Builder} A self reference.
    */
  def setSafariOptions(options: typings.seleniumWebdriver.safariMod.Options): Builder = js.native
  /**
