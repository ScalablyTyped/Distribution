...
class WebDriver protected () extends js.Object {
  ...
  /**
     ...
     */
  def setFileDetector(detector: FileDetector): scala.Unit = js.native
  /**
  ...
  /**
     ...
     * @template T
     */
  def wait[T](condition: js.Function1[/* driver */ this.type, T | stdLib.PromiseLike[T]]): seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Promise[T] = js.native
  /**
     * Schedules a command to wait for a condition to hold. The condition may be
     * specified by a {@link webdriver.Condition}, as a custom function, or
     * as a {@link webdriver.promise.Promise}.
     ...
     */
  def wait[T](
    condition: js.Function1[/* driver */ this.type, T | stdLib.PromiseLike[T]],
  ...
  /**
     ...
     * @template T
     */
  def wait[T](condition: stdLib.PromiseLike[T]): seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Promise[T] = js.native
  /**
     * Schedules a command to wait for a condition to hold. The condition may be
     * specified by a {@link webdriver.Condition}, as a custom function, or
     * as a {@link webdriver.promise.Promise}.
     ...
     * @template T
     */
  def wait[T](condition: stdLib.PromiseLike[T], opt_timeout: scala.Double): seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Promise[T] = js.native
  /**
     * Schedules a command to wait for a condition to hold. The condition may be
     * specified by a {@link webdriver.Condition}, as a custom function, or
     * as a {@link webdriver.promise.Promise}.
     ...
     * @template T
     */
  def wait[T](condition: stdLib.PromiseLike[T], opt_timeout: scala.Double, opt_message: java.lang.String): seleniumDashWebdriverLib.seleniumDashWebdriverMod.promiseNs.Promise[T] = js.native
}
