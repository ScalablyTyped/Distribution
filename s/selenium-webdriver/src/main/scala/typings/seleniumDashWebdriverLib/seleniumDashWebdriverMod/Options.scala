...
class Options protected () extends js.Object {
  ...
  /**
    ...
    */
  def addCookie(spec: IWebDriverOptionsCookie): js.Promise[scala.Unit] = js.native
  /**
    * Schedules a command to delete all cookies visible to the current page.
    * @return {!Promise} A promise that will be resolved when all
    *     cookies have been deleted.
    */
  def deleteAllCookies(): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def deleteCookie(name: java.lang.String): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def getCookie(name: java.lang.String): js.Promise[IWebDriverOptionsCookie] = js.native
  /**
  ...
  /**
    ...
    */
  def setTimeouts(timeouts: ITimeouts): js.Promise[scala.Unit] = js.native
  /**
