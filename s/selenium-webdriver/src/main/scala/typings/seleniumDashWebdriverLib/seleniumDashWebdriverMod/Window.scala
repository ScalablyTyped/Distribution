...
class Window protected () extends js.Object {
  ...
  /**
    ...
    *     command has completed.
    */
  def setPosition(x: scala.Double, y: scala.Double): js.Promise[scala.Unit] = js.native
  /**
    ...
    */
  def setRect(hasXYWidthHeight: stdLib.Partial[IRectangle]): js.Promise[IRectangle] = js.native
  /**
    ...
    *     command has completed.
    */
  def setSize(width: scala.Double, height: scala.Double): js.Promise[scala.Unit] = js.native
}
