...
class ServiceBuilder ()
  ...
  /**
       ...
       * @return {!ServiceBuilder} A self reference.
       */
  def loggingTo(path: java.lang.String): this.type = js.native
  /**
       ...
       * @return {!ServiceBuilder} A self reference.
       */
  def setAdbPort(port: scala.Double): this.type = js.native
  /**
       ...
       * @return {!ServiceBuilder} A self reference.
       */
  def setNumHttpThreads(n: scala.Double): this.type = js.native
}
