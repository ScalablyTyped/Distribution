...
object Proxy {
  @scala.inline
  def apply[/* <: typings.saywhen.mod.Func */ T](`then`: T => Proxy[T], thenReturn: js.Any => Proxy[T], thenThrow: Error => Proxy[T]): Proxy[T] = {
  ...
  @scala.inline
  implicit class ProxyOps[Self <: Proxy[_], /* <: typings.saywhen.mod.Func */ T] (val x: Self with Proxy[T]) extends AnyVal {
    @scala.inline
