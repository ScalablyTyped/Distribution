...
trait SimmerConstructor
  ...
  */
org.scalablytyped.runtime.Instantiable0[Simmer]
     with org.scalablytyped.runtime.Instantiable1[/* scope */ Scope, Simmer]
     with org.scalablytyped.runtime.Instantiable2[/* scope */ Scope, /* options */ Options, Simmer]
     with org.scalablytyped.runtime.Instantiable3[/* scope */ Scope, /* options */ Options, /* query */ QueryEngine, Simmer] {
  /**
    * @param scope The context in which Simmer should query for elements.
    * Generally speaking this would be the window, which is the default value,
    * but it would be overriden in a situation where you might be using Simmer
