...
trait Options extends js.Object {
  ...
  /**
    ...
    */
  var errorHandling: js.UndefOr[
    scala.Boolean | (js.Function2[/* error */ js.Any, /* element */ stdLib.Element, scala.Unit])
  ] = js.undefined
  /**
    ...
    * @default 520
    */
  var selectorMaxLength: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    * @default 100
    */
  var specificityThreshold: js.UndefOr[scala.Double] = js.undefined
}
...
object Options {
  ...
  def apply(
    ...
    errorHandling: scala.Boolean | (js.Function2[/* error */ js.Any, /* element */ stdLib.Element, scala.Unit]) = null,
    selectorMaxLength: scala.Int | scala.Double = null,
    specificityThreshold: scala.Int | scala.Double = null
  ): Options = {
