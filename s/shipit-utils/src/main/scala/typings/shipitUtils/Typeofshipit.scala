...
trait Typeofshipit extends js.Object {
  ...
  def initConfig(config: js.Object): typings.shipitCli.Typeofshipit = js.native
  ...
  def start(tasks: String*): typings.shipitCli.Typeofshipit = js.native
  def start(tasks: String): typings.shipitCli.Typeofshipit = js.native
  def start(tasks: js.Array[String]): typings.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String]): typings.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: js.Array[String], fn: js.Function0[Unit]): typings.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback): typings.shipitCli.Typeofshipit = js.native
  def task(name: String, depsOrFn: EmptyCallback, fn: js.Function0[Unit]): typings.shipitCli.Typeofshipit = js.native
}
