...
object shipitDashUtilsModMembers extends js.Object {
  ...
  def getShipit(gruntOrShipit: GruntOrShipit): shipitDashUtilsLib.Anon_Task = js.native
  def registerTask(
    gruntOrShipit: GruntOrShipit,
    name: java.lang.String,
    dependenciesOrTask: js.Array[java.lang.String]
  ): shipitDashUtilsLib.Anon_Task = js.native
  def registerTask(gruntOrShipit: GruntOrShipit, name: java.lang.String, dependenciesOrTask: EmptyCallback): shipitDashUtilsLib.Anon_Task = js.native
