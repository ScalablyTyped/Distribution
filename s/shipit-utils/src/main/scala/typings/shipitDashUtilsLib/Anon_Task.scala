...
@js.native
trait Anon_Task extends js.Object {
  ...
  def task(name: java.lang.String, depsOrFn: shipitLib.shipitMod.EmptyCallback): shipitLib.Anon_Task = js.native
  def task(name: java.lang.String, depsOrFn: shipitLib.shipitMod.EmptyCallback, fn: js.Function0[scala.Unit]): shipitLib.Anon_Task = js.native
}
