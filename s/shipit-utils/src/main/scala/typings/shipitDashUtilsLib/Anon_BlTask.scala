...
trait Anon_BlTask extends js.Object {
  ...
  def task(name: java.lang.String, depsOrFn: shipitDashCliLib.shipitDashCliMod.EmptyCallback): shipitDashCliLib.Anon_BlTask = js.native
  def task(
    name: java.lang.String,
    depsOrFn: shipitDashCliLib.shipitDashCliMod.EmptyCallback,
    fn: js.Function0[scala.Unit]
  ): shipitDashCliLib.Anon_BlTask = js.native
}
