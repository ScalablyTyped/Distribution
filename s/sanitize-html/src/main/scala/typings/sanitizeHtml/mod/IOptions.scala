...
object IOptions {
  ...
  def apply(
    ...
    enforceHtmlBoundary: js.UndefOr[Boolean] = js.undefined,
    ...
    textFilter: (/* text */ String, /* tagName */ String) => String = null,
    ...
    if (!js.isUndefined(enforceHtmlBoundary)) __obj.updateDynamic("enforceHtmlBoundary")(enforceHtmlBoundary.get.asInstanceOf[js.Any])
    ...
    if (textFilter != null) __obj.updateDynamic("textFilter")(js.Any.fromFunction2(textFilter))
