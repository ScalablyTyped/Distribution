package typings.selectorDashSet.selectorDashSetMod
...
object ISelectorSetIndex {
  ...
  def apply(element: Element => js.Array[String] | Unit, name: String, selector: String => String | Unit): ISelectorSetIndex = {
    val __obj = js.Dynamic.literal(element = js.Any.fromFunction1(element), name = name, selector = js.Any.fromFunction1(selector))
