...
object mod {
  ...
  inline def append(value: String, appends: String*): String = (^.asInstanceOf[js.Dynamic].applyDynamic("append")(value.asInstanceOf[js.Any], appends.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def format(value: String, params: String*): String = (^.asInstanceOf[js.Dynamic].applyDynamic("format")(value.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def prepend(value: String, prepends: String*): String = (^.asInstanceOf[js.Dynamic].applyDynamic("prepend")(value.asInstanceOf[js.Any], prepends.asInstanceOf[js.Any])).asInstanceOf[String]
