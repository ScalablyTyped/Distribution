...
trait DisplayMultiParams extends StObject {
  
  var altValue: js.UndefOr[String | Double] = js.undefined
  
  var detailString: js.UndefOr[String] = js.undefined
  
  var detailStringVisible: js.UndefOr[Boolean] = js.undefined
  ...
  var linkAltValue: js.UndefOr[Boolean] = js.undefined
...
object DisplayMultiParams {
  
  inline def apply(): DisplayMultiParams = {
  ...
  implicit open class MutableBuilder[Self <: DisplayMultiParams] (val x: Self) extends AnyVal {
    ...
    inline def setAltValueUndefined: Self = StObject.set(x, "altValue", js.undefined)
    ...
    inline def setDetailStringVisible(value: Boolean): Self = StObject.set(x, "detailStringVisible", value.asInstanceOf[js.Any])
    
    inline def setDetailStringVisibleUndefined: Self = StObject.set(x, "detailStringVisible", js.undefined)
    ...
    inline def setLinkAltValue(value: Boolean): Self = StObject.set(x, "linkAltValue", value.asInstanceOf[js.Any])
    
    inline def setLinkAltValueUndefined: Self = StObject.set(x, "linkAltValue", js.undefined)
