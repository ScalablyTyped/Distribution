...
import typings.stripeV3.AnonPreventDefault
...
trait Element extends js.Object {
  ...
  def addEventListener_click(event: click, handler: js.Function1[/* response */ AnonPreventDefault, Unit]): Unit = js.native
  ...
  @JSName("on")
  def on_click(event: click, handler: js.Function1[/* response */ AnonPreventDefault, Unit]): Unit = js.native
