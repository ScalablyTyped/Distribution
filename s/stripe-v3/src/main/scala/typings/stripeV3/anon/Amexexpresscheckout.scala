...
object Amexexpresscheckout {
  ...
  extension [Self <: Amexexpresscheckout](x: Self) {
    ...
    inline def setAmex_express_checkout(value: js.Any): Self = StObject.set(x, "amex_express_checkout", value.asInstanceOf[js.Any])
    
    inline def setAmex_express_checkoutUndefined: Self = StObject.set(x, "amex_express_checkout", js.undefined)
    
    inline def setApple_pay(value: js.Any): Self = StObject.set(x, "apple_pay", value.asInstanceOf[js.Any])
    
    inline def setApple_payUndefined: Self = StObject.set(x, "apple_pay", js.undefined)
    
    inline def setDynamic_last4(value: js.Any): Self = StObject.set(x, "dynamic_last4", value.asInstanceOf[js.Any])
    
    inline def setDynamic_last4Undefined: Self = StObject.set(x, "dynamic_last4", js.undefined)
    
    inline def setGoogle_pay(value: js.Any): Self = StObject.set(x, "google_pay", value.asInstanceOf[js.Any])
    
    inline def setGoogle_payUndefined: Self = StObject.set(x, "google_pay", js.undefined)
    
    inline def setMasterpass(value: js.Any): Self = StObject.set(x, "masterpass", value.asInstanceOf[js.Any])
    
    inline def setMasterpassUndefined: Self = StObject.set(x, "masterpass", js.undefined)
    
    inline def setSamsung_pay(value: js.Any): Self = StObject.set(x, "samsung_pay", value.asInstanceOf[js.Any])
    ...
    inline def setVisa_checkout(value: js.Any): Self = StObject.set(x, "visa_checkout", value.asInstanceOf[js.Any])
