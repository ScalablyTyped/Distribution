...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.triangle
...
object Triangle {
  ...
  implicit open class MutableBuilder[Self <: Triangle] (val x: Self) extends AnyVal {
    ...
    inline def setIsEquilateral(value: Boolean): Self = StObject.set(x, "isEquilateral", value.asInstanceOf[js.Any])
    ...
    inline def set_class(value: triangle): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
