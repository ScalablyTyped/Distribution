...
object StrikethroughStyle extends StObject {
  ...
  /* 0 */ val None: typings.sketchHqSketchFileFormatTs.distCjsTypesMod.StrikethroughStyle.None & Double = js.native
  
  @js.native
  sealed trait Strikethrough
    extends StObject
       with StrikethroughStyle
  /* 1 */ val Strikethrough: typings.sketchHqSketchFileFormatTs.distCjsTypesMod.StrikethroughStyle.Strikethrough & Double = js.native
}
