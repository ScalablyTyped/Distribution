...
object InferredLayoutAxis extends StObject {
  ...
  /* 0 */ val Horizontal: typings.sketchHqSketchFileFormatTs.distCjsTypesMod.InferredLayoutAxis.Horizontal & Double = js.native
  
  @js.native
  sealed trait Vertical
    extends StObject
       with InferredLayoutAxis
  /* 1 */ val Vertical: typings.sketchHqSketchFileFormatTs.distCjsTypesMod.InferredLayoutAxis.Vertical & Double = js.native
}
