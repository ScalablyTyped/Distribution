...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.symbolMaster
...
trait SymbolMaster
  ...
  var overrideProperties: js.Array[OverrideProperty]
  
  var presetDictionary: js.UndefOr[Any] = js.undefined
...
object SymbolMaster {
  ...
  extension [Self <: SymbolMaster](x: Self) {
    ...
    inline def setOverrideProperties(value: js.Array[OverrideProperty]): Self = StObject.set(x, "overrideProperties", value.asInstanceOf[js.Any])
    
    inline def setOverridePropertiesVarargs(value: OverrideProperty*): Self = StObject.set(x, "overrideProperties", js.Array(value*))
    
    inline def setPresetDictionary(value: Any): Self = StObject.set(x, "presetDictionary", value.asInstanceOf[js.Any])
    
    inline def setPresetDictionaryUndefined: Self = StObject.set(x, "presetDictionary", js.undefined)
