...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.rectangle
...
trait Rectangle
  ...
  var hasConvertedToNewRoundCorners: Boolean
  ...
  var needsConvertionToNewRoundCorners: Boolean
...
object Rectangle {
  ...
  implicit open class MutableBuilder[Self <: Rectangle] (val x: Self) extends AnyVal {
    ...
    inline def setFixedRadius(value: Double): Self = StObject.set(x, "fixedRadius", value.asInstanceOf[js.Any])
    ...
    inline def setHasConvertedToNewRoundCorners(value: Boolean): Self = StObject.set(x, "hasConvertedToNewRoundCorners", value.asInstanceOf[js.Any])
    ...
    inline def setNeedsConvertionToNewRoundCorners(value: Boolean): Self = StObject.set(x, "needsConvertionToNewRoundCorners", value.asInstanceOf[js.Any])
    ...
    inline def set_class(value: rectangle): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
