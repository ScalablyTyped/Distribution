...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.polygon
...
object Polygon {
  ...
  implicit open class MutableBuilder[Self <: Polygon] (val x: Self) extends AnyVal {
    ...
    inline def set_class(value: polygon): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
