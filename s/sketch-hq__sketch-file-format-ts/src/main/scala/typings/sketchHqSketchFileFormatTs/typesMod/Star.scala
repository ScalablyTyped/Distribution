...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.star
...
object Star {
  ...
  extension [Self <: Star](x: Self) {
    ...
    inline def set_class(value: star): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
