...
object ColorSpace extends StObject {
  ...
  sealed trait P3
    extends StObject
       with ColorSpace
  /* 2 */ val P3: typings.sketchHqSketchFileFormatTs.typesMod.ColorSpace.P3 & Double = js.native
  
  @js.native
  sealed trait SRGB
    extends StObject
       with ColorSpace
  /* 1 */ val SRGB: typings.sketchHqSketchFileFormatTs.typesMod.ColorSpace.SRGB & Double = js.native
  
  @js.native
  sealed trait Unmanaged
    extends StObject
       with ColorSpace
  /* 0 */ val Unmanaged: typings.sketchHqSketchFileFormatTs.typesMod.ColorSpace.Unmanaged & Double = js.native
}
