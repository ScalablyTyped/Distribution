...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.group
...
object Group {
  ...
  extension [Self <: Group](x: Self) {
    ...
    inline def set_class(value: group): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
