...
object UnderlineStyle extends StObject {
  ...
  sealed trait None
    extends StObject
       with UnderlineStyle
  /* 0 */ val None: typings.sketchHqSketchFileFormatTs.typesMod.UnderlineStyle.None & Double = js.native
  
  @js.native
  sealed trait Underlined
    extends StObject
       with UnderlineStyle
  /* 1 */ val Underlined: typings.sketchHqSketchFileFormatTs.typesMod.UnderlineStyle.Underlined & Double = js.native
}
