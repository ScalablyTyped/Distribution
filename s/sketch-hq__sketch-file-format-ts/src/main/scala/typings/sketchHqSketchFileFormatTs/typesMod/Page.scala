...
import typings.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.page
...
object Page {
  ...
  extension [Self <: Page](x: Self) {
    ...
    inline def setLayersVarargs(
      value: (Artboard | Group | Oval | Polygon | Rectangle | ShapePath | Star | Triangle | ShapeGroup | Text | SymbolMaster | SymbolInstance | Slice | Hotspot | Bitmap)*
    ...
    inline def set_class(value: page): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
