...
object NumericalBool extends StObject {
  ...
  sealed trait False
    extends StObject
       with NumericalBool
  /* 1 */ val False: typings.sketchHqSketchFileFormatTs.typesMod.NumericalBool.False & Double = js.native
  
  @js.native
  sealed trait True
    extends StObject
       with NumericalBool
  /* 0 */ val True: typings.sketchHqSketchFileFormatTs.typesMod.NumericalBool.True & Double = js.native
}
