...
trait CMEventCallback extends js.Object {
  ...
  /**
    ...
    */
  def connected(serverLoad: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def logOnResponse(response: CMsgClientLogonResponse): scala.Unit = js.native
  /**
    * You were logged off from Steam. loggedOn is now false.
    *
    * @param eresesult A value from EResult
    */
  def loggedOff(eresesult: EResult): scala.Unit = js.native
  def message(
    /**
  ...
  /**
    ...
    */
  def servers(servers: js.Array[Server]): scala.Unit = js.native
}
