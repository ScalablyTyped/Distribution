...
object EWorkshopFileAction extends StObject {
  ...
  /* 1 */ val Completed: typings.steamClient.mod.EWorkshopFileAction.Completed with Double = js.native
  
  @js.native
  sealed trait Played extends EWorkshopFileAction
  /* 0 */ val Played: typings.steamClient.mod.EWorkshopFileAction.Played with Double = js.native
}
