...
trait Assertion extends js.Object {
  ...
  /**
    ...
    */
  def calledAfter(anotherSpy: sinonLib.sinonMod.SinonSpy): Assertion = js.native
  /**
    * Returns true if the spy was called before anotherSpy.
    */
  def calledBefore(anotherSpy: sinonLib.sinonMod.SinonSpy): Assertion = js.native
  /**
    * Returns true if spy was called after anotherSpy, and no spy calls occurred
    * between anotherSpy and spy.
    */
  def calledImmediatelyAfter(anotherSpy: sinonLib.sinonMod.SinonSpy): Assertion = js.native
  /**
    * Returns true if spy was called before anotherSpy, and no spy calls occurred
    * between spy and anotherSpy.
    */
  def calledImmediatelyBefore(anotherSpy: sinonLib.sinonMod.SinonSpy): Assertion = js.native
  /**
