...
object mod {
  ...
  */
  ...
  object Events {
    ...
    inline def beforeclose: typings.slideout.slideoutStrings.beforeclose = "beforeclose".asInstanceOf[typings.slideout.slideoutStrings.beforeclose]
    
    inline def beforeopen: typings.slideout.slideoutStrings.beforeopen = "beforeopen".asInstanceOf[typings.slideout.slideoutStrings.beforeopen]
    
    inline def close: typings.slideout.slideoutStrings.close = "close".asInstanceOf[typings.slideout.slideoutStrings.close]
    
    inline def open: typings.slideout.slideoutStrings.open = "open".asInstanceOf[typings.slideout.slideoutStrings.open]
    
    inline def translate: typings.slideout.slideoutStrings.translate = "translate".asInstanceOf[typings.slideout.slideoutStrings.translate]
    
    inline def translateend: typings.slideout.slideoutStrings.translateend = "translateend".asInstanceOf[typings.slideout.slideoutStrings.translateend]
    
    inline def translatestart: typings.slideout.slideoutStrings.translatestart = "translatestart".asInstanceOf[typings.slideout.slideoutStrings.translatestart]
  }
