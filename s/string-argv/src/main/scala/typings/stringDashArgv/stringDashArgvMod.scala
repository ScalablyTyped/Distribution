...
object stringDashArgvMod extends js.Object {
  /**
    ...
    * However if your cli.parse method expects a valid argv value then you should include this value.
    */
  def apply(value: String): js.Array[String] = js.native
  def apply(value: String, env: String): js.Array[String] = js.native
  def apply(value: String, env: String, file: String): js.Array[String] = js.native
}
