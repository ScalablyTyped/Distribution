...
import typings.splitJs.splitMod.Split.Instance
import typings.splitJs.splitMod.Split.Options
...
object splitMod {
  ...
  inline def apply(elements: js.Array[String | HTMLElement], options: js.UndefOr[Options]): Instance = (^.asInstanceOf[js.Dynamic].apply(elements.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Instance]
  ...
  object Split {
    ...
    /* Inlined split.js.split.Split.Partial<std.CSSStyleDeclaration> */
