...
object mod {
  ...
  inline def apply(elements: js.Array[String | HTMLElement]): Instance = ^.asInstanceOf[js.Dynamic].apply(elements.asInstanceOf[js.Any]).asInstanceOf[Instance]
  inline def apply(elements: js.Array[String | HTMLElement], options: Options): Instance = (^.asInstanceOf[js.Dynamic].apply(elements.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Instance]
  ...
  object CSSStyleDeclarationPartial {
    ...
    inline def apply(): CSSStyleDeclarationPartial = {
  ...
  trait Instance extends StObject {
    ...
    def destroy(preserveStyles: Unit, preserveGutters: Boolean): Unit = js.native
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDragInterval(value: Double): Self = StObject.set(x, "dragInterval", value.asInstanceOf[js.Any])
      
      inline def setDragIntervalUndefined: Self = StObject.set(x, "dragInterval", js.undefined)
      
      inline def setElementStyle(
      ...
      inline def setExpandToMin(value: Boolean): Self = StObject.set(x, "expandToMin", value.asInstanceOf[js.Any])
      
      inline def setExpandToMinUndefined: Self = StObject.set(x, "expandToMin", js.undefined)
      
      inline def setGutter(value: (/* index */ Double, /* direction */ horizontal | vertical) => HTMLElement): Self = StObject.set(x, "gutter", js.Any.fromFunction2(value))
      
      inline def setGutterAlign(value: String): Self = StObject.set(x, "gutterAlign", value.asInstanceOf[js.Any])
      
      inline def setGutterAlignUndefined: Self = StObject.set(x, "gutterAlign", js.undefined)
      ...
      inline def setGutterStyleUndefined: Self = StObject.set(x, "gutterStyle", js.undefined)
      ...
      inline def setOnDragEnd(value: /* sizes */ js.Array[Double] => Unit): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1(value))
      
      inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      inline def setOnDragStart(value: /* sizes */ js.Array[Double] => Unit): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1(value))
  ...
  {[ P in keyof T ]:? T[P]}
    */ typings.splitJs.splitJsStrings.Partial & TopLevel[T]
}
