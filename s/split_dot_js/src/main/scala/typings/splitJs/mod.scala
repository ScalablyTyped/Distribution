...
object mod {
  ...
  @scala.inline
  def apply(elements: js.Array[String | HTMLElement]): Instance = ^.asInstanceOf[js.Dynamic].apply(elements.asInstanceOf[js.Any]).asInstanceOf[Instance]
  @scala.inline
  def apply(elements: js.Array[String | HTMLElement], options: Options): Instance = (^.asInstanceOf[js.Dynamic].apply(elements.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Instance]
