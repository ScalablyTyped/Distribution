...
trait TypeofModelInstantiable
  ...
  def traverse(
    filterConstructor: typings.objection.TypeofModel,
    models: js.Array[Model],
    traverser: TraverserFunction
  ): Unit = js.native
  def traverse(filterConstructor: typings.objection.TypeofModel, models: Model, traverser: TraverserFunction): Unit = js.native
