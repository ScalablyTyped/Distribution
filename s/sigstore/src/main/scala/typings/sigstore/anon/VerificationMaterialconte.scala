...
/* Inlined @sigstore/protobuf-specs.@sigstore/protobuf-specs.VerificationMaterial & {  content :std.Extract<@sigstore/protobuf-specs.@sigstore/protobuf-specs.VerificationMaterial['content'], {  $case :'x509CertificateChain'}>} */
trait VerificationMaterialconte extends StObject {
...
object VerificationMaterialconte {
  
  inline def apply(tlogEntries: js.Array[TransparencyLogEntry]): VerificationMaterialconte = {
    val __obj = js.Dynamic.literal(tlogEntries = tlogEntries.asInstanceOf[js.Any])
    __obj.asInstanceOf[VerificationMaterialconte]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VerificationMaterialconte] (val x: Self) extends AnyVal {
