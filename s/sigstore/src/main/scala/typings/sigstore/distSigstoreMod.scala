...
object distSigstoreMod {
  
  @JSImport("sigstore/dist/sigstore", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("sigstore/dist/sigstore", "DEFAULT_FULCIO_URL")
  @js.native
  val DEFAULT_FULCIO_URL: /* "https://fulcio.sigstore.dev" */ String = js.native
  
  @JSImport("sigstore/dist/sigstore", "DEFAULT_REKOR_URL")
  @js.native
  val DEFAULT_REKOR_URL: /* "https://rekor.sigstore.dev" */ String = js.native
  
  @JSImport("sigstore/dist/sigstore", "InternalError")
  @js.native
  open class InternalError protected ()
    extends typings.sigstore.distErrorMod.InternalError {
    def this(param0: Cause) = this()
  }
  
  @JSImport("sigstore/dist/sigstore", "PolicyError")
  @js.native
  open class PolicyError ()
    extends typings.sigstore.distErrorMod.PolicyError
  
  @JSImport("sigstore/dist/sigstore", "ValidationError")
  @js.native
  open class ValidationError ()
    extends typings.sigstore.distErrorMod.ValidationError
  
  @JSImport("sigstore/dist/sigstore", "VerificationError")
  @js.native
  open class VerificationError ()
    extends typings.sigstore.distErrorMod.VerificationError
  ...
  object tuf {
    ...
    @JSImport("sigstore/dist/sigstore", "tuf")
    @js.native
    val ^ : js.Any = js.native
  ...
  object utils {
    ...
    @JSImport("sigstore/dist/sigstore", "utils")
    @js.native
    val ^ : js.Any = js.native
