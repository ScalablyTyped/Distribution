...
object ^ extends js.Object {
  ...
  def apply(matcher: split2Lib.split2Mod.Matcher): nodeLib.streamMod.Transform = js.native
  def apply(matcher: split2Lib.split2Mod.Matcher, mapper: split2Lib.split2Mod.splitNs.Mapper): nodeLib.streamMod.Transform = js.native
  def apply(
    matcher: split2Lib.split2Mod.Matcher,
  ...
  def apply(matcher: split2Lib.split2Mod.Matcher, options: split2Lib.split2Mod.splitNs.Options): nodeLib.streamMod.Transform = js.native
