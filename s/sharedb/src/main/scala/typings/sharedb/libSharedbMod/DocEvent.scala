...
/* keyof sharedb.sharedb/lib/sharedb.DocEventMap<any> */ /* Rewritten from type alias, can be one of: 
  ...
  - typings.sharedb.sharedbStrings.`op batch`
  - typings.sharedb.sharedbStrings.`before op`
  - typings.sharedb.sharedbStrings.`before op batch`
  - typings.sharedb.sharedbStrings.del
  - typings.sharedb.sharedbStrings.error
  - typings.sharedb.sharedbStrings.destroy
*/
