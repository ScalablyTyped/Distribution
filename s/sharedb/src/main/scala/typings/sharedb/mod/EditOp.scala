...
object EditOp {
  ...
  implicit class EditOpOps[Self <: EditOp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOpVarargs(value: typings.sharedb.sharedbMod.Op*): Self = this.set("op", js.Array(value :_*))
    
    @scala.inline
    def setOp(value: js.Array[typings.sharedb.sharedbMod.Op]): Self = this.set("op", value.asInstanceOf[js.Any])
