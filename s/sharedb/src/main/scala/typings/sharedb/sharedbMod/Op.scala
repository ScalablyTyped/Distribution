...
object Op {
  ...
  inline def ListDeleteOp(ld: js.Any, p: Path): typings.sharedb.sharedbMod.ListDeleteOp = {
  ...
  inline def ListInsertOp(li: js.Any, p: Path): typings.sharedb.sharedbMod.ListInsertOp = {
  ...
  inline def ListMoveOp(lm: js.Any, p: Path): typings.sharedb.sharedbMod.ListMoveOp = {
  ...
  inline def ListReplaceOp(ld: js.Any, li: js.Any, p: Path): typings.sharedb.sharedbMod.ListReplaceOp = {
  ...
  inline def ObjectDeleteOp(od: js.Any, p: Path): typings.sharedb.sharedbMod.ObjectDeleteOp = {
  ...
  inline def ObjectInsertOp(oi: js.Any, p: Path): typings.sharedb.sharedbMod.ObjectInsertOp = {
  ...
  inline def ObjectReplaceOp(od: js.Any, oi: js.Any, p: Path): typings.sharedb.sharedbMod.ObjectReplaceOp = {
  ...
  inline def SubtypeOp(o: js.Any, p: Path, t: String): typings.sharedb.sharedbMod.SubtypeOp = {
