package typings.samchon.templatesParallelDerivedParallelClientArrayMod
...
- typings.samchon.templatesExternalInterfacesIExternalClientArrayMod.IExternalClientArray because var conflicts: _Compute_col_size, _Fetch_index, _Handle_system_erase, _Insert_to_end, _Insert_to_middle, _Notify_erase, _Notify_insert, _Swap, _Try_add_row_at_back, _Try_add_row_at_front, _Try_expand_capacity, capacity_, dispatcher_, iterator, iterator_IContainer, matrix_, size_. Inlined  */ @JSImport("samchon/templates/parallel/derived/ParallelClientArray", "ParallelClientArray")
@js.native
/**
  * Default Constructor.
  */
abstract class ParallelClientArray[System /* <: ParallelSystem */] () extends ParallelSystemArray[System] {
  /**
    * @hidden
    */
