package typings.samchon.protocolCommunicatorServerUnderscoreConnectorDedicatedWorkerServerConnectorMod
...
- typings.samchon.protocolCommunicatorIServerConnectorMod.IServerConnector because var conflicts: onClose. Inlined onConnect, connect */ @JSImport("samchon/protocol/communicator/server_connector/DedicatedWorkerServerConnector", "DedicatedWorkerServerConnector")
@js.native
class DedicatedWorkerServerConnector protected () extends DedicatedWorkerCommunicator {
  /**
