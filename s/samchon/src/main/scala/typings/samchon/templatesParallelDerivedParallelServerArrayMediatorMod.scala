...
object templatesParallelDerivedParallelServerArrayMediatorMod {
  ...
  - typings.samchon.templatesExternalInterfacesIexternalserverarrayMod.IExternalServerArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined connect */ @JSImport("samchon/templates/parallel/derived/ParallelServerArrayMediator", "ParallelServerArrayMediator")
  @js.native
  /**
    * Default Constructor.
    */
  open class ParallelServerArrayMediator[System /* <: IParallelServer */] () extends ParallelSystemArrayMediator[System] {
