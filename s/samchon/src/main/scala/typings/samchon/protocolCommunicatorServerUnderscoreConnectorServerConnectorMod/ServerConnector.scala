package typings.samchon.protocolCommunicatorServerUnderscoreConnectorServerConnectorMod
...
- typings.samchon.protocolCommunicatorIServerConnectorMod.IServerConnector because var conflicts: onClose. Inlined onConnect, connect */ @JSImport("samchon/protocol/communicator/server_connector/ServerConnector", "ServerConnector")
@js.native
