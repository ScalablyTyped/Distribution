...
object library {
  ...
  object default {
    ...
    @js.native
    open class XML ()
      extends typings.samchon.libraryMod.default.XML {
    ...
    @js.native
    open class XMLList ()
      extends typings.samchon.libraryMod.default.XMLList
  }
  ...
  open class Factorial protected ()
    extends typings.samchon.libraryMod.Factorial {
    /**
  ...
  open class Permutation protected ()
    extends typings.samchon.libraryMod.Permutation {
    /**
  ...
  open class RepeatedPermutation protected ()
    extends typings.samchon.libraryMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  open class XMLList ()
    extends typings.samchon.libraryMod.XMLList
}
