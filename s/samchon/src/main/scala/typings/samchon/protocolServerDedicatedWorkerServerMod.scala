...
import typings.samchon.protocolCommunicatorClientDriverDedicatedWorkerClientDriverMod.DedicatedWorkerClientDriver
...
object protocolServerDedicatedWorkerServerMod {
  
  /* note: abstract class */ @JSImport("samchon/protocol/server/DedicatedWorkerServer", "DedicatedWorkerServer")
  @js.native
