...
object templatesDistributedDerivedDistributedServerClientArrayMod {
  ...
  - typings.samchon.templatesExternalInterfacesIexternalserverclientarrayMod.IExternalServerClientArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined connect */ @JSImport("samchon/templates/distributed/derived/DistributedServerClientArray", "DistributedServerClientArray")
  @js.native
  /**
    * Default Constructor.
    */
  open class DistributedServerClientArray[System /* <: DistributedSystem */] () extends DistributedClientArray[System] {
