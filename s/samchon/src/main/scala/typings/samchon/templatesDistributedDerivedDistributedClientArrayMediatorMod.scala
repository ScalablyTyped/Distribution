...
object templatesDistributedDerivedDistributedClientArrayMediatorMod {
  ...
  - typings.samchon.templatesExternalInterfacesIexternalclientarrayMod.IExternalClientArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined  */ @JSImport("samchon/templates/distributed/derived/DistributedClientArrayMediator", "DistributedClientArrayMediator")
  @js.native
  /**
    * Default Constructor.
    */
  open class DistributedClientArrayMediator[System /* <: DistributedSystem */] ()
