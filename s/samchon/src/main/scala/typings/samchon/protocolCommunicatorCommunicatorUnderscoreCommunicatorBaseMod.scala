...
@JSImport("samchon/protocol/communicator/communicator/_CommunicatorBase", JSImport.Namespace)
@js.native
object protocolCommunicatorCommunicatorUnderscoreCommunicatorBaseMod extends js.Object {
  @js.native
  /**
    * Default Constructor.
    */
