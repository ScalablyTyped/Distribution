...
object protocolCommunicatorCommunicatorCommunicatorBaseMod {
  
  /* note: abstract class */ @JSImport("samchon/protocol/communicator/communicator/_CommunicatorBase", "_CommunicatorBase")
  @js.native
  /**
    * Default Constructor.
    */
  open class CommunicatorBase ()
    extends StObject
       with ICommunicator {
    /**
