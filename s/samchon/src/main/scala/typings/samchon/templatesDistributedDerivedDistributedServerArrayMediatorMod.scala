...
object templatesDistributedDerivedDistributedServerArrayMediatorMod {
  ...
  - typings.samchon.templatesExternalInterfacesIexternalserverarrayMod.IExternalServerArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined connect */ @JSImport("samchon/templates/distributed/derived/DistributedServerArrayMediator", "DistributedServerArrayMediator")
  @js.native
  /**
    * Default Constructor.
    */
  open class DistributedServerArrayMediator[System /* <: IDistributedServer */] () extends DistributedSystemArrayMediator[System] {
