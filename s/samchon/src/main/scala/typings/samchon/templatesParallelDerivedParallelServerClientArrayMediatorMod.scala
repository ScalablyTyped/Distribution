...
import typings.samchon.templatesParallelDerivedParallelClientArrayMediatorMod.ParallelClientArrayMediator
...
@js.native
object templatesParallelDerivedParallelServerClientArrayMediatorMod extends js.Object {
  ...
  /**
    * Default Constructor.
    */
  abstract class ParallelServerClientArrayMediator[System /* <: ParallelSystem */] () extends ParallelClientArrayMediator[System] {
    /**
      * @inheritdoc
      */
    /**
