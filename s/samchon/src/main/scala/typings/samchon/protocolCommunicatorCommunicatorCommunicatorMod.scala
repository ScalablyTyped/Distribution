...
object protocolCommunicatorCommunicatorCommunicatorMod {
  
  /* note: abstract class */ @JSImport("samchon/protocol/communicator/communicator/Communicator", "Communicator")
  @js.native
  /**
    * Default Constructor.
    */
  open class Communicator () extends CommunicatorBase {
    /**
