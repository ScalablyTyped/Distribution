...
object protocolCommunicatorServerConnectorWebServerConnectorMod {
  ...
  - typings.samchon.protocolCommunicatorIserverconnectorMod.IServerConnector because var conflicts: onClose. Inlined onConnect, connect */ @JSImport("samchon/protocol/communicator/server_connector/WebServerConnector", "WebServerConnector")
  @js.native
