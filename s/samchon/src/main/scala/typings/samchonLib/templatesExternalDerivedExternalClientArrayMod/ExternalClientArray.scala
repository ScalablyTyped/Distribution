package typings
package samchonLib.templatesExternalDerivedExternalClientArrayMod
...
abstract class ExternalClientArray[T /* <: samchonLib.templatesExternalExternalSystemMod.ExternalSystem */] ()
  extends samchonLib.templatesExternalInterfacesIExternalClientArrayMod.IExternalClientArray[T] {
  /**
    * @hidden
    */
  ...
  /**
    ...
    */
  /* protected */ def createExternalClient(driver: samchonLib.protocolCommunicatorIClientDriverMod.IClientDriver): T = js.native
  /**
