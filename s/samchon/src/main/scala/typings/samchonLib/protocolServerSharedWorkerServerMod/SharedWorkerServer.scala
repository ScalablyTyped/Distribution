package typings
package samchonLib.protocolServerSharedWorkerServerMod
...
abstract class SharedWorkerServer ()
  ...
  /**
    ...
    */
  def addClient(
    driver: samchonLib.protocolCommunicatorClientUnderscoreDriverSharedWorkerClientDriverMod.SharedWorkerClientDriver
