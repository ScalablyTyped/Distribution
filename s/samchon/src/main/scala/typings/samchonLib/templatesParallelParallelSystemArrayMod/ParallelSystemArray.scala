package typings
package samchonLib.templatesParallelParallelSystemArrayMod
...
abstract class ParallelSystemArray[System /* <: samchonLib.templatesParallelParallelSystemMod.ParallelSystem */] ()
  ...
  /**
    * @hidden
    */
  /* protected */ def _Complete_history(history: samchonLib.templatesSlaveInvokeHistoryMod.InvokeHistory): scala.Boolean = js.native
  /**
    * @hidden
    */
  /* protected */ def _Normalize_performance(): scala.Unit = js.native
  /**
    ...
    */
  def sendPieceData(invoke: samchonLib.protocolInvokeInvokeMod.Invoke, first: scala.Double, last: scala.Double): scala.Double = js.native
  /**
    ...
    */
  def sendSegmentData(invoke: samchonLib.protocolInvokeInvokeMod.Invoke, size: scala.Double): scala.Double = js.native
}
