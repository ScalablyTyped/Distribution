package typings
package samchonLib.templatesDistributedDistributedSystemArrayMediatorMod
...
abstract class DistributedSystemArrayMediator[System /* <: samchonLib.templatesDistributedDistributedSystemMod.DistributedSystem */] ()
  ...
  /**
    ...
    */
  /* protected */ def createMediator(): samchonLib.templatesParallelMediatorSystemMod.MediatorSystem = js.native
  /**
    ...
    */
  def getMediator(): samchonLib.templatesParallelMediatorSystemMod.MediatorSystem = js.native
  /**
    * Start mediator.
    *
    ...
    */
  /* protected */ def startMediator(): scala.Unit = js.native
}
