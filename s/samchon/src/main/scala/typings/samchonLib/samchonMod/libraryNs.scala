...
object libraryNs extends js.Object {
  ...
  class CartesianProduct protected ()
    extends samchonLib.libraryMod.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends samchonLib.libraryMod.Factorial {
    /**
  ...
  class Permutation protected ()
    extends samchonLib.libraryMod.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends samchonLib.libraryMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends samchonLib.libraryMod.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends samchonLib.libraryMod.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends samchonLib.libraryMod.XML {
    def this(str: java.lang.String) = this()
