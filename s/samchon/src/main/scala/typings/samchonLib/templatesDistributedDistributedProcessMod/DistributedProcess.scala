package typings
package samchonLib.templatesDistributedDistributedProcessMod
...
abstract class DistributedProcess protected ()
  ...
  /**
    ...
    */
  def enforceResource(`val`: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getResource(): scala.Double = js.native
  /**
    * Get parent {@link DistributedSystemArray} object.
    *
    * @return The parent {@link DistributedSystemArray} object.
    */
  def getSystemArray(): samchonLib.templatesDistributedDistributedSystemArrayMod.DistributedSystemArray[samchonLib.templatesDistributedDistributedSystemMod.DistributedSystem] = js.native
  /**
    * Get parent {@link DistributedSystemArray} object.
    *
    * @return The parent {@link DistributedSystemArray} object.
  ...
  /**
    ...
    */
  def sendData(invoke: samchonLib.protocolInvokeInvokeMod.Invoke, weight: scala.Double): samchonLib.templatesDistributedDistributedSystemMod.DistributedSystem = js.native
  /**
    * Set resource index.
    *
    ...
    */
  def setResource(`val`: scala.Double): scala.Unit = js.native
}
