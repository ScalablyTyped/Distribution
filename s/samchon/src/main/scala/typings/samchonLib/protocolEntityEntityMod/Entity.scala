package typings
package samchonLib.protocolEntityEntityMod
...
abstract class Entity ()
  extends samchonLib.protocolEntityIEntityMod.IEntity {
  /**
    ...
    */
  /* CompleteClass */
  override def TAG(): java.lang.String = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def construct(xml: sxmlLib.sxmlMod.XML): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def toXML(): sxmlLib.sxmlMod.XML = js.native
}
