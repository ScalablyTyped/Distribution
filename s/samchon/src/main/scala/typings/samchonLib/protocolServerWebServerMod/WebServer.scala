package typings
package samchonLib.protocolServerWebServerMod
...
abstract class WebServer ()
  ...
  /**
    * @inheritdoc
    */
  def addClient(driver: samchonLib.protocolCommunicatorClientUnderscoreDriverWebClientDriverMod.WebClientDriver): scala.Unit = js.native
  /**
