package typings
package samchonLib.protocolServerDedicatedWorkerServerMod
...
abstract class DedicatedWorkerServer ()
  ...
  /**
    ...
    */
  def addClient(
    driver: samchonLib.protocolCommunicatorClientUnderscoreDriverDedicatedWorkerClientDriverMod.DedicatedWorkerClientDriver
