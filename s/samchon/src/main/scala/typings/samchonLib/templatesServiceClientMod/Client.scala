package typings
package samchonLib.templatesServiceClientMod
...
abstract class Client protected ()
  ...
  /**
    ...
    */
  /* protected */ def changeService(path: java.lang.String): scala.Unit = js.native
  /**
    * Change {@link Service} to another.
    *
    * @param service {@link service} object to newly assigned.
    */
  /* protected */ def changeService(service: samchonLib.templatesServiceServiceMod.Service): scala.Unit = js.native
  /**
    * Close connection.
    */
  ...
  /**
    ...
    */
  /* protected */ def createService(path: java.lang.String): samchonLib.templatesServiceServiceMod.Service = js.native
  /**
    * Default Destructor.
    *
  ...
  /**
    ...
    */
  def getNo(): scala.Double = js.native
  /**
    * Get child {@link Service} object.
    *
    * @return The child {@link Service} object.
    */
  def getService(): samchonLib.templatesServiceServiceMod.Service = js.native
  /**
    ...
    */
  def getUser(): samchonLib.templatesServiceUserMod.User = js.native
  /**
    * Sending message.
    *
