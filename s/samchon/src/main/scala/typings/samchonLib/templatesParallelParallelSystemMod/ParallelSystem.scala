package typings
package samchonLib.templatesParallelParallelSystemMod
...
abstract class ParallelSystem protected ()
  ...
  /**
    ...
    */
  def this(systemArray: samchonLib.templatesParallelParallelSystemArrayMod.ParallelSystemArray[ParallelSystem]) = this()
  /**
    ...
    */
  def this(systemArray: samchonLib.templatesParallelParallelSystemArrayMod.ParallelSystemArray[ParallelSystem], communicator: samchonLib.protocolCommunicatorIClientDriverMod.IClientDriver) = this()
  /**
    * @hidden
    */
  ...
  /**
    * @hidden
    */
  /* protected */ def _Report_history(xml: sxmlLib.sxmlMod.XML): scala.Unit = js.native
  /**
    * @hidden
    */
  /* protected */ def _Send_back_history(
    invoke: samchonLib.protocolInvokeInvokeMod.Invoke,
    history: samchonLib.templatesSlaveInvokeHistoryMod.InvokeHistory
  ...
  /**
    ...
    */
  def enforcePerformance(`val`: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def getPerformance(): scala.Double = js.native
  /**
  ...
  def getSystemArray_SystemArrayParallelSystemArraySystemArray[SystemArray /* <: samchonLib.templatesParallelParallelSystemArrayMod.ParallelSystemArray[ParallelSystem] */](): SystemArray = js.native
  /**
    ...
    */
  def setPerformance(`val`: scala.Double): scala.Unit = js.native
}
