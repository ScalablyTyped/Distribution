package typings
package samchonLib.templatesParallelPRInvokeHistoryMod
...
class PRInvokeHistory ()
  ...
  /**
    ...
    */
  def computeSize(): scala.Double = js.native
  /**
    ...
    */
  def getFirst(): scala.Double = js.native
  /**
    ...
    */
  def getLast(): scala.Double = js.native
}
