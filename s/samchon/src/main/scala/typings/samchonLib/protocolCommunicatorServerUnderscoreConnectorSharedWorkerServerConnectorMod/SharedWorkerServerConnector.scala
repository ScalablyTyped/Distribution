package typings
package samchonLib.protocolCommunicatorServerUnderscoreConnectorSharedWorkerServerConnectorMod
...
- samchonLib.protocolCommunicatorIServerConnectorMod.IServerConnector because var conflicts: onClose. Inlined onConnect, connect */ @JSImport("samchon/protocol/communicator/server_connector/SharedWorkerServerConnector", "SharedWorkerServerConnector")
@js.native
class SharedWorkerServerConnector protected ()
  ...
  /**
    ...
    */
  def connect(jsFile: java.lang.String): scala.Unit = js.native
}
