...
/* Inlined std.Pick<semantic-ui-site.SemanticUI.SiteSettings._Impl, 'name'> & std.Partial<std.Pick<semantic-ui-site.SemanticUI.SiteSettings._Impl, keyof semantic-ui-site.SemanticUI.SiteSettings._Impl>> */
