...
object TiffOptions {
  ...
  extension [Self <: TiffOptions](x: Self) {
    ...
    inline def setTileHeight(value: Boolean): Self = StObject.set(x, "tileHeight", value.asInstanceOf[js.Any])
    ...
    inline def setTileWidth(value: Boolean): Self = StObject.set(x, "tileWidth", value.asInstanceOf[js.Any])
