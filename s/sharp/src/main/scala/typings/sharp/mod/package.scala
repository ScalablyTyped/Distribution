...
package object mod {
  ...
  @scala.inline
  def apply(input: js.UndefOr[scala.Nothing], options: typings.sharp.mod.SharpOptions): typings.sharp.mod.Sharp = (typings.sharp.mod.^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sharp.mod.Sharp]
  @scala.inline
