...
trait Anon_TransformAnonTranslateXTranslateY extends js.Object {
  var transform: js.Array[Anon_TranslateXTranslateY | Anon_TranslateXTranslateYAnimatedInterpolation]
}
