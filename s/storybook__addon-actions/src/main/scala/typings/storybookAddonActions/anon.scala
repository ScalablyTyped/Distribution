...
object anon {
  ...
  object Action {
    ...
    inline def apply(action: () => Unit, actions: () => Unit, withActions: () => Unit): Action = {
    ...
    extension [Self <: Action](x: Self) {
      ...
      inline def setActions(value: () => Unit): Self = StObject.set(x, "actions", js.Any.fromFunction0(value))
      
      inline def setWithActions(value: () => Unit): Self = StObject.set(x, "withActions", js.Any.fromFunction0(value))
    }
  }
