...
trait SequelizeStaticAndInstance extends Errors {
  /**
    ...
    */
  var Deferrable: typings.sequelize.sequelizeMod.Deferrable = js.native
  /**
    * A reference to the sequelize instance class.
    */
  var Instance: typings.sequelize.sequelizeMod.Instance[_] = js.native
  /**
    ...
    */
  var Model: typings.sequelize.sequelizeMod.Model[_, _, _] = js.native
  ...
  /**
    ...
    */
  var QueryTypes: typings.sequelize.sequelizeMod.QueryTypes = js.native
  /**
  ...
  /**
    ...
    */
  var Utils: typings.sequelize.sequelizeMod.Utils = js.native
  /**
    ...
    */
  var Validator: typings.sequelize.sequelizeMod.Validator = js.native
  /**
    * An AND query
    *
    * @param args Each argument will be joined by AND
    */
  def and(args: (String | js.Object)*): typings.sequelize.sequelizeMod.and = js.native
  ...
  /**
    ...
    */
  def cast(`val`: js.Any, `type`: String): typings.sequelize.sequelizeMod.cast = js.native
  /**
    ...
    */
  def col(col: String): typings.sequelize.sequelizeMod.col = js.native
  ...
  /**
    ...
    */
  def fn(fn: String, args: js.Any*): typings.sequelize.sequelizeMod.fn = js.native
  /**
    ...
    *     '<value>'".
    */
  def json(conditionsOrPath: String): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: String): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: Boolean): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: String, value: Double): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: String): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: Boolean): typings.sequelize.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: Double): typings.sequelize.sequelizeMod.json = js.native
  /**
    * Creates a object representing a literal, i.e. something that will not be escaped.
    *
    * @param val
    */
  def literal(`val`: js.Any): typings.sequelize.sequelizeMod.literal = js.native
  /**
    * An OR query
    *
    * @param args Each argument will be joined by OR
    */
  def or(args: (String | js.Object)*): typings.sequelize.sequelizeMod.or = js.native
  /**
    ...
    *     etc.)
    */
  def where(attr: js.Object, comparator: String, logic: String): typings.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, comparator: String, logic: js.Object): typings.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: String): typings.sequelize.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: js.Object): typings.sequelize.sequelizeMod.where = js.native
}
