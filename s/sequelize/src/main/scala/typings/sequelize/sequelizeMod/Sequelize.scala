...
import typings.sequelize.Anon_LoggingBoolean
import typings.sequelize.Anon_Query
...
trait Sequelize
  ...
  /**
    ...
    */
  def authenticate(): typings.bluebird.bluebirdMod.^[Unit] = js.native
  def authenticate(options: QueryOptions): typings.bluebird.bluebirdMod.^[Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def createSchema(schema: String, options: Anon_LoggingBoolean): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def drop(): typings.bluebird.bluebirdMod.^[_] = js.native
  def drop(options: DropOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    * Drop all schemas
    *
    * Note,that this is a schema in the
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropAllSchemas(options: Anon_LoggingBoolean): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropSchema(schema: String, options: Anon_LoggingBoolean): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    * Escape value.
    *
  ...
  /**
    ...
    */
  def query(sql: String): typings.bluebird.bluebirdMod.^[_] = js.native
  def query(sql: String, options: QueryOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  def query(sql: Anon_Query): typings.bluebird.bluebirdMod.^[_] = js.native
  def query(sql: Anon_Query, options: QueryOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    * @param options Query options.
    */
  def set(variables: js.Object, options: QueryOptionsTransactionRequired): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def showAllSchemas(options: Anon_LoggingBoolean): typings.bluebird.bluebirdMod.^[_] = js.native
  /**
    * Sync all defined models to the DB.
    *
    * @param options Sync Options
    */
  def sync(): typings.bluebird.bluebirdMod.^[_] = js.native
  def sync(options: SyncOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  def transaction(): typings.bluebird.bluebirdMod.^[Transaction] = js.native
  def transaction(options: TransactionOptions): typings.bluebird.bluebirdMod.^[Transaction] = js.native
  def transaction[T](autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): typings.bluebird.bluebirdMod.^[T] = js.native
  /**
    ...
    */
  def transaction[T](options: TransactionOptions, autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): typings.bluebird.bluebirdMod.^[T] = js.native
  /**
    ...
    */
  def truncate(): typings.bluebird.bluebirdMod.^[_] = js.native
  def truncate(options: DestroyOptions): typings.bluebird.bluebirdMod.^[_] = js.native
  def validate(): typings.bluebird.bluebirdMod.^[ValidationError] = js.native
  def validate(options: QueryOptions): typings.bluebird.bluebirdMod.^[ValidationError] = js.native
}
