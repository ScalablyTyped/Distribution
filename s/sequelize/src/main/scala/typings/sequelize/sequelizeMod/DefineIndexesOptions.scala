...
import typings.sequelize.Anon_Attribute
...
trait DefineIndexesOptions extends js.Object {
  ...
  /**
    ...
    */
  var fields: js.UndefOr[js.Array[String | fn | Anon_Attribute]] = js.undefined
  /**
...
object DefineIndexesOptions {
  ...
  def apply(
    ...
    fields: js.Array[String | fn | Anon_Attribute] = null,
    method: String = null,
    name: String = null,
