...
object QueryOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(mapToModel)) __obj.updateDynamic("mapToModel")(mapToModel.asInstanceOf[js.Any])
    if (model != null) __obj.updateDynamic("model")(model.asInstanceOf[js.Any])
    if (!js.isUndefined(nest)) __obj.updateDynamic("nest")(nest.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(supportsSearchPath)) __obj.updateDynamic("supportsSearchPath")(supportsSearchPath.asInstanceOf[js.Any])
