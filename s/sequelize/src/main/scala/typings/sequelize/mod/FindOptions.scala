...
object FindOptions {
  ...
  extension [Self <: FindOptions[?], T](x: Self & FindOptions[T]) {
    ...
    inline def setGroup(value: String | js.Array[String] | js.Object): Self = StObject.set(x, "group", value.asInstanceOf[js.Any])
    ...
    inline def setLock(value: TransactionLockLevel | Level): Self = StObject.set(x, "lock", value.asInstanceOf[js.Any])
    ...
    inline def setRejectOnEmpty(value: Boolean): Self = StObject.set(x, "rejectOnEmpty", value.asInstanceOf[js.Any])
    
    inline def setRejectOnEmptyUndefined: Self = StObject.set(x, "rejectOnEmpty", js.undefined)
