...
trait UpsertOptionsreturningfal extends js.Object {
  /**
  ...
  /**
    ...
    */
  var returning: js.UndefOr[Boolean with js.UndefOr[`false`]] = js.undefined
  /**
...
object UpsertOptionsreturningfal {
  ...
  def apply(
    ...
    returning: js.UndefOr[Boolean with js.UndefOr[`false`]] = js.undefined,
    searchPath: String = null,
    transaction: Transaction = null,
    validate: js.UndefOr[Boolean] = js.undefined
  ): UpsertOptionsreturningfal = {
