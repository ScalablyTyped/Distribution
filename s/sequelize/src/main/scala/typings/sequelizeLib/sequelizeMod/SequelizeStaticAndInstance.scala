...
trait SequelizeStaticAndInstance extends Errors {
  /**
    ...
    */
  var Deferrable: sequelizeLib.sequelizeMod.Deferrable = js.native
  /**
    * A reference to the sequelize instance class.
    */
  var Instance: sequelizeLib.sequelizeMod.Instance[_] = js.native
  /**
    ...
    */
  var Model: sequelizeLib.sequelizeMod.Model[_, _, _] = js.native
  ...
  /**
    ...
    */
  var QueryTypes: sequelizeLib.sequelizeMod.QueryTypes = js.native
  /**
  ...
  /**
    ...
    */
  var Utils: sequelizeLib.sequelizeMod.Utils = js.native
  /**
    ...
    */
  var Validator: sequelizeLib.sequelizeMod.Validator = js.native
  /**
    * An AND query
    *
    * @param args Each argument will be joined by AND
    */
  def and(args: (java.lang.String | js.Object)*): sequelizeLib.sequelizeMod.and = js.native
  ...
  /**
    ...
    */
  def cast(`val`: js.Any, `type`: java.lang.String): sequelizeLib.sequelizeMod.cast = js.native
  /**
    ...
    */
  def col(col: java.lang.String): sequelizeLib.sequelizeMod.col = js.native
  ...
  /**
    ...
    */
  def fn(fn: java.lang.String, args: js.Any*): sequelizeLib.sequelizeMod.fn = js.native
  /**
    ...
    *     '<value>'".
    */
  def json(conditionsOrPath: java.lang.String): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: java.lang.String, value: java.lang.String): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: java.lang.String, value: scala.Boolean): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: java.lang.String, value: scala.Double): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: java.lang.String): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: scala.Boolean): sequelizeLib.sequelizeMod.json = js.native
  def json(conditionsOrPath: js.Object, value: scala.Double): sequelizeLib.sequelizeMod.json = js.native
  /**
    * Creates a object representing a literal, i.e. something that will not be escaped.
    *
    * @param val
    */
  def literal(`val`: js.Any): sequelizeLib.sequelizeMod.literal = js.native
  /**
    * An OR query
    *
    * @param args Each argument will be joined by OR
    */
  def or(args: (java.lang.String | js.Object)*): sequelizeLib.sequelizeMod.or = js.native
  /**
    ...
    *     etc.)
    */
  def where(attr: js.Object, comparator: java.lang.String, logic: java.lang.String): sequelizeLib.sequelizeMod.where = js.native
  def where(attr: js.Object, comparator: java.lang.String, logic: js.Object): sequelizeLib.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: java.lang.String): sequelizeLib.sequelizeMod.where = js.native
  def where(attr: js.Object, logic: js.Object): sequelizeLib.sequelizeMod.where = js.native
}
