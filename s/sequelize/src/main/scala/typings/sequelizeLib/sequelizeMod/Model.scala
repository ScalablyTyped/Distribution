...
trait Model[TInstance, TAttributes, TCreationAttributes]
  ...
  /**
    ...
    */
  def aggregate(field: java.lang.String, aggregateFunction: java.lang.String): bluebirdLib.bluebirdMod.^[js.Object] = js.native
  def aggregate(field: java.lang.String, aggregateFunction: java.lang.String, options: AggregateOptions): bluebirdLib.bluebirdMod.^[js.Object] = js.native
  def all[TCustomAttributes](): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  def all[TCustomAttributes](optionz: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  /**
  ...
  /**
    ...
    */
  def bulkCreate(records: js.Array[TAttributes]): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  def bulkCreate(records: js.Array[TAttributes], options: BulkCreateOptions): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  /**
  ...
  def count(options: CountOptions): bluebirdLib.bluebirdMod.^[scala.Double] = js.native
  /**
    * Builds a new model instance and calls save on it.
    */
  def create(): bluebirdLib.bluebirdMod.^[TInstance] = js.native
  def create(values: TCreationAttributes): bluebirdLib.bluebirdMod.^[TInstance] = js.native
  def create(values: TCreationAttributes, options: CreateOptions): bluebirdLib.bluebirdMod.^[TInstance] = js.native
  /**
    * Run a describe query on the table. The result will be return to the listener as a hash of attributes and
    * their types.
    */
  def describe(): bluebirdLib.bluebirdMod.^[js.Object] = js.native
  /**
    * Delete multiple instances, or set their deletedAt timestamp to the current time if `paranoid` is enabled.
    *
    * @return Promise<number> The number of destroyed rows
    */
  def destroy(): bluebirdLib.bluebirdMod.^[scala.Double] = js.native
  def destroy(options: DestroyOptions): bluebirdLib.bluebirdMod.^[scala.Double] = js.native
  /**
    * Drop the table represented by this Model
    *
    * @param options
    */
  def drop(): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def drop(options: DropOptions): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def find[TCustomAttributes](): bluebirdLib.bluebirdMod.^[TInstance | scala.Null] = js.native
  def find[TCustomAttributes](options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[TInstance | scala.Null] = js.native
  /**
    ...
    * @see    {Sequelize#query}
    */
  def findAll[TCustomAttributes](): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  def findAll[TCustomAttributes](options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[js.Array[TInstance]] = js.native
  /**
    ...
    */
  def findAndCount[TCustomAttributes](): bluebirdLib.bluebirdMod.^[sequelizeLib.Anon_Count[TInstance]] = js.native
  def findAndCount[TCustomAttributes](options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[sequelizeLib.Anon_Count[TInstance]] = js.native
  def findAndCountAll[TCustomAttributes](): bluebirdLib.bluebirdMod.^[sequelizeLib.Anon_Count[TInstance]] = js.native
  def findAndCountAll[TCustomAttributes](options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[sequelizeLib.Anon_Count[TInstance]] = js.native
  /**
  ...
  /**
    ...
    */
  def findCreateFind[TCustomAttributes](options: FindCreateFindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[js.Tuple2[TInstance, scala.Boolean]] = js.native
  /**
    * Search for a single instance. This applies LIMIT 1, so the listener will always be called with a single
    * instance.
    */
  def findOne[TCustomAttributes](): bluebirdLib.bluebirdMod.^[TInstance | scala.Null] = js.native
  def findOne[TCustomAttributes](options: FindOptions[TAttributes with TCustomAttributes]): bluebirdLib.bluebirdMod.^[TInstance | scala.Null] = js.native
  def findOrBuild(options: FindOrInitializeOptions[TAttributes]): bluebirdLib.bluebirdMod.^[js.Tuple2[TInstance, scala.Boolean]] = js.native
  /**
    ...
    */
  def findOrCreate(options: FindOrInitializeOptions[TAttributes]): bluebirdLib.bluebirdMod.^[js.Tuple2[TInstance, scala.Boolean]] = js.native
  /**
    * Find a row that matches the query, or build (but don't save) the row if none is found.
    * The successfull result of the promise will be (instance, initialized) - Make sure to use .spread()
    */
  def findOrInitialize(options: FindOrInitializeOptions[TAttributes]): bluebirdLib.bluebirdMod.^[js.Tuple2[TInstance, scala.Boolean]] = js.native
  /**
  ...
  def insertOrUpdate(values: TAttributes): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  def insertOrUpdate(
    values: TAttributes,
  ...
  /**
    ...
    */
  def max(field: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def max(field: java.lang.String, options: AggregateOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    * Find the minimum value of field
    */
  def min(field: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def min(field: java.lang.String, options: AggregateOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def restore(): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def restore(options: RestoreOptions): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def sum(field: java.lang.String): bluebirdLib.bluebirdMod.^[scala.Double] = js.native
  def sum(field: java.lang.String, options: AggregateOptions): bluebirdLib.bluebirdMod.^[scala.Double] = js.native
  /**
    * Sync this Model to the DB, that is create the table. Upon success, the callback will be called with the
    * model instance (this)
    */
  def sync(): bluebirdLib.bluebirdMod.^[this.type] = js.native
  def sync(options: SyncOptions): bluebirdLib.bluebirdMod.^[this.type] = js.native
  /**
    * Truncate all instances of the model. This is a convenient method for Model.destroy({ truncate: true }).
    */
  def truncate(): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def truncate(options: TruncateOptions): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  /**
    * Unscope the model
    */
  ...
  /**
    ...
    */
  def update(values: stdLib.Partial[TAttributes]): bluebirdLib.bluebirdMod.^[js.Tuple2[scala.Double, js.Array[TInstance]]] = js.native
  def update(values: stdLib.Partial[TAttributes], options: UpdateOptions): bluebirdLib.bluebirdMod.^[js.Tuple2[scala.Double, js.Array[TInstance]]] = js.native
  /**
    ...
    */
  def upsert(values: TAttributes): bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  def upsert(
    values: TAttributes,
