...
trait Sequelize
  ...
  /**
    ...
    */
  def authenticate(): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  def authenticate(options: QueryOptions): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    */
  def createSchema(schema: java.lang.String, options: sequelizeLib.Anon_LoggingBoolean): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    */
  def drop(): bluebirdLib.bluebirdMod.^[_] = js.native
  def drop(options: DropOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    * Drop all schemas
    *
    * Note,that this is a schema in the
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropAllSchemas(options: sequelizeLib.Anon_LoggingBoolean): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def dropSchema(schema: java.lang.String, options: sequelizeLib.Anon_LoggingBoolean): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    * Escape value.
    *
  ...
  /**
    ...
    */
  def query(sql: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def query(sql: java.lang.String, options: QueryOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  def query(sql: sequelizeLib.Anon_Query): bluebirdLib.bluebirdMod.^[_] = js.native
  def query(sql: sequelizeLib.Anon_Query, options: QueryOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
  ...
  /**
    ...
    * @param options Query options.
    */
  def set(variables: js.Object, options: QueryOptionsTransactionRequired): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @param options.logging A function that logs sql queries, or false for no logging
    */
  def showAllSchemas(options: sequelizeLib.Anon_LoggingBoolean): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    * Sync all defined models to the DB.
    *
    * @param options Sync Options
    */
  def sync(): bluebirdLib.bluebirdMod.^[_] = js.native
  def sync(options: SyncOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  def transaction(): bluebirdLib.bluebirdMod.^[Transaction] = js.native
  def transaction(options: TransactionOptions): bluebirdLib.bluebirdMod.^[Transaction] = js.native
  def transaction[T](autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): bluebirdLib.bluebirdMod.^[T] = js.native
  /**
    ...
    */
  def transaction[T](options: TransactionOptions, autoCallback: js.Function1[/* t */ Transaction, js.Thenable[T]]): bluebirdLib.bluebirdMod.^[T] = js.native
  /**
    ...
    */
  def truncate(): bluebirdLib.bluebirdMod.^[_] = js.native
  def truncate(options: DestroyOptions): bluebirdLib.bluebirdMod.^[_] = js.native
  def validate(): bluebirdLib.bluebirdMod.^[ValidationError] = js.native
  def validate(options: QueryOptions): bluebirdLib.bluebirdMod.^[ValidationError] = js.native
}
