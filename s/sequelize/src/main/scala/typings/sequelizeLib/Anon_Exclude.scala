...
trait Anon_Exclude extends js.Object {
  ...
  var include: js.UndefOr[sequelizeLib.sequelizeMod.FindOptionsAttributesArray] = js.undefined
}
...
object Anon_Exclude {
  ...
  def apply(
    ...
    include: sequelizeLib.sequelizeMod.FindOptionsAttributesArray = null
  ): Anon_Exclude = {
