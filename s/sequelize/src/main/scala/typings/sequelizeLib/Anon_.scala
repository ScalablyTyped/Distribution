...
trait Anon_ extends js.Object {
  var `!..`: (js.Tuple2[scala.Double, scala.Double]) | (js.Tuple2[java.lang.String, java.lang.String])
  @JSName("$between")
...
object Anon_ {
  @scala.inline
  def apply(
    `!..`: (js.Tuple2[scala.Double, scala.Double]) | (js.Tuple2[java.lang.String, java.lang.String]),
