...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'transition'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImpltransitionPartial
  ...
  var transition: (`false` | String) & (js.UndefOr[`false` | String])
...
object PickImpltransitionPartial {
  ...
  inline def apply(transition: (`false` | String) & (js.UndefOr[`false` | String])): PickImpltransitionPartial = {
  ...
  extension [Self <: PickImpltransitionPartial](x: Self) {
    ...
    inline def setTransition(value: (`false` | String) & (js.UndefOr[`false` | String])): Self = StObject.set(x, "transition", value.asInstanceOf[js.Any])
