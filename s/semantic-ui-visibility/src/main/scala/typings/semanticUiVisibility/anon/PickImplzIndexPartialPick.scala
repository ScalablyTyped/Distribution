...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'zIndex'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplzIndexPartialPick
  extends StObject
     with Param {
...
object PickImplzIndexPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplzIndexPartialPick] (val x: Self) extends AnyVal {
