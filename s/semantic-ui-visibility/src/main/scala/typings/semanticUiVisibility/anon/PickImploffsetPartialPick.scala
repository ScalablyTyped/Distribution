...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'offset'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImploffsetPartialPick
  extends StObject
     with Param {
...
object PickImploffsetPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImploffsetPartialPick] (val x: Self) extends AnyVal {
