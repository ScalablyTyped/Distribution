...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'once'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImploncePartialPickIm
  extends StObject
     with Param {
...
object PickImploncePartialPickIm {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImploncePartialPickIm] (val x: Self) extends AnyVal {
