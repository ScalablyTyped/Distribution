...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'initialCheck'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplinitialCheckParti
  extends StObject
     with Param {
...
object PickImplinitialCheckParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplinitialCheckParti] (val x: Self) extends AnyVal {
