...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onUnfixed'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonUnfixedPartialP
  extends StObject
     with Param {
...
object PickImplonUnfixedPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonUnfixedPartialP] (val x: Self) extends AnyVal {
