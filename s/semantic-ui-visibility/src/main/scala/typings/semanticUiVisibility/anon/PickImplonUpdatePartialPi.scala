...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onUpdate'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonUpdatePartialPi
  extends StObject
     with Param {
...
object PickImplonUpdatePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonUpdatePartialPi] (val x: Self) extends AnyVal {
