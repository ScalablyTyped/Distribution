...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'includeMargin'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplincludeMarginPart
  extends StObject
     with Param {
...
object PickImplincludeMarginPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplincludeMarginPart] (val x: Self) extends AnyVal {
