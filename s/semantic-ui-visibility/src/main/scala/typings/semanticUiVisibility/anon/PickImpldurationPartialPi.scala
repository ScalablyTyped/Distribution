...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'duration'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
...
object PickImpldurationPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldurationPartialPi] (val x: Self) extends AnyVal {
