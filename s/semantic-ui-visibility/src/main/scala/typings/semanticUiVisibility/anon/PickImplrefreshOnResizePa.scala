...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'refreshOnResize'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplrefreshOnResizePa
  extends StObject
     with Param {
...
object PickImplrefreshOnResizePa {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplrefreshOnResizePa] (val x: Self) extends AnyVal {
