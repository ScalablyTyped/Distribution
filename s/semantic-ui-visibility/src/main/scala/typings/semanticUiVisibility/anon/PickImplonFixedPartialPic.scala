...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onFixed'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonFixedPartialPic
  extends StObject
     with Param {
...
object PickImplonFixedPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonFixedPartialPic] (val x: Self) extends AnyVal {
