...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onLoad'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
...
object PickImplonLoadPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonLoadPartialPick] (val x: Self) extends AnyVal {
