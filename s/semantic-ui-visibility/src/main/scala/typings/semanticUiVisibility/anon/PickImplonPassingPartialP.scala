...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onPassing'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonPassingPartialP
  extends StObject
     with Param {
...
object PickImplonPassingPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonPassingPartialP] (val x: Self) extends AnyVal {
