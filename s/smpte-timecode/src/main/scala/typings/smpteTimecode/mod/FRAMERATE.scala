...
object FRAMERATE {
  ...
  @scala.inline
  def `24`: typings.smpteTimecode.smpteTimecodeNumbers.`24` = this.cast(24)
  @scala.inline
  def `25`: typings.smpteTimecode.smpteTimecodeNumbers.`25` = this.cast(25)
  @scala.inline
  def `29Dot97`: `29.97` = this.cast(29.97)
  @scala.inline
  def `30`: typings.smpteTimecode.smpteTimecodeNumbers.`30` = this.cast(30)
  @scala.inline
  def `50`: typings.smpteTimecode.smpteTimecodeNumbers.`50` = this.cast(50)
  @scala.inline
  def `59Dot94`: `59.94` = this.cast(59.94)
  @scala.inline
  def `60`: typings.smpteTimecode.smpteTimecodeNumbers.`60` = this.cast(60)
  @scala.inline
