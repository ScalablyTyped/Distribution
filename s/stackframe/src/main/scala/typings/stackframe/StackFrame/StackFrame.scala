...
class StackFrame protected () extends js.Object {
  ...
  def getEvalOrigin(): typings.stackframe.StackFrame.StackFrame = js.native
  ...
  def setEvalOrigin(stackframe: typings.stackframe.StackFrame.StackFrame): Unit = js.native
