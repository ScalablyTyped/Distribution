...
class AbstractDataClient protected ()
  ...
  def count(
    keyChain: fleximapLib.fleximapMod.KeyChain,
    callback: js.Function2[/* err */ nodeLib.Error | scala.Null, /* value */ scala.Double, scala.Unit]
  ): scala.Unit = js.native
  ...
  def get(
    keyChain: fleximapLib.fleximapMod.KeyChain,
    callback: js.Function2[/* err */ nodeLib.Error | scala.Null, /* value */ js.Any, scala.Unit]
  ): scala.Unit = js.native
  def getAll(
  ...
  def hasKey(
    keyChain: fleximapLib.fleximapMod.KeyChain,
    callback: js.Function2[/* err */ nodeLib.Error | scala.Null, /* data */ scala.Boolean, scala.Unit]
  ): scala.Unit = js.native
  def pop(
    keyChain: fleximapLib.fleximapMod.KeyChain,
    callback: js.Function2[/* err */ nodeLib.Error | scala.Null, /* data */ js.Any, scala.Unit]
  ...
  def removeAll(callback: js.Function1[/* err */ nodeLib.Error, scala.Unit]): scala.Unit = js.native
