...
class Server protected ()
  ...
  def on_brokerExit(
    ...
    listener: js.Function1[/* brokerInfo */ socketclusterLib.socketclusterMod.BrokerExitInfo, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  def on_brokerStart(
    ...
    listener: js.Function1[/* brokerInfo */ socketclusterLib.socketclusterMod.BrokerStartInfo, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_error(
