...
trait SCBrokerClusterServerOptions extends js.Object {
  ...
  var brokerOptions: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify SCServer.SCServerOptions */ js.UndefOr[
    /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify SCServer.SCServerOptions */ js.Any
  ] = js.undefined
