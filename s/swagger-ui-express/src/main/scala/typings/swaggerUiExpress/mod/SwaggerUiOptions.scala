...
object SwaggerUiOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(explorer)) __obj.updateDynamic("explorer")(explorer.get.asInstanceOf[js.Any])
    if (!js.isUndefined(isExplorer)) __obj.updateDynamic("isExplorer")(isExplorer.get.asInstanceOf[js.Any])
