...
trait RouterProps extends StObject {
  ...
  var location: PartialLocation1 | String
...
object RouterProps {
  ...
  inline def apply(location: PartialLocation1 | String, navigator: Navigator): RouterProps = {
  ...
  implicit open class MutableBuilder[Self <: RouterProps] (val x: Self) extends AnyVal {
    ...
    inline def setLocation(value: PartialLocation1 | String): Self = StObject.set(x, "location", value.asInstanceOf[js.Any])
