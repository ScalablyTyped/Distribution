...
object distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod {
  ...
  inline def createPath(param0: typings.storybookRouter.anon.PartialPath): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createPath")(param0.asInstanceOf[js.Any]).asInstanceOf[String]
