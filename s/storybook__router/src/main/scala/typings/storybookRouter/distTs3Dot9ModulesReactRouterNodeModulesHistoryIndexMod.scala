...
object distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod {
  
  @JSImport("@storybook/router/dist/ts3.9/_modules/react-router-node_modules-history-index", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @js.native
  sealed trait Action extends StObject
  @JSImport("@storybook/router/dist/ts3.9/_modules/react-router-node_modules-history-index", "Action")
  @js.native
  ...
  inline def createPath(hasPathnameSearchHash: typings.storybookRouter.anon.PartialPath): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createPath")(hasPathnameSearchHash.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def parsePath(path: String): typings.storybookRouter.anon.PartialPath = ^.asInstanceOf[js.Dynamic].applyDynamic("parsePath")(path.asInstanceOf[js.Any]).asInstanceOf[typings.storybookRouter.anon.PartialPath]
  ...
  type InitialEntry = String | typings.storybookRouter.anon.PartialLocation
  ...
  type To = String | typings.storybookRouter.anon.PartialPath
