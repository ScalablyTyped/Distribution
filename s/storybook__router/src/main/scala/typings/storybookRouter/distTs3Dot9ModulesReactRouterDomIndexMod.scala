...
import typings.storybookRouter.anon.IsActive
import typings.storybookRouter.anon.PartialLocation
import typings.storybookRouter.anon.Replace
import typings.storybookRouter.anon.State
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.IndexRouteProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.LayoutRouteProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.MemoryRouterProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.NavigateFunction
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.NavigateProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.OutletProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.Params
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathMatch
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathPattern
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathRouteProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RouteMatch
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RouteObject
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RouterProps
import typings.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RoutesProps
...
import typings.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Path
import typings.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.To
import typings.storybookRouter.storybookRouterStrings.`additions removals`
import typings.storybookRouter.storybookRouterStrings.`additions text`
import typings.storybookRouter.storybookRouterStrings.`inline`
import typings.storybookRouter.storybookRouterStrings.`removals additions`
import typings.storybookRouter.storybookRouterStrings.`removals text`
import typings.storybookRouter.storybookRouterStrings.`text additions`
import typings.storybookRouter.storybookRouterStrings.`text removals`
import typings.storybookRouter.storybookRouterStrings.additions
import typings.storybookRouter.storybookRouterStrings.all
import typings.storybookRouter.storybookRouterStrings.ascending
import typings.storybookRouter.storybookRouterStrings.assertive
import typings.storybookRouter.storybookRouterStrings.both
import typings.storybookRouter.storybookRouterStrings.copy
import typings.storybookRouter.storybookRouterStrings.date
import typings.storybookRouter.storybookRouterStrings.decimal
import typings.storybookRouter.storybookRouterStrings.descending
import typings.storybookRouter.storybookRouterStrings.dialog
import typings.storybookRouter.storybookRouterStrings.email
import typings.storybookRouter.storybookRouterStrings.execute
import typings.storybookRouter.storybookRouterStrings.grammar
import typings.storybookRouter.storybookRouterStrings.grid
import typings.storybookRouter.storybookRouterStrings.horizontal
import typings.storybookRouter.storybookRouterStrings.inherit
import typings.storybookRouter.storybookRouterStrings.link
import typings.storybookRouter.storybookRouterStrings.list
import typings.storybookRouter.storybookRouterStrings.listbox
import typings.storybookRouter.storybookRouterStrings.location
import typings.storybookRouter.storybookRouterStrings.menu
import typings.storybookRouter.storybookRouterStrings.mixed
import typings.storybookRouter.storybookRouterStrings.move
import typings.storybookRouter.storybookRouterStrings.no
import typings.storybookRouter.storybookRouterStrings.none
import typings.storybookRouter.storybookRouterStrings.numeric
import typings.storybookRouter.storybookRouterStrings.off
import typings.storybookRouter.storybookRouterStrings.on
import typings.storybookRouter.storybookRouterStrings.other
import typings.storybookRouter.storybookRouterStrings.page
import typings.storybookRouter.storybookRouterStrings.polite
import typings.storybookRouter.storybookRouterStrings.popup
import typings.storybookRouter.storybookRouterStrings.removals
import typings.storybookRouter.storybookRouterStrings.search
import typings.storybookRouter.storybookRouterStrings.spelling
import typings.storybookRouter.storybookRouterStrings.step
import typings.storybookRouter.storybookRouterStrings.tel
import typings.storybookRouter.storybookRouterStrings.text
import typings.storybookRouter.storybookRouterStrings.time
import typings.storybookRouter.storybookRouterStrings.tree
import typings.storybookRouter.storybookRouterStrings.url
import typings.storybookRouter.storybookRouterStrings.vertical
import typings.storybookRouter.storybookRouterStrings.yes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTs3Dot9ModulesReactRouterDomIndexMod {
  
  @JSImport("@storybook/router/dist/ts3.9/_modules/react-router-dom-index", JSImport.Namespace)
  @js.native
  ...
  object NavigationType extends StObject {
    ...
    /* "POP" */ val Pop: typings.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Pop & String = js.native
    
    /* "PUSH" */ val Push: typings.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Push & String = js.native
    
    /* "REPLACE" */ val Replace: typings.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Replace & String = js.native
  }
  ...
  inline def useSearchParams(): js.Tuple2[
    URLSearchParams, 
    js.Function2[/* nextInit */ URLSearchParamsInit, /* navigateOptions */ js.UndefOr[State], Unit]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("useSearchParams")().asInstanceOf[js.Tuple2[
    URLSearchParams, 
    js.Function2[/* nextInit */ URLSearchParamsInit, /* navigateOptions */ js.UndefOr[State], Unit]
  ]]
  inline def useSearchParams(defaultInit: URLSearchParamsInit): js.Tuple2[
    URLSearchParams, 
    js.Function2[/* nextInit */ URLSearchParamsInit, /* navigateOptions */ js.UndefOr[State], Unit]
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("useSearchParams")(defaultInit.asInstanceOf[js.Any]).asInstanceOf[js.Tuple2[
    URLSearchParams, 
    js.Function2[/* nextInit */ URLSearchParamsInit, /* navigateOptions */ js.UndefOr[State], Unit]
  ]]
  ...
  object HashRouterProps {
    ...
    inline def apply(): HashRouterProps = {
      val __obj = js.Dynamic.literal()
  ...
  /* Inlined parent std.Omit<react.react.AnchorHTMLAttributes<std.HTMLAnchorElement>, 'href'> */
  trait LinkProps extends StObject {
    ...
    var reloadDocument: js.UndefOr[Boolean] = js.undefined
  ...
  object LinkProps {
    ...
    implicit open class MutableBuilder[Self <: LinkProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnAuxClick(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onAuxClick", js.Any.fromFunction1(value))
      ...
      inline def setOnBlur(value: FocusEvent[HTMLAnchorElement, typings.std.Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnClick(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      ...
      inline def setOnContextMenu(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onContextMenu", js.Any.fromFunction1(value))
      ...
      inline def setOnDoubleClick(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onDoubleClick", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLAnchorElement, typings.std.Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
      ...
      inline def setOnMouseDown(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1(value))
      
      inline def setOnMouseDownUndefined: Self = StObject.set(x, "onMouseDown", js.undefined)
      
      inline def setOnMouseEnter(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseEnter", js.Any.fromFunction1(value))
      
      inline def setOnMouseEnterUndefined: Self = StObject.set(x, "onMouseEnter", js.undefined)
      
      inline def setOnMouseLeave(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseLeave", js.Any.fromFunction1(value))
      
      inline def setOnMouseLeaveUndefined: Self = StObject.set(x, "onMouseLeave", js.undefined)
      
      inline def setOnMouseMove(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1(value))
      
      inline def setOnMouseMoveUndefined: Self = StObject.set(x, "onMouseMove", js.undefined)
      
      inline def setOnMouseOut(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseOut", js.Any.fromFunction1(value))
      
      inline def setOnMouseOutUndefined: Self = StObject.set(x, "onMouseOut", js.undefined)
      
      inline def setOnMouseOver(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseOver", js.Any.fromFunction1(value))
      
      inline def setOnMouseOverUndefined: Self = StObject.set(x, "onMouseOver", js.undefined)
      
      inline def setOnMouseUp(value: typings.react.mod.MouseEvent[HTMLAnchorElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onMouseUp", js.Any.fromFunction1(value))
      ...
      inline def setReloadDocument(value: Boolean): Self = StObject.set(x, "reloadDocument", value.asInstanceOf[js.Any])
      
      inline def setReloadDocumentUndefined: Self = StObject.set(x, "reloadDocument", js.undefined)
  ...
  /* Inlined parent std.Omit<@storybook/router.@storybook/router/dist/ts3.9/_modules/react-router-dom-index.LinkProps, 'className' | 'style'> */
  trait NavLinkProps extends StObject {
    ...
    var className: js.UndefOr[String | (js.Function1[/* props */ IsActive, String])] = js.undefined
    ...
    var style: js.UndefOr[CSSProperties | (js.Function1[/* props */ IsActive, CSSProperties])] = js.undefined
  ...
  object NavLinkProps {
    ...
    implicit open class MutableBuilder[Self <: NavLinkProps] (val x: Self) extends AnyVal {
      ...
      inline def setClassName(value: String | (js.Function1[/* props */ IsActive, String])): Self = StObject.set(x, "className", value.asInstanceOf[js.Any])
      
      inline def setClassNameFunction1(value: /* props */ IsActive => String): Self = StObject.set(x, "className", js.Any.fromFunction1(value))
      ...
      inline def setStyle(value: CSSProperties | (js.Function1[/* props */ IsActive, CSSProperties])): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
      
      inline def setStyleFunction1(value: /* props */ IsActive => CSSProperties): Self = StObject.set(x, "style", js.Any.fromFunction1(value))
