...
trait storybookRouterProps {
  @scala.inline
  def LinkProps: QueryLinkProps.type = typings.storybookRouter.routerMod.QueryLinkProps
  ...
  @scala.inline
  def ToggleVisibilityProps: Props.type = typings.storybookRouter.visibilityMod.Props
