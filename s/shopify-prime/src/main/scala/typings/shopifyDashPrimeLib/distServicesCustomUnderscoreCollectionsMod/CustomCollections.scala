...
class CustomCollections protected ()
  ...
  /**
       ...
       */
  def create(collection: shopifyDashPrimeLib.distModelsProductUnderscoreCollectionMod.CustomCollection): stdLib.Promise[shopifyDashPrimeLib.distModelsProductUnderscoreCollectionMod.CustomCollection] = js.native
  /**
  ...
  /**
       ...
       * @param options Options for filtering the results.
       */
  def get(id: scala.Double): stdLib.Promise[shopifyDashPrimeLib.distModelsProductUnderscoreCollectionMod.CustomCollection] = js.native
  /**
       * Get a single custom collection
       * @param id The collection's id.
       * @param options Options for filtering the results.
       */
  def get(id: scala.Double, options: shopifyDashPrimeLib.distOptionsBaseMod.FieldOptions): stdLib.Promise[shopifyDashPrimeLib.distModelsProductUnderscoreCollectionMod.CustomCollection] = js.native
  /**
  ...
  ): stdLib.Promise[shopifyDashPrimeLib.distModelsProductUnderscoreCollectionMod.CustomCollection] = js.native
}
