...
class Shops protected ()
  ...
  /**
       ...
       */
  def forceUninstallApp(): stdLib.Promise[scala.Unit] = js.native
  /**
       * Returns shop data for the shop.
       * @param options Options for filtering the result.
       */
  def get(): stdLib.Promise[shopifyDashPrimeLib.distModelsShopMod.Shop] = js.native
  /**
       * Returns shop data for the shop.
       * @param options Options for filtering the result.
       */
  def get(options: shopifyDashPrimeLib.distOptionsBaseMod.FieldOptions): stdLib.Promise[shopifyDashPrimeLib.distModelsShopMod.Shop] = js.native
}
