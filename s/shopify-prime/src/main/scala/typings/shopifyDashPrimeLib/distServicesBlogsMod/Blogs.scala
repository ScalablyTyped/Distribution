...
class Blogs protected ()
  ...
  /**
       ...
       */
  def create(blog: shopifyDashPrimeLib.distModelsBlogMod.Blog): stdLib.Promise[shopifyDashPrimeLib.distModelsBlogMod.Blog] = js.native
  /**
  ...
  /**
       ...
       */
  def get(id: scala.Double): stdLib.Promise[shopifyDashPrimeLib.distModelsBlogMod.Blog] = js.native
  /**
       * Gets a blog with the given id.
       * @param id Id of the blog to retrieve.
       * @param options Options for filtering the result.
       */
  def get(id: scala.Double, options: shopifyDashPrimeLib.distOptionsBaseMod.FieldOptions): stdLib.Promise[shopifyDashPrimeLib.distModelsBlogMod.Blog] = js.native
  /**
       * Gets a list of all blogs on the shop.
       * @param options Options for filtering the results.
       */
  def list(): stdLib.Promise[js.Array[shopifyDashPrimeLib.distModelsBlogMod.Blog]] = js.native
  /**
       * Gets a list of all blogs on the shop.
       * @param options Options for filtering the results.
       */
  ...
  ): stdLib.Promise[js.Array[shopifyDashPrimeLib.distModelsBlogMod.Blog]] = js.native
  /**
       * Updates the blog with the given id.
       * @param id Id of the blog being updated.
       * @param blog The updated blog.
       */
  def update(id: scala.Double, blog: shopifyDashPrimeLib.distModelsBlogMod.Blog): stdLib.Promise[shopifyDashPrimeLib.distModelsBlogMod.Blog] = js.native
}
