...
@JSImport("shopify-prime/dist/tests/price_rules", JSImport.Namespace)
@js.native
object testsPriceRulesMod extends js.Object {
  @js.native
  class OrderTests () extends js.Object {
    var created: js.Any = js.native
    var createdDiscounts: js.Any = js.native
    var discountService: js.Any = js.native
    ...
    /* private */ def createDiscountCode(ruleId: js.Any): js.Any = js.native
