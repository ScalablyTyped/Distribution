...
import typings.shopifyDashPrime.distServicesCustomUnderscoreCollectionsMod.CustomCollections
...
@js.native
object distServicesCustomUnderscoreCollectionsMod extends js.Object {
  @js.native
