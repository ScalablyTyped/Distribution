...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'beforeChange'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
trait PickImplbeforeChangeParti
  extends StObject
     with Param {
...
object PickImplbeforeChangeParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplbeforeChangeParti] (val x: Self) extends AnyVal {
