...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'silent'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
