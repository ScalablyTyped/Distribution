...
object SpeedTestEvent {
  ...
  inline def DownloadEvent(download: DownloadUploadData, progress: Double, timestamp: js.Date): typings.speedtestNet.mod.DownloadEvent = {
  ...
  inline def LogEvent(level: String, message: String, progress: Double, timestamp: js.Date): typings.speedtestNet.mod.LogEvent = {
  ...
  inline def PingEvent(ping: PingData, progress: Double, timestamp: js.Date): typings.speedtestNet.mod.PingEvent = {
  ...
  inline def TestStartEvent(interface: InterfaceData, isp: String, progress: Double, server: ServerData, timestamp: js.Date): typings.speedtestNet.mod.TestStartEvent = {
  ...
  inline def UploadEvent(progress: Double, timestamp: js.Date, upload: DownloadUploadData): typings.speedtestNet.mod.UploadEvent = {
