...
import typings.semanticUiForm.SemanticUI.Form.PromptSettings.Param
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'contain'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplcontainPartialPic
  extends StObject
     with Param {
...
object PickImplcontainPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplcontainPartialPic] (val x: Self) extends AnyVal {
    ...
    inline def setContainExactlyUndefined: Self = StObject.set(x, "containExactly", js.undefined)
    ...
    inline def setDoesntContainExactlyUndefined: Self = StObject.set(x, "doesntContainExactly", js.undefined)
    ...
    inline def setIsExactlyUndefined: Self = StObject.set(x, "isExactly", js.undefined)
    ...
    inline def setNotExactlyUndefined: Self = StObject.set(x, "notExactly", js.undefined)
