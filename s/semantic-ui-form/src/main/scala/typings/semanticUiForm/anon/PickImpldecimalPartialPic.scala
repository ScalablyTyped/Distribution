...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'decimal'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImpldecimalPartialPic
  extends StObject
     with Param {
...
object PickImpldecimalPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldecimalPartialPic] (val x: Self) extends AnyVal {
