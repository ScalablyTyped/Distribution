...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'containExactly'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplcontainExactlyPar
  extends StObject
     with Param {
