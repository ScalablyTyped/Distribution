...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'url'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
...
object PickImplurlPartialPickImp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplurlPartialPickImp] (val x: Self) extends AnyVal {
