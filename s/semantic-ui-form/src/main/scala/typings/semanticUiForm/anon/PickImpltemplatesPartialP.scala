...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'templates'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
