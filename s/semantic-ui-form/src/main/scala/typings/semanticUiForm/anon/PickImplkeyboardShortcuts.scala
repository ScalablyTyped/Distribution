...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'keyboardShortcuts'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplkeyboardShortcuts
  extends StObject
     with Param {
