...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'onInvalid'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplonInvalidPartialP
  extends StObject
     with Param {
...
object PickImplonInvalidPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonInvalidPartialP] (val x: Self) extends AnyVal {
