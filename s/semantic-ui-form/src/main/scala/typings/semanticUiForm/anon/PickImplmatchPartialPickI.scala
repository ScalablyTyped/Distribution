...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'match'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplmatchPartialPickI
  extends StObject
     with Param {
  ...
  var `match`: String & js.UndefOr[String]
...
object PickImplmatchPartialPickI {
  ...
  inline def apply(`match`: String & js.UndefOr[String]): PickImplmatchPartialPickI = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("match")(`match`.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplmatchPartialPickI]
  }
  
  extension [Self <: PickImplmatchPartialPickI](x: Self) {
    ...
    inline def setMatch(value: String & js.UndefOr[String]): Self = StObject.set(x, "match", value.asInstanceOf[js.Any])
