...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'on'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
...
object PickImplonPartialPickImpl {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonPartialPickImpl] (val x: Self) extends AnyVal {
