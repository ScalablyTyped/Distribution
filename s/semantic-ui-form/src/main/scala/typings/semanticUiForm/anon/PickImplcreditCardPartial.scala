...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'creditCard'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplcreditCardPartial
  extends StObject
     with Param {
