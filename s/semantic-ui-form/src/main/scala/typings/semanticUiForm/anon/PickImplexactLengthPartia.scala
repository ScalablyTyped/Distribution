...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'exactLength'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplexactLengthPartia
  extends StObject
     with Param {
...
object PickImplexactLengthPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplexactLengthPartia] (val x: Self) extends AnyVal {
