...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'onValid'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplonValidPartialPic
  extends StObject
     with Param {
...
object PickImplonValidPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonValidPartialPic] (val x: Self) extends AnyVal {
