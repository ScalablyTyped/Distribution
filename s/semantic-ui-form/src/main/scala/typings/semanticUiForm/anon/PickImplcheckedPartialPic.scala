...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'checked'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
...
object PickImplcheckedPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplcheckedPartialPic] (val x: Self) extends AnyVal {
