...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'transition'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImpltransitionPartial
  extends StObject
     with Param {
