...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'prompt'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
...
object PickImplpromptPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplpromptPartialPick] (val x: Self) extends AnyVal {
