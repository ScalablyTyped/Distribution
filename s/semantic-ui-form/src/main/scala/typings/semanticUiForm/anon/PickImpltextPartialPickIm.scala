...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'text'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImpltextPartialPickIm
  extends StObject
     with Param {
