...
object semanticDashUiDashFormStrings {
  @js.native
  ...
  @js.native
  sealed trait `add field` extends js.Object
  
  @js.native
  sealed trait `add fields` extends js.Object
  
  @js.native
  sealed trait `add prompt` extends js.Object
  
  @js.native
  sealed trait `add rule` extends js.Object
  ...
  @js.native
  sealed trait `get change event` extends js.Object
  
  @js.native
  sealed trait `get field` extends js.Object
  
  @js.native
  sealed trait `get validation` extends js.Object
  
  @js.native
  sealed trait `get value` extends js.Object
  ...
  @js.native
  sealed trait onInvalid extends js.Object
  
  @js.native
  sealed trait onSuccess extends js.Object
  
  @js.native
  sealed trait onValid extends js.Object
  ...
  @js.native
  sealed trait `remove fields` extends js.Object
  
  @js.native
  sealed trait `remove rule` extends js.Object
  
  @js.native
  sealed trait `remove rules` extends js.Object
  
  @js.native
  sealed trait revalidate extends js.Object
  ...
  @js.native
  sealed trait `set value` extends js.Object
  
  @js.native
  sealed trait `set values` extends js.Object
  ...
  @scala.inline
  def onInvalid: onInvalid = "onInvalid".asInstanceOf[onInvalid]
  @scala.inline
  def onSuccess: onSuccess = "onSuccess".asInstanceOf[onSuccess]
  @scala.inline
  def onValid: onValid = "onValid".asInstanceOf[onValid]
  @scala.inline
