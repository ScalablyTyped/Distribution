...
trait Form extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashFormLib.semanticDashUiDashFormLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-form.SemanticUI.FormSettings._Impl[K] */ js.Any = js.native
