...
object Options {
  ...
  def apply(
    ...
    requestValidationFn: (/* req */ expressLib.expressMod.eNs.Request, /* data */ js.Any, /* errors */ js.Any) => scala.Unit = null,
    responseValidationFn: (/* req */ expressLib.expressMod.eNs.Request, /* data */ js.Any, /* errors */ js.Any) => scala.Unit = null,
