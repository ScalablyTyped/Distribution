...
object Options {
  ...
  def apply(
    ...
    if (ignoreFile != null) __obj.updateDynamic("ignoreFile")(ignoreFile)
    if (release != null) __obj.updateDynamic("release")(release)
    if (!js.isUndefined(rewrite)) __obj.updateDynamic("rewrite")(rewrite)
    if (setCommits != null) __obj.updateDynamic("setCommits")(setCommits)
    if (!js.isUndefined(silent)) __obj.updateDynamic("silent")(silent)
    if (!js.isUndefined(sourceMapReference)) __obj.updateDynamic("sourceMapReference")(sourceMapReference)
    if (!js.isUndefined(stripCommonPrefix)) __obj.updateDynamic("stripCommonPrefix")(stripCommonPrefix)
