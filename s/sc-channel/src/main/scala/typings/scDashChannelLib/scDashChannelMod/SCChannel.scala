...
class SCChannel protected ()
  ...
  def this(name: java.lang.String, client: scDashBrokerDashClusterLib.scDashBrokerDashClusterMod.SCExchange) = this()
  def this(name: java.lang.String, client: scDashBrokerDashClusterLib.scDashBrokerDashClusterMod.SCExchange, options: SCChannelOptions) = this()
  ...
  def publish(data: js.Any, callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error], scala.Unit]): scala.Unit = js.native
  ...
  def unwatch(handler: scDashBrokerDashClusterLib.scDashBrokerDashClusterMod.handlerFunction): scala.Unit = js.native
  def watch(handler: scDashBrokerDashClusterLib.scDashBrokerDashClusterMod.handlerFunction): scala.Unit = js.native
  def watchers(): js.Array[scDashBrokerDashClusterLib.scDashBrokerDashClusterMod.handlerFunction] = js.native
}
