...
object srcCoreSauronMod {
  ...
  type SauronComponentMap = StringDictionary[
    TypeofComponent & (Instantiable1[/* params */ ComponentParameters, typings.sauronjs.srcCoreComponentMod.^])
  ]
  ...
  trait SauronInstance extends StObject {
    ...
    def service(Service: Instantiable1[/* options */ Any, typings.sauronjs.srcCoreServiceMod.^]): SauronInstance = js.native
    def service(Service: Instantiable1[/* options */ Any, typings.sauronjs.srcCoreServiceMod.^], options: Any): SauronInstance = js.native
  }
}
