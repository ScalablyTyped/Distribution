...
class TransactionV1Envelope protected ()
  extends typings.stellarBase.mod.xdr.TransactionV1Envelope {
  def this(attributes: Tx) = this()
}
object TransactionV1Envelope {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.TransactionV1Envelope.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.TransactionV1Envelope.write")
  @js.native
