...
@JSImport("stellar-sdk", "xdr.TransactionResultCode")
@js.native
class TransactionResultCode ()
  extends typings.stellarBase.mod.xdr.TransactionResultCode
/* static members */
@JSImport("stellar-sdk", "xdr.TransactionResultCode")
@js.native
object TransactionResultCode extends js.Object {
  ...
  def txBadSponsorship(): typings.stellarBase.xdrMod.xdr.TransactionResultCode = js.native
