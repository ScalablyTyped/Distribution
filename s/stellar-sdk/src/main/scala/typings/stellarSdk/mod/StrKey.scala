...
object StrKey {
  ...
  @JSImport("stellar-sdk", "StrKey.decodeEd25519PublicKey")
  @js.native
  def decodeEd25519PublicKey(data: String): Buffer = js.native
  
  @JSImport("stellar-sdk", "StrKey.decodeEd25519SecretSeed")
  @js.native
  def decodeEd25519SecretSeed(data: String): Buffer = js.native
  
  @JSImport("stellar-sdk", "StrKey.decodePreAuthTx")
  @js.native
  def decodePreAuthTx(data: String): Buffer = js.native
  
  @JSImport("stellar-sdk", "StrKey.decodeSha256Hash")
  @js.native
  def decodeSha256Hash(data: String): Buffer = js.native
  
  @JSImport("stellar-sdk", "StrKey.encodeEd25519PublicKey")
  @js.native
  def encodeEd25519PublicKey(data: Buffer): String = js.native
  
  @JSImport("stellar-sdk", "StrKey.encodeEd25519SecretSeed")
  @js.native
  def encodeEd25519SecretSeed(data: Buffer): String = js.native
  
  @JSImport("stellar-sdk", "StrKey.encodePreAuthTx")
  @js.native
  def encodePreAuthTx(data: Buffer): String = js.native
  
  @JSImport("stellar-sdk", "StrKey.encodeSha256Hash")
  @js.native
  def encodeSha256Hash(data: Buffer): String = js.native
  
  @JSImport("stellar-sdk", "StrKey.isValidEd25519PublicKey")
  @js.native
  def isValidEd25519PublicKey(Key: String): Boolean = js.native
  
  @JSImport("stellar-sdk", "StrKey.isValidEd25519SecretSeed")
  @js.native
