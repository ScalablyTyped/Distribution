...
@JSImport("stellar-sdk", "xdr.DataEntryExt")
@js.native
class DataEntryExt ()
  extends typings.stellarBase.mod.xdr.DataEntryExt
object DataEntryExt {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.DataEntryExt.fromXDR")
  @js.native
