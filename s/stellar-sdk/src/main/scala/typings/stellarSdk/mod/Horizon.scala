...
object Horizon extends js.Object {
  ...
  object OperationResponseTypeI extends js.Object {
    ...
    /* 16 */ val beginSponsoringFutureReserves: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.beginSponsoringFutureReserves with Double = js.native
    ...
    /* 15 */ val claimClaimableBalance: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.claimClaimableBalance with Double = js.native
    
    /* 0 */ val createAccount: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.createAccount with Double = js.native
    
    /* 14 */ val createClaimableBalance: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.createClaimableBalance with Double = js.native
    ...
    /* 17 */ val endSponsoringFutureReserves: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.endSponsoringFutureReserves with Double = js.native
    ...
    /* 18 */ val revokeSponsorship: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.revokeSponsorship with Double = js.native
