...
@JSImport("stellar-sdk", "xdr.TransactionHistoryResultEntryExt")
@js.native
class TransactionHistoryResultEntryExt ()
  extends typings.stellarBase.mod.xdr.TransactionHistoryResultEntryExt
object TransactionHistoryResultEntryExt {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.TransactionHistoryResultEntryExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.TransactionHistoryResultEntryExt.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TransactionHistoryResultEntryExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.TransactionHistoryResultEntryExt.0")
  @js.native
