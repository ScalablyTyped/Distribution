...
class ScpStatementPrepare protected ()
  extends typings.stellarBase.mod.xdr.ScpStatementPrepare {
  def this(attributes: Ballot) = this()
}
object ScpStatementPrepare {
  
  /* static member */
  @JSImport("stellar-sdk", "xdr.ScpStatementPrepare.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-sdk", "xdr.ScpStatementPrepare.write")
  @js.native
