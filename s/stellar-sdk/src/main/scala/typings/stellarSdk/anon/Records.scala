...
object Records {
  ...
  @scala.inline
  implicit class RecordsOps[Self <: Records[_], /* <: typings.stellarSdk.horizonApiMod.Horizon.BaseResponse[scala.Nothing] */ T] (val x: Self with Records[T]) extends AnyVal {
    @scala.inline
