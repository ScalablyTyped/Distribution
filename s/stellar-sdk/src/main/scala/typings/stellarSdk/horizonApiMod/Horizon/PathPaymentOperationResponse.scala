...
object PathPaymentOperationResponse {
  ...
  @scala.inline
  implicit class PathPaymentOperationResponseMutableBuilder[Self <: PathPaymentOperationResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSource_max(value: String): Self = StObject.set(x, "source_max", value.asInstanceOf[js.Any])
