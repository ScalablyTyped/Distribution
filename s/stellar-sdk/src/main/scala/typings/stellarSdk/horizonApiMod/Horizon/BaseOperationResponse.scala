...
object BaseOperationResponse {
  ...
  @scala.inline
  implicit class BaseOperationResponseOps[Self <: BaseOperationResponse[_, _], /* <: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseType */ T, /* <: typings.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI */ TI] (val x: Self with (BaseOperationResponse[T, TI])) extends AnyVal {
    @scala.inline
