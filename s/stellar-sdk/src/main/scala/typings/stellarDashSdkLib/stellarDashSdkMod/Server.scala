...
class Server protected () extends js.Object {
  ...
  ): stellarDashSdkLib.stellarDashSdkMod.ServerNs.OrderbookCallBuilder = js.native
  def paths(
    source: java.lang.String,
    destination: java.lang.String,
    destinationAsset: stellarDashBaseLib.stellarDashBaseMod.Asset,
  ...
  def submitTransaction(
    transaction: stellarDashBaseLib.stellarDashBaseMod.Transaction[
      stellarDashBaseLib.stellarDashBaseMod.Memo[stellarDashBaseLib.stellarDashBaseMod.MemoType], 
      js.Array[stellarDashBaseLib.stellarDashBaseMod.Operation]
    ]
  ): js.Promise[stellarDashSdkLib.stellarDashSdkMod.ServerNs.TransactionRecord] = js.native
  def tradeAggregation(
    ...
    endTime: stdLib.Date,
    resolution: stdLib.Date
  ): stellarDashSdkLib.stellarDashSdkMod.ServerNs.TradeAggregationCallBuilder = js.native
