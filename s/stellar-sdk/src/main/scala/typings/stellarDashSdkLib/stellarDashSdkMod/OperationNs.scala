...
object OperationNs extends js.Object {
  ...
  def fromXDRObject[T /* <: stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.Operation[stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationType] */](xdrOperation: stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.xdrNs.Operation[T]): T = js.native
  def inflation(options: stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.InflationOptions): stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.xdrNs.Operation[stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.Inflation] = js.native
  ...
  def setOptions[T /* <: stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.SignerUnion */](options: stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.SetOptionsOptions[T]): stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.xdrNs.Operation[stellarDashSdkLib.stellarDashSdkMod.StellarBaseNs.OperationNs.SetOptions[T]] = js.native
  /*
    * Required = 1 << 0
    * Revocable = 1 << 1
    * Immutable = 1 << 2
