...
class AccountResponse protected () extends AccountRecord {
  ...
  /* CompleteClass */
  override var _links: ScalablyTyped.runtime.StringDictionary[RecordLink] = js.native
  @JSName("_links")
  var _links_AccountResponse: ScalablyTyped.runtime.StringDictionary[stellarDashSdkLib.Anon_Href] = js.native
