...
trait SetOptionsOperationResponse
  extends BaseOperationResponse[
      setOptions, 
      typings.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.setOptions
    ] {
...
object SetOptionsOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typings.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    `type`: setOptions,
    type_i: typings.stellarDashSdk.libHorizonUnderscoreApiMod.Horizon.OperationResponseTypeI.setOptions,
    ...
    val __obj = js.Dynamic.literal(_links = _links, clear_flags = clear_flags, clear_flags_s = clear_flags_s, created_at = created_at, id = id, paging_token = paging_token, set_flags = set_flags, set_flags_s = set_flags_s, source_account = source_account, transaction_hash = transaction_hash, type_i = type_i)
    ...
    if (signer_key != null) __obj.updateDynamic("signer_key")(signer_key)
