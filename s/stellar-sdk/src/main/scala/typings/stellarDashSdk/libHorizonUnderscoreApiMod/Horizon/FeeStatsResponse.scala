...
object FeeStatsResponse {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(last_ledger = last_ledger, last_ledger_base_fee = last_ledger_base_fee, ledger_capacity_usage = ledger_capacity_usage, min_accepted_fee = min_accepted_fee, mode_accepted_fee = mode_accepted_fee, p10_accepted_fee = p10_accepted_fee, p20_accepted_fee = p20_accepted_fee, p30_accepted_fee = p30_accepted_fee, p40_accepted_fee = p40_accepted_fee, p50_accepted_fee = p50_accepted_fee, p60_accepted_fee = p60_accepted_fee, p70_accepted_fee = p70_accepted_fee, p80_accepted_fee = p80_accepted_fee, p90_accepted_fee = p90_accepted_fee, p95_accepted_fee = p95_accepted_fee, p99_accepted_fee = p99_accepted_fee)
