...
import typings.stellarDashSdk.stellarDashSdkMod.Horizon.OperationResponseType.payment
...
trait PaymentOperationResponse
  extends BaseOperationResponse[
      payment, 
      typings.stellarDashSdk.stellarDashSdkMod.Horizon.OperationResponseTypeI.payment
    ] {
  var amount: String
...
object PaymentOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk.Horizon.ResponseLink}
    */ typings.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    `type`: payment,
    type_i: typings.stellarDashSdk.stellarDashSdkMod.Horizon.OperationResponseTypeI.payment,
