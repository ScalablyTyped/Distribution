...
import typings.stellarDashSdk.stellarDashSdkMod.Horizon.OperationResponseType.setOptions
...
- typings.stellarDashSdk.stellarDashSdkMod.Horizon.SetOptionsOperationResponse because var conflicts: _links, created_at, id, paging_token, source_account, transaction_hash, `type`, type_i. Inlined signer_key, signer_weight, master_key_weight, low_threshold, med_threshold, high_threshold, home_domain, set_flags, set_flags_s, clear_flags, clear_flags_s */ @js.native
trait SetOptionsOperationRecord
  extends BaseOperationRecord[
      setOptions, 
      typings.stellarDashSdk.stellarDashSdkMod.Horizon.OperationResponseTypeI.setOptions
    ]
