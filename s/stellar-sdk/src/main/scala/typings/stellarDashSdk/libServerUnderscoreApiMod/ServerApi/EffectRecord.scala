...
object EffectRecord {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typings.stellarDashSdk.stellarDashSdkStrings.BaseResponse with js.Any,
    ...
    val __obj = js.Dynamic.literal(_links = _links, account = account, created_at = created_at, id = id, paging_token = paging_token, type_i = type_i)
    ...
    if (asset_type != null) __obj.updateDynamic("asset_type")(asset_type)
    if (!js.isUndefined(auth_required_flag)) __obj.updateDynamic("auth_required_flag")(auth_required_flag)
    if (!js.isUndefined(auth_revokable_flag)) __obj.updateDynamic("auth_revokable_flag")(auth_revokable_flag)
    if (bought_amount != null) __obj.updateDynamic("bought_amount")(bought_amount)
    if (bought_asset_code != null) __obj.updateDynamic("bought_asset_code")(bought_asset_code)
    if (bought_asset_issuer != null) __obj.updateDynamic("bought_asset_issuer")(bought_asset_issuer)
    if (bought_asset_type != null) __obj.updateDynamic("bought_asset_type")(bought_asset_type)
    if (high_threshold != null) __obj.updateDynamic("high_threshold")(high_threshold.asInstanceOf[js.Any])
    if (home_domain != null) __obj.updateDynamic("home_domain")(home_domain)
    ...
    if (sold_amount != null) __obj.updateDynamic("sold_amount")(sold_amount)
    if (sold_asset_code != null) __obj.updateDynamic("sold_asset_code")(sold_asset_code)
    if (sold_asset_issuer != null) __obj.updateDynamic("sold_asset_issuer")(sold_asset_issuer)
    if (sold_asset_type != null) __obj.updateDynamic("sold_asset_type")(sold_asset_type)
    if (starting_balance != null) __obj.updateDynamic("starting_balance")(starting_balance)
    if (succeeds != null) __obj.updateDynamic("succeeds")(js.Any.fromFunction0(succeeds))
    if (trustor != null) __obj.updateDynamic("trustor")(trustor)
