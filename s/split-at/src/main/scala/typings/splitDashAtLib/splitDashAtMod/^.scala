...
object ^ extends js.Object {
  ...
  ```
  */
  def apply(string: java.lang.String, index: scala.Double | js.Array[scala.Double]): js.Array[java.lang.String] = js.native
  def apply(string: java.lang.String, index: scala.Double | js.Array[scala.Double], options: Options): js.Array[java.lang.String] = js.native
}
