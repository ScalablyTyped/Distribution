...
/* Inlined @sentry/replay.@sentry/replay/types/types.ReplayNetworkOptions & {  textEncoder :@sentry/types.@sentry/types.TextEncoderInternal,   replay :@sentry/replay.@sentry/replay/types/types.ReplayContainer} */
trait ReplayNetworkOptionstextE extends StObject {
...
object ReplayNetworkOptionstextE {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ReplayNetworkOptionstextE]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReplayNetworkOptionstextE] (val x: Self) extends AnyVal {
