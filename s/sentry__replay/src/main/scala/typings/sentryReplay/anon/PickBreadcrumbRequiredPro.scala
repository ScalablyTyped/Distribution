...
/* Inlined std.Pick<@sentry/types.@sentry/types.Breadcrumb, @sentry/replay.@sentry/replay/types/util/createBreadcrumb.RequiredProperties> & std.Partial<std.Omit<@sentry/types.@sentry/types.Breadcrumb, @sentry/replay.@sentry/replay/types/util/createBreadcrumb.RequiredProperties>> */
trait PickBreadcrumbRequiredPro extends StObject {
...
object PickBreadcrumbRequiredPro {
  
  inline def apply(): PickBreadcrumbRequiredPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickBreadcrumbRequiredPro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickBreadcrumbRequiredPro] (val x: Self) extends AnyVal {
