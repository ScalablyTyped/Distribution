...
/* Inlined @sentry/types.@sentry/types.Breadcrumb & {  data :@sentry/types.@sentry/types.XhrBreadcrumbData} */
trait BreadcrumbdataXhrBreadcru extends StObject {
...
object BreadcrumbdataXhrBreadcru {
  
  inline def apply(): BreadcrumbdataXhrBreadcru = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BreadcrumbdataXhrBreadcru]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BreadcrumbdataXhrBreadcru] (val x: Self) extends AnyVal {
