...
/* Inlined @sentry/replay.@sentry/replay/types/types.ReplayNetworkOptions & {  replay :@sentry/replay.@sentry/replay/types/types.ReplayContainer} */
trait ReplayNetworkOptionsrepla extends StObject {
...
object ReplayNetworkOptionsrepla {
  ...
  ): ReplayNetworkOptionsrepla = {
    val __obj = js.Dynamic.literal(networkCaptureBodies = networkCaptureBodies.asInstanceOf[js.Any], networkDetailAllowUrls = networkDetailAllowUrls.asInstanceOf[js.Any], networkRequestHeaders = networkRequestHeaders.asInstanceOf[js.Any], networkResponseHeaders = networkResponseHeaders.asInstanceOf[js.Any], replay = replay.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReplayNetworkOptionsrepla]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReplayNetworkOptionsrepla] (val x: Self) extends AnyVal {
