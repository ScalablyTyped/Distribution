...
/* Inlined parent @sentry/replay.@sentry/replay/types/types.ReplayIntegrationPrivacyOptions */
/* Inlined parent @sentry/replay.@sentry/replay/types/types.OptionalReplayPluginOptions */
/* Inlined parent @sentry/replay.@sentry/replay/types/types.DeprecatedPrivacyOptions */
/* Inlined parent std.Pick<@sentry/replay.@sentry/replay/types/types.RecordingOptions, 'maskAllText' | 'maskAllInputs'> */
