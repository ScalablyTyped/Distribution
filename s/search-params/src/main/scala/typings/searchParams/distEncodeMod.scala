...
object distEncodeMod {
  ...
  trait IFinalOptions extends StObject {
    ...
    var arrayFormat: typings.searchParams.distEncodeMod.arrayFormat
    
    var booleanFormat: typings.searchParams.distEncodeMod.booleanFormat
    
    var nullFormat: typings.searchParams.distEncodeMod.nullFormat
  }
  ...
  trait IOptions extends StObject {
    ...
    var arrayFormat: js.UndefOr[typings.searchParams.distEncodeMod.arrayFormat] = js.undefined
    
    var booleanFormat: js.UndefOr[typings.searchParams.distEncodeMod.booleanFormat] = js.undefined
    
    var nullFormat: js.UndefOr[typings.searchParams.distEncodeMod.nullFormat] = js.undefined
  }
  object IOptions {
