...
trait Anon_Disputeexplanation extends js.Object {
  /**
...
object Anon_Disputeexplanation {
  @scala.inline
  def apply(dispute_explanation: String, uncategorized_file: String): Anon_Disputeexplanation = {
    ...
    __obj.asInstanceOf[Anon_Disputeexplanation]
  }
}
