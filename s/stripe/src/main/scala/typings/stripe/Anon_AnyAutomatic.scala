...
trait Anon_AnyAutomatic extends js.Object {
  /**
...
object Anon_AnyAutomatic {
  @scala.inline
  def apply(request_three_d_secure: automatic | any = null): Anon_AnyAutomatic = {
    ...
    __obj.asInstanceOf[Anon_AnyAutomatic]
  }
}
