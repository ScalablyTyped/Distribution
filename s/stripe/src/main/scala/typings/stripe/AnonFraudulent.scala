...
trait AnonFraudulent extends js.Object {
  /**
...
object AnonFraudulent {
  @scala.inline
  def apply(stripe_report: fraudulent = null, user_report: fraudulent | safe = null): AnonFraudulent = {
    ...
    __obj.asInstanceOf[AnonFraudulent]
  }
}
