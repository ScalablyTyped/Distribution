...
trait AnonAccountnumberBankname extends js.Object {
...
object AnonAccountnumberBankname {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAccountnumberBankname]
  }
}
