...
object IDisputeEvidence {
  ...
  def apply(
    ...
    if (access_activity_log != null) __obj.updateDynamic("access_activity_log")(access_activity_log.asInstanceOf[js.Any])
    if (billing_address != null) __obj.updateDynamic("billing_address")(billing_address.asInstanceOf[js.Any])
    if (cancellation_policy != null) __obj.updateDynamic("cancellation_policy")(cancellation_policy.asInstanceOf[js.Any])
    if (cancellation_policy_disclosure != null) __obj.updateDynamic("cancellation_policy_disclosure")(cancellation_policy_disclosure.asInstanceOf[js.Any])
    if (cancellation_rebuttal != null) __obj.updateDynamic("cancellation_rebuttal")(cancellation_rebuttal.asInstanceOf[js.Any])
    if (customer_communication != null) __obj.updateDynamic("customer_communication")(customer_communication.asInstanceOf[js.Any])
    if (customer_email_address != null) __obj.updateDynamic("customer_email_address")(customer_email_address.asInstanceOf[js.Any])
    if (customer_name != null) __obj.updateDynamic("customer_name")(customer_name.asInstanceOf[js.Any])
    if (customer_purchase_ip != null) __obj.updateDynamic("customer_purchase_ip")(customer_purchase_ip.asInstanceOf[js.Any])
    if (customer_signature != null) __obj.updateDynamic("customer_signature")(customer_signature.asInstanceOf[js.Any])
    if (duplicate_charge_documentation != null) __obj.updateDynamic("duplicate_charge_documentation")(duplicate_charge_documentation.asInstanceOf[js.Any])
    if (duplicate_charge_explanation != null) __obj.updateDynamic("duplicate_charge_explanation")(duplicate_charge_explanation.asInstanceOf[js.Any])
    if (duplicate_charge_id != null) __obj.updateDynamic("duplicate_charge_id")(duplicate_charge_id.asInstanceOf[js.Any])
    ...
    if (refund_policy != null) __obj.updateDynamic("refund_policy")(refund_policy.asInstanceOf[js.Any])
    if (refund_policy_disclosure != null) __obj.updateDynamic("refund_policy_disclosure")(refund_policy_disclosure.asInstanceOf[js.Any])
    if (refund_refusal_explanation != null) __obj.updateDynamic("refund_refusal_explanation")(refund_refusal_explanation.asInstanceOf[js.Any])
    if (service_date != null) __obj.updateDynamic("service_date")(service_date.asInstanceOf[js.Any])
    if (service_documentation != null) __obj.updateDynamic("service_documentation")(service_documentation.asInstanceOf[js.Any])
    if (shipping_address != null) __obj.updateDynamic("shipping_address")(shipping_address.asInstanceOf[js.Any])
    if (shipping_carrier != null) __obj.updateDynamic("shipping_carrier")(shipping_carrier.asInstanceOf[js.Any])
    if (shipping_date != null) __obj.updateDynamic("shipping_date")(shipping_date.asInstanceOf[js.Any])
    if (shipping_documentation != null) __obj.updateDynamic("shipping_documentation")(shipping_documentation.asInstanceOf[js.Any])
    if (shipping_tracking_number != null) __obj.updateDynamic("shipping_tracking_number")(shipping_tracking_number.asInstanceOf[js.Any])
    if (uncategorized_file != null) __obj.updateDynamic("uncategorized_file")(uncategorized_file.asInstanceOf[js.Any])
    if (uncategorized_text != null) __obj.updateDynamic("uncategorized_text")(uncategorized_text.asInstanceOf[js.Any])
