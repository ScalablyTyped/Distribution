...
object IPaymentIntentSessionSubset {
  ...
  inline def apply(): IPaymentIntentSessionSubset = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IPaymentIntentSessionSubset]
  }
  
  extension [Self <: IPaymentIntentSessionSubset](x: Self) {
    ...
    inline def setCapture_method(value: PaymentIntentDataCaptureMethodOptions): Self = StObject.set(x, "capture_method", value.asInstanceOf[js.Any])
    ...
    inline def setSetup_future_usage(value: PaymentIntendDataFutureUsageOptions): Self = StObject.set(x, "setup_future_usage", value.asInstanceOf[js.Any])
    
    inline def setSetup_future_usageUndefined: Self = StObject.set(x, "setup_future_usage", js.undefined)
    
    inline def setShipping(value: IPaymentIntentDataShipping): Self = StObject.set(x, "shipping", value.asInstanceOf[js.Any])
    
    inline def setShippingUndefined: Self = StObject.set(x, "shipping", js.undefined)
    
    inline def setTransfer_data(value: IPaymentIntentDataTransferDataOptions): Self = StObject.set(x, "transfer_data", value.asInstanceOf[js.Any])
