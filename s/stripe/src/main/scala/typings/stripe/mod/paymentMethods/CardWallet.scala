...
object CardWallet {
  ...
  inline def AmericanExpressWallet(): typings.stripe.mod.paymentMethods.AmericanExpressWallet = {
  ...
  inline def ApplePayWallet(): typings.stripe.mod.paymentMethods.ApplePayWallet = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("apple_pay")
    __obj.asInstanceOf[typings.stripe.mod.paymentMethods.ApplePayWallet]
  }
  
  inline def GooglePayWallet(): typings.stripe.mod.paymentMethods.GooglePayWallet = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("google_pay")
    __obj.asInstanceOf[typings.stripe.mod.paymentMethods.GooglePayWallet]
  }
  
  inline def MasterpassWallet(masterpass: WalletData): typings.stripe.mod.paymentMethods.MasterpassWallet = {
  ...
  inline def SamsungPayWallet(): typings.stripe.mod.paymentMethods.SamsungPayWallet = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("samsung_pay")
    __obj.asInstanceOf[typings.stripe.mod.paymentMethods.SamsungPayWallet]
  }
  
  inline def VisaCheckoutWallet(visa_checkout: WalletData): typings.stripe.mod.paymentMethods.VisaCheckoutWallet = {
