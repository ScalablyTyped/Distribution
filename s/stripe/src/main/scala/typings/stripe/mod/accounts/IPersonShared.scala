...
object IPersonShared {
  ...
  inline def apply(): IPersonShared = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IPersonShared]
  }
  
  extension [Self <: IPersonShared](x: Self) {
    ...
    inline def setRelationship(value: Director): Self = StObject.set(x, "relationship", value.asInstanceOf[js.Any])
