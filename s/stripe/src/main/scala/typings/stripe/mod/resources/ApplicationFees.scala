...
class ApplicationFees () extends StripeResource {
  ...
  def updateRefund(feeId: String, refundId: String, data: AnonMetadata): js.Promise[IApplicationFeeRefund] = js.native
  /**
    ...
    */
  def updateRefund(feeId: String, refundId: String, data: AnonMetadata, options: HeaderOptions): js.Promise[IApplicationFeeRefund] = js.native
  def updateRefund(
    feeId: String,
    refundId: String,
    data: AnonMetadata,
  ...
  def updateRefund(feeId: String, refundId: String, data: AnonMetadata, response: IResponseFn[IApplicationFeeRefund]): js.Promise[IApplicationFeeRefund] = js.native
}
