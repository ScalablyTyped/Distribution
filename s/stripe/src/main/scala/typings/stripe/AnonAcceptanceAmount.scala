...
trait AnonAcceptanceAmount extends js.Object {
  var acceptance: js.UndefOr[AnonAcceptedDate] = js.undefined
...
object AnonAcceptanceAmount {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AnonAcceptanceAmount]
  }
}
