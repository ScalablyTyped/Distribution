...
trait AnonFraudulentSafe extends js.Object {
  /**
...
object AnonFraudulentSafe {
  @scala.inline
  def apply(user_report: fraudulent | safe = null): AnonFraudulentSafe = {
    val __obj = js.Dynamic.literal()
    if (user_report != null) __obj.updateDynamic("user_report")(user_report.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonFraudulentSafe]
  }
}
