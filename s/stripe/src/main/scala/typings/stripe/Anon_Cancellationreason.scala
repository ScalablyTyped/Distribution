...
trait Anon_Cancellationreason extends js.Object {
  var cancellation_reason: js.UndefOr[PaymentIntentCancellationReason] = js.undefined
}

object Anon_Cancellationreason {
  @scala.inline
  def apply(cancellation_reason: PaymentIntentCancellationReason = null): Anon_Cancellationreason = {
