...
object IInvoiceListUpcomingLineItemsOptions {
  ...
  def apply(
    ...
    if (invoice_items != null) __obj.updateDynamic("invoice_items")(invoice_items)
    ...
    if (!js.isUndefined(subscription_cancel_at)) __obj.updateDynamic("subscription_cancel_at")(subscription_cancel_at)
    ...
    if (!js.isUndefined(subscription_cancel_now)) __obj.updateDynamic("subscription_cancel_now")(subscription_cancel_now)
    ...
    if (!js.isUndefined(subscription_trial_from_plan)) __obj.updateDynamic("subscription_trial_from_plan")(subscription_trial_from_plan)
