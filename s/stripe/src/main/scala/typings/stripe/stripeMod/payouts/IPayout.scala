...
trait IPayout extends IResourceObject {
  ...
  /**
    ...
    */
  var destination: String | typings.stripe.stripeMod.bankAccounts.IBankAccount | ICardHash
  /**
...
object IPayout {
  ...
  def apply(
    ...
    currency: String,
    description: String,
    destination: String | typings.stripe.stripeMod.bankAccounts.IBankAccount | ICardHash,
