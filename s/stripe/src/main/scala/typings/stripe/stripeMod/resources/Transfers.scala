...
import typings.stripe.stripeMod.transfers.ITransferCreationOptions
import typings.stripe.stripeMod.transfers.ITransferListOptions
import typings.stripe.stripeMod.transfers.ITransferUpdateOptions
