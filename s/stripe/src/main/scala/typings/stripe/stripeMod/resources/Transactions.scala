...
import typings.stripe.stripeMod.issuing.transactions.ITransactionListOptions
import typings.stripe.stripeMod.issuing.transactions.ITransactionUpdateOptions
