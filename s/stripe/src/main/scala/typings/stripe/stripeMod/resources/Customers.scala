...
import typings.stripe.stripeMod.bankAccounts.IBankAccountUpdateOptions
import typings.stripe.stripeMod.bankAccounts.IBankAccountVerifyOptions
import typings.stripe.stripeMod.cards.ICardUpdateOptions
import typings.stripe.stripeMod.customerBalanceTransactions.ICustomerBalanceTransaction
import typings.stripe.stripeMod.customerBalanceTransactions.ICustomerBalanceTransactionCreationOptions
import typings.stripe.stripeMod.customerBalanceTransactions.ICustomerBalanceTransactionUpdateOptions
...
import typings.stripe.stripeMod.customers.IBankAccountSourceListOptions
import typings.stripe.stripeMod.customers.ICardSourceListOptions
import typings.stripe.stripeMod.customers.ICustomer
import typings.stripe.stripeMod.customers.ICustomerBankAccountSourceCreationOptions
import typings.stripe.stripeMod.customers.ICustomerCardSourceCreationOptions
import typings.stripe.stripeMod.customers.ICustomerCreationOptions
import typings.stripe.stripeMod.customers.ICustomerListOptions
import typings.stripe.stripeMod.customers.ICustomerSourceCreationOptions
import typings.stripe.stripeMod.customers.ICustomerUpdateOptions
import typings.stripe.stripeMod.customers.ISourceListOptions
import typings.stripe.stripeMod.subscriptions.ISubscription
import typings.stripe.stripeMod.subscriptions.ISubscriptionCancellationOptions
import typings.stripe.stripeMod.subscriptions.ISubscriptionCustCreationOptions
import typings.stripe.stripeMod.subscriptions.ISubscriptionUpdateOptions
...
class Customers () extends StripeResource {
  ...
  /**
    ...
    */
  def createSource(customerId: String, data: ICustomerBankAccountSourceCreationOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  def createSource(
    customerId: String,
  ...
  def createSource(customerId: String, data: ICustomerCardSourceCreationOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    * @param customerId The customer ID to which to add the card.
    */
  def createSource(customerId: String, data: ICustomerCardSourceCreationOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  def createSource(
    customerId: String,
  ...
  def listCards(customerId: String): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listCards(customerId: String, data: IListOptions): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    */
  def listCards(customerId: String, data: IListOptions, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listCards(
    customerId: String,
    data: IListOptions,
    options: HeaderOptions,
  ...
  def listCards(customerId: String, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listCards(
    customerId: String,
    options: HeaderOptions,
    response: IResponseFn[IList[typings.stripe.stripeMod.cards.ICard]]
  ): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listCards(customerId: String, response: IResponseFn[IList[typings.stripe.stripeMod.cards.ICard]]): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listSources(customerId: String, data: IBankAccountSourceListOptions): IListPromise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  /**
    ...
    * @param data Filtering options
    */
  def listSources(customerId: String, data: IBankAccountSourceListOptions, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  def listSources(
    customerId: String,
  ...
  def listSources(customerId: String, data: ICardSourceListOptions): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    * You can see a list of the cards belonging to a customer or recipient. Note that the 10 most recent
    * cards are always available by default on the customer or recipient object. If you need more than
    * those 10, you can use this API method and the limit and starting_after parameters to page through
    ...
    * @param data Filtering options
    */
  def listSources(customerId: String, data: ICardSourceListOptions, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.cards.ICard] = js.native
  def listSources(
    customerId: String,
  ...
  def listSources(customerId: String, data: ISourceListOptions): IListPromise[typings.stripe.stripeMod.sources.ISource] = js.native
  def listSources(customerId: String, data: ISourceListOptions, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.sources.ISource] = js.native
  def listSources(
    customerId: String,
    data: ISourceListOptions,
    options: HeaderOptions,
    response: IResponseFn[IList[typings.stripe.stripeMod.sources.ISource]]
  ): IListPromise[typings.stripe.stripeMod.sources.ISource] = js.native
  def listSources(
    customerId: String,
    data: ISourceListOptions,
    response: IResponseFn[IList[typings.stripe.stripeMod.sources.ISource]]
  ...
  def listTaxIds(customerId: String, data: IListOptions): IListPromise[typings.stripe.stripeMod.sources.ISource] = js.native
  def listTaxIds(customerId: String, data: IListOptions, options: HeaderOptions): IListPromise[typings.stripe.stripeMod.sources.ISource] = js.native
  def listTaxIds(
    customerId: String,
    data: IListOptions,
    options: HeaderOptions,
  ...
  def retrieveCard(customerId: String, cardId: String): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    * @param cardId The ID of the card to be retrieved.
    */
  def retrieveCard(customerId: String, cardId: String, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  def retrieveCard(
    customerId: String,
    cardId: String,
    options: HeaderOptions,
  ...
  def retrieveCard(customerId: String, cardId: String, response: IResponseFn[typings.stripe.stripeMod.cards.ICard]): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  ...
  def updateCard(customerId: String, cardId: String, data: ICardUpdateOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    ...
    * @param cardId The ID of the card to be retrieved.
    */
  def updateCard(customerId: String, cardId: String, data: ICardUpdateOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  def updateCard(
    customerId: String,
    cardId: String,
  ...
  def updateSource(customerId: String, sourceId: String, data: IBankAccountUpdateOptions): js.Promise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  /**
    ...
    */
  def updateSource(customerId: String, sourceId: String, data: IBankAccountUpdateOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  def updateSource(
    customerId: String,
    sourceId: String,
  ...
  def updateSource(customerId: String, sourceId: String, data: ICardUpdateOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  /**
    * If you need to update only some card details, like the billing address or expiration date, you can do so without having to re-enter the
    * full card details. Stripe also works directly with card networks so that your customers can continue using your service without
    * interruption. When you update a card, Stripe will automatically validate the card.
    ...
    */
  def updateSource(customerId: String, sourceId: String, data: ICardUpdateOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.cards.ICard] = js.native
  def updateSource(
    customerId: String,
    sourceId: String,
    data: ICardUpdateOptions,
  ...
  def verifySource(customerId: String, sourceId: String, data: IBankAccountVerifyOptions): js.Promise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
  /**
    ...
    */
  def verifySource(customerId: String, sourceId: String, data: IBankAccountVerifyOptions, options: HeaderOptions): js.Promise[typings.stripe.stripeMod.bankAccounts.IBankAccount] = js.native
}
