...
import typings.stripe.stripeMod.bitcoinReceivers.IBitcoinReceiver
import typings.stripe.stripeMod.bitcoinReceivers.IBitcoinReceiverCreationOptions
import typings.stripe.stripeMod.bitcoinReceivers.IBitcoinReceiverListOptions
