...
class CustomerCards () extends StripeResource {
  def create(data: Anon_Card): js.Promise[ICard] = js.native
  /**
    ...
    */
  def create(data: Anon_Card, options: HeaderOptions): js.Promise[ICard] = js.native
  def create(data: Anon_Card, options: HeaderOptions, response: IResponseFn[ICard]): js.Promise[ICard] = js.native
  def create(data: Anon_Card, response: IResponseFn[ICard]): js.Promise[ICard] = js.native
