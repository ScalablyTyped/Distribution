...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.DeletedTaxId> */
trait ResponseDeletedTaxId extends StObject {
...
object ResponseDeletedTaxId {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedTaxId = {
    ...
    __obj.asInstanceOf[ResponseDeletedTaxId]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedTaxId] (val x: Self) extends AnyVal {
