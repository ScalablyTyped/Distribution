...
object StripeRawErrortypeapierro {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypeapierro = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeapierro] (val x: Self) extends AnyVal {
