...
object StripeRawErrortyperatelim {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortyperatelim = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortyperatelim] (val x: Self) extends AnyVal {
