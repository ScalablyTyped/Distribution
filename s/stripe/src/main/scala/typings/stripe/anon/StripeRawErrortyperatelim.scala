...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'rate_limit_error'} */
trait StripeRawErrortyperatelim extends StObject {
  ...
  var `type`: RawErrorType & rate_limit_error
}
object StripeRawErrortyperatelim {
  
  inline def apply(`type`: RawErrorType & rate_limit_error): StripeRawErrortyperatelim = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortyperatelim]
  }
  
  extension [Self <: StripeRawErrortyperatelim](x: Self) {
    ...
    inline def setType(value: RawErrorType & rate_limit_error): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
