...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Radar.DeletedValueList> */
trait ResponseDeletedValueList extends StObject {
...
object ResponseDeletedValueList {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedValueList = {
    ...
    __obj.asInstanceOf[ResponseDeletedValueList]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedValueList] (val x: Self) extends AnyVal {
