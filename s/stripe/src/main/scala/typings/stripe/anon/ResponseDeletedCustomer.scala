...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.DeletedCustomer> */
trait ResponseDeletedCustomer extends StObject {
...
object ResponseDeletedCustomer {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedCustomer = {
    ...
    __obj.asInstanceOf[ResponseDeletedCustomer]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedCustomer] (val x: Self) extends AnyVal {
