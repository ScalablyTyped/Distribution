...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Terminal.DeletedReader> */
trait ResponseDeletedReader extends StObject {
...
object ResponseDeletedReader {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedReader = {
    ...
    __obj.asInstanceOf[ResponseDeletedReader]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedReader] (val x: Self) extends AnyVal {
