...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Terminal.DeletedLocation> */
trait ResponseDeletedLocation extends StObject {
...
object ResponseDeletedLocation {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedLocation = {
    ...
    __obj.asInstanceOf[ResponseDeletedLocation]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedLocation] (val x: Self) extends AnyVal {
