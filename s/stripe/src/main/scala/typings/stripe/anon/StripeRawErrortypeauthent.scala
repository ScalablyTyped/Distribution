...
object StripeRawErrortypeauthent {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypeauthent = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeauthent] (val x: Self) extends AnyVal {
