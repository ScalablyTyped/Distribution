...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'authentication_error'} */
trait StripeRawErrortypeauthent extends StObject {
  ...
  var `type`: RawErrorType & authentication_error
}
object StripeRawErrortypeauthent {
  
  inline def apply(`type`: RawErrorType & authentication_error): StripeRawErrortypeauthent = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypeauthent]
  }
  
  extension [Self <: StripeRawErrortypeauthent](x: Self) {
    ...
    inline def setType(value: RawErrorType & authentication_error): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
