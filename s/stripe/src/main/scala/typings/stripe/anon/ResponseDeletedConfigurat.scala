...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Terminal.DeletedConfiguration> */
trait ResponseDeletedConfigurat extends StObject {
...
object ResponseDeletedConfigurat {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedConfigurat = {
    ...
    __obj.asInstanceOf[ResponseDeletedConfigurat]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedConfigurat] (val x: Self) extends AnyVal {
