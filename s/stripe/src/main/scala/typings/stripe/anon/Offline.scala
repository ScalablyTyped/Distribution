...
object Offline {
  ...
  inline def apply(status: accepted | refused, `type`: online | offline): Offline = {
  ...
  extension [Self <: Offline](x: Self) {
    ...
    inline def setOnline(value: Ip): Self = StObject.set(x, "online", value.asInstanceOf[js.Any])
