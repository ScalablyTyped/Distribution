...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'invalid_request_error'} */
trait StripeRawErrortypeinvalid extends StObject {
  ...
  var `type`: RawErrorType & invalid_request_error
}
object StripeRawErrortypeinvalid {
  
  inline def apply(`type`: RawErrorType & invalid_request_error): StripeRawErrortypeinvalid = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypeinvalid]
  }
  
  extension [Self <: StripeRawErrortypeinvalid](x: Self) {
    ...
    inline def setType(value: RawErrorType & invalid_request_error): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
