...
object StripeRawErrortypeinvalid {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypeinvalid = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeinvalid] (val x: Self) extends AnyVal {
