...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.DeletedPlan> */
trait ResponseDeletedPlan extends StObject {
...
object ResponseDeletedPlan {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedPlan = {
    ...
    __obj.asInstanceOf[ResponseDeletedPlan]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedPlan] (val x: Self) extends AnyVal {
