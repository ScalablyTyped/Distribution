...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.DeletedPerson> */
trait ResponseDeletedPerson extends StObject {
...
object ResponseDeletedPerson {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedPerson = {
    ...
    __obj.asInstanceOf[ResponseDeletedPerson]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedPerson] (val x: Self) extends AnyVal {
