...
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.FailureCode
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.InitiatingPaymentMethodDetails
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.LinkedFlows
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.Network
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.ReversalDetails
import typings.stripe.mod.Stripe.Treasury.ReceivedCredit.Status
import typings.stripe.mod.Stripe.Treasury.Transaction
import typings.stripe.stripeStrings.treasuryDotreceived_credit
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Treasury.ReceivedCredit> */
trait ResponseReceivedCredit extends StObject {
  ...
  var initiating_payment_method_details: InitiatingPaymentMethodDetails
  ...
  /**
    ...
    */
  var `object`: treasuryDotreceived_credit
...
object ResponseReceivedCredit {
  ...
  implicit open class MutableBuilder[Self <: ResponseReceivedCredit] (val x: Self) extends AnyVal {
    ...
    inline def setObject(value: treasuryDotreceived_credit): Self = StObject.set(x, "object", value.asInstanceOf[js.Any])
