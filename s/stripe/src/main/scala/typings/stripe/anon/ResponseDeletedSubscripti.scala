...
/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.DeletedSubscriptionItem> */
trait ResponseDeletedSubscripti extends StObject {
...
object ResponseDeletedSubscripti {
  
  inline def apply(id: String, lastResponse: ApiVersion): ResponseDeletedSubscripti = {
    ...
    __obj.asInstanceOf[ResponseDeletedSubscripti]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseDeletedSubscripti] (val x: Self) extends AnyVal {
