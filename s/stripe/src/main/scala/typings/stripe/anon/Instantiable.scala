...
trait Instantiable
  ...
  var OrdersResource: Instantiable0[typings.stripe.mod.Stripe.OrdersResource] = js.native
  ...
  var SkusResource: Instantiable0[typings.stripe.mod.Stripe.SkusResource] = js.native
