...
import typings.stripe.mod.Stripe.Treasury.OutboundPayment.DestinationPaymentMethodDetails
import typings.stripe.mod.Stripe.Treasury.OutboundPayment.EndUserDetails
import typings.stripe.mod.Stripe.Treasury.OutboundPayment.ReturnedDetails
import typings.stripe.mod.Stripe.Treasury.OutboundPayment.Status
import typings.stripe.mod.Stripe.Treasury.OutboundPayment.StatusTransitions
import typings.stripe.mod.Stripe.Treasury.Transaction
import typings.stripe.stripeStrings.treasuryDotoutbound_payment
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined stripe.stripe.Stripe.Response<stripe.stripe.Stripe.Treasury.OutboundPayment> */
trait ResponseOutboundPayment extends StObject {
  ...
  /**
    ...
    */
  var destination_payment_method_details: DestinationPaymentMethodDetails | Null
  
  /**
    * Details about the end user.
    */
  var end_user_details: EndUserDetails | Null
  ...
  /**
    ...
    */
  var `object`: treasuryDotoutbound_payment
...
object ResponseOutboundPayment {
  ...
  ): ResponseOutboundPayment = {
    val __obj = js.Dynamic.literal(amount = amount.asInstanceOf[js.Any], cancelable = cancelable.asInstanceOf[js.Any], created = created.asInstanceOf[js.Any], currency = currency.asInstanceOf[js.Any], expected_arrival_date = expected_arrival_date.asInstanceOf[js.Any], financial_account = financial_account.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], lastResponse = lastResponse.asInstanceOf[js.Any], livemode = livemode.asInstanceOf[js.Any], metadata = metadata.asInstanceOf[js.Any], statement_descriptor = statement_descriptor.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], status_transitions = status_transitions.asInstanceOf[js.Any], transaction = transaction.asInstanceOf[js.Any], customer = null, description = null, destination_payment_method = null, destination_payment_method_details = null, end_user_details = null, hosted_regulatory_receipt_url = null, returned_details = null)
    __obj.updateDynamic("object")("treasury.outbound_payment")
    __obj.asInstanceOf[ResponseOutboundPayment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ResponseOutboundPayment] (val x: Self) extends AnyVal {
    ...
    inline def setDestination_payment_method_detailsNull: Self = StObject.set(x, "destination_payment_method_details", null)
    
    inline def setEnd_user_details(value: EndUserDetails): Self = StObject.set(x, "end_user_details", value.asInstanceOf[js.Any])
    
    inline def setEnd_user_detailsNull: Self = StObject.set(x, "end_user_details", null)
    ...
    inline def setObject(value: treasuryDotoutbound_payment): Self = StObject.set(x, "object", value.asInstanceOf[js.Any])
