...
object StripeRawErrortypecarderr {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypecarderr = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypecarderr] (val x: Self) extends AnyVal {
