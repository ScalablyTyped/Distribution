...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'card_error'} */
trait StripeRawErrortypecarderr extends StObject {
  ...
  var `type`: RawErrorType & card_error
}
object StripeRawErrortypecarderr {
  
  inline def apply(`type`: RawErrorType & card_error): StripeRawErrortypecarderr = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypecarderr]
  }
  
  extension [Self <: StripeRawErrortypecarderr](x: Self) {
    ...
    inline def setType(value: RawErrorType & card_error): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
