...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'invalid_grant'} */
trait StripeRawErrortypeinvalidCharge extends StObject {
  ...
  var `type`: RawErrorType & invalid_grant
}
object StripeRawErrortypeinvalidCharge {
  
  inline def apply(`type`: RawErrorType & invalid_grant): StripeRawErrortypeinvalidCharge = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypeinvalidCharge]
  }
  
  extension [Self <: StripeRawErrortypeinvalidCharge](x: Self) {
    ...
    inline def setType(value: RawErrorType & invalid_grant): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
