...
object StripeRawErrortypeinvalidCharge {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypeinvalidCharge = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeinvalidCharge] (val x: Self) extends AnyVal {
