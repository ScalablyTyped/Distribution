...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :stripe.stripe.Stripe.RawErrorType} */
trait StripeRawErrortypeRawErro extends StObject {
...
object StripeRawErrortypeRawErro {
  
  inline def apply(`type`: RawErrorType): StripeRawErrortypeRawErro = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypeRawErro]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeRawErro] (val x: Self) extends AnyVal {
