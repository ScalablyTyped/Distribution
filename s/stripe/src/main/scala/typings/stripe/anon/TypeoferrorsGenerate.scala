...
@js.native
trait TypeoferrorsGenerate extends StObject {
  ...
  var StripeError: (Instantiable1[/* rawError */ StripeRawError, typings.stripe.mod.Stripe.errors.StripeError]) & TypeofStripeErrorGenerate = js.native
