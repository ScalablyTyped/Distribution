...
object StripeRawErrortypeidempot {
  ...
  inline def apply(`type`: RawErrorType): StripeRawErrortypeidempot = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StripeRawErrortypeidempot] (val x: Self) extends AnyVal {
