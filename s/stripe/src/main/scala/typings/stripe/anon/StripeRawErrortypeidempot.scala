...
/* Inlined stripe.stripe.Stripe.StripeRawError & {  type :'idempotency_error'} */
trait StripeRawErrortypeidempot extends StObject {
  ...
  var `type`: RawErrorType & idempotency_error
}
object StripeRawErrortypeidempot {
  
  inline def apply(`type`: RawErrorType & idempotency_error): StripeRawErrortypeidempot = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[StripeRawErrortypeidempot]
  }
  
  extension [Self <: StripeRawErrortypeidempot](x: Self) {
    ...
    inline def setType(value: RawErrorType & idempotency_error): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
