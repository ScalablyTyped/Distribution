...
trait IBalanceTransaction
  ...
  /**
    ...
    */
  var source: java.lang.String | stripeLib.stripeMod.IResourceObject
  /**
    * The transfers (if any) for which source is a source_transaction.
    */
  var source_transfers: stripeLib.stripeMod.IList[stripeLib.stripeMod.transfersNs.ITransfer]
  /**
...
object IBalanceTransaction {
  ...
  def apply(
    ...
    source: java.lang.String | stripeLib.stripeMod.IResourceObject,
    source_transfers: stripeLib.stripeMod.IList[stripeLib.stripeMod.transfersNs.ITransfer],
