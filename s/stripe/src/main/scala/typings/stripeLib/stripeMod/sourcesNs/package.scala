...
package object sourcesNs {
  /**
    ...
    * card.
    */
  type ISourceCreationOptions = java.lang.String | stripeLib.stripeMod.cardsNs.ISourceCreationOptions
  /**
    * The source can either be a token, like the ones returned by our
    * Stripe.js, or a object containing a user's credit card details (with
    * the options shown below). You must provide a source if the
    ...
    * card.
    */
  type ISourceCreationOptionsExtended = java.lang.String | stripeLib.stripeMod.cardsNs.ISourceCreationOptionsExtended
}
