...
trait ISku
  ...
  /**
    ...
    */
  var package_dimensions: stripeLib.stripeMod.productsNs.IPackageDimensions
  /**
  ...
  /**
    ...
    */
  var product: java.lang.String | stripeLib.stripeMod.productsNs.IProduct
...
object ISku {
  ...
  def apply(
    ...
    package_dimensions: stripeLib.stripeMod.productsNs.IPackageDimensions,
    price: scala.Double,
    product: java.lang.String | stripeLib.stripeMod.productsNs.IProduct,
