...
trait BitcoinReceivers
  ...
  def create(data: stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiverCreationOptions): stdLib.Promise[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver] = js.native
  /**
  ...
  ): stdLib.Promise[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver] = js.native
  /**
               * Creates a Bitcoin receiver object that can be used to accept bitcoin payments from your customer. The receiver exposes a Bitcoin address
               * and is created with a bitcoin to USD exchange rate that is valid for 10 minutes.
               */
  ...
  def list(data: stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiverListOptions): stdLib.Promise[
  ...
  def retrieve(id: java.lang.String): stdLib.Promise[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver] = js.native
  def retrieve(id: java.lang.String, data: stripeLib.stripeMod.StripeNs.IDataOptions): stdLib.Promise[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver] = js.native
  /**
  ...
  def retrieve(id: java.lang.String, options: stripeLib.stripeMod.StripeNs.HeaderOptions): stdLib.Promise[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver] = js.native
  def retrieve(
    id: java.lang.String,
    options: stripeLib.stripeMod.StripeNs.HeaderOptions,
    response: stripeLib.stripeMod.StripeNs.IResponseFn[stripeLib.stripeMod.StripeNs.bitcoinReceiversNs.IBitcoinReceiver]
