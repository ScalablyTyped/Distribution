...
trait IPayout
  ...
  /**
    ...
    */
  var destination: java.lang.String | stripeLib.stripeMod.bankAccountsNs.IBankAccount | stripeLib.stripeMod.cardsNs.ICardHash
  /**
    ...
    */
  var failure_balance_transaction: java.lang.String | stripeLib.stripeMod.balanceNs.IBalanceTransaction
  /**
...
object IPayout {
  ...
  def apply(
    ...
    destination: java.lang.String | stripeLib.stripeMod.bankAccountsNs.IBankAccount | stripeLib.stripeMod.cardsNs.ICardHash,
    failure_balance_transaction: java.lang.String | stripeLib.stripeMod.balanceNs.IBalanceTransaction,
