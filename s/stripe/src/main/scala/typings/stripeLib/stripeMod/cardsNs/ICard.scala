...
trait ICard extends ICardHash {
  /**
    ...
    * [Expandable]
    */
  var account: js.UndefOr[java.lang.String | stripeLib.stripeMod.accountsNs.IAccount] = js.undefined
  /**
  ...
  /**
    ...
    * instead.
    */
  var customer: js.UndefOr[java.lang.String | stripeLib.stripeMod.customersNs.ICustomer | scala.Null] = js.undefined
  /**
  ...
  /**
    ...
    * instead. [Expandable]
    */
  var recipient: js.UndefOr[java.lang.String | stripeLib.stripeMod.recipientsNs.IRecipient] = js.undefined
}
...
object ICard {
  ...
  def apply(
    ...
    account: java.lang.String | stripeLib.stripeMod.accountsNs.IAccount = null,
    ...
    recipient: java.lang.String | stripeLib.stripeMod.recipientsNs.IRecipient = null,
