...
trait IBalanceListOptions
  ...
  var available_on: js.UndefOr[java.lang.String | stripeLib.stripeMod.IDateFilter] = js.undefined
...
object IBalanceListOptions {
  @scala.inline
  def apply(
    available_on: java.lang.String | stripeLib.stripeMod.IDateFilter = null,
