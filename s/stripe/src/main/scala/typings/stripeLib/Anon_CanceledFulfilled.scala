...
trait Anon_CanceledFulfilled extends js.Object {
  /**
    ...
    */
  var canceled: js.UndefOr[stripeLib.stripeMod.IDateFilter] = js.undefined
  /**
    * A filter on the list based on the object fulfilled field. The value can be a string with an integer Unix timestamp,
    * or it can be a dictionary with the following options:
    */
  var fulfilled: js.UndefOr[stripeLib.stripeMod.IDateFilter] = js.undefined
  /**
    * A filter on the list based on the object paid field. The value can be a string with an integer Unix timestamp,
    * or it can be a dictionary with the following options:
    */
  var paid: js.UndefOr[stripeLib.stripeMod.IDateFilter] = js.undefined
  /**
    * A filter on the list based on the object returned field. The value can be a string with an integer Unix timestamp,
    * or it can be a dictionary with the following options:
    */
  var returned: js.UndefOr[stripeLib.stripeMod.IDateFilter] = js.undefined
}

object Anon_CanceledFulfilled {
  @scala.inline
  def apply(
    canceled: stripeLib.stripeMod.IDateFilter = null,
    fulfilled: stripeLib.stripeMod.IDateFilter = null,
    paid: stripeLib.stripeMod.IDateFilter = null,
    returned: stripeLib.stripeMod.IDateFilter = null
