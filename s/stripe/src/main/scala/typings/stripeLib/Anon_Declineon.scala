...
trait Anon_Declineon extends js.Object {
  ...
  /**
    ...
    */
  var statement_descriptor_prefix: js.UndefOr[java.lang.String] = js.undefined
}

object Anon_Declineon {
  @scala.inline
  def apply(decline_on: Anon_Avsfailure = null, statement_descriptor_prefix: java.lang.String = null): Anon_Declineon = {
