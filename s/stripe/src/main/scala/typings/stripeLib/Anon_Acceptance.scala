...
trait Anon_Acceptance extends js.Object {
  var acceptance: js.UndefOr[Anon_Accepted] = js.undefined
...
object Anon_Acceptance {
  @scala.inline
  def apply(
    acceptance: Anon_Accepted = null,
    ...
    __obj.asInstanceOf[Anon_Acceptance]
  }
}
