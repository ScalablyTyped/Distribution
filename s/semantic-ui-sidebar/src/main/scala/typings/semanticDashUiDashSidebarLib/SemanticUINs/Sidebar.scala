...
trait Sidebar extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashSidebarLib.semanticDashUiDashSidebarLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl[K] */ js.Any = js.native
