...
package object DefaultTransitionSettings {
  ...
  type Param = (typings.semanticUiSidebar.anon.PickImplcomputer | typings.semanticUiSidebar.anon.PickImplmobile) with typings.semanticUiSidebar.anon.PartialPickImplkeyofImplComputer
}
