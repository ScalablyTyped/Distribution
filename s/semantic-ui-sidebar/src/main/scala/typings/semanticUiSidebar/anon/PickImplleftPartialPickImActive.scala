...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, 'left'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl>> */
trait PickImplleftPartialPickImActive
  extends StObject
     with Param {
...
object PickImplleftPartialPickImActive {
  
  inline def apply(left: String): PickImplleftPartialPickImActive = {
    val __obj = js.Dynamic.literal(left = left.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplleftPartialPickImActive]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplleftPartialPickImActive] (val x: Self) extends AnyVal {
