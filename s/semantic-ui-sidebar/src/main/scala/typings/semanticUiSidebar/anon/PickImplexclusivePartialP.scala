...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, 'exclusive'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl>> */
trait PickImplexclusivePartialP
  extends StObject
     with Param {
...
object PickImplexclusivePartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplexclusivePartialP] (val x: Self) extends AnyVal {
