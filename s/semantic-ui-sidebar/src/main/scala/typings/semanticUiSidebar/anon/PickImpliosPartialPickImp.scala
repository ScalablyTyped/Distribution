...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, 'ios'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl>> */
trait PickImpliosPartialPickImp
  extends StObject
     with Param {
...
object PickImpliosPartialPickImp {
  ...
  extension [Self <: PickImpliosPartialPickImp](x: Self) {
