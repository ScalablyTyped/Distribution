...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, 'returnScroll'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl>> */
trait PickImplreturnScrollParti
  extends StObject
     with Param {
...
object PickImplreturnScrollParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplreturnScrollParti] (val x: Self) extends AnyVal {
