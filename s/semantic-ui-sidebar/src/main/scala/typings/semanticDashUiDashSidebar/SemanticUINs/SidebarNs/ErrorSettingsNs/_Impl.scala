package typings.semanticDashUiDashSidebar.SemanticUINs.SidebarNs.ErrorSettingsNs
...
object _Impl {
  @scala.inline
  def apply(method: String, movedSidebar: String, notFound: String, overlay: String, pusher: String): _Impl = {
