...
import typings.sift.srcUtilsMod.Comparator
...
object srcCoreMod {
  ...
  inline def createQueryOperation[TItem, TSchema](query: Query[TSchema], owneryQuery: Any, param2: PartialOptionsCompare): QueryOperation[TItem] = (^.asInstanceOf[js.Dynamic].applyDynamic("createQueryOperation")(query.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[QueryOperation[TItem]]
  inline def createQueryOperation[TItem, TSchema](query: Query[TSchema], owneryQuery: Unit, param2: PartialOptionsCompare): QueryOperation[TItem] = (^.asInstanceOf[js.Dynamic].applyDynamic("createQueryOperation")(query.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], param2.asInstanceOf[js.Any])).asInstanceOf[QueryOperation[TItem]]
