...
import typings.sift.coreMod.Operation
import typings.sift.coreMod.Options
import typings.sift.coreMod.Query
import typings.sift.coreMod.QueryOperation
import typings.sift.operationsMod.$All
import typings.sift.operationsMod.$And
import typings.sift.operationsMod.$ElemMatch
import typings.sift.operationsMod.$Exists
import typings.sift.operationsMod.$In
import typings.sift.operationsMod.$Ne
import typings.sift.operationsMod.$Nin
import typings.sift.operationsMod.$Nor
import typings.sift.operationsMod.$Not
import typings.sift.operationsMod.$Or
import typings.sift.utilsMod.Key
...
object mod {
  ...
  open class $Size protected ()
    extends typings.sift.libMod.$Size {
  ...
  open class EqualsOperation[TParam] protected ()
    extends typings.sift.libMod.EqualsOperation[TParam] {
  ...
  inline def createEqualsOperation(params: Any, owneryQuery: Any, options: Options): typings.sift.coreMod.EqualsOperation[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("createEqualsOperation")(params.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[Any]]
  ...
  inline def eq(params: Any, owneryQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("$eq")(params.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[Any]]
  ...
  inline def mod(hasModEqualsValue: js.Array[Double], owneryQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Boolean]] = (^.asInstanceOf[js.Dynamic].applyDynamic("$mod")(hasModEqualsValue.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Boolean]]]
  ...
  inline def regex(pattern: String, owneryQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.RegExp] = (^.asInstanceOf[js.Dynamic].applyDynamic("$regex")(pattern.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.RegExp]]
  
  inline def size(params: Double, ownerQuery: Query[Any], options: Options): typings.sift.operationsMod.$Size = (^.asInstanceOf[js.Dynamic].applyDynamic("$size")(params.asInstanceOf[js.Any], ownerQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.operationsMod.$Size]
  
  inline def `type`(clazz: String, owneryQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("$type")(clazz.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]]]
  inline def `type`(clazz: js.Function, owneryQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("$type")(clazz.asInstanceOf[js.Any], owneryQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]]]
  
  inline def where(params: String, ownerQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("$where")(params.asInstanceOf[js.Any], ownerQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]]]
  inline def where(params: js.Function, ownerQuery: Query[Any], options: Options): typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("$where")(params.asInstanceOf[js.Any], ownerQuery.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.sift.coreMod.EqualsOperation[js.Function1[/* b */ Any, Any]]]
}
