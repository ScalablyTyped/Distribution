...
import typings.sift.utilsMod.Comparator
...
object coreMod {
  ...
  @JSImport("sift/lib/core", "BaseOperation")
  @js.native
  abstract class BaseOperation[TParams, TItem] protected ()
    extends StObject
  ...
  - typings.sift.coreMod.NamedOperation because var conflicts: name. Inlined  */ @JSImport("sift/lib/core", "NamedGroupOperation")
  @js.native
  abstract class NamedGroupOperation protected () extends GroupOperation {
  ...
  {[ k in keyof TItemSchema ]:? TItemSchema[k] | sift.sift/lib/core.ValueQuery<TItemSchema[k]>}
