...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, 'rightArrow'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl>> */
trait PickImplrightArrowPartial
  extends StObject
     with Param {
...
object PickImplrightArrowPartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplrightArrowPartial] (val x: Self) extends AnyVal {
