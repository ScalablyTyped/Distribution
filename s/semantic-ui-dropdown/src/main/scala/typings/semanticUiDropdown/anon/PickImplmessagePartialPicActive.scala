...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'message'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplmessagePartialPicActive
  extends StObject
     with Param {
...
object PickImplmessagePartialPicActive {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmessagePartialPicActive] (val x: Self) extends AnyVal {
