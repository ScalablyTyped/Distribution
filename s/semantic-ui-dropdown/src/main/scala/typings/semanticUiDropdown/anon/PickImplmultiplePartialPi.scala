...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'multiple'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplmultiplePartialPi
  extends StObject
     with Param {
...
object PickImplmultiplePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmultiplePartialPi] (val x: Self) extends AnyVal {
