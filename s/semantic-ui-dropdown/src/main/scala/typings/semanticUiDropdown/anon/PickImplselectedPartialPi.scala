...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'selected'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplselectedPartialPi
  extends StObject
     with Param {
...
object PickImplselectedPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplselectedPartialPi] (val x: Self) extends AnyVal {
