...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'useLabels'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImpluseLabelsPartialP
  extends StObject
     with Param {
...
object PickImpluseLabelsPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpluseLabelsPartialP] (val x: Self) extends AnyVal {
