...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'item'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplitemPartialPickImActive
  extends StObject
     with Param {
...
object PickImplitemPartialPickImActive {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplitemPartialPickImActive] (val x: Self) extends AnyVal {
