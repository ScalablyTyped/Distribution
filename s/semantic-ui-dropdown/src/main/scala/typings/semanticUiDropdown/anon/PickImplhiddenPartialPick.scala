...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'hidden'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
...
object PickImplhiddenPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplhiddenPartialPick] (val x: Self) extends AnyVal {
