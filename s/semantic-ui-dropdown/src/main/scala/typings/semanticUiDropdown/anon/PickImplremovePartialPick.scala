...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'remove'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplremovePartialPick
  extends StObject
     with Param {
...
object PickImplremovePartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplremovePartialPick] (val x: Self) extends AnyVal {
