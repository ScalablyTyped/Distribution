...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'showOnFocus'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplshowOnFocusPartia
  extends StObject
     with Param {
...
object PickImplshowOnFocusPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplshowOnFocusPartia] (val x: Self) extends AnyVal {
