...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'allowAdditions'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplallowAdditionsPar
  extends StObject
     with Param {
...
object PickImplallowAdditionsPar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplallowAdditionsPar] (val x: Self) extends AnyVal {
