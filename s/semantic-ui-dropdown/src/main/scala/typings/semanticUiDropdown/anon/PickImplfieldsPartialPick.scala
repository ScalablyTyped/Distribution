...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'fields'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplfieldsPartialPick
  extends StObject
     with Param {
...
object PickImplfieldsPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplfieldsPartialPick] (val x: Self) extends AnyVal {
