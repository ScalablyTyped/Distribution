...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'onRemove'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplonRemovePartialPi
  extends StObject
     with Param {
...
object PickImplonRemovePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonRemovePartialPi] (val x: Self) extends AnyVal {
