...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'selection'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplselectionPartialP
  extends StObject
     with Param {
  ...
  var selection: String & js.UndefOr[String]
  
  var upward: js.UndefOr[String] = js.undefined
  
  var visible: js.UndefOr[String] = js.undefined
}
object PickImplselectionPartialP {
  
  inline def apply(selection: String & js.UndefOr[String]): PickImplselectionPartialP = {
    val __obj = js.Dynamic.literal(selection = selection.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplselectionPartialP]
  }
  
  extension [Self <: PickImplselectionPartialP](x: Self) {
    ...
    inline def setSelection(value: String & js.UndefOr[String]): Self = StObject.set(x, "selection", value.asInstanceOf[js.Any])
