...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'keys'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplkeysPartialPickIm
  extends StObject
     with Param {
...
object PickImplkeysPartialPickIm {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplkeysPartialPickIm] (val x: Self) extends AnyVal {
