...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'transition'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImpltransitionPartial
  ...
  var transition: (auto | String) & (js.UndefOr[auto | String])
...
object PickImpltransitionPartial {
  ...
  inline def apply(transition: (auto | String) & (js.UndefOr[auto | String])): PickImpltransitionPartial = {
  ...
  extension [Self <: PickImpltransitionPartial](x: Self) {
    ...
    inline def setTransition(value: (auto | String) & (js.UndefOr[auto | String])): Self = StObject.set(x, "transition", value.asInstanceOf[js.Any])
