...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'label'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImpllabelPartialPickIActive
  extends StObject
     with Param {
...
object PickImpllabelPartialPickIActive {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpllabelPartialPickIActive] (val x: Self) extends AnyVal {
