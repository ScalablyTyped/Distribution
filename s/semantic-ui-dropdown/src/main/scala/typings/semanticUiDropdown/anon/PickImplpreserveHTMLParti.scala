...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'preserveHTML'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplpreserveHTMLParti
  extends StObject
     with Param {
...
object PickImplpreserveHTMLParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplpreserveHTMLParti] (val x: Self) extends AnyVal {
