...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'onNoResults'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplonNoResultsPartia
  extends StObject
     with Param {
...
object PickImplonNoResultsPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonNoResultsPartia] (val x: Self) extends AnyVal {
