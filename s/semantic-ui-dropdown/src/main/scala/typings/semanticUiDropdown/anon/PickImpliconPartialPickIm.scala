...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'icon'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
...
object PickImpliconPartialPickIm {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpliconPartialPickIm] (val x: Self) extends AnyVal {
