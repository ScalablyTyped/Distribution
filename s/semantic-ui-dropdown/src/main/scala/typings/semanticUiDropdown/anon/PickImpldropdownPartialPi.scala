...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'dropdown'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImpldropdownPartialPi
  extends StObject
     with Param {
...
object PickImpldropdownPartialPi {
  
  inline def apply(dropdown: String): PickImpldropdownPartialPi = {
    val __obj = js.Dynamic.literal(dropdown = dropdown.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImpldropdownPartialPi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldropdownPartialPi] (val x: Self) extends AnyVal {
