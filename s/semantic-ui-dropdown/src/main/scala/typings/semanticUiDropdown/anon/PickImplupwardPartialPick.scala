...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'upward'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplupwardPartialPick
  extends StObject
     with Param {
...
object PickImplupwardPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplupwardPartialPick] (val x: Self) extends AnyVal {
