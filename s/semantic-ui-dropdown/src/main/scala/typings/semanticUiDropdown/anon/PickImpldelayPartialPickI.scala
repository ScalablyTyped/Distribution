...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'delay'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImpldelayPartialPickI
  extends StObject
     with Param {
...
object PickImpldelayPartialPickI {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldelayPartialPickI] (val x: Self) extends AnyVal {
