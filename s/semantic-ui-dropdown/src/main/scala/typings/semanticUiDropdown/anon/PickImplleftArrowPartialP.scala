...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, 'leftArrow'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl>> */
trait PickImplleftArrowPartialP
  extends StObject
     with Param {
...
object PickImplleftArrowPartialP {
  
  inline def apply(leftArrow: Double): PickImplleftArrowPartialP = {
    val __obj = js.Dynamic.literal(leftArrow = leftArrow.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplleftArrowPartialP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplleftArrowPartialP] (val x: Self) extends AnyVal {
