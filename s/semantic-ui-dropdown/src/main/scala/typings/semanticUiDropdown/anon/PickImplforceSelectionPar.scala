...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'forceSelection'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplforceSelectionPar
  extends StObject
     with Param {
  ...
  var forceSelection: Boolean & js.UndefOr[Boolean]
...
object PickImplforceSelectionPar {
  
  inline def apply(forceSelection: Boolean & js.UndefOr[Boolean]): PickImplforceSelectionPar = {
  ...
  extension [Self <: PickImplforceSelectionPar](x: Self) {
    ...
    inline def setForceSelection(value: Boolean & js.UndefOr[Boolean]): Self = StObject.set(x, "forceSelection", value.asInstanceOf[js.Any])
