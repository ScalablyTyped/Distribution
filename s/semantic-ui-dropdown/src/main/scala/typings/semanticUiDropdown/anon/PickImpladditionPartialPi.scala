...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'addition'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImpladditionPartialPi
  extends StObject
     with Param {
...
object PickImpladditionPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpladditionPartialPi] (val x: Self) extends AnyVal {
