...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'item'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplitemPartialPickIm
  extends StObject
     with Param {
...
object PickImplitemPartialPickIm {
  
  inline def apply(item: String): PickImplitemPartialPickIm = {
    val __obj = js.Dynamic.literal(item = item.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplitemPartialPickIm]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplitemPartialPickIm] (val x: Self) extends AnyVal {
