...
import typings.semanticUiDropdown.SemanticUI.Dropdown.SelectorSettings.Param
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'menuIcon'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplmenuIconPartialPi
  extends StObject
     with Param {
  ...
  var menuIcon: String & js.UndefOr[String]
...
object PickImplmenuIconPartialPi {
  
  inline def apply(menuIcon: String & js.UndefOr[String]): PickImplmenuIconPartialPi = {
    val __obj = js.Dynamic.literal(menuIcon = menuIcon.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplmenuIconPartialPi]
  }
  
  extension [Self <: PickImplmenuIconPartialPi](x: Self) {
    ...
    inline def setMenuIcon(value: String & js.UndefOr[String]): Self = StObject.set(x, "menuIcon", value.asInstanceOf[js.Any])
