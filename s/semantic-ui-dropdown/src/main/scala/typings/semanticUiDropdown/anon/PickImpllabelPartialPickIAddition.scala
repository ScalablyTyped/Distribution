...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'label'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImpllabelPartialPickIAddition
  extends StObject
     with Param {
...
object PickImpllabelPartialPickIAddition {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpllabelPartialPickIAddition] (val x: Self) extends AnyVal {
