...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'direction'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImpldirectionPartialP
  extends StObject
     with Param {
...
object PickImpldirectionPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldirectionPartialP] (val x: Self) extends AnyVal {
