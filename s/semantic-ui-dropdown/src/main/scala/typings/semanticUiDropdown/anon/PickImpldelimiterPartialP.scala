...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, 'delimiter'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl>> */
trait PickImpldelimiterPartialP
  extends StObject
     with Param {
...
object PickImpldelimiterPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldelimiterPartialP] (val x: Self) extends AnyVal {
