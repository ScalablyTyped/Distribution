...
trait Dropdown extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashDropdownLib.semanticDashUiDashDropdownLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl[K] */ js.Any = js.native
