...
object alarms {
  ...
  inline def clearAll_=(x: SinonChromeStub): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("clearAll")(x.asInstanceOf[js.Any])
  
  inline def clear_=(x: SinonChromeStub): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("clear")(x.asInstanceOf[js.Any])
  ...
  inline def onAlarm_=(x: Event): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("onAlarm")(x.asInstanceOf[js.Any])
}
