...
@js.native
object managementNs extends js.Object {
  var createAppShortcut: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var generateAppForLink: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  ...
  var uninstallSelf: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
}
