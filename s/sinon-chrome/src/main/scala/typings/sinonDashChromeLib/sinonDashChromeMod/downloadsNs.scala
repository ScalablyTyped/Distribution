...
@js.native
object downloadsNs extends js.Object {
  var acceptDanger: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var cancel: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var download: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  ...
  var setShelfEnabled: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var show: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var showDefaultFolder: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
}
