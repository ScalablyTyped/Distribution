...
object historyNs extends js.Object {
  var addUrl: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var deleteAll: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
