...
object browserActionNs extends js.Object {
  var disable: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var enable: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var getBadgeBackgroundColor: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  ...
  var setPopup: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var setTitle: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
}
