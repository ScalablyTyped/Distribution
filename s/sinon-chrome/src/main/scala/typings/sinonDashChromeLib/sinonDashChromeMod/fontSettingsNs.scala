...
object fontSettingsNs extends js.Object {
  var clearDefaultFixedFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var clearDefaultFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var clearFont: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var clearMinimumFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var getDefaultFixedFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  var getDefaultFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
  ...
  var setMinimumFontSize: sinonDashChromeLib.sinonDashChromeMod.SinonChromeStub = js.native
}
