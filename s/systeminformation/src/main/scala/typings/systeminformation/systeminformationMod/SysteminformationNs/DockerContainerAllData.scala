...
- typings.systeminformation.systeminformationMod.SysteminformationNs.DockerContainerStatsData because var conflicts: id. Inlined mem_usage, mem_limit, mem_percent, cpu_percent, netIO, blockIO, cpu_stats, precpu_stats, memory_stats, networks */ trait DockerContainerAllData extends DockerContainerData {
  var blockIO: Anon_R
