...
import typings.shelljs.shelljsMod.ExecCallback
import typings.shelljs.shelljsMod.ExecOptions
import typings.shelljs.shelljsMod.HeadOptions
import typings.shelljs.shelljsMod.ShellArray
import typings.shelljs.shelljsMod.ShellConfig
import typings.shelljs.shelljsMod.ShellString
import typings.shelljs.shelljsMod.ShellStringConstructor
import typings.shelljs.shelljsMod.TailOptions
...
trait ShelljsExecProxy extends /* k */ StringDictionary[Exec] {
  ...
  /**
  	 ...
  	 */
  def ShellString(value: String): typings.shelljs.shelljsMod.ShellString = js.native
