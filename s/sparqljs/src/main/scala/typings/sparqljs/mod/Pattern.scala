...
object Pattern {
  ...
  @scala.inline
  def BindPattern(expression: Expression, variable: VariableTerm): typings.sparqljs.mod.BindPattern = {
  ...
  @scala.inline
  def FilterPattern(expression: Expression): typings.sparqljs.mod.FilterPattern = {
  ...
  @scala.inline
  def ValuesPattern(values: js.Array[ValuePatternRow]): typings.sparqljs.mod.ValuesPattern = {
