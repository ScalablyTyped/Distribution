...
trait BaseListener[T /* <: BaseEntity[BaseListener[_]] */] extends js.Object {
  var lockChanged: js.UndefOr[js.Function1[/* event */ BaseEvent[T] with Anon_Locked, Unit]] = js.undefined
}

object BaseListener {
  @scala.inline
  def apply[T /* <: BaseEntity[BaseListener[_]] */](lockChanged: /* event */ BaseEvent[T] with Anon_Locked => Unit = null): BaseListener[T] = {
