...
import typings.sqlite.buildInterfacesMod.ISqlite.ConfigureOption
...
object buildDatabaseMod {
  ...
  open class Database[Driver /* <: typings.sqlite.sqlite3Mod.Database */, Stmt /* <: Statement */] protected () extends StObject {
    ...
    /**
      ...
      */
    def prepare(sql: SqlType, params: Any*): js.Promise[typings.sqlite.buildStatementMod.Statement[Stmt]] = js.native
