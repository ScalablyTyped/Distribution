...
object ^ extends js.Object {
  ...
  def nlapiCreateSearch(`type`: String, filters: js.Array[nlobjSearchFilter], columns: js.Array[nlobjSearchColumn]): nlobjSearch = js.native
  def nlapiCreateSearch(`type`: String, filters: js.Array[nlobjSearchFilter], columns: nlobjSearchColumn): nlobjSearch = js.native
  def nlapiCreateSearch(`type`: String, filters: nlobjSearchFilter, columns: js.Array[nlobjSearchColumn]): nlobjSearch = js.native
  def nlapiCreateSearch(`type`: String, filters: nlobjSearchFilter, columns: nlobjSearchColumn): nlobjSearch = js.native
  /**
