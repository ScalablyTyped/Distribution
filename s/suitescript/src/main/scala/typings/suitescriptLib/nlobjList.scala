...
org.scalablytyped.runtime.Instantiable0[js.Any] {
  /**
    ...
    * @param script
    */
  def addButton(name: java.lang.String, label: java.lang.String, script: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @return
    */
  def addColumn(name: java.lang.String, `type`: java.lang.String, label: java.lang.String): js.Function0[scala.Unit] = js.native
  def addColumn(name: java.lang.String, `type`: java.lang.String, label: java.lang.String, align: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
