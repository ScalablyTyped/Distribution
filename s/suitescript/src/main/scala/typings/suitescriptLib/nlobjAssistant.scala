...
ScalablyTyped.runtime.Instantiable0[js.Any] {
  ...
  /**
       ...
       * @return
       */
  def addFieldGroup(name: java.lang.String, label: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def addStep(name: java.lang.String, label: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def addSubList(name: java.lang.String, `type`: java.lang.String, label: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @since 2009.2
       */
  def getAllFieldGroups(): scala.Unit = js.native
  /**
  ...
  /**
       ...
       * @since 2009.2
       */
  def getAllSteps(): scala.Unit = js.native
  /**
       ...
       * @since 2009.2
       */
  def getAllSubLists(): scala.Unit = js.native
  /**
       ...
       * @return
       */
  def getCurrentStep(): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def getField(name: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def getFieldGroup(name: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def getLastAction(): java.lang.String = js.native
  /**
       ...
       * @return
       */
  def getLastStep(): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def getNextStep(): js.Function0[scala.Unit] = js.native
  /**
       ...
       * @return
       */
  def getStep(name: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
       ...
       * @return
       */
  def getSubList(name: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
       ...
       * @return
       */
  def sendRedirect(response: js.Function0[scala.Unit]): js.Any = js.native
  /**
       ...
       * @return
       */
  def setCurrentStep(step: js.Function0[scala.Unit]): js.Any = js.native
  /**
       ...
       * @return
       */
  def setError(html: java.lang.String): js.Any = js.native
  /**
  ...
  /**
       ...
       * @return
       */
  def setFinished(html: java.lang.String): js.Any = js.native
  /**
       ...
       * @return
       */
  def setNumbered(numbered: scala.Boolean): js.Any = js.native
  /**
       ...
       * @return
       */
  def setOrdered(ordered: scala.Boolean): js.Any = js.native
  /**
  ...
  /**
       ...
       * @return
       */
  def setShortcut(show: scala.Boolean): js.Any = js.native
  /**
       ...
       * @return
       */
  def setSplash(title: java.lang.String, text1: java.lang.String): js.Any = js.native
  /**
       * set the splash screen used for this page.
       * @param {string} title splash portlet title
       * @param {string} text1 splash portlet content (left side)
       ...
       * @return
       */
  def setSplash(title: java.lang.String, text1: java.lang.String, text2: java.lang.String): js.Any = js.native
  /**
       * set the page title.
       * @param {string} title
       * @return {void}
