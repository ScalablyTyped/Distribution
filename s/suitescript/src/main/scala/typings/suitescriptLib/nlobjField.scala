...
trait nlobjField
  ...
  * @return
  */
org.scalablytyped.runtime.Instantiable0[/* nlobjField */ js.Any] {
  /**
    ...
    * @param selected?
    */
  def addSelectOption(value: java.lang.String, text: java.lang.String): scala.Unit = js.native
  def addSelectOption(value: java.lang.String, text: java.lang.String, selected: scala.Boolean): scala.Unit = js.native
  /**
    * return field label.
    * @return {string}
    *
  ...
  /**
    ...
    * @return
    */
  def isMandatory(): scala.Boolean = js.native
  /**
    ...
    * @return
    */
  def setAlias(alias: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setBreakType(breaktype: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setDefaultValue(value: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setDisabled(disabled: scala.Boolean): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setDisplaySize(width: js.Any, height: js.Any): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setDisplayType(`type`: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
  ...
  def setHelpText(help: java.lang.String, `inline`: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
  ...
  /**
    ...
    * @return
    */
  def setLayoutType(`type`: java.lang.String): js.Function0[scala.Unit] = js.native
  def setLayoutType(`type`: java.lang.String, breaktype: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setLinkText(text: java.lang.String): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setMandatory(mandatory: scala.Boolean): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setMaxLength(maxlength: js.Any): js.Function0[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def setPadding(padding: js.Any): js.Function0[scala.Unit] = js.native
}
