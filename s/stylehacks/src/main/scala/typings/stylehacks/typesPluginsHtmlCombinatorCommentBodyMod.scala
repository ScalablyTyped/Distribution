...
object typesPluginsHtmlCombinatorCommentBodyMod {
  
  @JSImport("stylehacks/types/plugins/htmlCombinatorCommentBody", JSImport.Namespace)
  @js.native
  open class ^ protected () extends HtmlCombinatorCommentBody {
    /** @param {import('postcss').Result} result */
    def this(result: Result) = this()
  }
  
  @js.native
  trait HtmlCombinatorCommentBody
