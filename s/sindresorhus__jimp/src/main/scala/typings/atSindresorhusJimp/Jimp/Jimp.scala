package typings.atSindresorhusJimp.Jimp
...
class Jimp protected () extends js.Object {
  ...
  def this(image: typings.atSindresorhusJimp.Jimp.Jimp) = this()
  def this(path: String) = this()
  def this(data: Buffer, cb: ImageCallback) = this()
  def this(image: typings.atSindresorhusJimp.Jimp.Jimp, cb: ImageCallback) = this()
  ...
  def blit(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def blit(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double): this.type = js.native
  def blit(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double, srcy: Double): this.type = js.native
  def blit(
    src: typings.atSindresorhusJimp.Jimp.Jimp,
    x: Double,
    y: Double,
    srcx: Double,
    srcy: Double,
  ...
  def clone(cb: ImageCallback): typings.atSindresorhusJimp.Jimp.Jimp = js.native
  ...
  def composite(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def composite(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
  ...
  def displace(map: typings.atSindresorhusJimp.Jimp.Jimp, offset: Double): this.type = js.native
  def displace(map: typings.atSindresorhusJimp.Jimp.Jimp, offset: Double, cb: ImageCallback): this.type = js.native
  ...
  def mask(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def mask(src: typings.atSindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
...
object Jimp extends js.Object {
  ...
  def diff(img1: typings.atSindresorhusJimp.Jimp.Jimp, img2: typings.atSindresorhusJimp.Jimp.Jimp): Anon_Diff = js.native
  def diff(
    img1: typings.atSindresorhusJimp.Jimp.Jimp,
    img2: typings.atSindresorhusJimp.Jimp.Jimp,
    threshold: Double
  ): Anon_Diff = js.native
  def distance(img1: typings.atSindresorhusJimp.Jimp.Jimp, img2: typings.atSindresorhusJimp.Jimp.Jimp): Double = js.native
  ...
  /* These are constructors, have already moved up, TODO: remove it in the future
    ...
    */
  def read(src: String): js.Promise[typings.atSindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: String, cb: ImageCallback): js.Promise[typings.atSindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer): js.Promise[typings.atSindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer, cb: ImageCallback): js.Promise[typings.atSindresorhusJimp.Jimp.Jimp] = js.native
