...
import typings.sindresorhusJimp.anon.Diff
...
object global extends js.Object {
  ...
  object Jimp extends js.Object {
    @js.native
    class Jimp protected ()
      extends typings.sindresorhusJimp.Jimp.Jimp {
      def this(data: Buffer) = this()
      def this(image: typings.sindresorhusJimp.Jimp.Jimp) = this()
      def this(path: String) = this()
      def this(data: Buffer, cb: ImageCallback) = this()
      def this(image: typings.sindresorhusJimp.Jimp.Jimp, cb: ImageCallback) = this()
    ...
    object Jimp extends js.Object {
      ...
      def diff(img1: typings.sindresorhusJimp.Jimp.Jimp, img2: typings.sindresorhusJimp.Jimp.Jimp): Diff = js.native
      def diff(
        img1: typings.sindresorhusJimp.Jimp.Jimp,
        img2: typings.sindresorhusJimp.Jimp.Jimp,
        threshold: Double
      ): Diff = js.native
      def distance(img1: typings.sindresorhusJimp.Jimp.Jimp, img2: typings.sindresorhusJimp.Jimp.Jimp): Double = js.native
      ...
      /* These are constructors, have already moved up, TODO: remove it in the future
        ...
        */
      def read(src: String): js.Promise[typings.sindresorhusJimp.Jimp.Jimp] = js.native
      def read(src: String, cb: ImageCallback): js.Promise[typings.sindresorhusJimp.Jimp.Jimp] = js.native
      def read(src: Buffer): js.Promise[typings.sindresorhusJimp.Jimp.Jimp] = js.native
      def read(src: Buffer, cb: ImageCallback): js.Promise[typings.sindresorhusJimp.Jimp.Jimp] = js.native
