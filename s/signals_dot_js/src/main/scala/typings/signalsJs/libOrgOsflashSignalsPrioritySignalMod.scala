...
import typings.signalsJs.libOrgOsflashSignalsSignalMod.Signal
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libOrgOsflashSignalsPrioritySignalMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.signalsJs.libOrgOsflashSignalsIoncesignalMod.IOnceSignal because Already inherited
  - typings.signalsJs.libOrgOsflashSignalsIsignalMod.ISignal because Already inherited
  - typings.signalsJs.libOrgOsflashSignalsIprioritysignalMod.IPrioritySignal because var conflicts: numListeners, valueClasses. Inlined addWithPriority, addOnceWithPriority */ @JSImport("signals.js/lib/org/osflash/signals/PrioritySignal", "PrioritySignal")
  @js.native
