...
import typings.signalsJs.libOrgOsflashSignalsOnceSignalMod.OnceSignal
...
object libOrgOsflashSignalsSignalMod {
  ...
  - typings.signalsJs.libOrgOsflashSignalsIsignalMod.ISignal because var conflicts: numListeners, valueClasses. Inlined add */ @JSImport("signals.js/lib/org/osflash/signals/Signal", "Signal")
  @js.native
