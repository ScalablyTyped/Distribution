package typings
package signalsDotJsLib.libOrgOsflashSignalsOnceSignalMod
...
class OnceSignal protected ()
  ...
  var slots: signalsDotJsLib.libOrgOsflashSignalsSlotListMod.SlotList = js.native
  /**
  ...
  /* protected */ def registrationPossible(listener: js.Function, once: scala.Boolean): scala.Boolean = js.native
  /**
