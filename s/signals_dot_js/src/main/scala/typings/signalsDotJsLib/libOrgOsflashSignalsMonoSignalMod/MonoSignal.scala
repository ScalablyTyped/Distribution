package typings
package signalsDotJsLib.libOrgOsflashSignalsMonoSignalMod
...
class MonoSignal protected ()
  ...
  /* CompleteClass */
  override var numListeners: scala.Double = js.native
  var slot: signalsDotJsLib.libOrgOsflashSignalsSlotMod.Slot = js.native
  /**
  ...
  /**
       ...
       */
  /* CompleteClass */
  override def add(listener: js.Function): signalsDotJsLib.libOrgOsflashSignalsISlotMod.ISlot = js.native
  /**
       ...
       */
  /* CompleteClass */
  override def addOnce(listener: js.Function): signalsDotJsLib.libOrgOsflashSignalsISlotMod.ISlot = js.native
  /**
       ...
       */
  /* CompleteClass */
  override def dispatch(valueObjects: js.Any*): scala.Unit = js.native
  /* protected */ def registerListener(listener: js.Function): signalsDotJsLib.libOrgOsflashSignalsISlotMod.ISlot = js.native
  /* protected */ def registerListener(listener: js.Function, once: scala.Boolean): signalsDotJsLib.libOrgOsflashSignalsISlotMod.ISlot = js.native
  /**
       ...
       */
  /* CompleteClass */
  override def remove(listener: js.Function): signalsDotJsLib.libOrgOsflashSignalsISlotMod.ISlot = js.native
  /**
