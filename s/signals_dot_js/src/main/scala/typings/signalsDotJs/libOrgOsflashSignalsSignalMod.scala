...
import typings.signalsDotJs.libOrgOsflashSignalsOnceSignalMod.OnceSignal
...
@js.native
object libOrgOsflashSignalsSignalMod extends js.Object {
  /* import warning: RemoveMultipleInheritance.findNewParents newComments Dropped parents 
  - typings.signalsDotJs.libOrgOsflashSignalsIOnceSignalMod.IOnceSignal because Already inherited
  - typings.signalsDotJs.libOrgOsflashSignalsISignalMod.ISignal because var conflicts: numListeners, valueClasses. Inlined add */ @js.native
