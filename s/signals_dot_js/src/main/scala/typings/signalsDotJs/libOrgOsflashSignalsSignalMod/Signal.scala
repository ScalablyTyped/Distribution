package typings.signalsDotJs.libOrgOsflashSignalsSignalMod
...
- typings.signalsDotJs.libOrgOsflashSignalsISignalMod.ISignal because var conflicts: numListeners, valueClasses. Inlined add */ @JSImport("signals.js/lib/org/osflash/signals/Signal", "Signal")
@js.native
