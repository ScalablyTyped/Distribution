...
object ^ extends js.Object {
  ...
  def checkStream(stream: nodeLib.streamMod.Readable, sri: java.lang.String): js.Thenable[Hash] = js.native
  def checkStream(stream: nodeLib.streamMod.Readable, sri: java.lang.String, opts: ssriLib.Anon_Algo1Algo2Options): js.Thenable[Hash] = js.native
  def checkStream(stream: nodeLib.streamMod.Readable, sri: HashLike): js.Thenable[Hash] = js.native
  def checkStream(stream: nodeLib.streamMod.Readable, sri: HashLike, opts: ssriLib.Anon_Algo1Algo2Options): js.Thenable[Hash] = js.native
  def checkStream(stream: nodeLib.streamMod.Readable, sri: IntegrityLike): js.Thenable[Hash] = js.native
  def checkStream(stream: nodeLib.streamMod.Readable, sri: IntegrityLike, opts: ssriLib.Anon_Algo1Algo2Options): js.Thenable[Hash] = js.native
  ...
  def fromHex(hexDigest: java.lang.String, algorithm: java.lang.String): Hash = js.native
  def fromHex(hexDigest: java.lang.String, algorithm: java.lang.String, opts: ssriLib.Anon_Options): IntegrityMap = js.native
  def fromHex(hexDigest: java.lang.String, algorithm: java.lang.String, opts: ssriLib.Anon_OptionsSingle): Hash = js.native
  @JSName("fromHex")
  def fromHex_IntegrityMap(hexDigest: java.lang.String, algorithm: java.lang.String): IntegrityMap = js.native
  def fromStream(stream: nodeLib.streamMod.Readable): js.Thenable[IntegrityMap] = js.native
