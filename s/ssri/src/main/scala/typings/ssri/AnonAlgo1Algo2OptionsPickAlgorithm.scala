...
trait AnonAlgo1Algo2OptionsPickAlgorithm extends js.Object {
...
object AnonAlgo1Algo2OptionsPickAlgorithm {
  @scala.inline
  def apply(
  ...
  ): AnonAlgo1Algo2OptionsPickAlgorithm = {
    ...
    __obj.asInstanceOf[AnonAlgo1Algo2OptionsPickAlgorithm]
  }
}
