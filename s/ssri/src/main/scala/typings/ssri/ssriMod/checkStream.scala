...
object checkStream extends js.Object {
  def apply(stream: Readable, sri: String): js.Promise[Hash] = js.native
  ...
  def apply(stream: Readable, sri: HashLike): js.Promise[Hash] = js.native
  ...
  def apply(stream: Readable, sri: IntegrityLike): js.Promise[Hash] = js.native
