...
import typings.sailsDotIoDotJs.sailsDotIoDotJsStrings.polling
import typings.sailsDotIoDotJs.sailsDotIoDotJsStrings.production
import typings.sailsDotIoDotJs.sailsDotIoDotJsStrings.websocket
