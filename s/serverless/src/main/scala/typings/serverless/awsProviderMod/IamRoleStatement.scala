...
object IamRoleStatement {
  ...
  extension [Self <: IamRoleStatement](x: Self) {
    ...
    inline def setNotAction(value: String | js.Array[String] | StringDictionary[js.Any]): Self = StObject.set(x, "NotAction", value.asInstanceOf[js.Any])
    ...
    inline def setNotResource(value: String | js.Array[String] | StringDictionary[js.Any]): Self = StObject.set(x, "NotResource", value.asInstanceOf[js.Any])
