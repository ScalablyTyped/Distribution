...
object ResourcePolicy {
  ...
  extension [Self <: ResourcePolicy](x: Self) {
    ...
    inline def setAction(value: String | js.Array[String] | StringDictionary[js.Any]): Self = StObject.set(x, "Action", value.asInstanceOf[js.Any])
    
    inline def setActionUndefined: Self = StObject.set(x, "Action", js.undefined)
    
    inline def setActionVarargs(value: String*): Self = StObject.set(x, "Action", js.Array(value :_*))
    
    inline def setCondition(value: StringDictionary[js.Any]): Self = StObject.set(x, "Condition", value.asInstanceOf[js.Any])
    
    inline def setConditionUndefined: Self = StObject.set(x, "Condition", js.undefined)
    
    inline def setEffect(value: Allow | Deny): Self = StObject.set(x, "Effect", value.asInstanceOf[js.Any])
    
    inline def setPrincipal(value: String | js.Array[String] | StringDictionary[js.Any]): Self = StObject.set(x, "Principal", value.asInstanceOf[js.Any])
    
    inline def setPrincipalUndefined: Self = StObject.set(x, "Principal", js.undefined)
    
    inline def setPrincipalVarargs(value: String*): Self = StObject.set(x, "Principal", js.Array(value :_*))
    
    inline def setResource(value: String | js.Array[String] | StringDictionary[js.Any]): Self = StObject.set(x, "Resource", value.asInstanceOf[js.Any])
