...
trait Utils extends js.Object {
  ...
  def logStat(serverless: typings.serverless.serverlessMod.^, context: String): js.Thenable[js.Object]
...
object Utils {
  ...
  def apply(
    ...
    getVersion: () => String,
    logStat: (typings.serverless.serverlessMod.^, String) => js.Thenable[js.Object],
