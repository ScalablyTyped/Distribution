...
object classesUtilsMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    override def logStat(serverless: typings.serverless.mod.^, context: String): PromiseLike[js.Object] = js.native
  ...
  trait Utils extends StObject {
    ...
    def logStat(serverless: typings.serverless.mod.^, context: String): PromiseLike[js.Object]
  ...
  object Utils {
    ...
    inline def apply(
      ...
      getVersion: () => String,
      logStat: (typings.serverless.mod.^, String) => PromiseLike[js.Object],
    ...
    extension [Self <: Utils](x: Self) {
      ...
      inline def setLogStat(value: (typings.serverless.mod.^, String) => PromiseLike[js.Object]): Self = StObject.set(x, "logStat", js.Any.fromFunction2(value))
