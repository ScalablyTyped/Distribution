package typings
package stropheDotJsLib.stropheDotJsMod.Global
...
@JSGlobal("Strophe")
@js.native
object Strophe extends js.Object {
  ...
  var Connection: org.scalablytyped.runtime.Instantiable2[
    ...
    js.UndefOr[/* options */ stropheDotJsLib.stropheDotJsMod.StropheNs.ConnectionOptions], 
  ...
  /** Constants: SASL mechanisms
    ...
    */
  val SASLAnonymous: stropheDotJsLib.stropheDotJsMod.StropheNs.SASLMechanism = js.native
  val SASLMD5: stropheDotJsLib.stropheDotJsMod.StropheNs.SASLMechanism = js.native
  val SASLPlain: stropheDotJsLib.stropheDotJsMod.StropheNs.SASLMechanism = js.native
  val SASLSHA1: stropheDotJsLib.stropheDotJsMod.StropheNs.SASLMechanism = js.native
  /** Constant: VERSION
  ...
  /** Function: log
    ...
    *    (String) msg - The log message.
    */
  def log(level: stropheDotJsLib.stropheDotJsMod.StropheNs.LogLevel, msg: java.lang.String): scala.Unit = js.native
  /** Function: serialize
  ...
  def serialize(elem: stropheDotJsLib.stropheDotJsMod.StropheNs.Builder): java.lang.String = js.native
