package typings.stropheDotJs.stropheDotJsMod._Global_.Strophe

import org.scalablytyped.runtime.Instantiable2
import typings.std.Document
import typings.std.Element
import typings.std.Text
import typings.stropheDotJs.Anon_AUTH
...
object ^ extends js.Object {
  ...
  var Builder: Instantiable2[
    ...
    typings.stropheDotJs.stropheDotJsMod.Strophe.Builder
  ] = js.native
  ...
  var Connection: Instantiable2[
    /* service */ String, 
    js.UndefOr[/* options */ typings.stropheDotJs.stropheDotJsMod.Strophe.ConnectionOptions], 
    typings.stropheDotJs.stropheDotJsMod.Strophe.Connection
  ] = js.native
  ...
  /** Constants: SASL mechanisms
    ...
    */
  val SASLAnonymous: typings.stropheDotJs.stropheDotJsMod.Strophe.SASLMechanism = js.native
  val SASLMD5: typings.stropheDotJs.stropheDotJsMod.Strophe.SASLMechanism = js.native
  val SASLPlain: typings.stropheDotJs.stropheDotJsMod.Strophe.SASLMechanism = js.native
  val SASLSHA1: typings.stropheDotJs.stropheDotJsMod.Strophe.SASLMechanism = js.native
  /** Constant: VERSION
  ...
  /** Function: log
    ...
    *    (String) msg - The log message.
    */
  def log(level: typings.stropheDotJs.stropheDotJsMod.Strophe.LogLevel, msg: String): Unit = js.native
  /** Function: serialize
  ...
  def serialize(elem: typings.stropheDotJs.stropheDotJsMod.Strophe.Builder): String = js.native
