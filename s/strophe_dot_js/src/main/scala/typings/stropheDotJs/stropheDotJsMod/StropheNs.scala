...
import typings.stropheDotJs.Anon_MatchBare
import typings.stropheDotJs.stropheDotJsMod.StropheNs.Builder
import typings.stropheDotJs.stropheDotJsMod.StropheNs.Connection
import typings.stropheDotJs.stropheDotJsMod.StropheNs.ConnectionOptions
import typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel
import typings.stropheDotJs.stropheDotJsMod.StropheNs.SASLMechanism
import typings.stropheDotJs.stropheDotJsMod.StropheNs.Status
...
object StropheNs extends js.Object {
  ...
  object LogLevel extends js.Object {
    ...
    /* 0 */ val DEBUG: typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel.DEBUG with Double = js.native
    /* 3 */ val ERROR: typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel.ERROR with Double = js.native
    /* 4 */ val FATAL: typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel.FATAL with Double = js.native
    /* 1 */ val INFO: typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel.INFO with Double = js.native
    /* 2 */ val WARN: typings.stropheDotJs.stropheDotJsMod.StropheNs.LogLevel.WARN with Double = js.native
    @JSBracketAccess
  ...
  object Status extends js.Object {
    ...
    /* 8 */ val ATTACHED: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.ATTACHED with Double = js.native
    /* 3 */ val AUTHENTICATING: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.AUTHENTICATING with Double = js.native
    /* 4 */ val AUTHFAIL: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.AUTHFAIL with Double = js.native
    /* 5 */ val CONNECTED: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.CONNECTED with Double = js.native
    /* 1 */ val CONNECTING: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.CONNECTING with Double = js.native
    /* 2 */ val CONNFAIL: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.CONNFAIL with Double = js.native
    /* 10 */ val CONNTIMEOUT: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.CONNTIMEOUT with Double = js.native
    /* 6 */ val DISCONNECTED: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.DISCONNECTED with Double = js.native
    /* 7 */ val DISCONNECTING: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.DISCONNECTING with Double = js.native
    /* 0 */ val ERROR: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.ERROR with Double = js.native
    /* 9 */ val REDIRECT: typings.stropheDotJs.stropheDotJsMod.StropheNs.Status.REDIRECT with Double = js.native
    @JSBracketAccess
