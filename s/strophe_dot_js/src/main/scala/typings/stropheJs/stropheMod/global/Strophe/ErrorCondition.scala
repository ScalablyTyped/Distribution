...
object ErrorCondition extends StObject {
  ...
  sealed trait BAD_FORMAT
    extends StObject
       with ErrorCondition
  /* "bad-format" */ val BAD_FORMAT: typings.stropheJs.stropheMod.global.Strophe.ErrorCondition.BAD_FORMAT & String = js.native
  
  @js.native
  sealed trait CONFLICT
    extends StObject
       with ErrorCondition
  /* "conflict" */ val CONFLICT: typings.stropheJs.stropheMod.global.Strophe.ErrorCondition.CONFLICT & String = js.native
  
  @js.native
  sealed trait MISSING_JID_NODE
    extends StObject
       with ErrorCondition
  /* "x-strophe-bad-non-anon-jid" */ val MISSING_JID_NODE: typings.stropheJs.stropheMod.global.Strophe.ErrorCondition.MISSING_JID_NODE & String = js.native
  
  @js.native
  sealed trait NO_AUTH_MECH
    extends StObject
       with ErrorCondition
  /* "no-auth-mech" */ val NO_AUTH_MECH: typings.stropheJs.stropheMod.global.Strophe.ErrorCondition.NO_AUTH_MECH & String = js.native
  
  @js.native
  sealed trait UNKNOWN_REASON
    extends StObject
       with ErrorCondition
  /* "unknown" */ val UNKNOWN_REASON: typings.stropheJs.stropheMod.global.Strophe.ErrorCondition.UNKNOWN_REASON & String = js.native
}
