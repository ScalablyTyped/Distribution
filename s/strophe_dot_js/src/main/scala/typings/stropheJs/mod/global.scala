...
object global {
  ...
  object Strophe {
    ...
    object LogLevel extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.stropheJs.mod.Strophe.LogLevel with Double] = js.native
    ...
    object Status extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.stropheJs.mod.Strophe.Status with Double] = js.native
