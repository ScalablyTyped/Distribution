...
object global {
  ...
  object Strophe {
    ...
    /** Function: log
      ...
      *    (String) msg - The log message.
      */
    inline def log(level: typings.stropheJs.mod.Strophe.LogLevel, msg: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("log")(level.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def serialize(elem: typings.stropheJs.mod.Strophe.Builder): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serialize")(elem.asInstanceOf[js.Any]).asInstanceOf[String]
