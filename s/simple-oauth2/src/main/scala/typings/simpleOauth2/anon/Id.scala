...
object Id {
  @scala.inline
  def apply[/* <: java.lang.String */ ClientIdName](id: String, secret: String): Id[ClientIdName] = {
  ...
  @scala.inline
  implicit class IdOps[Self <: Id[_], /* <: java.lang.String */ ClientIdName] (val x: Self with Id[ClientIdName]) extends AnyVal {
    @scala.inline
