...
import typings.simpleOauth2.simpleOauth2Strings.Anon_AuthorizeURL
...
trait AnonAuthorizeURL[ClientIdName /* <: String */] extends js.Object {
  ...
  def authorizeURL(params: Anon_AuthorizeURL with js.Any with AnonRedirecturi): String = js.native
