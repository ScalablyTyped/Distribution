...
object PromotionSnake {
  
  inline def apply(): PromotionSnake = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PromotionSnake]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PromotionSnake] (val x: Self) extends AnyVal {
