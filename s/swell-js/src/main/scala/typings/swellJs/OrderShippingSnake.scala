...
trait OrderShippingSnake extends StObject {
...
object OrderShippingSnake {
  
  inline def apply(): OrderShippingSnake = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrderShippingSnake]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OrderShippingSnake] (val x: Self) extends AnyVal {
