...
object CartItemSnake {
  
  inline def apply(): CartItemSnake = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CartItemSnake]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CartItemSnake] (val x: Self) extends AnyVal {
