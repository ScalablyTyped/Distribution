...
object typesOrderCamelMod {
  
  /* Inlined {[ K in keyof swell-js.OrderSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.OrderSnake[K]} */
  trait OrderCamel extends StObject {
  ...
  object OrderCamel {
    ...
    inline def apply(): OrderCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OrderCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OrderCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.OrderGiftCardSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.OrderGiftCardSnake[K]} */
  trait OrderGiftCardCamel extends StObject {
  ...
  object OrderGiftCardCamel {
    
    inline def apply(): OrderGiftCardCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OrderGiftCardCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OrderGiftCardCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.OrderItemSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.OrderItemSnake[K]} */
  trait OrderItemCamel extends StObject {
  ...
  object OrderItemCamel {
    
    inline def apply(): OrderItemCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OrderItemCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OrderItemCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.OrderOptionSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.OrderOptionSnake[K]} */
  trait OrderOptionCamel extends StObject {
  ...
  object OrderOptionCamel {
    
    inline def apply(value_id: String): OrderOptionCamel = {
      val __obj = js.Dynamic.literal(value_id = value_id.asInstanceOf[js.Any])
      __obj.asInstanceOf[OrderOptionCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OrderOptionCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.OrderShippingSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.OrderShippingSnake[K]} */
  trait OrderShippingCamel extends StObject {
  ...
  object OrderShippingCamel {
    
    inline def apply(): OrderShippingCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OrderShippingCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: OrderShippingCamel] (val x: Self) extends AnyVal {
