...
object typesRefundCamelMod {
  
  /* Inlined {[ K in keyof swell-js.swell-js/types/refund/snake.RefundSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.swell-js/types/refund/snake.RefundSnake[K]} */
  trait RefundCamel extends StObject {
  ...
  object RefundCamel {
    ...
    inline def apply(error: Code, parent: Payment, subscription: Subscription): RefundCamel = {
      ...
      __obj.asInstanceOf[RefundCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: RefundCamel] (val x: Self) extends AnyVal {
