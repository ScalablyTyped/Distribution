...
import typings.swellJs.typesPurchaseLinkSnakeMod.PurchaseLinkDiscountSnake
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesPurchaseLinkCamelMod {
  
  /* Inlined {[ K in keyof swell-js.swell-js/types/purchase_link/snake.PurchaseLinkSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.swell-js/types/purchase_link/snake.PurchaseLinkSnake[K]} */
  trait PurchaseLinkCamel extends StObject {
  ...
  object PurchaseLinkCamel {
    
    inline def apply(): PurchaseLinkCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PurchaseLinkCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PurchaseLinkCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.swell-js/types/purchase_link/snake.PurchaseLinkDiscountSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.swell-js/types/purchase_link/snake.PurchaseLinkDiscountSnake[K]} */
  trait PurchaseLinkDiscountCamel extends StObject {
  ...
  object PurchaseLinkDiscountCamel {
    
    inline def apply(): PurchaseLinkDiscountCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PurchaseLinkDiscountCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PurchaseLinkDiscountCamel] (val x: Self) extends AnyVal {
