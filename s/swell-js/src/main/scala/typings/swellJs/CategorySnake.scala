...
object CategorySnake {
  
  inline def apply(description: String, name: String, slug: String): CategorySnake = {
    ...
    __obj.asInstanceOf[CategorySnake]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CategorySnake] (val x: Self) extends AnyVal {
