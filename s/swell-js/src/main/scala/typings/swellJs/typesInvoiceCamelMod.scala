...
object typesInvoiceCamelMod {
  
  /* Inlined {[ K in keyof swell-js.InvoiceSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.InvoiceSnake[K]} */
  trait InvoiceCamel extends StObject {
  ...
  object InvoiceCamel {
    ...
    inline def apply(): InvoiceCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InvoiceCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: InvoiceCamel] (val x: Self) extends AnyVal {
