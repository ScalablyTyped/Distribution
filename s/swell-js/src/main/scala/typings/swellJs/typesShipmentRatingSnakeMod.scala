...
object typesShipmentRatingSnakeMod {
  
  trait ShipmentRatingSnake extends StObject {
  ...
  object ShipmentRatingSnake {
    
    inline def apply(): ShipmentRatingSnake = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ShipmentRatingSnake]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ShipmentRatingSnake] (val x: Self) extends AnyVal {
  ...
  trait ShipmentServiceSnake extends StObject {
  ...
  object ShipmentServiceSnake {
    
    inline def apply(): ShipmentServiceSnake = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ShipmentServiceSnake]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ShipmentServiceSnake] (val x: Self) extends AnyVal {
