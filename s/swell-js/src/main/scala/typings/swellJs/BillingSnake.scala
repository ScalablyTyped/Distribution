...
trait BillingSnake extends StObject {
...
object BillingSnake {
  ...
  inline def apply(): BillingSnake = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BillingSnake]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BillingSnake] (val x: Self) extends AnyVal {
