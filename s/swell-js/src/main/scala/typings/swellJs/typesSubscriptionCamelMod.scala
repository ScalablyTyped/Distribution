...
object typesSubscriptionCamelMod {
  
  /* Inlined {[ K in keyof swell-js.SubscriptionBillingScheduleSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.SubscriptionBillingScheduleSnake[K]} */
  trait SubscriptionBillingScheduleCamel extends StObject {
  ...
  object SubscriptionBillingScheduleCamel {
    
    inline def apply(): SubscriptionBillingScheduleCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SubscriptionBillingScheduleCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SubscriptionBillingScheduleCamel] (val x: Self) extends AnyVal {
  ...
  /* Inlined {[ K in keyof swell-js.SubscriptionSnake as swell-js.swell-js.SnakeToCamelCase<K> ]: swell-js.SubscriptionSnake[K]} */
  trait SubscriptionCamel extends StObject {
  ...
  object SubscriptionCamel {
    
    inline def apply(): SubscriptionCamel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SubscriptionCamel]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SubscriptionCamel] (val x: Self) extends AnyVal {
