...
trait TranspileOnlyResults extends StObject {
...
object TranspileOnlyResults {
  
  inline def apply(diagnostics: js.Array[Diagnostic], output: String, sourceMap: Any): TranspileOnlyResults = {
    ...
    __obj.asInstanceOf[TranspileOnlyResults]
  }
  
  extension [Self <: TranspileOnlyResults](x: Self) {
