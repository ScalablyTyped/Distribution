...
/* Inlined @stencil/core.@stencil/core/internal/stencil-public-compiler.RequireFields<@stencil/core.@stencil/core/internal/stencil-public-compiler.Config, @stencil/core.@stencil/core/internal/stencil-public-compiler.StrictConfigFields> */
trait ValidatedConfig extends StObject {
  ...
  var devServer: js.UndefOr[DevServerConfig] = js.undefined
  ...
  var flags: js.UndefOr[ConfigFlags] & ConfigFlags
  ...
  /**
    ...
    */
  var logger: js.UndefOr[Logger] & Logger
  ...
  /**
    ...
    */
  var outputTargets: js.UndefOr[js.Array[OutputTarget]] & js.Array[OutputTarget]
  ...
  var sys: js.UndefOr[CompilerSystem] & CompilerSystem
  ...
  var testing: js.UndefOr[TestingConfig] & TestingConfig
...
object ValidatedConfig {
  ...
  inline def apply(
    flags: js.UndefOr[ConfigFlags] & ConfigFlags,
    logger: js.UndefOr[Logger] & Logger,
    outputTargets: js.UndefOr[js.Array[OutputTarget]] & js.Array[OutputTarget],
    rootDir: js.UndefOr[String] & String,
    sys: js.UndefOr[CompilerSystem] & CompilerSystem,
    testing: js.UndefOr[TestingConfig] & TestingConfig
  ): ValidatedConfig = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], logger = logger.asInstanceOf[js.Any], outputTargets = outputTargets.asInstanceOf[js.Any], rootDir = rootDir.asInstanceOf[js.Any], sys = sys.asInstanceOf[js.Any], testing = testing.asInstanceOf[js.Any])
    __obj.asInstanceOf[ValidatedConfig]
  }
  
  extension [Self <: ValidatedConfig](x: Self) {
    ...
    inline def setFlags(value: js.UndefOr[ConfigFlags] & ConfigFlags): Self = StObject.set(x, "flags", value.asInstanceOf[js.Any])
    ...
    inline def setLogger(value: js.UndefOr[Logger] & Logger): Self = StObject.set(x, "logger", value.asInstanceOf[js.Any])
    ...
    inline def setOutputTargets(value: js.UndefOr[js.Array[OutputTarget]] & js.Array[OutputTarget]): Self = StObject.set(x, "outputTargets", value.asInstanceOf[js.Any])
    ...
    inline def setSys(value: js.UndefOr[CompilerSystem] & CompilerSystem): Self = StObject.set(x, "sys", value.asInstanceOf[js.Any])
    ...
    inline def setTesting(value: js.UndefOr[TestingConfig] & TestingConfig): Self = StObject.set(x, "testing", value.asInstanceOf[js.Any])
