...
trait ErrorCharStart extends StObject {
...
object ErrorCharStart {
  
  inline def apply(errorCharStart: Double, lineIndex: Double, lineNumber: Double): ErrorCharStart = {
    ...
    __obj.asInstanceOf[ErrorCharStart]
  }
  
  extension [Self <: ErrorCharStart](x: Self) {
