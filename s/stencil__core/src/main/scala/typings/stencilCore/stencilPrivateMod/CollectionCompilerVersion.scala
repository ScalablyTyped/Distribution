...
trait CollectionCompilerVersion extends StObject {
...
object CollectionCompilerVersion {
  
  inline def apply(name: String, version: String): CollectionCompilerVersion = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    __obj.asInstanceOf[CollectionCompilerVersion]
  }
  
  extension [Self <: CollectionCompilerVersion](x: Self) {
