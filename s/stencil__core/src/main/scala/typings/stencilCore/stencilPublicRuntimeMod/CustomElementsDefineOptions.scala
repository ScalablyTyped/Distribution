...
trait CustomElementsDefineOptions extends StObject {
  ...
  var ce: js.UndefOr[
    js.Function2[/* eventName */ String, /* opts */ js.UndefOr[Any], CustomEvent[Any]]
  ] = js.undefined
...
object CustomElementsDefineOptions {
  ...
  extension [Self <: CustomElementsDefineOptions](x: Self) {
    ...
    inline def setCe(value: (/* eventName */ String, /* opts */ js.UndefOr[Any]) => CustomEvent[Any]): Self = StObject.set(x, "ce", js.Any.fromFunction2(value))
