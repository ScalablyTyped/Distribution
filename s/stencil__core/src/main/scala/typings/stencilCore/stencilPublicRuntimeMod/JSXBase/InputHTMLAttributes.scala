...
object InputHTMLAttributes {
  ...
  extension [Self <: InputHTMLAttributes[?], T](x: Self & InputHTMLAttributes[T]) {
    ...
    inline def setAllowdirs(value: Boolean): Self = StObject.set(x, "allowdirs", value.asInstanceOf[js.Any])
    
    inline def setAllowdirsUndefined: Self = StObject.set(x, "allowdirs", js.undefined)
    ...
    inline def setSelectionDirection(value: String): Self = StObject.set(x, "selectionDirection", value.asInstanceOf[js.Any])
    
    inline def setSelectionDirectionUndefined: Self = StObject.set(x, "selectionDirection", js.undefined)
    
    inline def setSelectionEnd(value: Double | String): Self = StObject.set(x, "selectionEnd", value.asInstanceOf[js.Any])
    
    inline def setSelectionEndUndefined: Self = StObject.set(x, "selectionEnd", js.undefined)
    
    inline def setSelectionStart(value: Double | String): Self = StObject.set(x, "selectionStart", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitdirectoryUndefined: Self = StObject.set(x, "webkitdirectory", js.undefined)
