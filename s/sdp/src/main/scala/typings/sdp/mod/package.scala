...
package object mod {
  ...
  @scala.inline
  def writeSessionBoilerplate(sessId: js.UndefOr[scala.Nothing], sessVer: js.UndefOr[scala.Nothing], sessUser: java.lang.String): typings.sdp.mod.SDPBlob = (typings.sdp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("writeSessionBoilerplate")(sessId.asInstanceOf[js.Any], sessVer.asInstanceOf[js.Any], sessUser.asInstanceOf[js.Any])).asInstanceOf[typings.sdp.mod.SDPBlob]
  @scala.inline
  def writeSessionBoilerplate(sessId: js.UndefOr[scala.Nothing], sessVer: scala.Double): typings.sdp.mod.SDPBlob = (typings.sdp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("writeSessionBoilerplate")(sessId.asInstanceOf[js.Any], sessVer.asInstanceOf[js.Any])).asInstanceOf[typings.sdp.mod.SDPBlob]
  @scala.inline
  def writeSessionBoilerplate(sessId: js.UndefOr[scala.Nothing], sessVer: scala.Double, sessUser: java.lang.String): typings.sdp.mod.SDPBlob = (typings.sdp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("writeSessionBoilerplate")(sessId.asInstanceOf[js.Any], sessVer.asInstanceOf[js.Any], sessUser.asInstanceOf[js.Any])).asInstanceOf[typings.sdp.mod.SDPBlob]
  @scala.inline
  ...
  @scala.inline
  def writeSessionBoilerplate(sessId: java.lang.String, sessVer: js.UndefOr[scala.Nothing], sessUser: java.lang.String): typings.sdp.mod.SDPBlob = (typings.sdp.mod.^.asInstanceOf[js.Dynamic].applyDynamic("writeSessionBoilerplate")(sessId.asInstanceOf[js.Any], sessVer.asInstanceOf[js.Any], sessUser.asInstanceOf[js.Any])).asInstanceOf[typings.sdp.mod.SDPBlob]
  @scala.inline
