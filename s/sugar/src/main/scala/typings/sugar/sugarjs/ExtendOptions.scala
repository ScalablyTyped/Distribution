...
object ExtendOptions {
  ...
  extension [Self <: ExtendOptions](x: Self) {
    ...
    inline def setExcept(value: typings.sugar.Array[java.lang.String | NativeConstructor]): Self = StObject.set(x, "except", value.asInstanceOf[js.Any])
    
    inline def setExceptUndefined: Self = StObject.set(x, "except", js.undefined)
    
    inline def setMethods(value: typings.sugar.Array[java.lang.String]): Self = StObject.set(x, "methods", value.asInstanceOf[js.Any])
    
    inline def setMethodsUndefined: Self = StObject.set(x, "methods", js.undefined)
    
    inline def setNamespaces(value: typings.sugar.Array[NativeConstructor]): Self = StObject.set(x, "namespaces", value.asInstanceOf[js.Any])
