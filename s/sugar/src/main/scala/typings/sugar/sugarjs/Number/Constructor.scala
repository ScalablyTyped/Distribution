...
trait Constructor
  ...
  def dayAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def dayAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def dayBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def dayBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def daysAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def daysAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def daysBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def daysBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def hourAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def hourAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def hourBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def hourBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def hoursAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def hoursAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def hoursBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def hoursBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def millisecondAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def millisecondAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def millisecondBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def millisecondBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def millisecondsAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def millisecondsAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def millisecondsBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def millisecondsBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def minuteAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def minuteAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def minuteBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def minuteBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def minutesAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def minutesAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def minutesBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def minutesBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def monthAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def monthAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def monthBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def monthBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def monthsAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def monthsAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def monthsBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def monthsBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def secondAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def secondAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def secondBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def secondBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def secondsAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def secondsAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def secondsBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def secondsBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def weekAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def weekAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def weekBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def weekBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def weeksAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def weeksAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def weeksBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def weeksBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def yearAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def yearAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def yearBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def yearBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def yearsAfter(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def yearsAfter(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
  ...
  def yearsBefore(instance: Double, d: java.lang.String): typings.std.Date = js.native
  def yearsBefore(instance: Double, d: java.lang.String, options: DateCreateOptions): typings.std.Date = js.native
