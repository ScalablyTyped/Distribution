...
trait Sugar extends js.Object {
  ...
  def Date(d: typings.std.Date, options: DateCreateOptions): typings.sugar.sugarjs.Date.Chainable[typings.std.Date] = js.native
  def Function(): typings.sugar.sugarjs.Function.Chainable[js.Function] = js.native
  def Function(raw: js.Function): typings.sugar.sugarjs.Function.Chainable[js.Function] = js.native
  ...
  def RegExp(): typings.sugar.sugarjs.RegExp.Chainable[typings.std.RegExp] = js.native
