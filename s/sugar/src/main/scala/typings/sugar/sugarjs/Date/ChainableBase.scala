...
trait ChainableBase[RawValue] extends js.Object {
  ...
  def advance(set: String): SugarDefaultChainable[typings.std.Date] = js.native
  def advance(set: String, reset: Boolean): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def beginningOfDay(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def beginningOfMonth(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  def beginningOfWeek(): SugarDefaultChainable[typings.std.Date] = js.native
  def beginningOfWeek(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  def beginningOfYear(): SugarDefaultChainable[typings.std.Date] = js.native
  def beginningOfYear(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def endOfDay(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def endOfMonth(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  def endOfWeek(): SugarDefaultChainable[typings.std.Date] = js.native
  def endOfWeek(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  def endOfYear(): SugarDefaultChainable[typings.std.Date] = js.native
  def endOfYear(localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def get(d: String): SugarDefaultChainable[typings.std.Date] = js.native
  def get(d: String, options: DateCreateOptions): SugarDefaultChainable[typings.std.Date] = js.native
  ...
  def isBetween(d1: String, d2: typings.std.Date): SugarDefaultChainable[Boolean] = js.native
  def isBetween(d1: String, d2: typings.std.Date, margin: Double): SugarDefaultChainable[Boolean] = js.native
  ...
  def isBetween(d1: typings.std.Date, d2: String): SugarDefaultChainable[Boolean] = js.native
  def isBetween(d1: typings.std.Date, d2: String, margin: Double): SugarDefaultChainable[Boolean] = js.native
  ...
  def relativeTo(d: typings.std.Date): SugarDefaultChainable[String] = js.native
  def relativeTo(d: typings.std.Date, localeCode: String): SugarDefaultChainable[String] = js.native
  def reset(): SugarDefaultChainable[typings.std.Date] = js.native
  def reset(unit: String): SugarDefaultChainable[typings.std.Date] = js.native
  def reset(unit: String, localeCode: String): SugarDefaultChainable[typings.std.Date] = js.native
  def rewind(milliseconds: Double): SugarDefaultChainable[typings.std.Date] = js.native
  def rewind(set: String): SugarDefaultChainable[typings.std.Date] = js.native
  def rewind(set: String, reset: Boolean): SugarDefaultChainable[typings.std.Date] = js.native
