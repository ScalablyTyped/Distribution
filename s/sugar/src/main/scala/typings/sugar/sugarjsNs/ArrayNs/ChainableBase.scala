package typings.sugar.sugarjsNs.ArrayNs
...
trait ChainableBase[T, RawValue] extends js.Object {
  ...
  def least[U](all: Boolean, map: String): SugarDefaultChainable[js.Array[T]] = js.native
  def least[U](all: Boolean, map: mapFn[T, U]): SugarDefaultChainable[js.Array[T]] = js.native
  def least[U](map: String): SugarDefaultChainable[js.Array[T]] = js.native
  ...
  def map[U](map: String): SugarDefaultChainable[js.Array[U]] = js.native
  def map[U](map: String, context: js.Any): SugarDefaultChainable[js.Array[U]] = js.native
  ...
  def most[U](all: Boolean, map: String): SugarDefaultChainable[js.Array[T]] = js.native
  def most[U](all: Boolean, map: mapFn[T, U]): SugarDefaultChainable[js.Array[T]] = js.native
  def most[U](map: String): SugarDefaultChainable[js.Array[T]] = js.native
  ...
  def sortBy[U](map: String): SugarDefaultChainable[js.Array[T]] = js.native
  def sortBy[U](map: String, desc: Boolean): SugarDefaultChainable[js.Array[T]] = js.native
  ...
  def unique[U](map: String): SugarDefaultChainable[js.Array[T]] = js.native
