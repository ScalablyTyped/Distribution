...
trait Constructor
  ...
  def isArray(instance: js.Any): /* is std.Array<any> */ Boolean = js.native
  def isBoolean(instance: js.Any): /* is boolean */ Boolean = js.native
  def isDate(instance: js.Any): /* is std.Date */ Boolean = js.native
  ...
  def isFunction(instance: js.Any): /* is std.Function */ Boolean = js.native
  ...
  def isRegExp(instance: js.Any): /* is std.RegExp */ Boolean = js.native
