...
trait Constructor
  ...
  def isArray(instance: js.Any): /* is Array */scala.Boolean = js.native
  def isBoolean(instance: js.Any): /* is boolean */scala.Boolean = js.native
  def isDate(instance: js.Any): /* is Date */scala.Boolean = js.native
  ...
  def isError(instance: js.Any): /* is Error */scala.Boolean = js.native
  def isFunction(instance: js.Any): /* is Function */scala.Boolean = js.native
  def isMap(instance: js.Any): /* is Map */scala.Boolean = js.native
  def isNumber(instance: js.Any): /* is number */scala.Boolean = js.native
  def isObject(instance: js.Object): scala.Boolean = js.native
  def isRegExp(instance: js.Any): /* is RegExp */scala.Boolean = js.native
  def isSet(instance: js.Any): /* is Set */scala.Boolean = js.native
