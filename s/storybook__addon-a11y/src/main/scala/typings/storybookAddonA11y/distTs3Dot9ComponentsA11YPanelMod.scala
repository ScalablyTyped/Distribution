...
object distTs3Dot9ComponentsA11YPanelMod {
  ...
  object RuleType extends StObject {
    ...
    sealed trait INCOMPLETION
      extends StObject
         with RuleType
    /* 2 */ val INCOMPLETION: typings.storybookAddonA11y.distTs3Dot9ComponentsA11YPanelMod.RuleType.INCOMPLETION & Double = js.native
    
    @js.native
    sealed trait PASS
      extends StObject
         with RuleType
    /* 1 */ val PASS: typings.storybookAddonA11y.distTs3Dot9ComponentsA11YPanelMod.RuleType.PASS & Double = js.native
    
    @js.native
    sealed trait VIOLATION
      extends StObject
         with RuleType
    /* 0 */ val VIOLATION: typings.storybookAddonA11y.distTs3Dot9ComponentsA11YPanelMod.RuleType.VIOLATION & Double = js.native
  }
}
