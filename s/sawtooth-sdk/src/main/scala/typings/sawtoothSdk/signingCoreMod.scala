...
object signingCoreMod {
  
  /* note: abstract class */ @JSImport("sawtooth-sdk/signing/core", "Context")
  @js.native
  ...
  /* note: abstract class */ @JSImport("sawtooth-sdk/signing/core", "PrivateKey")
  @js.native
  ...
  /* note: abstract class */ @JSImport("sawtooth-sdk/signing/core", "PublicKey")
  @js.native
  open class PublicKey () extends StObject {
