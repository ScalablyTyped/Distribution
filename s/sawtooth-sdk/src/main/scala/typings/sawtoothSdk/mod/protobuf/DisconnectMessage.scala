...
object DisconnectMessage {
  ...
  @js.native
  def create(): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.create")
  @js.native
  def create(properties: IDisconnectMessage): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  ...
  @js.native
  def decode(reader: Reader): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.decode")
  @js.native
  def decode(reader: Reader, length: Double): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.decode")
  @js.native
  def decode(reader: Uint8Array): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  ...
  @js.native
  def decodeDelimited(reader: Reader): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  ...
  @js.native
  def fromObject(`object`: StringDictionary[js.Any]): typings.sawtoothSdk.protobufMod.DisconnectMessage = js.native
  ...
  @js.native
  def toObject(message: typings.sawtoothSdk.protobufMod.DisconnectMessage): StringDictionary[js.Any] = js.native
  @JSImport("sawtooth-sdk", "protobuf.DisconnectMessage.toObject")
  @js.native
  def toObject(message: typings.sawtoothSdk.protobufMod.DisconnectMessage, options: IConversionOptions): StringDictionary[js.Any] = js.native
