...
object ConsensusInitializeBlockRequest extends js.Object {
  /**
    ...
    */
  def create(): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  def create(properties: IConsensusInitializeBlockRequest): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  def decode(reader: Reader, length: Double): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  def decode(reader: Uint8Array): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  def decode(reader: Uint8Array, length: Double): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  def decodeDelimited(reader: Uint8Array): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  /**
  ...
  /**
    ...
    * @returns ConsensusInitializeBlockRequest
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest = js.native
  /**
    ...
    */
  def toObject(message: typings.sawtoothSdk.protobufMod.ConsensusInitializeBlockRequest): StringDictionary[js.Any] = js.native
  def toObject(
