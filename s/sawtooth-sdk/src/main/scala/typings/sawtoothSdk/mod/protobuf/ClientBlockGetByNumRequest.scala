...
object ClientBlockGetByNumRequest extends js.Object {
  /**
    ...
    */
  def create(): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  def create(properties: IClientBlockGetByNumRequest): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  def decode(reader: Reader, length: Double): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  def decode(reader: Uint8Array): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  def decode(reader: Uint8Array, length: Double): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  def decodeDelimited(reader: Uint8Array): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  /**
  ...
  /**
    ...
    * @returns ClientBlockGetByNumRequest
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest = js.native
  /**
    ...
    */
  def toObject(message: typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest): StringDictionary[js.Any] = js.native
  def toObject(message: typings.sawtoothSdk.protobufMod.ClientBlockGetByNumRequest, options: IConversionOptions): StringDictionary[js.Any] = js.native
  /**
