...
object ClientBlockListRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBlockListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockListRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBlockListRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBlockListRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBlockListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockListRequest]
  ...
  /**
    ...
    * @returns ClientBlockListRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBlockListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBlockListRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBlockListRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBlockListRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
