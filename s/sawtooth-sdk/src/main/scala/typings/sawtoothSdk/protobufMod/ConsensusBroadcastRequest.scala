...
object ConsensusBroadcastRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusBroadcastRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusBroadcastRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusBroadcastRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusBroadcastRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusBroadcastRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusBroadcastRequest]
  ...
  /**
    ...
    * @returns ConsensusBroadcastRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusBroadcastRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusBroadcastRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusBroadcastRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusBroadcastRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
