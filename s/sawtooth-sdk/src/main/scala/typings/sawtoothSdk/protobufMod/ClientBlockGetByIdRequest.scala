...
object ClientBlockGetByIdRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBlockGetByIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByIdRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBlockGetByIdRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBlockGetByIdRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBlockGetByIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByIdRequest]
  ...
  /**
    ...
    * @returns ClientBlockGetByIdRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBlockGetByIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByIdRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBlockGetByIdRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBlockGetByIdRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
