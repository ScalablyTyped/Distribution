...
object ConsensusNotifyPeerDisconnected {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ConsensusNotifyPeerDisconnected = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerDisconnected]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusNotifyPeerDisconnected = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusNotifyPeerDisconnected]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusNotifyPeerDisconnected = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerDisconnected]
  /**
  ...
  /**
    ...
    * @returns ConsensusNotifyPeerDisconnected
    */
  inline def fromObject(`object`: StringDictionary[Any]): ConsensusNotifyPeerDisconnected = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerDisconnected]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusNotifyPeerDisconnected): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ConsensusNotifyPeerDisconnected, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
