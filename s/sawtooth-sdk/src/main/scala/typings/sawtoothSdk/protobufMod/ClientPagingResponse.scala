...
object ClientPagingResponse {
  ...
  inline def decode(reader: Uint8Array): ClientPagingResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPagingResponse]
  inline def decode(reader: Uint8Array, length: Double): ClientPagingResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientPagingResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientPagingResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPagingResponse]
  ...
  /**
    ...
    * @returns ClientPagingResponse
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientPagingResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientPagingResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientPagingResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientPagingResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
