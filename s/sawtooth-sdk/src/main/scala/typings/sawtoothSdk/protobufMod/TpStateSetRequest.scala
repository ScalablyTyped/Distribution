...
object TpStateSetRequest {
  ...
  inline def decode(reader: Uint8Array): TpStateSetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateSetRequest]
  inline def decode(reader: Uint8Array, length: Double): TpStateSetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpStateSetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): TpStateSetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateSetRequest]
  ...
  /**
    ...
    * @returns TpStateSetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): TpStateSetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpStateSetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: TpStateSetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: TpStateSetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
