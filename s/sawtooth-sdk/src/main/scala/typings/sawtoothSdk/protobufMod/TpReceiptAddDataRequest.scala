...
object TpReceiptAddDataRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): TpReceiptAddDataRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpReceiptAddDataRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): TpReceiptAddDataRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpReceiptAddDataRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): TpReceiptAddDataRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpReceiptAddDataRequest]
  /**
  ...
  /**
    ...
    * @returns TpReceiptAddDataRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): TpReceiptAddDataRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpReceiptAddDataRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: TpReceiptAddDataRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: TpReceiptAddDataRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
