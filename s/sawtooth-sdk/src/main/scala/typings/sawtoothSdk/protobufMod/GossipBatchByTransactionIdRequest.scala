...
object GossipBatchByTransactionIdRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): GossipBatchByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[GossipBatchByTransactionIdRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): GossipBatchByTransactionIdRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[GossipBatchByTransactionIdRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): GossipBatchByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[GossipBatchByTransactionIdRequest]
  /**
  ...
  /**
    ...
    * @returns GossipBatchByTransactionIdRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): GossipBatchByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[GossipBatchByTransactionIdRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: GossipBatchByTransactionIdRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: GossipBatchByTransactionIdRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
