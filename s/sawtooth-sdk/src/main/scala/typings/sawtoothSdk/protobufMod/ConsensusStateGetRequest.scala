...
object ConsensusStateGetRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusStateGetRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusStateGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusStateGetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusStateGetRequest]
  ...
  /**
    ...
    * @returns ConsensusStateGetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusStateGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusStateGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusStateGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
