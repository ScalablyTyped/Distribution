...
object ConsensusSettingsGetRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusSettingsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusSettingsGetRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusSettingsGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusSettingsGetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusSettingsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusSettingsGetRequest]
  ...
  /**
    ...
    * @returns ConsensusSettingsGetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusSettingsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusSettingsGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusSettingsGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusSettingsGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
