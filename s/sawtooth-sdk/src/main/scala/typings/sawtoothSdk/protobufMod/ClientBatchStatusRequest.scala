...
object ClientBatchStatusRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBatchStatusRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchStatusRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBatchStatusRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBatchStatusRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBatchStatusRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchStatusRequest]
  ...
  /**
    ...
    * @returns ClientBatchStatusRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBatchStatusRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBatchStatusRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBatchStatusRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBatchStatusRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
