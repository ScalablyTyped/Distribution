...
object DisconnectMessage {
  ...
  inline def decode(reader: Uint8Array): DisconnectMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[DisconnectMessage]
  inline def decode(reader: Uint8Array, length: Double): DisconnectMessage = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[DisconnectMessage]
  ...
  inline def decodeDelimited(reader: Uint8Array): DisconnectMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[DisconnectMessage]
  ...
  /**
    ...
    * @returns DisconnectMessage
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): DisconnectMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[DisconnectMessage]
  ...
  /**
    ...
    */
  inline def toObject(message: DisconnectMessage): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: DisconnectMessage, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
