...
object ClientEventsGetRequest {
  ...
  /**
    ...
    */
  @scala.inline
  def create(): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ClientEventsGetRequest]
  @scala.inline
  def create(properties: IClientEventsGetRequest): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def decode(reader: Reader): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  @scala.inline
  def decode(reader: Reader, length: Double): ClientEventsGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsGetRequest]
  @scala.inline
  def decode(reader: Uint8Array): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): ClientEventsGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsGetRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def decodeDelimited(reader: Reader): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): ClientEventsGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def toObject(message: ClientEventsGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: ClientEventsGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
