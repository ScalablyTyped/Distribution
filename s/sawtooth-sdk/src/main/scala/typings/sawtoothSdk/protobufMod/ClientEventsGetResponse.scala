...
object ClientEventsGetResponse {
  ...
  inline def decode(reader: Uint8Array): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  inline def decode(reader: Uint8Array, length: Double): ClientEventsGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsGetResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  ...
  /**
    ...
    * @returns ClientEventsGetResponse
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientEventsGetResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientEventsGetResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
