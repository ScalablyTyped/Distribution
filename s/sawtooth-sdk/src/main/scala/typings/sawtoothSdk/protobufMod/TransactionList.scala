...
object TransactionList extends js.Object {
  ...
  def decode(reader: Uint8Array): TransactionList = js.native
  def decode(reader: Uint8Array, length: Double): TransactionList = js.native
  ...
  def decodeDelimited(reader: Uint8Array): TransactionList = js.native
