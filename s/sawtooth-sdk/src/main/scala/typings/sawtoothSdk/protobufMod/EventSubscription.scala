...
object EventSubscription {
  ...
  /**
    ...
    */
  @scala.inline
  def create(): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[EventSubscription]
  @scala.inline
  def create(properties: IEventSubscription): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  ...
  /**
    ...
    */
  @scala.inline
  def decode(reader: Reader): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  @scala.inline
  def decode(reader: Reader, length: Double): EventSubscription = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[EventSubscription]
  @scala.inline
  def decode(reader: Uint8Array): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): EventSubscription = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[EventSubscription]
  ...
  /**
    ...
    */
  @scala.inline
  def decodeDelimited(reader: Reader): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): EventSubscription = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[EventSubscription]
  ...
  /**
    ...
    */
  @scala.inline
  def toObject(message: EventSubscription): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: EventSubscription, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
