...
object ConsensusFailBlockRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusFailBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusFailBlockRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusFailBlockRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusFailBlockRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusFailBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusFailBlockRequest]
  ...
  /**
    ...
    * @returns ConsensusFailBlockRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusFailBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusFailBlockRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusFailBlockRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusFailBlockRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
