...
object TpUnregisterResponse {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): TpUnregisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): TpUnregisterResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpUnregisterResponse]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): TpUnregisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterResponse]
  /**
  ...
  /**
    ...
    * @returns TpUnregisterResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): TpUnregisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: TpUnregisterResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: TpUnregisterResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
