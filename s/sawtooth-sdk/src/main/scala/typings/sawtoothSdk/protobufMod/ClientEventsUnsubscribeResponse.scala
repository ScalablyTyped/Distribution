...
object ClientEventsUnsubscribeResponse {
  ...
  inline def decode(reader: Uint8Array): ClientEventsUnsubscribeResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsUnsubscribeResponse]
  inline def decode(reader: Uint8Array, length: Double): ClientEventsUnsubscribeResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsUnsubscribeResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientEventsUnsubscribeResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsUnsubscribeResponse]
  ...
  /**
    ...
    * @returns ClientEventsUnsubscribeResponse
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientEventsUnsubscribeResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientEventsUnsubscribeResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientEventsUnsubscribeResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientEventsUnsubscribeResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
