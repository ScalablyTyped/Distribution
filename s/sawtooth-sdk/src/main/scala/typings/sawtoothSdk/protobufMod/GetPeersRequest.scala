...
object GetPeersRequest {
  ...
  inline def decode(reader: Uint8Array): GetPeersRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[GetPeersRequest]
  inline def decode(reader: Uint8Array, length: Double): GetPeersRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[GetPeersRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): GetPeersRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[GetPeersRequest]
  ...
  /**
    ...
    * @returns GetPeersRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): GetPeersRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[GetPeersRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: GetPeersRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: GetPeersRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
