...
object ConsensusIgnoreBlockRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusIgnoreBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusIgnoreBlockRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusIgnoreBlockRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusIgnoreBlockRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusIgnoreBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusIgnoreBlockRequest]
  ...
  /**
    ...
    * @returns ConsensusIgnoreBlockRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusIgnoreBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusIgnoreBlockRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusIgnoreBlockRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusIgnoreBlockRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
