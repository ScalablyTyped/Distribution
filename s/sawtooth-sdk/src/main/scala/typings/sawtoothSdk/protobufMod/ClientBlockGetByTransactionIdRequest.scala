...
object ClientBlockGetByTransactionIdRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBlockGetByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByTransactionIdRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBlockGetByTransactionIdRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBlockGetByTransactionIdRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBlockGetByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByTransactionIdRequest]
  ...
  /**
    ...
    * @returns ClientBlockGetByTransactionIdRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBlockGetByTransactionIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByTransactionIdRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBlockGetByTransactionIdRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBlockGetByTransactionIdRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
