...
object ConsensusCommitBlockRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusCommitBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusCommitBlockRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusCommitBlockRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusCommitBlockRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusCommitBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusCommitBlockRequest]
  ...
  /**
    ...
    * @returns ConsensusCommitBlockRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusCommitBlockRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusCommitBlockRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusCommitBlockRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusCommitBlockRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
