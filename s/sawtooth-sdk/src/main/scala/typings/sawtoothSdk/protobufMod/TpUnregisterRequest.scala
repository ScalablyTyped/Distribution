...
object TpUnregisterRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): TpUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): TpUnregisterRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpUnregisterRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): TpUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterRequest]
  /**
  ...
  /**
    ...
    * @returns TpUnregisterRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): TpUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpUnregisterRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: TpUnregisterRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: TpUnregisterRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
