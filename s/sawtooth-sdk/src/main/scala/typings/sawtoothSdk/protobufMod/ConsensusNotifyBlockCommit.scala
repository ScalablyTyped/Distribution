...
object ConsensusNotifyBlockCommit {
  ...
  inline def decode(reader: Uint8Array): ConsensusNotifyBlockCommit = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyBlockCommit]
  inline def decode(reader: Uint8Array, length: Double): ConsensusNotifyBlockCommit = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusNotifyBlockCommit]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusNotifyBlockCommit = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyBlockCommit]
  ...
  /**
    ...
    * @returns ConsensusNotifyBlockCommit
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusNotifyBlockCommit = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyBlockCommit]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusNotifyBlockCommit): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusNotifyBlockCommit, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
