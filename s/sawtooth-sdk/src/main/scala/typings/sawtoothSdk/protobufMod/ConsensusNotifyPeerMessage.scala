...
object ConsensusNotifyPeerMessage {
  ...
  inline def decode(reader: Uint8Array): ConsensusNotifyPeerMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerMessage]
  inline def decode(reader: Uint8Array, length: Double): ConsensusNotifyPeerMessage = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusNotifyPeerMessage]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusNotifyPeerMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerMessage]
  ...
  /**
    ...
    * @returns ConsensusNotifyPeerMessage
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusNotifyPeerMessage = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusNotifyPeerMessage]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusNotifyPeerMessage): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusNotifyPeerMessage, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
