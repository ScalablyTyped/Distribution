...
object TpStateDeleteResponse {
  ...
  /**
    ...
    */
  @scala.inline
  def create(): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[TpStateDeleteResponse]
  @scala.inline
  def create(properties: ITpStateDeleteResponse): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  ...
  /**
    ...
    */
  @scala.inline
  def decode(reader: Reader): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  @scala.inline
  def decode(reader: Reader, length: Double): TpStateDeleteResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpStateDeleteResponse]
  @scala.inline
  def decode(reader: Uint8Array): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): TpStateDeleteResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpStateDeleteResponse]
  ...
  /**
    ...
    */
  @scala.inline
  def decodeDelimited(reader: Reader): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): TpStateDeleteResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteResponse]
  ...
  /**
    ...
    */
  @scala.inline
  def toObject(message: TpStateDeleteResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: TpStateDeleteResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
