...
object ConsensusChainHeadGetRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusChainHeadGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusChainHeadGetRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusChainHeadGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusChainHeadGetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusChainHeadGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusChainHeadGetRequest]
  ...
  /**
    ...
    * @returns ConsensusChainHeadGetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusChainHeadGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusChainHeadGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusChainHeadGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusChainHeadGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
