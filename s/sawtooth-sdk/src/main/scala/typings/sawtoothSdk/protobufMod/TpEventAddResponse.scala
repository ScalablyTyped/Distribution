...
object TpEventAddResponse {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): TpEventAddResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpEventAddResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): TpEventAddResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpEventAddResponse]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): TpEventAddResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpEventAddResponse]
  /**
  ...
  /**
    ...
    * @returns TpEventAddResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): TpEventAddResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpEventAddResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: TpEventAddResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: TpEventAddResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
