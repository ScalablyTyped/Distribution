...
object ConsensusRegisterResponse {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ConsensusRegisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusRegisterResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ConsensusRegisterResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusRegisterResponse]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ConsensusRegisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusRegisterResponse]
  /**
  ...
  /**
    ...
    * @returns ConsensusRegisterResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): ConsensusRegisterResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusRegisterResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusRegisterResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ConsensusRegisterResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
