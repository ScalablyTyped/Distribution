...
object PeerRegisterRequest {
  ...
  /**
    ...
    */
  @scala.inline
  def create(): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[PeerRegisterRequest]
  @scala.inline
  def create(properties: IPeerRegisterRequest): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def decode(reader: Reader): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  @scala.inline
  def decode(reader: Reader, length: Double): PeerRegisterRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PeerRegisterRequest]
  @scala.inline
  def decode(reader: Uint8Array): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): PeerRegisterRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def decodeDelimited(reader: Reader): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    */
  @scala.inline
  def toObject(message: PeerRegisterRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: PeerRegisterRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
