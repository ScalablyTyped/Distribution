...
object PeerRegisterRequest {
  ...
  inline def decode(reader: Uint8Array): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  inline def decode(reader: Uint8Array, length: Double): PeerRegisterRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PeerRegisterRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    * @returns PeerRegisterRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): PeerRegisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[PeerRegisterRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: PeerRegisterRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: PeerRegisterRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
