...
object PeerUnregisterRequest {
  ...
  inline def decode(reader: Uint8Array): PeerUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerUnregisterRequest]
  inline def decode(reader: Uint8Array, length: Double): PeerUnregisterRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[PeerUnregisterRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): PeerUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[PeerUnregisterRequest]
  ...
  /**
    ...
    * @returns PeerUnregisterRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): PeerUnregisterRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[PeerUnregisterRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: PeerUnregisterRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: PeerUnregisterRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
