...
object ClientPeersGetRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ClientPeersGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientPeersGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientPeersGetRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientPeersGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetRequest]
  /**
  ...
  /**
    ...
    * @returns ClientPeersGetRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientPeersGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientPeersGetRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientPeersGetRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
