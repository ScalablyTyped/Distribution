...
object ClientBlockGetByNumRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBlockGetByNumRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByNumRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBlockGetByNumRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBlockGetByNumRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBlockGetByNumRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByNumRequest]
  ...
  /**
    ...
    * @returns ClientBlockGetByNumRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBlockGetByNumRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByNumRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBlockGetByNumRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBlockGetByNumRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
