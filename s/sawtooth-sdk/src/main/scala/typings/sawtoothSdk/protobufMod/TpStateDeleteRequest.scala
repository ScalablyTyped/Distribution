...
object TpStateDeleteRequest {
  ...
  inline def decode(reader: Uint8Array): TpStateDeleteRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteRequest]
  inline def decode(reader: Uint8Array, length: Double): TpStateDeleteRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TpStateDeleteRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): TpStateDeleteRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteRequest]
  ...
  /**
    ...
    * @returns TpStateDeleteRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): TpStateDeleteRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TpStateDeleteRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: TpStateDeleteRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: TpStateDeleteRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
