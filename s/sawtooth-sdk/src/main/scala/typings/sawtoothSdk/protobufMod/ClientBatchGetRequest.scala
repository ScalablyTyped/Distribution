...
object ClientBatchGetRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBatchGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchGetRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBatchGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBatchGetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBatchGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchGetRequest]
  ...
  /**
    ...
    * @returns ClientBatchGetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBatchGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBatchGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBatchGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBatchGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
