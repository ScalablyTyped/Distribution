...
object ConsensusBlocksGetResponse {
  ...
  inline def decode(reader: Uint8Array): ConsensusBlocksGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusBlocksGetResponse]
  inline def decode(reader: Uint8Array, length: Double): ConsensusBlocksGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusBlocksGetResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusBlocksGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusBlocksGetResponse]
  ...
  /**
    ...
    * @returns ConsensusBlocksGetResponse
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusBlocksGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusBlocksGetResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusBlocksGetResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusBlocksGetResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
