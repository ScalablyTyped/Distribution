...
object ClientStatusGetResponse {
  ...
  @JSImport("sawtooth-sdk/protobuf", "ClientStatusGetResponse.decode")
  @js.native
  def decode(reader: Uint8Array): ClientStatusGetResponse = js.native
  @JSImport("sawtooth-sdk/protobuf", "ClientStatusGetResponse.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): ClientStatusGetResponse = js.native
  ...
  @JSImport("sawtooth-sdk/protobuf", "ClientStatusGetResponse.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): ClientStatusGetResponse = js.native
