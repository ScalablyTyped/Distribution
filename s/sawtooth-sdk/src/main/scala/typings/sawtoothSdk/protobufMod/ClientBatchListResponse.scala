...
object ClientBatchListResponse {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ClientBatchListResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchListResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchListResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBatchListResponse]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchListResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchListResponse]
  /**
  ...
  /**
    ...
    * @returns ClientBatchListResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientBatchListResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBatchListResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBatchListResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientBatchListResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
