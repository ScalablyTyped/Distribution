...
object ConsensusPeerInfo {
  ...
  /**
    ...
    */
  @scala.inline
  def create(): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ConsensusPeerInfo]
  @scala.inline
  def create(properties: IConsensusPeerInfo): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    */
  @scala.inline
  def decode(reader: Reader): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  @scala.inline
  def decode(reader: Reader, length: Double): ConsensusPeerInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusPeerInfo]
  @scala.inline
  def decode(reader: Uint8Array): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  @scala.inline
  def decode(reader: Uint8Array, length: Double): ConsensusPeerInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    */
  @scala.inline
  def decodeDelimited(reader: Reader): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  @scala.inline
  def decodeDelimited(reader: Uint8Array): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    */
  @scala.inline
  def fromObject(`object`: StringDictionary[js.Any]): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    */
  @scala.inline
  def toObject(message: ConsensusPeerInfo): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  @scala.inline
  def toObject(message: ConsensusPeerInfo, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
