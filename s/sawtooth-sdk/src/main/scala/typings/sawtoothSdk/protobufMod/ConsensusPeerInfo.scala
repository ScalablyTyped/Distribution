...
object ConsensusPeerInfo {
  ...
  inline def decode(reader: Uint8Array): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  inline def decode(reader: Uint8Array, length: Double): ConsensusPeerInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusPeerInfo]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    * @returns ConsensusPeerInfo
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusPeerInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusPeerInfo]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusPeerInfo): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusPeerInfo, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
