...
object GenesisData {
  ...
  inline def decode(reader: Uint8Array): GenesisData = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[GenesisData]
  inline def decode(reader: Uint8Array, length: Double): GenesisData = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[GenesisData]
  ...
  inline def decodeDelimited(reader: Uint8Array): GenesisData = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[GenesisData]
  ...
  /**
    ...
    * @returns GenesisData
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): GenesisData = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[GenesisData]
  ...
  /**
    ...
    */
  inline def toObject(message: GenesisData): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: GenesisData, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
