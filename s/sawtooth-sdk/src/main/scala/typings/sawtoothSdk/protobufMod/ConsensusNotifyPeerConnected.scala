...
object ConsensusNotifyPeerConnected {
  ...
  @JSImport("sawtooth-sdk/protobuf", "ConsensusNotifyPeerConnected.decode")
  @js.native
  def decode(reader: Uint8Array): ConsensusNotifyPeerConnected = js.native
  @JSImport("sawtooth-sdk/protobuf", "ConsensusNotifyPeerConnected.decode")
  @js.native
  def decode(reader: Uint8Array, length: Double): ConsensusNotifyPeerConnected = js.native
  ...
  @JSImport("sawtooth-sdk/protobuf", "ConsensusNotifyPeerConnected.decodeDelimited")
  @js.native
  def decodeDelimited(reader: Uint8Array): ConsensusNotifyPeerConnected = js.native
