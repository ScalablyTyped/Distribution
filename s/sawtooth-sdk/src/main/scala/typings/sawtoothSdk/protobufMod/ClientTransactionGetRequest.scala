...
object ClientTransactionGetRequest {
  ...
  inline def decode(reader: Uint8Array): ClientTransactionGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientTransactionGetRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientTransactionGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientTransactionGetRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientTransactionGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientTransactionGetRequest]
  ...
  /**
    ...
    * @returns ClientTransactionGetRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientTransactionGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientTransactionGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientTransactionGetRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientTransactionGetRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
