...
object IPolicyList {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IPolicyList] (val x: Self) extends AnyVal {
    ...
    inline def setPoliciesVarargs(value: IPolicy*): Self = StObject.set(x, "policies", js.Array(value*))
  }
}
