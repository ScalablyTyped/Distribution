...
object ClientStateListRequest {
  ...
  inline def decode(reader: Uint8Array): ClientStateListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientStateListRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientStateListRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientStateListRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientStateListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientStateListRequest]
  ...
  /**
    ...
    * @returns ClientStateListRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientStateListRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientStateListRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientStateListRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientStateListRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
