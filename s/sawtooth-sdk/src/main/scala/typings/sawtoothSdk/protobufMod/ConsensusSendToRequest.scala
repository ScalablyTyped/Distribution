...
object ConsensusSendToRequest {
  ...
  inline def decode(reader: Uint8Array): ConsensusSendToRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusSendToRequest]
  inline def decode(reader: Uint8Array, length: Double): ConsensusSendToRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ConsensusSendToRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ConsensusSendToRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ConsensusSendToRequest]
  ...
  /**
    ...
    * @returns ConsensusSendToRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ConsensusSendToRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ConsensusSendToRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ConsensusSendToRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ConsensusSendToRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
