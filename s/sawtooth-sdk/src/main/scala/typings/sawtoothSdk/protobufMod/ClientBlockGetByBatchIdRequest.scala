...
object ClientBlockGetByBatchIdRequest {
  ...
  inline def decode(reader: Uint8Array): ClientBlockGetByBatchIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByBatchIdRequest]
  inline def decode(reader: Uint8Array, length: Double): ClientBlockGetByBatchIdRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBlockGetByBatchIdRequest]
  ...
  inline def decodeDelimited(reader: Uint8Array): ClientBlockGetByBatchIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByBatchIdRequest]
  ...
  /**
    ...
    * @returns ClientBlockGetByBatchIdRequest
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ClientBlockGetByBatchIdRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBlockGetByBatchIdRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBlockGetByBatchIdRequest): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ClientBlockGetByBatchIdRequest, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
