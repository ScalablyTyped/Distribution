...
@JSGlobal("sawtooth.protobuf.TpProcessResponse")
@js.native
/**
...
class TpProcessResponse ()
  extends typings.sawtoothSdk.mod.protobuf.TpProcessResponse {
...
object TpProcessResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.TpProcessResponse.Status")
  @js.native
  ...
  inline def decode(reader: Uint8Array): typings.sawtoothSdk.protobufMod.TpProcessResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.sawtoothSdk.protobufMod.TpProcessResponse]
  inline def decode(reader: Uint8Array, length: Double): typings.sawtoothSdk.protobufMod.TpProcessResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[typings.sawtoothSdk.protobufMod.TpProcessResponse]
  ...
  inline def decodeDelimited(reader: Uint8Array): typings.sawtoothSdk.protobufMod.TpProcessResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[typings.sawtoothSdk.protobufMod.TpProcessResponse]
  ...
  /**
    ...
    * @returns TpProcessResponse
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): typings.sawtoothSdk.protobufMod.TpProcessResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.sawtoothSdk.protobufMod.TpProcessResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: typings.sawtoothSdk.protobufMod.TpProcessResponse): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: typings.sawtoothSdk.protobufMod.TpProcessResponse, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
