...
@JSGlobal("sawtooth.protobuf.ConsensusFailBlockResponse")
@js.native
/**
...
class ConsensusFailBlockResponse ()
  extends typings.sawtoothSdk.mod.protobuf.ConsensusFailBlockResponse {
...
object ConsensusFailBlockResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.ConsensusFailBlockResponse.Status")
  @js.native
