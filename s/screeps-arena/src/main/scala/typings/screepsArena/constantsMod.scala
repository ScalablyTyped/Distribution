...
import typings.screepsArena.screepsArenaNumbers.`-10`
import typings.screepsArena.screepsArenaNumbers.`-11`
import typings.screepsArena.screepsArenaNumbers.`-12`
import typings.screepsArena.screepsArenaNumbers.`-14`
import typings.screepsArena.screepsArenaNumbers.`-15`
import typings.screepsArena.screepsArenaNumbers.`-1`
import typings.screepsArena.screepsArenaNumbers.`-2`
import typings.screepsArena.screepsArenaNumbers.`-3`
import typings.screepsArena.screepsArenaNumbers.`-4`
import typings.screepsArena.screepsArenaNumbers.`-5`
import typings.screepsArena.screepsArenaNumbers.`-6`
import typings.screepsArena.screepsArenaNumbers.`-7`
import typings.screepsArena.screepsArenaNumbers.`-8`
import typings.screepsArena.screepsArenaNumbers.`-9`
