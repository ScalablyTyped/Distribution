...
object gameConstantsMod {
  ...
  type BodyPartConstant = typings.screepsArena.gameConstantsMod.MOVE | typings.screepsArena.gameConstantsMod.WORK | typings.screepsArena.gameConstantsMod.CARRY | typings.screepsArena.gameConstantsMod.ATTACK | typings.screepsArena.gameConstantsMod.RANGED_ATTACK | typings.screepsArena.gameConstantsMod.TOUGH | typings.screepsArena.gameConstantsMod.HEAL | typings.screepsArena.gameConstantsMod.CLAIM
  ...
  */
  ...
  type CreepActionReturnCode = typings.screepsArena.gameConstantsMod.OK | typings.screepsArena.gameConstantsMod.ERR_NOT_OWNER | typings.screepsArena.gameConstantsMod.ERR_BUSY | typings.screepsArena.gameConstantsMod.ERR_INVALID_TARGET | typings.screepsArena.gameConstantsMod.ERR_NOT_IN_RANGE | typings.screepsArena.gameConstantsMod.ERR_NO_BODYPART | typings.screepsArena.gameConstantsMod.ERR_TIRED
  
  type CreepMoveReturnCode = typings.screepsArena.gameConstantsMod.OK | typings.screepsArena.gameConstantsMod.ERR_NOT_OWNER | typings.screepsArena.gameConstantsMod.ERR_BUSY | typings.screepsArena.gameConstantsMod.ERR_TIRED | typings.screepsArena.gameConstantsMod.ERR_NO_BODYPART
  
  type DirectionConstant = typings.screepsArena.gameConstantsMod.TOP | typings.screepsArena.gameConstantsMod.TOP_RIGHT | typings.screepsArena.gameConstantsMod.RIGHT | typings.screepsArena.gameConstantsMod.BOTTOM_RIGHT | typings.screepsArena.gameConstantsMod.BOTTOM | typings.screepsArena.gameConstantsMod.BOTTOM_LEFT | typings.screepsArena.gameConstantsMod.LEFT | typings.screepsArena.gameConstantsMod.TOP_LEFT
  ...
  type ScreepsReturnCode = typings.screepsArena.gameConstantsMod.OK | typings.screepsArena.gameConstantsMod.ERR_NOT_OWNER | typings.screepsArena.gameConstantsMod.ERR_NO_PATH | typings.screepsArena.gameConstantsMod.ERR_BUSY | typings.screepsArena.gameConstantsMod.ERR_NAME_EXISTS | typings.screepsArena.gameConstantsMod.ERR_NOT_FOUND | typings.screepsArena.gameConstantsMod.ERR_NOT_ENOUGH_RESOURCES | typings.screepsArena.gameConstantsMod.ERR_NOT_ENOUGH_ENERGY | typings.screepsArena.gameConstantsMod.ERR_INVALID_TARGET | typings.screepsArena.gameConstantsMod.ERR_FULL | typings.screepsArena.gameConstantsMod.ERR_NOT_IN_RANGE | typings.screepsArena.gameConstantsMod.ERR_INVALID_ARGS | typings.screepsArena.gameConstantsMod.ERR_TIRED | typings.screepsArena.gameConstantsMod.ERR_NO_BODYPART | typings.screepsArena.gameConstantsMod.ERR_NOT_ENOUGH_EXTENSIONS | ERR_RCL_NOT_ENOUGH | ERR_GCL_NOT_ENOUGH
