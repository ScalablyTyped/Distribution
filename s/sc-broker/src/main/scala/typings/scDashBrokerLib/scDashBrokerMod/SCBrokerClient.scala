...
trait SCBrokerClient
  ...
  def end(callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error], scala.Unit]): scala.Unit = js.native
  ...
  def on_subscribeFail(
    ...
    listener: js.Function2[/* err */ nodeLib.Error | scala.Null, /* channel */ java.lang.String, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  def send(data: js.Any, callback: js.Function1[/* err */ js.UndefOr[nodeLib.Error], scala.Unit]): scala.Unit = js.native
  ...
  def subscribe(
    channel: java.lang.String,
    ackCallback: js.Function1[/* err */ js.UndefOr[nodeLib.Error], scala.Unit]
  ): scala.Unit = js.native
  def subscribe(
    channel: java.lang.String,
    ackCallback: js.Function1[/* err */ js.UndefOr[nodeLib.Error], scala.Unit],
