...
object StrictTableHeaderCellProps {
  ...
  def apply(
    ...
    textAlign: typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.center | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.left | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.right = null,
    title: String = null,
