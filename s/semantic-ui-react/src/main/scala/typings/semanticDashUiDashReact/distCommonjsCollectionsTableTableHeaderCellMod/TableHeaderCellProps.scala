...
object TableHeaderCellProps {
  ...
  def apply(
    ...
    slot: String = null,
    sorted: typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.ascending | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.descending = null,
