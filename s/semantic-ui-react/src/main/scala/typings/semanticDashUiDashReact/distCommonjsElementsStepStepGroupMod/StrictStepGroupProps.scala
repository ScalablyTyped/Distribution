...
trait StrictStepGroupProps extends js.Object {
  ...
  var widths: js.UndefOr[
    `1` | `2` | `3` | `4` | `5` | `6` | `7` | `8` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`1` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`2` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`3` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`4` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`5` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`6` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`7` | typings.semanticDashUiDashReact.semanticDashUiDashReactStrings.`8` | one | two | three | four | five | six | seven | eight
  ] = js.undefined
}
