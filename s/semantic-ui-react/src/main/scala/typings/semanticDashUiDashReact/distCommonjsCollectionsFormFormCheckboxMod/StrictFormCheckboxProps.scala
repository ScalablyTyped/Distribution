...
import typings.semanticDashUiDashReact.distCommonjsModulesCheckboxCheckboxMod.StrictCheckboxProps
...
- typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, label, required, `type`, width. Inlined content, control, error, `inline` */ trait StrictFormCheckboxProps extends StrictCheckboxProps {
