...
object CommentContent
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsCommentCommentContentMod.^.default.asInstanceOf[String | js.Object]
  def apply(
  ...
  type Props = CommentContentProps
}
