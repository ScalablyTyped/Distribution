...
object AccordionContent
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsModulesAccordionAccordionContentMod.^.default.asInstanceOf[String | js.Object]
  def apply(
