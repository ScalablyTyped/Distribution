...
object ButtonGroup
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsElementsButtonButtonGroupMod.^.default.asInstanceOf[String | js.Object]
  def apply(
