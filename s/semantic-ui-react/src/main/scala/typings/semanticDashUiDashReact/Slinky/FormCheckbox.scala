...
import typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormCheckboxMod.FormCheckboxProps
...
/* The following DOM/SVG props were specified: children, className, disabled, type, name, readOnly, checked, defaultChecked, value */
object FormCheckbox
  extends ExternalComponentWithAttributesWithRefType[tag.type, js.Object] {
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormCheckboxMod.^.default.asInstanceOf[String | js.Object]
  def apply(
    ...
    type_StrictFormCheckboxProps: checkbox | radio = null,
    ...
    if (type_StrictFormCheckboxProps != null) __obj.updateDynamic("type")(type_StrictFormCheckboxProps.asInstanceOf[js.Any])
