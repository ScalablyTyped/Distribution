...
import typings.semanticDashUiDashReact.distCommonjsModulesDropdownMod.default
...
/* The following DOM/SVG props were specified: children, direction, placeholder, open, className, disabled, multiple, defaultValue, value */
object Dropdown
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.distCommonjsModulesDropdownMod.default].asInstanceOf[String | js.Object]
  def apply(
