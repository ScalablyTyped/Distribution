...
object SearchResults
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsModulesSearchSearchResultsMod.^.default.asInstanceOf[String | js.Object]
  def apply(
