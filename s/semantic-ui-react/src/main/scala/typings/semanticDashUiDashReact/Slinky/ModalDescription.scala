...
object ModalDescription
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsModulesModalModalDescriptionMod.^.default.asInstanceOf[String | js.Object]
  def apply(
  ...
  type Props = ModalDescriptionProps
}
