...
/* The following DOM/SVG props were specified: children, hidden, className, disabled, href */
object ItemImage
  extends ExternalComponentWithAttributesWithRefType[tag.type, js.Object] {
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsItemItemImageMod.^.default.asInstanceOf[String | js.Object]
  def apply(
