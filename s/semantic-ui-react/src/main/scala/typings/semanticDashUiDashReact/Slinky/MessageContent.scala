...
object MessageContent
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsCollectionsMessageMessageContentMod.^.default.asInstanceOf[String | js.Object]
  def apply(
