...
import typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormDropdownMod.FormDropdownProps
...
/* The following DOM/SVG props were specified: children, className, disabled, type, direction, placeholder, open, multiple, defaultValue, value */
object FormDropdown
  extends ExternalComponentWithAttributesWithRefType[tag.type, js.Object] {
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormDropdownMod.^.default.asInstanceOf[String | js.Object]
  def apply(
    ...
    error_StrictFormDropdownProps: js.Any = null,
    ...
    if (error_StrictFormDropdownProps != null) __obj.updateDynamic("error")(error_StrictFormDropdownProps)
