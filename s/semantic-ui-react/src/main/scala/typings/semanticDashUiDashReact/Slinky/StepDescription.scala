...
object StepDescription
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsElementsStepStepDescriptionMod.^.default.asInstanceOf[String | js.Object]
  def apply(
