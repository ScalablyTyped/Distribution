...
object ListDescription
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsElementsListListDescriptionMod.^.default.asInstanceOf[String | js.Object]
  def apply(
