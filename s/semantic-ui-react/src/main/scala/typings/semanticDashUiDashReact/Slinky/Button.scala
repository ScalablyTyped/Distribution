...
import typings.semanticDashUiDashReact.distCommonjsElementsButtonMod.default
...
/* The following DOM/SVG props were specified: children, role, className, disabled */
object Button
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.distCommonjsElementsButtonMod.default].asInstanceOf[String | js.Object]
  def apply(
