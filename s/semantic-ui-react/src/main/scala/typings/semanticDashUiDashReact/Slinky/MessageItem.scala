...
object MessageItem
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsCollectionsMessageMessageItemMod.^.default.asInstanceOf[String | js.Object]
  def apply(
