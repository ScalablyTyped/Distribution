...
object CommentActions
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsCommentCommentActionsMod.^.default.asInstanceOf[String | js.Object]
  def apply(
