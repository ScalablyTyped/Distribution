...
object FeedMeta
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsFeedFeedMetaMod.^.default.asInstanceOf[String | js.Object]
  def apply(
