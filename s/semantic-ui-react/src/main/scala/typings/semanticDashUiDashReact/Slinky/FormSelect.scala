...
import typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormSelectMod.FormSelectProps
...
/* The following DOM/SVG props were specified: children, direction, placeholder, open, className, disabled, multiple, defaultValue, value, type */
object FormSelect
  extends ExternalComponentWithAttributesWithRefType[tag.type, js.Object] {
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsCollectionsFormFormSelectMod.^.default.asInstanceOf[String | js.Object]
  def apply(
    options_StrictSelectProps: js.Array[DropdownItemProps],
    ...
    error_StrictFormSelectProps: js.Any = null,
    ...
    __obj.updateDynamic("options")(options_StrictSelectProps)
    ...
    if (error_StrictFormSelectProps != null) __obj.updateDynamic("error")(error_StrictFormSelectProps)
