...
object CommentMetadata
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsCommentCommentMetadataMod.^.default.asInstanceOf[String | js.Object]
  def apply(
