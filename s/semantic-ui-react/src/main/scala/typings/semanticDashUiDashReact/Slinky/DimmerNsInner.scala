...
import typings.semanticDashUiDashReact.semanticDashUiDashReactMod.DimmerNs.Inner
...
object DimmerNsInner
  extends ExternalComponentWithAttributesWithRefType[tag.type, Inner] {
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.semanticDashUiDashReactMod.DimmerNs.Inner].asInstanceOf[String | js.Object]
  def apply(
