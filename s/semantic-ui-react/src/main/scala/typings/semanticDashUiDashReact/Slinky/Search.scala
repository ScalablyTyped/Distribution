...
import typings.semanticDashUiDashReact.distCommonjsModulesSearchMod.default
...
import typings.semanticDashUiDashReact.distCommonjsModulesSearchSearchMod.SearchResultData
...
/* The following DOM/SVG props were specified: open, className */
object Search
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.semanticDashUiDashReact.distCommonjsModulesSearchMod.default].asInstanceOf[String | js.Object]
  def apply(
