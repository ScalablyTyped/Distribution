...
object CommentAuthor
  ...
  override val component: String | js.Object = typings.semanticDashUiDashReact.distCommonjsViewsCommentCommentAuthorMod.^.default.asInstanceOf[String | js.Object]
  def apply(
