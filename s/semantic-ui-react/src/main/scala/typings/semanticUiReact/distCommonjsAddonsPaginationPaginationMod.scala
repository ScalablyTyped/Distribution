...
import typings.semanticUiReact.distCommonjsAddonsPaginationPaginationItemMod.PaginationItemProps
...
object distCommonjsAddonsPaginationPaginationMod {
  ...
  object default {
    ...
    @js.native
    open class Item ()
      extends typings.semanticUiReact.distCommonjsAddonsPaginationPaginationItemMod.default
  }
  
  object Pagination {
    
    /* was `typeof PaginationItem` */
    type Item = typings.semanticUiReact.distCommonjsAddonsPaginationPaginationItemMod.default
  }
  ...
  object StrictPaginationProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictPaginationProps] (val x: Self) extends AnyVal {
