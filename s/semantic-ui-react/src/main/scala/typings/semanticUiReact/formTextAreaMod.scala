...
object formTextAreaMod extends Shortcut {
  ...
  - typings.semanticUiReact.textAreaTextAreaMod.StrictTextAreaProps because Inheritance from two classes. Inlined onChange, onInput, rows, value */ trait StrictFormTextAreaProps
    extends StObject
