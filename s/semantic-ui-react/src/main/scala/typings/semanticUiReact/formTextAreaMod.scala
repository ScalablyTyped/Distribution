...
object formTextAreaMod extends Shortcut {
  ...
  object StrictFormTextAreaProps {
    ...
    implicit class StrictFormTextAreaPropsMutableBuilder[Self <: StrictFormTextAreaProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChangeFunction1(value: ChangeEvent[HTMLTextAreaElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnChangeFunction2(value: (/* event */ ChangeEvent[HTMLTextAreaElement], /* data */ TextAreaProps) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
