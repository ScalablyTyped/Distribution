...
@js.native
trait StrictPlaceholderHeaderProps extends js.Object {
...
object StrictPlaceholderHeaderProps {
  ...
  @scala.inline
  implicit class StrictPlaceholderHeaderPropsOps[Self <: StrictPlaceholderHeaderProps] (val x: Self) extends AnyVal {
