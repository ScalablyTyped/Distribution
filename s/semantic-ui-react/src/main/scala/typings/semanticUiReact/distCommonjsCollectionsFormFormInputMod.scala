...
import typings.semanticUiReact.distCommonjsElementsInputInputMod.InputOnChangeData
...
object distCommonjsCollectionsFormFormInputMod extends Shortcut {
  ...
  object StrictFormInputProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictFormInputProps] (val x: Self) extends AnyVal {
