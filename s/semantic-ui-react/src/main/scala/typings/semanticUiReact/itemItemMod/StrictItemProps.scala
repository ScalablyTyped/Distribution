...
object StrictItemProps {
  ...
  @scala.inline
  implicit class StrictItemPropsOps[Self <: StrictItemProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    def setImageFunction3(
      value: (/* component */ ReactType[ItemImageProps], ItemImageProps, /* children */ js.UndefOr[ReactNode | ReactNodeArray]) => ReactElement | Null
    ): Self = this.set("image", js.Any.fromFunction3(value))
    @scala.inline
    def setImage(value: SemanticShorthandItem[ItemImageProps]): Self = this.set("image", value.asInstanceOf[js.Any])
    @scala.inline
