package typings.semanticUiReact.formRadioMod
...
- typings.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, label, required, `type`, width. Inlined content, control, error, `inline` */ trait StrictFormRadioProps extends StrictRadioProps {
