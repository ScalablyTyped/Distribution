...
object formSelectMod extends Shortcut {
  ...
  - typings.semanticUiReact.selectSelectMod.StrictSelectProps because var conflicts: as, children, className, disabled, error, `inline`. Inlined options */ trait StrictFormSelectProps
    extends StObject
