...
import typings.semanticUiReact.distCommonjsViewsFeedFeedEventMod.FeedEventProps
...
object distCommonjsViewsFeedFeedMod extends Shortcut {
  ...
  object StrictFeedProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictFeedProps] (val x: Self) extends AnyVal {
