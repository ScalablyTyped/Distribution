...
object distCommonjsViewsItemItemDescriptionMod extends Shortcut {
  ...
  object StrictItemDescriptionProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictItemDescriptionProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsViewsItemItemDescriptionMod.foo` */
