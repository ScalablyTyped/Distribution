...
object itemExtraMod extends Shortcut {
  ...
  object StrictItemExtraProps {
    ...
    @scala.inline
    implicit class StrictItemExtraPropsMutableBuilder[Self <: StrictItemExtraProps] (val x: Self) extends AnyVal {
