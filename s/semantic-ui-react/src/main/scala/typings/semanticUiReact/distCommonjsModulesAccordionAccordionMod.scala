...
import typings.semanticUiReact.distCommonjsModulesAccordionAccordionAccordionMod.StrictAccordionAccordionProps
...
object distCommonjsModulesAccordionAccordionMod {
  ...
  trait AccordionComponent
    ...
    var Panel: Instantiable0[typings.semanticUiReact.distCommonjsModulesAccordionAccordionPanelMod.default] = js.native
