...
import typings.semanticUiReact.distCommonjsAddonsTextAreaTextAreaMod.TextAreaProps
  ...
  object StrictFormTextAreaProps {
    ...
    implicit open class MutableBuilder[Self <: StrictFormTextAreaProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(
        value: ChangeEventHandler[HTMLTextAreaElement] | (js.Function2[/* event */ ChangeEvent[HTMLTextAreaElement], /* data */ TextAreaProps, Unit])
      ): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
      
      inline def setOnChangeFunction1(value: ChangeEvent[HTMLTextAreaElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      inline def setOnChangeFunction2(value: (/* event */ ChangeEvent[HTMLTextAreaElement], /* data */ TextAreaProps) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
