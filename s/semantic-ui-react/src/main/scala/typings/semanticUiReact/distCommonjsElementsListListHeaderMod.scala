...
object distCommonjsElementsListListHeaderMod extends Shortcut {
  
  @JSImport("semantic-ui-react/dist/commonjs/elements/List/ListHeader", JSImport.Default)
  @js.native
  val default: FC[ListHeaderProps] = js.native
  ...
  object StrictListHeaderProps {
    ...
    inline def apply(): StrictListHeaderProps = {
      val __obj = js.Dynamic.literal()
  ...
  type _To = FC[ListHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsElementsListListHeaderMod.foo` */
  override def _to: FC[ListHeaderProps] = default
}
