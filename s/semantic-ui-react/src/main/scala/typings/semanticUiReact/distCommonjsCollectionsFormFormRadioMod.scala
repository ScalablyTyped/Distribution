...
object distCommonjsCollectionsFormFormRadioMod extends Shortcut {
  ...
  - typings.semanticUiReact.distCommonjsAddonsRadioRadioMod.StrictRadioProps because Inheritance from two classes. Inlined slider, toggle */ trait StrictFormRadioProps
    extends StObject
  ...
  object StrictFormRadioProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictFormRadioProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsCollectionsFormFormRadioMod.foo` */
