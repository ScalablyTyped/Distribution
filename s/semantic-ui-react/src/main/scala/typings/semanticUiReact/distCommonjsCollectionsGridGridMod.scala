...
import typings.semanticUiReact.distCommonjsCollectionsGridGridColumnMod.GridColumnProps
import typings.semanticUiReact.distCommonjsCollectionsGridGridRowMod.GridRowProps
...
object distCommonjsCollectionsGridGridMod extends Shortcut {
  ...
  */
  ...
  object StrictGridProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictGridProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsCollectionsGridGridMod.foo` */
