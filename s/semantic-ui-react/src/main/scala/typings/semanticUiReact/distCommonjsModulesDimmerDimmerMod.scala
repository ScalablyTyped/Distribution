...
object distCommonjsModulesDimmerDimmerMod {
  ...
  trait DimmerComponent
    ...
    var Inner: Instantiable0[typings.semanticUiReact.distCommonjsModulesDimmerDimmerInnerMod.default] = js.native
  }
  ...
  object StrictDimmerProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictDimmerProps] (val x: Self) extends AnyVal {
