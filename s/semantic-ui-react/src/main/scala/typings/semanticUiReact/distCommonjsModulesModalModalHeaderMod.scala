...
object distCommonjsModulesModalModalHeaderMod extends Shortcut {
  ...
  object StrictModalHeaderProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictModalHeaderProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsModulesModalModalHeaderMod.foo` */
