...
object distCommonjsViewsStatisticStatisticValueMod extends Shortcut {
  
  @JSImport("semantic-ui-react/dist/commonjs/views/Statistic/StatisticValue", JSImport.Default)
  @js.native
  val default: FC[StatisticValueProps] = js.native
  ...
  object StrictStatisticValueProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictStatisticValueProps] (val x: Self) extends AnyVal {
  ...
  type _To = FC[StatisticValueProps]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsViewsStatisticStatisticValueMod.foo` */
  override def _to: FC[StatisticValueProps] = default
}
