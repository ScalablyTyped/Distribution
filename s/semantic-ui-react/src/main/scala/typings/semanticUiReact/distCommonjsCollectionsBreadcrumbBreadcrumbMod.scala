...
import typings.semanticUiReact.distCommonjsCollectionsBreadcrumbBreadcrumbDividerMod.BreadcrumbDividerProps
...
object distCommonjsCollectionsBreadcrumbBreadcrumbMod {
  ...
  object StrictBreadcrumbProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictBreadcrumbProps] (val x: Self) extends AnyVal {
