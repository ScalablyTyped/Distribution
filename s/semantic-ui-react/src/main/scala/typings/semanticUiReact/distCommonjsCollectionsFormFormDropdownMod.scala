...
object distCommonjsCollectionsFormFormDropdownMod extends Shortcut {
  
  @JSImport("semantic-ui-react/dist/commonjs/collections/Form/FormDropdown", JSImport.Default)
  @js.native
  val default: FC[FormDropdownProps] = js.native
  
  trait FormDropdownProps
    extends StObject
       with StrictFormDropdownProps
       with /* key */ StringDictionary[Any]
  object FormDropdownProps {
    
    inline def apply(): FormDropdownProps = {
  ...
  - typings.semanticUiReact.distCommonjsModulesDropdownDropdownMod.StrictDropdownProps because var conflicts: as, children, className, disabled, error, `inline`. Inlined additionLabel, additionPosition, allowAdditions, basic, button, clearable, closeOnBlur, closeOnEscape, closeOnChange, compact, deburr, defaultOpen, defaultSearchQuery, defaultSelectedLabel, defaultUpward, defaultValue, direction, floating, fluid, header, icon, item, labeled, lazyLoad, loading, minCharacters, multiple, noResultsMessage, onAddItem, onBlur, onChange, onClick, onClose, onFocus, onLabelClick, onMouseDown, onOpen, onSearchChange, open, openOnFocus, options, placeholder, pointing, renderLabel, scrolling, search, searchInput, searchQuery, selectOnBlur, selectOnNavigation, selectedLabel, selection, simple, tabIndex, text, trigger, value, upward, wrapSelection */ trait StrictFormDropdownProps
    ...
    @JSName("error")
    var error_StrictFormDropdownProps: js.UndefOr[Any] = js.undefined
  ...
  object StrictFormDropdownProps {
    ...
    inline def apply(): StrictFormDropdownProps = {
      val __obj = js.Dynamic.literal()
  ...
  type _To = FC[FormDropdownProps]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsCollectionsFormFormDropdownMod.foo` */
  override def _to: FC[FormDropdownProps] = default
}
