...
object distCommonjsCollectionsFormFormButtonMod extends Shortcut {
  ...
  object StrictFormButtonProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictFormButtonProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsCollectionsFormFormButtonMod.foo` */
