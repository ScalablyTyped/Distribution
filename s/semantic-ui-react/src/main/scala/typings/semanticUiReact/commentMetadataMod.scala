...
object commentMetadataMod extends Shortcut {
  ...
  @js.native
  val default: FC[CommentMetadataProps] = js.native
  
  trait CommentMetadataProps
    extends StObject
       with StrictCommentMetadataProps
       with /* key */ StringDictionary[Any]
  object CommentMetadataProps {
    
    inline def apply(): CommentMetadataProps = {
  ...
  object StrictCommentMetadataProps {
    ...
    inline def apply(): StrictCommentMetadataProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StrictCommentMetadataProps]
    }
    
    extension [Self <: StrictCommentMetadataProps](x: Self) {
