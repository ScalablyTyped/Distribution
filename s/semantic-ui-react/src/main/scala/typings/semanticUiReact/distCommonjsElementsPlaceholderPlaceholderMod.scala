...
import typings.semanticUiReact.distCommonjsElementsPlaceholderPlaceholderHeaderMod.PlaceholderHeaderComponent
import typings.semanticUiReact.distCommonjsElementsPlaceholderPlaceholderImageMod.PlaceholderImageComponent
import typings.semanticUiReact.distCommonjsElementsPlaceholderPlaceholderLineMod.PlaceholderLineComponent
import typings.semanticUiReact.distCommonjsElementsPlaceholderPlaceholderParagraphMod.PlaceholderParagraphComponent
import typings.semanticUiReact.distCommonjsGenericMod.SemanticShorthandContent
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCommonjsElementsPlaceholderPlaceholderMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distCommonjsElementsPlaceholderPlaceholderMod.foo` */
