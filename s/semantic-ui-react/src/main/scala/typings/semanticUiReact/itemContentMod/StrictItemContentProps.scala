...
object StrictItemContentProps {
  ...
  implicit class StrictItemContentPropsOps[Self <: StrictItemContentProps] (val x: Self) extends AnyVal {
    ...
    def setDescriptionFunction3(
      value: (/* component */ ReactType[ItemDescriptionProps], ItemDescriptionProps, /* children */ js.UndefOr[ReactNode | ReactNodeArray]) => ReactElement | Null
    ...
    def setExtraFunction3(
      value: (/* component */ ReactType[ItemExtraProps], ItemExtraProps, /* children */ js.UndefOr[ReactNode | ReactNodeArray]) => ReactElement | Null
    ...
    def setHeaderFunction3(
      value: (/* component */ ReactType[ItemHeaderProps], ItemHeaderProps, /* children */ js.UndefOr[ReactNode | ReactNodeArray]) => ReactElement | Null
    ...
    def setMetaFunction3(
      value: (/* component */ ReactType[ItemMetaProps], ItemMetaProps, /* children */ js.UndefOr[ReactNode | ReactNodeArray]) => ReactElement | Null
