...
import typings.semanticUiReact.distCommonjsViewsFeedFeedContentMod.FeedContentProps
...
import typings.semanticUiReact.distCommonjsViewsFeedFeedLabelMod.FeedLabelProps
...
object distCommonjsViewsFeedFeedEventMod extends Shortcut {
  ...
  object StrictFeedEventProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictFeedEventProps] (val x: Self) extends AnyVal {
