...
object segmentInlineMod extends Shortcut {
  ...
  object StrictSegmentInlineProps {
    ...
    @scala.inline
    implicit class StrictSegmentInlinePropsMutableBuilder[Self <: StrictSegmentInlineProps] (val x: Self) extends AnyVal {
  ...
  /* This means you don't have to write `default`, but can instead just say `segmentInlineMod.foo` */
