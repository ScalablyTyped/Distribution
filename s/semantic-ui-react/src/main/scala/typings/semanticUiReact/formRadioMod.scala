...
object formRadioMod extends Shortcut {
  ...
  object StrictFormRadioProps {
    ...
    implicit class StrictFormRadioPropsMutableBuilder[Self <: StrictFormRadioProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnChangeFunction1(value: ChangeEvent[HTMLInputElement] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnChangeFunction2(value: (/* event */ FormEvent[HTMLInputElement], /* data */ CheckboxProps) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
