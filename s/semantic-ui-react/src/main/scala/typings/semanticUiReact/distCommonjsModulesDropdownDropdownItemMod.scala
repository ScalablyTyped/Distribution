...
import typings.semanticUiReact.distCommonjsElementsFlagFlagMod.FlagProps
...
import typings.semanticUiReact.distCommonjsGenericMod.HtmlSpanProps
...
object distCommonjsModulesDropdownDropdownItemMod extends Shortcut {
  ...
  object StrictDropdownItemProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: StrictDropdownItemProps] (val x: Self) extends AnyVal {
