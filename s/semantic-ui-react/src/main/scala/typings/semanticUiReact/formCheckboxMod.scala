...
object formCheckboxMod extends Shortcut {
  ...
  - typings.semanticUiReact.checkboxCheckboxMod.StrictCheckboxProps because Inheritance from two classes. Inlined checked, defaultChecked, defaultIndeterminate, fitted, indeterminate, name, onChange, onClick, onMouseDown, onMouseUp, radio, readOnly, slider, tabIndex, toggle, value */ trait StrictFormCheckboxProps
    extends StObject
