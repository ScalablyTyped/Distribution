...
trait MessageComponent
  extends reactLib.reactMod.ReactNs.ComponentClass[MessageProps, reactLib.reactMod.ReactNs.ComponentState] {
  @JSName("Content")
  ...
  @JSName("Item")
  var Item_Original: reactLib.reactMod.ReactNs.StatelessComponent[
    semanticDashUiDashReactLib.distCommonjsCollectionsMessageMessageItemMod.MessageItemProps
  ] = js.native
  @JSName("List")
  var List_Original: reactLib.reactMod.ReactNs.StatelessComponent[
