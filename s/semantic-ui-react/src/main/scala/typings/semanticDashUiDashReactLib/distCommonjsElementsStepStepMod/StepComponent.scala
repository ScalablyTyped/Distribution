...
trait StepComponent
  ...
  @JSName("Group")
  var Group_Original: reactLib.reactMod.ReactNs.StatelessComponent[semanticDashUiDashReactLib.distCommonjsElementsStepStepGroupMod.StepGroupProps] = js.native
  @JSName("Title")
