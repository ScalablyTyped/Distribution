...
object semanticDashUiDashReactLibStrings {
  ...
  sealed trait ENTERED
    extends semanticDashUiDashReactLib.distCommonjsModulesTransitionTransitionMod.TRANSITION_STATUSES
  ...
  sealed trait `bottom left`
    extends semanticDashUiDashReactLib.distCommonjsElementsIconIconMod.IconCorner
  ...
  sealed trait `computer vertically`
    extends semanticDashUiDashReactLib.distCommonjsCollectionsGridGridMod._GridReversedProp
  ...
  sealed trait largeScreen
    extends semanticDashUiDashReactLib.distCommonjsCollectionsGridGridColumnMod._GridOnlyProp
