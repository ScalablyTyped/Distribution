package typings
package semanticDashUiDashReactLib.distCommonjsCollectionsMenuMenuHeaderMod
...
class default protected ()
  extends reactLib.reactMod.Component[MenuHeaderProps, reactLib.reactMod.ComponentState, js.Any] {
