...
object FormButtonProps {
  ...
  def apply(
    ...
    onClick: (/* event */ reactLib.reactMod.MouseEvent[stdLib.HTMLButtonElement, reactLib.NativeMouseEvent], /* data */ semanticDashUiDashReactLib.distCommonjsElementsButtonButtonMod.ButtonProps) => scala.Unit = null,
