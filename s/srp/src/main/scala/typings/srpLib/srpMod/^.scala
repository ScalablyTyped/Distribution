...
object ^ extends js.Object {
  ...
  def genKey(
    bytes: scala.Double,
    callback: js.Function2[/* error */ nodeLib.Error, /* key */ nodeLib.Buffer, scala.Unit]
  ): scala.Unit = js.native
  def genKey(callback: js.Function2[/* error */ nodeLib.Error, /* key */ nodeLib.Buffer, scala.Unit]): scala.Unit = js.native
}
