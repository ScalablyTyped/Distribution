...
object PathOptionslatLngBoundsLa {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PathOptionslatLngBoundsLa] (val x: Self) extends AnyVal {
    ...
    inline def setGetRectangle(value: () => Rectangle_[Any]): Self = StObject.set(x, "getRectangle", js.Any.fromFunction0(value))
