...
/* Inlined leaflet.leaflet.PathOptions & {  latLngs :std.Array<leaflet.leaflet.LatLngExpression> | std.Array<std.Array<leaflet.leaflet.LatLngExpression>>,   options :leaflet.leaflet.PolylineOptions | undefined,   events :svelte-leafletjs.svelte-leafletjs.PathEventKeys | undefined,   getPolyline :(): leaflet.leaflet.Polyline<geojson.geojson.LineString | geojson.geojson.MultiLineString, any> | undefined} */
trait PathOptionslatLngsArrayLaAttribution extends StObject {
  ...
  var getPolyline: js.UndefOr[js.Function0[Polyline_[LineString | MultiLineString, Any]]] = js.undefined
  
  var interactive: js.UndefOr[Boolean] = js.undefined
  
  var latLngs: js.Array[js.Array[LatLngExpression] | LatLngExpression]
...
object PathOptionslatLngsArrayLaAttribution {
  
  inline def apply(latLngs: js.Array[js.Array[LatLngExpression] | LatLngExpression]): PathOptionslatLngsArrayLaAttribution = {
    val __obj = js.Dynamic.literal(latLngs = latLngs.asInstanceOf[js.Any])
    __obj.asInstanceOf[PathOptionslatLngsArrayLaAttribution]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PathOptionslatLngsArrayLaAttribution] (val x: Self) extends AnyVal {
    ...
    inline def setLatLngs(value: js.Array[js.Array[LatLngExpression] | LatLngExpression]): Self = StObject.set(x, "latLngs", value.asInstanceOf[js.Any])
    
    inline def setLatLngsVarargs(value: (js.Array[LatLngExpression] | LatLngExpression)*): Self = StObject.set(x, "latLngs", js.Array(value*))
