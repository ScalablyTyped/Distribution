...
/* Inlined svelte-leafletjs.svelte-leafletjs.CreateSvelteEventMap<react-leaflet.react-leaflet.MarkerEvents> */
...
object MarkerEvents {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(onadd = onadd.asInstanceOf[js.Any], onclick = onclick.asInstanceOf[js.Any], oncontextmenu = oncontextmenu.asInstanceOf[js.Any], ondblclick = ondblclick.asInstanceOf[js.Any], ondrag = ondrag.asInstanceOf[js.Any], ondragend = ondragend.asInstanceOf[js.Any], ondragstart = ondragstart.asInstanceOf[js.Any], onmousedown = onmousedown.asInstanceOf[js.Any], onmouseout = onmouseout.asInstanceOf[js.Any], onmouseover = onmouseover.asInstanceOf[js.Any], onmove = onmove.asInstanceOf[js.Any], onpopupclose = onpopupclose.asInstanceOf[js.Any], onpopupopen = onpopupopen.asInstanceOf[js.Any], onremove = onremove.asInstanceOf[js.Any])
