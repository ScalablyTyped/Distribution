...
import typings.scrivito.scrivitoStrings.`removals additions`
...
import typings.scrivito.scrivitoStrings.copy
import typings.scrivito.scrivitoStrings.date
import typings.scrivito.scrivitoStrings.decimal
import typings.scrivito.scrivitoStrings.descending
import typings.scrivito.scrivitoStrings.dialog
import typings.scrivito.scrivitoStrings.email
import typings.scrivito.scrivitoStrings.execute
import typings.scrivito.scrivitoStrings.grammar
import typings.scrivito.scrivitoStrings.grid
import typings.scrivito.scrivitoStrings.horizontal
import typings.scrivito.scrivitoStrings.inherit
import typings.scrivito.scrivitoStrings.link
import typings.scrivito.scrivitoStrings.list
import typings.scrivito.scrivitoStrings.listbox
import typings.scrivito.scrivitoStrings.location
import typings.scrivito.scrivitoStrings.menu
import typings.scrivito.scrivitoStrings.mixed
import typings.scrivito.scrivitoStrings.move
import typings.scrivito.scrivitoStrings.no
import typings.scrivito.scrivitoStrings.none
import typings.scrivito.scrivitoStrings.numeric
import typings.scrivito.scrivitoStrings.off
import typings.scrivito.scrivitoStrings.on
import typings.scrivito.scrivitoStrings.other
import typings.scrivito.scrivitoStrings.page
import typings.scrivito.scrivitoStrings.polite
import typings.scrivito.scrivitoStrings.popup
import typings.scrivito.scrivitoStrings.removals
import typings.scrivito.scrivitoStrings.search
import typings.scrivito.scrivitoStrings.spelling
import typings.scrivito.scrivitoStrings.step
import typings.scrivito.scrivitoStrings.tel
import typings.scrivito.scrivitoStrings.text
import typings.scrivito.scrivitoStrings.time
import typings.scrivito.scrivitoStrings.tree
import typings.scrivito.scrivitoStrings.url
import typings.scrivito.scrivitoStrings.vertical
...
/* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLImageElement>, 'content'> */
trait ImageTagProps extends StObject {
...
object ImageTagProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ImageTagProps] (val x: Self) extends AnyVal {
