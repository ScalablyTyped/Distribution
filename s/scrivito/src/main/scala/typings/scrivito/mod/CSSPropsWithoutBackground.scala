...
trait CSSPropsWithoutBackground extends StObject {
  ...
  var hack: js.UndefOr[js.Any] = js.undefined
...
object CSSPropsWithoutBackground {
  ...
  @scala.inline
  def apply(): CSSPropsWithoutBackground = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropsWithoutBackground]
  }
  
  @scala.inline
  implicit class CSSPropsWithoutBackgroundMutableBuilder[Self <: CSSPropsWithoutBackground] (val x: Self) extends AnyVal {
