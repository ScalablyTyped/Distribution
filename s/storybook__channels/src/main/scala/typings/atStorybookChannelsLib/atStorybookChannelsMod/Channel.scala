...
trait Channel extends js.Object {
  def addListener(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
  def addPeerListener(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
  def emit(
  ...
  def listeners(`type`: atStorybookChannelsLib.EventName): js.Array[Listener]
  def on(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
  def once(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
  def prependListener(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
  def removeAllListeners(`type`: atStorybookChannelsLib.EventName): scala.Unit
  def removeListener(`type`: atStorybookChannelsLib.EventName, listener: Listener): scala.Unit
}

object Channel {
  @scala.inline
  def apply(
    addListener: (atStorybookChannelsLib.EventName, Listener) => scala.Unit,
    addPeerListener: (atStorybookChannelsLib.EventName, Listener) => scala.Unit,
    ...
    listeners: atStorybookChannelsLib.EventName => js.Array[Listener],
    on: (atStorybookChannelsLib.EventName, Listener) => scala.Unit,
    once: (atStorybookChannelsLib.EventName, Listener) => scala.Unit,
    prependListener: (atStorybookChannelsLib.EventName, Listener) => scala.Unit,
    removeAllListeners: atStorybookChannelsLib.EventName => scala.Unit,
    removeListener: (atStorybookChannelsLib.EventName, Listener) => scala.Unit
  ): Channel = {
