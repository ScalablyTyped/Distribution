...
object streamDashToDashPromiseMod extends js.Object {
   ...
   */
  def apply(stream: nodeLib.NodeJSNs.ReadableStream): stdLib.Promise[nodeLib.Buffer] = js.native
  /**
   * Return s promise which resolves when the input stream ends
   * @param stream The input stream
   */
  def apply(stream: nodeLib.NodeJSNs.WritableStream): stdLib.Promise[scala.Unit] = js.native
}
