...
object ^ extends js.Object {
  def install(cb: js.Function2[js.UndefOr[stdLib.Error], /* fsPaths */ FsPaths, scala.Unit]): scala.Unit = js.native
  def install(
  ...
  def install(opts: InstallOpts, cb: js.Function2[js.UndefOr[stdLib.Error], /* fsPaths */ FsPaths, scala.Unit]): scala.Unit = js.native
  def start(
    cb: js.Function2[
