...
trait Emitter extends js.Object {
  /**
  		 * @see on( event, fn )
  		 */
  def addEventListener(event: java.lang.String, fn: js.Function): Emitter = js.native
  /**
  ...
  /**
  		 ...
  		 * @return This Emitter
  		 */
  def on(event: java.lang.String, fn: js.Function): Emitter = js.native
  /**
  		 ...
  		 * @return This Emitter
  		 */
  def once(event: java.lang.String, fn: js.Function): Emitter = js.native
  /**
