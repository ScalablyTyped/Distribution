...
object Socks5HostType extends StObject {
  ...
  sealed trait Hostname
    extends StObject
       with Socks5HostType
  /* 3 */ val Hostname: typings.socks.constantsMod.Socks5HostType.Hostname & Double = js.native
  
  @js.native
  sealed trait IPv4
    extends StObject
       with Socks5HostType
  /* 1 */ val IPv4: typings.socks.constantsMod.Socks5HostType.IPv4 & Double = js.native
  
  @js.native
  sealed trait IPv6
    extends StObject
       with Socks5HostType
  /* 4 */ val IPv6: typings.socks.constantsMod.Socks5HostType.IPv6 & Double = js.native
}
