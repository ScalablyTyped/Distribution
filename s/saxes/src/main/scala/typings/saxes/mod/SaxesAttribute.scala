...
object SaxesAttribute {
  ...
  @scala.inline
  def SaxesAttributeNS(local: String, name: String, prefix: String, uri: String, value: String): typings.saxes.mod.SaxesAttributeNS = {
  ...
  @scala.inline
  def SaxesAttributePlain(name: String, value: String): typings.saxes.mod.SaxesAttributePlain = {
