...
trait BasicPaginateOptions[T] extends js.Object {
  ...
  var attributes: js.UndefOr[sequelizeLib.sequelizeMod.FindOptionsAttributesArray | sequelizeLib.Anon_Exclude] = js.undefined
   // [default: false]
  ...
  var where: js.UndefOr[
    sequelizeLib.sequelizeMod.WhereOptions[T] | sequelizeLib.sequelizeMod.where | sequelizeLib.sequelizeMod.fn | (js.Array[
