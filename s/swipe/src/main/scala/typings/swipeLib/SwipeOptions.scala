...
object SwipeOptions {
  ...
  def apply(
    ...
    callback: js.Function2[/* index */ scala.Double, /* elem */ stdLib.HTMLElement, scala.Unit] = null,
    ...
    transitionEnd: js.Function2[/* index */ scala.Double, /* elem */ stdLib.HTMLElement, scala.Unit] = null
  ): SwipeOptions = {
