...
trait Peer extends js.Object {
  ...
  @JSName("on")
  def on_call(
    event: skywayLib.skywayLibStrings.call,
  ...
  /**
           ...
           */
  @JSName("on")
  def on_disconnected(event: skywayLib.skywayLibStrings.disconnected, cb: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
