...
object IROOM_CAPACITY_CHANGE_ERROR {
  ...
  inline def apply(errorCode: Double, errorMessage: String): IROOM_CAPACITY_CHANGE_ERROR = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IROOM_CAPACITY_CHANGE_ERROR] (val x: Self) extends AnyVal {
