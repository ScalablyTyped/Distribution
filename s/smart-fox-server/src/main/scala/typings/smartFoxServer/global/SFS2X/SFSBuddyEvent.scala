...
@js.native
class SFSBuddyEvent ()
  extends typings.smartFoxServer.SFS2X.SFSBuddyEvent
/* static members */
object SFSBuddyEvent {
  ...
  @scala.inline
  def BUDDY_ADD_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_ADD")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_BLOCK_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_BLOCK")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_ERROR_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_ERROR")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_LIST_INIT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_LIST_INIT")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_MESSAGE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_MESSAGE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_ONLINE_STATE_CHANGE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_ONLINE_STATE_CHANGE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_REMOVE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_REMOVE")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def BUDDY_VARIABLES_UPDATE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BUDDY_VARIABLES_UPDATE")(x.asInstanceOf[js.Any])
}
