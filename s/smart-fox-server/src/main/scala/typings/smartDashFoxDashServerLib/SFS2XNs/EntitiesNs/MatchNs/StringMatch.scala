...
object StringMatch extends js.Object {
  ...
  var CONTAINS: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.MatchNs.StringMatch = js.native
  ...
  var ENDS_WITH: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.MatchNs.StringMatch = js.native
  /** @type {StringMatch} An instance of StringMatch representing the following condition: string1 == string2. */
  var EQUALS: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.MatchNs.StringMatch = js.native
  /** @type {StringMatch} An instance of StringMatch representing the following condition: string1 != string2. */
  var NOT_EQUALS: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.MatchNs.StringMatch = js.native
  ...
  var STARTS_WITH: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.MatchNs.StringMatch = js.native
}
