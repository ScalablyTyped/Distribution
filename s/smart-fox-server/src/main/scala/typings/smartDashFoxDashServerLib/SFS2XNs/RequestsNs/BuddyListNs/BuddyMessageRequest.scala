...
class BuddyMessageRequest protected () extends js.Object {
  /**
    ...
    */
  def this(message: java.lang.String, targetBuddy: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.SFSBuddy) = this()
  def this(message: java.lang.String, targetBuddy: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.SFSBuddy, parms: js.Object) = this()
}
