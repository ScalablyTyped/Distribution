...
class PublicMessageRequest protected () extends js.Object {
  ...
  def this(message: java.lang.String, params: js.Object) = this()
  def this(message: java.lang.String, params: js.Object, targetRoom: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.SFSRoom) = this()
}
