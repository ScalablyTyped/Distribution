...
class SFSUser protected () extends js.Object {
  ...
  def this(id: scala.Double, name: java.lang.String, isItMe: scala.Boolean) = this()
  /** @type {Data.Vec3D} Returns the entry point of this user in the current user's AoI. */
  var aoiEntryPoint: smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.DataNs.Vec3D = js.native
  ...
  var isItMe: scala.Boolean = js.native
  ...
  var privilegeId: scala.Double = js.native
  ...
  /**
    ...
    */
  def getPlayerId(room: SFSRoom): scala.Double = js.native
  /**
    ...
    */
  def getUserManager(): smartDashFoxDashServerLib.SFS2XNs.ManagersNs.UserManager = js.native
  /**
    ...
    */
  def getVariable(varName: java.lang.String): smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.VariablesNs.SFSUserVariable = js.native
  /**
    ...
    */
  def getVariables(): js.Array[smartDashFoxDashServerLib.SFS2XNs.EntitiesNs.VariablesNs.SFSUserVariable] = js.native
  /**
    ...
    */
  def isAdmin(): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def isJoinedInRoom(room: SFSRoom): scala.Boolean = js.native
  /**
    ...
    */
  def isModerator(): scala.Boolean = js.native
  /**
    ...
    */
  def isPlayer(): scala.Boolean = js.native
  /**
    ...
    */
  def isPlayerInRoom(room: SFSRoom): scala.Boolean = js.native
  /**
    ...
    */
  def isSpectator(): scala.Boolean = js.native
  /**
    ...
    */
  def isSpectatorInRoom(room: SFSRoom): scala.Boolean = js.native
  /**
    ...
    */
  def isStandardUser(): scala.Boolean = js.native
}
