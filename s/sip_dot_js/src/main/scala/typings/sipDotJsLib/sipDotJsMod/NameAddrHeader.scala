...
class NameAddrHeader protected () extends js.Object {
  def this(uri: URI, displayName: java.lang.String, parameters: js.Array[sipDotJsLib.Anon_Key]) = this()
...
object NameAddrHeader extends js.Object {
  def parse(name_addr_header: java.lang.String): sipDotJsLib.sipDotJsMod.NameAddrHeader = js.native
}
