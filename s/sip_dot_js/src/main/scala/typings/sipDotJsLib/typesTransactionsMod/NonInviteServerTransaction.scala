...
@JSImport("sip.js/types/transactions", "NonInviteServerTransaction")
@js.native
class NonInviteServerTransaction protected ()
  ...
  def receiveResponse(statusCode: scala.Double, response: java.lang.String): js.Promise[_] = js.native
