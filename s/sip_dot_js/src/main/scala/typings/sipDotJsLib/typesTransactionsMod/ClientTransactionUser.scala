...
trait ClientTransactionUser extends TransactionUser {
  ...
  var receiveResponse: js.UndefOr[
    js.Function1[/* response */ sipDotJsLib.typesSipDashMessageMod.IncomingResponse, scala.Unit]
  ] = js.undefined
}
...
object ClientTransactionUser {
  ...
  def apply(
    ...
    receiveResponse: /* response */ sipDotJsLib.typesSipDashMessageMod.IncomingResponse => scala.Unit = null
