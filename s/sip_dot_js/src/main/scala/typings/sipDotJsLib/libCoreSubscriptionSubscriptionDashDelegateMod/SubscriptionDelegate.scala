package typings
package sipDotJsLib.libCoreSubscriptionSubscriptionDashDelegateMod
...
trait SubscriptionDelegate extends js.Object {
  ...
  var onRefresh: js.UndefOr[
    js.Function1[
      /* request */ sipDotJsLib.libCoreMessagesMethodsSubscribeMod.OutgoingSubscribeRequest, 
      scala.Unit
    ]
  ] = js.undefined
  /**
    ...
    */
  var onTerminated: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
}
...
object SubscriptionDelegate {
  ...
  def apply(
    ...
    onRefresh: /* request */ sipDotJsLib.libCoreMessagesMethodsSubscribeMod.OutgoingSubscribeRequest => scala.Unit = null,
    onTerminated: () => scala.Unit = null
