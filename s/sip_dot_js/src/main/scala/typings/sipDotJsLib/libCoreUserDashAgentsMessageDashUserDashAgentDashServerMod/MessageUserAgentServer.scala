package typings
package sipDotJsLib.libCoreUserDashAgentsMessageDashUserDashAgentDashServerMod
...
- sipDotJsLib.libCoreMessagesMethodsMessageMod.IncomingMessageRequest because Already inherited */ @JSImport("sip.js/lib/Core/user-agents/message-user-agent-server", "MessageUserAgentServer")
@js.native
