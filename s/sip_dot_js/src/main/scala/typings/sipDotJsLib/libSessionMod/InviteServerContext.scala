...
- sipDotJsLib.libServerContextMod.ServerContext because Inheritance from two classes. Inlined incomingRequest, request, transaction, progress, progress, accept, accept, reject, reject, reply, reply, onRequestTimeout, onTransportError */ @JSImport("sip.js/lib/Session", "InviteServerContext")
@js.native
class InviteServerContext protected () extends Session {
  ...
  /**
    ...
    */
  val autoSendAnInitialProvisionalResponse: scala.Boolean = js.native
  var getOffer: js.Any = js.native
  var getSessionDescriptionHandler: js.Any = js.native
  var incomingRequest: sipDotJsLib.libCoreMessagesMethodsInviteMod.IncomingInviteRequest | sipDotJsLib.libCoreMessagesIncomingDashRequestMod.IncomingRequest = js.native
  /**
  ...
  /* protected */ def generateResponseOfferAnswer(options: sipDotJsLib.Anon_Modifiers): js.Promise[js.UndefOr[sipDotJsLib.libCoreMessagesBodyMod.Body]] = js.native
  /* protected */ def handlePrackOfferAnswer(
  ...
  /* protected */ def setupSessionDescriptionHandler(): sipDotJsLib.libSessionDashDescriptionDashHandlerMod.SessionDescriptionHandler = js.native
}
