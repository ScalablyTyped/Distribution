package typings
package sipDotJsLib.libSessionMod.ReferServerContextNs
...
trait AcceptOptions extends js.Object {
  ...
  var inviteOptions: js.UndefOr[sipDotJsLib.libSessionMod.InviteClientContextNs.Options] = js.undefined
}
...
object AcceptOptions {
  ...
  def apply(
    ...
    inviteOptions: sipDotJsLib.libSessionMod.InviteClientContextNs.Options = null
  ): AcceptOptions = {
