...
@JSImport("sip.js/lib/Transactions", "ClientTransaction")
@js.native
abstract class ClientTransaction protected () extends Transaction {
  protected def this(_request: sipDotJsLib.libSIPMessageMod.OutgoingRequest, transport: sipDotJsLib.libTransportMod.Transport, user: ClientTransactionUser, state: TransactionState, loggerCategory: java.lang.String) = this()
