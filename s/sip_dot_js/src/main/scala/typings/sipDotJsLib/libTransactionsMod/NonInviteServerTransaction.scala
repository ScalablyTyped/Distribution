...
@JSImport("sip.js/lib/Transactions", "NonInviteServerTransaction")
@js.native
class NonInviteServerTransaction protected () extends ServerTransaction {
  /**
    ...
    */
  def this(request: sipDotJsLib.libSIPMessageMod.IncomingRequest, transport: sipDotJsLib.libTransportMod.Transport, user: ServerTransactionUser) = this()
