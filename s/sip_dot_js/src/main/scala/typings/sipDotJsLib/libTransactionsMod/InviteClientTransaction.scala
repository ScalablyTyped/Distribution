...
@JSImport("sip.js/lib/Transactions", "InviteClientTransaction")
@js.native
class InviteClientTransaction protected () extends ClientTransaction {
  /**
    ...
    */
  def this(request: sipDotJsLib.libSIPMessageMod.OutgoingRequest, transport: sipDotJsLib.libTransportMod.Transport, user: ClientTransactionUser) = this()
