...
class RequestSender protected () extends js.Object {
  ...
  var clientTransaction: js.UndefOr[
    sipDotJsLib.typesTransactionsMod.InviteClientTransaction | sipDotJsLib.typesTransactionsMod.NonInviteClientTransaction | sipDotJsLib.typesTransactionsMod.AckClientTransaction
  ] = js.native
  ...
  def send(): sipDotJsLib.typesTransactionsMod.InviteClientTransaction | sipDotJsLib.typesTransactionsMod.NonInviteClientTransaction | sipDotJsLib.typesTransactionsMod.AckClientTransaction = js.native
}
