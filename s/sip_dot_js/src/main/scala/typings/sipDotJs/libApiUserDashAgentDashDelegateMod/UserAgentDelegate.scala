package typings.sipDotJs.libApiUserDashAgentDashDelegateMod

import typings.sipDotJs.libApiInvitationMod.Invitation
import typings.sipDotJs.libApiMessageMod.Message
