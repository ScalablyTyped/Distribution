...
object UserAgentOptions {
  ...
  def apply(
    ...
    if (authorizationPassword != null) __obj.updateDynamic("authorizationPassword")(authorizationPassword)
    if (authorizationUsername != null) __obj.updateDynamic("authorizationUsername")(authorizationUsername)
    ...
    if (sipExtensionReplaces != null) __obj.updateDynamic("sipExtensionReplaces")(sipExtensionReplaces)
