...
import typings.sipDotJs.libReferContextMod.ReferServerContextNs.AcceptOptions
import typings.sipDotJs.libReferContextMod.ReferServerContextNs.RejectOptions
...
@js.native
class ReferServerContext protected () extends ServerContext {
