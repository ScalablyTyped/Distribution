package typings.sipDotJs.libCoreUserDashAgentsMessageDashUserDashAgentDashServerMod
...
- typings.sipDotJs.libCoreMessagesMethodsMessageMod.IncomingMessageRequest because Already inherited */ @JSImport("sip.js/lib/core/user-agents/message-user-agent-server", "MessageUserAgentServer")
@js.native
