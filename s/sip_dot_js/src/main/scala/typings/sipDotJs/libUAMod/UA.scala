...
class UA () extends EventEmitter {
  ...
  def invite(target: String, options: typings.sipDotJs.libSessionMod.InviteClientContextNs.Options): InviteClientContext = js.native
  def invite(
    target: String,
    options: typings.sipDotJs.libSessionMod.InviteClientContextNs.Options,
    modifiers: SessionDescriptionHandlerModifiers
  ): InviteClientContext = js.native
  def invite(target: URI): InviteClientContext = js.native
  def invite(target: URI, options: typings.sipDotJs.libSessionMod.InviteClientContextNs.Options): InviteClientContext = js.native
  def invite(
    target: URI,
    options: typings.sipDotJs.libSessionMod.InviteClientContextNs.Options,
    modifiers: SessionDescriptionHandlerModifiers
