package typings.sipDotJs.libCoreUserDashAgentsInfoDashUserDashAgentDashServerMod
...
- typings.sipDotJs.libCoreMessagesMethodsInfoMod.IncomingInfoRequest because Already inherited */ @JSImport("sip.js/lib/core/user-agents/info-user-agent-server", "InfoUserAgentServer")
@js.native
