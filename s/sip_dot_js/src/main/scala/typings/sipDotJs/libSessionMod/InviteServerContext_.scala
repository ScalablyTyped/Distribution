...
import typings.sipDotJs.libSessionMod.InviteServerContext.Options
...
- typings.events.eventsMod.EventEmitter because Already inherited
...
@js.native
class InviteServerContext_ protected () extends Session {
