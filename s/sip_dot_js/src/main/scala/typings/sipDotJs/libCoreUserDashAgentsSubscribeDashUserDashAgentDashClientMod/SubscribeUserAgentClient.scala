package typings.sipDotJs.libCoreUserDashAgentsSubscribeDashUserDashAgentDashClientMod
...
- typings.sipDotJs.libCoreMessagesMethodsSubscribeMod.OutgoingSubscribeRequest because var conflicts: delegate, message. Inlined waitNotifyStop */ @JSImport("sip.js/lib/core/user-agents/subscribe-user-agent-client", "SubscribeUserAgentClient")
@js.native
