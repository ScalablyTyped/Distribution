...
object ExceptionsNs extends js.Object {
  ...
  class ClosedSessionDescriptionHandlerError ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.ClosedSessionDescriptionHandlerError
  
  @js.native
  class ConfigurationError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.ConfigurationError {
  ...
  class InvalidStateError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.InvalidStateError {
    def this(status: typings.sipDotJs.libEnumsMod.SessionStatus) = this()
  }
  
  @js.native
  class MethodParameterError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.MethodParameterError {
    def this(method: String, parameter: String, value: js.Any) = this()
  }
  
  @js.native
  class NotSupportedError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.NotSupportedError {
    def this(message: String) = this()
  }
  
  @js.native
  class RenegotiationError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.RenegotiationError {
    def this(message: String) = this()
  }
  
  @js.native
  class SessionDescriptionHandlerError protected ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.SessionDescriptionHandlerError {
  ...
  class TerminatedSessionError ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.TerminatedSessionError
  ...
  class UnsupportedSessionDescriptionContentTypeError ()
    extends typings.sipDotJs.libExceptionsMod.ExceptionsNs.UnsupportedSessionDescriptionContentTypeError {
    def this(message: String) = this()
  }
