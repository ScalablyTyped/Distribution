package typings.sipJs.sessionByeOptionsMod
...
trait SessionByeOptions extends js.Object {
  /** See `core` API. */
...
object SessionByeOptions {
  @scala.inline
  def apply(requestDelegate: OutgoingRequestDelegate = null, requestOptions: RequestOptions = null): SessionByeOptions = {
