...
import typings.sipJs.libCoreMessagesMethodsRegisterMod.IncomingRegisterRequest
import typings.sipJs.libCoreMessagesMethodsSubscribeMod.IncomingSubscribeRequest
