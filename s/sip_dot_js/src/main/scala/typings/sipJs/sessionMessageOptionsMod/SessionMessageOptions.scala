package typings.sipJs.sessionMessageOptionsMod
...
trait SessionMessageOptions extends js.Object {
  /** See `core` API. */
...
object SessionMessageOptions {
  @scala.inline
  def apply(requestDelegate: OutgoingRequestDelegate = null, requestOptions: RequestOptions = null): SessionMessageOptions = {
