...
object mod {
  ...
  @js.native
  open class WithChildren_ () extends WithChildren
  ...
  @js.native
  open class WithContext_[C] () extends WithContext[C]
  
  @JSImport("skatejs", "WithLifecycle")
  @js.native
  open class WithLifecycle_ () extends WithLifecycle
  
  @JSImport("skatejs", "WithRenderer")
  @js.native
  open class WithRenderer_[O] () extends WithRenderer[O]
  
  @JSImport("skatejs", "WithUpdate")
  @js.native
  open class WithUpdate_[P, S] () extends WithUpdate[P, S]
  ...
  inline def link(elem: typings.skatejs.typesMod.CustomElement): js.Function1[/* e */ ComposedCustomEvent, Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("link")(elem.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* e */ ComposedCustomEvent, Unit]]
  inline def link(elem: typings.skatejs.typesMod.CustomElement, target: String): js.Function1[/* e */ ComposedCustomEvent, Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(elem.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* e */ ComposedCustomEvent, Unit]]
  ...
  inline def shadow(elem: typings.skatejs.typesMod.CustomElement): ShadowRoot = ^.asInstanceOf[js.Dynamic].applyDynamic("shadow")(elem.asInstanceOf[js.Any]).asInstanceOf[ShadowRoot]
