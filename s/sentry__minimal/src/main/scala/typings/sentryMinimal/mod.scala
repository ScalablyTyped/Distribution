...
object mod {
  ...
  inline def callOnClient(method: String, args: js.Any*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("_callOnClient")(method.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def configureScope(callback: js.Function1[/* scope */ Scope, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("configureScope")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def withScope(callback: js.Function1[/* scope */ Scope, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("withScope")(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
