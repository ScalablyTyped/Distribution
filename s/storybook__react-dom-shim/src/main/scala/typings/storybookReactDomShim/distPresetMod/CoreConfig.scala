...
import typings.storybookReactDomShim.anon.PartialOptions1
...
trait CoreConfig extends StObject {
  ...
  var builder: js.UndefOr[BuilderName | typings.storybookReactDomShim.anon.Options] = js.undefined
  
  var channelOptions: js.UndefOr[PartialOptions1] = js.undefined
  ...
  var renderer: js.UndefOr[RendererName] = js.undefined
}
object CoreConfig {
  
  inline def apply(): CoreConfig = {
  ...
  implicit open class MutableBuilder[Self <: CoreConfig] (val x: Self) extends AnyVal {
    ...
    inline def setBuilder(value: BuilderName | typings.storybookReactDomShim.anon.Options): Self = StObject.set(x, "builder", value.asInstanceOf[js.Any])
    
    inline def setBuilderUndefined: Self = StObject.set(x, "builder", js.undefined)
    
    inline def setChannelOptions(value: PartialOptions1): Self = StObject.set(x, "channelOptions", value.asInstanceOf[js.Any])
    ...
    inline def setRenderer(value: RendererName): Self = StObject.set(x, "renderer", value.asInstanceOf[js.Any])
