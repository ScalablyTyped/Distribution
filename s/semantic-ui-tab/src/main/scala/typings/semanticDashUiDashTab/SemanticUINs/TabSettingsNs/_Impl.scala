package typings.semanticDashUiDashTab.SemanticUINs.TabSettingsNs

import typings.semanticDashUiDashApi.SemanticUINs.ApiSettings
import typings.semanticDashUiDashTab.JQuery
import typings.semanticDashUiDashTab.SemanticUINs.TabNs.ClassNameSettings
import typings.semanticDashUiDashTab.SemanticUINs.TabNs.ErrorSettings
import typings.semanticDashUiDashTab.SemanticUINs.TabNs.MetadataSettings
import typings.semanticDashUiDashTab.SemanticUINs.TabNs.SelectorSettings
import typings.semanticDashUiDashTab.SemanticUINs.TabNs.TemplatesSettings
...
object _Impl {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(alwaysRefresh = alwaysRefresh, apiSettings = apiSettings, auto = auto, cache = cache, cacheType = cacheType.asInstanceOf[js.Any], childrenOnly = childrenOnly, className = className, context = context.asInstanceOf[js.Any], deactivate = deactivate.asInstanceOf[js.Any], debug = debug, error = error, evaluateScripts = evaluateScripts.asInstanceOf[js.Any], history = history, historyType = historyType.asInstanceOf[js.Any], ignoreFirstLoad = ignoreFirstLoad, loadOnce = loadOnce, maxDepth = maxDepth, metadata = metadata, name = name, namespace = namespace, onFirstLoad = js.Any.fromFunction4(onFirstLoad), onLoad = js.Any.fromFunction4(onLoad), onRequest = js.Any.fromFunction2(onRequest), onVisible = js.Any.fromFunction2(onVisible), path = path.asInstanceOf[js.Any], performance = performance, selector = selector, silent = silent, templates = templates, verbose = verbose)
