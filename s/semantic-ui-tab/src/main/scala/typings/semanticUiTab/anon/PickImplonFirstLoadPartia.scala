...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'onFirstLoad'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplonFirstLoadPartia
  extends StObject
     with Param {
...
object PickImplonFirstLoadPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonFirstLoadPartia] (val x: Self) extends AnyVal {
