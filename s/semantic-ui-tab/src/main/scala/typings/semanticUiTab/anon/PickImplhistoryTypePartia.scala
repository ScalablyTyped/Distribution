...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'historyType'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplhistoryTypePartia
  extends StObject
     with Param {
...
object PickImplhistoryTypePartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplhistoryTypePartia] (val x: Self) extends AnyVal {
