...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'alwaysRefresh'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplalwaysRefreshPart
  extends StObject
     with Param {
...
object PickImplalwaysRefreshPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplalwaysRefreshPart] (val x: Self) extends AnyVal {
