...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'childrenOnly'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplchildrenOnlyParti
  extends StObject
     with Param {
