...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'evaluateScripts'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplevaluateScriptsPa
  extends StObject
     with Param {
...
object PickImplevaluateScriptsPa {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplevaluateScriptsPa] (val x: Self) extends AnyVal {
