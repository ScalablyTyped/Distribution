...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'context'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
