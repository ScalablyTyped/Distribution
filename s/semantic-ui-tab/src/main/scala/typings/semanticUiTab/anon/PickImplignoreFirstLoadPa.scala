...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'ignoreFirstLoad'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplignoreFirstLoadPa
  extends StObject
     with Param {
