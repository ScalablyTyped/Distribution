...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'maxDepth'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplmaxDepthPartialPi
  extends StObject
     with Param {
...
object PickImplmaxDepthPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmaxDepthPartialPi] (val x: Self) extends AnyVal {
