...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'cacheType'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplcacheTypePartialP
  extends StObject
     with Param {
...
object PickImplcacheTypePartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplcacheTypePartialP] (val x: Self) extends AnyVal {
