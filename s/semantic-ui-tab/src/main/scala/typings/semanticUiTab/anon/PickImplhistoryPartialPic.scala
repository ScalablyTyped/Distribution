...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'history'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplhistoryPartialPic
  extends StObject
     with Param {
...
object PickImplhistoryPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplhistoryPartialPic] (val x: Self) extends AnyVal {
