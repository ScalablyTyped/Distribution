...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'namespace'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
