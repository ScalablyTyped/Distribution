...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'apiSettings'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
