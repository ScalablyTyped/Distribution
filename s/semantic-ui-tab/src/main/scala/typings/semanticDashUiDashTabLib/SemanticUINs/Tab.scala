...
trait Tab extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashTabLib.semanticDashUiDashTabLibStrings.setting, name: K): js.Any = js.native
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashTabLib.semanticDashUiDashTabLibStrings.setting, name: K, value: js.Any): semanticDashUiDashTabLib.JQuery = js.native
}
