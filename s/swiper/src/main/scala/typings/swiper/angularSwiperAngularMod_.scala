...
object angularSwiperAngularMod_ {
  
  @JSImport("swiper/angular/swiper_angular", "SwiperComponent")
  @js.native
  open class SwiperComponent protected ()
    extends typings.swiper.angularSwiperAngularMod.SwiperComponent {
    def this(
      _ngZone: NgZone,
  ...
  open class SwiperModule ()
    extends typings.swiper.angularSwiperAngularMod.SwiperModule
  /* static members */
  object SwiperModule {
  ...
  open class SwiperSlideDirective protected ()
    extends typings.swiper.angularSwiperAngularMod.SwiperSlideDirective {
