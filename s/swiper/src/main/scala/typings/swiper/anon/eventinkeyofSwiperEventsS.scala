...
object eventinkeyofSwiperEventsS {
  ...
  extension [Self <: eventinkeyofSwiperEventsS](x: Self) {
    ...
    inline def setBreakpoint(value: (/* swiper */ default, eventinkeyofSwiperEventsS) => Unit): Self = StObject.set(x, "breakpoint", js.Any.fromFunction2(value))
    ...
    inline def set_beforeBreakpoint(value: (/* swiper */ default, eventinkeyofSwiperEventsS) => Unit): Self = StObject.set(x, "_beforeBreakpoint", js.Any.fromFunction2(value))
