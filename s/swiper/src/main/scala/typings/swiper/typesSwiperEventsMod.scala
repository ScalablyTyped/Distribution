...
import typings.swiper.a11yMod.A11yEvents
import typings.swiper.anon.ClassNames
import typings.swiper.autoplayMod.AutoplayEvents
import typings.swiper.controllerMod.ControllerEvents
import typings.swiper.effectCardsMod.CardsEffectEvents
import typings.swiper.effectCoverflowMod.CoverflowEffectEvents
import typings.swiper.effectCreativeMod.CreativeEffectEvents
import typings.swiper.effectCubeMod.CubeEffectEvents
import typings.swiper.effectFadeMod.FadeEffectEvents
import typings.swiper.effectFlipMod.FlipEffectEvents
import typings.swiper.freeModeMod.FreeModeEvents
import typings.swiper.hashNavigationMod.HashNavigationEvents
import typings.swiper.historyMod.HistoryEvents
import typings.swiper.keyboardMod.KeyboardEvents
import typings.swiper.lazyMod.LazyEvents
import typings.swiper.mousewheelMod.MousewheelEvents
import typings.swiper.navigationMod.NavigationEvents
import typings.swiper.paginationMod.PaginationEvents
import typings.swiper.parallaxMod.ParallaxEvents
import typings.swiper.scrollbarMod.ScrollbarEvents
import typings.swiper.swiperClassMod.default
import typings.swiper.swiperOptionsMod.SwiperOptions
import typings.swiper.thumbsMod.ThumbsEvents
import typings.swiper.virtualMod.VirtualEvents
import typings.swiper.zoomMod.ZoomEvents
