...
import typings.swiper.jsSwiperDotEsmMod.A11y
import typings.swiper.jsSwiperDotEsmMod.Autoplay
import typings.swiper.jsSwiperDotEsmMod.Controller
import typings.swiper.jsSwiperDotEsmMod.EffectCoverflow
import typings.swiper.jsSwiperDotEsmMod.EffectCube
import typings.swiper.jsSwiperDotEsmMod.EffectFade
import typings.swiper.jsSwiperDotEsmMod.EffectFlip
import typings.swiper.jsSwiperDotEsmMod.HashNavigation
import typings.swiper.jsSwiperDotEsmMod.History
import typings.swiper.jsSwiperDotEsmMod.Keyboard
import typings.swiper.jsSwiperDotEsmMod.Lazy
import typings.swiper.jsSwiperDotEsmMod.Mousewheel
import typings.swiper.jsSwiperDotEsmMod.Navigation
import typings.swiper.jsSwiperDotEsmMod.Pagination
import typings.swiper.jsSwiperDotEsmMod.Parallax
