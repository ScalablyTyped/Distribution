...
object publicApiMod {
  ...
  open class SwiperComponent protected ()
    extends typings.swiper.swiperComponentMod.SwiperComponent {
    def this(
      _ngZone: NgZone,
  ...
  open class SwiperModule ()
    extends typings.swiper.swiperModuleMod.SwiperModule
  /* static members */
  object SwiperModule {
  ...
  open class SwiperSlideDirective protected ()
    extends typings.swiper.swiperSlideDirectiveMod.SwiperSlideDirective {
