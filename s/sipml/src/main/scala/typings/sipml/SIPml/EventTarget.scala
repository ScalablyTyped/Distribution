...
object EventTarget {
  ...
  @scala.inline
  implicit class EventTargetOps[Self <: EventTarget[_, _], /* <: java.lang.String */ EventSubscriptionType, /* <: typings.sipml.SIPml.Event */ EventType] (val x: Self with (EventTarget[EventSubscriptionType, EventType])) extends AnyVal {
    @scala.inline
