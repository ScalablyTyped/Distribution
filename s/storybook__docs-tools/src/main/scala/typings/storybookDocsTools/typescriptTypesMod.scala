...
object typescriptTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.storybookDocsTools.typescriptTypesMod.TSObjectSigType
    - typings.storybookDocsTools.typescriptTypesMod.TSFuncSigType
  */
  trait TSSigType
    extends StObject
       with TSType
  object TSSigType {
    ...
    inline def TSFuncSigType(signature: Return): typings.storybookDocsTools.typescriptTypesMod.TSFuncSigType = {
      val __obj = js.Dynamic.literal(name = "signature", signature = signature.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("function")
      __obj.asInstanceOf[typings.storybookDocsTools.typescriptTypesMod.TSFuncSigType]
    }
    
    inline def TSObjectSigType(signature: PropertiesArray): typings.storybookDocsTools.typescriptTypesMod.TSObjectSigType = {
      val __obj = js.Dynamic.literal(name = "signature", signature = signature.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("object")
      __obj.asInstanceOf[typings.storybookDocsTools.typescriptTypesMod.TSObjectSigType]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.storybookDocsTools.typescriptTypesMod.TSScalarType
    - typings.storybookDocsTools.typescriptTypesMod.TSCombinationType
    - typings.storybookDocsTools.typescriptTypesMod.TSSigType
    - typings.storybookDocsTools.typescriptTypesMod.TSArrayType
  */
  trait TSType extends StObject
  object TSType {
    
    inline def TSArrayType(elements: js.Array[TSType]): typings.storybookDocsTools.typescriptTypesMod.TSArrayType = {
      val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any], name = "Array")
      __obj.asInstanceOf[typings.storybookDocsTools.typescriptTypesMod.TSArrayType]
    }
    
    inline def TSCombinationType(elements: js.Array[TSType], name: union | intersection): typings.storybookDocsTools.typescriptTypesMod.TSCombinationType = {
      val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.storybookDocsTools.typescriptTypesMod.TSCombinationType]
    }
    ...
    inline def TSScalarType(name: any | boolean | number | void | string | symbol): typings.storybookDocsTools.typescriptTypesMod.TSScalarType = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.storybookDocsTools.typescriptTypesMod.TSScalarType]
    }
  }
}
