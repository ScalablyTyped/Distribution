...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.storybookDocsTools.typesMod.FlowObjectSigType
    - typings.storybookDocsTools.typesMod.FlowFuncSigType
  */
  trait FlowSigType
    extends StObject
       with FlowType
  object FlowSigType {
    ...
    inline def FlowFuncSigType(signature: Arguments): typings.storybookDocsTools.typesMod.FlowFuncSigType = {
      val __obj = js.Dynamic.literal(name = "signature", signature = signature.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("function")
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowFuncSigType]
    }
    
    inline def FlowObjectSigType(signature: Properties): typings.storybookDocsTools.typesMod.FlowObjectSigType = {
      val __obj = js.Dynamic.literal(name = "signature", signature = signature.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("object")
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowObjectSigType]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.storybookDocsTools.typesMod.FlowScalarType
    - typings.storybookDocsTools.typesMod.FlowLiteralType
    - typings.storybookDocsTools.typesMod.FlowCombinationType
    - typings.storybookDocsTools.typesMod.FlowSigType
    - typings.storybookDocsTools.typesMod.FlowArrayType
  */
  trait FlowType extends StObject
  object FlowType {
    
    inline def FlowArrayType(elements: js.Array[FlowType]): typings.storybookDocsTools.typesMod.FlowArrayType = {
      val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any], name = "Array")
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowArrayType]
    }
    
    inline def FlowCombinationType(elements: js.Array[FlowType], name: union | intersection): typings.storybookDocsTools.typesMod.FlowCombinationType = {
      val __obj = js.Dynamic.literal(elements = elements.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowCombinationType]
    }
    ...
    inline def FlowLiteralType(value: String): typings.storybookDocsTools.typesMod.FlowLiteralType = {
      val __obj = js.Dynamic.literal(name = "literal", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowLiteralType]
    }
    ...
    inline def FlowScalarType(name: any | boolean | number | void | string | symbol): typings.storybookDocsTools.typesMod.FlowScalarType = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.storybookDocsTools.typesMod.FlowScalarType]
    }
  }
}
