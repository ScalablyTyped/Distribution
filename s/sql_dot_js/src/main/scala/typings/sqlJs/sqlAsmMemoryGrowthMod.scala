...
object sqlAsmMemoryGrowthMod {
  
  @JSImport("sql.js/dist/sql-asm-memory-growth", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("sql.js/dist/sql-asm-memory-growth", JSImport.Default)
  @js.native
  def default: InitSqlJsStatic = js.native
  
  @JSImport("sql.js/dist/sql-asm-memory-growth", "Database")
  @js.native
  /**
  ...
  @JSImport("sql.js/dist/sql-asm-memory-growth", "Statement")
  @js.native
  open class Statement ()
    extends typings.sqlJs.mod.Statement
  
  @JSImport("sql.js/dist/sql-asm-memory-growth", "StatementIterator")
  @js.native
