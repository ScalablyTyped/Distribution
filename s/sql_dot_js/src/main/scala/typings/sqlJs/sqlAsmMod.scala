...
object sqlAsmMod {
  ...
  @JSImport("sql.js/dist/sql-asm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("sql.js/dist/sql-asm", JSImport.Default)
  @js.native
  def default: InitSqlJsStatic = js.native
  
  @JSImport("sql.js/dist/sql-asm", "Database")
  @js.native
  /**
  ...
  @JSImport("sql.js/dist/sql-asm", "Statement")
  @js.native
  open class Statement ()
    extends typings.sqlJs.mod.Statement
  
  @JSImport("sql.js/dist/sql-asm", "StatementIterator")
  @js.native
