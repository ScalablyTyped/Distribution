...
object sqlAsmDebugMod {
  
  @JSImport("sql.js/dist/sql-asm-debug", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("sql.js/dist/sql-asm-debug", JSImport.Default)
  @js.native
  def default: InitSqlJsStatic = js.native
  
  @JSImport("sql.js/dist/sql-asm-debug", "Database")
  @js.native
  /**
  ...
  @JSImport("sql.js/dist/sql-asm-debug", "Statement")
  @js.native
  open class Statement ()
    extends typings.sqlJs.mod.Statement
  
  @JSImport("sql.js/dist/sql-asm-debug", "StatementIterator")
  @js.native
