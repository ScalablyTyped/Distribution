...
object sqlWasmDebugMod {
  
  @JSImport("sql.js/dist/sql-wasm-debug", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("sql.js/dist/sql-wasm-debug", JSImport.Default)
  @js.native
  def default: InitSqlJsStatic = js.native
  
  @JSImport("sql.js/dist/sql-wasm-debug", "Database")
  @js.native
  /**
  ...
  @JSImport("sql.js/dist/sql-wasm-debug", "Statement")
  @js.native
  open class Statement ()
    extends typings.sqlJs.mod.Statement
  
  @JSImport("sql.js/dist/sql-wasm-debug", "StatementIterator")
  @js.native
