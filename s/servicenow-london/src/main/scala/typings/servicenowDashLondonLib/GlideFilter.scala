...
object GlideFilter extends js.Object {
  /**
    ...
    * }
    */
  def checkRecord(gr: servicenowDashLondonLib.ScopedGlideRecord, filter: java.lang.String): scala.Boolean = js.native
  def checkRecord(gr: servicenowDashLondonLib.ScopedGlideRecord, filter: java.lang.String, matchAll: js.Object): scala.Boolean = js.native
}
