...
class GlideDateTime () extends js.Object {
  ...
  /**
    ...
    * gs.info(gdt.getNumericValue());
    */
  def add(milliseconds: scala.Double): scala.Unit = js.native
  /**
    ...
    */
  def addDaysLocalTime(days: scala.Double): scala.Unit = js.native
  /**
    * Adds a specified number of days to the current GlideDateTime object. A negative parameter
  ...
  /**
    ...
    */
  def after(gdt: GlideDateTime): scala.Boolean = js.native
  /**
    ...
    */
  def before(gdt: GlideDateTime): scala.Boolean = js.native
  /**
  ...
  def equals(dateTime: java.lang.String): scala.Boolean = js.native
  /**
    ...
    */
  def equals(dateTime: GlideDateTime): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def getDaysInMonthLocalTime(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getInternalFormattedLocalTime(): java.lang.String = js.native
  /**
    * Gets the date stored by the GlideDateTime object, expressed in the standard format, yyyy-MM-dd,
  ...
  /**
    ...
    * @returns The object's time in the local time zone and in the user's format.
    */
  def getUserFormattedLocalTime(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def onOrAfter(gdt: GlideDateTime): scala.Boolean = js.native
  /**
    ...
    */
  def onOrBefore(gdt: GlideDateTime): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * gs.info(gdt.getValue());
    */
  def subtract(milliseconds: scala.Double): scala.Unit = js.native
  /**
...
object GlideDateTime extends js.Object {
  /**
    ...
    */
  def subtract(start: servicenowDashLondonLib.GlideDateTime): servicenowDashLondonLib.GlideDuration = js.native
  def subtract(start: servicenowDashLondonLib.GlideDateTime, end: servicenowDashLondonLib.GlideDateTime): servicenowDashLondonLib.GlideDuration = js.native
}
