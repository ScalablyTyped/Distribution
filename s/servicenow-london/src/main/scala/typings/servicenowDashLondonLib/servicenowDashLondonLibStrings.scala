...
object servicenowDashLondonLibStrings {
  @js.native
  ...
  sealed trait delete
    extends GlideRecordOperation
       with servicenowDashLondonLib.snUnderscoreWsNs.RestHTTPMethods
  ...
  @js.native
  sealed trait get
    extends servicenowDashLondonLib.snUnderscoreWsNs.RestHTTPMethods
