...
class GlideSchedule () extends js.Object {
  /**
    ...
    */
  def this(sysId: java.lang.String) = this()
  ...
  /**
    ...
    */
  def load(sysId: java.lang.String): scala.Unit = js.native
  def load(sysId: java.lang.String, timeZone: java.lang.String): scala.Unit = js.native
  ...
  /**
    ...
    */
  def whenNext(time: GlideDateTime): scala.Double = js.native
