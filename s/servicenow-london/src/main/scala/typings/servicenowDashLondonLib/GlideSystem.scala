...
trait GlideSystem extends js.Object {
  ...
  def executeNow(job: ScopedGlideRecord): java.lang.String = js.native
  ...
  def getEscapedMessage(id: java.lang.String): java.lang.String = js.native
  def getEscapedMessage(id: java.lang.String, `object`: js.Any): java.lang.String = js.native
  ...
  def hoursAgo(hours: scala.Double): java.lang.String = js.native
  def hoursAgoEnd(hours: scala.Double): java.lang.String = js.native
  def hoursAgoStart(hours: scala.Double): java.lang.String = js.native
  def include(include: java.lang.String): scala.Unit = js.native
  def info(message: js.Any): scala.Unit = js.native
  def info(message: js.Any, parm1: js.Any): scala.Unit = js.native
  def info(message: js.Any, parm1: js.Any, parm2: js.Any): scala.Unit = js.native
  def info(message: js.Any, parm1: js.Any, parm2: js.Any, parm3: js.Any): scala.Unit = js.native
  def info(message: js.Any, parm1: js.Any, parm2: js.Any, parm3: js.Any, parm4: js.Any): scala.Unit = js.native
  def info(message: js.Any, parm1: js.Any, parm2: js.Any, parm3: js.Any, parm4: js.Any, parm5: js.Any): scala.Unit = js.native
  ...
  def setProperty(key: java.lang.String, value: java.lang.String, description: java.lang.String): scala.Unit = js.native
