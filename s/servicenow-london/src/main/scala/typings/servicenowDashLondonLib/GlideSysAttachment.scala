...
class GlideSysAttachment () extends js.Object {
  ...
  def getContentBase64(record: ScopedGlideRecord): java.lang.String = js.native
  def getContentStream(sysId: java.lang.String): js.Object = js.native
  def write(record: ScopedGlideRecord, fileName: java.lang.String, contentType: java.lang.String, data: js.Any): java.lang.String = js.native
  def writeBase64(
