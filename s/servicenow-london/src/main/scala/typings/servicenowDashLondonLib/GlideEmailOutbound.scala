...
class GlideEmailOutbound () extends js.Object {
  /**
    ...
    */
  def addAddress(`type`: java.lang.String, address: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def addAddress(`type`: java.lang.String, address: java.lang.String, displayName: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def getWatermark(): java.lang.String = js.native
  /**
    ...
    */
  def setBody(bodyText: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setFrom(address: java.lang.String): scala.Unit = js.native
  /**
    ...
    */
  def setReplyTo(address: java.lang.String): scala.Unit = js.native
  /**
