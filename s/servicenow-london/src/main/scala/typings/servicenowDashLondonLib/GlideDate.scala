...
class GlideDate () extends js.Object {
  ...
  /**
    ...
    * // 13
    */
  def getDayOfMonthNoTZ(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * // 5
    */
  def getMonthNoTZ(): scala.Double = js.native
  /**
  ...
  /**
    ...
    * // 5
    */
  def getYearNoTZ(): scala.Double = js.native
  /**
...
object GlideDate extends js.Object {
  /**
    ...
    * // 1 Day
    */
  def subtract(start: servicenowDashLondonLib.GlideDate, end: servicenowDashLondonLib.GlideDate): servicenowDashLondonLib.GlideDuration = js.native
  def subtract(start: servicenowDashLondonLib.GlideDate, end: servicenowDashLondonLib.GlideTime): servicenowDashLondonLib.GlideDuration = js.native
  def subtract(start: servicenowDashLondonLib.GlideTime, end: servicenowDashLondonLib.GlideDate): servicenowDashLondonLib.GlideDuration = js.native
  def subtract(start: servicenowDashLondonLib.GlideTime, end: servicenowDashLondonLib.GlideTime): servicenowDashLondonLib.GlideDuration = js.native
}
