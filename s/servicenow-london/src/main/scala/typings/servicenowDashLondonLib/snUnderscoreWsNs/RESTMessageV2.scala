...
class RESTMessageV2 () extends js.Object {
  /**
    ...
    */
  def this(name: java.lang.String, methodName: RestHTTPMethods) = this()
  /**
  ...
  /**
    ...
    */
  def setHttpMethod(method: RestHTTPMethods): scala.Unit = js.native
  /**
  ...
  @JSName("setLogLevel")
  def setLogLevel_all(level: servicenowDashLondonLib.servicenowDashLondonLibStrings.all): scala.Unit = js.native
  /**
    ...
    */
  @JSName("setLogLevel")
  def setLogLevel_basic(level: servicenowDashLondonLib.servicenowDashLondonLibStrings.basic): scala.Unit = js.native
  @JSName("setLogLevel")
  def setLogLevel_elevated(level: servicenowDashLondonLib.servicenowDashLondonLibStrings.elevated): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * })();
    */
  def setRequestBodyFromAttachment(attachmentSysId: java.lang.String): scala.Unit = js.native
  /**
