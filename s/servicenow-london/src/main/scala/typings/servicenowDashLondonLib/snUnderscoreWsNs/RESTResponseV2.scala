...
class RESTResponseV2 () extends js.Object {
  /**
    ...
    * }
    */
  def getAllHeaders(): js.Array[servicenowDashLondonLib.Anon_Name] = js.native
  /**
  ...
  /**
    ...
    * }
    */
  def getCookies(): servicenowDashLondonLib.Anon_Get = js.native
  /**
    ...
    */
  def getErrorCode(): scala.Double = js.native
  /**
    ...
    */
  def getErrorMessage(): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def getResponseAttachmentSysid(): java.lang.String = js.native
  /**
    ...
    */
  def getStatusCode(): scala.Double = js.native
  /**
    ...
    */
  def haveError(): scala.Boolean = js.native
  /**
    ...
    */
  def waitForResponse(timeoutSecs: scala.Double): scala.Unit = js.native
}
