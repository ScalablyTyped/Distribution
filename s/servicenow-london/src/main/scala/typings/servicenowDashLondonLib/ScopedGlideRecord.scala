...
trait ScopedGlideRecord
  ...
  */
org.scalablytyped.runtime.Instantiable1[/* tableName */ java.lang.String, ScopedGlideRecord] {
  val sys_created_by: java.lang.String with ScopedGlideElement = js.native
  val sys_created_on: GlideDateTime with ScopedGlideElement = js.native
  val sys_id: java.lang.String with ScopedGlideElement = js.native
  ...
  def _query(name: java.lang.String): scala.Unit = js.native
  def _query(name: java.lang.String, value: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def addFunction(fun: java.lang.String): scala.Unit = js.native
  /**
    ...
    * gr.query();
    */
  def addJoinQuery(joinTable: java.lang.String): ScopedQueryCondition = js.native
  def addJoinQuery(joinTable: java.lang.String, primaryField: java.lang.String): ScopedQueryCondition = js.native
  def addJoinQuery(joinTable: java.lang.String, primaryField: java.lang.String, joinTableField: java.lang.String): ScopedQueryCondition = js.native
  /**
    ...
    * }
    */
  def addNotNullQuery(fieldName: java.lang.String): ScopedQueryCondition = js.native
  /**
    ...
    * }
    */
  def addNullQuery(fieldName: java.lang.String): ScopedQueryCondition = js.native
  /**
    ...
    * }
    */
  def addQuery(name: java.lang.String, operator: QueryOperator, value: js.Any): ScopedQueryCondition = js.native
  /**
    * Provides the ability to build a request, which when executed, returns the rows from the
    * specified table, that match the request.
    *
    ...
    * }
    */
  def addQuery(name: java.lang.String, value: js.Any): ScopedQueryCondition = js.native
  /**
    ...
    * }
    */
  def addQuery(query: java.lang.String): ScopedQueryCondition = js.native
  /**
  ...
  /**
    ...
    */
  def dateNumericValue(): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def getElement(columnName: java.lang.String): ScopedGlideElement = js.native
  /**
  ...
  def query(field: java.lang.String, value: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def setLimit(maxNumRecords: scala.Double): scala.Unit = js.native
  /**
