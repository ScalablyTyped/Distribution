...
trait InitOptions[Rendered] extends js.Object {
  ...
  var renderer: js.UndefOr[js.Function1[/* node */ reactLib.reactMod.ReactElement[_], Rendered]] = js.undefined
...
object InitOptions {
  ...
  def apply[Rendered](
    ...
    renderer: /* node */ reactLib.reactMod.ReactElement[_] => Rendered = null,
