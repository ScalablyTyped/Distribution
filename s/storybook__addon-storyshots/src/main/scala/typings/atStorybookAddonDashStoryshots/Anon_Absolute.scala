...
import typings.atStorybookAddonDashStoryshots.atStorybookAddonDashStoryshotsStrings.DIR
import typings.atStorybookAddonDashStoryshots.atStorybookAddonDashStoryshotsStrings.FILE
...
trait Anon_Absolute extends js.Object {
  ...
  var statCache: js.UndefOr[StringDictionary[`false` | Anon_IsDirectory]] = js.undefined
...
object Anon_Absolute {
  ...
  def apply(
    ...
    statCache: StringDictionary[`false` | Anon_IsDirectory] = null,
