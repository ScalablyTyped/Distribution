...
import typings.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.Data
import typings.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.Item
import typings.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.OddsSums
import typings.simpleDashStatistics.srcChiUnderscoreSquaredUnderscoreDistributionUnderscoreTableMod.DistributionTable
import typings.simpleDashStatistics.srcKernelUnderscoreDensityUnderscoreEstimationMod.BandwidthMethods
import typings.simpleDashStatistics.srcKernelUnderscoreDensityUnderscoreEstimationMod.Kernels
...
object simpleDashStatisticsMod extends js.Object {
  ...
  class BayesianClassifier ()
    extends typings.simpleDashStatistics.srcBayesianUnderscoreClassifierMod.BayesianClassifier {
    /* CompleteClass */
  ...
  class PerceptronModel ()
    extends typings.simpleDashStatistics.srcPerceptronMod.PerceptronModel {
    /* CompleteClass */
    ...
    /* CompleteClass */
    override def train(features: js.Array[Double], label: Double): typings.simpleDashStatistics.srcPerceptronMod.PerceptronModel = js.native
  }
