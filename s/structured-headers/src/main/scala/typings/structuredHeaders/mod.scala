...
import typings.structuredHeaders.typesMod.BareItem
...
object mod {
  ...
  open class ByteSequence protected ()
    extends typings.structuredHeaders.typesMod.ByteSequence {
  ...
  open class ParseError protected ()
    extends typings.structuredHeaders.parserMod.ParseError {
  ...
  open class SerializeError ()
    extends typings.structuredHeaders.serializerMod.SerializeError
  
  @JSImport("structured-headers/dist", "Token")
  @js.native
  open class Token protected ()
    extends typings.structuredHeaders.tokenMod.Token {
  ...
  inline def serializeByteSequence(input: typings.structuredHeaders.typesMod.ByteSequence): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeByteSequence")(input.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def serializeToken(input: typings.structuredHeaders.tokenMod.Token): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeToken")(input.asInstanceOf[js.Any]).asInstanceOf[String]
}
