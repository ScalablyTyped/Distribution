...
trait IssuesRequestDetails extends StObject {
...
object IssuesRequestDetails {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[IssuesRequestDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: IssuesRequestDetails] (val x: Self) extends AnyVal {
