...
/* Inlined std.Partial<snyk.snyk/dist/lib/types.Options & snyk.snyk/dist/lib/types.TestOptions & snyk.snyk/dist/lib/types.MonitorOptions & snyk.snyk/dist/lib/types.PolicyOptions> */
trait PartialOptionsTestOptionsAdvertiseSubprojectsCount extends StObject {
...
object PartialOptionsTestOptionsAdvertiseSubprojectsCount {
  
  inline def apply(): PartialOptionsTestOptionsAdvertiseSubprojectsCount = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOptionsTestOptionsAdvertiseSubprojectsCount]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialOptionsTestOptionsAdvertiseSubprojectsCount] (val x: Self) extends AnyVal {
