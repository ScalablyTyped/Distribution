...
class QuestionPanelDynamicImplementor protected () extends QuestionImplementor {
  ...
  /* protected */ def addPanel(): scala.Unit = js.native
  /* protected */ def onCurrentIndexChanged(): scala.Unit = js.native
  /* protected */ def onPanelCountChanged(): scala.Unit = js.native
  /* protected */ def onRenderModeChanged(): scala.Unit = js.native
  /* protected */ def removePanel(`val`: js.Any): scala.Unit = js.native
}
