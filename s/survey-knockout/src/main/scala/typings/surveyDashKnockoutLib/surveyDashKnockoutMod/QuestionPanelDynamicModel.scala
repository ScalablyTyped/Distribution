...
class QuestionPanelDynamicModel protected ()
  ...
  /**
    ...
    */
  var allowAddPanel: scala.Boolean = js.native
  /**
    * Set this property to false to hide the 'Remove' button
    * @see allowAddPanel
    */
  var allowRemovePanel: scala.Boolean = js.native
  /**
    ...
    * @see maxPanelCount
    */
  val canAddPanel: scala.Boolean = js.native
  /**
    ...
    * @see minPanelCount
    */
  val canRemovePanel: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  var defaultValueFromLastPanel: scala.Boolean = js.native
  /**
    ...
    * @see panelCount
    */
  val isNextButtonShowing: scala.Boolean = js.native
  /**
    * Returns true when currentIndex is more than 0.
    * @see currenIndex
    * @see currenPanel
    */
  val isPrevButtonShowing: scala.Boolean = js.native
  /**
    * Returns true when the renderMode equals to "progressBottom" or "progressTopBottom"
    */
  val isProgressBottomShowing: scala.Boolean = js.native
  /**
    * Returns true when the renderMode equals to "progressTop" or "progressTopBottom"
    */
  val isProgressTopShowing: scala.Boolean = js.native
  /**
    * Returns true when showRangeInProgress equals to true, renderMode doesn't equal to "list" and panelCount is >= 2.
    */
  val isRangeShowing: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @see removePanelUI
    */
  var panelCount: scala.Double = js.native
  /**
    ...
    * @see renderMode
    */
  var panelNextText: java.lang.String = js.native
  /**
    ...
    * @see renderMode
    */
  var panelPrevText: java.lang.String = js.native
  /**
    * Use this property to change the default value of remove panel button text.
    */
  var panelRemoveText: java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @see templateTitle
    */
  var panelsState: java.lang.String = js.native
  /**
    * By default the property equals to "list" and all dynamic panels are rendered one by one on the page. You may change it to: "progressTop", "progressBottom" or "progressTopBottom" to render only one dynamic panel at once. The progress and navigation elements can be rendred on top, bottom or both.
    */
  var renderMode: java.lang.String = js.native
  /**
  ...
  /**
    ...
    * @see renderMode
    */
  var showRangeInProgress: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @see templateTitle
    */
  var templateDescription: java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  var templateTitleLocation: java.lang.String = js.native
  /**
  ...
  /* protected */ def rebuildPanels(): scala.Unit = js.native
  /**
    ...
    * @see template
    */
  def removePanel(value: js.Any): scala.Unit = js.native
  /**
    ...
    *
    */
  def removePanelUI(value: js.Any): scala.Unit = js.native
...
@JSImport("survey-knockout", "QuestionPanelDynamicModel")
@js.native
object QuestionPanelDynamicModel extends js.Object {
  var MaxPanelCount: scala.Double = js.native
}
