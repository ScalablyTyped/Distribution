...
trait AnonClearButtonImageItemItemChecked extends js.Object {
...
object AnonClearButtonImageItemItemChecked {
  @scala.inline
  def apply(
    clearButton: String,
    image: String,
    ...
    other: String,
    root: String
  ): AnonClearButtonImageItemItemChecked = {
    ...
    __obj.asInstanceOf[AnonClearButtonImageItemItemChecked]
  }
}
