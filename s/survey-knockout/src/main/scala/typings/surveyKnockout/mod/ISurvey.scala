...
trait ISurvey
  ...
  def dynamicPanelRemoved(question: IQuestion, panelIndex: Double): js.Any
  def getCss(): js.Any
...
object ISurvey {
  ...
  def apply(
    ...
    dynamicPanelRemoved: (IQuestion, Double) => js.Any,
    getCss: () => js.Any,
