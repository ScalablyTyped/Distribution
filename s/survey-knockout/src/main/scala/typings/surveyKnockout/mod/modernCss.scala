...
object modernCss {
  ...
  inline def comment_=(x: Small): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("comment")(x.asInstanceOf[js.Any])
  ...
  inline def file_=(x: FileInput): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("file")(x.asInstanceOf[js.Any])
  ...
  inline def matrix_=(x: CellTextDisabled): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("matrix")(x.asInstanceOf[js.Any])
  ...
  inline def panel_=(x: Footer): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("panel")(x.asInstanceOf[js.Any])
  ...
  inline def question_=(x: ContentLeft): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("question")(x.asInstanceOf[js.Any])
