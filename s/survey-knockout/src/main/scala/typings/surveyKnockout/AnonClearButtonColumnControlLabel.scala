...
trait AnonClearButtonColumnControlLabel extends js.Object {
...
object AnonClearButtonColumnControlLabel {
  @scala.inline
  def apply(
    clearButton: String,
    column: String,
    ...
    other: String,
    root: String
  ): AnonClearButtonColumnControlLabel = {
    ...
    __obj.asInstanceOf[AnonClearButtonColumnControlLabel]
  }
}
