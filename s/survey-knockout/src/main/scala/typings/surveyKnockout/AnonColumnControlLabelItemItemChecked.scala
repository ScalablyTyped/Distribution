...
trait AnonColumnControlLabelItemItemChecked extends js.Object {
  var column: String
...
object AnonColumnControlLabelItemItemChecked {
  @scala.inline
  def apply(
    column: String,
    controlLabel: String,
    ...
    other: String,
    root: String
  ): AnonColumnControlLabelItemItemChecked = {
    ...
    __obj.asInstanceOf[AnonColumnControlLabelItemItemChecked]
  }
}
