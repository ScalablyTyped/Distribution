...
trait AnonButtonButtonCollapsed extends js.Object {
  var button: String
...
object AnonButtonButtonCollapsed {
  @scala.inline
  def apply(button: String, buttonCollapsed: String, buttonExpanded: String, root: String, title: String): AnonButtonButtonCollapsed = {
    ...
    __obj.asInstanceOf[AnonButtonButtonCollapsed]
  }
}
