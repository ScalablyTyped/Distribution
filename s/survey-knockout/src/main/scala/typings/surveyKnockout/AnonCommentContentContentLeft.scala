...
trait AnonCommentContentContentLeft extends js.Object {
  var comment: String
  var content: String
...
object AnonCommentContentContentLeft {
  @scala.inline
  def apply(
    comment: String,
    content: String,
    ...
    __obj.asInstanceOf[AnonCommentContentContentLeft]
  }
}
