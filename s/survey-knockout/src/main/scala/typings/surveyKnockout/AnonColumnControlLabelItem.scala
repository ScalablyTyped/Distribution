...
trait AnonColumnControlLabelItem extends js.Object {
  var column: String
...
object AnonColumnControlLabelItem {
  @scala.inline
  def apply(
    column: String,
    controlLabel: String,
    ...
    __obj.asInstanceOf[AnonColumnControlLabelItem]
  }
}
