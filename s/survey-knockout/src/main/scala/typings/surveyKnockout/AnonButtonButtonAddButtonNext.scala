...
trait AnonButtonButtonAddButtonNext extends js.Object {
  var button: String
...
object AnonButtonButtonAddButtonNext {
  @scala.inline
  def apply(
    button: String,
    buttonAdd: String,
    ...
    __obj.asInstanceOf[AnonButtonButtonAddButtonNext]
  }
}
