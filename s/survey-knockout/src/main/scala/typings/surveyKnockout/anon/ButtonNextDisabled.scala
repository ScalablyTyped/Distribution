...
trait ButtonNextDisabled extends StObject {
...
object ButtonNextDisabled {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ButtonNextDisabled]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ButtonNextDisabled] (val x: Self) extends AnyVal {
