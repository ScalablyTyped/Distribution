...
object AsCell {
  ...
  @scala.inline
  implicit class AsCellMutableBuilder[Self <: AsCell] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAsCell(value: String): Self = StObject.set(x, "asCell", value.asInstanceOf[js.Any])
