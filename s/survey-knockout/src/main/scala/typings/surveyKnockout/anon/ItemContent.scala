...
object ItemContent {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(controlLabel = controlLabel.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], itemContent = itemContent.asInstanceOf[js.Any], itemDragMod = itemDragMod.asInstanceOf[js.Any], itemGhostMod = itemGhostMod.asInstanceOf[js.Any], itemGhostNode = itemGhostNode.asInstanceOf[js.Any], itemIcon = itemIcon.asInstanceOf[js.Any], itemIconContainer = itemIconContainer.asInstanceOf[js.Any], itemIconFocusMod = itemIconFocusMod.asInstanceOf[js.Any], itemIconHoverMod = itemIconHoverMod.asInstanceOf[js.Any], itemIndex = itemIndex.asInstanceOf[js.Any], itemOnError = itemOnError.asInstanceOf[js.Any], root = root.asInstanceOf[js.Any], rootDesignMode = rootDesignMode.asInstanceOf[js.Any], rootDisabled = rootDisabled.asInstanceOf[js.Any], rootDragMod = rootDragMod.asInstanceOf[js.Any], rootMobileMod = rootMobileMod.asInstanceOf[js.Any])
  ...
  extension [Self <: ItemContent](x: Self) {
    ...
    inline def setRootDesignMode(value: String): Self = StObject.set(x, "rootDesignMode", value.asInstanceOf[js.Any])
