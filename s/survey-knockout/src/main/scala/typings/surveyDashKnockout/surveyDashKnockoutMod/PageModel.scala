...
- typings.surveyDashKnockout.surveyDashKnockoutMod.IPage because var conflicts: isPage, isReadOnly, isVisible, name, parent. Inlined isStarted */ @JSImport("survey-knockout", "PageModel")
@js.native
