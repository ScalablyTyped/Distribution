...
object SignOptions {
  ...
  def apply(
    ...
    noncefn: (/* message */ nodeLib.Buffer, /* privateKey */ nodeLib.Buffer, /* algo */ nodeLib.Buffer | scala.Null, /* data */ nodeLib.Buffer | scala.Null, /* attempt */ scala.Double) => nodeLib.Buffer = null
  ): SignOptions = {
