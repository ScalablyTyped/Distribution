...
object OnSelectedRowsChangedEventArgs {
  ...
  @scala.inline
  implicit class OnSelectedRowsChangedEventArgsOps[Self <: OnSelectedRowsChangedEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnSelectedRowsChangedEventArgs[T]) extends AnyVal {
    @scala.inline
