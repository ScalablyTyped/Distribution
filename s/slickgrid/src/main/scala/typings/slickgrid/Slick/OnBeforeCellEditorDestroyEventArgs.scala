...
object OnBeforeCellEditorDestroyEventArgs {
  ...
  @scala.inline
  implicit class OnBeforeCellEditorDestroyEventArgsOps[Self <: OnBeforeCellEditorDestroyEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnBeforeCellEditorDestroyEventArgs[T]) extends AnyVal {
    @scala.inline
