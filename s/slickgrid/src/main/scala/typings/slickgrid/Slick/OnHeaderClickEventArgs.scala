...
object OnHeaderClickEventArgs {
  @scala.inline
  def apply[/* <: typings.slickgrid.Slick.SlickData */ T](column: Column[T], grid: Grid[T]): OnHeaderClickEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnHeaderClickEventArgsOps[Self <: OnHeaderClickEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderClickEventArgs[T]) extends AnyVal {
    @scala.inline
