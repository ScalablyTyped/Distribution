...
object ColumnMetadata {
  @scala.inline
  def apply[/* <: typings.slickgrid.Slick.SlickData */ T](): ColumnMetadata[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnMetadata[T]]
  }
  @scala.inline
  implicit class ColumnMetadataOps[Self <: ColumnMetadata[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with ColumnMetadata[T]) extends AnyVal {
    @scala.inline
