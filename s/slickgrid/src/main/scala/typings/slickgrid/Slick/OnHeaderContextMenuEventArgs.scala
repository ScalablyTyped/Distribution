...
object OnHeaderContextMenuEventArgs {
  ...
  @scala.inline
  implicit class OnHeaderContextMenuEventArgsOps[Self <: OnHeaderContextMenuEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderContextMenuEventArgs[T]) extends AnyVal {
    @scala.inline
