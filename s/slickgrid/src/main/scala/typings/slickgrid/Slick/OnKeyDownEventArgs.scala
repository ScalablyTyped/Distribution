...
object OnKeyDownEventArgs {
  @scala.inline
  def apply[/* <: typings.slickgrid.Slick.SlickData */ T](cell: Double, grid: Grid[T], row: Double): OnKeyDownEventArgs[T] = {
  ...
  @scala.inline
  implicit class OnKeyDownEventArgsOps[Self <: OnKeyDownEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnKeyDownEventArgs[T]) extends AnyVal {
    @scala.inline
