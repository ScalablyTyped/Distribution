...
object OnHeaderCellRenderedEventArgs {
  ...
  @scala.inline
  implicit class OnHeaderCellRenderedEventArgsMutableBuilder[Self <: OnHeaderCellRenderedEventArgs[?], T /* <: SlickData */] (val x: Self & OnHeaderCellRenderedEventArgs[T]) extends AnyVal {
