...
object OnActiveCellChangedEventArgs {
  ...
  @scala.inline
  implicit class OnActiveCellChangedEventArgsOps[Self <: OnActiveCellChangedEventArgs[_], T /* <: SlickData */] (val x: Self with OnActiveCellChangedEventArgs[T]) extends AnyVal {
