...
object OnDblClickEventArgs {
  ...
  @scala.inline
  implicit class OnDblClickEventArgsOps[Self <: OnDblClickEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnDblClickEventArgs[T]) extends AnyVal {
    @scala.inline
