...
object OnValidationErrorEventArgs {
  ...
  @scala.inline
  implicit class OnValidationErrorEventArgsOps[Self <: OnValidationErrorEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnValidationErrorEventArgs[T]) extends AnyVal {
    @scala.inline
