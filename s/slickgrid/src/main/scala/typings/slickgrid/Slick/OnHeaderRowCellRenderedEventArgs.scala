...
object OnHeaderRowCellRenderedEventArgs {
  ...
  @scala.inline
  implicit class OnHeaderRowCellRenderedEventArgsOps[Self <: OnHeaderRowCellRenderedEventArgs[_], /* <: typings.slickgrid.Slick.SlickData */ T] (val x: Self with OnHeaderRowCellRenderedEventArgs[T]) extends AnyVal {
    @scala.inline
