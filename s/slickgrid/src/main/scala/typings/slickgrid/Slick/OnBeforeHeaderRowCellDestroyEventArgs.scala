...
object OnBeforeHeaderRowCellDestroyEventArgs {
  ...
  @scala.inline
  implicit class OnBeforeHeaderRowCellDestroyEventArgsOps[Self <: OnBeforeHeaderRowCellDestroyEventArgs[_], T /* <: SlickData */] (val x: Self with OnBeforeHeaderRowCellDestroyEventArgs[T]) extends AnyVal {
