...
object OnBeforeHeaderRowCellDestroyEventArgs {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OnBeforeHeaderRowCellDestroyEventArgs[?], T /* <: SlickData */] (val x: Self & OnBeforeHeaderRowCellDestroyEventArgs[T]) extends AnyVal {
