...
object libTransformableSVGMod {
  
  /* note: abstract class */ @JSImport("svg-pathdata/lib/TransformableSVG", "TransformableSVG")
  @js.native
  open class TransformableSVG () extends StObject {
