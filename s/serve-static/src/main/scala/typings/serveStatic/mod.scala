...
object mod {
  ...
  object ServeStaticOptions {
    ...
    @scala.inline
    implicit class ServeStaticOptionsMutableBuilder[Self <: ServeStaticOptions[_], R /* <: ServerResponse */] (val x: Self with ServeStaticOptions[R]) extends AnyVal {
      ...
      @scala.inline
      def setSetHeaders(value: (/* res */ R, /* path */ String, /* stat */ js.Any) => _): Self = StObject.set(x, "setHeaders", js.Any.fromFunction3(value))
