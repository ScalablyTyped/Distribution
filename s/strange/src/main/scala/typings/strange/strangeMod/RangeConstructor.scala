...
trait RangeConstructor
  ...
  */
Instantiable0[Range[Endpoint]]
     with Instantiable2[(/* begin */ Endpoint) | (/* begin */ Null), /* end */ Endpoint, Range[Endpoint]]
     with Instantiable1[/* begin */ Endpoint, Range[Endpoint]]
     with Instantiable3[
  ...
  def apply[T /* <: Endpoint */](begin: T, end: Null, bounds: Bounds): Range[T] = js.native
  def apply[T /* <: Endpoint */](begin: Null, end: T): Range[T] = js.native
  def apply[T /* <: Endpoint */](begin: Null, end: T, bounds: Bounds): Range[T] = js.native
  def apply[T /* <: Endpoint */](begin: Null, end: Null, bounds: Bounds): Range[T] = js.native
  /**
    ...
    */
  def compareBeginToBegin[U /* <: Endpoint */](a: Range[U], b: Range[U]): `-1` | `0` | `1` = js.native
  /**
    ...
    */
  def compareBeginToEnd[U /* <: Endpoint */](a: Range[U], b: Range[U]): `-1` | `0` | `1` = js.native
  /**
    ...
    */
  def compareEndToEnd[U /* <: Endpoint */](a: Range[U], b: Range[U]): `-1` | `0` | `1` = js.native
  /**
    ...
    */
  def parse(range: String): Range[String] = js.native
  /**
    * Parses a string stringified by
    * [`Range.prototype.toString`](#Range.prototype.toString).
    *
    ...
    */
  def parse[U /* <: Endpoint */](range: String, parse: js.Function1[/* endpoint */ String, U]): Range[U] = js.native
  /**
