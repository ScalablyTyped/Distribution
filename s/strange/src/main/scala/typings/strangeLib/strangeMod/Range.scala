...
trait Range[T /* <: strangeLib.strangeMod.RangeNs.Endpoint */] extends js.Object {
  /**
    ...
    */
  var begin: js.UndefOr[T | scala.Null] = js.native
  /**
    * Range's bounds.
    *
  ...
  /**
    ...
    */
  var end: js.UndefOr[T | scala.Null] = js.native
  def compareBegin(): strangeLib.strangeLibNumbers.`-1` | strangeLib.strangeLibNumbers.`0` = js.native
  /**
    ...
    */
  def compareBegin(begin: T): strangeLib.strangeLibNumbers.`-1` | strangeLib.strangeLibNumbers.`0` = js.native
  def compareEnd(): strangeLib.strangeLibNumbers.`-1` | strangeLib.strangeLibNumbers.`0` = js.native
  /**
    ...
    */
  def compareEnd(end: T): strangeLib.strangeLibNumbers.`-1` | strangeLib.strangeLibNumbers.`0` = js.native
  ...
  /**
    ...
    */
  def intersects(value: Range[T]): scala.Boolean = js.native
  /**
    ...
    */
  def isBounded(): scala.Boolean = js.native
  /**
