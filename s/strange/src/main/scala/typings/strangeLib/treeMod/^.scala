...
@js.native
class ^[T /* <: stdLib.Date | scala.Double | java.lang.String */] protected () extends RangeTree[T] {
...
object ^ extends js.Object {
  /**
    ...
    */
  def from[U /* <: stdLib.Date | scala.Double | java.lang.String */](ranges: js.Array[strangeLib.strangeMod.Range[U]]): RangeTree[U] = js.native
}
