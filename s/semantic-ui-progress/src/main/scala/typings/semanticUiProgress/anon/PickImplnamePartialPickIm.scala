...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'name'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
...
object PickImplnamePartialPickIm {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplnamePartialPickIm] (val x: Self) extends AnyVal {
