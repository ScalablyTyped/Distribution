...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'namespace'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
