...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'onActive'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImplonActivePartialPi
  extends StObject
     with Param {
...
object PickImplonActivePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonActivePartialPi] (val x: Self) extends AnyVal {
