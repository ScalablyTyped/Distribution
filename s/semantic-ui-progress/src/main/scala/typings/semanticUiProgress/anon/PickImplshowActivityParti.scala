...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'showActivity'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImplshowActivityParti
  extends StObject
     with Param {
...
object PickImplshowActivityParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplshowActivityParti] (val x: Self) extends AnyVal {
