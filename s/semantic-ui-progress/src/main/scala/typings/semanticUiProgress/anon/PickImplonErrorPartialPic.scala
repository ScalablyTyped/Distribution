...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'onError'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
...
object PickImplonErrorPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonErrorPartialPic] (val x: Self) extends AnyVal {
