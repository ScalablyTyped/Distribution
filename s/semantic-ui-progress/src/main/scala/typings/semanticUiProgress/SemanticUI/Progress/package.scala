...
package object Progress {
  type ClassNameSettings = typings.semanticUiProgress.SemanticUI.Progress.ClassNameSettings.Param
  ...
  type RegExpSettings = typings.semanticUiProgress.SemanticUI.Progress.RegExpSettings.Param
