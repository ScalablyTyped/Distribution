...
object PartialPickImplkeyofImpl {
  ...
  def apply(
    ...
    if (!js.isUndefined(limitValues)) __obj.updateDynamic("limitValues")(limitValues.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(showActivity)) __obj.updateDynamic("showActivity")(showActivity.asInstanceOf[js.Any])
