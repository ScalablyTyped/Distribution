...
object skiaCanvasStrings {
  ...
  @js.native
  sealed trait `contain-x`
    extends StObject
       with FitStyle
  inline def `contain-x`: `contain-x` = "contain-x".asInstanceOf[`contain-x`]
  
  @js.native
  sealed trait `contain-y`
    extends StObject
       with FitStyle
  inline def `contain-y`: `contain-y` = "contain-y".asInstanceOf[`contain-y`]
