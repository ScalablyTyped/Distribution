...
trait AnonAllowEmptyValueCollectionFormat extends js.Object {
...
object AnonAllowEmptyValueCollectionFormat {
  @scala.inline
  def apply(
    in: formData,
  ...
  ): AnonAllowEmptyValueCollectionFormat = {
    ...
    __obj.asInstanceOf[AnonAllowEmptyValueCollectionFormat]
  }
}
