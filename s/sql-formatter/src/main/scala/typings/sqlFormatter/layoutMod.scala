...
object layoutMod {
  ...
  open class default protected ()
    extends StObject
       with Layout {
    def this(indentation: typings.sqlFormatter.indentationMod.default) = this()
    ...
    /* CompleteClass */
    var indentation: typings.sqlFormatter.indentationMod.default = js.native
  ...
  object WS extends StObject {
    ...
    sealed trait INDENT
      extends StObject
         with WS
    /* 5 */ val INDENT: typings.sqlFormatter.layoutMod.WS.INDENT & Double = js.native
    ...
    sealed trait MANDATORY_NEWLINE
      extends StObject
         with WS
         with _LayoutItem
    /* 4 */ val MANDATORY_NEWLINE: typings.sqlFormatter.layoutMod.WS.MANDATORY_NEWLINE & Double = js.native
    ...
    sealed trait NEWLINE
      extends StObject
         with WS
         with _LayoutItem
    /* 3 */ val NEWLINE: typings.sqlFormatter.layoutMod.WS.NEWLINE & Double = js.native
    
    @js.native
    sealed trait NO_NEWLINE
      extends StObject
         with WS
    /* 2 */ val NO_NEWLINE: typings.sqlFormatter.layoutMod.WS.NO_NEWLINE & Double = js.native
    
    @js.native
    sealed trait NO_SPACE
      extends StObject
         with WS
    /* 1 */ val NO_SPACE: typings.sqlFormatter.layoutMod.WS.NO_SPACE & Double = js.native
    ...
    sealed trait SINGLE_INDENT
      extends StObject
         with WS
         with _LayoutItem
    /* 6 */ val SINGLE_INDENT: typings.sqlFormatter.layoutMod.WS.SINGLE_INDENT & Double = js.native
    ...
    sealed trait SPACE
      extends StObject
         with WS
         with _LayoutItem
    /* 0 */ val SPACE: typings.sqlFormatter.layoutMod.WS.SPACE & Double = js.native
  }
  ...
  trait Layout extends StObject {
    ...
    var indentation: typings.sqlFormatter.indentationMod.default
  ...
  object Layout {
    ...
    inline def apply(
      ...
      indentation: typings.sqlFormatter.indentationMod.default,
      itemToString: Any,
      items: Any,
    ...
    extension [Self <: Layout](x: Self) {
      ...
      inline def setIndentation(value: typings.sqlFormatter.indentationMod.default): Self = StObject.set(x, "indentation", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sqlFormatter.layoutMod.WS.SPACE
    - typings.sqlFormatter.layoutMod.WS.SINGLE_INDENT
    - typings.sqlFormatter.layoutMod.WS.NEWLINE
    - typings.sqlFormatter.layoutMod.WS.MANDATORY_NEWLINE
    - java.lang.String
  */
