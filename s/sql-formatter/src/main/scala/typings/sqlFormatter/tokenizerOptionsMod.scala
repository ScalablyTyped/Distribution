...
object tokenizerOptionsMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sqlFormatter.tokenizerOptionsMod.PlainQuoteType
    - typings.sqlFormatter.tokenizerOptionsMod.PrefixedQuoteType
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sqlFormatter.tokenizerOptionsMod.VariableRegex
    - typings.sqlFormatter.tokenizerOptionsMod.PrefixedQuoteType
  */
  trait VariableType extends StObject
  object VariableType {
    
    inline def PrefixedQuoteType(prefixes: js.Array[String], quote: PlainQuoteType): typings.sqlFormatter.tokenizerOptionsMod.PrefixedQuoteType = {
      val __obj = js.Dynamic.literal(prefixes = prefixes.asInstanceOf[js.Any], quote = quote.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sqlFormatter.tokenizerOptionsMod.PrefixedQuoteType]
    }
    
    inline def VariableRegex(regex: String): typings.sqlFormatter.tokenizerOptionsMod.VariableRegex = {
      val __obj = js.Dynamic.literal(regex = regex.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sqlFormatter.tokenizerOptionsMod.VariableRegex]
    }
  }
}
