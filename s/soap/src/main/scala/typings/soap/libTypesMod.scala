...
object libTypesMod {
  ...
  */
  ...
  object ISoapFault {
    ...
    inline def ISoapFault11(faultcode: Double | String, faultstring: String): typings.soap.libTypesMod.ISoapFault11 = {
      val __obj = js.Dynamic.literal(faultcode = faultcode.asInstanceOf[js.Any], faultstring = faultstring.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.soap.libTypesMod.ISoapFault11]
    }
    
    inline def ISoapFault12(Code: Subcode, Reason: Text): typings.soap.libTypesMod.ISoapFault12 = {
      val __obj = js.Dynamic.literal(Code = Code.asInstanceOf[js.Any], Reason = Reason.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.soap.libTypesMod.ISoapFault12]
    }
  }
