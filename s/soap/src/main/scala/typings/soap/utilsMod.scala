...
object utilsMod {
  ...
  inline def findPrefix(xmlnsMapping: js.Any, nsURI: js.Any): String = (^.asInstanceOf[js.Dynamic].applyDynamic("findPrefix")(xmlnsMapping.asInstanceOf[js.Any], nsURI.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def xmlEscape(obj: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("xmlEscape")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Any]
}
