...
object ^ extends js.Object {
  ...
  def createClientAsync(url: java.lang.String): bluebirdLib.bluebirdMod.^[Client] = js.native
  def createClientAsync(url: java.lang.String, options: IOptions): bluebirdLib.bluebirdMod.^[Client] = js.native
  def createClientAsync(url: java.lang.String, options: IOptions, endpoint: java.lang.String): bluebirdLib.bluebirdMod.^[Client] = js.native
