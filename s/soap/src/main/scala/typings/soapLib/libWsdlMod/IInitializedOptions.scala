...
trait IInitializedOptions
  extends soapLib.libTypesMod.IOptions {
  @JSName("ignoredNamespaces")
  var ignoredNamespaces_IInitializedOptions: js.UndefOr[js.Array[java.lang.String]] = js.undefined
}
...
object IInitializedOptions {
  ...
  def apply(
    ...
    ignoredNamespaces: js.Array[java.lang.String] = null,
