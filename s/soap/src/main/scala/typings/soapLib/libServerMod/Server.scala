...
class Server protected ()
  ...
  def authenticate(security: soapLib.libTypesMod.ISecurity): scala.Boolean = js.native
  def authenticate(security: soapLib.libTypesMod.ISecurity, processAuthResult: js.Any): scala.Boolean = js.native
