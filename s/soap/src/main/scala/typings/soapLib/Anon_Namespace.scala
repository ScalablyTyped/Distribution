...
trait Anon_Namespace extends js.Object {
  ...
  var xmlnsAttributes: js.UndefOr[js.Array[soapLib.libTypesMod.IXmlAttribute]] = js.undefined
}

object Anon_Namespace {
  @scala.inline
  def apply(namespace: java.lang.String, xmlnsAttributes: js.Array[soapLib.libTypesMod.IXmlAttribute] = null): Anon_Namespace = {
