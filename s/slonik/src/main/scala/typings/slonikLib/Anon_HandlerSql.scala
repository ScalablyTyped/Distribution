...
trait Anon_HandlerSql extends js.Object {
  def stream(
    sql: slonikLib.slonikMod.TaggedTemplateLiteralInvocationType[slonikLib.slonikMod.QueryResultRowType[java.lang.String]],
...
object Anon_HandlerSql {
  @scala.inline
  def apply(
    stream: (slonikLib.slonikMod.TaggedTemplateLiteralInvocationType[slonikLib.slonikMod.QueryResultRowType[java.lang.String]], slonikLib.slonikMod.StreamHandlerType) => js.Promise[scala.Null],
