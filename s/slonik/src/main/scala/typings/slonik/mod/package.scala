...
@scala.inline
def createTypeParserPreset(): js.Array[typings.slonik.mod.TypeParserType[js.Any]] = typings.slonik.mod.^.asInstanceOf[js.Dynamic].applyDynamic("createTypeParserPreset")().asInstanceOf[js.Array[typings.slonik.mod.TypeParserType[js.Any]]]
