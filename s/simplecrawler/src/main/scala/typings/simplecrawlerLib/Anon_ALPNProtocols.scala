...
trait Anon_ALPNProtocols extends js.Object {
  /**
    ...
    * to the client.
    */
  var ALPNProtocols: js.UndefOr[js.Array[java.lang.String] | Buffer] = js.undefined
  /**
    * An array of strings or a Buffer naming possible NPN protocols.
    * (Protocols should be ordered by their priority.)
    */
  var NPNProtocols: js.UndefOr[js.Array[java.lang.String] | Buffer] = js.undefined
  /**
    ...
    */
  var SNICallback: js.UndefOr[js.Function] = js.undefined
  /**
  ...
  /**
    ...
    */
  var secureContext: js.UndefOr[simplecrawlerLib.tlsMod.SecureContext] = js.undefined
  /**
    * An optional net.Server instance.
    */
  var server: js.UndefOr[simplecrawlerLib.netMod.Server] = js.undefined
  /**
...
object Anon_ALPNProtocols {
  @scala.inline
  def apply(
    ALPNProtocols: js.Array[java.lang.String] | Buffer = null,
    NPNProtocols: js.Array[java.lang.String] | Buffer = null,
    SNICallback: js.Function = null,
    ...
    secureContext: simplecrawlerLib.tlsMod.SecureContext = null,
    server: simplecrawlerLib.netMod.Server = null,
    session: Buffer = null
  ): Anon_ALPNProtocols = {
