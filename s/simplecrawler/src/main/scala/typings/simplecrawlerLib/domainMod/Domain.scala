package typings
package simplecrawlerLib.domainMod
...
class Domain ()
  extends simplecrawlerLib.eventsMod.EventEmitter
     with simplecrawlerLib.NodeJSNs.Domain {
  var members: js.Array[_] = js.native
  def add(emitter: simplecrawlerLib.eventsMod.EventEmitter): scala.Unit = js.native
  ...
  def remove(emitter: simplecrawlerLib.eventsMod.EventEmitter): scala.Unit = js.native
  /* InferMemberOverrides */
