...
trait Global extends js.Object {
  ...
  var Buffer: simplecrawlerLib.Anon_Alloc = js.native
  ...
  var Intl: simplecrawlerLib.Anon_Collator = js.native
  var JSON: stdLib.JSON = js.native
  var Map: simplecrawlerLib.MapConstructor = js.native
  ...
  var Set: simplecrawlerLib.SetConstructor = js.native
  @JSName("String")
  ...
  var WeakMap: simplecrawlerLib.WeakMapConstructor = js.native
  var WeakSet: simplecrawlerLib.WeakSetConstructor = js.native
  var console: simplecrawlerLib.Console = js.native
  ...
  @JSName("parseInt")
  var parseInt_Original: simplecrawlerLib.Anon_Radix = js.native
