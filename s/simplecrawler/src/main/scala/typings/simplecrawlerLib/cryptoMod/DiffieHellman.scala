...
trait DiffieHellman extends js.Object {
  ...
  def computeSecret(other_public_key: java.lang.String, input_encoding: HexBase64Latin1Encoding): simplecrawlerLib.Buffer = js.native
  def computeSecret(
    other_public_key: java.lang.String,
    input_encoding: HexBase64Latin1Encoding,
    output_encoding: HexBase64Latin1Encoding
  ): java.lang.String = js.native
  def computeSecret(other_public_key: simplecrawlerLib.Buffer): simplecrawlerLib.Buffer = js.native
  def generateKeys(): simplecrawlerLib.Buffer = js.native
  def generateKeys(encoding: HexBase64Latin1Encoding): java.lang.String = js.native
  def getGenerator(): simplecrawlerLib.Buffer = js.native
  def getGenerator(encoding: HexBase64Latin1Encoding): java.lang.String = js.native
  def getPrime(): simplecrawlerLib.Buffer = js.native
  def getPrime(encoding: HexBase64Latin1Encoding): java.lang.String = js.native
  def getPrivateKey(): simplecrawlerLib.Buffer = js.native
  def getPrivateKey(encoding: HexBase64Latin1Encoding): java.lang.String = js.native
  def getPublicKey(): simplecrawlerLib.Buffer = js.native
  ...
  def setPrivateKey(private_key: simplecrawlerLib.Buffer): scala.Unit = js.native
  def setPublicKey(public_key: java.lang.String, encoding: java.lang.String): scala.Unit = js.native
  def setPublicKey(public_key: simplecrawlerLib.Buffer): scala.Unit = js.native
}
