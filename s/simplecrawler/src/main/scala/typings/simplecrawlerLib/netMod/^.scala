...
object ^ extends js.Object {
  def connect(options: simplecrawlerLib.Anon_AllowHalfOpenFamily): Socket = js.native
  def connect(options: simplecrawlerLib.Anon_AllowHalfOpenFamily, connectionListener: js.Function): Socket = js.native
  ...
  def createConnection(options: simplecrawlerLib.Anon_AllowHalfOpenFamily): Socket = js.native
  def createConnection(options: simplecrawlerLib.Anon_AllowHalfOpenFamily, connectionListener: js.Function): Socket = js.native
  ...
  def createServer(options: simplecrawlerLib.Anon_AllowHalfOpenPauseOnConnect): Server = js.native
  def createServer(
    options: simplecrawlerLib.Anon_AllowHalfOpenPauseOnConnect,
