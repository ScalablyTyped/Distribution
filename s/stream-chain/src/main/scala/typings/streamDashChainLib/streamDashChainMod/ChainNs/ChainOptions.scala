package typings
package streamDashChainLib.streamDashChainMod.ChainNs
...
trait ChainOptions
  ...
  var skipEvents: js.UndefOr[scala.Boolean] = js.undefined
}
...
object ChainOptions {
  ...
  def apply(
    ...
    skipEvents: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(skipEvents)) __obj.updateDynamic("skipEvents")(skipEvents)
