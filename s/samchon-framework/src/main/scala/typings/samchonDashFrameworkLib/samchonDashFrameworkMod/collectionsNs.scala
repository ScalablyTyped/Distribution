...
@JSImport("samchon-framework", "collections")
@js.native
object collectionsNs extends js.Object {
  @js.native
  class ArrayCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.ArrayCollection[T]
  ...
  class CollectionEvent[T, SourceT /* <: tstlLib.baseContainerContainerMod.Container[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: tstlLib.baseIteratorIteratorMod.Iterator[T, SourceT, IteratorT, ReverseT, T] */, ReverseT /* <: tstlLib.baseIteratorReverseIteratorMod.ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */] protected ()
    extends samchonLib.samchonMod.collectionsNs.CollectionEvent[T, SourceT, IteratorT, ReverseT] {
    def this(`type`: java.lang.String, first: IteratorT, last: IteratorT) = this()
  }
  
  @js.native
  class DequeCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.DequeCollection[T]
  ...
  class EventDispatcher[T, SourceT /* <: tstlLib.baseContainerContainerMod.Container[T, SourceT, IteratorT, ReverseT, T] */, IteratorT /* <: tstlLib.baseIteratorIteratorMod.Iterator[T, SourceT, IteratorT, ReverseT, T] */, ReverseT /* <: tstlLib.baseIteratorReverseIteratorMod.ReverseIterator[T, SourceT, IteratorT, ReverseT, T] */] ()
    extends samchonLib.samchonMod.collectionsNs.EventDispatcher[T, SourceT, IteratorT, ReverseT]
  
  @js.native
  class HashMapCollection[Key, T] ()
    extends samchonLib.samchonMod.collectionsNs.HashMapCollection[Key, T]
  
  @js.native
  class HashMultiMapCollection[Key, T] ()
    extends samchonLib.samchonMod.collectionsNs.HashMultiMapCollection[Key, T]
  
  @js.native
  class HashMultiSetCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.HashMultiSetCollection[T]
  
  @js.native
  class HashSetCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.HashSetCollection[T]
  
  @js.native
  class ListCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.ListCollection[T]
  
  @js.native
  class TreeMapCollection[Key, T] ()
    extends samchonLib.samchonMod.collectionsNs.TreeMapCollection[Key, T]
  
  @js.native
  class TreeMultiMapCollection[Key, T] ()
    extends samchonLib.samchonMod.collectionsNs.TreeMultiMapCollection[Key, T]
  
  @js.native
  class TreeMultiSetCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.TreeMultiSetCollection[T]
  
  @js.native
  class TreeSetCollection[T] ()
    extends samchonLib.samchonMod.collectionsNs.TreeSetCollection[T]
