...
object libraryNs extends js.Object {
  ...
  class CartesianProduct protected ()
    extends typings.samchon.samchonMod.libraryNs.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends typings.samchon.samchonMod.libraryNs.Factorial {
    /**
  ...
  class Permutation protected ()
    extends typings.samchon.samchonMod.libraryNs.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends typings.samchon.samchonMod.libraryNs.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends typings.samchon.samchonMod.libraryNs.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends typings.samchon.samchonMod.libraryNs.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends typings.samchon.samchonMod.libraryNs.XML {
    def this(str: String) = this()
  ...
  @js.native
  class XMLList ()
    extends typings.samchon.samchonMod.libraryNs.XMLList
