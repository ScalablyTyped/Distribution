...
object library extends js.Object {
  ...
  class CartesianProduct protected ()
    extends typings.samchon.samchonMod.library.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends typings.samchon.samchonMod.library.Factorial {
    /**
  ...
  class Permutation protected ()
    extends typings.samchon.samchonMod.library.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends typings.samchon.samchonMod.library.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends typings.samchon.samchonMod.library.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends typings.samchon.samchonMod.library.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends typings.samchon.samchonMod.library.XML {
    def this(str: String) = this()
  ...
  @js.native
  class XMLList ()
    extends typings.samchon.samchonMod.library.XMLList
