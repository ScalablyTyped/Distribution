...
/* Inlined std.Partial<@storybook/components.@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-types.Modifier<any, any>> */
...
object PartialModifieranyany {
  ...
  inline def apply(): PartialModifieranyany = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialModifieranyany]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialModifieranyany] (val x: Self) extends AnyVal {
