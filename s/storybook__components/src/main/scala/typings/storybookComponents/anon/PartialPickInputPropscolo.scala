...
object PartialPickInputPropscolo {
  
  @scala.inline
  def apply(): PartialPickInputPropscolo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPickInputPropscolo]
  }
  
  @scala.inline
  implicit class PartialPickInputPropscoloMutableBuilder[Self <: PartialPickInputPropscolo] (val x: Self) extends AnyVal {
