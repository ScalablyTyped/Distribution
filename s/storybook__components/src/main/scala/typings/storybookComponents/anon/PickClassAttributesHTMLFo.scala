...
/* Inlined std.Pick<react.react.ClassAttributes<std.HTMLFormElement> & react.react.FormHTMLAttributes<std.HTMLFormElement>, keyof react.react.FormHTMLAttributes<std.HTMLFormElement>> */
trait PickClassAttributesHTMLFo extends StObject {
...
object PickClassAttributesHTMLFo {
  
  inline def apply(): PickClassAttributesHTMLFo = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickClassAttributesHTMLFo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickClassAttributesHTMLFo] (val x: Self) extends AnyVal {
