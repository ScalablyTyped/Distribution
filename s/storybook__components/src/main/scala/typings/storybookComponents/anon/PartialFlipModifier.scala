...
import typings.storybookComponents.`distTs3Dot9Modules@popperjsCoreLibModifiersFlipMod`.Options
...
import typings.storybookComponents.`distTs3Dot9Modules@popperjsCoreLibTypesMod`.StrictModifiers
import typings.storybookComponents.storybookComponentsStrings.flip
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<@storybook/components.@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-flip.FlipModifier> */
