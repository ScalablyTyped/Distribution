...
import typings.storybookComponents.storybookComponentsStrings.`lazy`
...
import typings.storybookComponents.storybookComponentsStrings.`use-credentials`
...
import typings.storybookComponents.storybookComponentsStrings.anonymous
...
import typings.storybookComponents.storybookComponentsStrings.async
...
import typings.storybookComponents.storybookComponentsStrings.eager
...
import typings.storybookComponents.storybookComponentsStrings.sync
...
/* Inlined std.Pick<react.react.ClassAttributes<std.HTMLImageElement> & react.react.ImgHTMLAttributes<std.HTMLImageElement>, keyof react.react.ImgHTMLAttributes<std.HTMLImageElement>> */
trait PickClassAttributesHTMLIm extends StObject {
  ...
  var crossOrigin: js.UndefOr[
    anonymous | `use-credentials` | typings.storybookComponents.storybookComponentsStrings._empty
  ] = js.undefined
...
object PickClassAttributesHTMLIm {
  
  inline def apply(): PickClassAttributesHTMLIm = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickClassAttributesHTMLIm]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickClassAttributesHTMLIm] (val x: Self) extends AnyVal {
    ...
    inline def setCrossOrigin(
      value: anonymous | `use-credentials` | typings.storybookComponents.storybookComponentsStrings._empty
