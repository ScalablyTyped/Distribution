...
/* Inlined std.Omit<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, keyof @storybook/components.@storybook/components.InputStyleProps> & @storybook/components.@storybook/components.InputStyleProps */
trait OmitSelectHTMLAttributesH extends StObject {
  ...
  var `aria-sort`: js.UndefOr[none | ascending | descending | other_] = js.undefined
...
object OmitSelectHTMLAttributesH {
  
  inline def apply(): OmitSelectHTMLAttributesH = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitSelectHTMLAttributesH]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitSelectHTMLAttributesH] (val x: Self) extends AnyVal {
    ...
    inline def `setAria-sort`(value: none | ascending | descending | other_): Self = StObject.set(x, "aria-sort", value.asInstanceOf[js.Any])
