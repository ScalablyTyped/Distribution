...
@js.native
trait StyledComponentPickanycol extends js.Object {
  ...
  def withComponent[Tag /* <: ComponentType[_] */](tag: Tag): StyledComponent[PropsOf[Tag], Pickanycolortranslatehidd, typings.storybookTheming.typesMod.Theme] = js.native
  /**
