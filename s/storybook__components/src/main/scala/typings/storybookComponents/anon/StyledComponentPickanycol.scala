...
trait StyledComponentPickanycol extends StObject {
  ...
  def withComponent[Tag /* <: ComponentType[js.Any] */](tag: Tag): StyledComponent[PropsOf[Tag], Pickanycolortranslatehidd, typings.storybookTheming.typesMod.Theme] = js.native
  /**
