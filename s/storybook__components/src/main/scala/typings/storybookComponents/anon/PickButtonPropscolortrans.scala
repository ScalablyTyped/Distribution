...
import typings.storybookComponents.storybookComponentsStrings.reset
...
import typings.storybookComponents.storybookComponentsStrings.submit
...
trait PickButtonPropscolortrans extends StObject {
  ...
  var ref: js.UndefOr[
    (js.Function1[/* instance */ HTMLButtonElement, Unit]) | RefObject[HTMLButtonElement]
  ] = js.undefined
...
object PickButtonPropscolortrans {
  ...
  inline def apply(): PickButtonPropscolortrans = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickButtonPropscolortrans]
  }
  
  extension [Self <: PickButtonPropscolortrans](x: Self) {
    ...
    inline def setRef(value: (js.Function1[/* instance */ HTMLButtonElement, Unit]) | RefObject[HTMLButtonElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ HTMLButtonElement => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
