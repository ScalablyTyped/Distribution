...
trait WeakValidationMapPickPick extends StObject {
  ...
  var capture: js.UndefOr[Validator[js.UndefOr[Boolean | Null | String]]] = js.undefined
  ...
  var download: js.UndefOr[Validator[js.UndefOr[js.Any | Null]]] = js.undefined
...
object WeakValidationMapPickPick {
  ...
  inline def apply(): WeakValidationMapPickPick = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapPickPick]
  }
  
  extension [Self <: WeakValidationMapPickPick](x: Self) {
    ...
    inline def setCapture(value: Validator[js.UndefOr[Boolean | Null | String]]): Self = StObject.set(x, "capture", value.asInstanceOf[js.Any])
    ...
    inline def setDownload(value: Validator[js.UndefOr[js.Any | Null]]): Self = StObject.set(x, "download", value.asInstanceOf[js.Any])
