...
import typings.storybookComponents.`distTs3Dot9Modules@popperjsCoreLibModifiersPreventOverflowMod`.Options
...
/* Inlined std.Partial<@storybook/components.@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-preventOverflow.PreventOverflowModifier> */
