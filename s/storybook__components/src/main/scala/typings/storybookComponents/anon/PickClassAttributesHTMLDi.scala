...
/* Inlined std.Pick<react.react.ClassAttributes<std.HTMLDivElement> & react.react.HTMLAttributes<std.HTMLDivElement>, keyof react.react.HTMLAttributes<std.HTMLDivElement>> */
trait PickClassAttributesHTMLDi extends StObject {
...
object PickClassAttributesHTMLDi {
  
  inline def apply(): PickClassAttributesHTMLDi = {
