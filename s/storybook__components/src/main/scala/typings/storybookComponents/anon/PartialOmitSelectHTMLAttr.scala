...
trait PartialOmitSelectHTMLAttr extends StObject {
...
object PartialOmitSelectHTMLAttr {
  
  inline def apply(): PartialOmitSelectHTMLAttr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialOmitSelectHTMLAttr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialOmitSelectHTMLAttr] (val x: Self) extends AnyVal {
