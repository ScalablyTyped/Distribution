...
/* Inlined @storybook/theming.@storybook/theming.StyledComponent<std.Omit</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_react-textarea-autosize.TextareaAutosizeProps * / any, keyof @storybook/components.@storybook/components.InputStyleProps> & @storybook/components.@storybook/components.InputStyleProps & react.react.RefAttributes<any>, std.Omit</ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_react-textarea-autosize.TextareaAutosizeProps * / any, keyof @storybook/components.@storybook/components.InputStyleProps> & @storybook/components.@storybook/components.InputStyleProps, @storybook/theming.@storybook/theming.Theme> & {  displayName :string} */
@js.native
trait StyledComponentOmitanykey extends StObject {
  
  def apply(
    props: (Omit[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_react-textarea-autosize.TextareaAutosizeProps */ Any, 
      size | align | valid | height
    ]) & InputStyleProps & RefAttributes[Any] & (DistributiveOmit[
      (Omit[
        /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_react-textarea-autosize.TextareaAutosizeProps */ Any, 
        size | align | valid | height
      ]) & InputStyleProps, 
  ...
  def withComponent[Tag /* <: ComponentType[Any] */](tag: Tag): StyledComponent[
    PropsOf[Tag], 
    (Omit[
      /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_react-textarea-autosize.TextareaAutosizeProps */ Any, 
      size | align | valid | height
