...
/* Inlined react.react.AnchorHTMLAttributes<std.HTMLAnchorElement> & {  children :react.react.ReactNode | undefined} */
trait AnchorHTMLAttributesHTMLA extends StObject {
...
object AnchorHTMLAttributesHTMLA {
  
  inline def apply(): AnchorHTMLAttributesHTMLA = {
