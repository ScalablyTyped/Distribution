...
import typings.storybookComponents.`distTs3Dot9Modules@popperjsCoreLibModifiersArrowMod`.Options
...
/* Inlined std.Partial<@storybook/components.@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-arrow.ArrowModifier> */
