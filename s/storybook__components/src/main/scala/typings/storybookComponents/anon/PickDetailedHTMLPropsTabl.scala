...
object PickDetailedHTMLPropsTabl {
  ...
  inline def apply(): PickDetailedHTMLPropsTabl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDetailedHTMLPropsTabl]
  }
  
  extension [Self <: PickDetailedHTMLPropsTabl](x: Self) {
