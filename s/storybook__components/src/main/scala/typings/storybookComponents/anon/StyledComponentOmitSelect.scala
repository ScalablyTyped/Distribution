...
/* Inlined @storybook/theming.@storybook/theming.StyledComponent<std.Omit<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, keyof @storybook/components.@storybook/components.InputStyleProps> & @storybook/components.@storybook/components.InputStyleProps & react.react.RefAttributes<any>, std.Omit<react.react.SelectHTMLAttributes<std.HTMLSelectElement>, keyof @storybook/components.@storybook/components.InputStyleProps> & @storybook/components.@storybook/components.InputStyleProps, @storybook/theming.@storybook/theming.Theme> & {  displayName :string} */
@js.native
trait StyledComponentOmitSelect extends StObject {
  
  def apply(props: OmitSelectHTMLAttributesHAbout): ReactElement | Null = js.native
  def apply(props: OmitSelectHTMLAttributesHAbout, context: Any): ReactElement | Null = js.native
  ...
  def withComponent[Tag /* <: ComponentType[Any] */](tag: Tag): StyledComponent[PropsOf[Tag], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  /**
  ...
  @JSName("withComponent")
  def withComponent_animate(tag: animate): StyledComponent[SVGProps[SVGElement], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  @JSName("withComponent")
  def withComponent_animateMotion(tag: animateMotion): StyledComponent[SVGProps[SVGElement], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  @JSName("withComponent")
  def withComponent_animateTransform(tag: animateTransform): StyledComponent[SVGProps[SVGElement], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  @JSName("withComponent")
  ...
  @JSName("withComponent")
  def withComponent_g(tag: g): StyledComponent[SVGProps[SVGGElement], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  @JSName("withComponent")
  ...
  @JSName("withComponent")
  def withComponent_mpath(tag: mpath): StyledComponent[SVGProps[SVGElement], OmitSelectHTMLAttributesH, typings.storybookTheming.mod.Theme] = js.native
  @JSName("withComponent")
