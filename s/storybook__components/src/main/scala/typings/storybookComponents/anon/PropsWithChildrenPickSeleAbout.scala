...
object PropsWithChildrenPickSeleAbout {
  ...
  @scala.inline
  def apply(): PropsWithChildrenPickSeleAbout = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PropsWithChildrenPickSeleAbout]
  }
  
  @scala.inline
  implicit class PropsWithChildrenPickSeleAboutMutableBuilder[Self <: PropsWithChildrenPickSeleAbout] (val x: Self) extends AnyVal {
