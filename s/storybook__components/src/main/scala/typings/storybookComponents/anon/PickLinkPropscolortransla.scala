...
object PickLinkPropscolortransla {
  ...
  inline def apply(href: String): PickLinkPropscolortransla = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickLinkPropscolortransla]
  }
  
  extension [Self <: PickLinkPropscolortransla](x: Self) {
    ...
    inline def setRef(value: (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | RefObject[HTMLAnchorElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ HTMLAnchorElement => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
