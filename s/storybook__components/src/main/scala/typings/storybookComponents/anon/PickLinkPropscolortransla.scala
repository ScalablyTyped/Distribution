...
@js.native
trait PickLinkPropscolortransla extends js.Object {
...
object PickLinkPropscolortransla {
  ...
  @scala.inline
  implicit class PickLinkPropscolortranslaOps[Self <: PickLinkPropscolortransla] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLAnchorElement => Unit): Self = this.set("ref", js.Any.fromFunction1(value))
    
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | RefObject[HTMLAnchorElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
