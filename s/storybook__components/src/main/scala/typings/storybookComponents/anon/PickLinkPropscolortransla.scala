...
trait PickLinkPropscolortransla extends StObject {
  ...
  var ref: js.UndefOr[
    (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | RefObject[HTMLAnchorElement]
  ] = js.undefined
...
object PickLinkPropscolortransla {
  
  @scala.inline
  def apply(href: String): PickLinkPropscolortransla = {
    val __obj = js.Dynamic.literal(href = href.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickLinkPropscolortransla]
  }
  
  @scala.inline
  implicit class PickLinkPropscolortranslaMutableBuilder[Self <: PickLinkPropscolortransla] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: (js.Function1[/* instance */ HTMLAnchorElement, Unit]) | RefObject[HTMLAnchorElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRefFunction1(value: /* instance */ HTMLAnchorElement => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
