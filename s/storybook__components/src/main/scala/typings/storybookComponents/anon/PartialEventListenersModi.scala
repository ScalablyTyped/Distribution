...
import typings.storybookComponents.`distTs3Dot9Modules@popperjsCoreLibModifiersEventListenersMod`.Options
...
/* Inlined std.Partial<@storybook/components.@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-eventListeners.EventListenersModifier> */
