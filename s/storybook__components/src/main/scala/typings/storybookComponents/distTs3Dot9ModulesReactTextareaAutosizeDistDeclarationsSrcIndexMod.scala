...
import typings.storybookComponents.anon.Height
...
import typings.storybookComponents.storybookComponentsStrings.maxHeight
import typings.storybookComponents.storybookComponentsStrings.menu
import typings.storybookComponents.storybookComponentsStrings.minHeight
...
object distTs3Dot9ModulesReactTextareaAutosizeDistDeclarationsSrcIndexMod extends Shortcut {
  
  @JSImport("@storybook/components/dist/ts3.9/_modules/react-textarea-autosize-dist-declarations-src-index", JSImport.Default)
  @js.native
  ...
  /* Inlined parent std.Omit<@storybook/components.@storybook/components/dist/ts3.9/_modules/react-textarea-autosize-dist-declarations-src-index.TextareaProps, 'style'> */
  ...
  /* This means you don't have to write `default`, but can instead just say `distTs3Dot9ModulesReactTextareaAutosizeDistDeclarationsSrcIndexMod.foo` */
