...
/* Inlined std.Record<@storybook/components.@storybook/components/dist/ts3.9/_modules/@types-prettier-index.BuiltInParserName, @storybook/components.@storybook/components/dist/ts3.9/_modules/@types-prettier-index.BuiltInParser> */
trait BuiltInParsers extends StObject {
  
  var angular: BuiltInParser
  
  var babel: BuiltInParser
  
  var `babel-flow`: BuiltInParser
  
  var `babel-ts`: BuiltInParser
  
  var css: BuiltInParser
  
  var espree: BuiltInParser
  
  var flow: BuiltInParser
  
  var glimmer: BuiltInParser
  
  var graphql: BuiltInParser
  
  var html: BuiltInParser
  
  var json: BuiltInParser
  
  var `json-stringify`: BuiltInParser
  
  var json5: BuiltInParser
  
  var less: BuiltInParser
  
  var lwc: BuiltInParser
  
  var markdown: BuiltInParser
  
  var mdx: BuiltInParser
  
  var meriyah: BuiltInParser
  
  var scss: BuiltInParser
  
  var typescript: BuiltInParser
  
  var vue: BuiltInParser
  
  var yaml: BuiltInParser
}
