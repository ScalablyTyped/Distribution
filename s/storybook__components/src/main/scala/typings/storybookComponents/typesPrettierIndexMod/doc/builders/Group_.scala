...
trait Group_
  ...
  var `type`: typings.storybookComponents.storybookComponentsStrings.group
}
object Group_ {
  ...
  extension [Self <: Group_](x: Self) {
    ...
    inline def setType(value: typings.storybookComponents.storybookComponentsStrings.group): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
