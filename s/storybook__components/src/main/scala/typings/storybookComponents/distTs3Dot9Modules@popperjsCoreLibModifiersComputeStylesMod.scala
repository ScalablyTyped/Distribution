...
import typings.storybookComponents.anon.Adaptive
import typings.storybookComponents.anon.Bottom
import typings.storybookComponents.anon.Partialxnumberynumbercent
import typings.storybookComponents.storybookComponentsStrings.computeStyles
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object `distTs3Dot9Modules@popperjsCoreLibModifiersComputeStylesMod` {
  
  @JSImport("@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-computeStyles", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@storybook/components/dist/ts3.9/_modules/@popperjs-core-lib-modifiers-computeStyles", JSImport.Default)
  @js.native
