...
object SelectProps {
  ...
  def apply(
    ...
    name: String = null,
    onAbort: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onCanPlay: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onCanPlayThrough: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onDurationChange: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onEmptied: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onEncrypted: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onEnded: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onError: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onLoad: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onLoadStart: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onLoadedData: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onLoadedMetadata: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onPause: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onPlay: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onPlaying: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onProgress: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onRateChange: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onReset: FormEvent[HTMLSelectElement] => Unit = null,
    onScroll: UIEvent[HTMLSelectElement, NativeUIEvent] => Unit = null,
    onSeeked: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onSeeking: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onSelect: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onStalled: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onSubmit: FormEvent[HTMLSelectElement] => Unit = null,
    onSuspend: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onTimeUpdate: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    ...
    onVolumeChange: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
    onWaiting: SyntheticEvent[HTMLSelectElement, Event] => Unit = null,
