...
object TabsStateProps {
  ...
  implicit class TabsStatePropsOps[Self <: TabsStateProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: (ReactNode | FuncChilden)*): Self = this.set("children", js.Array(value :_*))
    @scala.inline
    def setChildren(value: js.Array[ReactNode | FuncChilden]): Self = this.set("children", value.asInstanceOf[js.Any])
    @scala.inline
