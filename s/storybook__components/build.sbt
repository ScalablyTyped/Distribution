...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-syntax-highlighter" % "11.0-dt-20190910Z-cec932",
  "org.scalablytyped" %%% "react-textarea-autosize" % "4.3.0-dt-20190404Z-a37666",
