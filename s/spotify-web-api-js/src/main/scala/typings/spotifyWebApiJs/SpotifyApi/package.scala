...
package object SpotifyApi {
  ...
  /**
    ...
    */
  type ChangePlaylistDetailsReponse = typings.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
  ...
  /**
    ...
    */
  type FollowPlaylistReponse = typings.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
  ...
  /**
    ...
    */
  type UnfollowPlaylistReponse = typings.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
    ...
    */
  type UploadCustomPlaylistCoverImageReponse = typings.spotifyWebApiJs.SpotifyApi.VoidResponse
  /**
