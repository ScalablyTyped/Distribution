...
version := "0.7-dt-20181027Z-016da1"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "restify" % "7.2-dt-20181121Z-61f5ca",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180910Z-1add06",
  "org.scalablytyped" %%% "shot" % "4.0-dt-20181002Z-41bb3c",
  "org.scalablytyped" %%% "spdy" % "3.4-dt-20181121Z-65ee4c",
  "org.scalablytyped" %%% "std" % "3.2.2-04ea79",
  "org.scalablytyped" %%% "swagger-node-runner" % "0.5-dt-20181027Z-f29d8b",
