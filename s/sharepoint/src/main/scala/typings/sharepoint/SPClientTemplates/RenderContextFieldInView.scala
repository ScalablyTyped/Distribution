...
object RenderContextFieldInView {
  ...
  def apply(
    ...
    RenderBody: RenderContextFieldInView => String = null,
    RenderFieldByName: (RenderContextFieldInView, /* fieldName */ String) => String = null,
    RenderFields: RenderContextFieldInView => String = null,
    RenderFooter: RenderContextFieldInView => String = null,
    RenderGroups: RenderContextFieldInView => String = null,
    RenderHeader: RenderContextFieldInView => String = null,
    RenderItems: RenderContextFieldInView => String = null,
    RenderView: RenderContextFieldInView => String = null,
