...
object StringMatchOption extends js.Object {
  ...
  /* 1 */ val exactMatch: typings.sharepoint.SPNs.TaxonomyNs.StringMatchOption.exactMatch with Double = js.native
  /* 0 */ val startsWith: typings.sharepoint.SPNs.TaxonomyNs.StringMatchOption.startsWith with Double = js.native
  @JSBracketAccess
