...
object GanttDrawBarFlags extends js.Object {
  ...
  /* 0 */ val LeftLink: typings.sharepoint.SPNs.JsGridNs.GanttDrawBarFlags.LeftLink with Double = js.native
  /* 1 */ val RightLink: typings.sharepoint.SPNs.JsGridNs.GanttDrawBarFlags.RightLink with Double = js.native
  @JSBracketAccess
