...
object SocialAttachmentActionKind extends js.Object {
  ...
  /* 1 */ val adHocAction: typings.sharepoint.SPNs.SocialNs.SocialAttachmentActionKind.adHocAction with Double = js.native
  /* 0 */ val navigate: typings.sharepoint.SPNs.SocialNs.SocialAttachmentActionKind.navigate with Double = js.native
  @JSBracketAccess
