...
object SocialFeedSortOrder extends js.Object {
  ...
  /* 1 */ val byCreatedTime: typings.sharepoint.SPNs.SocialNs.SocialFeedSortOrder.byCreatedTime with Double = js.native
  /* 0 */ val byModifiedTime: typings.sharepoint.SPNs.SocialNs.SocialFeedSortOrder.byModifiedTime with Double = js.native
  @JSBracketAccess
