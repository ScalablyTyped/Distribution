...
object SocialFeedAttributes extends js.Object {
  ...
  /* 1 */ val moreThreadsAvailable: typings.sharepoint.SPNs.SocialNs.SocialFeedAttributes.moreThreadsAvailable with Double = js.native
  /* 0 */ val none: typings.sharepoint.SPNs.SocialNs.SocialFeedAttributes.none with Double = js.native
  @JSBracketAccess
