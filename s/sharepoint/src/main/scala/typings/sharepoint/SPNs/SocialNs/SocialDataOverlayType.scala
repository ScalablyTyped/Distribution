...
object SocialDataOverlayType extends js.Object {
  ...
  /* 1 */ val actors: typings.sharepoint.SPNs.SocialNs.SocialDataOverlayType.actors with Double = js.native
  /* 0 */ val link: typings.sharepoint.SPNs.SocialNs.SocialDataOverlayType.link with Double = js.native
  @JSBracketAccess
