...
object SocialPostAttributes extends js.Object {
  ...
  /* 2 */ val canDelete: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.canDelete with Double = js.native
  /* 5 */ val canFollowUp: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.canFollowUp with Double = js.native
  /* 1 */ val canLike: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.canLike with Double = js.native
  /* 0 */ val none: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.none with Double = js.native
  /* 3 */ val useAuthorImage: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.useAuthorImage with Double = js.native
  /* 4 */ val useSmallImage: typings.sharepoint.SPNs.SocialNs.SocialPostAttributes.useSmallImage with Double = js.native
  @JSBracketAccess
