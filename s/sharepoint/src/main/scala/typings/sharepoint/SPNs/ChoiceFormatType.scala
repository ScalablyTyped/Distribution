...
object ChoiceFormatType extends js.Object {
  ...
  /* 0 */ val dropdown: typings.sharepoint.SPNs.ChoiceFormatType.dropdown with Double = js.native
  /* 1 */ val radioButtons: typings.sharepoint.SPNs.ChoiceFormatType.radioButtons with Double = js.native
  @JSBracketAccess
