...
import typings.sharepoint.SPNs.UtilitiesNs.SPWOPIFrameAction
...
@js.native
class ListItem[T] () extends SecurableObject {
  ...
  def get_item[K /* <: String */](fieldInternalName: K): /* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any = js.native
