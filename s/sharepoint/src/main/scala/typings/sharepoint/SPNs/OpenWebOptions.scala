...
object OpenWebOptions extends js.Object {
  ...
  /* 1 */ val initNavigationCache: typings.sharepoint.SPNs.OpenWebOptions.initNavigationCache with Double = js.native
  /* 0 */ val none: typings.sharepoint.SPNs.OpenWebOptions.none with Double = js.native
  @JSBracketAccess
