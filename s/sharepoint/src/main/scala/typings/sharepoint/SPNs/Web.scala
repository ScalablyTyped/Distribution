...
import typings.sharepoint.SPNs.BusinessDataNs.AppBdcCatalog
import typings.sharepoint.SPNs.BusinessDataNs.Entity
import typings.sharepoint.SPNs.UtilitiesNs.IconSize
import typings.sharepoint.SPNs.WorkflowNs.WorkflowAssociationCollection
import typings.sharepoint.SPNs.WorkflowNs.WorkflowTemplateCollection
