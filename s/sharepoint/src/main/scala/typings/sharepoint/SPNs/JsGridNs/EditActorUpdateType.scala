...
object EditActorUpdateType extends js.Object {
  ...
  /* 0 */ val Committed: typings.sharepoint.SPNs.JsGridNs.EditActorUpdateType.Committed with Double = js.native
  /* 1 */ val Uncommitted: typings.sharepoint.SPNs.JsGridNs.EditActorUpdateType.Uncommitted with Double = js.native
  @JSBracketAccess
