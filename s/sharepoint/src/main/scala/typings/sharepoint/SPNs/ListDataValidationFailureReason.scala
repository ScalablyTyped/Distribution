...
object ListDataValidationFailureReason extends js.Object {
  ...
  /* 0 */ val dataFailure: typings.sharepoint.SPNs.ListDataValidationFailureReason.dataFailure with Double = js.native
  /* 1 */ val formulaError: typings.sharepoint.SPNs.ListDataValidationFailureReason.formulaError with Double = js.native
  @JSBracketAccess
