...
object UpgradeType extends js.Object {
  ...
  /* 0 */ val buildUpgrade: typings.sharepoint.SPNs.UpgradeType.buildUpgrade with Double = js.native
  /* 1 */ val versionUpgrade: typings.sharepoint.SPNs.UpgradeType.versionUpgrade with Double = js.native
  @JSBracketAccess
