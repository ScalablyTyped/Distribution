...
object DateTimeFieldFormatType extends js.Object {
  ...
  /* 0 */ val dateOnly: typings.sharepoint.SPNs.DateTimeFieldFormatType.dateOnly with Double = js.native
  /* 1 */ val dateTime: typings.sharepoint.SPNs.DateTimeFieldFormatType.dateTime with Double = js.native
  @JSBracketAccess
