...
object UrlFieldFormatType extends js.Object {
  ...
  /* 0 */ val hyperlink: typings.sharepoint.SPNs.UrlFieldFormatType.hyperlink with Double = js.native
  /* 1 */ val image: typings.sharepoint.SPNs.UrlFieldFormatType.image with Double = js.native
  @JSBracketAccess
