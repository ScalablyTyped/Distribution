...
@JSGlobal("SP.WebCreationInformation")
@js.native
open class WebCreationInformation ()
  extends StObject
     with typings.sharepoint.SP.WebCreationInformation {
  ...
  /* CompleteClass */
  override def get_language(): Double = js.native
  ...
  /* CompleteClass */
  override def get_useSamePermissionsAsParentSite(): Boolean = js.native
  
  /* CompleteClass */
  override def get_webTemplate(): String = js.native
  
  /* CompleteClass */
  override def set_description(value: String): Unit = js.native
  
  /* CompleteClass */
  override def set_language(value: Double): Unit = js.native
  ...
  /* CompleteClass */
  override def set_useSamePermissionsAsParentSite(value: Boolean): Unit = js.native
  
  /* CompleteClass */
  override def set_webTemplate(value: String): Unit = js.native
