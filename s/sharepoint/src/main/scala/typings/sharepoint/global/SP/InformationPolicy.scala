...
object InformationPolicy {
  ...
  object ProjectPolicy {
    ...
    /* static member */
    inline def closeProject(context: typings.sharepoint.SP.ClientRuntimeContext, web: typings.sharepoint.SP.Web): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("closeProject")(context.asInstanceOf[js.Any], web.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /* static member */
    inline def getProjectCloseDate(context: typings.sharepoint.SP.ClientRuntimeContext, web: typings.sharepoint.SP.Web): typings.sharepoint.SP.DateTimeResult = (^.asInstanceOf[js.Dynamic].applyDynamic("getProjectCloseDate")(context.asInstanceOf[js.Any], web.asInstanceOf[js.Any])).asInstanceOf[typings.sharepoint.SP.DateTimeResult]
    ...
    /* static member */
    inline def isProjectClosed(context: typings.sharepoint.SP.ClientRuntimeContext, web: typings.sharepoint.SP.Web): typings.sharepoint.SP.BooleanResult = (^.asInstanceOf[js.Dynamic].applyDynamic("isProjectClosed")(context.asInstanceOf[js.Any], web.asInstanceOf[js.Any])).asInstanceOf[typings.sharepoint.SP.BooleanResult]
    
    /* static member */
    inline def openProject(context: typings.sharepoint.SP.ClientRuntimeContext, web: typings.sharepoint.SP.Web): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("openProject")(context.asInstanceOf[js.Any], web.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    /* static member */
    inline def postponeProject(context: typings.sharepoint.SP.ClientRuntimeContext, web: typings.sharepoint.SP.Web): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("postponeProject")(context.asInstanceOf[js.Any], web.asInstanceOf[js.Any])).asInstanceOf[Unit]
  }
}
