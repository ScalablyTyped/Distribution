...
object ClientConstants {
  ...
  @js.native
  def ExceptionHandlingScope: String = js.native
  ...
  /* static member */
  @JSGlobal("SP.ClientConstants.ObjectIdentity")
  @js.native
  def ObjectIdentity: String = js.native
  ...
  @js.native
  def ObjectPath: String = js.native
  ...
  @js.native
  def TraceCorrelationId: String = js.native
  ...
  @js.native
  def fluidApplicationInitParamFormDigest: String = js.native
  ...
  @js.native
  def useWebLanguageHeader: String = js.native
