...
class Ribbon protected ()
  ...
  /* CompleteClass */
  override def removeContextualGroup(id: String): scala.Unit = js.native
  
  /* CompleteClass */
  override def setFocus(): scala.Unit = js.native
  
  /* CompleteClass */
  override def setFocusOnCurrentTab(): scala.Unit = js.native
  
  /* CompleteClass */
  override def setFocusOnRibbon(): scala.Unit = js.native
  ...
  /* CompleteClass */
  override def showContextualGroup(id: String): scala.Unit = js.native
