...
@JSGlobal("SP.WebRequestInfo")
@js.native
open class WebRequestInfo ()
  extends StObject
     with typings.sharepoint.SP.WebRequestInfo {
  ...
  /* CompleteClass */
  override def get_method(): String = js.native
  ...
  /* CompleteClass */
  override def set_method(value: String): Unit = js.native
