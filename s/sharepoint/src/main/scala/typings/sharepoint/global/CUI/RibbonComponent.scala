...
@js.native
open class RibbonComponent protected ()
  extends StObject
     with typings.sharepoint.CUI.RibbonComponent {
  def this(ribbon: typings.sharepoint.CUI.Ribbon, id: String, title: String, description: String) = this()
  ...
  /* CompleteClass */
  override def get_ribbon(): typings.sharepoint.CUI.Ribbon = js.native
