...
class AttractModeControl ()
  extends typings.sharepoint.SP.UI.AttractModeControl {
  /* CompleteClass */
  override var cssAttractMode: String = js.native
  /* CompleteClass */
  override var cssAttractModeBackground: String = js.native
  /* CompleteClass */
  override var cssAttractModeCell: String = js.native
  /* CompleteClass */
  override var cssAttractModeIcon: String = js.native
  /* CompleteClass */
  override var cssAttractModeText: String = js.native
  /* CompleteClass */
  override var cssAttractModeWrapper: String = js.native
  /* CompleteClass */
  override var defaultAttractModeIcon: String = js.native
  //#endregion
  //#region Methods
  /**
