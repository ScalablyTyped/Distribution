...
object sharepointStrings {
  ...
  @scala.inline
  def IsFirstPinnedResultBlock: IsFirstPinnedResultBlock = "IsFirstPinnedResultBlock".asInstanceOf[IsFirstPinnedResultBlock]
  ...
  @scala.inline
  def QueryErrors: QueryErrors = "QueryErrors".asInstanceOf[QueryErrors]
  
  @js.native
  sealed trait QueryId extends StObject
  @scala.inline
  def QueryId: QueryId = "QueryId".asInstanceOf[QueryId]
  
  @js.native
  sealed trait QueryRuleId extends StObject
  @scala.inline
  def QueryRuleId: QueryRuleId = "QueryRuleId".asInstanceOf[QueryRuleId]
  
  @js.native
  sealed trait RenderTemplateId extends StObject
  @scala.inline
  def RenderTemplateId: RenderTemplateId = "RenderTemplateId".asInstanceOf[RenderTemplateId]
  
  @js.native
  sealed trait RenderTemplates extends StObject
  @scala.inline
  def RenderTemplates: RenderTemplates = "RenderTemplates".asInstanceOf[RenderTemplates]
  
  @js.native
  sealed trait ResultRows extends StObject
  @scala.inline
  def ResultRows: ResultRows = "ResultRows".asInstanceOf[ResultRows]
  
  @js.native
  sealed trait ResultTables extends StObject
  @scala.inline
  def ResultTables: ResultTables = "ResultTables".asInstanceOf[ResultTables]
  ...
  @scala.inline
  def TableType: TableType = "TableType".asInstanceOf[TableType]
  
  @js.native
  sealed trait TotalRows extends StObject
  @scala.inline
  def TotalRows: TotalRows = "TotalRows".asInstanceOf[TotalRows]
  
  @js.native
  sealed trait TotalRowsIncludingDuplicates extends StObject
  @scala.inline
  def TotalRowsIncludingDuplicates: TotalRowsIncludingDuplicates = "TotalRowsIncludingDuplicates".asInstanceOf[TotalRowsIncludingDuplicates]
  ...
  @scala.inline
  def _deepLinks: _deepLinks = "_deepLinks".asInstanceOf[_deepLinks]
  
  @js.native
  sealed trait _discussions extends StObject
  @scala.inline
  def _discussions: _discussions = "_discussions".asInstanceOf[_discussions]
  
  @js.native
  sealed trait _group extends StObject
  @scala.inline
  def _group: _group = "_group".asInstanceOf[_group]
  
  @js.native
  sealed trait _groupContent extends StObject
  @scala.inline
  def _groupContent: _groupContent = "_groupContent".asInstanceOf[_groupContent]
  
  @js.native
  sealed trait _groupLink extends StObject
  @scala.inline
  def _groupLink: _groupLink = "_groupLink".asInstanceOf[_groupLink]
  
  @js.native
  sealed trait _groupTitle extends StObject
  @scala.inline
  def _groupTitle: _groupTitle = "_groupTitle".asInstanceOf[_groupTitle]
  
  @js.native
  sealed trait _hover extends StObject
  @scala.inline
  def _hover: _hover = "_hover".asInstanceOf[_hover]
  
  @js.native
  sealed trait _item extends StObject
  @scala.inline
  def _item: _item = "_item".asInstanceOf[_item]
  
  @js.native
  sealed trait _itemBody extends StObject
  @scala.inline
  def _itemBody: _itemBody = "_itemBody".asInstanceOf[_itemBody]
  
  @js.native
  sealed trait _itemIcon extends StObject
  @scala.inline
  def _itemIcon: _itemIcon = "_itemIcon".asInstanceOf[_itemIcon]
  
  @js.native
  sealed trait _itemPath extends StObject
  @scala.inline
  def _itemPath: _itemPath = "_itemPath".asInstanceOf[_itemPath]
  
  @js.native
  sealed trait _itemPreview extends StObject
  @scala.inline
  def _itemPreview: _itemPreview = "_itemPreview".asInstanceOf[_itemPreview]
  
  @js.native
  sealed trait _itemSummary extends StObject
  @scala.inline
  def _itemSummary: _itemSummary = "_itemSummary".asInstanceOf[_itemSummary]
  
  @js.native
  sealed trait _itemTitle extends StObject
  @scala.inline
  def _itemTitle: _itemTitle = "_itemTitle".asInstanceOf[_itemTitle]
  
  @js.native
  sealed trait _itemTitleLink extends StObject
  @scala.inline
  def _itemTitleLink: _itemTitleLink = "_itemTitleLink".asInstanceOf[_itemTitleLink]
  
  @js.native
  sealed trait _likes extends StObject
  @scala.inline
  def _likes: _likes = "_likes".asInstanceOf[_likes]
  
  @js.native
  sealed trait _members extends StObject
  @scala.inline
  def _members: _members = "_members".asInstanceOf[_members]
  
  @js.native
  sealed trait _postInfo extends StObject
  @scala.inline
  def _postInfo: _postInfo = "_postInfo".asInstanceOf[_postInfo]
