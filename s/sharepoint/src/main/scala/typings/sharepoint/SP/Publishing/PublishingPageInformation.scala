...
object PublishingPageInformation {
  ...
  inline def apply(
    ...
    get_folder: () => Folder,
    get_name: () => String,
    get_pageLayoutListItem: () => ListItem[Any],
    get_typeId: () => String,
  ...
  extension [Self <: PublishingPageInformation](x: Self) {
    ...
    inline def setGet_pageLayoutListItem(value: () => ListItem[Any]): Self = StObject.set(x, "get_pageLayoutListItem", js.Any.fromFunction0(value))
