...
object SiteHealth {
  ...
  object SiteHealthResult {
    ...
    extension [Self <: SiteHealthResult](x: Self) {
      ...
      inline def setGet_timeStamp(value: () => js.Date): Self = StObject.set(x, "get_timeStamp", js.Any.fromFunction0(value))
      
      inline def setSet_status(value: SiteHealthStatusType => Unit): Self = StObject.set(x, "set_status", js.Any.fromFunction1(value))
      
      inline def setSet_timeStamp(value: js.Date => Unit): Self = StObject.set(x, "set_timeStamp", js.Any.fromFunction1(value))
    }
  }
