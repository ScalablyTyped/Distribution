...
object ClientRequestFailedEventArgs {
  ...
  implicit open class MutableBuilder[Self <: ClientRequestFailedEventArgs] (val x: Self) extends AnyVal {
    ...
    inline def setGet_errorTypeName(value: () => String): Self = StObject.set(x, "get_errorTypeName", js.Any.fromFunction0(value))
    
    inline def setGet_errorValue(value: () => String): Self = StObject.set(x, "get_errorValue", js.Any.fromFunction0(value))
