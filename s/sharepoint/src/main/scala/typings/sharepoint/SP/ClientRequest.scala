...
object ClientRequest {
  ...
  inline def apply(
    add_requestFailed: js.Function2[/* sender */ Any, /* args */ ClientRequestFailedEventArgs, Unit] => Unit,
    add_requestSucceeded: js.Function2[/* sender */ Any, /* args */ ClientRequestSucceededEventArgs, Unit] => Unit,
    get_navigateWhenServerRedirect: () => Boolean,
    get_webRequest: () => WebRequest,
    remove_requestFailed: js.Function2[/* sender */ Any, /* args */ ClientRequestFailedEventArgs, Unit] => Unit,
    remove_requestSucceeded: js.Function2[/* sender */ Any, /* args */ ClientRequestSucceededEventArgs, Unit] => Unit,
  ...
  implicit open class MutableBuilder[Self <: ClientRequest] (val x: Self) extends AnyVal {
    ...
    inline def setAdd_requestSucceeded(value: js.Function2[/* sender */ Any, /* args */ ClientRequestSucceededEventArgs, Unit] => Unit): Self = StObject.set(x, "add_requestSucceeded", js.Any.fromFunction1(value))
    
    inline def setGet_navigateWhenServerRedirect(value: () => Boolean): Self = StObject.set(x, "get_navigateWhenServerRedirect", js.Any.fromFunction0(value))
    
    inline def setGet_webRequest(value: () => WebRequest): Self = StObject.set(x, "get_webRequest", js.Any.fromFunction0(value))
    
    inline def setRemove_requestFailed(value: js.Function2[/* sender */ Any, /* args */ ClientRequestFailedEventArgs, Unit] => Unit): Self = StObject.set(x, "remove_requestFailed", js.Any.fromFunction1(value))
    
    inline def setRemove_requestSucceeded(value: js.Function2[/* sender */ Any, /* args */ ClientRequestSucceededEventArgs, Unit] => Unit): Self = StObject.set(x, "remove_requestSucceeded", js.Any.fromFunction1(value))
    
    inline def setSet_navigateWhenServerRedirect(value: Boolean => Unit): Self = StObject.set(x, "set_navigateWhenServerRedirect", js.Any.fromFunction1(value))
  }
}
