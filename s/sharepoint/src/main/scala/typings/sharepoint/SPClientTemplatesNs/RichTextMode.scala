...
object RichTextMode extends js.Object {
  ...
  /* 0 */ val Compatible: typings.sharepoint.SPClientTemplatesNs.RichTextMode.Compatible with Double = js.native
  /* 1 */ val FullHtml: typings.sharepoint.SPClientTemplatesNs.RichTextMode.FullHtml with Double = js.native
  /* 2 */ val HtmlAsXml: typings.sharepoint.SPClientTemplatesNs.RichTextMode.HtmlAsXml with Double = js.native
  /* 3 */ val ThemeHtml: typings.sharepoint.SPClientTemplatesNs.RichTextMode.ThemeHtml with Double = js.native
  @JSBracketAccess
