...
object ChoiceFormatType extends js.Object {
  ...
  /* 0 */ val Dropdown: typings.sharepoint.SPClientTemplatesNs.ChoiceFormatType.Dropdown with Double = js.native
  /* 1 */ val Radio: typings.sharepoint.SPClientTemplatesNs.ChoiceFormatType.Radio with Double = js.native
  @JSBracketAccess
