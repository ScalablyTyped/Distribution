...
object RenderContext_GroupInView {
  ...
  def apply(
    ...
    RenderBody: RenderContext_GroupInView => String = null,
    RenderFieldByName: (RenderContext_GroupInView, /* fieldName */ String) => String = null,
    RenderFields: RenderContext_GroupInView => String = null,
    RenderFooter: RenderContext_GroupInView => String = null,
    RenderGroups: RenderContext_GroupInView => String = null,
    RenderHeader: RenderContext_GroupInView => String = null,
    RenderItems: RenderContext_GroupInView => String = null,
    RenderView: RenderContext_GroupInView => String = null,
