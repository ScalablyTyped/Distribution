...
@JSGlobalScope
@js.native
object sharepointLibMembers extends js.Object {
  ...
  var _spFriendlyUrlPageContextInfo: _spFriendlyUrlPageContextInfo = js.native
  var _spPageContextInfo: _spPageContextInfo = js.native
