...
class SPMgr () extends js.Object {
  def NewGroup(listItem: ScalablyTyped.runtime.StringDictionary[js.Any], fieldName: java.lang.String): scala.Boolean = js.native
  def RenderField(
    renderCtx: sharepointLib.SPClientTemplatesNs.RenderContext,
    field: sharepointLib.SPClientTemplatesNs.FieldSchema,
    listItem: ScalablyTyped.runtime.StringDictionary[js.Any],
