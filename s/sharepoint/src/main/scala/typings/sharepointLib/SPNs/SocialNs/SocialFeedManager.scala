...
class SocialFeedManager protected ()
  ...
  def createImageAttachment(name: java.lang.String, description: java.lang.String, imageData: js.Any): SocialAttachment = js.native
  ...
  def createPost(targetId: java.lang.String, creationData: SocialPostCreationData): SocialThread = js.native
  ...
  def deletePost(postId: java.lang.String): SocialThread = js.native
  /** Returns the set of users who have liked the specified post.
    ...
    Corresponds the value returned from SocialPost.get_id().*/
  def getAllLikers(postId: java.lang.String): js.Array[SocialActor] = js.native
  ...
  def getFeedFor(actorId: java.lang.String, options: SocialFeedOptions): SocialFeed = js.native
  /** Returns the root post and all reply posts in the thread. */
  def getFullThread(threadId: java.lang.String): SocialThread = js.native
  /** Returns a feed containing mention reference threads from the current user's personal feed. */
  def getMentions(clearUnreadMentions: scala.Boolean, options: SocialFeedOptions): SocialFeed = js.native
  /** Generates a preview for the content specified by the URL. */
  def getPreview(itemUrl: java.lang.String): SocialAttachment = js.native
  ...
  def getPreviewImage(url: java.lang.String, key: java.lang.String, iv: java.lang.String): js.Any = js.native
  ...
  def getUnreadMentionCount(): sharepointLib.SPNs.IntResult = js.native
  /** Returns the current user */
  def get_owner(): SocialActor = js.native
  /** Specifies the URI of the personal site portal. */
  def get_personalSitePortalUri(): java.lang.String = js.native
  ...
  def likePost(postId: java.lang.String): SocialThread = js.native
  ...
  def lockThread(threadId: java.lang.String): SocialThread = js.native
  /** Suppresses activity notifications for the current user of updates to the specified thread. */
  def suppressThreadNotifications(threadId: java.lang.String): scala.Unit = js.native
  /** Specifies that the current user does not like the specified post.
    Returns a digest thread containing the specified post.  */
  def unlikePost(postId: java.lang.String): SocialThread = js.native
  /** Allows users to add new reply posts to the specified thread. */
  def unlockThread(threadId: java.lang.String): SocialThread = js.native
}
