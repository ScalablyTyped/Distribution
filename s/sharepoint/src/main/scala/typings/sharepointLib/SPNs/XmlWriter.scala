...
class XmlWriter () extends js.Object {
  ...
  def writeAttributeString(localName: java.lang.String, value: java.lang.String): scala.Unit = js.native
  /** Appends an element with the specified tag name and value in XML format to the string builder. */
  def writeElementString(tagName: java.lang.String, value: java.lang.String): scala.Unit = js.native
  /** Appends an end of an attribute in XML format to the object?s string builder. */
  def writeEndAttribute(): scala.Unit = js.native
  ...
  def writeEndElement(): scala.Unit = js.native
  /** Appends the specified text to the object?s string builder. */
  def writeRaw(xml: java.lang.String): scala.Unit = js.native
  ...
  def writeStartAttribute(localName: java.lang.String): scala.Unit = js.native
  /** Appends a start element tag with the specified name in XML format to the object?s string builder. */
  def writeStartElement(tagName: java.lang.String): scala.Unit = js.native
...
object XmlWriter extends js.Object {
  ...
  def create(sb: microsoftDashAjaxLib.SysNs.StringBuilder): sharepointLib.SPNs.XmlWriter = js.native
}
