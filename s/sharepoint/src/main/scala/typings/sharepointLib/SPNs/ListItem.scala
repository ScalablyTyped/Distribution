...
class ListItem[T] () extends SecurableObject {
  ...
  def getWOPIFrameUrl(action: sharepointLib.SPNs.UtilitiesNs.SPWOPIFrameAction): StringResult = js.native
  ...
  def parseAndSetFieldValue(fieldInternalName: java.lang.String, value: java.lang.String): scala.Unit = js.native
  ...
  def validateUpdateListItem(formValues: js.Array[ListItemFormUpdateValue], bNewDocumentUpdate: scala.Boolean): js.Array[ListItemFormUpdateValue] = js.native
}
