...
trait Transaction extends js.Object {
  ...
  def abort(options: stompitLib.libClientMod.ClientNs.SendOptions): scala.Unit = js.native
  def commit(): scala.Unit = js.native
  def commit(options: stompitLib.libClientMod.ClientNs.SendOptions): scala.Unit = js.native
