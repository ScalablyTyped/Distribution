...
trait ConnectFailoverOptions extends js.Object {
  ...
  var connectFunction: js.UndefOr[
    js.Function2[
      /* options */ stompitLib.libConnectMod.ConnectOptions, 
...
object ConnectFailoverOptions {
  @scala.inline
  def apply(
    connectFunction: (/* options */ stompitLib.libConnectMod.ConnectOptions, /* connectionListener */ js.UndefOr[
      js.Function2[
        /* err */ stdLib.Error | scala.Null, 
        /* client */ stompitLib.libClientMod.^, 
        scala.Unit
      ]
    ]) => stompitLib.libClientMod.^ = null,
