...
trait ConnectFailover
  ...
  def addServer(config: stompitLib.libConnectMod.ConnectOptions): scala.Unit = js.native
  def connect(
  ...
  def on_connect(
    ...
    listener: js.Function1[/* server */ ConnectState, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_connecting(
  ...
  def on_error(
    ...
    listener: js.Function2[/* err */ ConnectError, /* server */ ConnectState, scala.Unit]
  ): this.type = js.native
}
