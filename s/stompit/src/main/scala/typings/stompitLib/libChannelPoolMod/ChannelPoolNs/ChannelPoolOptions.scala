package typings
package stompitLib.libChannelPoolMod.ChannelPoolNs
...
trait ChannelPoolOptions extends js.Object {
  var channelOptions: js.UndefOr[stompitLib.libChannelMod.ChannelNs.ChannelOptions] = js.undefined
...
object ChannelPoolOptions {
  @scala.inline
  def apply(
    channelOptions: stompitLib.libChannelMod.ChannelNs.ChannelOptions = null,
