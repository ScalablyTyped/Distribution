...
object libChannelPoolMod {
  ...
  open class ^ protected ()
    ...
    override def channel(
      callback: js.Function2[/* err */ js.Error | Null, /* channel */ typings.stompit.libChannelMod.^, Unit]
    ): Unit = js.native
  ...
  object ChannelPool {
    ...
    inline def apply(
      channel: js.Function2[/* err */ js.Error | Null, /* channel */ typings.stompit.libChannelMod.^, Unit] => Unit,
      close: () => Unit
    ): ChannelPool = {
