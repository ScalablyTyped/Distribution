...
object ^ extends js.Object {
  ...
  @JSName("default")
  var default_Original: atSindresorhusDfLib.Anon_Default = js.native
  /**
  ...
  /**
  	 ...
  	 */
  def file(path: java.lang.String): js.Promise[SpaceInfo] = js.native
  /**
  	 * @param path - Path to a filesystem device file. Example: `'/dev/disk1'`.
  	 * @returns Space info for the given filesystem.
  	 */
  def fs(path: java.lang.String): js.Promise[SpaceInfo] = js.native
}
