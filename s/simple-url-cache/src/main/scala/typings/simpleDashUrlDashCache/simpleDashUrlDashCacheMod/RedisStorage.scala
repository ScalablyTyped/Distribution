...
import typings.simpleDashUrlDashCache.simpleDashUrlDashCacheMod.privateN.CacheCategory
import typings.simpleDashUrlDashCache.simpleDashUrlDashCacheMod.privateN.CacheStorage
