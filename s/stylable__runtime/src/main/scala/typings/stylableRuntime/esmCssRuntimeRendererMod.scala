...
import typings.stylableRuntime.esmTypesMod.RenderableStylesheet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esmCssRuntimeRendererMod {
  
  @JSImport("@stylable/runtime/esm/css-runtime-renderer", "RuntimeRenderer")
  @js.native
  ...
  @JSImport("@stylable/runtime/esm/css-runtime-renderer", "$")
  @js.native
