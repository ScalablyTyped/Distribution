...
object distMod {
  ...
  open class RuntimeRenderer ()
    extends typings.stylableRuntime.distCssRuntimeRendererMod.RuntimeRenderer
  
  @JSImport("@stylable/runtime/dist", "$")
  @js.native
  val _empty: typings.stylableRuntime.distCssRuntimeRendererMod.RuntimeRenderer = js.native
  ...
  inline def create(
    ...
    depth: Double,
    id: String,
    renderer: typings.stylableRuntime.distCssRuntimeRendererMod.RuntimeRenderer
