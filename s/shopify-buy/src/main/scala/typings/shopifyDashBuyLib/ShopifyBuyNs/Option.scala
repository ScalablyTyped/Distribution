...
object Option {
  @scala.inline
  def apply(name: java.lang.String, selected: java.lang.String, values: js.Array[OptionValue]): Option = {
    val __obj = js.Dynamic.literal(name = name, selected = selected, values = values)
