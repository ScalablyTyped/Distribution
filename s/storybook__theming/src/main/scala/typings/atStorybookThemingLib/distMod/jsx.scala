...
@JSImport("@storybook/theming/dist", "jsx")
@js.native
object jsx extends js.Object {
  def apply(`type`: atStorybookThemingLib.atStorybookThemingLibStrings.input): reactLib.reactMod.DetailedReactHTMLElement[
    reactLib.reactMod.InputHTMLAttributes[reactLib.HTMLInputElement], 
    reactLib.HTMLInputElement
  ] = js.native
  def apply(
    `type`: atStorybookThemingLib.atStorybookThemingLibStrings.input,
