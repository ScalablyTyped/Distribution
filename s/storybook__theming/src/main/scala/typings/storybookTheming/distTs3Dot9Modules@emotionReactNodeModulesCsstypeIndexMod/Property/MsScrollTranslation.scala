...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`vertical-to-horizontal`
...
object MsScrollTranslation {
  ...
  inline def `vertical-to-horizontal`: typings.storybookTheming.storybookThemingStrings.`vertical-to-horizontal` = "vertical-to-horizontal".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`vertical-to-horizontal`]
}
