...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.justify
...
*/
trait BoxPack extends StObject
object BoxPack {
  ...
  inline def justify: typings.storybookTheming.storybookThemingStrings.justify = "justify".asInstanceOf[typings.storybookTheming.storybookThemingStrings.justify]
