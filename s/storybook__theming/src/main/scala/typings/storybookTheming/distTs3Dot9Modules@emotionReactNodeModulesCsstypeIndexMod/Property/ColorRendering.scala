...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.optimizeQuality
...
*/
trait ColorRendering extends StObject
object ColorRendering {
  ...
  inline def optimizeQuality: typings.storybookTheming.storybookThemingStrings.optimizeQuality = "optimizeQuality".asInstanceOf[typings.storybookTheming.storybookThemingStrings.optimizeQuality]
