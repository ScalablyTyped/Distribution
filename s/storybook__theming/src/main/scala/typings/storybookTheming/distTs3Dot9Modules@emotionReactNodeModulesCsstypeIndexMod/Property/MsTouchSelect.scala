...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.grippers
...
object MsTouchSelect {
  ...
  inline def grippers: typings.storybookTheming.storybookThemingStrings.grippers = "grippers".asInstanceOf[typings.storybookTheming.storybookThemingStrings.grippers]
