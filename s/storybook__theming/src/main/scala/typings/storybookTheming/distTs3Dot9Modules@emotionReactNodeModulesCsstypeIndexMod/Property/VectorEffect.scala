...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.`non-scaling-stroke`
...
object VectorEffect {
  ...
  inline def `non-scaling-stroke`: typings.storybookTheming.storybookThemingStrings.`non-scaling-stroke` = "non-scaling-stroke".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`non-scaling-stroke`]
