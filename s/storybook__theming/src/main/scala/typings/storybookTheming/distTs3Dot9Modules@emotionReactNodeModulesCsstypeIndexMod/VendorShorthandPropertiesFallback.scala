...
trait VendorShorthandPropertiesFallback[TLength, TTime] extends StObject {
  ...
  var WebkitBorderBefore: js.UndefOr[
    typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitBorderBefore[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[
          typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitBorderBefore[TLength]
        ]
      ]
    ])
  ] = js.undefined
  ...
  var WebkitMask: js.UndefOr[
    typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitMask[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[
          typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitMask[TLength]
        ]
      ]
    ])
  ] = js.undefined
  ...
  var WebkitTextStroke: js.UndefOr[
    typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitTextStroke[TLength] | (js.Array[
      NonNullable[
        js.UndefOr[
          typings.storybookTheming.`distTs3Dot9Modules@emotionReactNodeModulesCsstypeIndexMod`.Property.WebkitTextStroke[TLength]
        ]
      ]
    ])
  ] = js.undefined
...
object VendorShorthandPropertiesFallback {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: VendorShorthandPropertiesFallback[?, ?], TLength, TTime] (val x: Self & (VendorShorthandPropertiesFallback[TLength, TTime])) extends AnyVal {
