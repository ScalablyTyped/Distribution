...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.bevel
  - typings.storybookTheming.storybookThemingStrings.miter
...
object StrokeLinejoin {
  ...
  inline def bevel: typings.storybookTheming.storybookThemingStrings.bevel = "bevel".asInstanceOf[typings.storybookTheming.storybookThemingStrings.bevel]
  ...
  inline def miter: typings.storybookTheming.storybookThemingStrings.miter = "miter".asInstanceOf[typings.storybookTheming.storybookThemingStrings.miter]
