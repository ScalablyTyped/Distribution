...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.anywhere
...
object OverflowWrap {
  ...
  inline def anywhere: typings.storybookTheming.storybookThemingStrings.anywhere = "anywhere".asInstanceOf[typings.storybookTheming.storybookThemingStrings.anywhere]
