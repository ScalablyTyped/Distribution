...
object PropertiesHyphenFallback {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropertiesHyphenFallback[?, ?], TLength, TTime] (val x: Self & (PropertiesHyphenFallback[TLength, TTime])) extends AnyVal {
