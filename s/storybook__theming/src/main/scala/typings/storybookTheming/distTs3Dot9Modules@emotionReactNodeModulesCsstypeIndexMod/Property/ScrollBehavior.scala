...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.smooth
...
object ScrollBehavior {
  ...
  inline def smooth: typings.storybookTheming.storybookThemingStrings.smooth = "smooth".asInstanceOf[typings.storybookTheming.storybookThemingStrings.smooth]
