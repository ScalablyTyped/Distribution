...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.after
...
*/
trait MsImeAlign extends StObject
object MsImeAlign {
  ...
  inline def after: typings.storybookTheming.storybookThemingStrings.after = "after".asInstanceOf[typings.storybookTheming.storybookThemingStrings.after]
