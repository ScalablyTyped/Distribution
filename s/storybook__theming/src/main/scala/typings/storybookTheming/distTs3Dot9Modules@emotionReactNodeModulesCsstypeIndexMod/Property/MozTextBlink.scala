...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.blink
...
*/
trait MozTextBlink extends StObject
object MozTextBlink {
  ...
  inline def blink: typings.storybookTheming.storybookThemingStrings.blink = "blink".asInstanceOf[typings.storybookTheming.storybookThemingStrings.blink]
