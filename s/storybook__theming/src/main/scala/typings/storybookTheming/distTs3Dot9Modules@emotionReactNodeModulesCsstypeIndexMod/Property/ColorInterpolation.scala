...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.linearRGB
  - typings.storybookTheming.storybookThemingStrings.sRGB
...
object ColorInterpolation {
  ...
  inline def linearRGB: typings.storybookTheming.storybookThemingStrings.linearRGB = "linearRGB".asInstanceOf[typings.storybookTheming.storybookThemingStrings.linearRGB]
  ...
  inline def sRGB: typings.storybookTheming.storybookThemingStrings.sRGB = "sRGB".asInstanceOf[typings.storybookTheming.storybookThemingStrings.sRGB]
