...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.drag
  - typings.storybookTheming.storybookThemingStrings.`no-drag`
...
object MozWindowDragging {
  ...
  inline def drag: typings.storybookTheming.storybookThemingStrings.drag = "drag".asInstanceOf[typings.storybookTheming.storybookThemingStrings.drag]
  ...
  inline def `no-drag`: typings.storybookTheming.storybookThemingStrings.`no-drag` = "no-drag".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`no-drag`]
