...
import typings.storybookTheming.storybookThemingStrings.`lazy`
...
import typings.storybookTheming.storybookThemingStrings.async
...
import typings.storybookTheming.storybookThemingStrings.eager
...
import typings.storybookTheming.storybookThemingStrings.sync
...
/* Inlined react.react.DetailedHTMLProps<react.react.ImgHTMLAttributes<std.HTMLImageElement>, std.HTMLImageElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
...
object DetailedHTMLPropsImgHTMLA {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsImgHTMLA] (val x: Self) extends AnyVal {
