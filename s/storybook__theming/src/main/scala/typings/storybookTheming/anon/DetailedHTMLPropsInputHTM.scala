...
import typings.storybookTheming.storybookThemingStrings.done
import typings.storybookTheming.storybookThemingStrings.email
import typings.storybookTheming.storybookThemingStrings.enter
import typings.storybookTheming.storybookThemingStrings.environment
import typings.storybookTheming.storybookThemingStrings.execute
import typings.storybookTheming.storybookThemingStrings.go
...
import typings.storybookTheming.storybookThemingStrings.next
...
import typings.storybookTheming.storybookThemingStrings.previous
...
import typings.storybookTheming.storybookThemingStrings.send
...
import typings.storybookTheming.storybookThemingStrings.user
...
/* Inlined react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLInputElement>, std.HTMLInputElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
trait DetailedHTMLPropsInputHTM extends StObject {
...
object DetailedHTMLPropsInputHTM {
  
  inline def apply(): DetailedHTMLPropsInputHTM = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsInputHTM]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsInputHTM] (val x: Self) extends AnyVal {
