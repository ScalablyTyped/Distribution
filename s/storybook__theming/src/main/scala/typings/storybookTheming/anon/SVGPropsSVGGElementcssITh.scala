...
/* Inlined react.react.SVGProps<std.SVGGElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
trait SVGPropsSVGGElementcssITh extends StObject {
...
object SVGPropsSVGGElementcssITh {
  
  inline def apply(): SVGPropsSVGGElementcssITh = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGPropsSVGGElementcssITh]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGPropsSVGGElementcssITh] (val x: Self) extends AnyVal {
