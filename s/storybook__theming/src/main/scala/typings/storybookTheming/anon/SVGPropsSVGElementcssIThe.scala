...
/* Inlined react.react.SVGProps<std.SVGElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
trait SVGPropsSVGElementcssIThe extends StObject {
...
object SVGPropsSVGElementcssIThe {
  
  inline def apply(): SVGPropsSVGElementcssIThe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGPropsSVGElementcssIThe]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGPropsSVGElementcssIThe] (val x: Self) extends AnyVal {
    ...
    inline def setRefFunction1(value: /* instance */ SVGElement | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
