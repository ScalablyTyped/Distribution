...
/* Inlined react.react.SVGProps<std.SVGFEMorphologyElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
