...
/* Inlined react.react.DetailedHTMLProps<react.react.ThHTMLAttributes<std.HTMLTableHeaderCellElement>, std.HTMLTableHeaderCellElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
