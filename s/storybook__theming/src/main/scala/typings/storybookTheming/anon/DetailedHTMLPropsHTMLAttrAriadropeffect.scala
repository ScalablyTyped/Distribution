...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLUListElement>, std.HTMLUListElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
