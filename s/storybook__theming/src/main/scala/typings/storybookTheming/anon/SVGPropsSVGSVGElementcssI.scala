...
/* Inlined react.react.SVGProps<std.SVGSVGElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
trait SVGPropsSVGSVGElementcssI extends StObject {
...
object SVGPropsSVGSVGElementcssI {
  
  inline def apply(): SVGPropsSVGSVGElementcssI = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGPropsSVGSVGElementcssI]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGPropsSVGSVGElementcssI] (val x: Self) extends AnyVal {
