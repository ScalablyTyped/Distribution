...
import typings.storybookTheming.storybookThemingStrings.reset
...
import typings.storybookTheming.storybookThemingStrings.submit
...
/* Inlined react.react.DetailedHTMLProps<react.react.ButtonHTMLAttributes<std.HTMLButtonElement>, std.HTMLButtonElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
...
object DetailedHTMLPropsButtonHT {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsButtonHT] (val x: Self) extends AnyVal {
