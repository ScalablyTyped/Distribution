...
/* Inlined react.react.DetailedHTMLProps<react.react.KeygenHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
