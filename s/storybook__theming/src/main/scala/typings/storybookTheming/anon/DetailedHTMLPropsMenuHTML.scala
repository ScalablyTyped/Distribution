...
/* Inlined react.react.DetailedHTMLProps<react.react.MenuHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
trait DetailedHTMLPropsMenuHTML extends StObject {
...
object DetailedHTMLPropsMenuHTML {
  
  inline def apply(): DetailedHTMLPropsMenuHTML = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsMenuHTML]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsMenuHTML] (val x: Self) extends AnyVal {
