...
/* Inlined react.react.SVGProps<std.SVGPathElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
...
object SVGPropsSVGPathElementcss {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGPropsSVGPathElementcss] (val x: Self) extends AnyVal {
