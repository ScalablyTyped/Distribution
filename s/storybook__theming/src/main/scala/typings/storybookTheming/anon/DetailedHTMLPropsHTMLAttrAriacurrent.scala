...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLSpanElement>, std.HTMLSpanElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
trait DetailedHTMLPropsHTMLAttrAriacurrent extends StObject {
...
object DetailedHTMLPropsHTMLAttrAriacurrent {
  
  inline def apply(): DetailedHTMLPropsHTMLAttrAriacurrent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsHTMLAttrAriacurrent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAriacurrent] (val x: Self) extends AnyVal {
