...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
...
object DetailedHTMLPropsHTMLAttrAbout {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAbout] (val x: Self) extends AnyVal {
