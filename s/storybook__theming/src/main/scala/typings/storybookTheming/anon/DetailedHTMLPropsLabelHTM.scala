...
/* Inlined react.react.DetailedHTMLProps<react.react.LabelHTMLAttributes<std.HTMLLabelElement>, std.HTMLLabelElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
...
object DetailedHTMLPropsLabelHTM {
  ...
  extension [Self <: DetailedHTMLPropsLabelHTM](x: Self) {
