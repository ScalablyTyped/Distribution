...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLDivElement>, std.HTMLDivElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
...
object DetailedHTMLPropsHTMLAttrAriaatomic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetailedHTMLPropsHTMLAttrAriaatomic] (val x: Self) extends AnyVal {
