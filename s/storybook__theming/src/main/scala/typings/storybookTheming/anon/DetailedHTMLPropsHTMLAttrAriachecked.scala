...
/* Inlined react.react.DetailedHTMLProps<react.react.HTMLAttributes<std.HTMLHeadingElement>, std.HTMLHeadingElement> & {  css :@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.I<@storybook/theming.@storybook/theming.Theme> | undefined} */
