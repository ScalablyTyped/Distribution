...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.`break-word`
...
object WordWrap {
  ...
  inline def `break-word`: typings.storybookTheming.storybookThemingStrings.`break-word` = "break-word".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`break-word`]
