...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.mandatory
  - typings.storybookTheming.storybookThemingStrings.none
  - typings.storybookTheming.storybookThemingStrings.proximity
...
*/
trait MsContentZoomSnapType extends StObject
object MsContentZoomSnapType {
  ...
  inline def mandatory: typings.storybookTheming.storybookThemingStrings.mandatory = "mandatory".asInstanceOf[typings.storybookTheming.storybookThemingStrings.mandatory]
  ...
  inline def proximity: typings.storybookTheming.storybookThemingStrings.proximity = "proximity".asInstanceOf[typings.storybookTheming.storybookThemingStrings.proximity]
