...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.touch
...
object WebkitOverflowScrolling {
  ...
  inline def touch: typings.storybookTheming.storybookThemingStrings.touch = "touch".asInstanceOf[typings.storybookTheming.storybookThemingStrings.touch]
