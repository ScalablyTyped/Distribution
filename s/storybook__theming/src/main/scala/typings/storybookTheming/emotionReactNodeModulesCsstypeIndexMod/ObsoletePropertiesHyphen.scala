...
trait ObsoletePropertiesHyphen[TLength, TTime] extends StObject {
  ...
  /**
    ...
    * @deprecated
    */
  var `-ms-scrollbar-track-color`: js.UndefOr[MsScrollbarTrackColor] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var `scrollbar-track-color`: js.UndefOr[MsScrollbarTrackColor] = js.undefined
}
object ObsoletePropertiesHyphen {
  ...
  extension [Self <: ObsoletePropertiesHyphen[?, ?], TLength, TTime](x: Self & (ObsoletePropertiesHyphen[TLength, TTime])) {
    ...
    inline def `set-ms-scrollbar-track-color`(value: MsScrollbarTrackColor): Self = StObject.set(x, "-ms-scrollbar-track-color", value.asInstanceOf[js.Any])
    ...
    inline def `setScrollbar-track-color`(value: MsScrollbarTrackColor): Self = StObject.set(x, "scrollbar-track-color", value.asInstanceOf[js.Any])
