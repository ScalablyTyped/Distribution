...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.optimizeLegibility
...
object TextRendering {
  ...
  inline def optimizeLegibility: typings.storybookTheming.storybookThemingStrings.optimizeLegibility = "optimizeLegibility".asInstanceOf[typings.storybookTheming.storybookThemingStrings.optimizeLegibility]
