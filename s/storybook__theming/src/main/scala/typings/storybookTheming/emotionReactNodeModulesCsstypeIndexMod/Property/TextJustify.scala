...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`inter-word`
...
object TextJustify {
  ...
  inline def `inter-character`: typings.storybookTheming.storybookThemingStrings.`inter-character` = "inter-character".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`inter-character`]
  
  inline def `inter-word`: typings.storybookTheming.storybookThemingStrings.`inter-word` = "inter-word".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`inter-word`]
