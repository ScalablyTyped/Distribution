...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.flat
  - typings.storybookTheming.storybookThemingStrings.`preserve-3d`
...
object TransformStyle {
  ...
  inline def flat: typings.storybookTheming.storybookThemingStrings.flat = "flat".asInstanceOf[typings.storybookTheming.storybookThemingStrings.flat]
  ...
  inline def `preserve-3d`: typings.storybookTheming.storybookThemingStrings.`preserve-3d` = "preserve-3d".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`preserve-3d`]
