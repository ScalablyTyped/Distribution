...
import typings.storybookTheming.storybookThemingStrings.scrollbar_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.`-ms-autohiding-scrollbar`
  - typings.storybookTheming.storybookThemingStrings.auto
  - typings.storybookTheming.storybookThemingStrings.none
  - typings.storybookTheming.storybookThemingStrings.scrollbar_
...
object MsOverflowStyle {
  ...
  inline def `-ms-autohiding-scrollbar`: typings.storybookTheming.storybookThemingStrings.`-ms-autohiding-scrollbar` = "-ms-autohiding-scrollbar".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`-ms-autohiding-scrollbar`]
