...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.balance
  - typings.storybookTheming.storybookThemingStrings.`balance-all`
...
object ColumnFill {
  ...
  inline def balance: typings.storybookTheming.storybookThemingStrings.balance = "balance".asInstanceOf[typings.storybookTheming.storybookThemingStrings.balance]
  
  inline def `balance-all`: typings.storybookTheming.storybookThemingStrings.`balance-all` = "balance-all".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`balance-all`]
