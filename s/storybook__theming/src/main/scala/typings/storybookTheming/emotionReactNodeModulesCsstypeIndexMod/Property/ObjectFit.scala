...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`scale-down`
...
object ObjectFit {
  ...
  inline def cover: typings.storybookTheming.storybookThemingStrings.cover = "cover".asInstanceOf[typings.storybookTheming.storybookThemingStrings.cover]
  ...
  inline def `scale-down`: typings.storybookTheming.storybookThemingStrings.`scale-down` = "scale-down".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`scale-down`]
