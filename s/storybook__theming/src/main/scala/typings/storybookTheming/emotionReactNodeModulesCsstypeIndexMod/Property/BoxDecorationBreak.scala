...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.clone
  - typings.storybookTheming.storybookThemingStrings.slice
...
*/
trait BoxDecorationBreak extends StObject
object BoxDecorationBreak {
  ...
  inline def slice: typings.storybookTheming.storybookThemingStrings.slice = "slice".asInstanceOf[typings.storybookTheming.storybookThemingStrings.slice]
