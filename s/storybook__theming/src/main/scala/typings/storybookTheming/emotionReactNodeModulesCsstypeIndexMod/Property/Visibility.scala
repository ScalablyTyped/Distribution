...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.collapse
...
object Visibility {
  ...
  inline def collapse: typings.storybookTheming.storybookThemingStrings.collapse = "collapse".asInstanceOf[typings.storybookTheming.storybookThemingStrings.collapse]
