...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.separate
...
object BorderCollapse {
  ...
  inline def separate: typings.storybookTheming.storybookThemingStrings.separate = "separate".asInstanceOf[typings.storybookTheming.storybookThemingStrings.separate]
