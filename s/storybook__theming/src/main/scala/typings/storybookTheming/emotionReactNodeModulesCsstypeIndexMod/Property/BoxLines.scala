...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.single
...
object BoxLines {
  ...
  inline def single: typings.storybookTheming.storybookThemingStrings.single = "single".asInstanceOf[typings.storybookTheming.storybookThemingStrings.single]
