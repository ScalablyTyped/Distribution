...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.maximum
...
object MsWrapFlow {
  ...
  inline def maximum: typings.storybookTheming.storybookThemingStrings.maximum = "maximum".asInstanceOf[typings.storybookTheming.storybookThemingStrings.maximum]
