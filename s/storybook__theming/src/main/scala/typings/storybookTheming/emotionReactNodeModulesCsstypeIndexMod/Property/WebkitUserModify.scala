...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`read-write-plaintext-only`
...
object WebkitUserModify {
  ...
  inline def `read-write-plaintext-only`: typings.storybookTheming.storybookThemingStrings.`read-write-plaintext-only` = "read-write-plaintext-only".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`read-write-plaintext-only`]
