...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.chained
...
*/
trait MsContentZoomChaining extends StObject
object MsContentZoomChaining {
  ...
  inline def chained: typings.storybookTheming.storybookThemingStrings.chained = "chained".asInstanceOf[typings.storybookTheming.storybookThemingStrings.chained]
