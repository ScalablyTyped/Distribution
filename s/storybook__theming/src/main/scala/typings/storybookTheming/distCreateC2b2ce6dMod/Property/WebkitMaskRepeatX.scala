...
object WebkitMaskRepeatX {
  ...
  inline def `no-repeat`: typings.storybookTheming.storybookThemingStrings.`no-repeat` = "no-repeat".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`no-repeat`]
  
  inline def repeat: typings.storybookTheming.storybookThemingStrings.repeat = "repeat".asInstanceOf[typings.storybookTheming.storybookThemingStrings.repeat]
  ...
  inline def round: typings.storybookTheming.storybookThemingStrings.round = "round".asInstanceOf[typings.storybookTheming.storybookThemingStrings.round]
  
  inline def space: typings.storybookTheming.storybookThemingStrings.space = "space".asInstanceOf[typings.storybookTheming.storybookThemingStrings.space]
