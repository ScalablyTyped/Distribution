...
trait StandardLonghandProperties[TLength, TTime] extends StObject {
  ...
  /**
    ...
    */
  var color: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.Color] = js.undefined
...
object StandardLonghandProperties {
  ...
  implicit open class MutableBuilder[Self <: StandardLonghandProperties[?, ?], TLength, TTime] (val x: Self & (StandardLonghandProperties[TLength, TTime])) extends AnyVal {
    ...
    inline def setColor(value: typings.storybookTheming.distCreateC2b2ce6dMod.Property.Color): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
