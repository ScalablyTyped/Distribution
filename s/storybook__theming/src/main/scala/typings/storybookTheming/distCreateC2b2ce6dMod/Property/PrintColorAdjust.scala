...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.economy
  - typings.storybookTheming.storybookThemingStrings.exact
...
object PrintColorAdjust {
  ...
  inline def economy: typings.storybookTheming.storybookThemingStrings.economy = "economy".asInstanceOf[typings.storybookTheming.storybookThemingStrings.economy]
  
  inline def exact: typings.storybookTheming.storybookThemingStrings.exact = "exact".asInstanceOf[typings.storybookTheming.storybookThemingStrings.exact]
