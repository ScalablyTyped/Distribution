...
trait VendorShorthandProperties[TLength, TTime] extends StObject {
  ...
  /**
    ...
    */
  var MozAnimation: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]] = js.undefined
  ...
  /**
    ...
    * **Syntax**: `<single-animation>#`
    */
  var WebkitAnimation: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]] = js.undefined
  ...
  var WebkitBorderBefore: js.UndefOr[
    typings.storybookTheming.distCreateC2b2ce6dMod.Property.WebkitBorderBefore[TLength]
  ] = js.undefined
  ...
  /**
    ...
    */
  var WebkitMask: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.WebkitMask[TLength]] = js.undefined
  ...
  var WebkitTextStroke: js.UndefOr[
    typings.storybookTheming.distCreateC2b2ce6dMod.Property.WebkitTextStroke[TLength]
  ] = js.undefined
...
object VendorShorthandProperties {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: VendorShorthandProperties[?, ?], TLength, TTime] (val x: Self & (VendorShorthandProperties[TLength, TTime])) extends AnyVal {
    
    inline def setMozAnimation(value: typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]): Self = StObject.set(x, "MozAnimation", value.asInstanceOf[js.Any])
    ...
    inline def setWebkitAnimation(value: typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]): Self = StObject.set(x, "WebkitAnimation", value.asInstanceOf[js.Any])
