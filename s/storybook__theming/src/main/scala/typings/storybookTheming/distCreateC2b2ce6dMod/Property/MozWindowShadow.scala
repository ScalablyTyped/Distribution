...
object MozWindowShadow {
  ...
  inline def default: typings.storybookTheming.storybookThemingStrings.default = "default".asInstanceOf[typings.storybookTheming.storybookThemingStrings.default]
