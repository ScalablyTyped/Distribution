...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.loose
...
object LineBreak {
  ...
  inline def loose: typings.storybookTheming.storybookThemingStrings.loose = "loose".asInstanceOf[typings.storybookTheming.storybookThemingStrings.loose]
  ...
  inline def strict: typings.storybookTheming.storybookThemingStrings.strict = "strict".asInstanceOf[typings.storybookTheming.storybookThemingStrings.strict]
