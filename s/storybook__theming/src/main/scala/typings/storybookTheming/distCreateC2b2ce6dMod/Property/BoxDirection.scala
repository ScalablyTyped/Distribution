...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.reverse
...
object BoxDirection {
  ...
  inline def reverse: typings.storybookTheming.storybookThemingStrings.reverse = "reverse".asInstanceOf[typings.storybookTheming.storybookThemingStrings.reverse]
