...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.`break-all`
  - typings.storybookTheming.storybookThemingStrings.`break-word`
  - typings.storybookTheming.storybookThemingStrings.`keep-all`
...
object WordBreak {
  ...
  inline def `break-all`: typings.storybookTheming.storybookThemingStrings.`break-all` = "break-all".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`break-all`]
  ...
  inline def `keep-all`: typings.storybookTheming.storybookThemingStrings.`keep-all` = "keep-all".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`keep-all`]
