...
trait ThemeVars extends StObject {
  ...
  var booleanBg: js.UndefOr[String] = js.undefined
  
  var booleanSelectedBg: js.UndefOr[String] = js.undefined
  
  var brandImage: js.UndefOr[String] = js.undefined
  
  var brandTarget: js.UndefOr[String] = js.undefined
  
  var brandTitle: js.UndefOr[String] = js.undefined
  
  var brandUrl: js.UndefOr[String] = js.undefined
  
  var buttonBg: js.UndefOr[String] = js.undefined
...
object ThemeVars {
  ...
  implicit open class MutableBuilder[Self <: ThemeVars] (val x: Self) extends AnyVal {
    ...
    inline def setBooleanBg(value: String): Self = StObject.set(x, "booleanBg", value.asInstanceOf[js.Any])
    
    inline def setBooleanBgUndefined: Self = StObject.set(x, "booleanBg", js.undefined)
    
    inline def setBooleanSelectedBg(value: String): Self = StObject.set(x, "booleanSelectedBg", value.asInstanceOf[js.Any])
    
    inline def setBooleanSelectedBgUndefined: Self = StObject.set(x, "booleanSelectedBg", js.undefined)
    ...
    inline def setBrandTarget(value: String): Self = StObject.set(x, "brandTarget", value.asInstanceOf[js.Any])
    
    inline def setBrandTargetUndefined: Self = StObject.set(x, "brandTarget", js.undefined)
    ...
    inline def setButtonBg(value: String): Self = StObject.set(x, "buttonBg", value.asInstanceOf[js.Any])
    
    inline def setButtonBgUndefined: Self = StObject.set(x, "buttonBg", js.undefined)
