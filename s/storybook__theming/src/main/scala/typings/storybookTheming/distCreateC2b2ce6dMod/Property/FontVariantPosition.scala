...
object FontVariantPosition {
  ...
  inline def sub: typings.storybookTheming.storybookThemingStrings.sub = "sub".asInstanceOf[typings.storybookTheming.storybookThemingStrings.sub]
  
  inline def `super`: typings.storybookTheming.storybookThemingStrings.`super` = "super".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`super`]
