...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.railed
...
object MsScrollRails {
  ...
  inline def railed: typings.storybookTheming.storybookThemingStrings.railed = "railed".asInstanceOf[typings.storybookTheming.storybookThemingStrings.railed]
