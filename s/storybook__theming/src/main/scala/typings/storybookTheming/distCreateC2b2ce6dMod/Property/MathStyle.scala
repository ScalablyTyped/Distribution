...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.compact
...
*/
trait MathStyle extends StObject
object MathStyle {
  ...
  inline def compact: typings.storybookTheming.storybookThemingStrings.compact = "compact".asInstanceOf[typings.storybookTheming.storybookThemingStrings.compact]
