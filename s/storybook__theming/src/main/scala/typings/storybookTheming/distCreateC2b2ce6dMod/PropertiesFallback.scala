...
- typings.storybookTheming.distCreateC2b2ce6dMod.SvgPropertiesFallback because var conflicts: clip, clipPath, color, cursor, direction, display, filter, font, fontFamily, fontSize, fontSizeAdjust, fontStretch, fontStyle, fontVariant, fontWeight, imageRendering, letterSpacing, lineHeight, mask, opacity, overflow, paintOrder, pointerEvents, textDecoration, textRendering, unicodeBidi, visibility, whiteSpace, wordSpacing, writingMode. Inlined floodOpacity, fillOpacity, shapeRendering, vectorEffect, strokeMiterlimit, fill, clipRule, lightingColor, baselineShift, strokeLinecap, alignmentBaseline, textAnchor, strokeOpacity, glyphOrientationVertical, strokeWidth, strokeLinejoin, strokeDashoffset, dominantBaseline, colorInterpolation, markerEnd, stopOpacity, stroke, fillRule, stopColor, colorRendering, markerMid, floodColor, marker, strokeDasharray, markerStart */ trait PropertiesFallback[TLength, TTime]
  extends StObject
     with StandardPropertiesFallback[TLength, TTime]
     with VendorPropertiesFallback[TLength, TTime]
...
object PropertiesFallback {
  ...
  inline def apply[TLength, TTime](): PropertiesFallback[TLength, TTime] = {
