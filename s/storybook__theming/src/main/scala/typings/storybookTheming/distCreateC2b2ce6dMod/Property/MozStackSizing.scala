...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`stretch-to-fit`
...
object MozStackSizing {
  ...
  inline def `stretch-to-fit`: typings.storybookTheming.storybookThemingStrings.`stretch-to-fit` = "stretch-to-fit".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`stretch-to-fit`]
