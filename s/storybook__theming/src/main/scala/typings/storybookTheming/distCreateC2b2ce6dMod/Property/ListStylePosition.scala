...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.inside
  - typings.storybookTheming.storybookThemingStrings.outside
...
*/
trait ListStylePosition extends StObject
object ListStylePosition {
  ...
  inline def inside: typings.storybookTheming.storybookThemingStrings.inside = "inside".asInstanceOf[typings.storybookTheming.storybookThemingStrings.inside]
  
  inline def outside: typings.storybookTheming.storybookThemingStrings.outside = "outside".asInstanceOf[typings.storybookTheming.storybookThemingStrings.outside]
