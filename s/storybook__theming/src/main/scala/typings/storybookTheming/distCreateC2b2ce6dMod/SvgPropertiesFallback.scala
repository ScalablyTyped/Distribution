...
/* Inlined @storybook/theming.@storybook/theming/dist/create-c2b2ce6d.Fallback<@storybook/theming.@storybook/theming/dist/create-c2b2ce6d.SvgProperties<TLength, TTime>> */
...
object SvgPropertiesFallback {
  ...
  implicit open class MutableBuilder[Self <: SvgPropertiesFallback[?, ?], TLength, TTime] (val x: Self & (SvgPropertiesFallback[TLength, TTime])) extends AnyVal {
    ...
    inline def setColorVarargs(value: NonNullable[js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.Color]]*): Self = StObject.set(x, "color", js.Array(value*))
