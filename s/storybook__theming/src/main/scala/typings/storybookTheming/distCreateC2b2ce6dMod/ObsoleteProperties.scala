...
trait ObsoleteProperties[TLength, TTime] extends StObject {
  ...
  /**
    ...
    * @deprecated
    */
  var MozFloatEdge: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.MozFloatEdge] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozForceBrokenImageIcon: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.MozForceBrokenImageIcon] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var MozUserInput: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.MozUserInput] = js.undefined
  ...
  /**
    ...
    * @deprecated
    */
  var OAnimation: js.UndefOr[typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]] = js.undefined
...
object ObsoleteProperties {
  ...
  implicit open class MutableBuilder[Self <: ObsoleteProperties[?, ?], TLength, TTime] (val x: Self & (ObsoleteProperties[TLength, TTime])) extends AnyVal {
    ...
    inline def setOAnimation(value: typings.storybookTheming.distCreateC2b2ce6dMod.Property.Animation[TTime]): Self = StObject.set(x, "OAnimation", value.asInstanceOf[js.Any])
