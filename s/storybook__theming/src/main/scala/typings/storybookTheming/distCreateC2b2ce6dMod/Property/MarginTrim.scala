...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.`in-flow`
...
object MarginTrim {
  ...
  inline def `in-flow`: typings.storybookTheming.storybookThemingStrings.`in-flow` = "in-flow".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`in-flow`]
