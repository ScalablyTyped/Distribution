...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.storybookTheming.storybookThemingStrings.manual
...
*/
trait Hyphens extends StObject
object Hyphens {
  ...
  inline def manual: typings.storybookTheming.storybookThemingStrings.manual = "manual".asInstanceOf[typings.storybookTheming.storybookThemingStrings.manual]
