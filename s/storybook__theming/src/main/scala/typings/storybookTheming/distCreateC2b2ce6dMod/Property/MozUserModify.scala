...
/* Rewritten from type alias, can be one of: 
  - typings.storybookTheming.storybookThemingStrings.`read-only`
  - typings.storybookTheming.storybookThemingStrings.`read-write`
  - typings.storybookTheming.storybookThemingStrings.`write-only`
...
object MozUserModify {
  ...
  inline def `read-only`: typings.storybookTheming.storybookThemingStrings.`read-only` = "read-only".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`read-only`]
  
  inline def `read-write`: typings.storybookTheming.storybookThemingStrings.`read-write` = "read-write".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`read-write`]
  ...
  inline def `write-only`: typings.storybookTheming.storybookThemingStrings.`write-only` = "write-only".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`write-only`]
}
