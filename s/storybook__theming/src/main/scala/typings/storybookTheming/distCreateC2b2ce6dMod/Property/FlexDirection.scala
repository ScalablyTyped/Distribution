...
object FlexDirection {
  ...
  inline def `column-reverse`: typings.storybookTheming.storybookThemingStrings.`column-reverse` = "column-reverse".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`column-reverse`]
  ...
  inline def row: typings.storybookTheming.storybookThemingStrings.row = "row".asInstanceOf[typings.storybookTheming.storybookThemingStrings.row]
  
  inline def `row-reverse`: typings.storybookTheming.storybookThemingStrings.`row-reverse` = "row-reverse".asInstanceOf[typings.storybookTheming.storybookThemingStrings.`row-reverse`]
