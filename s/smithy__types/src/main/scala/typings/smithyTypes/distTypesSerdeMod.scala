...
import typings.smithyTypes.distTypesHttpMod.Endpoint
import typings.smithyTypes.distTypesTransferMod.RequestHandler
import typings.smithyTypes.distTypesUtilMod.Decoder
import typings.smithyTypes.distTypesUtilMod.Encoder
import typings.smithyTypes.distTypesUtilMod.Provider
...
object distTypesSerdeMod {
  ...
  /** NOTE: Mapped type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    {[ key in keyof T ]: key extends StreamKey? @smithy/types.@smithy/types/dist-types/serde.SdkStream<T[StreamKey]> : T[key]}
    }}}
    */
  @js.native
