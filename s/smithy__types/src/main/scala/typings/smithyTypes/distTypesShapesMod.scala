...
import typings.smithyTypes.distTypesHttpMod.HttpResponse
import typings.smithyTypes.distTypesResponseMod.ResponseMetadata
import typings.smithyTypes.smithyTypesStrings.client
import typings.smithyTypes.smithyTypesStrings.server
...
object distTypesShapesMod {
  ...
  {{{
  type DocumentType = null | boolean | number | string | std.Array<@smithy/types.@smithy/types/dist-types/shapes.DocumentType> | {[prop: string] : @smithy/types.@smithy/types/dist-types/shapes.DocumentType}
  }}}
  to avoid circular code involving: 
  - @smithy/types.@smithy/types/dist-types/shapes.DocumentType
  */
  ...
  /* Inlined std.Error & std.Partial<@smithy/types.@smithy/types/dist-types/shapes.SmithyException> & std.Partial<@smithy/types.@smithy/types/dist-types/response.MetadataBearer> */
