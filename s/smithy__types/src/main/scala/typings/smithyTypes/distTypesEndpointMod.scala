...
import typings.smithyTypes.anon.AuthSchemes
...
object distTypesEndpointMod {
  ...
  @JSImport("@smithy/types/dist-types/endpoint", "EndpointURLScheme")
  @js.native
  ...
  {{{
  type EndpointObjectProperty = string | boolean | {[key: string] : @smithy/types.@smithy/types/dist-types/endpoint.EndpointObjectProperty} | std.Array<@smithy/types.@smithy/types/dist-types/endpoint.EndpointObjectProperty>
  }}}
