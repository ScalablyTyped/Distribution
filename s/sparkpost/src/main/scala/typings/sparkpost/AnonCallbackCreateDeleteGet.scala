...
@js.native
trait AnonCallbackCreateDeleteGet extends js.Object {
  /**
  ...
  def preview(id: String, options: AnonDraftSubstitutiondata): ResultsPromise[TemplateContent] = js.native
  /**
    * Preview the most recent version of an existing template by id
    *
    * @param id the id of the template you want to look up
    ...
    * @param callback The request callback with webhook id results
    */
  def preview(id: String, options: AnonDraftSubstitutiondata, callback: ResultsCallback[TemplateContent]): Unit = js.native
  /**
