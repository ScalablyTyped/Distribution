...
trait AnonDraftSubstitutiondata extends js.Object {
  var draft: js.UndefOr[Boolean] = js.undefined
  var substitution_data: js.UndefOr[js.Any] = js.undefined
}

object AnonDraftSubstitutiondata {
  @scala.inline
  def apply(draft: js.UndefOr[Boolean] = js.undefined, substitution_data: js.Any = null): AnonDraftSubstitutiondata = {
    ...
    __obj.asInstanceOf[AnonDraftSubstitutiondata]
  }
}
