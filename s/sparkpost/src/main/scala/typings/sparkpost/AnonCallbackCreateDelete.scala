...
@js.native
trait AnonCallbackCreateDelete extends js.Object {
  /**
    ...
    */
  def create(options: RelayWebhook): ResultsPromise[AnonId] = js.native
  /**
    * Create a relay webhook by providing a relay webhooks object as the POST request body.
    * @param options The create options
    * @param callback The request callback with webhook id results
    */
  def create(options: RelayWebhook, callback: ResultsCallback[AnonId]): Unit = js.native
  /**
  ...
  /**
    ...
    * @returns Promise The webhook id results
    */
  def update(id: String, options: UpdateRelayWebhook): ResultsPromise[AnonId] = js.native
  /**
    * Update a relay webhook by specifying the webhook ID in the URI path.
    * @param options The update options
    * @param callback The request callback with webhook id results
    */
  def update(id: String, options: UpdateRelayWebhook, callback: ResultsCallback[AnonId]): Unit = js.native
}
