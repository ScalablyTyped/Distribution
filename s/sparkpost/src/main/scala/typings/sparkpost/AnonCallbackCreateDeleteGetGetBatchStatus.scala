...
@js.native
trait AnonCallbackCreateDeleteGetGetBatchStatus extends js.Object {
  /**
    ...
    */
  def create(options: Webhook): ResultsPromise[WebhookLinks with AnonId] = js.native
  /**
    * Create a new webhook
    *
    * @param options a hash of [webhook attributes]{@link https://developers.sparkpost.com/api/webhooks#header-webhooks-object-properties}
    ...
    */
  def create(options: Webhook, callback: ResultsCallback[WebhookLinks with AnonId]): Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def update(id: String, options: UpdateWebhook): ResultsPromise[WebhookLinks with AnonId] = js.native
  /**
    * Update an existing webhook
    ...
    * @param callback The request callback with webhook id results
    */
  def update(id: String, options: UpdateWebhook, callback: ResultsCallback[WebhookLinks with AnonId]): Unit = js.native
  /**
