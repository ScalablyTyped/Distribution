...
object TransmissionOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(click_tracking)) __obj.updateDynamic("click_tracking")(click_tracking.get.asInstanceOf[js.Any])
    if (!js.isUndefined(inline_css)) __obj.updateDynamic("inline_css")(inline_css.get.asInstanceOf[js.Any])
    if (ip_pool != null) __obj.updateDynamic("ip_pool")(ip_pool.asInstanceOf[js.Any])
    if (!js.isUndefined(open_tracking)) __obj.updateDynamic("open_tracking")(open_tracking.get.asInstanceOf[js.Any])
    if (!js.isUndefined(sandbox)) __obj.updateDynamic("sandbox")(sandbox.get.asInstanceOf[js.Any])
    if (!js.isUndefined(skip_suppression)) __obj.updateDynamic("skip_suppression")(skip_suppression.get.asInstanceOf[js.Any])
