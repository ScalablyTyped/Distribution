...
trait SparkPost extends StObject {
  ...
  def delete(options: Options): js.Promise[Response[js.Any]] = js.native
  def delete(options: Options, callback: Callback[js.Any]): Unit = js.native
  
  def get(options: Options): js.Promise[Response[js.Any]] = js.native
  def get(options: Options, callback: Callback[js.Any]): Unit = js.native
  ...
  def post(options: Options): js.Promise[Response[js.Any]] = js.native
  def post(options: Options, callback: Callback[js.Any]): Unit = js.native
  
  def put(options: Options): js.Promise[Response[js.Any]] = js.native
  def put(options: Options, callback: Callback[js.Any]): Unit = js.native
  ...
  def request(options: Options): js.Promise[Response[js.Any]] = js.native
  def request(options: Options, callback: Callback[js.Any]): Unit = js.native
