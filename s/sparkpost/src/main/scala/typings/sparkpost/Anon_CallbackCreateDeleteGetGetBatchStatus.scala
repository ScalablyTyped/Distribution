...
import typings.sparkpost.sparkpostMod.Response
import typings.sparkpost.sparkpostMod.ResultsCallback
import typings.sparkpost.sparkpostMod.ResultsPromise
import typings.sparkpost.sparkpostMod.UpdateWebhook
import typings.sparkpost.sparkpostMod.Webhook
import typings.sparkpost.sparkpostMod.WebhookLinks
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Anon_CallbackCreateDeleteGetGetBatchStatus extends js.Object {
  /**
    ...
    */
  def create(options: Webhook): ResultsPromise[WebhookLinks with Anon_Id] = js.native
  /**
    * Create a new webhook
    *
    * @param options a hash of [webhook attributes]{@link https://developers.sparkpost.com/api/webhooks#header-webhooks-object-properties}
    ...
    */
  def create(options: Webhook, callback: ResultsCallback[WebhookLinks with Anon_Id]): Unit = js.native
  /**
  ...
  def get(id: String, options: Anon_Timezone): ResultsPromise[WebhookLinks with Webhook] = js.native
  /**
    * Retrieve details about a specified webhook by its id
    *
    * @param id The id of the webhook to get
    ...
    * @param callback The request callback with RelayWebhook results
    */
  def get(id: String, options: Anon_Timezone, callback: ResultsCallback[WebhookLinks with Webhook]): Unit = js.native
  /**
    ...
    */
  def getBatchStatus(id: String, callback: ResultsCallback[js.Array[Anon_Attempts]]): Unit = js.native
  /**
    * Gets recent status information about a webhook.
    *
    * @param id The id of the webhook
    ...
    */
  def getBatchStatus(id: String, options: Anon_Limit): ResultsPromise[js.Array[Anon_Attempts]] = js.native
  /**
    * Gets recent status information about a webhook.
    *
    * @param id The id of the webhook
    ...
    * @param callback The request callback with status results
    */
  def getBatchStatus(id: String, options: Anon_Limit, callback: ResultsCallback[js.Array[Anon_Attempts]]): Unit = js.native
  /**
  ...
  def getSamples(options: Anon_Events): js.Promise[Response[_]] = js.native
  /**
    * List an example of the event data that will be posted by a Webhook for the specified events.
    * @param options The optional event name
    * @param callback The request callback containing examples
    */
  def getSamples(options: Anon_Events, callback: Callback[_]): Unit = js.native
  /**
  ...
  def list(options: Anon_Timezone): ResultsPromise[js.Array[WebhookLinks with Webhook]] = js.native
  /**
    * List currently existing webhooks.
    * @param options Object containing optional timezone
    * @param callback The request callback with RelayWebhook results array
    */
  def list(options: Anon_Timezone, callback: ResultsCallback[js.Array[WebhookLinks with Webhook]]): Unit = js.native
  /**
    * Update an existing webhook
    *
    */
  def update(id: String, options: UpdateWebhook): ResultsPromise[WebhookLinks with Anon_Id] = js.native
  /**
    * Update an existing webhook
    ...
    * @param callback The request callback with webhook id results
    */
  def update(id: String, options: UpdateWebhook, callback: ResultsCallback[WebhookLinks with Anon_Id]): Unit = js.native
  /**
    ...
    */
  def validate(id: String, options: Anon_MessageAny): ResultsPromise[Anon_Msg] = js.native
  /**
    * Sends an example message event batch from the Webhook API to the target URL
    *
    * @param id The id of the webhook to validate
    ...
    */
  def validate(id: String, options: Anon_MessageAny, callback: ResultsCallback[Anon_Msg]): Unit = js.native
}
