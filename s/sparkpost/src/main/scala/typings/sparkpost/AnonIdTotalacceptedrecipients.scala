...
trait AnonIdTotalacceptedrecipients extends js.Object {
  var id: String
  var total_accepted_recipients: Double
  var total_rejected_recipients: Double
}

object AnonIdTotalacceptedrecipients {
  @scala.inline
  def apply(id: String, total_accepted_recipients: Double, total_rejected_recipients: Double): AnonIdTotalacceptedrecipients = {
    ...
    __obj.asInstanceOf[AnonIdTotalacceptedrecipients]
  }
}
