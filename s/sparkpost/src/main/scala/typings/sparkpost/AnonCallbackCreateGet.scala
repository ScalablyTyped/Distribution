...
@js.native
trait AnonCallbackCreateGet extends js.Object {
  /**
  ...
  /**
    ...
    */
  def update(id: String, subaccount: UpdateSubaccount): ResultsPromise[AnonMessage] = js.native
  /**
    * Update an existing subaccount’s information.
    *
    * @param id the id of the subaccount you want to update
    ...
    */
  def update(id: String, subaccount: UpdateSubaccount, callback: ResultsCallback[AnonMessage]): Unit = js.native
}
