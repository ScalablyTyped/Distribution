...
object SfBottomModal extends Shortcut {
  
  @JSImport("@storefront-ui/vue", "SfBottomModal")
  @js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `SfBottomModal.foo` */
