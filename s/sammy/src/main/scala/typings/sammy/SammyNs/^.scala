...
object ^ extends js.Object {
  var DataLocationProxy: typings.sammy.SammyNs.DataLocationProxy = js.native
  var FormBuilder: typings.sammy.SammyNs.FormBuilder = js.native
  var Store: typings.sammy.SammyNs.Store = js.native
