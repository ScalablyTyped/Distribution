...
@js.native
object sammyModMembers extends js.Object {
  var DataLocationProxy: sammyLib.SammyNs.DataLocationProxy = js.native
  var FormBuilder: sammyLib.SammyNs.FormBuilder = js.native
  var Store: sammyLib.SammyNs.Store = js.native
  def apply(): sammyLib.SammyNs.Application = js.native
  def apply(handler: js.Function): sammyLib.SammyNs.Application = js.native
  def apply(selector: java.lang.String): sammyLib.SammyNs.Application = js.native
  def apply(selector: java.lang.String, handler: js.Function): sammyLib.SammyNs.Application = js.native
