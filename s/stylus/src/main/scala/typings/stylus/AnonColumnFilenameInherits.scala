...
trait AnonColumnFilenameInherits extends js.Object {
  var __type: String
  var column: Double
  var filename: String
...
object AnonColumnFilenameInherits {
  @scala.inline
  def apply(
    __type: String,
    column: Double,
    ...
    __obj.asInstanceOf[AnonColumnFilenameInherits]
  }
}
