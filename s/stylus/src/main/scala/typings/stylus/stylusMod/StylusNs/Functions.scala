...
import typings.stylus.stylusMod.StylusNs.NodesNs.Boolean
...
import typings.stylus.stylusMod.StylusNs.NodesNs.Number
...
import typings.stylus.stylusMod.StylusNs.NodesNs.String
