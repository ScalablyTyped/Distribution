...
trait Static extends js.Object {
  var Compiler: Instantiable0[typings.stylus.stylusMod.StylusNs.Compiler] = js.native
  var Evaluator: Instantiable0[typings.stylus.stylusMod.StylusNs.Evaluator] = js.native
  var Parser: Instantiable0[typings.stylus.stylusMod.StylusNs.Parser] = js.native
  var Visitor: Instantiable0[typings.stylus.stylusMod.StylusNs.Visitor] = js.native
  /**
    * Expose BIFs.
    */
