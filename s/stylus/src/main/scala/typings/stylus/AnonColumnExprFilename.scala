...
trait AnonColumnExprFilename extends js.Object {
  var __type: String
  var column: Double
  var expr: Expression
  var filename: String
...
object AnonColumnExprFilename {
  @scala.inline
  def apply(__type: String, column: Double, expr: Expression, filename: String, lineno: Double, op: String): AnonColumnExprFilename = {
    ...
    __obj.asInstanceOf[AnonColumnExprFilename]
  }
}
