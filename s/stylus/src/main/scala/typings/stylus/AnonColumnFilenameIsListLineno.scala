...
trait AnonColumnFilenameIsListLineno extends js.Object {
  var __type: String
  var column: Double
  var filename: String
  var isList: Boolean
...
object AnonColumnFilenameIsListLineno {
  @scala.inline
  def apply(
    __type: String,
    column: Double,
    ...
    nodes: js.Array[Node],
    preserve: Boolean
  ): AnonColumnFilenameIsListLineno = {
    ...
    __obj.asInstanceOf[AnonColumnFilenameIsListLineno]
  }
}
