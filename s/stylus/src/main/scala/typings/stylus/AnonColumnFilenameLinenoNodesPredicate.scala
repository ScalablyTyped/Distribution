...
trait AnonColumnFilenameLinenoNodesPredicate extends js.Object {
  var __type: String
  var column: Double
  var filename: String
  var lineno: Double
...
object AnonColumnFilenameLinenoNodesPredicate {
  @scala.inline
  def apply(
    __type: String,
    column: Double,
    ...
    predicate: String,
    `type`: String
  ): AnonColumnFilenameLinenoNodesPredicate = {
    ...
    __obj.asInstanceOf[AnonColumnFilenameLinenoNodesPredicate]
  }
}
