...
trait AnonColumnFilenameLinenoTypeVals extends js.Object {
  var __type: String
  var column: Double
  var filename: String
  var lineno: Double
...
object AnonColumnFilenameLinenoTypeVals {
  @scala.inline
  def apply(__type: String, column: Double, filename: String, lineno: Double, vals: Dictionary[Node]): AnonColumnFilenameLinenoTypeVals = {
    ...
    __obj.asInstanceOf[AnonColumnFilenameLinenoTypeVals]
  }
}
