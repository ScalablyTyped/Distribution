...
object ColumnFilename {
  ...
  inline def apply(__type: String, column: Double, filename: String, lineno: Double): ColumnFilename = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ColumnFilename] (val x: Self) extends AnyVal {
