...
trait FilenameLineno extends StObject {
...
object FilenameLineno {
  ...
  inline def apply(__type: String, column: Double, filename: String, lineno: Double, `val`: String): FilenameLineno = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FilenameLineno] (val x: Self) extends AnyVal {
