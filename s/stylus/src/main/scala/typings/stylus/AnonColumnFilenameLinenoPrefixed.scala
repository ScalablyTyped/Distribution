...
trait AnonColumnFilenameLinenoPrefixed extends js.Object {
  var __type: String
  var column: Double
  var filename: String
  var lineno: Double
...
object AnonColumnFilenameLinenoPrefixed {
  @scala.inline
  def apply(
    __type: String,
    column: Double,
    ...
    string: String,
    `val`: String
  ): AnonColumnFilenameLinenoPrefixed = {
    ...
    __obj.asInstanceOf[AnonColumnFilenameLinenoPrefixed]
  }
}
