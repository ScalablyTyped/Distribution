...
trait AnonColumnFilenameLinenoSegments extends js.Object {
  var __type: String
  var column: Double
  var filename: String
  var lineno: Double
...
object AnonColumnFilenameLinenoSegments {
  @scala.inline
  def apply(__type: String, column: Double, filename: String, lineno: Double, segments: js.Array[Node]): AnonColumnFilenameLinenoSegments = {
    ...
    __obj.asInstanceOf[AnonColumnFilenameLinenoSegments]
  }
}
