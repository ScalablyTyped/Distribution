...
object jsBrowserMod {
  ...
  @JSImport("speech-rule-engine/js/browser", JSImport.Namespace)
  @js.native
  ...
  @JSImport("speech-rule-engine/js/browser", "variables")
  @js.native
  val variables: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Variables */ Any = js.native
  
  @JSImport("speech-rule-engine/js/browser", "version")
  @js.native
