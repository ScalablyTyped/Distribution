...
object jsCommonProcessorsMod {
  
  @JSImport("speech-rule-engine/js/common/processors", "KeyProcessor")
  @js.native
  ...
  object KeyProcessor {
    ...
    @JSImport("speech-rule-engine/js/common/processors", "KeyProcessor.getKey_")
    @js.native
  ...
  @JSImport("speech-rule-engine/js/common/processors", "Processor")
  @js.native
  ...
  object Processor {
    ...
    @JSImport("speech-rule-engine/js/common/processors", "Processor.LocalState")
    @js.native
    ...
    @JSImport("speech-rule-engine/js/common/processors", "Processor.stringify_")
    @js.native
