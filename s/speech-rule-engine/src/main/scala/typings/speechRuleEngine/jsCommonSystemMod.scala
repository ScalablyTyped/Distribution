...
object jsCommonSystemMod {
  
  @JSImport("speech-rule-engine/js/common/system", JSImport.Namespace)
  @js.native
  ...
  @JSImport("speech-rule-engine/js/common/system", "version")
  @js.native
