...
name := "slack-winston"
version := "0.0-dt-20180924Z-e478fe"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "is-stream" % "1.1-dt-20180214Z-e98c3d",
  ...
  "org.scalablytyped" %%% "winston" % "3.2.1-e632d2",
  "org.scalablytyped" %%% "winston-transport" % "4.3.0-9aa6dc")
