...
name := "slack-winston"
version := "0.0-dt-20180924Z-4e4675"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "readable-stream" % "2.3-dt-20181231Z-4b5ba6",
  ...
  "org.scalablytyped" %%% "winston" % "3.2.1-59b6a0",
  "org.scalablytyped" %%% "winston-transport" % "4.3.0-2d6f09")
