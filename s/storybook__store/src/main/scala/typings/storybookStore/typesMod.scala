...
object typesMod {
  ...
  type StoriesWithPartialProps[TFramework /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnyFramework */ Any */, TModule] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof TModule ]: TModule[K] extends @storybook/store.@storybook/store/dist/ts3.9/csf/testing-utils/types.ComposedStory<infer _, infer TProps>? / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnnotatedStoryFn<TFramework, Partial<TProps>> * / any : unknown}
    */ typings.storybookStore.storybookStoreStrings.StoriesWithPartialProps & TopLevel[TModule]
