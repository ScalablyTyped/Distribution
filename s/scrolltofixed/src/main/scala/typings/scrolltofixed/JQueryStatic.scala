...
trait JQueryStatic extends js.Object {
  ...
  def ScrollToFixed(el: Element, options: ScrollToFixedOptions): JQuery = js.native
  @JSName("ScrollToFixed")
  def ScrollToFixed_Unit(el: Element, options: ScrollToFixedOptions): Unit = js.native
