...
import typings.subscribeDashUiDashEvent.subscribeDashUiDashEventStrings._empty
...
object Anon_ {
  @scala.inline
  def apply(axisIntention: x | y | _empty, deltaX: Double, deltaY: Double, startX: Double, startY: Double): Anon_ = {
