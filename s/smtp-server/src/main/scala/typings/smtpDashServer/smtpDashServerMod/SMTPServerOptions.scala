...
import typings.smtpDashServer.Anon_Passphrase
...
object SMTPServerOptions {
  ...
  def apply(
    ...
    SNICallback: (/* servername */ String, /* cb */ js.Function2[/* err */ typings.node.Error | Null, /* ctx */ SecureContext, Unit]) => Unit = null,
