...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'brandedUI'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplbrandedUIPartialP
  extends StObject
     with Param {
...
object PickImplbrandedUIPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplbrandedUIPartialP] (val x: Self) extends AnyVal {
