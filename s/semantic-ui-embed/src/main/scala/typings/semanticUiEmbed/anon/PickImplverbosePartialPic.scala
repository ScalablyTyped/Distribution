...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'verbose'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
