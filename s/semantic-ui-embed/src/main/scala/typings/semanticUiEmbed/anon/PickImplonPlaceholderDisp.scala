...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'onPlaceholderDisplay'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplonPlaceholderDisp
  extends StObject
     with Param {
...
object PickImplonPlaceholderDisp {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonPlaceholderDisp] (val x: Self) extends AnyVal {
