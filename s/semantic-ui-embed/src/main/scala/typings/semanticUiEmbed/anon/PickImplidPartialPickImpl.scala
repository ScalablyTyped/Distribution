...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'id'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplidPartialPickImpl
  extends StObject
     with Param {
...
object PickImplidPartialPickImpl {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplidPartialPickImpl] (val x: Self) extends AnyVal {
