...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'parameters'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplparametersPartial
  extends StObject
     with Param {
...
object PickImplparametersPartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplparametersPartial] (val x: Self) extends AnyVal {
