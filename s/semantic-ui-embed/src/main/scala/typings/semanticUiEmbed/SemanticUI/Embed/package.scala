...
package object Embed {
  ...
  type ClassNameSettings = typings.semanticUiEmbed.SemanticUI.Embed.ClassNameSettings.Param
  ...
  type ParametersSettings = typings.semanticUiEmbed.SemanticUI.Embed.ParametersSettings.Impl
