  ...
  */
  ...
  trait Utils_ extends StObject {
    ...
    /**
      ...
      */
    def css[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 476, starting with typings.sortablejs.sortablejsStrings.accentColor, typings.sortablejs.sortablejsStrings.alignContent, typings.sortablejs.sortablejsStrings.alignItems */ Any */](
      element: HTMLElement,
      prop: K,
