...
trait Utils extends js.Object {
  ...
  /**
    ...
    */
  def css[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 423 */ js.Any */](element: HTMLElement, prop: K): /* import warning: ImportType.apply Failed type conversion: std.CSSStyleDeclaration[K] */ js.Any = js.native
  /**
    ...
    */
  def css[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 423 */ js.Any */](
    element: HTMLElement,
    prop: K,
