...
version := "4.1-dt-20190201Z-9e34f2"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__channels" % "4.1-dt-20190201Z-bad618",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190213Z-58abed",
