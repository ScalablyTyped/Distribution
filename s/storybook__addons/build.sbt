...
version := "4.1-dt-20190201Z-49b01f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__channels" % "4.1-dt-20190201Z-47f0d6",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190213Z-bd182a",
