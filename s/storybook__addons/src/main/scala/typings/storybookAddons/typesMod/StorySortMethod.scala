...
/* Rewritten from type alias, can be one of: 
  - typings.storybookAddons.storybookAddonsStrings.configure
  - typings.storybookAddons.storybookAddonsStrings.alphabetical
*/
trait StorySortMethod extends js.Object
