...
object linterMod {
  ...
  type FormatterType = typings.stylelintWebpackPlugin.optionsMod.FormatterType
  ...
  trait Options extends StObject {
    ...
    var formatter: js.UndefOr[typings.stylelintWebpackPlugin.optionsMod.FormatterType] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFormatter(value: typings.stylelintWebpackPlugin.optionsMod.FormatterType): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
  ...
  trait Report extends StObject {
    ...
    var errors: js.UndefOr[typings.stylelintWebpackPlugin.stylelintErrorMod.^] = js.undefined
    
    var generateReportAsset: js.UndefOr[GenerateReport] = js.undefined
    
    var warnings: js.UndefOr[typings.stylelintWebpackPlugin.stylelintErrorMod.^] = js.undefined
  }
  object Report {
    ...
    extension [Self <: Report](x: Self) {
      ...
      inline def setErrors(value: typings.stylelintWebpackPlugin.stylelintErrorMod.^): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
      ...
      inline def setWarnings(value: typings.stylelintWebpackPlugin.stylelintErrorMod.^): Self = StObject.set(x, "warnings", value.asInstanceOf[js.Any])
