...
object anon {
  ...
  trait FnCall extends StObject {
    ...
    def apply(value: Any, replacer: js.Function2[/* key */ String, /* value */ Any, Any]): String = js.native
    def apply(value: Any, replacer: js.Function2[/* key */ String, /* value */ Any, Any], space: String): String = js.native
    def apply(value: Any, replacer: js.Function2[/* key */ String, /* value */ Any, Any], space: Double): String = js.native
