...
trait TextShadowProps extends js.Object {
  /**
    ...
    */
  var textShadow: js.UndefOr[ResponsiveValue[csstypeLib.csstypeMod.TextShadowProperty | scala.Double]] = js.undefined
}

object TextShadowProps {
  @scala.inline
  def apply(textShadow: ResponsiveValue[csstypeLib.csstypeMod.TextShadowProperty | scala.Double] = null): TextShadowProps = {
