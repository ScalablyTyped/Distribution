...
object MaxWidthProps {
  ...
  @scala.inline
  implicit class MaxWidthPropsOps[Self <: MaxWidthProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (MaxWidthProps[ThemeType, TVal])) extends AnyVal {
