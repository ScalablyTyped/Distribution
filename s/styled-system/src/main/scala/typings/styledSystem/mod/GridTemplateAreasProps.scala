...
object GridTemplateAreasProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GridTemplateAreasProps[?], ThemeType /* <: Theme[TLengthStyledSystem] */] (val x: Self & GridTemplateAreasProps[ThemeType]) extends AnyVal {
