...
object GridTemplateColumnsProps {
  ...
  @scala.inline
  implicit class GridTemplateColumnsPropsOps[Self <: GridTemplateColumnsProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (GridTemplateColumnsProps[ThemeType, TVal])) extends AnyVal {
