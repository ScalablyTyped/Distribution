...
object TextColorProps {
  @scala.inline
  def apply[/* <: typings.styledSystem.mod.Theme[typings.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal](): TextColorProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TextColorProps[ThemeType, TVal]]
  }
  @scala.inline
  implicit class TextColorPropsOps[Self <: TextColorProps[_, _], /* <: typings.styledSystem.mod.Theme[typings.styledSystem.mod.TLengthStyledSystem] */ ThemeType, TVal] (val x: Self with (TextColorProps[ThemeType, TVal])) extends AnyVal {
    @scala.inline
