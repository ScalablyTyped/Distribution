...
object GridAutoColumnsProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GridAutoColumnsProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (GridAutoColumnsProps[ThemeType, TVal])) extends AnyVal {
