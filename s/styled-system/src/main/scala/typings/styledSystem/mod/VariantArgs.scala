...
object VariantArgs {
  @scala.inline
  def apply[TStyle, /* <: java.lang.String */ K, TPropName](): VariantArgs[TStyle, K, TPropName] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VariantArgs[TStyle, K, TPropName]]
  }
  @scala.inline
  implicit class VariantArgsOps[Self <: VariantArgs[_, _, _], TStyle, /* <: java.lang.String */ K, TPropName] (val x: Self with (VariantArgs[TStyle, K, TPropName])) extends AnyVal {
    @scala.inline
