...
object BorderRightProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BorderRightProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (BorderRightProps[ThemeType, TVal])) extends AnyVal {
