...
object BorderLeftProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BorderLeftProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (BorderLeftProps[ThemeType, TVal])) extends AnyVal {
