...
object FlexProps {
  ...
  @scala.inline
  implicit class FlexPropsOps[Self <: FlexProps[_, _], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self with (FlexProps[ThemeType, TVal])) extends AnyVal {
    ...
    @scala.inline
    def setFlexVarargs(value: (TVal | Null)*): Self = this.set("flex", js.Array(value :_*))
    
    @scala.inline
    def setFlex(value: ResponsiveValue[TVal, ThemeType]): Self = this.set("flex", value.asInstanceOf[js.Any])
