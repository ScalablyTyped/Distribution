...
object JustifyItemsProps {
  ...
  @scala.inline
  implicit class JustifyItemsPropsMutableBuilder[Self <: JustifyItemsProps[?], ThemeType /* <: Theme[TLengthStyledSystem] */] (val x: Self & JustifyItemsProps[ThemeType]) extends AnyVal {
