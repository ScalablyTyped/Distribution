...
object SpaceProps {
  ...
  @scala.inline
  def apply[ThemeType /* <: Theme[TLengthStyledSystem] */, TVal](): SpaceProps[ThemeType, TVal] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SpaceProps[ThemeType, TVal]]
  }
  
  @scala.inline
  implicit class SpacePropsMutableBuilder[Self <: SpaceProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (SpaceProps[ThemeType, TVal])) extends AnyVal {
