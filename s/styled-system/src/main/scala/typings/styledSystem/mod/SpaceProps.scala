...
object SpaceProps {
  ...
  inline def apply[ThemeType /* <: Theme[TLengthStyledSystem] */, TVal](): SpaceProps[ThemeType, TVal] = {
  ...
  extension [Self <: SpaceProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal](x: Self & (SpaceProps[ThemeType, TVal])) {
    ...
    inline def setMarginBottom(value: ResponsiveValue[TVal, ThemeType]): Self = StObject.set(x, "marginBottom", value.asInstanceOf[js.Any])
    ...
    inline def setMarginRight(value: ResponsiveValue[TVal, ThemeType]): Self = StObject.set(x, "marginRight", value.asInstanceOf[js.Any])
    ...
    inline def setPaddingBottom(value: ResponsiveValue[TVal, ThemeType]): Self = StObject.set(x, "paddingBottom", value.asInstanceOf[js.Any])
    ...
    inline def setPaddingRight(value: ResponsiveValue[TVal, ThemeType]): Self = StObject.set(x, "paddingRight", value.asInstanceOf[js.Any])
