...
object BackgroundColorProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BackgroundColorProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (BackgroundColorProps[ThemeType, TVal])) extends AnyVal {
