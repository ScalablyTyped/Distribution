...
object GridAutoRowsProps {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GridAutoRowsProps[?, ?], ThemeType /* <: Theme[TLengthStyledSystem] */, TVal] (val x: Self & (GridAutoRowsProps[ThemeType, TVal])) extends AnyVal {
