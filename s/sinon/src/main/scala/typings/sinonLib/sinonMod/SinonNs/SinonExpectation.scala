...
trait SinonExpectation extends SinonStub {
  /**
           ...
           */
  def atLeast(n: scala.Double): SinonExpectation = js.native
  /**
           * Specify the maximum amount of calls expected.
           * @param n
           */
  def atMost(n: scala.Double): SinonExpectation = js.native
  /**
           * Expect the method to be called exactly @param n times.
           */
  def exactly(n: scala.Double): SinonExpectation = js.native
  /**
