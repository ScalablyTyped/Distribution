...
trait SinonSandbox extends js.Object {
  ...
  def replace[T, TKey /* <: java.lang.String */](
    obj: T,
    prop: TKey,
    replacement: /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(TKey))) */js.Any
  ): /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(TKey))) */js.Any = js.native
  /**
  ...
  def replaceSetter[T, TKey /* <: java.lang.String */](
    ...
    replacement: js.Function1[
      /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(TKey))) *//* val */ js.Any, 
      scala.Unit
    ]
  ): js.Function1[
    /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(T))),List()),Left(TsIdentSimple(TKey))) *//* val */ js.Any, 
