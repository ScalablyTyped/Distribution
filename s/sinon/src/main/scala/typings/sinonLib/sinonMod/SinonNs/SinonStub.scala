...
trait SinonStub[TArgs /* <: js.Array[_] */, TReturnValue] extends SinonSpy[TArgs, TReturnValue] {
  ...
  /**
           ...
           */
  def callsArg(index: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  /**
           ...
           * @param index
           */
  def callsArgAsync(index: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Like stub.callsArg(index); but with an additional parameter to pass the this context.
           * @param index
           * @param context
           */
  def callsArgOn(index: scala.Double, context: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
           * In Node environment the callback is deferred with process.nextTick.
           * In a browser the callback is deferred with setTimeout(callback, 0).
           ...
           * @param context
           */
  def callsArgOnAsync(index: scala.Double, context: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  /**
           ...
           * @param args
           */
  def callsArgOnWith(index: scala.Double, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
           * In Node environment the callback is deferred with process.nextTick.
           * In a browser the callback is deferred with setTimeout(callback, 0).
           */
  def callsArgOnWithAsync(index: scala.Double, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Like callsArg, but with arguments to pass to the callback.
           * @param index
           * @param args
           */
  def callsArgWith(index: scala.Double, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
           * In Node environment the callback is deferred with process.nextTick.
           * In a browser the callback is deferred with setTimeout(callback, 0).
           */
  def callsArgWithAsync(index: scala.Double, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * @param n
           */
  def onCall(n: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * Since sinon@2.0.0
           */
  def rejects(errorType: java.lang.String): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           */
  def resolvesArg(index: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * @param index
           */
  def returnsArg(index: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * @param func
           */
  def set(func: js.Function1[/* v */ js.Any, scala.Unit]): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * @param type
           */
  def throws(`type`: java.lang.String): SinonStub[TArgs, TReturnValue] = js.native
  /**
           ...
           * @param index
           */
  def throwsArg(index: scala.Double): SinonStub[TArgs, TReturnValue] = js.native
  ...
  def throwsException(`type`: java.lang.String): SinonStub[TArgs, TReturnValue] = js.native
  /**
  ...
  /**
           ...
           * @param args
           */
  def yieldsTo(property: java.lang.String, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
           * In Node environment the callback is deferred with process.nextTick.
           * In a browser the callback is deferred with setTimeout(callback, 0).
           ...
           * @param args
           */
  def yieldsToAsync(property: java.lang.String, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Like above but with an additional parameter to pass the this context.
           */
  def yieldsToOn(property: java.lang.String, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  /**
           * Same as their corresponding non-Async counterparts, but with callback being deferred at called after all instructions in the current call stack are processed.
           * In Node environment the callback is deferred with process.nextTick.
           * In a browser the callback is deferred with setTimeout(callback, 0).
           ...
           * @param args
           */
  def yieldsToOnAsync(property: java.lang.String, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
}
