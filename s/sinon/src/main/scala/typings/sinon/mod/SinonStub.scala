...
trait SinonStub[TArgs /* <: js.Array[_] */, TReturnValue] extends SinonSpy[TArgs, TReturnValue] {
  ...
  /**
    ...
    * @param context
    */
  def callsArgOn(index: Double, context: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param context
    */
  def callsArgOnAsync(index: Double, context: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def callsArgOnWith(index: Double, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * In a browser the callback is deferred with setTimeout(callback, 0).
    */
  def callsArgOnWithAsync(index: Double, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def callsArgWith(index: Double, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * In a browser the callback is deferred with setTimeout(callback, 0).
    */
  def callsArgWithAsync(index: Double, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * Since sinon@2.0.0
    */
  def rejects(value: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  def resolves(value: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param func
    */
  def set(func: js.Function1[/* v */ js.Any, Unit]): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    */
  def throws(obj: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  def throwsException(obj: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    */
  def usingPromise(promiseLibrary: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  
  /**
    * Defines a new value for this stub.
    * @param val
    */
  def value(`val`: js.Any): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    */
  def yields(args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def yieldsAsync(args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  
  /**
    * Like above but with an additional parameter to pass the this context.
    */
  def yieldsOn(context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def yieldsOnAsync(context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  
  def yieldsRight(args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def yieldsTo(property: String, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def yieldsToAsync(property: String, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  
  /**
    * Like above but with an additional parameter to pass the this context.
    */
  def yieldsToOn(property: String, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
  ...
  /**
    ...
    * @param args
    */
  def yieldsToOnAsync(property: String, context: js.Any, args: js.Any*): SinonStub[TArgs, TReturnValue] = js.native
}
