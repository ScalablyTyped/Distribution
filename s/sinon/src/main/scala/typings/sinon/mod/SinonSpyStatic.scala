...
trait SinonSpyStatic extends StObject {
  ...
  /**
    ...
    */
  def apply[F /* <: js.Function1[/* repeated */ js.Any, js.Any] */](func: F): SinonSpy[Parameters[F], ReturnType[F]] = js.native
  /**
    ...
    */
  def apply[T, K /* <: /* keyof T */ String */](obj: T, method: K): SinonSpy[js.Any | js.Array[js.Any], js.Any] = js.native
  def apply[T, K /* <: /* keyof T */ String */](obj: T, method: K, types: js.Array[get | set]): PropertyDescriptor & (Get[T, K]) = js.native
}
