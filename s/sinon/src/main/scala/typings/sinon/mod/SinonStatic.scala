...
- typings.sinon.mod.SinonApi because var conflicts: clock. Inlined expectation, FakeXMLHttpRequest, fakeServer, fakeServerWithClock, createSandbox, createSandbox, defaultConfig, addBehavior, setFormatter, promise, promise */ @js.native
trait SinonStatic
  extends StObject
     with SinonSandbox {
