...
- typings.sinon.mod.SinonApi because var conflicts: clock. Inlined fake, fake, fake_Original, `match`, `match`, `match`, `match`, `match`, `match`, match_Original, spyCall, expectation, FakeXMLHttpRequest, fakeServer, fakeServerWithClock, createSandbox, createSandbox, defaultConfig */ @js.native
trait SinonStatic
  extends StObject
     with SinonSandbox
     with LegacySandbox {
