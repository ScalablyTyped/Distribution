package typings.sinonDashExpressDashMock
...
@js.native
object sinonDashExpressDashMockMod extends js.Object {
  @js.native
  ...
  object mockRes extends js.Object {
    ...
    def apply[T /* <: js.Object */](): MockRes with T with Response = js.native
    def apply[T /* <: js.Object */](options: T): MockRes with T with Response = js.native
  }
