...
object ^ extends js.Object {
  ...
  def compile(source: java.lang.String, options: swigLib.swigMod.SwigOptions): js.Function1[/* locals */ js.UndefOr[js.Any], java.lang.String] = js.native
  def compileFile(pathname: java.lang.String): js.Function1[/* locals */ js.UndefOr[js.Any], java.lang.String] = js.native
  def compileFile(pathname: java.lang.String, options: swigLib.swigMod.SwigOptions): js.Function1[/* locals */ js.UndefOr[js.Any], java.lang.String] = js.native
  def compileFile(
    pathname: java.lang.String,
    options: swigLib.swigMod.SwigOptions,
    cb: js.Function2[
      /* err */ stdLib.Error, 
  ...
  def precompile(source: java.lang.String, options: swigLib.swigMod.SwigOptions): js.Any = js.native
  def render(source: java.lang.String): java.lang.String = js.native
  def render(source: java.lang.String, options: swigLib.swigMod.SwigOptions): java.lang.String = js.native
  ...
  def setDefaultTZOffset(offset: scala.Double): scala.Unit = js.native
  def setDefaults(options: swigLib.swigMod.SwigOptions): scala.Unit = js.native
  ...
  def setTag(
    ...
    parse: js.Function7[
      ...
      /* swig */ js.UndefOr[swigLib.swigMod.Swig], 
      scala.Boolean
    ],
