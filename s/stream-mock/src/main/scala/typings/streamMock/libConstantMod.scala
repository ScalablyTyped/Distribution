...
object libConstantMod {
  ...
  object WARNINGS {
    ...
    @JSImport("stream-mock/lib/constant", "WARNINGS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("stream-mock/lib/constant", "WARNINGS.DEP_READABLE_MOCK")
    @js.native
    ...
    @JSImport("stream-mock/lib/constant", "WARNINGS.DEP_WRITABLE_MOCK")
    @js.native
