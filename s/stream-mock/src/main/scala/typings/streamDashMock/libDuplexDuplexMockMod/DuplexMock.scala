...
- typings.streamDashMock.libReadableIReadableMockMod.IReadableMock because var conflicts: readable. Inlined it- typings.streamDashMock.libWritableIWritableMockMod.IWritableMock because Inheritance from two classes. Inlined data, flatData */ @js.native
