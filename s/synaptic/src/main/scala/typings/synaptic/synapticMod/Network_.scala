...
import typings.synaptic.Anon_Code
import typings.synaptic.synapticMod.Layer.LayerConnection
import typings.synaptic.synapticMod.Layer.connectionType
import typings.synaptic.synapticMod.Layer.gateType
import typings.synaptic.synapticMod.Network.Optimized
...
class Network_ () extends js.Object {
  ...
  /**
    ...
    */
  def toDot(): Anon_Code = js.native
  def toDot(edgeConnection: js.Any): Anon_Code = js.native
  /**
