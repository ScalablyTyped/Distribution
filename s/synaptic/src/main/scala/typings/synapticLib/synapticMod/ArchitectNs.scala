...
object ArchitectNs extends js.Object {
  ...
  class Hopfield protected ()
    ...
    /**
      ...
      * @param pattern
      */
    def feed(pattern: js.Array[scala.Double]): js.Array[scala.Double] = js.native
    /**
      * Teach the network two different patterns.
      * @param patterns
      */
    def learn(patterns: js.Tuple2[js.Array[scala.Double], js.Array[scala.Double]]): js.Any = js.native
  }
  ...
  class LSTM protected ()
    ...
    var trainer: synapticLib.synapticMod.Trainer = js.native
  }
