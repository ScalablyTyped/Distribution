...
trait Anon_LSTM extends js.Object {
  /**
       ...
       */
  var Hopfield: ScalablyTyped.runtime.Instantiable1[/* patternSize */ scala.Double, synapticLib.synapticMod.ArchitectNs.Hopfield]
  /**
       ...
       */
  var LSTM: ScalablyTyped.runtime.Instantiable1[
  ...
  /**
       ...
       */
  var Liquid: ScalablyTyped.runtime.Instantiable5[
    /* input */ scala.Double, 
    /* pool */ scala.Double, 
    /* output */ scala.Double, 
  ...
  /**
       ...
       */
  var Perceptron: ScalablyTyped.runtime.Instantiable1[
    /* numberOfNeurons (repeated) */ scala.Double, 
