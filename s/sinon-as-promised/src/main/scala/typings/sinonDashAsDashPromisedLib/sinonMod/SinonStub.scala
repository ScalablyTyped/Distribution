...
trait SinonStub extends js.Object {
  /**
    ...
    */
  def rejects(error: js.Any): sinonLib.sinonMod.SinonStub
  /**
    ...
    */
  def resolves[T](value: T): sinonLib.sinonMod.SinonStub
}

object SinonStub {
  @scala.inline
  def apply(rejects: js.Any => sinonLib.sinonMod.SinonStub, resolves: js.Any => sinonLib.sinonMod.SinonStub): SinonStub = {
