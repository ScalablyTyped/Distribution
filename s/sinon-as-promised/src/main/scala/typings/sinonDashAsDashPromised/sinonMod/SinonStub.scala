package typings.sinonDashAsDashPromised.sinonMod
...
trait SinonStub extends js.Object {
  /**
    ...
    */
  def rejects(error: js.Any): typings.sinon.sinonMod.SinonStub
  /**
    ...
    */
  def resolves[T](value: T): typings.sinon.sinonMod.SinonStub
}

object SinonStub {
  @scala.inline
  def apply(
    rejects: js.Any => typings.sinon.sinonMod.SinonStub,
    resolves: js.Any => typings.sinon.sinonMod.SinonStub
  ): SinonStub = {
