...
trait ImageSnapshotConfig extends CommonConfig {
  def afterScreenshot(options: typings.storybookAddonStoryshotsPuppeteer.anon.Context): Unit = js.native
...
object ImageSnapshotConfig {
  ...
  implicit class ImageSnapshotConfigOps[Self <: ImageSnapshotConfig] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAfterScreenshot(value: typings.storybookAddonStoryshotsPuppeteer.anon.Context => Unit): Self = this.set("afterScreenshot", js.Any.fromFunction1(value))
    @scala.inline
