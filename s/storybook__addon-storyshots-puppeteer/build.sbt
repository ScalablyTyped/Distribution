...
version := "5.1-dt-20191122Z-00d9e1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jest-image-snapshot" % "2.11-dt-20191223Z-5de6b0",
  "org.scalablytyped" %%% "node" % "13.1-dt-20200103Z-b9f880",
  "org.scalablytyped" %%% "prop-types" % "15.7-dt-20190924Z-b24434",
  "org.scalablytyped" %%% "puppeteer" % "2.0-dt-20191126Z-951e40",
  "org.scalablytyped" %%% "reach__router" % "1.2-dt-20191009Z-3afe31",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191220Z-22d23f",
  "org.scalablytyped" %%% "std" % "3.7-b6d959",
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-0ab9ce",
  "org.scalablytyped" %%% "storybook__addons" % "5.2.8-c76791",
  "org.scalablytyped" %%% "storybook__api" % "5.2.8-17136c",
  "org.scalablytyped" %%% "storybook__channels" % "5.2.8-a17bce",
  "org.scalablytyped" %%% "storybook__react" % "5.2.8-ca9e80",
