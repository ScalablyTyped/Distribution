...
version := "5.1-dt-20191122Z-1ca65c"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "puppeteer" % "2.0-dt-20191126Z-26df2b",
  "org.scalablytyped" %%% "reach__router" % "1.2-dt-20191009Z-3afe31",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191220Z-22d23f",
  "org.scalablytyped" %%% "std" % "3.7-b6d959",
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-d90a30",
