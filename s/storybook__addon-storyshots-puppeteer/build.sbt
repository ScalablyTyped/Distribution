...
version := "5.1-dt-20190802Z-daa306"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190813Z-37f792",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-7c6aa6")
