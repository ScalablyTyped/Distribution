...
version := "5.1-dt-20190802Z-e9003b"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190813Z-38fc35",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-c36e9c")
