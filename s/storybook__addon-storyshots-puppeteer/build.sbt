...
version := "5.1-dt-20190802Z-cdbd25"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190813Z-217670",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-b0944b")
