...
version := "5.1-dt-20191122Z-1bf393"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "puppeteer" % "2.0-dt-20191119Z-bccbbb",
  "org.scalablytyped" %%% "reach__router" % "1.2-dt-20191009Z-a01247",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191122Z-caf4d8",
  "org.scalablytyped" %%% "std" % "3.7-1c17cf",
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-d5c0b1",
