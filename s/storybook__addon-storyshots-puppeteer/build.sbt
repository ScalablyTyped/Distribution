...
version := "5.1-dt-20191122Z-8162ac"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "puppeteer" % "2.0-dt-20191126Z-138094",
  "org.scalablytyped" %%% "reach__router" % "1.2-dt-20191009Z-60a520",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191220Z-73a5bc",
  "org.scalablytyped" %%% "std" % "3.7-953338",
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-bf742d",
  ...
  "org.scalablytyped" %%% "storybook__react" % "5.2.8-0f148e",
