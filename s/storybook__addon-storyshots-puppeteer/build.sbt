...
version := "5.1-dt-20190802Z-9173e3"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190802Z-25ad9d",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-f9b2c7")
