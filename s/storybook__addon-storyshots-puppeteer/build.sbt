...
version := "5.1-dt-20191122Z-06d507"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "puppeteer" % "2.0-dt-20191126Z-f5ab95",
  "org.scalablytyped" %%% "reach__router" % "1.2-dt-20191009Z-a9dfcd",
  "org.scalablytyped" %%% "react" % "16.9-dt-20191126Z-0aa2c4",
  "org.scalablytyped" %%% "std" % "3.7-1d724d",
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20191122Z-9da6db",
