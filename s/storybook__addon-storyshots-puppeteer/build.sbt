...
version := "5.1-dt-20190802Z-dcaf2e"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190813Z-07236d",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-f64966")
