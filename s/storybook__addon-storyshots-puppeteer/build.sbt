...
version := "5.1-dt-20190802Z-af9ec6"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__addon-storyshots" % "5.1-dt-20190813Z-843720",
  "org.scalablytyped" %%% "storybook__react" % "4.0-dt-20190605Z-8a8059")
