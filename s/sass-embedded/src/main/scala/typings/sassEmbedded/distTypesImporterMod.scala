...
object distTypesImporterMod {
  ...
  object FileImporter {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: FileImporter[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] (val x: Self & FileImporter[sync]) extends AnyVal {
  ...
  object Importer {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: Importer[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] (val x: Self & Importer[sync]) extends AnyVal {
