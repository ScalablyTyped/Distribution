...
import typings.sassEmbedded.importerMod.FileImporter
import typings.sassEmbedded.importerMod.Importer
...
object typesOptionsMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sassEmbedded.typesOptionsMod.StringOptionsWithImporter[sync]
    - typings.sassEmbedded.typesOptionsMod.StringOptionsWithoutImporter[sync]
  */
  trait StringOptions[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject
  object StringOptions {
    
    inline def StringOptionsWithImporter[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](importer: Importer[sync] | FileImporter[sync], url: URL): typings.sassEmbedded.typesOptionsMod.StringOptionsWithImporter[sync] = {
      val __obj = js.Dynamic.literal(importer = importer.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sassEmbedded.typesOptionsMod.StringOptionsWithImporter[sync]]
    }
    
    inline def StringOptionsWithoutImporter[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](): typings.sassEmbedded.typesOptionsMod.StringOptionsWithoutImporter[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.sassEmbedded.typesOptionsMod.StringOptionsWithoutImporter[sync]]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.sassEmbedded.typesOptionsMod.StringOptions because Already inherited */ trait StringOptionsWithImporter[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */]
    extends StObject
