...
import typings.sassEmbedded.distTypesLegacyFunctionMod.LegacyFunction
import typings.sassEmbedded.distTypesLegacyImporterMod.LegacyImporter
...
object distTypesLegacyOptionsMod {
  ...
  object LegacyFileOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LegacyFileOptions[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] (val x: Self & LegacyFileOptions[sync]) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyFileOptions[sync]
    - typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyStringOptions[sync]
  */
  trait LegacyOptions[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject
  object LegacyOptions {
    
    inline def LegacyFileOptions[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](file: String): typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyFileOptions[sync] = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyFileOptions[sync]]
    }
    
    inline def LegacyStringOptions[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](data: String): typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyStringOptions[sync] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sassEmbedded.distTypesLegacyOptionsMod.LegacyStringOptions[sync]]
    }
  }
  ...
  object LegacySharedOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LegacySharedOptions[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] (val x: Self & LegacySharedOptions[sync]) extends AnyVal {
  ...
  object LegacyStringOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: LegacyStringOptions[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] (val x: Self & LegacyStringOptions[sync]) extends AnyVal {
