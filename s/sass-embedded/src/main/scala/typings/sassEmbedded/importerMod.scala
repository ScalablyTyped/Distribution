...
import typings.sassEmbedded.anon.FromImport
import typings.sassEmbedded.promiseOrMod.PromiseOr
...
object importerMod {
  ...
  trait FileImporter[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject {
  ...
  object FileImporter {
    ...
    inline def apply[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](findFileUrl: (String, FromImport) => PromiseOr[URL | Null, sync]): FileImporter[sync] = {
      val __obj = js.Dynamic.literal(findFileUrl = js.Any.fromFunction2(findFileUrl))
      __obj.asInstanceOf[FileImporter[sync]]
    }
    
    extension [Self <: FileImporter[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & FileImporter[sync]) {
  ...
  trait Importer[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject {
  ...
  object Importer {
    ...
    inline def apply[sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](
    ...
    extension [Self <: Importer[?], sync /* <: typings.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & Importer[sync]) {
