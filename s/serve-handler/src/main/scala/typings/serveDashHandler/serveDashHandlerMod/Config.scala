...
object Config {
  ...
  def apply(
    ...
    if (redirects != null) __obj.updateDynamic("redirects")(redirects)
    if (!js.isUndefined(renderSingle)) __obj.updateDynamic("renderSingle")(renderSingle)
    ...
    if (unlisted != null) __obj.updateDynamic("unlisted")(unlisted)
