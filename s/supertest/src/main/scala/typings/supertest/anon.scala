...
import typings.superagent.mod.CallbackHandler
...
object anon extends js.Object {
  ...
  @js.native
  trait SuperTestTestPickRequestu extends js.Object {
    @JSName("accept")
    ...
    def checkout(url: String, callback: CallbackHandler): Test = js.native
    def connect(url: String): Test = js.native
    def connect(url: String, callback: CallbackHandler): Test = js.native
    def copy(url: String): Test = js.native
    def copy(url: String, callback: CallbackHandler): Test = js.native
    def del(url: String): Test = js.native
    def del(url: String, callback: CallbackHandler): Test = js.native
    def delete(url: String): Test = js.native
    def delete(url: String, callback: CallbackHandler): Test = js.native
    def emit(event: String, args: js.Any*): Boolean = js.native
    def emit(event: js.Symbol, args: js.Any*): Boolean = js.native
    def eventNames(): js.Array[String | js.Symbol] = js.native
    def get(url: String): Test = js.native
    def get(url: String, callback: CallbackHandler): Test = js.native
    def getMaxListeners(): Double = js.native
    def head(url: String): Test = js.native
    def head(url: String, callback: CallbackHandler): Test = js.native
    ...
    def lock(url: String, callback: CallbackHandler): Test = js.native
    def merge(url: String): Test = js.native
    def merge(url: String, callback: CallbackHandler): Test = js.native
    def mkactivity(url: String): Test = js.native
    def mkactivity(url: String, callback: CallbackHandler): Test = js.native
    def mkcol(url: String): Test = js.native
    def mkcol(url: String, callback: CallbackHandler): Test = js.native
    def move(url: String): Test = js.native
    def move(url: String, callback: CallbackHandler): Test = js.native
    def notify(url: String): Test = js.native
    def notify(url: String, callback: CallbackHandler): Test = js.native
    ...
    def options(url: String, callback: CallbackHandler): Test = js.native
    def parse(parser: Parser): this.type = js.native
    def patch(url: String): Test = js.native
    def patch(url: String, callback: CallbackHandler): Test = js.native
    def pfx(cert: String): this.type = js.native
    def pipe[T /* <: WritableStream */](destination: T): T = js.native
    def pipe[T /* <: WritableStream */](destination: T, options: End): T = js.native
    def post(url: String): Test = js.native
    def post(url: String, callback: CallbackHandler): Test = js.native
    // Added in Node 6...
    ...
    def propfind(url: String, callback: CallbackHandler): Test = js.native
    def proppatch(url: String): Test = js.native
    def proppatch(url: String, callback: CallbackHandler): Test = js.native
    def purge(url: String): Test = js.native
    def purge(url: String, callback: CallbackHandler): Test = js.native
    def put(url: String): Test = js.native
    def put(url: String, callback: CallbackHandler): Test = js.native
    ...
    def report(url: String, callback: CallbackHandler): Test = js.native
    def retry(): this.type = js.native
    def saveCookies(res: Response): Unit = js.native
    def search(url: String): Test = js.native
    def search(url: String, callback: CallbackHandler): Test = js.native
    ...
    def subscribe(url: String, callback: CallbackHandler): Test = js.native
    def timeout(ms: Double): this.type = js.native
    def trace(url: String): Test = js.native
    def trace(url: String, callback: CallbackHandler): Test = js.native
    def `type`(`val`: String): this.type = js.native
    def unlock(url: String): Test = js.native
    def unlock(url: String, callback: CallbackHandler): Test = js.native
    def unsubscribe(url: String): Test = js.native
    def unsubscribe(url: String, callback: CallbackHandler): Test = js.native
