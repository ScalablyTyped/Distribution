...
trait AndroidInstrumentationTestReport
  ...
  var testSuites: js.UndefOr[js.Array[TestSuite]] = js.undefined
...
object AndroidInstrumentationTestReport {
  ...
  @scala.inline
  implicit class AndroidInstrumentationTestReportMutableBuilder[Self <: AndroidInstrumentationTestReport] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTestSuitesUndefined: Self = StObject.set(x, "testSuites", js.undefined)
