...
object RobotiumTestReport {
  
  @scala.inline
  def apply(): RobotiumTestReport = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RobotiumTestReport]
  }
  
  @scala.inline
  implicit class RobotiumTestReportMutableBuilder[Self <: RobotiumTestReport] (val x: Self) extends AnyVal {
