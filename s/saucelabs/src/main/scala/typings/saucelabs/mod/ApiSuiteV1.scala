...
object ApiSuiteV1 {
  ...
  @scala.inline
  implicit class ApiSuiteV1Ops[Self <: ApiSuiteV1] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDeviceIdsVarargs(value: Id*): Self = this.set("deviceIds", js.Array(value :_*))
    
    @scala.inline
    def setDeviceIds(value: js.Array[Id]): Self = this.set("deviceIds", value.asInstanceOf[js.Any])
