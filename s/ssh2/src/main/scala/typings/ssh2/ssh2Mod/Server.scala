...
import typings.ssh2.Anon_Address
import typings.ssh2.Anon_Fd
...
class Server protected () extends EventEmitter {
  ...
  def listen(handle: Anon_Fd): this.type = js.native
  def listen(handle: Anon_Fd, backlog: Double): this.type = js.native
  def listen(handle: Anon_Fd, backlog: Double, callback: js.Function0[Unit]): this.type = js.native
  def listen(handle: Anon_Fd, callback: js.Function0[Unit]): this.type = js.native
  /**
