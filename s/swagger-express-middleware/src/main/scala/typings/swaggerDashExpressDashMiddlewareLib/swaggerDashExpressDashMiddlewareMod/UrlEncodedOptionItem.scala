...
trait UrlEncodedOptionItem extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    (js.Function1[/* req */ expressLib.expressMod.Request, java.lang.String]) | java.lang.String
  ] = js.undefined
  /**
...
object UrlEncodedOptionItem {
  ...
  def apply(
    ...
    `type`: (js.Function1[/* req */ expressLib.expressMod.Request, java.lang.String]) | java.lang.String = null,
    verify: (/* req */ expressLib.expressMod.Request, /* res */ Response, /* buf */ nodeLib.Buffer, /* encoding */ java.lang.String) => scala.Unit = null
