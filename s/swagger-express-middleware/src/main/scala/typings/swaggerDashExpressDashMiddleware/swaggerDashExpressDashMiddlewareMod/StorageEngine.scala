...
trait StorageEngine extends js.Object {
  ...
  def _removeFile(req: Request[ParamsDictionary], file: File, callback: js.Function1[/* error */ Error, Unit]): Unit
}
...
object StorageEngine {
  ...
  def apply(
    ...
    _removeFile: (Request[ParamsDictionary], File, js.Function1[/* error */ Error, Unit]) => Unit
  ): StorageEngine = {
