...
import typings.stellarDashBase.stellarDashBaseMod.xdrNs.TransactionResult
import typings.stellarDashBase.stellarDashBaseMod.xdrNs.XDRStruct
...
object xdrNs extends js.Object {
  ...
  object Asset extends js.Object {
    def fromXDR(xdr: Buffer): typings.stellarDashBase.stellarDashBaseMod.xdrNs.Asset = js.native
  }
  ...
  object Memo extends js.Object {
    def fromXDR(xdr: Buffer): typings.stellarDashBase.stellarDashBaseMod.xdrNs.Memo = js.native
  }
  
  /* static members */
  @js.native
  object Operation extends js.Object {
    def fromXDR(xdr: Buffer): typings.stellarDashBase.stellarDashBaseMod.xdrNs.Operation[typings.stellarDashBase.stellarDashBaseMod.Operation] = js.native
  }
