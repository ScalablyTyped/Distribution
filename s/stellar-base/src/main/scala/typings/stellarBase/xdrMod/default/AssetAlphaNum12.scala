...
@JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12")
@js.native
class AssetAlphaNum12 protected ()
  extends typings.stellarBase.xdrMod.xdr.AssetAlphaNum12 {
  def this(attributes: AssetCode) = this()
}
object AssetAlphaNum12 {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.AssetAlphaNum12): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.AssetAlphaNum12 = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.AssetAlphaNum12): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AssetAlphaNum12.write")
  @js.native
