...
@JSImport("stellar-base/types/xdr", "default.SetOptionsOp")
@js.native
class SetOptionsOp protected ()
  extends typings.stellarBase.xdrMod.xdr.SetOptionsOp {
  def this(attributes: ClearFlags) = this()
}
object SetOptionsOp {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.SetOptionsOp): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.SetOptionsOp = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.SetOptionsOp): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.SetOptionsOp.write")
  @js.native
