...
@JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp")
@js.native
...
object ManageBuyOfferOp {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.ManageBuyOfferOp): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.ManageBuyOfferOp = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.ManageBuyOfferOp): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ManageBuyOfferOp.write")
  @js.native
