...
@JSImport("stellar-base/types/xdr", "default.TransactionV0Ext")
@js.native
...
object TransactionV0Ext {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.TransactionV0Ext): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.TransactionV0Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.TransactionV0Ext): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TransactionV0Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionV0Ext.0")
  @js.native
