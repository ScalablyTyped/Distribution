...
@JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry")
@js.native
class ScpHistoryEntry ()
  extends typings.stellarBase.xdrMod.xdr.ScpHistoryEntry
object ScpHistoryEntry {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.ScpHistoryEntry): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.ScpHistoryEntry = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.ScpHistoryEntry): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.ScpHistoryEntry, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpHistoryEntry.0")
  @js.native
