...
@JSImport("stellar-base/types/xdr", "default.ScpBallot")
@js.native
class ScpBallot protected ()
  extends typings.stellarBase.xdrMod.xdr.ScpBallot {
  def this(attributes: Counter) = this()
}
object ScpBallot {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.ScpBallot): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.ScpBallot = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.ScpBallot): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ScpBallot.write")
  @js.native
