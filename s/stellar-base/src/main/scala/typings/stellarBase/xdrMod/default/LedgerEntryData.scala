...
@JSImport("stellar-base/types/xdr", "default.LedgerEntryData")
@js.native
class LedgerEntryData ()
  extends typings.stellarBase.xdrMod.xdr.LedgerEntryData
object LedgerEntryData {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.account")
  @js.native
  def account(value: typings.stellarBase.xdrMod.xdr.AccountEntry): typings.stellarBase.xdrMod.xdr.LedgerEntryData = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.claimableBalance")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.data")
  @js.native
  def data(value: typings.stellarBase.xdrMod.xdr.DataEntry): typings.stellarBase.xdrMod.xdr.LedgerEntryData = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerEntryData.write")
  @js.native
