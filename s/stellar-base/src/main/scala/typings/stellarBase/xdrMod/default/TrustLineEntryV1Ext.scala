...
@JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext")
@js.native
class TrustLineEntryV1Ext ()
  extends typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext
object TrustLineEntryV1Ext {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TrustLineEntryV1Ext.0")
  @js.native
