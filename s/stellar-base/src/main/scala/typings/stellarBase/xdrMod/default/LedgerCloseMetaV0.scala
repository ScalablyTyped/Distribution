...
@JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0")
@js.native
class LedgerCloseMetaV0 protected ()
  extends typings.stellarBase.xdrMod.xdr.LedgerCloseMetaV0 {
  def this(attributes: typings.stellarBase.anon.LedgerHeader) = this()
}
object LedgerCloseMetaV0 {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.LedgerCloseMetaV0): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.LedgerCloseMetaV0 = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.LedgerCloseMetaV0): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerCloseMetaV0.write")
  @js.native
