...
@JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext")
@js.native
...
object AccountEntryExtensionV1Ext {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV1Ext): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV1Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV1Ext): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV1Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.0")
  @js.native
  def `0`(): typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV1Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV1Ext.2")
  @js.native
