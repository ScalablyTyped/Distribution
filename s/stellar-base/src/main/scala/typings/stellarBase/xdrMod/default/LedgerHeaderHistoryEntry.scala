...
@JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry")
@js.native
class LedgerHeaderHistoryEntry protected ()
  extends typings.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntry {
  def this(attributes: typings.stellarBase.anon.Hash) = this()
}
object LedgerHeaderHistoryEntry {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntry): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntry = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.LedgerHeaderHistoryEntry): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.LedgerHeaderHistoryEntry.write")
  @js.native
