...
@JSImport("stellar-base/types/xdr", "AccountEntryExtensionV2")
@js.native
class AccountEntryExtensionV2 protected ()
  extends typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2 {
  def this(attributes: NumSponsored) = this()
}
/* static members */
@JSImport("stellar-base/types/xdr", "AccountEntryExtensionV2")
@js.native
object AccountEntryExtensionV2 extends js.Object {
