...
@JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom")
@js.native
class ClaimOfferAtom protected ()
  extends typings.stellarBase.xdrMod.xdr.ClaimOfferAtom {
  def this(attributes: AmountBought) = this()
}
object ClaimOfferAtom {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.ClaimOfferAtom): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.ClaimOfferAtom = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.ClaimOfferAtom): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.ClaimOfferAtom.write")
  @js.native
