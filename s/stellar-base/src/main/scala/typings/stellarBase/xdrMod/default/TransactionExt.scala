...
@JSImport("stellar-base/types/xdr", "default.TransactionExt")
@js.native
class TransactionExt ()
  extends typings.stellarBase.xdrMod.xdr.TransactionExt
object TransactionExt {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.TransactionExt): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.TransactionExt = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.TransactionExt): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TransactionExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.TransactionExt.0")
  @js.native
