...
@JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp")
@js.native
class BeginSponsoringFutureReservesOp protected ()
  extends typings.stellarBase.xdrMod.xdr.BeginSponsoringFutureReservesOp {
  def this(attributes: SponsoredId) = this()
}
object BeginSponsoringFutureReservesOp {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.BeginSponsoringFutureReservesOp): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.BeginSponsoringFutureReservesOp = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.BeginSponsoringFutureReservesOp): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BeginSponsoringFutureReservesOp.write")
  @js.native
