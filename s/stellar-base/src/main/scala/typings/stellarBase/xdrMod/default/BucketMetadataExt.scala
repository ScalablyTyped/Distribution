...
@JSImport("stellar-base/types/xdr", "default.BucketMetadataExt")
@js.native
class BucketMetadataExt ()
  extends typings.stellarBase.xdrMod.xdr.BucketMetadataExt
object BucketMetadataExt {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.BucketMetadataExt): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.BucketMetadataExt = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.BucketMetadataExt): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.BucketMetadataExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.BucketMetadataExt.0")
  @js.native
