...
@JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext")
@js.native
class AccountEntryExtensionV2Ext ()
  extends typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext
object AccountEntryExtensionV2Ext {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.AccountEntryExtensionV2Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.AccountEntryExtensionV2Ext.0")
  @js.native
