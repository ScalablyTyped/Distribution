...
@JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta")
@js.native
...
object UpgradeEntryMeta {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.UpgradeEntryMeta): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.UpgradeEntryMeta = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.UpgradeEntryMeta): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.UpgradeEntryMeta.write")
  @js.native
