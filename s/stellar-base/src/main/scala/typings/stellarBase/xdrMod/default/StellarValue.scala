...
@JSImport("stellar-base/types/xdr", "default.StellarValue")
@js.native
...
object StellarValue {
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.StellarValue): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.StellarValue = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.StellarValue): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.StellarValue.write")
  @js.native
