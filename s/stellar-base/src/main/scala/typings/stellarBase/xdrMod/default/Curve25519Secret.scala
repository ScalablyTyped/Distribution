...
@JSImport("stellar-base/types/xdr", "default.Curve25519Secret")
@js.native
class Curve25519Secret protected ()
  extends typings.stellarBase.xdrMod.xdr.Curve25519Secret {
  def this(attributes: Key) = this()
}
object Curve25519Secret {
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.isValid")
  @js.native
  def isValid(value: typings.stellarBase.xdrMod.xdr.Curve25519Secret): Boolean = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.read")
  @js.native
  def read(io: Buffer): typings.stellarBase.xdrMod.xdr.Curve25519Secret = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.toXDR")
  @js.native
  def toXDR(value: typings.stellarBase.xdrMod.xdr.Curve25519Secret): Buffer = js.native
  
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.validateXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base/types/xdr", "default.Curve25519Secret.write")
  @js.native
