...
@JSImport("stellar-base", "xdr.TrustLineEntryV1Ext")
@js.native
class TrustLineEntryV1Ext ()
  extends typings.stellarBase.xdrMod.default.TrustLineEntryV1Ext
object TrustLineEntryV1Ext {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TrustLineEntryV1Ext.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TrustLineEntryV1Ext.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TrustLineEntryV1Ext, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.TrustLineEntryV1Ext.0")
  @js.native
