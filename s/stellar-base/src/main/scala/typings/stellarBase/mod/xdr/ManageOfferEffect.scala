...
@JSImport("stellar-base", "xdr.ManageOfferEffect")
@js.native
class ManageOfferEffect ()
  extends typings.stellarBase.xdrMod.default.ManageOfferEffect
object ManageOfferEffect {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ManageOfferEffect.manageOfferCreated")
  @js.native
  def manageOfferCreated(): typings.stellarBase.xdrMod.xdr.ManageOfferEffect = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.ManageOfferEffect.manageOfferDeleted")
  @js.native
  def manageOfferDeleted(): typings.stellarBase.xdrMod.xdr.ManageOfferEffect = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.ManageOfferEffect.manageOfferUpdated")
  @js.native
