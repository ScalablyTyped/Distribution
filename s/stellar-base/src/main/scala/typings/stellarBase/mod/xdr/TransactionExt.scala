...
class TransactionExt ()
  extends typings.stellarBase.xdrMod.default.TransactionExt
object TransactionExt {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionExt.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.TransactionExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionExt.0")
  @js.native
