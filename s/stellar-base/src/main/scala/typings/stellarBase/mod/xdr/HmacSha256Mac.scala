...
object HmacSha256Mac {
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.HmacSha256Mac.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.HmacSha256Mac.write")
  @js.native
