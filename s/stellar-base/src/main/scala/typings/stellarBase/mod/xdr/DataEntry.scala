...
class DataEntry protected ()
  extends typings.stellarBase.xdrMod.default.DataEntry {
  def this(attributes: typings.stellarBase.anon.DataValue) = this()
}
object DataEntry {
  
  /* static member */
  @JSImport("stellar-base", "xdr.DataEntry.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.DataEntry.write")
  @js.native
