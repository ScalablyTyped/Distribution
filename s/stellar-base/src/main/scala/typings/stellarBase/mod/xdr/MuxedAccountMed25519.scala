...
@JSImport("stellar-base", "xdr.MuxedAccountMed25519")
@js.native
class MuxedAccountMed25519 protected ()
  extends typings.stellarBase.xdrMod.default.MuxedAccountMed25519 {
  def this(attributes: Ed25519) = this()
}
object MuxedAccountMed25519 {
  
  /* static member */
  @JSImport("stellar-base", "xdr.MuxedAccountMed25519.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.MuxedAccountMed25519.write")
  @js.native
