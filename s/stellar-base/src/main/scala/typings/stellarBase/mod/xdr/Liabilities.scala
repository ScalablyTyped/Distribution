...
@JSImport("stellar-base", "xdr.Liabilities")
@js.native
class Liabilities protected ()
  extends typings.stellarBase.xdrMod.default.Liabilities {
  def this(attributes: Selling) = this()
}
object Liabilities {
  
  /* static member */
  @JSImport("stellar-base", "xdr.Liabilities.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.Liabilities.write")
  @js.native
