...
@js.native
trait RevokeTrustlineSponsorship extends BaseOptions {
...
object RevokeTrustlineSponsorship {
  ...
  @scala.inline
  implicit class RevokeTrustlineSponsorshipOps[Self <: RevokeTrustlineSponsorship] (val x: Self) extends AnyVal {
