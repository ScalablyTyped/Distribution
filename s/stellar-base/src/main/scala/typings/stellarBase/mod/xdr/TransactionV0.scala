...
@JSImport("stellar-base", "xdr.TransactionV0")
@js.native
class TransactionV0 protected ()
  extends typings.stellarBase.xdrMod.default.TransactionV0 {
  def this(attributes: Ext) = this()
}
object TransactionV0 {
  
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionV0.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.TransactionV0.write")
  @js.native
