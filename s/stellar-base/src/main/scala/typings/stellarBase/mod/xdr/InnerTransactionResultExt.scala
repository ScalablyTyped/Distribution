...
@JSImport("stellar-base", "xdr.InnerTransactionResultExt")
@js.native
class InnerTransactionResultExt ()
  extends typings.stellarBase.xdrMod.default.InnerTransactionResultExt
object InnerTransactionResultExt {
  
  /* static member */
  @JSImport("stellar-base", "xdr.InnerTransactionResultExt.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.InnerTransactionResultExt.write")
  @js.native
  def write(value: typings.stellarBase.xdrMod.xdr.InnerTransactionResultExt, io: Buffer): Unit = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.InnerTransactionResultExt.0")
  @js.native
