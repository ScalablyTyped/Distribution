...
@JSImport("stellar-base", "xdr.LedgerEntryExtensionV1")
@js.native
class LedgerEntryExtensionV1 protected ()
  extends typings.stellarBase.xdrMod.default.LedgerEntryExtensionV1 {
  def this(attributes: SponsoringId) = this()
}
object LedgerEntryExtensionV1 {
  
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerEntryExtensionV1.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerEntryExtensionV1.write")
  @js.native
