...
@JSImport("stellar-base", "xdr.LedgerKeyOffer")
@js.native
class LedgerKeyOffer protected ()
  extends typings.stellarBase.xdrMod.default.LedgerKeyOffer {
  def this(attributes: SellerId) = this()
}
object LedgerKeyOffer {
  
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyOffer.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyOffer.write")
  @js.native
