...
class ManageBuyOfferOp protected ()
  extends typings.stellarBase.xdrMod.default.ManageBuyOfferOp {
  def this(attributes: BuyAmount) = this()
}
object ManageBuyOfferOp {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ManageBuyOfferOp.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ManageBuyOfferOp.write")
  @js.native
