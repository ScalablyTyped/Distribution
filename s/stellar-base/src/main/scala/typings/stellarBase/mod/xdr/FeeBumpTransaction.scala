...
class FeeBumpTransaction protected ()
  extends typings.stellarBase.xdrMod.default.FeeBumpTransaction {
  def this(attributes: FeeSource) = this()
}
object FeeBumpTransaction {
  
  /* static member */
  @JSImport("stellar-base", "xdr.FeeBumpTransaction.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.FeeBumpTransaction.write")
  @js.native
