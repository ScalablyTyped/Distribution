...
@JSImport("stellar-base", "xdr.LedgerKeyClaimableBalance")
@js.native
class LedgerKeyClaimableBalance protected ()
  extends typings.stellarBase.xdrMod.default.LedgerKeyClaimableBalance {
  def this(attributes: BalanceId) = this()
}
object LedgerKeyClaimableBalance {
  
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyClaimableBalance.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.LedgerKeyClaimableBalance.write")
  @js.native
