...
@JSImport("stellar-base", "xdr.ClaimableBalanceId")
@js.native
class ClaimableBalanceId ()
  extends typings.stellarBase.xdrMod.default.ClaimableBalanceId
object ClaimableBalanceId {
  
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceId.claimableBalanceIdTypeV0")
  @js.native
  def claimableBalanceIdTypeV0(value: Buffer): typings.stellarBase.xdrMod.xdr.ClaimableBalanceId = js.native
  
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceId.fromXDR")
  @js.native
  ...
  /* static member */
  @JSImport("stellar-base", "xdr.ClaimableBalanceId.write")
  @js.native
