...
object InitializerContext {
  ...
  @scala.inline
  implicit class InitializerContextOps[Self <: InitializerContext[_, _], Obj, /* <: typings.stampit.mod.StampSignature */ S̤t̤a̤m̤p̤] (val x: Self with (InitializerContext[Obj, S̤t̤a̤m̤p̤])) extends AnyVal {
    @scala.inline
