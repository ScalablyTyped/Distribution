...
class Database protected ()
  ...
  def this(filename: java.lang.String, callback: js.Function1[/* err */ nodeLib.Error | scala.Null, scala.Unit]) = this()
  def this(filename: java.lang.String, mode: scala.Double) = this()
  def this(filename: java.lang.String, mode: scala.Double, callback: js.Function1[/* err */ nodeLib.Error | scala.Null, scala.Unit]) = this()
  ...
  def close(callback: js.Function1[/* err */ nodeLib.Error | scala.Null, scala.Unit]): scala.Unit = js.native
  @JSName("configure")
  ...
  def exec(
    sql: java.lang.String,
    callback: js.ThisFunction1[/* this */ Statement, /* err */ nodeLib.Error | scala.Null, scala.Unit]
  ): this.type = js.native
