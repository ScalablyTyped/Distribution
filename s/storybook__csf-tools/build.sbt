...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-element-to-jsx-string" % "15.0.0-285329",
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.13-3d37b4",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-18dfea",
  "org.scalablytyped" %%% "storybook__react" % "6.5.13-86a8a6",
