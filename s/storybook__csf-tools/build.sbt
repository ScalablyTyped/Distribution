...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.13-1004e7",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-7f8b9f",
  "org.scalablytyped" %%% "storybook__react" % "6.5.13-30a0cd",
