...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-element-to-jsx-string" % "15.0.0-fee673",
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.13-e5fa5f",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-3353e8",
  "org.scalablytyped" %%% "storybook__react" % "6.5.13-0227af",
