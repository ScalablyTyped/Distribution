...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.13-ccf355",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-3a9e11",
  "org.scalablytyped" %%% "storybook__react" % "6.5.13-23769c",
