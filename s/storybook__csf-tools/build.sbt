...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.12-337b5e",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-77e2d6",
  "org.scalablytyped" %%% "storybook__react" % "6.5.12-d40b39",
