...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.12-44e12d",
  "org.scalablytyped" %%% "storybook__mdx1-csf" % "0.0.4-366528",
  "org.scalablytyped" %%% "storybook__react" % "6.5.12-81fad4",
