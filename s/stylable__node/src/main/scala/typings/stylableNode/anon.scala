...
object anon {
  ...
  object Errors {
    ...
    inline def apply(errors: js.Array[Error], result: js.Array[String]): Errors = {
    ...
    extension [Self <: Errors](x: Self) {
      ...
      inline def setResultVarargs(value: String*): Self = StObject.set(x, "result", js.Array(value :_*))
    }
  }
