...
import typings.sugarDashCore.sugarjs.Array.ChainableBase
...
object Array extends js.Object {
  ...
  type Chainable[T, RawValue] = (ChainableBase[T, RawValue]) with typings.sugarDashCore.sugarjs.Object.ChainableBase[RawValue]
}
