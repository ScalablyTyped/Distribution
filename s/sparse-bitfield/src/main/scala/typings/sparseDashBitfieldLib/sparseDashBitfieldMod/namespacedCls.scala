...
@js.native
class namespacedCls ()
  extends sparseDashBitfieldLib.sparseDashBitfieldMod.BitFieldNs.BitFieldInstance {
  def this(bufferOrOptions: nodeLib.Buffer) = this()
  def this(bufferOrOptions: sparseDashBitfieldLib.sparseDashBitfieldMod.BitFieldNs.Options) = this()
  /**
    ...
    */
  /* CompleteClass */
  override val pages: memoryDashPagerLib.memoryDashPagerMod.PagerNs.PagerInstance = js.native
  /**
