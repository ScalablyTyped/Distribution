...
class V1PaymentTax () extends js.Object {
  ...
  /**
    ...
    */
  var fee_id: js.UndefOr[java.lang.String] = js.native
  /**
    ...
    */
  var inclusion_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1PaymentTaxNs.InclusionTypeEnum] = js.native
  /**
