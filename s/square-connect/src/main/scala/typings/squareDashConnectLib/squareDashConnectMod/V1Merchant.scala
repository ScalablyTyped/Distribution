...
class V1Merchant () extends js.Object {
  /**
    ...
    */
  var account_capabilities: js.UndefOr[js.Array[java.lang.String]] = js.native
  /**
    ...
    * possible values
    */
  var account_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1MerchantNs.AccountTypeEnum] = js.native
  /**
  ...
  /**
    ...
    * possible values
    */
  var business_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1MerchantNs.BusinessTypeEnum] = js.native
  /**
  ...
  /**
    ...
    */
  var market_url: js.UndefOr[java.lang.String] = js.native
  /**
