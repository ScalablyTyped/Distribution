...
class V1Item () extends js.Object {
  ...
  /**
    ...
    */
  var color: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1ItemNs.ColorEnum] = js.native
  /**
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1ItemNs.TypeEnum] = js.native
  /**
  ...
  /**
    ...
    */
  var visibility: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1ItemNs.VisibilityEnum] = js.native
}
