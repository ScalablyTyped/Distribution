...
class V1PaymentItemization () extends js.Object {
  ...
  /**
    ...
    */
  var item_variation_name: js.UndefOr[java.lang.String] = js.native
  /**
    ...
    */
  var itemization_type: js.UndefOr[
    squareDashConnectLib.squareDashConnectMod.V1PaymentItemizationNs.ItemizationTypeEnum
  ] = js.native
  /**
