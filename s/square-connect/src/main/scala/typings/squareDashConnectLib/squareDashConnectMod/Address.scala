...
class Address () extends js.Object {
  /**
    ...
    */
  var address_line_1: js.UndefOr[java.lang.String] = js.native
  /**
    * The second line of the address, if any.
    */
  var address_line_2: js.UndefOr[java.lang.String] = js.native
  /**
    * The third line of the address, if any.
    */
  var address_line_3: js.UndefOr[java.lang.String] = js.native
  /**
    * A civil entity within the address's country. In the US, this is the state.
    */
  var administrative_district_level_1: js.UndefOr[java.lang.String] = js.native
  /**
    * A civil entity within the address's `administrative_district_level_1`. In the US, this is the county.
    */
  var administrative_district_level_2: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var locality: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var postal_code: js.UndefOr[java.lang.String] = js.native
  /**
    * A civil region within the address's `locality`, if any.
    */
  var sublocality: js.UndefOr[java.lang.String] = js.native
  /**
    * A civil region within the address's `sublocality`, if any.
    */
  var sublocality_2: js.UndefOr[java.lang.String] = js.native
  /**
    * A civil region within the address's `sublocality_2`, if any.
    */
  var sublocality_3: js.UndefOr[java.lang.String] = js.native
}
