...
class V1ListTimecardsRequest () extends js.Object {
  ...
  /**
    ...
    * format.
    */
  var begin_clockin_time: js.UndefOr[java.lang.String] = js.native
  /**
    * If filtering results by their clockout_time field, the beginning of the requested reporting period, in ISO 8601
    * format.
    */
  var begin_clockout_time: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var end_clockin_time: js.UndefOr[java.lang.String] = js.native
  /**
    * If filtering results by their clockout_time field, the end of the requested reporting period, in ISO 8601 format.
    */
  var end_clockout_time: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var order: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1ListTimecardsRequestNs.OrderEnum] = js.native
}
