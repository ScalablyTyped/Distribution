...
class V1ListPaymentsRequest () extends js.Object {
  ...
  /**
    ...
    */
  var include_partial: js.UndefOr[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  var order: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1ListPaymentsRequestNs.OrderEnum] = js.native
}
