...
class CustomerSort () extends js.Object {
  /**
    ...
    */
  var field: js.UndefOr[squareDashConnectLib.squareDashConnectMod.CustomerSortNs.FieldEnum] = js.native
  /**
    ...
    */
  var order: js.UndefOr[squareDashConnectLib.squareDashConnectMod.CustomerSortNs.OrderEnum] = js.native
}
