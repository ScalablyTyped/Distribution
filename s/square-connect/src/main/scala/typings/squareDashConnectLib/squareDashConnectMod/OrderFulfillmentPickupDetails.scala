...
class OrderFulfillmentPickupDetails () extends js.Object {
  ...
  /**
    ...
    */
  var auto_complete_duration: js.UndefOr[java.lang.String] = js.native
  /**
    * A description of why the pickup was canceled. Max length is 100 characters.
    */
  var cancel_reason: js.UndefOr[java.lang.String] = js.native
  /**
    * The [timestamp](#workingwithdates) in RFC3339 timestamp format, e.g., \"2016-09-04T23:59:33.123Z\", indicating
    * when the fulfillment was canceled by the merchant or buyer.
    */
  var canceled_at: js.UndefOr[java.lang.String] = js.native
  /**
    * The [timestamp](#workingwithdates) in RFC3339 timestamp format, e.g., \"2016-09-04T23:59:33.123Z\", indicating
  ...
  /**
    ...
    */
  var pickup_window_duration: js.UndefOr[java.lang.String] = js.native
  /**
    * The [timestamp](#workingwithdates) in RFC3339 timestamp format, e.g., \"2016-09-04T23:59:33.123Z\", indicating
    * when the fulfillment was placed.
    */
  var placed_at: js.UndefOr[java.lang.String] = js.native
  /**
    ...
    */
  var prep_time_duration: js.UndefOr[java.lang.String] = js.native
  /**
    * The [timestamp](#workingwithdates) in RFC3339 timestamp format, e.g., \"2016-09-04T23:59:33.123Z\", indicating
    * when the merchant set the fulfillment as ready for pickup.
    */
  var ready_at: js.UndefOr[java.lang.String] = js.native
  /**
