...
class OrderReturnTax () extends js.Object {
  ...
  /**
    ...
    */
  var scope: js.UndefOr[squareDashConnectLib.squareDashConnectMod.OrderReturnTaxNs.ScopeEnum] = js.native
  /**
    * `uid` of the Tax from the Order which contains the original charge of this tax.
    */
  var source_tax_uid: js.UndefOr[java.lang.String] = js.native
  /**
    * Indicates the calculation method used to apply the tax.
    * See [OrderLineItemTaxType](#type-orderlineitemtaxtype) for possible values.
    */
  var `type`: js.UndefOr[squareDashConnectLib.squareDashConnectMod.OrderReturnTaxNs.TypeEnum] = js.native
  /**
