...
class V1CashDrawerShift () extends js.Object {
  ...
  /**
    ...
    */
  var closing_employee_id: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var employee_ids: js.UndefOr[js.Array[java.lang.String]] = js.native
  /**
    * The time when the shift ended, in ISO 8601 format.
    */
  var ended_at: js.UndefOr[java.lang.String] = js.native
  /**
    * The ID of the employee that ended the cash drawer shift.
    */
  var ending_employee_id: js.UndefOr[java.lang.String] = js.native
  /**
    * The shift's current state. See [V1CashDrawerShiftEventType](#type-v1cashdrawershifteventtype) for possible values
    */
  var event_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1CashDrawerShiftNs.EventTypeEnum] = js.native
  /**
  ...
  /**
    ...
    */
  var opened_at: js.UndefOr[java.lang.String] = js.native
  /**
    * The ID of the employee that started the cash drawer shift.
    */
  var opening_employee_id: js.UndefOr[java.lang.String] = js.native
  /**
