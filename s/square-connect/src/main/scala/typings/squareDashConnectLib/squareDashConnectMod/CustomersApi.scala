...
class CustomersApi () extends js.Object {
  /**
    ...
    */
  def createCustomer(params: CreateCustomerRequest): js.Promise[CreateCustomerResponse] = js.native
  /**
  ...
  /**
    ...
    */
  def deleteCustomerCard(params: DeleteCustomerCardRequest): js.Promise[DeleteCustomerCardResponse] = js.native
  /**
    * Lists a business's customers.
    */
  def listCustomers(params: ListCustomersRequest): js.Promise[ListCustomersResponse] = js.native
  /**
    * Returns details for a single customer.
    */
  def retrieveCustomer(params: RetrieveCustomerRequest): js.Promise[RetrieveCustomerResponse] = js.native
  /**
    ...
    */
  def searchCustomers(params: SearchCustomersRequest): js.Promise[SearchCustomersResponse] = js.native
  /**
    ...
    */
  def updateCustomer(params: UpdateCustomerRequest): js.Promise[UpdateCustomerResponse] = js.native
}
