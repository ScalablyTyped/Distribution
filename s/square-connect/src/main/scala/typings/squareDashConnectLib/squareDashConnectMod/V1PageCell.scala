...
class V1PageCell () extends js.Object {
  ...
  /**
    ...
    * PLACEHOLDER.
    */
  var object_id: js.UndefOr[java.lang.String] = js.native
  /**
    ...
    */
  var object_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1PageCellNs.ObjectTypeEnum] = js.native
  /**
    * The unique identifier of the page the cell is included on.
    */
  var page_id: js.UndefOr[java.lang.String] = js.native
  /**
    ...
    */
  var placeholder_type: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1PageCellNs.PlaceholderTypeEnum] = js.native
  /**
    * The row of the cell. Always an integer between 0 and 4, inclusive.
    */
  var row: js.UndefOr[scala.Double] = js.native
}
