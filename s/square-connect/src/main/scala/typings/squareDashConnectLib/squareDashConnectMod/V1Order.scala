...
class V1Order () extends js.Object {
  /**
    ...
    */
  var btc_price_satoshi: js.UndefOr[scala.Double] = js.native
  /**
    * For Bitcoin transactions, the address that the buyer sent Bitcoin to.
    */
  var btc_receive_address: js.UndefOr[java.lang.String] = js.native
  /**
    * The email address of the order's buyer.
    */
  var buyer_email: js.UndefOr[java.lang.String] = js.native
  /**
    * A note provided by the buyer when the order was created, if any.
    */
  var buyer_note: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var payment_id: js.UndefOr[java.lang.String] = js.native
  /**
    * The promo code provided by the buyer, if any.
    */
  var promo_code: js.UndefOr[java.lang.String] = js.native
  /**
    * The name of the order's buyer.
    */
  var recipient_name: js.UndefOr[java.lang.String] = js.native
  /**
    * The phone number to use for the order's delivery.
    */
  var recipient_phone_number: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    * values
    */
  var state: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1OrderNs.StateEnum] = js.native
  /**
