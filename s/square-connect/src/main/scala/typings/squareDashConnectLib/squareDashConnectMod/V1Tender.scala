...
class V1Tender () extends js.Object {
  ...
  /**
    ...
    */
  var is_exchange: js.UndefOr[scala.Boolean] = js.native
  /**
  ...
  /**
    ...
    */
  var settled_at: js.UndefOr[java.lang.String] = js.native
  /**
    * The time when the tender was created, in ISO 8601 format.
    */
  var tendered_at: js.UndefOr[java.lang.String] = js.native
  /**
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[squareDashConnectLib.squareDashConnectMod.V1TenderNs.TypeEnum] = js.native
}
