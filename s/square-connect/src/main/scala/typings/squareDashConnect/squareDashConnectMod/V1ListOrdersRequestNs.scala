...
@js.native
object V1ListOrdersRequestNs extends js.Object {
  @js.native
  ...
  object OrderEnum extends js.Object {
    ...
    /* "ASC" */ val ASC: typings.squareDashConnect.squareDashConnectMod.V1ListOrdersRequestNs.OrderEnum.ASC with String = js.native
    /* "DESC" */ val DESC: typings.squareDashConnect.squareDashConnectMod.V1ListOrdersRequestNs.OrderEnum.DESC with String = js.native
    @JSBracketAccess
