...
object ListRefundsRequestNs extends js.Object {
  ...
  object SortOrderEnum extends js.Object {
    ...
    /* "ASC" */ val ASC: typings.squareDashConnect.squareDashConnectMod.ListRefundsRequestNs.SortOrderEnum.ASC with String = js.native
    /* "DESC" */ val DESC: typings.squareDashConnect.squareDashConnectMod.ListRefundsRequestNs.SortOrderEnum.DESC with String = js.native
    @JSBracketAccess
