...
object V1ListPaymentsRequestNs extends js.Object {
  ...
  object OrderEnum extends js.Object {
    ...
    /* "ASC" */ val ASC: typings.squareDashConnect.squareDashConnectMod.V1ListPaymentsRequestNs.OrderEnum.ASC with String = js.native
    /* "DESC" */ val DESC: typings.squareDashConnect.squareDashConnectMod.V1ListPaymentsRequestNs.OrderEnum.DESC with String = js.native
    @JSBracketAccess
