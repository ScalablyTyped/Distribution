...
object V1CreateRefundRequestNs extends js.Object {
  ...
  object TypeEnum extends js.Object {
    ...
    /* "FULL" */ val FULL: typings.squareDashConnect.squareDashConnectMod.V1CreateRefundRequestNs.TypeEnum.FULL with String = js.native
    /* "PARTIAL" */ val PARTIAL: typings.squareDashConnect.squareDashConnectMod.V1CreateRefundRequestNs.TypeEnum.PARTIAL with String = js.native
    @JSBracketAccess
