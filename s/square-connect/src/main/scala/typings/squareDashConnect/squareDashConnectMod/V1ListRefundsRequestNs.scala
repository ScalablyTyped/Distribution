...
object V1ListRefundsRequestNs extends js.Object {
  ...
  object OrderEnum extends js.Object {
    ...
    /* "ASC" */ val ASC: typings.squareDashConnect.squareDashConnectMod.V1ListRefundsRequestNs.OrderEnum.ASC with String = js.native
    /* "DESC" */ val DESC: typings.squareDashConnect.squareDashConnectMod.V1ListRefundsRequestNs.OrderEnum.DESC with String = js.native
    @JSBracketAccess
