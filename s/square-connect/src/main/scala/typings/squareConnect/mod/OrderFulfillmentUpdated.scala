...
@JSImport("square-connect", "OrderFulfillmentUpdated")
@js.native
open class OrderFulfillmentUpdated () extends StObject {
  ...
  /**
    ...
    */
  var fulfillment_update: js.UndefOr[js.Array[OrderFulfillmentUpdatedUpdate]] = js.native
