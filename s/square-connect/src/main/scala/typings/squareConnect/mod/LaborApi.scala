...
/**
  ...
  */
open class LaborApi () extends StObject {
  ...
  /**
    ...
    */
  def createBreakType(args: Any*): js.Promise[CreateBreakTypeResponse] = js.native
  ...
  /**
    ...
    */
  def createShift(args: Any*): js.Promise[CreateShiftResponse] = js.native
  
  /**
    * Deletes an existing `BreakType`. A `BreakType` can be deleted even if it is referenced from a `Shift`.
    */
  def deleteBreakType(args: Any*): js.Promise[DeleteBreakTypeResponse] = js.native
  
  /**
    * Deletes a `Shift`.
    */
  def deleteShift(args: Any*): js.Promise[DeleteShiftResponse] = js.native
  
  /**
    * Returns a single `BreakType` specified by id.
    */
  def getBreakType(args: Any*): js.Promise[GetBreakTypeResponse] = js.native
  
  /**
    * Returns a single `EmployeeWage` specified by id.
    */
  def getEmployeeWage(args: Any*): js.Promise[GetEmployeeWageResponse] = js.native
  
  /**
    * Returns a single `Shift` specified by id.
    */
  def getShift(args: Any*): js.Promise[GetShiftResponse] = js.native
  
  /**
    * Returns a paginated list of `BreakType` instances for a business.
    */
  def listBreakTypes(args: Any*): js.Promise[ListBreakTypesResponse] = js.native
  
  /**
    * Returns a paginated list of `EmployeeWage` instances for a business.
    */
  def listEmployeeWages(args: Any*): js.Promise[ListEmployeeWagesResponse] = js.native
  
  /**
    * Returns a list of `WorkweekConfig` instances for a business.
    */
  def listWorkweekConfigs(args: Any*): js.Promise[ListWorkweekConfigsResponse] = js.native
  ...
  /**
    ...
    */
  def searchShifts(args: Any*): js.Promise[SearchShiftsResponse] = js.native
  
  /**
    * Updates an existing `BreakType`.
    */
  def updateBreakType(args: Any*): js.Promise[UpdateBreakTypeResponse] = js.native
  ...
  /**
    ...
    */
  def updateShift(args: Any*): js.Promise[UpdateShiftResponse] = js.native
  
  /**
    * Updates a `WorkweekConfig`.
    */
  def updateWorkweekConfig(args: Any*): js.Promise[UpdateWorkweekConfigResponse] = js.native
}
