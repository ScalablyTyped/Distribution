...
import typings.scriptDashExtDashHtmlDashWebpackDashPlugin.scriptDashExtDashHtmlDashWebpackDashPluginStrings.defer
import typings.scriptDashExtDashHtmlDashWebpackDashPlugin.scriptDashExtDashHtmlDashWebpackDashPluginStrings.sync
