...
import typings.shakacodeRecompose.anon.Children
...
object mod {
  ...
  @JSImport("@shakacode/recompose", "onlyUpdateForPropTypes")
  @js.native
  ...
  @JSImport("@shakacode/recompose", "renderNothing")
  @js.native
  ...
  @JSImport("@shakacode/recompose", "toClass")
  @js.native
  ...
  {[ P in keyof THandlers ]: (props : TOutter): THandlers[P]}
    */ typings.shakacodeRecompose.shakacodeRecomposeStrings.HandleCreatorsHandlers & TopLevel[THandlers]
  ...
  {[ updaterName in keyof TUpdaters ]: (state : TState, props : TOutter): TUpdaters[updaterName]}
    */ typings.shakacodeRecompose.shakacodeRecomposeStrings.StateUpdaters & TopLevel[TUpdaters]
