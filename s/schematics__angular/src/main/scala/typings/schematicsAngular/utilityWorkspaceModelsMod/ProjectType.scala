...
object ProjectType extends StObject {
  ...
  sealed trait Application
    extends StObject
       with ProjectType
  /* "application" */ val Application: typings.schematicsAngular.utilityWorkspaceModelsMod.ProjectType.Application & String = js.native
  
  @js.native
  sealed trait Library
    extends StObject
       with ProjectType
  /* "library" */ val Library: typings.schematicsAngular.utilityWorkspaceModelsMod.ProjectType.Library & String = js.native
}
