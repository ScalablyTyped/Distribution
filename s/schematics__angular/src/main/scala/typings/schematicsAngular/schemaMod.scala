...
object schemaMod {
  ...
  object Style extends StObject {
    ...
    sealed trait Css
      extends StObject
         with Style
    /* "css" */ val Css: typings.schematicsAngular.schemaMod.Style.Css & String = js.native
    
    @js.native
    sealed trait Less
      extends StObject
         with Style
    /* "less" */ val Less: typings.schematicsAngular.schemaMod.Style.Less & String = js.native
    
    @js.native
    sealed trait Sass
      extends StObject
         with Style
    /* "sass" */ val Sass: typings.schematicsAngular.schemaMod.Style.Sass & String = js.native
    
    @js.native
    sealed trait Scss
      extends StObject
         with Style
    /* "scss" */ val Scss: typings.schematicsAngular.schemaMod.Style.Scss & String = js.native
  }
  ...
  object ViewEncapsulation extends StObject {
    ...
    /* "Emulated" */ val Emulated: typings.schematicsAngular.schemaMod.ViewEncapsulation.Emulated & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with ViewEncapsulation
    /* "None" */ val None: typings.schematicsAngular.schemaMod.ViewEncapsulation.None & String = js.native
    
    @js.native
    sealed trait ShadowDom
      extends StObject
         with ViewEncapsulation
    /* "ShadowDom" */ val ShadowDom: typings.schematicsAngular.schemaMod.ViewEncapsulation.ShadowDom & String = js.native
  }
