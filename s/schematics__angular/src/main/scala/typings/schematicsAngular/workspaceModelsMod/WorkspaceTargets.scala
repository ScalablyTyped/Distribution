...
trait WorkspaceTargets[TProjectType /* <: ProjectType */]
  ...
  var build: js.UndefOr[BrowserBuilderTarget | LibraryBuilderTarget] = js.undefined
...
object WorkspaceTargets {
  ...
  extension [Self <: WorkspaceTargets[?], TProjectType /* <: ProjectType */](x: Self & WorkspaceTargets[TProjectType]) {
    ...
    inline def setBuild(value: BrowserBuilderTarget | LibraryBuilderTarget): Self = StObject.set(x, "build", value.asInstanceOf[js.Any])
