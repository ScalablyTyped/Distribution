...
import typings.schematicsAngular.typescriptMod.ImportDeclaration
import typings.schematicsAngular.typescriptMod.ModifierLike
import typings.schematicsAngular.typescriptMod.NamedImportBindings
...
import typings.schematicsAngular.typescriptMod.SyntaxKind.ImportClause
