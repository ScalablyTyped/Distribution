...
import typings.schematicsAngular.typescriptMod.ImportClause
import typings.schematicsAngular.typescriptMod.ImportSpecifier
...
import typings.schematicsAngular.typescriptMod.SyntaxKind.NamedImports
