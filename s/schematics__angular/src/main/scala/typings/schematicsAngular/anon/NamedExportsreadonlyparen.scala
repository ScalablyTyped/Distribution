...
import typings.schematicsAngular.typescriptMod.ExportDeclaration
import typings.schematicsAngular.typescriptMod.ExportSpecifier
...
import typings.schematicsAngular.typescriptMod.SyntaxKind.NamedExports
