...
object utilityDependenciesMod {
  ...
  object NodeDependencyType extends StObject {
    ...
    /* "dependencies" */ val Default: typings.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Default & String = js.native
    
    @js.native
    sealed trait Dev
      extends StObject
         with NodeDependencyType
    /* "devDependencies" */ val Dev: typings.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Dev & String = js.native
    
    @js.native
    sealed trait Optional
      extends StObject
         with NodeDependencyType
    /* "optionalDependencies" */ val Optional: typings.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Optional & String = js.native
    
    @js.native
    sealed trait Peer
      extends StObject
         with NodeDependencyType
    /* "peerDependencies" */ val Peer: typings.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Peer & String = js.native
  }
