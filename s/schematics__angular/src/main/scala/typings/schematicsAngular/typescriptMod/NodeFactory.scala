...
import typings.schematicsAngular.typescriptMod.SyntaxKind.NullKeyword
import typings.schematicsAngular.typescriptMod.SyntaxKind.SuperKeyword
import typings.schematicsAngular.typescriptMod.SyntaxKind.ThisKeyword
...
import typings.schematicsAngular.typescriptMod.SyntaxKind.Unknown
...
trait NodeFactory extends StObject {
  ...
  def createTypeOperatorNode(operator: typings.schematicsAngular.typescriptMod.SyntaxKind.ReadonlyKeyword, `type`: TypeNode): TypeOperatorNode = js.native
