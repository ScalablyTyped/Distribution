...
object InvalidatedProjectKind extends StObject {
  ...
  /* 0 */ val Build: typings.schematicsAngular.typescriptMod.InvalidatedProjectKind.Build & Double = js.native
  
  @js.native
  sealed trait UpdateBundle
    extends StObject
       with InvalidatedProjectKind
  /* 1 */ val UpdateBundle: typings.schematicsAngular.typescriptMod.InvalidatedProjectKind.UpdateBundle & Double = js.native
  
  @js.native
  sealed trait UpdateOutputFileStamps
    extends StObject
       with InvalidatedProjectKind
  /* 2 */ val UpdateOutputFileStamps: typings.schematicsAngular.typescriptMod.InvalidatedProjectKind.UpdateOutputFileStamps & Double = js.native
}
