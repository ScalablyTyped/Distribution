...
trait SourceFile
  ...
  val endOfFileToken: Token[typings.schematicsAngular.typescriptMod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  val kind_SourceFile: typings.schematicsAngular.typescriptMod.SyntaxKind.SourceFile = js.native
