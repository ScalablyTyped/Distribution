...
import typings.schematicsAngular.typescriptMod.CompilerOptions
import typings.schematicsAngular.typescriptMod.Path
import typings.schematicsAngular.typescriptMod.SortedReadonlyArray
import typings.schematicsAngular.typescriptMod.TypeAcquisition
import typings.schematicsAngular.typescriptMod.WatchOptions
