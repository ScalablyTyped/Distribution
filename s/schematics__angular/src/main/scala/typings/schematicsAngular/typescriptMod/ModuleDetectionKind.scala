...
object ModuleDetectionKind extends StObject {
  ...
  /* 2 */ val Auto: typings.schematicsAngular.typescriptMod.ModuleDetectionKind.Auto & Double = js.native
  ...
  sealed trait Force
    extends StObject
       with ModuleDetectionKind
  /* 3 */ val Force: typings.schematicsAngular.typescriptMod.ModuleDetectionKind.Force & Double = js.native
  ...
  sealed trait Legacy
    extends StObject
       with ModuleDetectionKind
  /* 1 */ val Legacy: typings.schematicsAngular.typescriptMod.ModuleDetectionKind.Legacy & Double = js.native
}
