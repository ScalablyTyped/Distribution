...
object LanguageServiceMode extends StObject {
  ...
  /* 1 */ val PartialSemantic: typings.schematicsAngular.typescriptMod.LanguageServiceMode.PartialSemantic & Double = js.native
  
  @js.native
  sealed trait Semantic
    extends StObject
       with LanguageServiceMode
  /* 0 */ val Semantic: typings.schematicsAngular.typescriptMod.LanguageServiceMode.Semantic & Double = js.native
  
  @js.native
  sealed trait Syntactic
    extends StObject
       with LanguageServiceMode
  /* 2 */ val Syntactic: typings.schematicsAngular.typescriptMod.LanguageServiceMode.Syntactic & Double = js.native
}
