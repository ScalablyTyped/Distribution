...
- typings.schematicsAngular.typescriptMod.FlowType because Already inherited
- typings.schematicsAngular.typescriptMod.Type because Already inherited
- typings.schematicsAngular.typescriptMod.ObjectType because Already inherited
- typings.schematicsAngular.typescriptMod.TypeReference because var conflicts: aliasSymbol, aliasTypeArguments, flags, objectFlags, pattern, symbol. Inlined target, node, typeArguments */ trait GenericType
  extends StObject
     with InterfaceType {
