...
object WatchDirectoryFlags extends StObject {
  ...
  /* 0 */ val None: typings.schematicsAngular.typescriptMod.WatchDirectoryFlags.None & Double = js.native
  
  @js.native
  sealed trait Recursive
    extends StObject
       with WatchDirectoryFlags
  /* 1 */ val Recursive: typings.schematicsAngular.typescriptMod.WatchDirectoryFlags.Recursive & Double = js.native
}
