...
import typings.schematicsAngular.schematicsAngularStrings.auto
import typings.schematicsAngular.schematicsAngularStrings.braces
import typings.schematicsAngular.schematicsAngularStrings.double
