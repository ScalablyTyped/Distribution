...
trait IdentifierTypePredicate
  ...
  @JSName("kind")
  var kind_IdentifierTypePredicate: typings.schematicsAngular.typescriptMod.TypePredicateKind.Identifier
...
object IdentifierTypePredicate {
  ...
  extension [Self <: IdentifierTypePredicate](x: Self) {
    ...
    inline def setKind(value: typings.schematicsAngular.typescriptMod.TypePredicateKind.Identifier): Self = StObject.set(x, "kind", value.asInstanceOf[js.Any])
