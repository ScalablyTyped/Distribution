...
object NewLineKind extends StObject {
  ...
  sealed trait CarriageReturnLineFeed
    extends StObject
       with NewLineKind
  /* 0 */ val CarriageReturnLineFeed: typings.schematicsAngular.typescriptMod.NewLineKind.CarriageReturnLineFeed & Double = js.native
  
  @js.native
  sealed trait LineFeed
    extends StObject
       with NewLineKind
  /* 1 */ val LineFeed: typings.schematicsAngular.typescriptMod.NewLineKind.LineFeed & Double = js.native
}
