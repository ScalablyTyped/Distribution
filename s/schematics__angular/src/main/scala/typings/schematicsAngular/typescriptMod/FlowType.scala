...
/* Rewritten from type alias, can be one of: 
  - typings.schematicsAngular.typescriptMod.Type
  - typings.schematicsAngular.typescriptMod.IncompleteType
*/
trait FlowType extends StObject
object FlowType {
  
  inline def IncompleteType(flags: TypeFlags, `type`: Type): typings.schematicsAngular.typescriptMod.IncompleteType = {
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.schematicsAngular.typescriptMod.IncompleteType]
  }
  ...
  inline def Type(
    ...
    getConstraint: () => js.UndefOr[typings.schematicsAngular.typescriptMod.Type],
    getConstructSignatures: () => js.Array[Signature],
    getDefault: () => js.UndefOr[typings.schematicsAngular.typescriptMod.Type],
    getFlags: () => TypeFlags,
    getNonNullableType: () => typings.schematicsAngular.typescriptMod.Type,
    getNumberIndexType: () => js.UndefOr[typings.schematicsAngular.typescriptMod.Type],
    getProperties: () => js.Array[Symbol],
    getProperty: java.lang.String => js.UndefOr[Symbol],
    getStringIndexType: () => js.UndefOr[typings.schematicsAngular.typescriptMod.Type],
    ...
    __obj.asInstanceOf[typings.schematicsAngular.typescriptMod.Type]
  }
}
