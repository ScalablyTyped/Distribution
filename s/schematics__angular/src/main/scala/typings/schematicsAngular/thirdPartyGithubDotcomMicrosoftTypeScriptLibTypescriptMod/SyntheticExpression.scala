...
trait SyntheticExpression
  ...
  @JSName("kind")
  val kind_SyntheticExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.SyntheticExpression = js.native
