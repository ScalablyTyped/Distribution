...
trait TypeParameterDeclaration
  ...
  @JSName("kind")
  val kind_TypeParameterDeclaration: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TypeParameter = js.native
