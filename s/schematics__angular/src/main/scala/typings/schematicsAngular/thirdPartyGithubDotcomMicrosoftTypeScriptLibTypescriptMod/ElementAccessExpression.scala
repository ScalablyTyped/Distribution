...
trait ElementAccessExpression
  ...
  @JSName("kind")
  val kind_ElementAccessExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ElementAccessExpression = js.native
