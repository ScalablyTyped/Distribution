...
trait ClassLikeDeclarationBase
  ...
  @JSName("kind")
  val kind_ClassLikeDeclarationBase: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ClassDeclaration | typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ClassExpression = js.native
