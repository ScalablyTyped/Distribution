...
trait VariableDeclaration
  ...
  @JSName("kind")
  val kind_VariableDeclaration: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.VariableDeclaration = js.native
