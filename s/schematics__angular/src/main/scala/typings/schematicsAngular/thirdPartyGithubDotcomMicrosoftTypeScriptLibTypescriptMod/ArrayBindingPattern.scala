...
trait ArrayBindingPattern
  ...
  @JSName("kind")
  val kind_ArrayBindingPattern: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ArrayBindingPattern = js.native
