...
trait ArrayLiteralExpression
  ...
  @JSName("kind")
  val kind_ArrayLiteralExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ArrayLiteralExpression = js.native
}
