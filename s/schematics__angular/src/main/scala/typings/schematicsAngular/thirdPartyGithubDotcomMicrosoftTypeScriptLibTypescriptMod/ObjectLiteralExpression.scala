...
trait ObjectLiteralExpression
  ...
  @JSName("kind")
  val kind_ObjectLiteralExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ObjectLiteralExpression = js.native
}
