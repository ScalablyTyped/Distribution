...
trait ObjectBindingPattern
  ...
  @JSName("kind")
  val kind_ObjectBindingPattern: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ObjectBindingPattern = js.native
