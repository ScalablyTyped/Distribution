...
trait TaggedTemplateExpression
  ...
  @JSName("kind")
  val kind_TaggedTemplateExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TaggedTemplateExpression = js.native
