...
trait ImportEqualsDeclaration
  ...
  @JSName("kind")
  val kind_ImportEqualsDeclaration: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ImportEqualsDeclaration = js.native
