...
trait TemplateLiteralTypeSpan
  ...
  @JSName("kind")
  val kind_TemplateLiteralTypeSpan: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TemplateLiteralTypeSpan = js.native
