...
trait PropertyAccessExpression
  ...
  @JSName("kind")
  val kind_PropertyAccessExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.PropertyAccessExpression = js.native
