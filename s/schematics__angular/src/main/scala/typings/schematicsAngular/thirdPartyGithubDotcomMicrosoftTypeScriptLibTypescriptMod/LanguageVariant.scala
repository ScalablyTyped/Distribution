...
object LanguageVariant extends StObject {
  ...
  /* 1 */ val JSX: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.LanguageVariant.JSX & Double = js.native
  
  @js.native
  sealed trait Standard
    extends StObject
       with LanguageVariant
  /* 0 */ val Standard: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.LanguageVariant.Standard & Double = js.native
}
