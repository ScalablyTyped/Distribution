...
trait ConditionalExpression
  ...
  @JSName("kind")
  val kind_ConditionalExpression: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ConditionalExpression = js.native
