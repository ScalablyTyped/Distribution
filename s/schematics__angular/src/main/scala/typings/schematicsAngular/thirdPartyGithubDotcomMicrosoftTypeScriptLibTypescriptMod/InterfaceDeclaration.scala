...
trait InterfaceDeclaration
  ...
  @JSName("kind")
  val kind_InterfaceDeclaration: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.InterfaceDeclaration = js.native
