...
trait PropertyAssignment
  ...
  @JSName("kind")
  val kind_PropertyAssignment: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.PropertyAssignment = js.native
