...
trait PropertyDeclaration
  ...
  @JSName("kind")
  val kind_PropertyDeclaration: typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.PropertyDeclaration = js.native
