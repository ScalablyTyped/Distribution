...
- typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.ModuleResolutionHost because var conflicts: directoryExists, getCurrentDirectory. Inlined fileExists, readFile, trace, realpath, getDirectories, useCaseSensitiveFileNames
- typings.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.MinimalResolutionCacheHost because var conflicts: directoryExists, getCurrentDirectory. Inlined getCompilationSettings, getCompilerHost */ @js.native
