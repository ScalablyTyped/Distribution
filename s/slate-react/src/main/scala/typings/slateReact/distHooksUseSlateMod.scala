...
object distHooksUseSlateMod {
  ...
  inline def useSlate(): typings.slate.distInterfacesEditorMod.Editor = ^.asInstanceOf[js.Dynamic].applyDynamic("useSlate")().asInstanceOf[typings.slate.distInterfacesEditorMod.Editor]
