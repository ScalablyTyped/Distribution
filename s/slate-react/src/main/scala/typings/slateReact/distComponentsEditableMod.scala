...
object distComponentsEditableMod {
  ...
  trait RenderElementProps extends StObject {
    ...
    var element: typings.slate.distInterfacesElementMod.Element
  }
  object RenderElementProps {
    ...
    extension [Self <: RenderElementProps](x: Self) {
      ...
      inline def setElement(value: typings.slate.distInterfacesElementMod.Element): Self = StObject.set(x, "element", value.asInstanceOf[js.Any])
    }
  }
