...
import typings.slateReact.editableMod.EditableProps
...
object slateReactMod {
  ...
  object ReactEditor {
    ...
    /**
      * Blur the editor.
      */
    inline def blur(editor: typings.slateReact.reactEditorMod.ReactEditor): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("blur")(editor.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    /**
      * Deselect the editor.
      */
    inline def deselect(editor: typings.slateReact.reactEditorMod.ReactEditor): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("deselect")(editor.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    /**
      * Find the DOM node that implements DocumentOrShadowRoot for the editor.
      */
    inline def findDocumentOrShadowRoot(editor: typings.slateReact.reactEditorMod.ReactEditor): Document | ShadowRoot = ^.asInstanceOf[js.Dynamic].applyDynamic("findDocumentOrShadowRoot")(editor.asInstanceOf[js.Any]).asInstanceOf[Document | ShadowRoot]
    
    /**
      * Get the target range from a DOM `event`.
      */
    inline def findEventRange(editor: typings.slateReact.reactEditorMod.ReactEditor, event: Any): Range = (^.asInstanceOf[js.Dynamic].applyDynamic("findEventRange")(editor.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[Range]
    
    /**
      * Find a key for a Slate node.
      */
    inline def findKey(editor: typings.slateReact.reactEditorMod.ReactEditor, node: Node): Key = (^.asInstanceOf[js.Dynamic].applyDynamic("findKey")(editor.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[Key]
    
    /**
      * Find the path of Slate node.
      */
    inline def findPath(editor: typings.slateReact.reactEditorMod.ReactEditor, node: Node): Path = (^.asInstanceOf[js.Dynamic].applyDynamic("findPath")(editor.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[Path]
    
    /**
      * Focus the editor.
      */
    inline def focus(editor: typings.slateReact.reactEditorMod.ReactEditor): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("focus")(editor.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    /**
      * Return the host window of the current editor.
      */
    inline def getWindow(editor: typings.slateReact.reactEditorMod.ReactEditor): Window = ^.asInstanceOf[js.Dynamic].applyDynamic("getWindow")(editor.asInstanceOf[js.Any]).asInstanceOf[Window]
    
    /**
      * Check if a DOM node is within the editor.
      */
    inline def hasDOMNode(
      editor: typings.slateReact.reactEditorMod.ReactEditor,
    ...
    inline def hasRange(editor: typings.slateReact.reactEditorMod.ReactEditor, range: Range): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("hasRange")(editor.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    
    /**
      * Insert data from a `DataTransfer` into the editor.
      */
    inline def insertData(editor: typings.slateReact.reactEditorMod.ReactEditor, data: DataTransfer): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("insertData")(editor.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    /**
      * Insert fragment data from a `DataTransfer` into the editor.
      */
    inline def insertFragmentData(editor: typings.slateReact.reactEditorMod.ReactEditor, data: DataTransfer): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("insertFragmentData")(editor.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    
    /**
      * Insert text data from a `DataTransfer` into the editor.
      */
    inline def insertTextData(editor: typings.slateReact.reactEditorMod.ReactEditor, data: DataTransfer): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("insertTextData")(editor.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    
    /**
      * Check if the user is currently composing inside the editor.
      */
    inline def isComposing(editor: typings.slateReact.reactEditorMod.ReactEditor): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isComposing")(editor.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    
    /**
      * Check if the editor is focused.
      */
    inline def isFocused(editor: typings.slateReact.reactEditorMod.ReactEditor): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFocused")(editor.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    
    /**
      * Check if the editor is in read-only mode.
      */
    inline def isReadOnly(editor: typings.slateReact.reactEditorMod.ReactEditor): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isReadOnly")(editor.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    
    /**
      * Sets data from the currently selected fragment on a `DataTransfer`.
      */
    inline def setFragmentData(editor: typings.slateReact.reactEditorMod.ReactEditor, data: DataTransfer): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFragmentData")(editor.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    inline def toDOMNode(editor: typings.slateReact.reactEditorMod.ReactEditor, node: Node): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("toDOMNode")(editor.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
    
    /**
      * Find a native DOM selection point from a Slate point.
      */
    inline def toDOMPoint(editor: typings.slateReact.reactEditorMod.ReactEditor, point: Point): DOMPoint = (^.asInstanceOf[js.Dynamic].applyDynamic("toDOMPoint")(editor.asInstanceOf[js.Any], point.asInstanceOf[js.Any])).asInstanceOf[DOMPoint]
    ...
    /**
      ...
      */
    inline def toDOMRange(editor: typings.slateReact.reactEditorMod.ReactEditor, range: Range): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("toDOMRange")(editor.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    /**
      ...
      */
    inline def toSlatePoint[T /* <: Boolean */](editor: typings.slateReact.reactEditorMod.ReactEditor, domPoint: DOMPoint, options: ExactMatch[T]): BasePoint | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("toSlatePoint")(editor.asInstanceOf[js.Any], domPoint.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[BasePoint | Null]
