...
trait DirsFunction extends js.Object {
  /**
  	 ...
  	 */
  def apply(options: java.lang.String): ShellArray | ShellString = js.native
  /**
  	 * Displays the list of currently remembered directories.
  	 *
  	 ...
  	 * @return        Returns an array of paths in the stack, or a single path if +N or -N was specified.
  	 */
  def apply(options: shelljsLib.shelljsLibStrings.`+N`): ShellString = js.native
  /**
  	 * Displays the list of currently remembered directories.
  	 *
  ...
  /**
  	 ...
  	 * @return        Returns an array of paths in the stack, or a single path if +N or -N was specified.
  	 */
  def apply(options: shelljsLib.shelljsLibStrings.`-c`): ShellArray = js.native
}
