...
object ^ extends js.Object {
  ...
  def `dirs_-N`(options: shelljsLib.shelljsLibStrings.`-N`): shelljsLib.shelljsMod.ShellString = js.native
  @JSName("dirs")
  def `dirs_-c`(options: shelljsLib.shelljsLibStrings.`-c`): shelljsLib.shelljsMod.ShellArray = js.native
  ...
  def exec(command: java.lang.String): shelljsLib.shelljsMod.ExecOutputReturnValue = js.native
  ...
  def exec(command: java.lang.String, options: shelljsLib.shelljsMod.ExecOptions): shelljsLib.shelljsMod.ExecOutputReturnValue | nodeLib.childUnderscoreProcessMod.ChildProcess = js.native
  def exec(
  ...
  def find(path: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellArray = js.native
  def grep(
  ...
  def grep(regex_filter: java.lang.String, files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def grep(regex_filter: stdLib.RegExp, files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def head(files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def head(
  ...
  @JSName("popd")
  def `popd_+N`(dir: shelljsLib.shelljsLibStrings.`+N`): shelljsLib.shelljsMod.ShellArray = js.native
  @JSName("popd")
  def `popd_+N`(options: java.lang.String, dir: shelljsLib.shelljsLibStrings.`+N`): shelljsLib.shelljsMod.ShellArray = js.native
  @JSName("popd")
  def `popd_-N`(dir: shelljsLib.shelljsLibStrings.`-N`): shelljsLib.shelljsMod.ShellArray = js.native
  @JSName("popd")
  def `popd_-N`(options: java.lang.String, dir: shelljsLib.shelljsLibStrings.`-N`): shelljsLib.shelljsMod.ShellArray = js.native
  ...
  @JSName("pushd")
  def `pushd_+N`(dir: shelljsLib.shelljsLibStrings.`+N`): shelljsLib.shelljsMod.ShellArray = js.native
  @JSName("pushd")
  ...
  def sed(searchRegex: java.lang.String, replacement: java.lang.String, file: java.lang.String): shelljsLib.shelljsMod.ShellString = js.native
  def sed(searchRegex: stdLib.RegExp, replacement: java.lang.String, file: java.lang.String): shelljsLib.shelljsMod.ShellString = js.native
  def set(options: java.lang.String): scala.Unit = js.native
  def sort(files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def sort(options: java.lang.String, files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def tail(files: (java.lang.String | js.Array[java.lang.String])*): shelljsLib.shelljsMod.ShellString = js.native
  def tail(
