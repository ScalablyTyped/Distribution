...
object ^ extends js.Object {
  ...
  def chmod(mode: java.lang.String, file: java.lang.String): ShellString = js.native
  def chmod(octalMode: scala.Double, file: java.lang.String): ShellString = js.native
  def chmod(options: java.lang.String, mode: java.lang.String, file: java.lang.String): ShellString = js.native
  def chmod(options: java.lang.String, octalMode: scala.Double, file: java.lang.String): ShellString = js.native
  def cp(options: java.lang.String, source: java.lang.String, dest: java.lang.String): ShellString = js.native
  def cp(options: java.lang.String, source: js.Array[java.lang.String], dest: java.lang.String): ShellString = js.native
  def cp(source: java.lang.String, dest: java.lang.String): ShellString = js.native
  def cp(source: js.Array[java.lang.String], dest: java.lang.String): ShellString = js.native
  ...
  def ln(options: java.lang.String, source: java.lang.String, dest: java.lang.String): ShellString = js.native
  def ln(source: java.lang.String, dest: java.lang.String): ShellString = js.native
  ...
  def mkdir(dir: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
  def mkdir(options: java.lang.String, dir: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
  def mv(options: java.lang.String, source: java.lang.String, dest: java.lang.String): ShellString = js.native
  def mv(options: java.lang.String, source: js.Array[java.lang.String], dest: java.lang.String): ShellString = js.native
  def mv(source: java.lang.String, dest: java.lang.String): ShellString = js.native
  def mv(source: js.Array[java.lang.String], dest: java.lang.String): ShellString = js.native
  ...
  def rm(files: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
  def rm(options: java.lang.String, files: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
  def sed(
    options: java.lang.String,
  ...
  def touch(files: java.lang.String*): ShellString = js.native
  def touch(files: js.Array[java.lang.String]): ShellString = js.native
  def touch(options: TouchOptionsArray, files: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
  def touch(options: TouchOptionsLiteral, files: (java.lang.String | js.Array[java.lang.String])*): ShellString = js.native
