package typings.sbd.sbdMod

import typings.sbd.sbdNumbers.`false`
...
object Options {
  ...
  def apply(
    ...
    if (html_boundaries_tags != null) __obj.updateDynamic("html_boundaries_tags")(html_boundaries_tags)
