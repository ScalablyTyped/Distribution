...
object libTypesMod {
  ...
  */
  ...
  trait StyletronProps[Props] extends StObject {
    ...
    @JSName("$as")
    var $as: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.react.mod.ComponentType[scala.Any], typings.styletronReact.styletronReactStrings.a, typings.styletronReact.styletronReactStrings.abbr */ Any
      ] = js.undefined
  ...
  object StyletronProps {
    ...
    implicit open class MutableBuilder[Self <: StyletronProps[?], Props] (val x: Self & StyletronProps[Props]) extends AnyVal {
      ...
      inline def set$as(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typings.react.mod.ComponentType[scala.Any], typings.styletronReact.styletronReactStrings.a, typings.styletronReact.styletronReactStrings.abbr */ Any
