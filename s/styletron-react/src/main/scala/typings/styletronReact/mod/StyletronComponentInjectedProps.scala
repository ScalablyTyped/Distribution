...
object StyletronComponentInjectedProps {
  @scala.inline
  def apply[/* <: js.Object */ P](): StyletronComponentInjectedProps[P] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StyletronComponentInjectedProps[P]]
  }
  @scala.inline
  implicit class StyletronComponentInjectedPropsOps[Self <: StyletronComponentInjectedProps[_], /* <: js.Object */ P] (val x: Self with StyletronComponentInjectedProps[P]) extends AnyVal {
    @scala.inline
