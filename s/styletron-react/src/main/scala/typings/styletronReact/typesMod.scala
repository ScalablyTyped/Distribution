...
import typings.styletronReact.anon.`1`
...
object typesMod {
  ...
  type AddStyletronRef[P /* <: Ref */] = P | (P & `1`)
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.styletronReact.typesMod.AssignmentCommutativeReducerContainer
    - typings.styletronReact.typesMod.NonAssignmentCommutativeReducerContainer
  */
  trait ReducerContainer extends StObject
  object ReducerContainer {
    
    inline def AssignmentCommutativeReducerContainer(
      factory: StyleObject => typings.styletronReact.typesMod.AssignmentCommutativeReducerContainer,
      reducer: StyleObject => StyleObject,
      style: StyleObject
    ): typings.styletronReact.typesMod.AssignmentCommutativeReducerContainer = {
      val __obj = js.Dynamic.literal(assignmentCommutative = true, factory = js.Any.fromFunction1(factory), reducer = js.Any.fromFunction1(reducer), style = style.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.styletronReact.typesMod.AssignmentCommutativeReducerContainer]
    }
    
    inline def NonAssignmentCommutativeReducerContainer(reducer: (StyleObject, Any) => StyleObject): typings.styletronReact.typesMod.NonAssignmentCommutativeReducerContainer = {
      val __obj = js.Dynamic.literal(assignmentCommutative = false, reducer = js.Any.fromFunction2(reducer))
      __obj.asInstanceOf[typings.styletronReact.typesMod.NonAssignmentCommutativeReducerContainer]
    }
  }
  ...
  object StyletronProps {
    ...
    extension [Self <: StyletronProps[?], Props](x: Self & StyletronProps[Props]) {
      ...
      inline def set$as(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177 */ Any): Self = StObject.set(x, "$as", value.asInstanceOf[js.Any])
      
      inline def set$asUndefined: Self = StObject.set(x, "$as", js.undefined)
      
      inline def set$ref(value: typings.react.mod.Ref[Any]): Self = StObject.set(x, "$ref", value.asInstanceOf[js.Any])
      
      inline def set$refFunction1(value: /* instance */ Any | Null => Unit): Self = StObject.set(x, "$ref", js.Any.fromFunction1(value))
  ...
  type WithStyleFn = js.Function2[
    ...
    StyletronComponent[Any, Any & js.Object]
  ]
