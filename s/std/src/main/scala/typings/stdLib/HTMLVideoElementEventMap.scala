...
object HTMLVideoElementEventMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("MSVideoFormatChanged")(MSVideoFormatChanged)
    __obj.updateDynamic("MSVideoFrameStepCompleted")(MSVideoFrameStepCompleted)
    __obj.updateDynamic("MSVideoOptimalLayoutChanged")(MSVideoOptimalLayoutChanged)
