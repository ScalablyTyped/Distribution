...
trait Int16Array
  ...
  val toStringTag: stdLib.stdLibStrings.Int16Array = js.native
  /**
  ...
  /**
    ...
    */
  def reverse(): Int16Array = js.native
  /**
  ...
  def slice(start: scala.Double): Int16Array = js.native
  def slice(start: scala.Double, end: scala.Double): Int16Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Int16Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Int16Array = js.native
  /**
...
@JSGlobal("Int16Array")
@js.native
class Int16ArrayCls () extends Int16Array {
