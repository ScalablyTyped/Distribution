...
trait Int8ArrayConstructor
  extends ScalablyTyped.runtime.Instantiable0[Int8Array]
     with ScalablyTyped.runtime.Instantiable2[/* buffer */ ArrayBufferLike, /* byteOffset */ scala.Double, Int8Array]
