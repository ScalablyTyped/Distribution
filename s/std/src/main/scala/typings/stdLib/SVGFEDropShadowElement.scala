...
@js.native
class SVGFEDropShadowElementCls () extends SVGFEDropShadowElement {
  /* CompleteClass */
...
@JSGlobal("SVGFEDropShadowElement")
@js.native
object SVGFEDropShadowElement
  extends org.scalablytyped.runtime.Instantiable0[SVGFEDropShadowElement]
