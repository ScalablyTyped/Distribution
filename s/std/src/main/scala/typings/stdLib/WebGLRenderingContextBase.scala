...
trait WebGLRenderingContextBase extends js.Object {
  ...
  def activeTexture(texture: GLenum): scala.Unit = js.native
  def attachShader(program: WebGLProgram, shader: WebGLShader): scala.Unit = js.native
  def bindAttribLocation(program: WebGLProgram, index: GLuint, name: java.lang.String): scala.Unit = js.native
  def bindBuffer(target: GLenum): scala.Unit = js.native
  def bindBuffer(target: GLenum, buffer: WebGLBuffer): scala.Unit = js.native
  def bindFramebuffer(target: GLenum): scala.Unit = js.native
  def bindFramebuffer(target: GLenum, framebuffer: WebGLFramebuffer): scala.Unit = js.native
  def bindRenderbuffer(target: GLenum): scala.Unit = js.native
  def bindRenderbuffer(target: GLenum, renderbuffer: WebGLRenderbuffer): scala.Unit = js.native
  def bindTexture(target: GLenum): scala.Unit = js.native
  def bindTexture(target: GLenum, texture: WebGLTexture): scala.Unit = js.native
  def blendColor(red: GLclampf, green: GLclampf, blue: GLclampf, alpha: GLclampf): scala.Unit = js.native
  def blendEquation(mode: GLenum): scala.Unit = js.native
  def blendEquationSeparate(modeRGB: GLenum, modeAlpha: GLenum): scala.Unit = js.native
  def blendFunc(sfactor: GLenum, dfactor: GLenum): scala.Unit = js.native
  def blendFuncSeparate(srcRGB: GLenum, dstRGB: GLenum, srcAlpha: GLenum, dstAlpha: GLenum): scala.Unit = js.native
  def bufferData(target: GLenum, data: scala.Null, usage: GLenum): scala.Unit = js.native
  def bufferData(target: GLenum, data: BufferSource, usage: GLenum): scala.Unit = js.native
  def bufferData(target: GLenum, size: GLsizeiptr, usage: GLenum): scala.Unit = js.native
  def bufferSubData(target: GLenum, offset: GLintptr, data: BufferSource): scala.Unit = js.native
  def checkFramebufferStatus(target: GLenum): GLenum = js.native
  def clear(mask: GLbitfield): scala.Unit = js.native
  def clearColor(red: GLclampf, green: GLclampf, blue: GLclampf, alpha: GLclampf): scala.Unit = js.native
  def clearDepth(depth: GLclampf): scala.Unit = js.native
  def clearStencil(s: GLint): scala.Unit = js.native
  def colorMask(red: GLboolean, green: GLboolean, blue: GLboolean, alpha: GLboolean): scala.Unit = js.native
  def compileShader(shader: WebGLShader): scala.Unit = js.native
  ...
  def createBuffer(): WebGLBuffer | scala.Null = js.native
  def createFramebuffer(): WebGLFramebuffer | scala.Null = js.native
  def createProgram(): WebGLProgram | scala.Null = js.native
  def createRenderbuffer(): WebGLRenderbuffer | scala.Null = js.native
  def createShader(`type`: GLenum): WebGLShader | scala.Null = js.native
  def createTexture(): WebGLTexture | scala.Null = js.native
  def cullFace(mode: GLenum): scala.Unit = js.native
  def deleteBuffer(): scala.Unit = js.native
  def deleteBuffer(buffer: WebGLBuffer): scala.Unit = js.native
  def deleteFramebuffer(): scala.Unit = js.native
  def deleteFramebuffer(framebuffer: WebGLFramebuffer): scala.Unit = js.native
  def deleteProgram(): scala.Unit = js.native
  def deleteProgram(program: WebGLProgram): scala.Unit = js.native
  def deleteRenderbuffer(): scala.Unit = js.native
  def deleteRenderbuffer(renderbuffer: WebGLRenderbuffer): scala.Unit = js.native
  def deleteShader(): scala.Unit = js.native
  def deleteShader(shader: WebGLShader): scala.Unit = js.native
  def deleteTexture(): scala.Unit = js.native
  def deleteTexture(texture: WebGLTexture): scala.Unit = js.native
  def depthFunc(func: GLenum): scala.Unit = js.native
  def depthMask(flag: GLboolean): scala.Unit = js.native
  def depthRange(zNear: GLclampf, zFar: GLclampf): scala.Unit = js.native
  def detachShader(program: WebGLProgram, shader: WebGLShader): scala.Unit = js.native
  def disable(cap: GLenum): scala.Unit = js.native
  def disableVertexAttribArray(index: GLuint): scala.Unit = js.native
  def drawArrays(mode: GLenum, first: GLint, count: GLsizei): scala.Unit = js.native
  def drawElements(mode: GLenum, count: GLsizei, `type`: GLenum, offset: GLintptr): scala.Unit = js.native
  def enable(cap: GLenum): scala.Unit = js.native
  def enableVertexAttribArray(index: GLuint): scala.Unit = js.native
  def finish(): scala.Unit = js.native
  def flush(): scala.Unit = js.native
  def framebufferRenderbuffer(target: GLenum, attachment: GLenum, renderbuffertarget: GLenum): scala.Unit = js.native
  def framebufferRenderbuffer(target: GLenum, attachment: GLenum, renderbuffertarget: GLenum, renderbuffer: WebGLRenderbuffer): scala.Unit = js.native
  def framebufferTexture2D(target: GLenum, attachment: GLenum, textarget: GLenum, texture: scala.Null, level: GLint): scala.Unit = js.native
  def framebufferTexture2D(target: GLenum, attachment: GLenum, textarget: GLenum, texture: WebGLTexture, level: GLint): scala.Unit = js.native
  def frontFace(mode: GLenum): scala.Unit = js.native
  def generateMipmap(target: GLenum): scala.Unit = js.native
  def getActiveAttrib(program: WebGLProgram, index: GLuint): WebGLActiveInfo | scala.Null = js.native
  def getActiveUniform(program: WebGLProgram, index: GLuint): WebGLActiveInfo | scala.Null = js.native
  def getAttachedShaders(program: WebGLProgram): js.Array[WebGLShader] | scala.Null = js.native
  ...
  def getContextAttributes(): WebGLContextAttributes | scala.Null = js.native
  ...
  def getShaderInfoLog(shader: WebGLShader): java.lang.String | scala.Null = js.native
  def getShaderParameter(shader: WebGLShader, pname: GLenum): js.Any = js.native
  def getShaderPrecisionFormat(shadertype: GLenum, precisiontype: GLenum): WebGLShaderPrecisionFormat | scala.Null = js.native
  def getShaderSource(shader: WebGLShader): java.lang.String | scala.Null = js.native
  def getSupportedExtensions(): js.Array[java.lang.String] | scala.Null = js.native
  ...
  def getUniformLocation(program: WebGLProgram, name: java.lang.String): WebGLUniformLocation | scala.Null = js.native
  ...
  def hint(target: GLenum, mode: GLenum): scala.Unit = js.native
  ...
  def renderbufferStorage(target: GLenum, internalformat: GLenum, width: GLsizei, height: GLsizei): scala.Unit = js.native
  def sampleCoverage(value: GLclampf, invert: GLboolean): scala.Unit = js.native
  def scissor(x: GLint, y: GLint, width: GLsizei, height: GLsizei): scala.Unit = js.native
  def shaderSource(shader: WebGLShader, source: java.lang.String): scala.Unit = js.native
  def stencilFunc(func: GLenum, ref: GLint, mask: GLuint): scala.Unit = js.native
  def stencilFuncSeparate(face: GLenum, func: GLenum, ref: GLint, mask: GLuint): scala.Unit = js.native
  def stencilMask(mask: GLuint): scala.Unit = js.native
  def stencilMaskSeparate(face: GLenum, mask: GLuint): scala.Unit = js.native
  def stencilOp(fail: GLenum, zfail: GLenum, zpass: GLenum): scala.Unit = js.native
  def stencilOpSeparate(face: GLenum, fail: GLenum, zfail: GLenum, zpass: GLenum): scala.Unit = js.native
  def texImage2D(
    target: GLenum,
    level: GLint,
  ...
  def texParameterf(target: GLenum, pname: GLenum, param: GLfloat): scala.Unit = js.native
  def texParameteri(target: GLenum, pname: GLenum, param: GLint): scala.Unit = js.native
  def texSubImage2D(
    target: GLenum,
    level: GLint,
    xoffset: GLint,
  ...
  def uniform1f(location: scala.Null, x: GLfloat): scala.Unit = js.native
  def uniform1f(location: WebGLUniformLocation, x: GLfloat): scala.Unit = js.native
  def uniform1fv(location: scala.Null, v: Float32List): scala.Unit = js.native
  def uniform1fv(location: WebGLUniformLocation, v: Float32List): scala.Unit = js.native
  def uniform1i(location: scala.Null, x: GLint): scala.Unit = js.native
  def uniform1i(location: WebGLUniformLocation, x: GLint): scala.Unit = js.native
  def uniform1iv(location: scala.Null, v: Int32List): scala.Unit = js.native
  def uniform1iv(location: WebGLUniformLocation, v: Int32List): scala.Unit = js.native
  def uniform2f(location: scala.Null, x: GLfloat, y: GLfloat): scala.Unit = js.native
  def uniform2f(location: WebGLUniformLocation, x: GLfloat, y: GLfloat): scala.Unit = js.native
  def uniform2fv(location: scala.Null, v: Float32List): scala.Unit = js.native
  def uniform2fv(location: WebGLUniformLocation, v: Float32List): scala.Unit = js.native
  def uniform2i(location: scala.Null, x: GLint, y: GLint): scala.Unit = js.native
  def uniform2i(location: WebGLUniformLocation, x: GLint, y: GLint): scala.Unit = js.native
  def uniform2iv(location: scala.Null, v: Int32List): scala.Unit = js.native
  def uniform2iv(location: WebGLUniformLocation, v: Int32List): scala.Unit = js.native
  def uniform3f(location: scala.Null, x: GLfloat, y: GLfloat, z: GLfloat): scala.Unit = js.native
  def uniform3f(location: WebGLUniformLocation, x: GLfloat, y: GLfloat, z: GLfloat): scala.Unit = js.native
  def uniform3fv(location: scala.Null, v: Float32List): scala.Unit = js.native
  def uniform3fv(location: WebGLUniformLocation, v: Float32List): scala.Unit = js.native
  def uniform3i(location: scala.Null, x: GLint, y: GLint, z: GLint): scala.Unit = js.native
  def uniform3i(location: WebGLUniformLocation, x: GLint, y: GLint, z: GLint): scala.Unit = js.native
  def uniform3iv(location: scala.Null, v: Int32List): scala.Unit = js.native
  def uniform3iv(location: WebGLUniformLocation, v: Int32List): scala.Unit = js.native
  def uniform4f(location: scala.Null, x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat): scala.Unit = js.native
  def uniform4f(location: WebGLUniformLocation, x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat): scala.Unit = js.native
  def uniform4fv(location: scala.Null, v: Float32List): scala.Unit = js.native
  def uniform4fv(location: WebGLUniformLocation, v: Float32List): scala.Unit = js.native
  def uniform4i(location: scala.Null, x: GLint, y: GLint, z: GLint, w: GLint): scala.Unit = js.native
  def uniform4i(location: WebGLUniformLocation, x: GLint, y: GLint, z: GLint, w: GLint): scala.Unit = js.native
  def uniform4iv(location: scala.Null, v: Int32List): scala.Unit = js.native
  def uniform4iv(location: WebGLUniformLocation, v: Int32List): scala.Unit = js.native
  def uniformMatrix2fv(location: scala.Null, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def uniformMatrix2fv(location: WebGLUniformLocation, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def uniformMatrix3fv(location: scala.Null, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def uniformMatrix3fv(location: WebGLUniformLocation, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def uniformMatrix4fv(location: scala.Null, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def uniformMatrix4fv(location: WebGLUniformLocation, transpose: GLboolean, value: Float32List): scala.Unit = js.native
  def useProgram(): scala.Unit = js.native
  def useProgram(program: WebGLProgram): scala.Unit = js.native
  def validateProgram(program: WebGLProgram): scala.Unit = js.native
  def vertexAttrib1f(index: GLuint, x: GLfloat): scala.Unit = js.native
  def vertexAttrib1fv(index: GLuint, values: Float32List): scala.Unit = js.native
  def vertexAttrib2f(index: GLuint, x: GLfloat, y: GLfloat): scala.Unit = js.native
  def vertexAttrib2fv(index: GLuint, values: Float32List): scala.Unit = js.native
  def vertexAttrib3f(index: GLuint, x: GLfloat, y: GLfloat, z: GLfloat): scala.Unit = js.native
  def vertexAttrib3fv(index: GLuint, values: Float32List): scala.Unit = js.native
  def vertexAttrib4f(index: GLuint, x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat): scala.Unit = js.native
  def vertexAttrib4fv(index: GLuint, values: Float32List): scala.Unit = js.native
  ...
  def viewport(x: GLint, y: GLint, width: GLsizei, height: GLsizei): scala.Unit = js.native
}
