...
trait Uint32Array
  ...
  val toStringTag: stdLib.stdLibStrings.Uint32Array = js.native
  /**
  ...
  def slice(start: scala.Double): Uint32Array = js.native
  def slice(start: scala.Double, end: scala.Double): Uint32Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Uint32Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Uint32Array = js.native
  /**
...
@js.native
class Uint32ArrayCls () extends Uint32Array {
