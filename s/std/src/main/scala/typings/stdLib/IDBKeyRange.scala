...
object IDBKeyRange
  ...
  /**
    ...
    */
  def bound(lower: js.Any, upper: js.Any): stdLib.IDBKeyRange = js.native
  def bound(lower: js.Any, upper: js.Any, lowerOpen: scala.Boolean): stdLib.IDBKeyRange = js.native
  def bound(lower: js.Any, upper: js.Any, lowerOpen: scala.Boolean, upperOpen: scala.Boolean): stdLib.IDBKeyRange = js.native
  /**
    * Returns a new IDBKeyRange starting at key with no
    * upper bound. If open is true, key is not included in the
    * range.
    */
  def lowerBound(lower: js.Any): stdLib.IDBKeyRange = js.native
  def lowerBound(lower: js.Any, open: scala.Boolean): stdLib.IDBKeyRange = js.native
  /**
    * Returns a new IDBKeyRange spanning only key.
    */
  def only(value: js.Any): stdLib.IDBKeyRange = js.native
  /**
    * Returns a new IDBKeyRange with no lower bound and ending at key. If open is true, key is not included in the range.
    */
  def upperBound(upper: js.Any): stdLib.IDBKeyRange = js.native
  def upperBound(upper: js.Any, open: scala.Boolean): stdLib.IDBKeyRange = js.native
}
