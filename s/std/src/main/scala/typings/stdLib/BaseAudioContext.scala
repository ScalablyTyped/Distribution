...
trait BaseAudioContext extends EventTarget {
  ...
  def createPeriodicWave(real: js.Array[scala.Double], imag: Float32Array): PeriodicWave = js.native
  def createPeriodicWave(real: js.Array[scala.Double], imag: Float32Array, constraints: PeriodicWaveConstraints): PeriodicWave = js.native
  def createPeriodicWave(real: Float32Array, imag: js.Array[scala.Double]): PeriodicWave = js.native
  def createPeriodicWave(real: Float32Array, imag: js.Array[scala.Double], constraints: PeriodicWaveConstraints): PeriodicWave = js.native
...
object BaseAudioContext
  extends ScalablyTyped.runtime.Instantiable0[BaseAudioContext]
