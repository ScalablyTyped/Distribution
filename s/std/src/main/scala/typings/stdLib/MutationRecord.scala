...
class MutationRecordCls () extends MutationRecord {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val attributeName: java.lang.String | scala.Null = js.native
  /**
    * Returns the namespace of the
    * changed attribute, and null otherwise.
    */
  /* CompleteClass */
  override val attributeNamespace: java.lang.String | scala.Null = js.native
  /**
    * Return the previous and next sibling respectively
    * of the added or removed nodes, and null otherwise.
    */
  /* CompleteClass */
  override val nextSibling: Node | scala.Null = js.native
  /**
    * The return value depends on type. For
    * "attributes", it is the value of the
    * changed attribute before the change.
    ...
    */
  /* CompleteClass */
  override val oldValue: java.lang.String | scala.Null = js.native
  /* CompleteClass */
  override val previousSibling: Node | scala.Null = js.native
  /**
    * Return the nodes added and removed
    * respectively.
    */
