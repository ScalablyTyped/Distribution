...
trait RegExp extends js.Object {
  ...
  var lastIndex: scala.Double = js.native
  /**
  ...
  var `match`: js.Function1[/* string */ java.lang.String, RegExpMatchArray | scala.Null] = js.native
  ...
  var search: js.Function1[/* string */ java.lang.String, scala.Double] = js.native
  ...
  /**
    ...
    */
  def exec(string: java.lang.String): RegExpExecArray | scala.Null = js.native
  /**
