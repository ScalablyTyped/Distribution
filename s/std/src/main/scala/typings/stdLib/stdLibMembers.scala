...
object stdLibMembers extends js.Object {
  var ActiveXObject: ActiveXObject = js.native
  ...
  var webkitURL: Anon_Url with (/* import warning: Failed type conversion: TsTypeQuery(TsQIdent(List(TsIdentLibrarySimple(std), TsIdentSimple(URL)))) */js.Any) = js.native
