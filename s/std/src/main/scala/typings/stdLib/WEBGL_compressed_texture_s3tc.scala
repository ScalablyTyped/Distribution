...
object WEBGL_compressed_texture_s3tc {
  ...
  def apply(
    ...
    __obj.updateDynamic("COMPRESSED_RGBA_S3TC_DXT1_EXT")(COMPRESSED_RGBA_S3TC_DXT1_EXT)
    __obj.updateDynamic("COMPRESSED_RGBA_S3TC_DXT3_EXT")(COMPRESSED_RGBA_S3TC_DXT3_EXT)
    __obj.updateDynamic("COMPRESSED_RGBA_S3TC_DXT5_EXT")(COMPRESSED_RGBA_S3TC_DXT5_EXT)
    __obj.updateDynamic("COMPRESSED_RGB_S3TC_DXT1_EXT")(COMPRESSED_RGB_S3TC_DXT1_EXT)
