...
trait VBArray[T] extends js.Object {
  ...
  /**
    ...
    */
  def getItem(dimension1Index: scala.Double, dimensionNIndexes: scala.Double*): T = js.native
  /**
    * Returns the smallest available index for a given dimension.
    * @param dimension 1-based dimension (defaults to 1)
    */
  def lbound(): scala.Double = js.native
  def lbound(dimension: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    * @param dimension 1-based dimension (defaults to 1)
    */
  def ubound(): scala.Double = js.native
