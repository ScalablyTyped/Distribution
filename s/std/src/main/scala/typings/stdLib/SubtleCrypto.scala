...
trait SubtleCrypto extends js.Object {
  ...
  def deriveBits(algorithm: java.lang.String, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveBits(algorithm: ConcatParams, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveBits(algorithm: DhKeyDeriveParams, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveBits(algorithm: EcdhKeyDeriveParams, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveBits(algorithm: HkdfCtrParams, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveBits(algorithm: Pbkdf2Params, baseKey: CryptoKey, length: scala.Double): js.Thenable[ArrayBuffer] = js.native
  def deriveKey(
  ...
  @JSName("exportKey")
  def exportKey_jwk(format: stdLib.stdLibStrings.jwk, key: CryptoKey): js.Thenable[JsonWebKey] = js.native
  @JSName("exportKey")
  def exportKey_pkcs8(format: stdLib.stdLibStrings.pkcs8, key: CryptoKey): js.Thenable[ArrayBuffer] = js.native
  @JSName("exportKey")
  def exportKey_raw(format: stdLib.stdLibStrings.raw, key: CryptoKey): js.Thenable[ArrayBuffer] = js.native
  @JSName("exportKey")
  def exportKey_spki(format: stdLib.stdLibStrings.spki, key: CryptoKey): js.Thenable[ArrayBuffer] = js.native
