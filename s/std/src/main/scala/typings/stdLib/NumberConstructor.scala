...
trait NumberConstructor
  ...
  val MAX_VALUE: scala.Double = js.native
  /**
  ...
  val MIN_VALUE: scala.Double = js.native
  /**
        * A value that is less than the largest negative number that can be represented in JavaScript.
        * JavaScript displays NEGATIVE_INFINITY values as -infinity.
        */
  val NEGATIVE_INFINITY: scala.Double = js.native
  /**
  ...
  /**
        ...
        */
  val POSITIVE_INFINITY: scala.Double = js.native
  def apply(): scala.Double = js.native
  def apply(value: js.Any): scala.Double = js.native
  /**
