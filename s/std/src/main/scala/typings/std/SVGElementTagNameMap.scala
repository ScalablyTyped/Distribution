...
object SVGElementTagNameMap {
  ...
  extension [Self <: SVGElementTagNameMap](x: Self) {
    ...
    inline def setScript(value: SVGScriptElement): Self = StObject.set(x, "script", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: SVGStyleElement): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: SVGTitleElement): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
