...
trait HTMLCanvasElement
  ...
  /* standard dom */
  @JSName("getContext")
  @scala.annotation.targetName("getContext_webgl2")
  def getContext(contextId: "webgl2"): WebGL2RenderingContext | Null = js.native
  /**
  ...
  /* standard dom */
  @JSName("getContext")
  @scala.annotation.targetName("getContext_2d")
  def getContext(contextId: "2d"): CanvasRenderingContext2D | Null = js.native
  /* standard dom */
  @JSName("getContext")
  @scala.annotation.targetName("getContext_bitmaprenderer")
  def getContext(contextId: "bitmaprenderer"): ImageBitmapRenderingContext | Null = js.native
  /* standard dom */
  @JSName("getContext")
  @scala.annotation.targetName("getContext_webgl")
  def getContext(contextId: "webgl"): WebGLRenderingContext | Null = js.native
  @JSName("getContext")
  @scala.annotation.targetName("getContext_2d")
  def getContext(contextId: "2d", options: CanvasRenderingContext2DSettings): CanvasRenderingContext2D | Null = js.native
  @JSName("getContext")
  @scala.annotation.targetName("getContext_bitmaprenderer")
  def getContext(contextId: "bitmaprenderer", options: ImageBitmapRenderingContextSettings): ImageBitmapRenderingContext | Null = js.native
  @JSName("getContext")
  @scala.annotation.targetName("getContext_webgl")
  def getContext(contextId: "webgl", options: WebGLContextAttributes): WebGLRenderingContext | Null = js.native
  @JSName("getContext")
  @scala.annotation.targetName("getContext_webgl2")
  def getContext(contextId: "webgl2", options: WebGLContextAttributes): WebGL2RenderingContext | Null = js.native
  /* standard dom */
