...
@JSGlobal("SVGPathSegCurvetoQuadraticAbs")
@js.native
class SVGPathSegCurvetoQuadraticAbsCls () extends SVGPathSegCurvetoQuadraticAbs {
  /* CompleteClass */
...
@JSGlobal("SVGPathSegCurvetoQuadraticAbs")
@js.native
object SVGPathSegCurvetoQuadraticAbs extends Instantiable0[SVGPathSegCurvetoQuadraticAbs]
