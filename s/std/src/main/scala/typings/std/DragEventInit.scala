...
object DragEventInit {
  ...
  def apply(
    ...
    dataTransfer: js.UndefOr[Null | DataTransfer] = js.undefined,
    ...
    if (!js.isUndefined(dataTransfer)) __obj.updateDynamic("dataTransfer")(dataTransfer.asInstanceOf[js.Any])
