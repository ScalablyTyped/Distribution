...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.std.stdStrings.previoustrack
  - typings.std.stdStrings.seekbackward
  - typings.std.stdStrings.seekforward
...
object MediaSessionAction {
  ...
  inline def pause: typings.std.stdStrings.pause = "pause".asInstanceOf[typings.std.stdStrings.pause]
  
  inline def play: typings.std.stdStrings.play = "play".asInstanceOf[typings.std.stdStrings.play]
  
  inline def previoustrack: typings.std.stdStrings.previoustrack = "previoustrack".asInstanceOf[typings.std.stdStrings.previoustrack]
  
  inline def seekbackward: typings.std.stdStrings.seekbackward = "seekbackward".asInstanceOf[typings.std.stdStrings.seekbackward]
  
  inline def seekforward: typings.std.stdStrings.seekforward = "seekforward".asInstanceOf[typings.std.stdStrings.seekforward]
  
  inline def seekto: typings.std.stdStrings.seekto = "seekto".asInstanceOf[typings.std.stdStrings.seekto]
