...
trait RTCRtpCodec extends StObject {
...
object RTCRtpCodec {
  ...
  inline def apply(clockRate: Double, mimeType: java.lang.String): RTCRtpCodec = {
    val __obj = js.Dynamic.literal(clockRate = clockRate.asInstanceOf[js.Any], mimeType = mimeType.asInstanceOf[js.Any])
    __obj.asInstanceOf[RTCRtpCodec]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RTCRtpCodec] (val x: Self) extends AnyVal {
