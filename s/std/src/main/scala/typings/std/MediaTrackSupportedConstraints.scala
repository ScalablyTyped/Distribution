...
object MediaTrackSupportedConstraints {
  ...
  extension [Self <: MediaTrackSupportedConstraints](x: Self) {
    ...
    inline def setAspectRatio(value: scala.Boolean): Self = StObject.set(x, "aspectRatio", value.asInstanceOf[js.Any])
    ...
    inline def setFacingMode(value: scala.Boolean): Self = StObject.set(x, "facingMode", value.asInstanceOf[js.Any])
    
    inline def setFacingModeUndefined: Self = StObject.set(x, "facingMode", js.undefined)
    
    inline def setFrameRate(value: scala.Boolean): Self = StObject.set(x, "frameRate", value.asInstanceOf[js.Any])
    
    inline def setFrameRateUndefined: Self = StObject.set(x, "frameRate", js.undefined)
    
    inline def setGroupId(value: scala.Boolean): Self = StObject.set(x, "groupId", value.asInstanceOf[js.Any])
    
    inline def setGroupIdUndefined: Self = StObject.set(x, "groupId", js.undefined)
    
    inline def setHeight(value: scala.Boolean): Self = StObject.set(x, "height", value.asInstanceOf[js.Any])
    
    inline def setHeightUndefined: Self = StObject.set(x, "height", js.undefined)
    
    inline def setLatency(value: scala.Boolean): Self = StObject.set(x, "latency", value.asInstanceOf[js.Any])
    ...
    inline def setResizeMode(value: scala.Boolean): Self = StObject.set(x, "resizeMode", value.asInstanceOf[js.Any])
    
    inline def setResizeModeUndefined: Self = StObject.set(x, "resizeMode", js.undefined)
    
    inline def setSampleRate(value: scala.Boolean): Self = StObject.set(x, "sampleRate", value.asInstanceOf[js.Any])
