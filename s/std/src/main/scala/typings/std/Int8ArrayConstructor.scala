...
Instantiable0[js.typedarray.Int8Array]
     with Instantiable2[/* buffer */ ArrayBufferLike, /* byteOffset */ Double, js.typedarray.Int8Array]
     with Instantiable3[
  ...
  def from(arrayLike: js.Iterable[Double]): js.typedarray.Int8Array = js.native
  def from(arrayLike: js.Iterable[Double], mapfn: js.Function2[/* v */ Double, /* k */ Double, Double]): js.typedarray.Int8Array = js.native
  def from(
    arrayLike: js.Iterable[Double],
    mapfn: js.Function2[/* v */ Double, /* k */ Double, Double],
    thisArg: Any
  ): js.typedarray.Int8Array = js.native
  def from(arrayLike: js.Iterable[Double], mapfn: Unit, thisArg: Any): js.typedarray.Int8Array = js.native
  /**
    * Creates an array from an array-like or iterable object.
    * @param arrayLike An array-like or iterable object to convert to an array.
    */
  ...
  def from[T](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ Double, Double], thisArg: Any): js.typedarray.Int8Array = js.native
