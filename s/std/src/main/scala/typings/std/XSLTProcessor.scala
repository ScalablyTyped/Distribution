...
object XSLTProcessor {
  ...
  implicit class XSLTProcessorMutableBuilder[Self <: XSLTProcessor] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setImportStylesheet(value: Node => Unit): Self = StObject.set(x, "importStylesheet", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setTransformToDocument(value: Node => Document): Self = StObject.set(x, "transformToDocument", js.Any.fromFunction1(value))
    
    @scala.inline
    def setTransformToFragment(value: (Node, Document) => DocumentFragment): Self = StObject.set(x, "transformToFragment", js.Any.fromFunction2(value))
  }
}
