...
object ClassAccessorDecoratorContext {
  ...
  inline def apply[This, Value](
    ...
    val __obj = js.Dynamic.literal(access = access.asInstanceOf[js.Any], addInitializer = js.Any.fromFunction1(addInitializer), kind = "accessor", name = name.asInstanceOf[js.Any], static = static.asInstanceOf[js.Any])
