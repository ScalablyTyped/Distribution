...
object CSSNamespaceRule {
  ...
  @scala.inline
  implicit class CSSNamespaceRuleOps[Self <: CSSNamespaceRule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setNamespaceURI(value: java.lang.String): Self = this.set("namespaceURI", value.asInstanceOf[js.Any])
