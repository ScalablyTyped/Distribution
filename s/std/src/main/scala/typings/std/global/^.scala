...
object ^ extends js.Object {
  ...
  var onmessage: (js.ThisFunction1[/* this */ Window, /* ev */ typings.std.MessageEvent[js.Any], js.Any]) | Null = js.native
  
  var onmessageerror: (js.ThisFunction1[/* this */ Window, /* ev */ typings.std.MessageEvent[js.Any], js.Any]) | Null = js.native
