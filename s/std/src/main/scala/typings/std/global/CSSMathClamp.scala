...
@JSGlobal("CSSMathClamp")
@js.native
open class CSSMathClamp protected ()
  extends StObject
     with typings.std.CSSMathClamp {
  /* standard dom */
  def this(lower: CSSNumberish, value: CSSNumberish, upper: CSSNumberish) = this()
  ...
  /* standard dom */
  /* CompleteClass */
  override val lower: typings.std.CSSNumericValue = js.native
  ...
  /* standard dom */
  /* CompleteClass */
  override val upper: typings.std.CSSNumericValue = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val value: typings.std.CSSNumericValue = js.native
}
