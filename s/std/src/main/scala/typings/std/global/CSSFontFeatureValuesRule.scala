...
@JSGlobal("CSSFontFeatureValuesRule")
@js.native
/* standard dom */
open class CSSFontFeatureValuesRule ()
  extends StObject
     with typings.std.CSSFontFeatureValuesRule {
  
  /* standard dom */
  /* CompleteClass */
  override val CHARSET_RULE: `2` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val FONT_FACE_RULE: `5` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val IMPORT_RULE: `3` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val KEYFRAMES_RULE: `7` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val KEYFRAME_RULE: `8` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val MEDIA_RULE: `4` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val NAMESPACE_RULE: `10` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val PAGE_RULE: `6` = js.native
  
  /* standard dom */
  /* CompleteClass */
  override val STYLE_RULE: `1` = js.native
