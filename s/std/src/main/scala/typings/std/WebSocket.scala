...
trait WebSocket
  ...
  def addEventListener(`type`: "close", listener: js.ThisFunction1[/* this */ this.type, /* ev */ CloseEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  def removeEventListener(`type`: "close", listener: js.ThisFunction1[/* this */ this.type, /* ev */ CloseEvent, Any]): Unit = js.native
  @JSName("removeEventListener")
