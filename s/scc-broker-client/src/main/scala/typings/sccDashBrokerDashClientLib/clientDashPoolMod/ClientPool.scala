...
trait ClientPool
  ...
  var clients: js.Array[socketclusterDashClientLib.libScclientsocketMod.^] = js.native
  var hasher: sccDashBrokerDashClientLib.hasherMod.^ = js.native
  ...
  def on_publish(
    ...
    listener: js.Function1[/* data */ PublishData, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_publishFail(
  ...
  def on_subscribe(
    ...
    listener: js.Function1[/* data */ SubscribeData, scala.Unit]
  ): this.type = js.native
  @JSName("on")
  def on_subscribeFail(
    event: sccDashBrokerDashClientLib.sccDashBrokerDashClientLibStrings.subscribeFail,
    listener: js.Function1[/* data */ SubscribeFailData, scala.Unit]
  ): this.type = js.native
  def publish(channelName: java.lang.String, data: js.Any): scala.Unit = js.native
  def selectClient(key: java.lang.String): socketclusterDashClientLib.libScclientsocketMod.^ = js.native
