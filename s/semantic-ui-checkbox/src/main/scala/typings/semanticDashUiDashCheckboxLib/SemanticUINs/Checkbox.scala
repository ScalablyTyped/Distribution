...
trait Checkbox extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashCheckboxLib.semanticDashUiDashCheckboxLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl[K] */ js.Any = js.native
