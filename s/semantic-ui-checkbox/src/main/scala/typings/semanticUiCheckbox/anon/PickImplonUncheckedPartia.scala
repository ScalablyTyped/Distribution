...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'onUnchecked'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplonUncheckedPartia
  extends StObject
     with Param {
...
object PickImplonUncheckedPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonUncheckedPartia] (val x: Self) extends AnyVal {
