...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'beforeChecked'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplbeforeCheckedPart
  extends StObject
     with Param {
...
object PickImplbeforeCheckedPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplbeforeCheckedPart] (val x: Self) extends AnyVal {
