...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'fireOnInit'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
...
object PickImplfireOnInitPartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplfireOnInitPartial] (val x: Self) extends AnyVal {
