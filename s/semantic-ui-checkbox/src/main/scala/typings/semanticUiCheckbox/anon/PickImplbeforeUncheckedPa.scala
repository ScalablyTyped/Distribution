...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'beforeUnchecked'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplbeforeUncheckedPa
  extends StObject
     with Param {
...
object PickImplbeforeUncheckedPa {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplbeforeUncheckedPa] (val x: Self) extends AnyVal {
