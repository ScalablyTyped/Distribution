...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'onEnabled'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplonEnabledPartialP
  extends StObject
     with Param {
...
object PickImplonEnabledPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonEnabledPartialP] (val x: Self) extends AnyVal {
