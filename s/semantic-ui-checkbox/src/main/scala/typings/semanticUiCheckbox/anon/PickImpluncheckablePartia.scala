...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'uncheckable'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImpluncheckablePartia
  extends StObject
     with Param {
...
object PickImpluncheckablePartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpluncheckablePartia] (val x: Self) extends AnyVal {
