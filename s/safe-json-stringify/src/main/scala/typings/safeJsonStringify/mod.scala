...
object mod {
  ...
  inline def apply(data: js.Object, replacer: js.Array[js.Any]): String = (^.asInstanceOf[js.Dynamic].apply(data.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def apply(data: js.Object, replacer: js.Array[js.Any], space: String): String = (^.asInstanceOf[js.Dynamic].apply(data.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any], space.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def apply(data: js.Object, replacer: js.Array[js.Any], space: Double): String = (^.asInstanceOf[js.Dynamic].apply(data.asInstanceOf[js.Any], replacer.asInstanceOf[js.Any], space.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def ensureProperties(obj: js.Any): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("ensureProperties")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Object]
