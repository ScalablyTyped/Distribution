...
object distTypingsSodiumVertexMod {
  ...
  object Color extends StObject {
    ...
    sealed trait black
      extends StObject
         with Color
    /* 0 */ val black: typings.sodiumjs.distTypingsSodiumVertexMod.Color.black & Double = js.native
    
    @js.native
    sealed trait gray
      extends StObject
         with Color
    /* 1 */ val gray: typings.sodiumjs.distTypingsSodiumVertexMod.Color.gray & Double = js.native
    
    @js.native
    sealed trait purple
      extends StObject
         with Color
    /* 3 */ val purple: typings.sodiumjs.distTypingsSodiumVertexMod.Color.purple & Double = js.native
    
    @js.native
    sealed trait white
      extends StObject
         with Color
    /* 2 */ val white: typings.sodiumjs.distTypingsSodiumVertexMod.Color.white & Double = js.native
  }
