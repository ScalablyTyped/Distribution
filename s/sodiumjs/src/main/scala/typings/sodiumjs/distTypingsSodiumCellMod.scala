...
@js.native
object distTypingsSodiumCellMod extends js.Object {
  @js.native
  class Cell[A] protected () extends js.Object {
    ...
    def lift[B, C](b: Cell[B], fn0: Lambda2[A, B, C]): Cell[C] = js.native
    /**
    ...
    def lift3[B, C, D](b: Cell[B], c: Cell[C], fn0: Lambda3[A, B, C, D]): Cell[D] = js.native
    /**
    ...
    def lift4[B, C, D, E](b: Cell[B], c: Cell[C], d: Cell[D], fn0: Lambda4[A, B, C, D, E]): Cell[E] = js.native
    /**
    ...
    def lift5[B, C, D, E, F](b: Cell[B], c: Cell[C], d: Cell[D], e: Cell[E], fn0: Lambda5[A, B, C, D, E, F]): Cell[F] = js.native
    /**
    ...
    def lift6[B, C, D, E, F, G](b: Cell[B], c: Cell[C], d: Cell[D], e: Cell[E], f: Cell[F], fn0: Lambda6[A, B, C, D, E, F, G]): Cell[G] = js.native
    /**
    ...
    def map[B](f: Lambda1[A, B]): Cell[B] = js.native
    /**
