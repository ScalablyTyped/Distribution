...
@js.native
object distTypingsSodiumStreamMod extends js.Object {
  @js.native
  class Stream[A] () extends js.Object {
    ...
    def accum[S](initState: S, f: Lambda2[A, S, S]): Cell[S] = js.native
    /**
    ...
    def accumLazy[S](initState: Lazy[S], f: Lambda2[A, S, S]): Cell[S] = js.native
    /**
    ...
    def collect[B, S](initState: S, f: Lambda2[A, S, Tuple2[B, S]]): Stream[B] = js.native
    /**
    ...
    def filter(f: Lambda1[A, Boolean]): Stream[A] = js.native
    /**
    ...
    def map[B](f: Lambda1[A, B]): Stream[B] = js.native
    /**
    ...
    def merge(s: Stream[A], f: Lambda2[A, A, A]): Stream[A] = js.native
    /**
    ...
    def snapshot[B, C](b: Cell[B], f_ : Lambda2[A, B, C]): Stream[C] = js.native
    /**
    ...
    def snapshot3[B, C, D](b: Cell[B], c: Cell[C], f_ : Lambda3[A, B, C, D]): Stream[D] = js.native
    /**
      * Return a stream whose events are the result of the combination using the specified
      * function of the input stream's event value and the value of the cells at that time.
      * <P>
    ...
    def snapshot4[B, C, D, E](b: Cell[B], c: Cell[C], d: Cell[D], f_ : Lambda4[A, B, C, D, E]): Stream[E] = js.native
    /**
      * Return a stream whose events are the result of the combination using the specified
      * function of the input stream's event value and the value of the cells at that time.
      * <P>
    ...
    def snapshot5[B, C, D, E, F](b: Cell[B], c: Cell[C], d: Cell[D], e: Cell[E], f_ : Lambda5[A, B, C, D, E, F]): Stream[F] = js.native
    /**
      * Return a stream whose events are the result of the combination using the specified
      * function of the input stream's event value and the value of the cells at that time.
      * <P>
    ...
    def snapshot6[B, C, D, E, F, G](b: Cell[B], c: Cell[C], d: Cell[D], e: Cell[E], f: Cell[F], f_ : Lambda6[A, B, C, D, E, F, G]): Stream[G] = js.native
  }
