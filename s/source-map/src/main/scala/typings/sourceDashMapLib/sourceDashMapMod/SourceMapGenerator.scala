...
class SourceMapGenerator () extends js.Object {
  ...
  /**
    ...
    */
  def addMapping(mapping: Mapping): scala.Unit = js.native
  /**
    ...
    */
  def applySourceMap(sourceMapConsumer: SourceMapConsumer): scala.Unit = js.native
  def applySourceMap(sourceMapConsumer: SourceMapConsumer, sourceFile: java.lang.String): scala.Unit = js.native
  def applySourceMap(
...
object SourceMapGenerator extends js.Object {
  /**
    ...
    */
  def fromSourceMap(sourceMapConsumer: sourceDashMapLib.sourceDashMapMod.SourceMapConsumer): sourceDashMapLib.sourceDashMapMod.SourceMapGenerator = js.native
}
