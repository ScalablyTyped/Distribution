...
import typings.sass.functionMod.LegacyFunction
import typings.sass.legacyImporterMod.LegacyImporter
...
object optionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sass.optionsMod.LegacyFileOptions[sync]
    - typings.sass.optionsMod.LegacyStringOptions[sync]
  */
  trait LegacyOptions[sync /* <: typings.sass.sassStrings.sync | async */] extends StObject
  object LegacyOptions {
    
    inline def LegacyFileOptions[sync /* <: typings.sass.sassStrings.sync | async */](file: String): typings.sass.optionsMod.LegacyFileOptions[sync] = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sass.optionsMod.LegacyFileOptions[sync]]
    }
    
    inline def LegacyStringOptions[sync /* <: typings.sass.sassStrings.sync | async */](data: String): typings.sass.optionsMod.LegacyStringOptions[sync] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sass.optionsMod.LegacyStringOptions[sync]]
    }
  }
