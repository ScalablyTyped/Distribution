...
import typings.sass.functionMod.types.Error
...
object functionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sass.functionMod.types.Null
    - typings.sass.functionMod.types.Number
    - typings.sass.functionMod.types.String
    - typings.sass.functionMod.types.Boolean[scala.Boolean]
    - typings.sass.functionMod.types.Color
    - typings.sass.functionMod.types.List
    - typings.sass.functionMod.types.Map
  */
