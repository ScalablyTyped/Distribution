...
object typesOptionsMod {
  ...
  type CustomFunction[sync /* <: typings.sass.sassStrings.sync | async */] = js.Function1[/* args */ js.Array[Value], PromiseOr[Value, sync]]
  
  trait Options[sync /* <: typings.sass.sassStrings.sync | async */] extends StObject {
  ...
  object Options {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](): Options[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Options[sync]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: Options[?], sync /* <: typings.sass.sassStrings.sync | async */] (val x: Self & Options[sync]) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sass.sassStrings.expanded
    - typings.sass.sassStrings.compressed
  */
  trait OutputStyle extends StObject
  object OutputStyle {
    
    inline def compressed: typings.sass.sassStrings.compressed = "compressed".asInstanceOf[typings.sass.sassStrings.compressed]
    
    inline def expanded: typings.sass.sassStrings.expanded = "expanded".asInstanceOf[typings.sass.sassStrings.expanded]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.sass.typesOptionsMod.StringOptionsWithImporter[sync]
    - typings.sass.typesOptionsMod.StringOptionsWithoutImporter[sync]
  */
  trait StringOptions[sync /* <: typings.sass.sassStrings.sync | async */] extends StObject
  object StringOptions {
    
    inline def StringOptionsWithImporter[sync /* <: typings.sass.sassStrings.sync | async */](importer: Importer[sync] | FileImporter[sync], url: URL): typings.sass.typesOptionsMod.StringOptionsWithImporter[sync] = {
      val __obj = js.Dynamic.literal(importer = importer.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sass.typesOptionsMod.StringOptionsWithImporter[sync]]
    }
    
    inline def StringOptionsWithoutImporter[sync /* <: typings.sass.sassStrings.sync | async */](): typings.sass.typesOptionsMod.StringOptionsWithoutImporter[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.sass.typesOptionsMod.StringOptionsWithoutImporter[sync]]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.sass.typesOptionsMod.StringOptions because Already inherited */ trait StringOptionsWithImporter[sync /* <: typings.sass.sassStrings.sync | async */]
    extends StObject
  ...
  object StringOptionsWithImporter {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](importer: Importer[sync] | FileImporter[sync], url: URL): StringOptionsWithImporter[sync] = {
      val __obj = js.Dynamic.literal(importer = importer.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[StringOptionsWithImporter[sync]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: StringOptionsWithImporter[?], sync /* <: typings.sass.sassStrings.sync | async */] (val x: Self & StringOptionsWithImporter[sync]) extends AnyVal {
  ...
  trait StringOptionsWithoutImporter[sync /* <: typings.sass.sassStrings.sync | async */]
    extends StObject
       with Options[sync]
  ...
  object StringOptionsWithoutImporter {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](): StringOptionsWithoutImporter[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StringOptionsWithoutImporter[sync]]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: StringOptionsWithoutImporter[?], sync /* <: typings.sass.sassStrings.sync | async */] (val x: Self & StringOptionsWithoutImporter[sync]) extends AnyVal {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sass.sassStrings.scss
    - typings.sass.sassStrings.indented
    - typings.sass.sassStrings.css
  */
  trait Syntax extends StObject
  object Syntax {
    
    inline def css: typings.sass.sassStrings.css = "css".asInstanceOf[typings.sass.sassStrings.css]
    
    inline def indented: typings.sass.sassStrings.indented = "indented".asInstanceOf[typings.sass.sassStrings.indented]
    
    inline def scss: typings.sass.sassStrings.scss = "scss".asInstanceOf[typings.sass.sassStrings.scss]
  }
}
