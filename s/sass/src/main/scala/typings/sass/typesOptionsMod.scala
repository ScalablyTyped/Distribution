...
object typesOptionsMod {
  ...
  object Options {
    ...
    extension [Self <: Options[?], sync /* <: typings.sass.sassStrings.sync | async */](x: Self & Options[sync]) {
  ...
  */
  ...
  object StringOptionsWithImporter {
    ...
    extension [Self <: StringOptionsWithImporter[?], sync /* <: typings.sass.sassStrings.sync | async */](x: Self & StringOptionsWithImporter[sync]) {
  ...
  object StringOptionsWithoutImporter {
    ...
    extension [Self <: StringOptionsWithoutImporter[?], sync /* <: typings.sass.sassStrings.sync | async */](x: Self & StringOptionsWithoutImporter[sync]) {
