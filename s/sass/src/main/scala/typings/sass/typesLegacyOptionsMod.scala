...
import typings.sass.sassStrings.compact
...
import typings.sass.sassStrings.nested
import typings.sass.sassStrings.space_
import typings.sass.sassStrings.tab
import typings.sass.typesLegacyFunctionMod.LegacyFunction
import typings.sass.typesLegacyImporterMod.LegacyImporter
import typings.sass.typesLoggerMod.Logger
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesLegacyOptionsMod {
  
  trait LegacyFileOptions[sync /* <: typings.sass.sassStrings.sync | async */]
    extends StObject
  ...
  object LegacyFileOptions {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](file: String): LegacyFileOptions[sync] = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.sass.typesLegacyOptionsMod.LegacyFileOptions[sync]
    - typings.sass.typesLegacyOptionsMod.LegacyStringOptions[sync]
  */
  trait LegacyOptions[sync /* <: typings.sass.sassStrings.sync | async */] extends StObject
  object LegacyOptions {
    
    inline def LegacyFileOptions[sync /* <: typings.sass.sassStrings.sync | async */](file: String): typings.sass.typesLegacyOptionsMod.LegacyFileOptions[sync] = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sass.typesLegacyOptionsMod.LegacyFileOptions[sync]]
    }
    
    inline def LegacyStringOptions[sync /* <: typings.sass.sassStrings.sync | async */](data: String): typings.sass.typesLegacyOptionsMod.LegacyStringOptions[sync] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.sass.typesLegacyOptionsMod.LegacyStringOptions[sync]]
    }
  }
  
  trait LegacySharedOptions[sync /* <: typings.sass.sassStrings.sync | async */] extends StObject {
  ...
  object LegacySharedOptions {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](): LegacySharedOptions[sync] = {
  ...
  trait LegacyStringOptions[sync /* <: typings.sass.sassStrings.sync | async */]
    extends StObject
       with LegacySharedOptions[sync]
       with LegacyOptions[sync] {
  ...
  object LegacyStringOptions {
    ...
    inline def apply[sync /* <: typings.sass.sassStrings.sync | async */](data: String): LegacyStringOptions[sync] = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
