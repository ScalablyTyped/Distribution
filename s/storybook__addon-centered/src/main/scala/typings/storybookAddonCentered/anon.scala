...
object anon {
  ...
  object AlignItems {
    ...
    implicit class AlignItemsMutableBuilder[Self <: AlignItems] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAlignItems(value: center): Self = StObject.set(x, "alignItems", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setBottom(value: `0`): Self = StObject.set(x, "bottom", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setDisplay(value: flex): Self = StObject.set(x, "display", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setLeft(value: `0`): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setOverflow(value: auto): Self = StObject.set(x, "overflow", value.asInstanceOf[js.Any])
  ...
  object Margin {
    ...
    implicit class MarginMutableBuilder[Self <: Margin] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMargin(value: auto): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxHeight(value: `100Percentsign`): Self = StObject.set(x, "maxHeight", value.asInstanceOf[js.Any])
    }
  }
