...
object styledDashReactDashModalLibComponents {
  ...
  @scala.inline
  def ModalProviderProps: styledDashReactDashModalLib.styledDashReactDashModalMod.ModalProviderProps.type = styledDashReactDashModalLib.styledDashReactDashModalMod.ModalProviderProps
  type ModalProviderProps = styledDashReactDashModalLib.styledDashReactDashModalMod.ModalProviderProps
}
