...
trait BigNumber extends js.Object {
  ...
  var add: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// this += that.  Does not normalize.
  var addM: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// Initializes this with it, either as a bn, a number, or a hex string.
  var initWith: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// return inverse mod prime p.  p must be odd. Binary extended Euclidean algorithm mod p.
  var inverseMod: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  var maxMul: scala.Double = js.native
  var mod: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// this * that.  Normalizes and reduces.
  var mul: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// this * that mod N
  var mulmod: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberTrinaryOperator = js.native
  /// this ^ x mod N
  var powermod: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberTrinaryOperator = js.native
  var radix: scala.Double = js.native
  /// this - that.  Does not normalize.
  var sub: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
  /// this -= that.  Does not normalize.
  var subM: sjclLib.sjclMod.sjclNs.TypeHelpersNs.BigNumberBinaryOperator = js.native
