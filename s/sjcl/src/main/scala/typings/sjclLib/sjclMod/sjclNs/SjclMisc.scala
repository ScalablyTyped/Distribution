...
trait SjclMisc extends js.Object {
  ...
  def cachedPbkdf2(password: java.lang.String): sjclLib.Anon_KeySalt = js.native
  def cachedPbkdf2(password: java.lang.String, obj: Pbkdf2Params): sjclLib.Anon_KeySalt = js.native
