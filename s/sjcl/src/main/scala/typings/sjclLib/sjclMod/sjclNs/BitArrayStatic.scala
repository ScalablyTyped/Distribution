...
trait BitArrayStatic extends js.Object {
  ...
  def bitLength(a: BitArray): scala.Double = js.native
  /// Array slices in units of bits.
  def bitSlice(a: BitArray, bstart: scala.Double, bend: scala.Double): BitArray = js.native
  /// Truncate an array.
  def clamp(a: BitArray, len: scala.Double): BitArray = js.native
  /// Concatenate two bit arrays.
  def concat(a1: BitArray, a2: BitArray): BitArray = js.native
  /// Compare two arrays for equality in a predictable amount of time.
  def equal(a: BitArray, b: BitArray): scala.Boolean = js.native
  /// Extract a number packed into a bit array.
  def extract(a: BitArray, bstart: scala.Double, blenth: scala.Double): scala.Double = js.native
