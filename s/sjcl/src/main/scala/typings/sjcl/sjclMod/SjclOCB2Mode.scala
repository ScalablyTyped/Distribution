...
trait SjclOCB2Mode extends js.Object {
  ...
  def encrypt(prp: SjclCipher, plaintext: BitArray, iv: BitArray, adata: BitArray, tlen: Double, premac: Boolean): BitArray = js.native
  def pmac(prp: SjclCipher, adata: BitArray): js.Array[Double] = js.native
}
