...
object ^ extends js.Object {
  ...
  var keyexchange: SjclKeyExchange = js.native
  var misc: SjclMisc = js.native
  var mode: SjclModes = js.native
  var prng: SjclRandomStatic = js.native
  var random: SjclRandom = js.native
}
