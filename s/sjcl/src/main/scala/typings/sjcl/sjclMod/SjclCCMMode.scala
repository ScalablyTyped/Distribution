...
trait SjclCCMMode extends js.Object {
  ...
  def decrypt(prp: SjclCipher, ciphertext: BitArray, iv: BitArray, adata: BitArray, tlen: Double): BitArray = js.native
  ...
  def encrypt(prp: SjclCipher, plaintext: BitArray, iv: BitArray, adata: BitArray, tlen: Double): BitArray = js.native
}
