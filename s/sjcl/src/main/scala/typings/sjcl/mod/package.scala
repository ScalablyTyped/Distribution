...
package object mod {
  ...
  @scala.inline
  def bn: typings.sjcl.mod.BigNumberStatic = typings.sjcl.mod.^.asInstanceOf[js.Dynamic].selectDynamic("bn").asInstanceOf[typings.sjcl.mod.BigNumberStatic]
  @scala.inline
  ...
  @scala.inline
  def prng: typings.sjcl.mod.SjclRandomStatic = typings.sjcl.mod.^.asInstanceOf[js.Dynamic].selectDynamic("prng").asInstanceOf[typings.sjcl.mod.SjclRandomStatic]
  @scala.inline
