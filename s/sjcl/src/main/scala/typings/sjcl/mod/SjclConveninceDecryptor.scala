...
trait SjclConveninceDecryptor extends js.Object {
  ...
  def apply(password: BitArray_, ciphertext: SjclCipherEncrypted): String = js.native
  def apply(password: BitArray_, ciphertext: SjclCipherEncrypted, params: SjclCipherDecryptParams): String = js.native
  def apply(
    password: BitArray_,
    ciphertext: SjclCipherEncrypted,
    params: SjclCipherDecryptParams,
