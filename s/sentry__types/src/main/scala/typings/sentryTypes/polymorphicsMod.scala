...
object polymorphicsMod {
  ...
  - typings.sentryTypes.polymorphicsMod.BaseRequest because Already inherited
  - typings.sentryTypes.polymorphicsMod.NodeRequest because Already inherited
  - typings.sentryTypes.polymorphicsMod.NextjsRequest because var conflicts: headers, method, protocol, query, socket, url. Inlined cookies
  - typings.sentryTypes.polymorphicsMod.KoaRequest because var conflicts: headers, host, hostname, ip, method, originalUrl, protocol, socket, url. Inlined  */ trait PolymorphicRequest
    extends StObject
       with ExpressRequest {
