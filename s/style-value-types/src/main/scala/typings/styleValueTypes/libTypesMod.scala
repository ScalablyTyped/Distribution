...
object libTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.styleValueTypes.libTypesMod.HSLA
    - typings.styleValueTypes.libTypesMod.RGBA
  */
  trait Color extends StObject
  object Color {
    
    inline def HSLA(hue: Double, lightness: Double, saturation: Double): typings.styleValueTypes.libTypesMod.HSLA = {
      ...
      __obj.asInstanceOf[typings.styleValueTypes.libTypesMod.HSLA]
    }
    
    inline def RGBA(blue: Double, green: Double, red: Double): typings.styleValueTypes.libTypesMod.RGBA = {
      val __obj = js.Dynamic.literal(blue = blue.asInstanceOf[js.Any], green = green.asInstanceOf[js.Any], red = red.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.styleValueTypes.libTypesMod.RGBA]
    }
  }
