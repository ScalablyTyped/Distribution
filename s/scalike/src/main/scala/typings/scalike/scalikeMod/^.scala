...
object ^ extends js.Object {
  ...
  def Future[A](f: js.Function0[A]): typings.scalike.scalikeMod.Future[A] = js.native
  def Future[A](f: js.Promise[A]): typings.scalike.scalikeMod.Future[A] = js.native
  def Left[A, B](a: A): Either[A, B] = js.native
  def Optional[A](a: A): typings.scalike.scalikeMod.Optional[A] = js.native
  def Right[A, B](b: B): Either[A, B] = js.native
  def Some[A](a: A): Optional[A] = js.native
  def Success[A](a: A): Try[A] = js.native
  def Try[A](f: js.Function0[A]): typings.scalike.scalikeMod.Try[A] = js.native
}
