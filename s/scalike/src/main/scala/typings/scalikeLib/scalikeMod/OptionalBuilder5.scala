...
@js.native
class OptionalBuilder5[A, B, C, D, E, F] protected () extends js.Object {
  def this(oa: Optional[A], ob: Optional[B], oc: Optional[C], od: Optional[D], oe: Optional[E], of: Optional[F]) = this()
