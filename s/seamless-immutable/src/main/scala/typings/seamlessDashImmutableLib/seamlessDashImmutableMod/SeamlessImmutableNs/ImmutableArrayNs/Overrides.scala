...
trait Overrides[T] extends js.Object {
  ...
  ): seamlessDashImmutableLib.seamlessDashImmutableMod.SeamlessImmutableNs.Immutable[T, js.Object] = js.native
  def reduce[TTarget](
    callbackfn: js.Function4[
  ...
  ): seamlessDashImmutableLib.seamlessDashImmutableMod.SeamlessImmutableNs.Immutable[TTarget, js.Object] = js.native
  def reduceRight(
    callbackfn: js.Function4[
      /* previousValue */ T, 
      /* currentValue */ T, 
  ...
  def slice(): seamlessDashImmutableLib.seamlessDashImmutableMod.SeamlessImmutableNs.Immutable[js.Array[T], js.Object] = js.native
  def slice(start: scala.Double): seamlessDashImmutableLib.seamlessDashImmutableMod.SeamlessImmutableNs.Immutable[js.Array[T], js.Object] = js.native
  def slice(start: scala.Double, end: scala.Double): seamlessDashImmutableLib.seamlessDashImmutableMod.SeamlessImmutableNs.Immutable[js.Array[T], js.Object] = js.native
}
