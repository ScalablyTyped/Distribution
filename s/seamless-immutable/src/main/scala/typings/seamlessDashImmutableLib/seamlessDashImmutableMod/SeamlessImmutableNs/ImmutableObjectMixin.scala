...
trait ImmutableObjectMixin[T] extends js.Object {
  ...
  ): Immutable[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  def getIn[K /* <: java.lang.String */, L /* <: java.lang.String */](propertyPath: js.Tuple2[K, L]): Immutable[/* import warning: ImportType.apply Failed type conversion: T[K][L] */ js.Any] = js.native
  ...
  ): Immutable[/* import warning: ImportType.apply Failed type conversion: T[K][L] */ js.Any] = js.native
  def getIn[K /* <: java.lang.String */, L /* <: java.lang.String */, M /* <: java.lang.String */](propertyPath: js.Tuple3[K, L, M]): Immutable[/* import warning: ImportType.apply Failed type conversion: T[K][L][M] */ js.Any] = js.native
  ...
  @JSName("getIn")
  def getIn_KString[K /* <: java.lang.String */](propertyPath: js.Array[K]): Immutable[/* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any] = js.native
  ...
  def set[K /* <: java.lang.String */](property: K, value: /* import warning: ImportType.apply Failed type conversion: T[K] */ js.Any): Immutable[T] = js.native
