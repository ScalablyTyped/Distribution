...
trait ImmutableObjectMixin[T] extends js.Object {
  ...
  def asMutable(opts: AsMutableOptions[scala.Boolean]): T | (/* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof T ]: seamless-immutable.seamless-immutable.Immutable<T[K], {}>}
    */ seamlessDashImmutableLib.seamlessDashImmutableLibStrings.ImmutableObjectMixin with T) = js.native
  @JSName("asMutable")
  def asMutable_false(opts: AsMutableOptions[seamlessDashImmutableLib.seamlessDashImmutableLibNumbers.`false`]): /* import warning: ImportType.apply c Unsupported type mapping: 
  {[ K in keyof T ]: seamless-immutable.seamless-immutable.Immutable<T[K], {}>}
    */ seamlessDashImmutableLib.seamlessDashImmutableLibStrings.ImmutableObjectMixin with T = js.native
  @JSName("asMutable")
  def asMutable_true(opts: AsMutableOptions[seamlessDashImmutableLib.seamlessDashImmutableLibNumbers.`true`]): T = js.native
  ...
  @JSName("updateIn")
  def updateIn_KString[K /* <: java.lang.String */](
    propertyPath: js.Array[K],
    updaterFunction: js.Function2[
      /* import warning: ImportType.apply Failed type conversion: T[K] */ /* value */ js.Any, 
      /* repeated */ js.Any, 
