...
/* Inlined @storybook/csf.@storybook/csf.StoryContextForLoaders<TRenderer, TArgs> & {  loaded :std.Record<string, any>,   abortSignal :std.AbortSignal,   canvasElement :TRenderer['canvasElement']} */
trait StoryContext[TRenderer /* <: Renderer */, TArgs] extends StObject {
