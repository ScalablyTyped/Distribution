...
/* Inlined @storybook/csf.@storybook/csf.StoryContextForEnhancers<TRenderer, TArgs> & std.Required<@storybook/csf.@storybook/csf.StoryContextUpdate<TArgs>> & {  hooks :unknown,   viewMode :@storybook/csf.@storybook/csf.ViewMode,   originalStoryFn :@storybook/csf.@storybook/csf.StoryFn<TRenderer, @storybook/csf.@storybook/csf.Args>} */
trait StoryContextForLoaders[TRenderer /* <: Renderer */, TArgs] extends StObject {
...
object StoryContextForLoaders {
  ...
  inline def apply[TRenderer /* <: Renderer */, TArgs](
    ...
    val __obj = js.Dynamic.literal(argTypes = argTypes.asInstanceOf[js.Any], args = args.asInstanceOf[js.Any], componentId = componentId.asInstanceOf[js.Any], globals = globals.asInstanceOf[js.Any], hooks = hooks.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], initialArgs = initialArgs.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], originalStoryFn = originalStoryFn.asInstanceOf[js.Any], parameters = parameters.asInstanceOf[js.Any], story = story.asInstanceOf[js.Any], tags = tags.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], viewMode = viewMode.asInstanceOf[js.Any])
    __obj.asInstanceOf[StoryContextForLoaders[TRenderer, TArgs]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StoryContextForLoaders[?, ?], TRenderer /* <: Renderer */, TArgs] (val x: Self & (StoryContextForLoaders[TRenderer, TArgs])) extends AnyVal {
