...
trait Modal extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashModalLib.semanticDashUiDashModalLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-modal.SemanticUI.ModalSettings._Impl[K] */ js.Any = js.native
