...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'selector'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
