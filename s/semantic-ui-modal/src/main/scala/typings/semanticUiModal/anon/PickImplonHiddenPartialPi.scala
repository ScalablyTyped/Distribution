...
import typings.semanticUiModal.SemanticUI.ModalSettings.Param
import typings.semanticUiModal.semanticUiModalBooleans.`false`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'onHidden'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
trait PickImplonHiddenPartialPi
  extends StObject
     with Param {
  ...
  def onHidden(): Unit
  @JSName("onHidden")
  var onHidden_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonHiddenPartialPi {
  ...
  extension [Self <: PickImplonHiddenPartialPi](x: Self) {
    ...
    inline def setDimmerSettingsUndefined: Self = StObject.set(x, "dimmerSettings", js.undefined)
    ...
    inline def setOnDenyUndefined: Self = StObject.set(x, "onDeny", js.undefined)
    
    inline def setOnHidden(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onHidden", value.asInstanceOf[js.Any])
