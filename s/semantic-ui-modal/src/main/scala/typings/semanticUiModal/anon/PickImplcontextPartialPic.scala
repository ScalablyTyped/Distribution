...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'context'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
...
object PickImplcontextPartialPic {
  ...
  extension [Self <: PickImplcontextPartialPic](x: Self) {
