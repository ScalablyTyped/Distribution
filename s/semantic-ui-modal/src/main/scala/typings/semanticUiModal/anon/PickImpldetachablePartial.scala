...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'detachable'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
...
object PickImpldetachablePartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldetachablePartial] (val x: Self) extends AnyVal {
