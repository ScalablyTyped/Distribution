...
/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.distTypesMod.RuleSet[Props]
  - scala.Double
  - java.lang.String
  - js.Array[java.lang.String]
  - typings.styledComponents.distTypesMod.IStyledComponent[scala.Any, scala.Any]
  - typings.styledComponents.distTypesMod.Keyframes
*/
type FlattenerResult[Props] = _FlattenerResult[Props] | js.Array[String] | (IStyledComponent[Any, Any]) | Double | String

/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.distTypesMod.StyleFunction[Props]
  - typings.styledComponents.distTypesMod.StyledObject
  - java.lang.String
  - scala.Double
  - typings.styledComponents.distTypesMod.Keyframes
  - typings.styledComponents.distTypesMod.IStyledComponent[scala.Any, scala.Any]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.styledComponents.distTypesMod.AnyComponent[scala.Any]
*/
