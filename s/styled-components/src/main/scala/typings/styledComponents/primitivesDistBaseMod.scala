...
import typings.styledComponents.primitivesDistModelsServerStyleSheetMod.default
...
object primitivesDistBaseMod {
  
  @JSImport("styled-components/primitives/dist/base", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("styled-components/primitives/dist/base", "ServerStyleSheet")
  @js.native
  open class ServerStyleSheet () extends default
  
  @JSImport("styled-components/primitives/dist/base", "StyleSheetConsumer")
  @js.native
  val StyleSheetConsumer: Consumer[Unit | typings.styledComponents.primitivesDistSheetMod.default] = js.native
  
  @JSImport("styled-components/primitives/dist/base", "StyleSheetContext")
  @js.native
  ...
  @JSImport("styled-components/primitives/dist/base", "ThemeConsumer")
  @js.native
  val ThemeConsumer: Consumer[js.UndefOr[DefaultTheme]] = js.native
  
  @JSImport("styled-components/primitives/dist/base", "ThemeContext")
  @js.native
  ...
  object __PRIVATE__ {
    ...
    @JSImport("styled-components/primitives/dist/base", "__PRIVATE__")
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("styled-components/primitives/dist/base", "__PRIVATE__.StyleSheet")
    @js.native
    ...
    @JSImport("styled-components/primitives/dist/base", "__PRIVATE__.mainSheet")
    @js.native
  ...
  @JSImport("styled-components/primitives/dist/base", "version")
  @js.native
