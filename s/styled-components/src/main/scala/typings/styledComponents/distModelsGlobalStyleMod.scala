...
import typings.styledComponents.distDistTypesMod.FlattenerResult
...
object distModelsGlobalStyleMod {
  
  @JSImport("styled-components/primitives/dist/dist/models/GlobalStyle", JSImport.Default)
  @js.native
  open class default[Props] protected ()
    ...
    /* CompleteClass */
    override def removeStyles(instance: Double, styleSheet: typings.styledComponents.distDistSheetMod.default): Unit = js.native
  ...
  trait GlobalStyle[Props] extends StObject {
    ...
    def removeStyles(instance: Double, styleSheet: typings.styledComponents.distDistSheetMod.default): Unit
  ...
  object GlobalStyle {
    ...
    inline def apply[Props](
      componentId: String,
      createStyles: (Double, ExecutionContext & Props, typings.styledComponents.distDistSheetMod.default, Stringifier) => Unit,
      isStatic: Boolean,
      removeStyles: (Double, typings.styledComponents.distDistSheetMod.default) => Unit,
      renderStyles: (Double, ExecutionContext & Props, typings.styledComponents.distDistSheetMod.default, Stringifier) => Unit,
    ...
    extension [Self <: GlobalStyle[?], Props](x: Self & GlobalStyle[Props]) {
      ...
      inline def setCreateStyles(
        value: (Double, ExecutionContext & Props, typings.styledComponents.distDistSheetMod.default, Stringifier) => Unit
      ...
      inline def setRemoveStyles(value: (Double, typings.styledComponents.distDistSheetMod.default) => Unit): Self = StObject.set(x, "removeStyles", js.Any.fromFunction2(value))
