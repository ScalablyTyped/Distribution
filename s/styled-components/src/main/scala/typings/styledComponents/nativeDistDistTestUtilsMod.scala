...
object nativeDistDistTestUtilsMod {
  ...
  inline def resetStyled(): (js.Function1[/* tag */ WebTarget, `172`[WebTarget]]) & Abbr = ^.asInstanceOf[js.Dynamic].applyDynamic("resetStyled")().asInstanceOf[(js.Function1[/* tag */ WebTarget, `172`[WebTarget]]) & Abbr]
  inline def resetStyled(isServer: Boolean): (js.Function1[/* tag */ WebTarget, `172`[WebTarget]]) & Abbr = ^.asInstanceOf[js.Dynamic].applyDynamic("resetStyled")(isServer.asInstanceOf[js.Any]).asInstanceOf[(js.Function1[/* tag */ WebTarget, `172`[WebTarget]]) & Abbr]
