...
object nativeDistDistModelsComponentStyleMod {
  ...
  object ComponentStyle {
    ...
    inline def apply(
      baseHash: Double,
      componentId: String,
      generateAndInjectStyles: (js.Object, typings.styledComponents.nativeDistDistSheetMod.default, Stringifier) => String,
      isStatic: Boolean,
      rules: RuleSet[Any],
    ...
    implicit open class MutableBuilder[Self <: ComponentStyle] (val x: Self) extends AnyVal {
      ...
      inline def setGenerateAndInjectStyles(value: (js.Object, typings.styledComponents.nativeDistDistSheetMod.default, Stringifier) => String): Self = StObject.set(x, "generateAndInjectStyles", js.Any.fromFunction3(value))
