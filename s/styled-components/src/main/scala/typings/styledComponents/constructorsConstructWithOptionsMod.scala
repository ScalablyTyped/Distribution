...
object constructorsConstructWithOptionsMod {
  
  @JSImport("styled-components/native/dist/dist/constructors/constructWithOptions", JSImport.Namespace)
  @js.native
  ...
  trait NativeStyled[Target /* <: NativeTarget */, OuterProps, OuterStatics] extends StObject {
    ...
    def apply[Props, Statics](
      ...
      interpolations: (Exclude[Interpolation[OuterProps & Props], IStyledComponent[Any, Any]])*
    ): (IStyledNativeComponent[Target, OuterProps & Props]) & OuterStatics & Statics = js.native
    
    def attrs(attrs: Attrs[OuterProps]): NativeStyled[Target, OuterProps, OuterStatics] = js.native
    
    def withConfig(config: StyledNativeOptions[OuterProps]): NativeStyled[Target, OuterProps, OuterStatics] = js.native
  }
  
  @js.native
  trait WebStyled[Target /* <: WebTarget */, OuterProps, OuterStatics] extends StObject {
    
    def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): (IStyledComponent[Target, OuterProps & Props]) & OuterStatics & Statics = js.native
    
    def attrs(attrs: Attrs[OuterProps]): WebStyled[Target, OuterProps, OuterStatics] = js.native
    
    def withConfig(config: StyledOptions[OuterProps]): WebStyled[Target, OuterProps, OuterStatics] = js.native
  }
}
