...
object serverStyleSheetMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var instance: typings.styledComponents.sheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typings.styledComponents.sheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      getStyleTags: () => String,
      instance: typings.styledComponents.sheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typings.styledComponents.sheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
