...
object distModelsStyleSheetManagerMod {
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", JSImport.Namespace)
  @js.native
  ...
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "StyleSheetConsumer")
  @js.native
  val StyleSheetConsumer: Consumer[Unit | default] = js.native
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "StyleSheetContext")
  @js.native
  val StyleSheetContext: Context[Unit | default] = js.native
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "StylisConsumer")
  @js.native
  val StylisConsumer: Consumer[Unit | Stringifier] = js.native
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "StylisContext")
  @js.native
  val StylisContext: Context[Unit | Stringifier] = js.native
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "mainSheet")
  @js.native
  val mainSheet: default = js.native
  
  @JSImport("styled-components/primitives/dist/dist/models/StyleSheetManager", "mainStylis")
  @js.native
