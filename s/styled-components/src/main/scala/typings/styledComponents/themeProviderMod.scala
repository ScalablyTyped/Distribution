...
object themeProviderMod {
  ...
  @JSImport("styled-components/native/dist/dist/models/ThemeProvider", JSImport.Namespace)
  @js.native
  ...
  @JSImport("styled-components/native/dist/dist/models/ThemeProvider", "ThemeConsumer")
  @js.native
  val ThemeConsumer: Consumer[js.UndefOr[DefaultTheme]] = js.native
  
  @JSImport("styled-components/native/dist/dist/models/ThemeProvider", "ThemeContext")
  @js.native
