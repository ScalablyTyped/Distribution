...
object nativeDistModelsStyleSheetManagerMod {
  
  @JSImport("styled-components/native/dist/models/StyleSheetManager", JSImport.Namespace)
  @js.native
  ...
  @JSImport("styled-components/native/dist/models/StyleSheetManager", "StyleSheetConsumer")
  @js.native
  val StyleSheetConsumer: Consumer[Unit | default] = js.native
  
  @JSImport("styled-components/native/dist/models/StyleSheetManager", "StyleSheetContext")
  @js.native
  ...
  @JSImport("styled-components/native/dist/models/StyleSheetManager", "StylisContext")
  @js.native
  val StylisContext: Context[Unit | Stringifier] = js.native
  
  @JSImport("styled-components/native/dist/models/StyleSheetManager", "mainSheet")
  @js.native
  val mainSheet: default = js.native
  
  @JSImport("styled-components/native/dist/models/StyleSheetManager", "mainStylis")
  @js.native
