...
import typings.styledComponents.anon.View
...
object primitivesDistPrimitivesMod {
  
  @JSImport("styled-components/primitives/dist/primitives", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("styled-components/primitives/dist/primitives", JSImport.Default)
  @js.native
  val default: (js.Function1[/* tag */ NativeTarget, `709`[NativeTarget]]) & View = js.native
  
  @JSImport("styled-components/primitives/dist/primitives", "ThemeConsumer")
  @js.native
  val ThemeConsumer: Consumer[js.UndefOr[DefaultTheme]] = js.native
  
  @JSImport("styled-components/primitives/dist/primitives", "ThemeContext")
  @js.native
