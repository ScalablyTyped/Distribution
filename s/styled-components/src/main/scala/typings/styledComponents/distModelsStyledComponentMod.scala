...
import typings.styledComponents.distDistTypesMod.ExoticComponentWithDisplayName
...
object distModelsStyledComponentMod {
  
  @JSImport("styled-components/primitives/dist/dist/models/StyledComponent", JSImport.Namespace)
  @js.native
