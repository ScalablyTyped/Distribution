...
object modelsServerStyleSheetMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var instance: typings.styledComponents.distSheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typings.styledComponents.distSheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      getStyleTags: () => String,
      instance: typings.styledComponents.distSheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typings.styledComponents.distSheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
