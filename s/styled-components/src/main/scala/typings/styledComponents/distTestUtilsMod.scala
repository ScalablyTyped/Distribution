...
object distTestUtilsMod {
  ...
  @JSImport("styled-components/primitives/dist/dist/test/utils", JSImport.Namespace)
  @js.native
  ...
  inline def resetStyled(): (js.Function1[/* tag */ WebTarget, `706`[WebTarget]]) & Animate = ^.asInstanceOf[js.Dynamic].applyDynamic("resetStyled")().asInstanceOf[(js.Function1[/* tag */ WebTarget, `706`[WebTarget]]) & Animate]
  inline def resetStyled(isServer: Boolean): (js.Function1[/* tag */ WebTarget, `706`[WebTarget]]) & Animate = ^.asInstanceOf[js.Dynamic].applyDynamic("resetStyled")(isServer.asInstanceOf[js.Any]).asInstanceOf[(js.Function1[/* tag */ WebTarget, `706`[WebTarget]]) & Animate]
