...
object nativeDistDistModelsServerStyleSheetMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    var instance: typings.styledComponents.nativeDistDistSheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typings.styledComponents.nativeDistDistSheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      getStyleTags: () => String,
      instance: typings.styledComponents.nativeDistDistSheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typings.styledComponents.nativeDistDistSheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
