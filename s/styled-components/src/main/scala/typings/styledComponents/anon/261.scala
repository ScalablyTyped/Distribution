...
@js.native
trait `261`[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[source, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[source, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
