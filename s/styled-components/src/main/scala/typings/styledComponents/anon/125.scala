...
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[feDisplacementMap, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[feDisplacementMap, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
