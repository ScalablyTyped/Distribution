...
@js.native
trait `576`[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[hgroup, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[hgroup, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
