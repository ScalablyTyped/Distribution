...
import typings.styledComponents.nativeDistTypesMod.ExoticComponentWithDisplayName
...
@js.native
trait `167`[OuterProps, Environment /* <: web | native */, Target /* <: ExoticComponentWithDisplayName[Any] | (ComponentClass[Any, ComponentState]) | FunctionComponent[Any] */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
