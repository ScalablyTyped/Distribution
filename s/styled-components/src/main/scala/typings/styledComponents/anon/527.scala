...
@js.native
trait `527`[OuterProps, Environment /* <: web | native */, Target /* <: ExoticComponentWithDisplayName[Any] | (ComponentClass[Any, ComponentState]) | FunctionComponent[Any] */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[Target, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[Target, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
