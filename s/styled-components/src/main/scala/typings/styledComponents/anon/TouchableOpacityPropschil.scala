...
/* Inlined react-native.react-native.TouchableOpacityProps & {  children :react.react.ReactNode | undefined} */
trait TouchableOpacityPropschil extends StObject {
...
object TouchableOpacityPropschil {
  
  inline def apply(): TouchableOpacityPropschil = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TouchableOpacityPropschil]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TouchableOpacityPropschil] (val x: Self) extends AnyVal {
