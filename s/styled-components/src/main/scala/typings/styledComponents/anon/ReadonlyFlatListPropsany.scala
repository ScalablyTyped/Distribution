...
object ReadonlyFlatListPropsany {
  ...
  extension [Self <: ReadonlyFlatListPropsany](x: Self) {
    ...
    inline def setData(value: js.Array[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ js.Any]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataNull: Self = StObject.set(x, "data", null)
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: (/* import warning: RewrittenClass.unapply cls was tparam ItemT */ js.Any)*): Self = StObject.set(x, "data", js.Array(value :_*))
