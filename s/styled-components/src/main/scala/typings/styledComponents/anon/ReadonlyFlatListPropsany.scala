...
trait ReadonlyFlatListPropsany extends StObject {
  ...
  val ListFooterComponentStyle: js.UndefOr[ViewStyle | Null] = js.native
  
  val ListHeaderComponent: js.UndefOr[ComponentType[_] | ReactElement | Null] = js.native
  
  val ListHeaderComponentStyle: js.UndefOr[ViewStyle | Null] = js.native
  ...
  val columnWrapperStyle: js.UndefOr[StyleProp[ViewStyle]] = js.native
  ...
  val data: js.UndefOr[
    (js.Array[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ _]) | Null
  ] = js.native
  ...
  val numColumns: js.UndefOr[Double] = js.native
  ...
  val renderItem: js.UndefOr[
    (ListRenderItem[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ _]) | Null
  ] = js.native
  ...
  val viewabilityConfig: js.UndefOr[js.Any] = js.native
...
object ReadonlyFlatListPropsany {
  ...
  implicit class ReadonlyFlatListPropsanyMutableBuilder[Self <: ReadonlyFlatListPropsany] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setData(value: js.Array[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ _]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRenderItem(
      value: /* info */ ListRenderItemInfo[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ _] => ReactElement | Null
