...
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[animateMotion, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[animateMotion, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
