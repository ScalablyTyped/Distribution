...
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[feComponentTransfer, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[feComponentTransfer, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
