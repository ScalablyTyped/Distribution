...
object PickStyledComponentBasean {
  ...
  extension [Self <: PickStyledComponentBasean](x: Self) {
    
    inline def setDefaultProps(value: Partial[StyledComponentProps[js.Any, js.Any, js.Any, js.Any]]): Self = StObject.set(x, "defaultProps", value.asInstanceOf[js.Any])
    ...
    inline def setPropTypes(value: WeakValidationMap[StyledComponentProps[js.Any, js.Any, js.Any, js.Any]]): Self = StObject.set(x, "propTypes", value.asInstanceOf[js.Any])
