...
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[animateTransform, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[animateTransform, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
