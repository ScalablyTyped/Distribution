...
@js.native
trait `169`[OuterProps, Environment /* <: web | native */, Target /* <: ExoticComponentWithDisplayName[Any] | (ComponentClass[Any, ComponentState]) | FunctionComponent[Any] */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
