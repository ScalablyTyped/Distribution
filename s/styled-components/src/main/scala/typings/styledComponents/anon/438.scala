...
@js.native
trait `438`[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[slot, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[slot, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
