...
/* Inlined std.Readonly<react-native.react-native.VirtualizedListProps</ * import warning: RewrittenClass.unapply cls was tparam ItemT * / any>> */
trait ReadonlyVirtualizedListPr extends StObject {
...
object ReadonlyVirtualizedListPr {
  
  inline def apply(): ReadonlyVirtualizedListPr = {
