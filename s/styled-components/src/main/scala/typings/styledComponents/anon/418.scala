...
@js.native
trait `418`[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
OuterStatics] extends StObject {
  ...
  def apply[Props, Statics](initialStyles: Styles[OuterProps & Props], interpolations: (Interpolation[OuterProps & Props])*): ReturnType[
    (IStyledNativeComponentFactory[meter, OuterProps & Props, OuterStatics & Statics]) | (IStyledComponentFactory[meter, OuterProps & Props, OuterStatics & Statics])
  ] = js.native
