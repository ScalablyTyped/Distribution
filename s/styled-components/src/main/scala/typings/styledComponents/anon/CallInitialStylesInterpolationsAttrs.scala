...
@js.native
trait CallInitialStylesInterpolationsAttrs[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
