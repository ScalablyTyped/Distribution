...
import typings.styledComponents.anon.AsActualComponent
import typings.styledComponents.anon.`708`
...
type CustomComponentProps[ActualComponent /* <: StyledTarget */, PropsToBeInjectedIntoActualComponent /* <: js.Object */, ActualComponentProps] = (AsActualComponent[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
(/* keyof ActualComponentProps */ String) | as | $as]) & ActualComponentProps) | (`708`[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
(/* keyof ActualComponentProps */ String) | as | $as]) & ActualComponentProps)

/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.distDistTypesMod.RuleSet[Props]
  - scala.Double
  - java.lang.String
  - js.Array[java.lang.String]
  - typings.styledComponents.distDistTypesMod.IStyledComponent[scala.Any, scala.Any]
  - typings.styledComponents.distDistTypesMod.Keyframes
*/
type FlattenerResult[Props] = _FlattenerResult[Props] | js.Array[String] | (IStyledComponent[Any, Any]) | Double | String

/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.distDistTypesMod.StyleFunction[Props]
  - typings.styledComponents.distDistTypesMod.StyledObject
  - java.lang.String
  - scala.Double
  - typings.styledComponents.distDistTypesMod.Keyframes
  - typings.styledComponents.distDistTypesMod.IStyledComponent[scala.Any, scala.Any]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.styledComponents.distDistTypesMod.AnyComponent[scala.Any]
*/
