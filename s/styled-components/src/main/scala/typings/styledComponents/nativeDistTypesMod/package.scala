...
import typings.styledComponents.anon.`350`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.styledComponents.nativeDistTypesMod.IStyledComponent[scala.Any, scala.Any]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.styledComponents.nativeDistTypesMod.StyledObject
  - java.lang.String
  - scala.Double
  - typings.styledComponents.nativeDistTypesMod.Keyframes
  - typings.styledComponents.nativeDistTypesMod.IStyledComponent[scala.Any, scala.Any]
...
type PolymorphicComponentProps[ActualComponent /* <: StyledTarget */, PropsToBeInjectedIntoActualComponent /* <: js.Object */, ActualComponentProps] = (AsAs[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
(/* keyof ActualComponentProps */ String) | as | $as]) & ActualComponentProps) | (`350`[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
