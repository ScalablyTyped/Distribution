...
import typings.styledComponents.primitivesDistSheetTypesMod.GroupedTag
import typings.styledComponents.primitivesDistSheetTypesMod.Sheet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object primitivesDistSheetSheetMod {
  
  @JSImport("styled-components/primitives/dist/sheet/Sheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with StyleSheet {
