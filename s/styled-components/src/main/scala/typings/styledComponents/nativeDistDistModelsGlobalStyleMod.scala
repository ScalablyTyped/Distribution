...
import typings.styledComponents.nativeDistDistTypesMod.FlattenerResult
...
object nativeDistDistModelsGlobalStyleMod {
  ...
  open class default[Props] protected ()
    ...
    /* CompleteClass */
    override def removeStyles(instance: Double, styleSheet: typings.styledComponents.nativeDistDistSheetMod.default): Unit = js.native
  ...
  trait GlobalStyle[Props] extends StObject {
    ...
    def removeStyles(instance: Double, styleSheet: typings.styledComponents.nativeDistDistSheetMod.default): Unit
  ...
  object GlobalStyle {
    ...
    inline def apply[Props](
      componentId: String,
      createStyles: (Double, ExecutionContext & Props, typings.styledComponents.nativeDistDistSheetMod.default, Stringifier) => Unit,
      isStatic: Boolean,
      removeStyles: (Double, typings.styledComponents.nativeDistDistSheetMod.default) => Unit,
      renderStyles: (Double, ExecutionContext & Props, typings.styledComponents.nativeDistDistSheetMod.default, Stringifier) => Unit,
    ...
    extension [Self <: GlobalStyle[?], Props](x: Self & GlobalStyle[Props]) {
      ...
      inline def setCreateStyles(
        value: (Double, ExecutionContext & Props, typings.styledComponents.nativeDistDistSheetMod.default, Stringifier) => Unit
      ...
      inline def setRemoveStyles(value: (Double, typings.styledComponents.nativeDistDistSheetMod.default) => Unit): Self = StObject.set(x, "removeStyles", js.Any.fromFunction2(value))
