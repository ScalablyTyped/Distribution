...
object CSSObject {
  ...
  def apply(
    ...
    StringDictionary: /* key */ StringDictionary[js.UndefOr[CSSObject | String | Double]] = null,
    ...
    if (_InterpolationValue != null) js.Dynamic.global.Object.assign(__obj, _InterpolationValue)
