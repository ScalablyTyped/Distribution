...
@js.native
trait ThemedStyledFunction[C /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 176 */ js.Any */, T /* <: js.Object */, O /* <: js.Object */, A /* <: String */] extends ThemedStyledFunctionBase[C, T, O, A] {
