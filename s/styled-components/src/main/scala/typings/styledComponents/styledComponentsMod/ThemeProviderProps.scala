...
object ThemeProviderProps {
  @scala.inline
  def apply[/* <: js.Object */ T, /* <: js.Object */ U](theme: T | (js.Function1[/* theme */ U, T])): ThemeProviderProps[T, U] = {
    val __obj = js.Dynamic.literal(theme = theme.asInstanceOf[js.Any])
    __obj.asInstanceOf[ThemeProviderProps[T, U]]
  }
  @scala.inline
  implicit class ThemeProviderPropsOps[Self <: ThemeProviderProps[_, _], /* <: js.Object */ T, /* <: js.Object */ U] (val x: Self with (ThemeProviderProps[T, U])) extends AnyVal {
    @scala.inline
