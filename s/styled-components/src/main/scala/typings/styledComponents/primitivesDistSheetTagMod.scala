...
import typings.styledComponents.primitivesDistSheetTypesMod.SheetOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object primitivesDistSheetTagMod {
  
  @JSImport("styled-components/primitives/dist/sheet/Tag", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("styled-components/primitives/dist/sheet/Tag", "CSSOMTag")
  @js.native
  open class CSSOMTag ()
    extends StObject
       with DeleteRule {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("styled-components/primitives/dist/sheet/Tag", "TextTag")
  @js.native
  open class TextTag ()
    extends StObject
       with Element {
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("styled-components/primitives/dist/sheet/Tag", "VirtualTag")
  @js.native
