...
import typings.styledComponents.TypeofClassImage
import typings.styledComponents.TypeofClassListView
import typings.styledComponents.TypeofClassPicker
import typings.styledComponents.TypeofClassPickerIOS
import typings.styledComponents.TypeofClassRefreshControl
import typings.styledComponents.TypeofClassStatusBar
import typings.styledComponents.TypeofClassSwipeableListView
import typings.styledComponents.TypeofClassTabBarIOS
import typings.styledComponents.TypeofClassTextInput
import typings.styledComponents.TypeofClassTouchableNativeFeedback
import typings.styledComponents.TypeofClassView
...
trait ReactNativeStyledInterface[T /* <: js.Object */] extends ReactNativeThemedBaseStyledInterface[AnyIfEmpty[T]] {
  ...
  var Modal: ReactNativeThemedStyledFunction[Instantiable0[typings.reactNative.mod.Modal], T] = js.native
  var NavigatorIOS: ReactNativeThemedStyledFunction[Instantiable0[typings.reactNative.mod.NavigatorIOS], T] = js.native
  ...
  var SwitchIOS: ReactNativeThemedStyledFunction[Instantiable0[typings.reactNative.mod.SwitchIOS], T] = js.native
