...
object modelsGlobalStyleMod {
  ...
  open class default[Props] protected ()
    ...
    override def createStyles(
      ...
      styleSheet: typings.styledComponents.distSheetMod.default,
      stylis: Stringifier
    ): Unit = js.native
    ...
    /* CompleteClass */
    override def removeStyles(instance: Double, styleSheet: typings.styledComponents.distSheetMod.default): Unit = js.native
  ...
  trait GlobalStyle[Props] extends StObject {
    ...
    def removeStyles(instance: Double, styleSheet: typings.styledComponents.distSheetMod.default): Unit
  ...
  object GlobalStyle {
    ...
    inline def apply[Props](
      componentId: String,
      createStyles: (Double, ExecutionContext & Props, typings.styledComponents.distSheetMod.default, Stringifier) => Unit,
      isStatic: Boolean,
      removeStyles: (Double, typings.styledComponents.distSheetMod.default) => Unit,
      renderStyles: (Double, ExecutionContext & Props, typings.styledComponents.distSheetMod.default, Stringifier) => Unit,
    ...
    extension [Self <: GlobalStyle[?], Props](x: Self & GlobalStyle[Props]) {
      ...
      inline def setCreateStyles(
        value: (Double, ExecutionContext & Props, typings.styledComponents.distSheetMod.default, Stringifier) => Unit
      ...
      inline def setRemoveStyles(value: (Double, typings.styledComponents.distSheetMod.default) => Unit): Self = StObject.set(x, "removeStyles", js.Any.fromFunction2(value))
