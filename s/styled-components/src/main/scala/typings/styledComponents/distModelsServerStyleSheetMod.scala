...
object distModelsServerStyleSheetMod {
  
  @JSImport("styled-components/primitives/dist/dist/models/ServerStyleSheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
    ...
    /* CompleteClass */
    var instance: typings.styledComponents.distDistSheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typings.styledComponents.distDistSheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      getStyleTags: () => String,
      instance: typings.styledComponents.distDistSheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typings.styledComponents.distDistSheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
