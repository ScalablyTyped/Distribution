...
object distModelsKeyframesMod {
  ...
  trait Keyframes
    ...
    def inject(styleSheet: typings.styledComponents.distSheetMod.default): Unit = js.native
    def inject(styleSheet: typings.styledComponents.distSheetMod.default, stylisInstance: Stringifier): Unit = js.native
  }
}
