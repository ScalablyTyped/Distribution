...
import typings.styledComponents.anon.AsActualComponentAs
import typings.styledComponents.anon.`710`
...
type CSSProp = String | StyledObject | StyleFunction[ExecutionContext]

/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.primitivesDistTypesMod.RuleSet[Props]
  - scala.Double
  - java.lang.String
  - js.Array[java.lang.String]
  - typings.styledComponents.primitivesDistTypesMod.IStyledComponent[scala.Any, scala.Any]
  - typings.styledComponents.primitivesDistTypesMod.Keyframes
*/
type FlattenerResult[Props] = _FlattenerResult[Props] | js.Array[String] | (IStyledComponent[Any, Any]) | Double | String

/* Rewritten from type alias, can be one of: 
  - typings.styledComponents.primitivesDistTypesMod.StyleFunction[Props]
  - typings.styledComponents.primitivesDistTypesMod.StyledObject
  - java.lang.String
  - scala.Double
  - typings.styledComponents.primitivesDistTypesMod.Keyframes
  - typings.styledComponents.primitivesDistTypesMod.IStyledComponent[scala.Any, scala.Any]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.styledComponents.primitivesDistTypesMod.AnyComponent[scala.Any]
*/
...
type PolymorphicComponentProps[ActualComponent /* <: StyledTarget */, PropsToBeInjectedIntoActualComponent /* <: js.Object */, ActualComponentProps] = (AsActualComponentAs[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
(/* keyof ActualComponentProps */ String) | as | $as]) & ActualComponentProps) | (`710`[ActualComponent] & HTMLAttributes[ActualComponent] & (Omit[
PropsToBeInjectedIntoActualComponent, 
