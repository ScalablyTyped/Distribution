...
object primitivesDistModelsComponentStyleMod {
  
  @JSImport("styled-components/primitives/dist/models/ComponentStyle", JSImport.Default)
  @js.native
  ...
  object ComponentStyle {
    ...
    inline def apply(
      baseHash: Double,
      componentId: String,
      generateAndInjectStyles: (js.Object, typings.styledComponents.primitivesDistSheetMod.default, Stringifier) => String,
      isStatic: Boolean,
      rules: RuleSet[Any],
    ...
    extension [Self <: ComponentStyle](x: Self) {
      ...
      inline def setGenerateAndInjectStyles(value: (js.Object, typings.styledComponents.primitivesDistSheetMod.default, Stringifier) => String): Self = StObject.set(x, "generateAndInjectStyles", js.Any.fromFunction3(value))
