...
import typings.styledComponents.anon.ActivityIndicatorIOS
...
object distDistNativeMod {
  
  @JSImport("styled-components/primitives/dist/dist/native", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("styled-components/primitives/dist/dist/native", JSImport.Default)
  @js.native
  val default: (js.Function1[/* tag */ NativeTarget, `707`[NativeTarget]]) & ActivityIndicatorIOS = js.native
  
  @JSImport("styled-components/primitives/dist/dist/native", "ThemeConsumer")
  @js.native
  val ThemeConsumer: Consumer[js.UndefOr[DefaultTheme]] = js.native
  
  @JSImport("styled-components/primitives/dist/dist/native", "ThemeContext")
  @js.native
