...
object primitivesDistModelsServerStyleSheetMod {
  
  @JSImport("styled-components/primitives/dist/models/ServerStyleSheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
    ...
    /* CompleteClass */
    var instance: typings.styledComponents.primitivesDistSheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typings.styledComponents.primitivesDistSheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      getStyleTags: () => String,
      instance: typings.styledComponents.primitivesDistSheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typings.styledComponents.primitivesDistSheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
