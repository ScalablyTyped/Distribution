...
import typings.styledComponents.nativeDistSheetTypesMod.GroupedTag
import typings.styledComponents.nativeDistSheetTypesMod.Sheet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nativeDistSheetSheetMod {
  
  @JSImport("styled-components/native/dist/sheet/Sheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with StyleSheet {
