...
object nativeDistUtilsHashMod {
  
  @JSImport("styled-components/native/dist/utils/hash", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("styled-components/native/dist/utils/hash", "SEED")
  @js.native
