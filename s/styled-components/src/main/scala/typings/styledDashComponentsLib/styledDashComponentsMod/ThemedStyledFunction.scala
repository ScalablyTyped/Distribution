...
trait ThemedStyledFunction[C /* <: java.lang.String */, T /* <: js.Object */, O /* <: js.Object */, A /* <: java.lang.String */] extends ThemedStyledFunctionBase[C, T, O, A] {
  ...
  def attrs[U, NewA /* <: (stdLib.Partial[StyledComponentPropsWithRef[C] with U]) with org.scalablytyped.runtime.StringDictionary[js.Any] */](attrs: DeprecatedAttrs[StyledComponentPropsWithRef[C] with U, NewA, T]): ThemedStyledFunction[C, T, O with NewA, A | java.lang.String] = js.native
}
