...
class ServerStyleSheet () extends js.Object {
  ...
  def collectStyles(tree: reactLib.reactMod.ReactNs.ReactNode): reactLib.reactMod.ReactNs.ReactElement = js.native
  def getStyleElement(): js.Array[reactLib.reactMod.ReactNs.ReactElement] = js.native
