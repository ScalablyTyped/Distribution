...
object operationMod {
  ...
  */
  ...
  trait OperationInterface extends StObject {
    ...
    def inverse(op: typings.slate.operationMod.Operation): typings.slate.operationMod.Operation
  ...
  object OperationInterface {
    ...
    inline def apply(
      inverse: typings.slate.operationMod.Operation => typings.slate.operationMod.Operation,
    ...
    extension [Self <: OperationInterface](x: Self) {
      ...
      inline def setInverse(value: typings.slate.operationMod.Operation => typings.slate.operationMod.Operation): Self = StObject.set(x, "inverse", js.Any.fromFunction1(value))
