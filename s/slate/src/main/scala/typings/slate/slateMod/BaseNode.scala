...
trait BaseNode extends js.Object {
  ...
  def blocks(options: IterableOptions with Anon_OnlyLeaves): Iterable[js.Tuple2[Block, List[Double]]] = js.native
  ...
  def inlines(options: IterableOptions with Anon_OnlyLeaves): Iterable[js.Tuple2[Inline, List[Double]]] = js.native
  ...
  def marks(options: IterableOptions with Anon_OnlyTypes): Iterable[js.Tuple3[Mark, Node, List[Double]]] = js.native
