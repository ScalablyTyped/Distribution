...
object distInterfacesTransformsTextMod {
  ...
  @JSImport("slate/dist/interfaces/transforms/text", "TextTransforms")
  @js.native
  val TextTransforms: typings.slate.distInterfacesTransformsTextMod.TextTransforms = js.native
