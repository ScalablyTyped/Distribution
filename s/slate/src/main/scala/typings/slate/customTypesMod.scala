...
object customTypesMod {
  ...
  */
  ...
  type ExtendedType[K /* <: ExtendableTypes */, B] = (/* import warning: importer.ImportType#apply Failed type conversion: slate.slate/dist/interfaces/custom-types.CustomTypes[K] */ js.Any) | B
}
