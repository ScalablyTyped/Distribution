...
object pointMod {
  ...
  type PointEntry = js.Tuple2[typings.slate.pointMod.Point, anchor | focus]
  
  @js.native
  trait PointInterface extends StObject {
    
    def compare(point: typings.slate.pointMod.Point, another: typings.slate.pointMod.Point): `-1` | `0` | `1` = js.native
    
    def equals(point: typings.slate.pointMod.Point, another: typings.slate.pointMod.Point): Boolean = js.native
    
    def isAfter(point: typings.slate.pointMod.Point, another: typings.slate.pointMod.Point): Boolean = js.native
    
    def isBefore(point: typings.slate.pointMod.Point, another: typings.slate.pointMod.Point): Boolean = js.native
    
    def isPoint(value: Any): /* is slate.slate/dist/interfaces/point.Point */ Boolean = js.native
    
    def transform(point: typings.slate.pointMod.Point, op: Operation): typings.slate.pointMod.Point | Null = js.native
    def transform(point: typings.slate.pointMod.Point, op: Operation, options: PointTransformOptions): typings.slate.pointMod.Point | Null = js.native
  }
