...
object elementMod {
  ...
  type ElementEntry = js.Tuple2[typings.slate.elementMod.Element, Path]
  ...
  trait ElementInterface extends StObject {
    ...
    def isElementType[T /* <: typings.slate.elementMod.Element */](value: Any, elementVal: String): /* is T */ Boolean = js.native
    def isElementType[T /* <: typings.slate.elementMod.Element */](value: Any, elementVal: String, elementKey: String): /* is T */ Boolean = js.native
    
    def matches(element: typings.slate.elementMod.Element, props: Partial[typings.slate.elementMod.Element]): Boolean = js.native
  }
}
