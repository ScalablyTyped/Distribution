...
trait Anon_010100014 extends js.Object {
  var className: screepsLib.screepsLibStrings.operator
  var cooldown: screepsLib.screepsLibNumbers.`400`
  var duration: js.Tuple5[
    screepsLib.screepsLibNumbers.`200`, 
    screepsLib.screepsLibNumbers.`400`, 
    screepsLib.screepsLibNumbers.`600`, 
    screepsLib.screepsLibNumbers.`800`, 
    screepsLib.screepsLibNumbers.`1000`
  ]
  var level: js.Tuple5[
...
object Anon_010100014 {
  @scala.inline
  def apply(
    className: screepsLib.screepsLibStrings.operator,
    cooldown: screepsLib.screepsLibNumbers.`400`,
    duration: js.Tuple5[
      screepsLib.screepsLibNumbers.`200`, 
      screepsLib.screepsLibNumbers.`400`, 
      screepsLib.screepsLibNumbers.`600`, 
    ...
    __obj.asInstanceOf[Anon_010100014]
  }
}
