...
trait RoomPosition extends js.Object {
  ...
  /**
       ...
       */
  def findClosestByPath[K /* <: FindConstant */](`type`: K): js.Any | scala.Null = js.native
  /**
       * Find the object with the shortest path from the given position. Uses A* search algorithm and Dijkstra's algorithm.
       * @param type Any of the FIND_* constants.
       * @param opts An object containing pathfinding options (see Room.findPath), or one of the following: filter, algorithm
       * @returns An instance of a RoomObject.
       */
  def findClosestByPath[K /* <: FindConstant */](`type`: K, opts: FindPathOpts with FilterOptions[K] with Anon_Algorithm): js.Any | scala.Null = js.native
  ...
  /**
       ...
       * @param opts An object containing pathfinding options (see Room.findPath), or one of the following: filter, algorithm
       */
  def findClosestByRange[K /* <: FindConstant */](`type`: K): js.Any | scala.Null = js.native
  /**
       * Find the object with the shortest linear distance from the given position.
       * @param type Any of the FIND_* constants.
       * @param opts An object containing pathfinding options (see Room.findPath), or one of the following: filter, algorithm
       */
  def findClosestByRange[K /* <: FindConstant */](`type`: K, opts: FilterOptions[K]): js.Any | scala.Null = js.native
  ...
  /**
       ...
       * @param opts See Room.find.
       */
  def findInRange[K /* <: FindConstant */](`type`: K, range: scala.Double): js.Array[_] = js.native
  /**
       * Find all objects in the specified linear range.
       * @param type Any of the FIND_* constants.
       * @param range The range distance.
       * @param opts See Room.find.
       */
  def findInRange[K /* <: FindConstant */](`type`: K, range: scala.Double, opts: FilterOptions[K]): js.Array[_] = js.native
