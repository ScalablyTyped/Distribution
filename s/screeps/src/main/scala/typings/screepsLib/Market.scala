...
trait Market extends js.Object {
  /**
       ...
       */
  var credits: scala.Double = js.native
  /**
  ...
  /**
       ...
       */
  def calcTransactionCost(amount: scala.Double, roomName1: java.lang.String, roomName2: java.lang.String): scala.Double = js.native
  /**
       ...
       */
  def cancelOrder(orderId: java.lang.String): ScreepsReturnCode = js.native
  /**
       ...
       */
  def changeOrderPrice(orderId: java.lang.String, newPrice: scala.Double): ScreepsReturnCode = js.native
  /**
  ...
  /**
       ...
       */
  def deal(orderId: java.lang.String, amount: scala.Double): ScreepsReturnCode = js.native
  /**
       * Execute a trade deal from your Terminal to another player's Terminal using the specified buy/sell order.
       *
       * Your Terminal will be charged energy units of transfer cost regardless of the order resource type.
       ...
       * When multiple players try to execute the same deal, the one with the shortest distance takes precedence.
       */
  def deal(orderId: java.lang.String, amount: scala.Double, targetRoomName: java.lang.String): ScreepsReturnCode = js.native
  /**
       ...
       */
  def extendOrder(orderId: java.lang.String, addAmount: scala.Double): ScreepsReturnCode = js.native
  /**
  ...
  /**
       ...
       * @returns An array of objects containing order information.
       */
  def getAllOrders(filter: js.Function1[/* o */ Order, scala.Boolean]): js.Array[Order] = js.native
  /**
       * Get other players' orders currently active on the market.
       * @param filter (optional) An object or function that will filter the resulting list using the lodash.filter method.
       * @returns An array of objects containing order information.
  ...
  /**
       ...
       */
  def getOrderById(id: java.lang.String): Order | scala.Null = js.native
}
