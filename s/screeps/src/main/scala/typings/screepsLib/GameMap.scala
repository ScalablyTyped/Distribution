...
trait GameMap extends js.Object {
  ...
  /**
    ...
    */
  def findRoute(fromRoom: java.lang.String, toRoom: java.lang.String): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: java.lang.String, toRoom: java.lang.String, opts: RouteOptions): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: java.lang.String, toRoom: Room): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: java.lang.String, toRoom: Room, opts: RouteOptions): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: Room, toRoom: java.lang.String): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: Room, toRoom: java.lang.String, opts: RouteOptions): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: Room, toRoom: Room): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  def findRoute(fromRoom: Room, toRoom: Room, opts: RouteOptions): js.Array[Anon_RoomExit] | ERR_NO_PATH = js.native
  /**
