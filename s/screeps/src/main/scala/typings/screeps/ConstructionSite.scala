...
object ConstructionSite {
  ...
  @scala.inline
  implicit class ConstructionSiteOps[Self <: ConstructionSite[_], /* <: typings.screeps.BuildableStructureConstant */ T] (val x: Self with ConstructionSite[T]) extends AnyVal {
    @scala.inline
