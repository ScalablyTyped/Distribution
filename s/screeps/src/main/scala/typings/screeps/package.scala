...
import typings.screeps.screepsInts.`-11`
import typings.screeps.screepsInts.`-12`
import typings.screeps.screepsInts.`-14`
...
import typings.screeps.screepsInts.`-6`
import typings.screeps.screepsInts.`-7`
import typings.screeps.screepsInts.`-8`
import typings.screeps.screepsInts.`-9`
import typings.screeps.screepsInts.`0`
import typings.screeps.screepsInts.`1001`
import typings.screeps.screepsInts.`1002`
import typings.screeps.screepsInts.`101`
import typings.screeps.screepsInts.`102`
import typings.screeps.screepsInts.`103`
import typings.screeps.screepsInts.`104`
import typings.screeps.screepsInts.`105`
import typings.screeps.screepsInts.`106`
import typings.screeps.screepsInts.`107`
import typings.screeps.screepsInts.`108`
import typings.screeps.screepsInts.`109`
import typings.screeps.screepsInts.`10`
import typings.screeps.screepsInts.`110`
import typings.screeps.screepsInts.`111`
import typings.screeps.screepsInts.`112`
import typings.screeps.screepsInts.`113`
import typings.screeps.screepsInts.`114`
import typings.screeps.screepsInts.`115`
import typings.screeps.screepsInts.`116`
import typings.screeps.screepsInts.`117`
import typings.screeps.screepsInts.`118`
import typings.screeps.screepsInts.`119`
import typings.screeps.screepsInts.`11`
import typings.screeps.screepsInts.`120`
import typings.screeps.screepsInts.`121`
import typings.screeps.screepsInts.`122`
import typings.screeps.screepsInts.`123`
import typings.screeps.screepsInts.`12`
import typings.screeps.screepsInts.`13`
import typings.screeps.screepsInts.`14`
import typings.screeps.screepsInts.`15`
import typings.screeps.screepsInts.`16`
import typings.screeps.screepsInts.`17`
import typings.screeps.screepsInts.`18`
import typings.screeps.screepsInts.`19`
import typings.screeps.screepsInts.`1`
import typings.screeps.screepsInts.`2`
import typings.screeps.screepsInts.`3`
import typings.screeps.screepsInts.`4`
...
import typings.screeps.screepsStrings.accessKey
import typings.screeps.screepsStrings.alloy
import typings.screeps.screepsStrings.attack
import typings.screeps.screepsStrings.battery
import typings.screeps.screepsStrings.biomass
import typings.screeps.screepsStrings.buy
import typings.screeps.screepsStrings.carry
import typings.screeps.screepsStrings.cell
import typings.screeps.screepsStrings.circuit
import typings.screeps.screepsStrings.claim
import typings.screeps.screepsStrings.composite
import typings.screeps.screepsStrings.concentrate
import typings.screeps.screepsStrings.condensate
...
import typings.screeps.screepsStrings.cpuUnlock
import typings.screeps.screepsStrings.creep
import typings.screeps.screepsStrings.crystal
import typings.screeps.screepsStrings.deposit
import typings.screeps.screepsStrings.device
import typings.screeps.screepsStrings.emanation
import typings.screeps.screepsStrings.energy
import typings.screeps.screepsStrings.essence
import typings.screeps.screepsStrings.exit
import typings.screeps.screepsStrings.extract
import typings.screeps.screepsStrings.extractor
import typings.screeps.screepsStrings.factory
import typings.screeps.screepsStrings.fixtures
import typings.screeps.screepsStrings.flag
import typings.screeps.screepsStrings.frame
import typings.screeps.screepsStrings.ghodium_melt
import typings.screeps.screepsStrings.heal
import typings.screeps.screepsStrings.hydraulics
import typings.screeps.screepsStrings.invaderCore
import typings.screeps.screepsStrings.keanium_bar
import typings.screeps.screepsStrings.keeperLair
import typings.screeps.screepsStrings.lab
import typings.screeps.screepsStrings.lemergium_bar
import typings.screeps.screepsStrings.link
import typings.screeps.screepsStrings.liquid
import typings.screeps.screepsStrings.machine
import typings.screeps.screepsStrings.metal
import typings.screeps.screepsStrings.microchip
import typings.screeps.screepsStrings.mineral
import typings.screeps.screepsStrings.mist
import typings.screeps.screepsStrings.move
import typings.screeps.screepsStrings.muscle
...
import typings.screeps.screepsStrings.organism
import typings.screeps.screepsStrings.organoid
import typings.screeps.screepsStrings.oxidant
import typings.screeps.screepsStrings.phlegm
import typings.screeps.screepsStrings.pixel
...
import typings.screeps.screepsStrings.transistor
import typings.screeps.screepsStrings.tube
import typings.screeps.screepsStrings.utrium_bar
import typings.screeps.screepsStrings.wire
import typings.screeps.screepsStrings.work
import typings.screeps.screepsStrings.zynthium_bar
...
/**
  ...
  */
type ConcreteStructure[T /* <: StructureConstant */] = /* import warning: importer.ImportType#apply Failed type conversion: screeps.ConcreteStructureMap[T] */ js.Any
...
type FilterFunction[T, S /* <: T */] = js.Function1[/* object */ T, /* is S */ Boolean]

type FilterObject = StringDictionary[Any]
...
type LookAtResult[K /* <: LookConstant */] = (Pick[LookAtTypes, K]) & Type[K]

type LookAtResultMatrix[K /* <: LookConstant */] = NumberDictionary[NumberDictionary[js.Array[LookAtResult[K]]]]

type LookAtResultWithPos[K /* <: LookConstant */] = LookAtResult[K] & X
...
type LookForAtAreaResultArray[T, K /* <: tombstone | exit | resource | creep | structure | source | deposit | constructionSite | mineral | nuke | flag | energy | ruin | terrain | powerCreep */] = js.Array[LookForAtAreaResultWithPos[T, K]]

type LookForAtAreaResultMatrix[T, K /* <: tombstone | exit | resource | creep | structure | source | deposit | constructionSite | mineral | nuke | flag | energy | ruin | terrain | powerCreep */] = NumberDictionary[NumberDictionary[js.Array[LookForAtAreaResult[T, K]]]]

type LookForAtAreaResultWithPos[T, K /* <: tombstone | exit | resource | creep | structure | source | deposit | constructionSite | mineral | nuke | flag | energy | ruin | terrain | powerCreep */] = (LookForAtAreaResult[T, K]) & X
...
type PowerConstant = PWR_GENERATE_OPS | PWR_OPERATE_SPAWN | PWR_OPERATE_TOWER | PWR_OPERATE_STORAGE | PWR_OPERATE_LAB | PWR_OPERATE_EXTENSION | PWR_OPERATE_OBSERVER | PWR_OPERATE_TERMINAL | PWR_DISRUPT_SPAWN | PWR_DISRUPT_TOWER | PWR_DISRUPT_SOURCE | PWR_SHIELD | PWR_REGEN_SOURCE | PWR_REGEN_MINERAL | PWR_DISRUPT_TERMINAL | PWR_OPERATE_POWER | PWR_FORTIFY | PWR_OPERATE_CONTROLLER | PWR_OPERATE_FACTORY

/**
  * Available powers, an object with power ID as a key, and the following properties
  */
type PowerCreepPowers = NumberDictionary[Cooldown]
