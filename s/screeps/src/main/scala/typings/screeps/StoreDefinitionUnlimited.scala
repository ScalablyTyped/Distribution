...
trait StoreDefinitionUnlimited extends StObject {
  ...
  /**
    ...
    */
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: true extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: true extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
