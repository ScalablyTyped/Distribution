...
trait StoreDefinition extends StObject {
  ...
  /**
    ...
    */
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: false extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: false extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  ...
  /**
    ...
    */
  def getFreeCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  def getFreeCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  ...
  /**
    ...
    */
  def getUsedCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
  def getUsedCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.ResourceConstant ? number : null : R extends screeps.ResourceConstant ? number : null */ js.Any = js.native
