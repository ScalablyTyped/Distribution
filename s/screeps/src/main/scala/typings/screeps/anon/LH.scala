...
object LH {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LH] (val x: Self) extends AnyVal {
    
    inline def setGH(value: UpgradeController): Self = StObject.set(x, "GH", value.asInstanceOf[js.Any])
    
    inline def setGH2O(value: `25`): Self = StObject.set(x, "GH2O", value.asInstanceOf[js.Any])
    ...
    inline def setUHO2(value: `21`): Self = StObject.set(x, "UHO2", value.asInstanceOf[js.Any])
    
    inline def setUO(value: Harvest): Self = StObject.set(x, "UO", value.asInstanceOf[js.Any])
    
    inline def setXGH2O(value: `26`): Self = StObject.set(x, "XGH2O", value.asInstanceOf[js.Any])
    
    inline def setXLH2O(value: BuildRepair): Self = StObject.set(x, "XLH2O", value.asInstanceOf[js.Any])
    
    inline def setXUHO2(value: `22`): Self = StObject.set(x, "XUHO2", value.asInstanceOf[js.Any])
    
    inline def setXZH2O(value: `24`): Self = StObject.set(x, "XZH2O", value.asInstanceOf[js.Any])
    
    inline def setZH(value: Dismantle): Self = StObject.set(x, "ZH", value.asInstanceOf[js.Any])
    
    inline def setZH2O(value: `23`): Self = StObject.set(x, "ZH2O", value.asInstanceOf[js.Any])
  }
}
