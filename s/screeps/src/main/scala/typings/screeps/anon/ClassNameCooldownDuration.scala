...
object ClassNameCooldownDuration {
  ...
  @scala.inline
  implicit class ClassNameCooldownDurationOps[Self <: ClassNameCooldownDuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOps(value: typings.screeps.screepsNumbers.`5`): Self = this.set("ops", value.asInstanceOf[js.Any])
