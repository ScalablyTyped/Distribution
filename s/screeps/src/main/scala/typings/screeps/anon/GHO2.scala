...
object GHO2 {
  ...
  inline def apply(GHO2: `12`, GO: Damage, XGHO2: `13`): GHO2 = {
  ...
  extension [Self <: GHO2](x: Self) {
    ...
    inline def setGHO2(value: `12`): Self = StObject.set(x, "GHO2", value.asInstanceOf[js.Any])
    
    inline def setGO(value: Damage): Self = StObject.set(x, "GO", value.asInstanceOf[js.Any])
    
    inline def setXGHO2(value: `13`): Self = StObject.set(x, "XGHO2", value.asInstanceOf[js.Any])
  }
}
