...
object HealRangedHeal {
  ...
  implicit class HealRangedHealOps[Self <: HealRangedHeal] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeal(value: typings.screeps.screepsNumbers.`4`): Self = this.set("heal", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRangedHeal(value: typings.screeps.screepsNumbers.`4`): Self = this.set("rangedHeal", value.asInstanceOf[js.Any])
  }
}
