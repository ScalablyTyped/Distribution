...
@js.native
class StructureFactoryCls protected () extends StructureFactory {
  def this(id: Id[StructureFactory]) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: STRUCTURE_FACTORY = js.native
  /**
