...
trait AnonGHGH2O extends js.Object {
  var GH: GH2O
  var GO: GHO2
  var KH: KH2O
  var KO: KHO2
...
object AnonGHGH2O {
  @scala.inline
  def apply(GH: GH2O, GO: GHO2, KH: KH2O, KO: KHO2, LH: LH2O, LO: LHO2, UH: UH2O, UO: UHO2, ZH: ZH2O, ZO: ZHO2): AnonGHGH2O = {
