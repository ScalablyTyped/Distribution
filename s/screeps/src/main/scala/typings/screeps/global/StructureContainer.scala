...
import typings.screeps.StoreDefinition
import typings.screeps.StructureContainerConstructor
...
@js.native
class StructureContainer protected ()
  extends StObject
     with typings.screeps.StructureContainer {
  def this(id: Id[typings.screeps.StructureContainer]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_CONTAINER = js.native
...
object StructureContainer {
  ...
  @scala.inline
  def apply: StructureContainerConstructor = js.Dynamic.global.selectDynamic("StructureContainer").asInstanceOf[StructureContainerConstructor]
}
