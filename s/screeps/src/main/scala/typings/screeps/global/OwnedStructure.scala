...
import typings.screeps.OwnedStructureConstructor
...
@js.native
class OwnedStructure protected ()
  extends StObject
     with typings.screeps.OwnedStructure[StructureConstant] {
...
object OwnedStructure {
  ...
  @scala.inline
  def apply: OwnedStructureConstructor = js.Dynamic.global.selectDynamic("OwnedStructure").asInstanceOf[OwnedStructureConstructor]
}
