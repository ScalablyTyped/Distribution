...
import typings.screeps.StructureObserverConstructor
...
@js.native
open class StructureObserver protected ()
  extends StObject
     with typings.screeps.StructureObserver {
  def this(id: Id[typings.screeps.StructureObserver]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_OBSERVER = js.native
}
object StructureObserver {
  
  inline def apply: StructureObserverConstructor = js.Dynamic.global.selectDynamic("StructureObserver").asInstanceOf[StructureObserverConstructor]
}
