...
import typings.screeps.StructurePowerBankConstructor
...
class StructurePowerBank protected ()
  extends typings.screeps.StructurePowerBank {
  def this(id: Id[typings.screeps.StructurePowerBank]) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var structureType: typings.screeps.STRUCTURE_POWER_BANK = js.native
  /**
