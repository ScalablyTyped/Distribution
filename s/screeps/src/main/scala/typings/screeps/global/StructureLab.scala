...
import typings.screeps.StructureLabConstructor
...
@js.native
open class StructureLab protected ()
  extends StObject
     with typings.screeps.StructureLab {
  def this(id: Id[typings.screeps.StructureLab]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_LAB = js.native
}
object StructureLab {
  
  inline def apply: StructureLabConstructor = js.Dynamic.global.selectDynamic("StructureLab").asInstanceOf[StructureLabConstructor]
}
