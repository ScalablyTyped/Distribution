...
@js.native
open class StructureTower protected ()
  extends StObject
     with typings.screeps.StructureTower {
  def this(id: Id[typings.screeps.StructureTower]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_TOWER = js.native
}
object StructureTower {
  
  inline def apply: StructureTowerConstructor = js.Dynamic.global.selectDynamic("StructureTower").asInstanceOf[StructureTowerConstructor]
}
