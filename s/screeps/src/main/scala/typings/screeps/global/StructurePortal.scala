...
class StructurePortal protected ()
  extends StObject
     with typings.screeps.StructurePortal {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var destination: typings.screeps.RoomPosition | Shard = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_PORTAL = js.native
}
object StructurePortal {
  
  @scala.inline
  def apply: StructurePortalConstructor = js.Dynamic.global.selectDynamic("StructurePortal").asInstanceOf[StructurePortalConstructor]
}
