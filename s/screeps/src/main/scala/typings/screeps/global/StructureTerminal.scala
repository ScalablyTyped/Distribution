...
import typings.screeps.StructureTerminalConstructor
...
@js.native
open class StructureTerminal protected ()
  extends StObject
     with typings.screeps.StructureTerminal {
  def this(id: Id[typings.screeps.StructureTerminal]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_TERMINAL = js.native
}
