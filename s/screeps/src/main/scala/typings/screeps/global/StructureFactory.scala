...
import typings.screeps.StructureFactoryConstructor
...
class StructureFactory protected ()
  extends StObject
     with typings.screeps.StructureFactory {
  def this(id: Id[typings.screeps.StructureFactory]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typings.screeps.STRUCTURE_FACTORY = js.native
}
object StructureFactory {
  
  @scala.inline
  def apply: StructureFactoryConstructor = js.Dynamic.global.selectDynamic("StructureFactory").asInstanceOf[StructureFactoryConstructor]
}
