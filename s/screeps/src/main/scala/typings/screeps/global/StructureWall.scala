...
@js.native
open class StructureWall protected ()
  extends StObject
...
object StructureWall {
  ...
  inline def apply: StructureWallConstructor = js.Dynamic.global.selectDynamic("StructureWall").asInstanceOf[StructureWallConstructor]
}
