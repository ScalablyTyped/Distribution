...
trait Client extends js.Object {
  ...
  def prepareCommit(callback: js.Function2[/* err */ nodeLib.Error, /* data */ js.Object, scala.Unit]): nodeLib.httpMod.ClientRequest = js.native
  ...
  def rollback(callback: js.Function2[/* err */ nodeLib.Error, /* data */ js.Object, scala.Unit]): nodeLib.httpMod.ClientRequest = js.native
  def search(query: Query): nodeLib.httpMod.ClientRequest = js.native
  def search(query: Query, callback: js.Function2[/* err */ nodeLib.Error, /* data */ js.Object, scala.Unit]): nodeLib.httpMod.ClientRequest = js.native
  def searchAll(): nodeLib.httpMod.ClientRequest = js.native
  def searchAll(callback: js.Function2[/* err */ nodeLib.Error, /* data */ js.Object, scala.Unit]): nodeLib.httpMod.ClientRequest = js.native
  def softCommit(): nodeLib.httpMod.ClientRequest = js.native
  def softCommit(callback: js.Function2[/* err */ nodeLib.Error, /* data */ js.Object, scala.Unit]): nodeLib.httpMod.ClientRequest = js.native
