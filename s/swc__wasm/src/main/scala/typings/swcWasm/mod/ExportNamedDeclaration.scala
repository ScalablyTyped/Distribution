...
trait ExportNamedDeclaration
  ...
  @JSName("type")
  var type_ExportNamedDeclaration: typings.swcWasm.swcWasmStrings.ExportNamedDeclaration
}
object ExportNamedDeclaration {
  ...
  extension [Self <: ExportNamedDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ExportNamedDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
