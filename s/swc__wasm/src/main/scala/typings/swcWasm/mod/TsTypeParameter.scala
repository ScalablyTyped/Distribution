...
trait TsTypeParameter
  ...
  @JSName("type")
  var type_TsTypeParameter: typings.swcWasm.swcWasmStrings.TsTypeParameter
}
object TsTypeParameter {
  ...
  implicit open class MutableBuilder[Self <: TsTypeParameter] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTypeParameter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
