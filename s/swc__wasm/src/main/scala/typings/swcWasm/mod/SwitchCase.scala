...
trait SwitchCase
  ...
  @JSName("type")
  var type_SwitchCase: typings.swcWasm.swcWasmStrings.SwitchCase
}
object SwitchCase {
  ...
  implicit open class MutableBuilder[Self <: SwitchCase] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.SwitchCase): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
