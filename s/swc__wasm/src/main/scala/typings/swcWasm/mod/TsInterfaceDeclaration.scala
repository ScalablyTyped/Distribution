...
trait TsInterfaceDeclaration
  ...
  @JSName("type")
  var type_TsInterfaceDeclaration: typings.swcWasm.swcWasmStrings.TsInterfaceDeclaration
}
object TsInterfaceDeclaration {
  ...
  extension [Self <: TsInterfaceDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsInterfaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
