...
trait ClassProperty
  ...
  @JSName("type")
  var type_ClassProperty: typings.swcWasm.swcWasmStrings.ClassProperty
}
object ClassProperty {
  ...
  implicit open class MutableBuilder[Self <: ClassProperty] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ClassProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
