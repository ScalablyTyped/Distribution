...
trait TsMappedType
  ...
  @JSName("type")
  var type_TsMappedType: typings.swcWasm.swcWasmStrings.TsMappedType
}
object TsMappedType {
  ...
  extension [Self <: TsMappedType](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsMappedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
