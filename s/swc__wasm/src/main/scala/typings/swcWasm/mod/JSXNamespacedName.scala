...
trait JSXNamespacedName
  ...
  @JSName("type")
  var type_JSXNamespacedName: typings.swcWasm.swcWasmStrings.JSXNamespacedName
}
object JSXNamespacedName {
  ...
  implicit open class MutableBuilder[Self <: JSXNamespacedName] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.JSXNamespacedName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
