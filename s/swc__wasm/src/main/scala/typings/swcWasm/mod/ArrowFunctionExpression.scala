...
trait ArrowFunctionExpression
  ...
  @JSName("type")
  var type_ArrowFunctionExpression: typings.swcWasm.swcWasmStrings.ArrowFunctionExpression
}
object ArrowFunctionExpression {
  ...
  extension [Self <: ArrowFunctionExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ArrowFunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
