...
trait ForStatement
  ...
  @JSName("type")
  var type_ForStatement: typings.swcWasm.swcWasmStrings.ForStatement
...
object ForStatement {
  ...
  implicit open class MutableBuilder[Self <: ForStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ForStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
