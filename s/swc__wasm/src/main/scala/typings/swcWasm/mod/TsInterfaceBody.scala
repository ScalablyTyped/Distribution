...
trait TsInterfaceBody
  ...
  @JSName("type")
  var type_TsInterfaceBody: typings.swcWasm.swcWasmStrings.TsInterfaceBody
}
object TsInterfaceBody {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TsInterfaceBody] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsInterfaceBody): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
