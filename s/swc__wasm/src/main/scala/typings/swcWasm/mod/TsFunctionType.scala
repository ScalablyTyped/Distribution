...
trait TsFunctionType
  ...
  @JSName("type")
  var type_TsFunctionType: typings.swcWasm.swcWasmStrings.TsFunctionType
}
object TsFunctionType {
  ...
  extension [Self <: TsFunctionType](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsFunctionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
