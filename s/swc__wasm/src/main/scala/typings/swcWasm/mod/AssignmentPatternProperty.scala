...
trait AssignmentPatternProperty
  ...
  @JSName("type")
  var type_AssignmentPatternProperty: typings.swcWasm.swcWasmStrings.AssignmentPatternProperty
...
object AssignmentPatternProperty {
  ...
  implicit open class MutableBuilder[Self <: AssignmentPatternProperty] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.AssignmentPatternProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
