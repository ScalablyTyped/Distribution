...
trait TsTypeReference
  ...
  @JSName("type")
  var type_TsTypeReference: typings.swcWasm.swcWasmStrings.TsTypeReference
}
object TsTypeReference {
  ...
  extension [Self <: TsTypeReference](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTypeReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
