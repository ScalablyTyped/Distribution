...
trait NewExpression
  ...
  @JSName("type")
  var type_NewExpression: typings.swcWasm.swcWasmStrings.NewExpression
}
object NewExpression {
  ...
  extension [Self <: NewExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.NewExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
