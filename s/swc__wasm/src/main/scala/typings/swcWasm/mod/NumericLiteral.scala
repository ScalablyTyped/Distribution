...
trait NumericLiteral
  ...
  @JSName("type")
  var type_NumericLiteral: typings.swcWasm.swcWasmStrings.NumericLiteral
...
object NumericLiteral {
  ...
  implicit open class MutableBuilder[Self <: NumericLiteral] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.NumericLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
