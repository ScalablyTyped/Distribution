...
trait BinaryExpression
  ...
  @JSName("type")
  var type_BinaryExpression: typings.swcWasm.swcWasmStrings.BinaryExpression
}
object BinaryExpression {
  ...
  implicit open class MutableBuilder[Self <: BinaryExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.BinaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
