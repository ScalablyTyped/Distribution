...
trait JSXSpreadChild
  ...
  @JSName("type")
  var type_JSXSpreadChild: typings.swcWasm.swcWasmStrings.JSXSpreadChild
}
object JSXSpreadChild {
  ...
  implicit open class MutableBuilder[Self <: JSXSpreadChild] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.JSXSpreadChild): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
