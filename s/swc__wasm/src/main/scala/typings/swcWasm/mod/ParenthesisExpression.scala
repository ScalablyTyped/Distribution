...
trait ParenthesisExpression
  ...
  @JSName("type")
  var type_ParenthesisExpression: typings.swcWasm.swcWasmStrings.ParenthesisExpression
}
object ParenthesisExpression {
  ...
  extension [Self <: ParenthesisExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ParenthesisExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
