...
trait ExportDefaultSpecifier
  ...
  @JSName("type")
  var type_ExportDefaultSpecifier: typings.swcWasm.swcWasmStrings.ExportDefaultSpecifier
}
object ExportDefaultSpecifier {
  ...
  extension [Self <: ExportDefaultSpecifier](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ExportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
