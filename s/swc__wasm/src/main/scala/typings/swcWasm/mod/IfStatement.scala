...
trait IfStatement
  ...
  @JSName("type")
  var type_IfStatement: typings.swcWasm.swcWasmStrings.IfStatement
}
object IfStatement {
  ...
  extension [Self <: IfStatement](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.IfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
