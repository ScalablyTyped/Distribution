...
trait OptionalChainingExpression
  ...
  @JSName("type")
  var type_OptionalChainingExpression: typings.swcWasm.swcWasmStrings.OptionalChainingExpression
}
object OptionalChainingExpression {
  ...
  implicit open class MutableBuilder[Self <: OptionalChainingExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.OptionalChainingExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
