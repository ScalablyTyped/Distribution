...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typings.swcWasm.swcWasmStrings.ConditionalExpression
}
object ConditionalExpression {
  ...
  extension [Self <: ConditionalExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
