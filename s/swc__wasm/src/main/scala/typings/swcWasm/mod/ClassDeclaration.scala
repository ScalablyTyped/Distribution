...
trait ClassDeclaration
  ...
  @JSName("type")
  var type_ClassDeclaration: typings.swcWasm.swcWasmStrings.ClassDeclaration
}
object ClassDeclaration {
  ...
  implicit open class MutableBuilder[Self <: ClassDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ClassDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
