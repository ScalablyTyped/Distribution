...
trait Constructor
  ...
  @JSName("type")
  var type_Constructor: typings.swcWasm.swcWasmStrings.Constructor
}
object Constructor {
  ...
  extension [Self <: Constructor](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.Constructor): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
