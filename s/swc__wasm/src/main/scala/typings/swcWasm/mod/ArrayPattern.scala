...
trait ArrayPattern
  ...
  @JSName("type")
  var type_ArrayPattern: typings.swcWasm.swcWasmStrings.ArrayPattern
}
object ArrayPattern {
  ...
  implicit open class MutableBuilder[Self <: ArrayPattern] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ArrayPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
