...
trait UnaryExpression
  ...
  @JSName("type")
  var type_UnaryExpression: typings.swcWasm.swcWasmStrings.UnaryExpression
}
object UnaryExpression {
  ...
  implicit open class MutableBuilder[Self <: UnaryExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.UnaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
