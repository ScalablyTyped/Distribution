...
trait AssignmentExpression
  ...
  @JSName("type")
  var type_AssignmentExpression: typings.swcWasm.swcWasmStrings.AssignmentExpression
}
object AssignmentExpression {
  ...
  extension [Self <: AssignmentExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.AssignmentExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
