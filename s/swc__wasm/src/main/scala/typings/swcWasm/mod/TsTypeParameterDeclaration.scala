...
trait TsTypeParameterDeclaration
  ...
  @JSName("type")
  var type_TsTypeParameterDeclaration: typings.swcWasm.swcWasmStrings.TsTypeParameterDeclaration
}
object TsTypeParameterDeclaration {
  ...
  implicit open class MutableBuilder[Self <: TsTypeParameterDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTypeParameterDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
