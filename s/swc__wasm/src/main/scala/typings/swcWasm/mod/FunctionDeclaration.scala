...
trait FunctionDeclaration
  ...
  var `type`: typings.swcWasm.swcWasmStrings.FunctionDeclaration
}
object FunctionDeclaration {
  ...
  implicit open class MutableBuilder[Self <: FunctionDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.FunctionDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
