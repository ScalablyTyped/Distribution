...
trait BlockStatement
  ...
  @JSName("type")
  var type_BlockStatement: typings.swcWasm.swcWasmStrings.BlockStatement
}
object BlockStatement {
  ...
  extension [Self <: BlockStatement](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.BlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
