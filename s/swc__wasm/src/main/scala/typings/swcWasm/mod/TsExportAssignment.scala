...
trait TsExportAssignment
  ...
  @JSName("type")
  var type_TsExportAssignment: typings.swcWasm.swcWasmStrings.TsExportAssignment
}
object TsExportAssignment {
  ...
  implicit open class MutableBuilder[Self <: TsExportAssignment] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsExportAssignment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
