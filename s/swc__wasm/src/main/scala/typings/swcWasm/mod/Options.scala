...
import typings.swcWasm.swcWasmStrings.`upward-optional`
import typings.swcWasm.swcWasmStrings.root
import typings.swcWasm.swcWasmStrings.unknown
import typings.swcWasm.swcWasmStrings.upward
