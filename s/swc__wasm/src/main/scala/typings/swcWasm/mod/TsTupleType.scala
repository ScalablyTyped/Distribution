...
trait TsTupleType
  ...
  @JSName("type")
  var type_TsTupleType: typings.swcWasm.swcWasmStrings.TsTupleType
}
object TsTupleType {
  ...
  implicit open class MutableBuilder[Self <: TsTupleType] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTupleType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
