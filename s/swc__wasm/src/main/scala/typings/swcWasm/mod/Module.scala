...
trait Module
  ...
  @JSName("type")
  var type_Module: typings.swcWasm.swcWasmStrings.Module
}
object Module {
  ...
  implicit open class MutableBuilder[Self <: Module] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.Module): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
