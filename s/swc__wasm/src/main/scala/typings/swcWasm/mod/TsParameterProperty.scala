...
trait TsParameterProperty
  ...
  @JSName("type")
  var type_TsParameterProperty: typings.swcWasm.swcWasmStrings.TsParameterProperty
}
object TsParameterProperty {
  ...
  extension [Self <: TsParameterProperty](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsParameterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
