...
trait TsTupleElement
  ...
  @JSName("type")
  var type_TsTupleElement: typings.swcWasm.swcWasmStrings.TsTupleElement
}
object TsTupleElement {
  ...
  implicit open class MutableBuilder[Self <: TsTupleElement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTupleElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
