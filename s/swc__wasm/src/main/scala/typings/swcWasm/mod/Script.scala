...
trait Script
  ...
  @JSName("type")
  var type_Script: typings.swcWasm.swcWasmStrings.Script
}
object Script {
  ...
  implicit open class MutableBuilder[Self <: Script] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.Script): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
