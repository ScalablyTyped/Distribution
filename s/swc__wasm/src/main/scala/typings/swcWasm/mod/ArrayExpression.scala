...
trait ArrayExpression
  ...
  @JSName("type")
  var type_ArrayExpression: typings.swcWasm.swcWasmStrings.ArrayExpression
}
object ArrayExpression {
  ...
  extension [Self <: ArrayExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ArrayExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
