...
trait TsTypeQuery
  ...
  @JSName("type")
  var type_TsTypeQuery: typings.swcWasm.swcWasmStrings.TsTypeQuery
}
object TsTypeQuery {
  ...
  extension [Self <: TsTypeQuery](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.TsTypeQuery): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
