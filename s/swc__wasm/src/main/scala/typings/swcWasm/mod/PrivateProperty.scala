...
trait PrivateProperty
  ...
  @JSName("type")
  var type_PrivateProperty: typings.swcWasm.swcWasmStrings.PrivateProperty
}
object PrivateProperty {
  ...
  implicit open class MutableBuilder[Self <: PrivateProperty] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.PrivateProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
