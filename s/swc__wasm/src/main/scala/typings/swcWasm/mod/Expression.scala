...
/* Rewritten from type alias, can be one of: 
  - typings.swcWasm.mod.ThisExpression
  - typings.swcWasm.mod.ArrayExpression
  - typings.swcWasm.mod.ObjectExpression
  - typings.swcWasm.mod.FunctionExpression
  - typings.swcWasm.mod.UnaryExpression
  - typings.swcWasm.mod.UpdateExpression
  - typings.swcWasm.mod.BinaryExpression
  - typings.swcWasm.mod.AssignmentExpression
  - typings.swcWasm.mod.MemberExpression
  - typings.swcWasm.mod.SuperPropExpression
  - typings.swcWasm.mod.ConditionalExpression
  - typings.swcWasm.mod.CallExpression
  - typings.swcWasm.mod.NewExpression
  - typings.swcWasm.mod.SequenceExpression
  - typings.swcWasm.mod.Identifier
  - typings.swcWasm.mod.Literal
  - typings.swcWasm.mod.TemplateLiteral
  - typings.swcWasm.mod.TaggedTemplateExpression
  - typings.swcWasm.mod.ArrowFunctionExpression
  - typings.swcWasm.mod.ClassExpression
  - typings.swcWasm.mod.YieldExpression
  - typings.swcWasm.mod.MetaProperty
  - typings.swcWasm.mod.AwaitExpression
  - typings.swcWasm.mod.ParenthesisExpression
  ...
  - typings.swcWasm.mod.TsTypeAssertion
  - typings.swcWasm.mod.TsConstAssertion
  - typings.swcWasm.mod.TsNonNullExpression
  - typings.swcWasm.mod.TsAsExpression
  - typings.swcWasm.mod.TsInstantiation
  - typings.swcWasm.mod.PrivateName
  - typings.swcWasm.mod.OptionalChainingExpression
