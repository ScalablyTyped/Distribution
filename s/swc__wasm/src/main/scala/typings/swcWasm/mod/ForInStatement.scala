...
trait ForInStatement
  ...
  @JSName("type")
  var type_ForInStatement: typings.swcWasm.swcWasmStrings.ForInStatement
}
object ForInStatement {
  ...
  implicit open class MutableBuilder[Self <: ForInStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.ForInStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
