...
trait YieldExpression
  ...
  @JSName("type")
  var type_YieldExpression: typings.swcWasm.swcWasmStrings.YieldExpression
}
object YieldExpression {
  ...
  extension [Self <: YieldExpression](x: Self) {
    ...
    inline def setType(value: typings.swcWasm.swcWasmStrings.YieldExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
