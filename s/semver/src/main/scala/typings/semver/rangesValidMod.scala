...
object rangesValidMod {
  ...
  @scala.inline
  def apply(range: Null, optionsOrLoose: Boolean): String = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
  def apply(range: Null, optionsOrLoose: Options): String = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
  def apply(range: Unit, optionsOrLoose: Boolean): String = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
  def apply(range: Unit, optionsOrLoose: Options): String = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[String]
  @scala.inline
