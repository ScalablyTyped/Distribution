...
object subsetMod {
  ...
  inline def apply(sub: String, dom: typings.semver.rangeMod.^, options: RangeOptions): Boolean = (^.asInstanceOf[js.Dynamic].apply(sub.asInstanceOf[js.Any], dom.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def apply(sub: typings.semver.rangeMod.^, dom: String, options: RangeOptions): Boolean = (^.asInstanceOf[js.Dynamic].apply(sub.asInstanceOf[js.Any], dom.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def apply(sub: typings.semver.rangeMod.^, dom: typings.semver.rangeMod.^, options: RangeOptions): Boolean = (^.asInstanceOf[js.Dynamic].apply(sub.asInstanceOf[js.Any], dom.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
