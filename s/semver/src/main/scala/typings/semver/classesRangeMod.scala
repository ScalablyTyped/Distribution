...
object classesRangeMod {
  ...
  trait Range extends StObject {
    ...
    def parseRange(range: String): js.Array[typings.semver.classesComparatorMod.^] = js.native
    
    var range: String = js.native
    
    var raw: String = js.native
    
    var set: js.Array[js.Array[typings.semver.classesComparatorMod.^]] = js.native
