...
object valid extends js.Object {
  ...
  def apply(version: SemVer): String | Null = js.native
  def apply(version: SemVer, optionsOrLoose: Boolean): String | Null = js.native
  def apply(version: SemVer, optionsOrLoose: Options): String | Null = js.native
}
