...
object validRange extends js.Object {
  ...
  def apply(range: Range): String = js.native
  def apply(range: Range, optionsOrLoose: Boolean): String = js.native
  def apply(range: Range, optionsOrLoose: Options): String = js.native
}
