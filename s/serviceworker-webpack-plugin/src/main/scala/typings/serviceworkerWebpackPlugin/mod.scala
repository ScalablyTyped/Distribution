...
object mod {
  ...
  object ServiceWorkerWebpackPluginOptions {
    ...
    @scala.inline
    implicit class ServiceWorkerWebpackPluginOptionsMutableBuilder[Self <: ServiceWorkerWebpackPluginOptions[_], T] (val x: Self with ServiceWorkerWebpackPluginOptions[T]) extends AnyVal {
