...
import typings.senchaUnderscoreTouch.Ext.device.capture.IAbstract
...
object ICapture {
  ...
  def apply(
    ...
    captureAudio: /* config */ js.UndefOr[js.Any] => Unit = null,
    captureVideo: /* config */ js.UndefOr[js.Any] => Unit = null,
    config: js.Any = null,
    destroy: () => Unit = null,
    extend: String = null,
