package typings.senchaUnderscoreTouch.Ext.draw.engine
...
import typings.senchaUnderscoreTouch.Ext.draw.IGroup
...
object ICanvas {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ICanvas = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ICanvas = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ICanvas], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    if (initElement != null) __obj.updateDynamic("initElement")(js.Any.fromFunction0(initElement))
