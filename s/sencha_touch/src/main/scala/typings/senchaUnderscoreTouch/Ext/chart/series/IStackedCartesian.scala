package typings.senchaUnderscoreTouch.Ext.chart.series
...
object IStackedCartesian {
  ...
  def apply(
    ...
    setHidden: /* hidden */ js.UndefOr[Array] => Unit = null,
    ...
    setStacked: /* stacked */ js.UndefOr[Boolean] => Unit = null,
    ...
    if (getStacked != null) __obj.updateDynamic("getStacked")(js.Any.fromFunction0(getStacked))
    ...
    if (setStacked != null) __obj.updateDynamic("setStacked")(js.Any.fromFunction1(setStacked))
