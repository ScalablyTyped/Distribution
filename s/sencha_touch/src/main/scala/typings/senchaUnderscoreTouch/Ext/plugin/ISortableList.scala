package typings.senchaUnderscoreTouch.Ext.plugin
...
trait ISortableList extends IComponent {
  /** [Method] Returns the value of handleSelector
  		* @returns String
  		*/
  var getHandleSelector: js.UndefOr[js.Function0[String]] = js.undefined
  ...
  /** [Method] Sets the value of handleSelector
  		...
  		*/
  var setHandleSelector: js.UndefOr[js.Function1[/* handleSelector */ js.UndefOr[String], Unit]] = js.undefined
...
object ISortableList {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ISortableList = null,
    ...
    setHandleSelector: /* handleSelector */ js.UndefOr[String] => Unit = null,
    ...
    setList: /* list */ js.UndefOr[js.Any] => Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ISortableList = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISortableList], /* alignment */ js.UndefOr[String]) => Unit = null,
    ...
    if (getHandleSelector != null) __obj.updateDynamic("getHandleSelector")(js.Any.fromFunction0(getHandleSelector))
    ...
    if (setHandleSelector != null) __obj.updateDynamic("setHandleSelector")(js.Any.fromFunction1(setHandleSelector))
