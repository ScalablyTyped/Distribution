package typings.senchaUnderscoreTouch.Ext.dataview.element
...
trait IList
  extends typings.senchaUnderscoreTouch.Ext.dataview.element.IContainer
...
object IList {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typings.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.Ext.dataview.element.IList = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typings.senchaUnderscoreTouch.Ext.dataview.element.IList], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
