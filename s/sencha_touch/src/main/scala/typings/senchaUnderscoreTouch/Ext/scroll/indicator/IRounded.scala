...
trait IRounded extends IAbstract {
  /** [Method] Returns the value of cls
  		...
  		*/
  @JSName("getCls")
  var getCls_IRounded: js.UndefOr[js.Function0[String]] = js.undefined
  /** [Method] Sets the value of cls
  		* @param cls String The new value.
  		*/
  @JSName("setCls")
  var setCls_IRounded: js.UndefOr[js.Function1[/* cls */ js.UndefOr[String], Unit]] = js.undefined
}
...
object IRounded {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IRounded = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IRounded = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IRounded], /* alignment */ js.UndefOr[String]) => Unit = null,
