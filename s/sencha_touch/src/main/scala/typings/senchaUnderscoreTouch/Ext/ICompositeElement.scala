...
trait ICompositeElement
  extends typings.senchaUnderscoreTouch.Ext.dom.ICompositeElementLite {
  ...
  var addListener_ICompositeElement: js.UndefOr[
    js.Function4[
      ...
      typings.senchaUnderscoreTouch.Ext.dom.ICompositeElementLite
    ]
  ] = js.undefined
...
object ICompositeElement {
  @scala.inline
  def apply(
    ICompositeElementLite: typings.senchaUnderscoreTouch.Ext.dom.ICompositeElementLite = null,
