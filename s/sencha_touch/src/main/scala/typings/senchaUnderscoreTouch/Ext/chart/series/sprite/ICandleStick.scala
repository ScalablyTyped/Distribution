...
object ICandleStick {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.ICandleStick = null,
    ...
    show: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.ICandleStick = null,
