...
object ILoadMask {
  ...
  def apply(
    ...
    getMessageCls: () => java.lang.String = null,
    getMinHeight: () => _ = null,
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => ILoadMask = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ILoadMask = null,
    ...
    setMessageCls: /* messageCls */ js.UndefOr[java.lang.String] => Unit = null,
    ...
    setTransparent: /* transparent */ js.UndefOr[Boolean] => Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ILoadMask = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ILoadMask], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    if (getMessageCls != null) __obj.updateDynamic("getMessageCls")(js.Any.fromFunction0(getMessageCls))
    ...
    if (getTransparent != null) __obj.updateDynamic("getTransparent")(js.Any.fromFunction0(getTransparent))
    ...
    if (messageCls != null) __obj.updateDynamic("messageCls")(messageCls.asInstanceOf[js.Any])
    ...
    if (setMessageCls != null) __obj.updateDynamic("setMessageCls")(js.Any.fromFunction1(setMessageCls))
    ...
    if (setTransparent != null) __obj.updateDynamic("setTransparent")(js.Any.fromFunction1(setTransparent))
