...
trait IDefault extends IAbstract {
  ...
  var animation: js.UndefOr[typings.senchaUnderscoreTouch.Ext.fx.layout.ICard] = js.undefined
  /** [Method] Returns the value of animation
  		* @returns Ext.fx.layout.Card
  		*/
  var getAnimation: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.Ext.fx.layout.ICard]] = js.undefined
  /** [Method]
  ...
  var setAnimation: js.UndefOr[
    js.Function1[
      /* animation */ js.UndefOr[typings.senchaUnderscoreTouch.Ext.fx.layout.ICard], 
      Unit
    ]
  ] = js.undefined
}
