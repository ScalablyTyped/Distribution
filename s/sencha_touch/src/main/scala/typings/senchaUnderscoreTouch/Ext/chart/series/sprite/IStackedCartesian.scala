...
trait IStackedCartesian
  extends typings.senchaUnderscoreTouch.Ext.chart.series.sprite.ICartesian {
...
object IStackedCartesian {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian = null,
    ...
    show: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian = null,
