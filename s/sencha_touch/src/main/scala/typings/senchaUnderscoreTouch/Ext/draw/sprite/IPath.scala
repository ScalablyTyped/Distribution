...
object IPath {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.Ext.draw.sprite.IPath = null,
    ...
    show: () => typings.senchaUnderscoreTouch.Ext.draw.sprite.IPath = null,
    ...
    updatePath: (/* path */ js.UndefOr[typings.senchaUnderscoreTouch.Ext.draw.sprite.IPath], /* attr */ js.UndefOr[js.Any]) => Unit = null,
