...
import typings.senchaUnderscoreTouch.Ext.draw.sprite.IText
...
object ILabel {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.Ext.chart.label.ILabel = null,
    ...
    setFx: /* fx */ js.UndefOr[js.Any] => Unit = null,
    ...
    show: () => typings.senchaUnderscoreTouch.Ext.chart.label.ILabel = null,
    ...
    if (getFx != null) __obj.updateDynamic("getFx")(js.Any.fromFunction0(getFx))
    ...
    if (setFx != null) __obj.updateDynamic("setFx")(js.Any.fromFunction1(setFx))
