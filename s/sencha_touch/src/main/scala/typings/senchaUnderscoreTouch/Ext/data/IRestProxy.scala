...
trait IRestProxy
  extends typings.senchaUnderscoreTouch.Ext.data.proxy.IAjax {
  ...
  /** [Method] Sets the value of format
  		...
  		*/
  var setFormat: js.UndefOr[js.Function1[/* format */ js.UndefOr[java.lang.String], Unit]] = js.undefined
}
...
object IRestProxy {
  ...
  def apply(
    ...
    api: js.Any = null,
    appendId: js.UndefOr[Boolean] = js.undefined,
    ...
    self: IClass = null,
    setActionMethods: /* actionMethods */ js.UndefOr[js.Any] => Unit = null,
    setApi: /* api */ js.UndefOr[js.Any] => Unit = null,
    setAppendId: /* appendId */ js.UndefOr[Boolean] => Unit = null,
    ...
    setFormat: /* format */ js.UndefOr[java.lang.String] => Unit = null,
    ...
    if (!js.isUndefined(appendId)) __obj.updateDynamic("appendId")(appendId.asInstanceOf[js.Any])
