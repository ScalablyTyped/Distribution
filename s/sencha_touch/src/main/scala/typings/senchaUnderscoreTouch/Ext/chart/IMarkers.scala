...
object IMarkers {
  ...
  def apply(
    ...
    clear: /* category */ js.UndefOr[String] => Unit = null,
    ...
    getListeners: () => _ = null,
    getMarkerBBoxFor: (/* category */ js.UndefOr[String], /* index */ js.UndefOr[js.Any], /* isWithoutTransform */ js.UndefOr[Boolean]) => Unit = null,
    getParent: () => _ = null,
    getTemplate: () => _ = null,
    ...
    preRender: () => Unit = null,
    putMarkerFor: (/* category */ js.UndefOr[String], /* markerAttr */ js.UndefOr[js.Any], /* index */ js.UndefOr[js.Any], /* canonical */ js.UndefOr[Boolean], /* keepRevision */ js.UndefOr[Boolean]) => Unit = null,
