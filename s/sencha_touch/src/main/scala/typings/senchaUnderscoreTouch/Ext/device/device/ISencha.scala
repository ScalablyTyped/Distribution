package typings.senchaUnderscoreTouch.Ext.device.device
...
object ISencha {
  ...
  def apply(
    ...
    openURL: /* url */ js.UndefOr[js.Any] => Unit = null,
    ...
    if (openURL != null) __obj.updateDynamic("openURL")(js.Any.fromFunction1(openURL))
