package typings.senchaUnderscoreTouch.Ext.data.association
...
trait IAssociation extends IBase {
  ...
  /** [Method] Returns the value of reader
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.Ext.data.reader.IReader]] = js.undefined
  ...
  var setReader: js.UndefOr[
    js.Function1[
      /* reader */ js.UndefOr[typings.senchaUnderscoreTouch.Ext.data.reader.IReader], 
      Unit
    ]
  ] = js.undefined
