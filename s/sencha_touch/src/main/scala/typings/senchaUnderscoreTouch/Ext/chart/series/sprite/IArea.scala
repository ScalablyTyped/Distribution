...
trait IArea
  extends typings.senchaUnderscoreTouch.Ext.chart.series.sprite.IStackedCartesian {
...
object IArea {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.IArea = null,
    ...
    show: () => typings.senchaUnderscoreTouch.Ext.chart.series.sprite.IArea = null,
