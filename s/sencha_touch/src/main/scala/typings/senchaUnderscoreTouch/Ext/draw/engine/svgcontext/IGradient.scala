package typings.senchaUnderscoreTouch.Ext.draw.engine.svgcontext
...
object IGradient {
  ...
  def apply(
    ...
    if (addColorStop != null) __obj.updateDynamic("addColorStop")(js.Any.fromFunction2(addColorStop))
