package typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs
...
object IContainer {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IContainer = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IContainer = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IContainer = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IContainer], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
