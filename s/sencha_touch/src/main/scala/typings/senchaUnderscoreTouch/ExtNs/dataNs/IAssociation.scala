...
trait IAssociation extends IBase {
  ...
  /** [Method] Returns the value of reader
  		...
  		*/
  var getReader: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.dataNs.readerNs.IReader]] = js.undefined
  ...
  var reader: js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataNs.readerNs.IReader] = js.undefined
  ...
  var setReader: js.UndefOr[
    js.Function1[
      /* reader */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataNs.readerNs.IReader], 
      Unit
    ]
  ] = js.undefined
