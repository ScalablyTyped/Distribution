...
object IPath {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.drawNs.spriteNs.IPath = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.drawNs.spriteNs.IPath = null,
    ...
    updatePath: (/* path */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.drawNs.spriteNs.IPath], /* attr */ js.UndefOr[js.Any]) => Unit = null,
