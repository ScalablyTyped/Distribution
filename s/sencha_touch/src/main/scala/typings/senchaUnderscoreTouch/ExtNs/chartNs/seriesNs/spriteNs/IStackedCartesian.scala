...
object IStackedCartesian {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IStackedCartesian = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IStackedCartesian = null,
