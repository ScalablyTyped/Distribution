package typings.senchaUnderscoreTouch.ExtNs.chartNs.interactionsNs
...
object IItemHighlight {
  ...
  def apply(
    ...
    onGesture: (/* series */ js.UndefOr[js.Any], /* item */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any]) => Unit = null,
    ...
    if (onGesture != null) __obj.updateDynamic("onGesture")(js.Any.fromFunction3(onGesture))
