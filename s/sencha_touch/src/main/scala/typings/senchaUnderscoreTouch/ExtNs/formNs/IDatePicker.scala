...
trait IDatePicker
  extends typings.senchaUnderscoreTouch.ExtNs.fieldNs.ISelect {
  ...
  /** [Method] Resets the Select field to the value of the first record in the store
  		...
  		*/
  @JSName("reset")
  var reset_IDatePicker: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.fieldNs.ISelect]] = js.undefined
...
object IDatePicker {
  @scala.inline
  def apply(
    ISelect: typings.senchaUnderscoreTouch.ExtNs.fieldNs.ISelect = null,
    ...
    onChange: () => Unit = null,
    picker: js.Any = null,
    reset: () => typings.senchaUnderscoreTouch.ExtNs.fieldNs.ISelect = null,
