package typings.senchaUnderscoreTouch.ExtNs.libNs
...
trait IComponent extends IEvented {
  ...
  var up: js.UndefOr[
    js.Function1[
      ...
      typings.senchaUnderscoreTouch.ExtNs.IContainer
    ]
  ] = js.undefined
...
object IComponent {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typings.senchaUnderscoreTouch.ExtNs.libNs.IComponent = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.libNs.IComponent = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.libNs.IComponent = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.libNs.IComponent], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    up: /* selector */ js.UndefOr[java.lang.String] => typings.senchaUnderscoreTouch.ExtNs.IContainer = null,
    update: () => Unit = null,
