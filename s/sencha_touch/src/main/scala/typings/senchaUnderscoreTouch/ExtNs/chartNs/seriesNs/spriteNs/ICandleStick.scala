...
trait ICandleStick extends IAggregative {
  ...
  var ohlcType: js.UndefOr[java.lang.String] = js.undefined
  /** [Config Option] (Number) */
...
object ICandleStick {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.ICandleStick = null,
    ...
    ohlcType: java.lang.String = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.ICandleStick = null,
    ...
    if (ohlcType != null) __obj.updateDynamic("ohlcType")(ohlcType)
