package typings.senchaUnderscoreTouch.ExtNs.drawNs.engineNs
...
import typings.senchaUnderscoreTouch.ExtNs.drawNs.IGroup
...
object ISvg {
  ...
  def apply(
    ...
    showBy: (/* component */ js.UndefOr[ISvg], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
