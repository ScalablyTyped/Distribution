...
import typings.senchaUnderscoreTouch.ExtNs.drawNs.spriteNs.IInstancing
...
trait IMarkers extends IInstancing {
  /** [Method] Clear the markers in the category
  		...
  		*/
  var clear: js.UndefOr[js.Function1[/* category */ js.UndefOr[java.lang.String], Unit]] = js.undefined
  /** [Method]
  		* @param category String
  		* @param index Mixed
...
object IMarkers {
  ...
  def apply(
    ...
    clear: /* category */ js.UndefOr[java.lang.String] => Unit = null,
    clearListeners: () => Unit = null,
    config: js.Any = null,
    createInstance: (/* config */ js.UndefOr[js.Any], /* data */ js.UndefOr[js.Any], /* bypassNormalization */ js.UndefOr[Boolean], /* avoidCopy */ js.UndefOr[Boolean]) => _ = null,
    destroy: () => Unit = null,
    ...
    getBBoxFor: (/* index */ js.UndefOr[Double], /* isWithoutTransform */ js.UndefOr[Boolean]) => _ = null,
    getBubbleEvents: () => _ = null,
    getId: () => _ = null,
    getInitialConfig: /* name */ js.UndefOr[java.lang.String] => _ = null,
    getListeners: () => _ = null,
    getMarkerBBoxFor: (/* category */ js.UndefOr[java.lang.String], /* index */ js.UndefOr[js.Any], /* isWithoutTransform */ js.UndefOr[Boolean]) => Unit = null,
    getParent: () => _ = null,
    getTemplate: () => _ = null,
    ...
    preRender: () => Unit = null,
    putMarkerFor: (/* category */ js.UndefOr[java.lang.String], /* markerAttr */ js.UndefOr[js.Any], /* index */ js.UndefOr[js.Any], /* canonical */ js.UndefOr[Boolean], /* keepRevision */ js.UndefOr[Boolean]) => Unit = null,
    ...
    setAttributesFor: (/* index */ js.UndefOr[Double], /* changes */ js.UndefOr[js.Any], /* bypassNormalization */ js.UndefOr[Boolean]) => Unit = null,
