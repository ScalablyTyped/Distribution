package typings.senchaUnderscoreTouch.ExtNs.carouselNs
...
import typings.senchaUnderscoreTouch.ExtNs.IDecorator
...
object IItem {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IItem = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IItem = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IItem], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
