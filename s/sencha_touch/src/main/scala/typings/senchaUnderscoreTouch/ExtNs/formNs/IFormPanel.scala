...
trait IFormPanel
  extends typings.senchaUnderscoreTouch.ExtNs.IPanel {
  ...
  var doSetDisabled: js.UndefOr[
    js.Function1[
      ...
      typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel
    ]
  ] = js.undefined
  ...
  /** [Method] Hides a previously shown wait mask See showMask
  		...
  		*/
  var hideMask: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel]] = js.undefined
  ...
  var loadModel: js.UndefOr[
    js.Function1[/* record */ js.UndefOr[IModel], typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel]
  ] = js.undefined
  /** [Method] Loads matching fields from a model instance into this form
  		* @param record Ext.data.Model The model instance.
  		* @returns Ext.form.Panel This form.
  ...
  /** [Method] Resets all fields in the form back to their original values
  		* @returns Ext.form.Panel This form.
  		*/
  var reset: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel]] = js.undefined
  ...
  var setValues: js.UndefOr[
    js.Function1[/* values */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel]
  ] = js.undefined
  ...
  var waitMsgTarget: js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.domNs.IElement] = js.undefined
...
object IFormPanel {
  @scala.inline
  def apply(
    IPanel: typings.senchaUnderscoreTouch.ExtNs.IPanel = null,
    api: js.Any = null,
    baseCls: java.lang.String = null,
    baseParams: js.Any = null,
    doSetDisabled: /* newDisabled */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    ...
    hideMask: () => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    load: /* options */ js.UndefOr[js.Any] => IConnection = null,
    loadModel: /* record */ js.UndefOr[IModel] => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    loadRecord: /* record */ js.UndefOr[IModel] => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    ...
    record: IModel = null,
    reset: () => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    ...
    setRecord: /* record */ js.UndefOr[IModel] => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    ...
    setValues: /* values */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    showMask: (/* cfg */ js.UndefOr[js.Any], /* target */ js.UndefOr[js.Any]) => typings.senchaUnderscoreTouch.ExtNs.formNs.IPanel = null,
    ...
    waitMsgTarget: typings.senchaUnderscoreTouch.ExtNs.domNs.IElement = null,
    waitTpl: js.Any = null
  ): IFormPanel = {
