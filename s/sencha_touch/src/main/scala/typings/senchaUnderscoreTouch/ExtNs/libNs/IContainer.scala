...
trait IContainer
  extends typings.senchaUnderscoreTouch.ExtNs.IComponent {
  ...
  /** [Method] Adds one or more Components to this Container
  		...
  		*/
  var add: js.UndefOr[
    js.Function1[/* newItems */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.IComponent]
  ] = js.undefined
  ...
  var child: js.UndefOr[
    js.Function1[
      ...
      typings.senchaUnderscoreTouch.ExtNs.IComponent
    ]
  ] = js.undefined
  ...
  var getAt: js.UndefOr[
    js.Function1[/* index */ js.UndefOr[Double], typings.senchaUnderscoreTouch.ExtNs.IComponent]
  ] = js.undefined
  ...
  var getComponent: js.UndefOr[
    js.Function1[/* component */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.IComponent]
  ] = js.undefined
  ...
  /** [Method] Hides this Component optionally using an animation
  		...
  		*/
  @JSName("hide")
  var hide_IContainer: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.IComponent]] = js.undefined
  ...
  /** [Method] Shows this component optionally using an animation
  		...
  		*/
  @JSName("show")
  var show_IContainer: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.IComponent]] = js.undefined
...
object IContainer {
  @scala.inline
  def apply(
    IComponent: typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    activeItem: js.Any = null,
    add: /* newItems */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    ...
    child: /* selector */ js.UndefOr[java.lang.String] => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    control: js.Any = null,
    defaultType: java.lang.String = null,
    defaults: js.Any = null,
    destroy: () => Unit = null,
    down: /* selector */ js.UndefOr[java.lang.String] => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    getActiveItem: () => _ = null,
    getAt: /* index */ js.UndefOr[Double] => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    getAutoDestroy: () => Boolean = null,
    getComponent: /* component */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    getControl: () => _ = null,
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    ...
    remove: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    removeAll: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    removeAt: /* index */ js.UndefOr[Double] => typings.senchaUnderscoreTouch.ExtNs.libNs.IContainer = null,
    removeDocked: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    removeInnerAt: /* index */ js.UndefOr[Double] => typings.senchaUnderscoreTouch.ExtNs.libNs.IContainer = null,
    scroll: js.Any = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.IComponent = null,
    unmask: () => Unit = null
  ): IContainer = {
