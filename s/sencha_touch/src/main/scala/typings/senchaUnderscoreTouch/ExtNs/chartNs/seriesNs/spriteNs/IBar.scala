...
trait IBar
  extends typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IStackedCartesian {
...
object IBar {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IBar = null,
    inGroupGapWidth: Int | Double = null,
    ...
    maxBarWidth: Int | Double = null,
    minBarWidth: Int | Double = null,
    minGapWidth: Int | Double = null,
    ...
    renderClipped: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[js.Any]) => Unit = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IBar = null,
