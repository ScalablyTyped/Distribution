...
trait IPullRefresh extends IComponent {
  ...
  /** [Method] Returns the value of list
  		...
  		*/
  var getList: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList]] = js.undefined
  ...
  var list: js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList] = js.undefined
  /** [Config Option] (String) */
  ...
  var setList: js.UndefOr[
    js.Function1[/* list */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList], Unit]
  ] = js.undefined
...
object IPullRefresh {
  ...
  def apply(
    ...
    getLeft: () => _ = null,
    getList: () => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList = null,
    getListeners: () => _ = null,
    ...
    left: js.Any = null,
    list: typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList = null,
    ...
    setList: /* list */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IList] => Unit = null,
