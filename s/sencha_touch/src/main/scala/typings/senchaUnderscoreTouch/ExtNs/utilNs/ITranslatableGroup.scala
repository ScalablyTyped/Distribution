...
import typings.senchaUnderscoreTouch.ExtNs.utilNs.translatableNs.IAbstract
...
object ITranslatableGroup {
  ...
  def apply(
    ...
    self: IClass = null,
    setActiveIndex: /* activeIndex */ js.UndefOr[Double] => Unit = null,
    ...
    if (setActiveIndex != null) __obj.updateDynamic("setActiveIndex")(js.Any.fromFunction1(setActiveIndex))
