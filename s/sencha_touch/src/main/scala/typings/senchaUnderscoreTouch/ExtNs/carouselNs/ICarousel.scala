...
object ICarousel {
  ...
  def apply(
    ...
    next: () => typings.senchaUnderscoreTouch.ExtNs.carouselNs.ICarousel = null,
    prev: () => typings.senchaUnderscoreTouch.ExtNs.carouselNs.ICarousel = null,
    previous: () => typings.senchaUnderscoreTouch.ExtNs.carouselNs.ICarousel = null,
