...
trait INestedList extends IContainer {
  ...
  var onItemTap: js.UndefOr[
    js.Function5[
      /* list */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.IList], 
...
object INestedList {
  ...
  def apply(
    ...
    onItemTap: (/* list */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.IList], /* index */ js.UndefOr[Double], /* target */ js.UndefOr[IElement], /* record */ js.UndefOr[IRecord], /* e */ js.UndefOr[IEvent]) => Unit = null,
