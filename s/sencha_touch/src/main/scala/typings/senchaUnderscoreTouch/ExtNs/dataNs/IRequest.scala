...
trait IRequest extends IBase {
  ...
  /** [Method] Returns the value of proxy
  		...
  		*/
  var getProxy: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy]] = js.undefined
  ...
  var proxy: js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy] = js.undefined
  ...
  var setProxy: js.UndefOr[
    js.Function1[
      /* proxy */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy], 
      Unit
    ]
  ] = js.undefined
...
object IRequest {
  ...
  def apply(
    ...
    getProxy: () => typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy = null,
    getRecords: () => _ = null,
    getScope: () => _ = null,
    ...
    proxy: typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy = null,
    self: IClass = null,
    ...
    setProxy: /* proxy */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataNs.proxyNs.IProxy] => Unit = null,
