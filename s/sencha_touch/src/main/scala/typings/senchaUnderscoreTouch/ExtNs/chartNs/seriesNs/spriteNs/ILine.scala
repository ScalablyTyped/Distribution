package typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs

import typings.senchaUnderscoreTouch.ExtNs.Array
import typings.senchaUnderscoreTouch.ExtNs.IClass
import typings.senchaUnderscoreTouch.ExtNs.chartNs.IMarkers
...
object ILine {
  ...
  def apply(
    ...
    fillArea: js.UndefOr[Boolean] = js.undefined,
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.ILine = null,
    ...
    preRender: () => Unit = null,
    preciseStroke: js.UndefOr[Boolean] = js.undefined,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.ILine = null,
    ...
    if (dataClose != null) __obj.updateDynamic("dataClose")(dataClose)
    if (dataHigh != null) __obj.updateDynamic("dataHigh")(dataHigh)
    if (dataLow != null) __obj.updateDynamic("dataLow")(dataLow)
    ...
    if (dataOpen != null) __obj.updateDynamic("dataOpen")(dataOpen)
    ...
    if (!js.isUndefined(fillArea)) __obj.updateDynamic("fillArea")(fillArea)
    ...
    if (!js.isUndefined(preciseStroke)) __obj.updateDynamic("preciseStroke")(preciseStroke)
