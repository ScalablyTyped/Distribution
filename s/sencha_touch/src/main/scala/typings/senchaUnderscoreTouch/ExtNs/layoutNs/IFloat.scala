...
object IFloat {
  ...
  def apply(
    ...
    animation: typings.senchaUnderscoreTouch.ExtNs.fxNs.layoutNs.ICard = null,
    ...
    getAnimation: () => typings.senchaUnderscoreTouch.ExtNs.fxNs.layoutNs.ICard = null,
    ...
    self: IClass = null,
    setAnimation: /* animation */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.fxNs.layoutNs.ICard] => Unit = null,
