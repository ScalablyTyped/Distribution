...
trait IList
  extends typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IContainer
...
object IList {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IList = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IList = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IList = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.elementNs.IList], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
