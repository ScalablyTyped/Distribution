...
object IDecorator {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IDecorator = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IDecorator = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IDecorator], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
