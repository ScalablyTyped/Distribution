...
object ITabMenuButton {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ITabMenuButton = null,
    ...
    setMenuItems: /* menuItems */ js.UndefOr[Array] => Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ITabMenuButton = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ITabMenuButton], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
