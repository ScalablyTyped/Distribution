...
trait IText
  extends typings.senchaUnderscoreTouch.ExtNs.fieldNs.IField {
  ...
  /** [Method] Resets the current field value back to the original value on this field when it was created
  		...
  		*/
  @JSName("reset")
  var reset_IText: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.fieldNs.IField]] = js.undefined
...
object IText {
  @scala.inline
  def apply(
    IField: typings.senchaUnderscoreTouch.ExtNs.fieldNs.IField = null,
