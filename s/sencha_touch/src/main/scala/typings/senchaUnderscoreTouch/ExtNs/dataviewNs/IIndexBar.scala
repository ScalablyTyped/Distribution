package typings.senchaUnderscoreTouch.ExtNs.dataviewNs
...
import typings.senchaUnderscoreTouch.ExtNs.IElement
...
object IIndexBar {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IIndexBar = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IIndexBar = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IIndexBar = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.dataviewNs.IIndexBar], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
    ...
    if (getLetters != null) __obj.updateDynamic("getLetters")(js.Any.fromFunction0(getLetters))
    if (getListPrefix != null) __obj.updateDynamic("getListPrefix")(js.Any.fromFunction0(getListPrefix))
    ...
    if (setLetters != null) __obj.updateDynamic("setLetters")(js.Any.fromFunction1(setLetters))
    if (setListPrefix != null) __obj.updateDynamic("setListPrefix")(js.Any.fromFunction1(setListPrefix))
