package typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.spriteNs
...
- typings.senchaUnderscoreTouch.ExtNs.chartNs.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IAxis extends ISprite {
  ...
  var axis: js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.IAxis] = js.undefined
...
object IAxis {
  ...
  def apply(
    ...
    attr: js.Any = null,
    axis: typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.IAxis = null,
    ...
    getAxis: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.spriteNs.IAxis = null,
    getBBox: () => Unit = null,
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.spriteNs.IAxis = null,
    ...
    setAxis: /* axis */ js.UndefOr[typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.spriteNs.IAxis] => Unit = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.axisNs.spriteNs.IAxis = null,
