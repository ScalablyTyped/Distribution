...
trait ICompositeElementLite
  extends typings.senchaUnderscoreTouch.ExtNs.domNs.IElement {
  ...
  var addCls_ICompositeElementLite: js.UndefOr[
    js.Function3[
      ...
      typings.senchaUnderscoreTouch.ExtNs.domNs.IElement
    ]
  ] = js.undefined
  ...
  var appendTo_ICompositeElementLite: js.UndefOr[
    js.Function1[/* el */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  /** [Method] Returns a flyweight Element of the dom element object at the specified index
  		...
  		*/
  var item: js.UndefOr[
    js.Function1[/* index */ js.UndefOr[Double], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  /** [Method] Forces the browser to repaint this element
  		...
  		*/
  @JSName("repaint")
  var repaint_ICompositeElementLite: js.UndefOr[js.Function0[typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]] = js.undefined
  ...
  var setBox_ICompositeElementLite: js.UndefOr[
    js.Function1[/* box */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var setMaxWidth_ICompositeElementLite: js.UndefOr[
    js.Function1[/* width */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var setVisibilityMode_ICompositeElementLite: js.UndefOr[
    js.Function1[/* mode */ js.UndefOr[js.Any], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var setXY_ICompositeElementLite: js.UndefOr[
    js.Function1[/* pos */ js.UndefOr[Array], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var setX_ICompositeElementLite: js.UndefOr[
    js.Function1[/* x */ js.UndefOr[Double], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
  ...
  var setY_ICompositeElementLite: js.UndefOr[
    js.Function1[/* y */ js.UndefOr[Double], typings.senchaUnderscoreTouch.ExtNs.domNs.IElement]
  ] = js.undefined
...
object ICompositeElementLite {
  @scala.inline
  def apply(
    IElement: typings.senchaUnderscoreTouch.ExtNs.domNs.IElement = null,
    ...
    item: /* index */ js.UndefOr[Double] => typings.senchaUnderscoreTouch.ExtNs.domNs.IElement = null,
    mask: () => Unit = null,
