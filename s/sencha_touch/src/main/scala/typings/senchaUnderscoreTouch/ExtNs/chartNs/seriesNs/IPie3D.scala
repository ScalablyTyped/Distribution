...
object IPie3D {
  ...
  def apply(
    ...
    if (getDistortion != null) __obj.updateDynamic("getDistortion")(js.Any.fromFunction0(getDistortion))
    ...
    if (getThickness != null) __obj.updateDynamic("getThickness")(js.Any.fromFunction0(getThickness))
    ...
    if (setDistortion != null) __obj.updateDynamic("setDistortion")(js.Any.fromFunction1(setDistortion))
    ...
    if (setThickness != null) __obj.updateDynamic("setThickness")(js.Any.fromFunction1(setThickness))
