...
object IAbstract {
  ...
  def apply(
    ...
    capture: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* destination */ js.UndefOr[java.lang.String], /* encoding */ js.UndefOr[java.lang.String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => Unit = null,
    config: js.Any = null,
    destroy: () => Unit = null,
