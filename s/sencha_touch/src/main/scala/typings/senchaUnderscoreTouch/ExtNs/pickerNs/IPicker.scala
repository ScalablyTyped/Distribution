package typings.senchaUnderscoreTouch.ExtNs.pickerNs

import typings.senchaUnderscoreTouch.ExtNs.Array
import typings.senchaUnderscoreTouch.ExtNs.IComponent
import typings.senchaUnderscoreTouch.ExtNs.ISheet
...
object IPicker {
  ...
  def apply(
    ...
    setValue: (/* values */ js.UndefOr[js.Any], /* animated */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.pickerNs.IPicker = null,
