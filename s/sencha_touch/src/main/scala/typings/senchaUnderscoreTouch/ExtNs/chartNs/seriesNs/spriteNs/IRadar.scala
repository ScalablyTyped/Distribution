...
trait IRadar
  extends typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IPolar {
...
object IRadar {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IRadar = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IRadar = null,
