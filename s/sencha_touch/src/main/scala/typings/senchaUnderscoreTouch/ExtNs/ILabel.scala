...
object ILabel {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ILabel = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ILabel = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ILabel], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
