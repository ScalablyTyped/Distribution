...
trait ISpinner
  extends typings.senchaUnderscoreTouch.ExtNs.fieldNs.INumber {
...
object ISpinner {
  @scala.inline
  def apply(
    INumber: typings.senchaUnderscoreTouch.ExtNs.fieldNs.INumber = null,
    ...
    reset: () => typings.senchaUnderscoreTouch.ExtNs.fieldNs.IField = null,
