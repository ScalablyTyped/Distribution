...
trait ICompositeElement
  extends typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite {
  ...
  var addListener_ICompositeElement: js.UndefOr[
    js.Function4[
      ...
      typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite
    ]
  ] = js.undefined
...
object ICompositeElement {
  @scala.inline
  def apply(
    ICompositeElementLite: typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    add: (/* els */ js.UndefOr[js.Any], /* root */ js.UndefOr[js.Any]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    ...
    addListener: (/* eventName */ js.UndefOr[js.Any], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* opt */ js.UndefOr[js.Any]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    elements: Array = null,
    fill: /* els */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    filter: /* selector */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    ...
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    ...
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
    replaceWith: /* el */ js.UndefOr[js.Any] => typings.senchaUnderscoreTouch.ExtNs.domNs.IElement = null,
    select: (/* selector */ js.UndefOr[js.Any], /* composite */ js.UndefOr[Boolean]) => typings.senchaUnderscoreTouch.ExtNs.domNs.ICompositeElementLite = null,
