...
trait IScatter
  extends typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.ICartesian {
...
object IScatter {
  ...
  def apply(
    ...
    hide: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IScatter = null,
    ...
    show: () => typings.senchaUnderscoreTouch.ExtNs.chartNs.seriesNs.spriteNs.IScatter = null,
