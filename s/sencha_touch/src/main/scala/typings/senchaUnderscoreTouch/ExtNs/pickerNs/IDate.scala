...
trait IDate
  extends typings.senchaUnderscoreTouch.ExtNs.pickerNs.IPicker {
  ...
  var setValue_IDate: js.UndefOr[
    js.Function2[
      ...
      typings.senchaUnderscoreTouch.ExtNs.IPicker
    ]
  ] = js.undefined
...
object IDate {
  @scala.inline
  def apply(
    IPicker: typings.senchaUnderscoreTouch.ExtNs.pickerNs.IPicker = null,
    ...
    setValue: (/* value */ js.UndefOr[js.Any], /* animated */ js.UndefOr[js.Any]) => typings.senchaUnderscoreTouch.ExtNs.IPicker = null,
