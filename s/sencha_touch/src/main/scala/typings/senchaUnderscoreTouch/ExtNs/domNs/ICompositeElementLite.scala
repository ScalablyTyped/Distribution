...
trait ICompositeElementLite
  ...
  var setVisible_ICompositeElementLite: js.UndefOr[
    js.Function1[/* visible */ js.UndefOr[Boolean], typings.senchaUnderscoreTouch.ExtNs.IElement]
  ] = js.undefined
...
object ICompositeElementLite {
  ...
  def apply(
    ...
    setVisible: /* visible */ js.UndefOr[Boolean] => typings.senchaUnderscoreTouch.ExtNs.IElement = null,
