...
import typings.senchaUnderscoreTouch.ExtNs.dataNs.readerNs.IJson
...
object IArrayReader {
  ...
  def apply(
    ...
    setSuccessProperty: /* successProperty */ js.UndefOr[js.Any] => Unit = null,
    setTotalProperty: /* totalProperty */ js.UndefOr[js.Any] => Unit = null,
