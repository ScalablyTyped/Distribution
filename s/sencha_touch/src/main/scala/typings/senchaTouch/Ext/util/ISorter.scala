...
object ISorter {
  ...
  extension [Self <: ISorter](x: Self) {
    ...
    inline def setGetSorterFn(value: () => js.Any): Self = StObject.set(x, "getSorterFn", js.Any.fromFunction0(value))
    
    inline def setGetSorterFnUndefined: Self = StObject.set(x, "getSorterFn", js.undefined)
    
    inline def setGetTransform(value: () => js.Any): Self = StObject.set(x, "getTransform", js.Any.fromFunction0(value))
    ...
    inline def setSetSorterFn(value: /* sorterFn */ js.UndefOr[js.Any] => Unit): Self = StObject.set(x, "setSorterFn", js.Any.fromFunction1(value))
    
    inline def setSetSorterFnUndefined: Self = StObject.set(x, "setSorterFn", js.undefined)
    
    inline def setSetTransform(value: /* transform */ js.UndefOr[js.Any] => Unit): Self = StObject.set(x, "setTransform", js.Any.fromFunction1(value))
