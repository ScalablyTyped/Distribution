...
object IFit {
  ...
  def apply(
    ...
    animation: typings.senchaTouch.Ext.fx.layout.ICard = null,
    ...
    getAnimation: () => typings.senchaTouch.Ext.fx.layout.ICard = null,
    ...
    self: IClass = null,
    setAnimation: /* animation */ js.UndefOr[typings.senchaTouch.Ext.fx.layout.ICard] => Unit = null,
