...
trait IDatePicker
  extends StObject
     with typings.senchaTouch.Ext.field.ISelect {
  ...
  /** [Method] Resets the Select field to the value of the first record in the store
    ...
    */
  @JSName("reset")
  var reset_IDatePicker: js.UndefOr[js.Function0[typings.senchaTouch.Ext.field.ISelect]] = js.undefined
...
object IDatePicker {
  ...
  extension [Self <: IDatePicker](x: Self) {
    ...
    inline def setReset(value: () => typings.senchaTouch.Ext.field.ISelect): Self = StObject.set(x, "reset", js.Any.fromFunction0(value))
