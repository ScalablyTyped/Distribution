...
object IComposite {
  ...
  def apply(
    A: Int | Double = null,
    An: Array = null,
    add: /* sprite */ js.UndefOr[js.Any] => Unit = null,
    ...
    render: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* region */ js.UndefOr[js.Any]) => Unit = null,
