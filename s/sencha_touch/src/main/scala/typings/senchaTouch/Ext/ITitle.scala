...
object ITitle {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ITitle = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ITitle = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ITitle], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
