...
@js.native
class Contacts_ () extends js.Object

/* static members */
@JSGlobal("Ext.device.Contacts")
@js.native
object Contacts_ extends js.Object {
  /** [Property] (Ext.Class) */
  ...
  /** [Method] Returns an Array of contact objects
  		...
  		*/
  def getContacts(): Array = js.native
  def getContacts(config: js.Any): Array = js.native
  ...
  /** [Method] Returns localized user readable label for a contact field i e
  		...
  		*/
  def getLocalizedLabel(): String = js.native
  def getLocalizedLabel(config: js.Any): String = js.native
  ...
  def getThumbnail(config: js.Any): String = js.native
