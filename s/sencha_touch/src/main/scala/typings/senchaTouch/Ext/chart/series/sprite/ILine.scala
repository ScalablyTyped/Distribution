...
object ILine {
  ...
  def apply(
    ...
    if (!js.isUndefined(fillArea)) __obj.updateDynamic("fillArea")(fillArea.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(preciseStroke)) __obj.updateDynamic("preciseStroke")(preciseStroke.get.asInstanceOf[js.Any])
