...
object IAbstract {
  ...
  def apply(
    ...
    capture: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* destination */ js.UndefOr[String], /* encoding */ js.UndefOr[String], /* width */ js.UndefOr[Double], /* height */ js.UndefOr[Double]) => Unit = null,
    config: js.Any = null,
    destroy: () => Unit = null,
    extend: String = null,
    ...
    if (capture != null) __obj.updateDynamic("capture")(js.Any.fromFunction6(capture))
