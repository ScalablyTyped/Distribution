...
object IPie {
  @scala.inline
  def apply(
    Allows: js.UndefOr[Double] = js.undefined,
    ...
    title: String = null,
    totalAngle: js.UndefOr[Double] = js.undefined,
    `type`: String = null,
    ...
    if (!js.isUndefined(Allows)) __obj.updateDynamic("Allows")(Allows.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(totalAngle)) __obj.updateDynamic("totalAngle")(totalAngle.get.asInstanceOf[js.Any])
