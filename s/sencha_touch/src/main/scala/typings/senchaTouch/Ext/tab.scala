...
object tab {
  ...
  object IPanel {
    ...
    @scala.inline
    def apply(): typings.senchaTouch.Ext.tab.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.senchaTouch.Ext.tab.IPanel]
    }
    
    @scala.inline
    implicit class IPanelMutableBuilder[Self <: typings.senchaTouch.Ext.tab.IPanel] (val x: Self) extends AnyVal {
  ...
  object ITab {
    ...
    @scala.inline
    def apply(): typings.senchaTouch.Ext.tab.ITab = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.senchaTouch.Ext.tab.ITab]
    }
    
    @scala.inline
    implicit class ITabMutableBuilder[Self <: typings.senchaTouch.Ext.tab.ITab] (val x: Self) extends AnyVal {
