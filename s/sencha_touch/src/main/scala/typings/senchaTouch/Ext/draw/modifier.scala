...
object modifier {
  ...
  object IAnimation {
    ...
    extension [Self <: IAnimation](x: Self) {
      ...
      inline def setAddBeforeListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "addBeforeListener", js.Any.fromFunction4(value))
      ...
      inline def setAddListener(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[String]) => Unit
      ...
      inline def setAddManagedListener(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit
      ...
      inline def setClearDurationOn(value: /* attrs */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "clearDurationOn", js.Any.fromFunction1(value))
      
      inline def setClearDurationOnUndefined: Self = StObject.set(x, "clearDurationOn", js.undefined)
      
      inline def setClearEasingOn(value: /* attrs */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "clearEasingOn", js.Any.fromFunction1(value))
      ...
      inline def setGetCustomDuration(value: () => Any): Self = StObject.set(x, "getCustomDuration", js.Any.fromFunction0(value))
      
      inline def setGetCustomDurationUndefined: Self = StObject.set(x, "getCustomDuration", js.undefined)
      
      inline def setGetCustomEasings(value: () => Any): Self = StObject.set(x, "getCustomEasings", js.Any.fromFunction0(value))
      ...
      inline def setOnAfter(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "onAfter", js.Any.fromFunction4(value))
      
      inline def setOnAfterUndefined: Self = StObject.set(x, "onAfter", js.undefined)
      
      inline def setOnBefore(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "onBefore", js.Any.fromFunction4(value))
      ...
      inline def setRemoveAfterListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "removeAfterListener", js.Any.fromFunction4(value))
      
      inline def setRemoveAfterListenerUndefined: Self = StObject.set(x, "removeAfterListener", js.undefined)
      
      inline def setRemoveBeforeListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "removeBeforeListener", js.Any.fromFunction4(value))
      ...
      inline def setSetBubbleEvents(value: js.UndefOr[Any] => Unit): Self = StObject.set(x, "setBubbleEvents", js.Any.fromFunction1(value))
      
      inline def setSetBubbleEventsUndefined: Self = StObject.set(x, "setBubbleEvents", js.undefined)
      
      inline def setSetCustomDuration(value: /* customDuration */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "setCustomDuration", js.Any.fromFunction1(value))
      
      inline def setSetCustomDurationUndefined: Self = StObject.set(x, "setCustomDuration", js.undefined)
      
      inline def setSetCustomEasings(value: /* customEasings */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "setCustomEasings", js.Any.fromFunction1(value))
      ...
      inline def setSetDurationOn(value: (/* attrs */ js.UndefOr[Any], /* duration */ js.UndefOr[Double]) => Unit): Self = StObject.set(x, "setDurationOn", js.Any.fromFunction2(value))
      ...
      inline def setSetEasingOn(value: (/* attrs */ js.UndefOr[Any], /* easing */ js.UndefOr[String]) => Unit): Self = StObject.set(x, "setEasingOn", js.Any.fromFunction2(value))
      ...
      inline def setSetListeners(value: js.UndefOr[Any] => Unit): Self = StObject.set(x, "setListeners", js.Any.fromFunction1(value))
      ...
      inline def setUnAfter(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "unAfter", js.Any.fromFunction4(value))
      
      inline def setUnAfterUndefined: Self = StObject.set(x, "unAfter", js.undefined)
      
      inline def setUnBefore(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Unit): Self = StObject.set(x, "unBefore", js.Any.fromFunction4(value))
  ...
  object IHighlight {
    ...
    extension [Self <: IHighlight](x: Self) {
      ...
      inline def setGetHighlightStyle(value: () => Any): Self = StObject.set(x, "getHighlightStyle", js.Any.fromFunction0(value))
      ...
      inline def setSetHighlightStyle(value: /* highlightStyle */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "setHighlightStyle", js.Any.fromFunction1(value))
  ...
  object IModifier {
    ...
    extension [Self <: IModifier](x: Self) {
      ...
      inline def setPopUp(value: (/* attributes */ js.UndefOr[Any], /* changes */ js.UndefOr[Any]) => Unit): Self = StObject.set(x, "popUp", js.Any.fromFunction2(value))
      
      inline def setPopUpUndefined: Self = StObject.set(x, "popUp", js.undefined)
      
      inline def setPrepareAttributes(value: /* attr */ js.UndefOr[Any] => Unit): Self = StObject.set(x, "prepareAttributes", js.Any.fromFunction1(value))
