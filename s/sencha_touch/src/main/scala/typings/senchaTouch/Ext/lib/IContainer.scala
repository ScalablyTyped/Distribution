...
object IContainer {
  ...
  implicit class IContainerOps[Self <: IContainer] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdd(value: /* newItems */ js.UndefOr[js.Any] => typings.senchaTouch.Ext.IComponent): Self = this.set("add", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setChild(value: /* selector */ js.UndefOr[String] => typings.senchaTouch.Ext.IComponent): Self = this.set("child", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setDown(value: /* selector */ js.UndefOr[String] => typings.senchaTouch.Ext.IComponent): Self = this.set("down", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setGetAt(value: /* index */ js.UndefOr[Double] => typings.senchaTouch.Ext.IComponent): Self = this.set("getAt", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setGetComponent(value: /* component */ js.UndefOr[js.Any] => typings.senchaTouch.Ext.IComponent): Self = this.set("getComponent", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setHide(value: () => typings.senchaTouch.Ext.IComponent): Self = this.set("hide", js.Any.fromFunction0(value))
    @scala.inline
    ...
    @scala.inline
    def setShow(value: () => typings.senchaTouch.Ext.IComponent): Self = this.set("show", js.Any.fromFunction0(value))
    @scala.inline
