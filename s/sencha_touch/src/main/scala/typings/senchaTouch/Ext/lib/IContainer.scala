...
object IContainer {
  @scala.inline
  def apply(
    IComponent: typings.senchaTouch.Ext.IComponent = null,
    activeItem: js.Any = null,
    add: /* newItems */ js.UndefOr[js.Any] => typings.senchaTouch.Ext.IComponent = null,
    ...
    child: /* selector */ js.UndefOr[String] => typings.senchaTouch.Ext.IComponent = null,
    control: js.Any = null,
    defaultType: String = null,
    defaults: js.Any = null,
    down: /* selector */ js.UndefOr[String] => typings.senchaTouch.Ext.IComponent = null,
    getActiveItem: () => _ = null,
    getAt: /* index */ js.UndefOr[Double] => typings.senchaTouch.Ext.IComponent = null,
    getAutoDestroy: () => Boolean = null,
    getComponent: /* component */ js.UndefOr[js.Any] => typings.senchaTouch.Ext.IComponent = null,
    getControl: () => _ = null,
    ...
    hide: () => typings.senchaTouch.Ext.IComponent = null,
    ...
    remove: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typings.senchaTouch.Ext.IComponent = null,
    removeAll: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => typings.senchaTouch.Ext.IComponent = null,
    removeAt: /* index */ js.UndefOr[Double] => IContainer = null,
    removeDocked: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => typings.senchaTouch.Ext.IComponent = null,
    ...
    show: () => typings.senchaTouch.Ext.IComponent = null,
    unmask: () => Unit = null
  ): IContainer = {
