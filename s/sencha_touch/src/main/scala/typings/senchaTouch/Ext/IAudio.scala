...
object IAudio {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IAudio = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IAudio = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IAudio], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
