...
object IFlip {
  ...
  def apply(
    ...
    setHalf: /* half */ js.UndefOr[Boolean] => Unit = null,
    ...
    setOut: /* out */ js.UndefOr[js.Any] => Unit = null,
    ...
    if (getHalf != null) __obj.updateDynamic("getHalf")(js.Any.fromFunction0(getHalf))
    ...
    if (setHalf != null) __obj.updateDynamic("setHalf")(js.Any.fromFunction1(setHalf))
