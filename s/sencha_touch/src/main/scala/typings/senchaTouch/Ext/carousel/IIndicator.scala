...
object IIndicator {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IIndicator = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IIndicator = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IIndicator], /* alignment */ js.UndefOr[String]) => Unit = null,
