...
object IErrors {
  ...
  implicit class IErrorsMutableBuilder[Self <: IErrors] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddFunction0(value: () => js.Any): Self = StObject.set(x, "add", js.Any.fromFunction0(value))
    
    @scala.inline
    def setAddFunction2(value: (/* key */ js.UndefOr[String], /* item */ js.UndefOr[js.Any]) => js.Any): Self = StObject.set(x, "add", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setInsertSorters(value: () => IErrors): Self = StObject.set(x, "insertSorters", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setRemoveFilters(value: /* filters */ js.UndefOr[js.Any] => IErrors): Self = StObject.set(x, "removeFilters", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setRemoveSorters(value: /* sorters */ js.UndefOr[js.Any] => IErrors): Self = StObject.set(x, "removeSorters", js.Any.fromFunction1(value))
