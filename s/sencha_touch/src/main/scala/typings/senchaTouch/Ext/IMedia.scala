...
object IMedia {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IMedia = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IMedia = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IMedia], /* alignment */ js.UndefOr[java.lang.String]) => Unit = null,
