...
object IRequest {
  ...
  def apply(
    ...
    getProxy: () => typings.senchaTouch.Ext.data.proxy.IProxy = null,
    getRecords: () => _ = null,
    getScope: () => _ = null,
    ...
    proxy: typings.senchaTouch.Ext.data.proxy.IProxy = null,
    self: IClass = null,
    ...
    setProxy: /* proxy */ js.UndefOr[typings.senchaTouch.Ext.data.proxy.IProxy] => Unit = null,
