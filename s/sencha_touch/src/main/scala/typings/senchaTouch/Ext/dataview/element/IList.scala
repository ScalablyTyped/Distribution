package typings.senchaTouch.Ext.dataview.element
...
object IList {
  ...
  def apply(
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IList = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IList = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IList], /* alignment */ js.UndefOr[String]) => Unit = null,
    ...
    up: /* selector */ js.UndefOr[String] => typings.senchaTouch.Ext.IContainer = null,
    update: () => Unit = null,
