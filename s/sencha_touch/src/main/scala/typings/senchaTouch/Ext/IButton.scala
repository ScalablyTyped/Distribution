...
object IButton {
  ...
  implicit class IButtonMutableBuilder[Self <: IButton] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetHandler(value: () => js.Any): Self = StObject.set(x, "getHandler", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetPressedDelay(value: () => js.Any): Self = StObject.set(x, "getPressedDelay", js.Any.fromFunction0(value))
