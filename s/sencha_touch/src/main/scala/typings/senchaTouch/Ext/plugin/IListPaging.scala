...
trait IListPaging extends IComponent {
  ...
  /** [Method] Returns the value of loadMoreText
    * @returns String
    */
  var getLoadMoreText: js.UndefOr[js.Function0[String]] = js.undefined
  /** [Method] Returns the value of noMoreRecordsText
    * @returns String
    */
  var getNoMoreRecordsText: js.UndefOr[js.Function0[String]] = js.undefined
  /** [Config Option] (String) */
  var loadMoreText: js.UndefOr[String] = js.undefined
  /** [Config Option] (String) */
  var noMoreRecordsText: js.UndefOr[String] = js.undefined
  ...
  /** [Method] Sets the value of loadMoreText
    ...
    */
  var setLoadMoreText: js.UndefOr[js.Function1[/* loadMoreText */ js.UndefOr[String], Unit]] = js.undefined
  /** [Method] Sets the value of noMoreRecordsText
    * @param noMoreRecordsText String The new value.
    */
  var setNoMoreRecordsText: js.UndefOr[js.Function1[/* noMoreRecordsText */ js.UndefOr[String], Unit]] = js.undefined
}
...
object IListPaging {
  ...
  def apply(
    ...
    autoPaging: js.UndefOr[Boolean] = js.undefined,
    baseCls: String = null,
    border: js.Any = null,
    bottom: js.Any = null,
    ...
    getLeft: () => _ = null,
    getListeners: () => _ = null,
    getLoadMoreText: () => String = null,
    getMargin: () => _ = null,
    getMaxHeight: () => _ = null,
    getMaxWidth: () => _ = null,
    getMinHeight: () => _ = null,
    getMinWidth: () => _ = null,
    getNoMoreRecordsText: () => String = null,
    getPadding: () => _ = null,
    getParent: () => IListPaging = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IListPaging = null,
    ...
    scroll: js.Any = null,
    self: IClass = null,
    setAutoPaging: /* autoPaging */ js.UndefOr[Boolean] => Unit = null,
    ...
    setLoadMoreText: /* loadMoreText */ js.UndefOr[String] => Unit = null,
    ...
    setNoMoreRecordsText: /* noMoreRecordsText */ js.UndefOr[String] => Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IListPaging = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IListPaging], /* alignment */ js.UndefOr[String]) => Unit = null,
    ...
    if (!js.isUndefined(autoPaging)) __obj.updateDynamic("autoPaging")(autoPaging.get.asInstanceOf[js.Any])
    ...
    if (getAutoPaging != null) __obj.updateDynamic("getAutoPaging")(js.Any.fromFunction0(getAutoPaging))
    ...
    if (getLoadMoreText != null) __obj.updateDynamic("getLoadMoreText")(js.Any.fromFunction0(getLoadMoreText))
    ...
    if (getNoMoreRecordsText != null) __obj.updateDynamic("getNoMoreRecordsText")(js.Any.fromFunction0(getNoMoreRecordsText))
    ...
    if (noMoreRecordsText != null) __obj.updateDynamic("noMoreRecordsText")(noMoreRecordsText.asInstanceOf[js.Any])
    ...
    if (setAutoPaging != null) __obj.updateDynamic("setAutoPaging")(js.Any.fromFunction1(setAutoPaging))
    ...
    if (setLoadMoreText != null) __obj.updateDynamic("setLoadMoreText")(js.Any.fromFunction1(setLoadMoreText))
    ...
    if (setNoMoreRecordsText != null) __obj.updateDynamic("setNoMoreRecordsText")(js.Any.fromFunction1(setNoMoreRecordsText))
