...
object IDate {
  ...
  implicit class IDateOps[Self <: IDate] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDayText(value: String): Self = this.set("dayText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteDayText: Self = this.set("dayText", js.undefined)
    
    @scala.inline
    def setGetDayText(value: () => String): Self = this.set("getDayText", js.Any.fromFunction0(value))
    
    @scala.inline
    def deleteGetDayText: Self = this.set("getDayText", js.undefined)
    
    @scala.inline
    def setGetMonthText(value: () => String): Self = this.set("getMonthText", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setGetYearText(value: () => String): Self = this.set("getYearText", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setMonthText(value: String): Self = this.set("monthText", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteMonthText: Self = this.set("monthText", js.undefined)
    
    @scala.inline
    def setSetDayText(value: /* dayText */ js.UndefOr[String] => Unit): Self = this.set("setDayText", js.Any.fromFunction1(value))
    
    @scala.inline
    def deleteSetDayText: Self = this.set("setDayText", js.undefined)
    
    @scala.inline
    def setSetMonthText(value: /* monthText */ js.UndefOr[String] => Unit): Self = this.set("setMonthText", js.Any.fromFunction1(value))
    ...
    ): Self = this.set("setValue", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setSetYearText(value: /* yearText */ js.UndefOr[String] => Unit): Self = this.set("setYearText", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setYearText(value: String): Self = this.set("yearText", value.asInstanceOf[js.Any])
