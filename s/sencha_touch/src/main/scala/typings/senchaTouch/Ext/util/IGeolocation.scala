...
object IGeolocation {
  ...
  extension [Self <: IGeolocation](x: Self) {
    ...
    inline def setGetAutoUpdate(value: () => Boolean): Self = StObject.set(x, "getAutoUpdate", js.Any.fromFunction0(value))
    ...
    inline def setSetAutoUpdate(value: /* autoUpdate */ js.UndefOr[Boolean] => Unit): Self = StObject.set(x, "setAutoUpdate", js.Any.fromFunction1(value))
