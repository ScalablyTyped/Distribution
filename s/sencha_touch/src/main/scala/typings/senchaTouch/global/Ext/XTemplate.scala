...
class XTemplate ()
  extends StObject
     with typings.senchaTouch.Ext.XTemplate
/* static members */
object XTemplate {
  ...
  /** [Method] Gets an XTemplate from an object an instance of an Ext define d class
    ...
    */
  @scala.inline
  def getTpl(): IXTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")().asInstanceOf[IXTemplate]
  @scala.inline
  def getTpl(instance: js.Any): IXTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")(instance.asInstanceOf[js.Any]).asInstanceOf[IXTemplate]
  @scala.inline
  def getTpl(instance: js.Any, name: java.lang.String): IXTemplate = (^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")(instance.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[IXTemplate]
  @scala.inline
  def getTpl(instance: Unit, name: java.lang.String): IXTemplate = (^.asInstanceOf[js.Dynamic].applyDynamic("getTpl")(instance.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[IXTemplate]
