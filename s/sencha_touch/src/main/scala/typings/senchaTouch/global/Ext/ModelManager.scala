...
@js.native
class ModelManager ()
  extends typings.senchaTouch.Ext.ModelManager
/* static members */
object ModelManager {
  ...
  /** [Method] Call the original method that was previously overridden with override  This method is deprecated as callParent does
    ...
    */
  @JSGlobal("Ext.ModelManager.callOverridden")
  @js.native
  ...
  /** [Method] Call the parent method of the current method
    ...
    */
  @JSGlobal("Ext.ModelManager.callParent")
  @js.native
  ...
  /** [Method] This method is used by an override to call the superclass method but bypass any overridden method
    ...
    */
  @JSGlobal("Ext.ModelManager.callSuper")
  @js.native
  ...
  /** [Method] Creates a new instance of a Model using the given data
    ...
    * @returns Object
    */
  @JSGlobal("Ext.ModelManager.create")
  @js.native
  ...
  /** [Method]  */
  @JSGlobal("Ext.ModelManager.destroy")
  @js.native
  ...
  /** [Method] Executes the specified function once for each item in the collection
    ...
    */
  @JSGlobal("Ext.ModelManager.each")
  @js.native
  ...
  /** [Method] Gets the number of items in the collection
    ...
    */
  @JSGlobal("Ext.ModelManager.getCount")
  @js.native
  ...
  /** [Method] Returns the initial configuration passed to constructor
    ...
    */
  @JSGlobal("Ext.ModelManager.getInitialConfig")
  @js.native
  ...
  /** [Method] Returns the Ext data Model for a given model name
    ...
    */
  @JSGlobal("Ext.ModelManager.getModel")
  @js.native
  ...
  /** [Method] Initialize configuration for this class
    ...
    */
  @JSGlobal("Ext.ModelManager.initConfig")
  @js.native
  ...
  /** [Method] Checks if an item type is registered
    ...
    */
  @JSGlobal("Ext.ModelManager.isRegistered")
  @js.native
  ...
  /** [Method] Registers a function that will be called when an item with the specified id is added to the manager
    ...
    */
  @JSGlobal("Ext.ModelManager.onAvailable")
  @js.native
  ...
  /** [Method] Registers an item to be managed
    ...
    */
  @JSGlobal("Ext.ModelManager.register")
  @js.native
  ...
  /** [Method] Registers a model definition
    ...
    * @returns Object
    */
  @JSGlobal("Ext.ModelManager.registerType")
  @js.native
  ...
  /** [Method] Get the reference to the class from which this object was instantiated
    * @returns Ext.Class
    */
  @JSGlobal("Ext.ModelManager.statics")
  @js.native
  ...
  /** [Method] Unregisters an item by removing it from this manager
    ...
    */
  @JSGlobal("Ext.ModelManager.unregister")
  @js.native
