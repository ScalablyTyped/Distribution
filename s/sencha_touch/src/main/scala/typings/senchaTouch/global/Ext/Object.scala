...
object Object {
  ...
  /** [Method] Gets all keys of the given object as an array
    ...
    */
  @scala.inline
  def getKeys(): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeys")().asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def getKeys(`object`: js.Any): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getKeys")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.senchaTouch.Ext.Array]
  ...
  /** [Method] Gets all values of the given object as an array
    ...
    */
  @scala.inline
  def getValues(): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getValues")().asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def getValues(`object`: js.Any): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getValues")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.senchaTouch.Ext.Array]
  ...
  /** [Method] Merges any number of objects recursively without referencing them or their children
    ...
    */
  @scala.inline
  def merge(source: js.Any, objs: js.Any*): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("merge")(source.asInstanceOf[js.Any], objs.asInstanceOf[js.Any])).asInstanceOf[js.Any]
  
  /** [Method]
    * @param source Object
    */
  @scala.inline
  def mergeIf(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeIf")().asInstanceOf[Unit]
  @scala.inline
  def mergeIf(source: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("mergeIf")(source.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /** [Method] Convert a name  value pair to an array of objects with support for nested structures useful to construct query stri
    ...
    */
  @scala.inline
  def toQueryObjects(): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")().asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: java.lang.String): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any]).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: java.lang.String, value: js.Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: java.lang.String, value: js.Any, recursive: Boolean): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: java.lang.String, value: Unit, recursive: Boolean): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: Unit, value: js.Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: Unit, value: js.Any, recursive: Boolean): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
  @scala.inline
  def toQueryObjects(name: Unit, value: Unit, recursive: Boolean): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("toQueryObjects")(name.asInstanceOf[js.Any], value.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
