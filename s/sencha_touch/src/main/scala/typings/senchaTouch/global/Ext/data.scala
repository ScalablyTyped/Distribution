...
object data {
  ...
  object Model {
    ...
    @scala.inline
    def load(id: Double): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any]).asInstanceOf[Unit]
    @scala.inline
    def load(id: Double, config: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def load(id: Double, config: js.Any, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def load(id: Double, config: Unit, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    ...
    @scala.inline
    def load(id: Unit, config: js.Any, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def load(id: Unit, config: Unit, scope: js.Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(id.asInstanceOf[js.Any], config.asInstanceOf[js.Any], scope.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object Node {
    ...
    @scala.inline
    def decorate(record: IModel): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("decorate")(record.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  object SortTypes {
    ...
    @scala.inline
    def asDate(value: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asDate")(value.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    @scala.inline
    def asFloat(value: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asFloat")(value.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    @scala.inline
    def asInt(value: js.Any): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("asInt")(value.asInstanceOf[js.Any]).asInstanceOf[Double]
    ...
    @scala.inline
    def asText(value: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asText")(value.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    @scala.inline
    def asUCString(value: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCString")(value.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    @scala.inline
    def asUCText(value: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("asUCText")(value.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    @scala.inline
    def none(value: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("none")(value.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  object Validations {
    ...
    /** [Method] Returns the configured error message for any of the validation types
      ...
      */
    @scala.inline
    def getMessage(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getMessage")().asInstanceOf[js.Any]
    @scala.inline
    def getMessage(`type`: java.lang.String): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getMessage")(`type`.asInstanceOf[js.Any]).asInstanceOf[js.Any]
