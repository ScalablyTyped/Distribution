...
object dom {
  ...
  class Element ()
    extends StObject
       with typings.senchaTouch.Ext.dom.Element
  /* static members */
  object Element {
    ...
    inline def fly(element: js.Any): IElement = ^.asInstanceOf[js.Dynamic].applyDynamic("fly")(element.asInstanceOf[js.Any]).asInstanceOf[IElement]
    inline def fly(element: js.Any, named: java.lang.String): IElement = (^.asInstanceOf[js.Dynamic].applyDynamic("fly")(element.asInstanceOf[js.Any], named.asInstanceOf[js.Any])).asInstanceOf[IElement]
    ...
    inline def get(element: js.Any): IElement = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(element.asInstanceOf[js.Any]).asInstanceOf[IElement]
    ...
    inline def select(selector: js.Any): ICompositeElementLite = ^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any]).asInstanceOf[ICompositeElementLite]
    inline def select(selector: js.Any, composite: Boolean): ICompositeElementLite = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], composite.asInstanceOf[js.Any])).asInstanceOf[ICompositeElementLite]
    inline def select(selector: js.Any, composite: Boolean, root: js.Any): ICompositeElementLite = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], composite.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[ICompositeElementLite]
    inline def select(selector: js.Any, composite: Unit, root: js.Any): ICompositeElementLite = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], composite.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[ICompositeElementLite]
    ...
    inline def select(selector: Unit, composite: Boolean, root: js.Any): ICompositeElementLite = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], composite.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[ICompositeElementLite]
    inline def select(selector: Unit, composite: Unit, root: js.Any): ICompositeElementLite = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], composite.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[ICompositeElementLite]
    ...
    inline def serializeForm(form: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeForm")(form.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
    ...
    inline def serializeNode(node: js.Any): java.lang.String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeNode")(node.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
