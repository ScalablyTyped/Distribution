  ...
  object device {
    ...
    object Analytics_ {
      ...
      /** [Method] Returns the value of accountID
        ...
        */
      @scala.inline
      def getAccountID(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccountID")().asInstanceOf[js.Any]
      ...
      /** [Method] Registers yur Google Analytics account
        ...
        */
      @scala.inline
      def registerAccount(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerAccount")().asInstanceOf[Unit]
      @scala.inline
      def registerAccount(accountID: java.lang.String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerAccount")(accountID.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      /** [Method] Sets the value of accountID
        ...
        */
      @scala.inline
      def setAccountID(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setAccountID")().asInstanceOf[Unit]
      @scala.inline
      def setAccountID(accountID: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setAccountID")(accountID.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      /** [Method] Track an event in your application
        ...
        */
      @scala.inline
      def trackEvent(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trackEvent")().asInstanceOf[Unit]
      @scala.inline
      def trackEvent(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trackEvent")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      
      /** [Method] Track an pageview in your application
        * @param config String The page you want to track (must start with a slash).
        */
      @scala.inline
      def trackPageview(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trackPageview")().asInstanceOf[Unit]
      @scala.inline
      def trackPageview(config: java.lang.String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trackPageview")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    }
    ...
    object Twitter_ {
      ...
      /** [Method] Pops up a Twitter compose sheet view with your specified tweet
        ...
        */
      @scala.inline
      def compose(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("compose")().asInstanceOf[Unit]
      @scala.inline
      def compose(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("compose")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      /** [Method] Gets Tweets from Twitter Mentions
        ...
        */
      @scala.inline
      def getMentions(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getMentions")().asInstanceOf[Unit]
      @scala.inline
      def getMentions(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getMentions")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      
      /** [Method] Gets Tweets from Twitter Timeline
        * @param config Object An object which contains the following config options:
        */
      @scala.inline
      def getPublicTimeline(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublicTimeline")().asInstanceOf[Unit]
      @scala.inline
      def getPublicTimeline(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublicTimeline")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      
      /** [Method] Gets a specific Twitter user info
        * @param config Object An object which contains the following config options:
        */
      @scala.inline
      def getTwitterRequest(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterRequest")().asInstanceOf[Unit]
      @scala.inline
      def getTwitterRequest(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterRequest")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      
      /** [Method] Gets a specific Twitter user info
        * @param config Object An object which contains the following config options:
        */
      @scala.inline
      def getTwitterUsername(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterUsername")().asInstanceOf[Unit]
      @scala.inline
      def getTwitterUsername(config: js.Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterUsername")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
