...
@js.native
class ClassManager ()
  extends typings.senchaTouch.Ext.ClassManager
...
object ClassManager extends js.Object {
  ...
  /** [Method] Get the aliases of a class by the class name
    ...
    */
  def getAliasesByName(): typings.senchaTouch.Ext.Array = js.native
  def getAliasesByName(name: java.lang.String): typings.senchaTouch.Ext.Array = js.native
  ...
  /** [Method] Converts a string expression to an array of matching class names
    ...
    */
  def getNamesByExpression(): typings.senchaTouch.Ext.Array = js.native
  def getNamesByExpression(expression: java.lang.String): typings.senchaTouch.Ext.Array = js.native
