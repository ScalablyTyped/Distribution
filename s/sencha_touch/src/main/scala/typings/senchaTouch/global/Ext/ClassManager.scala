...
object ClassManager {
  ...
  /** [Method] Instantiate a class by either full name alias or alternate name usually invoked by the convenient shorthand Ext cre
    ...
    */
  inline def instantiate(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("instantiate")().asInstanceOf[Any]
  inline def instantiate(name: java.lang.String): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("instantiate")(name.asInstanceOf[js.Any]).asInstanceOf[Any]
  inline def instantiate(name: java.lang.String, args: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("instantiate")(name.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Any]
  inline def instantiate(name: Unit, args: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("instantiate")(name.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[Any]
