...
class Direct_ ()
  extends StObject
     with typings.senchaTouch.Ext.Direct_
/* static members */
object Direct_ {
  ...
  /** [Method] Adds an Ext Direct Provider and creates the proxy or stub methods to execute server side methods
    ...
    */
  @scala.inline
  def addProvider(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addProvider")().asInstanceOf[js.Any]
  @scala.inline
  def addProvider(provider: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  /** [Method] Retrieves a provider by the id specified when the provider is added
    ...
    */
  @scala.inline
  def getProvider(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getProvider")().asInstanceOf[js.Any]
  @scala.inline
  def getProvider(id: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getProvider")(id.asInstanceOf[js.Any]).asInstanceOf[js.Any]
  ...
  /** [Method] Removes the provider
    ...
    */
  @scala.inline
  def removeProvider(): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProvider")().asInstanceOf[js.Any]
  @scala.inline
  def removeProvider(provider: js.Any): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[js.Any]
