...
object core {
  ...
  class DomQuery ()
    extends StObject
       with typings.senchaTouch.Ext.core.DomQuery
  /* static members */
  object DomQuery {
    ...
    /** [Method] Selects a group of elements
      ...
      */
    @scala.inline
    def select(): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("select")().asInstanceOf[typings.senchaTouch.Ext.Array]
    @scala.inline
    def select(selector: java.lang.String): typings.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any]).asInstanceOf[typings.senchaTouch.Ext.Array]
    @scala.inline
    def select(selector: java.lang.String, root: js.Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
    @scala.inline
    def select(selector: Unit, root: js.Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
    ...
    @scala.inline
    def selectNode(selector: java.lang.String, root: js.Any): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("selectNode")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
    @scala.inline
    def selectNode(selector: Unit, root: js.Any): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("selectNode")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
