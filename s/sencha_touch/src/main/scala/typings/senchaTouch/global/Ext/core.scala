...
object core {
  ...
  object DomQuery {
    ...
    inline def select(selector: java.lang.String, root: Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
    inline def select(selector: Unit, root: Any): typings.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("select")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typings.senchaTouch.Ext.Array]
