...
object SQLite extends js.Object {
  ...
  /** [Method] Returns a Ext device sqlite Database instance
  		...
  		*/
  def openDatabase(): senchaUnderscoreTouchLib.ExtNs.deviceNs.sqliteNs.IDatabase = js.native
  def openDatabase(config: js.Any): senchaUnderscoreTouchLib.ExtNs.deviceNs.sqliteNs.IDatabase = js.native
