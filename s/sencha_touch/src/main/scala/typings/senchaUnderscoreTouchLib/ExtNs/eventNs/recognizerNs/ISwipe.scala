...
object ISwipe {
  ...
  def apply(
    ...
    getMaxDuration: () => scala.Double = null,
    getMaxOffset: () => scala.Double = null,
    ...
    setMaxDuration: /* maxDuration */ js.UndefOr[scala.Double] => scala.Unit = null,
    setMaxOffset: /* maxOffset */ js.UndefOr[scala.Double] => scala.Unit = null,
