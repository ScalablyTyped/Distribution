...
object ITapRepeater {
  ...
  def apply(
    ...
    getAccelerate: () => scala.Boolean = null,
    ...
    getListeners: () => _ = null,
    getPressCls: () => _ = null,
    getPreventDefault: () => scala.Boolean = null,
    getStopDefault: () => scala.Boolean = null,
    getTimer: () => scala.Double = null,
    ...
    setAccelerate: /* accelerate */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[js.Any] => scala.Unit = null,
    setDelay: /* delay */ js.UndefOr[scala.Double] => scala.Unit = null,
    setEl: /* el */ js.UndefOr[js.Any] => scala.Unit = null,
    setInterval: /* interval */ js.UndefOr[scala.Double] => scala.Unit = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setPressCls: /* pressCls */ js.UndefOr[js.Any] => scala.Unit = null,
    setPreventDefault: /* preventDefault */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setStopDefault: /* stopDefault */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setTimer: /* timer */ js.UndefOr[scala.Double] => scala.Unit = null,
