package typings
package senchaUnderscoreTouchLib.ExtNs.chartNs.gridNs
...
trait IRadialGrid
  ...
  /** [Method] Update the path
  		...
  		*/
  @JSName("updatePath")
  var updatePath_IRadialGrid: js.UndefOr[
    js.Function2[/* path */ js.UndefOr[js.Any], /* attr */ js.UndefOr[js.Any], scala.Unit]
  ] = js.undefined
}
...
object IRadialGrid {
  ...
  def apply(
    ...
    hide: js.Function0[IRadialGrid] = null,
    ...
    show: js.Function0[IRadialGrid] = null,
