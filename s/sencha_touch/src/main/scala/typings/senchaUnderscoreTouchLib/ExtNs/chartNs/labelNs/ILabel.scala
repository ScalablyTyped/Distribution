...
object ILabel {
  ...
  def apply(
    ...
    setFx: js.Function1[/* fx */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getFx != null) __obj.updateDynamic("getFx")(getFx)
    ...
    if (setFx != null) __obj.updateDynamic("setFx")(setFx)
