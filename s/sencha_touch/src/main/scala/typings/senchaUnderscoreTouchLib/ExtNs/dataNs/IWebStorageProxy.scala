...
object IWebStorageProxy {
  ...
  def apply(
    ...
    config: js.Any = null,
    create: (/* operation */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    destroy: (/* operation */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    read: (/* operation */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    reader: js.Any = null,
    ...
    setDefaultDateFormat: /* defaultDateFormat */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    setRecord: (/* record */ js.UndefOr[IModel], /* id */ js.UndefOr[java.lang.String]) => scala.Unit = null,
    ...
    update: (/* operation */ js.UndefOr[js.Any], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
