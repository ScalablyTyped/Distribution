...
object ICanvas {
  ...
  def apply(
    ...
    showBy: (/* component */ js.UndefOr[ICanvas], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
    ...
    waitFor: /* surface */ js.UndefOr[ICanvas] => scala.Unit = null,
    width: js.Any = null,
