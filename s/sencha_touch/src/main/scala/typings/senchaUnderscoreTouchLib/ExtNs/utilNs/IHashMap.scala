...
object IHashMap {
  ...
  def apply(
    ...
    getKeys: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    getListeners: () => _ = null,
    getValues: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    ...
    removeByKey: /* key */ js.UndefOr[java.lang.String] => scala.Boolean = null,
