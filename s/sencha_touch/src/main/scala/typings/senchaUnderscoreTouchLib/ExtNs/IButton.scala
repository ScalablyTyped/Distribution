...
trait IButton extends IComponent {
  ...
  /** [Method] Sets the value of autoEvent
  		...
  		*/
  var setAutoEvent: js.UndefOr[js.Function1[/* autoEvent */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Updates the badge text
  		* @param text String
  		*/
  var setBadge: js.UndefOr[js.Function1[/* text */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of badgeCls
  		* @param badgeCls String The new value.
  		*/
  var setBadgeCls: js.UndefOr[js.Function1[/* badgeCls */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of badgeText
  		* @param badgeText String The new value.
  		*/
  var setBadgeText: js.UndefOr[js.Function1[/* badgeText */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of handler
  		* @param handler Function The new value.
  		*/
  var setHandler: js.UndefOr[js.Function1[/* handler */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of iconAlign
  		...
  		*/
  var setIconAlign: js.UndefOr[js.Function1[/* iconAlign */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Updates the icon class
  		* @param iconClass String
  		*/
  var setIconClass: js.UndefOr[js.Function1[/* iconClass */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of pressedDelay
  		...
  		*/
  var setPressedDelay: js.UndefOr[js.Function1[/* pressedDelay */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
