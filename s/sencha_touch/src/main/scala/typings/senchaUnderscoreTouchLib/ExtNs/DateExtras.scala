...
object DateExtras extends js.Object {
  ...
  /** [Property] (Array) */
  var dayNames: senchaUnderscoreTouchLib.ExtNs.Array = js.native
  /** [Property] (String) */
  ...
  /** [Property] (Array) */
  var monthNames: senchaUnderscoreTouchLib.ExtNs.Array = js.native
  /** [Property] (Object) */
  ...
  def diff(min: js.Any): scala.Double = js.native
  def diff(min: js.Any, max: js.Any): scala.Double = js.native
  def diff(min: js.Any, max: js.Any, unit: java.lang.String): scala.Double = js.native
  ...
  def parse(input: js.Any, format: java.lang.String, strict: scala.Boolean): js.Any = js.native
}
