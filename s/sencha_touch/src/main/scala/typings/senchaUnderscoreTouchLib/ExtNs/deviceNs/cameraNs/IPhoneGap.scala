...
trait IPhoneGap extends IAbstract {
  /** [Method] Allows you to capture a photo
  		...
  		*/
  @JSName("capture")
  var capture_IPhoneGap: js.UndefOr[js.Function1[/* args */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object IPhoneGap {
  ...
  def apply(
    ...
    capture: js.Function1[/* args */ js.UndefOr[js.Any], scala.Unit] = null,
    config: js.Any = null,
