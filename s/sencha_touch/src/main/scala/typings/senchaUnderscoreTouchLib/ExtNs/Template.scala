...
object Template extends js.Object {
  ...
  /** [Method] Creates a template from the passed element s value display none textarea preferred or innerHTML
  		...
  		*/
  def from(): senchaUnderscoreTouchLib.ExtNs.ITemplate = js.native
  def from(el: js.Any): senchaUnderscoreTouchLib.ExtNs.ITemplate = js.native
  def from(el: js.Any, config: js.Any): senchaUnderscoreTouchLib.ExtNs.ITemplate = js.native
