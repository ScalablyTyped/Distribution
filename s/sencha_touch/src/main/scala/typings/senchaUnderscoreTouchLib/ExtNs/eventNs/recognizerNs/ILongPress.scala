...
object ILongPress {
  ...
  def apply(
    ...
    getMinDuration: js.Function0[scala.Double] = null,
    ...
    setMinDuration: js.Function1[/* minDuration */ js.UndefOr[scala.Double], scala.Unit] = null,
    ...
    if (getMinDuration != null) __obj.updateDynamic("getMinDuration")(getMinDuration)
    ...
    if (setMinDuration != null) __obj.updateDynamic("setMinDuration")(setMinDuration)
