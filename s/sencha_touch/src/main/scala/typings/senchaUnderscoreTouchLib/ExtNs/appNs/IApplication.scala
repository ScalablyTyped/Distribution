...
object IApplication {
  ...
  def apply(
    ...
    dispatch: (/* action */ js.UndefOr[IAction], /* addToHistory */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
    ...
    getProfiles: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    getRefs: () => _ = null,
    getRequires: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    ...
    redirectTo: /* url */ js.UndefOr[js.Any] => scala.Unit = null,
    refs: js.Any = null,
    ...
    setAppFolder: /* appFolder */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    setCurrentProfile: /* currentProfile */ js.UndefOr[IProfile] => scala.Unit = null,
    setHistory: /* history */ js.UndefOr[IHistory] => scala.Unit = null,
    setLaunch: /* launch */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setProfiles: /* profiles */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => scala.Unit = null,
    setRefs: /* refs */ js.UndefOr[js.Any] => scala.Unit = null,
    setRequires: /* requires */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => scala.Unit = null,
    setRouter: /* router */ js.UndefOr[IRouter] => scala.Unit = null,
    ...
    setThemeVariation: /* themeVariation */ js.UndefOr[js.Any] => scala.Unit = null,
    setThemeVariationPrefix: /* themeVariationPrefix */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setThemeVariationTransitionCls: /* themeVariationTransitionCls */ js.UndefOr[java.lang.String] => scala.Unit = null,
