...
trait IScrollPosition extends IDom {
  ...
  var getUseWrapper_IScrollPosition: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** [Method] Sets the value of useWrapper
  		* @param useWrapper Boolean The new value.
  		*/
  @JSName("setUseWrapper")
  var setUseWrapper_IScrollPosition: js.UndefOr[js.Function1[/* useWrapper */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
}
...
object IScrollPosition {
  ...
  def apply(
    ...
    getUseWrapper: js.Function0[scala.Boolean] = null,
    ...
    setUseWrapper: js.Function1[/* useWrapper */ js.UndefOr[scala.Boolean], scala.Unit] = null,
