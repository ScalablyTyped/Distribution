...
trait IEllipse extends IPath {
  ...
  var axisRotation: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (Number) */
  ...
  /** [Method] Update the path
  		...
  		*/
  @JSName("updatePath")
  var updatePath_IEllipse: js.UndefOr[
...
object IEllipse {
  ...
  def apply(
    ...
    attr: js.Any = null,
    axisRotation: scala.Int | scala.Double = null,
    ...
    hide: js.Function0[IEllipse] = null,
    ...
    show: js.Function0[IEllipse] = null,
