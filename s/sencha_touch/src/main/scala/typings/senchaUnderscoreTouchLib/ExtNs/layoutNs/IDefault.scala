...
object IDefault {
  ...
  def apply(
    ...
    onItemInnerStateChange: (/* item */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.IComponent], /* isInner */ js.UndefOr[scala.Boolean], /* destroying */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
