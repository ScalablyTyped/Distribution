...
object ISimpleListItem {
  ...
  def apply(
    ...
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => ISimpleListItem = null,
    getPlugins: () => _ = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ISimpleListItem = null,
    ...
    setDisclosure: /* disclosure */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setHeader: /* header */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ISimpleListItem = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISimpleListItem], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
