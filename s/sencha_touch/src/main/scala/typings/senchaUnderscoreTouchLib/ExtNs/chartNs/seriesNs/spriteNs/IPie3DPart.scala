...
object IPie3DPart {
  ...
  def apply(
    ...
    attr: js.Any = null,
    baseColor: js.Any = null,
    baseRotation: scala.Int | scala.Double = null,
    ...
    show: () => IPie3DPart = null,
    singleton: js.UndefOr[scala.Boolean] = js.undefined,
    startAngle: scala.Int | scala.Double = null,
    startRho: scala.Int | scala.Double = null,
    statics: js.Any = null,
    ...
    updatePath: /* path */ js.UndefOr[js.Any] => scala.Unit = null,
    updatePlainBBox: /* plain */ js.UndefOr[js.Any] => scala.Unit = null,
    updateTransformedBBox: /* transform */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    if (distortion != null) __obj.updateDynamic("distortion")(distortion.asInstanceOf[js.Any])
    ...
    if (updatePath != null) __obj.updateDynamic("updatePath")(js.Any.fromFunction1(updatePath))
