...
object IMessageBox {
  ...
  def apply(
    ...
    getButtons: () => _ = null,
    getDefaultTextHeight: () => scala.Double = null,
    getLayout: () => _ = null,
    getPrompt: () => _ = null,
    ...
    setButtons: /* buttons */ js.UndefOr[js.Any] => scala.Unit = null,
    setDefaultTextHeight: /* defaultTextHeight */ js.UndefOr[scala.Double] => scala.Unit = null,
    ...
    setPrompt: /* prompt */ js.UndefOr[js.Any] => scala.Unit = null,
