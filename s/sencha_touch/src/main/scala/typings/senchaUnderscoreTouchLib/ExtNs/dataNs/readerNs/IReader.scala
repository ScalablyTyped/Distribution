...
trait IReader
  ...
  var read: js.UndefOr[
    js.Function1[
      ...
      senchaUnderscoreTouchLib.ExtNs.dataNs.IResultSet
    ]
  ] = js.undefined
  /** [Method] Abstracts common functionality used by all Reader subclasses
  		...
  		*/
  var readRecords: js.UndefOr[
    js.Function1[/* data */ js.UndefOr[js.Any], senchaUnderscoreTouchLib.ExtNs.dataNs.IResultSet]
  ] = js.undefined
...
object IReader {
  ...
  def apply(
    ...
    rawData: js.Any = null,
    read: /* response */ js.UndefOr[js.Any] => senchaUnderscoreTouchLib.ExtNs.dataNs.IResultSet = null,
    readRecords: /* data */ js.UndefOr[js.Any] => senchaUnderscoreTouchLib.ExtNs.dataNs.IResultSet = null,
