...
object IComponent {
  ...
  def apply(
    ...
    getRenderTo: js.Function0[senchaUnderscoreTouchLib.ExtNs.IElement] = null,
    ...
    setRenderTo: js.Function1[/* renderTo */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.IElement], scala.Unit] = null,
