...
object IFloat {
  ...
  def apply(
    ...
    getAnimation: js.Function0[senchaUnderscoreTouchLib.ExtNs.fxNs.layoutNs.ICard] = null,
    ...
    onItemInnerStateChange: js.Function2[/* item */ js.UndefOr[js.Any], /* isInner */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (onItemInnerStateChange != null) __obj.updateDynamic("onItemInnerStateChange")(onItemInnerStateChange)
