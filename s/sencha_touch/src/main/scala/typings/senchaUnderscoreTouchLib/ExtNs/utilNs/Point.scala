...
object Point extends js.Object {
  ...
  /** [Method] Returns a new point from an object that has x and y properties if that object is not an instance of Ext util Point
  		...
  		*/
  def from(): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
  def from(`object`: js.Any): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
  /** [Method] Returns a new instance of Ext util Point based on the pageX  pageY values of the given event
  		* @param e Event The event.
  		* @returns Ext.util.Point
  		*/
  def fromEvent(): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
  def fromEvent(e: stdLib.Event): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
  /** [Method] Returns a new instance of Ext util Point based on the pageX  pageY values of the given touch
  		* @param touch Event
  		* @returns Ext.util.Point
  		*/
  def fromTouch(): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
  def fromTouch(touch: stdLib.Event): senchaUnderscoreTouchLib.ExtNs.utilNs.IPoint = js.native
