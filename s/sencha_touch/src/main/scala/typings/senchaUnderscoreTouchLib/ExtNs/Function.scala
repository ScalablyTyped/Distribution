...
object Function extends js.Object {
  ...
  def createBuffered(fn: js.Any, buffer: scala.Double): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: scala.Double, scope: js.Any): js.Any = js.native
  def createBuffered(fn: js.Any, buffer: scala.Double, scope: js.Any, args: senchaUnderscoreTouchLib.ExtNs.Array): js.Any = js.native
  ...
  def createDelayed(fn: js.Any, delay: scala.Double): js.Any = js.native
  def createDelayed(fn: js.Any, delay: scala.Double, scope: js.Any): js.Any = js.native
  def createDelayed(fn: js.Any, delay: scala.Double, scope: js.Any, args: senchaUnderscoreTouchLib.ExtNs.Array): js.Any = js.native
  def createDelayed(
    fn: js.Any,
    delay: scala.Double,
    scope: js.Any,
  ...
  def createDelegate(fn: js.Any, scope: js.Any, args: senchaUnderscoreTouchLib.ExtNs.Array): js.Any = js.native
  def createDelegate(fn: js.Any, scope: js.Any, args: senchaUnderscoreTouchLib.ExtNs.Array, appendArgs: js.Any): js.Any = js.native
  ...
  def createThrottled(fn: js.Any, interval: scala.Double): js.Any = js.native
  def createThrottled(fn: js.Any, interval: scala.Double, scope: js.Any): js.Any = js.native
