...
- senchaUnderscoreTouchLib.ExtNs.chartNs.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait ICartesian
...
object ICartesian {
  ...
  def apply(
    ...
    getIndexNearPoint: js.Function2[/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double], scala.Double] = null,
    ...
    hide: js.Function0[ICartesian] = null,
    ...
    show: js.Function0[ICartesian] = null,
