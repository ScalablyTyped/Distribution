...
object IIndexBar {
  ...
  def apply(
    ...
    isHorizontal: () => scala.Unit = null,
    isVertical: () => scala.Unit = null,
    ...
    setLetters: /* letters */ js.UndefOr[Array] => scala.Unit = null,
    setListPrefix: /* listPrefix */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    setRenderTo: /* renderTo */ js.UndefOr[IElement] => scala.Unit = null,
    ...
    showBy: (/* component */ js.UndefOr[IIndexBar], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
