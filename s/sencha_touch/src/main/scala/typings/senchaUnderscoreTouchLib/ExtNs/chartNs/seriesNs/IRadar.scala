...
object IRadar {
  ...
  def apply(
    ...
    getOffsetX: js.Function0[scala.Double] = null,
    getOffsetY: js.Function0[scala.Double] = null,
    ...
    getXAxis: js.Function0[_] = null,
    getXField: js.Function0[java.lang.String] = null,
    getYAxis: js.Function0[_] = null,
    getYField: js.Function0[java.lang.String] = null,
    ...
    setOffsetX: js.Function1[/* offsetX */ js.UndefOr[scala.Double], scala.Unit] = null,
    setOffsetY: js.Function1[/* offsetY */ js.UndefOr[scala.Double], scala.Unit] = null,
    ...
    setXAxis: js.Function1[/* xAxis */ js.UndefOr[js.Any], scala.Unit] = null,
    setXField: js.Function1[/* xField */ js.UndefOr[java.lang.String], scala.Unit] = null,
    setYAxis: js.Function1[/* yAxis */ js.UndefOr[js.Any], scala.Unit] = null,
    setYField: js.Function1[/* yField */ js.UndefOr[java.lang.String], scala.Unit] = null,
    ...
    if (getOffsetX != null) __obj.updateDynamic("getOffsetX")(getOffsetX)
    if (getOffsetY != null) __obj.updateDynamic("getOffsetY")(getOffsetY)
    ...
    if (getXAxis != null) __obj.updateDynamic("getXAxis")(getXAxis)
    if (getXField != null) __obj.updateDynamic("getXField")(getXField)
    if (getYAxis != null) __obj.updateDynamic("getYAxis")(getYAxis)
    if (getYField != null) __obj.updateDynamic("getYField")(getYField)
    ...
    if (setOffsetX != null) __obj.updateDynamic("setOffsetX")(setOffsetX)
    if (setOffsetY != null) __obj.updateDynamic("setOffsetY")(setOffsetY)
    ...
    if (setXAxis != null) __obj.updateDynamic("setXAxis")(setXAxis)
    if (setXField != null) __obj.updateDynamic("setXField")(setXField)
    if (setYAxis != null) __obj.updateDynamic("setYAxis")(setYAxis)
    if (setYField != null) __obj.updateDynamic("setYField")(setYField)
