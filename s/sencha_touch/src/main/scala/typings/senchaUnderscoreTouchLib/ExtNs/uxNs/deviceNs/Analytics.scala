...
object Analytics extends js.Object {
  ...
  /** [Method] Registers yur Google Analytics account
  		...
  		*/
  def registerAccount(): scala.Unit = js.native
  def registerAccount(accountID: java.lang.String): scala.Unit = js.native
  /** [Method] Sets the value of accountID
  		* @param accountID Object The new value.
  		*/
  def setAccountID(): scala.Unit = js.native
  def setAccountID(accountID: js.Any): scala.Unit = js.native
  ...
  /** [Method] Track an event in your application
  		* @param config Object
  		*/
  def trackEvent(): scala.Unit = js.native
  def trackEvent(config: js.Any): scala.Unit = js.native
  ...
  def trackPageview(config: java.lang.String): scala.Unit = js.native
}
