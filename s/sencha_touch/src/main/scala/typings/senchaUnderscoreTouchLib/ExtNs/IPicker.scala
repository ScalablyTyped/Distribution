...
trait IPicker extends ISheet {
  ...
  /** [Method] Sets the value of slots
  		...
  		*/
  var setSlots: js.UndefOr[js.Function1[/* slots */ js.UndefOr[Array], scala.Unit]] = js.undefined
...
object IPicker {
  ...
  def apply(
    ...
    getSlots: js.Function0[Array] = null,
    ...
    setSlots: js.Function1[/* slots */ js.UndefOr[Array], scala.Unit] = null,
