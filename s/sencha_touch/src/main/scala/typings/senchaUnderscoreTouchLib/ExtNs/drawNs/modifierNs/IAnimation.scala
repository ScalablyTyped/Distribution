...
object IAnimation {
  ...
  def apply(
    ...
    clearDurationOn: /* attrs */ js.UndefOr[js.Any] => scala.Unit = null,
    clearEasingOn: /* attrs */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setCustomDuration: /* customDuration */ js.UndefOr[js.Any] => scala.Unit = null,
    setCustomEasings: /* customEasings */ js.UndefOr[js.Any] => scala.Unit = null,
    setDuration: /* duration */ js.UndefOr[scala.Double] => scala.Unit = null,
    setDurationOn: (/* attrs */ js.UndefOr[js.Any], /* duration */ js.UndefOr[scala.Double]) => scala.Unit = null,
    setEasing: /* easing */ js.UndefOr[js.Any] => scala.Unit = null,
    setEasingOn: (/* attrs */ js.UndefOr[js.Any], /* easing */ js.UndefOr[java.lang.String]) => scala.Unit = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setNext: /* next */ js.UndefOr[IAnimation] => scala.Unit = null,
    setPrevious: /* previous */ js.UndefOr[IAnimation] => scala.Unit = null,
