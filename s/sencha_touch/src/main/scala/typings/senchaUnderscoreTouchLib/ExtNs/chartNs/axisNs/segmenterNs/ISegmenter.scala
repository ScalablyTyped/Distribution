...
object ISegmenter {
  @scala.inline
  def apply(
    add: (/* value */ js.UndefOr[js.Any], /* step */ js.UndefOr[scala.Double], /* unit */ js.UndefOr[js.Any]) => scala.Unit = null,
    alias: senchaUnderscoreTouchLib.ExtNs.Array = null,
    align: (/* value */ js.UndefOr[js.Any], /* step */ js.UndefOr[scala.Double], /* unit */ js.UndefOr[js.Any]) => _ = null,
