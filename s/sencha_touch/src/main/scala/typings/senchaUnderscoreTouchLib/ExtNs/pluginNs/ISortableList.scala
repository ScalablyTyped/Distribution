...
object ISortableList {
  ...
  def apply(
    ...
    setHandleSelector: /* handleSelector */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    showBy: (/* component */ js.UndefOr[ISortableList], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
