...
trait IEaseIn extends ILinear {
  /** [Method] Returns the value of exponent
  		* @returns Number
  		*/
  var getExponent: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Sets the value of exponent
  		* @param exponent Number The new value.
  		*/
  var setExponent: js.UndefOr[js.Function1[/* exponent */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
}
...
object IEaseIn {
  ...
  def apply(
    ...
    getExponent: js.Function0[scala.Double] = null,
    ...
    setExponent: js.Function1[/* exponent */ js.UndefOr[scala.Double], scala.Unit] = null,
    ...
    if (getExponent != null) __obj.updateDynamic("getExponent")(getExponent)
    ...
    if (setExponent != null) __obj.updateDynamic("setExponent")(setExponent)
