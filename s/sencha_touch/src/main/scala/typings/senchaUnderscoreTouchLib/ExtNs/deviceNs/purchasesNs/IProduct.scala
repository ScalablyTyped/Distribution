...
object IProduct {
  ...
  def apply(
    ...
    config: js.Any = null,
    copy: js.Function1[/* id */ js.UndefOr[java.lang.String], IProduct] = null,
    ...
    erase: js.Function2[/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], IProduct] = null,
    ...
    proxy: js.Any = null,
    purchase: js.Function1[/* config */ js.UndefOr[js.Any], scala.Unit] = null,
    raw: js.Any = null,
    ...
    save: js.Function2[/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], IProduct] = null,
    ...
    setConvertedData: js.Function1[/* data */ js.UndefOr[js.Any], IProduct] = null,
    setData: js.Function1[/* rawData */ js.UndefOr[js.Any], IProduct] = null,
