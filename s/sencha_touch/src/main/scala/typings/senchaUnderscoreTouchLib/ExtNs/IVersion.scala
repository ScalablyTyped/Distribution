...
object IVersion {
  @scala.inline
  def apply(
    deprecate: (/* packageName */ js.UndefOr[java.lang.String], /* since */ js.UndefOr[java.lang.String], /* closure */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    toArray: () => Array = null,
    toNumber: /* value */ js.UndefOr[scala.Double] => scala.Double = null
  ): IVersion = {
