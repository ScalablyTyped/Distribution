...
object ISurface {
  ...
  def apply(
    ...
    getGroup: /* id */ js.UndefOr[java.lang.String] => IGroup = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => ISurface = null,
    ...
    remove: (/* sprite */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.drawNs.spriteNs.ISprite], /* destroySprite */ js.UndefOr[scala.Boolean]) => scala.Unit = null,
    ...
    setItems: /* items */ js.UndefOr[IGroup] => scala.Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => ISurface = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISurface], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
    ...
    waitFor: /* surface */ js.UndefOr[ISurface] => scala.Unit = null,
    width: js.Any = null,
