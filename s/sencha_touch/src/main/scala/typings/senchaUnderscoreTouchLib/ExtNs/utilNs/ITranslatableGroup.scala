...
trait ITranslatableGroup
  ...
  /** [Method] Sets the value of activeIndex
  		...
  		*/
  var setActiveIndex: js.UndefOr[js.Function1[/* activeIndex */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
...
object ITranslatableGroup {
  ...
  def apply(
    ...
    setActiveIndex: js.Function1[/* activeIndex */ js.UndefOr[scala.Double], scala.Unit] = null,
    ...
    if (setActiveIndex != null) __obj.updateDynamic("setActiveIndex")(setActiveIndex)
