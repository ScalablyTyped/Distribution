...
trait IScroll extends IAbstract {
  /** [Method] Returns the value of duration
  		...
  		*/
  @JSName("getDuration")
  var getDuration_IScroll: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Sets the value of duration
  		* @param duration Number The new value.
  		*/
  @JSName("setDuration")
  var setDuration_IScroll: js.UndefOr[js.Function1[/* duration */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
}
