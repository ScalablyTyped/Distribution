...
object IFileEntry {
  ...
  def apply(
    ...
    read: /* config */ js.UndefOr[js.Any] => scala.Unit = null,
    remove: /* config */ js.UndefOr[js.Any] => scala.Unit = null,
    seek: /* config */ js.UndefOr[js.Any] => scala.Unit = null,
    self: senchaUnderscoreTouchLib.ExtNs.IClass = null,
    singleton: js.UndefOr[scala.Boolean] = js.undefined,
    statics: js.Any = null,
    truncate: /* config */ js.UndefOr[js.Any] => scala.Unit = null,
    uses: senchaUnderscoreTouchLib.ExtNs.Array = null,
    write: /* config */ js.UndefOr[js.Any] => scala.Unit = null
  ): IFileEntry = {
