...
object IRest {
  ...
  def apply(
    ...
    getActionMethods: js.Function0[_] = null,
    getApi: js.Function0[_] = null,
    getAppendId: js.Function0[scala.Boolean] = null,
    ...
    getFormat: js.Function0[java.lang.String] = null,
    ...
    setActionMethods: js.Function1[/* actionMethods */ js.UndefOr[js.Any], scala.Unit] = null,
    setApi: js.Function1[/* api */ js.UndefOr[js.Any], scala.Unit] = null,
    setAppendId: js.Function1[/* appendId */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    ...
    setFormat: js.Function1[/* format */ js.UndefOr[java.lang.String], scala.Unit] = null,
    ...
    if (getActionMethods != null) __obj.updateDynamic("getActionMethods")(getActionMethods)
    if (getApi != null) __obj.updateDynamic("getApi")(getApi)
    if (getAppendId != null) __obj.updateDynamic("getAppendId")(getAppendId)
    ...
    if (getFormat != null) __obj.updateDynamic("getFormat")(getFormat)
    ...
    if (setActionMethods != null) __obj.updateDynamic("setActionMethods")(setActionMethods)
    if (setApi != null) __obj.updateDynamic("setApi")(setApi)
    if (setAppendId != null) __obj.updateDynamic("setAppendId")(setAppendId)
    ...
    if (setFormat != null) __obj.updateDynamic("setFormat")(setFormat)
