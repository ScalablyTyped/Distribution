...
trait IRest extends IAjax {
  ...
  /** [Method] Returns the value of actionMethods
  		* @returns Object
  		*/
  var getActionMethods: js.UndefOr[js.Function0[_]] = js.undefined
  /** [Method] Returns the value of appendId
  		* @returns Boolean
  		*/
  var getAppendId: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** [Method] Returns the value of format
  		* @returns String
  		*/
  var getFormat: js.UndefOr[js.Function0[java.lang.String]] = js.undefined
  /** [Method] Sets the value of actionMethods
  		* @param actionMethods Object The new value.
  		*/
  var setActionMethods: js.UndefOr[js.Function1[/* actionMethods */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of appendId
  		* @param appendId Boolean The new value.
  		*/
  var setAppendId: js.UndefOr[js.Function1[/* appendId */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Method] Sets the value of format
  		* @param format String The new value.
  		*/
  var setFormat: js.UndefOr[js.Function1[/* format */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
}
...
object IRest {
  ...
  def apply(
    ...
    buildUrl: /* request */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IRequest] => java.lang.String = null,
    ...
    doRequest: (/* operation */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IOperation], /* callback */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => _ = null,
    ...
    getActionMethods: () => _ = null,
    getApi: () => _ = null,
    getAppendId: () => scala.Boolean = null,
    ...
    getListeners: () => _ = null,
    getMethod: /* request */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IRequest] => java.lang.String = null,
    getModel: () => _ = null,
    ...
    getUseDefaultXhrHeader: () => scala.Boolean = null,
    ...
    setActionMethods: /* actionMethods */ js.UndefOr[js.Any] => scala.Unit = null,
    setApi: /* api */ js.UndefOr[js.Any] => scala.Unit = null,
    setAppendId: /* appendId */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    ...
    setFormat: /* format */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    setUseDefaultXhrHeader: /* useDefaultXhrHeader */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    ...
    if (getActionMethods != null) __obj.updateDynamic("getActionMethods")(js.Any.fromFunction0(getActionMethods))
    if (getApi != null) __obj.updateDynamic("getApi")(js.Any.fromFunction0(getApi))
    if (getAppendId != null) __obj.updateDynamic("getAppendId")(js.Any.fromFunction0(getAppendId))
    ...
    if (getFormat != null) __obj.updateDynamic("getFormat")(js.Any.fromFunction0(getFormat))
    ...
    if (setActionMethods != null) __obj.updateDynamic("setActionMethods")(js.Any.fromFunction1(setActionMethods))
    if (setApi != null) __obj.updateDynamic("setApi")(js.Any.fromFunction1(setApi))
    if (setAppendId != null) __obj.updateDynamic("setAppendId")(js.Any.fromFunction1(setAppendId))
    ...
    if (setFormat != null) __obj.updateDynamic("setFormat")(js.Any.fromFunction1(setFormat))
