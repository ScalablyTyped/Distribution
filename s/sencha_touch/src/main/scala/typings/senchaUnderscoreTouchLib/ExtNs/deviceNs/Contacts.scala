...
object Contacts extends js.Object {
  ...
  /** [Method] Returns an Array of contact objects
  		...
  		*/
  def getContacts(): senchaUnderscoreTouchLib.ExtNs.Array = js.native
  def getContacts(config: js.Any): senchaUnderscoreTouchLib.ExtNs.Array = js.native
  ...
  /** [Method] Returns the value of includeImages
  		* @returns Boolean
  		*/
  def getIncludeImages(): scala.Boolean = js.native
  ...
  /** [Method] Sets the value of includeImages
  		...
  		*/
  def setIncludeImages(): scala.Unit = js.native
  def setIncludeImages(includeImages: scala.Boolean): scala.Unit = js.native
