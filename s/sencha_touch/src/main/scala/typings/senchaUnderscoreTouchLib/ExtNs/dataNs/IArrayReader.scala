...
trait IArrayReader
  extends senchaUnderscoreTouchLib.ExtNs.dataNs.readerNs.IJson {
  /** [Method] Sets the value of successProperty
  		* @param successProperty Object The new value.
  		*/
  @JSName("setSuccessProperty")
  var setSuccessProperty_IArrayReader: js.UndefOr[js.Function1[/* successProperty */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of totalProperty
  		* @param totalProperty Object The new value.
  		*/
  @JSName("setTotalProperty")
  var setTotalProperty_IArrayReader: js.UndefOr[js.Function1[/* totalProperty */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object IArrayReader {
  ...
  def apply(
    ...
    getUseSimpleAccessors: () => scala.Boolean = null,
    ...
    setSuccessProperty: /* successProperty */ js.UndefOr[js.Any] => scala.Unit = null,
    setTotalProperty: /* totalProperty */ js.UndefOr[js.Any] => scala.Unit = null,
    setUseSimpleAccessors: /* useSimpleAccessors */ js.UndefOr[scala.Boolean] => scala.Unit = null,
