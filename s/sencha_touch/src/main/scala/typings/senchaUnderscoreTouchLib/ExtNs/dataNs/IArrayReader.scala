...
object IArrayReader {
  ...
  def apply(
    ...
    setSuccessProperty: js.Function1[/* successProperty */ js.UndefOr[js.Any], scala.Unit] = null,
    setTotalProperty: js.Function1[/* totalProperty */ js.UndefOr[js.Any], scala.Unit] = null,
