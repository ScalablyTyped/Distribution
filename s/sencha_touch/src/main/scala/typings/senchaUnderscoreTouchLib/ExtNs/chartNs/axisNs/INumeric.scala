...
trait INumeric extends IAxis {
  ...
  /** [Method] Sets the value of aggregator
  		...
  		*/
  var setAggregator: js.UndefOr[js.Function1[/* aggregator */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of layout
  		* @param layout String The new value.
  		*/
  @JSName("setLayout")
  var setLayout_INumeric: js.UndefOr[js.Function1[/* layout */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of segmenter
  		* @param segmenter String The new value.
  		*/
  @JSName("setSegmenter")
  var setSegmenter_INumeric: js.UndefOr[js.Function1[/* segmenter */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
}
