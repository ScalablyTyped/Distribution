...
object Record extends js.Object {
  ...
  def load(id: scala.Double): scala.Unit = js.native
  def load(id: scala.Double, config: js.Any): scala.Unit = js.native
  def load(id: scala.Double, config: js.Any, scope: js.Any): scala.Unit = js.native
