...
object INestedList {
  ...
  def apply(
    ...
    onItemTap: (/* list */ js.UndefOr[IList], /* index */ js.UndefOr[scala.Double], /* target */ js.UndefOr[IElement], /* record */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IRecord], /* e */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.eventNs.IEvent]) => scala.Unit = null,
    ...
    setDetailCard: /* detailCard */ js.UndefOr[IComponent] => scala.Unit = null,
    setDetailContainer: /* detailContainer */ js.UndefOr[IContainer] => scala.Unit = null,
