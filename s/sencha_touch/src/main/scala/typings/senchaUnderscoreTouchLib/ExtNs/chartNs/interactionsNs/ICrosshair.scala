...
trait ICrosshair extends IAbstract {
  ...
  /** [Method] Placeholder method
  		...
  		*/
  @JSName("onGesture")
  var onGesture_ICrosshair: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of lines
  		...
  		*/
  var setLines: js.UndefOr[js.Function1[/* lines */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object ICrosshair {
  ...
  def apply(
    ...
    setLines: js.Function1[/* lines */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getLines != null) __obj.updateDynamic("getLines")(getLines)
    ...
    if (setLines != null) __obj.updateDynamic("setLines")(setLines)
