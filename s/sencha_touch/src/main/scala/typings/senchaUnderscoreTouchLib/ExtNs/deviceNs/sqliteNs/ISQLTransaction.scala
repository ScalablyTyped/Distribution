...
trait ISQLTransaction
  ...
  /** [Method] Executes an SQL statement
  		...
  		*/
  var executeSql: js.UndefOr[js.Function1[/* config */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object ISQLTransaction {
  ...
  def apply(
    ...
    executeSql: js.Function1[/* config */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (executeSql != null) __obj.updateDynamic("executeSql")(executeSql)
