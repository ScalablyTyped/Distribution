...
object IPieSlice {
  ...
  def apply(
    ...
    getListeners: () => _ = null,
    getParent: () => _ = null,
    getRendererIndex: () => scala.Double = null,
    ...
    setRendererIndex: /* rendererIndex */ js.UndefOr[scala.Double] => scala.Unit = null,
    ...
    updatePath: (/* path */ js.UndefOr[js.Any], /* attr */ js.UndefOr[js.Any]) => scala.Unit = null,
