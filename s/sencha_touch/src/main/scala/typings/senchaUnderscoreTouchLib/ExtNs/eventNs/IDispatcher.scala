...
object IDispatcher {
  ...
  def apply(
    ...
    getPublishers: js.Function0[_] = null,
    inheritableStatics: js.Any = null,
    initConfig: js.Function1[/* instanceConfig */ js.UndefOr[js.Any], _] = null,
    mixins: js.Any = null,
    platformConfig: js.Any = null,
    self: senchaUnderscoreTouchLib.ExtNs.IClass = null,
    setPublishers: js.Function1[/* publishers */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getPublishers != null) __obj.updateDynamic("getPublishers")(getPublishers)
    if (inheritableStatics != null) __obj.updateDynamic("inheritableStatics")(inheritableStatics)
    if (initConfig != null) __obj.updateDynamic("initConfig")(initConfig)
    if (mixins != null) __obj.updateDynamic("mixins")(mixins)
    if (platformConfig != null) __obj.updateDynamic("platformConfig")(platformConfig)
    if (self != null) __obj.updateDynamic("self")(self)
    if (setPublishers != null) __obj.updateDynamic("setPublishers")(setPublishers)
