...
trait IItemCollection
  extends senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection
...
object IItemCollection {
  ...
  def apply(
    ...
    collect: (/* property */ js.UndefOr[java.lang.String], /* root */ js.UndefOr[java.lang.String], /* allowNull */ js.UndefOr[scala.Boolean]) => Array = null,
    config: js.Any = null,
    ...
    filter: (/* property */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any], /* anyMatch */ js.UndefOr[scala.Boolean], /* caseSensitive */ js.UndefOr[scala.Boolean]) => senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
    ...
    getListeners: () => _ = null,
    getRange: (/* start */ js.UndefOr[scala.Double], /* end */ js.UndefOr[scala.Double]) => Array = null,
    ...
    removeAll: /* items */ js.UndefOr[Array] => senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
    ...
    sort: (/* sorters */ js.UndefOr[js.Any], /* direction */ js.UndefOr[java.lang.String], /* where */ js.UndefOr[java.lang.String], /* doSort */ js.UndefOr[scala.Boolean]) => Array = null,
    ...
    sorters: senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
    statics: js.Any = null,
