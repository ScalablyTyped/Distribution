...
object IErrors {
  ...
  def apply(
    ...
    clone: () => senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
    config: js.Any = null,
    ...
    filterBy: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
    ...
    getByField: /* fieldName */ js.UndefOr[java.lang.String] => senchaUnderscoreTouchLib.ExtNs.Array = null,
    ...
    removeAll: /* items */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => senchaUnderscoreTouchLib.ExtNs.utilNs.IMixedCollection = null,
