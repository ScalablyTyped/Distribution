...
object Draw extends js.Object {
  ...
  def degrees(radian: scala.Double): scala.Double = js.native
  /** [Method]  */
  ...
  /** [Method]
  		...
  		* @returns Boolean
  		*/
  def isBBoxIntersect(): scala.Boolean = js.native
  def isBBoxIntersect(bbox1: js.Any): scala.Boolean = js.native
  def isBBoxIntersect(bbox1: js.Any, bbox2: js.Any): scala.Boolean = js.native
  def isBBoxIntersect(bbox1: js.Any, bbox2: js.Any, padding: scala.Double): scala.Boolean = js.native
  /** [Method] Converting degrees to radians
  		* @param degrees Number
  		* @returns Number
  		*/
  def rad(): scala.Double = js.native
  def rad(degrees: scala.Double): scala.Double = js.native
  ...
  /** [Method] Natural cubic spline interpolation
  		...
  		*/
  def spline(): scala.Unit = js.native
  def spline(points: senchaUnderscoreTouchLib.ExtNs.Array): scala.Unit = js.native
