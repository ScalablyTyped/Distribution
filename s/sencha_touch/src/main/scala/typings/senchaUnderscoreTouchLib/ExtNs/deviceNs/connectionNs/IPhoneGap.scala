...
object IPhoneGap {
  ...
  def apply(
    ...
    getOnline: js.Function0[scala.Boolean] = null,
    getType: js.Function0[java.lang.String] = null,
    hasListener: js.Function1[/* eventName */ js.UndefOr[java.lang.String], scala.Boolean] = null,
    inheritableStatics: js.Any = null,
    initConfig: js.Function1[/* instanceConfig */ js.UndefOr[js.Any], _] = null,
    isOnline: js.Function0[scala.Boolean] = null,
    ...
    setOnline: js.Function1[/* online */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    setType: js.Function1[/* type */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getOnline != null) __obj.updateDynamic("getOnline")(getOnline)
    if (getType != null) __obj.updateDynamic("getType")(getType)
    if (hasListener != null) __obj.updateDynamic("hasListener")(hasListener)
    if (inheritableStatics != null) __obj.updateDynamic("inheritableStatics")(inheritableStatics)
    if (initConfig != null) __obj.updateDynamic("initConfig")(initConfig)
    if (isOnline != null) __obj.updateDynamic("isOnline")(isOnline)
    ...
    if (setOnline != null) __obj.updateDynamic("setOnline")(setOnline)
