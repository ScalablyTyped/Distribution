...
object IBounce {
  ...
  def apply(
    ...
    getSpringTension: js.Function0[scala.Double] = null,
    ...
    setSpringTension: js.Function1[/* springTension */ js.UndefOr[scala.Double], scala.Unit] = null,
    ...
    if (getSpringTension != null) __obj.updateDynamic("getSpringTension")(getSpringTension)
    ...
    if (setSpringTension != null) __obj.updateDynamic("setSpringTension")(setSpringTension)
