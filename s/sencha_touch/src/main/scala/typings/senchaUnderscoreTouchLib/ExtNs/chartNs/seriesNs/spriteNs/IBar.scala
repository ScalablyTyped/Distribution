...
object IBar {
  ...
  def apply(
    ...
    attr: js.Any = null,
    binarySearch: js.Function1[/* key */ js.UndefOr[java.lang.String], _] = null,
    ...
    getIndexNearPoint: js.Function2[/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any], scala.Double] = null,
    ...
    hide: js.Function0[IBar] = null,
    inGroupGapWidth: scala.Int | scala.Double = null,
    ...
    maxBarWidth: scala.Int | scala.Double = null,
    minBarWidth: scala.Int | scala.Double = null,
    minGapWidth: scala.Int | scala.Double = null,
    ...
    if (binarySearch != null) __obj.updateDynamic("binarySearch")(binarySearch)
    ...
    if (getIndexNearPoint != null) __obj.updateDynamic("getIndexNearPoint")(getIndexNearPoint)
    ...
    if (inGroupGapWidth != null) __obj.updateDynamic("inGroupGapWidth")(inGroupGapWidth.asInstanceOf[js.Any])
    ...
    if (maxBarWidth != null) __obj.updateDynamic("maxBarWidth")(maxBarWidth.asInstanceOf[js.Any])
    if (minBarWidth != null) __obj.updateDynamic("minBarWidth")(minBarWidth.asInstanceOf[js.Any])
    if (minGapWidth != null) __obj.updateDynamic("minGapWidth")(minGapWidth.asInstanceOf[js.Any])
    ...
    if (renderClipped != null) __obj.updateDynamic("renderClipped")(renderClipped)
