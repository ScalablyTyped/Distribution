...
object IBar {
  ...
  def apply(
    ...
    renderClipped: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[js.Any]) => scala.Unit = null,
    ...
    if (renderClipped != null) __obj.updateDynamic("renderClipped")(js.Any.fromFunction3(renderClipped))
