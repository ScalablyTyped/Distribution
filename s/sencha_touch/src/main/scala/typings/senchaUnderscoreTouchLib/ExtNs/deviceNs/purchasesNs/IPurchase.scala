...
object IPurchase {
  ...
  def apply(
    ...
    complete: /* config */ js.UndefOr[js.Any] => scala.Unit = null,
    config: js.Any = null,
    ...
    join: /* store */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IStore] => scala.Unit = null,
    ...
    unjoin: /* store */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.dataNs.IStore] => scala.Unit = null,
    useCache: js.UndefOr[scala.Boolean] = js.undefined,
    uses: senchaUnderscoreTouchLib.ExtNs.Array = null,
    validate: () => senchaUnderscoreTouchLib.ExtNs.dataNs.IErrors = null,
