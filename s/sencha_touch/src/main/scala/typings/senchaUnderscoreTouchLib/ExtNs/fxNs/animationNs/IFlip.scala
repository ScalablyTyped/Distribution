...
trait IFlip extends IAbstract {
  ...
  /** [Method] Returns the value of half
  		* @returns Boolean
  		*/
  var getHalf: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  ...
  /** [Method] Sets the value of half
  		...
  		*/
  var setHalf: js.UndefOr[js.Function1[/* half */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Method] Sets the value of out
  		* @param out Object The new value.
  		*/
  var setOut: js.UndefOr[js.Function1[/* out */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object IFlip {
  ...
  def apply(
    ...
    getHalf: js.Function0[scala.Boolean] = null,
    ...
    setHalf: js.Function1[/* half */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    ...
    setOut: js.Function1[/* out */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getHalf != null) __obj.updateDynamic("getHalf")(getHalf)
    ...
    if (setHalf != null) __obj.updateDynamic("setHalf")(setHalf)
