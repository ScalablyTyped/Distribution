...
trait IScrollPosition extends IAbstract {
  ...
  /** [Method] Sets the value of cls
  		...
  		*/
  @JSName("setCls")
  var setCls_IScrollPosition: js.UndefOr[js.Function1[/* cls */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
}
...
object IScrollPosition {
  ...
  def apply(
    ...
    getAutoHide: () => scala.Boolean = null,
    getAxis: () => java.lang.String = null,
    getBarCls: () => java.lang.String = null,
    ...
    getMaxWidth: () => _ = null,
    getMinHeight: () => _ = null,
    getMinLength: () => scala.Double = null,
    getMinWidth: () => _ = null,
    getPadding: () => _ = null,
    getParent: () => IScrollPosition = null,
    getPlugins: () => _ = null,
    getRatio: () => scala.Double = null,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => IScrollPosition = null,
    ...
    setAutoHide: /* autoHide */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setAxis: /* axis */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setBarCls: /* barCls */ js.UndefOr[java.lang.String] => scala.Unit = null,
    ...
    setLength: /* length */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setMinLength: /* minLength */ js.UndefOr[scala.Double] => scala.Unit = null,
    ...
    setRatio: /* ratio */ js.UndefOr[scala.Double] => scala.Unit = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => IScrollPosition = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IScrollPosition], /* alignment */ js.UndefOr[java.lang.String]) => scala.Unit = null,
    ...
    if (getAutoHide != null) __obj.updateDynamic("getAutoHide")(js.Any.fromFunction0(getAutoHide))
    if (getAxis != null) __obj.updateDynamic("getAxis")(js.Any.fromFunction0(getAxis))
    if (getBarCls != null) __obj.updateDynamic("getBarCls")(js.Any.fromFunction0(getBarCls))
    ...
    if (getMinLength != null) __obj.updateDynamic("getMinLength")(js.Any.fromFunction0(getMinLength))
    ...
    if (getRatio != null) __obj.updateDynamic("getRatio")(js.Any.fromFunction0(getRatio))
    ...
    if (setAutoHide != null) __obj.updateDynamic("setAutoHide")(js.Any.fromFunction1(setAutoHide))
    if (setAxis != null) __obj.updateDynamic("setAxis")(js.Any.fromFunction1(setAxis))
    if (setBarCls != null) __obj.updateDynamic("setBarCls")(js.Any.fromFunction1(setBarCls))
    ...
    if (setLength != null) __obj.updateDynamic("setLength")(js.Any.fromFunction1(setLength))
    ...
    if (setMinLength != null) __obj.updateDynamic("setMinLength")(js.Any.fromFunction1(setMinLength))
    ...
    if (setRatio != null) __obj.updateDynamic("setRatio")(js.Any.fromFunction1(setRatio))
