...
object IMarkers {
  ...
  def apply(
    ...
    clear: js.Function1[/* category */ js.UndefOr[java.lang.String], scala.Unit] = null,
    clearListeners: js.Function0[scala.Unit] = null,
    config: js.Any = null,
    createInstance: js.Function4[
    ...
    setTemplate: js.Function1[/* template */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    show: js.Function0[IMarkers] = null,
    ...
    if (createInstance != null) __obj.updateDynamic("createInstance")(createInstance)
    ...
    if (getBBoxFor != null) __obj.updateDynamic("getBBoxFor")(getBBoxFor)
    ...
    if (getMarkerBBoxFor != null) __obj.updateDynamic("getMarkerBBoxFor")(getMarkerBBoxFor)
    if (getParent != null) __obj.updateDynamic("getParent")(getParent)
    if (getTemplate != null) __obj.updateDynamic("getTemplate")(getTemplate)
    ...
    if (putMarkerFor != null) __obj.updateDynamic("putMarkerFor")(putMarkerFor)
    ...
    if (setAttributesFor != null) __obj.updateDynamic("setAttributesFor")(setAttributesFor)
    ...
    if (setTemplate != null) __obj.updateDynamic("setTemplate")(setTemplate)
