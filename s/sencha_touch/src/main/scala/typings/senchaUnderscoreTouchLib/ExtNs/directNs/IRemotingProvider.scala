...
object IRemotingProvider {
  ...
  def apply(
    ...
    getListeners: () => _ = null,
    getMaxRetries: () => scala.Double = null,
    getNamespace: () => _ = null,
    ...
    setActions: /* actions */ js.UndefOr[js.Any] => scala.Unit = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[js.Any] => scala.Unit = null,
    setEnableBuffer: /* enableBuffer */ js.UndefOr[js.Any] => scala.Unit = null,
    setEnableUrlEncode: /* enableUrlEncode */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setId: /* id */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setMaxRetries: /* maxRetries */ js.UndefOr[scala.Double] => scala.Unit = null,
    setNamespace: /* namespace */ js.UndefOr[js.Any] => scala.Unit = null,
