...
object Twitter extends js.Object {
  ...
  /** [Method] Pops up a Twitter compose sheet view with your specified tweet
  		...
  		*/
  def compose(): scala.Unit = js.native
  def compose(config: js.Any): scala.Unit = js.native
  /** [Method]  */
  ...
  /** [Method] Gets Tweets from Twitter Mentions
  		* @param config Object An object which contains the following config options:
  		*/
  def getMentions(): scala.Unit = js.native
  def getMentions(config: js.Any): scala.Unit = js.native
  /** [Method] Gets Tweets from Twitter Timeline
  		* @param config Object An object which contains the following config options:
  		*/
  def getPublicTimeline(): scala.Unit = js.native
  def getPublicTimeline(config: js.Any): scala.Unit = js.native
  /** [Method] Gets a specific Twitter user info
  		* @param config Object An object which contains the following config options:
  		*/
  def getTwitterRequest(): scala.Unit = js.native
  def getTwitterRequest(config: js.Any): scala.Unit = js.native
  /** [Method] Gets a specific Twitter user info
  		* @param config Object An object which contains the following config options:
  		*/
  def getTwitterUsername(): scala.Unit = js.native
  def getTwitterUsername(config: js.Any): scala.Unit = js.native
