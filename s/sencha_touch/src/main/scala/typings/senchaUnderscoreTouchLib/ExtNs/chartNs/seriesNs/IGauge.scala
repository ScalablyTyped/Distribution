...
trait IGauge extends ISeries {
  ...
  var donut: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (String) */
  ...
  /** [Method] Returns the value of donut
  		* @returns Number
  		*/
  var getDonut: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  ...
  /** [Method] Returns the value of needle
  		* @returns Boolean
  		*/
  var getNeedle: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** [Method] Returns the value of needleLength
  		* @returns Number
  		*/
  var getNeedleLength: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Returns the value of needleLengthRatio
  		* @returns Number
  		*/
  var getNeedleLengthRatio: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Returns the value of needleWidth
  		* @returns Number
  		*/
  var getNeedleWidth: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  ...
  /** [Method] Returns the value of sectors
  		* @returns Array
  		*/
  var getSectors: js.UndefOr[js.Function0[senchaUnderscoreTouchLib.ExtNs.Array]] = js.undefined
  ...
  /** [Method] Returns the value of value
  		* @returns Number
  		*/
  var getValue: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Returns the value of wholeDisk
  		* @returns Boolean
  		*/
  var getWholeDisk: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** [Config Option] (Number) */
  ...
  /** [Config Option] (Number) */
  var needleLength: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (Number) */
  var needleLengthRatio: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (Number) */
  var needleWidth: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (Array) */
  var sectors: js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] = js.undefined
  /** [Method] Sets the value of angleField
  		* @param angleField String The new value.
  		*/
  var setAngleField: js.UndefOr[js.Function1[/* angleField */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of donut
  		...
  		*/
  var setDonut: js.UndefOr[js.Function1[/* donut */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of needle
  		...
  		*/
  var setNeedle: js.UndefOr[js.Function1[/* needle */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Method] Sets the value of needleLength
  		* @param needleLength Number The new value.
  		*/
  var setNeedleLength: js.UndefOr[js.Function1[/* needleLength */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
  /** [Method] Sets the value of needleLengthRatio
  		* @param needleLengthRatio Number The new value.
  		*/
  var setNeedleLengthRatio: js.UndefOr[js.Function1[/* needleLengthRatio */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
  /** [Method] Sets the value of needleWidth
  		* @param needleWidth Number The new value.
  		*/
  var setNeedleWidth: js.UndefOr[js.Function1[/* needleWidth */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of sectors
  		...
  		*/
  var setSectors: js.UndefOr[
    js.Function1[/* sectors */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array], scala.Unit]
  ] = js.undefined
  /** [Method] Sets the value of totalAngle
  		* @param totalAngle Object The new value.
  		*/
  var setTotalAngle: js.UndefOr[js.Function1[/* totalAngle */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of value
  		* @param value Number The new value.
  		*/
  var setValue: js.UndefOr[js.Function1[/* value */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
  /** [Method] Sets the value of wholeDisk
  		* @param wholeDisk Boolean The new value.
  		*/
  var setWholeDisk: js.UndefOr[js.Function1[/* wholeDisk */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Config Option] (Number) */
  var value: js.UndefOr[scala.Double] = js.undefined
  /** [Config Option] (Boolean) */
  var wholeDisk: js.UndefOr[scala.Boolean] = js.undefined
}
