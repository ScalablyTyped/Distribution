...
trait IPositionMap
  ...
  /** [Method] Returns the value of minimumHeight
  		* @returns Number
  		*/
  var getMinimumHeight: js.UndefOr[js.Function0[scala.Double]] = js.undefined
  /** [Method] Sets the value of minimumHeight
  		* @param minimumHeight Number The new value.
  		*/
  var setMinimumHeight: js.UndefOr[js.Function1[/* minimumHeight */ js.UndefOr[scala.Double], scala.Unit]] = js.undefined
}
...
object IPositionMap {
  ...
  def apply(
    ...
    getMinimumHeight: () => scala.Double = null,
    inheritableStatics: js.Any = null,
    initConfig: /* instanceConfig */ js.UndefOr[js.Any] => _ = null,
    mixins: js.Any = null,
    platformConfig: js.Any = null,
    self: senchaUnderscoreTouchLib.ExtNs.IClass = null,
    setMinimumHeight: /* minimumHeight */ js.UndefOr[scala.Double] => scala.Unit = null,
