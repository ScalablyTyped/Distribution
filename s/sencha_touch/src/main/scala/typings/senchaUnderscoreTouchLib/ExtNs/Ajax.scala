...
object Ajax extends js.Object {
  ...
  /** [Method] Returns the value of async
  		* @returns Boolean
  		*/
  def getAsync(): scala.Boolean = js.native
  /** [Method] Returns the value of autoAbort
  		* @returns Boolean
  		*/
  def getAutoAbort(): scala.Boolean = js.native
  ...
  /** [Method] Returns the value of disableCaching
  		* @returns Boolean
  		*/
  def getDisableCaching(): scala.Boolean = js.native
  ...
  /** [Method] Returns the value of useDefaultHeader
  		* @returns Boolean
  		*/
  def getUseDefaultHeader(): scala.Boolean = js.native
  /** [Method] Returns the value of useDefaultXhrHeader
  		* @returns Boolean
  		*/
  def getUseDefaultXhrHeader(): scala.Boolean = js.native
  ...
  def parseStatus(status: scala.Double, xhr: stdLib.XMLHttpRequest): js.Any = js.native
  ...
  /** [Method] Sets the value of async
  		...
  		*/
  def setAsync(): scala.Unit = js.native
  def setAsync(async: scala.Boolean): scala.Unit = js.native
  /** [Method] Sets the value of autoAbort
  		* @param autoAbort Boolean The new value.
  		*/
  def setAutoAbort(): scala.Unit = js.native
  def setAutoAbort(autoAbort: scala.Boolean): scala.Unit = js.native
  ...
  /** [Method] Sets the value of defaultHeaders
  		...
  		*/
  def setDefaultHeaders(): scala.Unit = js.native
  def setDefaultHeaders(defaultHeaders: js.Any): scala.Unit = js.native
  /** [Method] Sets the value of defaultPostHeader
  		* @param defaultPostHeader String The new value.
  		*/
  def setDefaultPostHeader(): scala.Unit = js.native
  def setDefaultPostHeader(defaultPostHeader: java.lang.String): scala.Unit = js.native
  /** [Method] Sets the value of defaultXhrHeader
  		* @param defaultXhrHeader String The new value.
  		*/
  def setDefaultXhrHeader(): scala.Unit = js.native
  def setDefaultXhrHeader(defaultXhrHeader: java.lang.String): scala.Unit = js.native
  /** [Method] Sets the value of disableCaching
  		* @param disableCaching Boolean The new value.
  		*/
  def setDisableCaching(): scala.Unit = js.native
  def setDisableCaching(disableCaching: scala.Boolean): scala.Unit = js.native
  /** [Method] Sets the value of disableCachingParam
  		* @param disableCachingParam String The new value.
  		*/
  def setDisableCachingParam(): scala.Unit = js.native
  def setDisableCachingParam(disableCachingParam: java.lang.String): scala.Unit = js.native
  /** [Method] Sets the value of extraParams
  		* @param extraParams Object The new value.
  		*/
  def setExtraParams(): scala.Unit = js.native
  def setExtraParams(extraParams: js.Any): scala.Unit = js.native
  ...
  /** [Method] Sets the value of method
  		...
  		*/
  def setMethod(): scala.Unit = js.native
  def setMethod(method: java.lang.String): scala.Unit = js.native
  ...
  /** [Method] Sets the value of password
  		...
  		*/
  def setPassword(): scala.Unit = js.native
  ...
  /** [Method] Sets the value of useDefaultHeader
  		...
  		*/
  def setUseDefaultHeader(): scala.Unit = js.native
  def setUseDefaultHeader(useDefaultHeader: scala.Boolean): scala.Unit = js.native
  /** [Method] Sets the value of useDefaultXhrHeader
  		* @param useDefaultXhrHeader Boolean The new value.
  		*/
  def setUseDefaultXhrHeader(): scala.Unit = js.native
  def setUseDefaultXhrHeader(useDefaultXhrHeader: scala.Boolean): scala.Unit = js.native
  /** [Method] Sets the value of username
  		* @param username String The new value.
  		*/
  def setUsername(): scala.Unit = js.native
