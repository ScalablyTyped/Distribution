...
object IInfinite {
  ...
  def apply(
    ...
    setIndicator: /* indicator */ js.UndefOr[js.Any] => scala.Unit = null,
    setInnerItemConfig: /* innerItemConfig */ js.UndefOr[js.Any] => scala.Unit = null,
    setMaxItemIndex: /* maxItemIndex */ js.UndefOr[js.Any] => scala.Unit = null
  ): IInfinite = {
