...
trait ICrossZoom extends IAbstract {
  ...
  /** [Method] Placeholder method
  		...
  		*/
  @JSName("onGesture")
  var onGesture_ICrossZoom: js.UndefOr[js.Function1[/* e */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of undoButton
  		...
  		*/
  var setUndoButton: js.UndefOr[js.Function1[/* undoButton */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object ICrossZoom {
  ...
  def apply(
    ...
    getUndoButton: js.Function0[_] = null,
    ...
    setUndoButton: js.Function1[/* undoButton */ js.UndefOr[js.Any], scala.Unit] = null,
    ...
    if (getUndoButton != null) __obj.updateDynamic("getUndoButton")(getUndoButton)
    ...
    if (setUndoButton != null) __obj.updateDynamic("setUndoButton")(setUndoButton)
