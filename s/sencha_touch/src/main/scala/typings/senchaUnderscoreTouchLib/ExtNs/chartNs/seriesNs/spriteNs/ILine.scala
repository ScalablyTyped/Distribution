...
trait ILine extends IAggregative {
  ...
  var fillArea: js.UndefOr[scala.Boolean] = js.undefined
  /** [Config Option] (Boolean) */
  var preciseStroke: js.UndefOr[scala.Boolean] = js.undefined
  /** [Config Option] (Boolean) */
...
object ILine {
  ...
  def apply(
    ...
    fillArea: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    getId: () => _ = null,
    getIndexNearPoint: (/* x */ js.UndefOr[scala.Double], /* y */ js.UndefOr[scala.Double]) => scala.Double = null,
    ...
    preciseStroke: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    renderClipped: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[js.Any], /* region */ js.UndefOr[js.Any]) => scala.Unit = null,
