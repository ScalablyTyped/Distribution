...
object IVBox {
  ...
  def apply(
    ...
    setItemFlex: (/* item */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.IComponent], /* flex */ js.UndefOr[scala.Double]) => scala.Unit = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setOrient: /* orient */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setPack: /* pack */ js.UndefOr[java.lang.String] => scala.Unit = null,
