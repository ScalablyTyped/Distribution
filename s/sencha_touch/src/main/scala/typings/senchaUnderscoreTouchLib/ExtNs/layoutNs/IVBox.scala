...
object IVBox {
  ...
  def apply(
    ...
    getOrient: js.Function0[java.lang.String] = null,
    getPack: js.Function0[java.lang.String] = null,
    ...
    setOrient: js.Function1[/* orient */ js.UndefOr[java.lang.String], scala.Unit] = null,
    setPack: js.Function1[/* pack */ js.UndefOr[java.lang.String], scala.Unit] = null,
    ...
    if (getOrient != null) __obj.updateDynamic("getOrient")(getOrient)
    if (getPack != null) __obj.updateDynamic("getPack")(getPack)
    ...
    if (setItemFlex != null) __obj.updateDynamic("setItemFlex")(setItemFlex)
    if (setListeners != null) __obj.updateDynamic("setListeners")(setListeners)
    if (setOrient != null) __obj.updateDynamic("setOrient")(setOrient)
    if (setPack != null) __obj.updateDynamic("setPack")(setPack)
