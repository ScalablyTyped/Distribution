...
object ICordova {
  ...
  def apply(
    ...
    getContacts: /* config */ js.UndefOr[js.Any] => senchaUnderscoreTouchLib.ExtNs.Array = null,
    getId: () => _ = null,
    getIncludeImages: () => scala.Boolean = null,
    ...
    setIncludeImages: /* includeImages */ js.UndefOr[scala.Boolean] => scala.Unit = null,
