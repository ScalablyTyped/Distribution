...
trait ICordova extends IAbstract {
  ...
  var trackPageview_ICordova: js.UndefOr[js.Function1[/* page */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
...
object ICordova {
  ...
  def apply(
    ...
    trackPageview: js.Function1[/* page */ js.UndefOr[js.Any], scala.Unit] = null,
