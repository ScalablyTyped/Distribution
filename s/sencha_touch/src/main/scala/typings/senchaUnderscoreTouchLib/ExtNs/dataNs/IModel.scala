...
trait IModel
  ...
  /** [Method] This sets the data directly without converting and applying default values
  		...
  		*/
  var setConvertedData: js.UndefOr[js.Function1[/* data */ js.UndefOr[js.Any], this.type]] = js.undefined
  /** [Method] This method is used to set the data for this Record instance
  		* @param rawData Object
  		* @returns Ext.data.Model This record.
  		*/
  var setData: js.UndefOr[js.Function1[/* rawData */ js.UndefOr[js.Any], this.type]] = js.undefined
...
object IModel {
  ...
  def apply(
    ...
    commit: /* silent */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    config: js.Any = null,
    ...
    endEdit: (/* silent */ js.UndefOr[scala.Boolean], /* modifiedFieldNames */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array]) => scala.Unit = null,
    ...
    getAssociations: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    getBelongsTo: () => _ = null,
    ...
    getIsErased: () => scala.Unit = null,
    getListeners: () => _ = null,
    getProxy: () => _ = null,
    getUseCache: () => scala.Boolean = null,
    getValidations: () => senchaUnderscoreTouchLib.ExtNs.Array = null,
    ...
    set: (/* fieldName */ js.UndefOr[js.Any], /* value */ js.UndefOr[js.Any]) => scala.Unit = null,
    setAssociations: /* associations */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => scala.Unit = null,
    setBelongsTo: /* belongsTo */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setFields: /* fields */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => _ = null,
    setHasMany: /* hasMany */ js.UndefOr[js.Any] => scala.Unit = null,
    setHasOne: /* hasOne */ js.UndefOr[js.Any] => scala.Unit = null,
    setId: /* id */ js.UndefOr[js.Any] => scala.Unit = null,
    setIdProperty: /* idProperty */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setIdentifier: /* identifier */ js.UndefOr[js.Any] => scala.Unit = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setProxy: /* proxy */ js.UndefOr[js.Any] => scala.Unit = null,
    setUseCache: /* useCache */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setValidations: /* validations */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] => scala.Unit = null,
