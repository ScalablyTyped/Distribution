...
trait IField
  ...
  /** [Method] Returns the value of allowNull
  		* @returns Boolean
  		*/
  var getAllowNull: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  ...
  /** [Method] Returns the value of persist
  		* @returns Boolean
  		*/
  var getPersist: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  ...
  /** [Method] Sets the value of allowNull
  		...
  		*/
  var setAllowNull: js.UndefOr[js.Function1[/* allowNull */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Method] Sets the value of bubbleEvents
  		* @param bubbleEvents String The new value.
  		*/
  var setBubbleEvents: js.UndefOr[js.Function1[/* bubbleEvents */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of convert
  		* @param convert Function The new value.
  		*/
  var setConvert: js.UndefOr[js.Function1[/* convert */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of decode
  		...
  		*/
  var setDecode: js.UndefOr[js.Function1[/* decode */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of defaultValue
  		* @param defaultValue Object The new value.
  		*/
  var setDefaultValue: js.UndefOr[js.Function1[/* defaultValue */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of encode
  		* @param encode Object The new value.
  		*/
  var setEncode: js.UndefOr[js.Function1[/* encode */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of mapping
  		* @param mapping String/Number The new value.
  		*/
  var setMapping: js.UndefOr[js.Function1[/* mapping */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  ...
  /** [Method] Sets the value of persist
  		...
  		*/
  var setPersist: js.UndefOr[js.Function1[/* persist */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
  /** [Method] Sets the value of sortDir
  		* @param sortDir String The new value.
  		*/
  var setSortDir: js.UndefOr[js.Function1[/* sortDir */ js.UndefOr[java.lang.String], scala.Unit]] = js.undefined
  /** [Method] Sets the value of sortType
  		* @param sortType Function The new value.
  		*/
  var setSortType: js.UndefOr[js.Function1[/* sortType */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
...
object IField {
  ...
  def apply(
    ...
    getAllowNull: () => scala.Boolean = null,
    ...
    setAllowNull: /* allowNull */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setConvert: /* convert */ js.UndefOr[js.Any] => scala.Unit = null,
    setDateFormat: /* dateFormat */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setDecode: /* decode */ js.UndefOr[js.Any] => scala.Unit = null,
    setDefaultValue: /* defaultValue */ js.UndefOr[js.Any] => scala.Unit = null,
    setEncode: /* encode */ js.UndefOr[js.Any] => scala.Unit = null,
    setMapping: /* mapping */ js.UndefOr[js.Any] => scala.Unit = null,
    setName: /* name */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setPersist: /* persist */ js.UndefOr[scala.Boolean] => scala.Unit = null,
    setSortDir: /* sortDir */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setSortType: /* sortType */ js.UndefOr[js.Any] => scala.Unit = null,
