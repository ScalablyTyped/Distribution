...
trait IStackedCartesian extends ICartesian {
  /** [Method] Returns the value of stacked
  		* @returns Boolean
  		*/
  var getStacked: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** [Config Option] (Array) */
  @JSName("hidden")
  var hidden_IStackedCartesian: js.UndefOr[senchaUnderscoreTouchLib.ExtNs.Array] = js.undefined
  /** [Method] Sets the value of hidden
  		* @param hidden Array The new value.
  		*/
  @JSName("setHidden")
  var setHidden_IStackedCartesian: js.UndefOr[
  ...
  /** [Method] Sets the value of stacked
  		...
  		*/
  var setStacked: js.UndefOr[js.Function1[/* stacked */ js.UndefOr[scala.Boolean], scala.Unit]] = js.undefined
...
object IStackedCartesian {
  ...
  def apply(
    ...
    getStacked: js.Function0[scala.Boolean] = null,
    ...
    setStacked: js.Function1[/* stacked */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    ...
    if (getStacked != null) __obj.updateDynamic("getStacked")(getStacked)
    ...
    if (setStacked != null) __obj.updateDynamic("setStacked")(setStacked)
