...
object IMap {
  ...
  def apply(
    ...
    getGeo: () => senchaUnderscoreTouchLib.ExtNs.utilNs.IGeolocation = null,
    getMap: () => _ = null,
    ...
    setGeo: /* geo */ js.UndefOr[senchaUnderscoreTouchLib.ExtNs.utilNs.IGeolocation] => scala.Unit = null,
    setMap: /* map */ js.UndefOr[js.Any] => scala.Unit = null,
    setMapCenter: /* coordinates */ js.UndefOr[js.Any] => scala.Unit = null,
    setMapListeners: /* mapListeners */ js.UndefOr[js.Any] => scala.Unit = null,
    setMapOptions: /* mapOptions */ js.UndefOr[js.Any] => scala.Unit = null,
    setUseCurrentLocation: /* useCurrentLocation */ js.UndefOr[js.Any] => scala.Unit = null,
    update: /* coordinates */ js.UndefOr[js.Any] => scala.Unit = null,
