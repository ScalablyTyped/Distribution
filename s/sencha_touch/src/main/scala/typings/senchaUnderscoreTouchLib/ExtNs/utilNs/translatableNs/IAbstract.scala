...
trait IAbstract
  ...
  /** [Method] Sets the value of easingX
  		...
  		*/
  var setEasingX: js.UndefOr[js.Function1[/* easingX */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of easingY
  		* @param easingY Object The new value.
  		*/
  var setEasingY: js.UndefOr[js.Function1[/* easingY */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
  /** [Method] Sets the value of useWrapper
  		* @param useWrapper Object The new value.
  		*/
  var setUseWrapper: js.UndefOr[js.Function1[/* useWrapper */ js.UndefOr[js.Any], scala.Unit]] = js.undefined
}
