...
object XTemplate extends js.Object {
  ...
  /** [Method] Gets an XTemplate from an object an instance of an Ext define d class
  		...
  		*/
  def getTpl(): senchaUnderscoreTouchLib.ExtNs.IXTemplate = js.native
  def getTpl(instance: js.Any): senchaUnderscoreTouchLib.ExtNs.IXTemplate = js.native
  def getTpl(instance: js.Any, name: java.lang.String): senchaUnderscoreTouchLib.ExtNs.IXTemplate = js.native
