...
object ILine {
  ...
  def apply(
    ...
    getFill: js.Function0[scala.Boolean] = null,
    ...
    getSelectionTolerance: js.Function0[scala.Double] = null,
    getShowInLegend: js.Function0[scala.Boolean] = null,
    getSmooth: js.Function0[_] = null,
    getSprites: js.Function0[scala.Unit] = null,
    getStep: js.Function0[scala.Boolean] = null,
    ...
    setFill: js.Function1[/* fill */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    ...
    setSelectionTolerance: js.Function1[/* selectionTolerance */ js.UndefOr[scala.Double], scala.Unit] = null,
    setShowInLegend: js.Function1[/* showInLegend */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    setSmooth: js.Function1[/* smooth */ js.UndefOr[js.Any], scala.Unit] = null,
    setStep: js.Function1[/* step */ js.UndefOr[scala.Boolean], scala.Unit] = null,
    ...
    if (getFill != null) __obj.updateDynamic("getFill")(getFill)
    ...
    if (getSelectionTolerance != null) __obj.updateDynamic("getSelectionTolerance")(getSelectionTolerance)
    if (getShowInLegend != null) __obj.updateDynamic("getShowInLegend")(getShowInLegend)
    if (getSmooth != null) __obj.updateDynamic("getSmooth")(getSmooth)
    ...
    if (setFill != null) __obj.updateDynamic("setFill")(setFill)
    ...
    if (setSelectionTolerance != null) __obj.updateDynamic("setSelectionTolerance")(setSelectionTolerance)
    if (setShowInLegend != null) __obj.updateDynamic("setShowInLegend")(setShowInLegend)
    if (setSmooth != null) __obj.updateDynamic("setSmooth")(setSmooth)
