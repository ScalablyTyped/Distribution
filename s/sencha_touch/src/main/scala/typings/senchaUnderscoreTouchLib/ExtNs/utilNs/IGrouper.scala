...
object IGrouper {
  ...
  def apply(
    ...
    setGroupFn: /* groupFn */ js.UndefOr[js.Any] => scala.Unit = null,
    ...
    setSortProperty: /* sortProperty */ js.UndefOr[java.lang.String] => scala.Unit = null,
    setSorterFn: /* sorterFn */ js.UndefOr[js.Any] => scala.Unit = null,
    setTransform: /* transform */ js.UndefOr[js.Any] => scala.Unit = null,
