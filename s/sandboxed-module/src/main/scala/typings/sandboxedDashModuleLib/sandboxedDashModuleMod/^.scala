...
object ^ extends js.Object {
  /**
    ...
    */
  def configure(options: SandboxOptions): scala.Unit = js.native
  /**
    ...
    */
  def load(moduleId: java.lang.String): SandboxedModule = js.native
  def load(moduleId: java.lang.String, options: SandboxOptions): SandboxedModule = js.native
  /**
  ...
  def require(moduleId: java.lang.String, options: SandboxOptions): js.Any = js.native
}
