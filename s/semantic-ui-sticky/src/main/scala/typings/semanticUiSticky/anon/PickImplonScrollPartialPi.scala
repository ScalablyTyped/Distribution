...
/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'onScroll'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
trait PickImplonScrollPartialPi
  extends StObject
     with Param {
...
object PickImplonScrollPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonScrollPartialPi] (val x: Self) extends AnyVal {
