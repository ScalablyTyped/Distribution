...
/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'onTop'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
trait PickImplonTopPartialPickI
  extends StObject
     with Param {
...
object PickImplonTopPartialPickI {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonTopPartialPickI] (val x: Self) extends AnyVal {
