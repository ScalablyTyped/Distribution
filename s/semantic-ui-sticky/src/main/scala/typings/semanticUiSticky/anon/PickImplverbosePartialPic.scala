...
/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'verbose'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
