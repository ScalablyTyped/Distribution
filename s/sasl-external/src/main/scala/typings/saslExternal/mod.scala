...
object mod {
  ...
  object ExternalMechanism {
    ...
    inline def apply(challenge: String => Unit, response: Credentials => String): ExternalMechanism = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ExternalMechanism] (val x: Self) extends AnyVal {
