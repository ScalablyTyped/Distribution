...
@js.native
object scanfMod extends js.Object {
  /**
  	 ...
  	 */
  def apply(format: java.lang.String): js.Array[scala.Double | java.lang.String] = js.native
  /**
  	 * <p> Reads formatted data from stdin. </p>
  	 * 
  	 ...
  	 */
  def apply(format: java.lang.String, names: java.lang.String*): js.Object = js.native
  /**
  	 ...
  	 * @return A word.
  	 */
  def apply(format: scanfLib.scanfLibStrings.`%S`): java.lang.String = js.native
  /**
  	 ...
  	 * @return An integer.
  	 */
  def apply(format: scanfLib.scanfLibStrings.`%d`): scala.Double = js.native
  /**
  	 ...
  	 * @return A float.
  	 */
  def apply(format: scanfLib.scanfLibStrings.`%f`): scala.Double = js.native
  /**
  	 ...
  	 * @return An octal.
  	 */
  def apply(format: scanfLib.scanfLibStrings.`%o`): scala.Double = js.native
  /* ------------------------------------------------------------
  		SCANF - FROM STDIN
  	------------------------------------------------------------ */
  /**
  ...
  /**
  	 ...
  	 * @return A hex.
  	 */
  def apply(format: scanfLib.scanfLibStrings.`%x`): scala.Double = js.native
  /**
