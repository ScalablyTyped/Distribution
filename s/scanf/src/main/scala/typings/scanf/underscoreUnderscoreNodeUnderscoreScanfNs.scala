...
object underscoreUnderscoreNodeUnderscoreScanfNs extends js.Object {
  /**
  	 ...
  	 */
  def scanf(format: String): js.Array[Double | String] = js.native
  /**
  	 * <p> Reads formatted data from stdin. </p>
  	 * 
  	 ...
  	 */
  def scanf(format: String, names: String*): js.Object = js.native
  /**
  	 ...
  	 */
  @JSName("scanf")
  def scanf_S(format: `%S`): String = js.native
  /**
  	 ...
  	 */
  @JSName("scanf")
  def scanf_d(format: `%d`): Double = js.native
  /**
  	 ...
  	 */
  @JSName("scanf")
  def scanf_f(format: `%f`): Double = js.native
  /**
  	 ...
  	 */
  @JSName("scanf")
  def scanf_o(format: `%o`): Double = js.native
  /* ------------------------------------------------------------
  		SCANF - FROM STDIN
  	------------------------------------------------------------ */
  /**
  ...
  /**
  	 ...
  	 */
  @JSName("scanf")
  def scanf_x(format: `%x`): Double = js.native
  /* ------------------------------------------------------------
