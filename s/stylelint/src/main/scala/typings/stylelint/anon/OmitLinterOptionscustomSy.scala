...
/* Inlined std.Omit<stylelint.stylelint.LinterOptions, 'customSyntax'> */
trait OmitLinterOptionscustomSy
  extends StObject
...
object OmitLinterOptionscustomSy {
  
  inline def apply(): OmitLinterOptionscustomSy = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitLinterOptionscustomSy]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitLinterOptionscustomSy] (val x: Self) extends AnyVal {
