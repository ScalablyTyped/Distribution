...
object IBrowserExtJS {
  ...
  def apply(
    ...
    __obj.updateDynamic("allowExtVersionChange")(allowExtVersionChange)
    ...
    __obj.updateDynamic("waitForAppReady")(waitForAppReady)
    __obj.updateDynamic("waitForExtReady")(waitForExtReady)
