package typings
package streamDashCsvDashAsDashJsonLib.asObjectsMod.AsObjectsNs
...
object AsObjectOptions {
  ...
  def apply(
    ...
    fieldPrefix: java.lang.String = null,
    ...
    if (fieldPrefix != null) __obj.updateDynamic("fieldPrefix")(fieldPrefix)
