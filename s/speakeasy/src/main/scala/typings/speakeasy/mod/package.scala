...
@scala.inline
def generateSecretASCII(length: scala.Unit, symbols: scala.Boolean): java.lang.String = (typings.speakeasy.mod.^.asInstanceOf[js.Dynamic].applyDynamic("generateSecretASCII")(length.asInstanceOf[js.Any], symbols.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
