...
import typings.superstruct.libSuperstructMod.SuperstructSettings
...
@js.native
object superstructMod extends js.Object {
  @js.native
  class StructError protected ()
    extends typings.superstruct.libStructDashErrorMod.StructError {
  ...
  /**
    ...
    */
  val struct: Superstruct = js.native
  def isStruct(value: js.Any): /* is superstruct.superstruct/lib/struct.Struct */ Boolean = js.native
  def superstruct(): Superstruct = js.native
  def superstruct(settings: Partial[SuperstructSettings]): Superstruct = js.native
  @js.native
