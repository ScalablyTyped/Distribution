...
@js.native
trait PartialStructFailureBranch extends js.Object {
...
object PartialStructFailureBranch {
  ...
  @scala.inline
  implicit class PartialStructFailureBranchOps[Self <: PartialStructFailureBranch] (val x: Self) extends AnyVal {
    @scala.inline
