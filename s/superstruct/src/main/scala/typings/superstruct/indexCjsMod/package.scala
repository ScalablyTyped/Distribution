...
package object indexCjsMod {
  ...
  /**
    ...
    */
  type OptionalizeObject[T] = typings.superstruct.indexCjsMod.Flatten[
  ...
  type StructRecord[T] = typings.std.Record[java.lang.String, typings.superstruct.indexCjsMod.Struct_[T, js.Any]]
  
  /**
    * A `StructResult` is returned from validation functions.
    */
  type StructResult = scala.Boolean | typings.std.Iterable[typings.superstruct.indexCjsMod.StructFailure]
  ...
  /**
    ...
    */
  type StructType[T /* <: typings.superstruct.indexCjsMod.Struct_[_, _] */] = /* import warning: importer.ImportType#apply Failed type conversion: std.Parameters<T['refiner']>[0] */ js.Any
}
