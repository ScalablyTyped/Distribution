...
object indexEsMod {
  ...
  @scala.inline
  def enums[T /* <: String */](values: js.Array[T]): Struct_[T, js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("enums")(values.asInstanceOf[js.Any]).asInstanceOf[Struct_[T, js.Any]]
  
  /**
    * Validate that a value against a set of potential values.
    */
  @scala.inline
  def enums_T_Double[T /* <: Double */](values: js.Array[T]): Struct_[T, js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("enums")(values.asInstanceOf[js.Any]).asInstanceOf[Struct_[T, js.Any]]
  ...
  @scala.inline
  def literal[T /* <: String */](constant: T): Struct_[T, js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("literal")(constant.asInstanceOf[js.Any]).asInstanceOf[Struct_[T, js.Any]]
  ...
  @scala.inline
  def literal_T_Double[T /* <: Double */](constant: T): Struct_[T, js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("literal")(constant.asInstanceOf[js.Any]).asInstanceOf[Struct_[T, js.Any]]
