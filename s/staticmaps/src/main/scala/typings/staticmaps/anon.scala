...
object anon {
  ...
  object Max {
    ...
    implicit class MaxMutableBuilder[Self <: Max] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMax(value: ZoomLevel): Self = StObject.set(x, "max", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setMaxUndefined: Self = StObject.set(x, "max", js.undefined)
      
      @scala.inline
      def setMin(value: ZoomLevel): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
