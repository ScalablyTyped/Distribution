...
object Change {
  ...
  inline def ModificationChange[T](ccid: String, id: String, v: JSONDiff[T]): typings.simperium.mod.ModificationChange[T] = {
  ...
  inline def RemovalChange(ccid: String, id: String): typings.simperium.mod.RemovalChange = {
