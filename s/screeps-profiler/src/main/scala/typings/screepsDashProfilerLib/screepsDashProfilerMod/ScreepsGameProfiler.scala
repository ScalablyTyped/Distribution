...
trait ScreepsGameProfiler extends js.Object {
  ...
  def background(functionFilter: java.lang.String): scala.Unit = js.native
  /**
    ...
    * @param [functionFilter] - parameter will limit the scope of the profiler to a specific function name
    */
  def email(ticks: scala.Double): scala.Unit = js.native
  def email(ticks: scala.Double, functionFilter: java.lang.String): scala.Unit = js.native
  /**
  ...
  def output(lineCount: scala.Double): scala.Unit = js.native
  /**
    ...
    * @param [functionFilter] - parameter will limit the scope of the profiler to a specific function name
    */
  def profile(ticks: scala.Double): scala.Unit = js.native
  def profile(ticks: scala.Double, functionFilter: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    * @param [functionFilter] - parameter will limit the scope of the profiler to a specific function name
    */
  def stream(ticks: scala.Double): scala.Unit = js.native
  def stream(ticks: scala.Double, functionFilter: java.lang.String): scala.Unit = js.native
}
