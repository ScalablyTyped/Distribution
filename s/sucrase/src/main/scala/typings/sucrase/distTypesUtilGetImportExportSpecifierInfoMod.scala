...
object distTypesUtilGetImportExportSpecifierInfoMod {
  ...
  inline def default(tokens: typings.sucrase.distTypesTokenProcessorMod.default): ImportExportSpecifierInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(tokens.asInstanceOf[js.Any]).asInstanceOf[ImportExportSpecifierInfo]
  inline def default(tokens: typings.sucrase.distTypesTokenProcessorMod.default, index: Double): ImportExportSpecifierInfo = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(tokens.asInstanceOf[js.Any], index.asInstanceOf[js.Any])).asInstanceOf[ImportExportSpecifierInfo]
