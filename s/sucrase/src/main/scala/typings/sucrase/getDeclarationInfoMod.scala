...
object getDeclarationInfoMod {
  
  @JSImport("sucrase/dist/types/util/getDeclarationInfo", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(tokens: typings.sucrase.tokenProcessorMod.default): DeclarationInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(tokens.asInstanceOf[js.Any]).asInstanceOf[DeclarationInfo]
