...
object distTypesUtilGetDeclarationInfoMod {
  ...
  inline def default(tokens: typings.sucrase.distTypesTokenProcessorMod.default): DeclarationInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(tokens.asInstanceOf[js.Any]).asInstanceOf[DeclarationInfo]
