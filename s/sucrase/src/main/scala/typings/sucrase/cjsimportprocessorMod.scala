...
object cjsimportprocessorMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override val nameManager: typings.sucrase.nameManagerMod.default = js.native
    ...
    /* CompleteClass */
    override val tokens: typings.sucrase.tokenProcessorMod.default = js.native
  }
  ...
  trait CJSImportProcessor extends StObject {
    ...
    val nameManager: typings.sucrase.nameManagerMod.default
    ...
    val tokens: typings.sucrase.tokenProcessorMod.default
  }
  object CJSImportProcessor {
    ...
    extension [Self <: CJSImportProcessor](x: Self) {
      ...
      inline def setTokens(value: typings.sucrase.tokenProcessorMod.default): Self = StObject.set(x, "tokens", value.asInstanceOf[js.Any])
    }
  }
}
