...
trait ClientOptions extends js.Object {
  ...
  var codecEngine: js.UndefOr[socketclusterDashServerLib.scserverMod.SCCodecEngine | scala.Null] = js.undefined
  // (milliseconds)
...
object ClientOptions {
  ...
  def apply(
    ...
    codecEngine: socketclusterDashServerLib.scserverMod.SCCodecEngine = null,
