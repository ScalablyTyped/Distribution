...
version := "13.0-dt-20191126Z-fb585f"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20191126Z-594f4b",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20191126Z-25e1a0",
