...
version := "13.0-dt-20190212Z-f087cb"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-auth" % "5.0-dt-20181130Z-c8b2fa",
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20181218Z-e8d96d",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-afe92d",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-6b269f",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190205Z-45c1eb",
