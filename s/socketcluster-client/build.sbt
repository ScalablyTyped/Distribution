...
version := "13.0-dt-20190513Z-a1ac1f"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "jsonwebtoken" % "8.3-dt-20191015Z-5255ec",
  "org.scalablytyped" %%% "node" % "12.12-dt-20191125Z-959704",
  "org.scalablytyped" %%% "sc-auth" % "5.0-dt-20181130Z-a933fc",
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-6b810e",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-2051fa",
  "org.scalablytyped" %%% "sc-errors" % "1.4-dt-20190513Z-bd0861",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-af191b",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-460961",
