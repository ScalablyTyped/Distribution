...
version := "13.0-dt-20190513Z-4d5471"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-a1a48a",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-4a4a13",
