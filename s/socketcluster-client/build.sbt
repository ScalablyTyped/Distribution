...
version := "13.0-dt-20190513Z-f24eb4"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-c7ff74",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-7b13bc",
