...
version := "13.0-dt-20190212Z-02f014"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-924ab5",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-be0883",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-430aa7",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-74de39",
