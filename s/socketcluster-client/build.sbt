...
version := "13.0-dt-20190513Z-7f2fc3"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-5d815f",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-9cd374",
