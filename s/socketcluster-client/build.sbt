...
version := "13.0-dt-20190212Z-af0501"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20181218Z-d30691",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-afe92d",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-ac7b40",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190205Z-bfa7f8",
