...
version := "13.0-dt-20181205Z-584ae8"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20181205Z-372a62",
  "com.scalablytyped" %%% "sc-channel" % "1.2-dt-20181205Z-345f1b",
  "com.scalablytyped" %%% "socketcluster" % "14.0-dt-20181205Z-98a6cb",
  "com.scalablytyped" %%% "socketcluster-server" % "13.1-dt-20181205Z-8ae996",
