...
version := "13.0-dt-20190513Z-349dfc"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-72a6d0",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-143ef6",
