...
version := "13.0-dt-20190513Z-59e2ee"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-f5dbdd",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-dfa269",
