...
version := "13.0-dt-20190212Z-dc848a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20181218Z-53c606",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-af7d93",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-fa86bf",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190205Z-28c85b",
