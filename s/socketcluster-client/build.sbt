...
version := "13.0-dt-20190212Z-6d8064"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20181218Z-b46561",
  "org.scalablytyped" %%% "sc-channel" % "1.2-dt-20181130Z-c096f7",
  "org.scalablytyped" %%% "socketcluster" % "14.0-dt-20190212Z-28441a",
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190205Z-2f5844",
