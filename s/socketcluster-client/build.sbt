...
version := "13.0-dt-20190513Z-920875"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "sc-broker-cluster" % "6.1-dt-20190415Z-111c9a",
  ...
  "org.scalablytyped" %%% "socketcluster-server" % "14.2-dt-20190415Z-dd0496",
