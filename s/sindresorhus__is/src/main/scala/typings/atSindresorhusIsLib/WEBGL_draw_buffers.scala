...
object WEBGL_draw_buffers {
  ...
  def apply(
    ...
    drawBuffersWEBGL: js.Function1[Array[GLenum], scala.Unit]
  ): WEBGL_draw_buffers = {
    val __obj = js.Dynamic.literal(COLOR_ATTACHMENT0_WEBGL = COLOR_ATTACHMENT0_WEBGL, COLOR_ATTACHMENT10_WEBGL = COLOR_ATTACHMENT10_WEBGL, COLOR_ATTACHMENT11_WEBGL = COLOR_ATTACHMENT11_WEBGL, COLOR_ATTACHMENT12_WEBGL = COLOR_ATTACHMENT12_WEBGL, COLOR_ATTACHMENT13_WEBGL = COLOR_ATTACHMENT13_WEBGL, COLOR_ATTACHMENT14_WEBGL = COLOR_ATTACHMENT14_WEBGL, COLOR_ATTACHMENT15_WEBGL = COLOR_ATTACHMENT15_WEBGL, COLOR_ATTACHMENT1_WEBGL = COLOR_ATTACHMENT1_WEBGL, COLOR_ATTACHMENT2_WEBGL = COLOR_ATTACHMENT2_WEBGL, COLOR_ATTACHMENT3_WEBGL = COLOR_ATTACHMENT3_WEBGL, COLOR_ATTACHMENT4_WEBGL = COLOR_ATTACHMENT4_WEBGL, COLOR_ATTACHMENT5_WEBGL = COLOR_ATTACHMENT5_WEBGL, COLOR_ATTACHMENT6_WEBGL = COLOR_ATTACHMENT6_WEBGL, COLOR_ATTACHMENT7_WEBGL = COLOR_ATTACHMENT7_WEBGL, COLOR_ATTACHMENT8_WEBGL = COLOR_ATTACHMENT8_WEBGL, COLOR_ATTACHMENT9_WEBGL = COLOR_ATTACHMENT9_WEBGL, DRAW_BUFFER0_WEBGL = DRAW_BUFFER0_WEBGL, DRAW_BUFFER10_WEBGL = DRAW_BUFFER10_WEBGL, DRAW_BUFFER11_WEBGL = DRAW_BUFFER11_WEBGL, DRAW_BUFFER12_WEBGL = DRAW_BUFFER12_WEBGL, DRAW_BUFFER13_WEBGL = DRAW_BUFFER13_WEBGL, DRAW_BUFFER14_WEBGL = DRAW_BUFFER14_WEBGL, DRAW_BUFFER15_WEBGL = DRAW_BUFFER15_WEBGL, DRAW_BUFFER1_WEBGL = DRAW_BUFFER1_WEBGL, DRAW_BUFFER2_WEBGL = DRAW_BUFFER2_WEBGL, DRAW_BUFFER3_WEBGL = DRAW_BUFFER3_WEBGL, DRAW_BUFFER4_WEBGL = DRAW_BUFFER4_WEBGL, DRAW_BUFFER5_WEBGL = DRAW_BUFFER5_WEBGL, DRAW_BUFFER6_WEBGL = DRAW_BUFFER6_WEBGL, DRAW_BUFFER7_WEBGL = DRAW_BUFFER7_WEBGL, DRAW_BUFFER8_WEBGL = DRAW_BUFFER8_WEBGL, DRAW_BUFFER9_WEBGL = DRAW_BUFFER9_WEBGL, MAX_COLOR_ATTACHMENTS_WEBGL = MAX_COLOR_ATTACHMENTS_WEBGL, MAX_DRAW_BUFFERS_WEBGL = MAX_DRAW_BUFFERS_WEBGL, drawBuffersWEBGL = drawBuffersWEBGL)
