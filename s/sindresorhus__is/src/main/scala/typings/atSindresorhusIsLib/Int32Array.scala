...
trait Int32Array
  ...
  val toStringTag: atSindresorhusIsLib.atSindresorhusIsLibStrings.Int32Array = js.native
  /**
  ...
  def slice(start: scala.Double): Int32Array = js.native
  def slice(start: scala.Double, end: scala.Double): Int32Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Int32Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Int32Array = js.native
  /**
