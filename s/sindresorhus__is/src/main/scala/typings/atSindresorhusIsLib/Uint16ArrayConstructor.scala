...
trait Uint16ArrayConstructor
  extends org.scalablytyped.runtime.Instantiable2[/* buffer */ ArrayBufferLike, /* byteOffset */ scala.Double, Uint16Array]
  ...
  /**
    ...
    */
  def from(arrayLike: ArrayLike[scala.Double]): Uint16Array = js.native
  /**
    * Creates an array from an array-like or iterable object.
    * @param arrayLike An array-like or iterable object to convert to an array.
    ...
    */
  def from(arrayLike: Iterable[scala.Double]): Uint16Array = js.native
  def from(
  ...
  /**
    ...
    * @param thisArg Value of 'this' used to invoke the mapfn.
    */
  def from[T](arrayLike: ArrayLike[T], mapfn: js.Function2[/* v */ T, /* k */ scala.Double, scala.Double]): Uint16Array = js.native
  def from[T](
  ...
  /**
    ...
    */
  def of(items: scala.Double*): Uint16Array = js.native
}
