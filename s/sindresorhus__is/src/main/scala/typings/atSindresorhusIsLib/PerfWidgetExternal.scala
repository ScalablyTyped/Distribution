...
trait PerfWidgetExternal extends js.Object {
  ...
  def addEventListener(eventType: java.lang.String, callback: Function): scala.Unit = js.native
  ...
  def removeEventListener(eventType: java.lang.String, callback: Function): scala.Unit = js.native
