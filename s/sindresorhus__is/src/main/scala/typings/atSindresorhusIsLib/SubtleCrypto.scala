...
trait SubtleCrypto extends js.Object {
  ...
  def deriveKey(
    ...
    keyUsages: Array[java.lang.String]
  ...
  @JSName("exportKey")
  def exportKey_jwk(format: atSindresorhusIsLib.atSindresorhusIsLibStrings.jwk, key: CryptoKey): PromiseLike[JsonWebKey] = js.native
  @JSName("exportKey")
  def exportKey_pkcs8(format: atSindresorhusIsLib.atSindresorhusIsLibStrings.pkcs8, key: CryptoKey): PromiseLike[ArrayBuffer] = js.native
  @JSName("exportKey")
  def exportKey_raw(format: atSindresorhusIsLib.atSindresorhusIsLibStrings.raw, key: CryptoKey): PromiseLike[ArrayBuffer] = js.native
  @JSName("exportKey")
  def exportKey_spki(format: atSindresorhusIsLib.atSindresorhusIsLibStrings.spki, key: CryptoKey): PromiseLike[ArrayBuffer] = js.native
  def generateKey(algorithm: AesKeyGenParams, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKey] = js.native
  def generateKey(algorithm: DhKeyGenParams, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKeyPair] = js.native
  def generateKey(algorithm: EcKeyGenParams, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKeyPair] = js.native
  def generateKey(algorithm: HmacKeyGenParams, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKey] = js.native
  def generateKey(algorithm: Pbkdf2Params, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKey] = js.native
  def generateKey(algorithm: RsaHashedKeyGenParams, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKeyPair] = js.native
  def generateKey(algorithm: java.lang.String, extractable: scala.Boolean, keyUsages: Array[java.lang.String]): PromiseLike[CryptoKeyPair | CryptoKey] = js.native
  def importKey(
  ...
  @JSName("importKey")
  def importKey_jwk(
    format: atSindresorhusIsLib.atSindresorhusIsLibStrings.jwk,
    keyData: JsonWebKey,
    algorithm: AesKeyAlgorithm,
    extractable: scala.Boolean,
    keyUsages: Array[java.lang.String]
  ...
  @JSName("importKey")
  def importKey_pkcs8(
    format: atSindresorhusIsLib.atSindresorhusIsLibStrings.pkcs8,
  ...
  @JSName("importKey")
  def importKey_raw(
    format: atSindresorhusIsLib.atSindresorhusIsLibStrings.raw,
    keyData: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer,
    algorithm: AesKeyAlgorithm,
    extractable: scala.Boolean,
    keyUsages: Array[java.lang.String]
  ...
  @JSName("importKey")
  def importKey_spki(
    format: atSindresorhusIsLib.atSindresorhusIsLibStrings.spki,
    keyData: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer,
    algorithm: AesKeyAlgorithm,
    extractable: scala.Boolean,
    keyUsages: Array[java.lang.String]
