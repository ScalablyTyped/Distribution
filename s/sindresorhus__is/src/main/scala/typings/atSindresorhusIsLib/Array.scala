...
trait Array[T]
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], _]): Array[T] = js.native
  def filter(
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], _],
    thisArg: js.Any
  ): Array[T] = js.native
  /**
    * Returns the elements of an array that meet the condition specified in a callback function.
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def map[U](callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ Array[T], U]): Array[U] = js.native
  def map[U](
  ...
  /**
    ...
    */
  def splice(start: scala.Double): Array[T] = js.native
  def splice(start: scala.Double, deleteCount: scala.Double): Array[T] = js.native
  /**
    * Removes elements from an array and, if necessary, inserts new elements in their place, returning the deleted elements.
    * @param start The zero-based location in the array from which to start removing elements.
    * @param deleteCount The number of elements to remove.
    ...
    */
  def splice(start: scala.Double, deleteCount: scala.Double, items: T*): Array[T] = js.native
  /**
