...
trait HTMLCanvasElement extends HTMLElement {
  ...
  /**
    ...
    */
  @JSName("getContext")
  def getContext_2d(contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.`2d`): CanvasRenderingContext2D | scala.Null = js.native
  @JSName("getContext")
  def getContext_2d(
    contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.`2d`,
    contextAttributes: CanvasRenderingContext2DSettings
  ): CanvasRenderingContext2D | scala.Null = js.native
  @JSName("getContext")
  def `getContext_experimental-webgl`(contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.`experimental-webgl`): WebGLRenderingContext | scala.Null = js.native
  @JSName("getContext")
  def `getContext_experimental-webgl`(
    contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.`experimental-webgl`,
    contextAttributes: WebGLContextAttributes
  ): WebGLRenderingContext | scala.Null = js.native
  @JSName("getContext")
  def getContext_webgl(contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.webgl): WebGLRenderingContext | scala.Null = js.native
  @JSName("getContext")
  def getContext_webgl(
    contextId: atSindresorhusIsLib.atSindresorhusIsLibStrings.webgl,
    contextAttributes: WebGLContextAttributes
  ): WebGLRenderingContext | scala.Null = js.native
