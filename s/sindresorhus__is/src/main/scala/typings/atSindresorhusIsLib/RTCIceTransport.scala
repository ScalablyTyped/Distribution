...
trait RTCIceTransport extends EventTarget {
  ...
  def addEventListener_gatheringstatechange(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.gatheringstatechange,
  ...
  def addEventListener_selectedcandidatepairchange(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.selectedcandidatepairchange,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_selectedcandidatepairchange(
  ...
  def getLocalCandidates(): Array[RTCIceCandidate] = js.native
  def getLocalParameters(): RTCIceParameters | scala.Null = js.native
  def getRemoteCandidates(): Array[RTCIceCandidate] = js.native
