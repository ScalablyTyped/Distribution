...
trait Notification extends EventTarget {
  val actions: ReadonlyArray[NotificationAction] = js.native
  ...
  val vibrate: ReadonlyArray[scala.Double] = js.native
  ...
  def addEventListener_show(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.show,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_show(
...
object Notification
  ...
  val permission: atSindresorhusIsLib.NotificationPermission = js.native
  def requestPermission(): atSindresorhusIsLib.Promise[atSindresorhusIsLib.NotificationPermission] = js.native
  def requestPermission(deprecatedCallback: atSindresorhusIsLib.NotificationPermissionCallback): atSindresorhusIsLib.Promise[atSindresorhusIsLib.NotificationPermission] = js.native
}
