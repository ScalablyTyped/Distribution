...
trait JSON extends js.Object {
  ...
  def stringify(value: js.Any, replacer: Array[scala.Double | java.lang.String]): java.lang.String = js.native
  def stringify(value: js.Any, replacer: Array[scala.Double | java.lang.String], space: java.lang.String): java.lang.String = js.native
  def stringify(value: js.Any, replacer: Array[scala.Double | java.lang.String], space: scala.Double): java.lang.String = js.native
