...
trait Float32Array
  ...
  val toStringTag: atSindresorhusIsLib.atSindresorhusIsLibStrings.Float32Array = js.native
  /**
  ...
  /**
    ...
    */
  def reverse(): Float32Array = js.native
  /**
  ...
  /**
    ...
    */
  def slice(): Float32Array = js.native
  def slice(start: scala.Double): Float32Array = js.native
  def slice(start: scala.Double, end: scala.Double): Float32Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Float32Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Float32Array = js.native
  /**
