...
object DOMMatrixReadOnly
  extends org.scalablytyped.runtime.Instantiable0[DOMMatrixReadOnly]
     with org.scalablytyped.runtime.Instantiable1[
      (/* init */ Array[scala.Double]) | (/* init */ java.lang.String), 
      DOMMatrixReadOnly
    ] {
  def fromFloat32Array(array32: atSindresorhusIsLib.Float32Array): atSindresorhusIsLib.DOMMatrixReadOnly = js.native
  def fromFloat64Array(array64: atSindresorhusIsLib.Float64Array): atSindresorhusIsLib.DOMMatrixReadOnly = js.native
  def fromMatrix(): atSindresorhusIsLib.DOMMatrixReadOnly = js.native
  def fromMatrix(other: atSindresorhusIsLib.DOMMatrixInit): atSindresorhusIsLib.DOMMatrixReadOnly = js.native
}
