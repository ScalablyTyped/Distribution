...
trait IDBObjectStore extends js.Object {
  ...
  def createIndex(name: java.lang.String, keyPath: Array[java.lang.String]): IDBIndex = js.native
  def createIndex(name: java.lang.String, keyPath: Array[java.lang.String], options: IDBIndexParameters): IDBIndex = js.native
  /**
