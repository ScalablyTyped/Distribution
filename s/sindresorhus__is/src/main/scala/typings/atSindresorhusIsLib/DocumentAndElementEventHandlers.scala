...
trait DocumentAndElementEventHandlers extends js.Object {
  ...
  def addEventListener_copy(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.copy,
  ...
  def addEventListener_cut(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.cut,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ ClipboardEvent, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_cut(
  ...
  def addEventListener_paste(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.paste,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ ClipboardEvent, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_paste(
