...
trait PerformanceObserverInit extends js.Object {
  ...
  var entryTypes: Array[java.lang.String]
}

object PerformanceObserverInit {
  @scala.inline
  def apply(entryTypes: Array[java.lang.String], buffered: js.UndefOr[scala.Boolean] = js.undefined): PerformanceObserverInit = {
