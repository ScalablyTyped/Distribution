...
trait ReadonlyArray[T]
  ...
  /**
    ...
    */
  def every(
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], scala.Boolean]
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], _]): Array[T] = js.native
  def filter(
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], _],
    thisArg: js.Any
  ): Array[T] = js.native
  /**
    * Returns the elements of an array that meet the condition specified in a callback function.
  ...
  def find(
    predicate: js.Function3[/* value */ T, /* index */ scala.Double, /* obj */ ReadonlyArray[T], scala.Boolean]
  ...
  /**
    ...
    */
  def forEach(
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], scala.Unit]
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def map[U](callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], U]): Array[U] = js.native
  def map[U](
    callbackfn: js.Function3[/* value */ T, /* index */ scala.Double, /* array */ ReadonlyArray[T], U],
    thisArg: js.Any
  ): Array[U] = js.native
  /**
  ...
  def slice(start: scala.Double): Array[T] = js.native
  def slice(start: scala.Double, end: scala.Double): Array[T] = js.native
  /**
