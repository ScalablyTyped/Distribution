...
object DOMPointReadOnly
  ...
  def fromPoint(): atSindresorhusIsLib.DOMPointReadOnly = js.native
  def fromPoint(other: atSindresorhusIsLib.DOMPointInit): atSindresorhusIsLib.DOMPointReadOnly = js.native
}
