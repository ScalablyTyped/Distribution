...
trait HTMLVideoElement
  ...
  def addEventListener_MSVideoFormatChanged(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.MSVideoFormatChanged,
  ...
  def addEventListener_MSVideoFrameStepCompleted(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.MSVideoFrameStepCompleted,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_MSVideoFrameStepCompleted(
  ...
  def addEventListener_MSVideoOptimalLayoutChanged(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.MSVideoOptimalLayoutChanged,
    listener: js.ThisFunction1[/* this */ this.type, /* ev */ Event, _]
  ): scala.Unit = js.native
  @JSName("addEventListener")
  def addEventListener_MSVideoOptimalLayoutChanged(
