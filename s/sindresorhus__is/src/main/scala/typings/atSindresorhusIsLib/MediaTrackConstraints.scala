...
object MediaTrackConstraints {
  @scala.inline
  def apply(
    advanced: Array[MediaTrackConstraintSet] = null,
    aspectRatio: scala.Double | ConstrainDoubleRange = null,
    channelCount: scala.Double | ConstrainLongRange = null,
    deviceId: java.lang.String | Array[java.lang.String] | ConstrainDOMStringParameters = null,
    displaySurface: java.lang.String | Array[java.lang.String] | ConstrainDOMStringParameters = null,
    echoCancellation: scala.Boolean | ConstrainBooleanParameters = null,
    facingMode: java.lang.String | Array[java.lang.String] | ConstrainDOMStringParameters = null,
    frameRate: scala.Double | ConstrainDoubleRange = null,
    groupId: java.lang.String | Array[java.lang.String] | ConstrainDOMStringParameters = null,
