...
trait Atomics extends js.Object {
  ...
  val toStringTag: atSindresorhusIsLib.atSindresorhusIsLibStrings.Atomics = js.native
  ...
  /**
    ...
    * `"not-equal"`.
    */
  def wait(typedArray: Int32Array, index: scala.Double, value: scala.Double): atSindresorhusIsLib.atSindresorhusIsLibStrings.ok | atSindresorhusIsLib.atSindresorhusIsLibStrings.`not-equal` | atSindresorhusIsLib.atSindresorhusIsLibStrings.`timed-out` = js.native
  def wait(typedArray: Int32Array, index: scala.Double, value: scala.Double, timeout: scala.Double): atSindresorhusIsLib.atSindresorhusIsLibStrings.ok | atSindresorhusIsLib.atSindresorhusIsLibStrings.`not-equal` | atSindresorhusIsLib.atSindresorhusIsLibStrings.`timed-out` = js.native
  /**
