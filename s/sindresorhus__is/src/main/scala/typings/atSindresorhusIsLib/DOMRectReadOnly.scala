...
object DOMRectReadOnly
  ...
  def fromRect(): atSindresorhusIsLib.DOMRectReadOnly = js.native
  def fromRect(other: atSindresorhusIsLib.DOMRectInit): atSindresorhusIsLib.DOMRectReadOnly = js.native
}
