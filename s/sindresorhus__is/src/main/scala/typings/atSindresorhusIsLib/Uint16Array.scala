...
trait Uint16Array
  ...
  val toStringTag: atSindresorhusIsLib.atSindresorhusIsLibStrings.Uint16Array = js.native
  /**
  ...
  def slice(start: scala.Double): Uint16Array = js.native
  def slice(start: scala.Double, end: scala.Double): Uint16Array = js.native
  /**
  ...
  /**
    ...
    */
  def subarray(begin: scala.Double): Uint16Array = js.native
  def subarray(begin: scala.Double, end: scala.Double): Uint16Array = js.native
  /**
