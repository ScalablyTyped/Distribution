...
trait HTMLInputElement extends HTMLElement {
  ...
  def setSelectionRange_backward(
    ...
    direction: atSindresorhusIsLib.atSindresorhusIsLibStrings.backward
  ): scala.Unit = js.native
  @JSName("setSelectionRange")
  def setSelectionRange_forward(
    start: scala.Double,
    end: scala.Double,
    direction: atSindresorhusIsLib.atSindresorhusIsLibStrings.forward
  ): scala.Unit = js.native
  @JSName("setSelectionRange")
  def setSelectionRange_none(
    start: scala.Double,
    end: scala.Double,
    direction: atSindresorhusIsLib.atSindresorhusIsLibStrings.none
  ): scala.Unit = js.native
  /**
