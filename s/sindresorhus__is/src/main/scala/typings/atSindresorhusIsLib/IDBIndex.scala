...
trait IDBIndex extends js.Object {
  ...
  /**
    ...
    */
  def getAll(): IDBRequest[Array[_]] = js.native
  def getAll(query: IDBKeyRange): IDBRequest[Array[_]] = js.native
  def getAll(query: IDBKeyRange, count: scala.Double): IDBRequest[Array[_]] = js.native
  def getAll(query: IDBValidKey): IDBRequest[Array[_]] = js.native
  def getAll(query: IDBValidKey, count: scala.Double): IDBRequest[Array[_]] = js.native
  /**
  ...
  def getAllKeys(query: IDBKeyRange, count: scala.Double): IDBRequest[Array[IDBValidKey]] = js.native
  def getAllKeys(query: IDBValidKey): IDBRequest[Array[IDBValidKey]] = js.native
  def getAllKeys(query: IDBValidKey, count: scala.Double): IDBRequest[Array[IDBValidKey]] = js.native
