...
trait String
  ...
  def localeCompare(
    ...
    options: atSindresorhusIsLib.IntlNs.CollatorOptions
  ...
  /**
    ...
    */
  def `match`(
    matcher: /* import warning: ImportType.apply Failed type conversion: {[Symbol.match] : (string : string): @sindresorhus/is.RegExpMatchArray | null} */ js.Any
  ...
  /**
    ...
    */
  @JSName("normalize")
  def normalize_NFC(form: atSindresorhusIsLib.atSindresorhusIsLibStrings.NFC): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFD(form: atSindresorhusIsLib.atSindresorhusIsLibStrings.NFD): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFKC(form: atSindresorhusIsLib.atSindresorhusIsLibStrings.NFKC): java.lang.String = js.native
  @JSName("normalize")
  def normalize_NFKD(form: atSindresorhusIsLib.atSindresorhusIsLibStrings.NFKD): java.lang.String = js.native
  /**
  ...
  /**
    ...
    */
  def split(
    splitter: /* import warning: ImportType.apply Failed type conversion: {[Symbol.split] : (string : string, limit? : number): @sindresorhus/is.Array<string>} */ js.Any
