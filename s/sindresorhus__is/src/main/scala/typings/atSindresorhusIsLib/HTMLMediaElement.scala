...
trait HTMLMediaElement extends HTMLElement {
  ...
  def addEventListener_encrypted(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.encrypted,
  ...
  def addEventListener_msneedkey(
    `type`: atSindresorhusIsLib.atSindresorhusIsLibStrings.msneedkey,
  ...
  /**
    ...
    */
  def play(): Promise[scala.Unit] = js.native
  ...
  def setMediaKeys(): Promise[scala.Unit] = js.native
  def setMediaKeys(mediaKeys: MediaKeys): Promise[scala.Unit] = js.native
}
