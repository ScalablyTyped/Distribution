...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-sizeme" % "2.6.12-1d59ee",
  "org.scalablytyped" %%% "react-syntax-highlighter" % "13.5-dt-20201016Z-1dff3d",
  "org.scalablytyped" %%% "std" % "4.1-40053c",
  "org.scalablytyped" %%% "store2" % "2.12.0-864b90",
  "org.scalablytyped" %%% "storybook__addon-actions" % "6.1.2-e297fb",
  ...
  "org.scalablytyped" %%% "storybook__components" % "6.1.2-248383",
  "org.scalablytyped" %%% "storybook__react" % "6.1.2-e3f128",
