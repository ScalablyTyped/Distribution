...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-sizeme" % "2.6.12-0c3d10",
  "org.scalablytyped" %%% "react-syntax-highlighter" % "13.5-dt-20201016Z-59a09e",
  "org.scalablytyped" %%% "std" % "4.1-044efb",
  "org.scalablytyped" %%% "store2" % "2.12.0-c4957c",
  "org.scalablytyped" %%% "storybook__addon-actions" % "6.1.2-c72914",
  ...
  "org.scalablytyped" %%% "storybook__components" % "6.1.2-881778",
