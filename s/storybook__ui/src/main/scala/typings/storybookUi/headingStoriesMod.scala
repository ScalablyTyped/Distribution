...
object headingStoriesMod {
  ...
  object default {
    ...
    inline def component_=(x: FunctionComponent[themeThemeundefinedchildr]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
  ...
  inline def customBrandImage(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("customBrandImage")().asInstanceOf[Element]
  
  inline def linkAndText(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("linkAndText")().asInstanceOf[Element]
  
  inline def longText(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("longText")().asInstanceOf[Element]
  
  inline def menuHighlighted(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("menuHighlighted")().asInstanceOf[Element]
  
  inline def onlyText(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("onlyText")().asInstanceOf[Element]
  
  inline def standard(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("standard")().asInstanceOf[Element]
  ...
  inline def standardNoLink(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("standardNoLink")().asInstanceOf[Element]
}
