...
object searchResultsStoriesMod {
  ...
  object default {
    ...
    inline def component_=(x: FunctionComponent[EnableShortcuts]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
    ...
    inline def includeStories_=(x: RegExp): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("includeStories")(x.asInstanceOf[js.Any])
  ...
  inline def LastViewed_(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("LastViewed")().asInstanceOf[Element]
  
  inline def NoResults_(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("NoResults")().asInstanceOf[Element]
  
  inline def Searching_(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Searching")().asInstanceOf[Element]
  ...
  object lastViewed {
    ...
    inline def closeMenu(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("closeMenu")().asInstanceOf[Unit]
    
    inline def getItemProps(): KeyAny = ^.asInstanceOf[js.Dynamic].applyDynamic("getItemProps")().asInstanceOf[KeyAny]
    inline def getItemProps(props: js.Any): KeyAny = ^.asInstanceOf[js.Dynamic].applyDynamic("getItemProps")(props.asInstanceOf[js.Any]).asInstanceOf[KeyAny]
    
    inline def getMenuProps(): KeyAny = ^.asInstanceOf[js.Dynamic].applyDynamic("getMenuProps")().asInstanceOf[KeyAny]
    inline def getMenuProps(props: js.Any): KeyAny = ^.asInstanceOf[js.Dynamic].applyDynamic("getMenuProps")(props.asInstanceOf[js.Any]).asInstanceOf[KeyAny]
    ...
    inline def highlightedIndex_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("highlightedIndex")(x.asInstanceOf[js.Any])
    ...
    inline def results_=(x: js.Array[Matches]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("results")(x.asInstanceOf[js.Any])
  }
  ...
  object noResults {
    ...
    inline def results_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("results")(x.asInstanceOf[js.Any])
  }
  ...
  object searching {
    ...
    inline def results_=(x: js.Array[Item]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("results")(x.asInstanceOf[js.Any])
  }
}
