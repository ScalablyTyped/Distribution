...
import typings.storybookUi.storybookUiStrings.reset
...
import typings.storybookUi.storybookUiStrings.submit
...
@js.native
trait PickDetailedHTMLPropsButt extends js.Object {
...
object PickDetailedHTMLPropsButt {
  ...
  @scala.inline
  def apply(): PickDetailedHTMLPropsButt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDetailedHTMLPropsButt]
  }
  
  @scala.inline
  implicit class PickDetailedHTMLPropsButtOps[Self <: PickDetailedHTMLPropsButt] (val x: Self) extends AnyVal {
