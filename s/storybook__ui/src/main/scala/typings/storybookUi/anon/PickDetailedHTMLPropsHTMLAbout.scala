...
@js.native
trait PickDetailedHTMLPropsHTMLAbout extends js.Object {
...
object PickDetailedHTMLPropsHTMLAbout {
  ...
  @scala.inline
  implicit class PickDetailedHTMLPropsHTMLAboutOps[Self <: PickDetailedHTMLPropsHTMLAbout] (val x: Self) extends AnyVal {
