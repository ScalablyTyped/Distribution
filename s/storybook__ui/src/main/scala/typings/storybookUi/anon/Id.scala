...
object Id {
  ...
  inline def apply(id: String, onClick: HandlerFunction, title: String): Id = {
  ...
  extension [Self <: Id](x: Self) {
    ...
    inline def setOnClick(value: HandlerFunction): Self = StObject.set(x, "onClick", value.asInstanceOf[js.Any])
