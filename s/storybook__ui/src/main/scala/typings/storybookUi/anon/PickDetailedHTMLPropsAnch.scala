...
object PickDetailedHTMLPropsAnch {
  
  @scala.inline
  def apply(): PickDetailedHTMLPropsAnch = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickDetailedHTMLPropsAnch]
  }
  
  @scala.inline
  implicit class PickDetailedHTMLPropsAnchMutableBuilder[Self <: PickDetailedHTMLPropsAnch] (val x: Self) extends AnyVal {
