...
object BasePanelRenderPropsalign {
  ...
  inline def apply(align: PanelPosition, animate: Boolean, hidden: Boolean, position: Bounds): BasePanelRenderPropsalign = {
  ...
  extension [Self <: BasePanelRenderPropsalign](x: Self) {
    
    inline def setAlign(value: PanelPosition): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
