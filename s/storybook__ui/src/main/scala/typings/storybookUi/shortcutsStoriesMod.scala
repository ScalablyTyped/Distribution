...
object shortcutsStoriesMod {
  ...
  object default {
    ...
    inline def component_=(x: Instantiable1[/* props */ ShortcutsScreenProps, ShortcutsScreen]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
