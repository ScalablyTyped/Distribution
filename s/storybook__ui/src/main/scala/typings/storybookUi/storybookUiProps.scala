...
trait storybookUiProps {
  @scala.inline
  def LinkProps: AnonChildIds.type = typings.storybookUi.AnonChildIds
  type LinkProps = AnonChildIds
  @scala.inline
  ...
  type SidebarProps = typings.storybookUi.sidebarMod.SidebarProps
  @scala.inline
  def SidebarDotstoriesComponentProps: typings.storybookUi.sidebarMod.SidebarProps.type = typings.storybookUi.sidebarMod.SidebarProps
  type SidebarDotstoriesComponentProps = typings.storybookUi.sidebarMod.SidebarProps
  @scala.inline
  ...
  @scala.inline
  def SidebarStoriesDotstoriesComponentProps: StoriesProps.type = typings.storybookUi.sidebarSidebarStoriesMod.StoriesProps
  type SidebarStoriesDotstoriesComponentProps = StoriesProps
}
