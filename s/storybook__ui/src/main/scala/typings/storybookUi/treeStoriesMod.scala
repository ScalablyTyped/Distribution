...
object treeStoriesMod {
  ...
  object default {
    ...
    inline def component_=(x: NamedExoticComponent[HighlightedRef]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("component")(x.asInstanceOf[js.Any])
  ...
  inline def Full(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Full")().asInstanceOf[Element]
  
  inline def SingleStoryComponents(): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("SingleStoryComponents")().asInstanceOf[Element]
}
