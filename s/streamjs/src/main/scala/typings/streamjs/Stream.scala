...
import typings.streamjs.StreamNs.Accumulator
import typings.streamjs.StreamNs.Collector
import typings.streamjs.StreamNs.Comparator
import typings.streamjs.StreamNs.Consumer
import typings.streamjs.StreamNs.Function
import typings.streamjs.StreamNs.GroupingResult
import typings.streamjs.StreamNs.Iterator
import typings.streamjs.StreamNs.JoinOptions
import typings.streamjs.StreamNs.Map
import typings.streamjs.StreamNs.Optional
import typings.streamjs.StreamNs.Predicate
import typings.streamjs.StreamNs.Sample
import typings.streamjs.StreamNs.Supplier
...
object Stream extends js.Object {
  def from(str: String): Stream[String] = js.native
  def from[T](elems: js.Array[T]): Stream[T] = js.native
  def generate[T](supplier: Supplier[T]): Stream[T] = js.native
  def iterate[T](seed: T, fn: Function[T, T]): Stream[T] = js.native
  def of[T](elems: T*): Stream[T] = js.native
  def range(startInclusive: Double, endExclusive: Double): Stream[Double] = js.native
  def rangeClosed(startInclusive: Double, endInclusive: Double): Stream[Double] = js.native
}
