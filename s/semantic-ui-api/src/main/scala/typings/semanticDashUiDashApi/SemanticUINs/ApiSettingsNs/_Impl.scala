package typings.semanticDashUiDashApi.SemanticUINs.ApiSettingsNs
...
import typings.semanticDashUiDashApi.SemanticUINs.ApiNs.ClassNameSettings
import typings.semanticDashUiDashApi.SemanticUINs.ApiNs.ErrorSettings
import typings.semanticDashUiDashApi.SemanticUINs.ApiNs.MetadataSettings
import typings.semanticDashUiDashApi.SemanticUINs.ApiNs.RegExpSettings
import typings.semanticDashUiDashApi.SemanticUINs.ApiNs.SelectorSettings
...
import typings.semanticDashUiDashApi.semanticDashUiDashApiNumbers.`true`
...
object _Impl {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], api = api, beforeSend = js.Any.fromFunction1(beforeSend), beforeXHR = js.Any.fromFunction1(beforeXHR), cache = cache.asInstanceOf[js.Any], className = className, data = data, dataType = dataType.asInstanceOf[js.Any], debug = debug, defaultData = defaultData, encodeParameters = encodeParameters, error = error, errorDuration = errorDuration.asInstanceOf[js.Any], hideError = hideError.asInstanceOf[js.Any], interruptRequests = interruptRequests, loadingDuration = loadingDuration, metadata = metadata, method = method.asInstanceOf[js.Any], mockResponse = mockResponse.asInstanceOf[js.Any], mockResponseAsync = mockResponseAsync.asInstanceOf[js.Any], name = name, namespace = namespace, on = on, onAbort = js.Any.fromFunction3(onAbort), onComplete = js.Any.fromFunction3(onComplete), onError = js.Any.fromFunction3(onError), onFailure = js.Any.fromFunction2(onFailure), onRequest = js.Any.fromFunction2(onRequest), onResponse = js.Any.fromFunction1(onResponse), onSuccess = js.Any.fromFunction3(onSuccess), performance = performance, regExp = regExp, response = response.asInstanceOf[js.Any], responseAsync = responseAsync.asInstanceOf[js.Any], selector = selector, serializeForm = serializeForm, silent = silent, stateContext = stateContext.asInstanceOf[js.Any], successTest = js.Any.fromFunction1(successTest), throttle = throttle, throttleFirstRequest = throttleFirstRequest, url = url.asInstanceOf[js.Any], urlData = urlData.asInstanceOf[js.Any], verbose = verbose)
