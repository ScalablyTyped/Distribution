...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'throttleFirstRequest'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplthrottleFirstRequ
  extends StObject
     with Param {
