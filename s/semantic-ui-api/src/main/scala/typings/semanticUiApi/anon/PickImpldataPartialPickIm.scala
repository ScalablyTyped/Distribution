...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'data'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImpldataPartialPickIm
  extends StObject
     with Param {
...
object PickImpldataPartialPickIm {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldataPartialPickIm] (val x: Self) extends AnyVal {
