...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'beforeXHR'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplbeforeXHRPartialP
  extends StObject
     with Param {
...
object PickImplbeforeXHRPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplbeforeXHRPartialP] (val x: Self) extends AnyVal {
