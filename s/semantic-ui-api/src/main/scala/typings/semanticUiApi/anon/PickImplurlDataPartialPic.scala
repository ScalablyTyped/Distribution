...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'urlData'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplurlDataPartialPic
  extends StObject
     with Param {
...
object PickImplurlDataPartialPic {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplurlDataPartialPic] (val x: Self) extends AnyVal {
