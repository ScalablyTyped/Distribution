...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'name'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
