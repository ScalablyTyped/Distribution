...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'response'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplresponsePartialPi
  extends StObject
     with Param {
...
object PickImplresponsePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplresponsePartialPi] (val x: Self) extends AnyVal {
