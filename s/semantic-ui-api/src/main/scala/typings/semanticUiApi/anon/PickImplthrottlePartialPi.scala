...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'throttle'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplthrottlePartialPi
  extends StObject
     with Param {
  ...
  var throttle: Double & js.UndefOr[Double]
...
object PickImplthrottlePartialPi {
  ...
  inline def apply(throttle: Double & js.UndefOr[Double]): PickImplthrottlePartialPi = {
  ...
  extension [Self <: PickImplthrottlePartialPi](x: Self) {
    ...
    inline def setThrottle(value: Double & js.UndefOr[Double]): Self = StObject.set(x, "throttle", value.asInstanceOf[js.Any])
