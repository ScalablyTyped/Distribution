...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'responseAsync'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplresponseAsyncPart
  extends StObject
     with Param {
...
object PickImplresponseAsyncPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplresponseAsyncPart] (val x: Self) extends AnyVal {
