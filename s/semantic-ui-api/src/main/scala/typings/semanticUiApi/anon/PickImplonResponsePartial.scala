...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'onResponse'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplonResponsePartial
  extends StObject
     with Param {
...
object PickImplonResponsePartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonResponsePartial] (val x: Self) extends AnyVal {
