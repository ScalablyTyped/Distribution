...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'hideError'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplhideErrorPartialP
  extends StObject
     with Param {
...
object PickImplhideErrorPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplhideErrorPartialP] (val x: Self) extends AnyVal {
