...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'errorDuration'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplerrorDurationPart
  extends StObject
     with Param {
...
object PickImplerrorDurationPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplerrorDurationPart] (val x: Self) extends AnyVal {
