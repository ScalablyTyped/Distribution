...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'mockResponse'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplmockResponseParti
  extends StObject
     with Param {
...
object PickImplmockResponseParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmockResponseParti] (val x: Self) extends AnyVal {
