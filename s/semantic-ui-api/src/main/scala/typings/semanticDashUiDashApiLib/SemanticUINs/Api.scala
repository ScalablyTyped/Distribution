...
trait Api extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashApiLib.semanticDashUiDashApiLibStrings.setting, name: K): js.Any = js.native
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashApiLib.semanticDashUiDashApiLibStrings.setting, name: K, value: js.Any): semanticDashUiDashApiLib.JQuery = js.native
}
