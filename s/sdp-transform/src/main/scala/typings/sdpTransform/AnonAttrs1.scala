...
trait AnonAttrs1 extends js.Object {
  var attrs1: String
...
object AnonAttrs1 {
  @scala.inline
  def apply(attrs1: String, dir1: String, pt: Double | String, attrs2: String = null, dir2: String = null): AnonAttrs1 = {
