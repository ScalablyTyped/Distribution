...
object global {
  ...
  object Strophe {
    ...
    class Connection protected ()
      ...
      def this(service: String, options: typings.strophe.mod.Strophe.ConnectionOptions) = this()
    }
    ...
    object LogLevel extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.strophe.mod.Strophe.LogLevel & Double] = js.native
    ...
    type LogLevel = typings.strophe.mod.Strophe.LogLevel
    ...
    @js.native
    def SASLAnonymous: typings.strophe.mod.Strophe.SASLMechanism = js.native
    inline def SASLAnonymous_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLAnonymous")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLMD5")
    @js.native
    def SASLMD5: typings.strophe.mod.Strophe.SASLMechanism = js.native
    inline def SASLMD5_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLMD5")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLPlain")
    @js.native
    def SASLPlain: typings.strophe.mod.Strophe.SASLMechanism = js.native
    inline def SASLPlain_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLPlain")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLSHA1")
    @js.native
    def SASLSHA1: typings.strophe.mod.Strophe.SASLMechanism = js.native
    inline def SASLSHA1_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLSHA1")(x.asInstanceOf[js.Any])
    ...
    object Status extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.strophe.mod.Strophe.Status & Double] = js.native
    ...
    type Status = typings.strophe.mod.Strophe.Status
    ...
    /** Function: log
      ...
      *    (String) msg - The log message.
      */
    inline def log(level: typings.strophe.mod.Strophe.LogLevel, msg: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("log")(level.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def serialize(elem: typings.strophe.mod.Strophe.Builder): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serialize")(elem.asInstanceOf[js.Any]).asInstanceOf[String]
    ...
    type ConnectionOptions = typings.strophe.mod.Strophe.ConnectionOptions
    
    type SASLMechanism = typings.strophe.mod.Strophe.SASLMechanism
  }
  
  /* was `typeof _$build` */
  inline def build(name: String): Builder = js.Dynamic.global.applyDynamic("$build")(name.asInstanceOf[js.Any]).asInstanceOf[Builder]
  inline def build(name: String, attrs: js.Any): Builder = (js.Dynamic.global.applyDynamic("$build")(name.asInstanceOf[js.Any], attrs.asInstanceOf[js.Any])).asInstanceOf[Builder]
  
  /* was `typeof _$iq` */
  inline def iq(): Builder = js.Dynamic.global.applyDynamic("$iq")().asInstanceOf[Builder]
  inline def iq(attrs: js.Any): Builder = js.Dynamic.global.applyDynamic("$iq")(attrs.asInstanceOf[js.Any]).asInstanceOf[Builder]
  
  /* was `typeof _$msg` */
  inline def msg(): Builder = js.Dynamic.global.applyDynamic("$msg")().asInstanceOf[Builder]
  inline def msg(attrs: js.Any): Builder = js.Dynamic.global.applyDynamic("$msg")(attrs.asInstanceOf[js.Any]).asInstanceOf[Builder]
  
  /* was `typeof _$pres` */
  inline def pres(): Builder = js.Dynamic.global.applyDynamic("$pres")().asInstanceOf[Builder]
  inline def pres(attrs: js.Any): Builder = js.Dynamic.global.applyDynamic("$pres")(attrs.asInstanceOf[js.Any]).asInstanceOf[Builder]
}
