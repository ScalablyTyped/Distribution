...
object global {
  ...
  object Strophe {
    ...
    @scala.inline
    def SASLAnonymous_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLAnonymous")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLMD5")
    @js.native
    def SASLMD5: typings.strophe.mod.Strophe.SASLMechanism = js.native
    @scala.inline
    def SASLMD5_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLMD5")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLPlain")
    @js.native
    def SASLPlain: typings.strophe.mod.Strophe.SASLMechanism = js.native
    @scala.inline
    def SASLPlain_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLPlain")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Strophe.SASLSHA1")
    @js.native
    def SASLSHA1: typings.strophe.mod.Strophe.SASLMechanism = js.native
    @scala.inline
    def SASLSHA1_=(x: typings.strophe.mod.Strophe.SASLMechanism): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SASLSHA1")(x.asInstanceOf[js.Any])
    ...
    /** Function: log
      ...
      */
    @scala.inline
    def log(level: typings.strophe.mod.Strophe.LogLevel, msg: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("log")(level.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    @scala.inline
    def serialize(elem: typings.strophe.mod.Strophe.Builder): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serialize")(elem.asInstanceOf[js.Any]).asInstanceOf[String]
