...
import typings.strophe.mod.ConnectionOptions
import typings.strophe.mod.LogLevel
import typings.strophe.mod.SASLMechanism
...
object global {
  ...
  object Strophe {
    ...
    open class Builder protected ()
      extends typings.strophe.mod.Builder {
      /**
    ...
    open class Connection protected ()
      extends typings.strophe.mod.Connection {
    ...
    object LogLevel extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.strophe.mod.LogLevel & Double] = js.native
    ...
    object Status extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typings.strophe.mod.Status & Double] = js.native
    ...
    /**
      ...
      */
    inline def build(name: String): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$build")(name.asInstanceOf[js.Any]).asInstanceOf[typings.strophe.mod.Builder]
    inline def build(name: String, attrs: Any): typings.strophe.mod.Builder = (^.asInstanceOf[js.Dynamic].applyDynamic("$build")(name.asInstanceOf[js.Any], attrs.asInstanceOf[js.Any])).asInstanceOf[typings.strophe.mod.Builder]
    ...
    /**
      ...
      *  A new Strophe.Builder object.
      */
    inline def iq(): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$iq")().asInstanceOf[typings.strophe.mod.Builder]
    inline def iq(attrs: Any): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$iq")(attrs.asInstanceOf[js.Any]).asInstanceOf[typings.strophe.mod.Builder]
    ...
    /**
      ...
      *  A new Strophe.Builder object.
      */
    inline def msg(): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$msg")().asInstanceOf[typings.strophe.mod.Builder]
    inline def msg(attrs: Any): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$msg")(attrs.asInstanceOf[js.Any]).asInstanceOf[typings.strophe.mod.Builder]
    ...
    /**
      ...
      *  A new Strophe.Builder object.
      */
    inline def pres(): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$pres")().asInstanceOf[typings.strophe.mod.Builder]
    inline def pres(attrs: Any): typings.strophe.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("$pres")(attrs.asInstanceOf[js.Any]).asInstanceOf[typings.strophe.mod.Builder]
    ...
    inline def serialize(elem: typings.strophe.mod.Builder): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serialize")(elem.asInstanceOf[js.Any]).asInstanceOf[String]
