...
@js.native
trait Occupant
  extends typings.strophe.mucMod.stropheMod.Strophe.MUC.OccupantInfo {
  ...
  def update(data: typings.strophe.mucMod.stropheMod.Strophe.MUC.OccupantInfo): Unit = js.native
