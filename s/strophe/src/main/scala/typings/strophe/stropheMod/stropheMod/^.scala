...
import typings.strophe.stropheMod.StropheNs.SASLMechanism
...
object ^ extends js.Object {
  ...
  /** Function: log
    ...
    *    (String) msg - The log message.
    */
  def log(level: typings.strophe.stropheMod.StropheNs.LogLevel, msg: String): Unit = js.native
  /** Function: serialize
  ...
  def serialize(elem: typings.strophe.stropheMod.StropheNs.Builder): String = js.native
