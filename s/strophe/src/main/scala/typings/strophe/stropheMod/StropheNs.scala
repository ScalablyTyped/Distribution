...
import typings.strophe.stropheMod.StropheNs.Connection
...
import typings.strophe.stropheMod.StropheNs.Status
...
object StropheNs extends js.Object {
  ...
  object MUCNs extends js.Object {
    @js.native
    trait Occupant
      extends typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.OccupantInfo {
      ...
      def update(data: typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.OccupantInfo): Unit = js.native
    ...
    trait Plugin extends js.Object {
      ...
      /**
        ...
        */
      def init(conn: typings.strophe.mucMod.stropheMod.StropheNs.Connection): Unit = js.native
      /**
      ...
      def join(
        ...
        msg_handler_cb: js.Function2[
              /* stanza */ Element, 
              /* room */ typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.XmppRoom, 
              Boolean
            ],
        ...
        roster_cb: js.Function2[
              /* occupants */ typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.OccupantMap, 
              /* room */ typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.XmppRoom, 
              Boolean
            ]
      ): Unit = js.native
    ...
    type OccupantMap = StringDictionary[typings.strophe.mucMod.stropheMod.StropheNs.MUCNs.Occupant]
  }
