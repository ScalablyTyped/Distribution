...
object anon {
  ...
  @js.native
  trait TypeofReactDOM extends StObject {
    ...
    def unstable_batchedUpdates(callback: js.Function0[js.Any]): Unit = js.native
    def unstable_batchedUpdates[A](callback: js.Function1[/* a */ A, js.Any], a: A): Unit = js.native
    def unstable_batchedUpdates[A, B](callback: js.Function2[/* a */ A, /* b */ B, js.Any], a: A, b: B): Unit = js.native
    ...
    def unstable_renderSubtreeIntoContainer[P](parentComponent: Component[js.Any, js.Object, js.Any], element: ReactElement, container: Element): (Component[P, ComponentState, js.Any]) | Element | Unit = js.native
    ...
    ): (Component[P, ComponentState, js.Any]) | Element | Unit = js.native
    def unstable_renderSubtreeIntoContainer[P, T /* <: Component[P, ComponentState, js.Any] */](parentComponent: Component[js.Any, js.Object, js.Any], element: CElement[P, T], container: Element): T = js.native
    def unstable_renderSubtreeIntoContainer[P, T /* <: Component[P, ComponentState, js.Any] */](
      parentComponent: Component[js.Any, js.Object, js.Any],
