...
trait Anon_Lazy extends js.Object {
  ...
  var Component: org.scalablytyped.runtime.Instantiable1[
    /* props */ stdLib.Readonly[js.Object], 
    reactLib.reactMod.Component[js.Object, js.Object, js.Object]
  ] = js.native
  val Fragment: reactLib.reactMod.ReactNs.ExoticComponent[reactLib.Anon_Children] = js.native
  var PureComponent: org.scalablytyped.runtime.Instantiable0[reactLib.reactMod.PureComponent[js.Object, js.Object, js.Any]] = js.native
  val StrictMode: reactLib.reactMod.ReactNs.ExoticComponent[reactLib.Anon_Children] = js.native
  /**
  ...
  @JSName("createElement")
  def createElement_input(`type`: singleDashSpaDashReactLib.singleDashSpaDashReactLibStrings.input): reactLib.reactMod.ReactNs.DetailedReactHTMLElement[
    reactLib.reactMod.ReactNs.InputHTMLAttributes[reactLib.HTMLInputElement], 
    reactLib.HTMLInputElement
  ] = js.native
  @JSName("createElement")
  def createElement_input(
    `type`: singleDashSpaDashReactLib.singleDashSpaDashReactLibStrings.input,
