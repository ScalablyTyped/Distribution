...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-element-to-jsx-string" % "15.0.0-72ec64",
  ...
  "org.scalablytyped" %%% "storybook__core-common" % "6.5.12-da131e",
  "org.scalablytyped" %%% "storybook__docs-tools" % "6.5.12-7c33c6",
