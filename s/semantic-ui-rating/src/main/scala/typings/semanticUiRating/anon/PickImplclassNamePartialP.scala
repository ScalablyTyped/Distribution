...
/* Inlined std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, 'className'> & std.Partial<std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, keyof semantic-ui-rating.SemanticUI.RatingSettings._Impl>> */
