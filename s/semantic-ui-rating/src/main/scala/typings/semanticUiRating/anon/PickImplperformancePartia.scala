...
/* Inlined std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, 'performance'> & std.Partial<std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, keyof semantic-ui-rating.SemanticUI.RatingSettings._Impl>> */
