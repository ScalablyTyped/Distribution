...
object ^ extends js.Object {
  ...
  @JSName("useLDflex")
  def useLDflex_false(expression: java.lang.String, listMode: atSolidReactLib.atSolidReactLibNumbers.`false`): js.Tuple3[LDflexValue, scala.Boolean, js.UndefOr[stdLib.Error]] = js.native
  @JSName("useLDflex")
  def useLDflex_true(expression: java.lang.String, listMode: atSolidReactLib.atSolidReactLibNumbers.`true`): js.Tuple3[js.Array[LDflexValue], scala.Boolean, js.UndefOr[stdLib.Error]] = js.native
