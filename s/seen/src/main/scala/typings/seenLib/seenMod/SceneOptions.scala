...
trait SceneOptions extends js.Object {
  ...
  var cullBackfaces: js.UndefOr[scala.Boolean] = js.undefined
  var fractionalPoints: js.UndefOr[scala.Boolean] = js.undefined
...
object SceneOptions {
  ...
  def apply(
    ...
    camera: Camera = null,
    cullBackfaces: js.UndefOr[scala.Boolean] = js.undefined,
    fractionalPoints: js.UndefOr[scala.Boolean] = js.undefined,
    model: Model = null,
    shader: Shader = null,
