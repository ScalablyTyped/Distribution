...
version := "0.6-dt-20190212Z-1e4eb1"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "bunyan" % "1.8-dt-20190311Z-25aaeb",
  ...
  "org.scalablytyped" %%% "hapi" % "18.0-dt-20190426Z-0a7801",
  "org.scalablytyped" %%% "iron" % "5.0-dt-20180214Z-905511",
  ...
  "org.scalablytyped" %%% "restify" % "8.4-dt-20190826Z-0ececf",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-7db036",
  "org.scalablytyped" %%% "shot" % "4.0-dt-20181002Z-a8d2ba",
  "org.scalablytyped" %%% "spdy" % "3.4-dt-20181121Z-eea42b",
