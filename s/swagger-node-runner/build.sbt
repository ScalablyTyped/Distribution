...
version := "0.6-dt-20190212Z-c1e22f"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "hapi" % "18.0-dt-20190426Z-f45aad",
  "org.scalablytyped" %%% "iron" % "5.0-dt-20180214Z-ecc900",
  ...
  "org.scalablytyped" %%% "restify" % "7.2-dt-20190716Z-9069b6",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-42b281",
  "org.scalablytyped" %%% "shot" % "4.0-dt-20181002Z-9d6f29",
  "org.scalablytyped" %%% "spdy" % "3.4-dt-20181121Z-acdae6",
