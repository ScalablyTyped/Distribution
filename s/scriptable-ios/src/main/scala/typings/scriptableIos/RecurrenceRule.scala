...
object RecurrenceRule extends js.Object {
  ...
  /**
    ...
    */
  def complexWeeklyEndDate(interval: Double, daysOfTheWeek: js.Array[Double], setPositions: js.Array[Double], endDate: Date): RecurrenceRule = js.native
  /**
  ...
  /**
    ...
    */
  def dailyEndDate(interval: Double, endDate: Date): RecurrenceRule = js.native
  /**
  ...
  /**
    ...
    */
  def monthlyEndDate(interval: Double, endDate: Date): RecurrenceRule = js.native
  /**
  ...
  /**
    ...
    */
  def weeklyEndDate(interval: Double, endDate: Date): RecurrenceRule = js.native
  /**
  ...
  /**
    ...
    */
  def yearlyEndDate(interval: Double, endDate: Date): RecurrenceRule = js.native
  /**
