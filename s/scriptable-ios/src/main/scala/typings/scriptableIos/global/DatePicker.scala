...
class DatePicker ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var countdownDuration: Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var initialDate: Date = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var maximumDate: Date = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var minimumDate: Date = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var minuteInterval: Double = js.native
  /**
