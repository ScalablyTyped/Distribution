...
object Device {
  ...
  /**
    ...
    */
  inline def screenResolution(): typings.scriptableIos.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("screenResolution")().asInstanceOf[typings.scriptableIos.Size]
  ...
  /**
    ...
    */
  inline def screenSize(): typings.scriptableIos.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("screenSize")().asInstanceOf[typings.scriptableIos.Size]
