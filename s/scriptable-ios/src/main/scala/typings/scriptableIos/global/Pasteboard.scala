...
object Pasteboard {
  ...
  /**
    ...
    */
  @scala.inline
  def copy(string: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("copy")(string.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def copyImage(image: typings.scriptableIos.Image): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("copyImage")(image.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def copyString(string: String): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("copyString")(string.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  @scala.inline
  def pasteImage(): typings.scriptableIos.Image = ^.asInstanceOf[js.Dynamic].applyDynamic("pasteImage")().asInstanceOf[typings.scriptableIos.Image]
  ...
  /**
    ...
    */
  @scala.inline
  def pasteString(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("pasteString")().asInstanceOf[String]
}
