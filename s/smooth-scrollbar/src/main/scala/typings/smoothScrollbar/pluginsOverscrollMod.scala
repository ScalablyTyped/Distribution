...
object pluginsOverscrollMod {
  ...
  object OverscrollEffect extends StObject {
    ...
    /* "bounce" */ val BOUNCE: typings.smoothScrollbar.pluginsOverscrollMod.OverscrollEffect.BOUNCE & String = js.native
    
    @js.native
    sealed trait GLOW
      extends StObject
         with OverscrollEffect
    /* "glow" */ val GLOW: typings.smoothScrollbar.pluginsOverscrollMod.OverscrollEffect.GLOW & String = js.native
  }
