...
object Default {
  ...
  extension [Self <: Default](x: Self) {
    ...
    inline def setDefault(value: `-st-default`): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
    
    inline def setExtends(value: `-st-extends`): Self = StObject.set(x, "extends", value.asInstanceOf[js.Any])
    
    inline def setFrom(value: `-st-from`): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
    
    inline def setGlobal(value: `-st-global`): Self = StObject.set(x, "global", value.asInstanceOf[js.Any])
    
    inline def setMixin(value: `-st-mixin`): Self = StObject.set(x, "mixin", value.asInstanceOf[js.Any])
    
    inline def setNamed(value: `-st-named`): Self = StObject.set(x, "named", value.asInstanceOf[js.Any])
    
    inline def setPartialMixin(value: `-st-partial-mixin`): Self = StObject.set(x, "partialMixin", value.asInstanceOf[js.Any])
    
    inline def setRoot(value: `-st-root`): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
    
    inline def setStates(value: `-st-states`): Self = StObject.set(x, "states", value.asInstanceOf[js.Any])
  }
}
