...
object stylableProcessorMod {
  ...
  class StylableProcessor () extends StObject {
    ...
    /* protected */ @JSName("extendTypedRule")
    def extendTypedRule_stextends(node: Node, selector: String, key: `-st-extends`, value: js.Any): Unit = js.native
    /* protected */ @JSName("extendTypedRule")
    def extendTypedRule_stglobal(node: Node, selector: String, key: `-st-global`, value: js.Any): Unit = js.native
    /* protected */ @JSName("extendTypedRule")
    def extendTypedRule_stroot(node: Node, selector: String, key: `-st-root`, value: js.Any): Unit = js.native
    /* protected */ @JSName("extendTypedRule")
    def extendTypedRule_ststates(node: Node, selector: String, key: `-st-states`, value: js.Any): Unit = js.native
    ...
    /* private */ var handleNamespaceReference: js.Any = js.native
    ...
    /* protected */ var meta: typings.stylableCore.stylableMetaMod.StylableMeta = js.native
    
    def process(root: Root_): typings.stylableCore.stylableMetaMod.StylableMeta = js.native
    
    /* private */ var resolveNamespace: js.Any = js.native
    
    /* protected */ def setClassGlobalMapping(decl: Declaration, rule: Rule_): Unit = js.native
  }
  
  inline def createEmptyMeta(root: Root_, diagnostics: Diagnostics): typings.stylableCore.stylableMetaMod.StylableMeta = (^.asInstanceOf[js.Dynamic].applyDynamic("createEmptyMeta")(root.asInstanceOf[js.Any], diagnostics.asInstanceOf[js.Any])).asInstanceOf[typings.stylableCore.stylableMetaMod.StylableMeta]
  ...
  inline def process(root: Root_, diagnostics: Diagnostics): typings.stylableCore.stylableMetaMod.StylableMeta = (^.asInstanceOf[js.Dynamic].applyDynamic("process")(root.asInstanceOf[js.Any], diagnostics.asInstanceOf[js.Any])).asInstanceOf[typings.stylableCore.stylableMetaMod.StylableMeta]
  inline def process(
    root: Root_,
    diagnostics: Diagnostics,
    resolveNamespace: js.Function2[/* namespace */ String, /* source */ String, String]
  ...
  inline def validateScopingSelector(atRule: AtRule_, hasScopingSelector: SRule, diagnostics: Diagnostics): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("validateScopingSelector")(atRule.asInstanceOf[js.Any], hasScopingSelector.asInstanceOf[js.Any], diagnostics.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object DeclStylableProps {
    ...
    inline def apply(sourceValue: String): DeclStylableProps = {
      val __obj = js.Dynamic.literal(sourceValue = sourceValue.asInstanceOf[js.Any])
      __obj.asInstanceOf[DeclStylableProps]
    }
    
    extension [Self <: DeclStylableProps](x: Self) {
      
      inline def setSourceValue(value: String): Self = StObject.set(x, "sourceValue", value.asInstanceOf[js.Any])
    }
  }
