...
object customValuesMod {
  ...
  @scala.inline
  def resolveCustomValues(meta: StylableMeta, resolver: StylableResolver): StringDictionary[CustomValueExtension[js.Any]] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveCustomValues")(meta.asInstanceOf[js.Any], resolver.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[CustomValueExtension[js.Any]]]
  ...
  object Box_ {
    ...
    @scala.inline
    implicit class Box_MutableBuilder[Self <: Box_[?, ?], Type /* <: String */, Value /* <: js.Any */] (val x: Self & (Box_[Type, Value])) extends AnyVal {
  ...
  object CustomValueExtension {
    ...
    @scala.inline
    implicit class CustomValueExtensionMutableBuilder[Self <: CustomValueExtension[?], T] (val x: Self & CustomValueExtension[T]) extends AnyVal {
      
      @scala.inline
      def setEvalVarAst(value: (ParsedValue, StringDictionary[CustomValueExtension[js.Any]]) => Box_[String, T]): Self = StObject.set(x, "evalVarAst", js.Any.fromFunction2(value))
  ...
  object ExtensionApi {
    ...
    @scala.inline
    implicit class ExtensionApiMutableBuilder[Self <: ExtensionApi[?, ?], Value, Args] (val x: Self & (ExtensionApi[Value, Args])) extends AnyVal {
      ...
      @scala.inline
      def setGetValue(value: (Value, String) => String | (Box_[String, js.Any])): Self = StObject.set(x, "getValue", js.Any.fromFunction2(value))
  ...
  object JSValueExtension {
    ...
    @scala.inline
    def apply[Value](register: String => CustomValueExtension[Value]): JSValueExtension[Value] = {
    ...
    @scala.inline
    implicit class JSValueExtensionMutableBuilder[Self <: JSValueExtension[?], Value] (val x: Self & JSValueExtension[Value]) extends AnyVal {
