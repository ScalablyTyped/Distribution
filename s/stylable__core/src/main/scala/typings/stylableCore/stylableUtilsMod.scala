...
object stylableUtilsMod {
  ...
  inline def expandCustomSelectors(rule: Rule_, customSelectors: Record[String, String], diagnostics: Diagnostics): String = (^.asInstanceOf[js.Dynamic].applyDynamic("expandCustomSelectors")(rule.asInstanceOf[js.Any], customSelectors.asInstanceOf[js.Any], diagnostics.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def getSourcePath(root: Root_, diagnostics: Diagnostics): String = (^.asInstanceOf[js.Dynamic].applyDynamic("getSourcePath")(root.asInstanceOf[js.Any], diagnostics.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def scopeCSSVar(resolver: StylableResolver, meta: StylableMeta, symbolName: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("scopeCSSVar")(resolver.asInstanceOf[js.Any], meta.asInstanceOf[js.Any], symbolName.asInstanceOf[js.Any])).asInstanceOf[String]
