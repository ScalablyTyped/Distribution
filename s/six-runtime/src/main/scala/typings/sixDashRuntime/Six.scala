...
import typings.sixDashRuntime.SixNs.PluginsMap
import typings.sixDashRuntime.SixNs.pluginsNs.rpc
import typings.sixDashRuntime.SixNs.pluginsNs.timeNs.timmer
import typings.sixDashRuntime.SixNs.pluginsNs.viewNs.render
import typings.sixDashRuntime.SixNs.pluginsNs.viewNs.runtimeConf
...
trait Six extends js.Object {
  /**
    ...
    */
  var DataProvider: typings.sixDashRuntime.SixNs.pluginsNs.dataProviderNs.DataProvider = js.native
  /**
    * NODE_ENV的缩短版
    *
  ...
  /**
    ...
    */
  var http: typings.sixDashRuntime.SixNs.pluginsNs.http = js.native
  /**
    * 打日志方法
    */
  var log: typings.sixDashRuntime.SixNs.pluginsNs.log = js.native
  /**
    * Six的plugin的map
    */
