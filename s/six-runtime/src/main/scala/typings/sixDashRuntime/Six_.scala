...
import typings.sixDashRuntime.Six.PluginsMap
import typings.sixDashRuntime.Six.plugins.rpc
import typings.sixDashRuntime.Six.plugins.time.timmer
import typings.sixDashRuntime.Six.plugins.view.render
import typings.sixDashRuntime.Six.plugins.view.runtimeConf
...
trait Six_ extends js.Object {
  /**
    ...
    */
  var DataProvider: typings.sixDashRuntime.Six.plugins.dataProvider.DataProvider = js.native
  /**
    * NODE_ENV的缩短版
    *
  ...
  /**
    ...
    */
  var http: typings.sixDashRuntime.Six.plugins.http = js.native
  /**
    * 打日志方法
    */
  var log: typings.sixDashRuntime.Six.plugins.log = js.native
  /**
    * Six的plugin的map
    */
