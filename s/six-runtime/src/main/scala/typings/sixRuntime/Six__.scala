...
import typings.sixRuntime.Six_.PluginsMap
import typings.sixRuntime.Six_.plugins.rpc
import typings.sixRuntime.Six_.plugins.time.timmer
import typings.sixRuntime.Six_.plugins.view.render
import typings.sixRuntime.Six_.plugins.view.runtimeConf
...
trait Six__ extends js.Object {
  /**
    ...
    */
  var DataProvider: typings.sixRuntime.Six_.plugins.dataProvider.DataProvider = js.native
  /**
    * NODE_ENV的缩短版
    *
  ...
  /**
    ...
    */
  var http: typings.sixRuntime.Six_.plugins.http = js.native
  /**
    * 打日志方法
    */
  var log: typings.sixRuntime.Six_.plugins.log = js.native
  /**
    * Six的plugin的map
    */
