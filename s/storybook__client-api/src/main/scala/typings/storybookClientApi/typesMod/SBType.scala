...
object SBType {
  ...
  inline def SBArrayType(value: SBType): typings.storybookClientApi.typesMod.SBArrayType = {
  ...
  inline def SBEnumType(value: js.Array[String | Double]): typings.storybookClientApi.typesMod.SBEnumType = {
  ...
  inline def SBIntersectionType(value: js.Array[SBType]): typings.storybookClientApi.typesMod.SBIntersectionType = {
  ...
  inline def SBObjectType(value: Record[String, SBType]): typings.storybookClientApi.typesMod.SBObjectType = {
  ...
  inline def SBOtherType(value: String): typings.storybookClientApi.typesMod.SBOtherType = {
  ...
  inline def SBScalarType(name: boolean | string | number | function): typings.storybookClientApi.typesMod.SBScalarType = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.storybookClientApi.typesMod.SBScalarType]
  }
  
  inline def SBUnionType(value: js.Array[SBType]): typings.storybookClientApi.typesMod.SBUnionType = {
