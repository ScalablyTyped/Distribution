...
@js.native
trait RenderContextWithoutStoryContext extends js.Object {
...
object RenderContextWithoutStoryContext {
  ...
  @scala.inline
  implicit class RenderContextWithoutStoryContextOps[Self <: RenderContextWithoutStoryContext] (val x: Self) extends AnyVal {
