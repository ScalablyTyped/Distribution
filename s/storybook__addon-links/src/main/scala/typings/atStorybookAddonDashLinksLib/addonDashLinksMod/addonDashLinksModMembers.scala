package typings
package atStorybookAddonDashLinksLib.addonDashLinksMod
...
@js.native
object addonDashLinksModMembers extends js.Object {
  def hrefTo(kind: java.lang.String, story: java.lang.String): stdLib.Promise[java.lang.String] = js.native
