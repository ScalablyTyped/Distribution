...
trait Anon_CallbackDefaultValue extends js.Object {
...
object Anon_CallbackDefaultValue {
  @scala.inline
  def apply(
    label: String,
    name: String,
    ...
    __obj.asInstanceOf[Anon_CallbackDefaultValue]
  }
}
