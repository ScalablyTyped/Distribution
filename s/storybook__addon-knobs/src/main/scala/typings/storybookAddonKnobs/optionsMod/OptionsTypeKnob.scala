...
object OptionsTypeKnob {
  ...
  @scala.inline
  implicit class OptionsTypeKnobOps[Self <: OptionsTypeKnob[_], T /* <: OptionsTypeKnobValue[OptionsTypeKnobSingleValue] */] (val x: Self with OptionsTypeKnob[T]) extends AnyVal {
