...
trait AnonKnobsOnFieldChange extends js.Object {
  var knobs: js.Array[KnobStoreKnob]
  def onFieldChange(): Unit
  def onFieldClick(): Unit
}

object AnonKnobsOnFieldChange {
  @scala.inline
  def apply(knobs: js.Array[KnobStoreKnob], onFieldChange: () => Unit, onFieldClick: () => Unit): AnonKnobsOnFieldChange = {
    ...
    __obj.asInstanceOf[AnonKnobsOnFieldChange]
  }
}
