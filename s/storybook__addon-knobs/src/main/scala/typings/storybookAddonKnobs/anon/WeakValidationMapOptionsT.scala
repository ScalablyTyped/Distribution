...
trait WeakValidationMapOptionsT extends StObject {
  ...
  var knob: js.UndefOr[Validator[js.UndefOr[Null | OptionsTypeKnob[Any]]]] = js.undefined
  
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* value */ Any, Any]) | Null]]] = js.undefined
}
object WeakValidationMapOptionsT {
  ...
  extension [Self <: WeakValidationMapOptionsT](x: Self) {
    ...
    inline def setKnob(value: Validator[js.UndefOr[Null | OptionsTypeKnob[Any]]]): Self = StObject.set(x, "knob", value.asInstanceOf[js.Any])
    
    inline def setKnobUndefined: Self = StObject.set(x, "knob", js.undefined)
    
    inline def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* value */ Any, Any]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
