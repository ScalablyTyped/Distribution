...
object PickOptionsTypeKnobanyopt {
  ...
  inline def apply(options: OptionsTypeOptionsProp[js.Any], optionsObj: OptionsKnobOptions, value: js.Any): PickOptionsTypeKnobanyopt = {
  ...
  extension [Self <: PickOptionsTypeKnobanyopt](x: Self) {
    ...
    inline def setOptions(value: OptionsTypeOptionsProp[js.Any]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
