...
import typings.storybookAddonKnobs.distComponentsTypesNumberMod.NumberTypeKnob
...
object KnobValidator {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: KnobValidator] (val x: Self) extends AnyVal {
