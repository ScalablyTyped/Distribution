...
trait AnonCallbackDefaultValueGroupId extends js.Object {
...
object AnonCallbackDefaultValueGroupId {
  @scala.inline
  def apply(
    label: String,
    name: String,
  ...
  ): AnonCallbackDefaultValueGroupId = {
    ...
    __obj.asInstanceOf[AnonCallbackDefaultValueGroupId]
  }
}
