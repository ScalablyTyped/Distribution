...
object errorsMod {
  ...
  @JSImport("@sinclair/typebox/errors", "ValueErrorIterator")
  @js.native
  open class ValueErrorIterator protected ()
    extends typings.sinclairTypebox.errorsErrorsMod.ValueErrorIterator {
    def this(iterator: IterableIterator[ValueError]) = this()
  }
  
  @JSImport("@sinclair/typebox/errors", "ValueErrorType")
  @js.native
  ...
  object ValueErrors {
    ...
    @JSImport("@sinclair/typebox/errors", "ValueErrors")
    @js.native
    val ^ : js.Any = js.native
    
    inline def Errors[T /* <: TSchema */](schema: T, references: js.Array[TSchema], value: Any): typings.sinclairTypebox.errorsErrorsMod.ValueErrorIterator = (^.asInstanceOf[js.Dynamic].applyDynamic("Errors")(schema.asInstanceOf[js.Any], references.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typings.sinclairTypebox.errorsErrorsMod.ValueErrorIterator]
  }
  
  @JSImport("@sinclair/typebox/errors", "ValueErrorsDereferenceError")
  @js.native
  open class ValueErrorsDereferenceError protected ()
    extends typings.sinclairTypebox.errorsErrorsMod.ValueErrorsDereferenceError {
    def this(schema: TRef[TSchema]) = this()
    def this(schema: TThis) = this()
  }
  
  @JSImport("@sinclair/typebox/errors", "ValueErrorsUnknownTypeError")
  @js.native
  open class ValueErrorsUnknownTypeError protected ()
    extends typings.sinclairTypebox.errorsErrorsMod.ValueErrorsUnknownTypeError {
