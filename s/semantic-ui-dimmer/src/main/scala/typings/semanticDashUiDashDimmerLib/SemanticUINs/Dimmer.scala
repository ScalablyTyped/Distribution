...
trait Dimmer extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashDimmerLib.semanticDashUiDashDimmerLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl[K] */ js.Any = js.native
