package typings.semanticDashUiDashDimmer.SemanticUINs.DimmerSettingsNs

import typings.semanticDashUiDashDimmer.JQuery
import typings.semanticDashUiDashDimmer.SemanticUINs.DimmerNs.ClassNameSettings
import typings.semanticDashUiDashDimmer.SemanticUINs.DimmerNs.DurationSettings
import typings.semanticDashUiDashDimmer.SemanticUINs.DimmerNs.ErrorSettings
import typings.semanticDashUiDashDimmer.SemanticUINs.DimmerNs.SelectorSettings
import typings.semanticDashUiDashDimmer.SemanticUINs.DimmerNs.TemplateSettings
