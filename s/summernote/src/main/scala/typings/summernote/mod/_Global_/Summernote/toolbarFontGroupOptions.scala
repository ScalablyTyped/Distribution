...
import typings.summernote.summernoteStrings.backcolor_
import typings.summernote.summernoteStrings.fontname_
import typings.summernote.summernoteStrings.fontsize_
import typings.summernote.summernoteStrings.forecolor_
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.summernote.summernoteStrings.forecolor_
  - typings.summernote.summernoteStrings.backcolor_
...
object toolbarFontGroupOptions {
  ...
  @scala.inline
  def bold: typings.summernote.summernoteStrings.bold = this.cast("bold")
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def clear: typings.summernote.summernoteStrings.clear = this.cast("clear")
  @scala.inline
  ...
  @scala.inline
  def italic: typings.summernote.summernoteStrings.italic = this.cast("italic")
  @scala.inline
  ...
  @scala.inline
  def underline: typings.summernote.summernoteStrings.underline = this.cast("underline")
}
