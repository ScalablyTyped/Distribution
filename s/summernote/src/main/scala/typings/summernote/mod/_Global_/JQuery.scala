...
import typings.jquery.JQuery_.Node
import typings.summernote.mod._Global_.Summernote.CreateLinkOptions
import typings.summernote.mod._Global_.Summernote.EditImageCallback
import typings.summernote.mod._Global_.Summernote.Options
