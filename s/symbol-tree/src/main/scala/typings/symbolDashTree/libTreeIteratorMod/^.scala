...
import typings.symbolDashTree.symbolDashTreeNumbers.`1`
import typings.symbolDashTree.symbolDashTreeNumbers.`2`
import typings.symbolDashTree.symbolDashTreeNumbers.`3`
import typings.symbolDashTree.symbolDashTreeNumbers.`4`
import typings.symbolDashTree.symbolDashTreeNumbers.`5`
...
class ^[T /* <: js.Object */] protected () extends TreeIterator[T] {
  def this(
    tree: typings.symbolDashTree.libSymbolTreeMod.^[_],
    root: T,
    firstResult: T,
