...
import typings.symbolDashTree.Anon_Filter
...
trait SymbolTree[T /* <: js.Object */] extends js.Object {
  /**
  	 ...
  	 */
  def ancestorsIterator(`object`: T): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  ...
  @JSName("ancestorsToArray")
  def ancestorsToArray_THIS[THIS](`object`: T, options: ToArrayOptions[T] with (Anon_Filter[THIS, T])): js.Array[T] = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def childrenIterator(parent: T): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  def childrenIterator(parent: T, options: IteratorOptions): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  ...
  @JSName("childrenToArray")
  def childrenToArray_THIS[THIS](parent: T, options: ToArrayOptions[T] with (Anon_Filter[THIS, T])): js.Array[T] = js.native
  /**
  ...
  def initialize(): js.UndefOr[scala.Nothing] = js.native
  def initialize[O /* <: T */](`object`: O): O = js.native
  /**
  	 ...
  	 */
  @JSName("initialize")
  def initialize_Null(): Null = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def nextSiblingsIterator(`object`: T): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def previousSiblingsIterator(`object`: T): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def treeIterator(`object`: T): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  def treeIterator(`object`: T, options: IteratorOptions): typings.symbolDashTree.libTreeIteratorMod.^[T] = js.native
  ...
  @JSName("treeToArray")
  def treeToArray_THIS[THIS](`object`: T, options: ToArrayOptions[T] with (Anon_Filter[THIS, T])): js.Array[T] = js.native
}
