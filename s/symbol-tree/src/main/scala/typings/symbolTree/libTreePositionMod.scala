...
object libTreePositionMod {
  
  @JSImport("symbol-tree/lib/TreePosition", "CONTAINED_BY")
  @js.native
  val CONTAINED_BY: `16` = js.native
  
  @JSImport("symbol-tree/lib/TreePosition", "CONTAINS")
  @js.native
  val CONTAINS: `8` = js.native
  
  @JSImport("symbol-tree/lib/TreePosition", "DISCONNECTED")
  @js.native
  val DISCONNECTED: `1` = js.native
  
  @JSImport("symbol-tree/lib/TreePosition", "FOLLOWING")
  @js.native
  val FOLLOWING: `4` = js.native
  
  @JSImport("symbol-tree/lib/TreePosition", "PRECEDING")
  @js.native
