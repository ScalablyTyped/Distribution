...
object PartialFullConfiguration {
  ...
  implicit open class MutableBuilder[Self <: PartialFullConfiguration] (val x: Self) extends AnyVal {
    ...
    inline def setOnError(value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction3(value))
    
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati, /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Unit
    ...
    inline def setOnLoadingSlow(value: (/* key */ String, /* config */ ReadonlyPublicConfigurati) => Unit): Self = StObject.set(x, "onLoadingSlow", js.Any.fromFunction2(value))
    
    inline def setOnLoadingSlowUndefined: Self = StObject.set(x, "onLoadingSlow", js.undefined)
    
    inline def setOnSuccess(value: (/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati) => Unit): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3(value))
