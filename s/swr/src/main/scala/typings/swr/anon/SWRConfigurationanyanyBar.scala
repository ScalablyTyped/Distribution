...
/* Inlined swr.swr/dist/types.SWRConfiguration<any, any, swr.swr/dist/types.BareFetcher<any>> & std.Partial<swr.swr/dist/types.ProviderConfiguration> & {  provider :(cache : std.Readonly<swr.swr/dist/types.Cache<any>>): swr.swr/dist/types.Cache<any> | undefined} */
trait SWRConfigurationanyanyBar extends StObject {
  ...
  var onError: js.UndefOr[
    js.Function3[/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiCompare, Unit]
  ] = js.undefined
  ...
  var onErrorRetry: js.UndefOr[
    js.Function5[
      /* err */ Any, 
      /* key */ String, 
      /* config */ ReadonlyPublicConfiguratiCompare, 
  ...
  var onLoadingSlow: js.UndefOr[
    js.Function2[/* key */ String, /* config */ ReadonlyPublicConfiguratiCompare, Unit]
  ] = js.undefined
  
  var onSuccess: js.UndefOr[
    js.Function3[/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiCompare, Unit]
  ] = js.undefined
  
  var provider: js.UndefOr[js.Function1[/* cache */ ReadonlyCacheany, Cache[Any]]] = js.undefined
...
object SWRConfigurationanyanyBar {
  
  inline def apply(): SWRConfigurationanyanyBar = {
  ...
  implicit open class MutableBuilder[Self <: SWRConfigurationanyanyBar] (val x: Self) extends AnyVal {
    ...
    inline def setOnError(value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiCompare) => Unit): Self = StObject.set(x, "onError", js.Any.fromFunction3(value))
    
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiCompare, /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Unit
    ...
    inline def setOnLoadingSlow(value: (/* key */ String, /* config */ ReadonlyPublicConfiguratiCompare) => Unit): Self = StObject.set(x, "onLoadingSlow", js.Any.fromFunction2(value))
    
    inline def setOnLoadingSlowUndefined: Self = StObject.set(x, "onLoadingSlow", js.undefined)
    
    inline def setOnSuccess(value: (/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiCompare) => Unit): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3(value))
    
    inline def setOnSuccessUndefined: Self = StObject.set(x, "onSuccess", js.undefined)
    
    inline def setProvider(value: /* cache */ ReadonlyCacheany => Cache[Any]): Self = StObject.set(x, "provider", js.Any.fromFunction1(value))
