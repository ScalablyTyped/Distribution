...
trait ReadonlyPublicConfiguratiDedupingInterval extends StObject {
...
object ReadonlyPublicConfiguratiDedupingInterval {
  ...
  inline def apply(
    ...
    onErrorRetry: (/* err */ Any, /* key */ String, /* config */ PublicConfiguration[Any, Any, BareFetcher[Any]], /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Unit,
  ...
  ): ReadonlyPublicConfiguratiDedupingInterval = {
  ...
  extension [Self <: ReadonlyPublicConfiguratiDedupingInterval](x: Self) {
    ...
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ PublicConfiguration[Any, Any, BareFetcher[Any]], /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Unit
