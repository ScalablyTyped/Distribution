...
trait CustomsDeclaration
  ...
  var exporter_identification: js.UndefOr[CustomsExporterIdentification] = js.undefined
...
object CustomsDeclaration {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(certify = certify.asInstanceOf[js.Any], certify_signer = certify_signer.asInstanceOf[js.Any], contents_type = contents_type.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], non_delivery_option = non_delivery_option.asInstanceOf[js.Any], object_created = object_created.asInstanceOf[js.Any], object_id = object_id.asInstanceOf[js.Any], object_owner = object_owner.asInstanceOf[js.Any], object_state = object_state.asInstanceOf[js.Any], object_updated = object_updated.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomsDeclaration]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.shippo.shippoStrings.FILED_ELECTRONICALLY
    - typings.shippo.shippoStrings.SUMMARY_REPORTING
    - typings.shippo.shippoStrings.NOT_REQUIRED
  */
  trait B13aFilingOption extends StObject
  object B13aFilingOption {
    
    inline def FILED_ELECTRONICALLY: typings.shippo.shippoStrings.FILED_ELECTRONICALLY = "FILED_ELECTRONICALLY".asInstanceOf[typings.shippo.shippoStrings.FILED_ELECTRONICALLY]
    
    inline def NOT_REQUIRED: typings.shippo.shippoStrings.NOT_REQUIRED = "NOT_REQUIRED".asInstanceOf[typings.shippo.shippoStrings.NOT_REQUIRED]
    
    inline def SUMMARY_REPORTING: typings.shippo.shippoStrings.SUMMARY_REPORTING = "SUMMARY_REPORTING".asInstanceOf[typings.shippo.shippoStrings.SUMMARY_REPORTING]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typings.shippo.shippoStrings.DOCUMENTS
    - typings.shippo.shippoStrings.GIFT
    - typings.shippo.shippoStrings.SAMPLE
    - typings.shippo.shippoStrings.MERCHANDISE
    - typings.shippo.shippoStrings.HUMANITARIAN_DONATION
    - typings.shippo.shippoStrings.RETURN_MERCHANDISE
    - typings.shippo.shippoStrings.OTHER
    - java.lang.String
  */
  type ContentsType = _ContentsType | String
  
  /* Rewritten from type alias, can be one of: 
    - typings.shippo.shippoStrings.NOEEI_30_37_a
    - typings.shippo.shippoStrings.NOEEI_30_37_h
    - typings.shippo.shippoStrings.NOEEI_30_37_f
    - typings.shippo.shippoStrings.NOEEI_30_36
    - typings.shippo.shippoStrings.AES_ITN
  */
  trait EelPfc extends StObject
  object EelPfc {
    
    inline def AES_ITN: typings.shippo.shippoStrings.AES_ITN = "AES_ITN".asInstanceOf[typings.shippo.shippoStrings.AES_ITN]
    
    inline def NOEEI_30_36: typings.shippo.shippoStrings.NOEEI_30_36 = "NOEEI_30_36".asInstanceOf[typings.shippo.shippoStrings.NOEEI_30_36]
    
    inline def NOEEI_30_37_a: typings.shippo.shippoStrings.NOEEI_30_37_a = "NOEEI_30_37_a".asInstanceOf[typings.shippo.shippoStrings.NOEEI_30_37_a]
    
    inline def NOEEI_30_37_f: typings.shippo.shippoStrings.NOEEI_30_37_f = "NOEEI_30_37_f".asInstanceOf[typings.shippo.shippoStrings.NOEEI_30_37_f]
    
    inline def NOEEI_30_37_h: typings.shippo.shippoStrings.NOEEI_30_37_h = "NOEEI_30_37_h".asInstanceOf[typings.shippo.shippoStrings.NOEEI_30_37_h]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomsDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setExporter_identification(value: CustomsExporterIdentification): Self = StObject.set(x, "exporter_identification", value.asInstanceOf[js.Any])
    
    inline def setExporter_identificationUndefined: Self = StObject.set(x, "exporter_identification", js.undefined)
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.shippo.shippoStrings.ABANDON
    - typings.shippo.shippoStrings.RETURN
    - java.lang.String
  */
  type NonDeliveryOption = _NonDeliveryOption | String
  
  trait _ContentsType extends StObject
  
  trait _NonDeliveryOption extends StObject
}
