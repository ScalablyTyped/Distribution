...
trait ServiceLevel extends StObject {
  ...
  var parent_servicelevel: Extendedtoken | String | Null
...
object ServiceLevel {
  ...
  inline def apply(extended_token: String, name: String, terms: String, token: ServiceLevels): ServiceLevel = {
    val __obj = js.Dynamic.literal(extended_token = extended_token.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], terms = terms.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any], parent_servicelevel = null)
  ...
  implicit open class MutableBuilder[Self <: ServiceLevel] (val x: Self) extends AnyVal {
    ...
    inline def setParent_servicelevel(value: Extendedtoken | String): Self = StObject.set(x, "parent_servicelevel", value.asInstanceOf[js.Any])
