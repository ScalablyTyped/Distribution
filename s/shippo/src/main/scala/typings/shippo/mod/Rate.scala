...
object Rate {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.shippo.shippoStrings.CHEAPEST
    - typings.shippo.shippoStrings.FASTEST
    - typings.shippo.shippoStrings.BESTVALUE
  */
  trait Attribute extends StObject
  object Attribute {
    
    inline def BESTVALUE: typings.shippo.shippoStrings.BESTVALUE = "BESTVALUE".asInstanceOf[typings.shippo.shippoStrings.BESTVALUE]
    
    inline def CHEAPEST: typings.shippo.shippoStrings.CHEAPEST = "CHEAPEST".asInstanceOf[typings.shippo.shippoStrings.CHEAPEST]
    
    inline def FASTEST: typings.shippo.shippoStrings.FASTEST = "FASTEST".asInstanceOf[typings.shippo.shippoStrings.FASTEST]
  }
