...
import typings.shippo.mod.Address.ValidationResults
...
trait Address
  ...
  var validation_results: js.UndefOr[ValidationResults] = js.undefined
...
object Address {
  ...
  implicit open class MutableBuilder[Self <: Address] (val x: Self) extends AnyVal {
    ...
    inline def setValidation_results(value: ValidationResults): Self = StObject.set(x, "validation_results", value.asInstanceOf[js.Any])
  ...
  trait ValidationResults extends StObject {
  ...
  object ValidationResults {
    ...
    inline def apply(): ValidationResults = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ValidationResults]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: ValidationResults] (val x: Self) extends AnyVal {
