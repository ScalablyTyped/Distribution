...
import typings.syslogPro.mod.CEF.ExtensionType
import typings.syslogPro.mod.CEF.Severity
import typings.syslogPro.mod.CEF.SeverityNumber
...
object syslogProInts {
  ...
  sealed trait `0`
    extends StObject
       with ExtensionType
       with Severity
       with typings.syslogPro.mod.RFC5424.Severity
       with typings.syslogPro.mod.RFC3164.Severity
       with SeverityNumber
