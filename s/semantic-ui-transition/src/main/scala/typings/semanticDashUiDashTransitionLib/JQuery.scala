...
trait JQuery extends js.Object {
  ...
  @JSName("transition")
  def transition_setting[K /* <: java.lang.String */](behavior: semanticDashUiDashTransitionLib.semanticDashUiDashTransitionLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-transition.SemanticUI.TransitionSettings._Impl[K] */ js.Any = js.native
  @JSName("transition")
