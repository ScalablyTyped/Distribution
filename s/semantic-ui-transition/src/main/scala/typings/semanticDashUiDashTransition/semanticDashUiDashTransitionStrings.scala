...
object semanticDashUiDashTransitionStrings {
  @js.native
  ...
  @js.native
  sealed trait `clear queue` extends js.Object
  ...
  @js.native
  sealed trait `force repaint` extends js.Object
  
  @js.native
  sealed trait `get animation event` extends js.Object
  ...
  @js.native
  sealed trait `is looping` extends js.Object
  
  @js.native
  sealed trait `is supported` extends js.Object
  ...
  @js.native
  sealed trait `remove looping` extends js.Object
  ...
  @js.native
  sealed trait `restore conditions` extends js.Object
  
  @js.native
  sealed trait reverse extends js.Object
  
  @js.native
  sealed trait `save conditions` extends js.Object
  
  @js.native
  sealed trait `set duration` extends js.Object
  ...
  @js.native
  sealed trait `stop all` extends js.Object
