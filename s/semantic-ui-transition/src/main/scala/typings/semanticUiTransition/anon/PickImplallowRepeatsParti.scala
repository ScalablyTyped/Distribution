...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'allowRepeats'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImplallowRepeatsParti
  extends StObject
     with Param {
...
object PickImplallowRepeatsParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplallowRepeatsParti] (val x: Self) extends AnyVal {
