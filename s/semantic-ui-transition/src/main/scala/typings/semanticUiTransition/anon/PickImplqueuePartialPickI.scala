...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'queue'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImplqueuePartialPickI
  extends StObject
     with Param {
...
object PickImplqueuePartialPickI {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplqueuePartialPickI] (val x: Self) extends AnyVal {
