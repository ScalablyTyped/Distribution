...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl, 'inward'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl, keyof semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl>> */
trait PickImplinwardPartialPick
  extends StObject
     with Param {
  ...
  var inward: String & js.UndefOr[String]
...
object PickImplinwardPartialPick {
  
  inline def apply(inward: String & js.UndefOr[String]): PickImplinwardPartialPick = {
    val __obj = js.Dynamic.literal(inward = inward.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplinwardPartialPick]
  }
  
  extension [Self <: PickImplinwardPartialPick](x: Self) {
    ...
    inline def setInward(value: String & js.UndefOr[String]): Self = StObject.set(x, "inward", value.asInstanceOf[js.Any])
