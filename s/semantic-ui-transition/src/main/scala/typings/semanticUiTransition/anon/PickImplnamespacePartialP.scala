...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'namespace'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
...
object PickImplnamespacePartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplnamespacePartialP] (val x: Self) extends AnyVal {
