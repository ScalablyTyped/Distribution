...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'onHide'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImplonHidePartialPick
  extends StObject
     with Param {
...
object PickImplonHidePartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonHidePartialPick] (val x: Self) extends AnyVal {
