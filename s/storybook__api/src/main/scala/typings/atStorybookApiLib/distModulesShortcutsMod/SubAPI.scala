package typings
package atStorybookApiLib.distModulesShortcutsMod
...
object SubAPI {
  ...
  def apply(
    ...
    handleKeydownEvent: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify API */ js.Any, Event) => scala.Unit,
    handleShortcutFeature: (/* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify API */ js.Any, Action) => scala.Unit,
