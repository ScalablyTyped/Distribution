...
object distTs3Dot9ModulesAddonsMod {
  ...
  object types extends StObject {
    ...
    sealed trait NOTES_ELEMENT
      extends StObject
         with types
    /* "notes-element" */ val NOTES_ELEMENT: typings.storybookApi.distTs3Dot9ModulesAddonsMod.types.NOTES_ELEMENT & String = js.native
    
    @js.native
    sealed trait PANEL
      extends StObject
         with types
    /* "panel" */ val PANEL: typings.storybookApi.distTs3Dot9ModulesAddonsMod.types.PANEL & String = js.native
    
    @js.native
    sealed trait PREVIEW
      extends StObject
         with types
    /* "preview" */ val PREVIEW: typings.storybookApi.distTs3Dot9ModulesAddonsMod.types.PREVIEW & String = js.native
    
    @js.native
    sealed trait TAB
      extends StObject
         with types
    /* "tab" */ val TAB: typings.storybookApi.distTs3Dot9ModulesAddonsMod.types.TAB & String = js.native
    
    @js.native
    sealed trait TOOL
      extends StObject
         with types
    /* "tool" */ val TOOL: typings.storybookApi.distTs3Dot9ModulesAddonsMod.types.TOOL & String = js.native
  }
