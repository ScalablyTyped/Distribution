...
import typings.ssh2DashStreams.ssh2DashStreamsStrings.NEWKEYS
import typings.ssh2DashStreams.ssh2DashStreamsStrings.REQUEST_FAILURE
import typings.ssh2DashStreams.ssh2DashStreamsStrings.REQUEST_SUCCESS
import typings.ssh2DashStreams.ssh2DashStreamsStrings.SERVICE_ACCEPT
import typings.ssh2DashStreams.ssh2DashStreamsStrings.SERVICE_REQUEST
import typings.ssh2DashStreams.ssh2DashStreamsStrings.USERAUTH_BANNER
import typings.ssh2DashStreams.ssh2DashStreamsStrings.USERAUTH_FAILURE
import typings.ssh2DashStreams.ssh2DashStreamsStrings.USERAUTH_INFO_REQUEST
import typings.ssh2DashStreams.ssh2DashStreamsStrings.USERAUTH_INFO_RESPONSE
import typings.ssh2DashStreams.ssh2DashStreamsStrings.USERAUTH_PASSWD_CHANGEREQ
...
import typings.ssh2DashStreams.ssh2DashStreamsStrings.fingerprint
import typings.ssh2DashStreams.ssh2DashStreamsStrings.header
import typings.ssh2DashStreams.ssh2DashStreamsStrings.ready
