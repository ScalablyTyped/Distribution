...
object ChannelRequest {
  ...
  @scala.inline
  def EnvChannelRequest(key: String, recipient: Double, `val`: String, wantReply: Boolean): typings.ssh2Streams.mod.EnvChannelRequest = {
  ...
  @scala.inline
  def ExecChannelRequest(command: String, recipient: Double, wantReply: Boolean): typings.ssh2Streams.mod.ExecChannelRequest = {
  ...
  @scala.inline
  def ExitSignalChannelRequest(coredump: Boolean, description: String, recipient: Double, signal: String): typings.ssh2Streams.mod.ExitSignalChannelRequest = {
  ...
  @scala.inline
  def ExitStatusChannelRequest(code: Double, recipient: Double): typings.ssh2Streams.mod.ExitStatusChannelRequest = {
  ...
  @scala.inline
  def FlowControlChannelRequest(clientControl: Boolean, recipient: Double): typings.ssh2Streams.mod.FlowControlChannelRequest = {
  ...
  @scala.inline
  def ShellChannelRequest(recipient: Double, wantReply: Boolean): typings.ssh2Streams.mod.ShellChannelRequest = {
  ...
  @scala.inline
  def SignalChannelRequest(recipient: Double, signal: String): typings.ssh2Streams.mod.SignalChannelRequest = {
  ...
  @scala.inline
  def SubsystemChannelRequest(recipient: Double, subsystem: String, wantReply: Boolean): typings.ssh2Streams.mod.SubsystemChannelRequest = {
  ...
  @scala.inline
  def WindowChangeChannelRequest(cols: Double, height: Double, recipient: Double, rows: Double, width: Double): typings.ssh2Streams.mod.WindowChangeChannelRequest = {
