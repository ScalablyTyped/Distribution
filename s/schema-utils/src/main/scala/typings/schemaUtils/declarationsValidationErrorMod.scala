...
object declarationsValidationErrorMod {
  ...
  type PostFormatter = typings.schemaUtils.declarationsValidateMod.PostFormatter
  ...
  type ValidationErrorConfiguration = typings.schemaUtils.declarationsValidateMod.ValidationErrorConfiguration
}
