...
object declarationsValidateMod {
  ...
  open class ValidationError protected () extends default {
    /**
      ...
      */
    def this(
      errors: js.Array[typings.schemaUtils.declarationsValidationErrorMod.SchemaUtilErrorObject],
      schema: typings.schemaUtils.declarationsValidationErrorMod.Schema
    ) = this()
    def this(
      errors: js.Array[typings.schemaUtils.declarationsValidationErrorMod.SchemaUtilErrorObject],
      schema: typings.schemaUtils.declarationsValidationErrorMod.Schema,
      configuration: typings.schemaUtils.declarationsValidationErrorMod.ValidationErrorConfiguration
    ) = this()
  }
