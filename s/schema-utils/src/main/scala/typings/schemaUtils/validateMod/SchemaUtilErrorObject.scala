...
object SchemaUtilErrorObject {
  ...
  implicit class SchemaUtilErrorObjectOps[Self <: SchemaUtilErrorObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildrenVarargs(value: typings.ajv.mod.ErrorObject*): Self = this.set("children", js.Array(value :_*))
    
    @scala.inline
    def setChildren(value: js.Array[typings.ajv.mod.ErrorObject]): Self = this.set("children", value.asInstanceOf[js.Any])
