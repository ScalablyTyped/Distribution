package typings.schemaDashUtils.declarationsValidateMod
...
object ValidationErrorConfiguration {
  ...
  def apply(
    ...
    name: String = null,
    postFormatter: (/* formattedError */ String, /* error */ typings.ajv.ajvMod.ErrorObject with Anon_Children) => String = null
