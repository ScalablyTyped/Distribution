...
trait ValidationError extends Error {
  ...
  def formatSchema(schema: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6): String = js.native
  def formatSchema(schema: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6, prevSchemas: js.Array[js.Object]): String = js.native
  def formatSchema(schema: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7): String = js.native
  def formatSchema(schema: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7, prevSchemas: js.Array[js.Object]): String = js.native
  /**
  ...
  /**
    ...
    * @returns {Schema}
    */
  def getSchemaPart(path: String): JSONSchema4 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7 = js.native
  /**
  ...
  def getSchemaPartDescription(schemaPart: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6): String = js.native
  def getSchemaPartDescription(schemaPart: typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7): String = js.native
  /**
    * @param {Schema=} schemaPart
  ...
  def getSchemaPartText(
    schemaPart: JSONSchema4 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7
  ): String = js.native
  def getSchemaPartText(
    schemaPart: JSONSchema4 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema6 | typings.jsonDashSchema.jsonDashSchemaMod.JSONSchema7,
