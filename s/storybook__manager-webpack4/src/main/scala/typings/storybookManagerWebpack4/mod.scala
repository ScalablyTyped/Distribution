...
object mod {
  ...
  @JSImport("@storybook/manager-webpack4", "WEBPACK_VERSION")
  @js.native
  val WEBPACK_VERSION: /* "4" */ String = js.native
  ...
  @JSImport("@storybook/manager-webpack4", "corePresets")
  @js.native
  val corePresets: js.UndefOr[js.Array[String]] = js.native
  
  object executor {
    
    @JSImport("@storybook/manager-webpack4", "executor")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("@storybook/manager-webpack4", "overridePresets")
  @js.native
  val overridePresets: js.UndefOr[js.Array[String]] = js.native
