...
trait ReturnStatement
  ...
  @JSName("type")
  var type_ReturnStatement: typings.swcCore.swcCoreStrings.ReturnStatement
}
object ReturnStatement {
  ...
  implicit open class MutableBuilder[Self <: ReturnStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ReturnStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
