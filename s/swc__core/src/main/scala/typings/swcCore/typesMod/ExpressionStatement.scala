...
trait ExpressionStatement
  ...
  @JSName("type")
  var type_ExpressionStatement: typings.swcCore.swcCoreStrings.ExpressionStatement
}
object ExpressionStatement {
  ...
  implicit open class MutableBuilder[Self <: ExpressionStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ExpressionStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
