...
trait TsConstructorType
  ...
  @JSName("type")
  var type_TsConstructorType: typings.swcCore.swcCoreStrings.TsConstructorType
}
object TsConstructorType {
  ...
  extension [Self <: TsConstructorType](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsConstructorType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
