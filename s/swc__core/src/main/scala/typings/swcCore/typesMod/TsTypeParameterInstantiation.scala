...
trait TsTypeParameterInstantiation
  ...
  @JSName("type")
  var type_TsTypeParameterInstantiation: typings.swcCore.swcCoreStrings.TsTypeParameterInstantiation
}
object TsTypeParameterInstantiation {
  ...
  extension [Self <: TsTypeParameterInstantiation](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsTypeParameterInstantiation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
