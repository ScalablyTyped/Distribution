...
trait WithStatement
  ...
  @JSName("type")
  var type_WithStatement: typings.swcCore.swcCoreStrings.WithStatement
}
object WithStatement {
  ...
  implicit open class MutableBuilder[Self <: WithStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.WithStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
