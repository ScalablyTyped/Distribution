...
trait ObjectPattern
  ...
  @JSName("type")
  var type_ObjectPattern: typings.swcCore.swcCoreStrings.ObjectPattern
}
object ObjectPattern {
  ...
  extension [Self <: ObjectPattern](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ObjectPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
