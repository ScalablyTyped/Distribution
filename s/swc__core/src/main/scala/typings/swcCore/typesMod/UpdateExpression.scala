...
trait UpdateExpression
  ...
  @JSName("type")
  var type_UpdateExpression: typings.swcCore.swcCoreStrings.UpdateExpression
}
object UpdateExpression {
  ...
  extension [Self <: UpdateExpression](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.UpdateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
