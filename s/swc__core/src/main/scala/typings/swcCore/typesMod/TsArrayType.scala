...
trait TsArrayType
  ...
  @JSName("type")
  var type_TsArrayType: typings.swcCore.swcCoreStrings.TsArrayType
}
object TsArrayType {
  ...
  implicit open class MutableBuilder[Self <: TsArrayType] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsArrayType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
