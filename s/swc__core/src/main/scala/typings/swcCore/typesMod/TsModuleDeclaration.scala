...
trait TsModuleDeclaration
  ...
  @JSName("type")
  var type_TsModuleDeclaration: typings.swcCore.swcCoreStrings.TsModuleDeclaration
}
object TsModuleDeclaration {
  ...
  extension [Self <: TsModuleDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsModuleDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
