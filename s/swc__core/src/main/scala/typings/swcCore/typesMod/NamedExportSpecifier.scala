...
trait NamedExportSpecifier
  ...
  @JSName("type")
  var type_NamedExportSpecifier: typings.swcCore.swcCoreStrings.ExportSpecifier
}
object NamedExportSpecifier {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NamedExportSpecifier] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ExportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
