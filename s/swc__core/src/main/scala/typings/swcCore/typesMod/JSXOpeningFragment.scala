...
trait JSXOpeningFragment
  ...
  @JSName("type")
  var type_JSXOpeningFragment: typings.swcCore.swcCoreStrings.JSXOpeningFragment
}
object JSXOpeningFragment {
  ...
  implicit open class MutableBuilder[Self <: JSXOpeningFragment] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.JSXOpeningFragment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
