...
trait TsTypeOperator
  ...
  @JSName("type")
  var type_TsTypeOperator: typings.swcCore.swcCoreStrings.TsTypeOperator
}
object TsTypeOperator {
  ...
  extension [Self <: TsTypeOperator](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsTypeOperator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
