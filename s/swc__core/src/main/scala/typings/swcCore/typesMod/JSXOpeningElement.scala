...
trait JSXOpeningElement
  ...
  @JSName("type")
  var type_JSXOpeningElement: typings.swcCore.swcCoreStrings.JSXOpeningElement
}
object JSXOpeningElement {
  ...
  extension [Self <: JSXOpeningElement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.JSXOpeningElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
