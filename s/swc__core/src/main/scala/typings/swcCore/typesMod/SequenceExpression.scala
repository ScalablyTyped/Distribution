...
trait SequenceExpression
  ...
  @JSName("type")
  var type_SequenceExpression: typings.swcCore.swcCoreStrings.SequenceExpression
}
object SequenceExpression {
  ...
  implicit open class MutableBuilder[Self <: SequenceExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.SequenceExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
