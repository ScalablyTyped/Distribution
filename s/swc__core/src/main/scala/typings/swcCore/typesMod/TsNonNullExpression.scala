...
trait TsNonNullExpression
  ...
  @JSName("type")
  var type_TsNonNullExpression: typings.swcCore.swcCoreStrings.TsNonNullExpression
}
object TsNonNullExpression {
  ...
  implicit open class MutableBuilder[Self <: TsNonNullExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsNonNullExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
