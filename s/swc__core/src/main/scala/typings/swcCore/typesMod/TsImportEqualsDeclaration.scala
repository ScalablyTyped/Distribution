...
trait TsImportEqualsDeclaration
  ...
  @JSName("type")
  var type_TsImportEqualsDeclaration: typings.swcCore.swcCoreStrings.TsImportEqualsDeclaration
}
object TsImportEqualsDeclaration {
  ...
  implicit open class MutableBuilder[Self <: TsImportEqualsDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsImportEqualsDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
