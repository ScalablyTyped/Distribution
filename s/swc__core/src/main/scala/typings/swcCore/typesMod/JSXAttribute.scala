...
trait JSXAttribute
  ...
  @JSName("type")
  var type_JSXAttribute: typings.swcCore.swcCoreStrings.JSXAttribute
...
object JSXAttribute {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: JSXAttribute] (val x: Self) extends AnyVal {
    
    inline def setName(value: JSXAttributeName): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setType(value: typings.swcCore.swcCoreStrings.JSXAttribute): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
