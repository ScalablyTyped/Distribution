...
trait VariableDeclaration
  ...
  @JSName("type")
  var type_VariableDeclaration: typings.swcCore.swcCoreStrings.VariableDeclaration
}
object VariableDeclaration {
  ...
  extension [Self <: VariableDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.VariableDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
