...
/* Rewritten from type alias, can be one of: 
  - typings.swcCore.typesMod.ThisExpression
  - typings.swcCore.typesMod.ArrayExpression
  - typings.swcCore.typesMod.ObjectExpression
  - typings.swcCore.typesMod.FunctionExpression
  - typings.swcCore.typesMod.UnaryExpression
  - typings.swcCore.typesMod.UpdateExpression
  - typings.swcCore.typesMod.BinaryExpression
  - typings.swcCore.typesMod.AssignmentExpression
  - typings.swcCore.typesMod.MemberExpression
  - typings.swcCore.typesMod.SuperPropExpression
  - typings.swcCore.typesMod.ConditionalExpression
  - typings.swcCore.typesMod.CallExpression
  - typings.swcCore.typesMod.NewExpression
  - typings.swcCore.typesMod.SequenceExpression
  - typings.swcCore.typesMod.Identifier
  - typings.swcCore.typesMod.Literal
  - typings.swcCore.typesMod.TemplateLiteral
  - typings.swcCore.typesMod.TaggedTemplateExpression
  - typings.swcCore.typesMod.ArrowFunctionExpression
  - typings.swcCore.typesMod.ClassExpression
  - typings.swcCore.typesMod.YieldExpression
  - typings.swcCore.typesMod.MetaProperty
  - typings.swcCore.typesMod.AwaitExpression
  - typings.swcCore.typesMod.ParenthesisExpression
  ...
  - typings.swcCore.typesMod.TsTypeAssertion
  - typings.swcCore.typesMod.TsConstAssertion
  - typings.swcCore.typesMod.TsNonNullExpression
  - typings.swcCore.typesMod.TsAsExpression
  - typings.swcCore.typesMod.TsInstantiation
  - typings.swcCore.typesMod.PrivateName
  - typings.swcCore.typesMod.OptionalChainingExpression
