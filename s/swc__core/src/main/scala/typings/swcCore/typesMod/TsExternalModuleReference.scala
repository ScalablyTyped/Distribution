...
trait TsExternalModuleReference
  ...
  @JSName("type")
  var type_TsExternalModuleReference: typings.swcCore.swcCoreStrings.TsExternalModuleReference
}
object TsExternalModuleReference {
  ...
  implicit open class MutableBuilder[Self <: TsExternalModuleReference] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsExternalModuleReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
