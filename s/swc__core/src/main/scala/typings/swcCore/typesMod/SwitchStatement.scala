...
trait SwitchStatement
  ...
  @JSName("type")
  var type_SwitchStatement: typings.swcCore.swcCoreStrings.SwitchStatement
}
object SwitchStatement {
  ...
  implicit open class MutableBuilder[Self <: SwitchStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.SwitchStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
