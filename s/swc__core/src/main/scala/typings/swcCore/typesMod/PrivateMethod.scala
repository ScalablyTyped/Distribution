...
trait PrivateMethod
  ...
  @JSName("type")
  var type_PrivateMethod: typings.swcCore.swcCoreStrings.PrivateMethod
}
object PrivateMethod {
  ...
  implicit open class MutableBuilder[Self <: PrivateMethod] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.PrivateMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
