...
trait ExportDeclaration
  ...
  @JSName("type")
  var type_ExportDeclaration: typings.swcCore.swcCoreStrings.ExportDeclaration
}
object ExportDeclaration {
  ...
  extension [Self <: ExportDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ExportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
