...
trait DoWhileStatement
  ...
  @JSName("type")
  var type_DoWhileStatement: typings.swcCore.swcCoreStrings.DoWhileStatement
}
object DoWhileStatement {
  ...
  extension [Self <: DoWhileStatement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.DoWhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
