...
trait BigIntLiteral
  ...
  @JSName("type")
  var type_BigIntLiteral: typings.swcCore.swcCoreStrings.BigIntLiteral
...
object BigIntLiteral {
  ...
  extension [Self <: BigIntLiteral](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.BigIntLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
