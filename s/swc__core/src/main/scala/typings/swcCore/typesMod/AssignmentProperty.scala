...
trait AssignmentProperty
  ...
  @JSName("type")
  var type_AssignmentProperty: typings.swcCore.swcCoreStrings.AssignmentProperty
...
object AssignmentProperty {
  ...
  extension [Self <: AssignmentProperty](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.AssignmentProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
