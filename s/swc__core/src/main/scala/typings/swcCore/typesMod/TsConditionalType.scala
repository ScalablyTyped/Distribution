...
trait TsConditionalType
  ...
  @JSName("type")
  var type_TsConditionalType: typings.swcCore.swcCoreStrings.TsConditionalType
}
object TsConditionalType {
  ...
  implicit open class MutableBuilder[Self <: TsConditionalType] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsConditionalType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
