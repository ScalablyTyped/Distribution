...
trait TsInstantiation
  ...
  @JSName("type")
  var type_TsInstantiation: typings.swcCore.swcCoreStrings.TsInstantiation
}
object TsInstantiation {
  ...
  extension [Self <: TsInstantiation](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsInstantiation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
