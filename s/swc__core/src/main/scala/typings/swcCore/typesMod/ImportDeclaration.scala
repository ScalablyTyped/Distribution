...
trait ImportDeclaration
  ...
  @JSName("type")
  var type_ImportDeclaration: typings.swcCore.swcCoreStrings.ImportDeclaration
}
object ImportDeclaration {
  ...
  implicit open class MutableBuilder[Self <: ImportDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ImportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
