...
trait SetterProperty
  ...
  @JSName("type")
  var type_SetterProperty: typings.swcCore.swcCoreStrings.SetterProperty
}
object SetterProperty {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SetterProperty] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.SetterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
