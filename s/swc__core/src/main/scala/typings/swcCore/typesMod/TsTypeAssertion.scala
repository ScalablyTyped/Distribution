...
trait TsTypeAssertion
  ...
  @JSName("type")
  var type_TsTypeAssertion: typings.swcCore.swcCoreStrings.TsTypeAssertion
}
object TsTypeAssertion {
  ...
  implicit open class MutableBuilder[Self <: TsTypeAssertion] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsTypeAssertion): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
