...
trait ForOfStatement
  ...
  @JSName("type")
  var type_ForOfStatement: typings.swcCore.swcCoreStrings.ForOfStatement
}
object ForOfStatement {
  ...
  implicit open class MutableBuilder[Self <: ForOfStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ForOfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
