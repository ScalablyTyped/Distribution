...
trait JSXExpressionContainer
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typings.swcCore.swcCoreStrings.JSXExpressionContainer
}
object JSXExpressionContainer {
  ...
  implicit open class MutableBuilder[Self <: JSXExpressionContainer] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.JSXExpressionContainer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
