...
trait PrivateName
  ...
  @JSName("type")
  var type_PrivateName: typings.swcCore.swcCoreStrings.PrivateName
}
object PrivateName {
  ...
  implicit open class MutableBuilder[Self <: PrivateName] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.PrivateName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
