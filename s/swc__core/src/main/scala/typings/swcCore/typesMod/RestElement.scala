...
trait RestElement
  ...
  @JSName("type")
  var type_RestElement: typings.swcCore.swcCoreStrings.RestElement
}
object RestElement {
  ...
  extension [Self <: RestElement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.RestElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
