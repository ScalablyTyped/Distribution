...
trait TsCallSignatureDeclaration
  ...
  @JSName("type")
  var type_TsCallSignatureDeclaration: typings.swcCore.swcCoreStrings.TsCallSignatureDeclaration
}
object TsCallSignatureDeclaration {
  ...
  implicit open class MutableBuilder[Self <: TsCallSignatureDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsCallSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
