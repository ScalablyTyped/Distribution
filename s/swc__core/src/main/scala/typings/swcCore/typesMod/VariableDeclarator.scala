...
trait VariableDeclarator
  ...
  @JSName("type")
  var type_VariableDeclarator: typings.swcCore.swcCoreStrings.VariableDeclarator
}
object VariableDeclarator {
  ...
  extension [Self <: VariableDeclarator](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.VariableDeclarator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
