...
trait TsConstructSignatureDeclaration
  ...
  @JSName("type")
  var type_TsConstructSignatureDeclaration: typings.swcCore.swcCoreStrings.TsConstructSignatureDeclaration
}
object TsConstructSignatureDeclaration {
  ...
  implicit open class MutableBuilder[Self <: TsConstructSignatureDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsConstructSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
