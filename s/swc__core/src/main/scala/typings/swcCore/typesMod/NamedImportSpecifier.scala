...
trait NamedImportSpecifier
  ...
  @JSName("type")
  var type_NamedImportSpecifier: typings.swcCore.swcCoreStrings.ImportSpecifier
}
object NamedImportSpecifier {
  ...
  implicit open class MutableBuilder[Self <: NamedImportSpecifier] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ImportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
