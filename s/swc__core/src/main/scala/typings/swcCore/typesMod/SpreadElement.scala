...
trait SpreadElement
  ...
  @JSName("type")
  var type_SpreadElement: typings.swcCore.swcCoreStrings.SpreadElement
}
object SpreadElement {
  ...
  extension [Self <: SpreadElement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.SpreadElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
