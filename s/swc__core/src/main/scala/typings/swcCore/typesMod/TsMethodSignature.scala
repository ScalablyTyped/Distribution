...
trait TsMethodSignature
  ...
  @JSName("type")
  var type_TsMethodSignature: typings.swcCore.swcCoreStrings.TsMethodSignature
}
object TsMethodSignature {
  ...
  implicit open class MutableBuilder[Self <: TsMethodSignature] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsMethodSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
