...
trait CatchClause
  ...
  @JSName("type")
  var type_CatchClause: typings.swcCore.swcCoreStrings.CatchClause
}
object CatchClause {
  ...
  extension [Self <: CatchClause](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.CatchClause): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
