...
trait TsGetterSignature
  ...
  @JSName("type")
  var type_TsGetterSignature: typings.swcCore.swcCoreStrings.TsGetterSignature
}
object TsGetterSignature {
  ...
  implicit open class MutableBuilder[Self <: TsGetterSignature] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsGetterSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
