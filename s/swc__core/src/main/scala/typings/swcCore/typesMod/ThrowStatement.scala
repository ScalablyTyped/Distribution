...
trait ThrowStatement
  ...
  @JSName("type")
  var type_ThrowStatement: typings.swcCore.swcCoreStrings.ThrowStatement
}
object ThrowStatement {
  ...
  implicit open class MutableBuilder[Self <: ThrowStatement] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.ThrowStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
