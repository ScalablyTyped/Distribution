...
trait TsTypeAliasDeclaration
  ...
  @JSName("type")
  var type_TsTypeAliasDeclaration: typings.swcCore.swcCoreStrings.TsTypeAliasDeclaration
}
object TsTypeAliasDeclaration {
  ...
  extension [Self <: TsTypeAliasDeclaration](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsTypeAliasDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
