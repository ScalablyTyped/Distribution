...
trait TsLiteralType
  ...
  @JSName("type")
  var type_TsLiteralType: typings.swcCore.swcCoreStrings.TsLiteralType
}
object TsLiteralType {
  ...
  extension [Self <: TsLiteralType](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsLiteralType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
