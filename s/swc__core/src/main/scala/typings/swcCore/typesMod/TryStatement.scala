...
trait TryStatement
  ...
  @JSName("type")
  var type_TryStatement: typings.swcCore.swcCoreStrings.TryStatement
}
object TryStatement {
  ...
  extension [Self <: TryStatement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TryStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
