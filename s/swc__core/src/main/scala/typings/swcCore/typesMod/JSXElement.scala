...
trait JSXElement
  ...
  @JSName("type")
  var type_JSXElement: typings.swcCore.swcCoreStrings.JSXElement
}
object JSXElement {
  ...
  extension [Self <: JSXElement](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.JSXElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
