...
trait MemberExpression
  ...
  @JSName("type")
  var type_MemberExpression: typings.swcCore.swcCoreStrings.MemberExpression
}
object MemberExpression {
  ...
  implicit open class MutableBuilder[Self <: MemberExpression] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.MemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
