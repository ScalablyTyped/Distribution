...
trait TsNamespaceDeclaration
  ...
  @JSName("type")
  var type_TsNamespaceDeclaration: typings.swcCore.swcCoreStrings.TsNamespaceDeclaration
}
object TsNamespaceDeclaration {
  ...
  implicit open class MutableBuilder[Self <: TsNamespaceDeclaration] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsNamespaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
