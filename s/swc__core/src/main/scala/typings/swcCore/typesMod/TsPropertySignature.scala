...
trait TsPropertySignature
  ...
  @JSName("type")
  var type_TsPropertySignature: typings.swcCore.swcCoreStrings.TsPropertySignature
}
object TsPropertySignature {
  ...
  extension [Self <: TsPropertySignature](x: Self) {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsPropertySignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
