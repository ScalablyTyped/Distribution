...
trait TsImportType
  ...
  @JSName("type")
  var type_TsImportType: typings.swcCore.swcCoreStrings.TsImportType
}
object TsImportType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TsImportType] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: typings.swcCore.swcCoreStrings.TsImportType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
