...
import typings.swcCore.swcCoreBooleans.`false`
import typings.swcCore.swcCoreStrings.all
import typings.swcCore.swcCoreStrings.some
import typings.swcCore.swcCoreStrings.traceEvent
import typings.swcCore.typesMod.JscTarget
import typings.swcCore.typesMod.TerserEcmaVersion
