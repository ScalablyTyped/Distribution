...
trait Typeofshipit extends js.Object {
  ...
  def task(name: java.lang.String, depsOrFn: shipitDashCliLib.shipitDashCliMod.EmptyCallback): /* import warning: ImportType.apply Failed type conversion: typeof shipit */ js.Any = js.native
  def task(
    name: java.lang.String,
    depsOrFn: shipitDashCliLib.shipitDashCliMod.EmptyCallback,
    fn: js.Function0[scala.Unit]
  ): /* import warning: ImportType.apply Failed type conversion: typeof shipit */ js.Any = js.native
}
