...
class GlideSysAttachment () extends js.Object {
  ...
  def getContent(record: typings.servicenow.servicenow.GlideRecord): js.Any = js.native
  def getContentBase64(record: typings.servicenow.servicenow.GlideRecord): String = js.native
