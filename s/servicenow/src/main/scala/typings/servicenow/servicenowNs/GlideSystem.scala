...
trait GlideSystem extends js.Object {
  ...
  def eventQueue(
    eventName: String,
    gr: typings.servicenow.servicenowNs.GlideRecord,
  ...
  def eventQueueScheduled(
    name: String,
    instance: typings.servicenow.servicenowNs.GlideRecord,
    parm1: String,
    parm2: String,
    expiration: js.Object
  ): Unit = js.native
  def executeNow(job: typings.servicenow.servicenowNs.GlideRecord): String = js.native
