...
trait Static extends js.Object {
  ...
  def T[A](x: A): js.Function1[/* f */ sanctuaryLib.sanctuaryMod.Fn[A, _], _] = js.native
  def add(p: sanctuaryLib.FiniteNumber): js.Function1[/* q */ sanctuaryLib.FiniteNumber, sanctuaryLib.FiniteNumber] = js.native
  def allPass[A](p: js.Array[sanctuaryLib.sanctuaryMod.Predicate[A]]): sanctuaryLib.sanctuaryMod.Predicate[A] = js.native
  ...
  def anyPass[A](p: js.Array[sanctuaryLib.sanctuaryMod.Predicate[A]]): sanctuaryLib.sanctuaryMod.Predicate[A] = js.native
  def ap[A, B](p: sanctuaryLib.sanctuaryMod.Apply[sanctuaryLib.sanctuaryMod.Fn[A, B]]): js.Function1[/* q */ sanctuaryLib.sanctuaryMod.Apply[A], sanctuaryLib.sanctuaryMod.Apply[B]] = js.native
  ...
  def chain[A, B](f: sanctuaryLib.sanctuaryMod.Fn[A, sanctuaryLib.sanctuaryMod.Chain[B]]): js.Function1[
  ...
  def chain_ABX[A, B, X](f: sanctuaryLib.sanctuaryMod.Fn2[A, X, B]): js.Function1[
    ...
    sanctuaryLib.sanctuaryMod.Fn[X, B]
  ] = js.native
  def complement[A](p: sanctuaryLib.sanctuaryMod.Predicate[A]): sanctuaryLib.sanctuaryMod.Predicate[A] = js.native
  //  Composition
  def compose[B, C](f: sanctuaryLib.sanctuaryMod.Fn[B, C]): js.Function1[/* g */ sanctuaryLib.sanctuaryMod.Fn[_, B], sanctuaryLib.sanctuaryMod.Fn[_, C]] = js.native
  ...
  def curry4[A, B, C, D, E](f: sanctuaryLib.sanctuaryMod.Fn4_[A, B, C, D, E]): sanctuaryLib.sanctuaryMod.Fn4[A, B, C, D, E] = js.native
  def curry5[A, B, C, D, E, F](f: sanctuaryLib.sanctuaryMod.Fn5_[A, B, C, D, E, F]): sanctuaryLib.sanctuaryMod.Fn5[A, B, C, D, E, F] = js.native
  ...
  def dropWhile[A](pred: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[
    /* foldable */ sanctuaryLib.sanctuaryMod.Foldable[A], 
    sanctuaryLib.sanctuaryMod.Foldable[A]
  ] = js.native
  def either[A, C](p: sanctuaryLib.sanctuaryMod.Fn[A, C]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[_, C], 
  ...
  def encase[A, B](p: sanctuaryLib.sanctuaryMod.Fn[A, B]): sanctuaryLib.sanctuaryMod.Fn[A, sanctuaryLib.sanctuaryMod.Maybe[B]] = js.native
  def encase2[A, B, C](p: sanctuaryLib.sanctuaryMod.Fn2[A, B, C]): sanctuaryLib.sanctuaryMod.Fn2[A, B, sanctuaryLib.sanctuaryMod.Maybe[C]] = js.native
  def encase3[A, B, C, D](p: sanctuaryLib.sanctuaryMod.Fn3[A, B, C, D]): sanctuaryLib.sanctuaryMod.Fn3[A, B, C, sanctuaryLib.sanctuaryMod.Maybe[D]] = js.native
  def encaseEither[L](p: sanctuaryLib.sanctuaryMod.Fn[stdLib.Error, L]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[_, _], 
    sanctuaryLib.sanctuaryMod.Fn[_, sanctuaryLib.sanctuaryMod.Either[L, _]]
  ] = js.native
  def encaseEither2[L](p: sanctuaryLib.sanctuaryMod.Fn[stdLib.Error, L]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn2[_, _, _], 
    sanctuaryLib.sanctuaryMod.Fn2[_, _, sanctuaryLib.sanctuaryMod.Either[L, _]]
  ] = js.native
  def encaseEither3[L](p: sanctuaryLib.sanctuaryMod.Fn[stdLib.Error, L]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn3[_, _, _, _], 
    sanctuaryLib.sanctuaryMod.Fn3[_, _, _, sanctuaryLib.sanctuaryMod.Either[L, _]]
  ] = js.native
  //  Fantasy Land
  ...
  def extend[A, B](f: sanctuaryLib.sanctuaryMod.Fn[sanctuaryLib.sanctuaryMod.Extend[A], B]): js.Function1[
  ...
  def flip[A, B, C](f: sanctuaryLib.sanctuaryMod.Fn2[A, B, C]): sanctuaryLib.sanctuaryMod.Fn2[B, A, C] = js.native
  ...
  def fromMaybe_[A](p: sanctuaryLib.sanctuaryMod.Thunk[A]): js.Function1[/* q */ sanctuaryLib.sanctuaryMod.Maybe[A], A] = js.native
  def get(p: sanctuaryLib.sanctuaryMod.Predicate[_]): js.Function1[
    /* q */ java.lang.String, 
    js.Function1[/* r */ _, sanctuaryLib.sanctuaryMod.Maybe[_]]
  ] = js.native
  def gets(p: sanctuaryLib.sanctuaryMod.Predicate[_]): js.Function1[
    /* q */ js.Array[java.lang.String], 
    js.Function1[/* r */ _, sanctuaryLib.sanctuaryMod.Maybe[_]]
  ] = js.native
  def groupBy[A](f: sanctuaryLib.sanctuaryMod.Fn2[A, A, scala.Boolean]): js.Function1[/* xs */ js.Array[A], js.Array[js.Array[A]]] = js.native
  ...
  def id[A](p: sanctuaryLib.sanctuaryMod.TypeRep): (sanctuaryLib.sanctuaryMod.Fn[A, A]) | sanctuaryLib.sanctuaryMod.Category[_] = js.native
  def ifElse[A, B](p: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[A, B], 
    js.Function1[/* r */ sanctuaryLib.sanctuaryMod.Fn[A, B], sanctuaryLib.sanctuaryMod.Fn[A, B]]
  ] = js.native
  ...
  def join[A, B](chain_ : sanctuaryLib.sanctuaryMod.Fn2[B, B, A]): sanctuaryLib.sanctuaryMod.Fn[B, A] = js.native
  ...
  def maybe[B](p: B): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[_, B], 
  ...
  def maybeToNullable[A](p: sanctuaryLib.sanctuaryMod.Maybe[A]): sanctuaryLib.sanctuaryMod.Nullable[A] = js.native
  def maybe_[B](p: sanctuaryLib.sanctuaryMod.Thunk[B]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[_, B], 
    js.Function1[/* r */ sanctuaryLib.sanctuaryMod.Maybe[_], B]
  ] = js.native
  ...
  def of[A](typeRep: sanctuaryLib.sanctuaryMod.TypeRep): js.Function1[/* x */ A, sanctuaryLib.sanctuaryMod.Fn[_, A]] = js.native
  def on[A, B, C](p: sanctuaryLib.sanctuaryMod.Fn2[B, B, C]): js.Function1[
    /* q */ sanctuaryLib.sanctuaryMod.Fn[A, B], 
    js.Function1[/* r */ A, sanctuaryLib.sanctuaryMod.Fn[A, C]]
  ] = js.native
  def or(p: scala.Boolean): js.Function1[/* q */ scala.Boolean, scala.Boolean] = js.native
  def pairs[A](p: sanctuaryLib.sanctuaryMod.StrMap[A]): js.Array[sanctuaryLib.sanctuaryMod.Pair[java.lang.String, A]] = js.native
  //  Parse
  ...
  def parseJson(p: sanctuaryLib.sanctuaryMod.Predicate[_]): js.Function1[/* q */ java.lang.String, sanctuaryLib.sanctuaryMod.Maybe[_]] = js.native
  def pipe(fs: js.Array[sanctuaryLib.sanctuaryMod.Fn[_, _]]): js.Function1[/* x */ js.Any, _] = js.native
  def pipe[A, B, C](fs: js.Tuple2[sanctuaryLib.sanctuaryMod.Fn[A, B], sanctuaryLib.sanctuaryMod.Fn[B, C]]): js.Function1[/* x */ A, C] = js.native
  def pipe[A, B, C, D](
    fs: js.Tuple3[
      sanctuaryLib.sanctuaryMod.Fn[A, B], 
      sanctuaryLib.sanctuaryMod.Fn[B, C], 
      sanctuaryLib.sanctuaryMod.Fn[C, D]
    ]
  ): js.Function1[/* x */ A, D] = js.native
  def pipe[A, B, C, D, E](
    fs: js.Tuple4[
      sanctuaryLib.sanctuaryMod.Fn[A, B], 
      sanctuaryLib.sanctuaryMod.Fn[B, C], 
      sanctuaryLib.sanctuaryMod.Fn[C, D], 
      sanctuaryLib.sanctuaryMod.Fn[D, E]
    ]
  ...
  def pipe[A, B, C, D, E, F](
    fs: js.Tuple5[
      ...
      sanctuaryLib.sanctuaryMod.Fn[C, D], 
      sanctuaryLib.sanctuaryMod.Fn[D, E], 
      sanctuaryLib.sanctuaryMod.Fn[E, F]
    ]
  ): js.Function1[/* x */ A, F] = js.native
  @JSName("pipe")
  def pipe_AB[A, B](fs: js.Array[sanctuaryLib.sanctuaryMod.Fn[A, B]]): js.Function1[/* x */ A, B] = js.native
  ...
  def reduce[A, B](p: sanctuaryLib.sanctuaryMod.Fn2[B, A, B]): js.Function1[
    /* q */ B, 
    js.Function1[
  ...
  def tagBy[A](p: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[/* q */ A, sanctuaryLib.sanctuaryMod.Either[A, A]] = js.native
  ...
  def takeWhile[A](pred: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[
    /* foldable */ sanctuaryLib.sanctuaryMod.Foldable[A], 
    sanctuaryLib.sanctuaryMod.Foldable[A]
  ] = js.native
  def test(pattern: stdLib.RegExp): sanctuaryLib.sanctuaryMod.Predicate[java.lang.String] = js.native
  ...
  def traverse(typeRep: sanctuaryLib.sanctuaryMod.TypeRep): js.Function1[
    /* f */ sanctuaryLib.sanctuaryMod.Fn[_, sanctuaryLib.sanctuaryMod.Applicative[_]], 
    js.Function1[
  ...
  def unfoldr[A, B](
    f: sanctuaryLib.sanctuaryMod.Fn[B, sanctuaryLib.sanctuaryMod.Maybe[sanctuaryLib.sanctuaryMod.Pair[A, B]]]
  ): js.Function1[/* x */ B, js.Array[A]] = js.native
  def unless[A](p: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[/* q */ sanctuaryLib.sanctuaryMod.Fn[A, A], sanctuaryLib.sanctuaryMod.Fn[A, A]] = js.native
  ...
  def when[A](p: sanctuaryLib.sanctuaryMod.Predicate[A]): js.Function1[/* q */ sanctuaryLib.sanctuaryMod.Fn[A, A], sanctuaryLib.sanctuaryMod.Fn[A, A]] = js.native
