package typings.sanctuary.sanctuaryMod.SanctuaryNs
...
import typings.sanctuary.Fn_M
import typings.sanctuary.Fn_Q
import typings.sanctuary.Fn_QA
import typings.sanctuary.Fn_R
...
import typings.sanctuary.sanctuaryMod.Alt
import typings.sanctuary.sanctuaryMod.Applicative
import typings.sanctuary.sanctuaryMod.Apply
import typings.sanctuary.sanctuaryMod.Bifunctor
import typings.sanctuary.sanctuaryMod.Category
import typings.sanctuary.sanctuaryMod.Chain
import typings.sanctuary.sanctuaryMod.Comonad
import typings.sanctuary.sanctuaryMod.Either
import typings.sanctuary.sanctuaryMod.Extend
import typings.sanctuary.sanctuaryMod.Fn
import typings.sanctuary.sanctuaryMod.Fn2
import typings.sanctuary.sanctuaryMod.Fn2_
import typings.sanctuary.sanctuaryMod.Fn3
import typings.sanctuary.sanctuaryMod.Fn3_
import typings.sanctuary.sanctuaryMod.Fn4
import typings.sanctuary.sanctuaryMod.Fn4_
import typings.sanctuary.sanctuaryMod.Fn5
import typings.sanctuary.sanctuaryMod.Fn5_
import typings.sanctuary.sanctuaryMod.Foldable
import typings.sanctuary.sanctuaryMod.Functor
import typings.sanctuary.sanctuaryMod.ListToMaybeList
import typings.sanctuary.sanctuaryMod.MatchObj
import typings.sanctuary.sanctuaryMod.Maybe
import typings.sanctuary.sanctuaryMod.Monoid
import typings.sanctuary.sanctuaryMod.Nullable
import typings.sanctuary.sanctuaryMod.Ord
import typings.sanctuary.sanctuaryMod.Pair
import typings.sanctuary.sanctuaryMod.Plus
import typings.sanctuary.sanctuaryMod.Predicate
import typings.sanctuary.sanctuaryMod.Semigroup
import typings.sanctuary.sanctuaryMod.Semigroupoid
import typings.sanctuary.sanctuaryMod.Setoid
import typings.sanctuary.sanctuaryMod.StrMap
import typings.sanctuary.sanctuaryMod.Thunk
import typings.sanctuary.sanctuaryMod.Traversable
import typings.sanctuary.sanctuaryMod.TypeRep
...
trait Static extends js.Object {
  ...
  def append[A](x: A): Fn_Xs[A] = js.native
  def at(p: Integer): Fn_QA = js.native
  ...
  def chainRec(typeRep: TypeRep): Fn_F = js.native
  @JSName("chain")
  ...
  def contramap[A, B](f: Fn[B, A]): Fn_Contravariant[A, B] = js.native
  //  Function
  ...
  def filter[A](pred: Predicate[A]): Fn_M[A] = js.native
  def filterM[A](pred: Predicate[A]): Fn_M[A] = js.native
  ...
  def lift2[A, B, C](f: Fn2[A, B, C]): Fn_X[A, B, C] = js.native
  def lift3[A, B, C, D](f: Fn3[A, B, C, D]): Fn_XY[A, B, C, D] = js.native
  ...
  def map[A, B](p: Fn[A, B]): Fn_Q[A, B] = js.native
  ...
  def sortBy[A](f: Fn[A, Ord[_]]): Fn_Foldable[A] = js.native
  ...
  //  Classify
  def `type`(x: js.Any): Anon_Name = js.native
