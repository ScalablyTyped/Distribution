...
- typings.storybookCoreCommon.typesMod.BuilderOptions because var conflicts: configDir, ignorePreview. Inlined configType, cache, docsMode, features, versionCheck, releaseNotesData, disableWebpackDefaults, serverChannelUrl
- typings.storybookCoreCommon.typesMod.CLIOptions because var conflicts: configDir, ignorePreview, outputDir. Inlined port, previewUrl, forceBuildPreview, disableTelemetry, enableCrashReports, host, staticDir, https, sslCa, sslCert, sslKey, smokeTest, managerCache, open, ci, loglevel, quiet, versionUpdates, releaseNotes, dll, docs, docsDll, uiDll, debugWebpack, webpackStatsJson, modern */ trait Options
  extends StObject
     with LoadOptions
