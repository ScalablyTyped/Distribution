...
/* Rewritten from type alias, can be one of: 
  - typings.storybookCoreCommon.typesMod.BuilderName
  - typings.storybookCoreCommon.typesMod.BuilderConfigObject
  - typings.storybookCoreCommon.typesMod.Webpack4BuilderConfig
  - typings.storybookCoreCommon.typesMod.Webpack5BuilderConfig
*/
