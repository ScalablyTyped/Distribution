...
- typings.storybookCoreCommon.distTs3Dot9TypesMod.BuilderOptions because var conflicts: configDir, ignorePreview. Inlined configType, cache, docsMode, features, versionCheck, releaseNotesData, disableWebpackDefaults, serverChannelUrl
- typings.storybookCoreCommon.distTs3Dot9TypesMod.CLIOptions because var conflicts: configDir, ignorePreview, outputDir. Inlined port, previewUrl, forceBuildPreview, disableTelemetry, enableCrashReports, host, staticDir, https, sslCa, sslCert, sslKey, smokeTest, managerCache, open, ci, loglevel, quiet, versionUpdates, releaseNotes, dll, docs, docsDll, uiDll, debugWebpack, webpackStatsJson, modern */ trait Options
  extends StObject
     with LoadOptions
...
object Options {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], docsMode = docsMode.asInstanceOf[js.Any], framework = framework.asInstanceOf[js.Any], frameworkPresets = frameworkPresets.asInstanceOf[js.Any], packageJson = packageJson.asInstanceOf[js.Any], presets = presets.asInstanceOf[js.Any])
