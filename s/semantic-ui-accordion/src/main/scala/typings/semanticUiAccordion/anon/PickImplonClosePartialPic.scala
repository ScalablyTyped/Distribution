...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'onClose'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplonClosePartialPic
  extends StObject
     with Param {
...
object PickImplonClosePartialPic {
  
  inline def apply(onClose: js.ThisFunction0[/* this */ JQuery, Unit]): PickImplonClosePartialPic = {
    val __obj = js.Dynamic.literal(onClose = onClose.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplonClosePartialPic]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonClosePartialPic] (val x: Self) extends AnyVal {
