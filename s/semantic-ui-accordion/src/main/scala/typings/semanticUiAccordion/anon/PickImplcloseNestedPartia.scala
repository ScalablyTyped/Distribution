...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'closeNested'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplcloseNestedPartia
  extends StObject
     with Param {
...
object PickImplcloseNestedPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplcloseNestedPartia] (val x: Self) extends AnyVal {
