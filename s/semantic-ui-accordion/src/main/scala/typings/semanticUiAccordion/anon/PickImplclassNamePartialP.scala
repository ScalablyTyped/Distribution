...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'className'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplclassNamePartialP
  extends StObject
     with Param {
