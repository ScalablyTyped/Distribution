...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'onChange'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplonChangePartialPi
  extends StObject
     with Param {
...
object PickImplonChangePartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonChangePartialPi] (val x: Self) extends AnyVal {
