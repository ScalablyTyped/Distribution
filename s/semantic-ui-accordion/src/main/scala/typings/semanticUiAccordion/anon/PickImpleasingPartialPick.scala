...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'easing'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImpleasingPartialPick
  extends StObject
     with Param {
...
object PickImpleasingPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpleasingPartialPick] (val x: Self) extends AnyVal {
