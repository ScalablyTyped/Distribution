...
object typesBrowserMod {
  ...
  @JSImport("@sentry-internal/tracing/types/browser", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@sentry-internal/tracing/types/browser", "BROWSER_TRACING_INTEGRATION_ID")
  @js.native
  val BROWSER_TRACING_INTEGRATION_ID: /* "BrowserTracing" */ String = js.native
  
  @JSImport("@sentry-internal/tracing/types/browser", "BrowserTracing")
  @js.native
  open class BrowserTracing ()
    extends typings.sentryInternalTracing.typesBrowserBrowsertracingMod.BrowserTracing {
    def this(_options: PartialBrowserTracingOpti) = this()
  }
  
  @JSImport("@sentry-internal/tracing/types/browser", "IdleTransaction")
  @js.native
  ...
  @JSImport("@sentry-internal/tracing/types/browser", "Span")
  @js.native
  /**
  ...
  @JSImport("@sentry-internal/tracing/types/browser", "SpanStatus")
  @js.native
  ...
  @JSImport("@sentry-internal/tracing/types/browser", "TRACEPARENT_REGEXP")
  @js.native
  val TRACEPARENT_REGEXP: js.RegExp = js.native
  
  @JSImport("@sentry-internal/tracing/types/browser", "Transaction")
  @js.native
  ...
  @JSImport("@sentry-internal/tracing/types/browser", "defaultRequestInstrumentationOptions")
  @js.native
