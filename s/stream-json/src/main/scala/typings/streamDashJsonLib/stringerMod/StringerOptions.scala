...
trait StringerOptions
  ...
  var useNumberValues: js.UndefOr[scala.Boolean] = js.undefined
  var useStringValues: js.UndefOr[scala.Boolean] = js.undefined
  var useValues: js.UndefOr[scala.Boolean] = js.undefined
}
...
object StringerOptions {
  ...
  def apply(
    ...
    useKeyValues: js.UndefOr[scala.Boolean] = js.undefined,
    useNumberValues: js.UndefOr[scala.Boolean] = js.undefined,
    useStringValues: js.UndefOr[scala.Boolean] = js.undefined,
    useValues: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(useKeyValues)) __obj.updateDynamic("useKeyValues")(useKeyValues)
    if (!js.isUndefined(useNumberValues)) __obj.updateDynamic("useNumberValues")(useNumberValues)
