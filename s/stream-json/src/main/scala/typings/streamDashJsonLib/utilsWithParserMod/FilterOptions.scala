...
trait FilterOptions
  extends streamDashJsonLib.filtersFilterBaseMod.FilterOptions {
...
object FilterOptions {
  @scala.inline
  def apply(
    filter: java.lang.String | stdLib.RegExp | streamDashJsonLib.filtersFilterBaseMod.FilterFunction,
    ...
    replacement: js.Array[streamDashJsonLib.filtersFilterBaseMod.Token] | streamDashJsonLib.filtersFilterBaseMod.ReplacementFunction = null,
