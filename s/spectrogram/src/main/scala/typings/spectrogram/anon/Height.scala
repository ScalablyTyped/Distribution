...
object Height {
  ...
  implicit class HeightOps[Self <: Height] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHeight(value: Double | js.Function0[Double]): Self = this.set("height", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHeight: Self = this.set("height", js.undefined)
    @scala.inline
    def setWidthFunction0(value: () => Double): Self = this.set("width", js.Any.fromFunction0(value))
    @scala.inline
    def setWidth(value: Double | js.Function0[Double]): Self = this.set("width", value.asInstanceOf[js.Any])
    @scala.inline
