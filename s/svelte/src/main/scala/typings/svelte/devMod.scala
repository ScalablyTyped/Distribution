...
import typings.svelte.componentMod.SvelteComponent
...
object devMod {
  ...
  open class SvelteComponentTyped[Props /* <: Record[String, Any] */, Events /* <: Record[String, Any] */, Slots /* <: Record[String, Any] */] protected () extends SvelteComponentDev {
    ...
    @JSName("$set")
    def $set(props: Partial[Props]): Unit = js.native
  ...
  type ComponentEvents[Component /* <: SvelteComponent */] = Any
  
  type ComponentProps[Component /* <: SvelteComponent */] = Any
  
  type ComponentType[Component /* <: SvelteComponentTyped[Any, Any, Any] */] = Instantiable1[/* options */ ComponentConstructorOptions[Record[String, Any]], Component]
