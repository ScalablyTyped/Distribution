...
- Dropped {[ P in std.Exclude<keyof @styled-system/css.@styled-system/css.CSSProperties, 'boxShadow' | 'fontWeight'> ]: @styled-system/css.@styled-system/css.CSSProperties[P]} */ trait SystemCSSProperties
