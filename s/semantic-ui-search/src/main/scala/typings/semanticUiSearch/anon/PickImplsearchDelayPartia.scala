...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'searchDelay'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplsearchDelayPartia
  extends StObject
     with Param {
...
object PickImplsearchDelayPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplsearchDelayPartia] (val x: Self) extends AnyVal {
