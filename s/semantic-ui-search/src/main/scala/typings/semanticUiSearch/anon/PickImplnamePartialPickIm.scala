...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'name'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
