...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'searchFullText'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplsearchFullTextPar
  extends StObject
     with Param {
...
object PickImplsearchFullTextPar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplsearchFullTextPar] (val x: Self) extends AnyVal {
