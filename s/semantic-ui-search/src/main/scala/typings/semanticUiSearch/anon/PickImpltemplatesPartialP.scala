...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'templates'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImpltemplatesPartialP
  extends StObject
     with Param {
...
object PickImpltemplatesPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpltemplatesPartialP] (val x: Self) extends AnyVal {
