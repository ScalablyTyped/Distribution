...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'namespace'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
