...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, 'action'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, keyof semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl>> */
trait PickImplactionPartialPick
  extends StObject
     with Param {
...
object PickImplactionPartialPick {
  ...
  inline def apply(action: String): PickImplactionPartialPick = {
    val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplactionPartialPick]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplactionPartialPick] (val x: Self) extends AnyVal {
