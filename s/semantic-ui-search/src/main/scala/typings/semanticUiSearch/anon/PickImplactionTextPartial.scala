...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, 'actionText'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, keyof semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl>> */
trait PickImplactionTextPartial
  extends StObject
     with Param {
...
object PickImplactionTextPartial {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplactionTextPartial] (val x: Self) extends AnyVal {
