...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'onResultsClose'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplonResultsClosePar
  extends StObject
     with Param {
...
object PickImplonResultsClosePar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonResultsClosePar] (val x: Self) extends AnyVal {
