...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'searchFields'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplsearchFieldsParti
  extends StObject
     with Param {
