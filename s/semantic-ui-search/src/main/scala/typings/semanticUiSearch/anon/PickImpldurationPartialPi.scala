...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'duration'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
