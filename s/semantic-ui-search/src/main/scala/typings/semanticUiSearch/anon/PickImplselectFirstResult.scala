...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'selectFirstResult'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplselectFirstResult
  extends StObject
     with Param {
...
object PickImplselectFirstResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplselectFirstResult] (val x: Self) extends AnyVal {
