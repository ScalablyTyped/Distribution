...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'minCharacters'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplminCharactersPart
  extends StObject
     with Param {
