...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'onSearchQuery'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplonSearchQueryPart
  extends StObject
     with Param {
...
object PickImplonSearchQueryPart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonSearchQueryPart] (val x: Self) extends AnyVal {
