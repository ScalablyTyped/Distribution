...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'apiSettings'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplapiSettingsPartia
  extends StObject
     with Param {
...
object PickImplapiSettingsPartia {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplapiSettingsPartia] (val x: Self) extends AnyVal {
