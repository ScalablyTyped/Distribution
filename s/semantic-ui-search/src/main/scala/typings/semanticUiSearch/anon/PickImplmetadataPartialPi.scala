...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'metadata'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplmetadataPartialPi
  extends StObject
     with Param {
...
object PickImplmetadataPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmetadataPartialPi] (val x: Self) extends AnyVal {
