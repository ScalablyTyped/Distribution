...
trait Search extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashSearchLib.semanticDashUiDashSearchLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-search.SemanticUI.SearchSettings._Impl[K] */ js.Any = js.native
