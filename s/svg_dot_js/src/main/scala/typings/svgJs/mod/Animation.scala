...
trait Animation extends js.Object {
  ...
  def rotate(degrees: Double, cx: js.UndefOr[scala.Nothing], cy: Double): Animation = js.native
  ...
  def scale(scaleX: Double, scaleY: js.UndefOr[scala.Nothing], cx: js.UndefOr[scala.Nothing], cy: Double): Animation = js.native
  def scale(scaleX: Double, scaleY: js.UndefOr[scala.Nothing], cx: Double): Animation = js.native
  def scale(scaleX: Double, scaleY: js.UndefOr[scala.Nothing], cx: Double, cy: Double): Animation = js.native
  def scale(scaleX: Double, scaleY: Double): Animation = js.native
  def scale(scaleX: Double, scaleY: Double, cx: js.UndefOr[scala.Nothing], cy: Double): Animation = js.native
  ...
  def skew(skewX: Double, skewY: js.UndefOr[scala.Nothing], cx: js.UndefOr[scala.Nothing], cy: Double): Animation = js.native
  def skew(skewX: Double, skewY: js.UndefOr[scala.Nothing], cx: Double): Animation = js.native
  def skew(skewX: Double, skewY: js.UndefOr[scala.Nothing], cx: Double, cy: Double): Animation = js.native
  def skew(skewX: Double, skewY: Double): Animation = js.native
  def skew(skewX: Double, skewY: Double, cx: js.UndefOr[scala.Nothing], cy: Double): Animation = js.native
