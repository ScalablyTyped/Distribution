...
trait Matrix
  ...
  def scale(x: Double, y: js.UndefOr[scala.Nothing], cx: Double, cy: Double): Matrix = js.native
  ...
  def skew(x: Double, y: js.UndefOr[scala.Nothing], cx: Double, cy: Double): Matrix = js.native
