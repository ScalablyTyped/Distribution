...
trait Element
  ...
  def animate(duration: js.UndefOr[scala.Nothing], ease: js.UndefOr[scala.Nothing], delay: Double): Animation = js.native
  def animate(duration: js.UndefOr[scala.Nothing], ease: String): Animation = js.native
  def animate(duration: js.UndefOr[scala.Nothing], ease: String, delay: Double): Animation = js.native
  def animate(duration: Double): Animation = js.native
  def animate(duration: Double, ease: js.UndefOr[scala.Nothing], delay: Double): Animation = js.native
  ...
  def off(event: String, cb: js.UndefOr[scala.Nothing], context: js.Object): this.type = js.native
  ...
  def rotate(d: Double, cx: js.UndefOr[scala.Nothing], cy: Double): this.type = js.native
  ...
  def scale(x: Double, y: js.UndefOr[scala.Nothing], cx: js.UndefOr[scala.Nothing], cy: Double): this.type = js.native
  def scale(x: Double, y: js.UndefOr[scala.Nothing], cx: Double): this.type = js.native
  def scale(x: Double, y: js.UndefOr[scala.Nothing], cx: Double, cy: Double): this.type = js.native
  def scale(x: Double, y: Double): this.type = js.native
  def scale(x: Double, y: Double, cx: js.UndefOr[scala.Nothing], cy: Double): this.type = js.native
  ...
  def size(width: js.UndefOr[NumberAlias], height: NumberAlias): this.type = js.native
  def size(width: NumberAlias): this.type = js.native
  
  def skew(x: Double): this.type = js.native
  def skew(x: Double, y: js.UndefOr[scala.Nothing], cx: js.UndefOr[scala.Nothing], cy: Double): this.type = js.native
  def skew(x: Double, y: js.UndefOr[scala.Nothing], cx: Double): this.type = js.native
  def skew(x: Double, y: js.UndefOr[scala.Nothing], cx: Double, cy: Double): this.type = js.native
  def skew(x: Double, y: Double): this.type = js.native
  def skew(x: Double, y: Double, cx: js.UndefOr[scala.Nothing], cy: Double): this.type = js.native
