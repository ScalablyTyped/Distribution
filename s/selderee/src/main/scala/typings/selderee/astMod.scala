...
object astMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.selderee.astMod.TerminalNode[V]
    - typings.selderee.astMod.TagNameNode[V]
    - typings.selderee.astMod.AttrPresenceNode[V]
    - typings.selderee.astMod.AttrValueNode[V]
    - typings.selderee.astMod.PushElementNode[V]
    - typings.selderee.astMod.PopElementNode[V]
  */
  trait DecisionTreeNode[V] extends StObject
  object DecisionTreeNode {
    
    inline def AttrPresenceNode[V](cont: js.Array[DecisionTreeNode[V]], name: String): typings.selderee.astMod.AttrPresenceNode[V] = {
      val __obj = js.Dynamic.literal(cont = cont.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("attrPresence")
      __obj.asInstanceOf[typings.selderee.astMod.AttrPresenceNode[V]]
    }
    
    inline def AttrValueNode[V](matchers: js.Array[MatcherNode[V]], name: String): typings.selderee.astMod.AttrValueNode[V] = {
      val __obj = js.Dynamic.literal(matchers = matchers.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("attrValue")
      __obj.asInstanceOf[typings.selderee.astMod.AttrValueNode[V]]
    }
    
    inline def PopElementNode[V](cont: js.Array[DecisionTreeNode[V]]): typings.selderee.astMod.PopElementNode[V] = {
      val __obj = js.Dynamic.literal(cont = cont.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("popElement")
      __obj.asInstanceOf[typings.selderee.astMod.PopElementNode[V]]
    }
    
    inline def PushElementNode[V](combinator: Greaterthansign | Plussign, cont: js.Array[DecisionTreeNode[V]]): typings.selderee.astMod.PushElementNode[V] = {
      ...
      __obj.asInstanceOf[typings.selderee.astMod.PushElementNode[V]]
    }
    
    inline def TagNameNode[V](variants: js.Array[VariantNode[V]]): typings.selderee.astMod.TagNameNode[V] = {
      val __obj = js.Dynamic.literal(variants = variants.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("tagName")
      __obj.asInstanceOf[typings.selderee.astMod.TagNameNode[V]]
    }
    
    inline def TerminalNode[V](valueContainer: ValueContainer[V]): typings.selderee.astMod.TerminalNode[V] = {
      val __obj = js.Dynamic.literal(valueContainer = valueContainer.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("terminal")
      __obj.asInstanceOf[typings.selderee.astMod.TerminalNode[V]]
    }
  }
