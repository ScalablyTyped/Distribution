...
trait Nag extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashNagLib.semanticDashUiDashNagLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-nag.SemanticUI.NagSettings._Impl[K] */ js.Any = js.native
  ...
  ): semanticDashUiDashNagLib.JQuery = js.native
}
