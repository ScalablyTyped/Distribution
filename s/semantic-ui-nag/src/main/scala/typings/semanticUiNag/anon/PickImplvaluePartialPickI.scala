...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'value'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
...
object PickImplvaluePartialPickI {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplvaluePartialPickI] (val x: Self) extends AnyVal {
