...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'animation'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
...
object PickImplanimationPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplanimationPartialP] (val x: Self) extends AnyVal {
