...
import typings.signalr.SignalRNs.AjaxDefaults
import typings.signalr.SignalRNs.AvailableEvents
import typings.signalr.SignalRNs.ConnectionStates
import typings.signalr.SignalRNs.HubNs.Connection
import typings.signalr.SignalRNs.HubNs.HubCreator
import typings.signalr.SignalRNs.HubNs.Options
import typings.signalr.SignalRNs.Transports
...
trait SignalR extends js.Object {
  ...
  /**
    ...
    */
  def apply(url: String): typings.signalr.SignalRNs.Connection = js.native
  def apply(url: String, queryString: String): typings.signalr.SignalRNs.Connection = js.native
  def apply(url: String, queryString: String, logging: Boolean): typings.signalr.SignalRNs.Connection = js.native
  def apply(url: String, queryString: js.Object): typings.signalr.SignalRNs.Connection = js.native
  def apply(url: String, queryString: js.Object, logging: Boolean): typings.signalr.SignalRNs.Connection = js.native
  def changeState(connection: typings.signalr.SignalRNs.Connection, expectedState: Double, newState: Double): Unit = js.native
  ...
  def isDisconnecting(connection: typings.signalr.SignalRNs.Connection): Boolean = js.native
  /**
    *   Reinstates the original value of $.connection and returns the signalR object for manual assignment.
    */
  def noConflict(): typings.signalr.SignalRNs.Connection = js.native
}
