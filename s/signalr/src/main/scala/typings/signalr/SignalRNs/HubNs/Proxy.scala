package typings.signalr.SignalRNs.HubNs
...
trait Proxy extends js.Object {
  var connection: typings.signalr.SignalRNs.HubNs.Connection
  var hubName: String
  var state: js.Any
  def hasSubscriptions(): Boolean
  def init(connection: typings.signalr.SignalRNs.HubNs.Connection, hubName: String): Unit
  /**
...
object Proxy {
  @scala.inline
  def apply(
    connection: typings.signalr.SignalRNs.HubNs.Connection,
    hasSubscriptions: () => Boolean,
    hubName: String,
    init: (typings.signalr.SignalRNs.HubNs.Connection, String) => Unit,
