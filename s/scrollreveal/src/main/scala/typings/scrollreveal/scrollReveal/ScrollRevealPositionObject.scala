...
@js.native
trait ScrollRevealPositionObject extends js.Object {
...
object ScrollRevealPositionObject {
  ...
  @scala.inline
  implicit class ScrollRevealPositionObjectOps[Self <: ScrollRevealPositionObject] (val x: Self) extends AnyVal {
