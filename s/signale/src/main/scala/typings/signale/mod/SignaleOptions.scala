...
object SignaleOptions {
  @scala.inline
  def apply[/* <: java.lang.String */ TTypes](): SignaleOptions[TTypes] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SignaleOptions[TTypes]]
  }
  @scala.inline
  implicit class SignaleOptionsOps[Self <: SignaleOptions[_], /* <: java.lang.String */ TTypes] (val x: Self with SignaleOptions[TTypes]) extends AnyVal {
    @scala.inline
