...
object global {
  ...
  object System {
    ...
    /**
      ...
      */
    @scala.inline
    def delete(moduleId: String): `false` | UpdateModuleFn = ^.asInstanceOf[js.Dynamic].applyDynamic("delete")(moduleId.asInstanceOf[js.Any]).asInstanceOf[`false` | UpdateModuleFn]
    
    /**
      * Use for (let entry of System.entries()) to access all of the modules in the SystemJS registry.
      */
    @scala.inline
    def entries(): Iterable[js.Tuple2[String, Module]] = ^.asInstanceOf[js.Dynamic].applyDynamic("entries")().asInstanceOf[Iterable[js.Tuple2[String, Module]]]
    ...
    /**
      ...
      */
    @scala.inline
    def get(moduleId: String): Module | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(moduleId.asInstanceOf[js.Any]).asInstanceOf[Module | Null]
    
    // tslint:disable-next-line no-unnecessary-generics
    @scala.inline
    def get_T[T](moduleId: String): T | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(moduleId.asInstanceOf[js.Any]).asInstanceOf[T | Null]
    ...
    /**
      ...
      */
    @scala.inline
    def has(moduleId: String): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("has")(moduleId.asInstanceOf[js.Any]).asInstanceOf[Boolean]
    ...
    /**
      ...
      */
    @scala.inline
    def `import`[T /* <: Module */](moduleId: String): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("import")(moduleId.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
    @scala.inline
    def `import`[T /* <: Module */](moduleId: String, parentUrl: String): js.Promise[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("import")(moduleId.asInstanceOf[js.Any], parentUrl.asInstanceOf[js.Any])).asInstanceOf[js.Promise[T]]
    ...
    /**
      ...
      */
    @scala.inline
    def register(dependencies: js.Array[String], declare: DeclareFn): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("register")(dependencies.asInstanceOf[js.Any], declare.asInstanceOf[js.Any])).asInstanceOf[Unit]
    @scala.inline
    def register(name: String, dependencies: js.Array[String], declare: DeclareFn): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("register")(name.asInstanceOf[js.Any], dependencies.asInstanceOf[js.Any], declare.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /**
      ...
      */
    @scala.inline
    def resolve(moduleId: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(moduleId.asInstanceOf[js.Any]).asInstanceOf[String]
    @scala.inline
    def resolve(moduleId: String, parentUrl: String): String = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(moduleId.asInstanceOf[js.Any], parentUrl.asInstanceOf[js.Any])).asInstanceOf[String]
    ...
    /**
      ...
      */
    @scala.inline
    def set(moduleId: String, module: Module): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(moduleId.asInstanceOf[js.Any], module.asInstanceOf[js.Any])).asInstanceOf[Unit]
  }
}
