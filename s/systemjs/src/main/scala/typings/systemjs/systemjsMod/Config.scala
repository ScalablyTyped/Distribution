...
import typings.systemjs.Anon_Key
...
trait Config
  ...
  */
/* customName */ StringDictionary[js.Any] {
  /**
  ...
  /**
    ...
    */
  var defaultJSExtensions: js.UndefOr[Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var paths: js.UndefOr[PackageList[String]] = js.undefined
  ...
  var typescriptOptions: js.UndefOr[Anon_Key] = js.undefined
}
