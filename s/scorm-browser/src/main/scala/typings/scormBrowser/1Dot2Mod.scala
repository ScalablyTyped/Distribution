...
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIBlank
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIBoolean
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIDecimal
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIFeedback
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIIdentifier
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIInteger
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMISInteger
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIString255
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMIString4096
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMITime
import typings.scormBrowser.`1Dot2CmidatatypesMod`.CMITimeSpan
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementComments
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCommentsFromLMS
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreCredit
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreEntry
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreExit
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonLocation
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonMode
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonStatus
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreMax
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreMin
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreRaw
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreSessionTime
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreStudentId
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreStudentName
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreTotalTime
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsCount
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNCorrectResponsesCount
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNCorrectResponsesNPattern
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNID
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNLatency
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNObjectivesCount
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNResult
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNStudentResponse
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNTime
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNType
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNWeighting
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementLaunchData
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesCount
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNID
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreMax
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreMin
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreRaw
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNStatus
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataMasteryScore
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataMaxTimeAllowed
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataTimeLimitAction
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceAudio
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceChildren
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceLanguage
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceSpeed
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceText
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementSuspendData
import typings.scormBrowser.`1Dot2CmielementMod`.CMIElementVersion
import typings.scormBrowser.`1Dot2CmierrorcodeMod`.CMIErrorCode
...
import typings.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyResult
import typings.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyStatus
import typings.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyTimeLimitAction
...
object `1Dot2Mod` {
  ...
  trait SCORM12 extends StObject {
    ...
    /**
      ...
      */
    @JSName("LMSGetValue")
    def LMSGetValue_CMIInteger(element: CMIElementInteractionsNCorrectResponsesCount | CMIElementInteractionsNObjectivesCount): CMIInteger = js.native
    /**
      * The _children keyword is used to determine all of the elements in the core category that are supported by the LMS. If an element has no children, but is supported, an empty string is returned.
      * If an element is not supported, an empty string is returned. A subsequent request for last error can verify that the element is not supported.
      */
