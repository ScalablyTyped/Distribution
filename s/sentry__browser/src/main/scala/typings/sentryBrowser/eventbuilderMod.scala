...
object eventbuilderMod {
  ...
  inline def eventFromString(input: String): Event = ^.asInstanceOf[js.Dynamic].applyDynamic("eventFromString")(input.asInstanceOf[js.Any]).asInstanceOf[Event]
  inline def eventFromString(input: String, syntheticException: Unit, options: `0`): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromString")(input.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Event]
  inline def eventFromString(input: String, syntheticException: Error): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromString")(input.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any])).asInstanceOf[Event]
  inline def eventFromString(input: String, syntheticException: Error, options: `0`): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromString")(input.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Event]
  
  inline def eventFromUnknownInput(exception: js.Any): Event = ^.asInstanceOf[js.Dynamic].applyDynamic("eventFromUnknownInput")(exception.asInstanceOf[js.Any]).asInstanceOf[Event]
  inline def eventFromUnknownInput(exception: js.Any, syntheticException: Unit, options: AttachStacktrace): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromUnknownInput")(exception.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Event]
  inline def eventFromUnknownInput(exception: js.Any, syntheticException: Error): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromUnknownInput")(exception.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any])).asInstanceOf[Event]
  inline def eventFromUnknownInput(exception: js.Any, syntheticException: Error, options: AttachStacktrace): Event = (^.asInstanceOf[js.Dynamic].applyDynamic("eventFromUnknownInput")(exception.asInstanceOf[js.Any], syntheticException.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Event]
}
