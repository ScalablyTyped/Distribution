...
class User () extends js.Object {
  ...
  var socket: socketDotIoLib.socketDotIoMod.Socket = js.native
  var sockets: js.Array[socketDotIoLib.socketDotIoMod.Socket] = js.native
  var store: js.Any = js.native
  def attach(socket: socketDotIoLib.socketDotIoMod.Socket): scala.Unit = js.native
  ...
  def detachSocket(socket: socketDotIoLib.socketDotIoMod.Socket): scala.Unit = js.native
  ...
  def to(room: java.lang.String): socketDotIoLib.socketDotIoMod.Socket = js.native
}
