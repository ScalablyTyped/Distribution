...
object mod {
  ...
  inline def h(
    ...
    children: Children[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typings.superfine.superfineStrings.a, typings.superfine.superfineStrings.animate, typings.superfine.superfineStrings.animateMotion */ Any
    ]
  ...
  inline def h_a(tagName: a, props: Props[a]): VNode[a] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[a]]
  
  inline def h_abbr(tagName: abbr, props: Props[abbr]): VNode[abbr] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[abbr]]
  ...
  inline def h_article(tagName: article, props: Props[article]): VNode[article] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[article]]
  
  inline def h_aside(tagName: aside, props: Props[aside]): VNode[aside] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[aside]]
  
  inline def h_audio(tagName: audio, props: Props[audio]): VNode[audio] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[audio]]
  ...
  inline def h_bdo(tagName: bdo, props: Props[bdo]): VNode[bdo] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[bdo]]
  
  inline def h_blockquote(tagName: blockquote, props: Props[blockquote]): VNode[blockquote] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[blockquote]]
  
  inline def h_body(tagName: body, props: Props[body]): VNode[body] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[body]]
  
  inline def h_br(tagName: br, props: Props[br]): VNode[br] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[br]]
  
  inline def h_button(tagName: button, props: Props[button]): VNode[button] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[button]]
  
  inline def h_canvas(tagName: canvas, props: Props[canvas]): VNode[canvas] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[canvas]]
  
  inline def h_caption(tagName: caption, props: Props[caption]): VNode[caption] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[caption]]
  
  inline def h_circle(tagName: circle, props: Props[circle]): VNode[circle] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[circle]]
  
  inline def h_cite(tagName: cite, props: Props[cite]): VNode[cite] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[cite]]
  
  inline def h_clipPath(tagName: clipPath, props: Props[clipPath]): VNode[clipPath] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[clipPath]]
  
  inline def h_code(tagName: code, props: Props[code]): VNode[code] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[code]]
  
  inline def h_col(tagName: col, props: Props[col]): VNode[col] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[col]]
  
  inline def h_colgroup(tagName: colgroup, props: Props[colgroup]): VNode[colgroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[colgroup]]
  
  inline def h_data(tagName: data, props: Props[data]): VNode[data] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[data]]
  
  inline def h_datalist(tagName: datalist, props: Props[datalist]): VNode[datalist] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[datalist]]
  
  inline def h_dd(tagName: dd, props: Props[dd]): VNode[dd] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[dd]]
  
  inline def h_defs(tagName: defs, props: Props[defs]): VNode[defs] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[defs]]
  
  inline def h_del(tagName: del, props: Props[del]): VNode[del] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[del]]
  
  inline def h_desc(tagName: desc, props: Props[desc]): VNode[desc] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[desc]]
  
  inline def h_details(tagName: details, props: Props[details]): VNode[details] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[details]]
  
  inline def h_dfn(tagName: dfn, props: Props[dfn]): VNode[dfn] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[dfn]]
  ...
  inline def h_dt(tagName: dt, props: Props[dt]): VNode[dt] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[dt]]
  
  inline def h_ellipse(tagName: ellipse, props: Props[ellipse]): VNode[ellipse] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[ellipse]]
  
  inline def h_em(tagName: em, props: Props[em]): VNode[em] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[em]]
  
  inline def h_embed(tagName: embed, props: Props[embed]): VNode[embed] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[embed]]
  
  inline def h_feBlend(tagName: feBlend, props: Props[feBlend]): VNode[feBlend] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feBlend]]
  
  inline def h_feColorMatrix(tagName: feColorMatrix, props: Props[feColorMatrix]): VNode[feColorMatrix] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feColorMatrix]]
  
  inline def h_feComponentTransfer(tagName: feComponentTransfer, props: Props[feComponentTransfer]): VNode[feComponentTransfer] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feComponentTransfer]]
  
  inline def h_feComposite(tagName: feComposite, props: Props[feComposite]): VNode[feComposite] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feComposite]]
  
  inline def h_feConvolveMatrix(tagName: feConvolveMatrix, props: Props[feConvolveMatrix]): VNode[feConvolveMatrix] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feConvolveMatrix]]
  
  inline def h_feDiffuseLighting(tagName: feDiffuseLighting, props: Props[feDiffuseLighting]): VNode[feDiffuseLighting] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feDiffuseLighting]]
  ...
  inline def h_feFuncA(tagName: feFuncA, props: Props[feFuncA]): VNode[feFuncA] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feFuncA]]
  
  inline def h_feFuncB(tagName: feFuncB, props: Props[feFuncB]): VNode[feFuncB] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feFuncB]]
  
  inline def h_feFuncG(tagName: feFuncG, props: Props[feFuncG]): VNode[feFuncG] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feFuncG]]
  
  inline def h_feFuncR(tagName: feFuncR, props: Props[feFuncR]): VNode[feFuncR] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feFuncR]]
  
  inline def h_feGaussianBlur(tagName: feGaussianBlur, props: Props[feGaussianBlur]): VNode[feGaussianBlur] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feGaussianBlur]]
  
  inline def h_feImage(tagName: feImage, props: Props[feImage]): VNode[feImage] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feImage]]
  
  inline def h_feMerge(tagName: feMerge, props: Props[feMerge]): VNode[feMerge] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feMerge]]
  
  inline def h_feMergeNode(tagName: feMergeNode, props: Props[feMergeNode]): VNode[feMergeNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feMergeNode]]
  
  inline def h_feMorphology(tagName: feMorphology, props: Props[feMorphology]): VNode[feMorphology] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feMorphology]]
  
  inline def h_feOffset(tagName: feOffset, props: Props[feOffset]): VNode[feOffset] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feOffset]]
  
  inline def h_fePointLight(tagName: fePointLight, props: Props[fePointLight]): VNode[fePointLight] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[fePointLight]]
  
  inline def h_feSpecularLighting(tagName: feSpecularLighting, props: Props[feSpecularLighting]): VNode[feSpecularLighting] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feSpecularLighting]]
  
  inline def h_feSpotLight(tagName: feSpotLight, props: Props[feSpotLight]): VNode[feSpotLight] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feSpotLight]]
  
  inline def h_feTile(tagName: feTile, props: Props[feTile]): VNode[feTile] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feTile]]
  
  inline def h_feTurbulence(tagName: feTurbulence, props: Props[feTurbulence]): VNode[feTurbulence] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[feTurbulence]]
  
  inline def h_fieldset(tagName: fieldset, props: Props[fieldset]): VNode[fieldset] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[fieldset]]
  
  inline def h_figcaption(tagName: figcaption, props: Props[figcaption]): VNode[figcaption] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[figcaption]]
  
  inline def h_figure(tagName: figure, props: Props[figure]): VNode[figure] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[figure]]
  ...
  inline def h_h1(tagName: h1, props: Props[h1]): VNode[h1] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h1]]
  
  inline def h_h2(tagName: h2, props: Props[h2]): VNode[h2] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h2]]
  
  inline def h_h3(tagName: h3, props: Props[h3]): VNode[h3] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h3]]
  
  inline def h_h4(tagName: h4, props: Props[h4]): VNode[h4] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h4]]
  
  inline def h_h5(tagName: h5, props: Props[h5]): VNode[h5] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h5]]
  
  inline def h_h6(tagName: h6, props: Props[h6]): VNode[h6] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[h6]]
  
  inline def h_head(tagName: head, props: Props[head]): VNode[head] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[head]]
  
  inline def h_header(tagName: header, props: Props[header]): VNode[header] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[header]]
  
  inline def h_hgroup(tagName: hgroup, props: Props[hgroup]): VNode[hgroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[hgroup]]
  
  inline def h_hr(tagName: hr, props: Props[hr]): VNode[hr] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[hr]]
  
  inline def h_html(tagName: html, props: Props[html]): VNode[html] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[html]]
  
  inline def h_i(tagName: i, props: Props[i]): VNode[i] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[i]]
  
  inline def h_iframe(tagName: iframe, props: Props[iframe]): VNode[iframe] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[iframe]]
  
  inline def h_image(tagName: image, props: Props[image]): VNode[image] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[image]]
  
  inline def h_img(tagName: img, props: Props[img]): VNode[img] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[img]]
  
  inline def h_input(tagName: input, props: Props[input]): VNode[input] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[input]]
  
  inline def h_ins(tagName: ins, props: Props[ins]): VNode[ins] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[ins]]
  
  inline def h_kbd(tagName: kbd, props: Props[kbd]): VNode[kbd] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[kbd]]
  
  inline def h_label(tagName: label, props: Props[label]): VNode[label] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[label]]
  
  inline def h_legend(tagName: legend, props: Props[legend]): VNode[legend] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[legend]]
  
  inline def h_li(tagName: li, props: Props[li]): VNode[li] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[li]]
  
  inline def h_line(tagName: line, props: Props[line]): VNode[line] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[line]]
  
  inline def h_linearGradient(tagName: linearGradient, props: Props[linearGradient]): VNode[linearGradient] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[linearGradient]]
  
  inline def h_link(tagName: link, props: Props[link]): VNode[link] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[link]]
  
  inline def h_main(tagName: main, props: Props[main]): VNode[main] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[main]]
  
  inline def h_map(tagName: map, props: Props[map]): VNode[map] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[map]]
  
  inline def h_mark(tagName: mark, props: Props[mark]): VNode[mark] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[mark]]
  ...
  inline def h_meta(tagName: meta, props: Props[meta]): VNode[meta] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[meta]]
  ...
  inline def h_noscript(tagName: noscript, props: Props[noscript]): VNode[noscript] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[noscript]]
  
  inline def h_object(tagName: `object`, props: Props[`object`]): VNode[`object`] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[`object`]]
  
  inline def h_ol(tagName: ol, props: Props[ol]): VNode[ol] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[ol]]
  
  inline def h_optgroup(tagName: optgroup, props: Props[optgroup]): VNode[optgroup] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[optgroup]]
  
  inline def h_option(tagName: option, props: Props[option]): VNode[option] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[option]]
  ...
  inline def h_pattern(tagName: pattern, props: Props[pattern]): VNode[pattern] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[pattern]]
  
  inline def h_picture(tagName: picture, props: Props[picture]): VNode[picture] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[picture]]
  
  inline def h_polygon(tagName: polygon, props: Props[polygon]): VNode[polygon] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[polygon]]
  
  inline def h_polyline(tagName: polyline, props: Props[polyline]): VNode[polyline] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[polyline]]
  
  inline def h_pre(tagName: pre, props: Props[pre]): VNode[pre] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[pre]]
  
  inline def h_progress(tagName: progress, props: Props[progress]): VNode[progress] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[progress]]
  
  inline def h_q(tagName: q, props: Props[q]): VNode[q] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[q]]
  
  inline def h_radialGradient(tagName: radialGradient, props: Props[radialGradient]): VNode[radialGradient] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[radialGradient]]
  
  inline def h_rect(tagName: rect, props: Props[rect]): VNode[rect] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[rect]]
  
  inline def h_rp(tagName: rp, props: Props[rp]): VNode[rp] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[rp]]
  
  inline def h_rt(tagName: rt, props: Props[rt]): VNode[rt] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[rt]]
  
  inline def h_ruby(tagName: ruby, props: Props[ruby]): VNode[ruby] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[ruby]]
  
  inline def h_s(tagName: s, props: Props[s]): VNode[s] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[s]]
  ...
  inline def h_small(tagName: small, props: Props[small]): VNode[small] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[small]]
  
  inline def h_source(tagName: source, props: Props[source]): VNode[source] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[source]]
  
  inline def h_span(tagName: span, props: Props[span]): VNode[span] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[span]]
  
  inline def h_stop(tagName: stop, props: Props[stop]): VNode[stop] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[stop]]
  
  inline def h_strong(tagName: strong, props: Props[strong]): VNode[strong] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[strong]]
  
  inline def h_style(tagName: style, props: Props[style]): VNode[style] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[style]]
  
  inline def h_sub(tagName: sub, props: Props[sub]): VNode[sub] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[sub]]
  
  inline def h_summary(tagName: summary, props: Props[summary]): VNode[summary] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[summary]]
  
  inline def h_sup(tagName: sup, props: Props[sup]): VNode[sup] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[sup]]
  
  inline def h_svg(tagName: svg, props: Props[svg]): VNode[svg] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[svg]]
  
  inline def h_switch(tagName: switch, props: Props[switch]): VNode[switch] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[switch]]
  
  inline def h_symbol(tagName: symbol, props: Props[symbol]): VNode[symbol] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[symbol]]
  
  inline def h_table(tagName: table, props: Props[table]): VNode[table] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[table]]
  
  inline def h_tbody(tagName: tbody, props: Props[tbody]): VNode[tbody] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[tbody]]
  
  inline def h_td(tagName: td, props: Props[td]): VNode[td] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[td]]
  
  inline def h_template(tagName: template, props: Props[template]): VNode[template] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[template]]
  
  inline def h_text(tagName: text, props: Props[text]): VNode[text] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[text]]
  
  inline def h_textPath(tagName: textPath, props: Props[textPath]): VNode[textPath] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[textPath]]
  
  inline def h_textarea(tagName: textarea, props: Props[textarea]): VNode[textarea] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[textarea]]
  
  inline def h_tfoot(tagName: tfoot, props: Props[tfoot]): VNode[tfoot] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[tfoot]]
  
  inline def h_th(tagName: th, props: Props[th]): VNode[th] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[th]]
  
  inline def h_thead(tagName: thead, props: Props[thead]): VNode[thead] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[thead]]
  
  inline def h_time(tagName: time, props: Props[time]): VNode[time] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[time]]
  
  inline def h_title(tagName: title, props: Props[title]): VNode[title] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[title]]
  
  inline def h_tr(tagName: tr, props: Props[tr]): VNode[tr] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[tr]]
  
  inline def h_track(tagName: track, props: Props[track]): VNode[track] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[track]]
  
  inline def h_tspan(tagName: tspan, props: Props[tspan]): VNode[tspan] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[tspan]]
  
  inline def h_u(tagName: u, props: Props[u]): VNode[u] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[u]]
  
  inline def h_ul(tagName: ul, props: Props[ul]): VNode[ul] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[ul]]
  
  inline def h_use(tagName: use, props: Props[use]): VNode[use] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[use]]
  
  inline def h_var(tagName: `var`, props: Props[`var`]): VNode[`var`] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[`var`]]
  
  inline def h_video(tagName: video, props: Props[video]): VNode[video] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[video]]
  
  inline def h_view(tagName: view, props: Props[view]): VNode[view] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[view]]
  
  inline def h_wbr(tagName: wbr, props: Props[wbr]): VNode[wbr] = (^.asInstanceOf[js.Dynamic].applyDynamic("h")(tagName.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[VNode[wbr]]
  
  inline def patch_a(rootElement: HTMLAnchorElement, vNode: VNode[a]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_abbr(rootElement: HTMLElement, vNode: VNode[abbr]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_article(rootElement: HTMLElement, vNode: VNode[article]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_aside(rootElement: HTMLElement, vNode: VNode[aside]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_audio(rootElement: HTMLAudioElement, vNode: VNode[audio]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_bdo(rootElement: HTMLElement, vNode: VNode[bdo]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_blockquote(rootElement: HTMLQuoteElement, vNode: VNode[blockquote]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_body(rootElement: HTMLBodyElement, vNode: VNode[body]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_br(rootElement: HTMLBRElement, vNode: VNode[br]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_button(rootElement: HTMLButtonElement, vNode: VNode[button]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_canvas(rootElement: HTMLCanvasElement, vNode: VNode[canvas]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_caption(rootElement: HTMLTableCaptionElement, vNode: VNode[caption]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_circle(rootElement: SVGCircleElement, vNode: VNode[circle]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_cite(rootElement: HTMLElement, vNode: VNode[cite]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_clipPath(rootElement: SVGClipPathElement, vNode: VNode[clipPath]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_code(rootElement: HTMLElement, vNode: VNode[code]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_col(rootElement: HTMLTableColElement, vNode: VNode[col]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_colgroup(rootElement: HTMLTableColElement, vNode: VNode[colgroup]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_data(rootElement: HTMLDataElement, vNode: VNode[data]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_datalist(rootElement: HTMLDataListElement, vNode: VNode[datalist]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_dd(rootElement: HTMLElement, vNode: VNode[dd]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_defs(rootElement: SVGDefsElement, vNode: VNode[defs]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_del(rootElement: HTMLModElement, vNode: VNode[del]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_desc(rootElement: SVGDescElement, vNode: VNode[desc]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_details(rootElement: HTMLDetailsElement, vNode: VNode[details]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_dfn(rootElement: HTMLElement, vNode: VNode[dfn]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_dt(rootElement: HTMLElement, vNode: VNode[dt]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_ellipse(rootElement: SVGEllipseElement, vNode: VNode[ellipse]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_em(rootElement: HTMLElement, vNode: VNode[em]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_embed(rootElement: HTMLEmbedElement, vNode: VNode[embed]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feBlend(rootElement: SVGFEBlendElement, vNode: VNode[feBlend]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feColorMatrix(rootElement: SVGFEColorMatrixElement, vNode: VNode[feColorMatrix]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feComponentTransfer(rootElement: SVGFEComponentTransferElement, vNode: VNode[feComponentTransfer]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feComposite(rootElement: SVGFECompositeElement, vNode: VNode[feComposite]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feConvolveMatrix(rootElement: SVGFEConvolveMatrixElement, vNode: VNode[feConvolveMatrix]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feDiffuseLighting(rootElement: SVGFEDiffuseLightingElement, vNode: VNode[feDiffuseLighting]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_feFuncA(rootElement: SVGFEFuncAElement, vNode: VNode[feFuncA]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feFuncB(rootElement: SVGFEFuncBElement, vNode: VNode[feFuncB]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feFuncG(rootElement: SVGFEFuncGElement, vNode: VNode[feFuncG]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feFuncR(rootElement: SVGFEFuncRElement, vNode: VNode[feFuncR]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feGaussianBlur(rootElement: SVGFEGaussianBlurElement, vNode: VNode[feGaussianBlur]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feImage(rootElement: SVGFEImageElement, vNode: VNode[feImage]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feMerge(rootElement: SVGFEMergeElement, vNode: VNode[feMerge]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feMergeNode(rootElement: SVGFEMergeNodeElement, vNode: VNode[feMergeNode]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feMorphology(rootElement: SVGFEMorphologyElement, vNode: VNode[feMorphology]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feOffset(rootElement: SVGFEOffsetElement, vNode: VNode[feOffset]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_fePointLight(rootElement: SVGFEPointLightElement, vNode: VNode[fePointLight]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feSpecularLighting(rootElement: SVGFESpecularLightingElement, vNode: VNode[feSpecularLighting]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feSpotLight(rootElement: SVGFESpotLightElement, vNode: VNode[feSpotLight]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feTile(rootElement: SVGFETileElement, vNode: VNode[feTile]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_feTurbulence(rootElement: SVGFETurbulenceElement, vNode: VNode[feTurbulence]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_fieldset(rootElement: HTMLFieldSetElement, vNode: VNode[fieldset]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_figcaption(rootElement: HTMLElement, vNode: VNode[figcaption]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_figure(rootElement: HTMLElement, vNode: VNode[figure]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_h1(rootElement: HTMLHeadingElement, vNode: VNode[h1]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_h2(rootElement: HTMLHeadingElement, vNode: VNode[h2]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_h3(rootElement: HTMLHeadingElement, vNode: VNode[h3]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_h4(rootElement: HTMLHeadingElement, vNode: VNode[h4]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_h5(rootElement: HTMLHeadingElement, vNode: VNode[h5]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_h6(rootElement: HTMLHeadingElement, vNode: VNode[h6]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_head(rootElement: HTMLHeadElement, vNode: VNode[head]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_header(rootElement: HTMLElement, vNode: VNode[header]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_hgroup(rootElement: HTMLElement, vNode: VNode[hgroup]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_hr(rootElement: HTMLHRElement, vNode: VNode[hr]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_html(rootElement: HTMLHtmlElement, vNode: VNode[html]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_i(rootElement: HTMLElement, vNode: VNode[i]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_iframe(rootElement: HTMLIFrameElement, vNode: VNode[iframe]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_image(rootElement: SVGImageElement, vNode: VNode[image]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_img(rootElement: HTMLImageElement, vNode: VNode[img]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_input(rootElement: HTMLInputElement, vNode: VNode[input]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_ins(rootElement: HTMLModElement, vNode: VNode[ins]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_kbd(rootElement: HTMLElement, vNode: VNode[kbd]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_label(rootElement: HTMLLabelElement, vNode: VNode[label]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_legend(rootElement: HTMLLegendElement, vNode: VNode[legend]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_li(rootElement: HTMLLIElement, vNode: VNode[li]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_line(rootElement: SVGLineElement, vNode: VNode[line]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_linearGradient(rootElement: SVGLinearGradientElement, vNode: VNode[linearGradient]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_link(rootElement: HTMLLinkElement, vNode: VNode[link]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_main(rootElement: HTMLElement, vNode: VNode[main]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_map(rootElement: HTMLMapElement, vNode: VNode[map]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_mark(rootElement: HTMLElement, vNode: VNode[mark]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_meta(rootElement: HTMLMetaElement, vNode: VNode[meta]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_noscript(rootElement: HTMLElement, vNode: VNode[noscript]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_object(rootElement: HTMLObjectElement, vNode: VNode[`object`]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_ol(rootElement: HTMLOListElement, vNode: VNode[ol]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_optgroup(rootElement: HTMLOptGroupElement, vNode: VNode[optgroup]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_option(rootElement: HTMLOptionElement, vNode: VNode[option]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_pattern(rootElement: SVGPatternElement, vNode: VNode[pattern]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_picture(rootElement: HTMLPictureElement, vNode: VNode[picture]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_polygon(rootElement: SVGPolygonElement, vNode: VNode[polygon]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_polyline(rootElement: SVGPolylineElement, vNode: VNode[polyline]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_pre(rootElement: HTMLPreElement, vNode: VNode[pre]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_progress(rootElement: HTMLProgressElement, vNode: VNode[progress]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_q(rootElement: HTMLQuoteElement, vNode: VNode[q]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_radialGradient(rootElement: SVGRadialGradientElement, vNode: VNode[radialGradient]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_rect(rootElement: SVGRectElement, vNode: VNode[rect]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_rp(rootElement: HTMLElement, vNode: VNode[rp]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_rt(rootElement: HTMLElement, vNode: VNode[rt]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_ruby(rootElement: HTMLElement, vNode: VNode[ruby]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_s(rootElement: HTMLElement, vNode: VNode[s]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_samp(rootElement: HTMLElement, vNode: VNode[samp]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_source(rootElement: HTMLSourceElement, vNode: VNode[source]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_span(rootElement: HTMLSpanElement, vNode: VNode[span]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_stop(rootElement: SVGStopElement, vNode: VNode[stop]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_strong(rootElement: HTMLElement, vNode: VNode[strong]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_style(rootElement: HTMLStyleElement, vNode: VNode[style]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_sub(rootElement: HTMLElement, vNode: VNode[sub]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_summary(rootElement: HTMLElement, vNode: VNode[summary]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_sup(rootElement: HTMLElement, vNode: VNode[sup]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_svg(rootElement: SVGSVGElement, vNode: VNode[svg]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_switch(rootElement: SVGSwitchElement, vNode: VNode[switch]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_symbol(rootElement: SVGSymbolElement, vNode: VNode[symbol]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_table(rootElement: HTMLTableElement, vNode: VNode[table]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_text(rootElement: SVGTextElement, vNode: VNode[text]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_textPath(rootElement: SVGTextPathElement, vNode: VNode[textPath]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_textarea(rootElement: HTMLTextAreaElement, vNode: VNode[textarea]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def patch_time(rootElement: HTMLTimeElement, vNode: VNode[time]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_title(rootElement: HTMLTitleElement, vNode: VNode[title]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_tr(rootElement: HTMLTableRowElement, vNode: VNode[tr]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_track(rootElement: HTMLTrackElement, vNode: VNode[track]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_tspan(rootElement: SVGTSpanElement, vNode: VNode[tspan]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_u(rootElement: HTMLElement, vNode: VNode[u]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_ul(rootElement: HTMLUListElement, vNode: VNode[ul]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_use(rootElement: SVGUseElement, vNode: VNode[use]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_var(rootElement: HTMLElement, vNode: VNode[`var`]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_video(rootElement: HTMLVideoElement, vNode: VNode[video]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def patch_view(rootElement: SVGViewElement, vNode: VNode[view]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(rootElement.asInstanceOf[js.Any], vNode.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object global {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        val a: Props[typings.superfine.superfineStrings.a]
        
        val abbr: Props[typings.superfine.superfineStrings.abbr]
        ...
        val article: Props[typings.superfine.superfineStrings.article]
        
        val aside: Props[typings.superfine.superfineStrings.aside]
        
        val audio: Props[typings.superfine.superfineStrings.audio]
        ...
        val bdo: Props[typings.superfine.superfineStrings.bdo]
        
        val blockquote: Props[typings.superfine.superfineStrings.blockquote]
        
        val body: Props[typings.superfine.superfineStrings.body]
        
        val br: Props[typings.superfine.superfineStrings.br]
        
        val button: Props[typings.superfine.superfineStrings.button]
        
        val canvas: Props[typings.superfine.superfineStrings.canvas]
        
        val caption: Props[typings.superfine.superfineStrings.caption]
        
        val circle: Props[typings.superfine.superfineStrings.circle]
        
        val cite: Props[typings.superfine.superfineStrings.cite]
        
        val clipPath: Props[typings.superfine.superfineStrings.clipPath]
        
        val code: Props[typings.superfine.superfineStrings.code]
        
        val col: Props[typings.superfine.superfineStrings.col]
        
        val colgroup: Props[typings.superfine.superfineStrings.colgroup]
        
        val data: Props[typings.superfine.superfineStrings.data]
        
        val datalist: Props[typings.superfine.superfineStrings.datalist]
        
        val dd: Props[typings.superfine.superfineStrings.dd]
        
        val defs: Props[typings.superfine.superfineStrings.defs]
        
        val del: Props[typings.superfine.superfineStrings.del]
        
        val desc: Props[typings.superfine.superfineStrings.desc]
        
        val details: Props[typings.superfine.superfineStrings.details]
        
        val dfn: Props[typings.superfine.superfineStrings.dfn]
        ...
        val dt: Props[typings.superfine.superfineStrings.dt]
        
        val ellipse: Props[typings.superfine.superfineStrings.ellipse]
        
        val em: Props[typings.superfine.superfineStrings.em]
        
        val embed: Props[typings.superfine.superfineStrings.embed]
        
        val feBlend: Props[typings.superfine.superfineStrings.feBlend]
        
        val feColorMatrix: Props[typings.superfine.superfineStrings.feColorMatrix]
        
        val feComponentTransfer: Props[typings.superfine.superfineStrings.feComponentTransfer]
        
        val feComposite: Props[typings.superfine.superfineStrings.feComposite]
        
        val feConvolveMatrix: Props[typings.superfine.superfineStrings.feConvolveMatrix]
        
        val feDiffuseLighting: Props[typings.superfine.superfineStrings.feDiffuseLighting]
        ...
        val feFuncA: Props[typings.superfine.superfineStrings.feFuncA]
        
        val feFuncB: Props[typings.superfine.superfineStrings.feFuncB]
        
        val feFuncG: Props[typings.superfine.superfineStrings.feFuncG]
        
        val feFuncR: Props[typings.superfine.superfineStrings.feFuncR]
        
        val feGaussianBlur: Props[typings.superfine.superfineStrings.feGaussianBlur]
        
        val feImage: Props[typings.superfine.superfineStrings.feImage]
        
        val feMerge: Props[typings.superfine.superfineStrings.feMerge]
        
        val feMergeNode: Props[typings.superfine.superfineStrings.feMergeNode]
        
        val feMorphology: Props[typings.superfine.superfineStrings.feMorphology]
        
        val feOffset: Props[typings.superfine.superfineStrings.feOffset]
        
        val fePointLight: Props[typings.superfine.superfineStrings.fePointLight]
        
        val feSpecularLighting: Props[typings.superfine.superfineStrings.feSpecularLighting]
        
        val feSpotLight: Props[typings.superfine.superfineStrings.feSpotLight]
        
        val feTile: Props[typings.superfine.superfineStrings.feTile]
        
        val feTurbulence: Props[typings.superfine.superfineStrings.feTurbulence]
        
        val fieldset: Props[typings.superfine.superfineStrings.fieldset]
        
        val figcaption: Props[typings.superfine.superfineStrings.figcaption]
        
        val figure: Props[typings.superfine.superfineStrings.figure]
        ...
        val h1: Props[typings.superfine.superfineStrings.h1]
        
        val h2: Props[typings.superfine.superfineStrings.h2]
        
        val h3: Props[typings.superfine.superfineStrings.h3]
        
        val h4: Props[typings.superfine.superfineStrings.h4]
        
        val h5: Props[typings.superfine.superfineStrings.h5]
        
        val h6: Props[typings.superfine.superfineStrings.h6]
        
        val head: Props[typings.superfine.superfineStrings.head]
        
        val header: Props[typings.superfine.superfineStrings.header]
        
        val hgroup: Props[typings.superfine.superfineStrings.hgroup]
        
        val hr: Props[typings.superfine.superfineStrings.hr]
        
        val html: Props[typings.superfine.superfineStrings.html]
        
        val i: Props[typings.superfine.superfineStrings.i]
        
        val iframe: Props[typings.superfine.superfineStrings.iframe]
        
        val image: Props[typings.superfine.superfineStrings.image]
        
        val img: Props[typings.superfine.superfineStrings.img]
        
        val input: Props[typings.superfine.superfineStrings.input]
        
        val ins: Props[typings.superfine.superfineStrings.ins]
        
        val kbd: Props[typings.superfine.superfineStrings.kbd]
        
        val label: Props[typings.superfine.superfineStrings.label]
        
        val legend: Props[typings.superfine.superfineStrings.legend]
        
        val li: Props[typings.superfine.superfineStrings.li]
        
        val line: Props[typings.superfine.superfineStrings.line]
        
        val linearGradient: Props[typings.superfine.superfineStrings.linearGradient]
        
        val link: Props[typings.superfine.superfineStrings.link]
        
        val main: Props[typings.superfine.superfineStrings.main]
        
        val map: Props[typings.superfine.superfineStrings.map]
        
        val mark: Props[typings.superfine.superfineStrings.mark]
        ...
        val meta: Props[typings.superfine.superfineStrings.meta]
        ...
        val noscript: Props[typings.superfine.superfineStrings.noscript]
        
        val `object`: Props[typings.superfine.superfineStrings.`object`]
        
        val ol: Props[typings.superfine.superfineStrings.ol]
        
        val optgroup: Props[typings.superfine.superfineStrings.optgroup]
        
        val option: Props[typings.superfine.superfineStrings.option]
        ...
        val pattern: Props[typings.superfine.superfineStrings.pattern]
        
        val picture: Props[typings.superfine.superfineStrings.picture]
        
        val polygon: Props[typings.superfine.superfineStrings.polygon]
        
        val polyline: Props[typings.superfine.superfineStrings.polyline]
        
        val pre: Props[typings.superfine.superfineStrings.pre]
        
        val progress: Props[typings.superfine.superfineStrings.progress]
        
        val q: Props[typings.superfine.superfineStrings.q]
        
        val radialGradient: Props[typings.superfine.superfineStrings.radialGradient]
        
        val rect: Props[typings.superfine.superfineStrings.rect]
        
        val rp: Props[typings.superfine.superfineStrings.rp]
        
        val rt: Props[typings.superfine.superfineStrings.rt]
        
        val ruby: Props[typings.superfine.superfineStrings.ruby]
        
        val s: Props[typings.superfine.superfineStrings.s]
        
        val samp: Props[typings.superfine.superfineStrings.samp]
        ...
        val small: Props[typings.superfine.superfineStrings.small]
        
        val source: Props[typings.superfine.superfineStrings.source]
        
        val span: Props[typings.superfine.superfineStrings.span]
        
        val stop: Props[typings.superfine.superfineStrings.stop]
        
        val strong: Props[typings.superfine.superfineStrings.strong]
        
        val style: Props[typings.superfine.superfineStrings.style]
        
        val sub: Props[typings.superfine.superfineStrings.sub]
        
        val summary: Props[typings.superfine.superfineStrings.summary]
        
        val sup: Props[typings.superfine.superfineStrings.sup]
        
        val svg: Props[typings.superfine.superfineStrings.svg]
        
        val switch: Props[typings.superfine.superfineStrings.switch]
        
        val symbol: Props[typings.superfine.superfineStrings.symbol]
        
        val table: Props[typings.superfine.superfineStrings.table]
        
        val tbody: Props[typings.superfine.superfineStrings.tbody]
        
        val td: Props[typings.superfine.superfineStrings.td]
        
        val template: Props[typings.superfine.superfineStrings.template]
        
        val text: Props[typings.superfine.superfineStrings.text]
        
        val textPath: Props[typings.superfine.superfineStrings.textPath]
        
        val textarea: Props[typings.superfine.superfineStrings.textarea]
        
        val tfoot: Props[typings.superfine.superfineStrings.tfoot]
        
        val th: Props[typings.superfine.superfineStrings.th]
        
        val thead: Props[typings.superfine.superfineStrings.thead]
        
        val time: Props[typings.superfine.superfineStrings.time]
        
        val title: Props[typings.superfine.superfineStrings.title]
        
        val tr: Props[typings.superfine.superfineStrings.tr]
        
        val track: Props[typings.superfine.superfineStrings.track]
        
        val tspan: Props[typings.superfine.superfineStrings.tspan]
        
        val u: Props[typings.superfine.superfineStrings.u]
        
        val ul: Props[typings.superfine.superfineStrings.ul]
        
        val use: Props[typings.superfine.superfineStrings.use]
        
        val `var`: Props[typings.superfine.superfineStrings.`var`]
        
        val video: Props[typings.superfine.superfineStrings.video]
        
        val view: Props[typings.superfine.superfineStrings.view]
        
        val wbr: Props[typings.superfine.superfineStrings.wbr]
      }
      object IntrinsicElements {
        ...
        implicit open class MutableBuilder[Self <: IntrinsicElements] (val x: Self) extends AnyVal {
          ...
          inline def setAbbr(value: Props[abbr]): Self = StObject.set(x, "abbr", value.asInstanceOf[js.Any])
          ...
          inline def setArticle(value: Props[article]): Self = StObject.set(x, "article", value.asInstanceOf[js.Any])
          
          inline def setAside(value: Props[aside]): Self = StObject.set(x, "aside", value.asInstanceOf[js.Any])
          
          inline def setAudio(value: Props[audio]): Self = StObject.set(x, "audio", value.asInstanceOf[js.Any])
          ...
          inline def setBdo(value: Props[bdo]): Self = StObject.set(x, "bdo", value.asInstanceOf[js.Any])
          
          inline def setBlockquote(value: Props[blockquote]): Self = StObject.set(x, "blockquote", value.asInstanceOf[js.Any])
          
          inline def setBody(value: Props[body]): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
          
          inline def setBr(value: Props[br]): Self = StObject.set(x, "br", value.asInstanceOf[js.Any])
          
          inline def setButton(value: Props[button]): Self = StObject.set(x, "button", value.asInstanceOf[js.Any])
          
          inline def setCanvas(value: Props[canvas]): Self = StObject.set(x, "canvas", value.asInstanceOf[js.Any])
          
          inline def setCaption(value: Props[caption]): Self = StObject.set(x, "caption", value.asInstanceOf[js.Any])
          
          inline def setCircle(value: Props[circle]): Self = StObject.set(x, "circle", value.asInstanceOf[js.Any])
          
          inline def setCite(value: Props[cite]): Self = StObject.set(x, "cite", value.asInstanceOf[js.Any])
          
          inline def setClipPath(value: Props[clipPath]): Self = StObject.set(x, "clipPath", value.asInstanceOf[js.Any])
          
          inline def setCode(value: Props[code]): Self = StObject.set(x, "code", value.asInstanceOf[js.Any])
          
          inline def setCol(value: Props[col]): Self = StObject.set(x, "col", value.asInstanceOf[js.Any])
          
          inline def setColgroup(value: Props[colgroup]): Self = StObject.set(x, "colgroup", value.asInstanceOf[js.Any])
          
          inline def setData(value: Props[data]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
          
          inline def setDatalist(value: Props[datalist]): Self = StObject.set(x, "datalist", value.asInstanceOf[js.Any])
          
          inline def setDd(value: Props[dd]): Self = StObject.set(x, "dd", value.asInstanceOf[js.Any])
          
          inline def setDefs(value: Props[defs]): Self = StObject.set(x, "defs", value.asInstanceOf[js.Any])
          
          inline def setDel(value: Props[del]): Self = StObject.set(x, "del", value.asInstanceOf[js.Any])
          
          inline def setDesc(value: Props[desc]): Self = StObject.set(x, "desc", value.asInstanceOf[js.Any])
          
          inline def setDetails(value: Props[details]): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
          
          inline def setDfn(value: Props[dfn]): Self = StObject.set(x, "dfn", value.asInstanceOf[js.Any])
          ...
          inline def setDt(value: Props[dt]): Self = StObject.set(x, "dt", value.asInstanceOf[js.Any])
          
          inline def setEllipse(value: Props[ellipse]): Self = StObject.set(x, "ellipse", value.asInstanceOf[js.Any])
          
          inline def setEm(value: Props[em]): Self = StObject.set(x, "em", value.asInstanceOf[js.Any])
          
          inline def setEmbed(value: Props[embed]): Self = StObject.set(x, "embed", value.asInstanceOf[js.Any])
          
          inline def setFeBlend(value: Props[feBlend]): Self = StObject.set(x, "feBlend", value.asInstanceOf[js.Any])
          
          inline def setFeColorMatrix(value: Props[feColorMatrix]): Self = StObject.set(x, "feColorMatrix", value.asInstanceOf[js.Any])
          
          inline def setFeComponentTransfer(value: Props[feComponentTransfer]): Self = StObject.set(x, "feComponentTransfer", value.asInstanceOf[js.Any])
          
          inline def setFeComposite(value: Props[feComposite]): Self = StObject.set(x, "feComposite", value.asInstanceOf[js.Any])
          
          inline def setFeConvolveMatrix(value: Props[feConvolveMatrix]): Self = StObject.set(x, "feConvolveMatrix", value.asInstanceOf[js.Any])
          
          inline def setFeDiffuseLighting(value: Props[feDiffuseLighting]): Self = StObject.set(x, "feDiffuseLighting", value.asInstanceOf[js.Any])
          ...
          inline def setFeFuncA(value: Props[feFuncA]): Self = StObject.set(x, "feFuncA", value.asInstanceOf[js.Any])
          
          inline def setFeFuncB(value: Props[feFuncB]): Self = StObject.set(x, "feFuncB", value.asInstanceOf[js.Any])
          
          inline def setFeFuncG(value: Props[feFuncG]): Self = StObject.set(x, "feFuncG", value.asInstanceOf[js.Any])
          
          inline def setFeFuncR(value: Props[feFuncR]): Self = StObject.set(x, "feFuncR", value.asInstanceOf[js.Any])
          
          inline def setFeGaussianBlur(value: Props[feGaussianBlur]): Self = StObject.set(x, "feGaussianBlur", value.asInstanceOf[js.Any])
          
          inline def setFeImage(value: Props[feImage]): Self = StObject.set(x, "feImage", value.asInstanceOf[js.Any])
          
          inline def setFeMerge(value: Props[feMerge]): Self = StObject.set(x, "feMerge", value.asInstanceOf[js.Any])
          
          inline def setFeMergeNode(value: Props[feMergeNode]): Self = StObject.set(x, "feMergeNode", value.asInstanceOf[js.Any])
          
          inline def setFeMorphology(value: Props[feMorphology]): Self = StObject.set(x, "feMorphology", value.asInstanceOf[js.Any])
          
          inline def setFeOffset(value: Props[feOffset]): Self = StObject.set(x, "feOffset", value.asInstanceOf[js.Any])
          
          inline def setFePointLight(value: Props[fePointLight]): Self = StObject.set(x, "fePointLight", value.asInstanceOf[js.Any])
          
          inline def setFeSpecularLighting(value: Props[feSpecularLighting]): Self = StObject.set(x, "feSpecularLighting", value.asInstanceOf[js.Any])
          
          inline def setFeSpotLight(value: Props[feSpotLight]): Self = StObject.set(x, "feSpotLight", value.asInstanceOf[js.Any])
          
          inline def setFeTile(value: Props[feTile]): Self = StObject.set(x, "feTile", value.asInstanceOf[js.Any])
          
          inline def setFeTurbulence(value: Props[feTurbulence]): Self = StObject.set(x, "feTurbulence", value.asInstanceOf[js.Any])
          
          inline def setFieldset(value: Props[fieldset]): Self = StObject.set(x, "fieldset", value.asInstanceOf[js.Any])
          
          inline def setFigcaption(value: Props[figcaption]): Self = StObject.set(x, "figcaption", value.asInstanceOf[js.Any])
          
          inline def setFigure(value: Props[figure]): Self = StObject.set(x, "figure", value.asInstanceOf[js.Any])
          ...
          inline def setH1(value: Props[h1]): Self = StObject.set(x, "h1", value.asInstanceOf[js.Any])
          
          inline def setH2(value: Props[h2]): Self = StObject.set(x, "h2", value.asInstanceOf[js.Any])
          
          inline def setH3(value: Props[h3]): Self = StObject.set(x, "h3", value.asInstanceOf[js.Any])
          
          inline def setH4(value: Props[h4]): Self = StObject.set(x, "h4", value.asInstanceOf[js.Any])
          
          inline def setH5(value: Props[h5]): Self = StObject.set(x, "h5", value.asInstanceOf[js.Any])
          
          inline def setH6(value: Props[h6]): Self = StObject.set(x, "h6", value.asInstanceOf[js.Any])
          
          inline def setHead(value: Props[head]): Self = StObject.set(x, "head", value.asInstanceOf[js.Any])
          
          inline def setHeader(value: Props[header]): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
          
          inline def setHgroup(value: Props[hgroup]): Self = StObject.set(x, "hgroup", value.asInstanceOf[js.Any])
          
          inline def setHr(value: Props[hr]): Self = StObject.set(x, "hr", value.asInstanceOf[js.Any])
          
          inline def setHtml(value: Props[html]): Self = StObject.set(x, "html", value.asInstanceOf[js.Any])
          
          inline def setI(value: Props[i]): Self = StObject.set(x, "i", value.asInstanceOf[js.Any])
          
          inline def setIframe(value: Props[iframe]): Self = StObject.set(x, "iframe", value.asInstanceOf[js.Any])
          
          inline def setImage(value: Props[image]): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
          
          inline def setImg(value: Props[img]): Self = StObject.set(x, "img", value.asInstanceOf[js.Any])
          
          inline def setInput(value: Props[input]): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
          
          inline def setIns(value: Props[ins]): Self = StObject.set(x, "ins", value.asInstanceOf[js.Any])
          
          inline def setKbd(value: Props[kbd]): Self = StObject.set(x, "kbd", value.asInstanceOf[js.Any])
          
          inline def setLabel(value: Props[label]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
          
          inline def setLegend(value: Props[legend]): Self = StObject.set(x, "legend", value.asInstanceOf[js.Any])
          
          inline def setLi(value: Props[li]): Self = StObject.set(x, "li", value.asInstanceOf[js.Any])
          
          inline def setLine(value: Props[line]): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
          
          inline def setLinearGradient(value: Props[linearGradient]): Self = StObject.set(x, "linearGradient", value.asInstanceOf[js.Any])
          
          inline def setLink(value: Props[link]): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
          
          inline def setMain(value: Props[main]): Self = StObject.set(x, "main", value.asInstanceOf[js.Any])
          
          inline def setMap(value: Props[map]): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
          
          inline def setMark(value: Props[mark]): Self = StObject.set(x, "mark", value.asInstanceOf[js.Any])
          ...
          inline def setMeta(value: Props[meta]): Self = StObject.set(x, "meta", value.asInstanceOf[js.Any])
          ...
          inline def setNoscript(value: Props[noscript]): Self = StObject.set(x, "noscript", value.asInstanceOf[js.Any])
          
          inline def setObject(value: Props[`object`]): Self = StObject.set(x, "object", value.asInstanceOf[js.Any])
          
          inline def setOl(value: Props[ol]): Self = StObject.set(x, "ol", value.asInstanceOf[js.Any])
          
          inline def setOptgroup(value: Props[optgroup]): Self = StObject.set(x, "optgroup", value.asInstanceOf[js.Any])
          
          inline def setOption(value: Props[option]): Self = StObject.set(x, "option", value.asInstanceOf[js.Any])
          ...
          inline def setPattern(value: Props[pattern]): Self = StObject.set(x, "pattern", value.asInstanceOf[js.Any])
          
          inline def setPicture(value: Props[picture]): Self = StObject.set(x, "picture", value.asInstanceOf[js.Any])
          
          inline def setPolygon(value: Props[polygon]): Self = StObject.set(x, "polygon", value.asInstanceOf[js.Any])
          
          inline def setPolyline(value: Props[polyline]): Self = StObject.set(x, "polyline", value.asInstanceOf[js.Any])
          
          inline def setPre(value: Props[pre]): Self = StObject.set(x, "pre", value.asInstanceOf[js.Any])
          
          inline def setProgress(value: Props[progress]): Self = StObject.set(x, "progress", value.asInstanceOf[js.Any])
          
          inline def setQ(value: Props[q]): Self = StObject.set(x, "q", value.asInstanceOf[js.Any])
          
          inline def setRadialGradient(value: Props[radialGradient]): Self = StObject.set(x, "radialGradient", value.asInstanceOf[js.Any])
          
          inline def setRect(value: Props[rect]): Self = StObject.set(x, "rect", value.asInstanceOf[js.Any])
          
          inline def setRp(value: Props[rp]): Self = StObject.set(x, "rp", value.asInstanceOf[js.Any])
          
          inline def setRt(value: Props[rt]): Self = StObject.set(x, "rt", value.asInstanceOf[js.Any])
          
          inline def setRuby(value: Props[ruby]): Self = StObject.set(x, "ruby", value.asInstanceOf[js.Any])
          
          inline def setS(value: Props[s]): Self = StObject.set(x, "s", value.asInstanceOf[js.Any])
          ...
          inline def setSmall(value: Props[small]): Self = StObject.set(x, "small", value.asInstanceOf[js.Any])
          
          inline def setSource(value: Props[source]): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
          
          inline def setSpan(value: Props[span]): Self = StObject.set(x, "span", value.asInstanceOf[js.Any])
          
          inline def setStop(value: Props[stop]): Self = StObject.set(x, "stop", value.asInstanceOf[js.Any])
          
          inline def setStrong(value: Props[strong]): Self = StObject.set(x, "strong", value.asInstanceOf[js.Any])
          
          inline def setStyle(value: Props[style]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
          
          inline def setSub(value: Props[sub]): Self = StObject.set(x, "sub", value.asInstanceOf[js.Any])
          
          inline def setSummary(value: Props[summary]): Self = StObject.set(x, "summary", value.asInstanceOf[js.Any])
          
          inline def setSup(value: Props[sup]): Self = StObject.set(x, "sup", value.asInstanceOf[js.Any])
          
          inline def setSvg(value: Props[svg]): Self = StObject.set(x, "svg", value.asInstanceOf[js.Any])
          
          inline def setSwitch(value: Props[switch]): Self = StObject.set(x, "switch", value.asInstanceOf[js.Any])
          
          inline def setSymbol(value: Props[symbol]): Self = StObject.set(x, "symbol", value.asInstanceOf[js.Any])
          
          inline def setTable(value: Props[table]): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
          
          inline def setTbody(value: Props[tbody]): Self = StObject.set(x, "tbody", value.asInstanceOf[js.Any])
          
          inline def setTd(value: Props[td]): Self = StObject.set(x, "td", value.asInstanceOf[js.Any])
          
          inline def setTemplate(value: Props[template]): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
          
          inline def setText(value: Props[text]): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
          
          inline def setTextPath(value: Props[textPath]): Self = StObject.set(x, "textPath", value.asInstanceOf[js.Any])
          
          inline def setTextarea(value: Props[textarea]): Self = StObject.set(x, "textarea", value.asInstanceOf[js.Any])
          
          inline def setTfoot(value: Props[tfoot]): Self = StObject.set(x, "tfoot", value.asInstanceOf[js.Any])
          
          inline def setTh(value: Props[th]): Self = StObject.set(x, "th", value.asInstanceOf[js.Any])
          
          inline def setThead(value: Props[thead]): Self = StObject.set(x, "thead", value.asInstanceOf[js.Any])
          
          inline def setTime(value: Props[time]): Self = StObject.set(x, "time", value.asInstanceOf[js.Any])
          
          inline def setTitle(value: Props[title]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
          
          inline def setTr(value: Props[tr]): Self = StObject.set(x, "tr", value.asInstanceOf[js.Any])
          
          inline def setTrack(value: Props[track]): Self = StObject.set(x, "track", value.asInstanceOf[js.Any])
          
          inline def setTspan(value: Props[tspan]): Self = StObject.set(x, "tspan", value.asInstanceOf[js.Any])
          
          inline def setU(value: Props[u]): Self = StObject.set(x, "u", value.asInstanceOf[js.Any])
          
          inline def setUl(value: Props[ul]): Self = StObject.set(x, "ul", value.asInstanceOf[js.Any])
          
          inline def setUse(value: Props[use]): Self = StObject.set(x, "use", value.asInstanceOf[js.Any])
          
          inline def setVar(value: Props[`var`]): Self = StObject.set(x, "var", value.asInstanceOf[js.Any])
          
          inline def setVideo(value: Props[video]): Self = StObject.set(x, "video", value.asInstanceOf[js.Any])
          
          inline def setView(value: Props[view]): Self = StObject.set(x, "view", value.asInstanceOf[js.Any])
          
          inline def setWbr(value: Props[wbr]): Self = StObject.set(x, "wbr", value.asInstanceOf[js.Any])
        }
      }
    }
  }
