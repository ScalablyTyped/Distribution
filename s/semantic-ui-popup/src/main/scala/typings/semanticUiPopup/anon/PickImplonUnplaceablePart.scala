...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'onUnplaceable'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplonUnplaceablePart
  extends StObject
     with Param {
...
object PickImplonUnplaceablePart {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonUnplaceablePart] (val x: Self) extends AnyVal {
