...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'title'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
...
object PickImpltitlePartialPickI {
  ...
  inline def apply(title: String & js.UndefOr[String]): PickImpltitlePartialPickI = {
