...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'boundary'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplboundaryPartialPi
  extends StObject
     with Param {
...
object PickImplboundaryPartialPi {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplboundaryPartialPi] (val x: Self) extends AnyVal {
