...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'distanceAway'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImpldistanceAwayParti
  extends StObject
     with Param {
...
object PickImpldistanceAwayParti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpldistanceAwayParti] (val x: Self) extends AnyVal {
