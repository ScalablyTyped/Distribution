...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'onVisible'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplonVisiblePartialP
  extends StObject
     with Param {
...
object PickImplonVisiblePartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplonVisiblePartialP] (val x: Self) extends AnyVal {
