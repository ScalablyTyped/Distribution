...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'jitter'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImpljitterPartialPick
  extends StObject
     with Param {
...
object PickImpljitterPartialPick {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImpljitterPartialPick] (val x: Self) extends AnyVal {
