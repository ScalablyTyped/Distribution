...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'movePopup'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplmovePopupPartialP
  extends StObject
     with Param {
...
object PickImplmovePopupPartialP {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmovePopupPartialP] (val x: Self) extends AnyVal {
