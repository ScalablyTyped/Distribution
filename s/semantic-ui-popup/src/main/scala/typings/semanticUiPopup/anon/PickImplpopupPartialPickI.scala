...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'popup'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplpopupPartialPickI
  extends StObject
     with Param {
...
object PickImplpopupPartialPickI {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplpopupPartialPickI] (val x: Self) extends AnyVal {
