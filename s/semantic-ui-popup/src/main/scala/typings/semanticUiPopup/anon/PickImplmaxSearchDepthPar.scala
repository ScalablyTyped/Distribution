...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'maxSearchDepth'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplmaxSearchDepthPar
  extends StObject
     with Param {
...
object PickImplmaxSearchDepthPar {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PickImplmaxSearchDepthPar] (val x: Self) extends AnyVal {
