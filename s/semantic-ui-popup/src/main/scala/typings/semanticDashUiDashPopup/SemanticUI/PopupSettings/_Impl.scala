package typings.semanticDashUiDashPopup.SemanticUI.PopupSettings

import typings.semanticDashUiDashPopup.JQuery
import typings.semanticDashUiDashPopup.SemanticUI.Popup.ClassNameSettings
import typings.semanticDashUiDashPopup.SemanticUI.Popup.DelaySettings
