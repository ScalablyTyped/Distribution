...
trait Popup extends js.Object {
  ...
  def apply[K /* <: java.lang.String */](behavior: semanticDashUiDashPopupLib.semanticDashUiDashPopupLibStrings.setting, name: K): /* import warning: ImportType.apply Failed type conversion: semantic-ui-popup.SemanticUI.PopupSettings._Impl[K] */ js.Any = js.native
