...
package object yargsNs {
  type Arguments[T] = T with yargsLib.Anon_ArgName
  ...
  type RequiredOptionType[O /* <: Options | PositionalOptions */] = java.lang.String | scala.Double | scala.Boolean | (js.Array[java.lang.String | scala.Double]) | js.Array[java.lang.String] | js.Array[scala.Double]
