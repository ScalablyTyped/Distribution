...
object parseCommandMod {
  ...
  inline def parseCommand(cmd: String): ParsedCommand = ^.asInstanceOf[js.Dynamic].applyDynamic("parseCommand")(cmd.asInstanceOf[js.Any]).asInstanceOf[ParsedCommand]
  ...
  object ParsedCommand {
    ...
    inline def apply(cmd: String, demanded: js.Array[Positional], optional: js.Array[Positional]): ParsedCommand = {
    ...
    extension [Self <: ParsedCommand](x: Self) {
  ...
  object Positional {
    ...
    inline def apply(cmd: NotEmptyArray[String], variadic: Boolean): Positional = {
    ...
    extension [Self <: Positional](x: Self) {
      
      inline def setCmd(value: NotEmptyArray[String]): Self = StObject.set(x, "cmd", value.asInstanceOf[js.Any])
