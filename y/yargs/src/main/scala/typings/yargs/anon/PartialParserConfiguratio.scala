...
trait PartialParserConfiguratio extends js.Object {
  ...
  var `negation-prefix`: js.UndefOr[java.lang.String] = js.undefined
  ...
  var `sort-commands`: js.UndefOr[scala.Boolean] = js.undefined
...
object PartialParserConfiguratio {
  ...
  def apply(
    ...
    `negation-prefix`: java.lang.String = null,
    ...
    `sort-commands`: js.UndefOr[scala.Boolean] = js.undefined,
    ...
    if (!js.isUndefined(`sort-commands`)) __obj.updateDynamic("sort-commands")(`sort-commands`.get.asInstanceOf[js.Any])
