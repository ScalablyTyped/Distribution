...
object commonTypesMod {
  ...
  @scala.inline
  def objectKeys[T](`object`: T): js.Array[/* keyof T */ String] = ^.asInstanceOf[js.Dynamic].applyDynamic("objectKeys")(`object`.asInstanceOf[js.Any]).asInstanceOf[js.Array[/* keyof T */ String]]
