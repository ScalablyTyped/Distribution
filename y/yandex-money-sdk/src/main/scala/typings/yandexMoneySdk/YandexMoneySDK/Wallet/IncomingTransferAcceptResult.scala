...
object IncomingTransferAcceptResult {
  ...
  def apply(
    ...
    protection_code_attempts_available: js.UndefOr[Double] = js.undefined
    ...
    if (!js.isUndefined(protection_code_attempts_available)) __obj.updateDynamic("protection_code_attempts_available")(protection_code_attempts_available.get.asInstanceOf[js.Any])
