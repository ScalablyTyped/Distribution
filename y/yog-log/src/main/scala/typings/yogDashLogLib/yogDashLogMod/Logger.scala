...
class Logger protected () extends js.Object {
  ...
  def debug(info: LogInput): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def extend(destination: js.Object, source: js.Object): js.Object = js.native
  def fatal(info: LogInput): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def getCookie(name: java.lang.String): java.lang.String | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def getLogFile(intLevel: LevelInt): java.lang.String = js.native
  def getLogFormat(level: LevelName): java.lang.String | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def getLogID(req: expressLib.expressMod.Request, logIDName: java.lang.String): java.lang.String = js.native
  def getLogLevelInt(level: LevelName): LevelInt | yogDashLogLib.yogDashLogLibNumbers.`-1` = js.native
  ...
  def notice(info: LogInput): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  ...
  def trace(info: LogInput): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def warning(info: LogInput): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
  def writeLog(intLevel: LevelInt, options: WriteLogConfig, log_format: java.lang.String): scala.Unit | yogDashLogLib.yogDashLogLibNumbers.`false` = js.native
}
