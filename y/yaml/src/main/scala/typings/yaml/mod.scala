...
object mod {
  ...
  open class Alias protected ()
    extends typings.yaml.distMod.Alias {
  ...
  object CST {
    ...
    @JSImport("yaml", "CST.BOM")
    @js.native
    val BOM: /* "\\uFEFF" */ String = js.native
    
    @JSImport("yaml", "CST.DOCUMENT")
    @js.native
    val DOCUMENT: /* "\\u0002" */ String = js.native
    
    @JSImport("yaml", "CST.FLOW_END")
    @js.native
    val FLOW_END: /* "\\u0018" */ String = js.native
    
    @JSImport("yaml", "CST.SCALAR")
    @js.native
    ...
    object visit {
      ...
      @JSImport("yaml", "CST.visit")
      @js.native
      val ^ : js.Any = js.native
      
      @JSImport("yaml", "CST.visit.BREAK")
      @js.native
      ...
      @JSImport("yaml", "CST.visit.REMOVE")
      @js.native
      ...
      @JSImport("yaml", "CST.visit.itemAtPath")
      @js.native
      ...
      @JSImport("yaml", "CST.visit.parentCollection")
      @js.native
  ...
  @JSImport("yaml", "Composer")
  @js.native
  open class Composer[Contents /* <: ParsedNode */, Strict /* <: Boolean */] ()
    extends typings.yaml.distMod.Composer[Contents, Strict] {
  ...
  open class Document[Contents /* <: Node[Any] */, Strict /* <: Boolean */] ()
    extends typings.yaml.distMod.Document[Contents, Strict] {
  ...
  @js.native
  open class Lexer ()
    extends typings.yaml.distMod.Lexer
  
  @JSImport("yaml", "LineCounter")
  @js.native
  open class LineCounter ()
    extends typings.yaml.distMod.LineCounter
  
  @JSImport("yaml", "Pair")
  @js.native
  open class Pair[K, V] protected ()
    extends typings.yaml.distMod.Pair[K, V] {
    def this(key: K) = this()
    def this(key: K, value: V) = this()
  }
  
  @JSImport("yaml", "Parser")
  @js.native
  /**
  ...
  @JSImport("yaml", "YAMLMap")
  @js.native
  open class YAMLMap[K, V] ()
    extends typings.yaml.distMod.YAMLMap[K, V] {
  ...
  @JSImport("yaml", "YAMLOMap")
  @js.native
  open class YAMLOMap ()
    extends typings.yaml.distMod.YAMLOMap
  /* static members */
  object YAMLOMap {
  ...
  @JSImport("yaml", "YAMLSet")
  @js.native
  open class YAMLSet[T] ()
    extends typings.yaml.distMod.YAMLSet[T] {
    def this(schema: typings.yaml.distSchemaSchemaMod.Schema) = this()
  }
  /* static members */
  object YAMLSet {
    ...
    @JSImport("yaml", "YAMLSet.tag")
    @js.native
    def tag: String = js.native
    inline def tag_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("tag")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("yaml", "YAMLWarning")
  @js.native
  open class YAMLWarning protected ()
    extends typings.yaml.distMod.YAMLWarning {
    def this(pos: js.Tuple2[Double, Double], code: ErrorCode, message: String) = this()
  }
  ...
  object visit {
    ...
    @JSImport("yaml", "visit.BREAK")
    @js.native
    def BREAK: js.Symbol = js.native
    inline def BREAK_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BREAK")(x.asInstanceOf[js.Any])
    
    @JSImport("yaml", "visit.REMOVE")
    @js.native
    def REMOVE: js.Symbol = js.native
    inline def REMOVE_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REMOVE")(x.asInstanceOf[js.Any])
    
    @JSImport("yaml", "visit.SKIP")
    @js.native
    def SKIP: js.Symbol = js.native
    inline def SKIP_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SKIP")(x.asInstanceOf[js.Any])
  }
  ...
  object visitAsync {
    ...
    @JSImport("yaml", "visitAsync")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("yaml", "visitAsync.BREAK")
    @js.native
    def BREAK: js.Symbol = js.native
    inline def BREAK_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BREAK")(x.asInstanceOf[js.Any])
    
    @JSImport("yaml", "visitAsync.REMOVE")
    @js.native
    def REMOVE: js.Symbol = js.native
    inline def REMOVE_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("REMOVE")(x.asInstanceOf[js.Any])
    
    @JSImport("yaml", "visitAsync.SKIP")
    @js.native
    def SKIP: js.Symbol = js.native
    inline def SKIP_=(x: js.Symbol): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SKIP")(x.asInstanceOf[js.Any])
  }
