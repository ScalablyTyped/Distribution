...
object nodeMod {
  ...
  @JSImport("yaml/dist/nodes/Node", "NodeBase")
  @js.native
  abstract class NodeBase protected () extends StObject {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.yaml.aliasMod.Alias
    - typings.yaml.scalarMod.Scalar[T]
    - typings.yaml.yamlmapMod.YAMLMap[scala.Any, T]
    - typings.yaml.yamlseqMod.YAMLSeq[T]
  */
  type Node[T] = _Node[T] | (YAMLMap[Any, T])
  
  type NodeType[T] = Node[Any] | (YAMLMap[Any, Any]) | YAMLSeq[Any] | Scalar[T]
  
  /* Rewritten from type alias, can be one of: 
    - typings.yaml.aliasMod.Alias.Parsed
    - typings.yaml.scalarMod.Scalar.Parsed
    - typings.yaml.yamlmapMod.YAMLMap.Parsed[scala.Any, scala.Any | scala.Null]
    - typings.yaml.yamlseqMod.YAMLSeq.Parsed[scala.Any]
  */
  type ParsedNode = _ParsedNode | (Parsed[Any, Any | Null]) | typings.yaml.yamlseqMod.YAMLSeq.Parsed[Any]
