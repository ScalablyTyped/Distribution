...
object nullMod {
  ...
  object nullTag {
    ...
    @JSImport("yaml/dist/schema/common/null", "nullTag")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.createNode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.format")
    @js.native
    ...
    /**
      ...
      * `instanceof`.
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.identify")
    @js.native
    ...
    @JSImport("yaml/dist/schema/common/null", "nullTag.nodeClass")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.stringify")
    @js.native
    ...
    /**
      ...
      * `tag:domain,date:foo`.
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.tag")
    @js.native
    ...
    /**
      ...
      * you do.
      */
    @JSImport("yaml/dist/schema/common/null", "nullTag.test")
    @js.native
