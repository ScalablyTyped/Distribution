...
import typings.yaml.visitMod.visitorFn
...
trait Alias extends StObject {
  ...
  var Alias: js.UndefOr[visitorFn[typings.yaml.aliasMod.Alias]] = js.undefined
  ...
  var Node: js.UndefOr[
    visitorFn[typings.yaml.aliasMod.Alias | Scalar[Any] | (YAMLMap[Any, Any]) | YAMLSeq[Any]]
  ] = js.undefined
  
  var Pair: js.UndefOr[visitorFn[typings.yaml.pairMod.Pair[Any, Any]]] = js.undefined
  
  var Scalar: js.UndefOr[visitorFn[typings.yaml.scalarMod.Scalar[Any]]] = js.undefined
  ...
  extension [Self <: Alias](x: Self) {
    ...
    inline def setAlias(
      value: (/* key */ Double | key | value | Null, typings.yaml.aliasMod.Alias, /* path */ js.Array[
        ...
        ]) => Unit | js.Symbol | Double | typings.yaml.nodeMod.Node[Any] | (Pair[Any, Any])
