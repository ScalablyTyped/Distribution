...
object cstMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.yaml.cstMod.SourceToken
    - typings.yaml.cstMod.ErrorToken
    - typings.yaml.cstMod.Directive
    - typings.yaml.cstMod.Document
    - typings.yaml.cstMod.DocumentEnd
    - typings.yaml.cstMod.FlowScalar
    - typings.yaml.cstMod.BlockScalar
    - typings.yaml.cstMod.BlockMap
    - typings.yaml.cstMod.BlockSequence
    - typings.yaml.cstMod.FlowCollection
  */
  trait Token extends StObject
  object Token {
    
    inline def BlockMap(indent: Double, items: js.Array[Sep | Start], offset: Double): typings.yaml.cstMod.BlockMap = {
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("block-map")
      __obj.asInstanceOf[typings.yaml.cstMod.BlockMap]
    }
    
    inline def BlockScalar(indent: Double, offset: Double, props: js.Array[Token], source: String): typings.yaml.cstMod.BlockScalar = {
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], props = props.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("block-scalar")
      __obj.asInstanceOf[typings.yaml.cstMod.BlockScalar]
    }
    
    inline def BlockSequence(indent: Double, items: js.Array[KeySep], offset: Double): typings.yaml.cstMod.BlockSequence = {
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("block-seq")
      __obj.asInstanceOf[typings.yaml.cstMod.BlockSequence]
    }
    
    inline def Directive(offset: Double, source: String): typings.yaml.cstMod.Directive = {
      val __obj = js.Dynamic.literal(offset = offset.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("directive")
      __obj.asInstanceOf[typings.yaml.cstMod.Directive]
    }
    
    inline def Document(offset: Double, start: js.Array[SourceToken]): typings.yaml.cstMod.Document = {
      val __obj = js.Dynamic.literal(offset = offset.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("document")
      __obj.asInstanceOf[typings.yaml.cstMod.Document]
    }
    
    inline def DocumentEnd(offset: Double, source: String): typings.yaml.cstMod.DocumentEnd = {
      val __obj = js.Dynamic.literal(offset = offset.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("doc-end")
      __obj.asInstanceOf[typings.yaml.cstMod.DocumentEnd]
    }
    
    inline def ErrorToken(message: String, offset: Double, source: String): typings.yaml.cstMod.ErrorToken = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("error")
      __obj.asInstanceOf[typings.yaml.cstMod.ErrorToken]
    }
    ...
    inline def FlowCollection(
      ...
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], indent = indent.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("flow-collection")
      __obj.asInstanceOf[typings.yaml.cstMod.FlowCollection]
    }
    ...
    inline def FlowScalar(
      ...
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.yaml.cstMod.FlowScalar]
    }
    ...
    inline def SourceToken(
      ...
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.yaml.cstMod.SourceToken]
    }
  }
