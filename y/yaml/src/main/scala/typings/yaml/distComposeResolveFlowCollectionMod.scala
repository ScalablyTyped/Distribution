...
object distComposeResolveFlowCollectionMod {
  ...
  inline def resolveFlowCollection(
    ...
    tag: CollectionTag
  ): (Parsed[ParsedNode, ParsedNode | Null]) | typings.yaml.distNodesYamlseqMod.YAMLSeq.Parsed[ParsedNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolveFlowCollection")(param0.asInstanceOf[js.Any], ctx.asInstanceOf[js.Any], fc.asInstanceOf[js.Any], onError.asInstanceOf[js.Any], tag.asInstanceOf[js.Any])).asInstanceOf[(Parsed[ParsedNode, ParsedNode | Null]) | typings.yaml.distNodesYamlseqMod.YAMLSeq.Parsed[ParsedNode]]
}
