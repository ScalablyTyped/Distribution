...
object distParseCstMod {
  ...
  object BlockSequence {
    ...
    inline def apply(indent: Double, items: js.Array[Value], offset: Double): BlockSequence = {
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: BlockSequence] (val x: Self) extends AnyVal {
      ...
      inline def setItems(value: js.Array[Value]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: Value*): Self = StObject.set(x, "items", js.Array(value*))
  ...
  */
  ...
  object Token {
    ...
    inline def BlockSequence(indent: Double, items: js.Array[Value], offset: Double): typings.yaml.distParseCstMod.BlockSequence = {
      val __obj = js.Dynamic.literal(indent = indent.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("block-seq")
