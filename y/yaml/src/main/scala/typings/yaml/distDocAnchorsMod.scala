...
object distDocAnchorsMod {
  ...
  inline def anchorNames(root: Document[Node[Any], Boolean]): Set[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("anchorNames")(root.asInstanceOf[js.Any]).asInstanceOf[Set[String]]
  ...
  inline def createNodeAnchors(doc: Document[Node[Any], Boolean], prefix: String): OnAnchor = (^.asInstanceOf[js.Dynamic].applyDynamic("createNodeAnchors")(doc.asInstanceOf[js.Any], prefix.asInstanceOf[js.Any])).asInstanceOf[OnAnchor]
