...
object timestampMod {
  ...
  @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "floatTime")
  @js.native
  val floatTime: ScalarTag = js.native
  
  @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "intTime")
  @js.native
  val intTime: ScalarTag = js.native
  
  /* Inlined yaml.yaml/dist/schema/types.ScalarTag & {  test :std.RegExp} */
  object timestamp {
    
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.createNode")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.format")
    @js.native
    ...
    /**
      ...
      * `instanceof`.
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.identify")
    @js.native
    ...
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.nodeClass")
    @js.native
    ...
    /**
      ...
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.stringify")
    @js.native
    ...
    /**
      ...
      * `tag:domain,date:foo`.
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.tag")
    @js.native
    ...
    /**
      ...
      * you do.
      */
    @JSImport("yaml/dist/schema/yaml-1.1/timestamp", "timestamp.test")
    @js.native
