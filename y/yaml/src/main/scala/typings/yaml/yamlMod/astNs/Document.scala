...
trait Document extends js.Object {
  ...
  /**
    ...
    */
  var cstNode: js.UndefOr[typings.yaml.yamlMod.cstNs.Document] = js.undefined
  /**
  ...
  /**
    ...
    */
  def parse(cst: typings.yaml.yamlMod.cstNs.Document): this.type
  /**
...
object Document {
  ...
  def apply(
    ...
    parse: typings.yaml.yamlMod.cstNs.Document => Document,
    schema: Schema,
    ...
    cstNode: typings.yaml.yamlMod.cstNs.Document = null,
