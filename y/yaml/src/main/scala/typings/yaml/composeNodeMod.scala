...
object composeNodeMod {
  ...
  inline def composeEmptyNode(
    ...
    pos: Double,
    hasSpaceBeforeCommentAnchorTag: Props,
    onError: ComposeErrorHandler
  ): Parsed = (^.asInstanceOf[js.Dynamic].applyDynamic("composeEmptyNode")(ctx.asInstanceOf[js.Any], offset.asInstanceOf[js.Any], before.asInstanceOf[js.Any], pos.asInstanceOf[js.Any], hasSpaceBeforeCommentAnchorTag.asInstanceOf[js.Any], onError.asInstanceOf[js.Any])).asInstanceOf[Parsed]
  inline def composeEmptyNode(
    ctx: ComposeContext,
    offset: Double,
    before: js.Array[Token],
  ...
  object Props {
    ...
    inline def apply(comment: String, spaceBefore: Boolean): Props = {
      val __obj = js.Dynamic.literal(comment = comment.asInstanceOf[js.Any], spaceBefore = spaceBefore.asInstanceOf[js.Any], anchor = null, tag = null)
