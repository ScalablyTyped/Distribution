...
/* Rewritten from type alias, can be one of: 
  - typings.yaml.mod.cst.Alias
  - typings.yaml.mod.cst.Scalar
  - typings.yaml.mod.cst.Map
  - typings.yaml.mod.cst.Seq
  - typings.yaml.mod.cst.FlowCollection
*/
...
object ContentNode {
  ...
  def FlowCollection(
    ...
    hasProps: Boolean,
    items: js.Array[
      FlowChar | BlankLine | Comment | Alias | Scalar | typings.yaml.mod.cst.FlowCollection
    ],
    jsonLike: Boolean,
    props: js.Array[Range],
