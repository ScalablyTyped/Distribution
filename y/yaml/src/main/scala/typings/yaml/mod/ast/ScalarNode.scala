...
/* Rewritten from type alias, can be one of: 
  - typings.yaml.mod.ast.BlockFolded
  - typings.yaml.mod.ast.BlockLiteral
  - typings.yaml.mod.ast.PlainValue
  - typings.yaml.mod.ast.QuoteDouble
  - typings.yaml.mod.ast.QuoteSingle
*/
