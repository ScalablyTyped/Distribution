...
import typings.yaml.mod.YAMLError
import typings.yaml.mod.YAMLWarning
...
trait Document extends js.Object {
  ...
  /**
    ...
    */
  var cstNode: js.UndefOr[typings.yaml.mod.cst.Document] = js.undefined
  /**
  ...
  /**
    ...
    */
  def parse(cst: typings.yaml.mod.cst.Document): this.type
  /**
...
object Document {
  ...
  def apply(
    ...
    parse: typings.yaml.mod.cst.Document => Document,
    schema: Schema,
    ...
    cstNode: typings.yaml.mod.cst.Document = null,
