...
object distNodesScalarMod {
  ...
  object Scalar {
    ...
    type Type = typings.yaml.distNodesScalarMod.Scalar.BLOCK_FOLDED | typings.yaml.distNodesScalarMod.Scalar.BLOCK_LITERAL | typings.yaml.distNodesScalarMod.Scalar.PLAIN | typings.yaml.distNodesScalarMod.Scalar.QUOTE_DOUBLE | typings.yaml.distNodesScalarMod.Scalar.QUOTE_SINGLE
  }
