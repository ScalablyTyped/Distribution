...
object ^ extends js.Object {
  ...
  val defaultOptions: yamlLib.yamlMod.ParseOptions = js.native
  ...
  def parse(str: java.lang.String, options: yamlLib.yamlMod.ParseOptions): js.Any = js.native
  def parseAllDocuments(str: java.lang.String): js.Array[yamlLib.yamlMod.astNs.Document] = js.native
  def parseAllDocuments(str: java.lang.String, options: yamlLib.yamlMod.ParseOptions): js.Array[yamlLib.yamlMod.astNs.Document] = js.native
  def parseCST(str: java.lang.String): yamlLib.yamlMod.ParsedCST = js.native
  def parseDocument(str: java.lang.String): yamlLib.yamlMod.astNs.Document = js.native
  def parseDocument(str: java.lang.String, options: yamlLib.yamlMod.ParseOptions): yamlLib.yamlMod.astNs.Document = js.native
  def stringify(value: js.Any): java.lang.String = js.native
  def stringify(value: js.Any, options: yamlLib.yamlMod.ParseOptions): java.lang.String = js.native
}
