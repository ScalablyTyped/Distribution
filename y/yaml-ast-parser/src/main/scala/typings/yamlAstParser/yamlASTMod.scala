...
object yamlASTMod {
  ...
  object YAMLAnchorReference {
    ...
    inline def apply(
      endPosition: Double,
      errors: js.Array[typings.yamlAstParser.exceptionMod.^],
      kind: Kind,
      parent: YAMLNode,
  ...
  trait YAMLDocument extends StObject {
    ...
    var errors: js.Array[typings.yamlAstParser.exceptionMod.^]
    
    var startPosition: Double
  }
  object YAMLDocument {
    
    inline def apply(endPosition: Double, errors: js.Array[typings.yamlAstParser.exceptionMod.^], startPosition: Double): YAMLDocument = {
    ...
    extension [Self <: YAMLDocument](x: Self) {
      ...
      inline def setErrors(value: js.Array[typings.yamlAstParser.exceptionMod.^]): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
      
      inline def setErrorsVarargs(value: typings.yamlAstParser.exceptionMod.^ *): Self = StObject.set(x, "errors", js.Array(value*))
