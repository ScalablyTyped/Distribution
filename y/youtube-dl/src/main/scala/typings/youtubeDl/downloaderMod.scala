...
object downloaderMod {
  ...
  @scala.inline
  def apply(binDir: String): js.Promise[String] = ^.asInstanceOf[js.Dynamic].apply(binDir.asInstanceOf[js.Any]).asInstanceOf[js.Promise[String]]
  /**
  ...
  @scala.inline
  def apply(callback: js.Function2[/* err */ Error | String | Null, /* message */ js.UndefOr[String], Unit]): Unit = ^.asInstanceOf[js.Dynamic].apply(callback.asInstanceOf[js.Any]).asInstanceOf[Unit]
