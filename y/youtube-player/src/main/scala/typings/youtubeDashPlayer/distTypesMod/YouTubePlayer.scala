...
import typings.youtubeDashPlayer.Anon_Data
import typings.youtubeDashPlayer.Anon_EndSeconds
import typings.youtubeDashPlayer.Anon_EndSecondsMediaContentUrl
import typings.youtubeDashPlayer.Anon_Index
import typings.youtubeDashPlayer.distConstantsPlayerStatesMod.PlayerStates
import typings.youtubeDashPlayer.distEventNamesMod.EventType
...
trait YouTubePlayer extends js.Object {
  ...
  def cuePlaylist(playlist: Anon_Index): Unit = js.native
  ...
  def cueVideoById(video: Anon_EndSeconds): Unit = js.native
  ...
  def cueVideoByUrl(video: Anon_EndSecondsMediaContentUrl): Unit = js.native
  ...
  def loadPlaylist(playlist: Anon_Index): Unit = js.native
  ...
  def loadVideoById(video: Anon_EndSeconds): Unit = js.native
  ...
  def loadVideoByUrl(video: Anon_EndSecondsMediaContentUrl): Unit = js.native
  def mute(): Unit = js.native
  def nextVideo(): Unit = js.native
  def on(eventType: EventType, listener: js.Function1[/* event */ CustomEvent[_], Unit]): Unit = js.native
  @JSName("on")
  def on_stateChange(eventType: stateChange, listener: js.Function1[/* event */ CustomEvent[_] with Anon_Data, Unit]): Unit = js.native
