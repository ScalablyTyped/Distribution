...
trait Anon3000 extends js.Object {
...
object Anon3000 {
  @scala.inline
  def apply(acceptableStates: js.Tuple3[ENDED, PLAYING, PAUSED], stateChangeRequired: `true`, timeout: `3000`): Anon3000 = {
