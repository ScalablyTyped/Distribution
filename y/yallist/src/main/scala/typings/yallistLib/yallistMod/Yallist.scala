...
trait Yallist[T]
  ...
  var head: yallistLib.yallistMod.YallistNs.Node[T] | scala.Null = js.native
  var length: scala.Double = js.native
  var tail: yallistLib.yallistMod.YallistNs.Node[T] | scala.Null = js.native
  def forEach[U](
  ...
  def pushNode(node: yallistLib.yallistMod.YallistNs.Node[T]): scala.Unit = js.native
  ...
  def removeNode(node: yallistLib.yallistMod.YallistNs.Node[T]): scala.Unit = js.native
  ...
  def unshiftNode(node: yallistLib.yallistMod.YallistNs.Node[T]): scala.Unit = js.native
}
