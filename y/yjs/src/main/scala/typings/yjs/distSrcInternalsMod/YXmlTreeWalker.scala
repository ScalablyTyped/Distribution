...
open class YXmlTreeWalker protected ()
  ...
  def this(root: typings.yjs.distSrcTypesYxmlelementMod.YXmlElement[StringDictionary[String]]) = this()
  /**
  ...
  def this(
    root: typings.yjs.distSrcTypesYxmlelementMod.YXmlElement[StringDictionary[String]],
