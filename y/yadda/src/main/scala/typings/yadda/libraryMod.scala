...
object libraryMod {
  ...
  trait Library
    ...
    def define(signatures: js.Array[js.RegExp | String], fn: Unit, macro_context: Unit, options: Options): this.type = js.native
    def define(signatures: js.Array[js.RegExp | String], fn: Unit, macro_context: typings.yadda.contextMod.^): this.type = js.native
    def define(
      signatures: js.Array[js.RegExp | String],
      fn: Unit,
      macro_context: typings.yadda.contextMod.^,
    ...
    def define(signatures: js.RegExp, fn: Unit, macro_context: Unit, options: Options): this.type = js.native
    def define(signatures: js.RegExp, fn: Unit, macro_context: typings.yadda.contextMod.^): this.type = js.native
    def define(signatures: js.RegExp, fn: Unit, macro_context: typings.yadda.contextMod.^, options: Options): this.type = js.native
  }
}
