...
object polishMod extends Shortcut {
  
  @JSImport("yadda/lib/localisation/Polish", JSImport.Namespace)
  @js.native
  ...
  /* This means you don't have to write `^`, but can instead just say `polishMod.foo` */
