...
@js.native
object yeomanDashAssertModMembers extends js.Object {
  ...
  /**
       ...
       */
  def file(path: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file exists or that each files in the array exists
       * @param path path to a file or an array of paths to files
       * @example
       ...
       * assert.noFile(['templates/user.hbs', 'templates/user/edit.hbs']);
       */
  def file(path: js.Array[java.lang.String]): scala.Unit = js.native
  /**
       ...
       * assert.fileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def fileContent(file: java.lang.String, reg: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file's content matches a regex or string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.fileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def fileContent(file: java.lang.String, reg: stdLib.RegExp): scala.Unit = js.native
  /**
       * Assert that a file's content matches a regex or string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.fileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def fileContent(file: js.Array[java.lang.String], reg: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file's content matches a regex or string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.fileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def fileContent(file: js.Array[java.lang.String], reg: stdLib.RegExp): scala.Unit = js.native
  /**
  ...
  /**
       ...
       */
  def implement(subject: js.Object, methods: js.Array[java.lang.String]): scala.Unit = js.native
  /**
       * Assert an Object implements an interface
       * @param subject subject implementing the façade
       * @param methods a façace, hash or array of keys to be implemented
       */
  def implement(subject: js.Object, methods: js.Object): scala.Unit = js.native
  /**
       * @see JSONFileContent
       */
  def jsonFileContent(filename: java.lang.String, content: js.Object): scala.Unit = js.native
  /**
       ...
       * assert.noFile(['templates/user.hbs', 'templates/user/edit.hbs']);
       */
  def noFile(file: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file doesn't exist
       * @param file path to a file
       * @example
       ...
       * assert.noFile(['templates/user.hbs', 'templates/user/edit.hbs']);
       */
  def noFile(file: js.Array[java.lang.String]): scala.Unit = js.native
  /**
       ...
       * assert.noFileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def noFileContent(file: java.lang.String, reg: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file's content does not match a regex / string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.noFileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def noFileContent(file: java.lang.String, reg: stdLib.RegExp): scala.Unit = js.native
  /**
       * Assert that a file's content does not match a regex / string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.noFileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def noFileContent(file: js.Array[java.lang.String], reg: java.lang.String): scala.Unit = js.native
  /**
       * Assert that a file's content does not match a regex / string
       * @param file path to a file
       * @param reg regex / string that will be used to search the file
       ...
       * assert.noFileContent('models/user.js', 'App.User = DS.Model.extend');
       */
  def noFileContent(file: js.Array[java.lang.String], reg: stdLib.RegExp): scala.Unit = js.native
  /**
  ...
  /**
       ...
       * @param methods hash or array of method names to be implemented
       */
  def notImplement(subject: js.Object, methods: js.Object): scala.Unit = js.native
