...
object utilMod {
  ...
  inline def log[TCategories /* <: String | Double | js.Symbol */](options: LoggerOptions[TCategories]): Logger[TCategories] = ^.asInstanceOf[js.Dynamic].applyDynamic("log")(options.asInstanceOf[js.Any]).asInstanceOf[Logger[TCategories]]
}
