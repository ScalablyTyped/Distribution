...
import typings.yeomanDashGenerator.Anon_Adapter
import typings.yeomanDashGenerator.Anon_Git
import typings.yeomanDashGenerator.Anon_Link
...
trait Generator extends EventEmitter {
  ...
  def composeWith(namespace: String, options: StringDictionary[js.Any], settings: Anon_Link): this.type = js.native
