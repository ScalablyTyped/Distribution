...
object Options {
  ...
  inline def OptionsWithQuery(query: String): typings.ytSearch.mod.OptionsWithQuery = {
    val __obj = js.Dynamic.literal(query = query.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ytSearch.mod.OptionsWithQuery]
  }
  
  inline def OptionsWithSearch(search: String): typings.ytSearch.mod.OptionsWithSearch = {
