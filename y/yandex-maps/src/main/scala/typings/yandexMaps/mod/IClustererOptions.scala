...
object IClustererOptions {
  ...
  extension [Self <: IClustererOptions](x: Self) {
    ...
    inline def setMargin(value: (js.Array[js.Array[Double] | Double]) | Double): Self = StObject.set(x, "margin", value.asInstanceOf[js.Any])
    ...
    inline def setMaxZoomVarargs(value: Double*): Self = StObject.set(x, "maxZoom", js.Array(value :_*))
    ...
    inline def setViewportMargin(value: (js.Array[js.Array[Double] | Double]) | Double): Self = StObject.set(x, "viewportMargin", value.asInstanceOf[js.Any])
    
    inline def setViewportMarginUndefined: Self = StObject.set(x, "viewportMargin", js.undefined)
    
    inline def setViewportMarginVarargs(value: (js.Array[Double] | Double)*): Self = StObject.set(x, "viewportMargin", js.Array(value :_*))
