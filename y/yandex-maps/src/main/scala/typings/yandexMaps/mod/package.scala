...
@scala.inline
def ready(successCallback: js.Function0[js.Any | typings.yandexMaps.mod.IReadyobject]): js.Promise[scala.Unit] = typings.yandexMaps.mod.^.asInstanceOf[js.Dynamic].applyDynamic("ready")(successCallback.asInstanceOf[js.Any]).asInstanceOf[js.Promise[scala.Unit]]
@scala.inline
def ready(
...
@scala.inline
def ready(successCallback: scala.Unit, errorCallback: js.Function0[js.Any]): js.Promise[scala.Unit] = (typings.yandexMaps.mod.^.asInstanceOf[js.Dynamic].applyDynamic("ready")(successCallback.asInstanceOf[js.Any], errorCallback.asInstanceOf[js.Any])).asInstanceOf[js.Promise[scala.Unit]]
@scala.inline
...
@scala.inline
def ready(successCallback: scala.Unit, errorCallback: scala.Unit, context: js.Object): js.Promise[scala.Unit] = (typings.yandexMaps.mod.^.asInstanceOf[js.Dynamic].applyDynamic("ready")(successCallback.asInstanceOf[js.Any], errorCallback.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[js.Promise[scala.Unit]]
