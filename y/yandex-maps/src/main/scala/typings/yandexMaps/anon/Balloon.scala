...
trait Balloon extends StObject {
  ...
  @JSName("autoPan")
  var autoPan_Original: js.Function0[js.Promise[typings.yandexMaps.mod.map.Balloon]] = js.native
  ...
  @JSName("close")
  var close_Original: js.Function1[/* force */ js.UndefOr[Boolean], js.Promise[typings.yandexMaps.mod.map.Balloon]] = js.native
  ...
  var setData_Original: js.Function1[
    ...
    js.Promise[typings.yandexMaps.mod.map.Balloon]
  ] = js.native
  
  def setOptions(options: js.Object): js.Promise[typings.yandexMaps.mod.objectManager.Balloon] = js.native
  @JSName("setOptions")
  var setOptions_Original: js.Function1[/* options */ js.Object, js.Promise[typings.yandexMaps.mod.map.Balloon]] = js.native
  
  def setPosition(position: js.Array[Double]): js.Promise[typings.yandexMaps.mod.objectManager.Balloon] = js.native
  @JSName("setPosition")
  var setPosition_Original: js.Function1[/* position */ js.Array[Double], js.Promise[typings.yandexMaps.mod.map.Balloon]] = js.native
}
