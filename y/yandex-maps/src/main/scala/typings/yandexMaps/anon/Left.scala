...
object Left {
  ...
  implicit class LeftOps[Self <: Left] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBottom(value: Double | String | auto): Self = this.set("bottom", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteBottom: Self = this.set("bottom", js.undefined)
    
    @scala.inline
    def setLeft(value: Double | String | auto): Self = this.set("left", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteLeft: Self = this.set("left", js.undefined)
    
    @scala.inline
    def setRight(value: Double | String | auto): Self = this.set("right", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteRight: Self = this.set("right", js.undefined)
    
    @scala.inline
    def setTop(value: Double | String | auto): Self = this.set("top", value.asInstanceOf[js.Any])
