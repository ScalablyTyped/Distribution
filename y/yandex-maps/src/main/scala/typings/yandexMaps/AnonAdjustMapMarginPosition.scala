...
trait AnonAdjustMapMarginPosition extends js.Object {
...
object AnonAdjustMapMarginPosition {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAdjustMapMarginPosition]
  }
}
