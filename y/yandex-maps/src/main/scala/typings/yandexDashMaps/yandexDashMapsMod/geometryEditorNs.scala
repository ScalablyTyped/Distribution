...
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.ChildLineString
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.ChildLinearRing
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.ChildVertex
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.Edge
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.RootLineString
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.modelNs.RootPolygon
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.viewNs.MultiPath
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.viewNs.Path
import typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.viewNs.Vertex
...
object geometryEditorNs extends js.Object {
  ...
  object viewNs extends js.Object {
    ...
    class Path () extends js.Object {
      def getEdgePlacemarks(): GeoObjectCollection = js.native
      def getEdgeViews(): js.Array[typings.yandexDashMaps.yandexDashMapsMod.geometryEditorNs.viewNs.Edge] = js.native
      def getVertexPlacemarks(): GeoObjectCollection = js.native
