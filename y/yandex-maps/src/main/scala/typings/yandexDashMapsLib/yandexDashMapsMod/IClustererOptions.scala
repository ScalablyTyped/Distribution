...
trait IClustererOptions extends js.Object {
  ...
  var margin: js.UndefOr[(js.Array[js.Array[scala.Double] | scala.Double]) | scala.Double] = js.undefined
  ...
  var viewportMargin: js.UndefOr[(js.Array[js.Array[scala.Double] | scala.Double]) | scala.Double] = js.undefined
...
object IClustererOptions {
  ...
  def apply(
    ...
    margin: (js.Array[js.Array[scala.Double] | scala.Double]) | scala.Double = null,
    ...
    viewportMargin: (js.Array[js.Array[scala.Double] | scala.Double]) | scala.Double = null,
