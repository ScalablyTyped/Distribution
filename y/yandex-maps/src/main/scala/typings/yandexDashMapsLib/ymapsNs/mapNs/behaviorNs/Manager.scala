...
class Manager protected ()
  ...
  def this(map: yandexDashMapsLib.ymapsNs.Map, behaviors: js.Array[js.Array[java.lang.String] | java.lang.String]) = this()
  def this(map: yandexDashMapsLib.ymapsNs.Map, behaviors: js.Array[js.Array[java.lang.String] | java.lang.String], options: js.Object) = this()
  /* CompleteClass */
