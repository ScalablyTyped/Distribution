...
class Map protected () extends IDomEventEmitter {
  ...
  def getPanoramaManager(): stdLib.Promise[yandexDashMapsLib.ymapsNs.panoramaNs.Manager] = js.native
  def getType(): java.lang.String | MapType = js.native
  def getZoom(): scala.Double = js.native
  def panTo(center: js.Array[scala.Double | js.Object]): stdLib.Promise[scala.Unit] = js.native
  def panTo(center: js.Array[scala.Double | js.Object], options: IMapPanOptions): stdLib.Promise[scala.Unit] = js.native
  def setBounds(bounds: js.Array[js.Array[scala.Double]]): stdLib.Promise[scala.Unit] = js.native
  def setBounds(bounds: js.Array[js.Array[scala.Double]], options: IMapBoundsOptions): stdLib.Promise[scala.Unit] = js.native
  def setCenter(center: js.Array[scala.Double]): stdLib.Promise[scala.Unit] = js.native
  def setCenter(center: js.Array[scala.Double], zoom: scala.Double): stdLib.Promise[scala.Unit] = js.native
  def setCenter(center: js.Array[scala.Double], zoom: scala.Double, options: IMapPositionOptions): stdLib.Promise[scala.Unit] = js.native
  def setGlobalPixelCenter(globalPixelCenter: js.Array[scala.Double]): stdLib.Promise[scala.Unit] = js.native
  def setGlobalPixelCenter(globalPixelCenter: js.Array[scala.Double], zoom: scala.Double): stdLib.Promise[scala.Unit] = js.native
  def setGlobalPixelCenter(globalPixelCenter: js.Array[scala.Double], zoom: scala.Double, options: IMapPositionOptions): stdLib.Promise[scala.Unit] = js.native
  def setType(`type`: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def setType(`type`: java.lang.String, options: IMapCheckZoomRangeOptions): stdLib.Promise[scala.Unit] = js.native
  def setType(`type`: MapType): stdLib.Promise[scala.Unit] = js.native
  def setType(`type`: MapType, options: IMapCheckZoomRangeOptions): stdLib.Promise[scala.Unit] = js.native
  def setZoom(zoom: scala.Double): stdLib.Promise[scala.Unit] = js.native
  def setZoom(zoom: scala.Double, options: IMapZoomOptions): stdLib.Promise[scala.Unit] = js.native
}
