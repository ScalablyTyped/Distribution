...
object srcFuzzySetsRightSCurveFuzzySetMod {
  
  @JSImport("yuka/src/fuzzy/sets/RightSCurveFuzzySet", "RightSCurveFuzzySet")
  @js.native
  /**
    ...
    */
  open class RightSCurveFuzzySet () extends FuzzySet {
