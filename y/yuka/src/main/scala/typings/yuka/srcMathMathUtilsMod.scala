...
object srcMathMathUtilsMod {
  
  @JSImport("yuka/src/math/MathUtils", "MathUtils")
  @js.native
  ...
  object MathUtils {
    ...
    /**
      ...
      */
    inline def area(a: Vector3, b: Vector3, c: Vector3): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("area")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[Double]
