...
object srcSteeringBehaviorsAlignmentBehaviorMod {
  
  @JSImport("yuka/src/steering/behaviors/AlignmentBehavior", "AlignmentBehavior")
  @js.native
  /**
    * Constructs a new alignment behavior.
    */
  open class AlignmentBehavior () extends SteeringBehavior {
