...
class ZipFile () extends js.Object {
  ...
  def addReadStream(input: Readable, metadataPath: String): Unit = js.native
  def addReadStream(input: Readable, metadataPath: String, options: Partial[ReadStreamOptions]): Unit = js.native
  def dateToDosDateTime(jsDate: Date): DosDateTime = js.native
  def end(): Unit = js.native
  def end(optoins: EndOptions): Unit = js.native
  def end(optoins: EndOptions, finalSizeCallback: js.Function0[Unit]): Unit = js.native
}
