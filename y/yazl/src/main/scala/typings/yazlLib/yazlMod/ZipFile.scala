...
class ZipFile () extends js.Object {
  ...
  def addBuffer(buffer: nodeLib.bufferMod.Buffer, metadataPath: java.lang.String): scala.Unit = js.native
  def addBuffer(buffer: nodeLib.bufferMod.Buffer, metadataPath: java.lang.String, options: stdLib.Partial[Options]): scala.Unit = js.native
