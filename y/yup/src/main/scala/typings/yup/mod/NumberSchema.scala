...
@js.native
trait NumberSchema[T /* <: js.UndefOr[Double | Null] */, C]
  extends StObject
     with Schema[T, C] {
  
  def defined(): NumberSchema[Exclude[T, Unit], C] = js.native
  
  def equals[U /* <: T */](arrayOfValues: js.Array[U | Ref_]): NumberSchema[MaintainOptionality[T, U], C] = js.native
  def equals[U /* <: T */](arrayOfValues: js.Array[U | Ref_], message: js.UndefOr[TestOptionsMessage[Values, js.Any]]): NumberSchema[MaintainOptionality[T, U], C] = js.native
  
  def integer(): NumberSchema[T, C] = js.native
  def integer(message: js.UndefOr[TestOptionsMessage[js.Object, js.Any]]): NumberSchema[T, C] = js.native
  
  def lessThan(limit: Double): NumberSchema[T, C] = js.native
  def lessThan(limit: Double, message: js.UndefOr[TestOptionsMessage[Less, js.Any]]): NumberSchema[T, C] = js.native
  def lessThan(limit: Ref_): NumberSchema[T, C] = js.native
  def lessThan(limit: Ref_, message: js.UndefOr[TestOptionsMessage[Less, js.Any]]): NumberSchema[T, C] = js.native
  
  def max(limit: Double): NumberSchema[T, C] = js.native
  def max(limit: Double, message: js.UndefOr[TestOptionsMessage[Max, js.Any]]): NumberSchema[T, C] = js.native
  def max(limit: Ref_): NumberSchema[T, C] = js.native
  def max(limit: Ref_, message: js.UndefOr[TestOptionsMessage[Max, js.Any]]): NumberSchema[T, C] = js.native
  
  def min(limit: Double): NumberSchema[T, C] = js.native
  def min(limit: Double, message: js.UndefOr[TestOptionsMessage[Min, js.Any]]): NumberSchema[T, C] = js.native
  def min(limit: Ref_): NumberSchema[T, C] = js.native
  def min(limit: Ref_, message: js.UndefOr[TestOptionsMessage[Min, js.Any]]): NumberSchema[T, C] = js.native
  
  def moreThan(limit: Double): NumberSchema[T, C] = js.native
  def moreThan(limit: Double, message: js.UndefOr[TestOptionsMessage[More, js.Any]]): NumberSchema[T, C] = js.native
  def moreThan(limit: Ref_): NumberSchema[T, C] = js.native
  def moreThan(limit: Ref_, message: js.UndefOr[TestOptionsMessage[More, js.Any]]): NumberSchema[T, C] = js.native
  
  def negative(): NumberSchema[T, C] = js.native
  def negative(message: js.UndefOr[TestOptionsMessage[Less, js.Any]]): NumberSchema[T, C] = js.native
  ...
  def oneOf[U /* <: T */](arrayOfValues: js.Array[U | Ref_], message: js.UndefOr[TestOptionsMessage[Values, js.Any]]): NumberSchema[MaintainOptionality[T, U], C] = js.native
  
  def optional(): NumberSchema[js.UndefOr[T], C] = js.native
  
  def positive(): NumberSchema[T, C] = js.native
  def positive(message: js.UndefOr[TestOptionsMessage[More, js.Any]]): NumberSchema[T, C] = js.native
  
  def required(): NumberSchema[Exclude[T, js.UndefOr[Null]], C] = js.native
  def required(message: TestOptionsMessage[js.Object, js.Any]): NumberSchema[Exclude[T, js.UndefOr[Null]], C] = js.native
  ...
  def test[U /* <: T */](options: AssertingTestOptions[U, Record[String, js.Any], C]): NumberSchema[U, C] = js.native
  @JSName("test")
  def test_U_T_NumberSchema[U /* <: T */](name: String, message: TestOptionsMessage[js.Object, js.Any], test: AssertingTestFunction[U, C]): NumberSchema[U, C] = js.native
