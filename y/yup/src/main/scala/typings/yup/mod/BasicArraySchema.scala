...
@js.native
trait BasicArraySchema[E, T /* <: js.UndefOr[js.Array[E] | Null] */, C]
  extends StObject
     with Schema[T, C] {
  ...
  def equals(arrayOfValues: js.Array[T | Ref_ | Null], message: js.UndefOr[TestOptionsMessage[Values, js.Any]]): this.type = js.native
  
  var innerType: Schema[E, C] = js.native
  
  def max(limit: Double): this.type = js.native
  def max(limit: Double, message: js.UndefOr[TestOptionsMessage[Max, js.Any]]): this.type = js.native
  def max(limit: Ref_): this.type = js.native
  def max(limit: Ref_, message: js.UndefOr[TestOptionsMessage[Max, js.Any]]): this.type = js.native
  
  def min(limit: Double): this.type = js.native
  def min(limit: Double, message: js.UndefOr[TestOptionsMessage[Min, js.Any]]): this.type = js.native
  def min(limit: Ref_): this.type = js.native
  def min(limit: Ref_, message: js.UndefOr[TestOptionsMessage[Min, js.Any]]): this.type = js.native
  ...
  def oneOf(arrayOfValues: js.Array[T | Ref_ | Null], message: js.UndefOr[TestOptionsMessage[Values, js.Any]]): this.type = js.native
