...
object Is {
  ...
  inline def apply(otherwise: js.Any, `then`: js.Any): Is = {
  ...
  extension [Self <: Is](x: Self) {
    ...
    inline def setIs(value: WhenOptionsBuilderObjectIs): Self = StObject.set(x, "is", value.asInstanceOf[js.Any])
    
    inline def setIsFunction1(value: /* repeated */ js.Any => Boolean): Self = StObject.set(x, "is", js.Any.fromFunction1(value))
    
    inline def setIsNull: Self = StObject.set(x, "is", null)
    
    inline def setOtherwise(value: js.Any): Self = StObject.set(x, "otherwise", value.asInstanceOf[js.Any])
