...
object ^ extends js.Object {
  ...
  def isSchema(obj: js.Any): /* is yup.yup.Schema<any> */ Boolean = js.native
  def `lazy`[T](fn: js.Function1[/* value */ T, Schema[T]]): Lazy = js.native
  def reach[T](schema: Schema[T], path: String): Schema[T] = js.native
  def reach[T](schema: Schema[T], path: String, value: js.Any): Schema[T] = js.native
  def reach[T](schema: Schema[T], path: String, value: js.Any, context: js.Any): Schema[T] = js.native
  def ref(path: String): Ref = js.native
  def ref(path: String, options: Anon_ContextPrefix): Ref = js.native
  def setLocale(customLocale: LocaleObject): Unit = js.native
}
