...
trait NumberSchema[T /* <: js.UndefOr[Double | Null] */] extends Schema[T] {
  ...
  def lessThan(limit: Double, message: TestOptionsMessage): NumberSchema[T] = js.native
  ...
  def max(limit: Double, message: TestOptionsMessage): NumberSchema[T] = js.native
  ...
  def min(limit: Double, message: TestOptionsMessage): NumberSchema[T] = js.native
  ...
  def moreThan(limit: Double, message: TestOptionsMessage): NumberSchema[T] = js.native
  ...
  def required(message: TestOptionsMessage): NumberSchema[Exclude[T, js.UndefOr[scala.Nothing]]] = js.native
  @JSName("round")
