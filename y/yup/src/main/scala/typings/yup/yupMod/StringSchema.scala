...
trait StringSchema[T /* <: js.UndefOr[String | Null] */] extends Schema[T] {
  ...
  def length(limit: Double, message: TestOptionsMessage): StringSchema[T] = js.native
  ...
  def matches(regex: RegExp, messageOrOptions: TestOptionsMessage): StringSchema[T] = js.native
  def max(limit: Double): StringSchema[T] = js.native
  def max(limit: Double, message: TestOptionsMessage): StringSchema[T] = js.native
  ...
  def min(limit: Double, message: TestOptionsMessage): StringSchema[T] = js.native
  ...
  def required(message: TestOptionsMessage): StringSchema[Exclude[T, js.UndefOr[scala.Nothing]]] = js.native
