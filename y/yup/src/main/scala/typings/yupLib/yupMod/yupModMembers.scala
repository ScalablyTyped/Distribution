...
@js.native
object yupModMembers extends js.Object {
  ...
  def ValidationError(errors: java.lang.String, value: js.Any, path: java.lang.String): ValidationError = js.native
  def ValidationError(errors: java.lang.String, value: js.Any, path: java.lang.String, `type`: js.Any): ValidationError = js.native
  def ValidationError(errors: js.Array[java.lang.String], value: js.Any, path: java.lang.String): ValidationError = js.native
  def ValidationError(errors: js.Array[java.lang.String], value: js.Any, path: java.lang.String, `type`: js.Any): ValidationError = js.native
