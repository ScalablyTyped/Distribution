...
trait NumberSchema
  ...
  def integer(message: java.lang.String): NumberSchema = js.native
  def lessThan(limit: scala.Double): NumberSchema = js.native
  def lessThan(limit: scala.Double, message: java.lang.String): NumberSchema = js.native
  def lessThan(limit: Ref): NumberSchema = js.native
  def lessThan(limit: Ref, message: java.lang.String): NumberSchema = js.native
  def max(limit: scala.Double): NumberSchema = js.native
  def max(limit: scala.Double, message: java.lang.String): NumberSchema = js.native
  def max(limit: Ref): NumberSchema = js.native
  def max(limit: Ref, message: java.lang.String): NumberSchema = js.native
  def min(limit: scala.Double): NumberSchema = js.native
  def min(limit: scala.Double, message: java.lang.String): NumberSchema = js.native
  def min(limit: Ref): NumberSchema = js.native
  def min(limit: Ref, message: java.lang.String): NumberSchema = js.native
  def moreThan(limit: scala.Double): NumberSchema = js.native
  def moreThan(limit: scala.Double, message: java.lang.String): NumberSchema = js.native
  def moreThan(limit: Ref): NumberSchema = js.native
  def moreThan(limit: Ref, message: java.lang.String): NumberSchema = js.native
  def negative(): NumberSchema = js.native
  def negative(message: java.lang.String): NumberSchema = js.native
  def positive(): NumberSchema = js.native
  def positive(message: java.lang.String): NumberSchema = js.native
  @JSName("round")
