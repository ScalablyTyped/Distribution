...
object asmMod {
  ...
  @JSImport("yoga-wasm-web/asm", "EXPERIMENTAL_FEATURE_FIX_ABSOLUTE_TRAILING_COLUMN_MARGIN")
  @js.native
  ...
  @JSImport("yoga-wasm-web/asm", "EXPERIMENTAL_FEATURE_WEB_FLEX_BASIS")
  @js.native
