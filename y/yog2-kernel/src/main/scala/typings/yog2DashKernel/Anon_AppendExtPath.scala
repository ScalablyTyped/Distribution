...
@js.native
trait Anon_AppendExtPath extends js.Object {
  var NormalizerManager: Instantiable0[typings.nodeDashRal.nodeDashRalMod.RALNs.NormalizerManager] = js.native
  var RalRunner: Instantiable1[/* serviceName */ String, typings.nodeDashRal.nodeDashRalMod.RALNs.RalRunner] = js.native
