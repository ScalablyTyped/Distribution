...
object ActionObject {
  ...
  def apply(
    ...
    get: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    head: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    link: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    lock: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    options: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    patch: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    post: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    propfind: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    purge: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    put: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    unlick: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    unlock: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null,
    view: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any = null
  ): ActionObject = {
