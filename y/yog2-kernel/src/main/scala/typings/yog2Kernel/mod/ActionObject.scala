...
object ActionObject {
  ...
  implicit class ActionObjectOps[Self <: ActionObject] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCopy(
      value: (/* req */ typings.expressServeStaticCore.mod.Request[ParamsDictionary, _, _, Query], /* res */ typings.expressServeStaticCore.mod.Response[_], /* next */ NextFunction) => js.Any
