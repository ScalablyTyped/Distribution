...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-903739"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-c25936",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-145d73",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-ff7651",
  "org.scalablytyped" %%% "std" % "3.3.1-6e0314",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-8fff98",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-478475")
