...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-26b424"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-91034f",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-565137",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-3f05df",
  "org.scalablytyped" %%% "std" % "3.4-495f93",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-abee81",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-b232bb")
