...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-ca3b94"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-7ddf93",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-db4fa8",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-c08138",
  "org.scalablytyped" %%% "std" % "3.6-c16502",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20190819Z-def4dd",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-64afc6")
