...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-7d0889"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-c4316f",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-c44ea2",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-3a858a",
  "org.scalablytyped" %%% "std" % "3.6-b80e7a",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20190819Z-32561c",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-6c21cd")
