...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-b4c5b9"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-1b6e73",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-13d69c",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-3abc85",
  "org.scalablytyped" %%% "std" % "3.2.2-f3cc98",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-4b4acb",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-f5a3fc")
