...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-386f2c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-834ea6",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-623d43",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-dd9008",
  "org.scalablytyped" %%% "std" % "3.4-d52857",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-cd3f1a",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-a0766e")
