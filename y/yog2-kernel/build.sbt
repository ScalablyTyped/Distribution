...
name := "yog2-kernel"
version := "1.9-dt-20190214Z-a0c672"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-312517",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-aeafd9",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-96e810",
  "org.scalablytyped" %%% "std" % "3.3-05be79",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-1822d8",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-c77eae")
