...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-22cc08"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-a0a215",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-6ebcbf",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-1c7f66",
  "org.scalablytyped" %%% "std" % "3.7-1c17cf",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20190819Z-0b43dd",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-8f845c")
