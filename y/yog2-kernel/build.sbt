...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-707cf4"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-e1f726",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-d16283",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-604ebf",
  "org.scalablytyped" %%% "std" % "3.3-14e863",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-a6860f",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-967315")
