...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-ab31a5"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-8b6c8e",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-623d43",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-201a01",
  "org.scalablytyped" %%% "std" % "3.4-d52857",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-ef8473",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-1ebb7b")
