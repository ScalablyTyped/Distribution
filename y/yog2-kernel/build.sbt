...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-760702"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-61cf89",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-ef877c",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-f8f5d7",
  "org.scalablytyped" %%% "std" % "3.2.2-669a73",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-a15852",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-47dfcd")
