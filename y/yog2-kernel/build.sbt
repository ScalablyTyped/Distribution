...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-d9e368"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-e4a838",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-5082d0",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-b44a76",
  "org.scalablytyped" %%% "std" % "3.3-ec2942",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-d76512",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-a04140")
