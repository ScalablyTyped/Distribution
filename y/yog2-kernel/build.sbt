...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-00a6a3"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-9ca2ca",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-acf35f",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-94d189",
  "org.scalablytyped" %%% "std" % "3.4-8a92b2",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-3378c2",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-81d694")
