...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-05c905"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-c1a2d8",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-223eff",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-010b16",
  "org.scalablytyped" %%% "std" % "3.5-65dbfc",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-8b5123",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-21d7c5")
