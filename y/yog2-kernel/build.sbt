...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-9981c6"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-23eb37",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-1e193b",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-9be8ed",
  "org.scalablytyped" %%% "std" % "3.3-6e4388",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-262b5d",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-827bdf")
