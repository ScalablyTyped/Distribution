...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-d12fe5"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-d7309f",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-6ebcbf",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-cc63ce",
  "org.scalablytyped" %%% "std" % "3.7-1c17cf",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20190819Z-ff5e04",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-789202")
