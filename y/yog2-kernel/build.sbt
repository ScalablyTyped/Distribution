...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-329cea"
scalaVersion := "2.12.9"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-813fcb",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-db4fa8",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190819Z-4181d6",
  "org.scalablytyped" %%% "std" % "3.6-c16502",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20190819Z-f70da5",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-aa7064")
