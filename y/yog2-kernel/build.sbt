...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-20aa11"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-50a196",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-d115b2",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-91019c",
  "org.scalablytyped" %%% "std" % "3.2.2-2926f1",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-2a8915",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-a1c0e8")
