...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-d7b97d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-1ee613",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-374f35",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-20ad05",
  "org.scalablytyped" %%% "std" % "3.5-f010ac",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-564cd2",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-f714b4")
