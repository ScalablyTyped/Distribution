...
name := "yog2-kernel"
version := "1.9-dt-20181121Z-15d7f2"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-8bf9d3",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-a57469",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20180428Z-c3aa54",
  "org.scalablytyped" %%% "std" % "3.2.4-2926f1",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-f3be12",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-86eef3")
