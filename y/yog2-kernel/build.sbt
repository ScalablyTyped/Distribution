...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-27e7fd"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-33eb46",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-c3b9c7",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-4dbd53",
  "org.scalablytyped" %%% "std" % "3.4-6f75bc",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-8d26ca",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-d27c80")
