...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-7c316c"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-930320",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-f16918",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-496baf",
  "org.scalablytyped" %%% "std" % "3.5-983486",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-23c4a5",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-8596df")
