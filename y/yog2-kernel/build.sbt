...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-8751dc"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-1cfade",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-f16918",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-5d9695",
  "org.scalablytyped" %%% "std" % "3.5-983486",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-8f9e1c",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-b67b48")
