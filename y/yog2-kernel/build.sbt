...
name := "yog2-kernel"
version := "1.9-dt-20190312Z-e57d31"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "node-ral" % "0.18-dt-20181121Z-71cde0",
  "org.scalablytyped" %%% "range-parser" % "1.2-dt-20181016Z-39a594",
  "org.scalablytyped" %%% "serve-static" % "1.13-dt-20190322Z-c829e9",
  "org.scalablytyped" %%% "std" % "3.5-c5d119",
  "org.scalablytyped" %%% "yog-bigpipe" % "0.4-dt-20180214Z-c5ab8c",
  "org.scalablytyped" %%% "yog-log" % "0.1-dt-20181121Z-2182fa")
