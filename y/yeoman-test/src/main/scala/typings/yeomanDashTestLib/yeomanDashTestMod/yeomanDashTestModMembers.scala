...
@js.native
object yeomanDashTestModMembers extends js.Object {
  ...
  def mockPrompt(generator: yeomanDashGeneratorLib.yeomanDashGeneratorMod.namespaced, answers: Dictionary[_]): scala.Unit = js.native
  def registerDependencies(env: js.Any, dependencies: js.Array[Dependency]): scala.Unit = js.native
