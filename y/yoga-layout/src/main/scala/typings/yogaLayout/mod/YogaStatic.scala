...
object YogaStatic {
  ...
  inline def apply(Config: ConfigStatic, Node: NodeStatic, getInstanceCount: () => Double): YogaStatic = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: YogaStatic] (val x: Self) extends AnyVal {
    
    inline def setConfig(value: ConfigStatic): Self = StObject.set(x, "Config", value.asInstanceOf[js.Any])
    
    inline def setGetInstanceCount(value: () => Double): Self = StObject.set(x, "getInstanceCount", js.Any.fromFunction0(value))
    
    inline def setNode(value: NodeStatic): Self = StObject.set(x, "Node", value.asInstanceOf[js.Any])
  }
}
