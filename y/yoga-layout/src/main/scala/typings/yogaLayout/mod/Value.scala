...
object Value {
  ...
  implicit class ValueOps[Self <: Value] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFromJS(value: js.Function2[/* unit */ YogaUnit | Double, /* value */ Double, _] => Unit): Self = this.set("fromJS", js.Any.fromFunction1(value))
    @scala.inline
    def setUnit(value: YogaUnit | Double): Self = this.set("unit", value.asInstanceOf[js.Any])
    @scala.inline
