...
import typings.amqplib.callbackUnderscoreApiMod.Channel
import typings.amqplib.callbackUnderscoreApiMod.ConfirmChannel
import typings.amqplib.callbackUnderscoreApiMod.Connection
