...
object publicApiMod {
  ...
  open class IconDirective protected ()
    extends typings.antDesignIconsAngular.componentIconDotdirectiveMod.IconDirective {
    def this(
  ...
  open class IconModule ()
    extends typings.antDesignIconsAngular.componentIconDotmoduleMod.IconModule
  /* static members */
  object IconModule {
  ...
  open class IconService protected ()
    extends typings.antDesignIconsAngular.componentIconDotserviceMod.IconService {
    def this(
