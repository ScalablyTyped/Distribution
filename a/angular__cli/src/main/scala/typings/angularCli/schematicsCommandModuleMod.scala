...
object schematicsCommandModuleMod {
  ...
  @JSImport("@angular/cli/src/command-builder/schematics-command-module", "SchematicsCommandModule")
  @js.native
  abstract class SchematicsCommandModule protected () extends CommandModule[SchematicsCommandArgs] {
