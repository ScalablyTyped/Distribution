...
trait AngularDirectiveOptionsSchema extends StObject {
...
object AngularDirectiveOptionsSchema {
  
  inline def apply(name: String, project: String): AngularDirectiveOptionsSchema = {
