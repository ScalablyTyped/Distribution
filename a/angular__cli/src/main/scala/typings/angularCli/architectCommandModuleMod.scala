...
object architectCommandModuleMod {
  
  @JSImport("@angular/cli/src/command-builder/architect-command-module", "ArchitectCommandModule")
  @js.native
  abstract class ArchitectCommandModule protected () extends ArchitectBaseCommandModule[ArchitectCommandArgs] {
