...
import typings.angularCli.packageManagerMod.PackageManagerUtils
...
object commandModuleMod {
  
  @JSImport("@angular/cli/src/command-builder/command-module", "CommandModule")
  @js.native
  abstract class CommandModule[T /* <: js.Object */] protected ()
    extends StObject
  ...
  object CommandScope extends StObject {
    ...
    sealed trait Both
      extends StObject
         with CommandScope
    /* 2 */ val Both: typings.angularCli.commandModuleMod.CommandScope.Both & Double = js.native
    ...
    sealed trait In
      extends StObject
         with CommandScope
    /* 0 */ val In: typings.angularCli.commandModuleMod.CommandScope.In & Double = js.native
    ...
    sealed trait Out
      extends StObject
         with CommandScope
    /* 1 */ val Out: typings.angularCli.commandModuleMod.CommandScope.Out & Double = js.native
  }
  ...
  type Options[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof T as yargs.yargs.CamelCaseKey<key> ]: T[key]}
    */ typings.angularCli.angularCliStrings.Options & TopLevel[T]
