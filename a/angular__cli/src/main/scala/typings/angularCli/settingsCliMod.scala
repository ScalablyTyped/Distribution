...
object settingsCliMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.angularCli.commandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsDisableModule")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.angularCli.commandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsEnableModule")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.angularCli.commandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsPromptModule")
  @js.native
