package typings.awsSdkClientKmsNode.typesDisableKeyRotationInputMod
...
object DisableKeyRotationInput {
  ...
  @scala.inline
  implicit class DisableKeyRotationInputOps[Self <: DisableKeyRotationInput] (val x: Self) extends AnyVal {
