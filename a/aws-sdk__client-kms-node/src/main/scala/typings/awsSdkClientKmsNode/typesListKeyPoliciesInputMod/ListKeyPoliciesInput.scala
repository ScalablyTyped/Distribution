package typings.awsSdkClientKmsNode.typesListKeyPoliciesInputMod
...
@js.native
trait ListKeyPoliciesInput extends InputTypesUnion {
  /**
...
object ListKeyPoliciesInput {
  ...
  @scala.inline
  implicit class ListKeyPoliciesInputOps[Self <: ListKeyPoliciesInput] (val x: Self) extends AnyVal {
    @scala.inline
