package typings.awsSdkClientKmsNode.typesImportKeyMaterialInputMod
...
object ImportKeyMaterialInput {
  ...
  implicit class ImportKeyMaterialInputOps[Self <: ImportKeyMaterialInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncryptedKeyMaterial(value: ArrayBuffer | ArrayBufferView | String): Self = this.set("EncryptedKeyMaterial", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setImportToken(value: ArrayBuffer | ArrayBufferView | String): Self = this.set("ImportToken", value.asInstanceOf[js.Any])
