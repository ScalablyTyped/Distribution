package typings.awsSdkClientKmsNode.typesEncryptInputMod
...
trait EncryptInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var Plaintext: ArrayBuffer | ArrayBufferView | String = js.native
}
object EncryptInput {
  ...
  implicit class EncryptInputOps[Self <: EncryptInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPlaintext(value: ArrayBuffer | ArrayBufferView | String): Self = this.set("Plaintext", value.asInstanceOf[js.Any])
