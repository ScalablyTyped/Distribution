package typings.awsSdkClientKmsNode.typesReEncryptInputMod
...
object ReEncryptInput {
  ...
  implicit class ReEncryptInputOps[Self <: ReEncryptInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCiphertextBlob(value: ArrayBuffer | ArrayBufferView | String): Self = this.set("CiphertextBlob", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setDestinationEncryptionContext(value: StringDictionary[String] | (Iterable[js.Tuple2[String, String]])): Self = this.set("DestinationEncryptionContext", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSourceEncryptionContext(value: StringDictionary[String] | (Iterable[js.Tuple2[String, String]])): Self = this.set("SourceEncryptionContext", value.asInstanceOf[js.Any])
