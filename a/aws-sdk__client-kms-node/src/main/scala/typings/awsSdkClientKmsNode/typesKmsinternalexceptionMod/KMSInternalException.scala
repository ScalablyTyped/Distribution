...
trait KMSInternalException
  ...
  var name: typings.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInternalException = js.native
}
object KMSInternalException {
  
  @scala.inline
  def apply(name: typings.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInternalException): KMSInternalException = {
  ...
  implicit class KMSInternalExceptionOps[Self <: KMSInternalException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.KMSInternalException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
