package typings.awsSdkClientKmsNode.typesDescribeKeyInputMod
...
@js.native
trait DescribeKeyInput extends InputTypesUnion {
...
object DescribeKeyInput {
  ...
  @scala.inline
  implicit class DescribeKeyInputOps[Self <: DescribeKeyInput] (val x: Self) extends AnyVal {
