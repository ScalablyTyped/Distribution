...
import typings.atAwsDashSdkClientDashKmsDashNode.typesUpdateAliasInputMod.UpdateAliasInput
import typings.atAwsDashSdkClientDashKmsDashNode.typesUpdateAliasOutputMod.UpdateAliasOutput
