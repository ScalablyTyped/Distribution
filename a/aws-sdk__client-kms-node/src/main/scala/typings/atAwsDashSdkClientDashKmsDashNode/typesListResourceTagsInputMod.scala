...
@JSImport("@aws-sdk/client-kms-node/types/ListResourceTagsInput", JSImport.Namespace)
@js.native
object typesListResourceTagsInputMod extends js.Object {
  @js.native
  trait ListResourceTagsInput extends InputTypesUnion {
    /**
