...
import typings.atAwsDashSdkClientDashKmsDashNode.atAwsDashSdkClientDashKmsDashNodeStrings.AES_128
import typings.atAwsDashSdkClientDashKmsDashNode.atAwsDashSdkClientDashKmsDashNodeStrings.AES_256
...
@JSImport("@aws-sdk/client-kms-node/types/GenerateDataKeyWithoutPlaintextInput", JSImport.Namespace)
@js.native
