...
@JSImport("@aws-sdk/client-kms-node/types/EnableKeyRotationInput", JSImport.Namespace)
@js.native
object typesEnableKeyRotationInputMod extends js.Object {
  @js.native
  trait EnableKeyRotationInput extends InputTypesUnion {
    /**
