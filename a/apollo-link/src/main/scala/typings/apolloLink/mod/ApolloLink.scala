...
@js.native
class ApolloLink ()
  extends typings.apolloLink.linkMod.ApolloLink {
...
object ApolloLink extends js.Object {
  ...
  var execute_Original: js.Function2[
    ...
    typings.zenObservableTs.zenObservableMod.Observable[FetchResult[StringDictionary[_], Record[String, _], Record[String, _]]]
  ] = js.native
  @JSName("from")
  ...
  def execute(link: this.type, operation: GraphQLRequest): typings.zenObservableTs.zenObservableMod.Observable[FetchResult[StringDictionary[_], Record[String, _], Record[String, _]]] = js.native
