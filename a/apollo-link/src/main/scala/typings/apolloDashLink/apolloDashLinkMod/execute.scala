...
object execute extends js.Object {
  def apply(link: typings.apolloDashLink.libLinkMod.ApolloLink, operation: GraphQLRequest): Observable[FetchResult[StringDictionary[_], Record[String, _], Record[String, _]]] = js.native
}
