...
trait DirectiveDefinition[T] extends StObject {
...
object DirectiveDefinition {
  ...
  inline def apply[T](`type`: Type[T]): DirectiveDefinition[T] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[DirectiveDefinition[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DirectiveDefinition[?], T] (val x: Self & DirectiveDefinition[T]) extends AnyVal {
