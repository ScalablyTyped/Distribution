...
@js.native
class ɵangularPackagesCoreCoreE protected () extends js.Object {
...
@JSImport("@angular/core", "\u0275angular_packages_core_core_e")
@js.native
object ɵangularPackagesCoreCoreE extends js.Object {
  def fromKey(key: ReflectiveKey): ɵangularPackagesCoreCoreE = js.native
}
