...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.angularCore.mod.ɵangularPackagesCoreCoreBf
...
object TNodeWithLocalRefs {
  ...
  def ɵangularPackagesCoreCoreBf(
    ...
    `type`: TNodeType,
    attrs: TAttributes = null,
    child: typings.angularCore.mod.ɵangularPackagesCoreCoreBf | TTextNode | TElementContainerNode | TContainerNode | TProjectionNode = null,
    classes: StylingMapArray | TStylingContext = null,
    initialInputs: InitialInputData = null,
    inputs: PropertyAliases = null,
    localNames: js.Array[String | Double] = null,
    next: TNode = null,
    outputs: PropertyAliases = null,
    parent: typings.angularCore.mod.ɵangularPackagesCoreCoreBf | TElementContainerNode = null,
  ...
  def TElementContainerNode(
    ...
    `type`: TNodeType,
    attrs: TAttributes = null,
    child: ɵangularPackagesCoreCoreBf | TTextNode | TContainerNode | typings.angularCore.mod.TElementContainerNode | TProjectionNode = null,
    classes: StylingMapArray | TStylingContext = null,
    initialInputs: InitialInputData = null,
    inputs: PropertyAliases = null,
    localNames: js.Array[String | Double] = null,
    next: TNode = null,
    outputs: PropertyAliases = null,
    parent: ɵangularPackagesCoreCoreBf | typings.angularCore.mod.TElementContainerNode = null,
    projectionNext: TNode = null,
    styles: StylingMapArray | TStylingContext = null,
    tagName: String = null
  ): TNodeWithLocalRefs = {
