...
@scala.inline
def forwardRef(forwardRefFn: typings.angularCore.mod.ForwardRefFn): typings.angularCore.mod.Type[js.Any] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("forwardRef")(forwardRefFn.asInstanceOf[js.Any]).asInstanceOf[typings.angularCore.mod.Type[js.Any]]
...
@scala.inline
def getModuleFactory(id: java.lang.String): typings.angularCore.mod.NgModuleFactory[js.Any] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("getModuleFactory")(id.asInstanceOf[js.Any]).asInstanceOf[typings.angularCore.mod.NgModuleFactory[js.Any]]
...
@scala.inline
def ɵLifecycleHooksFeature(component: js.Any, `def`: typings.angularCore.mod.ɵComponentDef[js.Any]): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275LifecycleHooksFeature")(component.asInstanceOf[js.Any], `def`.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵangularPackagesCoreCoreBo(name: java.lang.String, props: js.Function1[/* repeated */ js.Any, js.Any]): js.Any = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_bo")(name.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
...
@scala.inline
def ɵangularPackagesCoreCoreBo(name: java.lang.String, props: scala.Unit, parentClass: js.Any): js.Any = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_bo")(name.asInstanceOf[js.Any], props.asInstanceOf[js.Any], parentClass.asInstanceOf[js.Any])).asInstanceOf[js.Any]
...
@scala.inline
def ɵangularPackagesCoreCoreBp(name: java.lang.String, props: js.Function1[/* repeated */ js.Any, js.Any]): js.Any = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_bp")(name.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
...
@scala.inline
def ɵangularPackagesCoreCoreBp(name: java.lang.String, props: scala.Unit, parentClass: js.Any): js.Any = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_bp")(name.asInstanceOf[js.Any], props.asInstanceOf[js.Any], parentClass.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def ɵangularPackagesCoreCoreBp(
  name: java.lang.String,
  props: scala.Unit,
...
@scala.inline
def ɵangularPackagesCoreCoreH(): typings.angularCore.mod.ElementRef[js.Any] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_h")().asInstanceOf[typings.angularCore.mod.ElementRef[js.Any]]
...
@scala.inline
def ɵangularPackagesCoreCoreJ(id: java.lang.String): typings.angularCore.mod.NgModuleFactory[js.Any] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_core_core_j")(id.asInstanceOf[js.Any]).asInstanceOf[typings.angularCore.mod.NgModuleFactory[js.Any]]
...
@scala.inline
def ɵcompileComponent(`type`: typings.angularCore.mod.Type[js.Any], metadata: typings.angularCore.mod.Component): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compileComponent")(`type`.asInstanceOf[js.Any], metadata.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

@scala.inline
def ɵcompileDirective(`type`: typings.angularCore.mod.Type[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compileDirective")(`type`.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def ɵcompileDirective(`type`: typings.angularCore.mod.Type[js.Any], directive: typings.angularCore.mod.Directive): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compileDirective")(`type`.asInstanceOf[js.Any], directive.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

@scala.inline
def ɵcompileNgModule(moduleType: typings.angularCore.mod.Type[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compileNgModule")(moduleType.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def ɵcompileNgModule(moduleType: typings.angularCore.mod.Type[js.Any], ngModule: typings.angularCore.mod.NgModule): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compileNgModule")(moduleType.asInstanceOf[js.Any], ngModule.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵcompilePipe(`type`: typings.angularCore.mod.Type[js.Any], meta: typings.angularCore.mod.Pipe): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275compilePipe")(`type`.asInstanceOf[js.Any], meta.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵgetModuleFactoryPOSTR3(id: java.lang.String): typings.angularCore.mod.NgModuleFactory[js.Any] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275getModuleFactory__POST_R3__")(id.asInstanceOf[js.Any]).asInstanceOf[typings.angularCore.mod.NgModuleFactory[js.Any]]
...
@scala.inline
def ɵisObservable(obj: typings.rxjs.mod.Observable_[js.Any]): /* is rxjs.rxjs.Observable<any> */ scala.Boolean = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275isObservable")(obj.asInstanceOf[js.Any]).asInstanceOf[/* is rxjs.rxjs.Observable<any> */ scala.Boolean]
...
@scala.inline
def ɵmakeDecorator[T](name: java.lang.String, props: js.Function1[/* repeated */ js.Any, js.Any]): typings.angularCore.anon.Call = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275makeDecorator")(name.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[typings.angularCore.anon.Call]
@scala.inline
...
@scala.inline
def ɵregisterLocaleData(data: js.Any, localeId: scala.Unit, extraData: js.Any): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275registerLocaleData")(data.asInstanceOf[js.Any], localeId.asInstanceOf[js.Any], extraData.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

@scala.inline
def ɵregisterModuleFactory(id: java.lang.String, factory: typings.angularCore.mod.NgModuleFactory[js.Any]): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275registerModuleFactory")(id.asInstanceOf[js.Any], factory.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]

@scala.inline
def ɵregisterNgModuleType(ngModuleType: typings.angularCore.mod.ɵNgModuleType[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275registerNgModuleType")(ngModuleType.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵsetClassMetadata(`type`: typings.angularCore.mod.Type[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275setClassMetadata")(`type`.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def ɵsetClassMetadata(`type`: typings.angularCore.mod.Type[js.Any], decorators: js.Array[js.Any]): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275setClassMetadata")(`type`.asInstanceOf[js.Any], decorators.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
...
@scala.inline
def ɵɵCopyDefinitionFeature(definition: typings.angularCore.mod.ɵComponentDef[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275CopyDefinitionFeature")(definition.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵCopyDefinitionFeature(definition: typings.angularCore.mod.ɵDirectiveDef[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275CopyDefinitionFeature")(definition.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]

@scala.inline
def ɵɵInheritDefinitionFeature(definition: typings.angularCore.mod.ɵComponentDef[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275InheritDefinitionFeature")(definition.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵInheritDefinitionFeature(definition: typings.angularCore.mod.ɵDirectiveDef[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275InheritDefinitionFeature")(definition.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
/* import warning: importer.ImportType#apply Failed type conversion: typeof ɵɵattribute */ js.Any]]
@scala.inline
def ɵɵattribute(name: java.lang.String, value: js.Any, sanitizer: scala.Unit, namespace: java.lang.String): js.Function4[
/* name */ java.lang.String, 
/* value */ js.Any, 
/* sanitizer */ js.UndefOr[typings.angularCore.mod.SanitizerFn | scala.Null], 
/* namespace */ js.UndefOr[java.lang.String], 
...
@scala.inline
def ɵɵattributeInterpolateV(attrName: java.lang.String, values: js.Array[js.Any]): js.Function4[
/* attrName */ java.lang.String, 
...
@scala.inline
def ɵɵclassMapInterpolateV(values: js.Array[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275classMapInterpolateV")(values.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵɵelementContainer(index: scala.Double, attrsIndex: scala.Unit, localRefsIndex: scala.Double): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275elementContainer")(index.asInstanceOf[js.Any], attrsIndex.asInstanceOf[js.Any], localRefsIndex.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵɵgetFactoryOf[T](`type`: typings.angularCore.mod.Type[js.Any]): typings.angularCore.mod.FactoryFn[T] | scala.Null = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275getFactoryOf")(`type`.asInstanceOf[js.Any]).asInstanceOf[typings.angularCore.mod.FactoryFn[T] | scala.Null]

@scala.inline
def ɵɵgetInheritedFactory[T](`type`: typings.angularCore.mod.Type[js.Any]): js.Function1[/* type */ typings.angularCore.mod.Type[T], T] = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275getInheritedFactory")(`type`.asInstanceOf[js.Any]).asInstanceOf[js.Function1[/* type */ typings.angularCore.mod.Type[T], T]]
...
@scala.inline
def ɵɵlistener(eventName: java.lang.String, listenerFn: js.Function1[/* e */ js.UndefOr[js.Any], js.Any]): js.Function4[
...
@scala.inline
def ɵɵpropertyInterpolateV(propName: java.lang.String, values: js.Array[js.Any]): js.Function3[
/* propName */ java.lang.String, 
/* values */ js.Array[js.Any], 
/* sanitizer */ js.UndefOr[typings.angularCore.mod.SanitizerFn], 
...
@scala.inline
def ɵɵpureFunction1(slotOffset: scala.Double, pureFn: js.Function1[/* v */ js.Any, js.Any], exp: js.Any): js.Any = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275pureFunction1")(slotOffset.asInstanceOf[js.Any], pureFn.asInstanceOf[js.Any], exp.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def ɵɵpureFunction1(
  slotOffset: scala.Double,
  pureFn: js.Function1[/* v */ js.Any, js.Any],
...
@scala.inline
def ɵɵqueryRefresh(queryList: typings.angularCore.mod.QueryList[js.Any]): scala.Boolean = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275queryRefresh")(queryList.asInstanceOf[js.Any]).asInstanceOf[scala.Boolean]
...
@scala.inline
def ɵɵstaticViewQuery[T](predicate: typings.angularCore.mod.InjectionToken[js.Any], descend: scala.Boolean): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275staticViewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
...
@scala.inline
def ɵɵstaticViewQuery[T](predicate: typings.angularCore.mod.Type[js.Any], descend: scala.Boolean): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275staticViewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵstaticViewQuery[T](predicate: typings.angularCore.mod.Type[js.Any], descend: scala.Boolean, read: js.Any): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275staticViewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any], read.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def ɵɵstyleMapInterpolateV(values: js.Array[js.Any]): scala.Unit = typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275styleMapInterpolateV")(values.asInstanceOf[js.Any]).asInstanceOf[scala.Unit]
...
/* import warning: importer.ImportType#apply Failed type conversion: typeof ɵɵstyleProp */ js.Any]]
@scala.inline
def ɵɵstyleProp(prop: java.lang.String, value: scala.Unit, suffix: java.lang.String): js.Function3[
/* prop */ java.lang.String, 
/* value */ js.UndefOr[
  java.lang.String | scala.Double | typings.angularCore.mod.ɵSafeValue | scala.Null
], 
...
@scala.inline
def ɵɵstylePropInterpolateV(prop: java.lang.String, values: js.Array[js.Any]): js.Function3[
/* prop */ java.lang.String, 
/* values */ js.Array[js.Any], 
/* valueSuffix */ js.UndefOr[java.lang.String | scala.Null], 
...
@scala.inline
def ɵɵstylePropInterpolateV(prop: java.lang.String, values: js.Array[js.Any], valueSuffix: java.lang.String): js.Function3[
/* prop */ java.lang.String, 
/* values */ js.Array[js.Any], 
/* valueSuffix */ js.UndefOr[java.lang.String | scala.Null], 
...
@scala.inline
def ɵɵsyntheticHostListener(eventName: java.lang.String, listenerFn: js.Function1[/* e */ js.UndefOr[js.Any], js.Any]): js.Function4[
/* eventName */ java.lang.String, 
/* listenerFn */ js.Function1[/* e */ js.UndefOr[js.Any], js.Any], 
/* useCapture */ js.UndefOr[scala.Boolean], 
/* eventTargetResolver */ js.UndefOr[typings.angularCore.mod.GlobalTargetResolver], 
...
@scala.inline
def ɵɵtextInterpolateV(values: js.Array[js.Any]): js.Function1[
/* values */ js.Array[js.Any], 
...
@scala.inline
def ɵɵviewQuery[T](predicate: typings.angularCore.mod.InjectionToken[js.Any], descend: scala.Boolean): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275viewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵviewQuery[T](predicate: typings.angularCore.mod.InjectionToken[js.Any], descend: scala.Boolean, read: js.Any): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275viewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any], read.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵviewQuery[T](predicate: typings.angularCore.mod.Type[js.Any], descend: scala.Boolean): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275viewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def ɵɵviewQuery[T](predicate: typings.angularCore.mod.Type[js.Any], descend: scala.Boolean, read: js.Any): scala.Unit = (typings.angularCore.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275\u0275viewQuery")(predicate.asInstanceOf[js.Any], descend.asInstanceOf[js.Any], read.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
