...
object MissingTranslationStrategy extends StObject {
  ...
  /* 0 */ val Error: typings.angularCore.mod.MissingTranslationStrategy.Error with Double = js.native
  
  @js.native
  sealed trait Ignore extends MissingTranslationStrategy
  /* 2 */ val Ignore: typings.angularCore.mod.MissingTranslationStrategy.Ignore with Double = js.native
  
  @js.native
  sealed trait Warning extends MissingTranslationStrategy
  /* 1 */ val Warning: typings.angularCore.mod.MissingTranslationStrategy.Warning with Double = js.native
}
