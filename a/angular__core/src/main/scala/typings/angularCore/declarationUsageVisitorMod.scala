...
object declarationUsageVisitorMod {
  ...
  class DeclarationUsageVisitor protected () extends StObject {
    ...
    /**
      ...
      */
    /* private */ var _getDeclarationSymbolOfNode: js.Any = js.native
    
    /** Gets the symbol of the given property access expression. */
    /* private */ var _getPropertyAccessSymbol: js.Any = js.native
    ...
    /**
      ...
      */
    /* private */ var _updateContext: js.Any = js.native
    
    /* private */ var addJumpExpressionToQueue: js.Any = js.native
    
    /* private */ var addNewExpressionToQueue: js.Any = js.native
    
    /**
      * Nodes which need to be checked for declaration usage but aren't
      * guaranteed to execute synchronously.
      */
    /* private */ var ambiguousNodeQueue: js.Any = js.native
    
    /* private */ var baseContext: js.Any = js.native
    ...
    /* private */ var declaration: js.Any = js.native
    
    def getResolvedNodeUsage(searchNode: Node): ResolvedUsage = js.native
    
    /* private */ var isReferringToSymbol: js.Any = js.native
    
    /* private */ var isSynchronouslyUsedInNode: js.Any = js.native
    
    /**
      * Queue of nodes that need to be checked for declaration usage and
      * are guaranteed to be executed synchronously.
      */
    /* private */ var nodeQueue: js.Any = js.native
    ...
    /**
      ...
      * usage is ambiguous.
      */
    /* private */ var peekIntoJumpExpression: js.Any = js.native
    
    /* private */ var typeChecker: js.Any = js.native
    
    /* private */ var visitBinaryExpression: js.Any = js.native
    
    /* private */ var visitPropertyAccessors: js.Any = js.native
    
    /** Set of visited symbols that caused a jump in control flow. */
    /* private */ var visitedJumpExprNodes: js.Any = js.native
  }
