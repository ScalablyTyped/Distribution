...
import typings.angularCore.angularCoreStrings.Anon_ContentQueriesExportAs
...
@js.native
trait AnonContentQueriesExportAs[T] extends js.Object {
  /**
  ...
  {[ P in keyof T ]:? string | [string, string] | undefined}
    */ Anon_ContentQueriesExportAs with js.Any
  ] = js.native
  /**
