...
object _StaticProvider {
  ...
  inline def ConstructorProvider(provide: Type[js.Any]): typings.angularCore.r3SymbolsMod.ConstructorProvider = {
  ...
  inline def ExistingProvider(provide: js.Any, useExisting: js.Any): typings.angularCore.r3SymbolsMod.ExistingProvider = {
  ...
  inline def FactoryProvider(provide: js.Any, useFactory: js.Function): typings.angularCore.r3SymbolsMod.FactoryProvider = {
  ...
  inline def StaticClassProvider(deps: js.Array[js.Any], provide: js.Any, useClass: Type[js.Any]): typings.angularCore.r3SymbolsMod.StaticClassProvider = {
  ...
  inline def ValueProvider(provide: js.Any, useValue: js.Any): typings.angularCore.r3SymbolsMod.ValueProvider = {
