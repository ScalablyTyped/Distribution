...
object NgModuleDef {
  ...
  extension [Self <: NgModuleDef[?], T](x: Self & NgModuleDef[T]) {
    ...
    inline def setTransitiveCompileScopes(value: NgModuleTransitiveScopes): Self = StObject.set(x, "transitiveCompileScopes", value.asInstanceOf[js.Any])
