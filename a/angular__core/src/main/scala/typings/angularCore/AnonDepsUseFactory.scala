...
trait AnonDepsUseFactory extends js.Object {
...
object AnonDepsUseFactory {
  @scala.inline
  def apply(deps: js.Array[_] = null, useFactory: js.Function = null, useValue: js.Any = null): AnonDepsUseFactory = {
    ...
    __obj.asInstanceOf[AnonDepsUseFactory]
  }
}
