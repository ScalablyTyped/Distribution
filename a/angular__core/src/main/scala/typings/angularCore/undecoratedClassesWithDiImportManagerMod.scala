...
@JSImport("@angular/core/schematics/migrations/undecorated-classes-with-di/import_manager", JSImport.Namespace)
@js.native
object undecoratedClassesWithDiImportManagerMod extends js.Object {
  @js.native
  class ImportManager protected () extends js.Object {
    def this(getUpdateRecorder: js.Function1[/* sf */ SourceFile, UpdateRecorder], printer: Printer) = this()
    /**
