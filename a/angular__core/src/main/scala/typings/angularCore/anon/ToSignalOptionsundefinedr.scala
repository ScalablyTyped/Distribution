...
/* Inlined @angular/core.@angular/core/rxjs-interop.ToSignalOptions<undefined> & {  requireSync :false | undefined} */
trait ToSignalOptionsundefinedr extends StObject {
...
object ToSignalOptionsundefinedr {
  
  inline def apply(initialValue: scala.Unit): ToSignalOptionsundefinedr = {
    val __obj = js.Dynamic.literal(initialValue = initialValue.asInstanceOf[js.Any])
    __obj.asInstanceOf[ToSignalOptionsundefinedr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ToSignalOptionsundefinedr] (val x: Self) extends AnyVal {
