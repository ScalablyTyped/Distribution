...
import typings.angularCore.angularCoreStrings.`@angularSlashplatform-browser`
...
@js.native
object PLATFORM_BROWSER_IMPORT extends TopLevel[`@angularSlashplatform-browser`]
