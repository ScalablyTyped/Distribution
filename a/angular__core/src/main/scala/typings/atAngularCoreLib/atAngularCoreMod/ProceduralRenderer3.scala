...
trait ProceduralRenderer3 extends Renderer3 {
  ...
  def removeChild(parent: RElement, oldChild: RNode, isHostElement: scala.Boolean): scala.Unit = js.native
  ...
  def removeStyle(el: RElement, style: java.lang.String, flags: RendererStyleFlags2): scala.Unit = js.native
  ...
  def setStyle(el: RElement, style: java.lang.String, value: js.Any, flags: RendererStyleFlags2): scala.Unit = js.native
