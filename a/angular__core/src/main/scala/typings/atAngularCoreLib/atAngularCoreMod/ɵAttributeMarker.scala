...
@js.native
sealed trait ɵAttributeMarker extends js.Object
...
object ɵAttributeMarker extends js.Object {
  ...
  sealed trait Bindings
    extends atAngularCoreLib.atAngularCoreMod.ɵAttributeMarker
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[atAngularCoreLib.atAngularCoreMod.ɵAttributeMarker with scala.Double] = js.native
}
