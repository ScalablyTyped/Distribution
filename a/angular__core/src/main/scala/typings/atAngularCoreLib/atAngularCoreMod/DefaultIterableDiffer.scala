...
class DefaultIterableDiffer[V] ()
  ...
  def check(collection: NgIterable[V]): scala.Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def diff(`object`: NgIterable[V]): IterableChanges[V] | scala.Null = js.native
  /** Iterate over all added items. */
  /* CompleteClass */
  override def forEachAddedItem(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
  /** Iterate over all items which had their identity (as computed by the `TrackByFunction`)
    * changed. */
  /* CompleteClass */
  override def forEachIdentityChange(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
  /**
    * Iterate over all changes. `IterableChangeRecord` will contain information about changes
    * to each item.
    */
  /* CompleteClass */
  override def forEachItem(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
  /** Iterate over all moved items. */
  /* CompleteClass */
  override def forEachMovedItem(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def forEachPreviousItem(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
  /** Iterate over all removed items. */
  /* CompleteClass */
  override def forEachRemovedItem(fn: js.Function1[/* record */ IterableChangeRecord[V], scala.Unit]): scala.Unit = js.native
