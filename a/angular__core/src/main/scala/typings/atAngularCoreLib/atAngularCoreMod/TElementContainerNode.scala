...
trait TElementContainerNode
  ...
  @JSName("child")
  var child_TElementContainerNode: ɵangular_packages_core_core_bg | TTextNode | TContainerNode | TElementContainerNode | TProjectionNode | scala.Null
  @JSName("parent")
  var parent_TElementContainerNode: ɵangular_packages_core_core_bg | TElementContainerNode | scala.Null
  @JSName("projection")
