...
abstract class Renderer () extends js.Object {
  ...
  def createElement(parentElement: js.Any, name: java.lang.String, debugInfo: ɵRenderDebugInfo): js.Any = js.native
  ...
  def createText(parentElement: js.Any, value: java.lang.String, debugInfo: ɵRenderDebugInfo): js.Any = js.native
  ...
  def selectRootElement(selectorOrNode: java.lang.String, debugInfo: ɵRenderDebugInfo): js.Any = js.native
