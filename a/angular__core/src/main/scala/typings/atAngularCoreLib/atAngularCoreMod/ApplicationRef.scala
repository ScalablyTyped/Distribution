...
class ApplicationRef () extends js.Object {
  ...
  /**
    ...
    */
  def attachView(viewRef: ViewRef): scala.Unit = js.native
  /**
  ...
  def bootstrap[C](componentOrFactory: ComponentFactory[C], rootSelectorOrNode: java.lang.String): ComponentRef[C] = js.native
  ...
  def bootstrap[C](componentOrFactory: Type[C], rootSelectorOrNode: java.lang.String): ComponentRef[C] = js.native
  def bootstrap[C](componentOrFactory: Type[C], rootSelectorOrNode: js.Any): ComponentRef[C] = js.native
  /**
    * Detaches a view from dirty checking again.
    */
  def detachView(viewRef: ViewRef): scala.Unit = js.native
  /**
