...
object srcRender3JitModuleMod extends js.Object {
  def compileNgModule(moduleType: atAngularCoreLib.srcTypeMod.Type[_]): scala.Unit = js.native
  def compileNgModule(
  ...
  def flushModuleScopingQueueAsMuchAsPossible(): scala.Unit = js.native
  ...
  def resetCompiledComponents(): scala.Unit = js.native
