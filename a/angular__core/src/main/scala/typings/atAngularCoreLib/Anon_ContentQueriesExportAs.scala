...
trait Anon_ContentQueriesExportAs[T] extends js.Object {
  ...
  /**
    ...
    */
  var features: js.UndefOr[js.Array[atAngularCoreLib.atAngularCoreMod.DirectiveDefFeature]] = js.native
  /**
  ...
  {[ P in keyof T ]:? string | [string, string] | undefined}
    */ atAngularCoreLib.atAngularCoreLibStrings.Anon_ContentQueriesExportAs with js.Any
  ] = js.native
  /**
  ...
  var selectors: js.Array[js.Array[java.lang.String | atAngularCoreLib.atAngularCoreMod.SelectorFlags]] = js.native
  /**
