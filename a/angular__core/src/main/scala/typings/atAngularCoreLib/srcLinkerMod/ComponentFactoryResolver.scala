package typings
package atAngularCoreLib.srcLinkerMod
...
object ComponentFactoryResolver extends js.Object {
  var NULL: atAngularCoreLib.srcLinkerComponentUnderscoreFactoryUnderscoreResolverMod.ComponentFactoryResolver = js.native
}
