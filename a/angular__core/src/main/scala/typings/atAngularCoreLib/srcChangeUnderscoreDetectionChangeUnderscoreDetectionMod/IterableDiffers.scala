...
@JSImport("@angular/core/src/change_detection/change_detection", "IterableDiffers")
@js.native
class IterableDiffers protected ()
  extends atAngularCoreLib.srcChangeUnderscoreDetectionDiffersIterableUnderscoreDiffersMod.IterableDiffers {
