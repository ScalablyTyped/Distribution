...
class NgZone protected () extends js.Object {
  ...
  /**
    ...
    */
  val onError: atAngularCoreLib.srcEventUnderscoreEmitterMod.EventEmitter[_] = js.native
  /**
    * Notifies when there is no more microtasks enqueued in the current VM Turn.
    * This is a hint for Angular to do change detection, which may enqueue more microtasks.
    * For this reason this event can fire multiple times per VM Turn.
    */
  val onMicrotaskEmpty: atAngularCoreLib.srcEventUnderscoreEmitterMod.EventEmitter[_] = js.native
  /**
    * Notifies when the last `onMicrotaskEmpty` has run and there are no more microtasks, which
    * implies we are about to relinquish VM turn.
    * This event gets called just once.
    */
  val onStable: atAngularCoreLib.srcEventUnderscoreEmitterMod.EventEmitter[_] = js.native
  /**
    * Notifies when code enters Angular Zone. This gets fired first on VM Turn.
    */
  val onUnstable: atAngularCoreLib.srcEventUnderscoreEmitterMod.EventEmitter[_] = js.native
  /**
