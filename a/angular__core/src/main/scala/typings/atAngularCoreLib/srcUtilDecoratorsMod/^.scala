...
object ^ extends js.Object {
  ...
  def makeDecorator[T](name: java.lang.String): atAngularCoreLib.Anon_ArgsCls = js.native
  def makeDecorator[T](name: java.lang.String, props: js.Function1[/* repeated */ js.Any, _]): atAngularCoreLib.Anon_ArgsCls = js.native
  def makeDecorator[T](name: java.lang.String, props: js.Function1[/* repeated */ js.Any, _], parentClass: js.Any): atAngularCoreLib.Anon_ArgsCls = js.native
  def makeDecorator[T](
