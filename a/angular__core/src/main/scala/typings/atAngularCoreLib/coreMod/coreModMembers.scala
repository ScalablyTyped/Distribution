...
object coreModMembers extends js.Object {
  ...
  val APP_INITIALIZER: atAngularCoreLib.srcDiMod.InjectionToken[js.Array[js.Function0[scala.Unit]]] = js.native
  ...
  val LOCALE_ID: atAngularCoreLib.srcDiInjectionUnderscoreTokenMod.InjectionToken[java.lang.String] = js.native
  ...
  val TRANSLATIONS: atAngularCoreLib.srcDiInjectionUnderscoreTokenMod.InjectionToken[java.lang.String] = js.native
  val TRANSLATIONS_FORMAT: atAngularCoreLib.srcDiInjectionUnderscoreTokenMod.InjectionToken[java.lang.String] = js.native
  ...
  val ɵNO_CHANGE: atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  val `ɵR3_CHANGE_DETECTOR_REF_FACTORY__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchRuntimeLegacyMod.FactoryFunction[js.Any] = js.native
  val `ɵR3_COMPILE_COMPONENT__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchCompilerLegacyMod.DirectiveCompiler = js.native
  val `ɵR3_COMPILE_DIRECTIVE__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchCompilerLegacyMod.DirectiveCompiler = js.native
  val `ɵR3_COMPILE_INJECTABLE__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchCompilerLegacyMod.DirectiveCompiler = js.native
  val `ɵR3_COMPILE_NGMODULE__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchCompilerLegacyMod.DirectiveCompiler = js.native
  val `ɵR3_COMPILE_PIPE__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchCompilerLegacyMod.DirectiveCompiler = js.native
  val `ɵR3_ELEMENT_REF_FACTORY__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchRuntimeLegacyMod.FactoryFunction[js.Any] = js.native
  val `ɵR3_RENDERER2_FACTORY__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchRuntimeLegacyMod.FactoryFunction[js.Any] = js.native
  val `ɵR3_TEMPLATE_REF_FACTORY__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchRuntimeLegacyMod.FactoryFunction[js.Any] = js.native
  val `ɵR3_VIEW_CONTAINER_REF_FACTORY__POST_NGCC__`: atAngularCoreLib.srcIvyUnderscoreSwitchRuntimeLegacyMod.FactoryFunction[js.Any] = js.native
  ...
  val ɵangular_packages_core_core_bb: java.lang.String = js.native
  val ɵangular_packages_core_core_l: js.Array[atAngularCoreLib.srcDiProviderMod.StaticProvider] = js.native
  val ɵangular_packages_core_core_m: scala.Boolean = js.native
  val ɵcompileComponent: js.Function2[
    /* type */ atAngularCoreLib.srcTypeMod.Type[js.Any], 
    /* metadata */ atAngularCoreLib.srcMetadataDirectivesMod.Component, 
    scala.Unit
  ] = js.native
  val ɵcompileDirective: js.Function2[
    /* type */ atAngularCoreLib.srcTypeMod.Type[js.Any], 
    /* directive */ atAngularCoreLib.srcMetadataDirectivesMod.Directive, 
    scala.Unit
  ] = js.native
  val ɵcompileNgModuleDefs: js.Function2[
    /* moduleType */ atAngularCoreLib.srcTypeMod.Type[js.Any], 
    /* ngModule */ atAngularCoreLib.srcMetadataNgUnderscoreModuleMod.NgModule, 
    scala.Unit
  ] = js.native
  val ɵcompilePipe: js.Function2[
    /* type */ atAngularCoreLib.srcTypeMod.Type[js.Any], 
  ...
  val `ɵivyEnable__POST_NGCC__`: scala.Boolean = js.native
  val ɵivyEnabled: /* false */ scala.Boolean = js.native
  val ɵpatchComponentDefWithScope: js.Function2[
    /* componentDef */ atAngularCoreLib.srcRender3InterfacesDefinitionMod.ComponentDef[js.Any], 
  ...
  def ɵNgOnChangesFeature[T](definition: atAngularCoreLib.srcRender3InterfacesDefinitionMod.DirectiveDef[T]): scala.Unit = js.native
  def ɵPublicFeature[T](definition: atAngularCoreLib.srcRender3InterfacesDefinitionMod.DirectiveDef[T]): scala.Unit = js.native
  ...
  def ɵand(
    ...
    ngContentIndex: scala.Double,
    childCount: scala.Double,
    handleEvent: atAngularCoreLib.srcViewTypesMod.ElementHandleEventFn
  ): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵand(
    flags: atAngularCoreLib.srcViewTypesMod.NodeFlags,
    matchedQueriesDsl: js.Array[
  ...
  def ɵangular_packages_core_core_a(name: java.lang.String): js.Any = js.native
  def ɵangular_packages_core_core_a(name: java.lang.String, props: js.Function1[/* repeated */js.Any, _]): js.Any = js.native
  def ɵangular_packages_core_core_a(name: java.lang.String, props: js.Function1[/* repeated */js.Any, _], parentClass: js.Any): js.Any = js.native
  def ɵangular_packages_core_core_b(name: java.lang.String): js.Any = js.native
  def ɵangular_packages_core_core_b(name: java.lang.String, props: js.Function1[/* repeated */js.Any, _]): js.Any = js.native
  def ɵangular_packages_core_core_b(name: java.lang.String, props: js.Function1[/* repeated */js.Any, _], parentClass: js.Any): js.Any = js.native
  def ɵangular_packages_core_core_b(
    name: java.lang.String,
  ...
  def ɵangular_packages_core_core_bc[T](objWithPropertyToExtract: T): java.lang.String = js.native
  def ɵangular_packages_core_core_be[T](index: scala.Double, arr: atAngularCoreLib.srcRender3InterfacesViewMod.LViewData): T = js.native
  def ɵangular_packages_core_core_be[T](index: scala.Double, arr: atAngularCoreLib.srcRender3InterfacesViewMod.TData): T = js.native
  def ɵangular_packages_core_core_bf(target: js.Object): atAngularCoreLib.srcRender3InterfacesPlayerMod.PlayerContext = js.native
  def ɵangular_packages_core_core_bf(target: js.Object, context: atAngularCoreLib.srcRender3InterfacesContextMod.LContext): atAngularCoreLib.srcRender3InterfacesPlayerMod.PlayerContext = js.native
  def ɵangular_packages_core_core_e(providers: js.Array[atAngularCoreLib.srcDiProviderMod.Provider]): js.Array[atAngularCoreLib.srcDiReflectiveUnderscoreProviderMod.ResolvedReflectiveProvider] = js.native
  def ɵangular_packages_core_core_f(): java.lang.String = js.native
  def ɵangular_packages_core_core_i(): atAngularCoreLib.srcChangeUnderscoreDetectionChangeUnderscoreDetectionMod.IterableDiffers = js.native
  def ɵangular_packages_core_core_j(): atAngularCoreLib.srcChangeUnderscoreDetectionChangeUnderscoreDetectionMod.KeyValueDiffers = js.native
  def ɵangular_packages_core_core_k(): java.lang.String = js.native
  def ɵangular_packages_core_core_k(locale: java.lang.String): java.lang.String = js.native
  def ɵangular_packages_core_core_n(): scala.Boolean = js.native
  def ɵangular_packages_core_core_o(signature: java.lang.String): js.Any = js.native
  def ɵangular_packages_core_core_o(signature: java.lang.String, flags: js.Any): js.Any = js.native
  def ɵangular_packages_core_core_p[T](scope: atAngularCoreLib.srcProfileWtfUnderscoreImplMod.Scope): T = js.native
  def ɵangular_packages_core_core_p[T](scope: atAngularCoreLib.srcProfileWtfUnderscoreImplMod.Scope, returnValue: T): T = js.native
  @JSName("ɵangular_packages_core_core_p")
  def ɵangular_packages_core_core_p_TUnit[T](scope: atAngularCoreLib.srcProfileWtfUnderscoreImplMod.Scope): scala.Unit = js.native
  def ɵangular_packages_core_core_q(rangeType: java.lang.String, action: java.lang.String): atAngularCoreLib.srcProfileWtfUnderscoreImplMod.Range = js.native
  def ɵangular_packages_core_core_r(range: atAngularCoreLib.srcProfileWtfUnderscoreImplMod.Range): scala.Unit = js.native
  def ɵangular_packages_core_core_s(
  ...
  def ɵangular_packages_core_core_v(): atAngularCoreLib.srcRender3InterfacesNodeMod.TNode = js.native
  def ɵangular_packages_core_core_w(): atAngularCoreLib.srcRender3InterfacesViewMod.LViewData = js.native
  def ɵangular_packages_core_core_x(bindingIndex: scala.Double, value: js.Any): scala.Boolean = js.native
  ...
  def ɵangular_packages_core_core_z[T](
    ...
    hostTNode: atAngularCoreLib.srcRender3InterfacesNodeMod.TNode,
    hostView: atAngularCoreLib.srcRender3InterfacesViewMod.LViewData
  ): atAngularCoreLib.srcLinkerTemplateUnderscoreRefMod.TemplateRef[T] = js.native
  ...
  def ɵbypassSanitizationTrustStyle(trustedStyle: java.lang.String): atAngularCoreLib.srcSanitizationBypassMod.TrustedStyleString = js.native
  def ɵbypassSanitizationTrustUrl(trustedUrl: java.lang.String): atAngularCoreLib.srcSanitizationBypassMod.TrustedUrlString = js.native
  def ɵccf(
  ...
  def `ɵcompileNgModuleFactory__POST_NGCC__`[M](
  ...
  def ɵdirectiveInject[T](token: atAngularCoreLib.srcDiInjectionUnderscoreTokenMod.InjectionToken[T]): T = js.native
  def ɵdirectiveInject[T](
    token: atAngularCoreLib.srcDiInjectionUnderscoreTokenMod.InjectionToken[T],
    flags: atAngularCoreLib.srcDiInjectorMod.InjectFlags
  ): T = js.native
  def ɵdirectiveInject[T](token: atAngularCoreLib.srcTypeMod.Type[T]): T = js.native
  def ɵdirectiveInject[T](token: atAngularCoreLib.srcTypeMod.Type[T], flags: atAngularCoreLib.srcDiInjectorMod.InjectFlags): T = js.native
  def ɵdisableBindings(): scala.Unit = js.native
  def ɵeld(
    checkIndex: scala.Double,
    flags: atAngularCoreLib.srcViewTypesMod.NodeFlags,
    ...
    bindings: js.UndefOr[
      scala.Null | (js.Array[
        js.Tuple3[
          atAngularCoreLib.srcViewTypesMod.BindingFlags, 
          java.lang.String, 
          java.lang.String | atAngularCoreLib.srcSanitizationSecurityMod.SecurityContext | scala.Null
        ]
      ])
    ],
    outputs: js.UndefOr[scala.Null | (js.Array[js.Tuple2[java.lang.String, java.lang.String]])],
    handleEvent: js.UndefOr[scala.Null | atAngularCoreLib.srcViewTypesMod.ElementHandleEventFn],
    componentView: js.UndefOr[scala.Null | atAngularCoreLib.srcViewTypesMod.ViewDefinitionFactory],
    componentRendererType: js.UndefOr[atAngularCoreLib.srcRenderApiMod.RendererType2 | scala.Null]
  ): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵelement(index: scala.Double, name: java.lang.String): scala.Unit = js.native
  def ɵelement(
    index: scala.Double,
    name: java.lang.String,
  ...
  def ɵelementAttribute(index: scala.Double, name: java.lang.String, value: js.Any): scala.Unit = js.native
  def ɵelementAttribute(
    index: scala.Double,
    name: java.lang.String,
    value: js.Any,
  ...
  def ɵelementStylingMap[T](index: scala.Double, classes: scala.Null, styles: ScalablyTyped.runtime.StringDictionary[js.Any]): scala.Unit = js.native
  ...
  def ɵgetFactoryOf[T](`type`: atAngularCoreLib.srcTypeMod.Type[_]): (js.Function1[/* type */ js.UndefOr[atAngularCoreLib.srcTypeMod.Type[T]], T]) | scala.Null = js.native
  ...
  def ɵi18nApply(
    ...
    instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]
  ): scala.Unit = js.native
  def ɵi18nAttribute(index: scala.Double, attrs: js.Array[_]): scala.Unit = js.native
  def ɵi18nEnd(): scala.Unit = js.native
  def ɵi18nExp(expression: js.Any): scala.Unit = js.native
  def ɵi18nExpMapping(translation: java.lang.String, placeholders: atAngularCoreLib.srcRender3I18nMod.PlaceholderMap): js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction] = js.native
  def ɵi18nInterpolation1(instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction], v0: js.Any): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵi18nInterpolation2(
    instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction],
    v0: js.Any,
    v1: js.Any
  ): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵi18nInterpolation3(
    instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction],
    v0: js.Any,
    v1: js.Any,
    v2: js.Any
  ): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵi18nInterpolation4(
    instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction],
    v0: js.Any,
    v1: js.Any,
    v2: js.Any,
  ...
  def ɵi18nInterpolationV(instructions: js.Array[atAngularCoreLib.srcRender3I18nMod.I18nExpInstruction], values: js.Array[_]): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵi18nMapping(translation: java.lang.String): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null]
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    expressions: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null]
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    expressions: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    templateRoots: js.Array[java.lang.String]
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    expressions: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    templateRoots: js.Array[java.lang.String],
    lastChildIndex: scala.Double
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    expressions: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    templateRoots: scala.Null,
    lastChildIndex: scala.Double
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
    elements: js.Array[atAngularCoreLib.srcRender3I18nMod.PlaceholderMap | scala.Null],
    expressions: scala.Null,
    templateRoots: js.Array[java.lang.String]
  ): js.Array[js.Array[atAngularCoreLib.srcRender3I18nMod.I18nInstruction]] = js.native
  def ɵi18nMapping(
    translation: java.lang.String,
  ...
  def ɵi18nStart(index: scala.Double, message: java.lang.String): scala.Unit = js.native
  def ɵi18nStart(index: scala.Double, message: java.lang.String, subTemplateIndex: scala.Double): scala.Unit = js.native
  ...
  def ɵinterpolation1(prefix: java.lang.String, v0: js.Any, suffix: java.lang.String): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵinterpolation2(prefix: java.lang.String, v0: js.Any, i0: java.lang.String, v1: js.Any, suffix: java.lang.String): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  def ɵinterpolation3(
  ...
  def ɵinterpolationV(values: js.Array[_]): java.lang.String | atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE = js.native
  ...
  def ɵload[T](index: scala.Double): T = js.native
  ...
  def ɵnamespaceHTML(): scala.Unit = js.native
  def ɵnamespaceMathML(): scala.Unit = js.native
  def ɵnamespaceSVG(): scala.Unit = js.native
  def ɵncd(ngContentIndex: scala.Double, index: scala.Double): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵncd(ngContentIndex: scala.Null, index: scala.Double): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵnextContext[T](): T = js.native
  def ɵnextContext[T](level: scala.Double): T = js.native
  def ɵnov(view: atAngularCoreLib.srcViewTypesMod.ViewData, index: scala.Double): js.Any = js.native
  ...
  def ɵpad(checkIndex: scala.Double, argCount: scala.Double): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵpid(
    flags: atAngularCoreLib.srcViewTypesMod.NodeFlags,
    ctor: js.Any,
    deps: js.Array[(js.Tuple2[atAngularCoreLib.srcViewTypesMod.DepFlags, _]) | _]
  ): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵpipe(index: scala.Double, pipeName: java.lang.String): js.Any = js.native
  def ɵpipeBind1(index: scala.Double, slotOffset: scala.Double, v1: js.Any): js.Any = js.native
  def ɵpipeBind2(index: scala.Double, slotOffset: scala.Double, v1: js.Any, v2: js.Any): js.Any = js.native
  def ɵpipeBind3(index: scala.Double, slotOffset: scala.Double, v1: js.Any, v2: js.Any, v3: js.Any): js.Any = js.native
  def ɵpipeBind4(index: scala.Double, slotOffset: scala.Double, v1: js.Any, v2: js.Any, v3: js.Any, v4: js.Any): js.Any = js.native
  def ɵpipeBindV(index: scala.Double, slotOffset: scala.Double, values: js.Array[_]): js.Any = js.native
  ...
  def ɵprojection(nodeIndex: scala.Double): scala.Unit = js.native
  def ɵprojection(nodeIndex: scala.Double, selectorIndex: scala.Double): scala.Unit = js.native
  def ɵprojection(nodeIndex: scala.Double, selectorIndex: scala.Double, attrs: js.Array[java.lang.String]): scala.Unit = js.native
  def ɵprojectionDef(): scala.Unit = js.native
  def ɵprojectionDef(selectors: js.Array[atAngularCoreLib.srcRender3InterfacesProjectionMod.CssSelectorList]): scala.Unit = js.native
  def ɵprojectionDef(
  ...
  def ɵpureFunction0[T](slotOffset: scala.Double, pureFn: js.Function0[T]): T = js.native
  def ɵpureFunction0[T](slotOffset: scala.Double, pureFn: js.Function0[T], thisArg: js.Any): T = js.native
  def ɵpureFunction1(slotOffset: scala.Double, pureFn: js.Function1[/* v */ js.Any, _], exp: js.Any): js.Any = js.native
  def ɵpureFunction1(slotOffset: scala.Double, pureFn: js.Function1[/* v */ js.Any, _], exp: js.Any, thisArg: js.Any): js.Any = js.native
  def ɵpureFunction2(
  ...
  def ɵquery[T](memoryIndex: scala.Double, predicate: atAngularCoreLib.srcTypeMod.Type[_]): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](memoryIndex: scala.Double, predicate: atAngularCoreLib.srcTypeMod.Type[_], descend: scala.Boolean): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](
  ...
  def ɵquery[T](memoryIndex: scala.Double, predicate: js.Array[java.lang.String]): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](memoryIndex: scala.Double, predicate: js.Array[java.lang.String], descend: scala.Boolean): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](
    memoryIndex: scala.Double,
  ...
  def ɵquery[T](memoryIndex: scala.Null, predicate: atAngularCoreLib.srcTypeMod.Type[_]): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](memoryIndex: scala.Null, predicate: atAngularCoreLib.srcTypeMod.Type[_], descend: scala.Boolean): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](
  ...
  def ɵquery[T](memoryIndex: scala.Null, predicate: js.Array[java.lang.String]): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](memoryIndex: scala.Null, predicate: js.Array[java.lang.String], descend: scala.Boolean): atAngularCoreLib.srcRender3QueryMod.QueryList[T] = js.native
  def ɵquery[T](
    memoryIndex: scala.Null,
    predicate: js.Array[java.lang.String],
    descend: scala.Boolean,
  ...
  def ɵqueryRefresh(queryList: atAngularCoreLib.srcRender3QueryMod.QueryList[_]): scala.Boolean = js.native
  def ɵreference[T](index: scala.Double): T = js.native
  def ɵregisterContentQuery[Q](queryList: atAngularCoreLib.srcLinkerMod.QueryList[Q]): scala.Unit = js.native
  def ɵregisterModuleFactory(
    id: java.lang.String,
    factory: atAngularCoreLib.srcLinkerNgUnderscoreModuleUnderscoreFactoryMod.NgModuleFactory[_]
  ): scala.Unit = js.native
  def ɵrenderComponent[T](componentType: atAngularCoreLib.srcRender3InterfacesDefinitionMod.ComponentType[T]): T = js.native
  ...
  def ɵrenderComponent[T](componentType: atAngularCoreLib.srcTypeMod.Type[T]): T = js.native
  def ɵrenderComponent[T](
  ...
  def ɵted(checkIndex: scala.Double, ngContentIndex: scala.Double, staticText: js.Array[java.lang.String]): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵted(checkIndex: scala.Double, ngContentIndex: scala.Null, staticText: js.Array[java.lang.String]): atAngularCoreLib.srcViewTypesMod.NodeDef = js.native
  def ɵtemplate(
    index: scala.Double,
  ...
  def ɵtemplate(index: scala.Double, templateFn: scala.Null, consts: scala.Double, vars: scala.Double): scala.Unit = js.native
  def ɵtemplate(
    index: scala.Double,
  ...
  def ɵtextBinding[T](index: scala.Double, value: T): scala.Unit = js.native
  def ɵtextBinding[T](index: scala.Double, value: atAngularCoreLib.srcRender3InstructionsMod.NO_CHANGE): scala.Unit = js.native
  def ɵunv(
