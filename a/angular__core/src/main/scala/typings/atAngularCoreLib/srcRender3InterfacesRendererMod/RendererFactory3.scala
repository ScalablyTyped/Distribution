...
trait RendererFactory3 extends js.Object {
  ...
  def createRenderer(hostElement: RElement, rendererType: atAngularCoreLib.srcRenderApiMod.RendererType2): Renderer3 = js.native
  def createRenderer(hostElement: scala.Null, rendererType: atAngularCoreLib.srcRenderApiMod.RendererType2): Renderer3 = js.native
}
