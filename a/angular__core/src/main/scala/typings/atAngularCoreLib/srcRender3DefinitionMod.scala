...
object srcRender3DefinitionMod extends js.Object {
  ...
  def getNgModuleDef[T](`type`: js.Any, throwNotFound: atAngularCoreLib.atAngularCoreLibNumbers.`true`): atAngularCoreLib.srcMetadataNgUnderscoreModuleMod.NgModuleDef[T] = js.native
