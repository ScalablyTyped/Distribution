...
import typings.atAngularCore.Anon_Character
...
trait ResolvedTemplate extends js.Object {
  ...
  /**
    ...
    */
  def getCharacterAndLineOfPosition(pos: Double): Anon_Character
}
...
object ResolvedTemplate {
  ...
  def apply(
    ...
    content: String,
    filePath: String,
    getCharacterAndLineOfPosition: Double => Anon_Character,
    `inline`: Boolean,
    start: Double
  ): ResolvedTemplate = {
