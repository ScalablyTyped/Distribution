...
trait IPanelRef extends js.Object {
  ...
  def attach(): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def close(): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def destroy(): scala.Unit = js.native
  def detach(): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def hide(): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def open(): angularLib.angularMod.angularNs.IPromise[_] = js.native
  def registerInterceptor(`type`: java.lang.String, callback: js.Function0[angularLib.angularMod.angularNs.IPromise[_]]): IPanelRef = js.native
  ...
  def removeInterceptor(`type`: java.lang.String, callback: js.Function0[angularLib.angularMod.angularNs.IPromise[_]]): IPanelRef = js.native
  def show(): angularLib.angularMod.angularNs.IPromise[_] = js.native
