...
trait ISidenavObject extends js.Object {
  def close(): angularLib.angularMod.IPromise[scala.Unit]
  def isLockedOpen(): scala.Boolean
  def isOpen(): scala.Boolean
  def onClose(onClose: js.Function0[scala.Unit]): scala.Unit
  def open(): angularLib.angularMod.IPromise[scala.Unit]
  def toggle(): angularLib.angularMod.IPromise[scala.Unit]
}

object ISidenavObject {
  @scala.inline
  def apply(
    close: () => angularLib.angularMod.IPromise[scala.Unit],
    isLockedOpen: () => scala.Boolean,
    isOpen: () => scala.Boolean,
    onClose: js.Function0[scala.Unit] => scala.Unit,
    open: () => angularLib.angularMod.IPromise[scala.Unit],
    toggle: () => angularLib.angularMod.IPromise[scala.Unit]
  ): ISidenavObject = {
