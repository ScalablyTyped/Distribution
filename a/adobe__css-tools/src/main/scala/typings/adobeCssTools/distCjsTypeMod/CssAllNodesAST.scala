...
import typings.adobeCssTools.distCjsTypeMod.CssTypes.keyframe
...
/* Rewritten from type alias, can be one of: 
  - typings.adobeCssTools.distCjsTypeMod.CssAtRuleAST
  - typings.adobeCssTools.distCjsTypeMod.CssStylesheetAST
  - typings.adobeCssTools.distCjsTypeMod.CssDeclarationAST
  - typings.adobeCssTools.distCjsTypeMod.CssKeyframeAST
*/
...
object CssAllNodesAST {
  ...
  inline def CssDeclarationAST(property: String, `type`: declaration, value: String): typings.adobeCssTools.distCjsTypeMod.CssDeclarationAST = {
    val __obj = js.Dynamic.literal(property = property.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.adobeCssTools.distCjsTypeMod.CssDeclarationAST]
  }
  ...
  inline def CssKeyframeAST(
    ...
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.adobeCssTools.distCjsTypeMod.CssKeyframeAST]
  }
  ...
  inline def CssStylesheetAST(stylesheet: ParsingErrors, `type`: stylesheet): typings.adobeCssTools.distCjsTypeMod.CssStylesheetAST = {
    val __obj = js.Dynamic.literal(stylesheet = stylesheet.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.adobeCssTools.distCjsTypeMod.CssStylesheetAST]
  }
