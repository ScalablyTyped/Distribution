...
trait FaxServer_Invoke_Parameter extends js.Object {
...
object FaxServer_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    __obj.asInstanceOf[FaxServer_Invoke_Parameter]
  }
}
