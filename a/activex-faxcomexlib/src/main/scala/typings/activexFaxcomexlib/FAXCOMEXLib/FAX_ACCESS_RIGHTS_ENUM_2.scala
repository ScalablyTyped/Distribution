...
*/
trait FAX_ACCESS_RIGHTS_ENUM_2 extends StObject
object FAX_ACCESS_RIGHTS_ENUM_2 {
  
  inline def far2MANAGE_ARCHIVES: `256` = 256.asInstanceOf[`256`]
  
  inline def far2MANAGE_CONFIG: `64` = 64.asInstanceOf[`64`]
  
  inline def far2MANAGE_OUT_JOBS: `16` = 16.asInstanceOf[`16`]
  
  inline def far2MANAGE_RECEIVE_FOLDER: `512` = 512.asInstanceOf[`512`]
  
  inline def far2QUERY_ARCHIVES: `128` = 128.asInstanceOf[`128`]
  
  inline def far2QUERY_CONFIG: `32` = 32.asInstanceOf[`32`]
  
  inline def far2QUERY_OUT_JOBS: `8` = 8.asInstanceOf[`8`]
  
  inline def far2SUBMIT_HIGH: `4` = 4.asInstanceOf[`4`]
  
  inline def far2SUBMIT_LOW: `1` = 1.asInstanceOf[`1`]
  
  inline def far2SUBMIT_NORMAL: `2` = 2.asInstanceOf[`2`]
}
