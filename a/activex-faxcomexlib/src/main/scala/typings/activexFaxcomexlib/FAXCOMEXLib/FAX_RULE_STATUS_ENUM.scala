...
*/
trait FAX_RULE_STATUS_ENUM extends StObject
object FAX_RULE_STATUS_ENUM {
  
  inline def frsALL_GROUP_DEV_NOT_VALID: `2` = 2.asInstanceOf[`2`]
  
  inline def frsBAD_DEVICE: `4` = 4.asInstanceOf[`4`]
  
  inline def frsEMPTY_GROUP: `1` = 1.asInstanceOf[`1`]
  
  inline def frsSOME_GROUP_DEV_NOT_VALID: `3` = 3.asInstanceOf[`3`]
  
  inline def frsVALID: `0` = 0.asInstanceOf[`0`]
}
