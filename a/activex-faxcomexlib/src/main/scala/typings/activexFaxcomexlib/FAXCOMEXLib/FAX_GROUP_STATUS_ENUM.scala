...
*/
trait FAX_GROUP_STATUS_ENUM extends StObject
object FAX_GROUP_STATUS_ENUM {
  
  inline def fgsALL_DEV_NOT_VALID: `2` = 2.asInstanceOf[`2`]
  
  inline def fgsALL_DEV_VALID: `0` = 0.asInstanceOf[`0`]
  
  inline def fgsEMPTY: `1` = 1.asInstanceOf[`1`]
  
  inline def fgsSOME_DEV_NOT_VALID: `3` = 3.asInstanceOf[`3`]
}
