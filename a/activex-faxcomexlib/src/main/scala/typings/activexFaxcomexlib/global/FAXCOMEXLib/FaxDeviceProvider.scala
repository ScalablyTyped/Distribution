...
class FaxDeviceProvider protected ()
  extends typings.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider {
  ...
  override var FAXCOMEXLibDotFaxDeviceProvider_typekey: typings.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider = js.native
