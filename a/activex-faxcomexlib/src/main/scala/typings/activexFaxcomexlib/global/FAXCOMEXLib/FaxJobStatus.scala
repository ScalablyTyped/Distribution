...
class FaxJobStatus protected ()
  extends typings.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus {
  ...
  override var FAXCOMEXLibDotFaxJobStatus_typekey: typings.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus = js.native
  /** Job type */
  /* CompleteClass */
