...
class IFaxOutgoingJob protected ()
  extends typings.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob {
  ...
  override var FAXCOMEXLibDotIFaxOutgoingJob_typekey: typings.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob = js.native
