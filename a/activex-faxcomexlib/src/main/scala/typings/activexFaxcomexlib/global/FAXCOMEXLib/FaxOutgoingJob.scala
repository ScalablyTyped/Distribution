...
@js.native
/* private */ class FaxOutgoingJob ()
  extends StObject
     with typings.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob {
  ...
  var FAXCOMEXLibDotFaxOutgoingJob_typekey: typings.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob = js.native
