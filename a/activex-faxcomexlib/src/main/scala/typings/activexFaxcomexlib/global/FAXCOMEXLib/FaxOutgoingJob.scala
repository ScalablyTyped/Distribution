...
class FaxOutgoingJob protected ()
  extends typings.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob {
  ...
  override var FAXCOMEXLibDotFaxOutgoingJob_typekey: typings.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob = js.native
