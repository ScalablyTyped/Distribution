...
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Numbers.`50`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`AWS4-HMAC-SHA256`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`UNSIGNED-PAYLOAD`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Algorithm`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Credential`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Date`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Expires`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Security-Token`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-Signature`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`X-Amz-SignedHeaders`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.`x-amz-content-sha256`
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.authorization
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.aws4_request
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.date
import typings.atAwsDashSdkSignatureDashV4.atAwsDashSdkSignatureDashV4Strings.host
