...
@js.native
trait AutoAdjust extends js.Object {
...
object AutoAdjust {
  ...
  @scala.inline
  implicit class AutoAdjustOps[Self <: AutoAdjust] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoordinateBBox(value: js.Any): Self = this.set("coordinateBBox", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultCfg(value: Line): Self = this.set("defaultCfg", value.asInstanceOf[js.Any])
