...
object AutoAdjust {
  ...
  @scala.inline
  implicit class AutoAdjustMutableBuilder[Self <: AutoAdjust] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCoordinateBBox(value: js.Any): Self = StObject.set(x, "coordinateBBox", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDefaultCfg(value: Line): Self = StObject.set(x, "defaultCfg", value.asInstanceOf[js.Any])
