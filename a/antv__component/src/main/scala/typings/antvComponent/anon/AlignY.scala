...
object AlignY {
  ...
  def apply(
    ...
    __obj.asInstanceOf[AlignY]
  }
  
  @scala.inline
  implicit class AlignYMutableBuilder[Self <: AlignY] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAlignX(value: String): Self = StObject.set(x, "alignX", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlignY(value: String): Self = StObject.set(x, "alignY", value.asInstanceOf[js.Any])
