...
object MarginBottom {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MarginBottom] (val x: Self) extends AnyVal {
    ...
    inline def setBoxShadow(value: Unit): Self = StObject.set(x, "boxShadow", value.asInstanceOf[js.Any])
