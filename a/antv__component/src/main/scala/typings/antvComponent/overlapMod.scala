...
object overlapMod {
  ...
  object autoHide {
    ...
    inline def getDefault(): js.Function2[/* isVertical */ Boolean, /* labelsGroup */ IGroup, Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDefault")().asInstanceOf[js.Function2[/* isVertical */ Boolean, /* labelsGroup */ IGroup, Boolean]]
