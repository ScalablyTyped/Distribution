...
object libAbstractGroupComponentMod {
  
  /* note: abstract class */ @JSImport("@antv/component/lib/abstract/group-component", JSImport.Default)
  @js.native
  open class default[T /* <: GroupComponentCfg */] () extends GroupComponent[T]
