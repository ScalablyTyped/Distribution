...
/* Rewritten from type alias, can be one of: 
  - typings.antvComponent.antvComponentStrings.point
  - typings.antvComponent.antvComponentStrings.Region
  - typings.antvComponent.antvComponentStrings.points
  - typings.antvComponent.antvComponentStrings.circle
  - typings.antvComponent.antvComponentStrings.none
*/
