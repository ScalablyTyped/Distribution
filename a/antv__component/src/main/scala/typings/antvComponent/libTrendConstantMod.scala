...
object libTrendConstantMod {
  
  object AREA_STYLE {
    
    @JSImport("@antv/component/lib/trend/constant", "AREA_STYLE")
    @js.native
  ...
  object BACKGROUND_STYLE {
    ...
    @JSImport("@antv/component/lib/trend/constant", "BACKGROUND_STYLE")
    @js.native
    val ^ : js.Any = js.native
  ...
  object LINE_STYLE {
    ...
    @JSImport("@antv/component/lib/trend/constant", "LINE_STYLE")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@antv/component/lib/trend/constant", "LINE_STYLE.stroke")
    @js.native
