...
*/
trait AcFormView extends js.Object

object AcFormView {
  @scala.inline
  def acDesign: `1` = this.cast(1)
  @scala.inline
  def acFormDS: `3` = this.cast(3)
  @scala.inline
  def acFormPivotChart: `5` = this.cast(5)
  @scala.inline
  def acFormPivotTable: `4` = this.cast(4)
  @scala.inline
  def acLayout: `6` = this.cast(6)
  @scala.inline
  def acNormal: `0` = this.cast(0)
  @scala.inline
  def acPreview: `2` = this.cast(2)
  @scala.inline
