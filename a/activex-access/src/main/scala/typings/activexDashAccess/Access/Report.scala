...
class Report protected () extends js.Object {
  ...
  def GroupLevel(Index: Double): typings.activexDashAccess.Access.GroupLevel = js.native
  ...
  def Section(Index: AcReportSection): typings.activexDashAccess.Access.Section = js.native
