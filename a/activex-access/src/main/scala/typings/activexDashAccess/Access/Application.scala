...
class Application protected () extends js.Object {
  ...
  var AccessDotApplication_typekey: typings.activexDashAccess.Access.Application = js.native
  ...
  val AutoCorrect: typings.activexDashAccess.Access.AutoCorrect = js.native
  ...
  val CodeData: typings.activexDashAccess.Access.CodeData = js.native
  val CodeProject: typings.activexDashAccess.Access.CodeProject = js.native
  @JSName("CommandBars")
  val CommandBars_Original: CommandBars = js.native
  val CurrentData: typings.activexDashAccess.Access.CurrentData = js.native
  val CurrentObjectName: String = js.native
  val CurrentObjectType: AcObjectType = js.native
  val CurrentProject: typings.activexDashAccess.Access.CurrentProject = js.native
  val DBEngine: typings.activexDashDao.DAO.DBEngine = js.native
  @JSName("DataAccessPages")
  val DataAccessPages_Original: DataAccessPages = js.native
  val DefaultWebOptions: typings.activexDashAccess.Access.DefaultWebOptions = js.native
  val DoCmd: typings.activexDashAccess.Access.DoCmd = js.native
  ...
  val MacroError: typings.activexDashAccess.Access.MacroError = js.native
  ...
  val Screen: typings.activexDashAccess.Access.Screen = js.native
  ...
  val WizHook: typings.activexDashAccess.Access.WizHook = js.native
  ...
  def FileDialog(dialogType: MsoFileDialogType): typings.activexDashOffice.Office.FileDialog = js.native
  /**
