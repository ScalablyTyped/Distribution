...
object AcImeSentenceMode {
  @scala.inline
  def acImeSentenceModeConversation: `2` = this.cast(2)
  @scala.inline
  def acImeSentenceModeNone: `3` = this.cast(3)
  @scala.inline
  def acImeSentenceModePhrasePredict: `0` = this.cast(0)
  @scala.inline
  def acImeSentenceModePluralClause: `1` = this.cast(1)
  @scala.inline
