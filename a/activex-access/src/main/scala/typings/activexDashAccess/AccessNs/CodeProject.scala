...
class CodeProject protected () extends js.Object {
  var `Access.CodeProject_typekey`: CodeProject = js.native
  val AccessConnection: typings.activexDashAdodb.ADODBNs.Connection = js.native
  ...
  val Connection: typings.activexDashAdodb.ADODBNs.Connection = js.native
