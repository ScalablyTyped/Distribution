...
trait CommandButton extends StObject {
  ...
  /* private */ @JSName("Access.CommandButton_typekey")
  ...
  var CursorOnHover: AcCursorOnHover = js.native
  ...
  var HoverColor: Double = js.native
  
  var HoverForeColor: Double = js.native
  
  var HoverForeShade: Double = js.native
  
  var HoverForeThemeColorIndex: Double = js.native
  
  var HoverForeTint: Double = js.native
  
  var HoverShade: Double = js.native
  
  var HoverThemeColorIndex: Double = js.native
  
  var HoverTint: Double = js.native
  ...
  var OnPush: String = js.native
  
  val Parent: Any = js.native
  
  var Picture: String = js.native
  
  var PictureCaptionArrangement: AcPictureCaptionArrangement = js.native
  
  var PictureData: Any = js.native
  
  var PictureType: Double = js.native
  
  var PressedColor: Double = js.native
  
  var PressedForeColor: Double = js.native
  
  var PressedForeShade: Double = js.native
  
  var PressedForeThemeColorIndex: Double = js.native
  
  var PressedForeTint: Double = js.native
  
  var PressedShade: Double = js.native
  
  var PressedThemeColorIndex: Double = js.native
  
  var PressedTint: Double = js.native
  ...
  var QuickStyle: Double = js.native
  
  var QuickStyleMask: Double = js.native
  ...
  var UseTheme: Boolean = js.native
