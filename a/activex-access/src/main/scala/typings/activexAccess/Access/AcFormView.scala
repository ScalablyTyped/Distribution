...
object AcFormView {
  ...
  @scala.inline
  def acDesign: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def acFormDS: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def acFormPivotChart: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def acFormPivotTable: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def acLayout: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def acNormal: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def acPreview: `2` = 2.asInstanceOf[`2`]
}
