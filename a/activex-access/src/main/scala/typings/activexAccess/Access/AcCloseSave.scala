...
*/
trait AcCloseSave extends StObject
object AcCloseSave {
  
  inline def acSaveNo: `2` = 2.asInstanceOf[`2`]
  
  inline def acSavePrompt: `0` = 0.asInstanceOf[`0`]
  
  inline def acSaveYes: `1` = 1.asInstanceOf[`1`]
}
