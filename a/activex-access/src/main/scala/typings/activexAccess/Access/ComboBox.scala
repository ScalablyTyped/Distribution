...
trait ComboBox extends StObject {
  ...
  def AddItem(Item: String): Unit = js.native
  def AddItem(Item: String, Index: Double): Unit = js.native
  
  var AfterUpdate: String = js.native
  
  var AfterUpdateMacro: String = js.native
  
  var AllowAutoCorrect: Boolean = js.native
  
  var AllowValueListEdits: Boolean = js.native
  ...
  var FormatPictureText: String = js.native
  ...
  var InheritValueList: Boolean = js.native
  
  var InputMask: String = js.native
  
  var IsHyperlink: Boolean = js.native
  ...
  var LimitToList: Boolean = js.native
  
  var ListCount: Double = js.native
  
  var ListIndex: Double = js.native
  
  var ListItemsEditForm: String = js.native
  
  var ListRows: Double = js.native
  
  var ListWidth: String = js.native
  ...
  var OnNotInList: String = js.native
  
  var OnNotInListMacro: String = js.native
  ...
  def RemoveItem(Index: String): Unit = js.native
  ...
  var RowSourceType: String = js.native
  ...
  var ShowOnlyRowSourceValues: Boolean = js.native
  ...
  var TextAlignGeneral: Double = js.native
