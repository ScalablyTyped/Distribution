...
trait Report extends StObject {
  ...
  var AccessDotReport_typekey: typings.activexAccess.Access.Report = js.native
  ...
  val Module: typings.activexAccess.Access.Module = js.native
  ...
  var Recordset: typings.activexDao.DAO.Recordset | typings.activexAdodb.ADODB.Recordset | Null = js.native
