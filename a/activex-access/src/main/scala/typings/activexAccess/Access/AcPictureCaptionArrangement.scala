...
*/
trait AcPictureCaptionArrangement extends StObject
object AcPictureCaptionArrangement {
  
  inline def acBottom: `3` = 3.asInstanceOf[`3`]
  
  inline def acGeneral: `1` = 1.asInstanceOf[`1`]
  
  inline def acLeft: `4` = 4.asInstanceOf[`4`]
  
  inline def acNoPictureCaption: `0` = 0.asInstanceOf[`0`]
  
  inline def acRight: `5` = 5.asInstanceOf[`5`]
  
  inline def acTop: `2` = 2.asInstanceOf[`2`]
}
