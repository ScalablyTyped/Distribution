...
*/
trait AcWindowMode extends js.Object
object AcWindowMode {
  
  @scala.inline
  def acDialog: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def acHidden: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def acIcon: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def acWindowNormal: `0` = 0.asInstanceOf[`0`]
}
