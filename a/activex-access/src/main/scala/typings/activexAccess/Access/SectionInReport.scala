...
trait SectionInReport extends StObject {
  
  @JSName("Access._SectionInReport_typekey")
  var AccessDot_SectionInReport_typekey: SectionInReport
...
object SectionInReport {
  
  @scala.inline
  def apply(
    AccessDot_SectionInReport_typekey: SectionInReport,
    ...
    __obj.updateDynamic("Access._SectionInReport_typekey")(AccessDot_SectionInReport_typekey.asInstanceOf[js.Any])
    __obj.asInstanceOf[SectionInReport]
  }
  
  @scala.inline
  implicit class SectionInReportMutableBuilder[Self <: SectionInReport] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setAccessDot_SectionInReport_typekey(value: SectionInReport): Self = StObject.set(x, "Access._SectionInReport_typekey", value.asInstanceOf[js.Any])
