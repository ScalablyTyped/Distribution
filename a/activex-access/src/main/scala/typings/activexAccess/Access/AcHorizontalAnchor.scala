...
*/
trait AcHorizontalAnchor extends StObject
object AcHorizontalAnchor {
  
  inline def acHorizontalAnchorBoth: `2` = 2.asInstanceOf[`2`]
  
  inline def acHorizontalAnchorLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def acHorizontalAnchorRight: `1` = 1.asInstanceOf[`1`]
}
