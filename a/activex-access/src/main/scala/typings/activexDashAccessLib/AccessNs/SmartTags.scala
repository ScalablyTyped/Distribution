...
trait SmartTags extends js.Object {
  ...
  def apply(Index: java.lang.String): SmartTag = js.native
  def apply(Index: scala.Double): SmartTag = js.native
  def Add(Name: java.lang.String): SmartTag = js.native
  def IsMemberSafe(dispid: scala.Double): scala.Boolean = js.native
  def Item(Index: java.lang.String): SmartTag = js.native
  def Item(Index: scala.Double): SmartTag = js.native
}
