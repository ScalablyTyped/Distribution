...
class Section protected () extends js.Object {
  var `Access.Section_typekey`: Section = js.native
  var AlternateBackColor: scala.Double = js.native
  ...
  var ForceNewPage: scala.Double = js.native
  var HasContinued: scala.Boolean = js.native
  var Height: scala.Double = js.native
  var InSelection: scala.Boolean = js.native
  var KeepTogether: scala.Boolean = js.native
  var Name: java.lang.String = js.native
  var NewRowOrCol: scala.Double = js.native
  ...
  var OnFormat: java.lang.String = js.native
  var OnFormatMacro: java.lang.String = js.native
  ...
  var OnPaint: java.lang.String = js.native
  var OnPaintMacro: java.lang.String = js.native
  var OnPrint: java.lang.String = js.native
  var OnPrintMacro: java.lang.String = js.native
  var OnRetreat: java.lang.String = js.native
  var OnRetreatMacro: java.lang.String = js.native
  val Parent: js.Any = js.native
  @JSName("Properties")
  val Properties_Original: Properties = js.native
  var RepeatSection: scala.Boolean = js.native
