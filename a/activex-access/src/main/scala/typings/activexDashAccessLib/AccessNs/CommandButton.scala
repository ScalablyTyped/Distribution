...
class CommandButton protected () extends js.Object {
  ...
  var Bevel: scala.Double = js.native
  ...
  var Glow: scala.Double = js.native
  var Gradient: scala.Double = js.native
  ...
  var HoverColor: scala.Double = js.native
  var HoverForeColor: scala.Double = js.native
  var HoverForeShade: scala.Double = js.native
  var HoverForeThemeColorIndex: scala.Double = js.native
  var HoverForeTint: scala.Double = js.native
  ...
  var OnPush: java.lang.String = js.native
  ...
  var PressedColor: scala.Double = js.native
  var PressedForeColor: scala.Double = js.native
  var PressedForeShade: scala.Double = js.native
  var PressedForeThemeColorIndex: scala.Double = js.native
  var PressedForeTint: scala.Double = js.native
  var PressedShade: scala.Double = js.native
  var PressedThemeColorIndex: scala.Double = js.native
  var PressedTint: scala.Double = js.native
  @JSName("Properties")
  val Properties_Original: Properties = js.native
  var QuickStyle: scala.Double = js.native
  var QuickStyleMask: scala.Double = js.native
  ...
  var Shape: scala.Double = js.native
  var ShortcutMenuBar: java.lang.String = js.native
  var SoftEdges: scala.Double = js.native
  ...
  var UseTheme: scala.Boolean = js.native
