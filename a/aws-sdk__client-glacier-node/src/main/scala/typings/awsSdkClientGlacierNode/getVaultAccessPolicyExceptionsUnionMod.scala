...
@JSImport("@aws-sdk/client-glacier-node/types/GetVaultAccessPolicyExceptionsUnion", JSImport.Namespace)
@js.native
object getVaultAccessPolicyExceptionsUnionMod extends js.Object {
