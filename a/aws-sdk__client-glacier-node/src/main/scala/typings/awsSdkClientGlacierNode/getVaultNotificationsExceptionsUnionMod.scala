...
@JSImport("@aws-sdk/client-glacier-node/types/GetVaultNotificationsExceptionsUnion", JSImport.Namespace)
@js.native
object getVaultNotificationsExceptionsUnionMod extends js.Object {
