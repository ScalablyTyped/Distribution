...
object glacierConfigurationMod {
  ...
  object GlacierConfiguration {
    ...
    inline def apply(): GlacierConfiguration = {
  ...
  trait GlacierResolvedConfiguration
    ...
    def base64Decoder_MGlacierResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MGlacierResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MGlacierResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("urlParser")
    def urlParser_MGlacierResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MGlacierResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MGlacierResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
