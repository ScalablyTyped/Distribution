...
object glacierConfigurationMod {
  ...
  trait GlacierResolvableConfiguration
    extends StObject
       with GlacierConfiguration {
  ...
  object GlacierResolvableConfiguration {
    ...
    @scala.inline
    implicit class GlacierResolvableConfigurationMutableBuilder[Self <: GlacierResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait GlacierResolvedConfiguration
    extends StObject
       with GlacierConfiguration {
    ...
    def base64Decoder_MGlacierResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MGlacierResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MGlacierResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MGlacierResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_GlacierResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_GlacierResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<_stream.Readable> */ js.Any
    
    @JSName("region")
    def region_MGlacierResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_GlacierResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_GlacierResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_GlacierResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_GlacierResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MGlacierResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MGlacierResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MGlacierResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MGlacierResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
    var utf8Encoder_Original: Encoder
  }
  object GlacierResolvedConfiguration {
    ...
    @scala.inline
    implicit class GlacierResolvedConfigurationMutableBuilder[Self <: GlacierResolvedConfiguration] (val x: Self) extends AnyVal {
