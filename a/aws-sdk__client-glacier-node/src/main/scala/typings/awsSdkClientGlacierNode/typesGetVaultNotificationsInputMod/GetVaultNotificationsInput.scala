package typings.awsSdkClientGlacierNode.typesGetVaultNotificationsInputMod
...
object GetVaultNotificationsInput {
  ...
  @scala.inline
  implicit class GetVaultNotificationsInputOps[Self <: GetVaultNotificationsInput] (val x: Self) extends AnyVal {
    @scala.inline
