package typings.awsSdkClientGlacierNode.typesSetVaultAccessPolicyInputMod

import typings.awsSdkClientGlacierNode.inputTypesUnionMod._InputTypesUnion
import typings.awsSdkClientGlacierNode.typesVaultAccessPolicyMod.VaultAccessPolicy
