...
object outputTypesUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsSdkClientGlacierNode.typesAbortMultipartUploadOutputMod.AbortMultipartUploadOutput
    - typings.awsSdkClientGlacierNode.typesAbortVaultLockOutputMod.AbortVaultLockOutput
    - typings.awsSdkClientGlacierNode.typesAddTagsToVaultOutputMod.AddTagsToVaultOutput
    - typings.awsSdkClientGlacierNode.typesCompleteMultipartUploadOutputMod.CompleteMultipartUploadOutput
    - typings.awsSdkClientGlacierNode.typesCompleteVaultLockOutputMod.CompleteVaultLockOutput
    - typings.awsSdkClientGlacierNode.typesCreateVaultOutputMod.CreateVaultOutput
    - typings.awsSdkClientGlacierNode.typesDeleteArchiveOutputMod.DeleteArchiveOutput
    - typings.awsSdkClientGlacierNode.typesDeleteVaultOutputMod.DeleteVaultOutput
    - typings.awsSdkClientGlacierNode.typesDeleteVaultAccessPolicyOutputMod.DeleteVaultAccessPolicyOutput
    - typings.awsSdkClientGlacierNode.typesDeleteVaultNotificationsOutputMod.DeleteVaultNotificationsOutput
    - typings.awsSdkClientGlacierNode.typesDescribeJobOutputMod.DescribeJobOutput
    - typings.awsSdkClientGlacierNode.typesDescribeVaultOutputMod.DescribeVaultOutput
    - typings.awsSdkClientGlacierNode.typesGetDataRetrievalPolicyOutputMod.GetDataRetrievalPolicyOutput
    - typings.awsSdkClientGlacierNode.typesGetJobOutputOutputMod.GetJobOutputOutput[typings.node.streamMod.Readable]
    - typings.awsSdkClientGlacierNode.typesGetVaultAccessPolicyOutputMod.GetVaultAccessPolicyOutput
    - typings.awsSdkClientGlacierNode.typesGetVaultLockOutputMod.GetVaultLockOutput
    - typings.awsSdkClientGlacierNode.typesGetVaultNotificationsOutputMod.GetVaultNotificationsOutput
    - typings.awsSdkClientGlacierNode.typesInitiateJobOutputMod.InitiateJobOutput
    - typings.awsSdkClientGlacierNode.typesInitiateMultipartUploadOutputMod.InitiateMultipartUploadOutput
    - typings.awsSdkClientGlacierNode.typesInitiateVaultLockOutputMod.InitiateVaultLockOutput
    - typings.awsSdkClientGlacierNode.typesListJobsOutputMod.ListJobsOutput
    - typings.awsSdkClientGlacierNode.typesListMultipartUploadsOutputMod.ListMultipartUploadsOutput
    - typings.awsSdkClientGlacierNode.typesListPartsOutputMod.ListPartsOutput
    - typings.awsSdkClientGlacierNode.typesListProvisionedCapacityOutputMod.ListProvisionedCapacityOutput
    - typings.awsSdkClientGlacierNode.typesListTagsForVaultOutputMod.ListTagsForVaultOutput
    - typings.awsSdkClientGlacierNode.typesListVaultsOutputMod.ListVaultsOutput
    - typings.awsSdkClientGlacierNode.typesPurchaseProvisionedCapacityOutputMod.PurchaseProvisionedCapacityOutput
    - typings.awsSdkClientGlacierNode.typesRemoveTagsFromVaultOutputMod.RemoveTagsFromVaultOutput
    - typings.awsSdkClientGlacierNode.typesSetDataRetrievalPolicyOutputMod.SetDataRetrievalPolicyOutput
    - typings.awsSdkClientGlacierNode.typesSetVaultAccessPolicyOutputMod.SetVaultAccessPolicyOutput
    - typings.awsSdkClientGlacierNode.typesSetVaultNotificationsOutputMod.SetVaultNotificationsOutput
    - typings.awsSdkClientGlacierNode.typesUploadArchiveOutputMod.UploadArchiveOutput
    - typings.awsSdkClientGlacierNode.typesUploadMultipartPartOutputMod.UploadMultipartPartOutput
  */
