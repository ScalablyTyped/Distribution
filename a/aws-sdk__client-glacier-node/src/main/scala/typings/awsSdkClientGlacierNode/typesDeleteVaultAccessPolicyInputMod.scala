...
object typesDeleteVaultAccessPolicyInputMod {
  
  @js.native
  trait DeleteVaultAccessPolicyInput extends _InputTypesUnion {
  ...
  object DeleteVaultAccessPolicyInput {
    ...
    @scala.inline
    implicit class DeleteVaultAccessPolicyInputMutableBuilder[Self <: DeleteVaultAccessPolicyInput] (val x: Self) extends AnyVal {
