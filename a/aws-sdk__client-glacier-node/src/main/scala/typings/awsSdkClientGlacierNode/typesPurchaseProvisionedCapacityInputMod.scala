...
@JSImport("@aws-sdk/client-glacier-node/types/PurchaseProvisionedCapacityInput", JSImport.Namespace)
@js.native
object typesPurchaseProvisionedCapacityInputMod extends js.Object {
  @js.native
  trait PurchaseProvisionedCapacityInput extends _InputTypesUnion {
    /**
