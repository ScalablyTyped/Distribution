package typings.awsSdkClientGlacierNode.typesGetVaultLockInputMod
...
@js.native
trait GetVaultLockInput extends _InputTypesUnion {
...
object GetVaultLockInput {
  ...
  @scala.inline
  implicit class GetVaultLockInputOps[Self <: GetVaultLockInput] (val x: Self) extends AnyVal {
