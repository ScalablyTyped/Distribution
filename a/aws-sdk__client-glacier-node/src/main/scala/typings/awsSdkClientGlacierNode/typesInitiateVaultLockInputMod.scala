...
object typesInitiateVaultLockInputMod {
  
  trait InitiateVaultLockInput
    extends StObject
  ...
  object InitiateVaultLockInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InitiateVaultLockInput] (val x: Self) extends AnyVal {
