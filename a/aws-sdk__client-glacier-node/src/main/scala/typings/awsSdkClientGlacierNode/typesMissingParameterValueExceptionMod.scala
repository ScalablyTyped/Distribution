...
import typings.awsSdkClientGlacierNode.typesGetDataRetrievalPolicyExceptionsUnionMod.GetDataRetrievalPolicyExceptionsUnion
...
import typings.awsSdkClientGlacierNode.typesListProvisionedCapacityExceptionsUnionMod.ListProvisionedCapacityExceptionsUnion
...
import typings.awsSdkClientGlacierNode.typesSetDataRetrievalPolicyExceptionsUnionMod.SetDataRetrievalPolicyExceptionsUnion
...
object typesMissingParameterValueExceptionMod {
  ...
  object MissingParameterValueException {
    ...
    inline def apply(): MissingParameterValueException = {
  ...
  object MissingParameterValueExceptionDetails {
    ...
    inline def apply(): MissingParameterValueExceptionDetails = {
