package typings.awsSdkClientGlacierNode.typesListTagsForVaultInputMod
...
@js.native
trait ListTagsForVaultInput extends _InputTypesUnion {
  /**
...
object ListTagsForVaultInput {
  ...
  @scala.inline
  implicit class ListTagsForVaultInputOps[Self <: ListTagsForVaultInput] (val x: Self) extends AnyVal {
    @scala.inline
