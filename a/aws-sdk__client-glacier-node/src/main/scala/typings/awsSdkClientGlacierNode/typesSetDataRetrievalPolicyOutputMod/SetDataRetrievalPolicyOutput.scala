package typings.awsSdkClientGlacierNode.typesSetDataRetrievalPolicyOutputMod
...
object SetDataRetrievalPolicyOutput {
  ...
  @scala.inline
  implicit class SetDataRetrievalPolicyOutputOps[Self <: SetDataRetrievalPolicyOutput] (val x: Self) extends AnyVal {
    @scala.inline
