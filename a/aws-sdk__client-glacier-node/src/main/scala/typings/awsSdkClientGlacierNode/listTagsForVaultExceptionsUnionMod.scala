...
@JSImport("@aws-sdk/client-glacier-node/types/ListTagsForVaultExceptionsUnion", JSImport.Namespace)
@js.native
object listTagsForVaultExceptionsUnionMod extends js.Object {
