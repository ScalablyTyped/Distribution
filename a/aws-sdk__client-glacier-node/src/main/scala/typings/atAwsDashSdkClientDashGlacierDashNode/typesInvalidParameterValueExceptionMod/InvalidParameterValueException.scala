...
trait InvalidParameterValueException
  ...
  @JSName("name")
  var name_InvalidParameterValueException: typings.atAwsDashSdkClientDashGlacierDashNode.atAwsDashSdkClientDashGlacierDashNodeStrings.InvalidParameterValueException = js.native
}
