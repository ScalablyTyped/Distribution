package typings.atAwsDashSdkClientDashGlacierDashNode.typesSetVaultNotificationsInputMod
...
trait SetVaultNotificationsInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var vaultNotificationConfig: js.UndefOr[_VaultNotificationConfig] = js.undefined
}
...
object SetVaultNotificationsInput {
  ...
  def apply(
    ...
    vaultNotificationConfig: _VaultNotificationConfig = null
