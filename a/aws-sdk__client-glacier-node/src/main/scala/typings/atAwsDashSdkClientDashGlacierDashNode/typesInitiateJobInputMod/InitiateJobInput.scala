package typings.atAwsDashSdkClientDashGlacierDashNode.typesInitiateJobInputMod

import typings.atAwsDashSdkClientDashGlacierDashNode.typesInputTypesUnionMod._InputTypesUnion
import typings.atAwsDashSdkClientDashGlacierDashNode.typesUnderscoreJobParametersMod._JobParameters
...
trait InitiateJobInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var jobParameters: js.UndefOr[_JobParameters] = js.undefined
  /**
...
object InitiateJobInput {
  ...
  def apply(
    ...
    jobParameters: _JobParameters = null
  ): InitiateJobInput = {
