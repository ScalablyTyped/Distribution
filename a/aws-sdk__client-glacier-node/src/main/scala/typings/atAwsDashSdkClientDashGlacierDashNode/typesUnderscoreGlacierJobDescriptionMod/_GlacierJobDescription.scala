...
import typings.atAwsDashSdkClientDashGlacierDashNode.typesUnderscoreInventoryRetrievalJobDescriptionMod._InventoryRetrievalJobDescription
...
trait _GlacierJobDescription extends js.Object {
  /**
  ...
  /**
    ...
    */
  var InventoryRetrievalParameters: js.UndefOr[_InventoryRetrievalJobDescription] = js.undefined
  /**
...
object _GlacierJobDescription {
  ...
  def apply(
    ...
    InventoryRetrievalParameters: _InventoryRetrievalJobDescription = null,
    ...
    __obj.asInstanceOf[_GlacierJobDescription]
  }
}
