...
@JSImport("@aws-sdk/client-glacier-node/types/InitiateMultipartUploadInput", JSImport.Namespace)
@js.native
object typesInitiateMultipartUploadInputMod extends js.Object {
  @js.native
