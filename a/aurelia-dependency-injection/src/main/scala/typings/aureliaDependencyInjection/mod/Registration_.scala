...
object Registration_ {
  ...
  @scala.inline
  implicit class Registration_Ops[Self <: Registration_[_, _, _], TBase, /* <: typings.aureliaDependencyInjection.mod.Impl[TBase] */ TImpl, /* <: typings.aureliaDependencyInjection.mod.Args[TBase] */ TArgs] (val x: Self with (Registration_[TBase, TImpl, TArgs])) extends AnyVal {
    @scala.inline
