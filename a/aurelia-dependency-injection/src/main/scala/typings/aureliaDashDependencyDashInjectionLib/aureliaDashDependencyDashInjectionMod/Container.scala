...
class Container () extends js.Object {
  ...
  def _createInvocationHandler(fn: js.Function with aureliaDashDependencyDashInjectionLib.Anon_Inject): InvocationHandler = js.native
  ...
  /**
    ...
    */
  def autoRegisterAll(fns: js.Array[_]): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def hasResolver(key: js.Any): scala.Boolean = js.native
  def hasResolver(key: js.Any, checkParent: scala.Boolean): scala.Boolean = js.native
  /**
    ...
    */
  def invoke(fn: js.Function with aureliaDashDependencyDashInjectionLib.Anon_Name): js.Any = js.native
  def invoke(
    fn: js.Function with aureliaDashDependencyDashInjectionLib.Anon_Name,
  ...
  /**
    ...
    */
  def setHandlerCreatedCallback(onHandlerCreated: js.Function1[/* handler */ InvocationHandler, InvocationHandler]): scala.Unit = js.native
  /**
...
object Container extends js.Object {
  /**
    ...
    */
  var instance: aureliaDashDependencyDashInjectionLib.aureliaDashDependencyDashInjectionMod.Container = js.native
}
