...
trait TypeofAMap extends js.Object {
  ...
  val Buildings: Instantiable1[
    js.UndefOr[/* opts */ typings.amapJsApi.AMap.Buildings.Options], 
  ...
  val Circle: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.Circle.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val ContextMenu: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.ContextMenu.Options], 
    typings.amapJsApi.AMap.ContextMenu[js.Object]
  ] = js.native
  val DomUtil: TypeofDomUtil = js.native
  val Ellipse: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.Ellipse.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val GeoJSON: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.GeoJSON.Options], 
    typings.amapJsApi.AMap.GeoJSON[js.Object]
  ] = js.native
  val GeometryUtil: TypeofGeometryUtil = js.native
  val Icon: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.Icon.Options], 
  ...
  val InfoWindow: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.InfoWindow.Options[js.Any]], 
    typings.amapJsApi.AMap.InfoWindow[js.Object]
  ] = js.native
  val LabelMarker: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.LabelMarker.Options[js.Any]], 
    typings.amapJsApi.AMap.LabelMarker[js.Object]
  ] = js.native
  val LabelsLayer: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.LabelsLayer.Options], 
  ...
  val Map: Instantiable2[
    ...
    js.UndefOr[/* opts */ typings.amapJsApi.AMap.Map.Options], 
    typings.amapJsApi.AMap.Map
  ] = js.native
  val Marker: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.Marker.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val MassMarks: Instantiable2[
    ...
    typings.amapJsApi.AMap.MassMarks[Data]
  ] = js.native
  val MediaLayer: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.MediaLayer.Options], 
    typings.amapJsApi.AMap.MediaLayer[HTMLElement]
  ] = js.native
  val Overlay: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.Overlay.Options[js.Any]], 
  ...
  val PathOverlay: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.PathOverlay.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val Polygon: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.Polygon.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val Rectangle: Instantiable1[
    js.UndefOr[
      /* options */ typings.amapJsApi.AMap.Rectangle.Options[/* import warning: RewrittenClass.unapply cls was tparam ExtraData */ js.Any]
    ], 
  ...
  val Text: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.Text.Options], 
    typings.amapJsApi.AMap.Text[js.Object]
  ] = js.native
  val TileLayer: TypeofTileLayer with (Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.TileLayer.Options], 
  ...
  val View2D: Instantiable1[
    js.UndefOr[/* options */ typings.amapJsApi.AMap.View2D.Options], 
