...
trait EventMap[I]
  ...
  var setCenter: Event_[typings.amapJsApi.amapJsApiStrings.setCenter, js.UndefOr[scala.Nothing]]
  var setPath: Event_[typings.amapJsApi.amapJsApiStrings.setPath, js.UndefOr[scala.Nothing]]
}
