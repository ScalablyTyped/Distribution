...
import typings.amapJsApi.LngLatcontrolPointsArrayLngLat
import typings.amapJsApi.PartialOptionsExtraData
...
class Polyline_[ExtraData] () extends PathOverlay[ExtraData] {
  ...
  /**
    ...
    * @param options 属性
    */
  def setOptions(options: typings.amapJsApi.AMap.Polyline.Options[ExtraData] | PartialOptionsExtraData[ExtraData]): Unit = js.native
  /**
    * 设置组成该折线的节点数组
    * @param path 节点数组
    */
