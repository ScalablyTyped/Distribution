...
object TileLayer {
  ...
  object Flexible {
    ...
    object Options {
      ...
      inline def apply(): typings.amapJsApi.AMap.TileLayer.Flexible.Options = {
  ...
  object Traffic {
    ...
    object Options {
      ...
      inline def apply(): typings.amapJsApi.AMap.TileLayer.Traffic.Options = {
        val __obj = js.Dynamic.literal()
  ...
  object WMS {
    ...
    object Options {
      ...
      inline def apply(params: Params, url: String): typings.amapJsApi.AMap.TileLayer.WMS.Options = {
  ...
  object WMTS {
    ...
    object Options {
      ...
      inline def apply(params: typings.amapJsApi.AMap.TileLayer.WMTS.Params, url: String): typings.amapJsApi.AMap.TileLayer.WMTS.Options = {
        val __obj = js.Dynamic.literal(params = params.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      ...
      implicit open class MutableBuilder[Self <: typings.amapJsApi.AMap.TileLayer.WMTS.Options] (val x: Self) extends AnyVal {
        ...
        inline def setParams(value: typings.amapJsApi.AMap.TileLayer.WMTS.Params): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    ...
    object Params {
      ...
      inline def apply(): typings.amapJsApi.AMap.TileLayer.WMTS.Params = {
        val __obj = js.Dynamic.literal()
