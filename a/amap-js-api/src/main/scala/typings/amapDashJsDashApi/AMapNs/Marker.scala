...
import typings.amapDashJsDashApi.AMapNs.MarkerNs.Options
import typings.amapDashJsDashApi.Anon_Name
...
/**
  ...
  * @param options 选项
  */
class Marker[ExtraData] () extends Overlay[ExtraData] {
  ...
  def markOnAMAP(obj: Anon_Name): Unit = js.native
  /**
    * 以指定的速度，点标记沿指定的路径移动
    * @param path 移动轨迹
    * @param speed 速度
