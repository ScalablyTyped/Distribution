...
trait EventMap[I]
  extends typings.amapDashJsDashApi.AMapNs.OverlayNs.EventMap[I] {
  var change: Event[typings.amapDashJsDashApi.amapDashJsDashApiStrings.change, Anon_TargetI[I]]
  var hide: Event[typings.amapDashJsDashApi.amapDashJsDashApiStrings.hide, Anon_TargetI[I]]
  var options: Event[
    typings.amapDashJsDashApi.amapDashJsDashApiStrings.options, 
    js.UndefOr[scala.Nothing]
  ]
  var show: Event[typings.amapDashJsDashApi.amapDashJsDashApiStrings.show, Anon_TargetI[I]]
}
...
object EventMap {
  ...
  def apply[I](
    ...
    val __obj = js.Dynamic.literal(change = change, click = click, dblclick = dblclick, hide = hide, mousedown = mousedown, mousemove = mousemove, mouseover = mouseover, mouseup = mouseup, options = options, rightclick = rightclick, show = show, touchend = touchend, touchmove = touchmove, touchstart = touchstart)
