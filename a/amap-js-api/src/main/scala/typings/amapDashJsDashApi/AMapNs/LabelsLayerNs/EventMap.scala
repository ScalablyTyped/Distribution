...
object EventMap {
  ...
  def apply[I](
    ...
    val __obj = js.Dynamic.literal(click = click, mousedown = mousedown, mousemove = mousemove, mouseout = mouseout, mouseover = mouseover, mouseup = mouseup, touchend = touchend, touchstart = touchstart)
