...
import typings.amapDashJsDashApi.amapDashJsDashApiStrings.other
...
object BrowserNs extends js.Object {
  ...
  /**
    ...
    */
  val plat: typings.amapDashJsDashApi.amapDashJsDashApiStrings.android | typings.amapDashJsDashApi.amapDashJsDashApiStrings.ios | typings.amapDashJsDashApi.amapDashJsDashApiStrings.windows | typings.amapDashJsDashApi.amapDashJsDashApiStrings.mac | other = js.native
  /**
    * 是否pointer设备
    */
