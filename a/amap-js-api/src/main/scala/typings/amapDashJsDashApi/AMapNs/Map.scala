...
import typings.amapDashJsDashApi.AMapNs.MapNs.Feature
import typings.amapDashJsDashApi.AMapNs.MapNs.Options
import typings.amapDashJsDashApi.AMapNs.MapNs.Status
...
@JSGlobal("AMap.Map")
@js.native
class Map protected () extends EventEmitter {
  /**
    * 构造一个地图对象
