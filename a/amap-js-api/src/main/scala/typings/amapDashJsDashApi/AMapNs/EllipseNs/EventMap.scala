package typings.amapDashJsDashApi.AMapNs.EllipseNs
...
import typings.amapDashJsDashApi.amapDashJsDashApiStrings.setPath
...
trait EventMap[I]
  extends typings.amapDashJsDashApi.AMapNs.ShapeOverlayNs.EventMap[I] {
  var setCenter: Event[
    typings.amapDashJsDashApi.amapDashJsDashApiStrings.setCenter, 
    js.UndefOr[scala.Nothing]
  ]
  var setPath: Event[
    typings.amapDashJsDashApi.amapDashJsDashApiStrings.setPath, 
    js.UndefOr[scala.Nothing]
  ]
}
...
object EventMap {
  ...
  def apply[I](
    ...
    setPath: Event[setPath, js.UndefOr[scala.Nothing]],
    show: Event[show, Anon_TargetI[I]],
    touchend: MapsEvent[touchend, I],
    touchmove: MapsEvent[touchmove, I],
    touchstart: MapsEvent[touchstart, I]
  ): EventMap[I] = {
    val __obj = js.Dynamic.literal(change = change, click = click, dblclick = dblclick, hide = hide, mousedown = mousedown, mousemove = mousemove, mouseover = mouseover, mouseup = mouseup, options = options, rightclick = rightclick, setCenter = setCenter, setPath = setPath, show = show, touchend = touchend, touchmove = touchmove, touchstart = touchstart)
