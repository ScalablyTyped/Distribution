...
import typings.amapDashJsDashApi.AMapNs.MediaLayerNs.Options
import typings.amapDashJsDashApi.PartialOptions
...
/**
  * @param options 图层选项
  */
abstract class MediaLayer[E /* <: HTMLElement */] () extends Layer {
