...
import typings.amapDashJsDashApi.AMapNs.TileLayerNs.WMTSNs.Params
...
@js.native
class WMTS protected () extends Flexible {
  /**
    * WMTS图层
    * @param options 图层选项
    */
  def this(options: typings.amapDashJsDashApi.AMapNs.TileLayerNs.WMTSNs.Options) = this()
  /**
