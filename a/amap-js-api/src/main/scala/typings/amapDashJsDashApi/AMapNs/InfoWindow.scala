...
import typings.amapDashJsDashApi.AMapNs.InfoWindowNs.Anchor
import typings.amapDashJsDashApi.AMapNs.InfoWindowNs.Options
...
/**
  ...
  * @param options 选项
  */
class InfoWindow[ExtraData] () extends Overlay[ExtraData] {
