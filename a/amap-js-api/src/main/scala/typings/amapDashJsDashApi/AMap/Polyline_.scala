...
class Polyline_[ExtraData] () extends PathOverlay[ExtraData] {
  ...
  def this(options: typings.amapDashJsDashApi.AMap.Polyline.Options[ExtraData]) = this()
  /**
    * 获取折线的总长度（单位：米）
    */
  ...
  /**
    ...
    */
  def setOptions(
    options: typings.amapDashJsDashApi.AMap.Polyline.Options[ExtraData] | PartialOptionsExtraData[ExtraData]
  ): Unit = js.native
  /**
    * 设置组成该折线的节点数组
    * @param path 节点数组
