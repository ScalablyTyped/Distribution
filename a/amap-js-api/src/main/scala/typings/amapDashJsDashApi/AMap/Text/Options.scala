package typings.amapDashJsDashApi.AMap.Text
...
import typings.amapDashJsDashApi.AMap.Marker.Anchor
import typings.amapDashJsDashApi.AMap.Marker.Label
...
trait Options
  extends typings.amapDashJsDashApi.AMap.Marker.Options[js.Any] {
  /**
    * 文本内容
    */
