...
object srcJsonMod {
  ...
  @JSImport("@angular-devkit/core/src/json", JSImport.Namespace)
  @js.native
  ...
  object schema {
    ...
    @JSImport("@angular-devkit/core/src/json", "schema")
    @js.native
    val ^ : js.Any = js.native
    ...
    open class CoreSchemaRegistry ()
      extends typings.angularDevkitCore.srcJsonSchemaMod.CoreSchemaRegistry {
    ...
    open class SchemaValidationException ()
      extends typings.angularDevkitCore.srcJsonSchemaMod.SchemaValidationException {
