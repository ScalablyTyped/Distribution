...
import typings.angularDevkitCore.apiMod.EventOptions
import typings.angularDevkitCore.apiMod.PageviewOptions
import typings.angularDevkitCore.apiMod.ScreenviewOptions
import typings.angularDevkitCore.apiMod.TimingOptions
import typings.angularDevkitCore.forwarderMod.AnalyticsReportKind.Event
import typings.angularDevkitCore.forwarderMod.AnalyticsReportKind.Pageview
import typings.angularDevkitCore.forwarderMod.AnalyticsReportKind.Screenview
import typings.angularDevkitCore.forwarderMod.AnalyticsReportKind.Timing
...
object forwarderMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularDevkitCore.forwarderMod.AnalyticsReportEvent
    - typings.angularDevkitCore.forwarderMod.AnalyticsReportScreenview
    - typings.angularDevkitCore.forwarderMod.AnalyticsReportPageview
    - typings.angularDevkitCore.forwarderMod.AnalyticsReportTiming
  */
  trait AnalyticsReport extends StObject
  object AnalyticsReport {
    
    inline def AnalyticsReportEvent(action: String, category: String, kind: Event, options: JsonObject & EventOptions): typings.angularDevkitCore.forwarderMod.AnalyticsReportEvent = {
      ...
      __obj.asInstanceOf[typings.angularDevkitCore.forwarderMod.AnalyticsReportEvent]
    }
    
    inline def AnalyticsReportPageview(kind: Pageview, options: JsonObject & PageviewOptions, path: String): typings.angularDevkitCore.forwarderMod.AnalyticsReportPageview = {
      ...
      __obj.asInstanceOf[typings.angularDevkitCore.forwarderMod.AnalyticsReportPageview]
    }
    
    inline def AnalyticsReportScreenview(appName: String, kind: Screenview, options: JsonObject & ScreenviewOptions, screenName: String): typings.angularDevkitCore.forwarderMod.AnalyticsReportScreenview = {
      ...
      __obj.asInstanceOf[typings.angularDevkitCore.forwarderMod.AnalyticsReportScreenview]
    }
    ...
    inline def AnalyticsReportTiming(
      ...
      __obj.asInstanceOf[typings.angularDevkitCore.forwarderMod.AnalyticsReportTiming]
    }
  }
