...
object experimentalMod {
  ...
  object jobs {
    ...
    open class ChannelAlreadyExistException protected ()
      extends typings.angularDevkitCore.jobsMod.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitCore.jobsMod.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typings.angularDevkitCore.jobsMod.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typings.angularDevkitCore.jobsMod.JobDoesNotExistException {
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typings.angularDevkitCore.jobsMod.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typings.angularDevkitCore.jobsMod.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    ...
    open class JobOutputSchemaValidationError ()
      extends typings.angularDevkitCore.jobsMod.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitCore.jobsMod.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typings.angularDevkitCore.jobsMod.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
