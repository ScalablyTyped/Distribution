...
object loggerMod {
  ...
  open class IndentLogger protected ()
    extends typings.angularDevkitCore.indentMod.IndentLogger {
  ...
  open class LevelCapLogger protected ()
    extends typings.angularDevkitCore.levelMod.LevelCapLogger {
  ...
  open class LevelTransformLogger protected ()
    extends typings.angularDevkitCore.levelMod.LevelTransformLogger {
  ...
  open class Logger protected ()
    extends typings.angularDevkitCore.loggerLoggerMod.Logger {
    def this(name: String) = this()
    def this(name: String, parent: typings.angularDevkitCore.loggerLoggerMod.Logger) = this()
  }
  ...
  open class NullLogger ()
    extends typings.angularDevkitCore.nullLoggerMod.NullLogger {
  ...
  open class TransformLogger protected ()
    extends typings.angularDevkitCore.transformLoggerMod.TransformLogger {
    def this(
      name: String,
