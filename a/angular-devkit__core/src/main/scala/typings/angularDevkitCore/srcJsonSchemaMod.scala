...
object srcJsonSchemaMod {
  ...
  open class CoreSchemaRegistry ()
    extends typings.angularDevkitCore.srcJsonSchemaRegistryMod.CoreSchemaRegistry {
  ...
  open class SchemaValidationException ()
    extends typings.angularDevkitCore.srcJsonSchemaRegistryMod.SchemaValidationException {
