...
object srcExperimentalMod {
  
  object jobs {
    
    @JSImport("@angular-devkit/core/src/experimental", "jobs")
    @js.native
    ...
    open class ChannelAlreadyExistException protected ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.JobDoesNotExistException {
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    ...
    open class JobOutputSchemaValidationError ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typings.angularDevkitCore.srcExperimentalJobsMod.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
