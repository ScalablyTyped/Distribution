...
trait AnonBodyCommentsIdImplements extends js.Object {
...
object AnonBodyCommentsIdImplements {
  @scala.inline
  def apply(
    body: ClassBodyKind,
    ...
    __obj.asInstanceOf[AnonBodyCommentsIdImplements]
  }
}
