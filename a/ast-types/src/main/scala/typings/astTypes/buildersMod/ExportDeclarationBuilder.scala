...
trait ExportDeclarationBuilder extends StObject {
  ...
  def apply(defaultParam: Boolean, declaration: Null, specifiers: Unit, source: LiteralKind): ExportDeclaration = js.native
  ...
  def apply(defaultParam: Boolean, declaration: DeclarationKind, specifiers: Unit, source: LiteralKind): ExportDeclaration = js.native
  ...
  def apply(defaultParam: Boolean, declaration: ExpressionKind, specifiers: Unit, source: LiteralKind): ExportDeclaration = js.native
