...
trait TypeParameterBuilder extends StObject {
  ...
  def apply(name: String, variance: Null, bound: Unit, defaultParam: FlowTypeKind): TypeParameter = js.native
  ...
  def apply(name: String, variance: Unit, bound: Null, defaultParam: FlowTypeKind): TypeParameter = js.native
  def apply(name: String, variance: Unit, bound: Unit, defaultParam: FlowTypeKind): TypeParameter = js.native
  def apply(name: String, variance: Unit, bound: TypeAnnotationKind): TypeParameter = js.native
  def apply(name: String, variance: Unit, bound: TypeAnnotationKind, defaultParam: FlowTypeKind): TypeParameter = js.native
  ...
  def apply(name: String, variance: minus, bound: Unit, defaultParam: FlowTypeKind): TypeParameter = js.native
  ...
  def apply(name: String, variance: plus, bound: Unit, defaultParam: FlowTypeKind): TypeParameter = js.native
  ...
  def apply(name: String, variance: VarianceKind, bound: Unit, defaultParam: FlowTypeKind): TypeParameter = js.native
