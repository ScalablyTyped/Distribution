...
trait OptionalMemberExpressionBuilder extends StObject {
  ...
  def apply(`object`: ExpressionKind, property: ExpressionKind, computed: Unit, optional: Boolean): OptionalMemberExpression = js.native
  ...
  def apply(`object`: ExpressionKind, property: IdentifierKind, computed: Unit, optional: Boolean): OptionalMemberExpression = js.native
