...
trait JSXOpeningElementBuilder extends StObject {
  ...
  def apply(name: JSXIdentifierKind, attributes: Unit, selfClosing: Boolean): JSXOpeningElement = js.native
  ...
  def apply(name: JSXMemberExpressionKind, attributes: Unit, selfClosing: Boolean): JSXOpeningElement = js.native
  ...
  def apply(name: JSXNamespacedNameKind, attributes: Unit, selfClosing: Boolean): JSXOpeningElement = js.native
