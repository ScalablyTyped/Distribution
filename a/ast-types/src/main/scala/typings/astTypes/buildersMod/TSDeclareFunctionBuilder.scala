...
trait TSDeclareFunctionBuilder extends StObject {
  ...
  def apply(id: Unit, params: js.Array[PatternKind]): TSDeclareFunction = js.native
  def apply(id: Unit, params: js.Array[PatternKind], returnType: NoopKind): TSDeclareFunction = js.native
  def apply(id: Unit, params: js.Array[PatternKind], returnType: TSTypeAnnotationKind): TSDeclareFunction = js.native
