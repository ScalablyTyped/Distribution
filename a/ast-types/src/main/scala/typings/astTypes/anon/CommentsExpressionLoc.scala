...
object CommentsExpressionLoc {
  ...
  @scala.inline
  implicit class CommentsExpressionLocOps[Self <: CommentsExpressionLoc] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTypeAnnotation(value: TypeAnnotationKind): Self = this.set("typeAnnotation", value.asInstanceOf[js.Any])
