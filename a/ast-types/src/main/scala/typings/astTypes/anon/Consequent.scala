...
object Consequent {
  ...
  @scala.inline
  implicit class ConsequentOps[Self <: Consequent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setConsequentVarargs(value: StatementKind*): Self = this.set("consequent", js.Array(value :_*))
    
    @scala.inline
    def setConsequent(value: js.Array[StatementKind]): Self = this.set("consequent", value.asInstanceOf[js.Any])
