...
@js.native
trait LocTypeAnnotation extends js.Object {
...
object LocTypeAnnotation {
  ...
  @scala.inline
  def apply(typeAnnotation: FlowTypeKind): LocTypeAnnotation = {
    val __obj = js.Dynamic.literal(typeAnnotation = typeAnnotation.asInstanceOf[js.Any])
    __obj.asInstanceOf[LocTypeAnnotation]
  }
  
  @scala.inline
  implicit class LocTypeAnnotationOps[Self <: LocTypeAnnotation] (val x: Self) extends AnyVal {
