...
object Generator {
  ...
  implicit class GeneratorOps[Self <: Generator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setBody(value: BlockStatementKind | ExpressionKind): Self = this.set("body", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGenerator(value: `false`): Self = this.set("generator", value.asInstanceOf[js.Any])
