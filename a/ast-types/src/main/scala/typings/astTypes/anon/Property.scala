...
object Property {
  ...
  implicit class PropertyOps[Self <: Property] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setObject(value: JSXIdentifierKind | JSXMemberExpressionKind): Self = this.set("object", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProperty(value: JSXIdentifierKind): Self = this.set("property", value.asInstanceOf[js.Any])
