...
object LocTypeParameters {
  ...
  inline def apply(expression: IdentifierKind | TSQualifiedNameKind): LocTypeParameters = {
    val __obj = js.Dynamic.literal(expression = expression.asInstanceOf[js.Any])
    __obj.asInstanceOf[LocTypeParameters]
  }
  
  extension [Self <: LocTypeParameters](x: Self) {
    ...
    inline def setExpression(value: IdentifierKind | TSQualifiedNameKind): Self = StObject.set(x, "expression", value.asInstanceOf[js.Any])
