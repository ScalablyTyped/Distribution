...
object Quasi {
  ...
  @scala.inline
  implicit class QuasiOps[Self <: Quasi] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setQuasi(value: TemplateLiteralKind): Self = this.set("quasi", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setTag(value: ExpressionKind): Self = this.set("tag", value.asInstanceOf[js.Any])
