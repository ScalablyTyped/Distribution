...
object ExpressionExtra {
  ...
  @scala.inline
  implicit class ExpressionExtraOps[Self <: ExpressionExtra] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExtra(value: Parenthesized): Self = this.set("extra", value.asInstanceOf[js.Any])
