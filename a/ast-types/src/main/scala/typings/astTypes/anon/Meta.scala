...
object Meta {
  ...
  implicit class MetaOps[Self <: Meta] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMeta(value: IdentifierKind): Self = this.set("meta", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setProperty(value: IdentifierKind): Self = this.set("property", value.asInstanceOf[js.Any])
