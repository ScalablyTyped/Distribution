...
trait TSCallSignatureDeclaration
  ...
  var `type`: typings.astTypes.astTypesStrings.TSCallSignatureDeclaration = js.native
...
object TSCallSignatureDeclaration {
  ...
  implicit class TSCallSignatureDeclarationMutableBuilder[Self <: TSCallSignatureDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSCallSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
