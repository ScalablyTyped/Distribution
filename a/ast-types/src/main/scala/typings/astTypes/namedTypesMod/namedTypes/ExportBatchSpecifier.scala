...
object ExportBatchSpecifier {
  ...
  extension [Self <: ExportBatchSpecifier](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ExportBatchSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
