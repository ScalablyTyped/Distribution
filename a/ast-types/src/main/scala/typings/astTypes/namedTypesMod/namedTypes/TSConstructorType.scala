...
trait TSConstructorType
  ...
  var `type`: typings.astTypes.astTypesStrings.TSConstructorType = js.native
...
object TSConstructorType {
  ...
  implicit class TSConstructorTypeMutableBuilder[Self <: TSConstructorType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSConstructorType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
