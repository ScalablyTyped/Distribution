...
object ForAwaitStatement {
  ...
  extension [Self <: ForAwaitStatement](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ForAwaitStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
