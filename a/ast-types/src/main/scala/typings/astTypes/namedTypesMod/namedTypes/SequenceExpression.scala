...
trait SequenceExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.SequenceExpression = js.native
}
object SequenceExpression {
  ...
  implicit class SequenceExpressionMutableBuilder[Self <: SequenceExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.SequenceExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
