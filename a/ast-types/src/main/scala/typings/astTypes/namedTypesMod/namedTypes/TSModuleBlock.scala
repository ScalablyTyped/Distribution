...
trait TSModuleBlock
  ...
  var `type`: typings.astTypes.astTypesStrings.TSModuleBlock = js.native
}
object TSModuleBlock {
  ...
  implicit class TSModuleBlockMutableBuilder[Self <: TSModuleBlock] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSModuleBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
