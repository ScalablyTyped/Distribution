...
trait TSExternalModuleReference
  ...
  var `type`: typings.astTypes.astTypesStrings.TSExternalModuleReference = js.native
}
object TSExternalModuleReference {
  ...
  implicit class TSExternalModuleReferenceMutableBuilder[Self <: TSExternalModuleReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSExternalModuleReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
