...
trait TSParenthesizedType
  ...
  var `type`: typings.astTypes.astTypesStrings.TSParenthesizedType = js.native
...
object TSParenthesizedType {
  ...
  implicit class TSParenthesizedTypeMutableBuilder[Self <: TSParenthesizedType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSParenthesizedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
