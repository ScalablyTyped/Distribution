...
trait TSMethodSignature
  ...
  var `type`: typings.astTypes.astTypesStrings.TSMethodSignature = js.native
...
object TSMethodSignature {
  ...
  implicit class TSMethodSignatureMutableBuilder[Self <: TSMethodSignature] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSMethodSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
