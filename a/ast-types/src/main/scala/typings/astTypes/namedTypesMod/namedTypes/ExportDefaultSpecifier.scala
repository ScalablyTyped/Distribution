...
trait ExportDefaultSpecifier
  ...
  var `type`: typings.astTypes.astTypesStrings.ExportDefaultSpecifier = js.native
}
object ExportDefaultSpecifier {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.ExportDefaultSpecifier")
  @js.native
  val ^ : Type[ExportDefaultSpecifier] = js.native
  
  @scala.inline
  implicit class ExportDefaultSpecifierMutableBuilder[Self <: ExportDefaultSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ExportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
