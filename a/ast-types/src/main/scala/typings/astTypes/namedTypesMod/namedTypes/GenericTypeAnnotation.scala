...
object GenericTypeAnnotation {
  ...
  extension [Self <: GenericTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.GenericTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
