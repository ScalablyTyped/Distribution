...
trait ExistentialTypeParam
  ...
  var `type`: typings.astTypes.astTypesStrings.ExistentialTypeParam = js.native
}
object ExistentialTypeParam {
  ...
  implicit class ExistentialTypeParamMutableBuilder[Self <: ExistentialTypeParam] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ExistentialTypeParam): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
