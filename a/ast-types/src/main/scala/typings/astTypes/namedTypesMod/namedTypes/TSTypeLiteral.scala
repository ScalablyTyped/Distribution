...
trait TSTypeLiteral
  ...
  var `type`: typings.astTypes.astTypesStrings.TSTypeLiteral = js.native
}
object TSTypeLiteral {
  ...
  implicit class TSTypeLiteralMutableBuilder[Self <: TSTypeLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSTypeLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
