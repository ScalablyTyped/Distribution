...
object InterfaceExtends {
  ...
  extension [Self <: InterfaceExtends](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.InterfaceExtends): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
