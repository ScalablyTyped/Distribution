...
trait InterfaceExtends
  ...
  var `type`: typings.astTypes.astTypesStrings.InterfaceExtends = js.native
...
object InterfaceExtends {
  ...
  @js.native
  val ^ : Type[InterfaceExtends] = js.native
  
  @scala.inline
  implicit class InterfaceExtendsMutableBuilder[Self <: InterfaceExtends] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.InterfaceExtends): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
