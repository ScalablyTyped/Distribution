...
trait ArrayPattern
  ...
  var `type`: typings.astTypes.astTypesStrings.ArrayPattern = js.native
}
object ArrayPattern {
  ...
  implicit class ArrayPatternMutableBuilder[Self <: ArrayPattern] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ArrayPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
