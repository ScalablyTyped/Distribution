...
object DeclareModule {
  ...
  @js.native
  val ^ : Type[DeclareModule] = js.native
  ...
  extension [Self <: DeclareModule](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.DeclareModule): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
