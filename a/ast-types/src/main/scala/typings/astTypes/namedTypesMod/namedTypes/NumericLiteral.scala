...
import typings.astTypes.anon.RawRawValue
...
trait NumericLiteral
  ...
  var `type`: typings.astTypes.astTypesStrings.NumericLiteral = js.native
...
object NumericLiteral {
  ...
  implicit class NumericLiteralMutableBuilder[Self <: NumericLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.NumericLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
