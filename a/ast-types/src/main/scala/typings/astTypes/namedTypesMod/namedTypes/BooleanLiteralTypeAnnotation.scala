...
object BooleanLiteralTypeAnnotation {
  ...
  extension [Self <: BooleanLiteralTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.BooleanLiteralTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
