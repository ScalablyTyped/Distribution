...
trait ExportSpecifier
  ...
  var `type`: typings.astTypes.astTypesStrings.ExportSpecifier = js.native
}
object ExportSpecifier {
  ...
  implicit class ExportSpecifierMutableBuilder[Self <: ExportSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ExportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
