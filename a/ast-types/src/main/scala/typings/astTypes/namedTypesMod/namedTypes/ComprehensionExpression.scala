...
object ComprehensionExpression {
  ...
  extension [Self <: ComprehensionExpression](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ComprehensionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
