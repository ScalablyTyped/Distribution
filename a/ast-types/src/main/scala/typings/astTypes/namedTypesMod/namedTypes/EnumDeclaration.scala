...
trait EnumDeclaration
  ...
  var `type`: typings.astTypes.astTypesStrings.EnumDeclaration
}
object EnumDeclaration {
  ...
  extension [Self <: EnumDeclaration](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.EnumDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
