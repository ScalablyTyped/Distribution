...
trait ExpressionStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.ExpressionStatement = js.native
}
object ExpressionStatement {
  ...
  implicit class ExpressionStatementMutableBuilder[Self <: ExpressionStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ExpressionStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
