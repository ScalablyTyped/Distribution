...
trait ChainExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.ChainExpression = js.native
}
object ChainExpression {
  ...
  implicit class ChainExpressionMutableBuilder[Self <: ChainExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ChainExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
