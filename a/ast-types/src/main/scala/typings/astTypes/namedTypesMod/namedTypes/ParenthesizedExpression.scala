...
trait ParenthesizedExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.ParenthesizedExpression = js.native
}
object ParenthesizedExpression {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.ParenthesizedExpression")
  @js.native
  val ^ : Type[ParenthesizedExpression] = js.native
  ...
  implicit class ParenthesizedExpressionMutableBuilder[Self <: ParenthesizedExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ParenthesizedExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
