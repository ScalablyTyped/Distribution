...
object TupleTypeAnnotation {
  ...
  extension [Self <: TupleTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.TupleTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
