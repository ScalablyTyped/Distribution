...
trait TSNonNullExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.TSNonNullExpression = js.native
}
object TSNonNullExpression {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.TSNonNullExpression")
  @js.native
  val ^ : Type[TSNonNullExpression] = js.native
  ...
  implicit class TSNonNullExpressionMutableBuilder[Self <: TSNonNullExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSNonNullExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
