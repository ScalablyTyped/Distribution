...
trait Variance
  ...
  var `type`: typings.astTypes.astTypesStrings.Variance = js.native
}
object Variance {
  ...
  implicit class VarianceMutableBuilder[Self <: Variance] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.Variance): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
