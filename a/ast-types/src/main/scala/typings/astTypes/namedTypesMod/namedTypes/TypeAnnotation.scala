...
trait TypeAnnotation
  ...
  var `type`: typings.astTypes.astTypesStrings.TypeAnnotation = js.native
...
object TypeAnnotation {
  ...
  @js.native
  val ^ : Type[TypeAnnotation] = js.native
  ...
  implicit class TypeAnnotationMutableBuilder[Self <: TypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
