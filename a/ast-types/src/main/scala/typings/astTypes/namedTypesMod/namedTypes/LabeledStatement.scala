...
trait LabeledStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.LabeledStatement = js.native
}
object LabeledStatement {
  ...
  implicit class LabeledStatementMutableBuilder[Self <: LabeledStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.LabeledStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
