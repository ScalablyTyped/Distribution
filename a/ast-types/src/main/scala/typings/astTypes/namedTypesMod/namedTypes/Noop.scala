...
trait Noop
  ...
  var `type`: typings.astTypes.astTypesStrings.Noop = js.native
}
object Noop {
  ...
  implicit class NoopMutableBuilder[Self <: Noop] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.Noop): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
