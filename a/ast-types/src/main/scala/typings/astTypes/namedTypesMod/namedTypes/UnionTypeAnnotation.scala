...
object UnionTypeAnnotation {
  ...
  extension [Self <: UnionTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.UnionTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
