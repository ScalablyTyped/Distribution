...
trait UnionTypeAnnotation
  ...
  var `type`: typings.astTypes.astTypesStrings.UnionTypeAnnotation = js.native
...
object UnionTypeAnnotation {
  ...
  @js.native
  val ^ : Type[UnionTypeAnnotation] = js.native
  
  @scala.inline
  implicit class UnionTypeAnnotationMutableBuilder[Self <: UnionTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.UnionTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
