...
object ExportNamespaceSpecifier {
  ...
  @js.native
  val ^ : Type[ExportNamespaceSpecifier] = js.native
  
  @scala.inline
  implicit class ExportNamespaceSpecifierMutableBuilder[Self <: ExportNamespaceSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ExportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
