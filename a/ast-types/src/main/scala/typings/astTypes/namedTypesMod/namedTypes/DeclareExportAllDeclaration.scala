...
object DeclareExportAllDeclaration {
  ...
  extension [Self <: DeclareExportAllDeclaration](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.DeclareExportAllDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
