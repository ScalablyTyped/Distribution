...
object GeneratorExpression {
  ...
  extension [Self <: GeneratorExpression](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.GeneratorExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
