...
trait TSIntersectionType
  ...
  var `type`: typings.astTypes.astTypesStrings.TSIntersectionType
...
object TSIntersectionType {
  ...
  extension [Self <: TSIntersectionType](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.TSIntersectionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
