...
trait DeclareClass
  ...
  var `type`: typings.astTypes.astTypesStrings.DeclareClass = js.native
...
object DeclareClass {
  ...
  @js.native
  val ^ : Type[DeclareClass] = js.native
  ...
  implicit class DeclareClassMutableBuilder[Self <: DeclareClass] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.DeclareClass): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
