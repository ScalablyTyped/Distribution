...
trait DebuggerStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.DebuggerStatement = js.native
}
object DebuggerStatement {
  ...
  implicit class DebuggerStatementMutableBuilder[Self <: DebuggerStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.DebuggerStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
