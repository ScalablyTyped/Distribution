...
trait NullLiteral
  ...
  var `type`: typings.astTypes.astTypesStrings.NullLiteral = js.native
...
object NullLiteral {
  ...
  @js.native
  val ^ : Type[NullLiteral] = js.native
  ...
  implicit class NullLiteralMutableBuilder[Self <: NullLiteral] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.NullLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
