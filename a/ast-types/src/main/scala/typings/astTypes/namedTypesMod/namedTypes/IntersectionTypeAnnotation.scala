...
object IntersectionTypeAnnotation {
  ...
  extension [Self <: IntersectionTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.IntersectionTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
