...
trait IntersectionTypeAnnotation
  ...
  var `type`: typings.astTypes.astTypesStrings.IntersectionTypeAnnotation = js.native
...
object IntersectionTypeAnnotation {
  ...
  @js.native
  val ^ : Type[IntersectionTypeAnnotation] = js.native
  
  @scala.inline
  implicit class IntersectionTypeAnnotationMutableBuilder[Self <: IntersectionTypeAnnotation] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.IntersectionTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
