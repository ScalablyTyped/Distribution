...
object DeclaredPredicate {
  ...
  extension [Self <: DeclaredPredicate](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.DeclaredPredicate): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
