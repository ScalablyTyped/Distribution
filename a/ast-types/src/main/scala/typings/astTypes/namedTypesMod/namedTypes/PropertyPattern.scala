...
object PropertyPattern {
  ...
  extension [Self <: PropertyPattern](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.PropertyPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
