...
object NumberLiteralTypeAnnotation {
  ...
  extension [Self <: NumberLiteralTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.NumberLiteralTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
