...
trait TSConstructSignatureDeclaration
  ...
  var `type`: typings.astTypes.astTypesStrings.TSConstructSignatureDeclaration = js.native
...
object TSConstructSignatureDeclaration {
  ...
  implicit class TSConstructSignatureDeclarationMutableBuilder[Self <: TSConstructSignatureDeclaration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSConstructSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
