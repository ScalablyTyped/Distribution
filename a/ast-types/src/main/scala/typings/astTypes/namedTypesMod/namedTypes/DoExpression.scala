...
trait DoExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.DoExpression = js.native
}
object DoExpression {
  ...
  implicit class DoExpressionMutableBuilder[Self <: DoExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.DoExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
