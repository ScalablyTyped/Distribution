...
object VoidTypeAnnotation {
  ...
  extension [Self <: VoidTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.VoidTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
