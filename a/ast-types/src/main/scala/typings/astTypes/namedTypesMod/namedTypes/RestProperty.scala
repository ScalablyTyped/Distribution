...
object RestProperty {
  ...
  extension [Self <: RestProperty](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.RestProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
