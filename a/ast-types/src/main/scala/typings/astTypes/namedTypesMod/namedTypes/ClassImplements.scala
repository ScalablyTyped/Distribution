...
object ClassImplements {
  ...
  extension [Self <: ClassImplements](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ClassImplements): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
