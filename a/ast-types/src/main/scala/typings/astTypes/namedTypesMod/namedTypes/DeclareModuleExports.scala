...
object DeclareModuleExports {
  ...
  extension [Self <: DeclareModuleExports](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.DeclareModuleExports): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
