...
trait FunctionExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.FunctionExpression = js.native
...
object FunctionExpression {
  ...
  @js.native
  val ^ : Type[FunctionExpression] = js.native
  ...
  implicit class FunctionExpressionMutableBuilder[Self <: FunctionExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.FunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
