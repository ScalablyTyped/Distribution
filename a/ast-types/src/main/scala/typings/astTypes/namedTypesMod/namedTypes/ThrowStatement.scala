...
trait ThrowStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.ThrowStatement = js.native
}
object ThrowStatement {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.ThrowStatement")
  @js.native
  val ^ : Type[ThrowStatement] = js.native
  ...
  implicit class ThrowStatementMutableBuilder[Self <: ThrowStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ThrowStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
