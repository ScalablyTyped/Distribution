...
object TSNamedTupleMember {
  ...
  @scala.inline
  implicit class TSNamedTupleMemberMutableBuilder[Self <: TSNamedTupleMember] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TSNamedTupleMember): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
