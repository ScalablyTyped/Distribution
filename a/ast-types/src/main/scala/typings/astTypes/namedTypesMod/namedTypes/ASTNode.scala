...
object ASTNode {
  ...
  inline def EnumBooleanBody(explicitType: Boolean, members: js.Array[EnumBooleanMemberKind]): typings.astTypes.namedTypesMod.namedTypes.EnumBooleanBody = {
  ...
  inline def EnumBooleanMember(id: IdentifierKind, init: LiteralKind | Boolean): typings.astTypes.namedTypesMod.namedTypes.EnumBooleanMember = {
  ...
  inline def EnumDefaultedMember(id: IdentifierKind): typings.astTypes.namedTypesMod.namedTypes.EnumDefaultedMember = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
  ...
  inline def EnumNumberBody(explicitType: Boolean, members: js.Array[EnumNumberMemberKind]): typings.astTypes.namedTypesMod.namedTypes.EnumNumberBody = {
    val __obj = js.Dynamic.literal(explicitType = explicitType.asInstanceOf[js.Any], members = members.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("EnumNumberBody")
    __obj.asInstanceOf[typings.astTypes.namedTypesMod.namedTypes.EnumNumberBody]
  }
  
  inline def EnumNumberMember(id: IdentifierKind, init: LiteralKind): typings.astTypes.namedTypesMod.namedTypes.EnumNumberMember = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], init = init.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("EnumNumberMember")
    __obj.asInstanceOf[typings.astTypes.namedTypesMod.namedTypes.EnumNumberMember]
  }
  
  inline def EnumStringBody(explicitType: Boolean, members: js.Array[EnumDefaultedMemberKind | EnumStringMemberKind]): typings.astTypes.namedTypesMod.namedTypes.EnumStringBody = {
    val __obj = js.Dynamic.literal(explicitType = explicitType.asInstanceOf[js.Any], members = members.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("EnumStringBody")
    __obj.asInstanceOf[typings.astTypes.namedTypesMod.namedTypes.EnumStringBody]
  }
  
  inline def EnumStringMember(id: IdentifierKind, init: LiteralKind): typings.astTypes.namedTypesMod.namedTypes.EnumStringMember = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], init = init.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("EnumStringMember")
    __obj.asInstanceOf[typings.astTypes.namedTypesMod.namedTypes.EnumStringMember]
  }
  
  inline def EnumSymbolBody(members: js.Array[EnumDefaultedMemberKind]): typings.astTypes.namedTypesMod.namedTypes.EnumSymbolBody = {
