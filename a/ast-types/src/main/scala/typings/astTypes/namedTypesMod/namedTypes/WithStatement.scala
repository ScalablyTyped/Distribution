...
trait WithStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.WithStatement = js.native
}
object WithStatement {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.WithStatement")
  @js.native
  val ^ : Type[WithStatement] = js.native
  ...
  implicit class WithStatementMutableBuilder[Self <: WithStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.WithStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
