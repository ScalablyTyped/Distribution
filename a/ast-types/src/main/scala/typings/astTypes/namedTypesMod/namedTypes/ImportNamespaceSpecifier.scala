...
trait ImportNamespaceSpecifier
  ...
  var `type`: typings.astTypes.astTypesStrings.ImportNamespaceSpecifier = js.native
}
object ImportNamespaceSpecifier {
  ...
  implicit class ImportNamespaceSpecifierMutableBuilder[Self <: ImportNamespaceSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ImportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
