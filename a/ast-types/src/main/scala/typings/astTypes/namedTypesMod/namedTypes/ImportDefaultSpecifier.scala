...
trait ImportDefaultSpecifier
  ...
  var `type`: typings.astTypes.astTypesStrings.ImportDefaultSpecifier = js.native
}
object ImportDefaultSpecifier {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.ImportDefaultSpecifier")
  @js.native
  val ^ : Type[ImportDefaultSpecifier] = js.native
  ...
  implicit class ImportDefaultSpecifierMutableBuilder[Self <: ImportDefaultSpecifier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ImportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
