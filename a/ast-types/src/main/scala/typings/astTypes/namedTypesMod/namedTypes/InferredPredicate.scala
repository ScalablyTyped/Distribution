...
object InferredPredicate {
  ...
  extension [Self <: InferredPredicate](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.InferredPredicate): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
