...
object DeclareInterface {
  ...
  extension [Self <: DeclareInterface](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.DeclareInterface): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
