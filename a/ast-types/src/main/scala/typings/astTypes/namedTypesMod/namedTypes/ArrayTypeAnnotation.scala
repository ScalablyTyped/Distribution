...
object ArrayTypeAnnotation {
  ...
  extension [Self <: ArrayTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ArrayTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
