...
object SpreadElementPattern {
  ...
  extension [Self <: SpreadElementPattern](x: Self) {
    
    inline def setArgument(value: PatternKind): Self = StObject.set(x, "argument", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.SpreadElementPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
