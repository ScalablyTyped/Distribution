...
trait SpreadElementPattern
  ...
  var `type`: typings.astTypes.astTypesStrings.SpreadElementPattern = js.native
}
object SpreadElementPattern {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.SpreadElementPattern")
  @js.native
  val ^ : Type[SpreadElementPattern] = js.native
  
  @scala.inline
  implicit class SpreadElementPatternMutableBuilder[Self <: SpreadElementPattern] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.SpreadElementPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
