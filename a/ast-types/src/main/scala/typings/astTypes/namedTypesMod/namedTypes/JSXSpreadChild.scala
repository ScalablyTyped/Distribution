...
trait JSXSpreadChild
  ...
  var `type`: typings.astTypes.astTypesStrings.JSXSpreadChild = js.native
}
object JSXSpreadChild {
  ...
  implicit class JSXSpreadChildMutableBuilder[Self <: JSXSpreadChild] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.JSXSpreadChild): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
