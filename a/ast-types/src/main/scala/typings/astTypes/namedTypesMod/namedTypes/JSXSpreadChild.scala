...
trait JSXSpreadChild
  ...
  var `type`: typings.astTypes.astTypesStrings.JSXSpreadChild
}
object JSXSpreadChild {
  ...
  extension [Self <: JSXSpreadChild](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.JSXSpreadChild): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
