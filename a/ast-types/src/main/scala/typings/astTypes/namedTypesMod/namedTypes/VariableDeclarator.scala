...
trait VariableDeclarator
  ...
  var `type`: typings.astTypes.astTypesStrings.VariableDeclarator = js.native
}
object VariableDeclarator {
  ...
  implicit class VariableDeclaratorMutableBuilder[Self <: VariableDeclarator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.VariableDeclarator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
