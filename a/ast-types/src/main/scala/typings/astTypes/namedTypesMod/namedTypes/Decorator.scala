...
trait Decorator
  ...
  var `type`: typings.astTypes.astTypesStrings.Decorator = js.native
}
object Decorator {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.Decorator")
  @js.native
  val ^ : Type[Decorator] = js.native
  ...
  implicit class DecoratorMutableBuilder[Self <: Decorator] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.Decorator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
