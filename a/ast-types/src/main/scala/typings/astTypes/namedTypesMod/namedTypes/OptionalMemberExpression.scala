...
object OptionalMemberExpression {
  ...
  extension [Self <: OptionalMemberExpression](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.OptionalMemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
