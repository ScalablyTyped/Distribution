...
trait JSXOpeningFragment
  ...
  var `type`: typings.astTypes.astTypesStrings.JSXOpeningFragment = js.native
}
object JSXOpeningFragment {
  ...
  implicit class JSXOpeningFragmentMutableBuilder[Self <: JSXOpeningFragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.JSXOpeningFragment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
