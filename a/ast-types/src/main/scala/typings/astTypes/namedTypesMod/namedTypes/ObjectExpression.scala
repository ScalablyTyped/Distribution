...
object ObjectExpression {
  ...
  @js.native
  val ^ : Type[ObjectExpression] = js.native
  ...
  extension [Self <: ObjectExpression](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ObjectExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
