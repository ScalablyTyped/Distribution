...
trait TypeCastExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.TypeCastExpression = js.native
...
object TypeCastExpression {
  ...
  implicit class TypeCastExpressionMutableBuilder[Self <: TypeCastExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.TypeCastExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
