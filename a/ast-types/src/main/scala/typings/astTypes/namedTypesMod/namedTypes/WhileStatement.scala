...
object WhileStatement {
  ...
  @js.native
  val ^ : Type[WhileStatement] = js.native
  ...
  extension [Self <: WhileStatement](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.WhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
