...
trait ReturnStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.ReturnStatement = js.native
}
object ReturnStatement {
  ...
  implicit class ReturnStatementMutableBuilder[Self <: ReturnStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ReturnStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
