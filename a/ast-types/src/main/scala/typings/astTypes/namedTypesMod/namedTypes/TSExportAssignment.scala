...
object TSExportAssignment {
  ...
  @js.native
  val ^ : Type[TSExportAssignment] = js.native
  ...
  extension [Self <: TSExportAssignment](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.TSExportAssignment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
