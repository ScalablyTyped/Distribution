...
trait AwaitExpression
  ...
  var `type`: typings.astTypes.astTypesStrings.AwaitExpression = js.native
}
object AwaitExpression {
  ...
  implicit class AwaitExpressionMutableBuilder[Self <: AwaitExpression] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.AwaitExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
