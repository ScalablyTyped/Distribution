...
object TSTypeReference {
  ...
  extension [Self <: TSTypeReference](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.TSTypeReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    
    inline def setTypeName(value: IdentifierKind | TSQualifiedNameKind): Self = StObject.set(x, "typeName", value.asInstanceOf[js.Any])
