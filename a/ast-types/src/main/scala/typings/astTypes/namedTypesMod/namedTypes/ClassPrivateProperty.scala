...
trait ClassPrivateProperty
  ...
  var `type`: typings.astTypes.astTypesStrings.ClassPrivateProperty = js.native
...
object ClassPrivateProperty {
  ...
  implicit class ClassPrivatePropertyMutableBuilder[Self <: ClassPrivateProperty] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.ClassPrivateProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
