...
trait DoWhileStatement
  ...
  var `type`: typings.astTypes.astTypesStrings.DoWhileStatement = js.native
}
object DoWhileStatement {
  
  @JSImport("ast-types/gen/namedTypes", "namedTypes.DoWhileStatement")
  @js.native
  val ^ : Type[DoWhileStatement] = js.native
  ...
  implicit class DoWhileStatementMutableBuilder[Self <: DoWhileStatement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.DoWhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
