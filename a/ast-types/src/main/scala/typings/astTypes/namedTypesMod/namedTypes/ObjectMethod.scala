...
object ObjectMethod {
  ...
  extension [Self <: ObjectMethod](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ObjectMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
