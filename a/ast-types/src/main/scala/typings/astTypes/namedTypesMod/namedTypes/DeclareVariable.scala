...
trait DeclareVariable
  ...
  var `type`: typings.astTypes.astTypesStrings.DeclareVariable = js.native
}
object DeclareVariable {
  ...
  implicit class DeclareVariableMutableBuilder[Self <: DeclareVariable] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.DeclareVariable): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
