...
object OptionalCallExpression {
  ...
  extension [Self <: OptionalCallExpression](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.OptionalCallExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
