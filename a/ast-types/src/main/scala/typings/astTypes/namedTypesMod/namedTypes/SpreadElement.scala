...
trait SpreadElement
  ...
  var `type`: typings.astTypes.astTypesStrings.SpreadElement = js.native
}
object SpreadElement {
  ...
  implicit class SpreadElementMutableBuilder[Self <: SpreadElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.astTypes.astTypesStrings.SpreadElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
