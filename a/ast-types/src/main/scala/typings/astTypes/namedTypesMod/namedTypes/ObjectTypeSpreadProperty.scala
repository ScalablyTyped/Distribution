...
object ObjectTypeSpreadProperty {
  ...
  extension [Self <: ObjectTypeSpreadProperty](x: Self) {
    ...
    inline def setType(value: typings.astTypes.astTypesStrings.ObjectTypeSpreadProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
