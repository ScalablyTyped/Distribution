...
- Dropped {[ P in std.Exclude<keyof ast-types.ast-types/gen/nodes.Node, 'type'> ]: ast-types.ast-types/gen/nodes.Node[P]} */ trait JSXSpreadAttribute extends ASTNode {
  ...
  var `type`: typings.astTypes.astTypesStrings.JSXSpreadAttribute
}

object JSXSpreadAttribute {
  @scala.inline
  def apply(argument: ExpressionKind, `type`: typings.astTypes.astTypesStrings.JSXSpreadAttribute): JSXSpreadAttribute = {
