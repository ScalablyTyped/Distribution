...
import typings.astDashTypes.Anon_CommentsExpressionLocTypeAnnotation
...
trait TypeCastExpressionBuilder extends js.Object {
  ...
  def from(params: Anon_CommentsExpressionLocTypeAnnotation): TypeCastExpression = js.native
}
