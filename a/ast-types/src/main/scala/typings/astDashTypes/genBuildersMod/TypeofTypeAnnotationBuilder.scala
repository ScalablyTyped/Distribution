...
import typings.astDashTypes.Anon_ArgumentCommentsLocArrayCommentKind
...
trait TypeofTypeAnnotationBuilder extends js.Object {
  ...
  def from(params: Anon_ArgumentCommentsLocArrayCommentKind): TypeofTypeAnnotation = js.native
}
