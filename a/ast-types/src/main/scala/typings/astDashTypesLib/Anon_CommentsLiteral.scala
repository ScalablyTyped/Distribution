...
object Anon_CommentsLiteral {
  @scala.inline
  def apply(
    literal: astDashTypesLib.genKindsMod.NumericLiteralKind | astDashTypesLib.genKindsMod.StringLiteralKind | astDashTypesLib.genKindsMod.BooleanLiteralKind | astDashTypesLib.genKindsMod.TemplateLiteralKind | astDashTypesLib.genKindsMod.UnaryExpressionKind,
