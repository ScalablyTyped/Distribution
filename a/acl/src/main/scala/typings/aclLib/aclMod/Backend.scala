...
trait Backend[T] extends js.Object {
  ...
  def getAsync(bucket: java.lang.String, key: aclLib.Value): bluebirdLib.bluebirdMod.^[_] = js.native
  def getAsync(
  ...
  def unionAsync(bucket: java.lang.String, keys: js.Array[aclLib.Value]): bluebirdLib.bluebirdMod.^[js.Array[_]] = js.native
  def unionAsync(
    bucket: java.lang.String,
