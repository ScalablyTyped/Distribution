...
trait Backend[T] extends js.Object {
  ...
  def cleanAsync(cb: js.Function1[/* error */ js.UndefOr[stdLib.Error], scala.Unit]): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
  ...
  def endAsync(transaction: T, cb: js.Function1[/* err */ stdLib.Error | scala.Null, scala.Unit]): bluebirdLib.bluebirdMod.namespaced[scala.Unit] = js.native
