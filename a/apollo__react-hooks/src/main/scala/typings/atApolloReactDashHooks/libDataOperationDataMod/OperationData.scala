package typings.atApolloReactDashHooks.libDataOperationDataMod
...
import typings.atApolloReactDashHooks.Anon_Client
...
@JSImport("@apollo/react-hooks/lib/data/OperationData", "OperationData")
@js.native
