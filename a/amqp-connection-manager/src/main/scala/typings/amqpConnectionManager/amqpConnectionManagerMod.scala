...
object amqpConnectionManagerMod {
  ...
  */
  ...
  trait IAmqpConnectionManager extends StObject {
    ...
    def createChannel(): typings.amqpConnectionManager.channelWrapperMod.default = js.native
    def createChannel(options: CreateChannelOpts): typings.amqpConnectionManager.channelWrapperMod.default = js.native
