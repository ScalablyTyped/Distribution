...
trait IModalStackService extends StObject {
  ...
  def close(modalInstance: IModalInstanceService, result: Any): Unit = js.native
  
  /**
    * Dismisses a modal instance with an optional reason.
    */
  def dismiss(modalInstance: IModalInstanceService): Unit = js.native
  def dismiss(modalInstance: IModalInstanceService, reason: Any): Unit = js.native
  ...
  /**
    ...
    */
  def open(modalInstance: IModalInstanceService, modal: Any): Unit = js.native
}
