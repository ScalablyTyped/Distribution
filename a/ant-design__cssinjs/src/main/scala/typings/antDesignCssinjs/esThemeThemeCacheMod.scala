...
object esThemeThemeCacheMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def delete(derivativeOption: DerivativeOptions): js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]] = js.native
    
    /* private */ /* CompleteClass */
    var deleteByPath: Any = js.native
    
    /* CompleteClass */
    override def get(derivativeOption: DerivativeOptions): js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]] = js.native
    ...
    override def set(
      ...
      value: typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]
    ): Unit = js.native
  ...
  trait ThemeCache extends StObject {
    ...
    def delete(derivativeOption: DerivativeOptions): js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
    
    /* private */ var deleteByPath: Any
    
    def get(derivativeOption: DerivativeOptions): js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
  ...
  object ThemeCache {
    ...
    inline def apply(
      cache: Any,
      cacheCallTimes: Any,
      delete: DerivativeOptions => js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]],
      deleteByPath: Any,
      get: DerivativeOptions => js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]],
      has: DerivativeOptions => Boolean,
      internalGet: Any,
      keys: Any,
      set: (DerivativeOptions, typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => Unit,
      size: () => Double
    ): ThemeCache = {
    ...
    extension [Self <: ThemeCache](x: Self) {
      ...
      inline def setDelete(value: DerivativeOptions => js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]): Self = StObject.set(x, "delete", js.Any.fromFunction1(value))
      
      inline def setDeleteByPath(value: Any): Self = StObject.set(x, "deleteByPath", value.asInstanceOf[js.Any])
      
      inline def setGet(value: DerivativeOptions => js.UndefOr[typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]): Self = StObject.set(x, "get", js.Any.fromFunction1(value))
      ...
      inline def setSet(value: (DerivativeOptions, typings.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => Unit): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
