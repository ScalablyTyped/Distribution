...
object styleContextMod {
  ...
  trait StyleContextProps extends StObject {
    ...
    /**
      ...
      */
    var cache: typings.antDesignCssinjs.cacheMod.default
  ...
  object StyleContextProps {
    ...
    inline def apply(cache: typings.antDesignCssinjs.cacheMod.default, defaultCache: Boolean): StyleContextProps = {
    ...
    extension [Self <: StyleContextProps](x: Self) {
      ...
      inline def setCache(value: typings.antDesignCssinjs.cacheMod.default): Self = StObject.set(x, "cache", value.asInstanceOf[js.Any])
  ...
  trait StyleProviderProps extends StObject {
    ...
    var cache: js.UndefOr[typings.antDesignCssinjs.cacheMod.default] = js.undefined
