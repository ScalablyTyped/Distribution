...
package object mod {
  ...
  type CbMacro[Args /* <: js.Array[_] */, Context] = (typings.ava.mod.UntitledCbMacro[Args, Context]) with typings.ava.AnonArgs[Args]
  ...
  type ImplementationResult = js.Thenable[scala.Unit] | typings.ava.mod.ObservableLike | scala.Unit
  type Macro[Args /* <: js.Array[_] */, Context] = (typings.ava.mod.UntitledMacro[Args, Context]) with typings.ava.AnonArgs[Args]
  type OneOrMoreCbMacros[Args /* <: js.Array[_] */, Context] = (typings.ava.mod.EitherCbMacro[Args, Context]) | (js.Array[typings.ava.mod.EitherCbMacro[Args, Context]])
  type OneOrMoreMacros[Args /* <: js.Array[_] */, Context] = (typings.ava.mod.EitherMacro[Args, Context]) | (js.Array[typings.ava.mod.EitherMacro[Args, Context]])
