...
trait ThrowsExpectation extends js.Object {
  ...
  var code: js.UndefOr[java.lang.String | scala.Double] = js.undefined
  ...
  var is: js.UndefOr[stdLib.Error] = js.undefined
...
object ThrowsExpectation {
  @scala.inline
  def apply(
    code: java.lang.String | scala.Double = null,
    instanceOf: Constructor = null,
    is: stdLib.Error = null,
