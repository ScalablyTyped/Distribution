...
object methodMod extends Shortcut {
  
  @JSImport("async-validator/dist-types/validator/method", JSImport.Default)
  @js.native
  val default: ExecuteValidator = js.native
  
  type _To = ExecuteValidator
  
  /* This means you don't have to write `default`, but can instead just say `methodMod.foo` */
