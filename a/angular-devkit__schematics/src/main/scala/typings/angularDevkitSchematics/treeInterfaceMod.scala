...
object treeInterfaceMod {
  ...
  object MergeStrategy extends StObject {
    ...
    sealed trait AllowCreationConflict
      extends StObject
         with MergeStrategy
    /* 4 */ val AllowCreationConflict: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.AllowCreationConflict & Double = js.native
    
    @js.native
    sealed trait AllowDeleteConflict
      extends StObject
         with MergeStrategy
    /* 8 */ val AllowDeleteConflict: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.AllowDeleteConflict & Double = js.native
    
    @js.native
    sealed trait AllowOverwriteConflict
      extends StObject
         with MergeStrategy
    /* 2 */ val AllowOverwriteConflict: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.AllowOverwriteConflict & Double = js.native
    
    @js.native
    sealed trait ContentOnly
      extends StObject
         with MergeStrategy
    /* 2 */ val ContentOnly: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.ContentOnly & Double = js.native
    
    @js.native
    sealed trait Default
      extends StObject
         with MergeStrategy
    /* 0 */ val Default: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.Default & Double = js.native
    
    @js.native
    sealed trait Error
      extends StObject
         with MergeStrategy
    /* 1 */ val Error: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.Error & Double = js.native
    
    @js.native
    sealed trait Overwrite
      extends StObject
         with MergeStrategy
    /* 14 */ val Overwrite: typings.angularDevkitSchematics.treeInterfaceMod.MergeStrategy.Overwrite & Double = js.native
  }
