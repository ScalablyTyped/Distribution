package typings.atAntDashDesignReactDashNative.esPickerPropsTypeMod
...
/* Inlined parent utility-types.utility-types/dist.Omit<@ant-design/react-native.@ant-design/react-native/es/picker/PopupPickerTypes.PopupPickerProps, 'styles'> */
