...
import typings.atAntDashDesignReactDashNative.esTabDashBarPropsTypeMod.TabBarProps
import typings.atAntDashDesignReactDashNative.esTabDashBarStyleMod.TabBarStyle
