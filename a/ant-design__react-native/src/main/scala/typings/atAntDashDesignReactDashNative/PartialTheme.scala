...
object PartialTheme {
  ...
  def apply(
    ...
    if (brand_primary_tap != null) __obj.updateDynamic("brand_primary_tap")(brand_primary_tap.asInstanceOf[js.Any])
    ...
    if (color_text_base_inverse != null) __obj.updateDynamic("color_text_base_inverse")(color_text_base_inverse.asInstanceOf[js.Any])
    if (color_text_caption != null) __obj.updateDynamic("color_text_caption")(color_text_caption.asInstanceOf[js.Any])
    if (color_text_disabled != null) __obj.updateDynamic("color_text_disabled")(color_text_disabled.asInstanceOf[js.Any])
    if (color_text_paragraph != null) __obj.updateDynamic("color_text_paragraph")(color_text_paragraph.asInstanceOf[js.Any])
    if (color_text_placeholder != null) __obj.updateDynamic("color_text_placeholder")(color_text_placeholder.asInstanceOf[js.Any])
    if (color_text_secondary != null) __obj.updateDynamic("color_text_secondary")(color_text_secondary.asInstanceOf[js.Any])
    if (ease_in_out_quint != null) __obj.updateDynamic("ease_in_out_quint")(ease_in_out_quint.asInstanceOf[js.Any])
    if (fill_base != null) __obj.updateDynamic("fill_base")(fill_base.asInstanceOf[js.Any])
    if (fill_body != null) __obj.updateDynamic("fill_body")(fill_body.asInstanceOf[js.Any])
    if (fill_disabled != null) __obj.updateDynamic("fill_disabled")(fill_disabled.asInstanceOf[js.Any])
