...
import typings.atAntDashDesignReactDashNative.esModalPropsTypeMod.ModalPropsType
import typings.atAntDashDesignReactDashNative.esModalStyleMod.ModalStyle
