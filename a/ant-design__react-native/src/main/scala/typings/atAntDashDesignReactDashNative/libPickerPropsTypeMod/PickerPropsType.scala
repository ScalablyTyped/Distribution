package typings.atAntDashDesignReactDashNative.libPickerPropsTypeMod

import typings.atAntDashDesignReactDashNative.libPickerCascaderCascaderTypesMod.CascaderValue
...
/* Inlined parent std.Omit<@ant-design/react-native.@ant-design/react-native/lib/picker/PopupPickerTypes.PopupPickerProps, 'styles'> */
