package typings.atAntDashDesignReactDashNative.libDateDashPickerDashViewPropsTypeMod
...
import typings.atAntDashDesignReactDashNative.libDateDashPickerPropsTypeMod.DatePickerPropsType
