package typings.atAntDashDesignReactDashNative.libPaginationMod
...
import typings.atAntDashDesignReactDashNative.libPaginationPropsTypeMod.PaginationPropsType
import typings.atAntDashDesignReactDashNative.libPaginationStyleMod.PaginationStyle
