...
import typings.atAntDashDesignReactDashNative.PartialTextareaItemStyle
...
import typings.atAntDashDesignReactDashNative.libTextareaDashItemPropsTypeMod.TextAreaEventHandle
