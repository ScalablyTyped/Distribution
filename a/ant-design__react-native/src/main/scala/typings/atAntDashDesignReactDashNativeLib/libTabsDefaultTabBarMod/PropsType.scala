...
trait PropsType
  extends atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabBarPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libTabsStyleMod.TabBarStyle] {
  /** default: false */
...
object PropsType {
  ...
  def apply(
    ...
    tabs: js.Array[atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabData],
    ...
    onTabClick: (/* tab */ atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabData, /* index */ scala.Double) => scala.Unit = null,
    page: scala.Int | scala.Double = null,
    renderTab: /* tab */ atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabData => reactLib.reactMod.ReactNode = null,
    renderUnderline: /* style */ js.Any => reactLib.reactMod.ReactNode = null,
    scrollValue: js.Any = null,
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libTabsStyleMod.TabBarStyle] = null,
