package typings
package atAntDashDesignReactDashNativeLib.libStepsMod
...
trait StepsProps
  extends atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libStepsStyleMod.StepsStyle] {
...
object StepsProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libStepsStyleMod.StepsStyle] = null
  ): StepsProps = {
