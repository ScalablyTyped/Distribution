...
trait PopoverProps
  extends atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esPopoverStyleMod.PopoverStyle] {
...
object PopoverProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esPopoverStyleMod.PopoverStyle] = null,
