package typings
package atAntDashDesignReactDashNativeLib.libTagMod
...
trait TagNativeProps
  extends atAntDashDesignReactDashNativeLib.libTagPropsTypeMod.TagPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libTagStyleMod.TagStyle] {
...
object TagNativeProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libTagStyleMod.TagStyle] = null
  ): TagNativeProps = {
