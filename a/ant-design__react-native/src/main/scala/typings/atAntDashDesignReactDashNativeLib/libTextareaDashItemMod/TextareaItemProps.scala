...
- Dropped {[ P in std.Exclude<keyof any, 'onChange' | 'onFocus' | 'onBlur'> ]: any[P]} */ trait TextareaItemProps
  extends atAntDashDesignReactDashNativeLib.libTextareaDashItemPropsTypeMod.TextAreaItemPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libTextareaDashItemStyleMod.TextareaItemStyle] {
...
object TextareaItemProps {
  ...
  def apply(
    ...
    onChange: atAntDashDesignReactDashNativeLib.libTextareaDashItemPropsTypeMod.TextAreaEventHandle = null,
    onContentSizeChange: /* e */ js.Any => scala.Unit = null,
    onErrorClick: () => scala.Unit = null,
    placeholder: java.lang.String = null,
    rows: scala.Int | scala.Double = null,
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libTextareaDashItemStyleMod.TextareaItemStyle] = null,
