...
trait TabsProps
  extends atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.PropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libTabsStyleTabsMod.TabsStyle]
...
object TabsProps {
  ...
  def apply(
    ...
    onChange: (/* tab */ atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabData, /* index */ scala.Double) => scala.Unit = null,
    ...
    renderTabBar: (js.Function1[
      /* props */ atAntDashDesignReactDashNativeLib.libTabsPropsTypeMod.TabBarPropsType, 
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libTabsStyleTabsMod.TabsStyle] = null,
