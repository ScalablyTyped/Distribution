package typings
package atAntDashDesignReactDashNativeLib.libSegmentedDashControlSegmentedDotIosMod
...
trait SegmentedControlProps
  extends atAntDashDesignReactDashNativeLib.libSegmentedDashControlPropsTypeMod.SegmentedControlPropsType {
