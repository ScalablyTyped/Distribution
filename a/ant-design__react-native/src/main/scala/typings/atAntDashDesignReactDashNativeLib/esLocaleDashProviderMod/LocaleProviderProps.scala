...
trait LocaleProviderProps extends js.Object {
  ...
  var locale: js.UndefOr[stdLib.Partial[Locale]] = js.undefined
}

object LocaleProviderProps {
  @scala.inline
  def apply(children: reactLib.reactMod.ReactElement = null, locale: stdLib.Partial[Locale] = null): LocaleProviderProps = {
