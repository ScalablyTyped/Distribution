...
trait DrawerNativeProps
  extends atAntDashDesignReactDashNativeLib.esDrawerPropsTypeMod.DrawerProps {
  var drawerBackgroundColor: js.UndefOr[java.lang.String] = js.undefined
  var drawerRef: js.UndefOr[
    js.Function1[
      /* el */ atBang88ReactDashNativeDashDrawerDashLayoutLib.atBang88ReactDashNativeDashDrawerDashLayoutMod.default | scala.Null, 
      scala.Unit
    ]
  ] = js.undefined
...
object DrawerNativeProps {
  ...
  def apply(
    ...
    drawerRef: /* el */ atBang88ReactDashNativeDashDrawerDashLayoutLib.atBang88ReactDashNativeDashDrawerDashLayoutMod.default | scala.Null => scala.Unit = null,
