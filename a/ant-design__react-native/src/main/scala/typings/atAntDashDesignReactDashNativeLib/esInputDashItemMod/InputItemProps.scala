package typings
package atAntDashDesignReactDashNativeLib.esInputDashItemMod
...
- Dropped {[ P in std.Exclude<keyof any, 'onChange' | 'onFocus' | 'onBlur'> ]: any[P]} */ trait InputItemProps
  extends atAntDashDesignReactDashNativeLib.esInputDashItemPropsTypeMod.InputItemPropsType
     with atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esInputDashItemStyleMod.InputItemStyle] {
...
object InputItemProps {
  ...
  def apply(
    ...
    onBlur: atAntDashDesignReactDashNativeLib.esInputDashItemPropsTypeMod.InputEventHandler = null,
    ...
    onFocus: atAntDashDesignReactDashNativeLib.esInputDashItemPropsTypeMod.InputEventHandler = null,
    onVirtualKeyboardConfirm: atAntDashDesignReactDashNativeLib.esInputDashItemPropsTypeMod.InputEventHandler = null,
    placeholder: java.lang.String = null,
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esInputDashItemStyleMod.InputItemStyle] = null,
