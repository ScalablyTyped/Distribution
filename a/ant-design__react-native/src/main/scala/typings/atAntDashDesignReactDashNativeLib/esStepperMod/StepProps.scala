package typings
package atAntDashDesignReactDashNativeLib.esStepperMod
...
trait StepProps
  extends atAntDashDesignReactDashNativeLib.esStepperPropsTypeMod.StepPropsType
     with atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esStepperStyleMod.StepperStyle] {
...
object StepProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esStepperStyleMod.StepperStyle] = null,
