package typings
package atAntDashDesignReactDashNativeLib.esListDashViewMod
...
trait ListViewProps[T] extends UltimateListViewProps {
  ...
  var keyExtractor: js.UndefOr[js.Function2[/* item */ T, /* index */ scala.Double, java.lang.String]] = js.undefined
  @JSName("numColumns")
  var numColumns_ListViewProps: js.UndefOr[scala.Double] = js.undefined
  def onFetch(currentPage: scala.Double, startFetch: js.Function0[_], abortFetch: js.Function0[scala.Unit]): scala.Unit
  def renderItem(item: T, index: scala.Double, separators: atAntDashDesignReactDashNativeLib.Anon_Highlight): reactLib.reactMod.ReactElement | scala.Null
}

object ListViewProps {
  @scala.inline
  def apply[T](
    onFetch: (scala.Double, js.Function0[_], js.Function0[scala.Unit]) => scala.Unit,
    renderItem: (T, scala.Double, atAntDashDesignReactDashNativeLib.Anon_Highlight) => reactLib.reactMod.ReactElement | scala.Null,
    ...
    keyExtractor: (/* item */ T, /* index */ scala.Double) => java.lang.String = null,
