...
trait PaginationNativeProps
  extends atAntDashDesignReactDashNativeLib.libPaginationPropsTypeMod.PaginationPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libPaginationStyleMod.PaginationStyle] {
...
object PaginationNativeProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libPaginationStyleMod.PaginationStyle] = null
