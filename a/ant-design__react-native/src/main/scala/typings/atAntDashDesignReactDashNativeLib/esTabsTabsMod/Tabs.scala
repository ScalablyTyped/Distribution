...
class Tabs protected ()
  ...
  def this(props: atAntDashDesignReactDashNativeLib.esTabsPropsTypeMod.PropsType) = this()
  ...
  def componentWillReceiveProps_MTabs(nextProps: atAntDashDesignReactDashNativeLib.esTabsPropsTypeMod.PropsType): scala.Unit = js.native
  ...
  def getTabBarBaseProps(): atAntDashDesignReactDashNativeLib.Anon_ActiveTabAnimated = js.native
  def getTabIndex(props: atAntDashDesignReactDashNativeLib.esTabsPropsTypeMod.PropsType): scala.Double = js.native
...
object Tabs extends js.Object {
  var DefaultTabBar: atAntDashDesignReactDashNativeLib.TypeofClassDefaultTabBar = js.native
  var defaultProps: atAntDashDesignReactDashNativeLib.esTabsPropsTypeMod.PropsType = js.native
}
