package typings
package atAntDashDesignReactDashNativeLib.libModalModalMod
...
trait ModalProps
  extends atAntDashDesignReactDashNativeLib.libModalPropsTypeMod.ModalPropsType[reactDashNativeLib.reactDashNativeMod.TextStyle]
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libModalStyleMod.ModalStyle] {
...
object ModalProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libModalStyleMod.ModalStyle] = null,
