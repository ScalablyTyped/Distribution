package typings
package atAntDashDesignReactDashNativeLib.esDateDashPickerDashViewPropsTypeMod
...
trait DatePickerProps
  extends atAntDashDesignReactDashNativeLib.esDateDashPickerPropsTypeMod.DatePickerPropsType {
