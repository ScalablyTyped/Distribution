...
trait ModalProps
  extends atAntDashDesignReactDashNativeLib.esModalPropsTypeMod.ModalPropsType[reactDashNativeLib.reactDashNativeMod.TextStyle]
     with atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esModalStyleMod.ModalStyle] {
...
object ModalProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esModalStyleMod.ModalStyle] = null,
