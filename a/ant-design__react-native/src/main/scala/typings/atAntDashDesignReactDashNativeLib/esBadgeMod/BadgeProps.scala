package typings
package atAntDashDesignReactDashNativeLib.esBadgeMod
...
trait BadgeProps
  extends atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esBadgeStyleMod.BadgeStyle] {
...
object BadgeProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esBadgeStyleMod.BadgeStyle] = null,
    text: js.Any = null
  ): BadgeProps = {
