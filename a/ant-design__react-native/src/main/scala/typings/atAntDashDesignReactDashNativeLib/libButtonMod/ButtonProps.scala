...
- Dropped any */ trait ButtonProps
  extends atAntDashDesignReactDashNativeLib.libButtonPropsTypeMod.ButtonPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libButtonStyleMod.ButtonStyles] {
...
object ButtonProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libButtonStyleMod.ButtonStyles] = null,
