package typings
package atAntDashDesignReactDashNativeLib.esPaginationPropsTypeMod
...
trait PaginationPropsType extends js.Object {
  ...
  var mode: js.UndefOr[
    atAntDashDesignReactDashNativeLib.atAntDashDesignReactDashNativeLibStrings.button | atAntDashDesignReactDashNativeLib.atAntDashDesignReactDashNativeLibStrings.number | atAntDashDesignReactDashNativeLib.atAntDashDesignReactDashNativeLibStrings.pointer
  ] = js.undefined
