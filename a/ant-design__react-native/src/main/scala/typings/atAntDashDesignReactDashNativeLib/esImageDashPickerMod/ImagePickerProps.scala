...
- atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles because var conflicts: styles. Inlined  */ trait ImagePickerProps
  extends atAntDashDesignReactDashNativeLib.esImageDashPickerPropsTypeMod.ImagePickerPropTypes
     with atAntDashDesignReactDashNativeLib.esImageDashPickerImageRollMod.ImageRollTexts {
...
object ImagePickerProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esImageDashPickerStyleMod.ImagePickerStyle] = null,
