...
trait TabBarNativeProps
  extends atAntDashDesignReactDashNativeLib.esTabDashBarPropsTypeMod.TabBarProps {
  var styles: js.UndefOr[atAntDashDesignReactDashNativeLib.esTabDashBarStyleMod.TabBarStyle] = js.undefined
}
...
object TabBarNativeProps {
  ...
  def apply(
    ...
    styles: atAntDashDesignReactDashNativeLib.esTabDashBarStyleMod.TabBarStyle = null,
