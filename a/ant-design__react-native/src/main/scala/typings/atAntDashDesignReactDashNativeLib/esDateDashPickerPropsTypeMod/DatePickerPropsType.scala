package typings
package atAntDashDesignReactDashNativeLib.esDateDashPickerPropsTypeMod
...
trait DatePickerPropsType
  extends atAntDashDesignReactDashNativeLib.esDateDashPickerDatepickerDatePickerPropsMod.DatePickerProps {
