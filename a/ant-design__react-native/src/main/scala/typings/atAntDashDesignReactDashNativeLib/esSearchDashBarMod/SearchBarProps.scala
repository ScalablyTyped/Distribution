...
trait SearchBarProps
  extends atAntDashDesignReactDashNativeLib.esSearchDashBarPropsTypeMod.SearchBarPropsType
     with atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esSearchDashBarStyleMod.SearchBarStyle] {
...
object SearchBarProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esSearchDashBarStyleMod.SearchBarStyle] = null,
