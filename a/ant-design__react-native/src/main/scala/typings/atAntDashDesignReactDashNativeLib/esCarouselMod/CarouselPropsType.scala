...
trait CarouselPropsType
  extends atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esCarouselStyleMod.CarouselStyle] {
...
object CarouselPropsType {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esCarouselStyleMod.CarouselStyle] = null,
