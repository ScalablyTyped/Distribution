...
trait ListItemProps
  extends atAntDashDesignReactDashNativeLib.libListPropsTypeMod.ListItemPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libListStyleMod.ListStyle] {
...
object ListItemProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libListStyleMod.ListStyle] = null,
