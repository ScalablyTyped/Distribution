package typings
package atAntDashDesignReactDashNativeLib.esResultMod
...
trait ResultNativeProps
  extends atAntDashDesignReactDashNativeLib.esResultPropsTypeMod.ResultPropsType
     with atAntDashDesignReactDashNativeLib.esStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.esResultStyleMod.ResultStyle] {
...
object ResultNativeProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.esResultStyleMod.ResultStyle] = null,
