...
- Dropped {[ P in std.Exclude<keyof any, 'onChange' | 'onFocus' | 'onBlur'> ]: any[P]} */ trait InputItemProps
  extends atAntDashDesignReactDashNativeLib.libInputDashItemPropsTypeMod.InputItemPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libInputDashItemStyleMod.InputItemStyle] {
...
object InputItemProps {
  ...
  def apply(
    ...
    onBlur: atAntDashDesignReactDashNativeLib.libInputDashItemPropsTypeMod.InputEventHandler = null,
    ...
    onFocus: atAntDashDesignReactDashNativeLib.libInputDashItemPropsTypeMod.InputEventHandler = null,
    onVirtualKeyboardConfirm: atAntDashDesignReactDashNativeLib.libInputDashItemPropsTypeMod.InputEventHandler = null,
    placeholder: java.lang.String = null,
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libInputDashItemStyleMod.InputItemStyle] = null,
