...
trait ProgressProps
  extends atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libProgressStyleMod.ProgressStyle] {
...
object ProgressProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libProgressStyleMod.ProgressStyle] = null,
