package typings
package atAntDashDesignReactDashNativeLib.libRadioRadioMod
...
trait RadioNativeProps
  extends atAntDashDesignReactDashNativeLib.libRadioPropsTypeMod.RadioPropsType
     with atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[atAntDashDesignReactDashNativeLib.libRadioStyleMod.RadioStyle] {
...
object RadioNativeProps {
  ...
  def apply(
    ...
    styles: stdLib.Partial[atAntDashDesignReactDashNativeLib.libRadioStyleMod.RadioStyle] = null,
