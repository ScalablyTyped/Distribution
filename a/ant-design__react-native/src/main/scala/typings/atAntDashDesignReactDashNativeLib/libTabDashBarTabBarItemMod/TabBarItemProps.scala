package typings
package atAntDashDesignReactDashNativeLib.libTabDashBarTabBarItemMod
...
trait TabBarItemProps extends js.Object {
  ...
  var icon: js.UndefOr[atAntDashDesignReactDashNativeLib.libTabDashBarPropsTypeMod.TabBarIcon] = js.undefined
  ...
  var selectedIcon: js.UndefOr[atAntDashDesignReactDashNativeLib.libTabDashBarPropsTypeMod.TabBarIcon] = js.undefined
...
object TabBarItemProps {
  ...
  def apply(
    ...
    icon: atAntDashDesignReactDashNativeLib.libTabDashBarPropsTypeMod.TabBarIcon = null,
    ...
    selectedIcon: atAntDashDesignReactDashNativeLib.libTabDashBarPropsTypeMod.TabBarIcon = null,
