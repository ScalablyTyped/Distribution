package typings
package atAntDashDesignReactDashNativeLib.libActivityDashIndicatorMod
...
trait ActivityIndicatorNativeProps
  extends atAntDashDesignReactDashNativeLib.libStyleMod.WithThemeStyles[
      atAntDashDesignReactDashNativeLib.libActivityDashIndicatorStyleMod.ActivityIndicatorStyle
    ] {
...
object ActivityIndicatorNativeProps {
  ...
  def apply(
    ...
    styles: atAntDashDesignReactDashNativeLib.libActivityDashIndicatorStyleMod.ActivityIndicatorStyle = null,
