...
import typings.antDesignReactNative.libCheckboxPropsTypeMod.CheckboxItemPropsType
...
object libRadioPropsTypeMod {
  ...
  - typings.antDesignReactNative.libCheckboxPropsTypeMod.CheckboxPropsType because Already inherited
  - typings.antDesignReactNative.libRadioPropsTypeMod.RadioPropsType because var conflicts: checked, children, defaultChecked, disabled, indeterminate, onChange, prefixCls. Inlined value */ trait RadioItemPropsType
    extends StObject
