...
import typings.antDesignReactNative.antDesignReactNativeStrings.addressState
import typings.antDesignReactNative.antDesignReactNativeStrings.always
...
import typings.antDesignReactNative.antDesignReactNativeStrings.creditCardNumber
import typings.antDesignReactNative.antDesignReactNativeStrings.dark
import typings.antDesignReactNative.antDesignReactNativeStrings.email
...
import typings.antDesignReactNative.antDesignReactNativeStrings.name
import typings.antDesignReactNative.antDesignReactNativeStrings.namePrefix
import typings.antDesignReactNative.antDesignReactNativeStrings.nameSuffix
import typings.antDesignReactNative.antDesignReactNativeStrings.never
...
import typings.antDesignReactNative.antDesignReactNativeStrings.organizationName
...
import typings.antDesignReactNative.antDesignReactNativeStrings.streetAddressLine2
import typings.antDesignReactNative.antDesignReactNativeStrings.sublocality
import typings.antDesignReactNative.antDesignReactNativeStrings.tel
import typings.antDesignReactNative.antDesignReactNativeStrings.telephoneNumber
...
import typings.antDesignReactNative.textareaItemPropsTypeMod.TextAreaItemPropsType
import typings.antDesignReactNative.textareaItemStyleMod.TextareaItemStyle
...
object textareaItemMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/textarea-item", "default.defaultProps")
    @js.native
  ...
  @js.native
  trait TextAreaItem extends Component[TextareaItemProps, Any, Any] {
    
    def getHeight(theme: Theme): Any = js.native
  ...
  object TextInputProps {
    ...
    extension [Self <: TextInputProps](x: Self) {
      ...
      inline def setKeyboardAppearance(value: typings.antDesignReactNative.antDesignReactNativeStrings.default | light | dark): Self = StObject.set(x, "keyboardAppearance", value.asInstanceOf[js.Any])
  ...
  object TextareaItemProps {
    ...
    inline def apply(): TextareaItemProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TextareaItemProps]
    }
    
    extension [Self <: TextareaItemProps](x: Self) {
