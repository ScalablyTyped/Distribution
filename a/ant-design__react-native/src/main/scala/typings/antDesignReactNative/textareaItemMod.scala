...
object textareaItemMod {
  ...
  object TextInputProps {
    ...
    implicit class TextInputPropsMutableBuilder[Self <: TextInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyboardAppearance(value: typings.antDesignReactNative.antDesignReactNativeStrings.default | light | dark): Self = StObject.set(x, "keyboardAppearance", value.asInstanceOf[js.Any])
  ...
  object TextareaItemProps {
    ...
    @scala.inline
    implicit class TextareaItemPropsMutableBuilder[Self <: TextareaItemProps] (val x: Self) extends AnyVal {
