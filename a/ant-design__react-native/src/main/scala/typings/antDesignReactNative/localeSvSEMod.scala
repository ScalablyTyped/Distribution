...
object localeSvSEMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.am")
    @js.native
    def am: String = js.native
    @scala.inline
    def am_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("am")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.day")
    @js.native
    def day: String = js.native
    @scala.inline
    def day_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("day")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.hour")
    @js.native
    def hour: String = js.native
    @scala.inline
    def hour_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("hour")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.minute")
    @js.native
    def minute: String = js.native
    @scala.inline
    def minute_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("minute")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.month")
    @js.native
    def month: String = js.native
    @scala.inline
    def month_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("month")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.pm")
    @js.native
    def pm: String = js.native
    @scala.inline
    def pm_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pm")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/sv_SE", "default.year")
    @js.native
