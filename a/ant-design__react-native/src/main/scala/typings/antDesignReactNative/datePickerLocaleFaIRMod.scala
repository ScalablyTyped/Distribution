...
object datePickerLocaleFaIRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/fa_IR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/fa_IR", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/fa_IR", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/fa_IR", "default.extra")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/fa_IR", "default.okText")
    @js.native
