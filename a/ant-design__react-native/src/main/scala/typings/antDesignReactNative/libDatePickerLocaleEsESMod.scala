...
object libDatePickerLocaleEsESMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/es_ES", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/es_ES", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/es_ES", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/es_ES", "default.extra")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/es_ES", "default.okText")
    @js.native
