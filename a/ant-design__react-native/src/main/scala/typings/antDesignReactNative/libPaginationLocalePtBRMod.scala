...
object libPaginationLocalePtBRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/pt_BR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/pt_BR", "default.nextText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/pagination/locale/pt_BR", "default.prevText")
    @js.native
