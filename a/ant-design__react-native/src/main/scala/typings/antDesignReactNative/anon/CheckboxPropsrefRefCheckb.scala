...
/* Inlined @ant-design/react-native.@ant-design/react-native/lib/checkbox/Checkbox.CheckboxProps & {  ref :react.react.Ref<@ant-design/react-native.@ant-design/react-native/lib/checkbox/PropsType.CheckboxForwardedRef> | undefined} */
trait CheckboxPropsrefRefCheckb extends StObject {
  ...
  var ref: js.UndefOr[Ref[CheckboxForwardedRef]] = js.undefined
  
  var style: js.UndefOr[StyleProp[ViewStyle]] = js.undefined
  
  var styles: js.UndefOr[PartialCheckboxStyle] = js.undefined
}
object CheckboxPropsrefRefCheckb {
  
  inline def apply(): CheckboxPropsrefRefCheckb = {
  ...
  extension [Self <: CheckboxPropsrefRefCheckb](x: Self) {
    ...
    inline def setRef(value: Ref[CheckboxForwardedRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ CheckboxForwardedRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
