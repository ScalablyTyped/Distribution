...
trait ReadonlyPickerPropsAccessibilityActions extends StObject {
  ...
  val onValueChange: js.UndefOr[js.Function2[/* itemValue */ ItemValue, /* itemIndex */ Double, Unit]] = js.native
  ...
  val selectedValue: js.UndefOr[ItemValue] = js.native
...
object ReadonlyPickerPropsAccessibilityActions {
  ...
  @scala.inline
  def apply(): ReadonlyPickerPropsAccessibilityActions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReadonlyPickerPropsAccessibilityActions]
  }
  
  @scala.inline
  implicit class ReadonlyPickerPropsAccessibilityActionsMutableBuilder[Self <: ReadonlyPickerPropsAccessibilityActions] (val x: Self) extends AnyVal {
