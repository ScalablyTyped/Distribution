...
object paginationLocaleRuRUMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/ru_RU", "default.nextText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/pagination/locale/ru_RU", "default.prevText")
    @js.native
