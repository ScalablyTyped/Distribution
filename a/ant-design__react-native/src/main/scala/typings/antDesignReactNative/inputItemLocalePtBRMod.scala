...
object inputItemLocalePtBRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/pt_BR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/pt_BR", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/pt_BR", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/pt_BR", "default.confirmLabel")
    @js.native
