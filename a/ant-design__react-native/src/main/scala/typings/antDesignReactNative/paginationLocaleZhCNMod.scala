...
object paginationLocaleZhCNMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/zh_CN", "default.nextText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/pagination/locale/zh_CN", "default.prevText")
    @js.native
