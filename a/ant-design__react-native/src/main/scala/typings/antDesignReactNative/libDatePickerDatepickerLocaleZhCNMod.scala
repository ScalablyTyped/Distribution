...
object libDatePickerDatepickerLocaleZhCNMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.am")
    @js.native
    def am: String = js.native
    inline def am_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("am")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.day")
    @js.native
    def day: String = js.native
    inline def day_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("day")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.hour")
    @js.native
    def hour: String = js.native
    inline def hour_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("hour")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.minute")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.month")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.pm")
    @js.native
    def pm: String = js.native
    inline def pm_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pm")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/date-picker/datepicker/locale/zh_CN", "default.year")
    @js.native
