...
import typings.antDesignReactNative.libNoticeBarMarqueeMod.MarqueeProps
import typings.antDesignReactNative.libNoticeBarPropsTypeMod.NoticeBarPropsType
import typings.antDesignReactNative.libNoticeBarStyleMod.NoticeBarStyle
