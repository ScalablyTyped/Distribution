...
object libCheckboxCheckboxItemMod {
  ...
  - typings.antDesignReactNative.libListPropsTypeMod.ListItemPropsType because var conflicts: children, disabled. Inlined align, multipleLine, thumb, extra, arrow, wrap, activeStyle, error, platform */ trait CheckboxItemProps
    extends StObject
