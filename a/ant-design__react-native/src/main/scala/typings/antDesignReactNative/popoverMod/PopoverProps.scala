...
object PopoverProps {
  ...
  implicit class PopoverPropsOps[Self <: PopoverProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderOverlayComponent(value: (/* node */ ReactNode, /* closePopover */ js.Function0[Unit]) => ReactNode): Self = this.set("renderOverlayComponent", js.Any.fromFunction2(value))
