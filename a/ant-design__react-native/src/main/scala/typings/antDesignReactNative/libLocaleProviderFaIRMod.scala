...
object libLocaleProviderFaIRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.DatePicker")
    @js.native
    def DatePicker: DismissText = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.DatePickerView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.InputItem")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.ListView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.Modal")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.Pagination")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.Picker")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.SearchBar")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/fa_IR", "default.locale")
    @js.native
