...
object libPaginationLocaleFaIRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/fa_IR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/pagination/locale/fa_IR", "default.nextText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/pagination/locale/fa_IR", "default.prevText")
    @js.native
