...
object localeProviderEnUSMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.DatePicker")
    @js.native
    def DatePicker: DismissText = js.native
    
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.DatePickerView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.InputItem")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.ListView")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.Modal")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.Pagination")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.Picker")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.SearchBar")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/locale-provider/en_US", "default.locale")
    @js.native
