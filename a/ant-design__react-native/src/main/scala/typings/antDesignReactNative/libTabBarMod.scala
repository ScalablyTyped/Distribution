...
import typings.antDesignReactNative.libTabBarPropsTypeMod.TabBarProps
...
object libTabBarMod {
  ...
  object default {
    ...
    @js.native
    open class Item ()
      extends typings.antDesignReactNative.libTabBarTabBarItemMod.default
    /* static members */
    object Item {
  ...
  object TabBar {
    ...
    /* was `typeof TabBarItem` */
    type Item = typings.antDesignReactNative.libTabBarTabBarItemMod.default
  }
