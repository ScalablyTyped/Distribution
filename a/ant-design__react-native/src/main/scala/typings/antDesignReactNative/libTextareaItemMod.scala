...
import typings.antDesignReactNative.libTextareaItemPropsTypeMod.TextAreaItemPropsType
import typings.antDesignReactNative.libTextareaItemStyleMod.TextareaItemStyle
...
object libTextareaItemMod {
  ...
  object TextareaItemProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TextareaItemProps] (val x: Self) extends AnyVal {
