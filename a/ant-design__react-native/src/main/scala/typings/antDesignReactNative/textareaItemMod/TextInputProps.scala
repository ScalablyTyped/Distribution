...
object TextInputProps {
  ...
  implicit class TextInputPropsOps[Self <: TextInputProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyboardAppearance(value: typings.antDesignReactNative.antDesignReactNativeStrings.default | light | dark): Self = this.set("keyboardAppearance", value.asInstanceOf[js.Any])
