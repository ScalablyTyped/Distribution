...
object pickerLocaleEsESMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/picker/locale/es_ES", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/picker/locale/es_ES", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/picker/locale/es_ES", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/react-native/lib/picker/locale/es_ES", "default.okText")
    @js.native
