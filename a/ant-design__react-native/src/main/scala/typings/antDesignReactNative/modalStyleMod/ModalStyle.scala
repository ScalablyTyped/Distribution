package typings.antDesignReactNative.modalStyleMod
...
object ModalStyle {
  ...
  @scala.inline
  implicit class ModalStyleOps[Self <: ModalStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPopupSlideDown(value: ViewStyle): Self = this.set("popupSlideDown", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPopupSlideUp(value: ViewStyle): Self = this.set("popupSlideUp", value.asInstanceOf[js.Any])
