...
import typings.antDesignReactNative.libInputItemPropsTypeMod.InputItemPropsType
import typings.antDesignReactNative.libInputItemStyleMod.InputItemStyle
...
object libInputItemMod {
  ...
  trait InputItem extends Component[InputItemProps, InputItemState, Any] {
    ...
    var inputRef: typings.antDesignReactNative.libInputItemInputMod.default | Null = js.native
  ...
  object InputItemProps {
    ...
    extension [Self <: InputItemProps](x: Self) {
      ...
      inline def setOnErrorClick(value: /* event */ GestureResponderEvent => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      
      inline def setOnErrorClickUndefined: Self = StObject.set(x, "onErrorClick", js.undefined)
      
      inline def setOnExtraClick(value: /* event */ GestureResponderEvent => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
