...
object searchBarMod {
  ...
  trait SearchBarProps extends StObject {
    ...
    var styles: js.UndefOr[PartialSearchBarStyle] = js.undefined
  ...
  object SearchBarProps {
    ...
    extension [Self <: SearchBarProps](x: Self) {
      ...
      inline def setStyles(value: PartialSearchBarStyle): Self = StObject.set(x, "styles", value.asInstanceOf[js.Any])
