...
object libSegmentedControlMod {
  ...
  @js.native
  open class default ()
    extends typings.antDesignReactNative.libSegmentedControlSegmentedDotiosMod.default
  /* static members */
  object default {
  ...
  /* was `typeof SegmentedIOS` */
  type _default = typings.antDesignReactNative.libSegmentedControlSegmentedDotiosMod.default
}
