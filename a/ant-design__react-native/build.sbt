...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-native-collapsible" % "1.6.0-0cbaba",
  "org.scalablytyped" %%% "react-native-gesture-handler" % "2.8.0-639eba",
  "org.scalablytyped" %%% "react-native-modal-popover" % "2.1.0-8aea12",
  "org.scalablytyped" %%% "react-native-picker__picker" % "2.4.7-a402b2",
