...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-native-collapsible" % "1.6.0-18ec16",
  "org.scalablytyped" %%% "react-native-gesture-handler" % "2.8.0-2017b7",
  "org.scalablytyped" %%% "react-native-modal-popover" % "2.1.0-ba410c",
  "org.scalablytyped" %%% "react-native-picker__picker" % "2.4.7-0662be",
