...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "react-native-collapsible" % "1.6.0-410275",
  "org.scalablytyped" %%% "react-native-gesture-handler" % "2.8.0-e32889",
  "org.scalablytyped" %%% "react-native-modal-popover" % "2.1.0-f9d459",
  "org.scalablytyped" %%% "react-native-picker__picker" % "2.4.7-4f1cc5",
