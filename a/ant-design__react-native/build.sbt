...
version := "3.2.0-671478"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "bang88__react-native-drawer-layout" % "2.0.3-933e1e",
  ...
  "org.scalablytyped" %%% "react-native-community__viewpager" % "1.1.7-87a5a3",
  "org.scalablytyped" %%% "react-native-modal-popover" % "0.0.12-ac8db7",
