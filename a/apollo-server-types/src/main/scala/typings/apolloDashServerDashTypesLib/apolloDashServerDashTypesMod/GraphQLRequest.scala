...
trait GraphQLRequest extends js.Object {
  ...
  var http: js.UndefOr[
    stdLib.Pick[
      ...
      apolloDashServerDashTypesLib.apolloDashServerDashTypesLibStrings.url | apolloDashServerDashTypesLib.apolloDashServerDashTypesLibStrings.method | apolloDashServerDashTypesLib.apolloDashServerDashTypesLibStrings.headers
    ]
  ] = js.undefined
