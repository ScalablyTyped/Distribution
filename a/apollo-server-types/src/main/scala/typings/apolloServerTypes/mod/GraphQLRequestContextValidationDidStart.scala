...
object GraphQLRequestContextValidationDidStart {
  ...
  def apply[TContext](
    ...
    val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], document = document.asInstanceOf[js.Any], logger = logger.asInstanceOf[js.Any], metrics = metrics.asInstanceOf[js.Any], queryHash = queryHash.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], schema = schema.asInstanceOf[js.Any], schemaHash = schemaHash.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphQLRequestContextValidationDidStart[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestContextValidationDidStartOps[Self <: GraphQLRequestContextValidationDidStart[_], TContext] (val x: Self with GraphQLRequestContextValidationDidStart[TContext]) extends AnyVal {
    @scala.inline
