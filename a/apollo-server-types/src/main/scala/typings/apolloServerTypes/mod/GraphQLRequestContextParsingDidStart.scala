...
/* Inlined apollo-server-types.apollo-server-types.GraphQLRequestContextDidResolveSource<TContext> */
@js.native
trait GraphQLRequestContextParsingDidStart[TContext] extends js.Object {
...
object GraphQLRequestContextParsingDidStart {
  @scala.inline
  def apply[TContext](
    ...
    __obj.asInstanceOf[GraphQLRequestContextParsingDidStart[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestContextParsingDidStartOps[Self <: GraphQLRequestContextParsingDidStart[_], TContext] (val x: Self with GraphQLRequestContextParsingDidStart[TContext]) extends AnyVal {
    @scala.inline
