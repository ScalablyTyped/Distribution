...
trait GraphQLRequestContextWillSendResponse[TContext] extends js.Object {
  ...
  val response: js.UndefOr[GraphQLResponse] with GraphQLResponse = js.native
...
object GraphQLRequestContextWillSendResponse {
  ...
  def apply[TContext](
    ...
    response: js.UndefOr[GraphQLResponse] with GraphQLResponse,
    schema: GraphQLSchema,
    schemaHash: SchemaHash
  ): GraphQLRequestContextWillSendResponse[TContext] = {
    val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], logger = logger.asInstanceOf[js.Any], metrics = metrics.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], response = response.asInstanceOf[js.Any], schema = schema.asInstanceOf[js.Any], schemaHash = schemaHash.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphQLRequestContextWillSendResponse[TContext]]
  }
  @scala.inline
  implicit class GraphQLRequestContextWillSendResponseOps[Self <: GraphQLRequestContextWillSendResponse[_], TContext] (val x: Self with GraphQLRequestContextWillSendResponse[TContext]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setResponse(value: js.UndefOr[GraphQLResponse] with GraphQLResponse): Self = this.set("response", value.asInstanceOf[js.Any])
    @scala.inline
