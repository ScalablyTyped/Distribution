...
object distTypesConfigMod {
  ...
  @JSImport("@aws-sdk/util-retry/dist-types/config", "DEFAULT_MAX_ATTEMPTS")
  @js.native
  val DEFAULT_MAX_ATTEMPTS: /* 3 */ Double = js.native
  
  @JSImport("@aws-sdk/util-retry/dist-types/config", "DEFAULT_RETRY_MODE")
  @js.native
  val DEFAULT_RETRY_MODE: String | Double = js.native
  
  @js.native
  sealed trait RETRY_MODES extends StObject
  @JSImport("@aws-sdk/util-retry/dist-types/config", "RETRY_MODES")
  @js.native
