...
object distTypesStandardRetryStrategyMod {
  ...
  @JSImport("@aws-sdk/util-retry/dist-types/StandardRetryStrategy", "StandardRetryStrategy")
  @js.native
  open class StandardRetryStrategy protected ()
    ...
    /* private */ var isRetryableError: Any = js.native
    ...
    def refreshRetryTokenForRetry(tokenToRenew: StandardRetryToken, errorInfo: RetryErrorInfo): js.Promise[StandardRetryToken] = js.native
    
    /* private */ var retryToken: Any = js.native
