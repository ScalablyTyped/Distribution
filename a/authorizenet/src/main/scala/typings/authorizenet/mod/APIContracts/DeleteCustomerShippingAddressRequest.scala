...
@JSImport("authorizenet", "APIContracts.DeleteCustomerShippingAddressRequest")
@js.native
open class DeleteCustomerShippingAddressRequest protected () extends ANetApiRequest {
  ...
  def getJSON(): typings.authorizenet.anon.DeleteCustomerShippingAddressRequest = js.native
