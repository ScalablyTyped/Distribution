...
import typings.antvScale.libTypesMod.NiceMethod
import typings.antvScale.libTypesMod.TickMethod
import typings.antvScale.libUtilsFindTickIntervalMod.TickInterval
import typings.antvScale.libUtilsTimeIntervalMod.Interval
import typings.antvScale.libUtilsTimeIntervalMod.IntervalMap
...
object libUtilsMod {
  ...
  open class InternMap[K, V] protected ()
    extends typings.antvScale.libUtilsInternMapMod.InternMap[K, V] {
