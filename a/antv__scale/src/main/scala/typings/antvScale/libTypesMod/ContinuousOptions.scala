...
trait ContinuousOptions extends StObject {
  
  /** 是否需要限制输入的范围在值域内 */
  var clamp: js.UndefOr[Boolean] = js.undefined
  
  /** 定义域，默认为 [0, 1] */
  var domain: js.UndefOr[js.Array[Double | js.Date]] = js.undefined
  ...
  /** 计算 ticks 的算法 */
  var tickMethod: js.UndefOr[TickMethod[Double | js.Date]] = js.undefined
  
  /** 当需要映射的值不合法的时候，返回的值 */
  var unknown: js.UndefOr[Any] = js.undefined
}
object ContinuousOptions {
  
  inline def apply(): ContinuousOptions = {
  ...
  extension [Self <: ContinuousOptions](x: Self) {
    ...
    inline def setDomain(value: js.Array[Double | js.Date]): Self = StObject.set(x, "domain", value.asInstanceOf[js.Any])
    
    inline def setDomainUndefined: Self = StObject.set(x, "domain", js.undefined)
    
    inline def setDomainVarargs(value: (Double | js.Date)*): Self = StObject.set(x, "domain", js.Array(value*))
    ...
    inline def setTickMethod(value: TickMethod[Double | js.Date]): Self = StObject.set(x, "tickMethod", value.asInstanceOf[js.Any])
