...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "azure__core-http-compat" % "1.3.0-e4c061",
  "org.scalablytyped" %%% "azure__core-lro" % "2.3.1-f6898d",
  "org.scalablytyped" %%% "azure__core-paging" % "1.3.0-40326e",
