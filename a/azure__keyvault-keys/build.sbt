...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "azure__core-http-compat" % "1.3.0-89650a",
  "org.scalablytyped" %%% "azure__core-lro" % "2.3.1-0a2b89",
  "org.scalablytyped" %%% "azure__core-paging" % "1.3.0-ea575f",
