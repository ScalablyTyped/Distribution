...
import typings.azureKeyvaultKeys.anon.KeyPropertiesreadonlyreco
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait DeletedKey extends StObject {
  ...
  /**
    ...
    */
  var properties: KeyPropertiesreadonlyreco
}
object DeletedKey {
  
  inline def apply(name: String, properties: KeyPropertiesreadonlyreco): DeletedKey = {
  ...
  implicit open class MutableBuilder[Self <: DeletedKey] (val x: Self) extends AnyVal {
    ...
    inline def setProperties(value: KeyPropertiesreadonlyreco): Self = StObject.set(x, "properties", value.asInstanceOf[js.Any])
  }
}
