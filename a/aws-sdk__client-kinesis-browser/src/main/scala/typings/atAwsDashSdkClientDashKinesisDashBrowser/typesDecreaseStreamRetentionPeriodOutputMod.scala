...
@JSImport("@aws-sdk/client-kinesis-browser/types/DecreaseStreamRetentionPeriodOutput", JSImport.Namespace)
@js.native
object typesDecreaseStreamRetentionPeriodOutputMod extends js.Object {
  @js.native
