package typings.atAwsDashSdkClientDashKinesisDashBrowser.typesRemoveTagsFromStreamInputMod
...
object RemoveTagsFromStreamInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(StreamName = StreamName, TagKeys = TagKeys.asInstanceOf[js.Any])
