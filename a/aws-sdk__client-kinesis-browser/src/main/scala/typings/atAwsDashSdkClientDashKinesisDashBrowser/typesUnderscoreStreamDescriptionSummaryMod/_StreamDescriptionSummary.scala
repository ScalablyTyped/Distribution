...
trait _StreamDescriptionSummary extends js.Object {
  /**
...
object _StreamDescriptionSummary {
  @scala.inline
  def apply(
    ...
    KeyId: String = null
  ): _StreamDescriptionSummary = {
    val __obj = js.Dynamic.literal(EnhancedMonitoring = EnhancedMonitoring.asInstanceOf[js.Any], OpenShardCount = OpenShardCount, RetentionPeriodHours = RetentionPeriodHours, StreamARN = StreamARN, StreamCreationTimestamp = StreamCreationTimestamp.asInstanceOf[js.Any], StreamName = StreamName, StreamStatus = StreamStatus.asInstanceOf[js.Any])
    if (ConsumerCount != null) __obj.updateDynamic("ConsumerCount")(ConsumerCount.asInstanceOf[js.Any])
    if (EncryptionType != null) __obj.updateDynamic("EncryptionType")(EncryptionType.asInstanceOf[js.Any])
    if (KeyId != null) __obj.updateDynamic("KeyId")(KeyId)
    __obj.asInstanceOf[_StreamDescriptionSummary]
  }
}
