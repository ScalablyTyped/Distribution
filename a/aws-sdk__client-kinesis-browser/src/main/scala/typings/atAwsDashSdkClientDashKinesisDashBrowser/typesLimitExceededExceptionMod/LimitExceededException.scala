...
trait LimitExceededException
  ...
  @JSName("name")
  var name_LimitExceededException: typings.atAwsDashSdkClientDashKinesisDashBrowser.atAwsDashSdkClientDashKinesisDashBrowserStrings.LimitExceededException = js.native
}
