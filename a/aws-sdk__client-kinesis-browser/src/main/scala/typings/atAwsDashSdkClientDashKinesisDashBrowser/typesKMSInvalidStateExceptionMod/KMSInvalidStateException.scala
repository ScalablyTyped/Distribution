...
trait KMSInvalidStateException
  ...
  @JSName("name")
  var name_KMSInvalidStateException: typings.atAwsDashSdkClientDashKinesisDashBrowser.atAwsDashSdkClientDashKinesisDashBrowserStrings.KMSInvalidStateException = js.native
}
