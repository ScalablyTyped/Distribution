package typings.atAwsDashSdkClientDashKinesisDashBrowser.typesListStreamConsumersExceptionsUnionMod
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.atAwsDashSdkClientDashKinesisDashBrowser.typesExpiredNextTokenExceptionMod.ExpiredNextTokenException
