package typings.atAwsDashSdkClientDashKinesisDashBrowser.typesAddTagsToStreamInputMod
...
object AddTagsToStreamInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(StreamName = StreamName, Tags = Tags.asInstanceOf[js.Any])
