package typings.atAwsDashSdkClientDashKinesisDashBrowser.typesUpdateShardCountInputMod

import typings.atAwsDashSdkClientDashKinesisDashBrowser.atAwsDashSdkClientDashKinesisDashBrowserStrings.UNIFORM_SCALING
