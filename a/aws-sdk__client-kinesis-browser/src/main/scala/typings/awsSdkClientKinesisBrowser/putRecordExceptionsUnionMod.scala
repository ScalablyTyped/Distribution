...
object putRecordExceptionsUnionMod {
  ...
  */
  trait PutRecordExceptionsUnion extends StObject
  object PutRecordExceptionsUnion {
    ...
    @scala.inline
    def KMSDisabledException(name: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSDisabledException): typings.awsSdkClientKinesisBrowser.typesKmsdisabledexceptionMod.KMSDisabledException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    ...
    @scala.inline
    def KMSNotFoundException(name: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSNotFoundException): typings.awsSdkClientKinesisBrowser.typesKmsnotfoundexceptionMod.KMSNotFoundException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientKinesisBrowser.typesKmsnotfoundexceptionMod.KMSNotFoundException]
    }
    
    @scala.inline
    def KMSOptInRequired(name: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSOptInRequired): typings.awsSdkClientKinesisBrowser.typesKmsoptinrequiredMod.KMSOptInRequired = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientKinesisBrowser.typesKmsoptinrequiredMod.KMSOptInRequired]
    }
    
    @scala.inline
    def KMSThrottlingException(name: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSThrottlingException): typings.awsSdkClientKinesisBrowser.typesKmsthrottlingexceptionMod.KMSThrottlingException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
