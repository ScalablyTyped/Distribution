...
@JSImport("@aws-sdk/client-kinesis-browser/types/DeregisterStreamConsumerExceptionsUnion", JSImport.Namespace)
@js.native
object deregisterStreamConsumerExceptionsUnionMod extends js.Object {
