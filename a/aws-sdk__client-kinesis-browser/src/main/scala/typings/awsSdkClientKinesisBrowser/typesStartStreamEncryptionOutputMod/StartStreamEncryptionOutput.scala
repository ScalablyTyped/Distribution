package typings.awsSdkClientKinesisBrowser.typesStartStreamEncryptionOutputMod
...
object StartStreamEncryptionOutput {
  ...
  @scala.inline
  implicit class StartStreamEncryptionOutputOps[Self <: StartStreamEncryptionOutput] (val x: Self) extends AnyVal {
    @scala.inline
