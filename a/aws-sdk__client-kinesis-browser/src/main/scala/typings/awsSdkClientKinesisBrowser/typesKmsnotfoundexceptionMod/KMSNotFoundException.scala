...
trait KMSNotFoundException
  ...
  @JSName("name")
  var name_KMSNotFoundException: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSNotFoundException = js.native
}
...
object KMSNotFoundException {
  ...
  implicit class KMSNotFoundExceptionOps[Self <: KMSNotFoundException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientKinesisBrowser.awsSdkClientKinesisBrowserStrings.KMSNotFoundException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
