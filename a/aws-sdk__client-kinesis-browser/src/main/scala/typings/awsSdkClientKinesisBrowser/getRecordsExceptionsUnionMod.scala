...
object getRecordsExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientKinesisBrowser.typesExpiredIteratorExceptionMod.ExpiredIteratorException
  ...
  */
  ...
  object GetRecordsExceptionsUnion {
    ...
    inline def ExpiredIteratorException(): typings.awsSdkClientKinesisBrowser.typesExpiredIteratorExceptionMod.ExpiredIteratorException = {
      val __obj = js.Dynamic.literal(name = "ExpiredIteratorException")
      __obj.asInstanceOf[typings.awsSdkClientKinesisBrowser.typesExpiredIteratorExceptionMod.ExpiredIteratorException]
    }
