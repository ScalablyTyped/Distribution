...
@JSImport("@aws-sdk/client-kinesis-browser/types/DisableEnhancedMonitoringOutput", JSImport.Namespace)
@js.native
object typesDisableEnhancedMonitoringOutputMod extends js.Object {
  @js.native
