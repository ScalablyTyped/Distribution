...
@JSImport("@aws-sdk/client-kinesis-browser/types/GetShardIteratorExceptionsUnion", JSImport.Namespace)
@js.native
object getShardIteratorExceptionsUnionMod extends js.Object {
