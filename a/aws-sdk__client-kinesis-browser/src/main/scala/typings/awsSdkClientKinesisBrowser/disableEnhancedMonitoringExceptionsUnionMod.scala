...
object disableEnhancedMonitoringExceptionsUnionMod {
  ...
  */
  trait DisableEnhancedMonitoringExceptionsUnion extends StObject
  object DisableEnhancedMonitoringExceptionsUnion {
