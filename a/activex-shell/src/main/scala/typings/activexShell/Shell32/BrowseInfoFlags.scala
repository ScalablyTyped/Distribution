...
import typings.activexShell.activexShellInts.`0x00000090`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexShell.activexShellInts.`0x00000090`
...
object BrowseInfoFlags {
  ...
  /**
    ...
    */
  inline def BIF_BROWSEFILEJUNCTIONS: `0x00010000` = 0x00010000.asInstanceOf[`0x00010000`]
  
  /** Only return computers. If the user selects anything other than a computer, the **OK** button is grayed. */
  inline def BIF_BROWSEFORCOMPUTER: `0x00001000` = 0x00001000.asInstanceOf[`0x00001000`]
  ...
  /**
    ...
    */
  inline def BIF_BROWSEFORPRINTER: `0x00002000` = 0x00002000.asInstanceOf[`0x00002000`]
  ...
  /**
    ...
    */
  inline def BIF_BROWSEINCLUDEFILES: `0x00004000` = 0x00004000.asInstanceOf[`0x00004000`]
  ...
  /**
    ...
    */
  inline def BIF_BROWSEINCLUDEURLS: `0x00000080` = 0x00000080.asInstanceOf[`0x00000080`]
  
  /** Do not include network folders below the domain level in the dialog box's tree view control. */
  inline def BIF_DONTGOBELOWDOMAIN: `0x00000002` = 0x00000002.asInstanceOf[`0x00000002`]
  ...
  /**
    ...
    * _[Version 4.7.1](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_EDITBOX: `0x00000010` = 0x00000010.asInstanceOf[`0x00000010`]
  ...
  /**
    ...
    * _[Version 5.0](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_NEWDIALOGSTYLE: `0x00000040` = 0x00000040.asInstanceOf[`0x00000040`]
  ...
  /**
    ...
    */
  inline def BIF_NONEWFOLDERBUTTON: `0x00000200` = 0x00000200.asInstanceOf[`0x00000200`]
  ...
  /**
    ...
    * _[Version 6.0](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_NOTRANSLATETARGETS: `0x00000400` = 0x00000400.asInstanceOf[`0x00000400`]
  ...
  /**
    ...
    */
  inline def BIF_RETURNFSANCESTORS: `0x00000008` = 0x00000008.asInstanceOf[`0x00000008`]
  ...
  /**
    ...
    */
  inline def BIF_RETURNONLYFSDIRS: `0x00000001` = 0x00000001.asInstanceOf[`0x00000001`]
  ...
  /**
    ...
    * _[Version 5.0](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_SHAREABLE: `0x00008000` = 0x00008000.asInstanceOf[`0x00008000`]
  ...
  /**
    ...
    * is specified.
    */
  inline def BIF_STATUSTEXT: `0x00000004` = 0x00000004.asInstanceOf[`0x00000004`]
  ...
  /**
    ...
    * _[Version 6.0](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_UAHINT: `0x00000100` = 0x00000100.asInstanceOf[`0x00000100`]
  ...
  /**
    ...
    * _[Version 5.0](https://msdn.microsoft.com/en-us/library/windows/desktop/bb776779.aspx)_
    */
  inline def BIF_USENEWUI: `0x00000090` = 0x00000090.asInstanceOf[`0x00000090`]
  ...
  /**
    ...
    */
  inline def BIF_VALIDATE: `0x00000020` = 0x00000020.asInstanceOf[`0x00000020`]
}
