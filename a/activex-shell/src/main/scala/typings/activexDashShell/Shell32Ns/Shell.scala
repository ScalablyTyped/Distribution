...
import typings.activexDashShell.activexDashShellStrings.DirectoryServiceAvailable
import typings.activexDashShell.activexDashShellStrings.DoubleClickTime
import typings.activexDashShell.activexDashShellStrings.IsOS_DomainMember
import typings.activexDashShell.activexDashShellStrings.IsOS_Personal
import typings.activexDashShell.activexDashShellStrings.IsOS_Professional
import typings.activexDashShell.activexDashShellStrings.PhysicalMemoryInstalled
import typings.activexDashShell.activexDashShellStrings.ProcessorArchitecture
import typings.activexDashShell.activexDashShellStrings.ProcessorLevel
import typings.activexDashShell.activexDashShellStrings.ProcessorSpeed
