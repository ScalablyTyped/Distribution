...
*/
trait fmListBoxStyles extends StObject
object fmListBoxStyles {
  
  @scala.inline
  def _fmListBoxStylesComboBox: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def _fmListBoxStylesListBox: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def _fmListBoxStylesNone: `0` = 0.asInstanceOf[`0`]
}
