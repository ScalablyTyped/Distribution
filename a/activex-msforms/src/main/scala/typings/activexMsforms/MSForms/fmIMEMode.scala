...
import typings.activexMsforms.activexMsformsNumbers.`4`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexMsforms.activexMsformsNumbers.`4`
  - typings.activexMsforms.activexMsformsNumbers.`5`
...
object fmIMEMode {
  ...
  inline def fmIMEModeAlpha: `8` = 8.asInstanceOf[`8`]
  
  inline def fmIMEModeAlphaFull: `7` = 7.asInstanceOf[`7`]
  
  inline def fmIMEModeDisable: `3` = 3.asInstanceOf[`3`]
  
  inline def fmIMEModeHangul: `10` = 10.asInstanceOf[`10`]
  
  inline def fmIMEModeHangulFull: `9` = 9.asInstanceOf[`9`]
  
  inline def fmIMEModeHanzi: `12` = 12.asInstanceOf[`12`]
  
  inline def fmIMEModeHanziFull: `11` = 11.asInstanceOf[`11`]
  
  inline def fmIMEModeHiragana: `4` = 4.asInstanceOf[`4`]
  
  inline def fmIMEModeKatakana: `5` = 5.asInstanceOf[`5`]
  
  inline def fmIMEModeKatakanaHalf: `6` = 6.asInstanceOf[`6`]
  
  inline def fmIMEModeNoControl: `0` = 0.asInstanceOf[`0`]
  
  inline def fmIMEModeOff: `2` = 2.asInstanceOf[`2`]
  
  inline def fmIMEModeOn: `1` = 1.asInstanceOf[`1`]
}
