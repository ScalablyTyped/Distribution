...
*/
trait fmRepeatDirection extends StObject
object fmRepeatDirection {
  
  inline def _fmRepeatDirectionHorizontal: `0` = 0.asInstanceOf[`0`]
  
  inline def _fmRepeatDirectionVertical: `1` = 1.asInstanceOf[`1`]
}
