...
object fmLayoutEffect {
  ...
  inline def _fmLayoutEffectRespond: `2` = 2.asInstanceOf[`2`]
  
  inline def fmLayoutEffectInitiate: `1` = 1.asInstanceOf[`1`]
  
  inline def fmLayoutEffectNone: `0` = 0.asInstanceOf[`0`]
}
