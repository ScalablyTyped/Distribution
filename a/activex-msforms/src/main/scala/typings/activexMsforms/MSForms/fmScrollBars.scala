...
object fmScrollBars {
  ...
  inline def fmScrollBarsBoth: `3` = 3.asInstanceOf[`3`]
  
  inline def fmScrollBarsHorizontal: `1` = 1.asInstanceOf[`1`]
  
  inline def fmScrollBarsNone: `0` = 0.asInstanceOf[`0`]
  
  inline def fmScrollBarsVertical: `2` = 2.asInstanceOf[`2`]
}
