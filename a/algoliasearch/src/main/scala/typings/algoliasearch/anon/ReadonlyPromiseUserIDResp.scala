...
object ReadonlyPromiseUserIDResp {
  ...
  @scala.inline
  implicit class ReadonlyPromiseUserIDRespMutableBuilder[Self <: ReadonlyPromiseUserIDResp] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCatch(value: () => js.Promise[UserIDResponse | js.Any]): Self = StObject.set(x, "catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[UserIDResponse]): Self = StObject.set(x, "finally", js.Any.fromFunction0(value))
