...
object ReadonlyPromiseUserIDResp {
  ...
  @scala.inline
  implicit class ReadonlyPromiseUserIDRespOps[Self <: ReadonlyPromiseUserIDResp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[UserIDResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[UserIDResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
