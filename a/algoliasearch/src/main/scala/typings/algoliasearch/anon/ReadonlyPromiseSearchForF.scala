...
object ReadonlyPromiseSearchForF {
  ...
  @scala.inline
  implicit class ReadonlyPromiseSearchForFOps[Self <: ReadonlyPromiseSearchForF] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[SearchForFacetValuesResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[SearchForFacetValuesResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
