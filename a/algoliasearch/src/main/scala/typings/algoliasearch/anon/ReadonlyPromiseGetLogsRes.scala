...
object ReadonlyPromiseGetLogsRes {
  ...
  @scala.inline
  implicit class ReadonlyPromiseGetLogsResOps[Self <: ReadonlyPromiseGetLogsRes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[GetLogsResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[GetLogsResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
