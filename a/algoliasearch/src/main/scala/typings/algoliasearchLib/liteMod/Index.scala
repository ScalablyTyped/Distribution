...
trait Index extends js.Object {
  ...
  /**
    ...
    */
  def searchForFacetValues(options: algoliasearchLib.liteMod.SearchForFacetValuesNs.Parameters): js.Promise[algoliasearchLib.liteMod.SearchForFacetValuesNs.Response] = js.native
  /**
    * Search in an index
    * https://www.algolia.com/doc/api-reference/api-methods/search-for-facet-values/
    */
  def searchForFacetValues(
    options: algoliasearchLib.liteMod.SearchForFacetValuesNs.Parameters,
    cb: js.Function2[
      /* err */ stdLib.Error, 
      /* res */ algoliasearchLib.liteMod.SearchForFacetValuesNs.Response, 
      scala.Unit
    ]
  ): scala.Unit = js.native
}
