package typings.amapDashJsDashApiDashStationDashSearch.AMapNs

import typings.amapDashJsDashApi.AMapNs.EventEmitter
import typings.amapDashJsDashApiDashStationDashSearch.AMapNs.StationSearchNs.Options
import typings.amapDashJsDashApiDashStationDashSearch.AMapNs.StationSearchNs.SearchResult
