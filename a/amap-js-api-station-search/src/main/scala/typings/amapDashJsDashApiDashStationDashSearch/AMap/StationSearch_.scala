package typings.amapDashJsDashApiDashStationDashSearch.AMap

import typings.amapDashJsDashApi.AMap.EventEmitter
import typings.amapDashJsDashApiDashStationDashSearch.AMap.StationSearch.Options
import typings.amapDashJsDashApiDashStationDashSearch.AMap.StationSearch.SearchResult
