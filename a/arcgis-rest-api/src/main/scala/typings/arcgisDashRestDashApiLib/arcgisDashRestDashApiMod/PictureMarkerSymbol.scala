...
/* RemoveMultipleInheritance: Dropped parents List(arcgisDashRestDashApiLib.arcgisDashRestDashApiMod.PictureSourced because Would inherit conflicting mutable fields List(xoffset, angle, yoffset))*/
