...
object distCommonjsMatchAbstractMatchMod {
  
  /* note: abstract class */ @JSImport("autolinker/dist/commonjs/match/abstract-match", "AbstractMatch")
  @js.native
  open class AbstractMatch protected () extends StObject {
    /**
