...
trait ITranslateService extends js.Object {
  def apply(translationId: java.lang.String): angularLib.angularMod.IPromise[java.lang.String] = js.native
  def apply(translationId: java.lang.String, interpolateParams: js.Any): angularLib.angularMod.IPromise[java.lang.String] = js.native
  def apply(translationId: java.lang.String, interpolateParams: js.Any, interpolationId: java.lang.String): angularLib.angularMod.IPromise[java.lang.String] = js.native
  def apply(
  ...
  ): angularLib.angularMod.IPromise[java.lang.String] = js.native
  def apply(
    translationId: java.lang.String,
    interpolateParams: js.Any,
    interpolationId: java.lang.String,
  ...
  def apply(translationId: js.Array[java.lang.String]): angularLib.angularMod.IPromise[org.scalablytyped.runtime.StringDictionary[java.lang.String]] = js.native
  def apply(translationId: js.Array[java.lang.String], interpolateParams: js.Any): angularLib.angularMod.IPromise[org.scalablytyped.runtime.StringDictionary[java.lang.String]] = js.native
  def apply(
    translationId: js.Array[java.lang.String],
    interpolateParams: js.Any,
    interpolationId: java.lang.String
  ): angularLib.angularMod.IPromise[org.scalablytyped.runtime.StringDictionary[java.lang.String]] = js.native
  def apply(
    translationId: js.Array[java.lang.String],
    interpolateParams: js.Any,
    interpolationId: java.lang.String,
  ...
  def onReady(): angularLib.angularMod.IPromise[scala.Unit] = js.native
  def onReady(fn: js.Function0[scala.Unit]): angularLib.angularMod.IPromise[scala.Unit] = js.native
  ...
  def refresh(): angularLib.angularMod.IPromise[scala.Unit] = js.native
  def refresh(langKey: java.lang.String): angularLib.angularMod.IPromise[scala.Unit] = js.native
  ...
  def use(key: java.lang.String): angularLib.angularMod.IPromise[java.lang.String] = js.native
