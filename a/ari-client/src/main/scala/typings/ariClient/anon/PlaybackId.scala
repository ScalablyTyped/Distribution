...
object PlaybackId {
  ...
  inline def apply(media: String | js.Array[String], playbackId: String): PlaybackId = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PlaybackId] (val x: Self) extends AnyVal {
