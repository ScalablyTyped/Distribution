...
object ConfigInfo {
  ...
  inline def apply(default_language: String, name: String, setid: SetId): ConfigInfo = {
  ...
  extension [Self <: ConfigInfo](x: Self) {
    ...
    inline def setMax_channels(value: Double): Self = StObject.set(x, "max_channels", value.asInstanceOf[js.Any])
    
    inline def setMax_channelsUndefined: Self = StObject.set(x, "max_channels", js.undefined)
    
    inline def setMax_load(value: Double): Self = StObject.set(x, "max_load", value.asInstanceOf[js.Any])
    
    inline def setMax_loadUndefined: Self = StObject.set(x, "max_load", js.undefined)
    
    inline def setMax_open_files(value: Double): Self = StObject.set(x, "max_open_files", value.asInstanceOf[js.Any])
    
    inline def setMax_open_filesUndefined: Self = StObject.set(x, "max_open_files", js.undefined)
    
    inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setSetid(value: SetId): Self = StObject.set(x, "setid", value.asInstanceOf[js.Any])
  }
}
