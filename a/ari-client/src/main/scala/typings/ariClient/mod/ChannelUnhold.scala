...
object ChannelUnhold {
  ...
  inline def apply(application: String, channel: Channel, timestamp: js.Date, `type`: String): ChannelUnhold = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ChannelUnhold] (val x: Self) extends AnyVal {
