...
import typings.ariClient.anon.BridgeIdChannel
import typings.ariClient.anon.BridgeIdChannelId
import typings.ariClient.anon.BridgeIdMohClass
...
trait Bridges extends StObject {
  ...
  /**
    ...
    * @param [params.name] - Set the name of the bridge.
    */
  def createWithId(params: Type, callback: js.Function2[/* err */ js.Error, /* bridge */ Bridge, Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def record(params: Format): js.Promise[LiveRecording] = js.native
  /**
    * Start a recording.
    * This records the mixed audio from all channels participating in this bridge.
    *
  ...
  /**
    ...
    */
  def removeChannel(params: BridgeIdChannel): js.Promise[Unit] = js.native
  /**
    * Remove a channel from a bridge.
    *
    * @param params.bridgeId - Bridges id.
    * @param params.channel - Ids of channels to remove from bridge.
    */
  def removeChannel(params: BridgeIdChannel, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def setVideoSource(params: BridgeIdChannelId): js.Promise[Unit] = js.native
  /**
    * Set a channel as the video source in a multi-party mixing bridge. This operation has no effect on bridges with two or fewer participants.
    *
    * @param params.bridgeId - Bridges id.
    * @param params.channelId - Channels id.
    */
  def setVideoSource(params: BridgeIdChannelId, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
  ...
  /**
    ...
    */
  def startMoh(params: BridgeIdMohClass): js.Promise[Unit] = js.native
  /**
    * Play music on hold to a bridge or change the MOH class that is playing.
    *
    * @param params.bridgeId - Bridges id.
    * @param [params.mohClass] - Channels id.
    */
  def startMoh(params: BridgeIdMohClass, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
