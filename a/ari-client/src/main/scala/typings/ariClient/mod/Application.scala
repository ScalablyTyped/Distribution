...
trait Application
  ...
  /**
    ...
    * @param [params.filter] - Specify which event types to allow/disallow.
    */
  def filter(params: Filter, callback: js.Function2[/* err */ js.Error, /* application */ this.type, Unit]): Unit = js.native
  ...
  /**
    ...
    * @param params.eventSource - URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}.
    */
  def subscribe(params: EventSource, callback: js.Function2[/* err */ js.Error, /* application */ this.type, Unit]): Unit = js.native
  ...
  /**
    ...
    * @param params.eventSource - URI for event source (channel:{channelId}, bridge:{bridgeId}, endpoint:{tech}[/{resource}], deviceState:{deviceName}.
    */
  def unsubscribe(params: EventSource, callback: js.Function2[/* err */ js.Error, /* application */ this.type, Unit]): Unit = js.native
}
