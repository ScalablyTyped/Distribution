package typings.amapDashJsDashApiDashLineDashSearch.AMap

import typings.amapDashJsDashApi.AMap.EventEmitter
import typings.amapDashJsDashApiDashLineDashSearch.AMap.LineSearch.Options
import typings.amapDashJsDashApiDashLineDashSearch.AMap.LineSearch.SearchResult
