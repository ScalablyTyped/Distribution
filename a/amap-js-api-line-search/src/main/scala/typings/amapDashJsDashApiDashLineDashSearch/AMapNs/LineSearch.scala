package typings.amapDashJsDashApiDashLineDashSearch.AMapNs

import typings.amapDashJsDashApi.AMapNs.EventEmitter
import typings.amapDashJsDashApiDashLineDashSearch.AMapNs.LineSearchNs.Options
import typings.amapDashJsDashApiDashLineDashSearch.AMapNs.LineSearchNs.SearchResult
import typings.amapDashJsDashApiDashLineDashSearch.AMapNs.LineSearchNs.SearchStatus
