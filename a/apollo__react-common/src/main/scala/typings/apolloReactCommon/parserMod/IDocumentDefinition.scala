...
object IDocumentDefinition {
  ...
  implicit class IDocumentDefinitionOps[Self <: IDocumentDefinition] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setVariablesVarargs(value: VariableDefinitionNode*): Self = this.set("variables", js.Array(value :_*))
    @scala.inline
    def setVariables(value: js.Array[VariableDefinitionNode]): Self = this.set("variables", value.asInstanceOf[js.Any])
  }
