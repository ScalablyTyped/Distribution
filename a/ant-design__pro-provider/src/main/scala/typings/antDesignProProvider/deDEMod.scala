...
object deDEMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/de_DE", "default.tableToolBar")
    @js.native
