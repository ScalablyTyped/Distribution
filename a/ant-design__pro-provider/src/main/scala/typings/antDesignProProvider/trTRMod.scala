...
object trTRMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/tr_TR", "default.tableToolBar")
    @js.native
