...
@js.native
trait ColumnDisplay extends js.Object {
...
object ColumnDisplay {
  ...
  @scala.inline
  implicit class ColumnDisplayOps[Self <: ColumnDisplay] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDensityDefault(value: String): Self = this.set("densityDefault", value.asInstanceOf[js.Any])
