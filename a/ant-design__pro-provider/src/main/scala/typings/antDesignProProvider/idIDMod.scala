...
object idIDMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/id_ID", "default.tableToolBar")
    @js.native
