...
object esLocaleCaESMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ca_ES", "default.tableToolBar")
    @js.native
