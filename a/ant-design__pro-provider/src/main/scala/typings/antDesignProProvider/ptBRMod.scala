...
object ptBRMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/pt_BR", "default.tableToolBar")
    @js.native
