...
object hrHRMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/hr_HR", "default.tableToolBar")
    @js.native
