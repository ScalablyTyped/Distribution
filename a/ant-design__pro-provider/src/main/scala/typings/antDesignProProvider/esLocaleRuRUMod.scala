...
object esLocaleRuRUMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ru_RU", "default.tableToolBar")
    @js.native
