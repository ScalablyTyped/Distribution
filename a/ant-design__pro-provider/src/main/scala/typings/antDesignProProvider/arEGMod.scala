...
object arEGMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.alert")
    @js.native
    def alert: Item = js.native
    @scala.inline
    def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.stepsForm")
    @js.native
    def stepsForm: Next = js.native
    @scala.inline
    def stepsForm_=(x: Next): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("stepsForm")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/lib/locale/ar_EG", "default.tableToolBar")
    @js.native
