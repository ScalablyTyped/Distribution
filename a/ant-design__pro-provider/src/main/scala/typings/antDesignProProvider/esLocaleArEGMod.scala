...
object esLocaleArEGMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ar_EG", "default.tableToolBar")
    @js.native
