...
object esLocaleFrFRMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fr_FR", "default.tableToolBar")
    @js.native
