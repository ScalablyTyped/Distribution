...
object esLocaleZhCNMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.copyThisLine")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.deleteThisLine")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/zh_CN", "default.tableToolBar")
    @js.native
