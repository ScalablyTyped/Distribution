...
object esLocaleSrRSMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/sr_RS", "default.tableToolBar")
    @js.native
