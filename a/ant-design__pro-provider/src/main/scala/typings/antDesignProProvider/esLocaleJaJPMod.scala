...
object esLocaleJaJPMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ja_JP", "default.tableToolBar")
    @js.native
