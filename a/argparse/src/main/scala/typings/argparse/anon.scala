...
object anon {
  ...
  object _empty {
    ...
    @scala.inline
    def apply(_underscore: typings.argparse.argparseStrings.ActionConstructorOptions): _empty = {
    ...
    implicit class _emptyMutableBuilder[Self <: _empty] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def set_underscore(value: typings.argparse.argparseStrings.ActionConstructorOptions): Self = StObject.set(x, "_", value.asInstanceOf[js.Any])
    }
  }
}
