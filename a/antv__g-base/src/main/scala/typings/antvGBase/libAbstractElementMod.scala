...
import typings.antvGBase.libInterfacesMod.IContainer
...
import typings.antvGBase.libTypesMod.AnimateCfg
import typings.antvGBase.libTypesMod.BBox
import typings.antvGBase.libTypesMod.ChangeType
import typings.antvGBase.libTypesMod.ClipCfg
import typings.antvGBase.libTypesMod.ElementAttrs
import typings.antvGBase.libTypesMod.OnFrame
import typings.antvGBase.libTypesMod.ShapeAttrs
import typings.antvGBase.libTypesMod.ShapeBase
...
object libAbstractElementMod {
  ...
  trait Element
    ...
    /**
      ...
      * @param  {GraphEvent}  eventObj 事件对象
      */
    def emitDelegation(`type`: String, eventObj: typings.antvGBase.libEventGraphEventMod.default): Unit = js.native
