...
import typings.antvGBase.libEventGraphEventMod.default
...
object libInterfacesMod {
  ...
  trait IObservable extends StObject {
    ...
    /**
      ...
      */
    def emit(eventName: String, eventObject: js.Object): Any = js.native
