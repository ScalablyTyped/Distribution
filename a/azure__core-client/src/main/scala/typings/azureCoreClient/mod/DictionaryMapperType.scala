...
import typings.azureCoreClient.azureCoreClientStrings.Dictionary
...
object DictionaryMapperType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DictionaryMapperType] (val x: Self) extends AnyVal {
