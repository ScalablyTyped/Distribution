package typings.amapDashJsDashApiDashIndoorDashMap.AMapNs

import typings.amapDashJsDashApi.AMapNs.Layer
import typings.amapDashJsDashApiDashIndoorDashMap.AMapNs.IndoorMapNs.Building
import typings.amapDashJsDashApiDashIndoorDashMap.AMapNs.IndoorMapNs.Options
import typings.amapDashJsDashApiDashIndoorDashMap.AMapNs.IndoorMapNs.SearchResult
