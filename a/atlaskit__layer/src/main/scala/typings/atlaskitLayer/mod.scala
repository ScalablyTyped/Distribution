...
object mod {
  ...
  */
  ...
  object FlipPositionType {
    ...
    @scala.inline
    def bottom: typings.atlaskitLayer.atlaskitLayerStrings.bottom = "bottom".asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.bottom]
    
    @scala.inline
    def left: typings.atlaskitLayer.atlaskitLayerStrings.left = "left".asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.left]
    
    @scala.inline
    def right: typings.atlaskitLayer.atlaskitLayerStrings.right = "right".asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.right]
    
    @scala.inline
    def top: typings.atlaskitLayer.atlaskitLayerStrings.top = "top".asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.top]
  }
  ...
  */
  ...
  object PositionType {
    ...
    @scala.inline
    def `bottom center`: typings.atlaskitLayer.atlaskitLayerStrings.`bottom center` = ("bottom center").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`bottom center`]
    
    @scala.inline
    def `bottom left`: typings.atlaskitLayer.atlaskitLayerStrings.`bottom left` = ("bottom left").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`bottom left`]
    
    @scala.inline
    def `bottom right`: typings.atlaskitLayer.atlaskitLayerStrings.`bottom right` = ("bottom right").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`bottom right`]
    
    @scala.inline
    def `left bottom`: typings.atlaskitLayer.atlaskitLayerStrings.`left bottom` = ("left bottom").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`left bottom`]
    
    @scala.inline
    def `left middle`: typings.atlaskitLayer.atlaskitLayerStrings.`left middle` = ("left middle").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`left middle`]
    
    @scala.inline
    def `left top`: typings.atlaskitLayer.atlaskitLayerStrings.`left top` = ("left top").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`left top`]
    
    @scala.inline
    def `right bottom`: typings.atlaskitLayer.atlaskitLayerStrings.`right bottom` = ("right bottom").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`right bottom`]
    
    @scala.inline
    def `right middle`: typings.atlaskitLayer.atlaskitLayerStrings.`right middle` = ("right middle").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`right middle`]
    
    @scala.inline
    def `right top`: typings.atlaskitLayer.atlaskitLayerStrings.`right top` = ("right top").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`right top`]
    
    @scala.inline
    def `top center`: typings.atlaskitLayer.atlaskitLayerStrings.`top center` = ("top center").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`top center`]
    
    @scala.inline
    def `top left`: typings.atlaskitLayer.atlaskitLayerStrings.`top left` = ("top left").asInstanceOf[typings.atlaskitLayer.atlaskitLayerStrings.`top left`]
  ...
  object Props {
    ...
    implicit class PropsMutableBuilder[Self <: Props] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAutoFlip(value: Boolean | FlipPositionType | js.Array[FlipPositionType]): Self = StObject.set(x, "autoFlip", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAutoFlipUndefined: Self = StObject.set(x, "autoFlip", js.undefined)
      
      @scala.inline
      def setAutoFlipVarargs(value: FlipPositionType*): Self = StObject.set(x, "autoFlip", js.Array(value :_*))
      
      @scala.inline
      def setBoundariesElement(value: BoundariesElementType): Self = StObject.set(x, "boundariesElement", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnFlippedChangeUndefined: Self = StObject.set(x, "onFlippedChange", js.undefined)
