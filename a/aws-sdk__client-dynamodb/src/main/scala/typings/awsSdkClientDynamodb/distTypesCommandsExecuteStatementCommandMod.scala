...
import typings.awsSdkClientDynamodb.distTypesModelsModels0Mod.ExecuteStatementInput
import typings.awsSdkClientDynamodb.distTypesModelsModels0Mod.ExecuteStatementOutput
...
object distTypesCommandsExecuteStatementCommandMod {
  ...
  @JSImport("@aws-sdk/client-dynamodb/dist-types/commands/ExecuteStatementCommand", "ExecuteStatementCommand")
  @js.native
  open class ExecuteStatementCommand protected () extends Command[
  ...
  type ExecuteStatementCommandInput = ExecuteStatementInput
  
  trait ExecuteStatementCommandOutput
    extends StObject
       with ExecuteStatementOutput
       with MetadataBearer
