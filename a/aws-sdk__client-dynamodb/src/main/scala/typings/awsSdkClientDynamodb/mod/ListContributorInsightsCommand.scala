...
@JSImport("@aws-sdk/client-dynamodb", "ListContributorInsightsCommand")
@js.native
open class ListContributorInsightsCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsMod.ListContributorInsightsCommand {
  /**
    * @public
    */
