...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "BatchGetItemCommand")
@js.native
open class BatchGetItemCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsBatchGetItemCommandMod.BatchGetItemCommand {
  /**
    * @public
    */
