...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "BatchExecuteStatementCommand")
@js.native
open class BatchExecuteStatementCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsBatchExecuteStatementCommandMod.BatchExecuteStatementCommand {
  /**
    * @public
    */
