...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "DescribeExportCommand")
@js.native
open class DescribeExportCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsDescribeExportCommandMod.DescribeExportCommand {
  /**
    * @public
    */
