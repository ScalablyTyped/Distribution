...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "DeleteItemCommand")
@js.native
open class DeleteItemCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsDeleteItemCommandMod.DeleteItemCommand {
  /**
    * @public
    */
