...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "DescribeTableCommand")
@js.native
open class DescribeTableCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsDescribeTableCommandMod.DescribeTableCommand {
  /**
    * @public
    */
