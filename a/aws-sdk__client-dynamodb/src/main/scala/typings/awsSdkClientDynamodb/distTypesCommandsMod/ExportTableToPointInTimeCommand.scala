...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "ExportTableToPointInTimeCommand")
@js.native
open class ExportTableToPointInTimeCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsExportTableToPointInTimeCommandMod.ExportTableToPointInTimeCommand {
  /**
    * @public
    */
