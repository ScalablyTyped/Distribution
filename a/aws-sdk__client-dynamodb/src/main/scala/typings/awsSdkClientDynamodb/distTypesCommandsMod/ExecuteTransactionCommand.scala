...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "ExecuteTransactionCommand")
@js.native
open class ExecuteTransactionCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsExecuteTransactionCommandMod.ExecuteTransactionCommand {
  /**
    * @public
    */
