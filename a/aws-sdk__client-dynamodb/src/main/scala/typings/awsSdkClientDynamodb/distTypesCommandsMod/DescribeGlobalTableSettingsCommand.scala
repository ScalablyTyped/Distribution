...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "DescribeGlobalTableSettingsCommand")
@js.native
open class DescribeGlobalTableSettingsCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsDescribeGlobalTableSettingsCommandMod.DescribeGlobalTableSettingsCommand {
  /**
    * @public
    */
