...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "DeleteTableCommand")
@js.native
open class DeleteTableCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsDeleteTableCommandMod.DeleteTableCommand {
  /**
    * @public
    */
