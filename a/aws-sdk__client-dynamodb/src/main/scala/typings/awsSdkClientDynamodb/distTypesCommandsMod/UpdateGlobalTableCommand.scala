...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "UpdateGlobalTableCommand")
@js.native
open class UpdateGlobalTableCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsUpdateGlobalTableCommandMod.UpdateGlobalTableCommand {
  /**
    * @public
    */
