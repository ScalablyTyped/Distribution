...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "ListExportsCommand")
@js.native
open class ListExportsCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsListExportsCommandMod.ListExportsCommand {
  /**
    * @public
    */
