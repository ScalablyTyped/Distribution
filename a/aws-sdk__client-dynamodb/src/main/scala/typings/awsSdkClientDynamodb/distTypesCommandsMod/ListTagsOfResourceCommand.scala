...
@JSImport("@aws-sdk/client-dynamodb/dist-types/commands", "ListTagsOfResourceCommand")
@js.native
open class ListTagsOfResourceCommand protected ()
  extends typings.awsSdkClientDynamodb.distTypesCommandsListTagsOfResourceCommandMod.ListTagsOfResourceCommand {
  /**
    * @public
    */
