...
trait AutoScalingSettingsDescription extends StObject {
  ...
  /**
    ...
    */
  var ScalingPolicies: js.UndefOr[js.Array[AutoScalingPolicyDescription]] = js.undefined
}
object AutoScalingSettingsDescription {
  ...
  implicit open class MutableBuilder[Self <: AutoScalingSettingsDescription] (val x: Self) extends AnyVal {
    ...
    inline def setScalingPolicies(value: js.Array[AutoScalingPolicyDescription]): Self = StObject.set(x, "ScalingPolicies", value.asInstanceOf[js.Any])
