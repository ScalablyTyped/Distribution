...
trait KeysAndAttributes extends StObject {
  ...
  /**
    ...
    *             with the items.</p>
    */
  var Keys: js.UndefOr[js.Array[Record[String, AttributeValue]]] = js.undefined
...
object KeysAndAttributes {
  ...
  inline def apply(): KeysAndAttributes = {
  ...
  implicit open class MutableBuilder[Self <: KeysAndAttributes] (val x: Self) extends AnyVal {
    ...
    inline def setKeys(value: js.Array[Record[String, AttributeValue]]): Self = StObject.set(x, "Keys", value.asInstanceOf[js.Any])
    
    inline def setKeysUndefined: Self = StObject.set(x, "Keys", js.undefined)
    
    inline def setKeysVarargs(value: (Record[String, AttributeValue])*): Self = StObject.set(x, "Keys", js.Array(value*))
