...
trait StreamSpecification extends StObject {
  ...
  /**
    ...
    *          </ul>
    */
  var StreamViewType: js.UndefOr[typings.awsSdkClientDynamodb.distTypesModelsModels0Mod.StreamViewType | String] = js.undefined
}
object StreamSpecification {
  ...
  implicit open class MutableBuilder[Self <: StreamSpecification] (val x: Self) extends AnyVal {
    ...
    inline def setStreamViewType(value: StreamViewType | String): Self = StObject.set(x, "StreamViewType", value.asInstanceOf[js.Any])
