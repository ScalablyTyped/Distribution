...
trait QueryInput extends StObject {
  ...
  /**
    ...
    *             Guide</i>.</p>
    */
  var KeyConditions: js.UndefOr[Record[String, Condition]] = js.undefined
  ...
  /**
    ...
    *             Guide</i>.</p>
    */
  var QueryFilter: js.UndefOr[Record[String, Condition]] = js.undefined
...
object QueryInput {
  ...
  implicit open class MutableBuilder[Self <: QueryInput] (val x: Self) extends AnyVal {
    ...
    inline def setKeyConditions(value: Record[String, Condition]): Self = StObject.set(x, "KeyConditions", value.asInstanceOf[js.Any])
    ...
    inline def setQueryFilter(value: Record[String, Condition]): Self = StObject.set(x, "QueryFilter", value.asInstanceOf[js.Any])
