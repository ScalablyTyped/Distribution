...
trait TransactWriteItemsInput extends StObject {
  ...
  /**
    ...
    */
  var TransactItems: js.UndefOr[js.Array[TransactWriteItem]] = js.undefined
}
object TransactWriteItemsInput {
  
  inline def apply(): TransactWriteItemsInput = {
  ...
  implicit open class MutableBuilder[Self <: TransactWriteItemsInput] (val x: Self) extends AnyVal {
    ...
    inline def setTransactItems(value: js.Array[TransactWriteItem]): Self = StObject.set(x, "TransactItems", value.asInstanceOf[js.Any])
