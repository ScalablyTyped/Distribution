...
trait WriteRequest extends StObject {
  ...
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typings.awsSdkClientDynamodb.distTypesModelsModels0Mod.DeleteRequest] = js.undefined
  
  /**
    * <p>A request to perform a <code>PutItem</code> operation.</p>
    */
  var PutRequest: js.UndefOr[typings.awsSdkClientDynamodb.distTypesModelsModels0Mod.PutRequest] = js.undefined
}
object WriteRequest {
