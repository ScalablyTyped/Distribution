...
trait UpdateItemInput extends StObject {
  ...
  /**
    ...
    *                 Guide</i>.</p>
    */
  var AttributeUpdates: js.UndefOr[Record[String, AttributeValueUpdate]] = js.undefined
...
object UpdateItemInput {
  ...
  inline def apply(): UpdateItemInput = {
  ...
  implicit open class MutableBuilder[Self <: UpdateItemInput] (val x: Self) extends AnyVal {
    ...
    inline def setAttributeUpdates(value: Record[String, AttributeValueUpdate]): Self = StObject.set(x, "AttributeUpdates", value.asInstanceOf[js.Any])
