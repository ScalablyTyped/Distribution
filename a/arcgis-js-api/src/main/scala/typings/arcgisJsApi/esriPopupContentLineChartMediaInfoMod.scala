...
/* static members */
object esriPopupContentLineChartMediaInfoMod {
  ...
  inline def fromJSON(json: Any): LineChartMediaInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[LineChartMediaInfo]
}
