...
object webStyleSymbolMod extends Shortcut {
  
  @JSImport("esri/symbols/WebStyleSymbol", JSImport.Namespace)
  @js.native
  val ^ : WebStyleSymbolConstructor = js.native
  ...
  type _To = WebStyleSymbolConstructor
  
  /* This means you don't have to write `^`, but can instead just say `webStyleSymbolMod.foo` */
  override def _to: WebStyleSymbolConstructor = ^
}
