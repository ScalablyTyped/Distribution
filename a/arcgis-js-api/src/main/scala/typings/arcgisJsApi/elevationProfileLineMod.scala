...
import typings.arcgisJsApi.esri.ElevationProfileLine
import typings.arcgisJsApi.esri.ElevationProfileLineConstructor
import typings.arcgisJsApi.esri.ElevationProfileLineProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object elevationProfileLineMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `elevationProfileLineMod.foo` */
