...
/* static members */
object esriPopupContentCustomContentMod {
  ...
  inline def fromJSON(json: Any): CustomContent = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[CustomContent]
}
