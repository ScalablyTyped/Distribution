...
object esriWidgetsDirectLineMeasurement3DDirectLineMeasurement3DViewModelMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsDirectLineMeasurement3DDirectLineMeasurement3DViewModelMod.foo` */
