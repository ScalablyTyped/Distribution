...
object esriRestNetworksSupportTraceParametersMod extends Shortcut {
  
  @JSImport("esri/rest/networks/support/TraceParameters", JSImport.Namespace)
  @js.native
  val ^ : js.Object & TraceParametersConstructor = js.native
  ...
  type _To = js.Object & TraceParametersConstructor
  
  /* This means you don't have to write `^`, but can instead just say `esriRestNetworksSupportTraceParametersMod.foo` */
  override def _to: js.Object & TraceParametersConstructor = ^
}
