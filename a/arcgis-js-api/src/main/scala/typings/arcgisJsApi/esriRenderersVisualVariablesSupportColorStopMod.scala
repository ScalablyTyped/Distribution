...
/* static members */
object esriRenderersVisualVariablesSupportColorStopMod {
  ...
  inline def fromJSON(json: Any): ColorStop = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[ColorStop]
}
