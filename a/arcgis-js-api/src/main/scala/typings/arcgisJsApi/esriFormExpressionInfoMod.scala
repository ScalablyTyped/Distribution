...
/* static members */
object esriFormExpressionInfoMod {
  ...
  inline def fromJSON(json: Any): ExpressionInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[ExpressionInfo]
}
