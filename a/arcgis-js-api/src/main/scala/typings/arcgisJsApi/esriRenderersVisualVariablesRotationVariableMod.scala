...
/* static members */
object esriRenderersVisualVariablesRotationVariableMod {
  ...
  inline def fromJSON(json: Any): RotationVariable = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[RotationVariable]
}
