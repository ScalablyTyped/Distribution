...
object esriPopupTemplateMod {
  ...
  inline def fromJSON(json: Any): PopupTemplate = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[PopupTemplate]
}
