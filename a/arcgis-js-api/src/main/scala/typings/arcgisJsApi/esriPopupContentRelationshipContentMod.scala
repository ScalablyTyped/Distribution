...
/* static members */
object esriPopupContentRelationshipContentMod {
  
  @JSImport("esri/popup/content/RelationshipContent", JSImport.Namespace)
  @js.native
  /**
  ...
  inline def fromJSON(json: Any): RelationshipContent = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[RelationshipContent]
}
