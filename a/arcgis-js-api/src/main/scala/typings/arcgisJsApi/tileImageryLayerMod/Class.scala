package typings.arcgisJsApi.tileImageryLayerMod

import typings.arcgisJsApi.esri.PortalItem
import typings.arcgisJsApi.esri.TileImageryLayer
import typings.arcgisJsApi.esri.TileImageryLayerProperties
