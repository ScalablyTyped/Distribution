...
object traceLocationMod extends Shortcut {
  
  @JSImport("esri/rest/networks/support/TraceLocation", JSImport.Namespace)
  @js.native
  val ^ : js.Object & TraceLocationConstructor = js.native
  ...
  type _To = js.Object & TraceLocationConstructor
  
  /* This means you don't have to write `^`, but can instead just say `traceLocationMod.foo` */
  override def _to: js.Object & TraceLocationConstructor = ^
}
