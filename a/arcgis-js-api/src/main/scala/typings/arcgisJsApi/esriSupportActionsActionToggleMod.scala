...
object esriSupportActionsActionToggleMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriSupportActionsActionToggleMod.foo` */
