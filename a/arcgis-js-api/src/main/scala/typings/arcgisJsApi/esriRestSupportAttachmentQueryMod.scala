...
object esriRestSupportAttachmentQueryMod extends Shortcut {
  
  @JSImport("esri/rest/support/AttachmentQuery", JSImport.Namespace)
  @js.native
  val ^ : js.Object & AttachmentQueryConstructor = js.native
  ...
  type _To = js.Object & AttachmentQueryConstructor
  
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportAttachmentQueryMod.foo` */
  override def _to: js.Object & AttachmentQueryConstructor = ^
}
