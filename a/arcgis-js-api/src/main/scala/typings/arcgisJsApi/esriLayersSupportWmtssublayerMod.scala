...
/* static members */
object esriLayersSupportWmtssublayerMod {
  ...
  inline def fromJSON(json: Any): WMTSSublayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[WMTSSublayer]
}
