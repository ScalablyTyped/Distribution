...
object esriRestSupportImageIdentifyParametersMod extends Shortcut {
  
  @JSImport("esri/rest/support/ImageIdentifyParameters", JSImport.Namespace)
  @js.native
  val ^ : js.Object & ImageIdentifyParametersConstructor = js.native
  ...
  type _To = js.Object & ImageIdentifyParametersConstructor
  
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportImageIdentifyParametersMod.foo` */
  override def _to: js.Object & ImageIdentifyParametersConstructor = ^
}
