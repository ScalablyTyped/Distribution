...
trait UniqueValueRendererProper extends StObject {
...
object UniqueValueRendererProper {
  
  inline def apply(): UniqueValueRendererProper = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("unique-value")
    __obj.asInstanceOf[UniqueValueRendererProper]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UniqueValueRendererProper] (val x: Self) extends AnyVal {
