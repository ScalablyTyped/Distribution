...
import typings.arcgisJsApi.esri.RasterStretchRendererStatistics
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined arcgis-js-api.__esri.RasterStretchRendererProperties & {  type :'raster-stretch'} */
...
object RasterStretchRendererProp {
  ...
  inline def apply(): RasterStretchRendererProp = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("raster-stretch")
    __obj.asInstanceOf[RasterStretchRendererProp]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RasterStretchRendererProp] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: `raster-stretch`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
