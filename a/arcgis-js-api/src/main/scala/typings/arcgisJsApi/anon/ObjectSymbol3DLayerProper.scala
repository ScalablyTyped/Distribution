...
import typings.arcgisJsApi.esri.ObjectSymbol3DLayerAnchorPosition
import typings.arcgisJsApi.esri.ObjectSymbol3DLayerMaterialProperties
import typings.arcgisJsApi.esri.ObjectSymbol3DLayerResource
...
object ObjectSymbol3DLayerProper {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectSymbol3DLayerProper] (val x: Self) extends AnyVal {
