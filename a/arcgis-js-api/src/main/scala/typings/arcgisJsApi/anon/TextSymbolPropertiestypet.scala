...
/* Inlined arcgis-js-api.__esri.TextSymbolProperties & {  type :'text'} */
trait TextSymbolPropertiestypet extends StObject {
...
object TextSymbolPropertiestypet {
  
  inline def apply(): TextSymbolPropertiestypet = {
