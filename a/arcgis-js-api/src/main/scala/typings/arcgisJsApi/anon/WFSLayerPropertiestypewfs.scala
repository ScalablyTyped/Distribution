...
/* Inlined arcgis-js-api.__esri.WFSLayerProperties & {  type :'wfs'} */
trait WFSLayerPropertiestypewfs extends StObject {
...
object WFSLayerPropertiestypewfs {
  ...
  inline def apply(): WFSLayerPropertiestypewfs = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("wfs")
    __obj.asInstanceOf[WFSLayerPropertiestypewfs]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WFSLayerPropertiestypewfs] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: wfs): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
