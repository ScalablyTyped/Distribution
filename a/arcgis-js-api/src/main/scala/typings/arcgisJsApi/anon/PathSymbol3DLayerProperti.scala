...
import typings.arcgisJsApi.esri.PathSymbol3DLayerMaterialProperties
...
object PathSymbol3DLayerProperti {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PathSymbol3DLayerProperti] (val x: Self) extends AnyVal {
