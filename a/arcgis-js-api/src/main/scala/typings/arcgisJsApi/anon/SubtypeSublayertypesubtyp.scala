...
import typings.arcgisJsApi.esri.CreatePopupTemplateOptions
...
import typings.arcgisJsApi.esri.SubtypeSublayerQueryAttachmentsOptions
...
/* Inlined arcgis-js-api.__esri.SubtypeSublayer & {  type :'subtype-sublayer'} */
@js.native
trait SubtypeSublayertypesubtyp extends StObject {
