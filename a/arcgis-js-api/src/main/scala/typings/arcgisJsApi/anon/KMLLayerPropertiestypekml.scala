...
/* Inlined arcgis-js-api.__esri.KMLLayerProperties & {  type :'kml'} */
trait KMLLayerPropertiestypekml extends StObject {
...
object KMLLayerPropertiestypekml {
  
  inline def apply(): KMLLayerPropertiestypekml = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("kml")
    __obj.asInstanceOf[KMLLayerPropertiestypekml]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KMLLayerPropertiestypekml] (val x: Self) extends AnyVal {
    ...
    inline def setType(value: kml): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
