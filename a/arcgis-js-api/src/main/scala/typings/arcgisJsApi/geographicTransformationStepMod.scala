...
object geographicTransformationStepMod extends Shortcut {
  ...
  @js.native
  val ^ : GeographicTransformationStepConstructor = js.native
  ...
  type _To = GeographicTransformationStepConstructor
  
  /* This means you don't have to write `^`, but can instead just say `geographicTransformationStepMod.foo` */
  override def _to: GeographicTransformationStepConstructor = ^
}
