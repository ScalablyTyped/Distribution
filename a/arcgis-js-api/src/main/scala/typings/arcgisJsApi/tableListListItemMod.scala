...
object tableListListItemMod extends Shortcut {
  ...
  @JSImport("esri/widgets/TableList/ListItem", JSImport.Namespace)
  @js.native
  class Class () extends TableListListItem
  
  type _To = TableListListItemConstructor
  
  /* This means you don't have to write `^`, but can instead just say `tableListListItemMod.foo` */
