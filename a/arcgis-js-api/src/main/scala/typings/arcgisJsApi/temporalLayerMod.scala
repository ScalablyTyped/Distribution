...
object temporalLayerMod extends Shortcut {
  ...
  @JSImport("esri/layers/mixins/TemporalLayer", JSImport.Namespace)
  @js.native
  class Class () extends TemporalLayer
  
  type _To = TemporalLayerConstructor
  
  /* This means you don't have to write `^`, but can instead just say `temporalLayerMod.foo` */
