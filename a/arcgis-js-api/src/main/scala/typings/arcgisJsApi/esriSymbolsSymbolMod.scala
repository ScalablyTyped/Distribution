...
object esriSymbolsSymbolMod {
  ...
  inline def fromJSON(json: Any): Symbol = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[Symbol]
}
