...
trait FeatureLayerQueryTopFeatureCountOptions extends StObject {
...
object FeatureLayerQueryTopFeatureCountOptions {
  ...
  inline def apply(): FeatureLayerQueryTopFeatureCountOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FeatureLayerQueryTopFeatureCountOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FeatureLayerQueryTopFeatureCountOptions] (val x: Self) extends AnyVal {
