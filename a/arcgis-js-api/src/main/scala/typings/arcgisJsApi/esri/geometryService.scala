...
trait geometryService extends StObject {
  ...
  /**
  		 ...
  		 */
  def autoComplete(url: String, polygons: js.Array[Polygon], polylines: js.Array[Polyline]): js.Promise[js.Array[Polygon]] = js.native
  def autoComplete(url: String, polygons: js.Array[Polygon], polylines: js.Array[Polyline], requestOptions: Any): js.Promise[js.Array[Polygon]] = js.native
  ...
  /**
  		 ...
  		 */
  def labelPoints(url: String, polygons: js.Array[Polygon]): js.Promise[js.Array[Point]] = js.native
  def labelPoints(url: String, polygons: js.Array[Polygon], requestOptions: Any): js.Promise[js.Array[Point]] = js.native
