...
trait KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations extends StObject {
...
object KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations {
  
  inline def apply(centroid: Boolean, convexHull: Boolean, envelope: Boolean): KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations = {
    ...
    __obj.asInstanceOf[KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations] (val x: Self) extends AnyVal {
