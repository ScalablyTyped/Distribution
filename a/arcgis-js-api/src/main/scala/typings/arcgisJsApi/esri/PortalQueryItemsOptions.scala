...
@js.native
trait PortalQueryItemsOptions extends Object {
...
object PortalQueryItemsOptions {
  ...
  @scala.inline
  implicit class PortalQueryItemsOptionsMutableBuilder[Self <: PortalQueryItemsOptions] (val x: Self) extends AnyVal {
