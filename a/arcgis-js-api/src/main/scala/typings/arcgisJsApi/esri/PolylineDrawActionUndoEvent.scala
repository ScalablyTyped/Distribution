...
@js.native
trait PolylineDrawActionUndoEvent extends js.Object {
...
object PolylineDrawActionUndoEvent {
  ...
  @scala.inline
  implicit class PolylineDrawActionUndoEventOps[Self <: PolylineDrawActionUndoEvent] (val x: Self) extends AnyVal {
