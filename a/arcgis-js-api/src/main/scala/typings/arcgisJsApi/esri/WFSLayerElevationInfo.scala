...
trait WFSLayerElevationInfo extends StObject {
...
object WFSLayerElevationInfo {
  ...
  inline def apply(mode: `on-the-ground` | `relative-to-ground` | `absolute-height` | `relative-to-scene`): WFSLayerElevationInfo = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    __obj.asInstanceOf[WFSLayerElevationInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WFSLayerElevationInfo] (val x: Self) extends AnyVal {
