...
trait KnowledgeGraphSublayerCapabilitiesAttachment extends StObject {
...
object KnowledgeGraphSublayerCapabilitiesAttachment {
  ...
  inline def apply(
  ...
  ): KnowledgeGraphSublayerCapabilitiesAttachment = {
    ...
    __obj.asInstanceOf[KnowledgeGraphSublayerCapabilitiesAttachment]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KnowledgeGraphSublayerCapabilitiesAttachment] (val x: Self) extends AnyVal {
