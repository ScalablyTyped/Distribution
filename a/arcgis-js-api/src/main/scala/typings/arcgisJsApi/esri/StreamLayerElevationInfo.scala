...
object StreamLayerElevationInfo {
  ...
  @scala.inline
  implicit class StreamLayerElevationInfoMutableBuilder[Self <: StreamLayerElevationInfo] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setFeatureExpressionInfo(value: StreamLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
