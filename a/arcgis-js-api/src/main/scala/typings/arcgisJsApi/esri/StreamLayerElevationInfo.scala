...
@js.native
trait StreamLayerElevationInfo extends Object {
  /**
    ...
    */
  var featureExpressionInfo: js.UndefOr[StreamLayerElevationInfoFeatureExpressionInfo] = js.native
  /**
...
object StreamLayerElevationInfo {
  ...
  @scala.inline
  implicit class StreamLayerElevationInfoOps[Self <: StreamLayerElevationInfo] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFeatureExpressionInfo(value: StreamLayerElevationInfoFeatureExpressionInfo): Self = this.set("featureExpressionInfo", value.asInstanceOf[js.Any])
    @scala.inline
