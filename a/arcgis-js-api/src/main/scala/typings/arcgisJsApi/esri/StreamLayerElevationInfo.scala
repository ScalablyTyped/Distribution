...
trait StreamLayerElevationInfo extends StObject {
  ...
  /**
    ...
    */
  var featureExpressionInfo: js.UndefOr[StreamLayerElevationInfoFeatureExpressionInfo] = js.undefined
...
object StreamLayerElevationInfo {
  
  inline def apply(mode: `on-the-ground` | `relative-to-ground` | `absolute-height` | `relative-to-scene`): StreamLayerElevationInfo = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    __obj.asInstanceOf[StreamLayerElevationInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StreamLayerElevationInfo] (val x: Self) extends AnyVal {
    
    inline def setFeatureExpressionInfo(value: StreamLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
