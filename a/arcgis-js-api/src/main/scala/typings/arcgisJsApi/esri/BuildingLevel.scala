...
@js.native
trait BuildingLevel extends js.Object {
  /**
  ...
  /**
    * Selects the next value, if available. If [enabled](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-BuildingExplorer-BuildingLevel.html#enabled) is `false`, the first allowed value is selected.
    *
  ...
  /**
    * Selects the previous value, if available. If [enabled](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-BuildingExplorer-BuildingLevel.html#enabled) is `false`, the last allowed value is selected.
    *
  ...
  /**
    * Selects the specified value for the filter. In case the filter is disabled, this method also enables it by setting [enabled](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-BuildingExplorer-BuildingLevel.html#enabled) to `true`.
    *
...
object BuildingLevel {
  ...
  def apply(
    ...
    __obj.asInstanceOf[BuildingLevel]
  }
  @scala.inline
  implicit class BuildingLevelOps[Self <: BuildingLevel] (val x: Self) extends AnyVal {
    @scala.inline
