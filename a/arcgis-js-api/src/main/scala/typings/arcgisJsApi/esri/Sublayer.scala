...
trait Sublayer
  ...
  /**
  		 ...
  		 */
  val capabilities: SublayerCapabilities = js.native
  ...
  /**
  		 ...
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-support-Sublayer.html#parent)
  		 */
  var parent: Sublayer | MapImageLayer | TileLayer = js.native
