...
trait FeatureLayerView
  ...
  /**
    * Creates query parameter object that can be used to [fetch aggregate features](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-layers-FeatureLayerView.html#queryAggregates) as they are being displayed.
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-layers-FeatureLayerView.html#createAggregateQuery)
    */
  ...
  def queryAggregates(query: scala.Unit, options: FeatureLayerViewQueryAggregatesOptions): js.Promise[FeatureSet] = js.native
  def queryAggregates(query: QueryProperties): js.Promise[FeatureSet] = js.native
  def queryAggregates(query: QueryProperties, options: FeatureLayerViewQueryAggregatesOptions): js.Promise[FeatureSet] = js.native
  def queryAggregates(query: Query_): js.Promise[FeatureSet] = js.native
  def queryAggregates(query: Query_, options: FeatureLayerViewQueryAggregatesOptions): js.Promise[FeatureSet] = js.native
