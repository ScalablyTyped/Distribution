...
object univariateColorSizeCreateVisualVariablesParamsSizeOptionsLegendOptions {
  ...
  @scala.inline
  implicit class univariateColorSizeCreateVisualVariablesParamsSizeOptionsLegendOptionsOps[Self <: univariateColorSizeCreateVisualVariablesParamsSizeOptionsLegendOptions] (val x: Self) extends AnyVal {
    @scala.inline
