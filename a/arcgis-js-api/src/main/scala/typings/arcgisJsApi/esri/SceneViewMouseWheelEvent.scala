...
@js.native
trait SceneViewMouseWheelEvent extends StObject {
...
object SceneViewMouseWheelEvent {
  ...
  @scala.inline
  implicit class SceneViewMouseWheelEventMutableBuilder[Self <: SceneViewMouseWheelEvent] (val x: Self) extends AnyVal {
