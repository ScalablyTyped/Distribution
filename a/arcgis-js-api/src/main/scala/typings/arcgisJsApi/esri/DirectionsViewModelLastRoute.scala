...
object DirectionsViewModelLastRoute {
  ...
  implicit class DirectionsViewModelLastRouteOps[Self <: DirectionsViewModelLastRoute] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMessagesVarargs(value: DirectionsViewModelLastRouteMessages*): Self = this.set("messages", js.Array(value :_*))
    
    @scala.inline
    def setMessages(value: js.Array[DirectionsViewModelLastRouteMessages]): Self = this.set("messages", value.asInstanceOf[js.Any])
