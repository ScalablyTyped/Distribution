...
trait ScaleBarProperties
  ...
  /**
  		 ...
  		 */
  var unit: js.UndefOr[metric | imperial | dual | `non-metric`] = js.undefined
...
object ScaleBarProperties {
  ...
  implicit open class MutableBuilder[Self <: ScaleBarProperties] (val x: Self) extends AnyVal {
    ...
    inline def setUnit(value: metric | imperial | dual | `non-metric`): Self = StObject.set(x, "unit", value.asInstanceOf[js.Any])
