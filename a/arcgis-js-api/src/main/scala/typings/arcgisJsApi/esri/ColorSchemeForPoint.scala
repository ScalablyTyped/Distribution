...
object ColorSchemeForPoint {
  ...
  @scala.inline
  implicit class ColorSchemeForPointMutableBuilder[Self <: ColorSchemeForPoint] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setColors(value: js.Array[Color_]): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorsForClassBreaks(value: js.Array[ColorSchemeForPointColorsForClassBreaks]): Self = StObject.set(x, "colorsForClassBreaks", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setColorsForClassBreaksVarargs(value: ColorSchemeForPointColorsForClassBreaks*): Self = StObject.set(x, "colorsForClassBreaks", js.Array(value :_*))
    ...
    @scala.inline
    def setOutline(value: ColorSchemeForPointOutline): Self = StObject.set(x, "outline", value.asInstanceOf[js.Any])
