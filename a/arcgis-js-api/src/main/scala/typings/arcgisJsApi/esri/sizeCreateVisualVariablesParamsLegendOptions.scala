...
trait sizeCreateVisualVariablesParamsLegendOptions extends StObject {
...
object sizeCreateVisualVariablesParamsLegendOptions {
  ...
  inline def apply(): sizeCreateVisualVariablesParamsLegendOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[sizeCreateVisualVariablesParamsLegendOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: sizeCreateVisualVariablesParamsLegendOptions] (val x: Self) extends AnyVal {
