...
trait KnowledgeGraphSublayerCapabilitiesQuery extends StObject {
  ...
  /**
  		 ...
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-knowledgeGraph-KnowledgeGraphSublayer.html#Capabilities)
  		 */
  var supportedSpatialStatisticAggregations: KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations
  ...
  /**
  		 * Indicates if the layer supports queries for distinct values based on fields specified in the [outFields](https://developers.arcgis.com/javascript/latest/api-reference/esri-rest-support-Query.html#outFields).
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-knowledgeGraph-KnowledgeGraphSublayer.html#Capabilities)
  		 */
...
object KnowledgeGraphSublayerCapabilitiesQuery {
  
  inline def apply(
    maxRecordCount: Double,
    supportedSpatialStatisticAggregations: KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations,
  ...
  ): KnowledgeGraphSublayerCapabilitiesQuery = {
    ...
    __obj.asInstanceOf[KnowledgeGraphSublayerCapabilitiesQuery]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KnowledgeGraphSublayerCapabilitiesQuery] (val x: Self) extends AnyVal {
    
    inline def setMaxRecordCount(value: Double): Self = StObject.set(x, "maxRecordCount", value.asInstanceOf[js.Any])
    
    inline def setSupportedSpatialStatisticAggregations(value: KnowledgeGraphSublayerCapabilitiesQuerySupportedSpatialStatisticAggregations): Self = StObject.set(x, "supportedSpatialStatisticAggregations", value.asInstanceOf[js.Any])
