...
trait SubtypeGroupLayerCapabilitiesEditing extends StObject {
...
object SubtypeGroupLayerCapabilitiesEditing {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SubtypeGroupLayerCapabilitiesEditing] (val x: Self) extends AnyVal {
