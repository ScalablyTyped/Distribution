...
@js.native
trait PolylineDrawActionVertexRemoveEvent extends StObject {
...
object PolylineDrawActionVertexRemoveEvent {
  ...
  @scala.inline
  implicit class PolylineDrawActionVertexRemoveEventMutableBuilder[Self <: PolylineDrawActionVertexRemoveEvent] (val x: Self) extends AnyVal {
