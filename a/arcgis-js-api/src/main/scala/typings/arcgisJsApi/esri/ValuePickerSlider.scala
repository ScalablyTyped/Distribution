...
trait ValuePickerSlider extends StObject {
  ...
  def labelFormatFunction(value: Double, `type`: scala.Unit, index: Double): String
  /**
  		 * A function used to format labels.
  		 *
  		 * @default null
...
object ValuePickerSlider {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ValuePickerSlider]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ValuePickerSlider] (val x: Self) extends AnyVal {
