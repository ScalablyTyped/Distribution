...
trait OpacitySliderThumbChangeEvent extends StObject {
...
object OpacitySliderThumbChangeEvent {
  ...
  @scala.inline
  def apply(index: Double, oldValue: Double, value: Double): OpacitySliderThumbChangeEvent = {
  ...
  @scala.inline
  implicit class OpacitySliderThumbChangeEventMutableBuilder[Self <: OpacitySliderThumbChangeEvent] (val x: Self) extends AnyVal {
