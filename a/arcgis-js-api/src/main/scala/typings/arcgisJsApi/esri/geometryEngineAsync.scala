...
trait geometryEngineAsync extends js.Object {
  def buffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def buffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  def buffer(geometry: js.Array[Geometry_], distance: Double, unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def buffer(geometry: js.Array[Geometry_], distance: Double, unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  def buffer(geometry: Geometry_, distance: js.Array[Double], unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def buffer(geometry: Geometry_, distance: js.Array[Double], unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  /**
    ...
    *
    */
  def buffer(geometry: Geometry_, distance: Double, unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def buffer(geometry: Geometry_, distance: Double, unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  /**
    ...
    *
    */
  def densify(geometry: Geometry_, maxSegmentLength: Double, maxSegmentLengthUnit: String): js.Promise[Geometry_] = js.native
  ...
  /**
    ...
    *
    */
  def distance(geometry1: Geometry_, geometry2: Geometry_, distanceUnit: String): js.Promise[Double] = js.native
  ...
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: Double, unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: Double, unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  def geodesicBuffer(geometry: Geometry_, distance: js.Array[Double], unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  def geodesicBuffer(geometry: Geometry_, distance: js.Array[Double], unit: String, unionResults: Boolean): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  /**
    ...
    *
    */
  def geodesicBuffer(geometry: Geometry_, distance: Double, unit: String): js.Promise[Polygon | js.Array[Polygon]] = js.native
  ...
  /**
    ...
    *
    */
  def geodesicLength(geometry: Geometry_, unit: String): js.Promise[Double] = js.native
  ...
  /**
    ...
    *
    */
  def planarLength(geometry: Geometry_, unit: String): js.Promise[Double] = js.native
