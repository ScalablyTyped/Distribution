...
trait CapabilitiesOperations extends StObject {
...
object CapabilitiesOperations {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CapabilitiesOperations]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CapabilitiesOperations] (val x: Self) extends AnyVal {
