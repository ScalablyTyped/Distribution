...
trait LocationSchemeForPointOutline extends StObject {
...
object LocationSchemeForPointOutline {
  ...
  inline def apply(color: Color_, width: Double): LocationSchemeForPointOutline = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LocationSchemeForPointOutline] (val x: Self) extends AnyVal {
