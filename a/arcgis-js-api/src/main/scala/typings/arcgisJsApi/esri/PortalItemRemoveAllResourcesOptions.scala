...
@js.native
trait PortalItemRemoveAllResourcesOptions extends Object {
  /**
...
object PortalItemRemoveAllResourcesOptions {
  ...
  @scala.inline
  implicit class PortalItemRemoveAllResourcesOptionsOps[Self <: PortalItemRemoveAllResourcesOptions] (val x: Self) extends AnyVal {
    @scala.inline
