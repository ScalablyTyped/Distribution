...
trait PortalItemRemoveAllResourcesOptions extends StObject {
...
object PortalItemRemoveAllResourcesOptions {
  ...
  inline def apply(): PortalItemRemoveAllResourcesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PortalItemRemoveAllResourcesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PortalItemRemoveAllResourcesOptions] (val x: Self) extends AnyVal {
