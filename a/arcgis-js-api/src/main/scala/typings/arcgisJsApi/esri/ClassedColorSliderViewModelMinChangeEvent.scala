...
object ClassedColorSliderViewModelMinChangeEvent {
  ...
  @scala.inline
  def apply(oldValue: Double, value: Double): ClassedColorSliderViewModelMinChangeEvent = {
  ...
  @scala.inline
  implicit class ClassedColorSliderViewModelMinChangeEventMutableBuilder[Self <: ClassedColorSliderViewModelMinChangeEvent] (val x: Self) extends AnyVal {
