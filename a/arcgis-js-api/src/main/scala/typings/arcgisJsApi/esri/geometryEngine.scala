...
trait geometryEngine extends js.Object {
  def buffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String): Polygon | js.Array[Polygon] = js.native
  def buffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  def buffer(geometry: js.Array[Geometry_], distance: Double, unit: String): Polygon | js.Array[Polygon] = js.native
  def buffer(geometry: js.Array[Geometry_], distance: Double, unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  def buffer(geometry: Geometry_, distance: js.Array[Double], unit: String): Polygon | js.Array[Polygon] = js.native
  def buffer(geometry: Geometry_, distance: js.Array[Double], unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  /**
    ...
    *
    */
  def buffer(geometry: Geometry_, distance: Double, unit: String): Polygon | js.Array[Polygon] = js.native
  def buffer(geometry: Geometry_, distance: Double, unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  /**
    ...
    *
    */
  def densify(geometry: Geometry_, maxSegmentLength: Double, maxSegmentLengthUnit: String): Geometry_ = js.native
  ...
  /**
    ...
    *
    */
  def distance(geometry1: Geometry_, geometry2: Geometry_, distanceUnit: String): Double = js.native
  ...
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String): Polygon | js.Array[Polygon] = js.native
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: js.Array[Double], unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: Double, unit: String): Polygon | js.Array[Polygon] = js.native
  def geodesicBuffer(geometry: js.Array[Geometry_], distance: Double, unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  def geodesicBuffer(geometry: Geometry_, distance: js.Array[Double], unit: String): Polygon | js.Array[Polygon] = js.native
  def geodesicBuffer(geometry: Geometry_, distance: js.Array[Double], unit: String, unionResults: Boolean): Polygon | js.Array[Polygon] = js.native
  ...
  /**
    ...
    *
    */
  def geodesicBuffer(geometry: Geometry_, distance: Double, unit: String): Polygon | js.Array[Polygon] = js.native
  ...
  /**
    ...
    *
    */
  def geodesicLength(geometry: Geometry_, unit: String): Double = js.native
  ...
  def offset(geometry: js.Array[Geometry_], offsetDistance: Double, offsetUnit: String, joinType: String): Geometry_ | js.Array[Geometry_] = js.native
  def offset(
  ...
  def offset(geometry: js.Array[Geometry_], offsetDistance: Double, offsetUnit: Double, joinType: String): Geometry_ | js.Array[Geometry_] = js.native
  def offset(
    geometry: js.Array[Geometry_],
    offsetDistance: Double,
    offsetUnit: Double,
  ...
  /**
    ...
    *
    */
  def offset(geometry: Geometry_, offsetDistance: Double, offsetUnit: String, joinType: String): Geometry_ | js.Array[Geometry_] = js.native
  def offset(
    geometry: Geometry_,
    offsetDistance: Double,
    offsetUnit: String,
  ...
  def offset(geometry: Geometry_, offsetDistance: Double, offsetUnit: Double, joinType: String): Geometry_ | js.Array[Geometry_] = js.native
  def offset(
    geometry: Geometry_,
    offsetDistance: Double,
    offsetUnit: Double,
  ...
  /**
    ...
    *
    */
  def planarLength(geometry: Geometry_, unit: String): Double = js.native
...
@JSGlobal("__esri.geometryEngine")
@js.native
object geometryEngine extends TopLevel[geometryEngine]
