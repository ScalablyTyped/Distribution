...
@js.native
trait NavigationToggleViewModelConstructor
  extends /**
  ...
  */
Instantiable0[NavigationToggleViewModel]
     with Instantiable1[/* properties */ NavigationToggleViewModelProperties, NavigationToggleViewModel]
