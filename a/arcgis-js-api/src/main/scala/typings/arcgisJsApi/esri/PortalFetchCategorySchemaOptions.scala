...
trait PortalFetchCategorySchemaOptions extends StObject {
...
object PortalFetchCategorySchemaOptions {
  ...
  inline def apply(): PortalFetchCategorySchemaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PortalFetchCategorySchemaOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PortalFetchCategorySchemaOptions] (val x: Self) extends AnyVal {
