...
@js.native
trait GeoJSONLayerQueryExtentOptions extends Object {
  /**
...
object GeoJSONLayerQueryExtentOptions {
  ...
  ): GeoJSONLayerQueryExtentOptions = {
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
    __obj.asInstanceOf[GeoJSONLayerQueryExtentOptions]
  }
  @scala.inline
  implicit class GeoJSONLayerQueryExtentOptionsOps[Self <: GeoJSONLayerQueryExtentOptions] (val x: Self) extends AnyVal {
    @scala.inline
