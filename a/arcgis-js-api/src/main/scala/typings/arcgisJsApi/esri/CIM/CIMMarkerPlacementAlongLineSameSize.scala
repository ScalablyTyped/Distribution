...
object CIMMarkerPlacementAlongLineSameSize {
  ...
  @scala.inline
  implicit class CIMMarkerPlacementAlongLineSameSizeOps[Self <: CIMMarkerPlacementAlongLineSameSize] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineSameSize): Self = this.set("type", value.asInstanceOf[js.Any])
  }
}
