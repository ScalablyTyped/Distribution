...
trait KnowledgeGraphSublayerElevationInfo extends StObject {
  ...
  /**
  		 ...
  		 */
  var featureExpressionInfo: js.UndefOr[KnowledgeGraphSublayerElevationInfoFeatureExpressionInfo] = js.undefined
...
object KnowledgeGraphSublayerElevationInfo {
  
  inline def apply(mode: `on-the-ground` | `relative-to-ground` | `absolute-height` | `relative-to-scene`): KnowledgeGraphSublayerElevationInfo = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    __obj.asInstanceOf[KnowledgeGraphSublayerElevationInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KnowledgeGraphSublayerElevationInfo] (val x: Self) extends AnyVal {
    
    inline def setFeatureExpressionInfo(value: KnowledgeGraphSublayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
