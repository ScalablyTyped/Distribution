...
trait BasemapLayerListVisibleElements extends StObject {
...
object BasemapLayerListVisibleElements {
  
  inline def apply(): BasemapLayerListVisibleElements = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BasemapLayerListVisibleElements]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BasemapLayerListVisibleElements] (val x: Self) extends AnyVal {
