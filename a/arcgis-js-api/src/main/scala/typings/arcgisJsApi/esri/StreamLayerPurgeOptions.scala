...
object StreamLayerPurgeOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(age = age.asInstanceOf[js.Any], constructor = constructor.asInstanceOf[js.Any], displayCount = displayCount.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
