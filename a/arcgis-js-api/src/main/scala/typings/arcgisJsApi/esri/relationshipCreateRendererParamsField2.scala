...
trait relationshipCreateRendererParamsField2 extends StObject {
...
object relationshipCreateRendererParamsField2 {
  ...
  inline def apply(field: String): relationshipCreateRendererParamsField2 = {
    val __obj = js.Dynamic.literal(field = field.asInstanceOf[js.Any])
    __obj.asInstanceOf[relationshipCreateRendererParamsField2]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: relationshipCreateRendererParamsField2] (val x: Self) extends AnyVal {
