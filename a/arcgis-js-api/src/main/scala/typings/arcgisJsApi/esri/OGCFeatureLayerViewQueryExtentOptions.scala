...
@js.native
trait OGCFeatureLayerViewQueryExtentOptions extends Object {
...
object OGCFeatureLayerViewQueryExtentOptions {
  ...
  @scala.inline
  implicit class OGCFeatureLayerViewQueryExtentOptionsMutableBuilder[Self <: OGCFeatureLayerViewQueryExtentOptions] (val x: Self) extends AnyVal {
