...
object MapViewKeyDownEvent {
  ...
  inline def apply(key: String, native: js.Any, repeat: Boolean, stopPropagation: js.Function, timestamp: Double): MapViewKeyDownEvent = {
  ...
  extension [Self <: MapViewKeyDownEvent](x: Self) {
