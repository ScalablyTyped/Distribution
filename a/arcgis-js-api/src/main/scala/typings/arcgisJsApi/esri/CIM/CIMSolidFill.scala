...
object CIMSolidFill {
  ...
  @scala.inline
  implicit class CIMSolidFillOps[Self <: CIMSolidFill] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: typings.arcgisJsApi.arcgisJsApiStrings.CIMSolidFill): Self = this.set("type", value.asInstanceOf[js.Any])
