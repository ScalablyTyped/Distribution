...
trait TraceJobInfoWaitForJobCompletionOptions extends StObject {
...
object TraceJobInfoWaitForJobCompletionOptions {
  
  inline def apply(): TraceJobInfoWaitForJobCompletionOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TraceJobInfoWaitForJobCompletionOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TraceJobInfoWaitForJobCompletionOptions] (val x: Self) extends AnyVal {
