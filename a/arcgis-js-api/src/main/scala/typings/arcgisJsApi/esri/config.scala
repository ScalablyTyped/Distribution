...
trait config extends StObject {
  ...
  /**
  		 ...
  		 * @default ""
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-config.html#applicationName)
  		 */
  ...
  /**
  		 * The URL for font resources used by the [Font](https://developers.arcgis.com/javascript/latest/api-reference/esri-symbols-Font.html#family) class in non-MapImageLayer labels for both 2D MapViews and 3D SceneViews.
  		 *
...
object config {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(apiKey = apiKey.asInstanceOf[js.Any], applicationName = applicationName.asInstanceOf[js.Any], assetsPath = assetsPath.asInstanceOf[js.Any], fontsUrl = fontsUrl.asInstanceOf[js.Any], geoRSSServiceUrl = geoRSSServiceUrl.asInstanceOf[js.Any], geometryServiceUrl = geometryServiceUrl.asInstanceOf[js.Any], kmlServiceUrl = kmlServiceUrl.asInstanceOf[js.Any], log = log.asInstanceOf[js.Any], portalUrl = portalUrl.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], routeServiceUrl = routeServiceUrl.asInstanceOf[js.Any], workers = workers.asInstanceOf[js.Any])
