...
trait SnappingControlsVisibleElements extends StObject {
...
object SnappingControlsVisibleElements {
  
  inline def apply(): SnappingControlsVisibleElements = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SnappingControlsVisibleElements]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SnappingControlsVisibleElements] (val x: Self) extends AnyVal {
