...
trait pieChartCreateRendererParamsAttributes extends StObject {
...
object pieChartCreateRendererParamsAttributes {
  
  inline def apply(): pieChartCreateRendererParamsAttributes = {
