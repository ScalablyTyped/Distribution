...
@js.native
trait AreaMeasurementAnalysisConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[AreaMeasurementAnalysis]
     with Instantiable1[/* properties */ AreaMeasurementAnalysisProperties, AreaMeasurementAnalysis]
