...
trait KnowledgeGraphSublayerCapabilitiesEditing extends StObject {
  ...
  /**
  		 * Indicates if the `globalId` values provided by the client are used in editing.
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-knowledgeGraph-KnowledgeGraphSublayer.html#Capabilities)
  		 */
...
object KnowledgeGraphSublayerCapabilitiesEditing {
  ...
  inline def apply(
  ...
  ): KnowledgeGraphSublayerCapabilitiesEditing = {
    ...
    __obj.asInstanceOf[KnowledgeGraphSublayerCapabilitiesEditing]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KnowledgeGraphSublayerCapabilitiesEditing] (val x: Self) extends AnyVal {
