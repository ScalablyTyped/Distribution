...
trait PopupViewModelOpenOptions extends StObject {
...
object PopupViewModelOpenOptions {
  ...
  inline def apply(): PopupViewModelOpenOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PopupViewModelOpenOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PopupViewModelOpenOptions] (val x: Self) extends AnyVal {
