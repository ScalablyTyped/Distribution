...
trait FeatureLayerCreatePopupTemplateOptions extends Object {
  /**
...
object FeatureLayerCreatePopupTemplateOptions {
  @scala.inline
  def apply(
  ...
  ): FeatureLayerCreatePopupTemplateOptions = {
    ...
    __obj.asInstanceOf[FeatureLayerCreatePopupTemplateOptions]
  }
}
