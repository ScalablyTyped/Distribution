...
trait TraceJobInfoProperties extends StObject {
...
object TraceJobInfoProperties {
  
  inline def apply(): TraceJobInfoProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TraceJobInfoProperties]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TraceJobInfoProperties] (val x: Self) extends AnyVal {
