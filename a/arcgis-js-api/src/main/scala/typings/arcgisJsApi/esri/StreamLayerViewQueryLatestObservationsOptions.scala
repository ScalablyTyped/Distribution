...
trait StreamLayerViewQueryLatestObservationsOptions extends StObject {
...
object StreamLayerViewQueryLatestObservationsOptions {
  ...
  inline def apply(): StreamLayerViewQueryLatestObservationsOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StreamLayerViewQueryLatestObservationsOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StreamLayerViewQueryLatestObservationsOptions] (val x: Self) extends AnyVal {
