...
object CollectionBeforeRemoveEvent {
  ...
  inline def apply(cancellable: Boolean, defaultPrevented: Boolean, item: Any, preventDefault: js.Function): CollectionBeforeRemoveEvent = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CollectionBeforeRemoveEvent] (val x: Self) extends AnyVal {
