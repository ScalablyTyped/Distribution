...
trait SceneLayer
  ...
  /**
  		 ...
  		 */
  def applyEdits(edits: SceneLayerApplyEditsEdits): js.Promise[SceneLayerEditsResult] = js.native
  def applyEdits(edits: SceneLayerApplyEditsEdits, options: SceneLayerApplyEditsOptions): js.Promise[SceneLayerEditsResult] = js.native
