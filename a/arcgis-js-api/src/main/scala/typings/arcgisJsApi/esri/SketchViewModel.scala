...
trait SketchViewModel
  ...
  /**
  		 ...
  		 */
  val activeTool: point | multipoint | polyline | polygon | circle | mesh | rectangle | move | transform | reshape = js.native
  ...
  /**
  		 ...
  		 */
  def create(tool: point | multipoint | polyline | polygon | rectangle | circle | mesh): scala.Unit = js.native
  def create(
