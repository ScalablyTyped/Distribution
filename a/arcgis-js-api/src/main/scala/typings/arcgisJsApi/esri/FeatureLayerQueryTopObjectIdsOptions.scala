...
trait FeatureLayerQueryTopObjectIdsOptions extends StObject {
...
object FeatureLayerQueryTopObjectIdsOptions {
  
  inline def apply(): FeatureLayerQueryTopObjectIdsOptions = {
