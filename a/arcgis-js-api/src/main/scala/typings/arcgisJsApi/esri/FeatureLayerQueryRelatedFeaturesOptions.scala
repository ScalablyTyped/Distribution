...
trait FeatureLayerQueryRelatedFeaturesOptions extends StObject {
...
object FeatureLayerQueryRelatedFeaturesOptions {
  ...
  inline def apply(): FeatureLayerQueryRelatedFeaturesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FeatureLayerQueryRelatedFeaturesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FeatureLayerQueryRelatedFeaturesOptions] (val x: Self) extends AnyVal {
