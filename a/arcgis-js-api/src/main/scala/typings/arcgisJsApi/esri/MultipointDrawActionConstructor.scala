...
@js.native
trait MultipointDrawActionConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[MultipointDrawAction]
     with Instantiable1[/* properties */ MultipointDrawActionProperties, MultipointDrawAction]
