...
trait SliderThumbChangeEvent extends StObject {
...
object SliderThumbChangeEvent {
  ...
  @scala.inline
  def apply(index: Double, oldValue: Double, value: Double): SliderThumbChangeEvent = {
  ...
  @scala.inline
  implicit class SliderThumbChangeEventMutableBuilder[Self <: SliderThumbChangeEvent] (val x: Self) extends AnyVal {
