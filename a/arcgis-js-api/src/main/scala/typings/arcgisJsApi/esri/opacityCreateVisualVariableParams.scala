...
trait opacityCreateVisualVariableParams extends StObject {
...
object opacityCreateVisualVariableParams {
  ...
  inline def apply(layer: FeatureLayer | SceneLayer | CSVLayer | GeoJSONLayer | WFSLayer | OGCFeatureLayer): opacityCreateVisualVariableParams = {
    val __obj = js.Dynamic.literal(layer = layer.asInstanceOf[js.Any])
    __obj.asInstanceOf[opacityCreateVisualVariableParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: opacityCreateVisualVariableParams] (val x: Self) extends AnyVal {
