...
trait MapViewPointerLeaveEvent extends StObject {
...
object MapViewPointerLeaveEvent {
  ...
  inline def apply(
    ...
    __obj.updateDynamic("type")("pointer-leave")
    __obj.asInstanceOf[MapViewPointerLeaveEvent]
  }
  
  extension [Self <: MapViewPointerLeaveEvent](x: Self) {
    ...
    inline def setType(value: `pointer-leave`): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
