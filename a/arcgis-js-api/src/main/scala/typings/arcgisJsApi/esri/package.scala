...
package object esri {
  ...
  */
  ...
  type StreamLayerEditsEventHandler = js.Function1[/* event */ typings.arcgisJsApi.esri.StreamLayerEditsEvent, scala.Unit]
  ...
  type StreamLayerViewProperties = typings.arcgisJsApi.esri.LayerViewProperties
