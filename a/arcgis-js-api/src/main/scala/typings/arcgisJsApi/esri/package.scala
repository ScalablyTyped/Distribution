...
package object esri {
  ...
  */
  ...
  type LogInterceptor = js.Function3[
    /* level */ typings.arcgisJsApi.arcgisJsApiStrings.error | typings.arcgisJsApi.arcgisJsApiStrings.warn | typings.arcgisJsApi.arcgisJsApiStrings.info, 
