...
trait UtilityNetworkTraceProps extends StObject {
...
object UtilityNetworkTraceProps {
  
  inline def apply(): UtilityNetworkTraceProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UtilityNetworkTraceProps]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UtilityNetworkTraceProps] (val x: Self) extends AnyVal {
