...
object ImageServiceIdentifyResultProperties {
  ...
  inline def apply(): ImageServiceIdentifyResultProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ImageServiceIdentifyResultProperties]
  }
  
  extension [Self <: ImageServiceIdentifyResultProperties](x: Self) {
    ...
    inline def setCatalogItemVisibilitiesVarargs(value: Double*): Self = StObject.set(x, "catalogItemVisibilities", js.Array(value :_*))
