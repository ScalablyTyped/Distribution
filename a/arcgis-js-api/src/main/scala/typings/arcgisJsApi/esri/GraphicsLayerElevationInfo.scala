...
object GraphicsLayerElevationInfo {
  ...
  inline def apply(mode: `on-the-ground` | `relative-to-ground` | `absolute-height` | `relative-to-scene`): GraphicsLayerElevationInfo = {
    val __obj = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    __obj.asInstanceOf[GraphicsLayerElevationInfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GraphicsLayerElevationInfo] (val x: Self) extends AnyVal {
