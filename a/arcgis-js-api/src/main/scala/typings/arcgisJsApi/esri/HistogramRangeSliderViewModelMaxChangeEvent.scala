...
object HistogramRangeSliderViewModelMaxChangeEvent {
  ...
  inline def apply(oldValue: Double, value: Double): HistogramRangeSliderViewModelMaxChangeEvent = {
    val __obj = js.Dynamic.literal(oldValue = oldValue.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("max")
    __obj.asInstanceOf[HistogramRangeSliderViewModelMaxChangeEvent]
  }
  
  extension [Self <: HistogramRangeSliderViewModelMaxChangeEvent](x: Self) {
