...
trait ArcGISImageService extends StObject {
  ...
  /**
  		 ...
  		 */
  def generateRasterInfo(rasterFunction: RasterFunction): js.Promise[RasterInfo] = js.native
  def generateRasterInfo(rasterFunction: RasterFunctionProperties): js.Promise[RasterInfo] = js.native
  def generateRasterInfo(rasterFunction: RasterFunctionProperties, options: ArcGISImageServiceGenerateRasterInfoOptions): js.Promise[RasterInfo] = js.native
  def generateRasterInfo(rasterFunction: RasterFunction, options: ArcGISImageServiceGenerateRasterInfoOptions): js.Promise[RasterInfo] = js.native
