...
object colorRampsColorRamp {
  ...
  implicit class colorRampsColorRampOps[Self <: colorRampsColorRamp] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColorsForClassBreaksVarargs(value: ColorRampColorsForClassBreaks*): Self = this.set("colorsForClassBreaks", js.Array(value :_*))
    
    @scala.inline
    def setColorsForClassBreaks(value: js.Array[ColorRampColorsForClassBreaks]): Self = this.set("colorsForClassBreaks", value.asInstanceOf[js.Any])
