...
object DotDensitySchemes {
  ...
  implicit class DotDensitySchemesOps[Self <: DotDensitySchemes] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPrimaryScheme(value: DotDensityScheme): Self = this.set("primaryScheme", value.asInstanceOf[js.Any])
    @scala.inline
    def setSecondarySchemesVarargs(value: DotDensityScheme*): Self = this.set("secondarySchemes", js.Array(value :_*))
    @scala.inline
    def setSecondarySchemes(value: js.Array[DotDensityScheme]): Self = this.set("secondarySchemes", value.asInstanceOf[js.Any])
  }
