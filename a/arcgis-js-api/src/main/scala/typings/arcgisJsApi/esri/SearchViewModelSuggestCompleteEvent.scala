...
object SearchViewModelSuggestCompleteEvent {
  ...
  @scala.inline
  implicit class SearchViewModelSuggestCompleteEventMutableBuilder[Self <: SearchViewModelSuggestCompleteEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setResults(value: js.Array[SearchViewModelSuggestCompleteEventResults]): Self = StObject.set(x, "results", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResultsVarargs(value: SearchViewModelSuggestCompleteEventResults*): Self = StObject.set(x, "results", js.Array(value :_*))
