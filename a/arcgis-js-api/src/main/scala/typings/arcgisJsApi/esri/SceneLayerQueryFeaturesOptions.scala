...
trait SceneLayerQueryFeaturesOptions extends StObject {
...
object SceneLayerQueryFeaturesOptions {
  ...
  inline def apply(): SceneLayerQueryFeaturesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SceneLayerQueryFeaturesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SceneLayerQueryFeaturesOptions] (val x: Self) extends AnyVal {
