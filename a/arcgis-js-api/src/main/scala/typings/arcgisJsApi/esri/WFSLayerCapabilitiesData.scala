...
trait WFSLayerCapabilitiesData extends StObject {
...
object WFSLayerCapabilitiesData {
  ...
  inline def apply(supportsAttachment: Boolean, supportsM: Boolean, supportsZ: Boolean): WFSLayerCapabilitiesData = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: WFSLayerCapabilitiesData] (val x: Self) extends AnyVal {
