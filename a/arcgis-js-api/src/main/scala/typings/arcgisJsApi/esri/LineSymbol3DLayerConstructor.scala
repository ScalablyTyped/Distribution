...
@js.native
trait LineSymbol3DLayerConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[LineSymbol3DLayer]
     with Instantiable1[/* properties */ LineSymbol3DLayerProperties, LineSymbol3DLayer] {
  
  def fromJSON(json: js.Any): LineSymbol3DLayer = js.native
}
