...
@js.native
trait FillSymbol3DLayerConstructor
  extends /**
  ...
  */
Instantiable0[FillSymbol3DLayer]
     with Instantiable1[/* properties */ FillSymbol3DLayerProperties, FillSymbol3DLayer] {
  
  def fromJSON(json: js.Any): FillSymbol3DLayer = js.native
}
