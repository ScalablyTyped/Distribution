...
object LayerView2DMixinProperties {
  ...
  inline def apply(): LayerView2DMixinProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LayerView2DMixinProperties]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LayerView2DMixinProperties] (val x: Self) extends AnyVal {
