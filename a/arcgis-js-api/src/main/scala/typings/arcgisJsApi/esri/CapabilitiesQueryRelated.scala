...
trait CapabilitiesQueryRelated extends StObject {
...
object CapabilitiesQueryRelated {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CapabilitiesQueryRelated]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CapabilitiesQueryRelated] (val x: Self) extends AnyVal {
