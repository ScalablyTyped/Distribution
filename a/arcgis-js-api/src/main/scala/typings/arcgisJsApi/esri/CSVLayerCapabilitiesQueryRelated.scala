...
trait CSVLayerCapabilitiesQueryRelated extends StObject {
...
object CSVLayerCapabilitiesQueryRelated {
  ...
  inline def apply(supportsCount: Boolean, supportsOrderBy: Boolean, supportsPagination: Boolean): CSVLayerCapabilitiesQueryRelated = {
