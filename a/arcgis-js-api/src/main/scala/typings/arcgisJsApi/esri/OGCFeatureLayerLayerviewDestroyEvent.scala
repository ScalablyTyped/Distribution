...
@js.native
trait OGCFeatureLayerLayerviewDestroyEvent extends js.Object {
...
object OGCFeatureLayerLayerviewDestroyEvent {
  ...
  @scala.inline
  implicit class OGCFeatureLayerLayerviewDestroyEventOps[Self <: OGCFeatureLayerLayerviewDestroyEvent] (val x: Self) extends AnyVal {
