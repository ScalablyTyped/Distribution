...
trait ValuePickerCombobox extends StObject {
...
object ValuePickerCombobox {
  
  inline def apply(items: js.Array[ComboboxItem], label: String, placeholder: String): ValuePickerCombobox = {
    ...
    __obj.asInstanceOf[ValuePickerCombobox]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ValuePickerCombobox] (val x: Self) extends AnyVal {
