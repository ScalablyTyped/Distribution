...
object SceneViewKeyDownEvent {
  ...
  inline def apply(key: String, native: js.Any, repeat: Boolean, stopPropagation: js.Function, timestamp: Double): SceneViewKeyDownEvent = {
  ...
  extension [Self <: SceneViewKeyDownEvent](x: Self) {
