...
trait SceneLayerQueryCachedStatisticsOptions
  extends StObject
     with Object {
...
object SceneLayerQueryCachedStatisticsOptions {
  ...
  @scala.inline
  implicit class SceneLayerQueryCachedStatisticsOptionsMutableBuilder[Self <: SceneLayerQueryCachedStatisticsOptions] (val x: Self) extends AnyVal {
