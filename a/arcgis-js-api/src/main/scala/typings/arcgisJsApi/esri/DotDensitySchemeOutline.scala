...
object DotDensitySchemeOutline {
  ...
  inline def apply(color: Color_, width: Double): DotDensitySchemeOutline = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DotDensitySchemeOutline] (val x: Self) extends AnyVal {
