...
object TypeSchemeForPolygon {
  ...
  @scala.inline
  implicit class TypeSchemeForPolygonOps[Self <: TypeSchemeForPolygon] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutline(value: TypeSchemeForPolygonOutline): Self = this.set("outline", value.asInstanceOf[js.Any])
