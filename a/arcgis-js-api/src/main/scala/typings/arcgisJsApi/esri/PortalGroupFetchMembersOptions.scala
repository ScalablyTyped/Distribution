...
trait PortalGroupFetchMembersOptions extends StObject {
...
object PortalGroupFetchMembersOptions {
  ...
  inline def apply(): PortalGroupFetchMembersOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PortalGroupFetchMembersOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PortalGroupFetchMembersOptions] (val x: Self) extends AnyVal {
