...
trait ColorSizeSliderViewModelStopInfo extends StObject {
...
object ColorSizeSliderViewModelStopInfo {
  ...
  inline def apply(color: Color_, offset: Double): ColorSizeSliderViewModelStopInfo = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorSizeSliderViewModelStopInfo] (val x: Self) extends AnyVal {
