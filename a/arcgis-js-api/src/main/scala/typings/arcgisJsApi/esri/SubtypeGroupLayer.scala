...
trait SubtypeGroupLayer
  ...
  /**
  		 * Returns the sublayer with the [subtypeCode](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-support-SubtypeSublayer.html#subtypeCode) that matches the number passed as an argument.
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-SubtypeGroupLayer.html#findSublayerForSubtypeCode)
  		 */
  def findSublayerForSubtypeCode(subtypeCode: Double): SubtypeSublayer = js.native
