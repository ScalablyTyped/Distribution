...
@js.native
trait BuildingSceneLayerViewConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[BuildingSceneLayerView]
     with Instantiable1[/* properties */ BuildingSceneLayerViewProperties, BuildingSceneLayerView]
