...
import typings.arcgisJsApi.arcgisJsApiStrings.`editing-attributes`
...
trait EditorViewModel
  ...
  /**
  		 ...
  		 */
  val state: `adding-attachment` | `awaiting-feature-creation-info` | `awaiting-feature-to-create` | `awaiting-feature-to-update` | `awaiting-update-feature-candidate` | `creating-features` | disabled | `editing-attributes` | `editing-attachment` | `editing-existing-feature` | `editing-new-feature` | ready = js.native
  ...
  /**
  		 ...
  		 *
  		 * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Editor-EditorViewModel.html#toggleUpdateWorkflow)
  		 */
  def toggleUpdateWorkflow(): scala.Unit = js.native
