...
object ViewImmediateClickEvent {
  ...
  @scala.inline
  implicit class ViewImmediateClickEventOps[Self <: ViewImmediateClickEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: `immediate-click`): Self = this.set("type", value.asInstanceOf[js.Any])
