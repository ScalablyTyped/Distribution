...
object SceneViewHoldEvent {
  ...
  @scala.inline
  implicit class SceneViewHoldEventOps[Self <: SceneViewHoldEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: hold): Self = this.set("type", value.asInstanceOf[js.Any])
