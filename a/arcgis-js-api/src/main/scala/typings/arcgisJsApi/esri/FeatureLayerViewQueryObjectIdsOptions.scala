...
trait FeatureLayerViewQueryObjectIdsOptions
  extends StObject
     with Object {
...
object FeatureLayerViewQueryObjectIdsOptions {
  ...
  @scala.inline
  implicit class FeatureLayerViewQueryObjectIdsOptionsMutableBuilder[Self <: FeatureLayerViewQueryObjectIdsOptions] (val x: Self) extends AnyVal {
