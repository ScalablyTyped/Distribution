...
object sizeGetSchemesParams {
  ...
  @scala.inline
  implicit class sizeGetSchemesParamsMutableBuilder[Self <: sizeGetSchemesParams] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGeometryType(value: point | multipoint | polyline | polygon): Self = StObject.set(x, "geometryType", value.asInstanceOf[js.Any])
