...
object sizeGetSchemesParams {
  ...
  @scala.inline
  implicit class sizeGetSchemesParamsOps[Self <: sizeGetSchemesParams] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setGeometryType(value: point | multipoint | polyline | polygon): Self = this.set("geometryType", value.asInstanceOf[js.Any])
    @scala.inline
