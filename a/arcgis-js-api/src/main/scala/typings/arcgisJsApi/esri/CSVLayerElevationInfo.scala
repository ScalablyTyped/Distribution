...
trait CSVLayerElevationInfo extends StObject {
...
object CSVLayerElevationInfo {
  ...
  inline def apply(mode: `on-the-ground` | `relative-to-ground` | `absolute-height` | `relative-to-scene`): CSVLayerElevationInfo = {
