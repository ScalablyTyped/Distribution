...
trait GeoJSONLayerCapabilitiesQueryRelated extends StObject {
...
object GeoJSONLayerCapabilitiesQueryRelated {
  ...
  inline def apply(supportsCount: Boolean, supportsOrderBy: Boolean, supportsPagination: Boolean): GeoJSONLayerCapabilitiesQueryRelated = {
