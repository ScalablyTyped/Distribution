...
@js.native
trait BuildingComponentSublayerViewQueryObjectIdsOptions extends Object {
...
object BuildingComponentSublayerViewQueryObjectIdsOptions {
  ...
  @scala.inline
  implicit class BuildingComponentSublayerViewQueryObjectIdsOptionsOps[Self <: BuildingComponentSublayerViewQueryObjectIdsOptions] (val x: Self) extends AnyVal {
