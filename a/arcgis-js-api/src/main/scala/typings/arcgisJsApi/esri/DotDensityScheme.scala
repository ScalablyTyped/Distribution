...
object DotDensityScheme {
  ...
  @scala.inline
  implicit class DotDensitySchemeOps[Self <: DotDensityScheme] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutline(value: DotDensitySchemeOutline): Self = this.set("outline", value.asInstanceOf[js.Any])
