...
trait FeatureLayerQueryFeaturesOptions extends StObject {
...
object FeatureLayerQueryFeaturesOptions {
  ...
  inline def apply(): FeatureLayerQueryFeaturesOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FeatureLayerQueryFeaturesOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FeatureLayerQueryFeaturesOptions] (val x: Self) extends AnyVal {
