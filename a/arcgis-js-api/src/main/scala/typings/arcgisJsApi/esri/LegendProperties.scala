...
trait LegendProperties
  ...
  /**
  		 ...
  		 *
  		 * @deprecated since 4.27. Use {@link module:esri/widgets/Legend#icon icon} instead.
  		 *
...
object LegendProperties {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LegendProperties] (val x: Self) extends AnyVal {
