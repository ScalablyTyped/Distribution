...
trait CSVLayerViewQueryFeatureCountOptions extends StObject {
...
object CSVLayerViewQueryFeatureCountOptions {
  ...
  inline def apply(): CSVLayerViewQueryFeatureCountOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSVLayerViewQueryFeatureCountOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSVLayerViewQueryFeatureCountOptions] (val x: Self) extends AnyVal {
