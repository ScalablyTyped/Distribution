...
object MapViewDragEvent {
  ...
  @scala.inline
  implicit class MapViewDragEventOps[Self <: MapViewDragEvent] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setOrigin(value: MapViewDragEventOrigin): Self = this.set("origin", value.asInstanceOf[js.Any])
    @scala.inline
