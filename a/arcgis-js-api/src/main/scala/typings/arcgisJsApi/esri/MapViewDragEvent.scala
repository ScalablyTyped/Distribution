...
object MapViewDragEvent {
  ...
  @scala.inline
  implicit class MapViewDragEventMutableBuilder[Self <: MapViewDragEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOrigin(value: MapViewDragEventOrigin): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
