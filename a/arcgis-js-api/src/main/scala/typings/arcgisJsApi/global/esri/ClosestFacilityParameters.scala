...
/**
		 ...
		 */
open class ClosestFacilityParameters ()
  extends StObject
...
/* static members */
object ClosestFacilityParameters {
  
  @JSGlobal("__esri.ClosestFacilityParameters")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.ClosestFacilityParameters = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ClosestFacilityParameters]
}
