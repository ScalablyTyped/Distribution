...
object BarChartMediaInfo {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.BarChartMediaInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.BarChartMediaInfo]
}
