...
/**
  ...
  */
open class ImageSampleParameters ()
  extends StObject
...
/* static members */
object ImageSampleParameters {
  
  @JSGlobal("__esri.ImageSampleParameters")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.ImageSampleParameters = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ImageSampleParameters]
}
