...
object LinearUnit {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.LinearUnit = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.LinearUnit]
}
