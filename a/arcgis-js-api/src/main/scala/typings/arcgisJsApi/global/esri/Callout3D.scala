...
object Callout3D {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.Callout3D = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.Callout3D]
}
