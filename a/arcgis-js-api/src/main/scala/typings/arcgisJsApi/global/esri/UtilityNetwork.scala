...
object UtilityNetwork {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.UtilityNetwork = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.UtilityNetwork]
}
