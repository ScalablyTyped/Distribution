...
open class WMSLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.WMSLayer {
...
object WMSLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WMSLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WMSLayer]
}
