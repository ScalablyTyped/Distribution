...
open class FieldInfo ()
  extends StObject
     with typings.arcgisJsApi.esri.FieldInfo {
...
object FieldInfo {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.FieldInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.FieldInfo]
}
