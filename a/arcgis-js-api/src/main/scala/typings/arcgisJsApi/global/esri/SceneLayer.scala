...
object SceneLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.SceneLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.SceneLayer]
}
