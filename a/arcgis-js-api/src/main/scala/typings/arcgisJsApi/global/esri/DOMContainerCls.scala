...
class DOMContainerCls ()
  extends typings.arcgisJsApi.esri.DOMContainer {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var popup: typings.arcgisJsApi.esri.Popup = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ui: typings.arcgisJsApi.esri.DefaultUI = js.native
  /**
