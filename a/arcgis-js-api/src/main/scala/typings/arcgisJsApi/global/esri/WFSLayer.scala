...
object WFSLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WFSLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WFSLayer]
  ...
  /**
    ...
    */
  inline def fromWFSLayerInfo(layerInfo: WFSLayerInfo): typings.arcgisJsApi.esri.WFSLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromWFSLayerInfo")(layerInfo.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WFSLayer]
}
