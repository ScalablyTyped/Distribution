...
@JSGlobal("__esri.VoxelVariableStyle")
@js.native
/**
		 ...
		 */
open class VoxelVariableStyle ()
  extends StObject
     with typings.arcgisJsApi.esri.VoxelVariableStyle {
  ...
  /**
  		 ...
  		 */
  /* CompleteClass */
  var isosurfaces: typings.arcgisJsApi.esri.Collection[VoxelIsosurface] = js.native
  ...
  /**
  		 ...
  		 */
  /* CompleteClass */
  var transferFunction: typings.arcgisJsApi.esri.VoxelTransferFunctionStyle = js.native
  ...
  /**
  		 ...
  		 */
  /* CompleteClass */
  var uniqueValues: typings.arcgisJsApi.esri.Collection[VoxelUniqueValue] = js.native
...
object VoxelVariableStyle {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.VoxelVariableStyle = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.VoxelVariableStyle]
}
