...
/**
		 ...
		 */
open class WebTileLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.WebTileLayer {
...
object WebTileLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WebTileLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WebTileLayer]
}
