...
object CSVLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.CSVLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.CSVLayer]
}
