...
/**
		 ...
		 */
open class RouteLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.RouteLayer {
...
object RouteLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.RouteLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.RouteLayer]
}
