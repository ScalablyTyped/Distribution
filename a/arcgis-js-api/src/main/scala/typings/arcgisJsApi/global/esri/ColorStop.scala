...
object ColorStop {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.ColorStop = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ColorStop]
}
