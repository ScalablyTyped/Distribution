...
/**
		 ...
		 */
open class ColumnChartMediaInfo ()
  extends StObject
...
object ColumnChartMediaInfo {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.ColumnChartMediaInfo = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ColumnChartMediaInfo]
}
