...
/**
  ...
  */
class ListItemCls ()
  extends typings.arcgisJsApi.esri.ListItem {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var actionsSections: typings.arcgisJsApi.esri.Collection[
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var children: typings.arcgisJsApi.esri.Collection[typings.arcgisJsApi.esri.ListItem] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var layer: typings.arcgisJsApi.esri.Layer = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val layerView: typings.arcgisJsApi.esri.LayerView = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var panel: typings.arcgisJsApi.esri.ListItemPanel = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var parent: typings.arcgisJsApi.esri.ListItem = js.native
  /**
