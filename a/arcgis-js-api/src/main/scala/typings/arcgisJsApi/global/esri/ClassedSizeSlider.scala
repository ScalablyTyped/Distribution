...
object ClassedSizeSlider {
  ...
  /**
    ...
    */
  inline def fromRendererResult(rendererResult: sizeClassBreaksRendererResult): typings.arcgisJsApi.esri.ClassedSizeSlider = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRendererResult")(rendererResult.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ClassedSizeSlider]
  inline def fromRendererResult(rendererResult: sizeClassBreaksRendererResult, histogramResult: HistogramResult): typings.arcgisJsApi.esri.ClassedSizeSlider = (^.asInstanceOf[js.Dynamic].applyDynamic("fromRendererResult")(rendererResult.asInstanceOf[js.Any], histogramResult.asInstanceOf[js.Any])).asInstanceOf[typings.arcgisJsApi.esri.ClassedSizeSlider]
}
