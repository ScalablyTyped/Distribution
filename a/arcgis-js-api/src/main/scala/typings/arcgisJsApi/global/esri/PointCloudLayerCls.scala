...
/**
  ...
  */
class PointCloudLayerCls ()
  extends typings.arcgisJsApi.esri.PointCloudLayer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var spatialReference: typings.arcgisJsApi.esri.SpatialReference = js.native
  /**
