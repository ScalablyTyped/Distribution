...
/**
		 ...
		 */
open class WMTSLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.WMTSLayer {
...
object WMTSLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WMTSLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WMTSLayer]
}
