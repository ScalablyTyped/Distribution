...
/**
  ...
  */
open class DimensionalDefinition ()
  extends StObject
...
/* static members */
object DimensionalDefinition {
  
  @JSGlobal("__esri.DimensionalDefinition")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.DimensionalDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.DimensionalDefinition]
}
