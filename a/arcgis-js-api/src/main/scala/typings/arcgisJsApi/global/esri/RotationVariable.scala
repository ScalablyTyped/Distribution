...
/**
  ...
  */
open class RotationVariable ()
  extends StObject
     with typings.arcgisJsApi.esri.RotationVariable {
...
/* static members */
object RotationVariable {
  
  @JSGlobal("__esri.RotationVariable")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.RotationVariable = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.RotationVariable]
}
