...
/**
  ...
  */
open class WMTSStyle ()
  extends StObject
     with typings.arcgisJsApi.esri.WMTSStyle {
...
object WMTSStyle {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WMTSStyle = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WMTSStyle]
}
