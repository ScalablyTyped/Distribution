...
open class Query_ ()
  extends StObject
     with typings.arcgisJsApi.esri.Query_ {
...
object Query_ {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.Query_ = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.Query_]
}
