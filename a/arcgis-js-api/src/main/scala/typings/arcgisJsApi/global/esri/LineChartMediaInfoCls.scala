...
/**
  ...
  */
class LineChartMediaInfoCls ()
  extends typings.arcgisJsApi.esri.LineChartMediaInfo {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var value: typings.arcgisJsApi.esri.ChartMediaInfoValue = js.native
  /**
