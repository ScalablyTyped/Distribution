...
object KMLSublayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.KMLSublayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.KMLSublayer]
}
