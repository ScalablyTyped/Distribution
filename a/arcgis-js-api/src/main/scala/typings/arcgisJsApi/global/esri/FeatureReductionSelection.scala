...
/**
  ...
  */
open class FeatureReductionSelection ()
  extends StObject
...
object FeatureReductionSelection {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.FeatureReductionSelection = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.FeatureReductionSelection]
}
