...
/**
		 ...
		 */
open class SubtypeGroupLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.SubtypeGroupLayer {
...
/* static members */
object SubtypeGroupLayer {
  
  @JSGlobal("__esri.SubtypeGroupLayer")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.SubtypeGroupLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.SubtypeGroupLayer]
}
