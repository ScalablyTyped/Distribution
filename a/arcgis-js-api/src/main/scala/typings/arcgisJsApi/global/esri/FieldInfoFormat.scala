...
/* static members */
object FieldInfoFormat {
  
  @JSGlobal("__esri.FieldInfoFormat")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.FieldInfoFormat = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.FieldInfoFormat]
}
