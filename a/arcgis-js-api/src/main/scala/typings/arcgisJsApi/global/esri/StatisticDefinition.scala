...
/**
		 ...
		 */
open class StatisticDefinition ()
  extends StObject
...
/* static members */
object StatisticDefinition {
  
  @JSGlobal("__esri.StatisticDefinition")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.StatisticDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.StatisticDefinition]
}
