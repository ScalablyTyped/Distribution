...
/**
		 ...
		 */
open class WMTSSublayer ()
  extends StObject
     with typings.arcgisJsApi.esri.WMTSSublayer {
...
object WMTSSublayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.WMTSSublayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.WMTSSublayer]
}
