...
@js.native
class RasterInfoCls ()
  extends typings.arcgisJsApi.esri.RasterInfo {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var attributeTable: typings.arcgisJsApi.esri.FeatureSet = js.native
  /**
    * Raster band count.
    *
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var extent: typings.arcgisJsApi.esri.Extent = js.native
  /**
