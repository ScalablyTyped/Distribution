...
/**
		 ...
		 */
open class OGCFeatureLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.OGCFeatureLayer {
...
/* static members */
object OGCFeatureLayer {
  
  @JSGlobal("__esri.OGCFeatureLayer")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.OGCFeatureLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.OGCFeatureLayer]
}
