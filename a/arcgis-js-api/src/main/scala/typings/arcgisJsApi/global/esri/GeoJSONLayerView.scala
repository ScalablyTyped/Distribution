...
import typings.arcgisJsApi.esri.GeoJSONLayerViewProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSGlobal("__esri.GeoJSONLayerView")
@js.native
/**
  ...
  *
  * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-views-layers-GeoJSONLayerView.html)
  */
open class GeoJSONLayerView ()
  extends StObject
     with typings.arcgisJsApi.esri.GeoJSONLayerView {
  def this(properties: GeoJSONLayerViewProperties) = this()
}
