...
object SolidEdges3D {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.SolidEdges3D = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.SolidEdges3D]
}
