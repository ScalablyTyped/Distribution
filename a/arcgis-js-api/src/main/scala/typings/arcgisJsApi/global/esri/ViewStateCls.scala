...
@js.native
class ViewStateCls ()
  extends typings.arcgisJsApi.esri.ViewState {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val extent: typings.arcgisJsApi.esri.Extent = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(state: typings.arcgisJsApi.esri.ViewState): typings.arcgisJsApi.esri.ViewState = js.native
  /**
