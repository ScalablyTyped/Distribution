...
/**
		 ...
		 */
open class IntegratedMeshLayer ()
  extends StObject
...
/* static members */
object IntegratedMeshLayer {
  
  @JSGlobal("__esri.IntegratedMeshLayer")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.IntegratedMeshLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.IntegratedMeshLayer]
}
