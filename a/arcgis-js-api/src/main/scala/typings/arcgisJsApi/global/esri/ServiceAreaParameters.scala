...
/**
  ...
  */
open class ServiceAreaParameters ()
  extends StObject
     with typings.arcgisJsApi.esri.ServiceAreaParameters {
...
/* static members */
object ServiceAreaParameters {
  
  @JSGlobal("__esri.ServiceAreaParameters")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.ServiceAreaParameters = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.ServiceAreaParameters]
}
