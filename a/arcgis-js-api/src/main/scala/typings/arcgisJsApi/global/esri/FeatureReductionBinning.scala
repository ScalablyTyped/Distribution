...
/**
		 ...
		 */
open class FeatureReductionBinning ()
  extends StObject
...
/* static members */
object FeatureReductionBinning {
  
  @JSGlobal("__esri.FeatureReductionBinning")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.FeatureReductionBinning = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.FeatureReductionBinning]
}
