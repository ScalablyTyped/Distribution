...
/**
  ...
  */
open class OpenStreetMapLayer ()
  extends StObject
     with typings.arcgisJsApi.esri.OpenStreetMapLayer {
...
/* static members */
object OpenStreetMapLayer {
  
  @JSGlobal("__esri.OpenStreetMapLayer")
  @js.native
  val ^ : js.Any = js.native
  
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.OpenStreetMapLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.OpenStreetMapLayer]
}
