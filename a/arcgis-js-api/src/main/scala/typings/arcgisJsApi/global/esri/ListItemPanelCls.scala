...
class ListItemPanelCls ()
  extends typings.arcgisJsApi.esri.ListItemPanel {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var content: typings.arcgisJsApi.esri.Widget_ | HTMLElement | String | js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var listItem: typings.arcgisJsApi.esri.ListItem = js.native
  /**
