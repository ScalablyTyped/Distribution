...
object VoxelLayer {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.VoxelLayer = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.VoxelLayer]
}
