...
object VoxelSlice {
  ...
  inline def fromJSON(json: Any): typings.arcgisJsApi.esri.VoxelSlice = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[typings.arcgisJsApi.esri.VoxelSlice]
}
