...
object directLineMeasurementAnalysisView3DMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `directLineMeasurementAnalysisView3DMod.foo` */
