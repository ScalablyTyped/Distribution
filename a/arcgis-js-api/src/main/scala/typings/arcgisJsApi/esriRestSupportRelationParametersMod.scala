...
/* static members */
object esriRestSupportRelationParametersMod {
  ...
  inline def fromJSON(json: Any): RelationParameters = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[RelationParameters]
}
