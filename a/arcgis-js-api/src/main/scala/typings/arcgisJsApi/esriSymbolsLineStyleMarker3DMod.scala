...
object esriSymbolsLineStyleMarker3DMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriSymbolsLineStyleMarker3DMod.foo` */
