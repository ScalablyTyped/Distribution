...
object esriViewsDrawPolygonDrawActionMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriViewsDrawPolygonDrawActionMod.foo` */
