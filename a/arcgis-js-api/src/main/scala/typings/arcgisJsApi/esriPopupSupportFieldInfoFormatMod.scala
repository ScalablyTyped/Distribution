...
/* static members */
object esriPopupSupportFieldInfoFormatMod {
  ...
  inline def fromJSON(json: Any): FieldInfoFormat = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(json.asInstanceOf[js.Any]).asInstanceOf[FieldInfoFormat]
}
