package typings
package arcgisDashJsDashApiLib.esriWidgetsNavigationToggleMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.NavigationToggle {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.NavigationToggleProperties) = this()
}
