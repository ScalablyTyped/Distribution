...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Slider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SliderProperties) = this()
}
