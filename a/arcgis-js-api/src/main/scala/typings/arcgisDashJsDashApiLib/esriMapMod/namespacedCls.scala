package typings
package arcgisDashJsDashApiLib.esriMapMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Map {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MapProperties) = this()
}
