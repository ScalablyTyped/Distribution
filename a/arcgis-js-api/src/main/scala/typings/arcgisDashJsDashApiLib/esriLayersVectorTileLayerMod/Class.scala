package typings
package arcgisDashJsDashApiLib.esriLayersVectorTileLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VectorTileLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VectorTileLayerProperties) = this()
  /**
