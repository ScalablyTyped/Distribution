package typings
package arcgisDashJsDashApiLib.esriGeometrySupportValueMeshColorMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("esri/geometry/support/ValueMeshColor", JSImport.Namespace)
@js.native
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ValueMeshColor {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ValueMeshColorProperties) = this()
}
