package typings
package arcgisDashJsDashApiLib.esriWidgetsSmartMappingClassedColorSliderMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClassedColorSlider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClassedColorSliderProperties) = this()
}
