package typings
package arcgisDashJsDashApiLib.esriWidgetsScaleBarMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ScaleBar {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ScaleBarProperties) = this()
}
