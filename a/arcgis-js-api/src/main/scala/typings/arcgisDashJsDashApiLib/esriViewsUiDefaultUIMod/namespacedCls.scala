package typings
package arcgisDashJsDashApiLib.esriViewsUiDefaultUIMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DefaultUI {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DefaultUIProperties) = this()
}
