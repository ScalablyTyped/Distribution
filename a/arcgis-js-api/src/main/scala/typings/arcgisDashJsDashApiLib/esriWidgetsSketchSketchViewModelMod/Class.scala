package typings
package arcgisDashJsDashApiLib.esriWidgetsSketchSketchViewModelMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SketchViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SketchViewModelProperties) = this()
}
