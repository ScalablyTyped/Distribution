package typings
package arcgisDashJsDashApiLib.esriRenderersVisualVariablesSizeVariableMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SizeVariable {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SizeVariableProperties) = this()
  /**
