package typings
package arcgisDashJsDashApiLib.esriWidgetsBasemapGalleryMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BasemapGallery {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BasemapGalleryProperties) = this()
}
