package typings
package arcgisDashJsDashApiLib.esriRenderersPointCloudUniqueValueRendererMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudUniqueValueRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudUniqueValueRendererProperties) = this()
  /**
