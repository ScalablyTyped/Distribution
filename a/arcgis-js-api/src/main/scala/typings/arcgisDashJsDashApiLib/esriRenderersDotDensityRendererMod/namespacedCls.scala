package typings
package arcgisDashJsDashApiLib.esriRenderersDotDensityRendererMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DotDensityRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DotDensityRendererProperties) = this()
  /**
