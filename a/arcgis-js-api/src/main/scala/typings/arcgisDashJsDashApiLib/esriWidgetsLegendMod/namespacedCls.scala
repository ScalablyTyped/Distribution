package typings
package arcgisDashJsDashApiLib.esriWidgetsLegendMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Legend {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LegendProperties) = this()
}
