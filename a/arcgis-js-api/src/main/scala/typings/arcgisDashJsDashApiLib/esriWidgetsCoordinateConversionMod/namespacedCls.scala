...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CoordinateConversion {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CoordinateConversionProperties) = this()
}
