package typings
package arcgisDashJsDashApiLib.esriWidgetsFeatureTemplatesMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureTemplates {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureTemplatesProperties) = this()
}
