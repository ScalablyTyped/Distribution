package typings
package arcgisDashJsDashApiLib.esriViewsLayersFeatureLayerViewMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureLayerView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureLayerViewProperties) = this()
}
