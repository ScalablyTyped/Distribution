package typings
package arcgisDashJsDashApiLib.esriRenderersVisualVariablesVisualVariableMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VisualVariable {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VisualVariableProperties) = this()
  /**
