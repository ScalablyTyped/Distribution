package typings
package arcgisDashJsDashApiLib.esriLayersSupportAttachmentInfoMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttachmentInfo {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttachmentInfoProperties) = this()
  /**
