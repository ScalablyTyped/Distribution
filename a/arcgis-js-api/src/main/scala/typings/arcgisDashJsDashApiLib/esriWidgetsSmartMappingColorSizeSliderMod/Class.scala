package typings
package arcgisDashJsDashApiLib.esriWidgetsSmartMappingColorSizeSliderMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorSizeSlider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorSizeSliderProperties) = this()
}
