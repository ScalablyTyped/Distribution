package typings
package arcgisDashJsDashApiLib.esriWidgetsLayerListListItemPanelMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ListItemPanel {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var content: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Widget | stdLib.HTMLElement | java.lang.String | js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var listItem: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ListItem = js.native
  /**
