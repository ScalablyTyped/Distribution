package typings
package arcgisDashJsDashApiLib.esriGeometrySupportMeshMaterialMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshMaterial {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshMaterialProperties) = this()
}
