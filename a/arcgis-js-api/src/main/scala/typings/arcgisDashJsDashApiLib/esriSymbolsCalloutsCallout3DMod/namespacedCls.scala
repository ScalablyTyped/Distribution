package typings
package arcgisDashJsDashApiLib.esriSymbolsCalloutsCallout3DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Callout3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Callout3DProperties) = this()
  /**
