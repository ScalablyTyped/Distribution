package typings
package arcgisDashJsDashApiLib.esriLayersWMTSLayerMod
...
@js.native
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WMTSLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WMTSLayerProperties) = this()
  /**
