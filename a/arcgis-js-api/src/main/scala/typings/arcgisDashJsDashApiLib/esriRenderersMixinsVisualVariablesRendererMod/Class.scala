package typings
package arcgisDashJsDashApiLib.esriRenderersMixinsVisualVariablesRendererMod
...
@js.native
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VisualVariablesRenderer {
  /**
