package typings
package arcgisDashJsDashApiLib.esriWidgetsAttributionMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Attribution {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttributionProperties) = this()
}
