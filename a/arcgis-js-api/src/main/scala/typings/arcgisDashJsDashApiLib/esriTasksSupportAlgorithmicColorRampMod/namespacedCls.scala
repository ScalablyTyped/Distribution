package typings
package arcgisDashJsDashApiLib.esriTasksSupportAlgorithmicColorRampMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AlgorithmicColorRamp {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AlgorithmicColorRampProperties) = this()
  /**
