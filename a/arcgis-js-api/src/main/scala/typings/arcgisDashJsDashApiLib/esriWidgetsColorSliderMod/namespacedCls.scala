package typings
package arcgisDashJsDashApiLib.esriWidgetsColorSliderMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("esri/widgets/ColorSlider", JSImport.Namespace)
@js.native
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorSlider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorSliderProperties) = this()
  /**
