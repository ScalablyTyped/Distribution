package typings
package arcgisDashJsDashApiLib.esriWidgetsSearchFeatureLayerSearchSourceMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("esri/widgets/Search/FeatureLayerSearchSource", JSImport.Namespace)
@js.native
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureLayerSearchSource {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureLayerSearchSourceProperties) = this()
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var featureLayer: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureLayer = js.native
  /**
