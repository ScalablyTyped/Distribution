package typings
package arcgisDashJsDashApiLib.esriViewsDrawDrawMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Draw {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DrawProperties) = this()
}
