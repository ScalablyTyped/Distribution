package typings
package arcgisDashJsDashApiLib.esriGeometrySupportGeographicTransformationMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeographicTransformation {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var steps: js.Array[arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeographicTransformationStep] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getInverse(): arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeographicTransformation = js.native
}
