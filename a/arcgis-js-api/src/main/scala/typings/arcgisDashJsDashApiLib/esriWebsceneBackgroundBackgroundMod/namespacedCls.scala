package typings
package arcgisDashJsDashApiLib.esriWebsceneBackgroundBackgroundMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Background {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BackgroundProperties) = this()
  /**
