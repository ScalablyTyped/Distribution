package typings
package arcgisDashJsDashApiLib.esriViewsLayersGraphicsLayerViewMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GraphicsLayerView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GraphicsLayerViewProperties) = this()
}
