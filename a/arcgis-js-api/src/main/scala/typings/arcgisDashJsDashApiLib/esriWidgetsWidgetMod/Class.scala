package typings
package arcgisDashJsDashApiLib.esriWidgetsWidgetMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Widget {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WidgetProperties) = this()
}
