package typings
package arcgisDashJsDashApiLib.esriLayersMixinsSceneServiceMod
...
@js.native
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneService {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneServiceProperties) = this()
  /**
