package typings
package arcgisDashJsDashApiLib.esriSymbolsWebStyleSymbolMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebStyleSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebStyleSymbolProperties) = this()
  /**
