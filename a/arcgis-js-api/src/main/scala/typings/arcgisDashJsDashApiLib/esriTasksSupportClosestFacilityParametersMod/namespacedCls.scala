package typings
package arcgisDashJsDashApiLib.esriTasksSupportClosestFacilityParametersMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClosestFacilityParameters {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClosestFacilityParametersProperties) = this()
  /**
