package typings
package arcgisDashJsDashApiLib.esriLayersOpenStreetMapLayerMod
...
@js.native
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.OpenStreetMapLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.OpenStreetMapLayerProperties) = this()
  /**
