package typings
package arcgisDashJsDashApiLib.esriTasksLocatorMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Locator {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LocatorProperties) = this()
}
