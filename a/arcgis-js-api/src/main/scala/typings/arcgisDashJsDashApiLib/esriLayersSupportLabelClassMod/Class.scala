package typings
package arcgisDashJsDashApiLib.esriLayersSupportLabelClassMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LabelClass {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LabelClassProperties) = this()
  /**
