package typings
package arcgisDashJsDashApiLib.esriRenderersSimpleRendererMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleRendererProperties) = this()
  /**
