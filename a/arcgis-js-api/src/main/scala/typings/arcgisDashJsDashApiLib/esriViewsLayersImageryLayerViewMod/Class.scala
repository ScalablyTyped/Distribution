package typings
package arcgisDashJsDashApiLib.esriViewsLayersImageryLayerViewMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ImageryLayerView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ImageryLayerViewProperties) = this()
}
