package typings
package arcgisDashJsDashApiLib.esriRenderersUniqueValueRendererMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UniqueValueRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UniqueValueRendererProperties) = this()
  /**
