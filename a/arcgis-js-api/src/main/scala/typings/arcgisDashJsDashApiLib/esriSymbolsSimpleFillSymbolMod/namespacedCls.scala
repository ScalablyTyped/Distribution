package typings
package arcgisDashJsDashApiLib.esriSymbolsSimpleFillSymbolMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleFillSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleFillSymbolProperties) = this()
  /**
