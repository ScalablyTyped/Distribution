package typings
package arcgisDashJsDashApiLib.esriWidgetsSliceMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Slice {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SliceProperties) = this()
}
