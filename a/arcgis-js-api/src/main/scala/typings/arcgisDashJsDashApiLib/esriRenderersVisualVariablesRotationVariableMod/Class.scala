package typings
package arcgisDashJsDashApiLib.esriRenderersVisualVariablesRotationVariableMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.RotationVariable {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.RotationVariableProperties) = this()
  /**
