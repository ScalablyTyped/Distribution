package typings
package arcgisDashJsDashApiLib.esriGeometrySupportGeographicTransformationStepMod
...
@js.native
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeographicTransformationStep {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var isInverse: scala.Boolean = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var wkid: scala.Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var wkt: java.lang.String = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def getInverse(): arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeographicTransformationStep = js.native
}
