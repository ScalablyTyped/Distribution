package typings
package arcgisDashJsDashApiLib.esriTasksFindTaskMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FindTask {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FindTaskProperties) = this()
}
