package typings
package arcgisDashJsDashApiLib.esriWidgetsSmartMappingHeatmapSliderMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.HeatmapSlider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.HeatmapSliderProperties) = this()
}
