package typings
package arcgisDashJsDashApiLib.esriSymbolsEdgesSolidEdges3DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SolidEdges3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SolidEdges3DProperties) = this()
  /**
