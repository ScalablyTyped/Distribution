package typings
package arcgisDashJsDashApiLib.esriRenderersSupportUniqueValueInfoMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UniqueValueInfo {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UniqueValueInfoProperties) = this()
  /**
