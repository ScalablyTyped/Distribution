package typings
package arcgisDashJsDashApiLib.esriTasksSupportServiceAreaParametersMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaParameters {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaParametersProperties) = this()
  /**
