package typings
package arcgisDashJsDashApiLib.esriWidgetsDirectionsMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Directions {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DirectionsProperties) = this()
}
