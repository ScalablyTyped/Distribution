package typings
package arcgisDashJsDashApiLib.esriTasksSupportColorRampMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorRamp {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorRampProperties) = this()
  /**
