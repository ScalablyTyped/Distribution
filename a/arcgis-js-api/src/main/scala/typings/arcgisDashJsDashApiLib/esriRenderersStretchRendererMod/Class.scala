package typings
package arcgisDashJsDashApiLib.esriRenderersStretchRendererMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.StretchRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.StretchRendererProperties) = this()
  /**
