package typings
package arcgisDashJsDashApiLib.esriLayersSupportSublayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Sublayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SublayerProperties) = this()
}
