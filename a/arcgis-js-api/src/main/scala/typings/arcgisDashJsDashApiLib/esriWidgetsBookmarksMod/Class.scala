package typings
package arcgisDashJsDashApiLib.esriWidgetsBookmarksMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Bookmarks {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BookmarksProperties) = this()
}
