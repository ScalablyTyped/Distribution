package typings
package arcgisDashJsDashApiLib.esriWebsceneSlideMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Slide {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SlideProperties) = this()
}
