package typings
package arcgisDashJsDashApiLib.esriWidgetsEditorMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Editor {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.EditorProperties) = this()
}
