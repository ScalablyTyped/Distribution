package typings
package arcgisDashJsDashApiLib.esriWidgetsCompassMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Compass {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CompassProperties) = this()
}
