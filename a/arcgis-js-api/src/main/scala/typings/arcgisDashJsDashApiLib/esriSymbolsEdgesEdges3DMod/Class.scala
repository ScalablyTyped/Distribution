package typings
package arcgisDashJsDashApiLib.esriSymbolsEdgesEdges3DMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Edges3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Edges3DProperties) = this()
  /**
