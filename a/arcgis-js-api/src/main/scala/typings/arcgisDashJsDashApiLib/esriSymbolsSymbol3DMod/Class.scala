package typings
package arcgisDashJsDashApiLib.esriSymbolsSymbol3DMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Symbol3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Symbol3DProperties) = this()
  /**
