package typings
package arcgisDashJsDashApiLib.esriViewsSceneViewMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneViewProperties) = this()
  /**
