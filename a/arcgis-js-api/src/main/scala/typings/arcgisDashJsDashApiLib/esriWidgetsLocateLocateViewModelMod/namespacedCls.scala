package typings
package arcgisDashJsDashApiLib.esriWidgetsLocateLocateViewModelMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LocateViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LocateViewModelProperties) = this()
  /**
