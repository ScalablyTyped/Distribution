package typings
package arcgisDashJsDashApiLib.esriWidgetsFeatureFormMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureForm {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureFormProperties) = this()
}
