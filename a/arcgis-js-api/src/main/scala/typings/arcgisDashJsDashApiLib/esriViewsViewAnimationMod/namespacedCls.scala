package typings
package arcgisDashJsDashApiLib.esriViewsViewAnimationMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewAnimation {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewAnimationProperties) = this()
}
