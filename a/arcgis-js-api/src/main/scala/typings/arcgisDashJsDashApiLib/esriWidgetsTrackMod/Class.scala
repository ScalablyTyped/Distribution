package typings
package arcgisDashJsDashApiLib.esriWidgetsTrackMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Track {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TrackProperties) = this()
}
