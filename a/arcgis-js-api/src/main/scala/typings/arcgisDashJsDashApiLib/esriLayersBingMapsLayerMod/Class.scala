package typings
package arcgisDashJsDashApiLib.esriLayersBingMapsLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BingMapsLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BingMapsLayerProperties) = this()
  /**
