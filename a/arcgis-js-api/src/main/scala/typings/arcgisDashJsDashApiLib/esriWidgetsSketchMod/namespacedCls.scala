package typings
package arcgisDashJsDashApiLib.esriWidgetsSketchMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Sketch {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SketchProperties) = this()
}
