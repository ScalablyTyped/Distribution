package typings
package arcgisDashJsDashApiLib.esriViews2dViewStateMod
...
@js.native
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewState {
  /**
    ...
    */
  /* CompleteClass */
  override val center: js.Array[scala.Double] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val extent: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Extent = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val resolution: scala.Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val rotation: scala.Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override val scale: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copy(state: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewState): arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewState = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def toMap(out: js.Array[scala.Double], x: scala.Double, y: scala.Double): js.Array[scala.Double] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def toScreen(out: js.Array[scala.Double], x: scala.Double, y: scala.Double): js.Array[scala.Double] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override def toScreenNoRotation(out: js.Array[scala.Double], x: scala.Double, y: scala.Double): js.Array[scala.Double] = js.native
}
