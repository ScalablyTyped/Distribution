package typings
package arcgisDashJsDashApiLib.esriWidgetsAttributionAttributionViewModelMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttributionViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttributionViewModelProperties) = this()
}
