package typings
package arcgisDashJsDashApiLib.esriViewsUiUIMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UI {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UIProperties) = this()
}
