package typings
package arcgisDashJsDashApiLib.esriLayersGeoJSONLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeoJSONLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GeoJSONLayerProperties) = this()
  /**
