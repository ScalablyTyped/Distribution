package typings
package arcgisDashJsDashApiLib.esriPopupContentColumnChartMediaInfoMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColumnChartMediaInfo {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColumnChartMediaInfoProperties) = this()
  /**
