package typings
package arcgisDashJsDashApiLib.esriLayersKMLLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.KMLLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.KMLLayerProperties) = this()
  /**
