package typings
package arcgisDashJsDashApiLib.esriWidgetsPopupMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Popup {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PopupProperties) = this()
}
