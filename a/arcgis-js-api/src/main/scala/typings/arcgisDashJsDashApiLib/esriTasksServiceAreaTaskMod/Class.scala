package typings
package arcgisDashJsDashApiLib.esriTasksServiceAreaTaskMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaTask {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaTaskProperties) = this()
}
