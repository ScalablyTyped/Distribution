package typings
package arcgisDashJsDashApiLib.esriWidgetsSearchMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.widgetsSearch {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.widgetsSearchProperties) = this()
}
