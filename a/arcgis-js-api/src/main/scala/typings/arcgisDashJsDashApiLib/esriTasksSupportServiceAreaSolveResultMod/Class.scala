package typings
package arcgisDashJsDashApiLib.esriTasksSupportServiceAreaSolveResultMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaSolveResult {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ServiceAreaSolveResultProperties) = this()
  /**
