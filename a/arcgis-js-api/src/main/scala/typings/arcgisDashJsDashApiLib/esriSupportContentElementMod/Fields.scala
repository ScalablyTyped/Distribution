...
@JSImport("esri/support/ContentElement", "Fields")
@js.native
/**
  ...
  */
class FieldsCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Fields {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FieldsProperties) = this()
  /**
