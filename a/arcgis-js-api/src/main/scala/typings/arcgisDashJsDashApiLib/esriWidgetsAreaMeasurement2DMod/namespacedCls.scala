package typings
package arcgisDashJsDashApiLib.esriWidgetsAreaMeasurement2DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AreaMeasurement2D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AreaMeasurement2DProperties) = this()
}
