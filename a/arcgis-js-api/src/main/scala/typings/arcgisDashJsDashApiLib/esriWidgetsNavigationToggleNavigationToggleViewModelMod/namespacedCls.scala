package typings
package arcgisDashJsDashApiLib.esriWidgetsNavigationToggleNavigationToggleViewModelMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.NavigationToggleViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.NavigationToggleViewModelProperties) = this()
}
