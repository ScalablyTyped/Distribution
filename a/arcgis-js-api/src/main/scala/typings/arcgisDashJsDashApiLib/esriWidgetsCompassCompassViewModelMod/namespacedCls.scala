...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CompassViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CompassViewModelProperties) = this()
}
