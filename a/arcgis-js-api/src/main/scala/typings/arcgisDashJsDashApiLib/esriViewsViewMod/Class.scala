package typings
package arcgisDashJsDashApiLib.esriViewsViewMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.View {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ViewProperties) = this()
  /**
