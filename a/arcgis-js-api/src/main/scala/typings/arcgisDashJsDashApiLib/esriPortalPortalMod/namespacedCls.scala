package typings
package arcgisDashJsDashApiLib.esriPortalPortalMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Portal {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PortalProperties) = this()
}
