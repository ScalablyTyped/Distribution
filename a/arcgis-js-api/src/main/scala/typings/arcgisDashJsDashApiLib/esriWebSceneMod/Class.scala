package typings
package arcgisDashJsDashApiLib.esriWebSceneMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebScene {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebSceneProperties) = this()
}
