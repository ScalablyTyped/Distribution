package typings
package arcgisDashJsDashApiLib.esriTasksQueryTaskMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.QueryTask {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.QueryTaskProperties) = this()
}
