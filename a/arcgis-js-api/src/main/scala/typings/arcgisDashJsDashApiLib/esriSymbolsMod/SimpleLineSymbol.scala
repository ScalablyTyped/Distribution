...
class SimpleLineSymbolCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleLineSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleLineSymbolProperties) = this()
  /**
