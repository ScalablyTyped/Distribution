...
class PictureFillSymbolCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PictureFillSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PictureFillSymbolProperties) = this()
  /**
