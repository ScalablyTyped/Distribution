...
class TextSymbol3DLayerCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TextSymbol3DLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TextSymbol3DLayerProperties) = this()
  /**
