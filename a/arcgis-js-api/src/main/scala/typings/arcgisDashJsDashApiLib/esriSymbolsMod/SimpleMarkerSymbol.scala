...
class SimpleMarkerSymbolCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleMarkerSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SimpleMarkerSymbolProperties) = this()
  /**
