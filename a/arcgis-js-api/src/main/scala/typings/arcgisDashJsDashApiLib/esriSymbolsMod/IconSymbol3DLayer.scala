...
class IconSymbol3DLayerCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.IconSymbol3DLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.IconSymbol3DLayerProperties) = this()
  /**
