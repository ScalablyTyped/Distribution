...
class WaterSymbol3DLayerCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WaterSymbol3DLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WaterSymbol3DLayerProperties) = this()
  /**
