package typings
package arcgisDashJsDashApiLib.esriGeometrySupportMeshTextureMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshTexture {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshTextureProperties) = this()
}
