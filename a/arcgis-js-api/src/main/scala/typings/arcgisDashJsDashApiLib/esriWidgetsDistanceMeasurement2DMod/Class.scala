package typings
package arcgisDashJsDashApiLib.esriWidgetsDistanceMeasurement2DMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DistanceMeasurement2D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DistanceMeasurement2DProperties) = this()
}
