package typings
package arcgisDashJsDashApiLib.esriTasksSupportClosestFacilitySolveResultMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClosestFacilitySolveResult {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClosestFacilitySolveResultProperties) = this()
  /**
