...
trait TimeSlider extends Widget {
  /**
    ...
    * @default null
    */
  val effectiveStops: js.Array[stdLib.Date] = js.native
  /**
  ...
  /**
    ...
    * @default "time-window"
    */
  var mode: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.instant | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`time-window` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-start` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-end` = js.native
  /**
    ...
    * @default 1000
    */
  var playRate: scala.Double = js.native
  /**
  ...
  /**
    ...
    * @default false
    */
  var timeVisible: scala.Boolean = js.native
  /**
    ...
    * @default null
    */
  var values: js.Array[stdLib.Date] = js.native
  /**
...
/**
  ...
  */
class TimeSliderCls () extends TimeSlider {
