...
trait TimeSliderProperties extends WidgetProperties {
  ...
  /**
    ...
    */
  var mode: js.UndefOr[
    arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.instant | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`time-window` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-start` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-end`
  ] = js.undefined
  /**
    ...
    * @default 1000
    */
  var playRate: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    * @default false
    */
  var timeVisible: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object TimeSliderProperties {
  ...
  def apply(
    ...
    mode: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.instant | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`time-window` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-start` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cumulative-from-end` = null,
    playRate: scala.Int | scala.Double = null,
    stops: StopsByDates | StopsByCount | StopsByInterval = null,
    timeVisible: js.UndefOr[scala.Boolean] = js.undefined,
