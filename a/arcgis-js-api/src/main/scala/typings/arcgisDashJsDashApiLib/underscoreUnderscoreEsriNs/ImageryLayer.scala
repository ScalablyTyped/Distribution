...
- arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ArcGISImageService because var conflicts: fullExtent. Inlined compressionQuality, compressionTolerance, copyright, definitionExpression, domainFields, fields, format, hasMultidimensions, hasRasterAttributeTable, imageMaxHeight, imageMaxWidth, mosaicRule, multidimensionalInfo, pixelType, popupTemplate, rasterAttributeTable, rasterAttributeTableFieldPrefix, rasterFields, renderer, renderingRule, spatialReference, url, version, createPopupTemplate, createPopupTemplate, fetchImage */ @js.native
trait ImageryLayer
  extends Layer
