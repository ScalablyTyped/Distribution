...
trait coordinateFormatter extends js.Object {
  /**
    ...
    *
    */
  def fromLatitudeLongitude(coordinates: java.lang.String): Point = js.native
  def fromLatitudeLongitude(coordinates: java.lang.String, spatialReference: SpatialReference): Point = js.native
  /**
  ...
  def fromMgrs(
    ...
    conversionMode: java.lang.String
  ): Point = js.native
  /**
    ...
    *
    */
  def fromUsng(coordinates: java.lang.String): Point = js.native
  def fromUsng(coordinates: java.lang.String, spatialReference: SpatialReference): Point = js.native
  /**
  ...
  /**
    ...
    *
    */
  def toLatitudeLongitude(point: Point, format: java.lang.String): java.lang.String = js.native
  def toLatitudeLongitude(point: Point, format: java.lang.String, decimalPlaces: scala.Double): java.lang.String = js.native
  /**
    ...
    *
    */
  def toMgrs(point: Point, conversionMode: java.lang.String): java.lang.String = js.native
  def toMgrs(point: Point, conversionMode: java.lang.String, precision: scala.Double): java.lang.String = js.native
  def toMgrs(point: Point, conversionMode: java.lang.String, precision: scala.Double, addSpaces: scala.Boolean): java.lang.String = js.native
  /**
    ...
    *
    */
  def toUsng(point: Point): java.lang.String = js.native
  def toUsng(point: Point, precision: scala.Double): java.lang.String = js.native
  def toUsng(point: Point, precision: scala.Double, addSpaces: scala.Boolean): java.lang.String = js.native
  /**
    ...
    *
    */
  def toUtm(point: Point, conversionMode: java.lang.String): java.lang.String = js.native
  def toUtm(point: Point, conversionMode: java.lang.String, addSpaces: scala.Boolean): java.lang.String = js.native
}
