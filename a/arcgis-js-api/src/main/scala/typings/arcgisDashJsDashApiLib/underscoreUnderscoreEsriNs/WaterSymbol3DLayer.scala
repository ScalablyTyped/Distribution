...
trait WaterSymbol3DLayer
  ...
  /**
    ...
    */
  @JSName("type")
  val type_WaterSymbol3DLayer: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.water = js.native
  /**
    ...
    * @default medium
    */
  var waterbodySize: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.small | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.medium | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.large = js.native
  /**
    ...
    * @default null
    */
  var waveDirection: scala.Double = js.native
  /**
    ...
    * @default moderate
    */
  var waveStrength: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.calm | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.rippled | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.slight | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.moderate = js.native
}
