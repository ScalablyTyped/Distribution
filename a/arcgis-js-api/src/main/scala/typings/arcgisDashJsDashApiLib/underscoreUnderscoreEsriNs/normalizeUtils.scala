...
trait normalizeUtils extends js.Object {
  /**
    ...
    *
    */
  def normalizeCentralMeridian(geometries: js.Array[Geometry]): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def normalizeCentralMeridian(geometries: js.Array[Geometry], geometryService: GeometryService): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def normalizeCentralMeridian(geometries: js.Array[Geometry], geometryService: GeometryService, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
}
