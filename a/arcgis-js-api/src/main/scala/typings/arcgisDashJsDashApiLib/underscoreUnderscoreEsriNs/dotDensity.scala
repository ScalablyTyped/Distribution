...
trait dotDensity extends js.Object {
  /**
    ...
    *
    */
  def createRenderer(params: dotDensityCreateRendererParams): arcgisDashJsDashApiLib.IPromise[RendererResult]
}

object dotDensity {
  @scala.inline
  def apply(createRenderer: dotDensityCreateRendererParams => arcgisDashJsDashApiLib.IPromise[RendererResult]): dotDensity = {
