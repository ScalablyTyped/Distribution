...
trait requireUtils extends js.Object {
  def when(moduleRequire: js.Any, moduleNames: java.lang.String): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def when(moduleRequire: js.Any, moduleNames: js.Array[java.lang.String]): arcgisDashJsDashApiLib.IPromise[_] = js.native
}
