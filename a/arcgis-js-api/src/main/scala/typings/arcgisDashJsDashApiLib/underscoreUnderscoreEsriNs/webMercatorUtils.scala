...
trait webMercatorUtils extends js.Object {
  /**
    ...
    *
    */
  def canProject(source: SpatialReference, target: SpatialReference): scala.Boolean = js.native
  def canProject(source: SpatialReference, target: js.Any): scala.Boolean = js.native
  def canProject(source: js.Any, target: SpatialReference): scala.Boolean = js.native
  def canProject(source: js.Any, target: js.Any): scala.Boolean = js.native
  /**
  ...
  /**
    ...
    *
    */
  def lngLatToXY(long: scala.Double, lat: scala.Double): js.Array[scala.Double] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def xyToLngLat(x: scala.Double, y: scala.Double): js.Array[scala.Double] = js.native
}
