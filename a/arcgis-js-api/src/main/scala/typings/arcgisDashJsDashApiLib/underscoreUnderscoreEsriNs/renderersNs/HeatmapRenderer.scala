...
class HeatmapRendererCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.HeatmapRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.HeatmapRendererProperties) = this()
  /**
