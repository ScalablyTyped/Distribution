...
trait GeometryService extends Task {
  /**
    ...
    *
    */
  def areasAndLengths(areasAndLengthsParameters: AreasAndLengthsParameters): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def areasAndLengths(areasAndLengthsParameters: AreasAndLengthsParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def autoComplete(polygons: js.Array[Polygon], polylines: js.Array[Polyline]): arcgisDashJsDashApiLib.IPromise[Polygon] = js.native
  def autoComplete(polygons: js.Array[Polygon], polylines: js.Array[Polyline], requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[Polygon] = js.native
  /**
    ...
    *
    */
  def buffer(bufferParameters: BufferParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Polygon]] = js.native
  def buffer(bufferParameters: BufferParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Polygon]] = js.native
  /**
    ...
    *
    */
  def convexHull(geometries: js.Array[Geometry]): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  def convexHull(geometries: js.Array[Geometry], requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  /**
    ...
    *
    */
  def cut(geometries: js.Array[Geometry], cutter: Polyline): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def cut(geometries: js.Array[Geometry], cutter: Polyline, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def densify(densifyParameters: DensifyParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def densify(densifyParameters: DensifyParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def difference(geometries: js.Array[Geometry], geometry: Geometry): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  def difference(geometries: js.Array[Geometry], geometry: Geometry, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  /**
    ...
    *
    */
  def distance(params: DistanceParameters): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def distance(params: DistanceParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  /**
    ...
    *
    */
  def fromGeoCoordinateString(params: GeometryServiceFromGeoCoordinateStringParams): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def fromGeoCoordinateString(params: GeometryServiceFromGeoCoordinateStringParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def generalize(params: GeneralizeParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def generalize(params: GeneralizeParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def intersect(geometries: js.Array[Geometry], intersector: Geometry): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def intersect(geometries: js.Array[Geometry], intersector: Geometry, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def labelPoints(polygons: js.Array[Polygon]): arcgisDashJsDashApiLib.IPromise[Point] = js.native
  def labelPoints(polygons: js.Array[Polygon], requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[Point] = js.native
  /**
    ...
    *
    */
  def lengths(params: LengthsParameters): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def lengths(params: LengthsParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def offset(params: OffsetParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def offset(params: OffsetParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def project(params: ProjectParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def project(params: ProjectParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def relation(params: RelationParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Polygon]] = js.native
  def relation(params: RelationParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Polygon]] = js.native
  /**
    ...
    *
    */
  def reshape(targetGeometry: Geometry, reshaper: Geometry): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  def reshape(targetGeometry: Geometry, reshaper: Geometry, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[Geometry] = js.native
  /**
    ...
    *
    */
  def simplify(geometries: js.Array[Geometry]): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def simplify(geometries: js.Array[Geometry], requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
    ...
    *
    */
  def toGeoCoordinateString(params: GeometryServiceToGeoCoordinateStringParams): arcgisDashJsDashApiLib.IPromise[js.Array[java.lang.String]] = js.native
  def toGeoCoordinateString(params: GeometryServiceToGeoCoordinateStringParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[java.lang.String]] = js.native
  /**
    ...
    *
    */
  def trimExtend(params: TrimExtendParameters): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  def trimExtend(params: TrimExtendParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[Geometry]] = js.native
  /**
