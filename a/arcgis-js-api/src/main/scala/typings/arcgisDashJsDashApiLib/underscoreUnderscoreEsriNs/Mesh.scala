...
trait Mesh
  ...
  /**
    ...
    */
  @JSName("type")
  val type_Mesh: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.mesh = js.native
  /**
  ...
  /**
    ...
    *
    */
  def offset(dx: scala.Double, dy: scala.Double, dz: scala.Double): Mesh = js.native
  def offset(dx: scala.Double, dy: scala.Double, dz: scala.Double, params: MeshOffsetParams): Mesh = js.native
  /**
