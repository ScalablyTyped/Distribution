...
trait heatmapTheme
  ...
  /**
    ...
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-renderers-smartMapping-symbology-heatmap.html#Theme)
    */
...
object heatmapTheme {
  ...
  def apply(
    ...
    __obj.asInstanceOf[heatmapTheme]
  }
}
