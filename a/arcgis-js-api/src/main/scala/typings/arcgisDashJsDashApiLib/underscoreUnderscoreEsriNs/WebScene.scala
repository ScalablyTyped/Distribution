...
trait WebScene
  ...
  /**
    ...
    * @default false
    */
  var clippingEnabled: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    *
    */
  def loadAll(): arcgisDashJsDashApiLib.IPromise[WebScene] = js.native
  /**
    ...
    *
    */
  def save(): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  def save(options: WebSceneSaveOptions): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  /**
    ...
    *
    */
  def saveAs(portalItem: PortalItem): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  def saveAs(portalItem: PortalItemProperties): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  def saveAs(portalItem: PortalItemProperties, options: WebSceneSaveAsOptions): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  def saveAs(portalItem: PortalItem, options: WebSceneSaveAsOptions): arcgisDashJsDashApiLib.IPromise[PortalItem] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def updateFrom(view: SceneView): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def updateFrom(view: SceneView, options: WebSceneUpdateFromOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
}
