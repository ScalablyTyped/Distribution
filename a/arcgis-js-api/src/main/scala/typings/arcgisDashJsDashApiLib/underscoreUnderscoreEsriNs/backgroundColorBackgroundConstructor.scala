...
@js.native
trait backgroundColorBackgroundConstructor
  extends /**
  ...
  */
org.scalablytyped.runtime.Instantiable0[backgroundColorBackground]
     with org.scalablytyped.runtime.Instantiable1[/* properties */ backgroundColorBackgroundProperties, backgroundColorBackground] {
  def fromJSON(json: js.Any): backgroundColorBackground = js.native
}
