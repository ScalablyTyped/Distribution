...
object ObjectSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, ObjectSymbol3DLayerMaterial]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], ObjectSymbol3DLayerMaterial]) = null,
