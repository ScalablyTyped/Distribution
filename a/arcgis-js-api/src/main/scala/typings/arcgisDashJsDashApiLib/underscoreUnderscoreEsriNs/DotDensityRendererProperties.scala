...
trait DotDensityRendererProperties extends RendererProperties {
  ...
  /**
    ...
    * @default true
    */
  var blendDots: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    */
  var referenceDotValue: js.UndefOr[scala.Double] = js.undefined
  /**
...
object DotDensityRendererProperties {
  ...
  def apply(
    ...
    blendDots: js.UndefOr[scala.Boolean] = js.undefined,
    legendOptions: DotDensityRendererLegendOptions = null,
    outline: SimpleLineSymbolProperties = null,
    referenceDotValue: scala.Int | scala.Double = null,
    ...
    if (!js.isUndefined(blendDots)) __obj.updateDynamic("blendDots")(blendDots)
    if (legendOptions != null) __obj.updateDynamic("legendOptions")(legendOptions)
    if (outline != null) __obj.updateDynamic("outline")(outline)
    if (referenceDotValue != null) __obj.updateDynamic("referenceDotValue")(referenceDotValue.asInstanceOf[js.Any])
