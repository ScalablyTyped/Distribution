...
trait SlideConstructor
  ...
  */
org.scalablytyped.runtime.Instantiable0[Slide]
     with org.scalablytyped.runtime.Instantiable1[/* properties */ SlideProperties, Slide] {
  /**
    ...
    *
    */
  def createFrom(view: SceneView): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
  def createFrom(view: SceneView, options: SlideCreateFromOptions): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
}
