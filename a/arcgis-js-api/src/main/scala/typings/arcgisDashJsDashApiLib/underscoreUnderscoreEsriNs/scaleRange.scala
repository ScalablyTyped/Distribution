...
trait scaleRange extends js.Object {
  /**
    ...
    *
    */
  def scaleRange(params: scaleRangeScaleRangeParams): arcgisDashJsDashApiLib.IPromise[ScaleRangeResult]
}

object scaleRange {
  @scala.inline
  def apply(scaleRange: scaleRangeScaleRangeParams => arcgisDashJsDashApiLib.IPromise[ScaleRangeResult]): scaleRange = {
