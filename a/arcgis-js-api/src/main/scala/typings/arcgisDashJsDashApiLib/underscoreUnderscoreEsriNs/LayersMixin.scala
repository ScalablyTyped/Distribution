...
trait LayersMixin extends js.Object {
  ...
  def add(layer: Layer, index: scala.Double): scala.Unit = js.native
  /**
  ...
  def addMany(layers: js.Array[Layer], index: scala.Double): scala.Unit = js.native
  /**
    ...
    *
    */
  def findLayerById(layerId: java.lang.String): Layer = js.native
  /**
