...
trait LayerInfo
  ...
  /**
    ...
    */
  var addEnabled: js.UndefOr[scala.Boolean] = js.undefined
  /**
    * Indicates whether to enable the ability to delete features. Defaults to `true` if service supports it.
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Editor.html#LayerInfo)
    */
  var deleteEnabled: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Editor.html#LayerInfo)
    */
  var updateEnabled: js.UndefOr[scala.Boolean] = js.undefined
}
...
object LayerInfo {
  ...
  def apply(
    ...
    addEnabled: js.UndefOr[scala.Boolean] = js.undefined,
    deleteEnabled: js.UndefOr[scala.Boolean] = js.undefined,
    enabled: js.UndefOr[scala.Boolean] = js.undefined,
    fieldConfig: js.Array[FieldConfig] = null,
    updateEnabled: js.UndefOr[scala.Boolean] = js.undefined
  ): LayerInfo = {
