...
trait meshUtils extends js.Object {
  /**
    ...
    *
    */
  def createElevationSampler(mesh: Mesh): arcgisDashJsDashApiLib.IPromise[ElevationSampler] = js.native
  def createElevationSampler(mesh: Mesh, options: meshUtilsCreateElevationSamplerOptions): arcgisDashJsDashApiLib.IPromise[ElevationSampler] = js.native
  /**
  ...
  def createFromElevation(source: ElevationLayer, extent: Extent, options: meshUtilsCreateFromElevationOptions): arcgisDashJsDashApiLib.IPromise[Mesh] = js.native
  def createFromElevation(source: ElevationSampler, extent: Extent): arcgisDashJsDashApiLib.IPromise[Mesh] = js.native
  def createFromElevation(source: ElevationSampler, extent: Extent, options: meshUtilsCreateFromElevationOptions): arcgisDashJsDashApiLib.IPromise[Mesh] = js.native
  def createFromElevation(source: Ground, extent: Extent): arcgisDashJsDashApiLib.IPromise[Mesh] = js.native
  def createFromElevation(source: Ground, extent: Extent, options: meshUtilsCreateFromElevationOptions): arcgisDashJsDashApiLib.IPromise[Mesh] = js.native
  /**
