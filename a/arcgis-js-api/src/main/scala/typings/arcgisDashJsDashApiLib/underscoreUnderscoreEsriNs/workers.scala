...
trait workers extends js.Object {
  /**
    ...
    *
    */
  def open(modulePath: java.lang.String): arcgisDashJsDashApiLib.IPromise[Connection] = js.native
  def open(modulePath: java.lang.String, options: workersOpenOptions): arcgisDashJsDashApiLib.IPromise[Connection] = js.native
}
