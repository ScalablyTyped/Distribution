...
trait Slide extends Accessor {
  ...
  /**
    ...
    *
    */
  def applyTo(view: SceneView): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
  def applyTo(view: SceneView, options: SlideApplyToOptions): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
  /**
    ...
    *
    */
  def updateFrom(view: SceneView): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
  def updateFrom(view: SceneView, options: SlideUpdateFromOptions): arcgisDashJsDashApiLib.IPromise[Slide] = js.native
}
