...
trait projection extends js.Object {
  ...
  /**
    ...
    *
    */
  def project(geometry: Geometry, outSpatialReference: SpatialReference): Geometry | js.Array[Geometry] = js.native
  def project(geometry: Geometry, outSpatialReference: SpatialReferenceProperties): Geometry | js.Array[Geometry] = js.native
  def project(
    geometry: Geometry,
    outSpatialReference: SpatialReferenceProperties,
