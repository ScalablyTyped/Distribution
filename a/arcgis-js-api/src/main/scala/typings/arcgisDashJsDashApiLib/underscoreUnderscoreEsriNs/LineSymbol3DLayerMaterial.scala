...
object LineSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, LineSymbol3DLayerMaterial]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], LineSymbol3DLayerMaterial]) = null,
