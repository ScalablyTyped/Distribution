...
trait TimeSliderViewModel extends Accessor {
  ...
  /**
    ...
    * @default disabled
    */
  val state: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.disabled | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.ready | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.playing = js.native
  /**
