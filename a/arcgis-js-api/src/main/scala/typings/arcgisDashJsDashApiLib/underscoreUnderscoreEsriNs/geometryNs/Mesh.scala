...
/**
  ...
  */
class MeshCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Mesh {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshProperties) = this()
  /**
