...
trait BaseLayerViewGL2D extends LayerView {
  ...
  /**
    ...
    * @param renderParameters.context The WebGL or WebGL 2 context. Its concrete type depends on system configuration. The initial state is guaranteed to be the default one.
