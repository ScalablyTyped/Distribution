...
trait CSVLayerView extends LayerView {
  ...
  def queryExtent(query: QueryProperties, options: CSVLayerViewQueryExtentOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def queryExtent(query: Query, options: CSVLayerViewQueryExtentOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
  ...
  def queryFeatureCount(query: QueryProperties, options: CSVLayerViewQueryFeatureCountOptions): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def queryFeatureCount(query: Query, options: CSVLayerViewQueryFeatureCountOptions): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  /**
  ...
  def queryFeatures(query: QueryProperties, options: CSVLayerViewQueryFeaturesOptions): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  def queryFeatures(query: Query, options: CSVLayerViewQueryFeaturesOptions): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  /**
  ...
  def queryObjectIds(query: QueryProperties, options: CSVLayerViewQueryObjectIdsOptions): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  def queryObjectIds(query: Query, options: CSVLayerViewQueryObjectIdsOptions): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
}
