...
trait LayerConstructor
  ...
  */
org.scalablytyped.runtime.Instantiable0[Layer]
     with org.scalablytyped.runtime.Instantiable1[/* properties */ LayerProperties, Layer] {
  /**
    ...
    *
    */
  def fromArcGISServerUrl(params: LayerFromArcGISServerUrlParams): arcgisDashJsDashApiLib.IPromise[Layer] = js.native
  /**
    ...
    *
    */
  def fromPortalItem(params: LayerFromPortalItemParams): arcgisDashJsDashApiLib.IPromise[Layer] = js.native
}
