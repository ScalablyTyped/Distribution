...
object MapViewHighlightOptions {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, MapViewHighlightOptions]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], MapViewHighlightOptions]) = null,
