...
trait heatmapStatistics extends js.Object {
  /**
    ...
    *
    */
  def heatmapStatistics(params: heatmapStatisticsHeatmapStatisticsParams): arcgisDashJsDashApiLib.IPromise[HeatmapStatisticsResult]
}

object heatmapStatistics {
  @scala.inline
  def apply(
    heatmapStatistics: heatmapStatisticsHeatmapStatisticsParams => arcgisDashJsDashApiLib.IPromise[HeatmapStatisticsResult]
  ): heatmapStatistics = {
