...
trait QueryTask extends Task {
  ...
  /**
    ...
    *
    */
  def execute(query: Query): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  def execute(query: QueryProperties): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  def execute(query: QueryProperties, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  def execute(query: Query, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  /**
    ...
    *
    */
  def executeAttachmentQuery(attachmentQuery: AttachmentQuery): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeAttachmentQuery(attachmentQuery: AttachmentQueryProperties): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeAttachmentQuery(attachmentQuery: AttachmentQueryProperties, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeAttachmentQuery(attachmentQuery: AttachmentQuery, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def executeForCount(query: Query): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def executeForCount(query: QueryProperties): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def executeForCount(query: QueryProperties, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def executeForCount(query: Query, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  /**
    ...
    *
    */
  def executeForExtent(params: Query): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeForExtent(params: Query, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def executeForIds(query: Query): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  def executeForIds(query: QueryProperties): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  def executeForIds(query: QueryProperties, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  def executeForIds(query: Query, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  /**
    ...
    *
    */
  def executeRelationshipQuery(relationshipQuery: RelationshipQuery): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeRelationshipQuery(relationshipQuery: RelationshipQueryProperties): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeRelationshipQuery(relationshipQuery: RelationshipQueryProperties, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def executeRelationshipQuery(relationshipQuery: RelationshipQuery, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
}
