...
trait Geoprocessor extends Task {
  ...
  /**
    ...
    *
    */
  def cancelJob(jobId: java.lang.String): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def cancelJob(jobId: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def cancelJobStatusUpdates(jobId: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def execute(params: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def execute(params: js.Any, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def getResultData(jobId: java.lang.String, resultName: java.lang.String): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def getResultData(jobId: java.lang.String, resultName: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def getResultImage(jobId: java.lang.String, resultName: java.lang.String, imageParams: ImageParameters): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def getResultImage(
  ...
  /**
    ...
    *
    */
  def getResultMapImageLayer(jobId: java.lang.String): MapImageLayer = js.native
  /**
