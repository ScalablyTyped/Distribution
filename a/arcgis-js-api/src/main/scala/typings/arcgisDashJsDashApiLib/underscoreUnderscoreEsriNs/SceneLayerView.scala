...
trait SceneLayerView extends LayerView {
  ...
  def queryExtent(query: QueryProperties, options: SceneLayerViewQueryExtentOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def queryExtent(query: Query, options: SceneLayerViewQueryExtentOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
  ...
  def queryFeatureCount(query: QueryProperties, options: SceneLayerViewQueryFeatureCountOptions): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  def queryFeatureCount(query: Query, options: SceneLayerViewQueryFeatureCountOptions): arcgisDashJsDashApiLib.IPromise[scala.Double] = js.native
  /**
  ...
  def queryFeatures(query: QueryProperties, options: SceneLayerViewQueryFeaturesOptions): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  def queryFeatures(query: Query, options: SceneLayerViewQueryFeaturesOptions): arcgisDashJsDashApiLib.IPromise[FeatureSet] = js.native
  /**
  ...
  def queryObjectIds(query: QueryProperties, options: SceneLayerViewQueryObjectIdsOptions): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
  def queryObjectIds(query: Query, options: SceneLayerViewQueryObjectIdsOptions): arcgisDashJsDashApiLib.IPromise[js.Array[scala.Double]] = js.native
}
