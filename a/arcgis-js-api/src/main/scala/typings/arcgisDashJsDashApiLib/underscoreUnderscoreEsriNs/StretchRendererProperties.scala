...
trait StretchRendererProperties extends RendererProperties {
  ...
  /**
    ...
    */
  var computeGamma: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var dynamicRangeAdjustment: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var gamma: js.UndefOr[js.Array[scala.Double]] = js.undefined
  /**
    ...
    */
  var maxPercent: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var minPercent: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var numberOfStandardDeviations: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var outputMax: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var outputMin: js.UndefOr[scala.Double] = js.undefined
  /**
    ...
    */
  var sigmoidStrengthLevel: js.UndefOr[scala.Double] = js.undefined
  /**
  ...
  /**
    ...
    */
  var useGamma: js.UndefOr[scala.Boolean] = js.undefined
}
...
object StretchRendererProperties {
  ...
  def apply(
    ...
    computeGamma: js.UndefOr[scala.Boolean] = js.undefined,
    dynamicRangeAdjustment: js.UndefOr[scala.Boolean] = js.undefined,
    gamma: js.Array[scala.Double] = null,
    maxPercent: scala.Int | scala.Double = null,
    minPercent: scala.Int | scala.Double = null,
    numberOfStandardDeviations: scala.Int | scala.Double = null,
