...
trait BasemapConstructor
  ...
  */
org.scalablytyped.runtime.Instantiable0[Basemap]
     with org.scalablytyped.runtime.Instantiable1[/* properties */ BasemapProperties, Basemap] {
  /**
    ...
    *
    */
  def fromId(id: java.lang.String): Basemap = js.native
