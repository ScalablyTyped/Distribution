...
object IconSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, IconSymbol3DLayerMaterial]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], IconSymbol3DLayerMaterial]) = null,
