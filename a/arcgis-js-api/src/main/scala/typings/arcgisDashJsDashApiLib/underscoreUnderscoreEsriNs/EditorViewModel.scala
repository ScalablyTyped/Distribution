...
trait EditorViewModel extends Accessor {
  ...
  /**
    ...
    */
  val canCreate: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    */
  val syncing: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    *
    */
  def startUpdateWorkflowAtMultipleFeatureSelection(): scala.Unit = js.native
}

@JSGlobal("__esri.EditorViewModel")
@js.native
class EditorViewModelCls () extends EditorViewModel {
