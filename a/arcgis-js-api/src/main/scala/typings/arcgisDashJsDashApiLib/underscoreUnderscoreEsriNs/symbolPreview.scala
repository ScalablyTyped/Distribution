...
trait symbolPreview extends js.Object {
  /**
    ...
    *
    */
  def renderPreviewHTML(symbol: Symbol): arcgisDashJsDashApiLib.IPromise[stdLib.HTMLElement] = js.native
  def renderPreviewHTML(symbol: Symbol, options: symbolPreviewRenderPreviewHTMLOptions): arcgisDashJsDashApiLib.IPromise[stdLib.HTMLElement] = js.native
}
