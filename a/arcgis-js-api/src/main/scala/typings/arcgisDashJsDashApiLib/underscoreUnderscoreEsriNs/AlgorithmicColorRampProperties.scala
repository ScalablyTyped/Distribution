...
trait AlgorithmicColorRampProperties extends ColorRampProperties {
  ...
  var algorithm: js.UndefOr[
    arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cie-lab` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`lab-lch` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.hsv
  ] = js.undefined
  /**
...
object AlgorithmicColorRampProperties {
  @scala.inline
  def apply(
    algorithm: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`cie-lab` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`lab-lch` | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.hsv = null,
    fromColor: Color = null,
    toColor: Color = null
  ): AlgorithmicColorRampProperties = {
