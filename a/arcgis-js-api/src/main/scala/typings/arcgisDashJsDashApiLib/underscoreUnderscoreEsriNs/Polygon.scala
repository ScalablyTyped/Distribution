...
trait Polygon
  ...
  /**
    ...
    */
  var isSelfIntersecting: scala.Boolean = js.native
  /**
    ...
    */
  var rings: js.Array[js.Array[js.Array[scala.Double]]] = js.native
  /**
    ...
    */
  @JSName("type")
  val type_Polygon: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.polygon = js.native
  /**
    ...
    *
    */
  def addRing(points: js.Array[js.Array[scala.Double] | Point]): Polygon = js.native
  /**
  ...
  /**
    ...
    *
    */
  def getPoint(ringIndex: scala.Double, pointIndex: scala.Double): Point = js.native
  /**
    ...
    *
    */
  def insertPoint(ringIndex: scala.Double, pointIndex: scala.Double, point: Point): Polygon = js.native
  def insertPoint(ringIndex: scala.Double, pointIndex: scala.Double, point: js.Array[scala.Double]): Polygon = js.native
  /**
    ...
    *
    */
  def isClockwise(ring: js.Array[js.Array[scala.Double] | Point]): scala.Boolean = js.native
  /**
    ...
    *
    */
  def removePoint(ringIndex: scala.Double, pointIndex: scala.Double): js.Array[Point] = js.native
  /**
    ...
    *
    */
  def removeRing(index: scala.Double): js.Array[Point] = js.native
  /**
    ...
    *
    */
  def setPoint(ringIndex: scala.Double, pointIndex: scala.Double, point: Point): Polygon = js.native
  def setPoint(ringIndex: scala.Double, pointIndex: scala.Double, point: js.Array[scala.Double]): Polygon = js.native
}
