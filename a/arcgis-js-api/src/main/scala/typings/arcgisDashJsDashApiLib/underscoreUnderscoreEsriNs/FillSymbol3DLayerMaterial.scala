...
object FillSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, FillSymbol3DLayerMaterial]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], FillSymbol3DLayerMaterial]) = null,
