...
@js.native
trait Fullscreen extends Widget {
  /**
  ...
  /**
    ...
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-Fullscreen.html#render)
    *
    *
    */
...
/**
  ...
  */
class FullscreenCls () extends Fullscreen {
