...
trait ServiceAreaTask extends Task {
  /**
    ...
    *
    */
  def solve(params: ServiceAreaParameters): arcgisDashJsDashApiLib.IPromise[ServiceAreaSolveResult] = js.native
  def solve(params: ServiceAreaParameters, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ServiceAreaSolveResult] = js.native
}
