...
object PathSymbol3DLayerMaterial {
  ...
  def apply(
    ...
    set: (js.Function2[/* propertyName */ java.lang.String, /* value */ js.Any, PathSymbol3DLayerMaterial]) with (js.Function1[/* props */ arcgisDashJsDashApiLib.HashMap[_], PathSymbol3DLayerMaterial]) = null,
