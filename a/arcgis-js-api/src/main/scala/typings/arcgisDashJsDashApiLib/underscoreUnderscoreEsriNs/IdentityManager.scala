...
trait IdentityManager extends Evented {
  ...
  /**
    ...
    * @default 60
    */
  var tokenValidity: scala.Double = js.native
  /**
    ...
    * @default true
    */
  var useSignInPage: scala.Boolean = js.native
  /**
    ...
    *
    */
  def checkAppAccess(resUrl: java.lang.String, appId: java.lang.String): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    *
    */
  def findCredential(url: java.lang.String): Credential = js.native
  def findCredential(url: java.lang.String, userId: java.lang.String): Credential = js.native
  /**
  ...
  /**
    ...
    *
    */
  def findServerinfo(url: java.lang.String): ServerInfo = js.native
  /**
    ...
    *
    */
  def generateToken(serverInfo: ServerInfo, userInfo: js.Any): arcgisDashJsDashApiLib.IPromise[_] = js.native
  def generateToken(serverInfo: ServerInfo, userInfo: js.Any, options: IdentityManagerGenerateTokenOptions): arcgisDashJsDashApiLib.IPromise[_] = js.native
  /**
    ...
    *
    */
  def getCredential(url: java.lang.String): arcgisDashJsDashApiLib.IPromise[Credential] = js.native
  def getCredential(url: java.lang.String, options: IdentityManagerGetCredentialOptions): arcgisDashJsDashApiLib.IPromise[Credential] = js.native
  /**
    ...
    *
    */
  def initialize(json: js.Any): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def setOAuthResponseHash(hash: java.lang.String): scala.Unit = js.native
  /**
  ...
  /**
    ...
    *
    */
  def setRedirectionHandler(handlerFunction: IdentityManagerSetRedirectionHandlerHandlerFunction): scala.Unit = js.native
  /**
