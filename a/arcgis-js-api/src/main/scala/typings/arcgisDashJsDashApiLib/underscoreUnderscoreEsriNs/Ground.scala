...
trait Ground
  ...
  /**
    ...
    * @default null
    */
  var surfaceColor: Color = js.native
  /**
  ...
  def createElevationSampler(extent: Extent, options: GroundCreateElevationSamplerOptions): arcgisDashJsDashApiLib.IPromise[ElevationSampler] = js.native
  /**
    ...
    *
    */
  def loadAll(): arcgisDashJsDashApiLib.IPromise[Ground] = js.native
  def queryElevation(geometry: Multipoint): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
  def queryElevation(geometry: Multipoint, options: GroundQueryElevationOptions): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
  /**
    ...
    *
    */
  def queryElevation(geometry: Point): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
  def queryElevation(geometry: Point, options: GroundQueryElevationOptions): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
  def queryElevation(geometry: Polyline): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
  def queryElevation(geometry: Polyline, options: GroundQueryElevationOptions): arcgisDashJsDashApiLib.IPromise[ElevationQueryResult] = js.native
}
