...
trait DotDensityRenderer
  ...
  /**
    ...
    */
  @JSName("type")
  val type_DotDensityRenderer: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.`dot-density` = js.native
  /**
  ...
  /**
    ...
    *
    */
  def calculateDotValue(scale: scala.Double): scala.Double = js.native
}
