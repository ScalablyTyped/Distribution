...
- arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ArcGISCachedService because var conflicts: copyright. Inlined tileInfo- arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ArcGISMapService because var conflicts: fullExtent. Inlined capabilities, copyright, legendEnabled, spatialReference, version */ @js.native
trait TileLayer
  extends Layer
     with SublayersOwner
  ...
  /**
    ...
    * @default true
    */
  var resampling: scala.Boolean = js.native
  /**
