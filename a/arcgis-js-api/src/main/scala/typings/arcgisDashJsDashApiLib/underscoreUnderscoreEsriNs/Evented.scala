...
trait Evented extends js.Object {
  /**
    ...
    *
    */
  def emit(`type`: java.lang.String): scala.Boolean = js.native
  ...
  def on(`type`: js.Array[java.lang.String], listener: EventHandler): arcgisDashJsDashApiLib.IHandle = js.native
}
