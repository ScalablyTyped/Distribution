...
trait PathSymbol3DLayer
  ...
  /**
    ...
    * @default "center"
    */
  var anchor: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.center | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.bottom = js.native
  /**
    ...
    * @default "butt"
    */
  var cap: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.none | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.butt | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.square | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.round = js.native
  /**
  ...
  /**
    ...
    * @default "miter"
    */
  var join: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.miter | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.bevel | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.round = js.native
  /**
  ...
  /**
    ...
    * @default "circle"
    */
  var profile: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.circle | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.quad = js.native
  /**
    ...
    * @default "all"
    */
  var profileRotation: arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.heading | arcgisDashJsDashApiLib.arcgisDashJsDashApiLibStrings.all = js.native
  /**
