package typings
package arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.contentNs
...
class AttachmentsContentCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttachmentsContent {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttachmentsContentProperties) = this()
  /**
