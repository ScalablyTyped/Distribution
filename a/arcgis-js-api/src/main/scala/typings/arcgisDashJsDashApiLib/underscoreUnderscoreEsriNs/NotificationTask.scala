...
trait NotificationTask extends Task {
  /**
    ...
    *
    */
  def addChangeRule(params: NotificationTaskAddChangeRuleParams): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  def addChangeRule(params: NotificationTaskAddChangeRuleParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  /**
    ...
    *
    */
  def deleteChangeRule(params: NotificationTaskDeleteChangeRuleParams): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  def deleteChangeRule(params: NotificationTaskDeleteChangeRuleParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  /**
    ...
    *
    */
  def getAllChangeRules(): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  def getAllChangeRules(requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  /**
    ...
    *
    */
  def getChangeRule(ruleId: java.lang.String): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  def getChangeRule(ruleId: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  /**
    ...
    *
    */
  def getChangeRuleMatch(matchId: java.lang.String): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  def getChangeRuleMatch(matchId: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  /**
    ...
    *
    */
  def getDatabaseTime(dataWorkspaceId: java.lang.String): arcgisDashJsDashApiLib.IPromise[stdLib.Date] = js.native
  def getDatabaseTime(dataWorkspaceId: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[stdLib.Date] = js.native
  /**
    ...
    *
    */
  def getSessionMatches(sessionId: java.lang.String): arcgisDashJsDashApiLib.IPromise[ChangeRuleMatch] = js.native
  def getSessionMatches(sessionId: java.lang.String, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRuleMatch] = js.native
  /**
    ...
    *
    */
  def notifySession(params: NotificationTaskNotifySessionParams): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  def notifySession(params: NotificationTaskNotifySessionParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  /**
    ...
    *
    */
  def queryChangeRules(params: NotificationTaskQueryChangeRulesParams): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  def queryChangeRules(params: NotificationTaskQueryChangeRulesParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[ChangeRule] = js.native
  /**
    ...
    *
    */
  def runSpatialNotificationOnHistory(params: NotificationTaskRunSpatialNotificationOnHistoryParams): arcgisDashJsDashApiLib.IPromise[java.lang.String] = js.native
  def runSpatialNotificationOnHistory(params: NotificationTaskRunSpatialNotificationOnHistoryParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[java.lang.String] = js.native
  /**
    ...
    *
    */
  def sendNotification(params: NotificationTaskSendNotificationParams): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  def sendNotification(params: NotificationTaskSendNotificationParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  /**
    ...
    *
    */
  def subscribeToNotification(params: NotificationTaskSubscribeToNotificationParams): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  def subscribeToNotification(params: NotificationTaskSubscribeToNotificationParams, requestOptions: js.Any): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
  /**
    ...
    *
    */
  def unsubscribeFromNotification(params: NotificationTaskUnsubscribeFromNotificationParams): arcgisDashJsDashApiLib.IPromise[scala.Boolean] = js.native
