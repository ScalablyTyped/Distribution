...
trait CoordinateConversion
  ...
  /**
    ...
    * @default true
    */
  var multipleConversions: scala.Boolean = js.native
  /**
  ...
  /**
    ...
    * @default 300
    */
  var requestDelay: scala.Double = js.native
  /**
  ...
  /**
    ...
    *
    */
  def reverseConvert(coordinate: java.lang.String, format: Format): arcgisDashJsDashApiLib.IPromise[Point] = js.native
}
