...
trait sizeRange extends js.Object {
  /**
    ...
    *
    */
  def sizeRange(params: sizeRangeSizeRangeParams): arcgisDashJsDashApiLib.IPromise[SizeRangeResult]
}

object sizeRange {
  @scala.inline
  def apply(sizeRange: sizeRangeSizeRangeParams => arcgisDashJsDashApiLib.IPromise[SizeRangeResult]): sizeRange = {
