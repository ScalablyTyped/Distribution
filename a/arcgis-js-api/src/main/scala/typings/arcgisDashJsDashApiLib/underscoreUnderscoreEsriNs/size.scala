...
trait size extends js.Object {
  /**
    ...
    *
    */
  def createAgeRenderer(params: sizeCreateAgeRendererParams): arcgisDashJsDashApiLib.IPromise[sizeAgeRendererResult]
  /**
    ...
    *
    */
  def createClassBreaksRenderer(params: sizeCreateClassBreaksRendererParams): arcgisDashJsDashApiLib.IPromise[sizeClassBreaksRendererResult]
  /**
    ...
    *
    */
  def createContinuousRenderer(params: sizeCreateContinuousRendererParams): arcgisDashJsDashApiLib.IPromise[sizeContinuousRendererResult]
  /**
