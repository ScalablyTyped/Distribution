package typings
package arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.renderersNs
...
class ClassBreaksRendererCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClassBreaksRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ClassBreaksRendererProperties) = this()
  /**
    ...
    */
  /* CompleteClass */
  override var visualVariables: js.Array[arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.VisualVariable] = js.native
  /**
