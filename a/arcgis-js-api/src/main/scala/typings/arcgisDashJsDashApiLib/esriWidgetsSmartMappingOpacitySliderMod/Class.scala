package typings
package arcgisDashJsDashApiLib.esriWidgetsSmartMappingOpacitySliderMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.OpacitySlider {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.OpacitySliderProperties) = this()
}
