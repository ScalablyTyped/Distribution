package typings
package arcgisDashJsDashApiLib.esriLayersGroupLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GroupLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GroupLayerProperties) = this()
  /**
