package typings
package arcgisDashJsDashApiLib.esriPopupTemplateMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PopupTemplate {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PopupTemplateProperties) = this()
  /**
