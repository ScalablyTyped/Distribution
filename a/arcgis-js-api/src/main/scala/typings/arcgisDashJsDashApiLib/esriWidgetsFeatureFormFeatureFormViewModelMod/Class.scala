package typings
package arcgisDashJsDashApiLib.esriWidgetsFeatureFormFeatureFormViewModelMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureFormViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureFormViewModelProperties) = this()
}
