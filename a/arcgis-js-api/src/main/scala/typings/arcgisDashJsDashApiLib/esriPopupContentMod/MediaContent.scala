...
class MediaContentCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MediaContent {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MediaContentProperties) = this()
  /**
