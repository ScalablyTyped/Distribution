package typings
package arcgisDashJsDashApiLib.esriWidgetsLocateMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Locate {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LocateProperties) = this()
}
