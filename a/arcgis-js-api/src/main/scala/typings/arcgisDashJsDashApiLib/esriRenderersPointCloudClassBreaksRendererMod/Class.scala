package typings
package arcgisDashJsDashApiLib.esriRenderersPointCloudClassBreaksRendererMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudClassBreaksRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudClassBreaksRendererProperties) = this()
  /**
