package typings
package arcgisDashJsDashApiLib.esriWidgetsAreaMeasurement3DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AreaMeasurement3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AreaMeasurement3DProperties) = this()
}
