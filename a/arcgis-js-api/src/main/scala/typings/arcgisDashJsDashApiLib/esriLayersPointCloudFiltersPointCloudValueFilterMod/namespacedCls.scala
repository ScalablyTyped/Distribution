package typings
package arcgisDashJsDashApiLib.esriLayersPointCloudFiltersPointCloudValueFilterMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudValueFilter {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudValueFilterProperties) = this()
  /**
