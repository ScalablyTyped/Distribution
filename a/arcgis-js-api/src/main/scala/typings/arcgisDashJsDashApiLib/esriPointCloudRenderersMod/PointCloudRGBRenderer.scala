...
class PointCloudRGBRendererCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudRGBRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudRGBRendererProperties) = this()
  /**
