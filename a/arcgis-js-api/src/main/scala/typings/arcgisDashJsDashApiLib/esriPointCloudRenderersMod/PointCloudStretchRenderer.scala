package typings
package arcgisDashJsDashApiLib.esriPointCloudRenderersMod
...
class PointCloudStretchRendererCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudStretchRenderer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudStretchRendererProperties) = this()
  /**
