package typings
package arcgisDashJsDashApiLib.esriGeometrySupportMeshComponentMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshComponent {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MeshComponentProperties) = this()
}
