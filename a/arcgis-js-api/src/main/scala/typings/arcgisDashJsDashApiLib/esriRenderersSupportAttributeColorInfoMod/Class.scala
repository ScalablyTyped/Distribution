package typings
package arcgisDashJsDashApiLib.esriRenderersSupportAttributeColorInfoMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttributeColorInfo {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.AttributeColorInfoProperties) = this()
  /**
