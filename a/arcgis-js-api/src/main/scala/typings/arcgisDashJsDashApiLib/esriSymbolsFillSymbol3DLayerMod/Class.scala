package typings
package arcgisDashJsDashApiLib.esriSymbolsFillSymbol3DLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FillSymbol3DLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FillSymbol3DLayerProperties) = this()
  /**
