package typings
package arcgisDashJsDashApiLib.esriWebMapMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebMap {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WebMapProperties) = this()
}
