package typings
package arcgisDashJsDashApiLib.esriRenderersVisualVariablesColorVariableMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorVariable {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ColorVariableProperties) = this()
  /**
