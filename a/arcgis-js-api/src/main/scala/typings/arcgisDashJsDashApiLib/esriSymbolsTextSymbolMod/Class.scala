package typings
package arcgisDashJsDashApiLib.esriSymbolsTextSymbolMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TextSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TextSymbolProperties) = this()
  /**
