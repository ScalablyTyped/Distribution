package typings
package arcgisDashJsDashApiLib.esriLayersUnknownLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UnknownLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.UnknownLayerProperties) = this()
}
