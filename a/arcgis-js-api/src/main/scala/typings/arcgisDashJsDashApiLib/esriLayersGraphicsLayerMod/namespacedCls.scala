package typings
package arcgisDashJsDashApiLib.esriLayersGraphicsLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GraphicsLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GraphicsLayerProperties) = this()
  /**
