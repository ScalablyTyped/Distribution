package typings
package arcgisDashJsDashApiLib.esriTasksSupportDataLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DataLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DataLayerProperties) = this()
  /**
