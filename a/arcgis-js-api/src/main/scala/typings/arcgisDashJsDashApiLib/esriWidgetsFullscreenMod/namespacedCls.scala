package typings
package arcgisDashJsDashApiLib.esriWidgetsFullscreenMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Fullscreen {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FullscreenProperties) = this()
}
