package typings
package arcgisDashJsDashApiLib.esriLayersMixinsArcGISCachedServiceMod
...
@js.native
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ArcGISCachedService {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ArcGISCachedServiceProperties) = this()
  /**
