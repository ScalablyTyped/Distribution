package typings
package arcgisDashJsDashApiLib.esriViews2dLayersBaseLayerView2DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseLayerView2D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseLayerView2DProperties) = this()
}
