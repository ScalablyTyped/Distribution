package typings
package arcgisDashJsDashApiLib.esriViewsMapViewMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MapView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.MapViewProperties) = this()
  /**
    ...
    */
  /* CompleteClass */
  override var breakpoints: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BreakpointsOwnerBreakpoints = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var popup: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Popup = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var ui: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DefaultUI = js.native
  /**
