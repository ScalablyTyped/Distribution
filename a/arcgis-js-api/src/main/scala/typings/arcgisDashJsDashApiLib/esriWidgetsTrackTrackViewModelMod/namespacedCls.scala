package typings
package arcgisDashJsDashApiLib.esriWidgetsTrackTrackViewModelMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TrackViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.TrackViewModelProperties) = this()
  /**
