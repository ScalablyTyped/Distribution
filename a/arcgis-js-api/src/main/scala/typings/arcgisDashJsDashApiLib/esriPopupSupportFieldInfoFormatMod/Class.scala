package typings
package arcgisDashJsDashApiLib.esriPopupSupportFieldInfoFormatMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FieldInfoFormat {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FieldInfoFormatProperties) = this()
  /**
