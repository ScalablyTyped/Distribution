package typings
package arcgisDashJsDashApiLib.esriSymbolsEdgesSketchEdges3DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SketchEdges3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SketchEdges3DProperties) = this()
  /**
