package typings
package arcgisDashJsDashApiLib.esriPopupContentContentMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Content {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ContentProperties) = this()
  /**
