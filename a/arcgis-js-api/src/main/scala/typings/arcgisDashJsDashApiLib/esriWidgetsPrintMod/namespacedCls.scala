package typings
package arcgisDashJsDashApiLib.esriWidgetsPrintMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Print {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PrintProperties) = this()
}
