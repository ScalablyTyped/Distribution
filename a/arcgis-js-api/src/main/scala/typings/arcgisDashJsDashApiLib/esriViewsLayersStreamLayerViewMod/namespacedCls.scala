package typings
package arcgisDashJsDashApiLib.esriViewsLayersStreamLayerViewMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.StreamLayerView {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.StreamLayerViewProperties) = this()
}
