package typings
package arcgisDashJsDashApiLib.esriSymbolsCalloutsLineCallout3DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LineCallout3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LineCallout3DProperties) = this()
  /**
