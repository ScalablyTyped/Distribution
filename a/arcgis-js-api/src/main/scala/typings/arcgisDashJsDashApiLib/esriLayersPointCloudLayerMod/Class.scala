package typings
package arcgisDashJsDashApiLib.esriLayersPointCloudLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudLayerProperties) = this()
  /**
