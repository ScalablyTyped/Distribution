package typings
package arcgisDashJsDashApiLib.esriViewsDrawDrawActionMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DrawAction {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DrawActionProperties) = this()
}
