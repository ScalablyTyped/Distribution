package typings
package arcgisDashJsDashApiLib.esriLayersSupportRasterInfoMod
...
@js.native
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.RasterInfo {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.RasterInfoProperties) = this()
  /**
    ...
    */
  /* CompleteClass */
  override var attributeTable: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.FeatureSet = js.native
  /**
    * Raster band count.
    *
    ...
    */
  /* CompleteClass */
  override var bandCount: scala.Double = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var colormap: js.Array[js.Array[scala.Double]] = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var dataType: java.lang.String = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var extent: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Extent = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var pixelSize: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Point = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var statistics: js.Array[arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.RasterInfoStatistics] = js.native
  /**
