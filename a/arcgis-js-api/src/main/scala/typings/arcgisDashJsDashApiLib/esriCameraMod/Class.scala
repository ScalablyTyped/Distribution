package typings
package arcgisDashJsDashApiLib.esriCameraMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Camera {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.CameraProperties) = this()
  /**
