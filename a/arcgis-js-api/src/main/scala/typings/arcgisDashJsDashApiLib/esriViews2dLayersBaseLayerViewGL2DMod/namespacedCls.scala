package typings
package arcgisDashJsDashApiLib.esriViews2dLayersBaseLayerViewGL2DMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseLayerViewGL2D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseLayerViewGL2DProperties) = this()
}
