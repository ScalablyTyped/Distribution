package typings
package arcgisDashJsDashApiLib.esriTasksIdentifyTaskMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.IdentifyTask {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.IdentifyTaskProperties) = this()
}
