package typings
package arcgisDashJsDashApiLib.esriLayersSceneLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.SceneLayerProperties) = this()
  /**
