package typings
package arcgisDashJsDashApiLib.esriLayersLayerMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Layer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LayerProperties) = this()
}
