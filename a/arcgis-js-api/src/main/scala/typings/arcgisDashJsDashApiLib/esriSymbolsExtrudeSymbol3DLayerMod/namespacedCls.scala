package typings
package arcgisDashJsDashApiLib.esriSymbolsExtrudeSymbol3DLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ExtrudeSymbol3DLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ExtrudeSymbol3DLayerProperties) = this()
  /**
