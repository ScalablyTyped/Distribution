package typings
package arcgisDashJsDashApiLib.esriWidgetsDirectLineMeasurement3DMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DirectLineMeasurement3D {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.DirectLineMeasurement3DProperties) = this()
}
