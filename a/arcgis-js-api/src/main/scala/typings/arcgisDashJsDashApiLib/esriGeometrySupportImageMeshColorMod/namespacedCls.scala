package typings
package arcgisDashJsDashApiLib.esriGeometrySupportImageMeshColorMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ImageMeshColor {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.ImageMeshColorProperties) = this()
}
