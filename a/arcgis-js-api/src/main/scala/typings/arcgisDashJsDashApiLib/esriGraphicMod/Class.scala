package typings
package arcgisDashJsDashApiLib.esriGraphicMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.Graphic {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.GraphicProperties) = this()
  /**
