package typings
package arcgisDashJsDashApiLib.esriLayersBaseDynamicLayerMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseDynamicLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.BaseDynamicLayerProperties) = this()
  /**
