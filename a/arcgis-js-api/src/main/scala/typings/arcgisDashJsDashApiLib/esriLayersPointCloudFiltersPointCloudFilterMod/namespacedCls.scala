package typings
package arcgisDashJsDashApiLib.esriLayersPointCloudFiltersPointCloudFilterMod
...
/**
  ...
  */
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudFilter {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PointCloudFilterProperties) = this()
  /**
