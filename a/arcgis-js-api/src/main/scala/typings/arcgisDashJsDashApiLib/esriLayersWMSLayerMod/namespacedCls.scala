package typings
package arcgisDashJsDashApiLib.esriLayersWMSLayerMod
...
@js.native
class namespacedCls ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WMSLayer {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.WMSLayerProperties) = this()
  /**
