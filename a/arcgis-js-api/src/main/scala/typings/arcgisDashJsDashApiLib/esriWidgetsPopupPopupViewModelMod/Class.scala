package typings
package arcgisDashJsDashApiLib.esriWidgetsPopupPopupViewModelMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PopupViewModel {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PopupViewModelProperties) = this()
}
