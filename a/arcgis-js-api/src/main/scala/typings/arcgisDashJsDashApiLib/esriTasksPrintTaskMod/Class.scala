package typings
package arcgisDashJsDashApiLib.esriTasksPrintTaskMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PrintTask {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.PrintTaskProperties) = this()
}
