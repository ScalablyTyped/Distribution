package typings
package arcgisDashJsDashApiLib.esriSymbolsLineSymbolMod
...
/**
  ...
  */
class Class ()
  extends arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LineSymbol {
  def this(properties: arcgisDashJsDashApiLib.underscoreUnderscoreEsriNs.LineSymbolProperties) = this()
  /**
