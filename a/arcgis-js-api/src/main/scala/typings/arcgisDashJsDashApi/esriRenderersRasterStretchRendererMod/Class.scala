package typings.arcgisDashJsDashApi.esriRenderersRasterStretchRendererMod

import typings.arcgisDashJsDashApi.__esri.RasterStretchRenderer
import typings.arcgisDashJsDashApi.__esri.RasterStretchRendererProperties
