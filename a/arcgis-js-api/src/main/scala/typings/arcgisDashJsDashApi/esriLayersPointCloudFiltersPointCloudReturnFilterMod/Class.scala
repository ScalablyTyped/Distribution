...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.PointCloudReturnFilter
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.PointCloudReturnFilterProperties
