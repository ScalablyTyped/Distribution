...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.MeshMaterial
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.MeshMaterialProperties
