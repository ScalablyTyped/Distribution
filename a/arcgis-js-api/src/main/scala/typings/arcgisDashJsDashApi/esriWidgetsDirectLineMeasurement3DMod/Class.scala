...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DirectLineMeasurement3D
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DirectLineMeasurement3DProperties
