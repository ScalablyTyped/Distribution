...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ColorRamp
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ColorRampProperties
