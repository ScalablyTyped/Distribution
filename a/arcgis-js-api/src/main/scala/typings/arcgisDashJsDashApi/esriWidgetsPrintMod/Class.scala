package typings.arcgisDashJsDashApi.esriWidgetsPrintMod

import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.Print
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.PrintProperties
