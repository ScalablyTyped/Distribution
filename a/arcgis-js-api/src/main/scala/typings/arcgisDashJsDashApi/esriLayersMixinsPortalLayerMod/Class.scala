...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.PortalLayer
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.PortalLayerProperties
