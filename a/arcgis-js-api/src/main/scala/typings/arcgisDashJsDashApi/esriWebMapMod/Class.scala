package typings.arcgisDashJsDashApi.esriWebMapMod

import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.WebMap
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.WebMapProperties
