...
import typings.arcgisDashJsDashApi.__esri.RelatedRecordsInfoFieldOrder
import typings.arcgisDashJsDashApi.__esri.RelatedRecordsInfoFieldOrderProperties
