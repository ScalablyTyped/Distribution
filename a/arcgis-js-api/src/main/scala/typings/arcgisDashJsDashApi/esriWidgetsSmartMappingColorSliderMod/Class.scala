...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ColorSlider
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ColorSliderProperties
