package typings.arcgisDashJsDashApi.esriWidgetsDaylightMod

import typings.arcgisDashJsDashApi.__esri.Daylight
import typings.arcgisDashJsDashApi.__esri.DaylightProperties
