...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.Symbol3D
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.Symbol3DProperties
