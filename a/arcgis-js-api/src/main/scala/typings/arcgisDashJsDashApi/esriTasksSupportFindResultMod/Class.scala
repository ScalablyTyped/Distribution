...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FindResult
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FindResultProperties
