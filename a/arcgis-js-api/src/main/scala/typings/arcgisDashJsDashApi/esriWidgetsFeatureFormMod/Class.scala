...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FeatureForm
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FeatureFormProperties
