package typings.arcgisDashJsDashApi.esriViews2dLayersBaseLayerView2DMod

import typings.arcgisDashJsDashApi.__esri.BaseLayerView2D
import typings.arcgisDashJsDashApi.__esri.BaseLayerView2DProperties
