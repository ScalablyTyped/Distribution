...
trait HeatmapRenderer
  extends Renderer
     with typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.renderersNs.Renderer
  ...
  /**
    ...
    */
  @JSName("type")
  val type_HeatmapRenderer: typings.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.heatmap = js.native
}
