...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.MeshSymbol3DProperties
...
class MeshSymbol3DCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.MeshSymbol3D {
