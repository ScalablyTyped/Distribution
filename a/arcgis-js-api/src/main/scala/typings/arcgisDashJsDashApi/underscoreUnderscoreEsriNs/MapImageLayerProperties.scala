...
- typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ArcGISMapServiceProperties because var conflicts: fullExtent. Inlined copyright, legendEnabled */ trait MapImageLayerProperties
