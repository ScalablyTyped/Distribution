...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DotDensityRendererProperties
...
class DotDensityRendererCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DotDensityRenderer {
