...
- typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.ArcGISMapService because var conflicts: fullExtent. Inlined capabilities, copyright, legendEnabled, spatialReference, version */ @js.native
trait MapImageLayer
  extends Layer
     with SublayersOwner
