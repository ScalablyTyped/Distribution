package typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.renderersNs
...
class UniqueValueRendererCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.UniqueValueRenderer {
