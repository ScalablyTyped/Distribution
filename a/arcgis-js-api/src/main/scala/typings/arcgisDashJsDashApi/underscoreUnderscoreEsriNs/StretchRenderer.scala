...
import typings.arcgisDashJsDashApi.arcgisDashJsDashApiStrings.`raster-stretch`
...
trait StretchRenderer extends Renderer {
  ...
  /**
    ...
    * @default none
    */
  var stretchType: String = js.native
  /**
    ...
    */
  @JSName("type")
  val type_StretchRenderer: `raster-stretch` = js.native
  /**
