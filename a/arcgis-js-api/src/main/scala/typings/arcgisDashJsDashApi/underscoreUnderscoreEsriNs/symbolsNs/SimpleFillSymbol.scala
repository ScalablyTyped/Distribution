...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.SimpleFillSymbolProperties
...
class SimpleFillSymbolCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.SimpleFillSymbol {
