...
object fieldUtils {
  @scala.inline
  def apply(
    getElevationFields: FeatureLayer => IPromise[js.Array[String]],
    getFeatureEditFields: FeatureLayer => js.Array[String],
    getLabelingFields: FeatureLayer => IPromise[js.Array[String]],
    getTimeFields: FeatureLayer => IPromise[js.Array[String]]
  ): fieldUtils = {
