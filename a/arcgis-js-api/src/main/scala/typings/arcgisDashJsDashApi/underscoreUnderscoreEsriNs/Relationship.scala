...
object relationship {
  @scala.inline
  def apply(
    createRenderer: relationshipCreateRendererParams => IPromise[relationshipRendererResult],
    updateRenderer: relationshipUpdateRendererParams => IPromise[UniqueValueRenderer]
  ): relationship = {
