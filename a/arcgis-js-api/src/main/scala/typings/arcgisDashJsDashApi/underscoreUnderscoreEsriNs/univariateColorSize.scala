...
object univariateColorSize {
  @scala.inline
  def apply(
    createContinuousRenderer: univariateColorSizeCreateContinuousRendererParams => IPromise[univariateColorSizeContinuousRendererResult],
    createVisualVariables: univariateColorSizeCreateVisualVariablesParams => IPromise[VisualVariablesResult]
  ): univariateColorSize = {
