...
@js.native
trait StretchRendererConstructor
  extends /**
  ...
  */
Instantiable0[StretchRenderer]
     with Instantiable1[/* properties */ StretchRendererProperties, StretchRenderer] {
  def fromJSON(json: js.Any): StretchRenderer = js.native
}
