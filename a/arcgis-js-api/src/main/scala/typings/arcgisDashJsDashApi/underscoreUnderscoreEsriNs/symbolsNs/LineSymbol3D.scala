...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.LineSymbol3DProperties
...
class LineSymbol3DCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.LineSymbol3D {
