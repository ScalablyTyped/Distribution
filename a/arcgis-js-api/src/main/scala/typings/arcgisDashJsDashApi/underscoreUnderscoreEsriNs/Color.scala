...
trait Color extends js.Object {
  ...
  /**
    ...
    *
    */
  def setColor(color: String): Color = js.native
  def setColor(color: js.Any): Color = js.native
  def setColor(color: js.Array[Double]): Color = js.native
  /**
...
trait color extends js.Object {
  /**
    ...
    *
    */
  def createAgeRenderer(params: colorCreateAgeRendererParams): IPromise[AgeRendererResult]
  /**
    ...
    *
    */
  def createClassBreaksRenderer(params: colorCreateClassBreaksRendererParams): IPromise[ClassBreaksRendererResult]
  /**
    ...
    *
    */
  def createContinuousRenderer(params: colorCreateContinuousRendererParams): IPromise[ContinuousRendererResult]
  /**
    ...
    *
    */
  def createPCContinuousRenderer(params: colorCreatePCContinuousRendererParams): IPromise[PCContinuousRendererResult]
  /**
    ...
    *
    */
  def createPCTrueColorRenderer(params: colorCreatePCTrueColorRendererParams): IPromise[PCTrueColorRendererResult]
  /**
    ...
    *
    */
  def createVisualVariable(params: colorCreateVisualVariableParams): IPromise[VisualVariableResult]
}

object color {
  @scala.inline
  def apply(
    createAgeRenderer: colorCreateAgeRendererParams => IPromise[AgeRendererResult],
    createClassBreaksRenderer: colorCreateClassBreaksRendererParams => IPromise[ClassBreaksRendererResult],
    createContinuousRenderer: colorCreateContinuousRendererParams => IPromise[ContinuousRendererResult],
    createPCContinuousRenderer: colorCreatePCContinuousRendererParams => IPromise[PCContinuousRendererResult],
    createPCTrueColorRenderer: colorCreatePCTrueColorRendererParams => IPromise[PCTrueColorRendererResult],
    createVisualVariable: colorCreateVisualVariableParams => IPromise[VisualVariableResult]
  ): color = {
