...
trait location extends js.Object {
  /**
    ...
    *
    */
  def createRenderer(params: locationCreateRendererParams): IPromise[locationRendererResult]
}

object location {
  @scala.inline
  def apply(createRenderer: locationCreateRendererParams => IPromise[locationRendererResult]): location = {
