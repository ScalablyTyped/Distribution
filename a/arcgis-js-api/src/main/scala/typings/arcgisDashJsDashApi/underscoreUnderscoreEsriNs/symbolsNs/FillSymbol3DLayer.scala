...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FillSymbol3DLayerProperties
...
class FillSymbol3DLayerCls ()
  extends typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FillSymbol3DLayer {
