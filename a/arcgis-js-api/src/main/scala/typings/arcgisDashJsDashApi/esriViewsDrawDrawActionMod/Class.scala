...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DrawAction
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.DrawActionProperties
