package typings.arcgisDashJsDashApi.esriWidgetsBasemapLayerListMod

import typings.arcgisDashJsDashApi.__esri.BasemapLayerList
import typings.arcgisDashJsDashApi.__esri.BasemapLayerListProperties
