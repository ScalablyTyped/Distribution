package typings.arcgisDashJsDashApi.esriTasksWorkflowJobTaskMod

import typings.arcgisDashJsDashApi.__esri.JobTask
import typings.arcgisDashJsDashApi.__esri.JobTaskProperties
