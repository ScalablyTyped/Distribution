package typings.arcgisDashJsDashApi.esriRenderersDictionaryRendererMod

import typings.arcgisDashJsDashApi.__esri.DictionaryRenderer
import typings.arcgisDashJsDashApi.__esri.DictionaryRendererProperties
