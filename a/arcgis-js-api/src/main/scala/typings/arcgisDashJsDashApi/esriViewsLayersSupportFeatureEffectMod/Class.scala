...
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FeatureEffect
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.FeatureEffectProperties
