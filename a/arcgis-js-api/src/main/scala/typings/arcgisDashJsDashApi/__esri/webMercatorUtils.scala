...
trait webMercatorUtils extends js.Object {
  ...
  /**
    ...
    *
    */
  def geographicToWebMercator(geometry: Geometry): Geometry = js.native
  /**
  ...
  def project(geometry: Geometry, spatialReference: js.Any): Geometry = js.native
  /**
    ...
    *
    */
  def project(geometry: Geometry, spatialReference: SpatialReference): Geometry = js.native
  /**
    ...
    *
    */
  def webMercatorToGeographic(geometry: Geometry): Geometry = js.native
  /**
