...
object Step {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(assignedTo = assignedTo.asInstanceOf[js.Any], assignedType = assignedType.asInstanceOf[js.Any], async = async.asInstanceOf[js.Any], autoRun = autoRun.asInstanceOf[js.Any], canSkip = canSkip.asInstanceOf[js.Any], canSpawnConcurrency = canSpawnConcurrency.asInstanceOf[js.Any], commonId = commonId.asInstanceOf[js.Any], constructor = constructor.asInstanceOf[js.Any], defaultPercentComplete = defaultPercentComplete.asInstanceOf[js.Any], hasBeenExecuted = hasBeenExecuted.asInstanceOf[js.Any], hasBeenStarted = hasBeenStarted.asInstanceOf[js.Any], hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], notificationType = notificationType.asInstanceOf[js.Any], propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable), selfCheck = selfCheck.asInstanceOf[js.Any], statusId = statusId.asInstanceOf[js.Any], stepPercentComplete = stepPercentComplete.asInstanceOf[js.Any], stepType = stepType.asInstanceOf[js.Any])
