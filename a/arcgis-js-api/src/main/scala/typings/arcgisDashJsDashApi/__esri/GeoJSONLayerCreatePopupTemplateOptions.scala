...
trait GeoJSONLayerCreatePopupTemplateOptions extends Object {
  /**
...
object GeoJSONLayerCreatePopupTemplateOptions {
  @scala.inline
  def apply(
  ...
  ): GeoJSONLayerCreatePopupTemplateOptions = {
    ...
    __obj.asInstanceOf[GeoJSONLayerCreatePopupTemplateOptions]
  }
}
