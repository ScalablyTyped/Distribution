...
trait ClassedSizeSlider extends SmartMappingSliderBase {
  ...
  @JSName("on")
  def on_maxchange(name: `max-change`, eventHandler: ClassedSizeSliderMaxChangeEventHandler): IHandle = js.native
  @JSName("on")
  def on_minchange(name: `min-change`, eventHandler: ClassedSizeSliderMinChangeEventHandler): IHandle = js.native
  @JSName("on")
  def on_thumbchange(name: `thumb-change`, eventHandler: ClassedSizeSliderThumbChangeEventHandler): IHandle = js.native
  @JSName("on")
  def on_thumbdrag(name: `thumb-drag`, eventHandler: ClassedSizeSliderThumbDragEventHandler): IHandle = js.native
  /**
