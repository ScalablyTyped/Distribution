...
object NamedScaleRange {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(constructor = constructor, hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), id = id, maxScale = maxScale, minScale = minScale, propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable))
