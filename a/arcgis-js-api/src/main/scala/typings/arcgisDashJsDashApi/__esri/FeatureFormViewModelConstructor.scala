...
@js.native
trait FeatureFormViewModelConstructor
  extends /**
  ...
  */
Instantiable0[FeatureFormViewModel]
     with Instantiable1[/* properties */ FeatureFormViewModelProperties, FeatureFormViewModel]
