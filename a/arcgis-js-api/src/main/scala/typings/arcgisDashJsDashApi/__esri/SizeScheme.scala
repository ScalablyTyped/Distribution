...
/* Rewritten from type alias, can be one of: 
  - typings.arcgisDashJsDashApi.__esri.SizeSchemeForPoint
  - typings.arcgisDashJsDashApi.__esri.SizeSchemeForPolyline
  - typings.arcgisDashJsDashApi.__esri.SizeSchemeForPolygon
*/
