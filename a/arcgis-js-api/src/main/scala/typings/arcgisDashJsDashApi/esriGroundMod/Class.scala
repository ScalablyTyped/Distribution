package typings.arcgisDashJsDashApi.esriGroundMod

import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.Ground
import typings.arcgisDashJsDashApi.underscoreUnderscoreEsriNs.GroundProperties
