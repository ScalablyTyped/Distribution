...
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_ExecuteComplete_ArgNames
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_ExecuteComplete_Parameter
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_WillConnect_ArgNames
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_WillConnect_Parameter
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_WillExecute_ArgNames
import typings.activexDashAdodb.ADODB.EventHelperTypes.Connection_WillExecute_Parameter
