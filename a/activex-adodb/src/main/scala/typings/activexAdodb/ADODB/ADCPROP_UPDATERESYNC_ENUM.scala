...
object ADCPROP_UPDATERESYNC_ENUM {
  ...
  @scala.inline
  def adResyncAll: `15` = 15.asInstanceOf[`15`]
  
  @scala.inline
  def adResyncAutoIncrement: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def adResyncConflicts: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def adResyncInserts: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def adResyncNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def adResyncUpdates: `4` = 4.asInstanceOf[`4`]
}
