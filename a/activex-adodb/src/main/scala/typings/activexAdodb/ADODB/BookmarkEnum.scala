...
*/
trait BookmarkEnum extends StObject
object BookmarkEnum {
  
  inline def adBookmarkCurrent: `0` = 0.asInstanceOf[`0`]
  
  inline def adBookmarkFirst: `1` = 1.asInstanceOf[`1`]
  
  inline def adBookmarkLast: `2` = 2.asInstanceOf[`2`]
}
