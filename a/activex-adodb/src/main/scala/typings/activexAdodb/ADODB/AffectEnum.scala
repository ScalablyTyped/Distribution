...
object AffectEnum {
  ...
  inline def adAffectAll: `3` = 3.asInstanceOf[`3`]
  
  inline def adAffectAllChapters: `4` = 4.asInstanceOf[`4`]
  
  inline def adAffectCurrent: `1` = 1.asInstanceOf[`1`]
  
  inline def adAffectGroup: `2` = 2.asInstanceOf[`2`]
}
