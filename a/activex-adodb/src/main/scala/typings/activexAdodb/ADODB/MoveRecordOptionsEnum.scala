...
object MoveRecordOptionsEnum {
  ...
  inline def adMoveAllowEmulation: `4` = 4.asInstanceOf[`4`]
  
  inline def adMoveDontUpdateLinks: `2` = 2.asInstanceOf[`2`]
  
  inline def adMoveOverWrite: `1` = 1.asInstanceOf[`1`]
  
  inline def adMoveUnspecified: `-1` = -1.asInstanceOf[`-1`]
}
