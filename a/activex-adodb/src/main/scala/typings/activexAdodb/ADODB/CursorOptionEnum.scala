...
object CursorOptionEnum {
  ...
  inline def adAddNew: `16778240` = 16778240.asInstanceOf[`16778240`]
  
  inline def adApproxPosition: `16384` = 16384.asInstanceOf[`16384`]
  
  inline def adBookmark: `8192` = 8192.asInstanceOf[`8192`]
  
  inline def adDelete: `16779264` = 16779264.asInstanceOf[`16779264`]
  
  inline def adFind: `524288` = 524288.asInstanceOf[`524288`]
  
  inline def adHoldRecords: `256` = 256.asInstanceOf[`256`]
  
  inline def adIndex: `8388608` = 8388608.asInstanceOf[`8388608`]
  
  inline def adMovePrevious: `512` = 512.asInstanceOf[`512`]
  
  inline def adNotify: `262144` = 262144.asInstanceOf[`262144`]
  
  inline def adResync: `131072` = 131072.asInstanceOf[`131072`]
  
  inline def adSeek: `4194304` = 4194304.asInstanceOf[`4194304`]
  
  inline def adUpdate: `16809984` = 16809984.asInstanceOf[`16809984`]
  
  inline def adUpdateBatch: `65536` = 65536.asInstanceOf[`65536`]
}
