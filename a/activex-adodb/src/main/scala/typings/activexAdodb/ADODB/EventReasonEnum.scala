...
object EventReasonEnum {
  ...
  inline def adRsnAddNew: `1` = 1.asInstanceOf[`1`]
  
  inline def adRsnClose: `9` = 9.asInstanceOf[`9`]
  
  inline def adRsnDelete: `2` = 2.asInstanceOf[`2`]
  
  inline def adRsnFirstChange: `11` = 11.asInstanceOf[`11`]
  
  inline def adRsnMove: `10` = 10.asInstanceOf[`10`]
  
  inline def adRsnMoveFirst: `12` = 12.asInstanceOf[`12`]
  
  inline def adRsnMoveLast: `15` = 15.asInstanceOf[`15`]
  
  inline def adRsnMoveNext: `13` = 13.asInstanceOf[`13`]
  
  inline def adRsnMovePrevious: `14` = 14.asInstanceOf[`14`]
  
  inline def adRsnRequery: `7` = 7.asInstanceOf[`7`]
  
  inline def adRsnResynch: `8` = 8.asInstanceOf[`8`]
  
  inline def adRsnUndoAddNew: `5` = 5.asInstanceOf[`5`]
  
  inline def adRsnUndoDelete: `6` = 6.asInstanceOf[`6`]
  
  inline def adRsnUndoUpdate: `4` = 4.asInstanceOf[`4`]
  
  inline def adRsnUpdate: `3` = 3.asInstanceOf[`3`]
}
