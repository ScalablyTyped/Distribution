...
object ErrorValueEnum {
  ...
  inline def adErrBoundToCommand: `3707` = 3707.asInstanceOf[`3707`]
  
  inline def adErrCannotComplete: `3732` = 3732.asInstanceOf[`3732`]
  
  inline def adErrCantChangeConnection: `3748` = 3748.asInstanceOf[`3748`]
  
  inline def adErrCantChangeProvider: `3220` = 3220.asInstanceOf[`3220`]
  
  inline def adErrCantConvertvalue: `3724` = 3724.asInstanceOf[`3724`]
  
  inline def adErrCantCreate: `3725` = 3725.asInstanceOf[`3725`]
  
  inline def adErrCatalogNotSet: `3747` = 3747.asInstanceOf[`3747`]
  
  inline def adErrColumnNotOnThisRow: `3726` = 3726.asInstanceOf[`3726`]
  
  inline def adErrConnectionStringTooLong: `3754` = 3754.asInstanceOf[`3754`]
  
  inline def adErrDataConversion: `3421` = 3421.asInstanceOf[`3421`]
  
  inline def adErrDataOverflow: `3721` = 3721.asInstanceOf[`3721`]
  
  inline def adErrDelResOutOfScope: `3738` = 3738.asInstanceOf[`3738`]
  
  inline def adErrDenyNotSupported: `3750` = 3750.asInstanceOf[`3750`]
  
  inline def adErrDenyTypeNotSupported: `3751` = 3751.asInstanceOf[`3751`]
  
  inline def adErrFeatureNotAvailable: `3251` = 3251.asInstanceOf[`3251`]
  
  inline def adErrFieldsUpdateFailed: `3749` = 3749.asInstanceOf[`3749`]
  
  inline def adErrIllegalOperation: `3219` = 3219.asInstanceOf[`3219`]
  
  inline def adErrInTransaction: `3246` = 3246.asInstanceOf[`3246`]
  
  inline def adErrIntegrityViolation: `3719` = 3719.asInstanceOf[`3719`]
  
  inline def adErrInvalidArgument: `3001` = 3001.asInstanceOf[`3001`]
  
  inline def adErrInvalidConnection: `3709` = 3709.asInstanceOf[`3709`]
  
  inline def adErrInvalidParamInfo: `3708` = 3708.asInstanceOf[`3708`]
  
  inline def adErrInvalidTransaction: `3714` = 3714.asInstanceOf[`3714`]
  
  inline def adErrInvalidURL: `3729` = 3729.asInstanceOf[`3729`]
  
  inline def adErrItemNotFound: `3265` = 3265.asInstanceOf[`3265`]
  
  inline def adErrNoCurrentRecord: `3021` = 3021.asInstanceOf[`3021`]
  
  inline def adErrNotExecuting: `3715` = 3715.asInstanceOf[`3715`]
  
  inline def adErrNotReentrant: `3710` = 3710.asInstanceOf[`3710`]
  
  inline def adErrObjectClosed: `3704` = 3704.asInstanceOf[`3704`]
  
  inline def adErrObjectInCollection: `3367` = 3367.asInstanceOf[`3367`]
  
  inline def adErrObjectNotSet: `3420` = 3420.asInstanceOf[`3420`]
  
  inline def adErrObjectOpen: `3705` = 3705.asInstanceOf[`3705`]
  
  inline def adErrOpeningFile: `3002` = 3002.asInstanceOf[`3002`]
  
  inline def adErrOperationCancelled: `3712` = 3712.asInstanceOf[`3712`]
  
  inline def adErrOutOfSpace: `3734` = 3734.asInstanceOf[`3734`]
  
  inline def adErrPermissionDenied: `3720` = 3720.asInstanceOf[`3720`]
  
  inline def adErrPropConflicting: `3742` = 3742.asInstanceOf[`3742`]
  
  inline def adErrPropInvalidColumn: `3739` = 3739.asInstanceOf[`3739`]
  
  inline def adErrPropInvalidOption: `3740` = 3740.asInstanceOf[`3740`]
  
  inline def adErrPropInvalidValue: `3741` = 3741.asInstanceOf[`3741`]
  
  inline def adErrPropNotAllSettable: `3743` = 3743.asInstanceOf[`3743`]
  
  inline def adErrPropNotSet: `3744` = 3744.asInstanceOf[`3744`]
  
  inline def adErrPropNotSettable: `3745` = 3745.asInstanceOf[`3745`]
  
  inline def adErrPropNotSupported: `3746` = 3746.asInstanceOf[`3746`]
  
  inline def adErrProviderFailed: `3000` = 3000.asInstanceOf[`3000`]
  
  inline def adErrProviderNotFound: `3706` = 3706.asInstanceOf[`3706`]
  
  inline def adErrProviderNotSpecified: `3753` = 3753.asInstanceOf[`3753`]
  
  inline def adErrReadFile: `3003` = 3003.asInstanceOf[`3003`]
  
  inline def adErrResourceExists: `3731` = 3731.asInstanceOf[`3731`]
  
  inline def adErrResourceLocked: `3730` = 3730.asInstanceOf[`3730`]
  
  inline def adErrResourceOutOfScope: `3735` = 3735.asInstanceOf[`3735`]
  
  inline def adErrSchemaViolation: `3722` = 3722.asInstanceOf[`3722`]
  
  inline def adErrSignMismatch: `3723` = 3723.asInstanceOf[`3723`]
  
  inline def adErrStillConnecting: `3713` = 3713.asInstanceOf[`3713`]
  
  inline def adErrStillExecuting: `3711` = 3711.asInstanceOf[`3711`]
  
  inline def adErrTreePermissionDenied: `3728` = 3728.asInstanceOf[`3728`]
  
  inline def adErrURLDoesNotExist: `3727` = 3727.asInstanceOf[`3727`]
  
  inline def adErrURLNamedRowDoesNotExist: `3737` = 3737.asInstanceOf[`3737`]
  
  inline def adErrUnavailable: `3736` = 3736.asInstanceOf[`3736`]
  
  inline def adErrUnsafeOperation: `3716` = 3716.asInstanceOf[`3716`]
  
  inline def adErrVolumeNotFound: `3733` = 3733.asInstanceOf[`3733`]
  
  inline def adErrWriteFile: `3004` = 3004.asInstanceOf[`3004`]
  
  inline def adwrnSecurityDialog: `3717` = 3717.asInstanceOf[`3717`]
  
  inline def adwrnSecurityDialogHeader: `3718` = 3718.asInstanceOf[`3718`]
}
