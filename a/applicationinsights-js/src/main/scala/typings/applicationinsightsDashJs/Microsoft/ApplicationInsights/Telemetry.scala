...
import typings.applicationinsightsDashJs.AI.DataPoint
import typings.applicationinsightsDashJs.AI.ExceptionDetails
import typings.applicationinsightsDashJs.AI.MessageData
...
object Telemetry extends js.Object {
  ...
  class Event protected () extends ISerializable {
    ...
    var aiDataContract_Event: Anon_Measurements = js.native
  ...
  class RemoteDependencyData protected ()
    extends typings.applicationinsightsDashJs.AI.RemoteDependencyData
       with ISerializable {
    /**
  ...
  object Common extends js.Object {
    @js.native
    class Base ()
      extends typings.applicationinsightsDashJs.Microsoft.Telemetry.Base
         with ISerializable {
      /**
        * The set of fields for a serializeable object.
        * This defines the serialization order and a value of true/false
    ...
    class Data[TDomain] protected ()
      extends typings.applicationinsightsDashJs.Microsoft.Telemetry.Data[TDomain]
         with ISerializable {
      /**
    ...
    class Envelope protected () extends IEnvelope {
      /**
        * Constructs a new instance of telemetry data.
        */
      def this(data: typings.applicationinsightsDashJs.Microsoft.Telemetry.Base, name: String) = this()
      /**
        * The set of fields for a serializeable object.
        * This defines the serialization order and a value of true/false
        * for each field defines whether the field is required or not.
