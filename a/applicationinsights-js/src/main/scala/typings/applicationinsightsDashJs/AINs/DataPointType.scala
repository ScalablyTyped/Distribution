...
object DataPointType extends js.Object {
  ...
  /* 1 */ val Aggregation: typings.applicationinsightsDashJs.AINs.DataPointType.Aggregation with Double = js.native
  /* 0 */ val Measurement: typings.applicationinsightsDashJs.AINs.DataPointType.Measurement with Double = js.native
  @JSBracketAccess
