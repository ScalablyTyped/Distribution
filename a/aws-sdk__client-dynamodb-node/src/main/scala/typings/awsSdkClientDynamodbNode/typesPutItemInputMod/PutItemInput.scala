package typings.awsSdkClientDynamodbNode.typesPutItemInputMod
...
object PutItemInput {
  ...
  def apply(
    ...
    Expected: StringDictionary[ExpectedAttributeValue] | (Iterable[js.Tuple2[String, ExpectedAttributeValue]]) = null,
