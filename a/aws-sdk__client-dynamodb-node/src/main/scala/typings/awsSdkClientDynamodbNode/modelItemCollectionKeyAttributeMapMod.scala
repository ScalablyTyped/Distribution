...
object modelItemCollectionKeyAttributeMapMod {
  
  @JSImport("@aws-sdk/client-dynamodb-node/model/_ItemCollectionKeyAttributeMap", "_ItemCollectionKeyAttributeMap")
  @js.native
  val ItemCollectionKeyAttributeMap: Map[
