...
object typesKeysAndAttributesMod {
  ...
  object KeysAndAttributes {
    ...
    implicit open class MutableBuilder[Self <: KeysAndAttributes] (val x: Self) extends AnyVal {
      ...
      inline def setKeysVarargs(value: (StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]]))*): Self = StObject.set(x, "Keys", js.Array(value*))
  ...
  object UnmarshalledKeysAndAttributes {
    ...
    implicit open class MutableBuilder[Self <: UnmarshalledKeysAndAttributes] (val x: Self) extends AnyVal {
      ...
      inline def setKeysVarargs(value: StringDictionary[UnmarshalledAttributeValue]*): Self = StObject.set(x, "Keys", js.Array(value*))
    }
  }
}
