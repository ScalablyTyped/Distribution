...
trait UpdateContinuousBackupsInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var PointInTimeRecoverySpecification: typings.awsSdkClientDynamodbNode.typesPointInTimeRecoverySpecificationMod.PointInTimeRecoverySpecification = js.native
  /**
