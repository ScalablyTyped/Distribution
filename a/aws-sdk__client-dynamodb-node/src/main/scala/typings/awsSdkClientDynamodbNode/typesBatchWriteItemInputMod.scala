...
object typesBatchWriteItemInputMod {
  ...
  trait BatchWriteItemInput
    ...
    /**
      ...
      */
    var RequestItems: (StringDictionary[js.Array[WriteRequest] | js.Iterable[WriteRequest]]) | (js.Iterable[js.Tuple2[String, js.Array[WriteRequest] | js.Iterable[WriteRequest]]])
  ...
  object BatchWriteItemInput {
    ...
    implicit open class MutableBuilder[Self <: BatchWriteItemInput] (val x: Self) extends AnyVal {
      ...
      inline def setRequestItems(
        value: (StringDictionary[js.Array[WriteRequest] | js.Iterable[WriteRequest]]) | (js.Iterable[js.Tuple2[String, js.Array[WriteRequest] | js.Iterable[WriteRequest]]])
