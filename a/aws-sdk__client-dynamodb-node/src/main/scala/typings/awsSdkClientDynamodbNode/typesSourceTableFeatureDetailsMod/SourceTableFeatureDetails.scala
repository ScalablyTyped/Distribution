package typings.awsSdkClientDynamodbNode.typesSourceTableFeatureDetailsMod
...
trait SourceTableFeatureDetails extends js.Object {
  ...
  /**
    ...
    */
  var SSEDescription: js.UndefOr[typings.awsSdkClientDynamodbNode.typesSsedescriptionMod.SSEDescription] = js.native
  /**
