...
import typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_ATTRIBUTES
import typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_PROJECTED_ATTRIBUTES
import typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.AND
import typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.COUNT
...
import typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.SPECIFIC_ATTRIBUTES
...
import typings.awsSdkClientDynamodbNode.typesConditionMod.Condition
...
object typesScanInputMod {
  ...
  trait ScanInput
    ...
    /**
      ...
      */
    var ScanFilter: js.UndefOr[StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])] = js.undefined
  ...
  object ScanInput {
    ...
    implicit open class MutableBuilder[Self <: ScanInput] (val x: Self) extends AnyVal {
      ...
      inline def setScanFilter(value: StringDictionary[Condition] | (js.Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "ScanFilter", value.asInstanceOf[js.Any])
