...
@JSImport("@aws-sdk/client-dynamodb-node/types/RestoreTableToPointInTimeExceptionsUnion", JSImport.Namespace)
@js.native
object restoreTableToPointInTimeExceptionsUnionMod extends js.Object {
