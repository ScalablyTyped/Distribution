...
object BackupNotFoundException {
  ...
  implicit class BackupNotFoundExceptionOps[Self <: BackupNotFoundException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.BackupNotFoundException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
