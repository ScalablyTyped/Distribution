...
object typesCreateTableInputMod {
  ...
  trait CreateTableInput
    ...
    /**
      ...
      */
    var AttributeDefinitions: js.Array[AttributeDefinition] | js.Iterable[AttributeDefinition]
    ...
    /**
      ...
      */
    var GlobalSecondaryIndexes: js.UndefOr[js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex]] = js.undefined
    ...
    /**
      ...
      */
    var LocalSecondaryIndexes: js.UndefOr[js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex]] = js.undefined
  ...
  object CreateTableInput {
    ...
    extension [Self <: CreateTableInput](x: Self) {
      ...
      inline def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndex] | js.Iterable[GlobalSecondaryIndex]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      ...
      inline def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndex] | js.Iterable[LocalSecondaryIndex]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
