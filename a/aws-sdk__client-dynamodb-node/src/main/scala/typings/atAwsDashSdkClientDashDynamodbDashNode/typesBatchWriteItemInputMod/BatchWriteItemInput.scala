package typings.atAwsDashSdkClientDashDynamodbDashNode.typesBatchWriteItemInputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreWriteRequestMod._WriteRequest
...
trait BatchWriteItemInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestItems: (StringDictionary[js.Array[_WriteRequest] | Iterable[_WriteRequest]]) | (Iterable[js.Tuple2[String, js.Array[_WriteRequest] | Iterable[_WriteRequest]]])
  /**
...
object BatchWriteItemInput {
  @scala.inline
  def apply(
    RequestItems: (StringDictionary[js.Array[_WriteRequest] | Iterable[_WriteRequest]]) | (Iterable[js.Tuple2[String, js.Array[_WriteRequest] | Iterable[_WriteRequest]]]),
