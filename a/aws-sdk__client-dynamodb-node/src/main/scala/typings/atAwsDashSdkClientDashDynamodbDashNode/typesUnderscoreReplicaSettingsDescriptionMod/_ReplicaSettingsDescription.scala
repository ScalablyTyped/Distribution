...
import typings.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreReplicaGlobalSecondaryIndexSettingsDescriptionMod._ReplicaGlobalSecondaryIndexSettingsDescription
