...
import typings.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreCreateReplicaActionMod._CreateReplicaAction
import typings.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreDeleteReplicaActionMod._DeleteReplicaAction
