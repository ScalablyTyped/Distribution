package typings.atAwsDashSdkClientDashDynamodbDashNode.typesDeleteItemInputMod
...
object DeleteItemInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Key = Key.asInstanceOf[js.Any], TableName = TableName)
