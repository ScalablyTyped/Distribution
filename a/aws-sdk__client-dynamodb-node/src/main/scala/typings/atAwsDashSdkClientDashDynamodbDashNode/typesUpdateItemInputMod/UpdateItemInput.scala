package typings.atAwsDashSdkClientDashDynamodbDashNode.typesUpdateItemInputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashNode.typesUnderscoreAttributeValueUpdateMod._AttributeValueUpdate
