...
object PartialSearchOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(preserveCase)) __obj.updateDynamic("preserveCase")(preserveCase.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(skipCurrent)) __obj.updateDynamic("skipCurrent")(skipCurrent.asInstanceOf[js.Any])
