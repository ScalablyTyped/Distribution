...
trait Anon_MoveToEndOfSelection extends js.Object {
  var moveToEndOfSelection: js.UndefOr[scala.Boolean] = js.undefined
}

object Anon_MoveToEndOfSelection {
  @scala.inline
  def apply(moveToEndOfSelection: js.UndefOr[scala.Boolean] = js.undefined): Anon_MoveToEndOfSelection = {
