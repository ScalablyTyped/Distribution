...
trait DecorationOptions extends SharedDecorationOptions {
  ...
  var `type`: js.UndefOr[
    atomLib.atomLibStrings.line | atomLib.atomLibStrings.`line-number` | atomLib.atomLibStrings.text | atomLib.atomLibStrings.highlight | atomLib.atomLibStrings.overlay | atomLib.atomLibStrings.gutter | atomLib.atomLibStrings.block | atomLib.atomLibStrings.cursor
  ] = js.undefined
}
...
object DecorationOptions {
  ...
  def apply(
    ...
    `type`: atomLib.atomLibStrings.line | atomLib.atomLibStrings.`line-number` | atomLib.atomLibStrings.text | atomLib.atomLibStrings.highlight | atomLib.atomLibStrings.overlay | atomLib.atomLibStrings.gutter | atomLib.atomLibStrings.block | atomLib.atomLibStrings.cursor = null
  ): DecorationOptions = {
