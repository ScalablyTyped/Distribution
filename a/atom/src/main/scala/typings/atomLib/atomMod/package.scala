...
package object atomMod {
  type CommandRegistryListener[TargetType /* <: stdLib.EventTarget */] = atomLib.Anon_HiddenInCommandPalette[TargetType] | (js.Function1[/* event */ CommandEvent[TargetType], scala.Unit | stdLib.Promise[scala.Unit]])
  ...
  type TestRunner = js.Function1[/* params */ TestRunnerParams, stdLib.Promise[scala.Double]]
