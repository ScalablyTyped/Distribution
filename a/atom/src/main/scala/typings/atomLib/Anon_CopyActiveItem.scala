...
trait Anon_CopyActiveItem extends js.Object {
  var copyActiveItem: js.UndefOr[scala.Boolean] = js.undefined
  var items: js.UndefOr[js.Array[js.Object]] = js.undefined
}

object Anon_CopyActiveItem {
  @scala.inline
  def apply(copyActiveItem: js.UndefOr[scala.Boolean] = js.undefined, items: js.Array[js.Object] = null): Anon_CopyActiveItem = {
