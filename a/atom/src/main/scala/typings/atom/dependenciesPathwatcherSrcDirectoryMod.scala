...
import typings.atom.dependenciesPathwatcherSrcFileMod.File
import typings.atom.mod.Disposable
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object dependenciesPathwatcherSrcDirectoryMod {
  
  @JSImport("atom/dependencies/pathwatcher/src/directory", "Directory")
  @js.native
  open class Directory protected () extends StObject {
    ...
    def getEntries(
      callback: js.Function2[/* error */ js.Error | Null, /* entries */ js.Array[File | this.type], Unit]
    ): Unit = js.native
