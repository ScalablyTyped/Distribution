...
import typings.atom.Anon_AutoscrollPreserveFolds
...
trait Selection extends js.Object {
  ...
  def clear(options: Anon_Autoscroll): Unit = js.native
  ...
  def merge(otherSelection: Selection, options: Anon_AutoscrollPreserveFolds): Unit = js.native
  // Event Subscription
  ...
  def setBufferRange(bufferRange: RangeCompatible, options: Anon_AutoscrollPreserveFolds): Unit = js.native
  /** Modifies the screen range for the selection. */
  def setScreenRange(screenRange: RangeCompatible): Unit = js.native
  def setScreenRange(screenRange: RangeCompatible, options: Anon_AutoscrollPreserveFolds): Unit = js.native
  /**
