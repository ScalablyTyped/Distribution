...
import typings.atom.Anon_AllowPrevious
import typings.atom.Anon_Autoscroll
import typings.atom.Anon_Backwards
import typings.atom.Anon_IncludeNewline
import typings.atom.Anon_IncludeNonWordCharacters
import typings.atom.Anon_IncludeNonWordCharactersBoolean
import typings.atom.Anon_MoveToEndOfSelection
import typings.atom.Anon_WordRegex
...
trait Cursor extends js.Object {
  ...
  def getBeginningOfCurrentWordBufferPosition(options: Anon_AllowPrevious): Point = js.native
  /** Retrieves the buffer position of where the next word starts. */
  def getBeginningOfNextWordBufferPosition(): Point = js.native
  def getBeginningOfNextWordBufferPosition(options: Anon_WordRegex): Point = js.native
  ...
  def getCurrentLineBufferRange(options: Anon_IncludeNewline): Range = js.native
  /**
  ...
  def getCurrentWordBufferRange(options: Anon_WordRegex): Range = js.native
  ...
  def getEndOfCurrentWordBufferPosition(options: Anon_IncludeNonWordCharacters): Point = js.native
  ...
  def getNextWordBoundaryBufferPosition(options: Anon_WordRegex): Point = js.native
  ...
  def getPreviousWordBoundaryBufferPosition(options: Anon_WordRegex): Point = js.native
  ...
  def isInsideWord(options: Anon_WordRegex): Boolean = js.native
  /**
  ...
  def moveDown(rowCount: Double, options: Anon_MoveToEndOfSelection): Unit = js.native
  /** Moves the cursor left one screen column. */
  def moveLeft(): Unit = js.native
  def moveLeft(columnCount: Double): Unit = js.native
  def moveLeft(columnCount: Double, options: Anon_MoveToEndOfSelection): Unit = js.native
  /** Moves the cursor right one screen column. */
  def moveRight(): Unit = js.native
  def moveRight(columnCount: Double): Unit = js.native
  def moveRight(columnCount: Double, options: Anon_MoveToEndOfSelection): Unit = js.native
  ...
  def moveUp(rowCount: Double, options: Anon_MoveToEndOfSelection): Unit = js.native
  // Event Subscription
  ...
  def setBufferPosition(bufferPosition: PointCompatible, options: Anon_Autoscroll): Unit = js.native
  // Managing Cursor Position
  /** Moves a cursor to a given screen position. */
  def setScreenPosition(screenPosition: PointCompatible): Unit = js.native
  def setScreenPosition(screenPosition: PointCompatible, options: Anon_Autoscroll): Unit = js.native
  // Visibility
  ...
  def subwordRegExp(options: Anon_Backwards): RegExp = js.native
  /** Get the RegExp used by the cursor to determine what a "word" is. */
  def wordRegExp(): RegExp = js.native
  def wordRegExp(options: Anon_IncludeNonWordCharactersBoolean): RegExp = js.native
}
