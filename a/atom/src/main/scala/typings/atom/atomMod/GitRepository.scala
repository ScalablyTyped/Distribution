...
import typings.atom.Anon_Added
import typings.atom.Anon_Ahead
import typings.atom.Anon_Config
import typings.atom.Anon_Heads
import typings.atom.Anon_NewLines
import typings.atom.Anon_RefreshOnWindowFocus
...
class GitRepository protected () extends js.Object {
  ...
  def this(path: String, options: Anon_Config) = this()
  // Checking Out
  /**
  ...
  /**
    ...
    */
  def getAheadBehindCount(reference: String): Anon_Ahead = js.native
  def getAheadBehindCount(reference: String, path: String): Anon_Ahead = js.native
  ...
  /**
    ...
    *  upstream branch.
    */
  def getCachedUpstreamAheadBehindCount(): Anon_Ahead = js.native
  def getCachedUpstreamAheadBehindCount(path: String): Anon_Ahead = js.native
  ...
  /**
    ...
    */
  def getDiffStats(path: String): Anon_Added = js.native
  ...
  /**
    ...
    *  and the given text.
    */
  def getLineDiffs(path: String, text: String): js.Array[Anon_NewLines] = js.native
  ...
  def getReferences(): Anon_Heads = js.native
  def getReferences(path: String): Anon_Heads = js.native
...
object GitRepository extends js.Object {
  ...
  def open(path: String, options: Anon_RefreshOnWindowFocus): GitRepository = js.native
}
