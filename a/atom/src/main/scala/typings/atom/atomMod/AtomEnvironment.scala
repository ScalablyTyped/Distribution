...
import typings.atom.Anon_Buttons
import typings.atom.Anon_ButtonsDetailedMessage
import typings.atom.Anon_DevMode
import typings.atom.Anon_Height
import typings.atom.Anon_X
...
trait AtomEnvironment extends js.Object {
  ...
  /**
    ...
    */
  def confirm(options: Anon_Buttons): Unit = js.native
  /**
    *  A flexible way to open a dialog akin to an alert dialog. If a callback
    *  is provided, then the confirmation will work asynchronously, which is
    *  recommended.
    ...
    *  Returns the chosen button index number if the buttons option was an array.
    */
  def confirm(options: Anon_ButtonsDetailedMessage): Double = js.native
  /**
    *  A flexible way to open a dialog akin to an alert dialog. If a callback
    *  is provided, then the confirmation will work asynchronously, which is
    *  recommended.
  ...
  def getPosition(): Anon_X = js.native
  /**
  ...
  def getSize(): Anon_Height = js.native
  ...
  def open(params: Anon_DevMode): Unit = js.native
