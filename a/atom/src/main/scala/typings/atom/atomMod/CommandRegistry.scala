...
import typings.atom.Anon_DescriptionDisplayName
import typings.atom.Anon_Target
...
trait CommandRegistry extends js.Object {
  ...
  def findCommands(params: Anon_Target): js.Array[Anon_DescriptionDisplayName] = js.native
