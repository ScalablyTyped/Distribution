...
object srcPaneMod {
  ...
  trait Pane extends StObject {
    ...
    def saveActiveItem[T](nextAction: js.Function1[/* error */ js.UndefOr[js.Error], T]): js.UndefOr[js.Promise[T]] = js.native
    ...
    def saveActiveItemAs[T](nextAction: js.Function1[/* error */ js.UndefOr[js.Error], T]): js.UndefOr[js.Promise[T]] = js.native
    
    /** Save the given item. */
    def saveItem[T](item: js.Object): js.UndefOr[js.Promise[T]] = js.native
    def saveItem[T](item: js.Object, nextAction: js.Function1[/* error */ js.UndefOr[js.Error], T]): js.UndefOr[js.Promise[T]] = js.native
    ...
    def saveItemAs[T](item: js.Object, nextAction: js.Function1[/* error */ js.UndefOr[js.Error], T]): js.UndefOr[js.Promise[T]] = js.native
