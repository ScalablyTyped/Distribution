...
import typings.ajv.coreMod.InstanceOptions
import typings.ajv.coreMod.default
...
import typings.ajv.resolveMod.LocalRefs
...
object compileMod {
  ...
  open class SchemaEnv protected ()
    ...
    val dynamicAnchors: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Ref in string ]:? true}
      */ typings.ajv.ajvStrings.SchemaEnv & TopLevel[Any] = js.native
  ...
  type SchemaRefs = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ Ref in string ]:? ajv.ajv/dist/compile.SchemaEnv | ajv.ajv/dist/types.AnySchema}
    */ typings.ajv.ajvStrings.SchemaRefs & TopLevel[Any]
}
