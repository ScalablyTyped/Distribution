...
import typings.ajv.jsonSchemaMod.JSONSchemaType
import typings.ajv.rulesMod.ValidationRules
import typings.ajv.scopeMod.ValueScope
import typings.ajv.typesJtdSchemaMod.JTDDataType
...
object coreMod {
  ...
  object default {
    ...
    def MissingRefError: Instantiable4[
        ...
        typings.ajv.refErrorMod.default
      ] = js.native
    ...
    def ValidationError: Instantiable1[
        ...
        typings.ajv.validationErrorMod.default
      ] = js.native
  ...
  trait Ajv extends StObject {
    ...
    val formats: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Name in string ]:? ajv.ajv/dist/types.AddedFormat}
      */ typings.ajv.ajvStrings.Ajv & TopLevel[Any] = js.native
    ...
    val refs: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Ref in string ]:? ajv.ajv/dist/compile.SchemaEnv | string}
      */ typings.ajv.ajvStrings.Ajv & TopLevel[Any] = js.native
    ...
    val schemas: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Key in string ]:? ajv.ajv/dist/compile.SchemaEnv}
      */ typings.ajv.ajvStrings.Ajv & TopLevel[Any] = js.native
    
    val scope: typings.ajv.codegenMod.ValueScope = js.native
  ...
  trait CurrentOptions extends StObject {
    ...
    {[ Name in string ]:? ajv.ajv/dist/types.Format}
      */ typings.ajv.ajvStrings.CurrentOptions & TopLevel[Any]
      ] = js.undefined
    ...
    var schemas: js.UndefOr[
        js.Array[AnySchema] | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  ...
  object CurrentOptions {
    ...
    extension [Self <: CurrentOptions](x: Self) {
      ...
      inline def setSchemas(
        value: js.Array[AnySchema] | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
      {[ Key in string ]:? ajv.ajv/dist/types.AnySchema}
        */ typings.ajv.ajvStrings.CurrentOptions & TopLevel[Any])
  ...
  trait InstanceOptions extends StObject {
    ...
    var formats: js.UndefOr[
        /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Name in string ]:? ajv.ajv/dist/types.Format}
      */ typings.ajv.ajvStrings.InstanceOptions & TopLevel[Any]
      ] = js.undefined
