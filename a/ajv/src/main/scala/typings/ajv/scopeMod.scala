...
import typings.ajv.codeMod.Name
...
object scopeMod {
  ...
  open class Scope () extends StObject {
    ...
    /* protected */ val _names: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ Prefix in string ]:? ajv.ajv/dist/compile/codegen/scope.NameGroup}
      */ typings.ajv.ajvStrings.Scope & TopLevel[Any] = js.native
  ...
  object UsedValueState extends StObject {
    ...
    sealed trait Completed
      extends StObject
         with UsedValueState
    /* 1 */ val Completed: typings.ajv.scopeMod.UsedValueState.Completed & Double = js.native
    
    @js.native
    sealed trait Started
      extends StObject
         with UsedValueState
    /* 0 */ val Started: typings.ajv.scopeMod.UsedValueState.Started & Double = js.native
  }
  ...
  open class ValueScope protected () extends Scope {
    ...
    def scopeCode(values: ScopeValueSets | ScopeValues): Code = js.native
    def scopeCode(
      values: ScopeValueSets | ScopeValues,
      usedValues: Unit,
      getCode: js.Function1[/* n */ ValueScopeName, js.UndefOr[Code]]
    ): Code = js.native
    def scopeCode(values: ScopeValueSets | ScopeValues, usedValues: UsedScopeValues): Code = js.native
    def scopeCode(
      values: ScopeValueSets | ScopeValues,
    ...
    def scopeRefs(scopeName: Name, values: ScopeValueSets | ScopeValues): Code = js.native
  ...
  type ScopeValueSets = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ Prefix in string ]:? std.Set<ajv.ajv/dist/compile/codegen/scope.ValueScopeName>}
    */ typings.ajv.ajvStrings.ScopeValueSets & TopLevel[Any]
  
  type ScopeValues = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ Prefix in string ]:? std.Map<unknown, ajv.ajv/dist/compile/codegen/scope.ValueScopeName>}
    */ typings.ajv.ajvStrings.ScopeValues & TopLevel[Any]
  
  type UsedScopeValues = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ Prefix in string ]:? std.Map<ajv.ajv/dist/compile/codegen/scope.ValueScopeName, ajv.ajv/dist/compile/codegen/scope.UsedValueState | undefined>}
    */ typings.ajv.ajvStrings.UsedScopeValues & TopLevel[Any]
