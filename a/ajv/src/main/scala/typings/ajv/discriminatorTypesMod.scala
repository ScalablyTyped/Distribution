...
object discriminatorTypesMod {
  ...
  object DiscrError extends StObject {
    ...
    sealed trait Mapping
      extends StObject
         with DiscrError
    /* "mapping" */ val Mapping: typings.ajv.discriminatorTypesMod.DiscrError.Mapping & String = js.native
    
    @js.native
    sealed trait Tag
      extends StObject
         with DiscrError
    /* "tag" */ val Tag: typings.ajv.discriminatorTypesMod.DiscrError.Tag & String = js.native
  }
