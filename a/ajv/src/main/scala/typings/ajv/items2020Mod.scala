...
import typings.ajv.ajvStrings.items_
...
object items2020Mod extends Shortcut {
  
  @JSImport("ajv/dist/vocabularies/applicator/items2020", JSImport.Default)
  @js.native
  val default: CodeKeywordDefinition = js.native
  
  type ItemsError = ErrorObject[items_, Limit, AnySchema]
  
  type _To = CodeKeywordDefinition
  
  /* This means you don't have to write `default`, but can instead just say `items2020Mod.foo` */
