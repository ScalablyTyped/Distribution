...
import typings.ajv.ajvStrings.uniqueItems
...
object uniqueItemsMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `uniqueItemsMod.foo` */
