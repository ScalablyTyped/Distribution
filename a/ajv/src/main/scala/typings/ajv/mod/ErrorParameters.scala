...
object ErrorParameters {
  ...
  inline def AdditionalPropertiesParams(additionalProperty: String): typings.ajv.mod.AdditionalPropertiesParams = {
  ...
  inline def ComparisonParams(comparison: String, exclusive: Boolean, limit: Double | String): typings.ajv.mod.ComparisonParams = {
  ...
  inline def CustomParams(keyword: String): typings.ajv.mod.CustomParams = {
    val __obj = js.Dynamic.literal(keyword = keyword.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.CustomParams]
  }
  
  inline def DependenciesParams(deps: String, depsCount: Double, missingProperty: String, property: String): typings.ajv.mod.DependenciesParams = {
  ...
  inline def EnumParams(allowedValues: js.Array[js.Any]): typings.ajv.mod.EnumParams = {
  ...
  inline def FormatParams(format: String): typings.ajv.mod.FormatParams = {
    val __obj = js.Dynamic.literal(format = format.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.FormatParams]
  }
  
  inline def IfParams(failingKeyword: String): typings.ajv.mod.IfParams = {
  ...
  inline def LimitParams(limit: Double): typings.ajv.mod.LimitParams = {
    val __obj = js.Dynamic.literal(limit = limit.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.LimitParams]
  }
  
  inline def MultipleOfParams(multipleOf: Double): typings.ajv.mod.MultipleOfParams = {
  ...
  inline def PatternParams(pattern: String): typings.ajv.mod.PatternParams = {
    val __obj = js.Dynamic.literal(pattern = pattern.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.PatternParams]
  }
  
  inline def PatternRequiredParams(missingPattern: String): typings.ajv.mod.PatternRequiredParams = {
  ...
  inline def PropertyNamesParams(propertyName: String): typings.ajv.mod.PropertyNamesParams = {
  ...
  inline def RefParams(ref: String): typings.ajv.mod.RefParams = {
    val __obj = js.Dynamic.literal(ref = ref.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.RefParams]
  }
  
  inline def RequiredParams(missingProperty: String): typings.ajv.mod.RequiredParams = {
  ...
  inline def SwitchParams(caseIndex: Double): typings.ajv.mod.SwitchParams = {
    val __obj = js.Dynamic.literal(caseIndex = caseIndex.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.SwitchParams]
  }
  
  inline def TypeParams(`type`: String): typings.ajv.mod.TypeParams = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.ajv.mod.TypeParams]
  }
  
  inline def UniqueItemsParams(i: Double, j: Double): typings.ajv.mod.UniqueItemsParams = {
