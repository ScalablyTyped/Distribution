...
object dependenciesMod {
  ...
  inline def validatePropertyDeps(
    cxt: KeywordCxt,
    propertyDeps: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in string ]:? std.Array<string>}
    */ typings.ajv.ajvStrings.validatePropertyDeps & TopLevel[Any]
  ...
  {[ K in string ]:? std.Array<string> | ajv.ajv/dist/types.AnySchema}
    */ typings.ajv.ajvStrings.DependenciesError & TopLevel[Any]
  ]
  ...
  type PropertyDependencies = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in string ]:? std.Array<string>}
    */ typings.ajv.ajvStrings.PropertyDependencies & TopLevel[Any]
}
