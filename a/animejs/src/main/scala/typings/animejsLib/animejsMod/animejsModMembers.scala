...
object animejsModMembers extends js.Object {
  ...
  def path(): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: java.lang.String): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: java.lang.String, percent: scala.Double): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: scala.Null, percent: scala.Double): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: stdLib.HTMLElement): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: stdLib.HTMLElement, percent: scala.Double): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: stdLib.SVGElement): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
  def path(path: stdLib.SVGElement, percent: scala.Double): js.Function1[/* prop */ java.lang.String, animejsLib.Anon_Property] = js.native
