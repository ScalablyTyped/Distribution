...
object path extends js.Object {
  ...
  def apply(path: Null, percent: Double): js.Function1[/* prop */ String, El] = js.native
  def apply(path: HTMLElement): js.Function1[/* prop */ String, El] = js.native
  def apply(path: HTMLElement, percent: Double): js.Function1[/* prop */ String, El] = js.native
