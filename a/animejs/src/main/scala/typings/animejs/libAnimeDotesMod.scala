...
object libAnimeDotesMod {
  ...
  object default {
    ...
    @JSImport("animejs/lib/anime.es", JSImport.Default)
    @js.native
    ...
    @JSImport("animejs/lib/anime.es", "default.running")
    @js.native
    ...
    @JSImport("animejs/lib/anime.es", "default.speed")
    @js.native
    ...
    // Helpers
    @JSImport("animejs/lib/anime.es", "default.version")
    @js.native
