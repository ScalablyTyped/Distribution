...
object libAnimeDotminMod {
  ...
  @JSImport("animejs/lib/anime.min", JSImport.Namespace)
  @js.native
  ...
  @JSImport("animejs/lib/anime.min", "running")
  @js.native
  ...
  @JSImport("animejs/lib/anime.min", "speed")
  @js.native
  ...
  // Helpers
  @JSImport("animejs/lib/anime.min", "version")
  @js.native
