...
trait IUrlMatcherFactory extends js.Object {
  ...
  /**
    ...
    */
  def compile(pattern: String): typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IUrlMatcher = js.native
  /**
  ...
  /**
    ...
    */
  def `type`(name: String): typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IType = js.native
  /**
  ...
  def `type`(
    name: String,
    definition: typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IType
  ...
  def `type`(
    ...
    definitionFn: js.Function1[
      /* repeated */ js.Any, 
      typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IType
    ]
  ): IUrlMatcherFactory = js.native
  def `type`(
    name: String,
