...
trait IHrefOptions extends js.Object {
  ...
  var relative: js.UndefOr[
    typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState
  ] = js.undefined
}
...
object IHrefOptions {
  ...
  def apply(
    ...
    relative: typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState = null
  ): IHrefOptions = {
