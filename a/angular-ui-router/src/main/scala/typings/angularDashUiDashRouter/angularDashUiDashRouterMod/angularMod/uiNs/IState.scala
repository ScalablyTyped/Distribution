...
trait IState extends js.Object {
  ...
  var parent: js.UndefOr[
    String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState
  ] = js.undefined
  /**
  ...
  var redirectTo: js.UndefOr[
    String | Function | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var url: js.UndefOr[
    String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IUrlMatcher
  ] = js.undefined
  /**
...
object IState {
  ...
  def apply(
    ...
    params: js.Any = null,
    parent: String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState = null,
    redirectTo: String | Function | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState = null,
    ...
    url: String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IUrlMatcher = null,
