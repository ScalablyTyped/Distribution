...
trait IStateOptions extends js.Object {
  ...
  var reload: js.UndefOr[
    Boolean | String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState
  ] = js.undefined
}
...
object IStateOptions {
  ...
  def apply(
    ...
    reload: Boolean | String | typings.angularDashUiDashRouter.angularDashUiDashRouterMod.angularMod.uiNs.IState = null
  ): IStateOptions = {
