...
object libStateFiltersMod {
  ...
  object IncludedByStateFilter {
    ...
    @JSImport("angular-ui-router/lib/stateFilters", "$IncludedByStateFilter")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("angular-ui-router/lib/stateFilters", "$IncludedByStateFilter.$inject")
    @js.native
  ...
  object IsStateFilter {
    ...
    @JSImport("angular-ui-router/lib/stateFilters", "$IsStateFilter")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("angular-ui-router/lib/stateFilters", "$IsStateFilter.$inject")
    @js.native
    def inject: js.Array[String] = js.native
