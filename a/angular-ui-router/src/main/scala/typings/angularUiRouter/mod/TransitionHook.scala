...
@JSImport("angular-ui-router", "TransitionHook")
@js.native
...
object TransitionHook {
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "TransitionHook.HANDLE_RESULT")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "TransitionHook.LOG_ERROR")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "TransitionHook.LOG_REJECTED_RESULT")
  @js.native
  ...
  @JSImport("angular-ui-router", "TransitionHook.REJECT_ERROR")
  @js.native
  ...
  @JSImport("angular-ui-router", "TransitionHook.THROW_ERROR")
  @js.native
