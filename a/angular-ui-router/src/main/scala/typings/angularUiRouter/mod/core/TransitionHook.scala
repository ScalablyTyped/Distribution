...
@JSImport("angular-ui-router", "core.TransitionHook")
@js.native
...
object TransitionHook {
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "core.TransitionHook.HANDLE_RESULT")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "core.TransitionHook.LOG_ERROR")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "core.TransitionHook.LOG_REJECTED_RESULT")
  @js.native
  ...
  @JSImport("angular-ui-router", "core.TransitionHook.REJECT_ERROR")
  @js.native
  ...
  @JSImport("angular-ui-router", "core.TransitionHook.THROW_ERROR")
  @js.native
