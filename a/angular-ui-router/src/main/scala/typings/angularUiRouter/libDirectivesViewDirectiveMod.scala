...
import typings.angularUiRouter.anon.Resolve
import typings.angularUiRouter.libDirectivesStateDirectivesMod.ng1Directive
import typings.angularUiRouter.libStatebuildersViewsMod.Ng1ViewConfig
