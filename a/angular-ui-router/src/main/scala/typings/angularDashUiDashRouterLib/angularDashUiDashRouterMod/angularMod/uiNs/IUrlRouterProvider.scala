...
trait IUrlRouterProvider
  ...
  def otherwise(handler: js.Function): IUrlRouterProvider = js.native
  def otherwise(path: java.lang.String): IUrlRouterProvider = js.native
  def rule(handler: js.Array[_]): IUrlRouterProvider = js.native
  def rule(handler: js.Function): IUrlRouterProvider = js.native
  def when(whenPath: IUrlMatcher, handler: js.Array[_]): IUrlRouterProvider = js.native
  def when(whenPath: IUrlMatcher, hanlder: js.Function): IUrlRouterProvider = js.native
  ...
  def when(whenPath: java.lang.String, handler: js.Function): IUrlRouterProvider = js.native
  ...
  def when(whenPath: stdLib.RegExp, handler: js.Function): IUrlRouterProvider = js.native
