...
object mod {
  ...
  /**
    ...
    * //   rhenish-periodical
    */
  inline def apply(): js.Tuple2[String, String] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[js.Tuple2[String, String]]
  ...
  /**
    ...
    * // -> false
    */
  inline def adjPrime(newPrime: Double): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("adjPrime")(newPrime.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  
  @JSImport("adj-noun", "next")
  @js.native
  val next: /* import warning: ResolveTypeQueries.resolve Couldn't resolve typeof nextFn */ Any = js.native
  ...
  /**
    ...
    * // -> false
    */
  inline def nounPrime(newPrime: Double): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("nounPrime")(newPrime.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  /**
    ...
    * // -> false
    */
  inline def seed(newSeed: Double): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("seed")(newSeed.asInstanceOf[js.Any]).asInstanceOf[Boolean]
}
