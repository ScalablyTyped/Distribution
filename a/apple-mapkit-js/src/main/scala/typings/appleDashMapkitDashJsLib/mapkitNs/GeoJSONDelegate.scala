...
trait GeoJSONDelegate extends js.Object {
  def geoJSONDidComplete(result: ItemCollection, geoJSON: js.Any): scala.Unit = js.native
  def geoJSONDidError(error: stdLib.Error, geoJSON: js.Any): scala.Unit = js.native
