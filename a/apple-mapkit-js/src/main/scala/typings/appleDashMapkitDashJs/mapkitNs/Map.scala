...
import typings.appleDashMapkitDashJs.Anon_Hybrid
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`double-tap`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`drag-end`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`drag-start`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`long-press`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`map-type-change`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`region-change-end`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`region-change-start`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`scroll-end`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`scroll-start`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`single-tap`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`user-location-change`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`user-location-error`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`zoom-end`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.`zoom-start`
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.deselect
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.dragging
import typings.appleDashMapkitDashJs.appleDashMapkitDashJsStrings.select
...
class Map protected () extends js.Object {
  ...
  def addEventListener_dragend[T](
    `type`: `drag-end`,
    listener: js.ThisFunction1[/* this */ T, /* event */ EventBase[this.type] with Anon_Annotation_1340307287, Unit]
  ): Unit = js.native
  @JSName("addEventListener")
  def addEventListener_dragend[T](
    `type`: `drag-end`,
  ...
  def removeEventListener_dragend[T](
    `type`: `drag-end`,
    listener: js.Function2[/* type */ T, /* event */ EventBase[this.type] with Anon_Annotation_1340307287, Unit]
  ): Unit = js.native
  @JSName("removeEventListener")
  def removeEventListener_dragend[T](
    `type`: `drag-end`,
