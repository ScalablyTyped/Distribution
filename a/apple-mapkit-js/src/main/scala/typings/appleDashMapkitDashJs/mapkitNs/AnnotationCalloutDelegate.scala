...
trait AnnotationCalloutDelegate extends js.Object {
  /**
    ...
    */
  var calloutAnchorOffsetForAnnotation: js.UndefOr[js.Function2[/* annotation */ Annotation, /* size */ Anon_Height, DOMPoint]] = js.undefined
  /**
...
object AnnotationCalloutDelegate {
  @scala.inline
  def apply(
    calloutAnchorOffsetForAnnotation: (/* annotation */ Annotation, /* size */ Anon_Height) => DOMPoint = null,
