...
import typings.appleMapkitJs.appleMapkitJsStrings.`long-press`
import typings.appleMapkitJs.appleMapkitJsStrings.`map-type-change`
import typings.appleMapkitJs.appleMapkitJsStrings.`region-change-end`
import typings.appleMapkitJs.appleMapkitJsStrings.`region-change-start`
import typings.appleMapkitJs.appleMapkitJsStrings.`scroll-end`
import typings.appleMapkitJs.appleMapkitJsStrings.`scroll-start`
import typings.appleMapkitJs.appleMapkitJsStrings.`single-tap`
import typings.appleMapkitJs.appleMapkitJsStrings.`user-location-change`
import typings.appleMapkitJs.appleMapkitJsStrings.`user-location-error`
import typings.appleMapkitJs.appleMapkitJsStrings.`zoom-end`
import typings.appleMapkitJs.appleMapkitJsStrings.`zoom-start`
import typings.appleMapkitJs.appleMapkitJsStrings.deselect
import typings.appleMapkitJs.appleMapkitJsStrings.dragging
import typings.appleMapkitJs.appleMapkitJsStrings.select
...
trait Map extends js.Object {
  ...
  def addEventListener_deselect[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typings.appleMapkitJs.anon.Annotation, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_dragging[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] with typings.appleMapkitJs.anon.Coordinate, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
