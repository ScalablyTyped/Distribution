...
class ViewConfiguration ()
  extends typings.androiduix.android.view.ViewConfiguration
...
object ViewConfiguration extends js.Object {
  ...
  var instance: typings.androiduix.android.view.ViewConfiguration = js.native
  def get(): typings.androiduix.android.view.ViewConfiguration = js.native
  def get(arg: js.Any): typings.androiduix.android.view.ViewConfiguration = js.native
