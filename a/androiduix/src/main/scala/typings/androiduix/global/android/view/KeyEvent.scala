...
import typings.androiduix.anon.Alt
...
@js.native
class KeyEvent ()
  extends typings.androiduix.android.view.KeyEvent
...
object KeyEvent extends js.Object {
  ...
  class DispatcherState ()
    extends typings.androiduix.android.view.KeyEvent.DispatcherState
  ...
  var KEYCODE_CHANGE_ANDROID_CHROME: Alt = js.native
