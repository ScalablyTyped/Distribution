...
import typings.androiduix.androidNs.viewNs.ViewNs.AttachInfo
import typings.androiduix.androidNs.viewNs.ViewNs.ListenerInfo
...
import typings.androiduix.androidNs.viewNs.ViewNs.OnFocusChangeListener
import typings.androiduix.androidNs.viewNs.ViewNs.OnKeyListener
import typings.androiduix.androidNs.viewNs.ViewNs.OnLayoutChangeListener
...
import typings.androiduix.androidNs.viewNs.ViewNs.TransformationInfo
...
object View extends js.Object {
  ...
  def inflate(context: Context, xml: String): View = js.native
  def inflate(context: Context, xml: String, root: ViewGroup): View = js.native
  def inflate(context: Context, xml: HTMLElement): View = js.native
  def inflate(context: Context, xml: HTMLElement, root: ViewGroup): View = js.native
