...
import typings.androiduix.androidNs.widgetNs.NumberPickerNs.Formatter
import typings.androiduix.androidNs.widgetNs.NumberPickerNs.OnScrollListener
import typings.androiduix.androidNs.widgetNs.NumberPickerNs.OnValueChangeListener
