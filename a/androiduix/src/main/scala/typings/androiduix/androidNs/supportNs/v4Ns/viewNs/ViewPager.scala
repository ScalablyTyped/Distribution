package typings.androiduix.androidNs.supportNs.v4Ns.viewNs

import typings.androiduix.androidNs.contentNs.Context
import typings.androiduix.androidNs.graphicsNs.drawableNs.Drawable
import typings.androiduix.androidNs.supportNs.v4Ns.viewNs.ViewPagerNs.OnAdapterChangeListener
import typings.androiduix.androidNs.supportNs.v4Ns.viewNs.ViewPagerNs.OnPageChangeListener
import typings.androiduix.androidNs.supportNs.v4Ns.viewNs.ViewPagerNs.PageTransformer
...
@js.native
class ViewPager protected () extends ViewGroup {
