...
object BufferType extends js.Object {
  ...
  /* 2 */ val EDITABLE: typings.androiduix.androidNs.widgetNs.TextViewNs.BufferType.EDITABLE with Double = js.native
  /* 0 */ val NORMAL: typings.androiduix.androidNs.widgetNs.TextViewNs.BufferType.NORMAL with Double = js.native
  /* 1 */ val SPANNABLE: typings.androiduix.androidNs.widgetNs.TextViewNs.BufferType.SPANNABLE with Double = js.native
  @JSBracketAccess
