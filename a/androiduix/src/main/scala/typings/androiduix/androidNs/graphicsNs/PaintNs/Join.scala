...
object Join extends js.Object {
  ...
  /* 2 */ val BEVEL: typings.androiduix.androidNs.graphicsNs.PaintNs.Join.BEVEL with Double = js.native
  /* 0 */ val MITER: typings.androiduix.androidNs.graphicsNs.PaintNs.Join.MITER with Double = js.native
  /* 1 */ val ROUND: typings.androiduix.androidNs.graphicsNs.PaintNs.Join.ROUND with Double = js.native
  @JSBracketAccess
