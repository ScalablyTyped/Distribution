...
class Window protected () extends js.Object {
  ...
  def getAttributes(): typings.androiduix.androidNs.viewNs.WindowManagerNs.LayoutParams = js.native
  ...
  def setAttributes(a: typings.androiduix.androidNs.viewNs.WindowManagerNs.LayoutParams): Unit = js.native
