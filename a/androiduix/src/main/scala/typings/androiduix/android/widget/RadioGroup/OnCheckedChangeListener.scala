...
trait OnCheckedChangeListener extends js.Object {
  ...
  def onCheckedChanged(group: typings.androiduix.android.widget.RadioGroup, checkedId: String): Unit = js.native
}
object OnCheckedChangeListener {
  ...
  implicit class OnCheckedChangeListenerOps[Self <: OnCheckedChangeListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOnCheckedChanged(value: (typings.androiduix.android.widget.RadioGroup, String) => Unit): Self = this.set("onCheckedChanged", js.Any.fromFunction2(value))
  }
}
