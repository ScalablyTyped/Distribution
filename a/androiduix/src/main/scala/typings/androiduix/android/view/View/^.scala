...
object ^ extends js.Object {
  ...
  def inflate(context: Context, xml: String, root: ViewGroup): typings.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement): typings.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement, root: ViewGroup): typings.androiduix.android.view.View = js.native
