...
import typings.androiduix.androiduiNs.imageNs.NetDrawableNs.LoadListener
import typings.androiduix.androiduiNs.imageNs.NetDrawableNs.TileMode
...
@js.native
class NetDrawable protected () extends Drawable {
