...
class AnimationSet () extends Animation {
  def this(shareInterpolator: scala.Boolean) = this()
  ...
  def addAnimation(a: Animation): scala.Unit = js.native
  def getAnimations(): androiduixLib.javaNs.utilNs.List[Animation] = js.native
  /* private */ def init(): js.Any = js.native
  def restoreChildrenStartOffset(): scala.Unit = js.native
