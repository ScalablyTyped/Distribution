...
class Global protected () extends js.Object {
  ...
  var BinaryOperation: Instantiable3[
    ...
    typings.angularDashOdataDashResources.OData.BinaryOperation
  ] = js.native
  ...
  var Property: Instantiable1[/* value */ String, typings.angularDashOdataDashResources.OData.Property] = js.native
  var Provider: typings.angularDashOdataDashResources.OData.Provider[_] = js.native
  var Value: Instantiable2[
    /* value */ js.Any, 
    js.UndefOr[/* type */ String], 
    typings.angularDashOdataDashResources.OData.Value
  ] = js.native
}
