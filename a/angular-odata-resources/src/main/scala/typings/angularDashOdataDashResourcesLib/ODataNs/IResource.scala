...
trait IResource[T] extends js.Object {
  ...
  @JSName("$update")
  def $update(params: js.Object, success: js.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
  @JSName("$update")
  def $update(params: js.Object, success: js.Function, error: js.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
  @JSName("$update")
  def $update(success: js.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
  @JSName("$update")
  def $update(success: js.Function, error: js.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
}
