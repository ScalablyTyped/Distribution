...
trait IResource[T] extends js.Object {
  ...
  @JSName("$update")
  def $update(params: js.Object, success: angularLib.angularMod.Global.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
  @JSName("$update")
  def $update(
    params: js.Object,
    success: angularLib.angularMod.Global.Function,
  ...
  @JSName("$update")
  def $update(success: angularLib.angularMod.Global.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
  @JSName("$update")
  def $update(success: angularLib.angularMod.Global.Function, error: angularLib.angularMod.Global.Function): angularLib.angularMod.angularNs.IPromise[T] = js.native
}
