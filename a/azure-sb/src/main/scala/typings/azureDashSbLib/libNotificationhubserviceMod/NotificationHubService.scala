...
trait NotificationHubService extends js.Object {
  ...
  def createOrUpdateInstallation(
    ...
    callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Callback */ js.Any
  ...
  def createRegistrationId(callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Callback */ js.Any): scala.Unit = js.native
  ...
  def listRegistrations(callback: /* import warning: QualifyReferences.resolveTypeRef Couldn't qualify Callback */ js.Any): scala.Unit = js.native
