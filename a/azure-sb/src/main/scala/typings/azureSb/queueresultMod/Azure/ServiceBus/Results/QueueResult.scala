...
object QueueResult {
  ...
  @scala.inline
  implicit class QueueResultOps[Self <: QueueResult] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSerialize(value: QueueProperties => String): Self = this.set("serialize", js.Any.fromFunction1(value))
  }
}
