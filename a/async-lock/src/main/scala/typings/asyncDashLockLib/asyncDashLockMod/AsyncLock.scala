...
trait AsyncLock extends js.Object {
  ...
  def acquire[T](key: java.lang.String, fn: js.Function1[/* done */ AsyncLockDoneCallback[T], _]): js.Promise[T] = js.native
  def acquire[T](
  ...
  def acquire[T](key: js.Array[java.lang.String], fn: js.Function1[/* done */ AsyncLockDoneCallback[T], _]): js.Promise[T] = js.native
  def acquire[T](
