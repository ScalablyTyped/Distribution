...
object quadraticMod {
  ...
  object default {
    ...
    inline def length(x1: Double, y1: Double, x2: Double, y2: Double, x3: Double, y3: Double): js.Any = (^.asInstanceOf[js.Dynamic].applyDynamic("length")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any], x3.asInstanceOf[js.Any], y3.asInstanceOf[js.Any])).asInstanceOf[js.Any]
