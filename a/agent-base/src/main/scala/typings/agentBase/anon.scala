...
object anon {
  ...
  trait FnCall extends StObject {
    ...
    def apply[TResult1, TResult2](onfulfilled: js.Function1[/* value */ IncomingMessage, TResult1 | PromiseLike[TResult1]]): js.Promise[TResult1 | TResult2] = js.native
  ...
  /* Inlined std.Partial<node.net.TcpNetConnectOpts & node.tls.ConnectionOptions> */
  trait PartialTcpNetConnectOptsC extends StObject {
  ...
  object PartialTcpNetConnectOptsC {
    
    inline def apply(): PartialTcpNetConnectOptsC = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PartialTcpNetConnectOptsC]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PartialTcpNetConnectOptsC] (val x: Self) extends AnyVal {
