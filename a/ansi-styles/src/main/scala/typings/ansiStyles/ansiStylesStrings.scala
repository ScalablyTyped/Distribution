...
import typings.ansiStyles.mod.BackgroundColorName
import typings.ansiStyles.mod.ForegroundColorName
import typings.ansiStyles.mod.ModifierName
...
object ansiStylesStrings {
  ...
  sealed trait black
    extends StObject
       with ForegroundColorName
  inline def black: black = "black".asInstanceOf[black]
  
  @js.native
  sealed trait blackBright
    extends StObject
       with ForegroundColorName
