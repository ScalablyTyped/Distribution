...
import typings.ansiStyles.escapeCodeMod.EscapeCode.BackgroundColor
import typings.ansiStyles.escapeCodeMod.EscapeCode.CodePair
import typings.ansiStyles.escapeCodeMod.EscapeCode.Color
import typings.ansiStyles.escapeCodeMod.EscapeCode.ColorType
...
object mod extends js.Object {
  ...
  val bgColor: BackgroundColor with ColorType with AnonClose = js.native
  ...
  val color: Color with ColorType with AnonClose = js.native
