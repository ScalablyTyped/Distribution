...
object mod {
  ...
  open class Ie11Sha256 ()
    extends typings.awsCryptoSha256Browser.buildIe11Sha256Mod.Sha256 {
  ...
  @js.native
  open class Sha256 ()
    extends typings.awsCryptoSha256Browser.buildCrossPlatformSha256Mod.Sha256 {
    def this(secret: SourceData) = this()
  }
  ...
  open class WebCryptoSha256 ()
    extends typings.awsCryptoSha256Browser.buildWebCryptoSha256Mod.Sha256 {
    def this(secret: SourceData) = this()
  }
}
