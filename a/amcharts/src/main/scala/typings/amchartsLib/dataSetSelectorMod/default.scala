...
class default () extends DataSetSelector {
  /**
    ...
    */
  /* CompleteClass */
  override var comboBoxSelectText: java.lang.String = js.native
  /**
    * Text displayed near "compare to" list. Compare to:
    */
  /* CompleteClass */
  override var compareText: java.lang.String = js.native
  /**
    * The maximum height of the Compare to field in pixels.
    * @default 150
    */
  /* CompleteClass */
  override var listHeight: scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var selectText: java.lang.String = js.native
  /**
