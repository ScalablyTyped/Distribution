...
object GaugeAxis {
  @scala.inline
  def apply(
    addListener: (java.lang.String, js.Any) => scala.Unit,
    ...
    labelFunction: scala.Double => java.lang.String,
    ...
    setBottomText: java.lang.String => scala.Unit,
    setTopText: java.lang.String => scala.Unit,
    ...
    value2angle: scala.Double => scala.Unit,
