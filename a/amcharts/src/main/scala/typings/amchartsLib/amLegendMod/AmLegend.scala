...
object AmLegend {
  @scala.inline
  def apply(
    addListener: (java.lang.String, js.Function1[/* e */ amchartsLib.Anon_ChartDataItem, scala.Unit]) => scala.Unit,
