package typings.amcharts.chartCursorMod

import typings.amcharts.Anon_ChartDelta2X
...
trait ChartCursor extends js.Object {
  ...
  /**
    ...
    */
  def addListener(`type`: String, handler: js.Function1[/* e */ Anon_ChartDelta2X, Unit]): Unit = js.native
  /**
    * Hides cursor.
    */
