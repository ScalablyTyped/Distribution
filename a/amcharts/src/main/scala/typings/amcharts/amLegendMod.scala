...
object amLegendMod {
  ...
  object AmLegend {
    ...
    @scala.inline
    implicit class AmLegendMutableBuilder[Self <: AmLegend] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setAddListener(value: (String, js.Function1[/* e */ DataItem, Unit]) => Unit): Self = StObject.set(x, "addListener", js.Any.fromFunction2(value))
      
      @scala.inline
      def setAlign(value: String): Self = StObject.set(x, "align", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setAutoMargins(value: Boolean): Self = StObject.set(x, "autoMargins", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setMaxColumns(value: Double): Self = StObject.set(x, "maxColumns", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setShowEntries(value: Boolean): Self = StObject.set(x, "showEntries", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setUseGraphSettings(value: Boolean): Self = StObject.set(x, "useGraphSettings", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setUseMarkerColorForLabels(value: Boolean): Self = StObject.set(x, "useMarkerColorForLabels", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setValueAlign(value: String): Self = StObject.set(x, "valueAlign", value.asInstanceOf[js.Any])
