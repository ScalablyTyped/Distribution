...
object DataSet {
  ...
  implicit class DataSetOps[Self <: DataSet] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStockEventsVarargs(value: typings.amcharts.stockEventMod.default*): Self = this.set("stockEvents", js.Array(value :_*))
    @scala.inline
    def setStockEvents(value: js.Array[typings.amcharts.stockEventMod.default]): Self = this.set("stockEvents", value.asInstanceOf[js.Any])
    @scala.inline
