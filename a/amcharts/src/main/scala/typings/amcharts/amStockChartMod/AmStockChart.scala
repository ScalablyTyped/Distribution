...
trait AmStockChart extends js.Object {
  ...
  /**
    ...
    */
  def addListener(`type`: String, handler: js.Function1[/* e */ typings.amcharts.anon.Date, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    */
  def zoom(startDate: Date, endDate: Date): Unit = js.native
  /**
    * Zooms out the chart.
    */
...
object AmStockChart {
  @scala.inline
  def apply(
    addListener: (String, js.Function1[/* e */ typings.amcharts.anon.Date, Unit]) => Unit,
  ...
  implicit class AmStockChartOps[Self <: AmStockChart] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddListener(value: (String, js.Function1[/* e */ typings.amcharts.anon.Date, Unit]) => Unit): Self = this.set("addListener", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setZoom(value: (Date, Date) => Unit): Self = this.set("zoom", js.Any.fromFunction2(value))
    @scala.inline
