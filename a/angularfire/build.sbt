...
name := "angularfire"
version := "0.8.2-dt-20180910Z-b020c8"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "firebase" % "5.5.5-d7acd8",
  ...
  "com.scalablytyped" %%% "firebase__firestore" % "0.8.5-19e834",
  ...
  "com.scalablytyped" %%% "firebase__polyfill" % "0.3.3-8e09a6",
