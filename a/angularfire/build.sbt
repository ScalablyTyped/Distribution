...
name := "angularfire"
version := "0.8.2-dt-20181124Z-c71d33"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.6-95b397",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.6-b33b73",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.7-fa15cc",
