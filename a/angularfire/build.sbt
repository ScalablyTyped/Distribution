...
name := "angularfire"
version := "0.8.2-dt-20181124Z-83706a"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.9.1-7d5616",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.1.1-1deab1",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.9-72b2ba",
