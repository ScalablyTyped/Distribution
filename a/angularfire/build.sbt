...
name := "angularfire"
version := "0.8.2-dt-20180910Z-fd49dd"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "firebase" % "5.5.5-2b9eb3",
  ...
  "com.scalablytyped" %%% "firebase__firestore" % "0.8.5-4bf797",
  ...
  "com.scalablytyped" %%% "firebase__polyfill" % "0.3.3-aa488e",
