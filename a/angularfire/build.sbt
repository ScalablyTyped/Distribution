...
name := "angularfire"
version := "0.8.2-dt-20181124Z-b6d55d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.2-1a865d",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.2-337618",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-f2ff58",
