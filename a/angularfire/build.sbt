...
name := "angularfire"
version := "0.8.2-dt-20181124Z-d73405"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.2-61a7f5",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.2-634f5a",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-8ae15a",
