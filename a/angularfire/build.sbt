...
name := "angularfire"
version := "0.8.2-dt-20181124Z-446b52"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.6-6a0748",
  "org.scalablytyped" %%% "firebase__app" % "0.3.11-936b51",
  "org.scalablytyped" %%% "firebase__app-types" % "0.3.5-f69060",
  "org.scalablytyped" %%% "firebase__auth" % "0.9.4-b98b15",
  "org.scalablytyped" %%% "firebase__auth-types" % "0.5.3-019ce5",
  "org.scalablytyped" %%% "firebase__database" % "0.3.14-e5de97",
  "org.scalablytyped" %%% "firebase__database-types" % "0.3.6-eb2d73",
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.6-095a76",
  "org.scalablytyped" %%% "firebase__firestore-types" % "1.0.3-f3cf31",
  "org.scalablytyped" %%% "firebase__functions" % "0.4.1-da9a32",
  "org.scalablytyped" %%% "firebase__functions-types" % "0.3.0-b58d1f",
  "org.scalablytyped" %%% "firebase__logger" % "0.1.8-4d839b",
  "org.scalablytyped" %%% "firebase__messaging" % "0.3.13-7225f3",
  "org.scalablytyped" %%% "firebase__messaging-types" % "0.2.6-902a8c",
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.7-be6828",
  "org.scalablytyped" %%% "firebase__storage" % "0.2.10-c63112",
  "org.scalablytyped" %%% "firebase__storage-types" % "0.2.6-268b92",
