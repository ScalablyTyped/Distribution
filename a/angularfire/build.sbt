...
name := "angularfire"
version := "0.8.2-dt-20181124Z-8934f7"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.9.0-4d98bc",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.1.0-6a8ac2",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.8-a4ca10",
