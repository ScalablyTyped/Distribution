...
name := "angularfire"
version := "0.8.2-dt-20181124Z-a2b133"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.6-047635",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.6-5cf2ab",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.7-a81ead",
