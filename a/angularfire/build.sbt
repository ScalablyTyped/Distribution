...
name := "angularfire"
version := "0.8.2-dt-20181124Z-a86c09"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.1-0f9aab",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.1-279b4e",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-b56a70",
