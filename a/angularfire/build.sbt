...
name := "angularfire"
version := "0.8.2-dt-20181124Z-bca286"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.2-977d25",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.2-9a2a47",
  "org.scalablytyped" %%% "firebase__firestore-types" % "1.0.1-11a2c6",
  "org.scalablytyped" %%% "firebase__functions" % "0.3.6-0735d0",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-89c6fd",
