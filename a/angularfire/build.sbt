...
name := "angularfire"
version := "0.8.2-dt-20181124Z-66b6b9"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.3-b49287",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.3-aa980f",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.6-71757b",
