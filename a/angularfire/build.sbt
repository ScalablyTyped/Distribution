...
name := "angularfire"
version := "0.8.2-dt-20181124Z-818081"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.4-a1d01f",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.4-f9d898",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.6-c33c0c",
