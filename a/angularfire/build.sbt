...
name := "angularfire"
version := "0.8.2-dt-20181206Z-ae33fa"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "0.8.8-8b68ac",
