...
name := "angularfire"
version := "0.8.2-dt-20190322Z-444c09"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.9.2-9dc1ae",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.1.2-0421c0",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.9-336bdb",
