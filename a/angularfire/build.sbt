...
name := "angularfire"
version := "0.8.2-dt-20181124Z-76470e"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.5-49d25b",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.5-86dbcc",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.7-2b392b",
