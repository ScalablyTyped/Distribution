...
name := "angularfire"
version := "0.8.2-dt-20181124Z-c49016"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.2-659906",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.2-dfa9be",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-7c905b",
