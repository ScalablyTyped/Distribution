...
name := "angularfire"
version := "0.8.2-dt-20181124Z-098343"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.1-2cf9dc",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.1-5be06f",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.5-e16411",
