...
name := "angularfire"
version := "0.8.2-dt-20181206Z-b2ae2d"
scalaVersion := "2.12.7"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.7.0-2e9508",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "0.9.0-25f11c",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.3-5b2100",
