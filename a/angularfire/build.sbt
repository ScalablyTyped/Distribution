...
name := "angularfire"
version := "0.8.2-dt-20181124Z-c7384d"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.9.0-4d6b94",
  ...
  "org.scalablytyped" %%% "firebase__firestore" % "1.1.0-ae6d53",
  ...
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.8-a40a75",
