...
name := "angularfire"
version := "0.8.2-dt-20181124Z-1ef307"
scalaVersion := "2.12.8"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "firebase" % "5.8.0-6c9d2a",
  "org.scalablytyped" %%% "firebase__app" % "0.3.7-3b917f",
  "org.scalablytyped" %%% "firebase__app-types" % "0.3.2-99e1ce",
  "org.scalablytyped" %%% "firebase__auth" % "0.9.1-775d57",
  "org.scalablytyped" %%% "firebase__auth-types" % "0.5.0-b172c0",
  "org.scalablytyped" %%% "firebase__database" % "0.3.10-dc1f13",
  "org.scalablytyped" %%% "firebase__database-types" % "0.3.3-45a9ac",
  "org.scalablytyped" %%% "firebase__firestore" % "1.0.0-3fa904",
  "org.scalablytyped" %%% "firebase__firestore-types" % "1.0.0-e32ce4",
  "org.scalablytyped" %%% "firebase__functions" % "0.3.5-b32e15",
  "org.scalablytyped" %%% "firebase__functions-types" % "0.2.1-43cf9a",
  "org.scalablytyped" %%% "firebase__logger" % "0.1.4-1b0e66",
  "org.scalablytyped" %%% "firebase__messaging" % "0.3.9-aa87ff",
  "org.scalablytyped" %%% "firebase__messaging-types" % "0.2.3-047c5b",
  "org.scalablytyped" %%% "firebase__polyfill" % "0.3.4-e16411",
  "org.scalablytyped" %%% "firebase__storage" % "0.2.6-fbd059",
  "org.scalablytyped" %%% "firebase__storage-types" % "0.2.3-dc5d69",
