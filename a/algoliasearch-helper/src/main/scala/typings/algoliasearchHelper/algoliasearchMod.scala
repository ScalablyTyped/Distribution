...
object algoliasearchMod {
  ...
  type ClientV5 = Any | ClientFullV5 | ClientSearchV5 | ClientLiteV5
  ...
  type PickForClient[T /* <: V3 */] = /* import warning: importer.ImportType#apply Failed type conversion: T['v3'] */ js.Any
  ...
  trait SearchClient extends StObject {
    ...
    var initIndex: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: algoliasearch-helper.algoliasearch-helper/types/algoliasearch.DefaultSearchClient['initIndex'] */ js.Any
      ] = js.undefined
    ...
    var searchForFacetValues: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: algoliasearch-helper.algoliasearch-helper/types/algoliasearch.DefaultSearchClient['searchForFacetValues'] */ js.Any
      ] = js.undefined
  }
  object SearchClient {
    ...
    extension [Self <: SearchClient](x: Self) {
      ...
      inline def setInitIndex(
        value: /* import warning: importer.ImportType#apply Failed type conversion: algoliasearch-helper.algoliasearch-helper/types/algoliasearch.DefaultSearchClient['initIndex'] */ js.Any
      ...
      inline def setSearchForFacetValues(
        value: /* import warning: importer.ImportType#apply Failed type conversion: algoliasearch-helper.algoliasearch-helper/types/algoliasearch.DefaultSearchClient['searchForFacetValues'] */ js.Any
