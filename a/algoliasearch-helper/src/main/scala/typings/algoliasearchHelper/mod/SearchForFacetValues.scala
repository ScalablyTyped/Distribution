...
object SearchForFacetValues {
  ...
  object Hit {
    ...
    inline def apply(count: Double, highlighted: String, isRefined: Boolean, value: String): Hit = {
  ...
  object Result {
    ...
    extension [Self <: Result](x: Self) {
      ...
      inline def setFacetHitsVarargs(value: Hit*): Self = StObject.set(x, "facetHits", js.Array(value :_*))
