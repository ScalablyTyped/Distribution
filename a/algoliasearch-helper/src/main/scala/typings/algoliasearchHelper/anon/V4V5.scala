...
trait V4V5 extends StObject {
  ...
  // @ts-ignore
  var v5: typings.algoliasearchHelper.algoliasearchMod.RankingInfo
}
object V4V5 {
  ...
  inline def apply(
    ...
    v4: RankingInfo,
    v5: typings.algoliasearchHelper.algoliasearchMod.RankingInfo
  ): V4V5 = {
  ...
  extension [Self <: V4V5](x: Self) {
    ...
    inline def setV5(value: typings.algoliasearchHelper.algoliasearchMod.RankingInfo): Self = StObject.set(x, "v5", value.asInstanceOf[js.Any])
  }
}
