...
trait V4V5 extends StObject {
  ...
  // @ts-ignore
  var v5: typings.algoliasearchHelper.typesAlgoliasearchMod.RankingInfo
}
object V4V5 {
  ...
  inline def apply(
    ...
    v4: RankingInfo,
    v5: typings.algoliasearchHelper.typesAlgoliasearchMod.RankingInfo
  ): V4V5 = {
    val __obj = js.Dynamic.literal(v3 = v3.asInstanceOf[js.Any], v4 = v4.asInstanceOf[js.Any], v5 = v5.asInstanceOf[js.Any])
    __obj.asInstanceOf[V4V5]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: V4V5] (val x: Self) extends AnyVal {
    ...
    inline def setV5(value: typings.algoliasearchHelper.typesAlgoliasearchMod.RankingInfo): Self = StObject.set(x, "v5", value.asInstanceOf[js.Any])
  }
}
