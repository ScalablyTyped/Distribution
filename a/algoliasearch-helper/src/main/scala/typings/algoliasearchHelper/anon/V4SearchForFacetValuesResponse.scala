...
trait V4SearchForFacetValuesResponse extends StObject {
  ...
  // @ts-ignore
  var v5: typings.algoliasearchHelper.algoliasearchMod.SearchForFacetValuesResponse
}
object V4SearchForFacetValuesResponse {
  ...
  inline def apply(
    ...
    v5: typings.algoliasearchHelper.algoliasearchMod.SearchForFacetValuesResponse
  ...
  extension [Self <: V4SearchForFacetValuesResponse](x: Self) {
    ...
    inline def setV5(value: typings.algoliasearchHelper.algoliasearchMod.SearchForFacetValuesResponse): Self = StObject.set(x, "v5", value.asInstanceOf[js.Any])
  }
}
