...
class SearchParameters () extends QueryParameters {
  ...
  var alternativesAsExact_SearchParameters: js.UndefOr[js.Array[ignorePlurals | singleWordSynonym | multiWordsSynonym]] = js.native
  @JSName("aroundRadius")
  var aroundRadius_SearchParameters: js.UndefOr[Double] = js.native
  @JSName("disjunctiveFacetsRefinements")
  var disjunctiveFacetsRefinements_SearchParameters: js.UndefOr[StringDictionary[js.Array[String]]] = js.native
  @JSName("exactOnSingleWordQuery")
  var exactOnSingleWordQuery_SearchParameters: js.UndefOr[none | attribute | word] = js.native
  @JSName("facetFilters")
  var facetFilters_SearchParameters: js.UndefOr[js.Array[js.Array[String] | String]] = js.native
  @JSName("facetsExcludes")
  var facetsExcludes_SearchParameters: js.UndefOr[StringDictionary[js.Array[String]]] = js.native
  @JSName("facetsRefinements")
  var facetsRefinements_SearchParameters: js.UndefOr[StringDictionary[js.Array[String]]] = js.native
  @JSName("hierarchicalFacetsRefinements")
  var hierarchicalFacetsRefinements_SearchParameters: js.UndefOr[StringDictionary[js.Array[String]]] = js.native
