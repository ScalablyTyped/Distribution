...
@js.native
trait SearchParameters extends QueryParameters {
  ...
  def addNumericRefinement(
    ...
    operator: algoliasearchDashHelperLib.algoliasearchDashHelperMod.algoliasearchHelperNs.SearchParametersNs.Operator,
