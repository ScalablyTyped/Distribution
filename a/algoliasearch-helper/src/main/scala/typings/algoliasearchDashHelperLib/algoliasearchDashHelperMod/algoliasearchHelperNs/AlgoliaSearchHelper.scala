...
trait AlgoliaSearchHelper
  ...
  def clearRefinements(name: java.lang.String): this.type = js.native
  /**
  ...
  def getState(filters: js.Array[java.lang.String]): QueryParameters = js.native
  ...
  @JSName("on")
  def on_change(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.change,
    cb: js.Function2[/* state */ SearchParameters, /* lastResults */ SearchResults | scala.Null, _]
  ): this.type = js.native
  @JSName("on")
  def on_error(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.error,
    cb: js.Function1[/* error */ js.Any, _]
  ): this.type = js.native
  @JSName("on")
  def on_result(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.result,
    cb: js.Function2[/* results */ SearchResults, /* state */ SearchParameters, _]
  ): this.type = js.native
  @JSName("on")
  def on_search(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.search,
    cb: js.Function2[/* state */ SearchParameters, /* lastResults */ SearchResults | scala.Null, _]
  ): this.type = js.native
  @JSName("on")
  def on_searchForFacetValues(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.searchForFacetValues,
    cb: js.Function3[
  ...
  @JSName("on")
  def on_searchOnce(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.searchOnce,
    cb: js.Function1[/* state */ SearchParameters, _]
  ): this.type = js.native
  @JSName("on")
  def on_searchQueueEmpty(
    event: algoliasearchDashHelperLib.algoliasearchDashHelperLibStrings.searchQueueEmpty,
    cb: js.Function0[_]
  ): this.type = js.native
  ...
  /**
    ...
    */
  def searchForFacetValues(facet: java.lang.String, query: java.lang.String, maxFacetHits: scala.Double, userState: js.Any): js.Promise[
    algoliasearchDashHelperLib.algoliasearchDashHelperMod.algoliasearchHelperNs.AlgoliaSearchHelperNs.FacetSearchResult
  ] = js.native
  /**
    ...
    * }
    */
  def searchOnce(options: QueryParameters): js.Promise[algoliasearchDashHelperLib.Anon_Content] = js.native
  def searchOnce(
  ...
  /**
    ...
    * @chainable
    */
  def setIndex(name: java.lang.String): this.type = js.native
  ...
  /**
    ...
    * @chainable
    */
  def setQuery(q: java.lang.String): this.type = js.native
