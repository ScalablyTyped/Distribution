...
trait QueryParameters
  ...
  var disjunctiveFacetsRefinements: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[
      algoliasearchDashHelperLib.algoliasearchDashHelperMod.algoliasearchHelperNs.SearchParametersNs.FacetList
    ]
  ] = js.undefined
  // Misc. parameters
  /**
  ...
  var numericRefinements: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[
      algoliasearchDashHelperLib.algoliasearchDashHelperMod.algoliasearchHelperNs.SearchParametersNs.OperatorList
    ]
  ] = js.undefined
  /**
