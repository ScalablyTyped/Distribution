...
@js.native
class Object ()
  extends typings.avoscloudDashSdk.avoscloudDashSdkMod.Object {
...
object Object extends js.Object {
  def destroyAll[T](list: js.Array[typings.avoscloudDashSdk.avoscloudDashSdkMod.Object]): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
  def destroyAll[T](list: js.Array[typings.avoscloudDashSdk.avoscloudDashSdkMod.Object], options: DestroyAllOptions): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
  ...
  ): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
  def fetchAllIfNeeded[T](
    list: js.Array[typings.avoscloudDashSdk.avoscloudDashSdkMod.Object],
    options: SuccessFailureOptions
  ): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
  def saveAll[T](list: js.Array[typings.avoscloudDashSdk.avoscloudDashSdkMod.Object]): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
  def saveAll[T](list: js.Array[typings.avoscloudDashSdk.avoscloudDashSdkMod.Object], options: SaveAllOptions): typings.avoscloudDashSdk.avoscloudDashSdkMod.Promise[T] = js.native
}
