...
import typings.avoscloudDashSdk.avoscloudDashSdkMod.QueryNs.CountOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.QueryNs.FindOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.QueryNs.FirstOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.QueryNs.GetOptions
...
@js.native
class Query protected () extends BaseObject {
...
object Query extends js.Object {
  def and(var_args: Query*): Query = js.native
  def or(var_args: Query*): Query = js.native
}
