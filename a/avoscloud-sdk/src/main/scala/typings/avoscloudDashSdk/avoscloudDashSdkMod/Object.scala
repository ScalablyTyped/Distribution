...
import typings.avoscloudDashSdk.avoscloudDashSdkMod.ObjectNs.DestroyOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.ObjectNs.FetchOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.ObjectNs.SaveAllOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.ObjectNs.SaveOptions
import typings.avoscloudDashSdk.avoscloudDashSdkMod.ObjectNs.SetOptions
...
object Object extends js.Object {
  def destroyAll[T](list: js.Array[Object]): Promise[T] = js.native
  def destroyAll[T](list: js.Array[Object], options: DestroyAllOptions): Promise[T] = js.native
  ...
  def fetchAll[T](list: js.Array[Object], options: SuccessFailureOptions): Promise[T] = js.native
  def fetchAllIfNeeded[T](list: js.Array[Object], options: SuccessFailureOptions): Promise[T] = js.native
  def saveAll[T](list: js.Array[Object]): Promise[T] = js.native
  def saveAll[T](list: js.Array[Object], options: SaveAllOptions): Promise[T] = js.native
}
