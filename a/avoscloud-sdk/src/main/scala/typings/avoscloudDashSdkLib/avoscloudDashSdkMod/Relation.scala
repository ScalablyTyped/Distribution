...
class Relation ()
  ...
  def this(parent: js.Object, key: java.lang.String) = this()
  /* CompleteClass */
  ...
  /* CompleteClass */
  override def add(`object`: js.Object): scala.Unit = js.native
  ...
  /* CompleteClass */
  override def remove(`object`: js.Object): scala.Unit = js.native
  /* CompleteClass */
