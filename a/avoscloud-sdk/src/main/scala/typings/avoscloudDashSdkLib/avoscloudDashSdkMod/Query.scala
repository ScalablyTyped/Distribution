...
class Query protected () extends BaseObject {
  ...
  def collection(items: js.Array[Object], options: avoscloudDashSdkLib.avoscloudDashSdkMod.CollectionNs.Options): Collection[Object] = js.native
  ...
  def count[T](options: avoscloudDashSdkLib.avoscloudDashSdkMod.QueryNs.CountOptions): Promise[T] = js.native
  ...
  def find[T](options: avoscloudDashSdkLib.avoscloudDashSdkMod.QueryNs.FindOptions): Promise[T] = js.native
  def first[T](): Promise[T] = js.native
  def first[T](options: avoscloudDashSdkLib.avoscloudDashSdkMod.QueryNs.FirstOptions): Promise[T] = js.native
  def get(objectId: java.lang.String): Promise[_] = js.native
  def get(objectId: java.lang.String, options: avoscloudDashSdkLib.avoscloudDashSdkMod.QueryNs.GetOptions): Promise[_] = js.native
