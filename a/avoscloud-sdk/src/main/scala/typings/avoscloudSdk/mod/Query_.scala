...
import typings.avoscloudSdk.mod.Query.CountOptions
import typings.avoscloudSdk.mod.Query.FindOptions
import typings.avoscloudSdk.mod.Query.FirstOptions
import typings.avoscloudSdk.mod.Query.GetOptions
