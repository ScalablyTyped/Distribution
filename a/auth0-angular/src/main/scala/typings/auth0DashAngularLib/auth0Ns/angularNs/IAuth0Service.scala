...
trait IAuth0Service extends js.Object {
  ...
  /**
    ...
    */
  def authenticate(): angularLib.angularMod.IPromise[_] = js.native
  def authenticate(profile: js.Any): angularLib.angularMod.IPromise[_] = js.native
  def authenticate(profile: js.Any, idToken: java.lang.String): angularLib.angularMod.IPromise[_] = js.native
  def authenticate(profile: js.Any, idToken: java.lang.String, accessToken: java.lang.String): angularLib.angularMod.IPromise[_] = js.native
  def authenticate(profile: js.Any, idToken: java.lang.String, accessToken: java.lang.String, state: js.Any): angularLib.angularMod.IPromise[_] = js.native
  def authenticate(
    profile: js.Any,
  ...
  /**
    ...
    * @param idToken Id token
    */
  def getProfile(): angularLib.angularMod.IPromise[_] = js.native
  def getProfile(idToken: java.lang.String): angularLib.angularMod.IPromise[_] = js.native
  /**
    * Performs a token delegation request exchanging th ecurrent token for another one.
    * @param options Token options
    */
  def getToken(): angularLib.angularMod.IPromise[_] = js.native
  def getToken(options: ITokenOptions): angularLib.angularMod.IPromise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def refreshIdToken(refreshToken: java.lang.String): angularLib.angularMod.IPromise[_] = js.native
  /**
    * Renews the Id Token with the same scopes as the original token
    * @param id_token Id Token
    */
  def renewIdToken(id_token: java.lang.String): angularLib.angularMod.IPromise[_] = js.native
  /**
