...
object PartialFileUploaderOption {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableMultipart)) __obj.updateDynamic("disableMultipart")(disableMultipart.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(removeAfterUpload)) __obj.updateDynamic("removeAfterUpload")(removeAfterUpload.get.asInstanceOf[js.Any])
