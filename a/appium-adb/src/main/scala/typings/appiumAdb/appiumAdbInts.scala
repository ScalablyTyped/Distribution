...
object appiumAdbInts {
  ...
  @js.native
  sealed trait `120000` extends StObject
  inline def `120000`: `120000` = 120000.asInstanceOf[`120000`]
  ...
  @js.native
  sealed trait `60000` extends StObject
  inline def `60000`: `60000` = 60000.asInstanceOf[`60000`]
}
