...
object legacyAnalyticsListenerMod {
  ...
  trait Props extends StObject {
    ...
    def onEvent(event: typings.atlaskitAnalyticsNext.uianalyticseventMod.default): Unit = js.native
    def onEvent(event: typings.atlaskitAnalyticsNext.uianalyticseventMod.default, channel: String): Unit = js.native
  }
}
