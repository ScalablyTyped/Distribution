...
import typings.atlaskitAnalyticsNext.withAnalyticsEventsMod.WithAnalyticsEventsProps
...
object analyticsErrorBoundaryMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `analyticsErrorBoundaryMod.foo` */
