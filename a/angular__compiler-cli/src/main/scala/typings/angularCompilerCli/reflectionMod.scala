...
object reflectionMod {
  ...
  object ClassMemberKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.angularCompilerCli.srcHostMod.ClassMemberKind & Double] = js.native
  ...
  object Decorator {
    ...
    inline def nodeForError(decorator: typings.angularCompilerCli.srcHostMod.Decorator): Node = ^.asInstanceOf[js.Dynamic].applyDynamic("nodeForError")(decorator.asInstanceOf[js.Any]).asInstanceOf[Node]
  }
  ...
  object KnownDeclaration extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.angularCompilerCli.srcHostMod.KnownDeclaration & Double] = js.native
  ...
  open class TypeScriptReflectionHost protected ()
    extends typings.angularCompilerCli.typescriptMod.TypeScriptReflectionHost {
