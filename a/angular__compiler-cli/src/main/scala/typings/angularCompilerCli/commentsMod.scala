...
object commentsMod {
  ...
  object CommentTriviaType extends StObject {
    ...
    /* "D" */ val DIAGNOSTIC: typings.angularCompilerCli.commentsMod.CommentTriviaType.DIAGNOSTIC & String = js.native
    
    @js.native
    sealed trait EXPRESSION_TYPE_IDENTIFIER
      extends StObject
         with CommentTriviaType
    /* "T" */ val EXPRESSION_TYPE_IDENTIFIER: typings.angularCompilerCli.commentsMod.CommentTriviaType.EXPRESSION_TYPE_IDENTIFIER & String = js.native
  }
  ...
  object ExpressionIdentifier extends StObject {
    ...
    /* "COMPCOMP" */ val COMPONENT_COMPLETION: typings.angularCompilerCli.commentsMod.ExpressionIdentifier.COMPONENT_COMPLETION & String = js.native
    
    @js.native
    sealed trait DIRECTIVE
      extends StObject
         with ExpressionIdentifier
    /* "DIR" */ val DIRECTIVE: typings.angularCompilerCli.commentsMod.ExpressionIdentifier.DIRECTIVE & String = js.native
    
    @js.native
    sealed trait EVENT_PARAMETER
      extends StObject
         with ExpressionIdentifier
    /* "EP" */ val EVENT_PARAMETER: typings.angularCompilerCli.commentsMod.ExpressionIdentifier.EVENT_PARAMETER & String = js.native
  }
