...
object typescriptMod {
  ...
  open class TypeScriptReflectionHost protected ()
    ...
    /**
      ...
      */
    /* protected */ def getDeclarationOfSymbol(symbol: Symbol): typings.angularCompilerCli.srcHostMod.Declaration[Declaration] | Null = js.native
    /* protected */ def getDeclarationOfSymbol(symbol: Symbol, originalId: Identifier): typings.angularCompilerCli.srcHostMod.Declaration[Declaration] | Null = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getExportsOfModule(module: Node): (Map[String, typings.angularCompilerCli.srcHostMod.Declaration[Declaration]]) | Null = js.native
