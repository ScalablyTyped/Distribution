...
object baseTaskQueueMod {
  
  @JSImport("@angular/compiler-cli/ngcc/src/execution/tasks/queues/base_task_queue", "BaseTaskQueue")
  @js.native
  abstract class BaseTaskQueue protected ()
    extends StObject
       with TaskQueue {
