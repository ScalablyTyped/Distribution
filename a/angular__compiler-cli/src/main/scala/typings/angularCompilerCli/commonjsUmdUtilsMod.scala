...
object commonjsUmdUtilsMod {
  ...
  trait ExportDeclaration extends StObject {
    ...
    var declaration: typings.angularCompilerCli.srcHostMod.Declaration[Declaration]
    
    var name: String
  }
  object ExportDeclaration {
    
    inline def apply(declaration: typings.angularCompilerCli.srcHostMod.Declaration[Declaration], name: String): ExportDeclaration = {
    ...
    extension [Self <: ExportDeclaration](x: Self) {
      ...
      inline def setDeclaration(value: typings.angularCompilerCli.srcHostMod.Declaration[Declaration]): Self = StObject.set(x, "declaration", value.asInstanceOf[js.Any])
