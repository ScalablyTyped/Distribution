...
import typings.angularCompilerCli.apiApiMod.SourceLocation
...
object tcbUtilMod {
  ...
  object TcbInliningRequirement extends StObject {
    ...
    /* 0 */ val MustInline: typings.angularCompilerCli.tcbUtilMod.TcbInliningRequirement.MustInline & Double = js.native
    ...
    sealed trait None
      extends StObject
         with TcbInliningRequirement
    /* 2 */ val None: typings.angularCompilerCli.tcbUtilMod.TcbInliningRequirement.None & Double = js.native
    ...
    sealed trait ShouldInlineForGenericBounds
      extends StObject
         with TcbInliningRequirement
    /* 1 */ val ShouldInlineForGenericBounds: typings.angularCompilerCli.tcbUtilMod.TcbInliningRequirement.ShouldInlineForGenericBounds & Double = js.native
  }
