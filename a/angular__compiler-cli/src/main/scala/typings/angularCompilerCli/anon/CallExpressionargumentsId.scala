...
/* Inlined typescript.typescript.CallExpression & {  arguments :[typescript.typescript.Identifier, typescript.typescript.StringLiteral, typescript.typescript.ObjectLiteralExpression]} */
@js.native
trait CallExpressionargumentsId extends StObject {
