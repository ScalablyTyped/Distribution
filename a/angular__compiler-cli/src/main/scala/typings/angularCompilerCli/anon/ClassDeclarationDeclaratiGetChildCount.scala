...
import typings.angularCompilerCli.srcNgtscAnnotationsSrcPipeMod.PipeSymbol
...
@js.native
trait ClassDeclarationDeclaratiGetChildCount extends StObject {
  ...
  def forEachChild[T](cbNode: js.Function1[/* node */ PipeSymbol, js.UndefOr[T]]): js.UndefOr[T] = js.native
  def forEachChild[T](
    cbNode: js.Function1[/* node */ PipeSymbol, js.UndefOr[T]],
    cbNodeArray: js.Function1[/* nodes */ NodeArray[PipeSymbol], js.UndefOr[T]]
