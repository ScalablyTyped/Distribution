...
import typings.angularCompilerCli.srcNgtscAnnotationsNgModuleSrcHandlerMod.NgModuleSymbol
...
@js.native
trait ClassDeclarationDeclaratiGetChildAt extends StObject {
  ...
  def forEachChild[T](cbNode: js.Function1[/* node */ NgModuleSymbol, js.UndefOr[T]]): js.UndefOr[T] = js.native
  def forEachChild[T](
    cbNode: js.Function1[/* node */ NgModuleSymbol, js.UndefOr[T]],
    cbNodeArray: js.Function1[/* nodes */ NodeArray[NgModuleSymbol], js.UndefOr[T]]
