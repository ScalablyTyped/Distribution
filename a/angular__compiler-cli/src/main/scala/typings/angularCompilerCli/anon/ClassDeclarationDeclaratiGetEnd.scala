...
@js.native
trait ClassDeclarationDeclaratiGetEnd extends StObject {
  ...
  def forEachChild[T](cbNode: js.Function1[/* node */ SemanticSymbol, js.UndefOr[T]]): js.UndefOr[T] = js.native
  def forEachChild[T](
    cbNode: js.Function1[/* node */ SemanticSymbol, js.UndefOr[T]],
    cbNodeArray: js.Function1[/* nodes */ NodeArray[SemanticSymbol], js.UndefOr[T]]
