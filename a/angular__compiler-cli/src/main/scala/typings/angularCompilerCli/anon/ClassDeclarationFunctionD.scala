...
import typings.typescript.mod.SyntaxKind.FunctionDeclaration
...
/* Inlined @angular/compiler-cli.@angular/compiler-cli/src/ngtsc/reflection/src/host.ClassDeclaration<typescript.typescript.FunctionDeclaration> */
@js.native
trait ClassDeclarationFunctionD extends StObject {
