...
/* Inlined typescript.typescript.CallExpression & {  arguments :[typescript.typescript.ArrayLiteralExpression, typescript.typescript.StringLiteral, typescript.typescript.StringLiteral]} */
@js.native
trait CallExpressionargumentsArArguments extends StObject {
  ...
  val arguments: NodeArray[Expression] & (js.Tuple3[ArrayLiteralExpression, StringLiteral, StringLiteral]) = js.native
