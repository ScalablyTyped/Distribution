...
@js.native
trait ClassDeclarationDeclaratiDeclarationBrand extends StObject {
  ...
  def forEachChild[T](cbNode: js.Function1[/* node */ ComponentSymbol, js.UndefOr[T]]): js.UndefOr[T] = js.native
  def forEachChild[T](
    cbNode: js.Function1[/* node */ ComponentSymbol, js.UndefOr[T]],
    cbNodeArray: js.Function1[/* nodes */ NodeArray[ComponentSymbol], js.UndefOr[T]]
