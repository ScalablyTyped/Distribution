...
@js.native
trait ClassDeclarationClassDeclDeclarationBrand extends StObject {
  ...
  def forEachChild[T](cbNode: js.Function1[/* node */ Context, js.UndefOr[T]]): js.UndefOr[T] = js.native
  def forEachChild[T](
    cbNode: js.Function1[/* node */ Context, js.UndefOr[T]],
    cbNodeArray: js.Function1[/* nodes */ NodeArray[Context], js.UndefOr[T]]
