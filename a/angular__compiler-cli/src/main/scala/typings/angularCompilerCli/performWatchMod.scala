...
object performWatchMod {
  ...
  object FileChangeEvent extends StObject {
    ...
    /* 0 */ val Change: typings.angularCompilerCli.performWatchMod.FileChangeEvent.Change & Double = js.native
    
    @js.native
    sealed trait CreateDelete
      extends StObject
         with FileChangeEvent
    /* 1 */ val CreateDelete: typings.angularCompilerCli.performWatchMod.FileChangeEvent.CreateDelete & Double = js.native
    
    @js.native
    sealed trait CreateDeleteDir
      extends StObject
         with FileChangeEvent
    /* 2 */ val CreateDeleteDir: typings.angularCompilerCli.performWatchMod.FileChangeEvent.CreateDeleteDir & Double = js.native
  }
