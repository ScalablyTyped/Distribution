...
import typings.angularCompilerCli.srcNgtscCoreSrcCompilerMod.CompilationTicketKind.Fresh
import typings.angularCompilerCli.srcNgtscCoreSrcCompilerMod.CompilationTicketKind.IncrementalResource
import typings.angularCompilerCli.srcNgtscCoreSrcCompilerMod.CompilationTicketKind.IncrementalTypeScript
import typings.angularCompilerCli.srcNgtscFileSystemSrcTypesMod.AbsoluteFsPath
import typings.angularCompilerCli.srcNgtscIncrementalMod.IncrementalCompilation
...
import typings.angularCompilerCli.srcNgtscTypecheckApiCheckerMod.OptimizeFor
