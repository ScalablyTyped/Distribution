...
import typings.angularCompilerCli.tasksApiMod.TaskProcessingOutcome
import typings.angularCompilerCli.writingPackageJsonUpdaterMod.PackageJsonChange
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object clusterApiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.clusterApiMod.ReadyMessage
    - typings.angularCompilerCli.clusterApiMod.ErrorMessage
    - typings.angularCompilerCli.clusterApiMod.TaskCompletedMessage
    - typings.angularCompilerCli.clusterApiMod.TransformedFilesMessage
    - typings.angularCompilerCli.clusterApiMod.UpdatePackageJsonMessage
  */
  trait MessageFromWorker extends StObject
  object MessageFromWorker {
    
    inline def ErrorMessage(error: String): typings.angularCompilerCli.clusterApiMod.ErrorMessage = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("error")
      __obj.asInstanceOf[typings.angularCompilerCli.clusterApiMod.ErrorMessage]
    }
    
    inline def ReadyMessage(): typings.angularCompilerCli.clusterApiMod.ReadyMessage = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("ready")
      __obj.asInstanceOf[typings.angularCompilerCli.clusterApiMod.ReadyMessage]
    }
    
    inline def TaskCompletedMessage(outcome: TaskProcessingOutcome): typings.angularCompilerCli.clusterApiMod.TaskCompletedMessage = {
      val __obj = js.Dynamic.literal(outcome = outcome.asInstanceOf[js.Any], message = null)
      __obj.updateDynamic("type")("task-completed")
      __obj.asInstanceOf[typings.angularCompilerCli.clusterApiMod.TaskCompletedMessage]
    }
    
    inline def TransformedFilesMessage(files: js.Array[AbsoluteFsPath]): typings.angularCompilerCli.clusterApiMod.TransformedFilesMessage = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("transformed-files")
      __obj.asInstanceOf[typings.angularCompilerCli.clusterApiMod.TransformedFilesMessage]
    }
    
    inline def UpdatePackageJsonMessage(changes: js.Array[PackageJsonChange], packageJsonPath: AbsoluteFsPath): typings.angularCompilerCli.clusterApiMod.UpdatePackageJsonMessage = {
      ...
      __obj.asInstanceOf[typings.angularCompilerCli.clusterApiMod.UpdatePackageJsonMessage]
    }
  }
