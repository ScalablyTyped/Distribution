...
object renderingFormatterMod {
  ...
  trait RenderingFormatter extends StObject {
    ...
    def removeDecorators(
      output: default,
      decoratorsToRemove: typings.angularCompilerCli.renderingFormatterMod.RedundantDecoratorMap
    ): Unit
  }
  object RenderingFormatter {
    ...
    inline def apply(
      ...
      removeDecorators: (default, typings.angularCompilerCli.renderingFormatterMod.RedundantDecoratorMap) => Unit
    ): RenderingFormatter = {
    ...
    extension [Self <: RenderingFormatter](x: Self) {
      ...
      inline def setRemoveDecorators(value: (default, typings.angularCompilerCli.renderingFormatterMod.RedundantDecoratorMap) => Unit): Self = StObject.set(x, "removeDecorators", js.Any.fromFunction2(value))
    }
  }
}
