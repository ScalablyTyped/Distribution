...
*/
trait TypeValueReferenceKind extends StObject
object TypeValueReferenceKind {
  
  inline def IMPORTED: `1` = 1.asInstanceOf[`1`]
  
  inline def LOCAL: `0` = 0.asInstanceOf[`0`]
  
  inline def UNAVAILABLE: `2` = 2.asInstanceOf[`2`]
}
