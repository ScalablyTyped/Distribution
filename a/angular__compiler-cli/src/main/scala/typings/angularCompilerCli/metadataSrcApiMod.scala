...
import typings.angularCompilerCli.metadataSrcApiMod.MetaKind.Directive
import typings.angularCompilerCli.metadataSrcApiMod.MetaKind.NgModule
import typings.angularCompilerCli.metadataSrcApiMod.MetaKind.Pipe
