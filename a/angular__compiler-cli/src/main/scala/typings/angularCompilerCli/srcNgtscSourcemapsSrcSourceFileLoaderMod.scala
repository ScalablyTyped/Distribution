...
import typings.angularCompilerCli.srcNgtscSourcemapsSrcRawSourceMapMod.MapAndPath
import typings.angularCompilerCli.srcNgtscSourcemapsSrcSourceFileMod.SourceFile
