...
import typings.angularCompilerCli.ngccSrcPackagesSourceFileCacheMod.EntryPointFileCache
import typings.angularCompilerCli.srcNgtscFileSystemMod.NgtscCompilerHost
