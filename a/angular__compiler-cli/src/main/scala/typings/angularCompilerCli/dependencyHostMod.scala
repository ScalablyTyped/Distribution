...
object dependencyHostMod {
  
  @JSImport("@angular/compiler-cli/ngcc/src/dependencies/dependency_host", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular/compiler-cli/ngcc/src/dependencies/dependency_host", "DependencyHostBase")
  @js.native
  abstract class DependencyHostBase protected ()
    extends StObject
       with DependencyHost {
