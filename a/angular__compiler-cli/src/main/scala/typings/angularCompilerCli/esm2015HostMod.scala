...
object esm2015HostMod {
  ...
  open class Esm2015ReflectionHost protected ()
    ...
    /* protected */ def getDeclarationOfExpression(expression: Expression): typings.angularCompilerCli.srcHostMod.Declaration[Declaration] | Null = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getDeclarationOfIdentifier(id: Identifier): typings.angularCompilerCli.srcHostMod.Declaration[Declaration] | Null = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getExportsOfModule(module: Node): (Map[java.lang.String, typings.angularCompilerCli.srcHostMod.Declaration[Declaration]]) | Null = js.native
    ...
    /* protected */ def isJavaScriptObjectDeclaration(decl: typings.angularCompilerCli.srcHostMod.Declaration[Declaration]): Boolean = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.esm2015HostMod.ParameterTypes
    - typings.angularCompilerCli.esm2015HostMod.ParameterDecorators
    - typings.angularCompilerCli.esm2015HostMod.DecoratorCall
  */
  trait DecorateHelperEntry extends StObject
  object DecorateHelperEntry {
    
    inline def DecoratorCall(decorator: Decorator): typings.angularCompilerCli.esm2015HostMod.DecoratorCall = {
      val __obj = js.Dynamic.literal(decorator = decorator.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("decorator")
      __obj.asInstanceOf[typings.angularCompilerCli.esm2015HostMod.DecoratorCall]
    }
    
    inline def ParameterDecorators(decorator: Decorator, index: Double): typings.angularCompilerCli.esm2015HostMod.ParameterDecorators = {
      ...
      __obj.asInstanceOf[typings.angularCompilerCli.esm2015HostMod.ParameterDecorators]
    }
    
    inline def ParameterTypes(types: js.Array[Expression]): typings.angularCompilerCli.esm2015HostMod.ParameterTypes = {
      val __obj = js.Dynamic.literal(types = types.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("params")
      __obj.asInstanceOf[typings.angularCompilerCli.esm2015HostMod.ParameterTypes]
    }
  }
