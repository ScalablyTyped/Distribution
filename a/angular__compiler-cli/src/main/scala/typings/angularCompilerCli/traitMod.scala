...
import typings.angularCompilerCli.traitMod.TraitState.Analyzed
import typings.angularCompilerCli.traitMod.TraitState.Pending
import typings.angularCompilerCli.traitMod.TraitState.Resolved
import typings.angularCompilerCli.traitMod.TraitState.Skipped
...
object traitMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.traitMod.PendingTrait[D, A, S, R]
    - typings.angularCompilerCli.traitMod.SkippedTrait[D, A, S, R]
    - typings.angularCompilerCli.traitMod.AnalyzedTrait[D, A, S, R]
    - typings.angularCompilerCli.traitMod.ResolvedTrait[D, A, S, R]
  */
