...
object typeCheckBlockMod {
  ...
  object TcbGenericContextBehavior extends StObject {
    ...
    /* 1 */ val CopyClassNodes: typings.angularCompilerCli.typeCheckBlockMod.TcbGenericContextBehavior.CopyClassNodes & Double = js.native
    ...
    sealed trait FallbackToAny
      extends StObject
         with TcbGenericContextBehavior
    /* 2 */ val FallbackToAny: typings.angularCompilerCli.typeCheckBlockMod.TcbGenericContextBehavior.FallbackToAny & Double = js.native
    ...
    sealed trait UseEmitter
      extends StObject
         with TcbGenericContextBehavior
    /* 0 */ val UseEmitter: typings.angularCompilerCli.typeCheckBlockMod.TcbGenericContextBehavior.UseEmitter & Double = js.native
  }
