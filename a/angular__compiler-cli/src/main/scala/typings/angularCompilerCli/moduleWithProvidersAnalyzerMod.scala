...
object moduleWithProvidersAnalyzerMod {
  ...
  open class ModuleWithProvidersAnalyzer protected () extends StObject {
    ...
    def analyzeProgram(program: Program): typings.angularCompilerCli.moduleWithProvidersAnalyzerMod.ModuleWithProvidersAnalyses = js.native
