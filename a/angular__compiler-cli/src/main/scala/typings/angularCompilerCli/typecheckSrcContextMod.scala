...
import typings.angularCompilerCli.apiApiMod.TypeCtorMetadata
...
import typings.angularCompilerCli.sourceMod.TemplateSourceManager
import typings.angularCompilerCli.srcHostMod.ReflectionHost
import typings.angularCompilerCli.srcTypesMod.AbsoluteFsPath
import typings.angularCompilerCli.typeCheckFileMod.TypeCheckFile
...
object typecheckSrcContextMod {
  ...
  object InliningMode extends StObject {
    ...
    sealed trait Error
      extends StObject
         with InliningMode
    /* 1 */ val Error: typings.angularCompilerCli.typecheckSrcContextMod.InliningMode.Error & Double = js.native
    ...
    sealed trait InlineOps
      extends StObject
         with InliningMode
    /* 0 */ val InlineOps: typings.angularCompilerCli.typecheckSrcContextMod.InliningMode.InlineOps & Double = js.native
  }
