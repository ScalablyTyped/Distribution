...
object srcNgtscFileSystemMod {
  ...
  open class LogicalFileSystem protected ()
    extends typings.angularCompilerCli.srcNgtscFileSystemSrcLogicalMod.LogicalFileSystem {
  ...
  open class NgtscCompilerHost protected ()
    extends typings.angularCompilerCli.srcNgtscFileSystemSrcCompilerHostMod.NgtscCompilerHost {
  ...
  open class NodeJSFileSystem ()
    extends typings.angularCompilerCli.srcNgtscFileSystemSrcNodeJsFileSystemMod.NodeJSFileSystem
