...
import typings.angularCompilerCli.scopeSrcApiMod.ComponentScopeKind.NgModule
import typings.angularCompilerCli.scopeSrcApiMod.ComponentScopeKind.Standalone
...
object scopeSrcApiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.scopeSrcApiMod.LocalModuleScope
    - typings.angularCompilerCli.scopeSrcApiMod.StandaloneScope
  */
  ...
  object ComponentScope {
    ...
    inline def LocalModuleScope(
      ...
      __obj.asInstanceOf[typings.angularCompilerCli.scopeSrcApiMod.LocalModuleScope]
    }
    ...
    inline def StandaloneScope(
      ...
      __obj.asInstanceOf[typings.angularCompilerCli.scopeSrcApiMod.StandaloneScope]
    }
  }
