...
import typings.angularCompilerCli.srcNgtscProgramDriverSrcApiMod.FileUpdate
import typings.angularCompilerCli.srcNgtscProgramDriverSrcApiMod.ProgramDriver
import typings.angularCompilerCli.srcNgtscProgramDriverSrcApiMod.UpdateMode
