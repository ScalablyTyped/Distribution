...
object srcNgtscIncrementalSemanticGraphMod {
  ...
  open class SemanticDepGraph ()
    extends typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcGraphMod.SemanticDepGraph
  ...
  open class SemanticDepGraphUpdater ()
    extends typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcGraphMod.SemanticDepGraphUpdater {
    def this(/**
      * The semantic dependency graph of the most recently succeeded compilation, or null if this
      * is the initial build.
      */
    priorGraph: typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcGraphMod.SemanticDepGraph) = this()
  }
  ...
  open class SemanticSymbol protected ()
    extends typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcApiMod.SemanticSymbol {
    def this(/**
  ...
  inline def isSymbolEqual(
    a: typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcApiMod.SemanticSymbol,
    b: typings.angularCompilerCli.srcNgtscIncrementalSemanticGraphSrcApiMod.SemanticSymbol
