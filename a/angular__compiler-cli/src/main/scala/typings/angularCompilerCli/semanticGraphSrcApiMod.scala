...
object semanticGraphSrcApiMod {
  
  @JSImport("@angular/compiler-cli/src/ngtsc/incremental/semantic_graph/src/api", "SemanticSymbol")
  @js.native
  abstract class SemanticSymbol protected () extends StObject {
    def this(/**
