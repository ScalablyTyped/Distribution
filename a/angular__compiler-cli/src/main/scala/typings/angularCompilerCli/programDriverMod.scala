...
object programDriverMod {
  ...
  open class TsCreateProgramDriver protected ()
    extends typings.angularCompilerCli.tsCreateProgramDriverMod.TsCreateProgramDriver {
    def this(
  ...
  object UpdateMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.angularCompilerCli.programDriverSrcApiMod.UpdateMode & Double] = js.native
    
    /* 0 */ val Complete: typings.angularCompilerCli.programDriverSrcApiMod.UpdateMode.Complete & Double = js.native
    
    /* 1 */ val Incremental: typings.angularCompilerCli.programDriverSrcApiMod.UpdateMode.Incremental & Double = js.native
  }
}
