...
import typings.angularCompilerCli.apiApiMod.NgTemplateDiagnostic
...
object extendedApiApiMod {
  
  @JSImport("@angular/compiler-cli/src/ngtsc/typecheck/extended/api/api", "TemplateCheckWithVisitor")
  @js.native
  abstract class TemplateCheckWithVisitor[Code /* <: ErrorCode */] ()
    extends StObject
