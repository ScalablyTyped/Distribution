...
object ngccOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.ngccOptionsMod.AsyncNgccOptions
    - typings.angularCompilerCli.ngccOptionsMod.SyncNgccOptions
  */
  trait NgccOptions extends StObject
  object NgccOptions {
    
    inline def AsyncNgccOptions(basePath: String): typings.angularCompilerCli.ngccOptionsMod.AsyncNgccOptions = {
      val __obj = js.Dynamic.literal(async = true, basePath = basePath.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularCompilerCli.ngccOptionsMod.AsyncNgccOptions]
    }
    
    inline def SyncNgccOptions(basePath: String): typings.angularCompilerCli.ngccOptionsMod.SyncNgccOptions = {
      val __obj = js.Dynamic.literal(basePath = basePath.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularCompilerCli.ngccOptionsMod.SyncNgccOptions]
    }
  }
