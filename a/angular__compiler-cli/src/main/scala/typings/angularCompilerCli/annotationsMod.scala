...
object annotationsMod {
  ...
  open class ComponentDecoratorHandler protected ()
    extends typings.angularCompilerCli.componentMod.ComponentDecoratorHandler {
    def this(
  ...
  open class DirectiveDecoratorHandler protected ()
    extends typings.angularCompilerCli.directiveMod.DirectiveDecoratorHandler {
    def this(
      reflector: ReflectionHost,
      evaluator: PartialEvaluator,
      metaRegistry: MetadataRegistry,
  ...
  open class InjectableDecoratorHandler protected ()
    extends typings.angularCompilerCli.injectableMod.InjectableDecoratorHandler {
    def this(
      reflector: ReflectionHost,
      isCore: Boolean,
  ...
  open class NgModuleDecoratorHandler protected ()
    extends typings.angularCompilerCli.ngModuleMod.NgModuleDecoratorHandler {
    def this(
      reflector: ReflectionHost,
      evaluator: PartialEvaluator,
      metaReader: MetadataReader,
  ...
  open class NoopReferencesRegistry ()
    extends typings.angularCompilerCli.commonMod.NoopReferencesRegistry
  
  @JSImport("@angular/compiler-cli/src/ngtsc/annotations", "PipeDecoratorHandler")
  @js.native
  open class PipeDecoratorHandler protected ()
    extends typings.angularCompilerCli.pipeMod.PipeDecoratorHandler {
    def this(
      reflector: ReflectionHost,
      evaluator: PartialEvaluator,
      metaRegistry: MetadataRegistry,
