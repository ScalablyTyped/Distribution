...
import typings.angularCompilerCli.srcUtilsMod.PartiallyOrderedList
...
object tasksApiMod {
  ...
  object DtsProcessing extends StObject {
    ...
    sealed trait No
      extends StObject
         with DtsProcessing
    /* 1 */ val No: typings.angularCompilerCli.tasksApiMod.DtsProcessing.No & Double = js.native
    ...
    sealed trait Only
      extends StObject
         with DtsProcessing
    /* 2 */ val Only: typings.angularCompilerCli.tasksApiMod.DtsProcessing.Only & Double = js.native
    ...
    sealed trait Yes
      extends StObject
         with DtsProcessing
    /* 0 */ val Yes: typings.angularCompilerCli.tasksApiMod.DtsProcessing.Yes & Double = js.native
  }
