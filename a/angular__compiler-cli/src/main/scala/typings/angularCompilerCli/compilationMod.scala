...
import typings.angularCompilerCli.declarationMod.DtsTransformRegistry
...
object compilationMod {
  ...
  open class TraitCompiler protected ()
    ...
    /* protected */ def detectTraits(
      clazz: ClassDeclaration[DeclarationNode],
      decorators: js.Array[typings.angularCompilerCli.srcHostMod.Decorator]
