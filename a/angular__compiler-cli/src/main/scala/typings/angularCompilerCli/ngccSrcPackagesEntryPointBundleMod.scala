...
import typings.angularCompilerCli.ngccSrcExecutionTasksApiMod.DtsProcessing
...
import typings.angularCompilerCli.ngccSrcPackagesSourceFileCacheMod.SharedFileCache
