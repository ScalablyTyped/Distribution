...
object tracingEntryPointFinderMod {
  
  @JSImport("@angular/compiler-cli/ngcc/src/entry_point_finder/tracing_entry_point_finder", "TracingEntryPointFinder")
  @js.native
  abstract class TracingEntryPointFinder protected ()
    extends StObject
