...
import typings.angularCompilerCli.resourcesMod.ParsedTemplateWithSource
import typings.angularCompilerCli.resourcesMod.StyleUrlMeta
...
import typings.angularCompilerCli.srcTypescriptMod.SubsetOfKeys
