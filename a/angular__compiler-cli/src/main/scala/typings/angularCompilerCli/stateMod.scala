...
import typings.angularCompilerCli.semanticGraphMod.SemanticDepGraph
...
import typings.angularCompilerCli.stateMod.IncrementalStateKind.Analyzed
import typings.angularCompilerCli.stateMod.IncrementalStateKind.Delta
import typings.angularCompilerCli.stateMod.IncrementalStateKind.Fresh
...
object stateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularCompilerCli.stateMod.AnalyzedIncrementalState
    - typings.angularCompilerCli.stateMod.DeltaIncrementalState
    - typings.angularCompilerCli.stateMod.FreshIncrementalState
  */
  ...
  object IncrementalState {
    ...
    inline def AnalyzedIncrementalState(
      ...
      val __obj = js.Dynamic.literal(depGraph = depGraph.asInstanceOf[js.Any], emitted = emitted.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], priorAnalysis = priorAnalysis.asInstanceOf[js.Any], semanticDepGraph = semanticDepGraph.asInstanceOf[js.Any], typeCheckResults = null, versions = null)
      __obj.asInstanceOf[typings.angularCompilerCli.stateMod.AnalyzedIncrementalState]
    }
    ...
    inline def DeltaIncrementalState(
      ...
      val __obj = js.Dynamic.literal(changedResourceFiles = changedResourceFiles.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], lastAnalyzedState = lastAnalyzedState.asInstanceOf[js.Any], physicallyChangedTsFiles = physicallyChangedTsFiles.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularCompilerCli.stateMod.DeltaIncrementalState]
    }
    
    inline def FreshIncrementalState(kind: Fresh): typings.angularCompilerCli.stateMod.FreshIncrementalState = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularCompilerCli.stateMod.FreshIncrementalState]
    }
  }
}
