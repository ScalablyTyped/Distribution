...
class Animator () extends js.Object {
  /**
       ...
       */
  def addClass(element: stdLib.HTMLElement, className: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  /**
       ...
       * @returns Resolved when the animation is done
       */
  def animate(element: js.Array[stdLib.HTMLElement], className: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  /**
       * Execute a single animation.
       * @param element Element to animate
       * @param className Properties to animate or name of the effect to use. For css animators this represents the className to be added and removed right after the animation is done.
       ...
       * @returns Resolved when the animation is done
       */
  def animate(element: stdLib.HTMLElement, className: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  /**
       * Execute an 'enter' animation on an element
       * @param element Element to animate
       * @returns Resolved when the animation is done
       */
  def enter(element: stdLib.HTMLElement): stdLib.Promise[scala.Boolean] = js.native
  /**
       * Execute a 'leave' animation on an element
       * @param element Element to animate
       * @returns Resolved when the animation is done
       */
  def leave(element: stdLib.HTMLElement): stdLib.Promise[scala.Boolean] = js.native
  /**
  ...
  /**
       ...
       * @returns Resolved when the animation is done
       */
  def removeClass(element: stdLib.HTMLElement, className: java.lang.String): stdLib.Promise[scala.Boolean] = js.native
  /**
       ...
       */
  def runSequence(animations: js.Array[_]): stdLib.Promise[scala.Boolean] = js.native
  /**
