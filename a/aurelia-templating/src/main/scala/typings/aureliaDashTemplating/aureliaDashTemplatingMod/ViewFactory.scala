...
class ViewFactory protected () extends js.Object {
  /**
    ...
    */
  def this(template: DocumentFragment, instructions: js.Object, resources: ViewResources) = this()
  /**
  ...
  /**
    ...
    */
  def create(container: Container): View = js.native
  def create(container: Container, createInstruction: ViewCreateInstruction): View = js.native
  def create(container: Container, createInstruction: ViewCreateInstruction, element: Element): View = js.native
  /**
