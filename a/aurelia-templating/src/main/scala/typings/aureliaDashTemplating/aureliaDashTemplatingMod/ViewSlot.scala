...
class ViewSlot protected () extends js.Object {
  ...
  /**
    ...
    */
  def add(view: View): Unit | js.Promise[_] = js.native
  /**
    ...
    */
  def animateView(view: View): Unit | js.Promise[_] = js.native
  def animateView(view: View, direction: String): Unit | js.Promise[_] = js.native
  /**
  ...
  /**
    ...
    */
  def insert(index: Double, view: View): Unit | js.Promise[_] = js.native
  /**
  ...
  def remove(view: View, returnToCache: Boolean): View | js.Promise[View] = js.native
  def remove(view: View, returnToCache: Boolean, skipAnimation: Boolean): View | js.Promise[View] = js.native
  /**
  ...
  /**
    ...
    * @return May return a promise if the view removal triggered an animation.
    */
  def removeAt(index: Double): View | js.Promise[View] = js.native
  def removeAt(index: Double, returnToCache: Boolean): View | js.Promise[View] = js.native
  def removeAt(index: Double, returnToCache: Boolean, skipAnimation: Boolean): View | js.Promise[View] = js.native
  /**
    ...
    * @return May return a promise if the view removal triggered an animation.
    */
  def removeMany(viewsToRemove: js.Array[View]): Unit | js.Promise[Unit] = js.native
  def removeMany(viewsToRemove: js.Array[View], returnToCache: Boolean): Unit | js.Promise[Unit] = js.native
  def removeMany(viewsToRemove: js.Array[View], returnToCache: Boolean, skipAnimation: Boolean): Unit | js.Promise[Unit] = js.native
  /**
