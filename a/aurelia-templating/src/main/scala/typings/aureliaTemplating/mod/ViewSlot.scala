...
class ViewSlot protected () extends StObject {
  ...
  /**
    ...
    */
  def add(view: View_): Unit | js.Promise[js.Any] = js.native
  ...
  /**
    ...
    */
  def animateView(view: View_): Unit | js.Promise[js.Any] = js.native
  def animateView(view: View_, direction: String): Unit | js.Promise[js.Any] = js.native
  ...
  /**
    ...
    */
  def insert(index: Double, view: View_): Unit | js.Promise[js.Any] = js.native
  ...
  def move(sourceIndex: Unit, targetIndex: js.Any): js.Any = js.native
  ...
  /**
    ...
    */
  def removeAll(): Unit | js.Promise[js.Any] = js.native
  def removeAll(returnToCache: Boolean): Unit | js.Promise[js.Any] = js.native
  def removeAll(returnToCache: Boolean, skipAnimation: Boolean): Unit | js.Promise[js.Any] = js.native
  def removeAll(returnToCache: Unit, skipAnimation: Boolean): Unit | js.Promise[js.Any] = js.native
