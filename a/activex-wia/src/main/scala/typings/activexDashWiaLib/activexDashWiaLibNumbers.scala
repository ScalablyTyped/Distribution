...
object activexDashWiaLibNumbers {
  @js.native
  ...
  sealed trait `0`
    extends activexDashWiaLib.WIANs.WiaDeviceType
       with activexDashWiaLib.WIANs.WiaImageIntent
       with activexDashWiaLib.WIANs.WiaItemFlag
       with activexDashWiaLib.WIANs.WiaPropertyType
       with activexDashWiaLib.WIANs.WiaSubType
  
  @js.native
  sealed trait `1`
    extends activexDashWiaLib.WIANs.WiaDeviceType
       with activexDashWiaLib.WIANs.WiaEventFlag
       with activexDashWiaLib.WIANs.WiaImageIntent
       with activexDashWiaLib.WIANs.WiaItemFlag
       with activexDashWiaLib.WIANs.WiaPropertyType
       with activexDashWiaLib.WIANs.WiaSubType
  ...
  @js.native
  sealed trait `1000`
    extends activexDashWiaLib.WIANs.WiaImagePropertyType
