...
trait Vector[TItem] extends js.Object {
  ...
  /**
    ...
    */
  def ImageFile(): typings.activexDashWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double): typings.activexDashWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double, Height: Double): typings.activexDashWia.WIA.ImageFile = js.native
  /** Returns the specified item in the vector by position */
