...
trait Vector[TItem] extends js.Object {
  ...
  /**
    ...
    */
  def ImageFile(): typings.activexDashWia.WIANs.ImageFile = js.native
  def ImageFile(Width: Double): typings.activexDashWia.WIANs.ImageFile = js.native
  def ImageFile(Width: Double, Height: Double): typings.activexDashWia.WIANs.ImageFile = js.native
  /** Returns the specified item in the vector by position */
