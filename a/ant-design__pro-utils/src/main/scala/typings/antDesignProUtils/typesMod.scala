...
import typings.antDesignProUtils.anon.Locale
...
import typings.antd.datePickerMod.DatePickerProps
import typings.antd.datePickerMod.RangePickerProps
...
import typings.antd.segmentedMod.SegmentedProps
...
import typings.antd.timePickerMod.TimeRangePickerProps
...
object typesMod {
  ...
  type ProFieldValueObject[Type] = Locale[Type]
  ...
  trait ProFieldValueTypeWithFieldProps extends StObject {
    ...
    var treeSelect: TreeSelectProps[Any, typings.rcTreeSelect.treeSelectMod.DefaultOptionType]
  }
  object ProFieldValueTypeWithFieldProps {
    ...
    inline def apply(
      ...
      treeSelect: TreeSelectProps[Any, typings.rcTreeSelect.treeSelectMod.DefaultOptionType]
    ...
    extension [Self <: ProFieldValueTypeWithFieldProps](x: Self) {
      ...
      inline def setTreeSelect(value: TreeSelectProps[Any, typings.rcTreeSelect.treeSelectMod.DefaultOptionType]): Self = StObject.set(x, "treeSelect", value.asInstanceOf[js.Any])
    }
  }
