...
trait BlockUIService extends js.Object {
  ...
  /**
    ...
    */
  def done(doneCallback: js.Function0[scala.Unit]): scala.Unit = js.native
  /**
    * Returns whether currently a block is shown for the instance or not.
    */
  def isBlocking(): scala.Boolean = js.native
  /**
    ...
    */
  def message(message: java.lang.String): scala.Unit = js.native
  /**
  ...
  def start(messageOrOptions: BlockUIConfig): scala.Unit = js.native
  def start(messageOrOptions: java.lang.String): scala.Unit = js.native
  /**
