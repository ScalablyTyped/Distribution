package typings
package appendDashQueryLib.appendDashQueryMod
...
trait Options extends js.Object {
  /**
    ...
    * Default: `true`.
    */
  var encodeComponents: js.UndefOr[scala.Boolean] = js.undefined
  /**
    ...
    */
  var removeNull: js.UndefOr[scala.Boolean] = js.undefined
}

object Options {
  @scala.inline
  def apply(
    encodeComponents: js.UndefOr[scala.Boolean] = js.undefined,
    removeNull: js.UndefOr[scala.Boolean] = js.undefined
  ): Options = {
