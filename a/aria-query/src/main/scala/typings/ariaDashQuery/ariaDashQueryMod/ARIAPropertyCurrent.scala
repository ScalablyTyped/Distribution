...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.ariaDashQuery.ariaDashQueryStrings.date
  - typings.ariaDashQuery.ariaDashQueryStrings.time
  - typings.ariaDashQuery.ariaDashQueryStrings.`true`
  - typings.ariaDashQuery.ariaDashQueryStrings.`false`
*/
...
object ARIAPropertyCurrent {
  ...
  @scala.inline
  def page: typings.ariaDashQuery.ariaDashQueryStrings.page = this.cast("page")
  @scala.inline
  def step: typings.ariaDashQuery.ariaDashQueryStrings.step = this.cast("step")
  @scala.inline
