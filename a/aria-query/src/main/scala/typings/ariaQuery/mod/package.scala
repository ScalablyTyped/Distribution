...
package object mod {
  ...
  */
  ...
  ] = typings.ariaQuery.mod.^.asInstanceOf[js.Dynamic].selectDynamic("elementRoles").asInstanceOf[typings.std.Map[
    typings.ariaQuery.mod.ARIARoleRelationConcept, 
    typings.std.Set[typings.ariaQuery.mod.ARIARoleDefintionKey]
  ]]
  ...
  ] = typings.ariaQuery.mod.^.asInstanceOf[js.Dynamic].selectDynamic("roleElements").asInstanceOf[typings.std.Map[
    typings.ariaQuery.mod.ARIARoleDefintionKey, 
    typings.std.Set[typings.ariaQuery.mod.ARIARoleRelationConcept]
  ]]
  ...
  ] = typings.ariaQuery.mod.^.asInstanceOf[js.Dynamic].selectDynamic("roles").asInstanceOf[typings.std.Map[
    typings.ariaQuery.mod.ARIARoleDefintionKey, 
    typings.ariaQuery.mod.ARIARoleDefinition
  ]]
}
