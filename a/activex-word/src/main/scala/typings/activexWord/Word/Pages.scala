...
object Pages {
  ...
  implicit class PagesOps[Self <: Pages] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => Page): Self = this.set("Item", js.Any.fromFunction1(value))
    
    @scala.inline
    def setParent(value: js.Any): Self = this.set("Parent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordDotPages_typekey(value: Pages): Self = this.set("Word.Pages_typekey", value.asInstanceOf[js.Any])
  }
}
