...
*/
trait WdShowFilter extends StObject
object WdShowFilter {
  
  inline def wdShowFilterFormattingAvailable: `4` = 4.asInstanceOf[`4`]
  
  inline def wdShowFilterFormattingInUse: `3` = 3.asInstanceOf[`3`]
  
  inline def wdShowFilterFormattingRecommended: `5` = 5.asInstanceOf[`5`]
  
  inline def wdShowFilterStylesAll: `2` = 2.asInstanceOf[`2`]
  
  inline def wdShowFilterStylesAvailable: `0` = 0.asInstanceOf[`0`]
  
  inline def wdShowFilterStylesInUse: `1` = 1.asInstanceOf[`1`]
}
