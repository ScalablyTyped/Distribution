...
object WdRulerStyle {
  ...
  inline def wdAdjustFirstColumn: `2` = 2.asInstanceOf[`2`]
  
  inline def wdAdjustNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdAdjustProportional: `1` = 1.asInstanceOf[`1`]
  
  inline def wdAdjustSameWidth: `3` = 3.asInstanceOf[`3`]
}
