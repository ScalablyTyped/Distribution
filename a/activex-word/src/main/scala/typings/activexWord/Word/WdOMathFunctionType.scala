...
object WdOMathFunctionType {
  ...
  inline def wdOMathFunctionAcc: `1` = 1.asInstanceOf[`1`]
  
  inline def wdOMathFunctionBar: `2` = 2.asInstanceOf[`2`]
  
  inline def wdOMathFunctionBorderBox: `4` = 4.asInstanceOf[`4`]
  
  inline def wdOMathFunctionBox: `3` = 3.asInstanceOf[`3`]
  
  inline def wdOMathFunctionDelim: `5` = 5.asInstanceOf[`5`]
  
  inline def wdOMathFunctionEqArray: `6` = 6.asInstanceOf[`6`]
  
  inline def wdOMathFunctionFrac: `7` = 7.asInstanceOf[`7`]
  
  inline def wdOMathFunctionFunc: `8` = 8.asInstanceOf[`8`]
  
  inline def wdOMathFunctionGroupChar: `9` = 9.asInstanceOf[`9`]
  
  inline def wdOMathFunctionLimLow: `10` = 10.asInstanceOf[`10`]
  
  inline def wdOMathFunctionLimUpp: `11` = 11.asInstanceOf[`11`]
  
  inline def wdOMathFunctionLiteralText: `22` = 22.asInstanceOf[`22`]
  
  inline def wdOMathFunctionMat: `12` = 12.asInstanceOf[`12`]
  
  inline def wdOMathFunctionNary: `13` = 13.asInstanceOf[`13`]
  
  inline def wdOMathFunctionNormalText: `21` = 21.asInstanceOf[`21`]
  
  inline def wdOMathFunctionPhantom: `14` = 14.asInstanceOf[`14`]
  
  inline def wdOMathFunctionRad: `16` = 16.asInstanceOf[`16`]
  
  inline def wdOMathFunctionScrPre: `15` = 15.asInstanceOf[`15`]
  
  inline def wdOMathFunctionScrSub: `17` = 17.asInstanceOf[`17`]
  
  inline def wdOMathFunctionScrSubSup: `18` = 18.asInstanceOf[`18`]
  
  inline def wdOMathFunctionScrSup: `19` = 19.asInstanceOf[`19`]
  
  inline def wdOMathFunctionText: `20` = 20.asInstanceOf[`20`]
}
