...
*/
trait WdFieldShading extends StObject
object WdFieldShading {
  
  inline def wdFieldShadingAlways: `1` = 1.asInstanceOf[`1`]
  
  inline def wdFieldShadingNever: `0` = 0.asInstanceOf[`0`]
  
  inline def wdFieldShadingWhenSelected: `2` = 2.asInstanceOf[`2`]
}
