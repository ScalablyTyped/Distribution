...
*/
trait WdOMathBreakSub extends StObject
object WdOMathBreakSub {
  
  inline def wdOMathBreakSubMinusMinus: `0` = 0.asInstanceOf[`0`]
  
  inline def wdOMathBreakSubMinusPlus: `2` = 2.asInstanceOf[`2`]
  
  inline def wdOMathBreakSubPlusMinus: `1` = 1.asInstanceOf[`1`]
}
