...
*/
trait WdAlignmentTabAlignment extends StObject
object WdAlignmentTabAlignment {
  
  inline def wdCenter: `1` = 1.asInstanceOf[`1`]
  
  inline def wdLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def wdRight: `2` = 2.asInstanceOf[`2`]
}
