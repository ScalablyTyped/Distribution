...
import typings.activexWord.activexWordNumbers.`-4127`
import typings.activexWord.activexWordNumbers.`-4134`
...
/* Rewritten from type alias, can be one of: 
  - typings.activexWord.activexWordNumbers.`-4127`
  - typings.activexWord.activexWordNumbers.`-4134`
