...
object WdJustificationMode {
  ...
  inline def wdJustificationModeCompress: `1` = 1.asInstanceOf[`1`]
  
  inline def wdJustificationModeCompressKana: `2` = 2.asInstanceOf[`2`]
  
  inline def wdJustificationModeExpand: `0` = 0.asInstanceOf[`0`]
}
