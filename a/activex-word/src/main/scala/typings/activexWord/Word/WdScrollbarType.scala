...
*/
trait WdScrollbarType extends js.Object
object WdScrollbarType {
  
  @scala.inline
  def wdScrollbarTypeAuto: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def wdScrollbarTypeNo: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def wdScrollbarTypeYes: `1` = 1.asInstanceOf[`1`]
}
