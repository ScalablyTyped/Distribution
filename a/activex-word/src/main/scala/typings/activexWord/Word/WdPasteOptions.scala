...
object WdPasteOptions {
  ...
  inline def wdKeepSourceFormatting: `0` = 0.asInstanceOf[`0`]
  
  inline def wdKeepTextOnly: `2` = 2.asInstanceOf[`2`]
  
  inline def wdMatchDestinationFormatting: `1` = 1.asInstanceOf[`1`]
  
  inline def wdUseDestinationStyles: `3` = 3.asInstanceOf[`3`]
}
