...
object WdHeadingSeparator {
  @scala.inline
  def wdHeadingSeparatorBlankLine: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def wdHeadingSeparatorLetter: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def wdHeadingSeparatorLetterFull: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def wdHeadingSeparatorLetterLow: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def wdHeadingSeparatorNone: `0` = 0.asInstanceOf[`0`]
}
