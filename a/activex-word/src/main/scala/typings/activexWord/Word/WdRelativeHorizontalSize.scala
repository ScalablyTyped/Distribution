...
*/
trait WdRelativeHorizontalSize extends js.Object

object WdRelativeHorizontalSize {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def wdRelativeHorizontalSizeInnerMarginArea: `4` = this.cast(4)
  @scala.inline
  def wdRelativeHorizontalSizeLeftMarginArea: `2` = this.cast(2)
  @scala.inline
  def wdRelativeHorizontalSizeMargin: `0` = this.cast(0)
  @scala.inline
  def wdRelativeHorizontalSizeOuterMarginArea: `5` = this.cast(5)
  @scala.inline
  def wdRelativeHorizontalSizePage: `1` = this.cast(1)
  @scala.inline
  def wdRelativeHorizontalSizeRightMarginArea: `3` = this.cast(3)
}
