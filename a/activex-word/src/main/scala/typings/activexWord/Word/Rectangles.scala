...
object Rectangles {
  ...
  @scala.inline
  implicit class RectanglesOps[Self <: Rectangles] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => Rectangle): Self = this.set("Item", js.Any.fromFunction1(value))
    
    @scala.inline
    def setParent(value: js.Any): Self = this.set("Parent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordDotRectangles_typekey(value: Rectangles): Self = this.set("Word.Rectangles_typekey", value.asInstanceOf[js.Any])
  }
}
