...
object WdSeparatorType {
  ...
  @scala.inline
  def wdSeparatorColon: `2` = this.cast(2)
  @scala.inline
  def wdSeparatorEmDash: `3` = this.cast(3)
  @scala.inline
  def wdSeparatorEnDash: `4` = this.cast(4)
  @scala.inline
  def wdSeparatorHyphen: `0` = this.cast(0)
  @scala.inline
  def wdSeparatorPeriod: `1` = this.cast(1)
}
