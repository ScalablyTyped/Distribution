...
object WdFindMatch {
  ...
  inline def wdMatchAnyCharacter: `65599` = 65599.asInstanceOf[`65599`]
  
  inline def wdMatchAnyDigit: `65567` = 65567.asInstanceOf[`65567`]
  
  inline def wdMatchAnyLetter: `65583` = 65583.asInstanceOf[`65583`]
  
  inline def wdMatchCaretCharacter: `11` = 11.asInstanceOf[`11`]
  
  inline def wdMatchColumnBreak: `14` = 14.asInstanceOf[`14`]
  
  inline def wdMatchCommentMark: `5` = 5.asInstanceOf[`5`]
  
  inline def wdMatchEmDash: `8212` = 8212.asInstanceOf[`8212`]
  
  inline def wdMatchEnDash: `8211` = 8211.asInstanceOf[`8211`]
  
  inline def wdMatchEndnoteMark: `65555` = 65555.asInstanceOf[`65555`]
  
  inline def wdMatchField: `19` = 19.asInstanceOf[`19`]
  
  inline def wdMatchFootnoteMark: `65554` = 65554.asInstanceOf[`65554`]
  
  inline def wdMatchGraphic: `1` = 1.asInstanceOf[`1`]
  
  inline def wdMatchManualLineBreak: `65551` = 65551.asInstanceOf[`65551`]
  
  inline def wdMatchManualPageBreak: `65564` = 65564.asInstanceOf[`65564`]
  
  inline def wdMatchNonbreakingHyphen: `30` = 30.asInstanceOf[`30`]
  
  inline def wdMatchNonbreakingSpace: `160` = 160.asInstanceOf[`160`]
  
  inline def wdMatchOptionalHyphen: `31` = 31.asInstanceOf[`31`]
  
  inline def wdMatchParagraphMark: `65551` = 65551.asInstanceOf[`65551`]
  
  inline def wdMatchSectionBreak: `65580` = 65580.asInstanceOf[`65580`]
  
  inline def wdMatchTabCharacter: `9` = 9.asInstanceOf[`9`]
  
  inline def wdMatchWhiteSpace: `65655` = 65655.asInstanceOf[`65655`]
}
