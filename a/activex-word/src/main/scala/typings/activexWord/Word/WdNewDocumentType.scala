...
*/
trait WdNewDocumentType extends StObject
object WdNewDocumentType {
  
  inline def wdNewBlankDocument: `0` = 0.asInstanceOf[`0`]
  
  inline def wdNewEmailMessage: `2` = 2.asInstanceOf[`2`]
  
  inline def wdNewFrameset: `3` = 3.asInstanceOf[`3`]
  
  inline def wdNewWebPage: `1` = 1.asInstanceOf[`1`]
  
  inline def wdNewXMLDocument: `4` = 4.asInstanceOf[`4`]
}
