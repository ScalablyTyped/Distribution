...
object WdNewDocumentType {
  ...
  @scala.inline
  def wdNewBlankDocument: `0` = this.cast(0)
  @scala.inline
  def wdNewEmailMessage: `2` = this.cast(2)
  @scala.inline
  def wdNewFrameset: `3` = this.cast(3)
  @scala.inline
  def wdNewWebPage: `1` = this.cast(1)
  @scala.inline
  def wdNewXMLDocument: `4` = this.cast(4)
}
