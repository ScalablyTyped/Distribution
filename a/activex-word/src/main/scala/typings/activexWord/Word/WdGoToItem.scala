...
*/
trait WdGoToItem extends StObject
object WdGoToItem {
  
  inline def wdGoToBookmark: `-1` = -1.asInstanceOf[`-1`]
  
  inline def wdGoToComment: `6` = 6.asInstanceOf[`6`]
  
  inline def wdGoToEndnote: `5` = 5.asInstanceOf[`5`]
  
  inline def wdGoToEquation: `10` = 10.asInstanceOf[`10`]
  
  inline def wdGoToField: `7` = 7.asInstanceOf[`7`]
  
  inline def wdGoToFootnote: `4` = 4.asInstanceOf[`4`]
  
  inline def wdGoToGrammaticalError: `14` = 14.asInstanceOf[`14`]
  
  inline def wdGoToGraphic: `8` = 8.asInstanceOf[`8`]
  
  inline def wdGoToHeading: `11` = 11.asInstanceOf[`11`]
  
  inline def wdGoToLine: `3` = 3.asInstanceOf[`3`]
  
  inline def wdGoToObject: `9` = 9.asInstanceOf[`9`]
  
  inline def wdGoToPage: `1` = 1.asInstanceOf[`1`]
  
  inline def wdGoToPercent: `12` = 12.asInstanceOf[`12`]
  
  inline def wdGoToProofreadingError: `15` = 15.asInstanceOf[`15`]
  
  inline def wdGoToSection: `0` = 0.asInstanceOf[`0`]
  
  inline def wdGoToSpellingError: `13` = 13.asInstanceOf[`13`]
  
  inline def wdGoToTable: `2` = 2.asInstanceOf[`2`]
}
