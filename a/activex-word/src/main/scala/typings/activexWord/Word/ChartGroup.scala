...
trait ChartGroup extends js.Object {
  ...
  val DownBars: typings.activexWord.Word.DownBars = js.native
  val DropLines: typings.activexWord.Word.DropLines = js.native
  ...
  val HiLoLines: typings.activexWord.Word.HiLoLines = js.native
  ...
  val UpBars: typings.activexWord.Word.UpBars = js.native
