...
object WdOMathBreakBin {
  ...
  inline def wdOMathBreakBinAfter: `1` = 1.asInstanceOf[`1`]
  
  inline def wdOMathBreakBinBefore: `0` = 0.asInstanceOf[`0`]
  
  inline def wdOMathBreakBinRepeat: `2` = 2.asInstanceOf[`2`]
}
