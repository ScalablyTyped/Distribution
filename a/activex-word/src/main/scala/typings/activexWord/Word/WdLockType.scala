...
object WdLockType {
  ...
  inline def wdLockChanged: `3` = 3.asInstanceOf[`3`]
  
  inline def wdLockEphemeral: `2` = 2.asInstanceOf[`2`]
  
  inline def wdLockNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdLockReservation: `1` = 1.asInstanceOf[`1`]
}
