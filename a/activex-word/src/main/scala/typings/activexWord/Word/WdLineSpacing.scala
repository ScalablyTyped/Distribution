...
*/
trait WdLineSpacing extends StObject
object WdLineSpacing {
  
  inline def wdLineSpace1pt5: `1` = 1.asInstanceOf[`1`]
  
  inline def wdLineSpaceAtLeast: `3` = 3.asInstanceOf[`3`]
  
  inline def wdLineSpaceDouble: `2` = 2.asInstanceOf[`2`]
  
  inline def wdLineSpaceExactly: `4` = 4.asInstanceOf[`4`]
  
  inline def wdLineSpaceMultiple: `5` = 5.asInstanceOf[`5`]
  
  inline def wdLineSpaceSingle: `0` = 0.asInstanceOf[`0`]
}
