...
*/
trait WdIMEMode extends StObject
object WdIMEMode {
  
  inline def wdIMEModeAlpha: `8` = 8.asInstanceOf[`8`]
  
  inline def wdIMEModeAlphaFull: `7` = 7.asInstanceOf[`7`]
  
  inline def wdIMEModeHangul: `10` = 10.asInstanceOf[`10`]
  
  inline def wdIMEModeHangulFull: `9` = 9.asInstanceOf[`9`]
  
  inline def wdIMEModeHiragana: `4` = 4.asInstanceOf[`4`]
  
  inline def wdIMEModeKatakana: `5` = 5.asInstanceOf[`5`]
  
  inline def wdIMEModeKatakanaHalf: `6` = 6.asInstanceOf[`6`]
  
  inline def wdIMEModeNoControl: `0` = 0.asInstanceOf[`0`]
  
  inline def wdIMEModeOff: `2` = 2.asInstanceOf[`2`]
  
  inline def wdIMEModeOn: `1` = 1.asInstanceOf[`1`]
}
