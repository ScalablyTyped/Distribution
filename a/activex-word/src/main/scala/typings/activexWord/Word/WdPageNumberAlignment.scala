...
*/
trait WdPageNumberAlignment extends StObject
object WdPageNumberAlignment {
  
  inline def wdAlignPageNumberCenter: `1` = 1.asInstanceOf[`1`]
  
  inline def wdAlignPageNumberInside: `3` = 3.asInstanceOf[`3`]
  
  inline def wdAlignPageNumberLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def wdAlignPageNumberOutside: `4` = 4.asInstanceOf[`4`]
  
  inline def wdAlignPageNumberRight: `2` = 2.asInstanceOf[`2`]
}
