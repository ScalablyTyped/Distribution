...
*/
trait WdSalutationType extends js.Object
object WdSalutationType {
  
  @scala.inline
  def wdSalutationBusiness: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def wdSalutationFormal: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def wdSalutationInformal: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def wdSalutationOther: `3` = 3.asInstanceOf[`3`]
}
