...
*/
trait WdSalutationType extends StObject
object WdSalutationType {
  
  inline def wdSalutationBusiness: `2` = 2.asInstanceOf[`2`]
  
  inline def wdSalutationFormal: `1` = 1.asInstanceOf[`1`]
  
  inline def wdSalutationInformal: `0` = 0.asInstanceOf[`0`]
  
  inline def wdSalutationOther: `3` = 3.asInstanceOf[`3`]
}
