...
object WdTabLeader {
  ...
  inline def wdTabLeaderDashes: `2` = 2.asInstanceOf[`2`]
  
  inline def wdTabLeaderDots: `1` = 1.asInstanceOf[`1`]
  
  inline def wdTabLeaderHeavy: `4` = 4.asInstanceOf[`4`]
  
  inline def wdTabLeaderLines: `3` = 3.asInstanceOf[`3`]
  
  inline def wdTabLeaderMiddleDot: `5` = 5.asInstanceOf[`5`]
  
  inline def wdTabLeaderSpaces: `0` = 0.asInstanceOf[`0`]
}
