...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexWord.activexWordNumbers.`1`
*/
trait WdCharacterCase extends StObject
object WdCharacterCase {
  
  inline def wdFullWidth: `7` = 7.asInstanceOf[`7`]
  
  inline def wdHalfWidth: `6` = 6.asInstanceOf[`6`]
  
  inline def wdHiragana: `9` = 9.asInstanceOf[`9`]
  
  inline def wdKatakana: `8` = 8.asInstanceOf[`8`]
  
  inline def wdLowerCase: `0` = 0.asInstanceOf[`0`]
  
  inline def wdNextCase: `-1` = -1.asInstanceOf[`-1`]
  
  inline def wdTitleSentence: `4` = 4.asInstanceOf[`4`]
  
  inline def wdTitleWord: `2` = 2.asInstanceOf[`2`]
  
  inline def wdToggleCase: `5` = 5.asInstanceOf[`5`]
  
  inline def wdUpperCase: `1` = 1.asInstanceOf[`1`]
}
