...
object WdXMLNodeLevel {
  ...
  inline def wdXMLNodeLevelCell: `3` = 3.asInstanceOf[`3`]
  
  inline def wdXMLNodeLevelInline: `0` = 0.asInstanceOf[`0`]
  
  inline def wdXMLNodeLevelParagraph: `1` = 1.asInstanceOf[`1`]
  
  inline def wdXMLNodeLevelRow: `2` = 2.asInstanceOf[`2`]
}
