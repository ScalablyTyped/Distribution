...
trait List extends StObject {
  ...
  def ApplyListTemplate(ListTemplate: ListTemplate, ContinuePreviousList: Unit, DefaultListBehavior: js.Any): Unit = js.native
  ...
  def ApplyListTemplateWithLevel(
    ListTemplate: ListTemplate,
    ContinuePreviousList: js.Any,
    DefaultListBehavior: Unit,
    ApplyLevel: js.Any
  ): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: ListTemplate, ContinuePreviousList: Unit, DefaultListBehavior: js.Any): Unit = js.native
  def ApplyListTemplateWithLevel(
    ListTemplate: ListTemplate,
    ContinuePreviousList: Unit,
    DefaultListBehavior: js.Any,
    ApplyLevel: js.Any
  ): Unit = js.native
  def ApplyListTemplateWithLevel(
