...
*/
trait WdInsertCells extends StObject
object WdInsertCells {
  
  inline def wdInsertCellsEntireColumn: `3` = 3.asInstanceOf[`3`]
  
  inline def wdInsertCellsEntireRow: `2` = 2.asInstanceOf[`2`]
  
  inline def wdInsertCellsShiftDown: `1` = 1.asInstanceOf[`1`]
  
  inline def wdInsertCellsShiftRight: `0` = 0.asInstanceOf[`0`]
}
