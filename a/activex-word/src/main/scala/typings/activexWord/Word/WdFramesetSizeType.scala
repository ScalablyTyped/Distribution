...
*/
trait WdFramesetSizeType extends StObject
object WdFramesetSizeType {
  
  inline def wdFramesetSizeTypeFixed: `1` = 1.asInstanceOf[`1`]
  
  inline def wdFramesetSizeTypePercent: `0` = 0.asInstanceOf[`0`]
  
  inline def wdFramesetSizeTypeRelative: `2` = 2.asInstanceOf[`2`]
}
