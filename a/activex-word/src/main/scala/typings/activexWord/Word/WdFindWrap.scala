...
*/
trait WdFindWrap extends StObject
object WdFindWrap {
  
  inline def wdFindAsk: `2` = 2.asInstanceOf[`2`]
  
  inline def wdFindContinue: `1` = 1.asInstanceOf[`1`]
  
  inline def wdFindStop: `0` = 0.asInstanceOf[`0`]
}
