...
*/
trait WdStoryType extends StObject
object WdStoryType {
  
  inline def wdCommentsStory: `4` = 4.asInstanceOf[`4`]
  
  inline def wdEndnoteContinuationNoticeStory: `17` = 17.asInstanceOf[`17`]
  
  inline def wdEndnoteContinuationSeparatorStory: `16` = 16.asInstanceOf[`16`]
  
  inline def wdEndnoteSeparatorStory: `15` = 15.asInstanceOf[`15`]
  
  inline def wdEndnotesStory: `3` = 3.asInstanceOf[`3`]
  
  inline def wdEvenPagesFooterStory: `8` = 8.asInstanceOf[`8`]
  
  inline def wdEvenPagesHeaderStory: `6` = 6.asInstanceOf[`6`]
  
  inline def wdFirstPageFooterStory: `11` = 11.asInstanceOf[`11`]
  
  inline def wdFirstPageHeaderStory: `10` = 10.asInstanceOf[`10`]
  
  inline def wdFootnoteContinuationNoticeStory: `14` = 14.asInstanceOf[`14`]
  
  inline def wdFootnoteContinuationSeparatorStory: `13` = 13.asInstanceOf[`13`]
  
  inline def wdFootnoteSeparatorStory: `12` = 12.asInstanceOf[`12`]
  
  inline def wdFootnotesStory: `2` = 2.asInstanceOf[`2`]
  
  inline def wdMainTextStory: `1` = 1.asInstanceOf[`1`]
  
  inline def wdPrimaryFooterStory: `9` = 9.asInstanceOf[`9`]
  
  inline def wdPrimaryHeaderStory: `7` = 7.asInstanceOf[`7`]
  
  inline def wdTextFrameStory: `5` = 5.asInstanceOf[`5`]
}
