...
*/
trait WdRelativeHorizontalPosition extends StObject
object WdRelativeHorizontalPosition {
  
  inline def wdRelativeHorizontalPositionCharacter: `3` = 3.asInstanceOf[`3`]
  
  inline def wdRelativeHorizontalPositionColumn: `2` = 2.asInstanceOf[`2`]
  
  inline def wdRelativeHorizontalPositionInnerMarginArea: `6` = 6.asInstanceOf[`6`]
  
  inline def wdRelativeHorizontalPositionLeftMarginArea: `4` = 4.asInstanceOf[`4`]
  
  inline def wdRelativeHorizontalPositionMargin: `0` = 0.asInstanceOf[`0`]
  
  inline def wdRelativeHorizontalPositionOuterMarginArea: `7` = 7.asInstanceOf[`7`]
  
  inline def wdRelativeHorizontalPositionPage: `1` = 1.asInstanceOf[`1`]
  
  inline def wdRelativeHorizontalPositionRightMarginArea: `5` = 5.asInstanceOf[`5`]
}
