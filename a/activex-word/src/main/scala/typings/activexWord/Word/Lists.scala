...
object Lists {
  ...
  implicit class ListsOps[Self <: Lists] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setItem(value: Double => List): Self = this.set("Item", js.Any.fromFunction1(value))
    
    @scala.inline
    def setParent(value: js.Any): Self = this.set("Parent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setWordDotLists_typekey(value: Lists): Self = this.set("Word.Lists_typekey", value.asInstanceOf[js.Any])
  }
}
