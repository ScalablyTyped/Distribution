...
*/
trait WdMergeSubType extends StObject
object WdMergeSubType {
  
  inline def wdMergeSubTypeAccess: `1` = 1.asInstanceOf[`1`]
  
  inline def wdMergeSubTypeOAL: `2` = 2.asInstanceOf[`2`]
  
  inline def wdMergeSubTypeOLEDBText: `5` = 5.asInstanceOf[`5`]
  
  inline def wdMergeSubTypeOLEDBWord: `3` = 3.asInstanceOf[`3`]
  
  inline def wdMergeSubTypeOther: `0` = 0.asInstanceOf[`0`]
  
  inline def wdMergeSubTypeOutlook: `6` = 6.asInstanceOf[`6`]
  
  inline def wdMergeSubTypeWord: `7` = 7.asInstanceOf[`7`]
  
  inline def wdMergeSubTypeWord2000: `8` = 8.asInstanceOf[`8`]
  
  inline def wdMergeSubTypeWorks: `4` = 4.asInstanceOf[`4`]
}
