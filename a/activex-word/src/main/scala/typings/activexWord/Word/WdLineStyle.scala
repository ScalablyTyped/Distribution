...
object WdLineStyle {
  ...
  inline def wdLineStyleDashDot: `5` = 5.asInstanceOf[`5`]
  
  inline def wdLineStyleDashDotDot: `6` = 6.asInstanceOf[`6`]
  
  inline def wdLineStyleDashDotStroked: `20` = 20.asInstanceOf[`20`]
  
  inline def wdLineStyleDashLargeGap: `4` = 4.asInstanceOf[`4`]
  
  inline def wdLineStyleDashSmallGap: `3` = 3.asInstanceOf[`3`]
  
  inline def wdLineStyleDot: `2` = 2.asInstanceOf[`2`]
  
  inline def wdLineStyleDouble: `7` = 7.asInstanceOf[`7`]
  
  inline def wdLineStyleDoubleWavy: `19` = 19.asInstanceOf[`19`]
  
  inline def wdLineStyleEmboss3D: `21` = 21.asInstanceOf[`21`]
  
  inline def wdLineStyleEngrave3D: `22` = 22.asInstanceOf[`22`]
  
  inline def wdLineStyleInset: `24` = 24.asInstanceOf[`24`]
  
  inline def wdLineStyleNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdLineStyleOutset: `23` = 23.asInstanceOf[`23`]
  
  inline def wdLineStyleSingle: `1` = 1.asInstanceOf[`1`]
  
  inline def wdLineStyleSingleWavy: `18` = 18.asInstanceOf[`18`]
  
  inline def wdLineStyleThickThinLargeGap: `16` = 16.asInstanceOf[`16`]
  
  inline def wdLineStyleThickThinMedGap: `13` = 13.asInstanceOf[`13`]
  
  inline def wdLineStyleThickThinSmallGap: `10` = 10.asInstanceOf[`10`]
  
  inline def wdLineStyleThinThickLargeGap: `15` = 15.asInstanceOf[`15`]
  
  inline def wdLineStyleThinThickMedGap: `12` = 12.asInstanceOf[`12`]
  
  inline def wdLineStyleThinThickSmallGap: `9` = 9.asInstanceOf[`9`]
  
  inline def wdLineStyleThinThickThinLargeGap: `17` = 17.asInstanceOf[`17`]
  
  inline def wdLineStyleThinThickThinMedGap: `14` = 14.asInstanceOf[`14`]
  
  inline def wdLineStyleThinThickThinSmallGap: `11` = 11.asInstanceOf[`11`]
  
  inline def wdLineStyleTriple: `8` = 8.asInstanceOf[`8`]
}
