...
*/
trait WdPictureLinkType extends js.Object

object WdPictureLinkType {
  @scala.inline
  def wdLinkDataInDoc: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def wdLinkDataOnDisk: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def wdLinkNone: `0` = 0.asInstanceOf[`0`]
}
