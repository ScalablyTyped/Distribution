...
*/
trait WdCellVerticalAlignment extends StObject
object WdCellVerticalAlignment {
  
  inline def wdCellAlignVerticalBottom: `3` = 3.asInstanceOf[`3`]
  
  inline def wdCellAlignVerticalCenter: `1` = 1.asInstanceOf[`1`]
  
  inline def wdCellAlignVerticalTop: `0` = 0.asInstanceOf[`0`]
}
