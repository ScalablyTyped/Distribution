...
*/
trait WdMeasurementUnits extends StObject
object WdMeasurementUnits {
  
  inline def wdCentimeters: `1` = 1.asInstanceOf[`1`]
  
  inline def wdInches: `0` = 0.asInstanceOf[`0`]
  
  inline def wdMillimeters: `2` = 2.asInstanceOf[`2`]
  
  inline def wdPicas: `4` = 4.asInstanceOf[`4`]
  
  inline def wdPoints: `3` = 3.asInstanceOf[`3`]
}
