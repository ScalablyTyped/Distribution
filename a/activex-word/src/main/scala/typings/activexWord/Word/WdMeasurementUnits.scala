...
*/
trait WdMeasurementUnits extends js.Object
object WdMeasurementUnits {
  
  @scala.inline
  def wdCentimeters: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def wdInches: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def wdMillimeters: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def wdPicas: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def wdPoints: `3` = 3.asInstanceOf[`3`]
}
