...
*/
trait WdViewType extends StObject
object WdViewType {
  
  inline def wdConflictView: `8` = 8.asInstanceOf[`8`]
  
  inline def wdMasterView: `5` = 5.asInstanceOf[`5`]
  
  inline def wdNormalView: `1` = 1.asInstanceOf[`1`]
  
  inline def wdOutlineView: `2` = 2.asInstanceOf[`2`]
  
  inline def wdPrintPreview: `4` = 4.asInstanceOf[`4`]
  
  inline def wdPrintView: `3` = 3.asInstanceOf[`3`]
  
  inline def wdReadingView: `7` = 7.asInstanceOf[`7`]
  
  inline def wdWebView: `6` = 6.asInstanceOf[`6`]
}
