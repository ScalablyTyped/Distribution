...
*/
trait WdViewType extends js.Object
object WdViewType {
  
  @scala.inline
  def wdConflictView: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def wdMasterView: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def wdNormalView: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def wdOutlineView: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def wdPrintPreview: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def wdPrintView: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def wdReadingView: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def wdWebView: `6` = 6.asInstanceOf[`6`]
}
