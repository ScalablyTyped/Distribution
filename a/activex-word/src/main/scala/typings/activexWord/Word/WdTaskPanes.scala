...
*/
trait WdTaskPanes extends StObject
object WdTaskPanes {
  
  inline def wdTaskPaneApplyStyles: `17` = 17.asInstanceOf[`17`]
  
  inline def wdTaskPaneDocumentActions: `7` = 7.asInstanceOf[`7`]
  
  inline def wdTaskPaneDocumentManagement: `16` = 16.asInstanceOf[`16`]
  
  inline def wdTaskPaneDocumentProtection: `6` = 6.asInstanceOf[`6`]
  
  inline def wdTaskPaneDocumentUpdates: `13` = 13.asInstanceOf[`13`]
  
  inline def wdTaskPaneFaxService: `11` = 11.asInstanceOf[`11`]
  
  inline def wdTaskPaneFormatting: `0` = 0.asInstanceOf[`0`]
  
  inline def wdTaskPaneHelp: `9` = 9.asInstanceOf[`9`]
  
  inline def wdTaskPaneMailMerge: `2` = 2.asInstanceOf[`2`]
  
  inline def wdTaskPaneNav: `18` = 18.asInstanceOf[`18`]
  
  inline def wdTaskPaneResearch: `10` = 10.asInstanceOf[`10`]
  
  inline def wdTaskPaneRevealFormatting: `1` = 1.asInstanceOf[`1`]
  
  inline def wdTaskPaneSearch: `4` = 4.asInstanceOf[`4`]
  
  inline def wdTaskPaneSelection: `19` = 19.asInstanceOf[`19`]
  
  inline def wdTaskPaneSharedWorkspace: `8` = 8.asInstanceOf[`8`]
  
  inline def wdTaskPaneSignature: `14` = 14.asInstanceOf[`14`]
  
  inline def wdTaskPaneStyleInspector: `15` = 15.asInstanceOf[`15`]
  
  inline def wdTaskPaneTranslate: `3` = 3.asInstanceOf[`3`]
  
  inline def wdTaskPaneXMLDocument: `12` = 12.asInstanceOf[`12`]
  
  inline def wdTaskPaneXMLStructure: `5` = 5.asInstanceOf[`5`]
}
