...
import typings.activexWord.activexWordNumbers.`37`
import typings.activexWord.activexWordNumbers.`38`
import typings.activexWord.activexWordNumbers.`39`
import typings.activexWord.activexWordNumbers.`3`
import typings.activexWord.activexWordNumbers.`40`
import typings.activexWord.activexWordNumbers.`41`
import typings.activexWord.activexWordNumbers.`42`
...
import typings.activexWord.activexWordNumbers.`59`
import typings.activexWord.activexWordNumbers.`5`
import typings.activexWord.activexWordNumbers.`60`
import typings.activexWord.activexWordNumbers.`61`
import typings.activexWord.activexWordNumbers.`62`
import typings.activexWord.activexWordNumbers.`63`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexWord.activexWordNumbers.`38`
  ...
  - typings.activexWord.activexWordNumbers.`62`
  ...
  - typings.activexWord.activexWordNumbers.`61`
  - typings.activexWord.activexWordNumbers.`63`
  ...
  - typings.activexWord.activexWordNumbers.`37`
  - typings.activexWord.activexWordNumbers.`50`
  - typings.activexWord.activexWordNumbers.`59`
  - typings.activexWord.activexWordNumbers.`40`
  - typings.activexWord.activexWordNumbers.`41`
  ...
  - typings.activexWord.activexWordNumbers.`60`
  ...
  - typings.activexWord.activexWordNumbers.`42`
...
*/
trait WdCompatibility extends StObject
object WdCompatibility {
  
  inline def wdAlignTablesRowByRow: `39` = 39.asInstanceOf[`39`]
  
  inline def wdAllowSpaceOfSameStyleInTable: `54` = 54.asInstanceOf[`54`]
  
  inline def wdApplyBreakingRules: `46` = 46.asInstanceOf[`46`]
  
  inline def wdAutofitLikeWW11: `57` = 57.asInstanceOf[`57`]
  
  inline def wdAutospaceLikeWW7: `38` = 38.asInstanceOf[`38`]
  
  inline def wdCachedColBalance: `65` = 65.asInstanceOf[`65`]
  
  inline def wdConvMailMergeEsc: `6` = 6.asInstanceOf[`6`]
  
  inline def wdDisableOTKerning: `66` = 66.asInstanceOf[`66`]
  
  inline def wdDontAdjustLineHeightInTable: `36` = 36.asInstanceOf[`36`]
  
  inline def wdDontAutofitConstrainedTables: `56` = 56.asInstanceOf[`56`]
  
  inline def wdDontBalanceSingleByteDoubleByteWidth: `16` = 16.asInstanceOf[`16`]
  
  inline def wdDontBreakConstrainedForcedTables: `62` = 62.asInstanceOf[`62`]
  
  inline def wdDontBreakWrappedTables: `43` = 43.asInstanceOf[`43`]
  
  inline def wdDontOverrideTableStyleFontSzAndJustification: `68` = 68.asInstanceOf[`68`]
  
  inline def wdDontSnapTextToGridInTableWithObjects: `44` = 44.asInstanceOf[`44`]
  
  inline def wdDontULTrailSpace: `15` = 15.asInstanceOf[`15`]
  
  inline def wdDontUseAsianBreakRulesInGrid: `48` = 48.asInstanceOf[`48`]
  
  inline def wdDontUseHTMLParagraphAutoSpacing: `35` = 35.asInstanceOf[`35`]
  
  inline def wdDontUseIndentAsNumberingTabStop: `52` = 52.asInstanceOf[`52`]
  
  inline def wdDontVertAlignCellWithShape: `61` = 61.asInstanceOf[`61`]
  
  inline def wdDontVertAlignInTextbox: `63` = 63.asInstanceOf[`63`]
  
  inline def wdDontWrapTextWithPunctuation: `47` = 47.asInstanceOf[`47`]
  
  inline def wdExactOnTop: `28` = 28.asInstanceOf[`28`]
  
  inline def wdExpandShiftReturn: `14` = 14.asInstanceOf[`14`]
  
  inline def wdFELineBreak11: `53` = 53.asInstanceOf[`53`]
  
  inline def wdFlipMirrorIndents: `67` = 67.asInstanceOf[`67`]
  
  inline def wdFootnoteLayoutLikeWW8: `34` = 34.asInstanceOf[`34`]
  
  inline def wdForgetLastTabAlignment: `37` = 37.asInstanceOf[`37`]
  
  inline def wdGrowAutofit: `50` = 50.asInstanceOf[`50`]
  
  inline def wdHangulWidthLikeWW11: `59` = 59.asInstanceOf[`59`]
  
  inline def wdLayoutRawTableWidth: `40` = 40.asInstanceOf[`40`]
  
  inline def wdLayoutTableRowsApart: `41` = 41.asInstanceOf[`41`]
  
  inline def wdLeaveBackslashAlone: `13` = 13.asInstanceOf[`13`]
  
  inline def wdLineWrapLikeWord6: `32` = 32.asInstanceOf[`32`]
  
  inline def wdMWSmallCaps: `22` = 22.asInstanceOf[`22`]
  
  inline def wdNoColumnBalance: `5` = 5.asInstanceOf[`5`]
  
  inline def wdNoExtraLineSpacing: `23` = 23.asInstanceOf[`23`]
  
  inline def wdNoLeading: `20` = 20.asInstanceOf[`20`]
  
  inline def wdNoSpaceForUL: `21` = 21.asInstanceOf[`21`]
  
  inline def wdNoSpaceRaiseLower: `2` = 2.asInstanceOf[`2`]
  
  inline def wdNoTabHangIndent: `1` = 1.asInstanceOf[`1`]
  
  inline def wdOrigWordTableRules: `9` = 9.asInstanceOf[`9`]
  
  inline def wdPrintBodyTextBeforeHeader: `19` = 19.asInstanceOf[`19`]
  
  inline def wdPrintColBlack: `3` = 3.asInstanceOf[`3`]
  
  inline def wdSelectFieldWithFirstOrLastCharacter: `45` = 45.asInstanceOf[`45`]
  
  inline def wdShapeLayoutLikeWW8: `33` = 33.asInstanceOf[`33`]
  
  inline def wdShowBreaksInFrames: `11` = 11.asInstanceOf[`11`]
  
  inline def wdSpacingInWholePoints: `18` = 18.asInstanceOf[`18`]
  
  inline def wdSplitPgBreakAndParaMark: `60` = 60.asInstanceOf[`60`]
  
  inline def wdSubFontBySize: `25` = 25.asInstanceOf[`25`]
  
  inline def wdSuppressBottomSpacing: `29` = 29.asInstanceOf[`29`]
  
  inline def wdSuppressSpBfAfterPgBrk: `7` = 7.asInstanceOf[`7`]
  
  inline def wdSuppressTopSpacing: `8` = 8.asInstanceOf[`8`]
  
  inline def wdSuppressTopSpacingMac5: `17` = 17.asInstanceOf[`17`]
  
  inline def wdSwapBordersFacingPages: `12` = 12.asInstanceOf[`12`]
  
  inline def wdTransparentMetafiles: `10` = 10.asInstanceOf[`10`]
  
  inline def wdTruncateFontHeight: `24` = 24.asInstanceOf[`24`]
  
  inline def wdUnderlineTabInNumList: `58` = 58.asInstanceOf[`58`]
  
  inline def wdUseNormalStyleForList: `51` = 51.asInstanceOf[`51`]
  
  inline def wdUsePrinterMetrics: `26` = 26.asInstanceOf[`26`]
  
  inline def wdUseWord2002TableStyleRules: `49` = 49.asInstanceOf[`49`]
  
  inline def wdUseWord97LineBreakingRules: `42` = 42.asInstanceOf[`42`]
  
  inline def wdWPJustification: `31` = 31.asInstanceOf[`31`]
  
  inline def wdWPSpaceWidth: `30` = 30.asInstanceOf[`30`]
  
  inline def wdWW11IndentRules: `55` = 55.asInstanceOf[`55`]
  
  inline def wdWW6BorderRules: `27` = 27.asInstanceOf[`27`]
  
  inline def wdWord11KerningPairs: `64` = 64.asInstanceOf[`64`]
  
  inline def wdWrapTrailSpaces: `4` = 4.asInstanceOf[`4`]
}
