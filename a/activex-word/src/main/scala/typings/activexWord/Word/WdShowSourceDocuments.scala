...
*/
trait WdShowSourceDocuments extends StObject
object WdShowSourceDocuments {
  
  inline def wdShowSourceDocumentsBoth: `3` = 3.asInstanceOf[`3`]
  
  inline def wdShowSourceDocumentsNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdShowSourceDocumentsOriginal: `1` = 1.asInstanceOf[`1`]
  
  inline def wdShowSourceDocumentsRevised: `2` = 2.asInstanceOf[`2`]
}
