...
*/
trait WdRevisedLinesMark extends StObject
object WdRevisedLinesMark {
  
  inline def wdRevisedLinesMarkLeftBorder: `1` = 1.asInstanceOf[`1`]
  
  inline def wdRevisedLinesMarkNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdRevisedLinesMarkOutsideBorder: `3` = 3.asInstanceOf[`3`]
  
  inline def wdRevisedLinesMarkRightBorder: `2` = 2.asInstanceOf[`2`]
}
