...
*/
trait WdLayoutMode extends StObject
object WdLayoutMode {
  
  inline def wdLayoutModeDefault: `0` = 0.asInstanceOf[`0`]
  
  inline def wdLayoutModeGenko: `3` = 3.asInstanceOf[`3`]
  
  inline def wdLayoutModeGrid: `1` = 1.asInstanceOf[`1`]
  
  inline def wdLayoutModeLineGrid: `2` = 2.asInstanceOf[`2`]
}
