...
*/
trait WdLayoutMode extends js.Object

object WdLayoutMode {
  @scala.inline
  def wdLayoutModeDefault: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def wdLayoutModeGenko: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def wdLayoutModeGrid: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def wdLayoutModeLineGrid: `2` = 2.asInstanceOf[`2`]
}
