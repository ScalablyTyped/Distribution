...
object XlDisplayUnit {
  ...
  inline def xlHundredMillions: `-8` = -8.asInstanceOf[`-8`]
  
  inline def xlHundredThousands: `-5` = -5.asInstanceOf[`-5`]
  
  inline def xlHundreds: `-2` = -2.asInstanceOf[`-2`]
  
  inline def xlMillionMillions: `-10` = -10.asInstanceOf[`-10`]
  
  inline def xlMillions: `-6` = -6.asInstanceOf[`-6`]
  
  inline def xlTenMillions: `-7` = -7.asInstanceOf[`-7`]
  
  inline def xlTenThousands: `-4` = -4.asInstanceOf[`-4`]
  
  inline def xlThousandMillions: `-9` = -9.asInstanceOf[`-9`]
  
  inline def xlThousands: `-3` = -3.asInstanceOf[`-3`]
}
