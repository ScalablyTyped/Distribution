...
@js.native
/* private */ open class HangulAndAlphabetExceptions ()
  extends StObject
     with typings.activexWord.Word.HangulAndAlphabetExceptions {
  
  /* CompleteClass */
  override def Add(Name: String): typings.activexWord.Word.HangulAndAlphabetException = js.native
  ...
  /* CompleteClass */
  override def Item(Index: Any): typings.activexWord.Word.HangulAndAlphabetException = js.native
