...
/* private */ class EmailOptions ()
  ...
  /* CompleteClass */
  override val ComposeStyle: typings.activexWord.Word.Style = js.native
  ...
  /* CompleteClass */
  override val EmailSignature: typings.activexWord.Word.EmailSignature = js.native
  ...
  /* CompleteClass */
  override val PlainTextStyle: typings.activexWord.Word.Style = js.native
  
  /* CompleteClass */
  var RelyOnCSS: Boolean = js.native
  
  /* CompleteClass */
  override val ReplyStyle: typings.activexWord.Word.Style = js.native
