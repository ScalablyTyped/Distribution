...
/* private */ class HeaderFooter ()
  ...
  /* CompleteClass */
  override val Index: WdHeaderFooterIndex = js.native
  
  /* CompleteClass */
  override val IsHeader: Boolean = js.native
  
  /* CompleteClass */
  var LinkToPrevious: Boolean = js.native
  
  /* CompleteClass */
  override val PageNumbers: typings.activexWord.Word.PageNumbers = js.native
