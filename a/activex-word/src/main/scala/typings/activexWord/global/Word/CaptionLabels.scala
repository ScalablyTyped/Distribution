...
@js.native
/* private */ open class CaptionLabels ()
  extends StObject
     with typings.activexWord.Word.CaptionLabels {
  
  /* CompleteClass */
  override def Add(Name: String): typings.activexWord.Word.CaptionLabel = js.native
  ...
  /* CompleteClass */
  override def Item(Index: Any): typings.activexWord.Word.CaptionLabel = js.native
