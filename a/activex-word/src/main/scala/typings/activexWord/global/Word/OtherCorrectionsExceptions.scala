...
@js.native
/* private */ open class OtherCorrectionsExceptions ()
  extends StObject
     with typings.activexWord.Word.OtherCorrectionsExceptions {
  
  /* CompleteClass */
  override def Add(Name: String): typings.activexWord.Word.OtherCorrectionsException = js.native
  ...
  /* CompleteClass */
  override def Item(Index: Any): typings.activexWord.Word.OtherCorrectionsException = js.native
