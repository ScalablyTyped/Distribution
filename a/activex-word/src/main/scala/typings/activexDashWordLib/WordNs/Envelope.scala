...
class Envelope protected () extends js.Object {
  ...
  var DefaultOmitReturnAddress: scala.Boolean = js.native
  var DefaultOrientation: WdEnvelopeOrientation = js.native
  var DefaultPrintBarCode: scala.Boolean = js.native
  var DefaultPrintFIMA: scala.Boolean = js.native
  var DefaultSize: java.lang.String = js.native
  var DefaultWidth: scala.Double = js.native
  var FeedSource: WdPaperTray = js.native
  val Parent: js.Any = js.native
  var RecipientNamefromLeft: scala.Double = js.native
  var RecipientNamefromTop: scala.Double = js.native
  var RecipientPostalfromLeft: scala.Double = js.native
  var RecipientPostalfromTop: scala.Double = js.native
  val ReturnAddress: Range = js.native
  var ReturnAddressFromLeft: scala.Double = js.native
  var ReturnAddressFromTop: scala.Double = js.native
  val ReturnAddressStyle: Style = js.native
  var SenderNamefromLeft: scala.Double = js.native
  var SenderNamefromTop: scala.Double = js.native
  var SenderPostalfromLeft: scala.Double = js.native
  var SenderPostalfromTop: scala.Double = js.native
  ...
  def UpdateDocument(): scala.Unit = js.native
}
