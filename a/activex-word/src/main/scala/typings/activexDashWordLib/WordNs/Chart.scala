...
class Chart protected () extends js.Object {
  ...
  val ChartArea: activexDashWordLib.WordNs.ChartArea = js.native
  val ChartData: activexDashWordLib.WordNs.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: activexDashWordLib.WordNs.ChartTitle = js.native
  var ChartType: activexDashOfficeLib.OfficeNs.XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: activexDashWordLib.WordNs.Corners = js.native
  val Creator: scala.Double = js.native
  val DataTable: activexDashWordLib.WordNs.DataTable = js.native
  ...
  val Floor: activexDashWordLib.WordNs.Floor = js.native
  ...
  val Legend: activexDashWordLib.WordNs.Legend = js.native
  ...
  val PlotArea: activexDashWordLib.WordNs.PlotArea = js.native
  ...
  val Walls: activexDashWordLib.WordNs.Walls = js.native
