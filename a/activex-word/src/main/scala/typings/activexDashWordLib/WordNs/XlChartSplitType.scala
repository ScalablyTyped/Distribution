...
@JSGlobal("Word.XlChartSplitType")
@js.native
object XlChartSplitType extends js.Object {
  @js.native
  sealed trait xlSplitByCustomSplit
    extends activexDashWordLib.WordNs.XlChartSplitType
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashWordLib.WordNs.XlChartSplitType with scala.Double] = js.native
}
