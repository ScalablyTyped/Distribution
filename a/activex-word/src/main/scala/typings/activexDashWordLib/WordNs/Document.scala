...
class Document protected () extends js.Object {
  ...
  val MailMerge: MailMerge = js.native
  ...
  val ReadabilityStatistics: ReadabilityStatistics = js.native
  ...
  val Revisions: Revisions = js.native
  ...
  val StoryRanges: StoryRanges = js.native
  val StyleSheets: StyleSheets = js.native
  var StyleSortMethod: WdStyleSort = js.native
  val Styles: Styles = js.native
  val Subdocuments: Subdocuments = js.native
  ...
  val TablesOfAuthorities: TablesOfAuthorities = js.native
  val TablesOfAuthoritiesCategories: TablesOfAuthoritiesCategories = js.native
  val TablesOfContents: TablesOfContents = js.native
  val TablesOfFigures: TablesOfFigures = js.native
  ...
  val XMLSchemaReferences: XMLSchemaReferences = js.native
  ...
  def Range(Start: scala.Double): Range = js.native
  def Range(Start: scala.Double, End: scala.Double): Range = js.native
