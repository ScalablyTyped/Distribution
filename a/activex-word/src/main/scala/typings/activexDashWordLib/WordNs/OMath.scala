...
class OMath protected () extends js.Object {
  ...
  def ConvertToLiteralText(): scala.Unit = js.native
  def ConvertToMathText(): scala.Unit = js.native
  def ConvertToNormalText(): scala.Unit = js.native
  def Linearize(): scala.Unit = js.native
