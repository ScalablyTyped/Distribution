...
class Application protected () extends js.Object {
  ...
  val Bibliography: Bibliography = js.native
  ...
  val EmailOptions: EmailOptions = js.native
  ...
  val MailMessage: MailMessage = js.native
  val MailSystem: WdMailSystem = js.native
  val MailingLabel: MailingLabel = js.native
  ...
  val OMathAutoCorrect: OMathAutoCorrect = js.native
  ...
  val SmartTagRecognizers: SmartTagRecognizers = js.native
  val SmartTagTypes: SmartTagTypes = js.native
  ...
  val TaskPanes: TaskPanes = js.native
  val Tasks: Tasks = js.native
  val Templates: Templates = js.native
  var Top: scala.Double = js.native
  val UndoRecord: UndoRecord = js.native
  ...
  val XMLNamespaces: XMLNamespaces = js.native
  ...
  def DefaultWebOptions(): DefaultWebOptions = js.native
