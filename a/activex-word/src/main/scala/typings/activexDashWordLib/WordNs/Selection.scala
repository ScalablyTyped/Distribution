...
class Selection protected () extends js.Object {
  ...
  val Editors: activexDashWordLib.WordNs.Editors = js.native
  var End: scala.Double = js.native
  val EndnoteOptions: activexDashWordLib.WordNs.EndnoteOptions = js.native
  ...
  val Find: activexDashWordLib.WordNs.Find[activexDashWordLib.WordNs.Selection] = js.native
  ...
  val FootnoteOptions: activexDashWordLib.WordNs.FootnoteOptions = js.native
  ...
  val HeaderFooter: activexDashWordLib.WordNs.HeaderFooter = js.native
  ...
  val ShapeRange: activexDashWordLib.WordNs.ShapeRange = js.native
