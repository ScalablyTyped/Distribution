...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: activexDashWordLib.WordNs.DownBars = js.native
  val DropLines: activexDashWordLib.WordNs.DropLines = js.native
  ...
  val HiLoLines: activexDashWordLib.WordNs.HiLoLines = js.native
  ...
  val SeriesLines: activexDashWordLib.WordNs.SeriesLines = js.native
  ...
  val UpBars: activexDashWordLib.WordNs.UpBars = js.native
