...
class Range protected () extends js.Object {
  ...
  val ListFormat: ListFormat = js.native
  ...
  val SynonymInfo: SynonymInfo = js.native
  val TableStyle: js.Any = js.native
  val Tables: Tables = js.native
  var Text: java.lang.String = js.native
  var TextRetrievalMode: TextRetrievalMode = js.native
