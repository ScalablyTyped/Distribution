...
class Range protected () extends js.Object {
  ...
  val CanEdit: scala.Double = js.native
  val CanPaste: scala.Double = js.native
  ...
  var CombineCharacters: scala.Boolean = js.native
  val Comments: activexDashWordLib.WordNs.Comments = js.native
  val Conflicts: activexDashWordLib.WordNs.Conflicts = js.native
  ...
  val Find: activexDashWordLib.WordNs.Find[activexDashWordLib.WordNs.Range] = js.native
  ...
  val ListFormat: activexDashWordLib.WordNs.ListFormat = js.native
  ...
  val SynonymInfo: activexDashWordLib.WordNs.SynonymInfo = js.native
  val TableStyle: js.Any = js.native
  val Tables: activexDashWordLib.WordNs.Tables = js.native
  var Text: java.lang.String = js.native
  var TextRetrievalMode: activexDashWordLib.WordNs.TextRetrievalMode = js.native
  ...
  def ConvertHangulAndHanja(ConversionsMode: js.Any): scala.Unit = js.native
  def ConvertHangulAndHanja(ConversionsMode: js.Any, FastConversion: js.Any): scala.Unit = js.native
  def ConvertHangulAndHanja(ConversionsMode: js.Any, FastConversion: js.Any, CheckHangulEnding: js.Any): scala.Unit = js.native
  ...
  def CreatePublisher(): scala.Unit = js.native
  def CreatePublisher(Edition: js.Any): scala.Unit = js.native
  def CreatePublisher(Edition: js.Any, ContainsPICT: js.Any): scala.Unit = js.native
  def CreatePublisher(Edition: js.Any, ContainsPICT: js.Any, ContainsRTF: js.Any): scala.Unit = js.native
  def CreatePublisher(Edition: js.Any, ContainsPICT: js.Any, ContainsRTF: js.Any, ContainsText: js.Any): scala.Unit = js.native
  ...
  def ExportFragment(FileName: java.lang.String, Format: WdSaveFormat): scala.Unit = js.native
  ...
  def LookupNameProperties(): scala.Unit = js.native
  def ModifyEnclosure(Style: js.Any): scala.Unit = js.native
  def ModifyEnclosure(Style: js.Any, Symbol: js.Any): scala.Unit = js.native
  def ModifyEnclosure(Style: js.Any, Symbol: js.Any, EnclosedText: js.Any): scala.Unit = js.native
  ...
  def Relocate(Direction: scala.Double): scala.Unit = js.native
  def Scripts(Index: js.Any): activexDashOfficeLib.OfficeNs.Script = js.native
  def Select(): scala.Unit = js.native
  def SetListLevel(Level: scala.Double): scala.Unit = js.native
