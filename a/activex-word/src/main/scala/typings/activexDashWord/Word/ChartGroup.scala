...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typings.activexDashWord.Word.DownBars = js.native
  val DropLines: typings.activexDashWord.Word.DropLines = js.native
  ...
  val HiLoLines: typings.activexDashWord.Word.HiLoLines = js.native
  val Index: Double = js.native
  var Overlap: Double = js.native
  val Parent: js.Any = js.native
  val RadarAxisLabels: TickLabels = js.native
  var SecondPlotSize: Double = js.native
  val SeriesLines: typings.activexDashWord.Word.SeriesLines = js.native
