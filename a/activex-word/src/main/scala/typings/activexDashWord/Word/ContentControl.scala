...
class ContentControl protected () extends js.Object {
  ...
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typings.activexDashWord.Word.Range): Unit = js.native
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typings.activexDashWord.Word.Range, Text: String): Unit = js.native
  /** @param string [Font=''] */
