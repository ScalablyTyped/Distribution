...
object WdOMathSpacingRule {
  ...
  @scala.inline
  def wdOMathSpacing1pt5: `1` = this.cast(1)
  @scala.inline
  def wdOMathSpacingDouble: `2` = this.cast(2)
  @scala.inline
  def wdOMathSpacingExactly: `3` = this.cast(3)
  @scala.inline
  def wdOMathSpacingMultiple: `4` = this.cast(4)
  @scala.inline
  def wdOMathSpacingSingle: `0` = this.cast(0)
}
