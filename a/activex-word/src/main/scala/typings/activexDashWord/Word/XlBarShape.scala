...
object XlBarShape {
  ...
  @scala.inline
  def xlBox: `0` = this.cast(0)
  @scala.inline
  def xlConeToMax: `5` = this.cast(5)
  @scala.inline
  def xlConeToPoint: `4` = this.cast(4)
  @scala.inline
  def xlCylinder: `3` = this.cast(3)
  @scala.inline
  def xlPyramidToMax: `2` = this.cast(2)
  @scala.inline
  def xlPyramidToPoint: `1` = this.cast(1)
}
