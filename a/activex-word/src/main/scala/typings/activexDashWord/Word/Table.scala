...
class Table protected () extends js.Object {
  ...
  val Columns: typings.activexDashWord.Word.Columns = js.native
  ...
  val Rows: typings.activexDashWord.Word.Rows = js.native
  ...
  def Cell(Row: Double, Column: Double): typings.activexDashWord.Word.Cell = js.native
  ...
  def ConvertToTextOld(): typings.activexDashWord.Word.Range = js.native
  def ConvertToTextOld(Separator: js.Any): typings.activexDashWord.Word.Range = js.native
