...
class Range protected () extends js.Object {
  ...
  val Find: typings.activexDashWord.Word.Find[Range] = js.native
  ...
  val ListFormat: typings.activexDashWord.Word.ListFormat = js.native
  ...
  val SynonymInfo: typings.activexDashWord.Word.SynonymInfo = js.native
  val TableStyle: js.Any = js.native
  val Tables: typings.activexDashWord.Word.Tables = js.native
  var Text: String = js.native
  var TextRetrievalMode: typings.activexDashWord.Word.TextRetrievalMode = js.native
