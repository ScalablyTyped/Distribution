...
class AutoCorrect protected () extends js.Object {
  ...
  val FirstLetterExceptions: typings.activexDashWord.Word.FirstLetterExceptions = js.native
  var HangulAndAlphabetAutoAdd: Boolean = js.native
  val HangulAndAlphabetExceptions: typings.activexDashWord.Word.HangulAndAlphabetExceptions = js.native
  var OtherCorrectionsAutoAdd: Boolean = js.native
  val OtherCorrectionsExceptions: typings.activexDashWord.Word.OtherCorrectionsExceptions = js.native
