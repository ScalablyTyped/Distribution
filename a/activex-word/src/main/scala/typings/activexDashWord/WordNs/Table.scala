...
class Table protected () extends js.Object {
  ...
  val Columns: typings.activexDashWord.WordNs.Columns = js.native
  ...
  val Rows: typings.activexDashWord.WordNs.Rows = js.native
  ...
  def Cell(Row: Double, Column: Double): typings.activexDashWord.WordNs.Cell = js.native
