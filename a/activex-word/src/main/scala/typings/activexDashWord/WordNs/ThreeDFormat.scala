...
import typings.activexDashOffice.OfficeNs.MsoBevelType
import typings.activexDashOffice.OfficeNs.MsoExtrusionColorType
import typings.activexDashOffice.OfficeNs.MsoLightRigType
import typings.activexDashOffice.OfficeNs.MsoPresetCamera
import typings.activexDashOffice.OfficeNs.MsoPresetExtrusionDirection
import typings.activexDashOffice.OfficeNs.MsoPresetLightingDirection
import typings.activexDashOffice.OfficeNs.MsoPresetLightingSoftness
import typings.activexDashOffice.OfficeNs.MsoPresetMaterial
import typings.activexDashOffice.OfficeNs.MsoPresetThreeDFormat
