...
class Shape protected () extends js.Object {
  val Adjustments: typings.activexDashWord.WordNs.Adjustments = js.native
  ...
  val ConnectorFormat: typings.activexDashWord.WordNs.ConnectorFormat = js.native
  val Creator: Double = js.native
  val Diagram: IMsoDiagram = js.native
  val DiagramNode: typings.activexDashWord.WordNs.DiagramNode = js.native
  ...
  val PictureFormat: typings.activexDashWord.WordNs.PictureFormat = js.native
  ...
  val TextFrame: typings.activexDashWord.WordNs.TextFrame = js.native
  ...
  val WrapFormat: typings.activexDashWord.WordNs.WrapFormat = js.native
