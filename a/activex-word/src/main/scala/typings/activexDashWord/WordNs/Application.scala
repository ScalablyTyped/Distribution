...
class Application protected () extends js.Object {
  ...
  val Browser: typings.activexDashWord.WordNs.Browser = js.native
  ...
  val EmailOptions: typings.activexDashWord.WordNs.EmailOptions = js.native
  ...
  val MailMessage: typings.activexDashWord.WordNs.MailMessage = js.native
  val MailSystem: WdMailSystem = js.native
  val MailingLabel: typings.activexDashWord.WordNs.MailingLabel = js.native
  ...
  val OMathAutoCorrect: typings.activexDashWord.WordNs.OMathAutoCorrect = js.native
  ...
  val PickerDialog: typings.activexDashOffice.OfficeNs.PickerDialog = js.native
  ...
  val SmartTagRecognizers: typings.activexDashWord.WordNs.SmartTagRecognizers = js.native
  val SmartTagTypes: typings.activexDashWord.WordNs.SmartTagTypes = js.native
  ...
  val TaskPanes: typings.activexDashWord.WordNs.TaskPanes = js.native
  ...
  val UndoRecord: typings.activexDashWord.WordNs.UndoRecord = js.native
  ...
  var `Word.Application_typekey`: typings.activexDashWord.WordNs.Application = js.native
  val WordBasic: js.Any = js.native
  val XMLNamespaces: typings.activexDashWord.WordNs.XMLNamespaces = js.native
  ...
  def DefaultWebOptions(): typings.activexDashWord.WordNs.DefaultWebOptions = js.native
  ...
  def FileDialog(FileDialogType: MsoFileDialogType): typings.activexDashOffice.OfficeNs.FileDialog = js.native
