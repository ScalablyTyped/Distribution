...
class Chart protected () extends js.Object {
  ...
  val BackWall: typings.activexDashWord.WordNs.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typings.activexDashWord.WordNs.ChartArea = js.native
  val ChartData: typings.activexDashWord.WordNs.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typings.activexDashWord.WordNs.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typings.activexDashWord.WordNs.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typings.activexDashWord.WordNs.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typings.activexDashWord.WordNs.Floor = js.native
  ...
  val Legend: typings.activexDashWord.WordNs.Legend = js.native
  ...
  val PlotArea: typings.activexDashWord.WordNs.PlotArea = js.native
  ...
  val SideWall: typings.activexDashWord.WordNs.Walls = js.native
  var SubType: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Type: Double = js.native
  val Walls: typings.activexDashWord.WordNs.Walls = js.native
