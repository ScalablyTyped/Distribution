...
object WdReferenceType {
  ...
  @scala.inline
  def wdRefTypeBookmark: `2` = this.cast(2)
  @scala.inline
  def wdRefTypeEndnote: `4` = this.cast(4)
  @scala.inline
  def wdRefTypeFootnote: `3` = this.cast(3)
  @scala.inline
  def wdRefTypeHeading: `1` = this.cast(1)
  @scala.inline
  def wdRefTypeNumberedItem: `0` = this.cast(0)
}
