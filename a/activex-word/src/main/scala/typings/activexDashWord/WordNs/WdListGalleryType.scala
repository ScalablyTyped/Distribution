...
*/
trait WdListGalleryType extends js.Object

object WdListGalleryType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def wdBulletGallery: `1` = this.cast(1)
  @scala.inline
  def wdNumberGallery: `2` = this.cast(2)
  @scala.inline
  def wdOutlineNumberGallery: `3` = this.cast(3)
}
