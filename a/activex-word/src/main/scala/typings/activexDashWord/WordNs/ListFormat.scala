...
class ListFormat protected () extends js.Object {
  ...
  val List: typings.activexDashWord.WordNs.List = js.native
  ...
  def ApplyListTemplate(ListTemplate: typings.activexDashWord.WordNs.ListTemplate): Unit = js.native
  def ApplyListTemplate(ListTemplate: typings.activexDashWord.WordNs.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplate(
    ListTemplate: typings.activexDashWord.WordNs.ListTemplate,
  ...
  def ApplyListTemplateOld(ListTemplate: typings.activexDashWord.WordNs.ListTemplate): Unit = js.native
  def ApplyListTemplateOld(ListTemplate: typings.activexDashWord.WordNs.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplateOld(
    ListTemplate: typings.activexDashWord.WordNs.ListTemplate,
    ContinuePreviousList: js.Any,
    ApplyTo: js.Any
  ): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typings.activexDashWord.WordNs.ListTemplate): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typings.activexDashWord.WordNs.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  ...
  def CanContinuePreviousList(ListTemplate: typings.activexDashWord.WordNs.ListTemplate): WdContinue = js.native
