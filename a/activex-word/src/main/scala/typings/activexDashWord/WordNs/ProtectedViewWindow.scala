...
class ProtectedViewWindow protected () extends js.Object {
  ...
  def Edit(): typings.activexDashWord.WordNs.Document = js.native
  def Edit(PasswordTemplate: js.Any): typings.activexDashWord.WordNs.Document = js.native
  def Edit(PasswordTemplate: js.Any, WritePasswordDocument: js.Any): typings.activexDashWord.WordNs.Document = js.native
  def Edit(PasswordTemplate: js.Any, WritePasswordDocument: js.Any, WritePasswordTemplate: js.Any): typings.activexDashWord.WordNs.Document = js.native
