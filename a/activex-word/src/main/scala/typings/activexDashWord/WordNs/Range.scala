...
import typings.activexDashWord.activexDashWordNumbers.`9999998`
...
class Range protected () extends js.Object {
  ...
  val Editors: typings.activexDashWord.WordNs.Editors = js.native
  var EmphasisMark: WdEmphasisMark = js.native
  var End: Double = js.native
  val EndnoteOptions: typings.activexDashWord.WordNs.EndnoteOptions = js.native
  ...
  val Find: typings.activexDashWord.WordNs.Find[Range] = js.native
  var FitTextWidth: Double = js.native
  var Font: typings.activexDashWord.WordNs.Font = js.native
  val FootnoteOptions: typings.activexDashWord.WordNs.FootnoteOptions = js.native
  ...
  val ListFormat: typings.activexDashWord.WordNs.ListFormat = js.native
  ...
  val ShapeRange: typings.activexDashWord.WordNs.ShapeRange = js.native
  ...
  val SynonymInfo: typings.activexDashWord.WordNs.SynonymInfo = js.native
  val TableStyle: js.Any = js.native
  val Tables: typings.activexDashWord.WordNs.Tables = js.native
  var Text: String = js.native
  var TextRetrievalMode: typings.activexDashWord.WordNs.TextRetrievalMode = js.native
  val TopLevelTables: typings.activexDashWord.WordNs.Tables = js.native
