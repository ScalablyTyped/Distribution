...
class AutoCorrect protected () extends js.Object {
  ...
  val FirstLetterExceptions: typings.activexDashWord.WordNs.FirstLetterExceptions = js.native
  var HangulAndAlphabetAutoAdd: Boolean = js.native
  val HangulAndAlphabetExceptions: typings.activexDashWord.WordNs.HangulAndAlphabetExceptions = js.native
  var OtherCorrectionsAutoAdd: Boolean = js.native
  val OtherCorrectionsExceptions: typings.activexDashWord.WordNs.OtherCorrectionsExceptions = js.native
  ...
  val TwoInitialCapsExceptions: typings.activexDashWord.WordNs.TwoInitialCapsExceptions = js.native
