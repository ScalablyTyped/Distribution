...
object anon {
  ...
  object Android {
    ...
    implicit open class MutableBuilder[Self <: Android] (val x: Self) extends AnyVal {
      ...
      inline def setAndroidICS(value: Boolean): Self = StObject.set(x, "androidICS", value.asInstanceOf[js.Any])
      ...
      inline def setFennec(value: Boolean): Self = StObject.set(x, "fennec", value.asInstanceOf[js.Any])
      
      inline def setIe(value: Boolean): Self = StObject.set(x, "ie", value.asInstanceOf[js.Any])
      
      inline def setIeTouch(value: Boolean): Self = StObject.set(x, "ieTouch", value.asInstanceOf[js.Any])
      
      inline def setIos(value: Boolean): Self = StObject.set(x, "ios", value.asInstanceOf[js.Any])
      
      inline def setIos7(value: Boolean): Self = StObject.set(x, "ios7", value.asInstanceOf[js.Any])
  ...
  object CssPrefix {
    ...
    inline def apply(cssPrefix: String, cssTransformEnd: String, cssTransformStart: String, nativeTouchScroll: Boolean): CssPrefix = {
    ...
    implicit open class MutableBuilder[Self <: CssPrefix] (val x: Self) extends AnyVal {
      ...
      inline def setCssTransformEnd(value: String): Self = StObject.set(x, "cssTransformEnd", value.asInstanceOf[js.Any])
      
      inline def setCssTransformStart(value: String): Self = StObject.set(x, "cssTransformStart", value.asInstanceOf[js.Any])
      
      inline def setNativeTouchScroll(value: Boolean): Self = StObject.set(x, "nativeTouchScroll", value.asInstanceOf[js.Any])
    }
  }
}
