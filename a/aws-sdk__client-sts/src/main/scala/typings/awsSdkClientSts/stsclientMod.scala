...
object stsclientMod {
  ...
  trait STSClientResolvedConfigType extends StObject {
    ...
    var credentialDefaultProvider_Original: js.Function1[/* input */ Any, Provider[Credentials]]
    ...
    /**
      ...
      * @internal
      */
    var stsClientCtor: Instantiable1[/* clientConfig */ Any, typings.awsSdkTypes.clientMod.Client[Any, Any, Any]]
  ...
  object STSClientResolvedConfigType {
    ...
    inline def apply(
      ...
      stsClientCtor: Instantiable1[/* clientConfig */ Any, typings.awsSdkTypes.clientMod.Client[Any, Any, Any]],
    ...
    extension [Self <: STSClientResolvedConfigType](x: Self) {
      ...
      inline def setStsClientCtor(value: Instantiable1[/* clientConfig */ Any, typings.awsSdkTypes.clientMod.Client[Any, Any, Any]]): Self = StObject.set(x, "stsClientCtor", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsSdkClientSts.assumeRoleCommandMod.AssumeRoleCommandOutput
    - typings.awsSdkClientSts.assumeRoleWithSAMLCommandMod.AssumeRoleWithSAMLCommandOutput
    - typings.awsSdkClientSts.assumeRoleWithWebIdentityCommandMod.AssumeRoleWithWebIdentityCommandOutput
    - typings.awsSdkClientSts.decodeAuthorizationMessageCommandMod.DecodeAuthorizationMessageCommandOutput
    - typings.awsSdkClientSts.getAccessKeyInfoCommandMod.GetAccessKeyInfoCommandOutput
    - typings.awsSdkClientSts.getCallerIdentityCommandMod.GetCallerIdentityCommandOutput
    - typings.awsSdkClientSts.getFederationTokenCommandMod.GetFederationTokenCommandOutput
    - typings.awsSdkClientSts.getSessionTokenCommandMod.GetSessionTokenCommandOutput
  */
  trait ServiceOutputTypes extends StObject
  object ServiceOutputTypes {
    
    inline def AssumeRoleCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.assumeRoleCommandMod.AssumeRoleCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.assumeRoleCommandMod.AssumeRoleCommandOutput]
    }
    
    inline def AssumeRoleWithSAMLCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.assumeRoleWithSAMLCommandMod.AssumeRoleWithSAMLCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.assumeRoleWithSAMLCommandMod.AssumeRoleWithSAMLCommandOutput]
    }
    
    inline def AssumeRoleWithWebIdentityCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.assumeRoleWithWebIdentityCommandMod.AssumeRoleWithWebIdentityCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.assumeRoleWithWebIdentityCommandMod.AssumeRoleWithWebIdentityCommandOutput]
    }
    
    inline def DecodeAuthorizationMessageCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.decodeAuthorizationMessageCommandMod.DecodeAuthorizationMessageCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.decodeAuthorizationMessageCommandMod.DecodeAuthorizationMessageCommandOutput]
    }
    
    inline def GetAccessKeyInfoCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.getAccessKeyInfoCommandMod.GetAccessKeyInfoCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.getAccessKeyInfoCommandMod.GetAccessKeyInfoCommandOutput]
    }
    
    inline def GetCallerIdentityCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.getCallerIdentityCommandMod.GetCallerIdentityCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.getCallerIdentityCommandMod.GetCallerIdentityCommandOutput]
    }
    
    inline def GetFederationTokenCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.getFederationTokenCommandMod.GetFederationTokenCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.getFederationTokenCommandMod.GetFederationTokenCommandOutput]
    }
    
    inline def GetSessionTokenCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSts.getSessionTokenCommandMod.GetSessionTokenCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSts.getSessionTokenCommandMod.GetSessionTokenCommandOutput]
    }
  }
}
