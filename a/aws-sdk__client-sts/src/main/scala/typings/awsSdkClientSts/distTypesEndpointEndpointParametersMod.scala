...
object distTypesEndpointEndpointParametersMod {
  ...
  @JSImport("@aws-sdk/client-sts/dist-types/endpoint/EndpointParameters", JSImport.Namespace)
  @js.native
  ...
  trait EndpointParameters
    ...
    var UseGlobalEndpoint: js.UndefOr[Boolean] = js.undefined
  }
  object EndpointParameters {
    ...
    extension [Self <: EndpointParameters](x: Self) {
      ...
      inline def setUseGlobalEndpoint(value: Boolean): Self = StObject.set(x, "UseGlobalEndpoint", value.asInstanceOf[js.Any])
