...
object IWebSocketMessageHandler {
  ...
  @scala.inline
  def apply(autoApply: Boolean, fn: MessageEvent[_] => Unit): IWebSocketMessageHandler = {
  ...
  implicit class IWebSocketMessageHandlerOps[Self <: IWebSocketMessageHandler] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFn(value: MessageEvent[_] => Unit): Self = this.set("fn", js.Any.fromFunction1(value))
