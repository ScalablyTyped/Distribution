...
trait Anon_EventName extends js.Object {
  def on(eventName: asyncDashPollingLib.asyncDashPollingMod.EventName, listener: js.Function): js.Any
  def run(): js.Any
  def stop(): js.Any
}
...
object Anon_EventName {
  @scala.inline
  def apply(
    on: (asyncDashPollingLib.asyncDashPollingMod.EventName, js.Function) => js.Any,
    run: () => js.Any,
    stop: () => js.Any
  ): Anon_EventName = {
