...
object FetchMoreQueryOptions {
  @scala.inline
  def apply[TVariables, /* <: / * keyof TVariables * / java.lang.String */ K](context: js.Any = null, query: DocumentNode = null, variables: Pick[TVariables, K] = null): FetchMoreQueryOptions[TVariables, K] = {
