...
trait AnonDocumentFetchMoreForQueryId extends js.Object {
...
object AnonDocumentFetchMoreForQueryId {
  @scala.inline
  def apply(
  ...
  ): AnonDocumentFetchMoreForQueryId = {
    ...
    __obj.asInstanceOf[AnonDocumentFetchMoreForQueryId]
  }
}
