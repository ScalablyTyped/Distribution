...
trait ReadonlyDocumentNode extends js.Object {
  ...
  val kind: typings.apolloClient.apolloClientStrings.Document = js.native
  val loc: js.UndefOr[Location] = js.native
}

object ReadonlyDocumentNode {
  @scala.inline
  def apply(definitions: js.Array[DefinitionNode], kind: typings.apolloClient.apolloClientStrings.Document): ReadonlyDocumentNode = {
  ...
  implicit class ReadonlyDocumentNodeOps[Self <: ReadonlyDocumentNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKind(value: typings.apolloClient.apolloClientStrings.Document): Self = this.set("kind", value.asInstanceOf[js.Any])
    @scala.inline
