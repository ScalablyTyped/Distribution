...
class QueryManager[TStore] protected () extends js.Object {
  def this(hasLinkQueryDeduplicationStoreOnBroadcastSsrModeClientAwarenessLocalStateAssumeImmutableResults: apolloDashClientLib.Anon_AssumeImmutableResults[TStore]) = this()
  val assumeImmutableResults: scala.Boolean = js.native
  ...
  def getQueryWithPreviousResult[TData, TVariables](queryIdOrObservable: apolloDashClientLib.coreObservableQueryMod.ObservableQuery[TData, TVariables]): apolloDashClientLib.Anon_Document[TVariables] = js.native
  def getQueryWithPreviousResult[TData, TVariables](queryIdOrObservable: java.lang.String): apolloDashClientLib.Anon_Document[TVariables] = js.native
  def mutate[T](
  ...
  def startGraphQLSubscription[T](
    hasQueryFetchPolicyVariables: apolloDashClientLib.coreWatchQueryOptionsMod.SubscriptionOptions[apolloDashClientLib.coreTypesMod.OperationVariables]
  ): apolloDashClientLib.utilObservableMod.Observable[
    apolloDashLinkLib.libTypesMod.FetchResult[T, stdLib.Record[java.lang.String, _], stdLib.Record[java.lang.String, _]]
  ] = js.native
