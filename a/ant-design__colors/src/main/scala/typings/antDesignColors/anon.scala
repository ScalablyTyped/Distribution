...
import typings.antDesignColors.mod.PalettesProps
...
object anon {
  ...
  /* n */ NumberDictionary[String] {
    ...
    def copyWithin(target: Double, start: Double): PalettesProps = js.native
    def copyWithin(target: Double, start: Double, end: Double): PalettesProps = js.native
    ...
    /**
      ...
      */
    /* standard es2015.core */
    def fill(value: String): PalettesProps = js.native
    def fill(value: String, start: Double): PalettesProps = js.native
    def fill(value: String, start: Double, end: Double): PalettesProps = js.native
    def fill(value: String, start: Unit, end: Double): PalettesProps = js.native
    ...
    /**
      ...
      */
    /* standard es5 */
    def sort(): PalettesProps = js.native
    def sort(compareFn: js.Function2[/* a */ String, /* b */ String, Double]): PalettesProps = js.native
