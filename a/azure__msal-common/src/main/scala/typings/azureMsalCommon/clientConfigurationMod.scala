...
import typings.azureMsalCommon.authorityOptionsMod.AzureCloudInstance
import typings.azureMsalCommon.cacheManagerMod.CacheManager
import typings.azureMsalCommon.clientCredentialsMod.ClientCredentials
