...
object Separators extends StObject {
  ...
  sealed trait CACHE_KEY_SEPARATOR
    extends StObject
       with Separators
  /* "-" */ val CACHE_KEY_SEPARATOR: typings.azureMsalCommon.distUtilsConstantsMod.Separators.CACHE_KEY_SEPARATOR & String = js.native
  
  @js.native
  sealed trait CLIENT_INFO_SEPARATOR
    extends StObject
       with Separators
  /* "." */ val CLIENT_INFO_SEPARATOR: typings.azureMsalCommon.distUtilsConstantsMod.Separators.CLIENT_INFO_SEPARATOR & String = js.native
}
