...
object PromptValue {
  ...
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue.CONSENT")
  @js.native
  ...
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue.CREATE")
  @js.native
  ...
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue.LOGIN")
  @js.native
  ...
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue.NONE")
  @js.native
  def NONE: String = js.native
  inline def NONE_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NONE")(x.asInstanceOf[js.Any])
  
  @JSImport("@azure/msal-common/dist/utils/Constants", "PromptValue.SELECT_ACCOUNT")
  @js.native
