...
object cacheTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.azureMsalCommon.accountEntityMod.AccountEntity
    - typings.azureMsalCommon.idTokenEntityMod.IdTokenEntity
    - typings.azureMsalCommon.accessTokenEntityMod.AccessTokenEntity
    - typings.azureMsalCommon.refreshTokenEntityMod.RefreshTokenEntity
    - typings.azureMsalCommon.appMetadataEntityMod.AppMetadataEntity
    - typings.azureMsalCommon.authorityMetadataEntityMod.AuthorityMetadataEntity
    - typings.azureMsalCommon.serverTelemetryEntityMod.ServerTelemetryEntity
    - typings.azureMsalCommon.throttlingEntityMod.ThrottlingEntity
    - java.lang.String
  */
