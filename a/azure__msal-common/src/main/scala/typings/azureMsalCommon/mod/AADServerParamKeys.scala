...
@JSImport("@azure/msal-common", "AADServerParamKeys")
@js.native
object AADServerParamKeys extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.azureMsalCommon.constantsMod.AADServerParamKeys & String] = js.native
