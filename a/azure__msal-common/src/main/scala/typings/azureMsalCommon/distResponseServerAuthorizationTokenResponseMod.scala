...
object distResponseServerAuthorizationTokenResponseMod {
  ...
  object ServerAuthorizationTokenResponse {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ServerAuthorizationTokenResponse] (val x: Self) extends AnyVal {
