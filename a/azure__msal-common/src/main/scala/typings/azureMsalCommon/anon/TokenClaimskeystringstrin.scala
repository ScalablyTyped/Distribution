...
/* Inlined @azure/msal-common.@azure/msal-common/dist/account/TokenClaims.TokenClaims & {[key: string] : string | number | std.Array<string> | object | undefined | unknown} */
trait TokenClaimskeystringstrin
  extends StObject
     with /* key */ StringDictionary[js.UndefOr[String | Double | js.Array[String] | js.Object | Any]] {
...
object TokenClaimskeystringstrin {
  
  inline def apply(): TokenClaimskeystringstrin = {
