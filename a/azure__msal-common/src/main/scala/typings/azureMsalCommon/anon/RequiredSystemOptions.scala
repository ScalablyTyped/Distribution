...
object RequiredSystemOptions {
  ...
  inline def apply(preventCorsPreflight: Boolean, tokenRenewalOffsetSeconds: Double): RequiredSystemOptions = {
    val __obj = js.Dynamic.literal(preventCorsPreflight = preventCorsPreflight.asInstanceOf[js.Any], tokenRenewalOffsetSeconds = tokenRenewalOffsetSeconds.asInstanceOf[js.Any])
