...
class KnockoutComposition protected () extends js.Object {
  ...
  /** internal: do not use */
  def buildCompositionSettings(value: js.Any, bindingContext: js.Any): stdLib.Promise[_] = js.native
  /** internal: do not use */
  def getViewModelInstance(moduleId: java.lang.String): stdLib.Promise[_] = js.native
  /**
