...
version := "2.3.0-0e6bf2"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "aurelia-binding" % "2.1.6-b1b2f3",
  "com.scalablytyped" %%% "aurelia-dependency-injection" % "1.4.1-8261f2",
  "com.scalablytyped" %%% "aurelia-loader" % "1.0.0-e97122",
  ...
  "com.scalablytyped" %%% "aurelia-templating" % "1.10.1-24e140",
