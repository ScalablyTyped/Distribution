...
trait Anon_AddExpand extends js.Object {
  ...
  def list(groupname: java.lang.String): js.Promise[
    js.Array[java.lang.String] | js.Array[atlassianDashCrowdDashClientLib.libModelsUserMod.^]
  ] = js.native
  def list(groupname: java.lang.String, nested: scala.Boolean): js.Promise[
    js.Array[java.lang.String] | js.Array[atlassianDashCrowdDashClientLib.libModelsUserMod.^]
  ] = js.native
  def list(groupname: java.lang.String, nested: scala.Boolean, startIndex: scala.Double): js.Promise[
    js.Array[java.lang.String] | js.Array[atlassianDashCrowdDashClientLib.libModelsUserMod.^]
  ] = js.native
  def list(
