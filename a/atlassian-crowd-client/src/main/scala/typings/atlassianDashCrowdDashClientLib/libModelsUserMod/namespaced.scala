...
@js.native
class namespaced protected () extends User {
...
object namespaced extends js.Object {
  def fromCrowd(userObj: atlassianDashCrowdDashClientLib.libModelsUserMod.UserObj): atlassianDashCrowdDashClientLib.libModelsUserMod.User = js.native
}
