...
trait IComponentOptions extends js.Object {
  ...
  /**
           ...
           * Use the array form to define dependencies (necessary if strictDi is enabled and you require dependency injection)
           */
  var template: js.UndefOr[java.lang.String | (Injectable[js.Function1[/* repeated */_, java.lang.String]])] = js.undefined
  /**
           ...
           * Use the array form to define dependencies (necessary if strictDi is enabled and you require dependency injection)
           */
  var templateUrl: js.UndefOr[java.lang.String | (Injectable[js.Function1[/* repeated */_, java.lang.String]])] = js.undefined
  /**
