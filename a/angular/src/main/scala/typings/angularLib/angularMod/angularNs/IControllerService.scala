...
trait IControllerService extends js.Object {
  ...
  def apply[T](controllerConstructor: ScalablyTyped.runtime.Instantiable1[/* args (repeated) */ js.Any, T]): T = js.native
  // Although the documentation doesn't state this, locals are optional
  def apply[T](
    controllerConstructor: ScalablyTyped.runtime.Instantiable1[/* args (repeated) */ js.Any, T],
    locals: js.Any
  ): T = js.native
