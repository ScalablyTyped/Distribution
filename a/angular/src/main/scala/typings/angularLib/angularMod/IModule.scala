...
trait IModule extends js.Object {
  ...
  var requires: js.Array[java.lang.String] = js.native
  /**
    ...
    */
  def component(name: java.lang.String, options: IComponentOptions): IModule = js.native
  /**
    * Use this method to register a component.
    *
  ...
  /**
    ...
    */
  def constant[T](name: java.lang.String, value: T): IModule = js.native
  /**
  ...
  def provider(name: java.lang.String, serviceProviderFactory: IServiceProviderFactory): IModule = js.native
  ...
  /**
    ...
    */
  def value[T](name: java.lang.String, value: T): IModule = js.native
}
