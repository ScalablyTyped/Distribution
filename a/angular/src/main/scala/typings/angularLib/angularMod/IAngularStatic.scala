...
trait IAngularStatic extends js.Object {
  ...
  var resumeBootstrap: js.UndefOr[
    js.Function1[
      ...
      angularLib.angularMod.autoNs.IInjectorService
    ]
  ] = js.native
  ...
  def bootstrap(element: angularLib.JQuery): angularLib.angularMod.autoNs.IInjectorService = js.native
  def bootstrap(
    element: angularLib.JQuery,
    modules: js.Array[java.lang.String | angularLib.angularMod.Global.Function | js.Array[_]]
  ): angularLib.angularMod.autoNs.IInjectorService = js.native
  def bootstrap(
    element: angularLib.JQuery,
    modules: js.Array[java.lang.String | angularLib.angularMod.Global.Function | js.Array[_]],
  ...
  /**
    ...
    */
  def bootstrap(element: java.lang.String): angularLib.angularMod.autoNs.IInjectorService = js.native
  def bootstrap(
  ...
  def bootstrap(element: stdLib.Document): angularLib.angularMod.autoNs.IInjectorService = js.native
  def bootstrap(
  ...
  def bootstrap(element: stdLib.Element): angularLib.angularMod.autoNs.IInjectorService = js.native
  def bootstrap(
  ...
  def injector(modules: js.Array[_]): angularLib.angularMod.autoNs.IInjectorService = js.native
  def injector(modules: js.Array[_], strictDi: scala.Boolean): angularLib.angularMod.autoNs.IInjectorService = js.native
