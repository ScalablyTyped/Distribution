...
object IDirective {
  ...
  @scala.inline
  implicit class IDirectiveMutableBuilder[Self <: IDirective[?, ?, ?, ?], TScope /* <: IScope */, TElement /* <: JQLite */, TAttributes /* <: IAttributes */, TController /* <: IDirectiveController */] (val x: Self & (IDirective[TScope, TElement, TAttributes, TController])) extends AnyVal {
