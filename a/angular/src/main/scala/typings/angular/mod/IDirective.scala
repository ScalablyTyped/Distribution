...
object IDirective {
  @scala.inline
  def apply[/* <: typings.angular.mod.IScope */ TScope, /* <: typings.angular.JQLite */ TElement, /* <: typings.angular.mod.IAttributes */ TAttributes, /* <: typings.angular.mod.IDirectiveController */ TController](): IDirective[TScope, TElement, TAttributes, TController] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IDirective[TScope, TElement, TAttributes, TController]]
  }
  @scala.inline
  implicit class IDirectiveOps[Self <: IDirective[_, _, _, _], /* <: typings.angular.mod.IScope */ TScope, /* <: typings.angular.JQLite */ TElement, /* <: typings.angular.mod.IAttributes */ TAttributes, /* <: typings.angular.mod.IDirectiveController */ TController] (val x: Self with (IDirective[TScope, TElement, TAttributes, TController])) extends AnyVal {
    @scala.inline
