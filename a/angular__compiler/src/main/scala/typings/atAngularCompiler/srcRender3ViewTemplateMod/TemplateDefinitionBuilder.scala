...
import typings.atAngularCompiler.srcRender3R3UnderscoreAstMod.Icu
...
import typings.atAngularCompiler.srcRender3R3UnderscoreAstMod.Text
...
class TemplateDefinitionBuilder protected ()
  ...
  def i18nAppendBindings(expressions: js.Array[typings.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST]): Unit = js.native
