...
@JSImport("@angular/compiler/src/compiler", "R3ResolvedDependencyType")
@js.native
object R3ResolvedDependencyType extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typings.atAngularCompiler.srcRender3R3UnderscoreFactoryMod.R3ResolvedDependencyType with Double
  ] = js.native
}
