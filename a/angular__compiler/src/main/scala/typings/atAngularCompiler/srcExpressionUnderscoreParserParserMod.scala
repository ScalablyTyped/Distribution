...
import typings.atAngularCompiler.srcExpressionUnderscoreParserParserMod.SplitInterpolation
import typings.atAngularCompiler.srcExpressionUnderscoreParserParserMod.TemplateBindingParseResult
