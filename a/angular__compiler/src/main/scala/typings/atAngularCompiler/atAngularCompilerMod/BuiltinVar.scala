...
@JSImport("@angular/compiler", "BuiltinVar")
@js.native
object BuiltinVar extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.atAngularCompiler.srcOutputOutputUnderscoreAstMod.BuiltinVar with Double] = js.native
}
