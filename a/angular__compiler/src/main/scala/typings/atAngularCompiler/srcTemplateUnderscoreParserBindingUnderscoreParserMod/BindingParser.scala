...
import typings.atAngularCompiler.srcExpressionUnderscoreParserAstMod.ParsedProperty
import typings.atAngularCompiler.srcExpressionUnderscoreParserAstMod.ParsedVariable
