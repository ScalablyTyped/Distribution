...
object Anon_IsEquivalent {
  @scala.inline
  def apply[T /* <: /* import warning: ImportType.apply Failed type conversion: {isEquivalent (other : T): boolean} */ js.Any */](isEquivalent: T => scala.Boolean): Anon_IsEquivalent[T] = {
