...
class SelectorContext[T] protected () extends js.Object {
  ...
  def finalize(cssSelector: CssSelector): scala.Boolean = js.native
  def finalize(cssSelector: CssSelector, callback: js.Function2[/* c */ CssSelector, /* a */ T, scala.Unit]): scala.Boolean = js.native
}
