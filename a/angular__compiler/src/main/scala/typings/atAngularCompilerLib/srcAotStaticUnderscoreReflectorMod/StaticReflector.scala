...
class StaticReflector protected ()
  ...
  def this(summaryResolver: atAngularCompilerLib.srcSummaryUnderscoreResolverMod.SummaryResolver[atAngularCompilerLib.srcAotStaticUnderscoreSymbolMod.StaticSymbol], symbolResolver: atAngularCompilerLib.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver, knownMetadataClasses: js.Array[atAngularCompilerLib.Anon_Ctor]) = this()
  def this(summaryResolver: atAngularCompilerLib.srcSummaryUnderscoreResolverMod.SummaryResolver[atAngularCompilerLib.srcAotStaticUnderscoreSymbolMod.StaticSymbol], symbolResolver: atAngularCompilerLib.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver, knownMetadataClasses: js.Array[atAngularCompilerLib.Anon_Ctor], knownMetadataFunctions: js.Array[atAngularCompilerLib.Anon_FilePath]) = this()
  def this(summaryResolver: atAngularCompilerLib.srcSummaryUnderscoreResolverMod.SummaryResolver[atAngularCompilerLib.srcAotStaticUnderscoreSymbolMod.StaticSymbol], symbolResolver: atAngularCompilerLib.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver, knownMetadataClasses: js.Array[atAngularCompilerLib.Anon_Ctor], knownMetadataFunctions: js.Array[atAngularCompilerLib.Anon_FilePath], errorRecorder: js.Function2[/* error */ js.Any, /* fileName */ js.UndefOr[java.lang.String], scala.Unit]) = this()
