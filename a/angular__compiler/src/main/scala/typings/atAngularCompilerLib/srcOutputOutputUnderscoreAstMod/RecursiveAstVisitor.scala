...
class RecursiveAstVisitor ()
  ...
  def visitAllExpressions(exprs: js.Array[Expression], context: js.Any): scala.Unit = js.native
  def visitAllStatements(stmts: js.Array[Statement], context: js.Any): scala.Unit = js.native
