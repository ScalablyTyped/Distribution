...
class ElementAst protected () extends TemplateAst {
  def this(name: java.lang.String, attrs: js.Array[AttrAst], inputs: js.Array[BoundElementPropertyAst], outputs: js.Array[BoundEventAst], references: js.Array[ReferenceAst], directives: js.Array[DirectiveAst], providers: js.Array[ProviderAst], hasViewContainer: scala.Boolean, queryMatches: js.Array[QueryMatch], children: js.Array[TemplateAst], ngContentIndex: scala.Double, sourceSpan: atAngularCompilerLib.srcParseUnderscoreUtilMod.ParseSourceSpan) = this()
  def this(name: java.lang.String, attrs: js.Array[AttrAst], inputs: js.Array[BoundElementPropertyAst], outputs: js.Array[BoundEventAst], references: js.Array[ReferenceAst], directives: js.Array[DirectiveAst], providers: js.Array[ProviderAst], hasViewContainer: scala.Boolean, queryMatches: js.Array[QueryMatch], children: js.Array[TemplateAst], ngContentIndex: scala.Null, sourceSpan: atAngularCompilerLib.srcParseUnderscoreUtilMod.ParseSourceSpan) = this()
  ...
  var ngContentIndex: scala.Double | scala.Null = js.native
