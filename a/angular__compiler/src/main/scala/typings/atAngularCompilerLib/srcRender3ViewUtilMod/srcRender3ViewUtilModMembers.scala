...
object srcRender3ViewUtilModMembers extends js.Object {
  ...
  val ID_SEPARATOR: /* @@ */ java.lang.String = js.native
  val IMPLICIT_REFERENCE: /* $implicit */ java.lang.String = js.native
  val MEANING_SEPARATOR: /* | */ java.lang.String = js.native
  ...
  def assembleI18nTemplate(strings: js.Array[java.lang.String]): java.lang.String = js.native
  def conditionallyCreateMapObjectLiteral(keys: ScalablyTyped.runtime.StringDictionary[java.lang.String]): atAngularCompilerLib.srcOutputOutputUnderscoreAstMod.Expression | scala.Null = js.native
