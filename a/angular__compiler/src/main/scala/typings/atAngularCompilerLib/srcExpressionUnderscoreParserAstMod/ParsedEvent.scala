...
class ParsedEvent protected () extends js.Object {
  def this(name: java.lang.String, targetOrPhase: java.lang.String, `type`: ParsedEventType, handler: AST, sourceSpan: atAngularCompilerLib.srcParseUnderscoreUtilMod.ParseSourceSpan) = this()
