...
@JSImport("@angular/compiler/src/compiler", "ParseErrorLevel")
@js.native
object ParseErrorLevel extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.angularCompiler.srcParseUtilMod.ParseErrorLevel with Double] = js.native
