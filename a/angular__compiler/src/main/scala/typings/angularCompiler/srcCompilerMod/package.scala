...
@scala.inline
def debugOutputAstAsTypeScript(ast: js.Array[js.Any]): java.lang.String = typings.angularCompiler.srcCompilerMod.^.asInstanceOf[js.Dynamic].applyDynamic("debugOutputAstAsTypeScript")(ast.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
@scala.inline
