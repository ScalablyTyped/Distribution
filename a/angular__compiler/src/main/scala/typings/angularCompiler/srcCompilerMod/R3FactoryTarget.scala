...
@JSImport("@angular/compiler/src/compiler", "R3FactoryTarget")
@js.native
object R3FactoryTarget extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.angularCompiler.r3FactoryMod.R3FactoryTarget & Double] = js.native
