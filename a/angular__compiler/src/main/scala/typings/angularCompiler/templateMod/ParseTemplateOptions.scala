...
object ParseTemplateOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableI18nLegacyMessageIdFormat)) __obj.updateDynamic("enableI18nLegacyMessageIdFormat")(enableI18nLegacyMessageIdFormat.get.asInstanceOf[js.Any])
