...
@JSImport("@angular/compiler/public_api", "BuiltinVar")
@js.native
object BuiltinVar extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.angularCompiler.outputAstMod.BuiltinVar with Double] = js.native
}
