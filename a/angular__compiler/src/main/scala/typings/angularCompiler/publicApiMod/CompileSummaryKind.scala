...
@JSImport("@angular/compiler/public_api", "CompileSummaryKind")
@js.native
object CompileSummaryKind extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.angularCompiler.compileMetadataMod.CompileSummaryKind with Double] = js.native
