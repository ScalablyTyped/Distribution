...
/**
  ...
  * Ivy mode only.
  */
trait IvySimpleExpressionChecker extends SimpleExpressionChecker

object IvySimpleExpressionChecker {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[IvySimpleExpressionChecker]
  }
}
