...
import typings.angularCompiler.AnonKeySpan
...
class ParseAST protected () extends js.Object {
  ...
  /**
    ...
    */
  def expectTemplateBindingKey(): AnonKeySpan = js.native
  ...
  /**
    ...
    */
  def parseTemplateBindings(templateKey: String): TemplateBindingParseResult = js.native
