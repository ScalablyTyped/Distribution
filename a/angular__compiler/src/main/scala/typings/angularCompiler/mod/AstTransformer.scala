...
@JSImport("@angular/compiler", "AstTransformer")
@js.native
open class AstTransformer ()
  ...
  def visitThisReceiver_MAstTransformer(ast: ThisReceiver, context: Any): AST = js.native
  
  @JSName("visitUnary")
  def visitUnary_MAstTransformer(ast: Unary, context: Any): AST = js.native
}
