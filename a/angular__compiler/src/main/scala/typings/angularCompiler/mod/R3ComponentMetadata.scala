...
object R3ComponentMetadata {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: R3ComponentMetadata[?], DeclarationT /* <: R3TemplateDependency */] (val x: Self & R3ComponentMetadata[DeclarationT]) extends AnyVal {
