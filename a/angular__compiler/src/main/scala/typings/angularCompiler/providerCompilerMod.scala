...
object providerCompilerMod {
  ...
  inline def componentFactoryResolverProviderDef(
  ...
  inline def depDef(ctx: OutputContext, dep: CompileDiDependencyMetadata): Expression = (^.asInstanceOf[js.Dynamic].applyDynamic("depDef")(ctx.asInstanceOf[js.Any], dep.asInstanceOf[js.Any])).asInstanceOf[Expression]
  
  inline def lifecycleHookToNodeFlag(lifecycleHook: LifecycleHooks): NodeFlags = ^.asInstanceOf[js.Dynamic].applyDynamic("lifecycleHookToNodeFlag")(lifecycleHook.asInstanceOf[js.Any]).asInstanceOf[NodeFlags]
  
  inline def providerDef(ctx: OutputContext, providerAst: ProviderAst): DepsExpr = (^.asInstanceOf[js.Dynamic].applyDynamic("providerDef")(ctx.asInstanceOf[js.Any], providerAst.asInstanceOf[js.Any])).asInstanceOf[DepsExpr]
}
