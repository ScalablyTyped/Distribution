...
@JSImport("@angular/compiler/compiler", "R3ResolvedDependencyType")
@js.native
object R3ResolvedDependencyType extends StObject {
  
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.angularCompiler.r3FactoryMod.R3ResolvedDependencyType & Double] = js.native
