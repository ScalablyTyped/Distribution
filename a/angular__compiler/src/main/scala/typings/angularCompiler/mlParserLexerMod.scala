...
object mlParserLexerMod {
  ...
  object TokenType extends StObject {
    ...
    /* 12 */ val ATTR_NAME: typings.angularCompiler.mlParserLexerMod.TokenType.ATTR_NAME with Double = js.native
    
    @js.native
    sealed trait ATTR_QUOTE extends TokenType
    /* 13 */ val ATTR_QUOTE: typings.angularCompiler.mlParserLexerMod.TokenType.ATTR_QUOTE with Double = js.native
    
    @js.native
    sealed trait ATTR_VALUE extends TokenType
    /* 14 */ val ATTR_VALUE: typings.angularCompiler.mlParserLexerMod.TokenType.ATTR_VALUE with Double = js.native
    
    @js.native
    sealed trait CDATA_END extends TokenType
    /* 11 */ val CDATA_END: typings.angularCompiler.mlParserLexerMod.TokenType.CDATA_END with Double = js.native
    
    @js.native
    sealed trait CDATA_START extends TokenType
    /* 10 */ val CDATA_START: typings.angularCompiler.mlParserLexerMod.TokenType.CDATA_START with Double = js.native
    
    @js.native
    sealed trait COMMENT_END extends TokenType
    /* 9 */ val COMMENT_END: typings.angularCompiler.mlParserLexerMod.TokenType.COMMENT_END with Double = js.native
    
    @js.native
    sealed trait COMMENT_START extends TokenType
    /* 8 */ val COMMENT_START: typings.angularCompiler.mlParserLexerMod.TokenType.COMMENT_START with Double = js.native
    
    @js.native
    sealed trait DOC_TYPE extends TokenType
    /* 15 */ val DOC_TYPE: typings.angularCompiler.mlParserLexerMod.TokenType.DOC_TYPE with Double = js.native
    
    @js.native
    sealed trait EOF extends TokenType
    /* 21 */ val EOF: typings.angularCompiler.mlParserLexerMod.TokenType.EOF with Double = js.native
    
    @js.native
    sealed trait ESCAPABLE_RAW_TEXT extends TokenType
    /* 6 */ val ESCAPABLE_RAW_TEXT: typings.angularCompiler.mlParserLexerMod.TokenType.ESCAPABLE_RAW_TEXT with Double = js.native
    
    @js.native
    sealed trait EXPANSION_CASE_EXP_END extends TokenType
    /* 19 */ val EXPANSION_CASE_EXP_END: typings.angularCompiler.mlParserLexerMod.TokenType.EXPANSION_CASE_EXP_END with Double = js.native
    
    @js.native
    sealed trait EXPANSION_CASE_EXP_START extends TokenType
    /* 18 */ val EXPANSION_CASE_EXP_START: typings.angularCompiler.mlParserLexerMod.TokenType.EXPANSION_CASE_EXP_START with Double = js.native
    
    @js.native
    sealed trait EXPANSION_CASE_VALUE extends TokenType
    /* 17 */ val EXPANSION_CASE_VALUE: typings.angularCompiler.mlParserLexerMod.TokenType.EXPANSION_CASE_VALUE with Double = js.native
    
    @js.native
    sealed trait EXPANSION_FORM_END extends TokenType
    /* 20 */ val EXPANSION_FORM_END: typings.angularCompiler.mlParserLexerMod.TokenType.EXPANSION_FORM_END with Double = js.native
    
    @js.native
    sealed trait EXPANSION_FORM_START extends TokenType
    /* 16 */ val EXPANSION_FORM_START: typings.angularCompiler.mlParserLexerMod.TokenType.EXPANSION_FORM_START with Double = js.native
    
    @js.native
    sealed trait INCOMPLETE_TAG_OPEN extends TokenType
    /* 4 */ val INCOMPLETE_TAG_OPEN: typings.angularCompiler.mlParserLexerMod.TokenType.INCOMPLETE_TAG_OPEN with Double = js.native
    
    @js.native
    sealed trait RAW_TEXT extends TokenType
    /* 7 */ val RAW_TEXT: typings.angularCompiler.mlParserLexerMod.TokenType.RAW_TEXT with Double = js.native
    
    @js.native
    sealed trait TAG_CLOSE extends TokenType
    /* 3 */ val TAG_CLOSE: typings.angularCompiler.mlParserLexerMod.TokenType.TAG_CLOSE with Double = js.native
    
    @js.native
    sealed trait TAG_OPEN_END extends TokenType
    /* 1 */ val TAG_OPEN_END: typings.angularCompiler.mlParserLexerMod.TokenType.TAG_OPEN_END with Double = js.native
    
    @js.native
    sealed trait TAG_OPEN_END_VOID extends TokenType
    /* 2 */ val TAG_OPEN_END_VOID: typings.angularCompiler.mlParserLexerMod.TokenType.TAG_OPEN_END_VOID with Double = js.native
    
    @js.native
    sealed trait TAG_OPEN_START extends TokenType
    /* 0 */ val TAG_OPEN_START: typings.angularCompiler.mlParserLexerMod.TokenType.TAG_OPEN_START with Double = js.native
    
    @js.native
    sealed trait TEXT extends TokenType
    /* 5 */ val TEXT: typings.angularCompiler.mlParserLexerMod.TokenType.TEXT with Double = js.native
  }
