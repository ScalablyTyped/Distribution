...
object CompileDirectiveSummary {
  ...
  @scala.inline
  implicit class CompileDirectiveSummaryOps[Self <: CompileDirectiveSummary] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setTemplate(value: CompileTemplateSummary): Self = this.set("template", value.asInstanceOf[js.Any])
    @scala.inline
