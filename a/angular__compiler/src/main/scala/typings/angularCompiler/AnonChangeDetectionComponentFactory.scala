...
trait AnonChangeDetectionComponentFactory extends js.Object {
...
object AnonChangeDetectionComponentFactory {
  @scala.inline
  def apply(
  ...
  ): AnonChangeDetectionComponentFactory = {
    ...
    __obj.asInstanceOf[AnonChangeDetectionComponentFactory]
  }
}
