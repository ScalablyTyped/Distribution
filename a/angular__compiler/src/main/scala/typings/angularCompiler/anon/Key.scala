...
object Key {
  ...
  inline def apply(key: String, quoted: Boolean, value: typings.angularCompiler.outputAstMod.Expression): Key = {
  ...
  extension [Self <: Key](x: Self) {
    ...
    inline def setValue(value: typings.angularCompiler.outputAstMod.Expression): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  }
}
