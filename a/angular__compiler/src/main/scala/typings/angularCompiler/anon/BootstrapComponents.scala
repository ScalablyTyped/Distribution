...
object BootstrapComponents {
  ...
  extension [Self <: BootstrapComponents](x: Self) {
    ...
    inline def setBootstrapComponents(value: js.Array[CompileIdentifierMetadata]): Self = StObject.set(x, "bootstrapComponents", value.asInstanceOf[js.Any])
    
    inline def setBootstrapComponentsVarargs(value: CompileIdentifierMetadata*): Self = StObject.set(x, "bootstrapComponents", js.Array(value :_*))
    
    inline def setDeclaredDirectives(value: js.Array[CompileIdentifierMetadata]): Self = StObject.set(x, "declaredDirectives", value.asInstanceOf[js.Any])
    
    inline def setDeclaredDirectivesVarargs(value: CompileIdentifierMetadata*): Self = StObject.set(x, "declaredDirectives", js.Array(value :_*))
    
    inline def setDeclaredPipes(value: js.Array[CompileIdentifierMetadata]): Self = StObject.set(x, "declaredPipes", value.asInstanceOf[js.Any])
    
    inline def setDeclaredPipesVarargs(value: CompileIdentifierMetadata*): Self = StObject.set(x, "declaredPipes", js.Array(value :_*))
    ...
    inline def setExportedModules(value: js.Array[CompileNgModuleSummary]): Self = StObject.set(x, "exportedModules", value.asInstanceOf[js.Any])
    
    inline def setExportedModulesVarargs(value: CompileNgModuleSummary*): Self = StObject.set(x, "exportedModules", js.Array(value :_*))
    ...
    inline def setImportedModules(value: js.Array[CompileNgModuleSummary]): Self = StObject.set(x, "importedModules", value.asInstanceOf[js.Any])
    
    inline def setImportedModulesVarargs(value: CompileNgModuleSummary*): Self = StObject.set(x, "importedModules", js.Array(value :_*))
    ...
    inline def setTransitiveModule(value: TransitiveCompileNgModuleMetadata): Self = StObject.set(x, "transitiveModule", value.asInstanceOf[js.Any])
