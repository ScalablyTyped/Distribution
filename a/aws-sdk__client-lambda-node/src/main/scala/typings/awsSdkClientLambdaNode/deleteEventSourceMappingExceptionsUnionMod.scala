...
@JSImport("@aws-sdk/client-lambda-node/types/DeleteEventSourceMappingExceptionsUnion", JSImport.Namespace)
@js.native
object deleteEventSourceMappingExceptionsUnionMod extends js.Object {
