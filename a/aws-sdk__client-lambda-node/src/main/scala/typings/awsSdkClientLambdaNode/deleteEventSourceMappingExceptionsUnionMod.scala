...
object deleteEventSourceMappingExceptionsUnionMod {
  ...
  */
  ...
  object DeleteEventSourceMappingExceptionsUnion {
    ...
    @scala.inline
    def ResourceInUseException(): typings.awsSdkClientLambdaNode.typesResourceInUseExceptionMod.ResourceInUseException = {
