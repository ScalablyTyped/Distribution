...
object typesGetEventSourceMappingInputMod {
  
  trait GetEventSourceMappingInput
    extends StObject
  ...
  object GetEventSourceMappingInput {
    ...
    inline def apply(UUID: String): GetEventSourceMappingInput = {
      val __obj = js.Dynamic.literal(UUID = UUID.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetEventSourceMappingInput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: GetEventSourceMappingInput] (val x: Self) extends AnyVal {
