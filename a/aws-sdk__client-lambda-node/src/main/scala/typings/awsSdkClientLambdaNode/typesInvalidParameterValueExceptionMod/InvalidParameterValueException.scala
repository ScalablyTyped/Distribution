...
object InvalidParameterValueException {
  ...
  implicit class InvalidParameterValueExceptionOps[Self <: InvalidParameterValueException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidParameterValueException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
