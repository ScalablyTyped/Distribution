package typings.awsSdkClientLambdaNode.typesDeleteFunctionInputMod
...
object DeleteFunctionInput {
  @scala.inline
  def apply(FunctionName: String): DeleteFunctionInput = {
    val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteFunctionInput]
  }
  @scala.inline
  implicit class DeleteFunctionInputOps[Self <: DeleteFunctionInput] (val x: Self) extends AnyVal {
    @scala.inline
