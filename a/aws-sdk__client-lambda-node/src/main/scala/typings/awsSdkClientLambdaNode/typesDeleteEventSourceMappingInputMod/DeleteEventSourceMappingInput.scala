package typings.awsSdkClientLambdaNode.typesDeleteEventSourceMappingInputMod
...
object DeleteEventSourceMappingInput {
  @scala.inline
  def apply(UUID: String): DeleteEventSourceMappingInput = {
    val __obj = js.Dynamic.literal(UUID = UUID.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteEventSourceMappingInput]
  }
  @scala.inline
  implicit class DeleteEventSourceMappingInputOps[Self <: DeleteEventSourceMappingInput] (val x: Self) extends AnyVal {
    @scala.inline
