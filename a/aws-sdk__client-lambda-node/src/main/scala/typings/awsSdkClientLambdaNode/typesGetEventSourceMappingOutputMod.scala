...
object typesGetEventSourceMappingOutputMod {
  ...
  trait GetEventSourceMappingOutput
    extends StObject
  ...
  object GetEventSourceMappingOutput {
    ...
    inline def apply($metadata: ResponseMetadata): GetEventSourceMappingOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetEventSourceMappingOutput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: GetEventSourceMappingOutput] (val x: Self) extends AnyVal {
