package typings.awsSdkClientLambdaNode.typesUpdateFunctionCodeOutputMod
...
object UpdateFunctionCodeOutput {
  ...
  @scala.inline
  implicit class UpdateFunctionCodeOutputOps[Self <: UpdateFunctionCodeOutput] (val x: Self) extends AnyVal {
    @scala.inline
