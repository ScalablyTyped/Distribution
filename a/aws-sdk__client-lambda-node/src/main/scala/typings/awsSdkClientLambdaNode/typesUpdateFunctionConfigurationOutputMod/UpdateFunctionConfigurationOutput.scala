package typings.awsSdkClientLambdaNode.typesUpdateFunctionConfigurationOutputMod
...
object UpdateFunctionConfigurationOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata): UpdateFunctionConfigurationOutput = {
    val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpdateFunctionConfigurationOutput]
  }
  @scala.inline
  implicit class UpdateFunctionConfigurationOutputOps[Self <: UpdateFunctionConfigurationOutput] (val x: Self) extends AnyVal {
    @scala.inline
