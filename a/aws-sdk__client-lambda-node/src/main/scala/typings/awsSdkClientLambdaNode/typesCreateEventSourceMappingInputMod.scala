...
@JSImport("@aws-sdk/client-lambda-node/types/CreateEventSourceMappingInput", JSImport.Namespace)
@js.native
object typesCreateEventSourceMappingInputMod extends js.Object {
  @js.native
