...
@JSImport("@aws-sdk/client-lambda-node/types/PutFunctionConcurrencyExceptionsUnion", JSImport.Namespace)
@js.native
object putFunctionConcurrencyExceptionsUnionMod extends js.Object {
