package typings.awsSdkClientLambdaNode.typesDeleteFunctionOutputMod
...
object DeleteFunctionOutput {
  ...
  @scala.inline
  implicit class DeleteFunctionOutputOps[Self <: DeleteFunctionOutput] (val x: Self) extends AnyVal {
