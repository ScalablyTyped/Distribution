...
object mod {
  ...
  @js.native
  class GetAliasCommand protected ()
  ...
  @js.native
  class Lambda protected ()
    extends typings.awsSdkClientLambdaNode.lambdaMod.Lambda {
    def this(configuration: LambdaConfiguration) = this()
  }
  
  @JSImport("@aws-sdk/client-lambda-node", "LambdaClient")
  @js.native
  class LambdaClient protected ()
  ...
  @js.native
  class ListFunctionsCommand protected ()
