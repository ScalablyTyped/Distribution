...
object typesGetPolicyInputMod {
  ...
  @js.native
  trait GetPolicyInput extends _InputTypesUnion {
  ...
  object GetPolicyInput {
    ...
    @scala.inline
    def apply(FunctionName: String): GetPolicyInput = {
      val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetPolicyInput]
    }
    
    @scala.inline
    implicit class GetPolicyInputMutableBuilder[Self <: GetPolicyInput] (val x: Self) extends AnyVal {
