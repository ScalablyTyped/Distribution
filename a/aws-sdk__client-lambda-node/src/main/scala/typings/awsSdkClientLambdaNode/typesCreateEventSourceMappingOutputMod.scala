...
object typesCreateEventSourceMappingOutputMod {
  ...
  trait CreateEventSourceMappingOutput
    extends StObject
  ...
  object CreateEventSourceMappingOutput {
    ...
    inline def apply($metadata: ResponseMetadata): CreateEventSourceMappingOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[CreateEventSourceMappingOutput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CreateEventSourceMappingOutput] (val x: Self) extends AnyVal {
