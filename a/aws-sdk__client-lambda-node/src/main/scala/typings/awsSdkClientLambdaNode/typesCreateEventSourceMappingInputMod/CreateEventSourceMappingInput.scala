package typings.awsSdkClientLambdaNode.typesCreateEventSourceMappingInputMod
...
object CreateEventSourceMappingInput {
  ...
  implicit class CreateEventSourceMappingInputOps[Self <: CreateEventSourceMappingInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStartingPositionTimestamp(value: Date | String | Double): Self = this.set("StartingPositionTimestamp", value.asInstanceOf[js.Any])
