...
object typesPublishVersionOutputMod {
  ...
  object PublishVersionOutput {
    ...
    inline def apply($metadata: ResponseMetadata): PublishVersionOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[PublishVersionOutput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PublishVersionOutput] (val x: Self) extends AnyVal {
