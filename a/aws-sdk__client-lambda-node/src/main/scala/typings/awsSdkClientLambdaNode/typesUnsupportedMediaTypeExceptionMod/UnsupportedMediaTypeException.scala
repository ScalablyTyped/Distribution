...
object UnsupportedMediaTypeException {
  ...
  implicit class UnsupportedMediaTypeExceptionOps[Self <: UnsupportedMediaTypeException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.UnsupportedMediaTypeException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
}
