package typings.awsSdkClientLambdaNode.typesUpdateEventSourceMappingOutputMod
...
object UpdateEventSourceMappingOutput {
  ...
  @scala.inline
  implicit class UpdateEventSourceMappingOutputOps[Self <: UpdateEventSourceMappingOutput] (val x: Self) extends AnyVal {
