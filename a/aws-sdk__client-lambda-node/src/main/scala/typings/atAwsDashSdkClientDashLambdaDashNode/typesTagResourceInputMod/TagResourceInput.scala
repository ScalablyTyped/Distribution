package typings.atAwsDashSdkClientDashLambdaDashNode.typesTagResourceInputMod
...
object TagResourceInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Resource = Resource, Tags = Tags.asInstanceOf[js.Any])
