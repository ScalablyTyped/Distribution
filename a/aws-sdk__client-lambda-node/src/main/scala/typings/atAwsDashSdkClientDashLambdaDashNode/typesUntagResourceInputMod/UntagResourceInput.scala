package typings.atAwsDashSdkClientDashLambdaDashNode.typesUntagResourceInputMod
...
object UntagResourceInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Resource = Resource, TagKeys = TagKeys.asInstanceOf[js.Any])
