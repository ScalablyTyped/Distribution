...
object typesDeleteMessageBatchInputMod {
  ...
  trait DeleteMessageBatchInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Entries: js.Array[DeleteMessageBatchRequestEntry] | Iterable[DeleteMessageBatchRequestEntry] = js.native
  ...
  object DeleteMessageBatchInput {
    ...
    @scala.inline
    implicit class DeleteMessageBatchInputMutableBuilder[Self <: DeleteMessageBatchInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setEntries(value: js.Array[DeleteMessageBatchRequestEntry] | Iterable[DeleteMessageBatchRequestEntry]): Self = StObject.set(x, "Entries", value.asInstanceOf[js.Any])
