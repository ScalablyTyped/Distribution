package typings.awsSdkClientSqsNode.typesDeleteMessageInputMod
...
object DeleteMessageInput {
  
  @scala.inline
  def apply(QueueUrl: String, ReceiptHandle: String): DeleteMessageInput = {
    val __obj = js.Dynamic.literal(QueueUrl = QueueUrl.asInstanceOf[js.Any], ReceiptHandle = ReceiptHandle.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteMessageInput]
  }
  
  @scala.inline
  implicit class DeleteMessageInputOps[Self <: DeleteMessageInput] (val x: Self) extends AnyVal {
