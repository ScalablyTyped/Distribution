...
object modelMessageBodyAttributeMapMod {
  
  @JSImport("@aws-sdk/client-sqs-node/model/_MessageBodyAttributeMap", "_MessageBodyAttributeMap")
  @js.native
  val MessageBodyAttributeMap: Map[
