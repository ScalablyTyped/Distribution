package typings.awsSdkClientSqsNode.typesSetQueueAttributesOutputMod
...
object SetQueueAttributesOutput {
  ...
  @scala.inline
  implicit class SetQueueAttributesOutputOps[Self <: SetQueueAttributesOutput] (val x: Self) extends AnyVal {
    @scala.inline
