...
object SendMessageBatchInput {
  ...
  @scala.inline
  implicit class SendMessageBatchInputOps[Self <: SendMessageBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntries(value: js.Array[SendMessageBatchRequestEntry] | Iterable[SendMessageBatchRequestEntry]): Self = this.set("Entries", value.asInstanceOf[js.Any])
