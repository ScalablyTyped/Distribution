...
object typesDeleteMessageInputMod {
  
  trait DeleteMessageInput
    extends StObject
  ...
  object DeleteMessageInput {
    ...
    inline def apply(QueueUrl: String, ReceiptHandle: String): DeleteMessageInput = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DeleteMessageInput] (val x: Self) extends AnyVal {
