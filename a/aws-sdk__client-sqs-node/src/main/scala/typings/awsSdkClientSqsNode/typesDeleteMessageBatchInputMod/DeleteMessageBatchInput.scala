package typings.awsSdkClientSqsNode.typesDeleteMessageBatchInputMod
...
object DeleteMessageBatchInput {
  ...
  implicit class DeleteMessageBatchInputOps[Self <: DeleteMessageBatchInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntries(value: js.Array[DeleteMessageBatchRequestEntry] | Iterable[DeleteMessageBatchRequestEntry]): Self = this.set("Entries", value.asInstanceOf[js.Any])
