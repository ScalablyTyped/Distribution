...
object typesTagQueueInputMod {
  ...
  object TagQueueInput {
    ...
    @scala.inline
    def apply(QueueUrl: String, Tags: StringDictionary[String] | (Iterable[js.Tuple2[String, String]])): TagQueueInput = {
    ...
    @scala.inline
    implicit class TagQueueInputMutableBuilder[Self <: TagQueueInput] (val x: Self) extends AnyVal {
