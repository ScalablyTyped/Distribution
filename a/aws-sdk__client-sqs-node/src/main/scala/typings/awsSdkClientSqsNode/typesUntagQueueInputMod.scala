...
object typesUntagQueueInputMod {
  
  trait UntagQueueInput
    extends StObject
  ...
  object UntagQueueInput {
    ...
    @scala.inline
    def apply(QueueUrl: String, TagKeys: js.Array[String] | Iterable[String]): UntagQueueInput = {
    ...
    @scala.inline
    implicit class UntagQueueInputMutableBuilder[Self <: UntagQueueInput] (val x: Self) extends AnyVal {
