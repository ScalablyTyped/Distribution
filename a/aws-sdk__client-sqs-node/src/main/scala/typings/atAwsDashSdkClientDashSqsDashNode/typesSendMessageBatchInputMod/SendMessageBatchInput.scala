package typings.atAwsDashSdkClientDashSqsDashNode.typesSendMessageBatchInputMod

import typings.atAwsDashSdkClientDashSqsDashNode.typesInputTypesUnionMod.InputTypesUnion
import typings.atAwsDashSdkClientDashSqsDashNode.typesUnderscoreSendMessageBatchRequestEntryMod._SendMessageBatchRequestEntry
...
trait SendMessageBatchInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var Entries: js.Array[_SendMessageBatchRequestEntry] | Iterable[_SendMessageBatchRequestEntry]
  /**
...
object SendMessageBatchInput {
  @scala.inline
  def apply(
    Entries: js.Array[_SendMessageBatchRequestEntry] | Iterable[_SendMessageBatchRequestEntry],
    QueueUrl: String,
