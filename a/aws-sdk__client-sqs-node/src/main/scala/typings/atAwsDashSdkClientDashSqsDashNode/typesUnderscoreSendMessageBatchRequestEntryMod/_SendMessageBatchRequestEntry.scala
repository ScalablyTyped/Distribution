...
trait _SendMessageBatchRequestEntry extends js.Object {
  /**
...
object _SendMessageBatchRequestEntry {
  @scala.inline
  def apply(
    Id: String,
    MessageBody: String,
    ...
    __obj.asInstanceOf[_SendMessageBatchRequestEntry]
  }
}
