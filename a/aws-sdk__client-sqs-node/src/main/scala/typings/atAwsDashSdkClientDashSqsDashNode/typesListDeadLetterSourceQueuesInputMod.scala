...
@JSImport("@aws-sdk/client-sqs-node/types/ListDeadLetterSourceQueuesInput", JSImport.Namespace)
@js.native
object typesListDeadLetterSourceQueuesInputMod extends js.Object {
  @js.native
