package typings.atAwsDashSdkClientDashSqsDashNode.typesChangeMessageVisibilityBatchInputMod
...
trait ChangeMessageVisibilityBatchInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var Entries: js.Array[_ChangeMessageVisibilityBatchRequestEntry] | Iterable[_ChangeMessageVisibilityBatchRequestEntry]
  /**
...
object ChangeMessageVisibilityBatchInput {
  @scala.inline
  def apply(
    Entries: js.Array[_ChangeMessageVisibilityBatchRequestEntry] | Iterable[_ChangeMessageVisibilityBatchRequestEntry],
    QueueUrl: String,
