...
@JSImport("@aws-sdk/client-sqs-node/types/DeleteQueueInput", JSImport.Namespace)
@js.native
object typesDeleteQueueInputMod extends js.Object {
  @js.native
  trait DeleteQueueInput extends InputTypesUnion {
    /**
