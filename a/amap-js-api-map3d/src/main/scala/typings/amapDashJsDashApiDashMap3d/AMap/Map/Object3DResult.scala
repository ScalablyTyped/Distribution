package typings.amapDashJsDashApiDashMap3d.AMap.Map

import typings.amapDashJsDashApiDashMap3d.AMap.Object3D
import typings.amapDashJsDashApiDashMap3d.AMap.Vector3
