...
version := "2.11.0-53dde6"
scalaVersion := "2.13.1"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-ead483",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.9.0-0cd192",
  "org.scalablytyped" %%% "apollo-datasource" % "0.7.0-704585",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.7.0-ab2aa8",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.11.0-82a1d6",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.3-8c5447",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.4.0-6442f5",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.7.0-c68c3d",
  "org.scalablytyped" %%% "apollo-server-types" % "0.3.0-fbba4b",
  "org.scalablytyped" %%% "apollo__protobufjs" % "1.0.3-42037c",
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.4.4-63dcc1",
  ...
  "org.scalablytyped" %%% "graphql-upload" % "8.0-dt-20190826Z-4946fd",
