...
version := "2.9.3-35d481"
scalaVersion := "2.12.9"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-7abcc9",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.8.4-6c5c85",
  "org.scalablytyped" %%% "apollo-datasource" % "0.6.3-9400c3",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.4.6-ed836b",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.9.3-8783d5",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.3-3c8fde",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.3.3-f0e4b4",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.6.4-632a5d",
  ...
  "org.scalablytyped" %%% "graphql-upload" % "8.0-dt-20190826Z-3d72f7",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-d28d11",
