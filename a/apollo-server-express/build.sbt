...
version := "2.9.3-433445"
scalaVersion := "2.12.9"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-7abcc9",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.8.4-a8d278",
  "org.scalablytyped" %%% "apollo-datasource" % "0.6.3-9400c3",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.4.6-01151e",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.9.3-2d0106",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.3-3c8fde",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.3.3-134d59",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.6.4-3a30be",
  "org.scalablytyped" %%% "apollo-server-types" % "0.2.4-3e6173",
  "org.scalablytyped" %%% "apollographql__apollo-tools" % "0.4.0-a42b61",
  ...
  "org.scalablytyped" %%% "graphql-tools" % "4.0.5-f85f74",
  "org.scalablytyped" %%% "graphql-upload" % "8.0-dt-20190826Z-460d32",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-5bad09",
