...
version := "2.9.12-61e6fc"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-8db10b",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.8.8-305334",
  "org.scalablytyped" %%% "apollo-datasource" % "0.6.3-280073",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.4.10-7fe778",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.9.12-a379ce",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.3-a66fbd",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.3.4-63cfbc",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.6.8-892f34",
  ...
  "org.scalablytyped" %%% "fs-capacitor" % "2.0-dt-20190509Z-887560",
  "org.scalablytyped" %%% "graphql" % "14.5.8-933f73",
  "org.scalablytyped" %%% "graphql-extensions" % "0.10.7-ba66f3",
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.1.0-ba927c",
  "org.scalablytyped" %%% "graphql-tools" % "4.0.6-ca9fe0",
  "org.scalablytyped" %%% "graphql-upload" % "8.0-dt-20190826Z-1895ee",
