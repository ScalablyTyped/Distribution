...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "apollo-cache-control" % "0.5.0-f1d280",
  "org.scalablytyped" %%% "apollo-datasource" % "0.3.0-9a9163",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.0.0-ab8343",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.4.0-8472dc",
  ...
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.0.0-f09bb9",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.15-f98e43",
  "org.scalablytyped" %%% "symbol-observable" % "1.2.0-31ba1a",
  "org.scalablytyped" %%% "tslib" % "1.9.3-2d26d9",
  "org.scalablytyped" %%% "type-is" % "1.6-dt-20180214Z-279884",
