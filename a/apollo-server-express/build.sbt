...
version := "2.9.7-1aa7e1"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.scalablytyped" %%% "accepts" % "1.3-dt-20180214Z-028d87",
  "org.scalablytyped" %%% "apollo-cache-control" % "0.8.5-3207a5",
  "org.scalablytyped" %%% "apollo-datasource" % "0.6.3-2fbd77",
  "org.scalablytyped" %%% "apollo-engine-reporting" % "1.4.7-4a63ae",
  ...
  "org.scalablytyped" %%% "apollo-server-core" % "2.9.7-3548b6",
  "org.scalablytyped" %%% "apollo-server-env" % "2.4.3-c3dce0",
  "org.scalablytyped" %%% "apollo-server-errors" % "2.3.4-984ae3",
  "org.scalablytyped" %%% "apollo-server-plugin-base" % "0.6.5-557809",
  ...
  "org.scalablytyped" %%% "fs-capacitor" % "2.0-dt-20190509Z-f5465c",
  "org.scalablytyped" %%% "graphql" % "14.5.8-9a82b3",
  "org.scalablytyped" %%% "graphql-extensions" % "0.10.4-28266d",
  "org.scalablytyped" %%% "graphql-subscriptions" % "1.1.0-11b384",
  "org.scalablytyped" %%% "graphql-tools" % "4.0.6-0f879c",
  "org.scalablytyped" %%% "graphql-upload" % "8.0-dt-20190826Z-4091fa",
  ...
  "org.scalablytyped" %%% "subscriptions-transport-ws" % "0.9.16-056c3d",
