...
object acornNumbers {
  ...
  @js.native
  sealed trait `2015` extends StObject
  @scala.inline
  def `2015`: `2015` = 2015.asInstanceOf[`2015`]
  
  @js.native
  sealed trait `2016` extends StObject
  @scala.inline
  def `2016`: `2016` = 2016.asInstanceOf[`2016`]
  
  @js.native
  sealed trait `2017` extends StObject
  @scala.inline
  def `2017`: `2017` = 2017.asInstanceOf[`2017`]
  
  @js.native
  sealed trait `2018` extends StObject
  @scala.inline
  def `2018`: `2018` = 2018.asInstanceOf[`2018`]
  
  @js.native
  sealed trait `2019` extends StObject
  @scala.inline
