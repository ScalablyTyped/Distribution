...
trait Options extends js.Object {
  ...
  var onComment: js.UndefOr[
    (js.Function6[
      ...
      /* start */ Double, 
      /* end */ Double, 
      /* startLoc */ js.UndefOr[typings.estree.mod.Position], 
      /* endLoc */ js.UndefOr[typings.estree.mod.Position], 
      Unit
    ]) | js.Array[Comment]
  ] = js.undefined
  var onInsertedSemicolon: js.UndefOr[
    js.Function2[
      /* lastTokEnd */ Double, 
      /* lastTokEndLoc */ js.UndefOr[typings.estree.mod.Position], 
      Unit
    ]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    onInsertedSemicolon: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typings.estree.mod.Position]) => Unit = null,
    onToken: (js.Function1[/* token */ Token, _]) | js.Array[Token] = null,
    onTrailingComma: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typings.estree.mod.Position]) => Unit = null,
    ...
    if (!js.isUndefined(allowHashBang)) __obj.updateDynamic("allowHashBang")(allowHashBang.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(preserveParens)) __obj.updateDynamic("preserveParens")(preserveParens.get.asInstanceOf[js.Any])
