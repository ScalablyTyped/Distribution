...
trait AQLfunctions extends Expression {
  ...
  /**
       ...
       *
       */
  def fn(functionName: java.lang.String): js.Function1[/* repeated */js.Any, FunctionCall] = js.native
  /**
       * Ternary(if / else)
       *
       ...
       *
       */
  def `if`(cond: js.Any, `then`: js.Any, otherwise: js.Any): Expression | scala.Double = js.native
  /**
       * Integer
       *
  ...
  /**
       ...
       *
       */
  def ref(value: java.lang.String): SimpleReference = js.native
  /**
       * String
       *
