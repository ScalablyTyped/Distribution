...
trait Hotkey extends js.Object {
  ...
  /**
    ...
    */
  def callback(event: Event, hotkey: typings.angularDashHotkeys.angularDashHotkeysMod.angularMod.hotkeysNs.Hotkey): Unit
}

object Hotkey {
  @scala.inline
  def apply(
    callback: (Event, typings.angularDashHotkeys.angularDashHotkeysMod.angularMod.hotkeysNs.Hotkey) => Unit,
