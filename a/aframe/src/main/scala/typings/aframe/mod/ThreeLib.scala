...
trait ThreeLib extends StObject {
  ...
  var AudioAnalyser: Instantiable1[/* audio */ Audio[AudioNode], typings.three.mod.AudioAnalyser] = js.native
  ...
  var DataTexture2DArray: Instantiable4[
    ...
    /* height */ Double, 
    /* depth */ Double, 
    typings.three.mod.DataTexture2DArray
  ] = js.native
  ...
  var ExtrudeBufferGeometry: Instantiable1[/* shapes */ Shape, typings.three.mod.ExtrudeBufferGeometry] = js.native
  
  var ExtrudeGeometry: Instantiable1[/* shapes */ Shape, typings.three.mod.ExtrudeGeometry] = js.native
  ...
  var InstancedMesh: Instantiable3[
    ...
    /* count */ Double, 
    typings.three.mod.InstancedMesh[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  ...
  var Line: Instantiable0[
    typings.three.mod.Line[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  ...
  var LineLoop: Instantiable0[
    typings.three.mod.LineLoop[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  
  val LinePieces: Double = js.native
  
  var LineSegments: Instantiable0[
    typings.three.mod.LineSegments[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  ...
  var Mesh: Instantiable0[
    typings.three.mod.Mesh[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  ...
  var SkinnedMesh: Instantiable0[
    typings.three.mod.SkinnedMesh[typings.three.geometryMod.Geometry | BufferGeometry, Material | js.Array[Material]]
  ] = js.native
  ...
  var WebGLClipping: Instantiable1[/* properties */ WebGLProperties, typings.three.mod.WebGLClipping] = js.native
  ...
  var WebXRController: Instantiable0[typings.three.mod.WebXRController] = js.native
  
  var WebXRManager: Instantiable2[
    /* renderer */ js.Any, 
    /* gl */ WebGLRenderingContext, 
    typings.three.mod.WebXRManager
  ] = js.native
  ...
  var XRRay: Instantiable1[/* transformOrOrigin */ XRRigidTransform, typings.three.mod.XRRay] = js.native
  
  var XRRigidTransform: Instantiable1[/* matrix */ Float32Array, typings.three.mod.XRRigidTransform] = js.native
  
  var XRWebGLLayer: Instantiable1[/* session */ XRSession, typings.three.mod.XRWebGLLayer] = js.native
