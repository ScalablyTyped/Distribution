...
object ComponentDescriptor {
  @scala.inline
  def apply[/* <: typings.aframe.mod.Component[_, typings.aframe.mod.System[_]] */ T](Component: ComponentConstructor[T]): ComponentDescriptor[T] = {
    val __obj = js.Dynamic.literal(Component = Component.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComponentDescriptor[T]]
  }
  @scala.inline
  implicit class ComponentDescriptorOps[Self <: ComponentDescriptor[_], /* <: typings.aframe.mod.Component[_, typings.aframe.mod.System[_]] */ T] (val x: Self with ComponentDescriptor[T]) extends AnyVal {
    @scala.inline
