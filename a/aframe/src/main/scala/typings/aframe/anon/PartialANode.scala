...
object PartialANode {
  ...
  def apply(
    ...
    addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PartialANode, /* ev */ Event, _]) => Unit = null,
    ...
    attachMixinListener: /* mixin */ HTMLElement => Unit = null,
    ...
    cloneNode: () => Node = null,
    closest: /* selector */ String => ANode = null,
    closestScene: () => Scene = null,
    ...
    emit: (/* name */ String, /* detail */ js.UndefOr[js.Any], /* bubbles */ js.UndefOr[Boolean]) => Unit = null,
    emitter: (/* name */ String, /* detail */ js.UndefOr[js.Any], /* bubbles */ js.UndefOr[Boolean]) => js.Function0[Unit] = null,
    ...
    load: (/* cb */ js.UndefOr[js.Function0[Unit]], /* childFilter */ js.UndefOr[js.Function1[/* el */ Element, Boolean]]) => Unit = null,
    ...
    oncancel: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    oncanplay: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    oncanplaythrough: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onchange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onclick: js.ThisFunction1[PartialANode, /* ev */ MouseEvent, _] = null,
    onclose: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    oncuechange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    ondragexit: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    ondurationchange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onemptied: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onended: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onerror: js.UndefOr[
    ...
    onfullscreenchange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onfullscreenerror: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ongotpointercapture: js.ThisFunction1[PartialANode, /* ev */ PointerEvent, _] = null,
    oninput: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    oninvalid: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    onload: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onloadeddata: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onloadedmetadata: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onloadstart: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    onpause: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onplay: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onplaying: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    onprogress: js.ThisFunction1[PartialANode, /* ev */ ProgressEvent[EventTarget], _] = null,
    onratechange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onreset: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onresize: js.ThisFunction1[PartialANode, /* ev */ UIEvent, _] = null,
    onscroll: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onsecuritypolicyviolation: js.ThisFunction1[PartialANode, /* ev */ SecurityPolicyViolationEvent, _] = null,
    onseeked: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onseeking: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onselect: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onselectionchange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onselectstart: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onstalled: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onsubmit: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onsuspend: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ontimeupdate: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ontoggle: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    onvolumechange: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    onwaiting: js.ThisFunction1[PartialANode, /* ev */ Event, _] = null,
    ...
    registerMixin: /* id */ String => Unit = null,
    ...
    removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[PartialANode, /* ev */ Event, _]) => Unit = null,
    removeMixinListener: /* id */ String => Unit = null,
    ...
    setAttribute: (/* type */ String, /* newValue */ js.Any) => Unit = null,
    ...
    unregisterMixin: /* id */ String => Unit = null,
    ...
    if (attachMixinListener != null) __obj.updateDynamic("attachMixinListener")(js.Any.fromFunction1(attachMixinListener))
    ...
    if (closestScene != null) __obj.updateDynamic("closestScene")(js.Any.fromFunction0(closestScene))
    ...
    if (emit != null) __obj.updateDynamic("emit")(js.Any.fromFunction3(emit))
    if (emitter != null) __obj.updateDynamic("emitter")(js.Any.fromFunction3(emitter))
    ...
    if (!js.isUndefined(hasLoaded)) __obj.updateDynamic("hasLoaded")(hasLoaded.get.asInstanceOf[js.Any])
    ...
    if (registerMixin != null) __obj.updateDynamic("registerMixin")(js.Any.fromFunction1(registerMixin))
    ...
    if (removeMixinListener != null) __obj.updateDynamic("removeMixinListener")(js.Any.fromFunction1(removeMixinListener))
    ...
    if (unregisterMixin != null) __obj.updateDynamic("unregisterMixin")(js.Any.fromFunction1(unregisterMixin))
