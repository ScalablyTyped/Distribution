...
import typings.aframe.aframeInts.`0x01`
import typings.aframe.aframeInts.`0x02`
import typings.aframe.aframeInts.`0x04`
import typings.aframe.aframeInts.`0x08`
import typings.aframe.aframeInts.`0x10`
import typings.aframe.aframeInts.`0x20`
import typings.aframe.aframeInts.`10`
import typings.aframe.aframeInts.`11`
import typings.aframe.aframeInts.`12`
...
import typings.aframe.aframeInts.`8`
import typings.aframe.aframeInts.`9`
...
object PartialANode {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialANode] (val x: Self) extends AnyVal {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PartialANode, /* ev */ Event, Any]) => Unit
    ...
    inline def setEmit(
      value: (/* name */ String, /* detail */ js.UndefOr[Any], /* bubbles */ js.UndefOr[Boolean]) => Unit
    ...
    inline def setOnbeforeinput(value: js.ThisFunction1[PartialANode, /* ev */ InputEvent, Any]): Self = StObject.set(x, "onbeforeinput", value.asInstanceOf[js.Any])
    ...
    inline def setOncancel(value: js.ThisFunction1[PartialANode, /* ev */ Event, Any]): Self = StObject.set(x, "oncancel", value.asInstanceOf[js.Any])
    ...
    inline def setOnprogress(value: js.ThisFunction1[PartialANode, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
    ...
    inline def setSetAttribute(value: (/* type */ String, /* newValue */ Any) => Unit): Self = StObject.set(x, "setAttribute", js.Any.fromFunction2(value))
