...
import typings.aframe.aframeMod.ThreeLib
import typings.aframe.aframeMod.TweenLib
import typings.aframe.aframeMod.Utils
...
object AFRAMENs extends js.Object {
  ...
  val ANode: typings.aframe.aframeMod.ANode = js.native
  ...
  val registerElement: js.Function2[/* name */ String, /* element */ js.Object, Unit] = js.native
  val registerGeometry: js.Function2[
    /* name */ String, 
    /* geometry */ GeometryDefinition[js.Object, js.Any], 
    GeometryConstructor[js.Object]
  ] = js.native
  val registerPrimitive: js.Function2[/* name */ String, /* primitive */ PrimitiveDefinition, Unit] = js.native
  ...
  object TWEENNs extends js.Object {
    @js.native
    class Group ()
      extends typings.tweenDotJs.atTweenjsTweenDotJsMod.Group
    
    @js.native
    class Tween ()
      extends typings.tweenDotJs.atTweenjsTweenDotJsMod.Tween
