...
object arrayDashMoveMod extends js.Object {
  ...
  @JSName("default")
  var default_Original: arrayDashMoveLib.Anon_Array = js.native
  /**
  	...
  	```
  	*/
  def apply[ValueType](array: js.Array[ValueType], from: scala.Double, to: scala.Double): js.Array[ValueType] = js.native
  /**
  	Move an array item to a different position.
  	@param array - The array to move the item in.
  	@param from - Index of item to move. If negative, it will begin that many elements from the end.
  	...
  	*/
  // TODO: Remove this for the next major release
  def default[ValueType](array: js.Array[ValueType], from: scala.Double, to: scala.Double): js.Array[ValueType] = js.native
  /**
  	...
  	@param to - Index of where to move the item. If negative, it will begin that many elements from the end.
  	*/
  def mutate(array: js.Array[_], from: scala.Double, to: scala.Double): scala.Unit = js.native
}
