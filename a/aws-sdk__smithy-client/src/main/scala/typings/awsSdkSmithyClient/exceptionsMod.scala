...
import typings.awsSdkTypes.shapesMod.RetryableTrait
import typings.awsSdkTypes.shapesMod.SmithyException
...
object exceptionsMod {
  ...
  - typings.awsSdkTypes.shapesMod.SmithyException because var conflicts: name. Inlined $service, $fault, $retryable, $response */ @JSImport("@aws-sdk/smithy-client/dist-types/exceptions", "ServiceException")
  @js.native
