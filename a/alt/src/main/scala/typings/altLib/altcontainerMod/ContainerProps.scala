...
object ContainerProps {
  ...
  def apply(
    ...
    render: js.Function1[/* repeated */ js.Any, reactLib.reactMod.ReactNs.ReactElement[_]] = null,
    shouldComponentUpdate: js.Function1[/* props */ js.Any, scala.Boolean] = null,
    store: altLib.AltJSNs.AltStore[_] = null,
    stores: js.Array[altLib.AltJSNs.AltStore[_]] = null,
    transform: js.Function2[/* store */ altLib.AltJSNs.AltStore[_], /* actions */ js.Any, _] = null
  ): ContainerProps = {
