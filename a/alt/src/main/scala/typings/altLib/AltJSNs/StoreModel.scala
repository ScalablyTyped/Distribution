...
object StoreModel {
  @scala.inline
  def apply[S](
    afterEach: (/* payload */ js.Object, /* state */ js.Object) => scala.Unit = null,
    alt: Alt = null,
    beforeEach: (/* payload */ js.Object, /* state */ js.Object) => scala.Unit = null,
    bindAction: (/* action */ Action[_], /* handler */ ActionHandler) => scala.Unit = null,
    bindActions: /* actions */ ActionsClass => scala.Unit = null,
    bindListeners: /* config */ org.scalablytyped.runtime.StringDictionary[Action[_] | Actions] => scala.Unit = null,
    dispatcher: js.Any = null,
    displayName: java.lang.String = null,
    emitChange: () => scala.Unit = null,
    exportAsync: /* source */ Source => scala.Unit = null,
    exportPublicMethods: /* exportConfig */ js.Any => scala.Unit = null,
    getInstance: () => AltStore[S] = null,
    getState: () => S = null,
    observe: /* alt */ Alt => _ = null,
    on: (/* event */ lifeCycleEvents, /* callback */ js.Function0[_]) => scala.Unit = null,
    onDeserialize: /* fn */ js.Function1[/* data */ js.Any, _] => scala.Unit = null,
    onSerialize: /* fn */ js.Function1[/* data */ js.Any, _] => scala.Unit = null,
    otherwise: (/* data */ js.Any, /* action */ Action[_]) => scala.Unit = null,
    preventDefault: () => scala.Unit = null,
    reduce: (/* state */ js.Any, /* config */ StoreReduce) => js.Object = null,
    registerAsync: /* datasource */ Source => scala.Unit = null,
