...
object altContainerMod extends Shortcut {
  ...
  @js.native
  val ^ : ComponentClass[ContainerProps, ComponentState] = js.native
  ...
  object ContainerProps {
    ...
    implicit class ContainerPropsMutableBuilder[Self <: ContainerProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setComponent(value: Component[_, js.Object, _]): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
  ...
  type _To = ComponentClass[ContainerProps, ComponentState]
  
  /* This means you don't have to write `^`, but can instead just say `altContainerMod.foo` */
  override def _to: ComponentClass[ContainerProps, ComponentState] = ^
}
