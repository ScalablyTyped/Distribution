...
package object mod {
  ...
  @scala.inline
  def serializeQueryParameters(parameters: typings.std.Record[java.lang.String, _]): java.lang.String = typings.algoliaTransporter.mod.^.asInstanceOf[js.Dynamic].applyDynamic("serializeQueryParameters")(parameters.asInstanceOf[js.Any]).asInstanceOf[java.lang.String]
