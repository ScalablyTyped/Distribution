...
class TaskItem protected () extends js.Object {
  ...
  var DateCompleted: activexDashInteropLib.VarDate = js.native
  ...
  var DueDate: activexDashInteropLib.VarDate = js.native
  ...
  var StartDate: activexDashInteropLib.VarDate = js.native
