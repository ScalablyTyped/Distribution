...
class AppointmentItem protected () extends js.Object {
  ...
  var EndInEndTimeZone: stdLib.VarDate = js.native
  var EndTimeZone: TimeZone = js.native
  var EndUTC: stdLib.VarDate = js.native
  ...
  var ReplyTime: stdLib.VarDate = js.native
  ...
  var StartInStartTimeZone: stdLib.VarDate = js.native
  var StartTimeZone: TimeZone = js.native
  var StartUTC: stdLib.VarDate = js.native
