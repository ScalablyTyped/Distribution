...
trait AnonCancelClipboardContent extends js.Object {
  var Cancel: Boolean
  val ClipboardContent: js.Any
  val Target: Folder
}

object AnonCancelClipboardContent {
  @scala.inline
  def apply(Cancel: Boolean, ClipboardContent: js.Any, Target: Folder): AnonCancelClipboardContent = {
    ...
    __obj.asInstanceOf[AnonCancelClipboardContent]
  }
}
