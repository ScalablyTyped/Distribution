...
class RuleConditions protected ()
  extends typings.activexOutlook.Outlook.RuleConditions {
  /* CompleteClass */
  ...
  override var OutlookDotRuleConditions_typekey: typings.activexOutlook.Outlook.RuleConditions = js.native
  /* CompleteClass */
