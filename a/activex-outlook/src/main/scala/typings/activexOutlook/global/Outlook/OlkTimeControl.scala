...
class OlkTimeControl protected ()
  extends typings.activexOutlook.Outlook.OlkTimeControl {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var IntervalTime: VarDate = js.native
  /* CompleteClass */
  ...
  override var OutlookDotOlkTimeControl_typekey: typings.activexOutlook.Outlook.OlkTimeControl = js.native
  /* CompleteClass */
  override var ReferenceTime: VarDate = js.native
  /* CompleteClass */
  override var Style: OlTimeStyle = js.native
  /* CompleteClass */
  override var Text: String = js.native
  /* CompleteClass */
  override var TextAlign: OlTextAlign = js.native
  /* CompleteClass */
  override var Time: VarDate = js.native
  /* CompleteClass */
