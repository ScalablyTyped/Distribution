...
/* private */ class OutlookBarPane ()
  ...
  /* CompleteClass */
  override val Contents: typings.activexOutlook.Outlook.OutlookBarStorage = js.native
  
  /* CompleteClass */
  var CurrentGroup: typings.activexOutlook.Outlook.OutlookBarGroup = js.native
