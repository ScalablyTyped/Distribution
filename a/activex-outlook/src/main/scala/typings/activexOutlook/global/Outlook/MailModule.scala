...
@JSGlobal("Outlook.MailModule")
@js.native
class MailModule protected ()
  extends StObject
     with typings.activexOutlook.Outlook.MailModule {
  ...
  var OutlookDotMailModule_typekey: typings.activexOutlook.Outlook.MailModule = js.native
