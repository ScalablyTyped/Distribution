...
@js.native
/* private */ open class NavigationFolder ()
  extends StObject
     with typings.activexOutlook.Outlook.NavigationFolder {
  ...
  var OutlookDotNavigationFolder_typekey: typings.activexOutlook.Outlook.NavigationFolder = js.native
