...
@js.native
/* private */ open class TasksModule ()
  extends StObject
     with typings.activexOutlook.Outlook.TasksModule {
  ...
  var OutlookDotTasksModule_typekey: typings.activexOutlook.Outlook.TasksModule = js.native
