...
class OlkTextBox protected ()
  ...
  var OutlookDotOlkTextBox_typekey: typings.activexOutlook.Outlook.OlkTextBox = js.native
  ...
  /* CompleteClass */
  override val SelText: String = js.native
