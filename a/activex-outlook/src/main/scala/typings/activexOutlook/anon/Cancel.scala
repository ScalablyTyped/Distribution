...
trait Cancel extends js.Object {
  ...
  val FolderToShare: typings.activexOutlook.Outlook.Folder = js.native
}
...
object Cancel {
  ...
  implicit class CancelOps[Self <: Cancel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFolderToShare(value: typings.activexOutlook.Outlook.Folder): Self = this.set("FolderToShare", value.asInstanceOf[js.Any])
  }
