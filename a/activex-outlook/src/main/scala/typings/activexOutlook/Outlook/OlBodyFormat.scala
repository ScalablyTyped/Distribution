...
object OlBodyFormat {
  @scala.inline
  def olFormatHTML: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def olFormatPlain: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def olFormatRichText: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def olFormatUnspecified: `0` = 0.asInstanceOf[`0`]
}
