...
*/
trait OlInspectorClose extends StObject
object OlInspectorClose {
  
  inline def olDiscard: `1` = 1.asInstanceOf[`1`]
  
  inline def olPromptForSave: `2` = 2.asInstanceOf[`2`]
  
  inline def olSave: `0` = 0.asInstanceOf[`0`]
}
