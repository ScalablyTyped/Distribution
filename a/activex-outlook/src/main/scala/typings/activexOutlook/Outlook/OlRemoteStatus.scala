...
*/
trait OlRemoteStatus extends StObject
object OlRemoteStatus {
  
  inline def olMarkedForCopy: `3` = 3.asInstanceOf[`3`]
  
  inline def olMarkedForDelete: `4` = 4.asInstanceOf[`4`]
  
  inline def olMarkedForDownload: `2` = 2.asInstanceOf[`2`]
  
  inline def olRemoteStatusNone: `0` = 0.asInstanceOf[`0`]
  
  inline def olUnMarked: `1` = 1.asInstanceOf[`1`]
}
