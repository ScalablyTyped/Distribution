...
object OlEditorType {
  ...
  inline def olEditorHTML: `2` = 2.asInstanceOf[`2`]
  
  inline def olEditorRTF: `3` = 3.asInstanceOf[`3`]
  
  inline def olEditorText: `1` = 1.asInstanceOf[`1`]
  
  inline def olEditorWord: `4` = 4.asInstanceOf[`4`]
}
