...
object OlFlagIcon {
  ...
  inline def olBlueFlagIcon: `5` = 5.asInstanceOf[`5`]
  
  inline def olGreenFlagIcon: `3` = 3.asInstanceOf[`3`]
  
  inline def olNoFlagIcon: `0` = 0.asInstanceOf[`0`]
  
  inline def olOrangeFlagIcon: `2` = 2.asInstanceOf[`2`]
  
  inline def olPurpleFlagIcon: `1` = 1.asInstanceOf[`1`]
  
  inline def olRedFlagIcon: `6` = 6.asInstanceOf[`6`]
  
  inline def olYellowFlagIcon: `4` = 4.asInstanceOf[`4`]
}
