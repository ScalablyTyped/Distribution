...
object OlFormatInteger {
  ...
  inline def olFormatIntegerComputer1: `2` = 2.asInstanceOf[`2`]
  
  inline def olFormatIntegerComputer2: `3` = 3.asInstanceOf[`3`]
  
  inline def olFormatIntegerComputer3: `4` = 4.asInstanceOf[`4`]
  
  inline def olFormatIntegerPlain: `1` = 1.asInstanceOf[`1`]
}
