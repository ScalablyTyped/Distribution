...
*/
trait OlTrackingStatus extends StObject
object OlTrackingStatus {
  
  inline def olTrackingDelivered: `1` = 1.asInstanceOf[`1`]
  
  inline def olTrackingNone: `0` = 0.asInstanceOf[`0`]
  
  inline def olTrackingNotDelivered: `2` = 2.asInstanceOf[`2`]
  
  inline def olTrackingNotRead: `3` = 3.asInstanceOf[`3`]
  
  inline def olTrackingRead: `6` = 6.asInstanceOf[`6`]
  
  inline def olTrackingRecallFailure: `4` = 4.asInstanceOf[`4`]
  
  inline def olTrackingRecallSuccess: `5` = 5.asInstanceOf[`5`]
  
  inline def olTrackingReplied: `7` = 7.asInstanceOf[`7`]
}
