...
object ContactsModule {
  ...
  @scala.inline
  implicit class ContactsModuleOps[Self <: ContactsModule] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setOutlookDotContactsModule_typekey(value: ContactsModule): Self = this.set("Outlook.ContactsModule_typekey", value.asInstanceOf[js.Any])
