...
*/
trait OlTaskStatus extends StObject
object OlTaskStatus {
  
  inline def olTaskComplete: `2` = 2.asInstanceOf[`2`]
  
  inline def olTaskDeferred: `4` = 4.asInstanceOf[`4`]
  
  inline def olTaskInProgress: `1` = 1.asInstanceOf[`1`]
  
  inline def olTaskNotStarted: `0` = 0.asInstanceOf[`0`]
  
  inline def olTaskWaiting: `3` = 3.asInstanceOf[`3`]
}
