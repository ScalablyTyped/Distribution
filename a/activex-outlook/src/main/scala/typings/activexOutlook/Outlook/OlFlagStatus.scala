...
*/
trait OlFlagStatus extends StObject
object OlFlagStatus {
  
  inline def olFlagComplete: `1` = 1.asInstanceOf[`1`]
  
  inline def olFlagMarked: `2` = 2.asInstanceOf[`2`]
  
  inline def olNoFlag: `0` = 0.asInstanceOf[`0`]
}
