...
*/
trait OlResponseStatus extends StObject
object OlResponseStatus {
  
  inline def olResponseAccepted: `3` = 3.asInstanceOf[`3`]
  
  inline def olResponseDeclined: `4` = 4.asInstanceOf[`4`]
  
  inline def olResponseNone: `0` = 0.asInstanceOf[`0`]
  
  inline def olResponseNotResponded: `5` = 5.asInstanceOf[`5`]
  
  inline def olResponseOrganized: `1` = 1.asInstanceOf[`1`]
  
  inline def olResponseTentative: `2` = 2.asInstanceOf[`2`]
}
