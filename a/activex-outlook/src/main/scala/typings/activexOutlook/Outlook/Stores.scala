...
object Stores {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Stores] (val x: Self) extends AnyVal {
    ...
    inline def setItem(value: Any => Store): Self = StObject.set(x, "Item", js.Any.fromFunction1(value))
