...
object OlCalendarViewMode {
  ...
  inline def olCalendarView5DayWeek: `4` = 4.asInstanceOf[`4`]
  
  inline def olCalendarViewDay: `0` = 0.asInstanceOf[`0`]
  
  inline def olCalendarViewMonth: `2` = 2.asInstanceOf[`2`]
  
  inline def olCalendarViewMultiDay: `3` = 3.asInstanceOf[`3`]
  
  inline def olCalendarViewWeek: `1` = 1.asInstanceOf[`1`]
}
