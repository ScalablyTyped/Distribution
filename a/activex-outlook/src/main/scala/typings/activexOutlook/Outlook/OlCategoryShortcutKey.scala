...
*/
trait OlCategoryShortcutKey extends StObject
object OlCategoryShortcutKey {
  
  inline def olCategoryShortcutKeyCtrlF10: `9` = 9.asInstanceOf[`9`]
  
  inline def olCategoryShortcutKeyCtrlF11: `10` = 10.asInstanceOf[`10`]
  
  inline def olCategoryShortcutKeyCtrlF12: `11` = 11.asInstanceOf[`11`]
  
  inline def olCategoryShortcutKeyCtrlF2: `1` = 1.asInstanceOf[`1`]
  
  inline def olCategoryShortcutKeyCtrlF3: `2` = 2.asInstanceOf[`2`]
  
  inline def olCategoryShortcutKeyCtrlF4: `3` = 3.asInstanceOf[`3`]
  
  inline def olCategoryShortcutKeyCtrlF5: `4` = 4.asInstanceOf[`4`]
  
  inline def olCategoryShortcutKeyCtrlF6: `5` = 5.asInstanceOf[`5`]
  
  inline def olCategoryShortcutKeyCtrlF7: `6` = 6.asInstanceOf[`6`]
  
  inline def olCategoryShortcutKeyCtrlF8: `7` = 7.asInstanceOf[`7`]
  
  inline def olCategoryShortcutKeyCtrlF9: `8` = 8.asInstanceOf[`8`]
  
  inline def olCategoryShortcutKeyNone: `0` = 0.asInstanceOf[`0`]
}
