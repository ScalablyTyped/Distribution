...
*/
trait OlFormRegistry extends StObject
object OlFormRegistry {
  
  inline def olDefaultRegistry: `0` = 0.asInstanceOf[`0`]
  
  inline def olFolderRegistry: `3` = 3.asInstanceOf[`3`]
  
  inline def olOrganizationRegistry: `4` = 4.asInstanceOf[`4`]
  
  inline def olPersonalRegistry: `2` = 2.asInstanceOf[`2`]
}
