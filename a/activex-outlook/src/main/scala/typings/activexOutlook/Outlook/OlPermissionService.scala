...
*/
trait OlPermissionService extends StObject
object OlPermissionService {
  
  inline def olPassport: `2` = 2.asInstanceOf[`2`]
  
  inline def olUnknown: `0` = 0.asInstanceOf[`0`]
  
  inline def olWindows: `1` = 1.asInstanceOf[`1`]
}
