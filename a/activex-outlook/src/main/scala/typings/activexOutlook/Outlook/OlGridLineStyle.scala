...
object OlGridLineStyle {
  ...
  @scala.inline
  def olGridLineDashes: `3` = this.cast(3)
  @scala.inline
  def olGridLineLargeDots: `2` = this.cast(2)
  @scala.inline
  def olGridLineNone: `0` = this.cast(0)
  @scala.inline
  def olGridLineSmallDots: `1` = this.cast(1)
  @scala.inline
  def olGridLineSolid: `4` = this.cast(4)
}
