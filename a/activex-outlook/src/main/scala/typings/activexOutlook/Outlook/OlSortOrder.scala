...
*/
trait OlSortOrder extends StObject
object OlSortOrder {
  
  inline def olAscending: `1` = 1.asInstanceOf[`1`]
  
  inline def olDescending: `2` = 2.asInstanceOf[`2`]
  
  inline def olSortNone: `0` = 0.asInstanceOf[`0`]
}
