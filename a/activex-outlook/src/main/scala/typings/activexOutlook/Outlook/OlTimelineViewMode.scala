...
*/
trait OlTimelineViewMode extends StObject
object OlTimelineViewMode {
  
  inline def olTimelineViewDay: `0` = 0.asInstanceOf[`0`]
  
  inline def olTimelineViewMonth: `2` = 2.asInstanceOf[`2`]
  
  inline def olTimelineViewWeek: `1` = 1.asInstanceOf[`1`]
}
