...
object OlRecurrenceState {
  ...
  inline def olApptException: `3` = 3.asInstanceOf[`3`]
  
  inline def olApptMaster: `1` = 1.asInstanceOf[`1`]
  
  inline def olApptNotRecurring: `0` = 0.asInstanceOf[`0`]
  
  inline def olApptOccurrence: `2` = 2.asInstanceOf[`2`]
}
