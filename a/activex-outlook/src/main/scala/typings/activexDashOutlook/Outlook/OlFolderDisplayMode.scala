...
*/
trait OlFolderDisplayMode extends js.Object

object OlFolderDisplayMode {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def olFolderDisplayFolderOnly: `1` = this.cast(1)
  @scala.inline
  def olFolderDisplayNoNavigation: `2` = this.cast(2)
  @scala.inline
  def olFolderDisplayNormal: `0` = this.cast(0)
}
