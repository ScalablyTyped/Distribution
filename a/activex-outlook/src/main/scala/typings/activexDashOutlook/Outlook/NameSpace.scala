...
class NameSpace protected () extends js.Object {
  val Accounts: typings.activexDashOutlook.Outlook.Accounts = js.native
  val AddressLists: typings.activexDashOutlook.Outlook.AddressLists = js.native
  ...
  val SyncObjects: typings.activexDashOutlook.Outlook.SyncObjects = js.native
