...
class DoNotUseMeFolder protected () extends js.Object {
  ...
  val Store: typings.activexDashOutlook.Outlook.Store = js.native
  val StoreID: String = js.native
  val UnReadItemCount: Double = js.native
  val UserDefinedProperties: typings.activexDashOutlook.Outlook.UserDefinedProperties = js.native
  val UserPermissions: js.Any = js.native
  val Views: typings.activexDashOutlook.Outlook.Views = js.native
