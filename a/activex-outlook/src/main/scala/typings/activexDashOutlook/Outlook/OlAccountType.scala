...
*/
trait OlAccountType extends js.Object

object OlAccountType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def olExchange: `0` = this.cast(0)
  @scala.inline
  def olHttp: `3` = this.cast(3)
  @scala.inline
  def olImap: `1` = this.cast(1)
  @scala.inline
  def olOtherAccount: `5` = this.cast(5)
  @scala.inline
  def olPop3: `2` = this.cast(2)
}
