...
*/
trait OlFormRegistry extends js.Object

object OlFormRegistry {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def olDefaultRegistry: `0` = this.cast(0)
  @scala.inline
  def olFolderRegistry: `3` = this.cast(3)
  @scala.inline
  def olOrganizationRegistry: `4` = this.cast(4)
  @scala.inline
  def olPersonalRegistry: `2` = this.cast(2)
}
