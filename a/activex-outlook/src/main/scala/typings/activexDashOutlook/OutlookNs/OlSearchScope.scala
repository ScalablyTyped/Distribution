...
*/
trait OlSearchScope extends js.Object

object OlSearchScope {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def olSearchScopeAllFolders: `1` = this.cast(1)
  @scala.inline
  def olSearchScopeAllOutlookItems: `2` = this.cast(2)
  @scala.inline
  def olSearchScopeCurrentFolder: `0` = this.cast(0)
  @scala.inline
  def olSearchScopeSubfolders: `3` = this.cast(3)
}
