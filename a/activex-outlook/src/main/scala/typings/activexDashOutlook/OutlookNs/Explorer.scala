...
class Explorer protected () extends js.Object {
  val AccountSelector: typings.activexDashOutlook.OutlookNs.AccountSelector = js.native
  ...
  val NavigationPane: typings.activexDashOutlook.OutlookNs.NavigationPane = js.native
  var `Outlook.Explorer_typekey`: Explorer = js.native
  val Panes: typings.activexDashOutlook.OutlookNs.Panes = js.native
  val Parent: js.Any = js.native
  val Selection: typings.activexDashOutlook.OutlookNs.Selection = js.native
