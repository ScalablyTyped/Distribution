...
class Application protected () extends js.Object {
  ...
  val Explorers: typings.activexDashOutlook.OutlookNs.Explorers = js.native
  ...
  val Inspectors: typings.activexDashOutlook.OutlookNs.Inspectors = js.native
  ...
  var `Outlook.Application_typekey`: typings.activexDashOutlook.OutlookNs.Application = js.native
  ...
  val Reminders: typings.activexDashOutlook.OutlookNs.Reminders = js.native
  val Session: NameSpace = js.native
  val TimeZones: typings.activexDashOutlook.OutlookNs.TimeZones = js.native
