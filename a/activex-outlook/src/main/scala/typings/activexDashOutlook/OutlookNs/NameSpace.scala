...
class NameSpace protected () extends js.Object {
  val Accounts: typings.activexDashOutlook.OutlookNs.Accounts = js.native
  val AddressLists: typings.activexDashOutlook.OutlookNs.AddressLists = js.native
  ...
  val Categories: typings.activexDashOutlook.OutlookNs.Categories = js.native
  ...
  val Stores: typings.activexDashOutlook.OutlookNs.Stores = js.native
  val SyncObjects: typings.activexDashOutlook.OutlookNs.SyncObjects = js.native
