...
class Folder protected () extends js.Object {
  ...
  val Folders: typings.activexDashOutlook.OutlookNs.Folders = js.native
  val FullFolderPath: String = js.native
  var InAppFolderSyncObject: Boolean = js.native
  val IsSharePointFolder: Boolean = js.native
  val Items: typings.activexDashOutlook.OutlookNs.Items = js.native
  ...
  val Store: typings.activexDashOutlook.OutlookNs.Store = js.native
  val StoreID: String = js.native
  val UnReadItemCount: Double = js.native
  val UserDefinedProperties: typings.activexDashOutlook.OutlookNs.UserDefinedProperties = js.native
  val UserPermissions: js.Any = js.native
  val Views: typings.activexDashOutlook.OutlookNs.Views = js.native
