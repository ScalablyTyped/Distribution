...
package object oauthconfigMod {
  type AuthorizationCodeGrantConfig = typings.authmosphere.oauthconfigMod.CredentialsConfig with typings.authmosphere.oauthconfigMod.GrantConfigBase with typings.authmosphere.AnonCode
  ...
  type RefreshGrantConfig = typings.authmosphere.oauthconfigMod.CredentialsConfig with typings.authmosphere.oauthconfigMod.GrantConfigBase with typings.authmosphere.AnonRefreshToken
  type TokenCacheOAuthConfig = (typings.authmosphere.oauthconfigMod.ClientCredentialsGrantConfig | typings.authmosphere.oauthconfigMod.PasswordCredentialsGrantConfig) with typings.authmosphere.AnonTokenInfoEndpoint
}
