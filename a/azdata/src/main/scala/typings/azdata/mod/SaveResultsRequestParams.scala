...
object SaveResultsRequestParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(formatted)) __obj.updateDynamic("formatted")(formatted.get.asInstanceOf[js.Any])
    if (!js.isUndefined(includeHeaders)) __obj.updateDynamic("includeHeaders")(includeHeaders.get.asInstanceOf[js.Any])
