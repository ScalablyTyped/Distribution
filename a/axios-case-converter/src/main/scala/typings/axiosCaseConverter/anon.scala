...
import typings.axios.mod.AxiosAdapterConfig
import typings.axios.mod.AxiosBasicCredentials
import typings.axios.mod.AxiosHeaders
import typings.axios.mod.AxiosInterceptorOptions
...
import typings.axios.mod.CustomParamsSerializer
...
import typings.axios.mod.MethodsHeaders
...
import typings.axiosCaseConverter.axiosCaseConverterBooleans.`false`
import typings.axiosCaseConverter.axiosCaseConverterInts.`4`
import typings.axiosCaseConverter.axiosCaseConverterInts.`6`
import typings.axiosCaseConverter.typingsTypesMod.AxiosRequestInterceptor
...
object anon {
  ...
  /* Inlined axios.axios.AxiosRequestConfig<any> & {  headers :axios.axios.AxiosRequestHeaders} */
  trait AxiosRequestConfiganyhead extends StObject {
  ...
  object AxiosRequestConfiganyhead {
    
    inline def apply(): AxiosRequestConfiganyhead = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[AxiosRequestConfiganyhead]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: AxiosRequestConfiganyhead] (val x: Self) extends AnyVal {
  ...
  @js.native
  trait FnCall[V] extends StObject {
    
    def apply(): Double = js.native
    def apply(onFulfilled: js.Function1[/* value */ V, V | js.Promise[V]]): Double = js.native
    def apply(
    ...
    def apply(onFulfilled: Null, onRejected: js.Function1[/* error */ Any, Any]): Double = js.native
    def apply(
      onFulfilled: Null,
      onRejected: js.Function1[/* error */ Any, Any],
      options: AxiosInterceptorOptions
    ): Double = js.native
    def apply(onFulfilled: Null, onRejected: Null, options: AxiosInterceptorOptions): Double = js.native
    def apply(onFulfilled: Null, onRejected: Unit, options: AxiosInterceptorOptions): Double = js.native
    def apply(onFulfilled: Unit, onRejected: js.Function1[/* error */ Any, Any]): Double = js.native
    def apply(
      onFulfilled: Unit,
      onRejected: js.Function1[/* error */ Any, Any],
      options: AxiosInterceptorOptions
    ): Double = js.native
    def apply(onFulfilled: Unit, onRejected: Null, options: AxiosInterceptorOptions): Double = js.native
    def apply(onFulfilled: Unit, onRejected: Unit, options: AxiosInterceptorOptions): Double = js.native
  }
  ...
  trait RequestInterceptor extends StObject {
    ...
    var requestInterceptor: js.UndefOr[AxiosRequestInterceptor] = js.undefined
  ...
  object RequestInterceptor {
    ...
    implicit open class MutableBuilder[Self <: RequestInterceptor] (val x: Self) extends AnyVal {
      ...
      inline def setRequestInterceptor(value: AxiosRequestInterceptor): Self = StObject.set(x, "requestInterceptor", value.asInstanceOf[js.Any])
