...
@JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo")
@js.native
/**
  * @param definition
...
open class MessageStreamInfo ()
  extends typings.awsGreengrassCoreSdk.dataMod.MessageStreamInfo {
...
object MessageStreamInfo {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo._exportStatuses")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo._storageStatus")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamInfo.validationsMap")
  @js.native
