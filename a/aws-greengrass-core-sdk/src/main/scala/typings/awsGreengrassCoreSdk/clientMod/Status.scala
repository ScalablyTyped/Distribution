...
@JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status")
@js.native
open class Status ()
  extends typings.awsGreengrassCoreSdk.dataMod.Status {
...
object Status {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.Canceled")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.Failure")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.InProgress")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.Success")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.Warning")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.options")
  @js.native
  def options: StatusOptions = js.native
  
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Status.optionsFlipped")
  @js.native
