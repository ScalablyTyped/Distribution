...
@JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamDefinition")
@js.native
open class MessageStreamDefinition protected ()
  extends typings.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition {
  /**
...
object MessageStreamDefinition {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamDefinition.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamDefinition.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "MessageStreamDefinition.validationsMap")
  @js.native
