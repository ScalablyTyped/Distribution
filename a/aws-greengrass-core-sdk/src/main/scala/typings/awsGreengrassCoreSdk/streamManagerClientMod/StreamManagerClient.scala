...
open class StreamManagerClient () extends StObject {
  ...
  /**
    ...
    * @returns
    */
  def createMessageStream(definition: typings.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition): js.Promise[Unit] = js.native
  ...
  /**
    ...
    * @returns
    */
  def describeMessageStream(streamName: String): js.Promise[typings.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamInfo] = js.native
  ...
  /**
    ...
    */
  def readMessages(streamName: String): js.Promise[js.Array[typings.awsGreengrassCoreSdk.streamManagerDataMod.Message]] = js.native
  def readMessages(streamName: String, options: typings.awsGreengrassCoreSdk.streamManagerDataMod.ReadMessagesOptions): js.Promise[js.Array[typings.awsGreengrassCoreSdk.streamManagerDataMod.Message]] = js.native
  ...
  /**
    ...
    * @returns
    */
  def updateMessageStream(definition: typings.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition): js.Promise[Unit] = js.native
}
