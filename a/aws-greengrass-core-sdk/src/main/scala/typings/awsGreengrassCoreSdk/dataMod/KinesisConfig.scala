...
@JSImport("aws-greengrass-core-sdk/stream-manager/data", "KinesisConfig")
@js.native
open class KinesisConfig protected ()
  extends StObject
     with StreamConfigBase[KinesisConfigMap] {
  /**
  ...
  /**
    ...
    * @returns
    */
  def kinesisStreamName: String | Null = js.native
  /**
    * @param value The name of the Kinesis data stream that this exporter should upload to.
    */
  def kinesisStreamName_=(value: String | Null): Unit = js.native
  ...
  /**
    ...
    * The batch size must be between 1 and 500.
    */
  def withBatchSize(): KinesisConfig = js.native
  def withBatchSize(value: Double): KinesisConfig = js.native
  
  /**
    * @param value The name of the Kinesis data stream that this exporter should upload to.
    * @returns
    */
  def withKinesisStreamName(): KinesisConfig = js.native
  def withKinesisStreamName(value: String): KinesisConfig = js.native
}
/* static members */
object KinesisConfig {
  ...
  inline def fromMap(d: KinesisConfigMap): KinesisConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[KinesisConfig]
}
