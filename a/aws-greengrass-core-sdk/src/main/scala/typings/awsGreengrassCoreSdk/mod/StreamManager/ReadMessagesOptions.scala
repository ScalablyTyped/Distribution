...
@JSImport("aws-greengrass-core-sdk", "StreamManager.ReadMessagesOptions")
@js.native
open class ReadMessagesOptions protected ()
  extends typings.awsGreengrassCoreSdk.streamManagerMod.ReadMessagesOptions {
  /**
...
object ReadMessagesOptions {
  ...
  @JSImport("aws-greengrass-core-sdk", "StreamManager.ReadMessagesOptions.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk", "StreamManager.ReadMessagesOptions.validationsMap")
  @js.native
