...
@JSImport("aws-greengrass-core-sdk/stream-manager", "StatusConfig")
@js.native
/**
...
open class StatusConfig ()
  extends typings.awsGreengrassCoreSdk.streamManagerClientMod.StatusConfig {
...
object StatusConfig {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "StatusConfig.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "StatusConfig.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "StatusConfig.validationsMap")
  @js.native
