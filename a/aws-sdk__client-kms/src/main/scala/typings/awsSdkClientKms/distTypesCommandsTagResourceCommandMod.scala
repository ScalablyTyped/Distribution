...
import typings.awsSdkClientKms.distTypesModelsModels0Mod.TagResourceRequest
...
object distTypesCommandsTagResourceCommandMod {
  ...
  @JSImport("@aws-sdk/client-kms/dist-types/commands/TagResourceCommand", "TagResourceCommand")
  @js.native
  open class TagResourceCommand protected () extends Command[TagResourceCommandInput, TagResourceCommandOutput, KMSClientResolvedConfig, Any, Any] {
    /**
      * @public
      */
  ...
  type TagResourceCommandInput = TagResourceRequest
