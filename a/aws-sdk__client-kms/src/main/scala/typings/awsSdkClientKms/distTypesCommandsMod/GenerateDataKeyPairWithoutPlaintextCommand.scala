...
@JSImport("@aws-sdk/client-kms/dist-types/commands", "GenerateDataKeyPairWithoutPlaintextCommand")
@js.native
open class GenerateDataKeyPairWithoutPlaintextCommand protected ()
  extends typings.awsSdkClientKms.distTypesCommandsGenerateDataKeyPairWithoutPlaintextCommandMod.GenerateDataKeyPairWithoutPlaintextCommand {
  /**
    * @public
    */
