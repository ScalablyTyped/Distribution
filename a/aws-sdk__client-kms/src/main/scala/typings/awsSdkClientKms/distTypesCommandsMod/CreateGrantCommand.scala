...
@JSImport("@aws-sdk/client-kms/dist-types/commands", "CreateGrantCommand")
@js.native
open class CreateGrantCommand protected ()
  extends typings.awsSdkClientKms.distTypesCommandsCreateGrantCommandMod.CreateGrantCommand {
  /**
    * @public
    */
