...
@JSImport("@aws-sdk/client-kms/dist-types/commands", "ListGrantsCommand")
@js.native
open class ListGrantsCommand protected ()
  extends typings.awsSdkClientKms.distTypesCommandsListGrantsCommandMod.ListGrantsCommand {
  /**
    * @public
    */
