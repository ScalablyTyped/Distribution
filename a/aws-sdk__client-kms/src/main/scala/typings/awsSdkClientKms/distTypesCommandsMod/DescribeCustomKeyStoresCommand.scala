...
@JSImport("@aws-sdk/client-kms/dist-types/commands", "DescribeCustomKeyStoresCommand")
@js.native
open class DescribeCustomKeyStoresCommand protected ()
  extends typings.awsSdkClientKms.distTypesCommandsDescribeCustomKeyStoresCommandMod.DescribeCustomKeyStoresCommand {
  /**
    * @public
    */
