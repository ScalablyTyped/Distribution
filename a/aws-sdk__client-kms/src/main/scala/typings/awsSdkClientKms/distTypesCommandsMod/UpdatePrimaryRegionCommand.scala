...
@JSImport("@aws-sdk/client-kms/dist-types/commands", "UpdatePrimaryRegionCommand")
@js.native
open class UpdatePrimaryRegionCommand protected ()
  extends typings.awsSdkClientKms.distTypesCommandsUpdatePrimaryRegionCommandMod.UpdatePrimaryRegionCommand {
  /**
    * @public
    */
