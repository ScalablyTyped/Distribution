...
/* Inlined @aws-sdk/smithy-client.@aws-sdk/smithy-client.ExceptionOptionType<@aws-sdk/client-kms.@aws-sdk/client-kms/dist-types/models/models_0.ExpiredImportTokenException, @aws-sdk/client-kms.@aws-sdk/client-kms/dist-types/models/KMSServiceException.KMSServiceException> */
