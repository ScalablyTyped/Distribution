...
/**
  ...
  */
@js.native
trait Webhooks extends Resource {
  /**
    ...
    * @return
    */
  def create(resource: scala.Double, target: java.lang.String, data: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def create(resource: scala.Double, target: java.lang.String, data: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  /**
    ...
    * @return
    */
  def deleteById(webhook: java.lang.String): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def deleteById(webhook: java.lang.String, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  /**
    ...
    * @return
    */
  def getAll(workspace: scala.Double): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def getAll(workspace: scala.Double, params: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def getAll(workspace: scala.Double, params: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  /**
    ...
    * @return
    */
  def getById(webhook: java.lang.String): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def getById(webhook: java.lang.String, params: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
  def getById(webhook: java.lang.String, params: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.namespaced[_] = js.native
}
