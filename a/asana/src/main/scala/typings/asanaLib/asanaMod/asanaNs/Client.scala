...
trait Client extends js.Object {
  /**
           ...
           */
  var app: asanaLib.asanaMod.asanaNs.authNs.App = js.native
  /**
           * An instance of the Attachments resource.
           * @type {Attachments}
           */
  var attachments: asanaLib.asanaMod.asanaNs.resourcesNs.Attachments = js.native
  /**
  ...
  /**
           ...
           * @type {Events}
           */
  var events: asanaLib.asanaMod.asanaNs.resourcesNs.Events = js.native
  /**
           * An instance of the Projects resource.
           * @type {Projects}
           */
  var projects: asanaLib.asanaMod.asanaNs.resourcesNs.Projects = js.native
  /**
           * An instance of the Stories resource.
           * @type {Stories}
           */
  var stories: asanaLib.asanaMod.asanaNs.resourcesNs.Stories = js.native
  /**
           * An instance of the Tags resource.
           * @type {Tags}
           */
  var tags: asanaLib.asanaMod.asanaNs.resourcesNs.Tags = js.native
  /**
           * An instance of the Tasks resource.
           * @type {Tasks}
           */
  var tasks: asanaLib.asanaMod.asanaNs.resourcesNs.Tasks = js.native
  /**
           * An instance of the Teams resource.
           * @type {Teams}
           */
  var teams: asanaLib.asanaMod.asanaNs.resourcesNs.Teams = js.native
  /**
           * An instance of the Users resource.
           * @type {Users}
           */
  var users: asanaLib.asanaMod.asanaNs.resourcesNs.Users = js.native
  /**
           * An instance of the Workspaces resource.
           * @type {Workspaces}
           */
  var workspaces: asanaLib.asanaMod.asanaNs.resourcesNs.Workspaces = js.native
  /**
           ...
           */
  def authorize(): bluebirdLib.bluebirdMod.namespaced[Client] = js.native
  /**
  ...
  /**
           ...
           * @return
           */
  def useOauth(options: asanaLib.asanaMod.asanaNs.authNs.OauthAuthenticatorOptions): this.type = js.native
}
