...
trait Dispatcher extends js.Object {
  ...
  /**
    ...
    * @return
    */
  def authorize(): bluebirdLib.bluebirdMod.^[scala.Unit] = js.native
  /**
    ...
    * @return
    */
  def delete(path: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def delete(path: java.lang.String, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def dispatch(params: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def dispatch(params: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def get(path: java.lang.String): bluebirdLib.bluebirdMod.^[_] = js.native
  def get(path: java.lang.String, query: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def get(path: java.lang.String, query: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @type {Function}
    */
  def handleUnauthorized(): scala.Boolean | bluebirdLib.bluebirdMod.^[scala.Boolean] = js.native
  /**
    ...
    * @return
    */
  def post(path: java.lang.String, data: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def post(path: java.lang.String, data: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def put(path: java.lang.String, data: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  def put(path: java.lang.String, data: js.Any, dispatchOptions: js.Any): bluebirdLib.bluebirdMod.^[_] = js.native
  /**
    ...
    * @return
    */
  def setAuthenticator(authenticator: asanaLib.asanaMod.authNs.Authenticator): this.type = js.native
  /**
