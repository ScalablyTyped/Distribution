...
trait DispatcherOptions extends js.Object {
  var authenticator: js.UndefOr[asanaLib.asanaMod.authNs.Authenticator] = js.undefined
  var handleUnauthorized: js.UndefOr[js.Function0[scala.Boolean | bluebirdLib.bluebirdMod.^[scala.Boolean]]] = js.undefined
...
object DispatcherOptions {
  @scala.inline
  def apply(
    authenticator: asanaLib.asanaMod.authNs.Authenticator = null,
    handleUnauthorized: () => scala.Boolean | bluebirdLib.bluebirdMod.^[scala.Boolean] = null,
