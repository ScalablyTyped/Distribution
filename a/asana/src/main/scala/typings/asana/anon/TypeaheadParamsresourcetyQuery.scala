...
object TypeaheadParamsresourcetyQuery {
  ...
  inline def apply(resource_type: String): TypeaheadParamsresourcetyQuery = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TypeaheadParamsresourcetyQuery] (val x: Self) extends AnyVal {
