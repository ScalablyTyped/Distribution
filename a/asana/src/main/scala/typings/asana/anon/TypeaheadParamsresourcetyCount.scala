...
import typings.asana.asanaStrings.project
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined asana.asana.resources.Typeahead.TypeaheadParams & {  resource_type :'project'} */
trait TypeaheadParamsresourcetyCount extends StObject {
  ...
  var resource_type: String & project
}
object TypeaheadParamsresourcetyCount {
  
  inline def apply(resource_type: String & project): TypeaheadParamsresourcetyCount = {
  ...
  extension [Self <: TypeaheadParamsresourcetyCount](x: Self) {
    ...
    inline def setResource_type(value: String & project): Self = StObject.set(x, "resource_type", value.asInstanceOf[js.Any])
  }
}
