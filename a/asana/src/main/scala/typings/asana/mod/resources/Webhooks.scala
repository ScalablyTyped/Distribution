...
class Webhooks protected () extends Resource {
  ...
  /**
    ...
    * @return
    */
  def create(resource: Double, target: String, data: js.Any): typings.bluebird.mod.^[_] = js.native
  def create(resource: Double, target: String, data: js.Any, dispatchOptions: js.Any): typings.bluebird.mod.^[_] = js.native
  /**
