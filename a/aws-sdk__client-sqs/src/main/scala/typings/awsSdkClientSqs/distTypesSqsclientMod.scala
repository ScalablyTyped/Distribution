...
object distTypesSqsclientMod {
  
  @JSImport("@aws-sdk/client-sqs/dist-types/SQSClient", "SQSClient")
  @js.native
  open class SQSClient protected () extends Client[HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, SQSClientResolvedConfig] {
  ...
  trait ClientDefaults extends StObject {
    ...
    /**
      ...
      * @internal
      */
    var md5: js.UndefOr[ChecksumConstructor | HashConstructor] = js.undefined
  ...
  type SQSClientConfig = SQSClientConfigType
  
  /**
    * @public
    */
  /* Inlined std.Partial<@aws-sdk/smithy-client.@aws-sdk/smithy-client.SmithyConfiguration<@aws-sdk/types.@aws-sdk/types.HttpHandlerOptions>> & @aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/SQSClient.ClientDefaults & @aws-sdk/config-resolver.@aws-sdk/config-resolver.RegionInputConfig & @aws-sdk/middleware-endpoint.@aws-sdk/middleware-endpoint.EndpointInputConfig<@aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/endpoint/EndpointParameters.EndpointParameters> & @aws-sdk/middleware-retry.@aws-sdk/middleware-retry.RetryInputConfig & @aws-sdk/middleware-host-header.@aws-sdk/middleware-host-header.HostHeaderInputConfig & @aws-sdk/middleware-signing.@aws-sdk/middleware-signing.AwsAuthInputConfig & @aws-sdk/middleware-user-agent.@aws-sdk/middleware-user-agent.UserAgentInputConfig & @aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/endpoint/EndpointParameters.ClientInputEndpointParameters */
  trait SQSClientConfigType extends StObject {
  ...
  object SQSClientConfigType {
    
    inline def apply(): SQSClientConfigType = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SQSClientConfigType]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: SQSClientConfigType] (val x: Self) extends AnyVal {
  ...
  type SQSClientResolvedConfig = SQSClientResolvedConfigType
  
  /**
    * @public
    */
  /* Inlined @aws-sdk/smithy-client.@aws-sdk/smithy-client.SmithyResolvedConfiguration<@aws-sdk/types.@aws-sdk/types.HttpHandlerOptions> & std.Required<@aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/SQSClient.ClientDefaults> & @aws-sdk/config-resolver.@aws-sdk/config-resolver.RegionResolvedConfig & @aws-sdk/middleware-endpoint.@aws-sdk/middleware-endpoint.EndpointResolvedConfig<@aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/endpoint/EndpointParameters.EndpointParameters> & @aws-sdk/middleware-retry.@aws-sdk/middleware-retry.RetryResolvedConfig & @aws-sdk/middleware-host-header.@aws-sdk/middleware-host-header.HostHeaderResolvedConfig & @aws-sdk/middleware-signing.@aws-sdk/middleware-signing.AwsAuthResolvedConfig & @aws-sdk/middleware-user-agent.@aws-sdk/middleware-user-agent.UserAgentResolvedConfig & @aws-sdk/client-sqs.@aws-sdk/client-sqs/dist-types/endpoint/EndpointParameters.ClientResolvedEndpointParameters */
  @js.native
  trait SQSClientResolvedConfigType extends StObject {
    ...
    var md5: ChecksumConstructor | HashConstructor = js.native
  ...
  type ServiceInputTypes = AddPermissionCommandInput | ChangeMessageVisibilityBatchCommandInput | ChangeMessageVisibilityCommandInput | CreateQueueCommandInput | DeleteMessageBatchCommandInput | DeleteMessageCommandInput | DeleteQueueCommandInput | GetQueueAttributesCommandInput | GetQueueUrlCommandInput | ListDeadLetterSourceQueuesCommandInput | ListQueueTagsCommandInput | ListQueuesCommandInput | PurgeQueueCommandInput | ReceiveMessageCommandInput | RemovePermissionCommandInput | SendMessageBatchCommandInput | SendMessageCommandInput | SetQueueAttributesCommandInput | TagQueueCommandInput | UntagQueueCommandInput
  
  /* Rewritten from type alias, can be one of: 
    - typings.awsSdkClientSqs.distTypesCommandsAddPermissionCommandMod.AddPermissionCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsChangeMessageVisibilityBatchCommandMod.ChangeMessageVisibilityBatchCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsChangeMessageVisibilityCommandMod.ChangeMessageVisibilityCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsCreateQueueCommandMod.CreateQueueCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsDeleteMessageBatchCommandMod.DeleteMessageBatchCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsDeleteMessageCommandMod.DeleteMessageCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsDeleteQueueCommandMod.DeleteQueueCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsGetQueueAttributesCommandMod.GetQueueAttributesCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsGetQueueUrlCommandMod.GetQueueUrlCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsListDeadLetterSourceQueuesCommandMod.ListDeadLetterSourceQueuesCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsListQueueTagsCommandMod.ListQueueTagsCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsListQueuesCommandMod.ListQueuesCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsPurgeQueueCommandMod.PurgeQueueCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsReceiveMessageCommandMod.ReceiveMessageCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsRemovePermissionCommandMod.RemovePermissionCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsSendMessageBatchCommandMod.SendMessageBatchCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsSendMessageCommandMod.SendMessageCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsSetQueueAttributesCommandMod.SetQueueAttributesCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsTagQueueCommandMod.TagQueueCommandOutput
    - typings.awsSdkClientSqs.distTypesCommandsUntagQueueCommandMod.UntagQueueCommandOutput
  */
  type ServiceOutputTypes = _ServiceOutputTypes | AddPermissionCommandOutput | ChangeMessageVisibilityCommandOutput | DeleteMessageCommandOutput | DeleteQueueCommandOutput | PurgeQueueCommandOutput | RemovePermissionCommandOutput | SetQueueAttributesCommandOutput | TagQueueCommandOutput | UntagQueueCommandOutput
  
  trait _ServiceOutputTypes extends StObject
  object _ServiceOutputTypes {
    
    inline def ChangeMessageVisibilityBatchCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsChangeMessageVisibilityBatchCommandMod.ChangeMessageVisibilityBatchCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsChangeMessageVisibilityBatchCommandMod.ChangeMessageVisibilityBatchCommandOutput]
    }
    
    inline def CreateQueueCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsCreateQueueCommandMod.CreateQueueCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsCreateQueueCommandMod.CreateQueueCommandOutput]
    }
    
    inline def DeleteMessageBatchCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsDeleteMessageBatchCommandMod.DeleteMessageBatchCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsDeleteMessageBatchCommandMod.DeleteMessageBatchCommandOutput]
    }
    
    inline def GetQueueAttributesCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsGetQueueAttributesCommandMod.GetQueueAttributesCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsGetQueueAttributesCommandMod.GetQueueAttributesCommandOutput]
    }
    
    inline def GetQueueUrlCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsGetQueueUrlCommandMod.GetQueueUrlCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsGetQueueUrlCommandMod.GetQueueUrlCommandOutput]
    }
    
    inline def ListDeadLetterSourceQueuesCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsListDeadLetterSourceQueuesCommandMod.ListDeadLetterSourceQueuesCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsListDeadLetterSourceQueuesCommandMod.ListDeadLetterSourceQueuesCommandOutput]
    }
    
    inline def ListQueueTagsCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsListQueueTagsCommandMod.ListQueueTagsCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsListQueueTagsCommandMod.ListQueueTagsCommandOutput]
    }
    
    inline def ListQueuesCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsListQueuesCommandMod.ListQueuesCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsListQueuesCommandMod.ListQueuesCommandOutput]
    }
    
    inline def ReceiveMessageCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsReceiveMessageCommandMod.ReceiveMessageCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsReceiveMessageCommandMod.ReceiveMessageCommandOutput]
    }
    
    inline def SendMessageBatchCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsSendMessageBatchCommandMod.SendMessageBatchCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsSendMessageBatchCommandMod.SendMessageBatchCommandOutput]
    }
    
    inline def SendMessageCommandOutput($metadata: ResponseMetadata): typings.awsSdkClientSqs.distTypesCommandsSendMessageCommandMod.SendMessageCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientSqs.distTypesCommandsSendMessageCommandMod.SendMessageCommandOutput]
    }
  }
}
