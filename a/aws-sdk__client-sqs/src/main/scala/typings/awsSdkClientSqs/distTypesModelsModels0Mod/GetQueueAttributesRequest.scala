...
trait GetQueueAttributesRequest extends StObject {
  ...
  /**
    ...
    *   in the <i>Amazon SQS Developer Guide</i>.</p>
    */
  var AttributeNames: js.UndefOr[js.Array[QueueAttributeName | String]] = js.undefined
...
object GetQueueAttributesRequest {
  ...
  inline def apply(): GetQueueAttributesRequest = {
  ...
  implicit open class MutableBuilder[Self <: GetQueueAttributesRequest] (val x: Self) extends AnyVal {
    ...
    inline def setAttributeNames(value: js.Array[QueueAttributeName | String]): Self = StObject.set(x, "AttributeNames", value.asInstanceOf[js.Any])
    
    inline def setAttributeNamesUndefined: Self = StObject.set(x, "AttributeNames", js.undefined)
    
    inline def setAttributeNamesVarargs(value: (QueueAttributeName | String)*): Self = StObject.set(x, "AttributeNames", js.Array(value*))
