...
import typings.alipayjssdk.alipayjssdkNumbers.`2`
...
trait CurrentPosition extends StObject {
  ...
  var status: typings.alipayjssdk.alipayjssdkNumbers.`0` | typings.alipayjssdk.alipayjssdkNumbers.`1` | `2`
...
object CurrentPosition {
  ...
  inline def apply(
    ...
    duration: Double,
    status: typings.alipayjssdk.alipayjssdkNumbers.`0` | typings.alipayjssdk.alipayjssdkNumbers.`1` | `2`,
    url: String
  ): CurrentPosition = {
  ...
  extension [Self <: CurrentPosition](x: Self) {
    ...
    inline def setStatus(
      value: typings.alipayjssdk.alipayjssdkNumbers.`0` | typings.alipayjssdk.alipayjssdkNumbers.`1` | `2`
