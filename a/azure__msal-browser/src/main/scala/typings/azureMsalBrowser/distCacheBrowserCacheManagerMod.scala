...
import typings.azureMsalBrowser.distCacheIwindowstorageMod.IWindowStorage
import typings.azureMsalBrowser.distCacheMemoryStorageMod.MemoryStorage
...
object distCacheBrowserCacheManagerMod {
