...
object distUtilsBrowserUtilsMod {
  
  @JSImport("@azure/msal-browser/dist/utils/BrowserUtils", "BrowserUtils")
  @js.native
  open class BrowserUtils () extends StObject
  /* static members */
  object BrowserUtils {
    ...
    /**
      ...
      */
    inline def blockRedirectInIframe(interactionType: InteractionType, allowRedirectInIframe: Boolean): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("blockRedirectInIframe")(interactionType.asInstanceOf[js.Any], allowRedirectInIframe.asInstanceOf[js.Any])).asInstanceOf[Unit]
