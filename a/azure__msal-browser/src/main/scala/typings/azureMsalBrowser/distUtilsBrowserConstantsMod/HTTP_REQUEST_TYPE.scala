...
object HTTP_REQUEST_TYPE extends StObject {
  ...
  /* "GET" */ val GET: typings.azureMsalBrowser.distUtilsBrowserConstantsMod.HTTP_REQUEST_TYPE.GET & String = js.native
  
  @js.native
  sealed trait POST
    extends StObject
       with HTTP_REQUEST_TYPE
  /* "POST" */ val POST: typings.azureMsalBrowser.distUtilsBrowserConstantsMod.HTTP_REQUEST_TYPE.POST & String = js.native
}
