...
object ClientAuthErrorMessage {
  ...
  @JSImport("@azure/msal-browser", "ClientAuthErrorMessage.authTimeNotFoundError")
  @js.native
  ...
  @JSImport("@azure/msal-browser", "ClientAuthErrorMessage.maxAgeTranspiredError")
  @js.native
  ...
  @JSImport("@azure/msal-browser", "ClientAuthErrorMessage.noNetworkConnectivity")
  @js.native
  ...
  @JSImport("@azure/msal-browser", "ClientAuthErrorMessage.userCanceledError")
  @js.native
