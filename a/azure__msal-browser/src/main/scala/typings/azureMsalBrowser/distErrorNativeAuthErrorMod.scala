...
object distErrorNativeAuthErrorMod {
  ...
  object NativeStatusCode extends StObject {
    ...
    /* "ACCOUNT_UNAVAILABLE" */ val ACCOUNT_UNAVAILABLE: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.ACCOUNT_UNAVAILABLE & String = js.native
    
    @js.native
    sealed trait DISABLED
      extends StObject
         with NativeStatusCode
    /* "DISABLED" */ val DISABLED: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.DISABLED & String = js.native
    
    @js.native
    sealed trait NO_NETWORK
      extends StObject
         with NativeStatusCode
    /* "NO_NETWORK" */ val NO_NETWORK: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.NO_NETWORK & String = js.native
    
    @js.native
    sealed trait PERSISTENT_ERROR
      extends StObject
         with NativeStatusCode
    /* "PERSISTENT_ERROR" */ val PERSISTENT_ERROR: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.PERSISTENT_ERROR & String = js.native
    
    @js.native
    sealed trait TRANSIENT_ERROR
      extends StObject
         with NativeStatusCode
    /* "TRANSIENT_ERROR" */ val TRANSIENT_ERROR: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.TRANSIENT_ERROR & String = js.native
    
    @js.native
    sealed trait USER_CANCEL
      extends StObject
         with NativeStatusCode
    /* "USER_CANCEL" */ val USER_CANCEL: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.USER_CANCEL & String = js.native
    
    @js.native
    sealed trait USER_INTERACTION_REQUIRED
      extends StObject
         with NativeStatusCode
    /* "USER_INTERACTION_REQUIRED" */ val USER_INTERACTION_REQUIRED: typings.azureMsalBrowser.distErrorNativeAuthErrorMod.NativeStatusCode.USER_INTERACTION_REQUIRED & String = js.native
  }
