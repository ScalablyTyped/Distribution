...
object activexDashAdoxNumbers {
  @js.native
  sealed trait `-1` extends ObjectTypeEnum
  
  @js.native
  sealed trait `-2147483648` extends RightsEnum
  
  @js.native
  sealed trait `0`
    extends AllowNullsEnum
       with InheritTypeEnum
       with RightsEnum
       with RuleEnum
  ...
  @js.native
  sealed trait `1024` extends RightsEnum
  
  @js.native
  sealed trait `1073741824` extends RightsEnum
  
  @js.native
  sealed trait `131072` extends RightsEnum
  
  @js.native
  sealed trait `16384` extends RightsEnum
  ...
  @js.native
  sealed trait `2048` extends RightsEnum
  
  @js.native
  sealed trait `256` extends RightsEnum
  
  @js.native
  sealed trait `262144` extends RightsEnum
  
  @js.native
  sealed trait `268435456` extends RightsEnum
  ...
  @js.native
  sealed trait `32768` extends RightsEnum
  
  @js.native
  sealed trait `33554432` extends RightsEnum
  ...
  @js.native
  sealed trait `4096` extends RightsEnum
  
  @js.native
  sealed trait `5` extends ObjectTypeEnum
  
  @js.native
  sealed trait `512` extends RightsEnum
  
  @js.native
  sealed trait `524288` extends RightsEnum
  
  @js.native
  sealed trait `536870912` extends RightsEnum
  
  @js.native
  sealed trait `65536` extends RightsEnum
  
  @js.native
  sealed trait `8192` extends RightsEnum
