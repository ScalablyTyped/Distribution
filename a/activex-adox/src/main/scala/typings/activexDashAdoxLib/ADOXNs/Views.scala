...
trait Views extends js.Object {
  ...
  def apply(Item: java.lang.String): View = js.native
  def apply(Item: scala.Double): View = js.native
  ...
  def Item(Item: java.lang.String): View = js.native
  def Item(Item: scala.Double): View = js.native
