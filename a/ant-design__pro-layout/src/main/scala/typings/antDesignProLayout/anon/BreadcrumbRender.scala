...
object BreadcrumbRender {
  ...
  implicit class BreadcrumbRenderMutableBuilder[Self <: BreadcrumbRender] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFooterRender(value: WithFalse[js.Function2[/* props */ HeaderViewProps, /* defaultDom */ ReactNode, ReactNode]]): Self = StObject.set(x, "footerRender", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFooterRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "footerRender", js.Any.fromFunction2(value))
    ...
    @scala.inline
    def setLogo(value: ReactNode | WithFalse[js.Function0[ReactNode]]): Self = StObject.set(x, "logo", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLogoFunction0(value: () => ReactNode): Self = StObject.set(x, "logo", js.Any.fromFunction0(value))
    ...
    @scala.inline
    def setMenuItemRenderFunction2(value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "menuItemRender", js.Any.fromFunction2(value))
