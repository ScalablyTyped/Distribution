...
/* Inlined std.Partial<@ant-design/pro-layout.@ant-design/pro-layout/lib/defaultSettings.PureSettings> */
@js.native
trait PartialPureSettings extends js.Object {
...
object PartialPureSettings {
  @scala.inline
  def apply(): PartialPureSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPureSettings]
  }
  @scala.inline
  implicit class PartialPureSettingsOps[Self <: PartialPureSettings] (val x: Self) extends AnyVal {
    @scala.inline
