...
/* Inlined std.Partial<@ant-design/pro-layout.@ant-design/pro-layout/lib/defaultSettings.ProSettings> */
@js.native
trait PartialProSettings extends js.Object {
...
object PartialProSettings {
  ...
  @scala.inline
  implicit class PartialProSettingsOps[Self <: PartialProSettings] (val x: Self) extends AnyVal {
    @scala.inline
