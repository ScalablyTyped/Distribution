  ...
  var menuItemRender: js.UndefOr[
    WithFalse[
      js.Function3[
        ...
        /* menuProps */ this.type & PartialPrivateSiderMenuPr, 
        ReactNode
      ]
    ]
  ] = js.undefined
...
object BaseMenuPropsPartialPriva {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BaseMenuPropsPartialPriva] (val x: Self) extends AnyVal {
    ...
    inline def setMenuItemRender(
      value: WithFalse[
          js.Function3[
            /* item */ MenuDataItemisUrlbooleano, 
            /* defaultDom */ ReactNode, 
            /* menuProps */ BaseMenuPropsPartialPriva & PartialPrivateSiderMenuPr, 
            ReactNode
          ]
        ]
    ...
    inline def setMenuItemRenderFunction3(
      value: (/* item */ MenuDataItemisUrlbooleano, /* defaultDom */ ReactNode, /* menuProps */ BaseMenuPropsPartialPriva & PartialPrivateSiderMenuPr) => ReactNode
    ...
    inline def setSubMenuItemRenderFunction3(
      value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ ReactNode, BaseMenuPropsPartialPriva) => ReactNode
