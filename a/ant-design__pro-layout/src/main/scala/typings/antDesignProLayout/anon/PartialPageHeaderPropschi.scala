...
/* Inlined std.Partial<@ant-design/pro-layout.@ant-design/pro-layout/es/components/PageHeader.PageHeaderProps> & {  children :react.react.ReactNode | undefined} */
trait PartialPageHeaderPropschi extends StObject {
  ...
  var breadcrumbRender: js.UndefOr[js.Function2[/* props */ PageHeaderProps, /* defaultDom */ ReactNode, ReactNode]] = js.undefined
...
object PartialPageHeaderPropschi {
  
  inline def apply(): PartialPageHeaderPropschi = {
  ...
  extension [Self <: PartialPageHeaderPropschi](x: Self) {
    ...
    inline def setBreadcrumbRender(value: (/* props */ PageHeaderProps, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "breadcrumbRender", js.Any.fromFunction2(value))
