...
trait PageContainerPropsprefixe extends StObject {
  ...
  var pageHeaderRender: js.UndefOr[WithFalse[js.Function1[/* props */ PageContainerProps, ReactNode]]] = js.undefined
...
object PageContainerPropsprefixe {
  ...
  implicit open class MutableBuilder[Self <: PageContainerPropsprefixe] (val x: Self) extends AnyVal {
    ...
    inline def setBreadcrumbRender(value: (js.Function2[PageContainerPropsprefixe, /* defaultDom */ ReactNode, ReactNode]) | `false`): Self = StObject.set(x, "breadcrumbRender", value.asInstanceOf[js.Any])
    
    inline def setBreadcrumbRenderFunction2(value: (PageContainerPropsprefixe, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "breadcrumbRender", js.Any.fromFunction2(value))
    ...
    inline def setPageHeaderRender(value: WithFalse[js.Function1[/* props */ PageContainerProps, ReactNode]]): Self = StObject.set(x, "pageHeaderRender", value.asInstanceOf[js.Any])
    
    inline def setPageHeaderRenderFunction1(value: /* props */ PageContainerProps => ReactNode): Self = StObject.set(x, "pageHeaderRender", js.Any.fromFunction1(value))
