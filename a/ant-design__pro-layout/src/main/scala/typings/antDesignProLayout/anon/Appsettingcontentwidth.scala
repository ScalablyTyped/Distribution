...
object Appsettingcontentwidth {
  ...
  implicit class AppsettingcontentwidthOps[Self <: Appsettingcontentwidth] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAppDotsettingDotregionalsettings(value: String): Self = this.set("app.setting.regionalsettings", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAppDotsettingDotregionalsettingsDotfooter(value: String): Self = this.set("app.setting.regionalsettings.footer", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAppDotsettingDotregionalsettingsDotheader(value: String): Self = this.set("app.setting.regionalsettings.header", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAppDotsettingDotregionalsettingsDotmenu(value: String): Self = this.set("app.setting.regionalsettings.menu", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAppDotsettingDotregionalsettingsDotmenuHeader(value: String): Self = this.set("app.setting.regionalsettings.menuHeader", value.asInstanceOf[js.Any])
