...
/* Inlined @ant-design/pro-layout.@ant-design/pro-layout/es/typing.MenuDataItem & {  isUrl :boolean, onClick (): void} */
...
object MenuDataItemisUrlbooleano {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MenuDataItemisUrlbooleano] (val x: Self) extends AnyVal {
