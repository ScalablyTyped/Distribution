...
/* Inlined antd.antd.TabPaneProps & {  key :react.react.Key | undefined} */
trait TabPanePropskeyKeyundefin extends StObject {
...
object TabPanePropskeyKeyundefin {
  
  inline def apply(): TabPanePropskeyKeyundefin = {
