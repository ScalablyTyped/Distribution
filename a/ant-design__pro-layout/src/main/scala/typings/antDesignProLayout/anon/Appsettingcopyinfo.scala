...
trait Appsettingcopyinfo extends StObject {
...
object Appsettingcopyinfo {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Appsettingcopyinfo]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Appsettingcopyinfo] (val x: Self) extends AnyVal {
