...
object esComponentsHeaderMod {
  ...
  trait HeaderViewProps extends StObject {
    ...
    var actionsRender: js.UndefOr[WithFalse[js.Function1[/* props */ this.type, js.Array[ReactNode]]]] = js.undefined
    ...
    var headerTitleRender: js.UndefOr[
        WithFalse[
          js.Function3[/* logo */ ReactNode, /* title */ ReactNode, /* props */ this.type, ReactNode]
        ]
      ] = js.undefined
  ...
  object HeaderViewProps {
    ...
    extension [Self <: HeaderViewProps](x: Self) {
      ...
      inline def setActionsRenderFunction1(value: HeaderViewProps => js.Array[ReactNode]): Self = StObject.set(x, "actionsRender", js.Any.fromFunction1(value))
      ...
      inline def setHeaderContentRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ ReactNode, ReactNode]]): Self = StObject.set(x, "headerContentRender", value.asInstanceOf[js.Any])
      
      inline def setHeaderContentRenderFunction2(value: (HeaderViewProps, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "headerContentRender", js.Any.fromFunction2(value))
      ...
      inline def setHeaderTitleRender(
        value: WithFalse[
              js.Function3[/* logo */ ReactNode, /* title */ ReactNode, HeaderViewProps, ReactNode]
            ]
      ): Self = StObject.set(x, "headerTitleRender", value.asInstanceOf[js.Any])
      
      inline def setHeaderTitleRenderFunction3(value: (/* logo */ ReactNode, /* title */ ReactNode, HeaderViewProps) => ReactNode): Self = StObject.set(x, "headerTitleRender", js.Any.fromFunction3(value))
      ...
      inline def setMenuRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ ReactNode, ReactNode]]): Self = StObject.set(x, "menuRender", value.asInstanceOf[js.Any])
      
      inline def setMenuRenderFunction2(value: (HeaderViewProps, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "menuRender", js.Any.fromFunction2(value))
      ...
      inline def setRightContentRender(value: WithFalse[js.Function1[HeaderViewProps, ReactNode]]): Self = StObject.set(x, "rightContentRender", value.asInstanceOf[js.Any])
      
      inline def setRightContentRenderFunction1(value: HeaderViewProps => ReactNode): Self = StObject.set(x, "rightContentRender", js.Any.fromFunction1(value))
