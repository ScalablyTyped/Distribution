...
object typingsMod {
  ...
  trait BasicRouteProps[Params /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof Params ]:? string}
    */ typings.antDesignProLayout.antDesignProLayoutStrings.BasicRouteProps & TopLevel[Any] */, C /* <: StaticContext */, S] extends StObject {
    
    var history: History
    
    var location: Location
    
    var `match`: typings.antDesignProLayout.typingsMod.`match`[Params]
  ...
  object BasicRouteProps {
    ...
    {[ K in keyof Params ]:? string}
      */ typings.antDesignProLayout.antDesignProLayoutStrings.BasicRouteProps & TopLevel[Any] */, C /* <: StaticContext */, S](history: History, location: Location, `match`: `match`[Params]): BasicRouteProps[Params, C, S] = {
      val __obj = js.Dynamic.literal(history = history.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any])
      __obj.updateDynamic("match")(`match`.asInstanceOf[js.Any])
      __obj.asInstanceOf[BasicRouteProps[Params, C, S]]
    }
    
    extension [Self <: BasicRouteProps[?, ?, ?], Params /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof Params ]:? string}
      */ typings.antDesignProLayout.antDesignProLayoutStrings.BasicRouteProps & TopLevel[Any] */, C /* <: StaticContext */, S](x: Self & (BasicRouteProps[Params, C, S])) {
  ...
  trait RouterTypes extends StObject {
    ...
    var `match`: typings.antDesignProLayout.typingsMod.`match`[Record[String, Any]]
  ...
  {[ K in keyof Params ]:? string}
    */ typings.antDesignProLayout.antDesignProLayoutStrings.`match` & TopLevel[Any] */] extends StObject {
  ...
  object `match` {
    ...
    inline def apply[Params /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
    {[ K in keyof Params ]:? string}
      */ typings.antDesignProLayout.antDesignProLayoutStrings.`match` & TopLevel[Any] */](isExact: Boolean, params: Params, path: String, url: String): `match`[Params] = {
    ...
    {[ K in keyof Params ]:? string}
      */ typings.antDesignProLayout.antDesignProLayoutStrings.`match` & TopLevel[Any] */](x: Self & `match`[Params]) {
