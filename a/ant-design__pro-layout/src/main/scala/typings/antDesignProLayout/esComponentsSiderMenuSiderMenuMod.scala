...
object esComponentsSiderMenuSiderMenuMod {
  ...
  type SiderMenuProps = ActionsRender & (Pick[
    BaseMenuProps, 
    Exclude[
      /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 234, starting with typings.antDesignProLayout.antDesignProLayoutStrings.className, typings.antDesignProLayout.antDesignProLayoutStrings.defaultCollapsed, typings.antDesignProLayout.antDesignProLayoutStrings.collapsed */ Any, 
      js.Array[onCollapse]
    ]
  ])
}
