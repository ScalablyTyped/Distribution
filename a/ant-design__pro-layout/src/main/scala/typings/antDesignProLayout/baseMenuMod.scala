...
object baseMenuMod extends Shortcut {
  ...
  @js.native
  val default: FC[BaseMenuProps with PrivateSiderMenuProps] = js.native
  ...
  object BaseMenuProps {
    ...
    implicit class BaseMenuPropsMutableBuilder[Self <: BaseMenuProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setSubMenuItemRenderFunction2(value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ ReactNode) => ReactNode): Self = StObject.set(x, "subMenuItemRender", js.Any.fromFunction2(value))
  ...
  type _To = FC[BaseMenuProps with PrivateSiderMenuProps]
  
  /* This means you don't have to write `default`, but can instead just say `baseMenuMod.foo` */
  override def _to: FC[BaseMenuProps with PrivateSiderMenuProps] = default
}
