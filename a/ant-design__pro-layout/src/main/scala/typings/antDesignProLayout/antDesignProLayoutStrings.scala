...
object antDesignProLayoutStrings {
  ...
  @js.native
  sealed trait sidemenu extends StObject
  inline def sidemenu: sidemenu = "sidemenu".asInstanceOf[sidemenu]
  ...
  @js.native
  sealed trait topmenu extends StObject
  inline def topmenu: topmenu = "topmenu".asInstanceOf[topmenu]
