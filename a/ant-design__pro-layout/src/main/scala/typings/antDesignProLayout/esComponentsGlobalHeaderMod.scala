...
object esComponentsGlobalHeaderMod {
  ...
  /* Inlined {  collapsed :boolean | undefined,   onCollapse :(collapsed : boolean): void | undefined,   isMobile :boolean | undefined,   logo :react.react.ReactNode | undefined,   menuRender :@ant-design/pro-layout.@ant-design/pro-layout/es/typing.WithFalse<(props : @ant-design/pro-layout.@ant-design/pro-layout/es/components/Header.HeaderViewProps, defaultDom : react.react.ReactNode): react.react.ReactNode> | undefined,   rightContentRender :@ant-design/pro-layout.@ant-design/pro-layout/es/typing.WithFalse<(props : @ant-design/pro-layout.@ant-design/pro-layout/es/components/Header.HeaderViewProps): react.react.ReactNode> | undefined,   className :string | undefined,   prefixCls :string | undefined,   menuData :std.Array<@ant-design/pro-layout.@ant-design/pro-layout.MenuDataItem> | undefined,   onMenuHeaderClick :(e : react.react.MouseEvent<std.HTMLDivElement, react.react.NativeMouseEvent>): void | undefined,   style :react.react.CSSProperties | undefined,   menuHeaderRender :@ant-design/pro-layout.@ant-design/pro-layout/es/components/SiderMenu/SiderMenu.SiderMenuProps['menuHeaderRender'] | undefined,   headerContentRender :@ant-design/pro-layout.@ant-design/pro-layout/es/typing.WithFalse<(props : @ant-design/pro-layout.@ant-design/pro-layout/es/components/Header.HeaderViewProps, defaultDom : react.react.ReactNode): react.react.ReactNode> | undefined,   collapsedButtonRender :@ant-design/pro-layout.@ant-design/pro-layout/es/components/SiderMenu/SiderMenu.SiderMenuProps['collapsedButtonRender'] | undefined,   splitMenus :boolean | undefined,   actionsRender :@ant-design/pro-layout.@ant-design/pro-layout/es/typing.WithFalse<(props : @ant-design/pro-layout.@ant-design/pro-layout/es/components/Header.HeaderViewProps): std.Array<react.react.ReactNode>> | undefined,   avatarProps :@ant-design/pro-layout.@ant-design/pro-layout/es/typing.WithFalse<antd.antd.AvatarProps & {  title :react.react.ReactNode | undefined}> | undefined,   children :react.react.ReactNode | undefined} & std.Partial<@ant-design/pro-layout.@ant-design/pro-layout/es/defaultSettings.PureSettings> */
