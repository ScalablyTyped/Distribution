...
object esContextRouteContextMod {
  
  @JSImport("@ant-design/pro-layout/es/context/RouteContext", "RouteContext")
  @js.native
  val RouteContext: Context[RouteContextType] = js.native
  
  /* Inlined {  breadcrumb :@ant-design/pro-layout.@ant-design/pro-layout/es/utils/getBreadcrumbProps.BreadcrumbListReturn | undefined,   menuData :std.Array<@ant-design/pro-layout.@ant-design/pro-layout/es/typing.MenuDataItem> | undefined,   isMobile :boolean | undefined,   prefixCls :string | undefined,   collapsed :boolean | undefined,   hasSiderMenu :boolean | undefined,   hasHeader :boolean | undefined,   siderWidth :number | undefined,   isChildrenLayout :boolean | undefined,   hasFooterToolbar :boolean | undefined,   hasFooter :boolean | undefined,   hasPageContainer :number | undefined,   setHasFooterToolbar :react.react.Dispatch<react.react.SetStateAction<boolean>> | undefined,   setHasPageContainer :react.react.Dispatch<react.react.SetStateAction<number>> | undefined,   pageTitleInfo :{  title :string,   id :string,   pageName :string} | undefined,   matchMenus :std.Array<@ant-design/pro-layout.@ant-design/pro-layout/es/typing.MenuDataItem> | undefined,   matchMenuKeys :std.Array<string> | undefined,   currentMenu :@ant-design/pro-layout.@ant-design/pro-layout/es/defaultSettings.PureSettings & @ant-design/pro-layout.@ant-design/pro-layout/es/typing.MenuDataItem | undefined,   breadcrumbProps :antd.antd.BreadcrumbProps | undefined,   waterMarkProps :@ant-design/pro-layout.@ant-design/pro-layout/es/components/WaterMark.WaterMarkProps | undefined} & std.Partial<@ant-design/pro-layout.@ant-design/pro-layout/es/defaultSettings.PureSettings> */
  ...
  object RouteContextType {
    ...
    inline def apply(): RouteContextType = {
