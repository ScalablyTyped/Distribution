package typings.antDesignProLayout.footerToolbarMod
...
object FooterToolbarProps {
  ...
  implicit class FooterToolbarPropsOps[Self <: FooterToolbarProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRenderContent(value: (/* props */ FooterToolbarPropsRouteCo, /* dom */ Element) => ReactNode): Self = this.set("renderContent", js.Any.fromFunction2(value))
    @scala.inline
