...
object BaseMenuProps {
  ...
  implicit class BaseMenuPropsOps[Self <: BaseMenuProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSubMenuItemRenderFunction2(value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ ReactNode) => ReactNode): Self = this.set("subMenuItemRender", js.Any.fromFunction2(value))
