...
- atAntDashDesignProDashLayoutLib.libHeaderMod.HeaderViewProps because var conflicts: logo, siderWidth. Inlined isMobile, collapsed, autoHideHeader, menuRender, headerRender, rightContentRender, menu, navTheme, contentWidth, layout, title, fixedHeader, iconfontUrl, fixSiderbar, collapsedButtonRender, onCollapse */ trait BasicLayoutProps
  extends atAntDashDesignProDashLayoutLib.libSiderMenuSiderMenuMod.SiderMenuProps {
  ...
  var footerRender: js.UndefOr[
    atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[
      js.Function2[
        /* props */ atAntDashDesignProDashLayoutLib.libHeaderMod.HeaderViewProps, 
  ...
  var locale: js.UndefOr[atAntDashDesignProDashLayoutLib.libLocalesMod.localeType] = js.undefined
  @JSName("logo")
  var logo_BasicLayoutProps: js.UndefOr[
    reactLib.reactMod.ReactNode | atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[js.Function0[reactLib.reactMod.ReactNode]]
  ] = js.undefined
  ...
  var menuItemRender: js.UndefOr[
    atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[
      js.Function2[
        /* item */ atAntDashDesignProDashLayoutLib.MenuDataItemisUrlbooleanAuthority, 
        /* defaultDom */ reactLib.reactMod.ReactNode, 
        reactLib.reactMod.ReactNode
      ]
    ]
...
object BasicLayoutProps {
  ...
  def apply(
    ...
    footerRender: atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[
      js.Function2[
        /* props */ atAntDashDesignProDashLayoutLib.libHeaderMod.HeaderViewProps, 
        /* defaultDom */ reactLib.reactMod.ReactNode, 
        reactLib.reactMod.ReactNode
    ...
    headerRender: atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[
      js.Function1[
        /* props */ atAntDashDesignProDashLayoutLib.libHeaderMod.HeaderViewProps, 
        reactLib.reactMod.ReactNode
      ]
    ...
    locale: atAntDashDesignProDashLayoutLib.libLocalesMod.localeType = null,
    logo: reactLib.reactMod.ReactNode | atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[js.Function0[reactLib.reactMod.ReactNode]] = null,
    menu: atAntDashDesignProDashLayoutLib.Anon_Locale = null,
    menuDataRender: /* menuData */ js.Array[atAntDashDesignProDashLayoutLib.libTypingsMod.MenuDataItem] => js.Array[atAntDashDesignProDashLayoutLib.libTypingsMod.MenuDataItem] = null,
    ...
    pageTitleRender: atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[
      js.Function2[
        /* props */ atAntDashDesignProDashLayoutLib.libGetPageTitleMod.GetPageTitleProps, 
        /* ignoreTile */ js.UndefOr[scala.Boolean], 
        java.lang.String
    ...
    rightContentRender: atAntDashDesignProDashLayoutLib.libTypingsMod.WithFalse[js.Function1[BasicLayoutProps, reactLib.reactMod.ReactNode]] = null,
