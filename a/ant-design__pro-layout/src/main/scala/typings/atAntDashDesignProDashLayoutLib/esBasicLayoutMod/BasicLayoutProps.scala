...
- atAntDashDesignProDashLayoutLib.esSiderMenuSiderMenuMod.SiderMenuProps because var conflicts: logo, siderWidth. Inlined  */ trait BasicLayoutProps
  extends atAntDashDesignProDashLayoutLib.esHeaderMod.HeaderViewProps {
