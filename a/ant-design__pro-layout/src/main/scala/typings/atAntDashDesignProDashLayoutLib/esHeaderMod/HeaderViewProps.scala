package typings
package atAntDashDesignProDashLayoutLib.esHeaderMod
...
- Dropped {[ P in keyof @ant-design/pro-layout.@ant-design/pro-layout/es/defaultSettings.Settings ]:? @ant-design/pro-layout.@ant-design/pro-layout/es/defaultSettings.Settings[P]} */ trait HeaderViewProps
  extends atAntDashDesignProDashLayoutLib.esGlobalHeaderMod.GlobalHeaderProps {
  var autoHideHeader: js.UndefOr[scala.Boolean] = js.undefined
  var headerRender: js.UndefOr[
    atAntDashDesignProDashLayoutLib.esTypingsMod.WithFalse[js.Function1[/* props */ HeaderViewProps, reactLib.reactMod.ReactNode]]
  ] = js.undefined
  @JSName("menuRender")
...
object HeaderViewProps {
  ...
  def apply(
    ...
    headerRender: atAntDashDesignProDashLayoutLib.esTypingsMod.WithFalse[js.Function1[/* props */ HeaderViewProps, reactLib.reactMod.ReactNode]] = null,
