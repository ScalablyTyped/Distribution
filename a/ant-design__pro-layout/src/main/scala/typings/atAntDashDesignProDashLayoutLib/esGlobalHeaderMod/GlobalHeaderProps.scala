package typings
package atAntDashDesignProDashLayoutLib.esGlobalHeaderMod
...
object GlobalHeaderProps {
  ...
  def apply(
    ...
    rightContentRender: atAntDashDesignProDashLayoutLib.esTypingsMod.WithFalse[js.Function1[GlobalHeaderProps, reactLib.reactMod.ReactNode]] = null
  ): GlobalHeaderProps = {
