...
trait Anon_BreadcrumbLocationPath extends js.Object {
  var breadcrumb: js.UndefOr[
    org.scalablytyped.runtime.StringDictionary[atAntDashDesignProDashLayoutLib.libTypingsMod.MenuDataItem]
  ] = js.undefined
...
object Anon_BreadcrumbLocationPath {
  @scala.inline
  def apply(
    breadcrumb: org.scalablytyped.runtime.StringDictionary[atAntDashDesignProDashLayoutLib.libTypingsMod.MenuDataItem] = null,
