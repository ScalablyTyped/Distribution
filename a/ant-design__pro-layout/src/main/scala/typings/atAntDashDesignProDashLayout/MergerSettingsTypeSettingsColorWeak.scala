...
trait MergerSettingsTypeSettingsColorWeak extends js.Object {
...
object MergerSettingsTypeSettingsColorWeak {
  @scala.inline
  def apply(
    ...
    title: String = null
  ): MergerSettingsTypeSettingsColorWeak = {
    ...
    __obj.asInstanceOf[MergerSettingsTypeSettingsColorWeak]
  }
}
