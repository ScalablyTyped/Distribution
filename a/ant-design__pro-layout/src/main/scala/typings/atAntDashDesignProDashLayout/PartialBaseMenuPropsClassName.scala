...
trait PartialBaseMenuPropsClassName extends js.Object {
...
object PartialBaseMenuPropsClassName {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PartialBaseMenuPropsClassName]
  }
}
