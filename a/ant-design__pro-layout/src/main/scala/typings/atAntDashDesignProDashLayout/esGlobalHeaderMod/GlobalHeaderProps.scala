...
trait GlobalHeaderProps extends js.Object {
  ...
  var menuRender: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: @ant-design/pro-layout.@ant-design/pro-layout/es/BasicLayout.BasicLayoutProps['menuRender'] */ js.Any
  ] = js.undefined
...
object GlobalHeaderProps {
  ...
  def apply(
    ...
    menuRender: /* import warning: importer.ImportType#apply Failed type conversion: @ant-design/pro-layout.@ant-design/pro-layout/es/BasicLayout.BasicLayoutProps['menuRender'] */ js.Any = null,
