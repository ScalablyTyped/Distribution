...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "antd" % "4.8.5-ac8be0",
  ...
  "org.scalablytyped" %%% "umijs__route-utils" % "1.0.34-c751f5",
  "org.scalablytyped" %%% "unstated-next" % "1.1.0-cbdeae")
