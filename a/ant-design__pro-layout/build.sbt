...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ant-design__pro-utils" % "2.2.0-855780",
  ...
  "org.scalablytyped" %%% "umijs__route-utils" % "3.0.0-ee187d",
  "org.scalablytyped" %%% "unstated-next" % "1.1.0-2964bf")
