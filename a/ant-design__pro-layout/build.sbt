...
version := "7.2.4-c18ba3"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "ant-design__cssinjs" % "0.0.0-alpha.60-22794e",
  "org.scalablytyped" %%% "ant-design__icons" % "4.7.0-89de04",
  "org.scalablytyped" %%% "ant-design__icons-svg" % "4.2.1-b90a28",
  "org.scalablytyped" %%% "ant-design__pro-provider" % "2.0.16-d7e7ad",
  ...
  "org.scalablytyped" %%% "umijs__route-utils" % "2.2.1-65c753",
  "org.scalablytyped" %%% "unstated-next" % "1.1.0-47065d")
