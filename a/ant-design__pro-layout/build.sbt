...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "antd" % "4.8.5-e0d7ba",
  ...
  "org.scalablytyped" %%% "umijs__route-utils" % "1.0.34-fd4d92",
  "org.scalablytyped" %%% "unstated-next" % "1.1.0-9b56f8")
