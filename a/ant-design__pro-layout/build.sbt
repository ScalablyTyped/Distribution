...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ant-design__pro-provider" % "2.0.6-4a8ad6",
  "org.scalablytyped" %%% "ant-design__pro-utils" % "2.2.6-7b70b4",
  "org.scalablytyped" %%% "ant-design__react-slick" % "0.29.2-ead447",
  "org.scalablytyped" %%% "antd" % "4.23.6-d4cf21",
