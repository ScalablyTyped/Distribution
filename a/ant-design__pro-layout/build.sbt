...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "antd" % "4.8.5-425db4",
  ...
  "org.scalablytyped" %%% "umijs__route-utils" % "1.0.34-d5665f",
  "org.scalablytyped" %%% "unstated-next" % "1.1.0-f0fc81")
