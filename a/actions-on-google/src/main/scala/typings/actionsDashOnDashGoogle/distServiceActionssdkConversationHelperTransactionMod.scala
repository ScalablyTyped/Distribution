...
object distServiceActionssdkConversationHelperTransactionMod extends js.Object {
  ...
  class CompletePurchase ()
    extends typings.actionsDashOnDashGoogle.distServiceActionssdkConversationHelperTransactionCompletepurchaseMod.CompletePurchase {
  ...
  class DeliveryAddress ()
    extends typings.actionsDashOnDashGoogle.distServiceActionssdkConversationHelperTransactionDeliveryaddressMod.DeliveryAddress {
  ...
  class DigitalPurchaseCheck ()
    extends typings.actionsDashOnDashGoogle.distServiceActionssdkConversationHelperTransactionDigitalpurchasecheckMod.DigitalPurchaseCheck {
  ...
  class TransactionDecision ()
    extends typings.actionsDashOnDashGoogle.distServiceActionssdkConversationHelperTransactionDecisionMod.TransactionDecision {
  ...
  class TransactionRequirements ()
    extends typings.actionsDashOnDashGoogle.distServiceActionssdkConversationHelperTransactionRequirementsMod.TransactionRequirements {
