...
class RichResponse () extends js.Object {
  ...
  /**
    ...
    * @return Returns current constructed RichResponse.
    */
  def addBrowseCarousel(browseCarousel: String): RichResponse = js.native
  ...
  /**
    ...
    * @return Returns current constructed RichResponse.
    */
  def addOrderUpdate(orderUpdate: OrderUpdate): RichResponse = js.native
  /**
    ...
    * @return Returns current constructed RichResponse.
    */
  def addSimpleResponse(simpleResponse: String): RichResponse = js.native
  ...
  /**
    ...
    * @return Returns current constructed RichResponse.
    */
  def addSuggestionLink(destinationName: String, suggestionUrl: String): RichResponse = js.native
  /**
    ...
    * @return Returns current constructed RichResponse.
    */
  def addSuggestions(suggestions: String): RichResponse = js.native
  def addSuggestions(suggestions: js.Array[String]): RichResponse = js.native
  /**
    ...
    */
  def isValidSuggestionText(suggestionText: String): Boolean = js.native
}
