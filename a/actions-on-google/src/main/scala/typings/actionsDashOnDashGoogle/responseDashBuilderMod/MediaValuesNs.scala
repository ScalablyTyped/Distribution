...
object MediaValuesNs extends js.Object {
  ...
  object ImageType extends js.Object {
    ...
    /* 0 */ val ICON: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.ImageType.ICON with Double = js.native
    /* 1 */ val LARGE: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.ImageType.LARGE with Double = js.native
    @JSBracketAccess
  ...
  object Status extends js.Object {
    ...
    /* 1 */ val FINISHED: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.Status.FINISHED with Double = js.native
    /* 0 */ val UNSPECIFIED: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.Status.UNSPECIFIED with Double = js.native
    @JSBracketAccess
  ...
  object Type extends js.Object {
    ...
    /* 1 */ val AUDIO: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.Type.AUDIO with Double = js.native
    /* 0 */ val MEDIA_TYPE_UNSPECIFIED: typings.actionsDashOnDashGoogle.responseDashBuilderMod.MediaValuesNs.Type.MEDIA_TYPE_UNSPECIFIED with Double = js.native
    @JSBracketAccess
