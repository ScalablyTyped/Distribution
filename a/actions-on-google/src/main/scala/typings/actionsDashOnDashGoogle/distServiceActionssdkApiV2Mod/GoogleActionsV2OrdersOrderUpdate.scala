...
object GoogleActionsV2OrdersOrderUpdate {
  ...
  def apply(
    ...
    if (cancellationInfo != null) __obj.updateDynamic("cancellationInfo")(cancellationInfo)
    ...
    if (inTransitInfo != null) __obj.updateDynamic("inTransitInfo")(inTransitInfo)
    if (infoExtension != null) __obj.updateDynamic("infoExtension")(infoExtension)
    if (lineItemUpdates != null) __obj.updateDynamic("lineItemUpdates")(lineItemUpdates)
    if (orderManagementActions != null) __obj.updateDynamic("orderManagementActions")(orderManagementActions)
    if (orderState != null) __obj.updateDynamic("orderState")(orderState)
    if (receipt != null) __obj.updateDynamic("receipt")(receipt)
    if (rejectionInfo != null) __obj.updateDynamic("rejectionInfo")(rejectionInfo)
    if (returnInfo != null) __obj.updateDynamic("returnInfo")(returnInfo)
    if (totalPrice != null) __obj.updateDynamic("totalPrice")(totalPrice)
