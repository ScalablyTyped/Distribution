...
@js.native
class ActionsSdkApp protected () extends AssistantApp {
  /**
  ...
  /**
    ...
    * @actionssdk
    */
  def ask(inputPrompt: js.Object): Response | Null = js.native
  def ask(inputPrompt: js.Object, dialogState: js.Object): Response | Null = js.native
  def ask(inputPrompt: RichResponse): Response | Null = js.native
  def ask(inputPrompt: RichResponse, dialogState: js.Object): Response | Null = js.native
  def ask(inputPrompt: SimpleResponse): Response | Null = js.native
  def ask(inputPrompt: SimpleResponse, dialogState: js.Object): Response | Null = js.native
  /**
    ...
    * @actionssdk
    */
  def askWithCarousel(inputPrompt: js.Object, carousel: Carousel): Response | Null = js.native
  def askWithCarousel(inputPrompt: js.Object, carousel: Carousel, dialogState: js.Object): Response | Null = js.native
  def askWithCarousel(inputPrompt: RichResponse, carousel: Carousel): Response | Null = js.native
  def askWithCarousel(inputPrompt: RichResponse, carousel: Carousel, dialogState: js.Object): Response | Null = js.native
  def askWithCarousel(inputPrompt: SimpleResponse, carousel: Carousel): Response | Null = js.native
  def askWithCarousel(inputPrompt: SimpleResponse, carousel: Carousel, dialogState: js.Object): Response | Null = js.native
  /**
    ...
    * @actionssdk
    */
  def askWithList(inputPrompt: js.Object, list: List): Response | Null = js.native
  def askWithList(inputPrompt: js.Object, list: List, dialogState: js.Object): Response | Null = js.native
  def askWithList(inputPrompt: RichResponse, list: List): Response | Null = js.native
  def askWithList(inputPrompt: RichResponse, list: List, dialogState: js.Object): Response | Null = js.native
  def askWithList(inputPrompt: SimpleResponse, list: List): Response | Null = js.native
  def askWithList(inputPrompt: SimpleResponse, list: List, dialogState: js.Object): Response | Null = js.native
  /**
    ...
    * @actionssdk
    */
  def buildInputPrompt(isSsml: Boolean, initialPrompt: String): js.Object = js.native
  def buildInputPrompt(isSsml: Boolean, initialPrompt: String, noInputs: js.Array[String]): js.Object = js.native
  /**
    ...
    * @actionssdk
    */
  def getActionVersionLabel(): String = js.native
  /**
    ...
    * @actionssdk
    */
  def getApiVersion(): String = js.native
  /**
    ...
    * @actionssdk
    */
  def getArgument(argName: String): String = js.native
  /**
    ...
    * @actionssdk
    */
  def getConversationId(): String = js.native
  /**
  ...
  /**
    ...
    * @actionssdk
    */
  def isRequestFromAssistant(projectId: String): js.Promise[js.Object] = js.native
  /**
    ...
    * @actionssdk
    */
  def isRequestFromGoogle(projectId: String): js.Promise[js.Object] = js.native
  /**
    ...
    * @actionssdk
    */
  def tell(textToSpeech: String): Response | Null = js.native
  def tell(textToSpeech: RichResponse): Response | Null = js.native
  def tell(textToSpeech: SimpleResponse): Response | Null = js.native
}
