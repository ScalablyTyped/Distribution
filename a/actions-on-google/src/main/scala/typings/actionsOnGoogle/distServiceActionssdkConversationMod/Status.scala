...
@JSImport("actions-on-google/dist/service/actionssdk/conversation", "Status")
@js.native
open class Status protected ()
  extends typings.actionsOnGoogle.distServiceActionssdkConversationArgumentMod.Status {
  /** @hidden */
