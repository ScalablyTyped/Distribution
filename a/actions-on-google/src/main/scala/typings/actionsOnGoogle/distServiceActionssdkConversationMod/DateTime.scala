...
@JSImport("actions-on-google/dist/service/actionssdk/conversation", "DateTime")
@js.native
open class DateTime protected ()
  extends typings.actionsOnGoogle.distServiceActionssdkConversationHelperMod.DateTime {
  /**
