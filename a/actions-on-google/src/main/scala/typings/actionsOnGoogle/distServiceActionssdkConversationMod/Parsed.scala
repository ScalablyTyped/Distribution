...
@JSImport("actions-on-google/dist/service/actionssdk/conversation", "Parsed")
@js.native
open class Parsed protected ()
  extends typings.actionsOnGoogle.distServiceActionssdkConversationArgumentMod.Parsed {
  /** @hidden */
