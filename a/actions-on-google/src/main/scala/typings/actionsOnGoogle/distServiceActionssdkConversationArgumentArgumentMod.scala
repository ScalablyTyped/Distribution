...
import typings.actionsOnGoogle.distServiceActionssdkConversationArgumentMediaMod.MediaStatusArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationArgumentNoinputMod.FinalRepromptArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationArgumentNoinputMod.RepromptArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperConfirmationMod.ConfirmationArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperDatetimeMod.DateTimeArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperNewsurfaceMod.NewSurfaceArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperOptionOptionMod.OptionArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperPermissionPermissionMod.PermissionArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperPermissionUpdateMod.UpdatePermissionUserIdArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperPlaceMod.PlaceArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperRegisterupdateMod.RegisterUpdateArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperSigninMod.SignInArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperTransactionCompletepurchaseMod.CompletePurchaseArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperTransactionDecisionMod.TransactionDecisionArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperTransactionDeliveryaddressMod.DeliveryAddressArgument
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperTransactionDigitalpurchasecheckMod.DigitalPurchaseCheckArgument
...
object distServiceActionssdkConversationArgumentArgumentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Double
    - scala.Unit
    - typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleRpcStatus
    - scala.Boolean
    - java.lang.String
    - typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2Location
    - typings.actionsOnGoogle.distCommonMod.ApiClientObjectMap[scala.Any]
    - typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2DateTime
  */
  ...
  object _Argument {
    ...
    inline def GoogleActionsV2DateTime(): typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2DateTime = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2DateTime]
    }
    
    inline def GoogleActionsV2Location(): typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2Location = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2Location]
    }
    
    inline def GoogleRpcStatus(): typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleRpcStatus = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleRpcStatus]
    }
  }
}
