...
object DialogflowV1BaseMessage {
  @scala.inline
  def apply[/* <: scala.Double */ TType](): DialogflowV1BaseMessage[TType] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DialogflowV1BaseMessage[TType]]
  }
  @scala.inline
  implicit class DialogflowV1BaseMessageOps[Self <: DialogflowV1BaseMessage[_], /* <: scala.Double */ TType] (val x: Self with DialogflowV1BaseMessage[TType]) extends AnyVal {
    @scala.inline
