...
import typings.actionsOnGoogle.distServiceDialogflowApiV1Mod.DialogflowV1Fulfillment
import typings.actionsOnGoogle.distServiceDialogflowApiV2Mod.GoogleCloudDialogflowV2IntentMessage
...
object distServiceDialogflowIncomingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typings.actionsOnGoogle.distServiceActionssdkMod.Image
    - typings.actionsOnGoogle.distServiceActionssdkMod.Suggestions
    - typings.actionsOnGoogle.distServiceActionssdkMod.BasicCard
    - typings.actionsOnGoogle.distServiceActionssdkMod.SimpleResponse
    - typings.actionsOnGoogle.distServiceActionssdkMod.LinkOutSuggestion
    - typings.actionsOnGoogle.distServiceActionssdkMod.List
    - typings.actionsOnGoogle.distServiceActionssdkMod.Carousel
    - typings.actionsOnGoogle.distCommonMod.JsonObject
  */
