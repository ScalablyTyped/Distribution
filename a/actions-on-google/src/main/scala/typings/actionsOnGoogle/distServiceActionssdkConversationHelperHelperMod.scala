...
import typings.actionsOnGoogle.distCommonMod.ProtoAny
import typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2ExpectedIntent
import typings.actionsOnGoogle.distServiceActionssdkConversationConversationMod.InputValueSpec
...
object distServiceActionssdkConversationHelperHelperMod {
  ...
  object HelperOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: HelperOptions[?, ?], TIntent /* <: Intent */, TValueSpec] (val x: Self & (HelperOptions[TIntent, TValueSpec])) extends AnyVal {
