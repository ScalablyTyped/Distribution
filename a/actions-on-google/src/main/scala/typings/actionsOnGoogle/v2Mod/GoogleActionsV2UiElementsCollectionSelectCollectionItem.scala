...
object GoogleActionsV2UiElementsCollectionSelectCollectionItem {
  ...
  @scala.inline
  implicit class GoogleActionsV2UiElementsCollectionSelectCollectionItemMutableBuilder[Self <: GoogleActionsV2UiElementsCollectionSelectCollectionItem] (val x: Self) extends AnyVal {
