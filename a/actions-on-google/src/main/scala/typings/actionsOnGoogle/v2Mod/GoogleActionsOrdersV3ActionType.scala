...
object GoogleActionsOrdersV3ActionType {
  ...
  @scala.inline
  def DIRECTION: typings.actionsOnGoogle.actionsOnGoogleStrings.DIRECTION = "DIRECTION".asInstanceOf[typings.actionsOnGoogle.actionsOnGoogleStrings.DIRECTION]
  @scala.inline
