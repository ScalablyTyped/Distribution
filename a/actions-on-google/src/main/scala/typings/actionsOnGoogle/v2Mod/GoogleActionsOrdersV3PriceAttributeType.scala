...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.actionsOnGoogle.actionsOnGoogleStrings.REGULAR
  - typings.actionsOnGoogle.actionsOnGoogleStrings.DISCOUNT
  - typings.actionsOnGoogle.actionsOnGoogleStrings.TAX
  ...
  - typings.actionsOnGoogle.actionsOnGoogleStrings.GRATUITY
  - typings.actionsOnGoogle.actionsOnGoogleStrings.TOTAL
*/
trait GoogleActionsOrdersV3PriceAttributeType extends StObject
object GoogleActionsOrdersV3PriceAttributeType {
  ...
  inline def TOTAL: typings.actionsOnGoogle.actionsOnGoogleStrings.TOTAL = "TOTAL".asInstanceOf[typings.actionsOnGoogle.actionsOnGoogleStrings.TOTAL]
