...
/* Rewritten from type alias, can be one of: 
  - typings.actionsOnGoogle.actionsOnGoogleStrings.DEFAULT
  - typings.actionsOnGoogle.actionsOnGoogleStrings.WHITE
  - typings.actionsOnGoogle.actionsOnGoogleStrings.CROPPED
*/
