...
/* Rewritten from type alias, can be one of: 
  - typings.actionsOnGoogle.actionsOnGoogleStrings.EVENT_TYPE_UNKNOWN
  - typings.actionsOnGoogle.actionsOnGoogleStrings.MOVIE
  - typings.actionsOnGoogle.actionsOnGoogleStrings.CONCERT
  - typings.actionsOnGoogle.actionsOnGoogleStrings.SPORTS
*/
