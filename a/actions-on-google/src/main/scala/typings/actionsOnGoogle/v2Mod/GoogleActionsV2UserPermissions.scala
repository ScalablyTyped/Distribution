...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.actionsOnGoogle.actionsOnGoogleStrings.NAME
  - typings.actionsOnGoogle.actionsOnGoogleStrings.DEVICE_PRECISE_LOCATION
  - typings.actionsOnGoogle.actionsOnGoogleStrings.DEVICE_COARSE_LOCATION
