...
/* Rewritten from type alias, can be one of: 
  - typings.actionsOnGoogle.actionsOnGoogleStrings.RESERVATION_STATUS_UNSPECIFIED
  ...
  - typings.actionsOnGoogle.actionsOnGoogleStrings.FULFILLED
  - typings.actionsOnGoogle.actionsOnGoogleStrings.CHANGE_REQUESTED
  - typings.actionsOnGoogle.actionsOnGoogleStrings.REJECTED
*/
trait GoogleActionsOrdersV3VerticalsReservationReservationItemExtensionStatus extends StObject
object GoogleActionsOrdersV3VerticalsReservationReservationItemExtensionStatus {
  ...
  inline def FULFILLED: typings.actionsOnGoogle.actionsOnGoogleStrings.FULFILLED = "FULFILLED".asInstanceOf[typings.actionsOnGoogle.actionsOnGoogleStrings.FULFILLED]
  ...
  inline def RESERVATION_STATUS_UNSPECIFIED: typings.actionsOnGoogle.actionsOnGoogleStrings.RESERVATION_STATUS_UNSPECIFIED = "RESERVATION_STATUS_UNSPECIFIED".asInstanceOf[typings.actionsOnGoogle.actionsOnGoogleStrings.RESERVATION_STATUS_UNSPECIFIED]
}
