...
object commonMod {
  ...
  inline def stringify(root: Any, exclude: String*): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(List(root.asInstanceOf[js.Any]).`++`(exclude.asInstanceOf[Seq[js.Any]])*).asInstanceOf[String]
