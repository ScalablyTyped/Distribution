...
object SmartHomeV1QueryRequest {
  ...
  implicit class SmartHomeV1QueryRequestOps[Self <: SmartHomeV1QueryRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInputsVarargs(value: SmartHomeV1QueryRequestInputs*): Self = this.set("inputs", js.Array(value :_*))
    
    @scala.inline
    def setInputs(value: js.Array[SmartHomeV1QueryRequestInputs]): Self = this.set("inputs", value.asInstanceOf[js.Any])
