...
object Type {
  ...
  @scala.inline
  implicit class TypeOps[Self <: Type[_], TType] (val x: Self with Type[TType]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def `set@type`(value: TType): Self = this.set("@type", value.asInstanceOf[js.Any])
  }
