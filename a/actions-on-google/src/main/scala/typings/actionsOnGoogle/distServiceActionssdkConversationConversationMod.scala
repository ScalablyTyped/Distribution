...
import typings.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2ExpectedIntent
...
import typings.actionsOnGoogle.distServiceActionssdkConversationArgumentMod.Arguments
import typings.actionsOnGoogle.distServiceActionssdkConversationCanvasMod.Canvas
import typings.actionsOnGoogle.distServiceActionssdkConversationDeviceMod.Device
import typings.actionsOnGoogle.distServiceActionssdkConversationHelperMod.Helper
import typings.actionsOnGoogle.distServiceActionssdkConversationInputMod.Input
import typings.actionsOnGoogle.distServiceActionssdkConversationResponseHtmlMod.HtmlResponse
import typings.actionsOnGoogle.distServiceActionssdkConversationResponseMod.SimpleResponse
import typings.actionsOnGoogle.distServiceActionssdkConversationSurfaceMod.Available
import typings.actionsOnGoogle.distServiceActionssdkConversationSurfaceMod.Surface
import typings.actionsOnGoogle.distServiceActionssdkConversationUserMod.User
...
object distServiceActionssdkConversationConversationMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.actionsOnGoogle.distServiceActionssdkConversationResponseMod.RichResponse
    - typings.actionsOnGoogle.distServiceActionssdkConversationResponseRichMod.RichResponseItem
    - typings.actionsOnGoogle.distServiceActionssdkConversationResponseMod.Image
    - typings.actionsOnGoogle.distServiceActionssdkConversationResponseMod.Suggestions
    - typings.actionsOnGoogle.distServiceActionssdkConversationResponseMod.MediaObject
    - typings.actionsOnGoogle.distServiceActionssdkConversationHelperMod.Helper[
  typings.actionsOnGoogle.distServiceActionssdkConversationConversationMod.Intent, 
