...
class DialogflowApp protected ()
  ...
  /**
    ...
    * @dialogflow
    */
  def getArgument(argName: java.lang.String): js.Object = js.native
  /**
    ...
    * @dialogflow
    */
  def getContext(name: java.lang.String): js.Object = js.native
  /**
    ...
    * @dialogflow
    */
  def getContextArgument(contextName: java.lang.String, argName: java.lang.String): js.Object = js.native
  /**
  ...
  /**
    ...
    * @dialogflow
    */
  def getIncomingCarousel(): actionsDashOnDashGoogleLib.responseDashBuilderMod.Carousel = js.native
  /**
    ...
    * @dialogflow
    */
  def getIncomingList(): actionsDashOnDashGoogleLib.responseDashBuilderMod.List = js.native
  /**
    ...
    * @dialogflow
    */
  def getIncomingRichResponse(): actionsDashOnDashGoogleLib.responseDashBuilderMod.RichResponse = js.native
  /**
  ...
  /**
    ...
    * @dialogflow
    */
  def isRequestFromApiAi(key: java.lang.String, value: java.lang.String): scala.Boolean = js.native
  /**
    * Verifies whether the request comes from Dialogflow.
    *
    * @param key The header key specified by the developer in the
    ...
    * @dialogflow
    */
  def isRequestFromDialogflow(key: java.lang.String, value: java.lang.String): scala.Boolean = js.native
  /**
