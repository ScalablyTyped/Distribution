...
import typings.agDashGrid.Anon_GroupId
...
class ColumnController () extends js.Object {
  ...
  def getColumnGroupState(): js.Array[Anon_GroupId] = js.native
  ...
  def setColumnGroupState(stateItems: js.Array[Anon_GroupId]): Unit = js.native
  def setColumnGroupState(stateItems: js.Array[Anon_GroupId], source: ColumnEventType): Unit = js.native
