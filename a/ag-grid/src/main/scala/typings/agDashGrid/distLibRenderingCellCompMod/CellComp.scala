package typings.agDashGrid.distLibRenderingCellCompMod

import typings.agDashGrid.Anon_ForceRefresh
...
import typings.agDashGrid.distLibRenderingRowCompMod.RowComp
...
class CellComp protected () extends Component {
  ...
  def refreshCell(params: Anon_ForceRefresh): Unit = js.native
