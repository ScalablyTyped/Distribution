...
@js.native
object distLibWidgetsPopupServiceMod extends js.Object {
  @js.native
  class PopupService () extends js.Object {
    ...
    def positionPopupForMenu(params: Anon_EPopup): Unit = js.native
    def positionPopupOverComponent(params: Anon_ColumnEPopupEventSource): Unit = js.native
    def positionPopupUnderComponent(params: Anon_ColumnEPopup): Unit = js.native
    def positionPopupUnderMouseEvent(params: Anon_Column): Unit = js.native
  }
