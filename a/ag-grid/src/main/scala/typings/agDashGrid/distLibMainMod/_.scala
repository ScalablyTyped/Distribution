...
@js.native
class `_` ()
  extends typings.agDashGrid.distLibUtilsMod.Utils

@JSImport("ag-grid/dist/lib/main", "_")
@js.native
object `_`
  extends Instantiable0[typings.agDashGrid.distLibUtilsMod.Utils] {
  ...
  def sortRowNodesByOrder(
    rowNodes: js.Array[typings.agDashGrid.distLibEntitiesRowNodeMod.RowNode],
  ...
  def traverseNodesWithKey(
    nodes: js.Array[typings.agDashGrid.distLibEntitiesRowNodeMod.RowNode],
    callback: js.Function2[
      /* node */ typings.agDashGrid.distLibEntitiesRowNodeMod.RowNode, 
      /* key */ String, 
      Unit
    ]
  ): Unit = js.native
