...
class ColumnGroup protected ()
  extends typings.agDashGrid.distLibEntitiesColumnGroupMod.ColumnGroup {
  def this(
    originalColumnGroup: typings.agDashGrid.distLibEntitiesOriginalColumnGroupMod.OriginalColumnGroup,
    groupId: String,
    instanceId: Double
  ) = this()
}
