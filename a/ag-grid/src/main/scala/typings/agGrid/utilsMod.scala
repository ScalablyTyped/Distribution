...
object utilsMod {
  ...
  class NumberSequence () extends StObject {
    ...
    /* private */ var nextValue: js.Any = js.native
    
    def peek(): Double = js.native
    
    def skip(count: Double): Unit = js.native
    
    /* private */ var step: js.Any = js.native
  }
  ...
  class Promise[T] protected () extends StObject {
    ...
    /* private */ var listOfWaiters: js.Any = js.native
    ...
    /* private */ var resolution: js.Any = js.native
  ...
  object Promise {
    ...
    inline def all[T](toCombine: js.Array[Promise[T]]): Promise[js.Array[T]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(toCombine.asInstanceOf[js.Any]).asInstanceOf[Promise[js.Array[T]]]
    
    inline def external[T](): ExternalPromise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("external")().asInstanceOf[ExternalPromise[T]]
    
    inline def resolve[T](value: T): Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(value.asInstanceOf[js.Any]).asInstanceOf[Promise[T]]
  }
  ...
  object Utils {
    ...
    /**
      ...
      */
    inline def createIcon(iconName: String, gridOptionsWrapper: GridOptionsWrapper, column: Column): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("createIcon")(iconName.asInstanceOf[js.Any], gridOptionsWrapper.asInstanceOf[js.Any], column.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
    
    inline def createIconNoSpan(iconName: String, gridOptionsWrapper: GridOptionsWrapper, column: Column): HTMLElement = (^.asInstanceOf[js.Dynamic].applyDynamic("createIconNoSpan")(iconName.asInstanceOf[js.Any], gridOptionsWrapper.asInstanceOf[js.Any], column.asInstanceOf[js.Any])).asInstanceOf[HTMLElement]
    ...
    inline def sortRowNodesByOrder(rowNodes: js.Array[RowNode], rowNodeOrder: StringDictionary[Double]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("sortRowNodesByOrder")(rowNodes.asInstanceOf[js.Any], rowNodeOrder.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    inline def traverseNodesWithKey(nodes: js.Array[RowNode], callback: js.Function2[/* node */ RowNode, /* key */ String, Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traverseNodesWithKey")(nodes.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  object ExternalPromise {
    ...
    inline def apply[T](promise: Promise[T], resolve: T => Unit): ExternalPromise[T] = {
    ...
    extension [Self <: ExternalPromise[?], T](x: Self & ExternalPromise[T]) {
      
      inline def setPromise(value: Promise[T]): Self = StObject.set(x, "promise", value.asInstanceOf[js.Any])
