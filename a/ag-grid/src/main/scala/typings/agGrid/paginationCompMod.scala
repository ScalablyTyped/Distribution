...
@JSImport("ag-grid/dist/lib/rowModels/pagination/paginationComp", JSImport.Namespace)
@js.native
object paginationCompMod extends js.Object {
  ...
  class PaginationComp () extends Component {
    ...
    /* private */ def onBtLast(): js.Any = js.native
    
    /* private */ def onBtNext(): js.Any = js.native
    
    /* private */ def onBtPrevious(): js.Any = js.native
    ...
    /* private */ def setTotalLabels(): js.Any = js.native
    
    /* private */ def updateRowLabels(): js.Any = js.native
  }
}
