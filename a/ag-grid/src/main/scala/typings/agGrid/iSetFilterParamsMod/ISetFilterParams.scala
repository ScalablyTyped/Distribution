...
object ISetFilterParams {
  ...
  def apply(
    ...
    if (!js.isUndefined(miniFilterSearchByRefDataKey)) __obj.updateDynamic("miniFilterSearchByRefDataKey")(miniFilterSearchByRefDataKey.get.asInstanceOf[js.Any])
    if (!js.isUndefined(suppressRemoveEntries)) __obj.updateDynamic("suppressRemoveEntries")(suppressRemoveEntries.get.asInstanceOf[js.Any])
