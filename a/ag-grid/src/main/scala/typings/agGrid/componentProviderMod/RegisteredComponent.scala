...
object RegisteredComponent {
  ...
  @scala.inline
  implicit class RegisteredComponentOps[Self <: RegisteredComponent[_, _], /* <: typings.agGrid.iComponentMod.IComponent[_] with B */ A, B] (val x: Self with (RegisteredComponent[A, B])) extends AnyVal {
    @scala.inline
