...
object RowComp {
  ...
  @JSImport("ag-grid", "RowComp.DETAIL_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.DETAIL_CELL_RENDERER_COMP_NAME")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.DOM_DATA_KEY_RENDERED_ROW")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.FULL_WIDTH_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.GROUP_ROW_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.GROUP_ROW_RENDERER_COMP_NAME")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.LOADING_CELL_RENDERER")
  @js.native
  ...
  @JSImport("ag-grid", "RowComp.LOADING_CELL_RENDERER_COMP_NAME")
  @js.native
