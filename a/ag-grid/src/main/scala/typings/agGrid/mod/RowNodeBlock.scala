...
object RowNodeBlock {
  ...
  @JSImport("ag-grid", "RowNodeBlock.EVENT_LOAD_COMPLETE")
  @js.native
  ...
  @JSImport("ag-grid", "RowNodeBlock.STATE_DIRTY")
  @js.native
  ...
  @JSImport("ag-grid", "RowNodeBlock.STATE_FAILED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNodeBlock.STATE_LOADED")
  @js.native
  ...
  @JSImport("ag-grid", "RowNodeBlock.STATE_LOADING")
  @js.native
