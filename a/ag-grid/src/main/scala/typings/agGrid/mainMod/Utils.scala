...
object Utils {
  ...
  inline def get_bigrams(from: String): js.Array[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("get_bigrams")(from.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Any]]
  ...
  inline def iconNameClassMap_=(x: StringDictionary[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("iconNameClassMap")(x.asInstanceOf[js.Any])
  ...
  inline def string_similarity(str1: String, str2: String): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("string_similarity")(str1.asInstanceOf[js.Any], str2.asInstanceOf[js.Any])).asInstanceOf[Double]
