...
object colDefUtilMod {
  
  @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil")
  @js.native
  class ColDefUtil () extends StObject
  /* static members */
  object ColDefUtil {
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.ALL_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.ARRAY_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.BOOLEAN_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.FRAMEWORK_PROPERTIES")
    @js.native
    def FRAMEWORK_PROPERTIES: js.Array[String] = js.native
    inline def FRAMEWORK_PROPERTIES_=(x: js.Array[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FRAMEWORK_PROPERTIES")(x.asInstanceOf[js.Any])
    
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.FUNCTION_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.NUMBER_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.OBJECT_PROPERTIES")
    @js.native
    ...
    @JSImport("ag-grid/dist/lib/components/colDefUtil", "ColDefUtil.STRING_PROPERTIES")
    @js.native
