...
object gridMod {
  ...
  object GridParams {
    ...
    inline def apply(): GridParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GridParams]
    }
    
    extension [Self <: GridParams](x: Self) {
      
      inline def set$compile(value: js.Any): Self = StObject.set(x, "$compile", value.asInstanceOf[js.Any])
      
      inline def set$compileUndefined: Self = StObject.set(x, "$compile", js.undefined)
      ...
      inline def setFrameworkFactory(value: IFrameworkFactory): Self = StObject.set(x, "frameworkFactory", value.asInstanceOf[js.Any])
      
      inline def setFrameworkFactoryUndefined: Self = StObject.set(x, "frameworkFactory", js.undefined)
      
      inline def setGlobalEventListener(value: js.Function): Self = StObject.set(x, "globalEventListener", value.asInstanceOf[js.Any])
      
      inline def setGlobalEventListenerUndefined: Self = StObject.set(x, "globalEventListener", js.undefined)
      
      inline def setQuickFilterOnScope(value: js.Any): Self = StObject.set(x, "quickFilterOnScope", value.asInstanceOf[js.Any])
      
      inline def setQuickFilterOnScopeUndefined: Self = StObject.set(x, "quickFilterOnScope", js.undefined)
      
      inline def setSeedBeanInstances(value: StringDictionary[js.Any]): Self = StObject.set(x, "seedBeanInstances", value.asInstanceOf[js.Any])
      
      inline def setSeedBeanInstancesUndefined: Self = StObject.set(x, "seedBeanInstances", js.undefined)
    }
  }
}
