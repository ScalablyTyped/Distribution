...
object clientSideNodeManagerMod {
  ...
  class ClientSideNodeManager protected () extends StObject {
    ...
    /* private */ var allNodesMap: js.Any = js.native
    ...
    /* private */ var doesDataFlower: js.Any = js.native
    
    /* private */ var doingLegacyTreeData: js.Any = js.native
    
    /* private */ var doingMasterDetail: js.Any = js.native
    
    /* private */ var eventService: js.Any = js.native
    
    def getCopyOfNodesMap(): StringDictionary[RowNode] = js.native
    
    /* private */ var getNodeChildDetails: js.Any = js.native
    ...
    /* private */ var isRowMasterFunc: js.Any = js.native
    ...
    /* private */ var suppressParentsInRowNodes: js.Any = js.native
