...
class ScrollVisibleService () extends js.Object {
  ...
  def isBodyHorizontalScrollShowing(): scala.Boolean = js.native
  def isLeftVerticalScrollShowing(): scala.Boolean = js.native
  def isRightVerticalScrollShowing(): scala.Boolean = js.native
  def setScrollsVisible(params: SetScrollsVisibleParams): scala.Unit = js.native
}
