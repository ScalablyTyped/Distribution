package typings
package agDashGridLib.distLibGridPanelGridPanelMod
...
class GridPanel ()
  ...
  var headerRootComp: agDashGridLib.distLibHeaderRenderingHeaderRootCompMod.HeaderRootComp = js.native
  ...
  def addScrollEventListener(listener: js.Function0[scala.Unit]): scala.Unit = js.native
  ...
  def checkViewportAndScrolls(): scala.Unit = js.native
  /* private */ def disableBrowserDragging(): js.Any = js.native
  /* private */ def doHorizontalScroll(): js.Any = js.native
  def ensureColumnVisible(key: js.Any): scala.Unit = js.native
  ...
  def executeFrame(): scala.Boolean = js.native
  def getBodyClientRect(): stdLib.ClientRect = js.native
  def getBodyContainer(): stdLib.HTMLElement = js.native
  def getBodyHeight(): scala.Double = js.native
  def getBodyViewportScrollLeft(): scala.Double = js.native
  def getCenterWidth(): scala.Double = js.native
  def getDropTargetBodyContainers(): js.Array[stdLib.HTMLElement] = js.native
  def getDropTargetLeftContainers(): js.Array[stdLib.HTMLElement] = js.native
  def getDropTargetRightContainers(): js.Array[stdLib.HTMLElement] = js.native
  def getHScrollPosition(): agDashGridLib.Anon_Left = js.native
  def getRowContainers(): RowContainerComponents = js.native
  /* private */ def getRowForEvent(event: js.Any): js.Any = js.native
  def getVScrollPosition(): agDashGridLib.Anon_Bottom = js.native
  ...
  def horizontallyScrollHeaderCenterAndFloatingCenter(): scala.Unit = js.native
  @JSName("init")
  /* private */ def init_MGridPanel(): js.Any = js.native
  def isHorizontalScrollShowing(): scala.Boolean = js.native
  ...
  def onDisplayedColumnsChanged(): scala.Unit = js.native
  ...
  def removeScrollEventListener(listener: js.Function0[scala.Unit]): scala.Unit = js.native
  def scrollHorizontally(pixels: scala.Double): scala.Double = js.native
  def scrollToTop(): scala.Unit = js.native
  def scrollVertically(pixels: scala.Double): scala.Double = js.native
  def setBodyAndHeaderHeights(): scala.Unit = js.native
  def setBodyViewportScrollLeft(value: scala.Double): scala.Unit = js.native
  /* private */ def setBottomPaddingOnPinned(): js.Any = js.native
  /* private */ def setCenterWidth(): js.Any = js.native
  def setColumnMovingCss(moving: scala.Boolean): scala.Unit = js.native
  /* private */ def setElementWidth(element: js.Any, width: js.Any): js.Any = js.native
  def setHorizontalScrollPosition(hScrollPosition: scala.Double): scala.Unit = js.native
  ...
  def setVerticalScrollPosition(vScrollPosition: scala.Double): scala.Unit = js.native
  ...
  def sizeColumnsToFit(nextTimeout: scala.Double): scala.Unit = js.native
