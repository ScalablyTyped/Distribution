...
class FilterManager () extends js.Object {
  ...
  def cachedFilter(column: agDashGridLib.distLibEntitiesColumnMod.Column): FilterWrapper = js.native
  ...
  def destroyFilter(column: agDashGridLib.distLibEntitiesColumnMod.Column): scala.Unit = js.native
  def destroyFilter(
  ...
  def doesRowPassFilter(node: js.Any): scala.Boolean = js.native
  def doesRowPassFilter(node: js.Any, filterToSkip: js.Any): scala.Boolean = js.native
  def doesRowPassOtherFilters(filterToSkip: js.Any, node: js.Any): scala.Boolean = js.native
  ...
  def getFilterComponent(column: agDashGridLib.distLibEntitiesColumnMod.Column): agDashGridLib.distLibUtilsMod.Promise[agDashGridLib.distLibInterfacesIFilterMod.IFilterComp] = js.native
  def getFilterModel(): js.Any = js.native
  def getOrCreateFilterWrapper(column: agDashGridLib.distLibEntitiesColumnMod.Column): FilterWrapper = js.native
...
object FilterManager extends js.Object {
  var QUICK_FILTER_SEPARATOR: java.lang.String = js.native
}
