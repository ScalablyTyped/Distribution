...
class ComponentResolver () extends js.Object {
  ...
  /**
    ...
    */
  def createAgGridComponent[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] */](
    holderOpt: ComponentHolder,
    agGridParams: js.Any,
    propertyName: java.lang.String,
    dynamicComponentParams: DynamicComponentParams
  ): agDashGridLib.distLibUtilsMod.Promise[A] = js.native
  def createAgGridComponent[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] */](
    holderOpt: ComponentHolder,
    agGridParams: js.Any,
    propertyName: java.lang.String,
    dynamicComponentParams: DynamicComponentParams,
    defaultComponentName: java.lang.String
  ): agDashGridLib.distLibUtilsMod.Promise[A] = js.native
  def createAgGridComponent[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] */](
    holderOpt: ComponentHolder,
    agGridParams: js.Any,
  ...
  /**
    ...
    *  params are and the component that init is about to get called for
    */
  def createInternalAgGridComponent[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] */](clazz: agDashGridLib.Anon_A[A], agGridParams: js.Any): A = js.native
  def createInternalAgGridComponent[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] */](
    clazz: agDashGridLib.Anon_A[A],
    agGridParams: js.Any,
    customInitParamsCb: js.Function2[/* params */ js.Any, /* component */ A, _]
  ): A = js.native
  /**
    ...
    */
  def getComponentToUse[A /* <: agDashGridLib.distLibInterfacesIComponentMod.IComponent[_] with B */, B](
