...
class RowNode ()
  ...
  var childrenCache: agDashGridLib.distLibRowModelsCacheRowNodeCacheMod.RowNodeCache[
    agDashGridLib.distLibRowModelsCacheRowNodeBlockMod.RowNodeBlock, 
    agDashGridLib.distLibRowModelsCacheRowNodeCacheMod.RowNodeCacheParams
  ] = js.native
  /** Children mapped by the pivot columns */
  var childrenMapped: org.scalablytyped.runtime.StringDictionary[js.Any] = js.native
  ...
  var daemon: scala.Boolean = js.native
  /** The user provided data */
  var data: js.Any = js.native
  /** True if this row is a detail row, part of master / detail (ie child row of an expanded master row)*/
  var detail: scala.Boolean = js.native
  /** If master detail, this contains details about the detail grid */
  var detailGridInfo: agDashGridLib.distLibGridApiMod.DetailGridInfo = js.native
  ...
  var firstChild: scala.Boolean = js.native
  /** Same as detail, kept for legacy reasons */
  var flower: scala.Boolean = js.native
  /** Groups only - True if row is a footer. Footers  have group = true and footer = true */
  var footer: scala.Boolean = js.native
  var gridApi: js.Any = js.native
  var gridOptionsWrapper: js.Any = js.native
  /** True if this node is a group node (ie has children) */
  var group: scala.Boolean = js.native
  /** The group data */
  ...
  var lastChild: scala.Boolean = js.native
  /** True if this node is a group and the group is the bottom level in the tree */
  var leafGroup: scala.Boolean = js.native
  ...
  var master: scala.Boolean = js.native
  /** The top pixel for this row last time, makes sense if data set was ordered or filtered,
    * it is used so new rows can animate in from their old position. */
  var oldRowTop: scala.Double = js.native
  /** The parent node to this node, or empty if top level */
  var parent: RowNode = js.native
  /** If using quick filter, stores a string representation of the row for searching against */
  var quickFilterAggregateText: java.lang.String = js.native
  /** Groups only - the row group column for this group */
  var rowGroupColumn: agDashGridLib.distLibEntitiesColumnMod.Column = js.native
  ...
  var rowPinned: java.lang.String = js.native
  /** The top pixel for this row */
  var rowTop: scala.Double = js.native
  ...
  def depthFirstSearch(callback: js.Function1[/* rowNode */ this.type, scala.Unit]): scala.Unit = js.native
  ...
  def getFirstChildOfFirstChild(rowGroupColumn: agDashGridLib.distLibEntitiesColumnMod.Column): RowNode = js.native
  def getRowIndexString(): java.lang.String = js.native
  def hasChildren(): scala.Boolean = js.native
  def isEmptyFillerNode(): scala.Boolean = js.native
  def isExpandable(): scala.Boolean = js.native
  def isParentOfNode(potentialParent: RowNode): scala.Boolean = js.native
  def isPixelInRange(pixel: scala.Double): scala.Boolean = js.native
  def isRowPinned(): scala.Boolean = js.native
  def isSelected(): scala.Boolean = js.native
  def onMouseEnter(): scala.Unit = js.native
  def onMouseLeave(): scala.Unit = js.native
  def resetQuickFilterAggregateText(): scala.Unit = js.native
  /* private */ def selectChildNodes(newValue: js.Any, groupSelectsFiltered: js.Any): js.Any = js.native
  def selectThisNode(newValue: scala.Boolean): scala.Boolean = js.native
  def setAggData(newAggData: js.Any): scala.Unit = js.native
  def setAllChildrenCount(allChildrenCount: scala.Double): scala.Unit = js.native
  def setChildIndex(childIndex: scala.Double): scala.Unit = js.native
  def setData(data: js.Any): scala.Unit = js.native
  def setDataAndId(data: js.Any, id: java.lang.String): scala.Unit = js.native
  def setDataValue(colKey: agDashGridLib.distLibEntitiesColumnMod.Column, newValue: js.Any): scala.Unit = js.native
  def setDataValue(colKey: java.lang.String, newValue: js.Any): scala.Unit = js.native
  def setDragging(dragging: scala.Boolean): scala.Unit = js.native
  def setExpanded(expanded: scala.Boolean): scala.Unit = js.native
  def setFirstChild(firstChild: scala.Boolean): scala.Unit = js.native
  def setGroupValue(colKey: agDashGridLib.distLibEntitiesColumnMod.Column, newValue: js.Any): scala.Unit = js.native
  def setGroupValue(colKey: java.lang.String, newValue: js.Any): scala.Unit = js.native
  def setId(id: java.lang.String): scala.Unit = js.native
  def setLastChild(lastChild: scala.Boolean): scala.Unit = js.native
  def setRowHeight(rowHeight: scala.Double): scala.Unit = js.native
  def setRowIndex(rowIndex: scala.Double): scala.Unit = js.native
  def setRowSelectable(newVal: scala.Boolean): scala.Unit = js.native
  def setRowTop(rowTop: scala.Double): scala.Unit = js.native
  def setSelected(newValue: scala.Boolean): scala.Unit = js.native
  def setSelected(newValue: scala.Boolean, clearSelection: scala.Boolean): scala.Unit = js.native
  def setSelected(newValue: scala.Boolean, clearSelection: scala.Boolean, suppressFinishActions: scala.Boolean): scala.Unit = js.native
  def setSelectedInitialValue(selected: scala.Boolean): scala.Unit = js.native
  def setSelectedParams(params: SetSelectedParams): scala.Double = js.native
  def setUiLevel(uiLevel: scala.Double): scala.Unit = js.native
...
object RowNode extends js.Object {
  var EVENT_ALL_CHILDREN_COUNT_CHANGED: java.lang.String = js.native
  var EVENT_CELL_CHANGED: java.lang.String = js.native
  var EVENT_CHILD_INDEX_CHANGED: java.lang.String = js.native
  var EVENT_DATA_CHANGED: java.lang.String = js.native
  var EVENT_DRAGGING_CHANGED: java.lang.String = js.native
  var EVENT_EXPANDED_CHANGED: java.lang.String = js.native
  var EVENT_FIRST_CHILD_CHANGED: java.lang.String = js.native
  var EVENT_HEIGHT_CHANGED: java.lang.String = js.native
  var EVENT_LAST_CHILD_CHANGED: java.lang.String = js.native
  var EVENT_MOUSE_ENTER: java.lang.String = js.native
  var EVENT_MOUSE_LEAVE: java.lang.String = js.native
  var EVENT_ROW_INDEX_CHANGED: java.lang.String = js.native
  var EVENT_ROW_SELECTED: java.lang.String = js.native
  var EVENT_SELECTABLE_CHANGED: java.lang.String = js.native
  var EVENT_TOP_CHANGED: java.lang.String = js.native
  var EVENT_UI_LEVEL_CHANGED: java.lang.String = js.native
}
