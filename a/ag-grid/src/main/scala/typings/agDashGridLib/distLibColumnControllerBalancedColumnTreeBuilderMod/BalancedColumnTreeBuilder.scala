package typings
package agDashGridLib.distLibColumnControllerBalancedColumnTreeBuilderMod
...
class BalancedColumnTreeBuilder () extends js.Object {
  ...
  def createForAutoGroups(
    autoGroupCols: js.Array[agDashGridLib.distLibEntitiesColumnMod.Column],
    gridBalancedTree: js.Array[
  ...
  def mergeColDefs(colDef: agDashGridLib.distLibEntitiesColDefMod.ColDef): agDashGridLib.distLibEntitiesColDefMod.ColDef = js.native
