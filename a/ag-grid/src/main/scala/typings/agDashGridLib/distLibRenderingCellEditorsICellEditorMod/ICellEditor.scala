...
trait ICellEditor extends js.Object {
  ...
  var focusIn: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
  /** If doing full line edit, then gets called when focus is leaving the editor */
  var focusOut: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
  ...
  var isCancelAfterEnd: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  /** Gets called once after initialised. If you return true, the editor will not be used and the grid will continue
    ...
    * */
  var isCancelBeforeStart: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
  ...
  var isPopup: js.UndefOr[js.Function0[scala.Boolean]] = js.undefined
