...
trait IComponent[T] extends js.Object {
  /** A hook to perform any necessary operation just after the gui for this component has been renderer
    ...
    after it is pressed. */
  var afterGuiAttached: js.UndefOr[js.Function1[/* params */ js.UndefOr[IAfterGuiAttachedParams], scala.Unit]] = js.undefined
  ...
  var init: js.UndefOr[
    js.Function1[/* params */ T, agDashGridLib.distLibUtilsMod.Promise[scala.Unit] | scala.Unit]
  ] = js.undefined
  /** Return the DOM element of your editor, this is what the grid puts into the DOM */
  def getGui(): stdLib.HTMLElement
}
...
object IComponent {
  ...
  def apply[T](
    ...
    afterGuiAttached: /* params */ js.UndefOr[IAfterGuiAttachedParams] => scala.Unit = null,
    destroy: () => scala.Unit = null,
    init: /* params */ T => agDashGridLib.distLibUtilsMod.Promise[scala.Unit] | scala.Unit = null
  ): IComponent[T] = {
