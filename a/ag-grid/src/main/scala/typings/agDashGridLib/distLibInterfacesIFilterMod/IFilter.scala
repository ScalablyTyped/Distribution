...
trait IFilter extends js.Object {
  ...
  /**
    ...
    * filter.
    */
  var getModelAsString: js.UndefOr[js.Function1[/* model */ js.Any, java.lang.String]] = js.undefined
  /**
    ...
    */
  var onFloatingFilterChanged: js.UndefOr[js.Function1[/* change */ js.Any, scala.Unit]] = js.undefined
  ...
  var onNewRowsLoaded: js.UndefOr[js.Function0[scala.Unit]] = js.undefined
  /** The grid will ask each active filter, in turn, whether each row in the grid passes. If any
    filter fails, then the row will be excluded from the final set. The method is provided a
    params object with attributes node (the rodNode the grid creates that wraps the data) and data
    (the data object that you provided to the grid for that row). */
  def doesFilterPass(params: IDoesFilterPassParams): scala.Boolean
  ...
  def isFilterActive(): scala.Boolean
  /** Restores the filter state. */
  def setModel(model: js.Any): scala.Unit
}
