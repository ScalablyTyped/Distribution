...
name := "antd"
version := "3.10.1-c80deb"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "ant-design__icons" % "1.1.15-11d199",
  "com.scalablytyped" %%% "ant-design__icons-react" % "1.1.2-cae58a",
  ...
  "com.scalablytyped" %%% "rc-calendar" % "9.7.10-e47b7e",
  "com.scalablytyped" %%% "rc-dialog" % "7.2.1-6df9d0",
  "com.scalablytyped" %%% "rc-progress" % "2.2-dt-20181120Z-ee1b59",
  "com.scalablytyped" %%% "rc-select" % "v5.9.0-dt-20180910Z-4bd849",
  "com.scalablytyped" %%% "rc-slider" % "8.6-dt-20180910Z-363582",
  "com.scalablytyped" %%% "rc-time-picker" % "3.4-dt-20181104Z-8bd373",
  "com.scalablytyped" %%% "rc-tooltip" % "v3.4.2-dt-20180910Z-1625e1",
  "com.scalablytyped" %%% "rc-tree" % "1.11-dt-20180910Z-f812e9",
  "com.scalablytyped" %%% "react" % "16.7-dt-20181116Z-44bb36",
  "com.scalablytyped" %%% "react-dom" % "16.0-dt-20181009Z-140611",
  "com.scalablytyped" %%% "react-slick" % "0.23-dt-20180910Z-02852f",
