...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ant-design__icons-react" % "1.1.2-8ee74a",
  "org.scalablytyped" %%% "array-tree-filter" % "2.1.0-35ff1a",
  "org.scalablytyped" %%% "classnames" % "2.2-dt-20181230Z-6d1ba2",
  "org.scalablytyped" %%% "create-react-class" % "15.6-dt-20180806Z-76524a",
  ...
  "org.scalablytyped" %%% "rc-slider" % "8.6-dt-20180822Z-f2986d",
  "org.scalablytyped" %%% "rc-time-picker" % "3.4-dt-20181102Z-276af5",
  "org.scalablytyped" %%% "rc-tooltip" % "3.7-dt-20181121Z-1ddb63",
