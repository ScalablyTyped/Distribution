...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "ant-design__icons-react" % "1.1.2-a38076",
  ...
  "org.scalablytyped" %%% "rc-calendar" % "9.8.1-fb5418",
  "org.scalablytyped" %%% "rc-dialog" % "7.2.1-43bf66",
  "org.scalablytyped" %%% "rc-progress" % "2.2-dt-20181120Z-030f77",
  "org.scalablytyped" %%% "rc-select" % "v5.9.0-dt-20180910Z-32128d",
  "org.scalablytyped" %%% "rc-slider" % "8.6-dt-20180910Z-9ec6e6",
  "org.scalablytyped" %%% "rc-time-picker" % "3.4-dt-20181104Z-a91b1f",
  "org.scalablytyped" %%% "rc-tooltip" % "3.7-dt-20181121Z-094744",
  "org.scalablytyped" %%% "rc-tree" % "1.11-dt-20180910Z-eab48b",
  "org.scalablytyped" %%% "react" % "16.7-dt-20181203Z-df71a8",
  "org.scalablytyped" %%% "react-dom" % "16.0-dt-20181122Z-f8a261",
  "org.scalablytyped" %%% "react-slick" % "0.23-dt-20180910Z-1fdbd6",
