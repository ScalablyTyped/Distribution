...
object libAffixUtilsMod {
  
  @JSImport("antd/lib/affix/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def addObserveTarget[T](): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addObserveTarget")().asInstanceOf[Unit]
  ...
  inline def addObserveTarget[T](target: HTMLElement): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addObserveTarget")(target.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def addObserveTarget[T](target: Window): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addObserveTarget")(target.asInstanceOf[js.Any]).asInstanceOf[Unit]
