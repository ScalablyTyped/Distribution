...
object inputNumberMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[InputNumberProps with RefAttributes[_]] = js.native
  ...
  */
  ...
  type _To = ForwardRefExoticComponent[InputNumberProps with RefAttributes[_]]
  
  /* This means you don't have to write `default`, but can instead just say `inputNumberMod.foo` */
  override def _to: ForwardRefExoticComponent[InputNumberProps with RefAttributes[_]] = default
}
