...
object inputNumberMod extends Shortcut {
  
  @JSImport("antd/lib/input-number", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[InputNumberProps & RefAttributes[js.Any]] = js.native
  ...
  trait InputNumberProps extends StObject {
    ...
    var onStep: js.UndefOr[js.Function2[/* value */ Double, /* info */ Offset, Unit]] = js.undefined
  ...
  object InputNumberProps {
    ...
    implicit class InputNumberPropsMutableBuilder[Self <: InputNumberProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnStep(value: (/* value */ Double, /* info */ Offset) => Unit): Self = StObject.set(x, "onStep", js.Any.fromFunction2(value))
      
      @scala.inline
      def setOnStepUndefined: Self = StObject.set(x, "onStep", js.undefined)
  ...
  */
  trait OmitAttrs extends StObject
  object OmitAttrs {
    
    @scala.inline
    def defaultValue: typings.antd.antdStrings.defaultValue = "defaultValue".asInstanceOf[typings.antd.antdStrings.defaultValue]
    
    @scala.inline
    def onChange: typings.antd.antdStrings.onChange = "onChange".asInstanceOf[typings.antd.antdStrings.onChange]
    
    @scala.inline
    def size: typings.antd.antdStrings.size = "size".asInstanceOf[typings.antd.antdStrings.size]
  }
  
  type _To = ForwardRefExoticComponent[InputNumberProps & RefAttributes[js.Any]]
  
  /* This means you don't have to write `default`, but can instead just say `inputNumberMod.foo` */
  override def _to: ForwardRefExoticComponent[InputNumberProps & RefAttributes[js.Any]] = default
}
