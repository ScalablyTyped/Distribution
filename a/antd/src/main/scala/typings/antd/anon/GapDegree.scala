...
object GapDegree {
  ...
  inline def apply(gapDegree: Unit, percent: Double, showInfo: Boolean, trailColor: Null): GapDegree = {
  ...
  extension [Self <: GapDegree](x: Self) {
    
    inline def setGapDegree(value: Unit): Self = StObject.set(x, "gapDegree", value.asInstanceOf[js.Any])
    
    inline def setPercent(value: Double): Self = StObject.set(x, "percent", value.asInstanceOf[js.Any])
    
    inline def setShowInfo(value: Boolean): Self = StObject.set(x, "showInfo", value.asInstanceOf[js.Any])
    
    inline def setSize(value: small | default): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
    
    inline def setSizeUndefined: Self = StObject.set(x, "size", js.undefined)
    
    inline def setStrokeLinecap(value: round | butt | square): Self = StObject.set(x, "strokeLinecap", value.asInstanceOf[js.Any])
    
    inline def setStrokeLinecapUndefined: Self = StObject.set(x, "strokeLinecap", js.undefined)
    
    inline def setTrailColor(value: Null): Self = StObject.set(x, "trailColor", value.asInstanceOf[js.Any])
    
    inline def setType(value: circle | line | dashboard): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
