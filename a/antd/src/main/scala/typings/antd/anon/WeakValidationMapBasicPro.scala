...
@js.native
trait WeakValidationMapBasicPro extends js.Object {
  ...
  var hasSider: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.native
...
object WeakValidationMapBasicPro {
  @scala.inline
  def apply(): WeakValidationMapBasicPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapBasicPro]
  }
  @scala.inline
  implicit class WeakValidationMapBasicProOps[Self <: WeakValidationMapBasicPro] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setHasSider(value: Validator[js.UndefOr[Boolean | Null]]): Self = this.set("hasSider", value.asInstanceOf[js.Any])
    @scala.inline
