...
/* Inlined antd.antd/lib/locale-provider.Locale & {  exist :boolean | undefined} */
trait Localeexistbooleanundefin extends StObject {
...
object Localeexistbooleanundefin {
  
  inline def apply(locale: String): Localeexistbooleanundefin = {
    val __obj = js.Dynamic.literal(locale = locale.asInstanceOf[js.Any])
    __obj.asInstanceOf[Localeexistbooleanundefin]
  }
  
  extension [Self <: Localeexistbooleanundefin](x: Self) {
