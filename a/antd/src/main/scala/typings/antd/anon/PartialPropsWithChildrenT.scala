...
/* Inlined std.Partial<react.react.PropsWithChildren<antd.antd/lib/tree/Tree.TreeProps<any>>> */
trait PartialPropsWithChildrenT extends StObject {
...
object PartialPropsWithChildrenT {
  
  inline def apply(): PartialPropsWithChildrenT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialPropsWithChildrenT]
  }
  
  extension [Self <: PartialPropsWithChildrenT](x: Self) {
