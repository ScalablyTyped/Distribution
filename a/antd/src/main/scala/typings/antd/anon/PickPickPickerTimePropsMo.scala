...
object PickPickPickerTimePropsMo {
  ...
  implicit class PickPickPickerTimePropsMoMutableBuilder[Self <: PickPickPickerTimePropsMo] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMonthCellRender(value: (Moment, /* locale */ typings.rcPicker.interfaceMod.Locale) => ReactNode): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
