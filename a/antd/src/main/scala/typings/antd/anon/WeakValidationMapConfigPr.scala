...
object WeakValidationMapConfigPr {
  ...
  extension [Self <: WeakValidationMapConfigPr](x: Self) {
    ...
    inline def setAutoInsertSpaceInButton(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "autoInsertSpaceInButton", value.asInstanceOf[js.Any])
    ...
    inline def setCsp(value: Validator[js.UndefOr[CSPConfig | Null]]): Self = StObject.set(x, "csp", value.asInstanceOf[js.Any])
    
    inline def setCspUndefined: Self = StObject.set(x, "csp", js.undefined)
    
    inline def setDirection(value: Validator[js.UndefOr[DirectionType | Null]]): Self = StObject.set(x, "direction", value.asInstanceOf[js.Any])
    
    inline def setDirectionUndefined: Self = StObject.set(x, "direction", js.undefined)
    
    inline def setDropdownMatchSelectWidth(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "dropdownMatchSelectWidth", value.asInstanceOf[js.Any])
    ...
    inline def setLocale(value: Validator[js.UndefOr[typings.antd.localeProviderMod.Locale | Null]]): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
    ...
    inline def setRenderEmpty(value: Validator[js.UndefOr[Null | RenderEmptyHandler]]): Self = StObject.set(x, "renderEmpty", value.asInstanceOf[js.Any])
    
    inline def setRenderEmptyUndefined: Self = StObject.set(x, "renderEmpty", js.undefined)
    
    inline def setSpace(value: Validator[js.UndefOr[Null | Size]]): Self = StObject.set(x, "space", value.asInstanceOf[js.Any])
    
    inline def setSpaceUndefined: Self = StObject.set(x, "space", js.undefined)
    
    inline def setVirtual(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "virtual", value.asInstanceOf[js.Any])
