...
object PartialAutoCompletePropsR {
  ...
  @scala.inline
  implicit class PartialAutoCompletePropsROps[Self <: PartialAutoCompletePropsR] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInternalProps(value: typings.rcSelect.anon.Mark[OptionsType]): Self = this.set("internalProps", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setRef(value: typings.react.mod.Ref[RefSelectProps]): Self = this.set("ref", value.asInstanceOf[js.Any])
