...
trait OmitPickerDatePropsMoment extends StObject {
...
object OmitPickerDatePropsMoment {
  
  inline def apply(): OmitPickerDatePropsMoment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitPickerDatePropsMoment]
  }
  
  extension [Self <: OmitPickerDatePropsMoment](x: Self) {
