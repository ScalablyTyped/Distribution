...
object PickSegmentedPropschildre {
  ...
  extension [Self <: PickSegmentedPropschildre](x: Self) {
    ...
    inline def setOnChange(value: /* value */ SegmentedValue => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
