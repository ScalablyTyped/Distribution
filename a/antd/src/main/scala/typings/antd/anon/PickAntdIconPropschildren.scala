...
object PickAntdIconPropschildren {
  ...
  @scala.inline
  def apply(): PickAntdIconPropschildren = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickAntdIconPropschildren]
  }
  
  @scala.inline
  implicit class PickAntdIconPropschildrenMutableBuilder[Self <: PickAntdIconPropschildren] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: typings.react.mod.Ref[HTMLSpanElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
