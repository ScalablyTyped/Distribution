...
trait PickAntdIconPropschildren extends StObject {
  ...
  var ref: js.UndefOr[typings.react.mod.Ref[HTMLSpanElement]] = js.undefined
...
object PickAntdIconPropschildren {
  
  inline def apply(): PickAntdIconPropschildren = {
  ...
  implicit open class MutableBuilder[Self <: PickAntdIconPropschildren] (val x: Self) extends AnyVal {
    ...
    inline def setRef(value: typings.react.mod.Ref[HTMLSpanElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
