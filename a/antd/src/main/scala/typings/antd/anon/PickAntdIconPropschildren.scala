...
@js.native
trait PickAntdIconPropschildren extends js.Object {
...
object PickAntdIconPropschildren {
  ...
  @scala.inline
  implicit class PickAntdIconPropschildrenOps[Self <: PickAntdIconPropschildren] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setRef(value: typings.react.mod.Ref[HTMLSpanElement]): Self = this.set("ref", value.asInstanceOf[js.Any])
