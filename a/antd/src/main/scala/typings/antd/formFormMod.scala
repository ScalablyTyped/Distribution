...
object formFormMod {
  ...
  @scala.inline
  def default[Values](props: Children[Values] & FormProps[Values]): ReactElement = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[ReactElement]
