...
object RcCustomRequestOptions {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(action = action, data = data, file = file, filename = filename, headers = headers, onError = js.Any.fromFunction1(onError), onProgress = js.Any.fromFunction2(onProgress), onSuccess = js.Any.fromFunction2(onSuccess), withCredentials = withCredentials)
