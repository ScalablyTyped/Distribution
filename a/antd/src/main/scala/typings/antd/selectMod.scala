...
object selectMod extends Shortcut {
  ...
  @js.native
  val default: SelectInterface = js.native
  
  /* Inlined parent std.Omit<rc-select.rc-select.SelectProps<VT>, 'mode'> */
  trait InternalSelectProps[VT] extends StObject {
  ...
  object InternalSelectProps {
    ...
    inline def apply[VT](): InternalSelectProps[VT] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[InternalSelectProps[VT]]
    }
    
    extension [Self <: InternalSelectProps[?], VT](x: Self & InternalSelectProps[VT]) {
      ...
      inline def setDefaultValue(value: VT): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      ...
      inline def setMode(value: multiple | tags | SECRET_COMBOBOX_MODE_DO_NOT_USE): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
      ...
      inline def setValue(value: VT): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  ...
  @js.native
  trait InternalSelectType extends StObject {
    
    def apply[VT /* <: SelectValue */](props: SelectProps[VT] & Ref): ReactElement = js.native
  }
  ...
  @js.native
  trait SelectInterface
    extends StObject
       with InternalSelectType {
  ...
  trait SelectProps[VT] extends StObject {
  ...
  object SelectProps {
    ...
    inline def apply[VT](): SelectProps[VT] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SelectProps[VT]]
    }
    
    extension [Self <: SelectProps[?], VT](x: Self & SelectProps[VT]) {
      ...
      inline def setMode(value: multiple | tags): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
