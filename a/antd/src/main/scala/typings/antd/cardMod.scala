...
object cardMod extends Shortcut {
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setActiveTabKey(value: String): Self = StObject.set(x, "activeTabKey", value.asInstanceOf[js.Any])
      
      inline def setActiveTabKeyUndefined: Self = StObject.set(x, "activeTabKey", js.undefined)
      ...
      inline def setCover(value: ReactNode): Self = StObject.set(x, "cover", value.asInstanceOf[js.Any])
      ...
      inline def setDefaultActiveTabKey(value: String): Self = StObject.set(x, "defaultActiveTabKey", value.asInstanceOf[js.Any])
      
      inline def setDefaultActiveTabKeyUndefined: Self = StObject.set(x, "defaultActiveTabKey", js.undefined)
      ...
      inline def setHeadStyle(value: CSSProperties): Self = StObject.set(x, "headStyle", value.asInstanceOf[js.Any])
      
      inline def setHeadStyleUndefined: Self = StObject.set(x, "headStyle", js.undefined)
      ...
      inline def setTabList(value: js.Array[CardTabListType]): Self = StObject.set(x, "tabList", value.asInstanceOf[js.Any])
      
      inline def setTabListUndefined: Self = StObject.set(x, "tabList", js.undefined)
      
      inline def setTabListVarargs(value: CardTabListType*): Self = StObject.set(x, "tabList", js.Array(value :_*))
  ...
  */
  ...
  object CardTabListType {
    ...
    inline def apply(key: String): CardTabListType = {
