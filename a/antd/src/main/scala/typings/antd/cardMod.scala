...
object cardMod extends Shortcut {
  ...
  trait CardProps extends StObject {
    ...
    var cover: js.UndefOr[ReactNode] = js.native
    ...
    var tabBarExtraContent: js.UndefOr[ReactNode | Null] = js.native
  ...
  object CardProps {
    ...
    implicit class CardPropsMutableBuilder[Self <: CardProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setCover(value: ReactNode): Self = StObject.set(x, "cover", value.asInstanceOf[js.Any])
