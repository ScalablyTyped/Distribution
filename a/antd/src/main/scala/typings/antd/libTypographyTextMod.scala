...
object libTypographyTextMod extends Shortcut {
  ...
  /* Inlined parent antd.antd/lib/typography/Base.BlockProps<'span'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLSpanElement>, 'type' | keyof antd.antd/lib/typography/Base.BlockProps<'span'>> */
  trait TextProps extends StObject {
    ...
    var ellipsis: js.UndefOr[Boolean | OmitEllipsisConfigexpanda] = js.undefined
