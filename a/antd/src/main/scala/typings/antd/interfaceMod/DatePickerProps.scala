...
trait DatePickerProps
  ...
  var disabledTime: js.UndefOr[js.Function1[/* current */ js.UndefOr[Moment | Null], AnonDisabledHours]] = js.undefined
...
object DatePickerProps {
  ...
  def apply(
    ...
    disabledTime: /* current */ js.UndefOr[Moment | Null] => AnonDisabledHours = null,
