...
import typings.antd.AnonDisabledHours
...
trait RangePickerProps extends PickerProps {
  ...
  var disabledTime: js.UndefOr[
    js.Function2[/* current */ RangePickerValue, /* type */ String, AnonDisabledHours]
  ] = js.undefined
...
object RangePickerProps {
  ...
  def apply(
    ...
    disabledTime: (/* current */ RangePickerValue, /* type */ String) => AnonDisabledHours = null,
    ...
    onMouseEnter: /* e */ typings.react.mod.MouseEvent[HTMLSpanElement, MouseEvent] => Unit = null,
    onMouseLeave: /* e */ typings.react.mod.MouseEvent[HTMLSpanElement, MouseEvent] => Unit = null,
