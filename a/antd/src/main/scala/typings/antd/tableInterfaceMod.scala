...
object tableInterfaceMod {
  ...
  object ColumnFilterItem {
    ...
    extension [Self <: ColumnFilterItem](x: Self) {
      ...
      inline def setChildrenVarargs(value: ColumnFilterItem*): Self = StObject.set(x, "children", js.Array(value :_*))
  ...
  object ColumnGroupType {
    ...
    extension [Self <: ColumnGroupType[?], RecordType](x: Self & ColumnGroupType[RecordType]) {
      ...
      inline def setDefaultFilteredValue(value: js.Array[Key]): Self = StObject.set(x, "defaultFilteredValue", value.asInstanceOf[js.Any])
      ...
      inline def setDefaultFilteredValueVarargs(value: Key*): Self = StObject.set(x, "defaultFilteredValue", js.Array(value :_*))
      ...
      inline def setFilteredValue(value: js.Array[Key]): Self = StObject.set(x, "filteredValue", value.asInstanceOf[js.Any])
      ...
      inline def setFilteredValueVarargs(value: Key*): Self = StObject.set(x, "filteredValue", js.Array(value :_*))
      ...
      inline def setFiltersVarargs(value: ColumnFilterItem*): Self = StObject.set(x, "filters", js.Array(value :_*))
  ...
  object ColumnTitleProps {
    ...
    extension [Self <: ColumnTitleProps[?], RecordType](x: Self & ColumnTitleProps[RecordType]) {
      ...
      inline def setSortColumnsVarargs(value: Column[RecordType]*): Self = StObject.set(x, "sortColumns", js.Array(value :_*))
  ...
  */
  ...
  object FilterDropdownProps {
    ...
    extension [Self <: FilterDropdownProps](x: Self) {
      
      inline def setClearFilters(value: () => Unit): Self = StObject.set(x, "clearFilters", js.Any.fromFunction0(value))
      
      inline def setClearFiltersUndefined: Self = StObject.set(x, "clearFilters", js.undefined)
      ...
      inline def setSelectedKeys(value: js.Array[typings.react.mod.Key]): Self = StObject.set(x, "selectedKeys", value.asInstanceOf[js.Any])
      
      inline def setSelectedKeysVarargs(value: typings.react.mod.Key*): Self = StObject.set(x, "selectedKeys", js.Array(value :_*))
      
      inline def setSetSelectedKeys(value: js.Array[typings.react.mod.Key] => Unit): Self = StObject.set(x, "setSelectedKeys", js.Any.fromFunction1(value))
  ...
  */
  ...
  object RowSelectionType {
    ...
    inline def checkbox: typings.antd.antdStrings.checkbox = "checkbox".asInstanceOf[typings.antd.antdStrings.checkbox]
    
    inline def radio: typings.antd.antdStrings.radio = "radio".asInstanceOf[typings.antd.antdStrings.radio]
  }
  ...
  */
  ...
  object SorterResult {
    ...
    extension [Self <: SorterResult[?], RecordType](x: Self & SorterResult[RecordType]) {
      ...
      inline def setFieldVarargs(value: Key*): Self = StObject.set(x, "field", js.Array(value :_*))
  ...
  */
  ...
  object TableCurrentDataSource {
    ...
    extension [Self <: TableCurrentDataSource[?], RecordType](x: Self & TableCurrentDataSource[RecordType]) {
      ...
      inline def setCurrentDataSourceVarargs(value: RecordType*): Self = StObject.set(x, "currentDataSource", js.Array(value :_*))
    }
  }
  ...
  object TablePaginationConfig {
    ...
    extension [Self <: TablePaginationConfig](x: Self) {
      ...
      inline def setPositionVarargs(value: TablePaginationPosition*): Self = StObject.set(x, "position", js.Array(value :_*))
    }
  }
  ...
  */
  ...
  object TableRowSelection {
    ...
    extension [Self <: TableRowSelection[?], T](x: Self & TableRowSelection[T]) {
      ...
      inline def setOnChange(value: (/* selectedRowKeys */ js.Array[Key], /* selectedRows */ js.Array[T]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      ...
      inline def setSelectedRowKeysVarargs(value: Key*): Self = StObject.set(x, "selectedRowKeys", js.Array(value :_*))
      ...
      inline def setSelectionsVarargs(value: INTERNAL_SELECTION_ITEM*): Self = StObject.set(x, "selections", js.Array(value :_*))
