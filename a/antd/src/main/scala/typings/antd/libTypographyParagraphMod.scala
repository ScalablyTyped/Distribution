...
object libTypographyParagraphMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[ParagraphProps & RefAttributes[HTMLElement]] = js.native
  
  /* Inlined parent antd.antd/lib/typography/Base.BlockProps<'div'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLDivElement>, 'type' | keyof antd.antd/lib/typography/Base.BlockProps<'div'>> */
  ...
  type _To = ForwardRefExoticComponent[ParagraphProps & RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `libTypographyParagraphMod.foo` */
  override def _to: ForwardRefExoticComponent[ParagraphProps & RefAttributes[HTMLElement]] = default
}
