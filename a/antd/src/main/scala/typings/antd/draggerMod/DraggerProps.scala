...
object DraggerProps {
  ...
  @scala.inline
  implicit class DraggerPropsOps[Self <: DraggerProps] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDataFunction1(value: /* file */ UploadFile[_] => js.Object): Self = this.set("data", js.Any.fromFunction1(value))
    @scala.inline
    def setData(value: js.Object | (js.Function1[/* file */ UploadFile[_], js.Object])): Self = this.set("data", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setIconRender(value: (/* file */ UploadFile[_], /* listType */ js.UndefOr[UploadListType]) => ReactNode): Self = this.set("iconRender", js.Any.fromFunction2(value))
    @scala.inline
    ...
    @scala.inline
    def setOnDownload(value: /* file */ UploadFile[_] => Unit): Self = this.set("onDownload", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnDownload: Self = this.set("onDownload", js.undefined)
    @scala.inline
    def setOnPreview(value: /* file */ UploadFile[_] => Unit): Self = this.set("onPreview", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnPreview: Self = this.set("onPreview", js.undefined)
    @scala.inline
    def setOnRemove(value: /* file */ UploadFile[_] => Unit | Boolean | (js.Promise[Unit | Boolean])): Self = this.set("onRemove", js.Any.fromFunction1(value))
    @scala.inline
