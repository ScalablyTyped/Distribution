...
object libInputNumberMod extends Shortcut {
  ...
  @js.native
  val default: (js.Function1[/* props */ `2` & InputNumberProps[ValueType], ReactElement]) & `3` = js.native
  ...
  object InputNumberProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: InputNumberProps[?], T /* <: ValueType */] (val x: Self & InputNumberProps[T]) extends AnyVal {
      ...
      inline def setOnChange(value: /* value */ T | Null => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnInput(value: /* text */ String => Unit): Self = StObject.set(x, "onInput", js.Any.fromFunction1(value))
      ...
      inline def setOnStep(value: (/* value */ T, /* info */ Offset) => Unit): Self = StObject.set(x, "onStep", js.Any.fromFunction2(value))
  ...
  type _To = (js.Function1[/* props */ `2` & InputNumberProps[ValueType], ReactElement]) & `3`
  
  /* This means you don't have to write `default`, but can instead just say `libInputNumberMod.foo` */
  override def _to: (js.Function1[/* props */ `2` & InputNumberProps[ValueType], ReactElement]) & `3` = default
}
