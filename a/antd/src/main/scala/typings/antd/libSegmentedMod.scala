...
object libSegmentedMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon
    - typings.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon
  */
  trait SegmentedLabeledOption extends StObject
  object SegmentedLabeledOption {
    
    inline def SegmentedLabeledOptionWithIcon(value: SegmentedRawOption): typings.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon]
    }
    
    inline def SegmentedLabeledOptionWithoutIcon(value: SegmentedRawOption): typings.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon]
    }
  }
