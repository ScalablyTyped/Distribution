...
trait FormProps[Values] extends js.Object {
  ...
  var children: js.UndefOr[RenderProps | ReactNode] = js.native
...
object FormProps {
  ...
  implicit class FormPropsOps[Self <: FormProps[_], Values] (val x: Self with FormProps[Values]) extends AnyVal {
    ...
    def setChildrenFunction2(
      value: (/* values */ Store, /* form */ typings.rcFieldForm.interfaceMod.FormInstance[js.Any]) => Element | ReactNode
    ...
    @scala.inline
    def setOnChange(value: FormEvent[HTMLFormElement] => Unit): Self = this.set("onChange", js.Any.fromFunction1(value))
