...
import typings.antd.anon.Fn1
import typings.antd.anon.FnCall_
import typings.antd.anon.PartialTablePropsany
...
object tableTableMod extends Shortcut {
  ...
  trait TableInterface
    ...
    var defaultProps: js.UndefOr[PartialTablePropsany] = js.native
  }
  ...
  object TableProps {
    ...
    extension [Self <: TableProps[?], RecordType](x: Self & TableProps[RecordType]) {
      ...
      inline def setColumnsVarargs(value: (ColumnGroupType[RecordType] | typings.antd.tableInterfaceMod.ColumnType[RecordType])*): Self = StObject.set(x, "columns", js.Array(value*))
