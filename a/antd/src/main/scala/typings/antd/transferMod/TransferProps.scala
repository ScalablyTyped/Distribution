...
trait TransferProps extends js.Object {
  var children: js.UndefOr[js.Function1[/* props */ TransferListBodyProps, ReactNode]] = js.native
  ...
  var footer: js.UndefOr[js.Function1[/* props */ TransferListProps, ReactNode]] = js.native
...
object TransferProps {
  ...
  implicit class TransferPropsOps[Self <: TransferProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChildren(value: /* props */ TransferListBodyProps => ReactNode): Self = this.set("children", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setFooter(value: /* props */ TransferListProps => ReactNode): Self = this.set("footer", js.Any.fromFunction1(value))
    @scala.inline
