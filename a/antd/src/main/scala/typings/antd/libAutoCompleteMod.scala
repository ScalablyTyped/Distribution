...
object libAutoCompleteMod extends Shortcut {
  ...
  object AutoCompleteProps {
    ...
    extension [Self <: AutoCompleteProps[?, ?], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](x: Self & (AutoCompleteProps[ValueType, OptionType])) {
      ...
      inline def setDataSource(value: js.Array[DataSourceItemType]): Self = StObject.set(x, "dataSource", value.asInstanceOf[js.Any])
  ...
  object DataSourceItemObject {
    ...
    inline def apply(text: String, value: String): DataSourceItemObject = {
  ...
  /* This means you don't have to write `default`, but can instead just say `libAutoCompleteMod.foo` */
