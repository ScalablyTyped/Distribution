...
object TreeSelectProps {
  ...
  implicit class TreeSelectPropsOps[Self <: TreeSelectProps[_], T] (val x: Self with TreeSelectProps[T]) extends AnyVal {
    ...
    @scala.inline
    def setMaxTagPlaceholder(value: /* omittedValues */ js.Array[LabelValueType] => ReactNode): Self = this.set("maxTagPlaceholder", js.Any.fromFunction1(value))
    @scala.inline
    ...
    @scala.inline
    def setOnChange(value: (/* value */ T, /* labelList */ js.Array[ReactNode], /* extra */ ChangeEventExtra) => Unit): Self = this.set("onChange", js.Any.fromFunction3(value))
    @scala.inline
    ...
    @scala.inline
    def setSearchPlaceholder(value: ReactNode): Self = this.set("searchPlaceholder", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTreeCheckable(value: Boolean | ReactNode): Self = this.set("treeCheckable", value.asInstanceOf[js.Any])
    @scala.inline
