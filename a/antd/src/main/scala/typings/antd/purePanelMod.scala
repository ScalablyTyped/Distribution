...
object purePanelMod {
  ...
  @JSImport("antd/lib/popconfirm/PurePanel", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def Overlay(props: OverlayProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Overlay")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
