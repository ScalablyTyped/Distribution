...
trait Tree
  ...
  def renderSwitcherIcon(
    ...
    hasIsLeafExpandedLoadingIcon: AntTreeNodeProps
  ): js.Object | Null = js.native
  def renderSwitcherIcon(prefixCls: String, switcherIcon: ReactElement, hasIsLeafExpandedLoadingIcon: AntTreeNodeProps): js.Object | Null = js.native
