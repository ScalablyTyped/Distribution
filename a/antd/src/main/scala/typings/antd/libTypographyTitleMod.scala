...
object libTypographyTitleMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[TitleProps & RefAttributes[HTMLElement]] = js.native
  
  /* Inlined parent std.Omit<antd.antd/lib/typography/Base.BlockProps<'h1' | 'h2' | 'h3' | 'h4' | 'h5'>, 'strong'> */
  /* Inlined parent std.Omit<react.react.HTMLAttributes<std.HTMLHeadElement>, 'type' | keyof antd.antd/lib/typography/Base.BlockProps<'h1' | 'h2' | 'h3' | 'h4' | 'h5'>> */
  ...
  type _To = ForwardRefExoticComponent[TitleProps & RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `libTypographyTitleMod.foo` */
  override def _to: ForwardRefExoticComponent[TitleProps & RefAttributes[HTMLElement]] = default
}
