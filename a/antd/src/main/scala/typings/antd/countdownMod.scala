...
object countdownMod {
  ...
  object default {
    ...
    object defaultProps {
      ...
      @scala.inline
      def prefix_=(x: js.UndefOr[ReactNode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("prefix")(x.asInstanceOf[js.Any])
      ...
      @scala.inline
      def suffix_=(x: js.UndefOr[ReactNode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("suffix")(x.asInstanceOf[js.Any])
      
      @JSImport("antd/lib/statistic/Countdown", "default.defaultProps.title")
      @js.native
      def title: js.UndefOr[ReactNode] = js.native
      @scala.inline
      def title_=(x: js.UndefOr[ReactNode]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("title")(x.asInstanceOf[js.Any])
      ...
      @scala.inline
      def valueRender_=(x: js.UndefOr[js.Function1[/* node */ ReactNode, ReactNode]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("valueRender")(x.asInstanceOf[js.Any])
