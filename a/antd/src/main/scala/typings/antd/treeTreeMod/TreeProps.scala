...
object TreeProps {
  ...
  implicit class TreePropsOps[Self <: TreeProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilterAntTreeNode(value: /* node */ AntTreeNode => Boolean): Self = this.set("filterAntTreeNode", js.Any.fromFunction1(value))
    ...
    @scala.inline
    def setIconFunction1(value: /* nodeProps */ AntdTreeNodeAttribute => ReactNode): Self = this.set("icon", js.Any.fromFunction1(value))
    
    @scala.inline
    def setIcon(value: (js.Function1[/* nodeProps */ AntdTreeNodeAttribute, ReactNode]) | ReactNode): Self = this.set("icon", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setOnCheck(value: (/* checked */ typings.rcTree.anon.Checked | js.Array[Key], /* info */ CheckInfo) => Unit): Self = this.set("onCheck", js.Any.fromFunction2(value))
