...
trait TreeProps extends js.Object {
  ...
  /** （受控）选中复选框的树节点 */
  var checkedKeys: js.UndefOr[js.Array[String] | AnonCheckedHalfChecked] = js.undefined
  ...
  var onCheck: js.UndefOr[
    js.Function2[
      /* checkedKeys */ js.Array[String] | AnonCheckedHalfChecked, 
  ...
  var onLoad: js.UndefOr[js.Function2[/* loadedKeys */ js.Array[String], /* info */ AnonEvent, Unit]] = js.undefined
