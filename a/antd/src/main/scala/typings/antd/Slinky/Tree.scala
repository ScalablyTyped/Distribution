...
import typings.antd.esTreeMod.default
...
import typings.antd.esTreeTreeMod.TreeProps
...
/* The following DOM/SVG props were specified: style, draggable, className, disabled, multiple */
object Tree
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.antd.esTreeMod.default].asInstanceOf[String | js.Object]
  def apply(
