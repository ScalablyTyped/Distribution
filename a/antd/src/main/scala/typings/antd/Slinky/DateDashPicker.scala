...
import typings.antd.esDateDashPickerMod.default
...
object DateDashPicker
  ...
  override val component: String | js.Object = js.constructorOf[typings.antd.esDateDashPickerMod.default].asInstanceOf[String | js.Object]
  def apply(
