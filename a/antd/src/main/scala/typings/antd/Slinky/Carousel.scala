...
import typings.antd.esCarouselMod.CarouselProps
import typings.antd.esCarouselMod.DotPosition
import typings.antd.esCarouselMod.default
...
/* The following DOM/SVG props were specified: draggable, className, rows, style */
object Carousel
  extends ExternalComponentWithAttributesWithRefType[tag.type, default] {
  override val component: String | js.Object = js.constructorOf[typings.antd.esCarouselMod.default].asInstanceOf[String | js.Object]
  def apply(
    ...
    appendDots: /* dots */ ReactNode => typings.react.reactMod.Global.JSXNs.Element = null,
    arrows: js.UndefOr[Boolean] = js.undefined,
    asNavFor: typings.reactDashSlick.reactDashSlickMod.Slider = null,
