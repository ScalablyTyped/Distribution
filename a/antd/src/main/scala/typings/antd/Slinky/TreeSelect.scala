...
object TreeSelect
  extends ExternalComponentWithAttributesWithRefType[tag.type, typings.antd.esMod.TreeSelect[js.Any]] {
  override val component: String | js.Object = js.constructorOf[typings.antd.esMod.TreeSelect[js.Any]].asInstanceOf[String | js.Object]
  def apply[T /* <: TreeNodeValue */](
    ...
    value: T = null
  ): BuildingComponent[tag.type, typings.antd.esMod.TreeSelect[js.Any]] = {
    ...
    super.apply(__obj.asInstanceOf[Props]).asInstanceOf[slinky.core.BuildingComponent[slinky.web.html.`*`.tag.type, typings.antd.esMod.TreeSelect[js.Any]]]
  }
