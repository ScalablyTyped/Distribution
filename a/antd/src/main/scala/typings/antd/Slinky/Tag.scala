...
import typings.antd.esTagMod.TagProps
import typings.antd.esTagMod.default
...
object Tag
  ...
  override val component: String | js.Object = js.constructorOf[typings.antd.esTagMod.default].asInstanceOf[String | js.Object]
  def apply(
