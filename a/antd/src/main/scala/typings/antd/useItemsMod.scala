...
object useItemsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antd.useItemsMod.MenuItemType
    - typings.antd.useItemsMod.SubMenuType
    - typings.antd.useItemsMod.MenuItemGroupType
    - typings.antd.useItemsMod.MenuDividerType
    - scala.Null
  */
  ...
  trait MenuDividerType
    extends StObject
       with typings.rcMenu.interfaceMod.MenuDividerType
       with _ItemType {
  ...
  trait MenuItemType
    extends StObject
       with typings.rcMenu.interfaceMod.MenuItemType
       with _ItemType {
  ...
  object _ItemType {
    ...
    inline def MenuDividerType(): typings.antd.useItemsMod.MenuDividerType = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("divider")
      __obj.asInstanceOf[typings.antd.useItemsMod.MenuDividerType]
    }
    
    inline def MenuItemGroupType(): typings.antd.useItemsMod.MenuItemGroupType = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("group")
      __obj.asInstanceOf[typings.antd.useItemsMod.MenuItemGroupType]
    }
    
    inline def MenuItemType(key: Key): typings.antd.useItemsMod.MenuItemType = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.useItemsMod.MenuItemType]
    }
    
    inline def SubMenuType(children: js.Array[ItemType], key: String): typings.antd.useItemsMod.SubMenuType = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.useItemsMod.SubMenuType]
    }
  }
}
