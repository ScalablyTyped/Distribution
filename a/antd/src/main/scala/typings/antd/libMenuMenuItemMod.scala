...
import typings.antd.libLayoutSiderMod.SiderContextProps
...
object libMenuMenuItemMod {
  ...
  object default {
    ...
    @JSImport("antd/lib/menu/MenuItem", "default.contextType")
    @js.native
  ...
  /* Inlined parent std.Omit<rc-menu.rc-menu.MenuItemProps, 'title'> */
  ...
  object MenuItemProps {
    ...
    extension [Self <: MenuItemProps](x: Self) {
      ...
      inline def setAttribute(value: Record[String, String]): Self = StObject.set(x, "attribute", value.asInstanceOf[js.Any])
      ...
      inline def setOnBlur(value: FocusEvent[HTMLLIElement, typings.std.Element] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: FocusEvent[HTMLLIElement, typings.std.Element] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
