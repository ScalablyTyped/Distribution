...
object CarouselProps {
  ...
  implicit class CarouselPropsOps[Self <: CarouselProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDotPosition(value: DotPosition): Self = this.set("dotPosition", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDotPosition: Self = this.set("dotPosition", js.undefined)
    @scala.inline
    def setDots(value: Boolean | ClassName): Self = this.set("dots", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setEffect(value: CarouselEffect): Self = this.set("effect", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setSlickGoTo(value: Double): Self = this.set("slickGoTo", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteSlickGoTo: Self = this.set("slickGoTo", js.undefined)
    @scala.inline
