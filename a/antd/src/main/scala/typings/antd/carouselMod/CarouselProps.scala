...
object CarouselProps {
  ...
  def apply(
    ...
    slickGoTo: js.UndefOr[Double] = js.undefined,
    slide: String = null,
    ...
    if (!js.isUndefined(slickGoTo)) __obj.updateDynamic("slickGoTo")(slickGoTo.get.asInstanceOf[js.Any])
