...
object generatePickerMod {
  ...
  */
  ...
  object PickerProps {
    ...
    inline def PickerBaseProps[DateType](picker: Exclude[PickerMode, date | time]): typings.antd.generatePickerMod.PickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.generatePickerMod.PickerBaseProps[DateType]]
    }
    
    inline def PickerDateProps[DateType](): typings.antd.generatePickerMod.PickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antd.generatePickerMod.PickerDateProps[DateType]]
    }
    
    inline def PickerTimeProps[DateType](): typings.antd.generatePickerMod.PickerTimeProps[DateType] = {
  ...
  */
  ...
  object RangePickerProps {
    ...
    inline def RangePickerBaseProps[DateType](picker: Exclude[PickerMode, date | time]): typings.antd.generatePickerMod.RangePickerBaseProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = picker.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.antd.generatePickerMod.RangePickerBaseProps[DateType]]
    }
    
    inline def RangePickerDateProps[DateType](): typings.antd.generatePickerMod.RangePickerDateProps[DateType] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antd.generatePickerMod.RangePickerDateProps[DateType]]
    }
    
    inline def RangePickerTimeProps[DateType](): typings.antd.generatePickerMod.RangePickerTimeProps[DateType] = {
      val __obj = js.Dynamic.literal(picker = "time")
