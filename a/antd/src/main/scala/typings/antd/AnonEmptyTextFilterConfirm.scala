...
trait AnonEmptyTextFilterConfirm extends js.Object {
...
object AnonEmptyTextFilterConfirm {
  @scala.inline
  def apply(
    emptyText: String,
    ...
    __obj.asInstanceOf[AnonEmptyTextFilterConfirm]
  }
}
