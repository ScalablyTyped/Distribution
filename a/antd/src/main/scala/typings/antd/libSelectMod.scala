...
object libSelectMod extends Shortcut {
  ...
  object InternalSelectProps {
    ...
    inline def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](): InternalSelectProps[ValueType, OptionType] = {
  ...
  /* Inlined parent std.Omit<antd.antd/lib/select.InternalSelectProps<ValueType, OptionType>, 'inputIcon' | 'mode' | 'getInputElement' | 'getRawInputElement' | 'backfill' | 'placement'> */
  ...
  object SelectProps {
    ...
    inline def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](): SelectProps[ValueType, OptionType] = {
      val __obj = js.Dynamic.literal()
