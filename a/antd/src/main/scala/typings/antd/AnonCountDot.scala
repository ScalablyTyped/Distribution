...
trait AnonCountDot extends js.Object {
  var count: Null
  var dot: Boolean
...
object AnonCountDot {
  @scala.inline
  def apply(count: Null, dot: Boolean, overflowCount: Double, showZero: Boolean): AnonCountDot = {
    ...
    __obj.asInstanceOf[AnonCountDot]
  }
}
