...
import typings.antd.TypeofClassPasswordDefaultProps
import typings.antd.TypeofClassSearchDefaultPropsAnonEnterButton
import typings.antd.TypeofClassTextAreaGetDerivedStateFromProps
