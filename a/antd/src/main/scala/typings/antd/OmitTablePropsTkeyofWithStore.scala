...
/* Inlined std.Omit<antd.antd/es/table/interface.TableProps<T>, keyof antd.antd/es/table/interface.WithStore> */
trait OmitTablePropsTkeyofWithStore[T] extends js.Object {
...
object OmitTablePropsTkeyofWithStore {
  @scala.inline
  def apply[T](
    ...
    __obj.asInstanceOf[OmitTablePropsTkeyofWithStore[T]]
  }
}
