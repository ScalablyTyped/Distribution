...
object TabsProps {
  ...
  implicit class TabsPropsOps[Self <: TabsProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAddIcon(value: ReactNode): Self = this.set("addIcon", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnEdit(
      value: (/* e */ (MouseEvent[Element, NativeMouseEvent]) | KeyboardEvent[Element] | String, /* action */ add | remove) => Unit
