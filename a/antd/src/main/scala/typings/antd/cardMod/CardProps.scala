...
object CardProps {
  ...
  implicit class CardPropsOps[Self <: CardProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setActiveTabKey(value: String): Self = this.set("activeTabKey", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteActiveTabKey: Self = this.set("activeTabKey", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setCover(value: ReactNode): Self = this.set("cover", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setDefaultActiveTabKey(value: String): Self = this.set("defaultActiveTabKey", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteDefaultActiveTabKey: Self = this.set("defaultActiveTabKey", js.undefined)
    @scala.inline
    ...
    @scala.inline
    def setHeadStyle(value: CSSProperties): Self = this.set("headStyle", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteHeadStyle: Self = this.set("headStyle", js.undefined)
    @scala.inline
