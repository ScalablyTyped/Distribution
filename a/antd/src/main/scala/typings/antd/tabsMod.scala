...
object tabsMod {
  ...
  */
  ...
  trait TabsProps extends StObject {
    ...
    var animated: js.UndefOr[Boolean | AnimatedConfig] = js.undefined
    ...
    var moreIcon: js.UndefOr[ReactNode] = js.undefined
    ...
    var onTabClick: js.UndefOr[
        js.Function2[
          /* activeKey */ String, 
          /* e */ KeyboardEvent[typings.std.Element] | (MouseEvent[typings.std.Element, NativeMouseEvent]), 
          Unit
        ]
      ] = js.undefined
    
    var onTabScroll: js.UndefOr[OnTabScroll] = js.undefined
    ...
    var renderTabBar: js.UndefOr[RenderTabBar] = js.undefined
  ...
  object TabsProps {
    ...
    implicit class TabsPropsMutableBuilder[Self <: TabsProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setAddIcon(value: ReactNode): Self = StObject.set(x, "addIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setHideAdd(value: Boolean): Self = StObject.set(x, "hideAdd", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setHideAddUndefined: Self = StObject.set(x, "hideAdd", js.undefined)
      ...
      @scala.inline
      def setMoreIcon(value: ReactNode): Self = StObject.set(x, "moreIcon", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setOnTabClick(
        value: (/* activeKey */ String, /* e */ KeyboardEvent[typings.std.Element] | (MouseEvent[typings.std.Element, NativeMouseEvent])) => Unit
      ...
      @scala.inline
      def setRenderTabBar(value: (/* props */ js.Any, /* DefaultTabBar */ ComponentType[js.Object]) => ReactElement): Self = StObject.set(x, "renderTabBar", js.Any.fromFunction2(value))
      ...
      @scala.inline
      def setType(value: TabsType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
