...
object libTableTableMod extends Shortcut {
  ...
  trait InternalTableType extends StObject {
    ...
    def apply[RecordType /* <: js.Object */](props: `3` & TableProps[RecordType]): ReactElement = js.native
  }
  ...
  object TableProps {
    ...
    extension [Self <: TableProps[?], RecordType](x: Self & TableProps[RecordType]) {
      ...
      inline def setColumnsVarargs(value: (ColumnGroupType[RecordType] | typings.antd.libTableInterfaceMod.ColumnType[RecordType])*): Self = StObject.set(x, "columns", js.Array(value*))
