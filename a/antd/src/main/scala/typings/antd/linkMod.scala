...
object linkMod extends Shortcut {
  ...
  @js.native
  val default: ForwardRefExoticComponent[LinkProps with RefAttributes[HTMLElement]] = js.native
  ...
  type _To = ForwardRefExoticComponent[LinkProps with RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `linkMod.foo` */
  override def _to: ForwardRefExoticComponent[LinkProps with RefAttributes[HTMLElement]] = default
}
