...
@JSImport("antd/lib/locale-provider/sl_SI", JSImport.Namespace)
@js.native
object localeProviderSlSIMod extends js.Object {
  @js.native
  object default extends js.Object {
    var Calendar: AnonLangTimePickerLocaleAnonBackToToday = js.native
    var DatePicker: AnonLangTimePickerLocaleAnonBackToToday = js.native
