...
import typings.antd.libTreeTreeMod.SwitcherIcon
...
import typings.rcTreeSelect.esTreeSelectMod.BaseOptionType
  ...
  object TreeSelectProps {
    ...
    implicit open class MutableBuilder[Self <: TreeSelectProps[?, ?], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */] (val x: Self & (TreeSelectProps[ValueType, OptionType])) extends AnyVal {
      ...
      inline def setSwitcherIconFunction1(
        value: (/* props */ AntTreeNodeProps) | (/* props */ typings.rcTree.esTreeNodeMod.TreeNodeProps[DataNode]) => ReactNode
