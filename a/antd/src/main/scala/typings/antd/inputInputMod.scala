...
object inputInputMod {
  ...
  @JSImport("antd/lib/input/Input", "resolveOnChange")
  @js.native
  def resolveOnChange(target: HTMLInputElement, e: typings.react.mod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  @JSImport("antd/lib/input/Input", "resolveOnChange")
  @js.native
  def resolveOnChange(
    target: HTMLInputElement,
  ...
  @JSImport("antd/lib/input/Input", "resolveOnChange")
  @js.native
  def resolveOnChange(target: HTMLTextAreaElement, e: typings.react.mod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  @JSImport("antd/lib/input/Input", "resolveOnChange")
  @js.native
  def resolveOnChange(
    target: HTMLTextAreaElement,
