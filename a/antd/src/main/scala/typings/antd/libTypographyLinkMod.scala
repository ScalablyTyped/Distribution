...
object libTypographyLinkMod extends Shortcut {
  ...
  /* Inlined parent antd.antd/lib/typography/Base.BlockProps<'a'> */
  /* Inlined parent std.Omit<react.react.AnchorHTMLAttributes<std.HTMLAnchorElement>, 'type' | keyof antd.antd/lib/typography/Base.BlockProps<'a'>> */
