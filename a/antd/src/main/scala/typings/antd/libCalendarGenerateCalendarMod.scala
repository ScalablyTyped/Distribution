  ...
  */
  ...
  object PickerPanelBaseProps {
    ...
    extension [Self <: PickerPanelBaseProps[?], DateType](x: Self & PickerPanelBaseProps[DateType]) {
      ...
      inline def setMonthCellRender(value: (DateType, /* locale */ typings.rcPicker.esInterfaceMod.Locale) => ReactNode): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
