...
trait PickTablePropsanyloadingfooterstyletitlescrollsizeBodyStyle extends js.Object {
...
object PickTablePropsanyloadingfooterstyletitlescrollsizeBodyStyle {
  @scala.inline
  def apply(
  ...
  ): PickTablePropsanyloadingfooterstyletitlescrollsizeBodyStyle = {
    ...
    __obj.asInstanceOf[PickTablePropsanyloadingfooterstyletitlescrollsizeBodyStyle]
  }
}
