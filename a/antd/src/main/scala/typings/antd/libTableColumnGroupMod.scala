...
import typings.antd.libTableInterfaceMod.FilterDropdownProps
...
object libTableColumnGroupMod {
  ...
  object ColumnGroupProps {
    ...
    extension [Self <: ColumnGroupProps[?], RecordType](x: Self & ColumnGroupProps[RecordType]) {
      ...
      inline def setDefaultFilteredValueVarargs(value: (typings.antd.libTableInterfaceMod.Key | Boolean)*): Self = StObject.set(x, "defaultFilteredValue", js.Array(value*))
      ...
      inline def setFilteredValueVarargs(value: (typings.antd.libTableInterfaceMod.Key | Boolean)*): Self = StObject.set(x, "filteredValue", js.Array(value*))
