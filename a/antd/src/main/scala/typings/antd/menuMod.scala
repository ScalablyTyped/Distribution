...
object menuMod {
  ...
  */
  ...
  trait MenuProps extends StObject {
    ...
    var mode: js.UndefOr[typings.rcMenu.interfaceMod.MenuMode] = js.undefined
  ...
  object MenuProps {
    ...
    extension [Self <: MenuProps](x: Self) {
      ...
      inline def setMode(value: typings.rcMenu.interfaceMod.MenuMode): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
