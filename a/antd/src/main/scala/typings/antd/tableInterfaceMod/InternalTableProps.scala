...
trait InternalTableProps[T] extends js.Object {
  ...
  var onRowClick: js.UndefOr[js.Function3[/* record */ T, /* index */ Double, /* event */ Event_, Unit]] = js.undefined
  ...
  var scroll: js.UndefOr[AnonScrollToFirstRowOnChange] = js.undefined
...
object InternalTableProps {
  ...
  def apply[T](
    ...
    onRowClick: (/* record */ T, /* index */ Double, /* event */ Event_) => Unit = null,
    ...
    scroll: AnonScrollToFirstRowOnChange = null,
