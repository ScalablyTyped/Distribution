...
import typings.antd.AnonFilters
...
trait ColumnProps[T] extends js.Object {
  ...
  var onCellClick: js.UndefOr[js.Function2[/* record */ T, /* event */ Event_, Unit]] = js.undefined
  ...
  var title: js.UndefOr[ReactNode | (js.Function1[/* options */ AnonFilters[T], ReactNode])] = js.undefined
...
object ColumnProps {
  ...
  def apply[T](
    ...
    onCellClick: (/* record */ T, /* event */ Event_) => Unit = null,
    ...
    title: ReactNode | (js.Function1[/* options */ AnonFilters[T], ReactNode]) = null,
