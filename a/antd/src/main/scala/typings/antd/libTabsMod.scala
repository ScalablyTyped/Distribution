...
import typings.rcTabs.esInterfaceMod.RenderTabBarProps
...
object libTabsMod {
  ...
  object default {
    ...
    @js.native
    def TabPane: FC[TabPaneProps] = js.native
  ...
  */
  ...
  trait TabsProps extends StObject {
    ...
    var items: js.UndefOr[js.Array[Tab]] = js.undefined
  ...
  object TabsProps {
    ...
    extension [Self <: TabsProps](x: Self) {
      ...
      inline def setAnimated(value: Boolean | AnimatedConfig): Self = StObject.set(x, "animated", value.asInstanceOf[js.Any])
      ...
      inline def setHideAdd(value: Boolean): Self = StObject.set(x, "hideAdd", value.asInstanceOf[js.Any])
      
      inline def setHideAddUndefined: Self = StObject.set(x, "hideAdd", js.undefined)
      ...
      inline def setItems(value: js.Array[Tab]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: Tab*): Self = StObject.set(x, "items", js.Array(value*))
      ...
      inline def setMoreIcon(value: ReactNode): Self = StObject.set(x, "moreIcon", value.asInstanceOf[js.Any])
      
      inline def setMoreIconUndefined: Self = StObject.set(x, "moreIcon", js.undefined)
      ...
      inline def setOnChange(value: /* activeKey */ String => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setOnTabScroll(value: /* info */ Direction => Unit): Self = StObject.set(x, "onTabScroll", js.Any.fromFunction1(value))
      
      inline def setOnTabScrollUndefined: Self = StObject.set(x, "onTabScroll", js.undefined)
      ...
      inline def setRenderTabBar(
        value: (/* props */ RenderTabBarProps, /* DefaultTabBar */ ComponentType[TabNavListProps]) => ReactElement
      ): Self = StObject.set(x, "renderTabBar", js.Any.fromFunction2(value))
      ...
      inline def setTabBarStyle(value: CSSProperties): Self = StObject.set(x, "tabBarStyle", value.asInstanceOf[js.Any])
      ...
      inline def setType(value: TabsType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
