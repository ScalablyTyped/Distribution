...
import typings.rcCascader.cascaderMod.OnMultipleChange
import typings.rcCascader.cascaderMod.OnSingleChange
...
import typings.rcCascader.cascaderMod.ValueType
...
object cascaderMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antd.cascaderMod.SingleCascaderProps
    - typings.antd.cascaderMod.MultipleCascaderProps
  */
  trait UnionCascaderProps extends StObject
  object UnionCascaderProps {
    
    inline def MultipleCascaderProps(): typings.antd.cascaderMod.MultipleCascaderProps = {
      val __obj = js.Dynamic.literal(multiple = true)
      __obj.asInstanceOf[typings.antd.cascaderMod.MultipleCascaderProps]
    }
    
    inline def SingleCascaderProps(): typings.antd.cascaderMod.SingleCascaderProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antd.cascaderMod.SingleCascaderProps]
    }
  }
  ...
  /* This means you don't have to write `default`, but can instead just say `cascaderMod.foo` */
