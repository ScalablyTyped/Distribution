...
trait TransferListProps extends js.Object {
  ...
  var direction: antdLib.libTransferMod.TransferDirection
  ...
  var render: js.UndefOr[
    js.Function1[
      /* item */ antdLib.libTransferMod.TransferItem, 
      antdLib.libTransferMod.RenderResult
    ]
  ] = js.undefined
  ...
  def handleSelect(selectedItem: antdLib.libTransferMod.TransferItem, checked: scala.Boolean): scala.Unit
  /** [Legacy] Only used when `body` prop used. */
  def handleSelectAll(dataSource: js.Array[antdLib.libTransferMod.TransferItem], checkAll: scala.Boolean): scala.Unit
...
object TransferListProps {
  ...
  def apply(
    ...
    direction: antdLib.libTransferMod.TransferDirection,
    handleClear: () => scala.Unit,
    handleFilter: reactLib.reactMod.ChangeEvent[stdLib.HTMLInputElement] => scala.Unit,
    handleSelect: (antdLib.libTransferMod.TransferItem, scala.Boolean) => scala.Unit,
    handleSelectAll: (js.Array[antdLib.libTransferMod.TransferItem], scala.Boolean) => scala.Unit,
    ...
    filterOption: (/* filterText */ java.lang.String, /* item */ antdLib.libTransferMod.TransferItem) => scala.Boolean = null,
    footer: /* props */ TransferListProps => reactLib.reactMod.ReactNode = null,
    `lazy`: scala.Boolean | js.Object = null,
    render: /* item */ antdLib.libTransferMod.TransferItem => antdLib.libTransferMod.RenderResult = null,
