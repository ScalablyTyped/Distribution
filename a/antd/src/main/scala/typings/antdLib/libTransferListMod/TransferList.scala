...
trait TransferList
  ...
  var fixIERepaintTimer: scala.Double = js.native
  var notFoundNode: reactLib.HTMLDivElement = js.native
  ...
  def fixIERepaint(): scala.Unit = js.native
  ...
  def handleFilter(e: reactLib.reactMod.ReactNs.ChangeEvent[reactLib.HTMLInputElement]): scala.Unit = js.native
  ...
  def saveNotFoundRef(node: reactLib.HTMLDivElement): scala.Unit = js.native
