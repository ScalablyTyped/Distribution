...
trait ScrollNumber
  ...
  def renderScrollNumber(hasGetPrefixCls: antdLib.esConfigDashProviderMod.ConfigConsumerProps): (reactLib.reactMod.ComponentElement[_, reactLib.reactMod.Component[_, _, _]]) | reactLib.reactMod.ReactElement = js.native
}
