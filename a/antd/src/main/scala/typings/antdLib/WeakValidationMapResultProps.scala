...
trait WeakValidationMapResultProps extends js.Object {
  ...
  var status: js.UndefOr[
    reactLib.reactMod.Validator[js.UndefOr[scala.Null | antdLib.esResultMod.ResultStatusType]]
  ] = js.undefined
...
object WeakValidationMapResultProps {
  ...
  def apply(
    ...
    status: reactLib.reactMod.Validator[js.UndefOr[scala.Null | antdLib.esResultMod.ResultStatusType]] = null,
