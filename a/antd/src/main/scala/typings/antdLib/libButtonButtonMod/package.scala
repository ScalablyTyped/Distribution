...
package object libButtonButtonMod {
  type AnchorButtonProps = antdLib.Anon_HrefOnClick with BaseButtonProps with (antdLib.libUnderscoreUtilTypeMod.Omit[reactLib.reactMod.AnchorHTMLAttributes[_], antdLib.antdLibStrings.`type`])
