...
package object libButtonButtonMod {
  type AnchorButtonProps = antdLib.Anon_HrefOnClick with BaseButtonProps with reactLib.reactMod.ReactNs.AnchorHTMLAttributes[stdLib.HTMLAnchorElement]
  ...
  type NativeButtonProps = antdLib.Anon_HtmlType with BaseButtonProps with reactLib.reactMod.ReactNs.ButtonHTMLAttributes[stdLib.HTMLButtonElement]
}
