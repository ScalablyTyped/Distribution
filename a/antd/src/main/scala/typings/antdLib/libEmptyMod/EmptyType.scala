...
/* Inlined react.react.SFC<antd.antd/lib/empty.EmptyProps> & {  PRESENTED_IMAGE_DEFAULT  :string,   PRESENTED_IMAGE_SIMPLE  :string} */
@js.native
trait EmptyType extends js.Object {
  var PRESENTED_IMAGE_DEFAULT: java.lang.String = js.native
  var PRESENTED_IMAGE_SIMPLE: java.lang.String = js.native
