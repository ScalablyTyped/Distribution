...
trait Popconfirm
  ...
  def onCancel(e: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, stdLib.MouseEvent]): scala.Unit = js.native
  def onConfirm(e: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, stdLib.MouseEvent]): scala.Unit = js.native
