...
trait AbstractTooltipProps extends js.Object {
  ...
  var autoAdjustOverflow: js.UndefOr[scala.Boolean | antdLib.esTooltipPlacementsMod.AdjustOverflow] = js.undefined
...
object AbstractTooltipProps {
  ...
  def apply(
    ...
    autoAdjustOverflow: scala.Boolean | antdLib.esTooltipPlacementsMod.AdjustOverflow = null,
