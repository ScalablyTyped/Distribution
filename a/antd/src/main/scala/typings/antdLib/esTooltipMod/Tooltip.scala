...
trait Tooltip
  ...
  def renderTooltip(hasGetPopupContainerGetPrefixCls: antdLib.esConfigDashProviderMod.ConfigConsumerProps): reactLib.reactMod.Global.JSXNs.Element = js.native
