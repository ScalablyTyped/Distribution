...
trait Header
  ...
  def onTypeChange(e: antdLib.esRadioInterfaceMod.RadioChangeEvent): scala.Unit = js.native
  def onYearChange(year: java.lang.String): scala.Unit = js.native
  def renderHeader(hasGetPrefixCls: antdLib.esConfigDashProviderMod.ConfigConsumerProps): reactLib.reactMod.Global.JSXNs.Element = js.native
}
