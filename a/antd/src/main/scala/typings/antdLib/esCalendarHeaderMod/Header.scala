...
trait Header
  ...
  def onInternalTypeChange(e: antdLib.esRadioInterfaceMod.RadioChangeEvent): scala.Unit = js.native
  ...
  def renderHeader(hasGetPrefixCls: antdLib.esConfigDashProviderMod.ConfigConsumerProps): js.UndefOr[js.Object | scala.Null] = js.native
}
