package typings
package antdLib.esInputDashNumberMod
...
- Dropped {[ P in std.Exclude<keyof react.react.InputHTMLAttributes<std.HTMLInputElement>, antd.antd/es/input-number.OmitAttrs> ]: react.react.InputHTMLAttributes<std.HTMLInputElement>[P]} */ trait InputNumberProps extends js.Object {
