...
trait Countdown
  ...
  def formatCountdown(value: java.lang.String, config: antdLib.libStatisticUtilsMod.FormatConfig): java.lang.String = js.native
  def formatCountdown(value: scala.Double, config: antdLib.libStatisticUtilsMod.FormatConfig): java.lang.String = js.native
  def startTimer(): scala.Unit = js.native
  def stopTimer(): scala.Unit = js.native
  def syncTimer(): scala.Unit = js.native
  def valueRender(node: reactLib.reactMod.ReactNs.ReactElement[stdLib.HTMLDivElement]): reactLib.reactMod.ReactNs.ReactElement[stdLib.HTMLDivElement] = js.native
}
