...
trait PropsWithChildrenStatisticProps extends js.Object {
  ...
  var formatter: js.UndefOr[antdLib.esStatisticUtilsMod.Formatter] = js.undefined
  ...
  var value: js.UndefOr[antdLib.esStatisticUtilsMod.valueType] = js.undefined
...
object PropsWithChildrenStatisticProps {
  ...
  def apply(
    ...
    value: antdLib.esStatisticUtilsMod.valueType = null,
