...
trait Search
  ...
  def onSearch(e: reactLib.reactMod.ReactNs.KeyboardEvent[stdLib.HTMLInputElement]): scala.Unit = js.native
  def onSearch(e: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLElement, stdLib.MouseEvent]): scala.Unit = js.native
