...
trait TransferList
  ...
  def getCheckStatus(filteredItems: js.Array[antdLib.esTransferMod.TransferItem]): antdLib.antdLibStrings.all | antdLib.antdLibStrings.none | antdLib.antdLibStrings.part = js.native
  def getFilteredItems(dataSource: js.Array[antdLib.esTransferMod.TransferItem], filterValue: java.lang.String): antdLib.Anon_FilteredItems = js.native
  def getListBody(
  ...
  def matchFilter(text: java.lang.String, item: antdLib.esTransferMod.TransferItem): scala.Boolean = js.native
  def renderItem(item: antdLib.esTransferMod.TransferItem): RenderedItem = js.native
