...
trait TransferList
  ...
  def getCheckStatus(filteredDataSource: js.Array[antdLib.esTransferMod.TransferItem]): antdLib.antdLibStrings.all | antdLib.antdLibStrings.none | antdLib.antdLibStrings.part = js.native
  ...
  def handleSelect(selectedItem: antdLib.esTransferMod.TransferItem): scala.Unit = js.native
  def matchFilter(text: java.lang.String, item: antdLib.esTransferMod.TransferItem): scala.Boolean = js.native
  def renderItem(item: antdLib.esTransferMod.TransferItem): antdLib.Anon_RenderedEl = js.native
