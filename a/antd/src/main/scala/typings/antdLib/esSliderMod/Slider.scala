...
trait Slider
  ...
  def handleWithTooltip(tooltipPrefixCls: java.lang.String, info: HandleGeneratorInfo): reactLib.reactMod.ReactElement[_] = js.native
  def renderSlider(hasGetPrefixCls: antdLib.esConfigDashProviderMod.ConfigConsumerProps): reactLib.reactMod.Global.JSXNs.Element = js.native
