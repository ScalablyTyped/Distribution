...
trait BreadcrumbItemProps extends js.Object {
  ...
  var overlay: js.UndefOr[reactLib.reactMod.ReactNode | antdLib.libDropdownDropdownMod.OverlayFunc] = js.undefined
...
object BreadcrumbItemProps {
  ...
  def apply(
    ...
    overlay: reactLib.reactMod.ReactNode | antdLib.libDropdownDropdownMod.OverlayFunc = null,
