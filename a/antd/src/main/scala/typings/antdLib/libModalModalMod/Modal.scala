...
trait Modal
  ...
  def handleCancel(e: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, stdLib.MouseEvent]): scala.Unit = js.native
  def handleOk(e: reactLib.reactMod.ReactNs.MouseEvent[stdLib.HTMLButtonElement, stdLib.MouseEvent]): scala.Unit = js.native
