...
object antdLibComponents {
  ...
  @scala.inline
  def AffixProps: antdLib.libAffixMod.AffixProps.type = antdLib.libAffixMod.AffixProps
  type AffixProps = antdLib.libAffixMod.AffixProps
  @scala.inline
  def AlertProps: antdLib.libAlertMod.AlertProps.type = antdLib.libAlertMod.AlertProps
  type AlertProps = antdLib.libAlertMod.AlertProps
  @scala.inline
  def AnchorLinkProps: antdLib.libAnchorAnchorLinkMod.AnchorLinkProps.type = antdLib.libAnchorAnchorLinkMod.AnchorLinkProps
  type AnchorLinkProps = antdLib.libAnchorAnchorLinkMod.AnchorLinkProps
  @scala.inline
  def AnchorProps: antdLib.libAnchorAnchorMod.AnchorProps.type = antdLib.libAnchorAnchorMod.AnchorProps
  type AnchorProps = antdLib.libAnchorAnchorMod.AnchorProps
  @scala.inline
  def AntTreeNodeProps: antdLib.libTreeTreeMod.AntTreeNodeProps.type = antdLib.libTreeTreeMod.AntTreeNodeProps
  type AntTreeNodeProps = antdLib.libTreeTreeMod.AntTreeNodeProps
  @scala.inline
  def AutoCompleteProps: antdLib.libAutoDashCompleteMod.AutoCompleteProps.type = antdLib.libAutoDashCompleteMod.AutoCompleteProps
  type AutoCompleteProps = antdLib.libAutoDashCompleteMod.AutoCompleteProps
  @scala.inline
  def AvatarProps: antdLib.libAvatarMod.AvatarProps.type = antdLib.libAvatarMod.AvatarProps
  type AvatarProps = antdLib.libAvatarMod.AvatarProps
  @scala.inline
  def BackTopProps: antdLib.libBackDashTopMod.BackTopProps.type = antdLib.libBackDashTopMod.BackTopProps
  type BackTopProps = antdLib.libBackDashTopMod.BackTopProps
  @scala.inline
  ...
  @scala.inline
  def BreadcrumbProps: antdLib.libBreadcrumbBreadcrumbMod.BreadcrumbProps.type = antdLib.libBreadcrumbBreadcrumbMod.BreadcrumbProps
  type BreadcrumbProps = antdLib.libBreadcrumbBreadcrumbMod.BreadcrumbProps
  @scala.inline
  def ButtonGroupProps: antdLib.libButtonButtonDashGroupMod.ButtonGroupProps.type = antdLib.libButtonButtonDashGroupMod.ButtonGroupProps
  type ButtonGroupProps = antdLib.libButtonButtonDashGroupMod.ButtonGroupProps
  type ButtonProps = antdLib.libButtonButtonMod.ButtonProps
  @scala.inline
  def CalendarProps: antdLib.libCalendarMod.CalendarProps.type = antdLib.libCalendarMod.CalendarProps
  type CalendarProps = antdLib.libCalendarMod.CalendarProps
  @scala.inline
  def CardGridProps: antdLib.libCardGridMod.CardGridProps.type = antdLib.libCardGridMod.CardGridProps
  type CardGridProps = antdLib.libCardGridMod.CardGridProps
  @scala.inline
  def CardMetaProps: antdLib.libCardMetaMod.CardMetaProps.type = antdLib.libCardMetaMod.CardMetaProps
  type CardMetaProps = antdLib.libCardMetaMod.CardMetaProps
  @scala.inline
  def CardProps: antdLib.libCardMod.CardProps.type = antdLib.libCardMod.CardProps
  type CardProps = antdLib.libCardMod.CardProps
  @scala.inline
  def CarouselProps: antdLib.libCarouselMod.CarouselProps.type = antdLib.libCarouselMod.CarouselProps
  type CarouselProps = antdLib.libCarouselMod.CarouselProps
  @scala.inline
  def CascaderProps: antdLib.libCascaderMod.CascaderProps.type = antdLib.libCascaderMod.CascaderProps
  type CascaderProps = antdLib.libCascaderMod.CascaderProps
  @scala.inline
  def CheckableTagProps: antdLib.libTagCheckableTagMod.CheckableTagProps.type = antdLib.libTagCheckableTagMod.CheckableTagProps
  type CheckableTagProps = antdLib.libTagCheckableTagMod.CheckableTagProps
  @scala.inline
  def CheckboxProps: antdLib.libCheckboxCheckboxMod.CheckboxProps.type = antdLib.libCheckboxCheckboxMod.CheckboxProps
  type CheckboxProps = antdLib.libCheckboxCheckboxMod.CheckboxProps
  @scala.inline
  def ColProps: antdLib.libGridColMod.ColProps.type = antdLib.libGridColMod.ColProps
  type ColProps = antdLib.libGridColMod.ColProps
  @scala.inline
  def CollapsePanelProps: antdLib.libCollapseCollapsePanelMod.CollapsePanelProps.type = antdLib.libCollapseCollapsePanelMod.CollapsePanelProps
  type CollapsePanelProps = antdLib.libCollapseCollapsePanelMod.CollapsePanelProps
  @scala.inline
  def CollapseProps: antdLib.libCollapseCollapseMod.CollapseProps.type = antdLib.libCollapseCollapseMod.CollapseProps
  type CollapseProps = antdLib.libCollapseCollapseMod.CollapseProps
  @scala.inline
  def ColumnGroupProps: antdLib.libTableColumnGroupMod.ColumnGroupProps.type = antdLib.libTableColumnGroupMod.ColumnGroupProps
  type ColumnGroupProps = antdLib.libTableColumnGroupMod.ColumnGroupProps
  @scala.inline
  def ColumnProps: antdLib.libTableInterfaceMod.ColumnProps.type = antdLib.libTableInterfaceMod.ColumnProps
  type ColumnProps[T] = antdLib.libTableInterfaceMod.ColumnProps[T]
  @scala.inline
  def CommentProps: antdLib.libCommentMod.CommentProps.type = antdLib.libCommentMod.CommentProps
  type CommentProps = antdLib.libCommentMod.CommentProps
  @scala.inline
  ...
  @scala.inline
  def DatePickerProps: antdLib.libDateDashPickerInterfaceMod.DatePickerProps.type = antdLib.libDateDashPickerInterfaceMod.DatePickerProps
  type DatePickerProps = antdLib.libDateDashPickerInterfaceMod.DatePickerProps
  @scala.inline
  def DirectoryTreeProps: antdLib.libTreeDirectoryTreeMod.DirectoryTreeProps.type = antdLib.libTreeDirectoryTreeMod.DirectoryTreeProps
  type DirectoryTreeProps = antdLib.libTreeDirectoryTreeMod.DirectoryTreeProps
  @scala.inline
  def DividerProps: antdLib.libDividerMod.DividerProps.type = antdLib.libDividerMod.DividerProps
  type DividerProps = antdLib.libDividerMod.DividerProps
  type DraggerProps = antdLib.libUploadDraggerMod.DraggerProps
  @scala.inline
  def DrawerProps: antdLib.libDrawerMod.DrawerProps.type = antdLib.libDrawerMod.DrawerProps
  type DrawerProps = antdLib.libDrawerMod.DrawerProps
  @scala.inline
  def DropDownProps: antdLib.libDropdownDropdownMod.DropDownProps.type = antdLib.libDropdownDropdownMod.DropDownProps
  type DropDownProps = antdLib.libDropdownDropdownMod.DropDownProps
  @scala.inline
  ...
  @scala.inline
  def FormProps: antdLib.libFormFormMod.FormProps.type = antdLib.libFormFormMod.FormProps
  type FormProps = antdLib.libFormFormMod.FormProps
  @scala.inline
  def GroupProps: antdLib.libInputGroupMod.GroupProps.type = antdLib.libInputGroupMod.GroupProps
  type GroupProps = antdLib.libInputGroupMod.GroupProps
  @scala.inline
  def HeaderProps: antdLib.libCalendarHeaderMod.HeaderProps.type = antdLib.libCalendarHeaderMod.HeaderProps
  type HeaderProps = antdLib.libCalendarHeaderMod.HeaderProps
  @scala.inline
  def IconProps: antdLib.libIconMod.IconProps.type = antdLib.libIconMod.IconProps
  type IconProps = antdLib.libIconMod.IconProps
  @scala.inline
  def InputNumberProps: antdLib.libInputDashNumberMod.InputNumberProps.type = antdLib.libInputDashNumberMod.InputNumberProps
  type InputNumberProps = antdLib.libInputDashNumberMod.InputNumberProps
  @scala.inline
  def InputProps: antdLib.libInputInputMod.InputProps.type = antdLib.libInputInputMod.InputProps
  type InputProps = antdLib.libInputInputMod.InputProps
  @scala.inline
  def InternalBlockProps: antdLib.libTypographyBaseMod.InternalBlockProps.type = antdLib.libTypographyBaseMod.InternalBlockProps
  type InternalBlockProps = antdLib.libTypographyBaseMod.InternalBlockProps
  @scala.inline
  def InternalTypographyProps: antdLib.libTypographyTypographyMod.InternalTypographyProps.type = antdLib.libTypographyTypographyMod.InternalTypographyProps
  type InternalTypographyProps = antdLib.libTypographyTypographyMod.InternalTypographyProps
  @scala.inline
  def ListItemProps: antdLib.libListItemMod.ListItemProps.type = antdLib.libListItemMod.ListItemProps
  ...
  @scala.inline
  def MentionProps: antdLib.libMentionMod.MentionProps.type = antdLib.libMentionMod.MentionProps
  type MentionProps = antdLib.libMentionMod.MentionProps
  @scala.inline
  def MenuItemProps: antdLib.libMenuMenuItemMod.MenuItemProps.type = antdLib.libMenuMenuItemMod.MenuItemProps
  type MenuItemProps = antdLib.libMenuMenuItemMod.MenuItemProps
  @scala.inline
  def MenuProps: antdLib.libMenuMod.MenuProps.type = antdLib.libMenuMod.MenuProps
  type MenuProps = antdLib.libMenuMod.MenuProps
  @scala.inline
  ...
  @scala.inline
  def OptionProps: antdLib.libSelectMod.OptionProps.type = antdLib.libSelectMod.OptionProps
  type OptionProps = antdLib.libSelectMod.OptionProps
  @scala.inline
  def PageHeaderProps: antdLib.libPageDashHeaderMod.PageHeaderProps.type = antdLib.libPageDashHeaderMod.PageHeaderProps
  type PageHeaderProps = antdLib.libPageDashHeaderMod.PageHeaderProps
  @scala.inline
  def PaginationProps: antdLib.libPaginationPaginationMod.PaginationProps.type = antdLib.libPaginationPaginationMod.PaginationProps
  type PaginationProps = antdLib.libPaginationPaginationMod.PaginationProps
  type ParagraphProps = antdLib.libTypographyParagraphMod.ParagraphProps
  @scala.inline
  def PasswordProps: antdLib.libInputPasswordMod.PasswordProps.type = antdLib.libInputPasswordMod.PasswordProps
  type PasswordProps = antdLib.libInputPasswordMod.PasswordProps
  @scala.inline
  def PopconfirmProps: antdLib.libPopconfirmMod.PopconfirmProps.type = antdLib.libPopconfirmMod.PopconfirmProps
  type PopconfirmProps = antdLib.libPopconfirmMod.PopconfirmProps
  @scala.inline
  def PopoverProps: antdLib.libPopoverMod.PopoverProps.type = antdLib.libPopoverMod.PopoverProps
  type PopoverProps = antdLib.libPopoverMod.PopoverProps
  @scala.inline
  def ProgressProps: antdLib.libProgressProgressMod.ProgressProps.type = antdLib.libProgressProgressMod.ProgressProps
  type ProgressProps = antdLib.libProgressProgressMod.ProgressProps
  type RadioButtonProps = antdLib.libRadioRadioButtonMod.RadioButtonProps
  type RadioProps = antdLib.libRadioInterfaceMod.RadioProps
  @scala.inline
  def RateProps: antdLib.libRateMod.RateProps.type = antdLib.libRateMod.RateProps
  type RateProps = antdLib.libRateMod.RateProps
  @scala.inline
  def RowProps: antdLib.libGridRowMod.RowProps.type = antdLib.libGridRowMod.RowProps
  type RowProps = antdLib.libGridRowMod.RowProps
  @scala.inline
  def ScrollNumberProps: antdLib.libBadgeScrollNumberMod.ScrollNumberProps.type = antdLib.libBadgeScrollNumberMod.ScrollNumberProps
  type ScrollNumberProps = antdLib.libBadgeScrollNumberMod.ScrollNumberProps
  @scala.inline
  def SearchProps: antdLib.libInputSearchMod.SearchProps.type = antdLib.libInputSearchMod.SearchProps
  type SearchProps = antdLib.libInputSearchMod.SearchProps
  @scala.inline
  ...
  @scala.inline
  def SliderProps: antdLib.libSliderMod.SliderProps.type = antdLib.libSliderMod.SliderProps
  type SliderProps = antdLib.libSliderMod.SliderProps
  @scala.inline
  def SpinProps: antdLib.libSpinMod.SpinProps.type = antdLib.libSpinMod.SpinProps
  type SpinProps = antdLib.libSpinMod.SpinProps
  @scala.inline
  def StepProps: antdLib.libStepsMod.StepProps.type = antdLib.libStepsMod.StepProps
  type StepProps = antdLib.libStepsMod.StepProps
  @scala.inline
  def StepsProps: antdLib.libStepsMod.StepsProps.type = antdLib.libStepsMod.StepsProps
  type StepsProps = antdLib.libStepsMod.StepsProps
  @scala.inline
  def SubMenuProps: antdLib.libMenuSubMenuMod.SubMenuProps.type = antdLib.libMenuSubMenuMod.SubMenuProps
  type SubMenuProps = antdLib.libMenuSubMenuMod.SubMenuProps
  @scala.inline
  def SwitchProps: antdLib.libSwitchMod.SwitchProps.type = antdLib.libSwitchMod.SwitchProps
  type SwitchProps = antdLib.libSwitchMod.SwitchProps
  @scala.inline
  def TabPaneProps: antdLib.libTabsMod.TabPaneProps.type = antdLib.libTabsMod.TabPaneProps
  type TabPaneProps = antdLib.libTabsMod.TabPaneProps
  @scala.inline
  def TableProps: antdLib.libTableInterfaceMod.TableProps.type = antdLib.libTableInterfaceMod.TableProps
  type TableProps[T] = antdLib.libTableInterfaceMod.TableProps[T]
  @scala.inline
  def TabsProps: antdLib.libTabsMod.TabsProps.type = antdLib.libTabsMod.TabsProps
  type TabsProps = antdLib.libTabsMod.TabsProps
  @scala.inline
  def TagProps: antdLib.libTagMod.TagProps.type = antdLib.libTagMod.TagProps
  type TagProps = antdLib.libTagMod.TagProps
  @scala.inline
  def TextAreaProps: antdLib.libInputTextAreaMod.TextAreaProps.type = antdLib.libInputTextAreaMod.TextAreaProps
  type TextAreaProps = antdLib.libInputTextAreaMod.TextAreaProps
  @scala.inline
  def TextProps: antdLib.libTypographyTextMod.TextProps.type = antdLib.libTypographyTextMod.TextProps
  type TextProps = antdLib.libTypographyTextMod.TextProps
  @scala.inline
  def TimeLineItemProps: antdLib.libTimelineTimelineItemMod.TimeLineItemProps.type = antdLib.libTimelineTimelineItemMod.TimeLineItemProps
  type TimeLineItemProps = antdLib.libTimelineTimelineItemMod.TimeLineItemProps
  @scala.inline
  def TimePickerProps: antdLib.libTimeDashPickerMod.TimePickerProps.type = antdLib.libTimeDashPickerMod.TimePickerProps
  type TimePickerProps = antdLib.libTimeDashPickerMod.TimePickerProps
  @scala.inline
  def TimelineProps: antdLib.libTimelineTimelineMod.TimelineProps.type = antdLib.libTimelineTimelineMod.TimelineProps
  type TimelineProps = antdLib.libTimelineTimelineMod.TimelineProps
  type TitleProps = antdLib.libTypographyTitleMod.TitleProps
  @scala.inline
  def TooltipProps: antdLib.libTooltipMod.TooltipProps.type = antdLib.libTooltipMod.TooltipProps
  type TooltipProps = antdLib.libTooltipMod.TooltipProps
  @scala.inline
  def TransferOperationProps: antdLib.libTransferOperationMod.TransferOperationProps.type = antdLib.libTransferOperationMod.TransferOperationProps
  type TransferOperationProps = antdLib.libTransferOperationMod.TransferOperationProps
  @scala.inline
  def TransferProps: antdLib.libTransferMod.TransferProps.type = antdLib.libTransferMod.TransferProps
  type TransferProps = antdLib.libTransferMod.TransferProps
  @scala.inline
  def TreeProps: antdLib.libTreeTreeMod.TreeProps.type = antdLib.libTreeTreeMod.TreeProps
  type TreeProps = antdLib.libTreeTreeMod.TreeProps
  @scala.inline
  def TreeSelectProps: antdLib.libTreeDashSelectInterfaceMod.TreeSelectProps.type = antdLib.libTreeDashSelectInterfaceMod.TreeSelectProps
  type TreeSelectProps = antdLib.libTreeDashSelectInterfaceMod.TreeSelectProps
  @scala.inline
  def UploadProps: antdLib.libUploadInterfaceMod.UploadProps.type = antdLib.libUploadInterfaceMod.UploadProps
  type UploadProps = antdLib.libUploadInterfaceMod.UploadProps
}
