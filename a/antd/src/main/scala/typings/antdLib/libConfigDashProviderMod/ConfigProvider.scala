...
trait ConfigProvider
  extends reactLib.reactMod.Component[ConfigProviderProps, js.Object, js.Any] {
  ...
  def renderProvider(context: ConfigConsumerProps): reactLib.reactMod.Global.JSXNs.Element = js.native
}
