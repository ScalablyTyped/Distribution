...
trait AntTreeNodeProps
  ...
  var icon: js.UndefOr[
    (js.Function1[/* treeNode */ AntdTreeNodeAttribute, reactLib.reactMod.ReactNode]) | reactLib.reactMod.ReactNode
  ] = js.undefined
...
object AntTreeNodeProps {
  ...
  def apply(
    ...
    icon: (js.Function1[/* treeNode */ AntdTreeNodeAttribute, reactLib.reactMod.ReactNode]) | reactLib.reactMod.ReactNode = null,
