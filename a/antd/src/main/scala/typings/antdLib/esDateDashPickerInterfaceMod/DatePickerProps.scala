...
trait DatePickerProps
  ...
  var showTime: js.UndefOr[antdLib.esTimeDashPickerMod.TimePickerProps | scala.Boolean] = js.undefined
...
object DatePickerProps {
  ...
  def apply(
    ...
    showTime: antdLib.esTimeDashPickerMod.TimePickerProps | scala.Boolean = null,
