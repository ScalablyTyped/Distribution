...
trait TransferSearchProps extends js.Object {
  ...
  var onChange: js.UndefOr[js.Function1[/* e */ reactLib.reactMod.FormEvent[_], scala.Unit]] = js.undefined
...
object TransferSearchProps {
  ...
  def apply(
    ...
    handleClear: /* e */ reactLib.reactMod.MouseEvent[_, reactLib.NativeMouseEvent] => scala.Unit = null,
    onChange: /* e */ reactLib.reactMod.FormEvent[_] => scala.Unit = null,
