...
trait CalendarProps extends js.Object {
  ...
  def headerRender(header: antdLib.libCalendarHeaderMod.RenderHeader): reactLib.reactMod.ReactNode
}

object CalendarProps {
  @scala.inline
  def apply(
    headerRender: antdLib.libCalendarHeaderMod.RenderHeader => reactLib.reactMod.ReactNode,
