...
trait WeakValidationMapStatisticPropsClassName extends js.Object {
  ...
  var formatter: js.UndefOr[
    reactLib.reactMod.Validator[js.UndefOr[antdLib.libStatisticUtilsMod.Formatter | scala.Null]]
  ] = js.undefined
  ...
  var value: js.UndefOr[
    reactLib.reactMod.Validator[js.UndefOr[scala.Null | antdLib.libStatisticUtilsMod.valueType]]
  ] = js.undefined
...
object WeakValidationMapStatisticPropsClassName {
  ...
  def apply(
    ...
    formatter: reactLib.reactMod.Validator[js.UndefOr[antdLib.libStatisticUtilsMod.Formatter | scala.Null]] = null,
    ...
    value: reactLib.reactMod.Validator[js.UndefOr[scala.Null | antdLib.libStatisticUtilsMod.valueType]] = null,
