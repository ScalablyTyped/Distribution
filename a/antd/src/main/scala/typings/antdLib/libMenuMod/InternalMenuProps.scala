...
/* Inlined antd.antd/lib/menu.MenuProps & antd.antd/lib/layout/Sider.SiderContextProps */
trait InternalMenuProps extends js.Object {
  ...
  var theme: js.UndefOr[antdLib.libMenuMenuContextMod.MenuTheme] = js.undefined
}
...
object InternalMenuProps {
  ...
  def apply(
    ...
    theme: antdLib.libMenuMenuContextMod.MenuTheme = null
  ): InternalMenuProps = {
