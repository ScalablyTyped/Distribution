package typings.awsSdkClientPinpointBrowser.typesUpdateBaiduChannelOutputMod
...
object UpdateBaiduChannelOutput {
  ...
  @scala.inline
  implicit class UpdateBaiduChannelOutputOps[Self <: UpdateBaiduChannelOutput] (val x: Self) extends AnyVal {
