...
object typesDeleteApnsVoipChannelExceptionsUnionMod {
  ...
  */
  trait DeleteApnsVoipChannelExceptionsUnion extends StObject
  object DeleteApnsVoipChannelExceptionsUnion {
