package typings.awsSdkClientPinpointBrowser.typesUpdateEmailChannelInputMod
...
trait UpdateEmailChannelInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var EmailChannelRequest: typings.awsSdkClientPinpointBrowser.typesEmailChannelRequestMod.EmailChannelRequest = js.native
}
