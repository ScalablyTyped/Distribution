package typings.awsSdkClientPinpointBrowser.typesDeleteGcmChannelInputMod
...
object DeleteGcmChannelInput {
  ...
  @scala.inline
  implicit class DeleteGcmChannelInputOps[Self <: DeleteGcmChannelInput] (val x: Self) extends AnyVal {
    @scala.inline
