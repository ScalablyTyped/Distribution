...
object typesDeleteCampaignInputMod {
  ...
  object DeleteCampaignInput {
    ...
    inline def apply(ApplicationId: String, CampaignId: String): DeleteCampaignInput = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: DeleteCampaignInput] (val x: Self) extends AnyVal {
