...
object typesDeleteApnsVoipSandboxChannelExceptionsUnionMod {
  ...
  */
  trait DeleteApnsVoipSandboxChannelExceptionsUnion extends StObject
  object DeleteApnsVoipSandboxChannelExceptionsUnion {
