...
object modelMapOfAttributeDimensionMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/model/_MapOfAttributeDimension", "_MapOfAttributeDimension")
  @js.native
  val MapOfAttributeDimension: Map[
