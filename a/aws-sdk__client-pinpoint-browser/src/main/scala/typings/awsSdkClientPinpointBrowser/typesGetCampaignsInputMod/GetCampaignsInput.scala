package typings.awsSdkClientPinpointBrowser.typesGetCampaignsInputMod
...
object GetCampaignsInput {
  ...
  @scala.inline
  implicit class GetCampaignsInputOps[Self <: GetCampaignsInput] (val x: Self) extends AnyVal {
    @scala.inline
