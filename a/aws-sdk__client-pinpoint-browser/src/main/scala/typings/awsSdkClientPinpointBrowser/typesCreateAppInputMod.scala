...
object typesCreateAppInputMod {
  ...
  trait CreateAppInput extends InputTypesUnion {
    ...
    /**
      * Application Request.
      */
    var CreateApplicationRequest: typings.awsSdkClientPinpointBrowser.typesCreateApplicationRequestMod.CreateApplicationRequest = js.native
  }
  object CreateAppInput {
    ...
    @scala.inline
    implicit class CreateAppInputMutableBuilder[Self <: CreateAppInput] (val x: Self) extends AnyVal {
