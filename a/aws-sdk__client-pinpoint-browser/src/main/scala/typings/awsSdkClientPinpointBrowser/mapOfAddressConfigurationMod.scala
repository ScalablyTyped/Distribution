...
object mapOfAddressConfigurationMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/model/_MapOfAddressConfiguration", "_MapOfAddressConfiguration")
  @js.native
  val MapOfAddressConfiguration: Map[
