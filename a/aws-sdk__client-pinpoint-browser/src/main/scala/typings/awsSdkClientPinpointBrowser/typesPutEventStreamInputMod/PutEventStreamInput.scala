package typings.awsSdkClientPinpointBrowser.typesPutEventStreamInputMod
...
trait PutEventStreamInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var WriteEventStream: typings.awsSdkClientPinpointBrowser.typesWriteEventStreamMod.WriteEventStream = js.native
}
...
object PutEventStreamInput {
  ...
  @scala.inline
  implicit class PutEventStreamInputOps[Self <: PutEventStreamInput] (val x: Self) extends AnyVal {
    @scala.inline
