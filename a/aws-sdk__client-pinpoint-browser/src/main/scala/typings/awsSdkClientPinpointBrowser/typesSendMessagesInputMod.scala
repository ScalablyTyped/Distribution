...
object typesSendMessagesInputMod {
  ...
  trait SendMessagesInput
    ...
    /**
      ...
      */
    var MessageRequest: typings.awsSdkClientPinpointBrowser.typesMessageRequestMod.MessageRequest
  }
  object SendMessagesInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SendMessagesInput] (val x: Self) extends AnyVal {
