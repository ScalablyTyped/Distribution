...
trait UpdateApnsVoipChannelInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var APNSVoipChannelRequest: typings.awsSdkClientPinpointBrowser.typesApnsvoipchannelrequestMod.APNSVoipChannelRequest = js.native
...
object UpdateApnsVoipChannelInput {
  ...
  @scala.inline
  implicit class UpdateApnsVoipChannelInputOps[Self <: UpdateApnsVoipChannelInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAPNSVoipChannelRequest(value: APNSVoipChannelRequest): Self = this.set("APNSVoipChannelRequest", value.asInstanceOf[js.Any])
