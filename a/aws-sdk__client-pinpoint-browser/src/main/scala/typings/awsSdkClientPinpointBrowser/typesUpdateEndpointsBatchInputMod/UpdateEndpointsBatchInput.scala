package typings.awsSdkClientPinpointBrowser.typesUpdateEndpointsBatchInputMod
...
object UpdateEndpointsBatchInput {
  ...
  @scala.inline
  implicit class UpdateEndpointsBatchInputOps[Self <: UpdateEndpointsBatchInput] (val x: Self) extends AnyVal {
