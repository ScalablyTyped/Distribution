...
object typesCreateCampaignInputMod {
  ...
  trait CreateCampaignInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var WriteCampaignRequest: typings.awsSdkClientPinpointBrowser.typesWriteCampaignRequestMod.WriteCampaignRequest = js.native
  }
  object CreateCampaignInput {
    ...
    @scala.inline
    implicit class CreateCampaignInputMutableBuilder[Self <: CreateCampaignInput] (val x: Self) extends AnyVal {
