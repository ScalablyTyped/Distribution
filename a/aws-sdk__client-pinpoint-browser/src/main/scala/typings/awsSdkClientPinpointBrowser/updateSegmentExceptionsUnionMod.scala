...
@JSImport("@aws-sdk/client-pinpoint-browser/types/UpdateSegmentExceptionsUnion", JSImport.Namespace)
@js.native
object updateSegmentExceptionsUnionMod extends js.Object {
