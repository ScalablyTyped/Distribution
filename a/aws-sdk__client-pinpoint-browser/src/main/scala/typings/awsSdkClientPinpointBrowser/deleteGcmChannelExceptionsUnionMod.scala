...
@JSImport("@aws-sdk/client-pinpoint-browser/types/DeleteGcmChannelExceptionsUnion", JSImport.Namespace)
@js.native
object deleteGcmChannelExceptionsUnionMod extends js.Object {
