package typings.awsSdkClientPinpointBrowser.typesDeleteCampaignInputMod
...
object DeleteCampaignInput {
  ...
  @scala.inline
  implicit class DeleteCampaignInputOps[Self <: DeleteCampaignInput] (val x: Self) extends AnyVal {
    @scala.inline
