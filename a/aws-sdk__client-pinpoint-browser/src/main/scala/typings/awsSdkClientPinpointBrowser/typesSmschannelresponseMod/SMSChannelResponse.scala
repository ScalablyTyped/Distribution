...
object SMSChannelResponse {
  ...
  implicit class SMSChannelResponseOps[Self <: SMSChannelResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPromotionalMessagesPerSecond(value: Double): Self = this.set("PromotionalMessagesPerSecond", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTransactionalMessagesPerSecond(value: Double): Self = this.set("TransactionalMessagesPerSecond", value.asInstanceOf[js.Any])
