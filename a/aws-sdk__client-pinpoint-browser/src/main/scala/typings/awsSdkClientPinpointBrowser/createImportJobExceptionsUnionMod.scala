...
@JSImport("@aws-sdk/client-pinpoint-browser/types/CreateImportJobExceptionsUnion", JSImport.Namespace)
@js.native
object createImportJobExceptionsUnionMod extends js.Object {
