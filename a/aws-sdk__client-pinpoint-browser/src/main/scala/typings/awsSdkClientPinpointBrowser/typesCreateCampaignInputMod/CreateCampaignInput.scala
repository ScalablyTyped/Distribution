package typings.awsSdkClientPinpointBrowser.typesCreateCampaignInputMod
...
object CreateCampaignInput {
  ...
  @scala.inline
  implicit class CreateCampaignInputOps[Self <: CreateCampaignInput] (val x: Self) extends AnyVal {
    @scala.inline
