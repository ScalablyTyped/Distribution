...
object typesUpdateSegmentInputMod {
  ...
  trait UpdateSegmentInput extends InputTypesUnion {
    ...
    /**
      * Segment definition.
      */
    var WriteSegmentRequest: typings.awsSdkClientPinpointBrowser.typesWriteSegmentRequestMod.WriteSegmentRequest = js.native
  }
  object UpdateSegmentInput {
    ...
    @scala.inline
    implicit class UpdateSegmentInputMutableBuilder[Self <: UpdateSegmentInput] (val x: Self) extends AnyVal {
