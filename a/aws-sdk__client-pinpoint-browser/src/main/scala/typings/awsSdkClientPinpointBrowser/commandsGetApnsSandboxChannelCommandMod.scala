...
object commandsGetApnsSandboxChannelCommandMod {
  ...
  open class GetApnsSandboxChannelCommand protected ()
    ...
    /* CompleteClass */
    override val middlewareStack: MiddlewareStack[GetApnsSandboxChannelInput, GetApnsSandboxChannelOutput] = js.native
