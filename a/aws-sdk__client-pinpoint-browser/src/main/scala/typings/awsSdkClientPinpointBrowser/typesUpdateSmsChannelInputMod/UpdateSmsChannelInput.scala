package typings.awsSdkClientPinpointBrowser.typesUpdateSmsChannelInputMod
...
@js.native
trait UpdateSmsChannelInput extends InputTypesUnion {
  ...
  /**
    * SMS Channel Request
    */
  var SMSChannelRequest: typings.awsSdkClientPinpointBrowser.typesSmschannelrequestMod.SMSChannelRequest = js.native
}
object UpdateSmsChannelInput {
  ...
  @scala.inline
  implicit class UpdateSmsChannelInputOps[Self <: UpdateSmsChannelInput] (val x: Self) extends AnyVal {
