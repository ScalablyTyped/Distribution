...
object updateApnsVoipChannelCommandMod {
  ...
  @js.native
  open class UpdateApnsVoipChannelCommand protected ()
    extends StObject
       with Command[
          InputTypesUnion, 
    ...
    /* CompleteClass */
    override val middlewareStack: MiddlewareStack[UpdateApnsVoipChannelInput, UpdateApnsVoipChannelOutput] = js.native
