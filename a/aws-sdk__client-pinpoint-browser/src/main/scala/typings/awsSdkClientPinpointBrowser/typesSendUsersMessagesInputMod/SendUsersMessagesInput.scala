package typings.awsSdkClientPinpointBrowser.typesSendUsersMessagesInputMod
...
@js.native
trait SendUsersMessagesInput extends InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var SendUsersMessageRequest: typings.awsSdkClientPinpointBrowser.typesSendUsersMessageRequestMod.SendUsersMessageRequest = js.native
}
...
object SendUsersMessagesInput {
  ...
  @scala.inline
  implicit class SendUsersMessagesInputOps[Self <: SendUsersMessagesInput] (val x: Self) extends AnyVal {
    @scala.inline
