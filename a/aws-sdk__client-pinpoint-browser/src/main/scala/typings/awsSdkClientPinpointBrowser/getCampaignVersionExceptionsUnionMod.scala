...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetCampaignVersionExceptionsUnion", JSImport.Namespace)
@js.native
object getCampaignVersionExceptionsUnionMod extends js.Object {
