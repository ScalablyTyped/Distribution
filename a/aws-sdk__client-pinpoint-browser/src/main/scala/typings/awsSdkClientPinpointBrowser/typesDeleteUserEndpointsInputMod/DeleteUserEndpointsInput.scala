package typings.awsSdkClientPinpointBrowser.typesDeleteUserEndpointsInputMod
...
object DeleteUserEndpointsInput {
  ...
  @scala.inline
  implicit class DeleteUserEndpointsInputOps[Self <: DeleteUserEndpointsInput] (val x: Self) extends AnyVal {
    @scala.inline
