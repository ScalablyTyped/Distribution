...
@JSImport("@aws-sdk/client-pinpoint-browser/types/UpdateApplicationSettingsExceptionsUnion", JSImport.Namespace)
@js.native
object updateApplicationSettingsExceptionsUnionMod extends js.Object {
