package typings.awsSdkClientPinpointBrowser.typesUpdateApplicationSettingsInputMod
...
trait UpdateApplicationSettingsInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var WriteApplicationSettingsRequest: typings.awsSdkClientPinpointBrowser.typesWriteApplicationSettingsRequestMod.WriteApplicationSettingsRequest = js.native
}
object UpdateApplicationSettingsInput {
  ...
  @scala.inline
  implicit class UpdateApplicationSettingsInputOps[Self <: UpdateApplicationSettingsInput] (val x: Self) extends AnyVal {
