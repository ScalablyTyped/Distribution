...
object typesUpdateApnsSandboxChannelInputMod {
  ...
  trait UpdateApnsSandboxChannelInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var APNSSandboxChannelRequest: typings.awsSdkClientPinpointBrowser.typesApnssandboxchannelrequestMod.APNSSandboxChannelRequest = js.native
  ...
  object UpdateApnsSandboxChannelInput {
    ...
    @scala.inline
    implicit class UpdateApnsSandboxChannelInputMutableBuilder[Self <: UpdateApnsSandboxChannelInput] (val x: Self) extends AnyVal {
