...
@JSImport("@aws-sdk/client-pinpoint-browser/types/UpdateEndpointExceptionsUnion", JSImport.Namespace)
@js.native
object updateEndpointExceptionsUnionMod extends js.Object {
