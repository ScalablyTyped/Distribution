package typings.awsSdkClientPinpointBrowser.typesGetEndpointInputMod
...
object GetEndpointInput {
  ...
  @scala.inline
  implicit class GetEndpointInputOps[Self <: GetEndpointInput] (val x: Self) extends AnyVal {
    @scala.inline
