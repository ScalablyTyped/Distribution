...
@JSImport("@aws-sdk/client-pinpoint-browser/types/UpdateEmailChannelExceptionsUnion", JSImport.Namespace)
@js.native
object updateEmailChannelExceptionsUnionMod extends js.Object {
