...
object typesGetEndpointInputMod {
  ...
  object GetEndpointInput {
    ...
    @scala.inline
    def apply(ApplicationId: String, EndpointId: String): GetEndpointInput = {
    ...
    @scala.inline
    implicit class GetEndpointInputMutableBuilder[Self <: GetEndpointInput] (val x: Self) extends AnyVal {
