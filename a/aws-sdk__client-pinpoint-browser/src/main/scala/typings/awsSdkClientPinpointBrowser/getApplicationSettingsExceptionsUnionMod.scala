...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetApplicationSettingsExceptionsUnion", JSImport.Namespace)
@js.native
object getApplicationSettingsExceptionsUnionMod extends js.Object {
