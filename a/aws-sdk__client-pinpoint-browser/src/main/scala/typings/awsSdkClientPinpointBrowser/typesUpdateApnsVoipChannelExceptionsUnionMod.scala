...
object typesUpdateApnsVoipChannelExceptionsUnionMod {
  ...
  */
  trait UpdateApnsVoipChannelExceptionsUnion extends StObject
  object UpdateApnsVoipChannelExceptionsUnion {
