package typings.awsSdkClientPinpointBrowser.typesCreateExportJobInputMod
...
@js.native
trait CreateExportJobInput extends InputTypesUnion {
  ...
  /**
    * Export job request.
    */
  var ExportJobRequest: typings.awsSdkClientPinpointBrowser.typesExportJobRequestMod.ExportJobRequest = js.native
}
object CreateExportJobInput {
  ...
  @scala.inline
  implicit class CreateExportJobInputOps[Self <: CreateExportJobInput] (val x: Self) extends AnyVal {
