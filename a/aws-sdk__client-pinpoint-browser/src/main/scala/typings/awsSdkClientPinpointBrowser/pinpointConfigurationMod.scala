...
object pinpointConfigurationMod {
  ...
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<PinpointResolvableConfiguration, PinpointResolvedConfiguration> */ js.Any = js.native
  ...
  object PinpointConfiguration {
    ...
    @scala.inline
    def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): PinpointConfiguration = {
    ...
    @scala.inline
    implicit class PinpointConfigurationMutableBuilder[Self <: PinpointConfiguration] (val x: Self) extends AnyVal {
  ...
  object PinpointResolvableConfiguration {
    ...
    @scala.inline
    implicit class PinpointResolvableConfigurationMutableBuilder[Self <: PinpointResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait PinpointResolvedConfiguration
    ...
    def base64Decoder_MPinpointResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MPinpointResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MPinpointResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("utf8Decoder")
    def utf8Decoder_MPinpointResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MPinpointResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
  ...
  object PinpointResolvedConfiguration {
    ...
    @scala.inline
    implicit class PinpointResolvedConfigurationMutableBuilder[Self <: PinpointResolvedConfiguration] (val x: Self) extends AnyVal {
