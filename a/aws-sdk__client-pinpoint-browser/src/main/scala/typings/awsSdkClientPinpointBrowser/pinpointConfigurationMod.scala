...
object pinpointConfigurationMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/PinpointConfiguration", "configurationProperties")
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<PinpointResolvableConfiguration, PinpointResolvedConfiguration> */ Any = js.native
  
  trait PinpointConfiguration extends StObject {
  ...
  object PinpointConfiguration {
    
    inline def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): PinpointConfiguration = {
      val __obj = js.Dynamic.literal(credentials = credentials.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
      __obj.asInstanceOf[PinpointConfiguration]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PinpointConfiguration] (val x: Self) extends AnyVal {
  ...
  trait PinpointResolvableConfiguration
    extends StObject
       with PinpointConfiguration {
  ...
  object PinpointResolvableConfiguration {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[PinpointResolvableConfiguration]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PinpointResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait PinpointResolvedConfiguration
    extends StObject
       with PinpointConfiguration {
    ...
    def base64Decoder_MPinpointResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MPinpointResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MPinpointResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MPinpointResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_PinpointResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_PinpointResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<Blob> */ Any
    
    @JSName("region")
    def region_MPinpointResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_PinpointResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_PinpointResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_PinpointResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_PinpointResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MPinpointResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MPinpointResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    def urlParser_MPinpointResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MPinpointResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MPinpointResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
    var utf8Encoder_Original: Encoder
  }
  object PinpointResolvedConfiguration {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[PinpointResolvedConfiguration]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: PinpointResolvedConfiguration] (val x: Self) extends AnyVal {
