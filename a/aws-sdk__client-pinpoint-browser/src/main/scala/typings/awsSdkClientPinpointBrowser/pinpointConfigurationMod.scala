...
object pinpointConfigurationMod {
  ...
  @js.native
  trait PinpointResolvableConfiguration extends PinpointConfiguration {
  ...
  trait PinpointResolvedConfiguration extends PinpointConfiguration {
    ...
    def streamCollector_MPinpointResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array] = js.native
    @JSName("streamCollector")
