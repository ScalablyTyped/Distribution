...
object getApnsVoipSandboxChannelExceptionsUnionMod {
  ...
  */
  trait GetApnsVoipSandboxChannelExceptionsUnion extends StObject
  object GetApnsVoipSandboxChannelExceptionsUnion {
