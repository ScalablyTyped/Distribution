package typings.awsSdkClientPinpointBrowser.typesGetCampaignInputMod
...
object GetCampaignInput {
  ...
  @scala.inline
  implicit class GetCampaignInputOps[Self <: GetCampaignInput] (val x: Self) extends AnyVal {
