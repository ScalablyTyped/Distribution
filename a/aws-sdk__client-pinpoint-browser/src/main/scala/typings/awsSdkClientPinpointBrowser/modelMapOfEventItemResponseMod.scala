...
object modelMapOfEventItemResponseMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/model/_MapOfEventItemResponse", "_MapOfEventItemResponse")
  @js.native
  val MapOfEventItemResponse: Map[
