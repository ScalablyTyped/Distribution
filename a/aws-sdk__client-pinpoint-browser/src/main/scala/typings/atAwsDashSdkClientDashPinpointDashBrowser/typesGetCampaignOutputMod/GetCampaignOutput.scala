package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesGetCampaignOutputMod
...
object GetCampaignOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, CampaignResponse: _UnmarshalledCampaignResponse): GetCampaignOutput = {
