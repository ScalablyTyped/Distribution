package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesGetImportJobsOutputMod
...
object GetImportJobsOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, ImportJobsResponse: _UnmarshalledImportJobsResponse): GetImportJobsOutput = {
