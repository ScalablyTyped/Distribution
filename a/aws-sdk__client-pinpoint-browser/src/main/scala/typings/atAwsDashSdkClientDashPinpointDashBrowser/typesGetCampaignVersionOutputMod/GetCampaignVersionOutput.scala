package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesGetCampaignVersionOutputMod
...
object GetCampaignVersionOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, CampaignResponse: _UnmarshalledCampaignResponse): GetCampaignVersionOutput = {
