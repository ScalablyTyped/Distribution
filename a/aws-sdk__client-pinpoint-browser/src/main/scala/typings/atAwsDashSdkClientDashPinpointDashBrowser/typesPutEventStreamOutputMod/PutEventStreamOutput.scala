package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesPutEventStreamOutputMod
...
object PutEventStreamOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, EventStream: _UnmarshalledEventStream): PutEventStreamOutput = {
