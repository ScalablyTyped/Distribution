package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesDeleteApnsVoipChannelOutputMod
...
trait DeleteApnsVoipChannelOutput extends OutputTypesUnion {
  ...
  /**
    ...
    */
  var APNSVoipChannelResponse: _UnmarshalledAPNSVoipChannelResponse
}
