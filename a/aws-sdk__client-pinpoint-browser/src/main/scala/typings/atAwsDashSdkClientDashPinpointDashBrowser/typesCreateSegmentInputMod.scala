...
@JSImport("@aws-sdk/client-pinpoint-browser/types/CreateSegmentInput", JSImport.Namespace)
@js.native
object typesCreateSegmentInputMod extends js.Object {
  @js.native
  trait CreateSegmentInput extends InputTypesUnion {
    ...
    /**
      * Segment definition.
      */
    var WriteSegmentRequest: _WriteSegmentRequest = js.native
  }
