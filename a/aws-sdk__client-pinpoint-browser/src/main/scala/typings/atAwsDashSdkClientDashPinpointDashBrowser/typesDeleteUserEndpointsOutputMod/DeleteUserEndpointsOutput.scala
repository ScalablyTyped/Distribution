package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesDeleteUserEndpointsOutputMod
...
object DeleteUserEndpointsOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, EndpointsResponse: _UnmarshalledEndpointsResponse): DeleteUserEndpointsOutput = {
