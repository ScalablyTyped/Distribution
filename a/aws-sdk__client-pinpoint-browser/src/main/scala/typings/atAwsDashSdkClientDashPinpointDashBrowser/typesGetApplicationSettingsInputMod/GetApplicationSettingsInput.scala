package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesGetApplicationSettingsInputMod
...
trait GetApplicationSettingsInput extends InputTypesUnion {
  /**
