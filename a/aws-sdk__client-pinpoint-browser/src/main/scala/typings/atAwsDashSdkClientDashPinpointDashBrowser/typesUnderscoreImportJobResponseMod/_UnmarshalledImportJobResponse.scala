package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreImportJobResponseMod
...
import typings.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreImportJobResourceMod._UnmarshalledImportJobResource
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait _UnmarshalledImportJobResponse extends _ImportJobResponse {
  /**
    * The import job settings.
    */
  @JSName("Definition")
  var Definition__UnmarshalledImportJobResponse: js.UndefOr[_UnmarshalledImportJobResource] = js.undefined
  /**
    * Provides up to 100 of the first failed entries for the job, if any exist.
    */
  @JSName("Failures")
  var Failures__UnmarshalledImportJobResponse: js.UndefOr[js.Array[String]] = js.undefined
}

object _UnmarshalledImportJobResponse {
  @scala.inline
  def apply(
    ...
    Definition: _UnmarshalledImportJobResource = null,
    ...
    __obj.asInstanceOf[_UnmarshalledImportJobResponse]
  }
}
