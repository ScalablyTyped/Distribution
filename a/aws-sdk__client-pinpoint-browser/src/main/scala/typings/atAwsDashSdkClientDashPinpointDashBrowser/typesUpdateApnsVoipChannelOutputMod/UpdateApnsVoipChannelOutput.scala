package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesUpdateApnsVoipChannelOutputMod
...
object UpdateApnsVoipChannelOutput {
  @scala.inline
  def apply($metadata: ResponseMetadata, APNSVoipChannelResponse: _UnmarshalledAPNSVoipChannelResponse): UpdateApnsVoipChannelOutput = {
