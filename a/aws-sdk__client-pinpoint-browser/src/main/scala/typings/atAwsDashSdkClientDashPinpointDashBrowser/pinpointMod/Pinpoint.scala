package typings.atAwsDashSdkClientDashPinpointDashBrowser.pinpointMod

import typings.atAwsDashSdkClientDashPinpointDashBrowser.pinpointClientMod.PinpointClient
