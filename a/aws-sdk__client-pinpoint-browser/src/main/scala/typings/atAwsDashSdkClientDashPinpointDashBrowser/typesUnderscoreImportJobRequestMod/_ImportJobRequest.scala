package typings.atAwsDashSdkClientDashPinpointDashBrowser.typesUnderscoreImportJobRequestMod
...
trait _ImportJobRequest extends js.Object {
  /**
...
object _ImportJobRequest {
  ...
  def apply(
    ...
    __obj.asInstanceOf[_ImportJobRequest]
  }
}
