...
import typings.awsSdkClientDynamodb.distTypesCommandsUpdateItemCommandMod.UpdateItemCommandOutput
...
import typings.awsSdkClientDynamodb.mod.UpdateItemCommand
...
import typings.awsSdkLibDynamodb.anon.OmitAttributeValueUpdateV
...
object distTypesCommandsUpdateCommandMod {
  
  @JSImport("@aws-sdk/lib-dynamodb/dist-types/commands/UpdateCommand", "UpdateCommand")
  @js.native
  open class UpdateCommand protected () extends DynamoDBDocumentClientCommand[
          UpdateCommandInput, 
          UpdateCommandOutput, 
    ...
    val clientCommand_UpdateCommand: UpdateItemCommand = js.native
    
    /* protected */ @JSName("inputKeyNodes")
    val inputKeyNodes_UpdateCommand: js.Array[KeyString | ChildrenKey] = js.native
    
    @JSName("input")
    val input_UpdateCommand: UpdateCommandInput = js.native
    
    /* protected */ @JSName("outputKeyNodes")
    val outputKeyNodes_UpdateCommand: js.Array[KeyString | Children] = js.native
    ...
    ): Handler[UpdateCommandInput, UpdateCommandOutput] = js.native
    def resolveMiddleware(
      clientStack: MiddlewareStack[ServiceInputTypes, ServiceOutputTypes],
      configuration: DynamoDBDocumentClientResolvedConfig,
  ...
  /* Inlined std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.UpdateItemCommandInput, 'Key' | 'AttributeUpdates' | 'Expected' | 'ExpressionAttributeValues'> & {  Key :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined,   AttributeUpdates :std.Record<string, std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.AttributeValueUpdate, 'Value'> & {  Value :@aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue | undefined}> | undefined,   Expected :std.Record<string, std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.ExpectedAttributeValue, 'Value' | 'AttributeValueList'> & {  Value :@aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue | undefined,   AttributeValueList :std.Array<@aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined}> | undefined,   ExpressionAttributeValues :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined} */
  trait UpdateCommandInput
    extends StObject
       with _ServiceInputTypes {
    
    var AttributeUpdates: js.UndefOr[Record[String, OmitAttributeValueUpdateV]] = js.undefined
  ...
  object UpdateCommandInput {
    
    inline def apply(): UpdateCommandInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[UpdateCommandInput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: UpdateCommandInput] (val x: Self) extends AnyVal {
      
      inline def setAttributeUpdates(value: Record[String, OmitAttributeValueUpdateV]): Self = StObject.set(x, "AttributeUpdates", value.asInstanceOf[js.Any])
  ...
  /* Inlined std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.UpdateItemCommandOutput, 'Attributes' | 'ItemCollectionMetrics'> & {  Attributes :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined,   ItemCollectionMetrics :std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.ItemCollectionMetrics, 'ItemCollectionKey'> & {  ItemCollectionKey :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined} | undefined} */
  trait UpdateCommandOutput
    extends StObject
  ...
  object UpdateCommandOutput {
    
    inline def apply($metadata: ResponseMetadata): UpdateCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[UpdateCommandOutput]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: UpdateCommandOutput] (val x: Self) extends AnyVal {
