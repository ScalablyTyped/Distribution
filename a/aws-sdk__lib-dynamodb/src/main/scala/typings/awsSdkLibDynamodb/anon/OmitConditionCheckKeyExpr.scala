...
/* Inlined std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.ConditionCheck, 'Key' | 'ExpressionAttributeValues'> & {  Key :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined,   ExpressionAttributeValues :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined} */
trait OmitConditionCheckKeyExpr extends StObject {
...
object OmitConditionCheckKeyExpr {
  
  inline def apply(): OmitConditionCheckKeyExpr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitConditionCheckKeyExpr]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitConditionCheckKeyExpr] (val x: Self) extends AnyVal {
