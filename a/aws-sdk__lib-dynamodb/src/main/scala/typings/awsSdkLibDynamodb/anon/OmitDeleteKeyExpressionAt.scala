...
/* Inlined std.Omit<@aws-sdk/client-dynamodb.@aws-sdk/client-dynamodb.Delete, 'Key' | 'ExpressionAttributeValues'> & {  Key :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined,   ExpressionAttributeValues :std.Record<string, @aws-sdk/util-dynamodb.@aws-sdk/util-dynamodb.NativeAttributeValue> | undefined} */
trait OmitDeleteKeyExpressionAt extends StObject {
...
object OmitDeleteKeyExpressionAt {
  
  inline def apply(): OmitDeleteKeyExpressionAt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitDeleteKeyExpressionAt]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitDeleteKeyExpressionAt] (val x: Self) extends AnyVal {
