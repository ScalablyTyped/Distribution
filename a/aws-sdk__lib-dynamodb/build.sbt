...
name := "aws-sdk__lib-dynamodb"
version := "3.329.0-bba2fc"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "aws-sdk__client-dynamodb" % "3.329.0-6e4d4d",
  ...
  "org.scalablytyped" %%% "aws-sdk__util-dynamodb" % "3.329.0-8f79f9",
