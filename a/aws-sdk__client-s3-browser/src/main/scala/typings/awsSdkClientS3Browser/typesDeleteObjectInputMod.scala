...
object typesDeleteObjectInputMod {
  
  @js.native
  trait DeleteObjectInput extends _InputTypesUnion {
  ...
  object DeleteObjectInput {
    ...
    @scala.inline
    implicit class DeleteObjectInputMutableBuilder[Self <: DeleteObjectInput] (val x: Self) extends AnyVal {
