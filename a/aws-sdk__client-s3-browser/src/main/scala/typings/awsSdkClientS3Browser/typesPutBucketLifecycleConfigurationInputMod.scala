...
import typings.awsSdkClientS3Browser.typesBucketLifecycleConfigurationMod.BucketLifecycleConfiguration
...
object typesPutBucketLifecycleConfigurationInputMod {
  ...
  object PutBucketLifecycleConfigurationInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketLifecycleConfigurationInput] (val x: Self) extends AnyVal {
