...
object typesPutBucketLoggingInputMod {
  ...
  trait PutBucketLoggingInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var BucketLoggingStatus: typings.awsSdkClientS3Browser.typesBucketLoggingStatusMod.BucketLoggingStatus = js.native
  ...
  object PutBucketLoggingInput {
    ...
    @scala.inline
    implicit class PutBucketLoggingInputMutableBuilder[Self <: PutBucketLoggingInput] (val x: Self) extends AnyVal {
