package typings.awsSdkClientS3Browser.typesGetBucketAclInputMod
...
@js.native
trait GetBucketAclInput extends _InputTypesUnion {
  /**
...
object GetBucketAclInput {
  ...
  @scala.inline
  implicit class GetBucketAclInputOps[Self <: GetBucketAclInput] (val x: Self) extends AnyVal {
    @scala.inline
