package typings.awsSdkClientS3Browser.typesNoncurrentVersionExpirationMod
...
object NoncurrentVersionExpiration {
  @scala.inline
  def apply(NoncurrentDays: js.UndefOr[Double] = js.undefined): NoncurrentVersionExpiration = {
