...
@JSImport("@aws-sdk/client-s3-browser/types/RestoreObjectInput", JSImport.Namespace)
@js.native
object typesRestoreObjectInputMod extends js.Object {
  ...
  trait RestoreObjectInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var RestoreRequest: js.UndefOr[typings.awsSdkClientS3Browser.typesRestoreRequestMod.RestoreRequest] = js.native
    /**
