...
object typesGetBucketMetricsConfigurationInputMod {
  ...
  object GetBucketMetricsConfigurationInput {
    ...
    @scala.inline
    implicit class GetBucketMetricsConfigurationInputMutableBuilder[Self <: GetBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
