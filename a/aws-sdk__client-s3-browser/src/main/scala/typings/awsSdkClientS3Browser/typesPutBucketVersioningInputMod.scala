...
object typesPutBucketVersioningInputMod {
  ...
  trait PutBucketVersioningInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var VersioningConfiguration: typings.awsSdkClientS3Browser.typesVersioningConfigurationMod.VersioningConfiguration = js.native
  }
  object PutBucketVersioningInput {
    ...
    @scala.inline
    implicit class PutBucketVersioningInputMutableBuilder[Self <: PutBucketVersioningInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setMFA(value: String): Self = StObject.set(x, "MFA", value.asInstanceOf[js.Any])
