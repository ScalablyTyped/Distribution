...
object typesPutBucketVersioningInputMod {
  ...
  object PutBucketVersioningInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketVersioningInput] (val x: Self) extends AnyVal {
      ...
      inline def setMFA(value: String): Self = StObject.set(x, "MFA", value.asInstanceOf[js.Any])
