...
object typesUploadPartCopyInputMod {
  ...
  object UploadPartCopyInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: UploadPartCopyInput] (val x: Self) extends AnyVal {
      ...
      inline def setCopySourceRange(value: String): Self = StObject.set(x, "CopySourceRange", value.asInstanceOf[js.Any])
