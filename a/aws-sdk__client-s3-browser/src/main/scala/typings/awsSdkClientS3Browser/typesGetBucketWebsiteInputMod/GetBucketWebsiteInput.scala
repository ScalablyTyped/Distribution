package typings.awsSdkClientS3Browser.typesGetBucketWebsiteInputMod
...
object GetBucketWebsiteInput {
  ...
  @scala.inline
  implicit class GetBucketWebsiteInputOps[Self <: GetBucketWebsiteInput] (val x: Self) extends AnyVal {
    @scala.inline
