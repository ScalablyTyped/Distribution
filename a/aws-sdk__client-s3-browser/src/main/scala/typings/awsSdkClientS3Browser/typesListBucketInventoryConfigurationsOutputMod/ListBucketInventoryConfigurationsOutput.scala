package typings.awsSdkClientS3Browser.typesListBucketInventoryConfigurationsOutputMod
...
object ListBucketInventoryConfigurationsOutput {
  ...
  def apply(
    ...
    InventoryConfigurationList: js.Array[UnmarshalledInventoryConfiguration] = null,
