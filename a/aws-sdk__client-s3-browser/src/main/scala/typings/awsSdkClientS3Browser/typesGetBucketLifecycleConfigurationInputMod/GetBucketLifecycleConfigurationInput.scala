package typings.awsSdkClientS3Browser.typesGetBucketLifecycleConfigurationInputMod
...
@js.native
trait GetBucketLifecycleConfigurationInput extends _InputTypesUnion {
...
object GetBucketLifecycleConfigurationInput {
  
  @scala.inline
  def apply(Bucket: String): GetBucketLifecycleConfigurationInput = {
    val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetBucketLifecycleConfigurationInput]
  }
  
  @scala.inline
  implicit class GetBucketLifecycleConfigurationInputOps[Self <: GetBucketLifecycleConfigurationInput] (val x: Self) extends AnyVal {
