package typings.awsSdkClientS3Browser.typesDeleteBucketAnalyticsConfigurationInputMod
...
object DeleteBucketAnalyticsConfigurationInput {
  ...
  @scala.inline
  implicit class DeleteBucketAnalyticsConfigurationInputOps[Self <: DeleteBucketAnalyticsConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
