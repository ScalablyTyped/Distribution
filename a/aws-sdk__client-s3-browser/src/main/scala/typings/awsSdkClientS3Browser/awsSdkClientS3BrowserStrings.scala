...
object awsSdkClientS3BrowserStrings {
  ...
  inline def AmazonCustomerByEmail: AmazonCustomerByEmail = "AmazonCustomerByEmail".asInstanceOf[AmazonCustomerByEmail]
  ...
  inline def BucketAlreadyExists: BucketAlreadyExists = "BucketAlreadyExists".asInstanceOf[BucketAlreadyExists]
  
  @js.native
  sealed trait BucketAlreadyOwnedByYou extends StObject
  inline def BucketAlreadyOwnedByYou: BucketAlreadyOwnedByYou = "BucketAlreadyOwnedByYou".asInstanceOf[BucketAlreadyOwnedByYou]
  
  @js.native
  sealed trait BucketOwner extends StObject
  inline def BucketOwner: BucketOwner = "BucketOwner".asInstanceOf[BucketOwner]
  ...
  inline def CanonicalUser: CanonicalUser = "CanonicalUser".asInstanceOf[CanonicalUser]
  ...
  inline def EncryptionStatus: EncryptionStatus = "EncryptionStatus".asInstanceOf[EncryptionStatus]
  
  @js.native
  sealed trait Expedited extends StObject
  inline def Expedited: Expedited = "Expedited".asInstanceOf[Expedited]
  ...
  inline def FULL_CONTROL: FULL_CONTROL = "FULL_CONTROL".asInstanceOf[FULL_CONTROL]
  ...
  inline def IsMultipartUploaded: IsMultipartUploaded = "IsMultipartUploaded".asInstanceOf[IsMultipartUploaded]
  ...
  inline def LastModifiedDate: LastModifiedDate = "LastModifiedDate".asInstanceOf[LastModifiedDate]
  ...
  inline def NoSuchBucket: NoSuchBucket = "NoSuchBucket".asInstanceOf[NoSuchBucket]
  
  @js.native
  sealed trait NoSuchKey extends StObject
  inline def NoSuchKey: NoSuchKey = "NoSuchKey".asInstanceOf[NoSuchKey]
  
  @js.native
  sealed trait NoSuchUpload extends StObject
  inline def NoSuchUpload: NoSuchUpload = "NoSuchUpload".asInstanceOf[NoSuchUpload]
  ...
  inline def ORC: ORC = "ORC".asInstanceOf[ORC]
  
  @js.native
  sealed trait ObjectAlreadyInActiveTierError extends StObject
  inline def ObjectAlreadyInActiveTierError: ObjectAlreadyInActiveTierError = "ObjectAlreadyInActiveTierError".asInstanceOf[ObjectAlreadyInActiveTierError]
  
  @js.native
  sealed trait ObjectNotInActiveTierError extends StObject
  inline def ObjectNotInActiveTierError: ObjectNotInActiveTierError = "ObjectNotInActiveTierError".asInstanceOf[ObjectNotInActiveTierError]
  ...
  inline def READ_ACP: READ_ACP = "READ_ACP".asInstanceOf[READ_ACP]
  ...
  inline def ReplicationStatus: ReplicationStatus = "ReplicationStatus".asInstanceOf[ReplicationStatus]
  ...
  inline def StorageClass: StorageClass = "StorageClass".asInstanceOf[StorageClass]
  ...
  inline def V_1: V_1 = "V_1".asInstanceOf[V_1]
  ...
  inline def WRITE_ACP: WRITE_ACP = "WRITE_ACP".asInstanceOf[WRITE_ACP]
  ...
  inline def requester_ : requester_ = "requester".asInstanceOf[requester_]
