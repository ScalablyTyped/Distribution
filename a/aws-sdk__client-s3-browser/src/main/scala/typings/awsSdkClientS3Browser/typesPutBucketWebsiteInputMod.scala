...
object typesPutBucketWebsiteInputMod {
  ...
  trait PutBucketWebsiteInput
    ...
    /**
      ...
      */
    var WebsiteConfiguration: typings.awsSdkClientS3Browser.typesWebsiteConfigurationMod.WebsiteConfiguration
  }
  object PutBucketWebsiteInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketWebsiteInput] (val x: Self) extends AnyVal {
