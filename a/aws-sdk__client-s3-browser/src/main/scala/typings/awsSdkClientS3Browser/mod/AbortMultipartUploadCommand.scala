...
@JSImport("@aws-sdk/client-s3-browser", "AbortMultipartUploadCommand")
@js.native
open class AbortMultipartUploadCommand protected ()
  extends typings.awsSdkClientS3Browser.commandsAbortMultipartUploadCommandMod.AbortMultipartUploadCommand {
