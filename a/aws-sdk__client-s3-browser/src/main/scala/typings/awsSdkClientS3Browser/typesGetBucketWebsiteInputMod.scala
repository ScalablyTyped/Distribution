...
object typesGetBucketWebsiteInputMod {
  
  @js.native
  trait GetBucketWebsiteInput extends _InputTypesUnion {
  ...
  object GetBucketWebsiteInput {
    
    @scala.inline
    def apply(Bucket: String): GetBucketWebsiteInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetBucketWebsiteInput]
    }
    
    @scala.inline
    implicit class GetBucketWebsiteInputMutableBuilder[Self <: GetBucketWebsiteInput] (val x: Self) extends AnyVal {
