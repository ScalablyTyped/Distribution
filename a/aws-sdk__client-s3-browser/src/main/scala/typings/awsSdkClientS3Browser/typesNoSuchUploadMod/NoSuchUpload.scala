...
trait NoSuchUpload extends ServiceException[NoSuchUploadDetails] {
  @JSName("name")
  var name_NoSuchUpload: typings.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchUpload = js.native
}
...
object NoSuchUpload {
  ...
  implicit class NoSuchUploadOps[Self <: NoSuchUpload] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchUpload): Self = this.set("name", value.asInstanceOf[js.Any])
  }
