package typings.awsSdkClientS3Browser.typesAbortMultipartUploadInputMod
...
@js.native
trait AbortMultipartUploadInput extends _InputTypesUnion {
...
object AbortMultipartUploadInput {
  ...
  @scala.inline
  implicit class AbortMultipartUploadInputOps[Self <: AbortMultipartUploadInput] (val x: Self) extends AnyVal {
