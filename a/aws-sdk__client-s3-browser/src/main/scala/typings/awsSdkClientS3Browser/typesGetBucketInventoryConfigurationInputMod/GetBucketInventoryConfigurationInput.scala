package typings.awsSdkClientS3Browser.typesGetBucketInventoryConfigurationInputMod
...
object GetBucketInventoryConfigurationInput {
  ...
  @scala.inline
  implicit class GetBucketInventoryConfigurationInputOps[Self <: GetBucketInventoryConfigurationInput] (val x: Self) extends AnyVal {
