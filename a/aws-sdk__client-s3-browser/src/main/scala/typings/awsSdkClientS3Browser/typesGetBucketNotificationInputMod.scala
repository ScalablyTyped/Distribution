...
object typesGetBucketNotificationInputMod {
  
  @js.native
  trait GetBucketNotificationInput extends _InputTypesUnion {
  ...
  object GetBucketNotificationInput {
    ...
    @scala.inline
    implicit class GetBucketNotificationInputMutableBuilder[Self <: GetBucketNotificationInput] (val x: Self) extends AnyVal {
