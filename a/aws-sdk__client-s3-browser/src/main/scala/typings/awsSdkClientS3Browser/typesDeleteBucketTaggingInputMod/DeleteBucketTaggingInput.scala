package typings.awsSdkClientS3Browser.typesDeleteBucketTaggingInputMod
...
object DeleteBucketTaggingInput {
  ...
  @scala.inline
  implicit class DeleteBucketTaggingInputOps[Self <: DeleteBucketTaggingInput] (val x: Self) extends AnyVal {
    @scala.inline
