package typings.awsSdkClientS3Browser.typesGetBucketMetricsConfigurationInputMod
...
@js.native
trait GetBucketMetricsConfigurationInput extends _InputTypesUnion {
  /**
...
object GetBucketMetricsConfigurationInput {
  ...
  @scala.inline
  implicit class GetBucketMetricsConfigurationInputOps[Self <: GetBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
