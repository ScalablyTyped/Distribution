...
object typesDeleteObjectsInputMod {
  ...
  trait DeleteObjectsInput extends _InputTypesUnion {
    ...
    /**
      * _Delete shape
      */
    var Delete: typings.awsSdkClientS3Browser.typesDeleteMod.Delete = js.native
  ...
  object DeleteObjectsInput {
    ...
    @scala.inline
    implicit class DeleteObjectsInputMutableBuilder[Self <: DeleteObjectsInput] (val x: Self) extends AnyVal {
