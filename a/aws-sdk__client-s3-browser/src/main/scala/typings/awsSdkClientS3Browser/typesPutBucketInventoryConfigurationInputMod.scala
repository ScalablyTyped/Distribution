...
object typesPutBucketInventoryConfigurationInputMod {
  ...
  trait PutBucketInventoryConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var InventoryConfiguration: typings.awsSdkClientS3Browser.typesInventoryConfigurationMod.InventoryConfiguration = js.native
  }
  object PutBucketInventoryConfigurationInput {
    ...
    @scala.inline
    implicit class PutBucketInventoryConfigurationInputMutableBuilder[Self <: PutBucketInventoryConfigurationInput] (val x: Self) extends AnyVal {
