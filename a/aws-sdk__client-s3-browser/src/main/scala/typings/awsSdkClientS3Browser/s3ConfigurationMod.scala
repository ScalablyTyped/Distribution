...
object s3ConfigurationMod {
  ...
  trait S3Configuration extends StObject {
    ...
    /**
      ...
      */
    var streamHasher: js.UndefOr[StreamHasher[Blob]] = js.native
  ...
  trait S3ResolvedConfiguration extends S3Configuration {
    ...
    @JSName("streamHasher")
    def streamHasher_MS3ResolvedConfiguration(hashCtor: typings.awsSdkTypes.anon.Instantiable, stream: Blob): js.Promise[Uint8Array] = js.native
    @JSName("streamHasher")
