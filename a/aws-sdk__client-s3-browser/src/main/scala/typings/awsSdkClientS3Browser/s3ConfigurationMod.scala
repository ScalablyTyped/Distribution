...
object s3ConfigurationMod {
  ...
  object S3Configuration {
    ...
    @scala.inline
    def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): S3Configuration = {
    ...
    implicit class S3ConfigurationMutableBuilder[Self <: S3Configuration] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setStreamHasher(value: (/* hashCtor */ typings.awsSdkTypes.anon.Instantiable, Blob) => js.Promise[Uint8Array]): Self = StObject.set(x, "streamHasher", js.Any.fromFunction2(value))
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ClientResolvedConfigurationBase<OutputTypesUnion, Blob> * / any */ trait S3ResolvedConfiguration
    extends StObject
       with S3Configuration {
