package typings.awsSdkClientS3Browser.typesGetBucketCorsInputMod
...
@js.native
trait GetBucketCorsInput extends _InputTypesUnion {
  /**
...
object GetBucketCorsInput {
  ...
  @scala.inline
  implicit class GetBucketCorsInputOps[Self <: GetBucketCorsInput] (val x: Self) extends AnyVal {
    @scala.inline
