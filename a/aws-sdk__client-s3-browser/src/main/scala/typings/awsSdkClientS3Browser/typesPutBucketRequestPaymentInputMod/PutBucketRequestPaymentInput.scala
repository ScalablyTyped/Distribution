package typings.awsSdkClientS3Browser.typesPutBucketRequestPaymentInputMod
...
trait PutBucketRequestPaymentInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestPaymentConfiguration: typings.awsSdkClientS3Browser.typesRequestPaymentConfigurationMod.RequestPaymentConfiguration = js.native
}
object PutBucketRequestPaymentInput {
  ...
  @scala.inline
  implicit class PutBucketRequestPaymentInputOps[Self <: PutBucketRequestPaymentInput] (val x: Self) extends AnyVal {
