...
object typesDeleteBucketWebsiteInputMod {
  
  trait DeleteBucketWebsiteInput
    extends StObject
  ...
  object DeleteBucketWebsiteInput {
    
    @scala.inline
    def apply(Bucket: String): DeleteBucketWebsiteInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[DeleteBucketWebsiteInput]
    }
    
    @scala.inline
    implicit class DeleteBucketWebsiteInputMutableBuilder[Self <: DeleteBucketWebsiteInput] (val x: Self) extends AnyVal {
