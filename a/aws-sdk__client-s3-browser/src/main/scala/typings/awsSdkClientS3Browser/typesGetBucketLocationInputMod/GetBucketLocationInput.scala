package typings.awsSdkClientS3Browser.typesGetBucketLocationInputMod
...
@js.native
trait GetBucketLocationInput extends _InputTypesUnion {
  /**
...
object GetBucketLocationInput {
  ...
  @scala.inline
  implicit class GetBucketLocationInputOps[Self <: GetBucketLocationInput] (val x: Self) extends AnyVal {
    @scala.inline
