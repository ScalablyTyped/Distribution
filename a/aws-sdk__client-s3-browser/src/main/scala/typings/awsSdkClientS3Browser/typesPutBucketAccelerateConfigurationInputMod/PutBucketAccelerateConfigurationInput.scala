package typings.awsSdkClientS3Browser.typesPutBucketAccelerateConfigurationInputMod
...
object PutBucketAccelerateConfigurationInput {
  ...
  @scala.inline
  implicit class PutBucketAccelerateConfigurationInputOps[Self <: PutBucketAccelerateConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
