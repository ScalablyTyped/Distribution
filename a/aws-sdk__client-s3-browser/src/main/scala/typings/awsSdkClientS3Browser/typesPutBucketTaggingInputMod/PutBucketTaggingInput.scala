package typings.awsSdkClientS3Browser.typesPutBucketTaggingInputMod
...
@js.native
trait PutBucketTaggingInput extends _InputTypesUnion {
  ...
  /**
    * _Tagging shape
    */
  var Tagging: typings.awsSdkClientS3Browser.typesTaggingMod.Tagging = js.native
}
object PutBucketTaggingInput {
  ...
  @scala.inline
  implicit class PutBucketTaggingInputOps[Self <: PutBucketTaggingInput] (val x: Self) extends AnyVal {
