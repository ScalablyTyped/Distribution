...
object S3Configuration {
  ...
  implicit class S3ConfigurationOps[Self <: S3Configuration] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setStreamHasher(value: (/* hashCtor */ typings.awsSdkTypes.anon.Instantiable, Blob) => js.Promise[Uint8Array]): Self = this.set("streamHasher", js.Any.fromFunction2(value))
