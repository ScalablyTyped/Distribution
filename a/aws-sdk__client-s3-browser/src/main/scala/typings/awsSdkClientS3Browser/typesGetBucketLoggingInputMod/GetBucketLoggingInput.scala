package typings.awsSdkClientS3Browser.typesGetBucketLoggingInputMod
...
@js.native
trait GetBucketLoggingInput extends _InputTypesUnion {
...
object GetBucketLoggingInput {
  ...
  @scala.inline
  implicit class GetBucketLoggingInputOps[Self <: GetBucketLoggingInput] (val x: Self) extends AnyVal {
