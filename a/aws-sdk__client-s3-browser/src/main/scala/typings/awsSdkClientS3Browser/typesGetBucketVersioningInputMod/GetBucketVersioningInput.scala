package typings.awsSdkClientS3Browser.typesGetBucketVersioningInputMod
...
@js.native
trait GetBucketVersioningInput extends _InputTypesUnion {
  /**
...
object GetBucketVersioningInput {
  ...
  @scala.inline
  implicit class GetBucketVersioningInputOps[Self <: GetBucketVersioningInput] (val x: Self) extends AnyVal {
    @scala.inline
