...
object typesGetBucketPolicyInputMod {
  
  @js.native
  trait GetBucketPolicyInput extends _InputTypesUnion {
  ...
  object GetBucketPolicyInput {
    ...
    @scala.inline
    def apply(Bucket: String): GetBucketPolicyInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetBucketPolicyInput]
    }
    
    @scala.inline
    implicit class GetBucketPolicyInputMutableBuilder[Self <: GetBucketPolicyInput] (val x: Self) extends AnyVal {
