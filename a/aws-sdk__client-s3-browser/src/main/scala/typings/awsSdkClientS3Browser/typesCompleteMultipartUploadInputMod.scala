...
import typings.awsSdkClientS3Browser.typesCompletedMultipartUploadMod.CompletedMultipartUpload
...
@JSImport("@aws-sdk/client-s3-browser/types/CompleteMultipartUploadInput", JSImport.Namespace)
@js.native
