...
object typesPutBucketEncryptionInputMod {
  ...
  trait PutBucketEncryptionInput
    ...
    /**
      ...
      */
    var ServerSideEncryptionConfiguration: typings.awsSdkClientS3Browser.typesServerSideEncryptionConfigurationMod.ServerSideEncryptionConfiguration
  }
  object PutBucketEncryptionInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketEncryptionInput] (val x: Self) extends AnyVal {
