...
trait NoSuchKey extends ServiceException[NoSuchKeyDetails] {
  @JSName("name")
  var name_NoSuchKey: typings.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchKey = js.native
}
...
object NoSuchKey {
  ...
  implicit class NoSuchKeyOps[Self <: NoSuchKey] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchKey): Self = this.set("name", value.asInstanceOf[js.Any])
  }
