package typings.awsSdkClientS3Browser.typesPutBucketCorsInputMod
...
trait PutBucketCorsInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var CORSConfiguration: typings.awsSdkClientS3Browser.typesCorsconfigurationMod.CORSConfiguration = js.native
  /**
    * _ContentMD5 shape
    */
