package typings.atAwsDashSdkClientDashS3DashBrowser.typesListMultipartUploadsOutputMod
...
trait ListMultipartUploadsOutput
  ...
  /**
    ...
    */
  var Uploads: js.UndefOr[js.Array[_UnmarshalledMultipartUpload]] = js.undefined
}
