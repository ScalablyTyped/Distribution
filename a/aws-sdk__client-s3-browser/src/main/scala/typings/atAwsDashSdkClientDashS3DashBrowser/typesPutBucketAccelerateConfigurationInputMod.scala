...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreAccelerateConfigurationMod._AccelerateConfiguration
...
@JSImport("@aws-sdk/client-s3-browser/types/PutBucketAccelerateConfigurationInput", JSImport.Namespace)
@js.native
object typesPutBucketAccelerateConfigurationInputMod extends js.Object {
  @js.native
  trait PutBucketAccelerateConfigurationInput extends _InputTypesUnion {
    /**
    ...
    /**
      ...
      */
    var AccelerateConfiguration: _AccelerateConfiguration = js.native
    /**
