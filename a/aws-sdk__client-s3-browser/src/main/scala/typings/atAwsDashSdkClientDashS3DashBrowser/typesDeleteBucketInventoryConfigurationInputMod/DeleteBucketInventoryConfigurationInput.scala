package typings.atAwsDashSdkClientDashS3DashBrowser.typesDeleteBucketInventoryConfigurationInputMod
...
trait DeleteBucketInventoryConfigurationInput extends _InputTypesUnion {
  /**
