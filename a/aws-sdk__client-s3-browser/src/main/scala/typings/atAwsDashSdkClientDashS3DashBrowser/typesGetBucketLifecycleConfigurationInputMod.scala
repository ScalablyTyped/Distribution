...
@JSImport("@aws-sdk/client-s3-browser/types/GetBucketLifecycleConfigurationInput", JSImport.Namespace)
@js.native
object typesGetBucketLifecycleConfigurationInputMod extends js.Object {
  @js.native
