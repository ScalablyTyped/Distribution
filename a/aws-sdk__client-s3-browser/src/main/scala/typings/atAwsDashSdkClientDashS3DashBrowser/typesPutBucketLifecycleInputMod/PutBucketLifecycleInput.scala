package typings.atAwsDashSdkClientDashS3DashBrowser.typesPutBucketLifecycleInputMod

import typings.atAwsDashSdkClientDashS3DashBrowser.typesInputTypesUnionMod._InputTypesUnion
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreLifecycleConfigurationMod._LifecycleConfiguration
...
trait PutBucketLifecycleInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var LifecycleConfiguration: js.UndefOr[_LifecycleConfiguration] = js.undefined
}
...
object PutBucketLifecycleInput {
  ...
  def apply(
    ...
    LifecycleConfiguration: _LifecycleConfiguration = null
