package typings.atAwsDashSdkClientDashS3DashBrowser.typesGetBucketNotificationConfigurationInputMod
...
trait GetBucketNotificationConfigurationInput extends _InputTypesUnion {
  /**
...
object GetBucketNotificationConfigurationInput {
  @scala.inline
  def apply(
    Bucket: String,
    ...
    __obj.asInstanceOf[GetBucketNotificationConfigurationInput]
  }
}
