...
@JSImport("@aws-sdk/client-s3-browser/types/DeleteBucketCorsInput", JSImport.Namespace)
@js.native
object typesDeleteBucketCorsInputMod extends js.Object {
  @js.native
  trait DeleteBucketCorsInput extends _InputTypesUnion {
    /**
