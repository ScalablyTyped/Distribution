...
@JSImport("@aws-sdk/client-s3-browser/types/GetBucketTaggingInput", JSImport.Namespace)
@js.native
object typesGetBucketTaggingInputMod extends js.Object {
  @js.native
  trait GetBucketTaggingInput extends _InputTypesUnion {
    /**
