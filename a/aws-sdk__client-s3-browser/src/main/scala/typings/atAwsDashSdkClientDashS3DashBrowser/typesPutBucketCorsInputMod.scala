...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreCORSConfigurationMod._CORSConfiguration
...
@JSImport("@aws-sdk/client-s3-browser/types/PutBucketCorsInput", JSImport.Namespace)
@js.native
object typesPutBucketCorsInputMod extends js.Object {
  @js.native
  trait PutBucketCorsInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var CORSConfiguration: _CORSConfiguration = js.native
    /**
      * _ContentMD5 shape
      */
