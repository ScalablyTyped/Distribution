...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreDeleteMod._Delete
...
@JSImport("@aws-sdk/client-s3-browser/types/DeleteObjectsInput", JSImport.Namespace)
@js.native
object typesDeleteObjectsInputMod extends js.Object {
  @js.native
