...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreServerSideEncryptionConfigurationMod._ServerSideEncryptionConfiguration
...
@JSImport("@aws-sdk/client-s3-browser/types/PutBucketEncryptionInput", JSImport.Namespace)
@js.native
object typesPutBucketEncryptionInputMod extends js.Object {
  @js.native
  trait PutBucketEncryptionInput extends _InputTypesUnion {
    /**
    ...
    /**
      ...
      */
    var ServerSideEncryptionConfiguration: _ServerSideEncryptionConfiguration = js.native
  }
