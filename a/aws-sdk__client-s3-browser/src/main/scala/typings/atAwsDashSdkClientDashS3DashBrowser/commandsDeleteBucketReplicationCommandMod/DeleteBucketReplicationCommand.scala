package typings.atAwsDashSdkClientDashS3DashBrowser.commandsDeleteBucketReplicationCommandMod
...
@JSImport("@aws-sdk/client-s3-browser/commands/DeleteBucketReplicationCommand", "DeleteBucketReplicationCommand")
@js.native
