...
@JSImport("@aws-sdk/client-s3-browser/types/GetBucketAccelerateConfigurationInput", JSImport.Namespace)
@js.native
object typesGetBucketAccelerateConfigurationInputMod extends js.Object {
  @js.native
