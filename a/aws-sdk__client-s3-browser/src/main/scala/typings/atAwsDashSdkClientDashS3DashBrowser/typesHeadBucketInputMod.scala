...
@JSImport("@aws-sdk/client-s3-browser/types/HeadBucketInput", JSImport.Namespace)
@js.native
object typesHeadBucketInputMod extends js.Object {
  @js.native
  trait HeadBucketInput extends _InputTypesUnion {
    /**
