...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreReplicationConfigurationMod._ReplicationConfiguration
...
@JSImport("@aws-sdk/client-s3-browser/types/PutBucketReplicationInput", JSImport.Namespace)
@js.native
