package typings.atAwsDashSdkClientDashS3DashBrowser.typesDeleteBucketPolicyInputMod
...
trait DeleteBucketPolicyInput extends _InputTypesUnion {
  /**
...
object DeleteBucketPolicyInput {
  @scala.inline
  def apply(
    Bucket: String,
    ...
    __obj.asInstanceOf[DeleteBucketPolicyInput]
  }
}
