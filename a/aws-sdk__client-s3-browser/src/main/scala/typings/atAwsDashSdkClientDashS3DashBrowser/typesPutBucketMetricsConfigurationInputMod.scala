...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreMetricsConfigurationMod._MetricsConfiguration
...
@JSImport("@aws-sdk/client-s3-browser/types/PutBucketMetricsConfigurationInput", JSImport.Namespace)
@js.native
object typesPutBucketMetricsConfigurationInputMod extends js.Object {
  @js.native
  trait PutBucketMetricsConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var MetricsConfiguration: _MetricsConfiguration = js.native
  }
