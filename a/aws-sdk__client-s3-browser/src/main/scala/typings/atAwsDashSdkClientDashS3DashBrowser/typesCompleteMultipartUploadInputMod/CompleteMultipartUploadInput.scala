package typings.atAwsDashSdkClientDashS3DashBrowser.typesCompleteMultipartUploadInputMod
...
import typings.atAwsDashSdkClientDashS3DashBrowser.typesUnderscoreCompletedMultipartUploadMod._CompletedMultipartUpload
...
trait CompleteMultipartUploadInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var MultipartUpload: js.UndefOr[_CompletedMultipartUpload] = js.undefined
  /**
...
object CompleteMultipartUploadInput {
  ...
  def apply(
    ...
    MultipartUpload: _CompletedMultipartUpload = null,
