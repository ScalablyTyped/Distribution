package typings.atAwsDashSdkClientDashS3DashBrowser.s3ClientMod
...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify __aws_sdk_types.AWSClient<InputTypesUnion, OutputTypesUnion, Blob> * / any */ @JSImport("@aws-sdk/client-s3-browser/S3Client", "S3Client")
@js.native
