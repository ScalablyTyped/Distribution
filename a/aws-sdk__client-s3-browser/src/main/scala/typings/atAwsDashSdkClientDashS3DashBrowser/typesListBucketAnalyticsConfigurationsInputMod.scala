...
@JSImport("@aws-sdk/client-s3-browser/types/ListBucketAnalyticsConfigurationsInput", JSImport.Namespace)
@js.native
object typesListBucketAnalyticsConfigurationsInputMod extends js.Object {
  @js.native
