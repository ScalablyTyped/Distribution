...
class Expression () extends js.Object {
  /**
    ...
    */
  def accept(visitor: ExpressionVisitor): scala.Unit = js.native
  /**
    * Assigns a value to the property represented by the expression.
    */
  def assign(scope: Scope, value: js.Any, lookupFunctions: LookupFunctions): scala.Unit = js.native
  /**
    * Subscribes a binding instance to the property change events along the path of the expression.
    */
  def connect(binding: Binding, scope: Scope): scala.Unit = js.native
  /**
