...
@scala.inline
def observable(targetOrConfig: js.Object, key: scala.Unit, descriptor: js.Any): js.Any = (typings.aureliaBinding.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(targetOrConfig.asInstanceOf[js.Any], key.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def observable(targetOrConfig: scala.Unit, key: js.Any): js.Any = (typings.aureliaBinding.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(targetOrConfig.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def observable(targetOrConfig: scala.Unit, key: js.Any, descriptor: js.Any): js.Any = (typings.aureliaBinding.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(targetOrConfig.asInstanceOf[js.Any], key.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[js.Any]
@scala.inline
def observable(targetOrConfig: scala.Unit, key: scala.Unit, descriptor: js.Any): js.Any = (typings.aureliaBinding.mod.^.asInstanceOf[js.Dynamic].applyDynamic("observable")(targetOrConfig.asInstanceOf[js.Any], key.asInstanceOf[js.Any], descriptor.asInstanceOf[js.Any])).asInstanceOf[js.Any]
