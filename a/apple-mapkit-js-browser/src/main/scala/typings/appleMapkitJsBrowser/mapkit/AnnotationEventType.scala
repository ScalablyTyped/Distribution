...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-start`
...
object AnnotationEventType {
  ...
  inline def `drag-end`: typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-end` = "drag-end".asInstanceOf[typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-end`]
  
  inline def `drag-start`: typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-start` = "drag-start".asInstanceOf[typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-start`]
  
  inline def dragging: typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.dragging = "dragging".asInstanceOf[typings.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.dragging]
