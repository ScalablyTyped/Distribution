package typings.atAntDashDesignIconsDashReactDashNative.esOutlineMod
...
object outlineGlyphMap extends js.Object {
  ...
  var `colum-height`: Double = js.native
  ...
  var `reload-time`: Double = js.native
