...
import typings.analyticsNode.AnonContext
...
trait Analytics extends js.Object {
  ...
  def alias(message: AnonIntegrations, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  ...
  def group(message: AnonGroupId, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  ...
  def page(message: AnonCategory, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  /* The track method lets you record the actions your users perform. */
  def track(message: AnonContext): Analytics = js.native
  def track(message: AnonContext, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
}
