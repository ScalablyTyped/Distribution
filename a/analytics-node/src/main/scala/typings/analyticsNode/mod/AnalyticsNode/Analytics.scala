...
trait Analytics extends js.Object {
  ...
  def alias(message: Identity with PreviousId, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  ...
  def group(message: Identity with GroupId, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  ...
  def page(message: Identity with Category, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
  /* The track method lets you record the actions your users perform. */
  def track(message: Identity with Event): Analytics = js.native
  def track(message: Identity with Event, callback: js.Function2[/* err */ Error, /* data */ Data, Unit]): Analytics = js.native
}
