...
object anon {
  ...
  object ExceptionOptionTypeAccess {
    ...
    extension [Self <: ExceptionOptionTypeAccess](x: Self) {
  ...
  object ExceptionOptionTypeAuthor {
    ...
    extension [Self <: ExceptionOptionTypeAuthor](x: Self) {
  ...
  object ExceptionOptionTypeSlowDo {
    ...
    extension [Self <: ExceptionOptionTypeSlowDo](x: Self) {
  ...
  object ExceptionOptionTypeUnsupp {
    ...
    extension [Self <: ExceptionOptionTypeUnsupp](x: Self) {
