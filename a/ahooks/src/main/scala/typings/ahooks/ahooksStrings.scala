...
object ahooksStrings {
  ...
  @js.native
  sealed trait onBefore extends StObject
  inline def onBefore: onBefore = "onBefore".asInstanceOf[onBefore]
  
  @js.native
  sealed trait onCancel extends StObject
  ...
  @js.native
  sealed trait onFinally extends StObject
  inline def onFinally: onFinally = "onFinally".asInstanceOf[onFinally]
  
  @js.native
  sealed trait onMutate extends StObject
  inline def onMutate: onMutate = "onMutate".asInstanceOf[onMutate]
