...
object libUseWebSocketMod {
  ...
  object ReadyState extends StObject {
    ...
    sealed trait Closed
      extends StObject
         with ReadyState
    /* 3 */ val Closed: typings.ahooks.libUseWebSocketMod.ReadyState.Closed & Double = js.native
    
    @js.native
    sealed trait Closing
      extends StObject
         with ReadyState
    /* 2 */ val Closing: typings.ahooks.libUseWebSocketMod.ReadyState.Closing & Double = js.native
    
    @js.native
    sealed trait Connecting
      extends StObject
         with ReadyState
    /* 0 */ val Connecting: typings.ahooks.libUseWebSocketMod.ReadyState.Connecting & Double = js.native
    
    @js.native
    sealed trait Open
      extends StObject
         with ReadyState
    /* 1 */ val Open: typings.ahooks.libUseWebSocketMod.ReadyState.Open & Double = js.native
  }
