...
import typings.ahooks.anon.Current
import typings.ahooks.anon.Loading
...
object useFusionTableTypesMod {
  ...
  object FusionTableResult {
    ...
    extension [Self <: FusionTableResult[?, ?], TData /* <: Data */, TParams /* <: Params */](x: Self & (FusionTableResult[TData, TParams])) {
      ...
      inline def setPaginationProps(value: Current): Self = StObject.set(x, "paginationProps", value.asInstanceOf[js.Any])
      ...
      inline def setTableProps(value: Loading[TData]): Self = StObject.set(x, "tableProps", value.asInstanceOf[js.Any])
    }
  }
}
