...
object libUseEventListenerMod {
  ...
  inline def default_message(eventName: message, handler: js.Function1[/* ev */ MessageEvent[Any], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def default_message(
    eventName: message,
    handler: js.Function1[/* ev */ MessageEvent[Any], Unit],
    options: Options[Window]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  inline def default_messageerror(eventName: messageerror, handler: js.Function1[/* ev */ MessageEvent[Any], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def default_progress(eventName: progress, handler: js.Function1[/* ev */ ProgressEvent[EventTarget], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(eventName.asInstanceOf[js.Any], handler.asInstanceOf[js.Any])).asInstanceOf[Unit]
