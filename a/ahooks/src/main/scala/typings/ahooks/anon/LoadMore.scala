...
trait LoadMore[TData /* <: typings.ahooks.useInfiniteScrollTypesMod.Data */] extends StObject {
...
object LoadMore {
  ...
  inline def apply[TData /* <: typings.ahooks.useInfiniteScrollTypesMod.Data */](
    cancel: () => Unit,
    loadMore: () => Unit,
    ...
    __obj.asInstanceOf[LoadMore[TData]]
  }
  
  extension [Self <: LoadMore[?], TData /* <: typings.ahooks.useInfiniteScrollTypesMod.Data */](x: Self & LoadMore[TData]) {
