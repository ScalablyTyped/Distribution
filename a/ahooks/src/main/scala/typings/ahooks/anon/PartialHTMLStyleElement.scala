...
object PartialHTMLStyleElement {
  ...
  extension [Self <: PartialHTMLStyleElement](x: Self) {
    ...
    inline def setAddEventListener(
      value: (fullscreenchange, /* listener */ js.ThisFunction1[PartialHTMLStyleElement, /* ev */ Event, Any]) => Unit
    ...
    inline def setOnprogress(value: js.ThisFunction1[PartialHTMLStyleElement, /* ev */ ProgressEvent[EventTarget], Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
