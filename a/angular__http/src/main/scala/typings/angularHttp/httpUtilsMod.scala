...
object httpUtilsMod {
  ...
  inline def getResponseURL(xhr: js.Any): String | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("getResponseURL")(xhr.asInstanceOf[js.Any]).asInstanceOf[String | Null]
  ...
  inline def stringToArrayBuffer(input: String): ArrayBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("stringToArrayBuffer")(input.asInstanceOf[js.Any]).asInstanceOf[ArrayBuffer]
  
  inline def stringToArrayBuffer8(input: String): ArrayBuffer = ^.asInstanceOf[js.Dynamic].applyDynamic("stringToArrayBuffer8")(input.asInstanceOf[js.Any]).asInstanceOf[ArrayBuffer]
}
