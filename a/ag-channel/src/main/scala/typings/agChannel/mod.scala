...
object mod {
  ...
  */
  ...
  object ChannelState {
    ...
    inline def pending: typings.agChannel.agChannelStrings.pending = "pending".asInstanceOf[typings.agChannel.agChannelStrings.pending]
    
    inline def subscribed: typings.agChannel.agChannelStrings.subscribed = "subscribed".asInstanceOf[typings.agChannel.agChannelStrings.subscribed]
    
    inline def unsubscribed: typings.agChannel.agChannelStrings.unsubscribed = "unsubscribed".asInstanceOf[typings.agChannel.agChannelStrings.unsubscribed]
  }
