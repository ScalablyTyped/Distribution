...
trait KeymapManager extends js.Object {
  ...
  var partialMatchTimeout: scala.Double = js.native
  ...
  def addKeystrokeResolver(
    resolver: js.Function1[
      /* event */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.AddedKeystrokeResolver, 
      java.lang.String
    ]
  ): eventDashKitLib.eventDashKitMod.Disposable = js.native
  ...
  def findKeyBindings(params: atomDashKeymapLib.Anon_Command): js.Array[KeyBinding] = js.native
  // Accessing Bindings
  ...
  def loadKeymap(bindingsPath: java.lang.String, options: atomDashKeymapLib.Anon_Priority): scala.Unit = js.native
  /** Invoke the given callback when one or more keystrokes fail to match any bindings. */
  def onDidFailToMatchBinding(
    callback: js.Function1[
      /* event */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.FailedKeybindingMatch, 
      scala.Unit
    ]
  ): eventDashKitLib.eventDashKitMod.Disposable = js.native
  /** Invoke the given callback when a keymap file not able to be loaded. */
  def onDidFailToReadFile(
    callback: js.Function1[
      /* error */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.FailedKeymapFileRead, 
      scala.Unit
    ]
  ): eventDashKitLib.eventDashKitMod.Disposable = js.native
  // Event Subscription
  ...
  def onDidPartiallyMatchBindings(
    callback: js.Function1[
      /* event */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.PartialKeybindingMatch, 
      scala.Unit
    ]
  ): eventDashKitLib.eventDashKitMod.Disposable = js.native
  /** Invoke the given callback when a keymap file is reloaded. */
  def onDidReloadKeymap(
    callback: js.Function1[
      /* event */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.KeymapLoaded, 
      scala.Unit
    ]
  ): eventDashKitLib.eventDashKitMod.Disposable = js.native
  /** Invoke the given callback when a keymap file is unloaded. */
  def onDidUnloadKeymap(
    callback: js.Function1[
      /* event */ atomDashKeymapLib.atomDashKeymapMod.Global.AtomKeymapNs.EventsNs.KeymapLoaded, 
      scala.Unit
    ]
  ...
  def watchKeymap(filePath: java.lang.String, options: atomDashKeymapLib.Anon_PriorityNumber): scala.Unit = js.native
}
