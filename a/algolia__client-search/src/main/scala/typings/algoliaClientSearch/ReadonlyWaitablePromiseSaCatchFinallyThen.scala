...
trait ReadonlyWaitablePromiseSaCatchFinallyThen extends js.Object {
  def `catch`[TResult](): js.Promise[SaveObjectResponse | TResult]
  def `finally`(): js.Promise[SaveObjectResponse]
  def `then`[TResult1, TResult2](): js.Promise[TResult1 | TResult2]
}

object ReadonlyWaitablePromiseSaCatchFinallyThen {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[ReadonlyWaitablePromiseSaCatchFinallyThen]
  }
}
