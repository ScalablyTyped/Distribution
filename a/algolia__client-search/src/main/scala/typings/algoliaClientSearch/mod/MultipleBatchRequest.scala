...
object MultipleBatchRequest {
  ...
  inline def apply(action: BatchActionType, body: Record[String, Any], indexName: String): MultipleBatchRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MultipleBatchRequest] (val x: Self) extends AnyVal {
