...
object ReadonlyPromiseListUserID {
  ...
  @scala.inline
  implicit class ReadonlyPromiseListUserIDMutableBuilder[Self <: ReadonlyPromiseListUserID] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCatch(value: () => js.Promise[ListUserIDsResponse | js.Any]): Self = StObject.set(x, "catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[ListUserIDsResponse]): Self = StObject.set(x, "finally", js.Any.fromFunction0(value))
