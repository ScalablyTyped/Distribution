...
trait ReadonlyPromiseListApiKey extends StObject {
  ...
  def `catch`[TResult](): js.Promise[ListApiKeysResponse | TResult] = js.native
  
  def `finally`(): js.Promise[ListApiKeysResponse] = js.native
...
object ReadonlyPromiseListApiKey {
  ...
  @scala.inline
  implicit class ReadonlyPromiseListApiKeyMutableBuilder[Self <: ReadonlyPromiseListApiKey] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setCatch(value: () => js.Promise[ListApiKeysResponse | js.Any]): Self = StObject.set(x, "catch", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFinally(value: () => js.Promise[ListApiKeysResponse]): Self = StObject.set(x, "finally", js.Any.fromFunction0(value))
