...
object ReadonlyPromiseListApiKey {
  ...
  @scala.inline
  implicit class ReadonlyPromiseListApiKeyOps[Self <: ReadonlyPromiseListApiKey] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCatch(value: () => js.Promise[ListApiKeysResponse | js.Any]): Self = this.set("catch", js.Any.fromFunction0(value))
    @scala.inline
    def setFinally(value: () => js.Promise[ListApiKeysResponse]): Self = this.set("finally", js.Any.fromFunction0(value))
    @scala.inline
