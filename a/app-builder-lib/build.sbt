...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "electron-osx-sign" % "0.4.11-610182",
  "com.scalablytyped" %%% "electron-publish" % "20.38.0-0cec5e",
  ...
  "com.scalablytyped" %%% "read-config-file" % "3.2.0-bccb8c",
