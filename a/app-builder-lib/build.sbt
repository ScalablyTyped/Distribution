...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "electron-osx-sign" % "0.4.10-5eac3e",
  "com.scalablytyped" %%% "electron-publish" % "20.28.3-6a9b39",
  ...
  "com.scalablytyped" %%% "read-config-file" % "3.1.2-f7889c",
