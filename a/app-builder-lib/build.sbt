...
libraryDependencies ++= Seq(
  ...
  "com.scalablytyped" %%% "electron-osx-sign" % "0.4.10-12d8a8",
  "com.scalablytyped" %%% "electron-publish" % "20.28.3-3d0dba",
  ...
  "com.scalablytyped" %%% "read-config-file" % "3.1.2-eb9b32",
