...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-7d6d21",
  "org.scalablytyped" %%% "electron-publish" % "20.38.3-f23b50",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.0-5fbfde",
