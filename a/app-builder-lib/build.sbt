...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "electron-osx-sign" % "0.4.11-5004c9",
  "org.scalablytyped" %%% "electron-publish" % "20.38.3-d6cccd",
  ...
  "org.scalablytyped" %%% "read-config-file" % "3.2.0-7d1f1a",
