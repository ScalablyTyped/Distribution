...
object configMod {
  ...
  inline def doMergeConfigs(configuration: Configuration): Configuration = ^.asInstanceOf[js.Dynamic].applyDynamic("doMergeConfigs")(configuration.asInstanceOf[js.Any]).asInstanceOf[Configuration]
  inline def doMergeConfigs(configuration: Configuration, parentConfiguration: Configuration): Configuration = (^.asInstanceOf[js.Dynamic].applyDynamic("doMergeConfigs")(configuration.asInstanceOf[js.Any], parentConfiguration.asInstanceOf[js.Any])).asInstanceOf[Configuration]
