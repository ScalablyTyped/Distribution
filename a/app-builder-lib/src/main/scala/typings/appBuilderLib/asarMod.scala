...
object asarMod {
  ...
  inline def readAsar(archive: String): js.Promise[
  ...
  inline def readAsarJson(archive: String, file: String): js.Promise[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("readAsarJson")(archive.asInstanceOf[js.Any], file.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Any]]
}
