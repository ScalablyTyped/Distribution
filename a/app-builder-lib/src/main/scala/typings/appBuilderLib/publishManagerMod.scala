...
object publishManagerMod {
  ...
  class PublishManager protected ()
    ...
    /* private */ var artifactCreatedWithoutExplicitPublishConfig: js.Any = js.native
    ...
    /* private */ var getAppInfo: js.Any = js.native
    
    def getGlobalPublishConfigurations(): js.Promise[js.Array[PublishConfiguration] | Null] = js.native
    
    /* private */ var getOrCreatePublisher: js.Any = js.native
    
    val isPublish: Boolean = js.native
    
    /* private */ val nameToPublisher: js.Any = js.native
    ...
    /* private */ val publishOptions: js.Any = js.native
    
    /* private */ val taskManager: js.Any = js.native
    
    /* private */ val updateFileWriteTask: js.Any = js.native
  }
  
  inline def computeDownloadUrl(publishConfiguration: PublishConfiguration, fileName: String, packager: PlatformPackager[js.Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("computeDownloadUrl")(publishConfiguration.asInstanceOf[js.Any], fileName.asInstanceOf[js.Any], packager.asInstanceOf[js.Any])).asInstanceOf[String]
  inline def computeDownloadUrl(publishConfiguration: PublishConfiguration, fileName: Null, packager: PlatformPackager[js.Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("computeDownloadUrl")(publishConfiguration.asInstanceOf[js.Any], fileName.asInstanceOf[js.Any], packager.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def getPublishConfigsForUpdateInfo(packager: PlatformPackager[js.Any]): js.Promise[js.Array[PublishConfiguration] | Null] = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublishConfigsForUpdateInfo")(packager.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[PublishConfiguration] | Null]]
