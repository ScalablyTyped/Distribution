...
object appFileWalkerMod {
  ...
  abstract class FileCopyHelper protected () extends StObject {
    ...
    /* private */ var handleSymlink: js.Any = js.native
    
    /* protected */ val matcher: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify FileMatcher */ js.Any = js.native
