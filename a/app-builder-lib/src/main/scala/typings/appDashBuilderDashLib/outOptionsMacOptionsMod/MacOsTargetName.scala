...
object MacOsTargetName {
  @scala.inline
  def `7z`: typings.appDashBuilderDashLib.appDashBuilderDashLibStrings.`7z` = this.cast("7z")
  @scala.inline
  ...
  @scala.inline
  def dmg: typings.appDashBuilderDashLib.appDashBuilderDashLibStrings.dmg = this.cast("dmg")
  @scala.inline
  def mas: typings.appDashBuilderDashLib.appDashBuilderDashLibStrings.mas = this.cast("mas")
  @scala.inline
  def `mas-dev`: typings.appDashBuilderDashLib.appDashBuilderDashLibStrings.`mas-dev` = this.cast("mas-dev")
  @scala.inline
