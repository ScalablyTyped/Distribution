...
@JSImport("@angular/platform-browser/src/private_export", "ɵDomRendererFactory2")
@js.native
class ɵDomRendererFactory2 protected ()
  extends atAngularPlatformDashBrowserLib.srcDomDomUnderscoreRendererMod.DomRendererFactory2 {
