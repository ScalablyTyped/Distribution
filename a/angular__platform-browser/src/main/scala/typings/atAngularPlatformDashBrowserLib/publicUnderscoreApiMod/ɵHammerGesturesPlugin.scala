...
@JSImport("@angular/platform-browser/public_api", "ɵHammerGesturesPlugin")
@js.native
class ɵHammerGesturesPlugin protected ()
  extends atAngularPlatformDashBrowserLib.srcPlatformDashBrowserMod.ɵHammerGesturesPlugin {
