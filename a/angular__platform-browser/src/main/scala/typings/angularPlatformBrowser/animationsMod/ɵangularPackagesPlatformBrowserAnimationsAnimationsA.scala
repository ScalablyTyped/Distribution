package typings.angularPlatformBrowser.animationsMod
...
@js.native
object ɵangularPackagesPlatformBrowserAnimationsAnimationsA extends js.Object {
  
  def apply(): ɵWebAnimationsDriver | ɵCssKeyframesDriver = js.native
}
