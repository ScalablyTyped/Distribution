...
trait MockAdapter extends js.Object {
  ...
  @JSName("onList")
  var onList_Original: axiosDashMockDashAdapterLib.RequestMatcherFunc = js.native
  @JSName("onPatch")
  ...
  def onList(matcher: java.lang.String, body: java.lang.String): js.Any = js.native
  def onList(
    matcher: java.lang.String,
    body: java.lang.String,
    headers: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify HeadersMatcher */ js.Any
