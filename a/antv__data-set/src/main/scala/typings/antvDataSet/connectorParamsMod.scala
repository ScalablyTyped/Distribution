...
object connectorParamsMod {
  ...
  trait ConnectorParams extends StObject {
    ...
    var TopoJSON: js.Tuple2[Any, typings.antvDataSet.topojsonMod.Options]
    
    var csv: js.Tuple2[String, js.Object]
    
    var diagram: js.Tuple2[Any, typings.antvDataSet.graphMod.Options]
    ...
    var graph: js.Tuple2[Any, typings.antvDataSet.graphMod.Options]
    ...
    var hierarchy: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options]
    
    var topojson: js.Tuple2[Any, typings.antvDataSet.topojsonMod.Options]
    
    var tree: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options]
  ...
  object ConnectorParams {
    ...
    inline def apply(
      ...
      TopoJSON: js.Tuple2[Any, typings.antvDataSet.topojsonMod.Options],
      csv: js.Tuple2[String, js.Object],
      diagram: js.Tuple2[Any, typings.antvDataSet.graphMod.Options],
      dsv: js.Tuple2[String, typings.antvDataSet.dsvMod.Options],
      geo: js.Tuple2[Any, js.Object],
      geojson: js.Tuple2[Any, js.Object],
      graph: js.Tuple2[Any, typings.antvDataSet.graphMod.Options],
      hex: js.Tuple2[js.Array[Any], Options],
      `hex-json`: js.Tuple2[js.Array[Any], Options],
      hexjson: js.Tuple2[js.Array[Any], Options],
      hierarchy: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options],
      topojson: js.Tuple2[Any, typings.antvDataSet.topojsonMod.Options],
      tree: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options],
    ...
    extension [Self <: ConnectorParams](x: Self) {
      ...
      inline def setDiagram(value: js.Tuple2[Any, typings.antvDataSet.graphMod.Options]): Self = StObject.set(x, "diagram", value.asInstanceOf[js.Any])
      ...
      inline def setGraph(value: js.Tuple2[Any, typings.antvDataSet.graphMod.Options]): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
      ...
      inline def setHierarchy(value: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options]): Self = StObject.set(x, "hierarchy", value.asInstanceOf[js.Any])
      
      inline def setTopoJSON(value: js.Tuple2[Any, typings.antvDataSet.topojsonMod.Options]): Self = StObject.set(x, "TopoJSON", value.asInstanceOf[js.Any])
      
      inline def setTree(value: js.Tuple2[Any, typings.antvDataSet.connectorHierarchyMod.Options]): Self = StObject.set(x, "tree", value.asInstanceOf[js.Any])
