...
object arcMod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setId(value: /* node */ js.Any => js.Any): Self = StObject.set(x, "id", js.Any.fromFunction1(value))
      ...
      inline def setSortBy(value: id | weigth | frequency | (js.Function2[/* a */ js.Any, /* b */ js.Any, Double])): Self = StObject.set(x, "sortBy", value.asInstanceOf[js.Any])
      
      inline def setSortByFunction2(value: (/* a */ js.Any, /* b */ js.Any) => Double): Self = StObject.set(x, "sortBy", js.Any.fromFunction2(value))
      ...
      inline def setSourceWeight(value: /* edge */ js.Any => Double): Self = StObject.set(x, "sourceWeight", js.Any.fromFunction1(value))
      ...
      inline def setTargetWeight(value: /* edge */ js.Any => Double): Self = StObject.set(x, "targetWeight", js.Any.fromFunction1(value))
