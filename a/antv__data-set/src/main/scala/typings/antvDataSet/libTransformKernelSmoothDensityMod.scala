...
object libTransformKernelSmoothDensityMod {
  ...
  trait Options extends StObject {
    ...
    var bandwidth: js.UndefOr[js.Tuple2[Double, Double]] = js.undefined
    
    var extent: js.UndefOr[js.Tuple2[js.Tuple2[Double, Double], js.Tuple2[Double, Double]]] = js.undefined
  ...
  object Options {
    ...
    implicit open class MutableBuilder[Self <: Options] (val x: Self) extends AnyVal {
      ...
      inline def setBandwidth(value: js.Tuple2[Double, Double]): Self = StObject.set(x, "bandwidth", value.asInstanceOf[js.Any])
      
      inline def setBandwidthUndefined: Self = StObject.set(x, "bandwidth", js.undefined)
      
      inline def setExtent(value: js.Tuple2[js.Tuple2[Double, Double], js.Tuple2[Double, Double]]): Self = StObject.set(x, "extent", value.asInstanceOf[js.Any])
