...
object PasswordChangeTicketParams {
  ...
  def apply(
    ...
    ttl_sec: js.UndefOr[Double] = js.undefined,
    user_id: String = null
    ...
    if (!js.isUndefined(includeEmailInRedirect)) __obj.updateDynamic("includeEmailInRedirect")(includeEmailInRedirect.get.asInstanceOf[js.Any])
    if (!js.isUndefined(mark_email_as_verified)) __obj.updateDynamic("mark_email_as_verified")(mark_email_as_verified.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(ttl_sec)) __obj.updateDynamic("ttl_sec")(ttl_sec.get.asInstanceOf[js.Any])
