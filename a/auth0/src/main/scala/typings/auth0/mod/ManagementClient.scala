...
@js.native
class ManagementClient[A, U] protected () extends StObject {
  ...
  def createCustomDomain(data: CreateDomainData, cb: js.Function2[/* err */ Error, /* domain */ Domain, Unit]): Unit = js.native
  ...
  def deleteCustomDomain(params: ObjectWithId, cb: js.Function1[/* err */ Error, Unit]): Unit = js.native
  ...
  def getCustomDomain(params: ObjectWithId, cb: js.Function2[/* err */ Error, /* data */ Domain, Unit]): Unit = js.native
  ...
  def verifyCustomDomain(params: ObjectWithId, cb: js.Function2[/* err */ Error, /* data */ DomainVerification, Unit]): Unit = js.native
}
