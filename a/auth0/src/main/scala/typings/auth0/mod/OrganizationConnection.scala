...
trait OrganizationConnection extends StObject {
  ...
  var connection: typings.auth0.anon.Strategy
...
object OrganizationConnection {
  ...
  inline def apply(
    ...
    connection: typings.auth0.anon.Strategy,
  ...
  extension [Self <: OrganizationConnection](x: Self) {
    ...
    inline def setConnection(value: typings.auth0.anon.Strategy): Self = StObject.set(x, "connection", value.asInstanceOf[js.Any])
