...
object ImportUsersOptions {
  ...
  inline def ImportUsersFromFileOptions(connection_id: String, users: String): typings.auth0.mod.ImportUsersFromFileOptions = {
  ...
  inline def ImportUsersFromJsonOptions(connection_id: String, users_json: String): typings.auth0.mod.ImportUsersFromJsonOptions = {
