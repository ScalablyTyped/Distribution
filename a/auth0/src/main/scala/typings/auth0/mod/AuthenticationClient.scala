...
class AuthenticationClient protected () extends StObject {
  ...
  def getDelegationToken(data: DelegationTokenOptions): js.Promise[js.Any] = js.native
  def getDelegationToken(data: DelegationTokenOptions, cb: js.Function2[/* err */ Error, /* message */ String, Unit]): Unit = js.native
  
  def getProfile(accessToken: String): js.Promise[js.Any] = js.native
  ...
  def requestEmailCode(data: RequestEmailOptions): js.Promise[js.Any] = js.native
  def requestEmailCode(data: RequestEmailOptions, cb: js.Function2[/* err */ Error, /* message */ String, Unit]): Unit = js.native
  
  def requestMagicLink(data: RequestEmailOptions): js.Promise[js.Any] = js.native
  def requestMagicLink(data: RequestEmailOptions, cb: js.Function2[/* err */ Error, /* message */ String, Unit]): Unit = js.native
  
  def requestSMSCode(data: RequestSMSOptions): js.Promise[js.Any] = js.native
  ...
  def verifyEmailCode(data: VerifyOptions): js.Promise[js.Any] = js.native
  def verifyEmailCode(data: VerifyOptions, cb: js.Function2[/* err */ Error, /* message */ String, Unit]): Unit = js.native
  
  def verifySMSCode(data: VerifyOptions): js.Promise[js.Any] = js.native
