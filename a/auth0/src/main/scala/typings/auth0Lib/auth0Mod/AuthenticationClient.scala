...
class AuthenticationClient protected () extends js.Object {
  ...
  def clientCredentialsGrant(options: ClientCredentialsGrantOptions): stdLib.Promise[_] = js.native
  ...
  def getDelegationToken(data: DelegationTokenOptions): stdLib.Promise[_] = js.native
  def getDelegationToken(
    data: DelegationTokenOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def getProfile(accessToken: java.lang.String): stdLib.Promise[_] = js.native
  def getProfile(
    accessToken: java.lang.String,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def passwordGrant(options: PasswordGrantOptions): stdLib.Promise[_] = js.native
  def passwordGrant(
  ...
  def requestEmailCode(data: RequestEmailOptions): stdLib.Promise[_] = js.native
  def requestEmailCode(
    data: RequestEmailOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def requestMagicLink(data: RequestEmailOptions): stdLib.Promise[_] = js.native
  def requestMagicLink(
    data: RequestEmailOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def requestSMSCode(data: RequestSMSOptions): stdLib.Promise[_] = js.native
  def requestSMSCode(
    data: RequestSMSOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def verifyEmailCode(data: VerifyOptions): stdLib.Promise[_] = js.native
  def verifyEmailCode(
    data: VerifyOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
  def verifySMSCode(data: VerifyOptions): stdLib.Promise[_] = js.native
  def verifySMSCode(
    data: VerifyOptions,
    cb: js.Function2[/* err */ stdLib.Error, /* message */ java.lang.String, scala.Unit]
  ): scala.Unit = js.native
