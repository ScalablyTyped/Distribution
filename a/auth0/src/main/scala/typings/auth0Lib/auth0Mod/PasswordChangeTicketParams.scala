...
trait PasswordChangeTicketParams extends js.Object {
  ...
  var includeEmailInRedirect: js.UndefOr[scala.Boolean] = js.undefined
  var mark_email_as_verified: js.UndefOr[scala.Boolean] = js.undefined
...
object PasswordChangeTicketParams {
  ...
  def apply(
    ...
    includeEmailInRedirect: js.UndefOr[scala.Boolean] = js.undefined,
    mark_email_as_verified: js.UndefOr[scala.Boolean] = js.undefined,
