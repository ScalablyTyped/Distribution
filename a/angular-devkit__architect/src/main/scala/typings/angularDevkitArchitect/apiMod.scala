...
import typings.angularDevkitArchitect.inputSchemaMod.Schema
...
object apiMod {
  ...
  trait BuilderOutput
    extends StObject
       with JsonObject
       with typings.angularDevkitArchitect.outputSchemaMod.Schema
  ...
  type BuilderOutputLike = AsyncIterable[BuilderOutput] | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SubscribableOrPromise<BuilderOutput> */ Any) | BuilderOutput
  
  type BuilderProgress = JsonObject & typings.angularDevkitArchitect.progressSchemaMod.Schema & TypedBuilderProgress
  ...
  trait BuilderRun extends StObject {
    ...
    /**
      ...
      */
    var output: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderOutput> */ Any
    ...
    /**
      ...
      */
    var progress: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderProgressReport> */ Any
  ...
  object BuilderRun {
    ...
    inline def apply(
      id: Double,
      info: BuilderInfo,
      output: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderOutput> */ Any,
      progress: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderProgressReport> */ Any,
    ...
    extension [Self <: BuilderRun](x: Self) {
      ...
      inline def setOutput(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderOutput> */ Any
      ): Self = StObject.set(x, "output", value.asInstanceOf[js.Any])
      
      inline def setProgress(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<BuilderProgressReport> */ Any
  ...
  trait Target
    extends StObject
       with JsonObject
       with typings.angularDevkitArchitect.inputSchemaMod.Target
  object Target {
  ...
  */
  ...
  object TypedBuilderProgress {
    ...
    inline def Error(state: typings.angularDevkitArchitect.progressSchemaMod.State.Error): typings.angularDevkitArchitect.anon.Error = {
