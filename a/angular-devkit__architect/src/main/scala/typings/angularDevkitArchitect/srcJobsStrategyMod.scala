...
import typings.angularDevkitArchitect.anon.PartialReadonlyJobDescrip
...
object srcJobsStrategyMod {
  
  object strategy {
    
    @JSImport("@angular-devkit/architect/src/jobs/strategy", "strategy")
    @js.native
