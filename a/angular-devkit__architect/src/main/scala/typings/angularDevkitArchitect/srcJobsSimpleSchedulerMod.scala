...
import typings.angularDevkitArchitect.srcJobsApiMod.ScheduleJobOptions
import typings.angularDevkitArchitect.srcJobsApiMod.Scheduler
import typings.angularDevkitCore.mod.schema.SchemaValidationException
...
object srcJobsSimpleSchedulerMod {
  
  @JSImport("@angular-devkit/architect/src/jobs/simple-scheduler", "JobArgumentSchemaValidationError")
  @js.native
  ...
  @JSImport("@angular-devkit/architect/src/jobs/simple-scheduler", "JobInboundMessageSchemaValidationError")
  @js.native
  open class JobInboundMessageSchemaValidationError () extends SchemaValidationException {
    def this(errors: js.Array[SchemaValidatorError]) = this()
  }
  
  @JSImport("@angular-devkit/architect/src/jobs/simple-scheduler", "JobOutputSchemaValidationError")
  @js.native
  open class JobOutputSchemaValidationError () extends SchemaValidationException {
    def this(errors: js.Array[SchemaValidatorError]) = this()
  }
  
  @JSImport("@angular-devkit/architect/src/jobs/simple-scheduler", "SimpleScheduler")
  @js.native
