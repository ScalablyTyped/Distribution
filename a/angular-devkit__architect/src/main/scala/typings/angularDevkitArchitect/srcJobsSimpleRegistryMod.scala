...
import typings.angularDevkitArchitect.anon.RegisterJobOptionsnamestr
...
object srcJobsSimpleRegistryMod {
  
  @JSImport("@angular-devkit/architect/src/jobs/simple-registry", "SimpleJobRegistry")
  @js.native
  ...
  /* Inlined parent std.Partial<@angular-devkit/architect.@angular-devkit/architect/src/jobs/api.JobDescription> */
