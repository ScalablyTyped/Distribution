...
object GetSamplingTargetsInput {
  ...
  implicit class GetSamplingTargetsInputOps[Self <: GetSamplingTargetsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSamplingStatisticsDocuments(value: js.Array[SamplingStatisticsDocument] | Iterable[SamplingStatisticsDocument]): Self = this.set("SamplingStatisticsDocuments", value.asInstanceOf[js.Any])
    @scala.inline
