...
@JSImport("@aws-sdk/client-xray-node/types/DeleteSamplingRuleExceptionsUnion", JSImport.Namespace)
@js.native
object deleteSamplingRuleExceptionsUnionMod extends js.Object {
