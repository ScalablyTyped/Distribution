package typings.awsSdkClientXrayNode.typesUpdateSamplingRuleInputMod
...
trait UpdateSamplingRuleInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var SamplingRuleUpdate: typings.awsSdkClientXrayNode.typesSamplingRuleUpdateMod.SamplingRuleUpdate = js.native
}
object UpdateSamplingRuleInput {
  ...
  @scala.inline
  implicit class UpdateSamplingRuleInputOps[Self <: UpdateSamplingRuleInput] (val x: Self) extends AnyVal {
