...
@JSImport("@aws-sdk/client-xray-node/types/GetEncryptionConfigExceptionsUnion", JSImport.Namespace)
@js.native
object getEncryptionConfigExceptionsUnionMod extends js.Object {
