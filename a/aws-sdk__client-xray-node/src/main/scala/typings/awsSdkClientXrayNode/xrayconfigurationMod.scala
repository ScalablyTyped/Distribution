...
object xrayconfigurationMod {
  ...
  object XRayResolvableConfiguration {
    ...
    @scala.inline
    implicit class XRayResolvableConfigurationMutableBuilder[Self <: XRayResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait XRayResolvedConfiguration
    ...
    def base64Decoder_MXRayResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MXRayResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MXRayResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("utf8Decoder")
    def utf8Decoder_MXRayResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MXRayResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
  ...
  object XRayResolvedConfiguration {
    ...
    @scala.inline
    implicit class XRayResolvedConfigurationMutableBuilder[Self <: XRayResolvedConfiguration] (val x: Self) extends AnyVal {
