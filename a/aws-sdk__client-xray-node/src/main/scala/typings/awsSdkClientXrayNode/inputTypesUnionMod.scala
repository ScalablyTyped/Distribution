...
object inputTypesUnionMod {
  ...
  */
  ...
  object InputTypesUnion {
    ...
    @scala.inline
    def BatchGetTracesInput(TraceIds: js.Array[String] | Iterable[String]): typings.awsSdkClientXrayNode.typesBatchGetTracesInputMod.BatchGetTracesInput = {
    ...
    @scala.inline
    def CreateSamplingRuleInput(SamplingRule: SamplingRule): typings.awsSdkClientXrayNode.typesCreateSamplingRuleInputMod.CreateSamplingRuleInput = {
    ...
    @scala.inline
    def DeleteSamplingRuleInput(): typings.awsSdkClientXrayNode.typesDeleteSamplingRuleInputMod.DeleteSamplingRuleInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesDeleteSamplingRuleInputMod.DeleteSamplingRuleInput]
    }
    
    @scala.inline
    def GetEncryptionConfigInput(): typings.awsSdkClientXrayNode.typesGetEncryptionConfigInputMod.GetEncryptionConfigInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesGetEncryptionConfigInputMod.GetEncryptionConfigInput]
    }
    
    @scala.inline
    def GetSamplingRulesInput(): typings.awsSdkClientXrayNode.typesGetSamplingRulesInputMod.GetSamplingRulesInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesGetSamplingRulesInputMod.GetSamplingRulesInput]
    }
    
    @scala.inline
    def GetSamplingStatisticSummariesInput(): typings.awsSdkClientXrayNode.typesGetSamplingStatisticSummariesInputMod.GetSamplingStatisticSummariesInput = {
      val __obj = js.Dynamic.literal()
    ...
    @scala.inline
    def GetServiceGraphInput(EndTime: Date | String | Double, StartTime: Date | String | Double): typings.awsSdkClientXrayNode.typesGetServiceGraphInputMod.GetServiceGraphInput = {
      val __obj = js.Dynamic.literal(EndTime = EndTime.asInstanceOf[js.Any], StartTime = StartTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesGetServiceGraphInputMod.GetServiceGraphInput]
    }
    
    @scala.inline
    def GetTraceGraphInput(TraceIds: js.Array[String] | Iterable[String]): typings.awsSdkClientXrayNode.typesGetTraceGraphInputMod.GetTraceGraphInput = {
      val __obj = js.Dynamic.literal(TraceIds = TraceIds.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesGetTraceGraphInputMod.GetTraceGraphInput]
    }
    
    @scala.inline
    def GetTraceSummariesInput(EndTime: Date | String | Double, StartTime: Date | String | Double): typings.awsSdkClientXrayNode.typesGetTraceSummariesInputMod.GetTraceSummariesInput = {
      val __obj = js.Dynamic.literal(EndTime = EndTime.asInstanceOf[js.Any], StartTime = StartTime.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesGetTraceSummariesInputMod.GetTraceSummariesInput]
    }
    
    @scala.inline
    def PutEncryptionConfigInput(Type: NONE | KMS | String): typings.awsSdkClientXrayNode.typesPutEncryptionConfigInputMod.PutEncryptionConfigInput = {
      val __obj = js.Dynamic.literal(Type = Type.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientXrayNode.typesPutEncryptionConfigInputMod.PutEncryptionConfigInput]
    }
    
    @scala.inline
    def PutTelemetryRecordsInput(TelemetryRecords: js.Array[TelemetryRecord] | Iterable[TelemetryRecord]): typings.awsSdkClientXrayNode.typesPutTelemetryRecordsInputMod.PutTelemetryRecordsInput = {
    ...
    @scala.inline
    def PutTraceSegmentsInput(TraceSegmentDocuments: js.Array[String] | Iterable[String]): typings.awsSdkClientXrayNode.typesPutTraceSegmentsInputMod.PutTraceSegmentsInput = {
    ...
    @scala.inline
    def UpdateSamplingRuleInput(SamplingRuleUpdate: SamplingRuleUpdate): typings.awsSdkClientXrayNode.typesUpdateSamplingRuleInputMod.UpdateSamplingRuleInput = {
