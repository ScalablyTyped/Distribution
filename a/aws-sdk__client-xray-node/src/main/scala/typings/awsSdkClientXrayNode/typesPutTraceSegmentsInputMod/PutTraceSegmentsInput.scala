...
object PutTraceSegmentsInput {
  @scala.inline
  def apply(TraceSegmentDocuments: js.Array[String] | Iterable[String]): PutTraceSegmentsInput = {
  ...
  implicit class PutTraceSegmentsInputOps[Self <: PutTraceSegmentsInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTraceSegmentDocuments(value: js.Array[String] | Iterable[String]): Self = this.set("TraceSegmentDocuments", value.asInstanceOf[js.Any])
    @scala.inline
