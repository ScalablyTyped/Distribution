...
trait XRayResolvedConfiguration extends XRayConfiguration {
  ...
  @JSName("base64Decoder")
  def base64Decoder_MXRayResolvedConfiguration(input: String): Uint8Array = js.native
  @JSName("base64Encoder")
  def base64Encoder_MXRayResolvedConfiguration(input: Uint8Array): String = js.native
  ...
  @JSName("streamCollector")
  def streamCollector_MXRayResolvedConfiguration(stream: Readable): js.Promise[Uint8Array] = js.native
  @JSName("urlParser")
  def urlParser_MXRayResolvedConfiguration(url: String): HttpEndpoint = js.native
  @JSName("utf8Decoder")
  def utf8Decoder_MXRayResolvedConfiguration(input: String): Uint8Array = js.native
  @JSName("utf8Encoder")
  def utf8Encoder_MXRayResolvedConfiguration(input: Uint8Array): String = js.native
}
