package typings.atAwsDashSdkClientDashXrayDashNode.typesGetTraceSummariesOutputMod
...
trait GetTraceSummariesOutput extends OutputTypesUnion {
  ...
  /**
    ...
    */
  var TraceSummaries: js.UndefOr[js.Array[_UnmarshalledTraceSummary]] = js.undefined
  /**
...
object GetTraceSummariesOutput {
  ...
  def apply(
    ...
    TraceSummaries: js.Array[_UnmarshalledTraceSummary] = null,
