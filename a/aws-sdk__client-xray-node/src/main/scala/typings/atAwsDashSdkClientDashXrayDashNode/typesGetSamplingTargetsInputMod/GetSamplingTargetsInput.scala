package typings.atAwsDashSdkClientDashXrayDashNode.typesGetSamplingTargetsInputMod
...
trait GetSamplingTargetsInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var SamplingStatisticsDocuments: js.Array[_SamplingStatisticsDocument] | Iterable[_SamplingStatisticsDocument]
}

object GetSamplingTargetsInput {
  @scala.inline
  def apply(
    SamplingStatisticsDocuments: js.Array[_SamplingStatisticsDocument] | Iterable[_SamplingStatisticsDocument],
