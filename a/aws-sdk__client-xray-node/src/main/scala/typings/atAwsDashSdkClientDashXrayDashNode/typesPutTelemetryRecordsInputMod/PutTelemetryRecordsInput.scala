package typings.atAwsDashSdkClientDashXrayDashNode.typesPutTelemetryRecordsInputMod

import typings.atAwsDashSdkClientDashXrayDashNode.typesInputTypesUnionMod.InputTypesUnion
import typings.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreTelemetryRecordMod._TelemetryRecord
...
trait PutTelemetryRecordsInput extends InputTypesUnion {
  ...
  /**
    * <p/>
    */
  var TelemetryRecords: js.Array[_TelemetryRecord] | Iterable[_TelemetryRecord]
}

object PutTelemetryRecordsInput {
  @scala.inline
  def apply(
    TelemetryRecords: js.Array[_TelemetryRecord] | Iterable[_TelemetryRecord],
