package typings.atAwsDashSdkClientDashXrayDashNode.typesUnderscoreFaultStatisticsMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait _FaultStatistics extends js.Object {
  /**
...
object _FaultStatistics {
  @scala.inline
  def apply(OtherCount: Int | Double = null, TotalCount: Int | Double = null): _FaultStatistics = {
    val __obj = js.Dynamic.literal()
    if (OtherCount != null) __obj.updateDynamic("OtherCount")(OtherCount.asInstanceOf[js.Any])
    if (TotalCount != null) __obj.updateDynamic("TotalCount")(TotalCount.asInstanceOf[js.Any])
    __obj.asInstanceOf[_FaultStatistics]
  }
}
