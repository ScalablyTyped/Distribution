...
trait InvalidRequestException
  ...
  @JSName("name")
  var name_InvalidRequestException: typings.atAwsDashSdkClientDashXrayDashNode.atAwsDashSdkClientDashXrayDashNodeStrings.InvalidRequestException = js.native
}
