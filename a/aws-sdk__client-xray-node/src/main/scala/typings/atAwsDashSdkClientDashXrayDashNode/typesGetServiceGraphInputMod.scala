...
@JSImport("@aws-sdk/client-xray-node/types/GetServiceGraphInput", JSImport.Namespace)
@js.native
object typesGetServiceGraphInputMod extends js.Object {
  @js.native
  trait GetServiceGraphInput extends InputTypesUnion {
    /**
