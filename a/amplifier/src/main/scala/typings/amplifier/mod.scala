...
object mod extends Shortcut {
  ...
  trait Request extends StObject {
    ...
    def apply(resourceId: String, hash: js.Any, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit = js.native
    def apply(resourceId: String, hash: Unit, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit = js.native
    /***
      * Request a resource.
  ...
  trait Static extends StObject {
    ...
    def request(resourceId: String, hash: js.Any, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit
    def request(resourceId: String, hash: Unit, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit
    /***
      * Request a resource.
      * settings: A set of key/value pairs of settings for the request.
      *   resourceId: Identifier string for the resource.
    ...
    /***
      ...
      */
    def subscribe(topic: String, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit
    def subscribe(topic: String, callback: js.Function1[/* repeated */ js.Any, js.Any], priority: Double): Unit
    /***
      * Subscribe to a message.
      * topic: Name of the message to subscribe to.
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def subscribe(topic: String, context: js.Any, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit
    def subscribe(
      topic: String,
      context: js.Any,
    ...
    /***
      ...
      */
    def unsubscribe(topic: String, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit
  }
  object Static {
    ...
    inline def apply(
      ...
      store: Store,
      subscribe: Subscribe,
      unsubscribe: (String, js.Function1[/* repeated */ js.Any, js.Any]) => Unit
    ): Static = {
    ...
    extension [Self <: Static](x: Self) {
      ...
      inline def setUnsubscribe(value: (String, js.Function1[/* repeated */ js.Any, js.Any]) => Unit): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction2(value))
    }
  }
  ...
  trait Subscribe extends StObject {
    ...
    /***
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def apply(topic: String, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit = js.native
    def apply(topic: String, callback: js.Function1[/* repeated */ js.Any, js.Any], priority: Double): Unit = js.native
    /***
      * Subscribe to a message.
      * topic: Name of the message to subscribe to.
      * context: What this will be when the callback is invoked.
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def apply(topic: String, context: js.Any, callback: js.Function1[/* repeated */ js.Any, js.Any]): Unit = js.native
    def apply(
      topic: String,
      context: js.Any,
      callback: js.Function1[/* repeated */ js.Any, js.Any],
