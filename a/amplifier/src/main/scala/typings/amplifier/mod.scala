...
object mod extends Shortcut {
  ...
  object Static {
    ...
    inline def apply(
      ...
      store: Store,
      subscribe: Subscribe,
      unsubscribe: (String, js.Function1[/* repeated */ Any, Any]) => Unit
    ): Static = {
    ...
    implicit open class MutableBuilder[Self <: Static] (val x: Self) extends AnyVal {
      ...
      inline def setUnsubscribe(value: (String, js.Function1[/* repeated */ Any, Any]) => Unit): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction2(value))
    }
  }
