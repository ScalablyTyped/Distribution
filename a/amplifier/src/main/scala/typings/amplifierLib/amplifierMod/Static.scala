...
trait Static extends js.Object {
  ...
  def request(resourceId: java.lang.String, hash: js.Any, callback: js.Function1[/* repeated */ js.Any, _]): scala.Unit = js.native
  /***
    * Request a resource.
  ...
  /***
    ...
    */
  def subscribe(topic: java.lang.String, callback: js.Function1[/* repeated */ js.Any, _]): scala.Unit = js.native
  def subscribe(topic: java.lang.String, callback: js.Function1[/* repeated */ js.Any, _], priority: scala.Double): scala.Unit = js.native
  /***
    * Subscribe to a message.
    * topic: Name of the message to subscribe to.
    ...
    * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
    */
  def subscribe(topic: java.lang.String, context: js.Any, callback: js.Function1[/* repeated */ js.Any, _]): scala.Unit = js.native
  def subscribe(
  ...
  /***
    ...
    */
  def unsubscribe(topic: java.lang.String, callback: js.Function1[/* repeated */ js.Any, _]): scala.Unit = js.native
}
