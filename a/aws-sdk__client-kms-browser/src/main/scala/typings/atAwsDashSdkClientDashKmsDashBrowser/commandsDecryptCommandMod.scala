...
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesDecryptInputMod.DecryptInput
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesDecryptOutputMod.DecryptOutput
