...
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesUnderscoreTagMod._Tag
...
@JSImport("@aws-sdk/client-kms-browser/types/TagResourceInput", JSImport.Namespace)
@js.native
object typesTagResourceInputMod extends js.Object {
  ...
  trait TagResourceInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Tags: js.Array[_Tag] | Iterable[_Tag] = js.native
  }
