package typings.atAwsDashSdkClientDashKmsDashBrowser.typesReEncryptInputMod
...
trait ReEncryptInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var DestinationEncryptionContext: js.UndefOr[StringDictionary[String] | (Iterable[js.Tuple2[String, String]])] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SourceEncryptionContext: js.UndefOr[StringDictionary[String] | (Iterable[js.Tuple2[String, String]])] = js.undefined
}
