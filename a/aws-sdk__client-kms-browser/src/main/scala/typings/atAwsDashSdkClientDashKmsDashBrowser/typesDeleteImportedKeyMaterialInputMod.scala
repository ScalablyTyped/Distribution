...
@JSImport("@aws-sdk/client-kms-browser/types/DeleteImportedKeyMaterialInput", JSImport.Namespace)
@js.native
object typesDeleteImportedKeyMaterialInputMod extends js.Object {
  @js.native
  trait DeleteImportedKeyMaterialInput extends InputTypesUnion {
    /**
