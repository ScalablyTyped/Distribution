package typings.atAwsDashSdkClientDashKmsDashBrowser.kMSConfigurationMod
...
trait KMSResolvedConfiguration extends KMSConfiguration {
  ...
  @JSName("streamCollector")
  def streamCollector_MKMSResolvedConfiguration(stream: Blob): js.Promise[Uint8Array] = js.native
  @JSName("urlParser")
