...
trait InvalidImportTokenException
  ...
  @JSName("name")
  var name_InvalidImportTokenException: typings.atAwsDashSdkClientDashKmsDashBrowser.atAwsDashSdkClientDashKmsDashBrowserStrings.InvalidImportTokenException = js.native
}
