...
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesRetireGrantInputMod.RetireGrantInput
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesRetireGrantOutputMod.RetireGrantOutput
