...
trait DependencyTimeoutException
  ...
  @JSName("name")
  var name_DependencyTimeoutException: typings.atAwsDashSdkClientDashKmsDashBrowser.atAwsDashSdkClientDashKmsDashBrowserStrings.DependencyTimeoutException = js.native
}
