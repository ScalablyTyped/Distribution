package typings.atAwsDashSdkClientDashKmsDashBrowser.typesListGrantsOutputMod

import typings.atAwsDashSdkClientDashKmsDashBrowser.typesOutputTypesUnionMod.OutputTypesUnion
import typings.atAwsDashSdkClientDashKmsDashBrowser.typesUnderscoreGrantListEntryMod._UnmarshalledGrantListEntry
...
trait ListGrantsOutput extends OutputTypesUnion {
  ...
  /**
    ...
    */
  var Grants: js.UndefOr[js.Array[_UnmarshalledGrantListEntry]] = js.undefined
  /**
...
object ListGrantsOutput {
  ...
  def apply(
    ...
    Grants: js.Array[_UnmarshalledGrantListEntry] = null,
