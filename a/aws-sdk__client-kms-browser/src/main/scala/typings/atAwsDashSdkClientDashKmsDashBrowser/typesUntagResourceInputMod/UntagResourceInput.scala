package typings.atAwsDashSdkClientDashKmsDashBrowser.typesUntagResourceInputMod
...
object UntagResourceInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(KeyId = KeyId, TagKeys = TagKeys.asInstanceOf[js.Any])
