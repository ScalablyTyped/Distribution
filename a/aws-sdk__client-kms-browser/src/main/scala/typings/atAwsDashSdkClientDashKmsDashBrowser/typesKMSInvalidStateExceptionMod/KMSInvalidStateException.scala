...
trait KMSInvalidStateException
  ...
  @JSName("name")
  var name_KMSInvalidStateException: typings.atAwsDashSdkClientDashKmsDashBrowser.atAwsDashSdkClientDashKmsDashBrowserStrings.KMSInvalidStateException = js.native
}
