...
object generateDataKeyExceptionsUnionMod {
  ...
  */
  ...
  object GenerateDataKeyExceptionsUnion {
    ...
    @scala.inline
    def InvalidKeyUsageException(name: typings.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.InvalidKeyUsageException): typings.awsSdkClientKmsBrowser.typesInvalidKeyUsageExceptionMod.InvalidKeyUsageException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    ...
    @scala.inline
    def KeyUnavailableException(name: typings.awsSdkClientKmsBrowser.awsSdkClientKmsBrowserStrings.KeyUnavailableException): typings.awsSdkClientKmsBrowser.typesKeyUnavailableExceptionMod.KeyUnavailableException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
