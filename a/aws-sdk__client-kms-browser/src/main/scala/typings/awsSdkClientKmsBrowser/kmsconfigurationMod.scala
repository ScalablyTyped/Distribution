...
object kmsconfigurationMod {
  ...
  object KMSResolvableConfiguration {
    ...
    @scala.inline
    implicit class KMSResolvableConfigurationMutableBuilder[Self <: KMSResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait KMSResolvedConfiguration
    ...
    def base64Decoder_MKMSResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MKMSResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MKMSResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("utf8Decoder")
    def utf8Decoder_MKMSResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MKMSResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
  ...
  object KMSResolvedConfiguration {
    ...
    @scala.inline
    implicit class KMSResolvedConfigurationMutableBuilder[Self <: KMSResolvedConfiguration] (val x: Self) extends AnyVal {
