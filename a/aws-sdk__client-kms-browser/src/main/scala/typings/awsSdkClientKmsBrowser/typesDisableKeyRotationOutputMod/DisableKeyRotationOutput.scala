package typings.awsSdkClientKmsBrowser.typesDisableKeyRotationOutputMod
...
object DisableKeyRotationOutput {
  ...
  @scala.inline
  implicit class DisableKeyRotationOutputOps[Self <: DisableKeyRotationOutput] (val x: Self) extends AnyVal {
    @scala.inline
