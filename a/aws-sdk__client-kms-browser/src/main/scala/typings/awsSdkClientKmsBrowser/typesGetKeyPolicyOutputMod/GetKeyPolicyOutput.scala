package typings.awsSdkClientKmsBrowser.typesGetKeyPolicyOutputMod
...
object GetKeyPolicyOutput {
  ...
  @scala.inline
  implicit class GetKeyPolicyOutputOps[Self <: GetKeyPolicyOutput] (val x: Self) extends AnyVal {
    @scala.inline
