...
@JSImport("@aws-sdk/client-kms-browser/types/EnableKeyRotationExceptionsUnion", JSImport.Namespace)
@js.native
object enableKeyRotationExceptionsUnionMod extends js.Object {
