...
@JSImport("@aws-sdk/client-kms-browser/types/ScheduleKeyDeletionExceptionsUnion", JSImport.Namespace)
@js.native
object scheduleKeyDeletionExceptionsUnionMod extends js.Object {
