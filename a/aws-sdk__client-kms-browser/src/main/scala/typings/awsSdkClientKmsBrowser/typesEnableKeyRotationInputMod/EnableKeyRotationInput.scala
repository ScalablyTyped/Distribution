package typings.awsSdkClientKmsBrowser.typesEnableKeyRotationInputMod
...
object EnableKeyRotationInput {
  ...
  @scala.inline
  implicit class EnableKeyRotationInputOps[Self <: EnableKeyRotationInput] (val x: Self) extends AnyVal {
