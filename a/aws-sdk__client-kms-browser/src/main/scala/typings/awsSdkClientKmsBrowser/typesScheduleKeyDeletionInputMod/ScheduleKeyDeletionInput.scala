package typings.awsSdkClientKmsBrowser.typesScheduleKeyDeletionInputMod
...
object ScheduleKeyDeletionInput {
  ...
  implicit class ScheduleKeyDeletionInputOps[Self <: ScheduleKeyDeletionInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPendingWindowInDays(value: Double): Self = this.set("PendingWindowInDays", value.asInstanceOf[js.Any])
    @scala.inline
