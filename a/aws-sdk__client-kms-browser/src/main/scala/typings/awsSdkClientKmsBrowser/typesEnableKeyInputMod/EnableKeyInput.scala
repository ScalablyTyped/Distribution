package typings.awsSdkClientKmsBrowser.typesEnableKeyInputMod
...
@js.native
trait EnableKeyInput extends InputTypesUnion {
...
object EnableKeyInput {
  ...
  @scala.inline
  implicit class EnableKeyInputOps[Self <: EnableKeyInput] (val x: Self) extends AnyVal {
