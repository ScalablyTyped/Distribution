...
object importKeyMaterialExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientKmsBrowser.typesIncorrectKeyMaterialExceptionMod.IncorrectKeyMaterialException
    - typings.awsSdkClientKmsBrowser.typesExpiredImportTokenExceptionMod.ExpiredImportTokenException
    - typings.awsSdkClientKmsBrowser.typesInvalidImportTokenExceptionMod.InvalidImportTokenException
  */
  ...
  object ImportKeyMaterialExceptionsUnion {
    ...
    inline def ExpiredImportTokenException(): typings.awsSdkClientKmsBrowser.typesExpiredImportTokenExceptionMod.ExpiredImportTokenException = {
      val __obj = js.Dynamic.literal(name = "ExpiredImportTokenException")
      __obj.asInstanceOf[typings.awsSdkClientKmsBrowser.typesExpiredImportTokenExceptionMod.ExpiredImportTokenException]
    }
    
    inline def IncorrectKeyMaterialException(): typings.awsSdkClientKmsBrowser.typesIncorrectKeyMaterialExceptionMod.IncorrectKeyMaterialException = {
      val __obj = js.Dynamic.literal(name = "IncorrectKeyMaterialException")
      __obj.asInstanceOf[typings.awsSdkClientKmsBrowser.typesIncorrectKeyMaterialExceptionMod.IncorrectKeyMaterialException]
    }
    ...
    inline def InvalidImportTokenException(): typings.awsSdkClientKmsBrowser.typesInvalidImportTokenExceptionMod.InvalidImportTokenException = {
      val __obj = js.Dynamic.literal(name = "InvalidImportTokenException")
      __obj.asInstanceOf[typings.awsSdkClientKmsBrowser.typesInvalidImportTokenExceptionMod.InvalidImportTokenException]
    }
