...
@JSImport("@aws-sdk/client-kms-browser/types/GetParametersForImportExceptionsUnion", JSImport.Namespace)
@js.native
object getParametersForImportExceptionsUnionMod extends js.Object {
