package typings.awsSdkClientKmsBrowser.typesGenerateDataKeyInputMod
...
@js.native
trait GenerateDataKeyInput extends InputTypesUnion {
  /**
...
object GenerateDataKeyInput {
  ...
  @scala.inline
  implicit class GenerateDataKeyInputOps[Self <: GenerateDataKeyInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEncryptionContext(value: StringDictionary[String] | (Iterable[js.Tuple2[String, String]])): Self = this.set("EncryptionContext", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setKeySpec(value: AES_256 | AES_128 | String): Self = this.set("KeySpec", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteKeySpec: Self = this.set("KeySpec", js.undefined)
    @scala.inline
    def setNumberOfBytes(value: Double): Self = this.set("NumberOfBytes", value.asInstanceOf[js.Any])
    @scala.inline
