...
object typesCancelKeyDeletionInputMod {
  
  @js.native
  trait CancelKeyDeletionInput extends InputTypesUnion {
  ...
  object CancelKeyDeletionInput {
    ...
    @scala.inline
    implicit class CancelKeyDeletionInputMutableBuilder[Self <: CancelKeyDeletionInput] (val x: Self) extends AnyVal {
