package typings.awsSdkClientKmsBrowser.typesGenerateDataKeyWithoutPlaintextInputMod
...
object GenerateDataKeyWithoutPlaintextInput {
  ...
  @scala.inline
  implicit class GenerateDataKeyWithoutPlaintextInputOps[Self <: GenerateDataKeyWithoutPlaintextInput] (val x: Self) extends AnyVal {
