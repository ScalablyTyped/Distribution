package typings.activexDashInfopath.InfoPathNs.EventHelperTypesNs
...
trait DataDOM_Invoke_Parameter extends js.Object {
...
object DataDOM_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    __obj.asInstanceOf[DataDOM_Invoke_Parameter]
  }
}
