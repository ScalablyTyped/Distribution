package typings.activexDashInfopath.InfoPath.EventHelperTypes
...
trait XDocument_Invoke_Parameter extends js.Object {
...
object XDocument_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    __obj.asInstanceOf[XDocument_Invoke_Parameter]
  }
}
