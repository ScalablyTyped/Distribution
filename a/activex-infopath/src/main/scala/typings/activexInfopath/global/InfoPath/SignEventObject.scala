...
/* private */ class SignEventObject ()
  ...
  var InfoPathDotSignEventObject_typekey: typings.activexInfopath.InfoPath.SignEventObject = js.native
  
  /* CompleteClass */
  var ReturnStatus: Boolean = js.native
  
  /* CompleteClass */
  override val SignedDataBlock: typings.activexInfopath.InfoPath.SignedDataBlockObject = js.native
