...
package object EventHelperTypes {
  ...
  type ButtonInvokeArgNames = js.Tuple8[
    ...
    typings.activexInfopath.activexInfopathStrings.lcid, 
    typings.activexInfopath.activexInfopathStrings.wFlags, 
    typings.activexInfopath.activexInfopathStrings.pdispparams, 
    typings.activexInfopath.activexInfopathStrings.pvarResult, 
