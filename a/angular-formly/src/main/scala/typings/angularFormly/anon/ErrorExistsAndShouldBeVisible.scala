...
object ErrorExistsAndShouldBeVisible {
  ...
  def apply(
    ...
    if (!js.isUndefined(errorExistsAndShouldBeVisible)) __obj.updateDynamic("errorExistsAndShouldBeVisible")(errorExistsAndShouldBeVisible.get.asInstanceOf[js.Any])
