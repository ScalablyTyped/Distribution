...
import typings.athenajs.Anon_False
...
class Drawable protected () extends js.Object {
  ...
  def playSound(id: String, options: Anon_False): Unit = js.native
  def reset(): Unit = js.native
  def setBehavior(behavior: String): Unit = js.native
  def setBehavior(behavior: String, options: JSObject): Unit = js.native
  def setBehavior(behavior: Anon_Options): Unit = js.native
  def setBehavior(behavior: Anon_Options, options: JSObject): Unit = js.native
