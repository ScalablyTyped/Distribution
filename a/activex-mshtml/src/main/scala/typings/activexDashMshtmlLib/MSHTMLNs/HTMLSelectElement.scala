...
trait HTMLSelectElement extends js.Object {
  ...
  var ie9_value: java.lang.String = js.native
  ...
  def ie8_add(pElem: IHTMLOptionElement, pvarBefore: js.Any): scala.Unit = js.native
  ...
  def ie9_add(pElem: IHTMLOptionElement, pvarBefore: js.Any): scala.Unit = js.native
