...
class CPrintManagerTemplatePrinter protected () extends js.Object {
  ...
  val percentScale: scala.Double = js.native
  ...
  val showHeaderFooter: scala.Boolean = js.native
  ...
  def drawPreviewPage(pElemDisp: js.Any, nPage: scala.Double): scala.Unit = js.native
  def endPrint(): scala.Unit = js.native
  ...
  def getPrintTaskOptionValue(bstrKey: java.lang.String): js.Any = js.native
  def invalidatePreview(): scala.Unit = js.native
  ...
  def setPageCount(nPage: scala.Double): scala.Unit = js.native
  ...
  def startPrint(): scala.Unit = js.native
