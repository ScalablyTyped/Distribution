...
@JSGlobal("MSHTML.ISVGElementInstance")
@js.native
class ISVGElementInstance protected () extends js.Object {
  var `MSHTML.ISVGElementInstance_typekey`: ISVGElementInstance = js.native
