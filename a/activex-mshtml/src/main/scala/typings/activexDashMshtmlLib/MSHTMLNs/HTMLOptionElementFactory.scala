...
trait HTMLOptionElementFactory extends js.Object {
  ...
  def apply(text: js.Any): IHTMLOptionElement = js.native
  def apply(text: js.Any, value: js.Any): IHTMLOptionElement = js.native
  ...
  def create(text: js.Any): IHTMLOptionElement = js.native
  def create(text: js.Any, value: js.Any): IHTMLOptionElement = js.native
