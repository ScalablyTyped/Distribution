...
class HTMLAudioElement protected () extends js.Object {
  ...
  var currentTimeDouble: scala.Double = js.native
  ...
  val initialTime: scala.Double = js.native
  val initialTimeDouble: scala.Double = js.native
  ...
  var playbackRateDouble: scala.Double = js.native
  ...
  var volumeDouble: scala.Double = js.native
