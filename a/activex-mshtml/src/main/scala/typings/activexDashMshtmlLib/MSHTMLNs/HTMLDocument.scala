...
class HTMLDocument protected () extends js.Object {
  ...
  val URLUnencoded: java.lang.String = js.native
  ...
  var msCapsLockWarningOff: scala.Boolean = js.native
  ...
  def compatible(index: scala.Double): IHTMLDocumentCompatibleInfo = js.native
  ...
  def createComment(bstrData: java.lang.String): IHTMLDOMNode = js.native
  def createDocumentFragment(): IHTMLDocument2 = js.native
  def createDocumentFromUrl(bstrURL: java.lang.String, bstrOptions: java.lang.String): IHTMLDocument2 = js.native
  ...
  def createEvent(eventType: java.lang.String): IDOMEvent = js.native
  def createNodeIterator(
    pRootNode: js.Any,
    ulWhatToShow: scala.Double,
    pFilter: js.Any,
    fEntityReferenceExpansion: scala.Boolean
  ): IDOMNodeIterator = js.native
  ...
  def elementsFromPoint(x: scala.Double, y: scala.Double): IHTMLDOMChildrenCollection = js.native
  def elementsFromRect(left: scala.Double, top: scala.Double, width: scala.Double, height: scala.Double): IHTMLDOMChildrenCollection = js.native
  ...
  def getElementById(v: java.lang.String): IHTMLElement = js.native
  def getElementsByClassName(v: java.lang.String): IHTMLElementCollection = js.native
  def getElementsByName(v: java.lang.String): IHTMLElementCollection = js.native
  ...
  def ie8_getElementById(bstrId: java.lang.String): IHTMLElement2 = js.native
  ...
  def ie9_createAttribute(bstrAttrName: java.lang.String): IHTMLDOMAttribute = js.native
  def ie9_createElement(bstrTag: java.lang.String): IHTMLElement = js.native
  ...
  def updateSettings(): scala.Unit = js.native
