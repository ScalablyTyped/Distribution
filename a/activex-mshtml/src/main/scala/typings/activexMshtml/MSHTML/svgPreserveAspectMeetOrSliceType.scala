...
*/
trait svgPreserveAspectMeetOrSliceType extends js.Object

object svgPreserveAspectMeetOrSliceType {
  @scala.inline
  def SVG_MEETORSLICE_MEET: `1` = this.cast(1)
  @scala.inline
  def SVG_MEETORSLICE_SLICE: `2` = this.cast(2)
  @scala.inline
  def SVG_MEETORSLICE_UNKNOWN: `0` = this.cast(0)
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def svgPreserveAspectMeetOrSliceType_Max: `2147483647` = this.cast(2147483647)
}
