...
object styleAlignmentBaseline {
  ...
  inline def styleAlignmentBaselineAfterEdge: `1` = 1.asInstanceOf[`1`]
  
  inline def styleAlignmentBaselineAlphabetic: `2` = 2.asInstanceOf[`2`]
  
  inline def styleAlignmentBaselineAuto: `3` = 3.asInstanceOf[`3`]
  
  inline def styleAlignmentBaselineBaseline: `4` = 4.asInstanceOf[`4`]
  
  inline def styleAlignmentBaselineBeforeEdge: `5` = 5.asInstanceOf[`5`]
  
  inline def styleAlignmentBaselineCentral: `6` = 6.asInstanceOf[`6`]
  
  inline def styleAlignmentBaselineHanging: `7` = 7.asInstanceOf[`7`]
  
  inline def styleAlignmentBaselineIdeographic: `12` = 12.asInstanceOf[`12`]
  
  inline def styleAlignmentBaselineMathematical: `8` = 8.asInstanceOf[`8`]
  
  inline def styleAlignmentBaselineMiddle: `9` = 9.asInstanceOf[`9`]
  
  inline def styleAlignmentBaselineNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleAlignmentBaselineTextAfterEdge: `10` = 10.asInstanceOf[`10`]
  
  inline def styleAlignmentBaselineTextBeforeEdge: `11` = 11.asInstanceOf[`11`]
  
  inline def styleAlignmentBaseline_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
