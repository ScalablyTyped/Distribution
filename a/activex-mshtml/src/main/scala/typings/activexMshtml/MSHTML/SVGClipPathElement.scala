...
object SVGClipPathElement {
  ...
  @scala.inline
  implicit class SVGClipPathElementOps[Self <: SVGClipPathElement] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMSHTMLDotSVGClipPathElement_typekey(value: SVGClipPathElement): Self = this.set("MSHTML.SVGClipPathElement_typekey", value.asInstanceOf[js.Any])
    @scala.inline
    def setClassName(value: SVGAnimatedString): Self = this.set("className", value.asInstanceOf[js.Any])
    @scala.inline
    def setClipPathUnits(value: SVGAnimatedEnumeration): Self = this.set("clipPathUnits", value.asInstanceOf[js.Any])
    @scala.inline
