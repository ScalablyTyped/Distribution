...
trait SVGTextPositioningElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.SVGTextPositioningElement_typekey")
...
object SVGTextPositioningElement {
  ...
  extension [Self <: SVGTextPositioningElement](x: Self) {
    ...
    inline def setMSHTMLDotSVGTextPositioningElement_typekey(value: SVGTextPositioningElement): Self = StObject.set(x, "MSHTML.SVGTextPositioningElement_typekey", value.asInstanceOf[js.Any])
