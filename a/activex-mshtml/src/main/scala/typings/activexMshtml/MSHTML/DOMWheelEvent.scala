...
object DOMWheelEvent {
  ...
  @scala.inline
  implicit class DOMWheelEventMutableBuilder[Self <: DOMWheelEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotDOMWheelEvent_typekey(value: DOMWheelEvent): Self = StObject.set(x, "MSHTML.DOMWheelEvent_typekey", value.asInstanceOf[js.Any])
