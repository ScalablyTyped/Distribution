...
*/
trait styleMsFlexLinePack extends StObject
object styleMsFlexLinePack {
  
  inline def styleMsFlexLinePackCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsFlexLinePackDistribute: `4` = 4.asInstanceOf[`4`]
  
  inline def styleMsFlexLinePackEnd: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsFlexLinePackJustify: `3` = 3.asInstanceOf[`3`]
  
  inline def styleMsFlexLinePackNotSet: `6` = 6.asInstanceOf[`6`]
  
  inline def styleMsFlexLinePackStart: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsFlexLinePackStretch: `5` = 5.asInstanceOf[`5`]
  
  inline def styleMsFlexLinePack_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
