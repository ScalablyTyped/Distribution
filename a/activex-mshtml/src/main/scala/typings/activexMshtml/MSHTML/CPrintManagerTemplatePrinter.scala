...
object CPrintManagerTemplatePrinter {
  ...
  inline def apply(
    ...
    drawPreviewPage: (Any, Double) => Unit,
    duplex: Boolean,
    endPrint: () => Unit,
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CPrintManagerTemplatePrinter] (val x: Self) extends AnyVal {
    ...
    inline def setDrawPreviewPage(value: (Any, Double) => Unit): Self = StObject.set(x, "drawPreviewPage", js.Any.fromFunction2(value))
