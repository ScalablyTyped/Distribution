...
trait SVGPolylineElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.SVGPolylineElement_typekey")
...
object SVGPolylineElement {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SVGPolylineElement] (val x: Self) extends AnyVal {
    ...
    inline def setMSHTMLDotSVGPolylineElement_typekey(value: SVGPolylineElement): Self = StObject.set(x, "MSHTML.SVGPolylineElement_typekey", value.asInstanceOf[js.Any])
