...
object svgPreserveAspectRatioAlignType {
  ...
  inline def SVG_PRESERVEASPECTRATIO_NONE: `1` = 1.asInstanceOf[`1`]
  
  inline def SVG_PRESERVEASPECTRATIO_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMAXYMAX: `10` = 10.asInstanceOf[`10`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMAXYMID: `7` = 7.asInstanceOf[`7`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMAXYMIN: `4` = 4.asInstanceOf[`4`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMIDYMAX: `9` = 9.asInstanceOf[`9`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMIDYMID: `6` = 6.asInstanceOf[`6`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMIDYMIN: `3` = 3.asInstanceOf[`3`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMINYMAX: `8` = 8.asInstanceOf[`8`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMINYMID: `5` = 5.asInstanceOf[`5`]
  
  inline def SVG_PRESERVEASPECTRATIO_XMINYMIN: `2` = 2.asInstanceOf[`2`]
  
  inline def svgPreserveAspectRatioAlignType_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
