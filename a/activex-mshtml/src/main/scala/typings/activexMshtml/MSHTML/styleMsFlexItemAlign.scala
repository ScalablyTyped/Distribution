...
*/
trait styleMsFlexItemAlign extends StObject
object styleMsFlexItemAlign {
  
  inline def styleMsFlexItemAlignAuto: `5` = 5.asInstanceOf[`5`]
  
  inline def styleMsFlexItemAlignBaseline: `3` = 3.asInstanceOf[`3`]
  
  inline def styleMsFlexItemAlignCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsFlexItemAlignEnd: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsFlexItemAlignNotSet: `6` = 6.asInstanceOf[`6`]
  
  inline def styleMsFlexItemAlignStart: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsFlexItemAlignStretch: `4` = 4.asInstanceOf[`4`]
  
  inline def styleMsFlexItemAlign_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
