...
@js.native
trait HTMLMapElement extends StObject {
  ...
  def areas(): Any = js.native
  def areas(name: Any): Any = js.native
  def areas(name: Any, index: Any): Any = js.native
  def areas(name: Unit, index: Any): Any = js.native
  @JSName("areas")
