...
*/
trait _MOVEUNIT_ACTION extends StObject
object _MOVEUNIT_ACTION {
  
  inline def MOVEUNIT_ACTION_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
  
  inline def MOVEUNIT_NEXTBLOCK: `19` = 19.asInstanceOf[`19`]
  
  inline def MOVEUNIT_NEXTCHAR: `1` = 1.asInstanceOf[`1`]
  
  inline def MOVEUNIT_NEXTCLUSTERBEGIN: `3` = 3.asInstanceOf[`3`]
  
  inline def MOVEUNIT_NEXTCLUSTEREND: `5` = 5.asInstanceOf[`5`]
  
  inline def MOVEUNIT_NEXTPROOFWORD: `11` = 11.asInstanceOf[`11`]
  
  inline def MOVEUNIT_NEXTSENTENCE: `17` = 17.asInstanceOf[`17`]
  
  inline def MOVEUNIT_NEXTURLBEGIN: `12` = 12.asInstanceOf[`12`]
  
  inline def MOVEUNIT_NEXTURLEND: `14` = 14.asInstanceOf[`14`]
  
  inline def MOVEUNIT_NEXTWORDBEGIN: `7` = 7.asInstanceOf[`7`]
  
  inline def MOVEUNIT_NEXTWORDEND: `9` = 9.asInstanceOf[`9`]
  
  inline def MOVEUNIT_PREVBLOCK: `18` = 18.asInstanceOf[`18`]
  
  inline def MOVEUNIT_PREVCHAR: `0` = 0.asInstanceOf[`0`]
  
  inline def MOVEUNIT_PREVCLUSTERBEGIN: `2` = 2.asInstanceOf[`2`]
  
  inline def MOVEUNIT_PREVCLUSTEREND: `4` = 4.asInstanceOf[`4`]
  
  inline def MOVEUNIT_PREVPROOFWORD: `10` = 10.asInstanceOf[`10`]
  
  inline def MOVEUNIT_PREVSENTENCE: `16` = 16.asInstanceOf[`16`]
  
  inline def MOVEUNIT_PREVURLBEGIN: `13` = 13.asInstanceOf[`13`]
  
  inline def MOVEUNIT_PREVURLEND: `15` = 15.asInstanceOf[`15`]
  
  inline def MOVEUNIT_PREVWORDBEGIN: `6` = 6.asInstanceOf[`6`]
  
  inline def MOVEUNIT_PREVWORDEND: `8` = 8.asInstanceOf[`8`]
}
