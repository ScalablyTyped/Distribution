...
*/
trait svgTurbulenceType extends StObject
object svgTurbulenceType {
  
  inline def SVG_TURBULENCE_TYPE_FACTALNOISE: `1` = 1.asInstanceOf[`1`]
  
  inline def SVG_TURBULENCE_TYPE_TURBULENCE: `2` = 2.asInstanceOf[`2`]
  
  inline def SVG_TURBULENCE_TYPE_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def svgTurbulenceType_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
