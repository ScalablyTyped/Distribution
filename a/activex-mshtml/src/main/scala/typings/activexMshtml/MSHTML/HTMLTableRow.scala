...
@js.native
trait HTMLTableRow extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLTableRow_typekey")
  ...
  /** @param index [index=-1] */
  def ie9_insertCell(): Any = js.native
  def ie9_insertCell(index: Double): Any = js.native
  ...
  /** @param index [index=-1] */
  def insertCell(): Any = js.native
  def insertCell(index: Double): Any = js.native
