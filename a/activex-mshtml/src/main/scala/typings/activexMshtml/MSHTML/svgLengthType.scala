...
object svgLengthType {
  ...
  inline def SVG_LENGTHTYPE_CM: `6` = 6.asInstanceOf[`6`]
  
  inline def SVG_LENGTHTYPE_EMS: `3` = 3.asInstanceOf[`3`]
  
  inline def SVG_LENGTHTYPE_EXS: `4` = 4.asInstanceOf[`4`]
  
  inline def SVG_LENGTHTYPE_IN: `8` = 8.asInstanceOf[`8`]
  
  inline def SVG_LENGTHTYPE_MM: `7` = 7.asInstanceOf[`7`]
  
  inline def SVG_LENGTHTYPE_NUMBER: `1` = 1.asInstanceOf[`1`]
  
  inline def SVG_LENGTHTYPE_PC: `10` = 10.asInstanceOf[`10`]
  
  inline def SVG_LENGTHTYPE_PERCENTAGE: `2` = 2.asInstanceOf[`2`]
  
  inline def SVG_LENGTHTYPE_PT: `9` = 9.asInstanceOf[`9`]
  
  inline def SVG_LENGTHTYPE_PX: `5` = 5.asInstanceOf[`5`]
  
  inline def SVG_LENGTHTYPE_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def svgLengthType_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
