...
*/
trait _HTML_PAINT_EVENT_FLAGS extends StObject
object _HTML_PAINT_EVENT_FLAGS {
  
  inline def HTMLPAINT_EVENT_SETCURSOR: `2` = 2.asInstanceOf[`2`]
  
  inline def HTMLPAINT_EVENT_TARGET: `1` = 1.asInstanceOf[`1`]
  
  inline def HTML_PAINT_EVENT_FLAGS_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
