...
*/
trait styleBidi extends StObject
object styleBidi {
  
  inline def styleBidiEmbed: `2` = 2.asInstanceOf[`2`]
  
  inline def styleBidiInherit: `4` = 4.asInstanceOf[`4`]
  
  inline def styleBidiNormal: `1` = 1.asInstanceOf[`1`]
  
  inline def styleBidiNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleBidiOverride: `3` = 3.asInstanceOf[`3`]
  
  inline def styleBidi_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
