...
*/
trait styleTransformOriginX extends StObject
object styleTransformOriginX {
  
  inline def styleTransformOriginXCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleTransformOriginXLeft: `1` = 1.asInstanceOf[`1`]
  
  inline def styleTransformOriginXNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleTransformOriginXRight: `3` = 3.asInstanceOf[`3`]
  
  inline def styleTransformOriginX_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
