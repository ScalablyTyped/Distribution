...
*/
trait svgMarkerOrient extends StObject
object svgMarkerOrient {
  
  inline def SVG_MARKER_ORIENT_ANGLE: `2` = 2.asInstanceOf[`2`]
  
  inline def SVG_MARKER_ORIENT_AUTO: `1` = 1.asInstanceOf[`1`]
  
  inline def SVG_MARKER_ORIENT_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def svgMarkerOrient_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
