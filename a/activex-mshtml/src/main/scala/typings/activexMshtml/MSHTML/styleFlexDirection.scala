...
*/
trait styleFlexDirection extends StObject
object styleFlexDirection {
  
  inline def styleFlexDirectionColumn: `2` = 2.asInstanceOf[`2`]
  
  inline def styleFlexDirectionColumnReverse: `3` = 3.asInstanceOf[`3`]
  
  inline def styleFlexDirectionNotSet: `4` = 4.asInstanceOf[`4`]
  
  inline def styleFlexDirectionRow: `0` = 0.asInstanceOf[`0`]
  
  inline def styleFlexDirectionRowReverse: `1` = 1.asInstanceOf[`1`]
  
  inline def styleFlexDirection_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
