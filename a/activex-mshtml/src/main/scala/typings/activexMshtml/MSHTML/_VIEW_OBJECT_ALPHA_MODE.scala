...
object _VIEW_OBJECT_ALPHA_MODE {
  ...
  @scala.inline
  def VIEW_OBJECT_ALPHA_MODE_IGNORE: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def VIEW_OBJECT_ALPHA_MODE_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
  
  @scala.inline
  def VIEW_OBJECT_ALPHA_MODE_PREMULTIPLIED: `1` = 1.asInstanceOf[`1`]
}
