...
trait HTMLImageElementFactory extends js.Object {
  ...
  def apply(width: js.UndefOr[scala.Nothing], height: js.Any): IHTMLImgElement = js.native
  ...
  def create(width: js.UndefOr[scala.Nothing], height: js.Any): IHTMLImgElement = js.native
