...
*/
trait styleMsContentZoomSnapType extends StObject
object styleMsContentZoomSnapType {
  
  inline def styleMsContentZoomSnapTypeMandatory: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsContentZoomSnapTypeNone: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsContentZoomSnapTypeNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsContentZoomSnapTypeProximity: `3` = 3.asInstanceOf[`3`]
  
  inline def styleMsContentZoomSnapType_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
