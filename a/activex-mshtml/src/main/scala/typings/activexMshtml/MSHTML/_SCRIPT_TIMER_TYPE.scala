...
*/
trait _SCRIPT_TIMER_TYPE extends StObject
object _SCRIPT_TIMER_TYPE {
  
  inline def SCRIPT_TIMER_TYPE_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
  
  inline def STT_ANIMATION_FRAME: `3` = 3.asInstanceOf[`3`]
  
  inline def STT_IMMEDIATE: `2` = 2.asInstanceOf[`2`]
  
  inline def STT_INTERVAL: `1` = 1.asInstanceOf[`1`]
  
  inline def STT_TIMEOUT: `0` = 0.asInstanceOf[`0`]
}
