...
object DOMCustomEvent {
  ...
  implicit class DOMCustomEventOps[Self <: DOMCustomEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotDOMCustomEvent_typekey(value: DOMCustomEvent): Self = this.set("MSHTML.DOMCustomEvent_typekey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setInitCustomEvent(value: (String, Boolean, Boolean, js.Any) => Unit): Self = this.set("initCustomEvent", js.Any.fromFunction4(value))
