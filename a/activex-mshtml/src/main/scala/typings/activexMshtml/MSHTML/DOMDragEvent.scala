...
trait DOMDragEvent extends StObject {
  ...
  /* private */ @JSName("MSHTML.DOMDragEvent_typekey")
...
object DOMDragEvent {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DOMDragEvent] (val x: Self) extends AnyVal {
    ...
    inline def setDataTransfer(value: IHTMLDataTransfer): Self = StObject.set(x, "dataTransfer", value.asInstanceOf[js.Any])
    ...
    inline def setMSHTMLDotDOMDragEvent_typekey(value: DOMDragEvent): Self = StObject.set(x, "MSHTML.DOMDragEvent_typekey", value.asInstanceOf[js.Any])
