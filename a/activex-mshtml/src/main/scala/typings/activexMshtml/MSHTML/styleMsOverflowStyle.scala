...
*/
trait styleMsOverflowStyle extends StObject
object styleMsOverflowStyle {
  
  inline def styleMsOverflowStyleAuto: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsOverflowStyleMsAutoHidingScrollbar: `4` = 4.asInstanceOf[`4`]
  
  inline def styleMsOverflowStyleNone: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsOverflowStyleNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsOverflowStyleScrollbar: `3` = 3.asInstanceOf[`3`]
  
  inline def styleMsOverflowStyle_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
