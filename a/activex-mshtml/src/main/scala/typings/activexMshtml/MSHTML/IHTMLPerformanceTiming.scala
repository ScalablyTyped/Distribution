...
object IHTMLPerformanceTiming {
  ...
  implicit class IHTMLPerformanceTimingOps[Self <: IHTMLPerformanceTiming] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotIHTMLPerformanceTiming_typekey(value: IHTMLPerformanceTiming): Self = this.set("MSHTML.IHTMLPerformanceTiming_typekey", value.asInstanceOf[js.Any])
