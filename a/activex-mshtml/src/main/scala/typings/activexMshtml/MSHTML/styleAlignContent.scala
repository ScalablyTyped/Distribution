...
*/
trait styleAlignContent extends StObject
object styleAlignContent {
  
  inline def styleAlignContentCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleAlignContentFlexEnd: `1` = 1.asInstanceOf[`1`]
  
  inline def styleAlignContentFlexStart: `0` = 0.asInstanceOf[`0`]
  
  inline def styleAlignContentNotSet: `6` = 6.asInstanceOf[`6`]
  
  inline def styleAlignContentSpaceAround: `4` = 4.asInstanceOf[`4`]
  
  inline def styleAlignContentSpaceBetween: `3` = 3.asInstanceOf[`3`]
  
  inline def styleAlignContentStretch: `5` = 5.asInstanceOf[`5`]
  
  inline def styleAlignContent_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
