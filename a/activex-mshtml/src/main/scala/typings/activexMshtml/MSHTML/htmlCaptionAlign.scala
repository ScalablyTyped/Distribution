...
object htmlCaptionAlign {
  ...
  inline def htmlCaptionAlignBottom: `6` = 6.asInstanceOf[`6`]
  
  inline def htmlCaptionAlignCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def htmlCaptionAlignJustify: `4` = 4.asInstanceOf[`4`]
  
  inline def htmlCaptionAlignLeft: `1` = 1.asInstanceOf[`1`]
  
  inline def htmlCaptionAlignNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def htmlCaptionAlignRight: `3` = 3.asInstanceOf[`3`]
  
  inline def htmlCaptionAlignTop: `5` = 5.asInstanceOf[`5`]
  
  inline def htmlCaptionAlign_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
