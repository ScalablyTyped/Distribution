...
trait HTMLTable extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLTable_typekey")
  ...
  var borderColorDark: Any = js.native
  
  var borderColorLight: Any = js.native
  ...
  var cellPadding: Any = js.native
  
  var cellSpacing: Any = js.native
  
  def cells(): Any = js.native
  def cells(name: Any): Any = js.native
  def cells(name: Any, index: Any): Any = js.native
  def cells(name: Unit, index: Any): Any = js.native
  @JSName("cells")
  ...
  def createTFoot(): Any = js.native
  
  def createTHead(): Any = js.native
  ...
  def tBodies(): Any = js.native
  def tBodies(name: Any): Any = js.native
  def tBodies(name: Any, index: Any): Any = js.native
  def tBodies(name: Unit, index: Any): Any = js.native
  @JSName("tBodies")
