...
object CTemplatePrinter {
  ...
  @scala.inline
  implicit class CTemplatePrinterOps[Self <: CTemplatePrinter] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotCTemplatePrinter_typekey(value: CTemplatePrinter): Self = this.set("MSHTML.CTemplatePrinter_typekey", value.asInstanceOf[js.Any])
