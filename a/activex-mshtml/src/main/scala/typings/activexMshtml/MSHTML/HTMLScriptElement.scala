...
trait HTMLScriptElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLScriptElement_typekey")
  var MSHTMLDotHTMLScriptElement_typekey: HTMLScriptElement = js.native
  ...
  val usedCharset: String = js.native
