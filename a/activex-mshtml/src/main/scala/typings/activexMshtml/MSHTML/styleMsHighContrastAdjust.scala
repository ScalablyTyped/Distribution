...
*/
trait styleMsHighContrastAdjust extends StObject
object styleMsHighContrastAdjust {
  
  inline def styleMsHighContrastAdjustAuto: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsHighContrastAdjustNone: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsHighContrastAdjustNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsHighContrastAdjust_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
