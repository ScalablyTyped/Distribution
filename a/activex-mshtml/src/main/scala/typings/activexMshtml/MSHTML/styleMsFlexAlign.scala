...
object styleMsFlexAlign {
  ...
  inline def styleMsFlexAlignBaseline: `3` = 3.asInstanceOf[`3`]
  
  inline def styleMsFlexAlignCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleMsFlexAlignEnd: `1` = 1.asInstanceOf[`1`]
  
  inline def styleMsFlexAlignNotSet: `5` = 5.asInstanceOf[`5`]
  
  inline def styleMsFlexAlignStart: `0` = 0.asInstanceOf[`0`]
  
  inline def styleMsFlexAlignStretch: `4` = 4.asInstanceOf[`4`]
  
  inline def styleMsFlexAlign_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
