...
object SVGAElement {
  ...
  implicit class SVGAElementOps[Self <: SVGAElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotSVGAElement_typekey(value: SVGAElement): Self = this.set("MSHTML.SVGAElement_typekey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setTarget(value: SVGAnimatedString): Self = this.set("target", value.asInstanceOf[js.Any])
    @scala.inline
