...
object SVGAElement {
  ...
  @scala.inline
  implicit class SVGAElementMutableBuilder[Self <: SVGAElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotSVGAElement_typekey(value: SVGAElement): Self = StObject.set(x, "MSHTML.SVGAElement_typekey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTarget(value: SVGAnimatedString): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
