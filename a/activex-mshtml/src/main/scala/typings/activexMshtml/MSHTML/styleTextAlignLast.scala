...
*/
trait styleTextAlignLast extends StObject
object styleTextAlignLast {
  
  inline def styleTextAlignLastAuto: `5` = 5.asInstanceOf[`5`]
  
  inline def styleTextAlignLastCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def styleTextAlignLastJustify: `4` = 4.asInstanceOf[`4`]
  
  inline def styleTextAlignLastLeft: `1` = 1.asInstanceOf[`1`]
  
  inline def styleTextAlignLastNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleTextAlignLastRight: `3` = 3.asInstanceOf[`3`]
  
  inline def styleTextAlignLast_Max: `2147483647` = 2147483647.asInstanceOf[`2147483647`]
}
