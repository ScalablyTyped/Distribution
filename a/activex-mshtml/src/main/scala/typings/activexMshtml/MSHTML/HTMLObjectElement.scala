...
@js.native
trait HTMLObjectElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLObjectElement_typekey")
  ...
  var ie8_codeBase: String = js.native
  
  var ie8_data: String = js.native
  ...
  var ie9_object: String = js.native
