...
object _HTML_PAINTER {
  ...
  inline def HTMLPAINTER_3DSURFACE: `512` = 512.asInstanceOf[`512`]
  
  inline def HTMLPAINTER_ALPHA: `4` = 4.asInstanceOf[`4`]
  
  inline def HTMLPAINTER_COMPLEX: `8` = 8.asInstanceOf[`8`]
  
  inline def HTMLPAINTER_EXPAND: `65536` = 65536.asInstanceOf[`65536`]
  
  inline def HTMLPAINTER_HITTEST: `32` = 32.asInstanceOf[`32`]
  
  inline def HTMLPAINTER_NOBAND: `1024` = 1024.asInstanceOf[`1024`]
  
  inline def HTMLPAINTER_NODC: `4096` = 4096.asInstanceOf[`4096`]
  
  inline def HTMLPAINTER_NOPHYSICALCLIP: `8192` = 8192.asInstanceOf[`8192`]
  
  inline def HTMLPAINTER_NOSAVEDC: `16384` = 16384.asInstanceOf[`16384`]
  
  inline def HTMLPAINTER_NOSCROLLBITS: `131072` = 131072.asInstanceOf[`131072`]
  
  inline def HTMLPAINTER_OPAQUE: `1` = 1.asInstanceOf[`1`]
  
  inline def HTMLPAINTER_OVERLAY: `16` = 16.asInstanceOf[`16`]
  
  inline def HTMLPAINTER_SUPPORTS_XFORM: `32768` = 32768.asInstanceOf[`32768`]
  
  inline def HTMLPAINTER_SURFACE: `256` = 256.asInstanceOf[`256`]
