...
object DOMMSTransitionEvent {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DOMMSTransitionEvent] (val x: Self) extends AnyVal {
    ...
    inline def setInitMSTransitionEvent(value: (String, Boolean, Boolean, String, Double) => Unit): Self = StObject.set(x, "initMSTransitionEvent", js.Any.fromFunction5(value))
