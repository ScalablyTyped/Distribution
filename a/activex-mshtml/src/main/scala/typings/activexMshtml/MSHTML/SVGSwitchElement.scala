...
trait SVGSwitchElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.SVGSwitchElement_typekey")
...
object SVGSwitchElement {
  ...
  extension [Self <: SVGSwitchElement](x: Self) {
    ...
    inline def setMSHTMLDotSVGSwitchElement_typekey(value: SVGSwitchElement): Self = StObject.set(x, "MSHTML.SVGSwitchElement_typekey", value.asInstanceOf[js.Any])
