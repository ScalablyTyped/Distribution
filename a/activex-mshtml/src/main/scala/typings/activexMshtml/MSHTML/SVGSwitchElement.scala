...
@js.native
trait SVGSwitchElement extends js.Object {
...
object SVGSwitchElement {
  ...
  @scala.inline
  implicit class SVGSwitchElementOps[Self <: SVGSwitchElement] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMSHTMLDotSVGSwitchElement_typekey(value: SVGSwitchElement): Self = this.set("MSHTML.SVGSwitchElement_typekey", value.asInstanceOf[js.Any])
    @scala.inline
