...
trait SVGSwitchElement extends StObject {
  
  @JSName("MSHTML.SVGSwitchElement_typekey")
  var MSHTMLDotSVGSwitchElement_typekey: SVGSwitchElement
...
object SVGSwitchElement {
  ...
  @scala.inline
  def apply(
    MSHTMLDotSVGSwitchElement_typekey: SVGSwitchElement,
    ...
    __obj.updateDynamic("MSHTML.SVGSwitchElement_typekey")(MSHTMLDotSVGSwitchElement_typekey.asInstanceOf[js.Any])
    __obj.asInstanceOf[SVGSwitchElement]
  }
  
  @scala.inline
  implicit class SVGSwitchElementMutableBuilder[Self <: SVGSwitchElement] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotSVGSwitchElement_typekey(value: SVGSwitchElement): Self = StObject.set(x, "MSHTML.SVGSwitchElement_typekey", value.asInstanceOf[js.Any])
