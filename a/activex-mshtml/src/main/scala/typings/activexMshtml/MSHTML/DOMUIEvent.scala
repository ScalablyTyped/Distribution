...
object DOMUIEvent {
  ...
  @scala.inline
  implicit class DOMUIEventMutableBuilder[Self <: DOMUIEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotDOMUIEvent_typekey(value: DOMUIEvent): Self = StObject.set(x, "MSHTML.DOMUIEvent_typekey", value.asInstanceOf[js.Any])
