...
object svgMorphologyOperator {
  @scala.inline
  def SVG_MORPHOLOGY_OPERATOR_DILATE: `2` = this.cast(2)
  @scala.inline
  def SVG_MORPHOLOGY_OPERATOR_ERODE: `1` = this.cast(1)
  @scala.inline
  def SVG_MORPHOLOGY_OPERATOR_UNKNOWN: `0` = this.cast(0)
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def svgMorphologyOperator_Max: `2147483647` = this.cast(2147483647)
}
