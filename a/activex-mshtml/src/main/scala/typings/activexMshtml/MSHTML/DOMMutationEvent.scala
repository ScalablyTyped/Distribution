...
object DOMMutationEvent {
  ...
  implicit class DOMMutationEventOps[Self <: DOMMutationEvent] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSHTMLDotDOMMutationEvent_typekey(value: DOMMutationEvent): Self = this.set("MSHTML.DOMMutationEvent_typekey", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setInitMutationEvent(value: (String, Boolean, Boolean, js.Any, String, String, String, Double) => Unit): Self = this.set("initMutationEvent", js.Any.fromFunction8(value))
    @scala.inline
    ...
    @scala.inline
    def setRelatedNode(value: js.Any): Self = this.set("relatedNode", value.asInstanceOf[js.Any])
    @scala.inline
