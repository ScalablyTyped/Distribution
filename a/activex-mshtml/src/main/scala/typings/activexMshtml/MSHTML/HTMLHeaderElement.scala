...
@js.native
trait HTMLHeaderElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLHeaderElement_typekey")
  var MSHTMLDotHTMLHeaderElement_typekey: HTMLHeaderElement = js.native
