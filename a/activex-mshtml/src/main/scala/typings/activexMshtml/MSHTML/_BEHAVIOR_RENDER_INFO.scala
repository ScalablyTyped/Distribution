...
object _BEHAVIOR_RENDER_INFO {
  ...
  inline def BEHAVIORRENDERINFO_3DSURFACE: `2097152` = 2097152.asInstanceOf[`2097152`]
  
  inline def BEHAVIORRENDERINFO_ABOVECONTENT: `40` = 40.asInstanceOf[`40`]
  
  inline def BEHAVIORRENDERINFO_AFTERBACKGROUND: `2` = 2.asInstanceOf[`2`]
  
  inline def BEHAVIORRENDERINFO_AFTERCONTENT: `8` = 8.asInstanceOf[`8`]
  
  inline def BEHAVIORRENDERINFO_AFTERFOREGROUND: `32` = 32.asInstanceOf[`32`]
  
  inline def BEHAVIORRENDERINFO_ALLLAYERS: `255` = 255.asInstanceOf[`255`]
  
  inline def BEHAVIORRENDERINFO_BEFOREBACKGROUND: `1` = 1.asInstanceOf[`1`]
  
  inline def BEHAVIORRENDERINFO_BEFORECONTENT: `4` = 4.asInstanceOf[`4`]
  
  inline def BEHAVIORRENDERINFO_DISABLEALLLAYERS: `3840` = 3840.asInstanceOf[`3840`]
  
  inline def BEHAVIORRENDERINFO_DISABLEBACKGROUND: `256` = 256.asInstanceOf[`256`]
  
  inline def BEHAVIORRENDERINFO_DISABLECONTENT: `1024` = 1024.asInstanceOf[`1024`]
  
  inline def BEHAVIORRENDERINFO_DISABLENEGATIVEZ: `512` = 512.asInstanceOf[`512`]
  
  inline def BEHAVIORRENDERINFO_DISABLEPOSITIVEZ: `2048` = 2048.asInstanceOf[`2048`]
  
  inline def BEHAVIORRENDERINFO_HITTESTING: `4096` = 4096.asInstanceOf[`4096`]
