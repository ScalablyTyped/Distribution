...
class DOMSiteModeEvent protected ()
  extends typings.activexMshtml.MSHTML.DOMSiteModeEvent {
  /* CompleteClass */
  @JSName("MSHTML.DOMSiteModeEvent_typekey")
  override var MSHTMLDotDOMSiteModeEvent_typekey: typings.activexMshtml.MSHTML.DOMSiteModeEvent = js.native
  /* CompleteClass */
