...
class SVGSwitchElement protected ()
  extends typings.activexMshtml.MSHTML.SVGSwitchElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGSwitchElement_typekey")
  override var MSHTMLDotSVGSwitchElement_typekey: typings.activexMshtml.MSHTML.SVGSwitchElement = js.native
  /* CompleteClass */
