...
@js.native
class HTMLPerformanceTiming protected ()
  extends typings.activexMshtml.MSHTML.HTMLPerformanceTiming {
  /* CompleteClass */
  @JSName("MSHTML.HTMLPerformanceTiming_typekey")
  override var MSHTMLDotHTMLPerformanceTiming_typekey: typings.activexMshtml.MSHTML.HTMLPerformanceTiming = js.native
  /* CompleteClass */
