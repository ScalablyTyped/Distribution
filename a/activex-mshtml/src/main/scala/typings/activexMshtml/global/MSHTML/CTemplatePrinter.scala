...
class CTemplatePrinter protected ()
  extends typings.activexMshtml.MSHTML.CTemplatePrinter {
  /* CompleteClass */
  @JSName("MSHTML.CTemplatePrinter_typekey")
  override var MSHTMLDotCTemplatePrinter_typekey: typings.activexMshtml.MSHTML.CTemplatePrinter = js.native
  /* CompleteClass */
