...
class SVGAElement protected ()
  extends typings.activexMshtml.MSHTML.SVGAElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGAElement_typekey")
  override var MSHTMLDotSVGAElement_typekey: typings.activexMshtml.MSHTML.SVGAElement = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var target: typings.activexMshtml.MSHTML.SVGAnimatedString = js.native
  /* CompleteClass */
