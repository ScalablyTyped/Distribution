...
@js.native
/* private */ open class SVGRadialGradientElement ()
  extends StObject
  ...
  /* CompleteClass */
  var cx: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var cy: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  ...
  /* CompleteClass */
  var fx: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var fy: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var gradientTransform: typings.activexMshtml.MSHTML.SVGAnimatedTransformList = js.native
  
  /* CompleteClass */
  var gradientUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
  ...
  /* CompleteClass */
  var r: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var spreadMethod: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
