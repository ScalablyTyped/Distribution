...
class SVGPathElement protected ()
  extends typings.activexMshtml.MSHTML.SVGPathElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGPathElement_typekey")
  override var MSHTMLDotSVGPathElement_typekey: typings.activexMshtml.MSHTML.SVGPathElement = js.native
  /* CompleteClass */
  override var animatedNormalizedPathSegList: typings.activexMshtml.MSHTML.SVGPathSegList = js.native
  /* CompleteClass */
  override var animatedPathSegList: typings.activexMshtml.MSHTML.SVGPathSegList = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var normalizedPathSegList: typings.activexMshtml.MSHTML.SVGPathSegList = js.native
  /* CompleteClass */
  override var ownerSVGElement: typings.activexMshtml.MSHTML.ISVGSVGElement = js.native
  /* CompleteClass */
  override var pathLength: typings.activexMshtml.MSHTML.SVGAnimatedNumber = js.native
  /* CompleteClass */
  override var pathSegList: typings.activexMshtml.MSHTML.SVGPathSegList = js.native
  /* CompleteClass */
