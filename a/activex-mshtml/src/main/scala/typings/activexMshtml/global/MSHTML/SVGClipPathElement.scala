...
class SVGClipPathElement protected ()
  extends typings.activexMshtml.MSHTML.SVGClipPathElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGClipPathElement_typekey")
  override var MSHTMLDotSVGClipPathElement_typekey: typings.activexMshtml.MSHTML.SVGClipPathElement = js.native
  /* CompleteClass */
  override val className: typings.activexMshtml.MSHTML.SVGAnimatedString = js.native
  /* CompleteClass */
  override var clipPathUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
  /* CompleteClass */
