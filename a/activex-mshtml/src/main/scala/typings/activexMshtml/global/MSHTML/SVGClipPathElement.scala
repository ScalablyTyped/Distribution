...
@js.native
/* private */ open class SVGClipPathElement ()
  extends StObject
     with typings.activexMshtml.MSHTML.SVGClipPathElement {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.SVGClipPathElement_typekey")
  var MSHTMLDotSVGClipPathElement_typekey: typings.activexMshtml.MSHTML.SVGClipPathElement = js.native
  
  /* CompleteClass */
  override val className: typings.activexMshtml.MSHTML.SVGAnimatedString = js.native
  
  /* CompleteClass */
  var clipPathUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
