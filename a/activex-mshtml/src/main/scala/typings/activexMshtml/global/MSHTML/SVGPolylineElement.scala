...
class SVGPolylineElement protected ()
  extends typings.activexMshtml.MSHTML.SVGPolylineElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGPolylineElement_typekey")
  override var MSHTMLDotSVGPolylineElement_typekey: typings.activexMshtml.MSHTML.SVGPolylineElement = js.native
  /* CompleteClass */
