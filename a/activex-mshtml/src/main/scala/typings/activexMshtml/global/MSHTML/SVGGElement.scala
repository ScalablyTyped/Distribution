...
@js.native
class SVGGElement protected ()
  extends typings.activexMshtml.MSHTML.SVGGElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGGElement_typekey")
  override var MSHTMLDotSVGGElement_typekey: typings.activexMshtml.MSHTML.SVGGElement = js.native
  /* CompleteClass */
