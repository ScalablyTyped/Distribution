...
@js.native
/* private */ open class SVGAnimatedLength ()
  extends StObject
  ...
  /* CompleteClass */
  var animVal: typings.activexMshtml.MSHTML.SVGLength = js.native
  
  /* CompleteClass */
  var baseVal: typings.activexMshtml.MSHTML.SVGLength = js.native
}
