...
import typings.activexMshtml.MSHTML.IHTMLElementCollection
...
/* private */ class IHTMLDocument7 ()
  ...
  /* CompleteClass */
  var body: typings.activexMshtml.MSHTML.IHTMLElement = js.native
  ...
  /* CompleteClass */
  override val head: typings.activexMshtml.MSHTML.IHTMLElement = js.native
  
  /* CompleteClass */
  override def importNode(pNodeSource: typings.activexMshtml.MSHTML.IHTMLDOMNode, fDeep: Boolean): typings.activexMshtml.MSHTML.IHTMLDOMNode3 = js.native
