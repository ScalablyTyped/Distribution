...
@js.native
class SVGCircleElement protected ()
  extends typings.activexMshtml.MSHTML.SVGCircleElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGCircleElement_typekey")
  override var MSHTMLDotSVGCircleElement_typekey: typings.activexMshtml.MSHTML.SVGCircleElement = js.native
  /* CompleteClass */
  override var cx: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  /* CompleteClass */
  override var cy: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var r: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  /* CompleteClass */
