...
@js.native
class SVGRectElement protected ()
  extends typings.activexMshtml.MSHTML.SVGRectElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGRectElement_typekey")
  override var MSHTMLDotSVGRectElement_typekey: typings.activexMshtml.MSHTML.SVGRectElement = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var rx: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  /* CompleteClass */
  override var ry: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  /* CompleteClass */
