...
@js.native
/* private */ class SVGPatternElement ()
  extends StObject
     with typings.activexMshtml.MSHTML.SVGPatternElement {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.SVGPatternElement_typekey")
  var MSHTMLDotSVGPatternElement_typekey: typings.activexMshtml.MSHTML.SVGPatternElement = js.native
  ...
  /* CompleteClass */
  var patternContentUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
  
  /* CompleteClass */
  var patternTransform: typings.activexMshtml.MSHTML.SVGAnimatedTransformList = js.native
  
  /* CompleteClass */
  var patternUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
