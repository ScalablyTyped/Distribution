...
class SVGLineElement protected ()
  ...
  var MSHTMLDotSVGLineElement_typekey: typings.activexMshtml.MSHTML.SVGLineElement = js.native
  ...
  /* CompleteClass */
  var x1: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var x2: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  ...
  /* CompleteClass */
  var y1: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
  
  /* CompleteClass */
  var y2: typings.activexMshtml.MSHTML.SVGAnimatedLength = js.native
}
