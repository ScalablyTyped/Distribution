...
class SVGMaskElement protected ()
  ...
  /* CompleteClass */
  var maskContentUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
  
  /* CompleteClass */
  var maskUnits: typings.activexMshtml.MSHTML.SVGAnimatedEnumeration = js.native
