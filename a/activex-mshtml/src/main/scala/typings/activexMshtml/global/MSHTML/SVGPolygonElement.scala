...
class SVGPolygonElement protected ()
  extends typings.activexMshtml.MSHTML.SVGPolygonElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGPolygonElement_typekey")
  override var MSHTMLDotSVGPolygonElement_typekey: typings.activexMshtml.MSHTML.SVGPolygonElement = js.native
  /* CompleteClass */
  override var animatedPoints: typings.activexMshtml.MSHTML.SVGPointList = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var points: typings.activexMshtml.MSHTML.SVGPointList = js.native
  /* CompleteClass */
