...
@js.native
/* private */ open class SVGPolygonElement ()
  extends StObject
  ...
  /* CompleteClass */
  var animatedPoints: typings.activexMshtml.MSHTML.SVGPointList = js.native
  ...
  /* CompleteClass */
  var points: typings.activexMshtml.MSHTML.SVGPointList = js.native
