...
@js.native
/* private */ open class SVGAnimatedNumberList ()
  extends StObject
  ...
  /* CompleteClass */
  var animVal: typings.activexMshtml.MSHTML.SVGNumberList = js.native
  
  /* CompleteClass */
  var baseVal: typings.activexMshtml.MSHTML.SVGNumberList = js.native
}
