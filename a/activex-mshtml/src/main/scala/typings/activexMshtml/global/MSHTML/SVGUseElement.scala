...
class SVGUseElement protected ()
  extends typings.activexMshtml.MSHTML.SVGUseElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGUseElement_typekey")
  override var MSHTMLDotSVGUseElement_typekey: typings.activexMshtml.MSHTML.SVGUseElement = js.native
  /* CompleteClass */
  override var animatedInstanceRoot: typings.activexMshtml.MSHTML.ISVGElementInstance = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var instanceRoot: typings.activexMshtml.MSHTML.ISVGElementInstance = js.native
  /* CompleteClass */
