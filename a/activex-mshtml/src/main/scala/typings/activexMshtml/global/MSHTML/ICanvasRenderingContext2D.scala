...
class ICanvasRenderingContext2D protected ()
  extends typings.activexMshtml.MSHTML.ICanvasRenderingContext2D {
  /* CompleteClass */
  @JSName("MSHTML.ICanvasRenderingContext2D_typekey")
  override var MSHTMLDotICanvasRenderingContext2D_typekey: typings.activexMshtml.MSHTML.ICanvasRenderingContext2D = js.native
  /* CompleteClass */
  override val canvas: typings.activexMshtml.MSHTML.IHTMLCanvasElement = js.native
  /* CompleteClass */
  override var fillStyle: js.Any = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var strokeStyle: js.Any = js.native
  /* CompleteClass */
