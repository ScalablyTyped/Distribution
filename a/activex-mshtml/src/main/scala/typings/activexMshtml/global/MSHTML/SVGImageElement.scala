...
@js.native
class SVGImageElement protected ()
  extends typings.activexMshtml.MSHTML.SVGImageElement {
  /* CompleteClass */
  @JSName("MSHTML.SVGImageElement_typekey")
  override var MSHTMLDotSVGImageElement_typekey: typings.activexMshtml.MSHTML.SVGImageElement = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override var preserveAspectRatio: typings.activexMshtml.MSHTML.SVGAnimatedPreserveAspectRatio = js.native
  /* CompleteClass */
