...
@JSGlobal("MSHTML.HTMLParamElement")
@js.native
class HTMLParamElement protected () extends js.Object {
  var `MSHTML.HTMLParamElement_typekey`: HTMLParamElement = js.native
  ...
  var ie8_valueType: String = js.native
