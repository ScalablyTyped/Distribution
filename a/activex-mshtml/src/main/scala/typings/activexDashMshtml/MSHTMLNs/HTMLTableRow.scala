...
class HTMLTableRow protected () extends js.Object {
  var `MSHTML.HTMLTableRow_typekey`: HTMLTableRow = js.native
  ...
  /** @param index [index=-1] */
  def ie9_deleteCell(): Unit = js.native
  def ie9_deleteCell(index: Double): Unit = js.native
  ...
  def ie9_insertCell(index: Double): js.Any = js.native
  ...
  def insertCell(index: Double): js.Any = js.native
