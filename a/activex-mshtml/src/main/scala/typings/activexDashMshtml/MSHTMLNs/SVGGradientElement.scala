...
@JSGlobal("MSHTML.SVGGradientElement")
@js.native
class SVGGradientElement protected () extends js.Object {
  var `MSHTML.SVGGradientElement_typekey`: SVGGradientElement = js.native
