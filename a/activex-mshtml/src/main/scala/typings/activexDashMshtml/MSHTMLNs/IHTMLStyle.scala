...
@JSGlobal("MSHTML.IHTMLStyle")
@js.native
class IHTMLStyle protected () extends js.Object {
  var `MSHTML.IHTMLStyle_typekey`: IHTMLStyle = js.native
  ...
  var pixelLeft: Double = js.native
  var pixelTop: Double = js.native
  var pixelWidth: Double = js.native
  var posHeight: Double = js.native
  var posLeft: Double = js.native
  var posTop: Double = js.native
  var posWidth: Double = js.native
  val position: String = js.native
  var styleFloat: String = js.native
  var textAlign: String = js.native
  var textDecoration: String = js.native
  var textDecorationBlink: Boolean = js.native
  var textDecorationLineThrough: Boolean = js.native
  var textDecorationNone: Boolean = js.native
  var textDecorationOverline: Boolean = js.native
