...
class HTMLIFrame protected () extends js.Object {
  var `MSHTML.HTMLIFrame_typekey`: HTMLIFrame = js.native
  ...
  val contentWindow_Original: IHTMLWindow2 = js.native
  ...
  var ie8_frameBorder: String = js.native
  var ie8_longDesc: String = js.native
  ...
  def contentWindow(pvarIndex: js.Any): js.Any = js.native
