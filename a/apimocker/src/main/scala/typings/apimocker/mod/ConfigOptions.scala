...
object ConfigOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(allowAvoidPreFlight)) __obj.updateDynamic("allowAvoidPreFlight")(allowAvoidPreFlight.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(logRequestHeaders)) __obj.updateDynamic("logRequestHeaders")(logRequestHeaders.get.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(useUploadFieldname)) __obj.updateDynamic("useUploadFieldname")(useUploadFieldname.get.asInstanceOf[js.Any])
