...
object ^ extends js.Object {
  ...
  def hash(plain: java.lang.String, options: Options with (argon2Lib.Anon_False | argon2Lib.Anon_Raw)): js.Promise[nodeLib.Buffer] = js.native
  def hash(plain: nodeLib.Buffer): js.Promise[java.lang.String] = js.native
  def hash(plain: nodeLib.Buffer, options: Options with (argon2Lib.Anon_False | argon2Lib.Anon_Raw)): js.Promise[nodeLib.Buffer] = js.native
  def needsRehash(hash: java.lang.String): scala.Boolean = js.native
  def needsRehash(hash: java.lang.String, options: Options): scala.Boolean = js.native
