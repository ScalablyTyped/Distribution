...
object lineMod {
  ...
  open class Line () extends DisplayObject[LineStyleProps, ParsedLineStyleProps] {
    ...
    def attributeChangedCallback_clipPath(
      attrName: clipPath,
      oldValue: js.UndefOr[(typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]) | Null],
      newValue: js.UndefOr[(typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]) | Null],
      prevParsedValue: js.UndefOr[(typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]) | Null],
      newParsedValue: js.UndefOr[(typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]) | Null]
    ): Unit = js.native
    @JSName("attributeChangedCallback")
    ...
    def attributeChangedCallback_clipPathTargets(
      ...
      oldValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]]
    ): Unit = js.native
    @JSName("attributeChangedCallback")
    def attributeChangedCallback_clipPathTargets(
      attrName: clipPathTargets,
      oldValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]],
      newValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]]
    ): Unit = js.native
    @JSName("attributeChangedCallback")
    def attributeChangedCallback_clipPathTargets(
      attrName: clipPathTargets,
      oldValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]],
      newValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]],
      prevParsedValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]]
    ): Unit = js.native
    @JSName("attributeChangedCallback")
    def attributeChangedCallback_clipPathTargets(
      attrName: clipPathTargets,
      ...
      newValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]],
      prevParsedValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]],
      newParsedValue: js.Array[typings.antvGLite.displayObjectsMod.DisplayObject[Any, Any]]
    ): Unit = js.native
    @JSName("attributeChangedCallback")
    def attributeChangedCallback_clipPathTargets(
      attrName: clipPathTargets,
