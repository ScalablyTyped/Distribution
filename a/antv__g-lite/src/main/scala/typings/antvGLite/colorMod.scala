...
import typings.antvGLite.antvGLiteStrings.`no-repeat`
import typings.antvGLite.antvGLiteStrings.`repeat-x`
import typings.antvGLite.antvGLiteStrings.`repeat-y`
import typings.antvGLite.antvGLiteStrings.repeat
