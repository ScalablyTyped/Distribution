...
import typings.antvGLite.utilsGradientMod.ColorStop
import typings.antvGLite.utilsGradientMod.GradientNode
...
object utilsMod {
  ...
  open class AsyncParallelHook[T, AdditionalOptions] ()
    extends typings.antvGLite.tapableMod.AsyncParallelHook[T, AdditionalOptions] {
  ...
  open class AsyncSeriesWaterfallHook[T, AdditionalOptions] ()
    extends typings.antvGLite.tapableMod.AsyncSeriesWaterfallHook[T, AdditionalOptions] {
    def this(args: js.Array[Any]) = this()
    def this(args: js.Array[Any], name: Any) = this()
    def this(args: Unit, name: Any) = this()
  }
  ...
  open class SyncHook[T, R, AdditionalOptions] ()
    extends typings.antvGLite.tapableMod.SyncHook[T, R, AdditionalOptions] {
    def this(args: js.Array[Any]) = this()
    def this(args: js.Array[Any], name: Any) = this()
    def this(args: Unit, name: Any) = this()
  }
  ...
  open class SyncWaterfallHook[T, AdditionalOptions] ()
    extends typings.antvGLite.tapableMod.SyncWaterfallHook[T, AdditionalOptions] {
    def this(args: js.Array[Any]) = this()
    def this(args: js.Array[Any], name: Any) = this()
    def this(args: Unit, name: Any) = this()
  }
