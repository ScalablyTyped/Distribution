...
import typings.antvGLite.cssnumericvalueMod.BaseType
...
object cssomMod {
  ...
  object BaseType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.cssnumericvalueMod.BaseType & Double] = js.native
    
    /* 1 */ val kAngle: typings.antvGLite.cssnumericvalueMod.BaseType.kAngle & Double = js.native
    
    /* 5 */ val kFlex: typings.antvGLite.cssnumericvalueMod.BaseType.kFlex & Double = js.native
    
    /* 3 */ val kFrequency: typings.antvGLite.cssnumericvalueMod.BaseType.kFrequency & Double = js.native
    
    /* 0 */ val kLength: typings.antvGLite.cssnumericvalueMod.BaseType.kLength & Double = js.native
    
    /* 7 */ val kNumBaseTypes: typings.antvGLite.cssnumericvalueMod.BaseType.kNumBaseTypes & Double = js.native
    
    /* 6 */ val kPercent: typings.antvGLite.cssnumericvalueMod.BaseType.kPercent & Double = js.native
    
    /* 4 */ val kResolution: typings.antvGLite.cssnumericvalueMod.BaseType.kResolution & Double = js.native
    
    /* 2 */ val kTime: typings.antvGLite.cssnumericvalueMod.BaseType.kTime & Double = js.native
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSColorValue")
  @js.native
  abstract class CSSColorValue protected ()
    extends typings.antvGLite.csscolorvalueMod.CSSColorValue {
  ...
  open class CSSGradientValue protected ()
    extends typings.antvGLite.cssgradientvalueMod.CSSGradientValue {
  ...
  open class CSSKeywordValue protected ()
    extends typings.antvGLite.csskeywordvalueMod.CSSKeywordValue {
  ...
  open class CSSMathInvert protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathInvert {
    def this(
      value: typings.antvGLite.cssnumericvalueMod.CSSNumericValue,
  ...
  object CSSMathInvert {
    ...
    inline def create(value: typings.antvGLite.cssnumericvalueMod.CSSNumericValue): typings.antvGLite.cssnumericvalueMod.CSSMathInvert = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(value.asInstanceOf[js.Any]).asInstanceOf[typings.antvGLite.cssnumericvalueMod.CSSMathInvert]
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathMax")
  @js.native
  open class CSSMathMax protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathMax {
    def this(
  ...
  object CSSMathMax {
    ...
    inline def create(values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue]): typings.antvGLite.cssnumericvalueMod.CSSMathMax = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(values.asInstanceOf[js.Any]).asInstanceOf[typings.antvGLite.cssnumericvalueMod.CSSMathMax]
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathMin")
  @js.native
  open class CSSMathMin protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathMin {
    def this(
      values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue],
      `type`: typings.antvGLite.cssnumericvalueMod.CSSNumericValueType
    ) = this()
  ...
  object CSSMathMin {
    ...
    inline def create(values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue]): typings.antvGLite.cssnumericvalueMod.CSSMathMin = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(values.asInstanceOf[js.Any]).asInstanceOf[typings.antvGLite.cssnumericvalueMod.CSSMathMin]
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathNegate")
  @js.native
  open class CSSMathNegate protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathNegate {
    def this(
      value: typings.antvGLite.cssnumericvalueMod.CSSNumericValue,
      `type`: typings.antvGLite.cssnumericvalueMod.CSSNumericValueType
    ) = this()
  ...
  object CSSMathNegate {
    ...
    inline def create(value: typings.antvGLite.cssnumericvalueMod.CSSNumericValue): typings.antvGLite.cssnumericvalueMod.CSSMathNegate = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(value.asInstanceOf[js.Any]).asInstanceOf[typings.antvGLite.cssnumericvalueMod.CSSMathNegate]
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathProduct")
  @js.native
  open class CSSMathProduct protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathProduct {
    def this(
      values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue],
      `type`: typings.antvGLite.cssnumericvalueMod.CSSNumericValueType
    ) = this()
  ...
  open class CSSMathSum protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathSum {
    def this(
      values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue],
      `type`: typings.antvGLite.cssnumericvalueMod.CSSNumericValueType
    ) = this()
  ...
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathValue")
  @js.native
  abstract class CSSMathValue protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathValue {
    /**
  ...
  @JSImport("@antv/g-lite/dist/css/cssom", "CSSMathVariadic")
  @js.native
  abstract class CSSMathVariadic protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSMathVariadic {
    def this(
      values: js.Array[typings.antvGLite.cssnumericvalueMod.CSSNumericValue],
      `type`: typings.antvGLite.cssnumericvalueMod.CSSNumericValueType
    ) = this()
  ...
  abstract class CSSNumericValue protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSNumericValue {
    /**
      * @see https://chromium.googlesource.com/chromium/src/+/refs/heads/main/third_party/blink/renderer/core/css/cssom/css_numeric_value.cc#296
      */
    def this(type_ : typings.antvGLite.cssnumericvalueMod.CSSNumericValueType) = this()
  ...
  open class CSSNumericValueType ()
    extends typings.antvGLite.cssnumericvalueMod.CSSNumericValueType {
  ...
  open class CSSRGB protected ()
    extends typings.antvGLite.cssrgbMod.CSSRGB {
  ...
  abstract class CSSStyleValue ()
    extends typings.antvGLite.cssstylevalueMod.CSSStyleValue
  /* static members */
  ...
  object CSSStyleValueType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.cssstylevalueMod.CSSStyleValueType & Double] = js.native
  ...
  open class CSSUnitValue protected ()
    extends typings.antvGLite.cssnumericvalueMod.CSSUnitValue {
  ...
  object Nested extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.typesMod.Nested & Double] = js.native
    
    /* 1 */ val kNo: typings.antvGLite.typesMod.Nested.kNo & Double = js.native
    
    /* 0 */ val kYes: typings.antvGLite.typesMod.Nested.kYes & Double = js.native
  }
  
  @JSImport("@antv/g-lite/dist/css/cssom", "Odeg")
  @js.native
  val Odeg: typings.antvGLite.cssnumericvalueMod.CSSUnitValue = js.native
  
  @JSImport("@antv/g-lite/dist/css/cssom", "Opx")
  @js.native
  val Opx: typings.antvGLite.cssnumericvalueMod.CSSUnitValue = js.native
  ...
  object ParenLess extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.typesMod.ParenLess & Double] = js.native
    
    /* 1 */ val kNo: typings.antvGLite.typesMod.ParenLess.kNo & Double = js.native
    
    /* 0 */ val kYes: typings.antvGLite.typesMod.ParenLess.kYes & Double = js.native
  }
  ...
  object UnitCategory extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.typesMod.UnitCategory & Double] = js.native
    
    /* 3 */ val kUAngle: typings.antvGLite.typesMod.UnitCategory.kUAngle & Double = js.native
    
    /* 2 */ val kULength: typings.antvGLite.typesMod.UnitCategory.kULength & Double = js.native
    
    /* 0 */ val kUNumber: typings.antvGLite.typesMod.UnitCategory.kUNumber & Double = js.native
    
    /* 5 */ val kUOther: typings.antvGLite.typesMod.UnitCategory.kUOther & Double = js.native
    
    /* 1 */ val kUPercent: typings.antvGLite.typesMod.UnitCategory.kUPercent & Double = js.native
    
    /* 4 */ val kUTime: typings.antvGLite.typesMod.UnitCategory.kUTime & Double = js.native
  }
  ...
  object ValueRange extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typings.antvGLite.typesMod.ValueRange & Double] = js.native
    
    /* 0 */ val kAll: typings.antvGLite.typesMod.ValueRange.kAll & Double = js.native
    
    /* 2 */ val kInteger: typings.antvGLite.typesMod.ValueRange.kInteger & Double = js.native
    
    /* 1 */ val kNonNegative: typings.antvGLite.typesMod.ValueRange.kNonNegative & Double = js.native
    
    /* 3 */ val kNonNegativeInteger: typings.antvGLite.typesMod.ValueRange.kNonNegativeInteger & Double = js.native
    
    /* 4 */ val kPositiveInteger: typings.antvGLite.typesMod.ValueRange.kPositiveInteger & Double = js.native
  }
