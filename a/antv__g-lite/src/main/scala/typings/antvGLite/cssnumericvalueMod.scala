...
object cssnumericvalueMod {
  ...
  @JSImport("@antv/g-lite/dist/css/cssom/CSSNumericValue", "CSSMathValue")
  @js.native
  abstract class CSSMathValue protected () extends CSSNumericValue {
    /**
  ...
  @JSImport("@antv/g-lite/dist/css/cssom/CSSNumericValue", "CSSMathVariadic")
  @js.native
  abstract class CSSMathVariadic protected () extends CSSMathValue {
    def this(values: js.Array[CSSNumericValue], `type`: CSSNumericValueType) = this()
  ...
  @js.native
  abstract class CSSNumericValue protected () extends CSSStyleValue {
    /**
      * @see https://chromium.googlesource.com/chromium/src/+/refs/heads/main/third_party/blink/renderer/core/css/cssom/css_numeric_value.cc#296
      */
    def this(type_ : CSSNumericValueType) = this()
