...
import typings.antvGLite.domInterfacesMod.IAnimation
import typings.antvGLite.domMod.Element
...
object displayObjectMod {
  ...
  open class DisplayObject[StyleProps /* <: BaseStyleProps */, ParsedStyleProps /* <: ParsedBaseStyleProps */] protected () extends Element[StyleProps, ParsedStyleProps] {
    ...
    def attr[Key /* <: /* keyof StyleProps */ String */](name: Key): /* import warning: importer.ImportType#apply Failed type conversion: StyleProps[Key] */ js.Any = js.native
