...
object customElementMod {
  
  @JSImport("@antv/g-lite/dist/display-objects/CustomElement", "CustomElement")
  @js.native
  abstract class CustomElement[CustomElementStyleProps] () extends DisplayObject[CustomElementStyleProps & BaseCustomElementStyleProps, Any] {
