...
import typings.antvGLite.antvGLiteStrings.`repeating-linear-gradient`
...
object RepeatingLinearGradientNode {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RepeatingLinearGradientNode] (val x: Self) extends AnyVal {
