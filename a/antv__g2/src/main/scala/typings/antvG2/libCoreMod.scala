...
object libCoreMod {
  ...
  open class Coordinate ()
    extends typings.antvG2.libDependentsMod.Coordinate {
  ...
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typings.antvG2.libFacetMod.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typings.antvG2.libGeometryBaseMod.default[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  open class GeometryLabel protected ()
    ...
    def this(geometry: typings.antvG2.libGeometryBaseMod.default[ShapePoint]) = this()
  }
  ...
  open class InteractionAction[T] protected ()
    extends typings.antvG2.libInteractionActionBaseMod.default[T] {
  ...
  open class TooltipController ()
    extends typings.antvG2.libChartControllerTooltipMod.default
  ...
  object Util {
    ...
    def getLegendItems: js.Function5[
        /* view */ View, 
        /* geometry */ typings.antvG2.libGeometryBaseMod.default[ShapePoint], 
        /* attr */ Attribute, 
    ...
    inline def getTooltipItems(data: MappingDatum, geometry: typings.antvG2.libGeometryBaseMod.default[ShapePoint]): js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("getTooltipItems")(data.asInstanceOf[js.Any], geometry.asInstanceOf[js.Any])).asInstanceOf[js.Array[Any]]
