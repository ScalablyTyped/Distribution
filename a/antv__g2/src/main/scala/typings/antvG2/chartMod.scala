...
import typings.antvG2.chartChartMod.default
...
object chartMod {
  ...
  open class Event protected ()
    extends typings.antvG2.eventMod.default {
    def this(view: typings.antvG2.viewMod.View, gEvent: typings.antvG2.dependentsMod.Event) = this()
    def this(view: typings.antvG2.viewMod.View, gEvent: typings.antvG2.dependentsMod.Event, data: Datum) = this()
  }
  /* static members */
  object Event {
    ...
    /**
      ...
      * @param data
      */
    inline def fromData(view: typings.antvG2.viewMod.View, `type`: String, data: Datum): typings.antvG2.eventMod.Event = (^.asInstanceOf[js.Dynamic].applyDynamic("fromData")(view.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[typings.antvG2.eventMod.Event]
  }
