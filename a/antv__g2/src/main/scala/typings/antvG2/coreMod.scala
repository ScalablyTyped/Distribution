...
object coreMod {
  ...
  @JSImport("@antv/g2/lib/core", "ComponentController")
  @js.native
  abstract class ComponentController[O] protected () extends Controller[O] {
  ...
  open class Coordinate ()
    extends typings.antvG2.dependentsMod.Coordinate {
  ...
  @JSImport("@antv/g2/lib/core", "Facet")
  @js.native
  abstract class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typings.antvG2.facetMod.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typings.antvG2.geometryBaseMod.default[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  /**
    * Action 的基类
    */
  @JSImport("@antv/g2/lib/core", "InteractionAction")
  @js.native
  abstract class InteractionAction[T] protected ()
    extends typings.antvG2.actionBaseMod.default[T] {
  ...
  open class TooltipController ()
    extends typings.antvG2.tooltipMod.default
  ...
  object Util {
    ...
    def getLegendItems: js.Function5[
        /* view */ View, 
        /* geometry */ typings.antvG2.geometryBaseMod.default[ShapePoint], 
        /* attr */ Attribute, 
    ...
    inline def getTooltipItems(data: MappingDatum, geometry: typings.antvG2.geometryBaseMod.default[ShapePoint]): js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("getTooltipItems")(data.asInstanceOf[js.Any], geometry.asInstanceOf[js.Any])).asInstanceOf[js.Array[Any]]
