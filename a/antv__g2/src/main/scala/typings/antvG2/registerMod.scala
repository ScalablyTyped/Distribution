...
object registerMod {
  ...
  inline def createCallbackAction(callback: ActionCallback, context: IInteractionContext): typings.antvG2.callbackMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("createCallbackAction")(callback.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[typings.antvG2.callbackMod.default]
