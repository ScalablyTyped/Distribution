...
object highlightMod {
  ...
  trait ElementHighlight
    ...
    /* protected */ def setElementHighlight(el: typings.antvG2.elementMod.default, callback: Callback): Unit = js.native
    
    /* protected */ def setHighlightBy(elements: js.Array[typings.antvG2.elementMod.default], callback: Callback, enable: Boolean): Unit = js.native
  }
}
