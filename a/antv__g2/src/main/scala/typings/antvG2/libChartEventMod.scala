...
object libChartEventMod {
  ...
  open class default protected ()
    extends StObject
       with Event {
    def this(view: View, gEvent: typings.antvG2.libDependentsMod.Event) = this()
    def this(view: View, gEvent: typings.antvG2.libDependentsMod.Event, data: Datum) = this()
  }
  /* static members */
  object default {
  ...
  trait Event extends StObject {
    ...
    /** 被包装的原生 G 事件 */
    var gEvent: typings.antvG2.libDependentsMod.Event = js.native
