...
object bboxMod {
  ...
  object BBox {
    ...
    inline def fromObject(bbox: typings.antvGBase.typesMod.BBox): BBox = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(bbox.asInstanceOf[js.Any]).asInstanceOf[BBox]
