...
object stateBaseMod {
  ...
  /**
    ...
    * @ignore
    */
  @JSImport("@antv/g2/lib/interaction/action/element/state-base", JSImport.Default)
  @js.native
  abstract class default () extends StateBase
  ...
  trait StateBase
    ...
    /**
      ...
      */
    /* protected */ def hasState(element: typings.antvG2.elementMod.default): Boolean = js.native
    
    /**
      * 设置状态激活
      * @param enable 状态值
      */
    /* protected */ def setElementState(element: typings.antvG2.elementMod.default, enable: Boolean): Unit = js.native
