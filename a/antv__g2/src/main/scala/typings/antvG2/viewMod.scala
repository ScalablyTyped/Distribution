...
import typings.antvG2.interactionMod.Interaction
import typings.antvG2.layoutMod.Layout
...
object viewMod {
  ...
  open class View protected ()
    ...
    /**
      ...
      * @returns [[Annotation]]
      */
    def annotation(): typings.antvG2.annotationMod.default = js.native
    ...
    /**
      ...
      */
    def coord(`type`: String): typings.antvG2.coordinateMod.default = js.native
    def coord(`type`: String, coordinateCfg: CoordinateCfg): typings.antvG2.coordinateMod.default = js.native
    def coord(`type`: CoordinateOption): typings.antvG2.coordinateMod.default = js.native
    def coord(`type`: CoordinateOption, coordinateCfg: CoordinateCfg): typings.antvG2.coordinateMod.default = js.native
    ...
    /**
      ...
      * @returns
      */
    def coordinate(): typings.antvG2.coordinateMod.default = js.native
    def coordinate(option: CoordinateOption): typings.antvG2.coordinateMod.default = js.native
    /**
      * 声明坐标系类型，并进行配置。
      *
      * ```ts
      ...
      * @returns
      */
    def coordinate(`type`: String): typings.antvG2.coordinateMod.default = js.native
    def coordinate(`type`: String, coordinateCfg: CoordinateCfg): typings.antvG2.coordinateMod.default = js.native
    
    /** 坐标系的位置大小，ViewBBox - padding = coordinateBBox。 */
    var coordinateBBox: BBox = js.native
    
    /** Coordinate 相关的控制器类，负责坐标系实例的创建、更新、变换等 */
    /* protected */ var coordinateController: typings.antvG2.coordinateMod.default = js.native
    ...
    /** 所有的 geometry 实例。 */
    var geometries: js.Array[typings.antvG2.geometryBaseMod.default[ShapePoint]] = js.native
    ...
    def getController_annotation(name: annotation): typings.antvG2.annotationMod.default = js.native
    @JSName("getController")
    def getController_axis(name: axis): typings.antvG2.axisMod.default = js.native
    @JSName("getController")
    def getController_gestucre(name: gestucre): typings.antvG2.gestureMod.default = js.native
    @JSName("getController")
    def getController_legend(name: legend): typings.antvG2.legendMod.default = js.native
    @JSName("getController")
    def getController_scrollbar(name: scrollbar): typings.antvG2.scrollbarMod.default = js.native
    @JSName("getController")
    def getController_slider(name: slider): typings.antvG2.sliderMod.default = js.native
    @JSName("getController")
    def getController_tooltip(name: tooltip): typings.antvG2.tooltipMod.default = js.native
    ...
    /**
      * 获取 view 中的所有 geome
      */
    def getElements(): js.Array[typings.antvG2.elementMod.default] = js.native
    ...
    /**
      ...
      * @returns
      */
    def getElementsBy(condition: js.Function1[/* element */ typings.antvG2.elementMod.default, Boolean]): js.Array[typings.antvG2.elementMod.default] = js.native
    
    /**
      * 获取当前 view 有的 geometries
      * @returns
      */
    def getGeometries(): js.Array[typings.antvG2.geometryBaseMod.default[ShapePoint]] = js.native
    ...
    /**
      ...
      */
    def guide(): typings.antvG2.annotationMod.default = js.native
