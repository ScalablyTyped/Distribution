...
object libGeometryHeatmapMod {
  ...
  trait Heatmap
    ...
    def color(field: AttributeOption, cfg: String): typings.antvG2.libGeometryBaseMod.default[ShapePoint] = js.native
    def color(field: AttributeOption, cfg: js.Array[String]): typings.antvG2.libGeometryBaseMod.default[ShapePoint] = js.native
    def color(field: AttributeOption, cfg: ColorAttrCallback): typings.antvG2.libGeometryBaseMod.default[ShapePoint] = js.native
