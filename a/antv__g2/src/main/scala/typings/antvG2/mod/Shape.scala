...
object Shape {
  ...
  extension [Self <: Shape](x: Self) {
    ...
    inline def setGetLinearValue(value: /* percent */ js.Any => js.Any): Self = StObject.set(x, "getLinearValue", js.Any.fromFunction1(value))
    
    inline def setGetLinearValueUndefined: Self = StObject.set(x, "getLinearValue", js.undefined)
    
    inline def setRegisterShape(
    ...
    inline def setRegisterShapeUndefined: Self = StObject.set(x, "registerShape", js.undefined)
  }
}
