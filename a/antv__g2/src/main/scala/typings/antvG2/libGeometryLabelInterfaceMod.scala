...
object libGeometryLabelInterfaceMod {
  ...
  - typings.antvG2.libGeometryLabelInterfaceMod.LabelPointCfg because var conflicts: content, rotate. Inlined x, y, start, color, textAlign, textBaseline, angle, r */ trait LabelItem
    extends StObject
       with LabelCfg {
