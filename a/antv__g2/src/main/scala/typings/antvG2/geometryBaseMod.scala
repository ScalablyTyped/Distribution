...
object geometryBaseMod {
  ...
  trait Geometry[S /* <: ShapePoint */]
    ...
    /**
      ...
      */
    /* protected */ def createElement(mappingDatum: MappingDatum, index: Double): typings.antvG2.elementMod.default = js.native
    /* protected */ def createElement(mappingDatum: MappingDatum, index: Double, isUpdate: Boolean): typings.antvG2.elementMod.default = js.native
    ...
    /** Element map */
    var elements: js.Array[typings.antvG2.elementMod.default] = js.native
    
    /** 使用 key-value 结构存储 Element，key 为每个 Element 实例对应的唯一 ID */
    var elementsMap: Record[String, typings.antvG2.elementMod.default] = js.native
    ...
    /* protected */ var lastElementsMap: Record[String, typings.antvG2.elementMod.default] = js.native
