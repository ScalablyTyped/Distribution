...
import typings.atAntvG2.atAntvG2Strings.polygon
...
trait AxisGrid extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[typings.atAntvG2.atAntvG2Strings.line | polygon] = js.undefined
}
...
object AxisGrid {
  ...
  def apply(
    ...
    lineStyle: line = null,
    `type`: typings.atAntvG2.atAntvG2Strings.line | polygon = null
  ): AxisGrid = {
