...
package object mod {
  type CheckLocale = org.scalablytyped.runtime.StringDictionary[typings.axeCore.AnonFail]
  type ElementContext = typings.std.Node | java.lang.String | typings.axeCore.mod.ContextObject
  type RuleLocale = org.scalablytyped.runtime.StringDictionary[typings.axeCore.AnonDescription]
