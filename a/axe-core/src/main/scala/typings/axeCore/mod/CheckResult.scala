...
object CheckResult {
  ...
  inline def apply(data: Any, id: String, impact: String, message: String): CheckResult = {
  ...
  extension [Self <: CheckResult](x: Self) {
    ...
    inline def setRelatedNodesVarargs(value: RelatedNode*): Self = StObject.set(x, "relatedNodes", js.Array(value*))
  }
}
