...
trait ITrace extends js.Object {
  ...
  var cachePolicy: js.UndefOr[
    apolloDashEngineDashReportingDashProtobufLib.apolloDashEngineDashReportingDashProtobufMod.TraceNs.ICachePolicy | scala.Null
  ] = js.undefined
  /** Trace clientAddress */
  ...
  var details: js.UndefOr[
    apolloDashEngineDashReportingDashProtobufLib.apolloDashEngineDashReportingDashProtobufMod.TraceNs.IDetails | scala.Null
  ] = js.undefined
  /** Trace durationNs */
  ...
  /** Trace http */
  var http: js.UndefOr[
    apolloDashEngineDashReportingDashProtobufLib.apolloDashEngineDashReportingDashProtobufMod.TraceNs.IHTTP | scala.Null
  ] = js.undefined
  ...
  /** Trace root */
  var root: js.UndefOr[
    apolloDashEngineDashReportingDashProtobufLib.apolloDashEngineDashReportingDashProtobufMod.TraceNs.INode | scala.Null
  ] = js.undefined
  /** Trace signature */
