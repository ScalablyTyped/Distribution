...
@js.native
class FieldStat ()
  extends apolloDashEngineDashReportingDashProtobufLib.distProtobufMod.FieldStat {
  /**
       * Constructs a new FieldStat.
       * @param [properties] Properties to set
       */
  def this(properties: apolloDashEngineDashReportingDashProtobufLib.distProtobufMod.IFieldStat) = this()
}
...
object FieldStat extends js.Object {
  ...
  /**
       ...
       * @returns FieldStat
       */
  def fromObject(`object`: ScalablyTyped.runtime.StringDictionary[js.Any]): apolloDashEngineDashReportingDashProtobufLib.distProtobufMod.FieldStat = js.native
  /**
       ...
       */
  def toObject(message: apolloDashEngineDashReportingDashProtobufLib.distProtobufMod.FieldStat): ScalablyTyped.runtime.StringDictionary[js.Any] = js.native
  /**
       * Creates a plain object from a FieldStat message. Also converts values to other types if specified.
       * @param message FieldStat
       * @param [options] Conversion options
