...
import typings.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.index
import typings.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.responseName
