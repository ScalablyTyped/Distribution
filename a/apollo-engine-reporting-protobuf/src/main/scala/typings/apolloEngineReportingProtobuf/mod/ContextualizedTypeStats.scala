...
import typings.apolloEngineReportingProtobuf.protobufMod.IContextualizedTypeStats
...
class ContextualizedTypeStats ()
  extends typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats {
...
object ContextualizedTypeStats extends js.Object {
  /**
    ...
    */
  def create(): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def create(properties: IContextualizedTypeStats): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Reader, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decodeDelimited(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedTypeStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def toObject(message: typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats,
