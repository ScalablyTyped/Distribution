...
import typings.apolloEngineReportingProtobuf.protobufMod.IQueryLatencyStats
...
class QueryLatencyStats ()
  extends typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats {
...
object QueryLatencyStats extends js.Object {
  /**
    ...
    */
  def create(): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def create(properties: IQueryLatencyStats): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Reader, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decodeDelimited(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    * @returns QueryLatencyStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    */
  def toObject(message: typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats,
