...
import typings.apolloEngineReportingProtobuf.protobufMod.IContextualizedQueryLatencyStats
...
class ContextualizedQueryLatencyStats ()
  extends typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats {
...
object ContextualizedQueryLatencyStats extends js.Object {
  /**
    ...
    */
  def create(): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def create(properties: IContextualizedQueryLatencyStats): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Reader, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decodeDelimited(reader: Uint8Array): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedQueryLatencyStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def toObject(message: typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats,
