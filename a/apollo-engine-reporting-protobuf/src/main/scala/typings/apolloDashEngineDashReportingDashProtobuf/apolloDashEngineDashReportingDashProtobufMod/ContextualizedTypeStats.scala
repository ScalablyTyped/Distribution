...
import typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.IContextualizedTypeStats
...
class ContextualizedTypeStats ()
  extends typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats {
...
object ContextualizedTypeStats extends js.Object {
  /**
    ...
    */
  def create(): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def create(properties: IContextualizedTypeStats): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Reader, length: Double): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array, length: Double): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  def decodeDelimited(reader: Uint8Array): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedTypeStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def toObject(message: typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typings.apolloDashEngineDashReportingDashProtobuf.distProtobufMod.ContextualizedTypeStats,
