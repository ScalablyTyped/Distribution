...
import typings.auth0DashLock.auth0DashLockStrings.authenticated
import typings.auth0DashLock.auth0DashLockStrings.authorization_error
import typings.auth0DashLock.auth0DashLockStrings.hide
import typings.auth0DashLock.auth0DashLockStrings.show
import typings.auth0DashLock.auth0DashLockStrings.unrecoverable_error
