...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.auth0Lock.Auth0LockAdditionalHiddenSignUpField
*/
...
object Auth0LockAdditionalSignUpField {
  ...
  inline def Auth0LockAdditionalHiddenSignUpField(name: String, value: String): typings.auth0Lock.Auth0LockAdditionalHiddenSignUpField = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.auth0Lock.Auth0LockAdditionalHiddenSignUpField]
  }
