...
trait tmhDynamicLocaleProvider
  ...
  def storageKey(storageKey: java.lang.String): scala.Unit = js.native
  def useCookieStorage(): scala.Unit = js.native
  def useStorage(storageName: java.lang.String): scala.Unit = js.native
}
