...
object IDropdownProvider {
  ...
  @scala.inline
  implicit class IDropdownProviderOps[Self <: IDropdownProvider] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setDefaults(value: IDropdownOptions): Self = this.set("defaults", value.asInstanceOf[js.Any])
  }
