...
class Chart protected () extends js.Object {
  ...
  val BackWall: typings.activexDashPowerpoint.PowerPointNs.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typings.activexDashPowerpoint.PowerPointNs.ChartArea = js.native
  val ChartData: typings.activexDashPowerpoint.PowerPointNs.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typings.activexDashPowerpoint.PowerPointNs.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typings.activexDashPowerpoint.PowerPointNs.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typings.activexDashPowerpoint.PowerPointNs.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typings.activexDashPowerpoint.PowerPointNs.Floor = js.native
  ...
  val Legend: typings.activexDashPowerpoint.PowerPointNs.Legend = js.native
  val Line3DGroup: ChartGroup = js.native
  var Name: String = js.native
  val Parent: js.Any = js.native
  var Perspective: Double = js.native
  val Pie3DGroup: ChartGroup = js.native
  val PlotArea: typings.activexDashPowerpoint.PowerPointNs.PlotArea = js.native
  ...
  val SideWall: typings.activexDashPowerpoint.PowerPointNs.Walls = js.native
  var Subtype: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Title: String = js.native
  var Type: Double = js.native
  val Walls: typings.activexDashPowerpoint.PowerPointNs.Walls = js.native
