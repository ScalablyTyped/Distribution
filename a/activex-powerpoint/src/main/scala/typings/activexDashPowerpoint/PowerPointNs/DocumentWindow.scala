...
class DocumentWindow protected () extends js.Object {
  ...
  val Panes: typings.activexDashPowerpoint.PowerPointNs.Panes = js.native
  ...
  val Selection: typings.activexDashPowerpoint.PowerPointNs.Selection = js.native
  var SplitHorizontal: Double = js.native
  var SplitVertical: Double = js.native
  var Top: Double = js.native
  val View: typings.activexDashPowerpoint.PowerPointNs.View = js.native
