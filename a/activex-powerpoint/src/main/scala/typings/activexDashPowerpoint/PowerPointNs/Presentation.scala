...
class Presentation protected () extends js.Object {
  ...
  val Broadcast: typings.activexDashPowerpoint.PowerPointNs.Broadcast = js.native
  val BuiltInDocumentProperties: js.Any = js.native
  val Coauthoring: typings.activexDashPowerpoint.PowerPointNs.Coauthoring = js.native
  val ColorSchemes: typings.activexDashPowerpoint.PowerPointNs.ColorSchemes = js.native
  @JSName("CommandBars")
  ...
  val Designs: typings.activexDashPowerpoint.PowerPointNs.Designs = js.native
  ...
  val ExtraColors: typings.activexDashPowerpoint.PowerPointNs.ExtraColors = js.native
  ...
  val Fonts: typings.activexDashPowerpoint.PowerPointNs.Fonts = js.native
  ...
  val PageSetup: typings.activexDashPowerpoint.PowerPointNs.PageSetup = js.native
  ...
  val PrintOptions: typings.activexDashPowerpoint.PowerPointNs.PrintOptions = js.native
  val PublishObjects: typings.activexDashPowerpoint.PowerPointNs.PublishObjects = js.native
  val ReadOnly: MsoTriState = js.native
  var RemovePersonalInformation: MsoTriState = js.native
  val Research: typings.activexDashPowerpoint.PowerPointNs.Research = js.native
  var Saved: MsoTriState = js.native
  val SectionCount: Double = js.native
  val SectionProperties: typings.activexDashPowerpoint.PowerPointNs.SectionProperties = js.native
  @JSName("ServerPolicy")
  ...
  val SlideShowSettings: typings.activexDashPowerpoint.PowerPointNs.SlideShowSettings = js.native
  val SlideShowWindow: typings.activexDashPowerpoint.PowerPointNs.SlideShowWindow = js.native
  val Slides: typings.activexDashPowerpoint.PowerPointNs.Slides = js.native
  ...
  val WebOptions: typings.activexDashPowerpoint.PowerPointNs.WebOptions = js.native
