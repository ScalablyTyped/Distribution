...
class AnimationSettings protected () extends js.Object {
  ...
  val PlaySettings: typings.activexDashPowerpoint.PowerPointNs.PlaySettings = js.native
  var `PowerPoint.AnimationSettings_typekey`: AnimationSettings = js.native
  val SoundEffect: typings.activexDashPowerpoint.PowerPointNs.SoundEffect = js.native
