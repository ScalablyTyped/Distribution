...
*/
trait PpProtectedViewCloseReason extends js.Object

object PpProtectedViewCloseReason {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def ppProtectedViewCloseEdit: `1` = this.cast(1)
  @scala.inline
  def ppProtectedViewCloseForced: `2` = this.cast(2)
  @scala.inline
  def ppProtectedViewCloseNormal: `0` = this.cast(0)
}
