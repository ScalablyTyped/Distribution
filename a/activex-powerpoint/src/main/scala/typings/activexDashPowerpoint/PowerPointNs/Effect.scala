...
class Effect protected () extends js.Object {
  ...
  val EffectInformation: typings.activexDashPowerpoint.PowerPointNs.EffectInformation = js.native
  val EffectParameters: typings.activexDashPowerpoint.PowerPointNs.EffectParameters = js.native
  ...
  var Shape: typings.activexDashPowerpoint.PowerPointNs.Shape = js.native
  val TextRangeLength: Double = js.native
  val TextRangeStart: Double = js.native
  val Timing: typings.activexDashPowerpoint.PowerPointNs.Timing = js.native
