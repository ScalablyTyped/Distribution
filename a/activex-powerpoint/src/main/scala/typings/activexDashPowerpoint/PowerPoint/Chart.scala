...
class Chart protected () extends js.Object {
  ...
  val BackWall: typings.activexDashPowerpoint.PowerPoint.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typings.activexDashPowerpoint.PowerPoint.ChartArea = js.native
  val ChartData: typings.activexDashPowerpoint.PowerPoint.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typings.activexDashPowerpoint.PowerPoint.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typings.activexDashPowerpoint.PowerPoint.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typings.activexDashPowerpoint.PowerPoint.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typings.activexDashPowerpoint.PowerPoint.Floor = js.native
  ...
  val Legend: typings.activexDashPowerpoint.PowerPoint.Legend = js.native
  ...
  val SideWall: typings.activexDashPowerpoint.PowerPoint.Walls = js.native
  var Subtype: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Title: String = js.native
  var Type: Double = js.native
  val Walls: typings.activexDashPowerpoint.PowerPoint.Walls = js.native
