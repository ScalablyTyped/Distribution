...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typings.activexDashPowerpoint.PowerPoint.DownBars = js.native
  val DropLines: typings.activexDashPowerpoint.PowerPoint.DropLines = js.native
  ...
  val HiLoLines: typings.activexDashPowerpoint.PowerPoint.HiLoLines = js.native
  ...
  val UpBars: typings.activexDashPowerpoint.PowerPoint.UpBars = js.native
