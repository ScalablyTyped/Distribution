...
class Presentation protected () extends js.Object {
  ...
  val Broadcast: typings.activexDashPowerpoint.PowerPoint.Broadcast = js.native
  val BuiltInDocumentProperties: js.Any = js.native
  val Coauthoring: typings.activexDashPowerpoint.PowerPoint.Coauthoring = js.native
  val ColorSchemes: typings.activexDashPowerpoint.PowerPoint.ColorSchemes = js.native
  @JSName("CommandBars")
  ...
  val Designs: typings.activexDashPowerpoint.PowerPoint.Designs = js.native
  ...
  val ExtraColors: typings.activexDashPowerpoint.PowerPoint.ExtraColors = js.native
  ...
  val Fonts: typings.activexDashPowerpoint.PowerPoint.Fonts = js.native
  ...
  val PageSetup: typings.activexDashPowerpoint.PowerPoint.PageSetup = js.native
  ...
  val Research: typings.activexDashPowerpoint.PowerPoint.Research = js.native
  var Saved: MsoTriState = js.native
  val SectionCount: Double = js.native
  val SectionProperties: typings.activexDashPowerpoint.PowerPoint.SectionProperties = js.native
  @JSName("ServerPolicy")
  ...
  val SlideShowSettings: typings.activexDashPowerpoint.PowerPoint.SlideShowSettings = js.native
  val SlideShowWindow: typings.activexDashPowerpoint.PowerPoint.SlideShowWindow = js.native
  val Slides: typings.activexDashPowerpoint.PowerPoint.Slides = js.native
  ...
  val WebOptions: typings.activexDashPowerpoint.PowerPoint.WebOptions = js.native
