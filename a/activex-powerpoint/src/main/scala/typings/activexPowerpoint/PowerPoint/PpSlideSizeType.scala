...
*/
trait PpSlideSizeType extends StObject
object PpSlideSizeType {
  
  inline def ppSlideSize35MM: `4` = 4.asInstanceOf[`4`]
  
  inline def ppSlideSizeA3Paper: `9` = 9.asInstanceOf[`9`]
  
  inline def ppSlideSizeA4Paper: `3` = 3.asInstanceOf[`3`]
  
  inline def ppSlideSizeB4ISOPaper: `10` = 10.asInstanceOf[`10`]
  
  inline def ppSlideSizeB4JISPaper: `12` = 12.asInstanceOf[`12`]
  
  inline def ppSlideSizeB5ISOPaper: `11` = 11.asInstanceOf[`11`]
  
  inline def ppSlideSizeB5JISPaper: `13` = 13.asInstanceOf[`13`]
  
  inline def ppSlideSizeBanner: `6` = 6.asInstanceOf[`6`]
  
  inline def ppSlideSizeCustom: `7` = 7.asInstanceOf[`7`]
  
  inline def ppSlideSizeHagakiCard: `14` = 14.asInstanceOf[`14`]
  
  inline def ppSlideSizeLedgerPaper: `8` = 8.asInstanceOf[`8`]
  
  inline def ppSlideSizeLetterPaper: `2` = 2.asInstanceOf[`2`]
  
  inline def ppSlideSizeOnScreen: `1` = 1.asInstanceOf[`1`]
  
  inline def ppSlideSizeOnScreen16x10: `16` = 16.asInstanceOf[`16`]
  
  inline def ppSlideSizeOnScreen16x9: `15` = 15.asInstanceOf[`15`]
  
  inline def ppSlideSizeOverhead: `5` = 5.asInstanceOf[`5`]
}
