...
*/
trait PpTextLevelEffect extends StObject
object PpTextLevelEffect {
  
  inline def ppAnimateByAllLevels: `16` = 16.asInstanceOf[`16`]
  
  inline def ppAnimateByFifthLevel: `5` = 5.asInstanceOf[`5`]
  
  inline def ppAnimateByFirstLevel: `1` = 1.asInstanceOf[`1`]
  
  inline def ppAnimateByFourthLevel: `4` = 4.asInstanceOf[`4`]
  
  inline def ppAnimateBySecondLevel: `2` = 2.asInstanceOf[`2`]
  
  inline def ppAnimateByThirdLevel: `3` = 3.asInstanceOf[`3`]
  
  inline def ppAnimateLevelMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def ppAnimateLevelNone: `0` = 0.asInstanceOf[`0`]
}
