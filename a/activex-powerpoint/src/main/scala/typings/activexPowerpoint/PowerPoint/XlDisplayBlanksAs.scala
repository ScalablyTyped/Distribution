...
*/
trait XlDisplayBlanksAs extends StObject
object XlDisplayBlanksAs {
  
  inline def xlInterpolated: `3` = 3.asInstanceOf[`3`]
  
  inline def xlNotPlotted: `1` = 1.asInstanceOf[`1`]
  
  inline def xlZero: `2` = 2.asInstanceOf[`2`]
}
