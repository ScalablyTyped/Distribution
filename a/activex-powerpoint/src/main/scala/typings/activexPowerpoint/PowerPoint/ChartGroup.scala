...
@JSGlobal("PowerPoint.ChartGroup")
@js.native
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typings.activexPowerpoint.PowerPoint.DownBars = js.native
  val DropLines: typings.activexPowerpoint.PowerPoint.DropLines = js.native
  ...
  val HiLoLines: typings.activexPowerpoint.PowerPoint.HiLoLines = js.native
  ...
  val UpBars: typings.activexPowerpoint.PowerPoint.UpBars = js.native
