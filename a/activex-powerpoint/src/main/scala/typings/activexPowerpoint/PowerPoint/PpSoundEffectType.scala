...
object PpSoundEffectType {
  ...
  inline def ppSoundEffectsMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def ppSoundFile: `2` = 2.asInstanceOf[`2`]
  
  inline def ppSoundNone: `0` = 0.asInstanceOf[`0`]
  
  inline def ppSoundStopPrevious: `1` = 1.asInstanceOf[`1`]
}
