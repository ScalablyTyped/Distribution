...
object XlPieSliceIndex {
  ...
  inline def xlCenterPoint: `5` = 5.asInstanceOf[`5`]
  
  inline def xlInnerCenterPoint: `8` = 8.asInstanceOf[`8`]
  
  inline def xlInnerClockwisePoint: `7` = 7.asInstanceOf[`7`]
  
  inline def xlInnerCounterClockwisePoint: `9` = 9.asInstanceOf[`9`]
  
  inline def xlMidClockwiseRadiusPoint: `4` = 4.asInstanceOf[`4`]
  
  inline def xlMidCounterClockwiseRadiusPoint: `6` = 6.asInstanceOf[`6`]
  
  inline def xlOuterCenterPoint: `2` = 2.asInstanceOf[`2`]
  
  inline def xlOuterClockwisePoint: `3` = 3.asInstanceOf[`3`]
  
  inline def xlOuterCounterClockwisePoint: `1` = 1.asInstanceOf[`1`]
}
