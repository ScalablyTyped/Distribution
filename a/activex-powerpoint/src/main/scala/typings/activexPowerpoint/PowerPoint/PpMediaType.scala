...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexPowerpoint.activexPowerpointNumbers.`2`
*/
trait PpMediaType extends StObject
object PpMediaType {
  
  inline def ppMediaTypeMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def ppMediaTypeMovie: `3` = 3.asInstanceOf[`3`]
  
  inline def ppMediaTypeOther: `1` = 1.asInstanceOf[`1`]
  
  inline def ppMediaTypeSound: `2` = 2.asInstanceOf[`2`]
}
