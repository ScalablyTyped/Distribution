...
*/
trait PpCheckInVersionType extends StObject
object PpCheckInVersionType {
  
  inline def ppCheckInMajorVersion: `1` = 1.asInstanceOf[`1`]
  
  inline def ppCheckInMinorVersion: `0` = 0.asInstanceOf[`0`]
  
  inline def ppCheckInOverwriteVersion: `2` = 2.asInstanceOf[`2`]
}
