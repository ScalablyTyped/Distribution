...
*/
trait MsoAnimAccumulate extends StObject
object MsoAnimAccumulate {
  
  inline def msoAnimAccumulateAlways: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAnimAccumulateNone: `1` = 1.asInstanceOf[`1`]
}
