...
*/
trait PpFarEastLineBreakLevel extends StObject
object PpFarEastLineBreakLevel {
  
  inline def ppFarEastLineBreakLevelCustom: `3` = 3.asInstanceOf[`3`]
  
  inline def ppFarEastLineBreakLevelNormal: `1` = 1.asInstanceOf[`1`]
  
  inline def ppFarEastLineBreakLevelStrict: `2` = 2.asInstanceOf[`2`]
}
