...
*/
trait PpSelectionType extends js.Object
object PpSelectionType {
  
  @scala.inline
  def ppSelectionNone: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def ppSelectionShapes: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def ppSelectionSlides: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def ppSelectionText: `3` = 3.asInstanceOf[`3`]
}
