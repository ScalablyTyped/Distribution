...
*/
trait PpSelectionType extends StObject
object PpSelectionType {
  
  inline def ppSelectionNone: `0` = 0.asInstanceOf[`0`]
  
  inline def ppSelectionShapes: `2` = 2.asInstanceOf[`2`]
  
  inline def ppSelectionSlides: `1` = 1.asInstanceOf[`1`]
  
  inline def ppSelectionText: `3` = 3.asInstanceOf[`3`]
}
