...
object PpDirection {
  ...
  inline def ppDirectionLeftToRight: `1` = 1.asInstanceOf[`1`]
  
  inline def ppDirectionMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def ppDirectionRightToLeft: `2` = 2.asInstanceOf[`2`]
}
