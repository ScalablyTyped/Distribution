...
*/
trait MsoAnimType extends StObject
object MsoAnimType {
  
  inline def msoAnimTypeColor: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAnimTypeCommand: `6` = 6.asInstanceOf[`6`]
  
  inline def msoAnimTypeFilter: `7` = 7.asInstanceOf[`7`]
  
  inline def msoAnimTypeMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoAnimTypeMotion: `1` = 1.asInstanceOf[`1`]
  
  inline def msoAnimTypeNone: `0` = 0.asInstanceOf[`0`]
  
  inline def msoAnimTypeProperty: `5` = 5.asInstanceOf[`5`]
  
  inline def msoAnimTypeRotation: `4` = 4.asInstanceOf[`4`]
  
  inline def msoAnimTypeScale: `3` = 3.asInstanceOf[`3`]
  
  inline def msoAnimTypeSet: `8` = 8.asInstanceOf[`8`]
}
