...
class DropLines protected ()
  extends typings.activexPowerpoint.PowerPoint.DropLines {
  /* CompleteClass */
  ...
  override var PowerPointDotDropLines_typekey: typings.activexPowerpoint.PowerPoint.DropLines = js.native
  /* CompleteClass */
