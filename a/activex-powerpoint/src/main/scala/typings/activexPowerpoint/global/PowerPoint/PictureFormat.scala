...
class PictureFormat protected ()
  extends typings.activexPowerpoint.PowerPoint.PictureFormat {
  /* CompleteClass */
  ...
  override var PowerPointDotPictureFormat_typekey: typings.activexPowerpoint.PowerPoint.PictureFormat = js.native
  /* CompleteClass */
