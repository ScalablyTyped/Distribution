...
/* private */ class Placeholders ()
  ...
  /* CompleteClass */
  override def FindByName(Index: js.Any): typings.activexPowerpoint.PowerPoint.Shape = js.native
  
  /* CompleteClass */
  override def Item(Index: Double): typings.activexPowerpoint.PowerPoint.Shape = js.native
