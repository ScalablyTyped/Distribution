...
class ThreeDFormat protected ()
  extends typings.activexPowerpoint.PowerPoint.ThreeDFormat {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ContourColor: typings.activexPowerpoint.PowerPoint.ColorFormat = js.native
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ExtrusionColor: typings.activexPowerpoint.PowerPoint.ColorFormat = js.native
  /* CompleteClass */
  ...
  override var PowerPointDotThreeDFormat_typekey: typings.activexPowerpoint.PowerPoint.ThreeDFormat = js.native
  /* CompleteClass */
