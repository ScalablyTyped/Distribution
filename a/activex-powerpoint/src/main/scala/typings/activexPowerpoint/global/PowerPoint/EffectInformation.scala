...
class EffectInformation protected ()
  extends typings.activexPowerpoint.PowerPoint.EffectInformation {
  /* CompleteClass */
  ...
  override var PowerPointDotEffectInformation_typekey: typings.activexPowerpoint.PowerPoint.EffectInformation = js.native
  /* CompleteClass */
