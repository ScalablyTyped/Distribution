...
class Chart protected () extends js.Object {
  ...
  val ChartArea: activexDashPowerpointLib.PowerPointNs.ChartArea = js.native
  val ChartData: activexDashPowerpointLib.PowerPointNs.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: activexDashPowerpointLib.PowerPointNs.ChartTitle = js.native
  var ChartType: activexDashOfficeLib.OfficeNs.XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: activexDashPowerpointLib.PowerPointNs.Corners = js.native
  val Creator: scala.Double = js.native
  val DataTable: activexDashPowerpointLib.PowerPointNs.DataTable = js.native
  ...
  val Floor: activexDashPowerpointLib.PowerPointNs.Floor = js.native
  ...
  val Legend: activexDashPowerpointLib.PowerPointNs.Legend = js.native
  ...
  val PlotArea: activexDashPowerpointLib.PowerPointNs.PlotArea = js.native
  ...
  val Walls: activexDashPowerpointLib.PowerPointNs.Walls = js.native
