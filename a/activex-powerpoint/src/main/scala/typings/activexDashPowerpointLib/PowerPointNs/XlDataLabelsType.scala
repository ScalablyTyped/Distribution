...
@JSGlobal("PowerPoint.XlDataLabelsType")
@js.native
object XlDataLabelsType extends js.Object {
  @js.native
  sealed trait xlDataLabelsShowBubbleSizes
    extends activexDashPowerpointLib.PowerPointNs.XlDataLabelsType
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashPowerpointLib.PowerPointNs.XlDataLabelsType with scala.Double] = js.native
}
