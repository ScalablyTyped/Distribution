...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: activexDashPowerpointLib.PowerPointNs.DownBars = js.native
  val DropLines: activexDashPowerpointLib.PowerPointNs.DropLines = js.native
  ...
  val HiLoLines: activexDashPowerpointLib.PowerPointNs.HiLoLines = js.native
  ...
  val SeriesLines: activexDashPowerpointLib.PowerPointNs.SeriesLines = js.native
  ...
  val UpBars: activexDashPowerpointLib.PowerPointNs.UpBars = js.native
