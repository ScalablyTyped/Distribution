...
class TextFrame2 protected () extends js.Object {
  ...
  var AutoSize: activexDashOfficeLib.OfficeNs.MsoAutoSize = js.native
  val Column: activexDashOfficeLib.OfficeNs.TextColumn2 = js.native
  val Creator: scala.Double = js.native
  val HasText: activexDashOfficeLib.OfficeNs.MsoTriState = js.native
  ...
  val Ruler: activexDashOfficeLib.OfficeNs.Ruler2 = js.native
  val TextRange: activexDashOfficeLib.OfficeNs.TextRange2 = js.native
  ...
  var WordArtFormat: activexDashOfficeLib.OfficeNs.MsoPresetTextEffect = js.native
