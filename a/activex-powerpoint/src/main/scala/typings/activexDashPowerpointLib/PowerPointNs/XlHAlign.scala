...
@JSGlobal("PowerPoint.XlHAlign")
@js.native
object XlHAlign extends js.Object {
  @js.native
  sealed trait xlHAlignCenter
    extends activexDashPowerpointLib.PowerPointNs.XlHAlign
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashPowerpointLib.PowerPointNs.XlHAlign with scala.Double] = js.native
}
