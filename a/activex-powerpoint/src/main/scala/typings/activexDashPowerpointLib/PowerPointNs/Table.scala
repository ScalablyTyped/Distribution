...
class Table protected () extends js.Object {
  ...
  val Columns: activexDashPowerpointLib.PowerPointNs.Columns = js.native
  ...
  val Rows: activexDashPowerpointLib.PowerPointNs.Rows = js.native
  ...
  def Cell(Row: scala.Double, Column: scala.Double): activexDashPowerpointLib.PowerPointNs.Cell = js.native
