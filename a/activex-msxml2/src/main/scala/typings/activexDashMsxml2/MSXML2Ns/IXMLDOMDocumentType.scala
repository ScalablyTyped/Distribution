...
@js.native
class IXMLDOMDocumentType protected () extends js.Object {
  var `MSXML2.IXMLDOMDocumentType_typekey`: IXMLDOMDocumentType = js.native
  ...
  @JSName("entities")
  val entities_Original: IXMLDOMNamedNodeMap = js.native
  ...
  @JSName("notations")
  val notations_Original: IXMLDOMNamedNodeMap = js.native
  ...
  /** collection of nodes */
  /** a list of entities in the document */
  def entities(index: Double): IXMLDOMNode = js.native
  def hasChildNodes(): Boolean = js.native
  /** insert a child node */
  def insertBefore(newChild: IXMLDOMNode, refChild: js.Any): IXMLDOMNode = js.native
  /** collection of nodes */
  /** a list of notations in the document */
  def notations(index: Double): IXMLDOMNode = js.native
  /** remove a child node */
