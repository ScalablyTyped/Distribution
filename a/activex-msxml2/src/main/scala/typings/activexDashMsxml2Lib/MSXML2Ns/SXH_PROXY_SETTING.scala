...
@js.native
sealed trait SXH_PROXY_SETTING extends js.Object

/** Settings for setProxy */
@JSGlobal("MSXML2.SXH_PROXY_SETTING")
@js.native
object SXH_PROXY_SETTING extends js.Object {
  @js.native
  sealed trait SXH_PROXY_SET_DEFAULT
    extends activexDashMsxml2Lib.MSXML2Ns.SXH_PROXY_SETTING
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.SXH_PROXY_SETTING with scala.Double] = js.native
}
