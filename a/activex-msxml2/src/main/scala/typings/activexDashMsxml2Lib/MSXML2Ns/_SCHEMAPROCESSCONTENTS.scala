...
@js.native
sealed trait _SCHEMAPROCESSCONTENTS extends js.Object

/** Schema Object Model Process Contents */
@JSGlobal("MSXML2._SCHEMAPROCESSCONTENTS")
@js.native
object _SCHEMAPROCESSCONTENTS extends js.Object {
  @js.native
  sealed trait SCHEMAPROCESSCONTENTS_LAX
    extends activexDashMsxml2Lib.MSXML2Ns._SCHEMAPROCESSCONTENTS
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns._SCHEMAPROCESSCONTENTS with scala.Double] = js.native
}
