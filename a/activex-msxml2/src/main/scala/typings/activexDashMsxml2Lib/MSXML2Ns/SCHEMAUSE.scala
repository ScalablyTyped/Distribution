...
@js.native
sealed trait SCHEMAUSE extends js.Object

/** Schema Object Model Attribute Uses */
@JSGlobal("MSXML2.SCHEMAUSE")
@js.native
object SCHEMAUSE extends js.Object {
  @js.native
  sealed trait SCHEMAUSE_OPTIONAL
    extends activexDashMsxml2Lib.MSXML2Ns.SCHEMAUSE
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.SCHEMAUSE with scala.Double] = js.native
}
