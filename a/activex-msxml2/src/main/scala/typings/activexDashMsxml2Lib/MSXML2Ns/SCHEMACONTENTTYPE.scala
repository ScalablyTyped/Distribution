...
@js.native
sealed trait SCHEMACONTENTTYPE extends js.Object

/** Schema Object Model Content Types */
@JSGlobal("MSXML2.SCHEMACONTENTTYPE")
@js.native
object SCHEMACONTENTTYPE extends js.Object {
  @js.native
  sealed trait SCHEMACONTENTTYPE_ELEMENTONLY
    extends activexDashMsxml2Lib.MSXML2Ns.SCHEMACONTENTTYPE
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.SCHEMACONTENTTYPE with scala.Double] = js.native
}
