...
@js.native
sealed trait SXH_SERVER_CERT_OPTION extends js.Object

/** Flags for SXH_OPTION_IGNORE_SERVER_SSL_CERT_ERROR_FLAGS option */
@JSGlobal("MSXML2.SXH_SERVER_CERT_OPTION")
@js.native
object SXH_SERVER_CERT_OPTION extends js.Object {
  @js.native
  sealed trait SXH_SERVER_CERT_IGNORE_ALL_SERVER_ERRORS
    extends activexDashMsxml2Lib.MSXML2Ns.SXH_SERVER_CERT_OPTION
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.SXH_SERVER_CERT_OPTION with scala.Double] = js.native
}
