...
@js.native
sealed trait tagDOMNodeType extends js.Object

/** Constants that define a node's type */
@JSGlobal("MSXML2.tagDOMNodeType")
@js.native
object tagDOMNodeType extends js.Object {
  @js.native
  sealed trait NODE_ATTRIBUTE
    extends activexDashMsxml2Lib.MSXML2Ns.tagDOMNodeType
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.tagDOMNodeType with scala.Double] = js.native
}
