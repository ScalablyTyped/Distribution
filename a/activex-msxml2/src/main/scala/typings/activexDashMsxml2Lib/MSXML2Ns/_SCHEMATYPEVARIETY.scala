...
@js.native
sealed trait _SCHEMATYPEVARIETY extends js.Object

/** Schema Object Model Type variety values */
@JSGlobal("MSXML2._SCHEMATYPEVARIETY")
@js.native
object _SCHEMATYPEVARIETY extends js.Object {
  @js.native
  sealed trait SCHEMATYPEVARIETY_ATOMIC
    extends activexDashMsxml2Lib.MSXML2Ns._SCHEMATYPEVARIETY
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns._SCHEMATYPEVARIETY with scala.Double] = js.native
}
