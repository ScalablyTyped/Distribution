...
@js.native
sealed trait SERVERXMLHTTP_OPTION extends js.Object

/** Options for ServerXMLHTTPRequest Option property */
@JSGlobal("MSXML2.SERVERXMLHTTP_OPTION")
@js.native
object SERVERXMLHTTP_OPTION extends js.Object {
  @js.native
  sealed trait SXH_OPTION_ESCAPE_PERCENT_IN_URL
    extends activexDashMsxml2Lib.MSXML2Ns.SERVERXMLHTTP_OPTION
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[activexDashMsxml2Lib.MSXML2Ns.SERVERXMLHTTP_OPTION with scala.Double] = js.native
}
