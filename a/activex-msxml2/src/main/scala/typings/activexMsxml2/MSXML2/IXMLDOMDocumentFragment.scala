...
object IXMLDOMDocumentFragment {
  ...
  @scala.inline
  implicit class IXMLDOMDocumentFragmentMutableBuilder[Self <: IXMLDOMDocumentFragment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMDocumentFragment_typekey(value: IXMLDOMDocumentFragment): Self = StObject.set(x, "MSXML2.IXMLDOMDocumentFragment_typekey", value.asInstanceOf[js.Any])
