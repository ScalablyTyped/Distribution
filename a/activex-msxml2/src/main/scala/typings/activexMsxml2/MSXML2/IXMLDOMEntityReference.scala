...
object IXMLDOMEntityReference {
  ...
  @scala.inline
  implicit class IXMLDOMEntityReferenceMutableBuilder[Self <: IXMLDOMEntityReference] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMEntityReference_typekey(value: IXMLDOMEntityReference): Self = StObject.set(x, "MSXML2.IXMLDOMEntityReference_typekey", value.asInstanceOf[js.Any])
