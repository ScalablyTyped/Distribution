...
import typings.activexMsxml2.activexMsxml2Numbers.`12`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexMsxml2.activexMsxml2Numbers.`12`
  - typings.activexMsxml2.activexMsxml2Numbers.`7`
  - typings.activexMsxml2.activexMsxml2Numbers.`3`
*/
trait DOMNodeType extends StObject
object DOMNodeType {
  
  inline def NODE_ATTRIBUTE: `2` = 2.asInstanceOf[`2`]
  
  inline def NODE_CDATA_SECTION: `4` = 4.asInstanceOf[`4`]
  
  inline def NODE_COMMENT: `8` = 8.asInstanceOf[`8`]
  
  inline def NODE_DOCUMENT: `9` = 9.asInstanceOf[`9`]
  
  inline def NODE_DOCUMENT_FRAGMENT: `11` = 11.asInstanceOf[`11`]
  
  inline def NODE_DOCUMENT_TYPE: `10` = 10.asInstanceOf[`10`]
  
  inline def NODE_ELEMENT: `1` = 1.asInstanceOf[`1`]
  
  inline def NODE_ENTITY: `6` = 6.asInstanceOf[`6`]
  
  inline def NODE_ENTITY_REFERENCE: `5` = 5.asInstanceOf[`5`]
  
  inline def NODE_INVALID: `0` = 0.asInstanceOf[`0`]
  
  inline def NODE_NOTATION: `12` = 12.asInstanceOf[`12`]
  
  inline def NODE_PROCESSING_INSTRUCTION: `7` = 7.asInstanceOf[`7`]
  
  inline def NODE_TEXT: `3` = 3.asInstanceOf[`3`]
}
