...
object IXMLDOMDocumentType {
  ...
  @scala.inline
  implicit class IXMLDOMDocumentTypeMutableBuilder[Self <: IXMLDOMDocumentType] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEntities(value: IXMLDOMNamedNodeMap): Self = StObject.set(x, "entities", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMDocumentType_typekey(value: IXMLDOMDocumentType): Self = StObject.set(x, "MSXML2.IXMLDOMDocumentType_typekey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setNotations(value: IXMLDOMNamedNodeMap): Self = StObject.set(x, "notations", value.asInstanceOf[js.Any])
