...
object IXMLDOMNode {
  ...
  @scala.inline
  implicit class IXMLDOMNodeMutableBuilder[Self <: IXMLDOMNode] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMNode_typekey(value: IXMLDOMNode): Self = StObject.set(x, "MSXML2.IXMLDOMNode_typekey", value.asInstanceOf[js.Any])
