...
object IXMLDOMComment {
  ...
  @scala.inline
  implicit class IXMLDOMCommentMutableBuilder[Self <: IXMLDOMComment] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMComment_typekey(value: IXMLDOMComment): Self = StObject.set(x, "MSXML2.IXMLDOMComment_typekey", value.asInstanceOf[js.Any])
