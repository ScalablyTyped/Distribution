...
object IXMLDOMDocument {
  ...
  @scala.inline
  implicit class IXMLDOMDocumentMutableBuilder[Self <: IXMLDOMDocument] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMDocument_typekey(value: IXMLDOMDocument): Self = StObject.set(x, "MSXML2.IXMLDOMDocument_typekey", value.asInstanceOf[js.Any])
