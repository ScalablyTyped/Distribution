...
object IXMLDOMCDATASection {
  ...
  @scala.inline
  implicit class IXMLDOMCDATASectionMutableBuilder[Self <: IXMLDOMCDATASection] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMCDATASection_typekey(value: IXMLDOMCDATASection): Self = StObject.set(x, "MSXML2.IXMLDOMCDATASection_typekey", value.asInstanceOf[js.Any])
