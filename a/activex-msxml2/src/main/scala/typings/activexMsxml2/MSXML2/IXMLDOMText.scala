...
trait IXMLDOMText extends StObject {
  
  @JSName("MSXML2.IXMLDOMText_typekey")
  var MSXML2DotIXMLDOMText_typekey: IXMLDOMText
...
object IXMLDOMText {
  ...
  @scala.inline
  def apply(
    MSXML2DotIXMLDOMText_typekey: IXMLDOMText,
    ...
    __obj.updateDynamic("MSXML2.IXMLDOMText_typekey")(MSXML2DotIXMLDOMText_typekey.asInstanceOf[js.Any])
    __obj.asInstanceOf[IXMLDOMText]
  }
  
  @scala.inline
  implicit class IXMLDOMTextMutableBuilder[Self <: IXMLDOMText] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMText_typekey(value: IXMLDOMText): Self = StObject.set(x, "MSXML2.IXMLDOMText_typekey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSplitText(value: Double => IXMLDOMText): Self = StObject.set(x, "splitText", js.Any.fromFunction1(value))
