...
trait IXMLDOMText extends StObject {
  ...
  /* private */ @JSName("MSXML2.IXMLDOMText_typekey")
...
object IXMLDOMText {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IXMLDOMText] (val x: Self) extends AnyVal {
    ...
    inline def setMSXML2DotIXMLDOMText_typekey(value: IXMLDOMText): Self = StObject.set(x, "MSXML2.IXMLDOMText_typekey", value.asInstanceOf[js.Any])
