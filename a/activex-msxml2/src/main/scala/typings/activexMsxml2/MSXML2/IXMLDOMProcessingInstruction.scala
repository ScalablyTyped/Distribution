...
object IXMLDOMProcessingInstruction {
  ...
  @scala.inline
  implicit class IXMLDOMProcessingInstructionMutableBuilder[Self <: IXMLDOMProcessingInstruction] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMSXML2DotIXMLDOMProcessingInstruction_typekey(value: IXMLDOMProcessingInstruction): Self = StObject.set(x, "MSXML2.IXMLDOMProcessingInstruction_typekey", value.asInstanceOf[js.Any])
