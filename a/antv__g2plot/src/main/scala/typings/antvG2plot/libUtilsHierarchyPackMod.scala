...
object libUtilsHierarchyPackMod {
  
  @JSImport("@antv/g2plot/lib/utils/hierarchy/pack", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def pack(data: Any, options: Options): js.Array[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("pack")(data.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[Any]]
  
  /* Inlined std.Omit<@antv/g2plot.@antv/g2plot/lib/utils/hierarchy/types.HierarchyOption, 'as'> & {  as :[string, string, string] | undefined} */
