...
import typings.antvG2plot.anon.CustomContent
import typings.antvG2plot.anon.G2tooltip
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object tinyColumnConstantsMod {
  
  object DEFAULT_OPTIONS {
    
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_OPTIONS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_OPTIONS.appendPadding")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_OPTIONS.tooltip")
    @js.native
    def tooltip: CustomContent = js.native
    inline def tooltip_=(x: CustomContent): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("tooltip")(x.asInstanceOf[js.Any])
  }
  
  object DEFAULT_TOOLTIP_OPTIONS {
    
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.containerTpl")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.domStyles")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.itemTpl")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.shared")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.showMarkers")
    @js.native
    ...
    @JSImport("@antv/g2plot/lib/plots/tiny-column/constants", "DEFAULT_TOOLTIP_OPTIONS.showTitle")
    @js.native
