...
import typings.antvG2plot.libTypesStateMod.StateCondition
import typings.antvG2plot.libTypesStateMod.StateName
import typings.antvG2plot.libTypesStateMod.StateObject
...
object libCorePlotMod {
  
  @JSImport("@antv/g2plot/lib/core/plot", "PLOT_CONTAINER_OPTIONS")
  @js.native
  val PLOT_CONTAINER_OPTIONS: js.Array[String] = js.native
  
  /* note: abstract class */ @JSImport("@antv/g2plot/lib/core/plot", "Plot")
  @js.native
  open class Plot[O /* <: PickOptions */] protected () extends default {
