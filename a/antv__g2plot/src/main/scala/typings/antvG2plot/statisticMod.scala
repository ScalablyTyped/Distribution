...
object statisticMod {
  ...
  /* Inlined std.Omit<std.Partial<std.CSSStyleDeclaration>, 'opacity' | 'fontWeight' | 'lineHeight'> & {  opacity :number | undefined,   fontWeight :string | number | undefined,   lineHeight :string | number | undefined} */
  ...
  trait Statistic extends StObject {
    ...
    /**
      * @title 内容
      */
    val content: js.UndefOr[`false` | StatisticText] = js.undefined
    
    /**
      * @title 标题
      */
    val title: js.UndefOr[`false` | StatisticText] = js.undefined
  }
  object Statistic {
    
    inline def apply(): Statistic = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: Statistic](x: Self) {
      ...
      inline def setTitle(value: `false` | StatisticText): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
      
      inline def setTitleUndefined: Self = StObject.set(x, "title", js.undefined)
    }
  }
  
  trait StatisticText extends StObject {
    ...
    /**
      * @title 自定义中心文本的 html
      */
    val customHtml: js.UndefOr[
        js.Function4[
          /* container */ HTMLElement, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify View */ /* view */ Any, 
    ...
    /**
      * @title 文本的格式化
      */
    val formatter: js.UndefOr[js.Function2[/* datum */ js.UndefOr[Datum], /* data */ js.UndefOr[Data], String]] = js.undefined
    ...
    /**
      * @title 统计文本的样式
      */
    val style: js.UndefOr[CSSStyle | (js.Function1[/* datum */ Datum, CSSStyle])] = js.undefined
  }
  object StatisticText {
    
    inline def apply(): StatisticText = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: StatisticText](x: Self) {
      ...
      inline def setCustomHtml(
        value: (/* container */ HTMLElement, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify View */ /* view */ Any, /* datum */ js.UndefOr[Datum], /* data */ js.UndefOr[Data]) => String
      ): Self = StObject.set(x, "customHtml", js.Any.fromFunction4(value))
      
      inline def setCustomHtmlUndefined: Self = StObject.set(x, "customHtml", js.undefined)
      
      inline def setFormatter(value: (/* datum */ js.UndefOr[Datum], /* data */ js.UndefOr[Data]) => String): Self = StObject.set(x, "formatter", js.Any.fromFunction2(value))
      ...
      inline def setStyle(value: CSSStyle | (js.Function1[/* datum */ Datum, CSSStyle])): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
      
      inline def setStyleFunction1(value: /* datum */ Datum => CSSStyle): Self = StObject.set(x, "style", js.Any.fromFunction1(value))
