  ...
  trait VennOptions
    ...
    val color_VennOptions: js.UndefOr[
        String | js.Array[String] | (js.Function2[
          /* datum */ typings.antvG2plot.typesCommonMod.Datum, 
  ...
  object VennOptions {
    ...
    extension [Self <: VennOptions](x: Self) {
      ...
      inline def setColorFunction2(
        value: (/* datum */ typings.antvG2plot.typesCommonMod.Datum, /* defaultColor */ js.UndefOr[String]) => String
      ...
      inline def setPointStyleFunction1(value: /* datum */ typings.antvG2plot.typesCommonMod.Datum => ShapeStyle): Self = StObject.set(x, "pointStyle", js.Any.fromFunction1(value))
