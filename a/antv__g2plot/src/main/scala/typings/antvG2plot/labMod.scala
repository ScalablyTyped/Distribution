...
object labMod {
  ...
  object Stage extends StObject {
    ...
    sealed trait BETA
      extends StObject
         with Stage
    /* "BETA" */ val BETA: typings.antvG2plot.labMod.Stage.BETA & String = js.native
    
    @js.native
    sealed trait DEV
      extends StObject
         with Stage
    /* "DEV" */ val DEV: typings.antvG2plot.labMod.Stage.DEV & String = js.native
    
    @js.native
    sealed trait STABLE
      extends StObject
         with Stage
    /* "STABLE" */ val STABLE: typings.antvG2plot.labMod.Stage.STABLE & String = js.native
  }
