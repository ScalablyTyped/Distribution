...
trait OmitHierarchyOptionastypeActiveDepth extends StObject {
...
object OmitHierarchyOptionastypeActiveDepth {
  
  inline def apply(): OmitHierarchyOptionastypeActiveDepth = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitHierarchyOptionastypeActiveDepth]
  }
  
  extension [Self <: OmitHierarchyOptionastypeActiveDepth](x: Self) {
