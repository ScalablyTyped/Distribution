...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/area.AreaOptions> */
trait PlotOptionsAreaOptions extends StObject {
...
object PlotOptionsAreaOptions {
  
  inline def apply(): PlotOptionsAreaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOptionsAreaOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOptionsAreaOptions] (val x: Self) extends AnyVal {
