...
trait readonlyfieldsArraystring
  ...
  /**
    ...
    */
  val callback: js.UndefOr[LabelCallback] = js.undefined
  ...
  /**
    ...
    */
  var labelLine: js.UndefOr[Null | Boolean | typings.antvG2.anon.`0`] = js.undefined
...
object readonlyfieldsArraystring {
  
  inline def apply(): readonlyfieldsArraystring = {
  ...
  extension [Self <: readonlyfieldsArraystring](x: Self) {
    ...
    inline def setLabelLine(value: Boolean | typings.antvG2.anon.`0`): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
