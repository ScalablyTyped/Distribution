...
trait OmitHierarchyOptionastypeIgnoreParentValue extends StObject {
...
object OmitHierarchyOptionastypeIgnoreParentValue {
  
  inline def apply(): OmitHierarchyOptionastypeIgnoreParentValue = {
