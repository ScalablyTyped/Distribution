...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/tiny-area.TinyAreaOptions> */
trait PlotOptionsTinyAreaOption extends StObject {
  ...
  var areaStyle: js.UndefOr[StyleAttr] = js.undefined
  ...
  var line: js.UndefOr[MappingOptions] = js.undefined
  ...
  var point: js.UndefOr[MappingOptionsPickPointGe] = js.undefined
...
object PlotOptionsTinyAreaOption {
  
  inline def apply(): PlotOptionsTinyAreaOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOptionsTinyAreaOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOptionsTinyAreaOption] (val x: Self) extends AnyVal {
