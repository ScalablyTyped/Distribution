...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/histogram.HistogramOptions> */
trait PlotOptionsHistogramOptio extends StObject {
...
object PlotOptionsHistogramOptio {
  
  inline def apply(binField: String): PlotOptionsHistogramOptio = {
    val __obj = js.Dynamic.literal(binField = binField.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotOptionsHistogramOptio]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOptionsHistogramOptio] (val x: Self) extends AnyVal {
