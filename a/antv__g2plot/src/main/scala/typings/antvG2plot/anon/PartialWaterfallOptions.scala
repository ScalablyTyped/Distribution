...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/waterfall/types.WaterfallOptions> */
trait PartialWaterfallOptions extends StObject {
  ...
  var total: js.UndefOr[`false` | TotalCfg] = js.undefined
  
  var useDeferredLabel: js.UndefOr[Boolean | Double] = js.undefined
  
  var waterfallStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialWaterfallOptions {
  
  inline def apply(): PartialWaterfallOptions = {
