...
import typings.antvG2plot.facetTypesMod.IPlot
import typings.antvG2plot.facetTypesMod.IView
...
trait PartialFacetOptionskeyofF extends StObject {
  ...
  var data: js.UndefOr[typings.antvG2plot.typesCommonMod.Data] = js.undefined
  ...
  var line: js.UndefOr[typings.antvG2.libInterfaceMod.Line] = js.undefined
...
object PartialFacetOptionskeyofF {
  ...
  extension [Self <: PartialFacetOptionskeyofF](x: Self) {
    ...
    inline def setData(value: typings.antvG2plot.typesCommonMod.Data): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setLine(value: typings.antvG2.libInterfaceMod.Line): Self = StObject.set(x, "line", value.asInstanceOf[js.Any])
