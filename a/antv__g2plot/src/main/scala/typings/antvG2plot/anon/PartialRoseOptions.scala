...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/rose/types.RoseOptions> */
trait PartialRoseOptions extends StObject {
  ...
  var sectorStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialRoseOptions {
  
  inline def apply(): PartialRoseOptions = {
