...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/column/types.ColumnOptions> */
trait PartialColumnOptions extends StObject {
...
object PartialColumnOptions {
  
  inline def apply(): PartialColumnOptions = {
