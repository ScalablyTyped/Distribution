...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/treemap/types.TreemapOptions> */
trait PartialTreemapOptions extends StObject {
  ...
  var rectStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialTreemapOptions {
  
  inline def apply(): PartialTreemapOptions = {
