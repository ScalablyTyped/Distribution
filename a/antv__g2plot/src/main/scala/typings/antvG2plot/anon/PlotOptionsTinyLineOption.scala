...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/tiny-line.TinyLineOptions> */
trait PlotOptionsTinyLineOption extends StObject {
...
object PlotOptionsTinyLineOption {
  
  inline def apply(): PlotOptionsTinyLineOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOptionsTinyLineOption]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PlotOptionsTinyLineOption] (val x: Self) extends AnyVal {
