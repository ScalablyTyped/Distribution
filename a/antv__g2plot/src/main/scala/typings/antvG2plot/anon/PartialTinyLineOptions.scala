...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/tiny-line/types.TinyLineOptions> */
trait PartialTinyLineOptions extends StObject {
...
object PartialTinyLineOptions {
  
  inline def apply(): PartialTinyLineOptions = {
