...
import typings.antvG2plot.gaugeTypesMod.Indicator
import typings.antvG2plot.gaugeTypesMod.Range
...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/gauge/types.GaugeOptions> */
trait PartialGaugeOptions extends StObject {
  ...
  var gaugeStyle: js.UndefOr[StyleAttr] = js.undefined
  
  var height: js.UndefOr[Double] = js.undefined
  
  var indicator: js.UndefOr[`false` | Indicator] = js.undefined
  ...
  var meter: js.UndefOr[StepRatio] = js.undefined
...
object PartialGaugeOptions {
  
  inline def apply(): PartialGaugeOptions = {
