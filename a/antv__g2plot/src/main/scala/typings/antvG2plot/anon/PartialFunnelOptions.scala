...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/funnel/types.FunnelOptions> */
trait PartialFunnelOptions extends StObject {
...
object PartialFunnelOptions {
  
  inline def apply(): PartialFunnelOptions = {
