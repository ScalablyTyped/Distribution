...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/progress/types.ProgressOptions> */
trait PartialProgressOptions extends StObject {
...
object PartialProgressOptions {
  
  inline def apply(): PartialProgressOptions = {
