...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/facet/types.FacetOptions<'rect' | 'circle' | 'mirror' | 'list' | 'matrix' | 'tree'>> */
trait PartialFacetOptionsrectci extends StObject {
  ...
  var `type`: js.UndefOr[rect | circle | mirror | list | matrix | tree] = js.undefined
...
object PartialFacetOptionsrectci {
  
  inline def apply(): PartialFacetOptionsrectci = {
  ...
  extension [Self <: PartialFacetOptionsrectci](x: Self) {
    ...
    inline def setType(value: rect | circle | mirror | list | matrix | tree): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
