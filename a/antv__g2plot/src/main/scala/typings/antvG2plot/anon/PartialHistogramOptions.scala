...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/histogram/types.HistogramOptions> */
trait PartialHistogramOptions extends StObject {
  ...
  var binField: js.UndefOr[String] = js.undefined
  
  var binNumber: js.UndefOr[Double] = js.undefined
...
object PartialHistogramOptions {
  
  inline def apply(): PartialHistogramOptions = {
  ...
  implicit open class MutableBuilder[Self <: PartialHistogramOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBinFieldUndefined: Self = StObject.set(x, "binField", js.undefined)
