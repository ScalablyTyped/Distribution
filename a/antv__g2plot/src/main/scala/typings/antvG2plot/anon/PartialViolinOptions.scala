...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/violin/types.ViolinOptions> */
trait PartialViolinOptions extends StObject {
  ...
  var box: js.UndefOr[Boolean | State] = js.undefined
  ...
  var kde: js.UndefOr[Max] = js.undefined
  ...
  var shape: js.UndefOr[smooth | hollow | `hollow-smooth`] = js.undefined
  ...
  var violinStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialViolinOptions {
  
  inline def apply(): PartialViolinOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialViolinOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialViolinOptions] (val x: Self) extends AnyVal {
