...
import typings.antvG2plot.libPlotsBulletTypesMod.BulletAttr
import typings.antvG2plot.libPlotsBulletTypesMod.GeometryLabelAttr
...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/bullet/types.BulletOptions> */
trait PartialBulletOptions extends StObject {
  ...
  var bulletStyle: js.UndefOr[BulletAttr[StyleAttr]] = js.undefined
  
  var color: js.UndefOr[BulletAttr[ColorAttr]] = js.undefined
  ...
  var label: js.UndefOr[BulletAttr[GeometryLabelAttr | `false`]] = js.undefined
  ...
  var measureField: js.UndefOr[String] = js.undefined
  ...
  var rangeField: js.UndefOr[String] = js.undefined
  
  var renderer: js.UndefOr[svg | canvas] = js.undefined
  
  var scrollbar: js.UndefOr[Scrollbar] = js.undefined
  
  var size: js.UndefOr[BulletAttr[SizeAttr]] = js.undefined
...
object PartialBulletOptions {
  
  inline def apply(): PartialBulletOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialBulletOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialBulletOptions] (val x: Self) extends AnyVal {
    ...
    inline def setBulletStyle(value: BulletAttr[StyleAttr]): Self = StObject.set(x, "bulletStyle", value.asInstanceOf[js.Any])
    
    inline def setBulletStyleUndefined: Self = StObject.set(x, "bulletStyle", js.undefined)
    
    inline def setColor(value: BulletAttr[ColorAttr]): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setLabel(value: BulletAttr[GeometryLabelAttr | `false`]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
    ...
    inline def setMeasureField(value: String): Self = StObject.set(x, "measureField", value.asInstanceOf[js.Any])
    
    inline def setMeasureFieldUndefined: Self = StObject.set(x, "measureField", js.undefined)
    ...
    inline def setRangeField(value: String): Self = StObject.set(x, "rangeField", value.asInstanceOf[js.Any])
    
    inline def setRangeFieldUndefined: Self = StObject.set(x, "rangeField", js.undefined)
    ...
    inline def setSize(value: BulletAttr[SizeAttr]): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
