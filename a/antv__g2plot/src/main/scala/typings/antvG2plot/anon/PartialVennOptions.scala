...
trait PartialVennOptions extends StObject {
  ...
  var data: js.UndefOr[js.Array[typings.antvG2.libInterfaceMod.Datum]] = js.undefined
  ...
  var setsField: js.UndefOr[String] = js.undefined
...
object PartialVennOptions {
  
  inline def apply(): PartialVennOptions = {
  ...
  extension [Self <: PartialVennOptions](x: Self) {
    ...
    inline def setColor(
      value: String | js.Array[String] | (js.Function2[/* datum */ Datum, /* defaultColor */ js.UndefOr[String], String])
    ...
    inline def setData(value: js.Array[typings.antvG2.libInterfaceMod.Datum]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: typings.antvG2.libInterfaceMod.Datum*): Self = StObject.set(x, "data", js.Array(value*))
    ...
    inline def setSetsFieldUndefined: Self = StObject.set(x, "setsField", js.undefined)
