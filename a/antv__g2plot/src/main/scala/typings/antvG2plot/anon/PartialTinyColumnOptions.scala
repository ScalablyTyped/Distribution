...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/tiny-column/types.TinyColumnOptions> */
trait PartialTinyColumnOptions extends StObject {
...
object PartialTinyColumnOptions {
  
  inline def apply(): PartialTinyColumnOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTinyColumnOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PartialTinyColumnOptions] (val x: Self) extends AnyVal {
