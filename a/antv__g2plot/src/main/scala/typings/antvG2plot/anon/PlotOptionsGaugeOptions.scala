...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/gauge.GaugeOptions> */
trait PlotOptionsGaugeOptions extends StObject {
...
object PlotOptionsGaugeOptions {
  
  inline def apply(percent: Double): PlotOptionsGaugeOptions = {
