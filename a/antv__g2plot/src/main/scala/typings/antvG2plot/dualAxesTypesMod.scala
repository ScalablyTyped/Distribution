...
object dualAxesTypesMod {
  ...
  object AxisType extends StObject {
    ...
    sealed trait Left
      extends StObject
         with AxisType
    /* "Left" */ val Left: typings.antvG2plot.dualAxesTypesMod.AxisType.Left & String = js.native
    
    @js.native
    sealed trait Right
      extends StObject
         with AxisType
    /* "Right" */ val Right: typings.antvG2plot.dualAxesTypesMod.AxisType.Right & String = js.native
  }
  ...
  object DualAxesGeometry extends StObject {
    ...
    /* "column" */ val Column: typings.antvG2plot.dualAxesTypesMod.DualAxesGeometry.Column & String = js.native
    
    @js.native
    sealed trait Line
      extends StObject
         with DualAxesGeometry
    /* "line" */ val Line: typings.antvG2plot.dualAxesTypesMod.DualAxesGeometry.Line & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antvG2plot.dualAxesTypesMod.GeometryColumnOption
    - typings.antvG2plot.dualAxesTypesMod.GeometryLineOption
  */
  trait GeometryOption extends StObject
  object GeometryOption {
    
    inline def GeometryColumnOption(): typings.antvG2plot.dualAxesTypesMod.GeometryColumnOption = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antvG2plot.dualAxesTypesMod.GeometryColumnOption]
    }
    
    inline def GeometryLineOption(): typings.antvG2plot.dualAxesTypesMod.GeometryLineOption = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antvG2plot.dualAxesTypesMod.GeometryLineOption]
    }
  }
