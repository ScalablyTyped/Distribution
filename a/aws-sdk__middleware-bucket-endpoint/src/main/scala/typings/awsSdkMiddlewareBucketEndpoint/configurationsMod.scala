...
object configurationsMod {
  ...
  object BucketEndpointResolvedConfig {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(bucketEndpoint = bucketEndpoint.asInstanceOf[js.Any], disableMultiregionAccessPoints = js.Any.fromFunction0(disableMultiregionAccessPoints), forcePathStyle = forcePathStyle.asInstanceOf[js.Any], isCustomEndpoint = isCustomEndpoint.asInstanceOf[js.Any], region = js.Any.fromFunction0(region), regionInfoProvider = js.Any.fromFunction2(regionInfoProvider), useAccelerateEndpoint = useAccelerateEndpoint.asInstanceOf[js.Any], useArnRegion = js.Any.fromFunction0(useArnRegion), useDualstackEndpoint = js.Any.fromFunction0(useDualstackEndpoint), useFipsEndpoint = js.Any.fromFunction0(useFipsEndpoint))
  ...
  object PreviouslyResolved {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(isCustomEndpoint = isCustomEndpoint.asInstanceOf[js.Any], region = js.Any.fromFunction0(region), regionInfoProvider = js.Any.fromFunction2(regionInfoProvider), useDualstackEndpoint = js.Any.fromFunction0(useDualstackEndpoint), useFipsEndpoint = js.Any.fromFunction0(useFipsEndpoint))
