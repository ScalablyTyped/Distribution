...
@JSImport("@ant-design/icons-vue/StarFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueStarFilledMod extends js.Object {
  @js.native
  trait StarFilled extends Vue {
  ...
  @js.native
  class default () extends StarFilled
