...
@JSImport("@ant-design/icons-vue/BehanceOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBehanceOutlinedMod extends js.Object {
  @js.native
  trait BehanceOutlined extends Vue {
  ...
  @js.native
  class default () extends BehanceOutlined
