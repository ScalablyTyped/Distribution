...
@JSImport("@ant-design/icons-vue/Html5Outlined", JSImport.Namespace)
@js.native
object antDesignIconsVueHtml5OutlinedMod extends js.Object {
  @js.native
  trait Html5Outlined extends Vue {
  ...
  @js.native
  class default () extends Html5Outlined
