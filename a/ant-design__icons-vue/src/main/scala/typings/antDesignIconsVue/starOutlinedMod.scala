...
@JSImport("@ant-design/icons-vue/lib/icons/StarOutlined", JSImport.Namespace)
@js.native
object starOutlinedMod extends js.Object {
  @js.native
  trait StarOutlined extends Vue {
  ...
  @js.native
  class default () extends StarOutlined
