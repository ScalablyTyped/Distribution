...
@JSImport("@ant-design/icons-vue/InboxOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueInboxOutlinedMod extends js.Object {
  @js.native
  trait InboxOutlined extends Vue {
  ...
  @js.native
  class default () extends InboxOutlined
