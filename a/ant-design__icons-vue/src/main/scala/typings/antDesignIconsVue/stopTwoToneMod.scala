...
@JSImport("@ant-design/icons-vue/lib/icons/StopTwoTone", JSImport.Namespace)
@js.native
object stopTwoToneMod extends js.Object {
  @js.native
  trait StopTwoTone extends Vue {
  ...
  @js.native
  class default () extends StopTwoTone
