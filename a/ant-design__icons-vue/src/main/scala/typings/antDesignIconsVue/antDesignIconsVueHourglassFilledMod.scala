...
@JSImport("@ant-design/icons-vue/HourglassFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueHourglassFilledMod extends js.Object {
  @js.native
  trait HourglassFilled extends Vue {
  ...
  @js.native
  class default () extends HourglassFilled
