...
@JSImport("@ant-design/icons-vue/lib/icons/CloudFilled", JSImport.Namespace)
@js.native
object cloudFilledMod extends js.Object {
  @js.native
  trait CloudFilled extends Vue {
  ...
  @js.native
  class default () extends CloudFilled
