...
@JSImport("@ant-design/icons-vue/lib/icons/CreditCardFilled", JSImport.Namespace)
@js.native
object creditCardFilledMod extends js.Object {
  @js.native
  trait CreditCardFilled extends Vue {
  ...
  @js.native
  class default () extends CreditCardFilled
