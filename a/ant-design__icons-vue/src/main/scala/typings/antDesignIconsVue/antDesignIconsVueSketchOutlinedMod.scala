...
@JSImport("@ant-design/icons-vue/SketchOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSketchOutlinedMod extends js.Object {
  @js.native
  trait SketchOutlined extends Vue {
  ...
  @js.native
  class default () extends SketchOutlined
