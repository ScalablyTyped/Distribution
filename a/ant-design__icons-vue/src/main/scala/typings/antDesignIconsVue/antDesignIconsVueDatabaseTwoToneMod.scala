...
@JSImport("@ant-design/icons-vue/DatabaseTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueDatabaseTwoToneMod extends js.Object {
  @js.native
  trait DatabaseTwoTone extends Vue {
  ...
  @js.native
  class default () extends DatabaseTwoTone
