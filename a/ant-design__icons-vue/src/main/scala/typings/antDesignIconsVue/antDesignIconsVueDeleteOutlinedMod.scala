...
@JSImport("@ant-design/icons-vue/DeleteOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueDeleteOutlinedMod extends js.Object {
  @js.native
  trait DeleteOutlined extends Vue {
  ...
  @js.native
  class default () extends DeleteOutlined
