...
@JSImport("@ant-design/icons-vue/ShakeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueShakeOutlinedMod extends js.Object {
  @js.native
  trait ShakeOutlined extends Vue {
  ...
  @js.native
  class default () extends ShakeOutlined
