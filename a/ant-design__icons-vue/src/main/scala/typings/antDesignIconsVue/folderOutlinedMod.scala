...
@JSImport("@ant-design/icons-vue/lib/icons/FolderOutlined", JSImport.Namespace)
@js.native
object folderOutlinedMod extends js.Object {
  @js.native
  trait FolderOutlined extends Vue {
  ...
  @js.native
  class default () extends FolderOutlined
