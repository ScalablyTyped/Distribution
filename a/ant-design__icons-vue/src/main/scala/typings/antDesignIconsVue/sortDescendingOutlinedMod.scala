...
@JSImport("@ant-design/icons-vue/lib/icons/SortDescendingOutlined", JSImport.Namespace)
@js.native
object sortDescendingOutlinedMod extends js.Object {
  @js.native
  trait SortDescendingOutlined extends Vue {
  ...
  @js.native
  class default () extends SortDescendingOutlined
