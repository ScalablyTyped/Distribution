...
@JSImport("@ant-design/icons-vue/MehOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueMehOutlinedMod extends js.Object {
  @js.native
  trait MehOutlined extends Vue {
  ...
  @js.native
  class default () extends MehOutlined
