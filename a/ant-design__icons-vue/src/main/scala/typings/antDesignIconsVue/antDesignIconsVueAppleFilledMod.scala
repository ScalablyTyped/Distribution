...
@JSImport("@ant-design/icons-vue/AppleFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueAppleFilledMod extends js.Object {
  @js.native
  trait AppleFilled extends Vue {
  ...
  @js.native
  class default () extends AppleFilled
