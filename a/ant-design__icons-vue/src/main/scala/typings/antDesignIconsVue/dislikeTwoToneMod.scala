...
@JSImport("@ant-design/icons-vue/lib/icons/DislikeTwoTone", JSImport.Namespace)
@js.native
object dislikeTwoToneMod extends js.Object {
  @js.native
  trait DislikeTwoTone extends Vue {
  ...
  @js.native
  class default () extends DislikeTwoTone
