...
@JSImport("@ant-design/icons-vue/WechatFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueWechatFilledMod extends js.Object {
  @js.native
  trait WechatFilled extends Vue {
  ...
  @js.native
  class default () extends WechatFilled
