...
@JSImport("@ant-design/icons-vue/UnlockTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueUnlockTwoToneMod extends js.Object {
  @js.native
  trait UnlockTwoTone extends Vue {
  ...
  @js.native
  class default () extends UnlockTwoTone
