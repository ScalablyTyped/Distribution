...
@JSImport("@ant-design/icons-vue/MehTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueMehTwoToneMod extends js.Object {
  @js.native
  trait MehTwoTone extends Vue {
  ...
  @js.native
  class default () extends MehTwoTone
