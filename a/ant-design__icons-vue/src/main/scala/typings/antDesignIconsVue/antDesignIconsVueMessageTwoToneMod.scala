...
@JSImport("@ant-design/icons-vue/MessageTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueMessageTwoToneMod extends js.Object {
  @js.native
  trait MessageTwoTone extends Vue {
  ...
  @js.native
  class default () extends MessageTwoTone
