...
@JSImport("@ant-design/icons-vue/SendOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSendOutlinedMod extends js.Object {
  @js.native
  trait SendOutlined extends Vue {
  ...
  @js.native
  class default () extends SendOutlined
