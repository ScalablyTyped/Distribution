...
@JSImport("@ant-design/icons-vue/ZhihuOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueZhihuOutlinedMod extends js.Object {
  @js.native
  trait ZhihuOutlined extends Vue {
  ...
  @js.native
  class default () extends ZhihuOutlined
