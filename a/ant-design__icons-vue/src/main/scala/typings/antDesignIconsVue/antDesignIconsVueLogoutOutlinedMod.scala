...
@JSImport("@ant-design/icons-vue/LogoutOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueLogoutOutlinedMod extends js.Object {
  @js.native
  trait LogoutOutlined extends Vue {
  ...
  @js.native
  class default () extends LogoutOutlined
