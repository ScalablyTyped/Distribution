...
@JSImport("@ant-design/icons-vue/FilePdfOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFilePdfOutlinedMod extends js.Object {
  @js.native
  trait FilePdfOutlined extends Vue {
  ...
  @js.native
  class default () extends FilePdfOutlined
