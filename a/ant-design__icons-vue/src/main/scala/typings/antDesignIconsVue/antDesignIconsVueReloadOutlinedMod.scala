...
@JSImport("@ant-design/icons-vue/ReloadOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueReloadOutlinedMod extends js.Object {
  @js.native
  trait ReloadOutlined extends Vue {
  ...
  @js.native
  class default () extends ReloadOutlined
