...
@JSImport("@ant-design/icons-vue/lib/icons/PoundOutlined", JSImport.Namespace)
@js.native
object poundOutlinedMod extends js.Object {
  @js.native
  trait PoundOutlined extends Vue {
  ...
  @js.native
  class default () extends PoundOutlined
