...
@JSImport("@ant-design/icons-vue/RobotFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueRobotFilledMod extends js.Object {
  @js.native
  trait RobotFilled extends Vue {
  ...
  @js.native
  class default () extends RobotFilled
