...
@JSImport("@ant-design/icons-vue/lib/icons/BookTwoTone", JSImport.Namespace)
@js.native
object bookTwoToneMod extends js.Object {
  @js.native
  trait BookTwoTone extends Vue {
  ...
  @js.native
  class default () extends BookTwoTone
