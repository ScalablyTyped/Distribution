...
@JSImport("@ant-design/icons-vue/TableOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTableOutlinedMod extends js.Object {
  @js.native
  trait TableOutlined extends Vue {
  ...
  @js.native
  class default () extends TableOutlined
