...
@JSImport("@ant-design/icons-vue/lib/icons/CaretUpOutlined", JSImport.Namespace)
@js.native
object caretUpOutlinedMod extends js.Object {
  @js.native
  trait CaretUpOutlined extends Vue {
  ...
  @js.native
  class default () extends CaretUpOutlined
