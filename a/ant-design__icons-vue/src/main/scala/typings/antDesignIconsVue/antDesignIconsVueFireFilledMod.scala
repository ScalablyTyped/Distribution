...
@JSImport("@ant-design/icons-vue/FireFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFireFilledMod extends js.Object {
  @js.native
  trait FireFilled extends Vue {
  ...
  @js.native
  class default () extends FireFilled
