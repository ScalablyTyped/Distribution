...
@JSImport("@ant-design/icons-vue/PushpinTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVuePushpinTwoToneMod extends js.Object {
  @js.native
  trait PushpinTwoTone extends Vue {
  ...
  @js.native
  class default () extends PushpinTwoTone
