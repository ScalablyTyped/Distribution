...
@JSImport("@ant-design/icons-vue/HddOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueHddOutlinedMod extends js.Object {
  @js.native
  trait HddOutlined extends Vue {
  ...
  @js.native
  class default () extends HddOutlined
