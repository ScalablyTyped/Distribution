...
object antDesignIconsVueHddOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/HddOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/HddOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/HddOutlined", "default.inheritAttrs")
    @js.native
