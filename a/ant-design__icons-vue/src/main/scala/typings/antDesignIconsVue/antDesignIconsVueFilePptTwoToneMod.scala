...
@JSImport("@ant-design/icons-vue/FilePptTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFilePptTwoToneMod extends js.Object {
  @js.native
  trait FilePptTwoTone extends Vue {
  ...
  @js.native
  class default () extends FilePptTwoTone
