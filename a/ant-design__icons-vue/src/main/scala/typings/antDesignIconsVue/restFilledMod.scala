...
@JSImport("@ant-design/icons-vue/lib/icons/RestFilled", JSImport.Namespace)
@js.native
object restFilledMod extends js.Object {
  @js.native
  trait RestFilled extends Vue {
  ...
  @js.native
  class default () extends RestFilled
