...
@JSImport("@ant-design/icons-vue/lib/icons/AudioTwoTone", JSImport.Namespace)
@js.native
object audioTwoToneMod extends js.Object {
  @js.native
  trait AudioTwoTone extends Vue {
  ...
  @js.native
  class default () extends AudioTwoTone
