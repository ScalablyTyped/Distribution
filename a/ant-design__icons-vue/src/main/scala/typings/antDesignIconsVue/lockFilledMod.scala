...
@JSImport("@ant-design/icons-vue/lib/icons/LockFilled", JSImport.Namespace)
@js.native
object lockFilledMod extends js.Object {
  @js.native
  trait LockFilled extends Vue {
  ...
  @js.native
  class default () extends LockFilled
