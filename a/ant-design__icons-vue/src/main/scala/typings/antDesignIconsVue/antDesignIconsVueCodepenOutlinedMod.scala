...
@JSImport("@ant-design/icons-vue/CodepenOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCodepenOutlinedMod extends js.Object {
  @js.native
  trait CodepenOutlined extends Vue {
  ...
  @js.native
  class default () extends CodepenOutlined
