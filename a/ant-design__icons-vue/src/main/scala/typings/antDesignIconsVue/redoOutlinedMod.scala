...
@JSImport("@ant-design/icons-vue/lib/icons/RedoOutlined", JSImport.Namespace)
@js.native
object redoOutlinedMod extends js.Object {
  @js.native
  trait RedoOutlined extends Vue {
  ...
  @js.native
  class default () extends RedoOutlined
