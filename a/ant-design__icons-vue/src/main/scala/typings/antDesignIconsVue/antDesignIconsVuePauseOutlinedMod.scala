...
@JSImport("@ant-design/icons-vue/PauseOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVuePauseOutlinedMod extends js.Object {
  @js.native
  trait PauseOutlined extends Vue {
  ...
  @js.native
  class default () extends PauseOutlined
