...
@JSImport("@ant-design/icons-vue/AlipayOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueAlipayOutlinedMod extends js.Object {
  @js.native
  trait AlipayOutlined extends Vue {
  ...
  @js.native
  class default () extends AlipayOutlined
