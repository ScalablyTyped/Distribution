...
@JSImport("@ant-design/icons-vue/lib/icons/EnterOutlined", JSImport.Namespace)
@js.native
object enterOutlinedMod extends js.Object {
  @js.native
  trait EnterOutlined extends Vue {
  ...
  @js.native
  class default () extends EnterOutlined
