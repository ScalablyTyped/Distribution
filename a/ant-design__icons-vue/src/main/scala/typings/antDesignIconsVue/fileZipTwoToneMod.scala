...
@JSImport("@ant-design/icons-vue/lib/icons/FileZipTwoTone", JSImport.Namespace)
@js.native
object fileZipTwoToneMod extends js.Object {
  @js.native
  trait FileZipTwoTone extends Vue {
  ...
  @js.native
  class default () extends FileZipTwoTone
