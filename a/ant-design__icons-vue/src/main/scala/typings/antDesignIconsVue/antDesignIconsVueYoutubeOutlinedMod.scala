...
@JSImport("@ant-design/icons-vue/YoutubeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueYoutubeOutlinedMod extends js.Object {
  @js.native
  trait YoutubeOutlined extends Vue {
  ...
  @js.native
  class default () extends YoutubeOutlined
