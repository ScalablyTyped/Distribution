...
@JSImport("@ant-design/icons-vue/lib/icons/ShareAltOutlined", JSImport.Namespace)
@js.native
object shareAltOutlinedMod extends js.Object {
  @js.native
  trait ShareAltOutlined extends Vue {
  ...
  @js.native
  class default () extends ShareAltOutlined
