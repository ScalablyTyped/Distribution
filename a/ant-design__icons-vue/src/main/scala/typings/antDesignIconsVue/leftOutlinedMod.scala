...
@JSImport("@ant-design/icons-vue/lib/icons/LeftOutlined", JSImport.Namespace)
@js.native
object leftOutlinedMod extends js.Object {
  @js.native
  trait LeftOutlined extends Vue {
  ...
  @js.native
  class default () extends LeftOutlined
