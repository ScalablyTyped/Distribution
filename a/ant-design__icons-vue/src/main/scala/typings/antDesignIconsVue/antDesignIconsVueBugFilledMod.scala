...
@JSImport("@ant-design/icons-vue/BugFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueBugFilledMod extends js.Object {
  @js.native
  trait BugFilled extends Vue {
  ...
  @js.native
  class default () extends BugFilled
