...
@JSImport("@ant-design/icons-vue/WomanOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueWomanOutlinedMod extends js.Object {
  @js.native
  trait WomanOutlined extends Vue {
  ...
  @js.native
  class default () extends WomanOutlined
