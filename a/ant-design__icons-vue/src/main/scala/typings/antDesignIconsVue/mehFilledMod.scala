...
@JSImport("@ant-design/icons-vue/lib/icons/MehFilled", JSImport.Namespace)
@js.native
object mehFilledMod extends js.Object {
  @js.native
  trait MehFilled extends Vue {
  ...
  @js.native
  class default () extends MehFilled
