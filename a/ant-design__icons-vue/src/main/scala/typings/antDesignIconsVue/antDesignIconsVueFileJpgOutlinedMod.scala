...
@JSImport("@ant-design/icons-vue/FileJpgOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFileJpgOutlinedMod extends js.Object {
  @js.native
  trait FileJpgOutlined extends Vue {
  ...
  @js.native
  class default () extends FileJpgOutlined
