...
@JSImport("@ant-design/icons-vue/lib/icons/DiffTwoTone", JSImport.Namespace)
@js.native
object diffTwoToneMod extends js.Object {
  @js.native
  trait DiffTwoTone extends Vue {
  ...
  @js.native
  class default () extends DiffTwoTone
