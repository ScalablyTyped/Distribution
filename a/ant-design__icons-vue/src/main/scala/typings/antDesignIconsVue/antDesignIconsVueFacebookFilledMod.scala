...
@JSImport("@ant-design/icons-vue/FacebookFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFacebookFilledMod extends js.Object {
  @js.native
  trait FacebookFilled extends Vue {
  ...
  @js.native
  class default () extends FacebookFilled
