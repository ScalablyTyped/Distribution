...
@JSImport("@ant-design/icons-vue/lib/icons/DownOutlined", JSImport.Namespace)
@js.native
object downOutlinedMod extends js.Object {
  @js.native
  trait DownOutlined extends Vue {
  ...
  @js.native
  class default () extends DownOutlined
