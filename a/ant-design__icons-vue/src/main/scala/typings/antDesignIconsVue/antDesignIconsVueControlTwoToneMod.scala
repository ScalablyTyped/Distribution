...
@JSImport("@ant-design/icons-vue/ControlTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueControlTwoToneMod extends js.Object {
  @js.native
  trait ControlTwoTone extends Vue {
  ...
  @js.native
  class default () extends ControlTwoTone
