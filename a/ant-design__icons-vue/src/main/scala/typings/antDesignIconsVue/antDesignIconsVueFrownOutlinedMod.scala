...
@JSImport("@ant-design/icons-vue/FrownOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFrownOutlinedMod extends js.Object {
  @js.native
  trait FrownOutlined extends Vue {
  ...
  @js.native
  class default () extends FrownOutlined
