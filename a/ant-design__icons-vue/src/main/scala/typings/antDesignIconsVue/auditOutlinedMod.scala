...
@JSImport("@ant-design/icons-vue/lib/icons/AuditOutlined", JSImport.Namespace)
@js.native
object auditOutlinedMod extends js.Object {
  @js.native
  trait AuditOutlined extends Vue {
  ...
  @js.native
  class default () extends AuditOutlined
