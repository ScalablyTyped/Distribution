...
@JSImport("@ant-design/icons-vue/HomeTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueHomeTwoToneMod extends js.Object {
  @js.native
  trait HomeTwoTone extends Vue {
  ...
  @js.native
  class default () extends HomeTwoTone
