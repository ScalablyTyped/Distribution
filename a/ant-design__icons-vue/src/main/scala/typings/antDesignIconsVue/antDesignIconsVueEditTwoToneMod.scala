...
@JSImport("@ant-design/icons-vue/EditTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueEditTwoToneMod extends js.Object {
  @js.native
  trait EditTwoTone extends Vue {
  ...
  @js.native
  class default () extends EditTwoTone
