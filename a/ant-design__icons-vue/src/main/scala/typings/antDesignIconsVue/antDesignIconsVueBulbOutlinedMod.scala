...
@JSImport("@ant-design/icons-vue/BulbOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBulbOutlinedMod extends js.Object {
  @js.native
  trait BulbOutlined extends Vue {
  ...
  @js.native
  class default () extends BulbOutlined
