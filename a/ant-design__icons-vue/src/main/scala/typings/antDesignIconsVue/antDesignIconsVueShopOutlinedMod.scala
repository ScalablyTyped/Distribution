...
@JSImport("@ant-design/icons-vue/ShopOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueShopOutlinedMod extends js.Object {
  @js.native
  trait ShopOutlined extends Vue {
  ...
  @js.native
  class default () extends ShopOutlined
