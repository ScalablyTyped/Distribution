...
@JSImport("@ant-design/icons-vue/SoundOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSoundOutlinedMod extends js.Object {
  @js.native
  trait SoundOutlined extends Vue {
  ...
  @js.native
  class default () extends SoundOutlined
