...
@JSImport("@ant-design/icons-vue/lib/icons/UpSquareFilled", JSImport.Namespace)
@js.native
object upSquareFilledMod extends js.Object {
  @js.native
  trait UpSquareFilled extends Vue {
  ...
  @js.native
  class default () extends UpSquareFilled
