...
@JSImport("@ant-design/icons-vue/WarningTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueWarningTwoToneMod extends js.Object {
  @js.native
  trait WarningTwoTone extends Vue {
  ...
  @js.native
  class default () extends WarningTwoTone
