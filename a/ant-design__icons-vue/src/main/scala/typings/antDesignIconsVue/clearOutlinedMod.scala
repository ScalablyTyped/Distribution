...
@JSImport("@ant-design/icons-vue/lib/icons/ClearOutlined", JSImport.Namespace)
@js.native
object clearOutlinedMod extends js.Object {
  @js.native
  trait ClearOutlined extends Vue {
  ...
  @js.native
  class default () extends ClearOutlined
