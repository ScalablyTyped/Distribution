...
@JSImport("@ant-design/icons-vue/lib/icons/GifOutlined", JSImport.Namespace)
@js.native
object gifOutlinedMod extends js.Object {
  @js.native
  trait GifOutlined extends Vue {
  ...
  @js.native
  class default () extends GifOutlined
