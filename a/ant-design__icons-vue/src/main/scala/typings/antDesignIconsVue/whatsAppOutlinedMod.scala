...
@JSImport("@ant-design/icons-vue/lib/icons/WhatsAppOutlined", JSImport.Namespace)
@js.native
object whatsAppOutlinedMod extends js.Object {
  @js.native
  trait WhatsAppOutlined extends Vue {
  ...
  @js.native
  class default () extends WhatsAppOutlined
