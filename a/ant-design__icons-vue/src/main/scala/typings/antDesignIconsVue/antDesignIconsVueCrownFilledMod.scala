...
@JSImport("@ant-design/icons-vue/CrownFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueCrownFilledMod extends js.Object {
  @js.native
  trait CrownFilled extends Vue {
  ...
  @js.native
  class default () extends CrownFilled
