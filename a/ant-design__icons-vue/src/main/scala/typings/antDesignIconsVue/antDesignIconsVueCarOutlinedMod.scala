...
@JSImport("@ant-design/icons-vue/CarOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCarOutlinedMod extends js.Object {
  @js.native
  trait CarOutlined extends Vue {
  ...
  @js.native
  class default () extends CarOutlined
