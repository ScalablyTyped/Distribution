...
@JSImport("@ant-design/icons-vue/SkypeFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSkypeFilledMod extends js.Object {
  @js.native
  trait SkypeFilled extends Vue {
  ...
  @js.native
  class default () extends SkypeFilled
