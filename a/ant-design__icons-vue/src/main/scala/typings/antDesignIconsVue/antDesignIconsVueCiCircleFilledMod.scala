...
@JSImport("@ant-design/icons-vue/CiCircleFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueCiCircleFilledMod extends js.Object {
  @js.native
  trait CiCircleFilled extends Vue {
  ...
  @js.native
  class default () extends CiCircleFilled
