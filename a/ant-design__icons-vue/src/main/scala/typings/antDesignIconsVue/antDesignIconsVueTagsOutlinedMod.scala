...
@JSImport("@ant-design/icons-vue/TagsOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTagsOutlinedMod extends js.Object {
  @js.native
  trait TagsOutlined extends Vue {
  ...
  @js.native
  class default () extends TagsOutlined
