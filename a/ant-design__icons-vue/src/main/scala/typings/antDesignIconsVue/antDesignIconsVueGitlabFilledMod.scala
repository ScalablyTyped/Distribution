...
@JSImport("@ant-design/icons-vue/GitlabFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueGitlabFilledMod extends js.Object {
  @js.native
  trait GitlabFilled extends Vue {
  ...
  @js.native
  class default () extends GitlabFilled
