...
@JSImport("@ant-design/icons-vue/lib/icons/UserAddOutlined", JSImport.Namespace)
@js.native
object userAddOutlinedMod extends js.Object {
  @js.native
  trait UserAddOutlined extends Vue {
  ...
  @js.native
  class default () extends UserAddOutlined
