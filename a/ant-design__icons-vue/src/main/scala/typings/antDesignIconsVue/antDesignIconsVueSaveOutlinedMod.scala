...
@JSImport("@ant-design/icons-vue/SaveOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSaveOutlinedMod extends js.Object {
  @js.native
  trait SaveOutlined extends Vue {
  ...
  @js.native
  class default () extends SaveOutlined
