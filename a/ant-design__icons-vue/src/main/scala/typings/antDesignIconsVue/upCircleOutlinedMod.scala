...
@JSImport("@ant-design/icons-vue/lib/icons/UpCircleOutlined", JSImport.Namespace)
@js.native
object upCircleOutlinedMod extends js.Object {
  @js.native
  trait UpCircleOutlined extends Vue {
  ...
  @js.native
  class default () extends UpCircleOutlined
