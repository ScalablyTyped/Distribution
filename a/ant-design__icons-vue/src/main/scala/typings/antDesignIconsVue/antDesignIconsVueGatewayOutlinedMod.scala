...
@JSImport("@ant-design/icons-vue/GatewayOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueGatewayOutlinedMod extends js.Object {
  @js.native
  trait GatewayOutlined extends Vue {
  ...
  @js.native
  class default () extends GatewayOutlined
