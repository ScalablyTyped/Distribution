...
@JSImport("@ant-design/icons-vue/PictureOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVuePictureOutlinedMod extends js.Object {
  @js.native
  trait PictureOutlined extends Vue {
  ...
  @js.native
  class default () extends PictureOutlined
