...
@JSImport("@ant-design/icons-vue/LineOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueLineOutlinedMod extends js.Object {
  @js.native
  trait LineOutlined extends Vue {
  ...
  @js.native
  class default () extends LineOutlined
