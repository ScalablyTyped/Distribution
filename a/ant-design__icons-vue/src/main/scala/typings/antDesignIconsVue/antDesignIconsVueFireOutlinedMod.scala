...
@JSImport("@ant-design/icons-vue/FireOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFireOutlinedMod extends js.Object {
  @js.native
  trait FireOutlined extends Vue {
  ...
  @js.native
  class default () extends FireOutlined
