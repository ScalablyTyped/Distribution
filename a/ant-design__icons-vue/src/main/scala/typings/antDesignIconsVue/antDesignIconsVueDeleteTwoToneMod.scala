...
@JSImport("@ant-design/icons-vue/DeleteTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueDeleteTwoToneMod extends js.Object {
  @js.native
  trait DeleteTwoTone extends Vue {
  ...
  @js.native
  class default () extends DeleteTwoTone
