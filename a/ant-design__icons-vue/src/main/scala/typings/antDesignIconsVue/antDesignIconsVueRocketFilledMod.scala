...
@JSImport("@ant-design/icons-vue/RocketFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueRocketFilledMod extends js.Object {
  @js.native
  trait RocketFilled extends Vue {
  ...
  @js.native
  class default () extends RocketFilled
