...
@JSImport("@ant-design/icons-vue/UndoOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueUndoOutlinedMod extends js.Object {
  @js.native
  trait UndoOutlined extends Vue {
  ...
  @js.native
  class default () extends UndoOutlined
