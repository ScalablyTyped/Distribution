...
@JSImport("@ant-design/icons-vue/FilePptFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFilePptFilledMod extends js.Object {
  @js.native
  trait FilePptFilled extends Vue {
  ...
  @js.native
  class default () extends FilePptFilled
