...
@JSImport("@ant-design/icons-vue/CompassOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCompassOutlinedMod extends js.Object {
  @js.native
  trait CompassOutlined extends Vue {
  ...
  @js.native
  class default () extends CompassOutlined
