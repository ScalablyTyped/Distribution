...
object antDesignIconsVueExceptionOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/ExceptionOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/ExceptionOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/ExceptionOutlined", "default.inheritAttrs")
    @js.native
