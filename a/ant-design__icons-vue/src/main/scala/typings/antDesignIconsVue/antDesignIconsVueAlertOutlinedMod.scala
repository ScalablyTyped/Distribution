...
@JSImport("@ant-design/icons-vue/AlertOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueAlertOutlinedMod extends js.Object {
  @js.native
  trait AlertOutlined extends Vue {
  ...
  @js.native
  class default () extends AlertOutlined
