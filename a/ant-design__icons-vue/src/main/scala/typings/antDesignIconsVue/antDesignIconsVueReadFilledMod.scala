...
@JSImport("@ant-design/icons-vue/ReadFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueReadFilledMod extends js.Object {
  @js.native
  trait ReadFilled extends Vue {
  ...
  @js.native
  class default () extends ReadFilled
