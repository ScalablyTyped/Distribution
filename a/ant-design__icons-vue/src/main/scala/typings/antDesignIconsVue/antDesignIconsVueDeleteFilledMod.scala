...
@JSImport("@ant-design/icons-vue/DeleteFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueDeleteFilledMod extends js.Object {
  @js.native
  trait DeleteFilled extends Vue {
  ...
  @js.native
  class default () extends DeleteFilled
