...
@JSImport("@ant-design/icons-vue/PicLeftOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVuePicLeftOutlinedMod extends js.Object {
  @js.native
  trait PicLeftOutlined extends Vue {
  ...
  @js.native
  class default () extends PicLeftOutlined
