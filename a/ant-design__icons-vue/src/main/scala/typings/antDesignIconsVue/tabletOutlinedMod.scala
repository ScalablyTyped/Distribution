...
@JSImport("@ant-design/icons-vue/lib/icons/TabletOutlined", JSImport.Namespace)
@js.native
object tabletOutlinedMod extends js.Object {
  @js.native
  trait TabletOutlined extends Vue {
  ...
  @js.native
  class default () extends TabletOutlined
