...
@JSImport("@ant-design/icons-vue/ZoomInOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueZoomInOutlinedMod extends js.Object {
  @js.native
  trait ZoomInOutlined extends Vue {
  ...
  @js.native
  class default () extends ZoomInOutlined
