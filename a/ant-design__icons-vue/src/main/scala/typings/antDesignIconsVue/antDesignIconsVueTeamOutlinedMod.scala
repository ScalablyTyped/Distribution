...
@JSImport("@ant-design/icons-vue/TeamOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTeamOutlinedMod extends js.Object {
  @js.native
  trait TeamOutlined extends Vue {
  ...
  @js.native
  class default () extends TeamOutlined
