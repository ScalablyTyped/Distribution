...
@JSImport("@ant-design/icons-vue/SlidersOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSlidersOutlinedMod extends js.Object {
  @js.native
  trait SlidersOutlined extends Vue {
  ...
  @js.native
  class default () extends SlidersOutlined
