...
@JSImport("@ant-design/icons-vue/BellTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueBellTwoToneMod extends js.Object {
  @js.native
  trait BellTwoTone extends Vue {
  ...
  @js.native
  class default () extends BellTwoTone
