...
@JSImport("@ant-design/icons-vue/WalletFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueWalletFilledMod extends js.Object {
  @js.native
  trait WalletFilled extends Vue {
  ...
  @js.native
  class default () extends WalletFilled
