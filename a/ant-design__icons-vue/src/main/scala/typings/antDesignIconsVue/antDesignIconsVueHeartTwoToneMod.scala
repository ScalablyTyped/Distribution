...
@JSImport("@ant-design/icons-vue/HeartTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueHeartTwoToneMod extends js.Object {
  @js.native
  trait HeartTwoTone extends Vue {
  ...
  @js.native
  class default () extends HeartTwoTone
