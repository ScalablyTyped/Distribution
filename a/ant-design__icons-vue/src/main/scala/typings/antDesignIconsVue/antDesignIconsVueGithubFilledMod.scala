...
@JSImport("@ant-design/icons-vue/GithubFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueGithubFilledMod extends js.Object {
  @js.native
  trait GithubFilled extends Vue {
  ...
  @js.native
  class default () extends GithubFilled
