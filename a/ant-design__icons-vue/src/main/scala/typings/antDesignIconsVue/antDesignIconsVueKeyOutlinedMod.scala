...
@JSImport("@ant-design/icons-vue/KeyOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueKeyOutlinedMod extends js.Object {
  @js.native
  trait KeyOutlined extends Vue {
  ...
  @js.native
  class default () extends KeyOutlined
