...
@JSImport("@ant-design/icons-vue/FormOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFormOutlinedMod extends js.Object {
  @js.native
  trait FormOutlined extends Vue {
  ...
  @js.native
  class default () extends FormOutlined
