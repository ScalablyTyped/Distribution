...
@JSImport("@ant-design/icons-vue/BookOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBookOutlinedMod extends js.Object {
  @js.native
  trait BookOutlined extends Vue {
  ...
  @js.native
  class default () extends BookOutlined
