...
@JSImport("@ant-design/icons-vue/FileAddTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFileAddTwoToneMod extends js.Object {
  @js.native
  trait FileAddTwoTone extends Vue {
  ...
  @js.native
  class default () extends FileAddTwoTone
