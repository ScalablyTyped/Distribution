...
@JSImport("@ant-design/icons-vue/CloudOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCloudOutlinedMod extends js.Object {
  @js.native
  trait CloudOutlined extends Vue {
  ...
  @js.native
  class default () extends CloudOutlined
