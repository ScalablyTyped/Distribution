...
@JSImport("@ant-design/icons-vue/TagsTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueTagsTwoToneMod extends js.Object {
  @js.native
  trait TagsTwoTone extends Vue {
  ...
  @js.native
  class default () extends TagsTwoTone
