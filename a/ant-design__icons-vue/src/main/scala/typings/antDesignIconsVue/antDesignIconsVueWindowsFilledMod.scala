...
@JSImport("@ant-design/icons-vue/WindowsFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueWindowsFilledMod extends js.Object {
  @js.native
  trait WindowsFilled extends Vue {
  ...
  @js.native
  class default () extends WindowsFilled
