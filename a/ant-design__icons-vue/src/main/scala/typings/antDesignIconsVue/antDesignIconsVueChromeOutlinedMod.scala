...
@JSImport("@ant-design/icons-vue/ChromeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueChromeOutlinedMod extends js.Object {
  @js.native
  trait ChromeOutlined extends Vue {
  ...
  @js.native
  class default () extends ChromeOutlined
