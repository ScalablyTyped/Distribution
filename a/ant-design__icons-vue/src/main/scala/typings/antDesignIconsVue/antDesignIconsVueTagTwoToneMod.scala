...
@JSImport("@ant-design/icons-vue/TagTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueTagTwoToneMod extends js.Object {
  @js.native
  trait TagTwoTone extends Vue {
  ...
  @js.native
  class default () extends TagTwoTone
