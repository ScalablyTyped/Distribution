...
@JSImport("@ant-design/icons-vue/lib/icons/PushpinFilled", JSImport.Namespace)
@js.native
object pushpinFilledMod extends js.Object {
  @js.native
  trait PushpinFilled extends Vue {
  ...
  @js.native
  class default () extends PushpinFilled
