...
@JSImport("@ant-design/icons-vue/lib/icons/BellFilled", JSImport.Namespace)
@js.native
object bellFilledMod extends js.Object {
  @js.native
  trait BellFilled extends Vue {
  ...
  @js.native
  class default () extends BellFilled
