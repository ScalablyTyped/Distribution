...
@JSImport("@ant-design/icons-vue/lib/icons/LayoutOutlined", JSImport.Namespace)
@js.native
object layoutOutlinedMod extends js.Object {
  @js.native
  trait LayoutOutlined extends Vue {
  ...
  @js.native
  class default () extends LayoutOutlined
