...
@JSImport("@ant-design/icons-vue/ProjectFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueProjectFilledMod extends js.Object {
  @js.native
  trait ProjectFilled extends Vue {
  ...
  @js.native
  class default () extends ProjectFilled
