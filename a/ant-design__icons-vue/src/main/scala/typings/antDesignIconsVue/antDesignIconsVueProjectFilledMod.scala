...
object antDesignIconsVueProjectFilledMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/ProjectFilled", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/ProjectFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/ProjectFilled", "default.inheritAttrs")
    @js.native
