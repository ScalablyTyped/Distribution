...
@JSImport("@ant-design/icons-vue/FolderAddFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFolderAddFilledMod extends js.Object {
  @js.native
  trait FolderAddFilled extends Vue {
  ...
  @js.native
  class default () extends FolderAddFilled
