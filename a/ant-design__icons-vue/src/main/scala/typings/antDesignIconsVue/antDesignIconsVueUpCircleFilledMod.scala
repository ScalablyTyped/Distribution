...
@JSImport("@ant-design/icons-vue/UpCircleFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueUpCircleFilledMod extends js.Object {
  @js.native
  trait UpCircleFilled extends Vue {
  ...
  @js.native
  class default () extends UpCircleFilled
