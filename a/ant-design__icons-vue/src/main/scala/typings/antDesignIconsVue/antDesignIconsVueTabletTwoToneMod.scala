...
@JSImport("@ant-design/icons-vue/TabletTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueTabletTwoToneMod extends js.Object {
  @js.native
  trait TabletTwoTone extends Vue {
  ...
  @js.native
  class default () extends TabletTwoTone
