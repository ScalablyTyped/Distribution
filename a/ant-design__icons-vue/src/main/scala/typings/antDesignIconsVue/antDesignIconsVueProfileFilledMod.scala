...
@JSImport("@ant-design/icons-vue/ProfileFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueProfileFilledMod extends js.Object {
  @js.native
  trait ProfileFilled extends Vue {
  ...
  @js.native
  class default () extends ProfileFilled
