...
@JSImport("@ant-design/icons-vue/AlertTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueAlertTwoToneMod extends js.Object {
  @js.native
  trait AlertTwoTone extends Vue {
  ...
  @js.native
  class default () extends AlertTwoTone
