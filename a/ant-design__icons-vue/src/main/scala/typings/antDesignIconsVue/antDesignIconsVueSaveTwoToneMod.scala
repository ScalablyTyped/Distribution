...
@JSImport("@ant-design/icons-vue/SaveTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueSaveTwoToneMod extends js.Object {
  @js.native
  trait SaveTwoTone extends Vue {
  ...
  @js.native
  class default () extends SaveTwoTone
