...
@JSImport("@ant-design/icons-vue/BoxPlotTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueBoxPlotTwoToneMod extends js.Object {
  @js.native
  trait BoxPlotTwoTone extends Vue {
  ...
  @js.native
  class default () extends BoxPlotTwoTone
