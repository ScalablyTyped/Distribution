...
@JSImport("@ant-design/icons-vue/TagOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTagOutlinedMod extends js.Object {
  @js.native
  trait TagOutlined extends Vue {
  ...
  @js.native
  class default () extends TagOutlined
