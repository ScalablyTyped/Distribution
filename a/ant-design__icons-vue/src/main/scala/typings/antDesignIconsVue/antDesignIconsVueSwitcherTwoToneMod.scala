...
object antDesignIconsVueSwitcherTwoToneMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/SwitcherTwoTone", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/SwitcherTwoTone", "default.inheritAttrs")
    @js.native
