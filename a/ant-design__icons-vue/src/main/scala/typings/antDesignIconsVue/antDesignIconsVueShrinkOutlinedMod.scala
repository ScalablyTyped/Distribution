...
@JSImport("@ant-design/icons-vue/ShrinkOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueShrinkOutlinedMod extends js.Object {
  @js.native
  trait ShrinkOutlined extends Vue {
  ...
  @js.native
  class default () extends ShrinkOutlined
