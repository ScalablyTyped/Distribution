...
@JSImport("@ant-design/icons-vue/LayoutFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueLayoutFilledMod extends js.Object {
  @js.native
  trait LayoutFilled extends Vue {
  ...
  @js.native
  class default () extends LayoutFilled
