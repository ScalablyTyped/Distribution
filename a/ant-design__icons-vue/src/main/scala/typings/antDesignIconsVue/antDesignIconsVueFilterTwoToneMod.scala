...
@JSImport("@ant-design/icons-vue/FilterTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFilterTwoToneMod extends js.Object {
  @js.native
  trait FilterTwoTone extends Vue {
  ...
  @js.native
  class default () extends FilterTwoTone
