...
@JSImport("@ant-design/icons-vue/CodeTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueCodeTwoToneMod extends js.Object {
  @js.native
  trait CodeTwoTone extends Vue {
  ...
  @js.native
  class default () extends CodeTwoTone
