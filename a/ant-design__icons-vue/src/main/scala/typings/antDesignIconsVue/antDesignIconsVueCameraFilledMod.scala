...
@JSImport("@ant-design/icons-vue/CameraFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueCameraFilledMod extends js.Object {
  @js.native
  trait CameraFilled extends Vue {
  ...
  @js.native
  class default () extends CameraFilled
