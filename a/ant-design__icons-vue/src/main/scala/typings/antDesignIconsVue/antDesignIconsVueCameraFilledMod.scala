...
object antDesignIconsVueCameraFilledMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/CameraFilled", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/CameraFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/CameraFilled", "default.inheritAttrs")
    @js.native
