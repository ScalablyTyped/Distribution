...
@JSImport("@ant-design/icons-vue/ApiTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueApiTwoToneMod extends js.Object {
  @js.native
  trait ApiTwoTone extends Vue {
  ...
  @js.native
  class default () extends ApiTwoTone
