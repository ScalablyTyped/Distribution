...
@JSImport("@ant-design/icons-vue/HistoryOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueHistoryOutlinedMod extends js.Object {
  @js.native
  trait HistoryOutlined extends Vue {
  ...
  @js.native
  class default () extends HistoryOutlined
