...
@JSImport("@ant-design/icons-vue/lib/icons/EyeTwoTone", JSImport.Namespace)
@js.native
object eyeTwoToneMod extends js.Object {
  @js.native
  trait EyeTwoTone extends Vue {
  ...
  @js.native
  class default () extends EyeTwoTone
