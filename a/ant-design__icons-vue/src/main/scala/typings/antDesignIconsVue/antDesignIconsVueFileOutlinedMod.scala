...
@JSImport("@ant-design/icons-vue/FileOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFileOutlinedMod extends js.Object {
  @js.native
  trait FileOutlined extends Vue {
  ...
  @js.native
  class default () extends FileOutlined
