...
object antDesignIconsVueFileOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/FileOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/FileOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/FileOutlined", "default.inheritAttrs")
    @js.native
