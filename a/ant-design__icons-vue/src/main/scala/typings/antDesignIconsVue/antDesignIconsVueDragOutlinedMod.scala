...
@JSImport("@ant-design/icons-vue/DragOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueDragOutlinedMod extends js.Object {
  @js.native
  trait DragOutlined extends Vue {
  ...
  @js.native
  class default () extends DragOutlined
