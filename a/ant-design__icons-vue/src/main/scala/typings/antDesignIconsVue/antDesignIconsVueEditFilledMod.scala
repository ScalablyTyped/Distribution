...
@JSImport("@ant-design/icons-vue/EditFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueEditFilledMod extends js.Object {
  @js.native
  trait EditFilled extends Vue {
  ...
  @js.native
  class default () extends EditFilled
