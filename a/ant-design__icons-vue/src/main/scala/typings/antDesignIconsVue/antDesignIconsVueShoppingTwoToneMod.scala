...
@JSImport("@ant-design/icons-vue/ShoppingTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueShoppingTwoToneMod extends js.Object {
  @js.native
  trait ShoppingTwoTone extends Vue {
  ...
  @js.native
  class default () extends ShoppingTwoTone
