...
@JSImport("@ant-design/icons-vue/ShopTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueShopTwoToneMod extends js.Object {
  @js.native
  trait ShopTwoTone extends Vue {
  ...
  @js.native
  class default () extends ShopTwoTone
