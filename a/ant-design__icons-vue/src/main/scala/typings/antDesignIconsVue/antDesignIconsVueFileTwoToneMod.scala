...
@JSImport("@ant-design/icons-vue/FileTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFileTwoToneMod extends js.Object {
  @js.native
  trait FileTwoTone extends Vue {
  ...
  @js.native
  class default () extends FileTwoTone
