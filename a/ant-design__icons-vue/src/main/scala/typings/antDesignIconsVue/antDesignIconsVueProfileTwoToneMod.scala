...
@JSImport("@ant-design/icons-vue/ProfileTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueProfileTwoToneMod extends js.Object {
  @js.native
  trait ProfileTwoTone extends Vue {
  ...
  @js.native
  class default () extends ProfileTwoTone
