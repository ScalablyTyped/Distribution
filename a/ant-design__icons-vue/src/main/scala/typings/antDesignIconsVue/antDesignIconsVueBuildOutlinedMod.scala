...
@JSImport("@ant-design/icons-vue/BuildOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBuildOutlinedMod extends js.Object {
  @js.native
  trait BuildOutlined extends Vue {
  ...
  @js.native
  class default () extends BuildOutlined
