...
@JSImport("@ant-design/icons-vue/ApiFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueApiFilledMod extends js.Object {
  @js.native
  trait ApiFilled extends Vue {
  ...
  @js.native
  class default () extends ApiFilled
