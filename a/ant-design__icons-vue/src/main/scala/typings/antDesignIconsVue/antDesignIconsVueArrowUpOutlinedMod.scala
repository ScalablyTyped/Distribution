...
object antDesignIconsVueArrowUpOutlinedMod {
  
  object default {
    
    @JSImport("@ant-design/icons-vue/ArrowUpOutlined", JSImport.Default)
    @js.native
    def apply(
      props: AntdIconProps,
    ...
    @JSImport("@ant-design/icons-vue/ArrowUpOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/ArrowUpOutlined", "default.inheritAttrs")
    @js.native
