...
@JSImport("@ant-design/icons-vue/ArrowUpOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueArrowUpOutlinedMod extends js.Object {
  @js.native
  trait ArrowUpOutlined extends Vue {
  ...
  @js.native
  class default () extends ArrowUpOutlined
