...
@JSImport("@ant-design/icons-vue/FileGifOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFileGifOutlinedMod extends js.Object {
  @js.native
  trait FileGifOutlined extends Vue {
  ...
  @js.native
  class default () extends FileGifOutlined
