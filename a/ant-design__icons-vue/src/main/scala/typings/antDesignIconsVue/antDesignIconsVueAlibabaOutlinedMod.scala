...
@JSImport("@ant-design/icons-vue/AlibabaOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueAlibabaOutlinedMod extends js.Object {
  @js.native
  trait AlibabaOutlined extends Vue {
  ...
  @js.native
  class default () extends AlibabaOutlined
