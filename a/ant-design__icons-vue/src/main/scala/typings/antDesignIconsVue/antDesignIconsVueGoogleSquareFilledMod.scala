...
object antDesignIconsVueGoogleSquareFilledMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/GoogleSquareFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/GoogleSquareFilled", "default.inheritAttrs")
    @js.native
