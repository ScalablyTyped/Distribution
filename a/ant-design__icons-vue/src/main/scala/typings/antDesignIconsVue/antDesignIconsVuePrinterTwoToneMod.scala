...
@JSImport("@ant-design/icons-vue/PrinterTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVuePrinterTwoToneMod extends js.Object {
  @js.native
  trait PrinterTwoTone extends Vue {
  ...
  @js.native
  class default () extends PrinterTwoTone
