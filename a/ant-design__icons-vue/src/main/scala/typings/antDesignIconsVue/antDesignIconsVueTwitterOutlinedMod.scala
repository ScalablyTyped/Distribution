...
@JSImport("@ant-design/icons-vue/TwitterOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTwitterOutlinedMod extends js.Object {
  @js.native
  trait TwitterOutlined extends Vue {
  ...
  @js.native
  class default () extends TwitterOutlined
