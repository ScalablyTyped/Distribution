...
@JSImport("@ant-design/icons-vue/lib/icons/MobileOutlined", JSImport.Namespace)
@js.native
object mobileOutlinedMod extends js.Object {
  @js.native
  trait MobileOutlined extends Vue {
  ...
  @js.native
  class default () extends MobileOutlined
