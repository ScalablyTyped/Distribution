...
@JSImport("@ant-design/icons-vue/MoreOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueMoreOutlinedMod extends js.Object {
  @js.native
  trait MoreOutlined extends Vue {
  ...
  @js.native
  class default () extends MoreOutlined
