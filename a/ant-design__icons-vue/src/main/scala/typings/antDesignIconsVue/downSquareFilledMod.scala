...
@JSImport("@ant-design/icons-vue/lib/icons/DownSquareFilled", JSImport.Namespace)
@js.native
object downSquareFilledMod extends js.Object {
  @js.native
  trait DownSquareFilled extends Vue {
  ...
  @js.native
  class default () extends DownSquareFilled
