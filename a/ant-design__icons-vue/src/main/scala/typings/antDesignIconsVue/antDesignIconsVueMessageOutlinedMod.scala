...
@JSImport("@ant-design/icons-vue/MessageOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueMessageOutlinedMod extends js.Object {
  @js.native
  trait MessageOutlined extends Vue {
  ...
  @js.native
  class default () extends MessageOutlined
