...
@JSImport("@ant-design/icons-vue/ProfileOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueProfileOutlinedMod extends js.Object {
  @js.native
  trait ProfileOutlined extends Vue {
  ...
  @js.native
  class default () extends ProfileOutlined
