...
@JSImport("@ant-design/icons-vue/ScissorOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueScissorOutlinedMod extends js.Object {
  @js.native
  trait ScissorOutlined extends Vue {
  ...
  @js.native
  class default () extends ScissorOutlined
