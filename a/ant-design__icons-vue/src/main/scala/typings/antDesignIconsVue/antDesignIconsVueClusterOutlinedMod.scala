...
object antDesignIconsVueClusterOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/ClusterOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/ClusterOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/ClusterOutlined", "default.inheritAttrs")
    @js.native
