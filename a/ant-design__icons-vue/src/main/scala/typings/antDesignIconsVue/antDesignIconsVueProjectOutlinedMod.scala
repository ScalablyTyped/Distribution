...
@JSImport("@ant-design/icons-vue/ProjectOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueProjectOutlinedMod extends js.Object {
  @js.native
  trait ProjectOutlined extends Vue {
  ...
  @js.native
  class default () extends ProjectOutlined
