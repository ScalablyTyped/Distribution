...
@JSImport("@ant-design/icons-vue/LikeTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueLikeTwoToneMod extends js.Object {
  @js.native
  trait LikeTwoTone extends Vue {
  ...
  @js.native
  class default () extends LikeTwoTone
