...
@JSImport("@ant-design/icons-vue/Html5Filled", JSImport.Namespace)
@js.native
object antDesignIconsVueHtml5FilledMod extends js.Object {
  @js.native
  trait Html5Filled extends Vue {
  ...
  @js.native
  class default () extends Html5Filled
