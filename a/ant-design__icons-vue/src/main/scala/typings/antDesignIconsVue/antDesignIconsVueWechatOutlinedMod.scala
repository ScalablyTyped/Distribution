...
@JSImport("@ant-design/icons-vue/WechatOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueWechatOutlinedMod extends js.Object {
  @js.native
  trait WechatOutlined extends Vue {
  ...
  @js.native
  class default () extends WechatOutlined
