...
@JSImport("@ant-design/icons-vue/UserOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueUserOutlinedMod extends js.Object {
  @js.native
  trait UserOutlined extends Vue {
  ...
  @js.native
  class default () extends UserOutlined
