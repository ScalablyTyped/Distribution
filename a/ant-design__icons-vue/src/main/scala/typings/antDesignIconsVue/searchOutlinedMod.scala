...
@JSImport("@ant-design/icons-vue/lib/icons/SearchOutlined", JSImport.Namespace)
@js.native
object searchOutlinedMod extends js.Object {
  @js.native
  trait SearchOutlined extends Vue {
  ...
  @js.native
  class default () extends SearchOutlined
