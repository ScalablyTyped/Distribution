...
@JSImport("@ant-design/icons-vue/lib/icons/BgColorsOutlined", JSImport.Namespace)
@js.native
object bgColorsOutlinedMod extends js.Object {
  @js.native
  trait BgColorsOutlined extends Vue {
  ...
  @js.native
  class default () extends BgColorsOutlined
