...
@JSImport("@ant-design/icons-vue/SettingFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSettingFilledMod extends js.Object {
  @js.native
  trait SettingFilled extends Vue {
  ...
  @js.native
  class default () extends SettingFilled
