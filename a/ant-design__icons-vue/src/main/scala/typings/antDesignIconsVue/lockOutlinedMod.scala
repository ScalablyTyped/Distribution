...
@JSImport("@ant-design/icons-vue/lib/icons/LockOutlined", JSImport.Namespace)
@js.native
object lockOutlinedMod extends js.Object {
  @js.native
  trait LockOutlined extends Vue {
  ...
  @js.native
  class default () extends LockOutlined
