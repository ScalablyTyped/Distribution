...
@JSImport("@ant-design/icons-vue/lib/icons/AimOutlined", JSImport.Namespace)
@js.native
object aimOutlinedMod extends js.Object {
  @js.native
  trait AimOutlined extends Vue {
  ...
  @js.native
  class default () extends AimOutlined
