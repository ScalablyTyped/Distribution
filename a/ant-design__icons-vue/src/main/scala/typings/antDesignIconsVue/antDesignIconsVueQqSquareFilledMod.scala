...
@JSImport("@ant-design/icons-vue/QqSquareFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueQqSquareFilledMod extends js.Object {
  @js.native
  trait QqSquareFilled extends Vue {
  ...
  @js.native
  class default () extends QqSquareFilled
