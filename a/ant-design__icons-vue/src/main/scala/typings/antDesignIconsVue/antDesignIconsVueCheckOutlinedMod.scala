...
@JSImport("@ant-design/icons-vue/CheckOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCheckOutlinedMod extends js.Object {
  @js.native
  trait CheckOutlined extends Vue {
  ...
  @js.native
  class default () extends CheckOutlined
