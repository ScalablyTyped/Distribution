...
@JSImport("@ant-design/icons-vue/FileWordFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFileWordFilledMod extends js.Object {
  @js.native
  trait FileWordFilled extends Vue {
  ...
  @js.native
  class default () extends FileWordFilled
