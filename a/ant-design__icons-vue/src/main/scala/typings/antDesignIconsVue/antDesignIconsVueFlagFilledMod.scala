...
@JSImport("@ant-design/icons-vue/FlagFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFlagFilledMod extends js.Object {
  @js.native
  trait FlagFilled extends Vue {
  ...
  @js.native
  class default () extends FlagFilled
