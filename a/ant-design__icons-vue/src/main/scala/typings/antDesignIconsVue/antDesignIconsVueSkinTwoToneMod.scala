...
@JSImport("@ant-design/icons-vue/SkinTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueSkinTwoToneMod extends js.Object {
  @js.native
  trait SkinTwoTone extends Vue {
  ...
  @js.native
  class default () extends SkinTwoTone
