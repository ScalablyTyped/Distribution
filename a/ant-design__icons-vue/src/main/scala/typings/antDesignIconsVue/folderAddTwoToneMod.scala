...
@JSImport("@ant-design/icons-vue/lib/icons/FolderAddTwoTone", JSImport.Namespace)
@js.native
object folderAddTwoToneMod extends js.Object {
  @js.native
  trait FolderAddTwoTone extends Vue {
  ...
  @js.native
  class default () extends FolderAddTwoTone
