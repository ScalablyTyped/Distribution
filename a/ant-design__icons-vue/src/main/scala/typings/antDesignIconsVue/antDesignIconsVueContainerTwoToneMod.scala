...
object antDesignIconsVueContainerTwoToneMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/ContainerTwoTone", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/ContainerTwoTone", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/ContainerTwoTone", "default.inheritAttrs")
    @js.native
