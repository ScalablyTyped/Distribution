...
@JSImport("@ant-design/icons-vue/TrophyOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueTrophyOutlinedMod extends js.Object {
  @js.native
  trait TrophyOutlined extends Vue {
  ...
  @js.native
  class default () extends TrophyOutlined
