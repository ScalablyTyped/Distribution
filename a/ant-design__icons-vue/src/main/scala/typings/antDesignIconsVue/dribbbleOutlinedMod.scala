...
@JSImport("@ant-design/icons-vue/lib/icons/DribbbleOutlined", JSImport.Namespace)
@js.native
object dribbbleOutlinedMod extends js.Object {
  @js.native
  trait DribbbleOutlined extends Vue {
  ...
  @js.native
  class default () extends DribbbleOutlined
