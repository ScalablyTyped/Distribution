...
@JSImport("@ant-design/icons-vue/ProjectTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueProjectTwoToneMod extends js.Object {
  @js.native
  trait ProjectTwoTone extends Vue {
  ...
  @js.native
  class default () extends ProjectTwoTone
