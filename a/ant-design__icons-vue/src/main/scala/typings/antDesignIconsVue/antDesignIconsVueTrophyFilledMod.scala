...
@JSImport("@ant-design/icons-vue/TrophyFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueTrophyFilledMod extends js.Object {
  @js.native
  trait TrophyFilled extends Vue {
  ...
  @js.native
  class default () extends TrophyFilled
