...
@JSImport("@ant-design/icons-vue/DatabaseFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueDatabaseFilledMod extends js.Object {
  @js.native
  trait DatabaseFilled extends Vue {
  ...
  @js.native
  class default () extends DatabaseFilled
