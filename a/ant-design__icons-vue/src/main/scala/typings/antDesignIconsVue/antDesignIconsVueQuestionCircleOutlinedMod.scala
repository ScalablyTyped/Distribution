...
object antDesignIconsVueQuestionCircleOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/QuestionCircleOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/QuestionCircleOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/QuestionCircleOutlined", "default.inheritAttrs")
    @js.native
