...
object SmileOutlined {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "SmileOutlined.displayName")
  @js.native
  def displayName: String = js.native
  inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "SmileOutlined.inheritAttrs")
  @js.native
