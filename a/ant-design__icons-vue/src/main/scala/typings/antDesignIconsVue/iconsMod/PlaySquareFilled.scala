...
object PlaySquareFilled {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "PlaySquareFilled.displayName")
  @js.native
  def displayName: String = js.native
  inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "PlaySquareFilled.inheritAttrs")
  @js.native
