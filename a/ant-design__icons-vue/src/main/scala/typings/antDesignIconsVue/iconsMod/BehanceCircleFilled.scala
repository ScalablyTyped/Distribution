...
object BehanceCircleFilled {
  ...
  @JSImport("@ant-design/icons-vue/lib/icons", "BehanceCircleFilled.displayName")
  @js.native
  def displayName: String = js.native
  inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib/icons", "BehanceCircleFilled.inheritAttrs")
  @js.native
