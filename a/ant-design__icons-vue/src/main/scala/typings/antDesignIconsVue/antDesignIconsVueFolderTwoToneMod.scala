...
@JSImport("@ant-design/icons-vue/FolderTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFolderTwoToneMod extends js.Object {
  @js.native
  trait FolderTwoTone extends Vue {
  ...
  @js.native
  class default () extends FolderTwoTone
