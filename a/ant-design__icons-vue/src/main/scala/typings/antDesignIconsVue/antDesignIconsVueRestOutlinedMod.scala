...
@JSImport("@ant-design/icons-vue/RestOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueRestOutlinedMod extends js.Object {
  @js.native
  trait RestOutlined extends Vue {
  ...
  @js.native
  class default () extends RestOutlined
