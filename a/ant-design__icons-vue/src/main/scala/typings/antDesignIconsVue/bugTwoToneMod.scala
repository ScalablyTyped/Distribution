...
@JSImport("@ant-design/icons-vue/lib/icons/BugTwoTone", JSImport.Namespace)
@js.native
object bugTwoToneMod extends js.Object {
  @js.native
  trait BugTwoTone extends Vue {
  ...
  @js.native
  class default () extends BugTwoTone
