...
@JSImport("@ant-design/icons-vue/TabletFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueTabletFilledMod extends js.Object {
  @js.native
  trait TabletFilled extends Vue {
  ...
  @js.native
  class default () extends TabletFilled
