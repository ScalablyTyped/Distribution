...
@JSImport("@ant-design/icons-vue/lib/icons/BankFilled", JSImport.Namespace)
@js.native
object bankFilledMod extends js.Object {
  @js.native
  trait BankFilled extends Vue {
  ...
  @js.native
  class default () extends BankFilled
