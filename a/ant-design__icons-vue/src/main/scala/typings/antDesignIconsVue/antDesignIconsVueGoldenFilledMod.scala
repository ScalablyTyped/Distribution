...
@JSImport("@ant-design/icons-vue/GoldenFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueGoldenFilledMod extends js.Object {
  @js.native
  trait GoldenFilled extends Vue {
  ...
  @js.native
  class default () extends GoldenFilled
