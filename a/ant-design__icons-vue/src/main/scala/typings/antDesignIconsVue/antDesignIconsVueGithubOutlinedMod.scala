...
@JSImport("@ant-design/icons-vue/GithubOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueGithubOutlinedMod extends js.Object {
  @js.native
  trait GithubOutlined extends Vue {
  ...
  @js.native
  class default () extends GithubOutlined
