...
@JSImport("@ant-design/icons-vue/FileZipFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFileZipFilledMod extends js.Object {
  @js.native
  trait FileZipFilled extends Vue {
  ...
  @js.native
  class default () extends FileZipFilled
