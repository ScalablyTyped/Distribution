...
@JSImport("@ant-design/icons-vue/StopOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueStopOutlinedMod extends js.Object {
  @js.native
  trait StopOutlined extends Vue {
  ...
  @js.native
  class default () extends StopOutlined
