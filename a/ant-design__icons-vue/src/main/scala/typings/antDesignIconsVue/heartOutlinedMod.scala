...
@JSImport("@ant-design/icons-vue/lib/icons/HeartOutlined", JSImport.Namespace)
@js.native
object heartOutlinedMod extends js.Object {
  @js.native
  trait HeartOutlined extends Vue {
  ...
  @js.native
  class default () extends HeartOutlined
