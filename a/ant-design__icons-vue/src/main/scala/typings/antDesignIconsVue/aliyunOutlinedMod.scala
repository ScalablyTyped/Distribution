...
@JSImport("@ant-design/icons-vue/lib/icons/AliyunOutlined", JSImport.Namespace)
@js.native
object aliyunOutlinedMod extends js.Object {
  @js.native
  trait AliyunOutlined extends Vue {
  ...
  @js.native
  class default () extends AliyunOutlined
