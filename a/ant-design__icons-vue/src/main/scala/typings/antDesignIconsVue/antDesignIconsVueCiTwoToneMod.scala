...
@JSImport("@ant-design/icons-vue/CiTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueCiTwoToneMod extends js.Object {
  @js.native
  trait CiTwoTone extends Vue {
  ...
  @js.native
  class default () extends CiTwoTone
