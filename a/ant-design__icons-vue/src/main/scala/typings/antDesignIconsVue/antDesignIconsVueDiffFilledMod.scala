...
@JSImport("@ant-design/icons-vue/DiffFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueDiffFilledMod extends js.Object {
  @js.native
  trait DiffFilled extends Vue {
  ...
  @js.native
  class default () extends DiffFilled
