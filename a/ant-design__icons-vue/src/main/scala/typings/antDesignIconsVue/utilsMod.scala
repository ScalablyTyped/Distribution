...
object utilsMod {
  ...
  @scala.inline
  def warn(valid: Boolean, message: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("warn")(valid.asInstanceOf[js.Any], message.asInstanceOf[js.Any])).asInstanceOf[Unit]
