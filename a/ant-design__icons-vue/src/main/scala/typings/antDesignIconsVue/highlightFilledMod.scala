...
@JSImport("@ant-design/icons-vue/lib/icons/HighlightFilled", JSImport.Namespace)
@js.native
object highlightFilledMod extends js.Object {
  @js.native
  trait HighlightFilled extends Vue {
  ...
  @js.native
  class default () extends HighlightFilled
