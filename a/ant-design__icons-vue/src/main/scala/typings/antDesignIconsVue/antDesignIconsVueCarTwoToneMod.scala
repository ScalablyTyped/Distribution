...
@JSImport("@ant-design/icons-vue/CarTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueCarTwoToneMod extends js.Object {
  @js.native
  trait CarTwoTone extends Vue {
  ...
  @js.native
  class default () extends CarTwoTone
