...
@JSImport("@ant-design/icons-vue/FolderFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFolderFilledMod extends js.Object {
  @js.native
  trait FolderFilled extends Vue {
  ...
  @js.native
  class default () extends FolderFilled
