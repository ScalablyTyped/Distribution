...
@JSImport("@ant-design/icons-vue/UnlockOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueUnlockOutlinedMod extends js.Object {
  @js.native
  trait UnlockOutlined extends Vue {
  ...
  @js.native
  class default () extends UnlockOutlined
