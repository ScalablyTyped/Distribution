...
@JSImport("@ant-design/icons-vue/lib/icons/MailFilled", JSImport.Namespace)
@js.native
object mailFilledMod extends js.Object {
  @js.native
  trait MailFilled extends Vue {
  ...
  @js.native
  class default () extends MailFilled
