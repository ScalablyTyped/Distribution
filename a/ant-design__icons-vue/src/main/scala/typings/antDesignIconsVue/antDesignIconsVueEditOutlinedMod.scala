...
@JSImport("@ant-design/icons-vue/EditOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueEditOutlinedMod extends js.Object {
  @js.native
  trait EditOutlined extends Vue {
  ...
  @js.native
  class default () extends EditOutlined
