...
@JSImport("@ant-design/icons-vue/lib/icons/BulbFilled", JSImport.Namespace)
@js.native
object bulbFilledMod extends js.Object {
  @js.native
  trait BulbFilled extends Vue {
  ...
  @js.native
  class default () extends BulbFilled
