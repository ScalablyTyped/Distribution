...
@JSImport("@ant-design/icons-vue/EuroTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueEuroTwoToneMod extends js.Object {
  @js.native
  trait EuroTwoTone extends Vue {
  ...
  @js.native
  class default () extends EuroTwoTone
