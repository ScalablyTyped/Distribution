...
@JSImport("@ant-design/icons-vue/lib/icons/LockTwoTone", JSImport.Namespace)
@js.native
object lockTwoToneMod extends js.Object {
  @js.native
  trait LockTwoTone extends Vue {
  ...
  @js.native
  class default () extends LockTwoTone
