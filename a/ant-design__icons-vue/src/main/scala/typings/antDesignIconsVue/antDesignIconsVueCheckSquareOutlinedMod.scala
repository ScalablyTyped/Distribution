...
object antDesignIconsVueCheckSquareOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/CheckSquareOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/CheckSquareOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/CheckSquareOutlined", "default.inheritAttrs")
    @js.native
