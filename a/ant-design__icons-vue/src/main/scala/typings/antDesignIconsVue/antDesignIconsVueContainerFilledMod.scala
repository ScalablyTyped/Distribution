...
@JSImport("@ant-design/icons-vue/ContainerFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueContainerFilledMod extends js.Object {
  @js.native
  trait ContainerFilled extends Vue {
  ...
  @js.native
  class default () extends ContainerFilled
