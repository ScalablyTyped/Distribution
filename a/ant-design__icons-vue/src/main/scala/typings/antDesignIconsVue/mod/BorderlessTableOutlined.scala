package typings.antDesignIconsVue.mod
...
object BorderlessTableOutlined {
  ...
  @JSImport("@ant-design/icons-vue/lib", "BorderlessTableOutlined.displayName")
  @js.native
  def displayName: String = js.native
  inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
  
  @JSImport("@ant-design/icons-vue/lib", "BorderlessTableOutlined.inheritAttrs")
  @js.native
