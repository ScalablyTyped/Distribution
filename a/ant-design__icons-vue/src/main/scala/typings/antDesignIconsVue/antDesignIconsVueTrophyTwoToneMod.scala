...
@JSImport("@ant-design/icons-vue/TrophyTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueTrophyTwoToneMod extends js.Object {
  @js.native
  trait TrophyTwoTone extends Vue {
  ...
  @js.native
  class default () extends TrophyTwoTone
