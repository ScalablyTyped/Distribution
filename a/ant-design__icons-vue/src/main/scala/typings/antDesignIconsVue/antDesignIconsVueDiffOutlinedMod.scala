...
@JSImport("@ant-design/icons-vue/DiffOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueDiffOutlinedMod extends js.Object {
  @js.native
  trait DiffOutlined extends Vue {
  ...
  @js.native
  class default () extends DiffOutlined
