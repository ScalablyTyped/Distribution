...
@JSImport("@ant-design/icons-vue/lib/icons/FolderOpenFilled", JSImport.Namespace)
@js.native
object folderOpenFilledMod extends js.Object {
  @js.native
  trait FolderOpenFilled extends Vue {
  ...
  @js.native
  class default () extends FolderOpenFilled
