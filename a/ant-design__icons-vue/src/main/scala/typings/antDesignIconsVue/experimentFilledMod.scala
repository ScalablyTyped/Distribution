...
@JSImport("@ant-design/icons-vue/lib/icons/ExperimentFilled", JSImport.Namespace)
@js.native
object experimentFilledMod extends js.Object {
  @js.native
  trait ExperimentFilled extends Vue {
  ...
  @js.native
  class default () extends ExperimentFilled
