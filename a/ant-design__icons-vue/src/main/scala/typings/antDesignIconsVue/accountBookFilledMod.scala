...
@JSImport("@ant-design/icons-vue/AccountBookFilled", JSImport.Namespace)
@js.native
object accountBookFilledMod extends js.Object {
  @js.native
  trait AccountBookFilled extends Vue {
  ...
  @js.native
  class default () extends AccountBookFilled
