...
@JSImport("@ant-design/icons-vue/ApiOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueApiOutlinedMod extends js.Object {
  @js.native
  trait ApiOutlined extends Vue {
  ...
  @js.native
  class default () extends ApiOutlined
