...
@JSImport("@ant-design/icons-vue/UpCircleTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueUpCircleTwoToneMod extends js.Object {
  @js.native
  trait UpCircleTwoTone extends Vue {
  ...
  @js.native
  class default () extends UpCircleTwoTone
