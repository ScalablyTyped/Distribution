...
@JSImport("@ant-design/icons-vue/FundOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFundOutlinedMod extends js.Object {
  @js.native
  trait FundOutlined extends Vue {
  ...
  @js.native
  class default () extends FundOutlined
