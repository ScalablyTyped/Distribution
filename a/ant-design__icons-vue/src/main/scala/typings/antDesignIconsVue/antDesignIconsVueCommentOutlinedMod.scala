...
@JSImport("@ant-design/icons-vue/CommentOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCommentOutlinedMod extends js.Object {
  @js.native
  trait CommentOutlined extends Vue {
  ...
  @js.native
  class default () extends CommentOutlined
