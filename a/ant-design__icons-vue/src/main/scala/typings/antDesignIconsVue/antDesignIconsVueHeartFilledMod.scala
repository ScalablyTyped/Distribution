...
@JSImport("@ant-design/icons-vue/HeartFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueHeartFilledMod extends js.Object {
  @js.native
  trait HeartFilled extends Vue {
  ...
  @js.native
  class default () extends HeartFilled
