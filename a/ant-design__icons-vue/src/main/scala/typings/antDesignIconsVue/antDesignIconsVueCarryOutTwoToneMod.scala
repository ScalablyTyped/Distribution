...
@JSImport("@ant-design/icons-vue/CarryOutTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueCarryOutTwoToneMod extends js.Object {
  @js.native
  trait CarryOutTwoTone extends Vue {
  ...
  @js.native
  class default () extends CarryOutTwoTone
