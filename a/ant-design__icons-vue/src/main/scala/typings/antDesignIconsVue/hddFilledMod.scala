...
@JSImport("@ant-design/icons-vue/lib/icons/HddFilled", JSImport.Namespace)
@js.native
object hddFilledMod extends js.Object {
  @js.native
  trait HddFilled extends Vue {
  ...
  @js.native
  class default () extends HddFilled
