...
@JSImport("@ant-design/icons-vue/WeiboOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueWeiboOutlinedMod extends js.Object {
  @js.native
  trait WeiboOutlined extends Vue {
  ...
  @js.native
  class default () extends WeiboOutlined
