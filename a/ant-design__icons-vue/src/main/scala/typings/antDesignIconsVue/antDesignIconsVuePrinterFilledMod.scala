...
@JSImport("@ant-design/icons-vue/PrinterFilled", JSImport.Namespace)
@js.native
object antDesignIconsVuePrinterFilledMod extends js.Object {
  @js.native
  trait PrinterFilled extends Vue {
  ...
  @js.native
  class default () extends PrinterFilled
