...
@JSImport("@ant-design/icons-vue/UploadOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueUploadOutlinedMod extends js.Object {
  @js.native
  trait UploadOutlined extends Vue {
  ...
  @js.native
  class default () extends UploadOutlined
