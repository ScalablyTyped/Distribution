...
@JSImport("@ant-design/icons-vue/GitlabOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueGitlabOutlinedMod extends js.Object {
  @js.native
  trait GitlabOutlined extends Vue {
  ...
  @js.native
  class default () extends GitlabOutlined
