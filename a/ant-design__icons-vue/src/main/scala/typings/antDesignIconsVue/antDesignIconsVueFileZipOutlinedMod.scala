...
@JSImport("@ant-design/icons-vue/FileZipOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFileZipOutlinedMod extends js.Object {
  @js.native
  trait FileZipOutlined extends Vue {
  ...
  @js.native
  class default () extends FileZipOutlined
