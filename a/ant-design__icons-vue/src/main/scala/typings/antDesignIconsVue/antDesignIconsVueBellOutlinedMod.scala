...
@JSImport("@ant-design/icons-vue/BellOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBellOutlinedMod extends js.Object {
  @js.native
  trait BellOutlined extends Vue {
  ...
  @js.native
  class default () extends BellOutlined
