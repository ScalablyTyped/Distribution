...
@JSImport("@ant-design/icons-vue/BugOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBugOutlinedMod extends js.Object {
  @js.native
  trait BugOutlined extends Vue {
  ...
  @js.native
  class default () extends BugOutlined
