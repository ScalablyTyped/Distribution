...
@JSImport("@ant-design/icons-vue/lib/icons/AppleOutlined", JSImport.Namespace)
@js.native
object appleOutlinedMod extends js.Object {
  @js.native
  trait AppleOutlined extends Vue {
  ...
  @js.native
  class default () extends AppleOutlined
