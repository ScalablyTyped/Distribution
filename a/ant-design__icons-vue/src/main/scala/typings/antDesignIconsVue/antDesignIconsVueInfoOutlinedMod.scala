...
@JSImport("@ant-design/icons-vue/InfoOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueInfoOutlinedMod extends js.Object {
  @js.native
  trait InfoOutlined extends Vue {
  ...
  @js.native
  class default () extends InfoOutlined
