...
@JSImport("@ant-design/icons-vue/BulbTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueBulbTwoToneMod extends js.Object {
  @js.native
  trait BulbTwoTone extends Vue {
  ...
  @js.native
  class default () extends BulbTwoTone
