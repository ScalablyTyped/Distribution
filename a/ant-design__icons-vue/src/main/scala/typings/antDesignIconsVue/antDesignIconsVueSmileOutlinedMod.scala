...
@JSImport("@ant-design/icons-vue/SmileOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSmileOutlinedMod extends js.Object {
  @js.native
  trait SmileOutlined extends Vue {
  ...
  @js.native
  class default () extends SmileOutlined
