...
@JSImport("@ant-design/icons-vue/lib/icons/FunctionOutlined", JSImport.Namespace)
@js.native
object functionOutlinedMod extends js.Object {
  @js.native
  trait FunctionOutlined extends Vue {
  ...
  @js.native
  class default () extends FunctionOutlined
