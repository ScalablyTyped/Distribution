...
@JSImport("@ant-design/icons-vue/BuildTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueBuildTwoToneMod extends js.Object {
  @js.native
  trait BuildTwoTone extends Vue {
  ...
  @js.native
  class default () extends BuildTwoTone
