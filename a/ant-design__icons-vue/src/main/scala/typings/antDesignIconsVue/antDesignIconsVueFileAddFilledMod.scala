...
@JSImport("@ant-design/icons-vue/FileAddFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFileAddFilledMod extends js.Object {
  @js.native
  trait FileAddFilled extends Vue {
  ...
  @js.native
  class default () extends FileAddFilled
