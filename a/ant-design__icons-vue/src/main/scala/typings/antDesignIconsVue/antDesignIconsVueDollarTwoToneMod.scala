...
@JSImport("@ant-design/icons-vue/DollarTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueDollarTwoToneMod extends js.Object {
  @js.native
  trait DollarTwoTone extends Vue {
  ...
  @js.native
  class default () extends DollarTwoTone
