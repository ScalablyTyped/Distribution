...
@JSImport("@ant-design/icons-vue/StarTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueStarTwoToneMod extends js.Object {
  @js.native
  trait StarTwoTone extends Vue {
  ...
  @js.native
  class default () extends StarTwoTone
