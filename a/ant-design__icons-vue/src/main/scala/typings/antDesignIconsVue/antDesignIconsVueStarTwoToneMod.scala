...
object antDesignIconsVueStarTwoToneMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/StarTwoTone", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/StarTwoTone", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/StarTwoTone", "default.inheritAttrs")
    @js.native
