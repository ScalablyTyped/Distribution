...
@JSImport("@ant-design/icons-vue/RiseOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueRiseOutlinedMod extends js.Object {
  @js.native
  trait RiseOutlined extends Vue {
  ...
  @js.native
  class default () extends RiseOutlined
