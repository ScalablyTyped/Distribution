...
@JSImport("@ant-design/icons-vue/lib/icons/DesktopOutlined", JSImport.Namespace)
@js.native
object desktopOutlinedMod extends js.Object {
  @js.native
  trait DesktopOutlined extends Vue {
  ...
  @js.native
  class default () extends DesktopOutlined
