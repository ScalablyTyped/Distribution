...
@JSImport("@ant-design/icons-vue/AndroidOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueAndroidOutlinedMod extends js.Object {
  @js.native
  trait AndroidOutlined extends Vue {
  ...
  @js.native
  class default () extends AndroidOutlined
