...
@JSImport("@ant-design/icons-vue/lib/icons/QqOutlined", JSImport.Namespace)
@js.native
object qqOutlinedMod extends js.Object {
  @js.native
  trait QqOutlined extends Vue {
  ...
  @js.native
  class default () extends QqOutlined
