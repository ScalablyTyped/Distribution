...
@JSImport("@ant-design/icons-vue/lib/icons/ToTopOutlined", JSImport.Namespace)
@js.native
object toTopOutlinedMod extends js.Object {
  @js.native
  trait ToTopOutlined extends Vue {
  ...
  @js.native
  class default () extends ToTopOutlined
