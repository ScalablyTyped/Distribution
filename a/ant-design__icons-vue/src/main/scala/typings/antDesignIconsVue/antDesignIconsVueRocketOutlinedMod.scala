...
object antDesignIconsVueRocketOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/RocketOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/RocketOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/RocketOutlined", "default.inheritAttrs")
    @js.native
