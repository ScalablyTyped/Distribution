...
@JSImport("@ant-design/icons-vue/RocketOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueRocketOutlinedMod extends js.Object {
  @js.native
  trait RocketOutlined extends Vue {
  ...
  @js.native
  class default () extends RocketOutlined
