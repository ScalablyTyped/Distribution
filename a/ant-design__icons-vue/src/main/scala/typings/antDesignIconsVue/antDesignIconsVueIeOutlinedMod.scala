...
@JSImport("@ant-design/icons-vue/IeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueIeOutlinedMod extends js.Object {
  @js.native
  trait IeOutlined extends Vue {
  ...
  @js.native
  class default () extends IeOutlined
