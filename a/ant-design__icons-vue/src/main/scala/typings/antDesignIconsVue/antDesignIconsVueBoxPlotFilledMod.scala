...
@JSImport("@ant-design/icons-vue/BoxPlotFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueBoxPlotFilledMod extends js.Object {
  @js.native
  trait BoxPlotFilled extends Vue {
  ...
  @js.native
  class default () extends BoxPlotFilled
