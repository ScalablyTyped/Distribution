...
@JSImport("@ant-design/icons-vue/BarcodeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueBarcodeOutlinedMod extends js.Object {
  @js.native
  trait BarcodeOutlined extends Vue {
  ...
  @js.native
  class default () extends BarcodeOutlined
