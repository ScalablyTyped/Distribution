...
@JSImport("@ant-design/icons-vue/CopyFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueCopyFilledMod extends js.Object {
  @js.native
  trait CopyFilled extends Vue {
  ...
  @js.native
  class default () extends CopyFilled
