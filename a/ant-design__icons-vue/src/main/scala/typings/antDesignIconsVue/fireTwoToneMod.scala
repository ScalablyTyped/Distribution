...
@JSImport("@ant-design/icons-vue/lib/icons/FireTwoTone", JSImport.Namespace)
@js.native
object fireTwoToneMod extends js.Object {
  @js.native
  trait FireTwoTone extends Vue {
  ...
  @js.native
  class default () extends FireTwoTone
