...
@JSImport("@ant-design/icons-vue/MessageFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueMessageFilledMod extends js.Object {
  @js.native
  trait MessageFilled extends Vue {
  ...
  @js.native
  class default () extends MessageFilled
