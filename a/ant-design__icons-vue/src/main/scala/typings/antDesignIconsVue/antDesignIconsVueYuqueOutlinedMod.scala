...
@JSImport("@ant-design/icons-vue/YuqueOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueYuqueOutlinedMod extends js.Object {
  @js.native
  trait YuqueOutlined extends Vue {
  ...
  @js.native
  class default () extends YuqueOutlined
