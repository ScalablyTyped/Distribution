...
@JSImport("@ant-design/icons-vue/MobileTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueMobileTwoToneMod extends js.Object {
  @js.native
  trait MobileTwoTone extends Vue {
  ...
  @js.native
  class default () extends MobileTwoTone
