...
@JSImport("@ant-design/icons-vue/UnlockFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueUnlockFilledMod extends js.Object {
  @js.native
  trait UnlockFilled extends Vue {
  ...
  @js.native
  class default () extends UnlockFilled
