...
@JSImport("@ant-design/icons-vue/SafetyOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSafetyOutlinedMod extends js.Object {
  @js.native
  trait SafetyOutlined extends Vue {
  ...
  @js.native
  class default () extends SafetyOutlined
