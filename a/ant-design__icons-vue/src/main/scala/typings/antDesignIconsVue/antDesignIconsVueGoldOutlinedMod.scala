...
@JSImport("@ant-design/icons-vue/GoldOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueGoldOutlinedMod extends js.Object {
  @js.native
  trait GoldOutlined extends Vue {
  ...
  @js.native
  class default () extends GoldOutlined
