...
@JSImport("@ant-design/icons-vue/LikeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueLikeOutlinedMod extends js.Object {
  @js.native
  trait LikeOutlined extends Vue {
  ...
  @js.native
  class default () extends LikeOutlined
