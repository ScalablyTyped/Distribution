...
@JSImport("@ant-design/icons-vue/CaretLeftFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueCaretLeftFilledMod extends js.Object {
  @js.native
  trait CaretLeftFilled extends Vue {
  ...
  @js.native
  class default () extends CaretLeftFilled
