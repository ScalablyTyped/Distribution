...
@JSImport("@ant-design/icons-vue/CrownOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCrownOutlinedMod extends js.Object {
  @js.native
  trait CrownOutlined extends Vue {
  ...
  @js.native
  class default () extends CrownOutlined
