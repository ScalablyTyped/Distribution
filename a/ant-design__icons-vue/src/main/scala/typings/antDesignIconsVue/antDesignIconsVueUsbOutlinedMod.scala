...
@JSImport("@ant-design/icons-vue/UsbOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueUsbOutlinedMod extends js.Object {
  @js.native
  trait UsbOutlined extends Vue {
  ...
  @js.native
  class default () extends UsbOutlined
