...
object antDesignIconsVueRightOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/RightOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/RightOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/RightOutlined", "default.inheritAttrs")
    @js.native
