...
@JSImport("@ant-design/icons-vue/RightOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueRightOutlinedMod extends js.Object {
  @js.native
  trait RightOutlined extends Vue {
  ...
  @js.native
  class default () extends RightOutlined
