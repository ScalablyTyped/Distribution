...
@JSImport("@ant-design/icons-vue/SubnodeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSubnodeOutlinedMod extends js.Object {
  @js.native
  trait SubnodeOutlined extends Vue {
  ...
  @js.native
  class default () extends SubnodeOutlined
