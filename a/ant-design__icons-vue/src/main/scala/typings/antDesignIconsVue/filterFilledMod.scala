...
@JSImport("@ant-design/icons-vue/lib/icons/FilterFilled", JSImport.Namespace)
@js.native
object filterFilledMod extends js.Object {
  @js.native
  trait FilterFilled extends Vue {
  ...
  @js.native
  class default () extends FilterFilled
