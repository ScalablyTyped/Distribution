...
@JSImport("@ant-design/icons-vue/lib/icons/IeSquareFilled", JSImport.Namespace)
@js.native
object ieSquareFilledMod extends js.Object {
  @js.native
  trait IeSquareFilled extends Vue {
  ...
  @js.native
  class default () extends IeSquareFilled
