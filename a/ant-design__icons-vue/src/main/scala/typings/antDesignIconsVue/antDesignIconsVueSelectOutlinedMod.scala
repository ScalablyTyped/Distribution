...
@JSImport("@ant-design/icons-vue/SelectOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSelectOutlinedMod extends js.Object {
  @js.native
  trait SelectOutlined extends Vue {
  ...
  @js.native
  class default () extends SelectOutlined
