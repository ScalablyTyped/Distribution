...
@JSImport("@ant-design/icons-vue/SmileFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSmileFilledMod extends js.Object {
  @js.native
  trait SmileFilled extends Vue {
  ...
  @js.native
  class default () extends SmileFilled
