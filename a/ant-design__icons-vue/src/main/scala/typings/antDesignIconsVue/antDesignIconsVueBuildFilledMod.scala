...
@JSImport("@ant-design/icons-vue/BuildFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueBuildFilledMod extends js.Object {
  @js.native
  trait BuildFilled extends Vue {
  ...
  @js.native
  class default () extends BuildFilled
