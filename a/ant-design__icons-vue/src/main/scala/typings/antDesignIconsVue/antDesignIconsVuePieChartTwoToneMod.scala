...
@JSImport("@ant-design/icons-vue/PieChartTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVuePieChartTwoToneMod extends js.Object {
  @js.native
  trait PieChartTwoTone extends Vue {
  ...
  @js.native
  class default () extends PieChartTwoTone
