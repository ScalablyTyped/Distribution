...
@JSImport("@ant-design/icons-vue/CiOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCiOutlinedMod extends js.Object {
  @js.native
  trait CiOutlined extends Vue {
  ...
  @js.native
  class default () extends CiOutlined
