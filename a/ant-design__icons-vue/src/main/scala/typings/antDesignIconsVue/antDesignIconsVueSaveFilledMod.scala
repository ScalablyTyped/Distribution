...
@JSImport("@ant-design/icons-vue/SaveFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSaveFilledMod extends js.Object {
  @js.native
  trait SaveFilled extends Vue {
  ...
  @js.native
  class default () extends SaveFilled
