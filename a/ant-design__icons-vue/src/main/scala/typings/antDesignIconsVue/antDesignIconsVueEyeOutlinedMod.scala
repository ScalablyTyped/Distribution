...
@JSImport("@ant-design/icons-vue/EyeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueEyeOutlinedMod extends js.Object {
  @js.native
  trait EyeOutlined extends Vue {
  ...
  @js.native
  class default () extends EyeOutlined
