...
@JSImport("@ant-design/icons-vue/SlidersTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueSlidersTwoToneMod extends js.Object {
  @js.native
  trait SlidersTwoTone extends Vue {
  ...
  @js.native
  class default () extends SlidersTwoTone
