...
@JSImport("@ant-design/icons-vue/LoginOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueLoginOutlinedMod extends js.Object {
  @js.native
  trait LoginOutlined extends Vue {
  ...
  @js.native
  class default () extends LoginOutlined
