...
@JSImport("@ant-design/icons-vue/SlidersFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSlidersFilledMod extends js.Object {
  @js.native
  trait SlidersFilled extends Vue {
  ...
  @js.native
  class default () extends SlidersFilled
