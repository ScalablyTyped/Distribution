...
@JSImport("@ant-design/icons-vue/lib/icons/RetweetOutlined", JSImport.Namespace)
@js.native
object retweetOutlinedMod extends js.Object {
  @js.native
  trait RetweetOutlined extends Vue {
  ...
  @js.native
  class default () extends RetweetOutlined
