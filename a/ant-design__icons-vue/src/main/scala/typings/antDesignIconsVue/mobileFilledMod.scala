...
@JSImport("@ant-design/icons-vue/lib/icons/MobileFilled", JSImport.Namespace)
@js.native
object mobileFilledMod extends js.Object {
  @js.native
  trait MobileFilled extends Vue {
  ...
  @js.native
  class default () extends MobileFilled
