...
@JSImport("@ant-design/icons-vue/SettingOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueSettingOutlinedMod extends js.Object {
  @js.native
  trait SettingOutlined extends Vue {
  ...
  @js.native
  class default () extends SettingOutlined
