...
object antDesignIconsVueSettingOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/SettingOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/SettingOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/SettingOutlined", "default.inheritAttrs")
    @js.native
