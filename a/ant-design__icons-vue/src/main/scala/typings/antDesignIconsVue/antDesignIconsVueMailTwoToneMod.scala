...
@JSImport("@ant-design/icons-vue/MailTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueMailTwoToneMod extends js.Object {
  @js.native
  trait MailTwoTone extends Vue {
  ...
  @js.native
  class default () extends MailTwoTone
