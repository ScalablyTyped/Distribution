...
@JSImport("@ant-design/icons-vue/MenuOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueMenuOutlinedMod extends js.Object {
  @js.native
  trait MenuOutlined extends Vue {
  ...
  @js.native
  class default () extends MenuOutlined
