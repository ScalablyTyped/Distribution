...
@JSImport("@ant-design/icons-vue/lib/icons/FilePptOutlined", JSImport.Namespace)
@js.native
object filePptOutlinedMod extends js.Object {
  @js.native
  trait FilePptOutlined extends Vue {
  ...
  @js.native
  class default () extends FilePptOutlined
