...
@JSImport("@ant-design/icons-vue/lib/icons/PlusCircleFilled", JSImport.Namespace)
@js.native
object plusCircleFilledMod extends js.Object {
  @js.native
  trait PlusCircleFilled extends Vue {
  ...
  @js.native
  class default () extends PlusCircleFilled
