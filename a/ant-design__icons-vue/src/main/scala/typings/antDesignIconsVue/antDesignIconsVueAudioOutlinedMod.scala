...
@JSImport("@ant-design/icons-vue/AudioOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueAudioOutlinedMod extends js.Object {
  @js.native
  trait AudioOutlined extends Vue {
  ...
  @js.native
  class default () extends AudioOutlined
