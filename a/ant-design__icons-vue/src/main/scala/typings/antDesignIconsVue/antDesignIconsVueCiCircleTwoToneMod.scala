...
@JSImport("@ant-design/icons-vue/CiCircleTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueCiCircleTwoToneMod extends js.Object {
  @js.native
  trait CiCircleTwoTone extends Vue {
  ...
  @js.native
  class default () extends CiCircleTwoTone
