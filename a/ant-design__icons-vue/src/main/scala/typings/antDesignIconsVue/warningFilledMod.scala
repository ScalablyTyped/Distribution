...
@JSImport("@ant-design/icons-vue/lib/icons/WarningFilled", JSImport.Namespace)
@js.native
object warningFilledMod extends js.Object {
  @js.native
  trait WarningFilled extends Vue {
  ...
  @js.native
  class default () extends WarningFilled
