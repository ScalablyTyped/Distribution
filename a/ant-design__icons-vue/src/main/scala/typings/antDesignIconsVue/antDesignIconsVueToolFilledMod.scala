...
@JSImport("@ant-design/icons-vue/ToolFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueToolFilledMod extends js.Object {
  @js.native
  trait ToolFilled extends Vue {
  ...
  @js.native
  class default () extends ToolFilled
