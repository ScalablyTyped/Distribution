...
@JSImport("@ant-design/icons-vue/LoadingOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueLoadingOutlinedMod extends js.Object {
  @js.native
  trait LoadingOutlined extends Vue {
  ...
  @js.native
  class default () extends LoadingOutlined
