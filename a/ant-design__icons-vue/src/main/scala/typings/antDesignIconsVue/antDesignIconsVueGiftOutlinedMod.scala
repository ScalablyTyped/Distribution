...
@JSImport("@ant-design/icons-vue/GiftOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueGiftOutlinedMod extends js.Object {
  @js.native
  trait GiftOutlined extends Vue {
  ...
  @js.native
  class default () extends GiftOutlined
