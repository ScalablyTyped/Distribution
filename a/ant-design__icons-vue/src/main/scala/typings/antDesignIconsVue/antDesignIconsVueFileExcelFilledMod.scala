...
@JSImport("@ant-design/icons-vue/FileExcelFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueFileExcelFilledMod extends js.Object {
  @js.native
  trait FileExcelFilled extends Vue {
  ...
  @js.native
  class default () extends FileExcelFilled
