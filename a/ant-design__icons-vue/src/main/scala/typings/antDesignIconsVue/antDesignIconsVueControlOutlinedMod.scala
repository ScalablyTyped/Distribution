...
@JSImport("@ant-design/icons-vue/ControlOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueControlOutlinedMod extends js.Object {
  @js.native
  trait ControlOutlined extends Vue {
  ...
  @js.native
  class default () extends ControlOutlined
