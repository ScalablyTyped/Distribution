...
@JSImport("@ant-design/icons-vue/CodeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCodeOutlinedMod extends js.Object {
  @js.native
  trait CodeOutlined extends Vue {
  ...
  @js.native
  class default () extends CodeOutlined
