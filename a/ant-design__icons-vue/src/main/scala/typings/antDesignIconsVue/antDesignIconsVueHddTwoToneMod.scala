...
@JSImport("@ant-design/icons-vue/HddTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueHddTwoToneMod extends js.Object {
  @js.native
  trait HddTwoTone extends Vue {
  ...
  @js.native
  class default () extends HddTwoTone
