...
@JSImport("@ant-design/icons-vue/TagFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueTagFilledMod extends js.Object {
  @js.native
  trait TagFilled extends Vue {
  ...
  @js.native
  class default () extends TagFilled
