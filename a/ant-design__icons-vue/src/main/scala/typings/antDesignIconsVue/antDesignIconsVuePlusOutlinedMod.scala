...
@JSImport("@ant-design/icons-vue/PlusOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVuePlusOutlinedMod extends js.Object {
  @js.native
  trait PlusOutlined extends Vue {
  ...
  @js.native
  class default () extends PlusOutlined
