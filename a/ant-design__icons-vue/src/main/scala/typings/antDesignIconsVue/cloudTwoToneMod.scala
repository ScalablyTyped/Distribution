...
@JSImport("@ant-design/icons-vue/lib/icons/CloudTwoTone", JSImport.Namespace)
@js.native
object cloudTwoToneMod extends js.Object {
  @js.native
  trait CloudTwoTone extends Vue {
  ...
  @js.native
  class default () extends CloudTwoTone
