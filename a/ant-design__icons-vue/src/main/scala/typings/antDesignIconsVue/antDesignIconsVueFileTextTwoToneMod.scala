...
@JSImport("@ant-design/icons-vue/FileTextTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFileTextTwoToneMod extends js.Object {
  @js.native
  trait FileTextTwoTone extends Vue {
  ...
  @js.native
  class default () extends FileTextTwoTone
