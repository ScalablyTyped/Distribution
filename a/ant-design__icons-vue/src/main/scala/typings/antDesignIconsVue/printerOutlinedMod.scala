...
@JSImport("@ant-design/icons-vue/lib/icons/PrinterOutlined", JSImport.Namespace)
@js.native
object printerOutlinedMod extends js.Object {
  @js.native
  trait PrinterOutlined extends Vue {
  ...
  @js.native
  class default () extends PrinterOutlined
