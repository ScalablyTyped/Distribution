...
@JSImport("@ant-design/icons-vue/LinkedinFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueLinkedinFilledMod extends js.Object {
  @js.native
  trait LinkedinFilled extends Vue {
  ...
  @js.native
  class default () extends LinkedinFilled
