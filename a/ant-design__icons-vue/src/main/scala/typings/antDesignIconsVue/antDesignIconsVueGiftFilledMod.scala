...
@JSImport("@ant-design/icons-vue/GiftFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueGiftFilledMod extends js.Object {
  @js.native
  trait GiftFilled extends Vue {
  ...
  @js.native
  class default () extends GiftFilled
