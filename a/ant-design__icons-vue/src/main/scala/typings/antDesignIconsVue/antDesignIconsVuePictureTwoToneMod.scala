...
@JSImport("@ant-design/icons-vue/PictureTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVuePictureTwoToneMod extends js.Object {
  @js.native
  trait PictureTwoTone extends Vue {
  ...
  @js.native
  class default () extends PictureTwoTone
