...
@JSImport("@ant-design/icons-vue/HomeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueHomeOutlinedMod extends js.Object {
  @js.native
  trait HomeOutlined extends Vue {
  ...
  @js.native
  class default () extends HomeOutlined
