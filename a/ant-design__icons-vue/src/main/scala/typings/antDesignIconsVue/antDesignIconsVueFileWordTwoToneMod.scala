...
@JSImport("@ant-design/icons-vue/FileWordTwoTone", JSImport.Namespace)
@js.native
object antDesignIconsVueFileWordTwoToneMod extends js.Object {
  @js.native
  trait FileWordTwoTone extends Vue {
  ...
  @js.native
  class default () extends FileWordTwoTone
