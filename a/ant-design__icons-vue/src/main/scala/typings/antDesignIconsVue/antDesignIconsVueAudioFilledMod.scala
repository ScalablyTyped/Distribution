...
@JSImport("@ant-design/icons-vue/AudioFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueAudioFilledMod extends js.Object {
  @js.native
  trait AudioFilled extends Vue {
  ...
  @js.native
  class default () extends AudioFilled
