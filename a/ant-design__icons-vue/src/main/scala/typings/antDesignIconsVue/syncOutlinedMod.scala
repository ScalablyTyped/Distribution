...
@JSImport("@ant-design/icons-vue/lib/icons/SyncOutlined", JSImport.Namespace)
@js.native
object syncOutlinedMod extends js.Object {
  @js.native
  trait SyncOutlined extends Vue {
  ...
  @js.native
  class default () extends SyncOutlined
