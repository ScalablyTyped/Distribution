...
object antDesignIconsVueLayoutOutlinedMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/LayoutOutlined", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/LayoutOutlined", "default.displayName")
    @js.native
    def displayName: String = js.native
    inline def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/LayoutOutlined", "default.inheritAttrs")
    @js.native
