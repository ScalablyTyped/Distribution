...
@JSImport("@ant-design/icons-vue/FallOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueFallOutlinedMod extends js.Object {
  @js.native
  trait FallOutlined extends Vue {
  ...
  @js.native
  class default () extends FallOutlined
