...
@JSImport("@ant-design/icons-vue/lib/icons/SmileTwoTone", JSImport.Namespace)
@js.native
object smileTwoToneMod extends js.Object {
  @js.native
  trait SmileTwoTone extends Vue {
  ...
  @js.native
  class default () extends SmileTwoTone
