...
@JSImport("@ant-design/icons-vue/HeatMapOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueHeatMapOutlinedMod extends js.Object {
  @js.native
  trait HeatMapOutlined extends Vue {
  ...
  @js.native
  class default () extends HeatMapOutlined
