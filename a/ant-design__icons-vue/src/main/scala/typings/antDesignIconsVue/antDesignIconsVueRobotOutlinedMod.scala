...
@JSImport("@ant-design/icons-vue/RobotOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueRobotOutlinedMod extends js.Object {
  @js.native
  trait RobotOutlined extends Vue {
  ...
  @js.native
  class default () extends RobotOutlined
