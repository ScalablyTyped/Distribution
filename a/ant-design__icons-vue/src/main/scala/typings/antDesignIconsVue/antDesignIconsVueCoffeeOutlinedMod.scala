...
@JSImport("@ant-design/icons-vue/CoffeeOutlined", JSImport.Namespace)
@js.native
object antDesignIconsVueCoffeeOutlinedMod extends js.Object {
  @js.native
  trait CoffeeOutlined extends Vue {
  ...
  @js.native
  class default () extends CoffeeOutlined
