...
object antDesignIconsVueCloseCircleFilledMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/icons-vue/CloseCircleFilled", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/icons-vue/CloseCircleFilled", "default.displayName")
    @js.native
    def displayName: String = js.native
    @scala.inline
    def displayName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("displayName")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/icons-vue/CloseCircleFilled", "default.inheritAttrs")
    @js.native
