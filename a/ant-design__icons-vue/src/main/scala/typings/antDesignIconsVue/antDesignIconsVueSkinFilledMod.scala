...
@JSImport("@ant-design/icons-vue/SkinFilled", JSImport.Namespace)
@js.native
object antDesignIconsVueSkinFilledMod extends js.Object {
  @js.native
  trait SkinFilled extends Vue {
  ...
  @js.native
  class default () extends SkinFilled
