...
@JSImport("@ant-design/icons-vue/lib/icons/FrownFilled", JSImport.Namespace)
@js.native
object frownFilledMod extends js.Object {
  @js.native
  trait FrownFilled extends Vue {
  ...
  @js.native
  class default () extends FrownFilled
