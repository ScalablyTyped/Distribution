package typings.antDashDesignDashPro.libChartsChartCardMod
...
import typings.antd.libCardMod.CardProps
import typings.antd.libCardMod.CardSize
import typings.antd.libCardMod.CardTabListType
import typings.antd.libCardMod.CardType
