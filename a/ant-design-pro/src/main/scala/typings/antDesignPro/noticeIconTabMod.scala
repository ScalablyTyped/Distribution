...
object noticeIconTabMod {
  ...
  type NoticeIconTab = Component[NoticeIconTabProps, Any, Any]
  ...
  object NoticeIconTabProps {
    ...
    inline def apply(locale: Any, onClear: Any => Unit, onClick: Any => Unit, onViewMore: Any => Unit): NoticeIconTabProps = {
    ...
    extension [Self <: NoticeIconTabProps](x: Self) {
      ...
      inline def setOnClear(value: Any => Unit): Self = StObject.set(x, "onClear", js.Any.fromFunction1(value))
      
      inline def setOnClick(value: Any => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      
      inline def setOnViewMore(value: Any => Unit): Self = StObject.set(x, "onViewMore", js.Any.fromFunction1(value))
