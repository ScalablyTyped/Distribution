...
object G2 {
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2")
  @js.native
  val ^ : js.Any = js.native
  
  /** range-filter 只用于：brush-filter, brush-x-filter, brush-y-filter */
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.BRUSH_FILTER_EVENTS")
  @js.native
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.ComponentController")
  @js.native
  abstract class ComponentController[O] protected ()
    extends typings.bizcharts.mod.G2.ComponentController[O] {
    def this(view: typings.antvG2.viewMod.View) = this()
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Coordinate")
  @js.native
  /**
  ...
  open class Coordinate ()
    extends typings.bizcharts.mod.G2.Coordinate {
    def this(options: PartialOptions) = this()
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.DIRECTION")
  @js.native
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.ELEMENT_RANGE_HIGHLIGHT_EVENTS")
  @js.native
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Element")
  @js.native
  open class Element protected ()
    extends typings.bizcharts.mod.G2.Element {
    def this(cfg: ElementCfg) = this()
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Facet")
  @js.native
  abstract class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typings.bizcharts.mod.G2.Facet[C, F] {
    def this(view: typings.antvG2.viewMod.View, cfg: C) = this()
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Geometry")
  @js.native
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typings.bizcharts.mod.G2.Geometry[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.GeometryLabel")
  @js.native
  open class GeometryLabel protected ()
    extends typings.bizcharts.mod.G2.GeometryLabel {
  ...
  /**
    * Action 的基类
    */
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.InteractionAction")
  @js.native
  abstract class InteractionAction[T] protected ()
    extends typings.bizcharts.mod.G2.InteractionAction[T] {
    def this(context: IInteractionContext) = this()
    def this(context: IInteractionContext, cfg: T) = this()
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.LAYER")
  @js.native
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.TooltipController")
  @js.native
  open class TooltipController ()
    extends typings.bizcharts.mod.G2.TooltipController
  
  object Util {
    
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getAngle")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getDelegationObject")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getLegendItems")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getMappingValue")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getPath")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getPathPoints")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getSectorPath")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.getTooltipItems")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.polarToCartesian")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.rotate")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.translate")
    @js.native
    ...
    @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Util.zoom")
    @js.native
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.VERSION")
  @js.native
  val VERSION: /* "4.2.8" */ String = js.native
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.VIEW_LIFE_CIRCLE")
  @js.native
  ...
  object antvG2LibChartViewAugmentingMod {
    ...
    trait View extends StObject {
      ...
      /**
        ...
        */
      def point(): typings.antvG2.libInterfaceMod.Point = js.native
      def point(cfg: PartialGeometryCfg): typings.antvG2.libInterfaceMod.Point = js.native
