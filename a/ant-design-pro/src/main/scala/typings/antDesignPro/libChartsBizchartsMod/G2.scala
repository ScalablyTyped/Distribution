...
object G2 {
  ...
  /* note: abstract class */ @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.ComponentController")
  @js.native
  ...
  /* note: abstract class */ @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.Facet")
  @js.native
  ...
  /**
    * Action 的基类
    */
  /* note: abstract class */ @JSImport("ant-design-pro/lib/Charts/bizcharts", "G2.InteractionAction")
  @js.native
