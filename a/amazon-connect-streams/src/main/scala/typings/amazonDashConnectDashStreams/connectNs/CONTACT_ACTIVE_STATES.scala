...
object CONTACT_ACTIVE_STATES extends js.Object {
  ...
  /* "connected" */ val CONNECTED: typings.amazonDashConnectDashStreams.connectNs.CONTACT_ACTIVE_STATES.CONNECTED with String = js.native
  /* "connecting" */ val CONNECTING: typings.amazonDashConnectDashStreams.connectNs.CONTACT_ACTIVE_STATES.CONNECTING with String = js.native
  /* "incoming" */ val INCOMING: typings.amazonDashConnectDashStreams.connectNs.CONTACT_ACTIVE_STATES.INCOMING with String = js.native
  @JSBracketAccess
