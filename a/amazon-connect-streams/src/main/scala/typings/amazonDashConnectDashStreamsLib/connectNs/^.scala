...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def agent(callback: AgentCallback): scala.Unit = js.native
  /**
    ...
    */
  def contact(callback: ContactCallback): scala.Unit = js.native
  /**
    ...
    */
  def hitch(scope: js.Object, method: js.Function0[_]): scala.Unit = js.native
}
