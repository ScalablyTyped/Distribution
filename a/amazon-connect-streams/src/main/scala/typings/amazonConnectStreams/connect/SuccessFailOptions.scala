...
object SuccessFailOptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SuccessFailOptions] (val x: Self) extends AnyVal {
    ...
    inline def setSuccess(value: js.Array[Any] => Unit): Self = StObject.set(x, "success", js.Any.fromFunction1(value))
