...
{readonly [ channel in amazon-connect-streams.connect.ChannelType ]: number}
  */ typings.amazonConnectStreams.amazonConnectStreamsStrings.AgentChannelConcurrencyMap & org.scalablytyped.runtime.TopLevel[js.Any]
...
/*
  ...
  */
type SuccessFailCallback[T /* <: js.Array[js.Any] */] = js.Function1[/* args */ T, scala.Unit]
