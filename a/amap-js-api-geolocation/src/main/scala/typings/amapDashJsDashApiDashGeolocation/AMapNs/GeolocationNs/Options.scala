...
trait Options extends js.Object {
  ...
  /**
    * 定位点Circle的配置
    */
  var circleOptions: js.UndefOr[typings.amapDashJsDashApi.AMapNs.CircleNs.Options[_]] = js.undefined
  /**
    * 是否转换成高德坐标
    */
  ...
  /**
    * 定位点Marker的配置
    */
  var markerOptions: js.UndefOr[typings.amapDashJsDashApi.AMapNs.MarkerNs.Options[_]] = js.undefined
  /**
    * 缓存毫秒数
    */
...
object Options {
  ...
  def apply(
    ...
    circleOptions: typings.amapDashJsDashApi.AMapNs.CircleNs.Options[_] = null,
    ...
    markerOptions: typings.amapDashJsDashApi.AMapNs.MarkerNs.Options[_] = null,
