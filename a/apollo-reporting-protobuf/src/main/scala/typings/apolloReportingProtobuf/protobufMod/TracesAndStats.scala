...
object TracesAndStats {
  ...
  inline def decode(reader: Uint8Array): TracesAndStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TracesAndStats]
  inline def decode(reader: Uint8Array, length: Double): TracesAndStats = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TracesAndStats]
  ...
  inline def decodeDelimited(reader: Uint8Array): TracesAndStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TracesAndStats]
  ...
  /**
    ...
    * @returns TracesAndStats
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): TracesAndStats = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TracesAndStats]
  ...
  /**
    ...
    */
  inline def toObject(message: TracesAndStats): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: TracesAndStats, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
