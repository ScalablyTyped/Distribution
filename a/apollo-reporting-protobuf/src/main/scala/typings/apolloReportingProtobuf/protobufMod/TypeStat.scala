...
object TypeStat {
  ...
  inline def decode(reader: Uint8Array): TypeStat = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[TypeStat]
  inline def decode(reader: Uint8Array, length: Double): TypeStat = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[TypeStat]
  ...
  inline def decodeDelimited(reader: Uint8Array): TypeStat = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[TypeStat]
  ...
  /**
    ...
    * @returns TypeStat
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): TypeStat = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[TypeStat]
  ...
  /**
    ...
    */
  inline def toObject(message: TypeStat): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: TypeStat, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
