...
object ContextualizedTypeStats {
  ...
  inline def decode(reader: Uint8Array): ContextualizedTypeStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ContextualizedTypeStats]
  inline def decode(reader: Uint8Array, length: Double): ContextualizedTypeStats = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ContextualizedTypeStats]
  ...
  inline def decodeDelimited(reader: Uint8Array): ContextualizedTypeStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ContextualizedTypeStats]
  ...
  /**
    ...
    * @returns ContextualizedTypeStats
    */
  inline def fromObject(`object`: StringDictionary[js.Any]): ContextualizedTypeStats = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ContextualizedTypeStats]
  ...
  /**
    ...
    */
  inline def toObject(message: ContextualizedTypeStats): StringDictionary[js.Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[js.Any]]
  inline def toObject(message: ContextualizedTypeStats, options: IConversionOptions): StringDictionary[js.Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[js.Any]]
