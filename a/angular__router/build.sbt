...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__animations" % "14.2.10-323d8b",
  "org.scalablytyped" %%% "angular__common" % "14.2.10-d1788f",
  ...
  "org.scalablytyped" %%% "angular__platform-browser" % "14.2.10-dd83c3",
