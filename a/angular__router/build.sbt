...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__animations" % "14.2.3-dfd6b6",
  "org.scalablytyped" %%% "angular__common" % "14.2.3-b0ba96",
  ...
  "org.scalablytyped" %%% "angular__platform-browser" % "14.2.3-48e685",
