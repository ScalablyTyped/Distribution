...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__animations" % "14.2.7-990011",
  "org.scalablytyped" %%% "angular__common" % "14.2.7-915b2b",
  ...
  "org.scalablytyped" %%% "angular__platform-browser" % "14.2.7-a74dc7",
