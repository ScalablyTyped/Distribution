...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__animations" % "14.2.8-2ae2c2",
  "org.scalablytyped" %%% "angular__common" % "14.2.8-496c46",
  ...
  "org.scalablytyped" %%% "angular__platform-browser" % "14.2.8-78c302",
