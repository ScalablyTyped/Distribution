...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "angular__animations" % "15.0.0-0ada94",
  "org.scalablytyped" %%% "angular__common" % "15.0.0-d4a98d",
  ...
  "org.scalablytyped" %%% "angular__platform-browser" % "15.0.0-c0d525",
