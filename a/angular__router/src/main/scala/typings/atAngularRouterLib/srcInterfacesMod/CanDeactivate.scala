...
trait CanDeactivate[T] extends js.Object {
  ...
  ): (rxjsLib.rxjsMod.Observable[scala.Boolean | atAngularRouterLib.srcUrlUnderscoreTreeMod.UrlTree]) | (stdLib.Promise[scala.Boolean | atAngularRouterLib.srcUrlUnderscoreTreeMod.UrlTree]) | scala.Boolean | atAngularRouterLib.srcUrlUnderscoreTreeMod.UrlTree = js.native
  def canDeactivate(
    component: T,
    currentRoute: atAngularRouterLib.srcRouterUnderscoreStateMod.ActivatedRouteSnapshot,
    currentState: atAngularRouterLib.srcRouterUnderscoreStateMod.RouterStateSnapshot,
