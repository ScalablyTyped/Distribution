...
@scala.inline
def ɵangularPackagesRouterRouterI(r: typings.angularRouter.mod.ɵangularPackagesRouterRouterH): js.Function0[js.Promise[js.Any]] = typings.angularRouter.mod.^.asInstanceOf[js.Dynamic].applyDynamic("\u0275angular_packages_router_router_i")(r.asInstanceOf[js.Any]).asInstanceOf[js.Function0[js.Promise[js.Any]]]

@scala.inline
def ɵangularPackagesRouterRouterJ(r: typings.angularRouter.mod.ɵangularPackagesRouterRouterH): js.Function1[
