...
object upgradeUpgradeMod {
  ...
  object RouterUpgradeInitializer {
    ...
    @JSImport("@angular/router/upgrade/upgrade", "RouterUpgradeInitializer")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@angular/router/upgrade/upgrade", "RouterUpgradeInitializer.deps")
    @js.native
    def deps: js.Array[
    ...
    @JSImport("@angular/router/upgrade/upgrade", "RouterUpgradeInitializer.multi")
    @js.native
    ...
    @JSImport("@angular/router/upgrade/upgrade", "RouterUpgradeInitializer.provide")
    @js.native
    def provide: InjectionToken[js.Array[js.Function1[/* compRef */ ComponentRef[js.Any], Unit]]] = js.native
    inline def provide_=(x: InjectionToken[js.Array[js.Function1[/* compRef */ ComponentRef[js.Any], Unit]]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("provide")(x.asInstanceOf[js.Any])
  ...
  inline def setUpLocationSync_hash(
    ngUpgrade: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify UpgradeModule */ js.Any,
    urlType: hash
  ...
  inline def setUpLocationSync_path(
    ngUpgrade: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify UpgradeModule */ js.Any,
    urlType: path
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setUpLocationSync")(ngUpgrade.asInstanceOf[js.Any], urlType.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
