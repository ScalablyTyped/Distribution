...
object QueryParamsHandling {
  ...
  @scala.inline
  def merge: typings.atAngularRouter.atAngularRouterStrings.merge = this.cast("merge")
  @scala.inline
  def preserve: typings.atAngularRouter.atAngularRouterStrings.preserve = this.cast("preserve")
}
