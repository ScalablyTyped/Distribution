...
trait ByteMatchTuple extends js.Object {
  /**
    ...
    */
  var FieldToMatch: awsDashSdkLib.clientsWafregionalMod.FieldToMatch
  /**
    ...
    */
  var PositionalConstraint: awsDashSdkLib.clientsWafregionalMod.PositionalConstraint
  /**
  ...
  /**
    ...
    */
  var TextTransformation: awsDashSdkLib.clientsWafregionalMod.TextTransformation
}
