...
object CreateIntegrationResponse {
  ...
  def apply(
    ...
    if (IntegrationId != null) __obj.updateDynamic("IntegrationId")(IntegrationId)
    if (IntegrationMethod != null) __obj.updateDynamic("IntegrationMethod")(IntegrationMethod)
    if (IntegrationResponseSelectionExpression != null) __obj.updateDynamic("IntegrationResponseSelectionExpression")(IntegrationResponseSelectionExpression)
