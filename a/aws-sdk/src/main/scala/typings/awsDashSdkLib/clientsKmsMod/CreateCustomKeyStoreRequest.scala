...
object CreateCustomKeyStoreRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(CloudHsmClusterId = CloudHsmClusterId, CustomKeyStoreName = CustomKeyStoreName, KeyStorePassword = KeyStorePassword, TrustAnchorCertificate = TrustAnchorCertificate)
