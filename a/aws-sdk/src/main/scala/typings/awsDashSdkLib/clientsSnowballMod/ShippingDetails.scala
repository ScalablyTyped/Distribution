...
object ShippingDetails {
  ...
  def apply(
    ...
    if (InboundShipment != null) __obj.updateDynamic("InboundShipment")(InboundShipment)
    if (OutboundShipment != null) __obj.updateDynamic("OutboundShipment")(OutboundShipment)
