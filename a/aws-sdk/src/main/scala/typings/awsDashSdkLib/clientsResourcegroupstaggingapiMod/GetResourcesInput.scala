...
trait GetResourcesInput extends js.Object {
  /**
    ...
    */
  var ExcludeCompliantResources: js.UndefOr[ExcludeCompliantResources] = js.undefined
  /**
    ...
    */
  var IncludeComplianceDetails: js.UndefOr[IncludeComplianceDetails] = js.undefined
  /**
...
object GetResourcesInput {
  ...
  def apply(
    ...
    if (!js.isUndefined(ExcludeCompliantResources)) __obj.updateDynamic("ExcludeCompliantResources")(ExcludeCompliantResources)
    if (!js.isUndefined(IncludeComplianceDetails)) __obj.updateDynamic("IncludeComplianceDetails")(IncludeComplianceDetails)
