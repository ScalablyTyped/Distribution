...
trait SizeConstraintSetUpdate extends js.Object {
  ...
  /**
    ...
    */
  var SizeConstraint: awsDashSdkLib.clientsWafMod.SizeConstraint
}

object SizeConstraintSetUpdate {
  @scala.inline
  def apply(Action: ChangeAction, SizeConstraint: SizeConstraint): SizeConstraintSetUpdate = {
    val __obj = js.Dynamic.literal(Action = Action.asInstanceOf[js.Any], SizeConstraint = SizeConstraint)
