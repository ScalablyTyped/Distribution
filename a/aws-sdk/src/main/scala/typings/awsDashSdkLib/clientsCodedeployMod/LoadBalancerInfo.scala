...
object LoadBalancerInfo {
  ...
  def apply(
    ...
    if (elbInfoList != null) __obj.updateDynamic("elbInfoList")(elbInfoList)
    if (targetGroupInfoList != null) __obj.updateDynamic("targetGroupInfoList")(targetGroupInfoList)
    if (targetGroupPairInfoList != null) __obj.updateDynamic("targetGroupPairInfoList")(targetGroupPairInfoList)
