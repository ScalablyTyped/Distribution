...
object ConfigurationServiceApiVersions {
  ...
  def apply(
    ...
    signer: awsDashSdkLib.clientsSignerMod.SignerNs.apiVersion = null,
    simpledb: awsDashSdkLib.clientsSimpledbMod.SimpleDBNs.apiVersion = null,
    sms: awsDashSdkLib.clientsSmsMod.SMSNs.apiVersion = null,
    snowball: awsDashSdkLib.clientsSnowballMod.SnowballNs.apiVersion = null,
    sns: awsDashSdkLib.clientsSnsMod.SNSNs.apiVersion = null,
    sqs: awsDashSdkLib.clientsSqsMod.SQSNs.apiVersion = null,
    ssm: awsDashSdkLib.clientsSsmMod.SSMNs.apiVersion = null,
    stepfunctions: awsDashSdkLib.clientsStepfunctionsMod.StepFunctionsNs.apiVersion = null,
    storagegateway: awsDashSdkLib.clientsStoragegatewayMod.StorageGatewayNs.apiVersion = null,
    sts: awsDashSdkLib.clientsStsMod.STSNs.apiVersion = null,
    support: awsDashSdkLib.clientsSupportMod.SupportNs.apiVersion = null,
    swf: awsDashSdkLib.clientsSwfMod.SWFNs.apiVersion = null,
    textract: awsDashSdkLib.clientsTextractMod.TextractNs.apiVersion = null,
    transcribeservice: awsDashSdkLib.clientsTranscribeserviceMod.TranscribeServiceNs.apiVersion = null,
    transfer: awsDashSdkLib.clientsTransferMod.TransferNs.apiVersion = null,
    translate: awsDashSdkLib.clientsTranslateMod.TranslateNs.apiVersion = null,
    waf: awsDashSdkLib.clientsWafMod.WAFNs.apiVersion = null,
    wafregional: awsDashSdkLib.clientsWafregionalMod.WAFRegionalNs.apiVersion = null,
    workdocs: awsDashSdkLib.clientsWorkdocsMod.WorkDocsNs.apiVersion = null,
    worklink: awsDashSdkLib.clientsWorklinkMod.WorkLinkNs.apiVersion = null,
    workmail: awsDashSdkLib.clientsWorkmailMod.WorkMailNs.apiVersion = null,
    workspaces: awsDashSdkLib.clientsWorkspacesMod.WorkSpacesNs.apiVersion = null,
    xray: awsDashSdkLib.clientsXrayMod.XRayNs.apiVersion = null
