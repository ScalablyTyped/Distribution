...
object Playlist {
  ...
  def apply(
    ...
    if (HlsContentProtection != null) __obj.updateDynamic("HlsContentProtection")(HlsContentProtection)
    if (Name != null) __obj.updateDynamic("Name")(Name)
    if (OutputKeys != null) __obj.updateDynamic("OutputKeys")(OutputKeys)
    if (PlayReadyDrm != null) __obj.updateDynamic("PlayReadyDrm")(PlayReadyDrm)
