...
trait CSVMappingParameters extends js.Object {
  /**
    ...
    */
  var RecordColumnDelimiter: awsDashSdkLib.clientsKinesisanalyticsv2Mod.RecordColumnDelimiter
  /**
    * The row delimiter. For example, in a CSV format, '\n' is the typical row delimiter.
    */
  var RecordRowDelimiter: awsDashSdkLib.clientsKinesisanalyticsv2Mod.RecordRowDelimiter
}
