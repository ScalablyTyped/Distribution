...
trait CloudWatch
  ...
  @JSName("config")
  var config_CloudWatch: awsDashSdkLib.libConfigMod.ConfigBase with ClientConfiguration = js.native
  /**
  ...
  /**
    ...
    */
  def deleteAnomalyDetector(): awsDashSdkLib.libRequestMod.Request[DeleteAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def deleteAnomalyDetector(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ DeleteAnomalyDetectorOutput, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[DeleteAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  /**
    * Deletes the specified anomaly detection model from your account.
    */
  def deleteAnomalyDetector(params: DeleteAnomalyDetectorInput): awsDashSdkLib.libRequestMod.Request[DeleteAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def deleteAnomalyDetector(
  ...
  /**
    ...
    */
  def describeAnomalyDetectors(): awsDashSdkLib.libRequestMod.Request[DescribeAnomalyDetectorsOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def describeAnomalyDetectors(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ DescribeAnomalyDetectorsOutput, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[DescribeAnomalyDetectorsOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  /**
    * Lists the anomaly detection models that you have created in your account. You can list all models in your account or filter the results to only the models that are related to a certain namespace, metric name, or metric dimension.
    */
  def describeAnomalyDetectors(params: DescribeAnomalyDetectorsInput): awsDashSdkLib.libRequestMod.Request[DescribeAnomalyDetectorsOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def describeAnomalyDetectors(
  ...
  /**
    ...
    */
  def putAnomalyDetector(): awsDashSdkLib.libRequestMod.Request[PutAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def putAnomalyDetector(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ PutAnomalyDetectorOutput, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[PutAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  /**
    * Creates an anomaly detection model for a CloudWatch metric. You can use the model to display a band of expected normal values when the metric is graphed. For more information, see CloudWatch Anomaly Detection.
    */
  def putAnomalyDetector(params: PutAnomalyDetectorInput): awsDashSdkLib.libRequestMod.Request[PutAnomalyDetectorOutput, awsDashSdkLib.libErrorMod.AWSError] = js.native
  def putAnomalyDetector(
