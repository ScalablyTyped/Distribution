...
object H264Settings {
  ...
  def apply(
    ...
    if (!js.isUndefined(GopNumBFrames)) __obj.updateDynamic("GopNumBFrames")(GopNumBFrames)
    ...
    if (!js.isUndefined(NumRefFrames)) __obj.updateDynamic("NumRefFrames")(NumRefFrames)
