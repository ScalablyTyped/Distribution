...
trait CloudWatchDimensionConfiguration extends js.Object {
  /**
    ...
    */
  var DefaultDimensionValue: awsDashSdkLib.clientsPinpointemailMod.DefaultDimensionValue
  /**
    ...
    */
  var DimensionName: awsDashSdkLib.clientsPinpointemailMod.DimensionName
  /**
    ...
    */
  var DimensionValueSource: awsDashSdkLib.clientsPinpointemailMod.DimensionValueSource
}
