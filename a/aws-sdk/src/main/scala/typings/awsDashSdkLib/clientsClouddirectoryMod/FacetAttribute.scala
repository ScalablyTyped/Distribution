...
object FacetAttribute {
  ...
  def apply(
    ...
    if (AttributeDefinition != null) __obj.updateDynamic("AttributeDefinition")(AttributeDefinition)
    if (AttributeReference != null) __obj.updateDynamic("AttributeReference")(AttributeReference)
