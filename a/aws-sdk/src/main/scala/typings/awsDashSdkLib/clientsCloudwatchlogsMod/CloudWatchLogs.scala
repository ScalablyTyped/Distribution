...
trait CloudWatchLogs
  ...
  /**
    ...
    */
  def describeQueries(): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def describeQueries(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesResponse, 
  ...
  /**
    * Returns a list of CloudWatch Logs Insights queries that are scheduled, executing, or have been executed recently in this account. You can request all queries, or limit it to queries of a specific log group or queries with a certain status.
    */
  def describeQueries(params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesRequest): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def describeQueries(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.DescribeQueriesResponse, 
      scala.Unit
  ...
  /**
    ...
    */
  def getLogGroupFields(): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getLogGroupFields(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsResponse, 
  ...
  /**
    * Returns a list of the fields that are included in log events in the specified log group, along with the percentage of log events that contain each field. The search is limited to a time period that you specify. In the results, fields that start with @ are fields generated by CloudWatch Logs. For example, @timestamp is the timestamp of each log event. The response results are sorted by the frequency percentage, starting with the highest percentage.
    */
  def getLogGroupFields(params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsRequest): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getLogGroupFields(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogGroupFieldsResponse, 
      scala.Unit
  ...
  /**
    ...
    */
  def getLogRecord(): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getLogRecord(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordResponse, 
  ...
  /**
    * Retrieves all the fields and values of a single log event. All fields are retrieved, even if the original query that produced the logRecordPointer retrieved only a subset of fields. Fields are returned as field name/field value pairs. Additionally, the entire unparsed log event is returned within @message.
    */
  def getLogRecord(params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordRequest): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getLogRecord(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetLogRecordResponse, 
      scala.Unit
  ...
  def getQueryResults(): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getQueryResults(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsResponse, 
  ...
  /**
    * Returns the results from the specified query. If the query is in progress, partial results of that current execution are returned. Only the fields requested in the query are returned.  GetQueryResults does not start a query execution. To run a query, use .
    */
  def getQueryResults(params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsRequest): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def getQueryResults(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.GetQueryResultsResponse, 
      scala.Unit
  ...
  def startQuery(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StartQueryResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StartQueryResponse, 
  ...
  def startQuery(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StartQueryRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StartQueryResponse, 
      scala.Unit
  ...
  /**
    ...
    */
  def stopQuery(): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def stopQuery(
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryResponse, 
      scala.Unit
    ]
  ): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryResponse, 
  ...
  /**
    * Stops a CloudWatch Logs Insights query that is in progress. If the query has already ended, the operation returns an error indicating that the specified query is not running.
    */
  def stopQuery(params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryRequest): awsDashSdkLib.libRequestMod.Request[
    awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryResponse, 
    awsDashSdkLib.libErrorMod.AWSError
  ] = js.native
  def stopQuery(
    params: awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryRequest,
    callback: js.Function2[
      /* err */ awsDashSdkLib.libErrorMod.AWSError, 
      /* data */ awsDashSdkLib.clientsCloudwatchlogsMod.CloudWatchLogsNs.StopQueryResponse, 
      scala.Unit
