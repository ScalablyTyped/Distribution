...
trait CreateHsmRequest extends js.Object {
  ...
  /**
    ...
    */
  var IamRoleArn: awsDashSdkLib.clientsCloudhsmMod.IamRoleArn
  /**
    * The SSH public key to install on the HSM.
    */
  var SshKey: awsDashSdkLib.clientsCloudhsmMod.SshKey
  /**
    * The identifier of the subnet in your VPC in which to place the HSM.
    */
  var SubnetId: awsDashSdkLib.clientsCloudhsmMod.SubnetId
  var SubscriptionType: awsDashSdkLib.clientsCloudhsmMod.SubscriptionType
  /**
