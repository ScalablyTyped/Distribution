...
object CreateCapacityReservationRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AvailabilityZone = AvailabilityZone, InstanceCount = InstanceCount, InstancePlatform = InstancePlatform.asInstanceOf[js.Any], InstanceType = InstanceType)
