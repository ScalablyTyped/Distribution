...
trait DescribeAlgorithmOutput extends js.Object {
  ...
  /**
    ...
    */
  var AlgorithmStatus: awsDashSdkLib.clientsSagemakerMod.AlgorithmStatus
  /**
    * Details about the current status of the algorithm.
    */
  var AlgorithmStatusDetails: awsDashSdkLib.clientsSagemakerMod.AlgorithmStatusDetails
  /**
