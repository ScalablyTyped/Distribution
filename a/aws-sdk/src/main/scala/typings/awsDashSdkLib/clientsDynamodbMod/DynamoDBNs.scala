...
object DynamoDBNs extends js.Object {
  ...
  object DocumentClientNs extends js.Object {
    ...
    /* Rewritten from type alias, can be one of: 
      - awsDashSdkLib.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.StringSet
      - awsDashSdkLib.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.NumberSet
      - awsDashSdkLib.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BinarySet
    */
  ...
  */
  ...
  type _Date = stdLib.Date
  /* Rewritten from type alias, can be one of: 
    - awsDashSdkLib.awsDashSdkLibStrings.`2011-12-05`
