...
trait SendSSHPublicKeyRequest extends js.Object {
  /**
    ...
    */
  var AvailabilityZone: awsDashSdkLib.clientsEc2instanceconnectMod.AvailabilityZone
  /**
    * The EC2 instance you wish to publish the SSH key to.
    */
  var InstanceId: awsDashSdkLib.clientsEc2instanceconnectMod.InstanceId
  /**
    * The OS user on the EC2 instance whom the key may be used to authenticate as.
    */
  var InstanceOSUser: awsDashSdkLib.clientsEc2instanceconnectMod.InstanceOSUser
  /**
    * The public key to be published to the instance. To use it after publication you must have the matching private key.
    */
  var SSHPublicKey: awsDashSdkLib.clientsEc2instanceconnectMod.SSHPublicKey
}
