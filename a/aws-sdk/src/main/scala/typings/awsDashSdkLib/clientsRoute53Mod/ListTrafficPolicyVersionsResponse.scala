...
trait ListTrafficPolicyVersionsResponse extends js.Object {
  ...
  /**
    ...
    */
  var TrafficPolicies: awsDashSdkLib.clientsRoute53Mod.TrafficPolicies
  /**
    ...
    */
  var TrafficPolicyVersionMarker: awsDashSdkLib.clientsRoute53Mod.TrafficPolicyVersionMarker
}
