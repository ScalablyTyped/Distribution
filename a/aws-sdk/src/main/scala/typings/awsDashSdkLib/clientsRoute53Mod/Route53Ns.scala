...
object Route53Ns extends js.Object {
  ...
  type AccountLimitType = awsDashSdkLib.awsDashSdkLibStrings.MAX_HEALTH_CHECKS_BY_OWNER | awsDashSdkLib.awsDashSdkLibStrings.MAX_HOSTED_ZONES_BY_OWNER | awsDashSdkLib.awsDashSdkLibStrings.MAX_TRAFFIC_POLICY_INSTANCES_BY_OWNER | awsDashSdkLib.awsDashSdkLibStrings.MAX_REUSABLE_DELEGATION_SETS_BY_OWNER | awsDashSdkLib.awsDashSdkLibStrings.MAX_TRAFFIC_POLICIES_BY_OWNER | java.lang.String
  type AlarmName = java.lang.String
  type AliasHealthEnabled = scala.Boolean
  type AssociateVPCComment = java.lang.String
  type ChangeAction = awsDashSdkLib.awsDashSdkLibStrings.CREATE | awsDashSdkLib.awsDashSdkLibStrings.DELETE | awsDashSdkLib.awsDashSdkLibStrings.UPSERT | java.lang.String
  type ChangeStatus = awsDashSdkLib.awsDashSdkLibStrings.PENDING | awsDashSdkLib.awsDashSdkLibStrings.INSYNC | java.lang.String
  ...
  type CloudWatchRegion = awsDashSdkLib.awsDashSdkLibStrings.`us-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-east-2` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`ca-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-3` | awsDashSdkLib.awsDashSdkLibStrings.`ap-south-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-3` | awsDashSdkLib.awsDashSdkLibStrings.`eu-north-1` | awsDashSdkLib.awsDashSdkLibStrings.`sa-east-1` | java.lang.String
  ...
  type HealthCheckRegion = awsDashSdkLib.awsDashSdkLibStrings.`us-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`sa-east-1` | java.lang.String
  type HealthCheckRegionList = js.Array[HealthCheckRegion]
  type HealthCheckType = awsDashSdkLib.awsDashSdkLibStrings.HTTP | awsDashSdkLib.awsDashSdkLibStrings.HTTPS | awsDashSdkLib.awsDashSdkLibStrings.HTTP_STR_MATCH | awsDashSdkLib.awsDashSdkLibStrings.HTTPS_STR_MATCH | awsDashSdkLib.awsDashSdkLibStrings.TCP | awsDashSdkLib.awsDashSdkLibStrings.CALCULATED | awsDashSdkLib.awsDashSdkLibStrings.CLOUDWATCH_METRIC | java.lang.String
  ...
  type HostedZoneLimitType = awsDashSdkLib.awsDashSdkLibStrings.MAX_RRSETS_BY_ZONE | awsDashSdkLib.awsDashSdkLibStrings.MAX_VPCS_ASSOCIATED_BY_ZONE | java.lang.String
  type HostedZoneRRSetCount = scala.Double
  type HostedZones = js.Array[HostedZone]
  type IPAddress = java.lang.String
  type IPAddressCidr = java.lang.String
  type InsufficientDataHealthStatus = awsDashSdkLib.awsDashSdkLibStrings.Healthy | awsDashSdkLib.awsDashSdkLibStrings.Unhealthy | awsDashSdkLib.awsDashSdkLibStrings.LastKnownStatus | java.lang.String
  ...
  type RRType = awsDashSdkLib.awsDashSdkLibStrings.SOA | awsDashSdkLib.awsDashSdkLibStrings.A | awsDashSdkLib.awsDashSdkLibStrings.TXT | awsDashSdkLib.awsDashSdkLibStrings.NS | awsDashSdkLib.awsDashSdkLibStrings.CNAME | awsDashSdkLib.awsDashSdkLibStrings.MX | awsDashSdkLib.awsDashSdkLibStrings.NAPTR | awsDashSdkLib.awsDashSdkLibStrings.PTR | awsDashSdkLib.awsDashSdkLibStrings.SRV | awsDashSdkLib.awsDashSdkLibStrings.SPF | awsDashSdkLib.awsDashSdkLibStrings.AAAA | awsDashSdkLib.awsDashSdkLibStrings.CAA | java.lang.String
  type RecordData = js.Array[RecordDataEntry]
  type RecordDataEntry = java.lang.String
  type RequestInterval = scala.Double
  type ResettableElementName = awsDashSdkLib.awsDashSdkLibStrings.FullyQualifiedDomainName | awsDashSdkLib.awsDashSdkLibStrings.Regions | awsDashSdkLib.awsDashSdkLibStrings.ResourcePath | awsDashSdkLib.awsDashSdkLibStrings.ChildHealthChecks | java.lang.String
  ...
  type ResourceRecordSetFailover = awsDashSdkLib.awsDashSdkLibStrings.PRIMARY | awsDashSdkLib.awsDashSdkLibStrings.SECONDARY | java.lang.String
  type ResourceRecordSetIdentifier = java.lang.String
  type ResourceRecordSetMultiValueAnswer = scala.Boolean
  type ResourceRecordSetRegion = awsDashSdkLib.awsDashSdkLibStrings.`us-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-east-2` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`ca-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-3` | awsDashSdkLib.awsDashSdkLibStrings.`eu-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-3` | awsDashSdkLib.awsDashSdkLibStrings.`eu-north-1` | awsDashSdkLib.awsDashSdkLibStrings.`sa-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`cn-north-1` | awsDashSdkLib.awsDashSdkLibStrings.`cn-northwest-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-south-1` | java.lang.String
  ...
  type Statistic = awsDashSdkLib.awsDashSdkLibStrings.Average | awsDashSdkLib.awsDashSdkLibStrings.Sum | awsDashSdkLib.awsDashSdkLibStrings.SampleCount | awsDashSdkLib.awsDashSdkLibStrings.Maximum | awsDashSdkLib.awsDashSdkLibStrings.Minimum | java.lang.String
  ...
  type TagResourceType = awsDashSdkLib.awsDashSdkLibStrings.healthcheck | awsDashSdkLib.awsDashSdkLibStrings.hostedzone | java.lang.String
  ...
  type VPCRegion = awsDashSdkLib.awsDashSdkLibStrings.`us-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-east-2` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`us-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-1` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-2` | awsDashSdkLib.awsDashSdkLibStrings.`eu-west-3` | awsDashSdkLib.awsDashSdkLibStrings.`eu-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-southeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-south-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-1` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-2` | awsDashSdkLib.awsDashSdkLibStrings.`ap-northeast-3` | awsDashSdkLib.awsDashSdkLibStrings.`eu-north-1` | awsDashSdkLib.awsDashSdkLibStrings.`sa-east-1` | awsDashSdkLib.awsDashSdkLibStrings.`ca-central-1` | awsDashSdkLib.awsDashSdkLibStrings.`cn-north-1` | java.lang.String
  type VPCs = js.Array[VPC]
  type apiVersion = awsDashSdkLib.awsDashSdkLibStrings.`2013-04-01` | awsDashSdkLib.awsDashSdkLibStrings.latest | java.lang.String
}
