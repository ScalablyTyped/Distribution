...
trait SourceBuildInformation extends js.Object {
  /**
    ...
    */
  var SourceLocation: awsDashSdkLib.clientsElasticbeanstalkMod.SourceLocation
  /**
    * Location where the repository is stored.    CodeCommit     S3   
    */
  var SourceRepository: awsDashSdkLib.clientsElasticbeanstalkMod.SourceRepository
  /**
    * The type of repository.    Git     Zip   
    */
  var SourceType: awsDashSdkLib.clientsElasticbeanstalkMod.SourceType
}
