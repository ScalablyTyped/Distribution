...
object RedshiftDataSpec {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(DatabaseCredentials = DatabaseCredentials, DatabaseInformation = DatabaseInformation, S3StagingLocation = S3StagingLocation, SelectSqlQuery = SelectSqlQuery)
