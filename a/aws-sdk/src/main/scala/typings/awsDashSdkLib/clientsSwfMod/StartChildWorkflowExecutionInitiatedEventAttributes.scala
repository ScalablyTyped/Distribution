...
object StartChildWorkflowExecutionInitiatedEventAttributes {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(childPolicy = childPolicy.asInstanceOf[js.Any], decisionTaskCompletedEventId = decisionTaskCompletedEventId, taskList = taskList, workflowId = workflowId, workflowType = workflowType)
