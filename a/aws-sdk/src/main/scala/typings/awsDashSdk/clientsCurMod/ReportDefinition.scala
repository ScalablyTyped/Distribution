...
trait ReportDefinition extends js.Object {
  ...
  /**
    ...
    */
  var RefreshClosedReports: js.UndefOr[typings.awsDashSdk.clientsCurMod.RefreshClosedReports] = js.undefined
  var ReportName: typings.awsDashSdk.clientsCurMod.ReportName
  /**
    * Whether you want Amazon Web Services to overwrite the previous version of each report or to deliver the report in addition to the previous versions.
    */
  var ReportVersioning: js.UndefOr[typings.awsDashSdk.clientsCurMod.ReportVersioning] = js.undefined
  var S3Bucket: typings.awsDashSdk.clientsCurMod.S3Bucket
  var S3Prefix: typings.awsDashSdk.clientsCurMod.S3Prefix
  var S3Region: AWSRegion
  var TimeUnit: typings.awsDashSdk.clientsCurMod.TimeUnit
}
