...
trait DomainNameConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var CertificateUploadDate: js.UndefOr[__timestampIso8601] = js.native
  /**
    * The status of the domain name migration. The valid values are AVAILABLE and UPDATING. If the status is UPDATING, the domain cannot be modified further until the existing operation is complete. If it is AVAILABLE, the domain can be updated.
    */
  var DomainNameStatus: js.UndefOr[typings.awsDashSdk.clientsApigatewayv2Mod.DomainNameStatus] = js.native
  /**
  ...
  /**
    * The endpoint type.
    */
  var EndpointType: js.UndefOr[typings.awsDashSdk.clientsApigatewayv2Mod.EndpointType] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityPolicy: js.UndefOr[typings.awsDashSdk.clientsApigatewayv2Mod.SecurityPolicy] = js.native
}
