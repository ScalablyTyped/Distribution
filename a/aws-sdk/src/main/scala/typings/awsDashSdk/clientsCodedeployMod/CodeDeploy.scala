...
import typings.awsDashSdk.awsDashSdkStrings.deploymentSuccessful
...
trait CodeDeploy extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_deploymentSuccessful(state: deploymentSuccessful, params: GetDeploymentInput with Anon_Waiter): Request[GetDeploymentOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_deploymentSuccessful(
    state: deploymentSuccessful,
    params: GetDeploymentInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetDeploymentOutput, Unit]
  ): Request[GetDeploymentOutput, AWSError] = js.native
}
