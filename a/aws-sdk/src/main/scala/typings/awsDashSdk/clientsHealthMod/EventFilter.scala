...
trait EventFilter extends js.Object {
  /**
    ...
    */
  var availabilityZones: js.UndefOr[typings.awsDashSdk.clientsHealthMod.availabilityZones] = js.undefined
  /**
...
object EventFilter {
  ...
  def apply(
    ...
    if (endTimes != null) __obj.updateDynamic("endTimes")(endTimes)
    ...
    if (eventStatusCodes != null) __obj.updateDynamic("eventStatusCodes")(eventStatusCodes)
    ...
    if (startTimes != null) __obj.updateDynamic("startTimes")(startTimes)
