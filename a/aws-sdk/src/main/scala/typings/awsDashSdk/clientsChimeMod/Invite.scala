...
trait Invite extends js.Object {
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typings.awsDashSdk.clientsChimeMod.EmailAddress] = js.native
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typings.awsDashSdk.clientsChimeMod.EmailStatus] = js.native
  /**
    * The invite ID.
    */
