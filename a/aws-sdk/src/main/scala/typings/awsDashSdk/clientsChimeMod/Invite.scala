...
trait Invite extends js.Object {
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typings.awsDashSdk.clientsChimeMod.EmailAddress] = js.undefined
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typings.awsDashSdk.clientsChimeMod.EmailStatus] = js.undefined
  /**
    * The invite ID.
    */
