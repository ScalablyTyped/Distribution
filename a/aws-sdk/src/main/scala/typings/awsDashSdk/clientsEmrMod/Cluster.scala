...
trait Cluster extends js.Object {
  ...
  /**
    ...
    */
  var Ec2InstanceAttributes: js.UndefOr[typings.awsDashSdk.clientsEmrMod.Ec2InstanceAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceCollectionType: js.UndefOr[typings.awsDashSdk.clientsEmrMod.InstanceCollectionType] = js.native
  /**
    * Attributes for Kerberos configuration when Kerberos authentication is enabled using a security configuration. For more information see Use Kerberos Authentication in the EMR Management Guide.
    */
  var KerberosAttributes: js.UndefOr[typings.awsDashSdk.clientsEmrMod.KerberosAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var RepoUpgradeOnBoot: js.UndefOr[typings.awsDashSdk.clientsEmrMod.RepoUpgradeOnBoot] = js.native
  /**
