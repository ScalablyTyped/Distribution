...
trait AssumeRoleWithWebIdentityResponse extends js.Object {
  /**
    ...
    */
  var AssumedRoleUser: js.UndefOr[typings.awsDashSdk.clientsStsMod.AssumedRoleUser] = js.native
  /**
    * The intended audience (also known as client ID) of the web identity token. This is traditionally the client identifier issued to the application that requested the web identity token.
    */
  var Audience: js.UndefOr[typings.awsDashSdk.clientsStsMod.Audience] = js.native
  /**
