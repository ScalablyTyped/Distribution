...
trait IndexField extends js.Object {
  var DateArrayOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.DateArrayOptions] = js.undefined
  var DateOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.DateOptions] = js.undefined
  var DoubleArrayOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.DoubleArrayOptions] = js.undefined
  var DoubleOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.DoubleOptions] = js.undefined
  /**
  ...
  var IndexFieldType: typings.awsDashSdk.clientsCloudsearchMod.IndexFieldType
  var IntArrayOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.IntArrayOptions] = js.undefined
  var IntOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.IntOptions] = js.undefined
  var LatLonOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.LatLonOptions] = js.undefined
  var LiteralArrayOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.LiteralArrayOptions] = js.undefined
  var LiteralOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.LiteralOptions] = js.undefined
  var TextArrayOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.TextArrayOptions] = js.undefined
  var TextOptions: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.TextOptions] = js.undefined
}
