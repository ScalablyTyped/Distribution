...
trait DomainStatus extends js.Object {
  var ARN: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.ARN] = js.native
  /**
  ...
  var DomainId: typings.awsDashSdk.clientsCloudsearchMod.DomainId = js.native
  var DomainName: typings.awsDashSdk.clientsCloudsearchMod.DomainName = js.native
  var Limits: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.Limits] = js.native
  /**
  ...
  /**
    ...
    */
  var SearchInstanceType: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.SearchInstanceType] = js.native
  /**
