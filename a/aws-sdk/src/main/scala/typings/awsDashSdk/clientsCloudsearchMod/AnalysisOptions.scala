...
trait AnalysisOptions extends js.Object {
  /**
    ...
    */
  var AlgorithmicStemming: js.UndefOr[typings.awsDashSdk.clientsCloudsearchMod.AlgorithmicStemming] = js.undefined
  /**
...
object AnalysisOptions {
  ...
  def apply(
    ...
    if (JapaneseTokenizationDictionary != null) __obj.updateDynamic("JapaneseTokenizationDictionary")(JapaneseTokenizationDictionary)
    if (StemmingDictionary != null) __obj.updateDynamic("StemmingDictionary")(StemmingDictionary)
