...
trait DirectoryDescription extends js.Object {
  /**
    ...
    */
  var AccessUrl: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.AccessUrl] = js.undefined
  /**
  ...
  /**
    ...
    */
  var DesiredNumberOfDomainControllers: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.DesiredNumberOfDomainControllers] = js.undefined
  /**
  ...
  /**
    ...
    */
  var OwnerDirectoryDescription: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.OwnerDirectoryDescription] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SsoEnabled: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.SsoEnabled] = js.undefined
  /**
  ...
  /**
    ...
    */
  var StageReason: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.StageReason] = js.undefined
  /**
    * The directory size.
    */
...
object DirectoryDescription {
  ...
  def apply(
    ...
    if (OwnerDirectoryDescription != null) __obj.updateDynamic("OwnerDirectoryDescription")(OwnerDirectoryDescription)
    ...
    if (!js.isUndefined(SsoEnabled)) __obj.updateDynamic("SsoEnabled")(SsoEnabled)
    if (Stage != null) __obj.updateDynamic("Stage")(Stage.asInstanceOf[js.Any])
    if (StageLastUpdatedDateTime != null) __obj.updateDynamic("StageLastUpdatedDateTime")(StageLastUpdatedDateTime)
    if (StageReason != null) __obj.updateDynamic("StageReason")(StageReason)
