...
trait ShareDirectoryRequest extends js.Object {
  ...
  /**
    ...
    */
  var ShareMethod: typings.awsDashSdk.clientsDirectoryserviceMod.ShareMethod = js.native
  /**
  ...
  /**
    ...
    */
  var ShareTarget: typings.awsDashSdk.clientsDirectoryserviceMod.ShareTarget = js.native
}
