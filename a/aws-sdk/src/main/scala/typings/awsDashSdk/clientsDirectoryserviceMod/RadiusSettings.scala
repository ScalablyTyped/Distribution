...
trait RadiusSettings extends js.Object {
  ...
  /**
    ...
    */
  var RadiusRetries: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.RadiusRetries] = js.native
  /**
  ...
  /**
    ...
    */
  var RadiusTimeout: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.RadiusTimeout] = js.native
  /**
  ...
  /**
    * Not currently used.
    */
  var UseSameUsername: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.UseSameUsername] = js.native
}
