...
trait SchemaExtensionInfo extends js.Object {
  ...
  /**
    ...
    */
  var EndDateTime: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.EndDateTime] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SchemaExtensionStatus: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.SchemaExtensionStatus] = js.undefined
  /**
    * The reason for the SchemaExtensionStatus.
    */
  var SchemaExtensionStatusReason: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.SchemaExtensionStatusReason] = js.undefined
  /**
    * The date and time that the schema extension started being applied to the directory.
    */
  var StartDateTime: js.UndefOr[typings.awsDashSdk.clientsDirectoryserviceMod.StartDateTime] = js.undefined
}
