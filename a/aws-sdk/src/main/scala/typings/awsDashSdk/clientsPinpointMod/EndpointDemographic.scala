...
trait EndpointDemographic extends js.Object {
  /**
    ...
    */
  var AppVersion: js.UndefOr[__string] = js.native
  /**
    * The locale of the endpoint, in the following format: the ISO 639-1 alpha-2 code, followed by an underscore (_), followed by an ISO 3166-1 alpha-2 value.
    */
  var Locale: js.UndefOr[__string] = js.native
  /**
    * The manufacturer of the endpoint device, such as apple or samsung.
    */
  var Make: js.UndefOr[__string] = js.native
  /**
    * The model name or number of the endpoint device, such as iPhone or SM-G900F.
    */
  var Model: js.UndefOr[__string] = js.native
  /**
    * The model version of the endpoint device.
    */
  var ModelVersion: js.UndefOr[__string] = js.native
  /**
    * The platform of the endpoint device, such as ios.
    */
  var Platform: js.UndefOr[__string] = js.native
  /**
    * The platform version of the endpoint device.
    */
  var PlatformVersion: js.UndefOr[__string] = js.native
  /**
