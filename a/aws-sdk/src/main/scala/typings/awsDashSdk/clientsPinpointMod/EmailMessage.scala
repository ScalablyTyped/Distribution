...
trait EmailMessage extends js.Object {
  ...
  /**
    ...
    */
  var RawEmail: js.UndefOr[typings.awsDashSdk.clientsPinpointMod.RawEmail] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SimpleEmail: js.UndefOr[typings.awsDashSdk.clientsPinpointMod.SimpleEmail] = js.undefined
  /**
