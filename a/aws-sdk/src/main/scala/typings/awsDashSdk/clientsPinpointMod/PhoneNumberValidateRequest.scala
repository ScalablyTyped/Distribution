...
trait PhoneNumberValidateRequest extends js.Object {
  var NumberValidateRequest: typings.awsDashSdk.clientsPinpointMod.NumberValidateRequest
}

object PhoneNumberValidateRequest {
  @scala.inline
  def apply(NumberValidateRequest: NumberValidateRequest): PhoneNumberValidateRequest = {
    val __obj = js.Dynamic.literal(NumberValidateRequest = NumberValidateRequest)
