...
trait EmailMessageActivity extends js.Object {
  ...
  /**
    ...
    */
  var NextActivity: js.UndefOr[__string] = js.native
  /**
    * The name of the email template to use for the message.
    */
  var TemplateName: js.UndefOr[__string] = js.native
  /**
    ...
    */
  var TemplateVersion: js.UndefOr[__string] = js.native
}
...
object EmailMessageActivity {
  ...
  def apply(
    ...
    NextActivity: __string = null,
    TemplateName: __string = null,
    TemplateVersion: __string = null
