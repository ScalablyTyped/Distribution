...
trait StorediSCSIVolume extends js.Object {
  /**
    ...
    */
  var CreatedDate: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.CreatedDate] = js.native
  ...
  /**
    ...
    */
  var TargetName: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.TargetName] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatus: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.VolumeStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeUsedInBytes: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.VolumeUsedInBytes] = js.native
  /**
    * An VolumeiSCSIAttributes object that represents a collection of iSCSI attributes for one stored volume.
    */
  var VolumeiSCSIAttributes: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.VolumeiSCSIAttributes] = js.native
}
...
object StorediSCSIVolume {
  ...
  def apply(
    ...
    if (!js.isUndefined(PreservedExistingData)) __obj.updateDynamic("PreservedExistingData")(PreservedExistingData.asInstanceOf[js.Any])
