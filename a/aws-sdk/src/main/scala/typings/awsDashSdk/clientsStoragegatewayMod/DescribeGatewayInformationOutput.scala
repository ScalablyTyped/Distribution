...
trait DescribeGatewayInformationOutput extends js.Object {
  ...
  /**
    ...
    */
  var GatewayNetworkInterfaces: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.GatewayNetworkInterfaces] = js.native
  /**
    * A value that indicates the operating state of the gateway.
    */
  var GatewayState: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.GatewayState] = js.native
  /**
  ...
  /**
    ...
    */
  var HostEnvironment: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.HostEnvironment] = js.native
  /**
    * The date on which the last software update was applied to the gateway. If the gateway has never been updated, this field does not return a value in the response.
    */
  var LastSoftwareUpdate: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.LastSoftwareUpdate] = js.native
  /**
    * The date on which an update to the gateway is available. This date is in the time zone of the gateway. If the gateway is not available for an update this field is not returned in the response.
    */
  var NextUpdateAvailabilityDate: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.NextUpdateAvailabilityDate] = js.native
  /**
