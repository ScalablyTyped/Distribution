...
trait ActivateGatewayInput extends js.Object {
  /**
    ...
    */
  var ActivationKey: typings.awsDashSdk.clientsStoragegatewayMod.ActivationKey = js.native
  /**
    * The name you configured for your gateway.
    */
  var GatewayName: typings.awsDashSdk.clientsStoragegatewayMod.GatewayName = js.native
  /**
  ...
  /**
    ...
    */
  var GatewayTimezone: typings.awsDashSdk.clientsStoragegatewayMod.GatewayTimezone = js.native
  /**
  ...
  /**
    ...
    */
  var MediumChangerType: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.MediumChangerType] = js.native
  /**
  ...
  /**
    ...
    */
  var TapeDriveType: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.TapeDriveType] = js.native
}
