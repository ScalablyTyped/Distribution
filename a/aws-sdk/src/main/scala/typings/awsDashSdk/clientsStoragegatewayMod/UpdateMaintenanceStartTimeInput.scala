...
trait UpdateMaintenanceStartTimeInput extends js.Object {
  ...
  /**
    ...
    */
  var HourOfDay: typings.awsDashSdk.clientsStoragegatewayMod.HourOfDay = js.native
  /**
    * The minute component of the maintenance start time represented as mm, where mm is the minute (00 to 59). The minute of the hour is in the time zone of the gateway.
    */
  var MinuteOfHour: typings.awsDashSdk.clientsStoragegatewayMod.MinuteOfHour = js.native
}
