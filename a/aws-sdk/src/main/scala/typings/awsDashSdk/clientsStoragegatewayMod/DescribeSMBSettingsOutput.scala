...
trait DescribeSMBSettingsOutput extends js.Object {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.DomainName] = js.native
  ...
  /**
    ...
    */
  var SMBSecurityStrategy: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.SMBSecurityStrategy] = js.native
}
