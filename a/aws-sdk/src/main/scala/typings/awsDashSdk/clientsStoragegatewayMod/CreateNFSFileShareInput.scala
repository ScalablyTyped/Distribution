...
trait CreateNFSFileShareInput extends js.Object {
  ...
  /**
    ...
    */
  var ClientToken: typings.awsDashSdk.clientsStoragegatewayMod.ClientToken = js.native
  /**
  ...
  /**
    ...
    */
  var LocationARN: typings.awsDashSdk.clientsStoragegatewayMod.LocationARN = js.native
  /**
  ...
  /**
    ...
    */
  var Role: typings.awsDashSdk.clientsStoragegatewayMod.Role = js.native
  /**
