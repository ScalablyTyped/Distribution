...
trait GatewayInfo extends js.Object {
  /**
    ...
    */
  var Ec2InstanceId: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.Ec2InstanceId] = js.native
  /**
    * The AWS Region where the Amazon EC2 instance is located.
    */
  var Ec2InstanceRegion: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.Ec2InstanceRegion] = js.native
  /**
  ...
  /**
    ...
    */
  var GatewayOperationalState: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.GatewayOperationalState] = js.native
  /**
    * The type of the gateway.
    */
  var GatewayType: js.UndefOr[typings.awsDashSdk.clientsStoragegatewayMod.GatewayType] = js.native
}
