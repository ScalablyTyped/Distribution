...
trait ResourceChangeDetail extends js.Object {
  /**
    ...
    */
  var CausingEntity: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.CausingEntity] = js.native
  /**
    ...
    */
  var ChangeSource: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ChangeSource] = js.native
  /**
