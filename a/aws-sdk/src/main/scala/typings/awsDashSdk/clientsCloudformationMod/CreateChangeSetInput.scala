...
trait CreateChangeSetInput extends js.Object {
  ...
  /**
    ...
    */
  var ChangeSetName: typings.awsDashSdk.clientsCloudformationMod.ChangeSetName = js.native
  /**
    ...
    */
  var ChangeSetType: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ChangeSetType] = js.native
  /**
    * A unique identifier for this CreateChangeSet request. Specify this token if you plan to retry requests so that AWS CloudFormation knows that you're not attempting to create another change set with the same name. You might retry CreateChangeSet requests to ensure that AWS CloudFormation successfully received them.
    */
  var ClientToken: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ClientToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourcesToImport: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ResourcesToImport] = js.native
  /**
