...
trait ContinueUpdateRollbackInput extends js.Object {
  ...
  /**
    ...
    */
  var ResourcesToSkip: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ResourcesToSkip] = js.undefined
  /**
...
object ContinueUpdateRollbackInput {
  ...
  def apply(
    ...
    if (ResourcesToSkip != null) __obj.updateDynamic("ResourcesToSkip")(ResourcesToSkip)
