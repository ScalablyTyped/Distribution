...
trait PropertyDifference extends js.Object {
  ...
  /**
    ...
    */
  var DifferenceType: typings.awsDashSdk.clientsCloudformationMod.DifferenceType
  /**
  ...
  /**
    ...
    */
  var PropertyPath: typings.awsDashSdk.clientsCloudformationMod.PropertyPath
}
