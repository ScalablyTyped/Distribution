...
trait DescribeStackDriftDetectionStatusOutput extends js.Object {
  ...
  /**
    ...
    */
  var StackDriftDetectionId: typings.awsDashSdk.clientsCloudformationMod.StackDriftDetectionId
  /**
    ...
    */
  var StackDriftStatus: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.StackDriftStatus] = js.undefined
  /**
    * The ID of the stack.
    */
