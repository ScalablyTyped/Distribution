...
trait StackResourceDrift extends js.Object {
  ...
  /**
    ...
    */
  var PhysicalResourceIdContext: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.PhysicalResourceIdContext] = js.undefined
  /**
    * A collection of the resource properties whose actual values differ from their expected values. These will be present only for resources whose StackResourceDriftStatus is MODIFIED. 
    */
  var PropertyDifferences: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.PropertyDifferences] = js.undefined
  /**
