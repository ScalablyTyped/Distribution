...
trait RecordHandlerProgressInput extends js.Object {
  ...
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var OperationStatus: typings.awsDashSdk.clientsCloudformationMod.OperationStatus = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var ResourceModel: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.ResourceModel] = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var StatusMessage: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.StatusMessage] = js.native
}
