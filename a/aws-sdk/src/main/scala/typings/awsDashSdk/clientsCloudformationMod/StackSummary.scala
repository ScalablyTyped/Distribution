...
trait StackSummary extends js.Object {
  /**
    ...
    */
  var CreationTime: typings.awsDashSdk.clientsCloudformationMod.CreationTime = js.native
  /**
    * The time the stack was deleted.
    */
  var DeletionTime: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.DeletionTime] = js.native
  /**
  ...
  /**
    ...
    */
  var LastUpdatedTime: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.LastUpdatedTime] = js.native
  /**
  ...
  /**
    ...
    */
  var StackStatus: typings.awsDashSdk.clientsCloudformationMod.StackStatus = js.native
  /**
    * Success/Failure message associated with the stack status.
    */
  var StackStatusReason: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.StackStatusReason] = js.native
  /**
    * The template description of the template used to create the stack.
    */
  var TemplateDescription: js.UndefOr[typings.awsDashSdk.clientsCloudformationMod.TemplateDescription] = js.native
}
