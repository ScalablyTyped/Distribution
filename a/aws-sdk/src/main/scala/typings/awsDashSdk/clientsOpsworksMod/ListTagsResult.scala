...
trait ListTagsResult extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typings.awsDashSdk.clientsOpsworksMod.NextToken] = js.native
  /**
    * A set of key-value pairs that contain tag keys and tag values that are attached to a stack or layer.
    */
  var Tags: js.UndefOr[typings.awsDashSdk.clientsOpsworksMod.Tags] = js.native
}
