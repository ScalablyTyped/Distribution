...
trait GetMediaForFragmentListOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoarchivedmediaMod.ContentType] = js.native
  /**
    ...
    */
  var Payload: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoarchivedmediaMod.Payload] = js.native
}
