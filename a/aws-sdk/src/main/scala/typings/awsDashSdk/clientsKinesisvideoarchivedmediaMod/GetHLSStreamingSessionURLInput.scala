...
trait GetHLSStreamingSessionURLInput extends js.Object {
  /**
    ...
    */
  var ContainerFormat: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoarchivedmediaMod.ContainerFormat] = js.native
  /**
  ...
  /**
    ...
    */
  var HLSFragmentSelector: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoarchivedmediaMod.HLSFragmentSelector] = js.native
  /**
