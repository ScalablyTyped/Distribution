...
trait NamedQuery extends js.Object {
  ...
  /**
    ...
    */
  var NamedQueryId: js.UndefOr[typings.awsDashSdk.clientsAthenaMod.NamedQueryId] = js.undefined
  /**
    * The SQL query statements that comprise the query.
    */
  var QueryString: typings.awsDashSdk.clientsAthenaMod.QueryString
  /**
