...
trait Listener extends js.Object {
  /**
    ...
    */
  var InstancePort: typings.awsDashSdk.clientsElbMod.InstancePort = js.native
  /**
  ...
  /**
    ...
    */
  var Protocol: typings.awsDashSdk.clientsElbMod.Protocol = js.native
  /**
    * The Amazon Resource Name (ARN) of the server certificate.
    */
  var SSLCertificateId: js.UndefOr[typings.awsDashSdk.clientsElbMod.SSLCertificateId] = js.native
}
