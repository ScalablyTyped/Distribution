...
trait LoadBalancerAttributes extends js.Object {
  /**
    ...
    */
  var AccessLog: js.UndefOr[typings.awsDashSdk.clientsElbMod.AccessLog] = js.native
  /**
    * This parameter is reserved.
    */
  var AdditionalAttributes: js.UndefOr[typings.awsDashSdk.clientsElbMod.AdditionalAttributes] = js.native
  /**
    ...
    */
  var ConnectionDraining: js.UndefOr[typings.awsDashSdk.clientsElbMod.ConnectionDraining] = js.native
  /**
    ...
    */
  var ConnectionSettings: js.UndefOr[typings.awsDashSdk.clientsElbMod.ConnectionSettings] = js.native
  /**
    ...
    */
  var CrossZoneLoadBalancing: js.UndefOr[typings.awsDashSdk.clientsElbMod.CrossZoneLoadBalancing] = js.native
}
