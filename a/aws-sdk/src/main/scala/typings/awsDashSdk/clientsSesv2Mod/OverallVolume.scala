...
trait OverallVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typings.awsDashSdk.clientsSesv2Mod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typings.awsDashSdk.clientsSesv2Mod.VolumeStatistics] = js.native
}
