...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typings.awsDashSdk.clientsSesv2Mod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typings.awsDashSdk.clientsSesv2Mod.MailFromDomainStatus = js.native
}
