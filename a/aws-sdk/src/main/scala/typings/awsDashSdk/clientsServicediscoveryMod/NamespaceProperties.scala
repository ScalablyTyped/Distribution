...
trait NamespaceProperties extends js.Object {
  /**
    ...
    */
  var DnsProperties: js.UndefOr[typings.awsDashSdk.clientsServicediscoveryMod.DnsProperties] = js.undefined
  /**
    * A complex type that contains the name of an HTTP namespace.
    */
  var HttpProperties: js.UndefOr[typings.awsDashSdk.clientsServicediscoveryMod.HttpProperties] = js.undefined
}
