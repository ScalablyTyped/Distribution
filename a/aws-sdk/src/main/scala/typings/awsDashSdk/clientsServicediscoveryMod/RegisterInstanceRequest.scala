...
trait RegisterInstanceRequest extends js.Object {
  /**
    ...
    */
  var Attributes: typings.awsDashSdk.clientsServicediscoveryMod.Attributes
  /**
...
object RegisterInstanceRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Attributes = Attributes, InstanceId = InstanceId, ServiceId = ServiceId)
