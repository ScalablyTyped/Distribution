...
trait ListLoggingConfigurationsRequest extends js.Object {
  ...
  /**
    ...
    */
  var Scope: js.UndefOr[typings.awsDashSdk.clientsWafv2Mod.Scope] = js.native
}

object ListLoggingConfigurationsRequest {
  @scala.inline
  def apply(Limit: Int | Double = null, NextMarker: NextMarker = null, Scope: Scope = null): ListLoggingConfigurationsRequest = {
