...
trait S3DataSourceConfiguration extends js.Object {
  /**
    ...
    */
  var AccessControlListConfiguration: js.UndefOr[typings.awsDashSdk.clientsKendraMod.AccessControlListConfiguration] = js.native
  /**
    * The name of the bucket that contains the documents.
    */
  var BucketName: S3BucketName = js.native
  var DocumentsMetadataConfiguration: js.UndefOr[typings.awsDashSdk.clientsKendraMod.DocumentsMetadataConfiguration] = js.native
  /**
