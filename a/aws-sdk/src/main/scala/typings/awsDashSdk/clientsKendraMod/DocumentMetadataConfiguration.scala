...
trait DocumentMetadataConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var Relevance: js.UndefOr[typings.awsDashSdk.clientsKendraMod.Relevance] = js.native
  /**
    * Provides information about how the field is used during a search.
    */
  var Search: js.UndefOr[typings.awsDashSdk.clientsKendraMod.Search] = js.native
  /**
