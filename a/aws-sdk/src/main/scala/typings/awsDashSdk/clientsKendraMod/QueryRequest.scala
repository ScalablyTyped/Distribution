...
trait QueryRequest extends js.Object {
  /**
    ...
    */
  var AttributeFilter: js.UndefOr[typings.awsDashSdk.clientsKendraMod.AttributeFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryText: typings.awsDashSdk.clientsKendraMod.QueryText = js.native
  /**
