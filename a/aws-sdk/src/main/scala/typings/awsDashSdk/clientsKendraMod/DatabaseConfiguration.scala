...
trait DatabaseConfiguration extends js.Object {
  /**
    ...
    */
  var AclConfiguration: js.UndefOr[typings.awsDashSdk.clientsKendraMod.AclConfiguration] = js.native
  /**
    * Information about where the index should get the document information from the database.
    */
  var ColumnConfiguration: typings.awsDashSdk.clientsKendraMod.ColumnConfiguration = js.native
  /**
    * The information necessary to connect to a database.
    */
  var ConnectionConfiguration: typings.awsDashSdk.clientsKendraMod.ConnectionConfiguration = js.native
  /**
    * The type of database engine that runs the database.
    */
  var DatabaseEngineType: typings.awsDashSdk.clientsKendraMod.DatabaseEngineType = js.native
