...
trait CreateFileSystemRequest extends js.Object {
  /**
    ...
    */
  var CreationToken: typings.awsDashSdk.clientsEfsMod.CreationToken = js.native
  /**
    ...
    */
  var Encrypted: js.UndefOr[typings.awsDashSdk.clientsEfsMod.Encrypted] = js.native
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typings.awsDashSdk.clientsEfsMod.KmsKeyId] = js.native
  /**
    * The performance mode of the file system. We recommend generalPurpose performance mode for most file systems. File systems using the maxIO performance mode can scale to higher levels of aggregate throughput and operations per second with a tradeoff of slightly higher latencies for most file operations. The performance mode can't be changed after the file system has been created.
    */
  var PerformanceMode: js.UndefOr[typings.awsDashSdk.clientsEfsMod.PerformanceMode] = js.native
  /**
    ...
    */
  var ProvisionedThroughputInMibps: js.UndefOr[typings.awsDashSdk.clientsEfsMod.ProvisionedThroughputInMibps] = js.native
  /**
    ...
    */
  var Tags: js.UndefOr[typings.awsDashSdk.clientsEfsMod.Tags] = js.native
  /**
    ...
    */
  var ThroughputMode: js.UndefOr[typings.awsDashSdk.clientsEfsMod.ThroughputMode] = js.native
}
