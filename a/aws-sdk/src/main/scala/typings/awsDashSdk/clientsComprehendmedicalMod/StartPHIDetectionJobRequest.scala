...
trait StartPHIDetectionJobRequest extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: typings.awsDashSdk.clientsComprehendmedicalMod.InputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageCode: typings.awsDashSdk.clientsComprehendmedicalMod.LanguageCode = js.native
  /**
    * Specifies where to send the output files.
    */
  var OutputDataConfig: typings.awsDashSdk.clientsComprehendmedicalMod.OutputDataConfig = js.native
}
