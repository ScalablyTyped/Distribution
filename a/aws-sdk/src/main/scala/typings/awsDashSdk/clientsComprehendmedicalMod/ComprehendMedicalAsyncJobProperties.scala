...
trait ComprehendMedicalAsyncJobProperties extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.InputDataConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var JobName: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.JobName] = js.native
  /**
    * The current status of the detection job. If the status is FAILED, the Message field shows the reason for the failure.
    */
  var JobStatus: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.JobStatus] = js.native
  /**
    * The AWS Key Management Service key, if any, used to encrypt the output files. 
    */
  var KMSKey: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.KMSKey] = js.native
  /**
    * The language code of the input documents.
    */
  var LanguageCode: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.LanguageCode] = js.native
  /**
    * The path to the file that describes the results of a batch job.
    */
  var ManifestFilePath: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.ManifestFilePath] = js.native
  /**
  ...
  /**
    ...
    */
  var ModelVersion: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.ModelVersion] = js.native
  /**
    * The output data configuration that you supplied when you created the detection job.
    */
  var OutputDataConfig: js.UndefOr[typings.awsDashSdk.clientsComprehendmedicalMod.OutputDataConfig] = js.native
  /**
