...
trait ScalingPolicy extends js.Object {
  ...
  /**
    ...
    */
  var PolicyName: typings.awsDashSdk.clientsApplicationautoscalingMod.PolicyName = js.native
  /**
    * The scaling policy type.
    */
  var PolicyType: typings.awsDashSdk.clientsApplicationautoscalingMod.PolicyType = js.native
  /**
