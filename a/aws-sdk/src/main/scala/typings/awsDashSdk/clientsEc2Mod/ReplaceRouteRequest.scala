...
trait ReplaceRouteRequest extends js.Object {
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.InstanceId] = js.native
  /**
  ...
  /**
    ...
    */
  var NatGatewayId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.NatGatewayId] = js.native
  /**
    * The ID of a network interface.
    */
  var NetworkInterfaceId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.NetworkInterfaceId] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcPeeringConnectionId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.VpcPeeringConnectionId] = js.native
}
