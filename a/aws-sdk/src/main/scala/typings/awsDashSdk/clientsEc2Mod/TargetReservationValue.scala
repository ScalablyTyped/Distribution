...
trait TargetReservationValue extends js.Object {
  /**
    ...
    */
  var ReservationValue: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.ReservationValue] = js.native
  /**
    * The configuration of the Convertible Reserved Instances that make up the exchange.
    */
  var TargetConfiguration: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.TargetConfiguration] = js.native
}
