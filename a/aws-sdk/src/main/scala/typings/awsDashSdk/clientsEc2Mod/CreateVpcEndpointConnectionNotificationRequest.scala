...
trait CreateVpcEndpointConnectionNotificationRequest extends js.Object {
  ...
  /**
    ...
    */
  var ServiceId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.ServiceId] = js.native
  /**
    * The ID of the endpoint. 
    */
  var VpcEndpointId: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.VpcEndpointId] = js.native
}
