...
trait NetworkInfo extends js.Object {
  /**
    ...
    */
  var EnaSupport: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.EnaSupport] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkPerformance: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.NetworkPerformance] = js.native
}
