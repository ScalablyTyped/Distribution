...
trait ExportTask extends js.Object {
  ...
  /**
    ...
    */
  var ExportToS3Task: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.ExportToS3Task] = js.native
  /**
    * Information about the instance to export.
    */
  var InstanceExportDetails: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.InstanceExportDetails] = js.native
  /**
