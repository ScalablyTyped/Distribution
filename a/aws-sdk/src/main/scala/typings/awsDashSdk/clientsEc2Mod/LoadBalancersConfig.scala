...
trait LoadBalancersConfig extends js.Object {
  /**
    ...
    */
  var ClassicLoadBalancersConfig: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.ClassicLoadBalancersConfig] = js.native
  /**
    * The target groups.
    */
  var TargetGroupsConfig: js.UndefOr[typings.awsDashSdk.clientsEc2Mod.TargetGroupsConfig] = js.native
}
