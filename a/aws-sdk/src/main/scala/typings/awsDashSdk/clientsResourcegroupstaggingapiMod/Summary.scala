...
trait Summary extends js.Object {
  /**
    ...
    */
  var LastUpdated: js.UndefOr[typings.awsDashSdk.clientsResourcegroupstaggingapiMod.LastUpdated] = js.native
  /**
    * The count of noncompliant resources.
    */
  var NonCompliantResources: js.UndefOr[typings.awsDashSdk.clientsResourcegroupstaggingapiMod.NonCompliantResources] = js.native
  /**
    * The AWS Region that the summary applies to.
    */
  var Region: js.UndefOr[typings.awsDashSdk.clientsResourcegroupstaggingapiMod.Region] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetId: js.UndefOr[typings.awsDashSdk.clientsResourcegroupstaggingapiMod.TargetId] = js.native
  /**
    * Whether the target is an account, an OU, or the organization root.
    */
  var TargetIdType: js.UndefOr[typings.awsDashSdk.clientsResourcegroupstaggingapiMod.TargetIdType] = js.native
}
