...
trait CopyBackupToRegionResponse extends js.Object {
  /**
    ...
    */
  var DestinationBackup: js.UndefOr[typings.awsDashSdk.clientsCloudhsmv2Mod.DestinationBackup] = js.undefined
}
...
object CopyBackupToRegionResponse {
  ...
  def apply(DestinationBackup: DestinationBackup = null): CopyBackupToRegionResponse = {
    ...
    if (DestinationBackup != null) __obj.updateDynamic("DestinationBackup")(DestinationBackup)
