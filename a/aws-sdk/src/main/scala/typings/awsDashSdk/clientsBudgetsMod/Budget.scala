...
trait Budget extends js.Object {
  ...
  /**
    ...
    */
  var BudgetType: typings.awsDashSdk.clientsBudgetsMod.BudgetType = js.native
  /**
    * The actual and forecasted cost or usage that the budget tracks.
    */
  var CalculatedSpend: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.CalculatedSpend] = js.native
  /**
    ...
    */
  var CostFilters: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.CostFilters] = js.native
  /**
    ...
    */
  var CostTypes: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.CostTypes] = js.native
  /**
  ...
  /**
    ...
    */
  var PlannedBudgetLimits: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.PlannedBudgetLimits] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeUnit: typings.awsDashSdk.clientsBudgetsMod.TimeUnit = js.native
}
