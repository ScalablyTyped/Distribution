...
trait BudgetPerformanceHistory extends js.Object {
  var BudgetName: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.BudgetName] = js.native
  var BudgetType: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.BudgetType] = js.native
  /**
    * A list of amounts of cost or usage that you created budgets for, compared to your actual costs or usage.
    */
  var BudgetedAndActualAmountsList: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.BudgetedAndActualAmountsList] = js.native
  /**
  ...
  var TimeUnit: js.UndefOr[typings.awsDashSdk.clientsBudgetsMod.TimeUnit] = js.native
}
