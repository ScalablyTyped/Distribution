...
trait GroupIdentifier extends js.Object {
  /**
    ...
    */
  var GroupArn: js.UndefOr[typings.awsDashSdk.clientsResourcegroupsMod.GroupArn] = js.native
  /**
    * The name of a resource group.
    */
  var GroupName: js.UndefOr[typings.awsDashSdk.clientsResourcegroupsMod.GroupName] = js.native
}
