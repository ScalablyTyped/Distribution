...
import typings.awsDashSdk.awsDashSdkStrings.alarmExists
...
trait CloudWatch extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_alarmExists(state: alarmExists, params: DescribeAlarmsInput with Anon_Waiter): Request[DescribeAlarmsOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_alarmExists(
    state: alarmExists,
    params: DescribeAlarmsInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeAlarmsOutput, Unit]
  ): Request[DescribeAlarmsOutput, AWSError] = js.native
}
