...
trait DescribeAlarmsInput extends js.Object {
  /**
    ...
    */
  var ActionPrefix: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.ActionPrefix] = js.undefined
  /**
    * The alarm name prefix. If this parameter is specified, you cannot specify AlarmNames.
    */
  var AlarmNamePrefix: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.AlarmNamePrefix] = js.undefined
  /**
    * The names of the alarms.
    */
  var AlarmNames: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.AlarmNames] = js.undefined
  /**
