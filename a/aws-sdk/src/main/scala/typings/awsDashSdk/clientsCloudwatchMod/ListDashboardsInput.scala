...
trait ListDashboardsInput extends js.Object {
  /**
    ...
    */
  var DashboardNamePrefix: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.DashboardNamePrefix] = js.undefined
  /**
...
object ListDashboardsInput {
  ...
  def apply(DashboardNamePrefix: DashboardNamePrefix = null, NextToken: NextToken = null): ListDashboardsInput = {
    ...
    if (DashboardNamePrefix != null) __obj.updateDynamic("DashboardNamePrefix")(DashboardNamePrefix)
