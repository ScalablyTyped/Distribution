...
trait PutMetricAlarmInput extends js.Object {
  ...
  /**
    ...
    */
  var ComparisonOperator: typings.awsDashSdk.clientsCloudwatchMod.ComparisonOperator = js.native
  /**
  ...
  /**
    ...
    */
  var EvaluationPeriods: typings.awsDashSdk.clientsCloudwatchMod.EvaluationPeriods = js.native
  /**
