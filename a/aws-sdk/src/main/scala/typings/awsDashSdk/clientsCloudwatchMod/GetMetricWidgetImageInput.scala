...
trait GetMetricWidgetImageInput extends js.Object {
  /**
    ...
    */
  var MetricWidget: typings.awsDashSdk.clientsCloudwatchMod.MetricWidget = js.native
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.OutputFormat] = js.native
}
