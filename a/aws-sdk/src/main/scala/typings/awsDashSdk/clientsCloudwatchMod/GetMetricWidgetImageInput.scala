...
trait GetMetricWidgetImageInput extends js.Object {
  /**
    ...
    */
  var MetricWidget: typings.awsDashSdk.clientsCloudwatchMod.MetricWidget
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.OutputFormat] = js.undefined
}
...
object GetMetricWidgetImageInput {
  ...
  def apply(MetricWidget: MetricWidget, OutputFormat: OutputFormat = null): GetMetricWidgetImageInput = {
    val __obj = js.Dynamic.literal(MetricWidget = MetricWidget)
