...
trait GetMetricDataInput extends js.Object {
  ...
  /**
    ...
    */
  var MetricDataQueries: typings.awsDashSdk.clientsCloudwatchMod.MetricDataQueries = js.native
  /**
  ...
  /**
    ...
    */
  var ScanBy: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.ScanBy] = js.native
  /**
