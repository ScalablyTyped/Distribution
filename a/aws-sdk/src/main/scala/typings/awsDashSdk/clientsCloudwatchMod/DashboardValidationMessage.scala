...
trait DashboardValidationMessage extends js.Object {
  /**
    ...
    */
  var DataPath: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.DataPath] = js.undefined
  /**
    * A message describing the error or warning.
    */
  var Message: js.UndefOr[typings.awsDashSdk.clientsCloudwatchMod.Message] = js.undefined
}
