...
trait UpdateNotificationRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var EventTypeIds: js.UndefOr[typings.awsDashSdk.clientsCodestarnotificationsMod.EventTypeIds] = js.native
  /**
  ...
  /**
    ...
    */
  var Targets: js.UndefOr[typings.awsDashSdk.clientsCodestarnotificationsMod.Targets] = js.native
}
