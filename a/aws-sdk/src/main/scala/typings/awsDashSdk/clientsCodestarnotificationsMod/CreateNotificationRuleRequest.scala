...
trait CreateNotificationRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var DetailType: typings.awsDashSdk.clientsCodestarnotificationsMod.DetailType = js.native
  /**
    * A list of event types associated with this notification rule. For a list of allowed events, see EventTypeSummary.
    */
  var EventTypeIds: typings.awsDashSdk.clientsCodestarnotificationsMod.EventTypeIds = js.native
  /**
  ...
  /**
    ...
    */
  var Targets: typings.awsDashSdk.clientsCodestarnotificationsMod.Targets = js.native
}
