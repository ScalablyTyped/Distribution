...
trait StartOutboundVoiceContactRequest extends js.Object {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typings.awsDashSdk.clientsConnectMod.ClientToken] = js.undefined
  /**
    ...
    */
  var ContactFlowId: typings.awsDashSdk.clientsConnectMod.ContactFlowId
  /**
  ...
  /**
    ...
    */
  var QueueId: js.UndefOr[typings.awsDashSdk.clientsConnectMod.QueueId] = js.undefined
  /**
