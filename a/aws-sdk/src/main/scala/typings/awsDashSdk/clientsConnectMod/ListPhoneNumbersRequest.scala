...
trait ListPhoneNumbersRequest extends js.Object {
  ...
  /**
    ...
    */
  var PhoneNumberCountryCodes: js.UndefOr[typings.awsDashSdk.clientsConnectMod.PhoneNumberCountryCodes] = js.native
  /**
    * The type of phone number.
    */
  var PhoneNumberTypes: js.UndefOr[typings.awsDashSdk.clientsConnectMod.PhoneNumberTypes] = js.native
}
