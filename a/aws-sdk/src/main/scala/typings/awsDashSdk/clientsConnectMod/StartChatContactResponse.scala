...
trait StartChatContactResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParticipantId: js.UndefOr[typings.awsDashSdk.clientsConnectMod.ParticipantId] = js.native
  /**
    * The token used by the chat participant to call CreateParticipantConnection. The participant token is valid for the lifetime of a chat participant.
    */
  var ParticipantToken: js.UndefOr[typings.awsDashSdk.clientsConnectMod.ParticipantToken] = js.native
}
