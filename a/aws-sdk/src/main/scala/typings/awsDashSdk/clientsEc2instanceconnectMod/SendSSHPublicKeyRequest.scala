...
trait SendSSHPublicKeyRequest extends js.Object {
  /**
    ...
    */
  var AvailabilityZone: typings.awsDashSdk.clientsEc2instanceconnectMod.AvailabilityZone = js.native
  /**
    * The EC2 instance you wish to publish the SSH key to.
    */
  var InstanceId: typings.awsDashSdk.clientsEc2instanceconnectMod.InstanceId = js.native
  /**
    * The OS user on the EC2 instance whom the key may be used to authenticate as.
    */
  var InstanceOSUser: typings.awsDashSdk.clientsEc2instanceconnectMod.InstanceOSUser = js.native
  /**
    * The public key to be published to the instance. To use it after publication you must have the matching private key.
    */
  var SSHPublicKey: typings.awsDashSdk.clientsEc2instanceconnectMod.SSHPublicKey = js.native
}
