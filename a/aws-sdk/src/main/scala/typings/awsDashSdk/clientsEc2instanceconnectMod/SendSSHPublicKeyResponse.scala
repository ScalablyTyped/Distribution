...
trait SendSSHPublicKeyResponse extends js.Object {
  /**
    ...
    */
  var RequestId: js.UndefOr[typings.awsDashSdk.clientsEc2instanceconnectMod.RequestId] = js.native
  /**
    * Indicates request success.
    */
  var Success: js.UndefOr[typings.awsDashSdk.clientsEc2instanceconnectMod.Success] = js.native
}
