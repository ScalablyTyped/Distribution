...
trait JobMetadata extends js.Object {
  ...
  /**
    ...
    */
  var JobState: js.UndefOr[typings.awsDashSdk.clientsSnowballMod.JobState] = js.native
  /**
    * The type of job.
    */
  var JobType: js.UndefOr[typings.awsDashSdk.clientsSnowballMod.JobType] = js.native
  /**
  ...
  /**
    ...
    */
  var ShippingDetails: js.UndefOr[typings.awsDashSdk.clientsSnowballMod.ShippingDetails] = js.native
  /**
