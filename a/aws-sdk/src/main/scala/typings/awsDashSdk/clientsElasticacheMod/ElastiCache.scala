...
import typings.awsDashSdk.awsDashSdkStrings.cacheClusterAvailable
import typings.awsDashSdk.awsDashSdkStrings.cacheClusterDeleted
import typings.awsDashSdk.awsDashSdkStrings.replicationGroupAvailable
import typings.awsDashSdk.awsDashSdkStrings.replicationGroupDeleted
...
trait ElastiCache extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_cacheClusterAvailable(state: cacheClusterAvailable, params: DescribeCacheClustersMessage with Anon_Waiter): Request[CacheClusterMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_cacheClusterAvailable(
    state: cacheClusterAvailable,
    params: DescribeCacheClustersMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ CacheClusterMessage, Unit]
  ): Request[CacheClusterMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_cacheClusterDeleted(state: cacheClusterDeleted, params: DescribeCacheClustersMessage with Anon_Waiter): Request[CacheClusterMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_cacheClusterDeleted(
    state: cacheClusterDeleted,
    params: DescribeCacheClustersMessage with Anon_Waiter,
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_replicationGroupAvailable(state: replicationGroupAvailable, params: DescribeReplicationGroupsMessage with Anon_Waiter): Request[ReplicationGroupMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_replicationGroupAvailable(
    state: replicationGroupAvailable,
    params: DescribeReplicationGroupsMessage with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ ReplicationGroupMessage, Unit]
  ): Request[ReplicationGroupMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_replicationGroupDeleted(state: replicationGroupDeleted, params: DescribeReplicationGroupsMessage with Anon_Waiter): Request[ReplicationGroupMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_replicationGroupDeleted(
    state: replicationGroupDeleted,
    params: DescribeReplicationGroupsMessage with Anon_Waiter,
