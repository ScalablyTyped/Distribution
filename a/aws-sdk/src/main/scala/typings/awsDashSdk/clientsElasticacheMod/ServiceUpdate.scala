...
trait ServiceUpdate extends js.Object {
  ...
  /**
    ...
    */
  var ServiceUpdateSeverity: js.UndefOr[typings.awsDashSdk.clientsElasticacheMod.ServiceUpdateSeverity] = js.native
  /**
    * The status of the service update
    */
  var ServiceUpdateStatus: js.UndefOr[typings.awsDashSdk.clientsElasticacheMod.ServiceUpdateStatus] = js.native
  /**
    * Reflects the nature of the service update
    */
  var ServiceUpdateType: js.UndefOr[typings.awsDashSdk.clientsElasticacheMod.ServiceUpdateType] = js.native
}
