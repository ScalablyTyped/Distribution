...
trait ResolveCustomerResult extends js.Object {
  /**
    ...
    */
  var CustomerIdentifier: js.UndefOr[typings.awsDashSdk.clientsMarketplacemeteringMod.CustomerIdentifier] = js.undefined
  /**
    * The product code is returned to confirm that the buyer is registering for your product. Subsequent BatchMeterUsage calls should be made using this product code.
    */
  var ProductCode: js.UndefOr[typings.awsDashSdk.clientsMarketplacemeteringMod.ProductCode] = js.undefined
}
