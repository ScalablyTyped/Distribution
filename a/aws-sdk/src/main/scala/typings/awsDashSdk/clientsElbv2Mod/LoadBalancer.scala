...
trait LoadBalancer extends js.Object {
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typings.awsDashSdk.clientsElbv2Mod.AvailabilityZones] = js.undefined
  /**
    * The ID of the Amazon Route 53 hosted zone associated with the load balancer.
    */
  var CanonicalHostedZoneId: js.UndefOr[typings.awsDashSdk.clientsElbv2Mod.CanonicalHostedZoneId] = js.undefined
  /**
    * The date and time the load balancer was created.
    */
  var CreatedTime: js.UndefOr[typings.awsDashSdk.clientsElbv2Mod.CreatedTime] = js.undefined
  /**
    * The public DNS name of the load balancer.
    */
  var DNSName: js.UndefOr[typings.awsDashSdk.clientsElbv2Mod.DNSName] = js.undefined
  /**
  ...
  /**
    ...
    */
  var LoadBalancerName: js.UndefOr[typings.awsDashSdk.clientsElbv2Mod.LoadBalancerName] = js.undefined
  /**
