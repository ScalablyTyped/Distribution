...
trait BlockDeviceMapping extends js.Object {
  ...
  /**
    ...
    */
  var Ebs: js.UndefOr[typings.awsDashSdk.clientsAutoscalingMod.Ebs] = js.native
  /**
    ...
    */
  var NoDevice: js.UndefOr[typings.awsDashSdk.clientsAutoscalingMod.NoDevice] = js.native
  /**
