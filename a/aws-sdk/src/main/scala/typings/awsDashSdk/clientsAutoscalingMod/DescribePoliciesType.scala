...
trait DescribePoliciesType extends js.Object {
  ...
  /**
    ...
    */
  var PolicyNames: js.UndefOr[typings.awsDashSdk.clientsAutoscalingMod.PolicyNames] = js.native
  /**
    * One or more policy types. The valid values are SimpleScaling, StepScaling, and TargetTrackingScaling.
    */
  var PolicyTypes: js.UndefOr[typings.awsDashSdk.clientsAutoscalingMod.PolicyTypes] = js.native
}
