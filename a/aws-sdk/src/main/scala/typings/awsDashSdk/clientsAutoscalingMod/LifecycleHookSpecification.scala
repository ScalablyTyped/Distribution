...
trait LifecycleHookSpecification extends js.Object {
  ...
  /**
    ...
    */
  var HeartbeatTimeout: js.UndefOr[typings.awsDashSdk.clientsAutoscalingMod.HeartbeatTimeout] = js.undefined
  /**
  ...
  /**
    ...
    */
  var LifecycleTransition: typings.awsDashSdk.clientsAutoscalingMod.LifecycleTransition
  /**
