...
trait FilterCondition extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typings.awsDashSdk.clientsLakeformationMod.ComparisonOperator] = js.native
  /**
  ...
  /**
    ...
    */
  var StringValueList: js.UndefOr[typings.awsDashSdk.clientsLakeformationMod.StringValueList] = js.native
}
