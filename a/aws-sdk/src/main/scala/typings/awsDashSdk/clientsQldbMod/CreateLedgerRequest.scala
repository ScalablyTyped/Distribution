...
trait CreateLedgerRequest extends js.Object {
  /**
    ...
    */
  var DeletionProtection: js.UndefOr[typings.awsDashSdk.clientsQldbMod.DeletionProtection] = js.native
  /**
  ...
  /**
    ...
    */
  var PermissionsMode: typings.awsDashSdk.clientsQldbMod.PermissionsMode = js.native
  /**
