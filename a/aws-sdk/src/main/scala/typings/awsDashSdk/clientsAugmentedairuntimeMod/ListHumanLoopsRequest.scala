...
trait ListHumanLoopsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsDashSdk.clientsAugmentedairuntimeMod.MaxResults] = js.native
  /**
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typings.awsDashSdk.clientsAugmentedairuntimeMod.SortOrder] = js.native
}
