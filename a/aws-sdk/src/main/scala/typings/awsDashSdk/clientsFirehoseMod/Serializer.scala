...
trait Serializer extends js.Object {
  /**
    ...
    */
  var OrcSerDe: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.OrcSerDe] = js.undefined
  /**
    * A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see Apache Parquet.
    */
  var ParquetSerDe: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.ParquetSerDe] = js.undefined
}
