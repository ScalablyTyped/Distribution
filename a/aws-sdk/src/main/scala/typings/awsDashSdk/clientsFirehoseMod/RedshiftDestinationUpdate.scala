...
trait RedshiftDestinationUpdate extends js.Object {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.ClusterJDBCURL] = js.undefined
  /**
    * The COPY command.
    */
  var CopyCommand: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.CopyCommand] = js.undefined
  /**
    * The user password.
    */
  var Password: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.Password] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Username: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.Username] = js.undefined
}
