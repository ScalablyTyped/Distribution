...
trait CopyCommand extends js.Object {
  /**
    ...
    */
  var CopyOptions: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.CopyOptions] = js.undefined
  /**
    * A comma-separated list of column names.
    */
  var DataTableColumns: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.DataTableColumns] = js.undefined
  /**
    * The name of the target table. The table must already exist in the database.
    */
  var DataTableName: typings.awsDashSdk.clientsFirehoseMod.DataTableName
}
...
object CopyCommand {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(DataTableName = DataTableName)
