...
trait CloudWatchLoggingOptions extends js.Object {
  ...
  /**
    ...
    */
  var LogGroupName: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.LogGroupName] = js.undefined
  /**
    * The CloudWatch log stream name for logging. This value is required if CloudWatch logging is enabled.
    */
  var LogStreamName: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.LogStreamName] = js.undefined
}
