...
trait KinesisStreamSourceDescription extends js.Object {
  /**
    ...
    */
  var DeliveryStartTimestamp: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.DeliveryStartTimestamp] = js.native
  /**
    * The Amazon Resource Name (ARN) of the source Kinesis data stream. For more information, see Amazon Kinesis Data Streams ARN Format.
    */
  var KinesisStreamARN: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.KinesisStreamARN] = js.native
  /**
