...
trait DeliveryStreamDescription extends js.Object {
  ...
  /**
    ...
    */
  var DeliveryStreamARN: typings.awsDashSdk.clientsFirehoseMod.DeliveryStreamARN
  /**
    * Indicates the server-side encryption (SSE) status for the delivery stream.
    */
  var DeliveryStreamEncryptionConfiguration: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.DeliveryStreamEncryptionConfiguration] = js.undefined
  /**
  ...
  /**
    ...
    */
  var DeliveryStreamStatus: typings.awsDashSdk.clientsFirehoseMod.DeliveryStreamStatus
  /**
    ...
    */
  var DeliveryStreamType: typings.awsDashSdk.clientsFirehoseMod.DeliveryStreamType
  /**
    * The destinations.
    */
