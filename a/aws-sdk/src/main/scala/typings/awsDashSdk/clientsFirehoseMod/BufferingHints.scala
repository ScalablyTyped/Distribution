...
trait BufferingHints extends js.Object {
  /**
    ...
    */
  var IntervalInSeconds: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.IntervalInSeconds] = js.native
  /**
    ...
    */
  var SizeInMBs: js.UndefOr[typings.awsDashSdk.clientsFirehoseMod.SizeInMBs] = js.native
}
