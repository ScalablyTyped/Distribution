...
trait StreamDescription extends js.Object {
  /**
    ...
    */
  var CreationRequestDateTime: js.UndefOr[_Date] = js.native
  /**
    * The key attribute(s) of the stream's DynamoDB table.
    */
  var KeySchema: js.UndefOr[typings.awsDashSdk.clientsDynamodbstreamsMod.KeySchema] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamArn: js.UndefOr[typings.awsDashSdk.clientsDynamodbstreamsMod.StreamArn] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamStatus: js.UndefOr[typings.awsDashSdk.clientsDynamodbstreamsMod.StreamStatus] = js.native
  /**
    ...
    */
  var StreamViewType: js.UndefOr[typings.awsDashSdk.clientsDynamodbstreamsMod.StreamViewType] = js.native
  /**
