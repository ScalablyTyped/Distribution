...
trait NotifyMigrationTaskStateRequest extends js.Object {
  ...
  /**
    ...
    */
  var NextUpdateSeconds: typings.awsDashSdk.clientsMigrationhubMod.NextUpdateSeconds
  /**
  ...
  /**
    ...
    */
  var Task: typings.awsDashSdk.clientsMigrationhubMod.Task
  /**
    * The timestamp when the task was gathered.
    */
  var UpdateDateTime: typings.awsDashSdk.clientsMigrationhubMod.UpdateDateTime
}
