...
trait NotifyMigrationTaskStateRequest extends js.Object {
  ...
  /**
    ...
    */
  var NextUpdateSeconds: typings.awsDashSdk.clientsMigrationhubMod.NextUpdateSeconds = js.native
  /**
  ...
  /**
    ...
    */
  var Task: typings.awsDashSdk.clientsMigrationhubMod.Task = js.native
  /**
    * The timestamp when the task was gathered.
    */
  var UpdateDateTime: typings.awsDashSdk.clientsMigrationhubMod.UpdateDateTime = js.native
}
