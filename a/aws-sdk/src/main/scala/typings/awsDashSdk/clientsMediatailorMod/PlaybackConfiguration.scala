...
trait PlaybackConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var DashConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediatailorMod.DashConfiguration] = js.native
  /**
    * The configuration for HLS content. 
    */
  var HlsConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediatailorMod.HlsConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var PlaybackConfigurationArn: js.UndefOr[__string] = js.native
  /**
    * The URL that the player accesses to get a manifest from AWS Elemental MediaTailor. This session will use server-side reporting. 
    */
  var PlaybackEndpointPrefix: js.UndefOr[__string] = js.native
  /**
    * The URL that the player uses to initialize a session that uses client-side reporting. 
    */
  var SessionInitializationEndpointPrefix: js.UndefOr[__string] = js.native
  /**
