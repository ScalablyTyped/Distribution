...
trait LivePreRollConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var MaxDurationSeconds: js.UndefOr[__integer] = js.native
}

object LivePreRollConfiguration {
  @scala.inline
  def apply(AdDecisionServerUrl: __string = null, MaxDurationSeconds: Int | Double = null): LivePreRollConfiguration = {
