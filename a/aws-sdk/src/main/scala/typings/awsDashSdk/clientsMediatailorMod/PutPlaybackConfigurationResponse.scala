...
trait PutPlaybackConfigurationResponse extends js.Object {
  ...
  /**
    ...
    */
  var CdnConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediatailorMod.CdnConfiguration] = js.undefined
  /**
    * The configuration for DASH content. 
    */
  var DashConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediatailorMod.DashConfiguration] = js.undefined
  /**
    * The configuration for HLS content. 
    */
  var HlsConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediatailorMod.HlsConfiguration] = js.undefined
  /**
