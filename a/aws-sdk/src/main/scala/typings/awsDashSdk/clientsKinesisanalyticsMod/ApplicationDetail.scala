...
trait ApplicationDetail extends js.Object {
  ...
  /**
    ...
    */
  var ApplicationCode: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.ApplicationCode] = js.native
  /**
    * Description of the application.
    */
  var ApplicationDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.ApplicationDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var ApplicationVersionId: typings.awsDashSdk.clientsKinesisanalyticsMod.ApplicationVersionId = js.native
  /**
  ...
  /**
    ...
    */
  var InputDescriptions: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.InputDescriptions] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputDescriptions: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.OutputDescriptions] = js.native
  /**
    * Describes reference data sources configured for the application. For more information, see Configuring Application Input. 
    */
  var ReferenceDataSourceDescriptions: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.ReferenceDataSourceDescriptions] = js.native
}
