...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var KinesisFirehoseInputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseInputDescription] = js.native
  /**
    * If an Amazon Kinesis stream is configured as streaming source, provides Amazon Kinesis stream's Amazon Resource Name (ARN) and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisStreamsInputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsInputDescription] = js.native
  /**
