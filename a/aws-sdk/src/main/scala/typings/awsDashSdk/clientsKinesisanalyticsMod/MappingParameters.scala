...
trait MappingParameters extends js.Object {
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.CSVMappingParameters] = js.undefined
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.JSONMappingParameters] = js.undefined
}
