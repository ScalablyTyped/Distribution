...
trait OutputDescription extends js.Object {
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.DestinationSchema] = js.undefined
  /**
    * Describes the Amazon Kinesis Firehose delivery stream configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputDescription] = js.undefined
  /**
    * Describes Amazon Kinesis stream configured as the destination where output is written.
    */
  var KinesisStreamsOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputDescription] = js.undefined
  /**
    * Describes the AWS Lambda function configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.LambdaOutputDescription] = js.undefined
  /**
