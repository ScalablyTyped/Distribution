...
trait OutputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputUpdate] = js.undefined
  /**
    * Describes an Amazon Kinesis stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputUpdate] = js.undefined
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.LambdaOutputUpdate] = js.undefined
  /**
