...
trait DiscoverInputSchemaResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.ParsedInputRecords] = js.undefined
  /**
    * Stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.ProcessedInputRecords] = js.undefined
  /**
    * Raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.RawInputRecords] = js.undefined
}
