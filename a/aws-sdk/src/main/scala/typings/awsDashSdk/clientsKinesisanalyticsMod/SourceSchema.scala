...
trait SourceSchema extends js.Object {
  /**
    ...
    */
  var RecordColumns: typings.awsDashSdk.clientsKinesisanalyticsMod.RecordColumns
  /**
    * Specifies the encoding of the records in the streaming source. For example, UTF-8.
    */
  var RecordEncoding: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsMod.RecordEncoding] = js.undefined
  /**
    * Specifies the format of the records on the streaming source.
    */
  var RecordFormat: typings.awsDashSdk.clientsKinesisanalyticsMod.RecordFormat
}
