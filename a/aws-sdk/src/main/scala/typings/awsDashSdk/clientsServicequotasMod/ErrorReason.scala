...
trait ErrorReason extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typings.awsDashSdk.clientsServicequotasMod.ErrorCode] = js.undefined
  /**
    * The error message that provides more detail.
    */
  var ErrorMessage: js.UndefOr[typings.awsDashSdk.clientsServicequotasMod.ErrorMessage] = js.undefined
}
