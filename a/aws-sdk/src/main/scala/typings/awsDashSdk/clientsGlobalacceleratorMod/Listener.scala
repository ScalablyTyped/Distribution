...
trait Listener extends js.Object {
  /**
    ...
    */
  var ClientAffinity: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.ClientAffinity] = js.native
  /**
  ...
  /**
    ...
    */
  var PortRanges: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.PortRanges] = js.native
  /**
    * The protocol for the connections from clients to the accelerator.
    */
  var Protocol: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.Protocol] = js.native
}
