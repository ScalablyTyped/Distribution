...
trait CreateEndpointGroupRequest extends js.Object {
  /**
    ...
    */
  var EndpointConfigurations: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.EndpointConfigurations] = js.undefined
  /**
  ...
  /**
    ...
    */
  var HealthCheckIntervalSeconds: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckIntervalSeconds] = js.undefined
  /**
  ...
  /**
    ...
    */
  var HealthCheckPort: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckPort] = js.undefined
  /**
    * The protocol that AWS Global Accelerator uses to check the health of endpoints that are part of this endpoint group. The default value is TCP.
    */
  var HealthCheckProtocol: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.HealthCheckProtocol] = js.undefined
  /**
    * A unique, case-sensitive identifier that you provide to ensure the idempotency—that is, the uniqueness—of the request.
    */
  var IdempotencyToken: typings.awsDashSdk.clientsGlobalacceleratorMod.IdempotencyToken
  /**
  ...
  /**
    ...
    */
  var ThresholdCount: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.ThresholdCount] = js.undefined
  /**
    ...
    */
  var TrafficDialPercentage: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.TrafficDialPercentage] = js.undefined
}
