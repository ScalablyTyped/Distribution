...
trait CreateListenerRequest extends js.Object {
  ...
  /**
    ...
    */
  var PortRanges: typings.awsDashSdk.clientsGlobalacceleratorMod.PortRanges = js.native
  /**
    * The protocol for connections from clients to your accelerator.
    */
  var Protocol: typings.awsDashSdk.clientsGlobalacceleratorMod.Protocol = js.native
}
