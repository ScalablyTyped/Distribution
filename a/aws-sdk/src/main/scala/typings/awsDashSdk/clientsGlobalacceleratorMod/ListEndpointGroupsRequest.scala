...
trait ListEndpointGroupsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsDashSdk.clientsGlobalacceleratorMod.MaxResults] = js.native
  /**
...
object ListEndpointGroupsRequest {
  @scala.inline
  def apply(ListenerArn: GenericString, MaxResults: Int | Double = null, NextToken: GenericString = null): ListEndpointGroupsRequest = {
