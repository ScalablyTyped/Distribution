...
trait CreateBucketRequest extends js.Object {
  ...
  /**
    ...
    */
  var CreateBucketConfiguration: js.UndefOr[typings.awsDashSdk.clientsS3Mod.CreateBucketConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var ObjectLockEnabledForBucket: js.UndefOr[typings.awsDashSdk.clientsS3Mod.ObjectLockEnabledForBucket] = js.native
}
