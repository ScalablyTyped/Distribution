...
trait CSVInput extends js.Object {
  /**
    ...
    */
  var AllowQuotedRecordDelimiter: js.UndefOr[typings.awsDashSdk.clientsS3Mod.AllowQuotedRecordDelimiter] = js.undefined
  /**
    * The single character used to indicate a row should be ignored when present at the start of a row.
    */
  var Comments: js.UndefOr[typings.awsDashSdk.clientsS3Mod.Comments] = js.undefined
  /**
  ...
  /**
    ...
    */
  var FileHeaderInfo: js.UndefOr[typings.awsDashSdk.clientsS3Mod.FileHeaderInfo] = js.undefined
  /**
