...
trait S3Location extends js.Object {
  ...
  /**
    ...
    */
  var BucketName: typings.awsDashSdk.clientsS3Mod.BucketName
  /**
  ...
  /**
    * 
    */
  var Encryption: js.UndefOr[typings.awsDashSdk.clientsS3Mod.Encryption] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Tagging: js.UndefOr[typings.awsDashSdk.clientsS3Mod.Tagging] = js.undefined
  /**
    * A list of metadata to store with the restore results in S3.
    */
  var UserMetadata: js.UndefOr[typings.awsDashSdk.clientsS3Mod.UserMetadata] = js.undefined
}
