...
trait EvaluationMetrics extends js.Object {
  /**
    ...
    */
  var FindMatchesMetrics: js.UndefOr[typings.awsDashSdk.clientsGlueMod.FindMatchesMetrics] = js.undefined
  /**
...
object EvaluationMetrics {
  ...
  def apply(TransformType: TransformType, FindMatchesMetrics: FindMatchesMetrics = null): EvaluationMetrics = {
    ...
    if (FindMatchesMetrics != null) __obj.updateDynamic("FindMatchesMetrics")(FindMatchesMetrics)
