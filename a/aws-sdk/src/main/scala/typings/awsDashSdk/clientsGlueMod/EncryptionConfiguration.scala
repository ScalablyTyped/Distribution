...
trait EncryptionConfiguration extends js.Object {
  /**
    ...
    */
  var CloudWatchEncryption: js.UndefOr[typings.awsDashSdk.clientsGlueMod.CloudWatchEncryption] = js.native
  /**
    * The encryption configuration for job bookmarks.
    */
  var JobBookmarksEncryption: js.UndefOr[typings.awsDashSdk.clientsGlueMod.JobBookmarksEncryption] = js.native
  /**
