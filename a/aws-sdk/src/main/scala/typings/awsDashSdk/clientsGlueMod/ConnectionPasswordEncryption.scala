...
object ConnectionPasswordEncryption {
  ...
  def apply(ReturnConnectionPasswordEncrypted: Boolean, AwsKmsKeyId: NameString = null): ConnectionPasswordEncryption = {
    val __obj = js.Dynamic.literal(ReturnConnectionPasswordEncrypted = ReturnConnectionPasswordEncrypted)
    if (AwsKmsKeyId != null) __obj.updateDynamic("AwsKmsKeyId")(AwsKmsKeyId)
