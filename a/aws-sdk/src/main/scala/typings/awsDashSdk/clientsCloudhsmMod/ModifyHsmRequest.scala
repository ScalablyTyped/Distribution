...
trait ModifyHsmRequest extends js.Object {
  ...
  /**
    ...
    */
  var IamRoleArn: js.UndefOr[typings.awsDashSdk.clientsCloudhsmMod.IamRoleArn] = js.native
  /**
    * The new identifier of the subnet that the HSM is in. The new subnet must be in the same Availability Zone as the current subnet.
    */
  var SubnetId: js.UndefOr[typings.awsDashSdk.clientsCloudhsmMod.SubnetId] = js.native
  /**
