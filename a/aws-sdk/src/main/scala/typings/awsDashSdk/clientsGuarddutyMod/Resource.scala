...
trait Resource extends js.Object {
  /**
    ...
    */
  var AccessKeyDetails: js.UndefOr[typings.awsDashSdk.clientsGuarddutyMod.AccessKeyDetails] = js.native
  /**
    * The information about the EC2 instance associated with the activity that prompted GuardDuty to generate a finding.
    */
  var InstanceDetails: js.UndefOr[typings.awsDashSdk.clientsGuarddutyMod.InstanceDetails] = js.native
  /**
