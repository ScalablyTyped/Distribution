...
trait GetSnapshotBlockResponse extends js.Object {
  /**
    ...
    */
  var BlockData: js.UndefOr[typings.awsDashSdk.clientsEbsMod.BlockData] = js.native
  /**
    * The checksum generated for the block.
    */
  var Checksum: js.UndefOr[typings.awsDashSdk.clientsEbsMod.Checksum] = js.native
  /**
    * The algorithm used to generate the checksum for the block, such as SHA256.
    */
  var ChecksumAlgorithm: js.UndefOr[typings.awsDashSdk.clientsEbsMod.ChecksumAlgorithm] = js.native
  /**
    * The size of the data in the block.
    */
  var DataLength: js.UndefOr[typings.awsDashSdk.clientsEbsMod.DataLength] = js.native
}
