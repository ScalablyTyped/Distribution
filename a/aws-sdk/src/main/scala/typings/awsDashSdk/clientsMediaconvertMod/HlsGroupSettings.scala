...
trait HlsGroupSettings extends js.Object {
  /**
    ...
    */
  var AdMarkers: js.UndefOr[__listOfHlsAdMarkers] = js.native
  /**
    * By default, the service creates one top-level .m3u8 HLS manifest for each HLS output group in your job. This default manifest references every output in the output group. To create additional top-level manifests that reference a subset of the outputs in the output group, specify a list of them here.
    */
  var AdditionalManifests: js.UndefOr[__listOfHlsAdditionalManifest] = js.native
  /**
  ...
  /**
    ...
    */
  var CaptionLanguageMappings: js.UndefOr[__listOfHlsCaptionLanguageMapping] = js.native
  /**
  ...
  /**
    ...
    */
  var MinFinalSegmentLength: js.UndefOr[__doubleMin0Max2147483647] = js.native
  /**
    * When set, Minimum Segment Size is enforced by looking ahead and back within the specified range for a nearby avail and extending the segment size if needed.
    */
  var MinSegmentLength: js.UndefOr[__integerMin0Max2147483647] = js.native
  /**
  ...
  /**
    ...
    */
  var ProgramDateTimePeriod: js.UndefOr[__integerMin0Max3600] = js.native
  /**
  ...
  /**
    ...
    */
  var SegmentsPerSubdirectory: js.UndefOr[__integerMin1Max2147483647] = js.native
  /**
  ...
  /**
    ...
    */
  var TimedMetadataId3Period: js.UndefOr[__integerMinNegative2147483648Max2147483647] = js.native
  /**
    * Provides an extra millisecond delta offset to fine tune the timestamps.
    */
  var TimestampDeltaMilliseconds: js.UndefOr[__integerMinNegative2147483648Max2147483647] = js.native
}
...
object HlsGroupSettings {
  ...
  def apply(
    ...
    AdditionalManifests: __listOfHlsAdditionalManifest = null,
