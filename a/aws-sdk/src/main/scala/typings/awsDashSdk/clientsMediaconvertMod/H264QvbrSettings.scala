...
trait H264QvbrSettings extends js.Object {
  /**
    ...
    */
  var MaxAverageBitrate: js.UndefOr[__integerMin1000Max1152000000] = js.native
  /**
...
object H264QvbrSettings {
  @scala.inline
  def apply(MaxAverageBitrate: Int | Double = null, QvbrQualityLevel: Int | Double = null): H264QvbrSettings = {
