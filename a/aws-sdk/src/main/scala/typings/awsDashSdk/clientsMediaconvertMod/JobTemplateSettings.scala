...
trait JobTemplateSettings extends js.Object {
  ...
  /**
    ...
    */
  var AvailBlanking: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.AvailBlanking] = js.native
  /**
  ...
  /**
    ...
    */
  var MotionImageInserter: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.MotionImageInserter] = js.native
  /**
    * Settings for your Nielsen configuration. If you don't do Nielsen measurement and analytics, ignore these settings. When you enable Nielsen configuration (nielsenConfiguration), MediaConvert enables PCM to ID3 tagging for all outputs in the job. To enable Nielsen configuration programmatically, include an instance of nielsenConfiguration in your JSON job specification. Even if you don't include any children of nielsenConfiguration, you still enable the setting.
    */
  var NielsenConfiguration: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.NielsenConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var TimecodeConfig: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.TimecodeConfig] = js.native
  /**
    ...
    */
  var TimedMetadataInsertion: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.TimedMetadataInsertion] = js.native
}
