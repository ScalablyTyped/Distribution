...
trait FileSourceSettings extends js.Object {
  ...
  /**
    ...
    */
  var SourceFile: js.UndefOr[__stringMin14PatternHttpHttpsS3SccSCCTtmlTTMLDfxpDFXPStlSTLSrtSRTXmlXMLSmiSMI] = js.native
  /**
    * Specifies a time delta in seconds to offset the captions from the source file.
    */
  var TimeDelta: js.UndefOr[__integerMinNegative2147483648Max2147483647] = js.native
}
