...
trait VideoDescription extends js.Object {
  /**
    ...
    */
  var AfdSignaling: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.AfdSignaling] = js.undefined
  /**
    * The anti-alias filter is automatically applied to all outputs. The service no longer accepts the value DISABLED for AntiAlias. If you specify that in your job, the service will ignore the setting.
    */
  var AntiAlias: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.AntiAlias] = js.undefined
  /**
  ...
  /**
    ...
    */
  var ColorMetadata: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.ColorMetadata] = js.undefined
  /**
  ...
  /**
    ...
    */
  var DropFrameTimecode: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.DropFrameTimecode] = js.undefined
  /**
  ...
  /**
    ...
    */
  var RespondToAfd: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.RespondToAfd] = js.undefined
  /**
    * Specify how the service handles outputs that have a different aspect ratio from the input aspect ratio. Choose Stretch to output (STRETCH_TO_OUTPUT) to have the service stretch your video image to fit. Keep the setting Default (DEFAULT) to have the service letterbox your video instead. This setting overrides any value that you specify for the setting Selection placement (position) in this output.
    */
  var ScalingBehavior: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.ScalingBehavior] = js.undefined
  /**
