...
trait VideoDescription extends js.Object {
  /**
    ...
    */
  var AfdSignaling: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.AfdSignaling] = js.native
  /**
    * The anti-alias filter is automatically applied to all outputs. The service no longer accepts the value DISABLED for AntiAlias. If you specify that in your job, the service will ignore the setting.
    */
  var AntiAlias: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.AntiAlias] = js.native
  /**
  ...
  /**
    ...
    */
  var ColorMetadata: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.ColorMetadata] = js.native
  /**
  ...
  /**
    ...
    */
  var DropFrameTimecode: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.DropFrameTimecode] = js.native
  /**
    * Applies only if you set AFD Signaling(AfdSignaling) to Fixed (FIXED). Use Fixed (FixedAfd) to specify a four-bit AFD value which the service will write on all  frames of this video output.
    */
  var FixedAfd: js.UndefOr[__integerMin0Max15] = js.native
  /**
    * Use the Height (Height) setting to define the video resolution height for this output. Specify in pixels. If you don't provide a value here, the service will use the input height.
    */
  var Height: js.UndefOr[__integerMin32Max8192] = js.native
  /**
  ...
  /**
    ...
    */
  var RespondToAfd: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.RespondToAfd] = js.native
  /**
    * Specify how the service handles outputs that have a different aspect ratio from the input aspect ratio. Choose Stretch to output (STRETCH_TO_OUTPUT) to have the service stretch your video image to fit. Keep the setting Default (DEFAULT) to have the service letterbox your video instead. This setting overrides any value that you specify for the setting Selection placement (position) in this output.
    */
  var ScalingBehavior: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.ScalingBehavior] = js.native
  /**
  ...
  /**
    ...
    */
  var Width: js.UndefOr[__integerMin32Max8192] = js.native
}
