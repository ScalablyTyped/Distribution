...
trait Timing extends js.Object {
  /**
    ...
    */
  var FinishTime: js.UndefOr[__timestampUnix] = js.native
  /**
    * The time, in Unix epoch format, that transcoding for the job began.
    */
  var StartTime: js.UndefOr[__timestampUnix] = js.native
  /**
    * The time, in Unix epoch format, that you submitted the job.
    */
  var SubmitTime: js.UndefOr[__timestampUnix] = js.native
}
