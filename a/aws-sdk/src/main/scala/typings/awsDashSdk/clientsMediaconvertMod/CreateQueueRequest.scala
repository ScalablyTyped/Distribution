...
trait CreateQueueRequest extends js.Object {
  ...
  /**
    ...
    */
  var PricingPlan: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.PricingPlan] = js.native
  /**
    * Details about the pricing plan for your reserved queue. Required for reserved queues and not applicable to on-demand queues.
    */
  var ReservationPlanSettings: js.UndefOr[typings.awsDashSdk.clientsMediaconvertMod.ReservationPlanSettings] = js.native
  /**
