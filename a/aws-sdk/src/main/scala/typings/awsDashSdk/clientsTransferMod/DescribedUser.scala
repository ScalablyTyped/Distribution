...
trait DescribedUser extends js.Object {
  ...
  /**
    ...
    */
  var HomeDirectory: js.UndefOr[typings.awsDashSdk.clientsTransferMod.HomeDirectory] = js.native
  /**
    ...
    */
  var HomeDirectoryMappings: js.UndefOr[typings.awsDashSdk.clientsTransferMod.HomeDirectoryMappings] = js.native
  /**
    ...
    */
  var HomeDirectoryType: js.UndefOr[typings.awsDashSdk.clientsTransferMod.HomeDirectoryType] = js.native
  /**
    * Specifies the name of the policy in use for the described user.
    */
  var Policy: js.UndefOr[typings.awsDashSdk.clientsTransferMod.Policy] = js.native
  /**
    ...
    */
  var Role: js.UndefOr[typings.awsDashSdk.clientsTransferMod.Role] = js.native
  /**
    * This property contains the public key portion of the Secure Shell (SSH) keys stored for the described user.
    */
  var SshPublicKeys: js.UndefOr[typings.awsDashSdk.clientsTransferMod.SshPublicKeys] = js.native
  /**
  ...
  /**
    ...
    */
  var UserName: js.UndefOr[typings.awsDashSdk.clientsTransferMod.UserName] = js.native
}
