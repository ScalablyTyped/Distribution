...
trait Observation extends js.Object {
  ...
  /**
    ...
    */
  var LineTime: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.LineTime] = js.native
  /**
    * The log filter of the observation.
    */
  var LogFilter: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.LogFilter] = js.native
  /**
    * The log group name.
    */
  var LogGroup: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.LogGroup] = js.native
  /**
    * The log text of the observation.
    */
  var LogText: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.LogText] = js.native
  /**
    * The name of the observation metric.
    */
  var MetricName: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.MetricName] = js.native
  /**
    * The namespace of the observation metric.
    */
  var MetricNamespace: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.MetricNamespace] = js.native
  /**
    * The source resource ARN of the observation.
    */
  var SourceARN: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.SourceARN] = js.native
  /**
    * The source type of the observation.
    */
  var SourceType: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.SourceType] = js.native
  /**
  ...
  /**
    ...
    */
  var Unit: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.Unit] = js.native
  /**
    * The value of the source observation metric.
    */
  var Value: js.UndefOr[typings.awsDashSdk.clientsApplicationinsightsMod.Value] = js.native
}
