...
trait BurnInDestinationSettings extends js.Object {
  ...
  /**
    ...
    */
  var FontSize: js.UndefOr[__string] = js.native
  /**
  ...
  /**
    ...
    */
  var ShadowXOffset: js.UndefOr[__integer] = js.native
  /**
    * Specifies the vertical offset of the shadow relative to the captions in pixels. A value of -2 would result in a shadow offset 2 pixels above the text.  All burn-in and DVB-Sub font settings must match.
    */
  var ShadowYOffset: js.UndefOr[__integer] = js.native
  /**
  ...
  /**
    ...
    */
  var XPosition: js.UndefOr[__integerMin0] = js.native
  /**
    * Specifies the vertical position of the caption relative to the top of the output in pixels. A value of 10 would result in the captions starting 10 pixels from the top of the output. If no explicit yPosition is provided, the caption will be positioned towards the bottom of the output.  All burn-in and DVB-Sub font settings must match.
    */
  var YPosition: js.UndefOr[__integerMin0] = js.native
}
