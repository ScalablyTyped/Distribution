...
trait HlsGroupSettings extends js.Object {
  ...
  /**
    ...
    */
  var BaseUrlContent: js.UndefOr[__string] = js.native
  /**
  ...
  This field is required only if you are completing Base URL content A, and the downstream system has notified you that the media files for pipeline 1 of all outputs are in a location different from the media files for pipeline 0.
    */
  var BaseUrlContent1: js.UndefOr[__string] = js.native
  /**
    * A partial URI prefix that will be prepended to each output in the media .m3u8 file. Can be used if base manifest is delivered from a different URL than the main .m3u8 file.
    */
  var BaseUrlManifest: js.UndefOr[__string] = js.native
  /**
    * Optional. One value per output group.
  Complete this field only if you are completing Base URL manifest A, and the downstream system has notified you that the child manifest files for pipeline 1 of all outputs are in a location different from the child manifest files for pipeline 0.
    */
  var BaseUrlManifest1: js.UndefOr[__string] = js.native
  /**
    * Mapping of up to 4 caption channels to caption languages.  Is only meaningful if captionLanguageSetting is set to "insert".
    */
  var CaptionLanguageMappings: js.UndefOr[__listOfCaptionLanguageMapping] = js.native
  /**
  ...
  /**
    ...
    */
  var ConstantIv: js.UndefOr[__stringMin32Max32] = js.native
  /**
  ...
  /**
    ...
    */
  var HlsCdnSettings: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.HlsCdnSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var IndexNSegments: js.UndefOr[__integerMin3] = js.native
  /**
  ...
  /**
    ...
    */
  var KeepSegments: js.UndefOr[__integerMin1] = js.native
  /**
    * The value specifies how the key is represented in the resource identified by the URI.  If parameter is absent, an implicit value of "identity" is used.  A reverse DNS string can also be given.
    */
  var KeyFormat: js.UndefOr[__string] = js.native
  /**
    * Either a single positive integer version value or a slash delimited list of version values (1/2/3).
    */
  var KeyFormatVersions: js.UndefOr[__string] = js.native
  /**
    * The key provider settings.
    */
  var KeyProviderSettings: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.KeyProviderSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var MinSegmentLength: js.UndefOr[__integerMin0] = js.native
  /**
  ...
  /**
    ...
    */
  var SegmentLength: js.UndefOr[__integerMin1] = js.native
  /**
  ...
  /**
    ...
    */
  var SegmentsPerSubdirectory: js.UndefOr[__integerMin1] = js.native
  /**
  ...
  /**
    ...
    */
  var TimestampDeltaMilliseconds: js.UndefOr[__integerMin0] = js.native
  /**
...
object HlsGroupSettings {
  ...
  def apply(
    ...
    BaseUrlContent1: __string = null,
    BaseUrlManifest: __string = null,
    BaseUrlManifest1: __string = null,
