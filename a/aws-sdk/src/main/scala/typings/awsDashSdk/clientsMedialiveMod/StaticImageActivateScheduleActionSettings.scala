...
trait StaticImageActivateScheduleActionSettings extends js.Object {
  /**
    ...
    */
  var Duration: js.UndefOr[__integerMin0] = js.native
  /**
    * The time in milliseconds for the image to fade in. The fade-in starts at the start time of the overlay. Default is 0 (no fade-in).
    */
  var FadeIn: js.UndefOr[__integerMin0] = js.native
  /**
  ...
  /**
    ...
    */
  var Height: js.UndefOr[__integerMin1] = js.native
  /**
  ...
  /**
    ...
    */
  var ImageX: js.UndefOr[__integerMin0] = js.native
  /**
    * Placement of the top edge of the overlay relative to the top edge of the video frame, in pixels. 0 (the default) is the top edge of the frame. If the placement causes the overlay to extend beyond the bottom edge of the underlying video, then the overlay is cropped on the bottom.
    */
  var ImageY: js.UndefOr[__integerMin0] = js.native
  /**
  ...
  /**
    ...
    */
  var Width: js.UndefOr[__integerMin1] = js.native
}
