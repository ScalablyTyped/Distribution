...
trait NielsenConfiguration extends js.Object {
  /**
    ...
    */
  var DistributorId: js.UndefOr[__string] = js.native
  /**
...
object NielsenConfiguration {
  @scala.inline
  def apply(DistributorId: __string = null, NielsenPcmToId3Tagging: NielsenPcmToId3TaggingState = null): NielsenConfiguration = {
