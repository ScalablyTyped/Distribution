...
trait InputLossBehavior extends js.Object {
  /**
    ...
    */
  var BlackFrameMsec: js.UndefOr[__integerMin0Max1000000] = js.native
  /**
    * When input loss image type is "color" this field specifies the color to use. Value: 6 hex characters representing the values of RGB.
    */
  var InputLossImageColor: js.UndefOr[__stringMin6Max6] = js.native
  /**
  ...
  /**
    ...
    */
  var InputLossImageType: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.InputLossImageType] = js.native
  /**
    * Documentation update needed
    */
  var RepeatFrameMsec: js.UndefOr[__integerMin0Max1000000] = js.native
}
