...
trait InputSettings extends js.Object {
  /**
    ...
    */
  var AudioSelectors: js.UndefOr[__listOfAudioSelector] = js.native
  /**
    * Used to select the caption input to use for inputs that have multiple available.
    */
  var CaptionSelectors: js.UndefOr[__listOfCaptionSelector] = js.native
  /**
  ...
  /**
    ...
    */
  var FilterStrength: js.UndefOr[__integerMin1Max5] = js.native
  /**
  ...
  3) forced - filtering will be applied regardless of input type
    */
  var InputFilter: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.InputFilter] = js.native
  /**
    * Input settings.
    */
  var NetworkInputSettings: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.NetworkInputSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var VideoSelector: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.VideoSelector] = js.native
}
