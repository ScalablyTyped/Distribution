...
trait ScheduleAction extends js.Object {
  ...
  /**
    ...
    */
  var ScheduleActionSettings: typings.awsDashSdk.clientsMedialiveMod.ScheduleActionSettings = js.native
  /**
    * The time for the action to start in the channel.
    */
  var ScheduleActionStartSettings: typings.awsDashSdk.clientsMedialiveMod.ScheduleActionStartSettings = js.native
}
