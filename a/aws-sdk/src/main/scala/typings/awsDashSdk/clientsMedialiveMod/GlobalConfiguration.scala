...
trait GlobalConfiguration extends js.Object {
  /**
    ...
    */
  var InitialAudioGain: js.UndefOr[__integerMinNegative60Max60] = js.native
  /**
  ...
  /**
    ...
    */
  var InputLossBehavior: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.InputLossBehavior] = js.native
  /**
