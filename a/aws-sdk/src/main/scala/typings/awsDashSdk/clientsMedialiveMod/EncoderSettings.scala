...
trait EncoderSettings extends js.Object {
  ...
  /**
    ...
    */
  var AvailBlanking: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.AvailBlanking] = js.undefined
  /**
    * Event-wide configuration settings for ad avail insertion.
    */
  var AvailConfiguration: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.AvailConfiguration] = js.undefined
  /**
    * Settings for blackout slate.
    */
  var BlackoutSlate: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.BlackoutSlate] = js.undefined
  /**
  ...
  /**
    ...
    */
  var GlobalConfiguration: js.UndefOr[typings.awsDashSdk.clientsMedialiveMod.GlobalConfiguration] = js.undefined
  var OutputGroups: __listOfOutputGroup
  /**
    * Contains settings used to acquire and adjust timecode information from inputs.
    */
  var TimecodeConfig: typings.awsDashSdk.clientsMedialiveMod.TimecodeConfig
