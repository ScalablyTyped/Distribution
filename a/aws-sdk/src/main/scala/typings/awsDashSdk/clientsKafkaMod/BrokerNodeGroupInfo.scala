...
trait BrokerNodeGroupInfo extends js.Object {
  /**
    ...
    */
  var BrokerAZDistribution: js.UndefOr[typings.awsDashSdk.clientsKafkaMod.BrokerAZDistribution] = js.native
  /**
    * 
    The list of subnets to connect to in the client virtual private cloud (VPC). AWS creates elastic network interfaces inside these subnets. Client applications use elastic network interfaces to produce and consume data. Client subnets can't be in Availability Zone us-east-1e.
    
    */
  var ClientSubnets: __listOf__string = js.native
  /**
    * 
  ...
  kafka.m5.4xlarge, kafka.m5.12xlarge, and kafka.m5.24xlarge.
    ...
    */
  var InstanceType: __stringMin5Max32 = js.native
  /**
    * 
  ...
  /**
    ...
    */
  var StorageInfo: js.UndefOr[typings.awsDashSdk.clientsKafkaMod.StorageInfo] = js.native
}
