...
trait Prometheus extends js.Object {
  /**
    ...
    */
  var JmxExporter: js.UndefOr[typings.awsDashSdk.clientsKafkaMod.JmxExporter] = js.native
  /**
    * 
    Indicates whether you want to enable or disable the Node Exporter.
    
    */
  var NodeExporter: js.UndefOr[typings.awsDashSdk.clientsKafkaMod.NodeExporter] = js.native
}
