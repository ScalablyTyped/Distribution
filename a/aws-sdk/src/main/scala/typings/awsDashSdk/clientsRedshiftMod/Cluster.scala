...
trait Cluster extends js.Object {
  ...
  /**
    ...
    */
  var ClusterSnapshotCopyStatus: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.ClusterSnapshotCopyStatus] = js.native
  /**
  ...
  /**
    * 
    */
  var DataTransferProgress: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.DataTransferProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticIpStatus: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.ElasticIpStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.Endpoint] = js.native
  /**
  ...
  /**
    ...
    */
  var HsmStatus: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.HsmStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.PendingModifiedValues] = js.native
  /**
  ...
  /**
    ...
    */
  var ResizeInfo: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.ResizeInfo] = js.native
  /**
    * A value that describes the status of a cluster restore action. This parameter returns null if the cluster was not created by restoring a snapshot.
    */
  var RestoreStatus: js.UndefOr[typings.awsDashSdk.clientsRedshiftMod.RestoreStatus] = js.native
  /**
