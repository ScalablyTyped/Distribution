...
trait Captions extends js.Object {
  /**
    ...
    */
  var CaptionFormats: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.CaptionFormats] = js.undefined
  /**
    * Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave CaptionSources blank.
    */
  var CaptionSources: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.CaptionSources] = js.undefined
  /**
