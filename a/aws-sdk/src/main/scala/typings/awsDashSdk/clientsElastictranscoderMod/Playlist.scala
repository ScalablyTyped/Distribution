...
trait Playlist extends js.Object {
  ...
  /**
    ...
    */
  var HlsContentProtection: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.HlsContentProtection] = js.undefined
  /**
  ...
  /**
    ...
    */
  var OutputKeys: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.OutputKeys] = js.undefined
  /**
    * The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
    */
  var PlayReadyDrm: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.PlayReadyDrm] = js.undefined
  /**
