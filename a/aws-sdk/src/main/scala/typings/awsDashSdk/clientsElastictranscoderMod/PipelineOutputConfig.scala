...
trait PipelineOutputConfig extends js.Object {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.Permissions] = js.native
  /**
    ...
    */
  var StorageClass: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.StorageClass] = js.native
}
