...
trait PipelineOutputConfig extends js.Object {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.Permissions] = js.undefined
  /**
    ...
    */
  var StorageClass: js.UndefOr[typings.awsDashSdk.clientsElastictranscoderMod.StorageClass] = js.undefined
}

object PipelineOutputConfig {
  @scala.inline
  def apply(Bucket: BucketName = null, Permissions: Permissions = null, StorageClass: StorageClass = null): PipelineOutputConfig = {
