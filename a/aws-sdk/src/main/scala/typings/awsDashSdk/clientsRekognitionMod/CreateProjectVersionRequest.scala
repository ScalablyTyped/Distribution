...
trait CreateProjectVersionRequest extends js.Object {
  /**
    ...
    */
  var OutputConfig: typings.awsDashSdk.clientsRekognitionMod.OutputConfig = js.native
  /**
  ...
  /**
    ...
    */
  var TestingData: typings.awsDashSdk.clientsRekognitionMod.TestingData = js.native
  /**
    * The dataset to use for training. 
    */
  var TrainingData: typings.awsDashSdk.clientsRekognitionMod.TrainingData = js.native
  /**
    * A name for the version of the model. This value must be unique.
    */
  var VersionName: typings.awsDashSdk.clientsRekognitionMod.VersionName = js.native
}
