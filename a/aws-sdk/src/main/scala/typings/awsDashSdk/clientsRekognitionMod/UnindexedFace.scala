...
trait UnindexedFace extends js.Object {
  /**
    ...
    */
  var FaceDetail: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.FaceDetail] = js.native
  /**
    ...
    */
  var Reasons: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.Reasons] = js.native
}
