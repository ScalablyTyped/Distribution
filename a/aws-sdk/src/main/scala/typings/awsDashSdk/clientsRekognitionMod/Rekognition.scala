...
import typings.awsDashSdk.awsDashSdkStrings.projectVersionRunning
import typings.awsDashSdk.awsDashSdkStrings.projectVersionTrainingCompleted
...
trait Rekognition extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_projectVersionRunning(state: projectVersionRunning, params: DescribeProjectVersionsRequest with Anon_Waiter): Request[DescribeProjectVersionsResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_projectVersionRunning(
    state: projectVersionRunning,
    params: DescribeProjectVersionsRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeProjectVersionsResponse, Unit]
  ): Request[DescribeProjectVersionsResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_projectVersionTrainingCompleted(state: projectVersionTrainingCompleted, params: DescribeProjectVersionsRequest with Anon_Waiter): Request[DescribeProjectVersionsResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_projectVersionTrainingCompleted(
    state: projectVersionTrainingCompleted,
    params: DescribeProjectVersionsRequest with Anon_Waiter,
