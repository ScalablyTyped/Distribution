...
trait GetCelebrityRecognitionResponse extends js.Object {
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.StatusMessage] = js.native
  /**
    * Information about a video that Amazon Rekognition Video analyzed. Videometadata is returned in every page of paginated responses from a Amazon Rekognition Video operation.
    */
  var VideoMetadata: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.VideoMetadata] = js.native
}
