...
trait ProjectVersionDescription extends js.Object {
  ...
  /**
    ...
    */
  var EvaluationResult: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.EvaluationResult] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputConfig: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.OutputConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var TestingDataResult: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.TestingDataResult] = js.native
  /**
    * The manifest file that represents the training results.
    */
  var TrainingDataResult: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.TrainingDataResult] = js.native
  /**
