...
trait OutputConfig extends js.Object {
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.S3Bucket] = js.native
  /**
    * The prefix applied to the training output files. 
    */
  var S3KeyPrefix: js.UndefOr[typings.awsDashSdk.clientsRekognitionMod.S3KeyPrefix] = js.native
}
