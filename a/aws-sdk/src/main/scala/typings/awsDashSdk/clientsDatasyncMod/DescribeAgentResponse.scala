...
trait DescribeAgentResponse extends js.Object {
  ...
  /**
    ...
    */
  var EndpointType: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.EndpointType] = js.native
  /**
  ...
  /**
    ...
    */
  var PrivateLinkConfig: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.PrivateLinkConfig] = js.native
  /**
