...
trait DescribeTaskResponse extends js.Object {
  ...
  /**
    ...
    */
  var DestinationNetworkInterfaceArns: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.DestinationNetworkInterfaceArns] = js.native
  /**
  ...
  /**
    ...
    */
  var SourceNetworkInterfaceArns: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.SourceNetworkInterfaceArns] = js.native
  /**
