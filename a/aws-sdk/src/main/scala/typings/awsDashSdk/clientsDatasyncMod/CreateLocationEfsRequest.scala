...
trait CreateLocationEfsRequest extends js.Object {
  /**
    ...
    */
  var Ec2Config: typings.awsDashSdk.clientsDatasyncMod.Ec2Config = js.native
  /**
    * The Amazon Resource Name (ARN) for the Amazon EFS file system.
    */
  var EfsFilesystemArn: typings.awsDashSdk.clientsDatasyncMod.EfsFilesystemArn = js.native
  /**
