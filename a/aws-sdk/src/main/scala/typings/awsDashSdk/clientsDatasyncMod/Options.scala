...
trait Options extends js.Object {
  /**
    ...
    */
  var Atime: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Atime] = js.undefined
  /**
    * A value that limits the bandwidth used by AWS DataSync. For example, if you want AWS DataSync to use a maximum of 1 MB, set this value to 1048576 (=1024*1024).
    */
  var BytesPerSecond: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.BytesPerSecond] = js.undefined
  /**
    ...
    */
  var Gid: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Gid] = js.undefined
  /**
