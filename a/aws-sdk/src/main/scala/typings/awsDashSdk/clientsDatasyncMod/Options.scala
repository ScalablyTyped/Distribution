...
trait Options extends js.Object {
  /**
    ...
    */
  var Atime: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Atime] = js.native
  /**
    * A value that limits the bandwidth used by AWS DataSync. For example, if you want AWS DataSync to use a maximum of 1 MB, set this value to 1048576 (=1024*1024).
    */
  var BytesPerSecond: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.BytesPerSecond] = js.native
  /**
    ...
    */
  var Gid: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Gid] = js.native
  /**
    ...
    */
  var Mtime: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Mtime] = js.native
  /**
    ...
    */
  var OverwriteMode: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.OverwriteMode] = js.native
  /**
    ...
    */
  var PosixPermissions: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.PosixPermissions] = js.native
  /**
    ...
    */
  var PreserveDeletedFiles: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.PreserveDeletedFiles] = js.native
  /**
    ...
    */
  var PreserveDevices: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.PreserveDevices] = js.native
  /**
    ...
    */
  var TaskQueueing: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.TaskQueueing] = js.native
  /**
    ...
    */
  var Uid: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.Uid] = js.native
  /**
    ...
    */
  var VerifyMode: js.UndefOr[typings.awsDashSdk.clientsDatasyncMod.VerifyMode] = js.native
}
