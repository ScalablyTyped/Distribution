...
trait OverallVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.VolumeStatistics] = js.native
}
