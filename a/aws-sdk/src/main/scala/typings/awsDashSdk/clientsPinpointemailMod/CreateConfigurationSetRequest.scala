...
trait CreateConfigurationSetRequest extends js.Object {
  ...
  /**
    ...
    */
  var DeliveryOptions: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.DeliveryOptions] = js.undefined
  /**
    * An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.ReputationOptions] = js.undefined
  /**
    * An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.SendingOptions] = js.undefined
  /**
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.TrackingOptions] = js.undefined
}
