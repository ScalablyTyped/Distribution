...
trait DedicatedIp extends js.Object {
  ...
  /**
    ...
    */
  var PoolName: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.PoolName] = js.native
  /**
  ...
  /**
    ...
    */
  var WarmupStatus: typings.awsDashSdk.clientsPinpointemailMod.WarmupStatus = js.native
}
