...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typings.awsDashSdk.clientsPinpointemailMod.BehaviorOnMxFailure
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typings.awsDashSdk.clientsPinpointemailMod.MailFromDomainStatus
}
