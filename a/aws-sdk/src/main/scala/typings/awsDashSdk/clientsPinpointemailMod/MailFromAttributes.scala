...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typings.awsDashSdk.clientsPinpointemailMod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typings.awsDashSdk.clientsPinpointemailMod.MailFromDomainStatus = js.native
}
