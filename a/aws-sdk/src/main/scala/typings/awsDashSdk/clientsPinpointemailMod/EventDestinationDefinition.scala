...
trait EventDestinationDefinition extends js.Object {
  /**
    ...
    */
  var CloudWatchDestination: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.CloudWatchDestination] = js.native
  /**
    ...
    */
  var Enabled: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.Enabled] = js.native
  /**
    * An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.
    */
  var KinesisFirehoseDestination: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.KinesisFirehoseDestination] = js.native
  /**
  ...
  /**
    ...
    */
  var PinpointDestination: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.PinpointDestination] = js.native
  /**
    * An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
    */
  var SnsDestination: js.UndefOr[typings.awsDashSdk.clientsPinpointemailMod.SnsDestination] = js.native
}
