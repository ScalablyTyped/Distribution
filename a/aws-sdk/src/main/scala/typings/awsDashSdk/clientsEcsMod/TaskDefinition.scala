...
object TaskDefinition {
  ...
  def apply(
    ...
    if (containerDefinitions != null) __obj.updateDynamic("containerDefinitions")(containerDefinitions)
    ...
    if (requiresAttributes != null) __obj.updateDynamic("requiresAttributes")(requiresAttributes)
