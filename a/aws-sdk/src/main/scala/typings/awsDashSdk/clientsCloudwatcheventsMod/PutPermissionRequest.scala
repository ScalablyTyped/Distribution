...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typings.awsDashSdk.clientsCloudwatcheventsMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typings.awsDashSdk.clientsCloudwatcheventsMod.Principal = js.native
  /**
