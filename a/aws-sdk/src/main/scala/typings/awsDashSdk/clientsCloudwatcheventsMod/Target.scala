...
trait Target extends js.Object {
  ...
  /**
    ...
    */
  var BatchParameters: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.BatchParameters] = js.undefined
  /**
    * Contains the Amazon ECS task definition and task count to be used if the event target is an Amazon ECS task. For more information about Amazon ECS tasks, see Task Definitions  in the Amazon EC2 Container Service Developer Guide.
    */
  var EcsParameters: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.EcsParameters] = js.undefined
  /**
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.InputTransformer] = js.undefined
  /**
    ...
    */
  var KinesisParameters: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.KinesisParameters] = js.undefined
  /**
  ...
  /**
    ...
    */
  var RunCommandParameters: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.RunCommandParameters] = js.undefined
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.SqsParameters] = js.undefined
}
