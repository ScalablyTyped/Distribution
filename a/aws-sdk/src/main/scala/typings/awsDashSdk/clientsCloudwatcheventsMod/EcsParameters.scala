...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typings.awsDashSdk.clientsCloudwatcheventsMod.NetworkConfiguration] = js.native
  /**
