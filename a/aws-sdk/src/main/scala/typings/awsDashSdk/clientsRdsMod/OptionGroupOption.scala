...
trait OptionGroupOption extends js.Object {
  ...
  /**
    ...
    */
  var OptionsConflictsWith: js.UndefOr[typings.awsDashSdk.clientsRdsMod.OptionsConflictsWith] = js.undefined
  /**
    * The options that are prerequisites for this option.
    */
  var OptionsDependedOn: js.UndefOr[typings.awsDashSdk.clientsRdsMod.OptionsDependedOn] = js.undefined
  /**
