...
trait DBCluster extends js.Object {
  ...
  /**
    ...
    */
  var ActivityStreamMode: js.UndefOr[typings.awsDashSdk.clientsRdsMod.ActivityStreamMode] = js.native
  /**
    * The status of the database activity stream.
    */
  var ActivityStreamStatus: js.UndefOr[typings.awsDashSdk.clientsRdsMod.ActivityStreamStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typings.awsDashSdk.clientsRdsMod.AvailabilityZones] = js.native
  /**
  ...
  /**
    ...
    */
  var DBClusterOptionGroupMemberships: js.UndefOr[typings.awsDashSdk.clientsRdsMod.DBClusterOptionGroupMemberships] = js.native
  /**
  ...
  var ScalingConfigurationInfo: js.UndefOr[typings.awsDashSdk.clientsRdsMod.ScalingConfigurationInfo] = js.native
  /**
