...
trait CreateMLModelInput extends js.Object {
  ...
  /**
    ...
    */
  var MLModelType: typings.awsDashSdk.clientsMachinelearningMod.MLModelType
  /**
...
object CreateMLModelInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(MLModelId = MLModelId, MLModelType = MLModelType.asInstanceOf[js.Any], TrainingDataSourceId = TrainingDataSourceId)
    ...
    if (RecipeUri != null) __obj.updateDynamic("RecipeUri")(RecipeUri)
