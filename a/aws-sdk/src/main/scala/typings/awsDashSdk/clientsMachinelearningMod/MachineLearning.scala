...
import typings.awsDashSdk.awsDashSdkStrings.batchPredictionAvailable
import typings.awsDashSdk.awsDashSdkStrings.dataSourceAvailable
import typings.awsDashSdk.awsDashSdkStrings.evaluationAvailable
import typings.awsDashSdk.awsDashSdkStrings.mLModelAvailable
...
trait MachineLearning extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_batchPredictionAvailable(state: batchPredictionAvailable, params: DescribeBatchPredictionsInput with Anon_Waiter): Request[DescribeBatchPredictionsOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_batchPredictionAvailable(
    state: batchPredictionAvailable,
    params: DescribeBatchPredictionsInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeBatchPredictionsOutput, Unit]
  ): Request[DescribeBatchPredictionsOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dataSourceAvailable(state: dataSourceAvailable, params: DescribeDataSourcesInput with Anon_Waiter): Request[DescribeDataSourcesOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dataSourceAvailable(
    state: dataSourceAvailable,
    params: DescribeDataSourcesInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeDataSourcesOutput, Unit]
  ): Request[DescribeDataSourcesOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_evaluationAvailable(state: evaluationAvailable, params: DescribeEvaluationsInput with Anon_Waiter): Request[DescribeEvaluationsOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_evaluationAvailable(
    state: evaluationAvailable,
    params: DescribeEvaluationsInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeEvaluationsOutput, Unit]
  ): Request[DescribeEvaluationsOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_mLModelAvailable(state: mLModelAvailable, params: DescribeMLModelsInput with Anon_Waiter): Request[DescribeMLModelsOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_mLModelAvailable(
    state: mLModelAvailable,
    params: DescribeMLModelsInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeMLModelsOutput, Unit]
  ): Request[DescribeMLModelsOutput, AWSError] = js.native
}
