...
trait GetDataSourceOutput extends js.Object {
  /**
    ...
    */
  var ComputeStatistics: js.UndefOr[typings.awsDashSdk.clientsMachinelearningMod.ComputeStatistics] = js.native
  /**
  ...
  var RDSMetadata: js.UndefOr[typings.awsDashSdk.clientsMachinelearningMod.RDSMetadata] = js.native
  var RedshiftMetadata: js.UndefOr[typings.awsDashSdk.clientsMachinelearningMod.RedshiftMetadata] = js.native
  var RoleARN: js.UndefOr[typings.awsDashSdk.clientsMachinelearningMod.RoleARN] = js.native
  /**
