...
trait ApplicationVersionLifecycleConfig extends js.Object {
  /**
    ...
    */
  var MaxAgeRule: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.MaxAgeRule] = js.native
  /**
    * Specify a max count rule to restrict the number of application versions that are retained for an application.
    */
  var MaxCountRule: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.MaxCountRule] = js.native
}
