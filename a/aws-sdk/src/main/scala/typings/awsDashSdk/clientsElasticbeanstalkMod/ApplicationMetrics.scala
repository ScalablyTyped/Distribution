...
trait ApplicationMetrics extends js.Object {
  ...
  /**
    ...
    */
  var Latency: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.Latency] = js.native
  /**
    * Average number of requests handled by the web server per second over the last 10 seconds.
    */
  var RequestCount: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.RequestCount] = js.native
  /**
    * Represents the percentage of requests over the last 10 seconds that resulted in each type of status code response.
    */
  var StatusCodes: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.StatusCodes] = js.native
}
