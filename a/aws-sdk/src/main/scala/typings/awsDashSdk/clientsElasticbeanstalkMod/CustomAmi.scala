...
trait CustomAmi extends js.Object {
  /**
    ...
    */
  var ImageId: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.ImageId] = js.undefined
  /**
    * The type of virtualization used to create the custom AMI.
    */
  var VirtualizationType: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.VirtualizationType] = js.undefined
}
