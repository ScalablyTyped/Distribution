...
trait SourceBuildInformation extends js.Object {
  /**
    ...
    */
  var SourceLocation: typings.awsDashSdk.clientsElasticbeanstalkMod.SourceLocation = js.native
  /**
    * Location where the repository is stored.    CodeCommit     S3   
    */
  var SourceRepository: typings.awsDashSdk.clientsElasticbeanstalkMod.SourceRepository = js.native
  /**
    * The type of repository.    Git     Zip   
    */
  var SourceType: typings.awsDashSdk.clientsElasticbeanstalkMod.SourceType = js.native
}
