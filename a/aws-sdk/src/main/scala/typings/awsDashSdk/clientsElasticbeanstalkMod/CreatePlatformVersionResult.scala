...
trait CreatePlatformVersionResult extends js.Object {
  /**
    ...
    */
  var Builder: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.Builder] = js.native
  /**
    * Detailed information about the new version of the custom platform.
    */
  var PlatformSummary: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.PlatformSummary] = js.native
}
