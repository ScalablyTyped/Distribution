...
trait CreateApplicationVersionMessage extends js.Object {
  ...
  /**
    ...
    */
  var AutoCreateApplication: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.AutoCreateApplication] = js.native
  /**
    * Settings for an AWS CodeBuild build.
    */
  var BuildConfiguration: js.UndefOr[typings.awsDashSdk.clientsElasticbeanstalkMod.BuildConfiguration] = js.native
  /**
