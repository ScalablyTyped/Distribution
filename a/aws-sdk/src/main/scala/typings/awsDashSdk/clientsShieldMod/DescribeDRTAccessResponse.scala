...
trait DescribeDRTAccessResponse extends js.Object {
  /**
    ...
    */
  var LogBucketList: js.UndefOr[typings.awsDashSdk.clientsShieldMod.LogBucketList] = js.native
  /**
    * The Amazon Resource Name (ARN) of the role the DRT used to access your AWS account.
    */
  var RoleArn: js.UndefOr[typings.awsDashSdk.clientsShieldMod.RoleArn] = js.native
}
