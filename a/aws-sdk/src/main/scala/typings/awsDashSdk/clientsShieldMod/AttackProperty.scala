...
trait AttackProperty extends js.Object {
  /**
    ...
    */
  var AttackLayer: js.UndefOr[typings.awsDashSdk.clientsShieldMod.AttackLayer] = js.native
  /**
    ...
    */
  var AttackPropertyIdentifier: js.UndefOr[typings.awsDashSdk.clientsShieldMod.AttackPropertyIdentifier] = js.native
  /**
    * The array of Contributor objects that includes the top five contributors to an attack. 
    */
  var TopContributors: js.UndefOr[typings.awsDashSdk.clientsShieldMod.TopContributors] = js.native
  /**
  ...
  /**
    ...
    */
  var Unit: js.UndefOr[typings.awsDashSdk.clientsShieldMod.Unit] = js.native
}
