...
trait CognitoStreams extends js.Object {
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typings.awsDashSdk.clientsCognitosyncMod.StreamName] = js.native
  /**
    ...
    */
  var StreamingStatus: js.UndefOr[typings.awsDashSdk.clientsCognitosyncMod.StreamingStatus] = js.native
}
