...
trait UpdateRecordsRequest extends js.Object {
  /**
    ...
    */
  var ClientContext: js.UndefOr[typings.awsDashSdk.clientsCognitosyncMod.ClientContext] = js.native
  /**
  ...
  /**
    ...
    */
  var SyncSessionToken: typings.awsDashSdk.clientsCognitosyncMod.SyncSessionToken = js.native
}
