...
trait DescribeDatasetImportJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var FieldStatistics: js.UndefOr[typings.awsDashSdk.clientsForecastserviceMod.FieldStatistics] = js.native
  /**
  ...
  /**
    ...
    */
  var TimestampFormat: js.UndefOr[typings.awsDashSdk.clientsForecastserviceMod.TimestampFormat] = js.native
}
