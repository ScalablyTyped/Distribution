...
trait FeaturizationMethod extends js.Object {
  /**
    ...
    */
  var FeaturizationMethodName: typings.awsDashSdk.clientsForecastserviceMod.FeaturizationMethodName = js.native
  /**
    ...
    */
  var FeaturizationMethodParameters: js.UndefOr[typings.awsDashSdk.clientsForecastserviceMod.FeaturizationMethodParameters] = js.native
}
