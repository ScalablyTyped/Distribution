...
trait WindowSummary extends js.Object {
  /**
    ...
    */
  var EvaluationType: js.UndefOr[typings.awsDashSdk.clientsForecastserviceMod.EvaluationType] = js.native
  /**
  ...
  /**
    ...
    */
  var Metrics: js.UndefOr[typings.awsDashSdk.clientsForecastserviceMod.Metrics] = js.native
  /**
