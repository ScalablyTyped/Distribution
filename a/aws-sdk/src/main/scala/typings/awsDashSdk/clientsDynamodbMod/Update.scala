...
trait Update extends js.Object {
  /**
    ...
    */
  var ConditionExpression: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ConditionExpression] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateExpression: typings.awsDashSdk.clientsDynamodbMod.UpdateExpression = js.native
}
