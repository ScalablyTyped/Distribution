...
trait TableDescription extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.AttributeDefinitions] = js.undefined
  /**
    * Contains the details for the read/write capacity mode.
    */
  var BillingModeSummary: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.BillingModeSummary] = js.undefined
  /**
  ...
  /**
    ...
    */
  var RestoreSummary: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.RestoreSummary] = js.undefined
  /**
    * The description of the server-side encryption status on the specified table.
    */
  var SSEDescription: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.SSEDescription] = js.undefined
  /**
    * The current DynamoDB Streams configuration for the table.
    */
  var StreamSpecification: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.StreamSpecification] = js.undefined
  /**
  ...
  /**
    ...
    */
  var TableStatus: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.TableStatus] = js.undefined
}
