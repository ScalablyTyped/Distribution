...
trait ReplicaDescription extends js.Object {
  ...
  /**
    ...
    */
  var KMSMasterKeyId: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.KMSMasterKeyId] = js.native
  /**
    * Replica-specific provisioned throughput. If not described, uses the source table's provisioned throughput settings.
    */
  var ProvisionedThroughputOverride: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ProvisionedThroughputOverride] = js.native
  /**
    * The name of the Region.
    */
  var RegionName: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.RegionName] = js.native
  /**
    ...
    */
  var ReplicaStatus: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ReplicaStatus] = js.native
  /**
    * Detailed information about the replica status.
    */
  var ReplicaStatusDescription: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ReplicaStatusDescription] = js.native
  /**
    * Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.
    */
  var ReplicaStatusPercentProgress: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ReplicaStatusPercentProgress] = js.native
}
