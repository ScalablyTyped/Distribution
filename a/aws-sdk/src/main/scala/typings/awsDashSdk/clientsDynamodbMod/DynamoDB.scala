...
import typings.awsDashSdk.awsDashSdkStrings.tableExists
import typings.awsDashSdk.awsDashSdkStrings.tableNotExists
import typings.awsDashSdk.libConfigMod.ConfigBase
import typings.awsDashSdk.libErrorMod.AWSError
import typings.awsDashSdk.libRequestMod.Request
import typings.awsDashSdk.libServicesDynamodbMod.DynamoDBCustomizations
...
trait DynamoDB extends DynamoDBCustomizations {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_tableExists(state: tableExists, params: DescribeTableInput with Anon_Waiter): Request[DescribeTableOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_tableExists(
    state: tableExists,
    params: DescribeTableInput with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeTableOutput, Unit]
  ): Request[DescribeTableOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_tableNotExists(state: tableNotExists, params: DescribeTableInput with Anon_Waiter): Request[DescribeTableOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_tableNotExists(
    state: tableNotExists,
    params: DescribeTableInput with Anon_Waiter,
