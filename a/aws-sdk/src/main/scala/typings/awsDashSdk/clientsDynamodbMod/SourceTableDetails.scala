...
trait SourceTableDetails extends js.Object {
  /**
    ...
    */
  var BillingMode: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.BillingMode] = js.native
  /**
    * Number of items in the table. Note that this is an approximate value. 
    */
  var ItemCount: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ItemCount] = js.native
  /**
    * Schema of the table. 
    */
  ...
  /**
    ...
    */
  var TableCreationDateTime: typings.awsDashSdk.clientsDynamodbMod.TableCreationDateTime = js.native
  /**
    * Unique identifier for the table for which the backup was created. 
    */
  var TableId: typings.awsDashSdk.clientsDynamodbMod.TableId = js.native
  /**
