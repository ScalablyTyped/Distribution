...
trait ArchivalSummary extends js.Object {
  ...
  /**
    ...
    */
  var ArchivalDateTime: js.UndefOr[_Date] = js.native
  /**
    ...
    */
  var ArchivalReason: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ArchivalReason] = js.native
}
