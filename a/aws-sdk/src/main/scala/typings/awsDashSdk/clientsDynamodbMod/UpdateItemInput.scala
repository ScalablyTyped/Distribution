...
trait UpdateItemInput extends js.Object {
  /**
    ...
    */
  var AttributeUpdates: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.AttributeUpdates] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateExpression: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.UpdateExpression] = js.native
}
