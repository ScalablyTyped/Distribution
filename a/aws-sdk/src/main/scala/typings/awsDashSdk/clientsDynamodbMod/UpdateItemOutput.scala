...
trait UpdateItemOutput extends js.Object {
  ...
  /**
    ...
    */
  var ConsumedCapacity: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ConsumedCapacity] = js.native
  /**
    ...
    */
  var ItemCollectionMetrics: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.ItemCollectionMetrics] = js.native
}
