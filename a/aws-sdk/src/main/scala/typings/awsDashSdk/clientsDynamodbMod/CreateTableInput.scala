...
trait CreateTableInput extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: typings.awsDashSdk.clientsDynamodbMod.AttributeDefinitions = js.native
  /**
  ...
  /**
    ...
    */
  var SSESpecification: js.UndefOr[typings.awsDashSdk.clientsDynamodbMod.SSESpecification] = js.native
  /**
