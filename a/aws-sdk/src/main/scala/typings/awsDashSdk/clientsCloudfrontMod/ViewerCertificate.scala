...
trait ViewerCertificate extends js.Object {
  ...
  /**
    * This field is no longer used. Use one of the following fields instead:    ACMCertificateArn     IAMCertificateId     CloudFrontDefaultCertificate   
    */
  var CertificateSource: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.CertificateSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MinimumProtocolVersion: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.MinimumProtocolVersion] = js.native
  /**
    ...
    */
  var SSLSupportMethod: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.SSLSupportMethod] = js.native
}
