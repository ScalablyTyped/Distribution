...
trait DistributionConfig extends js.Object {
  ...
  /**
    ...
    */
  var CacheBehaviors: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.CacheBehaviors] = js.undefined
  /**
  ...
  /**
    ...
    */
  var CustomErrorResponses: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.CustomErrorResponses] = js.undefined
  /**
  ...
  /**
    ...
    */
  var HttpVersion: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.HttpVersion] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Restrictions: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.Restrictions] = js.undefined
  /**
    ...
    */
  var ViewerCertificate: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.ViewerCertificate] = js.undefined
  /**
...
object DistributionConfig {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(CallerReference = CallerReference, Comment = Comment, DefaultCacheBehavior = DefaultCacheBehavior, Enabled = Enabled, Origins = Origins)
    if (Aliases != null) __obj.updateDynamic("Aliases")(Aliases)
    if (CacheBehaviors != null) __obj.updateDynamic("CacheBehaviors")(CacheBehaviors)
    if (CustomErrorResponses != null) __obj.updateDynamic("CustomErrorResponses")(CustomErrorResponses)
    if (DefaultRootObject != null) __obj.updateDynamic("DefaultRootObject")(DefaultRootObject)
    if (HttpVersion != null) __obj.updateDynamic("HttpVersion")(HttpVersion.asInstanceOf[js.Any])
    if (!js.isUndefined(IsIPV6Enabled)) __obj.updateDynamic("IsIPV6Enabled")(IsIPV6Enabled)
    ...
    if (ViewerCertificate != null) __obj.updateDynamic("ViewerCertificate")(ViewerCertificate)
    if (WebACLId != null) __obj.updateDynamic("WebACLId")(WebACLId)
