...
trait CustomOriginConfig extends js.Object {
  ...
  /**
    ...
    */
  var OriginProtocolPolicy: typings.awsDashSdk.clientsCloudfrontMod.OriginProtocolPolicy = js.native
  /**
  ...
  /**
    ...
    */
  var OriginSslProtocols: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.OriginSslProtocols] = js.native
}
