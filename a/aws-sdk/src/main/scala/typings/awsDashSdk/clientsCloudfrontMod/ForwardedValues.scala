...
trait ForwardedValues extends js.Object {
  ...
  /**
    ...
    */
  var Headers: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.Headers] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryStringCacheKeys: js.UndefOr[typings.awsDashSdk.clientsCloudfrontMod.QueryStringCacheKeys] = js.native
}
