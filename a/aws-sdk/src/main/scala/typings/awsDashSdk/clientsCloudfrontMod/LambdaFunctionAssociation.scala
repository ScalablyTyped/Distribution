...
trait LambdaFunctionAssociation extends js.Object {
  /**
    ...
    */
  var EventType: typings.awsDashSdk.clientsCloudfrontMod.EventType = js.native
  /**
  ...
  /**
    ...
    */
  var LambdaFunctionARN: typings.awsDashSdk.clientsCloudfrontMod.LambdaFunctionARN = js.native
}
