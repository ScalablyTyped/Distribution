...
trait ResourceDataContainer extends js.Object {
  /**
    ...
    */
  var LocalDeviceResourceData: js.UndefOr[typings.awsDashSdk.clientsGreengrassMod.LocalDeviceResourceData] = js.undefined
  /**
    * Attributes that define the local volume resource.
    */
  var LocalVolumeResourceData: js.UndefOr[typings.awsDashSdk.clientsGreengrassMod.LocalVolumeResourceData] = js.undefined
  /**
    * Attributes that define an Amazon S3 machine learning resource.
    */
  var S3MachineLearningModelResourceData: js.UndefOr[typings.awsDashSdk.clientsGreengrassMod.S3MachineLearningModelResourceData] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SecretsManagerSecretResourceData: js.UndefOr[typings.awsDashSdk.clientsGreengrassMod.SecretsManagerSecretResourceData] = js.undefined
}
