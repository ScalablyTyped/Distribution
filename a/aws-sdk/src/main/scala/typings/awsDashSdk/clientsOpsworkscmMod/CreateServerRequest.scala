...
trait CreateServerRequest extends js.Object {
  ...
  /**
    ...
    */
  var CustomCertificate: js.UndefOr[typings.awsDashSdk.clientsOpsworkscmMod.CustomCertificate] = js.native
  /**
    ...
    */
  var CustomDomain: js.UndefOr[typings.awsDashSdk.clientsOpsworkscmMod.CustomDomain] = js.native
  /**
    * Supported on servers running Chef Automate 2. A private key in PEM format for connecting to the server by using HTTPS. The private key must not be encrypted; it cannot be protected by a password or passphrase. If you specify a custom private key, you must also specify values for CustomDomain and CustomCertificate.
    */
  var CustomPrivateKey: js.UndefOr[typings.awsDashSdk.clientsOpsworkscmMod.CustomPrivateKey] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceProfileArn: typings.awsDashSdk.clientsOpsworkscmMod.InstanceProfileArn = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceRoleArn: typings.awsDashSdk.clientsOpsworkscmMod.ServiceRoleArn = js.native
  /**
