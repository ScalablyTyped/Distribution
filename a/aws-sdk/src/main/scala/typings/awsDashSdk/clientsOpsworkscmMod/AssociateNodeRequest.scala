...
trait AssociateNodeRequest extends js.Object {
  /**
    ...
    */
  var EngineAttributes: typings.awsDashSdk.clientsOpsworkscmMod.EngineAttributes = js.native
  /**
    * The name of the node. 
    */
  var NodeName: typings.awsDashSdk.clientsOpsworkscmMod.NodeName = js.native
  /**
