...
import typings.awsDashSdk.awsDashSdkStrings.nodeAssociated
...
trait OpsWorksCM extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_nodeAssociated(state: nodeAssociated, params: DescribeNodeAssociationStatusRequest with Anon_Waiter): Request[DescribeNodeAssociationStatusResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_nodeAssociated(
    state: nodeAssociated,
    params: DescribeNodeAssociationStatusRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeNodeAssociationStatusResponse, Unit]
  ): Request[DescribeNodeAssociationStatusResponse, AWSError] = js.native
}
