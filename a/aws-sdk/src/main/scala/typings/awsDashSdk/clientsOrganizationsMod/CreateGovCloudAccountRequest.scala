...
trait CreateGovCloudAccountRequest extends js.Object {
  /**
    ...
    */
  var AccountName: typings.awsDashSdk.clientsOrganizationsMod.AccountName = js.native
  /**
    ...
    */
  var Email: typings.awsDashSdk.clientsOrganizationsMod.Email = js.native
  /**
  ...
  /**
    ...
    */
  var RoleName: js.UndefOr[typings.awsDashSdk.clientsOrganizationsMod.RoleName] = js.native
}
