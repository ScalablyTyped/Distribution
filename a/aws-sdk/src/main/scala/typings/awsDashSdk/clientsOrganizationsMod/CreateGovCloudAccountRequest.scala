...
trait CreateGovCloudAccountRequest extends js.Object {
  /**
    ...
    */
  var AccountName: typings.awsDashSdk.clientsOrganizationsMod.AccountName
  /**
    ...
    */
  var Email: typings.awsDashSdk.clientsOrganizationsMod.Email
  /**
  ...
  /**
    ...
    */
  var RoleName: js.UndefOr[typings.awsDashSdk.clientsOrganizationsMod.RoleName] = js.undefined
}
