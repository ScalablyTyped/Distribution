...
trait SourceDetail extends js.Object {
  /**
    ...
    */
  var EventSource: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.EventSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.MessageType] = js.native
}
