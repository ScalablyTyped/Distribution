...
trait ConformancePackInputParameter extends js.Object {
  /**
    ...
    */
  var ParameterName: typings.awsDashSdk.clientsConfigserviceMod.ParameterName = js.native
  /**
    * Another part of the key-value pair. 
    */
  var ParameterValue: typings.awsDashSdk.clientsConfigserviceMod.ParameterValue = js.native
}
