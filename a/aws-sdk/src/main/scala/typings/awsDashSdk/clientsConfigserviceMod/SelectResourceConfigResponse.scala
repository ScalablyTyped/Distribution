...
trait SelectResourceConfigResponse extends js.Object {
  ...
  /**
    ...
    */
  var QueryInfo: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.QueryInfo] = js.undefined
  /**
    * Returns the results for the SQL query.
    */
  var Results: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.Results] = js.undefined
}
