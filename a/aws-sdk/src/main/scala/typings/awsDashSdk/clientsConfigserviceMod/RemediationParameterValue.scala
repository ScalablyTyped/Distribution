...
trait RemediationParameterValue extends js.Object {
  /**
    ...
    */
  var ResourceValue: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.ResourceValue] = js.undefined
  /**
    * The value is static and does not change at run-time.
    */
  var StaticValue: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.StaticValue] = js.undefined
}
