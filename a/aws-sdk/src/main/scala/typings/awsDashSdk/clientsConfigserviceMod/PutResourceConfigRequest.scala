...
trait PutResourceConfigRequest extends js.Object {
  /**
    ...
    */
  var Configuration: typings.awsDashSdk.clientsConfigserviceMod.Configuration = js.native
  /**
  ...
  /**
    ...
    */
  var SchemaVersionId: typings.awsDashSdk.clientsConfigserviceMod.SchemaVersionId = js.native
  /**
    * Tags associated with the resource.
    */
  var Tags: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.Tags] = js.native
}
