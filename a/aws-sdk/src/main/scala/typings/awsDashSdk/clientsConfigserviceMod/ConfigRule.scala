...
trait ConfigRule extends js.Object {
  ...
  /**
    ...
    */
  var ConfigRuleState: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.ConfigRuleState] = js.native
  /**
  ...
  /**
    ...
    */
  var Scope: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.Scope] = js.native
  /**
    * Provides the rule owner (AWS or customer), the rule identifier, and the notifications that cause the function to evaluate your AWS resources.
    */
  var Source: typings.awsDashSdk.clientsConfigserviceMod.Source = js.native
}
