...
trait Source extends js.Object {
  /**
    ...
    */
  var Owner: typings.awsDashSdk.clientsConfigserviceMod.Owner = js.native
  /**
    * Provides the source and type of the event that causes AWS Config to evaluate your AWS resources.
    */
  var SourceDetails: js.UndefOr[typings.awsDashSdk.clientsConfigserviceMod.SourceDetails] = js.native
  /**
