...
trait SSEDescription extends js.Object {
  ...
  var KMSMasterKeyArn: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.KMSMasterKeyArn
  ] = js.undefined
  /**
    ...
    */
  var SSEType: js.UndefOr[typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.SSEType] = js.undefined
  /**
