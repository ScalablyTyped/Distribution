...
trait DescribeContributorInsightsOutput extends js.Object {
  ...
  var ContributorInsightsRuleList: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ContributorInsightsRuleList
  ] = js.native
  /**
  ...
  var FailureException: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.FailureException
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var LastUpdateDateTime: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.LastUpdateDateTime
  ] = js.native
  /**
