...
trait BackupDetails extends js.Object {
  ...
  /**
    ...
    */
  var BackupCreationDateTime: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupCreationDateTime = js.native
  /**
  ...
  /**
    ...
    */
  var BackupStatus: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupStatus = js.native
  /**
    ...
    */
  var BackupType: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BackupType = js.native
}
