...
trait TableDescription extends js.Object {
  /**
    ...
    */
  var ArchivalSummary: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.ArchivalSummary
  ] = js.native
  /**
  ...
  var AttributeDefinitions: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.AttributeDefinitions
  ] = js.native
  /**
    * Contains the details for the read/write capacity mode.
    */
  var BillingModeSummary: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.BillingModeSummary
  ] = js.native
  /**
  ...
  var RestoreSummary: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.RestoreSummary
  ] = js.native
  /**
  ...
  var StreamSpecification: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.StreamSpecification
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var TableId: js.UndefOr[typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TableId] = js.native
  /**
