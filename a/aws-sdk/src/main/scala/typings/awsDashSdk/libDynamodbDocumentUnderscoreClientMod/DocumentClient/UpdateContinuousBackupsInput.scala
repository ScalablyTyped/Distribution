...
trait UpdateContinuousBackupsInput extends js.Object {
  /**
    ...
    */
  var PointInTimeRecoverySpecification: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.PointInTimeRecoverySpecification = js.native
  /**
