...
trait PutItemInput extends js.Object {
  ...
  var ConditionalOperator: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ConditionalOperator
  ] = js.undefined
  /**
  ...
  var ReturnItemCollectionMetrics: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ReturnItemCollectionMetrics
  ] = js.undefined
  /**
