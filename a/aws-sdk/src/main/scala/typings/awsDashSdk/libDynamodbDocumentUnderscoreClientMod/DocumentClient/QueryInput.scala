...
trait QueryInput extends js.Object {
  ...
  var KeyConditions: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.KeyConditions
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Select: js.UndefOr[typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.Select] = js.undefined
  /**
