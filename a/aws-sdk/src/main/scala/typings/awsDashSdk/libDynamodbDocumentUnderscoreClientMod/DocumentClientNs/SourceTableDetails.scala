...
trait SourceTableDetails extends js.Object {
  ...
  var ItemCount: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ItemCount
  ] = js.undefined
  /**
    * Schema of the table. 
    */
  ...
  /**
    ...
    */
  var ProvisionedThroughput: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ProvisionedThroughput
  /**
  ...
  /**
    ...
    */
  var TableCreationDateTime: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.TableCreationDateTime
  /**
    * Unique identifier for the table for which the backup was created. 
    */
  var TableId: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.TableId
  /**
