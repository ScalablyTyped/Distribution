...
trait StreamSpecification extends js.Object {
  /**
    ...
    */
  var StreamEnabled: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.StreamEnabled = js.native
  /**
  ...
  var StreamViewType: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.StreamViewType
  ] = js.native
}
