...
trait TableDescription extends js.Object {
  ...
  var BillingModeSummary: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BillingModeSummary
  ] = js.undefined
  /**
  ...
  var RestoreSummary: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.RestoreSummary
  ] = js.undefined
  /**
  ...
  var TableStatus: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.TableStatus
  ] = js.undefined
}
