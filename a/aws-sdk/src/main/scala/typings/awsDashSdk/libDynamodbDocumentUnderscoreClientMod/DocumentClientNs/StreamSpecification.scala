...
trait StreamSpecification extends js.Object {
  ...
  var StreamEnabled: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.StreamEnabled
  ] = js.undefined
  /**
  ...
  var StreamViewType: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.StreamViewType
  ] = js.undefined
}
