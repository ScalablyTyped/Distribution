...
trait CreateTableInput extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.AttributeDefinitions
  /**
  ...
  var BillingMode: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BillingMode
  ] = js.undefined
  /**
  ...
  var SSESpecification: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.SSESpecification
  ] = js.undefined
  /**
  ...
  var StreamSpecification: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.StreamSpecification
  ] = js.undefined
  /**
