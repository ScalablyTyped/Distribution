...
trait WriteRequest extends js.Object {
  ...
  var DeleteRequest: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.DeleteRequest
  ] = js.undefined
  /**
    * A request to perform a PutItem operation.
    */
  var PutRequest: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.PutRequest
  ] = js.undefined
}
