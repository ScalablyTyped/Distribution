...
trait UpdateItemOutput extends js.Object {
  ...
  var ConsumedCapacity: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ConsumedCapacity
  ] = js.undefined
  /**
  ...
  var ItemCollectionMetrics: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ItemCollectionMetrics
  ] = js.undefined
}
