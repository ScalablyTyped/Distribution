...
trait SourceTableDetails extends js.Object {
  ...
  /**
    ...
    */
  var TableCreationDateTime: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TableCreationDateTime = js.native
  /**
    * Unique identifier for the table for which the backup was created. 
    */
  var TableId: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClient.TableId = js.native
  /**
