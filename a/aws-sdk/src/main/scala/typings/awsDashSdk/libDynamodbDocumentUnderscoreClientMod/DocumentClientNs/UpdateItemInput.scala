...
trait UpdateItemInput extends js.Object {
  ...
  var AttributeUpdates: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.AttributeUpdates
  ] = js.undefined
  /**
  ...
  var UpdateExpression: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.UpdateExpression
  ] = js.undefined
}
