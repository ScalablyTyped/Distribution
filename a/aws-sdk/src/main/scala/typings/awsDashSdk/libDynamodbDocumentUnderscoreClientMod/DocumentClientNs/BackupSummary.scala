...
trait BackupSummary extends js.Object {
  /**
    ...
    */
  var BackupArn: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BackupArn
  ] = js.undefined
  /**
    * Time at which the backup was created.
    */
  var BackupCreationDateTime: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BackupCreationDateTime
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var BackupName: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BackupName
  ] = js.undefined
  /**
  ...
  var BackupStatus: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BackupStatus
  ] = js.undefined
  /**
  ...
  var BackupType: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.BackupType
  ] = js.undefined
  /**
    * ARN associated with the table.
    */
  var TableArn: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.TableArn
  ] = js.undefined
  /**
    * Unique identifier for the table.
    */
  var TableId: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.TableId
  ] = js.undefined
  /**
    * Name of the table.
    */
