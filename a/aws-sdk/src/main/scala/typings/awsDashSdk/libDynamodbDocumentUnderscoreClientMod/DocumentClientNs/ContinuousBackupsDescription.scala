...
trait ContinuousBackupsDescription extends js.Object {
  /**
    ...
    */
  var ContinuousBackupsStatus: typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.ContinuousBackupsStatus
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[
    typings.awsDashSdk.libDynamodbDocumentUnderscoreClientMod.DocumentClientNs.PointInTimeRecoveryDescription
  ] = js.undefined
}
