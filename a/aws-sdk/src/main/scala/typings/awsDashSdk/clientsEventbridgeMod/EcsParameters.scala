...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.NetworkConfiguration] = js.native
  /**
