...
trait PutRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var EventPattern: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.EventPattern] = js.native
  /**
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.RoleArn] = js.native
  /**
    * The scheduling expression: for example, "cron(0 20 * * ? *)" or "rate(5 minutes)".
    */
  var ScheduleExpression: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.ScheduleExpression] = js.native
  /**
