...
trait Target extends js.Object {
  ...
  /**
    ...
    */
  var BatchParameters: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.BatchParameters] = js.native
  /**
    * Contains the Amazon ECS task definition and task count to be used if the event target is an Amazon ECS task. For more information about Amazon ECS tasks, see Task Definitions  in the Amazon EC2 Container Service Developer Guide.
    */
  var EcsParameters: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.EcsParameters] = js.native
  /**
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.InputTransformer] = js.native
  /**
    ...
    */
  var KinesisParameters: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.KinesisParameters] = js.native
  /**
  ...
  /**
    ...
    */
  var RunCommandParameters: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.RunCommandParameters] = js.native
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typings.awsDashSdk.clientsEventbridgeMod.SqsParameters] = js.native
}
