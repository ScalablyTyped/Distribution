...
trait Schedule extends js.Object {
  /**
    ...
    */
  var CopyTags: js.UndefOr[typings.awsDashSdk.clientsDlmMod.CopyTags] = js.native
  /**
    * The creation rule.
    */
  var CreateRule: js.UndefOr[typings.awsDashSdk.clientsDlmMod.CreateRule] = js.native
  /**
    * The rule for cross-Region snapshot copies.
    */
  var CrossRegionCopyRules: js.UndefOr[typings.awsDashSdk.clientsDlmMod.CrossRegionCopyRules] = js.native
  /**
    * The rule for enabling fast snapshot restore.
    */
  var FastRestoreRule: js.UndefOr[typings.awsDashSdk.clientsDlmMod.FastRestoreRule] = js.native
  /**
  ...
  /**
    * The retention rule.
    */
  var RetainRule: js.UndefOr[typings.awsDashSdk.clientsDlmMod.RetainRule] = js.native
  /**
