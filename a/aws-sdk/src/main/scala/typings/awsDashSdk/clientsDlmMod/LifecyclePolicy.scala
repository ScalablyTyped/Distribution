...
trait LifecyclePolicy extends js.Object {
  ...
  /**
    ...
    */
  var PolicyArn: js.UndefOr[typings.awsDashSdk.clientsDlmMod.PolicyArn] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typings.awsDashSdk.clientsDlmMod.StatusMessage] = js.native
  /**
    * The tags.
    */
