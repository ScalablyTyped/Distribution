...
trait RenewDomainRequest extends js.Object {
  /**
    ...
    */
  var CurrentExpiryYear: typings.awsDashSdk.clientsRoute53domainsMod.CurrentExpiryYear = js.native
  /**
  ...
  /**
    ...
    */
  var DurationInYears: js.UndefOr[typings.awsDashSdk.clientsRoute53domainsMod.DurationInYears] = js.native
}
