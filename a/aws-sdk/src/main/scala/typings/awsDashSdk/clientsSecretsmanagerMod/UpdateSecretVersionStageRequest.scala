...
object UpdateSecretVersionStageRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(SecretId = SecretId, VersionStage = VersionStage)
    if (MoveToVersionId != null) __obj.updateDynamic("MoveToVersionId")(MoveToVersionId)
    if (RemoveFromVersionId != null) __obj.updateDynamic("RemoveFromVersionId")(RemoveFromVersionId)
