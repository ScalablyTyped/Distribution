...
trait ApplicationConfigurationUpdate extends js.Object {
  ...
  /**
    ...
    */
  var EnvironmentPropertyUpdates: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.EnvironmentPropertyUpdates] = js.native
  /**
  ...
  /**
    ...
    */
  var VpcConfigurationUpdates: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcConfigurationUpdates] = js.native
}
