...
trait ApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var ApplicationCodeConfiguration: typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfiguration
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfiguration] = js.undefined
  /**
    * Describes execution properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentProperties: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.EnvironmentProperties] = js.undefined
  /**
    * The creation and update parameters for a Java-based Kinesis Data Analytics application.
    */
  var FlinkApplicationConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfiguration] = js.undefined
  /**
    * The creation and update parameters for an SQL-based Kinesis Data Analytics application.
    */
  var SqlApplicationConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfiguration] = js.undefined
}
