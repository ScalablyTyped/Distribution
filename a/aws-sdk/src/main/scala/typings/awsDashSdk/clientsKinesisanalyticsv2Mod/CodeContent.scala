...
trait CodeContent extends js.Object {
  /**
    ...
    */
  var S3ContentLocation: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.S3ContentLocation] = js.native
  /**
  ...
  /**
    ...
    */
  var ZipFileContent: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ZipFileContent] = js.native
}
