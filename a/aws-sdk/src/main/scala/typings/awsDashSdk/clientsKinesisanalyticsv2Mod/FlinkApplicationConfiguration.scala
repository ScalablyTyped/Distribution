...
trait FlinkApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var CheckpointConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointConfiguration] = js.undefined
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.MonitoringConfiguration] = js.undefined
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismConfiguration] = js.undefined
}
