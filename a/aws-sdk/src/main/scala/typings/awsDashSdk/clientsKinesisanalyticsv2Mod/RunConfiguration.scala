...
trait RunConfiguration extends js.Object {
  /**
    ...
    */
  var ApplicationRestoreConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ApplicationRestoreConfiguration] = js.undefined
  /**
    * Describes the starting parameters for an SQL-based Kinesis Data Analytics application.
    */
  var SqlRunConfigurations: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.SqlRunConfigurations] = js.undefined
}
