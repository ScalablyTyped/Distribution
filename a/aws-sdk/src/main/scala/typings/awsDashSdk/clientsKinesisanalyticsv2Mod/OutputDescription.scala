...
trait OutputDescription extends js.Object {
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.DestinationSchema] = js.undefined
  /**
    * Describes the Kinesis Data Firehose delivery stream that is configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutputDescription] = js.undefined
  /**
    * Describes the Kinesis data stream that is configured as the destination where output is written.
    */
  var KinesisStreamsOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutputDescription] = js.undefined
  /**
    * Describes the Lambda function that is configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.LambdaOutputDescription] = js.undefined
  /**
