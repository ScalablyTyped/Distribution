...
trait ParallelismConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var Parallelism: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.Parallelism] = js.native
  /**
    * Describes the number of parallel tasks that a Java-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application. For more information about KPUs, see Amazon Kinesis Data Analytics Pricing.
    */
  var ParallelismPerKPU: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismPerKPU] = js.native
}
