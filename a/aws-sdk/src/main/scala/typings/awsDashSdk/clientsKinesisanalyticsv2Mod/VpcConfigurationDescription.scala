...
trait VpcConfigurationDescription extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: typings.awsDashSdk.clientsKinesisanalyticsv2Mod.SecurityGroupIds = js.native
  /**
    * The array of Subnet IDs used by the VPC configuration.
    */
  var SubnetIds: typings.awsDashSdk.clientsKinesisanalyticsv2Mod.SubnetIds = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: typings.awsDashSdk.clientsKinesisanalyticsv2Mod.VpcId = js.native
}
