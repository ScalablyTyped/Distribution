...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var KinesisFirehoseInputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseInputDescription] = js.native
  /**
    * If a Kinesis data stream is configured as a streaming source, provides the Kinesis data stream's Amazon Resource Name (ARN). 
    */
  var KinesisStreamsInputDescription: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsInputDescription] = js.native
  /**
