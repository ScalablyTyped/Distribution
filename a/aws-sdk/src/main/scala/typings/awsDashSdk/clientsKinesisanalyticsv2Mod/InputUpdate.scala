...
trait InputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var InputParallelismUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.InputParallelismUpdate] = js.native
  /**
  ...
  /**
    ...
    */
  var InputSchemaUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.InputSchemaUpdate] = js.native
  /**
    * If a Kinesis Data Firehose delivery stream is the streaming source to be updated, provides an updated stream ARN.
    */
  var KinesisFirehoseInputUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseInputUpdate] = js.native
  /**
    * If a Kinesis data stream is the streaming source to be updated, provides an updated stream Amazon Resource Name (ARN).
    */
  var KinesisStreamsInputUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsInputUpdate] = js.native
  /**
