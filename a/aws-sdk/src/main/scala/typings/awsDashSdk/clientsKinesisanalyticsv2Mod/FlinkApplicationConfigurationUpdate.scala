...
trait FlinkApplicationConfigurationUpdate extends js.Object {
  /**
    ...
    */
  var CheckpointConfigurationUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.CheckpointConfigurationUpdate] = js.undefined
  /**
    * Describes updates to the configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfigurationUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.MonitoringConfigurationUpdate] = js.undefined
  /**
    * Describes updates to the parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfigurationUpdate: js.UndefOr[typings.awsDashSdk.clientsKinesisanalyticsv2Mod.ParallelismConfigurationUpdate] = js.undefined
}
