...
trait ListConnectionsInput extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsDashSdk.clientsCodestarconnectionsMod.MaxResults] = js.native
  /**
    * The token that was returned from the previous ListConnections call, which can be used to return the next set of connections in the list.
    */
  var NextToken: js.UndefOr[typings.awsDashSdk.clientsCodestarconnectionsMod.NextToken] = js.native
  /**
