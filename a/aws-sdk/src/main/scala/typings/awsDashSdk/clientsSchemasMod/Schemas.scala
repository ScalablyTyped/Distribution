...
import typings.awsDashSdk.awsDashSdkStrings.codeBindingExists
...
trait Schemas extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_codeBindingExists(state: codeBindingExists, params: DescribeCodeBindingRequest with Anon_Waiter): Request[DescribeCodeBindingResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_codeBindingExists(
    state: codeBindingExists,
    params: DescribeCodeBindingRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeCodeBindingResponse, Unit]
  ): Request[DescribeCodeBindingResponse, AWSError] = js.native
}
