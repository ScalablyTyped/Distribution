...
trait DomainValidation extends js.Object {
  ...
  /**
    ...
    */
  var ResourceRecord: js.UndefOr[typings.awsDashSdk.clientsAcmMod.ResourceRecord] = js.native
  /**
  ...
  /**
    ...
    */
  var ValidationMethod: js.UndefOr[typings.awsDashSdk.clientsAcmMod.ValidationMethod] = js.native
  /**
