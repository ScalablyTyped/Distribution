...
trait ListCertificatesResponse extends js.Object {
  /**
    ...
    */
  var CertificateSummaryList: js.UndefOr[typings.awsDashSdk.clientsAcmMod.CertificateSummaryList] = js.undefined
  /**
    * When the list is truncated, this value is present and contains the value to use for the NextToken parameter in a subsequent pagination request.
    */
  var NextToken: js.UndefOr[typings.awsDashSdk.clientsAcmMod.NextToken] = js.undefined
}
