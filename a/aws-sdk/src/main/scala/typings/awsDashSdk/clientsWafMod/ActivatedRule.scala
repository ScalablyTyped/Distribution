...
trait ActivatedRule extends js.Object {
  ...
  /**
    ...
    */
  var ExcludedRules: js.UndefOr[typings.awsDashSdk.clientsWafMod.ExcludedRules] = js.undefined
  /**
...
object ActivatedRule {
  ...
  def apply(
    ...
    if (ExcludedRules != null) __obj.updateDynamic("ExcludedRules")(ExcludedRules)
