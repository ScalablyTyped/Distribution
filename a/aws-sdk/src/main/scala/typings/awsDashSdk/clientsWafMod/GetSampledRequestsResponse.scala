...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typings.awsDashSdk.clientsWafMod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typings.awsDashSdk.clientsWafMod.TimeWindow] = js.native
}
