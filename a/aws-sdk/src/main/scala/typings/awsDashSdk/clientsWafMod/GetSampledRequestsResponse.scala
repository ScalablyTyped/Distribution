...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typings.awsDashSdk.clientsWafMod.PopulationSize] = js.undefined
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typings.awsDashSdk.clientsWafMod.TimeWindow] = js.undefined
}
