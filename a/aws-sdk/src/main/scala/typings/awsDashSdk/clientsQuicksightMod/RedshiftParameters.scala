...
trait RedshiftParameters extends js.Object {
  /**
    ...
    */
  var ClusterId: js.UndefOr[typings.awsDashSdk.clientsQuicksightMod.ClusterId] = js.native
  /**
    * Database.
    */
  ...
  /**
    ...
    */
  var Host: js.UndefOr[typings.awsDashSdk.clientsQuicksightMod.Host] = js.native
  /**
