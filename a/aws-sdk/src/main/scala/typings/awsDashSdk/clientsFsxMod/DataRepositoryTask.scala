...
trait DataRepositoryTask extends js.Object {
  ...
  /**
    ...
    */
  var EndTime: js.UndefOr[typings.awsDashSdk.clientsFsxMod.EndTime] = js.native
  /**
  ...
  /**
    ...
    */
  var StartTime: js.UndefOr[typings.awsDashSdk.clientsFsxMod.StartTime] = js.native
  /**
