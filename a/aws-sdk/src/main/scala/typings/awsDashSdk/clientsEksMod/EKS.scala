...
import typings.awsDashSdk.awsDashSdkStrings.nodegroupActive
import typings.awsDashSdk.awsDashSdkStrings.nodegroupDeleted
...
trait EKS extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_nodegroupActive(state: nodegroupActive, params: DescribeNodegroupRequest with Anon_Waiter): Request[DescribeNodegroupResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_nodegroupActive(
    state: nodegroupActive,
    params: DescribeNodegroupRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeNodegroupResponse, Unit]
  ): Request[DescribeNodegroupResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_nodegroupDeleted(state: nodegroupDeleted, params: DescribeNodegroupRequest with Anon_Waiter): Request[DescribeNodegroupResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_nodegroupDeleted(
    state: nodegroupDeleted,
    params: DescribeNodegroupRequest with Anon_Waiter,
