...
trait ProvisionedProductAttribute extends js.Object {
  ...
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.IdempotencyToken] = js.undefined
  /**
  ...
  /**
    ...
    */
  var PhysicalId: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.PhysicalId] = js.undefined
  /**
  ...
  /**
    ...
    */
  var UserArn: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.UserArn] = js.undefined
  /**
    * The ARN of the IAM user in the session. This ARN might contain a session ID.
    */
  var UserArnSession: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.UserArnSession] = js.undefined
}
