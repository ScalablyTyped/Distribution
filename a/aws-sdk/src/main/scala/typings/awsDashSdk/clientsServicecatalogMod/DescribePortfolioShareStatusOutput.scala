...
trait DescribePortfolioShareStatusOutput extends js.Object {
  /**
    ...
    */
  var OrganizationNodeValue: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.OrganizationNodeValue] = js.undefined
  /**
  ...
  /**
    ...
    */
  var ShareDetails: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.ShareDetails] = js.undefined
  /**
