...
trait ResourceChange extends js.Object {
  ...
  /**
    ...
    */
  var LogicalResourceId: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.LogicalResourceId] = js.undefined
  /**
    * The ID of the resource, if it was already created.
    */
  var PhysicalResourceId: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.PhysicalResourceId] = js.undefined
  /**
    * If the change type is Modify, indicates whether the existing resource is deleted and replaced with a new one.
    */
  var Replacement: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.Replacement] = js.undefined
  /**
  ...
  /**
    * The change scope.
    */
  var Scope: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.Scope] = js.undefined
}
