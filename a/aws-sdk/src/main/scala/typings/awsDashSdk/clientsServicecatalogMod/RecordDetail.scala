...
trait RecordDetail extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductType: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.ProvisionedProductType] = js.undefined
  /**
  ...
  /**
    ...
    */
  var RecordErrors: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.RecordErrors] = js.undefined
  /**
  ...
  /**
    * One or more tags.
    */
  var RecordTags: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.RecordTags] = js.undefined
  /**
    * The record type.    PROVISION_PRODUCT     UPDATE_PROVISIONED_PRODUCT     TERMINATE_PROVISIONED_PRODUCT   
    */
  var RecordType: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.RecordType] = js.undefined
  /**
