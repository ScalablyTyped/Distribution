...
trait RecordOutput extends js.Object {
  ...
  /**
    * The output key.
    */
  var OutputKey: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.OutputKey] = js.undefined
  /**
    * The output value.
    */
  var OutputValue: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.OutputValue] = js.undefined
}
