...
trait UpdateProductInput extends js.Object {
  ...
  /**
    ...
    */
  var SupportDescription: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.SupportDescription] = js.native
  /**
    * The updated support email for the product.
    */
  var SupportEmail: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.SupportEmail] = js.native
  /**
    * The updated support URL for the product.
    */
  var SupportUrl: js.UndefOr[typings.awsDashSdk.clientsServicecatalogMod.SupportUrl] = js.native
}
