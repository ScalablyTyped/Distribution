...
import typings.awsDashSdk.awsDashSdkStrings.functionActive
import typings.awsDashSdk.awsDashSdkStrings.functionExists
import typings.awsDashSdk.awsDashSdkStrings.functionUpdated
...
trait Lambda extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_functionActive(state: functionActive, params: GetFunctionConfigurationRequest with Anon_Waiter): Request[FunctionConfiguration, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_functionActive(
    state: functionActive,
    params: GetFunctionConfigurationRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ FunctionConfiguration, Unit]
  ): Request[FunctionConfiguration, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_functionExists(state: functionExists, params: GetFunctionRequest with Anon_Waiter): Request[GetFunctionResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_functionExists(
    state: functionExists,
    params: GetFunctionRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetFunctionResponse, Unit]
  ): Request[GetFunctionResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_functionUpdated(state: functionUpdated, params: GetFunctionConfigurationRequest with Anon_Waiter): Request[FunctionConfiguration, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_functionUpdated(
    state: functionUpdated,
    params: GetFunctionConfigurationRequest with Anon_Waiter,
