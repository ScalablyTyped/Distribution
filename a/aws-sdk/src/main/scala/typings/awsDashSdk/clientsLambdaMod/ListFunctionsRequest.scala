...
trait ListFunctionsRequest extends js.Object {
  /**
    ...
    */
  var FunctionVersion: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.FunctionVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var MasterRegion: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.MasterRegion] = js.native
  /**
