...
trait InvocationRequest extends js.Object {
  ...
  /**
    ...
    */
  var InvocationType: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.InvocationType] = js.undefined
  /**
    * Set to Tail to include the execution log in the response.
    */
  var LogType: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.LogType] = js.undefined
  /**
