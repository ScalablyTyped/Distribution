...
trait CreateFunctionRequest extends js.Object {
  ...
  /**
    ...
    */
  var Environment: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.Environment] = js.native
  /**
  ...
  /**
    ...
    */
  var Handler: typings.awsDashSdk.clientsLambdaMod.Handler = js.native
  /**
  ...
  /**
    ...
    */
  var Runtime: typings.awsDashSdk.clientsLambdaMod.Runtime = js.native
  /**
  ...
  /**
    ...
    */
  var TracingConfig: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.TracingConfig] = js.native
  /**
    * For network connectivity to AWS resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can only access resources and the internet through that VPC. For more information, see VPC Settings.
    */
  var VpcConfig: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.VpcConfig] = js.native
}
