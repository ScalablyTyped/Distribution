...
trait AddPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typings.awsDashSdk.clientsLambdaMod.Action
  /**
    * For Alexa Smart Home functions, a token that must be supplied by the invoker.
    */
  var EventSourceToken: js.UndefOr[typings.awsDashSdk.clientsLambdaMod.EventSourceToken] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Principal: typings.awsDashSdk.clientsLambdaMod.Principal
  /**
