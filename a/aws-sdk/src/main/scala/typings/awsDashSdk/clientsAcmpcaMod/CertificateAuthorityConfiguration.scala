...
trait CertificateAuthorityConfiguration extends js.Object {
  /**
    ...
    */
  var KeyAlgorithm: typings.awsDashSdk.clientsAcmpcaMod.KeyAlgorithm = js.native
  /**
    * Name of the algorithm your private CA uses to sign certificate requests.
    */
  var SigningAlgorithm: typings.awsDashSdk.clientsAcmpcaMod.SigningAlgorithm = js.native
  /**
