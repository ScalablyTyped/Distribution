...
trait CreateCertificateAuthorityRequest extends js.Object {
  /**
    ...
    */
  var CertificateAuthorityConfiguration: typings.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityConfiguration
  /**
    * The type of the certificate authority.
    */
  var CertificateAuthorityType: typings.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityType
  /**
