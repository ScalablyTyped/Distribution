...
trait CreateCertificateAuthorityRequest extends js.Object {
  /**
    ...
    */
  var CertificateAuthorityConfiguration: typings.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityConfiguration = js.native
  /**
    * The type of the certificate authority.
    */
  var CertificateAuthorityType: typings.awsDashSdk.clientsAcmpcaMod.CertificateAuthorityType = js.native
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typings.awsDashSdk.clientsAcmpcaMod.IdempotencyToken] = js.native
  /**
