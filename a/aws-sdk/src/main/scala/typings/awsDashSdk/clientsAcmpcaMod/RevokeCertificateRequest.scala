...
trait RevokeCertificateRequest extends js.Object {
  ...
  /**
    ...
    */
  var RevocationReason: typings.awsDashSdk.clientsAcmpcaMod.RevocationReason
}
...
object RevokeCertificateRequest {
  ...
  def apply(CertificateAuthorityArn: Arn, CertificateSerial: String128, RevocationReason: RevocationReason): RevokeCertificateRequest = {
    val __obj = js.Dynamic.literal(CertificateAuthorityArn = CertificateAuthorityArn, CertificateSerial = CertificateSerial, RevocationReason = RevocationReason.asInstanceOf[js.Any])
