...
import typings.awsDashSdk.awsDashSdkStrings.instanceProfileExists
import typings.awsDashSdk.awsDashSdkStrings.policyExists
import typings.awsDashSdk.awsDashSdkStrings.roleExists
import typings.awsDashSdk.awsDashSdkStrings.userExists
...
trait IAM extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceProfileExists(state: instanceProfileExists, params: GetInstanceProfileRequest with Anon_Waiter): Request[GetInstanceProfileResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceProfileExists(
    state: instanceProfileExists,
    params: GetInstanceProfileRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetInstanceProfileResponse, Unit]
  ): Request[GetInstanceProfileResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_policyExists(state: policyExists, params: GetPolicyRequest with Anon_Waiter): Request[GetPolicyResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_policyExists(
    state: policyExists,
    params: GetPolicyRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetPolicyResponse, Unit]
  ): Request[GetPolicyResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_roleExists(state: roleExists, params: GetRoleRequest with Anon_Waiter): Request[GetRoleResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_roleExists(
    state: roleExists,
    params: GetRoleRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetRoleResponse, Unit]
  ): Request[GetRoleResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_userExists(state: userExists, params: GetUserRequest with Anon_Waiter): Request[GetUserResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_userExists(
    state: userExists,
    params: GetUserRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetUserResponse, Unit]
  ): Request[GetUserResponse, AWSError] = js.native
}
