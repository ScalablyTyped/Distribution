...
trait GetOrganizationsAccessReportResponse extends js.Object {
  /**
    ...
    */
  var AccessDetails: js.UndefOr[typings.awsDashSdk.clientsIamMod.AccessDetails] = js.native
  var ErrorDetails: js.UndefOr[typings.awsDashSdk.clientsIamMod.ErrorDetails] = js.native
  /**
