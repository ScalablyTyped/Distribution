...
trait PatchRule extends js.Object {
  /**
    ...
    */
  var ApproveAfterDays: typings.awsDashSdk.clientsSsmMod.ApproveAfterDays = js.native
  /**
  ...
  /**
    ...
    */
  var PatchFilterGroup: typings.awsDashSdk.clientsSsmMod.PatchFilterGroup = js.native
}
