...
trait CloudWatchOutputConfig extends js.Object {
  /**
    ...
    */
  var CloudWatchLogGroupName: js.UndefOr[typings.awsDashSdk.clientsSsmMod.CloudWatchLogGroupName] = js.undefined
  /**
    * Enables Systems Manager to send command output to CloudWatch Logs.
    */
  var CloudWatchOutputEnabled: js.UndefOr[typings.awsDashSdk.clientsSsmMod.CloudWatchOutputEnabled] = js.undefined
}
