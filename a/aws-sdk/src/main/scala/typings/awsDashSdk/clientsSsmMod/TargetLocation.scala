...
trait TargetLocation extends js.Object {
  /**
    ...
    */
  var Accounts: js.UndefOr[typings.awsDashSdk.clientsSsmMod.Accounts] = js.undefined
  /**
    * The Automation execution role used by the currently running Automation.
    */
  var ExecutionRoleName: js.UndefOr[typings.awsDashSdk.clientsSsmMod.ExecutionRoleName] = js.undefined
  /**
    * The AWS Regions targeted by the current Automation execution.
    */
  var Regions: js.UndefOr[typings.awsDashSdk.clientsSsmMod.Regions] = js.undefined
  /**
