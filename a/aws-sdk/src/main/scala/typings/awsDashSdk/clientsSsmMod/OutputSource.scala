...
trait OutputSource extends js.Object {
  /**
    ...
    */
  var OutputSourceId: js.UndefOr[typings.awsDashSdk.clientsSsmMod.OutputSourceId] = js.undefined
  /**
    * The type of source where the association execution details are stored, for example, Amazon S3.
    */
  var OutputSourceType: js.UndefOr[typings.awsDashSdk.clientsSsmMod.OutputSourceType] = js.undefined
}
