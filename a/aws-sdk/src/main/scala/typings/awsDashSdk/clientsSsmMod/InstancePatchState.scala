...
trait InstancePatchState extends js.Object {
  ...
  /**
    ...
    */
  var InstallOverrideList: js.UndefOr[typings.awsDashSdk.clientsSsmMod.InstallOverrideList] = js.native
  /**
  ...
  /**
    * Reserved for future use. 
    */
  var RebootOption: js.UndefOr[typings.awsDashSdk.clientsSsmMod.RebootOption] = js.native
  /**
