...
trait InstanceInformation extends js.Object {
  ...
  /**
    ...
    */
  var ComputerName: js.UndefOr[typings.awsDashSdk.clientsSsmMod.ComputerName] = js.native
  /**
    * The IP address of the managed instance.
    */
  var IPAddress: js.UndefOr[typings.awsDashSdk.clientsSsmMod.IPAddress] = js.native
  /**
  ...
  /**
    ...
    */
  var PingStatus: js.UndefOr[typings.awsDashSdk.clientsSsmMod.PingStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var PlatformType: js.UndefOr[typings.awsDashSdk.clientsSsmMod.PlatformType] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceType: js.UndefOr[typings.awsDashSdk.clientsSsmMod.ResourceType] = js.native
}
