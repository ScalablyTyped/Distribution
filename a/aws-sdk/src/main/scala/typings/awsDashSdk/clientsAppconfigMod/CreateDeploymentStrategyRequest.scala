...
trait CreateDeploymentStrategyRequest extends js.Object {
  ...
  /**
    ...
    */
  var GrowthFactor: typings.awsDashSdk.clientsAppconfigMod.GrowthFactor = js.native
  /**
  ...
  /**
    ...
    */
  var ReplicateTo: typings.awsDashSdk.clientsAppconfigMod.ReplicateTo = js.native
  /**
