...
object GenerateDataSetRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(dataSetPublicationDate = dataSetPublicationDate, dataSetType = dataSetType.asInstanceOf[js.Any], destinationS3BucketName = destinationS3BucketName, roleNameArn = roleNameArn, snsTopicArn = snsTopicArn)
