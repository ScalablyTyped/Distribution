...
object StartSupportDataExportRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(dataSetType = dataSetType.asInstanceOf[js.Any], destinationS3BucketName = destinationS3BucketName, fromDate = fromDate, roleNameArn = roleNameArn, snsTopicArn = snsTopicArn)
    if (customerDefinedValues != null) __obj.updateDynamic("customerDefinedValues")(customerDefinedValues)
    if (destinationS3Prefix != null) __obj.updateDynamic("destinationS3Prefix")(destinationS3Prefix)
