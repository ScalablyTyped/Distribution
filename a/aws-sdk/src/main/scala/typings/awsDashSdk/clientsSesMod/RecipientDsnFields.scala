...
trait RecipientDsnFields extends js.Object {
  ...
  /**
    ...
    */
  var DiagnosticCode: js.UndefOr[typings.awsDashSdk.clientsSesMod.DiagnosticCode] = js.undefined
  /**
  ...
  /**
    ...
    */
  var LastAttemptDate: js.UndefOr[typings.awsDashSdk.clientsSesMod.LastAttemptDate] = js.undefined
  /**
    * The MTA to which the remote MTA attempted to deliver the message, formatted as specified in RFC 3464 (mta-name-type; mta-name). This parameter typically applies only to propagating synchronous bounces.
    */
  var RemoteMta: js.UndefOr[typings.awsDashSdk.clientsSesMod.RemoteMta] = js.undefined
  /**
