...
trait BouncedRecipientInfo extends js.Object {
  /**
    ...
    */
  var BounceType: js.UndefOr[typings.awsDashSdk.clientsSesMod.BounceType] = js.native
  /**
  ...
  /**
    ...
    */
  var RecipientDsnFields: js.UndefOr[typings.awsDashSdk.clientsSesMod.RecipientDsnFields] = js.native
}
