...
trait IdentityVerificationAttributes extends js.Object {
  /**
    ...
    */
  var VerificationStatus: typings.awsDashSdk.clientsSesMod.VerificationStatus
  /**
    * The verification token for a domain identity. Null for email address identities.
    */
  var VerificationToken: js.UndefOr[typings.awsDashSdk.clientsSesMod.VerificationToken] = js.undefined
}
