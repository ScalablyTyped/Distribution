...
trait GetShardIteratorInput extends js.Object {
  ...
  /**
    ...
    */
  var ShardIteratorType: typings.awsDashSdk.clientsKinesisMod.ShardIteratorType = js.native
  /**
  ...
  /**
    ...
    */
  var Timestamp: js.UndefOr[typings.awsDashSdk.clientsKinesisMod.Timestamp] = js.native
}
