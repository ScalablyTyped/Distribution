...
object SubmitJobRequest {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(jobDefinition = jobDefinition, jobName = jobName, jobQueue = jobQueue)
    ...
    if (nodeOverrides != null) __obj.updateDynamic("nodeOverrides")(nodeOverrides)
