...
trait ChannelInfo extends js.Object {
  ...
  /**
    ...
    */
  var ChannelName: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoMod.ChannelName] = js.native
  /**
  ...
  /**
    ...
    */
  var ChannelType: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoMod.ChannelType] = js.native
  /**
  ...
  /**
    ...
    */
  var SingleMasterConfiguration: js.UndefOr[typings.awsDashSdk.clientsKinesisvideoMod.SingleMasterConfiguration] = js.native
  /**
