...
trait Warning extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typings.awsDashSdk.clientsTextractMod.ErrorCode] = js.undefined
  /**
    * A list of the pages that the warning applies to.
    */
  var Pages: js.UndefOr[typings.awsDashSdk.clientsTextractMod.Pages] = js.undefined
}
