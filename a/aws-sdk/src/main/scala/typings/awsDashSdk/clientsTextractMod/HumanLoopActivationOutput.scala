...
trait HumanLoopActivationOutput extends js.Object {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typings.awsDashSdk.clientsTextractMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.native
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typings.awsDashSdk.clientsTextractMod.HumanLoopActivationReasons] = js.native
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typings.awsDashSdk.clientsTextractMod.HumanLoopArn] = js.native
}
