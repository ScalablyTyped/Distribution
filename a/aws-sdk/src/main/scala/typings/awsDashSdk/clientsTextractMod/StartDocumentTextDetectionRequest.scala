...
trait StartDocumentTextDetectionRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typings.awsDashSdk.clientsTextractMod.ClientRequestToken] = js.undefined
  /**
    * The location of the document to be processed.
    */
  var DocumentLocation: typings.awsDashSdk.clientsTextractMod.DocumentLocation
  /**
    ...
    */
  var JobTag: js.UndefOr[typings.awsDashSdk.clientsTextractMod.JobTag] = js.undefined
  /**
    * The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. 
    */
  var NotificationChannel: js.UndefOr[typings.awsDashSdk.clientsTextractMod.NotificationChannel] = js.undefined
}
