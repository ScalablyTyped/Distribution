...
trait StartDocumentTextDetectionRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typings.awsDashSdk.clientsTextractMod.ClientRequestToken] = js.native
  /**
    * The location of the document to be processed.
    */
  var DocumentLocation: typings.awsDashSdk.clientsTextractMod.DocumentLocation = js.native
  /**
    * An identifier that you specify that's included in the completion notification published to the Amazon SNS topic. For example, you can use JobTag to identify the type of document that the completion notification corresponds to (such as a tax form or a receipt).
    */
  var JobTag: js.UndefOr[typings.awsDashSdk.clientsTextractMod.JobTag] = js.native
  /**
    * The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. 
    */
  var NotificationChannel: js.UndefOr[typings.awsDashSdk.clientsTextractMod.NotificationChannel] = js.native
}
