...
trait Block extends js.Object {
  /**
    ...
    */
  var BlockType: js.UndefOr[typings.awsDashSdk.clientsTextractMod.BlockType] = js.undefined
  /**
  ...
  /**
    ...
    */
  var EntityTypes: js.UndefOr[typings.awsDashSdk.clientsTextractMod.EntityTypes] = js.undefined
  /**
    * The location of the recognized text on the image. It includes an axis-aligned, coarse bounding box that surrounds the text, and a finer-grain polygon for more accurate spatial information. 
    */
  var Geometry: js.UndefOr[typings.awsDashSdk.clientsTextractMod.Geometry] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SelectionStatus: js.UndefOr[typings.awsDashSdk.clientsTextractMod.SelectionStatus] = js.undefined
  /**
