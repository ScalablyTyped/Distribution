...
trait QualificationRequirement extends js.Object {
  ...
  /**
    ...
    */
  var Comparator: typings.awsDashSdk.clientsMturkMod.Comparator
  /**
...
object QualificationRequirement {
  ...
  def apply(
    ...
    if (IntegerValues != null) __obj.updateDynamic("IntegerValues")(IntegerValues)
    if (LocaleValues != null) __obj.updateDynamic("LocaleValues")(LocaleValues)
    if (!js.isUndefined(RequiredToPreview)) __obj.updateDynamic("RequiredToPreview")(RequiredToPreview)
