...
trait GetScalingPlanResourceForecastDataRequest extends js.Object {
  ...
  /**
    ...
    */
  var ForecastDataType: typings.awsDashSdk.clientsAutoscalingplansMod.ForecastDataType = js.native
  /**
  ...
  /**
    ...
    */
  var ScalableDimension: typings.awsDashSdk.clientsAutoscalingplansMod.ScalableDimension = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceNamespace: typings.awsDashSdk.clientsAutoscalingplansMod.ServiceNamespace = js.native
  /**
