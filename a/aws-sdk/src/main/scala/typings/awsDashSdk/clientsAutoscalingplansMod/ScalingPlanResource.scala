...
trait ScalingPlanResource extends js.Object {
  ...
  /**
    ...
    */
  var ScalingPolicies: js.UndefOr[typings.awsDashSdk.clientsAutoscalingplansMod.ScalingPolicies] = js.native
  /**
    ...
    */
  var ScalingStatusCode: typings.awsDashSdk.clientsAutoscalingplansMod.ScalingStatusCode = js.native
  /**
