...
trait ScalingPlanResource extends js.Object {
  ...
  /**
    ...
    */
  var ScalingPolicies: js.UndefOr[typings.awsDashSdk.clientsAutoscalingplansMod.ScalingPolicies] = js.undefined
  /**
    ...
    */
  var ScalingStatusCode: typings.awsDashSdk.clientsAutoscalingplansMod.ScalingStatusCode
  /**
