...
trait SearchRecord extends js.Object {
  /**
    ...
    */
  var Experiment: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.Experiment] = js.native
  /**
  ...
  /**
    ...
    */
  var Trial: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.Trial] = js.native
  /**
    * A summary of the properties of a trial component.
    */
  var TrialComponent: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.TrialComponent] = js.native
}
