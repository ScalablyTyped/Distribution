...
trait DescribeAutoMLJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var AutoMLJobArtifacts: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.AutoMLJobArtifacts] = js.native
  /**
    * Returns the job's config.
    */
  var AutoMLJobConfig: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.AutoMLJobConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var GenerateCandidateDefinitionsOnly: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.GenerateCandidateDefinitionsOnly] = js.native
  /**
  ...
  /**
    ...
    */
  var ResolvedAttributes: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.ResolvedAttributes] = js.native
  /**
