...
trait InputConfig extends js.Object {
  /**
    ...
    */
  var DataInputConfig: typings.awsDashSdk.clientsSagemakerMod.DataInputConfig = js.native
  /**
    * Identifies the framework in which the model was trained. For example: TENSORFLOW.
    */
  var Framework: typings.awsDashSdk.clientsSagemakerMod.Framework = js.native
  /**
