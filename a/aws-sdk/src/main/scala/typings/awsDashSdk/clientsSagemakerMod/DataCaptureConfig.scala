...
trait DataCaptureConfig extends js.Object {
  /**
    * 
    */
  var CaptureContentTypeHeader: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.CaptureContentTypeHeader] = js.native
  /**
    * 
    */
  ...
  /**
    * 
    */
  var EnableCapture: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.EnableCapture] = js.native
  /**
    * 
    */
