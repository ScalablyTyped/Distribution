...
trait AutoMLJobArtifacts extends js.Object {
  /**
    ...
    */
  var CandidateDefinitionNotebookLocation: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.CandidateDefinitionNotebookLocation] = js.native
  /**
    * The URL to the notebook location.
    */
  var DataExplorationNotebookLocation: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.DataExplorationNotebookLocation] = js.native
}
