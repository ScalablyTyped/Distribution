...
import typings.awsDashSdk.awsDashSdkStrings.processingJobCompletedOrStopped
...
trait SageMaker extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_processingJobCompletedOrStopped(state: processingJobCompletedOrStopped, params: DescribeProcessingJobRequest with Anon_Waiter): Request[DescribeProcessingJobResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_processingJobCompletedOrStopped(
    state: processingJobCompletedOrStopped,
    params: DescribeProcessingJobRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeProcessingJobResponse, Unit]
  ): Request[DescribeProcessingJobResponse, AWSError] = js.native
  /**
