...
trait LabelingJobAlgorithmsConfig extends js.Object {
  ...
  /**
    ...
    */
  var LabelingJobAlgorithmSpecificationArn: typings.awsDashSdk.clientsSagemakerMod.LabelingJobAlgorithmSpecificationArn = js.native
  /**
    * Provides configuration information for a labeling job.
    */
  var LabelingJobResourceConfig: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.LabelingJobResourceConfig] = js.native
}
