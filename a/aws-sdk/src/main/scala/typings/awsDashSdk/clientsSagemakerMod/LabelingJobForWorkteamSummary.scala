...
trait LabelingJobForWorkteamSummary extends js.Object {
  ...
  /**
    ...
    */
  var LabelingJobName: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.LabelingJobName] = js.native
  /**
    * The configured number of workers per data object.
    */
  var NumberOfHumanWorkersPerDataObject: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.NumberOfHumanWorkersPerDataObject] = js.native
  /**
    * 
    */
