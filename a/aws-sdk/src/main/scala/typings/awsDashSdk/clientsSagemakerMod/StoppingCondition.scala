...
trait StoppingCondition extends js.Object {
  /**
    ...
    */
  var MaxRuntimeInSeconds: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.MaxRuntimeInSeconds] = js.native
  /**
    ...
    */
  var MaxWaitTimeInSeconds: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.MaxWaitTimeInSeconds] = js.native
}
