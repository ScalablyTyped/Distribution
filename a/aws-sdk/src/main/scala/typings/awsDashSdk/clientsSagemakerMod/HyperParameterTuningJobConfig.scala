...
trait HyperParameterTuningJobConfig extends js.Object {
  /**
    ...
    */
  var HyperParameterTuningJobObjective: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.HyperParameterTuningJobObjective] = js.native
  /**
    * The ParameterRanges object that specifies the ranges of hyperparameters that this tuning job searches.
    */
  var ParameterRanges: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.ParameterRanges] = js.native
  /**
    * The ResourceLimits object that specifies the maximum number of training jobs and parallel training jobs for this tuning job.
    */
  var ResourceLimits: typings.awsDashSdk.clientsSagemakerMod.ResourceLimits = js.native
  /**
  ...
  /**
    ...
    */
  var TrainingJobEarlyStoppingType: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.TrainingJobEarlyStoppingType] = js.native
  /**
    * The tuning job's completion criteria.
    */
  var TuningJobCompletionCriteria: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.TuningJobCompletionCriteria] = js.native
}
