...
trait TransformInput extends js.Object {
  /**
    ...
    */
  var CompressionType: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.CompressionType] = js.undefined
  /**
    * The multipurpose internet mail extension (MIME) type of the data. Amazon SageMaker uses the MIME type with each http call to transfer data to the transform job.
    */
  var ContentType: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.ContentType] = js.undefined
  /**
  ...
  /**
    ...
    */
  var SplitType: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.SplitType] = js.undefined
}
