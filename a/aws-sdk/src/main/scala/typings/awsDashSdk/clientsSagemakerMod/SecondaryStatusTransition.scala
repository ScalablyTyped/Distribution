...
trait SecondaryStatusTransition extends js.Object {
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.StatusMessage] = js.undefined
}
...
object SecondaryStatusTransition {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(StartTime = StartTime, Status = Status.asInstanceOf[js.Any])
