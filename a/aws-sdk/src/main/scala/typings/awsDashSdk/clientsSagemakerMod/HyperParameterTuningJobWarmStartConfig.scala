...
trait HyperParameterTuningJobWarmStartConfig extends js.Object {
  /**
    ...
    */
  var ParentHyperParameterTuningJobs: typings.awsDashSdk.clientsSagemakerMod.ParentHyperParameterTuningJobs
  /**
...
object HyperParameterTuningJobWarmStartConfig {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ParentHyperParameterTuningJobs = ParentHyperParameterTuningJobs, WarmStartType = WarmStartType.asInstanceOf[js.Any])
