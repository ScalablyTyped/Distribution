...
trait DescribeNotebookInstanceOutput extends js.Object {
  ...
  /**
    ...
    */
  var DirectInternetAccess: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.DirectInternetAccess] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkInterfaceId: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.NetworkInterfaceId] = js.native
  /**
    * The Amazon Resource Name (ARN) of the notebook instance.
    */
  var NotebookInstanceArn: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.NotebookInstanceArn] = js.native
  /**
  ...
  /**
    ...
    */
  var NotebookInstanceName: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.NotebookInstanceName] = js.native
  /**
    * The status of the notebook instance.
    */
  var NotebookInstanceStatus: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.NotebookInstanceStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typings.awsDashSdk.clientsSagemakerMod.SubnetId] = js.native
  /**
