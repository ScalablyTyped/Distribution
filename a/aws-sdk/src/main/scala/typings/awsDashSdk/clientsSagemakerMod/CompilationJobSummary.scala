...
trait CompilationJobSummary extends js.Object {
  ...
  /**
    ...
    */
  var CompilationJobArn: typings.awsDashSdk.clientsSagemakerMod.CompilationJobArn
  /**
  ...
  /**
    ...
    */
  var CompilationJobStatus: typings.awsDashSdk.clientsSagemakerMod.CompilationJobStatus
  /**
