...
trait RegexMatchTuple extends js.Object {
  /**
    ...
    */
  var FieldToMatch: typings.awsDashSdk.clientsWafregionalMod.FieldToMatch
  /**
  ...
  /**
    ...
    */
  var TextTransformation: typings.awsDashSdk.clientsWafregionalMod.TextTransformation
}
...
object RegexMatchTuple {
  ...
  def apply(FieldToMatch: FieldToMatch, RegexPatternSetId: ResourceId, TextTransformation: TextTransformation): RegexMatchTuple = {
    val __obj = js.Dynamic.literal(FieldToMatch = FieldToMatch, RegexPatternSetId = RegexPatternSetId, TextTransformation = TextTransformation.asInstanceOf[js.Any])
