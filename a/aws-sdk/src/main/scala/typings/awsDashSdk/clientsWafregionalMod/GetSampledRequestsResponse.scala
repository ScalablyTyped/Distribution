...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typings.awsDashSdk.clientsWafregionalMod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typings.awsDashSdk.clientsWafregionalMod.TimeWindow] = js.native
}
