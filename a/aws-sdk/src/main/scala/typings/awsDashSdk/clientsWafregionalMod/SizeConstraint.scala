...
trait SizeConstraint extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typings.awsDashSdk.clientsWafregionalMod.ComparisonOperator
  /**
  ...
  /**
    ...
    */
  var Size: typings.awsDashSdk.clientsWafregionalMod.Size
  /**
...
object SizeConstraint {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ComparisonOperator = ComparisonOperator.asInstanceOf[js.Any], FieldToMatch = FieldToMatch, Size = Size, TextTransformation = TextTransformation.asInstanceOf[js.Any])
