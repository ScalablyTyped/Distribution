...
trait GetMediaOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typings.awsDashSdk.clientsKinesisvideomediaMod.ContentType] = js.undefined
  /**
    ...
    */
  var Payload: js.UndefOr[typings.awsDashSdk.clientsKinesisvideomediaMod.Payload] = js.undefined
}
