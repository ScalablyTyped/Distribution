...
trait GetMediaOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typings.awsDashSdk.clientsKinesisvideomediaMod.ContentType] = js.native
  /**
    ...
    */
  var Payload: js.UndefOr[typings.awsDashSdk.clientsKinesisvideomediaMod.Payload] = js.native
}
