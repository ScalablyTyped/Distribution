...
trait RepositoryAssociation extends js.Object {
  ...
  /**
    ...
    */
  var AssociationId: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.AssociationId] = js.native
  /**
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.Name] = js.native
  /**
    * The owner of the repository.
    */
  var Owner: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.Owner] = js.native
  /**
    * The provider type of the repository association.
    */
  var ProviderType: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.ProviderType] = js.native
  /**
  ...
  /**
    ...
    */
  var StateReason: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.StateReason] = js.native
}
