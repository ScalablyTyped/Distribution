...
trait ListRepositoryAssociationsRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.MaxResults] = js.native
  /**
    * List of names to use as a filter.
    */
  var Names: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.Names] = js.native
  /**
  ...
  /**
    ...
    */
  var Owners: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.Owners] = js.native
  /**
    * List of provider types to use as a filter.
    */
  var ProviderTypes: js.UndefOr[typings.awsDashSdk.clientsCodegurureviewerMod.ProviderTypes] = js.native
  /**
