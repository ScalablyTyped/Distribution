...
trait Voice extends js.Object {
  ...
  /**
    * Gender of the voice.
    */
  var Gender: js.UndefOr[typings.awsDashSdk.clientsPollyMod.Gender] = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageName: js.UndefOr[typings.awsDashSdk.clientsPollyMod.LanguageName] = js.native
  /**
