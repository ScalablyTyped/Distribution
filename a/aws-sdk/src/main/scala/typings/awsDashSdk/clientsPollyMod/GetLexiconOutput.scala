...
trait GetLexiconOutput extends js.Object {
  /**
    ...
    */
  var Lexicon: js.UndefOr[typings.awsDashSdk.clientsPollyMod.Lexicon] = js.native
  /**
    * Metadata of the lexicon, including phonetic alphabetic used, language code, lexicon ARN, number of lexemes defined in the lexicon, and size of lexicon in bytes.
    */
  var LexiconAttributes: js.UndefOr[typings.awsDashSdk.clientsPollyMod.LexiconAttributes] = js.native
}
