...
trait StartSpeechSynthesisTaskInput extends js.Object {
  ...
  /**
    ...
    */
  var OutputS3BucketName: typings.awsDashSdk.clientsPollyMod.OutputS3BucketName = js.native
  /**
    * The Amazon S3 key prefix for the output speech file.
    */
  var OutputS3KeyPrefix: js.UndefOr[typings.awsDashSdk.clientsPollyMod.OutputS3KeyPrefix] = js.native
  /**
