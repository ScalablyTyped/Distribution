...
trait WorkspaceDirectory extends js.Object {
  /**
    * The directory alias.
    */
  var Alias: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.Alias] = js.native
  /**
  ...
  /**
    ...
    */
  var DirectoryName: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.DirectoryName] = js.native
  /**
    * The directory type.
    */
  ...
  /**
    ...
    */
  var DnsIpAddresses: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.DnsIpAddresses] = js.native
  /**
  ...
  /**
    ...
    */
  var RegistrationCode: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.RegistrationCode] = js.native
  /**
    * The default self-service permissions for WorkSpaces in the directory.
    */
  var SelfservicePermissions: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.SelfservicePermissions] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetIds: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.SubnetIds] = js.native
  /**
    ...
    */
  var Tenancy: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.Tenancy] = js.native
  /**
    * The devices and operating systems that users can use to access Workspaces.
    */
  var WorkspaceAccessProperties: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.WorkspaceAccessProperties] = js.native
  /**
