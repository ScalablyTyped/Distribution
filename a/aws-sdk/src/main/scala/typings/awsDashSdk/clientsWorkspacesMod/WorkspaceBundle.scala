...
trait WorkspaceBundle extends js.Object {
  ...
  /**
    ...
    */
  var ComputeType: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.ComputeType] = js.native
  /**
    * A description.
    */
  var Description: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var RootStorage: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.RootStorage] = js.native
  /**
    * The size of the user storage.
    */
  var UserStorage: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.UserStorage] = js.native
}
