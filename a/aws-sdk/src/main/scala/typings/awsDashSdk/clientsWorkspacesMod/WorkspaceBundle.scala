...
trait WorkspaceBundle extends js.Object {
  ...
  /**
    ...
    */
  var ComputeType: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.ComputeType] = js.undefined
  /**
    * A description.
    */
  var Description: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.Description] = js.undefined
  /**
  ...
  /**
    ...
    */
  var RootStorage: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.RootStorage] = js.undefined
  /**
    * The size of the user storage.
    */
  var UserStorage: js.UndefOr[typings.awsDashSdk.clientsWorkspacesMod.UserStorage] = js.undefined
}
