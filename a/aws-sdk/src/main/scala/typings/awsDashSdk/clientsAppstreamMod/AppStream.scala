...
import typings.awsDashSdk.awsDashSdkStrings.fleetStarted
import typings.awsDashSdk.awsDashSdkStrings.fleetStopped
...
trait AppStream extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_fleetStarted(state: fleetStarted, params: DescribeFleetsRequest with Anon_Waiter): Request[DescribeFleetsResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_fleetStarted(
    state: fleetStarted,
    params: DescribeFleetsRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetsResult, Unit]
  ): Request[DescribeFleetsResult, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_fleetStopped(state: fleetStopped, params: DescribeFleetsRequest with Anon_Waiter): Request[DescribeFleetsResult, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_fleetStopped(
    state: fleetStopped,
    params: DescribeFleetsRequest with Anon_Waiter,
