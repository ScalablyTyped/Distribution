...
trait VPC extends js.Object {
  var VPCId: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.VPCId] = js.undefined
  /**
    * (Private hosted zones only) The region that an Amazon VPC was created in.
    */
  var VPCRegion: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.VPCRegion] = js.undefined
}
