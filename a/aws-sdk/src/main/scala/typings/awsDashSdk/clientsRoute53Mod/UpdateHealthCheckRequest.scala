...
trait UpdateHealthCheckRequest extends js.Object {
  /**
    ...
    */
  var AlarmIdentifier: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.AlarmIdentifier] = js.undefined
  /**
  ...
  /**
    ...
    */
  var Disabled: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.Disabled] = js.undefined
  /**
    ...
    */
  var EnableSNI: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.EnableSNI] = js.undefined
  /**
    ...
    */
  var FailureThreshold: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.FailureThreshold] = js.undefined
  /**
    ...
    */
  var FullyQualifiedDomainName: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.FullyQualifiedDomainName] = js.undefined
  /**
  ...
  /**
    ...
    */
  var HealthCheckVersion: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.HealthCheckVersion] = js.undefined
  /**
    ...
    */
  var HealthThreshold: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.HealthThreshold] = js.undefined
  /**
  ...
  /**
    ...
    */
  var InsufficientDataHealthStatus: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.InsufficientDataHealthStatus] = js.undefined
  /**
    * Specify whether you want Amazon Route 53 to invert the status of a health check, for example, to consider a health check unhealthy when it otherwise would be considered healthy.
    */
  var Inverted: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.Inverted] = js.undefined
  /**
    * The port on the endpoint on which you want Amazon Route 53 to perform health checks.
    */
  var Port: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.Port] = js.undefined
  /**
  ...
  /**
    ...
    */
  var ResourcePath: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.ResourcePath] = js.undefined
  /**
    ...
    */
  var SearchString: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.SearchString] = js.undefined
}
...
object UpdateHealthCheckRequest {
  ...
  def apply(
    ...
    if (AlarmIdentifier != null) __obj.updateDynamic("AlarmIdentifier")(AlarmIdentifier)
    if (ChildHealthChecks != null) __obj.updateDynamic("ChildHealthChecks")(ChildHealthChecks)
    if (!js.isUndefined(Disabled)) __obj.updateDynamic("Disabled")(Disabled)
    if (!js.isUndefined(EnableSNI)) __obj.updateDynamic("EnableSNI")(EnableSNI)
    if (!js.isUndefined(FailureThreshold)) __obj.updateDynamic("FailureThreshold")(FailureThreshold)
    if (FullyQualifiedDomainName != null) __obj.updateDynamic("FullyQualifiedDomainName")(FullyQualifiedDomainName)
    if (!js.isUndefined(HealthCheckVersion)) __obj.updateDynamic("HealthCheckVersion")(HealthCheckVersion)
    if (!js.isUndefined(HealthThreshold)) __obj.updateDynamic("HealthThreshold")(HealthThreshold)
    ...
    if (ResetElements != null) __obj.updateDynamic("ResetElements")(ResetElements)
