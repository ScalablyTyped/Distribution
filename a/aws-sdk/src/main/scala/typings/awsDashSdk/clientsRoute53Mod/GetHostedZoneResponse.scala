...
trait GetHostedZoneResponse extends js.Object {
  /**
    ...
    */
  var DelegationSet: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.DelegationSet] = js.native
  /**
  ...
  /**
    ...
    */
  var VPCs: js.UndefOr[typings.awsDashSdk.clientsRoute53Mod.VPCs] = js.native
}
