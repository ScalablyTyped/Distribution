...
import typings.awsDashSdk.awsDashSdkStrings.resourceRecordSetsChanged
...
trait Route53 extends Service {
  @JSName("config")
  var config_Route53: ConfigBase with ClientConfiguration = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_resourceRecordSetsChanged(state: resourceRecordSetsChanged, params: GetChangeRequest with Anon_Waiter): Request[GetChangeResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_resourceRecordSetsChanged(
    state: resourceRecordSetsChanged,
    params: GetChangeRequest with Anon_Waiter,
    callback: js.Function2[/* err */ AWSError, /* data */ GetChangeResponse, Unit]
  ): Request[GetChangeResponse, AWSError] = js.native
}
