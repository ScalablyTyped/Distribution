...
trait Cluster extends StObject {
  ...
  /**
    ...
    */
  var OSReleaseLabel: js.UndefOr[String] = js.undefined
...
object Cluster {
  ...
  extension [Self <: Cluster](x: Self) {
    ...
    inline def setOSReleaseLabel(value: String): Self = StObject.set(x, "OSReleaseLabel", value.asInstanceOf[js.Any])
    ...
    inline def setPlacementGroupsVarargs(value: PlacementGroupConfig*): Self = StObject.set(x, "PlacementGroups", js.Array(value*))
