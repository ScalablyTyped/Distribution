...
trait GetServiceNetworkResponse extends StObject {
...
object GetServiceNetworkResponse {
  ...
  inline def apply(): GetServiceNetworkResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetServiceNetworkResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetServiceNetworkResponse] (val x: Self) extends AnyVal {
