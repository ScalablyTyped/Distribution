...
trait GetListenerResponse extends StObject {
...
object GetListenerResponse {
  ...
  inline def apply(): GetListenerResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetListenerResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetListenerResponse] (val x: Self) extends AnyVal {
