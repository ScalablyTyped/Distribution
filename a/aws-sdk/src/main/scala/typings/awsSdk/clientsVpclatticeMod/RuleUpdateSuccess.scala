...
trait RuleUpdateSuccess extends StObject {
...
object RuleUpdateSuccess {
  
  inline def apply(): RuleUpdateSuccess = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RuleUpdateSuccess]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RuleUpdateSuccess] (val x: Self) extends AnyVal {
