...
trait CreateServiceNetworkResponse extends StObject {
...
object CreateServiceNetworkResponse {
  
  inline def apply(): CreateServiceNetworkResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateServiceNetworkResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateServiceNetworkResponse] (val x: Self) extends AnyVal {
