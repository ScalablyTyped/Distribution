...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.awsSdk.awsSdkStrings.STOPPED
  - typings.awsSdk.awsSdkStrings.STOP_ERROR
  - typings.awsSdk.awsSdkStrings.REMOVAL_FAILED
  - typings.awsSdk.awsSdkStrings.REMOVAL_IN_PROGRESS
  - typings.awsSdk.awsSdkStrings.STARTING
  - typings.awsSdk.awsSdkStrings.RUNNING
  - typings.awsSdk.awsSdkStrings.INSTALL_ERROR
  - typings.awsSdk.awsSdkStrings.LAUNCHED
  - typings.awsSdk.awsSdkStrings.LAUNCH_ERROR
  - typings.awsSdk.awsSdkStrings.INSTALL_IN_PROGRESS
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.OTA
  - typings.awsSdk.awsSdkStrings.REBOOT
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.PAUSE
