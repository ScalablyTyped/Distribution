...
trait EthernetPayload extends StObject {
  ...
  /**
    ...
    */
  var ConnectionType: typings.awsSdk.clientsPanoramaMod.ConnectionType
  
  /**
    * Network configuration for a static IP connection.
    */
  var StaticIpConnectionInfo: js.UndefOr[typings.awsSdk.clientsPanoramaMod.StaticIpConnectionInfo] = js.undefined
}
object EthernetPayload {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EthernetPayload] (val x: Self) extends AnyVal {
