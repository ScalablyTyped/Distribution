...
trait NodeFromTemplateJob extends StObject {
  ...
  /**
    ...
    */
  var TemplateType: js.UndefOr[typings.awsSdk.clientsPanoramaMod.TemplateType] = js.undefined
}
object NodeFromTemplateJob {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NodeFromTemplateJob] (val x: Self) extends AnyVal {
