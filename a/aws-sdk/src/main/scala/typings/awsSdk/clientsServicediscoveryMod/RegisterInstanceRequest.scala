...
trait RegisterInstanceRequest extends StObject {
  ...
  /**
    ...
    */
  var Attributes: typings.awsSdk.clientsServicediscoveryMod.Attributes
  ...
  /**
    ...
    */
  var InstanceId: typings.awsSdk.clientsServicediscoveryMod.InstanceId
...
object RegisterInstanceRequest {
  ...
  inline def apply(Attributes: Attributes, InstanceId: InstanceId, ServiceId: ResourceId): RegisterInstanceRequest = {
