...
trait HttpInstanceSummary extends StObject {
  ...
  /**
    ...
    */
  var HealthStatus: js.UndefOr[typings.awsSdk.clientsServicediscoveryMod.HealthStatus] = js.undefined
  ...
  /**
    ...
    */
  var ServiceName: js.UndefOr[typings.awsSdk.clientsServicediscoveryMod.ServiceName] = js.undefined
}
