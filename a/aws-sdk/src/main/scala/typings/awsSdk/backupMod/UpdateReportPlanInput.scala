...
trait UpdateReportPlanInput extends StObject {
  ...
  /**
    ...
    */
  var ReportDeliveryChannel: js.UndefOr[typings.awsSdk.backupMod.ReportDeliveryChannel] = js.undefined
  ...
  /**
    ...
    */
  var ReportSetting: js.UndefOr[typings.awsSdk.backupMod.ReportSetting] = js.undefined
}
object UpdateReportPlanInput {
  ...
  extension [Self <: UpdateReportPlanInput](x: Self) {
