...
object ListBackupPlanTemplatesInput {
  ...
  @scala.inline
  def apply(): ListBackupPlanTemplatesInput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListBackupPlanTemplatesInput]
  }
  
  @scala.inline
  implicit class ListBackupPlanTemplatesInputMutableBuilder[Self <: ListBackupPlanTemplatesInput] (val x: Self) extends AnyVal {
