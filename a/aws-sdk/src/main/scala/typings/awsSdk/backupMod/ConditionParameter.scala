...
trait ConditionParameter extends StObject {
  ...
  /**
    ...
    */
  var ConditionKey: js.UndefOr[typings.awsSdk.backupMod.ConditionKey] = js.undefined
  
  /**
    * The value in a key-value pair. For example, in the tag Department: Accounting, Accounting is the value.
    */
  var ConditionValue: js.UndefOr[typings.awsSdk.backupMod.ConditionValue] = js.undefined
}
