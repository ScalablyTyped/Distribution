...
trait CreateFrameworkInput extends StObject {
  ...
  /**
    ...
    */
  var FrameworkControls: typings.awsSdk.backupMod.FrameworkControls
  
  /**
    * An optional description of the framework with a maximum of 1,024 characters.
    */
  var FrameworkDescription: js.UndefOr[typings.awsSdk.backupMod.FrameworkDescription] = js.undefined
