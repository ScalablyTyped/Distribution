...
trait RecommendationJobResourceLimit extends StObject {
  ...
  /**
    ...
    */
  var MaxNumberOfTests: js.UndefOr[typings.awsSdk.sagemakerMod.MaxNumberOfTests] = js.undefined
  
  /**
    * Defines the maximum number of parallel load tests.
    */
  var MaxParallelOfTests: js.UndefOr[typings.awsSdk.sagemakerMod.MaxParallelOfTests] = js.undefined
}
