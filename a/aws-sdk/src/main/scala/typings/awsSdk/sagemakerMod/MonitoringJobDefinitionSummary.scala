...
trait MonitoringJobDefinitionSummary extends StObject {
  ...
  /**
    ...
    */
  var MonitoringJobDefinitionArn: typings.awsSdk.sagemakerMod.MonitoringJobDefinitionArn
  
  /**
    * The name of the monitoring job.
    */
  var MonitoringJobDefinitionName: typings.awsSdk.sagemakerMod.MonitoringJobDefinitionName
}
