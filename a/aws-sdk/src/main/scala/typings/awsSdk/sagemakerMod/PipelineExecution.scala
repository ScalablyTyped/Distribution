...
trait PipelineExecution extends StObject {
  ...
  /**
    ...
    */
  var PipelineExecutionStatus: js.UndefOr[typings.awsSdk.sagemakerMod.PipelineExecutionStatus] = js.undefined
  
  var PipelineExperimentConfig: js.UndefOr[typings.awsSdk.sagemakerMod.PipelineExperimentConfig] = js.undefined
