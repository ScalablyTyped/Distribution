...
trait HumanTaskConfig extends js.Object {
  /**
    ...
    */
  var AnnotationConsolidationConfig: typings.awsSdk.sagemakerMod.AnnotationConsolidationConfig = js.native
  /**
    ...
    */
  var MaxConcurrentTaskCount: js.UndefOr[typings.awsSdk.sagemakerMod.MaxConcurrentTaskCount] = js.native
  /**
    * The number of human workers that will label an object. 
    */
  var NumberOfHumanWorkersPerDataObject: typings.awsSdk.sagemakerMod.NumberOfHumanWorkersPerDataObject = js.native
  /**
  ...
  /**
    ...
    */
  var TaskAvailabilityLifetimeInSeconds: js.UndefOr[typings.awsSdk.sagemakerMod.TaskAvailabilityLifetimeInSeconds] = js.native
  /**
    * A description of the task for your human workers.
    */
  var TaskDescription: typings.awsSdk.sagemakerMod.TaskDescription = js.native
  /**
    * Keywords used to describe the task so that workers on Amazon Mechanical Turk can discover the task.
    */
  var TaskKeywords: js.UndefOr[typings.awsSdk.sagemakerMod.TaskKeywords] = js.native
  /**
    * The amount of time that a worker has to complete a task.
    */
  var TaskTimeLimitInSeconds: typings.awsSdk.sagemakerMod.TaskTimeLimitInSeconds = js.native
  /**
    * A title for the task for your human workers.
    */
  var TaskTitle: typings.awsSdk.sagemakerMod.TaskTitle = js.native
  /**
    * Information about the user interface that workers use to complete the labeling task.
    */
  var UiConfig: typings.awsSdk.sagemakerMod.UiConfig = js.native
  /**
