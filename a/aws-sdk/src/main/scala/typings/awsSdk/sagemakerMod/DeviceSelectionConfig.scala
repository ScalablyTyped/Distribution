...
trait DeviceSelectionConfig extends StObject {
  ...
  /**
    ...
    */
  var DeviceNames: js.UndefOr[typings.awsSdk.sagemakerMod.DeviceNames] = js.undefined
  
  /**
    * Type of device subsets to deploy to the current stage.
    */
  var DeviceSubsetType: typings.awsSdk.sagemakerMod.DeviceSubsetType
  
  /**
    * Percentage of devices in the fleet to deploy to the current stage.
    */
  var Percentage: js.UndefOr[typings.awsSdk.sagemakerMod.Percentage] = js.undefined
}
