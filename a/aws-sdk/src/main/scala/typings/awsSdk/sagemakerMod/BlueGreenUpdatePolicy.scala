...
trait BlueGreenUpdatePolicy extends StObject {
  ...
  /**
    ...
    */
  var MaximumExecutionTimeoutInSeconds: js.UndefOr[typings.awsSdk.sagemakerMod.MaximumExecutionTimeoutInSeconds] = js.undefined
  
  /**
    * Additional waiting time in seconds after the completion of an endpoint deployment before terminating the old endpoint fleet. Default is 0.
    */
  var TerminationWaitInSeconds: js.UndefOr[typings.awsSdk.sagemakerMod.TerminationWaitInSeconds] = js.undefined
