...
trait DescribeModelExplainabilityJobDefinitionResponse extends StObject {
  ...
  /**
    ...
    */
  var ModelExplainabilityAppSpecification: typings.awsSdk.sagemakerMod.ModelExplainabilityAppSpecification
  
  /**
    * The baseline configuration for a model explainability job.
    */
  var ModelExplainabilityBaselineConfig: js.UndefOr[typings.awsSdk.sagemakerMod.ModelExplainabilityBaselineConfig] = js.undefined
  
  /**
    * Inputs for the model explainability job.
    */
  var ModelExplainabilityJobInput: typings.awsSdk.sagemakerMod.ModelExplainabilityJobInput
