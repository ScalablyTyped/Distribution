...
trait S3DataSource extends StObject {
  ...
  /**
    ...
    */
  var AttributeNames: js.UndefOr[typings.awsSdk.sagemakerMod.AttributeNames] = js.undefined
  
  /**
    * A list of names of instance groups that get data from the S3 data source.
    */
  var InstanceGroupNames: js.UndefOr[typings.awsSdk.sagemakerMod.InstanceGroupNames] = js.undefined
