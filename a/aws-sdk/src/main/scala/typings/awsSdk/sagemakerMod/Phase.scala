...
trait Phase extends StObject {
  ...
  /**
    ...
    */
  var InitialNumberOfUsers: js.UndefOr[typings.awsSdk.sagemakerMod.InitialNumberOfUsers] = js.undefined
  
  /**
    * Specified how many new users to spawn in a minute.
    */
  var SpawnRate: js.UndefOr[typings.awsSdk.sagemakerMod.SpawnRate] = js.undefined
}
object Phase {
