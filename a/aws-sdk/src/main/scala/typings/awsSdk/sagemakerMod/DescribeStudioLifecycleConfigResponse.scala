...
trait DescribeStudioLifecycleConfigResponse extends StObject {
  ...
  /**
    ...
    */
  var StudioLifecycleConfigAppType: js.UndefOr[typings.awsSdk.sagemakerMod.StudioLifecycleConfigAppType] = js.undefined
  ...
  /**
    ...
    */
  var StudioLifecycleConfigContent: js.UndefOr[typings.awsSdk.sagemakerMod.StudioLifecycleConfigContent] = js.undefined
  
  /**
    * The name of the Studio Lifecycle Configuration that is described.
    */
  var StudioLifecycleConfigName: js.UndefOr[typings.awsSdk.sagemakerMod.StudioLifecycleConfigName] = js.undefined
}
