...
trait DescribeModelBiasJobDefinitionResponse extends StObject {
  ...
  /**
    ...
    */
  var ModelBiasAppSpecification: typings.awsSdk.sagemakerMod.ModelBiasAppSpecification
  
  /**
    * The baseline configuration for a model bias job.
    */
  var ModelBiasBaselineConfig: js.UndefOr[typings.awsSdk.sagemakerMod.ModelBiasBaselineConfig] = js.undefined
  
  /**
    * Inputs for the model bias job.
    */
  var ModelBiasJobInput: typings.awsSdk.sagemakerMod.ModelBiasJobInput
