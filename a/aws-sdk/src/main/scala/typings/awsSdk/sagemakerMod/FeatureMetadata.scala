...
trait FeatureMetadata extends StObject {
  ...
  /**
    ...
    */
  var FeatureGroupArn: js.UndefOr[typings.awsSdk.sagemakerMod.FeatureGroupArn] = js.undefined
  
  /**
    * The name of the feature group containing the feature.
    */
  var FeatureGroupName: js.UndefOr[typings.awsSdk.sagemakerMod.FeatureGroupName] = js.undefined
