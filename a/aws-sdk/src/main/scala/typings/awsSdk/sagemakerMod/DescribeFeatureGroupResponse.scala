...
trait DescribeFeatureGroupResponse extends StObject {
  ...
  /**
    ...
    */
  var FeatureGroupStatus: js.UndefOr[typings.awsSdk.sagemakerMod.FeatureGroupStatus] = js.undefined
  ...
  /**
    ...
    */
  var LastUpdateStatus: js.UndefOr[typings.awsSdk.sagemakerMod.LastUpdateStatus] = js.undefined
  
  /**
    * A token to resume pagination of the list of Features (FeatureDefinitions).
    */
  var NextToken: typings.awsSdk.sagemakerMod.NextToken
  ...
  /**
    ...
    */
  var OfflineStoreStatus: js.UndefOr[typings.awsSdk.sagemakerMod.OfflineStoreStatus] = js.undefined
  ...
  /**
    ...
    */
  var OnlineStoreTotalSizeBytes: js.UndefOr[typings.awsSdk.sagemakerMod.OnlineStoreTotalSizeBytes] = js.undefined
