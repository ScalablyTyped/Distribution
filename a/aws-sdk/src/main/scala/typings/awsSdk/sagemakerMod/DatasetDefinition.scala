...
trait DatasetDefinition extends StObject {
  ...
  var AthenaDatasetDefinition: js.UndefOr[typings.awsSdk.sagemakerMod.AthenaDatasetDefinition] = js.undefined
  
  /**
    * Whether the generated dataset is FullyReplicated or ShardedByS3Key (default).
    */
  var DataDistributionType: js.UndefOr[typings.awsSdk.sagemakerMod.DataDistributionType] = js.undefined
  
  /**
    * Whether to use File or Pipe input mode. In File (default) mode, Amazon SageMaker copies the data from the input source onto the local Amazon Elastic Block Store (Amazon EBS) volumes before starting your training algorithm. This is the most commonly used input mode. In Pipe mode, Amazon SageMaker streams input data from the source directly to your algorithm without using the EBS volume.
    */
  var InputMode: js.UndefOr[typings.awsSdk.sagemakerMod.InputMode] = js.undefined
  ...
  var RedshiftDatasetDefinition: js.UndefOr[typings.awsSdk.sagemakerMod.RedshiftDatasetDefinition] = js.undefined
}
object DatasetDefinition {
  ...
  extension [Self <: DatasetDefinition](x: Self) {
