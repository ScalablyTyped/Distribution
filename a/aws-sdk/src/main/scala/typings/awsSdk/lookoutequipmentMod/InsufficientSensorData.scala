...
trait InsufficientSensorData extends StObject {
  ...
  /**
    ...
    */
  var MissingCompleteSensorData: typings.awsSdk.lookoutequipmentMod.MissingCompleteSensorData
  
  /**
    *  Parameter that describes the total number of sensors that have a short date range of less than 90 days of data overall. 
    */
  var SensorsWithShortDateRange: typings.awsSdk.lookoutequipmentMod.SensorsWithShortDateRange
}
