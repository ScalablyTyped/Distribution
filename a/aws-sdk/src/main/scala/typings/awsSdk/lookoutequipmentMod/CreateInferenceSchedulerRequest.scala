...
trait CreateInferenceSchedulerRequest extends StObject {
  ...
  /**
    ...
    */
  var DataUploadFrequency: typings.awsSdk.lookoutequipmentMod.DataUploadFrequency
  
  /**
    * The name of the inference scheduler being created. 
    */
  var InferenceSchedulerName: typings.awsSdk.lookoutequipmentMod.InferenceSchedulerName
