...
trait DataQualitySummary extends StObject {
  ...
  /**
    ...
    */
  var DuplicateTimestamps: typings.awsSdk.lookoutequipmentMod.DuplicateTimestamps
  ...
  /**
    ...
    */
  var InsufficientSensorData: typings.awsSdk.lookoutequipmentMod.InsufficientSensorData
  
  /**
    *  Parameter that gives information about data that is invalid over all the sensors in the input data. 
    */
  var InvalidSensorData: typings.awsSdk.lookoutequipmentMod.InvalidSensorData
  
  /**
    *  Parameter that gives information about data that is missing over all the sensors in the input data. 
    */
  var MissingSensorData: typings.awsSdk.lookoutequipmentMod.MissingSensorData
  
  /**
    *  Parameter that gives information about unsupported timestamps in the input data. 
    */
  var UnsupportedTimestamps: typings.awsSdk.lookoutequipmentMod.UnsupportedTimestamps
}
