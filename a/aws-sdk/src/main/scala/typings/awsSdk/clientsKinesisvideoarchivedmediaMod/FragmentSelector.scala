...
trait FragmentSelector extends StObject {
  ...
  /**
    ...
    */
  var FragmentSelectorType: typings.awsSdk.clientsKinesisvideoarchivedmediaMod.FragmentSelectorType
  
  /**
    * The range of timestamps to return.
    */
  var TimestampRange: typings.awsSdk.clientsKinesisvideoarchivedmediaMod.TimestampRange
}
