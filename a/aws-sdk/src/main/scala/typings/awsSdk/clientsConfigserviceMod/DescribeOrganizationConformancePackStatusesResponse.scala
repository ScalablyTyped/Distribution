...
trait DescribeOrganizationConformancePackStatusesResponse extends StObject {
  ...
  /**
    ...
    */
  var OrganizationConformancePackStatuses: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.OrganizationConformancePackStatuses] = js.undefined
}
object DescribeOrganizationConformancePackStatusesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeOrganizationConformancePackStatusesResponse] (val x: Self) extends AnyVal {
