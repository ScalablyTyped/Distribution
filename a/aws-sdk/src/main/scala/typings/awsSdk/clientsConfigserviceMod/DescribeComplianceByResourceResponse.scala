...
trait DescribeComplianceByResourceResponse extends StObject {
  ...
  /**
    ...
    */
  var ComplianceByResources: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.ComplianceByResources] = js.undefined
...
object DescribeComplianceByResourceResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeComplianceByResourceResponse] (val x: Self) extends AnyVal {
