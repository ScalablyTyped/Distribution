...
trait ConfigService extends Service {
  ...
  /**
    ...
    */
  def getResourceEvaluationSummary(): Request[GetResourceEvaluationSummaryResponse, AWSError] = js.native
  def getResourceEvaluationSummary(callback: js.Function2[/* err */ AWSError, /* data */ GetResourceEvaluationSummaryResponse, Unit]): Request[GetResourceEvaluationSummaryResponse, AWSError] = js.native
  /**
    * Returns a summary of resource evaluation for the specified resource evaluation ID from the proactive rules that were run. The results indicate which evaluation context was used to evaluate the rules, which resource details were evaluated, the evaluation mode that was run, and whether the resource details comply with the configuration of the proactive rules.   To see additional information about the evaluation result, such as which rule flagged a resource as NON_COMPLIANT, use the GetComplianceDetailsByResource API. For more information, see the Examples section. 
    */
  def getResourceEvaluationSummary(params: GetResourceEvaluationSummaryRequest): Request[GetResourceEvaluationSummaryResponse, AWSError] = js.native
  def getResourceEvaluationSummary(
    params: GetResourceEvaluationSummaryRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ GetResourceEvaluationSummaryResponse, Unit]
  ): Request[GetResourceEvaluationSummaryResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def listResourceEvaluations(): Request[ListResourceEvaluationsResponse, AWSError] = js.native
  def listResourceEvaluations(callback: js.Function2[/* err */ AWSError, /* data */ ListResourceEvaluationsResponse, Unit]): Request[ListResourceEvaluationsResponse, AWSError] = js.native
  /**
    * Returns a list of proactive resource evaluations.
    */
  def listResourceEvaluations(params: ListResourceEvaluationsRequest): Request[ListResourceEvaluationsResponse, AWSError] = js.native
  def listResourceEvaluations(
    params: ListResourceEvaluationsRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ ListResourceEvaluationsResponse, Unit]
  ): Request[ListResourceEvaluationsResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def startResourceEvaluation(): Request[StartResourceEvaluationResponse, AWSError] = js.native
  def startResourceEvaluation(callback: js.Function2[/* err */ AWSError, /* data */ StartResourceEvaluationResponse, Unit]): Request[StartResourceEvaluationResponse, AWSError] = js.native
  /**
    * Runs an on-demand evaluation for the specified resource to determine whether the resource details will comply with configured Config rules. You can also use it for evaluation purposes. Config recommends using an evaluation context. It runs an execution against the resource details with all of the Config rules in your account that match with the specified proactive mode and resource type.  Ensure you have the cloudformation:DescribeType role setup to validate the resource type schema. You can find the Resource type schema in "Amazon Web Services public extensions" within the CloudFormation registry or with the following CLI commmand: aws cloudformation describe-type --type-name "AWS::S3::Bucket" --type RESOURCE. For more information, see Managing extensions through the CloudFormation registry and Amazon Web Services resource and property types reference in the CloudFormation User Guide. 
    */
  def startResourceEvaluation(params: StartResourceEvaluationRequest): Request[StartResourceEvaluationResponse, AWSError] = js.native
  def startResourceEvaluation(
    params: StartResourceEvaluationRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ StartResourceEvaluationResponse, Unit]
  ): Request[StartResourceEvaluationResponse, AWSError] = js.native
