...
trait DescribeConfigurationAggregatorSourcesStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var AggregatedSourceStatusList: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.AggregatedSourceStatusList] = js.undefined
...
object DescribeConfigurationAggregatorSourcesStatusResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeConfigurationAggregatorSourcesStatusResponse] (val x: Self) extends AnyVal {
