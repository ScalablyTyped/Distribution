...
trait GetAggregateComplianceDetailsByConfigRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var AwsRegion: typings.awsSdk.clientsConfigserviceMod.AwsRegion
...
object GetAggregateComplianceDetailsByConfigRuleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetAggregateComplianceDetailsByConfigRuleRequest] (val x: Self) extends AnyVal {
