...
trait StartRemediationExecutionRequest extends StObject {
  ...
  /**
    ...
    */
  var ResourceKeys: typings.awsSdk.clientsConfigserviceMod.ResourceKeys
}
object StartRemediationExecutionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StartRemediationExecutionRequest] (val x: Self) extends AnyVal {
