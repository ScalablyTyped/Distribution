...
trait ResourceFilters extends StObject {
  ...
  /**
    ...
    */
  var ResourceId: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.ResourceId] = js.undefined
...
object ResourceFilters {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceFilters] (val x: Self) extends AnyVal {
