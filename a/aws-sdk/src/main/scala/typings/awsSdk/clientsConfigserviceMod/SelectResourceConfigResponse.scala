...
trait SelectResourceConfigResponse extends StObject {
  ...
  /**
    ...
    */
  var QueryInfo: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.QueryInfo] = js.undefined
  
  /**
    * Returns the results for the SQL query.
    */
  var Results: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.Results] = js.undefined
}
object SelectResourceConfigResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SelectResourceConfigResponse] (val x: Self) extends AnyVal {
