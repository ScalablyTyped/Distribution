...
trait GetOrganizationConfigRuleDetailedStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var OrganizationConfigRuleDetailedStatus: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.OrganizationConfigRuleDetailedStatus] = js.undefined
}
object GetOrganizationConfigRuleDetailedStatusResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetOrganizationConfigRuleDetailedStatusResponse] (val x: Self) extends AnyVal {
