...
trait SourceDetail extends StObject {
  ...
  /**
    ...
    */
  var EventSource: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.EventSource] = js.undefined
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.MessageType] = js.undefined
}
object SourceDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SourceDetail] (val x: Self) extends AnyVal {
