...
trait ConfigRule extends StObject {
  ...
  /**
    ...
    */
  var ConfigRuleState: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.ConfigRuleState] = js.undefined
  ...
  /**
    ...
    */
  var Scope: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.Scope] = js.undefined
  ...
  /**
    ...
    */
  var Source: typings.awsSdk.clientsConfigserviceMod.Source
}
object ConfigRule {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ConfigRule] (val x: Self) extends AnyVal {
