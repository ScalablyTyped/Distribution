...
trait MemberAccountStatus extends StObject {
  ...
  /**
    ...
    */
  var MemberAccountRuleStatus: typings.awsSdk.clientsConfigserviceMod.MemberAccountRuleStatus
}
object MemberAccountStatus {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MemberAccountStatus] (val x: Self) extends AnyVal {
