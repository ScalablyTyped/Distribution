...
trait DescribeOrganizationConformancePacksResponse extends StObject {
  ...
  /**
    ...
    */
  var OrganizationConformancePacks: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.OrganizationConformancePacks] = js.undefined
}
object DescribeOrganizationConformancePacksResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeOrganizationConformancePacksResponse] (val x: Self) extends AnyVal {
