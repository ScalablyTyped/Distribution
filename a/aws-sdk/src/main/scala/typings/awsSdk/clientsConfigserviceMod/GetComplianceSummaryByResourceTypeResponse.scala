...
trait GetComplianceSummaryByResourceTypeResponse extends StObject {
  ...
  /**
    ...
    */
  var ComplianceSummariesByResourceType: js.UndefOr[typings.awsSdk.clientsConfigserviceMod.ComplianceSummariesByResourceType] = js.undefined
}
object GetComplianceSummaryByResourceTypeResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetComplianceSummaryByResourceTypeResponse] (val x: Self) extends AnyVal {
