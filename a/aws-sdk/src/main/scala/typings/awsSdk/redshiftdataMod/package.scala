...
package object redshiftdataMod {
  ...
  type ClientConfiguration = typings.awsSdk.serviceMod.ServiceConfigurationOptions with typings.awsSdk.redshiftdataMod.ClientApiVersions
