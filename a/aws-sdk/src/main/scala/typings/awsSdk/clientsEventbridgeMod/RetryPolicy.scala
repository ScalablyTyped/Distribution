...
trait RetryPolicy extends StObject {
  ...
  /**
    ...
    */
  var MaximumEventAgeInSeconds: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.MaximumEventAgeInSeconds] = js.undefined
  
  /**
    * The maximum number of retry attempts to make before the request fails. Retry attempts continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is met.
    */
  var MaximumRetryAttempts: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.MaximumRetryAttempts] = js.undefined
}
object RetryPolicy {
