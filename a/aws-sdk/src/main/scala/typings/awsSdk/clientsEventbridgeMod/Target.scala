...
trait Target extends StObject {
  ...
  /**
    ...
    */
  var BatchParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.BatchParameters] = js.undefined
  
  /**
    * The DeadLetterConfig that defines the target queue to send dead-letter queue events to.
    */
  var DeadLetterConfig: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.DeadLetterConfig] = js.undefined
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.InputTransformer] = js.undefined
  
  /**
    * The custom parameter you can use to control the shard assignment, when the target is a Kinesis data stream. If you do not include this parameter, the default is to use the eventId as the partition key.
    */
  var KinesisParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.KinesisParameters] = js.undefined
  ...
  /**
    ...
    */
  var RedshiftDataParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.RedshiftDataParameters] = js.undefined
  
  /**
    * The RetryPolicy object that contains the retry policy configuration to use for the dead-letter queue.
    */
  var RetryPolicy: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.RetryPolicy] = js.undefined
  ...
  /**
    ...
    */
  var RunCommandParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.RunCommandParameters] = js.undefined
  ...
  /**
    ...
    */
  var SageMakerPipelineParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.SageMakerPipelineParameters] = js.undefined
  
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typings.awsSdk.clientsEventbridgeMod.SqsParameters] = js.undefined
}
object Target {
