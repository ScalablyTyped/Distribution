...
trait PostTextResponse extends StObject {
  ...
  /**
    ...
    */
  var alternativeIntents: js.UndefOr[IntentList] = js.native
...
object PostTextResponse {
  ...
  @scala.inline
  implicit class PostTextResponseMutableBuilder[Self <: PostTextResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativeIntents(value: IntentList): Self = StObject.set(x, "alternativeIntents", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setAlternativeIntentsUndefined: Self = StObject.set(x, "alternativeIntents", js.undefined)
    
    @scala.inline
    def setAlternativeIntentsVarargs(value: PredictedIntent*): Self = StObject.set(x, "alternativeIntents", js.Array(value :_*))
    ...
    @scala.inline
    def setSentimentResponse(value: SentimentResponse): Self = StObject.set(x, "sentimentResponse", value.asInstanceOf[js.Any])
