...
object PostTextResponse {
  ...
  implicit class PostTextResponseOps[Self <: PostTextResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAlternativeIntentsVarargs(value: PredictedIntent*): Self = this.set("alternativeIntents", js.Array(value :_*))
    
    @scala.inline
    def setAlternativeIntents(value: IntentList): Self = this.set("alternativeIntents", value.asInstanceOf[js.Any])
