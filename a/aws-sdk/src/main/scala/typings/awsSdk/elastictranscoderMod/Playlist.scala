...
trait Playlist extends StObject {
  ...
  /**
    ...
    */
  var HlsContentProtection: js.UndefOr[typings.awsSdk.elastictranscoderMod.HlsContentProtection] = js.undefined
  ...
  /**
    ...
    */
  var OutputKeys: js.UndefOr[typings.awsSdk.elastictranscoderMod.OutputKeys] = js.undefined
  
  /**
    * The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
    */
  var PlayReadyDrm: js.UndefOr[typings.awsSdk.elastictranscoderMod.PlayReadyDrm] = js.undefined
