...
trait PipelineOutputConfig extends StObject {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typings.awsSdk.elastictranscoderMod.Permissions] = js.undefined
  ...
  /**
    ...
    */
  var StorageClass: js.UndefOr[typings.awsSdk.elastictranscoderMod.StorageClass] = js.undefined
}
object PipelineOutputConfig {
  ...
  @scala.inline
  implicit class PipelineOutputConfigMutableBuilder[Self <: PipelineOutputConfig] (val x: Self) extends AnyVal {
