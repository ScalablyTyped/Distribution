...
object ProvisionPermissionSetRequest {
  ...
  @scala.inline
  implicit class ProvisionPermissionSetRequestOps[Self <: ProvisionPermissionSetRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTargetType(value: ProvisionTargetType): Self = this.set("TargetType", value.asInstanceOf[js.Any])
