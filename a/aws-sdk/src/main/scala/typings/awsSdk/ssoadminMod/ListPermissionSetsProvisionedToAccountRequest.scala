...
trait ListPermissionSetsProvisionedToAccountRequest extends StObject {
  ...
  /**
    ...
    */
  var AccountId: typings.awsSdk.ssoadminMod.AccountId
  ...
  /**
    ...
    */
  var ProvisioningStatus: js.UndefOr[typings.awsSdk.ssoadminMod.ProvisioningStatus] = js.undefined
}
object ListPermissionSetsProvisionedToAccountRequest {
  ...
  extension [Self <: ListPermissionSetsProvisionedToAccountRequest](x: Self) {
