...
trait DescribeCompanyNetworkConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typings.awsSdk.clientsWorklinkMod.SecurityGroupIds] = js.undefined
  
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: js.UndefOr[typings.awsSdk.clientsWorklinkMod.SubnetIds] = js.undefined
  
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: js.UndefOr[typings.awsSdk.clientsWorklinkMod.VpcId] = js.undefined
}
