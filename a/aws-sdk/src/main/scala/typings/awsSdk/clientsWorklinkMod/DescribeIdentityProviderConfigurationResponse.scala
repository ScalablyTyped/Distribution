...
trait DescribeIdentityProviderConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var IdentityProviderType: js.UndefOr[typings.awsSdk.clientsWorklinkMod.IdentityProviderType] = js.undefined
...
object DescribeIdentityProviderConfigurationResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeIdentityProviderConfigurationResponse] (val x: Self) extends AnyVal {
