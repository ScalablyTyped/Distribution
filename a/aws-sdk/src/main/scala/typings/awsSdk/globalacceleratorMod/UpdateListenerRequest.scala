...
trait UpdateListenerRequest extends StObject {
  ...
  /**
    ...
    */
  var PortRanges: js.UndefOr[typings.awsSdk.globalacceleratorMod.PortRanges] = js.undefined
  
  /**
    * The updated protocol for the connections from clients to the accelerator.
    */
  var Protocol: js.UndefOr[typings.awsSdk.globalacceleratorMod.Protocol] = js.undefined
}
object UpdateListenerRequest {
  
  inline def apply(ListenerArn: GenericString): UpdateListenerRequest = {
