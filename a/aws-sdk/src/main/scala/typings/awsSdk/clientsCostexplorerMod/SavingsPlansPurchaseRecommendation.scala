...
trait SavingsPlansPurchaseRecommendation extends StObject {
  ...
  /**
    ...
    */
  var SavingsPlansPurchaseRecommendationSummary: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.SavingsPlansPurchaseRecommendationSummary] = js.undefined
...
object SavingsPlansPurchaseRecommendation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SavingsPlansPurchaseRecommendation] (val x: Self) extends AnyVal {
