...
trait GetAnomalySubscriptionsResponse extends StObject {
  ...
  /**
    ...
    */
  var AnomalySubscriptions: typings.awsSdk.clientsCostexplorerMod.AnomalySubscriptions
...
object GetAnomalySubscriptionsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetAnomalySubscriptionsResponse] (val x: Self) extends AnyVal {
