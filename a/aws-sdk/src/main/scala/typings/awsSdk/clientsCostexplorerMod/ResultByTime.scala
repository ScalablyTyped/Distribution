...
trait ResultByTime extends StObject {
  ...
  /**
    ...
    */
  var Estimated: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.Estimated] = js.undefined
  
  /**
    * The groups that this time period includes.
    */
  var Groups: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.Groups] = js.undefined
