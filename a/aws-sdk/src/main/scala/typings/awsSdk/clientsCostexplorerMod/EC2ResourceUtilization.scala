...
trait EC2ResourceUtilization extends StObject {
  ...
  /**
    ...
    */
  var DiskResourceUtilization: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.DiskResourceUtilization] = js.undefined
  
  /**
    * The EBS field that contains a list of EBS metrics that are associated with the current instance. 
    */
  var EBSResourceUtilization: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.EBSResourceUtilization] = js.undefined
  ...
  /**
    ...
    */
  var NetworkResourceUtilization: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.NetworkResourceUtilization] = js.undefined
}
