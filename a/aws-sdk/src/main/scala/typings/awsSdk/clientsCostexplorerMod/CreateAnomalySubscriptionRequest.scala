...
trait CreateAnomalySubscriptionRequest extends StObject {
  ...
  /**
    ...
    */
  var AnomalySubscription: typings.awsSdk.clientsCostexplorerMod.AnomalySubscription
...
object CreateAnomalySubscriptionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAnomalySubscriptionRequest] (val x: Self) extends AnyVal {
