...
trait RightsizingRecommendation extends StObject {
  ...
  /**
    ...
    */
  var CurrentInstance: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.CurrentInstance] = js.undefined
  
  /**
    * The list of possible reasons why the recommendation is generated, such as under- or over-utilization of specific metrics (for example, CPU, Memory, Network). 
    */
  var FindingReasonCodes: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.FindingReasonCodes] = js.undefined
  
  /**
    * The details for the modification recommendations. 
    */
  var ModifyRecommendationDetail: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.ModifyRecommendationDetail] = js.undefined
  
  /**
    * A recommendation to either terminate or modify the resource.
    */
  var RightsizingType: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.RightsizingType] = js.undefined
  
  /**
    * The details for termination recommendations.
    */
  var TerminateRecommendationDetail: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.TerminateRecommendationDetail] = js.undefined
}
