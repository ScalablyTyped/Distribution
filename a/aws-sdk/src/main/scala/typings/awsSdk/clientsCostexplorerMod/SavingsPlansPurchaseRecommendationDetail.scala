...
trait SavingsPlansPurchaseRecommendationDetail extends StObject {
  ...
  /**
    ...
    */
  var SavingsPlansDetails: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.SavingsPlansDetails] = js.undefined
...
object SavingsPlansPurchaseRecommendationDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SavingsPlansPurchaseRecommendationDetail] (val x: Self) extends AnyVal {
