...
trait GetSavingsPlansUtilizationDetailsResponse extends StObject {
  ...
  /**
    ...
    */
  var SavingsPlansUtilizationDetails: typings.awsSdk.clientsCostexplorerMod.SavingsPlansUtilizationDetails
...
object GetSavingsPlansUtilizationDetailsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSavingsPlansUtilizationDetailsResponse] (val x: Self) extends AnyVal {
