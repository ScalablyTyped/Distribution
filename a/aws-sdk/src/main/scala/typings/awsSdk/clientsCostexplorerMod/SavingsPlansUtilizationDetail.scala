...
trait SavingsPlansUtilizationDetail extends StObject {
  ...
  /**
    ...
    */
  var SavingsPlanArn: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.SavingsPlanArn] = js.undefined
...
object SavingsPlansUtilizationDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SavingsPlansUtilizationDetail] (val x: Self) extends AnyVal {
