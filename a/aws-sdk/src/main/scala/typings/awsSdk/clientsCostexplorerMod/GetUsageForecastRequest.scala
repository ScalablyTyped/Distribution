...
trait GetUsageForecastRequest extends StObject {
  ...
  /**
    ...
    */
  var Metric: typings.awsSdk.clientsCostexplorerMod.Metric
  ...
  /**
    ...
    */
  var PredictionIntervalLevel: js.UndefOr[typings.awsSdk.clientsCostexplorerMod.PredictionIntervalLevel] = js.undefined
...
object GetUsageForecastRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetUsageForecastRequest] (val x: Self) extends AnyVal {
