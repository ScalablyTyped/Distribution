...
trait CreateBucketRequest extends js.Object {
  ...
  /**
    ...
    */
  var CreateBucketConfiguration: js.UndefOr[typings.awsSdk.s3controlMod.CreateBucketConfiguration] = js.native
  ...
  /**
    ...
    */
  var GrantFullControl: js.UndefOr[typings.awsSdk.s3controlMod.GrantFullControl] = js.native
  
  /**
    * Allows grantee to list the objects in the bucket.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantRead: js.UndefOr[typings.awsSdk.s3controlMod.GrantRead] = js.native
  
  /**
    * Allows grantee to read the bucket ACL.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantReadACP: js.UndefOr[typings.awsSdk.s3controlMod.GrantReadACP] = js.native
  ...
  /**
    ...
    */
  var GrantWrite: js.UndefOr[typings.awsSdk.s3controlMod.GrantWrite] = js.native
  
  /**
    * Allows grantee to write the ACL for the applicable bucket.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantWriteACP: js.UndefOr[typings.awsSdk.s3controlMod.GrantWriteACP] = js.native
  ...
  /**
    ...
    */
  var ObjectLockEnabledForBucket: js.UndefOr[typings.awsSdk.s3controlMod.ObjectLockEnabledForBucket] = js.native
