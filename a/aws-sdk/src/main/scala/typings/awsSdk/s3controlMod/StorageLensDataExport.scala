...
trait StorageLensDataExport extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchMetrics: js.UndefOr[typings.awsSdk.s3controlMod.CloudWatchMetrics] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketDestination: js.UndefOr[typings.awsSdk.s3controlMod.S3BucketDestination] = js.undefined
}
