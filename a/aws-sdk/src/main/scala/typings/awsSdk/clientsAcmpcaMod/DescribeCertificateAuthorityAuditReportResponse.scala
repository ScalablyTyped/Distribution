...
trait DescribeCertificateAuthorityAuditReportResponse extends StObject {
  ...
  /**
    ...
    */
  var AuditReportStatus: js.UndefOr[typings.awsSdk.clientsAcmpcaMod.AuditReportStatus] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[typings.awsSdk.clientsAcmpcaMod.S3BucketName] = js.undefined
...
object DescribeCertificateAuthorityAuditReportResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeCertificateAuthorityAuditReportResponse] (val x: Self) extends AnyVal {
