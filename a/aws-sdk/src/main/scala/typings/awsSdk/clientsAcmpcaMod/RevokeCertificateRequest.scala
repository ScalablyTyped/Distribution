...
trait RevokeCertificateRequest extends StObject {
  ...
  /**
    ...
    */
  var RevocationReason: typings.awsSdk.clientsAcmpcaMod.RevocationReason
}
object RevokeCertificateRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RevokeCertificateRequest] (val x: Self) extends AnyVal {
