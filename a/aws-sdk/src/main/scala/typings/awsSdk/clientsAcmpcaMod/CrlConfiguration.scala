...
trait CrlConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CustomCname: js.UndefOr[CnameString] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[S3BucketName3To255] = js.undefined
...
object CrlConfiguration {
  ...
  implicit open class MutableBuilder[Self <: CrlConfiguration] (val x: Self) extends AnyVal {
    ...
    inline def setCustomCname(value: CnameString): Self = StObject.set(x, "CustomCname", value.asInstanceOf[js.Any])
    ...
    inline def setS3BucketName(value: S3BucketName3To255): Self = StObject.set(x, "S3BucketName", value.asInstanceOf[js.Any])
