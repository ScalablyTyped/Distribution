...
trait TagHealth extends StObject {
  ...
  /**
    ...
    */
  var AppBoundaryKey: js.UndefOr[typings.awsSdk.devopsguruMod.AppBoundaryKey] = js.undefined
  ...
  /**
    ...
    */
  var TagValue: js.UndefOr[typings.awsSdk.devopsguruMod.TagValue] = js.undefined
}
object TagHealth {
