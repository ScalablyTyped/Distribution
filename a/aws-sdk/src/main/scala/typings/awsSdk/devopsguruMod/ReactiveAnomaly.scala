...
trait ReactiveAnomaly extends StObject {
  ...
  /**
    ...
    */
  var AnomalyReportedTimeRange: js.UndefOr[typings.awsSdk.devopsguruMod.AnomalyReportedTimeRange] = js.undefined
  
  /**
    * The Amazon Web Services resources in which anomalous behavior was detected by DevOps Guru.
    */
  var AnomalyResources: js.UndefOr[typings.awsSdk.devopsguruMod.AnomalyResources] = js.undefined
  
  var AnomalyTimeRange: js.UndefOr[typings.awsSdk.devopsguruMod.AnomalyTimeRange] = js.undefined
