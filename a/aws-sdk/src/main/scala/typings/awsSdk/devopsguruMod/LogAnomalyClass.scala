...
trait LogAnomalyClass extends StObject {
  ...
  /**
    ...
    */
  var Explanation: js.UndefOr[typings.awsSdk.devopsguruMod.Explanation] = js.undefined
  
  /**
    *  The token where the anomaly was detected. This may refer to an exception or another location, or it may be blank for log anomalies such as format anomalies. 
    */
  var LogAnomalyToken: js.UndefOr[typings.awsSdk.devopsguruMod.LogAnomalyToken] = js.undefined
  
  /**
    *  The type of log anomaly that has been detected. 
    */
  var LogAnomalyType: js.UndefOr[typings.awsSdk.devopsguruMod.LogAnomalyType] = js.undefined
  
  /**
    *  The ID of the log event. 
    */
  var LogEventId: js.UndefOr[typings.awsSdk.devopsguruMod.LogEventId] = js.undefined
  ...
  /**
    ...
    */
  var LogStreamName: js.UndefOr[typings.awsSdk.devopsguruMod.LogStreamName] = js.undefined
  
  /**
    *  The number of log lines where this anomalous log event occurs. 
    */
  var NumberOfLogLinesOccurrences: js.UndefOr[typings.awsSdk.devopsguruMod.NumberOfLogLinesOccurrences] = js.undefined
}
