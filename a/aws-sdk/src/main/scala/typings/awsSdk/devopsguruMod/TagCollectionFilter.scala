...
trait TagCollectionFilter extends StObject {
  ...
  /**
    ...
    */
  var TagValues: typings.awsSdk.devopsguruMod.TagValues
}
object TagCollectionFilter {
  
  inline def apply(AppBoundaryKey: AppBoundaryKey, TagValues: TagValues): TagCollectionFilter = {
