...
trait DescribeInsightResponse extends StObject {
  ...
  /**
    ...
    */
  var ProactiveInsight: js.UndefOr[typings.awsSdk.devopsguruMod.ProactiveInsight] = js.undefined
  
  /**
    *  A ReactiveInsight object that represents the requested insight. 
    */
  var ReactiveInsight: js.UndefOr[typings.awsSdk.devopsguruMod.ReactiveInsight] = js.undefined
}
