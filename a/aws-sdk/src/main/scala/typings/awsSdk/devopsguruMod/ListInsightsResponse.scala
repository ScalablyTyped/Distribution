...
trait ListInsightsResponse extends StObject {
  ...
  /**
    ...
    */
  var ProactiveInsights: js.UndefOr[typings.awsSdk.devopsguruMod.ProactiveInsights] = js.undefined
  
  /**
    *  The returned list of reactive insights. 
    */
  var ReactiveInsights: js.UndefOr[typings.awsSdk.devopsguruMod.ReactiveInsights] = js.undefined
}
object ListInsightsResponse {
  ...
  extension [Self <: ListInsightsResponse](x: Self) {
