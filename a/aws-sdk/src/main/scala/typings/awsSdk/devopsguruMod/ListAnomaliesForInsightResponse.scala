...
trait ListAnomaliesForInsightResponse extends StObject {
  ...
  /**
    ...
    */
  var ProactiveAnomalies: js.UndefOr[typings.awsSdk.devopsguruMod.ProactiveAnomalies] = js.undefined
  
  /**
    *  An array of ReactiveAnomalySummary objects that represent the requested anomalies 
    */
  var ReactiveAnomalies: js.UndefOr[typings.awsSdk.devopsguruMod.ReactiveAnomalies] = js.undefined
}
