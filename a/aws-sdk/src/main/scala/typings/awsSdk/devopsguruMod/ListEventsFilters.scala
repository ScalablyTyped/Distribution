...
trait ListEventsFilters extends StObject {
  ...
  /**
    ...
    */
  var EventClass: js.UndefOr[typings.awsSdk.devopsguruMod.EventClass] = js.undefined
  
  /**
    *  The Amazon Web Services source that emitted the events you want to filter for. 
    */
  var EventSource: js.UndefOr[typings.awsSdk.devopsguruMod.EventSource] = js.undefined
  
  /**
    *  A time range during which you want the filtered events to have occurred. 
    */
  var EventTimeRange: js.UndefOr[typings.awsSdk.devopsguruMod.EventTimeRange] = js.undefined
