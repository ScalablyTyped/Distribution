...
trait DescribeClustersMessage extends StObject {
...
object DescribeClustersMessage {
  ...
  inline def apply(): DescribeClustersMessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeClustersMessage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeClustersMessage] (val x: Self) extends AnyVal {
