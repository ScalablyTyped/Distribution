...
trait BatchModifyClusterSnapshotsMessage extends StObject {
  ...
  /**
    ...
    */
  var SnapshotIdentifierList: typings.awsSdk.clientsRedshiftMod.SnapshotIdentifierList
}
object BatchModifyClusterSnapshotsMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BatchModifyClusterSnapshotsMessage] (val x: Self) extends AnyVal {
