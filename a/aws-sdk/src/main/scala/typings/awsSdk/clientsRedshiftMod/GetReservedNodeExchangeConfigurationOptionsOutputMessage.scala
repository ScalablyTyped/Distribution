...
trait GetReservedNodeExchangeConfigurationOptionsOutputMessage extends StObject {
  ...
  /**
    ...
    */
  var ReservedNodeConfigurationOptionList: js.UndefOr[typings.awsSdk.clientsRedshiftMod.ReservedNodeConfigurationOptionList] = js.undefined
}
object GetReservedNodeExchangeConfigurationOptionsOutputMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetReservedNodeExchangeConfigurationOptionsOutputMessage] (val x: Self) extends AnyVal {
