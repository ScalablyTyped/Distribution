...
trait CreateEventSubscriptionResult extends StObject {
  ...
  var EventSubscription: js.UndefOr[typings.awsSdk.clientsRedshiftMod.EventSubscription] = js.undefined
}
object CreateEventSubscriptionResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateEventSubscriptionResult] (val x: Self) extends AnyVal {
