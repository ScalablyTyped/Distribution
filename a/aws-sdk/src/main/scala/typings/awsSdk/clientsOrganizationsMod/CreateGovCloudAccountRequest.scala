...
trait CreateGovCloudAccountRequest extends StObject {
  ...
  /**
    ...
    */
  var Email: typings.awsSdk.clientsOrganizationsMod.Email
  ...
  /**
    ...
    */
  var RoleName: js.UndefOr[typings.awsSdk.clientsOrganizationsMod.RoleName] = js.undefined
...
object CreateGovCloudAccountRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateGovCloudAccountRequest] (val x: Self) extends AnyVal {
