...
trait ListRootsResponse extends StObject {
  ...
  /**
    ...
    */
  var Roots: js.UndefOr[typings.awsSdk.clientsOrganizationsMod.Roots] = js.undefined
}
object ListRootsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListRootsResponse] (val x: Self) extends AnyVal {
