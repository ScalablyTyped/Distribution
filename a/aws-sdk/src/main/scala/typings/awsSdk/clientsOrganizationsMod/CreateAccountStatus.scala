...
trait CreateAccountStatus extends StObject {
  ...
  /**
    ...
    */
  var AccountId: js.UndefOr[typings.awsSdk.clientsOrganizationsMod.AccountId] = js.undefined
...
object CreateAccountStatus {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAccountStatus] (val x: Self) extends AnyVal {
