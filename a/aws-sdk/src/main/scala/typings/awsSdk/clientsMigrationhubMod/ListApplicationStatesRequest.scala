...
trait ListApplicationStatesRequest extends StObject {
  ...
  /**
    ...
    */
  var ApplicationIds: js.UndefOr[typings.awsSdk.clientsMigrationhubMod.ApplicationIds] = js.undefined
...
object ListApplicationStatesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListApplicationStatesRequest] (val x: Self) extends AnyVal {
