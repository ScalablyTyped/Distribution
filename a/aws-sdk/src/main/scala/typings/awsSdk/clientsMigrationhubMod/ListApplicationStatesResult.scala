...
trait ListApplicationStatesResult extends StObject {
  ...
  /**
    ...
    */
  var ApplicationStateList: js.UndefOr[typings.awsSdk.clientsMigrationhubMod.ApplicationStateList] = js.undefined
...
object ListApplicationStatesResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListApplicationStatesResult] (val x: Self) extends AnyVal {
