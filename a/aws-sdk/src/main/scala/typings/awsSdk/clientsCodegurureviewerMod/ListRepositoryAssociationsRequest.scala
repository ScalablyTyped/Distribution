...
trait ListRepositoryAssociationsRequest extends StObject {
  ...
  /**
    ...
    */
  var Names: js.UndefOr[typings.awsSdk.clientsCodegurureviewerMod.Names] = js.undefined
  ...
  /**
    ...
    */
  var Owners: js.UndefOr[typings.awsSdk.clientsCodegurureviewerMod.Owners] = js.undefined
...
object ListRepositoryAssociationsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListRepositoryAssociationsRequest] (val x: Self) extends AnyVal {
