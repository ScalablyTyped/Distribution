...
trait CodeReviewType extends StObject {
  ...
  /**
    ...
    */
  var RepositoryAnalysis: typings.awsSdk.clientsCodegurureviewerMod.RepositoryAnalysis
}
object CodeReviewType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CodeReviewType] (val x: Self) extends AnyVal {
