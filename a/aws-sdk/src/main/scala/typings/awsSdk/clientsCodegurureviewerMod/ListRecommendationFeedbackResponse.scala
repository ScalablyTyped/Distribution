...
trait ListRecommendationFeedbackResponse extends StObject {
  ...
  /**
    ...
    */
  var RecommendationFeedbackSummaries: js.UndefOr[typings.awsSdk.clientsCodegurureviewerMod.RecommendationFeedbackSummaries] = js.undefined
}
object ListRecommendationFeedbackResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListRecommendationFeedbackResponse] (val x: Self) extends AnyVal {
