...
trait TriggerUpdate extends StObject {
  ...
  /**
    ...
    */
  var EventBatchingCondition: js.UndefOr[typings.awsSdk.clientsGlueMod.EventBatchingCondition] = js.undefined
  ...
  /**
    ...
    */
  var Predicate: js.UndefOr[typings.awsSdk.clientsGlueMod.Predicate] = js.undefined
...
object TriggerUpdate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TriggerUpdate] (val x: Self) extends AnyVal {
