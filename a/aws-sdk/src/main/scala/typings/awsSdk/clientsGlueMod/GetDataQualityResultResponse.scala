...
trait GetDataQualityResultResponse extends StObject {
...
object GetDataQualityResultResponse {
  ...
  inline def apply(): GetDataQualityResultResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetDataQualityResultResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetDataQualityResultResponse] (val x: Self) extends AnyVal {
