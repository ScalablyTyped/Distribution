...
trait CreateSchemaInput extends StObject {
  ...
  /**
    ...
    */
  var RegistryId: js.UndefOr[typings.awsSdk.clientsGlueMod.RegistryId] = js.undefined
...
object CreateSchemaInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateSchemaInput] (val x: Self) extends AnyVal {
