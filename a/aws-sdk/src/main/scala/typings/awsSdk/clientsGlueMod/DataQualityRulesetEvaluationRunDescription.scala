...
trait DataQualityRulesetEvaluationRunDescription extends StObject {
...
object DataQualityRulesetEvaluationRunDescription {
  ...
  inline def apply(): DataQualityRulesetEvaluationRunDescription = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DataQualityRulesetEvaluationRunDescription]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DataQualityRulesetEvaluationRunDescription] (val x: Self) extends AnyVal {
