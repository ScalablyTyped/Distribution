...
trait CatalogHudiSource extends StObject {
...
object CatalogHudiSource {
  
  inline def apply(Database: EnclosedInStringProperty, Name: NodeName, Table: EnclosedInStringProperty): CatalogHudiSource = {
    ...
    __obj.asInstanceOf[CatalogHudiSource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CatalogHudiSource] (val x: Self) extends AnyVal {
