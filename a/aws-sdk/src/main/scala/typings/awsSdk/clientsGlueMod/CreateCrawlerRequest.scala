...
trait CreateCrawlerRequest extends StObject {
  ...
  /**
    ...
    */
  var Role: typings.awsSdk.clientsGlueMod.Role
...
object CreateCrawlerRequest {
  ...
  inline def apply(Name: NameString, Role: Role, Targets: CrawlerTargets): CreateCrawlerRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCrawlerRequest] (val x: Self) extends AnyVal {
