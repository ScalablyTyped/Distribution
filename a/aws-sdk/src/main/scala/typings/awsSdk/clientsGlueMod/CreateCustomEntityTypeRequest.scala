...
trait CreateCustomEntityTypeRequest extends StObject {
...
object CreateCustomEntityTypeRequest {
  ...
  inline def apply(Name: NameString, RegexString: NameString): CreateCustomEntityTypeRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCustomEntityTypeRequest] (val x: Self) extends AnyVal {
