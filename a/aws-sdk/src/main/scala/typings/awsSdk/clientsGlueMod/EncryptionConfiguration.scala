...
trait EncryptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchEncryption: js.UndefOr[typings.awsSdk.clientsGlueMod.CloudWatchEncryption] = js.undefined
  
  /**
    * The encryption configuration for job bookmarks.
    */
  var JobBookmarksEncryption: js.UndefOr[typings.awsSdk.clientsGlueMod.JobBookmarksEncryption] = js.undefined
