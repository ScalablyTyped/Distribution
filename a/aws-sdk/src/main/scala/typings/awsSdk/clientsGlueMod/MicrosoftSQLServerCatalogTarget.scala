...
trait MicrosoftSQLServerCatalogTarget extends StObject {
...
object MicrosoftSQLServerCatalogTarget {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MicrosoftSQLServerCatalogTarget] (val x: Self) extends AnyVal {
