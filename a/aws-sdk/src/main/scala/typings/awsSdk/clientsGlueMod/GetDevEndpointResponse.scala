...
trait GetDevEndpointResponse extends StObject {
  ...
  /**
    ...
    */
  var DevEndpoint: js.UndefOr[typings.awsSdk.clientsGlueMod.DevEndpoint] = js.undefined
}
object GetDevEndpointResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetDevEndpointResponse] (val x: Self) extends AnyVal {
