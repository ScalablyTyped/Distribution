...
trait JobBookmarkEntry extends StObject {
  ...
  /**
    ...
    */
  var JobName: js.UndefOr[typings.awsSdk.clientsGlueMod.JobName] = js.undefined
...
object JobBookmarkEntry {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: JobBookmarkEntry] (val x: Self) extends AnyVal {
