...
trait DropNullFields extends StObject {
  ...
  /**
    ...
    */
  var NullCheckBoxList: js.UndefOr[typings.awsSdk.clientsGlueMod.NullCheckBoxList] = js.undefined
...
object DropNullFields {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DropNullFields] (val x: Self) extends AnyVal {
