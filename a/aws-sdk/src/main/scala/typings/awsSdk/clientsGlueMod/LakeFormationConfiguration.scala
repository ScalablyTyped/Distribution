...
trait LakeFormationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AccountId: js.UndefOr[typings.awsSdk.clientsGlueMod.AccountId] = js.undefined
...
object LakeFormationConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LakeFormationConfiguration] (val x: Self) extends AnyVal {
