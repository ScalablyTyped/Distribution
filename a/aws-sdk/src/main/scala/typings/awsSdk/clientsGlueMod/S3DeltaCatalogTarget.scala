...
trait S3DeltaCatalogTarget extends StObject {
...
object S3DeltaCatalogTarget {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[S3DeltaCatalogTarget]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: S3DeltaCatalogTarget] (val x: Self) extends AnyVal {
