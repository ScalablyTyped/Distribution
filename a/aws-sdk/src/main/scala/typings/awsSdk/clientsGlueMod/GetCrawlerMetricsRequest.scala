...
trait GetCrawlerMetricsRequest extends StObject {
  ...
  /**
    ...
    */
  var CrawlerNameList: js.UndefOr[typings.awsSdk.clientsGlueMod.CrawlerNameList] = js.undefined
...
object GetCrawlerMetricsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetCrawlerMetricsRequest] (val x: Self) extends AnyVal {
