...
trait SchemaChangePolicy extends StObject {
  ...
  /**
    ...
    */
  var DeleteBehavior: js.UndefOr[typings.awsSdk.clientsGlueMod.DeleteBehavior] = js.undefined
  
  /**
    * The update behavior when the crawler finds a changed schema.
    */
  var UpdateBehavior: js.UndefOr[typings.awsSdk.clientsGlueMod.UpdateBehavior] = js.undefined
}
