...
trait JobUpdate extends StObject {
  ...
  /**
    ...
    */
  var CodeGenConfigurationNodes: js.UndefOr[typings.awsSdk.clientsGlueMod.CodeGenConfigurationNodes] = js.undefined
  ...
  /**
    ...
    */
  var ExecutionClass: js.UndefOr[typings.awsSdk.clientsGlueMod.ExecutionClass] = js.undefined
  
  /**
    * An ExecutionProperty specifying the maximum number of concurrent runs allowed for this job.
    */
  var ExecutionProperty: js.UndefOr[typings.awsSdk.clientsGlueMod.ExecutionProperty] = js.undefined
  ...
  /**
    ...
    */
  var MaxRetries: js.UndefOr[typings.awsSdk.clientsGlueMod.MaxRetries] = js.undefined
  ...
  /**
    ...
    */
  var NotificationProperty: js.UndefOr[typings.awsSdk.clientsGlueMod.NotificationProperty] = js.undefined
  ...
  /**
    ...
    */
  var SourceControlDetails: js.UndefOr[typings.awsSdk.clientsGlueMod.SourceControlDetails] = js.undefined
...
object JobUpdate {
  ...
  implicit open class MutableBuilder[Self <: JobUpdate] (val x: Self) extends AnyVal {
    ...
    inline def setSourceControlDetails(value: SourceControlDetails): Self = StObject.set(x, "SourceControlDetails", value.asInstanceOf[js.Any])
    
    inline def setSourceControlDetailsUndefined: Self = StObject.set(x, "SourceControlDetails", js.undefined)
