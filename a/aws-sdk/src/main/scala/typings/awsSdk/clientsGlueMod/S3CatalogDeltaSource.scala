...
trait S3CatalogDeltaSource extends StObject {
...
object S3CatalogDeltaSource {
  
  inline def apply(Database: EnclosedInStringProperty, Name: NodeName, Table: EnclosedInStringProperty): S3CatalogDeltaSource = {
    ...
    __obj.asInstanceOf[S3CatalogDeltaSource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: S3CatalogDeltaSource] (val x: Self) extends AnyVal {
