...
trait GetBlueprintRunsResponse extends StObject {
  ...
  /**
    ...
    */
  var BlueprintRuns: js.UndefOr[typings.awsSdk.clientsGlueMod.BlueprintRuns] = js.undefined
...
object GetBlueprintRunsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBlueprintRunsResponse] (val x: Self) extends AnyVal {
