...
trait DescribeSubscriptionResponse extends StObject {
  ...
  /**
    ...
    */
  var Subscription: js.UndefOr[typings.awsSdk.clientsShieldMod.Subscription] = js.undefined
}
object DescribeSubscriptionResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeSubscriptionResponse] (val x: Self) extends AnyVal {
