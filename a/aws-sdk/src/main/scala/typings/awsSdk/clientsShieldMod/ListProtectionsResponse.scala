...
trait ListProtectionsResponse extends StObject {
  ...
  /**
    ...
    */
  var Protections: js.UndefOr[typings.awsSdk.clientsShieldMod.Protections] = js.undefined
}
object ListProtectionsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProtectionsResponse] (val x: Self) extends AnyVal {
