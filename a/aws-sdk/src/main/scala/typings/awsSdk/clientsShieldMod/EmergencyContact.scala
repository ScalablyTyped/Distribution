...
trait EmergencyContact extends StObject {
  ...
  /**
    ...
    */
  var ContactNotes: js.UndefOr[typings.awsSdk.clientsShieldMod.ContactNotes] = js.undefined
  
  /**
    * The email address for the contact.
    */
  var EmailAddress: typings.awsSdk.clientsShieldMod.EmailAddress
  
  /**
    * The phone number for the contact.
    */
  var PhoneNumber: js.UndefOr[typings.awsSdk.clientsShieldMod.PhoneNumber] = js.undefined
}
object EmergencyContact {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EmergencyContact] (val x: Self) extends AnyVal {
