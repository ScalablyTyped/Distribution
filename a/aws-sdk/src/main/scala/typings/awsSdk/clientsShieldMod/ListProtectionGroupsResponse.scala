...
trait ListProtectionGroupsResponse extends StObject {
  ...
  /**
    * 
    */
  var ProtectionGroups: typings.awsSdk.clientsShieldMod.ProtectionGroups
}
object ListProtectionGroupsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProtectionGroupsResponse] (val x: Self) extends AnyVal {
