...
trait ScheduledQueryDescription extends StObject {
  ...
  /**
    ...
    */
  var ErrorReportConfiguration: js.UndefOr[typings.awsSdk.clientsTimestreamqueryMod.ErrorReportConfiguration] = js.undefined
...
object ScheduledQueryDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ScheduledQueryDescription] (val x: Self) extends AnyVal {
