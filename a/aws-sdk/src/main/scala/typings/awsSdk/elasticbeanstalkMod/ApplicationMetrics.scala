...
trait ApplicationMetrics extends StObject {
  ...
  /**
    ...
    */
  var Latency: js.UndefOr[typings.awsSdk.elasticbeanstalkMod.Latency] = js.undefined
  
  /**
    * Average number of requests handled by the web server per second over the last 10 seconds.
    */
  var RequestCount: js.UndefOr[typings.awsSdk.elasticbeanstalkMod.RequestCount] = js.undefined
  
  /**
    * Represents the percentage of requests over the last 10 seconds that resulted in each type of status code response.
    */
  var StatusCodes: js.UndefOr[typings.awsSdk.elasticbeanstalkMod.StatusCodes] = js.undefined
}
