...
trait SpotResizingSpecification extends StObject {
...
object SpotResizingSpecification {
  ...
  inline def apply(TimeoutDurationMinutes: WholeNumber): SpotResizingSpecification = {
    val __obj = js.Dynamic.literal(TimeoutDurationMinutes = TimeoutDurationMinutes.asInstanceOf[js.Any])
    __obj.asInstanceOf[SpotResizingSpecification]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SpotResizingSpecification] (val x: Self) extends AnyVal {
