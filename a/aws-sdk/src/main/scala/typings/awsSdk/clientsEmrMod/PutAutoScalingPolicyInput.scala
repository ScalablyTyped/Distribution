...
trait PutAutoScalingPolicyInput extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingPolicy: typings.awsSdk.clientsEmrMod.AutoScalingPolicy
...
object PutAutoScalingPolicyInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutAutoScalingPolicyInput] (val x: Self) extends AnyVal {
