...
trait ListChannelMessagesRequest extends StObject {
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typings.awsSdk.clientsChimeMod.SortOrder] = js.undefined
}
object ListChannelMessagesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListChannelMessagesRequest] (val x: Self) extends AnyVal {
