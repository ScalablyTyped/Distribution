...
trait TranscriptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EngineTranscribeMedicalSettings: js.UndefOr[typings.awsSdk.clientsChimeMod.EngineTranscribeMedicalSettings] = js.undefined
  
  /**
    * The transcription configuration settings passed to Amazon Transcribe.
    */
  var EngineTranscribeSettings: js.UndefOr[typings.awsSdk.clientsChimeMod.EngineTranscribeSettings] = js.undefined
}
