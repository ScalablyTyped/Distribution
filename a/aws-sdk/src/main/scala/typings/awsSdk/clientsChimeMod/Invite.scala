...
trait Invite extends StObject {
  ...
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typings.awsSdk.clientsChimeMod.EmailAddress] = js.undefined
  
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typings.awsSdk.clientsChimeMod.EmailStatus] = js.undefined
...
object Invite {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Invite] (val x: Self) extends AnyVal {
