...
object PostTextRequest {
  ...
  inline def apply(botAlias: BotAlias, botName: BotName, inputText: Text, userId: UserId): PostTextRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PostTextRequest] (val x: Self) extends AnyVal {
    ...
    inline def setInputText(value: Text): Self = StObject.set(x, "inputText", value.asInstanceOf[js.Any])
