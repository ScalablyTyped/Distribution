...
trait Cors extends StObject {
  ...
  /**
    ...
    */
  var AllowCredentials: js.UndefOr[typings.awsSdk.lambdaMod.AllowCredentials] = js.undefined
  ...
  /**
    ...
    */
  var MaxAge: js.UndefOr[typings.awsSdk.lambdaMod.MaxAge] = js.undefined
}
object Cors {
