...
trait GetInAppTemplateRequest extends StObject {
...
object GetInAppTemplateRequest {
  ...
  inline def apply(TemplateName: string): GetInAppTemplateRequest = {
    val __obj = js.Dynamic.literal(TemplateName = TemplateName.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetInAppTemplateRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetInAppTemplateRequest] (val x: Self) extends AnyVal {
