...
trait UpdateGcmChannelRequest extends StObject {
  ...
  var GCMChannelRequest: typings.awsSdk.clientsPinpointMod.GCMChannelRequest
}
object UpdateGcmChannelRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateGcmChannelRequest] (val x: Self) extends AnyVal {
