...
object GetCampaignDateRangeKpiRequest {
  ...
  inline def apply(ApplicationId: string, CampaignId: string, KpiName: string): GetCampaignDateRangeKpiRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetCampaignDateRangeKpiRequest] (val x: Self) extends AnyVal {
