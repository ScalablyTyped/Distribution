...
trait JourneyRunExecutionActivityMetricsResponse extends StObject {
...
object JourneyRunExecutionActivityMetricsResponse {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(ActivityType = ActivityType.asInstanceOf[js.Any], ApplicationId = ApplicationId.asInstanceOf[js.Any], JourneyActivityId = JourneyActivityId.asInstanceOf[js.Any], JourneyId = JourneyId.asInstanceOf[js.Any], LastEvaluatedTime = LastEvaluatedTime.asInstanceOf[js.Any], Metrics = Metrics.asInstanceOf[js.Any], RunId = RunId.asInstanceOf[js.Any])
    __obj.asInstanceOf[JourneyRunExecutionActivityMetricsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: JourneyRunExecutionActivityMetricsResponse] (val x: Self) extends AnyVal {
