...
trait UpdateBaiduChannelRequest extends StObject {
  ...
  var BaiduChannelRequest: typings.awsSdk.clientsPinpointMod.BaiduChannelRequest
}
object UpdateBaiduChannelRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateBaiduChannelRequest] (val x: Self) extends AnyVal {
