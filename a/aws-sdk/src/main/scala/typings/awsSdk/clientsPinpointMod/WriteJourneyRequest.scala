...
trait WriteJourneyRequest extends StObject {
  ...
  /**
    ...
    */
  var JourneyChannelSettings: js.UndefOr[typings.awsSdk.clientsPinpointMod.JourneyChannelSettings] = js.undefined
  ...
  /**
    ...
    */
  var StartCondition: js.UndefOr[typings.awsSdk.clientsPinpointMod.StartCondition] = js.undefined
...
object WriteJourneyRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: WriteJourneyRequest] (val x: Self) extends AnyVal {
