...
trait AlternateIdentifier extends StObject {
  ...
  /**
    ...
    */
  var ExternalId: js.UndefOr[typings.awsSdk.clientsIdentitystoreMod.ExternalId] = js.undefined
  
  /**
    * An entity attribute that's unique to a specific entity.
    */
  var UniqueAttribute: js.UndefOr[typings.awsSdk.clientsIdentitystoreMod.UniqueAttribute] = js.undefined
}
object AlternateIdentifier {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AlternateIdentifier] (val x: Self) extends AnyVal {
