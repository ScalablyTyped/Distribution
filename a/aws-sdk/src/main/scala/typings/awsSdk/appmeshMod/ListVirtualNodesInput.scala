...
object ListVirtualNodesInput {
  ...
  @scala.inline
  implicit class ListVirtualNodesInputMutableBuilder[Self <: ListVirtualNodesInput] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setLimit(value: ListVirtualNodesLimit): Self = StObject.set(x, "limit", value.asInstanceOf[js.Any])
