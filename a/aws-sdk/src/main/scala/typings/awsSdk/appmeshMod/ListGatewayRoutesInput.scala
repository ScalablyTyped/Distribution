...
object ListGatewayRoutesInput {
  ...
  @scala.inline
  implicit class ListGatewayRoutesInputOps[Self <: ListGatewayRoutesInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setLimit(value: ListGatewayRoutesLimit): Self = this.set("limit", value.asInstanceOf[js.Any])
    @scala.inline
