...
trait VirtualGatewayTlsValidationContextAcmTrust extends js.Object {
  ...
  /**
    ...
    */
  var certificateAuthorityArns: VirtualGatewayCertificateAuthorityArns = js.native
}
object VirtualGatewayTlsValidationContextAcmTrust {
  ...
  @scala.inline
  implicit class VirtualGatewayTlsValidationContextAcmTrustOps[Self <: VirtualGatewayTlsValidationContextAcmTrust] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setCertificateAuthorityArns(value: VirtualGatewayCertificateAuthorityArns): Self = this.set("certificateAuthorityArns", value.asInstanceOf[js.Any])
  }
}
