...
trait TrainingJobDefinition extends StObject {
  ...
  /**
    ...
    */
  var InputDataConfig: typings.awsSdk.clientsSagemakerMod.InputDataConfig
...
object TrainingJobDefinition {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TrainingJobDefinition] (val x: Self) extends AnyVal {
