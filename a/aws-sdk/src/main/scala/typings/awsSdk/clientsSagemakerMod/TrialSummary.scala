...
trait TrialSummary extends StObject {
  ...
  var TrialSource: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TrialSource] = js.undefined
}
object TrialSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TrialSummary] (val x: Self) extends AnyVal {
