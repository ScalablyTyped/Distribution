...
trait CreateCompilationJobRequest extends StObject {
  ...
  /**
    ...
    */
  var InputConfig: js.UndefOr[typings.awsSdk.clientsSagemakerMod.InputConfig] = js.undefined
...
object CreateCompilationJobRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCompilationJobRequest] (val x: Self) extends AnyVal {
