...
trait ResourceConfig extends StObject {
  ...
  /**
    ...
    */
  var InstanceGroups: js.UndefOr[typings.awsSdk.clientsSagemakerMod.InstanceGroups] = js.undefined
  ...
  /**
    ...
    */
  var KeepAlivePeriodInSeconds: js.UndefOr[typings.awsSdk.clientsSagemakerMod.KeepAlivePeriodInSeconds] = js.undefined
