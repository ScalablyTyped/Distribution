...
trait PipelineExecutionStep extends StObject {
  ...
  /**
    ...
    */
  var CacheHitResult: js.UndefOr[typings.awsSdk.clientsSagemakerMod.CacheHitResult] = js.undefined
  ...
  /**
    ...
    */
  var StepDescription: js.UndefOr[typings.awsSdk.clientsSagemakerMod.StepDescription] = js.undefined
  
  /**
    * The display name of the step.
    */
  var StepDisplayName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.StepDisplayName] = js.undefined
  
  /**
    * The name of the step that is executed.
    */
  var StepName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.StepName] = js.undefined
  
  /**
    * The status of the step execution.
    */
  var StepStatus: js.UndefOr[typings.awsSdk.clientsSagemakerMod.StepStatus] = js.undefined
}
