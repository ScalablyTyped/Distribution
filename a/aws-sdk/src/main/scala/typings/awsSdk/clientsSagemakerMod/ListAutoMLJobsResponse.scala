...
trait ListAutoMLJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var AutoMLJobSummaries: typings.awsSdk.clientsSagemakerMod.AutoMLJobSummaries
...
object ListAutoMLJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAutoMLJobsResponse] (val x: Self) extends AnyVal {
