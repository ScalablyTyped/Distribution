...
trait GetDeviceFleetReportResponse extends StObject {
  ...
  /**
    ...
    */
  var AgentVersions: js.UndefOr[typings.awsSdk.clientsSagemakerMod.AgentVersions] = js.undefined
  ...
  /**
    * Status of devices.
    */
  var DeviceStats: js.UndefOr[typings.awsSdk.clientsSagemakerMod.DeviceStats] = js.undefined
