...
trait ListLabelingJobsForWorkteamRequest extends StObject {
  ...
  /**
    ...
    */
  var JobReferenceCodeContains: js.UndefOr[typings.awsSdk.clientsSagemakerMod.JobReferenceCodeContains] = js.undefined
...
object ListLabelingJobsForWorkteamRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListLabelingJobsForWorkteamRequest] (val x: Self) extends AnyVal {
