...
trait HyperParameterTrainingJobSummary extends StObject {
  ...
  /**
    ...
    */
  var FinalHyperParameterTuningJobObjectiveMetric: js.UndefOr[typings.awsSdk.clientsSagemakerMod.FinalHyperParameterTuningJobObjectiveMetric] = js.undefined
  ...
  /**
    ...
    */
  var ObjectiveStatus: js.UndefOr[typings.awsSdk.clientsSagemakerMod.ObjectiveStatus] = js.undefined
...
object HyperParameterTrainingJobSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HyperParameterTrainingJobSummary] (val x: Self) extends AnyVal {
