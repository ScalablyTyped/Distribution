...
trait TransformJob extends StObject {
  ...
  var TransformInput: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformInput] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the transform job.
    */
  var TransformJobArn: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformJobArn] = js.undefined
  
  /**
    * The name of the transform job.
    */
  var TransformJobName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformJobName] = js.undefined
  ...
  /**
    ...
    */
  var TransformJobStatus: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformJobStatus] = js.undefined
  
  var TransformOutput: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformOutput] = js.undefined
  
  var TransformResources: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformResources] = js.undefined
