...
trait DescribeNotebookInstanceOutput extends StObject {
  ...
  /**
    ...
    */
  var NetworkInterfaceId: js.UndefOr[typings.awsSdk.clientsSagemakerMod.NetworkInterfaceId] = js.undefined
  ...
  /**
    ...
    */
  var NotebookInstanceName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.NotebookInstanceName] = js.undefined
...
object DescribeNotebookInstanceOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeNotebookInstanceOutput] (val x: Self) extends AnyVal {
