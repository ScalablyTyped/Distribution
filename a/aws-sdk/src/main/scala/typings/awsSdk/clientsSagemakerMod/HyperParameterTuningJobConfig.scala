...
trait HyperParameterTuningJobConfig extends StObject {
  ...
  /**
    ...
    */
  var TrainingJobEarlyStoppingType: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TrainingJobEarlyStoppingType] = js.undefined
  
  /**
    * The tuning job's completion criteria.
    */
  var TuningJobCompletionCriteria: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TuningJobCompletionCriteria] = js.undefined
}
