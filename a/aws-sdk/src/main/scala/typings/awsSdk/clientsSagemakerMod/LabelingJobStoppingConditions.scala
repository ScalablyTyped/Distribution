...
trait LabelingJobStoppingConditions extends StObject {
  ...
  /**
    ...
    */
  var MaxHumanLabeledObjectCount: js.UndefOr[typings.awsSdk.clientsSagemakerMod.MaxHumanLabeledObjectCount] = js.undefined
  
  /**
    * The maximum number of input data objects that should be labeled.
    */
  var MaxPercentageOfInputDatasetLabeled: js.UndefOr[typings.awsSdk.clientsSagemakerMod.MaxPercentageOfInputDatasetLabeled] = js.undefined
}
