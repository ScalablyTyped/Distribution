...
trait CreateWorkteamRequest extends StObject {
  ...
  /**
    ...
    */
  var MemberDefinitions: typings.awsSdk.clientsSagemakerMod.MemberDefinitions
  ...
  /**
    ...
    */
  var WorkforceName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.WorkforceName] = js.undefined
...
object CreateWorkteamRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateWorkteamRequest] (val x: Self) extends AnyVal {
