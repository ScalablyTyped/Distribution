...
trait AppImageConfigDetails extends StObject {
  ...
  /**
    ...
    */
  var AppImageConfigName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.AppImageConfigName] = js.undefined
...
object AppImageConfigDetails {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AppImageConfigDetails] (val x: Self) extends AnyVal {
