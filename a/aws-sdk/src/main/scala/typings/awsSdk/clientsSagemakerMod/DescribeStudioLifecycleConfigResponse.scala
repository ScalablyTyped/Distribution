...
trait DescribeStudioLifecycleConfigResponse extends StObject {
  ...
  /**
    ...
    */
  var StudioLifecycleConfigContent: js.UndefOr[typings.awsSdk.clientsSagemakerMod.StudioLifecycleConfigContent] = js.undefined
...
object DescribeStudioLifecycleConfigResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeStudioLifecycleConfigResponse] (val x: Self) extends AnyVal {
