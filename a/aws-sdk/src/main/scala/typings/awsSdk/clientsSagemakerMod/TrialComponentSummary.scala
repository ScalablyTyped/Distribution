...
trait TrialComponentSummary extends StObject {
  ...
  var TrialComponentSource: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TrialComponentSource] = js.undefined
}
object TrialComponentSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TrialComponentSummary] (val x: Self) extends AnyVal {
