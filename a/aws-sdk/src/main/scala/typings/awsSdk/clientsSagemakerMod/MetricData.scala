...
trait MetricData extends StObject {
  ...
  /**
    ...
    */
  var MetricName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.MetricName] = js.undefined
...
object MetricData {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MetricData] (val x: Self) extends AnyVal {
