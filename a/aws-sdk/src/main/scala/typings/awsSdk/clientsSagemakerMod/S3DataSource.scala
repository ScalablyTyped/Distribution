...
trait S3DataSource extends StObject {
  ...
  /**
    ...
    */
  var AttributeNames: js.UndefOr[typings.awsSdk.clientsSagemakerMod.AttributeNames] = js.undefined
  
  /**
    * A list of names of instance groups that get data from the S3 data source.
    */
  var InstanceGroupNames: js.UndefOr[typings.awsSdk.clientsSagemakerMod.InstanceGroupNames] = js.undefined
  ...
  /**
    ...
    */
  var S3DataType: typings.awsSdk.clientsSagemakerMod.S3DataType
