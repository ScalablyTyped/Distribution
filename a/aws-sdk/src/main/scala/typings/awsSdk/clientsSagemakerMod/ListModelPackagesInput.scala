...
trait ListModelPackagesInput extends StObject {
  ...
  /**
    ...
    */
  var ModelPackageType: js.UndefOr[typings.awsSdk.clientsSagemakerMod.ModelPackageType] = js.undefined
...
object ListModelPackagesInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListModelPackagesInput] (val x: Self) extends AnyVal {
