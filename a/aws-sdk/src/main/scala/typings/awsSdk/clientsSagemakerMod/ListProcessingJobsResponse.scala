...
trait ListProcessingJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var ProcessingJobSummaries: typings.awsSdk.clientsSagemakerMod.ProcessingJobSummaries
}
object ListProcessingJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProcessingJobsResponse] (val x: Self) extends AnyVal {
