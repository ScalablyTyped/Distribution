...
trait LabelingJobSummary extends StObject {
  ...
  /**
    ...
    */
  var LabelCounters: typings.awsSdk.clientsSagemakerMod.LabelCounters
  ...
  /**
    ...
    */
  var LabelingJobOutput: js.UndefOr[typings.awsSdk.clientsSagemakerMod.LabelingJobOutput] = js.undefined
  
  /**
    * The current status of the labeling job. 
    */
  var LabelingJobStatus: typings.awsSdk.clientsSagemakerMod.LabelingJobStatus
