...
trait SendPipelineExecutionStepFailureRequest extends StObject {
  ...
  /**
    ...
    */
  var CallbackToken: typings.awsSdk.clientsSagemakerMod.CallbackToken
...
object SendPipelineExecutionStepFailureRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SendPipelineExecutionStepFailureRequest] (val x: Self) extends AnyVal {
