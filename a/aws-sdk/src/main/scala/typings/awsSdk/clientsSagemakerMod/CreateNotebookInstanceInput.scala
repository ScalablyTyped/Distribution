...
trait CreateNotebookInstanceInput extends StObject {
  ...
  /**
    ...
    */
  var DirectInternetAccess: js.UndefOr[typings.awsSdk.clientsSagemakerMod.DirectInternetAccess] = js.undefined
  ...
  /**
    ...
    */
  var PlatformIdentifier: js.UndefOr[typings.awsSdk.clientsSagemakerMod.PlatformIdentifier] = js.undefined
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typings.awsSdk.clientsSagemakerMod.SecurityGroupIds] = js.undefined
  
  /**
    * The ID of the subnet in a VPC to which you would like to have a connectivity from your ML compute instance. 
    */
  var SubnetId: js.UndefOr[typings.awsSdk.clientsSagemakerMod.SubnetId] = js.undefined
...
object CreateNotebookInstanceInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateNotebookInstanceInput] (val x: Self) extends AnyVal {
