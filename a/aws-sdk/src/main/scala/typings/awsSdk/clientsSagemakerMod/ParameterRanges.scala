...
trait ParameterRanges extends StObject {
  ...
  /**
    ...
    */
  var CategoricalParameterRanges: js.UndefOr[typings.awsSdk.clientsSagemakerMod.CategoricalParameterRanges] = js.undefined
  
  /**
    * The array of ContinuousParameterRange objects that specify ranges of continuous hyperparameters that a hyperparameter tuning job searches.
    */
  var ContinuousParameterRanges: js.UndefOr[typings.awsSdk.clientsSagemakerMod.ContinuousParameterRanges] = js.undefined
  
  /**
    * The array of IntegerParameterRange objects that specify ranges of integer hyperparameters that a hyperparameter tuning job searches.
    */
  var IntegerParameterRanges: js.UndefOr[typings.awsSdk.clientsSagemakerMod.IntegerParameterRanges] = js.undefined
}
