...
trait MonitoringJobDefinition extends StObject {
  ...
  /**
    ...
    */
  var MonitoringAppSpecification: typings.awsSdk.clientsSagemakerMod.MonitoringAppSpecification
  
  /**
    * The array of inputs for the monitoring job. Currently we support monitoring an Amazon SageMaker Endpoint.
    */
  var MonitoringInputs: typings.awsSdk.clientsSagemakerMod.MonitoringInputs
  
  /**
    * The array of outputs from the monitoring job to be uploaded to Amazon Simple Storage Service (Amazon S3).
    */
  var MonitoringOutputConfig: typings.awsSdk.clientsSagemakerMod.MonitoringOutputConfig
  
  /**
    * Identifies the resources, ML compute instances, and ML storage volumes to deploy for a monitoring job. In distributed processing, you specify more than one instance.
    */
  var MonitoringResources: typings.awsSdk.clientsSagemakerMod.MonitoringResources
...
object MonitoringJobDefinition {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MonitoringJobDefinition] (val x: Self) extends AnyVal {
