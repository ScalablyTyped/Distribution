...
trait ListModelPackageGroupsOutput extends StObject {
  ...
  /**
    ...
    */
  var ModelPackageGroupSummaryList: typings.awsSdk.clientsSagemakerMod.ModelPackageGroupSummaryList
...
object ListModelPackageGroupsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListModelPackageGroupsOutput] (val x: Self) extends AnyVal {
