...
trait ModelCardVersionSummary extends StObject {
...
object ModelCardVersionSummary {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(CreationTime = CreationTime.asInstanceOf[js.Any], ModelCardArn = ModelCardArn.asInstanceOf[js.Any], ModelCardName = ModelCardName.asInstanceOf[js.Any], ModelCardStatus = ModelCardStatus.asInstanceOf[js.Any], ModelCardVersion = ModelCardVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModelCardVersionSummary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ModelCardVersionSummary] (val x: Self) extends AnyVal {
