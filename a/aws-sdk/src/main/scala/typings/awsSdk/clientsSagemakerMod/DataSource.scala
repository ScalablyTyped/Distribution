...
trait DataSource extends StObject {
  ...
  /**
    ...
    */
  var FileSystemDataSource: js.UndefOr[typings.awsSdk.clientsSagemakerMod.FileSystemDataSource] = js.undefined
  
  /**
    * The S3 location of the data source that is associated with a channel.
    */
  var S3DataSource: js.UndefOr[typings.awsSdk.clientsSagemakerMod.S3DataSource] = js.undefined
}
object DataSource {
