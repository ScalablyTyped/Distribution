...
trait DescribeLabelingJobResponse extends StObject {
  ...
  /**
    ...
    */
  var LabelAttributeName: js.UndefOr[typings.awsSdk.clientsSagemakerMod.LabelAttributeName] = js.undefined
...
object DescribeLabelingJobResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeLabelingJobResponse] (val x: Self) extends AnyVal {
