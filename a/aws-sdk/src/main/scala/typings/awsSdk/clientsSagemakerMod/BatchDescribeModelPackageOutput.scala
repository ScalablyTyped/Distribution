...
trait BatchDescribeModelPackageOutput extends StObject {
  ...
  /**
    ...
    */
  var BatchDescribeModelPackageErrorMap: js.UndefOr[typings.awsSdk.clientsSagemakerMod.BatchDescribeModelPackageErrorMap] = js.undefined
  
  /**
    * The summaries for the model package versions
    */
  var ModelPackageSummaries: js.UndefOr[typings.awsSdk.clientsSagemakerMod.ModelPackageSummaries] = js.undefined
}
