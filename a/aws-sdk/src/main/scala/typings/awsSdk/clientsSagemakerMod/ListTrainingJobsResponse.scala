...
trait ListTrainingJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var TrainingJobSummaries: typings.awsSdk.clientsSagemakerMod.TrainingJobSummaries
}
object ListTrainingJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTrainingJobsResponse] (val x: Self) extends AnyVal {
