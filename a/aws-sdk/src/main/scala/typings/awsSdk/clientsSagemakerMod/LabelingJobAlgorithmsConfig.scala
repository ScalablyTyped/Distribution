...
trait LabelingJobAlgorithmsConfig extends StObject {
  ...
  /**
    ...
    */
  var LabelingJobAlgorithmSpecificationArn: typings.awsSdk.clientsSagemakerMod.LabelingJobAlgorithmSpecificationArn
  
  /**
    * Provides configuration information for a labeling job.
    */
  var LabelingJobResourceConfig: js.UndefOr[typings.awsSdk.clientsSagemakerMod.LabelingJobResourceConfig] = js.undefined
}
object LabelingJobAlgorithmsConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LabelingJobAlgorithmsConfig] (val x: Self) extends AnyVal {
