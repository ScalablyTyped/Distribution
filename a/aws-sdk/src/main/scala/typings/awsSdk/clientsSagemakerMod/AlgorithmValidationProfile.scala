...
trait AlgorithmValidationProfile extends StObject {
  ...
  /**
    ...
    */
  var TrainingJobDefinition: typings.awsSdk.clientsSagemakerMod.TrainingJobDefinition
  
  /**
    * The TransformJobDefinition object that describes the transform job that SageMaker runs to validate your algorithm.
    */
  var TransformJobDefinition: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TransformJobDefinition] = js.undefined
}
