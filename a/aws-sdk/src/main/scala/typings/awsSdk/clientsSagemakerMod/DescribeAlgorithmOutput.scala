...
trait DescribeAlgorithmOutput extends StObject {
  ...
  /**
    ...
    */
  var AlgorithmStatusDetails: typings.awsSdk.clientsSagemakerMod.AlgorithmStatusDetails
...
object DescribeAlgorithmOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAlgorithmOutput] (val x: Self) extends AnyVal {
