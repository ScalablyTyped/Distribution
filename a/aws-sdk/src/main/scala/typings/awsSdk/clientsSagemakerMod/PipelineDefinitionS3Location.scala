...
trait PipelineDefinitionS3Location extends StObject {
  ...
  /**
    ...
    */
  var VersionId: js.UndefOr[typings.awsSdk.clientsSagemakerMod.VersionId] = js.undefined
}
object PipelineDefinitionS3Location {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipelineDefinitionS3Location] (val x: Self) extends AnyVal {
