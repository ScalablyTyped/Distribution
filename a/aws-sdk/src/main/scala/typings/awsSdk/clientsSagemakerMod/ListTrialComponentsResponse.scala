...
trait ListTrialComponentsResponse extends StObject {
  ...
  /**
    ...
    */
  var TrialComponentSummaries: js.UndefOr[typings.awsSdk.clientsSagemakerMod.TrialComponentSummaries] = js.undefined
}
object ListTrialComponentsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTrialComponentsResponse] (val x: Self) extends AnyVal {
