...
trait CreateStudioLifecycleConfigRequest extends StObject {
  ...
  /**
    ...
    */
  var StudioLifecycleConfigAppType: typings.awsSdk.clientsSagemakerMod.StudioLifecycleConfigAppType
  
  /**
    * The content of your Studio Lifecycle Configuration script. This content must be base64 encoded.
    */
  var StudioLifecycleConfigContent: typings.awsSdk.clientsSagemakerMod.StudioLifecycleConfigContent
...
object CreateStudioLifecycleConfigRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateStudioLifecycleConfigRequest] (val x: Self) extends AnyVal {
