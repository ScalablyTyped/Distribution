...
trait CreateWorkforceRequest extends StObject {
  ...
  /**
    ...
    */
  var OidcConfig: js.UndefOr[typings.awsSdk.clientsSagemakerMod.OidcConfig] = js.undefined
...
object CreateWorkforceRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateWorkforceRequest] (val x: Self) extends AnyVal {
