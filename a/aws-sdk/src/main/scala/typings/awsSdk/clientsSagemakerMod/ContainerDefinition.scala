...
trait ContainerDefinition extends StObject {
  ...
  /**
    ...
    */
  var ImageConfig: js.UndefOr[typings.awsSdk.clientsSagemakerMod.ImageConfig] = js.undefined
  ...
  /**
    ...
    */
  var MultiModelConfig: js.UndefOr[typings.awsSdk.clientsSagemakerMod.MultiModelConfig] = js.undefined
}
object ContainerDefinition {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ContainerDefinition] (val x: Self) extends AnyVal {
