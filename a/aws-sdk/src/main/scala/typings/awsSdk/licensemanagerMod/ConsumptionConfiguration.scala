...
trait ConsumptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var BorrowConfiguration: js.UndefOr[typings.awsSdk.licensemanagerMod.BorrowConfiguration] = js.undefined
  
  /**
    * Details about a provisional configuration.
    */
  var ProvisionalConfiguration: js.UndefOr[typings.awsSdk.licensemanagerMod.ProvisionalConfiguration] = js.undefined
  
  /**
    * Renewal frequency.
    */
  var RenewType: js.UndefOr[typings.awsSdk.licensemanagerMod.RenewType] = js.undefined
}
