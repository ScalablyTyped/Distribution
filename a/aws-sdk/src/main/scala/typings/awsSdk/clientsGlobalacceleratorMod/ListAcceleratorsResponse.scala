...
trait ListAcceleratorsResponse extends StObject {
  ...
  /**
    ...
    */
  var Accelerators: js.UndefOr[typings.awsSdk.clientsGlobalacceleratorMod.Accelerators] = js.undefined
...
object ListAcceleratorsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAcceleratorsResponse] (val x: Self) extends AnyVal {
