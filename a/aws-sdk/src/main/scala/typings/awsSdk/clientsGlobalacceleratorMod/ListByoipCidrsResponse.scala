...
trait ListByoipCidrsResponse extends StObject {
  ...
  /**
    ...
    */
  var ByoipCidrs: js.UndefOr[typings.awsSdk.clientsGlobalacceleratorMod.ByoipCidrs] = js.undefined
...
object ListByoipCidrsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListByoipCidrsResponse] (val x: Self) extends AnyVal {
