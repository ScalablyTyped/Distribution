...
trait StartSchemaExtensionRequest extends StObject {
  ...
  /**
    ...
    */
  var CreateSnapshotBeforeSchemaExtension: typings.awsSdk.directoryserviceMod.CreateSnapshotBeforeSchemaExtension
  
  /**
    * A description of the schema extension.
    */
  var Description: typings.awsSdk.directoryserviceMod.Description
  ...
  /**
    ...
    */
  var LdifContent: typings.awsSdk.directoryserviceMod.LdifContent
}
