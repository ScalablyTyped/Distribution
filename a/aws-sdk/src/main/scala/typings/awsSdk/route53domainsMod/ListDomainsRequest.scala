...
trait ListDomainsRequest extends StObject {
  ...
  /**
    ...
    */
  var FilterConditions: js.UndefOr[typings.awsSdk.route53domainsMod.FilterConditions] = js.undefined
  ...
  /**
    ...
    */
  var SortCondition: js.UndefOr[typings.awsSdk.route53domainsMod.SortCondition] = js.undefined
}
