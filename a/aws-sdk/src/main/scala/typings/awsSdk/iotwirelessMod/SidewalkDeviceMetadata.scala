...
trait SidewalkDeviceMetadata extends StObject {
  ...
  /**
    ...
    */
  var BatteryLevel: js.UndefOr[typings.awsSdk.iotwirelessMod.BatteryLevel] = js.undefined
  
  /**
    * Device state defines the device status of sidewalk device.
    */
  var DeviceState: js.UndefOr[typings.awsSdk.iotwirelessMod.DeviceState] = js.undefined
  
  /**
    * Sidewalk device status notification.
    */
  var Event: js.UndefOr[typings.awsSdk.iotwirelessMod.Event] = js.undefined
