...
trait EventConfigurationItem extends StObject {
  ...
  /**
    ...
    */
  var Identifier: js.UndefOr[typings.awsSdk.iotwirelessMod.Identifier] = js.undefined
  
  /**
    * Identifier type of the particular resource identifier for event configuration.
    */
  var IdentifierType: js.UndefOr[typings.awsSdk.iotwirelessMod.IdentifierType] = js.undefined
