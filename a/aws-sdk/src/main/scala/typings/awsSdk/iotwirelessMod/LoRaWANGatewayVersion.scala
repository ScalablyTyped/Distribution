...
trait LoRaWANGatewayVersion extends StObject {
  ...
  /**
    ...
    */
  var Model: js.UndefOr[typings.awsSdk.iotwirelessMod.Model] = js.undefined
  
  /**
    * The version of the wireless gateway firmware.
    */
  var PackageVersion: js.UndefOr[typings.awsSdk.iotwirelessMod.PackageVersion] = js.undefined
  
  /**
    * The basic station version of the wireless gateway.
    */
  var Station: js.UndefOr[typings.awsSdk.iotwirelessMod.Station] = js.undefined
}
