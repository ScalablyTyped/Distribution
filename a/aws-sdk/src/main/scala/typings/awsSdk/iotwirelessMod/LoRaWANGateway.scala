...
trait LoRaWANGateway extends StObject {
  ...
  /**
    ...
    */
  var Beaconing: js.UndefOr[typings.awsSdk.iotwirelessMod.Beaconing] = js.undefined
  ...
  var SubBands: js.UndefOr[typings.awsSdk.iotwirelessMod.SubBands] = js.undefined
}
