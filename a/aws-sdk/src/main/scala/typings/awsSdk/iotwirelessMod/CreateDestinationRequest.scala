...
trait CreateDestinationRequest extends StObject {
  ...
  /**
    ...
    */
  var Expression: typings.awsSdk.iotwirelessMod.Expression
  
  /**
    * The type of value in Expression.
    */
  var ExpressionType: typings.awsSdk.iotwirelessMod.ExpressionType
  ...
  /**
    ...
    */
  var RoleArn: typings.awsSdk.iotwirelessMod.RoleArn
