...
trait CreateSamplingRuleRequest extends StObject {
  ...
  /**
    * The rule definition.
    */
  var SamplingRule: typings.awsSdk.clientsXrayMod.SamplingRule
...
object CreateSamplingRuleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateSamplingRuleRequest] (val x: Self) extends AnyVal {
