...
trait PutRuleGroupsNamespaceResponse extends StObject {
...
object PutRuleGroupsNamespaceResponse {
  ...
  inline def apply(arn: RuleGroupsNamespaceArn, name: RuleGroupsNamespaceName, status: RuleGroupsNamespaceStatus): PutRuleGroupsNamespaceResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutRuleGroupsNamespaceResponse] (val x: Self) extends AnyVal {
