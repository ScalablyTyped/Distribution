...
object ConfirmDeviceResponse {
  ...
  implicit class ConfirmDeviceResponseOps[Self <: ConfirmDeviceResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUserConfirmationNecessary(value: BooleanType): Self = this.set("UserConfirmationNecessary", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteUserConfirmationNecessary: Self = this.set("UserConfirmationNecessary", js.undefined)
  }
}
