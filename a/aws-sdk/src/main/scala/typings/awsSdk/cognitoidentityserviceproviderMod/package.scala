...
package object cognitoidentityserviceproviderMod {
  ...
  */
  ...
  type ClientConfiguration = typings.awsSdk.serviceMod.ServiceConfigurationOptions with typings.awsSdk.cognitoidentityserviceproviderMod.ClientApiVersions
