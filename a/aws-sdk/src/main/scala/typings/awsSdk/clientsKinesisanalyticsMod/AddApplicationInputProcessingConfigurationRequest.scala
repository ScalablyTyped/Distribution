...
trait AddApplicationInputProcessingConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var InputProcessingConfiguration: typings.awsSdk.clientsKinesisanalyticsMod.InputProcessingConfiguration
}
object AddApplicationInputProcessingConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AddApplicationInputProcessingConfigurationRequest] (val x: Self) extends AnyVal {
