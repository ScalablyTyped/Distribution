...
trait InputDescription extends StObject {
  ...
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.InAppStreamNames] = js.undefined
  ...
  var InputProcessingConfigurationDescription: js.UndefOr[
    typings.awsSdk.clientsKinesisanalyticsMod.InputProcessingConfigurationDescription
  ] = js.undefined
  ...
  /**
    ...
    */
  var KinesisFirehoseInputDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.KinesisFirehoseInputDescription] = js.undefined
  
  /**
    * If an Amazon Kinesis stream is configured as streaming source, provides Amazon Kinesis stream's Amazon Resource Name (ARN) and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisStreamsInputDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.KinesisStreamsInputDescription] = js.undefined
