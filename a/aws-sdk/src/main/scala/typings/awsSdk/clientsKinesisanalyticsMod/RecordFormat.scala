...
trait RecordFormat extends StObject {
  ...
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.MappingParameters] = js.undefined
  
  /**
    * The type of record format.
    */
  var RecordFormatType: typings.awsSdk.clientsKinesisanalyticsMod.RecordFormatType
}
object RecordFormat {
