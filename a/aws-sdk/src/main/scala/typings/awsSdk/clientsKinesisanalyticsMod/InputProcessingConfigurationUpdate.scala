...
trait InputProcessingConfigurationUpdate extends StObject {
  ...
  /**
    ...
    */
  var InputLambdaProcessorUpdate: typings.awsSdk.clientsKinesisanalyticsMod.InputLambdaProcessorUpdate
}
object InputProcessingConfigurationUpdate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InputProcessingConfigurationUpdate] (val x: Self) extends AnyVal {
