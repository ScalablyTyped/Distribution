...
trait ApplicationUpdate extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLoggingOptionUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.CloudWatchLoggingOptionUpdates] = js.undefined
  
  /**
    * Describes application input configuration updates.
    */
  var InputUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.InputUpdates] = js.undefined
  
  /**
    * Describes application output configuration updates.
    */
  var OutputUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.OutputUpdates] = js.undefined
  
  /**
    * Describes application reference data source updates.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsMod.ReferenceDataSourceUpdates] = js.undefined
}
object ApplicationUpdate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicationUpdate] (val x: Self) extends AnyVal {
