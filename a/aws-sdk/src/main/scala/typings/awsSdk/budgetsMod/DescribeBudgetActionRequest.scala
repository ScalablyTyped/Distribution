...
object DescribeBudgetActionRequest {
  ...
  @scala.inline
  def apply(AccountId: AccountId, ActionId: ActionId, BudgetName: BudgetName): DescribeBudgetActionRequest = {
  ...
  @scala.inline
  implicit class DescribeBudgetActionRequestMutableBuilder[Self <: DescribeBudgetActionRequest] (val x: Self) extends AnyVal {
