...
trait DeauthorizeConnectionResponse extends StObject {
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.ConnectionArn] = js.undefined
  
  /**
    * The state of the connection.
    */
  var ConnectionState: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.ConnectionState] = js.undefined
...
object DeauthorizeConnectionResponse {
  ...
  extension [Self <: DeauthorizeConnectionResponse](x: Self) {
