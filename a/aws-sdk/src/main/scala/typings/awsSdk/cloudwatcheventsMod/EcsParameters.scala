...
trait EcsParameters extends StObject {
  ...
  /**
    ...
    */
  var CapacityProviderStrategy: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.CapacityProviderStrategy] = js.undefined
  ...
  /**
    ...
    */
  var PlacementConstraints: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.PlacementConstraints] = js.undefined
  ...
  /**
    ...
    */
  var PropagateTags: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.PropagateTags] = js.undefined
  
  /**
    * The reference ID to use for the task.
    */
  var ReferenceId: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.ReferenceId] = js.undefined
