...
trait RedshiftDataParameters extends StObject {
  ...
  /**
    ...
    */
  var Database: typings.awsSdk.cloudwatcheventsMod.Database = js.native
  
  /**
    * The database user name. Required when authenticating using temporary credentials.
    */
  var DbUser: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.DbUser] = js.native
  ...
  /**
    ...
    */
  var Sql: typings.awsSdk.cloudwatcheventsMod.Sql = js.native
  
  /**
    * The name of the SQL statement. You can name the SQL statement when you create it to identify the query.
    */
  var StatementName: js.UndefOr[typings.awsSdk.cloudwatcheventsMod.StatementName] = js.native
