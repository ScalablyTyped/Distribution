...
trait CreateApplicationRequest extends StObject {
  ...
  /**
    ...
    */
  var AutoCreate: js.UndefOr[typings.awsSdk.applicationinsightsMod.AutoCreate] = js.undefined
  ...
  /**
    ...
    */
  var GroupingType: js.UndefOr[typings.awsSdk.applicationinsightsMod.GroupingType] = js.undefined
