...
trait UpdateSafetyRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var AssertionRuleUpdate: js.UndefOr[typings.awsSdk.route53recoverycontrolconfigMod.AssertionRuleUpdate] = js.undefined
  
  /**
    * The gating rule to update.
    */
  var GatingRuleUpdate: js.UndefOr[typings.awsSdk.route53recoverycontrolconfigMod.GatingRuleUpdate] = js.undefined
}
