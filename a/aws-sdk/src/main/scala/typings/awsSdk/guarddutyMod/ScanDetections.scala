...
trait ScanDetections extends StObject {
  ...
  /**
    ...
    */
  var HighestSeverityThreatDetails: js.UndefOr[typings.awsSdk.guarddutyMod.HighestSeverityThreatDetails] = js.undefined
  
  /**
    * Total number of scanned files.
    */
  var ScannedItemCount: js.UndefOr[typings.awsSdk.guarddutyMod.ScannedItemCount] = js.undefined
  
  /**
    * Contains details about identified threats organized by threat name.
    */
  var ThreatDetectedByName: js.UndefOr[typings.awsSdk.guarddutyMod.ThreatDetectedByName] = js.undefined
  
  /**
    * Total number of infected files.
    */
  var ThreatsDetectedItemCount: js.UndefOr[typings.awsSdk.guarddutyMod.ThreatsDetectedItemCount] = js.undefined
}
