...
@js.native
trait ListThreatIntelSetsRequest extends StObject {
...
object ListThreatIntelSetsRequest {
  ...
  @scala.inline
  implicit class ListThreatIntelSetsRequestMutableBuilder[Self <: ListThreatIntelSetsRequest] (val x: Self) extends AnyVal {
