...
trait MetricSetDataQualityMetric extends StObject {
  ...
  /**
    ...
    */
  var DataQualityMetricList: js.UndefOr[typings.awsSdk.clientsLookoutmetricsMod.DataQualityMetricList] = js.undefined
...
object MetricSetDataQualityMetric {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MetricSetDataQualityMetric] (val x: Self) extends AnyVal {
