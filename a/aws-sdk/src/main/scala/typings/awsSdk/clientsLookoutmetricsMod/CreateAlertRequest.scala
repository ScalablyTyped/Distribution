...
trait CreateAlertRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: typings.awsSdk.clientsLookoutmetricsMod.Action
  
  /**
    * A description of the alert.
    */
  var AlertDescription: js.UndefOr[typings.awsSdk.clientsLookoutmetricsMod.AlertDescription] = js.undefined
  
  /**
    * The configuration of the alert filters, containing MetricList and DimensionFilterList.
    */
  var AlertFilters: js.UndefOr[typings.awsSdk.clientsLookoutmetricsMod.AlertFilters] = js.undefined
  
  /**
    * The name of the alert.
    */
  var AlertName: typings.awsSdk.clientsLookoutmetricsMod.AlertName
...
object CreateAlertRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAlertRequest] (val x: Self) extends AnyVal {
