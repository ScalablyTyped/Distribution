...
trait ListAnomalyGroupTimeSeriesResponse extends StObject {
  ...
  /**
    ...
    */
  var TimeSeriesList: js.UndefOr[typings.awsSdk.clientsLookoutmetricsMod.TimeSeriesList] = js.undefined
  
  /**
    * Timestamps for the anomalous metrics.
    */
  var TimestampList: js.UndefOr[typings.awsSdk.clientsLookoutmetricsMod.TimestampList] = js.undefined
}
