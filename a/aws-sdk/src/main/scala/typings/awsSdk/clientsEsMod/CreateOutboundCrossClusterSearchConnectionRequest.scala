...
trait CreateOutboundCrossClusterSearchConnectionRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectionAlias: typings.awsSdk.clientsEsMod.ConnectionAlias
...
object CreateOutboundCrossClusterSearchConnectionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateOutboundCrossClusterSearchConnectionRequest] (val x: Self) extends AnyVal {
