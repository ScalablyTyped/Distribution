...
trait CognitoOptions extends StObject {
  ...
  /**
    ...
    */
  var IdentityPoolId: js.UndefOr[typings.awsSdk.clientsEsMod.IdentityPoolId] = js.undefined
  
  /**
    * Specifies the role ARN that provides Elasticsearch permissions for accessing Cognito resources.
    */
  var RoleArn: js.UndefOr[typings.awsSdk.clientsEsMod.RoleArn] = js.undefined
  
  /**
    * Specifies the Cognito user pool ID for Kibana authentication.
    */
  var UserPoolId: js.UndefOr[typings.awsSdk.clientsEsMod.UserPoolId] = js.undefined
}
