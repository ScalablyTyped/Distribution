...
trait DomainPackageDetails extends StObject {
  ...
  /**
    ...
    */
  var DomainPackageStatus: js.UndefOr[typings.awsSdk.clientsEsMod.DomainPackageStatus] = js.undefined
  
  /**
    * Additional information if the package is in an error state. Null otherwise.
    */
  var ErrorDetails: js.UndefOr[typings.awsSdk.clientsEsMod.ErrorDetails] = js.undefined
  ...
  /**
    ...
    */
  var PackageName: js.UndefOr[typings.awsSdk.clientsEsMod.PackageName] = js.undefined
  
  /**
    * Currently supports only TXT-DICTIONARY.
    */
  var PackageType: js.UndefOr[typings.awsSdk.clientsEsMod.PackageType] = js.undefined
  
  var PackageVersion: js.UndefOr[typings.awsSdk.clientsEsMod.PackageVersion] = js.undefined
  
  /**
    * The relative path on Amazon ES nodes, which can be used as synonym_path when the package is synonym file.
    */
  var ReferencePath: js.UndefOr[typings.awsSdk.clientsEsMod.ReferencePath] = js.undefined
}
