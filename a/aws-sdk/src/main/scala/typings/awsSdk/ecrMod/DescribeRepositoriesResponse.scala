...
object DescribeRepositoriesResponse {
  ...
  extension [Self <: DescribeRepositoriesResponse](x: Self) {
    ...
    inline def setRepositoriesVarargs(value: Repository*): Self = StObject.set(x, "repositories", js.Array(value :_*))
  }
}
