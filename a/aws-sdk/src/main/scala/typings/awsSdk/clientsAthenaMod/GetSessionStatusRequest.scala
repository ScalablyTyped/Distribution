...
trait GetSessionStatusRequest extends StObject {
...
object GetSessionStatusRequest {
  ...
  inline def apply(SessionId: SessionId): GetSessionStatusRequest = {
    val __obj = js.Dynamic.literal(SessionId = SessionId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetSessionStatusRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSessionStatusRequest] (val x: Self) extends AnyVal {
