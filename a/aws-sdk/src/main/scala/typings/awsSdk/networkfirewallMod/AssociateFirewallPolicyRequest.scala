...
object AssociateFirewallPolicyRequest {
  ...
  @scala.inline
  def apply(FirewallPolicyArn: ResourceArn): AssociateFirewallPolicyRequest = {
  ...
  @scala.inline
  implicit class AssociateFirewallPolicyRequestMutableBuilder[Self <: AssociateFirewallPolicyRequest] (val x: Self) extends AnyVal {
