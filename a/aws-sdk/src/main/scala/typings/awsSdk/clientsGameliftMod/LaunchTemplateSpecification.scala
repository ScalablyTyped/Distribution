...
trait LaunchTemplateSpecification extends StObject {
  ...
  /**
    ...
    */
  var LaunchTemplateId: js.UndefOr[typings.awsSdk.clientsGameliftMod.LaunchTemplateId] = js.undefined
  
  /**
    * A readable identifier for an existing Amazon EC2 launch template. 
    */
  var LaunchTemplateName: js.UndefOr[typings.awsSdk.clientsGameliftMod.LaunchTemplateName] = js.undefined
