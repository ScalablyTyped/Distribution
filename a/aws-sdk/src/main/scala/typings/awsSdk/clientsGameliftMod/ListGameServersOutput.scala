...
trait ListGameServersOutput extends StObject {
  ...
  /**
    ...
    */
  var GameServers: js.UndefOr[typings.awsSdk.clientsGameliftMod.GameServers] = js.undefined
...
object ListGameServersOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListGameServersOutput] (val x: Self) extends AnyVal {
