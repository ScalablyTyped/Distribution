...
trait CreatePlayerSessionsInput extends StObject {
  ...
  /**
    ...
    */
  var PlayerDataMap: js.UndefOr[typings.awsSdk.clientsGameliftMod.PlayerDataMap] = js.undefined
...
object CreatePlayerSessionsInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatePlayerSessionsInput] (val x: Self) extends AnyVal {
