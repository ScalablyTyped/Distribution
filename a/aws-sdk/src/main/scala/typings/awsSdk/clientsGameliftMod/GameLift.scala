...
trait GameLift extends Service {
  ...
  @JSName("config")
  var config_GameLift: ConfigBase & ClientConfiguration = js.native
  ...
  /**
    ...
    */
  def createFleetLocations(): Request[CreateFleetLocationsOutput, AWSError] = js.native
  def createFleetLocations(callback: js.Function2[/* err */ AWSError, /* data */ CreateFleetLocationsOutput, Unit]): Request[CreateFleetLocationsOutput, AWSError] = js.native
  /**
    * Adds remote locations to a fleet and begins populating the new locations with EC2 instances. The new instances conform to the fleet's instance type, auto-scaling, and other configuration settings.   This operation cannot be used with fleets that don't support remote locations. Fleets can have multiple locations only if they reside in Amazon Web Services Regions that support this feature and were created after the feature was released in March 2021.  To add fleet locations, specify the fleet to be updated and provide a list of one or more locations.  If successful, this operation returns the list of added locations with their status set to NEW. Amazon GameLift initiates the process of starting an instance in each added location. You can track the status of each new location by monitoring location creation events using DescribeFleetEvents.  Learn more   Setting up fleets   Multi-location fleets 
    */
  def createFleetLocations(params: CreateFleetLocationsInput): Request[CreateFleetLocationsOutput, AWSError] = js.native
  def createFleetLocations(
    params: CreateFleetLocationsInput,
    callback: js.Function2[/* err */ AWSError, /* data */ CreateFleetLocationsOutput, Unit]
  ): Request[CreateFleetLocationsOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def createLocation(): Request[CreateLocationOutput, AWSError] = js.native
  def createLocation(callback: js.Function2[/* err */ AWSError, /* data */ CreateLocationOutput, Unit]): Request[CreateLocationOutput, AWSError] = js.native
  /**
    * Creates a custom location for use in an Anywhere fleet.
    */
  def createLocation(params: CreateLocationInput): Request[CreateLocationOutput, AWSError] = js.native
  def createLocation(
    params: CreateLocationInput,
    callback: js.Function2[/* err */ AWSError, /* data */ CreateLocationOutput, Unit]
  ): Request[CreateLocationOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def deleteFleetLocations(): Request[DeleteFleetLocationsOutput, AWSError] = js.native
  def deleteFleetLocations(callback: js.Function2[/* err */ AWSError, /* data */ DeleteFleetLocationsOutput, Unit]): Request[DeleteFleetLocationsOutput, AWSError] = js.native
  /**
    * Removes locations from a multi-location fleet. When deleting a location, all game server process and all instances that are still active in the location are shut down.  To delete fleet locations, identify the fleet ID and provide a list of the locations to be deleted.  If successful, GameLift sets the location status to DELETING, and begins to shut down existing server processes and terminate instances in each location being deleted. When completed, the location status changes to TERMINATED.  Learn more   Setting up Amazon GameLift fleets 
    */
  def deleteFleetLocations(params: DeleteFleetLocationsInput): Request[DeleteFleetLocationsOutput, AWSError] = js.native
  def deleteFleetLocations(
    params: DeleteFleetLocationsInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteFleetLocationsOutput, Unit]
  ): Request[DeleteFleetLocationsOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def deleteLocation(): Request[DeleteLocationOutput, AWSError] = js.native
  def deleteLocation(callback: js.Function2[/* err */ AWSError, /* data */ DeleteLocationOutput, Unit]): Request[DeleteLocationOutput, AWSError] = js.native
  /**
    * Deletes a custom location. Before deleting a custom location, review any fleets currently using the custom location and deregister the location if it is in use. For more information see, DeregisterCompute.
    */
  def deleteLocation(params: DeleteLocationInput): Request[DeleteLocationOutput, AWSError] = js.native
  def deleteLocation(
    params: DeleteLocationInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteLocationOutput, Unit]
  ): Request[DeleteLocationOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def deregisterCompute(): Request[DeregisterComputeOutput, AWSError] = js.native
  def deregisterCompute(callback: js.Function2[/* err */ AWSError, /* data */ DeregisterComputeOutput, Unit]): Request[DeregisterComputeOutput, AWSError] = js.native
  /**
    * Removes a compute resource from the specified fleet. Deregister your compute resources before you delete the compute.
    */
  def deregisterCompute(params: DeregisterComputeInput): Request[DeregisterComputeOutput, AWSError] = js.native
  def deregisterCompute(
    params: DeregisterComputeInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DeregisterComputeOutput, Unit]
  ): Request[DeregisterComputeOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeCompute(): Request[DescribeComputeOutput, AWSError] = js.native
  def describeCompute(callback: js.Function2[/* err */ AWSError, /* data */ DescribeComputeOutput, Unit]): Request[DescribeComputeOutput, AWSError] = js.native
  /**
    * Retrieves properties for a compute resource. To request a compute resource specify the fleet ID and compute name. If successful, Amazon GameLift returns an object containing the build properties.
    */
  def describeCompute(params: DescribeComputeInput): Request[DescribeComputeOutput, AWSError] = js.native
  def describeCompute(
    params: DescribeComputeInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeComputeOutput, Unit]
  ): Request[DescribeComputeOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeFleetLocationAttributes(): Request[DescribeFleetLocationAttributesOutput, AWSError] = js.native
  def describeFleetLocationAttributes(callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetLocationAttributesOutput, Unit]): Request[DescribeFleetLocationAttributesOutput, AWSError] = js.native
  /**
    * Retrieves information on a fleet's remote locations, including life-cycle status and any suspended fleet activity.  This operation can be used in the following ways:    To get data for specific locations, provide a fleet identifier and a list of locations. Location data is returned in the order that it is requested.    To get data for all locations, provide a fleet identifier only. Location data is returned in no particular order.    When requesting attributes for multiple locations, use the pagination parameters to retrieve results as a set of sequential pages.  If successful, a LocationAttributes object is returned for each requested location. If the fleet does not have a requested location, no information is returned. This operation does not return the home Region. To get information on a fleet's home Region, call DescribeFleetAttributes.  Learn more   Setting up Amazon GameLift fleets 
    */
  def describeFleetLocationAttributes(params: DescribeFleetLocationAttributesInput): Request[DescribeFleetLocationAttributesOutput, AWSError] = js.native
  def describeFleetLocationAttributes(
    params: DescribeFleetLocationAttributesInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetLocationAttributesOutput, Unit]
  ): Request[DescribeFleetLocationAttributesOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeFleetLocationCapacity(): Request[DescribeFleetLocationCapacityOutput, AWSError] = js.native
  def describeFleetLocationCapacity(callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetLocationCapacityOutput, Unit]): Request[DescribeFleetLocationCapacityOutput, AWSError] = js.native
  /**
    * Retrieves the resource capacity settings for a fleet location. The data returned includes the current capacity (number of EC2 instances) and some scaling settings for the requested fleet location. Use this operation to retrieve capacity information for a fleet's remote location or home Region (you can also retrieve home Region capacity by calling DescribeFleetCapacity). To retrieve capacity data, identify a fleet and location.  If successful, a FleetCapacity object is returned for the requested fleet location.   Learn more   Setting up Amazon GameLift fleets   GameLift metrics for fleets 
    */
  def describeFleetLocationCapacity(params: DescribeFleetLocationCapacityInput): Request[DescribeFleetLocationCapacityOutput, AWSError] = js.native
  def describeFleetLocationCapacity(
    params: DescribeFleetLocationCapacityInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetLocationCapacityOutput, Unit]
  ): Request[DescribeFleetLocationCapacityOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeFleetLocationUtilization(): Request[DescribeFleetLocationUtilizationOutput, AWSError] = js.native
  def describeFleetLocationUtilization(
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeFleetLocationUtilizationOutput, Unit]
  ): Request[DescribeFleetLocationUtilizationOutput, AWSError] = js.native
  /**
    * Retrieves current usage data for a fleet location. Utilization data provides a snapshot of current game hosting activity at the requested location. Use this operation to retrieve utilization information for a fleet's remote location or home Region (you can also retrieve home Region utilization by calling DescribeFleetUtilization). To retrieve utilization data, identify a fleet and location.  If successful, a FleetUtilization object is returned for the requested fleet location.   Learn more   Setting up Amazon GameLift fleets   GameLift metrics for fleets 
    */
  def describeFleetLocationUtilization(params: DescribeFleetLocationUtilizationInput): Request[DescribeFleetLocationUtilizationOutput, AWSError] = js.native
  def describeFleetLocationUtilization(
  ...
  /**
    ...
    */
  def getComputeAccess(): Request[GetComputeAccessOutput, AWSError] = js.native
  def getComputeAccess(callback: js.Function2[/* err */ AWSError, /* data */ GetComputeAccessOutput, Unit]): Request[GetComputeAccessOutput, AWSError] = js.native
  /**
    * Requests remote access to a fleet instance. Remote access is useful for debugging, gathering benchmarking data, or observing activity in real time.  To remotely access an instance, you need credentials that match the operating system of the instance. For a Windows instance, Amazon GameLift returns a user name and password as strings for use with a Windows Remote Desktop client. For a Linux instance, Amazon GameLift returns a user name and RSA private key, also as strings, for use with an SSH client. The private key must be saved in the proper format to a .pem file before using. If you're making this request using the CLI, saving the secret can be handled as part of the GetInstanceAccess request, as shown in one of the examples for this operation.  To request access to a specific instance, specify the IDs of both the instance and the fleet it belongs to.  Learn more   Remotely Access Fleet Instances   Debug Fleet Issues 
    */
  def getComputeAccess(params: GetComputeAccessInput): Request[GetComputeAccessOutput, AWSError] = js.native
  def getComputeAccess(
    params: GetComputeAccessInput,
    callback: js.Function2[/* err */ AWSError, /* data */ GetComputeAccessOutput, Unit]
  ): Request[GetComputeAccessOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def getComputeAuthToken(): Request[GetComputeAuthTokenOutput, AWSError] = js.native
  def getComputeAuthToken(callback: js.Function2[/* err */ AWSError, /* data */ GetComputeAuthTokenOutput, Unit]): Request[GetComputeAuthTokenOutput, AWSError] = js.native
  /**
    * Requests an authentication token from Amazon GameLift. The authentication token is used by your game server to authenticate with Amazon GameLift. Each authentication token has an expiration time. To continue using the compute resource to host your game server, regularly retrieve a new authorization token.
    */
  def getComputeAuthToken(params: GetComputeAuthTokenInput): Request[GetComputeAuthTokenOutput, AWSError] = js.native
  def getComputeAuthToken(
    params: GetComputeAuthTokenInput,
    callback: js.Function2[/* err */ AWSError, /* data */ GetComputeAuthTokenOutput, Unit]
  ): Request[GetComputeAuthTokenOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def listCompute(): Request[ListComputeOutput, AWSError] = js.native
  def listCompute(callback: js.Function2[/* err */ AWSError, /* data */ ListComputeOutput, Unit]): Request[ListComputeOutput, AWSError] = js.native
  /**
    * Retrieves all compute resources registered to a fleet in your Amazon Web Services account. You can filter the result set by location.
    */
  def listCompute(params: ListComputeInput): Request[ListComputeOutput, AWSError] = js.native
  def listCompute(
    params: ListComputeInput,
    callback: js.Function2[/* err */ AWSError, /* data */ ListComputeOutput, Unit]
  ): Request[ListComputeOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def listLocations(): Request[ListLocationsOutput, AWSError] = js.native
  def listLocations(callback: js.Function2[/* err */ AWSError, /* data */ ListLocationsOutput, Unit]): Request[ListLocationsOutput, AWSError] = js.native
  /**
    * Lists all custom and Amazon Web Services locations.
    */
  def listLocations(params: ListLocationsInput): Request[ListLocationsOutput, AWSError] = js.native
  def listLocations(
    params: ListLocationsInput,
    callback: js.Function2[/* err */ AWSError, /* data */ ListLocationsOutput, Unit]
  ): Request[ListLocationsOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def registerCompute(): Request[RegisterComputeOutput, AWSError] = js.native
  def registerCompute(callback: js.Function2[/* err */ AWSError, /* data */ RegisterComputeOutput, Unit]): Request[RegisterComputeOutput, AWSError] = js.native
  /**
    * Registers your compute resources in a fleet you previously created. After you register a compute to your fleet, you can monitor and manage your compute using Amazon GameLift. The operation returns the compute resource containing SDK endpoint you can use to connect your game server to Amazon GameLift.  Learn more     Create an Anywhere fleet     Test your integration   
    */
  def registerCompute(params: RegisterComputeInput): Request[RegisterComputeOutput, AWSError] = js.native
  def registerCompute(
    params: RegisterComputeInput,
    callback: js.Function2[/* err */ AWSError, /* data */ RegisterComputeOutput, Unit]
  ): Request[RegisterComputeOutput, AWSError] = js.native
