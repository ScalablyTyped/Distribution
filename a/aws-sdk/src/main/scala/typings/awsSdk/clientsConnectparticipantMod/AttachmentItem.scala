...
trait AttachmentItem extends StObject {
  ...
  /**
    ...
    */
  var AttachmentName: js.UndefOr[typings.awsSdk.clientsConnectparticipantMod.AttachmentName] = js.undefined
  
  /**
    * Describes the MIME file type of the attachment. For a list of supported file types, see Feature specifications in the Amazon Connect Administrator Guide.
    */
  var ContentType: js.UndefOr[typings.awsSdk.clientsConnectparticipantMod.ContentType] = js.undefined
...
object AttachmentItem {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AttachmentItem] (val x: Self) extends AnyVal {
