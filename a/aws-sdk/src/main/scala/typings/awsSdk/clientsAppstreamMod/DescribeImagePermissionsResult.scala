...
trait DescribeImagePermissionsResult extends StObject {
  ...
  /**
    ...
    */
  var SharedImagePermissionsList: js.UndefOr[typings.awsSdk.clientsAppstreamMod.SharedImagePermissionsList] = js.undefined
}
object DescribeImagePermissionsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeImagePermissionsResult] (val x: Self) extends AnyVal {
