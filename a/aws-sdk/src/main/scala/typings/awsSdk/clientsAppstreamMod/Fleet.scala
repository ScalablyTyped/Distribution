...
trait Fleet extends StObject {
  ...
  /**
    ...
    */
  var ComputeCapacityStatus: typings.awsSdk.clientsAppstreamMod.ComputeCapacityStatus
  ...
  /**
    * The fleet errors.
    */
  var FleetErrors: js.UndefOr[typings.awsSdk.clientsAppstreamMod.FleetErrors] = js.undefined
...
object Fleet {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Fleet] (val x: Self) extends AnyVal {
