...
trait ListBridgesRequest extends StObject {
...
object ListBridgesRequest {
  
  inline def apply(): ListBridgesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListBridgesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListBridgesRequest] (val x: Self) extends AnyVal {
