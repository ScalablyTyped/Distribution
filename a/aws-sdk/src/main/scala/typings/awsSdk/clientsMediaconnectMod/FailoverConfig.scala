...
trait FailoverConfig extends StObject {
  ...
  /**
    ...
    */
  var FailoverMode: js.UndefOr[typings.awsSdk.clientsMediaconnectMod.FailoverMode] = js.undefined
  ...
  /**
    ...
    */
  var SourcePriority: js.UndefOr[typings.awsSdk.clientsMediaconnectMod.SourcePriority] = js.undefined
  
  var State: js.UndefOr[typings.awsSdk.clientsMediaconnectMod.State] = js.undefined
}
