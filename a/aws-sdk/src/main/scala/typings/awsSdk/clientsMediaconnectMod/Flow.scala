...
trait Flow extends StObject {
  ...
  var Maintenance: js.UndefOr[typings.awsSdk.clientsMediaconnectMod.Maintenance] = js.undefined
  ...
  var Source: typings.awsSdk.clientsMediaconnectMod.Source
  ...
  /**
    ...
    */
  var Status: typings.awsSdk.clientsMediaconnectMod.Status
