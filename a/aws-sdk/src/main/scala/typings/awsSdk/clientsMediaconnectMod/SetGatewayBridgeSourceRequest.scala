...
trait SetGatewayBridgeSourceRequest extends StObject {
...
object SetGatewayBridgeSourceRequest {
  
  inline def apply(BridgeArn: string): SetGatewayBridgeSourceRequest = {
    val __obj = js.Dynamic.literal(BridgeArn = BridgeArn.asInstanceOf[js.Any])
    __obj.asInstanceOf[SetGatewayBridgeSourceRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SetGatewayBridgeSourceRequest] (val x: Self) extends AnyVal {
