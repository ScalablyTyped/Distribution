...
trait ListGatewayInstancesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.clientsMediaconnectMod.MaxResults] = js.undefined
...
object ListGatewayInstancesRequest {
  
  inline def apply(): ListGatewayInstancesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListGatewayInstancesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListGatewayInstancesRequest] (val x: Self) extends AnyVal {
    
    inline def setFilterArn(value: string): Self = StObject.set(x, "FilterArn", value.asInstanceOf[js.Any])
