...
trait LaunchConfigurationTemplate extends StObject {
  ...
  /**
    ...
    */
  var ec2LaunchTemplateID: js.UndefOr[EC2LaunchConfigurationTemplateID] = js.undefined
...
object LaunchConfigurationTemplate {
  ...
  implicit open class MutableBuilder[Self <: LaunchConfigurationTemplate] (val x: Self) extends AnyVal {
    ...
    inline def setEc2LaunchTemplateID(value: EC2LaunchConfigurationTemplateID): Self = StObject.set(x, "ec2LaunchTemplateID", value.asInstanceOf[js.Any])
