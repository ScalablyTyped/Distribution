...
trait ListApplicationsRequest extends StObject {
  ...
  /**
    ...
    */
  var filters: js.UndefOr[ListApplicationsRequestFilters] = js.undefined
...
object ListApplicationsRequest {
  ...
  implicit open class MutableBuilder[Self <: ListApplicationsRequest] (val x: Self) extends AnyVal {
    ...
    inline def setFilters(value: ListApplicationsRequestFilters): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
