...
trait DomainSummary extends StObject {
  ...
  /**
    ...
    */
  var Arn: js.UndefOr[typings.awsSdk.voiceidMod.Arn] = js.undefined
  ...
  /**
    ...
    */
  var DomainStatus: js.UndefOr[typings.awsSdk.voiceidMod.DomainStatus] = js.undefined
  ...
  /**
    ...
    */
  var ServerSideEncryptionConfiguration: js.UndefOr[typings.awsSdk.voiceidMod.ServerSideEncryptionConfiguration] = js.undefined
  
  /**
    * Details about the most recent server-side encryption configuration update. When the server-side encryption configuration is changed, dependency on the old KMS key is removed through an asynchronous process. When this update is complete, the domain's data can only be accessed using the new KMS key.
    */
  var ServerSideEncryptionUpdateDetails: js.UndefOr[typings.awsSdk.voiceidMod.ServerSideEncryptionUpdateDetails] = js.undefined
