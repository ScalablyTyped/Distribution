...
trait ListVirtualMachinesOutput extends StObject {
  ...
  /**
    ...
    */
  var VirtualMachines: js.UndefOr[typings.awsSdk.clientsBackupgatewayMod.VirtualMachines] = js.undefined
}
object ListVirtualMachinesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListVirtualMachinesOutput] (val x: Self) extends AnyVal {
