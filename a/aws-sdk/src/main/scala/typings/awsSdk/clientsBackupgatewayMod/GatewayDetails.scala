...
trait GatewayDetails extends StObject {
  ...
  /**
    ...
    */
  var MaintenanceStartTime: js.UndefOr[typings.awsSdk.clientsBackupgatewayMod.MaintenanceStartTime] = js.undefined
  ...
  /**
    ...
    */
  var VpcEndpoint: js.UndefOr[typings.awsSdk.clientsBackupgatewayMod.VpcEndpoint] = js.undefined
}
object GatewayDetails {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GatewayDetails] (val x: Self) extends AnyVal {
