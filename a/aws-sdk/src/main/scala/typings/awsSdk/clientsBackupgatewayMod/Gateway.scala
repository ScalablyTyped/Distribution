...
trait Gateway extends StObject {
  ...
  /**
    ...
    */
  var GatewayType: js.UndefOr[typings.awsSdk.clientsBackupgatewayMod.GatewayType] = js.undefined
  
  /**
    * The hypervisor ID of the gateway.
    */
  var HypervisorId: js.UndefOr[typings.awsSdk.clientsBackupgatewayMod.HypervisorId] = js.undefined
