...
@js.native
trait GetIntegrationResponseResponse extends StObject {
...
object GetIntegrationResponseResponse {
  ...
  @scala.inline
  def apply(): GetIntegrationResponseResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetIntegrationResponseResponse]
  }
  
  @scala.inline
  implicit class GetIntegrationResponseResponseMutableBuilder[Self <: GetIntegrationResponseResponse] (val x: Self) extends AnyVal {
