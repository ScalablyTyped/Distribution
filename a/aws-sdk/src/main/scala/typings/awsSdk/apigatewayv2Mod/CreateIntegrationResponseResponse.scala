...
object CreateIntegrationResponseResponse {
  ...
  @scala.inline
  def apply(): CreateIntegrationResponseResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateIntegrationResponseResponse]
  }
  
  @scala.inline
  implicit class CreateIntegrationResponseResponseMutableBuilder[Self <: CreateIntegrationResponseResponse] (val x: Self) extends AnyVal {
