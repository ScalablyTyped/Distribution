...
trait GetAuthorizerResponse extends StObject {
  ...
  /**
    ...
    */
  var AuthorizerType: js.UndefOr[typings.awsSdk.apigatewayv2Mod.AuthorizerType] = js.undefined
...
object GetAuthorizerResponse {
  ...
  @scala.inline
  implicit class GetAuthorizerResponseMutableBuilder[Self <: GetAuthorizerResponse] (val x: Self) extends AnyVal {
