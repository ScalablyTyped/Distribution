...
@js.native
trait CreateIntegrationResult extends StObject {
...
object CreateIntegrationResult {
  ...
  @scala.inline
  implicit class CreateIntegrationResultMutableBuilder[Self <: CreateIntegrationResult] (val x: Self) extends AnyVal {
