...
trait StartExpenseAnalysisRequest extends StObject {
...
object StartExpenseAnalysisRequest {
  ...
  inline def apply(DocumentLocation: DocumentLocation): StartExpenseAnalysisRequest = {
  ...
  extension [Self <: StartExpenseAnalysisRequest](x: Self) {
