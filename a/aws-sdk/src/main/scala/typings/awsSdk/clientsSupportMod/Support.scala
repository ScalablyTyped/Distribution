...
trait Support
  ...
  /**
    ...
    */
  def describeCreateCaseOptions(): Request[DescribeCreateCaseOptionsResponse, AWSError] = js.native
  def describeCreateCaseOptions(callback: js.Function2[/* err */ AWSError, /* data */ DescribeCreateCaseOptionsResponse, Unit]): Request[DescribeCreateCaseOptionsResponse, AWSError] = js.native
  /**
    * Returns a list of CreateCaseOption types along with the corresponding supported hours and language availability. You can specify the language categoryCode, issueType and serviceCode used to retrieve the CreateCaseOptions.    You must have a Business, Enterprise On-Ramp, or Enterprise Support plan to use the Amazon Web Services Support API.    If you call the Amazon Web Services Support API from an account that doesn't have a Business, Enterprise On-Ramp, or Enterprise Support plan, the SubscriptionRequiredException error message appears. For information about changing your support plan, see Amazon Web Services Support.   
    */
  def describeCreateCaseOptions(params: DescribeCreateCaseOptionsRequest): Request[DescribeCreateCaseOptionsResponse, AWSError] = js.native
  def describeCreateCaseOptions(
    params: DescribeCreateCaseOptionsRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeCreateCaseOptionsResponse, Unit]
  ): Request[DescribeCreateCaseOptionsResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeSupportedLanguages(): Request[DescribeSupportedLanguagesResponse, AWSError] = js.native
  def describeSupportedLanguages(callback: js.Function2[/* err */ AWSError, /* data */ DescribeSupportedLanguagesResponse, Unit]): Request[DescribeSupportedLanguagesResponse, AWSError] = js.native
  /**
    * Returns a list of supported languages for a specified categoryCode, issueType and serviceCode. The returned supported languages will include a ISO 639-1 code for the language, and the language display name.    You must have a Business, Enterprise On-Ramp, or Enterprise Support plan to use the Amazon Web Services Support API.    If you call the Amazon Web Services Support API from an account that doesn't have a Business, Enterprise On-Ramp, or Enterprise Support plan, the SubscriptionRequiredException error message appears. For information about changing your support plan, see Amazon Web Services Support.   
    */
  def describeSupportedLanguages(params: DescribeSupportedLanguagesRequest): Request[DescribeSupportedLanguagesResponse, AWSError] = js.native
  def describeSupportedLanguages(
    params: DescribeSupportedLanguagesRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeSupportedLanguagesResponse, Unit]
  ): Request[DescribeSupportedLanguagesResponse, AWSError] = js.native
