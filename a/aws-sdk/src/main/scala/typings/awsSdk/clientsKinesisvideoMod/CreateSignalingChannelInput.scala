...
trait CreateSignalingChannelInput extends StObject {
  ...
  /**
    ...
    */
  var ChannelName: typings.awsSdk.clientsKinesisvideoMod.ChannelName
...
object CreateSignalingChannelInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateSignalingChannelInput] (val x: Self) extends AnyVal {
