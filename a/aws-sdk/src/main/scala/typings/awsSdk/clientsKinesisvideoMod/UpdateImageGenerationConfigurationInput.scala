...
trait UpdateImageGenerationConfigurationInput extends StObject {
  ...
  /**
    ...
    */
  var ImageGenerationConfiguration: js.UndefOr[typings.awsSdk.clientsKinesisvideoMod.ImageGenerationConfiguration] = js.undefined
...
object UpdateImageGenerationConfigurationInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateImageGenerationConfigurationInput] (val x: Self) extends AnyVal {
