...
trait StartEdgeConfigurationUpdateOutput extends StObject {
...
object StartEdgeConfigurationUpdateOutput {
  
  inline def apply(): StartEdgeConfigurationUpdateOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StartEdgeConfigurationUpdateOutput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StartEdgeConfigurationUpdateOutput] (val x: Self) extends AnyVal {
