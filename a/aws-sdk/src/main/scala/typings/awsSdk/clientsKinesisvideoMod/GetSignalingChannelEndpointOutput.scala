...
trait GetSignalingChannelEndpointOutput extends StObject {
  ...
  /**
    ...
    */
  var ResourceEndpointList: js.UndefOr[typings.awsSdk.clientsKinesisvideoMod.ResourceEndpointList] = js.undefined
}
object GetSignalingChannelEndpointOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSignalingChannelEndpointOutput] (val x: Self) extends AnyVal {
