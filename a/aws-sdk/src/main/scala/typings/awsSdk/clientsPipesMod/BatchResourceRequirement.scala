...
trait BatchResourceRequirement extends StObject {
...
object BatchResourceRequirement {
  ...
  inline def apply(Type: BatchResourceRequirementType, Value: String): BatchResourceRequirement = {
    val __obj = js.Dynamic.literal(Type = Type.asInstanceOf[js.Any], Value = Value.asInstanceOf[js.Any])
    __obj.asInstanceOf[BatchResourceRequirement]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BatchResourceRequirement] (val x: Self) extends AnyVal {
    
    inline def setType(value: BatchResourceRequirementType): Self = StObject.set(x, "Type", value.asInstanceOf[js.Any])
