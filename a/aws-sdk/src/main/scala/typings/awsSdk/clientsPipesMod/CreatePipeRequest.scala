...
trait CreatePipeRequest extends StObject {
...
object CreatePipeRequest {
  ...
  inline def apply(Name: PipeName, RoleArn: RoleArn, Source: ArnOrUrl, Target: Arn): CreatePipeRequest = {
    val __obj = js.Dynamic.literal(Name = Name.asInstanceOf[js.Any], RoleArn = RoleArn.asInstanceOf[js.Any], Source = Source.asInstanceOf[js.Any], Target = Target.asInstanceOf[js.Any])
    __obj.asInstanceOf[CreatePipeRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatePipeRequest] (val x: Self) extends AnyVal {
