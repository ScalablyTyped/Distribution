...
trait CreatePipeResponse extends StObject {
...
object CreatePipeResponse {
  ...
  inline def apply(): CreatePipeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreatePipeResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatePipeResponse] (val x: Self) extends AnyVal {
