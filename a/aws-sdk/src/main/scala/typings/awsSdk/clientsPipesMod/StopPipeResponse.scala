...
trait StopPipeResponse extends StObject {
...
object StopPipeResponse {
  ...
  inline def apply(): StopPipeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StopPipeResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StopPipeResponse] (val x: Self) extends AnyVal {
