...
trait PipeSourceKinesisStreamParameters extends StObject {
...
object PipeSourceKinesisStreamParameters {
  ...
  inline def apply(StartingPosition: KinesisStreamStartPosition): PipeSourceKinesisStreamParameters = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeSourceKinesisStreamParameters] (val x: Self) extends AnyVal {
    ...
    inline def setStartingPosition(value: KinesisStreamStartPosition): Self = StObject.set(x, "StartingPosition", value.asInstanceOf[js.Any])
