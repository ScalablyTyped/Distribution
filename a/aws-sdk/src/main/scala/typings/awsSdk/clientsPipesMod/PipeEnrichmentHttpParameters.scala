...
trait PipeEnrichmentHttpParameters extends StObject {
...
object PipeEnrichmentHttpParameters {
  ...
  inline def apply(): PipeEnrichmentHttpParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PipeEnrichmentHttpParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeEnrichmentHttpParameters] (val x: Self) extends AnyVal {
