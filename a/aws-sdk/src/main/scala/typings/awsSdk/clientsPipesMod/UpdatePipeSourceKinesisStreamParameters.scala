...
trait UpdatePipeSourceKinesisStreamParameters extends StObject {
...
object UpdatePipeSourceKinesisStreamParameters {
  ...
  inline def apply(): UpdatePipeSourceKinesisStreamParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdatePipeSourceKinesisStreamParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdatePipeSourceKinesisStreamParameters] (val x: Self) extends AnyVal {
