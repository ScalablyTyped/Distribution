...
trait PipeSourceDynamoDBStreamParameters extends StObject {
...
object PipeSourceDynamoDBStreamParameters {
  ...
  inline def apply(StartingPosition: DynamoDBStreamStartPosition): PipeSourceDynamoDBStreamParameters = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeSourceDynamoDBStreamParameters] (val x: Self) extends AnyVal {
    ...
    inline def setStartingPosition(value: DynamoDBStreamStartPosition): Self = StObject.set(x, "StartingPosition", value.asInstanceOf[js.Any])
  }
}
