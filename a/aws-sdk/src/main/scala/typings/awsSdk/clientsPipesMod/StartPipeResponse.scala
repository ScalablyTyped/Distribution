...
trait StartPipeResponse extends StObject {
...
object StartPipeResponse {
  ...
  inline def apply(): StartPipeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StartPipeResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StartPipeResponse] (val x: Self) extends AnyVal {
