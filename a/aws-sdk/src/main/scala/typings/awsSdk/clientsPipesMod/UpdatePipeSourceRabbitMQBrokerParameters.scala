...
trait UpdatePipeSourceRabbitMQBrokerParameters extends StObject {
...
object UpdatePipeSourceRabbitMQBrokerParameters {
  ...
  inline def apply(Credentials: MQBrokerAccessCredentials): UpdatePipeSourceRabbitMQBrokerParameters = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdatePipeSourceRabbitMQBrokerParameters] (val x: Self) extends AnyVal {
