...
trait PipeTargetEcsTaskParameters extends StObject {
  ...
  /**
    ...
    */
  var CapacityProviderStrategy: js.UndefOr[typings.awsSdk.clientsPipesMod.CapacityProviderStrategy] = js.undefined
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typings.awsSdk.clientsPipesMod.LaunchType] = js.undefined
  ...
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typings.awsSdk.clientsPipesMod.NetworkConfiguration] = js.undefined
  
  /**
    * The overrides that are associated with a task.
    */
  var Overrides: js.UndefOr[EcsTaskOverride] = js.undefined
  
  /**
    * An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime).
    */
  var PlacementConstraints: js.UndefOr[typings.awsSdk.clientsPipesMod.PlacementConstraints] = js.undefined
  ...
  /**
    ...
    */
  var PropagateTags: js.UndefOr[typings.awsSdk.clientsPipesMod.PropagateTags] = js.undefined
  
  /**
    * The reference ID to use for the task.
    */
  var ReferenceId: js.UndefOr[typings.awsSdk.clientsPipesMod.ReferenceId] = js.undefined
...
object PipeTargetEcsTaskParameters {
  ...
  inline def apply(TaskDefinitionArn: ArnOrJsonPath): PipeTargetEcsTaskParameters = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeTargetEcsTaskParameters] (val x: Self) extends AnyVal {
    ...
    inline def setOverrides(value: EcsTaskOverride): Self = StObject.set(x, "Overrides", value.asInstanceOf[js.Any])
    ...
    inline def setTaskDefinitionArn(value: ArnOrJsonPath): Self = StObject.set(x, "TaskDefinitionArn", value.asInstanceOf[js.Any])
  }
}
