...
trait DeletePipeResponse extends StObject {
...
object DeletePipeResponse {
  ...
  inline def apply(): DeletePipeResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeletePipeResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeletePipeResponse] (val x: Self) extends AnyVal {
