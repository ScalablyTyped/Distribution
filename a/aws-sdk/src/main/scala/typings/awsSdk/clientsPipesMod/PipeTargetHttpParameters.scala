...
trait PipeTargetHttpParameters extends StObject {
...
object PipeTargetHttpParameters {
  ...
  inline def apply(): PipeTargetHttpParameters = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PipeTargetHttpParameters]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PipeTargetHttpParameters] (val x: Self) extends AnyVal {
