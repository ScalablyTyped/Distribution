...
object ExecutionAbortedEventDetails {
  ...
  @scala.inline
  def apply(): ExecutionAbortedEventDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExecutionAbortedEventDetails]
  }
  
  @scala.inline
  implicit class ExecutionAbortedEventDetailsMutableBuilder[Self <: ExecutionAbortedEventDetails] (val x: Self) extends AnyVal {
