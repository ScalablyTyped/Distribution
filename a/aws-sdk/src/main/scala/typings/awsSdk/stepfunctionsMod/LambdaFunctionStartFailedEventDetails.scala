...
object LambdaFunctionStartFailedEventDetails {
  ...
  @scala.inline
  def apply(): LambdaFunctionStartFailedEventDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LambdaFunctionStartFailedEventDetails]
  }
  
  @scala.inline
  implicit class LambdaFunctionStartFailedEventDetailsMutableBuilder[Self <: LambdaFunctionStartFailedEventDetails] (val x: Self) extends AnyVal {
