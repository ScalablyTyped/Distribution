...
trait AnomalyGroup extends StObject {
  ...
  /**
    ...
    */
  var MetricLevelImpactList: js.UndefOr[typings.awsSdk.lookoutmetricsMod.MetricLevelImpactList] = js.undefined
...
object AnomalyGroup {
  ...
  extension [Self <: AnomalyGroup](x: Self) {
    ...
    inline def setMetricLevelImpactList(value: MetricLevelImpactList): Self = StObject.set(x, "MetricLevelImpactList", value.asInstanceOf[js.Any])
    
    inline def setMetricLevelImpactListUndefined: Self = StObject.set(x, "MetricLevelImpactList", js.undefined)
    
    inline def setMetricLevelImpactListVarargs(value: MetricLevelImpact*): Self = StObject.set(x, "MetricLevelImpactList", js.Array(value*))
