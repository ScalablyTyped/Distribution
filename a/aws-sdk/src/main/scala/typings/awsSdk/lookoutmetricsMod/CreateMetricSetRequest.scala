...
trait CreateMetricSetRequest extends StObject {
  ...
  /**
    ...
    */
  var MetricList: typings.awsSdk.lookoutmetricsMod.MetricList
  ...
  /**
    ...
    */
  var MetricSetName: typings.awsSdk.lookoutmetricsMod.MetricSetName
  
  /**
    * Contains information about how the source data should be interpreted.
    */
  var MetricSource: typings.awsSdk.lookoutmetricsMod.MetricSource
