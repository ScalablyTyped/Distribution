...
trait SampleDataS3SourceConfig extends StObject {
  ...
  var FileFormatDescriptor: typings.awsSdk.lookoutmetricsMod.FileFormatDescriptor
  
  /**
    * An array of strings containing the historical set of data paths.
    */
  var HistoricalDataPathList: js.UndefOr[typings.awsSdk.lookoutmetricsMod.HistoricalDataPathList] = js.undefined
  ...
  /**
    ...
    */
  var TemplatedPathList: js.UndefOr[typings.awsSdk.lookoutmetricsMod.TemplatedPathList] = js.undefined
}
