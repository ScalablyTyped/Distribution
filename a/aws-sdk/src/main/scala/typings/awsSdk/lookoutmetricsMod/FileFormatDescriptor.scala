...
trait FileFormatDescriptor extends StObject {
  ...
  /**
    ...
    */
  var CsvFormatDescriptor: js.UndefOr[typings.awsSdk.lookoutmetricsMod.CsvFormatDescriptor] = js.undefined
  
  /**
    * Contains information about how a source JSON data file should be analyzed.
    */
  var JsonFormatDescriptor: js.UndefOr[typings.awsSdk.lookoutmetricsMod.JsonFormatDescriptor] = js.undefined
}
