...
trait Rule extends StObject {
  ...
  /**
    ...
    */
  var InterruptionFilter: js.UndefOr[typings.awsSdk.transcribeserviceMod.InterruptionFilter] = js.undefined
  
  /**
    * Flag the presence or absence of periods of silence in your Call Analytics transcription output. Refer to for more detail.
    */
  var NonTalkTimeFilter: js.UndefOr[typings.awsSdk.transcribeserviceMod.NonTalkTimeFilter] = js.undefined
  
  /**
    * Flag the presence or absence of specific sentiments in your Call Analytics transcription output. Refer to for more detail.
    */
  var SentimentFilter: js.UndefOr[typings.awsSdk.transcribeserviceMod.SentimentFilter] = js.undefined
  
  /**
    * Flag the presence or absence of specific words or phrases in your Call Analytics transcription output. Refer to for more detail.
    */
  var TranscriptFilter: js.UndefOr[typings.awsSdk.transcribeserviceMod.TranscriptFilter] = js.undefined
}
object Rule {
