...
trait StartMedicalTranscriptionJobRequest extends StObject {
  ...
  /**
    ...
    */
  var OutputBucketName: typings.awsSdk.transcribeserviceMod.OutputBucketName
  ...
  /**
    ...
    */
  var Specialty: typings.awsSdk.transcribeserviceMod.Specialty
  ...
  /**
    ...
    */
  var Type: typings.awsSdk.transcribeserviceMod.Type
}
