...
trait ListModelManifestNodesRequest extends StObject {
...
object ListModelManifestNodesRequest {
  ...
  inline def apply(name: resourceName): ListModelManifestNodesRequest = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListModelManifestNodesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListModelManifestNodesRequest] (val x: Self) extends AnyVal {
