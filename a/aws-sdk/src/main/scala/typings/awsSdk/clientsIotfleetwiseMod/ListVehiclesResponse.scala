...
trait ListVehiclesResponse extends StObject {
  ...
  /**
    ...
    */
  var vehicleSummaries: js.UndefOr[typings.awsSdk.clientsIotfleetwiseMod.vehicleSummaries] = js.undefined
}
object ListVehiclesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListVehiclesResponse] (val x: Self) extends AnyVal {
