...
trait EdgeMetric extends StObject {
  ...
  /**
    ...
    */
  var Dimension: js.UndefOr[typings.awsSdk.clientsSagemakeredgeMod.Dimension] = js.undefined
  ...
  /**
    ...
    */
  var Value: js.UndefOr[typings.awsSdk.clientsSagemakeredgeMod.Value] = js.undefined
}
object EdgeMetric {
