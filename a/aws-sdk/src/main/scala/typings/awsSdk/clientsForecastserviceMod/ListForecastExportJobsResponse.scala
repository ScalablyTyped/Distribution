...
trait ListForecastExportJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var ForecastExportJobs: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.ForecastExportJobs] = js.undefined
...
object ListForecastExportJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListForecastExportJobsResponse] (val x: Self) extends AnyVal {
