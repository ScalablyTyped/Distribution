...
trait FeaturizationMethod extends StObject {
  ...
  /**
    ...
    */
  var FeaturizationMethodName: typings.awsSdk.clientsForecastserviceMod.FeaturizationMethodName
  ...
  /**
    ...
    */
  var FeaturizationMethodParameters: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.FeaturizationMethodParameters] = js.undefined
}
object FeaturizationMethod {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FeaturizationMethod] (val x: Self) extends AnyVal {
