...
trait Metrics extends StObject {
  ...
  /**
    ...
    */
  var ErrorMetrics: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.ErrorMetrics] = js.undefined
  ...
  /**
    ...
    */
  var WeightedQuantileLosses: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.WeightedQuantileLosses] = js.undefined
}
object Metrics {
