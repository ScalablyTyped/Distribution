...
trait ListPredictorsResponse extends StObject {
  ...
  /**
    ...
    */
  var Predictors: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.Predictors] = js.undefined
}
object ListPredictorsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPredictorsResponse] (val x: Self) extends AnyVal {
