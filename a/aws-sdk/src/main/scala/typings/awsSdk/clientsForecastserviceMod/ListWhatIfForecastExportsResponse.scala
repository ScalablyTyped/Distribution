...
trait ListWhatIfForecastExportsResponse extends StObject {
  ...
  /**
    ...
    */
  var WhatIfForecastExports: js.UndefOr[typings.awsSdk.clientsForecastserviceMod.WhatIfForecastExports] = js.undefined
}
object ListWhatIfForecastExportsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListWhatIfForecastExportsResponse] (val x: Self) extends AnyVal {
