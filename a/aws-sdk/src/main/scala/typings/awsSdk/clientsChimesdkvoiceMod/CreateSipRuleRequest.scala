...
object CreateSipRuleRequest {
  ...
  inline def apply(Name: SipRuleName, TriggerType: SipRuleTriggerType, TriggerValue: NonEmptyString): CreateSipRuleRequest = {
    val __obj = js.Dynamic.literal(Name = Name.asInstanceOf[js.Any], TriggerType = TriggerType.asInstanceOf[js.Any], TriggerValue = TriggerValue.asInstanceOf[js.Any])
