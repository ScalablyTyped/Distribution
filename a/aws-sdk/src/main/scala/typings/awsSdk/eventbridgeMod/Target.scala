...
trait Target extends StObject {
  ...
  /**
    ...
    */
  var DeadLetterConfig: js.UndefOr[typings.awsSdk.eventbridgeMod.DeadLetterConfig] = js.native
  ...
  /**
    ...
    */
  var HttpParameters: js.UndefOr[typings.awsSdk.eventbridgeMod.HttpParameters] = js.native
  ...
  /**
    ...
    */
  var RedshiftDataParameters: js.UndefOr[typings.awsSdk.eventbridgeMod.RedshiftDataParameters] = js.native
  
  /**
    * The RetryPolicy object that contains the retry policy configuration to use for the dead-letter queue.
    */
  var RetryPolicy: js.UndefOr[typings.awsSdk.eventbridgeMod.RetryPolicy] = js.native
