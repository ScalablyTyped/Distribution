...
trait UpdateApiDestinationResponse extends StObject {
  ...
  /**
    ...
    */
  var ApiDestinationArn: js.UndefOr[typings.awsSdk.eventbridgeMod.ApiDestinationArn] = js.undefined
  
  /**
    * The state of the API destination that was updated.
    */
  var ApiDestinationState: js.UndefOr[typings.awsSdk.eventbridgeMod.ApiDestinationState] = js.undefined
