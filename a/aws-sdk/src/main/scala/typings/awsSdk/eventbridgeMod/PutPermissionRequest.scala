...
trait PutPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typings.awsSdk.eventbridgeMod.Action] = js.native
  ...
  /**
    ...
    */
  var Condition: js.UndefOr[typings.awsSdk.eventbridgeMod.Condition] = js.native
  ...
  /**
    ...
    */
  var Principal: js.UndefOr[typings.awsSdk.eventbridgeMod.Principal] = js.native
  
  /**
    * An identifier string for the external account that you are granting permissions to. If you later want to revoke the permission for this external account, specify this StatementId when you run RemovePermission.
    */
  var StatementId: js.UndefOr[typings.awsSdk.eventbridgeMod.StatementId] = js.native
}
