...
trait SetPrincipalTagAttributeMapInput extends StObject {
  ...
  /**
    ...
    */
  var IdentityProviderName: typings.awsSdk.clientsCognitoidentityMod.IdentityProviderName
...
object SetPrincipalTagAttributeMapInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SetPrincipalTagAttributeMapInput] (val x: Self) extends AnyVal {
