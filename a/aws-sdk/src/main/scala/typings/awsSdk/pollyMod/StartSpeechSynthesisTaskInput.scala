...
trait StartSpeechSynthesisTaskInput extends StObject {
  ...
  /**
    ...
    */
  var OutputFormat: typings.awsSdk.pollyMod.OutputFormat
  
  /**
    * Amazon S3 bucket name to which the output file will be saved.
    */
  var OutputS3BucketName: typings.awsSdk.pollyMod.OutputS3BucketName
  
  /**
    * The Amazon S3 key prefix for the output speech file.
    */
  var OutputS3KeyPrefix: js.UndefOr[typings.awsSdk.pollyMod.OutputS3KeyPrefix] = js.undefined
  ...
  /**
    ...
    */
  var SampleRate: js.UndefOr[typings.awsSdk.pollyMod.SampleRate] = js.undefined
  
  /**
    * ARN for the SNS topic optionally used for providing status notification for a speech synthesis task.
    */
  var SnsTopicArn: js.UndefOr[typings.awsSdk.pollyMod.SnsTopicArn] = js.undefined
  ...
  /**
    ...
    */
  var Text: typings.awsSdk.pollyMod.Text
  
  /**
    * Specifies whether the input text is plain text or SSML. The default value is plain text. 
    */
  var TextType: js.UndefOr[typings.awsSdk.pollyMod.TextType] = js.undefined
  
  /**
    * Voice ID to use for the synthesis. 
    */
  var VoiceId: typings.awsSdk.pollyMod.VoiceId
}
