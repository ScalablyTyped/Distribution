...
object ListComponentsResponse {
  ...
  implicit class ListComponentsResponseOps[Self <: ListComponentsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setComponentVersionListVarargs(value: ComponentVersion*): Self = this.set("componentVersionList", js.Array(value :_*))
    @scala.inline
    def setComponentVersionList(value: ComponentVersionList): Self = this.set("componentVersionList", value.asInstanceOf[js.Any])
    @scala.inline
    def deleteComponentVersionList: Self = this.set("componentVersionList", js.undefined)
    @scala.inline
