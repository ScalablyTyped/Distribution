...
object ListImagePipelinesResponse {
  ...
  extension [Self <: ListImagePipelinesResponse](x: Self) {
    ...
    inline def setImagePipelineListVarargs(value: ImagePipeline*): Self = StObject.set(x, "imagePipelineList", js.Array(value :_*))
