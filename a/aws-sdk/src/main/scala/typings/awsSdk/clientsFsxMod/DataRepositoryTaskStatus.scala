...
trait DataRepositoryTaskStatus extends StObject {
  ...
  /**
    ...
    */
  var FailedCount: js.UndefOr[typings.awsSdk.clientsFsxMod.FailedCount] = js.undefined
  ...
  /**
    ...
    */
  var ReleasedCapacity: js.UndefOr[typings.awsSdk.clientsFsxMod.ReleasedCapacity] = js.undefined
  
  /**
    * A running total of the number of files that the task has successfully processed.
    */
  var SucceededCount: js.UndefOr[typings.awsSdk.clientsFsxMod.SucceededCount] = js.undefined
  
  /**
    * The total number of files that the task will process. While a task is executing, the sum of SucceededCount plus FailedCount may not equal TotalCount. When the task is complete, TotalCount equals the sum of SucceededCount plus FailedCount.
    */
  var TotalCount: js.UndefOr[typings.awsSdk.clientsFsxMod.TotalCount] = js.undefined
}
