...
trait DescribeFileSystemsResponse extends StObject {
  ...
  /**
    ...
    */
  var FileSystems: js.UndefOr[typings.awsSdk.clientsFsxMod.FileSystems] = js.undefined
...
object DescribeFileSystemsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeFileSystemsResponse] (val x: Self) extends AnyVal {
