...
trait CreateSvmActiveDirectoryConfiguration extends StObject {
  ...
  var SelfManagedActiveDirectoryConfiguration: js.UndefOr[typings.awsSdk.clientsFsxMod.SelfManagedActiveDirectoryConfiguration] = js.undefined
}
object CreateSvmActiveDirectoryConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateSvmActiveDirectoryConfiguration] (val x: Self) extends AnyVal {
