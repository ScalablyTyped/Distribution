...
trait OpenZFSVolumeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var VolumePath: js.UndefOr[typings.awsSdk.clientsFsxMod.VolumePath] = js.undefined
}
object OpenZFSVolumeConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OpenZFSVolumeConfiguration] (val x: Self) extends AnyVal {
