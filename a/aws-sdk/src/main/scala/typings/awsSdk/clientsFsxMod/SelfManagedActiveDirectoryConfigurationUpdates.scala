...
trait SelfManagedActiveDirectoryConfigurationUpdates extends StObject {
  ...
  /**
    ...
    */
  var DnsIps: js.UndefOr[typings.awsSdk.clientsFsxMod.DnsIps] = js.undefined
...
object SelfManagedActiveDirectoryConfigurationUpdates {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SelfManagedActiveDirectoryConfigurationUpdates] (val x: Self) extends AnyVal {
