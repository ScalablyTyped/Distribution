...
trait AdministrativeAction extends StObject {
  ...
  var AdministrativeActionType: js.UndefOr[typings.awsSdk.clientsFsxMod.AdministrativeActionType] = js.undefined
  ...
  /**
    ...
    */
  var Status: js.UndefOr[typings.awsSdk.clientsFsxMod.Status] = js.undefined
