...
object ListAssetModelsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAssetModelsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setAssetModelSummariesVarargs(value: AssetModelSummary*): Self = StObject.set(x, "assetModelSummaries", js.Array(value*))
