...
trait AssociateTimeSeriesToAssetPropertyRequest extends StObject {
...
object AssociateTimeSeriesToAssetPropertyRequest {
  ...
  inline def apply(alias: PropertyAlias, assetId: ID, propertyId: ID): AssociateTimeSeriesToAssetPropertyRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AssociateTimeSeriesToAssetPropertyRequest] (val x: Self) extends AnyVal {
