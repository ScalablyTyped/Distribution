...
object DescribeSavingsPlansOfferingsResponse {
  ...
  implicit class DescribeSavingsPlansOfferingsResponseOps[Self <: DescribeSavingsPlansOfferingsResponse] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSearchResultsVarargs(value: SavingsPlanOffering*): Self = this.set("searchResults", js.Array(value :_*))
    
    @scala.inline
    def setSearchResults(value: SavingsPlanOfferingsList): Self = this.set("searchResults", value.asInstanceOf[js.Any])
