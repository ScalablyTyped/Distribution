...
trait DescribeConfigurationSetResponse extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationSet: js.UndefOr[typings.awsSdk.clientsSesMod.ConfigurationSet] = js.undefined
  ...
  /**
    ...
    */
  var EventDestinations: js.UndefOr[typings.awsSdk.clientsSesMod.EventDestinations] = js.undefined
  
  /**
    * An object that represents the reputation settings for the configuration set. 
    */
  var ReputationOptions: js.UndefOr[typings.awsSdk.clientsSesMod.ReputationOptions] = js.undefined
  
  /**
    * The name of the custom open and click tracking domain associated with the configuration set.
    */
  var TrackingOptions: js.UndefOr[typings.awsSdk.clientsSesMod.TrackingOptions] = js.undefined
}
