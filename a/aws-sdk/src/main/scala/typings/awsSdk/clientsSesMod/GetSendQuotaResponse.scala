...
trait GetSendQuotaResponse extends StObject {
  ...
  /**
    ...
    */
  var Max24HourSend: js.UndefOr[typings.awsSdk.clientsSesMod.Max24HourSend] = js.undefined
  ...
  /**
    ...
    */
  var MaxSendRate: js.UndefOr[typings.awsSdk.clientsSesMod.MaxSendRate] = js.undefined
  
  /**
    * The number of emails sent during the previous 24 hours.
    */
  var SentLast24Hours: js.UndefOr[typings.awsSdk.clientsSesMod.SentLast24Hours] = js.undefined
}
object GetSendQuotaResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSendQuotaResponse] (val x: Self) extends AnyVal {
