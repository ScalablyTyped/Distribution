...
trait BulkEmailDestinationStatus extends StObject {
  ...
  /**
    ...
    */
  var Error: js.UndefOr[typings.awsSdk.clientsSesMod.Error] = js.undefined
...
object BulkEmailDestinationStatus {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BulkEmailDestinationStatus] (val x: Self) extends AnyVal {
