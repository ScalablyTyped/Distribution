...
trait UpdateResourceCollectionFilter extends StObject {
  ...
  /**
    ...
    */
  var CloudFormation: js.UndefOr[UpdateCloudFormationCollectionFilter] = js.undefined
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[UpdateTagCollectionFilters] = js.undefined
}
object UpdateResourceCollectionFilter {
  
  inline def apply(): UpdateResourceCollectionFilter = {
  ...
  extension [Self <: UpdateResourceCollectionFilter](x: Self) {
    ...
    inline def setTags(value: UpdateTagCollectionFilters): Self = StObject.set(x, "Tags", value.asInstanceOf[js.Any])
    
    inline def setTagsUndefined: Self = StObject.set(x, "Tags", js.undefined)
    
    inline def setTagsVarargs(value: UpdateTagCollectionFilter*): Self = StObject.set(x, "Tags", js.Array(value*))
  }
}
