...
trait TagCostEstimationResourceCollectionFilter extends StObject {
...
object TagCostEstimationResourceCollectionFilter {
  ...
  inline def apply(AppBoundaryKey: AppBoundaryKey, TagValues: CostEstimationTagValues): TagCostEstimationResourceCollectionFilter = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TagCostEstimationResourceCollectionFilter] (val x: Self) extends AnyVal {
    
    inline def setAppBoundaryKey(value: AppBoundaryKey): Self = StObject.set(x, "AppBoundaryKey", value.asInstanceOf[js.Any])
    
    inline def setTagValues(value: CostEstimationTagValues): Self = StObject.set(x, "TagValues", value.asInstanceOf[js.Any])
