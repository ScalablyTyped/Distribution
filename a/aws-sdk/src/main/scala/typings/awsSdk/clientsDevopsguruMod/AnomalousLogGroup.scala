...
trait AnomalousLogGroup extends StObject {
  ...
  /**
    ...
    */
  var LogAnomalyShowcases: js.UndefOr[typings.awsSdk.clientsDevopsguruMod.LogAnomalyShowcases] = js.undefined
  
  /**
    *  The name of the CloudWatch log group. 
    */
  var LogGroupName: js.UndefOr[typings.awsSdk.clientsDevopsguruMod.LogGroupName] = js.undefined
  
  /**
    *  The number of log lines that were scanned for anomalous log events. 
    */
  var NumberOfLogLinesScanned: js.UndefOr[typings.awsSdk.clientsDevopsguruMod.NumberOfLogLinesScanned] = js.undefined
}
