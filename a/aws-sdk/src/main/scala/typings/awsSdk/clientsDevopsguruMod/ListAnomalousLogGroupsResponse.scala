...
trait ListAnomalousLogGroupsResponse extends StObject {
  ...
  /**
    ...
    */
  var AnomalousLogGroups: typings.awsSdk.clientsDevopsguruMod.AnomalousLogGroups
...
object ListAnomalousLogGroupsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAnomalousLogGroupsResponse] (val x: Self) extends AnyVal {
