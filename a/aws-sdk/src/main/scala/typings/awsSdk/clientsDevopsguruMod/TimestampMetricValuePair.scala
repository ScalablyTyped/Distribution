...
trait TimestampMetricValuePair extends StObject {
  ...
  /**
    ...
    */
  var MetricValue: js.UndefOr[typings.awsSdk.clientsDevopsguruMod.MetricValue] = js.undefined
...
object TimestampMetricValuePair {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TimestampMetricValuePair] (val x: Self) extends AnyVal {
