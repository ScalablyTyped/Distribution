...
trait NewPublicVirtualInterfaceAllocation extends StObject {
...
object NewPublicVirtualInterfaceAllocation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NewPublicVirtualInterfaceAllocation] (val x: Self) extends AnyVal {
