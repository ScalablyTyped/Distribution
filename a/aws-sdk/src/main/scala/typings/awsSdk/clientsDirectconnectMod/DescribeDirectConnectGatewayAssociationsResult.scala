...
object DescribeDirectConnectGatewayAssociationsResult {
  ...
  implicit open class MutableBuilder[Self <: DescribeDirectConnectGatewayAssociationsResult] (val x: Self) extends AnyVal {
    ...
    inline def setDirectConnectGatewayAssociationsVarargs(value: DirectConnectGatewayAssociation*): Self = StObject.set(x, "directConnectGatewayAssociations", js.Array(value*))
