...
trait DisassociateFraudsterRequest extends StObject {
...
object DisassociateFraudsterRequest {
  
  inline def apply(DomainId: DomainId, FraudsterId: FraudsterId, WatchlistId: WatchlistId): DisassociateFraudsterRequest = {
    ...
    __obj.asInstanceOf[DisassociateFraudsterRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DisassociateFraudsterRequest] (val x: Self) extends AnyVal {
