...
trait Watchlist extends StObject {
...
object Watchlist {
  ...
  inline def apply(): Watchlist = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Watchlist]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Watchlist] (val x: Self) extends AnyVal {
