...
trait ListWatchlistsRequest extends StObject {
...
object ListWatchlistsRequest {
  
  inline def apply(DomainId: DomainId): ListWatchlistsRequest = {
    val __obj = js.Dynamic.literal(DomainId = DomainId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListWatchlistsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListWatchlistsRequest] (val x: Self) extends AnyVal {
