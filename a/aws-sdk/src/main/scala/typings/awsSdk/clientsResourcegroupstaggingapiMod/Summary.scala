...
trait Summary extends StObject {
  ...
  /**
    ...
    */
  var LastUpdated: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.LastUpdated] = js.undefined
  
  /**
    * The count of noncompliant resources.
    */
  var NonCompliantResources: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.NonCompliantResources] = js.undefined
  
  /**
    * The Amazon Web Services Region that the summary applies to.
    */
  var Region: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.Region] = js.undefined
  ...
  /**
    ...
    */
  var TargetId: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.TargetId] = js.undefined
  
  /**
    * Whether the target is an account, an OU, or the organization root.
    */
  var TargetIdType: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.TargetIdType] = js.undefined
}
object Summary {
