...
trait DescribeReportCreationOutput extends StObject {
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.ErrorMessage] = js.undefined
  
  /**
    * The path to the Amazon S3 bucket where the report was stored on creation.
    */
  var S3Location: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.S3Location] = js.undefined
  ...
  /**
    ...
    */
  var Status: js.UndefOr[typings.awsSdk.clientsResourcegroupstaggingapiMod.Status] = js.undefined
}
