...
trait DescribeEntityResponse extends StObject {
  ...
  /**
    ...
    */
  var EntityType: js.UndefOr[typings.awsSdk.clientsMarketplacecatalogMod.EntityType] = js.undefined
...
object DescribeEntityResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeEntityResponse] (val x: Self) extends AnyVal {
