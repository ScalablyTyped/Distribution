...
trait AwsWafRegionalRulePredicateListDetails extends StObject {
...
object AwsWafRegionalRulePredicateListDetails {
  ...
  inline def apply(): AwsWafRegionalRulePredicateListDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AwsWafRegionalRulePredicateListDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AwsWafRegionalRulePredicateListDetails] (val x: Self) extends AnyVal {
