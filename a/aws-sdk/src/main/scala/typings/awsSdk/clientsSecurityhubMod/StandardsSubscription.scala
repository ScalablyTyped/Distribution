...
trait StandardsSubscription extends StObject {
  ...
  /**
    ...
    */
  var StandardsStatus: typings.awsSdk.clientsSecurityhubMod.StandardsStatus
  
  /**
    * The reason for the current status.
    */
  var StandardsStatusReason: js.UndefOr[typings.awsSdk.clientsSecurityhubMod.StandardsStatusReason] = js.undefined
