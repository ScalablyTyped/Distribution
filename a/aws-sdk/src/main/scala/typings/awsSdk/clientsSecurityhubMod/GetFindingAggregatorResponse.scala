...
trait GetFindingAggregatorResponse extends StObject {
...
object GetFindingAggregatorResponse {
  ...
  inline def apply(): GetFindingAggregatorResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetFindingAggregatorResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetFindingAggregatorResponse] (val x: Self) extends AnyVal {
