...
trait Action extends StObject {
  ...
  /**
    ...
    */
  var AwsApiCallAction: js.UndefOr[typings.awsSdk.clientsSecurityhubMod.AwsApiCallAction] = js.undefined
  
  /**
    * Included if ActionType is DNS_REQUEST. Provides details about the DNS request that was detected. 
    */
  var DnsRequestAction: js.UndefOr[typings.awsSdk.clientsSecurityhubMod.DnsRequestAction] = js.undefined
  
  /**
    * Included if ActionType is NETWORK_CONNECTION. Provides details about the network connection that was detected.
    */
  var NetworkConnectionAction: js.UndefOr[typings.awsSdk.clientsSecurityhubMod.NetworkConnectionAction] = js.undefined
  
  /**
    * Included if ActionType is PORT_PROBE. Provides details about the port probe that was detected. 
    */
  var PortProbeAction: js.UndefOr[typings.awsSdk.clientsSecurityhubMod.PortProbeAction] = js.undefined
}
object Action {
