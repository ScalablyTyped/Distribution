...
trait BatchEnableStandardsRequest extends StObject {
  ...
  /**
    ...
    */
  var StandardsSubscriptionRequests: typings.awsSdk.clientsSecurityhubMod.StandardsSubscriptionRequests
}
object BatchEnableStandardsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BatchEnableStandardsRequest] (val x: Self) extends AnyVal {
