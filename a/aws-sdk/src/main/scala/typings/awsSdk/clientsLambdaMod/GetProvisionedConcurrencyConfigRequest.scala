...
trait GetProvisionedConcurrencyConfigRequest extends StObject {
...
object GetProvisionedConcurrencyConfigRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetProvisionedConcurrencyConfigRequest] (val x: Self) extends AnyVal {
