...
trait CodeSigningConfig extends StObject {
  ...
  /**
    ...
    */
  var CodeSigningConfigId: typings.awsSdk.clientsLambdaMod.CodeSigningConfigId
  
  /**
    * The code signing policy controls the validation failure action for signature mismatch or expiry.
    */
  var CodeSigningPolicies: typings.awsSdk.clientsLambdaMod.CodeSigningPolicies
