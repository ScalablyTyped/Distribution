...
trait OrganizationCustomPolicyRuleMetadata extends StObject {
  ...
  /**
    ...
    */
  var DebugLogDeliveryAccounts: js.UndefOr[typings.awsSdk.configserviceMod.DebugLogDeliveryAccounts] = js.undefined
  ...
  /**
    ...
    */
  var PolicyRuntime: typings.awsSdk.configserviceMod.PolicyRuntime
  
  /**
    * The policy definition containing the logic for your organization Config Custom Policy rule.
    */
  var PolicyText: typings.awsSdk.configserviceMod.PolicyText
