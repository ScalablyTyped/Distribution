...
trait CustomizedLoadMetricSpecification extends StObject {
  ...
  /**
    ...
    */
  var MetricName: typings.awsSdk.clientsAutoscalingplansMod.MetricName
...
object CustomizedLoadMetricSpecification {
  ...
  inline def apply(MetricName: MetricName, Namespace: MetricNamespace, Statistic: MetricStatistic): CustomizedLoadMetricSpecification = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomizedLoadMetricSpecification] (val x: Self) extends AnyVal {
