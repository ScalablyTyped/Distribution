...
trait EventAggregate extends StObject {
  ...
  /**
    ...
    */
  var aggregateValue: js.UndefOr[typings.awsSdk.clientsHealthMod.aggregateValue] = js.undefined
  
  /**
    * The number of events of the associated issue type.
    */
  var count: js.UndefOr[typings.awsSdk.clientsHealthMod.count] = js.undefined
}
object EventAggregate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: EventAggregate] (val x: Self) extends AnyVal {
