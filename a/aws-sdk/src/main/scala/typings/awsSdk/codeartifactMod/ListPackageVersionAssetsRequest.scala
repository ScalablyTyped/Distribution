...
object ListPackageVersionAssetsRequest {
  ...
  @scala.inline
  implicit class ListPackageVersionAssetsRequestOps[Self <: ListPackageVersionAssetsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMaxResults(value: ListPackageVersionAssetsMaxResults): Self = this.set("maxResults", value.asInstanceOf[js.Any])
    @scala.inline
