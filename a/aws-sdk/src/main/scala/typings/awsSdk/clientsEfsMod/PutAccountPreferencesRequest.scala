...
trait PutAccountPreferencesRequest extends StObject {
  ...
  /**
    ...
    */
  var ResourceIdType: typings.awsSdk.clientsEfsMod.ResourceIdType
}
object PutAccountPreferencesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutAccountPreferencesRequest] (val x: Self) extends AnyVal {
