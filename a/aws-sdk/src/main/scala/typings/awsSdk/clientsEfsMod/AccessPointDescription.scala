...
trait AccessPointDescription extends StObject {
  ...
  /**
    ...
    */
  var AccessPointArn: js.UndefOr[typings.awsSdk.clientsEfsMod.AccessPointArn] = js.undefined
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typings.awsSdk.clientsEfsMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var LifeCycleState: js.UndefOr[typings.awsSdk.clientsEfsMod.LifeCycleState] = js.undefined
...
object AccessPointDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AccessPointDescription] (val x: Self) extends AnyVal {
