...
trait DescribePendingMaintenanceActionsResponse extends StObject {
  ...
  /**
    ...
    */
  var PendingMaintenanceActions: js.UndefOr[typings.awsSdk.dmsMod.PendingMaintenanceActions] = js.undefined
}
object DescribePendingMaintenanceActionsResponse {
  ...
  extension [Self <: DescribePendingMaintenanceActionsResponse](x: Self) {
