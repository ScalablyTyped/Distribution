...
trait DescribeSigningJobResponse extends StObject {
  ...
  /**
    ...
    */
  var revocationRecord: js.UndefOr[SigningJobRevocationRecord] = js.undefined
...
object DescribeSigningJobResponse {
  ...
  extension [Self <: DescribeSigningJobResponse](x: Self) {
    ...
    inline def setRevocationRecord(value: SigningJobRevocationRecord): Self = StObject.set(x, "revocationRecord", value.asInstanceOf[js.Any])
