...
trait ListTrafficPolicyVersionsRequest extends StObject {
  ...
  /**
    ...
    */
  var TrafficPolicyVersionMarker: js.UndefOr[typings.awsSdk.clientsRoute53Mod.TrafficPolicyVersionMarker] = js.undefined
}
object ListTrafficPolicyVersionsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTrafficPolicyVersionsRequest] (val x: Self) extends AnyVal {
