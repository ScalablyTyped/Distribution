...
trait ResourceRecordSet extends StObject {
  ...
  /**
    ...
    */
  var AliasTarget: js.UndefOr[typings.awsSdk.clientsRoute53Mod.AliasTarget] = js.undefined
  
  var CidrRoutingConfig: js.UndefOr[typings.awsSdk.clientsRoute53Mod.CidrRoutingConfig] = js.undefined
  ...
  /**
    ...
    */
  var GeoLocation: js.UndefOr[typings.awsSdk.clientsRoute53Mod.GeoLocation] = js.undefined
  ...
  /**
    ...
    */
  var HealthCheckId: js.UndefOr[typings.awsSdk.clientsRoute53Mod.HealthCheckId] = js.undefined
  ...
  /**
    ...
    */
  var ResourceRecords: js.UndefOr[typings.awsSdk.clientsRoute53Mod.ResourceRecords] = js.undefined
  ...
  /**
    ...
    */
  var TTL: js.UndefOr[typings.awsSdk.clientsRoute53Mod.TTL] = js.undefined
  ...
  /**
    ...
    */
  var TrafficPolicyInstanceId: js.UndefOr[typings.awsSdk.clientsRoute53Mod.TrafficPolicyInstanceId] = js.undefined
...
object ResourceRecordSet {
  ...
  implicit open class MutableBuilder[Self <: ResourceRecordSet] (val x: Self) extends AnyVal {
    ...
    inline def setCidrRoutingConfig(value: CidrRoutingConfig): Self = StObject.set(x, "CidrRoutingConfig", value.asInstanceOf[js.Any])
    
    inline def setCidrRoutingConfigUndefined: Self = StObject.set(x, "CidrRoutingConfig", js.undefined)
