...
trait CreateKeySigningKeyResponse extends StObject {
  ...
  /**
    ...
    */
  var KeySigningKey: typings.awsSdk.clientsRoute53Mod.KeySigningKey
...
object CreateKeySigningKeyResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateKeySigningKeyResponse] (val x: Self) extends AnyVal {
