...
trait HealthCheckConfig extends StObject {
  ...
  /**
    ...
    */
  var MeasureLatency: js.UndefOr[typings.awsSdk.clientsRoute53Mod.MeasureLatency] = js.undefined
  ...
  /**
    ...
    */
  var RequestInterval: js.UndefOr[typings.awsSdk.clientsRoute53Mod.RequestInterval] = js.undefined
  ...
  /**
    ...
    */
  var RoutingControlArn: js.UndefOr[typings.awsSdk.clientsRoute53Mod.RoutingControlArn] = js.undefined
...
object HealthCheckConfig {
  ...
  extension [Self <: HealthCheckConfig](x: Self) {
    ...
    inline def setMeasureLatency(value: MeasureLatency): Self = StObject.set(x, "MeasureLatency", value.asInstanceOf[js.Any])
    ...
    inline def setRequestInterval(value: RequestInterval): Self = StObject.set(x, "RequestInterval", value.asInstanceOf[js.Any])
    ...
    inline def setRoutingControlArn(value: RoutingControlArn): Self = StObject.set(x, "RoutingControlArn", value.asInstanceOf[js.Any])
