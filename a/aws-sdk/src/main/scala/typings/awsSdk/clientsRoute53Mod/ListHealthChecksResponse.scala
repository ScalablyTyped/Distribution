...
trait ListHealthChecksResponse extends StObject {
  ...
  /**
    ...
    */
  var HealthChecks: typings.awsSdk.clientsRoute53Mod.HealthChecks
...
object ListHealthChecksResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListHealthChecksResponse] (val x: Self) extends AnyVal {
