...
trait HealthCheck extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchAlarmConfiguration: js.UndefOr[typings.awsSdk.clientsRoute53Mod.CloudWatchAlarmConfiguration] = js.undefined
  
  /**
    * A complex type that contains detailed information about one health check.
    */
  var HealthCheckConfig: typings.awsSdk.clientsRoute53Mod.HealthCheckConfig
  
  /**
    * The version of the health check. You can optionally pass this value in a call to UpdateHealthCheck to prevent overwriting another change to the health check.
    */
  var HealthCheckVersion: typings.awsSdk.clientsRoute53Mod.HealthCheckVersion
  ...
  /**
    ...
    */
  var LinkedService: js.UndefOr[typings.awsSdk.clientsRoute53Mod.LinkedService] = js.undefined
}
object HealthCheck {
