...
trait WirelessDeviceStatistics extends StObject {
  ...
  var FuotaDeviceStatus: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.FuotaDeviceStatus] = js.undefined
  ...
  var McGroupId: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.McGroupId] = js.undefined
  
  /**
    * The status of the wireless device in the multicast group.
    */
  var MulticastDeviceStatus: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.MulticastDeviceStatus] = js.undefined
