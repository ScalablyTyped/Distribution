...
trait LoRaWANGetServiceProfileInfo extends StObject {
  ...
  /**
    ...
    */
  var ChannelMask: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.ChannelMask] = js.undefined
  
  /**
    * The DevStatusReqFreq value.
    */
  var DevStatusReqFreq: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DevStatusReqFreq] = js.undefined
  
  /**
    * The DLBucketSize value.
    */
  var DlBucketSize: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DlBucketSize] = js.undefined
  
  /**
    * The DLRate value.
    */
  var DlRate: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DlRate] = js.undefined
  
  /**
    * The DLRatePolicy value.
    */
  var DlRatePolicy: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DlRatePolicy] = js.undefined
  
  /**
    * The DRMax value.
    */
  var DrMax: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DrMax] = js.undefined
  
  /**
    * The DRMin value.
    */
  var DrMin: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.DrMin] = js.undefined
  
  /**
    * The HRAllowed value that describes whether handover roaming is allowed.
    */
  var HrAllowed: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.HrAllowed] = js.undefined
  
  /**
    * The MinGwDiversity value.
    */
  var MinGwDiversity: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.MinGwDiversity] = js.undefined
  
  /**
    * The NwkGeoLoc value.
    */
  var NwkGeoLoc: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.NwkGeoLoc] = js.undefined
  ...
  /**
    ...
    */
  var ReportDevStatusBattery: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.ReportDevStatusBattery] = js.undefined
  
  /**
    * The ReportDevStatusMargin value.
    */
  var ReportDevStatusMargin: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.ReportDevStatusMargin] = js.undefined
  
  /**
    * The TargetPER value.
    */
  var TargetPer: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.TargetPer] = js.undefined
  
  /**
    * The ULBucketSize value.
    */
  var UlBucketSize: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.UlBucketSize] = js.undefined
  
  /**
    * The ULRate value.
    */
  var UlRate: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.UlRate] = js.undefined
  
  /**
    * The ULRatePolicy value.
    */
  var UlRatePolicy: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.UlRatePolicy] = js.undefined
}
object LoRaWANGetServiceProfileInfo {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LoRaWANGetServiceProfileInfo] (val x: Self) extends AnyVal {
