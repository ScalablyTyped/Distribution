...
trait SessionKeysAbpV11 extends StObject {
  ...
  /**
    ...
    */
  var FNwkSIntKey: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.FNwkSIntKey] = js.undefined
  
  /**
    * The NwkSEncKey value.
    */
  var NwkSEncKey: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.NwkSEncKey] = js.undefined
  
  /**
    * The SNwkSIntKey value.
    */
  var SNwkSIntKey: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.SNwkSIntKey] = js.undefined
}
