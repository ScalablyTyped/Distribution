...
trait LoRaWANDeviceProfile extends StObject {
  ...
  /**
    ...
    */
  var ClassBTimeout: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.ClassBTimeout] = js.undefined
  
  /**
    * The ClassCTimeout value.
    */
  var ClassCTimeout: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.ClassCTimeout] = js.undefined
  
  /**
    * The list of values that make up the FactoryPresetFreqs value.
    */
  var FactoryPresetFreqsList: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.FactoryPresetFreqsList] = js.undefined
  
  /**
    * The MAC version (such as OTAA 1.1 or OTAA 1.0.3) to use with this device profile.
    */
  var MacVersion: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.MacVersion] = js.undefined
  
  /**
    * The MaxDutyCycle value.
    */
  var MaxDutyCycle: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.MaxDutyCycle] = js.undefined
  
  /**
    * The MaxEIRP value.
    */
  var MaxEirp: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.MaxEirp] = js.undefined
  
  /**
    * The PingSlotDR value.
    */
  var PingSlotDr: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.PingSlotDr] = js.undefined
  
  /**
    * The PingSlotFreq value.
    */
  var PingSlotFreq: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.PingSlotFreq] = js.undefined
  ...
  /**
    ...
    */
  var RegParamsRevision: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.RegParamsRevision] = js.undefined
  ...
  /**
    ...
    */
  var RxDataRate2: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.RxDataRate2] = js.undefined
  
  /**
    * The RXDelay1 value.
    */
  var RxDelay1: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.RxDelay1] = js.undefined
  
  /**
    * The RXDROffset1 value.
    */
  var RxDrOffset1: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.RxDrOffset1] = js.undefined
  
  /**
    * The RXFreq2 value.
    */
  var RxFreq2: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.RxFreq2] = js.undefined
  
  /**
    * The Supports32BitFCnt value.
    */
  var Supports32BitFCnt: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.Supports32BitFCnt] = js.undefined
  
  /**
    * The SupportsClassB value.
    */
  var SupportsClassB: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.SupportsClassB] = js.undefined
  
  /**
    * The SupportsClassC value.
    */
  var SupportsClassC: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.SupportsClassC] = js.undefined
  
  /**
    * The SupportsJoin value.
    */
  var SupportsJoin: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.SupportsJoin] = js.undefined
}
