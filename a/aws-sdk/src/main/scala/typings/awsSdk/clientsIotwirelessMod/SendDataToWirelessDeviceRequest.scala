...
trait SendDataToWirelessDeviceRequest extends StObject {
  ...
  /**
    ...
    */
  var TransmitMode: typings.awsSdk.clientsIotwirelessMod.TransmitMode
  
  /**
    * Metadata about the message request.
    */
  var WirelessMetadata: js.UndefOr[typings.awsSdk.clientsIotwirelessMod.WirelessMetadata] = js.undefined
}
object SendDataToWirelessDeviceRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SendDataToWirelessDeviceRequest] (val x: Self) extends AnyVal {
