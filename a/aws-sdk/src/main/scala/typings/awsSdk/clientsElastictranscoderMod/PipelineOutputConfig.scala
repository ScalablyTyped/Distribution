...
trait PipelineOutputConfig extends StObject {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typings.awsSdk.clientsElastictranscoderMod.Permissions] = js.undefined
  ...
  /**
    ...
    */
  var StorageClass: js.UndefOr[typings.awsSdk.clientsElastictranscoderMod.StorageClass] = js.undefined
}
