...
trait InputCaptions extends StObject {
  ...
  /**
    ...
    */
  var CaptionSources: js.UndefOr[typings.awsSdk.clientsElastictranscoderMod.CaptionSources] = js.undefined
...
object InputCaptions {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InputCaptions] (val x: Self) extends AnyVal {
