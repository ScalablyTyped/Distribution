...
trait PollForDecisionTaskInput extends StObject {
  ...
  /**
    ...
    */
  var startAtPreviousStartedEvent: js.UndefOr[StartAtPreviousStartedEvent] = js.undefined
...
object PollForDecisionTaskInput {
  ...
  implicit open class MutableBuilder[Self <: PollForDecisionTaskInput] (val x: Self) extends AnyVal {
    ...
    inline def setStartAtPreviousStartedEvent(value: StartAtPreviousStartedEvent): Self = StObject.set(x, "startAtPreviousStartedEvent", value.asInstanceOf[js.Any])
    
    inline def setStartAtPreviousStartedEventUndefined: Self = StObject.set(x, "startAtPreviousStartedEvent", js.undefined)
