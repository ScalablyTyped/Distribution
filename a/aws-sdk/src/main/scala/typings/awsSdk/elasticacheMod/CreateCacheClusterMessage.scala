...
trait CreateCacheClusterMessage extends StObject {
  ...
  /**
    ...
    */
  var AZMode: js.UndefOr[typings.awsSdk.elasticacheMod.AZMode] = js.undefined
  ...
  /**
    ...
    */
  var OutpostMode: js.UndefOr[typings.awsSdk.elasticacheMod.OutpostMode] = js.undefined
...
object CreateCacheClusterMessage {
  ...
  extension [Self <: CreateCacheClusterMessage](x: Self) {
    ...
    inline def setSnapshotArnsVarargs(value: String*): Self = StObject.set(x, "SnapshotArns", js.Array(value :_*))
