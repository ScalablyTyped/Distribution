...
trait DomainStatus extends StObject {
  ...
  var ARN: js.UndefOr[typings.awsSdk.cloudsearchMod.ARN] = js.undefined
  ...
  var DomainId: typings.awsSdk.cloudsearchMod.DomainId
  
  var DomainName: typings.awsSdk.cloudsearchMod.DomainName
  
  var Limits: js.UndefOr[typings.awsSdk.cloudsearchMod.Limits] = js.undefined
  ...
  /**
    ...
    */
  var SearchInstanceType: js.UndefOr[typings.awsSdk.cloudsearchMod.SearchInstanceType] = js.undefined
