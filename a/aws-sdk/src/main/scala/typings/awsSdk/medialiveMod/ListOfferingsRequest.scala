...
object ListOfferingsRequest {
  ...
  implicit class ListOfferingsRequestOps[Self <: ListOfferingsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannelConfiguration(value: string): Self = this.set("ChannelConfiguration", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteChannelConfiguration: Self = this.set("ChannelConfiguration", js.undefined)
