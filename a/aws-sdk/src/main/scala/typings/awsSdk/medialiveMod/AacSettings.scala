...
object AacSettings {
  ...
  extension [Self <: AacSettings](x: Self) {
    ...
    inline def setInputType(value: AacInputType): Self = StObject.set(x, "InputType", value.asInstanceOf[js.Any])
    
    inline def setInputTypeUndefined: Self = StObject.set(x, "InputType", js.undefined)
    
    inline def setProfile(value: AacProfile): Self = StObject.set(x, "Profile", value.asInstanceOf[js.Any])
    ...
    inline def setSpec(value: AacSpec): Self = StObject.set(x, "Spec", value.asInstanceOf[js.Any])
