...
object MultiplexSummary {
  ...
  @scala.inline
  implicit class MultiplexSummaryOps[Self <: MultiplexSummary] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMultiplexSettings(value: MultiplexSettingsSummary): Self = this.set("MultiplexSettings", value.asInstanceOf[js.Any])
    @scala.inline
