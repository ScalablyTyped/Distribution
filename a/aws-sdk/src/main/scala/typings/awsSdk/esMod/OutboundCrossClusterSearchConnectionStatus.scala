...
object OutboundCrossClusterSearchConnectionStatus {
  ...
  @scala.inline
  implicit class OutboundCrossClusterSearchConnectionStatusOps[Self <: OutboundCrossClusterSearchConnectionStatus] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setStatusCode(value: OutboundCrossClusterSearchConnectionStatusCode): Self = this.set("StatusCode", value.asInstanceOf[js.Any])
    @scala.inline
