...
trait CreateCloudFormationStackResult extends StObject {
...
object CreateCloudFormationStackResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCloudFormationStackResult] (val x: Self) extends AnyVal {
