...
trait DeleteInstanceResult extends StObject {
...
object DeleteInstanceResult {
  ...
  inline def apply(): DeleteInstanceResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteInstanceResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteInstanceResult] (val x: Self) extends AnyVal {
