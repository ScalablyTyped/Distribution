...
trait GetExportSnapshotRecordsRequest extends StObject {
...
object GetExportSnapshotRecordsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetExportSnapshotRecordsRequest] (val x: Self) extends AnyVal {
