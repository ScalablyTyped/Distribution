...
trait DeleteInstanceSnapshotResult extends StObject {
...
object DeleteInstanceSnapshotResult {
  ...
  inline def apply(): DeleteInstanceSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteInstanceSnapshotResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteInstanceSnapshotResult] (val x: Self) extends AnyVal {
