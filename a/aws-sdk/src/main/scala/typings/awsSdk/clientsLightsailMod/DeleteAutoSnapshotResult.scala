...
trait DeleteAutoSnapshotResult extends StObject {
...
object DeleteAutoSnapshotResult {
  ...
  inline def apply(): DeleteAutoSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteAutoSnapshotResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteAutoSnapshotResult] (val x: Self) extends AnyVal {
