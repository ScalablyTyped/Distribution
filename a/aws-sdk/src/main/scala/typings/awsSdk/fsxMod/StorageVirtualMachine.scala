...
trait StorageVirtualMachine extends StObject {
  ...
  /**
    ...
    */
  var LifecycleTransitionReason: js.UndefOr[typings.awsSdk.fsxMod.LifecycleTransitionReason] = js.undefined
  ...
  /**
    ...
    */
  var UUID: js.UndefOr[typings.awsSdk.fsxMod.UUID] = js.undefined
}
