...
trait DescribeWorkspaceImagePermissionsResult extends StObject {
  ...
  /**
    ...
    */
  var ImagePermissions: js.UndefOr[typings.awsSdk.clientsWorkspacesMod.ImagePermissions] = js.undefined
...
object DescribeWorkspaceImagePermissionsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeWorkspaceImagePermissionsResult] (val x: Self) extends AnyVal {
