...
trait ConnectionAliasAssociation extends StObject {
  ...
  /**
    ...
    */
  var AssociationStatus: js.UndefOr[typings.awsSdk.clientsWorkspacesMod.AssociationStatus] = js.undefined
...
object ConnectionAliasAssociation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ConnectionAliasAssociation] (val x: Self) extends AnyVal {
