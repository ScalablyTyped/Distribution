...
trait CreateWorkspaceBundleRequest extends StObject {
  ...
  var ComputeType: typings.awsSdk.clientsWorkspacesMod.ComputeType
  ...
  var UserStorage: typings.awsSdk.clientsWorkspacesMod.UserStorage
}
object CreateWorkspaceBundleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateWorkspaceBundleRequest] (val x: Self) extends AnyVal {
