...
trait CreateConnectionAliasRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectionString: typings.awsSdk.clientsWorkspacesMod.ConnectionString
...
object CreateConnectionAliasRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateConnectionAliasRequest] (val x: Self) extends AnyVal {
