...
trait ProtocolDetails extends StObject {
  ...
  /**
    ...
    */
  var As2Transports: js.UndefOr[typings.awsSdk.clientsTransferMod.As2Transports] = js.undefined
  ...
  /**
    ...
    */
  var PassiveIp: js.UndefOr[typings.awsSdk.clientsTransferMod.PassiveIp] = js.undefined
  ...
  /**
    ...
    */
  var SetStatOption: js.UndefOr[typings.awsSdk.clientsTransferMod.SetStatOption] = js.undefined
  ...
  /**
    ...
    */
  var TlsSessionResumptionMode: js.UndefOr[typings.awsSdk.clientsTransferMod.TlsSessionResumptionMode] = js.undefined
}
object ProtocolDetails {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProtocolDetails] (val x: Self) extends AnyVal {
