...
trait DescribedExecution extends StObject {
  ...
  /**
    ...
    */
  var LoggingConfiguration: js.UndefOr[typings.awsSdk.clientsTransferMod.LoggingConfiguration] = js.undefined
...
object DescribedExecution {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribedExecution] (val x: Self) extends AnyVal {
