...
trait VpcConfigOutput extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typings.awsSdk.clientsSyntheticsMod.SecurityGroupIds] = js.undefined
  
  /**
    * The IDs of the subnets where this canary is to run.
    */
  var SubnetIds: js.UndefOr[typings.awsSdk.clientsSyntheticsMod.SubnetIds] = js.undefined
  
  /**
    * The IDs of the VPC where this canary is to run.
    */
  var VpcId: js.UndefOr[typings.awsSdk.clientsSyntheticsMod.VpcId] = js.undefined
}
object VpcConfigOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: VpcConfigOutput] (val x: Self) extends AnyVal {
