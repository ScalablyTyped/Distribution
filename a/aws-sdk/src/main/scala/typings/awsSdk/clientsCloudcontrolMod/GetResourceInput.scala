...
trait GetResourceInput extends StObject {
...
object GetResourceInput {
  ...
  inline def apply(Identifier: Identifier, TypeName: TypeName): GetResourceInput = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetResourceInput] (val x: Self) extends AnyVal {
