...
trait UpdateResourceInput extends StObject {
  ...
  /**
    ...
    */
  var PatchDocument: typings.awsSdk.clientsCloudcontrolMod.PatchDocument
...
object UpdateResourceInput {
  ...
  inline def apply(Identifier: Identifier, PatchDocument: PatchDocument, TypeName: TypeName): UpdateResourceInput = {
    val __obj = js.Dynamic.literal(Identifier = Identifier.asInstanceOf[js.Any], PatchDocument = PatchDocument.asInstanceOf[js.Any], TypeName = TypeName.asInstanceOf[js.Any])
  ...
  extension [Self <: UpdateResourceInput](x: Self) {
    ...
    inline def setPatchDocument(value: PatchDocument): Self = StObject.set(x, "PatchDocument", value.asInstanceOf[js.Any])
