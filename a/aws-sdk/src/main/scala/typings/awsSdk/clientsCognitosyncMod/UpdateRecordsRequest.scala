...
trait UpdateRecordsRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientContext: js.UndefOr[typings.awsSdk.clientsCognitosyncMod.ClientContext] = js.undefined
  ...
  /**
    ...
    */
  var SyncSessionToken: typings.awsSdk.clientsCognitosyncMod.SyncSessionToken
}
object UpdateRecordsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateRecordsRequest] (val x: Self) extends AnyVal {
