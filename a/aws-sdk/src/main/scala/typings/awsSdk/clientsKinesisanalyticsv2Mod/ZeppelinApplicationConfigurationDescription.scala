...
trait ZeppelinApplicationConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var CatalogConfigurationDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CatalogConfigurationDescription] = js.undefined
  ...
  /**
    ...
    */
  var DeployAsApplicationConfigurationDescription: js.UndefOr[
    typings.awsSdk.clientsKinesisanalyticsv2Mod.DeployAsApplicationConfigurationDescription
  ] = js.undefined
...
object ZeppelinApplicationConfigurationDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ZeppelinApplicationConfigurationDescription] (val x: Self) extends AnyVal {
