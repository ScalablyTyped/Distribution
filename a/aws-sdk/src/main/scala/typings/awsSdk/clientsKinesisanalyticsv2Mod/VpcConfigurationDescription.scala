...
trait VpcConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var VpcId: typings.awsSdk.clientsKinesisanalyticsv2Mod.VpcId
}
object VpcConfigurationDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: VpcConfigurationDescription] (val x: Self) extends AnyVal {
