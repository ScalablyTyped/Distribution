...
trait Output extends StObject {
  ...
  /**
    ...
    */
  var DestinationSchema: typings.awsSdk.clientsKinesisanalyticsv2Mod.DestinationSchema
  
  /**
    * Identifies a Kinesis Data Firehose delivery stream as the destination.
    */
  var KinesisFirehoseOutput: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutput] = js.undefined
  
  /**
    * Identifies a Kinesis data stream as the destination.
    */
  var KinesisStreamsOutput: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutput] = js.undefined
  
  /**
    * Identifies an Amazon Lambda function as the destination.
    */
  var LambdaOutput: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.LambdaOutput] = js.undefined
