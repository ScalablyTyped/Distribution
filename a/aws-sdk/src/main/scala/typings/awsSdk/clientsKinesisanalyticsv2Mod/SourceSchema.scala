...
trait SourceSchema extends StObject {
  ...
  /**
    ...
    */
  var RecordColumns: typings.awsSdk.clientsKinesisanalyticsv2Mod.RecordColumns
  
  /**
    * Specifies the encoding of the records in the streaming source. For example, UTF-8.
    */
  var RecordEncoding: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.RecordEncoding] = js.undefined
  
  /**
    * Specifies the format of the records on the streaming source.
    */
  var RecordFormat: typings.awsSdk.clientsKinesisanalyticsv2Mod.RecordFormat
}
object SourceSchema {
