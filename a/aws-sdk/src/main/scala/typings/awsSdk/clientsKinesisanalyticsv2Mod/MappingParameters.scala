...
trait MappingParameters extends StObject {
  ...
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CSVMappingParameters] = js.undefined
  
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.JSONMappingParameters] = js.undefined
}
