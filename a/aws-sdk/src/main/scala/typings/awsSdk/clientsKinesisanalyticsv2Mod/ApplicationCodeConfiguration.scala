...
trait ApplicationCodeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CodeContent: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CodeContent] = js.undefined
...
object ApplicationCodeConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicationCodeConfiguration] (val x: Self) extends AnyVal {
