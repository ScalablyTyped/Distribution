...
trait CustomArtifactConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var ArtifactType: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.ArtifactType] = js.undefined
...
object CustomArtifactConfigurationDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomArtifactConfigurationDescription] (val x: Self) extends AnyVal {
