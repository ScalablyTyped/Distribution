...
trait FlinkApplicationConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var CheckpointConfigurationDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CheckpointConfigurationDescription] = js.undefined
  ...
  /**
    ...
    */
  var JobPlanDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.JobPlanDescription] = js.undefined
  
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfigurationDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.MonitoringConfigurationDescription] = js.undefined
  
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfigurationDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.ParallelismConfigurationDescription] = js.undefined
}
object FlinkApplicationConfigurationDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FlinkApplicationConfigurationDescription] (val x: Self) extends AnyVal {
