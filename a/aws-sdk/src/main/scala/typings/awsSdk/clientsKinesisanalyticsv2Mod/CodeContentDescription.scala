...
trait CodeContentDescription extends StObject {
  ...
  /**
    ...
    */
  var CodeMD5: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CodeMD5] = js.undefined
  
  /**
    * The size in bytes of the application code. Can be used to validate zip-format code.
    */
  var CodeSize: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CodeSize] = js.undefined
  
  /**
    * The S3 bucket Amazon Resource Name (ARN), file key, and object version of the application code stored in Amazon S3.
    */
  var S3ApplicationCodeLocationDescription: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.S3ApplicationCodeLocationDescription] = js.undefined
