...
trait ZeppelinApplicationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CatalogConfiguration: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.CatalogConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DeployAsApplicationConfiguration: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.DeployAsApplicationConfiguration] = js.undefined
...
object ZeppelinApplicationConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ZeppelinApplicationConfiguration] (val x: Self) extends AnyVal {
