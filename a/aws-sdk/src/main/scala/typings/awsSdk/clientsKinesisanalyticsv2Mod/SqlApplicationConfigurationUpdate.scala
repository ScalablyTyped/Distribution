...
trait SqlApplicationConfigurationUpdate extends StObject {
  ...
  /**
    ...
    */
  var InputUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.InputUpdates] = js.undefined
  
  /**
    * The array of OutputUpdate objects describing the new destination streams used by the application.
    */
  var OutputUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.OutputUpdates] = js.undefined
  
  /**
    * The array of ReferenceDataSourceUpdate objects describing the new reference data sources used by the application.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSourceUpdates] = js.undefined
}
object SqlApplicationConfigurationUpdate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SqlApplicationConfigurationUpdate] (val x: Self) extends AnyVal {
