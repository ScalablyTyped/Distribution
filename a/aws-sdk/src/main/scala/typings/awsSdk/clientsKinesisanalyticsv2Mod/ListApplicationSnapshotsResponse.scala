...
trait ListApplicationSnapshotsResponse extends StObject {
  ...
  /**
    ...
    */
  var SnapshotSummaries: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.SnapshotSummaries] = js.undefined
}
object ListApplicationSnapshotsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListApplicationSnapshotsResponse] (val x: Self) extends AnyVal {
