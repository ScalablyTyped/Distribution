...
trait RunConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ApplicationRestoreConfiguration: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationRestoreConfiguration] = js.undefined
  
  /**
    * Describes the starting parameters for a Flink-based Kinesis Data Analytics application.
    */
  var FlinkRunConfiguration: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.FlinkRunConfiguration] = js.undefined
  
  /**
    * Describes the starting parameters for a SQL-based Kinesis Data Analytics application application.
    */
  var SqlRunConfigurations: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.SqlRunConfigurations] = js.undefined
}
