...
trait CustomArtifactConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ArtifactType: typings.awsSdk.clientsKinesisanalyticsv2Mod.ArtifactType
  
  /**
    * The parameters required to fully specify a Maven reference.
    */
  var MavenReference: js.UndefOr[typings.awsSdk.clientsKinesisanalyticsv2Mod.MavenReference] = js.undefined
