...
trait GetFunctionDefinitionResponse extends StObject {
...
object GetFunctionDefinitionResponse {
  ...
  inline def apply(): GetFunctionDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetFunctionDefinitionResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetFunctionDefinitionResponse] (val x: Self) extends AnyVal {
