...
trait GetBulkDeploymentStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var BulkDeploymentMetrics: js.UndefOr[typings.awsSdk.clientsGreengrassMod.BulkDeploymentMetrics] = js.undefined
  
  /**
    * The status of the bulk deployment.
    */
  var BulkDeploymentStatus: js.UndefOr[typings.awsSdk.clientsGreengrassMod.BulkDeploymentStatus] = js.undefined
