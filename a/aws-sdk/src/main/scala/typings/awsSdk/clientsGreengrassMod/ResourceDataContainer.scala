...
trait ResourceDataContainer extends StObject {
  ...
  /**
    ...
    */
  var LocalDeviceResourceData: js.UndefOr[typings.awsSdk.clientsGreengrassMod.LocalDeviceResourceData] = js.undefined
  
  /**
    * Attributes that define the local volume resource.
    */
  var LocalVolumeResourceData: js.UndefOr[typings.awsSdk.clientsGreengrassMod.LocalVolumeResourceData] = js.undefined
  
  /**
    * Attributes that define an Amazon S3 machine learning resource.
    */
  var S3MachineLearningModelResourceData: js.UndefOr[typings.awsSdk.clientsGreengrassMod.S3MachineLearningModelResourceData] = js.undefined
  
  /**
    * Attributes that define an Amazon SageMaker machine learning resource.
    */
  var SageMakerMachineLearningModelResourceData: js.UndefOr[typings.awsSdk.clientsGreengrassMod.SageMakerMachineLearningModelResourceData] = js.undefined
  
  /**
    * Attributes that define a secret resource, which references a secret from AWS Secrets Manager.
    */
  var SecretsManagerSecretResourceData: js.UndefOr[typings.awsSdk.clientsGreengrassMod.SecretsManagerSecretResourceData] = js.undefined
}
