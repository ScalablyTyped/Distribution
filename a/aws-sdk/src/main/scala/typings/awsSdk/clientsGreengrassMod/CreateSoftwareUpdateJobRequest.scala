...
trait CreateSoftwareUpdateJobRequest extends StObject {
  ...
  var S3UrlSignerRole: typings.awsSdk.clientsGreengrassMod.S3UrlSignerRole
  
  var SoftwareToUpdate: typings.awsSdk.clientsGreengrassMod.SoftwareToUpdate
  
  var UpdateAgentLogLevel: js.UndefOr[typings.awsSdk.clientsGreengrassMod.UpdateAgentLogLevel] = js.undefined
  
  var UpdateTargets: typings.awsSdk.clientsGreengrassMod.UpdateTargets
  
  var UpdateTargetsArchitecture: typings.awsSdk.clientsGreengrassMod.UpdateTargetsArchitecture
  
  var UpdateTargetsOperatingSystem: typings.awsSdk.clientsGreengrassMod.UpdateTargetsOperatingSystem
}
