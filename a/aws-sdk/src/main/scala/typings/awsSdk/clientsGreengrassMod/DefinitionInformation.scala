...
trait DefinitionInformation extends StObject {
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typings.awsSdk.clientsGreengrassMod.Tags] = js.undefined
}
object DefinitionInformation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DefinitionInformation] (val x: Self) extends AnyVal {
