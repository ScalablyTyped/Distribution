...
trait ListBulkDeploymentsResponse extends StObject {
  ...
  /**
    ...
    */
  var BulkDeployments: js.UndefOr[typings.awsSdk.clientsGreengrassMod.BulkDeployments] = js.undefined
...
object ListBulkDeploymentsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListBulkDeploymentsResponse] (val x: Self) extends AnyVal {
