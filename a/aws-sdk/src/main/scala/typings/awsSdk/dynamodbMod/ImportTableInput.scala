...
trait ImportTableInput extends StObject {
  ...
  /**
    ...
    */
  var InputCompressionType: js.UndefOr[typings.awsSdk.dynamodbMod.InputCompressionType] = js.undefined
  
  /**
    *  The format of the source data. Valid values for ImportFormat are CSV, DYNAMODB_JSON or ION. 
    */
  var InputFormat: typings.awsSdk.dynamodbMod.InputFormat
  
  /**
    *  Additional properties that specify how the input is formatted, 
    */
  var InputFormatOptions: js.UndefOr[typings.awsSdk.dynamodbMod.InputFormatOptions] = js.undefined
  
  /**
    *  The S3 bucket that provides the source for the import. 
    */
  var S3BucketSource: typings.awsSdk.dynamodbMod.S3BucketSource
  
  /**
    * Parameters for the table to import the data into. 
    */
  var TableCreationParameters: typings.awsSdk.dynamodbMod.TableCreationParameters
}
