...
trait ImportSummary extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLogGroupArn: js.UndefOr[typings.awsSdk.dynamodbMod.CloudWatchLogGroupArn] = js.undefined
  ...
  /**
    ...
    */
  var ImportArn: js.UndefOr[typings.awsSdk.dynamodbMod.ImportArn] = js.undefined
  
  /**
    *  The status of the import operation. 
    */
  var ImportStatus: js.UndefOr[typings.awsSdk.dynamodbMod.ImportStatus] = js.undefined
  
  /**
    *  The format of the source data. Valid values are CSV, DYNAMODB_JSON or ION.
    */
  var InputFormat: js.UndefOr[typings.awsSdk.dynamodbMod.InputFormat] = js.undefined
  
  /**
    *  The path and S3 bucket of the source file that is being imported. This includes the S3Bucket (required), S3KeyPrefix (optional) and S3BucketOwner (optional if the bucket is owned by the requester). 
    */
  var S3BucketSource: js.UndefOr[typings.awsSdk.dynamodbMod.S3BucketSource] = js.undefined
