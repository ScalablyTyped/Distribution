...
trait QueryInput extends StObject {
  ...
  /**
    ...
    */
  var KeyConditions: js.UndefOr[typings.awsSdk.dynamodbMod.KeyConditions] = js.undefined
  ...
  /**
    ...
    */
  var Select: js.UndefOr[typings.awsSdk.dynamodbMod.Select] = js.undefined
