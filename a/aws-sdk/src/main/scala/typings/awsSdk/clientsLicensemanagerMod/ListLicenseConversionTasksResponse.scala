...
trait ListLicenseConversionTasksResponse extends StObject {
  ...
  /**
    ...
    */
  var LicenseConversionTasks: js.UndefOr[typings.awsSdk.clientsLicensemanagerMod.LicenseConversionTasks] = js.undefined
...
object ListLicenseConversionTasksResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListLicenseConversionTasksResponse] (val x: Self) extends AnyVal {
