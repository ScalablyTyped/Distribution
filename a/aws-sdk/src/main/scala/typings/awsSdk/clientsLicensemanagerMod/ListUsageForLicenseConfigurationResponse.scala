...
trait ListUsageForLicenseConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var LicenseConfigurationUsageList: js.UndefOr[typings.awsSdk.clientsLicensemanagerMod.LicenseConfigurationUsageList] = js.undefined
...
object ListUsageForLicenseConfigurationResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListUsageForLicenseConfigurationResponse] (val x: Self) extends AnyVal {
