...
trait CheckoutBorrowLicenseResponse extends StObject {
  ...
  /**
    * Signed token.
    */
  var SignedToken: js.UndefOr[typings.awsSdk.clientsLicensemanagerMod.SignedToken] = js.undefined
}
object CheckoutBorrowLicenseResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CheckoutBorrowLicenseResponse] (val x: Self) extends AnyVal {
