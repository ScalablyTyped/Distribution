...
trait GetLicenseResponse extends StObject {
  ...
  /**
    * License details.
    */
  var License: js.UndefOr[typings.awsSdk.clientsLicensemanagerMod.License] = js.undefined
}
object GetLicenseResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetLicenseResponse] (val x: Self) extends AnyVal {
