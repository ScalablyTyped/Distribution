...
trait CreateLicenseConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var LicenseCountingType: typings.awsSdk.clientsLicensemanagerMod.LicenseCountingType
...
object CreateLicenseConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateLicenseConfigurationRequest] (val x: Self) extends AnyVal {
