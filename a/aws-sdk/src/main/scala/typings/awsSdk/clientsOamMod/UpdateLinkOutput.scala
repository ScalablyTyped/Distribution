...
trait UpdateLinkOutput extends StObject {
  ...
  /**
    ...
    */
  var LabelTemplate: js.UndefOr[typings.awsSdk.clientsOamMod.LabelTemplate] = js.undefined
...
object UpdateLinkOutput {
  ...
  inline def apply(): UpdateLinkOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateLinkOutput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateLinkOutput] (val x: Self) extends AnyVal {
