...
trait GetQueryResultsResponse extends StObject {
  ...
  /**
    ...
    */
  var QueryResultRows: js.UndefOr[typings.awsSdk.cloudtrailMod.QueryResultRows] = js.undefined
  
  /**
    * Shows the count of query results.
    */
  var QueryStatistics: js.UndefOr[typings.awsSdk.cloudtrailMod.QueryStatistics] = js.undefined
