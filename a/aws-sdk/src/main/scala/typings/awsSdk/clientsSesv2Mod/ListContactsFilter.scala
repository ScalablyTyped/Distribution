...
trait ListContactsFilter extends StObject {
  ...
  /**
    ...
    */
  var TopicFilter: js.UndefOr[typings.awsSdk.clientsSesv2Mod.TopicFilter] = js.undefined
}
object ListContactsFilter {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListContactsFilter] (val x: Self) extends AnyVal {
