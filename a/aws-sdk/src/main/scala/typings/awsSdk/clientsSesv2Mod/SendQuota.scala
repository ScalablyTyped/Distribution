...
trait SendQuota extends StObject {
  ...
  /**
    ...
    */
  var MaxSendRate: js.UndefOr[typings.awsSdk.clientsSesv2Mod.MaxSendRate] = js.undefined
  
  /**
    * The number of emails sent from your Amazon SES account in the current Amazon Web Services Region over the past 24 hours.
    */
  var SentLast24Hours: js.UndefOr[typings.awsSdk.clientsSesv2Mod.SentLast24Hours] = js.undefined
}
object SendQuota {
