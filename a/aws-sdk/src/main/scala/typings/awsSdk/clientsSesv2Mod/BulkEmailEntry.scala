...
trait BulkEmailEntry extends StObject {
  ...
  /**
    ...
    */
  var Destination: typings.awsSdk.clientsSesv2Mod.Destination
  
  /**
    * The ReplacementEmailContent associated with a BulkEmailEntry.
    */
  var ReplacementEmailContent: js.UndefOr[typings.awsSdk.clientsSesv2Mod.ReplacementEmailContent] = js.undefined
...
object BulkEmailEntry {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BulkEmailEntry] (val x: Self) extends AnyVal {
