...
trait FailureInfo extends StObject {
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typings.awsSdk.clientsSesv2Mod.ErrorMessage] = js.undefined
  
  /**
    * An Amazon S3 presigned URL that contains all the failed records and related information.
    */
  var FailedRecordsS3Url: js.UndefOr[typings.awsSdk.clientsSesv2Mod.FailedRecordsS3Url] = js.undefined
}
object FailureInfo {
