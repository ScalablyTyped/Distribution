...
trait ContactListDestination extends StObject {
  ...
  /**
    ...
    */
  var ContactListImportAction: typings.awsSdk.clientsSesv2Mod.ContactListImportAction
...
object ContactListDestination {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ContactListDestination] (val x: Self) extends AnyVal {
