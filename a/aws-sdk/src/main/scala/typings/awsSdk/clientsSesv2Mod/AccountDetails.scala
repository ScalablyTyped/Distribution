...
trait AccountDetails extends StObject {
  ...
  /**
    ...
    */
  var MailType: js.UndefOr[typings.awsSdk.clientsSesv2Mod.MailType] = js.undefined
  
  /**
    * Information about the review of the latest details you submitted.
    */
  var ReviewDetails: js.UndefOr[typings.awsSdk.clientsSesv2Mod.ReviewDetails] = js.undefined
  
  /**
    * A description of the types of email that you plan to send.
    */
  var UseCaseDescription: js.UndefOr[typings.awsSdk.clientsSesv2Mod.UseCaseDescription] = js.undefined
  
  /**
    * The URL of your website. This information helps us better understand the type of content that you plan to send.
    */
  var WebsiteURL: js.UndefOr[typings.awsSdk.clientsSesv2Mod.WebsiteURL] = js.undefined
}
