...
trait GetSegmentExportJobsRequest extends StObject {
...
object GetSegmentExportJobsRequest {
  ...
  inline def apply(ApplicationId: string, SegmentId: string): GetSegmentExportJobsRequest = {
  ...
  extension [Self <: GetSegmentExportJobsRequest](x: Self) {
