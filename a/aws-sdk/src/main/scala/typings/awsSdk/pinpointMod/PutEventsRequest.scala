...
trait PutEventsRequest extends js.Object {
  ...
  var EventsRequest: typings.awsSdk.pinpointMod.EventsRequest = js.native
}
object PutEventsRequest {
  ...
  implicit class PutEventsRequestOps[Self <: PutEventsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEventsRequest(value: EventsRequest): Self = this.set("EventsRequest", value.asInstanceOf[js.Any])
  }
}
