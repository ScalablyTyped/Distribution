...
trait PushMessageActivity extends StObject {
  
  /**
    * Specifies the time to live (TTL) value for push notifications that are sent to participants in a journey.
    */
  var MessageConfig: js.UndefOr[JourneyPushMessage] = js.undefined
...
object PushMessageActivity {
  ...
  @scala.inline
  implicit class PushMessageActivityMutableBuilder[Self <: PushMessageActivity] (val x: Self) extends AnyVal {
    
    @scala.inline
    def setMessageConfig(value: JourneyPushMessage): Self = StObject.set(x, "MessageConfig", value.asInstanceOf[js.Any])
