...
object APNSSandboxChannelResponse {
  ...
  @scala.inline
  def apply(Platform: string): APNSSandboxChannelResponse = {
    val __obj = js.Dynamic.literal(Platform = Platform.asInstanceOf[js.Any])
    __obj.asInstanceOf[APNSSandboxChannelResponse]
  }
  
  @scala.inline
  implicit class APNSSandboxChannelResponseMutableBuilder[Self <: APNSSandboxChannelResponse] (val x: Self) extends AnyVal {
