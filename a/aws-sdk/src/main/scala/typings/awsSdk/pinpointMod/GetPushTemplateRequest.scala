...
object GetPushTemplateRequest {
  ...
  @scala.inline
  def apply(TemplateName: string): GetPushTemplateRequest = {
    val __obj = js.Dynamic.literal(TemplateName = TemplateName.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetPushTemplateRequest]
  }
  
  @scala.inline
  implicit class GetPushTemplateRequestMutableBuilder[Self <: GetPushTemplateRequest] (val x: Self) extends AnyVal {
