...
trait DescribeStackDriftDetectionStatusOutput extends StObject {
  ...
  /**
    ...
    */
  var StackDriftStatus: js.UndefOr[typings.awsSdk.clientsCloudformationMod.StackDriftStatus] = js.undefined
...
object DescribeStackDriftDetectionStatusOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeStackDriftDetectionStatusOutput] (val x: Self) extends AnyVal {
