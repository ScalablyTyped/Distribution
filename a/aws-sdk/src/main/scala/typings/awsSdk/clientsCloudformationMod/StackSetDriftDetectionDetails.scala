...
trait StackSetDriftDetectionDetails extends StObject {
  ...
  /**
    ...
    */
  var DriftedStackInstancesCount: js.UndefOr[typings.awsSdk.clientsCloudformationMod.DriftedStackInstancesCount] = js.undefined
  ...
  /**
    ...
    */
  var InProgressStackInstancesCount: js.UndefOr[typings.awsSdk.clientsCloudformationMod.InProgressStackInstancesCount] = js.undefined
  
  /**
    * The number of stack instances which match the expected template and parameter configuration of the stack set.
    */
  var InSyncStackInstancesCount: js.UndefOr[typings.awsSdk.clientsCloudformationMod.InSyncStackInstancesCount] = js.undefined
  ...
  /**
    ...
    */
  var TotalStackInstancesCount: js.UndefOr[typings.awsSdk.clientsCloudformationMod.TotalStackInstancesCount] = js.undefined
}
object StackSetDriftDetectionDetails {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StackSetDriftDetectionDetails] (val x: Self) extends AnyVal {
