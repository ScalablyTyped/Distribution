...
trait StackSet extends StObject {
  ...
  /**
    ...
    */
  var ExecutionRoleName: js.UndefOr[typings.awsSdk.clientsCloudformationMod.ExecutionRoleName] = js.undefined
  ...
  /**
    ...
    */
  var StackSetARN: js.UndefOr[typings.awsSdk.clientsCloudformationMod.StackSetARN] = js.undefined
  ...
  /**
    ...
    */
  var StackSetDriftDetectionDetails: js.UndefOr[typings.awsSdk.clientsCloudformationMod.StackSetDriftDetectionDetails] = js.undefined
...
object StackSet {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StackSet] (val x: Self) extends AnyVal {
