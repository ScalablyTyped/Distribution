...
trait RollbackConfiguration extends StObject {
  ...
  /**
    ...
    */
  var MonitoringTimeInMinutes: js.UndefOr[typings.awsSdk.clientsCloudformationMod.MonitoringTimeInMinutes] = js.undefined
  ...
  /**
    ...
    */
  var RollbackTriggers: js.UndefOr[typings.awsSdk.clientsCloudformationMod.RollbackTriggers] = js.undefined
}
