...
trait DescribeChangeSetOutput extends StObject {
  ...
  /**
    ...
    */
  var Changes: js.UndefOr[typings.awsSdk.clientsCloudformationMod.Changes] = js.undefined
...
object DescribeChangeSetOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeChangeSetOutput] (val x: Self) extends AnyVal {
