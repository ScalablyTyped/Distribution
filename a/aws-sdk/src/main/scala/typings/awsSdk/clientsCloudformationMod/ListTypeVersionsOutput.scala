...
trait ListTypeVersionsOutput extends StObject {
  ...
  /**
    ...
    */
  var TypeVersionSummaries: js.UndefOr[typings.awsSdk.clientsCloudformationMod.TypeVersionSummaries] = js.undefined
}
object ListTypeVersionsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTypeVersionsOutput] (val x: Self) extends AnyVal {
