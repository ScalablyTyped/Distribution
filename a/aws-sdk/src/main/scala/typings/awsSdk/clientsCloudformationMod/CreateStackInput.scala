...
trait CreateStackInput extends StObject {
  ...
  /**
    ...
    */
  var OnFailure: js.UndefOr[typings.awsSdk.clientsCloudformationMod.OnFailure] = js.undefined
...
object CreateStackInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateStackInput] (val x: Self) extends AnyVal {
