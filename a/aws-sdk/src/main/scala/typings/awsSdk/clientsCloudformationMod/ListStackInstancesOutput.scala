...
object ListStackInstancesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListStackInstancesOutput] (val x: Self) extends AnyVal {
    ...
    inline def setSummariesVarargs(value: StackInstanceSummary*): Self = StObject.set(x, "Summaries", js.Array(value*))
  }
}
