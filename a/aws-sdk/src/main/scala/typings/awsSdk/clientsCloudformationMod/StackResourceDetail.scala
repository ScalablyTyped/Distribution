...
trait StackResourceDetail extends StObject {
  ...
  /**
    ...
    */
  var Metadata: js.UndefOr[typings.awsSdk.clientsCloudformationMod.Metadata] = js.undefined
...
object StackResourceDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StackResourceDetail] (val x: Self) extends AnyVal {
