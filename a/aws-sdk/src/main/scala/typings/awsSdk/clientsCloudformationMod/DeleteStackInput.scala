...
trait DeleteStackInput extends StObject {
  ...
  /**
    ...
    */
  var RetainResources: js.UndefOr[typings.awsSdk.clientsCloudformationMod.RetainResources] = js.undefined
...
object DeleteStackInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteStackInput] (val x: Self) extends AnyVal {
