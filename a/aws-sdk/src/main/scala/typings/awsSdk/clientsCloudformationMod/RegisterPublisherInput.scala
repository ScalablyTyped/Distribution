...
trait RegisterPublisherInput extends StObject {
  ...
  /**
    ...
    */
  var AcceptTermsAndConditions: js.UndefOr[typings.awsSdk.clientsCloudformationMod.AcceptTermsAndConditions] = js.undefined
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typings.awsSdk.clientsCloudformationMod.ConnectionArn] = js.undefined
}
