...
trait StackResourceDrift extends StObject {
  ...
  /**
    ...
    */
  var PhysicalResourceIdContext: js.UndefOr[typings.awsSdk.clientsCloudformationMod.PhysicalResourceIdContext] = js.undefined
  
  /**
    * A collection of the resource properties whose actual values differ from their expected values. These will be present only for resources whose StackResourceDriftStatus is MODIFIED.
    */
  var PropertyDifferences: js.UndefOr[typings.awsSdk.clientsCloudformationMod.PropertyDifferences] = js.undefined
