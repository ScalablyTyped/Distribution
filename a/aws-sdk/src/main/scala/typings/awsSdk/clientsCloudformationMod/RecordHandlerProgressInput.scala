...
trait RecordHandlerProgressInput extends StObject {
  ...
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var OperationStatus: typings.awsSdk.clientsCloudformationMod.OperationStatus
  
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var ResourceModel: js.UndefOr[typings.awsSdk.clientsCloudformationMod.ResourceModel] = js.undefined
  
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var StatusMessage: js.UndefOr[typings.awsSdk.clientsCloudformationMod.StatusMessage] = js.undefined
}
