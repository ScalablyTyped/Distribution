...
trait ListTypeRegistrationsOutput extends StObject {
  ...
  /**
    ...
    */
  var RegistrationTokenList: js.UndefOr[typings.awsSdk.clientsCloudformationMod.RegistrationTokenList] = js.undefined
}
object ListTypeRegistrationsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTypeRegistrationsOutput] (val x: Self) extends AnyVal {
