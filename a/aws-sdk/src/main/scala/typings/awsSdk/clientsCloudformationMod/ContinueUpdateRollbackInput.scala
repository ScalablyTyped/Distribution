...
trait ContinueUpdateRollbackInput extends StObject {
  ...
  /**
    ...
    */
  var ResourcesToSkip: js.UndefOr[typings.awsSdk.clientsCloudformationMod.ResourcesToSkip] = js.undefined
...
object ContinueUpdateRollbackInput {
  ...
  implicit open class MutableBuilder[Self <: ContinueUpdateRollbackInput] (val x: Self) extends AnyVal {
    ...
    inline def setResourcesToSkipVarargs(value: ResourceToSkip*): Self = StObject.set(x, "ResourcesToSkip", js.Array(value*))
