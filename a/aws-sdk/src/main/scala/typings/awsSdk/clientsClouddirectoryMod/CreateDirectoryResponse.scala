...
trait CreateDirectoryResponse extends StObject {
  ...
  /**
    ...
    */
  var ObjectIdentifier: typings.awsSdk.clientsClouddirectoryMod.ObjectIdentifier
}
object CreateDirectoryResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateDirectoryResponse] (val x: Self) extends AnyVal {
