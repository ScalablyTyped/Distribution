...
object ListObjectPoliciesRequest {
  ...
  inline def apply(DirectoryArn: Arn, ObjectReference: ObjectReference): ListObjectPoliciesRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListObjectPoliciesRequest] (val x: Self) extends AnyVal {
