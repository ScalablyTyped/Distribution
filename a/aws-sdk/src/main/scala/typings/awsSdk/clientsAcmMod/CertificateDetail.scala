...
trait CertificateDetail extends StObject {
  ...
  /**
    ...
    */
  var FailureReason: js.UndefOr[typings.awsSdk.clientsAcmMod.FailureReason] = js.undefined
  ...
  /**
    ...
    */
  var RenewalSummary: js.UndefOr[typings.awsSdk.clientsAcmMod.RenewalSummary] = js.undefined
  
  /**
    * The reason the certificate was revoked. This value exists only when the certificate status is REVOKED. 
    */
  var RevocationReason: js.UndefOr[typings.awsSdk.clientsAcmMod.RevocationReason] = js.undefined
...
object CertificateDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CertificateDetail] (val x: Self) extends AnyVal {
