...
trait ListCertificatesRequest extends StObject {
  ...
  /**
    ...
    */
  var CertificateStatuses: js.UndefOr[typings.awsSdk.clientsAcmMod.CertificateStatuses] = js.undefined
  ...
  /**
    ...
    */
  var MaxItems: js.UndefOr[typings.awsSdk.clientsAcmMod.MaxItems] = js.undefined
  ...
  /**
    ...
    */
  var SortBy: js.UndefOr[typings.awsSdk.clientsAcmMod.SortBy] = js.undefined
  
  /**
    * Specifies the order of sorted results. If you specify SortOrder, you must also specify SortBy.
    */
  var SortOrder: js.UndefOr[typings.awsSdk.clientsAcmMod.SortOrder] = js.undefined
}
