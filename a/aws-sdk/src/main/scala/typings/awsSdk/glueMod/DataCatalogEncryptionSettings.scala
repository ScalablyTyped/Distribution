...
trait DataCatalogEncryptionSettings extends StObject {
  ...
  /**
    ...
    */
  var ConnectionPasswordEncryption: js.UndefOr[typings.awsSdk.glueMod.ConnectionPasswordEncryption] = js.undefined
  
  /**
    * Specifies the encryption-at-rest configuration for the Data Catalog.
    */
  var EncryptionAtRest: js.UndefOr[typings.awsSdk.glueMod.EncryptionAtRest] = js.undefined
}
