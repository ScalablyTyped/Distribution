...
trait GetPlanRequest extends js.Object {
  ...
  /**
    ...
    */
  var AdditionalPlanOptionsMap: js.UndefOr[typings.awsSdk.glueMod.AdditionalPlanOptionsMap] = js.native
...
object GetPlanRequest {
  ...
  implicit class GetPlanRequestOps[Self <: GetPlanRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAdditionalPlanOptionsMap(value: AdditionalPlanOptionsMap): Self = this.set("AdditionalPlanOptionsMap", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteAdditionalPlanOptionsMap: Self = this.set("AdditionalPlanOptionsMap", js.undefined)
