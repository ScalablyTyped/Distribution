...
object CrawlerTargets {
  ...
  extension [Self <: CrawlerTargets](x: Self) {
    ...
    inline def setCatalogTargetsVarargs(value: CatalogTarget*): Self = StObject.set(x, "CatalogTargets", js.Array(value :_*))
    ...
    inline def setDynamoDBTargetsVarargs(value: DynamoDBTarget*): Self = StObject.set(x, "DynamoDBTargets", js.Array(value :_*))
    ...
    inline def setJdbcTargetsVarargs(value: JdbcTarget*): Self = StObject.set(x, "JdbcTargets", js.Array(value :_*))
    ...
    inline def setMongoDBTargetsVarargs(value: MongoDBTarget*): Self = StObject.set(x, "MongoDBTargets", js.Array(value :_*))
    ...
    inline def setS3TargetsVarargs(value: S3Target*): Self = StObject.set(x, "S3Targets", js.Array(value :_*))
  }
}
