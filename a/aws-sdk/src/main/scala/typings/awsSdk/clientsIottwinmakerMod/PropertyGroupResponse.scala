...
trait PropertyGroupResponse extends StObject {
...
object PropertyGroupResponse {
  ...
  inline def apply(groupType: GroupType, isInherited: Boolean, propertyNames: PropertyNames): PropertyGroupResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PropertyGroupResponse] (val x: Self) extends AnyVal {
