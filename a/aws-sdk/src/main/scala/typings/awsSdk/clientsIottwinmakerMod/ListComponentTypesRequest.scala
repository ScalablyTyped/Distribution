...
trait ListComponentTypesRequest extends StObject {
  
  /**
    * A list of objects that filter the request.
    */
  var filters: js.UndefOr[ListComponentTypesFilters] = js.undefined
...
object ListComponentTypesRequest {
  ...
  inline def apply(workspaceId: Id): ListComponentTypesRequest = {
  ...
  extension [Self <: ListComponentTypesRequest](x: Self) {
    ...
    inline def setFiltersVarargs(value: ListComponentTypesFilter*): Self = StObject.set(x, "filters", js.Array(value*))
