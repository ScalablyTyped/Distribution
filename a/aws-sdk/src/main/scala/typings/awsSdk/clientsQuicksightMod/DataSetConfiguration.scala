...
trait DataSetConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ColumnGroupSchemaList: js.UndefOr[typings.awsSdk.clientsQuicksightMod.ColumnGroupSchemaList] = js.undefined
  
  /**
    * Dataset schema.
    */
  var DataSetSchema: js.UndefOr[typings.awsSdk.clientsQuicksightMod.DataSetSchema] = js.undefined
