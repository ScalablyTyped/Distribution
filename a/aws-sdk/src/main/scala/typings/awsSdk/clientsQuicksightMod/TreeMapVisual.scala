...
trait TreeMapVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[TreeMapConfiguration] = js.undefined
...
object TreeMapVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): TreeMapVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[TreeMapVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TreeMapVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: TreeMapConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
