...
trait UploadSettings extends StObject {
  ...
  /**
    ...
    */
  var Delimiter: js.UndefOr[typings.awsSdk.clientsQuicksightMod.Delimiter] = js.undefined
  ...
  /**
    * Text qualifier.
    */
  var TextQualifier: js.UndefOr[typings.awsSdk.clientsQuicksightMod.TextQualifier] = js.undefined
}
