...
trait CreateRefreshScheduleResponse extends StObject {
...
object CreateRefreshScheduleResponse {
  
  inline def apply(): CreateRefreshScheduleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateRefreshScheduleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateRefreshScheduleResponse] (val x: Self) extends AnyVal {
