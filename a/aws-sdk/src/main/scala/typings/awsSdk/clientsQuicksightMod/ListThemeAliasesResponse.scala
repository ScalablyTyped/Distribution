...
trait ListThemeAliasesResponse extends StObject {
  ...
  /**
    ...
    */
  var ThemeAliasList: js.UndefOr[typings.awsSdk.clientsQuicksightMod.ThemeAliasList] = js.undefined
}
object ListThemeAliasesResponse {
  ...
  implicit open class MutableBuilder[Self <: ListThemeAliasesResponse] (val x: Self) extends AnyVal {
    ...
    inline def setThemeAliasListVarargs(value: ThemeAlias*): Self = StObject.set(x, "ThemeAliasList", js.Array(value*))
  }
}
