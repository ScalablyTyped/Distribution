...
trait BarChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[BarChartConfiguration] = js.undefined
...
object BarChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): BarChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[BarChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BarChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: BarChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
