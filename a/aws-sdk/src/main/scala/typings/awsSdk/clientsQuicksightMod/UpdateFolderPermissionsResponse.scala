...
trait UpdateFolderPermissionsResponse extends StObject {
...
object UpdateFolderPermissionsResponse {
  ...
  inline def apply(): UpdateFolderPermissionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateFolderPermissionsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateFolderPermissionsResponse] (val x: Self) extends AnyVal {
