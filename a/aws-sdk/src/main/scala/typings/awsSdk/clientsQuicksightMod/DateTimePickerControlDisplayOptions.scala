...
trait DateTimePickerControlDisplayOptions extends StObject {
...
object DateTimePickerControlDisplayOptions {
  ...
  inline def apply(): DateTimePickerControlDisplayOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DateTimePickerControlDisplayOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DateTimePickerControlDisplayOptions] (val x: Self) extends AnyVal {
