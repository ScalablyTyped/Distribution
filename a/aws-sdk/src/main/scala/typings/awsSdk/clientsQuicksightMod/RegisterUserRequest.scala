...
trait RegisterUserRequest extends StObject {
  ...
  /**
    ...
    */
  var IdentityType: typings.awsSdk.clientsQuicksightMod.IdentityType
  ...
  /**
    ...
    */
  var UserRole: typings.awsSdk.clientsQuicksightMod.UserRole
}
object RegisterUserRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RegisterUserRequest] (val x: Self) extends AnyVal {
