...
trait PivotTableVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[PivotTableConfiguration] = js.undefined
  
  /**
    * The conditional formatting for a PivotTableVisual.
    */
  var ConditionalFormatting: js.UndefOr[PivotTableConditionalFormatting] = js.undefined
...
object PivotTableVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): PivotTableVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PivotTableVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PivotTableVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: PivotTableConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
    
    inline def setChartConfigurationUndefined: Self = StObject.set(x, "ChartConfiguration", js.undefined)
    
    inline def setConditionalFormatting(value: PivotTableConditionalFormatting): Self = StObject.set(x, "ConditionalFormatting", value.asInstanceOf[js.Any])
