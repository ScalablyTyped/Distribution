...
trait DescribeAnalysisDefinitionResponse extends StObject {
...
object DescribeAnalysisDefinitionResponse {
  ...
  inline def apply(): DescribeAnalysisDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeAnalysisDefinitionResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAnalysisDefinitionResponse] (val x: Self) extends AnyVal {
