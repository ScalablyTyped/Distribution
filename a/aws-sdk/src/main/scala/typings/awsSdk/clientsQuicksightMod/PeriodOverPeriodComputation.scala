...
trait PeriodOverPeriodComputation extends StObject {
...
object PeriodOverPeriodComputation {
  ...
  inline def apply(ComputationId: ShortRestrictiveResourceId, Time: DimensionField): PeriodOverPeriodComputation = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PeriodOverPeriodComputation] (val x: Self) extends AnyVal {
