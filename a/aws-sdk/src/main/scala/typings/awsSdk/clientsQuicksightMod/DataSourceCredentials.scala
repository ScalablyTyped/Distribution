...
trait DataSourceCredentials extends StObject {
  ...
  /**
    ...
    */
  var CopySourceArn: js.UndefOr[typings.awsSdk.clientsQuicksightMod.CopySourceArn] = js.undefined
  
  /**
    * Credential pair. For more information, see  CredentialPair .
    */
  var CredentialPair: js.UndefOr[typings.awsSdk.clientsQuicksightMod.CredentialPair] = js.undefined
