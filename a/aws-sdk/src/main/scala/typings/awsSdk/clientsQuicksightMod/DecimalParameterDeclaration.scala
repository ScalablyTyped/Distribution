...
trait DecimalParameterDeclaration extends StObject {
  
  /**
    * The default values of a parameter. If the parameter is a single-value parameter, a maximum of one default value can be provided.
    */
  var DefaultValues: js.UndefOr[DecimalDefaultValues] = js.undefined
  ...
  /**
    ...
    */
  var ValueWhenUnset: js.UndefOr[DecimalValueWhenUnsetConfiguration] = js.undefined
}
object DecimalParameterDeclaration {
  
  inline def apply(Name: ParameterName, ParameterValueType: ParameterValueType): DecimalParameterDeclaration = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DecimalParameterDeclaration] (val x: Self) extends AnyVal {
    
    inline def setDefaultValues(value: DecimalDefaultValues): Self = StObject.set(x, "DefaultValues", value.asInstanceOf[js.Any])
    ...
    inline def setValueWhenUnset(value: DecimalValueWhenUnsetConfiguration): Self = StObject.set(x, "ValueWhenUnset", value.asInstanceOf[js.Any])
