...
trait CreateTopicRefreshScheduleResponse extends StObject {
...
object CreateTopicRefreshScheduleResponse {
  
  inline def apply(): CreateTopicRefreshScheduleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateTopicRefreshScheduleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateTopicRefreshScheduleResponse] (val x: Self) extends AnyVal {
