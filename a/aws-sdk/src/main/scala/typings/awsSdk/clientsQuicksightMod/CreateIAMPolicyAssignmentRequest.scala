...
trait CreateIAMPolicyAssignmentRequest extends StObject {
  ...
  /**
    ...
    */
  var AssignmentStatus: typings.awsSdk.clientsQuicksightMod.AssignmentStatus
...
object CreateIAMPolicyAssignmentRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateIAMPolicyAssignmentRequest] (val x: Self) extends AnyVal {
