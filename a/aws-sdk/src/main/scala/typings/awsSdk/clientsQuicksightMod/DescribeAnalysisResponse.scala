...
trait DescribeAnalysisResponse extends StObject {
  ...
  /**
    ...
    */
  var Analysis: js.UndefOr[typings.awsSdk.clientsQuicksightMod.Analysis] = js.undefined
...
object DescribeAnalysisResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAnalysisResponse] (val x: Self) extends AnyVal {
