...
trait ListTemplateAliasesResponse extends StObject {
  ...
  /**
    ...
    */
  var TemplateAliasList: js.UndefOr[typings.awsSdk.clientsQuicksightMod.TemplateAliasList] = js.undefined
}
object ListTemplateAliasesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTemplateAliasesResponse] (val x: Self) extends AnyVal {
