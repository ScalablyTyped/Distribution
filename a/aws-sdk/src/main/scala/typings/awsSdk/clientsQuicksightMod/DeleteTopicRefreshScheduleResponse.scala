...
trait DeleteTopicRefreshScheduleResponse extends StObject {
...
object DeleteTopicRefreshScheduleResponse {
  
  inline def apply(): DeleteTopicRefreshScheduleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteTopicRefreshScheduleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteTopicRefreshScheduleResponse] (val x: Self) extends AnyVal {
