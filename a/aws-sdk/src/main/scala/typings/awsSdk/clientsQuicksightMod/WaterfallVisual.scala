...
trait WaterfallVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[WaterfallChartConfiguration] = js.undefined
...
object WaterfallVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): WaterfallVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[WaterfallVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WaterfallVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: WaterfallChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
