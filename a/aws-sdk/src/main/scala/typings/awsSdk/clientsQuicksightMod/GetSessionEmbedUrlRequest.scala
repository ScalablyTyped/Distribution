...
trait GetSessionEmbedUrlRequest extends StObject {
  ...
  /**
    ...
    */
  var EntryPoint: js.UndefOr[typings.awsSdk.clientsQuicksightMod.EntryPoint] = js.undefined
...
object GetSessionEmbedUrlRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSessionEmbedUrlRequest] (val x: Self) extends AnyVal {
