...
trait DateTimeValueWhenUnsetConfiguration extends StObject {
  
  /**
    * A custom value that's used when the value of a parameter isn't set.
    */
  var CustomValue: js.UndefOr[js.Date] = js.undefined
...
object DateTimeValueWhenUnsetConfiguration {
  ...
  inline def apply(): DateTimeValueWhenUnsetConfiguration = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DateTimeValueWhenUnsetConfiguration]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DateTimeValueWhenUnsetConfiguration] (val x: Self) extends AnyVal {
    
    inline def setCustomValue(value: js.Date): Self = StObject.set(x, "CustomValue", value.asInstanceOf[js.Any])
