...
trait LogicalTableSource extends StObject {
  ...
  /**
    ...
    */
  var JoinInstruction: js.UndefOr[typings.awsSdk.clientsQuicksightMod.JoinInstruction] = js.undefined
  
  /**
    * Physical table ID.
    */
  var PhysicalTableId: js.UndefOr[typings.awsSdk.clientsQuicksightMod.PhysicalTableId] = js.undefined
}
