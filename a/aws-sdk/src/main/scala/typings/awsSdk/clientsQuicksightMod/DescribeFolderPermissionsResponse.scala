...
trait DescribeFolderPermissionsResponse extends StObject {
...
object DescribeFolderPermissionsResponse {
  ...
  inline def apply(): DescribeFolderPermissionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeFolderPermissionsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeFolderPermissionsResponse] (val x: Self) extends AnyVal {
