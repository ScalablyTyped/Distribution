...
trait UpdateRefreshScheduleResponse extends StObject {
...
object UpdateRefreshScheduleResponse {
  
  inline def apply(): UpdateRefreshScheduleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateRefreshScheduleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateRefreshScheduleResponse] (val x: Self) extends AnyVal {
