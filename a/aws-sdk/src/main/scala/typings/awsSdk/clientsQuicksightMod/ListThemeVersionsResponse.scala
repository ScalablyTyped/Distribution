...
trait ListThemeVersionsResponse extends StObject {
  ...
  /**
    ...
    */
  var ThemeVersionSummaryList: js.UndefOr[typings.awsSdk.clientsQuicksightMod.ThemeVersionSummaryList] = js.undefined
}
object ListThemeVersionsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListThemeVersionsResponse] (val x: Self) extends AnyVal {
