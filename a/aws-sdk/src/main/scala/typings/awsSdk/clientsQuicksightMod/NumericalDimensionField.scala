...
trait NumericalDimensionField extends StObject {
...
object NumericalDimensionField {
  ...
  inline def apply(Column: ColumnIdentifier, FieldId: FieldId): NumericalDimensionField = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NumericalDimensionField] (val x: Self) extends AnyVal {
