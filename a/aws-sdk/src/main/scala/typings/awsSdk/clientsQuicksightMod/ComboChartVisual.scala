...
trait ComboChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[ComboChartConfiguration] = js.undefined
...
object ComboChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): ComboChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ComboChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ComboChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: ComboChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
