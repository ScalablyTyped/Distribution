...
trait GeospatialMapVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[GeospatialMapConfiguration] = js.undefined
...
object GeospatialMapVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): GeospatialMapVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GeospatialMapVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GeospatialMapVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: GeospatialMapConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
