...
trait DescribeIAMPolicyAssignmentResponse extends StObject {
  ...
  /**
    ...
    */
  var IAMPolicyAssignment: js.UndefOr[typings.awsSdk.clientsQuicksightMod.IAMPolicyAssignment] = js.undefined
...
object DescribeIAMPolicyAssignmentResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeIAMPolicyAssignmentResponse] (val x: Self) extends AnyVal {
