...
trait SearchDashboardsResponse extends StObject {
  ...
  /**
    ...
    */
  var DashboardSummaryList: js.UndefOr[typings.awsSdk.clientsQuicksightMod.DashboardSummaryList] = js.undefined
...
object SearchDashboardsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchDashboardsResponse] (val x: Self) extends AnyVal {
