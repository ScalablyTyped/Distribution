...
trait RadarChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[RadarChartConfiguration] = js.undefined
...
object RadarChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): RadarChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[RadarChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RadarChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: RadarChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
