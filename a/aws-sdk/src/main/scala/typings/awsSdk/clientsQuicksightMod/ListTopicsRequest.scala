...
trait ListTopicsRequest extends StObject {
...
object ListTopicsRequest {
  ...
  inline def apply(AwsAccountId: AwsAccountId): ListTopicsRequest = {
    val __obj = js.Dynamic.literal(AwsAccountId = AwsAccountId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListTopicsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTopicsRequest] (val x: Self) extends AnyVal {
