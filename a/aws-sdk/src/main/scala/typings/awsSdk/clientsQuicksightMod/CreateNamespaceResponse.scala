...
trait CreateNamespaceResponse extends StObject {
  ...
  /**
    ...
    */
  var IdentityStore: js.UndefOr[typings.awsSdk.clientsQuicksightMod.IdentityStore] = js.undefined
...
object CreateNamespaceResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateNamespaceResponse] (val x: Self) extends AnyVal {
