...
trait LineChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[LineChartConfiguration] = js.undefined
...
object LineChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): LineChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[LineChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LineChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: LineChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
