...
trait DescribeRefreshScheduleRequest extends StObject {
...
object DescribeRefreshScheduleRequest {
  
  inline def apply(AwsAccountId: AwsAccountId, DataSetId: ResourceId, ScheduleId: String): DescribeRefreshScheduleRequest = {
    ...
    __obj.asInstanceOf[DescribeRefreshScheduleRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeRefreshScheduleRequest] (val x: Self) extends AnyVal {
