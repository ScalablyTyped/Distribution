...
trait KPIVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[KPIConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var ConditionalFormatting: js.UndefOr[KPIConditionalFormatting] = js.undefined
...
object KPIVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): KPIVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[KPIVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: KPIVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: KPIConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
    ...
    inline def setConditionalFormatting(value: KPIConditionalFormatting): Self = StObject.set(x, "ConditionalFormatting", value.asInstanceOf[js.Any])
