...
trait WordCloudVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[WordCloudChartConfiguration] = js.undefined
...
object WordCloudVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): WordCloudVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[WordCloudVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: WordCloudVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: WordCloudChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
