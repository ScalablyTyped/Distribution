...
trait PieChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[PieChartConfiguration] = js.undefined
...
object PieChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): PieChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PieChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PieChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: PieChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
