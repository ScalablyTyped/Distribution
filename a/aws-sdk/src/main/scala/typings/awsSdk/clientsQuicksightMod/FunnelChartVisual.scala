...
trait FunnelChartVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[FunnelChartConfiguration] = js.undefined
...
object FunnelChartVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): FunnelChartVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FunnelChartVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FunnelChartVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: FunnelChartConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
