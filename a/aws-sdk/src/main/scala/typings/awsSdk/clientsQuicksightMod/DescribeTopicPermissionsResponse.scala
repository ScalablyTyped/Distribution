...
trait DescribeTopicPermissionsResponse extends StObject {
...
object DescribeTopicPermissionsResponse {
  
  inline def apply(): DescribeTopicPermissionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeTopicPermissionsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeTopicPermissionsResponse] (val x: Self) extends AnyVal {
