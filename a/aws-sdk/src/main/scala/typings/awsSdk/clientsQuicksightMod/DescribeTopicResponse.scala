...
trait DescribeTopicResponse extends StObject {
  ...
  /**
    ...
    */
  var Topic: js.UndefOr[TopicDetails] = js.undefined
...
object DescribeTopicResponse {
  
  inline def apply(): DescribeTopicResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeTopicResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeTopicResponse] (val x: Self) extends AnyVal {
