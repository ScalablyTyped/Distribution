...
trait HeatMapVisual extends StObject {
  ...
  /**
    ...
    */
  var ChartConfiguration: js.UndefOr[HeatMapConfiguration] = js.undefined
...
object HeatMapVisual {
  ...
  inline def apply(VisualId: ShortRestrictiveResourceId): HeatMapVisual = {
    val __obj = js.Dynamic.literal(VisualId = VisualId.asInstanceOf[js.Any])
    __obj.asInstanceOf[HeatMapVisual]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HeatMapVisual] (val x: Self) extends AnyVal {
    ...
    inline def setChartConfiguration(value: HeatMapConfiguration): Self = StObject.set(x, "ChartConfiguration", value.asInstanceOf[js.Any])
