...
trait RedshiftParameters extends StObject {
  ...
  /**
    ...
    */
  var ClusterId: js.UndefOr[typings.awsSdk.clientsQuicksightMod.ClusterId] = js.undefined
  ...
  /**
    ...
    */
  var Host: js.UndefOr[typings.awsSdk.clientsQuicksightMod.Host] = js.undefined
...
object RedshiftParameters {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RedshiftParameters] (val x: Self) extends AnyVal {
