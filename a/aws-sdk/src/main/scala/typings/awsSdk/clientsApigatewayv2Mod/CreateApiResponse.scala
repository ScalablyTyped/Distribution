...
trait CreateApiResponse extends StObject {
...
object CreateApiResponse {
  ...
  inline def apply(): CreateApiResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateApiResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateApiResponse] (val x: Self) extends AnyVal {
