...
trait ReimportApiResponse extends StObject {
  ...
  /**
    * The API protocol.
    */
  var ProtocolType: js.UndefOr[typings.awsSdk.clientsApigatewayv2Mod.ProtocolType] = js.undefined
...
object ReimportApiResponse {
  ...
  inline def apply(): ReimportApiResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReimportApiResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReimportApiResponse] (val x: Self) extends AnyVal {
