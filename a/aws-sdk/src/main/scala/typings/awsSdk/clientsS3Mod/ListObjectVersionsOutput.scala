...
trait ListObjectVersionsOutput extends StObject {
  ...
  /**
    ...
    */
  var DeleteMarkers: js.UndefOr[typings.awsSdk.clientsS3Mod.DeleteMarkers] = js.undefined
  ...
  /**
    ...
    */
  var NextKeyMarker: js.UndefOr[typings.awsSdk.clientsS3Mod.NextKeyMarker] = js.undefined
  
  /**
    * When the number of responses exceeds the value of MaxKeys, NextVersionIdMarker specifies the first object version not returned that satisfies the search criteria. Use this value for the version-id-marker request parameter in a subsequent request.
    */
  var NextVersionIdMarker: js.UndefOr[typings.awsSdk.clientsS3Mod.NextVersionIdMarker] = js.undefined
  ...
  /**
    ...
    */
  var VersionIdMarker: js.UndefOr[typings.awsSdk.clientsS3Mod.VersionIdMarker] = js.undefined
