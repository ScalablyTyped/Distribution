...
trait LoggingEnabled extends StObject {
  ...
  /**
    ...
    */
  var TargetBucket: typings.awsSdk.clientsS3Mod.TargetBucket
  ...
  /**
    ...
    */
  var TargetGrants: js.UndefOr[typings.awsSdk.clientsS3Mod.TargetGrants] = js.undefined
  
  /**
    * A prefix for all log object keys. If you store log files from multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish which log files came from which bucket.
    */
  var TargetPrefix: typings.awsSdk.clientsS3Mod.TargetPrefix
}
