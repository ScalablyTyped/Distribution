...
trait Stats extends StObject {
  ...
  /**
    ...
    */
  var BytesProcessed: js.UndefOr[typings.awsSdk.clientsS3Mod.BytesProcessed] = js.undefined
  
  /**
    * The total number of bytes of records payload data returned.
    */
  var BytesReturned: js.UndefOr[typings.awsSdk.clientsS3Mod.BytesReturned] = js.undefined
  
  /**
    * The total number of object bytes scanned.
    */
  var BytesScanned: js.UndefOr[typings.awsSdk.clientsS3Mod.BytesScanned] = js.undefined
}
object Stats {
