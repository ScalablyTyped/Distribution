...
trait CORSRule extends StObject {
  ...
  /**
    ...
    */
  var AllowedHeaders: js.UndefOr[typings.awsSdk.clientsS3Mod.AllowedHeaders] = js.undefined
  
  /**
    * An HTTP method that you allow the origin to execute. Valid values are GET, PUT, HEAD, POST, and DELETE.
    */
  var AllowedMethods: typings.awsSdk.clientsS3Mod.AllowedMethods
  
  /**
    * One or more origins you want customers to be able to access the bucket from.
    */
  var AllowedOrigins: typings.awsSdk.clientsS3Mod.AllowedOrigins
  
  /**
    * One or more headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript XMLHttpRequest object).
    */
  var ExposeHeaders: js.UndefOr[typings.awsSdk.clientsS3Mod.ExposeHeaders] = js.undefined
  ...
  /**
    ...
    */
  var MaxAgeSeconds: js.UndefOr[typings.awsSdk.clientsS3Mod.MaxAgeSeconds] = js.undefined
}
object CORSRule {
