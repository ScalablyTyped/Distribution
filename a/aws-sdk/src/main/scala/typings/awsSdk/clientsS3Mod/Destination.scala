...
trait Destination extends StObject {
  ...
  /**
    ...
    */
  var AccessControlTranslation: js.UndefOr[typings.awsSdk.clientsS3Mod.AccessControlTranslation] = js.undefined
  ...
  /**
    ...
    */
  var EncryptionConfiguration: js.UndefOr[typings.awsSdk.clientsS3Mod.EncryptionConfiguration] = js.undefined
  
  /**
    *  A container specifying replication metrics-related settings enabling replication metrics and events. 
    */
  var Metrics: js.UndefOr[typings.awsSdk.clientsS3Mod.Metrics] = js.undefined
  
  /**
    *  A container specifying S3 Replication Time Control (S3 RTC), including whether S3 RTC is enabled and the time when all objects and operations on objects must be replicated. Must be specified together with a Metrics block. 
    */
  var ReplicationTime: js.UndefOr[typings.awsSdk.clientsS3Mod.ReplicationTime] = js.undefined
