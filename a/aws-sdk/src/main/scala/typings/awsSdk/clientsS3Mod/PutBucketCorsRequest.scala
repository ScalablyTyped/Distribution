...
trait PutBucketCorsRequest extends StObject {
  ...
  /**
    ...
    */
  var CORSConfiguration: typings.awsSdk.clientsS3Mod.CORSConfiguration
...
object PutBucketCorsRequest {
  ...
  inline def apply(Bucket: BucketName, CORSConfiguration: CORSConfiguration): PutBucketCorsRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutBucketCorsRequest] (val x: Self) extends AnyVal {
