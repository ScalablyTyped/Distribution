...
trait ListObjectsV2Request extends StObject {
  ...
  /**
    ...
    */
  var FetchOwner: js.UndefOr[typings.awsSdk.clientsS3Mod.FetchOwner] = js.undefined
  ...
  /**
    ...
    */
  var StartAfter: js.UndefOr[typings.awsSdk.clientsS3Mod.StartAfter] = js.undefined
}
object ListObjectsV2Request {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListObjectsV2Request] (val x: Self) extends AnyVal {
