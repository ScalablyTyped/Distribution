...
trait ObjectLockConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ObjectLockEnabled: js.UndefOr[typings.awsSdk.clientsS3Mod.ObjectLockEnabled] = js.undefined
...
object ObjectLockConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ObjectLockConfiguration] (val x: Self) extends AnyVal {
