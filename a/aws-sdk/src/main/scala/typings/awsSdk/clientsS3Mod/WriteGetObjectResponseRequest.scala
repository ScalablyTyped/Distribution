...
trait WriteGetObjectResponseRequest extends StObject {
  ...
  /**
    * The object data.
    */
  var Body: js.UndefOr[typings.awsSdk.clientsS3Mod.Body] = js.undefined
  ...
  /**
    ...
    */
  var ContentRange: js.UndefOr[typings.awsSdk.clientsS3Mod.ContentRange] = js.undefined
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typings.awsSdk.clientsS3Mod.ErrorCode] = js.undefined
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typings.awsSdk.clientsS3Mod.ErrorMessage] = js.undefined
  ...
  /**
    ...
    */
  var RequestRoute: typings.awsSdk.clientsS3Mod.RequestRoute
  
  /**
    * A single use encrypted token that maps WriteGetObjectResponse to the end user GetObject request.
    */
  var RequestToken: typings.awsSdk.clientsS3Mod.RequestToken
  ...
  /**
    ...
    */
  var TagCount: js.UndefOr[typings.awsSdk.clientsS3Mod.TagCount] = js.undefined
