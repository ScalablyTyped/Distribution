...
trait GetObjectRequest extends StObject {
  ...
  /**
    ...
    */
  var ResponseCacheControl: js.UndefOr[typings.awsSdk.clientsS3Mod.ResponseCacheControl] = js.undefined
  
  /**
    * Sets the Content-Disposition header of the response
    */
  var ResponseContentDisposition: js.UndefOr[typings.awsSdk.clientsS3Mod.ResponseContentDisposition] = js.undefined
  
  /**
    * Sets the Content-Encoding header of the response.
    */
  var ResponseContentEncoding: js.UndefOr[typings.awsSdk.clientsS3Mod.ResponseContentEncoding] = js.undefined
  
  /**
    * Sets the Content-Language header of the response.
    */
  var ResponseContentLanguage: js.UndefOr[typings.awsSdk.clientsS3Mod.ResponseContentLanguage] = js.undefined
  
  /**
    * Sets the Content-Type header of the response.
    */
  var ResponseContentType: js.UndefOr[typings.awsSdk.clientsS3Mod.ResponseContentType] = js.undefined
