...
trait PutObjectRetentionRequest extends StObject {
  ...
  /**
    ...
    */
  var BypassGovernanceRetention: js.UndefOr[typings.awsSdk.clientsS3Mod.BypassGovernanceRetention] = js.undefined
...
object PutObjectRetentionRequest {
  ...
  extension [Self <: PutObjectRetentionRequest](x: Self) {
