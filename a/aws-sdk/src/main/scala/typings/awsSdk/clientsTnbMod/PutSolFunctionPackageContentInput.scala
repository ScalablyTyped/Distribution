...
trait PutSolFunctionPackageContentInput extends StObject {
...
object PutSolFunctionPackageContentInput {
  
  inline def apply(file: _Blob, vnfPkgId: VnfPkgId): PutSolFunctionPackageContentInput = {
    val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any], vnfPkgId = vnfPkgId.asInstanceOf[js.Any])
    __obj.asInstanceOf[PutSolFunctionPackageContentInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PutSolFunctionPackageContentInput] (val x: Self) extends AnyVal {
