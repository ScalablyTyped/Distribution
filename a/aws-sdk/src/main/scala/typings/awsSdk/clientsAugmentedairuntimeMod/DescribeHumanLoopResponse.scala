...
trait DescribeHumanLoopResponse extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopArn: typings.awsSdk.clientsAugmentedairuntimeMod.HumanLoopArn
  ...
  /**
    ...
    */
  var HumanLoopOutput: js.UndefOr[typings.awsSdk.clientsAugmentedairuntimeMod.HumanLoopOutput] = js.undefined
  
  /**
    * The status of the human loop. 
    */
  var HumanLoopStatus: typings.awsSdk.clientsAugmentedairuntimeMod.HumanLoopStatus
}
object DescribeHumanLoopResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeHumanLoopResponse] (val x: Self) extends AnyVal {
