...
trait VideoCodecSettings extends StObject {
  ...
  /**
    ...
    */
  var Av1Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Av1Settings] = js.undefined
  
  /**
    * Required when you choose AVC-Intra for your output video codec. For more information about the AVC-Intra settings, see the relevant specification. For detailed information about SD and HD in AVC-Intra, see https://ieeexplore.ieee.org/document/7290936. For information about 4K/2K in AVC-Intra, see https://pro-av.panasonic.net/en/avc-ultra/AVC-ULTRAoverview.pdf.
    */
  var AvcIntraSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.AvcIntraSettings] = js.undefined
  ...
  /**
    ...
    */
  var FrameCaptureSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.FrameCaptureSettings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value H_264.
    */
  var H264Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.H264Settings] = js.undefined
  
  /**
    * Settings for H265 codec
    */
  var H265Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.H265Settings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value MPEG2.
    */
  var Mpeg2Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Mpeg2Settings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value PRORES.
    */
  var ProresSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.ProresSettings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value VC3
    */
  var Vc3Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Vc3Settings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value VP8.
    */
  var Vp8Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Vp8Settings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value VP9.
    */
  var Vp9Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Vp9Settings] = js.undefined
  
  /**
    * Required when you set (Codec) under (VideoDescription)>(CodecSettings) to the value XAVC.
    */
  var XavcSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.XavcSettings] = js.undefined
}
