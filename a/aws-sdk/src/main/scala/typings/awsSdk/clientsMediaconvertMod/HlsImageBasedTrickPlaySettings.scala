...
trait HlsImageBasedTrickPlaySettings extends StObject {
  
  /**
    * The cadence MediaConvert follows for generating thumbnails.  If set to FOLLOW_IFRAME, MediaConvert generates thumbnails for each IDR frame in the output (matching the GOP cadence).  If set to FOLLOW_CUSTOM, MediaConvert generates thumbnails according to the interval you specify in thumbnailInterval.
    */
  var IntervalCadence: js.UndefOr[HlsIntervalCadence] = js.undefined
...
object HlsImageBasedTrickPlaySettings {
  ...
  inline def apply(): HlsImageBasedTrickPlaySettings = {
  ...
  extension [Self <: HlsImageBasedTrickPlaySettings](x: Self) {
    ...
    inline def setThumbnailHeight(value: integerMin2Max4096): Self = StObject.set(x, "ThumbnailHeight", value.asInstanceOf[js.Any])
