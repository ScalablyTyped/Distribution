...
trait ReservationPlan extends StObject {
  ...
  /**
    ...
    */
  var Commitment: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Commitment] = js.undefined
  ...
  /**
    ...
    */
  var RenewalType: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.RenewalType] = js.undefined
...
object ReservationPlan {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReservationPlan] (val x: Self) extends AnyVal {
