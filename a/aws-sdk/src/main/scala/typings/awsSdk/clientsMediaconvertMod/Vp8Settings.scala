...
trait Vp8Settings extends StObject {
  ...
  /**
    ...
    */
  var FramerateControl: js.UndefOr[Vp8FramerateControl] = js.undefined
  ...
  /**
    ...
    */
  var FramerateConversionAlgorithm: js.UndefOr[Vp8FramerateConversionAlgorithm] = js.undefined
  ...
  /**
    ...
    */
  var ParControl: js.UndefOr[Vp8ParControl] = js.undefined
  ...
  /**
    ...
    */
  var QualityTuningLevel: js.UndefOr[Vp8QualityTuningLevel] = js.undefined
  
  /**
    * With the VP8 codec, you can use only the variable bitrate (VBR) rate control mode.
    */
  var RateControlMode: js.UndefOr[Vp8RateControlMode] = js.undefined
}
object Vp8Settings {
  
  inline def apply(): Vp8Settings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Vp8Settings]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Vp8Settings] (val x: Self) extends AnyVal {
    ...
    inline def setFramerateControl(value: Vp8FramerateControl): Self = StObject.set(x, "FramerateControl", value.asInstanceOf[js.Any])
    
    inline def setFramerateControlUndefined: Self = StObject.set(x, "FramerateControl", js.undefined)
    
    inline def setFramerateConversionAlgorithm(value: Vp8FramerateConversionAlgorithm): Self = StObject.set(x, "FramerateConversionAlgorithm", value.asInstanceOf[js.Any])
    ...
    inline def setParControl(value: Vp8ParControl): Self = StObject.set(x, "ParControl", value.asInstanceOf[js.Any])
    ...
    inline def setQualityTuningLevel(value: Vp8QualityTuningLevel): Self = StObject.set(x, "QualityTuningLevel", value.asInstanceOf[js.Any])
    
    inline def setQualityTuningLevelUndefined: Self = StObject.set(x, "QualityTuningLevel", js.undefined)
    
    inline def setRateControlMode(value: Vp8RateControlMode): Self = StObject.set(x, "RateControlMode", value.asInstanceOf[js.Any])
