...
trait H264QvbrSettings extends StObject {
  ...
  /**
    ...
    */
  var MaxAverageBitrate: js.UndefOr[integerMin1000Max1152000000] = js.undefined
...
object H264QvbrSettings {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: H264QvbrSettings] (val x: Self) extends AnyVal {
