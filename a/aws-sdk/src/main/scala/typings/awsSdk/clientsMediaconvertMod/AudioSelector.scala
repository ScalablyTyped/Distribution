...
trait AudioSelector extends StObject {
  ...
  /**
    ...
    */
  var AudioDurationCorrection: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.AudioDurationCorrection] = js.undefined
  ...
  /**
    ...
    */
  var ExternalAudioFileInput: js.UndefOr[stringPatternS3Https] = js.undefined
  
  /**
    * Settings specific to audio sources in an HLS alternate rendition group. Specify the properties (renditionGroupId, renditionName or renditionLanguageCode) to identify the unique audio track among the alternative rendition groups present in the HLS manifest. If no unique track is found, or multiple tracks match the properties provided, the job fails. If no properties in hlsRenditionGroupSettings are specified, the default audio track within the video segment is chosen. If there is no audio within video segment, the alternative audio with DEFAULT=YES is chosen instead.
    */
  var HlsRenditionGroupSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.HlsRenditionGroupSettings] = js.undefined
  ...
  /**
    ...
    */
  var RemixSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.RemixSettings] = js.undefined
...
object AudioSelector {
  ...
  implicit open class MutableBuilder[Self <: AudioSelector] (val x: Self) extends AnyVal {
    ...
    inline def setExternalAudioFileInput(value: stringPatternS3Https): Self = StObject.set(x, "ExternalAudioFileInput", value.asInstanceOf[js.Any])
