...
trait ContainerSettings extends StObject {
  ...
  /**
    ...
    */
  var CmfcSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.CmfcSettings] = js.undefined
  ...
  /**
    ...
    */
  var F4vSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.F4vSettings] = js.undefined
  ...
  /**
    ...
    */
  var M2tsSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.M2tsSettings] = js.undefined
  
  /**
    * These settings relate to the MPEG-2 transport stream (MPEG2-TS) container for the MPEG2-TS segments in your HLS outputs.
    */
  var M3u8Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.M3u8Settings] = js.undefined
  
  /**
    * These settings relate to your QuickTime MOV output container.
    */
  var MovSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.MovSettings] = js.undefined
  
  /**
    * These settings relate to your MP4 output container. You can create audio only outputs with this container. For more information, see https://docs.aws.amazon.com/mediaconvert/latest/ug/supported-codecs-containers-audio-only.html#output-codecs-and-containers-supported-for-audio-only.
    */
  var Mp4Settings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.Mp4Settings] = js.undefined
  
  /**
    * These settings relate to the fragmented MP4 container for the segments in your DASH outputs.
    */
  var MpdSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.MpdSettings] = js.undefined
  
  /**
    * These settings relate to your MXF output container.
    */
  var MxfSettings: js.UndefOr[typings.awsSdk.clientsMediaconvertMod.MxfSettings] = js.undefined
}
