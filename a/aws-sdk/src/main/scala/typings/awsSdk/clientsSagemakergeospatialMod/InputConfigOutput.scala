...
trait InputConfigOutput extends StObject {
  ...
  /**
    ...
    */
  var RasterDataCollectionQuery: js.UndefOr[RasterDataCollectionQueryOutput] = js.undefined
}
object InputConfigOutput {
  
  inline def apply(): InputConfigOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputConfigOutput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputConfigOutput] (val x: Self) extends AnyVal {
    ...
    inline def setRasterDataCollectionQuery(value: RasterDataCollectionQueryOutput): Self = StObject.set(x, "RasterDataCollectionQuery", value.asInstanceOf[js.Any])
