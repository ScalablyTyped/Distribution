...
trait DeleteAutoScalingGroupType extends StObject {
  ...
  /**
    ...
    */
  var ForceDelete: js.UndefOr[typings.awsSdk.clientsAutoscalingMod.ForceDelete] = js.undefined
}
object DeleteAutoScalingGroupType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteAutoScalingGroupType] (val x: Self) extends AnyVal {
