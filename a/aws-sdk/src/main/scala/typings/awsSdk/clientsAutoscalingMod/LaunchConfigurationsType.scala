...
trait LaunchConfigurationsType extends StObject {
  ...
  /**
    ...
    */
  var LaunchConfigurations: typings.awsSdk.clientsAutoscalingMod.LaunchConfigurations
...
object LaunchConfigurationsType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: LaunchConfigurationsType] (val x: Self) extends AnyVal {
