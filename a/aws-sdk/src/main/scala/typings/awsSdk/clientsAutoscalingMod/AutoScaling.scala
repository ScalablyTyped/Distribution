...
trait AutoScaling extends Service {
  ...
  /**
    ...
    */
  def attachTrafficSources(): Request[AttachTrafficSourcesResultType, AWSError] = js.native
  def attachTrafficSources(callback: js.Function2[/* err */ AWSError, /* data */ AttachTrafficSourcesResultType, Unit]): Request[AttachTrafficSourcesResultType, AWSError] = js.native
  /**
    * Attaches one or more traffic sources to the specified Auto Scaling group. You can use any of the following as traffic sources for an Auto Scaling group:   Application Load Balancer   Classic Load Balancer   Gateway Load Balancer   Network Load Balancer   VPC Lattice   This operation is additive and does not detach existing traffic sources from the Auto Scaling group.  After the operation completes, use the DescribeTrafficSources API to return details about the state of the attachments between traffic sources and your Auto Scaling group. To detach a traffic source from the Auto Scaling group, call the DetachTrafficSources API.
    */
  def attachTrafficSources(params: AttachTrafficSourcesType): Request[AttachTrafficSourcesResultType, AWSError] = js.native
  def attachTrafficSources(
    params: AttachTrafficSourcesType,
    callback: js.Function2[/* err */ AWSError, /* data */ AttachTrafficSourcesResultType, Unit]
  ): Request[AttachTrafficSourcesResultType, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeTrafficSources(): Request[DescribeTrafficSourcesResponse, AWSError] = js.native
  def describeTrafficSources(callback: js.Function2[/* err */ AWSError, /* data */ DescribeTrafficSourcesResponse, Unit]): Request[DescribeTrafficSourcesResponse, AWSError] = js.native
  /**
    * Gets information about the traffic sources for the specified Auto Scaling group. You can optionally provide a traffic source type. If you provide a traffic source type, then the results only include that traffic source type. If you do not provide a traffic source type, then the results include all the traffic sources for the specified Auto Scaling group. 
    */
  def describeTrafficSources(params: DescribeTrafficSourcesRequest): Request[DescribeTrafficSourcesResponse, AWSError] = js.native
  def describeTrafficSources(
    params: DescribeTrafficSourcesRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeTrafficSourcesResponse, Unit]
  ): Request[DescribeTrafficSourcesResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def detachTrafficSources(): Request[DetachTrafficSourcesResultType, AWSError] = js.native
  def detachTrafficSources(callback: js.Function2[/* err */ AWSError, /* data */ DetachTrafficSourcesResultType, Unit]): Request[DetachTrafficSourcesResultType, AWSError] = js.native
  /**
    * Detaches one or more traffic sources from the specified Auto Scaling group. When you detach a taffic, it enters the Removing state while deregistering the instances in the group. When all instances are deregistered, then you can no longer describe the traffic source using the DescribeTrafficSources API call. The instances continue to run.
    */
  def detachTrafficSources(params: DetachTrafficSourcesType): Request[DetachTrafficSourcesResultType, AWSError] = js.native
  def detachTrafficSources(
    params: DetachTrafficSourcesType,
    callback: js.Function2[/* err */ AWSError, /* data */ DetachTrafficSourcesResultType, Unit]
  ): Request[DetachTrafficSourcesResultType, AWSError] = js.native
  ...
  /**
    ...
    */
  def rollbackInstanceRefresh(): Request[RollbackInstanceRefreshAnswer, AWSError] = js.native
  def rollbackInstanceRefresh(callback: js.Function2[/* err */ AWSError, /* data */ RollbackInstanceRefreshAnswer, Unit]): Request[RollbackInstanceRefreshAnswer, AWSError] = js.native
  /**
    * Cancels an instance refresh that is in progress and rolls back any changes that it made. Amazon EC2 Auto Scaling replaces any instances that were replaced during the instance refresh. This restores your Auto Scaling group to the configuration that it was using before the start of the instance refresh.  This operation is part of the instance refresh feature in Amazon EC2 Auto Scaling, which helps you update instances in your Auto Scaling group after you make configuration changes. A rollback is not supported in the following situations:    There is no desired configuration specified for the instance refresh.   The Auto Scaling group has a launch template that uses an Amazon Web Services Systems Manager parameter instead of an AMI ID for the ImageId property.   The Auto Scaling group uses the launch template's $Latest or $Default version.   When you receive a successful response from this operation, Amazon EC2 Auto Scaling immediately begins replacing instances. You can check the status of this operation through the DescribeInstanceRefreshes API operation. 
    */
  def rollbackInstanceRefresh(params: RollbackInstanceRefreshType): Request[RollbackInstanceRefreshAnswer, AWSError] = js.native
  def rollbackInstanceRefresh(
    params: RollbackInstanceRefreshType,
    callback: js.Function2[/* err */ AWSError, /* data */ RollbackInstanceRefreshAnswer, Unit]
  ): Request[RollbackInstanceRefreshAnswer, AWSError] = js.native
