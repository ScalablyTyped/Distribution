...
trait ScheduledActionsType extends StObject {
  ...
  /**
    ...
    */
  var ScheduledUpdateGroupActions: js.UndefOr[typings.awsSdk.clientsAutoscalingMod.ScheduledUpdateGroupActions] = js.undefined
}
object ScheduledActionsType {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ScheduledActionsType] (val x: Self) extends AnyVal {
