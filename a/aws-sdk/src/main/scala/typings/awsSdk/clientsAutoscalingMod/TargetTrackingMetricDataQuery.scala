...
trait TargetTrackingMetricDataQuery extends StObject {
  ...
  /**
    ...
    */
  var Expression: js.UndefOr[XmlStringMaxLen2047] = js.undefined
  ...
  /**
    ...
    */
  var ReturnData: js.UndefOr[typings.awsSdk.clientsAutoscalingMod.ReturnData] = js.undefined
}
object TargetTrackingMetricDataQuery {
  
  inline def apply(Id: XmlStringMaxLen255): TargetTrackingMetricDataQuery = {
  ...
  implicit open class MutableBuilder[Self <: TargetTrackingMetricDataQuery] (val x: Self) extends AnyVal {
    ...
    inline def setExpression(value: XmlStringMaxLen2047): Self = StObject.set(x, "Expression", value.asInstanceOf[js.Any])
