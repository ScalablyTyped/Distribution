...
trait BlockDeviceMapping extends StObject {
  ...
  /**
    ...
    */
  var Ebs: js.UndefOr[typings.awsSdk.clientsAutoscalingMod.Ebs] = js.undefined
  ...
  /**
    ...
    */
  var NoDevice: js.UndefOr[typings.awsSdk.clientsAutoscalingMod.NoDevice] = js.undefined
...
object BlockDeviceMapping {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BlockDeviceMapping] (val x: Self) extends AnyVal {
