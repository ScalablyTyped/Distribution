...
trait DetachTrafficSourcesType extends StObject {
...
object DetachTrafficSourcesType {
  ...
  inline def apply(AutoScalingGroupName: XmlStringMaxLen255, TrafficSources: TrafficSources): DetachTrafficSourcesType = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetachTrafficSourcesType] (val x: Self) extends AnyVal {
