...
object InstanceInformation {
  ...
  extension [Self <: InstanceInformation](x: Self) {
    ...
    inline def setLastAssociationExecutionDate(value: DateTime): Self = StObject.set(x, "LastAssociationExecutionDate", value.asInstanceOf[js.Any])
    
    inline def setLastAssociationExecutionDateUndefined: Self = StObject.set(x, "LastAssociationExecutionDate", js.undefined)
    
    inline def setLastPingDateTime(value: DateTime): Self = StObject.set(x, "LastPingDateTime", value.asInstanceOf[js.Any])
    
    inline def setLastPingDateTimeUndefined: Self = StObject.set(x, "LastPingDateTime", js.undefined)
    
    inline def setLastSuccessfulAssociationExecutionDate(value: DateTime): Self = StObject.set(x, "LastSuccessfulAssociationExecutionDate", value.asInstanceOf[js.Any])
    ...
    inline def setRegistrationDate(value: DateTime): Self = StObject.set(x, "RegistrationDate", value.asInstanceOf[js.Any])
