...
trait UpdateProgramResponse extends StObject {
...
object UpdateProgramResponse {
  ...
  inline def apply(): UpdateProgramResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateProgramResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateProgramResponse] (val x: Self) extends AnyVal {
