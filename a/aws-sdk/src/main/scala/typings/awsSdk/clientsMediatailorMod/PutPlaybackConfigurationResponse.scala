...
trait PutPlaybackConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var DashConfiguration: js.UndefOr[typings.awsSdk.clientsMediatailorMod.DashConfiguration] = js.undefined
  
  /**
    * The configuration for HLS content.
    */
  var HlsConfiguration: js.UndefOr[typings.awsSdk.clientsMediatailorMod.HlsConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var LogConfiguration: js.UndefOr[typings.awsSdk.clientsMediatailorMod.LogConfiguration] = js.undefined
...
object PutPlaybackConfigurationResponse {
  ...
  inline def apply(): PutPlaybackConfigurationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PutPlaybackConfigurationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PutPlaybackConfigurationResponse] (val x: Self) extends AnyVal {
