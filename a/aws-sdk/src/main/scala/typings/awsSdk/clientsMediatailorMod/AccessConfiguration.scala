...
trait AccessConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AccessType: js.UndefOr[typings.awsSdk.clientsMediatailorMod.AccessType] = js.undefined
  
  /**
    * AWS Secrets Manager access token configuration parameters.
    */
  var SecretsManagerAccessTokenConfiguration: js.UndefOr[typings.awsSdk.clientsMediatailorMod.SecretsManagerAccessTokenConfiguration] = js.undefined
}
object AccessConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AccessConfiguration] (val x: Self) extends AnyVal {
