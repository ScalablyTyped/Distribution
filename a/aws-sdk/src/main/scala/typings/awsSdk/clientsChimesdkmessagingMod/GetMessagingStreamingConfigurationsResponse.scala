...
trait GetMessagingStreamingConfigurationsResponse extends StObject {
...
object GetMessagingStreamingConfigurationsResponse {
  
  inline def apply(): GetMessagingStreamingConfigurationsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetMessagingStreamingConfigurationsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMessagingStreamingConfigurationsResponse] (val x: Self) extends AnyVal {
