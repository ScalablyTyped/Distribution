...
trait PutChannelExpirationSettingsRequest extends StObject {
...
object PutChannelExpirationSettingsRequest {
  ...
  inline def apply(ChannelArn: ChimeArn): PutChannelExpirationSettingsRequest = {
    val __obj = js.Dynamic.literal(ChannelArn = ChannelArn.asInstanceOf[js.Any])
    __obj.asInstanceOf[PutChannelExpirationSettingsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: PutChannelExpirationSettingsRequest] (val x: Self) extends AnyVal {
