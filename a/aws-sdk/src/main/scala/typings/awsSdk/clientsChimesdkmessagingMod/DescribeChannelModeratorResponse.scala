...
trait DescribeChannelModeratorResponse extends StObject {
  ...
  /**
    ...
    */
  var ChannelModerator: js.UndefOr[typings.awsSdk.clientsChimesdkmessagingMod.ChannelModerator] = js.undefined
}
object DescribeChannelModeratorResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeChannelModeratorResponse] (val x: Self) extends AnyVal {
