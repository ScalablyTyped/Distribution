...
trait DescribeLocationFsxOntapResponse extends StObject {
  ...
  /**
    ...
    */
  var FsxFilesystemArn: js.UndefOr[typings.awsSdk.clientsDatasyncMod.FsxFilesystemArn] = js.undefined
  ...
  /**
    ...
    */
  var StorageVirtualMachineArn: js.UndefOr[typings.awsSdk.clientsDatasyncMod.StorageVirtualMachineArn] = js.undefined
}
