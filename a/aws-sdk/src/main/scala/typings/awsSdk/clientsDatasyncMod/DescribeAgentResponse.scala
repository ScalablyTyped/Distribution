...
trait DescribeAgentResponse extends StObject {
  ...
  /**
    ...
    */
  var EndpointType: js.UndefOr[typings.awsSdk.clientsDatasyncMod.EndpointType] = js.undefined
  ...
  /**
    ...
    */
  var PrivateLinkConfig: js.UndefOr[typings.awsSdk.clientsDatasyncMod.PrivateLinkConfig] = js.undefined
...
object DescribeAgentResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAgentResponse] (val x: Self) extends AnyVal {
