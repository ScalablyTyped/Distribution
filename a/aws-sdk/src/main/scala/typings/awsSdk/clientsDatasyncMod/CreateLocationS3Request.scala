...
trait CreateLocationS3Request extends StObject {
  ...
  /**
    ...
    */
  var S3BucketArn: typings.awsSdk.clientsDatasyncMod.S3BucketArn
  
  var S3Config: typings.awsSdk.clientsDatasyncMod.S3Config
...
object CreateLocationS3Request {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateLocationS3Request] (val x: Self) extends AnyVal {
