...
trait UpdateServiceSettingsResponse extends StObject {
...
object UpdateServiceSettingsResponse {
  ...
  inline def apply(): UpdateServiceSettingsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateServiceSettingsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateServiceSettingsResponse] (val x: Self) extends AnyVal {
