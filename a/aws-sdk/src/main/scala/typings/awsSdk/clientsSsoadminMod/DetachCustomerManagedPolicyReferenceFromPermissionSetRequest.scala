...
trait DetachCustomerManagedPolicyReferenceFromPermissionSetRequest extends StObject {
  ...
  /**
    ...
    */
  var CustomerManagedPolicyReference: typings.awsSdk.clientsSsoadminMod.CustomerManagedPolicyReference
...
object DetachCustomerManagedPolicyReferenceFromPermissionSetRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetachCustomerManagedPolicyReferenceFromPermissionSetRequest] (val x: Self) extends AnyVal {
