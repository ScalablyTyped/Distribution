...
trait JiraConfiguration extends StObject {
  ...
  /**
    ...
    */
  var IssueSubEntityFilter: js.UndefOr[typings.awsSdk.kendraMod.IssueSubEntityFilter] = js.undefined
  
  /**
    * Specify which issue types to crawl in your Jira data source. You can specify one or more of these options to crawl.
    */
  var IssueType: js.UndefOr[typings.awsSdk.kendraMod.IssueType] = js.undefined
  ...
  /**
    ...
    */
  var JiraAccountUrl: typings.awsSdk.kendraMod.JiraAccountUrl
  
  /**
    * Specify which projects to crawl in your Jira data source. You can specify one or more Jira project IDs.
    */
  var Project: js.UndefOr[typings.awsSdk.kendraMod.Project] = js.undefined
