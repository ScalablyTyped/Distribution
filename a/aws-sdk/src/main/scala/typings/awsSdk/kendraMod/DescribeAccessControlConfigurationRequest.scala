...
trait DescribeAccessControlConfigurationRequest extends StObject {
...
object DescribeAccessControlConfigurationRequest {
  ...
  inline def apply(Id: AccessControlConfigurationId, IndexId: IndexId): DescribeAccessControlConfigurationRequest = {
    val __obj = js.Dynamic.literal(Id = Id.asInstanceOf[js.Any], IndexId = IndexId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescribeAccessControlConfigurationRequest]
  }
  
  extension [Self <: DescribeAccessControlConfigurationRequest](x: Self) {
