...
trait AlfrescoConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EntityFilter: js.UndefOr[typings.awsSdk.kendraMod.EntityFilter] = js.undefined
  ...
  /**
    ...
    */
  var SiteId: typings.awsSdk.kendraMod.SiteId
  
  /**
    * The URL of the Alfresco site. For example, https://hostname:8080.
    */
  var SiteUrl: typings.awsSdk.kendraMod.SiteUrl
