...
trait ConnectionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var DatabaseHost: typings.awsSdk.kendraMod.DatabaseHost
  
  /**
    * The name of the database containing the document data.
    */
  var DatabaseName: typings.awsSdk.kendraMod.DatabaseName
  ...
  /**
    ...
    */
  var TableName: typings.awsSdk.kendraMod.TableName
}
