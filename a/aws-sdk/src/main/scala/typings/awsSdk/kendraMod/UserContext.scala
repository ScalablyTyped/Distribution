...
trait UserContext extends StObject {
  ...
  /**
    ...
    */
  var DataSourceGroups: js.UndefOr[typings.awsSdk.kendraMod.DataSourceGroups] = js.undefined
  
  /**
    * The list of groups you want to filter search results based on the groups' access to documents.
    */
  var Groups: js.UndefOr[typings.awsSdk.kendraMod.Groups] = js.undefined
