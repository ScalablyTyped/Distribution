...
trait DataSourceConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AlfrescoConfiguration: js.UndefOr[typings.awsSdk.kendraMod.AlfrescoConfiguration] = js.undefined
  
  /**
    * Provides the configuration information to connect to Box as your data source.
    */
  var BoxConfiguration: js.UndefOr[typings.awsSdk.kendraMod.BoxConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var FsxConfiguration: js.UndefOr[typings.awsSdk.kendraMod.FsxConfiguration] = js.undefined
  
  /**
    * Provides the configuration information to connect to GitHub as your data source.
    */
  var GitHubConfiguration: js.UndefOr[typings.awsSdk.kendraMod.GitHubConfiguration] = js.undefined
  
  /**
    * Provides the configuration information to connect to Google Drive as your data source.
    */
  var GoogleDriveConfiguration: js.UndefOr[typings.awsSdk.kendraMod.GoogleDriveConfiguration] = js.undefined
  
  /**
    * Provides the configuration information to connect to Jira as your data source.
    */
  var JiraConfiguration: js.UndefOr[typings.awsSdk.kendraMod.JiraConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var QuipConfiguration: js.UndefOr[typings.awsSdk.kendraMod.QuipConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SlackConfiguration: js.UndefOr[typings.awsSdk.kendraMod.SlackConfiguration] = js.undefined
  
  /**
    * Provides a template for the configuration information to connect to your data source.
    */
  var TemplateConfiguration: js.UndefOr[typings.awsSdk.kendraMod.TemplateConfiguration] = js.undefined
  
  var WebCrawlerConfiguration: js.UndefOr[typings.awsSdk.kendraMod.WebCrawlerConfiguration] = js.undefined
  
  /**
    * Provides the configuration information to connect to Amazon WorkDocs as your data source.
    */
  var WorkDocsConfiguration: js.UndefOr[typings.awsSdk.kendraMod.WorkDocsConfiguration] = js.undefined
}
