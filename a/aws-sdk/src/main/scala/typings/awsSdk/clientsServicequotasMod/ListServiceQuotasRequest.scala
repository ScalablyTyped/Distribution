...
trait ListServiceQuotasRequest extends StObject {
...
object ListServiceQuotasRequest {
  ...
  inline def apply(ServiceCode: ServiceCode): ListServiceQuotasRequest = {
    val __obj = js.Dynamic.literal(ServiceCode = ServiceCode.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListServiceQuotasRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListServiceQuotasRequest] (val x: Self) extends AnyVal {
