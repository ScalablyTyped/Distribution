...
object UpdateAppInstanceRequest {
  ...
  inline def apply(AppInstanceArn: ChimeArn, Metadata: Metadata, Name: NonEmptyResourceName): UpdateAppInstanceRequest = {
    val __obj = js.Dynamic.literal(AppInstanceArn = AppInstanceArn.asInstanceOf[js.Any], Metadata = Metadata.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any])
