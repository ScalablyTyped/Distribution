...
trait RackPhysicalProperties extends StObject {
  ...
  /**
    ...
    */
  var FiberOpticCableType: js.UndefOr[typings.awsSdk.outpostsMod.FiberOpticCableType] = js.undefined
  
  /**
    * The maximum rack weight that this site can support. NO_LIMIT is over 2000 lbs (907 kg). 
    */
  var MaximumSupportedWeightLbs: js.UndefOr[typings.awsSdk.outpostsMod.MaximumSupportedWeightLbs] = js.undefined
  ...
  /**
    ...
    */
  var OpticalStandard: js.UndefOr[typings.awsSdk.outpostsMod.OpticalStandard] = js.undefined
  
  /**
    * The power connector for the hardware. 
    */
  var PowerConnector: js.UndefOr[typings.awsSdk.outpostsMod.PowerConnector] = js.undefined
  
  /**
    * The power draw available at the hardware placement position for the rack. 
    */
  var PowerDrawKva: js.UndefOr[typings.awsSdk.outpostsMod.PowerDrawKva] = js.undefined
  
  /**
    * The position of the power feed.
    */
  var PowerFeedDrop: js.UndefOr[typings.awsSdk.outpostsMod.PowerFeedDrop] = js.undefined
  
  /**
    * The power option that you can provide for hardware.
    */
  var PowerPhase: js.UndefOr[typings.awsSdk.outpostsMod.PowerPhase] = js.undefined
  
  /**
    * The number of uplinks each Outpost network device.
    */
  var UplinkCount: js.UndefOr[typings.awsSdk.outpostsMod.UplinkCount] = js.undefined
  
  /**
    * The uplink speed the rack supports for the connection to the Region. 
    */
  var UplinkGbps: js.UndefOr[typings.awsSdk.outpostsMod.UplinkGbps] = js.undefined
}
