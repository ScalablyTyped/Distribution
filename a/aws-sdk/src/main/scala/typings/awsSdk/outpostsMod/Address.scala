...
trait Address extends StObject {
  ...
  /**
    ...
    */
  var AddressLine1: typings.awsSdk.outpostsMod.AddressLine1
  
  /**
    * The second line of the address.
    */
  var AddressLine2: js.UndefOr[typings.awsSdk.outpostsMod.AddressLine2] = js.undefined
  
  /**
    * The third line of the address.
    */
  var AddressLine3: js.UndefOr[typings.awsSdk.outpostsMod.AddressLine3] = js.undefined
  
  /**
    * The city for the address.
    */
  var City: typings.awsSdk.outpostsMod.City
  
  /**
    * The name of the contact.
    */
  var ContactName: js.UndefOr[typings.awsSdk.outpostsMod.ContactName] = js.undefined
  
  /**
    * The phone number of the contact.
    */
  var ContactPhoneNumber: js.UndefOr[typings.awsSdk.outpostsMod.ContactPhoneNumber] = js.undefined
  
  /**
    * The ISO-3166 two-letter country code for the address.
    */
  var CountryCode: typings.awsSdk.outpostsMod.CountryCode
  
  /**
    * The district or county for the address.
    */
  var DistrictOrCounty: js.UndefOr[typings.awsSdk.outpostsMod.DistrictOrCounty] = js.undefined
  
  /**
    * The municipality for the address.
    */
  var Municipality: js.UndefOr[typings.awsSdk.outpostsMod.Municipality] = js.undefined
  
  /**
    * The postal code for the address.
    */
  var PostalCode: typings.awsSdk.outpostsMod.PostalCode
  
  /**
    * The state for the address.
    */
  var StateOrRegion: typings.awsSdk.outpostsMod.StateOrRegion
}
object Address {
