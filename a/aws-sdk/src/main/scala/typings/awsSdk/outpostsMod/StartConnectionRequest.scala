...
trait StartConnectionRequest extends StObject {
  ...
  /**
    ...
    */
  var AssetId: typings.awsSdk.outpostsMod.AssetId
  ...
  /**
    ...
    */
  var DeviceSerialNumber: typings.awsSdk.outpostsMod.DeviceSerialNumber
  
  /**
    *  The device index of the network interface on the Outpost server. 
    */
  var NetworkInterfaceDeviceIndex: typings.awsSdk.outpostsMod.NetworkInterfaceDeviceIndex
}
