...
trait Order extends StObject {
  ...
  /**
    * The ID of the order.
    */
  var OrderId: js.UndefOr[typings.awsSdk.outpostsMod.OrderId] = js.undefined
  ...
  /**
    ...
    */
  var PaymentOption: js.UndefOr[typings.awsSdk.outpostsMod.PaymentOption] = js.undefined
