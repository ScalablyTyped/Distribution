...
trait EC2Capacity extends StObject {
  ...
  /**
    ...
    */
  var Family: js.UndefOr[typings.awsSdk.outpostsMod.Family] = js.undefined
  
  /**
    *  The maximum size of the EC2 capacity. 
    */
  var MaxSize: js.UndefOr[typings.awsSdk.outpostsMod.MaxSize] = js.undefined
  
  /**
    *  The quantity of the EC2 capacity. 
    */
  var Quantity: js.UndefOr[typings.awsSdk.outpostsMod.Quantity] = js.undefined
}
object EC2Capacity {
