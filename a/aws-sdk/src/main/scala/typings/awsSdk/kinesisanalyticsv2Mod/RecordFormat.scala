...
trait RecordFormat extends StObject {
  ...
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typings.awsSdk.kinesisanalyticsv2Mod.MappingParameters] = js.undefined
  
  /**
    * The type of record format.
    */
  var RecordFormatType: typings.awsSdk.kinesisanalyticsv2Mod.RecordFormatType
}
object RecordFormat {
