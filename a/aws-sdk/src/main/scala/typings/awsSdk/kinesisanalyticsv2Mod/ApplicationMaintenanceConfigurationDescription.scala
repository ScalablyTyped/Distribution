...
trait ApplicationMaintenanceConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var ApplicationMaintenanceWindowEndTime: typings.awsSdk.kinesisanalyticsv2Mod.ApplicationMaintenanceWindowEndTime
  
  /**
    * The start time for the maintenance window.
    */
  var ApplicationMaintenanceWindowStartTime: typings.awsSdk.kinesisanalyticsv2Mod.ApplicationMaintenanceWindowStartTime
}
