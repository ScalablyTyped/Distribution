...
trait Input extends StObject {
  ...
  /**
    ...
    */
  var KinesisFirehoseInput: js.UndefOr[typings.awsSdk.kinesisanalyticsv2Mod.KinesisFirehoseInput] = js.undefined
  
  /**
    * If the streaming source is an Amazon Kinesis data stream, identifies the stream's Amazon Resource Name (ARN). 
    */
  var KinesisStreamsInput: js.UndefOr[typings.awsSdk.kinesisanalyticsv2Mod.KinesisStreamsInput] = js.undefined
