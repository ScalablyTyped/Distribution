...
trait CreateResourcePolicyResponse extends StObject {
...
object CreateResourcePolicyResponse {
  ...
  inline def apply(): CreateResourcePolicyResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateResourcePolicyResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateResourcePolicyResponse] (val x: Self) extends AnyVal {
