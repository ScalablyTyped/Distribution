...
trait CreateBackendAuthOAuthConfig extends StObject {
  ...
  /**
    ...
    */
  var OAuthGrantType: typings.awsSdk.amplifybackendMod.OAuthGrantType
  ...
  /**
    ...
    */
  var SocialProviderSettings: js.UndefOr[typings.awsSdk.amplifybackendMod.SocialProviderSettings] = js.undefined
}
