...
trait DatetimeOptions extends StObject {
  ...
  /**
    ...
    */
  var LocaleCode: js.UndefOr[typings.awsSdk.clientsDatabrewMod.LocaleCode] = js.undefined
  
  /**
    * Optional value for a timezone offset of the datetime parameter value in the Amazon S3 path. Shouldn't be used if Format for this parameter includes timezone fields. If no offset specified, UTC is assumed.
    */
  var TimezoneOffset: js.UndefOr[typings.awsSdk.clientsDatabrewMod.TimezoneOffset] = js.undefined
}
