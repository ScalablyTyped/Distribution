...
trait DescribeProjectResponse extends StObject {
  ...
  /**
    ...
    */
  var RecipeName: js.UndefOr[typings.awsSdk.clientsDatabrewMod.RecipeName] = js.undefined
  ...
  /**
    ...
    */
  var SessionStatus: js.UndefOr[typings.awsSdk.clientsDatabrewMod.SessionStatus] = js.undefined
