...
trait DatasetParameter extends StObject {
  ...
  /**
    ...
    */
  var CreateColumn: js.UndefOr[typings.awsSdk.clientsDatabrewMod.CreateColumn] = js.undefined
  
  /**
    * Additional parameter options such as a format and a timezone. Required for datetime parameters.
    */
  var DatetimeOptions: js.UndefOr[typings.awsSdk.clientsDatabrewMod.DatetimeOptions] = js.undefined
