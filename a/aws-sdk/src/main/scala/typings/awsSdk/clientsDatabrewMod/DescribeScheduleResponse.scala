...
trait DescribeScheduleResponse extends StObject {
  ...
  /**
    ...
    */
  var CronExpression: js.UndefOr[typings.awsSdk.clientsDatabrewMod.CronExpression] = js.undefined
...
object DescribeScheduleResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeScheduleResponse] (val x: Self) extends AnyVal {
