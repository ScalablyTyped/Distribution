...
trait SendProjectSessionActionRequest extends StObject {
  ...
  /**
    ...
    */
  var Preview: js.UndefOr[typings.awsSdk.clientsDatabrewMod.Preview] = js.undefined
  
  var RecipeStep: js.UndefOr[typings.awsSdk.clientsDatabrewMod.RecipeStep] = js.undefined
  
  /**
    * The index from which to preview a step. This index is used to preview the result of steps that have already been applied, so that the resulting view frame is from earlier in the view frame stack.
    */
  var StepIndex: js.UndefOr[typings.awsSdk.clientsDatabrewMod.StepIndex] = js.undefined
  
  var ViewFrame: js.UndefOr[typings.awsSdk.clientsDatabrewMod.ViewFrame] = js.undefined
}
object SendProjectSessionActionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SendProjectSessionActionRequest] (val x: Self) extends AnyVal {
