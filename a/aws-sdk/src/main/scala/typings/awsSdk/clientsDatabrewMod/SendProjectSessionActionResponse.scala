...
trait SendProjectSessionActionResponse extends StObject {
  ...
  /**
    ...
    */
  var ActionId: js.UndefOr[typings.awsSdk.clientsDatabrewMod.ActionId] = js.undefined
  ...
  /**
    ...
    */
  var Result: js.UndefOr[typings.awsSdk.clientsDatabrewMod.Result] = js.undefined
}
