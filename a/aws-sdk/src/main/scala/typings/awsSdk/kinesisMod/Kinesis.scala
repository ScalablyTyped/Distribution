...
trait Kinesis extends Service {
  ...
  @JSName("config")
  var config_Kinesis: ConfigBase & ClientConfiguration = js.native
  ...
  /**
    ...
    */
  def updateStreamMode(): Request[js.Object, AWSError] = js.native
  def updateStreamMode(callback: js.Function2[/* err */ AWSError, /* data */ js.Object, Unit]): Request[js.Object, AWSError] = js.native
  /**
    *  Updates the capacity mode of the data stream. Currently, in Kinesis Data Streams, you can choose between an on-demand capacity mode and a provisioned capacity mode for your data stream. 
    */
  def updateStreamMode(params: UpdateStreamModeInput): Request[js.Object, AWSError] = js.native
