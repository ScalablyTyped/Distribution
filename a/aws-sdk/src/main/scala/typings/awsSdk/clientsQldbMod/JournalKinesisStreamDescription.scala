...
trait JournalKinesisStreamDescription extends StObject {
  ...
  /**
    ...
    */
  var ErrorCause: js.UndefOr[typings.awsSdk.clientsQldbMod.ErrorCause] = js.undefined
  ...
  /**
    ...
    */
  var KinesisConfiguration: typings.awsSdk.clientsQldbMod.KinesisConfiguration
  ...
  /**
    ...
    */
  var StreamName: typings.awsSdk.clientsQldbMod.StreamName
}
