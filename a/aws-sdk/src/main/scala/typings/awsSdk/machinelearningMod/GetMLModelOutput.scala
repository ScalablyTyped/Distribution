...
trait GetMLModelOutput extends StObject {
  ...
  /**
    ...
    */
  var MLModelType: js.UndefOr[typings.awsSdk.machinelearningMod.MLModelType] = js.undefined
  ...
  /**
    ...
    */
  var Recipe: js.UndefOr[typings.awsSdk.machinelearningMod.Recipe] = js.undefined
  ...
  /**
    ...
    */
  var TrainingParameters: js.UndefOr[typings.awsSdk.machinelearningMod.TrainingParameters] = js.undefined
}
object GetMLModelOutput {
  ...
  extension [Self <: GetMLModelOutput](x: Self) {
    ...
    inline def setScoreThresholdLastUpdatedAt(value: EpochTime): Self = StObject.set(x, "ScoreThresholdLastUpdatedAt", value.asInstanceOf[js.Any])
