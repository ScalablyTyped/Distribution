...
trait ModuleInfo extends StObject {
  ...
  /**
    ...
    */
  var LogicalIdHierarchy: js.UndefOr[typings.awsSdk.cloudformationMod.LogicalIdHierarchy] = js.undefined
  ...
  /**
    ...
    */
  var TypeHierarchy: js.UndefOr[typings.awsSdk.cloudformationMod.TypeHierarchy] = js.undefined
}
object ModuleInfo {
