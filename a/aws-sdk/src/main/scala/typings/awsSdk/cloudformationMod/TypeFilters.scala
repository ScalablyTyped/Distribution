...
trait TypeFilters extends StObject {
  ...
  /**
    ...
    */
  var Category: js.UndefOr[typings.awsSdk.cloudformationMod.Category] = js.undefined
  ...
  /**
    ...
    */
  var TypeNamePrefix: js.UndefOr[typings.awsSdk.cloudformationMod.TypeNamePrefix] = js.undefined
}
object TypeFilters {
  ...
  extension [Self <: TypeFilters](x: Self) {
