...
trait DeleteStackInput extends StObject {
  ...
  /**
    ...
    */
  var RetainResources: js.UndefOr[typings.awsSdk.cloudformationMod.RetainResources] = js.undefined
...
object DeleteStackInput {
  ...
  extension [Self <: DeleteStackInput](x: Self) {
    ...
    inline def setRetainResourcesVarargs(value: LogicalResourceId*): Self = StObject.set(x, "RetainResources", js.Array(value*))
