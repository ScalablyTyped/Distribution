...
trait CreateChangeSetInput extends StObject {
  ...
  /**
    ...
    */
  var ChangeSetName: typings.awsSdk.cloudformationMod.ChangeSetName
  ...
  /**
    ...
    */
  var ChangeSetType: js.UndefOr[typings.awsSdk.cloudformationMod.ChangeSetType] = js.undefined
  
  /**
    * A unique identifier for this CreateChangeSet request. Specify this token if you plan to retry requests so that AWS CloudFormation knows that you're not attempting to create another change set with the same name. You might retry CreateChangeSet requests to ensure that AWS CloudFormation successfully received them.
    */
  var ClientToken: js.UndefOr[typings.awsSdk.cloudformationMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var ResourcesToImport: js.UndefOr[typings.awsSdk.cloudformationMod.ResourcesToImport] = js.undefined
