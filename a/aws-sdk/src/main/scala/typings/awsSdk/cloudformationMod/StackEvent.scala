...
trait StackEvent extends StObject {
  ...
  /**
    ...
    */
  var HookFailureMode: js.UndefOr[typings.awsSdk.cloudformationMod.HookFailureMode] = js.undefined
  
  /**
    * Invocation points are points in provisioning logic where hooks are initiated.
    */
  var HookInvocationPoint: js.UndefOr[typings.awsSdk.cloudformationMod.HookInvocationPoint] = js.undefined
  
  /**
    * Provides the status of the change set hook.
    */
  var HookStatus: js.UndefOr[typings.awsSdk.cloudformationMod.HookStatus] = js.undefined
  
  /**
    * Provides the reason for the hook status.
    */
  var HookStatusReason: js.UndefOr[typings.awsSdk.cloudformationMod.HookStatusReason] = js.undefined
  
  /**
    * The name of the hook.
    */
  var HookType: js.UndefOr[typings.awsSdk.cloudformationMod.HookType] = js.undefined
