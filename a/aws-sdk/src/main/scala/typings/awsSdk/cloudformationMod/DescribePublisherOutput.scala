...
trait DescribePublisherOutput extends StObject {
  ...
  /**
    ...
    */
  var IdentityProvider: js.UndefOr[typings.awsSdk.cloudformationMod.IdentityProvider] = js.undefined
  ...
  /**
    ...
    */
  var PublisherProfile: js.UndefOr[typings.awsSdk.cloudformationMod.PublisherProfile] = js.undefined
  
  /**
    * Whether the publisher is verified. Currently, all registered publishers are verified.
    */
  var PublisherStatus: js.UndefOr[typings.awsSdk.cloudformationMod.PublisherStatus] = js.undefined
}
