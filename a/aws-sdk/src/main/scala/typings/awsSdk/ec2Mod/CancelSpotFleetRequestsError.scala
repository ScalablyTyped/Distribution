...
object CancelSpotFleetRequestsError {
  ...
  @scala.inline
  implicit class CancelSpotFleetRequestsErrorOps[Self <: CancelSpotFleetRequestsError] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setCode(value: CancelBatchErrorCode): Self = this.set("Code", value.asInstanceOf[js.Any])
    @scala.inline
