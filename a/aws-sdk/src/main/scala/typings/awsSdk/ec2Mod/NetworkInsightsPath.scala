...
trait NetworkInsightsPath extends StObject {
  ...
  /**
    * The ID of the path.
    */
  var NetworkInsightsPathId: js.UndefOr[typings.awsSdk.ec2Mod.NetworkInsightsPathId] = js.undefined
  
  /**
    * The protocol.
    */
  var Protocol: js.UndefOr[typings.awsSdk.ec2Mod.Protocol] = js.undefined
...
object NetworkInsightsPath {
  ...
  extension [Self <: NetworkInsightsPath](x: Self) {
