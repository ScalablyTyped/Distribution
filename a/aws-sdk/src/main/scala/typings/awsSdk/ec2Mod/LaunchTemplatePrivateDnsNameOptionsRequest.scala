...
trait LaunchTemplatePrivateDnsNameOptionsRequest extends StObject {
...
object LaunchTemplatePrivateDnsNameOptionsRequest {
  
  inline def apply(): LaunchTemplatePrivateDnsNameOptionsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LaunchTemplatePrivateDnsNameOptionsRequest]
  }
  
  extension [Self <: LaunchTemplatePrivateDnsNameOptionsRequest](x: Self) {
