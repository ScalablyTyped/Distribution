...
object DescribeClientVpnConnectionsRequest {
  ...
  @scala.inline
  def apply(ClientVpnEndpointId: ClientVpnEndpointId): DescribeClientVpnConnectionsRequest = {
  ...
  @scala.inline
  implicit class DescribeClientVpnConnectionsRequestMutableBuilder[Self <: DescribeClientVpnConnectionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxResults(value: DescribeClientVpnConnectionsMaxResults): Self = StObject.set(x, "MaxResults", value.asInstanceOf[js.Any])
