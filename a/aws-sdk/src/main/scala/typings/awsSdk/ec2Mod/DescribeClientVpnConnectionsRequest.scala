...
object DescribeClientVpnConnectionsRequest {
  ...
  @scala.inline
  implicit class DescribeClientVpnConnectionsRequestOps[Self <: DescribeClientVpnConnectionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMaxResults(value: DescribeClientVpnConnectionsMaxResults): Self = this.set("MaxResults", value.asInstanceOf[js.Any])
