...
object DescribeTrafficMirrorSessionsRequest {
  ...
  @scala.inline
  implicit class DescribeTrafficMirrorSessionsRequestOps[Self <: DescribeTrafficMirrorSessionsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTrafficMirrorSessionIdsVarargs(value: TrafficMirrorSessionId*): Self = this.set("TrafficMirrorSessionIds", js.Array(value :_*))
    
    @scala.inline
    def setTrafficMirrorSessionIds(value: TrafficMirrorSessionIdList): Self = this.set("TrafficMirrorSessionIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def deleteTrafficMirrorSessionIds: Self = this.set("TrafficMirrorSessionIds", js.undefined)
  }
}
