...
@js.native
trait CreateTransitGatewayPrefixListReferenceResult extends js.Object {
...
object CreateTransitGatewayPrefixListReferenceResult {
  ...
  @scala.inline
  implicit class CreateTransitGatewayPrefixListReferenceResultOps[Self <: CreateTransitGatewayPrefixListReferenceResult] (val x: Self) extends AnyVal {
