...
@js.native
trait ModifyTransitGatewayPrefixListReferenceResult extends js.Object {
...
object ModifyTransitGatewayPrefixListReferenceResult {
  ...
  @scala.inline
  implicit class ModifyTransitGatewayPrefixListReferenceResultOps[Self <: ModifyTransitGatewayPrefixListReferenceResult] (val x: Self) extends AnyVal {
