...
trait InstanceRequirements extends StObject {
  ...
  /**
    ...
    */
  var AcceleratorCount: js.UndefOr[typings.awsSdk.ec2Mod.AcceleratorCount] = js.undefined
  ...
  /**
    ...
    */
  var AcceleratorTotalMemoryMiB: js.UndefOr[typings.awsSdk.ec2Mod.AcceleratorTotalMemoryMiB] = js.undefined
  ...
  /**
    ...
    */
  var BareMetal: js.UndefOr[typings.awsSdk.ec2Mod.BareMetal] = js.undefined
  ...
  /**
    ...
    */
  var BaselineEbsBandwidthMbps: js.UndefOr[typings.awsSdk.ec2Mod.BaselineEbsBandwidthMbps] = js.undefined
  ...
  /**
    ...
    */
  var BurstablePerformance: js.UndefOr[typings.awsSdk.ec2Mod.BurstablePerformance] = js.undefined
  ...
  /**
    ...
    */
  var LocalStorage: js.UndefOr[typings.awsSdk.ec2Mod.LocalStorage] = js.undefined
  ...
  /**
    ...
    */
  var MemoryGiBPerVCpu: js.UndefOr[typings.awsSdk.ec2Mod.MemoryGiBPerVCpu] = js.undefined
  
  /**
    * The minimum and maximum amount of memory, in MiB.
    */
  var MemoryMiB: js.UndefOr[typings.awsSdk.ec2Mod.MemoryMiB] = js.undefined
  
  /**
    * The minimum and maximum number of network interfaces. Default: No minimum or maximum limits
    */
  var NetworkInterfaceCount: js.UndefOr[typings.awsSdk.ec2Mod.NetworkInterfaceCount] = js.undefined
  ...
  /**
    ...
    */
  var TotalLocalStorageGB: js.UndefOr[typings.awsSdk.ec2Mod.TotalLocalStorageGB] = js.undefined
  
  /**
    * The minimum and maximum number of vCPUs.
    */
  var VCpuCount: js.UndefOr[VCpuCountRange] = js.undefined
}
object InstanceRequirements {
  
  inline def apply(): InstanceRequirements = {
  ...
  extension [Self <: InstanceRequirements](x: Self) {
    ...
    inline def setAcceleratorCount(value: AcceleratorCount): Self = StObject.set(x, "AcceleratorCount", value.asInstanceOf[js.Any])
    ...
    inline def setAcceleratorTotalMemoryMiB(value: AcceleratorTotalMemoryMiB): Self = StObject.set(x, "AcceleratorTotalMemoryMiB", value.asInstanceOf[js.Any])
    ...
    inline def setBaselineEbsBandwidthMbps(value: BaselineEbsBandwidthMbps): Self = StObject.set(x, "BaselineEbsBandwidthMbps", value.asInstanceOf[js.Any])
    ...
    inline def setMemoryGiBPerVCpu(value: MemoryGiBPerVCpu): Self = StObject.set(x, "MemoryGiBPerVCpu", value.asInstanceOf[js.Any])
    
    inline def setMemoryGiBPerVCpuUndefined: Self = StObject.set(x, "MemoryGiBPerVCpu", js.undefined)
    
    inline def setMemoryMiB(value: MemoryMiB): Self = StObject.set(x, "MemoryMiB", value.asInstanceOf[js.Any])
    
    inline def setMemoryMiBUndefined: Self = StObject.set(x, "MemoryMiB", js.undefined)
    
    inline def setNetworkInterfaceCount(value: NetworkInterfaceCount): Self = StObject.set(x, "NetworkInterfaceCount", value.asInstanceOf[js.Any])
    ...
    inline def setTotalLocalStorageGB(value: TotalLocalStorageGB): Self = StObject.set(x, "TotalLocalStorageGB", value.asInstanceOf[js.Any])
    
    inline def setTotalLocalStorageGBUndefined: Self = StObject.set(x, "TotalLocalStorageGB", js.undefined)
    
    inline def setVCpuCount(value: VCpuCountRange): Self = StObject.set(x, "VCpuCount", value.asInstanceOf[js.Any])
