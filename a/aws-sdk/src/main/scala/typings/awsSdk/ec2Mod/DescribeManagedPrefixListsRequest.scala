...
object DescribeManagedPrefixListsRequest {
  ...
  @scala.inline
  implicit class DescribeManagedPrefixListsRequestOps[Self <: DescribeManagedPrefixListsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPrefixListIds(value: ValueStringList): Self = this.set("PrefixListIds", value.asInstanceOf[js.Any])
    @scala.inline
