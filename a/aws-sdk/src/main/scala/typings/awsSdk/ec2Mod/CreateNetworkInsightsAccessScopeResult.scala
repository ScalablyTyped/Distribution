...
trait CreateNetworkInsightsAccessScopeResult extends StObject {
  ...
  /**
    ...
    */
  var NetworkInsightsAccessScope: js.UndefOr[typings.awsSdk.ec2Mod.NetworkInsightsAccessScope] = js.undefined
  
  /**
    * The Network Access Scope content.
    */
  var NetworkInsightsAccessScopeContent: js.UndefOr[typings.awsSdk.ec2Mod.NetworkInsightsAccessScopeContent] = js.undefined
}
