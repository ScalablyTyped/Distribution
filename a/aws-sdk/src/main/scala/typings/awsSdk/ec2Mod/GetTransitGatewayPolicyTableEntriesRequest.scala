...
trait GetTransitGatewayPolicyTableEntriesRequest extends StObject {
...
object GetTransitGatewayPolicyTableEntriesRequest {
  ...
  inline def apply(TransitGatewayPolicyTableId: TransitGatewayPolicyTableId): GetTransitGatewayPolicyTableEntriesRequest = {
    val __obj = js.Dynamic.literal(TransitGatewayPolicyTableId = TransitGatewayPolicyTableId.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetTransitGatewayPolicyTableEntriesRequest]
  }
  
  extension [Self <: GetTransitGatewayPolicyTableEntriesRequest](x: Self) {
