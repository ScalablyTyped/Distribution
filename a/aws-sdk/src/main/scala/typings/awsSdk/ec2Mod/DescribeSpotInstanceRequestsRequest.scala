...
@js.native
trait DescribeSpotInstanceRequestsRequest extends StObject {
...
object DescribeSpotInstanceRequestsRequest {
  ...
  @scala.inline
  def apply(): DescribeSpotInstanceRequestsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeSpotInstanceRequestsRequest]
  }
  
  @scala.inline
  implicit class DescribeSpotInstanceRequestsRequestMutableBuilder[Self <: DescribeSpotInstanceRequestsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSpotInstanceRequestIdsUndefined: Self = StObject.set(x, "SpotInstanceRequestIds", js.undefined)
