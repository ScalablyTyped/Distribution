...
trait DeleteTransitGatewayRouteTableAnnouncementRequest extends StObject {
  ...
  /**
    ...
    */
  var TransitGatewayRouteTableAnnouncementId: typings.awsSdk.ec2Mod.TransitGatewayRouteTableAnnouncementId
}
object DeleteTransitGatewayRouteTableAnnouncementRequest {
  ...
  extension [Self <: DeleteTransitGatewayRouteTableAnnouncementRequest](x: Self) {
