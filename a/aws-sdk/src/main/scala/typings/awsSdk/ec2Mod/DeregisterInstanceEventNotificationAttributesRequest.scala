...
object DeregisterInstanceEventNotificationAttributesRequest {
  ...
  @scala.inline
  implicit class DeregisterInstanceEventNotificationAttributesRequestOps[Self <: DeregisterInstanceEventNotificationAttributesRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setInstanceTagAttribute(value: DeregisterInstanceTagAttributeRequest): Self = this.set("InstanceTagAttribute", value.asInstanceOf[js.Any])
    @scala.inline
