...
object SearchTransitGatewayMulticastGroupsRequest {
  ...
  @scala.inline
  def apply(): SearchTransitGatewayMulticastGroupsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SearchTransitGatewayMulticastGroupsRequest]
  }
  
  @scala.inline
  implicit class SearchTransitGatewayMulticastGroupsRequestMutableBuilder[Self <: SearchTransitGatewayMulticastGroupsRequest] (val x: Self) extends AnyVal {
