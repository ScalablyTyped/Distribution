...
object DescribeByoipCidrsRequest {
  ...
  @scala.inline
  implicit class DescribeByoipCidrsRequestOps[Self <: DescribeByoipCidrsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMaxResults(value: DescribeByoipCidrsMaxResults): Self = this.set("MaxResults", value.asInstanceOf[js.Any])
    @scala.inline
