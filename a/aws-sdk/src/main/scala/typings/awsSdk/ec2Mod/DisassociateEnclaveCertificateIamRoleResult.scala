...
@js.native
trait DisassociateEnclaveCertificateIamRoleResult extends js.Object {
...
object DisassociateEnclaveCertificateIamRoleResult {
  ...
  @scala.inline
  implicit class DisassociateEnclaveCertificateIamRoleResultOps[Self <: DisassociateEnclaveCertificateIamRoleResult] (val x: Self) extends AnyVal {
