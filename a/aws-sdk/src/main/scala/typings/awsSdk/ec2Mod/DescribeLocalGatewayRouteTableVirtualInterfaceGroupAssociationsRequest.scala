...
object DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest {
  ...
  extension [Self <: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest](x: Self) {
    ...
    inline def setLocalGatewayRouteTableVirtualInterfaceGroupAssociationIdsVarargs(value: LocalGatewayRouteTableVirtualInterfaceGroupAssociationId*): Self = StObject.set(x, "LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds", js.Array(value :_*))
