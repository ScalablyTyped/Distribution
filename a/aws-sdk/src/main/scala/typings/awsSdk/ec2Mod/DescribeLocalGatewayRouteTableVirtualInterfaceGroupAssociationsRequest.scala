...
object DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest {
  ...
  @scala.inline
  implicit class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestMutableBuilder[Self <: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLocalGatewayRouteTableVirtualInterfaceGroupAssociationIds(value: LocalGatewayRouteTableVirtualInterfaceGroupAssociationIdSet): Self = StObject.set(x, "LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLocalGatewayRouteTableVirtualInterfaceGroupAssociationIdsUndefined: Self = StObject.set(x, "LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds", js.undefined)
    
    @scala.inline
    def setLocalGatewayRouteTableVirtualInterfaceGroupAssociationIdsVarargs(value: LocalGatewayRouteTableVirtualInterfaceGroupAssociationId*): Self = StObject.set(x, "LocalGatewayRouteTableVirtualInterfaceGroupAssociationIds", js.Array(value :_*))
