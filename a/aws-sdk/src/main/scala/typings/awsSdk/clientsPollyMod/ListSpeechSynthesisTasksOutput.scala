...
trait ListSpeechSynthesisTasksOutput extends StObject {
  ...
  /**
    ...
    */
  var SynthesisTasks: js.UndefOr[typings.awsSdk.clientsPollyMod.SynthesisTasks] = js.undefined
}
object ListSpeechSynthesisTasksOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSpeechSynthesisTasksOutput] (val x: Self) extends AnyVal {
