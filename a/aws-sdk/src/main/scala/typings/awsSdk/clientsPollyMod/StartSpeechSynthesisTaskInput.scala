...
trait StartSpeechSynthesisTaskInput extends StObject {
  ...
  /**
    ...
    */
  var OutputS3BucketName: typings.awsSdk.clientsPollyMod.OutputS3BucketName
  
  /**
    * The Amazon S3 key prefix for the output speech file.
    */
  var OutputS3KeyPrefix: js.UndefOr[typings.awsSdk.clientsPollyMod.OutputS3KeyPrefix] = js.undefined
  ...
  /**
    ...
    */
  var SnsTopicArn: js.UndefOr[typings.awsSdk.clientsPollyMod.SnsTopicArn] = js.undefined
...
object StartSpeechSynthesisTaskInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StartSpeechSynthesisTaskInput] (val x: Self) extends AnyVal {
