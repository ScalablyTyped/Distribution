...
trait GetApplicationResponse extends StObject {
  ...
  /**
    ...
    */
  var ApiGatewayProxy: js.UndefOr[ApiGatewayProxyConfig] = js.undefined
...
object GetApplicationResponse {
  ...
  extension [Self <: GetApplicationResponse](x: Self) {
    ...
    inline def setApiGatewayProxy(value: ApiGatewayProxyConfig): Self = StObject.set(x, "ApiGatewayProxy", value.asInstanceOf[js.Any])
