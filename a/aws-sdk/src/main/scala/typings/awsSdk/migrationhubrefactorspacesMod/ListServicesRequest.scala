...
trait ListServicesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.MaxResults] = js.undefined
...
object ListServicesRequest {
  ...
  inline def apply(ApplicationIdentifier: ApplicationId, EnvironmentIdentifier: EnvironmentId): ListServicesRequest = {
