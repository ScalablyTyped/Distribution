...
trait ApiGatewayProxySummary extends StObject {
  ...
  /**
    ...
    */
  var ApiGatewayId: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.ApiGatewayId] = js.undefined
  ...
  /**
    ...
    */
  var NlbArn: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.NlbArn] = js.undefined
  
  /**
    * The name of the Network Load Balancer that is configured by the API Gateway proxy. 
    */
  var NlbName: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.NlbName] = js.undefined
  ...
  /**
    ...
    */
  var VpcLinkId: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.VpcLinkId] = js.undefined
}
