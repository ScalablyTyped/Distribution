...
trait GetServiceResponse extends StObject {
  ...
  /**
    ...
    */
  var LambdaEndpoint: js.UndefOr[LambdaEndpointConfig] = js.undefined
  ...
  /**
    ...
    */
  var UrlEndpoint: js.UndefOr[UrlEndpointConfig] = js.undefined
  
  /**
    * The ID of the virtual private cloud (VPC). 
    */
  var VpcId: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.VpcId] = js.undefined
}
object GetServiceResponse {
  ...
  extension [Self <: GetServiceResponse](x: Self) {
    ...
    inline def setLambdaEndpoint(value: LambdaEndpointConfig): Self = StObject.set(x, "LambdaEndpoint", value.asInstanceOf[js.Any])
    ...
    inline def setUrlEndpoint(value: UrlEndpointConfig): Self = StObject.set(x, "UrlEndpoint", value.asInstanceOf[js.Any])
