...
trait EnvironmentVpc extends StObject {
  ...
  /**
    ...
    */
  var AccountId: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.AccountId] = js.undefined
  
  /**
    * The list of Amazon Virtual Private Cloud (Amazon VPC) CIDR blocks. 
    */
  var CidrBlocks: js.UndefOr[typings.awsSdk.migrationhubrefactorspacesMod.CidrBlocks] = js.undefined
