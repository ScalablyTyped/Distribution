...
trait CreateApplicationInstanceRequest extends StObject {
  ...
  /**
    * A device's ID.
    */
  var DefaultRuntimeContextDevice: typings.awsSdk.panoramaMod.DefaultRuntimeContextDevice
  ...
  /**
    ...
    */
  var ManifestOverridesPayload: js.UndefOr[typings.awsSdk.panoramaMod.ManifestOverridesPayload] = js.undefined
  
  /**
    * The application's manifest document.
    */
  var ManifestPayload: typings.awsSdk.panoramaMod.ManifestPayload
  ...
  /**
    ...
    */
  var RuntimeRoleArn: js.UndefOr[typings.awsSdk.panoramaMod.RuntimeRoleArn] = js.undefined
