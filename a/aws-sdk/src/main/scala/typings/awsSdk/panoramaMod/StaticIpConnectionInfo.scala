...
trait StaticIpConnectionInfo extends StObject {
  ...
  /**
    ...
    */
  var DefaultGateway: typings.awsSdk.panoramaMod.DefaultGateway
  ...
  /**
    ...
    */
  var IpAddress: typings.awsSdk.panoramaMod.IpAddress
  
  /**
    * The connection's DNS mask.
    */
  var Mask: typings.awsSdk.panoramaMod.Mask
}
