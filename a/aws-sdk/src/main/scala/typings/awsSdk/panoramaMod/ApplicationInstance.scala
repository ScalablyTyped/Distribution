...
trait ApplicationInstance extends StObject {
  ...
  /**
    ...
    */
  var ApplicationInstanceId: js.UndefOr[typings.awsSdk.panoramaMod.ApplicationInstanceId] = js.undefined
  ...
  /**
    * The device's ID.
    */
  var DefaultRuntimeContextDevice: js.UndefOr[typings.awsSdk.panoramaMod.DefaultRuntimeContextDevice] = js.undefined
