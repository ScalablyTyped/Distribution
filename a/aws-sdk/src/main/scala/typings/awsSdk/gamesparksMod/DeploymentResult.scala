...
trait DeploymentResult extends StObject {
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typings.awsSdk.gamesparksMod.Message] = js.undefined
  
  /**
    * The type of deployment result.
    */
  var ResultCode: js.UndefOr[typings.awsSdk.gamesparksMod.ResultCode] = js.undefined
}
