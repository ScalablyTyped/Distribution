...
trait Generator extends StObject {
  ...
  /**
    ...
    */
  var GameSdkVersion: js.UndefOr[typings.awsSdk.gamesparksMod.GameSdkVersion] = js.undefined
  ...
  /**
    ...
    */
  var Language: js.UndefOr[typings.awsSdk.gamesparksMod.Language] = js.undefined
  
  /**
    * The platform that will be used to run the generated code.
    */
  var TargetPlatform: js.UndefOr[typings.awsSdk.gamesparksMod.TargetPlatform] = js.undefined
}
object Generator {
