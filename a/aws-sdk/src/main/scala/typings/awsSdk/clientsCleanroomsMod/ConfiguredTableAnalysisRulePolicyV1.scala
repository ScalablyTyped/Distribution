...
trait ConfiguredTableAnalysisRulePolicyV1 extends StObject {
...
object ConfiguredTableAnalysisRulePolicyV1 {
  
  inline def apply(): ConfiguredTableAnalysisRulePolicyV1 = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConfiguredTableAnalysisRulePolicyV1]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ConfiguredTableAnalysisRulePolicyV1] (val x: Self) extends AnyVal {
