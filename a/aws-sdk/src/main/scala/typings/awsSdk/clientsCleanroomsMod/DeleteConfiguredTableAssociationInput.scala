...
trait DeleteConfiguredTableAssociationInput extends StObject {
...
object DeleteConfiguredTableAssociationInput {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[DeleteConfiguredTableAssociationInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteConfiguredTableAssociationInput] (val x: Self) extends AnyVal {
