...
trait AssociateNodeRequest extends StObject {
  ...
  /**
    ...
    */
  var EngineAttributes: typings.awsSdk.clientsOpsworkscmMod.EngineAttributes
...
object AssociateNodeRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AssociateNodeRequest] (val x: Self) extends AnyVal {
