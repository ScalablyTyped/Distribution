...
trait CreateServerRequest extends StObject {
  ...
  /**
    ...
    */
  var CustomCertificate: js.UndefOr[typings.awsSdk.clientsOpsworkscmMod.CustomCertificate] = js.undefined
  ...
  /**
    ...
    */
  var CustomPrivateKey: js.UndefOr[typings.awsSdk.clientsOpsworkscmMod.CustomPrivateKey] = js.undefined
  ...
  /**
    ...
    */
  var InstanceProfileArn: typings.awsSdk.clientsOpsworkscmMod.InstanceProfileArn
  ...
  /**
    ...
    */
  var ServiceRoleArn: typings.awsSdk.clientsOpsworkscmMod.ServiceRoleArn
...
object CreateServerRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateServerRequest] (val x: Self) extends AnyVal {
