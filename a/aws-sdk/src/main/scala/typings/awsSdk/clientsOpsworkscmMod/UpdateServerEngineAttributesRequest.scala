...
trait UpdateServerEngineAttributesRequest extends StObject {
  ...
  /**
    ...
    */
  var AttributeName: typings.awsSdk.clientsOpsworkscmMod.AttributeName
  
  /**
    * The value to set for the attribute. 
    */
  var AttributeValue: js.UndefOr[typings.awsSdk.clientsOpsworkscmMod.AttributeValue] = js.undefined
...
object UpdateServerEngineAttributesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateServerEngineAttributesRequest] (val x: Self) extends AnyVal {
