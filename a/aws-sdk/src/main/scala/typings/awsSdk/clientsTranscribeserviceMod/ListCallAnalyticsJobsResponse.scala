...
trait ListCallAnalyticsJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var CallAnalyticsJobSummaries: js.UndefOr[typings.awsSdk.clientsTranscribeserviceMod.CallAnalyticsJobSummaries] = js.undefined
...
object ListCallAnalyticsJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCallAnalyticsJobsResponse] (val x: Self) extends AnyVal {
