...
trait SubtitlesOutput extends StObject {
  ...
  /**
    ...
    */
  var SubtitleFileUris: js.UndefOr[typings.awsSdk.clientsTranscribeserviceMod.SubtitleFileUris] = js.undefined
}
object SubtitlesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SubtitlesOutput] (val x: Self) extends AnyVal {
