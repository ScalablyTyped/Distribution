...
trait CreateLanguageModelResponse extends StObject {
  ...
  /**
    ...
    */
  var BaseModelName: js.UndefOr[typings.awsSdk.clientsTranscribeserviceMod.BaseModelName] = js.undefined
  ...
  /**
    ...
    */
  var ModelName: js.UndefOr[typings.awsSdk.clientsTranscribeserviceMod.ModelName] = js.undefined
...
object CreateLanguageModelResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateLanguageModelResponse] (val x: Self) extends AnyVal {
