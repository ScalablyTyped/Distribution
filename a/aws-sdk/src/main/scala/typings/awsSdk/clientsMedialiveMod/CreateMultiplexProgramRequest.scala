...
trait CreateMultiplexProgramRequest extends StObject {
  ...
  /**
    ...
    */
  var MultiplexProgramSettings: typings.awsSdk.clientsMedialiveMod.MultiplexProgramSettings
...
object CreateMultiplexProgramRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateMultiplexProgramRequest] (val x: Self) extends AnyVal {
