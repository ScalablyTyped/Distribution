...
object DvbSubDestinationSettings {
  ...
  implicit open class MutableBuilder[Self <: DvbSubDestinationSettings] (val x: Self) extends AnyVal {
    ...
    inline def setBackgroundColor(value: DvbSubDestinationBackgroundColor): Self = StObject.set(x, "BackgroundColor", value.asInstanceOf[js.Any])
    ...
    inline def setFontColor(value: DvbSubDestinationFontColor): Self = StObject.set(x, "FontColor", value.asInstanceOf[js.Any])
    ...
    inline def setOutlineColor(value: DvbSubDestinationOutlineColor): Self = StObject.set(x, "OutlineColor", value.asInstanceOf[js.Any])
    ...
    inline def setShadowColor(value: DvbSubDestinationShadowColor): Self = StObject.set(x, "ShadowColor", value.asInstanceOf[js.Any])
    ...
    inline def setTeletextGridControl(value: DvbSubDestinationTeletextGridControl): Self = StObject.set(x, "TeletextGridControl", value.asInstanceOf[js.Any])
