...
trait OutputSettings extends StObject {
  ...
  var ArchiveOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.ArchiveOutputSettings] = js.undefined
  
  var FrameCaptureOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.FrameCaptureOutputSettings] = js.undefined
  
  var HlsOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.HlsOutputSettings] = js.undefined
  
  var MediaPackageOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.MediaPackageOutputSettings] = js.undefined
  
  var MsSmoothOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.MsSmoothOutputSettings] = js.undefined
  
  var MultiplexOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.MultiplexOutputSettings] = js.undefined
  
  var RtmpOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.RtmpOutputSettings] = js.undefined
  
  var UdpOutputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.UdpOutputSettings] = js.undefined
}
