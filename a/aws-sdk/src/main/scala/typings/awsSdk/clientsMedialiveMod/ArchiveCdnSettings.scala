...
trait ArchiveCdnSettings extends StObject {
  ...
  var ArchiveS3Settings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.ArchiveS3Settings] = js.undefined
}
object ArchiveCdnSettings {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ArchiveCdnSettings] (val x: Self) extends AnyVal {
