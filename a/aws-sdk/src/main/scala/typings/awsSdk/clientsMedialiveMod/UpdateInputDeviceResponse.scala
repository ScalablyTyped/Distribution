...
trait UpdateInputDeviceResponse extends StObject {
  ...
  /**
    ...
    */
  var DeviceSettingsSyncState: js.UndefOr[typings.awsSdk.clientsMedialiveMod.DeviceSettingsSyncState] = js.undefined
  
  /**
    * The status of software on the input device.
    */
  var DeviceUpdateStatus: js.UndefOr[typings.awsSdk.clientsMedialiveMod.DeviceUpdateStatus] = js.undefined
...
object UpdateInputDeviceResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateInputDeviceResponse] (val x: Self) extends AnyVal {
