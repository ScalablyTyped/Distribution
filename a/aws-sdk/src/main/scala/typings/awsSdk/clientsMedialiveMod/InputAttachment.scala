...
trait InputAttachment extends StObject {
  ...
  /**
    ...
    */
  var AutomaticInputFailoverSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.AutomaticInputFailoverSettings] = js.undefined
  ...
  /**
    ...
    */
  var InputSettings: js.UndefOr[typings.awsSdk.clientsMedialiveMod.InputSettings] = js.undefined
}
