...
trait DeleteLaunchProfileMemberRequest extends StObject {
...
object DeleteLaunchProfileMemberRequest {
  ...
  inline def apply(launchProfileId: String, principalId: String, studioId: String): DeleteLaunchProfileMemberRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteLaunchProfileMemberRequest] (val x: Self) extends AnyVal {
