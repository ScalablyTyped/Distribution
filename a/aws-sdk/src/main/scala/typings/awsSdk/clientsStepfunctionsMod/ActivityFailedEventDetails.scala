...
trait ActivityFailedEventDetails extends StObject {
...
object ActivityFailedEventDetails {
  ...
  inline def apply(): ActivityFailedEventDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ActivityFailedEventDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ActivityFailedEventDetails] (val x: Self) extends AnyVal {
