...
object TaskTimedOutEventDetails {
  ...
  inline def apply(resource: Name, resourceType: Name): TaskTimedOutEventDetails = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TaskTimedOutEventDetails] (val x: Self) extends AnyVal {
