...
trait MapRunFailedEventDetails extends StObject {
...
object MapRunFailedEventDetails {
  ...
  inline def apply(): MapRunFailedEventDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MapRunFailedEventDetails]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: MapRunFailedEventDetails] (val x: Self) extends AnyVal {
