...
object DescribeActivityOutput {
  ...
  inline def apply(activityArn: Arn, creationDate: js.Date, name: Name): DescribeActivityOutput = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeActivityOutput] (val x: Self) extends AnyVal {
