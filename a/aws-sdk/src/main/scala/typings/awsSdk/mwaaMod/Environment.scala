...
trait Environment extends StObject {
  ...
  /**
    ...
    */
  var AirflowConfigurationOptions: js.UndefOr[typings.awsSdk.mwaaMod.AirflowConfigurationOptions] = js.undefined
  
  /**
    * The Apache Airflow version on your environment. Valid values: 1.10.12, 2.0.2, and 2.2.2.
    */
  var AirflowVersion: js.UndefOr[typings.awsSdk.mwaaMod.AirflowVersion] = js.undefined
  ...
  /**
    ...
    */
  var EnvironmentClass: js.UndefOr[typings.awsSdk.mwaaMod.EnvironmentClass] = js.undefined
  ...
  /**
    ...
    */
  var KmsKey: js.UndefOr[typings.awsSdk.mwaaMod.KmsKey] = js.undefined
  
  /**
    * The status of the last update on the environment.
    */
  var LastUpdate: js.UndefOr[typings.awsSdk.mwaaMod.LastUpdate] = js.undefined
  
  /**
    * The Apache Airflow logs published to CloudWatch Logs.
    */
  var LoggingConfiguration: js.UndefOr[typings.awsSdk.mwaaMod.LoggingConfiguration] = js.undefined
  
  /**
    * The maximum number of workers that run in your environment. For example, 20.
    */
  var MaxWorkers: js.UndefOr[typings.awsSdk.mwaaMod.MaxWorkers] = js.undefined
  
  /**
    * The minimum number of workers that run in your environment. For example, 2.
    */
  var MinWorkers: js.UndefOr[typings.awsSdk.mwaaMod.MinWorkers] = js.undefined
  ...
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typings.awsSdk.mwaaMod.NetworkConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var Schedulers: js.UndefOr[typings.awsSdk.mwaaMod.Schedulers] = js.undefined
  ...
  /**
    ...
    */
  var WebserverAccessMode: js.UndefOr[typings.awsSdk.mwaaMod.WebserverAccessMode] = js.undefined
  ...
  /**
    ...
    */
  var WebserverUrl: js.UndefOr[typings.awsSdk.mwaaMod.WebserverUrl] = js.undefined
  
  /**
    * The day and time of the week in Coordinated Universal Time (UTC) 24-hour standard time that weekly maintenance updates are scheduled. For example: TUE:03:30.
    */
  var WeeklyMaintenanceWindowStart: js.UndefOr[typings.awsSdk.mwaaMod.WeeklyMaintenanceWindowStart] = js.undefined
}
object Environment {
