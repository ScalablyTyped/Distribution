...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typings.awsSdk.clientsNeptuneMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typings.awsSdk.clientsNeptuneMod.SourceIdsList] = js.undefined
