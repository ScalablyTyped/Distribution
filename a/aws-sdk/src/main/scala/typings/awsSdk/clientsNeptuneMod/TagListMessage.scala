...
trait TagListMessage extends StObject {
  ...
  /**
    ...
    */
  var TagList: js.UndefOr[typings.awsSdk.clientsNeptuneMod.TagList] = js.undefined
}
object TagListMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TagListMessage] (val x: Self) extends AnyVal {
