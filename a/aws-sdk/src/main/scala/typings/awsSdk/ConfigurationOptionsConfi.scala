...
object ConfigurationOptionsConfi {
  ...
  def apply(
    ...
    workmailmessageflow: typings.awsSdk.workmailmessageflowMod.ClientConfiguration = null,
    workspaces: typings.awsSdk.workspacesMod.ClientConfiguration = null,
    xray: typings.awsSdk.xrayMod.ClientConfiguration = null
