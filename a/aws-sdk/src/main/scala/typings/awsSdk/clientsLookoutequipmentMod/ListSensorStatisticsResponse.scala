...
trait ListSensorStatisticsResponse extends StObject {
  ...
  /**
    ...
    */
  var SensorStatisticsSummaries: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.SensorStatisticsSummaries] = js.undefined
}
object ListSensorStatisticsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSensorStatisticsResponse] (val x: Self) extends AnyVal {
