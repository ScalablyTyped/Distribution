...
trait SensorStatisticsSummary extends StObject {
  ...
  /**
    ...
    */
  var CategoricalValues: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.CategoricalValues] = js.undefined
  
  /**
    *  Name of the component to which the particular sensor belongs for which the statistics belong to. 
    */
  var ComponentName: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.ComponentName] = js.undefined
  ...
  /**
    ...
    */
  var LargeTimestampGaps: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.LargeTimestampGaps] = js.undefined
  ...
  /**
    ...
    */
  var MonotonicValues: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.MonotonicValues] = js.undefined
  
  /**
    *  Parameter that describes potential risk about whether data associated with the sensor has more than one operating mode. 
    */
  var MultipleOperatingModes: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.MultipleOperatingModes] = js.undefined
  
  /**
    *  Name of the sensor that the statistics belong to. 
    */
  var SensorName: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.SensorName] = js.undefined
}
