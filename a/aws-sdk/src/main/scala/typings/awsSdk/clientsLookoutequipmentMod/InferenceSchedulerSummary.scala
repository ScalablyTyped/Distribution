...
trait InferenceSchedulerSummary extends StObject {
  ...
  /**
    ...
    */
  var LatestInferenceResult: js.UndefOr[typings.awsSdk.clientsLookoutequipmentMod.LatestInferenceResult] = js.undefined
...
object InferenceSchedulerSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InferenceSchedulerSummary] (val x: Self) extends AnyVal {
