...
trait StartDataIngestionJobRequest extends StObject {
  ...
  /**
    ...
    */
  var IngestionInputConfiguration: typings.awsSdk.clientsLookoutequipmentMod.IngestionInputConfiguration
...
object StartDataIngestionJobRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StartDataIngestionJobRequest] (val x: Self) extends AnyVal {
