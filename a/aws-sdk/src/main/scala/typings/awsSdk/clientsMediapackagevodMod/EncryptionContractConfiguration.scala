...
trait EncryptionContractConfiguration extends StObject {
  ...
  /**
    ...
    */
  var PresetSpeke20Audio: typings.awsSdk.clientsMediapackagevodMod.PresetSpeke20Audio
  
  /**
    * A collection of video encryption presets.
    */
  var PresetSpeke20Video: typings.awsSdk.clientsMediapackagevodMod.PresetSpeke20Video
}
