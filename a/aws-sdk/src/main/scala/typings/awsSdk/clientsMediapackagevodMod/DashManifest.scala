...
trait DashManifest extends StObject {
  ...
  /**
    ...
    */
  var ManifestLayout: js.UndefOr[typings.awsSdk.clientsMediapackagevodMod.ManifestLayout] = js.undefined
  ...
  /**
    ...
    */
  var Profile: js.UndefOr[typings.awsSdk.clientsMediapackagevodMod.Profile] = js.undefined
  
  /**
    * The source of scte markers used. When set to SEGMENTS, the scte markers are sourced from the segments of the ingested content. When set to MANIFEST, the scte markers are sourced from the manifest of the ingested content.
    */
  var ScteMarkersSource: js.UndefOr[typings.awsSdk.clientsMediapackagevodMod.ScteMarkersSource] = js.undefined
