...
trait HlsEncryption extends StObject {
  ...
  /**
    ...
    */
  var EncryptionMethod: js.UndefOr[typings.awsSdk.clientsMediapackagevodMod.EncryptionMethod] = js.undefined
...
object HlsEncryption {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HlsEncryption] (val x: Self) extends AnyVal {
