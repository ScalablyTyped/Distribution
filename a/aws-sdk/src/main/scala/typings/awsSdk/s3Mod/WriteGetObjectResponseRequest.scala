...
trait WriteGetObjectResponseRequest extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typings.awsSdk.s3Mod.ErrorCode] = js.undefined
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typings.awsSdk.s3Mod.ErrorMessage] = js.undefined
  ...
  /**
    ...
    */
  var RequestRoute: typings.awsSdk.s3Mod.RequestRoute
  
  /**
    * A single use encrypted token that maps WriteGetObjectResponse to the end user GetObject request.
    */
  var RequestToken: typings.awsSdk.s3Mod.RequestToken
