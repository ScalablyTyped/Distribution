...
package object s3Mod {
  ...
  */
  ...
  type ClientConfiguration = typings.awsSdk.serviceMod.ServiceConfigurationOptions with typings.awsSdk.configUseDualstackMod.UseDualstackConfigOptions with typings.awsSdk.s3Mod.ClientApiVersions
