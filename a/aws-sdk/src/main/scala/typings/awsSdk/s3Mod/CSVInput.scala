...
trait CSVInput extends StObject {
  ...
  /**
    ...
    */
  var AllowQuotedRecordDelimiter: js.UndefOr[typings.awsSdk.s3Mod.AllowQuotedRecordDelimiter] = js.undefined
  
  /**
    * A single character used to indicate that a row should be ignored when the character is present at the start of that row. You can specify any character to indicate a comment line.
    */
  var Comments: js.UndefOr[typings.awsSdk.s3Mod.Comments] = js.undefined
  ...
  /**
    ...
    */
  var FileHeaderInfo: js.UndefOr[typings.awsSdk.s3Mod.FileHeaderInfo] = js.undefined
