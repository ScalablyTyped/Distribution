...
trait ImportAssetsFromLakeFormationTagPolicyRequestDetails extends StObject {
...
object ImportAssetsFromLakeFormationTagPolicyRequestDetails {
  ...
  inline def apply(CatalogId: AwsAccountId, DataSetId: Id, RevisionId: Id, RoleArn: RoleArn): ImportAssetsFromLakeFormationTagPolicyRequestDetails = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ImportAssetsFromLakeFormationTagPolicyRequestDetails] (val x: Self) extends AnyVal {
