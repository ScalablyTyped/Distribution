...
object AuditSuppression {
  ...
  inline def apply(checkName: AuditCheckName, resourceIdentifier: ResourceIdentifier): AuditSuppression = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AuditSuppression] (val x: Self) extends AnyVal {
