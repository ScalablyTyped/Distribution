...
@js.native
trait ConfigureLogsResponse extends StObject {
...
object ConfigureLogsResponse {
  ...
  @scala.inline
  def apply(): ConfigureLogsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ConfigureLogsResponse]
  }
  
  @scala.inline
  implicit class ConfigureLogsResponseMutableBuilder[Self <: ConfigureLogsResponse] (val x: Self) extends AnyVal {
