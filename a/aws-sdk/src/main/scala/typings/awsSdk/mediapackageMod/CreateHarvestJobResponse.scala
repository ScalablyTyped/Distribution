...
@js.native
trait CreateHarvestJobResponse extends StObject {
...
object CreateHarvestJobResponse {
  ...
  @scala.inline
  implicit class CreateHarvestJobResponseMutableBuilder[Self <: CreateHarvestJobResponse] (val x: Self) extends AnyVal {
