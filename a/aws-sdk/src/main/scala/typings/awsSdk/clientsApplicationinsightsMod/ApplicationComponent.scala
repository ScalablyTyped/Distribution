...
trait ApplicationComponent extends StObject {
  ...
  /**
    ...
    */
  var DetectedWorkload: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.DetectedWorkload] = js.undefined
  ...
  /**
    ...
    */
  var OsType: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.OsType] = js.undefined
  
  /**
    * The resource type. Supported resource types include EC2 instances, Auto Scaling group, Classic ELB, Application ELB, and SQS Queue.
    */
  var ResourceType: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.ResourceType] = js.undefined
...
object ApplicationComponent {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicationComponent] (val x: Self) extends AnyVal {
