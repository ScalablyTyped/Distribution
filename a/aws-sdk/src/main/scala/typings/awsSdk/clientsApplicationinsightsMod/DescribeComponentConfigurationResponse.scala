...
trait DescribeComponentConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var Monitor: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.Monitor] = js.undefined
  
  /**
    * The tier of the application component. Supported tiers include DOT_NET_CORE, DOT_NET_WORKER, DOT_NET_WEB, SQL_SERVER, and DEFAULT 
    */
  var Tier: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.Tier] = js.undefined
}
object DescribeComponentConfigurationResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeComponentConfigurationResponse] (val x: Self) extends AnyVal {
