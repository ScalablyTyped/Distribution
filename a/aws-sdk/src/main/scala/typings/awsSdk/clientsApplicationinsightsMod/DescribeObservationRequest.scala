...
trait DescribeObservationRequest extends StObject {
  ...
  /**
    ...
    */
  var ObservationId: typings.awsSdk.clientsApplicationinsightsMod.ObservationId
}
object DescribeObservationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeObservationRequest] (val x: Self) extends AnyVal {
