...
trait ListProblemsResponse extends StObject {
  ...
  /**
    ...
    */
  var ProblemList: js.UndefOr[typings.awsSdk.clientsApplicationinsightsMod.ProblemList] = js.undefined
...
object ListProblemsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProblemsResponse] (val x: Self) extends AnyVal {
