...
object ListEventTypesRequest {
  ...
  implicit class ListEventTypesRequestOps[Self <: ListEventTypesRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFiltersVarargs(value: ListEventTypesFilter*): Self = this.set("Filters", js.Array(value :_*))
    
    @scala.inline
    def setFilters(value: ListEventTypesFilters): Self = this.set("Filters", value.asInstanceOf[js.Any])
