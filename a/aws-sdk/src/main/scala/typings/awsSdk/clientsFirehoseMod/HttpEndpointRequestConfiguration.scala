...
trait HttpEndpointRequestConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ContentEncoding: js.UndefOr[typings.awsSdk.clientsFirehoseMod.ContentEncoding] = js.undefined
}
object HttpEndpointRequestConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HttpEndpointRequestConfiguration] (val x: Self) extends AnyVal {
