...
trait BufferingHints extends StObject {
  ...
  /**
    ...
    */
  var IntervalInSeconds: js.UndefOr[typings.awsSdk.clientsFirehoseMod.IntervalInSeconds] = js.undefined
  ...
  /**
    ...
    */
  var SizeInMBs: js.UndefOr[typings.awsSdk.clientsFirehoseMod.SizeInMBs] = js.undefined
}
object BufferingHints {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BufferingHints] (val x: Self) extends AnyVal {
