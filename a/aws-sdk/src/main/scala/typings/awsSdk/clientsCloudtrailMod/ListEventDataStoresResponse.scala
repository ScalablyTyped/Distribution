...
trait ListEventDataStoresResponse extends StObject {
  ...
  /**
    ...
    */
  var EventDataStores: js.UndefOr[typings.awsSdk.clientsCloudtrailMod.EventDataStores] = js.undefined
...
object ListEventDataStoresResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListEventDataStoresResponse] (val x: Self) extends AnyVal {
