...
trait ListPublicKeysResponse extends StObject {
  ...
  /**
    ...
    */
  var PublicKeyList: js.UndefOr[typings.awsSdk.clientsCloudtrailMod.PublicKeyList] = js.undefined
}
object ListPublicKeysResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPublicKeysResponse] (val x: Self) extends AnyVal {
