...
trait ListTrailsResponse extends StObject {
  ...
  /**
    ...
    */
  var Trails: js.UndefOr[typings.awsSdk.clientsCloudtrailMod.Trails] = js.undefined
}
object ListTrailsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTrailsResponse] (val x: Self) extends AnyVal {
