...
trait ListSopRecommendationsRequest extends StObject {
...
object ListSopRecommendationsRequest {
  ...
  inline def apply(assessmentArn: Arn): ListSopRecommendationsRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSopRecommendationsRequest] (val x: Self) extends AnyVal {
