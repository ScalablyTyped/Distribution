...
trait CreateAppVersionResourceResponse extends StObject {
...
object CreateAppVersionResourceResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): CreateAppVersionResourceResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[CreateAppVersionResourceResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAppVersionResourceResponse] (val x: Self) extends AnyVal {
