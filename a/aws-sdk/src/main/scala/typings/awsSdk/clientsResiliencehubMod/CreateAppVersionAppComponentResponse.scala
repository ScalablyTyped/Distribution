...
trait CreateAppVersionAppComponentResponse extends StObject {
...
object CreateAppVersionAppComponentResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): CreateAppVersionAppComponentResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[CreateAppVersionAppComponentResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAppVersionAppComponentResponse] (val x: Self) extends AnyVal {
