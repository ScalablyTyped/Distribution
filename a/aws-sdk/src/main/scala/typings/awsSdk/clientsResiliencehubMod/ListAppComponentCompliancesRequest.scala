...
trait ListAppComponentCompliancesRequest extends StObject {
...
object ListAppComponentCompliancesRequest {
  ...
  inline def apply(assessmentArn: Arn): ListAppComponentCompliancesRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAppComponentCompliancesRequest] (val x: Self) extends AnyVal {
