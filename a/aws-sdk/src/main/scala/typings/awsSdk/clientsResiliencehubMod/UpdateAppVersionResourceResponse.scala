...
trait UpdateAppVersionResourceResponse extends StObject {
...
object UpdateAppVersionResourceResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): UpdateAppVersionResourceResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpdateAppVersionResourceResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateAppVersionResourceResponse] (val x: Self) extends AnyVal {
