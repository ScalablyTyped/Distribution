...
trait DescribeAppVersionAppComponentResponse extends StObject {
...
object DescribeAppVersionAppComponentResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): DescribeAppVersionAppComponentResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescribeAppVersionAppComponentResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAppVersionAppComponentResponse] (val x: Self) extends AnyVal {
