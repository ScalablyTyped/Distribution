...
trait DescribeAppVersionResourceResponse extends StObject {
...
object DescribeAppVersionResourceResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): DescribeAppVersionResourceResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescribeAppVersionResourceResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAppVersionResourceResponse] (val x: Self) extends AnyVal {
