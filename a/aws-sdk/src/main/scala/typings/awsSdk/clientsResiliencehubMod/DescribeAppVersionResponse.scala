...
trait DescribeAppVersionResponse extends StObject {
...
object DescribeAppVersionResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): DescribeAppVersionResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[DescribeAppVersionResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAppVersionResponse] (val x: Self) extends AnyVal {
