...
trait DeleteAppVersionAppComponentResponse extends StObject {
...
object DeleteAppVersionAppComponentResponse {
  
  inline def apply(appArn: Arn, appVersion: EntityVersion): DeleteAppVersionAppComponentResponse = {
    val __obj = js.Dynamic.literal(appArn = appArn.asInstanceOf[js.Any], appVersion = appVersion.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteAppVersionAppComponentResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteAppVersionAppComponentResponse] (val x: Self) extends AnyVal {
