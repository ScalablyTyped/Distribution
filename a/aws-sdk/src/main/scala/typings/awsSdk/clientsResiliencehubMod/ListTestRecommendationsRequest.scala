...
trait ListTestRecommendationsRequest extends StObject {
...
object ListTestRecommendationsRequest {
  ...
  inline def apply(assessmentArn: Arn): ListTestRecommendationsRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTestRecommendationsRequest] (val x: Self) extends AnyVal {
