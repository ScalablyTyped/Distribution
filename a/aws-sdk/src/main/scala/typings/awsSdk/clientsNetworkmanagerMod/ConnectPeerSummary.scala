...
trait ConnectPeerSummary extends StObject {
  ...
  /**
    ...
    */
  var ConnectPeerState: js.UndefOr[typings.awsSdk.clientsNetworkmanagerMod.ConnectPeerState] = js.undefined
...
object ConnectPeerSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ConnectPeerSummary] (val x: Self) extends AnyVal {
