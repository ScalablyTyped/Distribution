...
trait GlobalNetwork extends StObject {
  ...
  /**
    ...
    */
  var GlobalNetworkArn: js.UndefOr[typings.awsSdk.clientsNetworkmanagerMod.GlobalNetworkArn] = js.undefined
...
object GlobalNetwork {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GlobalNetwork] (val x: Self) extends AnyVal {
