...
trait CreateMeetingRequest extends StObject {
  ...
  /**
    ...
    */
  var MediaRegion: typings.awsSdk.clientsChimesdkmeetingsMod.MediaRegion
  ...
  /**
    ...
    */
  var NotificationsConfiguration: js.UndefOr[typings.awsSdk.clientsChimesdkmeetingsMod.NotificationsConfiguration] = js.undefined
...
object CreateMeetingRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateMeetingRequest] (val x: Self) extends AnyVal {
