...
trait ListFirewallsResponse extends StObject {
  ...
  /**
    ...
    */
  var Firewalls: js.UndefOr[typings.awsSdk.clientsNetworkfirewallMod.Firewalls] = js.undefined
...
object ListFirewallsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListFirewallsResponse] (val x: Self) extends AnyVal {
