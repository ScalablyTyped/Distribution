...
trait DescribeTLSInspectionConfigurationRequest extends StObject {
...
object DescribeTLSInspectionConfigurationRequest {
  ...
  inline def apply(): DescribeTLSInspectionConfigurationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeTLSInspectionConfigurationRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeTLSInspectionConfigurationRequest] (val x: Self) extends AnyVal {
