...
trait DescribeFirewallPolicyResponse extends StObject {
  ...
  /**
    ...
    */
  var FirewallPolicy: js.UndefOr[typings.awsSdk.clientsNetworkfirewallMod.FirewallPolicy] = js.undefined
...
object DescribeFirewallPolicyResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeFirewallPolicyResponse] (val x: Self) extends AnyVal {
