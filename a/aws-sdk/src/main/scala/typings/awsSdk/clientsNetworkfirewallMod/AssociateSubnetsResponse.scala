...
trait AssociateSubnetsResponse extends StObject {
  ...
  /**
    ...
    */
  var SubnetMappings: js.UndefOr[typings.awsSdk.clientsNetworkfirewallMod.SubnetMappings] = js.undefined
...
object AssociateSubnetsResponse {
  ...
  inline def apply(): AssociateSubnetsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AssociateSubnetsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AssociateSubnetsResponse] (val x: Self) extends AnyVal {
