...
trait ListFirewallsRequest extends StObject {
  ...
  /**
    ...
    */
  var VpcIds: js.UndefOr[typings.awsSdk.clientsNetworkfirewallMod.VpcIds] = js.undefined
}
object ListFirewallsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListFirewallsRequest] (val x: Self) extends AnyVal {
