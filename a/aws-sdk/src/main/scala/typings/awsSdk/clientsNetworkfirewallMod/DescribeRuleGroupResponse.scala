...
trait DescribeRuleGroupResponse extends StObject {
  ...
  /**
    ...
    */
  var RuleGroup: js.UndefOr[typings.awsSdk.clientsNetworkfirewallMod.RuleGroup] = js.undefined
...
object DescribeRuleGroupResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeRuleGroupResponse] (val x: Self) extends AnyVal {
