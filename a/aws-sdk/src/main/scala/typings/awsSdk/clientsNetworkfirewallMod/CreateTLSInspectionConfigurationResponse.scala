...
trait CreateTLSInspectionConfigurationResponse extends StObject {
...
object CreateTLSInspectionConfigurationResponse {
  
  inline def apply(TLSInspectionConfigurationResponse: TLSInspectionConfigurationResponse, UpdateToken: UpdateToken): CreateTLSInspectionConfigurationResponse = {
    ...
    __obj.asInstanceOf[CreateTLSInspectionConfigurationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateTLSInspectionConfigurationResponse] (val x: Self) extends AnyVal {
