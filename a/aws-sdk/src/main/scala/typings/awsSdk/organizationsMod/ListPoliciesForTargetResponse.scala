...
trait ListPoliciesForTargetResponse extends StObject {
  ...
  /**
    ...
    */
  var Policies: js.UndefOr[typings.awsSdk.organizationsMod.Policies] = js.undefined
}
object ListPoliciesForTargetResponse {
  ...
  extension [Self <: ListPoliciesForTargetResponse](x: Self) {
    ...
    inline def setPoliciesVarargs(value: PolicySummary*): Self = StObject.set(x, "Policies", js.Array(value :_*))
  }
}
