...
trait ListOrganizationalUnitsForParentResponse extends StObject {
  ...
  /**
    ...
    */
  var OrganizationalUnits: js.UndefOr[typings.awsSdk.organizationsMod.OrganizationalUnits] = js.undefined
}
object ListOrganizationalUnitsForParentResponse {
  ...
  extension [Self <: ListOrganizationalUnitsForParentResponse](x: Self) {
