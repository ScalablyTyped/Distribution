...
trait ListFirewallRuleGroupAssociationsResponse extends StObject {
  ...
  /**
    ...
    */
  var FirewallRuleGroupAssociations: js.UndefOr[typings.awsSdk.clientsRoute53resolverMod.FirewallRuleGroupAssociations] = js.undefined
...
object ListFirewallRuleGroupAssociationsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListFirewallRuleGroupAssociationsResponse] (val x: Self) extends AnyVal {
