...
trait ResolverRule extends StObject {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typings.awsSdk.clientsRoute53resolverMod.DomainName] = js.undefined
...
object ResolverRule {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResolverRule] (val x: Self) extends AnyVal {
