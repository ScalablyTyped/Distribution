...
trait GetFirewallRuleGroupPolicyResponse extends StObject {
  ...
  /**
    ...
    */
  var FirewallRuleGroupPolicy: js.UndefOr[typings.awsSdk.clientsRoute53resolverMod.FirewallRuleGroupPolicy] = js.undefined
}
object GetFirewallRuleGroupPolicyResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetFirewallRuleGroupPolicyResponse] (val x: Self) extends AnyVal {
