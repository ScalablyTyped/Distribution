...
trait CreateResolverRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var DomainName: typings.awsSdk.clientsRoute53resolverMod.DomainName
...
object CreateResolverRuleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateResolverRuleRequest] (val x: Self) extends AnyVal {
