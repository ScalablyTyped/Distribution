...
trait CreateResolverQueryLogConfigRequest extends StObject {
  ...
  /**
    ...
    */
  var DestinationArn: typings.awsSdk.clientsRoute53resolverMod.DestinationArn
...
object CreateResolverQueryLogConfigRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateResolverQueryLogConfigRequest] (val x: Self) extends AnyVal {
