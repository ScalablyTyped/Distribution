...
trait GetQueryStatisticsResponse extends StObject {
  ...
  /**
    ...
    */
  var ExecutionStatistics: js.UndefOr[typings.awsSdk.lakeformationMod.ExecutionStatistics] = js.undefined
  
  /**
    * A PlanningStatistics structure containing query planning statistics.
    */
  var PlanningStatistics: js.UndefOr[typings.awsSdk.lakeformationMod.PlanningStatistics] = js.undefined
