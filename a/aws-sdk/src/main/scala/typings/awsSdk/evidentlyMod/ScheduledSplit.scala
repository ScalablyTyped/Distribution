...
trait ScheduledSplit extends StObject {
  ...
  /**
    ...
    */
  var groupWeights: js.UndefOr[GroupToWeightMap] = js.undefined
...
object ScheduledSplit {
  ...
  inline def apply(startTime: js.Date): ScheduledSplit = {
  ...
  extension [Self <: ScheduledSplit](x: Self) {
    ...
    inline def setGroupWeightsUndefined: Self = StObject.set(x, "groupWeights", js.undefined)
