...
trait RuleMetadata extends StObject {
  ...
  /**
    ...
    */
  var LongDescription: js.UndefOr[typings.awsSdk.codegurureviewerMod.LongDescription] = js.undefined
  
  /**
    * The ID of the rule.
    */
  var RuleId: js.UndefOr[typings.awsSdk.codegurureviewerMod.RuleId] = js.undefined
  
  /**
    * The name of the rule.
    */
  var RuleName: js.UndefOr[typings.awsSdk.codegurureviewerMod.RuleName] = js.undefined
  
  /**
    * Tags that are associated with the rule.
    */
  var RuleTags: js.UndefOr[typings.awsSdk.codegurureviewerMod.RuleTags] = js.undefined
  
  /**
    * A short description of the rule.
    */
  var ShortDescription: js.UndefOr[typings.awsSdk.codegurureviewerMod.ShortDescription] = js.undefined
}
object RuleMetadata {
