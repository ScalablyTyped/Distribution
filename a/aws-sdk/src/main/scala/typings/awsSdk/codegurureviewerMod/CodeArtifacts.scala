...
trait CodeArtifacts extends StObject {
  ...
  /**
    ...
    */
  var BuildArtifactsObjectKey: js.UndefOr[typings.awsSdk.codegurureviewerMod.BuildArtifactsObjectKey] = js.undefined
  
  /**
    * The S3 object key for a source code .zip file. This is required for all code reviews.
    */
  var SourceCodeArtifactsObjectKey: typings.awsSdk.codegurureviewerMod.SourceCodeArtifactsObjectKey
}
