...
trait SourceCodeType extends StObject {
  ...
  /**
    ...
    */
  var RequestMetadata: js.UndefOr[typings.awsSdk.codegurureviewerMod.RequestMetadata] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketRepository: js.UndefOr[typings.awsSdk.codegurureviewerMod.S3BucketRepository] = js.undefined
}
