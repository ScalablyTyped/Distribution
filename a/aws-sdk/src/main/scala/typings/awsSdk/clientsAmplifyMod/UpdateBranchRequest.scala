...
object UpdateBranchRequest {
  ...
  inline def apply(appId: AppId, branchName: BranchName): UpdateBranchRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateBranchRequest] (val x: Self) extends AnyVal {
