...
trait CreateObservabilityConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var ObservabilityConfigurationName: typings.awsSdk.clientsApprunnerMod.ObservabilityConfigurationName
...
object CreateObservabilityConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateObservabilityConfigurationRequest] (val x: Self) extends AnyVal {
