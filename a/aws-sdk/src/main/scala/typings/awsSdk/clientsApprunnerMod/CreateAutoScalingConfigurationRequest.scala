...
trait CreateAutoScalingConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingConfigurationName: typings.awsSdk.clientsApprunnerMod.AutoScalingConfigurationName
...
object CreateAutoScalingConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAutoScalingConfigurationRequest] (val x: Self) extends AnyVal {
