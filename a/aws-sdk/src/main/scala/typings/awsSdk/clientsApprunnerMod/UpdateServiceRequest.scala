...
trait UpdateServiceRequest extends StObject {
  ...
  /**
    ...
    */
  var InstanceConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.InstanceConfiguration] = js.undefined
  
  /**
    * Configuration settings related to network traffic of the web application that the App Runner service runs.
    */
  var NetworkConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.NetworkConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SourceConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.SourceConfiguration] = js.undefined
}
