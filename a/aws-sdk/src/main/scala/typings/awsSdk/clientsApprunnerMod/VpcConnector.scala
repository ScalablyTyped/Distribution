...
trait VpcConnector extends StObject {
  ...
  /**
    ...
    */
  var VpcConnectorName: js.UndefOr[typings.awsSdk.clientsApprunnerMod.VpcConnectorName] = js.undefined
...
object VpcConnector {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: VpcConnector] (val x: Self) extends AnyVal {
