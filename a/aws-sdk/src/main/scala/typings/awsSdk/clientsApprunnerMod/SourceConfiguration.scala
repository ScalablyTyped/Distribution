...
trait SourceConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AuthenticationConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.AuthenticationConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var CodeRepository: js.UndefOr[typings.awsSdk.clientsApprunnerMod.CodeRepository] = js.undefined
  
  /**
    * The description of a source image repository. You must provide either this member or CodeRepository (but not both).
    */
  var ImageRepository: js.UndefOr[typings.awsSdk.clientsApprunnerMod.ImageRepository] = js.undefined
}
