...
trait Service extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingConfigurationSummary: typings.awsSdk.clientsApprunnerMod.AutoScalingConfigurationSummary
  ...
  /**
    ...
    */
  var EncryptionConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.EncryptionConfiguration] = js.undefined
  
  /**
    * The settings for the health check that App Runner performs to monitor the health of this service.
    */
  var HealthCheckConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.HealthCheckConfiguration] = js.undefined
  
  /**
    * The runtime configuration of instances (scaling units) of this service.
    */
  var InstanceConfiguration: typings.awsSdk.clientsApprunnerMod.InstanceConfiguration
  
  /**
    * Configuration settings related to network traffic of the web application that this service runs.
    */
  var NetworkConfiguration: typings.awsSdk.clientsApprunnerMod.NetworkConfiguration
  ...
  /**
    ...
    */
  var ServiceId: typings.awsSdk.clientsApprunnerMod.ServiceId
  
  /**
    * The customer-provided service name.
    */
  var ServiceName: typings.awsSdk.clientsApprunnerMod.ServiceName
  ...
  /**
    ...
    */
  var SourceConfiguration: typings.awsSdk.clientsApprunnerMod.SourceConfiguration
