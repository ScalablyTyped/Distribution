...
trait CodeRepository extends StObject {
  ...
  /**
    ...
    */
  var CodeConfiguration: js.UndefOr[typings.awsSdk.clientsApprunnerMod.CodeConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SourceCodeVersion: typings.awsSdk.clientsApprunnerMod.SourceCodeVersion
}
