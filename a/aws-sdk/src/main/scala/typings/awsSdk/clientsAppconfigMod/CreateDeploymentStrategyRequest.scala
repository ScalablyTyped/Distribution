...
trait CreateDeploymentStrategyRequest extends StObject {
  ...
  /**
    ...
    */
  var GrowthFactor: typings.awsSdk.clientsAppconfigMod.GrowthFactor
  ...
  /**
    ...
    */
  var ReplicateTo: js.UndefOr[typings.awsSdk.clientsAppconfigMod.ReplicateTo] = js.undefined
