...
trait UpdateDeploymentStrategyRequest extends StObject {
  ...
  /**
    ...
    */
  var GrowthFactor: js.UndefOr[typings.awsSdk.clientsAppconfigMod.GrowthFactor] = js.undefined
...
object UpdateDeploymentStrategyRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateDeploymentStrategyRequest] (val x: Self) extends AnyVal {
