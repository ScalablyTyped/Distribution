...
trait UpdateSimulationApplicationResponse extends StObject {
...
object UpdateSimulationApplicationResponse {
  ...
  inline def apply(): UpdateSimulationApplicationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateSimulationApplicationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateSimulationApplicationResponse] (val x: Self) extends AnyVal {
