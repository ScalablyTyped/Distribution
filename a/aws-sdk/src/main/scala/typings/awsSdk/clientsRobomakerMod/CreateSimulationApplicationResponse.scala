...
object CreateSimulationApplicationResponse {
  ...
  inline def apply(): CreateSimulationApplicationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateSimulationApplicationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateSimulationApplicationResponse] (val x: Self) extends AnyVal {
