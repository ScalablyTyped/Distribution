...
trait DescribeSimulationApplicationResponse extends StObject {
...
object DescribeSimulationApplicationResponse {
  ...
  inline def apply(): DescribeSimulationApplicationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeSimulationApplicationResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeSimulationApplicationResponse] (val x: Self) extends AnyVal {
