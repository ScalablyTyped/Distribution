...
trait ListDeploymentJobsRequest extends StObject {
...
object ListDeploymentJobsRequest {
  ...
  inline def apply(): ListDeploymentJobsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListDeploymentJobsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListDeploymentJobsRequest] (val x: Self) extends AnyVal {
