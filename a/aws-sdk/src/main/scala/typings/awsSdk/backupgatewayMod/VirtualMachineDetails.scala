...
trait VirtualMachineDetails extends StObject {
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typings.awsSdk.backupgatewayMod.Name] = js.undefined
  
  /**
    * The path of the virtual machine.
    */
  var Path: js.UndefOr[typings.awsSdk.backupgatewayMod.Path] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the virtual machine. For example, arn:aws:backup-gateway:us-west-1:0000000000000:vm/vm-0000ABCDEFGIJKL.
    */
  var ResourceArn: js.UndefOr[typings.awsSdk.backupgatewayMod.ResourceArn] = js.undefined
}
