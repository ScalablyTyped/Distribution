...
trait AnnotationStoreItem extends StObject {
...
object AnnotationStoreItem {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(creationTime = creationTime.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], reference = reference.asInstanceOf[js.Any], sseConfig = sseConfig.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], statusMessage = statusMessage.asInstanceOf[js.Any], storeArn = storeArn.asInstanceOf[js.Any], storeFormat = storeFormat.asInstanceOf[js.Any], storeSizeBytes = storeSizeBytes.asInstanceOf[js.Any], updateTime = updateTime.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnnotationStoreItem]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AnnotationStoreItem] (val x: Self) extends AnyVal {
