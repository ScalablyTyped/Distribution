...
trait ImportReadSetFilter extends StObject {
  ...
  /**
    ...
    */
  var status: js.UndefOr[ReadSetImportJobStatus] = js.undefined
}
object ImportReadSetFilter {
  
  inline def apply(): ImportReadSetFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ImportReadSetFilter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ImportReadSetFilter] (val x: Self) extends AnyVal {
