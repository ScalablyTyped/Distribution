...
trait ReferenceStoreFilter extends StObject {
...
object ReferenceStoreFilter {
  ...
  inline def apply(): ReferenceStoreFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ReferenceStoreFilter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReferenceStoreFilter] (val x: Self) extends AnyVal {
