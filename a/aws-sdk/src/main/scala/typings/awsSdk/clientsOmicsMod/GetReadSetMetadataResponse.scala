...
trait GetReadSetMetadataResponse extends StObject {
  ...
  /**
    ...
    */
  var files: js.UndefOr[ReadSetFiles] = js.undefined
...
object GetReadSetMetadataResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetReadSetMetadataResponse] (val x: Self) extends AnyVal {
    ...
    inline def setFiles(value: ReadSetFiles): Self = StObject.set(x, "files", value.asInstanceOf[js.Any])
