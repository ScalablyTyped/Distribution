...
trait SequenceStoreDetail extends StObject {
...
object SequenceStoreDetail {
  ...
  inline def apply(arn: SequenceStoreArn, creationTime: js.Date, id: SequenceStoreId): SequenceStoreDetail = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SequenceStoreDetail] (val x: Self) extends AnyVal {
