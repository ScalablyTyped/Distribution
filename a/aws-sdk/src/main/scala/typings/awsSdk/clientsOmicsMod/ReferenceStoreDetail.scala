...
trait ReferenceStoreDetail extends StObject {
...
object ReferenceStoreDetail {
  ...
  inline def apply(arn: ReferenceStoreArn, creationTime: js.Date, id: ReferenceStoreId): ReferenceStoreDetail = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ReferenceStoreDetail] (val x: Self) extends AnyVal {
