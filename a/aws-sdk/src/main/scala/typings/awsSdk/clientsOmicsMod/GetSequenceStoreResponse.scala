...
trait GetSequenceStoreResponse extends StObject {
...
object GetSequenceStoreResponse {
  ...
  inline def apply(arn: SequenceStoreArn, creationTime: js.Date, id: SequenceStoreId): GetSequenceStoreResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSequenceStoreResponse] (val x: Self) extends AnyVal {
