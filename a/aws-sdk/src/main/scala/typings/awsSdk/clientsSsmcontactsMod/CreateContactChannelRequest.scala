...
trait CreateContactChannelRequest extends StObject {
  ...
  /**
    ...
    */
  var DeferActivation: js.UndefOr[typings.awsSdk.clientsSsmcontactsMod.DeferActivation] = js.undefined
...
object CreateContactChannelRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateContactChannelRequest] (val x: Self) extends AnyVal {
