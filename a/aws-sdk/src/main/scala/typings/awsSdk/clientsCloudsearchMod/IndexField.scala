...
trait IndexField extends StObject {
  ...
  var DateArrayOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.DateArrayOptions] = js.undefined
  
  var DateOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.DateOptions] = js.undefined
  
  var DoubleArrayOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.DoubleArrayOptions] = js.undefined
  
  var DoubleOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.DoubleOptions] = js.undefined
  ...
  var IndexFieldType: typings.awsSdk.clientsCloudsearchMod.IndexFieldType
  
  var IntArrayOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.IntArrayOptions] = js.undefined
  
  var IntOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.IntOptions] = js.undefined
  
  var LatLonOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.LatLonOptions] = js.undefined
  
  var LiteralArrayOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.LiteralArrayOptions] = js.undefined
  
  var LiteralOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.LiteralOptions] = js.undefined
  
  var TextArrayOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.TextArrayOptions] = js.undefined
  
  var TextOptions: js.UndefOr[typings.awsSdk.clientsCloudsearchMod.TextOptions] = js.undefined
}
object IndexField {
