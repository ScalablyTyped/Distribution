...
trait Connection extends StObject {
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typings.awsSdk.clientsCodestarconnectionsMod.ConnectionArn] = js.undefined
  
  /**
    * The name of the connection. Connection names must be unique in an AWS user account.
    */
  var ConnectionName: js.UndefOr[typings.awsSdk.clientsCodestarconnectionsMod.ConnectionName] = js.undefined
  
  /**
    * The current status of the connection. 
    */
  var ConnectionStatus: js.UndefOr[typings.awsSdk.clientsCodestarconnectionsMod.ConnectionStatus] = js.undefined
