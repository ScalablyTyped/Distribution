...
trait CreateConnectionInput extends StObject {
  ...
  /**
    ...
    */
  var ConnectionName: typings.awsSdk.clientsCodestarconnectionsMod.ConnectionName
...
object CreateConnectionInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateConnectionInput] (val x: Self) extends AnyVal {
