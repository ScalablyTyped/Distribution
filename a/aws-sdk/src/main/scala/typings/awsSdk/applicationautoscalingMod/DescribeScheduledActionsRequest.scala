...
trait DescribeScheduledActionsRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.applicationautoscalingMod.MaxResults] = js.undefined
  ...
  /**
    ...
    */
  var ScalableDimension: js.UndefOr[typings.awsSdk.applicationautoscalingMod.ScalableDimension] = js.undefined
...
object DescribeScheduledActionsRequest {
  ...
  extension [Self <: DescribeScheduledActionsRequest](x: Self) {
    ...
    inline def setScheduledActionNamesVarargs(value: ResourceIdMaxLen1600*): Self = StObject.set(x, "ScheduledActionNames", js.Array(value :_*))
