...
trait PutScheduledActionRequest extends StObject {
  ...
  /**
    ...
    */
  var ScalableTargetAction: js.UndefOr[typings.awsSdk.applicationautoscalingMod.ScalableTargetAction] = js.undefined
  ...
  /**
    ...
    */
  var ScheduledActionName: typings.awsSdk.applicationautoscalingMod.ScheduledActionName
  ...
  /**
    ...
    */
  var Timezone: js.UndefOr[ResourceIdMaxLen1600] = js.undefined
}
object PutScheduledActionRequest {
  ...
  extension [Self <: PutScheduledActionRequest](x: Self) {
    ...
    inline def setTimezone(value: ResourceIdMaxLen1600): Self = StObject.set(x, "Timezone", value.asInstanceOf[js.Any])
