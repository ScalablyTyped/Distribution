...
trait PutScheduledActionRequest extends js.Object {
  ...
  /**
    ...
    */
  var ScalableTargetAction: js.UndefOr[typings.awsSdk.applicationautoscalingMod.ScalableTargetAction] = js.native
  /**
    ...
    */
  var Schedule: js.UndefOr[ResourceIdMaxLen1600] = js.native
  /**
    * The name of the scheduled action. This name must be unique among all other scheduled actions on the specified scalable target. 
    */
  var ScheduledActionName: typings.awsSdk.applicationautoscalingMod.ScheduledActionName = js.native
  /**
...
object PutScheduledActionRequest {
  ...
  @scala.inline
  implicit class PutScheduledActionRequestOps[Self <: PutScheduledActionRequest] (val x: Self) extends AnyVal {
    @scala.inline
