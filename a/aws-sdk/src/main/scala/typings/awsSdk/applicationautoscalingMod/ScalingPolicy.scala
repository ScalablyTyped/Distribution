...
trait ScalingPolicy extends StObject {
  ...
  /**
    ...
    */
  var PolicyName: typings.awsSdk.applicationautoscalingMod.PolicyName
  
  /**
    * The scaling policy type.
    */
  var PolicyType: typings.awsSdk.applicationautoscalingMod.PolicyType
  ...
  /**
    ...
    */
  var StepScalingPolicyConfiguration: js.UndefOr[typings.awsSdk.applicationautoscalingMod.StepScalingPolicyConfiguration] = js.undefined
