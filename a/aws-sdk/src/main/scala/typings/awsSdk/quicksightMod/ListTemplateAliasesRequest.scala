...
object ListTemplateAliasesRequest {
  ...
  inline def apply(AwsAccountId: AwsAccountId, TemplateId: RestrictiveResourceId): ListTemplateAliasesRequest = {
  ...
  extension [Self <: ListTemplateAliasesRequest](x: Self) {
