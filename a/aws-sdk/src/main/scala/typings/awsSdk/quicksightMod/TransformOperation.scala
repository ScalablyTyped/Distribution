...
trait TransformOperation extends StObject {
  ...
  /**
    ...
    */
  var CastColumnTypeOperation: js.UndefOr[typings.awsSdk.quicksightMod.CastColumnTypeOperation] = js.undefined
  
  /**
    * An operation that creates calculated columns. Columns created in one such operation form a lexical closure.
    */
  var CreateColumnsOperation: js.UndefOr[typings.awsSdk.quicksightMod.CreateColumnsOperation] = js.undefined
  
  /**
    * An operation that filters rows based on some condition.
    */
  var FilterOperation: js.UndefOr[typings.awsSdk.quicksightMod.FilterOperation] = js.undefined
  
  /**
    * An operation that projects columns. Operations that come after a projection can only refer to projected columns.
    */
  var ProjectOperation: js.UndefOr[typings.awsSdk.quicksightMod.ProjectOperation] = js.undefined
  
  /**
    * An operation that renames a column.
    */
  var RenameColumnOperation: js.UndefOr[typings.awsSdk.quicksightMod.RenameColumnOperation] = js.undefined
