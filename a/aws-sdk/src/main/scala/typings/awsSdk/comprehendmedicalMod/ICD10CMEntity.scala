...
object ICD10CMEntity {
  ...
  inline def apply(): ICD10CMEntity = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ICD10CMEntity]
  }
  
  extension [Self <: ICD10CMEntity](x: Self) {
    
    inline def setAttributes(value: ICD10CMAttributeList): Self = StObject.set(x, "Attributes", value.asInstanceOf[js.Any])
    ...
    inline def setCategory(value: ICD10CMEntityCategory): Self = StObject.set(x, "Category", value.asInstanceOf[js.Any])
    ...
    inline def setICD10CMConcepts(value: ICD10CMConceptList): Self = StObject.set(x, "ICD10CMConcepts", value.asInstanceOf[js.Any])
