...
object ICD10CMTrait {
  ...
  @scala.inline
  implicit class ICD10CMTraitOps[Self <: ICD10CMTrait] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setName(value: ICD10CMTraitName): Self = this.set("Name", value.asInstanceOf[js.Any])
    @scala.inline
