...
trait RedshiftDataParameters extends StObject {
  ...
  /**
    ...
    */
  var Database: typings.awsSdk.clientsCloudwatcheventsMod.Database
  
  /**
    * The database user name. Required when authenticating using temporary credentials.
    */
  var DbUser: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.DbUser] = js.undefined
  ...
  /**
    ...
    */
  var Sql: typings.awsSdk.clientsCloudwatcheventsMod.Sql
  
  /**
    * The name of the SQL statement. You can name the SQL statement when you create it to identify the query.
    */
  var StatementName: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.StatementName] = js.undefined
