...
trait PutPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.Action] = js.undefined
  ...
  /**
    ...
    */
  var Condition: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.Condition] = js.undefined
  ...
  /**
    ...
    */
  var Principal: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.Principal] = js.undefined
  
  /**
    * An identifier string for the external account that you are granting permissions to. If you later want to revoke the permission for this external account, specify this StatementId when you run RemovePermission.
    */
  var StatementId: js.UndefOr[typings.awsSdk.clientsCloudwatcheventsMod.StatementId] = js.undefined
}
