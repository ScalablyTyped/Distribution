...
trait GetUsageStatisticsResponse extends StObject {
  ...
  /**
    ...
    */
  var UsageStatistics: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.UsageStatistics] = js.undefined
}
object GetUsageStatisticsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetUsageStatisticsResponse] (val x: Self) extends AnyVal {
