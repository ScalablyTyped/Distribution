...
trait S3BucketDetail extends StObject {
  ...
  /**
    ...
    */
  var DefaultServerSideEncryption: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.DefaultServerSideEncryption] = js.undefined
  ...
  /**
    ...
    */
  var Owner: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.Owner] = js.undefined
  
  /**
    * Describes the public access policies that apply to the S3 bucket.
    */
  var PublicAccess: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.PublicAccess] = js.undefined
...
object S3BucketDetail {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: S3BucketDetail] (val x: Self) extends AnyVal {
