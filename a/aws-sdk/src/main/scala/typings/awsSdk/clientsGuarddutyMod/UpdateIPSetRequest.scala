...
trait UpdateIPSetRequest extends StObject {
  ...
  /**
    ...
    */
  var Location: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.Location] = js.undefined
  
  /**
    * The unique ID that specifies the IPSet that you want to update.
    */
  var Name: js.UndefOr[typings.awsSdk.clientsGuarddutyMod.Name] = js.undefined
}
object UpdateIPSetRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateIPSetRequest] (val x: Self) extends AnyVal {
