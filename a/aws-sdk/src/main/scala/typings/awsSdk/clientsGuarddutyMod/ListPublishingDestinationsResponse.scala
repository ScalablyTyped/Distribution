...
trait ListPublishingDestinationsResponse extends StObject {
  ...
  /**
    ...
    */
  var Destinations: typings.awsSdk.clientsGuarddutyMod.Destinations
...
object ListPublishingDestinationsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPublishingDestinationsResponse] (val x: Self) extends AnyVal {
