...
object ModifyDBClusterEndpointOutput {
  ...
  @scala.inline
  def apply(): ModifyDBClusterEndpointOutput = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ModifyDBClusterEndpointOutput]
  }
  
  @scala.inline
  implicit class ModifyDBClusterEndpointOutputMutableBuilder[Self <: ModifyDBClusterEndpointOutput] (val x: Self) extends AnyVal {
