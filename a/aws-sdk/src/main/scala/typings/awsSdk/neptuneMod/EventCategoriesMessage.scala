...
trait EventCategoriesMessage extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesMapList: js.UndefOr[typings.awsSdk.neptuneMod.EventCategoriesMapList] = js.undefined
}
object EventCategoriesMessage {
  ...
  extension [Self <: EventCategoriesMessage](x: Self) {
    ...
    inline def setEventCategoriesMapListVarargs(value: EventCategoriesMap*): Self = StObject.set(x, "EventCategoriesMapList", js.Array(value :_*))
  }
}
