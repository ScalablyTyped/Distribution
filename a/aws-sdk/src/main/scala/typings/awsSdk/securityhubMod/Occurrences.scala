...
trait Occurrences extends StObject {
  ...
  /**
    ...
    */
  var Cells: js.UndefOr[typings.awsSdk.securityhubMod.Cells] = js.undefined
  ...
  /**
    ...
    */
  var Pages: js.UndefOr[typings.awsSdk.securityhubMod.Pages] = js.undefined
  
  /**
    * Occurrences of sensitive data in an Apache Avro object container or an Apache Parquet file.
    */
  var Records: js.UndefOr[typings.awsSdk.securityhubMod.Records] = js.undefined
}
object Occurrences {
