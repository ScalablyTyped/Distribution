...
trait ActionRemoteIpDetails extends StObject {
  ...
  /**
    ...
    */
  var City: js.UndefOr[typings.awsSdk.securityhubMod.City] = js.undefined
  
  /**
    * The country where the remote IP address is located.
    */
  var Country: js.UndefOr[typings.awsSdk.securityhubMod.Country] = js.undefined
  
  /**
    * The coordinates of the location of the remote IP address.
    */
  var GeoLocation: js.UndefOr[typings.awsSdk.securityhubMod.GeoLocation] = js.undefined
