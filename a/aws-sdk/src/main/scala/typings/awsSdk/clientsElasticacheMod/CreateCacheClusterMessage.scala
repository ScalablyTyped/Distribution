...
trait CreateCacheClusterMessage extends StObject {
  ...
  /**
    ...
    */
  var OutpostMode: js.UndefOr[typings.awsSdk.clientsElasticacheMod.OutpostMode] = js.undefined
...
object CreateCacheClusterMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCacheClusterMessage] (val x: Self) extends AnyVal {
