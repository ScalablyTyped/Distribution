...
trait CacheNodeTypeSpecificParameter extends StObject {
  ...
  /**
    ...
    */
  var ChangeType: js.UndefOr[typings.awsSdk.clientsElasticacheMod.ChangeType] = js.undefined
...
object CacheNodeTypeSpecificParameter {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CacheNodeTypeSpecificParameter] (val x: Self) extends AnyVal {
