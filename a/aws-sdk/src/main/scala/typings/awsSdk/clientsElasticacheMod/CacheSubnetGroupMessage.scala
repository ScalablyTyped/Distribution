...
trait CacheSubnetGroupMessage extends StObject {
  ...
  /**
    ...
    */
  var CacheSubnetGroups: js.UndefOr[typings.awsSdk.clientsElasticacheMod.CacheSubnetGroups] = js.undefined
...
object CacheSubnetGroupMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CacheSubnetGroupMessage] (val x: Self) extends AnyVal {
