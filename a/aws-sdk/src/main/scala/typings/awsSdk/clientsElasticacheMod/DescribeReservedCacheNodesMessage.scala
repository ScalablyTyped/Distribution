...
trait DescribeReservedCacheNodesMessage extends StObject {
...
object DescribeReservedCacheNodesMessage {
  ...
  inline def apply(): DescribeReservedCacheNodesMessage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeReservedCacheNodesMessage]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeReservedCacheNodesMessage] (val x: Self) extends AnyVal {
