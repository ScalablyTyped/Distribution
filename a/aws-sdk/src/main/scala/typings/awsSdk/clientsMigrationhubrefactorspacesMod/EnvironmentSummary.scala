...
trait EnvironmentSummary extends StObject {
  ...
  /**
    ...
    */
  var NetworkFabricType: js.UndefOr[typings.awsSdk.clientsMigrationhubrefactorspacesMod.NetworkFabricType] = js.undefined
...
object EnvironmentSummary {
  ...
  inline def apply(): EnvironmentSummary = {
