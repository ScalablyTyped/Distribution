...
trait SecurityPolicyDetail extends StObject {
...
object SecurityPolicyDetail {
  ...
  inline def apply(): SecurityPolicyDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SecurityPolicyDetail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SecurityPolicyDetail] (val x: Self) extends AnyVal {
