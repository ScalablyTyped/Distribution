...
trait GetSecurityConfigResponse extends StObject {
...
object GetSecurityConfigResponse {
  ...
  inline def apply(): GetSecurityConfigResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetSecurityConfigResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSecurityConfigResponse] (val x: Self) extends AnyVal {
