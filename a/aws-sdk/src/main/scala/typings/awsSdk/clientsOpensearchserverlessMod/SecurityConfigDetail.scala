...
trait SecurityConfigDetail extends StObject {
...
object SecurityConfigDetail {
  ...
  inline def apply(): SecurityConfigDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SecurityConfigDetail]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SecurityConfigDetail] (val x: Self) extends AnyVal {
