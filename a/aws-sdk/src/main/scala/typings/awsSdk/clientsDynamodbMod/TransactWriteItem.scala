...
trait TransactWriteItem extends StObject {
  ...
  /**
    ...
    */
  var ConditionCheck: js.UndefOr[typings.awsSdk.clientsDynamodbMod.ConditionCheck] = js.undefined
  
  /**
    * A request to perform a DeleteItem operation.
    */
  var Delete: js.UndefOr[typings.awsSdk.clientsDynamodbMod.Delete] = js.undefined
  
  /**
    * A request to perform a PutItem operation.
    */
  var Put: js.UndefOr[typings.awsSdk.clientsDynamodbMod.Put] = js.undefined
  
  /**
    * A request to perform an UpdateItem operation.
    */
  var Update: js.UndefOr[typings.awsSdk.clientsDynamodbMod.Update] = js.undefined
}
