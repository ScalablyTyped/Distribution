...
trait ExpectedAttributeValue extends StObject {
  ...
  /**
    ...
    */
  var AttributeValueList: js.UndefOr[typings.awsSdk.clientsDynamodbMod.AttributeValueList] = js.undefined
  ...
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typings.awsSdk.clientsDynamodbMod.ComparisonOperator] = js.undefined
