...
trait DynamoDB extends DynamoDBCustomizations {
  ...
  @JSName("config")
  var config_DynamoDB: ConfigBase & ClientConfiguration = js.native
  ...
  /**
    ...
    */
  def describeImport(): Request[DescribeImportOutput, AWSError] = js.native
  def describeImport(callback: js.Function2[/* err */ AWSError, /* data */ DescribeImportOutput, Unit]): Request[DescribeImportOutput, AWSError] = js.native
  /**
    *  Represents the properties of the import. 
    */
  def describeImport(params: DescribeImportInput): Request[DescribeImportOutput, AWSError] = js.native
  def describeImport(
    params: DescribeImportInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeImportOutput, Unit]
  ): Request[DescribeImportOutput, AWSError] = js.native
  
  /**
    * Returns information about the status of Kinesis streaming.
    */
  def describeKinesisStreamingDestination(): Request[DescribeKinesisStreamingDestinationOutput, AWSError] = js.native
  def describeKinesisStreamingDestination(
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeKinesisStreamingDestinationOutput, Unit]
  ): Request[DescribeKinesisStreamingDestinationOutput, AWSError] = js.native
  /**
    * Returns information about the status of Kinesis streaming.
    */
  def describeKinesisStreamingDestination(params: DescribeKinesisStreamingDestinationInput): Request[DescribeKinesisStreamingDestinationOutput, AWSError] = js.native
  def describeKinesisStreamingDestination(
  ...
  /**
    ...
    */
  def disableKinesisStreamingDestination(): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  def disableKinesisStreamingDestination(callback: js.Function2[/* err */ AWSError, /* data */ KinesisStreamingDestinationOutput, Unit]): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  /**
    * Stops replication from the DynamoDB table to the Kinesis data stream. This is done without deleting either of the resources.
    */
  def disableKinesisStreamingDestination(params: KinesisStreamingDestinationInput): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  def disableKinesisStreamingDestination(
    params: KinesisStreamingDestinationInput,
    callback: js.Function2[/* err */ AWSError, /* data */ KinesisStreamingDestinationOutput, Unit]
  ): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  
  /**
    * Starts table data replication to the specified Kinesis data stream at a timestamp chosen during the enable workflow. If this operation doesn't return results immediately, use DescribeKinesisStreamingDestination to check if streaming to the Kinesis data stream is ACTIVE.
    */
  def enableKinesisStreamingDestination(): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  def enableKinesisStreamingDestination(callback: js.Function2[/* err */ AWSError, /* data */ KinesisStreamingDestinationOutput, Unit]): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  /**
    * Starts table data replication to the specified Kinesis data stream at a timestamp chosen during the enable workflow. If this operation doesn't return results immediately, use DescribeKinesisStreamingDestination to check if streaming to the Kinesis data stream is ACTIVE.
    */
  def enableKinesisStreamingDestination(params: KinesisStreamingDestinationInput): Request[KinesisStreamingDestinationOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def executeTransaction(): Request[ExecuteTransactionOutput, AWSError] = js.native
  def executeTransaction(callback: js.Function2[/* err */ AWSError, /* data */ ExecuteTransactionOutput, Unit]): Request[ExecuteTransactionOutput, AWSError] = js.native
  /**
    * This operation allows you to perform transactional reads or writes on data stored in DynamoDB, using PartiQL.  The entire transaction must consist of either read statements or write statements, you cannot mix both in one transaction. The EXISTS function is an exception and can be used to check the condition of specific attributes of the item in a similar manner to ConditionCheck in the TransactWriteItems API. 
    */
  def executeTransaction(params: ExecuteTransactionInput): Request[ExecuteTransactionOutput, AWSError] = js.native
  def executeTransaction(
    params: ExecuteTransactionInput,
    callback: js.Function2[/* err */ AWSError, /* data */ ExecuteTransactionOutput, Unit]
  ): Request[ExecuteTransactionOutput, AWSError] = js.native
  ...
  /**
    ...
    */
  def importTable(): Request[ImportTableOutput, AWSError] = js.native
  def importTable(callback: js.Function2[/* err */ AWSError, /* data */ ImportTableOutput, Unit]): Request[ImportTableOutput, AWSError] = js.native
  /**
    *  Imports table data from an S3 bucket. 
    */
  def importTable(params: ImportTableInput): Request[ImportTableOutput, AWSError] = js.native
  def importTable(
    params: ImportTableInput,
    callback: js.Function2[/* err */ AWSError, /* data */ ImportTableOutput, Unit]
  ): Request[ImportTableOutput, AWSError] = js.native
