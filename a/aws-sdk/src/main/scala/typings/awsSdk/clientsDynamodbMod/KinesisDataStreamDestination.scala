...
trait KinesisDataStreamDestination extends StObject {
  ...
  /**
    ...
    */
  var DestinationStatus: js.UndefOr[typings.awsSdk.clientsDynamodbMod.DestinationStatus] = js.undefined
  ...
  /**
    ...
    */
  var StreamArn: js.UndefOr[typings.awsSdk.clientsDynamodbMod.StreamArn] = js.undefined
}
