...
trait BackupDescription extends StObject {
  ...
  /**
    ...
    */
  var SourceTableDetails: js.UndefOr[typings.awsSdk.clientsDynamodbMod.SourceTableDetails] = js.undefined
  
  /**
    * Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.
    */
  var SourceTableFeatureDetails: js.UndefOr[typings.awsSdk.clientsDynamodbMod.SourceTableFeatureDetails] = js.undefined
}
