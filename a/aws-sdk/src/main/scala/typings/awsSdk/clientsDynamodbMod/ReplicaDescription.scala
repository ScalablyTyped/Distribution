...
trait ReplicaDescription extends StObject {
  ...
  /**
    ...
    */
  var ReplicaStatusDescription: js.UndefOr[typings.awsSdk.clientsDynamodbMod.ReplicaStatusDescription] = js.undefined
  
  /**
    * Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.
    */
  var ReplicaStatusPercentProgress: js.UndefOr[typings.awsSdk.clientsDynamodbMod.ReplicaStatusPercentProgress] = js.undefined
