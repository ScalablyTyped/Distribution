...
object ListTopicRuleDestinationsRequest {
  ...
  @scala.inline
  implicit class ListTopicRuleDestinationsRequestOps[Self <: ListTopicRuleDestinationsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setMaxResults(value: TopicRuleDestinationMaxResults): Self = this.set("maxResults", value.asInstanceOf[js.Any])
    @scala.inline
