...
trait CreateRecoveryGroupResponse extends StObject {
...
object CreateRecoveryGroupResponse {
  ...
  inline def apply(): CreateRecoveryGroupResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateRecoveryGroupResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateRecoveryGroupResponse] (val x: Self) extends AnyVal {
