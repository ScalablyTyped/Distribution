...
trait UpdateRecoveryGroupResponse extends StObject {
...
object UpdateRecoveryGroupResponse {
  ...
  inline def apply(): UpdateRecoveryGroupResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateRecoveryGroupResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateRecoveryGroupResponse] (val x: Self) extends AnyVal {
