...
trait Fmtp extends StObject {
  ...
  /**
    ...
    */
  var Colorimetry: js.UndefOr[typings.awsSdk.mediaconnectMod.Colorimetry] = js.undefined
  ...
  /**
    ...
    */
  var Range: js.UndefOr[typings.awsSdk.mediaconnectMod.Range] = js.undefined
  
  /**
    * The type of compression that was used to smooth the video’s appearance
    */
  var ScanMode: js.UndefOr[typings.awsSdk.mediaconnectMod.ScanMode] = js.undefined
  
  /**
    * The transfer characteristic system (TCS) that is used in the video.
    */
  var Tcs: js.UndefOr[typings.awsSdk.mediaconnectMod.Tcs] = js.undefined
}
object Fmtp {
