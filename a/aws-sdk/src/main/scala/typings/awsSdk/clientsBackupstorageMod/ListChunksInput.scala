...
trait ListChunksInput extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.clientsBackupstorageMod.MaxResults] = js.undefined
...
object ListChunksInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListChunksInput] (val x: Self) extends AnyVal {
