...
trait ListPricingPlansAssociatedWithPricingRuleOutput extends StObject {
  ...
  /**
    ...
    */
  var PricingRuleArn: js.UndefOr[typings.awsSdk.clientsBillingconductorMod.PricingRuleArn] = js.undefined
}
object ListPricingPlansAssociatedWithPricingRuleOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPricingPlansAssociatedWithPricingRuleOutput] (val x: Self) extends AnyVal {
