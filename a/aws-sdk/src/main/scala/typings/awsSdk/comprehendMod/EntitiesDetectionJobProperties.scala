...
trait EntitiesDetectionJobProperties extends StObject {
  ...
  /**
    ...
    */
  var EntityRecognizerArn: js.UndefOr[typings.awsSdk.comprehendMod.EntityRecognizerArn] = js.undefined
...
object EntitiesDetectionJobProperties {
  ...
  inline def apply(): EntitiesDetectionJobProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[EntitiesDetectionJobProperties]
  }
  
  extension [Self <: EntitiesDetectionJobProperties](x: Self) {
