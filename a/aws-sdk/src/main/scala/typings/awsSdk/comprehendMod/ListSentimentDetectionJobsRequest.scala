...
object ListSentimentDetectionJobsRequest {
  ...
  @scala.inline
  implicit class ListSentimentDetectionJobsRequestOps[Self <: ListSentimentDetectionJobsRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFilter(value: SentimentDetectionJobFilter): Self = this.set("Filter", value.asInstanceOf[js.Any])
