...
trait TargetedSentimentDetectionJobFilter extends StObject {
...
object TargetedSentimentDetectionJobFilter {
  
  inline def apply(): TargetedSentimentDetectionJobFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetedSentimentDetectionJobFilter]
  }
  
  extension [Self <: TargetedSentimentDetectionJobFilter](x: Self) {
