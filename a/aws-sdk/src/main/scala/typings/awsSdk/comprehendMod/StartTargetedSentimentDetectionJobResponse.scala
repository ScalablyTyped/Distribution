...
trait StartTargetedSentimentDetectionJobResponse extends StObject {
...
object StartTargetedSentimentDetectionJobResponse {
  
  inline def apply(): StartTargetedSentimentDetectionJobResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StartTargetedSentimentDetectionJobResponse]
  }
  
  extension [Self <: StartTargetedSentimentDetectionJobResponse](x: Self) {
