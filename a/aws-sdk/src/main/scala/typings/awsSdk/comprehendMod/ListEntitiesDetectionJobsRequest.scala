...
object ListEntitiesDetectionJobsRequest {
  ...
  @scala.inline
  implicit class ListEntitiesDetectionJobsRequestOps[Self <: ListEntitiesDetectionJobsRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setFilter(value: EntitiesDetectionJobFilter): Self = this.set("Filter", value.asInstanceOf[js.Any])
    @scala.inline
