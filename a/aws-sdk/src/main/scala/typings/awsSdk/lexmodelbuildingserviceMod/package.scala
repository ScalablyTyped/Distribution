...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.V1_BOT_NAME
  - typings.awsSdk.awsSdkStrings.MIGRATION_DATE_TIME
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.CREATE_NEW
  - typings.awsSdk.awsSdkStrings.UPDATE_EXISTING
  - java.lang.String
*/
