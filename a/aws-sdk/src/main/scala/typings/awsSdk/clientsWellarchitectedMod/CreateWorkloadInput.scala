...
trait CreateWorkloadInput extends StObject {
  ...
  var WorkloadName: typings.awsSdk.clientsWellarchitectedMod.WorkloadName
}
object CreateWorkloadInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateWorkloadInput] (val x: Self) extends AnyVal {
