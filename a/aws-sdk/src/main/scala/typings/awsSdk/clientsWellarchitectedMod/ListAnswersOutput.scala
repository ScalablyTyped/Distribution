...
trait ListAnswersOutput extends StObject {
  ...
  var AnswerSummaries: js.UndefOr[typings.awsSdk.clientsWellarchitectedMod.AnswerSummaries] = js.undefined
...
object ListAnswersOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAnswersOutput] (val x: Self) extends AnyVal {
