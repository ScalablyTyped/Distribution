...
trait GetMilestoneOutput extends StObject {
  ...
  var Milestone: js.UndefOr[typings.awsSdk.clientsWellarchitectedMod.Milestone] = js.undefined
...
object GetMilestoneOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMilestoneOutput] (val x: Self) extends AnyVal {
