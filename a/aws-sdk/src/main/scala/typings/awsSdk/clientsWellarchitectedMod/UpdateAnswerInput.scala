...
trait UpdateAnswerInput extends StObject {
  ...
  /**
    ...
    */
  var ChoiceUpdates: js.UndefOr[typings.awsSdk.clientsWellarchitectedMod.ChoiceUpdates] = js.undefined
...
object UpdateAnswerInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateAnswerInput] (val x: Self) extends AnyVal {
