...
trait ECS
  ...
  /**
    ...
    */
  def deleteTaskDefinitions(): Request[DeleteTaskDefinitionsResponse, AWSError] = js.native
  def deleteTaskDefinitions(callback: js.Function2[/* err */ AWSError, /* data */ DeleteTaskDefinitionsResponse, Unit]): Request[DeleteTaskDefinitionsResponse, AWSError] = js.native
  /**
    * Deletes one or more task definitions. You must deregister a task definition revision before you delete it. For more information, see DeregisterTaskDefinition. When you delete a task definition revision, it is immediately transitions from the INACTIVE to DELETE_IN_PROGRESS. Existing tasks and services that reference a DELETE_IN_PROGRESS task definition revision continue to run without disruption. Existing services that reference a DELETE_IN_PROGRESS task definition revision can still scale up or down by modifying the service's desired count. You can't use a DELETE_IN_PROGRESS task definition revision to run new tasks or create new services. You also can't update an existing service to reference a DELETE_IN_PROGRESS task definition revision.  A task definition revision will stay in DELETE_IN_PROGRESS status until all the associated tasks and services have been terminated.
    */
  def deleteTaskDefinitions(params: DeleteTaskDefinitionsRequest): Request[DeleteTaskDefinitionsResponse, AWSError] = js.native
  def deleteTaskDefinitions(
    params: DeleteTaskDefinitionsRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteTaskDefinitionsResponse, Unit]
  ): Request[DeleteTaskDefinitionsResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def executeCommand(): Request[ExecuteCommandResponse, AWSError] = js.native
  def executeCommand(callback: js.Function2[/* err */ AWSError, /* data */ ExecuteCommandResponse, Unit]): Request[ExecuteCommandResponse, AWSError] = js.native
  /**
    * Runs a command remotely on a container within a task. If you use a condition key in your IAM policy to refine the conditions for the policy statement, for example limit the actions to a specific cluster, you receive an AccessDeniedException when there is a mismatch between the condition key value and the corresponding parameter value. For information about required permissions and considerations, see Using Amazon ECS Exec for debugging in the Amazon ECS Developer Guide. 
    */
  def executeCommand(params: ExecuteCommandRequest): Request[ExecuteCommandResponse, AWSError] = js.native
  def executeCommand(
    params: ExecuteCommandRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ ExecuteCommandResponse, Unit]
  ...
  /**
    ...
    */
  def listServicesByNamespace(): Request[ListServicesByNamespaceResponse, AWSError] = js.native
  def listServicesByNamespace(callback: js.Function2[/* err */ AWSError, /* data */ ListServicesByNamespaceResponse, Unit]): Request[ListServicesByNamespaceResponse, AWSError] = js.native
  /**
    * This operation lists all of the services that are associated with a Cloud Map namespace. This list might include services in different clusters. In contrast, ListServices can only list services in one cluster at a time. If you need to filter the list of services in a single cluster by various parameters, use ListServices. For more information, see Service Connect in the Amazon Elastic Container Service Developer Guide.
    */
  def listServicesByNamespace(params: ListServicesByNamespaceRequest): Request[ListServicesByNamespaceResponse, AWSError] = js.native
  def listServicesByNamespace(
    params: ListServicesByNamespaceRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ ListServicesByNamespaceResponse, Unit]
  ): Request[ListServicesByNamespaceResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def updateCapacityProvider(): Request[UpdateCapacityProviderResponse, AWSError] = js.native
  def updateCapacityProvider(callback: js.Function2[/* err */ AWSError, /* data */ UpdateCapacityProviderResponse, Unit]): Request[UpdateCapacityProviderResponse, AWSError] = js.native
  /**
    * Modifies the parameters for a capacity provider.
    */
  def updateCapacityProvider(params: UpdateCapacityProviderRequest): Request[UpdateCapacityProviderResponse, AWSError] = js.native
  def updateCapacityProvider(
    params: UpdateCapacityProviderRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ UpdateCapacityProviderResponse, Unit]
  ): Request[UpdateCapacityProviderResponse, AWSError] = js.native
