...
trait UnlockRuleResponse extends StObject {
...
object UnlockRuleResponse {
  ...
  inline def apply(): UnlockRuleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UnlockRuleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UnlockRuleResponse] (val x: Self) extends AnyVal {
