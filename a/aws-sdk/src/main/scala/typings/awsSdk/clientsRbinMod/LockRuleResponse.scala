...
trait LockRuleResponse extends StObject {
...
object LockRuleResponse {
  ...
  inline def apply(): LockRuleResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LockRuleResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LockRuleResponse] (val x: Self) extends AnyVal {
