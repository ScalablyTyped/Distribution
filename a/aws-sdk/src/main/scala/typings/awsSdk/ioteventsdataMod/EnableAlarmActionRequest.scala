...
trait EnableAlarmActionRequest extends StObject {
...
object EnableAlarmActionRequest {
  ...
  inline def apply(alarmModelName: AlarmModelName, requestId: RequestId): EnableAlarmActionRequest = {
  ...
  extension [Self <: EnableAlarmActionRequest](x: Self) {
