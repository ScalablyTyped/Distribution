...
trait SentimentDetectionJobFilter extends StObject {
...
object SentimentDetectionJobFilter {
  ...
  inline def apply(): SentimentDetectionJobFilter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SentimentDetectionJobFilter]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SentimentDetectionJobFilter] (val x: Self) extends AnyVal {
