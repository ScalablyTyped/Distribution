...
trait Geometry extends StObject {
  ...
  /**
    ...
    */
  var BoundingBox: js.UndefOr[typings.awsSdk.clientsComprehendMod.BoundingBox] = js.undefined
  
  /**
    * Within the bounding box, a fine-grained polygon around the recognized item.
    */
  var Polygon: js.UndefOr[typings.awsSdk.clientsComprehendMod.Polygon] = js.undefined
}
object Geometry {
