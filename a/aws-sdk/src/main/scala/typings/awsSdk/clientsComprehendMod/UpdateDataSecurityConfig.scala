...
trait UpdateDataSecurityConfig extends StObject {
...
object UpdateDataSecurityConfig {
  ...
  inline def apply(): UpdateDataSecurityConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateDataSecurityConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateDataSecurityConfig] (val x: Self) extends AnyVal {
