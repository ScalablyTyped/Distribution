...
trait ListTargetedSentimentDetectionJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var TargetedSentimentDetectionJobPropertiesList: js.UndefOr[typings.awsSdk.clientsComprehendMod.TargetedSentimentDetectionJobPropertiesList] = js.undefined
}
object ListTargetedSentimentDetectionJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTargetedSentimentDetectionJobsResponse] (val x: Self) extends AnyVal {
