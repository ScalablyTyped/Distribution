...
trait ListSentimentDetectionJobsRequest extends StObject {
...
object ListSentimentDetectionJobsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSentimentDetectionJobsRequest] (val x: Self) extends AnyVal {
