...
trait DescribeDocumentClassifierResponse extends StObject {
  ...
  /**
    ...
    */
  var DocumentClassifierProperties: js.UndefOr[typings.awsSdk.clientsComprehendMod.DocumentClassifierProperties] = js.undefined
}
object DescribeDocumentClassifierResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeDocumentClassifierResponse] (val x: Self) extends AnyVal {
