...
object BatchDetectSentimentResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BatchDetectSentimentResponse] (val x: Self) extends AnyVal {
    ...
    inline def setResultListVarargs(value: BatchDetectSentimentItemResult*): Self = StObject.set(x, "ResultList", js.Array(value*))
  }
}
