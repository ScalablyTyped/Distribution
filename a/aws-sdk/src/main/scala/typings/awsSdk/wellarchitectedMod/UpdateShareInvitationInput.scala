...
trait UpdateShareInvitationInput extends StObject {
  ...
  var ShareInvitationAction: typings.awsSdk.wellarchitectedMod.ShareInvitationAction
  
  /**
    * The ID assigned to the share invitation.
    */
  var ShareInvitationId: typings.awsSdk.wellarchitectedMod.ShareInvitationId
}
