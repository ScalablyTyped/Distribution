...
trait LensReview extends StObject {
  ...
  /**
    ...
    */
  var LensStatus: js.UndefOr[typings.awsSdk.wellarchitectedMod.LensStatus] = js.undefined
  ...
  var PillarReviewSummaries: js.UndefOr[typings.awsSdk.wellarchitectedMod.PillarReviewSummaries] = js.undefined
...
object LensReview {
  ...
  extension [Self <: LensReview](x: Self) {
