...
trait Policies extends StObject {
  ...
  /**
    ...
    */
  var AppCookieStickinessPolicies: js.UndefOr[typings.awsSdk.clientsElbMod.AppCookieStickinessPolicies] = js.undefined
  
  /**
    * The stickiness policies created using CreateLBCookieStickinessPolicy.
    */
  var LBCookieStickinessPolicies: js.UndefOr[typings.awsSdk.clientsElbMod.LBCookieStickinessPolicies] = js.undefined
