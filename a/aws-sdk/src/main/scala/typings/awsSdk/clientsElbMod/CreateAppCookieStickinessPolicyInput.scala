...
trait CreateAppCookieStickinessPolicyInput extends StObject {
  ...
  /**
    ...
    */
  var CookieName: typings.awsSdk.clientsElbMod.CookieName
...
object CreateAppCookieStickinessPolicyInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateAppCookieStickinessPolicyInput] (val x: Self) extends AnyVal {
