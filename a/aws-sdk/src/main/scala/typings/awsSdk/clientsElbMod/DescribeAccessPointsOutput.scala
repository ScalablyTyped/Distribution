...
trait DescribeAccessPointsOutput extends StObject {
  ...
  /**
    ...
    */
  var LoadBalancerDescriptions: js.UndefOr[typings.awsSdk.clientsElbMod.LoadBalancerDescriptions] = js.undefined
...
object DescribeAccessPointsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAccessPointsOutput] (val x: Self) extends AnyVal {
