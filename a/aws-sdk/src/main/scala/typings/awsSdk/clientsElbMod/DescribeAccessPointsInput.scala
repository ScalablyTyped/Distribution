...
trait DescribeAccessPointsInput extends StObject {
  ...
  /**
    ...
    */
  var LoadBalancerNames: js.UndefOr[typings.awsSdk.clientsElbMod.LoadBalancerNames] = js.undefined
...
object DescribeAccessPointsInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAccessPointsInput] (val x: Self) extends AnyVal {
