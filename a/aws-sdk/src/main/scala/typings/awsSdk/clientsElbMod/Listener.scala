...
trait Listener extends StObject {
  ...
  /**
    ...
    */
  var InstancePort: typings.awsSdk.clientsElbMod.InstancePort
  ...
  /**
    ...
    */
  var Protocol: typings.awsSdk.clientsElbMod.Protocol
  
  /**
    * The Amazon Resource Name (ARN) of the server certificate.
    */
  var SSLCertificateId: js.UndefOr[typings.awsSdk.clientsElbMod.SSLCertificateId] = js.undefined
}
object Listener {
