...
trait PolicyAttributeDescription extends StObject {
  ...
  /**
    ...
    */
  var AttributeValue: js.UndefOr[typings.awsSdk.clientsElbMod.AttributeValue] = js.undefined
}
object PolicyAttributeDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PolicyAttributeDescription] (val x: Self) extends AnyVal {
