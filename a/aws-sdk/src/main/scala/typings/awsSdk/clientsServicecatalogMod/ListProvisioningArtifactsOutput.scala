...
trait ListProvisioningArtifactsOutput extends StObject {
  ...
  /**
    ...
    */
  var ProvisioningArtifactDetails: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProvisioningArtifactDetails] = js.undefined
}
object ListProvisioningArtifactsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProvisioningArtifactsOutput] (val x: Self) extends AnyVal {
