...
trait SearchProductsOutput extends StObject {
  ...
  /**
    ...
    */
  var ProductViewAggregations: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProductViewAggregations] = js.undefined
  
  /**
    * Information about the product views.
    */
  var ProductViewSummaries: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProductViewSummaries] = js.undefined
}
object SearchProductsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchProductsOutput] (val x: Self) extends AnyVal {
