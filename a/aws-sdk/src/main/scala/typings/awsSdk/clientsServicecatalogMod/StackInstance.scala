...
trait StackInstance extends StObject {
  ...
  /**
    ...
    */
  var Region: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.Region] = js.undefined
  ...
  /**
    ...
    */
  var StackInstanceStatus: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.StackInstanceStatus] = js.undefined
}
