...
trait CreatePortfolioInput extends StObject {
  ...
  /**
    ...
    */
  var ProviderName: typings.awsSdk.clientsServicecatalogMod.ProviderName
...
object CreatePortfolioInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreatePortfolioInput] (val x: Self) extends AnyVal {
