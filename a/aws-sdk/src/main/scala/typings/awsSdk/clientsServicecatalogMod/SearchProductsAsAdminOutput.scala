...
trait SearchProductsAsAdminOutput extends StObject {
  ...
  /**
    ...
    */
  var ProductViewDetails: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProductViewDetails] = js.undefined
}
object SearchProductsAsAdminOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchProductsAsAdminOutput] (val x: Self) extends AnyVal {
