...
trait ProductViewSummary extends StObject {
  ...
  /**
    ...
    */
  var HasDefaultPath: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.HasDefaultPath] = js.undefined
...
object ProductViewSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ProductViewSummary] (val x: Self) extends AnyVal {
