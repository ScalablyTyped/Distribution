...
trait ListPrincipalsForPortfolioInput extends StObject {
...
object ListPrincipalsForPortfolioInput {
  ...
  inline def apply(PortfolioId: Id): ListPrincipalsForPortfolioInput = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPrincipalsForPortfolioInput] (val x: Self) extends AnyVal {
