...
trait RecordDetail extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedProductType: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProvisionedProductType] = js.undefined
  ...
  /**
    ...
    */
  var RecordErrors: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.RecordErrors] = js.undefined
  ...
  /**
    * One or more tags.
    */
  var RecordTags: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.RecordTags] = js.undefined
  
  /**
    * The record type.    PROVISION_PRODUCT     UPDATE_PROVISIONED_PRODUCT     TERMINATE_PROVISIONED_PRODUCT   
    */
  var RecordType: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.RecordType] = js.undefined
