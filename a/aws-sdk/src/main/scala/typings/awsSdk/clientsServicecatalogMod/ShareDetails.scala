...
trait ShareDetails extends StObject {
  ...
  /**
    * List of errors.
    */
  var ShareErrors: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ShareErrors] = js.undefined
  
  /**
    * List of accounts for whom the operation succeeded.
    */
  var SuccessfulShares: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.SuccessfulShares] = js.undefined
}
object ShareDetails {
