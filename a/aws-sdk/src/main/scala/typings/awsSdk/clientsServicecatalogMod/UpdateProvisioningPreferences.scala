...
trait UpdateProvisioningPreferences extends StObject {
  ...
  /**
    ...
    */
  var StackSetOperationType: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.StackSetOperationType] = js.undefined
...
object UpdateProvisioningPreferences {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateProvisioningPreferences] (val x: Self) extends AnyVal {
