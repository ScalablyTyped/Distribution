...
trait DescribeProductAsAdminOutput extends StObject {
  ...
  /**
    ...
    */
  var ProvisioningArtifactSummaries: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProvisioningArtifactSummaries] = js.undefined
...
object DescribeProductAsAdminOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeProductAsAdminOutput] (val x: Self) extends AnyVal {
