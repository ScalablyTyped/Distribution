...
trait DescribeProvisionedProductPlanOutput extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedProductPlanDetails: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProvisionedProductPlanDetails] = js.undefined
  
  /**
    * Information about the resource changes that will occur when the plan is executed.
    */
  var ResourceChanges: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ResourceChanges] = js.undefined
}
object DescribeProvisionedProductPlanOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeProvisionedProductPlanOutput] (val x: Self) extends AnyVal {
