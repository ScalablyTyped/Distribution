...
trait NotifyProvisionProductEngineWorkflowResultInput extends StObject {
  ...
  /**
    ...
    */
  var ResourceIdentifier: js.UndefOr[EngineWorkflowResourceIdentifier] = js.undefined
...
object NotifyProvisionProductEngineWorkflowResultInput {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[NotifyProvisionProductEngineWorkflowResultInput]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: NotifyProvisionProductEngineWorkflowResultInput] (val x: Self) extends AnyVal {
    ...
    inline def setResourceIdentifier(value: EngineWorkflowResourceIdentifier): Self = StObject.set(x, "ResourceIdentifier", value.asInstanceOf[js.Any])
