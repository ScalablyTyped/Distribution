...
trait ListProvisionedProductPlansOutput extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedProductPlans: js.UndefOr[typings.awsSdk.clientsServicecatalogMod.ProvisionedProductPlans] = js.undefined
}
object ListProvisionedProductPlansOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListProvisionedProductPlansOutput] (val x: Self) extends AnyVal {
