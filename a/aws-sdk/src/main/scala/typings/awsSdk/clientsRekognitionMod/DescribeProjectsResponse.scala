...
trait DescribeProjectsResponse extends StObject {
  ...
  /**
    ...
    */
  var ProjectDescriptions: js.UndefOr[typings.awsSdk.clientsRekognitionMod.ProjectDescriptions] = js.undefined
}
object DescribeProjectsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeProjectsResponse] (val x: Self) extends AnyVal {
