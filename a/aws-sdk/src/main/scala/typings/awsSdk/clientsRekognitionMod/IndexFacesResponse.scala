...
trait IndexFacesResponse extends StObject {
  ...
  /**
    ...
    */
  var UnindexedFaces: js.UndefOr[typings.awsSdk.clientsRekognitionMod.UnindexedFaces] = js.undefined
}
object IndexFacesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IndexFacesResponse] (val x: Self) extends AnyVal {
