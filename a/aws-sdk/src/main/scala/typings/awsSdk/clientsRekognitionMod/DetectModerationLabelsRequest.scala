...
trait DetectModerationLabelsRequest extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopConfig: js.UndefOr[typings.awsSdk.clientsRekognitionMod.HumanLoopConfig] = js.undefined
...
object DetectModerationLabelsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DetectModerationLabelsRequest] (val x: Self) extends AnyVal {
