...
trait StreamProcessorOutput extends StObject {
  ...
  /**
    ...
    */
  var KinesisDataStream: js.UndefOr[typings.awsSdk.clientsRekognitionMod.KinesisDataStream] = js.undefined
  
  /**
    *  The Amazon S3 bucket location to which Amazon Rekognition publishes the detailed inference results of a video analysis operation. 
    */
  var S3Destination: js.UndefOr[typings.awsSdk.clientsRekognitionMod.S3Destination] = js.undefined
}
object StreamProcessorOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StreamProcessorOutput] (val x: Self) extends AnyVal {
