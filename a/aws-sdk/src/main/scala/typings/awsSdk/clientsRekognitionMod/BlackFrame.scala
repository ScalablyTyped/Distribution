...
trait BlackFrame extends StObject {
  ...
  /**
    ...
    */
  var MaxPixelThreshold: js.UndefOr[typings.awsSdk.clientsRekognitionMod.MaxPixelThreshold] = js.undefined
  ...
  /**
    ...
    */
  var MinCoveragePercentage: js.UndefOr[typings.awsSdk.clientsRekognitionMod.MinCoveragePercentage] = js.undefined
}
object BlackFrame {
