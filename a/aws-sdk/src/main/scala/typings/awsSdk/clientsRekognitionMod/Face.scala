...
trait Face extends StObject {
  ...
  /**
    ...
    */
  var FaceId: js.UndefOr[typings.awsSdk.clientsRekognitionMod.FaceId] = js.undefined
  
  /**
    * Unique identifier that Amazon Rekognition assigns to the input image.
    */
  var ImageId: js.UndefOr[typings.awsSdk.clientsRekognitionMod.ImageId] = js.undefined
  
  /**
    *  The version of the face detect and storage model that was used when indexing the face vector. 
    */
  var IndexFacesModelVersion: js.UndefOr[typings.awsSdk.clientsRekognitionMod.IndexFacesModelVersion] = js.undefined
}
object Face {
