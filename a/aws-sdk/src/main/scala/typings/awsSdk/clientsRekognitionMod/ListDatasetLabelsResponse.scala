...
trait ListDatasetLabelsResponse extends StObject {
  ...
  /**
    ...
    */
  var DatasetLabelDescriptions: js.UndefOr[typings.awsSdk.clientsRekognitionMod.DatasetLabelDescriptions] = js.undefined
...
object ListDatasetLabelsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListDatasetLabelsResponse] (val x: Self) extends AnyVal {
