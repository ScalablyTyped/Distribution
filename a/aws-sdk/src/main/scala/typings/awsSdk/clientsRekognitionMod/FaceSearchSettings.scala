...
trait FaceSearchSettings extends StObject {
  ...
  /**
    ...
    */
  var CollectionId: js.UndefOr[typings.awsSdk.clientsRekognitionMod.CollectionId] = js.undefined
...
object FaceSearchSettings {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FaceSearchSettings] (val x: Self) extends AnyVal {
