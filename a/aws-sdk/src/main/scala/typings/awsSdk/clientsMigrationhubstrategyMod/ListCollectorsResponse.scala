...
trait ListCollectorsResponse extends StObject {
  ...
  /**
    ...
    */
  var Collectors: js.UndefOr[typings.awsSdk.clientsMigrationhubstrategyMod.Collectors] = js.undefined
...
object ListCollectorsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCollectorsResponse] (val x: Self) extends AnyVal {
