...
trait PutStorageLensConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var StorageLensConfiguration: typings.awsSdk.clientsS3controlMod.StorageLensConfiguration
...
object PutStorageLensConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutStorageLensConfigurationRequest] (val x: Self) extends AnyVal {
