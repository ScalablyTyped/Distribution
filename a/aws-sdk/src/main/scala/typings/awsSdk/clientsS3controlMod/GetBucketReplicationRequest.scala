...
object GetBucketReplicationRequest {
  ...
  inline def apply(AccountId: AccountId, Bucket: BucketName): GetBucketReplicationRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBucketReplicationRequest] (val x: Self) extends AnyVal {
