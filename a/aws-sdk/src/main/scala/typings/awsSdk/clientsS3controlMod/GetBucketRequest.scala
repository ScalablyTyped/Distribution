...
object GetBucketRequest {
  ...
  inline def apply(AccountId: AccountId, Bucket: BucketName): GetBucketRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBucketRequest] (val x: Self) extends AnyVal {
