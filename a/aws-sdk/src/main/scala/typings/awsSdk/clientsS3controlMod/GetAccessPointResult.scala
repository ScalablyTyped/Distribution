...
trait GetAccessPointResult extends StObject {
  ...
  /**
    ...
    */
  var Endpoints: js.UndefOr[typings.awsSdk.clientsS3controlMod.Endpoints] = js.undefined
  ...
  /**
    ...
    */
  var NetworkOrigin: js.UndefOr[typings.awsSdk.clientsS3controlMod.NetworkOrigin] = js.undefined
...
object GetAccessPointResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetAccessPointResult] (val x: Self) extends AnyVal {
