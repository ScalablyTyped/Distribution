...
trait CreateBucketRequest extends StObject {
  ...
  /**
    ...
    */
  var CreateBucketConfiguration: js.UndefOr[typings.awsSdk.clientsS3controlMod.CreateBucketConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var GrantFullControl: js.UndefOr[typings.awsSdk.clientsS3controlMod.GrantFullControl] = js.undefined
  
  /**
    * Allows grantee to list the objects in the bucket.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantRead: js.UndefOr[typings.awsSdk.clientsS3controlMod.GrantRead] = js.undefined
  
  /**
    * Allows grantee to read the bucket ACL.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantReadACP: js.UndefOr[typings.awsSdk.clientsS3controlMod.GrantReadACP] = js.undefined
  ...
  /**
    ...
    */
  var GrantWrite: js.UndefOr[typings.awsSdk.clientsS3controlMod.GrantWrite] = js.undefined
  
  /**
    * Allows grantee to write the ACL for the applicable bucket.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var GrantWriteACP: js.UndefOr[typings.awsSdk.clientsS3controlMod.GrantWriteACP] = js.undefined
  ...
  /**
    ...
    */
  var ObjectLockEnabledForBucket: js.UndefOr[typings.awsSdk.clientsS3controlMod.ObjectLockEnabledForBucket] = js.undefined
