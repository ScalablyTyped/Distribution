...
trait PutBucketReplicationRequest extends StObject {
  ...
  /**
    * 
    */
  var ReplicationConfiguration: typings.awsSdk.clientsS3controlMod.ReplicationConfiguration
}
object PutBucketReplicationRequest {
  
  inline def apply(AccountId: AccountId, Bucket: BucketName, ReplicationConfiguration: ReplicationConfiguration): PutBucketReplicationRequest = {
    val __obj = js.Dynamic.literal(AccountId = AccountId.asInstanceOf[js.Any], Bucket = Bucket.asInstanceOf[js.Any], ReplicationConfiguration = ReplicationConfiguration.asInstanceOf[js.Any])
