...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.awsSdk.awsSdkStrings.`HeadObject-Range`
  - typings.awsSdk.awsSdkStrings.`HeadObject-PartNumber`
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.GetObject
  - typings.awsSdk.awsSdkStrings.HeadObject
  - typings.awsSdk.awsSdkStrings.ListObjects
  - typings.awsSdk.awsSdkStrings.ListObjectsV2
  - java.lang.String
*/
