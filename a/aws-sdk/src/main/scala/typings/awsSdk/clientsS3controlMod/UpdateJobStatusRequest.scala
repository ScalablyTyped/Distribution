...
trait UpdateJobStatusRequest extends StObject {
  ...
  /**
    ...
    */
  var RequestedJobStatus: typings.awsSdk.clientsS3controlMod.RequestedJobStatus
...
object UpdateJobStatusRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateJobStatusRequest] (val x: Self) extends AnyVal {
