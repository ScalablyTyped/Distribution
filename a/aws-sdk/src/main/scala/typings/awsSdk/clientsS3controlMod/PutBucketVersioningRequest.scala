...
trait PutBucketVersioningRequest extends StObject {
  ...
  /**
    ...
    */
  var MFA: js.UndefOr[typings.awsSdk.clientsS3controlMod.MFA] = js.undefined
  
  /**
    * The root-level tag for the VersioningConfiguration parameters.
    */
  var VersioningConfiguration: typings.awsSdk.clientsS3controlMod.VersioningConfiguration
}
