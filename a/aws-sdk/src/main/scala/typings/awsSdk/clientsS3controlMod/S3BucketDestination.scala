...
trait S3BucketDestination extends StObject {
  ...
  /**
    * 
    */
  var Format: typings.awsSdk.clientsS3controlMod.Format
  
  /**
    * The schema version of the export file.
    */
  var OutputSchemaVersion: typings.awsSdk.clientsS3controlMod.OutputSchemaVersion
...
object S3BucketDestination {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: S3BucketDestination] (val x: Self) extends AnyVal {
