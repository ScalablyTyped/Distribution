...
trait ModifyInstanceCapacityReservationAttributesRequest extends StObject {
  ...
  /**
    ...
    */
  var CapacityReservationSpecification: typings.awsSdk.clientsEc2Mod.CapacityReservationSpecification
...
object ModifyInstanceCapacityReservationAttributesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModifyInstanceCapacityReservationAttributesRequest] (val x: Self) extends AnyVal {
