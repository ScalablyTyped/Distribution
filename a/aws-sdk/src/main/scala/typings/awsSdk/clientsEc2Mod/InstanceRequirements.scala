...
trait InstanceRequirements extends StObject {
  ...
  /**
    ...
    */
  var AcceleratorCount: js.UndefOr[typings.awsSdk.clientsEc2Mod.AcceleratorCount] = js.undefined
  ...
  /**
    ...
    */
  var AcceleratorTotalMemoryMiB: js.UndefOr[typings.awsSdk.clientsEc2Mod.AcceleratorTotalMemoryMiB] = js.undefined
  ...
  /**
    ...
    */
  var BaselineEbsBandwidthMbps: js.UndefOr[typings.awsSdk.clientsEc2Mod.BaselineEbsBandwidthMbps] = js.undefined
  ...
  /**
    ...
    */
  var MemoryGiBPerVCpu: js.UndefOr[typings.awsSdk.clientsEc2Mod.MemoryGiBPerVCpu] = js.undefined
  
  /**
    * The minimum and maximum amount of memory, in MiB.
    */
  var MemoryMiB: js.UndefOr[typings.awsSdk.clientsEc2Mod.MemoryMiB] = js.undefined
  
  /**
    * The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps). Default: No minimum or maximum limits
    */
  var NetworkBandwidthGbps: js.UndefOr[typings.awsSdk.clientsEc2Mod.NetworkBandwidthGbps] = js.undefined
  
  /**
    * The minimum and maximum number of network interfaces. Default: No minimum or maximum limits
    */
  var NetworkInterfaceCount: js.UndefOr[typings.awsSdk.clientsEc2Mod.NetworkInterfaceCount] = js.undefined
  ...
  /**
    ...
    */
  var TotalLocalStorageGB: js.UndefOr[typings.awsSdk.clientsEc2Mod.TotalLocalStorageGB] = js.undefined
...
object InstanceRequirements {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceRequirements] (val x: Self) extends AnyVal {
    ...
    inline def setNetworkBandwidthGbps(value: NetworkBandwidthGbps): Self = StObject.set(x, "NetworkBandwidthGbps", value.asInstanceOf[js.Any])
