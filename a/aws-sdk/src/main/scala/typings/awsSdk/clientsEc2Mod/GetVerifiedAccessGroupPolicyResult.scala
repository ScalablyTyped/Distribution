...
trait GetVerifiedAccessGroupPolicyResult extends StObject {
...
object GetVerifiedAccessGroupPolicyResult {
  
  inline def apply(): GetVerifiedAccessGroupPolicyResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetVerifiedAccessGroupPolicyResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetVerifiedAccessGroupPolicyResult] (val x: Self) extends AnyVal {
