...
trait FailedCapacityReservationFleetCancellationResult extends StObject {
  ...
  /**
    ...
    */
  var CancelCapacityReservationFleetError: js.UndefOr[typings.awsSdk.clientsEc2Mod.CancelCapacityReservationFleetError] = js.undefined
...
object FailedCapacityReservationFleetCancellationResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: FailedCapacityReservationFleetCancellationResult] (val x: Self) extends AnyVal {
