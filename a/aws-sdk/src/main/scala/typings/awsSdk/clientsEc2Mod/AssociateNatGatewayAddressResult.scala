...
trait AssociateNatGatewayAddressResult extends StObject {
...
object AssociateNatGatewayAddressResult {
  
  inline def apply(): AssociateNatGatewayAddressResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AssociateNatGatewayAddressResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AssociateNatGatewayAddressResult] (val x: Self) extends AnyVal {
