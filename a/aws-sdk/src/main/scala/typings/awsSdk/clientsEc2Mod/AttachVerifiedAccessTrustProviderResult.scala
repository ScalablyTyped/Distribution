...
trait AttachVerifiedAccessTrustProviderResult extends StObject {
...
object AttachVerifiedAccessTrustProviderResult {
  
  inline def apply(): AttachVerifiedAccessTrustProviderResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AttachVerifiedAccessTrustProviderResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AttachVerifiedAccessTrustProviderResult] (val x: Self) extends AnyVal {
