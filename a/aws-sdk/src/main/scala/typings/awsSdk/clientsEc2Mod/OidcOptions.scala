...
trait OidcOptions extends StObject {
...
object OidcOptions {
  ...
  inline def apply(): OidcOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OidcOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OidcOptions] (val x: Self) extends AnyVal {
