...
trait ExportToS3Task extends StObject {
  ...
  /**
    ...
    */
  var ContainerFormat: js.UndefOr[typings.awsSdk.clientsEc2Mod.ContainerFormat] = js.undefined
...
object ExportToS3Task {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ExportToS3Task] (val x: Self) extends AnyVal {
