...
trait GetTransitGatewayRouteTableAssociationsRequest extends StObject {
...
object GetTransitGatewayRouteTableAssociationsRequest {
  ...
  inline def apply(TransitGatewayRouteTableId: TransitGatewayRouteTableId): GetTransitGatewayRouteTableAssociationsRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetTransitGatewayRouteTableAssociationsRequest] (val x: Self) extends AnyVal {
