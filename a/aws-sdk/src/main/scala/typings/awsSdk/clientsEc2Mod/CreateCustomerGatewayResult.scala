...
trait CreateCustomerGatewayResult extends StObject {
  ...
  /**
    ...
    */
  var CustomerGateway: js.UndefOr[typings.awsSdk.clientsEc2Mod.CustomerGateway] = js.undefined
}
object CreateCustomerGatewayResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateCustomerGatewayResult] (val x: Self) extends AnyVal {
