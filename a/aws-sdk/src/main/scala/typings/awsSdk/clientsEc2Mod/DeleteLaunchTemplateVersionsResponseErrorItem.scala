...
trait DeleteLaunchTemplateVersionsResponseErrorItem extends StObject {
  ...
  /**
    ...
    */
  var ResponseError: js.UndefOr[typings.awsSdk.clientsEc2Mod.ResponseError] = js.undefined
...
object DeleteLaunchTemplateVersionsResponseErrorItem {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteLaunchTemplateVersionsResponseErrorItem] (val x: Self) extends AnyVal {
