...
trait HistoryRecordEntry extends StObject {
  ...
  /**
    ...
    */
  var EventInformation: js.UndefOr[typings.awsSdk.clientsEc2Mod.EventInformation] = js.undefined
...
object HistoryRecordEntry {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HistoryRecordEntry] (val x: Self) extends AnyVal {
