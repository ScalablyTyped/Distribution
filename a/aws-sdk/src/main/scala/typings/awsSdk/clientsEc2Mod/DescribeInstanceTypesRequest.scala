...
trait DescribeInstanceTypesRequest extends StObject {
  ...
  /**
    ...
    */
  var InstanceTypes: js.UndefOr[RequestInstanceTypeList] = js.undefined
  
  /**
    * The maximum number of items to return for this request. To get the next page of items, make another request with the token returned in the output. For more information, see Pagination.
    */
  var MaxResults: js.UndefOr[DITMaxResults] = js.undefined
...
object DescribeInstanceTypesRequest {
  ...
  inline def apply(): DescribeInstanceTypesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeInstanceTypesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeInstanceTypesRequest] (val x: Self) extends AnyVal {
    ...
    inline def setInstanceTypes(value: RequestInstanceTypeList): Self = StObject.set(x, "InstanceTypes", value.asInstanceOf[js.Any])
    ...
    inline def setMaxResults(value: DITMaxResults): Self = StObject.set(x, "MaxResults", value.asInstanceOf[js.Any])
