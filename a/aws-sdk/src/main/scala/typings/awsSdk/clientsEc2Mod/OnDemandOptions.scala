...
trait OnDemandOptions extends StObject {
  ...
  /**
    ...
    */
  var CapacityReservationOptions: js.UndefOr[typings.awsSdk.clientsEc2Mod.CapacityReservationOptions] = js.undefined
...
object OnDemandOptions {
  ...
  inline def apply(): OnDemandOptions = {
  ...
  extension [Self <: OnDemandOptions](x: Self) {
    ...
    inline def setCapacityReservationOptions(value: CapacityReservationOptions): Self = StObject.set(x, "CapacityReservationOptions", value.asInstanceOf[js.Any])
