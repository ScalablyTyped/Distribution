...
trait ModifyVpcEndpointServicePayerResponsibilityRequest extends StObject {
  ...
  /**
    ...
    */
  var PayerResponsibility: typings.awsSdk.clientsEc2Mod.PayerResponsibility
...
object ModifyVpcEndpointServicePayerResponsibilityRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModifyVpcEndpointServicePayerResponsibilityRequest] (val x: Self) extends AnyVal {
