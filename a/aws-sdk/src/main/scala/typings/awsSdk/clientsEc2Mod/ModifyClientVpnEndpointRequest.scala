...
trait ModifyClientVpnEndpointRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientConnectOptions: js.UndefOr[typings.awsSdk.clientsEc2Mod.ClientConnectOptions] = js.undefined
  
  /**
    * Options for enabling a customizable text banner that will be displayed on Amazon Web Services provided clients when a VPN session is established.
    */
  var ClientLoginBannerOptions: js.UndefOr[typings.awsSdk.clientsEc2Mod.ClientLoginBannerOptions] = js.undefined
  ...
  /**
    ...
    */
  var ConnectionLogOptions: js.UndefOr[typings.awsSdk.clientsEc2Mod.ConnectionLogOptions] = js.undefined
  ...
  /**
    ...
    */
  var SelfServicePortal: js.UndefOr[typings.awsSdk.clientsEc2Mod.SelfServicePortal] = js.undefined
...
object ModifyClientVpnEndpointRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModifyClientVpnEndpointRequest] (val x: Self) extends AnyVal {
