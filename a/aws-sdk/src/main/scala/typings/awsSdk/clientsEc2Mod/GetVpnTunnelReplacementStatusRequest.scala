...
trait GetVpnTunnelReplacementStatusRequest extends StObject {
...
object GetVpnTunnelReplacementStatusRequest {
  ...
  inline def apply(VpnConnectionId: VpnConnectionId, VpnTunnelOutsideIpAddress: String): GetVpnTunnelReplacementStatusRequest = {
    ...
    __obj.asInstanceOf[GetVpnTunnelReplacementStatusRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetVpnTunnelReplacementStatusRequest] (val x: Self) extends AnyVal {
