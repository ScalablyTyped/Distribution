...
trait CreateTrafficMirrorFilterRuleRequest extends StObject {
  ...
  /**
    * The type of traffic.
    */
  var TrafficDirection: typings.awsSdk.clientsEc2Mod.TrafficDirection
...
object CreateTrafficMirrorFilterRuleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateTrafficMirrorFilterRuleRequest] (val x: Self) extends AnyVal {
