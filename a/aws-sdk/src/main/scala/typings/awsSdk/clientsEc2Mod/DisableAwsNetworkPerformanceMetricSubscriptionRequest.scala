...
trait DisableAwsNetworkPerformanceMetricSubscriptionRequest extends StObject {
...
object DisableAwsNetworkPerformanceMetricSubscriptionRequest {
  ...
  inline def apply(): DisableAwsNetworkPerformanceMetricSubscriptionRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DisableAwsNetworkPerformanceMetricSubscriptionRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DisableAwsNetworkPerformanceMetricSubscriptionRequest] (val x: Self) extends AnyVal {
