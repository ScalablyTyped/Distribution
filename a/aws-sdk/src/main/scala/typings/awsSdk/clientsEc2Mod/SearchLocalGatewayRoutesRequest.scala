...
trait SearchLocalGatewayRoutesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.clientsEc2Mod.MaxResults] = js.undefined
...
object SearchLocalGatewayRoutesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SearchLocalGatewayRoutesRequest] (val x: Self) extends AnyVal {
