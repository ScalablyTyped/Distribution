...
trait TargetGroupsConfig extends StObject {
  ...
  /**
    ...
    */
  var TargetGroups: js.UndefOr[typings.awsSdk.clientsEc2Mod.TargetGroups] = js.undefined
}
object TargetGroupsConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetGroupsConfig] (val x: Self) extends AnyVal {
