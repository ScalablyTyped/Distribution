...
trait DeleteVerifiedAccessInstanceRequest extends StObject {
...
object DeleteVerifiedAccessInstanceRequest {
  ...
  inline def apply(VerifiedAccessInstanceId: VerifiedAccessInstanceId): DeleteVerifiedAccessInstanceRequest = {
    val __obj = js.Dynamic.literal(VerifiedAccessInstanceId = VerifiedAccessInstanceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteVerifiedAccessInstanceRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteVerifiedAccessInstanceRequest] (val x: Self) extends AnyVal {
