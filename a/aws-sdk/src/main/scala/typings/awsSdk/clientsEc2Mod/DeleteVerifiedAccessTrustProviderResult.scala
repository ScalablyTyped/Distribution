...
trait DeleteVerifiedAccessTrustProviderResult extends StObject {
...
object DeleteVerifiedAccessTrustProviderResult {
  
  inline def apply(): DeleteVerifiedAccessTrustProviderResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteVerifiedAccessTrustProviderResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteVerifiedAccessTrustProviderResult] (val x: Self) extends AnyVal {
