...
trait CreateVerifiedAccessTrustProviderOidcOptions extends StObject {
...
object CreateVerifiedAccessTrustProviderOidcOptions {
  
  inline def apply(): CreateVerifiedAccessTrustProviderOidcOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateVerifiedAccessTrustProviderOidcOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateVerifiedAccessTrustProviderOidcOptions] (val x: Self) extends AnyVal {
