...
trait ModifyVpcEndpointConnectionNotificationRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectionNotificationId: typings.awsSdk.clientsEc2Mod.ConnectionNotificationId
...
object ModifyVpcEndpointConnectionNotificationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModifyVpcEndpointConnectionNotificationRequest] (val x: Self) extends AnyVal {
