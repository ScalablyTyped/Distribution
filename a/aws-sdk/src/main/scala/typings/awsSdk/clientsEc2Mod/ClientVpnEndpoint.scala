...
trait ClientVpnEndpoint extends StObject {
  ...
  /**
    ...
    */
  var TransportProtocol: js.UndefOr[typings.awsSdk.clientsEc2Mod.TransportProtocol] = js.undefined
  ...
  /**
    ...
    */
  var VpnProtocol: js.UndefOr[typings.awsSdk.clientsEc2Mod.VpnProtocol] = js.undefined
}
object ClientVpnEndpoint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ClientVpnEndpoint] (val x: Self) extends AnyVal {
