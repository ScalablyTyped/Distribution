...
trait ModifyVerifiedAccessGroupRequest extends StObject {
...
object ModifyVerifiedAccessGroupRequest {
  ...
  inline def apply(VerifiedAccessGroupId: VerifiedAccessGroupId): ModifyVerifiedAccessGroupRequest = {
    val __obj = js.Dynamic.literal(VerifiedAccessGroupId = VerifiedAccessGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ModifyVerifiedAccessGroupRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ModifyVerifiedAccessGroupRequest] (val x: Self) extends AnyVal {
