...
trait CreateVpcEndpointConnectionNotificationResult extends StObject {
  ...
  /**
    ...
    */
  var ConnectionNotification: js.UndefOr[typings.awsSdk.clientsEc2Mod.ConnectionNotification] = js.undefined
}
object CreateVpcEndpointConnectionNotificationResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateVpcEndpointConnectionNotificationResult] (val x: Self) extends AnyVal {
