...
trait CreateClientVpnEndpointRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectionLogOptions: typings.awsSdk.clientsEc2Mod.ConnectionLogOptions
...
object CreateClientVpnEndpointRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateClientVpnEndpointRequest] (val x: Self) extends AnyVal {
