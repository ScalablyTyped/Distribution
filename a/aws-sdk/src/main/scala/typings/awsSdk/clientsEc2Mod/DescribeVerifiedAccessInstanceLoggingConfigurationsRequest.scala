...
trait DescribeVerifiedAccessInstanceLoggingConfigurationsRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[DescribeVerifiedAccessInstanceLoggingConfigurationsMaxResults] = js.undefined
...
object DescribeVerifiedAccessInstanceLoggingConfigurationsRequest {
  ...
  inline def apply(): DescribeVerifiedAccessInstanceLoggingConfigurationsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeVerifiedAccessInstanceLoggingConfigurationsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeVerifiedAccessInstanceLoggingConfigurationsRequest] (val x: Self) extends AnyVal {
    ...
    inline def setMaxResults(value: DescribeVerifiedAccessInstanceLoggingConfigurationsMaxResults): Self = StObject.set(x, "MaxResults", value.asInstanceOf[js.Any])
