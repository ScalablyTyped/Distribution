...
trait DeleteNetworkInterfacePermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var NetworkInterfacePermissionId: typings.awsSdk.clientsEc2Mod.NetworkInterfacePermissionId
}
object DeleteNetworkInterfacePermissionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteNetworkInterfacePermissionRequest] (val x: Self) extends AnyVal {
