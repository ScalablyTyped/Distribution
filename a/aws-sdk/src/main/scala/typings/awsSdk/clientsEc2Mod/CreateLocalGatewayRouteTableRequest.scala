...
trait CreateLocalGatewayRouteTableRequest extends StObject {
  ...
  /**
    ...
    */
  var LocalGatewayId: typings.awsSdk.clientsEc2Mod.LocalGatewayId
...
object CreateLocalGatewayRouteTableRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateLocalGatewayRouteTableRequest] (val x: Self) extends AnyVal {
