...
trait DeleteTransitGatewayConnectRequest extends StObject {
...
object DeleteTransitGatewayConnectRequest {
  ...
  inline def apply(TransitGatewayAttachmentId: TransitGatewayAttachmentId): DeleteTransitGatewayConnectRequest = {
    val __obj = js.Dynamic.literal(TransitGatewayAttachmentId = TransitGatewayAttachmentId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteTransitGatewayConnectRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteTransitGatewayConnectRequest] (val x: Self) extends AnyVal {
