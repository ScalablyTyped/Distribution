...
trait DescribeAddressesAttributeRequest extends StObject {
  ...
  /**
    ...
    */
  var AllocationIds: js.UndefOr[typings.awsSdk.clientsEc2Mod.AllocationIds] = js.undefined
...
object DescribeAddressesAttributeRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAddressesAttributeRequest] (val x: Self) extends AnyVal {
