...
trait ScheduledInstanceRecurrence extends StObject {
  ...
  /**
    ...
    */
  var OccurrenceDaySet: js.UndefOr[typings.awsSdk.clientsEc2Mod.OccurrenceDaySet] = js.undefined
...
object ScheduledInstanceRecurrence {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ScheduledInstanceRecurrence] (val x: Self) extends AnyVal {
