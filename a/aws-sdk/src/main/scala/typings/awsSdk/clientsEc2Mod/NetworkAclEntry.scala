...
trait NetworkAclEntry extends StObject {
  ...
  /**
    ...
    */
  var RuleAction: js.UndefOr[typings.awsSdk.clientsEc2Mod.RuleAction] = js.undefined
...
object NetworkAclEntry {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NetworkAclEntry] (val x: Self) extends AnyVal {
