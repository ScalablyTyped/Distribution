...
trait VerifiedAccessEndpointEniOptions extends StObject {
...
object VerifiedAccessEndpointEniOptions {
  
  inline def apply(): VerifiedAccessEndpointEniOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VerifiedAccessEndpointEniOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VerifiedAccessEndpointEniOptions] (val x: Self) extends AnyVal {
