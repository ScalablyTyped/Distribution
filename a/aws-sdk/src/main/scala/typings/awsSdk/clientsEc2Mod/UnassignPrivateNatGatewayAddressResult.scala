...
trait UnassignPrivateNatGatewayAddressResult extends StObject {
...
object UnassignPrivateNatGatewayAddressResult {
  
  inline def apply(): UnassignPrivateNatGatewayAddressResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UnassignPrivateNatGatewayAddressResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UnassignPrivateNatGatewayAddressResult] (val x: Self) extends AnyVal {
