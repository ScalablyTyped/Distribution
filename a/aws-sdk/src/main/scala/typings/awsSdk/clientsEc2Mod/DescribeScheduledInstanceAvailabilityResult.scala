...
trait DescribeScheduledInstanceAvailabilityResult extends StObject {
  ...
  /**
    ...
    */
  var ScheduledInstanceAvailabilitySet: js.UndefOr[typings.awsSdk.clientsEc2Mod.ScheduledInstanceAvailabilitySet] = js.undefined
}
object DescribeScheduledInstanceAvailabilityResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeScheduledInstanceAvailabilityResult] (val x: Self) extends AnyVal {
