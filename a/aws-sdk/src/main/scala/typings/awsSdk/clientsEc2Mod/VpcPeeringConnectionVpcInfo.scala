...
trait VpcPeeringConnectionVpcInfo extends StObject {
  ...
  /**
    ...
    */
  var CidrBlockSet: js.UndefOr[typings.awsSdk.clientsEc2Mod.CidrBlockSet] = js.undefined
  
  /**
    * The IPv6 CIDR block for the VPC.
    */
  var Ipv6CidrBlockSet: js.UndefOr[typings.awsSdk.clientsEc2Mod.Ipv6CidrBlockSet] = js.undefined
