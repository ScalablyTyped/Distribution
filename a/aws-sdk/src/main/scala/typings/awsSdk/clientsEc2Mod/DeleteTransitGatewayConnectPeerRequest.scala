...
trait DeleteTransitGatewayConnectPeerRequest extends StObject {
  ...
  /**
    ...
    */
  var TransitGatewayConnectPeerId: typings.awsSdk.clientsEc2Mod.TransitGatewayConnectPeerId
}
object DeleteTransitGatewayConnectPeerRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteTransitGatewayConnectPeerRequest] (val x: Self) extends AnyVal {
