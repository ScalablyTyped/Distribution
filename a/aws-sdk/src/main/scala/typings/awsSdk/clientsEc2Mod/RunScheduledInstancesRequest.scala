...
trait RunScheduledInstancesRequest extends StObject {
  ...
  /**
    ...
    */
  var ScheduledInstanceId: typings.awsSdk.clientsEc2Mod.ScheduledInstanceId
}
object RunScheduledInstancesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RunScheduledInstancesRequest] (val x: Self) extends AnyVal {
