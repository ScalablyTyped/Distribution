...
trait DeleteDhcpOptionsRequest extends StObject {
  ...
  /**
    ...
    */
  var DhcpOptionsId: typings.awsSdk.clientsEc2Mod.DhcpOptionsId
...
object DeleteDhcpOptionsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteDhcpOptionsRequest] (val x: Self) extends AnyVal {
