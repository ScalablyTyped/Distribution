...
trait RequestFilterPortRange extends StObject {
...
object RequestFilterPortRange {
  ...
  inline def apply(): RequestFilterPortRange = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RequestFilterPortRange]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: RequestFilterPortRange] (val x: Self) extends AnyVal {
