...
trait UpdateUserRequest extends StObject {
  ...
  /**
    ...
    */
  var AccessString: js.UndefOr[typings.awsSdk.memorydbMod.AccessString] = js.undefined
  
  /**
    * Denotes the user's authentication properties, such as whether it requires a password to authenticate.
    */
  var AuthenticationMode: js.UndefOr[typings.awsSdk.memorydbMod.AuthenticationMode] = js.undefined
