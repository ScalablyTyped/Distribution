...
trait GetReadinessCheckStatusRequest extends StObject {
...
object GetReadinessCheckStatusRequest {
  ...
  inline def apply(ReadinessCheckName: string): GetReadinessCheckStatusRequest = {
  ...
  extension [Self <: GetReadinessCheckStatusRequest](x: Self) {
