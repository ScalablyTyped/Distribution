...
trait AttributeSuggestionsDescribeConfig extends StObject {
...
object AttributeSuggestionsDescribeConfig {
  
  inline def apply(): AttributeSuggestionsDescribeConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AttributeSuggestionsDescribeConfig]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AttributeSuggestionsDescribeConfig] (val x: Self) extends AnyVal {
