...
trait ListThesauriResponse extends StObject {
  ...
  /**
    ...
    */
  var ThesaurusSummaryItems: js.UndefOr[typings.awsSdk.clientsKendraMod.ThesaurusSummaryItems] = js.undefined
}
object ListThesauriResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListThesauriResponse] (val x: Self) extends AnyVal {
