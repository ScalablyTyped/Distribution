...
trait GroupMembers extends StObject {
  ...
  /**
    ...
    */
  var MemberGroups: js.UndefOr[typings.awsSdk.clientsKendraMod.MemberGroups] = js.undefined
  
  /**
    * A list of users that belong to a group. For example, a list of interns all belong to the "Interns" group.
    */
  var MemberUsers: js.UndefOr[typings.awsSdk.clientsKendraMod.MemberUsers] = js.undefined
...
object GroupMembers {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GroupMembers] (val x: Self) extends AnyVal {
