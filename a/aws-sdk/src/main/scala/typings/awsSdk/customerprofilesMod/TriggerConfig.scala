...
trait TriggerConfig extends StObject {
  ...
  /**
    ...
    */
  var TriggerProperties: js.UndefOr[typings.awsSdk.customerprofilesMod.TriggerProperties] = js.undefined
  
  /**
    * Specifies the type of flow trigger. It can be OnDemand, Scheduled, or Event.
    */
  var TriggerType: typings.awsSdk.customerprofilesMod.TriggerType
}
