...
trait GetDomainResponse extends StObject {
  ...
  /**
    ...
    */
  var Stats: js.UndefOr[DomainStats] = js.undefined
...
object GetDomainResponse {
  ...
  inline def apply(CreatedAt: js.Date, DomainName: name, LastUpdatedAt: js.Date): GetDomainResponse = {
  ...
  extension [Self <: GetDomainResponse](x: Self) {
    ...
    inline def setStats(value: DomainStats): Self = StObject.set(x, "Stats", value.asInstanceOf[js.Any])
