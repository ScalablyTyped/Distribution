...
trait PutIntegrationResponse extends StObject {
...
object PutIntegrationResponse {
  ...
  inline def apply(CreatedAt: js.Date, DomainName: name, LastUpdatedAt: js.Date, Uri: string1To255): PutIntegrationResponse = {
