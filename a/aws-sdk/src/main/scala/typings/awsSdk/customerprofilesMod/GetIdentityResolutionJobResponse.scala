...
trait GetIdentityResolutionJobResponse extends StObject {
  ...
  /**
    ...
    */
  var ExportingLocation: js.UndefOr[typings.awsSdk.customerprofilesMod.ExportingLocation] = js.undefined
  ...
  /**
    ...
    */
  var JobStats: js.UndefOr[typings.awsSdk.customerprofilesMod.JobStats] = js.undefined
