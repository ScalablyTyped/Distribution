...
trait AppflowIntegrationWorkflowAttributes extends StObject {
  ...
  /**
    ...
    */
  var ConnectorProfileName: typings.awsSdk.customerprofilesMod.ConnectorProfileName
  ...
  /**
    ...
    */
  var SourceConnectorType: typings.awsSdk.customerprofilesMod.SourceConnectorType
}
