...
trait ScheduledTriggerProperties extends StObject {
  ...
  /**
    ...
    */
  var DataPullMode: js.UndefOr[typings.awsSdk.customerprofilesMod.DataPullMode] = js.undefined
  ...
  /**
    ...
    */
  var ScheduleExpression: typings.awsSdk.customerprofilesMod.ScheduleExpression
  
  /**
    * Specifies the optional offset that is added to the time interval for a schedule-triggered flow.
    */
  var ScheduleOffset: js.UndefOr[typings.awsSdk.customerprofilesMod.ScheduleOffset] = js.undefined
  ...
  /**
    ...
    */
  var Timezone: js.UndefOr[typings.awsSdk.customerprofilesMod.Timezone] = js.undefined
}
