...
trait SourceFlowConfig extends StObject {
  ...
  /**
    ...
    */
  var ConnectorProfileName: js.UndefOr[typings.awsSdk.customerprofilesMod.ConnectorProfileName] = js.undefined
  ...
  /**
    ...
    */
  var IncrementalPullConfig: js.UndefOr[typings.awsSdk.customerprofilesMod.IncrementalPullConfig] = js.undefined
  
  /**
    * Specifies the information that is required to query a particular source connector.
    */
  var SourceConnectorProperties: typings.awsSdk.customerprofilesMod.SourceConnectorProperties
}
