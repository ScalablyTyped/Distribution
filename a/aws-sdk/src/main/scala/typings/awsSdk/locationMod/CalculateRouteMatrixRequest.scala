...
trait CalculateRouteMatrixRequest extends StObject {
  ...
  /**
    ...
    */
  var DistanceUnit: js.UndefOr[typings.awsSdk.locationMod.DistanceUnit] = js.undefined
  ...
  /**
    ...
    */
  var TravelMode: js.UndefOr[typings.awsSdk.locationMod.TravelMode] = js.undefined
...
object CalculateRouteMatrixRequest {
  ...
  extension [Self <: CalculateRouteMatrixRequest](x: Self) {
