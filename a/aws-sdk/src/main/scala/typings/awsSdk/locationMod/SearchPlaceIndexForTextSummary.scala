...
trait SearchPlaceIndexForTextSummary extends StObject {
  ...
  /**
    ...
    */
  var ResultBBox: js.UndefOr[BoundingBox] = js.undefined
...
object SearchPlaceIndexForTextSummary {
  ...
  inline def apply(DataSource: String, Text: SensitiveString): SearchPlaceIndexForTextSummary = {
  ...
  extension [Self <: SearchPlaceIndexForTextSummary](x: Self) {
    ...
    inline def setResultBBox(value: BoundingBox): Self = StObject.set(x, "ResultBBox", value.asInstanceOf[js.Any])
    
    inline def setResultBBoxUndefined: Self = StObject.set(x, "ResultBBox", js.undefined)
    
    inline def setResultBBoxVarargs(value: Double*): Self = StObject.set(x, "ResultBBox", js.Array(value*))
