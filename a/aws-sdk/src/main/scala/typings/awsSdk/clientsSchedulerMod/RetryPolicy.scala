...
trait RetryPolicy extends StObject {
  ...
  /**
    ...
    */
  var MaximumEventAgeInSeconds: js.UndefOr[typings.awsSdk.clientsSchedulerMod.MaximumEventAgeInSeconds] = js.undefined
  
  /**
    * The maximum number of retry attempts to make before the request fails. Retry attempts with exponential backoff continue until either the maximum number of attempts is made or until the duration of the MaximumEventAgeInSeconds is reached.
    */
  var MaximumRetryAttempts: js.UndefOr[typings.awsSdk.clientsSchedulerMod.MaximumRetryAttempts] = js.undefined
}
object RetryPolicy {
