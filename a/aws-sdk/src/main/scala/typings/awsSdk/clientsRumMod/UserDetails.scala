...
trait UserDetails extends StObject {
  ...
  /**
    ...
    */
  var sessionId: js.UndefOr[UserDetailsSessionIdString] = js.undefined
  ...
  /**
    ...
    */
  var userId: js.UndefOr[UserDetailsUserIdString] = js.undefined
}
object UserDetails {
  ...
  implicit open class MutableBuilder[Self <: UserDetails] (val x: Self) extends AnyVal {
    ...
    inline def setSessionId(value: UserDetailsSessionIdString): Self = StObject.set(x, "sessionId", value.asInstanceOf[js.Any])
    
    inline def setSessionIdUndefined: Self = StObject.set(x, "sessionId", js.undefined)
    
    inline def setUserId(value: UserDetailsUserIdString): Self = StObject.set(x, "userId", value.asInstanceOf[js.Any])
