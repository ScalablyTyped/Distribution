...
trait UpdateDevEnvironmentResponse extends StObject {
  
  /**
    * The user-specified alias for the Dev Environment.
    */
  var alias: js.UndefOr[UpdateDevEnvironmentResponseAliasString] = js.undefined
...
object UpdateDevEnvironmentResponse {
  ...
  inline def apply(id: Uuid, projectName: NameString, spaceName: NameString): UpdateDevEnvironmentResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateDevEnvironmentResponse] (val x: Self) extends AnyVal {
    
    inline def setAlias(value: UpdateDevEnvironmentResponseAliasString): Self = StObject.set(x, "alias", value.asInstanceOf[js.Any])
