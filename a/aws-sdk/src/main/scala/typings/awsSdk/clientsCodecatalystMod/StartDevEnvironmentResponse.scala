...
trait StartDevEnvironmentResponse extends StObject {
...
object StartDevEnvironmentResponse {
  ...
  inline def apply(id: Uuid, projectName: NameString, spaceName: NameString, status: DevEnvironmentStatus): StartDevEnvironmentResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StartDevEnvironmentResponse] (val x: Self) extends AnyVal {
