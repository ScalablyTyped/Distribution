...
trait StopDevEnvironmentRequest extends StObject {
...
object StopDevEnvironmentRequest {
  ...
  inline def apply(id: Uuid, projectName: NameString, spaceName: NameString): StopDevEnvironmentRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StopDevEnvironmentRequest] (val x: Self) extends AnyVal {
