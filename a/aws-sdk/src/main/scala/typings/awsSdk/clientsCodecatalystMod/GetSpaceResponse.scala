...
trait GetSpaceResponse extends StObject {
...
object GetSpaceResponse {
  ...
  inline def apply(name: NameString, regionName: RegionString): GetSpaceResponse = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetSpaceResponse] (val x: Self) extends AnyVal {
