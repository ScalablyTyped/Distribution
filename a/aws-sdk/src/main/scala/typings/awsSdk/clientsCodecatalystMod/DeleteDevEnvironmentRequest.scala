...
trait DeleteDevEnvironmentRequest extends StObject {
...
object DeleteDevEnvironmentRequest {
  ...
  inline def apply(id: Uuid, projectName: NameString, spaceName: NameString): DeleteDevEnvironmentRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteDevEnvironmentRequest] (val x: Self) extends AnyVal {
