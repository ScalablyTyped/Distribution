...
trait DevEnvironmentRepositorySummary extends StObject {
...
object DevEnvironmentRepositorySummary {
  ...
  inline def apply(repositoryName: SourceRepositoryNameString): DevEnvironmentRepositorySummary = {
    val __obj = js.Dynamic.literal(repositoryName = repositoryName.asInstanceOf[js.Any])
    __obj.asInstanceOf[DevEnvironmentRepositorySummary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DevEnvironmentRepositorySummary] (val x: Self) extends AnyVal {
