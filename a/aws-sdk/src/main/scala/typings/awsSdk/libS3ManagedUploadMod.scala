...
import typings.awsSdk.clientsS3Mod.Tag
import typings.awsSdk.libErrorMod.AWSError
import typings.awsSdk.libS3ManagedUploadMod.ManagedUpload.ManagedUploadOptions
import typings.awsSdk.libS3ManagedUploadMod.ManagedUpload.Progress
  ...
  object ManagedUpload {
    ...
    trait ManagedUploadOptions extends StObject {
      ...
      /**
        ...
        */
      var service: js.UndefOr[typings.awsSdk.clientsS3Mod.^] = js.undefined
    ...
    object ManagedUploadOptions {
      ...
      implicit open class MutableBuilder[Self <: ManagedUploadOptions] (val x: Self) extends AnyVal {
        ...
        inline def setService(value: typings.awsSdk.clientsS3Mod.^): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
