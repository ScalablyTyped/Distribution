...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
type FailbackLaunchType = _FailbackLaunchType | String
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.awsSdk.awsSdkStrings.FAILED_GETTING_REPLICATION_STATE
  - typings.awsSdk.awsSdkStrings.SNAPSHOTS_FAILURE
  - typings.awsSdk.awsSdkStrings.FAILED_TO_CREATE_SECURITY_GROUP
  - typings.awsSdk.awsSdkStrings.FAILED_TO_LAUNCH_REPLICATION_SERVER
  - typings.awsSdk.awsSdkStrings.FAILED_TO_BOOT_REPLICATION_SERVER
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.awsSdk.awsSdkStrings.FAILBACK_NOT_READY_FOR_LAUNCH
  - typings.awsSdk.awsSdkStrings.FAILBACK_LAUNCH_STATE_NOT_AVAILABLE
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typings.awsSdk.awsSdkStrings.ON_PREMISES
  - typings.awsSdk.awsSdkStrings.AWS
  - java.lang.String
*/
type OriginEnvironment = _OriginEnvironment | String
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.awsSdk.awsSdkStrings.STALLED
  - typings.awsSdk.awsSdkStrings.DISCONNECTED
  - typings.awsSdk.awsSdkStrings.REPLICATION_STATE_NOT_AVAILABLE
  - typings.awsSdk.awsSdkStrings.NOT_STARTED
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  ...
  - java.lang.String
*/
type ReplicationDirection = _ReplicationDirection | String
