...
trait ListParallelDataResponse extends StObject {
  ...
  /**
    ...
    */
  var ParallelDataPropertiesList: js.UndefOr[typings.awsSdk.clientsTranslateMod.ParallelDataPropertiesList] = js.undefined
}
object ListParallelDataResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListParallelDataResponse] (val x: Self) extends AnyVal {
