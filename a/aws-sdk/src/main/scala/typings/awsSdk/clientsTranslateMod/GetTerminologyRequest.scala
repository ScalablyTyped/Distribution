...
trait GetTerminologyRequest extends StObject {
  ...
  /**
    ...
    */
  var TerminologyDataFormat: js.UndefOr[typings.awsSdk.clientsTranslateMod.TerminologyDataFormat] = js.undefined
}
object GetTerminologyRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetTerminologyRequest] (val x: Self) extends AnyVal {
