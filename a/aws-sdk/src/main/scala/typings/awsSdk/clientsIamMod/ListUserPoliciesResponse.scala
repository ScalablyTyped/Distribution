...
object ListUserPoliciesResponse {
  ...
  inline def apply(PolicyNames: policyNameListType): ListUserPoliciesResponse = {
    val __obj = js.Dynamic.literal(PolicyNames = PolicyNames.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListUserPoliciesResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListUserPoliciesResponse] (val x: Self) extends AnyVal {
