...
trait ListMFADevicesRequest extends StObject {
...
object ListMFADevicesRequest {
  ...
  inline def apply(): ListMFADevicesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListMFADevicesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListMFADevicesRequest] (val x: Self) extends AnyVal {
