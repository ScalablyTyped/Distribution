...
trait ListAttachedRolePoliciesRequest extends StObject {
...
object ListAttachedRolePoliciesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAttachedRolePoliciesRequest] (val x: Self) extends AnyVal {
