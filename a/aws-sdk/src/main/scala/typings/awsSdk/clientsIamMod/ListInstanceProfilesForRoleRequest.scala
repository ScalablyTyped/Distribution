...
trait ListInstanceProfilesForRoleRequest extends StObject {
...
object ListInstanceProfilesForRoleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListInstanceProfilesForRoleRequest] (val x: Self) extends AnyVal {
