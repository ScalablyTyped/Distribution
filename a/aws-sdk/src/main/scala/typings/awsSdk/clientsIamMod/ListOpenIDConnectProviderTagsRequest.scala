...
trait ListOpenIDConnectProviderTagsRequest extends StObject {
...
object ListOpenIDConnectProviderTagsRequest {
  ...
  inline def apply(OpenIDConnectProviderArn: arnType): ListOpenIDConnectProviderTagsRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListOpenIDConnectProviderTagsRequest] (val x: Self) extends AnyVal {
