...
trait ListUserPoliciesRequest extends StObject {
...
object ListUserPoliciesRequest {
  ...
  inline def apply(UserName: existingUserNameType): ListUserPoliciesRequest = {
    val __obj = js.Dynamic.literal(UserName = UserName.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListUserPoliciesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListUserPoliciesRequest] (val x: Self) extends AnyVal {
