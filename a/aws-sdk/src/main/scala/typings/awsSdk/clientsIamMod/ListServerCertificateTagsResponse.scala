...
trait ListServerCertificateTagsResponse extends StObject {
...
object ListServerCertificateTagsResponse {
  ...
  inline def apply(Tags: tagListType): ListServerCertificateTagsResponse = {
    val __obj = js.Dynamic.literal(Tags = Tags.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListServerCertificateTagsResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListServerCertificateTagsResponse] (val x: Self) extends AnyVal {
