...
trait MailFromAttributes extends StObject {
  ...
  /**
    ...
    */
  var BehaviorOnMxFailure: typings.awsSdk.pinpointemailMod.BehaviorOnMxFailure
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typings.awsSdk.pinpointemailMod.MailFromDomainStatus
}
