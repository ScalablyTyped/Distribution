...
package object rekognitionMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type BodyPart = typings.awsSdk.rekognitionMod._BodyPart | java.lang.String
  
  type BodyParts = js.Array[typings.awsSdk.rekognitionMod.ProtectiveEquipmentBodyPart]
  ...
  */
  ...
  type EquipmentDetections = js.Array[typings.awsSdk.rekognitionMod.EquipmentDetection]
  ...
  */
  ...
  type ProtectiveEquipmentPersonIds = js.Array[typings.awsSdk.rekognitionMod.UInteger]
  
  type ProtectiveEquipmentPersons = js.Array[typings.awsSdk.rekognitionMod.ProtectiveEquipmentPerson]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ProtectiveEquipmentType = typings.awsSdk.rekognitionMod._ProtectiveEquipmentType | java.lang.String
  
  type ProtectiveEquipmentTypes = js.Array[typings.awsSdk.rekognitionMod.ProtectiveEquipmentType]
