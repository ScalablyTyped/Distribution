...
object RecognizeCelebritiesResponse {
  ...
  extension [Self <: RecognizeCelebritiesResponse](x: Self) {
    ...
    inline def setCelebrityFacesVarargs(value: Celebrity*): Self = StObject.set(x, "CelebrityFaces", js.Array(value :_*))
    ...
    inline def setUnrecognizedFacesVarargs(value: ComparedFace*): Self = StObject.set(x, "UnrecognizedFaces", js.Array(value :_*))
  }
}
