...
trait SystemStatus extends StObject {
  ...
  /**
    ...
    */
  var CPUUtilization: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.CPUUtilization] = js.undefined
  
  /**
    * Load average in the last 1-minute, 5-minute, and 15-minute periods. For more information, see Operating System Metrics.
    */
  var LoadAverage: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.LoadAverage] = js.undefined
}
object SystemStatus {
