...
trait CreateApplicationVersionMessage extends StObject {
  ...
  /**
    ...
    */
  var AutoCreateApplication: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.AutoCreateApplication] = js.undefined
  
  /**
    * Settings for an AWS CodeBuild build.
    */
  var BuildConfiguration: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.BuildConfiguration] = js.undefined
...
object CreateApplicationVersionMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateApplicationVersionMessage] (val x: Self) extends AnyVal {
