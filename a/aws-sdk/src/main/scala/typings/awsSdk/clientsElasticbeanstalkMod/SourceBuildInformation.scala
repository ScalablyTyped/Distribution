...
trait SourceBuildInformation extends StObject {
  ...
  /**
    ...
    */
  var SourceLocation: typings.awsSdk.clientsElasticbeanstalkMod.SourceLocation
  
  /**
    * Location where the repository is stored.    CodeCommit     S3   
    */
  var SourceRepository: typings.awsSdk.clientsElasticbeanstalkMod.SourceRepository
  
  /**
    * The type of repository.    Git     Zip   
    */
  var SourceType: typings.awsSdk.clientsElasticbeanstalkMod.SourceType
}
