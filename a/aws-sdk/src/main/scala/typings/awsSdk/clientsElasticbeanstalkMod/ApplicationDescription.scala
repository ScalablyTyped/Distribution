...
trait ApplicationDescription extends StObject {
  ...
  /**
    ...
    */
  var ApplicationArn: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.ApplicationArn] = js.undefined
...
object ApplicationDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicationDescription] (val x: Self) extends AnyVal {
