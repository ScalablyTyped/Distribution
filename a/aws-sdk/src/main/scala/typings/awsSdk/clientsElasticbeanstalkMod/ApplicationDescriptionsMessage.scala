...
object ApplicationDescriptionsMessage {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ApplicationDescriptionsMessage] (val x: Self) extends AnyVal {
    ...
    inline def setApplicationsVarargs(value: ApplicationDescription*): Self = StObject.set(x, "Applications", js.Array(value*))
  }
}
