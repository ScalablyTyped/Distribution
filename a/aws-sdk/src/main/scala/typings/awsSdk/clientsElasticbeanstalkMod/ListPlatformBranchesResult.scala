...
trait ListPlatformBranchesResult extends StObject {
  ...
  /**
    ...
    */
  var PlatformBranchSummaryList: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.PlatformBranchSummaryList] = js.undefined
}
object ListPlatformBranchesResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListPlatformBranchesResult] (val x: Self) extends AnyVal {
