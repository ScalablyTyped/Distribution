...
trait EnvironmentDescription extends StObject {
  ...
  /**
    ...
    */
  var AbortableOperationInProgress: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.AbortableOperationInProgress] = js.undefined
  ...
  /**
    ...
    */
  var EndpointURL: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.EndpointURL] = js.undefined
  
  /**
    * The environment's Amazon Resource Name (ARN), which can be used in other API requests that require an ARN.
    */
  var EnvironmentArn: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.EnvironmentArn] = js.undefined
  ...
  /**
    ...
    */
  var EnvironmentLinks: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.EnvironmentLinks] = js.undefined
  ...
  /**
    ...
    */
  var OperationsRole: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.OperationsRole] = js.undefined
