...
trait DescribeEnvironmentManagedActionsResult extends StObject {
  ...
  /**
    ...
    */
  var ManagedActions: js.UndefOr[typings.awsSdk.clientsElasticbeanstalkMod.ManagedActions] = js.undefined
}
object DescribeEnvironmentManagedActionsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeEnvironmentManagedActionsResult] (val x: Self) extends AnyVal {
