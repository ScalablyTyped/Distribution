...
trait DeleteResourceInput extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typings.awsSdk.cloudcontrolMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var Identifier: typings.awsSdk.cloudcontrolMod.Identifier
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typings.awsSdk.cloudcontrolMod.RoleArn] = js.undefined
  
  /**
    * The name of the resource type.
    */
  var TypeName: typings.awsSdk.cloudcontrolMod.TypeName
  
  /**
    * For private resource types, the type version to use in this resource operation. If you do not specify a resource version, CloudFormation uses the default version.
    */
  var TypeVersionId: js.UndefOr[typings.awsSdk.cloudcontrolMod.TypeVersionId] = js.undefined
}
object DeleteResourceInput {
  ...
  extension [Self <: DeleteResourceInput](x: Self) {
