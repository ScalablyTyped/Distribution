...
trait ResourceRequestStatusFilter extends StObject {
  ...
  /**
    ...
    */
  var OperationStatuses: js.UndefOr[typings.awsSdk.cloudcontrolMod.OperationStatuses] = js.undefined
  
  /**
    * The operation types to include in the filter.
    */
  var Operations: js.UndefOr[typings.awsSdk.cloudcontrolMod.Operations] = js.undefined
}
