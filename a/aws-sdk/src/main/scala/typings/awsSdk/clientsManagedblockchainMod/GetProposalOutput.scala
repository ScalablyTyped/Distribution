...
trait GetProposalOutput extends StObject {
  ...
  /**
    ...
    */
  var Proposal: js.UndefOr[typings.awsSdk.clientsManagedblockchainMod.Proposal] = js.undefined
}
object GetProposalOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetProposalOutput] (val x: Self) extends AnyVal {
