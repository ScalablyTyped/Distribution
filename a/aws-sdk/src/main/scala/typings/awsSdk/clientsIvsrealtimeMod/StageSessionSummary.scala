...
trait StageSessionSummary extends StObject {
...
object StageSessionSummary {
  ...
  inline def apply(): StageSessionSummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[StageSessionSummary]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: StageSessionSummary] (val x: Self) extends AnyVal {
