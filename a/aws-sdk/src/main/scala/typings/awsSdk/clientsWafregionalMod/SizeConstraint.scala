...
trait SizeConstraint extends StObject {
  ...
  /**
    ...
    */
  var ComparisonOperator: typings.awsSdk.clientsWafregionalMod.ComparisonOperator
  ...
  /**
    ...
    */
  var Size: typings.awsSdk.clientsWafregionalMod.Size
...
object SizeConstraint {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SizeConstraint] (val x: Self) extends AnyVal {
