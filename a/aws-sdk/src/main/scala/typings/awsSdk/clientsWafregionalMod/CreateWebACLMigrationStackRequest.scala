...
trait CreateWebACLMigrationStackRequest extends StObject {
  ...
  /**
    ...
    */
  var IgnoreUnsupportedType: typings.awsSdk.clientsWafregionalMod.IgnoreUnsupportedType
  ...
  /**
    ...
    */
  var S3BucketName: typings.awsSdk.clientsWafregionalMod.S3BucketName
