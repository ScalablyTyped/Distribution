...
trait SqlInjectionMatchTuple extends StObject {
  ...
  /**
    ...
    */
  var FieldToMatch: typings.awsSdk.clientsWafregionalMod.FieldToMatch
  ...
  /**
    ...
    */
  var TextTransformation: typings.awsSdk.clientsWafregionalMod.TextTransformation
}
object SqlInjectionMatchTuple {
  
  inline def apply(FieldToMatch: FieldToMatch, TextTransformation: TextTransformation): SqlInjectionMatchTuple = {
