...
trait AssetDetails extends StObject {
  ...
  /**
    ...
    */
  var ApiGatewayApiAsset: js.UndefOr[typings.awsSdk.dataexchangeMod.ApiGatewayApiAsset] = js.undefined
  
  /**
    * The Amazon Redshift datashare that is the asset.
    */
  var RedshiftDataShareAsset: js.UndefOr[typings.awsSdk.dataexchangeMod.RedshiftDataShareAsset] = js.undefined
