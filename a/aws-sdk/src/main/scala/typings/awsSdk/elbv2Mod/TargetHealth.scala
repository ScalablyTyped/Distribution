...
trait TargetHealth extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typings.awsSdk.elbv2Mod.Description] = js.undefined
...
object TargetHealth {
  ...
  extension [Self <: TargetHealth](x: Self) {
    ...
    inline def setReason(value: TargetHealthReasonEnum): Self = StObject.set(x, "Reason", value.asInstanceOf[js.Any])
    
    inline def setReasonUndefined: Self = StObject.set(x, "Reason", js.undefined)
    
    inline def setState(value: TargetHealthStateEnum): Self = StObject.set(x, "State", value.asInstanceOf[js.Any])
