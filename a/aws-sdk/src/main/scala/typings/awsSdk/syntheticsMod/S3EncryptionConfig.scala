...
trait S3EncryptionConfig extends StObject {
  ...
  /**
    ...
    */
  var EncryptionMode: js.UndefOr[typings.awsSdk.syntheticsMod.EncryptionMode] = js.undefined
  
  /**
    * The ARN of the customer-managed KMS key to use, if you specify SSE-KMS for EncryptionMode 
    */
  var KmsKeyArn: js.UndefOr[typings.awsSdk.syntheticsMod.KmsKeyArn] = js.undefined
}
