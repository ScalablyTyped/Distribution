...
trait WorkflowStep extends StObject {
  ...
  /**
    ...
    */
  var CopyStepDetails: js.UndefOr[typings.awsSdk.transferMod.CopyStepDetails] = js.undefined
  
  /**
    * Details for a step that invokes a lambda function.  Consists of the lambda function name, target, and timeout (in seconds). 
    */
  var CustomStepDetails: js.UndefOr[typings.awsSdk.transferMod.CustomStepDetails] = js.undefined
  
  /**
    * Details for a step that deletes the file.
    */
  var DeleteStepDetails: js.UndefOr[typings.awsSdk.transferMod.DeleteStepDetails] = js.undefined
  
  /**
    * Details for a step that creates one or more tags. You specify one or more tags: each tag contains a key/value pair.
    */
  var TagStepDetails: js.UndefOr[typings.awsSdk.transferMod.TagStepDetails] = js.undefined
