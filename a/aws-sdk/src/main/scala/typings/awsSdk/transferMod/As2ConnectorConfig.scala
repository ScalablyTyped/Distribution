...
trait As2ConnectorConfig extends StObject {
  ...
  /**
    ...
    */
  var MdnResponse: js.UndefOr[typings.awsSdk.transferMod.MdnResponse] = js.undefined
  ...
  /**
    ...
    */
  var MessageSubject: js.UndefOr[typings.awsSdk.transferMod.MessageSubject] = js.undefined
