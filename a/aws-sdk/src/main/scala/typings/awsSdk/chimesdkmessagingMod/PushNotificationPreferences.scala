...
trait PushNotificationPreferences extends StObject {
  ...
  /**
    ...
    */
  var AllowNotifications: typings.awsSdk.chimesdkmessagingMod.AllowNotifications
  
  /**
    * The simple JSON object used to send a subset of a push notification to the requested member.
    */
  var FilterRule: js.UndefOr[typings.awsSdk.chimesdkmessagingMod.FilterRule] = js.undefined
}
