...
trait ChannelMembershipForAppInstanceUserSummary extends StObject {
  ...
  /**
    ...
    */
  var AppInstanceUserMembershipSummary: js.UndefOr[typings.awsSdk.chimesdkmessagingMod.AppInstanceUserMembershipSummary] = js.undefined
  
  /**
    * Returns the channel data for an AppInstance.
    */
  var ChannelSummary: js.UndefOr[typings.awsSdk.chimesdkmessagingMod.ChannelSummary] = js.undefined
}
