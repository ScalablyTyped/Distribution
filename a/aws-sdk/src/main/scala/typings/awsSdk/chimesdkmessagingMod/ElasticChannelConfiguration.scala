...
trait ElasticChannelConfiguration extends StObject {
  ...
  /**
    ...
    */
  var MaximumSubChannels: typings.awsSdk.chimesdkmessagingMod.MaximumSubChannels
  
  /**
    * The minimum allowed percentage of TargetMembershipsPerSubChannel users. Ceil of the calculated value is used in balancing members among SubChannels of the elastic channel.
    */
  var MinimumMembershipPercentage: typings.awsSdk.chimesdkmessagingMod.MinimumMembershipPercentage
  
  /**
    * The maximum number of members allowed in a SubChannel.
    */
  var TargetMembershipsPerSubChannel: typings.awsSdk.chimesdkmessagingMod.TargetMembershipsPerSubChannel
}
