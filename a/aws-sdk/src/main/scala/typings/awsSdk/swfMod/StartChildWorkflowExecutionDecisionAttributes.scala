...
object StartChildWorkflowExecutionDecisionAttributes {
  ...
  inline def apply(workflowId: WorkflowId, workflowType: WorkflowType): StartChildWorkflowExecutionDecisionAttributes = {
  ...
  extension [Self <: StartChildWorkflowExecutionDecisionAttributes](x: Self) {
