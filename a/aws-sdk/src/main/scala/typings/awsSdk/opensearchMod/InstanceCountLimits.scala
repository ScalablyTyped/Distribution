...
trait InstanceCountLimits extends StObject {
  ...
  var MaximumInstanceCount: js.UndefOr[typings.awsSdk.opensearchMod.MaximumInstanceCount] = js.undefined
  
  var MinimumInstanceCount: js.UndefOr[typings.awsSdk.opensearchMod.MinimumInstanceCount] = js.undefined
}
