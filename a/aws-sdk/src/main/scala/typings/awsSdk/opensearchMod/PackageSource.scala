...
trait PackageSource extends StObject {
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[typings.awsSdk.opensearchMod.S3BucketName] = js.undefined
  
  /**
    * Key (file name) of the package.
    */
  var S3Key: js.UndefOr[typings.awsSdk.opensearchMod.S3Key] = js.undefined
}
