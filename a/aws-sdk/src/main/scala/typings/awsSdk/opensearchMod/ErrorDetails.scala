...
trait ErrorDetails extends StObject {
  ...
  var ErrorMessage: js.UndefOr[typings.awsSdk.opensearchMod.ErrorMessage] = js.undefined
  
  var ErrorType: js.UndefOr[typings.awsSdk.opensearchMod.ErrorType] = js.undefined
}
object ErrorDetails {
