...
trait CreateDomainRequest extends StObject {
  ...
  /**
    ...
    */
  var ClusterConfig: js.UndefOr[typings.awsSdk.opensearchMod.ClusterConfig] = js.undefined
  ...
  /**
    ...
    */
  var TagList: js.UndefOr[typings.awsSdk.opensearchMod.TagList] = js.undefined
  
  /**
    * Options to specify the subnets and security groups for a VPC endpoint. For more information, see Launching your Amazon OpenSearch Service domains using a VPC . 
    */
  var VPCOptions: js.UndefOr[typings.awsSdk.opensearchMod.VPCOptions] = js.undefined
}
