...
object TimeRange {
  ...
  extension [Self <: TimeRange](x: Self) {
    ...
    inline def setFromInclusive(value: AttackTimestamp): Self = StObject.set(x, "FromInclusive", value.asInstanceOf[js.Any])
    
    inline def setFromInclusiveUndefined: Self = StObject.set(x, "FromInclusive", js.undefined)
    
    inline def setToExclusive(value: AttackTimestamp): Self = StObject.set(x, "ToExclusive", value.asInstanceOf[js.Any])
