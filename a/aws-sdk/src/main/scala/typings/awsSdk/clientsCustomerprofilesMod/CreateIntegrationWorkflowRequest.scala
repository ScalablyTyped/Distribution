...
trait CreateIntegrationWorkflowRequest extends StObject {
  ...
  /**
    ...
    */
  var IntegrationConfig: typings.awsSdk.clientsCustomerprofilesMod.IntegrationConfig
  ...
  /**
    ...
    */
  var RoleArn: typings.awsSdk.clientsCustomerprofilesMod.RoleArn
...
object CreateIntegrationWorkflowRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateIntegrationWorkflowRequest] (val x: Self) extends AnyVal {
