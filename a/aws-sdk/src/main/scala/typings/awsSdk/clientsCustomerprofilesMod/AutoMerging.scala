...
trait AutoMerging extends StObject {
  ...
  /**
    ...
    */
  var ConflictResolution: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.ConflictResolution] = js.undefined
  
  /**
    * A list of matching attributes that represent matching criteria. If two profiles meet at least one of the requirements in the matching attributes list, they will be merged.
    */
  var Consolidation: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.Consolidation] = js.undefined
...
object AutoMerging {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AutoMerging] (val x: Self) extends AnyVal {
