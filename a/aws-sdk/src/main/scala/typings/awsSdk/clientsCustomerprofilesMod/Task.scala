...
trait Task extends StObject {
  ...
  /**
    ...
    */
  var ConnectorOperator: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.ConnectorOperator] = js.undefined
  
  /**
    * A field in a destination connector, or a field value against which Amazon AppFlow validates a source field.
    */
  var DestinationField: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.DestinationField] = js.undefined
  
  /**
    * The source fields to which a particular task is applied.
    */
  var SourceFields: typings.awsSdk.clientsCustomerprofilesMod.SourceFields
  ...
  /**
    ...
    */
  var TaskType: typings.awsSdk.clientsCustomerprofilesMod.TaskType
}
object Task {
