...
trait S3SourceProperties extends StObject {
  ...
  /**
    ...
    */
  var BucketName: typings.awsSdk.clientsCustomerprofilesMod.BucketName
  
  /**
    * The object key for the Amazon S3 bucket in which the source files are stored.
    */
  var BucketPrefix: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.BucketPrefix] = js.undefined
}
