...
trait ListIdentityResolutionJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var IdentityResolutionJobsList: js.UndefOr[typings.awsSdk.clientsCustomerprofilesMod.IdentityResolutionJobsList] = js.undefined
...
object ListIdentityResolutionJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListIdentityResolutionJobsResponse] (val x: Self) extends AnyVal {
