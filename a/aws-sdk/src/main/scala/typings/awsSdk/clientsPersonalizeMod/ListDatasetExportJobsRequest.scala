...
trait ListDatasetExportJobsRequest extends StObject {
...
object ListDatasetExportJobsRequest {
  
  inline def apply(): ListDatasetExportJobsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListDatasetExportJobsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListDatasetExportJobsRequest] (val x: Self) extends AnyVal {
