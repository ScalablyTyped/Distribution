...
trait GetSampledRequestsResponse extends StObject {
  ...
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typings.awsSdk.wafregionalMod.PopulationSize] = js.undefined
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typings.awsSdk.wafregionalMod.TimeWindow] = js.undefined
}
