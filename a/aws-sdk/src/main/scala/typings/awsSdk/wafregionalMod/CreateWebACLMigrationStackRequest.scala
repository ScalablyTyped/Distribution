...
trait CreateWebACLMigrationStackRequest extends StObject {
  ...
  /**
    ...
    */
  var IgnoreUnsupportedType: typings.awsSdk.wafregionalMod.IgnoreUnsupportedType = js.native
  ...
  /**
    ...
    */
  var S3BucketName: typings.awsSdk.wafregionalMod.S3BucketName = js.native
