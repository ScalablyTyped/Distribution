...
@js.native
trait XssMatchTuple extends StObject {
  
  /**
    * Specifies where in a web request to look for cross-site scripting attacks.
    */
  var FieldToMatch: typings.awsSdk.wafregionalMod.FieldToMatch = js.native
  ...
  /**
    ...
    */
  var TextTransformation: typings.awsSdk.wafregionalMod.TextTransformation = js.native
}
