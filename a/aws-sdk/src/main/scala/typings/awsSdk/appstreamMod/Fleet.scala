...
trait Fleet extends StObject {
  ...
  /**
    ...
    */
  var ComputeCapacityStatus: typings.awsSdk.appstreamMod.ComputeCapacityStatus
  ...
  /**
    * The fleet errors.
    */
  var FleetErrors: js.UndefOr[typings.awsSdk.appstreamMod.FleetErrors] = js.undefined
...
object Fleet {
  ...
  extension [Self <: Fleet](x: Self) {
    ...
    inline def setFleetErrorsVarargs(value: FleetError*): Self = StObject.set(x, "FleetErrors", js.Array(value :_*))
