...
trait GetDASHStreamingSessionURLInput extends StObject {
  ...
  /**
    ...
    */
  var DASHFragmentSelector: js.UndefOr[typings.awsSdk.kinesisvideoarchivedmediaMod.DASHFragmentSelector] = js.undefined
  ...
  /**
    ...
    */
  var Expires: js.UndefOr[typings.awsSdk.kinesisvideoarchivedmediaMod.Expires] = js.undefined
