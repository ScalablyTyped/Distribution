...
trait GetMediaForFragmentListOutput extends StObject {
  ...
  /**
    ...
    */
  var ContentType: js.UndefOr[typings.awsSdk.kinesisvideoarchivedmediaMod.ContentType] = js.undefined
  ...
  /**
    ...
    */
  var Payload: js.UndefOr[typings.awsSdk.kinesisvideoarchivedmediaMod.Payload] = js.undefined
}
