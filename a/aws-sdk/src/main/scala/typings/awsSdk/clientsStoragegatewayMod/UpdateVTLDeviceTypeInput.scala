...
trait UpdateVTLDeviceTypeInput extends StObject {
  ...
  /**
    ...
    */
  var DeviceType: typings.awsSdk.clientsStoragegatewayMod.DeviceType
  
  /**
    * The Amazon Resource Name (ARN) of the medium changer you want to select.
    */
  var VTLDeviceARN: typings.awsSdk.clientsStoragegatewayMod.VTLDeviceARN
}
object UpdateVTLDeviceTypeInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateVTLDeviceTypeInput] (val x: Self) extends AnyVal {
