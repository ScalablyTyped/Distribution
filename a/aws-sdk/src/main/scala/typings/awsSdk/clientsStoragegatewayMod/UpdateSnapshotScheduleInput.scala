...
trait UpdateSnapshotScheduleInput extends StObject {
  ...
  /**
    ...
    */
  var RecurrenceInHours: typings.awsSdk.clientsStoragegatewayMod.RecurrenceInHours
...
object UpdateSnapshotScheduleInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateSnapshotScheduleInput] (val x: Self) extends AnyVal {
