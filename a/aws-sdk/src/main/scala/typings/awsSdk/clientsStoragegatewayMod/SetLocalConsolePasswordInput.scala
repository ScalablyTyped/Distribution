...
trait SetLocalConsolePasswordInput extends StObject {
  ...
  /**
    ...
    */
  var LocalConsolePassword: typings.awsSdk.clientsStoragegatewayMod.LocalConsolePassword
}
object SetLocalConsolePasswordInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SetLocalConsolePasswordInput] (val x: Self) extends AnyVal {
