...
trait ListAutomaticTapeCreationPoliciesOutput extends StObject {
  ...
  /**
    ...
    */
  var AutomaticTapeCreationPolicyInfos: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.AutomaticTapeCreationPolicyInfos] = js.undefined
}
object ListAutomaticTapeCreationPoliciesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAutomaticTapeCreationPoliciesOutput] (val x: Self) extends AnyVal {
