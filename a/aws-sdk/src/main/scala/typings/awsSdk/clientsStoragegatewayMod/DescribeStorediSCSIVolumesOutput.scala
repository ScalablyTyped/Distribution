...
trait DescribeStorediSCSIVolumesOutput extends StObject {
  ...
  /**
    ...
    */
  var StorediSCSIVolumes: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.StorediSCSIVolumes] = js.undefined
}
object DescribeStorediSCSIVolumesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeStorediSCSIVolumesOutput] (val x: Self) extends AnyVal {
