...
trait DescribeMaintenanceStartTimeOutput extends StObject {
  ...
  /**
    ...
    */
  var DayOfMonth: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.DayOfMonth] = js.undefined
  
  /**
    * An ordinal number between 0 and 6 that represents the day of the week, where 0 represents Sunday and 6 represents Saturday. The day of week is in the time zone of the gateway.
    */
  var DayOfWeek: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.DayOfWeek] = js.undefined
  ...
  /**
    ...
    */
  var HourOfDay: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.HourOfDay] = js.undefined
  
  /**
    * The minute component of the maintenance start time represented as mm, where mm is the minute (0 to 59). The minute of the hour is in the time zone of the gateway.
    */
  var MinuteOfHour: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.MinuteOfHour] = js.undefined
