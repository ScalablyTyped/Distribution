...
trait ActivateGatewayInput extends StObject {
  ...
  /**
    ...
    */
  var ActivationKey: typings.awsSdk.clientsStoragegatewayMod.ActivationKey
  
  /**
    * The name you configured for your gateway.
    */
  var GatewayName: typings.awsSdk.clientsStoragegatewayMod.GatewayName
  ...
  /**
    ...
    */
  var GatewayTimezone: typings.awsSdk.clientsStoragegatewayMod.GatewayTimezone
  ...
  /**
    ...
    */
  var MediumChangerType: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.MediumChangerType] = js.undefined
  ...
  /**
    ...
    */
  var TapeDriveType: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.TapeDriveType] = js.undefined
}
object ActivateGatewayInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ActivateGatewayInput] (val x: Self) extends AnyVal {
