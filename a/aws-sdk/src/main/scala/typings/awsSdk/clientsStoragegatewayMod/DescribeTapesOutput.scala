...
trait DescribeTapesOutput extends StObject {
  ...
  /**
    ...
    */
  var Tapes: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.Tapes] = js.undefined
}
object DescribeTapesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeTapesOutput] (val x: Self) extends AnyVal {
