...
trait DescribeSnapshotScheduleOutput extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.Description] = js.undefined
  
  /**
    * The number of hours between snapshots.
    */
  var RecurrenceInHours: js.UndefOr[typings.awsSdk.clientsStoragegatewayMod.RecurrenceInHours] = js.undefined
