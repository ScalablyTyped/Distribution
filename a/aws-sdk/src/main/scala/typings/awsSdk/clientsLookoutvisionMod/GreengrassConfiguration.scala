...
trait GreengrassConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CompilerOptions: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.CompilerOptions] = js.undefined
  
  /**
    *  A description for the AWS IoT Greengrass component. 
    */
  var ComponentDescription: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.ComponentDescription] = js.undefined
  
  /**
    *  A name for the AWS IoT Greengrass component. 
    */
  var ComponentName: typings.awsSdk.clientsLookoutvisionMod.ComponentName
  ...
  /**
    ...
    */
  var TargetDevice: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.TargetDevice] = js.undefined
  
  /**
    * The target platform for the model. If you specify TargetPlatform, you can't specify TargetDevice. 
    */
  var TargetPlatform: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.TargetPlatform] = js.undefined
}
