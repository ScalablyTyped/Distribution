...
trait ModelDescription extends StObject {
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.KmsKeyId] = js.undefined
  ...
  /**
    ...
    */
  var OutputConfig: js.UndefOr[typings.awsSdk.clientsLookoutvisionMod.OutputConfig] = js.undefined
...
object ModelDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ModelDescription] (val x: Self) extends AnyVal {
