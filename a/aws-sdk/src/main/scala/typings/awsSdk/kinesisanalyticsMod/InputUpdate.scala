...
trait InputUpdate extends StObject {
  ...
  /**
    ...
    */
  var InputParallelismUpdate: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.InputParallelismUpdate] = js.undefined
  
  /**
    * Describes updates for an input processing configuration.
    */
  var InputProcessingConfigurationUpdate: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.InputProcessingConfigurationUpdate] = js.undefined
  
  /**
    * Describes the data format on the streaming source, and how record elements on the streaming source map to columns of the in-application stream that is created.
    */
  var InputSchemaUpdate: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.InputSchemaUpdate] = js.undefined
  
  /**
    * If an Amazon Kinesis Firehose delivery stream is the streaming source to be updated, provides an updated stream ARN and IAM role ARN.
    */
  var KinesisFirehoseInputUpdate: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.KinesisFirehoseInputUpdate] = js.undefined
  
  /**
    * If an Amazon Kinesis stream is the streaming source to be updated, provides an updated stream Amazon Resource Name (ARN) and IAM role ARN.
    */
  var KinesisStreamsInputUpdate: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.KinesisStreamsInputUpdate] = js.undefined
