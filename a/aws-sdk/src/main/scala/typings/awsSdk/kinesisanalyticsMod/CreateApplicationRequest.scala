...
trait CreateApplicationRequest extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLoggingOptions: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.CloudWatchLoggingOptions] = js.undefined
  ...
  /**
    ...
    */
  var Inputs: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.Inputs] = js.undefined
  ...
  /**
    ...
    */
  var Outputs: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.Outputs] = js.undefined
  
  /**
    * A list of one or more tags to assign to the application. A tag is a key-value pair that identifies an application. Note that the maximum number of application tags includes system tags. The maximum number of user-defined application tags is 50. For more information, see Using Tagging.
    */
  var Tags: js.UndefOr[typings.awsSdk.kinesisanalyticsMod.Tags] = js.undefined
}
