...
trait Connection extends StObject {
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typings.awsSdk.networkmanagerMod.ConnectionArn] = js.undefined
  
  /**
    * The ID of the connection.
    */
  var ConnectionId: js.UndefOr[typings.awsSdk.networkmanagerMod.ConnectionId] = js.undefined
