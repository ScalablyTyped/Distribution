...
trait OrganizationStatus extends StObject {
  ...
  /**
    ...
    */
  var AccountStatusList: js.UndefOr[typings.awsSdk.networkmanagerMod.AccountStatusList] = js.undefined
  
  /**
    * The status of the organization's AWS service access. This will be ENABLED or DISABLED.
    */
  var OrganizationAwsServiceAccessStatus: js.UndefOr[typings.awsSdk.networkmanagerMod.OrganizationAwsServiceAccessStatus] = js.undefined
  
  /**
    * The ID of an Amazon Web Services Organization.
    */
  var OrganizationId: js.UndefOr[typings.awsSdk.networkmanagerMod.OrganizationId] = js.undefined
...
object OrganizationStatus {
  ...
  extension [Self <: OrganizationStatus](x: Self) {
