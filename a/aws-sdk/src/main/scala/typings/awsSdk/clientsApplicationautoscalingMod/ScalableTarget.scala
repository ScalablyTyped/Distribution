...
trait ScalableTarget extends StObject {
  ...
  var SuspendedState: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.SuspendedState] = js.undefined
}
object ScalableTarget {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ScalableTarget] (val x: Self) extends AnyVal {
