...
trait PutScalingPolicyRequest extends StObject {
  ...
  /**
    ...
    */
  var PolicyType: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.PolicyType] = js.undefined
...
object PutScalingPolicyRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutScalingPolicyRequest] (val x: Self) extends AnyVal {
