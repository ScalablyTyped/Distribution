...
trait StepScalingPolicyConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AdjustmentType: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.AdjustmentType] = js.undefined
  ...
  /**
    ...
    */
  var Cooldown: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.Cooldown] = js.undefined
  
  /**
    * The aggregation type for the CloudWatch metrics. Valid values are Minimum, Maximum, and Average. If the aggregation type is null, the value is treated as Average.
    */
  var MetricAggregationType: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.MetricAggregationType] = js.undefined
  
  /**
    * The minimum value to scale by when the adjustment type is PercentChangeInCapacity. For example, suppose that you create a step scaling policy to scale out an Amazon ECS service by 25 percent and you specify a MinAdjustmentMagnitude of 2. If the service has 4 tasks and the scaling policy is performed, 25 percent of 4 is 1. However, because you specified a MinAdjustmentMagnitude of 2, Application Auto Scaling scales out the service by 2 tasks.
    */
  var MinAdjustmentMagnitude: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.MinAdjustmentMagnitude] = js.undefined
  ...
  /**
    ...
    */
  var StepAdjustments: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.StepAdjustments] = js.undefined
}
object StepScalingPolicyConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StepScalingPolicyConfiguration] (val x: Self) extends AnyVal {
