...
trait ScalingPolicy extends StObject {
  ...
  /**
    ...
    */
  var Alarms: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.Alarms] = js.undefined
  ...
  /**
    ...
    */
  var PolicyName: typings.awsSdk.clientsApplicationautoscalingMod.PolicyName
  
  /**
    * The scaling policy type.
    */
  var PolicyType: typings.awsSdk.clientsApplicationautoscalingMod.PolicyType
  ...
  /**
    ...
    */
  var ScalableDimension: typings.awsSdk.clientsApplicationautoscalingMod.ScalableDimension
  ...
  /**
    ...
    */
  var StepScalingPolicyConfiguration: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.StepScalingPolicyConfiguration] = js.undefined
  
  /**
    * A target tracking scaling policy.
    */
  var TargetTrackingScalingPolicyConfiguration: js.UndefOr[
    typings.awsSdk.clientsApplicationautoscalingMod.TargetTrackingScalingPolicyConfiguration
  ] = js.undefined
}
