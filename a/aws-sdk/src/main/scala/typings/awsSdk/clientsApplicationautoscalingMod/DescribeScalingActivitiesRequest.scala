...
trait DescribeScalingActivitiesRequest extends StObject {
  ...
  /**
    ...
    */
  var IncludeNotScaledActivities: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.IncludeNotScaledActivities] = js.undefined
...
object DescribeScalingActivitiesRequest {
  ...
  implicit open class MutableBuilder[Self <: DescribeScalingActivitiesRequest] (val x: Self) extends AnyVal {
    ...
    inline def setIncludeNotScaledActivities(value: IncludeNotScaledActivities): Self = StObject.set(x, "IncludeNotScaledActivities", value.asInstanceOf[js.Any])
    
    inline def setIncludeNotScaledActivitiesUndefined: Self = StObject.set(x, "IncludeNotScaledActivities", js.undefined)
