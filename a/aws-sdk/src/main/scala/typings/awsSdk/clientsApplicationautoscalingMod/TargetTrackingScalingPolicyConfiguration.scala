...
object TargetTrackingScalingPolicyConfiguration {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetTrackingScalingPolicyConfiguration] (val x: Self) extends AnyVal {
