...
trait ScheduledAction extends StObject {
  ...
  /**
    ...
    */
  var ScalableTargetAction: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.ScalableTargetAction] = js.undefined
  ...
  /**
    ...
    */
  var ScheduledActionName: typings.awsSdk.clientsApplicationautoscalingMod.ScheduledActionName
...
object ScheduledAction {
  ...
  implicit open class MutableBuilder[Self <: ScheduledAction] (val x: Self) extends AnyVal {
    ...
    inline def setScheduledActionARN(value: ResourceIdMaxLen1600): Self = StObject.set(x, "ScheduledActionARN", value.asInstanceOf[js.Any])
