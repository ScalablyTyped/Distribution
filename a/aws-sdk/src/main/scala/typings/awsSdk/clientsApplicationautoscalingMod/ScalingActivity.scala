...
trait ScalingActivity extends StObject {
  ...
  /**
    ...
    */
  var NotScaledReasons: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.NotScaledReasons] = js.undefined
...
object ScalingActivity {
  ...
  implicit open class MutableBuilder[Self <: ScalingActivity] (val x: Self) extends AnyVal {
    ...
    inline def setNotScaledReasons(value: NotScaledReasons): Self = StObject.set(x, "NotScaledReasons", value.asInstanceOf[js.Any])
    
    inline def setNotScaledReasonsUndefined: Self = StObject.set(x, "NotScaledReasons", js.undefined)
    
    inline def setNotScaledReasonsVarargs(value: NotScaledReason*): Self = StObject.set(x, "NotScaledReasons", js.Array(value*))
