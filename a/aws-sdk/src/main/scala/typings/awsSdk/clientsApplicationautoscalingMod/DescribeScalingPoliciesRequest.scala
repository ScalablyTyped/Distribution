...
trait DescribeScalingPoliciesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.MaxResults] = js.undefined
  ...
  /**
    ...
    */
  var ScalableDimension: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.ScalableDimension] = js.undefined
  
  /**
    * The namespace of the Amazon Web Services service that provides the resource. For a resource provided by your own application or service, use custom-resource instead.
    */
  var ServiceNamespace: typings.awsSdk.clientsApplicationautoscalingMod.ServiceNamespace
}
object DescribeScalingPoliciesRequest {
  
  inline def apply(ServiceNamespace: ServiceNamespace): DescribeScalingPoliciesRequest = {
  ...
  implicit open class MutableBuilder[Self <: DescribeScalingPoliciesRequest] (val x: Self) extends AnyVal {
    ...
    inline def setPolicyNames(value: ResourceIdsMaxLen1600): Self = StObject.set(x, "PolicyNames", value.asInstanceOf[js.Any])
    
    inline def setPolicyNamesUndefined: Self = StObject.set(x, "PolicyNames", js.undefined)
    
    inline def setPolicyNamesVarargs(value: ResourceIdMaxLen1600*): Self = StObject.set(x, "PolicyNames", js.Array(value*))
