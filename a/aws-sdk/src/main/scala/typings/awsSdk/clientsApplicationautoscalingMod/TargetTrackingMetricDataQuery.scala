...
trait TargetTrackingMetricDataQuery extends StObject {
  ...
  /**
    ...
    */
  var Expression: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.Expression] = js.undefined
  
  /**
    * A short name that identifies the object's results in the response. This name must be unique among all MetricDataQuery objects specified for a single scaling policy. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscores. The first character must be a lowercase letter. 
    */
  var Id: typings.awsSdk.clientsApplicationautoscalingMod.Id
  
  /**
    * A human-readable label for this metric or expression. This is especially useful if this is a math expression, so that you know what the value represents.
    */
  var Label: js.UndefOr[XmlString] = js.undefined
  ...
  /**
    ...
    */
  var MetricStat: js.UndefOr[TargetTrackingMetricStat] = js.undefined
  ...
  /**
    ...
    */
  var ReturnData: js.UndefOr[typings.awsSdk.clientsApplicationautoscalingMod.ReturnData] = js.undefined
}
object TargetTrackingMetricDataQuery {
  
  inline def apply(Id: Id): TargetTrackingMetricDataQuery = {
    val __obj = js.Dynamic.literal(Id = Id.asInstanceOf[js.Any])
    __obj.asInstanceOf[TargetTrackingMetricDataQuery]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetTrackingMetricDataQuery] (val x: Self) extends AnyVal {
    ...
    inline def setLabel(value: XmlString): Self = StObject.set(x, "Label", value.asInstanceOf[js.Any])
    
    inline def setLabelUndefined: Self = StObject.set(x, "Label", js.undefined)
    
    inline def setMetricStat(value: TargetTrackingMetricStat): Self = StObject.set(x, "MetricStat", value.asInstanceOf[js.Any])
