...
trait DescribeAppInstanceAdminResponse extends StObject {
  ...
  /**
    ...
    */
  var AppInstanceAdmin: js.UndefOr[typings.awsSdk.clientsChimesdkidentityMod.AppInstanceAdmin] = js.undefined
}
object DescribeAppInstanceAdminResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAppInstanceAdminResponse] (val x: Self) extends AnyVal {
