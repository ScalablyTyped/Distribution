...
trait GetAppInstanceRetentionSettingsResponse extends StObject {
  ...
  /**
    ...
    */
  var AppInstanceRetentionSettings: js.UndefOr[typings.awsSdk.clientsChimesdkidentityMod.AppInstanceRetentionSettings] = js.undefined
...
object GetAppInstanceRetentionSettingsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetAppInstanceRetentionSettingsResponse] (val x: Self) extends AnyVal {
