...
trait ListAppInstanceBotsRequest extends StObject {
...
object ListAppInstanceBotsRequest {
  
  inline def apply(AppInstanceArn: ChimeArn): ListAppInstanceBotsRequest = {
    val __obj = js.Dynamic.literal(AppInstanceArn = AppInstanceArn.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListAppInstanceBotsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAppInstanceBotsRequest] (val x: Self) extends AnyVal {
