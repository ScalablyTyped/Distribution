...
open class ^ ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var AutoScalingConfigurationSummary: typings.awsSdk.apprunnerMod.AutoScalingConfigurationSummary = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var InstanceConfiguration: typings.awsSdk.apprunnerMod.InstanceConfiguration = js.native
  
  /**
    * Configuration settings related to network traffic of the web application that this service runs.
    */
  /* CompleteClass */
  var NetworkConfiguration: typings.awsSdk.apprunnerMod.NetworkConfiguration = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ServiceId: typings.awsSdk.apprunnerMod.ServiceId = js.native
  
  /**
    * The customer-provided service name.
    */
  /* CompleteClass */
  var ServiceName: typings.awsSdk.apprunnerMod.ServiceName = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var SourceConfiguration: typings.awsSdk.apprunnerMod.SourceConfiguration = js.native
