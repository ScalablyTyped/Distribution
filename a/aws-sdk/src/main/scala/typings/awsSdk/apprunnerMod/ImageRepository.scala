...
trait ImageRepository extends StObject {
  ...
  /**
    ...
    */
  var ImageConfiguration: js.UndefOr[typings.awsSdk.apprunnerMod.ImageConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var ImageIdentifier: typings.awsSdk.apprunnerMod.ImageIdentifier
  
  /**
    * The type of the image repository. This reflects the repository provider and whether the repository is private or public.
    */
  var ImageRepositoryType: typings.awsSdk.apprunnerMod.ImageRepositoryType
}
