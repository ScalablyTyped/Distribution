...
trait ListConnectionsRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectionName: js.UndefOr[typings.awsSdk.apprunnerMod.ConnectionName] = js.undefined
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typings.awsSdk.apprunnerMod.MaxResults] = js.undefined
...
object ListConnectionsRequest {
  ...
  extension [Self <: ListConnectionsRequest](x: Self) {
