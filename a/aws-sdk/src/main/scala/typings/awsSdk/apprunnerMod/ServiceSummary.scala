...
trait ServiceSummary extends StObject {
  ...
  /**
    ...
    */
  var ServiceId: js.UndefOr[typings.awsSdk.apprunnerMod.ServiceId] = js.undefined
  
  /**
    * The customer-provided service name.
    */
  var ServiceName: js.UndefOr[typings.awsSdk.apprunnerMod.ServiceName] = js.undefined
