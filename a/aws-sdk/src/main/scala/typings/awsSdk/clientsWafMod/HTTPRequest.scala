...
trait HTTPRequest extends StObject {
  ...
  /**
    ...
    */
  var Country: js.UndefOr[typings.awsSdk.clientsWafMod.Country] = js.undefined
  
  /**
    * The HTTP version specified in the sampled web request, for example, HTTP/1.1.
    */
  var HTTPVersion: js.UndefOr[typings.awsSdk.clientsWafMod.HTTPVersion] = js.undefined
