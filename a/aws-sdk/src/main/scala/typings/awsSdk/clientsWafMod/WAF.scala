...
@js.native
trait WAF extends Service {
  
  @JSName("config")
  var config_WAF: ConfigBase & ClientConfiguration = js.native
  ...
  /**
    ...
    */
  def createWebACLMigrationStack(): Request[CreateWebACLMigrationStackResponse, AWSError] = js.native
  def createWebACLMigrationStack(callback: js.Function2[/* err */ AWSError, /* data */ CreateWebACLMigrationStackResponse, Unit]): Request[CreateWebACLMigrationStackResponse, AWSError] = js.native
  /**
    * Creates an AWS CloudFormation WAFV2 template for the specified web ACL in the specified Amazon S3 bucket. Then, in CloudFormation, you create a stack from the template, to create the web ACL and its resources in AWS WAFV2. Use this to migrate your AWS WAF Classic web ACL to the latest version of AWS WAF. This is part of a larger migration procedure for web ACLs from AWS WAF Classic to the latest version of AWS WAF. For the full procedure, including caveats and manual steps to complete the migration and switch over to the new web ACL, see Migrating your AWS WAF Classic resources to AWS WAF in the AWS WAF Developer Guide. 
    */
  def createWebACLMigrationStack(params: CreateWebACLMigrationStackRequest): Request[CreateWebACLMigrationStackResponse, AWSError] = js.native
  def createWebACLMigrationStack(
    params: CreateWebACLMigrationStackRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ CreateWebACLMigrationStackResponse, Unit]
  ): Request[CreateWebACLMigrationStackResponse, AWSError] = js.native
