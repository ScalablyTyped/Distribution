...
trait SqlInjectionMatchSet extends StObject {
  ...
  /**
    ...
    */
  var SqlInjectionMatchTuples: typings.awsSdk.clientsWafMod.SqlInjectionMatchTuples
}
object SqlInjectionMatchSet {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SqlInjectionMatchSet] (val x: Self) extends AnyVal {
