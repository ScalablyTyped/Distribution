...
trait ListDeviceEventsRequest extends StObject {
  ...
  /**
    * The maximum number of results to return per request. If not set, a default value of
    100 is used.
    */
  var MaxResults: js.UndefOr[typings.awsSdk.clientsIot1clickdevicesserviceMod.MaxResults] = js.undefined
...
object ListDeviceEventsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListDeviceEventsRequest] (val x: Self) extends AnyVal {
