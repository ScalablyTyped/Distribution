...
trait ResolveCustomerResult extends StObject {
  ...
  /**
    ...
    */
  var CustomerAWSAccountId: js.UndefOr[typings.awsSdk.clientsMarketplacemeteringMod.CustomerAWSAccountId] = js.undefined
  
  /**
    * The CustomerIdentifier is used to identify an individual customer in your application. Calls to BatchMeterUsage require CustomerIdentifiers for each UsageRecord.
    */
  var CustomerIdentifier: js.UndefOr[typings.awsSdk.clientsMarketplacemeteringMod.CustomerIdentifier] = js.undefined
  
  /**
    * The product code is returned to confirm that the buyer is registering for your product. Subsequent BatchMeterUsage calls should be made using this product code.
    */
  var ProductCode: js.UndefOr[typings.awsSdk.clientsMarketplacemeteringMod.ProductCode] = js.undefined
}
object ResolveCustomerResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResolveCustomerResult] (val x: Self) extends AnyVal {
