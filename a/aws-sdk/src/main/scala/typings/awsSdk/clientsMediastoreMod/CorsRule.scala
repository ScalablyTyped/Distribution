...
trait CorsRule extends StObject {
  ...
  /**
    ...
    */
  var AllowedHeaders: typings.awsSdk.clientsMediastoreMod.AllowedHeaders
  ...
  /**
    ...
    */
  var AllowedMethods: js.UndefOr[typings.awsSdk.clientsMediastoreMod.AllowedMethods] = js.undefined
  ...
  /**
    ...
    */
  var AllowedOrigins: typings.awsSdk.clientsMediastoreMod.AllowedOrigins
  ...
  /**
    ...
    */
  var ExposeHeaders: js.UndefOr[typings.awsSdk.clientsMediastoreMod.ExposeHeaders] = js.undefined
  ...
  /**
    ...
    */
  var MaxAgeSeconds: js.UndefOr[typings.awsSdk.clientsMediastoreMod.MaxAgeSeconds] = js.undefined
}
object CorsRule {
  ...
  extension [Self <: CorsRule](x: Self) {
    ...
    inline def setAllowedHeadersVarargs(value: Header*): Self = StObject.set(x, "AllowedHeaders", js.Array(value*))
    ...
    inline def setAllowedMethodsVarargs(value: MethodName*): Self = StObject.set(x, "AllowedMethods", js.Array(value*))
    
    inline def setAllowedOrigins(value: AllowedOrigins): Self = StObject.set(x, "AllowedOrigins", value.asInstanceOf[js.Any])
    
    inline def setAllowedOriginsVarargs(value: Origin*): Self = StObject.set(x, "AllowedOrigins", js.Array(value*))
