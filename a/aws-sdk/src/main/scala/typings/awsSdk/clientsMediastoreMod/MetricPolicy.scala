...
trait MetricPolicy extends StObject {
  ...
  /**
    ...
    */
  var ContainerLevelMetrics: typings.awsSdk.clientsMediastoreMod.ContainerLevelMetrics
  ...
  /**
    ...
    */
  var MetricPolicyRules: js.UndefOr[typings.awsSdk.clientsMediastoreMod.MetricPolicyRules] = js.undefined
}
object MetricPolicy {
