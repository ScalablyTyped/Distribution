...
trait AlarmHistoryItem extends StObject {
  ...
  /**
    ...
    */
  var AlarmType: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.AlarmType] = js.undefined
  
  /**
    * Data about the alarm, in JSON format.
    */
  var HistoryData: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.HistoryData] = js.undefined
  
  /**
    * The type of alarm history item.
    */
  var HistoryItemType: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.HistoryItemType] = js.undefined
  
  /**
    * A summary of the alarm history, in text format.
    */
  var HistorySummary: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.HistorySummary] = js.undefined
