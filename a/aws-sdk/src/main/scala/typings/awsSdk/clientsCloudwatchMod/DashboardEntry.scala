...
trait DashboardEntry extends StObject {
  ...
  /**
    ...
    */
  var Size: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.Size] = js.undefined
}
object DashboardEntry {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DashboardEntry] (val x: Self) extends AnyVal {
