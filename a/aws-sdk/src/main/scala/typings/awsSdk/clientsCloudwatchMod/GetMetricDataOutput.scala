...
trait GetMetricDataOutput extends StObject {
  ...
  /**
    ...
    */
  var MetricDataResults: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.MetricDataResults] = js.undefined
...
object GetMetricDataOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMetricDataOutput] (val x: Self) extends AnyVal {
