...
trait MetricStat extends StObject {
  ...
  /**
    ...
    */
  var Metric: typings.awsSdk.clientsCloudwatchMod.Metric
  ...
  /**
    ...
    */
  var Stat: typings.awsSdk.clientsCloudwatchMod.Stat
...
object MetricStat {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MetricStat] (val x: Self) extends AnyVal {
