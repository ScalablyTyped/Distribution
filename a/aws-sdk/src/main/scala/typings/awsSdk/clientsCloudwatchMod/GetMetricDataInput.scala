...
trait GetMetricDataInput extends StObject {
  ...
  /**
    ...
    */
  var LabelOptions: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.LabelOptions] = js.undefined
  ...
  /**
    ...
    */
  var MetricDataQueries: typings.awsSdk.clientsCloudwatchMod.MetricDataQueries
  ...
  /**
    ...
    */
  var ScanBy: js.UndefOr[typings.awsSdk.clientsCloudwatchMod.ScanBy] = js.undefined
...
object GetMetricDataInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetMetricDataInput] (val x: Self) extends AnyVal {
