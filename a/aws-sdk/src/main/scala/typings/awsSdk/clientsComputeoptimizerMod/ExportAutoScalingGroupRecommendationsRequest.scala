...
trait ExportAutoScalingGroupRecommendationsRequest extends StObject {
  ...
  /**
    ...
    */
  var fieldsToExport: js.UndefOr[ExportableAutoScalingGroupFields] = js.undefined
...
object ExportAutoScalingGroupRecommendationsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ExportAutoScalingGroupRecommendationsRequest] (val x: Self) extends AnyVal {
    ...
    inline def setFieldsToExportVarargs(value: ExportableAutoScalingGroupField*): Self = StObject.set(x, "fieldsToExport", js.Array(value*))
