...
trait StartTransactionRequest extends StObject {
  ...
  /**
    ...
    */
  var TransactionType: js.UndefOr[typings.awsSdk.clientsLakeformationMod.TransactionType] = js.undefined
}
object StartTransactionRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: StartTransactionRequest] (val x: Self) extends AnyVal {
