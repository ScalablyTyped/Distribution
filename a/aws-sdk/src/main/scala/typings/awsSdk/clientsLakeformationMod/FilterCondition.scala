...
trait FilterCondition extends StObject {
  ...
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typings.awsSdk.clientsLakeformationMod.ComparisonOperator] = js.undefined
  ...
  /**
    ...
    */
  var StringValueList: js.UndefOr[typings.awsSdk.clientsLakeformationMod.StringValueList] = js.undefined
}
