...
trait TableResource extends StObject {
  ...
  /**
    ...
    */
  var TableWildcard: js.UndefOr[typings.awsSdk.clientsLakeformationMod.TableWildcard] = js.undefined
}
object TableResource {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: TableResource] (val x: Self) extends AnyVal {
