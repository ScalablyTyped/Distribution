...
trait PutDataLakeSettingsRequest extends StObject {
  ...
  /**
    ...
    */
  var DataLakeSettings: typings.awsSdk.clientsLakeformationMod.DataLakeSettings
}
object PutDataLakeSettingsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutDataLakeSettingsRequest] (val x: Self) extends AnyVal {
