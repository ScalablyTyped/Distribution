...
object ListQualificationTypesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListQualificationTypesResponse] (val x: Self) extends AnyVal {
    ...
    inline def setQualificationTypesVarargs(value: QualificationType*): Self = StObject.set(x, "QualificationTypes", js.Array(value*))
  }
}
