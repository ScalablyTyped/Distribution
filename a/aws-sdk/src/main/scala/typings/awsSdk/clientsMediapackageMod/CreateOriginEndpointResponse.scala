...
trait CreateOriginEndpointResponse extends StObject {
...
object CreateOriginEndpointResponse {
  ...
  inline def apply(): CreateOriginEndpointResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateOriginEndpointResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateOriginEndpointResponse] (val x: Self) extends AnyVal {
