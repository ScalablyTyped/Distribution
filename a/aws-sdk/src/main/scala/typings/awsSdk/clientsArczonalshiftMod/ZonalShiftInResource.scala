...
trait ZonalShiftInResource extends StObject {
...
object ZonalShiftInResource {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(appliedStatus = appliedStatus.asInstanceOf[js.Any], awayFrom = awayFrom.asInstanceOf[js.Any], comment = comment.asInstanceOf[js.Any], expiryTime = expiryTime.asInstanceOf[js.Any], resourceIdentifier = resourceIdentifier.asInstanceOf[js.Any], startTime = startTime.asInstanceOf[js.Any], zonalShiftId = zonalShiftId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ZonalShiftInResource]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ZonalShiftInResource] (val x: Self) extends AnyVal {
    
    inline def setAppliedStatus(value: AppliedStatus): Self = StObject.set(x, "appliedStatus", value.asInstanceOf[js.Any])
