...
trait ScheduledQueryRunSummary extends StObject {
  ...
  /**
    ...
    */
  var ErrorReportLocation: js.UndefOr[typings.awsSdk.timestreamqueryMod.ErrorReportLocation] = js.undefined
  
  /**
    * Runtime statistics for a scheduled run.
    */
  var ExecutionStats: js.UndefOr[typings.awsSdk.timestreamqueryMod.ExecutionStats] = js.undefined
