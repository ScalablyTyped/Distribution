...
object GetIntentsRequest {
  ...
  inline def apply(): GetIntentsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetIntentsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetIntentsRequest] (val x: Self) extends AnyVal {
    
    inline def setMaxResults(value: MaxResults): Self = StObject.set(x, "maxResults", value.asInstanceOf[js.Any])
    
    inline def setMaxResultsUndefined: Self = StObject.set(x, "maxResults", js.undefined)
    
    inline def setNameContains(value: IntentName): Self = StObject.set(x, "nameContains", value.asInstanceOf[js.Any])
