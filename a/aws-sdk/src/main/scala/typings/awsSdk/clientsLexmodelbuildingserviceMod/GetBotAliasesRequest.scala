...
object GetBotAliasesRequest {
  ...
  inline def apply(botName: BotName): GetBotAliasesRequest = {
    val __obj = js.Dynamic.literal(botName = botName.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetBotAliasesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBotAliasesRequest] (val x: Self) extends AnyVal {
    ...
    inline def setNameContains(value: AliasName): Self = StObject.set(x, "nameContains", value.asInstanceOf[js.Any])
