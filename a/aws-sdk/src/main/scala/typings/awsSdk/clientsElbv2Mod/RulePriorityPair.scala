...
trait RulePriorityPair extends StObject {
  ...
  /**
    ...
    */
  var RuleArn: js.UndefOr[typings.awsSdk.clientsElbv2Mod.RuleArn] = js.undefined
}
object RulePriorityPair {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RulePriorityPair] (val x: Self) extends AnyVal {
