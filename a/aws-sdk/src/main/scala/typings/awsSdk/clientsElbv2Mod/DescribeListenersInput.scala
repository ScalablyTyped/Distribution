...
trait DescribeListenersInput extends StObject {
  ...
  /**
    ...
    */
  var ListenerArns: js.UndefOr[typings.awsSdk.clientsElbv2Mod.ListenerArns] = js.undefined
...
object DescribeListenersInput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeListenersInput] (val x: Self) extends AnyVal {
