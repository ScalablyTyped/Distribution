...
trait DescribeSSLPoliciesOutput extends StObject {
  ...
  /**
    ...
    */
  var SslPolicies: js.UndefOr[typings.awsSdk.clientsElbv2Mod.SslPolicies] = js.undefined
}
object DescribeSSLPoliciesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeSSLPoliciesOutput] (val x: Self) extends AnyVal {
