...
trait DescribeConditionalForwardersRequest extends StObject {
  ...
  /**
    ...
    */
  var RemoteDomainNames: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.RemoteDomainNames] = js.undefined
}
object DescribeConditionalForwardersRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeConditionalForwardersRequest] (val x: Self) extends AnyVal {
