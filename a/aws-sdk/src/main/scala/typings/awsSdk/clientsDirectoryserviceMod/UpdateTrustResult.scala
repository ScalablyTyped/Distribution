...
trait UpdateTrustResult extends StObject {
  ...
  var RequestId: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.RequestId] = js.undefined
...
object UpdateTrustResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateTrustResult] (val x: Self) extends AnyVal {
