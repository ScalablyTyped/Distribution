...
trait ListSchemaExtensionsResult extends StObject {
  ...
  /**
    ...
    */
  var SchemaExtensionsInfo: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.SchemaExtensionsInfo] = js.undefined
}
object ListSchemaExtensionsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSchemaExtensionsResult] (val x: Self) extends AnyVal {
