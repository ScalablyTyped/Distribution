...
trait ListCertificatesResult extends StObject {
  ...
  /**
    ...
    */
  var CertificatesInfo: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.CertificatesInfo] = js.undefined
...
object ListCertificatesResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListCertificatesResult] (val x: Self) extends AnyVal {
