...
trait CreateTrustRequest extends StObject {
  ...
  /**
    ...
    */
  var TrustDirection: typings.awsSdk.clientsDirectoryserviceMod.TrustDirection
  
  /**
    * The trust password. The must be the same password that was used when creating the trust relationship on the external domain.
    */
  var TrustPassword: typings.awsSdk.clientsDirectoryserviceMod.TrustPassword
  
  /**
    * The trust relationship type. Forest is the default.
    */
  var TrustType: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.TrustType] = js.undefined
}
