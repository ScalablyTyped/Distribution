...
trait DescribeDomainControllersRequest extends StObject {
  ...
  /**
    ...
    */
  var DomainControllerIds: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.DomainControllerIds] = js.undefined
...
object DescribeDomainControllersRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeDomainControllersRequest] (val x: Self) extends AnyVal {
