...
trait RegionsInfo extends StObject {
  ...
  /**
    ...
    */
  var AdditionalRegions: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.AdditionalRegions] = js.undefined
...
object RegionsInfo {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RegionsInfo] (val x: Self) extends AnyVal {
