...
trait AddIpRoutesRequest extends StObject {
  ...
  /**
    ...
    */
  var IpRoutes: typings.awsSdk.clientsDirectoryserviceMod.IpRoutes
  ...
  var UpdateSecurityGroupForDirectoryControllers: js.UndefOr[
    typings.awsSdk.clientsDirectoryserviceMod.UpdateSecurityGroupForDirectoryControllers
  ] = js.undefined
}
object AddIpRoutesRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AddIpRoutesRequest] (val x: Self) extends AnyVal {
