...
trait ShareDirectoryRequest extends StObject {
  ...
  /**
    ...
    */
  var ShareMethod: typings.awsSdk.clientsDirectoryserviceMod.ShareMethod
  ...
  /**
    ...
    */
  var ShareTarget: typings.awsSdk.clientsDirectoryserviceMod.ShareTarget
}
object ShareDirectoryRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ShareDirectoryRequest] (val x: Self) extends AnyVal {
