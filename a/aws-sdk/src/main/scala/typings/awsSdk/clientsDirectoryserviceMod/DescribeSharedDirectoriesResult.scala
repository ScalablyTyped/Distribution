...
trait DescribeSharedDirectoriesResult extends StObject {
  ...
  /**
    ...
    */
  var SharedDirectories: js.UndefOr[typings.awsSdk.clientsDirectoryserviceMod.SharedDirectories] = js.undefined
}
object DescribeSharedDirectoriesResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeSharedDirectoriesResult] (val x: Self) extends AnyVal {
