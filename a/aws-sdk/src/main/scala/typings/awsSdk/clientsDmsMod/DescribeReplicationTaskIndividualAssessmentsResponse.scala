...
object DescribeReplicationTaskIndividualAssessmentsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeReplicationTaskIndividualAssessmentsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setReplicationTaskIndividualAssessmentsVarargs(value: ReplicationTaskIndividualAssessment*): Self = StObject.set(x, "ReplicationTaskIndividualAssessments", js.Array(value*))
  }
}
