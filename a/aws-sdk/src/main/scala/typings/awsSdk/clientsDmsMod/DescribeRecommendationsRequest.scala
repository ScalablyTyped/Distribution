...
trait DescribeRecommendationsRequest extends StObject {
...
object DescribeRecommendationsRequest {
  
  inline def apply(): DescribeRecommendationsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeRecommendationsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeRecommendationsRequest] (val x: Self) extends AnyVal {
