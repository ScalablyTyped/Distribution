...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typings.awsSdk.clientsDmsMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typings.awsSdk.clientsDmsMod.SourceIdsList] = js.undefined
