...
trait DescribeEventSubscriptionsResponse extends StObject {
  ...
  /**
    ...
    */
  var EventSubscriptionsList: js.UndefOr[typings.awsSdk.clientsDmsMod.EventSubscriptionsList] = js.undefined
...
object DescribeEventSubscriptionsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeEventSubscriptionsResponse] (val x: Self) extends AnyVal {
