...
trait CacheBehavior extends StObject {
  ...
  /**
    ...
    */
  var TrustedKeyGroups: js.UndefOr[typings.awsSdk.cloudfrontMod.TrustedKeyGroups] = js.native
  ...
  /**
    ...
    */
  var TrustedSigners: js.UndefOr[typings.awsSdk.cloudfrontMod.TrustedSigners] = js.native
...
object CacheBehavior {
  ...
  @scala.inline
  def apply(PathPattern: String, TargetOriginId: String, ViewerProtocolPolicy: ViewerProtocolPolicy): CacheBehavior = {
    val __obj = js.Dynamic.literal(PathPattern = PathPattern.asInstanceOf[js.Any], TargetOriginId = TargetOriginId.asInstanceOf[js.Any], ViewerProtocolPolicy = ViewerProtocolPolicy.asInstanceOf[js.Any])
