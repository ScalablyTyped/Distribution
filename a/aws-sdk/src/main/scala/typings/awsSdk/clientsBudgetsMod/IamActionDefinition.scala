...
trait IamActionDefinition extends StObject {
  ...
  /**
    ...
    */
  var Groups: js.UndefOr[typings.awsSdk.clientsBudgetsMod.Groups] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the policy to be attached. 
    */
  var PolicyArn: typings.awsSdk.clientsBudgetsMod.PolicyArn
  
  /**
    * A list of roles to be attached. There must be at least one role. 
    */
  var Roles: js.UndefOr[typings.awsSdk.clientsBudgetsMod.Roles] = js.undefined
  
  /**
    * A list of users to be attached. There must be at least one user. 
    */
  var Users: js.UndefOr[typings.awsSdk.clientsBudgetsMod.Users] = js.undefined
}
