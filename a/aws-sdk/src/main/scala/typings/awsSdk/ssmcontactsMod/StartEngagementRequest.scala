...
trait StartEngagementRequest extends StObject {
  ...
  /**
    ...
    */
  var Content: typings.awsSdk.ssmcontactsMod.Content
  ...
  /**
    ...
    */
  var PublicContent: js.UndefOr[typings.awsSdk.ssmcontactsMod.PublicContent] = js.undefined
  
  /**
    * The insecure subject of the message that was sent to the contact. Use this field for engagements to SMS.
    */
  var PublicSubject: js.UndefOr[typings.awsSdk.ssmcontactsMod.PublicSubject] = js.undefined
  ...
  /**
    ...
    */
  var Subject: typings.awsSdk.ssmcontactsMod.Subject
}
