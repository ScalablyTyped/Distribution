...
trait AcceptPageRequest extends StObject {
  ...
  /**
    ...
    */
  var AcceptCode: typings.awsSdk.ssmcontactsMod.AcceptCode
  ...
  /**
    ...
    */
  var AcceptCodeValidation: js.UndefOr[typings.awsSdk.ssmcontactsMod.AcceptCodeValidation] = js.undefined
  
  /**
    * The type indicates if the page was DELIVERED or READ.
    */
  var AcceptType: typings.awsSdk.ssmcontactsMod.AcceptType
