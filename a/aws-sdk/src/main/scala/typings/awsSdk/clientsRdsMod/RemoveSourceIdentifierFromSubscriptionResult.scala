...
trait RemoveSourceIdentifierFromSubscriptionResult extends StObject {
  ...
  var EventSubscription: js.UndefOr[typings.awsSdk.clientsRdsMod.EventSubscription] = js.undefined
}
object RemoveSourceIdentifierFromSubscriptionResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RemoveSourceIdentifierFromSubscriptionResult] (val x: Self) extends AnyVal {
