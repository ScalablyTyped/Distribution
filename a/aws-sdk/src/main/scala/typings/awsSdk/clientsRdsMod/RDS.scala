...
trait RDS extends Service {
  ...
  /**
    ...
    */
  def createBlueGreenDeployment(): Request[CreateBlueGreenDeploymentResponse, AWSError] = js.native
  def createBlueGreenDeployment(callback: js.Function2[/* err */ AWSError, /* data */ CreateBlueGreenDeploymentResponse, Unit]): Request[CreateBlueGreenDeploymentResponse, AWSError] = js.native
  /**
    * Creates a blue/green deployment. A blue/green deployment creates a staging environment that copies the production environment. In a blue/green deployment, the blue environment is the current production environment. The green environment is the staging environment. The staging environment stays in sync with the current production environment using logical replication. You can make changes to the databases in the green environment without affecting production workloads. For example, you can upgrade the major or minor DB engine version, change database parameters, or make schema changes in the staging environment. You can thoroughly test changes in the green environment. When ready, you can switch over the environments to promote the green environment to be the new production environment. The switchover typically takes under a minute. For more information, see Using Amazon RDS Blue/Green Deployments for database updates in the Amazon RDS User Guide and  Using Amazon RDS Blue/Green Deployments for database updates in the Amazon Aurora User Guide.
    */
  def createBlueGreenDeployment(params: CreateBlueGreenDeploymentRequest): Request[CreateBlueGreenDeploymentResponse, AWSError] = js.native
  def createBlueGreenDeployment(
    params: CreateBlueGreenDeploymentRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ CreateBlueGreenDeploymentResponse, Unit]
  ): Request[CreateBlueGreenDeploymentResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def deleteBlueGreenDeployment(): Request[DeleteBlueGreenDeploymentResponse, AWSError] = js.native
  def deleteBlueGreenDeployment(callback: js.Function2[/* err */ AWSError, /* data */ DeleteBlueGreenDeploymentResponse, Unit]): Request[DeleteBlueGreenDeploymentResponse, AWSError] = js.native
  /**
    * Deletes a blue/green deployment. For more information, see Using Amazon RDS Blue/Green Deployments for database updates in the Amazon RDS User Guide and  Using Amazon RDS Blue/Green Deployments for database updates in the Amazon Aurora User Guide.
    */
  def deleteBlueGreenDeployment(params: DeleteBlueGreenDeploymentRequest): Request[DeleteBlueGreenDeploymentResponse, AWSError] = js.native
  def deleteBlueGreenDeployment(
    params: DeleteBlueGreenDeploymentRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DeleteBlueGreenDeploymentResponse, Unit]
  ): Request[DeleteBlueGreenDeploymentResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def describeBlueGreenDeployments(): Request[DescribeBlueGreenDeploymentsResponse, AWSError] = js.native
  def describeBlueGreenDeployments(callback: js.Function2[/* err */ AWSError, /* data */ DescribeBlueGreenDeploymentsResponse, Unit]): Request[DescribeBlueGreenDeploymentsResponse, AWSError] = js.native
  /**
    * Returns information about blue/green deployments. For more information, see Using Amazon RDS Blue/Green Deployments for database updates in the Amazon RDS User Guide and  Using Amazon RDS Blue/Green Deployments for database updates in the Amazon Aurora User Guide.
    */
  def describeBlueGreenDeployments(params: DescribeBlueGreenDeploymentsRequest): Request[DescribeBlueGreenDeploymentsResponse, AWSError] = js.native
  def describeBlueGreenDeployments(
    params: DescribeBlueGreenDeploymentsRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeBlueGreenDeploymentsResponse, Unit]
  ): Request[DescribeBlueGreenDeploymentsResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def switchoverBlueGreenDeployment(): Request[SwitchoverBlueGreenDeploymentResponse, AWSError] = js.native
  def switchoverBlueGreenDeployment(callback: js.Function2[/* err */ AWSError, /* data */ SwitchoverBlueGreenDeploymentResponse, Unit]): Request[SwitchoverBlueGreenDeploymentResponse, AWSError] = js.native
  /**
    * Switches over a blue/green deployment. Before you switch over, production traffic is routed to the databases in the blue environment. After you switch over, production traffic is routed to the databases in the green environment. For more information, see Using Amazon RDS Blue/Green Deployments for database updates in the Amazon RDS User Guide and  Using Amazon RDS Blue/Green Deployments for database updates in the Amazon Aurora User Guide.
    */
  def switchoverBlueGreenDeployment(params: SwitchoverBlueGreenDeploymentRequest): Request[SwitchoverBlueGreenDeploymentResponse, AWSError] = js.native
  def switchoverBlueGreenDeployment(
    params: SwitchoverBlueGreenDeploymentRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ SwitchoverBlueGreenDeploymentResponse, Unit]
  ): Request[SwitchoverBlueGreenDeploymentResponse, AWSError] = js.native
