...
trait DBProxyTarget extends StObject {
  ...
  /**
    ...
    */
  var TargetHealth: js.UndefOr[typings.awsSdk.clientsRdsMod.TargetHealth] = js.undefined
...
object DBProxyTarget {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DBProxyTarget] (val x: Self) extends AnyVal {
