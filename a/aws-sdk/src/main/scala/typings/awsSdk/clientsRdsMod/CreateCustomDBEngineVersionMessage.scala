...
trait CreateCustomDBEngineVersionMessage extends StObject {
  ...
  /**
    ...
    */
  var DatabaseInstallationFilesS3BucketName: js.UndefOr[BucketName] = js.undefined
  ...
  /**
    ...
    */
  var ImageId: js.UndefOr[String255] = js.undefined
  ...
  /**
    ...
    */
  var KMSKeyId: js.UndefOr[KmsKeyIdOrArn] = js.undefined
  ...
  /**
    ...
    */
  var Manifest: js.UndefOr[CustomDBEngineVersionManifest] = js.undefined
  
  var Tags: js.UndefOr[TagList] = js.undefined
}
object CreateCustomDBEngineVersionMessage {
  
  inline def apply(Engine: CustomEngineName, EngineVersion: CustomEngineVersion): CreateCustomDBEngineVersionMessage = {
  ...
  implicit open class MutableBuilder[Self <: CreateCustomDBEngineVersionMessage] (val x: Self) extends AnyVal {
    ...
    inline def setImageId(value: String255): Self = StObject.set(x, "ImageId", value.asInstanceOf[js.Any])
