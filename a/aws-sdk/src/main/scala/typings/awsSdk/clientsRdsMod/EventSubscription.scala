...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typings.awsSdk.clientsRdsMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typings.awsSdk.clientsRdsMod.SourceIdsList] = js.undefined
