...
trait OptionGroups extends StObject {
  ...
  /**
    ...
    */
  var OptionGroupsList: js.UndefOr[typings.awsSdk.clientsRdsMod.OptionGroupsList] = js.undefined
}
object OptionGroups {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OptionGroups] (val x: Self) extends AnyVal {
