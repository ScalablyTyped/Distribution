...
object CreateLoggerDefinitionResponse {
  ...
  @scala.inline
  def apply(): CreateLoggerDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateLoggerDefinitionResponse]
  }
  
  @scala.inline
  implicit class CreateLoggerDefinitionResponseMutableBuilder[Self <: CreateLoggerDefinitionResponse] (val x: Self) extends AnyVal {
