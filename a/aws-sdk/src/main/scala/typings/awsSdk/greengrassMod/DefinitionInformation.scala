...
trait DefinitionInformation extends StObject {
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typings.awsSdk.greengrassMod.Tags] = js.undefined
}
object DefinitionInformation {
  
  @scala.inline
  def apply(): DefinitionInformation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DefinitionInformation]
  }
  
  @scala.inline
  implicit class DefinitionInformationMutableBuilder[Self <: DefinitionInformation] (val x: Self) extends AnyVal {
