...
object CreateConnectorDefinitionResponse {
  ...
  @scala.inline
  def apply(): CreateConnectorDefinitionResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateConnectorDefinitionResponse]
  }
  
  @scala.inline
  implicit class CreateConnectorDefinitionResponseMutableBuilder[Self <: CreateConnectorDefinitionResponse] (val x: Self) extends AnyVal {
