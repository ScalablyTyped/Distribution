...
object ListFunctionDefinitionVersionsResponse {
  ...
  @scala.inline
  def apply(): ListFunctionDefinitionVersionsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListFunctionDefinitionVersionsResponse]
  }
  
  @scala.inline
  implicit class ListFunctionDefinitionVersionsResponseMutableBuilder[Self <: ListFunctionDefinitionVersionsResponse] (val x: Self) extends AnyVal {
