...
object CreateCoreDefinitionRequest {
  ...
  @scala.inline
  implicit class CreateCoreDefinitionRequestOps[Self <: CreateCoreDefinitionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialVersion(value: CoreDefinitionVersion): Self = this.set("InitialVersion", value.asInstanceOf[js.Any])
