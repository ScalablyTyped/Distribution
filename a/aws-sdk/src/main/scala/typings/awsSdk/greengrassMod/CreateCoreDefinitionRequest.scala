...
object CreateCoreDefinitionRequest {
  ...
  inline def apply(): CreateCoreDefinitionRequest = {
  ...
  extension [Self <: CreateCoreDefinitionRequest](x: Self) {
    ...
    inline def setInitialVersion(value: CoreDefinitionVersion): Self = StObject.set(x, "InitialVersion", value.asInstanceOf[js.Any])
