...
object CreateLoggerDefinitionRequest {
  ...
  @scala.inline
  implicit class CreateLoggerDefinitionRequestOps[Self <: CreateLoggerDefinitionRequest] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setInitialVersion(value: LoggerDefinitionVersion): Self = this.set("InitialVersion", value.asInstanceOf[js.Any])
    @scala.inline
