...
object CreateLoggerDefinitionRequest {
  ...
  @scala.inline
  def apply(): CreateLoggerDefinitionRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateLoggerDefinitionRequest]
  }
  
  @scala.inline
  implicit class CreateLoggerDefinitionRequestMutableBuilder[Self <: CreateLoggerDefinitionRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setInitialVersion(value: LoggerDefinitionVersion): Self = StObject.set(x, "InitialVersion", value.asInstanceOf[js.Any])
