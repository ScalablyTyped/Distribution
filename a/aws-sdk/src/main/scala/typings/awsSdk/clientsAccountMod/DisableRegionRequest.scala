...
trait DisableRegionRequest extends StObject {
...
object DisableRegionRequest {
  ...
  inline def apply(RegionName: RegionName): DisableRegionRequest = {
    val __obj = js.Dynamic.literal(RegionName = RegionName.asInstanceOf[js.Any])
    __obj.asInstanceOf[DisableRegionRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DisableRegionRequest] (val x: Self) extends AnyVal {
