...
trait SimulatePrincipalPolicyRequest extends js.Object {
  /**
    ...
    */
  var ActionNames: ActionNameListType = js.native
  /**
    ...
    */
  var CallerArn: js.UndefOr[ResourceNameType] = js.native
  /**
    * A list of context keys and corresponding values for the simulation to use. Whenever a context key is evaluated in one of the simulated IAM permissions policies, the corresponding value is supplied.
    */
  var ContextEntries: js.UndefOr[ContextEntryListType] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceArns: js.UndefOr[ResourceNameListType] = js.native
  /**
    ...
    */
  var ResourceHandlingOption: js.UndefOr[ResourceHandlingOptionType] = js.native
  /**
    ...
    */
  var ResourceOwner: js.UndefOr[ResourceNameType] = js.native
  /**
    ...
    */
  var ResourcePolicy: js.UndefOr[policyDocumentType] = js.native
}
