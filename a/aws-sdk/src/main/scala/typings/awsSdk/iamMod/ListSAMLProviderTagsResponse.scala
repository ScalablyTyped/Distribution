...
trait ListSAMLProviderTagsResponse extends StObject {
...
object ListSAMLProviderTagsResponse {
  ...
  inline def apply(Tags: tagListType): ListSAMLProviderTagsResponse = {
    val __obj = js.Dynamic.literal(Tags = Tags.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListSAMLProviderTagsResponse]
  }
  
  extension [Self <: ListSAMLProviderTagsResponse](x: Self) {
