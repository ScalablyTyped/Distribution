...
trait ListInstanceProfilesResponse extends StObject {
...
object ListInstanceProfilesResponse {
  ...
  inline def apply(InstanceProfiles: instanceProfileListType): ListInstanceProfilesResponse = {
  ...
  extension [Self <: ListInstanceProfilesResponse](x: Self) {
