...
trait ListInstanceProfileTagsResponse extends StObject {
...
object ListInstanceProfileTagsResponse {
  ...
  inline def apply(Tags: tagListType): ListInstanceProfileTagsResponse = {
    val __obj = js.Dynamic.literal(Tags = Tags.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListInstanceProfileTagsResponse]
  }
  
  extension [Self <: ListInstanceProfileTagsResponse](x: Self) {
