...
trait GreengrassOutputDetails extends StObject {
  ...
  /**
    ...
    */
  var ComponentName: js.UndefOr[typings.awsSdk.lookoutvisionMod.ComponentName] = js.undefined
  ...
  /**
    ...
    */
  var ComponentVersionArn: js.UndefOr[typings.awsSdk.lookoutvisionMod.ComponentVersionArn] = js.undefined
}
