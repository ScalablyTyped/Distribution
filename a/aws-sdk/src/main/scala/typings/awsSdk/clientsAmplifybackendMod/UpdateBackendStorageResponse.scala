...
trait UpdateBackendStorageResponse extends StObject {
...
object UpdateBackendStorageResponse {
  ...
  inline def apply(): UpdateBackendStorageResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateBackendStorageResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateBackendStorageResponse] (val x: Self) extends AnyVal {
