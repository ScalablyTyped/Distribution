...
trait CreateBackendResponse extends StObject {
...
object CreateBackendResponse {
  ...
  inline def apply(): CreateBackendResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateBackendResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateBackendResponse] (val x: Self) extends AnyVal {
