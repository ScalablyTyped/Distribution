...
trait DeleteBackendAuthResponse extends StObject {
...
object DeleteBackendAuthResponse {
  ...
  inline def apply(): DeleteBackendAuthResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteBackendAuthResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteBackendAuthResponse] (val x: Self) extends AnyVal {
