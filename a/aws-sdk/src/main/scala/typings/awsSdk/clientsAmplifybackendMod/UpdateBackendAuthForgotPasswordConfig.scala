...
trait UpdateBackendAuthForgotPasswordConfig extends StObject {
  ...
  /**
    ...
    */
  var DeliveryMethod: js.UndefOr[typings.awsSdk.clientsAmplifybackendMod.DeliveryMethod] = js.undefined
...
object UpdateBackendAuthForgotPasswordConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateBackendAuthForgotPasswordConfig] (val x: Self) extends AnyVal {
