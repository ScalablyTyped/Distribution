...
trait CreateBackendStorageResponse extends StObject {
...
object CreateBackendStorageResponse {
  ...
  inline def apply(): CreateBackendStorageResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateBackendStorageResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateBackendStorageResponse] (val x: Self) extends AnyVal {
