...
trait CreateFHIRDatastoreRequest extends StObject {
  ...
  /**
    ...
    */
  var PreloadDataConfig: js.UndefOr[typings.awsSdk.healthlakeMod.PreloadDataConfig] = js.undefined
  
  /**
    *  The server-side encryption key configuration for a customer provided encryption key specified for creating a Data Store. 
    */
  var SseConfiguration: js.UndefOr[typings.awsSdk.healthlakeMod.SseConfiguration] = js.undefined
