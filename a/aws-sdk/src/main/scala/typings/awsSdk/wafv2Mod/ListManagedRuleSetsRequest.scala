...
trait ListManagedRuleSetsRequest extends StObject {
...
object ListManagedRuleSetsRequest {
  ...
  inline def apply(Scope: Scope): ListManagedRuleSetsRequest = {
    val __obj = js.Dynamic.literal(Scope = Scope.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListManagedRuleSetsRequest]
  }
  
  extension [Self <: ListManagedRuleSetsRequest](x: Self) {
