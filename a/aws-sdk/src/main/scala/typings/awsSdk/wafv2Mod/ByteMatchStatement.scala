...
trait ByteMatchStatement extends StObject {
  ...
  /**
    ...
    */
  var PositionalConstraint: typings.awsSdk.wafv2Mod.PositionalConstraint
  ...
  /**
    ...
    */
  var SearchString: typings.awsSdk.wafv2Mod.SearchString
...
object ByteMatchStatement {
  ...
  extension [Self <: ByteMatchStatement](x: Self) {
