...
trait ManagedRuleGroupConfig extends StObject {
  ...
  /**
    ...
    */
  var PasswordField: js.UndefOr[typings.awsSdk.wafv2Mod.PasswordField] = js.undefined
  
  /**
    * The payload type for your login endpoint, either JSON or form encoded.
    */
  var PayloadType: js.UndefOr[typings.awsSdk.wafv2Mod.PayloadType] = js.undefined
  
  /**
    * Details about your login page username field. 
    */
  var UsernameField: js.UndefOr[typings.awsSdk.wafv2Mod.UsernameField] = js.undefined
}
