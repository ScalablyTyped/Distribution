...
trait CaptchaResponse extends StObject {
  ...
  /**
    ...
    */
  var FailureReason: js.UndefOr[typings.awsSdk.wafv2Mod.FailureReason] = js.undefined
  ...
  /**
    ...
    */
  var ResponseCode: js.UndefOr[typings.awsSdk.wafv2Mod.ResponseCode] = js.undefined
  
  /**
    * The time that the CAPTCHA puzzle was solved for the supplied token. 
    */
  var SolveTimestamp: js.UndefOr[typings.awsSdk.wafv2Mod.SolveTimestamp] = js.undefined
}
