...
trait DescribeManagedEndpointRequest extends StObject {
...
object DescribeManagedEndpointRequest {
  ...
  inline def apply(id: ResourceIdString, virtualClusterId: ResourceIdString): DescribeManagedEndpointRequest = {
