...
trait DataConfig extends StObject {
  ...
  /**
    ...
    */
  var AdditionalDatasets: js.UndefOr[typings.awsSdk.forecastserviceMod.AdditionalDatasets] = js.undefined
  
  /**
    * Aggregation and filling options for attributes in your dataset group.
    */
  var AttributeConfigs: js.UndefOr[typings.awsSdk.forecastserviceMod.AttributeConfigs] = js.undefined
