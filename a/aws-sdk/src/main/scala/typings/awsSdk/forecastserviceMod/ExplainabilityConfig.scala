...
trait ExplainabilityConfig extends StObject {
  ...
  /**
    ...
    */
  var TimePointGranularity: typings.awsSdk.forecastserviceMod.TimePointGranularity
  ...
  /**
    ...
    */
  var TimeSeriesGranularity: typings.awsSdk.forecastserviceMod.TimeSeriesGranularity
}
