...
trait TimeAlignmentBoundary extends StObject {
  ...
  /**
    ...
    */
  var DayOfMonth: js.UndefOr[typings.awsSdk.forecastserviceMod.DayOfMonth] = js.undefined
  
  /**
    * The day of week to use for time alignment during aggregation. The day must be in uppercase.
    */
  var DayOfWeek: js.UndefOr[typings.awsSdk.forecastserviceMod.DayOfWeek] = js.undefined
  
  /**
    * The hour of day to use for time alignment during aggregation.
    */
  var Hour: js.UndefOr[typings.awsSdk.forecastserviceMod.Hour] = js.undefined
  
  /**
    * The month to use for time alignment during aggregation. The month must be in uppercase.
    */
  var Month: js.UndefOr[typings.awsSdk.forecastserviceMod.Month] = js.undefined
}
