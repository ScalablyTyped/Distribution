...
trait TimeSeriesTransformation extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typings.awsSdk.forecastserviceMod.Action] = js.undefined
  
  /**
    * An array of conditions that define which members of the related time series are transformed.
    */
  var TimeSeriesConditions: js.UndefOr[typings.awsSdk.forecastserviceMod.TimeSeriesConditions] = js.undefined
}
