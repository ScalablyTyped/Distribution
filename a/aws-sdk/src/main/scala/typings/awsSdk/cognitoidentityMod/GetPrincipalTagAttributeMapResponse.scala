...
trait GetPrincipalTagAttributeMapResponse extends StObject {
  ...
  /**
    ...
    */
  var IdentityProviderName: js.UndefOr[typings.awsSdk.cognitoidentityMod.IdentityProviderName] = js.undefined
...
object GetPrincipalTagAttributeMapResponse {
  ...
  extension [Self <: GetPrincipalTagAttributeMapResponse](x: Self) {
