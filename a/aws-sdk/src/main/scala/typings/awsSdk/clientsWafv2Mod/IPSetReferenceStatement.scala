...
trait IPSetReferenceStatement extends StObject {
  ...
  /**
    ...
    */
  var IPSetForwardedIPConfig: js.UndefOr[typings.awsSdk.clientsWafv2Mod.IPSetForwardedIPConfig] = js.undefined
}
object IPSetReferenceStatement {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IPSetReferenceStatement] (val x: Self) extends AnyVal {
