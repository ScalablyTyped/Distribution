...
trait ManagedRuleSet extends StObject {
  ...
  /**
    ...
    */
  var PublishedVersions: js.UndefOr[typings.awsSdk.clientsWafv2Mod.PublishedVersions] = js.undefined
...
object ManagedRuleSet {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ManagedRuleSet] (val x: Self) extends AnyVal {
