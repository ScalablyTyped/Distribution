...
object CreateLoadBalancerTlsCertificateResult {
  ...
  @scala.inline
  def apply(): CreateLoadBalancerTlsCertificateResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateLoadBalancerTlsCertificateResult]
  }
  
  @scala.inline
  implicit class CreateLoadBalancerTlsCertificateResultMutableBuilder[Self <: CreateLoadBalancerTlsCertificateResult] (val x: Self) extends AnyVal {
