...
@js.native
trait SendContactMethodVerificationResult extends StObject {
...
object SendContactMethodVerificationResult {
  ...
  @scala.inline
  def apply(): SendContactMethodVerificationResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SendContactMethodVerificationResult]
  }
  
  @scala.inline
  implicit class SendContactMethodVerificationResultMutableBuilder[Self <: SendContactMethodVerificationResult] (val x: Self) extends AnyVal {
