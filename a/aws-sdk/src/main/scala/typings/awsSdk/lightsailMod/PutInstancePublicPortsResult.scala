...
@js.native
trait PutInstancePublicPortsResult extends StObject {
...
object PutInstancePublicPortsResult {
  ...
  @scala.inline
  def apply(): PutInstancePublicPortsResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PutInstancePublicPortsResult]
  }
  
  @scala.inline
  implicit class PutInstancePublicPortsResultMutableBuilder[Self <: PutInstancePublicPortsResult] (val x: Self) extends AnyVal {
