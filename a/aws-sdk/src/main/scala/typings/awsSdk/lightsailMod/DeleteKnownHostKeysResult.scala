...
@js.native
trait DeleteKnownHostKeysResult extends StObject {
...
object DeleteKnownHostKeysResult {
  ...
  @scala.inline
  implicit class DeleteKnownHostKeysResultMutableBuilder[Self <: DeleteKnownHostKeysResult] (val x: Self) extends AnyVal {
