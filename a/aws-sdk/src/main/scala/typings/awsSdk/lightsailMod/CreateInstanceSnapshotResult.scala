...
object CreateInstanceSnapshotResult {
  ...
  @scala.inline
  def apply(): CreateInstanceSnapshotResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateInstanceSnapshotResult]
  }
  
  @scala.inline
  implicit class CreateInstanceSnapshotResultMutableBuilder[Self <: CreateInstanceSnapshotResult] (val x: Self) extends AnyVal {
