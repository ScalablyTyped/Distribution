...
trait SelectParameters extends StObject {
  ...
  /**
    ...
    */
  var ExpressionType: js.UndefOr[typings.awsSdk.clientsGlacierMod.ExpressionType] = js.undefined
  
  /**
    * Describes the serialization format of the object.
    */
  var InputSerialization: js.UndefOr[typings.awsSdk.clientsGlacierMod.InputSerialization] = js.undefined
  
  /**
    * Describes how the results of the select job are serialized.
    */
  var OutputSerialization: js.UndefOr[typings.awsSdk.clientsGlacierMod.OutputSerialization] = js.undefined
}
