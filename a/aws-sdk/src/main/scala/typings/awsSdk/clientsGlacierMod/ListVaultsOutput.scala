...
trait ListVaultsOutput extends StObject {
  ...
  /**
    * List of vaults.
    */
  var VaultList: js.UndefOr[typings.awsSdk.clientsGlacierMod.VaultList] = js.undefined
}
object ListVaultsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListVaultsOutput] (val x: Self) extends AnyVal {
