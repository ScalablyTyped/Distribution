...
trait EventDestination extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchDestination: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.CloudWatchDestination] = js.undefined
  ...
  /**
    ...
    */
  var Enabled: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.Enabled] = js.undefined
  
  /**
    * An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.
    */
  var KinesisFirehoseDestination: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.KinesisFirehoseDestination] = js.undefined
  ...
  /**
    ...
    */
  var PinpointDestination: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.PinpointDestination] = js.undefined
  
  /**
    * An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
    */
  var SnsDestination: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.SnsDestination] = js.undefined
}
