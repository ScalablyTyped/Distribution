...
trait CreateConfigurationSetRequest extends StObject {
  ...
  /**
    ...
    */
  var DeliveryOptions: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.DeliveryOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.ReputationOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.SendingOptions] = js.undefined
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.TrackingOptions] = js.undefined
}
