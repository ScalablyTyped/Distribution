...
trait MailFromAttributes extends StObject {
  ...
  /**
    ...
    */
  var BehaviorOnMxFailure: typings.awsSdk.clientsPinpointemailMod.BehaviorOnMxFailure
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typings.awsSdk.clientsPinpointemailMod.MailFromDomainStatus
}
