...
trait IspPlacement extends StObject {
  ...
  /**
    ...
    */
  var IspName: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.IspName] = js.undefined
  
  /**
    * An object that contains inbox placement metrics for a specific email provider.
    */
  var PlacementStatistics: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.PlacementStatistics] = js.undefined
}
object IspPlacement {
