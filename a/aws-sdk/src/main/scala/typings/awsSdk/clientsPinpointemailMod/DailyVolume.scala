...
trait DailyVolume extends StObject {
  ...
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.DomainIspPlacements] = js.undefined
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typings.awsSdk.clientsPinpointemailMod.VolumeStatistics] = js.undefined
}
object DailyVolume {
