...
package object chimeMod {
  ...
  */
  ...
  type AppInstanceAdminList = js.Array[typings.awsSdk.chimeMod.AppInstanceAdminSummary]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type AppInstanceDataType = typings.awsSdk.chimeMod._AppInstanceDataType | java.lang.String
  
  type AppInstanceList = js.Array[typings.awsSdk.chimeMod.AppInstanceSummary]
  
  type AppInstanceStreamingConfigurationList = js.Array[typings.awsSdk.chimeMod.AppInstanceStreamingConfiguration]
  
  type AppInstanceUserList = js.Array[typings.awsSdk.chimeMod.AppInstanceUserSummary]
  ...
  */
  ...
  type ChannelBanSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelBanSummary]
  
  type ChannelMembershipForAppInstanceUserSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelMembershipForAppInstanceUserSummary]
  
  type ChannelMembershipSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelMembershipSummary]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChannelMembershipType = typings.awsSdk.chimeMod._ChannelMembershipType | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChannelMessagePersistenceType = typings.awsSdk.chimeMod._ChannelMessagePersistenceType | java.lang.String
  
  type ChannelMessageSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelMessageSummary]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChannelMessageType = typings.awsSdk.chimeMod._ChannelMessageType | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChannelMode = typings.awsSdk.chimeMod._ChannelMode | java.lang.String
  
  type ChannelModeratedByAppInstanceUserSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelModeratedByAppInstanceUserSummary]
  
  type ChannelModeratorSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelModeratorSummary]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChannelPrivacy = typings.awsSdk.chimeMod._ChannelPrivacy | java.lang.String
  
  type ChannelSummaryList = js.Array[typings.awsSdk.chimeMod.ChannelSummary]
  ...
  type DNISEmergencyCallingConfigurationList = js.Array[typings.awsSdk.chimeMod.DNISEmergencyCallingConfiguration]
  ...
  */
  ...
  type SipMediaApplicationEndpointList = js.Array[typings.awsSdk.chimeMod.SipMediaApplicationEndpoint]
  
  type SipMediaApplicationList = js.Array[typings.awsSdk.chimeMod.SipMediaApplication]
  
  type SipMediaApplicationName = java.lang.String
  
  type SipRuleList = js.Array[typings.awsSdk.chimeMod.SipRule]
  
  type SipRuleName = java.lang.String
  
  type SipRuleTargetApplicationList = js.Array[typings.awsSdk.chimeMod.SipRuleTargetApplication]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type SipRuleTriggerType = typings.awsSdk.chimeMod._SipRuleTriggerType | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type SortOrder = typings.awsSdk.chimeMod._SortOrder | java.lang.String
