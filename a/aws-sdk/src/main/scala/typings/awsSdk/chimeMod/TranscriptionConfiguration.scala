...
trait TranscriptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EngineTranscribeMedicalSettings: js.UndefOr[typings.awsSdk.chimeMod.EngineTranscribeMedicalSettings] = js.undefined
  
  /**
    * The transcription configuration settings passed to Amazon Transcribe.
    */
  var EngineTranscribeSettings: js.UndefOr[typings.awsSdk.chimeMod.EngineTranscribeSettings] = js.undefined
}
