...
trait HIT extends StObject {
  ...
  /**
    ...
    */
  var HITReviewStatus: js.UndefOr[typings.awsSdk.mturkMod.HITReviewStatus] = js.undefined
  
  /**
    * The status of the HIT and its assignments. Valid Values are Assignable | Unassignable | Reviewable | Reviewing | Disposed. 
    */
  var HITStatus: js.UndefOr[typings.awsSdk.mturkMod.HITStatus] = js.undefined
