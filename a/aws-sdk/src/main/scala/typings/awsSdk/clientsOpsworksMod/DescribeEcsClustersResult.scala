...
trait DescribeEcsClustersResult extends StObject {
  ...
  /**
    ...
    */
  var EcsClusters: js.UndefOr[typings.awsSdk.clientsOpsworksMod.EcsClusters] = js.undefined
...
object DescribeEcsClustersResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeEcsClustersResult] (val x: Self) extends AnyVal {
