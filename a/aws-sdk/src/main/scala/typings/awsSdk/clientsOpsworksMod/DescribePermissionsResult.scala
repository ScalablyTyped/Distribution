...
trait DescribePermissionsResult extends StObject {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typings.awsSdk.clientsOpsworksMod.Permissions] = js.undefined
}
object DescribePermissionsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribePermissionsResult] (val x: Self) extends AnyVal {
