...
trait DescribeDeploymentsResult extends StObject {
  ...
  /**
    ...
    */
  var Deployments: js.UndefOr[typings.awsSdk.clientsOpsworksMod.Deployments] = js.undefined
}
object DescribeDeploymentsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeDeploymentsResult] (val x: Self) extends AnyVal {
