...
trait ListTagsResult extends StObject {
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typings.awsSdk.clientsOpsworksMod.Tags] = js.undefined
}
object ListTagsResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListTagsResult] (val x: Self) extends AnyVal {
