...
trait DescribeElasticLoadBalancersResult extends StObject {
  ...
  /**
    ...
    */
  var ElasticLoadBalancers: js.UndefOr[typings.awsSdk.clientsOpsworksMod.ElasticLoadBalancers] = js.undefined
}
object DescribeElasticLoadBalancersResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeElasticLoadBalancersResult] (val x: Self) extends AnyVal {
