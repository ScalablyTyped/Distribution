...
object CreateStackRequest {
  ...
  inline def apply(DefaultInstanceProfileArn: String, Name: String, Region: String, ServiceRoleArn: String): CreateStackRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateStackRequest] (val x: Self) extends AnyVal {
