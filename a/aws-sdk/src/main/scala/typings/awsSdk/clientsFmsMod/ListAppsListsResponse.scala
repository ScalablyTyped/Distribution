...
object ListAppsListsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListAppsListsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setAppsListsVarargs(value: AppsListDataSummary*): Self = StObject.set(x, "AppsLists", js.Array(value*))
