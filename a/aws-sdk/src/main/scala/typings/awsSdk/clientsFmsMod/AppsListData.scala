...
trait AppsListData extends StObject {
  ...
  /**
    ...
    */
  var AppsList: typings.awsSdk.clientsFmsMod.AppsList
  ...
  /**
    ...
    */
  var PreviousAppsList: js.UndefOr[typings.awsSdk.clientsFmsMod.PreviousAppsList] = js.undefined
}
object AppsListData {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AppsListData] (val x: Self) extends AnyVal {
