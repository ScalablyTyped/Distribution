...
trait NetworkFirewallPolicyDescription extends StObject {
  ...
  /**
    ...
    */
  var StatefulEngineOptions: js.UndefOr[typings.awsSdk.clientsFmsMod.StatefulEngineOptions] = js.undefined
...
object NetworkFirewallPolicyDescription {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: NetworkFirewallPolicyDescription] (val x: Self) extends AnyVal {
