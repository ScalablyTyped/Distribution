...
trait AppsListDataSummary extends StObject {
  ...
  /**
    ...
    */
  var AppsList: js.UndefOr[typings.awsSdk.clientsFmsMod.AppsList] = js.undefined
...
object AppsListDataSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AppsListDataSummary] (val x: Self) extends AnyVal {
