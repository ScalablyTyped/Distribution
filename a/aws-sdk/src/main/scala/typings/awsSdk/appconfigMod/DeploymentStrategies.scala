...
object DeploymentStrategies {
  ...
  @scala.inline
  implicit class DeploymentStrategiesOps[Self <: DeploymentStrategies] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItemsVarargs(value: DeploymentStrategy*): Self = this.set("Items", js.Array(value :_*))
    @scala.inline
    def setItems(value: DeploymentStrategyList): Self = this.set("Items", value.asInstanceOf[js.Any])
    @scala.inline
