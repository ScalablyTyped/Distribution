...
trait XavcSettings extends StObject {
  ...
  /**
    ...
    */
  var Xavc4kIntraCbgProfileSettings: js.UndefOr[typings.awsSdk.mediaconvertMod.Xavc4kIntraCbgProfileSettings] = js.undefined
  
  /**
    * Required when you set (Profile) under (VideoDescription)>(CodecSettings)>(XavcSettings) to the value XAVC_4K_INTRA_VBR.
    */
  var Xavc4kIntraVbrProfileSettings: js.UndefOr[typings.awsSdk.mediaconvertMod.Xavc4kIntraVbrProfileSettings] = js.undefined
  
  /**
    * Required when you set (Profile) under (VideoDescription)>(CodecSettings)>(XavcSettings) to the value XAVC_4K.
    */
  var Xavc4kProfileSettings: js.UndefOr[typings.awsSdk.mediaconvertMod.Xavc4kProfileSettings] = js.undefined
  
  /**
    * Required when you set (Profile) under (VideoDescription)>(CodecSettings)>(XavcSettings) to the value XAVC_HD_INTRA_CBG.
    */
  var XavcHdIntraCbgProfileSettings: js.UndefOr[typings.awsSdk.mediaconvertMod.XavcHdIntraCbgProfileSettings] = js.undefined
  
  /**
    * Required when you set (Profile) under (VideoDescription)>(CodecSettings)>(XavcSettings) to the value XAVC_HD.
    */
  var XavcHdProfileSettings: js.UndefOr[typings.awsSdk.mediaconvertMod.XavcHdProfileSettings] = js.undefined
}
object XavcSettings {
