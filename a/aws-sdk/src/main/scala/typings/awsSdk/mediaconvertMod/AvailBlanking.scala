...
trait AvailBlanking extends js.Object {
  /**
    ...
    */
  var AvailBlankingImage: js.UndefOr[stringMin14PatternHttpHttpsS3BmpBMPPngPNG] = js.native
}

object AvailBlanking {
  @scala.inline
  def apply(AvailBlankingImage: stringMin14PatternHttpHttpsS3BmpBMPPngPNG = null): AvailBlanking = {
