...
trait ExtendedDataServices extends StObject {
  ...
  /**
    ...
    */
  var CopyProtectionAction: js.UndefOr[typings.awsSdk.mediaconvertMod.CopyProtectionAction] = js.undefined
  
  /**
    * The action to take on content advisory XDS packets.  If you select PASSTHROUGH, packets will not be changed. If you select STRIP, any packets will be removed in output captions.
    */
  var VchipAction: js.UndefOr[typings.awsSdk.mediaconvertMod.VchipAction] = js.undefined
}
