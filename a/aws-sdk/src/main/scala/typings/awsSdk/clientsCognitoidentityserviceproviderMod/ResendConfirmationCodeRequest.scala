...
object ResendConfirmationCodeRequest {
  ...
  inline def apply(ClientId: ClientIdType, Username: UsernameType): ResendConfirmationCodeRequest = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResendConfirmationCodeRequest] (val x: Self) extends AnyVal {
