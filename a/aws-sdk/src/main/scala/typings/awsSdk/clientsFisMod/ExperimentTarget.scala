...
trait ExperimentTarget extends StObject {
  
  /**
    * The filters to apply to identify target resources using specific attributes.
    */
  var filters: js.UndefOr[ExperimentTargetFilterList] = js.undefined
  
  /**
    * The resource type parameters.
    */
  var parameters: js.UndefOr[ExperimentTargetParameterMap] = js.undefined
  ...
  /**
    ...
    */
  var selectionMode: js.UndefOr[ExperimentTargetSelectionMode] = js.undefined
}
object ExperimentTarget {
  
  inline def apply(): ExperimentTarget = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExperimentTarget]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ExperimentTarget] (val x: Self) extends AnyVal {
    
    inline def setFilters(value: ExperimentTargetFilterList): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
    
    inline def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
    
    inline def setFiltersVarargs(value: ExperimentTargetFilter*): Self = StObject.set(x, "filters", js.Array(value*))
    
    inline def setParameters(value: ExperimentTargetParameterMap): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
    ...
    inline def setSelectionMode(value: ExperimentTargetSelectionMode): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
