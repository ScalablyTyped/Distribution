...
package object apigatewayMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsSdk.awsSdkStrings.`0Dot5`
    - typings.awsSdk.awsSdkStrings.`1Dot6`
    - typings.awsSdk.awsSdkStrings.`6Dot1`
    - typings.awsSdk.awsSdkStrings.`13Dot5`
    - typings.awsSdk.awsSdkStrings.`28Dot4`
    - typings.awsSdk.awsSdkStrings.`58Dot2`
    - typings.awsSdk.awsSdkStrings.`118`
  ...
  */
  ...
  type ClientConfiguration = typings.awsSdk.serviceMod.ServiceConfigurationOptions with typings.awsSdk.apigatewayMod.ClientApiVersions
  /* Rewritten from type alias, can be one of: 
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdk.awsSdkStrings.PATH_PARAMETER
    - typings.awsSdk.awsSdkStrings.QUERY_PARAMETER
    - typings.awsSdk.awsSdkStrings.REQUEST_HEADER
    - typings.awsSdk.awsSdkStrings.REQUEST_BODY
    - typings.awsSdk.awsSdkStrings.RESPONSE
    - typings.awsSdk.awsSdkStrings.RESPONSE_HEADER
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdk.awsSdkStrings.DEFAULT_5XX
    - typings.awsSdk.awsSdkStrings.RESOURCE_NOT_FOUND
    - typings.awsSdk.awsSdkStrings.UNAUTHORIZED
    - typings.awsSdk.awsSdkStrings.INVALID_API_KEY
    - typings.awsSdk.awsSdkStrings.ACCESS_DENIED
    - typings.awsSdk.awsSdkStrings.AUTHORIZER_FAILURE
    - typings.awsSdk.awsSdkStrings.AUTHORIZER_CONFIGURATION_ERROR
    - typings.awsSdk.awsSdkStrings.INVALID_SIGNATURE
    - typings.awsSdk.awsSdkStrings.EXPIRED_TOKEN
    - typings.awsSdk.awsSdkStrings.MISSING_AUTHENTICATION_TOKEN
    - typings.awsSdk.awsSdkStrings.INTEGRATION_FAILURE
    - typings.awsSdk.awsSdkStrings.INTEGRATION_TIMEOUT
    - typings.awsSdk.awsSdkStrings.API_CONFIGURATION_ERROR
    - typings.awsSdk.awsSdkStrings.UNSUPPORTED_MEDIA_TYPE
    - typings.awsSdk.awsSdkStrings.BAD_REQUEST_PARAMETERS
    - typings.awsSdk.awsSdkStrings.BAD_REQUEST_BODY
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdk.awsSdkStrings.move
    - typings.awsSdk.awsSdkStrings.copy_
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdk.awsSdkStrings.SUCCEED_WITH_RESPONSE_HEADER
