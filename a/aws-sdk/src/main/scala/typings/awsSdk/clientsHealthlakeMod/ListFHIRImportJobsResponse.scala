...
trait ListFHIRImportJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var ImportJobPropertiesList: typings.awsSdk.clientsHealthlakeMod.ImportJobPropertiesList
...
object ListFHIRImportJobsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListFHIRImportJobsResponse] (val x: Self) extends AnyVal {
