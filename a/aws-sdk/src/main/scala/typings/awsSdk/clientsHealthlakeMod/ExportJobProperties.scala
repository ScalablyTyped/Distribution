...
trait ExportJobProperties extends StObject {
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typings.awsSdk.clientsHealthlakeMod.Message] = js.undefined
  
  /**
    * The output data configuration that was supplied when the export job was created.
    */
  var OutputDataConfig: typings.awsSdk.clientsHealthlakeMod.OutputDataConfig
