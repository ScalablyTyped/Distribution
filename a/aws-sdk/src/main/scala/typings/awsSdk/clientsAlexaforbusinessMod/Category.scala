...
trait Category extends StObject {
  ...
  /**
    ...
    */
  var CategoryId: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.CategoryId] = js.undefined
  
  /**
    * The name of the skill store category.
    */
  var CategoryName: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.CategoryName] = js.undefined
}
object Category {
