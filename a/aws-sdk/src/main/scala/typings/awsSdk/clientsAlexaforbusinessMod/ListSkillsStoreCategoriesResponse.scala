...
trait ListSkillsStoreCategoriesResponse extends StObject {
  ...
  /**
    ...
    */
  var CategoryList: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.CategoryList] = js.undefined
...
object ListSkillsStoreCategoriesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListSkillsStoreCategoriesResponse] (val x: Self) extends AnyVal {
