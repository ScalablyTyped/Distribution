...
trait Content extends StObject {
  ...
  /**
    ...
    */
  var AudioList: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.AudioList] = js.undefined
  
  /**
    * The list of SSML messages.
    */
  var SsmlList: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.SsmlList] = js.undefined
  
  /**
    * The list of text messages.
    */
  var TextList: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.TextList] = js.undefined
}
object Content {
