...
trait DeviceStatusInfo extends StObject {
  ...
  /**
    ...
    */
  var ConnectionStatus: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.ConnectionStatus] = js.undefined
  ...
  /**
    ...
    */
  var DeviceStatusDetails: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.DeviceStatusDetails] = js.undefined
}
object DeviceStatusInfo {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeviceStatusInfo] (val x: Self) extends AnyVal {
