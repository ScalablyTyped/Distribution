...
trait ResolveRoomResponse extends StObject {
  ...
  /**
    ...
    */
  var RoomSkillParameters: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.RoomSkillParameters] = js.undefined
}
object ResolveRoomResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResolveRoomResponse] (val x: Self) extends AnyVal {
