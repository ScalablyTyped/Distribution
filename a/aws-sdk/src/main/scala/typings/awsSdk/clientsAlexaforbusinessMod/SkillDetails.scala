...
trait SkillDetails extends StObject {
  ...
  /**
    ...
    */
  var BulletPoints: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.BulletPoints] = js.undefined
  
  /**
    * The details about the developer that published the skill.
    */
  var DeveloperInfo: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.DeveloperInfo] = js.undefined
  
  /**
    * The URL of the end user license agreement.
    */
  var EndUserLicenseAgreement: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.EndUserLicenseAgreement] = js.undefined
  
  /**
    * The generic keywords associated with the skill that can be used to find a skill.
    */
  var GenericKeywords: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.GenericKeywords] = js.undefined
  
  /**
    * The phrase used to trigger the skill.
    */
  var InvocationPhrase: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.InvocationPhrase] = js.undefined
  
  /**
    * The updates added in bullet points.
    */
  var NewInThisVersionBulletPoints: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.NewInThisVersionBulletPoints] = js.undefined
  
  /**
    * The description of the product.
    */
  var ProductDescription: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.ProductDescription] = js.undefined
  
  /**
    * The date when the skill was released.
    */
  var ReleaseDate: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.ReleaseDate] = js.undefined
  
  /**
    *  This member has been deprecated.  The list of reviews for the skill, including Key and Value pair.
    */
  var Reviews: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.Reviews] = js.undefined
  
  /**
    * The types of skills.
    */
  var SkillTypes: js.UndefOr[typings.awsSdk.clientsAlexaforbusinessMod.SkillTypes] = js.undefined
}
object SkillDetails {
