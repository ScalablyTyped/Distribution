...
trait DeleteDeviceUsageDataRequest extends StObject {
  ...
  /**
    ...
    */
  var DeviceUsageType: typings.awsSdk.clientsAlexaforbusinessMod.DeviceUsageType
}
object DeleteDeviceUsageDataRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DeleteDeviceUsageDataRequest] (val x: Self) extends AnyVal {
