...
trait MailboxExportJob extends StObject {
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[typings.awsSdk.clientsWorkmailMod.S3BucketName] = js.undefined
...
object MailboxExportJob {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: MailboxExportJob] (val x: Self) extends AnyVal {
