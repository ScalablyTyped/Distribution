...
trait DescribeEmailMonitoringConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var LogGroupArn: js.UndefOr[typings.awsSdk.clientsWorkmailMod.LogGroupArn] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the IAM Role associated with the email monitoring configuration.
    */
  var RoleArn: js.UndefOr[typings.awsSdk.clientsWorkmailMod.RoleArn] = js.undefined
}
