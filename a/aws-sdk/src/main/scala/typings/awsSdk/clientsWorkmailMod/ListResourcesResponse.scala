...
trait ListResourcesResponse extends StObject {
  ...
  /**
    ...
    */
  var Resources: js.UndefOr[typings.awsSdk.clientsWorkmailMod.Resources] = js.undefined
}
object ListResourcesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListResourcesResponse] (val x: Self) extends AnyVal {
