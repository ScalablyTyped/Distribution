...
trait EventIntegrationAssociation extends StObject {
  ...
  /**
    ...
    */
  var ClientAssociationMetadata: js.UndefOr[typings.awsSdk.appintegrationsMod.ClientAssociationMetadata] = js.undefined
  ...
  /**
    ...
    */
  var EventBridgeRuleName: js.UndefOr[typings.awsSdk.appintegrationsMod.EventBridgeRuleName] = js.undefined
