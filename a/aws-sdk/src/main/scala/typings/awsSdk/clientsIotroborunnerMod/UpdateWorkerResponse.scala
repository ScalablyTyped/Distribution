...
trait UpdateWorkerResponse extends StObject {
...
object UpdateWorkerResponse {
  ...
  inline def apply(arn: WorkerArn, fleet: WorkerFleetArn, id: WorkerId, name: Name, updatedAt: js.Date): UpdateWorkerResponse = {
    val __obj = js.Dynamic.literal(arn = arn.asInstanceOf[js.Any], fleet = fleet.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], updatedAt = updatedAt.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpdateWorkerResponse]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateWorkerResponse] (val x: Self) extends AnyVal {
