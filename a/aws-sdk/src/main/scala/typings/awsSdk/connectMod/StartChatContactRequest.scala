...
trait StartChatContactRequest extends StObject {
  ...
  /**
    ...
    */
  var ChatDurationInMinutes: js.UndefOr[typings.awsSdk.connectMod.ChatDurationInMinutes] = js.undefined
  ...
  /**
    ...
    */
  var SupportedMessagingContentTypes: js.UndefOr[typings.awsSdk.connectMod.SupportedMessagingContentTypes] = js.undefined
}
