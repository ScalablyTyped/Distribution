...
trait ListHoursOfOperationsRequest extends StObject {
...
object ListHoursOfOperationsRequest {
  ...
  @scala.inline
  def apply(InstanceId: InstanceId): ListHoursOfOperationsRequest = {
    val __obj = js.Dynamic.literal(InstanceId = InstanceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListHoursOfOperationsRequest]
  }
  
  @scala.inline
  implicit class ListHoursOfOperationsRequestMutableBuilder[Self <: ListHoursOfOperationsRequest] (val x: Self) extends AnyVal {
