...
trait ClaimedPhoneNumberSummary extends StObject {
  ...
  /**
    ...
    */
  var PhoneNumberDescription: js.UndefOr[typings.awsSdk.connectMod.PhoneNumberDescription] = js.undefined
  ...
  /**
    ...
    */
  var PhoneNumberStatus: js.UndefOr[typings.awsSdk.connectMod.PhoneNumberStatus] = js.undefined
