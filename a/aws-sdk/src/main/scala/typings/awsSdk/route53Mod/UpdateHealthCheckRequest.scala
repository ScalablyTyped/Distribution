...
trait UpdateHealthCheckRequest extends StObject {
  ...
  /**
    ...
    */
  var AlarmIdentifier: js.UndefOr[typings.awsSdk.route53Mod.AlarmIdentifier] = js.undefined
  ...
  /**
    ...
    */
  var Disabled: js.UndefOr[typings.awsSdk.route53Mod.Disabled] = js.undefined
  ...
  /**
    ...
    */
  var EnableSNI: js.UndefOr[typings.awsSdk.route53Mod.EnableSNI] = js.undefined
  ...
  /**
    ...
    */
  var FailureThreshold: js.UndefOr[typings.awsSdk.route53Mod.FailureThreshold] = js.undefined
  ...
  /**
    ...
    */
  var FullyQualifiedDomainName: js.UndefOr[typings.awsSdk.route53Mod.FullyQualifiedDomainName] = js.undefined
  ...
  /**
    ...
    */
  var HealthCheckVersion: js.UndefOr[typings.awsSdk.route53Mod.HealthCheckVersion] = js.undefined
  ...
  /**
    ...
    */
  var HealthThreshold: js.UndefOr[typings.awsSdk.route53Mod.HealthThreshold] = js.undefined
  ...
  /**
    ...
    */
  var Inverted: js.UndefOr[typings.awsSdk.route53Mod.Inverted] = js.undefined
  ...
  /**
    ...
    */
  var Port: js.UndefOr[typings.awsSdk.route53Mod.Port] = js.undefined
  ...
  /**
    ...
    */
  var ResourcePath: js.UndefOr[typings.awsSdk.route53Mod.ResourcePath] = js.undefined
  ...
  /**
    ...
    */
  var SearchString: js.UndefOr[typings.awsSdk.route53Mod.SearchString] = js.undefined
}
object UpdateHealthCheckRequest {
  ...
  @scala.inline
  implicit class UpdateHealthCheckRequestMutableBuilder[Self <: UpdateHealthCheckRequest] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHealthCheckVersionUndefined: Self = StObject.set(x, "HealthCheckVersion", js.undefined)
    ...
    @scala.inline
    def setResetElements(value: ResettableElementNameList): Self = StObject.set(x, "ResetElements", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setResetElementsUndefined: Self = StObject.set(x, "ResetElements", js.undefined)
    
    @scala.inline
    def setResetElementsVarargs(value: ResettableElementName*): Self = StObject.set(x, "ResetElements", js.Array(value :_*))
