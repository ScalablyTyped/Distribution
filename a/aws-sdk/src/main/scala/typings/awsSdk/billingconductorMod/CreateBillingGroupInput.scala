...
trait CreateBillingGroupInput extends StObject {
  ...
  /**
    ...
    */
  var AccountGrouping: typings.awsSdk.billingconductorMod.AccountGrouping
  ...
  /**
    ...
    */
  var ComputationPreference: typings.awsSdk.billingconductorMod.ComputationPreference
