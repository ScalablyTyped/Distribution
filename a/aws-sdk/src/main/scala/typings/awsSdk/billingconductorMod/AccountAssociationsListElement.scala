...
trait AccountAssociationsListElement extends StObject {
  ...
  /**
    ...
    */
  var AccountEmail: js.UndefOr[typings.awsSdk.billingconductorMod.AccountEmail] = js.undefined
  
  /**
    *  The associating array of account IDs. 
    */
  var AccountId: js.UndefOr[typings.awsSdk.billingconductorMod.AccountId] = js.undefined
  
  /**
    *  The Amazon Web Services account name. 
    */
  var AccountName: js.UndefOr[typings.awsSdk.billingconductorMod.AccountName] = js.undefined
