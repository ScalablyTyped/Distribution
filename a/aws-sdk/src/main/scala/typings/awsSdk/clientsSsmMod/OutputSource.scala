...
trait OutputSource extends StObject {
  ...
  /**
    ...
    */
  var OutputSourceId: js.UndefOr[typings.awsSdk.clientsSsmMod.OutputSourceId] = js.undefined
  
  /**
    * The type of source where the association execution details are stored, for example, Amazon S3.
    */
  var OutputSourceType: js.UndefOr[typings.awsSdk.clientsSsmMod.OutputSourceType] = js.undefined
}
object OutputSource {
