...
trait Command extends StObject {
  ...
  /**
    ...
    */
  var CompletedCount: js.UndefOr[typings.awsSdk.clientsSsmMod.CompletedCount] = js.undefined
  
  /**
    * The number of targets for which the status is Delivery Timed Out.
    */
  var DeliveryTimedOutCount: js.UndefOr[typings.awsSdk.clientsSsmMod.DeliveryTimedOutCount] = js.undefined
  ...
  /**
    ...
    */
  var ErrorCount: js.UndefOr[typings.awsSdk.clientsSsmMod.ErrorCount] = js.undefined
  ...
  /**
    ...
    */
  var TargetCount: js.UndefOr[typings.awsSdk.clientsSsmMod.TargetCount] = js.undefined
