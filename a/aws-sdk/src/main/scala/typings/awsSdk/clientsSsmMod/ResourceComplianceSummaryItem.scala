...
trait ResourceComplianceSummaryItem extends StObject {
  ...
  /**
    ...
    */
  var CompliantSummary: js.UndefOr[typings.awsSdk.clientsSsmMod.CompliantSummary] = js.undefined
  ...
  /**
    ...
    */
  var NonCompliantSummary: js.UndefOr[typings.awsSdk.clientsSsmMod.NonCompliantSummary] = js.undefined
...
object ResourceComplianceSummaryItem {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ResourceComplianceSummaryItem] (val x: Self) extends AnyVal {
