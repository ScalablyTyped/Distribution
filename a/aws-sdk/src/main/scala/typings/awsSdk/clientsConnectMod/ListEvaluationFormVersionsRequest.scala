...
trait ListEvaluationFormVersionsRequest extends StObject {
...
object ListEvaluationFormVersionsRequest {
  ...
  inline def apply(EvaluationFormId: ResourceId, InstanceId: InstanceId): ListEvaluationFormVersionsRequest = {
    ...
    __obj.asInstanceOf[ListEvaluationFormVersionsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListEvaluationFormVersionsRequest] (val x: Self) extends AnyVal {
