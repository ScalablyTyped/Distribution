...
trait ListContactReferencesResponse extends StObject {
  ...
  /**
    ...
    */
  var ReferenceSummaryList: js.UndefOr[typings.awsSdk.clientsConnectMod.ReferenceSummaryList] = js.undefined
}
object ListContactReferencesResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListContactReferencesResponse] (val x: Self) extends AnyVal {
