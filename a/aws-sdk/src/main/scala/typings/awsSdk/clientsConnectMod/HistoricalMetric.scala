...
trait HistoricalMetric extends StObject {
  ...
  /**
    ...
    */
  var Statistic: js.UndefOr[typings.awsSdk.clientsConnectMod.Statistic] = js.undefined
  
  /**
    * The threshold for the metric, used with service level metrics.
    */
  var Threshold: js.UndefOr[typings.awsSdk.clientsConnectMod.Threshold] = js.undefined
