...
trait InstanceStorageConfig extends StObject {
  ...
  /**
    ...
    */
  var KinesisFirehoseConfig: js.UndefOr[typings.awsSdk.clientsConnectMod.KinesisFirehoseConfig] = js.undefined
  
  /**
    * The configuration of the Kinesis data stream.
    */
  var KinesisStreamConfig: js.UndefOr[typings.awsSdk.clientsConnectMod.KinesisStreamConfig] = js.undefined
  
  /**
    * The configuration of the Kinesis video stream.
    */
  var KinesisVideoStreamConfig: js.UndefOr[typings.awsSdk.clientsConnectMod.KinesisVideoStreamConfig] = js.undefined
  
  /**
    * The S3 bucket configuration.
    */
  var S3Config: js.UndefOr[typings.awsSdk.clientsConnectMod.S3Config] = js.undefined
  
  /**
    * A valid storage type.
    */
  var StorageType: typings.awsSdk.clientsConnectMod.StorageType
}
object InstanceStorageConfig {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceStorageConfig] (val x: Self) extends AnyVal {
