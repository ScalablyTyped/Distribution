...
trait UpdateEvaluationFormRequest extends StObject {
  ...
  /**
    ...
    */
  var CreateNewVersion: js.UndefOr[BoxedBoolean] = js.undefined
...
object UpdateEvaluationFormRequest {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(EvaluationFormId = EvaluationFormId.asInstanceOf[js.Any], EvaluationFormVersion = EvaluationFormVersion.asInstanceOf[js.Any], InstanceId = InstanceId.asInstanceOf[js.Any], Items = Items.asInstanceOf[js.Any], Title = Title.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpdateEvaluationFormRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateEvaluationFormRequest] (val x: Self) extends AnyVal {
    
    inline def setClientToken(value: ClientToken): Self = StObject.set(x, "ClientToken", value.asInstanceOf[js.Any])
    
    inline def setClientTokenUndefined: Self = StObject.set(x, "ClientToken", js.undefined)
    
    inline def setCreateNewVersion(value: BoxedBoolean): Self = StObject.set(x, "CreateNewVersion", value.asInstanceOf[js.Any])
