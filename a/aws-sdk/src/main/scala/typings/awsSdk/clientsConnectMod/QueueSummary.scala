...
trait QueueSummary extends StObject {
  ...
  /**
    * The type of queue.
    */
  var QueueType: js.UndefOr[typings.awsSdk.clientsConnectMod.QueueType] = js.undefined
}
object QueueSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: QueueSummary] (val x: Self) extends AnyVal {
