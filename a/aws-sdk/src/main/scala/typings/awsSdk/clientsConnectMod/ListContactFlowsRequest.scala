...
trait ListContactFlowsRequest extends StObject {
  ...
  /**
    * The type of flow.
    */
  var ContactFlowTypes: js.UndefOr[typings.awsSdk.clientsConnectMod.ContactFlowTypes] = js.undefined
...
object ListContactFlowsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListContactFlowsRequest] (val x: Self) extends AnyVal {
