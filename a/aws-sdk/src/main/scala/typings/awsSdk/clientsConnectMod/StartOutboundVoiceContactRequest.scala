...
trait StartOutboundVoiceContactRequest extends StObject {
  ...
  /**
    ...
    */
  var AnswerMachineDetectionConfig: js.UndefOr[typings.awsSdk.clientsConnectMod.AnswerMachineDetectionConfig] = js.undefined
  ...
  /**
    ...
    */
  var TrafficType: js.UndefOr[typings.awsSdk.clientsConnectMod.TrafficType] = js.undefined
}
