...
trait SourceLocation extends StObject {
  ...
  /**
    ...
    */
  var AccessConfiguration: js.UndefOr[typings.awsSdk.mediatailorMod.AccessConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DefaultSegmentDeliveryConfiguration: js.UndefOr[typings.awsSdk.mediatailorMod.DefaultSegmentDeliveryConfiguration] = js.undefined
  
  /**
    * The HTTP configuration for the source location.
    */
  var HttpConfiguration: typings.awsSdk.mediatailorMod.HttpConfiguration
