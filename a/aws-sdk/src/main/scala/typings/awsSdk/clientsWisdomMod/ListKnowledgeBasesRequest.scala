...
trait ListKnowledgeBasesRequest extends StObject {
...
object ListKnowledgeBasesRequest {
  ...
  inline def apply(): ListKnowledgeBasesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListKnowledgeBasesRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ListKnowledgeBasesRequest] (val x: Self) extends AnyVal {
