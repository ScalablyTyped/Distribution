...
trait UpdateConnectivityRequest extends StObject {
  ...
  /**
    ...
    */
  var ConnectivityInfo: typings.awsSdk.clientsKafkaMod.ConnectivityInfo
...
object UpdateConnectivityRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateConnectivityRequest] (val x: Self) extends AnyVal {
