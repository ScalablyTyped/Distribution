...
object ListClusterOperationsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListClusterOperationsResponse] (val x: Self) extends AnyVal {
    ...
    inline def setClusterOperationInfoListVarargs(value: ClusterOperationInfo*): Self = StObject.set(x, "ClusterOperationInfoList", js.Array(value*))
