...
trait Prometheus extends StObject {
  ...
  /**
    ...
    */
  var JmxExporter: js.UndefOr[typings.awsSdk.clientsKafkaMod.JmxExporter] = js.undefined
  ...
  /**
    ...
    */
  var NodeExporter: js.UndefOr[typings.awsSdk.clientsKafkaMod.NodeExporter] = js.undefined
}
object Prometheus {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: Prometheus] (val x: Self) extends AnyVal {
