...
trait PolicyOption extends StObject {
  ...
  /**
    ...
    */
  var NetworkFirewallPolicy: js.UndefOr[typings.awsSdk.fmsMod.NetworkFirewallPolicy] = js.undefined
  
  /**
    * Defines the policy options for a third-party firewall policy.
    */
  var ThirdPartyFirewallPolicy: js.UndefOr[typings.awsSdk.fmsMod.ThirdPartyFirewallPolicy] = js.undefined
}
object PolicyOption {
