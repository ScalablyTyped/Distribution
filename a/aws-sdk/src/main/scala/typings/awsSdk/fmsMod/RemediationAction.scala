...
trait RemediationAction extends StObject {
  ...
  /**
    ...
    */
  var EC2AssociateRouteTableAction: js.UndefOr[typings.awsSdk.fmsMod.EC2AssociateRouteTableAction] = js.undefined
  
  /**
    * Information about the CopyRouteTable action in the Amazon EC2 API.
    */
  var EC2CopyRouteTableAction: js.UndefOr[typings.awsSdk.fmsMod.EC2CopyRouteTableAction] = js.undefined
  
  /**
    * Information about the CreateRoute action in the Amazon EC2 API.
    */
  var EC2CreateRouteAction: js.UndefOr[typings.awsSdk.fmsMod.EC2CreateRouteAction] = js.undefined
  
  /**
    * Information about the CreateRouteTable action in the Amazon EC2 API.
    */
  var EC2CreateRouteTableAction: js.UndefOr[typings.awsSdk.fmsMod.EC2CreateRouteTableAction] = js.undefined
  
  /**
    * Information about the DeleteRoute action in the Amazon EC2 API.
    */
  var EC2DeleteRouteAction: js.UndefOr[typings.awsSdk.fmsMod.EC2DeleteRouteAction] = js.undefined
  
  /**
    * Information about the ReplaceRoute action in the Amazon EC2 API.
    */
  var EC2ReplaceRouteAction: js.UndefOr[typings.awsSdk.fmsMod.EC2ReplaceRouteAction] = js.undefined
  
  /**
    * Information about the ReplaceRouteTableAssociation action in the Amazon EC2 API.
    */
  var EC2ReplaceRouteTableAssociationAction: js.UndefOr[typings.awsSdk.fmsMod.EC2ReplaceRouteTableAssociationAction] = js.undefined
  
  /**
    * The remedial action to take when updating a firewall configuration.
    */
  var FMSPolicyUpdateFirewallCreationConfigAction: js.UndefOr[typings.awsSdk.fmsMod.FMSPolicyUpdateFirewallCreationConfigAction] = js.undefined
}
