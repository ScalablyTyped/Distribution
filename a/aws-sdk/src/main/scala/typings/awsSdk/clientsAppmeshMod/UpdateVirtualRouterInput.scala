...
object UpdateVirtualRouterInput {
  ...
  inline def apply(meshName: ResourceName, spec: VirtualRouterSpec, virtualRouterName: ResourceName): UpdateVirtualRouterInput = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UpdateVirtualRouterInput] (val x: Self) extends AnyVal {
