...
import typings.awsSdk.clientsEc2Mod.RestorableByStringList
import typings.awsSdk.clientsEc2Mod.SnapshotId
import typings.awsSdk.clientsEc2Mod.SnapshotIdStringList
...
object DescribeSnapshotsRequestw {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeSnapshotsRequestw] (val x: Self) extends AnyVal {
