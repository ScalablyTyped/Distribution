...
import typings.awsSdk.clientsEc2Mod.DescribeVpcPeeringConnectionsMaxResults
...
import typings.awsSdk.clientsEc2Mod.VpcPeeringConnectionId
import typings.awsSdk.clientsEc2Mod.VpcPeeringConnectionIdList
...
object DescribeVpcPeeringConnect {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeVpcPeeringConnect] (val x: Self) extends AnyVal {
