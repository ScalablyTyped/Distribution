...
trait DescribeImageScanFindings extends StObject {
...
object DescribeImageScanFindings {
  ...
  inline def apply(imageId: ImageIdentifier, repositoryName: RepositoryName): DescribeImageScanFindings = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeImageScanFindings] (val x: Self) extends AnyVal {
