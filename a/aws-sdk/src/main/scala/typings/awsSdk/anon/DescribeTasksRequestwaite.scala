...
import typings.awsSdk.clientsEcsMod.TaskField
import typings.awsSdk.clientsEcsMod.TaskFieldList
...
object DescribeTasksRequestwaite {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeTasksRequestwaite] (val x: Self) extends AnyVal {
