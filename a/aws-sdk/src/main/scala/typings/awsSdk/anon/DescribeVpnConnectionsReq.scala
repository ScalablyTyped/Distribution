...
import typings.awsSdk.clientsEc2Mod.VpnConnectionId
import typings.awsSdk.clientsEc2Mod.VpnConnectionIdStringList
...
object DescribeVpnConnectionsReq {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeVpnConnectionsReq] (val x: Self) extends AnyVal {
