...
import typings.awsSdk.clientsMachinelearningMod.DataSourceFilterVariable
...
object DescribeDataSourcesInputw {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeDataSourcesInputw] (val x: Self) extends AnyVal {
