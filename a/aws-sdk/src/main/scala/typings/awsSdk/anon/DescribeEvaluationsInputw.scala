...
import typings.awsSdk.machinelearningMod.EvaluationFilterVariable
...
object DescribeEvaluationsInputw {
  ...
  @scala.inline
  implicit class DescribeEvaluationsInputwMutableBuilder[Self <: DescribeEvaluationsInputw] (val x: Self) extends AnyVal {
