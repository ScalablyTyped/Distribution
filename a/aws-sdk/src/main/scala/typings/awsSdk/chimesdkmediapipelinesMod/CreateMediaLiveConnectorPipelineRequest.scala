...
trait CreateMediaLiveConnectorPipelineRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typings.awsSdk.chimesdkmediapipelinesMod.ClientRequestToken] = js.undefined
...
object CreateMediaLiveConnectorPipelineRequest {
  ...
  extension [Self <: CreateMediaLiveConnectorPipelineRequest](x: Self) {
