...
trait CopyCommand extends StObject {
  ...
  /**
    ...
    */
  var CopyOptions: js.UndefOr[typings.awsSdk.firehoseMod.CopyOptions] = js.undefined
  
  /**
    * A comma-separated list of column names.
    */
  var DataTableColumns: js.UndefOr[typings.awsSdk.firehoseMod.DataTableColumns] = js.undefined
  
  /**
    * The name of the target table. The table must already exist in the database.
    */
  var DataTableName: typings.awsSdk.firehoseMod.DataTableName
}
object CopyCommand {
