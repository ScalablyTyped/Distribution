...
trait ListVehiclesInFleetRequest extends StObject {
...
object ListVehiclesInFleetRequest {
  ...
  inline def apply(fleetId: fleetId): ListVehiclesInFleetRequest = {
    val __obj = js.Dynamic.literal(fleetId = fleetId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListVehiclesInFleetRequest]
  }
  
  extension [Self <: ListVehiclesInFleetRequest](x: Self) {
