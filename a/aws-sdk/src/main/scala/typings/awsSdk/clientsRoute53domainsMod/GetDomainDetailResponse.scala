...
trait GetDomainDetailResponse extends StObject {
  ...
  /**
    ...
    */
  var RegistrarName: js.UndefOr[typings.awsSdk.clientsRoute53domainsMod.RegistrarName] = js.undefined
  
  /**
    * Web address of the registrar.
    */
  var RegistrarUrl: js.UndefOr[typings.awsSdk.clientsRoute53domainsMod.RegistrarUrl] = js.undefined
  
  /**
    * Reserved for future use.
    */
  var RegistryDomainId: js.UndefOr[typings.awsSdk.clientsRoute53domainsMod.RegistryDomainId] = js.undefined
  
  /**
    * Reseller of the domain. Domains registered or transferred using Route 53 domains will have "Amazon" as the reseller. 
    */
  var Reseller: js.UndefOr[typings.awsSdk.clientsRoute53domainsMod.Reseller] = js.undefined
