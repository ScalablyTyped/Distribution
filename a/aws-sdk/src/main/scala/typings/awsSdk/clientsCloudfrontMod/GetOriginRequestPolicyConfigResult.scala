...
trait GetOriginRequestPolicyConfigResult extends StObject {
  ...
  /**
    ...
    */
  var OriginRequestPolicyConfig: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.OriginRequestPolicyConfig] = js.undefined
}
object GetOriginRequestPolicyConfigResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetOriginRequestPolicyConfigResult] (val x: Self) extends AnyVal {
