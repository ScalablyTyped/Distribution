...
trait DistributionConfig extends StObject {
  ...
  /**
    ...
    */
  var CacheBehaviors: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.CacheBehaviors] = js.undefined
  ...
  /**
    ...
    */
  var ContinuousDeploymentPolicyId: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var CustomErrorResponses: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.CustomErrorResponses] = js.undefined
  
  /**
    * A complex type that describes the default cache behavior if you don't specify a CacheBehavior element or if files don't match any of the values of PathPattern in CacheBehavior elements. You must create exactly one default cache behavior.
    */
  var DefaultCacheBehavior: typings.awsSdk.clientsCloudfrontMod.DefaultCacheBehavior
  ...
  /**
    ...
    */
  var HttpVersion: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.HttpVersion] = js.undefined
  ...
  /**
    ...
    */
  var Restrictions: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.Restrictions] = js.undefined
  ...
  /**
    ...
    */
  var ViewerCertificate: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.ViewerCertificate] = js.undefined
...
object DistributionConfig {
  ...
  implicit open class MutableBuilder[Self <: DistributionConfig] (val x: Self) extends AnyVal {
    ...
    inline def setContinuousDeploymentPolicyId(value: String): Self = StObject.set(x, "ContinuousDeploymentPolicyId", value.asInstanceOf[js.Any])
    
    inline def setContinuousDeploymentPolicyIdUndefined: Self = StObject.set(x, "ContinuousDeploymentPolicyId", js.undefined)
