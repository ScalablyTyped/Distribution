...
trait GetContinuousDeploymentPolicyResult extends StObject {
...
object GetContinuousDeploymentPolicyResult {
  ...
  inline def apply(): GetContinuousDeploymentPolicyResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetContinuousDeploymentPolicyResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GetContinuousDeploymentPolicyResult] (val x: Self) extends AnyVal {
