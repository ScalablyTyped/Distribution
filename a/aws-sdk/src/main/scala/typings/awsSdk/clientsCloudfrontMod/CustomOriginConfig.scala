...
trait CustomOriginConfig extends StObject {
  ...
  /**
    ...
    */
  var OriginProtocolPolicy: typings.awsSdk.clientsCloudfrontMod.OriginProtocolPolicy
  ...
  /**
    ...
    */
  var OriginSslProtocols: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.OriginSslProtocols] = js.undefined
}
