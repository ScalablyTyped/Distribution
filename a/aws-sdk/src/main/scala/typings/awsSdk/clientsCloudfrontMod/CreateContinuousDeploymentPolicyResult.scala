...
trait CreateContinuousDeploymentPolicyResult extends StObject {
...
object CreateContinuousDeploymentPolicyResult {
  ...
  inline def apply(): CreateContinuousDeploymentPolicyResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateContinuousDeploymentPolicyResult]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CreateContinuousDeploymentPolicyResult] (val x: Self) extends AnyVal {
