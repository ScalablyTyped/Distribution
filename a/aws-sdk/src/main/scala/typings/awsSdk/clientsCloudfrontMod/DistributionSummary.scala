...
trait DistributionSummary extends StObject {
  ...
  /**
    ...
    */
  var Aliases: typings.awsSdk.clientsCloudfrontMod.Aliases
  
  /**
    * A complex type that contains zero or more CacheBehavior elements.
    */
  var CacheBehaviors: typings.awsSdk.clientsCloudfrontMod.CacheBehaviors
  ...
  /**
    ...
    */
  var CustomErrorResponses: typings.awsSdk.clientsCloudfrontMod.CustomErrorResponses
