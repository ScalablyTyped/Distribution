...
trait GetFieldLevelEncryptionProfileConfigResult extends StObject {
  ...
  /**
    ...
    */
  var FieldLevelEncryptionProfileConfig: js.UndefOr[typings.awsSdk.clientsCloudfrontMod.FieldLevelEncryptionProfileConfig] = js.undefined
}
object GetFieldLevelEncryptionProfileConfigResult {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetFieldLevelEncryptionProfileConfigResult] (val x: Self) extends AnyVal {
