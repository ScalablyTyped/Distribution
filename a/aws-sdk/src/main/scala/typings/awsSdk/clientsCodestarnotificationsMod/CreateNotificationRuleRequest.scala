...
trait CreateNotificationRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var DetailType: typings.awsSdk.clientsCodestarnotificationsMod.DetailType
  
  /**
    * A list of event types associated with this notification rule. For a list of allowed events, see EventTypeSummary.
    */
  var EventTypeIds: typings.awsSdk.clientsCodestarnotificationsMod.EventTypeIds
  ...
  /**
    ...
    */
  var Targets: typings.awsSdk.clientsCodestarnotificationsMod.Targets
}
