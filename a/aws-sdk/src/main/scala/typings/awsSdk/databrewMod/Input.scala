...
trait Input extends StObject {
  ...
  /**
    ...
    */
  var DatabaseInputDefinition: js.UndefOr[typings.awsSdk.databrewMod.DatabaseInputDefinition] = js.undefined
  
  /**
    * Contains additional resource information needed for specific datasets.
    */
  var Metadata: js.UndefOr[typings.awsSdk.databrewMod.Metadata] = js.undefined
