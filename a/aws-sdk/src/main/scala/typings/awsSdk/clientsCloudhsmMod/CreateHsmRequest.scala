...
trait CreateHsmRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typings.awsSdk.clientsCloudhsmMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var ExternalId: js.UndefOr[typings.awsSdk.clientsCloudhsmMod.ExternalId] = js.undefined
  
  /**
    * The ARN of an IAM role to enable the AWS CloudHSM service to allocate an ENI on your behalf.
    */
  var IamRoleArn: typings.awsSdk.clientsCloudhsmMod.IamRoleArn
  
  /**
    * The SSH public key to install on the HSM.
    */
  var SshKey: typings.awsSdk.clientsCloudhsmMod.SshKey
  
  /**
    * The identifier of the subnet in your VPC in which to place the HSM.
    */
  var SubnetId: typings.awsSdk.clientsCloudhsmMod.SubnetId
  
  var SubscriptionType: typings.awsSdk.clientsCloudhsmMod.SubscriptionType
