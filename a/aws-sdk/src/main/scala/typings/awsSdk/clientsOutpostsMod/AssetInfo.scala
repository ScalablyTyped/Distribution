...
trait AssetInfo extends StObject {
  ...
  /**
    ...
    */
  var AssetLocation: js.UndefOr[typings.awsSdk.clientsOutpostsMod.AssetLocation] = js.undefined
  
  /**
    *  The type of the asset. 
    */
  var AssetType: js.UndefOr[typings.awsSdk.clientsOutpostsMod.AssetType] = js.undefined
  
  /**
    *  Information about compute hardware assets. 
    */
  var ComputeAttributes: js.UndefOr[typings.awsSdk.clientsOutpostsMod.ComputeAttributes] = js.undefined
  
  /**
    *  The rack ID of the asset. 
    */
  var RackId: js.UndefOr[typings.awsSdk.clientsOutpostsMod.RackId] = js.undefined
}
object AssetInfo {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: AssetInfo] (val x: Self) extends AnyVal {
