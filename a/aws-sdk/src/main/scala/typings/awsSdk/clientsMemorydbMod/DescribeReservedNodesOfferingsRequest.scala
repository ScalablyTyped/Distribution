...
trait DescribeReservedNodesOfferingsRequest extends StObject {
...
object DescribeReservedNodesOfferingsRequest {
  ...
  inline def apply(): DescribeReservedNodesOfferingsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeReservedNodesOfferingsRequest]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeReservedNodesOfferingsRequest] (val x: Self) extends AnyVal {
