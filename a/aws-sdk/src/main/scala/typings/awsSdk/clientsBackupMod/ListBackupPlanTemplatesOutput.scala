...
trait ListBackupPlanTemplatesOutput extends StObject {
  ...
  /**
    ...
    */
  var BackupPlanTemplatesList: js.UndefOr[typings.awsSdk.clientsBackupMod.BackupPlanTemplatesList] = js.undefined
...
object ListBackupPlanTemplatesOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListBackupPlanTemplatesOutput] (val x: Self) extends AnyVal {
