...
trait ListBackupPlansOutput extends StObject {
  ...
  /**
    ...
    */
  var BackupPlansList: js.UndefOr[typings.awsSdk.clientsBackupMod.BackupPlansList] = js.undefined
...
object ListBackupPlansOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ListBackupPlansOutput] (val x: Self) extends AnyVal {
