...
trait BackupPlansListMember extends StObject {
  ...
  /**
    ...
    */
  var BackupPlanName: js.UndefOr[typings.awsSdk.clientsBackupMod.BackupPlanName] = js.undefined
...
object BackupPlansListMember {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: BackupPlansListMember] (val x: Self) extends AnyVal {
