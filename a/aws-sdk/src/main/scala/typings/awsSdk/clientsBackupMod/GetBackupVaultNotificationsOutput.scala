...
trait GetBackupVaultNotificationsOutput extends StObject {
  ...
  /**
    ...
    */
  var BackupVaultEvents: js.UndefOr[typings.awsSdk.clientsBackupMod.BackupVaultEvents] = js.undefined
...
object GetBackupVaultNotificationsOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBackupVaultNotificationsOutput] (val x: Self) extends AnyVal {
