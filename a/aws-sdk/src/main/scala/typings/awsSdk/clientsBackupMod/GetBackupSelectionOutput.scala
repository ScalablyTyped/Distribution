...
trait GetBackupSelectionOutput extends StObject {
  ...
  /**
    ...
    */
  var BackupSelection: js.UndefOr[typings.awsSdk.clientsBackupMod.BackupSelection] = js.undefined
...
object GetBackupSelectionOutput {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: GetBackupSelectionOutput] (val x: Self) extends AnyVal {
