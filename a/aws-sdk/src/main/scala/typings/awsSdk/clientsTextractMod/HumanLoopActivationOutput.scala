...
trait HumanLoopActivationOutput extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[typings.awsSdk.clientsTextractMod.HumanLoopActivationConditionsEvaluationResults] = js.undefined
  
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typings.awsSdk.clientsTextractMod.HumanLoopActivationReasons] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typings.awsSdk.clientsTextractMod.HumanLoopArn] = js.undefined
}
