...
import typings.azureMsalNode.clientApplicationMod.ClientApplication
import typings.azureMsalNode.configurationMod.Configuration
import typings.azureMsalNode.deviceCodeRequestMod.DeviceCodeRequest
import typings.azureMsalNode.interactiveRequestMod.InteractiveRequest
import typings.azureMsalNode.ipublicclientapplicationMod.IPublicClientApplication
