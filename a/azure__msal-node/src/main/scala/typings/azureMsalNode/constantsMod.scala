...
object constantsMod {
  ...
  object ApiId extends StObject {
    ...
    sealed trait acquireTokenByClientCredential
      extends StObject
         with ApiId
    /* 771 */ val acquireTokenByClientCredential: typings.azureMsalNode.constantsMod.ApiId.acquireTokenByClientCredential & Double = js.native
    
    @js.native
    sealed trait acquireTokenByCode
      extends StObject
         with ApiId
    /* 871 */ val acquireTokenByCode: typings.azureMsalNode.constantsMod.ApiId.acquireTokenByCode & Double = js.native
    
    @js.native
    sealed trait acquireTokenByDeviceCode
      extends StObject
         with ApiId
    /* 671 */ val acquireTokenByDeviceCode: typings.azureMsalNode.constantsMod.ApiId.acquireTokenByDeviceCode & Double = js.native
    
    @js.native
    sealed trait acquireTokenByRefreshToken
      extends StObject
         with ApiId
    /* 872 */ val acquireTokenByRefreshToken: typings.azureMsalNode.constantsMod.ApiId.acquireTokenByRefreshToken & Double = js.native
    
    @js.native
    sealed trait acquireTokenByUsernamePassword
      extends StObject
         with ApiId
    /* 371 */ val acquireTokenByUsernamePassword: typings.azureMsalNode.constantsMod.ApiId.acquireTokenByUsernamePassword & Double = js.native
    
    @js.native
    sealed trait acquireTokenSilent
      extends StObject
         with ApiId
    /* 62 */ val acquireTokenSilent: typings.azureMsalNode.constantsMod.ApiId.acquireTokenSilent & Double = js.native
  }
  ...
  object HttpMethod extends StObject {
    ...
    sealed trait GET
      extends StObject
         with HttpMethod
    /* "get" */ val GET: typings.azureMsalNode.constantsMod.HttpMethod.GET & String = js.native
    
    @js.native
    sealed trait POST
      extends StObject
         with HttpMethod
    /* "post" */ val POST: typings.azureMsalNode.constantsMod.HttpMethod.POST & String = js.native
  }
  ...
  object HttpStatus extends StObject {
    ...
    sealed trait OK
      extends StObject
         with HttpStatus
    /* 200 */ val OK: typings.azureMsalNode.constantsMod.HttpStatus.OK & Double = js.native
    
    @js.native
    sealed trait REDIRECT
      extends StObject
         with HttpStatus
    /* 302 */ val REDIRECT: typings.azureMsalNode.constantsMod.HttpStatus.REDIRECT & Double = js.native
  }
