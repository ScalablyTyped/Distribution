...
trait Expression extends js.Object {
  ...
  def add(other: algebraDotJsLib.Union): Expression = js.native
  def add(other: algebraDotJsLib.Union, simplify: scala.Boolean): Expression = js.native
  ...
  def multiply(other: algebraDotJsLib.Union): Expression = js.native
  def multiply(other: algebraDotJsLib.Union, simplify: scala.Boolean): Expression = js.native
  ...
  def subtract(other: algebraDotJsLib.Union): Expression = js.native
  def subtract(other: algebraDotJsLib.Union, simplify: scala.Boolean): Expression = js.native
