package typings.atAwsDashSdkClientDashCognitoDashIdentityDashBrowser.typesUnlinkIdentityInputMod
...
object UnlinkIdentityInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(IdentityId = IdentityId, Logins = Logins.asInstanceOf[js.Any], LoginsToRemove = LoginsToRemove.asInstanceOf[js.Any])
