...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/GetIdentityPoolRolesExceptionsUnion", JSImport.Namespace)
@js.native
object typesGetIdentityPoolRolesExceptionsUnionMod extends js.Object {
