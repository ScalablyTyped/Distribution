...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/UnlinkDeveloperIdentityInput", JSImport.Namespace)
@js.native
object typesUnlinkDeveloperIdentityInputMod extends js.Object {
  @js.native
