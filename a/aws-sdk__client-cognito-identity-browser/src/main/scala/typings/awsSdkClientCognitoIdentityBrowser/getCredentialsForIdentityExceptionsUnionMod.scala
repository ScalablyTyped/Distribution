...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/GetCredentialsForIdentityExceptionsUnion", JSImport.Namespace)
@js.native
object getCredentialsForIdentityExceptionsUnionMod extends js.Object {
