...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/DescribeIdentityExceptionsUnion", JSImport.Namespace)
@js.native
object describeIdentityExceptionsUnionMod extends js.Object {
