...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/GetOpenIdTokenForDeveloperIdentityExceptionsUnion", JSImport.Namespace)
@js.native
object getOpenIdTokenForDeveloperIdentityExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCognitoIdentityBrowser.typesDeveloperUserAlreadyRegisteredExceptionMod.DeveloperUserAlreadyRegisteredException
  */
