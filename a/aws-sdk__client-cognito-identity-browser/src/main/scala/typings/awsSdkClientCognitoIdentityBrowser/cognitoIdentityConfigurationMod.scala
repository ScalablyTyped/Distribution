...
object cognitoIdentityConfigurationMod {
  ...
  object CognitoIdentityConfiguration {
    ...
    @scala.inline
    def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): CognitoIdentityConfiguration = {
    ...
    @scala.inline
    implicit class CognitoIdentityConfigurationMutableBuilder[Self <: CognitoIdentityConfiguration] (val x: Self) extends AnyVal {
  ...
  object CognitoIdentityResolvableConfiguration {
    ...
    @scala.inline
    implicit class CognitoIdentityResolvableConfigurationMutableBuilder[Self <: CognitoIdentityResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait CognitoIdentityResolvedConfiguration
    ...
    def base64Decoder_MCognitoIdentityResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MCognitoIdentityResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MCognitoIdentityResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("utf8Decoder")
    def utf8Decoder_MCognitoIdentityResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MCognitoIdentityResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
  ...
  object CognitoIdentityResolvedConfiguration {
    ...
    @scala.inline
    implicit class CognitoIdentityResolvedConfigurationMutableBuilder[Self <: CognitoIdentityResolvedConfiguration] (val x: Self) extends AnyVal {
