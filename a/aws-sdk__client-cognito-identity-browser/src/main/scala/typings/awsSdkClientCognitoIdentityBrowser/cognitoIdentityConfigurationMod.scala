...
object cognitoIdentityConfigurationMod {
  ...
  trait CognitoIdentityConfiguration extends StObject {
  ...
  object CognitoIdentityConfiguration {
    ...
    inline def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): CognitoIdentityConfiguration = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CognitoIdentityConfiguration] (val x: Self) extends AnyVal {
  ...
  trait CognitoIdentityResolvableConfiguration
    extends StObject
       with CognitoIdentityConfiguration {
  ...
  object CognitoIdentityResolvableConfiguration {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[CognitoIdentityResolvableConfiguration]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CognitoIdentityResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait CognitoIdentityResolvedConfiguration
    extends StObject
       with CognitoIdentityConfiguration {
    ...
    def base64Decoder_MCognitoIdentityResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MCognitoIdentityResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MCognitoIdentityResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MCognitoIdentityResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_CognitoIdentityResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_CognitoIdentityResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<Blob> */ Any
    
    @JSName("region")
    def region_MCognitoIdentityResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_CognitoIdentityResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_CognitoIdentityResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_CognitoIdentityResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_CognitoIdentityResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MCognitoIdentityResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MCognitoIdentityResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    def urlParser_MCognitoIdentityResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MCognitoIdentityResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MCognitoIdentityResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
    var utf8Encoder_Original: Encoder
  }
  object CognitoIdentityResolvedConfiguration {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[CognitoIdentityResolvedConfiguration]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: CognitoIdentityResolvedConfiguration] (val x: Self) extends AnyVal {
