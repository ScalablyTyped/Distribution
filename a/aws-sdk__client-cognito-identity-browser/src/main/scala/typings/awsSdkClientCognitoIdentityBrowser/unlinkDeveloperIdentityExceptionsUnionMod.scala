...
@JSImport("@aws-sdk/client-cognito-identity-browser/types/UnlinkDeveloperIdentityExceptionsUnion", JSImport.Namespace)
@js.native
object unlinkDeveloperIdentityExceptionsUnionMod extends js.Object {
