package typings.awsSdkClientCognitoIdentityBrowser.typesDeleteIdentitiesInputMod
...
trait DeleteIdentitiesInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var IdentityIdsToDelete: js.Array[String] | Iterable[String] = js.native
}
object DeleteIdentitiesInput {
  
  @scala.inline
  def apply(IdentityIdsToDelete: js.Array[String] | Iterable[String]): DeleteIdentitiesInput = {
  ...
  implicit class DeleteIdentitiesInputOps[Self <: DeleteIdentitiesInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setIdentityIdsToDelete(value: js.Array[String] | Iterable[String]): Self = this.set("IdentityIdsToDelete", value.asInstanceOf[js.Any])
