package typings.amapDashJsDashApiDashDistrictDashSearch.AMapNs
...
import typings.amapDashJsDashApiDashDistrictDashSearch.AMapNs.DistrictSearchNs.Options
import typings.amapDashJsDashApiDashDistrictDashSearch.AMapNs.DistrictSearchNs.SearchResult
