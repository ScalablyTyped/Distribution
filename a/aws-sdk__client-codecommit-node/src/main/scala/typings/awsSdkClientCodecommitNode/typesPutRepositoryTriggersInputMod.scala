...
object typesPutRepositoryTriggersInputMod {
  ...
  trait PutRepositoryTriggersInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var triggers: js.Array[RepositoryTrigger] | Iterable[RepositoryTrigger] = js.native
  }
  object PutRepositoryTriggersInput {
    
    @scala.inline
    def apply(repositoryName: String, triggers: js.Array[RepositoryTrigger] | Iterable[RepositoryTrigger]): PutRepositoryTriggersInput = {
