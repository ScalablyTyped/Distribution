...
object getCommitExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesCommitIdDoesNotExistExceptionMod.CommitIdDoesNotExistException
  ...
  */
  trait GetCommitExceptionsUnion extends StObject
  object GetCommitExceptionsUnion {
    
    inline def CommitIdDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesCommitIdDoesNotExistExceptionMod.CommitIdDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "CommitIdDoesNotExistException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesCommitIdDoesNotExistExceptionMod.CommitIdDoesNotExistException]
    }
