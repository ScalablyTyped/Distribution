...
trait MaximumOpenPullRequestsExceededException
  ...
  @JSName("name")
  var name_MaximumOpenPullRequestsExceededException: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.MaximumOpenPullRequestsExceededException = js.native
}
