package typings.awsSdkClientCodecommitNode.typesGetRepositoryInputMod
...
@js.native
trait GetRepositoryInput extends InputTypesUnion {
  /**
...
object GetRepositoryInput {
  @scala.inline
  def apply(repositoryName: String): GetRepositoryInput = {
