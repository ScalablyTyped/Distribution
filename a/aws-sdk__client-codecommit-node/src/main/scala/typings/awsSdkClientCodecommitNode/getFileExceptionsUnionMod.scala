...
object getFileExceptionsUnionMod {
  ...
  */
  ...
  object GetFileExceptionsUnion {
    ...
    @scala.inline
    def FileTooLargeException(): typings.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException = {
    ...
    @scala.inline
    def InvalidCommitException(): typings.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException = {
