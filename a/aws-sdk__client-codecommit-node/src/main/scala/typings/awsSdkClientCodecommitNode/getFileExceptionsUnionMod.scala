...
object getFileExceptionsUnionMod {
  ...
  */
  trait GetFileExceptionsUnion extends StObject
  object GetFileExceptionsUnion {
    ...
    @scala.inline
    def FileTooLargeException(name: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.FileTooLargeException): typings.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException]
    }
    
    @scala.inline
    def InvalidCommitException(name: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.InvalidCommitException): typings.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
