...
@JSImport("@aws-sdk/client-codecommit-node/types/DeleteRepositoryExceptionsUnion", JSImport.Namespace)
@js.native
object deleteRepositoryExceptionsUnionMod extends js.Object {
