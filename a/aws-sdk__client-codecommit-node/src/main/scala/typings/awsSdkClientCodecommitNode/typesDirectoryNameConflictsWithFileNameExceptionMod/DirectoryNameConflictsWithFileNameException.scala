...
trait DirectoryNameConflictsWithFileNameException
  ...
  @JSName("name")
  var name_DirectoryNameConflictsWithFileNameException: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.DirectoryNameConflictsWithFileNameException = js.native
}
