...
object typesDescribePullRequestEventsExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesInvalidPullRequestEventTypeExceptionMod.InvalidPullRequestEventTypeException
    - typings.awsSdkClientCodecommitNode.typesInvalidActorArnExceptionMod.InvalidActorArnException
    - typings.awsSdkClientCodecommitNode.typesActorDoesNotExistExceptionMod.ActorDoesNotExistException
  ...
  */
  trait DescribePullRequestEventsExceptionsUnion extends StObject
  object DescribePullRequestEventsExceptionsUnion {
    
    inline def ActorDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesActorDoesNotExistExceptionMod.ActorDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "ActorDoesNotExistException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesActorDoesNotExistExceptionMod.ActorDoesNotExistException]
    }
    ...
    inline def InvalidActorArnException(): typings.awsSdkClientCodecommitNode.typesInvalidActorArnExceptionMod.InvalidActorArnException = {
      val __obj = js.Dynamic.literal(name = "InvalidActorArnException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidActorArnExceptionMod.InvalidActorArnException]
    }
    ...
    inline def InvalidPullRequestEventTypeException(): typings.awsSdkClientCodecommitNode.typesInvalidPullRequestEventTypeExceptionMod.InvalidPullRequestEventTypeException = {
      val __obj = js.Dynamic.literal(name = "InvalidPullRequestEventTypeException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidPullRequestEventTypeExceptionMod.InvalidPullRequestEventTypeException]
    }
