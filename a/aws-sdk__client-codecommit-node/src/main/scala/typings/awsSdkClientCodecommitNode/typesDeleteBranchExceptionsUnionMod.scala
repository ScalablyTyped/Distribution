...
object typesDeleteBranchExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesDefaultBranchCannotBeDeletedExceptionMod.DefaultBranchCannotBeDeletedException
  ...
  */
  ...
  object DeleteBranchExceptionsUnion {
    ...
    inline def DefaultBranchCannotBeDeletedException(): typings.awsSdkClientCodecommitNode.typesDefaultBranchCannotBeDeletedExceptionMod.DefaultBranchCannotBeDeletedException = {
      val __obj = js.Dynamic.literal(name = "DefaultBranchCannotBeDeletedException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesDefaultBranchCannotBeDeletedExceptionMod.DefaultBranchCannotBeDeletedException]
    }
