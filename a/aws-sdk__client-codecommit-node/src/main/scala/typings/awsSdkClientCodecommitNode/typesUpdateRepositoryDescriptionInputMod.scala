...
@JSImport("@aws-sdk/client-codecommit-node/types/UpdateRepositoryDescriptionInput", JSImport.Namespace)
@js.native
object typesUpdateRepositoryDescriptionInputMod extends js.Object {
  @js.native
