...
object createRepositoryExceptionsUnionMod {
  ...
  */
  ...
  object CreateRepositoryExceptionsUnion {
    ...
    @scala.inline
    def InvalidRepositoryDescriptionException(): typings.awsSdkClientCodecommitNode.typesInvalidRepositoryDescriptionExceptionMod.InvalidRepositoryDescriptionException = {
    ...
    @scala.inline
    def RepositoryLimitExceededException(): typings.awsSdkClientCodecommitNode.typesRepositoryLimitExceededExceptionMod.RepositoryLimitExceededException = {
