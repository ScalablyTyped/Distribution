package typings.awsSdkClientCodecommitNode.typesListBranchesInputMod
...
@js.native
trait ListBranchesInput extends InputTypesUnion {
...
object ListBranchesInput {
  ...
  @scala.inline
  def apply(repositoryName: String): ListBranchesInput = {
