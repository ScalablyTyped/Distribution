...
object typesGetFolderExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException
  ...
  */
  ...
  object GetFolderExceptionsUnion {
    ...
    inline def FolderDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "FolderDoesNotExistException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException]
    }
