...
object typesCreatePullRequestOutputMod {
  
  trait CreatePullRequestOutput
    extends StObject
  ...
  object CreatePullRequestOutput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CreatePullRequestOutput] (val x: Self) extends AnyVal {
