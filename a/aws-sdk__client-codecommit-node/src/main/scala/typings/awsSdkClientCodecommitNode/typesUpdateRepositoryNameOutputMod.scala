...
object typesUpdateRepositoryNameOutputMod {
  
  trait UpdateRepositoryNameOutput
    extends StObject
  ...
  object UpdateRepositoryNameOutput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: UpdateRepositoryNameOutput] (val x: Self) extends AnyVal {
