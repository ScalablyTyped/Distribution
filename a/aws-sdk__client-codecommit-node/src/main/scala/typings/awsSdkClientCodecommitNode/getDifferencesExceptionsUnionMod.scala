...
@JSImport("@aws-sdk/client-codecommit-node/types/GetDifferencesExceptionsUnion", JSImport.Namespace)
@js.native
object getDifferencesExceptionsUnionMod extends js.Object {
