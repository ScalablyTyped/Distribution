...
object typesUpdatePullRequestStatusInputMod {
  
  trait UpdatePullRequestStatusInput
    extends StObject
  ...
  object UpdatePullRequestStatusInput {
    ...
    inline def apply(pullRequestId: String, pullRequestStatus: OPEN | CLOSED | String): UpdatePullRequestStatusInput = {
