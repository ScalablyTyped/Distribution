...
object typesGetMergeConflictsExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesMergeOptionRequiredExceptionMod.MergeOptionRequiredException
    - typings.awsSdkClientCodecommitNode.typesInvalidMergeOptionExceptionMod.InvalidMergeOptionException
    - typings.awsSdkClientCodecommitNode.typesInvalidDestinationCommitSpecifierExceptionMod.InvalidDestinationCommitSpecifierException
    - typings.awsSdkClientCodecommitNode.typesInvalidSourceCommitSpecifierExceptionMod.InvalidSourceCommitSpecifierException
    ...
    - typings.awsSdkClientCodecommitNode.typesTipsDivergenceExceededExceptionMod.TipsDivergenceExceededException
  ...
  */
  trait GetMergeConflictsExceptionsUnion extends StObject
  object GetMergeConflictsExceptionsUnion {
    ...
    inline def InvalidDestinationCommitSpecifierException(): typings.awsSdkClientCodecommitNode.typesInvalidDestinationCommitSpecifierExceptionMod.InvalidDestinationCommitSpecifierException = {
      val __obj = js.Dynamic.literal(name = "InvalidDestinationCommitSpecifierException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidDestinationCommitSpecifierExceptionMod.InvalidDestinationCommitSpecifierException]
    }
    
    inline def InvalidMergeOptionException(): typings.awsSdkClientCodecommitNode.typesInvalidMergeOptionExceptionMod.InvalidMergeOptionException = {
      val __obj = js.Dynamic.literal(name = "InvalidMergeOptionException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidMergeOptionExceptionMod.InvalidMergeOptionException]
    }
    ...
    inline def InvalidSourceCommitSpecifierException(): typings.awsSdkClientCodecommitNode.typesInvalidSourceCommitSpecifierExceptionMod.InvalidSourceCommitSpecifierException = {
      val __obj = js.Dynamic.literal(name = "InvalidSourceCommitSpecifierException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidSourceCommitSpecifierExceptionMod.InvalidSourceCommitSpecifierException]
    }
    
    inline def MergeOptionRequiredException(): typings.awsSdkClientCodecommitNode.typesMergeOptionRequiredExceptionMod.MergeOptionRequiredException = {
      val __obj = js.Dynamic.literal(name = "MergeOptionRequiredException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesMergeOptionRequiredExceptionMod.MergeOptionRequiredException]
    }
    ...
    inline def TipsDivergenceExceededException(): typings.awsSdkClientCodecommitNode.typesTipsDivergenceExceededExceptionMod.TipsDivergenceExceededException = {
      val __obj = js.Dynamic.literal(name = "TipsDivergenceExceededException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesTipsDivergenceExceededExceptionMod.TipsDivergenceExceededException]
    }
  }
}
