...
object InvalidOrderException {
  ...
  implicit class InvalidOrderExceptionOps[Self <: InvalidOrderException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.InvalidOrderException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
