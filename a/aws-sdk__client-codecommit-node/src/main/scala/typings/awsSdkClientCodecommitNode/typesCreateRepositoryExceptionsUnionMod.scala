...
object typesCreateRepositoryExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesRepositoryLimitExceededExceptionMod.RepositoryLimitExceededException
  ...
  */
  trait CreateRepositoryExceptionsUnion extends StObject
  object CreateRepositoryExceptionsUnion {
    ...
    inline def RepositoryLimitExceededException(): typings.awsSdkClientCodecommitNode.typesRepositoryLimitExceededExceptionMod.RepositoryLimitExceededException = {
      val __obj = js.Dynamic.literal(name = "RepositoryLimitExceededException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesRepositoryLimitExceededExceptionMod.RepositoryLimitExceededException]
    }
