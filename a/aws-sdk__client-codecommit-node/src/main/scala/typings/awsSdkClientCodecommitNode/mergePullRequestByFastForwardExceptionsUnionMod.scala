...
object mergePullRequestByFastForwardExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesTipOfSourceReferenceIsDifferentExceptionMod.TipOfSourceReferenceIsDifferentException
  ...
  */
  trait MergePullRequestByFastForwardExceptionsUnion extends StObject
  object MergePullRequestByFastForwardExceptionsUnion {
    ...
    inline def ManualMergeRequiredException(): typings.awsSdkClientCodecommitNode.typesManualMergeRequiredExceptionMod.ManualMergeRequiredException = {
      val __obj = js.Dynamic.literal(name = "ManualMergeRequiredException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesManualMergeRequiredExceptionMod.ManualMergeRequiredException]
    }
    ...
    inline def ReferenceDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesReferenceDoesNotExistExceptionMod.ReferenceDoesNotExistException = {
    ...
    inline def TipOfSourceReferenceIsDifferentException(): typings.awsSdkClientCodecommitNode.typesTipOfSourceReferenceIsDifferentExceptionMod.TipOfSourceReferenceIsDifferentException = {
      val __obj = js.Dynamic.literal(name = "TipOfSourceReferenceIsDifferentException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesTipOfSourceReferenceIsDifferentExceptionMod.TipOfSourceReferenceIsDifferentException]
    }
  }
}
