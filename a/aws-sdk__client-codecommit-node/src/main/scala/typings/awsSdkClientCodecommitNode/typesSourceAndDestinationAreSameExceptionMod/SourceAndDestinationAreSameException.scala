...
trait SourceAndDestinationAreSameException
  ...
  @JSName("name")
  var name_SourceAndDestinationAreSameException: typings.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.SourceAndDestinationAreSameException = js.native
}
