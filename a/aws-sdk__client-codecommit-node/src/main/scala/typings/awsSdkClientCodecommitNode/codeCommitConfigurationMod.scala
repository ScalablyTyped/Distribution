...
object codeCommitConfigurationMod {
  ...
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<CodeCommitResolvableConfiguration, CodeCommitResolvedConfiguration> */ js.Any = js.native
  ...
  object CodeCommitConfiguration {
    ...
    @scala.inline
    implicit class CodeCommitConfigurationMutableBuilder[Self <: CodeCommitConfiguration] (val x: Self) extends AnyVal {
  ...
  object CodeCommitResolvableConfiguration {
    ...
    @scala.inline
    implicit class CodeCommitResolvableConfigurationMutableBuilder[Self <: CodeCommitResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  trait CodeCommitResolvedConfiguration
    ...
    def base64Decoder_MCodeCommitResolvedConfiguration(input: String): Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MCodeCommitResolvedConfiguration(input: Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MCodeCommitResolvedConfiguration(stream: js.Any): js.Promise[Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("utf8Decoder")
    def utf8Decoder_MCodeCommitResolvedConfiguration(input: String): Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MCodeCommitResolvedConfiguration(input: Uint8Array): String
    @JSName("utf8Encoder")
  ...
  object CodeCommitResolvedConfiguration {
    ...
    @scala.inline
    implicit class CodeCommitResolvedConfigurationMutableBuilder[Self <: CodeCommitResolvedConfiguration] (val x: Self) extends AnyVal {
