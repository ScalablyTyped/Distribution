package typings.awsSdkClientCodecommitNode.typesCreateBranchOutputMod
...
object CreateBranchOutput {
  ...
  @scala.inline
  implicit class CreateBranchOutputOps[Self <: CreateBranchOutput] (val x: Self) extends AnyVal {
