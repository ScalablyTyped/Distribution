...
object typesGetDifferencesExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.awsSdkClientCodecommitNode.typesCommitRequiredExceptionMod.CommitRequiredException
    - typings.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException
  ...
  */
  trait GetDifferencesExceptionsUnion extends StObject
  object GetDifferencesExceptionsUnion {
    
    inline def CommitDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesCommitDoesNotExistExceptionMod.CommitDoesNotExistException = {
    ...
    inline def CommitRequiredException(): typings.awsSdkClientCodecommitNode.typesCommitRequiredExceptionMod.CommitRequiredException = {
      val __obj = js.Dynamic.literal(name = "CommitRequiredException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesCommitRequiredExceptionMod.CommitRequiredException]
    }
    ...
    inline def InvalidCommitException(): typings.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException = {
      val __obj = js.Dynamic.literal(name = "InvalidCommitException")
      __obj.asInstanceOf[typings.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException]
    }
    
    inline def InvalidCommitIdException(): typings.awsSdkClientCodecommitNode.typesInvalidCommitIdExceptionMod.InvalidCommitIdException = {
    ...
    inline def InvalidMaxResultsException(): typings.awsSdkClientCodecommitNode.typesInvalidMaxResultsExceptionMod.InvalidMaxResultsException = {
    ...
    inline def PathDoesNotExistException(): typings.awsSdkClientCodecommitNode.typesPathDoesNotExistExceptionMod.PathDoesNotExistException = {
