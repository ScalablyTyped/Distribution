package typings.atAwsDashSdkClientDashCodecommitDashNode.typesEncryptionIntegrityChecksFailedExceptionMod
...
trait EncryptionIntegrityChecksFailedException
  ...
  @JSName("name")
  var name_EncryptionIntegrityChecksFailedException: typings.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.EncryptionIntegrityChecksFailedException
}

object EncryptionIntegrityChecksFailedException {
  @scala.inline
  def apply(
    details: _EncryptionIntegrityChecksFailedExceptionDetails,
    message: String,
    name: typings.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.EncryptionIntegrityChecksFailedException,
    stack: String = null
