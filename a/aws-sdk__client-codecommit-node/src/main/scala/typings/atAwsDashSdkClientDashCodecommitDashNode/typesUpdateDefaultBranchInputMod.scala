...
@JSImport("@aws-sdk/client-codecommit-node/types/UpdateDefaultBranchInput", JSImport.Namespace)
@js.native
object typesUpdateDefaultBranchInputMod extends js.Object {
  @js.native
  trait UpdateDefaultBranchInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var defaultBranchName: String = js.native
    /**
