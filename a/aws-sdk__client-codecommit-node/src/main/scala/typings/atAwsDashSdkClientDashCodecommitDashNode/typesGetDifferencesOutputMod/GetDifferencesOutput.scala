package typings.atAwsDashSdkClientDashCodecommitDashNode.typesGetDifferencesOutputMod
...
trait GetDifferencesOutput extends OutputTypesUnion {
  ...
  /**
    ...
    */
  var differences: js.UndefOr[js.Array[_UnmarshalledDifference]] = js.undefined
}
