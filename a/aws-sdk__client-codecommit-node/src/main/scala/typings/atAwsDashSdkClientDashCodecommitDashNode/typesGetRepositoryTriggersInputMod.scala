...
@JSImport("@aws-sdk/client-codecommit-node/types/GetRepositoryTriggersInput", JSImport.Namespace)
@js.native
object typesGetRepositoryTriggersInputMod extends js.Object {
  @js.native
  trait GetRepositoryTriggersInput extends InputTypesUnion {
    /**
