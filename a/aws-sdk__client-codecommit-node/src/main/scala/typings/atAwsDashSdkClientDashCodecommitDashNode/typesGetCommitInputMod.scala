...
@JSImport("@aws-sdk/client-codecommit-node/types/GetCommitInput", JSImport.Namespace)
@js.native
object typesGetCommitInputMod extends js.Object {
  @js.native
  trait GetCommitInput extends InputTypesUnion {
    /**
