...
@JSImport("@aws-sdk/client-codecommit-node/types/TestRepositoryTriggersInput", JSImport.Namespace)
@js.native
object typesTestRepositoryTriggersInputMod extends js.Object {
  @js.native
