...
trait EncryptionKeyAccessDeniedException
  ...
  @JSName("name")
  var name_EncryptionKeyAccessDeniedException: typings.atAwsDashSdkClientDashCodecommitDashNode.atAwsDashSdkClientDashCodecommitDashNodeStrings.EncryptionKeyAccessDeniedException = js.native
}
