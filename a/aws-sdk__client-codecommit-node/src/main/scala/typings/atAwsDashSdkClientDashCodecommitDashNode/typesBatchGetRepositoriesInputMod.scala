...
@JSImport("@aws-sdk/client-codecommit-node/types/BatchGetRepositoriesInput", JSImport.Namespace)
@js.native
object typesBatchGetRepositoriesInputMod extends js.Object {
  @js.native
  trait BatchGetRepositoriesInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var repositoryNames: js.Array[String] | Iterable[String] = js.native
  }
