...
trait BaseProps extends js.Object {
  ...
  var editView: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  /** Component to be shown in an @atlaskit/inline-dialog when edit view is open. */
  var invalidMessage: js.UndefOr[reactLib.reactMod.ReactElement] = js.undefined
  ...
  var readView: reactLib.reactMod.ReactElement
...
object BaseProps {
  ...
  def apply(
    ...
    readView: reactLib.reactMod.ReactElement,
    ...
    editView: reactLib.reactMod.ReactElement = null,
    invalidMessage: reactLib.reactMod.ReactElement = null,
