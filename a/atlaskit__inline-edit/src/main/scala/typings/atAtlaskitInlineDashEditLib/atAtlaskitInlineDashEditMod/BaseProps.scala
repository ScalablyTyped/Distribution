...
trait BaseProps extends js.Object {
  ...
  var editView: js.UndefOr[reactLib.reactMod.ReactElement[_]] = js.undefined
  /** Component to be shown in an @atlaskit/inline-dialog when edit view is open. */
  var invalidMessage: js.UndefOr[reactLib.reactMod.ReactElement[_]] = js.undefined
  ...
  var readView: reactLib.reactMod.ReactElement[_]
...
object BaseProps {
  ...
  def apply(
    ...
    readView: reactLib.reactMod.ReactElement[_],
    ...
    editView: reactLib.reactMod.ReactElement[_] = null,
    invalidMessage: reactLib.reactMod.ReactElement[_] = null,
