...
object iconsTwitterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TwitterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTwitterOutlinedMod.foo` */
