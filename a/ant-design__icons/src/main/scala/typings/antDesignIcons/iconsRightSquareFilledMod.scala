...
object iconsRightSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RightSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRightSquareFilledMod.foo` */
