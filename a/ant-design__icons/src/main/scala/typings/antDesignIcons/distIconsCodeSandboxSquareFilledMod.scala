...
object distIconsCodeSandboxSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CodeSandboxSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCodeSandboxSquareFilledMod.foo` */
