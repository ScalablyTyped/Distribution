...
object antDesignIconsHeartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/HeartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsHeartOutlinedMod.foo` */
