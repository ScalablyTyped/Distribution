...
object iconsInsertRowLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InsertRowLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInsertRowLeftOutlinedMod.foo` */
