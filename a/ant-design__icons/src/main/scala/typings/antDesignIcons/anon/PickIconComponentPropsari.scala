...
import typings.antDesignIcons.antDesignIconsStrings.`additions removals`
...
import typings.antDesignIcons.antDesignIconsStrings.`removals additions`
import typings.antDesignIcons.antDesignIconsStrings.`removals text`
import typings.antDesignIcons.antDesignIconsStrings.`text additions`
import typings.antDesignIcons.antDesignIconsStrings.`text removals`
...
import typings.antDesignIcons.iconMod.CustomIconComponentProps
...
object PickIconComponentPropsari {
  
  @scala.inline
  def apply(): PickIconComponentPropsari = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PickIconComponentPropsari]
  }
  
  @scala.inline
  implicit class PickIconComponentPropsariOps[Self <: PickIconComponentPropsari] (val x: Self) extends AnyVal {
