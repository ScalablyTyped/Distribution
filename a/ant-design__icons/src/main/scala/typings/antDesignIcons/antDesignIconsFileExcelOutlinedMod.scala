...
object antDesignIconsFileExcelOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FileExcelOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFileExcelOutlinedMod.foo` */
