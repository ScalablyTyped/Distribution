...
object libIconsExclamationCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ExclamationCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsExclamationCircleFilledMod.foo` */
