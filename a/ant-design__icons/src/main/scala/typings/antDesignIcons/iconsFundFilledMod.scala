...
object iconsFundFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FundFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFundFilledMod.foo` */
