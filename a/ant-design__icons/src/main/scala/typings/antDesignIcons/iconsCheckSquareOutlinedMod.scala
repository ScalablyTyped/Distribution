...
object iconsCheckSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CheckSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCheckSquareOutlinedMod.foo` */
