...
object iconsControlFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ControlFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsControlFilledMod.foo` */
