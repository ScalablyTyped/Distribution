...
object antDesignIconsCloseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CloseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCloseOutlinedMod.foo` */
