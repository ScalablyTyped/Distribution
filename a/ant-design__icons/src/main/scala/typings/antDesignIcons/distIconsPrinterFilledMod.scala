...
object distIconsPrinterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PrinterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPrinterFilledMod.foo` */
