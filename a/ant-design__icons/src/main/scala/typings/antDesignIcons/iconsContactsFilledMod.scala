...
object iconsContactsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ContactsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsContactsFilledMod.foo` */
