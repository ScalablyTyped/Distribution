...
object antDesignIconsDingtalkCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DingtalkCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDingtalkCircleFilledMod.foo` */
