...
object distIconsFullscreenExitOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FullscreenExitOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFullscreenExitOutlinedMod.foo` */
