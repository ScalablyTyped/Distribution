...
object iconsShrinkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShrinkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShrinkOutlinedMod.foo` */
