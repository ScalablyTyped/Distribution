...
object iconsIdcardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/IdcardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsIdcardFilledMod.foo` */
