...
object distIconsBarcodeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BarcodeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBarcodeOutlinedMod.foo` */
