...
object iconsLeftSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LeftSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLeftSquareTwoToneMod.foo` */
