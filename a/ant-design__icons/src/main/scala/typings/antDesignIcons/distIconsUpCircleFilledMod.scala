...
object distIconsUpCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UpCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUpCircleFilledMod.foo` */
