...
object antDesignIconsShopTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ShopTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsShopTwoToneMod.foo` */
