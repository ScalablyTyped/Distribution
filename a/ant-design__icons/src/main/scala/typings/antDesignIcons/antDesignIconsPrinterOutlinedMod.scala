...
object antDesignIconsPrinterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PrinterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPrinterOutlinedMod.foo` */
