...
object antDesignIconsDatabaseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DatabaseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDatabaseOutlinedMod.foo` */
