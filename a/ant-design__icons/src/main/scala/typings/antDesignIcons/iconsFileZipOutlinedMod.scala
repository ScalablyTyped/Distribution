...
object iconsFileZipOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileZipOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileZipOutlinedMod.foo` */
