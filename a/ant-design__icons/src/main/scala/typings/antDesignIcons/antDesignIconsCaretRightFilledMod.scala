...
object antDesignIconsCaretRightFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CaretRightFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCaretRightFilledMod.foo` */
