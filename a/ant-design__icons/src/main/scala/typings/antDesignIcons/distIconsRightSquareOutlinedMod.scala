...
object distIconsRightSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RightSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRightSquareOutlinedMod.foo` */
