...
object iconsUsergroupAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UsergroupAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUsergroupAddOutlinedMod.foo` */
