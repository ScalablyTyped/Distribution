...
object antDesignIconsFolderViewOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FolderViewOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFolderViewOutlinedMod.foo` */
