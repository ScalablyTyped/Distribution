...
object iconsFileAddFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileAddFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileAddFilledMod.foo` */
