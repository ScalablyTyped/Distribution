...
object distIconsInstagramFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/InstagramFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsInstagramFilledMod.foo` */
