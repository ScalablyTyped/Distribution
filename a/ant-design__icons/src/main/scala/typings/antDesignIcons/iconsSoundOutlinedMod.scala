...
object iconsSoundOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SoundOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSoundOutlinedMod.foo` */
