...
object distIconsStepForwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/StepForwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsStepForwardOutlinedMod.foo` */
