...
object iconsGoogleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GoogleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGoogleOutlinedMod.foo` */
