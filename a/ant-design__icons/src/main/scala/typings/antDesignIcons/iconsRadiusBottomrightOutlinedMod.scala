...
object iconsRadiusBottomrightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RadiusBottomrightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRadiusBottomrightOutlinedMod.foo` */
