...
object antDesignIconsFormOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FormOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFormOutlinedMod.foo` */
