...
object iconsCodeSandboxSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CodeSandboxSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCodeSandboxSquareFilledMod.foo` */
