...
object distIconsControlFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ControlFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsControlFilledMod.foo` */
