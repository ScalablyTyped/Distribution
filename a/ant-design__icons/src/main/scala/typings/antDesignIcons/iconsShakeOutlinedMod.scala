...
object iconsShakeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShakeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShakeOutlinedMod.foo` */
