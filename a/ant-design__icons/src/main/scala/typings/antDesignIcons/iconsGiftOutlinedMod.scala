...
object iconsGiftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GiftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGiftOutlinedMod.foo` */
