...
object iconsShopFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShopFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShopFilledMod.foo` */
