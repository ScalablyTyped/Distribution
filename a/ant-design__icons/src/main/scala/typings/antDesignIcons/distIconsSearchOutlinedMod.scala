...
object distIconsSearchOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SearchOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSearchOutlinedMod.foo` */
