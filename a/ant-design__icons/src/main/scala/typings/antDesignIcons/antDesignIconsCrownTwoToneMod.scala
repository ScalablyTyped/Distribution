...
object antDesignIconsCrownTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CrownTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCrownTwoToneMod.foo` */
