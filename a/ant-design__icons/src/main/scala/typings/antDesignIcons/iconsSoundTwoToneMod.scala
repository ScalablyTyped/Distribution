...
object iconsSoundTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SoundTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSoundTwoToneMod.foo` */
