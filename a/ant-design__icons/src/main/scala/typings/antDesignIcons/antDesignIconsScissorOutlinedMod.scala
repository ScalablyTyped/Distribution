...
object antDesignIconsScissorOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ScissorOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsScissorOutlinedMod.foo` */
