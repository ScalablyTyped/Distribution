...
object antDesignIconsUsergroupAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UsergroupAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUsergroupAddOutlinedMod.foo` */
