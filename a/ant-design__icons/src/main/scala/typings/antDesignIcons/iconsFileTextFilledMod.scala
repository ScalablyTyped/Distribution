...
object iconsFileTextFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileTextFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileTextFilledMod.foo` */
