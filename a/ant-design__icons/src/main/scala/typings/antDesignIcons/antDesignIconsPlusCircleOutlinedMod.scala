...
object antDesignIconsPlusCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PlusCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPlusCircleOutlinedMod.foo` */
