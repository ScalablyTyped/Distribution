...
object libIconsSlackSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SlackSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsSlackSquareOutlinedMod.foo` */
