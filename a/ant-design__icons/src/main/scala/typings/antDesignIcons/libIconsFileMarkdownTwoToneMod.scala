...
object libIconsFileMarkdownTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileMarkdownTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsFileMarkdownTwoToneMod.foo` */
