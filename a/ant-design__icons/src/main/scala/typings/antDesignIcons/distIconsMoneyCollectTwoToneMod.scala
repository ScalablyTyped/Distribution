...
object distIconsMoneyCollectTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MoneyCollectTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMoneyCollectTwoToneMod.foo` */
