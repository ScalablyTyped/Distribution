...
object antDesignIconsCheckSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CheckSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCheckSquareTwoToneMod.foo` */
