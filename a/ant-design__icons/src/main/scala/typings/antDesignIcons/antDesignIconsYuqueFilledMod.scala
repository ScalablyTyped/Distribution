...
object antDesignIconsYuqueFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/YuqueFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsYuqueFilledMod.foo` */
