...
object antDesignIconsReadFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ReadFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsReadFilledMod.foo` */
