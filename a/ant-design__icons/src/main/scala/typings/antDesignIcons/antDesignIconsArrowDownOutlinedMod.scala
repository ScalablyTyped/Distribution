...
object antDesignIconsArrowDownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ArrowDownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsArrowDownOutlinedMod.foo` */
