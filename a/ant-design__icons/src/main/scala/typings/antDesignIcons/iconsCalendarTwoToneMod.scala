...
object iconsCalendarTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CalendarTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCalendarTwoToneMod.foo` */
