...
object distIconsBellTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BellTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBellTwoToneMod.foo` */
