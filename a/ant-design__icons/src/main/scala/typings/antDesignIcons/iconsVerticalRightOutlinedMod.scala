...
object iconsVerticalRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/VerticalRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsVerticalRightOutlinedMod.foo` */
