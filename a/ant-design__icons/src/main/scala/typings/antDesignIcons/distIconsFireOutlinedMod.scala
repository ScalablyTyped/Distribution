...
object distIconsFireOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FireOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFireOutlinedMod.foo` */
