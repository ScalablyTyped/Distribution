...
object iconsFastForwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FastForwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFastForwardFilledMod.foo` */
