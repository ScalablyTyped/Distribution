...
object antDesignIconsFolderAddFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FolderAddFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFolderAddFilledMod.foo` */
