...
object antDesignIconsFileProtectOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FileProtectOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFileProtectOutlinedMod.foo` */
