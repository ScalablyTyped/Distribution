...
object antDesignIconsCloudOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CloudOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCloudOutlinedMod.foo` */
