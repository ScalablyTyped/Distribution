...
object antDesignIconsSlackCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SlackCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSlackCircleFilledMod.foo` */
