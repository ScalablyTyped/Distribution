...
object antDesignIconsThunderboltTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ThunderboltTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsThunderboltTwoToneMod.foo` */
