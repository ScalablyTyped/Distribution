...
object iconsSmileOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SmileOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSmileOutlinedMod.foo` */
