...
object antDesignIconsNumberOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/NumberOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsNumberOutlinedMod.foo` */
