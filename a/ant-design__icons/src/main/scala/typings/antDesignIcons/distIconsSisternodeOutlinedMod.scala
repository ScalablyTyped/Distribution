...
object distIconsSisternodeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SisternodeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSisternodeOutlinedMod.foo` */
