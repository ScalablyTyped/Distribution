...
object distIconsTagsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/TagsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsTagsFilledMod.foo` */
