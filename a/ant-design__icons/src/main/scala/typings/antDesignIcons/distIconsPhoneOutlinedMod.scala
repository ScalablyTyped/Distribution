...
object distIconsPhoneOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PhoneOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPhoneOutlinedMod.foo` */
