...
object iconsCameraOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CameraOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCameraOutlinedMod.foo` */
