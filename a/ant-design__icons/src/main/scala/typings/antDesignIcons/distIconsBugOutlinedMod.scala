...
object distIconsBugOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BugOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBugOutlinedMod.foo` */
