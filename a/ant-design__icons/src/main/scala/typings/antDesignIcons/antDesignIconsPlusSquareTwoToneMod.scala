...
object antDesignIconsPlusSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PlusSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPlusSquareTwoToneMod.foo` */
