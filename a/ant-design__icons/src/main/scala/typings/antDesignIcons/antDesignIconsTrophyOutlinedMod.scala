...
object antDesignIconsTrophyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TrophyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTrophyOutlinedMod.foo` */
