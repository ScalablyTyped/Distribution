...
object antDesignIconsCalculatorOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CalculatorOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCalculatorOutlinedMod.foo` */
