...
object iconsSelectOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SelectOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSelectOutlinedMod.foo` */
