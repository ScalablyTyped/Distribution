...
object iconsStrikethroughOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/StrikethroughOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsStrikethroughOutlinedMod.foo` */
