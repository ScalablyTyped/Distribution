...
object iconsMoneyCollectTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MoneyCollectTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMoneyCollectTwoToneMod.foo` */
