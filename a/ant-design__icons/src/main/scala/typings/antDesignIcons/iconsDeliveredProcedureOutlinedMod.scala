...
object iconsDeliveredProcedureOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DeliveredProcedureOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDeliveredProcedureOutlinedMod.foo` */
