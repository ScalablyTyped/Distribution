...
object antDesignIconsAreaChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AreaChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAreaChartOutlinedMod.foo` */
