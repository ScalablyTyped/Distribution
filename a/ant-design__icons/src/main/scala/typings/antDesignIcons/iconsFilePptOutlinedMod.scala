...
object iconsFilePptOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FilePptOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFilePptOutlinedMod.foo` */
