...
object antDesignIconsNotificationTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/NotificationTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsNotificationTwoToneMod.foo` */
