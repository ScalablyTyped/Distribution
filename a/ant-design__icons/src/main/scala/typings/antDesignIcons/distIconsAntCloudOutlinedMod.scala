...
object distIconsAntCloudOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AntCloudOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAntCloudOutlinedMod.foo` */
