...
object antDesignIconsTwitterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TwitterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTwitterOutlinedMod.foo` */
