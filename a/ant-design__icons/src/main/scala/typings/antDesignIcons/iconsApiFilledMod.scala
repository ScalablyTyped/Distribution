...
object iconsApiFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ApiFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsApiFilledMod.foo` */
