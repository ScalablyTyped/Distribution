...
object antDesignIconsStepForwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/StepForwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsStepForwardFilledMod.foo` */
