...
object antDesignIconsScheduleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ScheduleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsScheduleOutlinedMod.foo` */
