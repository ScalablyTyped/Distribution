...
object distIconsCarFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CarFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCarFilledMod.foo` */
