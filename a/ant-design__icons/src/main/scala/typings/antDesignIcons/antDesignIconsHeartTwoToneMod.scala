...
object antDesignIconsHeartTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/HeartTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsHeartTwoToneMod.foo` */
