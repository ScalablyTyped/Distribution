...
object distIconsRedEnvelopeFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RedEnvelopeFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRedEnvelopeFilledMod.foo` */
