...
object antDesignIconsAppleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AppleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAppleOutlinedMod.foo` */
