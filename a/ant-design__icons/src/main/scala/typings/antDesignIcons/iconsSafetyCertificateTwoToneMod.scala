...
object iconsSafetyCertificateTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SafetyCertificateTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSafetyCertificateTwoToneMod.foo` */
