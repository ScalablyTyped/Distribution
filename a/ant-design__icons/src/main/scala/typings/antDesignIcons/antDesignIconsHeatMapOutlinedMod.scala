...
object antDesignIconsHeatMapOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/HeatMapOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsHeatMapOutlinedMod.foo` */
