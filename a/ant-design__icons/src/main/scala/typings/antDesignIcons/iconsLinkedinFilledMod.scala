...
object iconsLinkedinFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LinkedinFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLinkedinFilledMod.foo` */
