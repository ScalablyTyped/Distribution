...
object antDesignIconsUsbTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UsbTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUsbTwoToneMod.foo` */
