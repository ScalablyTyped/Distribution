...
object antDesignIconsSmileTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SmileTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSmileTwoToneMod.foo` */
