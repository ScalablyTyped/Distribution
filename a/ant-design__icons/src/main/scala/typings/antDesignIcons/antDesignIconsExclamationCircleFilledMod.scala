...
object antDesignIconsExclamationCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ExclamationCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsExclamationCircleFilledMod.foo` */
