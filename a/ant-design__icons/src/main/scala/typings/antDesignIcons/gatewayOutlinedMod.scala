...
object gatewayOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/GatewayOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `gatewayOutlinedMod.foo` */
