...
object distIconsTaobaoSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/TaobaoSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsTaobaoSquareFilledMod.foo` */
