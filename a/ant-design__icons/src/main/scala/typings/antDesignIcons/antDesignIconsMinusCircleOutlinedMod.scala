...
object antDesignIconsMinusCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MinusCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMinusCircleOutlinedMod.foo` */
