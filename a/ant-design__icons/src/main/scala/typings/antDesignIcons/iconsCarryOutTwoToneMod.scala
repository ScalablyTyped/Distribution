...
object iconsCarryOutTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CarryOutTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCarryOutTwoToneMod.foo` */
