...
object iconsAmazonOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AmazonOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAmazonOutlinedMod.foo` */
