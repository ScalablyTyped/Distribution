...
object iconsInsertRowRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InsertRowRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInsertRowRightOutlinedMod.foo` */
