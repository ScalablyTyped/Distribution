...
object distIconsLoading3QuartersOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLoading3QuartersOutlinedMod.foo` */
