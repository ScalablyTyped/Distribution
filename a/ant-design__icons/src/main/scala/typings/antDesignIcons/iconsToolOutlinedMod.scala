...
object iconsToolOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ToolOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsToolOutlinedMod.foo` */
