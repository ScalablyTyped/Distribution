...
object distIconsInteractionFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/InteractionFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsInteractionFilledMod.foo` */
