...
object iconsPieChartTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PieChartTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPieChartTwoToneMod.foo` */
