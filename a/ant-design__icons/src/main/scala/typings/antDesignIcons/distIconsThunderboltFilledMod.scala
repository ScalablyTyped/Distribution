...
object distIconsThunderboltFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ThunderboltFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsThunderboltFilledMod.foo` */
