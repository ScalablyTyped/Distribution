...
object distIconsHeartFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/HeartFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsHeartFilledMod.foo` */
