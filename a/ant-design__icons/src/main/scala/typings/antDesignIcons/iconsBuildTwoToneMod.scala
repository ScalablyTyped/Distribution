...
object iconsBuildTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BuildTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBuildTwoToneMod.foo` */
