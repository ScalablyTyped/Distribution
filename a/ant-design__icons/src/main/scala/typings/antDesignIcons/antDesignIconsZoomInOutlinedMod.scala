...
object antDesignIconsZoomInOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ZoomInOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsZoomInOutlinedMod.foo` */
