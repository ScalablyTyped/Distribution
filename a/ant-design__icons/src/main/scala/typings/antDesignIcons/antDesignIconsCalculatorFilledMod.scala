...
object antDesignIconsCalculatorFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CalculatorFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCalculatorFilledMod.foo` */
