...
object distIconsGatewayOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GatewayOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGatewayOutlinedMod.foo` */
