...
object distIconsAlignLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AlignLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAlignLeftOutlinedMod.foo` */
