...
object antDesignIconsUsbOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UsbOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUsbOutlinedMod.foo` */
