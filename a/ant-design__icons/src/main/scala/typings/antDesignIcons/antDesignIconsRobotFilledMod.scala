...
object antDesignIconsRobotFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RobotFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRobotFilledMod.foo` */
