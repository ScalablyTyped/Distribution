...
object distIconsDownCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DownCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDownCircleFilledMod.foo` */
