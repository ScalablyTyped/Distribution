...
object distIconsCloseCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CloseCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCloseCircleTwoToneMod.foo` */
