...
object iconsPlaySquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PlaySquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPlaySquareOutlinedMod.foo` */
