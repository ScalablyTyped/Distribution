...
object antDesignIconsColumnHeightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ColumnHeightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsColumnHeightOutlinedMod.foo` */
