...
object distIconsExceptionOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ExceptionOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsExceptionOutlinedMod.foo` */
