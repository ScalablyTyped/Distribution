...
object distIconsSafetyCertificateTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SafetyCertificateTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSafetyCertificateTwoToneMod.foo` */
