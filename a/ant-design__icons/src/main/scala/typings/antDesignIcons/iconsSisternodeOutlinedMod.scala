...
object iconsSisternodeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SisternodeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSisternodeOutlinedMod.foo` */
