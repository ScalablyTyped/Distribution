...
object iconsCloudTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CloudTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCloudTwoToneMod.foo` */
