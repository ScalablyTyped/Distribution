...
object distIconsRightSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RightSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRightSquareFilledMod.foo` */
