...
object iconsCoffeeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CoffeeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCoffeeOutlinedMod.foo` */
