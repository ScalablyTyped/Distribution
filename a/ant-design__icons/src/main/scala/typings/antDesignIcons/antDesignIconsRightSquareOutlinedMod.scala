...
object antDesignIconsRightSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RightSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRightSquareOutlinedMod.foo` */
