...
object antDesignIconsCustomerServiceTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CustomerServiceTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCustomerServiceTwoToneMod.foo` */
