...
object antDesignIconsDollarCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DollarCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDollarCircleTwoToneMod.foo` */
