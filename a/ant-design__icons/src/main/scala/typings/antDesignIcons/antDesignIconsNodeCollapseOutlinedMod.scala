...
object antDesignIconsNodeCollapseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/NodeCollapseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsNodeCollapseOutlinedMod.foo` */
