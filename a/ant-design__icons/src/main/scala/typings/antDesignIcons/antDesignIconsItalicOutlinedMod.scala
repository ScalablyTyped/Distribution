...
object antDesignIconsItalicOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ItalicOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsItalicOutlinedMod.foo` */
