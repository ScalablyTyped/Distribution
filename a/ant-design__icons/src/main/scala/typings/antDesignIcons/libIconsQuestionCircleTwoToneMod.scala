...
object libIconsQuestionCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/QuestionCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsQuestionCircleTwoToneMod.foo` */
