...
object iconsZoomOutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ZoomOutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsZoomOutOutlinedMod.foo` */
