...
object iconsPayCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PayCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPayCircleOutlinedMod.foo` */
