...
object antDesignIconsMoneyCollectTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MoneyCollectTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMoneyCollectTwoToneMod.foo` */
