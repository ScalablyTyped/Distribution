...
object antDesignIconsBlockOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BlockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBlockOutlinedMod.foo` */
