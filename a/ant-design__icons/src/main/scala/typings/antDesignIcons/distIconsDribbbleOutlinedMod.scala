...
object distIconsDribbbleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DribbbleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDribbbleOutlinedMod.foo` */
