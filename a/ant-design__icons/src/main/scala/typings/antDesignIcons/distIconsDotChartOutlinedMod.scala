...
object distIconsDotChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DotChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDotChartOutlinedMod.foo` */
