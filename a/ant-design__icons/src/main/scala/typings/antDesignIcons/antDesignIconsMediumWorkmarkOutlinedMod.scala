...
object antDesignIconsMediumWorkmarkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MediumWorkmarkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMediumWorkmarkOutlinedMod.foo` */
