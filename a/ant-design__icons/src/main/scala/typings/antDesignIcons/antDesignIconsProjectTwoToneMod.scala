...
object antDesignIconsProjectTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ProjectTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsProjectTwoToneMod.foo` */
