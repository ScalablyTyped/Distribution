...
object iconsFilePptTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FilePptTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFilePptTwoToneMod.foo` */
