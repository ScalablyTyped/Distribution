...
object antDesignIconsBugFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BugFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBugFilledMod.foo` */
