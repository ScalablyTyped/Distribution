...
object iconsCloudFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CloudFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCloudFilledMod.foo` */
