...
object libIconsUnderlineOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UnderlineOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsUnderlineOutlinedMod.foo` */
