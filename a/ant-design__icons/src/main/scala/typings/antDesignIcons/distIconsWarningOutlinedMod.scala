...
object distIconsWarningOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WarningOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWarningOutlinedMod.foo` */
