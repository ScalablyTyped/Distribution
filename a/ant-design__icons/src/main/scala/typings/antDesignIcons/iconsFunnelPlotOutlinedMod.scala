...
object iconsFunnelPlotOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FunnelPlotOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFunnelPlotOutlinedMod.foo` */
