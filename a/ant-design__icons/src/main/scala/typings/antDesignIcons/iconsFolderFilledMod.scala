...
object iconsFolderFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderFilledMod.foo` */
