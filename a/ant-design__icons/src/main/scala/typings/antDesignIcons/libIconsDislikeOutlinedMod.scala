...
object libIconsDislikeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DislikeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsDislikeOutlinedMod.foo` */
