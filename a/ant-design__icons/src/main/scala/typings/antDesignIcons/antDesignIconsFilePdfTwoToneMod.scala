...
object antDesignIconsFilePdfTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilePdfTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilePdfTwoToneMod.foo` */
