...
object iconsInfoCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InfoCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInfoCircleOutlinedMod.foo` */
