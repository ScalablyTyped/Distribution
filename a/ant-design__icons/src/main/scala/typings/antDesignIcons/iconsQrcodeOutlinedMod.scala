...
object iconsQrcodeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/QrcodeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsQrcodeOutlinedMod.foo` */
