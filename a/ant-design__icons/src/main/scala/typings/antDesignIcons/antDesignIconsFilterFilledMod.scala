...
object antDesignIconsFilterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilterFilledMod.foo` */
