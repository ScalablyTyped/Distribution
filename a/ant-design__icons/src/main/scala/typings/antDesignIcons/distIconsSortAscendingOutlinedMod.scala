...
object distIconsSortAscendingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SortAscendingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSortAscendingOutlinedMod.foo` */
