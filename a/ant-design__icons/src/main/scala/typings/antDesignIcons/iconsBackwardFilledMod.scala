...
object iconsBackwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BackwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBackwardFilledMod.foo` */
