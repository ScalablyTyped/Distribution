...
object iconsFileTextTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileTextTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileTextTwoToneMod.foo` */
