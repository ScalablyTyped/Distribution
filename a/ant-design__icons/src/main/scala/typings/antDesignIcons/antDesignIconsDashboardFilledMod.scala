...
object antDesignIconsDashboardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DashboardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDashboardFilledMod.foo` */
