...
object antDesignIconsLinkedinFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LinkedinFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLinkedinFilledMod.foo` */
