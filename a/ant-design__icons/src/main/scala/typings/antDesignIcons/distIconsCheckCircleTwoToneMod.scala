...
object distIconsCheckCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CheckCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCheckCircleTwoToneMod.foo` */
