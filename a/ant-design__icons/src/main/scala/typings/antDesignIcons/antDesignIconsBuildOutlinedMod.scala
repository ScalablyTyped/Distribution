...
object antDesignIconsBuildOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BuildOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBuildOutlinedMod.foo` */
