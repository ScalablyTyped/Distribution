...
object distIconsReconciliationTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ReconciliationTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsReconciliationTwoToneMod.foo` */
