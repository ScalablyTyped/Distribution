...
object antDesignIconsFilterTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilterTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilterTwoToneMod.foo` */
