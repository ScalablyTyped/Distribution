...
object antDesignIconsHistoryOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/HistoryOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsHistoryOutlinedMod.foo` */
