...
object antDesignIconsDotChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DotChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDotChartOutlinedMod.foo` */
