...
object distIconsStarOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/StarOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsStarOutlinedMod.foo` */
