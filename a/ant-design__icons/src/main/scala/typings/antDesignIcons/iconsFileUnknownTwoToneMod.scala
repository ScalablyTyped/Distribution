...
object iconsFileUnknownTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileUnknownTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileUnknownTwoToneMod.foo` */
