...
object antDesignIconsRollbackOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RollbackOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRollbackOutlinedMod.foo` */
