...
object antDesignIconsZoomOutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ZoomOutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsZoomOutOutlinedMod.foo` */
