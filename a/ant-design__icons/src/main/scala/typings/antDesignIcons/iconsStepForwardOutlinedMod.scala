...
object iconsStepForwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/StepForwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsStepForwardOutlinedMod.foo` */
