...
object antDesignIconsThunderboltFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ThunderboltFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsThunderboltFilledMod.foo` */
