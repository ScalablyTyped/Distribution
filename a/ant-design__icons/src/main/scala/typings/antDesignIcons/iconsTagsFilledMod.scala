...
object iconsTagsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TagsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTagsFilledMod.foo` */
