...
object iconsAndroidFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AndroidFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAndroidFilledMod.foo` */
