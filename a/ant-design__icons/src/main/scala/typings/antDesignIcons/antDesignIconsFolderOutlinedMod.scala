...
object antDesignIconsFolderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FolderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFolderOutlinedMod.foo` */
