...
object iconsUserAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UserAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUserAddOutlinedMod.foo` */
