...
object iconsSignalFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SignalFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSignalFilledMod.foo` */
