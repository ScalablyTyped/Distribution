...
object antDesignIconsCarFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CarFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCarFilledMod.foo` */
