...
object antDesignIconsAlignLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlignLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlignLeftOutlinedMod.foo` */
