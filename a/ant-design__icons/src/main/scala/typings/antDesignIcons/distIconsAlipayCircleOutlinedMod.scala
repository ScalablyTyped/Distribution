...
object distIconsAlipayCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AlipayCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAlipayCircleOutlinedMod.foo` */
