...
object iconsSplitCellsOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SplitCellsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSplitCellsOutlinedMod.foo` */
