...
object antDesignIconsLinkedinOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LinkedinOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLinkedinOutlinedMod.foo` */
