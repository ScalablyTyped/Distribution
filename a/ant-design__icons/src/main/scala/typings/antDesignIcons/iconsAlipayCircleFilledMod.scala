...
object iconsAlipayCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AlipayCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAlipayCircleFilledMod.foo` */
