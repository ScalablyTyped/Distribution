...
object distIconsDeleteRowOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DeleteRowOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDeleteRowOutlinedMod.foo` */
