...
object iconsBoxPlotTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BoxPlotTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBoxPlotTwoToneMod.foo` */
