...
object distIconsFileMarkdownFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileMarkdownFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileMarkdownFilledMod.foo` */
