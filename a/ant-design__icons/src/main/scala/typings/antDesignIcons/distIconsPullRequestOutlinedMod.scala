...
object distIconsPullRequestOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PullRequestOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPullRequestOutlinedMod.foo` */
