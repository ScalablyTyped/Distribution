...
object iconsFundViewOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FundViewOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFundViewOutlinedMod.foo` */
