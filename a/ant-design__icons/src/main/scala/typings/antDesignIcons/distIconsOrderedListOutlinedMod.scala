...
object distIconsOrderedListOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/OrderedListOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsOrderedListOutlinedMod.foo` */
