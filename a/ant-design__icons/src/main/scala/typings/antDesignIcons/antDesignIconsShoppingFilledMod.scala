...
object antDesignIconsShoppingFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ShoppingFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsShoppingFilledMod.foo` */
