...
object iconsSoundFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SoundFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSoundFilledMod.foo` */
