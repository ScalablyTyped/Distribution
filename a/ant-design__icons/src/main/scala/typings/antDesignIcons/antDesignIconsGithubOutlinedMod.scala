...
object antDesignIconsGithubOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/GithubOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsGithubOutlinedMod.foo` */
