...
object iconsShoppingTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShoppingTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShoppingTwoToneMod.foo` */
