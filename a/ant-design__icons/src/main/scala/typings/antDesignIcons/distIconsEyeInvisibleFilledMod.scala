...
object distIconsEyeInvisibleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/EyeInvisibleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsEyeInvisibleFilledMod.foo` */
