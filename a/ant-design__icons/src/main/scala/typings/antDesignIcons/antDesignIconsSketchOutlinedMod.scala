...
object antDesignIconsSketchOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SketchOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSketchOutlinedMod.foo` */
