...
object iconsMinusCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MinusCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMinusCircleOutlinedMod.foo` */
