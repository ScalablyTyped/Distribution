...
object distIconsInboxOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/InboxOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsInboxOutlinedMod.foo` */
