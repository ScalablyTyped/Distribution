...
object distIconsPauseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PauseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPauseOutlinedMod.foo` */
