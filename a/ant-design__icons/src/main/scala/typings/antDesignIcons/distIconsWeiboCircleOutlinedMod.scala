...
object distIconsWeiboCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WeiboCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWeiboCircleOutlinedMod.foo` */
