...
object distIconsBuildFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BuildFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBuildFilledMod.foo` */
