...
object distIconsRightSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RightSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRightSquareTwoToneMod.foo` */
