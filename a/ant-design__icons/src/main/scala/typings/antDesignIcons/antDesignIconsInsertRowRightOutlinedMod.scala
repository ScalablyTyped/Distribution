...
object antDesignIconsInsertRowRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/InsertRowRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsInsertRowRightOutlinedMod.foo` */
