...
object iconsBorderVerticleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BorderVerticleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBorderVerticleOutlinedMod.foo` */
