...
object antDesignIconsGoldFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/GoldFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsGoldFilledMod.foo` */
