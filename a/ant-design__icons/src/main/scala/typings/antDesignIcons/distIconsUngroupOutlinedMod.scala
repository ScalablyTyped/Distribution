...
object distIconsUngroupOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UngroupOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUngroupOutlinedMod.foo` */
