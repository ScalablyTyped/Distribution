...
object distIconsMergeCellsOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MergeCellsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMergeCellsOutlinedMod.foo` */
