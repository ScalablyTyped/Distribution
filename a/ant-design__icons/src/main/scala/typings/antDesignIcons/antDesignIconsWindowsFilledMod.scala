...
object antDesignIconsWindowsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WindowsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWindowsFilledMod.foo` */
