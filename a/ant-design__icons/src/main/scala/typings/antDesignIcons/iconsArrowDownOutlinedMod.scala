...
object iconsArrowDownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ArrowDownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsArrowDownOutlinedMod.foo` */
