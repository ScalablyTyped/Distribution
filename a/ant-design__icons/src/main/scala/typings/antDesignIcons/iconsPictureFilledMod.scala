...
object iconsPictureFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PictureFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPictureFilledMod.foo` */
