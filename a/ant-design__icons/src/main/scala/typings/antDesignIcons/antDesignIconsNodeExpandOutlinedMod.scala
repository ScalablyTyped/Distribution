...
object antDesignIconsNodeExpandOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/NodeExpandOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsNodeExpandOutlinedMod.foo` */
