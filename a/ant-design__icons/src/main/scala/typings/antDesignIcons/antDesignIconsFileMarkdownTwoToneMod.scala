...
object antDesignIconsFileMarkdownTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FileMarkdownTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFileMarkdownTwoToneMod.foo` */
