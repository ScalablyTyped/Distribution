...
object distIconsLockOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLockOutlinedMod.foo` */
