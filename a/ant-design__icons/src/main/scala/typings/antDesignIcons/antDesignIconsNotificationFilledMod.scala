...
object antDesignIconsNotificationFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/NotificationFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsNotificationFilledMod.foo` */
