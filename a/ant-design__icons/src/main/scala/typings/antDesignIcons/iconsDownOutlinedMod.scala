...
object iconsDownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDownOutlinedMod.foo` */
