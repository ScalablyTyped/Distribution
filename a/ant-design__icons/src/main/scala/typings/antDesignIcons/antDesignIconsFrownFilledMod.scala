...
object antDesignIconsFrownFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FrownFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFrownFilledMod.foo` */
