...
object distIconsTranslationOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/TranslationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsTranslationOutlinedMod.foo` */
