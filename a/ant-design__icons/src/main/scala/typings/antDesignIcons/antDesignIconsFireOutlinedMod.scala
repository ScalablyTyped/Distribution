...
object antDesignIconsFireOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FireOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFireOutlinedMod.foo` */
