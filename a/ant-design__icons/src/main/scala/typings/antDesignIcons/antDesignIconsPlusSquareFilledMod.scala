...
object antDesignIconsPlusSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PlusSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPlusSquareFilledMod.foo` */
