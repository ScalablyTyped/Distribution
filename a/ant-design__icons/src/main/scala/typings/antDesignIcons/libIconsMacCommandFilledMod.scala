...
object libIconsMacCommandFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MacCommandFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsMacCommandFilledMod.foo` */
