...
object distIconsWarningFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WarningFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWarningFilledMod.foo` */
