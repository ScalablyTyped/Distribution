...
object distIconsFolderAddFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderAddFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderAddFilledMod.foo` */
