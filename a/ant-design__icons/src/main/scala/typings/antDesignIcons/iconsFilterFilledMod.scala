...
object iconsFilterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FilterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFilterFilledMod.foo` */
