...
object distIconsDropboxOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DropboxOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDropboxOutlinedMod.foo` */
