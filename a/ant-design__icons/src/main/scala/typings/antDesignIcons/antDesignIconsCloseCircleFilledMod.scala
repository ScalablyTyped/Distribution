...
object antDesignIconsCloseCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CloseCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCloseCircleFilledMod.foo` */
