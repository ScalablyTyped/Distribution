...
object libIconsBehanceCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BehanceCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsBehanceCircleFilledMod.foo` */
