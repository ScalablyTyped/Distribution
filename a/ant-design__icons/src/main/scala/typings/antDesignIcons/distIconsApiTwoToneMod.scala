...
object distIconsApiTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ApiTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsApiTwoToneMod.foo` */
