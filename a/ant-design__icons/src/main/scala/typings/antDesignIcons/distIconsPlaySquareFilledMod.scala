...
object distIconsPlaySquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PlaySquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPlaySquareFilledMod.foo` */
