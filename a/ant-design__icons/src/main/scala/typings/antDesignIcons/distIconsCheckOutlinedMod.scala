...
object distIconsCheckOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CheckOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCheckOutlinedMod.foo` */
