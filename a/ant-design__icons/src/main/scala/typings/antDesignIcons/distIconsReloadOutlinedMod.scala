...
object distIconsReloadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ReloadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsReloadOutlinedMod.foo` */
