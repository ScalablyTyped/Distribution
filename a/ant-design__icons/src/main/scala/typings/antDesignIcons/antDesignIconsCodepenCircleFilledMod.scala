...
object antDesignIconsCodepenCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CodepenCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCodepenCircleFilledMod.foo` */
