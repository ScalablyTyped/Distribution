...
object antDesignIconsRedoOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RedoOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRedoOutlinedMod.foo` */
