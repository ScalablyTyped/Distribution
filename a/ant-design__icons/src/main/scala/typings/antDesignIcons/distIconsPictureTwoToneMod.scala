...
object distIconsPictureTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PictureTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPictureTwoToneMod.foo` */
