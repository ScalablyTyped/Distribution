...
object antDesignIconsTrademarkCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TrademarkCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTrademarkCircleFilledMod.foo` */
