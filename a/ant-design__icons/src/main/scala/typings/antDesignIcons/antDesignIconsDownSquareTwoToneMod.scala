...
object antDesignIconsDownSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DownSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDownSquareTwoToneMod.foo` */
