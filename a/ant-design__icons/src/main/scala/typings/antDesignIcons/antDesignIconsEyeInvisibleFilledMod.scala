...
object antDesignIconsEyeInvisibleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/EyeInvisibleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsEyeInvisibleFilledMod.foo` */
