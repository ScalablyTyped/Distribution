...
object iconsAndroidOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AndroidOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAndroidOutlinedMod.foo` */
