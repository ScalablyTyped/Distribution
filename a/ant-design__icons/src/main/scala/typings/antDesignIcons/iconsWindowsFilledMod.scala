...
object iconsWindowsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WindowsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsWindowsFilledMod.foo` */
