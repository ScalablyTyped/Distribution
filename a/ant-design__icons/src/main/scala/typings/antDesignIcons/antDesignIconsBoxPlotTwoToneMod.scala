...
object antDesignIconsBoxPlotTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BoxPlotTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBoxPlotTwoToneMod.foo` */
