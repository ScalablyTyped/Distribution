...
object distIconsGoldTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GoldTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGoldTwoToneMod.foo` */
