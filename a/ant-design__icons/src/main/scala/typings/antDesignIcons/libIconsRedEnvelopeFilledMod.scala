...
object libIconsRedEnvelopeFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RedEnvelopeFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsRedEnvelopeFilledMod.foo` */
