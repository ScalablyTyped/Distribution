...
object distIconsEyeInvisibleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/EyeInvisibleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsEyeInvisibleTwoToneMod.foo` */
