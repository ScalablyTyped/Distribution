...
object antDesignIconsSlidersOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SlidersOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSlidersOutlinedMod.foo` */
