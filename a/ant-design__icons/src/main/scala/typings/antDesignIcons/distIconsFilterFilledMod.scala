...
object distIconsFilterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FilterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFilterFilledMod.foo` */
