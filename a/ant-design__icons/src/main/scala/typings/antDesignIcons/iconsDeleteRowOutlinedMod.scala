...
object iconsDeleteRowOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DeleteRowOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDeleteRowOutlinedMod.foo` */
