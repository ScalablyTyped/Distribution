...
object distIconsContactsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ContactsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsContactsFilledMod.foo` */
