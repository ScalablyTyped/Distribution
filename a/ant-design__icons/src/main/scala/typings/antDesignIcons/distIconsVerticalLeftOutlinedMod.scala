...
object distIconsVerticalLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/VerticalLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsVerticalLeftOutlinedMod.foo` */
