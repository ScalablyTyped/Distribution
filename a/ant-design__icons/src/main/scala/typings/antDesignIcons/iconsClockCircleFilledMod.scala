...
object iconsClockCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ClockCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsClockCircleFilledMod.foo` */
