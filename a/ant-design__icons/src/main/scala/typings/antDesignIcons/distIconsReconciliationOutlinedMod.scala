...
object distIconsReconciliationOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ReconciliationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsReconciliationOutlinedMod.foo` */
