...
object distIconsFileWordTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileWordTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileWordTwoToneMod.foo` */
