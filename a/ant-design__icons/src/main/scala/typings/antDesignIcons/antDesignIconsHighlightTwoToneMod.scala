...
object antDesignIconsHighlightTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/HighlightTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsHighlightTwoToneMod.foo` */
