...
object iconsYahooFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/YahooFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsYahooFilledMod.foo` */
