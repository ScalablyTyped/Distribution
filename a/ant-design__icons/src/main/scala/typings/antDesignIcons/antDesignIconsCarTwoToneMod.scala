...
object antDesignIconsCarTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CarTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCarTwoToneMod.foo` */
