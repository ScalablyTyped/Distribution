...
object antDesignIconsLoading3QuartersOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/Loading3QuartersOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLoading3QuartersOutlinedMod.foo` */
