...
object antDesignIconsAlignCenterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlignCenterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlignCenterOutlinedMod.foo` */
