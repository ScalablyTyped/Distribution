...
object antDesignIconsPauseCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PauseCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPauseCircleOutlinedMod.foo` */
