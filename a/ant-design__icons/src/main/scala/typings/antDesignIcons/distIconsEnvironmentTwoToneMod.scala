...
object distIconsEnvironmentTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/EnvironmentTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsEnvironmentTwoToneMod.foo` */
