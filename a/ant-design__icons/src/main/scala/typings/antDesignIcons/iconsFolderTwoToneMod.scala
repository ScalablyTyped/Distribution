...
object iconsFolderTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderTwoToneMod.foo` */
