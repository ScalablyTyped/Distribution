...
object antDesignIconsRestTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RestTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRestTwoToneMod.foo` */
