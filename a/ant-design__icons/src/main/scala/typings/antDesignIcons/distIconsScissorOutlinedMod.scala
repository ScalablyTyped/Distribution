...
object distIconsScissorOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ScissorOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsScissorOutlinedMod.foo` */
