...
object distIconsExclamationCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ExclamationCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsExclamationCircleFilledMod.foo` */
