...
object iconsScissorOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ScissorOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsScissorOutlinedMod.foo` */
