...
object distIconsRightCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RightCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRightCircleFilledMod.foo` */
