...
object libIconsRightCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RightCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsRightCircleFilledMod.foo` */
