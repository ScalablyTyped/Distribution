...
object antDesignIconsTagsTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TagsTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTagsTwoToneMod.foo` */
