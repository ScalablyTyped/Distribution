...
object iconsFastBackwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FastBackwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFastBackwardOutlinedMod.foo` */
