...
object distIconsDeliveredProcedureOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DeliveredProcedureOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDeliveredProcedureOutlinedMod.foo` */
