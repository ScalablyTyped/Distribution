...
object iconsSecurityScanTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SecurityScanTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSecurityScanTwoToneMod.foo` */
