...
object distIconsFormatPainterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FormatPainterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFormatPainterFilledMod.foo` */
