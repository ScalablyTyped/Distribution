...
object distIconsAccountBookFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AccountBookFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAccountBookFilledMod.foo` */
