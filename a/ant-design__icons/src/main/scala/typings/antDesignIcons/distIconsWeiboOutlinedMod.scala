...
object distIconsWeiboOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WeiboOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWeiboOutlinedMod.foo` */
