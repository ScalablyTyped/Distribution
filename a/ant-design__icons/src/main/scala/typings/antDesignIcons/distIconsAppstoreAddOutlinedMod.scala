...
object distIconsAppstoreAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AppstoreAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAppstoreAddOutlinedMod.foo` */
