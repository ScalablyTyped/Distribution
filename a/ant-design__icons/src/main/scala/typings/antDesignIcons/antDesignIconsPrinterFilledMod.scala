...
object antDesignIconsPrinterFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PrinterFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPrinterFilledMod.foo` */
