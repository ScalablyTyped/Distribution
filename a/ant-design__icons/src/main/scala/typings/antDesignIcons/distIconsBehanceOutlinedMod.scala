...
object distIconsBehanceOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BehanceOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBehanceOutlinedMod.foo` */
