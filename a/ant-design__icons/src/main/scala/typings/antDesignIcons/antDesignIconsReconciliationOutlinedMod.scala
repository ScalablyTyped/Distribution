...
object antDesignIconsReconciliationOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ReconciliationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsReconciliationOutlinedMod.foo` */
