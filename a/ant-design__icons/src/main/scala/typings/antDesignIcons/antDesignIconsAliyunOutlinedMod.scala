...
object antDesignIconsAliyunOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AliyunOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAliyunOutlinedMod.foo` */
