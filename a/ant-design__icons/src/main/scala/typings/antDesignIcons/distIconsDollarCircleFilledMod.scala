...
object distIconsDollarCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DollarCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDollarCircleFilledMod.foo` */
