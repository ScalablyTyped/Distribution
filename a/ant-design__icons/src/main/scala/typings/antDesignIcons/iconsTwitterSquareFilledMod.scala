...
object iconsTwitterSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TwitterSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTwitterSquareFilledMod.foo` */
