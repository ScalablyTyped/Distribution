...
object antDesignIconsFastForwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FastForwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFastForwardOutlinedMod.foo` */
