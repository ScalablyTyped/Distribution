...
object antDesignIconsExpandOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ExpandOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsExpandOutlinedMod.foo` */
