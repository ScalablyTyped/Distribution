...
object antDesignIconsBorderRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BorderRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBorderRightOutlinedMod.foo` */
