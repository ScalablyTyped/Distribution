...
object iconsCaretUpFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CaretUpFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCaretUpFilledMod.foo` */
