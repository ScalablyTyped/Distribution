...
object distIconsDownloadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DownloadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDownloadOutlinedMod.foo` */
