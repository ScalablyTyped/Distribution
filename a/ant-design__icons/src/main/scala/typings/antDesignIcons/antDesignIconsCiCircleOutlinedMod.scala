...
object antDesignIconsCiCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CiCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCiCircleOutlinedMod.foo` */
