...
object distIconsIdcardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/IdcardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsIdcardOutlinedMod.foo` */
