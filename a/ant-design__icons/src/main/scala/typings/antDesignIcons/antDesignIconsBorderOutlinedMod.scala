...
object antDesignIconsBorderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BorderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBorderOutlinedMod.foo` */
