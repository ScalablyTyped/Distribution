...
object iconsQuestionCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/QuestionCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsQuestionCircleOutlinedMod.foo` */
