...
object antDesignIconsFrownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FrownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFrownOutlinedMod.foo` */
