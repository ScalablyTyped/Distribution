...
object iconsLeftSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LeftSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLeftSquareOutlinedMod.foo` */
