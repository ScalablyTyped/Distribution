...
object antDesignIconsFilePptTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilePptTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilePptTwoToneMod.foo` */
