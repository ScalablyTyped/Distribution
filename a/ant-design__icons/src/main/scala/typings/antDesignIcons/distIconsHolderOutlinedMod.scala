...
object distIconsHolderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/HolderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsHolderOutlinedMod.foo` */
