...
object antDesignIconsRedEnvelopeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RedEnvelopeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRedEnvelopeOutlinedMod.foo` */
