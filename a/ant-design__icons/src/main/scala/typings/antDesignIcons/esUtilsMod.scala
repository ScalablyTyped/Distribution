...
import typings.antDesignIconsSvg.esTypesMod.AbstractNode
...
object esUtilsMod {
  ...
  @scala.annotation.targetName("generate_false")
  inline def generate(node: AbstractNode, key: String, rootProps: false): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(node.asInstanceOf[js.Any], key.asInstanceOf[js.Any], rootProps.asInstanceOf[js.Any])).asInstanceOf[Any]
