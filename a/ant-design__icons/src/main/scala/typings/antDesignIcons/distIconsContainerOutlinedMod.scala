...
object distIconsContainerOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ContainerOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsContainerOutlinedMod.foo` */
