...
object iconsHeartFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/HeartFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsHeartFilledMod.foo` */
