...
object iconsInstagramFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InstagramFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInstagramFilledMod.foo` */
