...
object distIconsGoldFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GoldFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGoldFilledMod.foo` */
