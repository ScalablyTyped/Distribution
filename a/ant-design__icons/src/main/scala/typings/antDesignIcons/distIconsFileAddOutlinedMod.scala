...
object distIconsFileAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileAddOutlinedMod.foo` */
