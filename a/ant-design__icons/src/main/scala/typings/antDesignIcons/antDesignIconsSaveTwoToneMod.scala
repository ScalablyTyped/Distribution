...
object antDesignIconsSaveTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SaveTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSaveTwoToneMod.foo` */
