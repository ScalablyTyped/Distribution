...
object iconsAppstoreAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AppstoreAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAppstoreAddOutlinedMod.foo` */
