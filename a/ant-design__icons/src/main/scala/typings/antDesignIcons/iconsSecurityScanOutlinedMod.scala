...
object iconsSecurityScanOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SecurityScanOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSecurityScanOutlinedMod.foo` */
