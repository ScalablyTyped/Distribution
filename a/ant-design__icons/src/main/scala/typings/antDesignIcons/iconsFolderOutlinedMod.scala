...
object iconsFolderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderOutlinedMod.foo` */
