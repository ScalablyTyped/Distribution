...
object distIconsCompassTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CompassTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCompassTwoToneMod.foo` */
