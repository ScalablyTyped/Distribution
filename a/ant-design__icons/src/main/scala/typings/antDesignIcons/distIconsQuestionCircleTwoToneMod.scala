...
object distIconsQuestionCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/QuestionCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsQuestionCircleTwoToneMod.foo` */
