...
object distIconsThunderboltOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ThunderboltOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsThunderboltOutlinedMod.foo` */
