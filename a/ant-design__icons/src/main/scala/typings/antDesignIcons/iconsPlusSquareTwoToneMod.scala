...
object iconsPlusSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PlusSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPlusSquareTwoToneMod.foo` */
