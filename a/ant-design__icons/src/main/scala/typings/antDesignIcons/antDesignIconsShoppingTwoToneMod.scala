...
object antDesignIconsShoppingTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ShoppingTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsShoppingTwoToneMod.foo` */
