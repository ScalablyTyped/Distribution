...
object iconsSlackCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SlackCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSlackCircleFilledMod.foo` */
