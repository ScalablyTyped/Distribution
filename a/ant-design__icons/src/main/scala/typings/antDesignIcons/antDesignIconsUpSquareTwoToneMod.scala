...
object antDesignIconsUpSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UpSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUpSquareTwoToneMod.foo` */
