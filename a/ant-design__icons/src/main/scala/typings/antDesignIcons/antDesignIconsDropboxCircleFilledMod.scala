...
object antDesignIconsDropboxCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DropboxCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDropboxCircleFilledMod.foo` */
