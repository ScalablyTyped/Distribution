...
object antDesignIconsAudioOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AudioOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAudioOutlinedMod.foo` */
