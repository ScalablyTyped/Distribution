...
object distIconsShoppingTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ShoppingTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsShoppingTwoToneMod.foo` */
