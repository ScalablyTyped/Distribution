...
object distIconsCloudUploadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CloudUploadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCloudUploadOutlinedMod.foo` */
