...
object distIconsIdcardTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/IdcardTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsIdcardTwoToneMod.foo` */
