...
object distIconsFallOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FallOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFallOutlinedMod.foo` */
