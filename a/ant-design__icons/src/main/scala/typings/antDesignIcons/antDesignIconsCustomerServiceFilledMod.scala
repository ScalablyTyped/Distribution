...
object antDesignIconsCustomerServiceFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CustomerServiceFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCustomerServiceFilledMod.foo` */
