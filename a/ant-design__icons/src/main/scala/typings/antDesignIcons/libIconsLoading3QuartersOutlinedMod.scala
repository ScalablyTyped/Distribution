...
object libIconsLoading3QuartersOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/Loading3QuartersOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsLoading3QuartersOutlinedMod.foo` */
