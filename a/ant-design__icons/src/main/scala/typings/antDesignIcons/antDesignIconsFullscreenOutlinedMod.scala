...
object antDesignIconsFullscreenOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FullscreenOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFullscreenOutlinedMod.foo` */
