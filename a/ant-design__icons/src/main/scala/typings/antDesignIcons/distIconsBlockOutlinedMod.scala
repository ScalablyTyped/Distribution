...
object distIconsBlockOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BlockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBlockOutlinedMod.foo` */
