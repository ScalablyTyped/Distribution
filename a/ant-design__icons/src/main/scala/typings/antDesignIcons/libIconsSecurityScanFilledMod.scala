...
object libIconsSecurityScanFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SecurityScanFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsSecurityScanFilledMod.foo` */
