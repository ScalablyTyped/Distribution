...
object iconsWeiboSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WeiboSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsWeiboSquareFilledMod.foo` */
