...
object distIconsMobileTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MobileTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMobileTwoToneMod.foo` */
