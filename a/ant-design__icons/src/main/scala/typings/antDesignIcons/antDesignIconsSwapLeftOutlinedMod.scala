...
object antDesignIconsSwapLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SwapLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSwapLeftOutlinedMod.foo` */
