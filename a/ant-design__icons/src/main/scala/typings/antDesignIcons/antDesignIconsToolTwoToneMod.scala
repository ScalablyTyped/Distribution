...
object antDesignIconsToolTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ToolTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsToolTwoToneMod.foo` */
