...
object iconsBookTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BookTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBookTwoToneMod.foo` */
