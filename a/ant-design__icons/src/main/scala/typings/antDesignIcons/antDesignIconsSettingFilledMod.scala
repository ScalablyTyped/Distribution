...
object antDesignIconsSettingFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SettingFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSettingFilledMod.foo` */
