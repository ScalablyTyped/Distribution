...
object antDesignIconsInfoCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/InfoCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsInfoCircleOutlinedMod.foo` */
