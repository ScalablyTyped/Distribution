...
object distIconsFolderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderOutlinedMod.foo` */
