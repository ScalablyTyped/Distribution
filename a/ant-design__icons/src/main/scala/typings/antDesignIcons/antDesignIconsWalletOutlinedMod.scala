...
object antDesignIconsWalletOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WalletOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWalletOutlinedMod.foo` */
