...
object distIconsForkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ForkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsForkOutlinedMod.foo` */
