...
object antDesignIconsDownSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DownSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDownSquareFilledMod.foo` */
