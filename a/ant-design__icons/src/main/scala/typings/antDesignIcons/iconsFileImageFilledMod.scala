...
object iconsFileImageFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileImageFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileImageFilledMod.foo` */
