...
object antDesignIconsFundProjectionScreenOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FundProjectionScreenOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFundProjectionScreenOutlinedMod.foo` */
