...
object antDesignIconsAndroidOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AndroidOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAndroidOutlinedMod.foo` */
