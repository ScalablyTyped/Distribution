...
object distIconsLinkedinOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LinkedinOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLinkedinOutlinedMod.foo` */
