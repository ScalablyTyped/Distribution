...
object antDesignIconsCheckSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CheckSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCheckSquareFilledMod.foo` */
