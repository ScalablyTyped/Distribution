...
object antDesignIconsBookOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BookOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBookOutlinedMod.foo` */
