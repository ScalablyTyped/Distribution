...
object iconsCarryOutFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CarryOutFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCarryOutFilledMod.foo` */
