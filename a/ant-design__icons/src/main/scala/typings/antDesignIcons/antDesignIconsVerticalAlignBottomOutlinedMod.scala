...
object antDesignIconsVerticalAlignBottomOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/VerticalAlignBottomOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsVerticalAlignBottomOutlinedMod.foo` */
