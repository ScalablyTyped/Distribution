...
object distIconsWalletOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WalletOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWalletOutlinedMod.foo` */
