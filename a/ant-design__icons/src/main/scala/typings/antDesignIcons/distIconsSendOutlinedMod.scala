...
object distIconsSendOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SendOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSendOutlinedMod.foo` */
