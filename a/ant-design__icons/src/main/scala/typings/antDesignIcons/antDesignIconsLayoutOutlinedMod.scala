...
object antDesignIconsLayoutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LayoutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLayoutOutlinedMod.foo` */
