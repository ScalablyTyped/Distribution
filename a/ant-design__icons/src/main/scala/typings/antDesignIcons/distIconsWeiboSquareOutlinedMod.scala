...
object distIconsWeiboSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WeiboSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWeiboSquareOutlinedMod.foo` */
