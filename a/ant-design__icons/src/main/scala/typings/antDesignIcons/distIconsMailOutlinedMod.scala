...
object distIconsMailOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MailOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMailOutlinedMod.foo` */
