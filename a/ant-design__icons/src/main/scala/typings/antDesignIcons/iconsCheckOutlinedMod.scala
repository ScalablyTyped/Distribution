...
object iconsCheckOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CheckOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCheckOutlinedMod.foo` */
