...
object antDesignIconsGooglePlusCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/GooglePlusCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsGooglePlusCircleFilledMod.foo` */
