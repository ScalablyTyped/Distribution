...
object distIconsFacebookFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FacebookFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFacebookFilledMod.foo` */
