...
object iconsDropboxCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DropboxCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDropboxCircleFilledMod.foo` */
