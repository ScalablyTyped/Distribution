...
object libIconsDownloadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DownloadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsDownloadOutlinedMod.foo` */
