...
object distIconsRadiusBottomleftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RadiusBottomleftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRadiusBottomleftOutlinedMod.foo` */
