...
object distIconsDollarCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DollarCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDollarCircleOutlinedMod.foo` */
