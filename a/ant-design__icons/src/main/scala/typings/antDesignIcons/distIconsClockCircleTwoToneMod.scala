...
object distIconsClockCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ClockCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsClockCircleTwoToneMod.foo` */
