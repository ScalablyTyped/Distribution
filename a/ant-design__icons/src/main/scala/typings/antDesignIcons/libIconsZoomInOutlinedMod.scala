...
object libIconsZoomInOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ZoomInOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsZoomInOutlinedMod.foo` */
