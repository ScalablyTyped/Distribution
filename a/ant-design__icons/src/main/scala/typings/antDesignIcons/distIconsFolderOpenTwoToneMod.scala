...
object distIconsFolderOpenTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderOpenTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderOpenTwoToneMod.foo` */
