...
object iconsEyeInvisibleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/EyeInvisibleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsEyeInvisibleOutlinedMod.foo` */
