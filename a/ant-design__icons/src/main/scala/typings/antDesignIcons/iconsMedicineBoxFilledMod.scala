...
object iconsMedicineBoxFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MedicineBoxFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMedicineBoxFilledMod.foo` */
