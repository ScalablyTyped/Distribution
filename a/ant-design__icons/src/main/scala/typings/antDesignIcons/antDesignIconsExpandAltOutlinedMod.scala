...
object antDesignIconsExpandAltOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ExpandAltOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsExpandAltOutlinedMod.foo` */
