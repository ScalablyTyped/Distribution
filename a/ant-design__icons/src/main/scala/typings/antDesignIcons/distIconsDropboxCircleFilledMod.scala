...
object distIconsDropboxCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DropboxCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDropboxCircleFilledMod.foo` */
