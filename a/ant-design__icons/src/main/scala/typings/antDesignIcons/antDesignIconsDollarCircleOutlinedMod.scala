...
object antDesignIconsDollarCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DollarCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDollarCircleOutlinedMod.foo` */
