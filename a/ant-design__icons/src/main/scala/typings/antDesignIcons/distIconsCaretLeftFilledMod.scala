...
object distIconsCaretLeftFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CaretLeftFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCaretLeftFilledMod.foo` */
