...
object iconsCloseCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CloseCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCloseCircleOutlinedMod.foo` */
