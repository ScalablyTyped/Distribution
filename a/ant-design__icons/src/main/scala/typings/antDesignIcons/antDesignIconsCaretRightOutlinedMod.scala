...
object antDesignIconsCaretRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CaretRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCaretRightOutlinedMod.foo` */
