...
object shoppingFilledMod extends Shortcut {
  ...
  @JSImport("@ant-design/icons/dist/icons/ShoppingFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `shoppingFilledMod.foo` */
