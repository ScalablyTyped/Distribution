...
object antDesignIconsManOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ManOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsManOutlinedMod.foo` */
