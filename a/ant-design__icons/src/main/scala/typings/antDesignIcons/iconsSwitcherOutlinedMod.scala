...
object iconsSwitcherOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SwitcherOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSwitcherOutlinedMod.foo` */
