...
object iconsDropboxSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DropboxSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDropboxSquareFilledMod.foo` */
