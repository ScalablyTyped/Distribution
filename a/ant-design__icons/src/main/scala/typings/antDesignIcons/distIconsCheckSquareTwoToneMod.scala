...
object distIconsCheckSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CheckSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCheckSquareTwoToneMod.foo` */
