...
object distIconsGifOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GifOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGifOutlinedMod.foo` */
