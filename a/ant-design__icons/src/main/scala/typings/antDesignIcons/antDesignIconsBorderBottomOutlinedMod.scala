...
object antDesignIconsBorderBottomOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BorderBottomOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBorderBottomOutlinedMod.foo` */
