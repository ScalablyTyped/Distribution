...
object iconsFormOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FormOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFormOutlinedMod.foo` */
