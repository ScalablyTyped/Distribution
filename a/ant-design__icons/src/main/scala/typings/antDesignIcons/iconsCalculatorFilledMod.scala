...
object iconsCalculatorFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CalculatorFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCalculatorFilledMod.foo` */
