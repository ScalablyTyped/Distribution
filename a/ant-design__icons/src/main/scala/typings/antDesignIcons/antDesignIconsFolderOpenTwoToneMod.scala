...
object antDesignIconsFolderOpenTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FolderOpenTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFolderOpenTwoToneMod.foo` */
