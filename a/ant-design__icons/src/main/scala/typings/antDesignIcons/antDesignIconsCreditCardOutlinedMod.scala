...
object antDesignIconsCreditCardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CreditCardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCreditCardOutlinedMod.foo` */
