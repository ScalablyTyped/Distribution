...
object antDesignIconsWalletFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WalletFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWalletFilledMod.foo` */
