...
object antDesignIconsBranchesOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BranchesOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBranchesOutlinedMod.foo` */
