...
object antDesignIconsRadiusUpleftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RadiusUpleftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRadiusUpleftOutlinedMod.foo` */
