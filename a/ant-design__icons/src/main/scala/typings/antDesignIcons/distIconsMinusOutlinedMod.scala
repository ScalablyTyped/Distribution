...
object distIconsMinusOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MinusOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMinusOutlinedMod.foo` */
