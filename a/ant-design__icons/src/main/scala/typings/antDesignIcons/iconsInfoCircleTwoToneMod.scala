...
object iconsInfoCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InfoCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInfoCircleTwoToneMod.foo` */
