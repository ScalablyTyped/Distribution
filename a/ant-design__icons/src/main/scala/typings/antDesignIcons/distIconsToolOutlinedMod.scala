...
object distIconsToolOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ToolOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsToolOutlinedMod.foo` */
