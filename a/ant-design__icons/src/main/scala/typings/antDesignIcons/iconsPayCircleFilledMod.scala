...
object iconsPayCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PayCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPayCircleFilledMod.foo` */
