...
object distIconsGoogleCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GoogleCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGoogleCircleFilledMod.foo` */
