...
object distIconsUpSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UpSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUpSquareOutlinedMod.foo` */
