...
object antDesignIconsCiCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CiCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCiCircleFilledMod.foo` */
