...
object antDesignIconsMinusOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MinusOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMinusOutlinedMod.foo` */
