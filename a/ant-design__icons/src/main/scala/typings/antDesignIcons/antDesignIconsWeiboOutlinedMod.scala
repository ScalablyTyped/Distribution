...
object antDesignIconsWeiboOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WeiboOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWeiboOutlinedMod.foo` */
