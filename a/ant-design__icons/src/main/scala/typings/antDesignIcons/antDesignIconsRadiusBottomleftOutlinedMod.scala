...
object antDesignIconsRadiusBottomleftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RadiusBottomleftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRadiusBottomleftOutlinedMod.foo` */
