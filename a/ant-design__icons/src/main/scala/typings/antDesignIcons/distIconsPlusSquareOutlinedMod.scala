...
object distIconsPlusSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PlusSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPlusSquareOutlinedMod.foo` */
