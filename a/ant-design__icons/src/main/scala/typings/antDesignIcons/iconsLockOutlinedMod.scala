...
object iconsLockOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLockOutlinedMod.foo` */
