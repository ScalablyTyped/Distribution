...
object iconsFolderOpenTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderOpenTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderOpenTwoToneMod.foo` */
