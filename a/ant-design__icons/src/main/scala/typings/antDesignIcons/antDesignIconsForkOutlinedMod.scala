...
object antDesignIconsForkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ForkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsForkOutlinedMod.foo` */
