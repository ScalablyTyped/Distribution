...
object distIconsSecurityScanTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SecurityScanTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSecurityScanTwoToneMod.foo` */
