...
object antDesignIconsSlidersFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SlidersFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSlidersFilledMod.foo` */
