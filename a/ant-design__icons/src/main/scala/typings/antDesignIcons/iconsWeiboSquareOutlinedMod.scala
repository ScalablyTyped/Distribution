...
object iconsWeiboSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WeiboSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsWeiboSquareOutlinedMod.foo` */
