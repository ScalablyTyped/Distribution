...
object iconsSortAscendingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SortAscendingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSortAscendingOutlinedMod.foo` */
