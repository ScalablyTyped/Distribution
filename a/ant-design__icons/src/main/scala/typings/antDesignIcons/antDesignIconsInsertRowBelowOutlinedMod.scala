...
object antDesignIconsInsertRowBelowOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/InsertRowBelowOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsInsertRowBelowOutlinedMod.foo` */
