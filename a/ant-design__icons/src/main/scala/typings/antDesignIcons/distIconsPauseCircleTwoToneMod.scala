...
object distIconsPauseCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PauseCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPauseCircleTwoToneMod.foo` */
