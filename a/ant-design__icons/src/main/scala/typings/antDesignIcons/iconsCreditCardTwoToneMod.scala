...
object iconsCreditCardTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CreditCardTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCreditCardTwoToneMod.foo` */
