...
object distIconsCloseCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CloseCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCloseCircleFilledMod.foo` */
