...
object antDesignIconsShrinkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ShrinkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsShrinkOutlinedMod.foo` */
