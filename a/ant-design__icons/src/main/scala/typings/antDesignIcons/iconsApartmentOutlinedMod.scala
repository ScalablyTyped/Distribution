...
object iconsApartmentOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ApartmentOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsApartmentOutlinedMod.foo` */
