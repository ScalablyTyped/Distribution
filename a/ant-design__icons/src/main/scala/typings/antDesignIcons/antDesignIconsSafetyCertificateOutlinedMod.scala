...
object antDesignIconsSafetyCertificateOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SafetyCertificateOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSafetyCertificateOutlinedMod.foo` */
