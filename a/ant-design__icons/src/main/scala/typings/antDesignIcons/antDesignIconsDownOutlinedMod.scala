...
object antDesignIconsDownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDownOutlinedMod.foo` */
