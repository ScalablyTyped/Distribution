...
object distIconsPauseCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PauseCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPauseCircleOutlinedMod.foo` */
