...
object iconsControlTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ControlTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsControlTwoToneMod.foo` */
