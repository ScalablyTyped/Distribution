...
object antDesignIconsTrademarkCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TrademarkCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTrademarkCircleOutlinedMod.foo` */
