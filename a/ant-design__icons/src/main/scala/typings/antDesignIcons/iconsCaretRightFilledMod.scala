...
object iconsCaretRightFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CaretRightFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCaretRightFilledMod.foo` */
