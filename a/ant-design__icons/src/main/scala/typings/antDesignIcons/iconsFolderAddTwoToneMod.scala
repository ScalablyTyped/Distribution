...
object iconsFolderAddTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderAddTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderAddTwoToneMod.foo` */
