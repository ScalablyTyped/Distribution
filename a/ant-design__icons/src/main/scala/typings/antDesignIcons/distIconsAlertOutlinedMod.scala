...
object distIconsAlertOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AlertOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAlertOutlinedMod.foo` */
