...
object antDesignIconsProfileOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ProfileOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsProfileOutlinedMod.foo` */
