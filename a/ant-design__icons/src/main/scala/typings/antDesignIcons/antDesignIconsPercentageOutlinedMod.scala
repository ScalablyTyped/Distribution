...
object antDesignIconsPercentageOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PercentageOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPercentageOutlinedMod.foo` */
