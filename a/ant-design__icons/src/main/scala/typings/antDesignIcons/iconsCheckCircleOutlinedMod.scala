...
object iconsCheckCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CheckCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCheckCircleOutlinedMod.foo` */
