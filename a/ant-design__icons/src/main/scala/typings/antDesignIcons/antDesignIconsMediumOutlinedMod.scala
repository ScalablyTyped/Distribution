...
object antDesignIconsMediumOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MediumOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMediumOutlinedMod.foo` */
