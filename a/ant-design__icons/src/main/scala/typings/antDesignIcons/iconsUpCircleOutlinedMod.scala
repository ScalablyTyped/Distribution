...
object iconsUpCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UpCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUpCircleOutlinedMod.foo` */
