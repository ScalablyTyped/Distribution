...
object antDesignIconsSkinOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SkinOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSkinOutlinedMod.foo` */
