...
object antDesignIconsContactsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ContactsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsContactsFilledMod.foo` */
