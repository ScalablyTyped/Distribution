...
object iconsCodepenSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CodepenSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCodepenSquareFilledMod.foo` */
