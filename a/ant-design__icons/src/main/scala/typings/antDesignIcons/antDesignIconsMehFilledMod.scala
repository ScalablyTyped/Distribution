...
object antDesignIconsMehFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MehFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMehFilledMod.foo` */
