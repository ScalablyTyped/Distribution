...
object iconsCloseSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CloseSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCloseSquareOutlinedMod.foo` */
