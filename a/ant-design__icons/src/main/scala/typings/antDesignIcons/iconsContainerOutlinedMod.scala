...
object iconsContainerOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ContainerOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsContainerOutlinedMod.foo` */
