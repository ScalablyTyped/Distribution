...
object antDesignIconsPauseCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PauseCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPauseCircleFilledMod.foo` */
