...
object iconsCaretUpOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CaretUpOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCaretUpOutlinedMod.foo` */
