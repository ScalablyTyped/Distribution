...
object antDesignIconsCodeSandboxCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CodeSandboxCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCodeSandboxCircleFilledMod.foo` */
