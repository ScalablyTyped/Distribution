...
object iconsNodeCollapseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/NodeCollapseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsNodeCollapseOutlinedMod.foo` */
