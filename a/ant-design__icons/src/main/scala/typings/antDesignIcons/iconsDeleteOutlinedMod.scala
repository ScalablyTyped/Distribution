...
object iconsDeleteOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DeleteOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDeleteOutlinedMod.foo` */
