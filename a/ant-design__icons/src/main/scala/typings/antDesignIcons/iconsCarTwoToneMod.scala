...
object iconsCarTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CarTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCarTwoToneMod.foo` */
