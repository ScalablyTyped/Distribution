...
object distIconsRestFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/RestFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsRestFilledMod.foo` */
