...
object iconsEditTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/EditTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsEditTwoToneMod.foo` */
