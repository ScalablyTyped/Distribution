...
object antDesignIconsInfoCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/InfoCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsInfoCircleFilledMod.foo` */
