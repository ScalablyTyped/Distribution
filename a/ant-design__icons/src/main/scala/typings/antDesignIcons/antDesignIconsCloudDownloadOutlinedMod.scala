...
object antDesignIconsCloudDownloadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CloudDownloadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCloudDownloadOutlinedMod.foo` */
