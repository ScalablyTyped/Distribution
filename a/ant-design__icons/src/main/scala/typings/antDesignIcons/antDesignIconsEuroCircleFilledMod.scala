...
object antDesignIconsEuroCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/EuroCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsEuroCircleFilledMod.foo` */
