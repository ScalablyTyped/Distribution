...
object distIconsLayoutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LayoutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLayoutOutlinedMod.foo` */
