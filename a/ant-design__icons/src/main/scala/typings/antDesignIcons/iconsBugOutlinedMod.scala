...
object iconsBugOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BugOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBugOutlinedMod.foo` */
