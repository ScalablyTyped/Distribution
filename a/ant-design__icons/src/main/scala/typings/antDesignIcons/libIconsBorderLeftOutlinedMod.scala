...
object libIconsBorderLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BorderLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsBorderLeftOutlinedMod.foo` */
