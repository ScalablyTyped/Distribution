...
object antDesignIconsWhatsAppOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WhatsAppOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWhatsAppOutlinedMod.foo` */
