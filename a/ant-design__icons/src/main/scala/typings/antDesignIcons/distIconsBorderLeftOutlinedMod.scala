...
object distIconsBorderLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BorderLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBorderLeftOutlinedMod.foo` */
