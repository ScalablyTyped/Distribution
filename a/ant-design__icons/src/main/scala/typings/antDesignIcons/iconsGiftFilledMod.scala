...
object iconsGiftFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GiftFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGiftFilledMod.foo` */
