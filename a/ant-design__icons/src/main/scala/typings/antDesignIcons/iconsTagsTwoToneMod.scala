...
object iconsTagsTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TagsTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTagsTwoToneMod.foo` */
