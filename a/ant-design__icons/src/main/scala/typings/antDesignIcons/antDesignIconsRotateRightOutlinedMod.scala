...
object antDesignIconsRotateRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RotateRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRotateRightOutlinedMod.foo` */
