...
object iconsFireFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FireFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFireFilledMod.foo` */
