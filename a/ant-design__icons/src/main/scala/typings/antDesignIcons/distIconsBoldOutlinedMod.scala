...
object distIconsBoldOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BoldOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBoldOutlinedMod.foo` */
