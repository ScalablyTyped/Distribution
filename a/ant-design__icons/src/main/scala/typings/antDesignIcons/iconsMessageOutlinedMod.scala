...
object iconsMessageOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MessageOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMessageOutlinedMod.foo` */
