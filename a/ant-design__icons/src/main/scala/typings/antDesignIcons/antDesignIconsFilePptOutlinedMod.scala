...
object antDesignIconsFilePptOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilePptOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilePptOutlinedMod.foo` */
