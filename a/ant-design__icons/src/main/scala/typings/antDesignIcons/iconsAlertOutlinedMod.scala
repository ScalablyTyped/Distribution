...
object iconsAlertOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AlertOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAlertOutlinedMod.foo` */
