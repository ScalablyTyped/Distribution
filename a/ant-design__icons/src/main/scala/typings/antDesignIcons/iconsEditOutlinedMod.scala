...
object iconsEditOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/EditOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsEditOutlinedMod.foo` */
