...
object iconsPhoneFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PhoneFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPhoneFilledMod.foo` */
