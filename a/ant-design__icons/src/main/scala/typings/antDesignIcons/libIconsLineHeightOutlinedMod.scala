...
object libIconsLineHeightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LineHeightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsLineHeightOutlinedMod.foo` */
