...
object distIconsInsertRowRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/InsertRowRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsInsertRowRightOutlinedMod.foo` */
