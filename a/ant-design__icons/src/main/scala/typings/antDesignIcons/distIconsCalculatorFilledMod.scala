...
object distIconsCalculatorFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CalculatorFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCalculatorFilledMod.foo` */
