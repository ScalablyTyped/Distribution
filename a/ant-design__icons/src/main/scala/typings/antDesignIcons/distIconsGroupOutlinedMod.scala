...
object distIconsGroupOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/GroupOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsGroupOutlinedMod.foo` */
