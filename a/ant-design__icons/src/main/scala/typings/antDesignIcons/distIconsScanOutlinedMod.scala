...
object distIconsScanOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ScanOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsScanOutlinedMod.foo` */
