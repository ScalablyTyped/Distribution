...
object distIconsBackwardOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBackwardOutlinedMod.foo` */
