...
object iconsIssuesCloseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/IssuesCloseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsIssuesCloseOutlinedMod.foo` */
