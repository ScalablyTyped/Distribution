...
object iconsControlOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ControlOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsControlOutlinedMod.foo` */
