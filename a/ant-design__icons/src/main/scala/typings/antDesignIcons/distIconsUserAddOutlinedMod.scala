...
object distIconsUserAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UserAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUserAddOutlinedMod.foo` */
