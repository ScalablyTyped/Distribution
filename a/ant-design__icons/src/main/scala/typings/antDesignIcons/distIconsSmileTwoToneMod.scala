...
object distIconsSmileTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SmileTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSmileTwoToneMod.foo` */
