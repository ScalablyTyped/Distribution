...
object iconsSnippetsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SnippetsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSnippetsFilledMod.foo` */
