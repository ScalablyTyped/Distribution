...
object distIconsArrowDownOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ArrowDownOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsArrowDownOutlinedMod.foo` */
