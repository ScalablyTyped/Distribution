...
object distIconsTagOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/TagOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsTagOutlinedMod.foo` */
