...
object iconsFolderAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FolderAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFolderAddOutlinedMod.foo` */
