...
object antDesignIconsLoginOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LoginOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLoginOutlinedMod.foo` */
