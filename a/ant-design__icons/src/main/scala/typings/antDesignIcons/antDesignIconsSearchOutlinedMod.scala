...
object antDesignIconsSearchOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SearchOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSearchOutlinedMod.foo` */
