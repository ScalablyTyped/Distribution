...
object antDesignIconsUsbFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UsbFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUsbFilledMod.foo` */
