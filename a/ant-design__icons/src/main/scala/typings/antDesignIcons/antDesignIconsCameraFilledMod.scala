...
object antDesignIconsCameraFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CameraFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCameraFilledMod.foo` */
