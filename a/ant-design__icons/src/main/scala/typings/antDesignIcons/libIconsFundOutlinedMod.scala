...
object libIconsFundOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FundOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsFundOutlinedMod.foo` */
