...
object antDesignIconsLikeTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LikeTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLikeTwoToneMod.foo` */
