...
object iconsRotateLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RotateLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRotateLeftOutlinedMod.foo` */
