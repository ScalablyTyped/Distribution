...
object iconsCloudSyncOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CloudSyncOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCloudSyncOutlinedMod.foo` */
