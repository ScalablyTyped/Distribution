...
object antDesignIconsFallOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FallOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFallOutlinedMod.foo` */
