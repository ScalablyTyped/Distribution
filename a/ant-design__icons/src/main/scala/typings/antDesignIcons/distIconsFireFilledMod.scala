...
object distIconsFireFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FireFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFireFilledMod.foo` */
