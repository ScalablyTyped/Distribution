...
object distIconsWindowsFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WindowsFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWindowsFilledMod.foo` */
