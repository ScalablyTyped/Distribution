...
object iconsReconciliationTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ReconciliationTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsReconciliationTwoToneMod.foo` */
