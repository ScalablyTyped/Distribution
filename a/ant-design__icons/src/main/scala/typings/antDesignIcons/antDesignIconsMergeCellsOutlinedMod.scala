...
object antDesignIconsMergeCellsOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MergeCellsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMergeCellsOutlinedMod.foo` */
