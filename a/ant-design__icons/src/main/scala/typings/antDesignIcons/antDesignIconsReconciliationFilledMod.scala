...
object antDesignIconsReconciliationFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ReconciliationFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsReconciliationFilledMod.foo` */
