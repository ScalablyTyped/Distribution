...
object iconsGooglePlusSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GooglePlusSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGooglePlusSquareFilledMod.foo` */
