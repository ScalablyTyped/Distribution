...
object distIconsUserDeleteOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UserDeleteOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUserDeleteOutlinedMod.foo` */
