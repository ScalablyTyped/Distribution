...
object antDesignIconsTabletOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TabletOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTabletOutlinedMod.foo` */
