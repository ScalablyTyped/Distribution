...
object distIconsPropertySafetyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PropertySafetyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPropertySafetyOutlinedMod.foo` */
