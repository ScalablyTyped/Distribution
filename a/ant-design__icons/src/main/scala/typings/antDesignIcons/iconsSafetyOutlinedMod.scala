...
object iconsSafetyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SafetyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSafetyOutlinedMod.foo` */
