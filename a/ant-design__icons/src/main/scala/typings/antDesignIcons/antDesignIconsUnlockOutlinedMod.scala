...
object antDesignIconsUnlockOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/UnlockOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsUnlockOutlinedMod.foo` */
