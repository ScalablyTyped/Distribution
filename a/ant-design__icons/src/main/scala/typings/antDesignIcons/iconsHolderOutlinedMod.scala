...
object iconsHolderOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/HolderOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsHolderOutlinedMod.foo` */
