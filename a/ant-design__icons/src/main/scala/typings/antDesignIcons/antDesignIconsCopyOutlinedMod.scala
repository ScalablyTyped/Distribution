...
object antDesignIconsCopyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CopyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCopyOutlinedMod.foo` */
