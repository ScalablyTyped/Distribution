...
object distIconsFolderOpenOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderOpenOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderOpenOutlinedMod.foo` */
