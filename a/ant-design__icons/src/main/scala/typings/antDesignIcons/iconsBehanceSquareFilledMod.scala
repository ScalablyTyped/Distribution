...
object iconsBehanceSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BehanceSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBehanceSquareFilledMod.foo` */
