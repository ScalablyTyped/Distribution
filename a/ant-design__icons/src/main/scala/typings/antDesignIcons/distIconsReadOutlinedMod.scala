...
object distIconsReadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ReadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsReadOutlinedMod.foo` */
