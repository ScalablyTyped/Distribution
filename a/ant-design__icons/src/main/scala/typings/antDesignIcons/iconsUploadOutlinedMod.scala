...
object iconsUploadOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UploadOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUploadOutlinedMod.foo` */
