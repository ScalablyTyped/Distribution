...
object iconsForwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ForwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsForwardFilledMod.foo` */
