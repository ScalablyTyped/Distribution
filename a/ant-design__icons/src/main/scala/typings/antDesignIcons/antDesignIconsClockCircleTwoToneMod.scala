...
object antDesignIconsClockCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ClockCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsClockCircleTwoToneMod.foo` */
