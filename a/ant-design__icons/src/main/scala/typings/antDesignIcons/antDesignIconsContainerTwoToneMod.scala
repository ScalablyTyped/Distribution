...
object antDesignIconsContainerTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ContainerTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsContainerTwoToneMod.foo` */
