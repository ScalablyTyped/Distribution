...
object iconsReconciliationOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ReconciliationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsReconciliationOutlinedMod.foo` */
