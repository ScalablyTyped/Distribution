...
object iconsConsoleSqlOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ConsoleSqlOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsConsoleSqlOutlinedMod.foo` */
