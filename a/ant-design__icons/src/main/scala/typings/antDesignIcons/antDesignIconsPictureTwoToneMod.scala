...
object antDesignIconsPictureTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PictureTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPictureTwoToneMod.foo` */
