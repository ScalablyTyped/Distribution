...
object distIconsEnvironmentOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/EnvironmentOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsEnvironmentOutlinedMod.foo` */
