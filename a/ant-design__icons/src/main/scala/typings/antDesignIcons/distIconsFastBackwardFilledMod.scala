...
object distIconsFastBackwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FastBackwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFastBackwardFilledMod.foo` */
