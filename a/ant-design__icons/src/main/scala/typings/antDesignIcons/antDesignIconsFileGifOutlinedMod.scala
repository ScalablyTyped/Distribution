...
object antDesignIconsFileGifOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FileGifOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFileGifOutlinedMod.foo` */
