...
object iconsClearOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ClearOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsClearOutlinedMod.foo` */
