...
object iconsHighlightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/HighlightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsHighlightOutlinedMod.foo` */
