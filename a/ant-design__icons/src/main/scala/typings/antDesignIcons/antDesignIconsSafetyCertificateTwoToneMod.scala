...
object antDesignIconsSafetyCertificateTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SafetyCertificateTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSafetyCertificateTwoToneMod.foo` */
