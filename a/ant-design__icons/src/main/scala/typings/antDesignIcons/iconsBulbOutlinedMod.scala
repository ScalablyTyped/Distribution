...
object iconsBulbOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BulbOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBulbOutlinedMod.foo` */
