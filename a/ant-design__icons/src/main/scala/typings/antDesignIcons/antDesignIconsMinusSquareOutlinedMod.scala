...
object antDesignIconsMinusSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MinusSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMinusSquareOutlinedMod.foo` */
