...
object distIconsKeyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/KeyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsKeyOutlinedMod.foo` */
