...
object antDesignIconsSaveOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SaveOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSaveOutlinedMod.foo` */
