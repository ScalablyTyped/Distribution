...
object antDesignIconsDatabaseTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DatabaseTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDatabaseTwoToneMod.foo` */
