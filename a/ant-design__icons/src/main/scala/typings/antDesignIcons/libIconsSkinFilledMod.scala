...
object libIconsSkinFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SkinFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsSkinFilledMod.foo` */
