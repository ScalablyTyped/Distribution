...
object iconsBellTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BellTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBellTwoToneMod.foo` */
