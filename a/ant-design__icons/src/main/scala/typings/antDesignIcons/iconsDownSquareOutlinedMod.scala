...
object iconsDownSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DownSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDownSquareOutlinedMod.foo` */
