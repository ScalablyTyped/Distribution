...
object antDesignIconsEditOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/EditOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsEditOutlinedMod.foo` */
