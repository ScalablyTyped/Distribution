...
object antDesignIconsAlipayCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlipayCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlipayCircleOutlinedMod.foo` */
