...
object antDesignIconsTrademarkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TrademarkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTrademarkOutlinedMod.foo` */
