...
object iconsDeleteTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DeleteTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDeleteTwoToneMod.foo` */
