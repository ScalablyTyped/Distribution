...
object distIconsDingtalkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DingtalkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDingtalkOutlinedMod.foo` */
