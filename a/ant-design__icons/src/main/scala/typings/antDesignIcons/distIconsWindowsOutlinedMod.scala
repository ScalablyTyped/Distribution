...
object distIconsWindowsOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WindowsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWindowsOutlinedMod.foo` */
