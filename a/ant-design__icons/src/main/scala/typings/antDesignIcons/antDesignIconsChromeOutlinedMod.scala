...
object antDesignIconsChromeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ChromeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsChromeOutlinedMod.foo` */
