...
object antDesignIconsAlipayCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlipayCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlipayCircleFilledMod.foo` */
