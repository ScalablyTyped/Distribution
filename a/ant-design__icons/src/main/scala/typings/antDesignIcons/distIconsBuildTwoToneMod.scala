...
object distIconsBuildTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BuildTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBuildTwoToneMod.foo` */
