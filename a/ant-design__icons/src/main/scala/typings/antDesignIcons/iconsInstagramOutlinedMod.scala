...
object iconsInstagramOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/InstagramOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsInstagramOutlinedMod.foo` */
