...
object distIconsShoppingCartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ShoppingCartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsShoppingCartOutlinedMod.foo` */
