...
object iconsCameraTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CameraTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsCameraTwoToneMod.foo` */
