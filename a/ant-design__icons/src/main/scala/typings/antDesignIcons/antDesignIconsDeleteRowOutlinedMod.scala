...
object antDesignIconsDeleteRowOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DeleteRowOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDeleteRowOutlinedMod.foo` */
