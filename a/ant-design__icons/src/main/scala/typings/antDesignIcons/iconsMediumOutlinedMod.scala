...
object iconsMediumOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MediumOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMediumOutlinedMod.foo` */
