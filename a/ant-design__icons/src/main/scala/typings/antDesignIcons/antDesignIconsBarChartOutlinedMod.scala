...
object antDesignIconsBarChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BarChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBarChartOutlinedMod.foo` */
