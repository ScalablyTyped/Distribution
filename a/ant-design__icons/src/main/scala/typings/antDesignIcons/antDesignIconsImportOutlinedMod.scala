...
object antDesignIconsImportOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ImportOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsImportOutlinedMod.foo` */
