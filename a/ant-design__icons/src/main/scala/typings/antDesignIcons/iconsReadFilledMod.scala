...
object iconsReadFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ReadFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsReadFilledMod.foo` */
