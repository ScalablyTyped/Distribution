...
object distIconsSafetyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SafetyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSafetyOutlinedMod.foo` */
