...
object distIconsDashboardOutlinedMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDashboardOutlinedMod.foo` */
