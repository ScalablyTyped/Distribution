...
object distIconsSmileFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SmileFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSmileFilledMod.foo` */
