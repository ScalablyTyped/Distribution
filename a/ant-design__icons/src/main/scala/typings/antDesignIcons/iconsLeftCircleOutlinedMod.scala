...
object iconsLeftCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LeftCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLeftCircleOutlinedMod.foo` */
