...
object antDesignIconsClockCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ClockCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsClockCircleOutlinedMod.foo` */
