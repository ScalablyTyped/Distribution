...
object iconsGroupOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GroupOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGroupOutlinedMod.foo` */
