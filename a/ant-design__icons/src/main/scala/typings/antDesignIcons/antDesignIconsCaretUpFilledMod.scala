...
object antDesignIconsCaretUpFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CaretUpFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCaretUpFilledMod.foo` */
