...
object iconsExperimentOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ExperimentOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsExperimentOutlinedMod.foo` */
