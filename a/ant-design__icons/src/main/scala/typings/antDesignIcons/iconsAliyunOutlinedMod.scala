...
object iconsAliyunOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AliyunOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAliyunOutlinedMod.foo` */
