...
object distIconsFolderViewOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderViewOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderViewOutlinedMod.foo` */
