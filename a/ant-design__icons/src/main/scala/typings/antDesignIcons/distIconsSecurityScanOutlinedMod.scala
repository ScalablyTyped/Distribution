...
object distIconsSecurityScanOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SecurityScanOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSecurityScanOutlinedMod.foo` */
