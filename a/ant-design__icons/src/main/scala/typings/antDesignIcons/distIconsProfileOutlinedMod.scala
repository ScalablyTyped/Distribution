...
object distIconsProfileOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ProfileOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsProfileOutlinedMod.foo` */
