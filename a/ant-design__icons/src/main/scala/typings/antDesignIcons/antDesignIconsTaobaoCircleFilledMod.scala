...
object antDesignIconsTaobaoCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TaobaoCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTaobaoCircleFilledMod.foo` */
