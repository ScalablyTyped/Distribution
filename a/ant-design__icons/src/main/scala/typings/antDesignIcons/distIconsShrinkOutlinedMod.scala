...
object distIconsShrinkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ShrinkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsShrinkOutlinedMod.foo` */
