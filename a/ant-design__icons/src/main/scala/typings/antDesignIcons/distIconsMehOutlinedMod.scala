...
object distIconsMehOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MehOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMehOutlinedMod.foo` */
