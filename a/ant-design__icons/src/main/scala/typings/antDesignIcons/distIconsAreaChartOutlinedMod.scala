...
object distIconsAreaChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AreaChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAreaChartOutlinedMod.foo` */
