...
object antDesignIconsAlipaySquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlipaySquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlipaySquareFilledMod.foo` */
