...
object antDesignIconsCloudFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CloudFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCloudFilledMod.foo` */
