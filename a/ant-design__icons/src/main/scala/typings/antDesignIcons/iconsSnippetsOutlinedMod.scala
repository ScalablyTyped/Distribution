...
object iconsSnippetsOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SnippetsOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSnippetsOutlinedMod.foo` */
