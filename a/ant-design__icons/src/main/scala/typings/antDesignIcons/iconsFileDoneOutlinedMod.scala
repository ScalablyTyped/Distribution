...
object iconsFileDoneOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileDoneOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileDoneOutlinedMod.foo` */
