...
object iconsRadarChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RadarChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRadarChartOutlinedMod.foo` */
