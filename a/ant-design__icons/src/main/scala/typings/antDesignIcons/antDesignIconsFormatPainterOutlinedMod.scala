...
object antDesignIconsFormatPainterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FormatPainterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFormatPainterOutlinedMod.foo` */
