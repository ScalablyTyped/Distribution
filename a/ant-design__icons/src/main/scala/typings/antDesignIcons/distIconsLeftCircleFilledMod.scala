...
object distIconsLeftCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LeftCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLeftCircleFilledMod.foo` */
