...
object iconsMedicineBoxOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MedicineBoxOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMedicineBoxOutlinedMod.foo` */
