...
object iconsAppleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AppleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAppleFilledMod.foo` */
