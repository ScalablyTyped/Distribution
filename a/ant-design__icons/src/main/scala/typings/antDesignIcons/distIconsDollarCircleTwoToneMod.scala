...
object distIconsDollarCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DollarCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDollarCircleTwoToneMod.foo` */
