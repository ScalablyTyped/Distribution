...
object distIconsExperimentTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ExperimentTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsExperimentTwoToneMod.foo` */
