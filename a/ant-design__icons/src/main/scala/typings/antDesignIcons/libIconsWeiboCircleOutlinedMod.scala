...
object libIconsWeiboCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WeiboCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsWeiboCircleOutlinedMod.foo` */
