...
object iconsUpSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UpSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUpSquareFilledMod.foo` */
