...
object antDesignIconsLinkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LinkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLinkOutlinedMod.foo` */
