...
object iconsHighlightFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/HighlightFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsHighlightFilledMod.foo` */
