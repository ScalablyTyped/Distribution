...
object distIconsScheduleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ScheduleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsScheduleOutlinedMod.foo` */
