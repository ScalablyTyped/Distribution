...
object iconsPlusCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PlusCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPlusCircleFilledMod.foo` */
