...
object antDesignIconsLeftCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LeftCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLeftCircleFilledMod.foo` */
