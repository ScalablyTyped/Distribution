...
object distIconsPictureFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PictureFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPictureFilledMod.foo` */
