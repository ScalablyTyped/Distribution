...
object iconsMailTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/MailTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsMailTwoToneMod.foo` */
