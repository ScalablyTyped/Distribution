...
object distIconsSwitcherOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SwitcherOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSwitcherOutlinedMod.foo` */
