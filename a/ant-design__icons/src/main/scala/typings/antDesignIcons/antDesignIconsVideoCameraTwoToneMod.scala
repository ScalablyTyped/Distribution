...
object antDesignIconsVideoCameraTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/VideoCameraTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsVideoCameraTwoToneMod.foo` */
