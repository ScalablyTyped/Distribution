...
object antDesignIconsForwardFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ForwardFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsForwardFilledMod.foo` */
