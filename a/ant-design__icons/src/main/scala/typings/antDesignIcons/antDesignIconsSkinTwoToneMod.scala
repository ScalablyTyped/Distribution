...
object antDesignIconsSkinTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SkinTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSkinTwoToneMod.foo` */
