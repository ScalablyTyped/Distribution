...
object distIconsOneToOneOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/OneToOneOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsOneToOneOutlinedMod.foo` */
