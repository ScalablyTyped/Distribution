...
object distIconsUpSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UpSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUpSquareFilledMod.foo` */
