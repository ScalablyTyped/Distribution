...
object antDesignIconsPoweroffOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PoweroffOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPoweroffOutlinedMod.foo` */
