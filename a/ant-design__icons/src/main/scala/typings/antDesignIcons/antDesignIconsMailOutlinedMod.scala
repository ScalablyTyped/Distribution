...
object antDesignIconsMailOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MailOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMailOutlinedMod.foo` */
