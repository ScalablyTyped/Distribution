...
object antDesignIconsApiOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ApiOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsApiOutlinedMod.foo` */
