...
object iconsRollbackOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RollbackOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRollbackOutlinedMod.foo` */
