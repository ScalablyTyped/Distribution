...
object antDesignIconsAimOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AimOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAimOutlinedMod.foo` */
