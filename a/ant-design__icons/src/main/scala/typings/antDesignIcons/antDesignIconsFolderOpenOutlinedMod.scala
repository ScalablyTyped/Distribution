...
object antDesignIconsFolderOpenOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FolderOpenOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFolderOpenOutlinedMod.foo` */
