...
object distIconsFileTextFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileTextFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileTextFilledMod.foo` */
