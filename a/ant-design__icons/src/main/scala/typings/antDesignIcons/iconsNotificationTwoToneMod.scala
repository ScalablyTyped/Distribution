...
object iconsNotificationTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/NotificationTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsNotificationTwoToneMod.foo` */
