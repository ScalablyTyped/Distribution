...
object antDesignIconsPushpinOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PushpinOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPushpinOutlinedMod.foo` */
