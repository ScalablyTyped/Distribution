...
object antDesignIconsToolFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ToolFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsToolFilledMod.foo` */
