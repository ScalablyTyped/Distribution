...
object antDesignIconsDesktopOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DesktopOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDesktopOutlinedMod.foo` */
