...
object distIconsExportOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ExportOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsExportOutlinedMod.foo` */
