...
object antDesignIconsMessageFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MessageFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMessageFilledMod.foo` */
