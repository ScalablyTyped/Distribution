...
object iconsShoppingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShoppingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShoppingOutlinedMod.foo` */
