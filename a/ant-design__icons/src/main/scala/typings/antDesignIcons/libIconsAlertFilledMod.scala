...
object libIconsAlertFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AlertFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsAlertFilledMod.foo` */
