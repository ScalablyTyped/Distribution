...
object iconsUpCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/UpCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsUpCircleTwoToneMod.foo` */
