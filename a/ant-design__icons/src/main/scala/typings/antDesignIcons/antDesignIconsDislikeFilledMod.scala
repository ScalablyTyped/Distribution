...
object antDesignIconsDislikeFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DislikeFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDislikeFilledMod.foo` */
