...
object antDesignIconsVerticalAlignTopOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/VerticalAlignTopOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsVerticalAlignTopOutlinedMod.foo` */
