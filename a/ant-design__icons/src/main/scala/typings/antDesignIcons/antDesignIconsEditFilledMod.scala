...
object antDesignIconsEditFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/EditFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsEditFilledMod.foo` */
