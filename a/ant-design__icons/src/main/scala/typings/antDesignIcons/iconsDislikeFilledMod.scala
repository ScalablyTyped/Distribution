...
object iconsDislikeFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DislikeFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDislikeFilledMod.foo` */
