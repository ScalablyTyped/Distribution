...
object distIconsDownSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DownSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDownSquareFilledMod.foo` */
