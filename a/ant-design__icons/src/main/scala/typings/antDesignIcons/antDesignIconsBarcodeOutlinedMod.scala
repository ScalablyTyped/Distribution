...
object antDesignIconsBarcodeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BarcodeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBarcodeOutlinedMod.foo` */
