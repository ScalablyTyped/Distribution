...
object antDesignIconsCheckOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CheckOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCheckOutlinedMod.foo` */
