...
object distIconsAudioFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AudioFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAudioFilledMod.foo` */
