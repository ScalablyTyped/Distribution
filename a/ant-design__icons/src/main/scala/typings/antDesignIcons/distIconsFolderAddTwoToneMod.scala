...
object distIconsFolderAddTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FolderAddTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFolderAddTwoToneMod.foo` */
