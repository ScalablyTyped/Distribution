...
object antDesignIconsLoadingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LoadingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLoadingOutlinedMod.foo` */
