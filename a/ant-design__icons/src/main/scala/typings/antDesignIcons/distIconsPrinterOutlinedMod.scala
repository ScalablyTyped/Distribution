...
object distIconsPrinterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PrinterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPrinterOutlinedMod.foo` */
