...
object antDesignIconsBackwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BackwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBackwardOutlinedMod.foo` */
