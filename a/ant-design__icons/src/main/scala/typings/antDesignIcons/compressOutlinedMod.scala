...
object compressOutlinedMod extends Shortcut {
  ...
  @JSImport("@ant-design/icons/CompressOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `compressOutlinedMod.foo` */
