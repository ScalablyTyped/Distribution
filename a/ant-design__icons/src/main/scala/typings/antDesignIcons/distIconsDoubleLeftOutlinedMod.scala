...
object distIconsDoubleLeftOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DoubleLeftOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDoubleLeftOutlinedMod.foo` */
