...
object iconsWechatFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WechatFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsWechatFilledMod.foo` */
