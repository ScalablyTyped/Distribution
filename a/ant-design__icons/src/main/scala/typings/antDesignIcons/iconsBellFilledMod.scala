...
object iconsBellFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BellFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBellFilledMod.foo` */
