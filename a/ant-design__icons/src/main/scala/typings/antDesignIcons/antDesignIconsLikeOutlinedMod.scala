...
object antDesignIconsLikeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LikeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLikeOutlinedMod.foo` */
