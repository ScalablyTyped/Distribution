...
object antDesignIconsMoneyCollectOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MoneyCollectOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMoneyCollectOutlinedMod.foo` */
