...
object distIconsSlidersTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SlidersTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSlidersTwoToneMod.foo` */
