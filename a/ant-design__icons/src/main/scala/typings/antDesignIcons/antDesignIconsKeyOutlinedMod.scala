...
object antDesignIconsKeyOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/KeyOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsKeyOutlinedMod.foo` */
