...
object iconsFilePdfFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FilePdfFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFilePdfFilledMod.foo` */
