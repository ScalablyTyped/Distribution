...
object antDesignIconsMoneyCollectFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MoneyCollectFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMoneyCollectFilledMod.foo` */
