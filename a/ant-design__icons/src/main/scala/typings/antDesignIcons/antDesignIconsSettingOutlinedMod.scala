...
object antDesignIconsSettingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/SettingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsSettingOutlinedMod.foo` */
