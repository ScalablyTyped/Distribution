...
object distIconsSkinOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SkinOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSkinOutlinedMod.foo` */
