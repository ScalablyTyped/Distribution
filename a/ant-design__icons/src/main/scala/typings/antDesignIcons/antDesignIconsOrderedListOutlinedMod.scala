...
object antDesignIconsOrderedListOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/OrderedListOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsOrderedListOutlinedMod.foo` */
