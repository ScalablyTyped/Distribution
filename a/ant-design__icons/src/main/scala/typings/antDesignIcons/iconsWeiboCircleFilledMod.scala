...
object iconsWeiboCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/WeiboCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsWeiboCircleFilledMod.foo` */
