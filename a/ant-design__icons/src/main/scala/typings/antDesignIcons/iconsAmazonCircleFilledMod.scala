...
object iconsAmazonCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/AmazonCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsAmazonCircleFilledMod.foo` */
