...
object iconsPoundCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PoundCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPoundCircleTwoToneMod.foo` */
