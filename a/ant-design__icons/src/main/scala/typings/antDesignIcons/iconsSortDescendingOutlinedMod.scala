...
object iconsSortDescendingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SortDescendingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSortDescendingOutlinedMod.foo` */
