...
object distIconsDribbbleSquareOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DribbbleSquareOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDribbbleSquareOutlinedMod.foo` */
