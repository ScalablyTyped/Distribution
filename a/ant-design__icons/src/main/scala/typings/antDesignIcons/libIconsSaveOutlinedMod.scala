...
object libIconsSaveOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SaveOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsSaveOutlinedMod.foo` */
