...
object distIconsLoginOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LoginOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLoginOutlinedMod.foo` */
