...
object iconsEuroCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/EuroCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsEuroCircleOutlinedMod.foo` */
