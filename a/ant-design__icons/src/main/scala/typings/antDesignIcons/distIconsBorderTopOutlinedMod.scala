...
object distIconsBorderTopOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BorderTopOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBorderTopOutlinedMod.foo` */
