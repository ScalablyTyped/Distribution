...
object iconsEuroCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/EuroCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsEuroCircleTwoToneMod.foo` */
