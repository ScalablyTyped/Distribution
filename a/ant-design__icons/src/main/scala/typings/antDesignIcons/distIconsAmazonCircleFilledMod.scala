...
object distIconsAmazonCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AmazonCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAmazonCircleFilledMod.foo` */
