...
object iconsPhoneTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PhoneTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPhoneTwoToneMod.foo` */
