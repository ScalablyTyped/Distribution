...
object iconsDropboxOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DropboxOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsDropboxOutlinedMod.foo` */
