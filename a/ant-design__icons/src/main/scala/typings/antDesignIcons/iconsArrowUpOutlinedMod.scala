...
object iconsArrowUpOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ArrowUpOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsArrowUpOutlinedMod.foo` */
