...
object distIconsSolutionOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SolutionOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSolutionOutlinedMod.foo` */
