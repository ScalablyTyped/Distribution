...
object iconsSlidersOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SlidersOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSlidersOutlinedMod.foo` */
