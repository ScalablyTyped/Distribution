...
object iconsContainerTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ContainerTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsContainerTwoToneMod.foo` */
