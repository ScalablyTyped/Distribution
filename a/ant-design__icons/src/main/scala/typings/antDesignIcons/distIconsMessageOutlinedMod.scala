...
object distIconsMessageOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MessageOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMessageOutlinedMod.foo` */
