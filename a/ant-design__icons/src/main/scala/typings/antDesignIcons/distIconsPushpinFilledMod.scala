...
object distIconsPushpinFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PushpinFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPushpinFilledMod.foo` */
