...
object iconsRiseOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/RiseOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsRiseOutlinedMod.foo` */
