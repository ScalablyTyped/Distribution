...
object iconsIeCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/IeCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsIeCircleFilledMod.foo` */
