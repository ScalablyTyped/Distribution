...
object antDesignIconsClearOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ClearOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsClearOutlinedMod.foo` */
