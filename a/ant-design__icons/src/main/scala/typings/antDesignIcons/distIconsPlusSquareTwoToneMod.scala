...
object distIconsPlusSquareTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/PlusSquareTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsPlusSquareTwoToneMod.foo` */
