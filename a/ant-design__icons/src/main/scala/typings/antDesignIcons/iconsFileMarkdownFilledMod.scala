...
object iconsFileMarkdownFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/FileMarkdownFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsFileMarkdownFilledMod.foo` */
