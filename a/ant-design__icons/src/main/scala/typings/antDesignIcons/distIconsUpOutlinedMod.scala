...
object distIconsUpOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/UpOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsUpOutlinedMod.foo` */
