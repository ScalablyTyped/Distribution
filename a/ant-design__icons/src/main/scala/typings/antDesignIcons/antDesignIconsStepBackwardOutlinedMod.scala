...
object antDesignIconsStepBackwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/StepBackwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsStepBackwardOutlinedMod.foo` */
