...
object libIconsDingdingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/DingdingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsDingdingOutlinedMod.foo` */
