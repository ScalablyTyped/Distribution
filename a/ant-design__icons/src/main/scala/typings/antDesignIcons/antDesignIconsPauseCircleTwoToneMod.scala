...
object antDesignIconsPauseCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PauseCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPauseCircleTwoToneMod.foo` */
