...
object distIconsFullscreenOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FullscreenOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFullscreenOutlinedMod.foo` */
