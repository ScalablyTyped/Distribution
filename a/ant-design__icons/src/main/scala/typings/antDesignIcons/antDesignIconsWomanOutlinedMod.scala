...
object antDesignIconsWomanOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WomanOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWomanOutlinedMod.foo` */
