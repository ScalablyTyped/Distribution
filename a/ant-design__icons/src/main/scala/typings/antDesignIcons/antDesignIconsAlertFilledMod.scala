...
object antDesignIconsAlertFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/AlertFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsAlertFilledMod.foo` */
