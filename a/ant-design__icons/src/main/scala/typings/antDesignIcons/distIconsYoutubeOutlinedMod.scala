...
object distIconsYoutubeOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/YoutubeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsYoutubeOutlinedMod.foo` */
