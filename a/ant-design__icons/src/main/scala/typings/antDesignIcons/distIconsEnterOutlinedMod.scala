...
object distIconsEnterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/EnterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsEnterOutlinedMod.foo` */
