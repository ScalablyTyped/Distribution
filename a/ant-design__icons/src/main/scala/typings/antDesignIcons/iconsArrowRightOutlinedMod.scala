...
object iconsArrowRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ArrowRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsArrowRightOutlinedMod.foo` */
