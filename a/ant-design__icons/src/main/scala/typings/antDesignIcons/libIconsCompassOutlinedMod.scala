...
object libIconsCompassOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/CompassOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsCompassOutlinedMod.foo` */
