...
object distIconsHddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/HddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsHddOutlinedMod.foo` */
