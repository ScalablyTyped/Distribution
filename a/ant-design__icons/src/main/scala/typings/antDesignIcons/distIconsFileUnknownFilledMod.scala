...
object distIconsFileUnknownFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileUnknownFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileUnknownFilledMod.foo` */
