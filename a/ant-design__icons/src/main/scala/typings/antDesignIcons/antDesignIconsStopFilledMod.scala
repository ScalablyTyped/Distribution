...
object antDesignIconsStopFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/StopFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsStopFilledMod.foo` */
