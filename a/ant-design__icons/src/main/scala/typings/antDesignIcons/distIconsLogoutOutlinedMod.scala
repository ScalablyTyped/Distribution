...
object distIconsLogoutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/LogoutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsLogoutOutlinedMod.foo` */
