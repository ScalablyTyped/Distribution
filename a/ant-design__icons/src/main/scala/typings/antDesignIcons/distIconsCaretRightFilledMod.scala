...
object distIconsCaretRightFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CaretRightFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCaretRightFilledMod.foo` */
