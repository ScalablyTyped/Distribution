...
object iconsBarChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BarChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBarChartOutlinedMod.foo` */
