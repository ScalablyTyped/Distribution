...
object antDesignIconsLaptopOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LaptopOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLaptopOutlinedMod.foo` */
