...
object distIconsDownCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DownCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDownCircleOutlinedMod.foo` */
