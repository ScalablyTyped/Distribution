...
object antDesignIconsFilePdfFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FilePdfFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFilePdfFilledMod.foo` */
