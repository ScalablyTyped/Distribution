...
object distIconsHighlightTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/HighlightTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsHighlightTwoToneMod.foo` */
