...
object distIconsFileProtectOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/FileProtectOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsFileProtectOutlinedMod.foo` */
