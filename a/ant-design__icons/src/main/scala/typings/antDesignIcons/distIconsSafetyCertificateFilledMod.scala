...
object distIconsSafetyCertificateFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/SafetyCertificateFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsSafetyCertificateFilledMod.foo` */
