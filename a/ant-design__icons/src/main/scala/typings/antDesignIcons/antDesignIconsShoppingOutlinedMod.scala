...
object antDesignIconsShoppingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/ShoppingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsShoppingOutlinedMod.foo` */
