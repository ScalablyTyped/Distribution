...
object antDesignIconsPlusCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PlusCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPlusCircleFilledMod.foo` */
