...
object antDesignIconsMinusCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MinusCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMinusCircleFilledMod.foo` */
