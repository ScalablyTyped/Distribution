...
object distIconsWechatOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WechatOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWechatOutlinedMod.foo` */
