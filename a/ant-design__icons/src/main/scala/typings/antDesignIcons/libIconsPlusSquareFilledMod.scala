...
object libIconsPlusSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PlusSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `libIconsPlusSquareFilledMod.foo` */
