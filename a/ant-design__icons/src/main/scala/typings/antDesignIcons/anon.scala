...
object anon {
  ...
  trait PickAntdIconPropstwoToneC extends StObject {
    ...
    var twoToneColor: js.UndefOr[typings.antDesignIcons.twoTonePrimaryColorMod.TwoToneColor] = js.undefined
  ...
  object PickAntdIconPropstwoToneC {
    ...
    inline def apply(): PickAntdIconPropstwoToneC = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickAntdIconPropstwoToneC]
    }
    
    extension [Self <: PickAntdIconPropstwoToneC](x: Self) {
      ...
      inline def setTwoToneColor(value: typings.antDesignIcons.twoTonePrimaryColorMod.TwoToneColor): Self = StObject.set(x, "twoToneColor", value.asInstanceOf[js.Any])
  ...
  object PickIconComponentPropsari {
    ...
    inline def apply(): PickIconComponentPropsari = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[PickIconComponentPropsari]
    }
    
    extension [Self <: PickIconComponentPropsari](x: Self) {
  ...
  trait PickIconComponentPropsmax extends StObject {
    ...
    var component: js.UndefOr[
        ComponentType[
          typings.antDesignIcons.componentsIconMod.CustomIconComponentProps | SVGProps[SVGSVGElement]
        ]
      ] = js.undefined
