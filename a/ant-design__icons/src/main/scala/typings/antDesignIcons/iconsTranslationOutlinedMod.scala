...
object iconsTranslationOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TranslationOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTranslationOutlinedMod.foo` */
