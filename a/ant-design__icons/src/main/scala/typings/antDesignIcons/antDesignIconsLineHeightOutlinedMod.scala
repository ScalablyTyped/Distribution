...
object antDesignIconsLineHeightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LineHeightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLineHeightOutlinedMod.foo` */
