...
object antDesignIconsRadarChartOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/RadarChartOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsRadarChartOutlinedMod.foo` */
