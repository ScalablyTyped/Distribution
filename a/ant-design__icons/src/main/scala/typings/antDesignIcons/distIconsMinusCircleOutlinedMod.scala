...
object distIconsMinusCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MinusCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMinusCircleOutlinedMod.foo` */
