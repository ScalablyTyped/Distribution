...
object antDesignIconsMinusCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/MinusCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsMinusCircleTwoToneMod.foo` */
