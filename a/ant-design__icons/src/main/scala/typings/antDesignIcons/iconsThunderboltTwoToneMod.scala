...
object iconsThunderboltTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ThunderboltTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsThunderboltTwoToneMod.foo` */
