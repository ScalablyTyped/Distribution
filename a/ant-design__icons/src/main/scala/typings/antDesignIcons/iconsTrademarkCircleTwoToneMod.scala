...
object iconsTrademarkCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TrademarkCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTrademarkCircleTwoToneMod.foo` */
