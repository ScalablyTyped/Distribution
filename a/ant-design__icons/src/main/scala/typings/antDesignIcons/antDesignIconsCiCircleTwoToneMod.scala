...
object antDesignIconsCiCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CiCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCiCircleTwoToneMod.foo` */
