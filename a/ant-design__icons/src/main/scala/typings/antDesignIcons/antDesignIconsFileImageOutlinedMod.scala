...
object antDesignIconsFileImageOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FileImageOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFileImageOutlinedMod.foo` */
