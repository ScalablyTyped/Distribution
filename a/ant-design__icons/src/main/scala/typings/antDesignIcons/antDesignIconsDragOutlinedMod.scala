...
object antDesignIconsDragOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/DragOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsDragOutlinedMod.foo` */
