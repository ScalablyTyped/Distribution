...
object antDesignIconsLeftCircleOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/LeftCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsLeftCircleOutlinedMod.foo` */
