...
object iconsTrademarkOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/TrademarkOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsTrademarkOutlinedMod.foo` */
