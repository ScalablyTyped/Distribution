...
object iconsPicRightOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/PicRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsPicRightOutlinedMod.foo` */
