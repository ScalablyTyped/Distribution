...
object iconsLayoutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/LayoutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsLayoutOutlinedMod.foo` */
