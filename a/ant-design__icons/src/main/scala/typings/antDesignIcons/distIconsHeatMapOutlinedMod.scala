...
object distIconsHeatMapOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/HeatMapOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsHeatMapOutlinedMod.foo` */
