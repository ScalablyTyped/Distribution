...
object distIconsDingdingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/DingdingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsDingdingOutlinedMod.foo` */
