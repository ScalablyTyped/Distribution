...
object antDesignIconsCompassFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/CompassFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsCompassFilledMod.foo` */
