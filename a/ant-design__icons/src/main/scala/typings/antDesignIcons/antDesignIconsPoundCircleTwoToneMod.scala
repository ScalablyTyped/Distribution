...
object antDesignIconsPoundCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/PoundCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsPoundCircleTwoToneMod.foo` */
