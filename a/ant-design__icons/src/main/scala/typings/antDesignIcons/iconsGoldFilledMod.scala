...
object iconsGoldFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/GoldFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsGoldFilledMod.foo` */
