...
object antDesignIconsBulbOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BulbOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBulbOutlinedMod.foo` */
