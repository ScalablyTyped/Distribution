...
object iconsBackwardOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/BackwardOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsBackwardOutlinedMod.foo` */
