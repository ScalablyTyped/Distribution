...
object antDesignIconsWeiboCircleFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WeiboCircleFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWeiboCircleFilledMod.foo` */
