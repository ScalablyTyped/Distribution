...
object antDesignIconsBorderlessTableOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BorderlessTableOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBorderlessTableOutlinedMod.foo` */
