...
object distIconsShopFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/ShopFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsShopFilledMod.foo` */
