...
object distIconsVideoCameraAddOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/VideoCameraAddOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsVideoCameraAddOutlinedMod.foo` */
