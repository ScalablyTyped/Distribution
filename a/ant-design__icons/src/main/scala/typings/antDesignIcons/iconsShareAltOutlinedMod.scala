...
object iconsShareAltOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/ShareAltOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsShareAltOutlinedMod.foo` */
