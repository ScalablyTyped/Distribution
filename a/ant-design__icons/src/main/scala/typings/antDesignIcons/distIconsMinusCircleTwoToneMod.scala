...
object distIconsMinusCircleTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MinusCircleTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMinusCircleTwoToneMod.foo` */
