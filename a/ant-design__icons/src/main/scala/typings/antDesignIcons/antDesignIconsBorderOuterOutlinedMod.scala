...
object antDesignIconsBorderOuterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/BorderOuterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsBorderOuterOutlinedMod.foo` */
