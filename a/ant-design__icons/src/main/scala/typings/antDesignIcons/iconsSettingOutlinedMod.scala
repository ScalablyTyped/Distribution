...
object iconsSettingOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/lib/icons/SettingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `iconsSettingOutlinedMod.foo` */
