...
object antDesignIconsWarningTwoToneMod extends Shortcut {
  
  @JSImport("@ant-design/icons/WarningTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsWarningTwoToneMod.foo` */
