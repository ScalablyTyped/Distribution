...
object distIconsBoxPlotFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/BoxPlotFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsBoxPlotFilledMod.foo` */
