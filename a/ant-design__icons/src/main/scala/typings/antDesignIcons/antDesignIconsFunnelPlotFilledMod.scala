...
object antDesignIconsFunnelPlotFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/FunnelPlotFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsFunnelPlotFilledMod.foo` */
