...
object distIconsMobileFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/MobileFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsMobileFilledMod.foo` */
