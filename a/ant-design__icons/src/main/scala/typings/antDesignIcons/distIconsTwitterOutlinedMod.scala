...
object distIconsTwitterOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/TwitterOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsTwitterOutlinedMod.foo` */
