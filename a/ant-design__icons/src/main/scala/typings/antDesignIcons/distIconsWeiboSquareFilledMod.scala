...
object distIconsWeiboSquareFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/WeiboSquareFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsWeiboSquareFilledMod.foo` */
