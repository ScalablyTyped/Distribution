...
object distIconsAudioOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/AudioOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsAudioOutlinedMod.foo` */
