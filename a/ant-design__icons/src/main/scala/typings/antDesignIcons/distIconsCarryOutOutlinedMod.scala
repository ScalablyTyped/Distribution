...
object distIconsCarryOutOutlinedMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CarryOutOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCarryOutOutlinedMod.foo` */
