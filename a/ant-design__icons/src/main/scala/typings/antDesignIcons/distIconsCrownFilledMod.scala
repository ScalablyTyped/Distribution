...
object distIconsCrownFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CrownFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCrownFilledMod.foo` */
