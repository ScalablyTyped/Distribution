...
object antDesignIconsTabletFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/TabletFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `antDesignIconsTabletFilledMod.foo` */
