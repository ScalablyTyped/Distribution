...
object distIconsCameraFilledMod extends Shortcut {
  
  @JSImport("@ant-design/icons/dist/icons/CameraFilled", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distIconsCameraFilledMod.foo` */
