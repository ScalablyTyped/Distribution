...
trait AzureDeveloperCliCredentialOptions
  extends StObject
...
object AzureDeveloperCliCredentialOptions {
  
  inline def apply(): AzureDeveloperCliCredentialOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AzureDeveloperCliCredentialOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AzureDeveloperCliCredentialOptions] (val x: Self) extends AnyVal {
