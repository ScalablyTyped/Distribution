...
import typings.azureCoreRestPipeline.`31CoreRestPipelineMod`.HttpMethods
...
object azureCoreRestPipelineStrings {
  ...
  sealed trait DELETE
    extends StObject
       with HttpMethods
       with typings.azureCoreRestPipeline.coreRestPipelineMod.HttpMethods
  ...
  sealed trait Deserialize
    extends StObject
       with PipelinePhase
       with typings.azureCoreRestPipeline.coreRestPipelineMod.PipelinePhase
