...
import typings.azureCoreRestPipeline.`31CoreRestPipelineMod`.^
...
type RequestBodyType = (ReadableStream[Any | js.typedarray.Uint8Array]) | (js.Function0[ReadableStream[Any | js.typedarray.Uint8Array]]) | Blob | js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | FormData | String | Null
