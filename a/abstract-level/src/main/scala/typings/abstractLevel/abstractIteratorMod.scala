...
import typings.abstractLevel.interfacesMod.RangeOptions
import typings.levelTranscoder.encodingMod.PartialDecoder
...
object abstractIteratorMod {
  ...
  trait CommonIterator[TDatabase, T] extends StObject {
    ...
    def apply(): AsyncGenerator[T, Unit, Any] = js.native
    ...
    /**
      ...
      */
    def limit: /* import warning: importer.ImportType#apply Failed type conversion: number[/ * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Symbol.asyncIterator * / any] */ js.Any = js.native
  }
