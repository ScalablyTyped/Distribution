...
import typings.abstractLevel.abstractChainedBatchMod.AbstractChainedBatch
import typings.abstractLevel.abstractIteratorMod.AbstractIterator
import typings.abstractLevel.abstractIteratorMod.AbstractIteratorOptions
import typings.abstractLevel.abstractIteratorMod.AbstractKeyIterator
import typings.abstractLevel.abstractIteratorMod.AbstractKeyIteratorOptions
import typings.abstractLevel.abstractIteratorMod.AbstractValueIterator
...
object abstractLevelMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.abstractLevel.abstractLevelMod.AbstractBatchPutOperation[TDatabase, K, V]
    - typings.abstractLevel.abstractLevelMod.AbstractBatchDelOperation[TDatabase, K]
  */
  trait AbstractBatchOperation[TDatabase, K, V] extends StObject
  object AbstractBatchOperation {
    
    inline def AbstractBatchDelOperation[TDatabase, K](key: K): typings.abstractLevel.abstractLevelMod.AbstractBatchDelOperation[TDatabase, K] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("del")
      __obj.asInstanceOf[typings.abstractLevel.abstractLevelMod.AbstractBatchDelOperation[TDatabase, K]]
    }
    
    inline def AbstractBatchPutOperation[TDatabase, K, V](key: K, value: V): typings.abstractLevel.abstractLevelMod.AbstractBatchPutOperation[TDatabase, K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("put")
      __obj.asInstanceOf[typings.abstractLevel.abstractLevelMod.AbstractBatchPutOperation[TDatabase, K, V]]
    }
  }
