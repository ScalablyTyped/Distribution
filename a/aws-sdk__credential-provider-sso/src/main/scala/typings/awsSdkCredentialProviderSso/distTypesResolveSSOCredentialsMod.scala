...
object distTypesResolveSSOCredentialsMod {
  ...
  inline def resolveSSOCredentials(param0: FromSSOInit & SsoCredentialsParameters): js.Promise[AwsCredentialIdentity] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolveSSOCredentials")(param0.asInstanceOf[js.Any]).asInstanceOf[js.Promise[AwsCredentialIdentity]]
}
