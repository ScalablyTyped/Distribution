...
trait AutoOptions extends js.Object {
  ...
  var challengePriority: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  ...
  var csr: js.UndefOr[acmeDashClientLib.cryptoForgeMod.Csr | java.lang.String] = js.undefined
...
object AutoOptions {
  ...
  def apply(
    ...
    challengePriority: js.Array[java.lang.String] = null,
    challengeRemoveFn: (/* authz */ Authorization, /* challenge */ Challenge, /* keyAuthorization */ ChallengeKey) => js.Promise[_] = null,
    csr: acmeDashClientLib.cryptoForgeMod.Csr | java.lang.String = null,
