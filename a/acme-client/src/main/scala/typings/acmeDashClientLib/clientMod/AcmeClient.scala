...
trait AcmeClient extends js.Object {
  ...
  def finalizeOrder(order: Order, csr: acmeDashClientLib.cryptoForgeMod.Csr): js.Promise[_] = js.native
  def finalizeOrder(order: Order, csr: java.lang.String): js.Promise[_] = js.native
  def getAccountUrl(): java.lang.String = js.native
  ...
  def getTermsOfServiceUrl(): js.Promise[java.lang.String] = js.native
