...
object Challenge {
  ...
  inline def DnsChallenge(status: pending | processing | valid | invalid, token: String, url: String): typings.acmeClient.rfc8555Mod.DnsChallenge = {
  ...
  inline def HttpChallenge(status: pending | processing | valid | invalid, token: String, url: String): typings.acmeClient.rfc8555Mod.HttpChallenge = {
    val __obj = js.Dynamic.literal(status = status.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
