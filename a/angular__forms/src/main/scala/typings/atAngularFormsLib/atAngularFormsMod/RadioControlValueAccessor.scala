...
class RadioControlValueAccessor protected ()
  ...
  def this(_renderer: atAngularCoreLib.atAngularCoreMod.Renderer2, _elementRef: atAngularCoreLib.atAngularCoreMod.ElementRef[_], _registry: ɵangular_packages_forms_forms_o, _injector: atAngularCoreLib.atAngularCoreMod.Injector) = this()
