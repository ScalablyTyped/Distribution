...
class FormGroupDirective protected ()
  ...
  /**
    ...
    */
  def addFormArray(dir: FormArrayName): scala.Unit = js.native
  /**
    * @description
  ...
  /**
    ...
    */
  def addFormGroup(dir: FormGroupName): scala.Unit = js.native
  /**
    * @description
  ...
  /**
    ...
    * @param dir The `FormControlName` directive instance.
    */
  def removeControl(dir: FormControlName): scala.Unit = js.native
  /**
    * @description
  ...
  /**
    ...
    * @param dir The `FormArrayName` directive instance.
    */
  def removeFormArray(dir: FormArrayName): scala.Unit = js.native
  /**
    * @description
  ...
  /**
    ...
    * @param dir The `FormGroupName` directive instance.
    */
  def removeFormGroup(dir: FormGroupName): scala.Unit = js.native
  /**
    * @description
  ...
  /**
    ...
    */
  def updateModel(dir: FormControlName, value: js.Any): scala.Unit = js.native
  /**
    * @description
