...
class FormBuilder () extends js.Object {
  ...
  def array(controlsConfig: js.Array[_], validatorOrOpts: scala.Null, asyncValidator: AsyncValidatorFn): FormArray = js.native
  def array(
    controlsConfig: js.Array[_],
  ...
  def control(formState: js.Any, validatorOrOpts: scala.Null, asyncValidator: AsyncValidatorFn): FormControl = js.native
  def control(formState: js.Any, validatorOrOpts: scala.Null, asyncValidator: js.Array[AsyncValidatorFn]): FormControl = js.native
  /**
    * @description
    ...
    *
    */
  def group(controlsConfig: org.scalablytyped.runtime.StringDictionary[js.Any]): FormGroup = js.native
  def group(
