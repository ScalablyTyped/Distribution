...
@JSImport("@angular/forms/src/forms", "RadioControlValueAccessor")
@js.native
class RadioControlValueAccessor protected ()
  extends atAngularFormsLib.srcDirectivesRadioUnderscoreControlUnderscoreValueUnderscoreAccessorMod.RadioControlValueAccessor {
