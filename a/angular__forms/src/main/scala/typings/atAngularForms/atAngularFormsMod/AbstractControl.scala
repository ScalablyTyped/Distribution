...
import typings.atAngularForms.Anon_EmitEventBoolean
import typings.atAngularForms.Anon_OnlySelf
...
abstract class AbstractControl () extends js.Object {
  ...
  /**
    ...
    *
    */
  val statusChanges: Observable[_] = js.native
  /**
  ...
  /**
    ...
    */
  val valueChanges: Observable[_] = js.native
  /**
  ...
  def disable(opts: Anon_EmitEvent): Unit = js.native
  /**
  ...
  def enable(opts: Anon_EmitEvent): Unit = js.native
  ...
  def markAsDirty(opts: Anon_OnlySelf): Unit = js.native
  /**
  ...
  def markAsPending(opts: Anon_EmitEvent): Unit = js.native
  /**
  ...
  def markAsPristine(opts: Anon_OnlySelf): Unit = js.native
  /**
  ...
  def markAsTouched(opts: Anon_OnlySelf): Unit = js.native
  /**
  ...
  def markAsUntouched(opts: Anon_OnlySelf): Unit = js.native
  /**
  ...
  def setErrors(errors: Null, opts: Anon_EmitEventBoolean): Unit = js.native
  /**
  ...
  def setErrors(errors: ValidationErrors, opts: Anon_EmitEventBoolean): Unit = js.native
  ...
  def updateValueAndValidity(opts: Anon_EmitEvent): Unit = js.native
}
