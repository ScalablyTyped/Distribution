...
import typings.atAngularForms.atAngularFormsStrings.blur
import typings.atAngularForms.atAngularFormsStrings.change
import typings.atAngularForms.atAngularFormsStrings.submit
