...
import typings.atAngularForms.Anon_EmitEvent
...
class FormArray protected () extends AbstractControl {
  ...
  def patchValue(value: js.Array[_], options: Anon_EmitEvent): Unit = js.native
  /**
  ...
  def reset(value: js.Any, options: Anon_EmitEvent): Unit = js.native
  /**
  ...
  def setValue(value: js.Array[_], options: Anon_EmitEvent): Unit = js.native
}
