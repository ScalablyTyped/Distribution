...
@js.native
open class FormGroup[TControl /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
{[ K in keyof TControl ]: @angular/forms.@angular/forms.AbstractControl<any, any>}
  */ typings.angularForms.angularFormsStrings.FormGroup & TopLevel[Any] */] protected () extends AbstractControl[
