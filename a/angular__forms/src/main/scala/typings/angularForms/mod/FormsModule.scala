...
object FormsModule {
  ...
  /**
    ...
    */
  inline def withConfig(opts: CallSetDisabledState): ModuleWithProviders[ReactiveFormsModule] = ^.asInstanceOf[js.Dynamic].applyDynamic("withConfig")(opts.asInstanceOf[js.Any]).asInstanceOf[ModuleWithProviders[ReactiveFormsModule]]
