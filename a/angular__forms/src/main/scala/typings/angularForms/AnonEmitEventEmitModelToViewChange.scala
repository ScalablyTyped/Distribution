...
trait AnonEmitEventEmitModelToViewChange extends js.Object {
...
object AnonEmitEventEmitModelToViewChange {
  @scala.inline
  def apply(
  ...
  ): AnonEmitEventEmitModelToViewChange = {
    ...
    __obj.asInstanceOf[AnonEmitEventEmitModelToViewChange]
  }
}
