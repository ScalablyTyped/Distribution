...
import typings.amqpDashRpc.Anon_AutoDelete
import typings.amqpDashRpc.Anon_DefaultExchangeName
...
trait Options extends js.Object {
  ...
  var exchange_options: js.UndefOr[Anon_AutoDelete] = js.undefined
  var ipml_options: js.UndefOr[Anon_DefaultExchangeName] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    exchange_options: Anon_AutoDelete = null,
    ipml_options: Anon_DefaultExchangeName = null,
    url: String = null
  ): Options = {
