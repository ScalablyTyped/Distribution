...
import typings.aliDashApp.Anon_DataIsBuffer
import typings.aliDashApp.Anon_IsConnected
...
object ^ extends js.Object {
  ...
  def alert(options: Partial[AlertOptions]): Unit = js.native
  ...
  /**
  	 ...
  	 */
  def chooseCity(options: Partial[ChooseCityOptions]): Unit = js.native
  /**
  ...
  /**
  	 * 从本地相册选择图片或使用相机拍照。
  	 */
  def chooseImage(options: Partial[ChooseImageOptions]): Unit = js.native
  /**
  	 * 使用支付宝内置地图选择地理位置。
  	 */
  ...
  def confirm(options: Partial[ConfirmOptions]): Unit = js.native
  /**
  	 * 连接低功耗蓝牙设备。
  	 */
  ...
  /**
  	 ...
  	 */
  def createAnimation(options: Partial[CreateAnimationOptions]): Animation = js.native
  /**
  	 * 创建 canvas 绘图上下文
  	 *
  ...
  /**
  	 * 打开日期选择列表
  	 */
  def datePicker(optiosn: Partial[DatePickerOptions]): Unit = js.native
  /**
  	 * 断开与低功耗蓝牙设备的连接。
  	 */
  ...
  /**
  	 * 获取用户当前的地理位置信息
  	 */
  def getLocation(options: Partial[GetLocationOptions]): Unit = js.native
  ...
  /**
  	 ...
  	 * 这是同步接口
  	 */
  def getStorageSync(options: Anon_Key): js.Any = js.native
  ...
  /**
  	 ...
  	 */
  def onSocketMessage(callback: js.Function1[/* res */ Anon_DataIsBuffer, Unit]): Unit = js.native
  /**
  	 * 监听WebSocket连接打开事件。
  	 */
  ...
  /**
  	 ...
  	 */
  def openBluetoothAdapter(options: Partial[OpenBluetoothAdapterOptions]): Unit = js.native
  /**
  	 * 打开当前用户的某张卡的详情页
  ...
  /**
  	 ...
  	 * @param key 缓存数据的key
  	 */
  def removeStorageSync(options: Anon_Key): Unit = js.native
  ...
  /**
  	 * 动态设置当前页面的标题。
  	 */
  def setNavigationBar(options: Partial[SetNavigationBarOptions]): Unit = js.native
  /**
  	 * 设置屏幕亮度
  	 */
  ...
  /**
  	 ...
  	 * @param data 需要存储的内容
  	 */
  def setStorageSync(options: Anon_Data): Unit = js.native
  /**
  	 * 显示操作菜单
  	 */
  ...
  /**
  	 * 显示消息提示框
  	 */
  def showToast(options: Partial[ToastOptions]): Unit = js.native
  /**
  	 * 开始搜索附近的iBeacon设备
  	 */
