...
import typings.aliDashApp.Anon_ContactsDicArray
import typings.aliDashApp.aliDashAppStrings.all
import typings.aliDashApp.aliDashAppStrings.known
import typings.aliDashApp.aliDashAppStrings.multi
import typings.aliDashApp.aliDashAppStrings.none
import typings.aliDashApp.aliDashAppStrings.single
...
trait ChooseContactOptions
  ...
  @JSName("success")
  def success_MChooseContactOptions(result: Anon_ContactsDicArray): Unit
}
...
object ChooseContactOptions {
  ...
  def apply(
    ...
    success: Anon_ContactsDicArray => Unit,
