...
trait ComponentRelation extends js.Object {
  ...
  var linkChanged: js.UndefOr[js.Function1[/* target */ typings.aliDashApp.my.Component, Unit]] = js.undefined
  /** 关系生命周期函数，当关系被建立在页面节点树中时触发，触发时机在组件attached生命周期之后 */
  var linked: js.UndefOr[js.Function1[/* target */ typings.aliDashApp.my.Component, Unit]] = js.undefined
  /** 如果这一项被设置，则它表示关联的目标节点所应具有的behavior，所有拥有这一behavior的组件节点都会被关联 */
  var target: js.UndefOr[String] = js.undefined
  /** 目标组件的相对关系，可选的值为 parent 、 child 、 ancestor 、 descendant */
  var `type`: parent | child | ancestor | descendant
  /** 关系生命周期函数，当关系脱离页面节点树时触发，触发时机在组件detached生命周期之后 */
  var unlinked: js.UndefOr[js.Function1[/* target */ typings.aliDashApp.my.Component, Unit]] = js.undefined
}
...
object ComponentRelation {
  ...
  def apply(
    ...
    linkChanged: /* target */ typings.aliDashApp.my.Component => Unit = null,
    linked: /* target */ typings.aliDashApp.my.Component => Unit = null,
    target: String = null,
    unlinked: /* target */ typings.aliDashApp.my.Component => Unit = null
  ): ComponentRelation = {
