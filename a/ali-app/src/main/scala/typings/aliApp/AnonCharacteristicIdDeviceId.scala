...
trait AnonCharacteristicIdDeviceId extends js.Object {
  /**
  			 * 蓝牙特征值的 uuid
  			 */
...
object AnonCharacteristicIdDeviceId {
  @scala.inline
  def apply(characteristicId: String, deviceId: String, serviceId: String, value: ArrayBuffer): AnonCharacteristicIdDeviceId = {
    ...
    __obj.asInstanceOf[AnonCharacteristicIdDeviceId]
  }
}
