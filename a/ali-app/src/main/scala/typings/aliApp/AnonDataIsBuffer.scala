...
trait AnonDataIsBuffer extends js.Object {
  /**
...
object AnonDataIsBuffer {
  @scala.inline
  def apply(data: String | ArrayBuffer, isBuffer: js.UndefOr[Boolean] = js.undefined): AnonDataIsBuffer = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    if (!js.isUndefined(isBuffer)) __obj.updateDynamic("isBuffer")(isBuffer.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDataIsBuffer]
  }
}
