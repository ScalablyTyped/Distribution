...
object ActionSheetOptions {
  ...
  def apply(
    ...
    destructiveBtnIndex: js.UndefOr[Double] = js.undefined,
    fail: js.Any => Unit = null,
    success: /* res */ Index => Unit = null,
    title: String = null
  ): ActionSheetOptions = {
    ...
    if (!js.isUndefined(destructiveBtnIndex)) __obj.updateDynamic("destructiveBtnIndex")(destructiveBtnIndex.get.asInstanceOf[js.Any])
