...
trait ConvasContext extends js.Object {
  ...
  /**
  		 ...
  		 * @returns
  		 */
  def createCircularGradient(x: scala.Double, y: scala.Double, r: scala.Double): CanvasAction = js.native
  /**
  		 * 创建一个线性的渐变色。
  		 *
  		 * @param x0 起点 x 坐标
  		 ...
  		 * @param y1 终点 y 坐标
  		 */
  def createLinearGradient(x0: scala.Double, y0: scala.Double, x1: scala.Double, y1: scala.Double): CanvasAction = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def setFillStyle(color: Color): scala.Unit = js.native
  /**
  		 * 设置字体大小。
  		 *
  		 * @param fontSize 字号
  ...
  /**
  		 ...
  		 */
  @JSName("setLineJoin")
  def setLineJoin_round(lineJoin: aliDashAppLib.aliDashAppLibStrings.round): scala.Unit = js.native
  /**
  		 * 设置线条的宽度。
  ...
  /**
  		 ...
  		 * @param color 阴影颜色
  		 */
  def setShadow(offsetX: scala.Double, offsetY: scala.Double, blur: scala.Double, color: Color): scala.Unit = js.native
  /**
  		 * 设置边框颜色。
  		 *
  ...
  /**
  		 ...
  		 */
  @JSName("setTextBaseline")
  def setTextBaseline_top(textBaseline: aliDashAppLib.aliDashAppLibStrings.top): scala.Unit = js.native
  /**
