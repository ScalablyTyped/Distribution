...
object TargetType {
  ...
  @scala.inline
  def ts: typings.apolloDashCodegen.apolloDashCodegenStrings.ts = this.cast("ts")
  @scala.inline
  def `ts-legacy`: typings.apolloDashCodegen.apolloDashCodegenStrings.`ts-legacy` = this.cast("ts-legacy")
  @scala.inline
  def typescript: typings.apolloDashCodegen.apolloDashCodegenStrings.typescript = this.cast("typescript")
  @scala.inline
  def `typescript-legacy`: typings.apolloDashCodegen.apolloDashCodegenStrings.`typescript-legacy` = this.cast("typescript-legacy")
}
