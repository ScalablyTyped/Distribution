...
import typings.azureArmResource.libManagementModelsMod.ManagementGroupListResult
import typings.azureArmResource.libManagementModelsMod.ManagementGroupWithHierarchy
import typings.azureArmResource.libManagementModelsMod.OperationListResult
