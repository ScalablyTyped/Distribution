...
import typings.azureArmResource.libLinkOperationsMod.Operations
import typings.azureArmResource.libLinkOperationsMod.ResourceLinks
...
object libLinkManagementLinkClientMod {
