...
import typings.azureArmResource.libLockModelsMod.ManagementLockListResult
import typings.azureArmResource.libLockModelsMod.ManagementLockObject
import typings.azureArmResource.libLockModelsMod.OperationListResult
