...
import typings.azureArmResource.libFeatureModelsMod.FeatureOperationsListResult
import typings.azureArmResource.libFeatureModelsMod.FeatureResult
...
object libFeatureOperationsMod {
