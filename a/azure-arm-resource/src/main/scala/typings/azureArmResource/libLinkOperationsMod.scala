...
import typings.azureArmResource.libLinkModelsMod.OperationListResult
import typings.azureArmResource.libLinkModelsMod.ResourceLink
import typings.azureArmResource.libLinkModelsMod.ResourceLinkResult
