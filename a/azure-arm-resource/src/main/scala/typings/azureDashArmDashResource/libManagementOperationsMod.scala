...
import typings.azureDashArmDashResource.libManagementModelsMod.ManagementGroupListResult
import typings.azureDashArmDashResource.libManagementModelsMod.ManagementGroupWithHierarchy
import typings.azureDashArmDashResource.libManagementModelsMod.OperationListResult
...
@js.native
object libManagementOperationsMod extends js.Object {
  @js.native
  trait ManagementGroups extends js.Object {
    ...
    def get(options: Anon_CustomHeadersExpand): js.Promise[ManagementGroupWithHierarchy] = js.native
    def get(options: Anon_CustomHeadersExpand, callback: ServiceCallback[ManagementGroupWithHierarchy]): Unit = js.native
    /**
      * Get the details of the management group.
      *
      *
    ...
    def getWithHttpOperationResponse(options: Anon_CustomHeadersExpand): js.Promise[HttpOperationResponse[ManagementGroupWithHierarchy]] = js.native
    /**
    ...
    def list(options: Anon_CustomHeadersHeaderName): js.Promise[ManagementGroupListResult] = js.native
    def list(options: Anon_CustomHeadersHeaderName, callback: ServiceCallback[ManagementGroupListResult]): Unit = js.native
    /**
      * List management groups for the authenticated user.
      *
      *
    ...
    def listNext(nextPageLink: String, options: Anon_CustomHeaders): js.Promise[ManagementGroupListResult] = js.native
    def listNext(
      nextPageLink: String,
    ...
    def listNextWithHttpOperationResponse(nextPageLink: String, options: Anon_CustomHeaders): js.Promise[HttpOperationResponse[ManagementGroupListResult]] = js.native
    /**
      * List management groups for the authenticated user.
      *
      *
    ...
    def listWithHttpOperationResponse(options: Anon_CustomHeadersHeaderName): js.Promise[HttpOperationResponse[ManagementGroupListResult]] = js.native
  }
