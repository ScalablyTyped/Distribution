...
object PolicyClient extends js.Object {
  ...
  class PolicyClient protected ()
    extends typings.azureDashArmDashResource.libPolicyPolicyClientMod.PolicyClient {
    /**
  ...
  class default protected ()
    extends typings.azureDashArmDashResource.libPolicyPolicyClientMod.default {
    /**
      * Initializes a new instance of the PolicyClient class.
      * @constructor
      *
  ...
  object PolicyModels extends js.Object {
    ...
    class CloudError protected ()
      extends typings.azureDashArmDashResource.libPolicyPolicyClientMod.PolicyModels.CloudError {
