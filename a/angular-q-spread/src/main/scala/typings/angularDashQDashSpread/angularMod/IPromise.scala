package typings.angularDashQDashSpread.angularMod
...
trait IPromise[T] extends js.Object {
  /**
    ...
    */
  def spread[TResult](
    successCallback: js.Function1[/* repeated */ js.Any, typings.angular.angularMod.IPromise[TResult] | TResult]
  ): typings.angular.angularMod.IPromise[TResult] = js.native
  def spread[TResult](
    successCallback: js.Function1[/* repeated */ js.Any, typings.angular.angularMod.IPromise[TResult] | TResult],
