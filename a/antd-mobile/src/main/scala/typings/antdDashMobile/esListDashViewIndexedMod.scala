...
import typings.antdDashMobile.esListDashViewIndexedMod.MIndexedList
...
@JSImport("antd-mobile/es/list-view/Indexed", JSImport.Namespace)
@js.native
object esListDashViewIndexedMod extends js.Object {
  @js.native
  trait MIndexedList
