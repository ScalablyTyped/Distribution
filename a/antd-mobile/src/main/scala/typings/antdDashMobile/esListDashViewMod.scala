...
import typings.antdDashMobile.esListDashViewMod.ListView
import typings.antdDashMobile.esListDashViewMod.ListViewProps
...
@JSImport("antd-mobile/es/list-view", JSImport.Namespace)
@js.native
object esListDashViewMod extends js.Object {
  @js.native
  trait ListView
