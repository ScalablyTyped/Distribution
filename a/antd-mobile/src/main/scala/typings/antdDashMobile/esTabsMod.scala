...
import typings.antdDashMobile.esTabsMod.Tabs
import typings.antdDashMobile.esTabsPropsTypeMod.TabsProps
...
@JSImport("antd-mobile/es/tabs", JSImport.Namespace)
@js.native
object esTabsMod extends js.Object {
  @js.native
  class DefaultTabBar ()
