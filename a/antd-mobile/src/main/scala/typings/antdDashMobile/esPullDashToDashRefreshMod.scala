...
import typings.antdDashMobile.esPullDashToDashRefreshMod.PullToRefresh
...
@JSImport("antd-mobile/es/pull-to-refresh", JSImport.Namespace)
@js.native
object esPullDashToDashRefreshMod extends js.Object {
  @js.native
  trait PullToRefresh
