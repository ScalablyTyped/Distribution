...
import typings.antdDashMobile.esTextareaDashItemPropsTypeMod.TextAreaEventHandle
import typings.antdDashMobile.esTextareaDashItemPropsTypeMod.TextAreaItemPropsType
