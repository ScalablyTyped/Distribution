...
- Dropped {[ P in std.Exclude<keyof react.react.React.HTMLProps<std.HTMLInputElement>, 'onChange' | 'onFocus' | 'onBlur' | 'value' | 'defaultValue' | 'type' | 'title'> ]: react.react.React.HTMLProps<std.HTMLInputElement>[P]} */ trait TextareaItemProps
  extends antdDashMobileLib.libTextareaDashItemPropsTypeMod.TextAreaItemPropsType {
...
object TextareaItemProps {
  ...
  def apply(
    ...
    onBlur: antdDashMobileLib.libTextareaDashItemPropsTypeMod.TextAreaEventHandle = null,
    onChange: antdDashMobileLib.libTextareaDashItemPropsTypeMod.TextAreaEventHandle = null,
    onErrorClick: () => scala.Unit = null,
    onFocus: antdDashMobileLib.libTextareaDashItemPropsTypeMod.TextAreaEventHandle = null,
