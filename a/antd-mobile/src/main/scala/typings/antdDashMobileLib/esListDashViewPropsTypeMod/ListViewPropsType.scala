...
trait ListViewPropsType extends js.Object {
  ...
  var renderBodyComponent: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement]] = js.native
  var renderFooter: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement]] = js.native
  var renderHeader: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement]] = js.native
  var renderScrollComponent: js.UndefOr[js.Function1[/* p */ js.Any, reactLib.reactMod.ReactElement]] = js.native
  var renderSectionBodyWrapper: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement]] = js.native
  ...
  var renderSectionWrapper: js.UndefOr[js.Function0[reactLib.reactMod.ReactElement]] = js.native
  ...
  def renderRow(rowData: js.Any, sectionID: java.lang.String, rowID: java.lang.String): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: java.lang.String, rowID: java.lang.String, highlightRow: scala.Boolean): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: java.lang.String, rowID: scala.Double): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: java.lang.String, rowID: scala.Double, highlightRow: scala.Boolean): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: scala.Double, rowID: java.lang.String): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: scala.Double, rowID: java.lang.String, highlightRow: scala.Boolean): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: scala.Double, rowID: scala.Double): reactLib.reactMod.ReactElement = js.native
  def renderRow(rowData: js.Any, sectionID: scala.Double, rowID: scala.Double, highlightRow: scala.Boolean): reactLib.reactMod.ReactElement = js.native
}
