...
@JSImport("antd-mobile/lib/toast", JSImport.Namespace)
@js.native
object libToastMod extends js.Object {
  @js.native
  object default extends js.Object {
    var LONG: scala.Double = js.native
    var SHORT: scala.Double = js.native
    def fail(content: reactLib.reactMod.ReactNode): scala.Unit = js.native
    def fail(
    ...
    def show(content: reactLib.reactMod.ReactNode, duration: js.UndefOr[scala.Nothing], mask: scala.Boolean): scala.Unit = js.native
    def show(content: reactLib.reactMod.ReactNode, duration: scala.Double): scala.Unit = js.native
    def show(content: reactLib.reactMod.ReactNode, duration: scala.Double, mask: scala.Boolean): scala.Unit = js.native
    def success(content: reactLib.reactMod.ReactNode): scala.Unit = js.native
    def success(
      content: reactLib.reactMod.ReactNode,
      duration: js.UndefOr[scala.Nothing],
      onClose: js.UndefOr[scala.Nothing],
