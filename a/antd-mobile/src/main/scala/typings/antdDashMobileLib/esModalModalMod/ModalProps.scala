...
trait ModalProps
  extends antdDashMobileLib.esModalPropsTypeMod.ModalPropsType[reactLib.reactMod.CSSProperties] {
...
object ModalProps {
  ...
  def apply(
    ...
    footer: js.Array[antdDashMobileLib.esModalPropsTypeMod.Action[reactLib.reactMod.CSSProperties]] = null,
