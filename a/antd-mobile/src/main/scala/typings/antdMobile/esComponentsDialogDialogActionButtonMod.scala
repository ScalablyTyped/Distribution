...
object esComponentsDialogDialogActionButtonMod {
  
  @JSImport("antd-mobile/es/components/dialog/dialog-action-button", "DialogActionButton")
  @js.native
  val DialogActionButton: FC[typings.antdMobile.anon.Action] = js.native
  
  /* Inlined {  key :string | number,   text :react.react.ReactNode,   disabled :boolean | undefined,   danger :boolean | undefined,   bold :boolean | undefined,   onClick :(): void | std.Promise<void> | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
