...
object pickerLocaleZhCNMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/picker/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/picker/locale/zh_CN", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/picker/locale/zh_CN", "default.extra")
    @js.native
    def extra: String = js.native
    @scala.inline
    def extra_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("extra")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile/lib/picker/locale/zh_CN", "default.okText")
    @js.native
