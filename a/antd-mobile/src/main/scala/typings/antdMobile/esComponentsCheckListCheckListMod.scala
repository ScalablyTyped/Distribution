...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAlignitems
...
object esComponentsCheckListCheckListMod {
  ...
  object CheckListProps {
    ...
    implicit open class MutableBuilder[Self <: CheckListProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: /* val */ js.Array[String] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
