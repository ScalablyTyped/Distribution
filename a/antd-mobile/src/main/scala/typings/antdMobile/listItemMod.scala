...
object listItemMod {
  ...
  /* Inlined {  title :react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined,   description :react.react.ReactNode | undefined,   prefix :react.react.ReactNode | undefined,   extra :react.react.ReactNode | undefined,   clickable :boolean | undefined,   arrow :boolean | react.react.ReactNode | undefined,   disabled :boolean | undefined,   onClick :(e : react.react.MouseEvent<std.Element, react.react.NativeMouseEvent>): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--prefix-width' | '--align-items' | '--active-background-color'> */
