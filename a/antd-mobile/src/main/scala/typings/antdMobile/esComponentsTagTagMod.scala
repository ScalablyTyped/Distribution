...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundcolor
...
import typings.antdMobile.antdMobileStrings.danger
import typings.antdMobile.antdMobileStrings.date
import typings.antdMobile.antdMobileStrings.default
...
import typings.antdMobile.antdMobileStrings.outline
...
import typings.antdMobile.antdMobileStrings.solid
...
object esComponentsTagTagMod {
  
  @JSImport("antd-mobile/es/components/tag/tag", "Tag")
  @js.native
  val Tag: FC[TagProps] = js.native
  
  /* Inlined {  color :'default' | 'primary' | 'success' | 'warning' | 'danger' | string & {} | undefined,   fill :'solid' | 'outline' | undefined,   round :boolean | undefined,   onClick :(e : react.react.MouseEvent<std.HTMLSpanElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--border-color' | '--background-color' | '--text-color' | '--border-radius'> */
  trait TagProps extends StObject {
    ...
    var color: js.UndefOr[default | primary | success | warning | danger | String] = js.undefined
    
    var fill: js.UndefOr[solid | outline] = js.undefined
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundcolor] = js.undefined
  ...
  object TagProps {
    ...
    implicit open class MutableBuilder[Self <: TagProps] (val x: Self) extends AnyVal {
      ...
      inline def setColor(value: default | primary | success | warning | danger | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      
      inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
      
      inline def setFill(value: solid | outline): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundcolor): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
