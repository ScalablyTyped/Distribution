...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAlignContent
import typings.antdMobile.anon.colordefaultprimarysucces
...
object esComponentsButtonButtonMod {
  
  @JSImport("antd-mobile/es/components/button/button", "Button")
  @js.native
  val Button: ForwardRefExoticComponent[colordefaultprimarysucces] = js.native
  
  /* Inlined {  color :'default' | 'primary' | 'success' | 'warning' | 'danger' | undefined,   fill :'solid' | 'outline' | 'none' | undefined,   size :'mini' | 'small' | 'middle' | 'large' | undefined,   block :boolean | undefined,   loading :boolean | 'auto' | undefined,   loadingText :string | undefined,   loadingIcon :react.react.ReactNode | undefined,   disabled :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLButtonElement, std.MouseEvent>): void | std.Promise<void> | unknown | undefined,   type :'submit' | 'reset' | 'button' | undefined,   shape :'default' | 'rounded' | 'rectangular' | undefined,   children :react.react.ReactNode | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/button/button.NativeButtonProps, 'onMouseDown' | 'onMouseUp' | 'onTouchStart' | 'onTouchEnd'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--text-color' | '--background-color' | '--border-radius' | '--border-width' | '--border-style' | '--border-color'> */
  trait ButtonProps extends StObject {
    ...
    var fill: js.UndefOr[solid | outline | none] = js.undefined
    ...
    var size: js.UndefOr[mini | small | middle | large] = js.undefined
  ...
  object ButtonProps {
    ...
    extension [Self <: ButtonProps](x: Self) {
      ...
      inline def setFill(value: solid | outline | none): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
      ...
      inline def setSize(value: mini | small | middle | large): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  trait ButtonRef extends StObject {
    
    var nativeElement: HTMLButtonElement | Null
  }
  object ButtonRef {
    
    inline def apply(): ButtonRef = {
