...
import typings.antdMobile.modalActionButtonMod.Action
...
object modalShowMod {
  ...
  @JSImport("antd-mobile/es/components/modal/show", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("antd-mobile/es/components/modal/show", "closeFnSet")
  @js.native
  val closeFnSet: Set[js.Function0[Unit]] = js.native
  
  inline def show(props: ModalShowProps): ModalShowHandler = ^.asInstanceOf[js.Dynamic].applyDynamic("show")(props.asInstanceOf[js.Any]).asInstanceOf[ModalShowHandler]
  
  trait ModalShowHandler extends StObject {
    
    def close(): Unit
  }
  object ModalShowHandler {
    
    inline def apply(close: () => Unit): ModalShowHandler = {
  ...
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/modal/modal.ModalProps, 'visible' | 'destroyOnClose' | 'forceRender'> */
  trait ModalShowProps extends StObject {
  ...
  object ModalShowProps {
    
    inline def apply(): ModalShowProps = {
