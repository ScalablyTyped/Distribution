...
object textareaItemMod {
  ...
  object HTMLTextAreaProps {
    ...
    @scala.inline
    implicit class HTMLTextAreaPropsMutableBuilder[Self <: HTMLTextAreaProps] (val x: Self) extends AnyVal {
  ...
  object TextareaItemProps {
    ...
    implicit class TextareaItemPropsMutableBuilder[Self <: TextareaItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setPrefixListClsUndefined: Self = StObject.set(x, "prefixListCls", js.undefined)
  ...
  object TextareaItemState {
    ...
    @scala.inline
    implicit class TextareaItemStateMutableBuilder[Self <: TextareaItemState] (val x: Self) extends AnyVal {
