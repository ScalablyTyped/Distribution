...
object textareaItemMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/textarea-item", "default.defaultProps")
    @js.native
  ...
  trait HTMLTextAreaProps extends StObject {
  ...
  object HTMLTextAreaProps {
    ...
    inline def apply(): HTMLTextAreaProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HTMLTextAreaProps]
    }
    
    extension [Self <: HTMLTextAreaProps](x: Self) {
  ...
  trait TextareaItem
    ...
    /* private */ var debounceTimeout: js.Any = js.native
  ...
  object TextareaItemProps {
    ...
    extension [Self <: TextareaItemProps](x: Self) {
      ...
      inline def setPrefixListClsUndefined: Self = StObject.set(x, "prefixListCls", js.undefined)
  ...
  trait TextareaItemState extends StObject {
  ...
  object TextareaItemState {
    ...
    inline def apply(): TextareaItemState = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TextareaItemState]
    }
    
    extension [Self <: TextareaItemState](x: Self) {
