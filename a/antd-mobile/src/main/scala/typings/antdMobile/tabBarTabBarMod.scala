...
object tabBarTabBarMod {
  ...
  trait TabBarItemProps extends StObject {
    ...
    var icon: js.UndefOr[ReactNode | (js.Function1[/* active */ Boolean, ReactNode])] = js.undefined
    
    var style: js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var title: js.UndefOr[ReactNode | (js.Function1[/* active */ Boolean, ReactNode])] = js.undefined
  }
  object TabBarItemProps {
    ...
    extension [Self <: TabBarItemProps](x: Self) {
      ...
      inline def setIcon(value: ReactNode | (js.Function1[/* active */ Boolean, ReactNode])): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      
      inline def setIconFunction1(value: /* active */ Boolean => ReactNode): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
      ...
      inline def setTitle(value: ReactNode | (js.Function1[/* active */ Boolean, ReactNode])): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
      
      inline def setTitleFunction1(value: /* active */ Boolean => ReactNode): Self = StObject.set(x, "title", js.Any.fromFunction1(value))
