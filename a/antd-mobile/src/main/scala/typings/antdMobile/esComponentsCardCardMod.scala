...
object esComponentsCardCardMod {
  
  @JSImport("antd-mobile/es/components/card/card", "Card")
  @js.native
  val Card: FC[CardProps] = js.native
  
  /* Inlined {  title :react.react.ReactNode | undefined,   extra :react.react.ReactNode | undefined,   headerStyle :react.react.CSSProperties | undefined,   headerClassName :string | undefined,   bodyStyle :react.react.CSSProperties | undefined,   bodyClassName :string | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   onBodyClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   onHeaderClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setOnBodyClick(value: /* event */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent] => Unit): Self = StObject.set(x, "onBodyClick", js.Any.fromFunction1(value))
      
      inline def setOnBodyClickUndefined: Self = StObject.set(x, "onBodyClick", js.undefined)
      ...
      inline def setOnHeaderClick(value: /* event */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent] => Unit): Self = StObject.set(x, "onHeaderClick", js.Any.fromFunction1(value))
