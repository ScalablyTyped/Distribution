...
object esComponentsResultPageResultPageCardMod {
  
  @JSImport("antd-mobile/es/components/result-page/result-page-card", "ResultPageCard")
  @js.native
  val ResultPageCard: FC[ResultPageCardProps] = js.native
  
  /* Inlined {  children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait ResultPageCardProps extends StObject {
  ...
  object ResultPageCardProps {
    
    inline def apply(): ResultPageCardProps = {
