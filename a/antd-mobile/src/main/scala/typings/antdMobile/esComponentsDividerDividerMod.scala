...
object esComponentsDividerDividerMod {
  
  @JSImport("antd-mobile/es/components/divider/divider", "Divider")
  @js.native
  val Divider: FC[DividerProps] = js.native
  
  /* Inlined {  contentPosition :'left' | 'right' | 'center' | undefined,   direction :'horizontal' | 'vertical' | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait DividerProps extends StObject {
    ...
    var contentPosition: js.UndefOr[left | right | center] = js.undefined
  ...
  object DividerProps {
    ...
    extension [Self <: DividerProps](x: Self) {
      ...
      inline def setContentPosition(value: left | right | center): Self = StObject.set(x, "contentPosition", value.asInstanceOf[js.Any])
