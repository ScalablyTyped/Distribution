...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundSize
import typings.antdMobile.anon.rightActionsArrayActionun
...
object esComponentsSwipeActionSwipeActionMod {
  
  @JSImport("antd-mobile/es/components/swipe-action/swipe-action", "SwipeAction")
  @js.native
  val SwipeAction: ForwardRefExoticComponent[rightActionsArrayActionun] = js.native
  
  trait Action extends StObject {
    
    var color: js.UndefOr[ActionColor | String] = js.undefined
  ...
  object Action {
    ...
    inline def apply(key: String | Double): Action = {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antdMobile.antdMobileStrings.light
    - typings.antdMobile.antdMobileStrings.weak
    - typings.antdMobile.antdMobileStrings.primary
    - typings.antdMobile.antdMobileStrings.success
    - typings.antdMobile.antdMobileStrings.warning
    - typings.antdMobile.antdMobileStrings.danger
  */
  trait ActionColor extends StObject
  object ActionColor {
    
    inline def danger: typings.antdMobile.antdMobileStrings.danger = "danger".asInstanceOf[typings.antdMobile.antdMobileStrings.danger]
    
    inline def light: typings.antdMobile.antdMobileStrings.light = "light".asInstanceOf[typings.antdMobile.antdMobileStrings.light]
    
    inline def primary: typings.antdMobile.antdMobileStrings.primary = "primary".asInstanceOf[typings.antdMobile.antdMobileStrings.primary]
    
    inline def success: typings.antdMobile.antdMobileStrings.success = "success".asInstanceOf[typings.antdMobile.antdMobileStrings.success]
    
    inline def warning: typings.antdMobile.antdMobileStrings.warning = "warning".asInstanceOf[typings.antdMobile.antdMobileStrings.warning]
    
    inline def weak: typings.antdMobile.antdMobileStrings.weak = "weak".asInstanceOf[typings.antdMobile.antdMobileStrings.weak]
  }
  
  /* Inlined {  rightActions :std.Array<antd-mobile.antd-mobile/es/components/swipe-action/swipe-action.Action> | undefined,   leftActions :std.Array<antd-mobile.antd-mobile/es/components/swipe-action/swipe-action.Action> | undefined,   onAction :(action : antd-mobile.antd-mobile/es/components/swipe-action/swipe-action.Action, e : react.react.MouseEvent<std.Element, react.react.NativeMouseEvent>): void | undefined,   closeOnTouchOutside :boolean | undefined,   closeOnAction :boolean | undefined,   children :react.react.ReactNode,   stopPropagation :std.Array<antd-mobile.antd-mobile/es/utils/with-stop-propagation.PropagationEvent> | undefined,   onActionsReveal :(side : 'left' | 'right'): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--background'> */
  trait SwipeActionProps extends StObject {
    ...
    var closeOnAction: js.UndefOr[Boolean] = js.undefined
    
    var closeOnTouchOutside: js.UndefOr[Boolean] = js.undefined
    
    var leftActions: js.UndefOr[js.Array[Action]] = js.undefined
    
    var onAction: js.UndefOr[
        js.Function2[/* action */ Action, /* e */ MouseEvent[Element, NativeMouseEvent], Unit]
      ] = js.undefined
    
    var onActionsReveal: js.UndefOr[js.Function1[/* side */ left | right, Unit]] = js.undefined
    
    var rightActions: js.UndefOr[js.Array[Action]] = js.undefined
    
    var stopPropagation: js.UndefOr[js.Array[PropagationEvent]] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundSize] = js.undefined
  ...
  object SwipeActionProps {
    ...
    extension [Self <: SwipeActionProps](x: Self) {
      ...
      inline def setCloseOnAction(value: Boolean): Self = StObject.set(x, "closeOnAction", value.asInstanceOf[js.Any])
      
      inline def setCloseOnActionUndefined: Self = StObject.set(x, "closeOnAction", js.undefined)
      ...
      inline def setLeftActions(value: js.Array[Action]): Self = StObject.set(x, "leftActions", value.asInstanceOf[js.Any])
      
      inline def setLeftActionsUndefined: Self = StObject.set(x, "leftActions", js.undefined)
      
      inline def setLeftActionsVarargs(value: Action*): Self = StObject.set(x, "leftActions", js.Array(value*))
      
      inline def setOnAction(value: (/* action */ Action, /* e */ MouseEvent[Element, NativeMouseEvent]) => Unit): Self = StObject.set(x, "onAction", js.Any.fromFunction2(value))
      
      inline def setOnActionUndefined: Self = StObject.set(x, "onAction", js.undefined)
      
      inline def setOnActionsReveal(value: /* side */ left | right => Unit): Self = StObject.set(x, "onActionsReveal", js.Any.fromFunction1(value))
      
      inline def setOnActionsRevealUndefined: Self = StObject.set(x, "onActionsReveal", js.undefined)
      
      inline def setRightActions(value: js.Array[Action]): Self = StObject.set(x, "rightActions", value.asInstanceOf[js.Any])
      
      inline def setRightActionsUndefined: Self = StObject.set(x, "rightActions", js.undefined)
      
      inline def setRightActionsVarargs(value: Action*): Self = StObject.set(x, "rightActions", js.Array(value*))
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundSize): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  @js.native
  trait SwipeActionRef extends StObject {
    
    def close(): Unit = js.native
    
    def show(): Unit = js.native
    def show(side: left | right): Unit = js.native
  }
}
