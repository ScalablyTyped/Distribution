...
object esComponentsCollapseCollapseMod {
  ...
  trait CollapsePanelProps extends StObject {
    ...
    var onClick: js.UndefOr[
        js.Function1[/* event */ typings.react.mod.MouseEvent[Element, MouseEvent], Unit]
      ] = js.undefined
  ...
  object CollapsePanelProps {
    ...
    implicit open class MutableBuilder[Self <: CollapsePanelProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnClick(value: /* event */ typings.react.mod.MouseEvent[Element, MouseEvent] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antdMobile.anon.accordionfalseundefinedVa
    - typings.antdMobile.anon.accordiontrueValuePropsst
  */
  trait CollapseProps extends StObject
  object CollapseProps {
    
    inline def accordionfalseundefinedVa(): typings.antdMobile.anon.accordionfalseundefinedVa = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.antdMobile.anon.accordionfalseundefinedVa]
    }
    
    inline def accordiontrueValuePropsst(): typings.antdMobile.anon.accordiontrueValuePropsst = {
      val __obj = js.Dynamic.literal(accordion = true)
      __obj.asInstanceOf[typings.antdMobile.anon.accordiontrueValuePropsst]
    }
  }
  ...
  object ValueProps {
    ...
    implicit open class MutableBuilder[Self <: ValueProps[?], T] (val x: Self & ValueProps[T]) extends AnyVal {
      ...
      inline def setOnChange(value: /* activeKey */ T => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
