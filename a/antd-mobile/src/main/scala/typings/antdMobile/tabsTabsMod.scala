...
import typings.antdMobile.anon.CSSPropertiesPartialRecorActivelineborderradius
...
import typings.antdMobile.antdMobileStrings.full
...
object tabsTabsMod {
  ...
  @JSImport("antd-mobile/es/components/tabs/tabs", "Tabs")
  @js.native
  val Tabs: FC[TabsProps] = js.native
  
  /* Inlined {  title :react.react.ReactNode,   disabled :boolean | undefined,   forceRender :boolean | undefined,   destroyOnClose :boolean | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  ...
  /* Inlined {  activeKey :string | null | undefined,   defaultActiveKey :string | null | undefined,   activeLineMode :'auto' | 'full' | 'fixed' | undefined,   stretch :boolean | undefined,   onChange :(key : string): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--fixed-active-line-width' | '--active-line-height' | '--active-line-border-radius' | '--title-font-size' | '--content-padding' | '--active-title-color' | '--active-line-color'> */
  trait TabsProps extends StObject {
    
    var activeKey: js.UndefOr[String | Null] = js.undefined
    
    var activeLineMode: js.UndefOr[auto | full | fixed] = js.undefined
    ...
    var onChange: js.UndefOr[js.Function1[/* key */ String, Unit]] = js.undefined
    
    var stretch: js.UndefOr[Boolean] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorActivelineborderradius] = js.undefined
  ...
  object TabsProps {
    ...
    extension [Self <: TabsProps](x: Self) {
      ...
      inline def setActiveLineMode(value: auto | full | fixed): Self = StObject.set(x, "activeLineMode", value.asInstanceOf[js.Any])
      
      inline def setActiveLineModeUndefined: Self = StObject.set(x, "activeLineMode", js.undefined)
      ...
      inline def setOnChange(value: /* key */ String => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorActivelineborderradius): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
