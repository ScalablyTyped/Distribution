...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundOrigin
...
object sideBarSideBarMod {
  ...
  @JSImport("antd-mobile/es/components/side-bar/side-bar", "SideBar")
  @js.native
  val SideBar: FC[SideBarProps] = js.native
  
  @JSImport("antd-mobile/es/components/side-bar/side-bar", "SideBarItem")
  @js.native
  val SideBarItem: FC[SideBarItemProps] = js.native
  
  /* Inlined {  title :react.react.ReactNode | undefined,   disabled :boolean | undefined,   badge :antd-mobile.antd-mobile/es/components/badge.BadgeProps['content'] | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait SideBarItemProps extends StObject {
    ...
    var badge: js.UndefOr[ReactNode | Element] = js.undefined
  ...
  object SideBarItemProps {
    ...
    extension [Self <: SideBarItemProps](x: Self) {
      ...
      inline def setBadge(value: ReactNode | Element): Self = StObject.set(x, "badge", value.asInstanceOf[js.Any])
  ...
  /* Inlined {  activeKey :string | null | undefined,   defaultActiveKey :string | null | undefined,   onChange :(key : string): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--width' | '--height' | '--item-border-radius' | '--background-color'> */
