...
import typings.antdMobile.alertMod.DialogAlertProps
import typings.antdMobile.anon.PartialDialogProps
import typings.antdMobile.anon.WeakValidationMapDialogPr
import typings.antdMobile.confirmMod.DialogConfirmProps
import typings.antdMobile.dialogDialogMod.DialogProps
import typings.antdMobile.showMod.DialogShowHandler
import typings.antdMobile.showMod.DialogShowProps
