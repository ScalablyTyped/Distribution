...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAlignItems_
...
object esComponentsDatePickerViewDatePickerViewMod {
  
  @JSImport("antd-mobile/es/components/date-picker-view/date-picker-view", "DatePickerView")
  @js.native
