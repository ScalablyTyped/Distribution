...
import typings.antdMobile.anon.optionsArrayCascaderOptio
...
object cascaderCascaderMod {
  ...
  @JSImport("antd-mobile/es/components/cascader/cascader", "Cascader")
  @js.native
  val Cascader: ForwardRefExoticComponent[optionsArrayCascaderOptio] = js.native
  
  trait CascaderActions extends StObject {
  ...
  object CascaderActions {
    
    inline def apply(close: () => Unit, open: () => Unit, toggle: () => Unit): CascaderActions = {
  ...
  /* Inlined {  options :std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderOption>,   value :std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderValue> | undefined,   defaultValue :std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderValue> | undefined,   placeholder :string | undefined,   onSelect :(value : std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderValue>, extend : antd-mobile.antd-mobile/es/components/cascader-view.CascaderValueExtend): void | undefined,   onConfirm :(value : std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderValue>, extend : antd-mobile.antd-mobile/es/components/cascader-view.CascaderValueExtend): void | undefined,   onCancel :(): void | undefined,   onClose :(): void | undefined,   visible :boolean | undefined,   title :react.react.ReactNode | undefined,   confirmText :react.react.ReactNode | undefined,   cancelText :react.react.ReactNode | undefined,   children :(items : std.Array<antd-mobile.antd-mobile/es/components/cascader-view.CascaderOption | null>, actions : antd-mobile.antd-mobile/es/components/cascader/cascader.CascaderActions): react.react.ReactNode | undefined,   onTabsChange :(index : number): void | undefined,   activeIcon :react.react.ReactNode | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/popup.PopupProps, 'getContainer' | 'afterShow' | 'afterClose' | 'onClick' | 'stopPropagation' | 'destroyOnClose' | 'forceRender'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait CascaderProps extends StObject {
    ...
    var children: js.UndefOr[
        js.Function2[
          /* items */ js.Array[CascaderOption | Null], 
    ...
    var value: js.UndefOr[js.Array[CascaderValue]] = js.undefined
    
    var visible: js.UndefOr[Boolean] = js.undefined
  }
  object CascaderProps {
    
    inline def apply(options: js.Array[CascaderOption]): CascaderProps = {
    ...
    extension [Self <: CascaderProps](x: Self) {
      ...
      inline def setChildren(value: (/* items */ js.Array[CascaderOption | Null], /* actions */ CascaderActions) => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      ...
      inline def setOnConfirm(value: (/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend) => Unit): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2(value))
      
      inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
      
      inline def setOnSelect(value: (/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
      
      inline def setOnSelectUndefined: Self = StObject.set(x, "onSelect", js.undefined)
      
      inline def setOnTabsChange(value: /* index */ Double => Unit): Self = StObject.set(x, "onTabsChange", js.Any.fromFunction1(value))
      ...
      inline def setValue(value: js.Array[CascaderValue]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      inline def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      inline def setValueVarargs(value: CascaderValue*): Self = StObject.set(x, "value", js.Array(value*))
