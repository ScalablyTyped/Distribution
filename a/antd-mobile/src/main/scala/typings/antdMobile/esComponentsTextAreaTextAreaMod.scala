...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBorder
import typings.antdMobile.anon.MaxRows
...
object esComponentsTextAreaTextAreaMod {
  
  @JSImport("antd-mobile/es/components/text-area/text-area", "TextArea")
  @js.native
  val TextArea: ForwardRefExoticComponent[onChangevalstringvoidunde] = js.native
  
  /* Inlined std.Pick<react.react.DetailedHTMLProps<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, std.HTMLTextAreaElement>, 'autoComplete' | 'autoFocus' | 'disabled' | 'readOnly' | 'name' | 'onFocus' | 'onBlur' | 'onCompositionStart' | 'onCompositionEnd' | 'onClick'> & {  onChange :(val : string): void | undefined,   value :string | undefined,   defaultValue :string | undefined,   placeholder :string | undefined,   rows :number | undefined,   maxLength :number | undefined,   showCount :boolean | (length : number, maxLength : number | undefined): react.react.ReactNode | undefined,   autoSize :boolean | {  minRows :number | undefined,   maxRows :number | undefined} | undefined,   id :string | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--font-size' | '--color' | '--placeholder-color' | '--disabled-color' | '--text-align' | '--count-text-align'> */
  trait TextAreaProps extends StObject {
    ...
    var autoSize: js.UndefOr[Boolean | MaxRows] = js.undefined
    ...
    var showCount: js.UndefOr[
        Boolean | (js.Function2[/* length */ Double, /* maxLength */ js.UndefOr[Double], ReactNode])
      ] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBorder] = js.undefined
  ...
  object TextAreaProps {
    ...
    extension [Self <: TextAreaProps](x: Self) {
      ...
      inline def setAutoSize(value: Boolean | MaxRows): Self = StObject.set(x, "autoSize", value.asInstanceOf[js.Any])
      ...
      inline def setShowCount(
        value: Boolean | (js.Function2[/* length */ Double, /* maxLength */ js.UndefOr[Double], ReactNode])
      ): Self = StObject.set(x, "showCount", value.asInstanceOf[js.Any])
      
      inline def setShowCountFunction2(value: (/* length */ Double, /* maxLength */ js.UndefOr[Double]) => ReactNode): Self = StObject.set(x, "showCount", js.Any.fromFunction2(value))
      
      inline def setShowCountUndefined: Self = StObject.set(x, "showCount", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorBorder): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  trait TextAreaRef extends StObject {
    ...
    var nativeElement: HTMLTextAreaElement | Null
  }
  object TextAreaRef {
    
    inline def apply(blur: () => Unit, clear: () => Unit, focus: () => Unit): TextAreaRef = {
      val __obj = js.Dynamic.literal(blur = js.Any.fromFunction0(blur), clear = js.Any.fromFunction0(clear), focus = js.Any.fromFunction0(focus), nativeElement = null)
    ...
    extension [Self <: TextAreaRef](x: Self) {
      ...
      inline def setNativeElement(value: HTMLTextAreaElement): Self = StObject.set(x, "nativeElement", value.asInstanceOf[js.Any])
