...
import typings.antdMobile.dotLoadingDotLoadingMod.DotLoadingProps
...
object loadingMod extends Shortcut {
  ...
  trait LoadingProps extends StObject {
    ...
    var color: js.UndefOr[typings.antdMobile.antdMobileStrings.default | primary | white | String] = js.undefined
  ...
  object LoadingProps {
    ...
    extension [Self <: LoadingProps](x: Self) {
      ...
      inline def setColor(value: typings.antdMobile.antdMobileStrings.default | primary | white | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
