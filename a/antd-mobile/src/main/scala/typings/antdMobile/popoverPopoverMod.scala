...
object popoverPopoverMod {
  ...
  @JSImport("antd-mobile/es/components/popover/popover", "Popover")
  @js.native
  ...
  object PopoverProps {
    ...
    inline def apply(children: ReactElement): PopoverProps = {
  ...
  trait PopoverRef extends StObject {
  ...
  object PopoverRef {
    ...
    inline def apply(hide: () => Unit, show: () => Unit, visible: Boolean): PopoverRef = {
      val __obj = js.Dynamic.literal(hide = js.Any.fromFunction0(hide), show = js.Any.fromFunction0(show), visible = visible.asInstanceOf[js.Any])
