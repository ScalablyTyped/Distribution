...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBlockSize
...
object esComponentsSwitchSwitchMod {
  
  @JSImport("antd-mobile/es/components/switch/switch", "Switch")
  @js.native
  val Switch: FC[SwitchProps] = js.native
  
  /* Inlined {  loading :boolean | undefined,   disabled :boolean | undefined,   checked :boolean | undefined,   defaultChecked :boolean | undefined,   beforeChange :(val : boolean): std.Promise<void> | undefined,   onChange :(checked : boolean): void | std.Promise<void> | undefined,   checkedText :react.react.ReactNode | undefined,   uncheckedText :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--checked-color' | '--width' | '--height' | '--border-width'> */
  trait SwitchProps extends StObject {
    ...
    var beforeChange: js.UndefOr[js.Function1[/* val */ Boolean, js.Promise[Unit]]] = js.undefined
    
    var checked: js.UndefOr[Boolean] = js.undefined
    
    var checkedText: js.UndefOr[ReactNode] = js.undefined
    ...
    var onChange: js.UndefOr[js.Function1[/* checked */ Boolean, Unit | js.Promise[Unit]]] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBlockSize] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var uncheckedText: js.UndefOr[ReactNode] = js.undefined
  }
  object SwitchProps {
    ...
    implicit open class MutableBuilder[Self <: SwitchProps] (val x: Self) extends AnyVal {
      ...
      inline def setBeforeChange(value: /* val */ Boolean => js.Promise[Unit]): Self = StObject.set(x, "beforeChange", js.Any.fromFunction1(value))
      
      inline def setBeforeChangeUndefined: Self = StObject.set(x, "beforeChange", js.undefined)
      
      inline def setChecked(value: Boolean): Self = StObject.set(x, "checked", value.asInstanceOf[js.Any])
      
      inline def setCheckedText(value: ReactNode): Self = StObject.set(x, "checkedText", value.asInstanceOf[js.Any])
      
      inline def setCheckedTextUndefined: Self = StObject.set(x, "checkedText", js.undefined)
      ...
      inline def setOnChange(value: /* checked */ Boolean => Unit | js.Promise[Unit]): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorBlockSize): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
      ...
      inline def setUncheckedText(value: ReactNode): Self = StObject.set(x, "uncheckedText", value.asInstanceOf[js.Any])
      
      inline def setUncheckedTextUndefined: Self = StObject.set(x, "uncheckedText", js.undefined)
    }
  }
}
