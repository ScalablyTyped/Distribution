...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundBlendMode
...
object progressBarProgressBarMod {
  
  @JSImport("antd-mobile/es/components/progress-bar/progress-bar", "ProgressBar")
  @js.native
  val ProgressBar: FC[ProgressBarProps] = js.native
  
  /* Inlined {  percent :number | undefined,   rounded :boolean | undefined,   text :boolean | react.react.ReactNode | (percent : number): react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--track-width' | '--track-color' | '--fill-color' | '--text-width'> */
  trait ProgressBarProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundBlendMode] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var text: js.UndefOr[Boolean | ReactNode | (js.Function1[/* percent */ Double, ReactNode])] = js.undefined
  }
  object ProgressBarProps {
    ...
    extension [Self <: ProgressBarProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundBlendMode): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
      ...
      inline def setText(value: Boolean | ReactNode | (js.Function1[/* percent */ Double, ReactNode])): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
      
      inline def setTextFunction1(value: /* percent */ Double => ReactNode): Self = StObject.set(x, "text", js.Any.fromFunction1(value))
