...
object checkboxCheckboxMod {
  ...
  @JSImport("antd-mobile/es/components/checkbox/checkbox", "Checkbox")
  @js.native
  val Checkbox: ForwardRefExoticComponent[checkedbooleanundefinedde] = js.native
  
  /* Inlined {  checked :boolean | undefined,   defaultChecked :boolean | undefined,   disabled :boolean | undefined,   onChange :(checked : boolean): void | undefined,   value :antd-mobile.antd-mobile/es/components/checkbox/checkbox.CheckboxValue | undefined,   indeterminate :boolean | undefined,   block :boolean | undefined,   id :string | undefined,   icon :(checked : boolean, indeterminate : boolean): react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--icon-size' | '--font-size' | '--gap'> */
  trait CheckboxProps extends StObject {
    ...
    var icon: js.UndefOr[js.Function2[/* checked */ Boolean, /* indeterminate */ Boolean, ReactNode]] = js.undefined
  ...
  object CheckboxProps {
    ...
    extension [Self <: CheckboxProps](x: Self) {
      ...
      inline def setIcon(value: (/* checked */ Boolean, /* indeterminate */ Boolean) => ReactNode): Self = StObject.set(x, "icon", js.Any.fromFunction2(value))
  ...
  object CheckboxRef {
    ...
    inline def apply(check: () => Unit, toggle: () => Unit, uncheck: () => Unit): CheckboxRef = {
      val __obj = js.Dynamic.literal(check = js.Any.fromFunction0(check), toggle = js.Any.fromFunction0(toggle), uncheck = js.Any.fromFunction0(uncheck))
  ...
  type CheckboxValue = String | Double
}
