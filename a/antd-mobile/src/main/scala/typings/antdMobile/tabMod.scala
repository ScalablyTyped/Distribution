...
object tabMod {
  ...
  object TabProps {
    ...
    inline def apply(prefixCls: String): TabProps = {
    ...
    extension [Self <: TabProps](x: Self) {
      ...
      inline def setDataAttrs(value: StringDictionary[String]): Self = StObject.set(x, "dataAttrs", value.asInstanceOf[js.Any])
