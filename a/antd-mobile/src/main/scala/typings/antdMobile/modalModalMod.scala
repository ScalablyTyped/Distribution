...
object modalModalMod {
  ...
  @JSImport("antd-mobile/es/components/modal/modal", "Modal")
  @js.native
  val Modal: FC[ModalProps] = js.native
  
  /* Inlined std.Pick<antd-mobile.antd-mobile/es/components/center-popup.CenterPopupProps, 'afterClose' | 'afterShow' | 'bodyClassName' | 'bodyStyle' | 'destroyOnClose' | 'disableBodyScroll' | 'forceRender' | 'getContainer' | 'maskClassName' | 'maskStyle' | 'stopPropagation' | 'visible'> & {  image :string | undefined,   header :react.react.ReactNode | undefined,   title :react.react.ReactNode | undefined,   content :react.react.ReactNode | undefined,   actions :std.Array<antd-mobile.antd-mobile/es/components/modal/modal-action-button.Action> | undefined,   onAction :(action : antd-mobile.antd-mobile/es/components/modal/modal-action-button.Action, index : number): void | std.Promise<void> | undefined,   onClose :(): void | undefined,   closeOnAction :boolean | undefined,   closeOnMaskClick :boolean | undefined,   showCloseButton :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
