...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundPositionX
...
import typings.antdMobile.marksMod.SliderMarks
...
object sliderSliderMod {
  ...
  @JSImport("antd-mobile/es/components/slider/slider", "Slider")
  @js.native
  val Slider: FC[SliderProps] = js.native
  
  /* Inlined {  min :number | undefined,   max :number | undefined,   value :antd-mobile.antd-mobile/es/components/slider/slider.SliderValue | undefined,   defaultValue :antd-mobile.antd-mobile/es/components/slider/slider.SliderValue | undefined,   step :number | undefined,   marks :antd-mobile.antd-mobile/es/components/slider/marks.SliderMarks | undefined,   ticks :boolean | undefined,   disabled :boolean | undefined,   range :boolean | undefined,   icon :react.react.ReactNode | undefined,   popover :boolean | (value : number): react.react.ReactNode | undefined,   residentPopover :boolean | undefined,   onChange :(value : antd-mobile.antd-mobile/es/components/slider/slider.SliderValue): void | undefined,   onAfterChange :(value : antd-mobile.antd-mobile/es/components/slider/slider.SliderValue): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--fill-color'> */
  trait SliderProps extends StObject {
    ...
    var popover: js.UndefOr[Boolean | (js.Function1[/* value */ Double, ReactNode])] = js.undefined
    
    var range: js.UndefOr[Boolean] = js.undefined
    
    var residentPopover: js.UndefOr[Boolean] = js.undefined
    
    var step: js.UndefOr[Double] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundPositionX] = js.undefined
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setDefaultValue(value: SliderValue): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      ...
      inline def setOnAfterChange(value: /* value */ SliderValue => Unit): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction1(value))
      ...
      inline def setPopover(value: Boolean | (js.Function1[/* value */ Double, ReactNode])): Self = StObject.set(x, "popover", value.asInstanceOf[js.Any])
      
      inline def setPopoverFunction1(value: /* value */ Double => ReactNode): Self = StObject.set(x, "popover", js.Any.fromFunction1(value))
      ...
      inline def setResidentPopoverUndefined: Self = StObject.set(x, "residentPopover", js.undefined)
      
      inline def setStep(value: Double): Self = StObject.set(x, "step", value.asInstanceOf[js.Any])
      
      inline def setStepUndefined: Self = StObject.set(x, "step", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundPositionX): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
