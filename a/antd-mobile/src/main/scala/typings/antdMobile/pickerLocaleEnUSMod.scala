...
object pickerLocaleEnUSMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/picker/locale/en_US", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/picker/locale/en_US", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/picker/locale/en_US", "default.extra")
    @js.native
    ...
    @JSImport("antd-mobile/lib/picker/locale/en_US", "default.okText")
    @js.native
