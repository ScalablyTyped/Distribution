...
object floatingPanelFloatingPanelMod {
  
  @JSImport("antd-mobile/es/components/floating-panel/floating-panel", "FloatingPanel")
  @js.native
  val FloatingPanel: ForwardRefExoticComponent[anchorsArraynumberchildre] = js.native
  
  /* Inlined {  anchors :std.Array<number>,   children :react.react.ReactNode,   onHeightChange :(height : number, animating : boolean): void | undefined,   handleDraggingOfContent :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--border-radius' | '--z-index' | '--header-height'> */
  trait FloatingPanelProps extends StObject {
    
    var anchors: js.Array[Double]
    ...
    var handleDraggingOfContent: js.UndefOr[Boolean] = js.undefined
  ...
  object FloatingPanelProps {
    
    inline def apply(anchors: js.Array[Double]): FloatingPanelProps = {
      val __obj = js.Dynamic.literal(anchors = anchors.asInstanceOf[js.Any])
    ...
    extension [Self <: FloatingPanelProps](x: Self) {
      ...
      inline def setAnchorsVarargs(value: Double*): Self = StObject.set(x, "anchors", js.Array(value*))
      ...
      inline def setHandleDraggingOfContent(value: Boolean): Self = StObject.set(x, "handleDraggingOfContent", value.asInstanceOf[js.Any])
      
      inline def setHandleDraggingOfContentUndefined: Self = StObject.set(x, "handleDraggingOfContent", js.undefined)
      
      inline def setOnHeightChange(value: (/* height */ Double, /* animating */ Boolean) => Unit): Self = StObject.set(x, "onHeightChange", js.Any.fromFunction2(value))
  ...
  @js.native
  trait FloatingPanelRef extends StObject {
    
    def setHeight(height: Double): Unit = js.native
    def setHeight(height: Double, options: Immediate): Unit = js.native
  }
}
