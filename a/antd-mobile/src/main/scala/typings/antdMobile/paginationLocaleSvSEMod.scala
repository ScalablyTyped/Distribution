...
object paginationLocaleSvSEMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/pagination/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/pagination/locale/sv_SE", "default.nextText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/pagination/locale/sv_SE", "default.prevText")
    @js.native
