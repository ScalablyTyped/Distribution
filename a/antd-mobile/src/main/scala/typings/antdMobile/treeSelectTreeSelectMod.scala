...
import typings.antdMobile.anon.Options
...
object treeSelectTreeSelectMod {
  ...
  object TreeSelectProps {
    ...
    extension [Self <: TreeSelectProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ js.Array[String], /* extend */ Options) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
