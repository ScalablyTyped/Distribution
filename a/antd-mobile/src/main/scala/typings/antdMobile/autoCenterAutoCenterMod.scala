...
object autoCenterAutoCenterMod {
  
  @JSImport("antd-mobile/es/components/auto-center/auto-center", "AutoCenter")
  @js.native
  val AutoCenter: FC[AutoCenterProps] = js.native
  
  /* Inlined {  children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait AutoCenterProps extends StObject {
  ...
  object AutoCenterProps {
    
    inline def apply(): AutoCenterProps = {
