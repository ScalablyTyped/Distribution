...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundPositionY
...
object esComponentsSpinLoadingSpinLoadingMod {
  
  @JSImport("antd-mobile/es/components/spin-loading/spin-loading", "SpinLoading")
  @js.native
  val SpinLoading: NamedExoticComponent[SpinLoadingProps] = js.native
  
  /* Inlined {  color :'default' | 'primary' | 'white' | string & {} | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--color' | '--size'> */
  trait SpinLoadingProps extends StObject {
    ...
    var color: js.UndefOr[default | primary | white | String] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundPositionY] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
  }
  object SpinLoadingProps {
    
    inline def apply(): SpinLoadingProps = {
    ...
    extension [Self <: SpinLoadingProps](x: Self) {
      ...
      inline def setColor(value: default | primary | white | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      
      inline def setColorUndefined: Self = StObject.set(x, "color", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundPositionY): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
