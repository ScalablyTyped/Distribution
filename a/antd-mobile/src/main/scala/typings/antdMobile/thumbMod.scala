...
object thumbMod extends Shortcut {
  ...
  trait ThumbProps extends StObject {
    ...
    var popover: Boolean | (js.Function1[/* value */ Double, ReactNode])
    ...
    var trackRef: RefObject[HTMLDivElement]
  ...
  object ThumbProps {
    ...
    inline def apply(
      ...
      max: Double,
      min: Double,
      onDrag: (Double, Boolean, Boolean) => Unit,
      popover: Boolean | (js.Function1[/* value */ Double, ReactNode]),
      residentPopover: Boolean,
      trackRef: RefObject[HTMLDivElement],
      value: Double
    ): ThumbProps = {
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], onDrag = js.Any.fromFunction3(onDrag), popover = popover.asInstanceOf[js.Any], residentPopover = residentPopover.asInstanceOf[js.Any], trackRef = trackRef.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: ThumbProps](x: Self) {
      ...
      inline def setOnDrag(value: (Double, Boolean, Boolean) => Unit): Self = StObject.set(x, "onDrag", js.Any.fromFunction3(value))
      ...
      inline def setTrackRef(value: RefObject[HTMLDivElement]): Self = StObject.set(x, "trackRef", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `default`, but can instead just say `thumbMod.foo` */
