...
object swiperItemMod {
  
  @JSImport("antd-mobile/es/components/swiper/swiper-item", "SwiperItem")
  @js.native
  val SwiperItem: FC[Props] = js.native
  
  /* Inlined {  onClick :(e : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
