...
object inputItemMod {
  ...
  object InputItemProps {
    ...
    implicit class InputItemPropsMutableBuilder[Self <: InputItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnErrorClick(value: MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnExtraClick(value: MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
