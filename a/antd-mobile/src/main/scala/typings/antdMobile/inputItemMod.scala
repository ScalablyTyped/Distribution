...
object inputItemMod {
  ...
  object HTMLInputProps {
    ...
    inline def apply(): HTMLInputProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[HTMLInputProps]
    }
    
    extension [Self <: HTMLInputProps](x: Self) {
  ...
  trait InputItem
    ...
    def handleOnChange(value: String, isMutated: Unit, adjustPos: js.Function): Unit = js.native
  ...
  object InputItemProps {
    ...
    extension [Self <: InputItemProps](x: Self) {
      ...
      inline def setOnErrorClick(value: MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      
      inline def setOnErrorClickUndefined: Self = StObject.set(x, "onErrorClick", js.undefined)
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnExtraClick(value: MouseEvent[HTMLDivElement, NativeMouseEvent] => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
