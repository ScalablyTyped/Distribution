...
import typings.rcFieldForm.esInterfaceMod.RecursivePartial
...
import typings.rcFieldForm.esInterfaceMod.ValidateFields
...
object esComponentsFormFormMod {
  ...
  object FormInstance {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: FormInstance] (val x: Self) extends AnyVal {
  ...
  trait FormProps extends StObject {
    ...
    var form: js.UndefOr[typings.rcFieldForm.esInterfaceMod.FormInstance[Any]] = js.undefined
  ...
  object FormProps {
    ...
    implicit open class MutableBuilder[Self <: FormProps] (val x: Self) extends AnyVal {
      ...
      inline def setForm(value: typings.rcFieldForm.esInterfaceMod.FormInstance[Any]): Self = StObject.set(x, "form", value.asInstanceOf[js.Any])
