...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAspectRatio
...
object indexBarIndexBarMod {
  
  @JSImport("antd-mobile/es/components/index-bar/index-bar", "IndexBar")
  @js.native
  val IndexBar: ForwardRefExoticComponent[stickybooleanundefinedonI] = js.native
  
  /* Inlined {  sticky :boolean | undefined,   onIndexChange :(index : string): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--sticky-offset-top'> */
  trait IndexBarProps extends StObject {
    ...
    var onIndexChange: js.UndefOr[js.Function1[/* index */ String, Unit]] = js.undefined
    
    var sticky: js.UndefOr[Boolean] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAspectRatio] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
  }
  object IndexBarProps {
    
    inline def apply(): IndexBarProps = {
    ...
    extension [Self <: IndexBarProps](x: Self) {
      ...
      inline def setOnIndexChange(value: /* index */ String => Unit): Self = StObject.set(x, "onIndexChange", js.Any.fromFunction1(value))
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAspectRatio): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  trait IndexBarRef extends StObject {
    
    def scrollTo(index: String): Unit
  }
  object IndexBarRef {
    
    inline def apply(scrollTo: String => Unit): IndexBarRef = {
