...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--width' | '--height' | '--border-radius' | '--track-padding', string>> */
trait CSSPropertiesPartialRecorBaselineShift extends StObject {
...
object CSSPropertiesPartialRecorBaselineShift {
  
  inline def apply(): CSSPropertiesPartialRecorBaselineShift = {
