...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--background-color' | '--border-color' | '--text-color' | '--font-size' | '--icon-font-size' | '--height', string>> */
trait CSSPropertiesPartialRecorBackground extends StObject {
  ...
  var `--icon-font-size`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackground {
  
  inline def apply(): CSSPropertiesPartialRecorBackground = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackground]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorBackground] (val x: Self) extends AnyVal {
    ...
    inline def `set--icon-font-size`(value: String): Self = StObject.set(x, "--icon-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--icon-font-sizeUndefined`: Self = StObject.set(x, "--icon-font-size", js.undefined)
