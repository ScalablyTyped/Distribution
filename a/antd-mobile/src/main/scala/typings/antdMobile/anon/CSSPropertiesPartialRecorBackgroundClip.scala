...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--size' | '--track-width' | '--track-color' | '--fill-color', string>> */
trait CSSPropertiesPartialRecorBackgroundClip extends StObject {
  
  var `--fill-color`: js.UndefOr[String] = js.undefined
  
  var `--size`: js.UndefOr[String] = js.undefined
  
  var `--track-color`: js.UndefOr[String] = js.undefined
  
  var `--track-width`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundClip {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundClip = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackgroundClip]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorBackgroundClip] (val x: Self) extends AnyVal {
    ...
    inline def `set--track-color`(value: String): Self = StObject.set(x, "--track-color", value.asInstanceOf[js.Any])
    
    inline def `set--track-colorUndefined`: Self = StObject.set(x, "--track-color", js.undefined)
    
    inline def `set--track-width`(value: String): Self = StObject.set(x, "--track-width", value.asInstanceOf[js.Any])
    
    inline def `set--track-widthUndefined`: Self = StObject.set(x, "--track-width", js.undefined)
