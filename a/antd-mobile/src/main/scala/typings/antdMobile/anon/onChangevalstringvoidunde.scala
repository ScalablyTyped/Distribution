...
import typings.antdMobile.esComponentsTextAreaTextAreaMod.TextAreaRef
...
object onChangevalstringvoidunde {
  
  inline def apply(): onChangevalstringvoidunde = {
  ...
  extension [Self <: onChangevalstringvoidunde](x: Self) {
    ...
    inline def setRef(value: Ref[TextAreaRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ TextAreaRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
