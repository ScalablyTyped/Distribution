...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--z-index' | '--arrow-size', string>> */
trait CSSPropertiesPartialRecorArrowsize extends StObject {
  
  var `--arrow-size`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorArrowsize {
  
  inline def apply(): CSSPropertiesPartialRecorArrowsize = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorArrowsize]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorArrowsize] (val x: Self) extends AnyVal {
    
    inline def `set--arrow-size`(value: String): Self = StObject.set(x, "--arrow-size", value.asInstanceOf[js.Any])
    
    inline def `set--arrow-sizeUndefined`: Self = StObject.set(x, "--arrow-size", js.undefined)
