...
import typings.antdMobile.esComponentsIndexBarIndexBarMod.IndexBarRef
...
object Partialstickybooleanundef {
  ...
  extension [Self <: Partialstickybooleanundef](x: Self) {
    ...
    inline def setRefFunction1(value: /* instance */ IndexBarRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
