...
import typings.antdMobile.esComponentsVirtualInputVirtualInputMod.VirtualInputRef
...
object onFocusvoidundefinedonBlu {
  ...
  implicit open class MutableBuilder[Self <: onFocusvoidundefinedonBlu] (val x: Self) extends AnyVal {
    ...
    inline def setRefFunction1(value: /* instance */ VirtualInputRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
