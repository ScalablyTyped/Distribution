...
object PartialoptionsArrayCascad {
  ...
  extension [Self <: PartialoptionsArrayCascad](x: Self) {
    ...
    inline def setOnConfirm(value: (/* value */ js.Array[String], /* extend */ CascaderValueExtend) => Unit): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2(value))
    
    inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
    
    inline def setOnSelect(value: (/* value */ js.Array[String], /* extend */ CascaderValueExtend) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
