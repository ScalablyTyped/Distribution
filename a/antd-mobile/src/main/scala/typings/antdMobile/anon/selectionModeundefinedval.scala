...
import typings.antdMobile.antdMobileStrings.Monday
import typings.antdMobile.antdMobileStrings.Sunday
...
trait selectionModeundefinedval
  ...
  var maxPage: js.UndefOr[Page] = js.undefined
  
  var min: js.UndefOr[js.Date] = js.undefined
  
  var minPage: js.UndefOr[Page] = js.undefined
  
  var nextMonthButton: js.UndefOr[ReactNode] = js.undefined
  
  var nextYearButton: js.UndefOr[ReactNode] = js.undefined
  
  var onChange: Unit
  
  var onPageChange: js.UndefOr[js.Function2[/* year */ Double, /* month */ Double, Unit]] = js.undefined
  ...
  var selectionMode: Unit
  
  var shouldDisableDate: js.UndefOr[js.Function1[/* date */ js.Date, Boolean]] = js.undefined
  ...
  var weekStartsOn: js.UndefOr[Monday | Sunday] = js.undefined
}
object selectionModeundefinedval {
  
  inline def apply(defaultValue: Unit, onChange: Unit, selectionMode: Unit, value: Unit): selectionModeundefinedval = {
    ...
    __obj.asInstanceOf[selectionModeundefinedval]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: selectionModeundefinedval] (val x: Self) extends AnyVal {
    ...
    inline def setMaxPage(value: Page): Self = StObject.set(x, "maxPage", value.asInstanceOf[js.Any])
    
    inline def setMaxPageUndefined: Self = StObject.set(x, "maxPage", js.undefined)
    
    inline def setMaxUndefined: Self = StObject.set(x, "max", js.undefined)
    
    inline def setMin(value: js.Date): Self = StObject.set(x, "min", value.asInstanceOf[js.Any])
    
    inline def setMinPage(value: Page): Self = StObject.set(x, "minPage", value.asInstanceOf[js.Any])
    
    inline def setMinPageUndefined: Self = StObject.set(x, "minPage", js.undefined)
    
    inline def setMinUndefined: Self = StObject.set(x, "min", js.undefined)
    
    inline def setNextMonthButton(value: ReactNode): Self = StObject.set(x, "nextMonthButton", value.asInstanceOf[js.Any])
    
    inline def setNextMonthButtonUndefined: Self = StObject.set(x, "nextMonthButton", js.undefined)
    
    inline def setNextYearButton(value: ReactNode): Self = StObject.set(x, "nextYearButton", value.asInstanceOf[js.Any])
    
    inline def setNextYearButtonUndefined: Self = StObject.set(x, "nextYearButton", js.undefined)
    
    inline def setOnChange(value: Unit): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    
    inline def setOnPageChange(value: (/* year */ Double, /* month */ Double) => Unit): Self = StObject.set(x, "onPageChange", js.Any.fromFunction2(value))
    
    inline def setOnPageChangeUndefined: Self = StObject.set(x, "onPageChange", js.undefined)
    
    inline def setPrevMonthButton(value: ReactNode): Self = StObject.set(x, "prevMonthButton", value.asInstanceOf[js.Any])
    
    inline def setPrevMonthButtonUndefined: Self = StObject.set(x, "prevMonthButton", js.undefined)
    ...
    inline def setSelectionMode(value: Unit): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
    
    inline def setShouldDisableDate(value: /* date */ js.Date => Boolean): Self = StObject.set(x, "shouldDisableDate", js.Any.fromFunction1(value))
    ...
    inline def setWeekStartsOn(value: Monday | Sunday): Self = StObject.set(x, "weekStartsOn", value.asInstanceOf[js.Any])
