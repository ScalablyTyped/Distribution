...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--size' | '--border-radius', string>> */
trait CSSPropertiesPartialRecor extends StObject {
...
object CSSPropertiesPartialRecor {
  
  inline def apply(): CSSPropertiesPartialRecor = {
