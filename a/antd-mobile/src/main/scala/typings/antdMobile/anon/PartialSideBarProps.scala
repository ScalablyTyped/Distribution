...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/side-bar/side-bar.SideBarProps> */
trait PartialSideBarProps extends StObject {
  ...
  var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundOrigin] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
}
object PartialSideBarProps {
  
  inline def apply(): PartialSideBarProps = {
  ...
  implicit open class MutableBuilder[Self <: PartialSideBarProps] (val x: Self) extends AnyVal {
    ...
    inline def setStyle(value: CSSPropertiesPartialRecorBackgroundOrigin): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
