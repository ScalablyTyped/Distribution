...
trait WeakValidationMapactiveKe extends StObject {
  ...
  var arrow: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var children: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var className: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  
  var closeOnClickAway: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[Null | String, Unit]) | Null]]] = js.undefined
  
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[DropdownRef]]]] = js.undefined
...
object WeakValidationMapactiveKe {
  ...
  extension [Self <: WeakValidationMapactiveKe](x: Self) {
    ...
    inline def setArrow(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "arrow", value.asInstanceOf[js.Any])
    ...
    inline def setCloseOnClickAway(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "closeOnClickAway", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: Validator[js.UndefOr[(js.Function1[Null | String, Unit]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setRef(value: Validator[js.UndefOr[Null | Ref[DropdownRef]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
