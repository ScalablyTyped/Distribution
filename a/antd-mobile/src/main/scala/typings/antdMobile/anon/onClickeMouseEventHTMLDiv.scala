...
/* Inlined {  onClick :(e : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<never, string>> | undefined,   tabIndex :number | undefined} & react.react.AriaAttributes */
trait onClickeMouseEventHTMLDiv extends StObject {
...
object onClickeMouseEventHTMLDiv {
  
  inline def apply(): onClickeMouseEventHTMLDiv = {
  ...
  extension [Self <: onClickeMouseEventHTMLDiv](x: Self) {
    ...
    inline def setOnClick(value: /* e */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
