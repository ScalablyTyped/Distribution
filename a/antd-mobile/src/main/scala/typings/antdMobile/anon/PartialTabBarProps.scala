...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/tab-bar/tab-bar.TabBarProps> */
trait PartialTabBarProps extends StObject {
...
object PartialTabBarProps {
  
  inline def apply(): PartialTabBarProps = {
