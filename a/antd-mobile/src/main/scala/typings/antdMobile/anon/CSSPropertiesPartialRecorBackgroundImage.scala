...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--color' | '--checked-color' | '--text-color' | '--checked-text-color' | '--border' | '--checked-border' | '--border-radius' | '--padding' | '--gap' | '--gap-vertical' | '--gap-horizontal', string>> */
trait CSSPropertiesPartialRecorBackgroundImage extends StObject {
  
  var `--border`: js.UndefOr[String] = js.undefined
  
  var `--border-radius`: js.UndefOr[String] = js.undefined
  
  var `--checked-border`: js.UndefOr[String] = js.undefined
  
  var `--checked-color`: js.UndefOr[String] = js.undefined
  
  var `--checked-text-color`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundImage {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundImage = {
  ...
  extension [Self <: CSSPropertiesPartialRecorBackgroundImage](x: Self) {
    ...
    inline def `set--checked-border`(value: String): Self = StObject.set(x, "--checked-border", value.asInstanceOf[js.Any])
    
    inline def `set--checked-borderUndefined`: Self = StObject.set(x, "--checked-border", js.undefined)
    ...
    inline def `set--checked-text-color`(value: String): Self = StObject.set(x, "--checked-text-color", value.asInstanceOf[js.Any])
    
    inline def `set--checked-text-colorUndefined`: Self = StObject.set(x, "--checked-text-color", js.undefined)
    ...
    inline def `set--padding`(value: String): Self = StObject.set(x, "--padding", value.asInstanceOf[js.Any])
