...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/skeleton/skeleton.SkeletonProps> */
trait WeakValidationMapSkeleton extends StObject {
  ...
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundPosition | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapSkeleton {
  
  inline def apply(): WeakValidationMapSkeleton = {
  ...
  extension [Self <: WeakValidationMapSkeleton](x: Self) {
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundPosition | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
