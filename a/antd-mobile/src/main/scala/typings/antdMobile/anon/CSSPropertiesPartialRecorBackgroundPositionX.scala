...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--fill-color', string>> */
trait CSSPropertiesPartialRecorBackgroundPositionX extends StObject {
  
  var `--fill-color`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundPositionX {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundPositionX = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackgroundPositionX]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorBackgroundPositionX] (val x: Self) extends AnyVal {
    
    inline def `set--fill-color`(value: String): Self = StObject.set(x, "--fill-color", value.asInstanceOf[js.Any])
    
    inline def `set--fill-colorUndefined`: Self = StObject.set(x, "--fill-color", js.undefined)
