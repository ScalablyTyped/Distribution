...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height' | '--input-width' | '--input-font-size' | '--input-background-color' | '--border-radius' | '--border' | '--border-inner' | '--active-border' | '--button-font-size' | '--button-background-color' | '--button-width' | '--input-font-color' | '--button-text-color', string>> */
trait CSSPropertiesPartialRecorActiveborder extends StObject {
  
  var `--active-border`: js.UndefOr[String] = js.undefined
  ...
  var `--button-background-color`: js.UndefOr[String] = js.undefined
  
  var `--button-font-size`: js.UndefOr[String] = js.undefined
  
  var `--button-text-color`: js.UndefOr[String] = js.undefined
  
  var `--button-width`: js.UndefOr[String] = js.undefined
  
  var `--height`: js.UndefOr[String] = js.undefined
  
  var `--input-background-color`: js.UndefOr[String] = js.undefined
  
  var `--input-font-color`: js.UndefOr[String] = js.undefined
  
  var `--input-font-size`: js.UndefOr[String] = js.undefined
  
  var `--input-width`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorActiveborder {
  
  inline def apply(): CSSPropertiesPartialRecorActiveborder = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorActiveborder] (val x: Self) extends AnyVal {
    ...
    inline def `set--active-borderUndefined`: Self = StObject.set(x, "--active-border", js.undefined)
    ...
    inline def `set--button-background-color`(value: String): Self = StObject.set(x, "--button-background-color", value.asInstanceOf[js.Any])
    
    inline def `set--button-background-colorUndefined`: Self = StObject.set(x, "--button-background-color", js.undefined)
    
    inline def `set--button-font-size`(value: String): Self = StObject.set(x, "--button-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--button-font-sizeUndefined`: Self = StObject.set(x, "--button-font-size", js.undefined)
    
    inline def `set--button-text-color`(value: String): Self = StObject.set(x, "--button-text-color", value.asInstanceOf[js.Any])
    
    inline def `set--button-text-colorUndefined`: Self = StObject.set(x, "--button-text-color", js.undefined)
    
    inline def `set--button-width`(value: String): Self = StObject.set(x, "--button-width", value.asInstanceOf[js.Any])
    
    inline def `set--button-widthUndefined`: Self = StObject.set(x, "--button-width", js.undefined)
    ...
    inline def `set--input-background-color`(value: String): Self = StObject.set(x, "--input-background-color", value.asInstanceOf[js.Any])
    
    inline def `set--input-background-colorUndefined`: Self = StObject.set(x, "--input-background-color", js.undefined)
    
    inline def `set--input-font-color`(value: String): Self = StObject.set(x, "--input-font-color", value.asInstanceOf[js.Any])
    
    inline def `set--input-font-colorUndefined`: Self = StObject.set(x, "--input-font-color", js.undefined)
    
    inline def `set--input-font-size`(value: String): Self = StObject.set(x, "--input-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--input-font-sizeUndefined`: Self = StObject.set(x, "--input-font-size", js.undefined)
    
    inline def `set--input-width`(value: String): Self = StObject.set(x, "--input-width", value.asInstanceOf[js.Any])
    
    inline def `set--input-widthUndefined`: Self = StObject.set(x, "--input-width", js.undefined)
