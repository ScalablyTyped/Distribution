...
import typings.antdMobile.esComponentsPasscodeInputPasscodeInputMod.PasscodeInputRef
...
object valuestringundefineddefauAriaactivedescendant {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: valuestringundefineddefauAriaactivedescendant] (val x: Self) extends AnyVal {
    ...
    inline def setOnFill(value: /* val */ String => Unit): Self = StObject.set(x, "onFill", js.Any.fromFunction1(value))
    ...
    inline def setRefFunction1(value: /* instance */ PasscodeInputRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
