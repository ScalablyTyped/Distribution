...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--background-color', string>> */
trait CSSPropertiesPartialRecorAnimationIterationCount extends StObject {
...
object CSSPropertiesPartialRecorAnimationIterationCount {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationIterationCount = {
