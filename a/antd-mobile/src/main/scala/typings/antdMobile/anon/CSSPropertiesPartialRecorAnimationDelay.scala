...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--image-height' | '--image-height-full-page' | '--image-width' | '--image-width-full-page', string>> */
trait CSSPropertiesPartialRecorAnimationDelay extends StObject {
  
  var `--image-height`: js.UndefOr[String] = js.undefined
  
  var `--image-height-full-page`: js.UndefOr[String] = js.undefined
  
  var `--image-width`: js.UndefOr[String] = js.undefined
  
  var `--image-width-full-page`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimationDelay {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationDelay = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAnimationDelay] (val x: Self) extends AnyVal {
    ...
    inline def `set--image-height-full-page`(value: String): Self = StObject.set(x, "--image-height-full-page", value.asInstanceOf[js.Any])
    
    inline def `set--image-height-full-pageUndefined`: Self = StObject.set(x, "--image-height-full-page", js.undefined)
    
    inline def `set--image-heightUndefined`: Self = StObject.set(x, "--image-height", js.undefined)
    
    inline def `set--image-width`(value: String): Self = StObject.set(x, "--image-width", value.asInstanceOf[js.Any])
    
    inline def `set--image-width-full-page`(value: String): Self = StObject.set(x, "--image-width-full-page", value.asInstanceOf[js.Any])
    
    inline def `set--image-width-full-pageUndefined`: Self = StObject.set(x, "--image-width-full-page", js.undefined)
    
    inline def `set--image-widthUndefined`: Self = StObject.set(x, "--image-width", js.undefined)
