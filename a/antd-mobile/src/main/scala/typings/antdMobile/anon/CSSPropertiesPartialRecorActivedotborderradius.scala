...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--dot-color' | '--active-dot-color' | '--dot-size' | '--active-dot-size' | '--dot-border-radius' | '--active-dot-border-radius' | '--dot-spacing', string>> */
trait CSSPropertiesPartialRecorActivedotborderradius extends StObject {
  
  var `--active-dot-border-radius`: js.UndefOr[String] = js.undefined
  
  var `--active-dot-color`: js.UndefOr[String] = js.undefined
  
  var `--active-dot-size`: js.UndefOr[String] = js.undefined
  
  var `--dot-border-radius`: js.UndefOr[String] = js.undefined
  
  var `--dot-color`: js.UndefOr[String] = js.undefined
  
  var `--dot-size`: js.UndefOr[String] = js.undefined
  
  var `--dot-spacing`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorActivedotborderradius {
  
  inline def apply(): CSSPropertiesPartialRecorActivedotborderradius = {
  ...
  extension [Self <: CSSPropertiesPartialRecorActivedotborderradius](x: Self) {
    ...
    inline def `set--active-dot-border-radiusUndefined`: Self = StObject.set(x, "--active-dot-border-radius", js.undefined)
    
    inline def `set--active-dot-color`(value: String): Self = StObject.set(x, "--active-dot-color", value.asInstanceOf[js.Any])
    
    inline def `set--active-dot-colorUndefined`: Self = StObject.set(x, "--active-dot-color", js.undefined)
    
    inline def `set--active-dot-size`(value: String): Self = StObject.set(x, "--active-dot-size", value.asInstanceOf[js.Any])
    
    inline def `set--active-dot-sizeUndefined`: Self = StObject.set(x, "--active-dot-size", js.undefined)
    
    inline def `set--dot-border-radius`(value: String): Self = StObject.set(x, "--dot-border-radius", value.asInstanceOf[js.Any])
    
    inline def `set--dot-border-radiusUndefined`: Self = StObject.set(x, "--dot-border-radius", js.undefined)
    
    inline def `set--dot-color`(value: String): Self = StObject.set(x, "--dot-color", value.asInstanceOf[js.Any])
    
    inline def `set--dot-colorUndefined`: Self = StObject.set(x, "--dot-color", js.undefined)
    ...
    inline def `set--dot-spacing`(value: String): Self = StObject.set(x, "--dot-spacing", value.asInstanceOf[js.Any])
    
    inline def `set--dot-spacingUndefined`: Self = StObject.set(x, "--dot-spacing", js.undefined)
