...
trait CSSPropertiesPartialRecorAnimationPlayState extends StObject {
  
  var `--border-bottom`: js.UndefOr[String] = js.undefined
  
  var `--border-inner`: js.UndefOr[String] = js.undefined
  
  var `--border-top`: js.UndefOr[String] = js.undefined
  
  var `--prefix-width`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimationPlayState {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationPlayState = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAnimationPlayState]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAnimationPlayState] (val x: Self) extends AnyVal {
    
    inline def `set--border-bottom`(value: String): Self = StObject.set(x, "--border-bottom", value.asInstanceOf[js.Any])
    
    inline def `set--border-bottomUndefined`: Self = StObject.set(x, "--border-bottom", js.undefined)
    
    inline def `set--border-inner`(value: String): Self = StObject.set(x, "--border-inner", value.asInstanceOf[js.Any])
    
    inline def `set--border-innerUndefined`: Self = StObject.set(x, "--border-inner", js.undefined)
    
    inline def `set--border-top`(value: String): Self = StObject.set(x, "--border-top", value.asInstanceOf[js.Any])
    
    inline def `set--border-topUndefined`: Self = StObject.set(x, "--border-top", js.undefined)
    
    inline def `set--prefix-width`(value: String): Self = StObject.set(x, "--prefix-width", value.asInstanceOf[js.Any])
    
    inline def `set--prefix-widthUndefined`: Self = StObject.set(x, "--prefix-width", js.undefined)
