...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/steps/steps.StepsProps> */
trait WeakValidationMapStepsPro extends StObject {
  ...
  var current: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var direction: js.UndefOr[Validator[js.UndefOr[Direction | Null]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundRepeat | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapStepsPro {
  
  inline def apply(): WeakValidationMapStepsPro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapStepsPro]
  }
  
  extension [Self <: WeakValidationMapStepsPro](x: Self) {
    ...
    inline def setCurrent(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "current", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundRepeat | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
