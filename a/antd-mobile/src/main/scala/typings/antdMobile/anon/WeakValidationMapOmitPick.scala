...
/* Inlined react.react.WeakValidationMap<std.Omit<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'columns'> & {  options :std.Array<antd-mobile.antd-mobile/es/components/cascade-picker/cascade-picker.CascadePickerOption>} & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/picker.PickerActions>> */
trait WeakValidationMapOmitPick extends StObject {
  ...
  var children: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[
          /* items */ js.Array[Null | PickerColumnItem], 
  ...
  var defaultValue: js.UndefOr[Validator[js.UndefOr[js.Array[PickerValue] | Null]]] = js.undefined
  ...
  var onConfirm: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend, Unit]) | Null
      ]
    ]
  ] = js.undefined
  ...
  var options: js.UndefOr[Validator[js.UndefOr[js.Array[CascadePickerOption] | Null]]] = js.undefined
  ...
  var renderLabel: js.UndefOr[
    Validator[js.UndefOr[(js.Function1[/* item */ PickerColumnItem, ReactNode]) | Null]]
  ] = js.undefined
  
  var stopPropagation: js.UndefOr[Validator[js.UndefOr[js.Array[PropagationEvent] | Null]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAlignSelf | Null]]] = js.undefined
  ...
  var value: js.UndefOr[Validator[js.UndefOr[js.Array[PickerValue] | Null]]] = js.undefined
  
  var visible: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
}
object WeakValidationMapOmitPick {
  
  inline def apply(): WeakValidationMapOmitPick = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapOmitPick]
  }
  
  extension [Self <: WeakValidationMapOmitPick](x: Self) {
    ...
    inline def setDefaultValue(value: Validator[js.UndefOr[js.Array[PickerValue] | Null]]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def setOptions(value: Validator[js.UndefOr[js.Array[CascadePickerOption] | Null]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    ...
    inline def setRenderLabel(value: Validator[js.UndefOr[(js.Function1[/* item */ PickerColumnItem, ReactNode]) | Null]]): Self = StObject.set(x, "renderLabel", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAlignSelf | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: Validator[js.UndefOr[js.Array[PickerValue] | Null]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
