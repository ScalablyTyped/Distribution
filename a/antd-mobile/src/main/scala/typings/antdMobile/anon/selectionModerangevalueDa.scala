...
trait selectionModerangevalueDa
  ...
  var defaultValue: js.UndefOr[(js.Tuple2[js.Date, js.Date]) | Null] = js.undefined
  ...
  var onChange: js.UndefOr[js.Function1[/* val */ (js.Tuple2[js.Date, js.Date]) | Null, Unit]] = js.undefined
  ...
  var value: js.UndefOr[(js.Tuple2[js.Date, js.Date]) | Null] = js.undefined
  
  var weekStartsOn: js.UndefOr[Monday | Sunday] = js.undefined
}
object selectionModerangevalueDa {
  
  inline def apply(): selectionModerangevalueDa = {
  ...
  extension [Self <: selectionModerangevalueDa](x: Self) {
    ...
    inline def setDefaultValue(value: js.Tuple2[js.Date, js.Date]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: /* val */ (js.Tuple2[js.Date, js.Date]) | Null => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    inline def setSelectionMode(value: range): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: js.Tuple2[js.Date, js.Date]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
