...
trait selectionModesinglevalueD
  ...
  var onChange: js.UndefOr[js.Function1[/* val */ js.Date | Null, Unit]] = js.undefined
...
object selectionModesinglevalueD {
  
  inline def apply(): selectionModesinglevalueD = {
  ...
  extension [Self <: selectionModesinglevalueD](x: Self) {
    ...
    inline def setOnChange(value: /* val */ js.Date | Null => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
    ...
    inline def setSelectionMode(value: single): Self = StObject.set(x, "selectionMode", value.asInstanceOf[js.Any])
