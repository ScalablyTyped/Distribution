...
trait CSSPropertiesPartialRecorAnimationFillMode extends StObject {
...
object CSSPropertiesPartialRecorAnimationFillMode {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationFillMode = {
