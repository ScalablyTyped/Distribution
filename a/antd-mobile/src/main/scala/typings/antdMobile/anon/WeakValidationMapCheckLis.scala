...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/check-list/check-list.CheckListProps> */
trait WeakValidationMapCheckLis extends StObject {
  ...
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* val */ js.Array[String], Unit]) | Null]]] = js.undefined
...
object WeakValidationMapCheckLis {
  
  inline def apply(): WeakValidationMapCheckLis = {
  ...
  extension [Self <: WeakValidationMapCheckLis](x: Self) {
    ...
    inline def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* val */ js.Array[String], Unit]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
