...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--header-button-font-size' | '--title-font-size' | '--item-font-size' | '--item-height', string>> */
trait CSSPropertiesPartialRecorAlignSelf extends StObject {
  
  var `--header-button-font-size`: js.UndefOr[String] = js.undefined
  
  var `--item-font-size`: js.UndefOr[String] = js.undefined
  
  var `--item-height`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAlignSelf {
  
  inline def apply(): CSSPropertiesPartialRecorAlignSelf = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAlignSelf] (val x: Self) extends AnyVal {
    ...
    inline def `set--header-button-font-sizeUndefined`: Self = StObject.set(x, "--header-button-font-size", js.undefined)
    
    inline def `set--item-font-size`(value: String): Self = StObject.set(x, "--item-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--item-font-sizeUndefined`: Self = StObject.set(x, "--item-font-size", js.undefined)
    
    inline def `set--item-height`(value: String): Self = StObject.set(x, "--item-height", value.asInstanceOf[js.Any])
    
    inline def `set--item-heightUndefined`: Self = StObject.set(x, "--item-height", js.undefined)
