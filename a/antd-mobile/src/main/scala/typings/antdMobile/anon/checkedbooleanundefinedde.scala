...
import typings.antdMobile.esComponentsCheckboxCheckboxMod.CheckboxRef
...
trait checkedbooleanundefinedde extends StObject {
...
object checkedbooleanundefinedde {
  
  inline def apply(): checkedbooleanundefinedde = {
  ...
  implicit open class MutableBuilder[Self <: checkedbooleanundefinedde] (val x: Self) extends AnyVal {
    ...
    inline def setRefFunction1(value: /* instance */ CheckboxRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
