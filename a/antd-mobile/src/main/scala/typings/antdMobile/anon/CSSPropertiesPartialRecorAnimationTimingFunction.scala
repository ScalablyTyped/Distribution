...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--cell-size' | '--gap' | '--gap-vertical' | '--gap-horizontal', string>> */
trait CSSPropertiesPartialRecorAnimationTimingFunction extends StObject {
  
  var `--cell-size`: js.UndefOr[String] = js.undefined
  
  var `--gap`: js.UndefOr[String] = js.undefined
  
  var `--gap-horizontal`: js.UndefOr[String] = js.undefined
  
  var `--gap-vertical`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimationTimingFunction {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationTimingFunction = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAnimationTimingFunction] (val x: Self) extends AnyVal {
    ...
    inline def `set--cell-sizeUndefined`: Self = StObject.set(x, "--cell-size", js.undefined)
    
    inline def `set--gap`(value: String): Self = StObject.set(x, "--gap", value.asInstanceOf[js.Any])
    
    inline def `set--gap-horizontal`(value: String): Self = StObject.set(x, "--gap-horizontal", value.asInstanceOf[js.Any])
    
    inline def `set--gap-horizontalUndefined`: Self = StObject.set(x, "--gap-horizontal", js.undefined)
    
    inline def `set--gap-vertical`(value: String): Self = StObject.set(x, "--gap-vertical", value.asInstanceOf[js.Any])
    
    inline def `set--gap-verticalUndefined`: Self = StObject.set(x, "--gap-vertical", js.undefined)
    
    inline def `set--gapUndefined`: Self = StObject.set(x, "--gap", js.undefined)
