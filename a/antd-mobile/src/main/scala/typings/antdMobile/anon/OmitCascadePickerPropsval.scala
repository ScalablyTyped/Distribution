...
/* Inlined std.Omit<antd-mobile.antd-mobile/es/components/cascade-picker/cascade-picker.CascadePickerProps, 'value' | 'visible' | 'children'> */
trait OmitCascadePickerPropsval extends StObject {
...
object OmitCascadePickerPropsval {
  
  inline def apply(options: js.Array[CascadePickerOption]): OmitCascadePickerPropsval = {
