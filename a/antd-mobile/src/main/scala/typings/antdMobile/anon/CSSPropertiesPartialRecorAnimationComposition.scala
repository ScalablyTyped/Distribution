...
trait CSSPropertiesPartialRecorAnimationComposition extends StObject {
...
object CSSPropertiesPartialRecorAnimationComposition {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationComposition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAnimationComposition]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAnimationComposition] (val x: Self) extends AnyVal {
