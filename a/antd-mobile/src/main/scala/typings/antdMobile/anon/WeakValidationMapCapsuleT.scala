...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/capsule-tabs/capsule-tabs.CapsuleTabsProps> */
trait WeakValidationMapCapsuleT extends StObject {
...
object WeakValidationMapCapsuleT {
  
  inline def apply(): WeakValidationMapCapsuleT = {
