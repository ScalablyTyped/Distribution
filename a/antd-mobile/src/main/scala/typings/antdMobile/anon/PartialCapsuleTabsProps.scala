...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/capsule-tabs/capsule-tabs.CapsuleTabsProps> */
trait PartialCapsuleTabsProps extends StObject {
...
object PartialCapsuleTabsProps {
  
  inline def apply(): PartialCapsuleTabsProps = {
