...
trait OnAction extends StObject {
  ...
  var action: typings.antdMobile.modalActionButtonMod.Action
  
  def onAction(): Unit | js.Promise[Unit]
}
object OnAction {
  
  inline def apply(action: typings.antdMobile.modalActionButtonMod.Action, onAction: () => Unit | js.Promise[Unit]): OnAction = {
  ...
  extension [Self <: OnAction](x: Self) {
    ...
    inline def setAction(value: typings.antdMobile.modalActionButtonMod.Action): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
