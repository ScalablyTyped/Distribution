...
trait PartialHTMLPropsHTMLDivEl extends StObject {
...
object PartialHTMLPropsHTMLDivEl {
  ...
  @scala.inline
  implicit class PartialHTMLPropsHTMLDivElMutableBuilder[Self <: PartialHTMLPropsHTMLDivEl] (val x: Self) extends AnyVal {
