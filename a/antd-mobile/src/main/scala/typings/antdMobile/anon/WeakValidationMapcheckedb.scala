...
trait WeakValidationMapcheckedb extends StObject {
  ...
  var icon: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[/* checked */ Boolean, /* indeterminate */ Boolean, ReactNode]) | Null
      ]
    ]
  ] = js.undefined
  ...
  var indeterminate: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[CheckboxRef]]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationComposition | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var value: js.UndefOr[Validator[js.UndefOr[CheckboxValue | Null]]] = js.undefined
}
object WeakValidationMapcheckedb {
  
  inline def apply(): WeakValidationMapcheckedb = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapcheckedb]
  }
  
  extension [Self <: WeakValidationMapcheckedb](x: Self) {
    ...
    inline def setIndeterminate(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "indeterminate", value.asInstanceOf[js.Any])
    ...
    inline def setRef(value: Validator[js.UndefOr[Null | Ref[CheckboxRef]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationComposition | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: Validator[js.UndefOr[CheckboxValue | Null]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
