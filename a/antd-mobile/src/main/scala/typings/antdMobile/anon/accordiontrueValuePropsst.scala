...
/* Inlined {  accordion :true} & antd-mobile.antd-mobile/es/components/collapse/collapse.ValueProps<string | null> & {  children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
trait accordiontrueValuePropsst
  extends StObject
     with CollapseProps {
  ...
  var arrow: js.UndefOr[ReactNode | (js.Function1[/* active */ Boolean, ReactNode])] = js.undefined
  ...
  var onChange: js.UndefOr[js.Function1[/* activeKey */ String | Null, Unit]] = js.undefined
  
  var style: js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
}
object accordiontrueValuePropsst {
  
  inline def apply(): accordiontrueValuePropsst = {
    val __obj = js.Dynamic.literal(accordion = true)
    __obj.asInstanceOf[accordiontrueValuePropsst]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: accordiontrueValuePropsst] (val x: Self) extends AnyVal {
    
    inline def setAccordion(value: `true`): Self = StObject.set(x, "accordion", value.asInstanceOf[js.Any])
    ...
    inline def setArrow(value: ReactNode | (js.Function1[/* active */ Boolean, ReactNode])): Self = StObject.set(x, "arrow", value.asInstanceOf[js.Any])
    
    inline def setArrowFunction1(value: /* active */ Boolean => ReactNode): Self = StObject.set(x, "arrow", js.Any.fromFunction1(value))
    ...
    inline def setOnChange(value: /* activeKey */ String | Null => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
