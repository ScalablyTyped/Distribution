...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height' | '--item-height' | '--item-font-size', string>> */
trait CSSPropertiesPartialRecorAlignItems_ extends StObject {
...
object CSSPropertiesPartialRecorAlignItems_ {
  
  inline def apply(): CSSPropertiesPartialRecorAlignItems_ = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAlignItems_]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAlignItems_] (val x: Self) extends AnyVal {
