...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--border-radius' | '--text-color' | '--background-color' | '--border-width' | '--border-style' | '--border-color', string>> */
trait CSSPropertiesPartialRecorAlignContent extends StObject {
  ...
  var `--text-color`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAlignContent {
  
  inline def apply(): CSSPropertiesPartialRecorAlignContent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAlignContent]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAlignContent] (val x: Self) extends AnyVal {
    
    inline def `set--background-color`(value: String): Self = StObject.set(x, "--background-color", value.asInstanceOf[js.Any])
    
    inline def `set--background-colorUndefined`: Self = StObject.set(x, "--background-color", js.undefined)
    
    inline def `set--border-color`(value: String): Self = StObject.set(x, "--border-color", value.asInstanceOf[js.Any])
    
    inline def `set--border-colorUndefined`: Self = StObject.set(x, "--border-color", js.undefined)
    
    inline def `set--border-radius`(value: String): Self = StObject.set(x, "--border-radius", value.asInstanceOf[js.Any])
    
    inline def `set--border-radiusUndefined`: Self = StObject.set(x, "--border-radius", js.undefined)
    
    inline def `set--border-style`(value: String): Self = StObject.set(x, "--border-style", value.asInstanceOf[js.Any])
    
    inline def `set--border-styleUndefined`: Self = StObject.set(x, "--border-style", js.undefined)
    
    inline def `set--border-width`(value: String): Self = StObject.set(x, "--border-width", value.asInstanceOf[js.Any])
    
    inline def `set--border-widthUndefined`: Self = StObject.set(x, "--border-width", js.undefined)
    
    inline def `set--text-color`(value: String): Self = StObject.set(x, "--text-color", value.asInstanceOf[js.Any])
    
    inline def `set--text-colorUndefined`: Self = StObject.set(x, "--text-color", js.undefined)
