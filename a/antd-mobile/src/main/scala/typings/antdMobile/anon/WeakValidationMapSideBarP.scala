...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/side-bar/side-bar.SideBarProps> */
trait WeakValidationMapSideBarP extends StObject {
  ...
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundOrigin | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapSideBarP {
  
  inline def apply(): WeakValidationMapSideBarP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapSideBarP]
  }
  
  extension [Self <: WeakValidationMapSideBarP](x: Self) {
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorBackgroundOrigin | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
