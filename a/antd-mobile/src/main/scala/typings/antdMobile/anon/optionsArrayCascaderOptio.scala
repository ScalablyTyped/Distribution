...
trait optionsArrayCascaderOptio extends StObject {
...
object optionsArrayCascaderOptio {
  
  inline def apply(options: js.Array[CascaderOption]): optionsArrayCascaderOptio = {
  ...
  extension [Self <: optionsArrayCascaderOptio](x: Self) {
    ...
    inline def setRefFunction1(value: /* instance */ CascaderActions | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
