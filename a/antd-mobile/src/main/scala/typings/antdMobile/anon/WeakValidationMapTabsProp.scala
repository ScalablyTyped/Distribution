...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/tabs/tabs.TabsProps> */
trait WeakValidationMapTabsProp extends StObject {
  
  var activeKey: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  
  var activeLineMode: js.UndefOr[Validator[js.UndefOr[auto | full | fixed | Null]]] = js.undefined
  ...
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* key */ String, Unit]) | Null]]] = js.undefined
  
  var stretch: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorActivelineborderradius | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapTabsProp {
  
  inline def apply(): WeakValidationMapTabsProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapTabsProp]
  }
  
  extension [Self <: WeakValidationMapTabsProp](x: Self) {
    ...
    inline def setActiveLineMode(value: Validator[js.UndefOr[auto | full | fixed | Null]]): Self = StObject.set(x, "activeLineMode", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultActiveKey(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "defaultActiveKey", value.asInstanceOf[js.Any])
    
    inline def setDefaultActiveKeyUndefined: Self = StObject.set(x, "defaultActiveKey", js.undefined)
    
    inline def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* key */ String, Unit]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setStretch(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "stretch", value.asInstanceOf[js.Any])
    
    inline def setStretchUndefined: Self = StObject.set(x, "stretch", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorActivelineborderradius | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
