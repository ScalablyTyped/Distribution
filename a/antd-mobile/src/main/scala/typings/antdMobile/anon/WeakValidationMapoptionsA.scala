...
trait WeakValidationMapoptionsA extends StObject {
  ...
  var confirmText: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var defaultValue: js.UndefOr[Validator[js.UndefOr[js.Array[String] | Null]]] = js.undefined
  ...
  var onCancel: js.UndefOr[Validator[js.UndefOr[js.Function0[Unit] | Null]]] = js.undefined
  
  var onClick: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function1[/* event */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent], Unit]) | Null
      ]
    ]
  ] = js.undefined
  ...
  var onConfirm: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[/* value */ js.Array[String], /* extend */ CascaderValueExtend, Unit]) | Null
      ]
    ]
  ] = js.undefined
  ...
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[CascaderActions]]]] = js.undefined
  ...
  var value: js.UndefOr[Validator[js.UndefOr[js.Array[String] | Null]]] = js.undefined
...
object WeakValidationMapoptionsA {
  ...
  extension [Self <: WeakValidationMapoptionsA](x: Self) {
    ...
    inline def setConfirmText(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "confirmText", value.asInstanceOf[js.Any])
    
    inline def setConfirmTextUndefined: Self = StObject.set(x, "confirmText", js.undefined)
    
    inline def setDefaultValue(value: Validator[js.UndefOr[js.Array[String] | Null]]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def setOnCancel(value: Validator[js.UndefOr[js.Function0[Unit] | Null]]): Self = StObject.set(x, "onCancel", value.asInstanceOf[js.Any])
    ...
    inline def setRef(value: Validator[js.UndefOr[Null | Ref[CascaderActions]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: Validator[js.UndefOr[js.Array[String] | Null]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
