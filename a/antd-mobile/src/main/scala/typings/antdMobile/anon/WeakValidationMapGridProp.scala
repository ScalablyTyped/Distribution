...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/grid/grid.GridProps> */
trait WeakValidationMapGridProp extends StObject {
  ...
  var columns: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var gap: js.UndefOr[
    Validator[
      js.UndefOr[Double | Null | String | (js.Tuple2[Double | String, Double | String])]
    ]
  ] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationTimeline | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapGridProp {
  
  inline def apply(): WeakValidationMapGridProp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapGridProp]
  }
  
  extension [Self <: WeakValidationMapGridProp](x: Self) {
    ...
    inline def setColumns(value: Validator[js.UndefOr[Double | Null]]): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationTimeline | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
