...
trait PartialdefaultIndexnumber extends StObject {
  ...
  var indicatorProps: js.UndefOr[PickPageIndicatorPropssty] = js.undefined
  ...
  var style: js.UndefOr[CSSPropertiesPartialRecorBaselineShift] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
  
  var trackOffset: js.UndefOr[Double] = js.undefined
}
object PartialdefaultIndexnumber {
  
  inline def apply(): PartialdefaultIndexnumber = {
  ...
  implicit open class MutableBuilder[Self <: PartialdefaultIndexnumber] (val x: Self) extends AnyVal {
    ...
    inline def setIndicatorProps(value: PickPageIndicatorPropssty): Self = StObject.set(x, "indicatorProps", value.asInstanceOf[js.Any])
    ...
    inline def setRef(value: Ref[SwiperRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ SwiperRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
    ...
    inline def setStyle(value: CSSPropertiesPartialRecorBaselineShift): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
