...
object activeKeystringnullundefi {
  
  inline def apply(): activeKeystringnullundefi = {
  ...
  extension [Self <: activeKeystringnullundefi](x: Self) {
    ...
    inline def setRefFunction1(value: /* instance */ DropdownRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
