...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/cascader-view/cascader-view.CascaderViewProps> */
trait WeakValidationMapCascader extends StObject {
  
  var activeIcon: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  ...
  var defaultValue: js.UndefOr[Validator[js.UndefOr[js.Array[CascaderValue] | Null]]] = js.undefined
  
  var onChange: js.UndefOr[
    Validator[
      js.UndefOr[
        (js.Function2[/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend, Unit]) | Null
      ]
    ]
  ] = js.undefined
  
  var onTabsChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* index */ Double, Unit]) | Null]]] = js.undefined
  
  var options: js.UndefOr[Validator[js.UndefOr[js.Array[CascaderOption] | Null]]] = js.undefined
  
  var placeholder: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAlignTracks | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var value: js.UndefOr[Validator[js.UndefOr[js.Array[CascaderValue] | Null]]] = js.undefined
}
object WeakValidationMapCascader {
  
  inline def apply(): WeakValidationMapCascader = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapCascader]
  }
  
  extension [Self <: WeakValidationMapCascader](x: Self) {
    
    inline def setActiveIcon(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "activeIcon", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultValue(value: Validator[js.UndefOr[js.Array[CascaderValue] | Null]]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def setOnTabsChange(value: Validator[js.UndefOr[(js.Function1[/* index */ Double, Unit]) | Null]]): Self = StObject.set(x, "onTabsChange", value.asInstanceOf[js.Any])
    
    inline def setOnTabsChangeUndefined: Self = StObject.set(x, "onTabsChange", js.undefined)
    
    inline def setOptions(value: Validator[js.UndefOr[js.Array[CascaderOption] | Null]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAlignTracks | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: Validator[js.UndefOr[js.Array[CascaderValue] | Null]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
