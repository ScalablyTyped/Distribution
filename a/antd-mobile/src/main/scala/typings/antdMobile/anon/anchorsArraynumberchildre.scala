...
/* Inlined {  anchors :std.Array<number>,   children :react.react.ReactNode,   onHeightChange :(height : number, animating : boolean): void | undefined,   handleDraggingOfContent :boolean | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<'--z-index' | '--border-radius' | '--header-height', string>> | undefined,   tabIndex :number | undefined} & react.react.AriaAttributes & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/floating-panel/floating-panel.FloatingPanelRef> */
trait anchorsArraynumberchildre extends StObject {
...
object anchorsArraynumberchildre {
  
  inline def apply(anchors: js.Array[Double]): anchorsArraynumberchildre = {
  ...
  implicit open class MutableBuilder[Self <: anchorsArraynumberchildre] (val x: Self) extends AnyVal {
    ...
    inline def setRef(value: Ref[FloatingPanelRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: /* instance */ FloatingPanelRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
