...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--background', string>> */
trait CSSPropertiesPartialRecorBackgroundSize extends StObject {
...
object CSSPropertiesPartialRecorBackgroundSize {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundSize = {
