...
trait WeakValidationMapTreeSele extends StObject {
  ...
  var fieldNames: js.UndefOr[Validator[js.UndefOr[Label | Null]]] = js.undefined
  
  var onChange: js.UndefOr[
    Validator[
      js.UndefOr[(js.Function2[/* value */ js.Array[String], /* extend */ Options, Unit]) | Null]
    ]
  ] = js.undefined
  
  var options: js.UndefOr[Validator[js.UndefOr[js.Array[TreeSelectOption] | Null]]] = js.undefined
...
object WeakValidationMapTreeSele {
  ...
  extension [Self <: WeakValidationMapTreeSele](x: Self) {
    ...
    inline def setFieldNames(value: Validator[js.UndefOr[Label | Null]]): Self = StObject.set(x, "fieldNames", value.asInstanceOf[js.Any])
    ...
    inline def setOptions(value: Validator[js.UndefOr[js.Array[TreeSelectOption] | Null]]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
