...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--sticky-offset-top', string>> */
trait CSSPropertiesPartialRecorAspectRatio extends StObject {
  
  var `--sticky-offset-top`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAspectRatio {
  
  inline def apply(): CSSPropertiesPartialRecorAspectRatio = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAspectRatio] (val x: Self) extends AnyVal {
    ...
    inline def `set--sticky-offset-topUndefined`: Self = StObject.set(x, "--sticky-offset-top", js.undefined)
