...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height' | '--border-radius' | '--padding-left' | '--background' | '--placeholder-color', string>> */
trait CSSPropertiesPartialRecorBackgroundColor_ extends StObject {
...
object CSSPropertiesPartialRecorBackgroundColor_ {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundColor_ = {
