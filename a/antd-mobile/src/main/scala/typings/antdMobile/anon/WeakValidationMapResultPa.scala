...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/result-page/result-page.ResultPageProps> */
trait WeakValidationMapResultPa extends StObject {
  ...
  var details: js.UndefOr[Validator[js.UndefOr[Null | ResultPageDetails]]] = js.undefined
  
  var icon: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var onPrimaryButtonClick: js.UndefOr[Validator[js.UndefOr[Null | OnClick]]] = js.undefined
  
  var onSecondaryButtonClick: js.UndefOr[Validator[js.UndefOr[Null | OnClick]]] = js.undefined
  
  var primaryButtonText: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var secondaryButtonText: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var status: js.UndefOr[Validator[js.UndefOr[success | error | info | waiting | warning | Null]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationIterationCount | Null]]] = js.undefined
...
object WeakValidationMapResultPa {
  
  inline def apply(): WeakValidationMapResultPa = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapResultPa]
  }
  
  extension [Self <: WeakValidationMapResultPa](x: Self) {
    ...
    inline def setDescription(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "description", value.asInstanceOf[js.Any])
    
    inline def setDescriptionUndefined: Self = StObject.set(x, "description", js.undefined)
    
    inline def setDetails(value: Validator[js.UndefOr[Null | ResultPageDetails]]): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
    
    inline def setDetailsUndefined: Self = StObject.set(x, "details", js.undefined)
    
    inline def setIcon(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
    
    inline def setIconUndefined: Self = StObject.set(x, "icon", js.undefined)
    
    inline def setOnPrimaryButtonClick(value: Validator[js.UndefOr[Null | OnClick]]): Self = StObject.set(x, "onPrimaryButtonClick", value.asInstanceOf[js.Any])
    
    inline def setOnPrimaryButtonClickUndefined: Self = StObject.set(x, "onPrimaryButtonClick", js.undefined)
    
    inline def setOnSecondaryButtonClick(value: Validator[js.UndefOr[Null | OnClick]]): Self = StObject.set(x, "onSecondaryButtonClick", value.asInstanceOf[js.Any])
    
    inline def setOnSecondaryButtonClickUndefined: Self = StObject.set(x, "onSecondaryButtonClick", js.undefined)
    
    inline def setPrimaryButtonText(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "primaryButtonText", value.asInstanceOf[js.Any])
    
    inline def setPrimaryButtonTextUndefined: Self = StObject.set(x, "primaryButtonText", js.undefined)
    
    inline def setSecondaryButtonText(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "secondaryButtonText", value.asInstanceOf[js.Any])
    
    inline def setSecondaryButtonTextUndefined: Self = StObject.set(x, "secondaryButtonText", js.undefined)
    
    inline def setStatus(value: Validator[js.UndefOr[success | error | info | waiting | warning | Null]]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
    
    inline def setStatusUndefined: Self = StObject.set(x, "status", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAnimationIterationCount | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
