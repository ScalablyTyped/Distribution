...
/* Inlined std.Omit<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'columns'> & {  options :std.Array<antd-mobile.antd-mobile/es/components/cascade-picker/cascade-picker.CascadePickerOption>} & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/picker.PickerActions> */
trait OmitPickerPropscolumnsopt extends StObject {
...
object OmitPickerPropscolumnsopt {
  
  inline def apply(options: js.Array[CascadePickerOption]): OmitPickerPropscolumnsopt = {
