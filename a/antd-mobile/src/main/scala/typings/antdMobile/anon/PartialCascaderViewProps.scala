...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/cascader-view/cascader-view.CascaderViewProps> */
trait PartialCascaderViewProps extends StObject {
...
object PartialCascaderViewProps {
  
  inline def apply(): PartialCascaderViewProps = {
  ...
  implicit open class MutableBuilder[Self <: PartialCascaderViewProps] (val x: Self) extends AnyVal {
    ...
    inline def setOnChange(value: (/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
