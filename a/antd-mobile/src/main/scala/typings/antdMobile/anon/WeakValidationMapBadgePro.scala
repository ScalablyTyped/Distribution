...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/badge/badge.BadgeProps> */
trait WeakValidationMapBadgePro extends StObject {
  ...
  var content: js.UndefOr[Validator[js.UndefOr[Element | Null | ReactNode]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAccentColor | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var wrapperClassName: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  
  var wrapperStyle: js.UndefOr[Validator[js.UndefOr[CSSProperties | Null]]] = js.undefined
}
object WeakValidationMapBadgePro {
  
  inline def apply(): WeakValidationMapBadgePro = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapBadgePro]
  }
  
  extension [Self <: WeakValidationMapBadgePro](x: Self) {
    ...
    inline def setBordered(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "bordered", value.asInstanceOf[js.Any])
    ...
    inline def setContent(value: Validator[js.UndefOr[Element | Null | ReactNode]]): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    
    inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAccentColor | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setWrapperClassName(value: Validator[js.UndefOr[Null | String]]): Self = StObject.set(x, "wrapperClassName", value.asInstanceOf[js.Any])
    
    inline def setWrapperClassNameUndefined: Self = StObject.set(x, "wrapperClassName", js.undefined)
    
    inline def setWrapperStyle(value: Validator[js.UndefOr[CSSProperties | Null]]): Self = StObject.set(x, "wrapperStyle", value.asInstanceOf[js.Any])
