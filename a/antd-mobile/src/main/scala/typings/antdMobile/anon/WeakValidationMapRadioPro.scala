...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/radio/radio.RadioProps> */
trait WeakValidationMapRadioPro extends StObject {
  ...
  var block: js.UndefOr[Validator[js.UndefOr[Boolean | Null]]] = js.undefined
  ...
  var icon: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* checked */ Boolean, ReactNode]) | Null]]] = js.undefined
  
  var id: js.UndefOr[Validator[js.UndefOr[Null | String]]] = js.undefined
  
  var onChange: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* checked */ Boolean, Unit]) | Null]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAnimation | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
  
  var value: js.UndefOr[Validator[js.UndefOr[Null | RadioValue]]] = js.undefined
}
object WeakValidationMapRadioPro {
  
  inline def apply(): WeakValidationMapRadioPro = {
  ...
  extension [Self <: WeakValidationMapRadioPro](x: Self) {
    ...
    inline def setBlock(value: Validator[js.UndefOr[Boolean | Null]]): Self = StObject.set(x, "block", value.asInstanceOf[js.Any])
    ...
    inline def setIcon(value: Validator[js.UndefOr[(js.Function1[/* checked */ Boolean, ReactNode]) | Null]]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: Validator[js.UndefOr[(js.Function1[/* checked */ Boolean, Unit]) | Null]]): Self = StObject.set(x, "onChange", value.asInstanceOf[js.Any])
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAnimation | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setValue(value: Validator[js.UndefOr[Null | RadioValue]]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
