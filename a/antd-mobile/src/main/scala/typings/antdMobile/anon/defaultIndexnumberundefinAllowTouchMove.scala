...
trait defaultIndexnumberundefinAllowTouchMove extends StObject {
  ...
  var indicatorProps: js.UndefOr[PickPageIndicatorPropsstyClassName] = js.undefined
...
object defaultIndexnumberundefinAllowTouchMove {
  
  inline def apply(): defaultIndexnumberundefinAllowTouchMove = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[defaultIndexnumberundefinAllowTouchMove]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: defaultIndexnumberundefinAllowTouchMove] (val x: Self) extends AnyVal {
    ...
    inline def setIndicatorProps(value: PickPageIndicatorPropsstyClassName): Self = StObject.set(x, "indicatorProps", value.asInstanceOf[js.Any])
