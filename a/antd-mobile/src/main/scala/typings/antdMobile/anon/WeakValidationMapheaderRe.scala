...
trait WeakValidationMapheaderRe extends StObject {
  ...
  var header: js.UndefOr[Validator[js.UndefOr[Null | ReactNode]]] = js.undefined
  
  var key: js.UndefOr[Validator[js.UndefOr[Key | Null]]] = js.undefined
  
  var mode: js.UndefOr[Validator[js.UndefOr[default | card | Null]]] = js.undefined
  
  var ref: js.UndefOr[Validator[js.UndefOr[Null | Ref[ListRef]]]] = js.undefined
  
  var style: js.UndefOr[Validator[js.UndefOr[CSSPropertiesPartialRecorAlignitems | Null]]] = js.undefined
  
  var tabIndex: js.UndefOr[Validator[js.UndefOr[Double | Null]]] = js.undefined
}
object WeakValidationMapheaderRe {
  
  inline def apply(): WeakValidationMapheaderRe = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[WeakValidationMapheaderRe]
  }
  
  extension [Self <: WeakValidationMapheaderRe](x: Self) {
    ...
    inline def setHeader(value: Validator[js.UndefOr[Null | ReactNode]]): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
    ...
    inline def setMode(value: Validator[js.UndefOr[default | card | Null]]): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
    
    inline def setModeUndefined: Self = StObject.set(x, "mode", js.undefined)
    
    inline def setRef(value: Validator[js.UndefOr[Null | Ref[ListRef]]]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setStyle(value: Validator[js.UndefOr[CSSPropertiesPartialRecorAlignitems | Null]]): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
