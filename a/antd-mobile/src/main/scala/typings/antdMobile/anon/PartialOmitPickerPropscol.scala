...
import typings.antdMobile.esComponentsCascadePickerCascadePickerMod.CascadePickerOption
...
/* Inlined std.Partial<std.Omit<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'columns'> & {  options :std.Array<antd-mobile.antd-mobile/es/components/cascade-picker/cascade-picker.CascadePickerOption>} & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/picker.PickerActions>> */
trait PartialOmitPickerPropscol extends StObject {
  ...
  var options: js.UndefOr[js.Array[CascadePickerOption]] = js.undefined
...
object PartialOmitPickerPropscol {
  
  inline def apply(): PartialOmitPickerPropscol = {
