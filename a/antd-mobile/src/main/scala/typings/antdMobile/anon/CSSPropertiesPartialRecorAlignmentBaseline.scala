...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--z-index', string>> */
trait CSSPropertiesPartialRecorAlignmentBaseline extends StObject {
...
object CSSPropertiesPartialRecorAlignmentBaseline {
  
  inline def apply(): CSSPropertiesPartialRecorAlignmentBaseline = {
