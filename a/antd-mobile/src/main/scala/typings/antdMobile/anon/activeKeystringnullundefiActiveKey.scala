...
trait activeKeystringnullundefiActiveKey extends StObject {
...
object activeKeystringnullundefiActiveKey {
  
  inline def apply(): activeKeystringnullundefiActiveKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[activeKeystringnullundefiActiveKey]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: activeKeystringnullundefiActiveKey] (val x: Self) extends AnyVal {
