...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--color' | '--size', string>> */
trait CSSPropertiesPartialRecorBackgroundPositionY extends StObject {
...
object CSSPropertiesPartialRecorBackgroundPositionY {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundPositionY = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackgroundPositionY]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorBackgroundPositionY] (val x: Self) extends AnyVal {
