...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--z-index' | '--border-radius' | '--header-height', string>> */
...
object CSSPropertiesPartialRecorAnimationDuration {
  ...
  extension [Self <: CSSPropertiesPartialRecorAnimationDuration](x: Self) {
