...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--border-radius' | '--z-index' | '--header-height', string>> */
trait CSSPropertiesPartialRecorAnimationDuration extends StObject {
  
  var `--border-radius`: js.UndefOr[String] = js.undefined
  
  var `--header-height`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimationDuration {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationDuration = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAnimationDuration]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorAnimationDuration] (val x: Self) extends AnyVal {
    ...
    inline def `set--header-height`(value: String): Self = StObject.set(x, "--header-height", value.asInstanceOf[js.Any])
    
    inline def `set--header-heightUndefined`: Self = StObject.set(x, "--header-height", js.undefined)
    
    inline def `set--z-index`(value: String): Self = StObject.set(x, "--z-index", value.asInstanceOf[js.Any])
    
    inline def `set--z-indexUndefined`: Self = StObject.set(x, "--z-index", js.undefined)
