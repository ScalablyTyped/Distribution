...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--border-radius' | '--border-color' | '--cell-size' | '--dot-size' | '--cell-gap', string>> */
trait CSSPropertiesPartialRecorBackgroundAttachment extends StObject {
  
  var `--border-color`: js.UndefOr[String] = js.undefined
  
  var `--border-radius`: js.UndefOr[String] = js.undefined
  
  var `--cell-gap`: js.UndefOr[String] = js.undefined
  
  var `--cell-size`: js.UndefOr[String] = js.undefined
  
  var `--dot-size`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundAttachment {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundAttachment = {
  ...
  implicit open class MutableBuilder[Self <: CSSPropertiesPartialRecorBackgroundAttachment] (val x: Self) extends AnyVal {
    ...
    inline def `set--cell-gap`(value: String): Self = StObject.set(x, "--cell-gap", value.asInstanceOf[js.Any])
    
    inline def `set--cell-gapUndefined`: Self = StObject.set(x, "--cell-gap", js.undefined)
    ...
    inline def `set--dot-size`(value: String): Self = StObject.set(x, "--dot-size", value.asInstanceOf[js.Any])
    
    inline def `set--dot-sizeUndefined`: Self = StObject.set(x, "--dot-size", js.undefined)
