...
import typings.antdMobile.antdMobileStrings.mini
...
import typings.antdMobile.antdMobileStrings.rectangular
import typings.antdMobile.antdMobileStrings.removals
import typings.antdMobile.antdMobileStrings.reset
import typings.antdMobile.antdMobileStrings.rounded
...
import typings.antdMobile.antdMobileStrings.submit
...
object colordefaultprimarysucces {
  ...
  extension [Self <: colordefaultprimarysucces](x: Self) {
    ...
    inline def setRefFunction1(value: /* instance */ ButtonRef | Null => Unit): Self = StObject.set(x, "ref", js.Any.fromFunction1(value))
