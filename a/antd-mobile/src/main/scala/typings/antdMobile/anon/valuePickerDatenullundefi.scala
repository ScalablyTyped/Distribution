...
object valuePickerDatenullundefi {
  
  inline def apply(): valuePickerDatenullundefi = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[valuePickerDatenullundefi]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: valuePickerDatenullundefi] (val x: Self) extends AnyVal {
