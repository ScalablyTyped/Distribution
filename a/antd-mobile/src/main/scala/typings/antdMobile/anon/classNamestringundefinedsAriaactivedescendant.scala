...
trait classNamestringundefinedsAriaactivedescendant extends StObject {
...
object classNamestringundefinedsAriaactivedescendant {
  
  inline def apply(): classNamestringundefinedsAriaactivedescendant = {
  ...
  extension [Self <: classNamestringundefinedsAriaactivedescendant](x: Self) {
    ...
    inline def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[Any]) => Element | ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
