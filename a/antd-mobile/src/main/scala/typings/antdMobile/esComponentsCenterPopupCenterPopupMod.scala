...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAll
...
object esComponentsCenterPopupCenterPopupMod {
  
  @JSImport("antd-mobile/es/components/center-popup/center-popup", "CenterPopup")
  @js.native
  val CenterPopup: FC[CenterPopupProps] = js.native
  
  /* Inlined antd-mobile.antd-mobile/es/components/popup/popup-base-props.PopupBaseProps & react.react.PropsWithChildren<{  role :string | undefined}> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--background-color' | '--border-radius' | '--max-width' | '--min-width' | '--z-index'> */
  trait CenterPopupProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorAll] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var visible: js.UndefOr[Boolean] = js.undefined
  }
  object CenterPopupProps {
    
    inline def apply(): CenterPopupProps = {
    ...
    implicit open class MutableBuilder[Self <: CenterPopupProps] (val x: Self) extends AnyVal {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAll): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
