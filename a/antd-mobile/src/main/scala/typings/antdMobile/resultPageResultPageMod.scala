...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAnimationIterationCount
...
import typings.antdMobile.antdMobileStrings.error
...
import typings.antdMobile.antdMobileStrings.info
...
object resultPageResultPageMod {
  
  @JSImport("antd-mobile/es/components/result-page/result-page", "ResultPage")
  @js.native
  val ResultPage: FC[ResultPageProps] = js.native
  
  type OnClick = js.Function1[
    /* event */ typings.react.mod.MouseEvent[HTMLButtonElement, MouseEvent], 
    Unit | js.Promise[Unit] | Any
  ]
  
  trait ResultPageDetail extends StObject {
  ...
  object ResultPageDetail {
    
    inline def apply(): ResultPageDetail = {
  ...
  type ResultPageDetails = js.Array[ResultPageDetail]
  
  /* Inlined {  status :'success' | 'error' | 'info' | 'waiting' | 'warning' | undefined,   title :react.react.ReactNode,   description :react.react.ReactNode | undefined,   icon :react.react.ReactNode | undefined,   details :antd-mobile.antd-mobile/es/components/result-page/result-page.ResultPageDetails | undefined,   children :react.react.ReactNode | undefined,   primaryButtonText :react.react.ReactNode | undefined,   secondaryButtonText :react.react.ReactNode | undefined,   onPrimaryButtonClick :antd-mobile.antd-mobile/es/components/result-page/result-page.OnClick | undefined,   onSecondaryButtonClick :antd-mobile.antd-mobile/es/components/result-page/result-page.OnClick | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--background-color'> */
  trait ResultPageProps extends StObject {
  ...
  object ResultPageProps {
    
    inline def apply(): ResultPageProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: ResultPageProps](x: Self) {
      ...
      inline def setOnPrimaryButtonClick(
        value: /* event */ typings.react.mod.MouseEvent[HTMLButtonElement, MouseEvent] => Unit | js.Promise[Unit] | Any
      ): Self = StObject.set(x, "onPrimaryButtonClick", js.Any.fromFunction1(value))
      
      inline def setOnPrimaryButtonClickUndefined: Self = StObject.set(x, "onPrimaryButtonClick", js.undefined)
      
      inline def setOnSecondaryButtonClick(
        value: /* event */ typings.react.mod.MouseEvent[HTMLButtonElement, MouseEvent] => Unit | js.Promise[Unit] | Any
      ): Self = StObject.set(x, "onSecondaryButtonClick", js.Any.fromFunction1(value))
