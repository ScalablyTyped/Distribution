...
object esComponentsEllipsisEllipsisMod {
  
  @JSImport("antd-mobile/es/components/ellipsis/ellipsis", "Ellipsis")
  @js.native
  ...
  trait EllipsisProps extends StObject {
    ...
    var collapseText: js.UndefOr[String] = js.undefined
    ...
    var onContentClick: js.UndefOr[
        js.Function1[/* e */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent], Unit]
      ] = js.undefined
    
    var rows: js.UndefOr[Double] = js.undefined
    
    var stopPropagationForActionButtons: js.UndefOr[js.Array[PropagationEvent]] = js.undefined
  ...
  object EllipsisProps {
    ...
    inline def apply(content: String): EllipsisProps = {
    ...
    implicit open class MutableBuilder[Self <: EllipsisProps] (val x: Self) extends AnyVal {
      ...
      inline def setCollapseText(value: String): Self = StObject.set(x, "collapseText", value.asInstanceOf[js.Any])
      ...
      inline def setOnContentClick(value: /* e */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent] => Unit): Self = StObject.set(x, "onContentClick", js.Any.fromFunction1(value))
      ...
      inline def setStopPropagationForActionButtons(value: js.Array[PropagationEvent]): Self = StObject.set(x, "stopPropagationForActionButtons", value.asInstanceOf[js.Any])
      
      inline def setStopPropagationForActionButtonsUndefined: Self = StObject.set(x, "stopPropagationForActionButtons", js.undefined)
      
      inline def setStopPropagationForActionButtonsVarargs(value: PropagationEvent*): Self = StObject.set(x, "stopPropagationForActionButtons", js.Array(value*))
