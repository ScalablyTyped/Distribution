...
import typings.antdMobile.anon.CSSPropertiesPartialRecorActivecolor
...
object esComponentsRateRateMod {
  
  @JSImport("antd-mobile/es/components/rate/rate", "Rate")
  @js.native
  val Rate: FC[RateProps] = js.native
  
  /* Inlined {  allowClear :boolean | undefined,   allowHalf :boolean | undefined,   character :react.react.ReactNode | undefined,   count :number | undefined,   defaultValue :number | undefined,   readOnly :boolean | undefined,   value :number | undefined,   onChange :(value : number): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--star-size' | '--active-color' | '--inactive-color'> */
  trait RateProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorActivecolor] = js.undefined
  ...
  object RateProps {
    ...
    extension [Self <: RateProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorActivecolor): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
