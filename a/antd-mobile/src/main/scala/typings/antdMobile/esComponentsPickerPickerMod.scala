...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAlignSelf
...
object esComponentsPickerPickerMod {
  
  @JSImport("antd-mobile/es/components/picker/picker", "Picker")
  @js.native
  val Picker: MemoExoticComponent[ForwardRefExoticComponent[columnsArrayPickerColumnv]] = js.native
  
  trait PickerActions extends StObject {
  ...
  object PickerActions {
    ...
    inline def apply(close: () => Unit, open: () => Unit, toggle: () => Unit): PickerActions = {
  ...
  /* Inlined {  columns :std.Array<antd-mobile.antd-mobile/es/components/picker.PickerColumn> | (value : std.Array<antd-mobile.antd-mobile/es/components/picker.PickerValue>): std.Array<antd-mobile.antd-mobile/es/components/picker.PickerColumn>,   value :std.Array<antd-mobile.antd-mobile/es/components/picker.PickerValue> | undefined,   defaultValue :std.Array<antd-mobile.antd-mobile/es/components/picker.PickerValue> | undefined,   loading :boolean | undefined,   loadingContent :react.react.ReactNode | undefined,   onSelect :(value : std.Array<antd-mobile.antd-mobile/es/components/picker.PickerValue>, extend : antd-mobile.antd-mobile/es/components/picker.PickerValueExtend): void | undefined,   onConfirm :(value : std.Array<antd-mobile.antd-mobile/es/components/picker.PickerValue>, extend : antd-mobile.antd-mobile/es/components/picker.PickerValueExtend): void | undefined,   onCancel :(): void | undefined,   onClose :(): void | undefined,   closeOnMaskClick :boolean | undefined,   visible :boolean | undefined,   title :react.react.ReactNode | undefined,   confirmText :react.react.ReactNode | undefined,   cancelText :react.react.ReactNode | undefined,   children :(items : std.Array<antd-mobile.antd-mobile/es/components/picker.PickerColumnItem | null>, actions : antd-mobile.antd-mobile/es/components/picker/picker.PickerActions): react.react.ReactNode | undefined,   renderLabel :(item : antd-mobile.antd-mobile/es/components/picker.PickerColumnItem): react.react.ReactNode | undefined,   mouseWheel :boolean | undefined,   popupClassName :string | undefined,   popupStyle :react.react.CSSProperties | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/popup.PopupProps, 'getContainer' | 'afterShow' | 'afterClose' | 'onClick' | 'stopPropagation' | 'forceRender' | 'destroyOnClose'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--header-button-font-size' | '--title-font-size' | '--item-font-size' | '--item-height'> */
  trait PickerProps extends StObject {
    ...
    var children: js.UndefOr[
        js.Function2[
          /* items */ js.Array[PickerColumnItem | Null], 
  ...
  object PickerProps {
    ...
    extension [Self <: PickerProps](x: Self) {
      ...
      inline def setChildren(value: (/* items */ js.Array[PickerColumnItem | Null], /* actions */ PickerActions) => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
      ...
      inline def setLoadingContent(value: ReactNode): Self = StObject.set(x, "loadingContent", value.asInstanceOf[js.Any])
      ...
      inline def setOnConfirm(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Unit): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2(value))
      
      inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
      
      inline def setOnSelect(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Unit): Self = StObject.set(x, "onSelect", js.Any.fromFunction2(value))
      ...
      inline def setRenderLabel(value: /* item */ PickerColumnItem => ReactNode): Self = StObject.set(x, "renderLabel", js.Any.fromFunction1(value))
