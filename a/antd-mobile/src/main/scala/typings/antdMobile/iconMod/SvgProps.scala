...
/* Inlined antd-mobile.antd-mobile/lib/_util/types.Omit<react.react.HTMLProps<std.SVGSVGElement>, 'size' | 'type'> */
...
object SvgProps {
  ...
  def apply(
    ...
    onTimeUpdate: SyntheticEvent[SVGSVGElement, Event_] => Unit = null,
    onTouchCancel: TouchEvent[SVGSVGElement] => Unit = null,
    onTouchEnd: TouchEvent[SVGSVGElement] => Unit = null,
    onTouchMove: TouchEvent[SVGSVGElement] => Unit = null,
    onTouchStart: TouchEvent[SVGSVGElement] => Unit = null,
    onTransitionEnd: TransitionEvent[SVGSVGElement] => Unit = null,
    onVolumeChange: SyntheticEvent[SVGSVGElement, Event_] => Unit = null,
    onWaiting: SyntheticEvent[SVGSVGElement, Event_] => Unit = null,
    onWheel: WheelEvent[SVGSVGElement] => Unit = null,
