...
object showMod {
  ...
  @JSImport("antd-mobile/es/components/dialog/show", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("antd-mobile/es/components/dialog/show", "closeFnSet")
  @js.native
  val closeFnSet: Set[js.Function0[Unit]] = js.native
  
  inline def show(props: DialogShowProps): DialogShowHandler = ^.asInstanceOf[js.Dynamic].applyDynamic("show")(props.asInstanceOf[js.Any]).asInstanceOf[DialogShowHandler]
  
  trait DialogShowHandler extends StObject {
    
    def close(): Unit
  }
  object DialogShowHandler {
    
    inline def apply(close: () => Unit): DialogShowHandler = {
  ...
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/dialog/dialog.DialogProps, 'visible' | 'destroyOnClose' | 'forceRender'> */
  trait DialogShowProps extends StObject {
  ...
  object DialogShowProps {
    
    inline def apply(): DialogShowProps = {
