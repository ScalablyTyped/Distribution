...
import typings.antdMobile.esComponentsDialogDialogActionButtonMod.Action
...
object esComponentsDialogDialogMod {
  
  @JSImport("antd-mobile/es/components/dialog/dialog", "Dialog")
  @js.native
  val Dialog: FC[DialogProps] = js.native
  
  /* Inlined std.Pick<antd-mobile.antd-mobile/es/components/center-popup.CenterPopupProps, 'afterClose' | 'afterShow' | 'bodyClassName' | 'bodyStyle' | 'destroyOnClose' | 'disableBodyScroll' | 'forceRender' | 'getContainer' | 'maskClassName' | 'maskStyle' | 'stopPropagation' | 'visible'> & {  image :string | undefined,   header :react.react.ReactNode | undefined,   title :react.react.ReactNode | undefined,   content :react.react.ReactNode | undefined,   actions :std.Array<antd-mobile.antd-mobile/es/components/dialog/dialog-action-button.Action | std.Array<antd-mobile.antd-mobile/es/components/dialog/dialog-action-button.Action>> | undefined,   onAction :(action : antd-mobile.antd-mobile/es/components/dialog/dialog-action-button.Action, index : number): void | std.Promise<void> | undefined,   onClose :(): void | undefined,   closeOnAction :boolean | undefined,   closeOnMaskClick :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait DialogProps extends StObject {
    
    var actions: js.UndefOr[js.Array[Action | js.Array[Action]]] = js.undefined
    ...
    var onAction: js.UndefOr[js.Function2[/* action */ Action, /* index */ Double, Unit | js.Promise[Unit]]] = js.undefined
  ...
  object DialogProps {
    ...
    extension [Self <: DialogProps](x: Self) {
      ...
      inline def setActionsVarargs(value: (Action | js.Array[Action])*): Self = StObject.set(x, "actions", js.Array(value*))
      ...
      inline def setOnAction(value: (/* action */ Action, /* index */ Double) => Unit | js.Promise[Unit]): Self = StObject.set(x, "onAction", js.Any.fromFunction2(value))
