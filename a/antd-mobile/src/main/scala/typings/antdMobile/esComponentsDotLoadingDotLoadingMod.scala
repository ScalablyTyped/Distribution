...
object esComponentsDotLoadingDotLoadingMod {
  
  @JSImport("antd-mobile/es/components/dot-loading/dot-loading", "DotLoading")
  @js.native
  val DotLoading: NamedExoticComponent[DotLoadingProps] = js.native
  
  /* Inlined {  color :'default' | 'primary' | 'white' | string & {} | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait DotLoadingProps extends StObject {
  ...
  object DotLoadingProps {
    
    inline def apply(): DotLoadingProps = {
