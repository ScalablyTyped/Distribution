...
import typings.antdMobile.antdMobileStrings.card
...
import typings.rcFieldForm.interfaceMod.RecursivePartial
...
import typings.rcFieldForm.interfaceMod.ValidateFields
...
object formFormMod {
  ...
  object FormInstance {
    ...
    inline def apply(
      ...
      getFieldsError: () => js.Array[FieldError],
    ...
    extension [Self <: FormInstance](x: Self) {
      ...
      inline def setGetFieldsError(value: () => js.Array[FieldError]): Self = StObject.set(x, "getFieldsError", js.Any.fromFunction0(value))
  ...
  trait FormProps extends StObject {
    ...
    var form: js.UndefOr[typings.rcFieldForm.interfaceMod.FormInstance[Any]] = js.undefined
  ...
  object FormProps {
    ...
    extension [Self <: FormProps](x: Self) {
      ...
      inline def setChildrenFunction2(
        value: (/* values */ Store, /* form */ typings.rcFieldForm.interfaceMod.FormInstance[Any]) => Element | ReactNode
      ...
      inline def setForm(value: typings.rcFieldForm.interfaceMod.FormInstance[Any]): Self = StObject.set(x, "form", value.asInstanceOf[js.Any])
      ...
      inline def setOnFinish(value: /* values */ Any => Unit): Self = StObject.set(x, "onFinish", js.Any.fromFunction1(value))
      
      inline def setOnFinishFailed(value: /* errorInfo */ ValidateErrorEntity[Any] => Unit): Self = StObject.set(x, "onFinishFailed", js.Any.fromFunction1(value))
      ...
      inline def setOnValuesChange(value: (/* changedValues */ Any, /* values */ Any) => Unit): Self = StObject.set(x, "onValuesChange", js.Any.fromFunction2(value))
