...
import typings.antdMobile.esComponentsTreeSelectMultipleMod.MultipleProps
import typings.antdMobile.esComponentsTreeSelectTreeSelectMod.TreeSelectProps
