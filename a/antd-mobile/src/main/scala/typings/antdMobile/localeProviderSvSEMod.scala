...
import typings.antdMobile.anon.ActivateText
import typings.antdMobile.anon.BackspaceLabel
import typings.antdMobile.anon.CancelText
import typings.antdMobile.anon.CancelTextOkText
import typings.antdMobile.anon.Day
import typings.antdMobile.anon.DismissText
import typings.antdMobile.anon.NextText
...
object localeProviderSvSEMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile/lib/locale-provider/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/locale-provider/sv_SE", "default.DatePicker")
    @js.native
