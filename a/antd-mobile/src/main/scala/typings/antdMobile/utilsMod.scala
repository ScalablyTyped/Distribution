...
object utilsMod {
  ...
  @JSImport("antd-mobile/es/components/form/utils", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def isSafeSetRefComponent(component: Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isSafeSetRefComponent")(component.asInstanceOf[js.Any]).asInstanceOf[Boolean]
