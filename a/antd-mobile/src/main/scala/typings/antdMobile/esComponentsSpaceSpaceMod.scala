...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAnimationTimeline
...
import typings.antdMobile.antdMobileStrings.evenly
...
object esComponentsSpaceSpaceMod {
  
  @JSImport("antd-mobile/es/components/space/space", "Space")
  @js.native
  val Space: FC[SpaceProps] = js.native
  
  /* Inlined {  direction :'horizontal' | 'vertical' | undefined,   align :'start' | 'end' | 'center' | 'baseline' | undefined,   justify :'start' | 'end' | 'center' | 'between' | 'around' | 'evenly' | 'stretch' | undefined,   wrap :boolean | undefined,   block :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--gap' | '--gap-vertical' | '--gap-horizontal'> */
  trait SpaceProps extends StObject {
    ...
    var justify: js.UndefOr[start | end | center | between | around | evenly | stretch] = js.undefined
    
    var onClick: js.UndefOr[
        js.Function1[/* event */ typings.react.mod.MouseEvent[HTMLDivElement, MouseEvent], Unit]
      ] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAnimationTimeline] = js.undefined
  ...
  object SpaceProps {
    ...
    implicit open class MutableBuilder[Self <: SpaceProps] (val x: Self) extends AnyVal {
      ...
      inline def setJustify(value: start | end | center | between | around | evenly | stretch): Self = StObject.set(x, "justify", value.asInstanceOf[js.Any])
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAnimationTimeline): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
