...
object checkListItemMod {
  
  @JSImport("antd-mobile/es/components/check-list/check-list-item", "CheckListItem")
  @js.native
  val CheckListItem: FC[CheckListItemProps] = js.native
  
  /* Inlined std.Pick<antd-mobile.antd-mobile/es/components/list.ListItemProps, 'title' | 'children' | 'description' | 'prefix' | 'disabled' | 'onClick' | 'style'> & {  value :string,   readOnly :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait CheckListItemProps extends StObject {
