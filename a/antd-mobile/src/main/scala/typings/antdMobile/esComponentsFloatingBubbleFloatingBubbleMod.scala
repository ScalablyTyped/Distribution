...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAnimationDirection
...
import typings.antdMobile.antdMobileStrings.lock
...
import typings.antdMobile.antdMobileStrings.x
import typings.antdMobile.antdMobileStrings.xy
import typings.antdMobile.antdMobileStrings.y
...
object esComponentsFloatingBubbleFloatingBubbleMod {
  
  @JSImport("antd-mobile/es/components/floating-bubble/floating-bubble", "FloatingBubble")
  @js.native
  ...
  trait FloatingBubbleProps extends StObject {
    ...
    var axis: js.UndefOr[x | y | xy | lock] = js.undefined
  ...
  object FloatingBubbleProps {
    
    inline def apply(): FloatingBubbleProps = {
    ...
    implicit open class MutableBuilder[Self <: FloatingBubbleProps] (val x: Self) extends AnyVal {
      ...
      inline def setAxis(value: typings.antdMobile.antdMobileStrings.x | y | xy | lock): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
