...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackground
...
import typings.antdMobile.antdMobileStrings.alert
...
object noticeBarNoticeBarMod {
  
  @JSImport("antd-mobile/es/components/notice-bar/notice-bar", "NoticeBar")
  @js.native
  ...
  object NoticeBarProps {
    ...
    inline def apply(): NoticeBarProps = {
    ...
    extension [Self <: NoticeBarProps](x: Self) {
      ...
      inline def setColor(value: default | alert | error | info): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackground): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
