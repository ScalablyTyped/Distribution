...
object iconMod {
  ...
  object IconProps {
    ...
    inline def apply(IconPropsType: IconPropsType): IconProps = {
    ...
    extension [Self <: IconProps](x: Self) {
      ...
      inline def setSize(value: xxs | xs | sm | md | lg): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
