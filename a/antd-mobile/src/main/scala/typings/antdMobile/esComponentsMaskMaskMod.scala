...
import typings.antdMobile.antdMobileStrings.black
...
import typings.antdMobile.antdMobileStrings.thick
import typings.antdMobile.antdMobileStrings.thin
...
object esComponentsMaskMaskMod {
  
  @JSImport("antd-mobile/es/components/mask/mask", "Mask")
  @js.native
  ...
  trait MaskProps extends StObject {
    ...
    var opacity: js.UndefOr[default | thin | thick | Double] = js.undefined
  ...
  object MaskProps {
    ...
    extension [Self <: MaskProps](x: Self) {
      ...
      inline def setOpacity(value: default | thin | thick | Double): Self = StObject.set(x, "opacity", value.asInstanceOf[js.Any])
