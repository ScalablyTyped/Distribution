...
import typings.antdMobile.antdMobileStrings.plain
...
object footerFooterMod {
  ...
  object FooterProps {
    ...
    extension [Self <: FooterProps](x: Self) {
      ...
      inline def setOnChipClick(value: (/* item */ ChipItem, /* index */ Double) => Unit): Self = StObject.set(x, "onChipClick", js.Any.fromFunction2(value))
      
      inline def setOnChipClickUndefined: Self = StObject.set(x, "onChipClick", js.undefined)
      
      inline def setOnLinkClick(value: (/* item */ LinkItem, /* index */ Double) => Unit): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction2(value))
