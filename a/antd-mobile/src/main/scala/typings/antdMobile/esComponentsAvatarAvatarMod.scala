...
import typings.antdMobile.anon.CSSPropertiesPartialRecor
...
object esComponentsAvatarAvatarMod {
  
  @JSImport("antd-mobile/es/components/avatar/avatar", "Avatar")
  @js.native
  ...
  object AvatarProps {
    ...
    inline def apply(src: String): AvatarProps = {
    ...
    implicit open class MutableBuilder[Self <: AvatarProps] (val x: Self) extends AnyVal {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecor): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
