...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAppearance
...
import typings.antdMobile.antdMobileStrings.`lazy`
...
import typings.antdMobile.antdMobileStrings.eager
...
import typings.antdMobile.antdMobileStrings.sync
...
object esComponentsImageImageMod {
  
  @JSImport("antd-mobile/es/components/image/image", "Image")
  @js.native
  val Image: FC[ImageProps] = js.native
  
  /* Inlined {  src :string | undefined,   alt :string | undefined,   width :number | string | undefined,   height :number | string | undefined,   fit :'contain' | 'cover' | 'fill' | 'none' | 'scale-down' | undefined,   placeholder :react.react.ReactNode | undefined,   fallback :react.react.ReactNode | undefined,   lazy :boolean | undefined,   draggable :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLImageElement, std.Event>): void | undefined,   onError :(event : react.react.SyntheticEvent<std.HTMLImageElement, std.Event>): void | undefined,   onLoad :(event : react.react.SyntheticEvent<std.HTMLImageElement, std.Event>): void | undefined,   onContainerClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.Event>): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--width' | '--height'> & std.Pick<react.react.ImgHTMLAttributes<std.HTMLImageElement>, 'crossOrigin' | 'decoding' | 'loading' | 'referrerPolicy' | 'sizes' | 'srcSet' | 'useMap'> */
  trait ImageProps extends StObject {
    ...
    var fit: js.UndefOr[contain | cover | fill | none | `scale-down`] = js.undefined
    ...
    var onClick: js.UndefOr[js.Function1[/* event */ MouseEvent[HTMLImageElement, Event], Unit]] = js.undefined
    
    var onContainerClick: js.UndefOr[js.Function1[/* event */ MouseEvent[HTMLDivElement, Event], Unit]] = js.undefined
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorAppearance] = js.undefined
  ...
  object ImageProps {
    ...
    implicit open class MutableBuilder[Self <: ImageProps] (val x: Self) extends AnyVal {
      ...
      inline def setFit(value: contain | cover | fill | none | `scale-down`): Self = StObject.set(x, "fit", value.asInstanceOf[js.Any])
      ...
      inline def setOnClick(value: /* event */ MouseEvent[HTMLImageElement, Event] => Unit): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnContainerClick(value: /* event */ MouseEvent[HTMLDivElement, Event] => Unit): Self = StObject.set(x, "onContainerClick", js.Any.fromFunction1(value))
      
      inline def setOnContainerClickUndefined: Self = StObject.set(x, "onContainerClick", js.undefined)
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAppearance): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
