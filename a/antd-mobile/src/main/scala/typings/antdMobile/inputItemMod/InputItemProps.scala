...
object InputItemProps {
  @scala.inline
  def apply(
    InputItemPropsType: InputItemPropsType = null,
    about: String = null,
    accept: String = null,
    ...
    if (InputItemPropsType != null) js.Dynamic.global.Object.assign(__obj, InputItemPropsType)
