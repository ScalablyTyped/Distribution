...
/* Inlined antd-mobile.antd-mobile/lib/_util/types.Omit<react.react.HTMLProps<std.HTMLInputElement>, 'onChange' | 'onFocus' | 'onBlur' | 'value' | 'defaultValue' | 'type'> */
@js.native
trait HTMLInputProps extends js.Object {
...
object HTMLInputProps {
  @scala.inline
  def apply(): HTMLInputProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLInputProps]
  }
  @scala.inline
  implicit class HTMLInputPropsOps[Self <: HTMLInputProps] (val x: Self) extends AnyVal {
    @scala.inline
