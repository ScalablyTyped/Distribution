...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAnimationDelay
...
import typings.antdMobile.esComponentsErrorBlockMod.ImageRecord
...
object esComponentsErrorBlockCreateErrorBlockMod {
  
  @JSImport("antd-mobile/es/components/error-block/create-error-block", JSImport.Namespace)
  @js.native
  ...
  /* Inlined {  status :antd-mobile.antd-mobile/es/components/error-block.ErrorBlockStatus | undefined,   title :react.react.ReactNode | undefined,   image :string | react.react.ReactElement | undefined,   description :react.react.ReactNode | undefined,   fullPage :boolean | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--image-height' | '--image-height-full-page' | '--image-width' | '--image-width-full-page'> */
  trait ErrorBlockProps extends StObject {
    ...
    var image: js.UndefOr[String | ReactElement] = js.undefined
    
    var status: js.UndefOr[ErrorBlockStatus] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAnimationDelay] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var title: js.UndefOr[ReactNode] = js.undefined
  }
  object ErrorBlockProps {
    
    inline def apply(): ErrorBlockProps = {
    ...
    implicit open class MutableBuilder[Self <: ErrorBlockProps] (val x: Self) extends AnyVal {
      ...
      inline def setImage(value: String | ReactElement): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
      
      inline def setImageUndefined: Self = StObject.set(x, "image", js.undefined)
      
      inline def setStatus(value: ErrorBlockStatus): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
      
      inline def setStatusUndefined: Self = StObject.set(x, "status", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorAnimationDelay): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
