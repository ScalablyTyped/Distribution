...
object esComponentsRadioRadioMod {
  
  @JSImport("antd-mobile/es/components/radio/radio", "Radio")
  @js.native
  val Radio: FC[RadioProps] = js.native
  
  /* Inlined {  checked :boolean | undefined,   defaultChecked :boolean | undefined,   disabled :boolean | undefined,   onChange :(checked : boolean): void | undefined,   value :antd-mobile.antd-mobile/es/components/radio/radio.RadioValue | undefined,   block :boolean | undefined,   id :string | undefined,   icon :(checked : boolean): react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--icon-size' | '--font-size' | '--gap'> */
  trait RadioProps extends StObject {
    ...
    var icon: js.UndefOr[js.Function1[/* checked */ Boolean, ReactNode]] = js.undefined
  ...
  object RadioProps {
    ...
    extension [Self <: RadioProps](x: Self) {
      ...
      inline def setIcon(value: /* checked */ Boolean => ReactNode): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
