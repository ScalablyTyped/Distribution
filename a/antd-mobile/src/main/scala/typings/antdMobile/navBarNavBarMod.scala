...
object navBarNavBarMod {
  ...
  /* Inlined {  back :string | null | undefined,   backArrow :boolean | react.react.ReactNode | undefined,   left :react.react.ReactNode | undefined,   right :react.react.ReactNode | undefined,   onBack :(): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--height' | '--border-bottom'> */
  trait NavBarProps extends StObject {
    ...
    var back: js.UndefOr[String | Null] = js.undefined
