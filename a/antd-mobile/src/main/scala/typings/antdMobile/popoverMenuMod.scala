...
object popoverMenuMod {
  ...
  object PopoverMenuProps {
    ...
    inline def apply(actions: js.Array[Action], children: ReactElement): PopoverMenuProps = {
    ...
    extension [Self <: PopoverMenuProps](x: Self) {
      ...
      inline def setOnAction(value: /* item */ Action => Unit): Self = StObject.set(x, "onAction", js.Any.fromFunction1(value))
