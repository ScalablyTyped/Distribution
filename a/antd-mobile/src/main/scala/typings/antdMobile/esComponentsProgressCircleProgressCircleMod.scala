...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundClip
...
object esComponentsProgressCircleProgressCircleMod {
  
  @JSImport("antd-mobile/es/components/progress-circle/progress-circle", "ProgressCircle")
  @js.native
  val ProgressCircle: FC[ProgressCircleProps] = js.native
  
  /* Inlined {  percent :number | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--size' | '--track-width' | '--track-color' | '--fill-color'> */
  trait ProgressCircleProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundClip] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
  }
  object ProgressCircleProps {
    
    inline def apply(): ProgressCircleProps = {
    ...
    extension [Self <: ProgressCircleProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundClip): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
