...
object esComponentsInfiniteScrollInfiniteScrollMod {
  
  @JSImport("antd-mobile/es/components/infinite-scroll/infinite-scroll", "InfiniteScroll")
  @js.native
  val InfiniteScroll: FC[InfiniteScrollProps] = js.native
  
  /* Inlined {loadMore (isRetry : boolean): std.Promise<void>,   hasMore :boolean,   threshold :number | undefined,   children :react.react.ReactNode | (hasMore : boolean, failed : boolean, retry : (): void): react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait InfiniteScrollProps extends StObject {
    ...
    var children: js.UndefOr[
        ReactNode | (js.Function3[/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit], ReactNode])
      ] = js.undefined
    ...
    def loadMore(isRetry: Boolean): js.Promise[Unit]
  ...
  object InfiniteScrollProps {
    ...
    inline def apply(hasMore: Boolean, loadMore: Boolean => js.Promise[Unit]): InfiniteScrollProps = {
      val __obj = js.Dynamic.literal(hasMore = hasMore.asInstanceOf[js.Any], loadMore = js.Any.fromFunction1(loadMore))
    ...
    extension [Self <: InfiniteScrollProps](x: Self) {
      ...
      inline def setChildren(
        value: ReactNode | (js.Function3[/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit], ReactNode])
      ): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction3(value: (/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit]) => ReactNode): Self = StObject.set(x, "children", js.Any.fromFunction3(value))
      ...
      inline def setLoadMore(value: Boolean => js.Promise[Unit]): Self = StObject.set(x, "loadMore", js.Any.fromFunction1(value))
