...
object itemMod extends Shortcut {
  ...
  @js.native
  val default: FC[DropdownItemProps] = js.native
  
  @JSImport("antd-mobile/es/components/dropdown/item", "ItemChildrenWrap")
  @js.native
  val ItemChildrenWrap: FC[DropdownItemChildrenWrapProps] = js.native
  
  /* Inlined {  onClick :(): void | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/dropdown/item.DropdownItemProps, 'active' | 'forceRender' | 'destroyOnClose' | 'children'> */
  trait DropdownItemChildrenWrapProps extends StObject {
  ...
  object DropdownItemChildrenWrapProps {
    
    inline def apply(): DropdownItemChildrenWrapProps = {
  ...
  /* Inlined {  key :string,   title :react.react.ReactNode,   active :boolean | undefined,   highlight :boolean | undefined,   forceRender :boolean | undefined,   destroyOnClose :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   arrow :react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait DropdownItemProps extends StObject {
    ...
    var arrow: js.UndefOr[ReactNode] = js.undefined
  ...
  object DropdownItemProps {
    ...
    inline def apply(key: String): DropdownItemProps = {
    ...
    extension [Self <: DropdownItemProps](x: Self) {
      ...
      inline def setArrow(value: ReactNode): Self = StObject.set(x, "arrow", value.asInstanceOf[js.Any])
