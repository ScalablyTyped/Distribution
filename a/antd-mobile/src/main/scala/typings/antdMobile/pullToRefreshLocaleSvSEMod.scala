...
object pullToRefreshLocaleSvSEMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/pull-to-refresh/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/pull-to-refresh/locale/sv_SE", "default.activateText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/pull-to-refresh/locale/sv_SE", "default.deactivateText")
    @js.native
    ...
    @JSImport("antd-mobile/lib/pull-to-refresh/locale/sv_SE", "default.finishText")
    @js.native
