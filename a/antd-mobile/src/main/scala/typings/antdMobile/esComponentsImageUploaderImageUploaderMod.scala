...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAnimationTimingFunction
...
import typings.antdMobile.antdMobileStrings.environment
...
import typings.antdMobile.antdMobileStrings.user
...
object esComponentsImageUploaderImageUploaderMod {
  ...
  object ImageUploaderProps {
    ...
    implicit open class MutableBuilder[Self <: ImageUploaderProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnChange(value: /* items */ js.Array[ImageUploadItem] => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction1(value))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnCountExceed(value: /* exceed */ Double => Unit): Self = StObject.set(x, "onCountExceed", js.Any.fromFunction1(value))
      ...
      inline def setOnPreview(value: (/* index */ Double, /* item */ ImageUploadItem) => Unit): Self = StObject.set(x, "onPreview", js.Any.fromFunction2(value))
      
      inline def setOnPreviewUndefined: Self = StObject.set(x, "onPreview", js.undefined)
      
      inline def setOnUploadQueueChange(value: /* tasks */ js.Array[UploadTask] => Unit): Self = StObject.set(x, "onUploadQueueChange", js.Any.fromFunction1(value))
      ...
      inline def setRenderItem(
        value: (/* originNode */ ReactElement, /* file */ ImageUploadItem, /* fileList */ js.Array[ImageUploadItem]) => ReactNode
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.antdMobile.antdMobileStrings.pending
    - typings.antdMobile.antdMobileStrings.fail
    - typings.antdMobile.antdMobileStrings.success
  */
  trait TaskStatus extends StObject
  object TaskStatus {
    
    inline def fail: typings.antdMobile.antdMobileStrings.fail = "fail".asInstanceOf[typings.antdMobile.antdMobileStrings.fail]
    
    inline def pending: typings.antdMobile.antdMobileStrings.pending = "pending".asInstanceOf[typings.antdMobile.antdMobileStrings.pending]
