...
import typings.antdMobile.anon.CSSPropertiesPartialRecorAccentColor
...
object esComponentsBadgeBadgeMod {
  
  @JSImport("antd-mobile/es/components/badge/badge", "Badge")
  @js.native
  val Badge: FC[BadgeProps] = js.native
  
  @JSImport("antd-mobile/es/components/badge/badge", "dot")
  @js.native
  val dot: Element = js.native
  
  /* Inlined {  content :react.react.ReactNode | react.react.<global>.JSX.Element | undefined,   color :string | undefined,   bordered :boolean | undefined,   children :react.react.ReactNode | undefined,   wrapperClassName :string | undefined,   wrapperStyle :react.react.CSSProperties | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--right' | '--top' | '--color'> */
  trait BadgeProps extends StObject {
    ...
    var content: js.UndefOr[ReactNode | Element] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAccentColor] = js.undefined
  ...
  object BadgeProps {
    ...
    implicit open class MutableBuilder[Self <: BadgeProps] (val x: Self) extends AnyVal {
      ...
      inline def setContent(value: ReactNode | Element): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      
      inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorAccentColor): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
