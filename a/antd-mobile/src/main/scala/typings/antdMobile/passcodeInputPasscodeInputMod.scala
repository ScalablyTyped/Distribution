...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundAttachment
...
object passcodeInputPasscodeInputMod {
  ...
  object PasscodeInputRef {
    ...
    inline def apply(blur: () => Unit, focus: () => Unit): PasscodeInputRef = {
