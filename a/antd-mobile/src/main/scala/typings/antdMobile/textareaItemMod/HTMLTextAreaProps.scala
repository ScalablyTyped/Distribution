...
/* Inlined antd-mobile.antd-mobile/lib/_util/types.Omit<react.react.HTMLProps<std.HTMLInputElement>, 'onChange' | 'onFocus' | 'onBlur' | 'value' | 'defaultValue' | 'type' | 'title'> */
@js.native
trait HTMLTextAreaProps extends js.Object {
...
object HTMLTextAreaProps {
  @scala.inline
  def apply(): HTMLTextAreaProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[HTMLTextAreaProps]
  }
  @scala.inline
  implicit class HTMLTextAreaPropsOps[Self <: HTMLTextAreaProps] (val x: Self) extends AnyVal {
    @scala.inline
