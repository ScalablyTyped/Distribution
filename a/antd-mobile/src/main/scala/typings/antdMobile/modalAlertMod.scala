...
object modalAlertMod {
  
  @JSImport("antd-mobile/es/components/modal/alert", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def alert(p: ModalAlertProps): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("alert")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Unit]]
  
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/modal.ModalProps, 'visible' | 'closeOnAction' | 'actions'> & {  confirmText :react.react.ReactNode | undefined,   onConfirm :(): void | std.Promise<void> | undefined} */
  ...
  object ModalAlertProps {
    ...
    inline def apply(): ModalAlertProps = {
