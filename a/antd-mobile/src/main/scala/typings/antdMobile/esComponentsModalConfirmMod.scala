...
import typings.antdMobile.esComponentsModalModalActionButtonMod.Action
...
object esComponentsModalConfirmMod {
  
  @JSImport("antd-mobile/es/components/modal/confirm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def confirm(p: ModalConfirmProps): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("confirm")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/modal.ModalProps, 'visible' | 'closeOnAction' | 'actions'> & {  confirmText :react.react.ReactNode | undefined,   cancelText :react.react.ReactNode | undefined,   onConfirm :(): void | std.Promise<void> | undefined,   onCancel :(): void | std.Promise<void> | undefined} */
  trait ModalConfirmProps extends StObject {
    ...
    var onCancel: js.UndefOr[js.Function0[Unit | js.Promise[Unit]]] = js.undefined
    
    var onClose: js.UndefOr[js.Function0[Unit]] = js.undefined
    
    var onConfirm: js.UndefOr[js.Function0[Unit | js.Promise[Unit]]] = js.undefined
  ...
  object ModalConfirmProps {
    
    inline def apply(): ModalConfirmProps = {
    ...
    implicit open class MutableBuilder[Self <: ModalConfirmProps] (val x: Self) extends AnyVal {
      ...
      inline def setOnCancel(value: () => Unit | js.Promise[Unit]): Self = StObject.set(x, "onCancel", js.Any.fromFunction0(value))
      ...
      inline def setOnConfirm(value: () => Unit | js.Promise[Unit]): Self = StObject.set(x, "onConfirm", js.Any.fromFunction0(value))
