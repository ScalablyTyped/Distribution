...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackgroundRepeat
...
object esComponentsStepsStepsMod {
  
  @JSImport("antd-mobile/es/components/steps/steps", "Steps")
  @js.native
  val Steps: FC[StepsProps] = js.native
  ...
  */
  ...
  /* Inlined {  current :number | undefined,   direction :antd-mobile.antd-mobile/es/components/steps/steps.Direction | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--title-font-size' | '--description-font-size' | '--indicator-margin-right' | '--icon-size'> */
  trait StepsProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundRepeat] = js.undefined
  ...
  object StepsProps {
    ...
    extension [Self <: StepsProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundRepeat): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
