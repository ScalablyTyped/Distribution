...
object modalPropsTypeMod {
  ...
  trait Action[T] extends StObject {
    ...
    var onPress: js.UndefOr[js.Function1[/* repeated */ js.Any, Unit | js.Promise[js.Any]]] = js.undefined
  ...
  object Action {
    ...
    extension [Self <: Action[?], T](x: Self & Action[T]) {
      ...
      inline def setOnPress(value: /* repeated */ js.Any => Unit | js.Promise[js.Any]): Self = StObject.set(x, "onPress", js.Any.fromFunction1(value))
