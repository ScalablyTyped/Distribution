...
object modalPropsTypeMod {
  ...
  trait Action[T] extends StObject {
    ...
    var onPress: js.UndefOr[js.Function1[/* repeated */ js.Any, Unit | js.Promise[_]]] = js.native
  ...
  object Action {
    ...
    implicit class ActionMutableBuilder[Self <: Action[_], T] (val x: Self with Action[T]) extends AnyVal {
      ...
      @scala.inline
      def setOnPress(value: /* repeated */ js.Any => Unit | js.Promise[_]): Self = StObject.set(x, "onPress", js.Any.fromFunction1(value))
