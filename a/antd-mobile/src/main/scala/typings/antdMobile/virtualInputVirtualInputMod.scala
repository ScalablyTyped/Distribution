...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBorderBlock
import typings.antdMobile.anon.onFocusvoidundefinedonBlu
...
object virtualInputVirtualInputMod {
  ...
  trait VirtualInputProps extends StObject {
    ...
    var keyboard: js.UndefOr[ReactElement] = js.undefined
  ...
  object VirtualInputProps {
    ...
    extension [Self <: VirtualInputProps](x: Self) {
      ...
      inline def setKeyboard(value: ReactElement): Self = StObject.set(x, "keyboard", value.asInstanceOf[js.Any])
  ...
  object VirtualInputRef {
    ...
    inline def apply(blur: () => Unit, focus: () => Unit): VirtualInputRef = {
