...
object multipleMod {
  ...
  object MultipleProps {
    ...
    extension [Self <: MultipleProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnExpand(value: (/* expandedKeys */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Unit): Self = StObject.set(x, "onExpand", js.Any.fromFunction2(value))
