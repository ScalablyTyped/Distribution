...
import typings.antdMobile.pickerViewPickerViewMod.PickerColumnItem
...
object cascadePickerViewCascadePickerViewMod {
  
  @JSImport("antd-mobile/es/components/cascade-picker-view/cascade-picker-view", "CascadePickerView")
  @js.native
  val CascadePickerView: FC[CascadePickerViewProps] = js.native
  
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/picker-view.PickerViewProps, 'columns'> & {  options :std.Array<antd-mobile.antd-mobile/es/components/cascade-picker.CascadePickerOption>} */
  trait CascadePickerViewProps extends StObject {
  ...
  object CascadePickerViewProps {
    
    inline def apply(options: js.Array[CascadePickerOption]): CascadePickerViewProps = {
    ...
    extension [Self <: CascadePickerViewProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Unit): Self = StObject.set(x, "onChange", js.Any.fromFunction2(value))
