...
import typings.antdMobile.anon.CSSPropertiesPartialRecorBackfaceVisibility
...
object esComponentsNavBarNavBarMod {
  
  @JSImport("antd-mobile/es/components/nav-bar/nav-bar", "NavBar")
  @js.native
  val NavBar: FC[NavBarProps] = js.native
  
  /* Inlined {  back :react.react.ReactNode | undefined,   backArrow :boolean | react.react.ReactNode | undefined,   left :react.react.ReactNode | undefined,   right :react.react.ReactNode | undefined,   onBack :(): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--height' | '--border-bottom'> */
  trait NavBarProps extends StObject {
    ...
    var backArrow: js.UndefOr[Boolean | ReactNode] = js.undefined
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackfaceVisibility] = js.undefined
  ...
  object NavBarProps {
    ...
    extension [Self <: NavBarProps](x: Self) {
      ...
      inline def setBackArrow(value: Boolean | ReactNode): Self = StObject.set(x, "backArrow", value.asInstanceOf[js.Any])
      
      inline def setBackArrowUndefined: Self = StObject.set(x, "backArrow", js.undefined)
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackfaceVisibility): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
