...
object inputItemLocaleSvSEMod {
  
  object default {
    
    @JSImport("antd-mobile/lib/input-item/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile/lib/input-item/locale/sv_SE", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("antd-mobile/lib/input-item/locale/sv_SE", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("antd-mobile/lib/input-item/locale/sv_SE", "default.confirmLabel")
    @js.native
