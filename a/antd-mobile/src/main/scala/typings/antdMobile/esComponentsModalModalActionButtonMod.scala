...
import typings.antdMobile.anon.OnAction
...
object esComponentsModalModalActionButtonMod {
  
  @JSImport("antd-mobile/es/components/modal/modal-action-button", "ModalActionButton")
  @js.native
  val ModalActionButton: FC[OnAction] = js.native
  
  /* Inlined {  key :string | number,   text :react.react.ReactNode,   disabled :boolean | undefined,   danger :boolean | undefined,   primary :boolean | undefined,   onClick :(): void | std.Promise<void> | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait Action extends StObject {
    ...
    var onClick: js.UndefOr[js.Function0[Unit | js.Promise[Unit]]] = js.undefined
  ...
  object Action {
    ...
    extension [Self <: Action](x: Self) {
      ...
      inline def setOnClick(value: () => Unit | js.Promise[Unit]): Self = StObject.set(x, "onClick", js.Any.fromFunction0(value))
