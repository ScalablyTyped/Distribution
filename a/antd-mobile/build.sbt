...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-calendar" % "1.1.4-8cbfd3",
  "org.scalablytyped" %%% "rmc-cascader" % "5.0.3-f19f38",
  "org.scalablytyped" %%% "rmc-input-number" % "1.0.5-947dc3",
  "org.scalablytyped" %%% "rmc-pull-to-refresh" % "1.0.11-116fe0",
