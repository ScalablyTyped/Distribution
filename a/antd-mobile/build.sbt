...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-calendar" % "1.1.4-89a2f4",
  "org.scalablytyped" %%% "rmc-cascader" % "5.0.3-0cbcdb",
  "org.scalablytyped" %%% "rmc-input-number" % "1.0.5-697ec9",
  "org.scalablytyped" %%% "rmc-pull-to-refresh" % "1.0.11-38605c",
