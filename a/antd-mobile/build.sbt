...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-calendar" % "1.1.4-594e23",
  "org.scalablytyped" %%% "rmc-cascader" % "5.0.3-850a62",
  "org.scalablytyped" %%% "rmc-input-number" % "1.0.5-dc36b8",
  "org.scalablytyped" %%% "rmc-pull-to-refresh" % "1.0.11-12a1b9",
