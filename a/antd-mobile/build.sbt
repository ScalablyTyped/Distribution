...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-calendar" % "1.1.4-1cc15e",
  "org.scalablytyped" %%% "rmc-cascader" % "5.0.3-0842df",
  "org.scalablytyped" %%% "rmc-input-number" % "1.0.5-96c1e3",
  "org.scalablytyped" %%% "rmc-pull-to-refresh" % "1.0.11-ae49ae",
