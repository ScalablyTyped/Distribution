...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "rmc-calendar" % "1.1.4-a5c6fd",
  "org.scalablytyped" %%% "rmc-cascader" % "5.0.3-6eabcb",
  "org.scalablytyped" %%% "rmc-input-number" % "1.0.5-7fa1f2",
  "org.scalablytyped" %%% "rmc-pull-to-refresh" % "1.0.11-b93aa5",
