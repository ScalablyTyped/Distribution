package typings.amapDashJsDashApiDashHeatmap.AMap

import typings.amapDashJsDashApi.AMap.Map
import typings.amapDashJsDashApiDashHeatmap.AMap.Heatmap.DataSet
import typings.amapDashJsDashApiDashHeatmap.AMap.Heatmap.Options
import typings.amapDashJsDashApiDashHeatmap.Anon_Data
...
class Heatmap_ protected () extends js.Object {
  ...
  def setDataSet(dataset: Anon_Data): Unit = js.native
  /**
    * 设置热力图要叠加的地图对象
    * @param map 地图对象
    */
