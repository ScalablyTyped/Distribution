...
@JSImport("@angular/platform-browser-dynamic/src/platform-browser-dynamic", "ɵCompilerImpl")
@js.native
class ɵCompilerImpl protected ()
  extends atAngularPlatformDashBrowserDashDynamicLib.srcPrivateUnderscoreExportMod.ɵCompilerImpl {
