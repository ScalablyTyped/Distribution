...
@JSImport("@angular/platform-browser-dynamic/public_api", "ɵCompilerImpl")
@js.native
class ɵCompilerImpl protected ()
  extends atAngularPlatformDashBrowserDashDynamicLib.srcPlatformDashBrowserDashDynamicMod.ɵCompilerImpl {
