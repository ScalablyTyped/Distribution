...
@JSImport("@angular/platform-browser-dynamic/src/private_export", "ɵCompilerImpl")
@js.native
class ɵCompilerImpl protected ()
  extends atAngularPlatformDashBrowserDashDynamicLib.srcCompilerUnderscoreFactoryMod.CompilerImpl {
