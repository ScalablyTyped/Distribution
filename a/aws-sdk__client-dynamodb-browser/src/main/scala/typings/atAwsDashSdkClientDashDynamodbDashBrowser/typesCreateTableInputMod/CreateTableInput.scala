package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesCreateTableInputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexMod._GlobalSecondaryIndex
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreKeySchemaElementMod._KeySchemaElement
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexMod._LocalSecondaryIndex
...
object CreateTableInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AttributeDefinitions = AttributeDefinitions.asInstanceOf[js.Any], KeySchema = KeySchema.asInstanceOf[js.Any], ProvisionedThroughput = ProvisionedThroughput, TableName = TableName)
