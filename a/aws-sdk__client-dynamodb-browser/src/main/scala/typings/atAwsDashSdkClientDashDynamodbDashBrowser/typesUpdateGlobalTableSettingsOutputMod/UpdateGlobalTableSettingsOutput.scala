package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUpdateGlobalTableSettingsOutputMod

import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesOutputTypesUnionMod.OutputTypesUnion
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreReplicaSettingsDescriptionMod._UnmarshalledReplicaSettingsDescription
