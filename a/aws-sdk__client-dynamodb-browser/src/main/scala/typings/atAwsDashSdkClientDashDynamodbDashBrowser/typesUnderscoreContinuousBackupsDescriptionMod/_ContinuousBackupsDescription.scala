package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreContinuousBackupsDescriptionMod
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscorePointInTimeRecoveryDescriptionMod._PointInTimeRecoveryDescription
