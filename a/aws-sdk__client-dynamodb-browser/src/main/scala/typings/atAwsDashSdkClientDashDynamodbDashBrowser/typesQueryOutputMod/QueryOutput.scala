package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesQueryOutputMod
...
trait QueryOutput extends OutputTypesUnion {
  ...
  /**
    ...
    */
  var Items: js.UndefOr[js.Array[StringDictionary[_UnmarshalledAttributeValue]]] = js.undefined
  /**
    ...
    */
  var LastEvaluatedKey: js.UndefOr[StringDictionary[_UnmarshalledAttributeValue]] = js.undefined
  /**
...
object QueryOutput {
  ...
  def apply(
    ...
    Items: js.Array[StringDictionary[_UnmarshalledAttributeValue]] = null,
