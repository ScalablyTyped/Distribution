...
@JSImport("@aws-sdk/client-dynamodb-browser/types/UpdateContinuousBackupsInput", JSImport.Namespace)
@js.native
object typesUpdateContinuousBackupsInputMod extends js.Object {
  @js.native
  trait UpdateContinuousBackupsInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var PointInTimeRecoverySpecification: _PointInTimeRecoverySpecification = js.native
    /**
