package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUpdateTimeToLiveInputMod

import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesInputTypesUnionMod.InputTypesUnion
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreTimeToLiveSpecificationMod._TimeToLiveSpecification
