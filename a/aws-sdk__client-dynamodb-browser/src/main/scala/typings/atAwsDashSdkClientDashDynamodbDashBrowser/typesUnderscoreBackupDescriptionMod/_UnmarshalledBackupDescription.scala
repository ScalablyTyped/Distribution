...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSourceTableDetailsMod._UnmarshalledSourceTableDetails
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSourceTableFeatureDetailsMod._UnmarshalledSourceTableFeatureDetails
