...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUpdateTableInputMod.UpdateTableInput
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUpdateTableOutputMod.UpdateTableOutput
