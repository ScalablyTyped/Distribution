package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUntagResourceInputMod
...
object UntagResourceInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ResourceArn = ResourceArn, TagKeys = TagKeys.asInstanceOf[js.Any])
