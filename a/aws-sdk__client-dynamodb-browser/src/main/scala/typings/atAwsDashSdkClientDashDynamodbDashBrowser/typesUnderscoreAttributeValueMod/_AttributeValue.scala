...
trait _AttributeValue extends js.Object {
  ...
  /**
    ...
    */
  var L: js.UndefOr[js.Array[_AttributeValue] | Iterable[_AttributeValue]] = js.undefined
  /**
...
object _AttributeValue {
  ...
  def apply(
    ...
    L: js.Array[_AttributeValue] | Iterable[_AttributeValue] = null,
    M: StringDictionary[_AttributeValue] | (Iterable[js.Tuple2[String, _AttributeValue]]) = null,
    N: String = null,
