package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesCreateGlobalTableInputMod
...
object CreateGlobalTableInput {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(GlobalTableName = GlobalTableName, ReplicationGroup = ReplicationGroup.asInstanceOf[js.Any])
