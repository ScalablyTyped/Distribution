...
trait InvalidRestoreTimeException
  ...
  @JSName("name")
  var name_InvalidRestoreTimeException: typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.InvalidRestoreTimeException
}
...
object InvalidRestoreTimeException {
  ...
  def apply(
    ...
    message: String,
    name: typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.InvalidRestoreTimeException,
    stack: String = null
