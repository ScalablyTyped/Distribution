...
@JSImport("@aws-sdk/client-dynamodb-browser/types/DescribeTableInput", JSImport.Namespace)
@js.native
object typesDescribeTableInputMod extends js.Object {
  @js.native
  trait DescribeTableInput extends InputTypesUnion {
    /**
