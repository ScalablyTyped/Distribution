package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSourceTableFeatureDetailsMod

import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexInfoMod._UnmarshalledGlobalSecondaryIndexInfo
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexInfoMod._UnmarshalledLocalSecondaryIndexInfo
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSSEDescriptionMod._UnmarshalledSSEDescription
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreStreamSpecificationMod._UnmarshalledStreamSpecification
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreTimeToLiveDescriptionMod._UnmarshalledTimeToLiveDescription
