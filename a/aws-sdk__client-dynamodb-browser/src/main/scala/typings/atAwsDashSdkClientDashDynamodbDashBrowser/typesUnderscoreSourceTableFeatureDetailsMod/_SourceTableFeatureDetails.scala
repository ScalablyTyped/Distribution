...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreGlobalSecondaryIndexInfoMod._GlobalSecondaryIndexInfo
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreLocalSecondaryIndexInfoMod._LocalSecondaryIndexInfo
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreSSEDescriptionMod._SSEDescription
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreStreamSpecificationMod._StreamSpecification
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreTimeToLiveDescriptionMod._TimeToLiveDescription
