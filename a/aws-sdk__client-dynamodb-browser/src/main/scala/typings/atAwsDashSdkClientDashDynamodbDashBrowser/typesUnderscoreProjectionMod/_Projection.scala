package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreProjectionMod

import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.ALL
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.INCLUDE
...
trait _Projection extends js.Object {
  /**
...
object _Projection {
  ...
  def apply(
    ...
    __obj.asInstanceOf[_Projection]
  }
}
