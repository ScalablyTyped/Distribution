...
object typesQueryInputMod extends js.Object {
  ...
  trait QueryInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var KeyConditions: js.UndefOr[StringDictionary[_Condition] | (Iterable[js.Tuple2[String, _Condition]])] = js.native
    /**
    ...
    /**
      ...
      */
    var QueryFilter: js.UndefOr[StringDictionary[_Condition] | (Iterable[js.Tuple2[String, _Condition]])] = js.native
    /**
