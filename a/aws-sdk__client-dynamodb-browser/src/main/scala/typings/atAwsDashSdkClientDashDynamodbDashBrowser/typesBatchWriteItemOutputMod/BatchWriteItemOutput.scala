package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesBatchWriteItemOutputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreWriteRequestMod._UnmarshalledWriteRequest
