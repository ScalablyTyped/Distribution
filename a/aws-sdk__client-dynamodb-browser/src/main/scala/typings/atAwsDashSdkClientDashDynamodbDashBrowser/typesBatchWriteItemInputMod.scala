...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreWriteRequestMod._WriteRequest
...
object typesBatchWriteItemInputMod extends js.Object {
  ...
  trait BatchWriteItemInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var RequestItems: (StringDictionary[js.Array[_WriteRequest] | Iterable[_WriteRequest]]) | (Iterable[js.Tuple2[String, js.Array[_WriteRequest] | Iterable[_WriteRequest]]]) = js.native
    /**
