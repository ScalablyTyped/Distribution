...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAutoScalingTargetTrackingScalingPolicyConfigurationDescriptionMod._AutoScalingTargetTrackingScalingPolicyConfigurationDescription
