package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesBatchGetItemInputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreKeysAndAttributesMod._KeysAndAttributes
...
trait BatchGetItemInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestItems: StringDictionary[_KeysAndAttributes] | (Iterable[js.Tuple2[String, _KeysAndAttributes]])
  /**
...
object BatchGetItemInput {
  @scala.inline
  def apply(
    RequestItems: StringDictionary[_KeysAndAttributes] | (Iterable[js.Tuple2[String, _KeysAndAttributes]]),
