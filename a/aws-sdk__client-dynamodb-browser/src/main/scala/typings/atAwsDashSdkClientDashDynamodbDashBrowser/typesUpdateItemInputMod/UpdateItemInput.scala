package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUpdateItemInputMod
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreAttributeValueUpdateMod._AttributeValueUpdate
...
trait UpdateItemInput extends InputTypesUnion {
  ...
  var AttributeUpdates: js.UndefOr[
    StringDictionary[_AttributeValueUpdate] | (Iterable[js.Tuple2[String, _AttributeValueUpdate]])
  ] = js.undefined
  /**
...
object UpdateItemInput {
  ...
  def apply(
    ...
    AttributeUpdates: StringDictionary[_AttributeValueUpdate] | (Iterable[js.Tuple2[String, _AttributeValueUpdate]]) = null,
