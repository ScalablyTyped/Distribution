package typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesScanInputMod

import org.scalablytyped.runtime.StringDictionary
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.ALL_ATTRIBUTES
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.ALL_PROJECTED_ATTRIBUTES
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.AND
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.COUNT
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.atAwsDashSdkClientDashDynamodbDashBrowserStrings.SPECIFIC_ATTRIBUTES
...
import typings.atAwsDashSdkClientDashDynamodbDashBrowser.typesUnderscoreConditionMod._Condition
...
trait ScanInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var ScanFilter: js.UndefOr[StringDictionary[_Condition] | (Iterable[js.Tuple2[String, _Condition]])] = js.undefined
  /**
...
object ScanInput {
  ...
  def apply(
    ...
    ExclusiveStartKey: StringDictionary[_AttributeValue] | (Iterable[js.Tuple2[String, _AttributeValue]]) = null,
    ...
    ScanFilter: StringDictionary[_Condition] | (Iterable[js.Tuple2[String, _Condition]]) = null,
    Segment: Int | Double = null,
    Select: ALL_ATTRIBUTES | ALL_PROJECTED_ATTRIBUTES | SPECIFIC_ATTRIBUTES | COUNT | String = null,
    TotalSegments: Int | Double = null
  ): ScanInput = {
