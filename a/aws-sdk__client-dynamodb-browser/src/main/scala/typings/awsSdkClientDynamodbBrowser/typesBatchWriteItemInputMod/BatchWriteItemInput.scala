package typings.awsSdkClientDynamodbBrowser.typesBatchWriteItemInputMod
...
trait BatchWriteItemInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestItems: (StringDictionary[js.Array[WriteRequest] | Iterable[WriteRequest]]) | (Iterable[js.Tuple2[String, js.Array[WriteRequest] | Iterable[WriteRequest]]]) = js.native
  /**
...
object BatchWriteItemInput {
  ...
  implicit class BatchWriteItemInputOps[Self <: BatchWriteItemInput] (val x: Self) extends AnyVal {
    ...
    ): Self = this.set("RequestItems", value.asInstanceOf[js.Any])
    @scala.inline
