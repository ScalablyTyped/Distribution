...
import typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.ALL_ATTRIBUTES
import typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.ALL_PROJECTED_ATTRIBUTES
import typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.AND
import typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.COUNT
...
@JSImport("@aws-sdk/client-dynamodb-browser/types/ScanInput", JSImport.Namespace)
@js.native
