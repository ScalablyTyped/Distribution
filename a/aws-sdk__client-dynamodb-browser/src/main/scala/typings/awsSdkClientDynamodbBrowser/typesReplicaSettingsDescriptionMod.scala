...
object typesReplicaSettingsDescriptionMod {
  ...
  object UnmarshalledReplicaSettingsDescription {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: UnmarshalledReplicaSettingsDescription] (val x: Self) extends AnyVal {
      ...
      inline def setReplicaGlobalSecondaryIndexSettingsVarargs(value: UnmarshalledReplicaGlobalSecondaryIndexSettingsDescription*): Self = StObject.set(x, "ReplicaGlobalSecondaryIndexSettings", js.Array(value*))
