...
object modelItemCollectionMetricsPerTableMod {
  
  @JSImport("@aws-sdk/client-dynamodb-browser/model/_ItemCollectionMetricsPerTable", "_ItemCollectionMetricsPerTable")
  @js.native
