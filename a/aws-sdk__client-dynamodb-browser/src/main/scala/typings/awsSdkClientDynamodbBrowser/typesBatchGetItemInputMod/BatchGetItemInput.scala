package typings.awsSdkClientDynamodbBrowser.typesBatchGetItemInputMod
...
trait BatchGetItemInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var RequestItems: StringDictionary[KeysAndAttributes] | (Iterable[js.Tuple2[String, KeysAndAttributes]]) = js.native
  /**
...
object BatchGetItemInput {
  ...
  @scala.inline
  implicit class BatchGetItemInputOps[Self <: BatchGetItemInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRequestItems(value: StringDictionary[KeysAndAttributes] | (Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = this.set("RequestItems", value.asInstanceOf[js.Any])
    @scala.inline
