...
object typesQueryInputMod {
  ...
  object QueryInput {
    ...
    implicit class QueryInputMutableBuilder[Self <: QueryInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyConditions(value: StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "KeyConditions", value.asInstanceOf[js.Any])
      ...
      @scala.inline
      def setQueryFilter(value: StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])): Self = StObject.set(x, "QueryFilter", value.asInstanceOf[js.Any])
