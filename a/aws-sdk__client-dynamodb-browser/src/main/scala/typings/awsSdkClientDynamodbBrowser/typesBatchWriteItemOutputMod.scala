...
object typesBatchWriteItemOutputMod {
  ...
  trait BatchWriteItemOutput
    ...
    /**
      ...
      */
    var ItemCollectionMetrics: js.UndefOr[StringDictionary[js.Array[UnmarshalledItemCollectionMetrics]]] = js.undefined
    ...
    /**
      ...
      */
    var UnprocessedItems: js.UndefOr[StringDictionary[js.Array[UnmarshalledWriteRequest]]] = js.undefined
  }
  object BatchWriteItemOutput {
    ...
    implicit open class MutableBuilder[Self <: BatchWriteItemOutput] (val x: Self) extends AnyVal {
      ...
      inline def setUnprocessedItems(value: StringDictionary[js.Array[UnmarshalledWriteRequest]]): Self = StObject.set(x, "UnprocessedItems", value.asInstanceOf[js.Any])
