...
object typesBatchGetItemInputMod {
  ...
  object BatchGetItemInput {
    ...
    implicit class BatchGetItemInputMutableBuilder[Self <: BatchGetItemInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setRequestItems(value: StringDictionary[KeysAndAttributes] | (Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = StObject.set(x, "RequestItems", value.asInstanceOf[js.Any])
