...
object typesBatchGetItemInputMod {
  ...
  object BatchGetItemInput {
    ...
    extension [Self <: BatchGetItemInput](x: Self) {
      ...
      inline def setRequestItems(value: StringDictionary[KeysAndAttributes] | (Iterable[js.Tuple2[String, KeysAndAttributes]])): Self = StObject.set(x, "RequestItems", value.asInstanceOf[js.Any])
