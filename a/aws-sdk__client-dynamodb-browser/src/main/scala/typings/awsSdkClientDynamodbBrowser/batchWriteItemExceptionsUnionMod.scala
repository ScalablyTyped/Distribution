...
@JSImport("@aws-sdk/client-dynamodb-browser/types/BatchWriteItemExceptionsUnion", JSImport.Namespace)
@js.native
object batchWriteItemExceptionsUnionMod extends js.Object {
