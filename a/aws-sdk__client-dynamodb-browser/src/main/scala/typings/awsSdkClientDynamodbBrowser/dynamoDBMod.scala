...
import typings.awsSdkClientDynamodbBrowser.dynamoDBClientMod.DynamoDBClient
...
@JSImport("@aws-sdk/client-dynamodb-browser/DynamoDB", JSImport.Namespace)
@js.native
object dynamoDBMod extends js.Object {
  @js.native
