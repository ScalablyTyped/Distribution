...
object modelBatchWriteItemRequestMapMod {
  
  @JSImport("@aws-sdk/client-dynamodb-browser/model/_BatchWriteItemRequestMap", "_BatchWriteItemRequestMap")
  @js.native
  val BatchWriteItemRequestMap: Map[
