...
trait BackupInUseException
  ...
  @JSName("name")
  var name_BackupInUseException: typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.BackupInUseException = js.native
}
...
object BackupInUseException {
  ...
  implicit class BackupInUseExceptionOps[Self <: BackupInUseException] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setName(value: typings.awsSdkClientDynamodbBrowser.awsSdkClientDynamodbBrowserStrings.BackupInUseException): Self = this.set("name", value.asInstanceOf[js.Any])
  }
