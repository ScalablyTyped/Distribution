package typings.awsSdkClientDynamodbBrowser.typesQueryInputMod
...
trait QueryInput extends InputTypesUnion {
  ...
  /**
    ...
    */
  var KeyConditions: js.UndefOr[StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])] = js.native
  ...
  /**
    ...
    */
  var QueryFilter: js.UndefOr[StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])] = js.native
...
object QueryInput {
  ...
  implicit class QueryInputOps[Self <: QueryInput] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyConditions(value: StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])): Self = this.set("KeyConditions", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setQueryFilter(value: StringDictionary[Condition] | (Iterable[js.Tuple2[String, Condition]])): Self = this.set("QueryFilter", value.asInstanceOf[js.Any])
