...
object dynamoDBConfigurationMod {
  ...
  object DynamoDBConfiguration {
    ...
    @scala.inline
    def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): DynamoDBConfiguration = {
  ...
  object DynamoDBResolvableConfiguration {
    ...
    @scala.inline
    implicit class DynamoDBResolvableConfigurationMutableBuilder[Self <: DynamoDBResolvableConfiguration] (val x: Self) extends AnyVal {
  ...
  object DynamoDBResolvedConfiguration {
    ...
    @scala.inline
    implicit class DynamoDBResolvedConfigurationMutableBuilder[Self <: DynamoDBResolvedConfiguration] (val x: Self) extends AnyVal {
