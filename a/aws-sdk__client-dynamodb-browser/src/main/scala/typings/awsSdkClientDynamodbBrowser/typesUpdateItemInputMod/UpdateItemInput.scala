package typings.awsSdkClientDynamodbBrowser.typesUpdateItemInputMod
...
import typings.awsSdkClientDynamodbBrowser.typesAttributeValueUpdateMod.AttributeValueUpdate
