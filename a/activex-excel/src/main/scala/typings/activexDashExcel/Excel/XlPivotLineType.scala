...
*/
trait XlPivotLineType extends js.Object

object XlPivotLineType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlPivotLineBlank: `3` = this.cast(3)
  @scala.inline
  def xlPivotLineGrandTotal: `2` = this.cast(2)
  @scala.inline
  def xlPivotLineRegular: `0` = this.cast(0)
  @scala.inline
  def xlPivotLineSubtotal: `1` = this.cast(1)
}
