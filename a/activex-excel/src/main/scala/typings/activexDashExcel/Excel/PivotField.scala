...
class PivotField protected () extends js.Object {
  ...
  val CubeField: typings.activexDashExcel.Excel.CubeField = js.native
  ...
  def CalculatedItems(): typings.activexDashExcel.Excel.CalculatedItems = js.native
  ...
  def PivotItems(Indexes: SafeArray[Double | String]): typings.activexDashExcel.Excel.PivotItems = js.native
