...
*/
trait XlXmlImportResult extends js.Object

object XlXmlImportResult {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlXmlImportElementsTruncated: `1` = this.cast(1)
  @scala.inline
  def xlXmlImportSuccess: `0` = this.cast(0)
  @scala.inline
  def xlXmlImportValidationFailed: `2` = this.cast(2)
}
