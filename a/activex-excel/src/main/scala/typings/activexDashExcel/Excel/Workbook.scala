...
class Workbook protected () extends js.Object {
  ...
  val BuiltinDocumentProperties_Original: DocumentProperties[typings.activexDashExcel.Excel.Application] = js.native
  ...
  val CustomDocumentProperties_Original: DocumentProperties[typings.activexDashExcel.Excel.Application] = js.native
  @JSName("CustomViews")
  ...
  val Mailer: typings.activexDashExcel.Excel.Mailer = js.native
  @JSName("Modules")
  ...
  val Research: typings.activexDashExcel.Excel.Research = js.native
  val RevisionNumber: Double = js.native
  val Routed: Boolean = js.native
  val RoutingSlip: typings.activexDashExcel.Excel.RoutingSlip = js.native
  ...
  val SmartTagOptions: typings.activexDashExcel.Excel.SmartTagOptions = js.native
  @JSName("Styles")
  ...
  val WebOptions: typings.activexDashExcel.Excel.WebOptions = js.native
  @JSName("Windows")
  ...
  def BuiltinDocumentProperties(index: String): DocumentProperty[typings.activexDashExcel.Excel.Application] = js.native
  def BuiltinDocumentProperties(index: Double): DocumentProperty[typings.activexDashExcel.Excel.Application] = js.native
  ...
  def CustomDocumentProperties(index: String): DocumentProperty[typings.activexDashExcel.Excel.Application] = js.native
  def CustomDocumentProperties(index: Double): DocumentProperty[typings.activexDashExcel.Excel.Application] = js.native
  ...
  def PivotCaches(): typings.activexDashExcel.Excel.PivotCaches = js.native
