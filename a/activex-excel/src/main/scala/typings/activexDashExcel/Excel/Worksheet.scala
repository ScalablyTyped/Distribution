...
class Worksheet protected () extends Sheet {
  ...
  val Outline: typings.activexDashExcel.Excel.Outline = js.native
  ...
  def Scenarios(): typings.activexDashExcel.Excel.Scenarios = js.native
  def Scenarios(Index: String): Scenario = js.native
  def Scenarios(Index: Double): Scenario = js.native
  def Scenarios(Index: SafeArray[Double | String]): typings.activexDashExcel.Excel.Scenarios = js.native
