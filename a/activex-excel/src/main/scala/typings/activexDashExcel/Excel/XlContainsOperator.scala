...
*/
trait XlContainsOperator extends js.Object

object XlContainsOperator {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlBeginsWith: `2` = this.cast(2)
  @scala.inline
  def xlContains: `0` = this.cast(0)
  @scala.inline
  def xlDoesNotContain: `1` = this.cast(1)
  @scala.inline
  def xlEndsWith: `3` = this.cast(3)
}
