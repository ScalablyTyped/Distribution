...
trait Range extends js.Object {
  ...
  val Comment: typings.activexDashExcel.Excel.Comment = js.native
  ...
  val DisplayFormat: typings.activexDashExcel.Excel.DisplayFormat = js.native
  @JSName("EntireColumn")
  ...
  var Name: String | typings.activexDashExcel.Excel.Name = js.native
  @JSName("Next")
  ...
  val Phonetic: typings.activexDashExcel.Excel.Phonetic = js.native
  @JSName("Phonetics")
  ...
  val SoundNote: typings.activexDashExcel.Excel.SoundNote = js.native
  @JSName("SparklineGroups")
  val SparklineGroups_Original: SparklineGroups = js.native
  var Style: typings.activexDashExcel.Excel.Style = js.native
  ...
  val Validation: typings.activexDashExcel.Excel.Validation = js.native
  ...
  val Worksheet: typings.activexDashExcel.Excel.Worksheet = js.native
  ...
  def AddComment(): typings.activexDashExcel.Excel.Comment = js.native
  def AddComment(Text: String): typings.activexDashExcel.Excel.Comment = js.native
  ...
  def CopyFromRecordset(Data: typings.activexDashDao.DAO.Recordset): Double = js.native
  def CopyFromRecordset(Data: typings.activexDashDao.DAO.Recordset, MaxRows: Double): Double = js.native
  def CopyFromRecordset(Data: typings.activexDashDao.DAO.Recordset, MaxRows: Double, MaxColumns: Double): Double = js.native
  /**
  ...
  def Phonetics(Index: Double): typings.activexDashExcel.Excel.Phonetic = js.native
