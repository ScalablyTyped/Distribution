...
class PivotTable protected () extends js.Object {
  ...
  def CalculatedFields(): typings.activexDashExcel.Excel.CalculatedFields = js.native
  ...
  def PivotCache(): typings.activexDashExcel.Excel.PivotCache = js.native
  def PivotFields(Indexes: SafeArray[Double | String]): typings.activexDashExcel.Excel.PivotFields = js.native
