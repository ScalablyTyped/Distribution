...
*/
trait XlDVType extends js.Object

object XlDVType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def xlValidateCustom: `7` = this.cast(7)
  @scala.inline
  def xlValidateDate: `4` = this.cast(4)
  @scala.inline
  def xlValidateDecimal: `2` = this.cast(2)
  @scala.inline
  def xlValidateInputOnly: `0` = this.cast(0)
  @scala.inline
  def xlValidateList: `3` = this.cast(3)
  @scala.inline
  def xlValidateTextLength: `6` = this.cast(6)
  @scala.inline
  def xlValidateTime: `5` = this.cast(5)
  @scala.inline
  def xlValidateWholeNumber: `1` = this.cast(1)
}
