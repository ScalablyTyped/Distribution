...
class Axis protected () extends js.Object {
  ...
  val AxisTitle: typings.activexDashExcel.ExcelNs.AxisTitle = js.native
  ...
  val DisplayUnitLabel: typings.activexDashExcel.ExcelNs.DisplayUnitLabel = js.native
  ...
  val TickLabels: typings.activexDashExcel.ExcelNs.TickLabels = js.native
