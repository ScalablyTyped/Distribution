package typings.activexDashExcel.ExcelNs.EventHelperTypesNs
...
trait Chart_Invoke_Parameter extends js.Object {
...
object Chart_Invoke_Parameter {
  ...
  def apply(
    ...
    __obj.asInstanceOf[Chart_Invoke_Parameter]
  }
}
