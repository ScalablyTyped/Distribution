...
class PivotField protected () extends js.Object {
  ...
  val CubeField: typings.activexDashExcel.ExcelNs.CubeField = js.native
  ...
  def CalculatedItems(): typings.activexDashExcel.ExcelNs.CalculatedItems = js.native
  ...
  def PivotItems(Indexes: SafeArray[Double | String]): typings.activexDashExcel.ExcelNs.PivotItems = js.native
