...
class Application protected () extends js.Object {
  ...
  val AutoCorrect: typings.activexDashExcel.ExcelNs.AutoCorrect = js.native
  var AutoFormatAsYouTypeReplaceHyperlinks: Boolean = js.native
  var AutoPercentEntry: Boolean = js.native
  val AutoRecover: typings.activexDashExcel.ExcelNs.AutoRecover = js.native
  ...
  val DefaultWebOptions: typings.activexDashExcel.ExcelNs.DefaultWebOptions = js.native
  ...
  val ErrorCheckingOptions: typings.activexDashExcel.ExcelNs.ErrorCheckingOptions = js.native
  var `Excel.Application_typekey`: typings.activexDashExcel.ExcelNs.Application = js.native
  ...
  val MultiThreadedCalculation: typings.activexDashExcel.ExcelNs.MultiThreadedCalculation = js.native
  ...
  val Parent: typings.activexDashExcel.ExcelNs.Application = js.native
  ...
  val RTD: typings.activexDashExcel.ExcelNs.RTD = js.native
  ...
  val Speech: typings.activexDashExcel.ExcelNs.Speech = js.native
  val SpellingOptions: typings.activexDashExcel.ExcelNs.SpellingOptions = js.native
  ...
  val WorksheetFunction: typings.activexDashExcel.ExcelNs.WorksheetFunction = js.native
  @JSName("Worksheets")
