...
trait Range extends js.Object {
  ...
  val Comment: typings.activexDashExcel.ExcelNs.Comment = js.native
  ...
  val DisplayFormat: typings.activexDashExcel.ExcelNs.DisplayFormat = js.native
  @JSName("EntireColumn")
  ...
  var Name: String | typings.activexDashExcel.ExcelNs.Name = js.native
  @JSName("Next")
  ...
  val Phonetic: typings.activexDashExcel.ExcelNs.Phonetic = js.native
  @JSName("Phonetics")
  val Phonetics_Original: Phonetics = js.native
  val PivotCell: typings.activexDashExcel.ExcelNs.PivotCell = js.native
  ...
  val SoundNote: typings.activexDashExcel.ExcelNs.SoundNote = js.native
  @JSName("SparklineGroups")
  val SparklineGroups_Original: SparklineGroups = js.native
  var Style: typings.activexDashExcel.ExcelNs.Style = js.native
  ...
  val Validation: typings.activexDashExcel.ExcelNs.Validation = js.native
  ...
  val Worksheet: typings.activexDashExcel.ExcelNs.Worksheet = js.native
  ...
  def AddComment(): typings.activexDashExcel.ExcelNs.Comment = js.native
  def AddComment(Text: String): typings.activexDashExcel.ExcelNs.Comment = js.native
  ...
  def CopyFromRecordset(Data: typings.activexDashDao.DAONs.Recordset): Double = js.native
  def CopyFromRecordset(Data: typings.activexDashDao.DAONs.Recordset, MaxRows: Double): Double = js.native
  def CopyFromRecordset(Data: typings.activexDashDao.DAONs.Recordset, MaxRows: Double, MaxColumns: Double): Double = js.native
  /**
  ...
  def Phonetics(Index: Double): typings.activexDashExcel.ExcelNs.Phonetic = js.native
