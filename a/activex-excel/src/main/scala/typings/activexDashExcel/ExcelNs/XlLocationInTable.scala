...
import typings.activexDashExcel.activexDashExcelNumbers.`-4110`
import typings.activexDashExcel.activexDashExcelNumbers.`-4153`
...
/* Rewritten from type alias, can be one of: 
  - typings.activexDashExcel.activexDashExcelNumbers.`-4110`
  ...
  - typings.activexDashExcel.activexDashExcelNumbers.`-4153`
