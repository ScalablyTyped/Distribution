...
class QueryTable protected () extends js.Object {
  ...
  val ListObject: typings.activexDashExcel.ExcelNs.ListObject = js.native
  ...
  var Recordset: typings.activexDashDao.DAONs.Recordset | typings.activexDashAdodb.ADODBNs.Recordset = js.native
