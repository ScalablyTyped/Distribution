...
- typings.activexDashExcel.ExcelNs.AddSheetResult because Already inherited */ @JSGlobal("Excel.Chart")
@js.native
class Chart protected () extends Sheet {
  ...
  val BackWall: typings.activexDashExcel.ExcelNs.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typings.activexDashExcel.ExcelNs.ChartArea = js.native
  ...
  val ChartTitle: typings.activexDashExcel.ExcelNs.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val CodeName: String = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typings.activexDashExcel.ExcelNs.Corners = js.native
  val Creator: XlCreator = js.native
  val DataTable: typings.activexDashExcel.ExcelNs.DataTable = js.native
  ...
  val Floor: typings.activexDashExcel.ExcelNs.Floor = js.native
  ...
  val Legend: typings.activexDashExcel.ExcelNs.Legend = js.native
  ...
  val PivotLayout: typings.activexDashExcel.ExcelNs.PivotLayout = js.native
  val PlotArea: typings.activexDashExcel.ExcelNs.PlotArea = js.native
  ...
  val SideWall: typings.activexDashExcel.ExcelNs.Walls = js.native
  ...
  val Walls: typings.activexDashExcel.ExcelNs.Walls = js.native
  ...
  def Axes(): typings.activexDashExcel.ExcelNs.Axes | Axis = js.native
  def Axes(Type: XlAxisType): typings.activexDashExcel.ExcelNs.Axes | Axis = js.native
  def Axes(Type: XlAxisType, AxisGroup: XlAxisGroup): typings.activexDashExcel.ExcelNs.Axes | Axis = js.native
