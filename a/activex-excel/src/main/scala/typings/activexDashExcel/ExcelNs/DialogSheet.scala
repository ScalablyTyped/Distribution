...
- typings.activexDashExcel.ExcelNs.AddSheetResult because Already inherited */ @JSGlobal("Excel.DialogSheet")
@js.native
class DialogSheet protected () extends Sheet {
  ...
  val DialogFrame: typings.activexDashExcel.ExcelNs.DialogFrame = js.native
