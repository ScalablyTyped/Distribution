...
class DialogFrame protected () extends js.Object {
  ...
  def Characters(Start: js.Any): typings.activexDashExcel.ExcelNs.Characters = js.native
  def Characters(Start: js.Any, Length: js.Any): typings.activexDashExcel.ExcelNs.Characters = js.native
