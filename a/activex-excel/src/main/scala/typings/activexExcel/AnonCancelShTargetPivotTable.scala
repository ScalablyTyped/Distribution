...
trait AnonCancelShTargetPivotTable extends js.Object {
  var Cancel: Boolean
  val Sh: Worksheet
...
object AnonCancelShTargetPivotTable {
  @scala.inline
  def apply(
    Cancel: Boolean,
    Sh: Worksheet,
    ...
    __obj.asInstanceOf[AnonCancelShTargetPivotTable]
  }
}
