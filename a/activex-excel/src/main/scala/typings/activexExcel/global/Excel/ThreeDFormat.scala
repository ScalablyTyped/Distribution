...
class ThreeDFormat protected ()
  extends typings.activexExcel.Excel.ThreeDFormat {
  /* CompleteClass */
  ...
  /* CompleteClass */
  override val ContourColor: typings.activexExcel.Excel.ColorFormat = js.native
  /* CompleteClass */
  ...
  override var ExcelDotThreeDFormat_typekey: typings.activexExcel.Excel.ThreeDFormat = js.native
  /* CompleteClass */
  override val ExtrusionColor: typings.activexExcel.Excel.ColorFormat = js.native
  /* CompleteClass */
