...
import typings.activexExcel.activexExcelInts.`-4145`
import typings.activexExcel.activexExcelInts.`-4158`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexExcel.activexExcelInts.`-4145`
  - typings.activexExcel.activexExcelInts.`-4158`
*/
