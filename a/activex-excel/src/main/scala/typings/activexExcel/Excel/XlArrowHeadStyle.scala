...
*/
trait XlArrowHeadStyle extends StObject
object XlArrowHeadStyle {
  
  inline def xlArrowHeadStyleClosed: `3` = 3.asInstanceOf[`3`]
  
  inline def xlArrowHeadStyleDoubleClosed: `5` = 5.asInstanceOf[`5`]
  
  inline def xlArrowHeadStyleDoubleOpen: `4` = 4.asInstanceOf[`4`]
  
  inline def xlArrowHeadStyleNone: `-4142` = -4142.asInstanceOf[`-4142`]
  
  inline def xlArrowHeadStyleOpen: `2` = 2.asInstanceOf[`2`]
}
