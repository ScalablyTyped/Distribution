...
*/
trait XlSparkType extends js.Object
object XlSparkType {
  
  @scala.inline
  def xlSparkColumn: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlSparkColumnStacked100: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlSparkLine: `1` = 1.asInstanceOf[`1`]
}
