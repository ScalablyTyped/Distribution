...
object XlArabicModes {
  ...
  inline def xlArabicBothStrict: `3` = 3.asInstanceOf[`3`]
  
  inline def xlArabicNone: `0` = 0.asInstanceOf[`0`]
  
  inline def xlArabicStrictAlefHamza: `1` = 1.asInstanceOf[`1`]
  
  inline def xlArabicStrictFinalYaa: `2` = 2.asInstanceOf[`2`]
}
