...
*/
trait XlEnableCancelKey extends StObject
object XlEnableCancelKey {
  
  inline def xlDisabled: `0` = 0.asInstanceOf[`0`]
  
  inline def xlErrorHandler: `2` = 2.asInstanceOf[`2`]
  
  inline def xlInterrupt: `1` = 1.asInstanceOf[`1`]
}
