...
*/
trait XlDataSeriesDate extends StObject
object XlDataSeriesDate {
  
  inline def xlDay: `1` = 1.asInstanceOf[`1`]
  
  inline def xlMonth: `3` = 3.asInstanceOf[`3`]
  
  inline def xlWeekday: `2` = 2.asInstanceOf[`2`]
  
  inline def xlYear: `4` = 4.asInstanceOf[`4`]
}
