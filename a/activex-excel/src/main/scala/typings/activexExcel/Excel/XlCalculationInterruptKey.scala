...
*/
trait XlCalculationInterruptKey extends StObject
object XlCalculationInterruptKey {
  
  inline def xlAnyKey: `2` = 2.asInstanceOf[`2`]
  
  inline def xlEscKey: `1` = 1.asInstanceOf[`1`]
  
  inline def xlNoKey: `0` = 0.asInstanceOf[`0`]
}
