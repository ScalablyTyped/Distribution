...
trait LineFormat extends StObject {
  ...
  /* private */ @JSName("Excel.LineFormat_typekey")
...
object LineFormat {
  ...
  implicit open class MutableBuilder[Self <: LineFormat] (val x: Self) extends AnyVal {
    ...
    inline def setExcelDotLineFormat_typekey(value: LineFormat): Self = StObject.set(x, "Excel.LineFormat_typekey", value.asInstanceOf[js.Any])
