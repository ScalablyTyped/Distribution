...
*/
trait XlCalculationState extends StObject
object XlCalculationState {
  
  inline def xlCalculating: `1` = 1.asInstanceOf[`1`]
  
  inline def xlDone: `0` = 0.asInstanceOf[`0`]
  
  inline def xlPending: `2` = 2.asInstanceOf[`2`]
}
