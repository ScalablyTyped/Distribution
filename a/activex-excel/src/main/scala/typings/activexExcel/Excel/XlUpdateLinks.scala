...
object XlUpdateLinks {
  ...
  inline def xlUpdateLinksAlways: `3` = 3.asInstanceOf[`3`]
  
  inline def xlUpdateLinksNever: `2` = 2.asInstanceOf[`2`]
  
  inline def xlUpdateLinksUserSetting: `1` = 1.asInstanceOf[`1`]
}
