...
object XlChartPicturePlacement {
  @scala.inline
  def xlAllFaces: `7` = 7.asInstanceOf[`7`]
  @scala.inline
  def xlEnd: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def xlEndSides: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def xlFront: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def xlFrontEnd: `6` = 6.asInstanceOf[`6`]
  @scala.inline
  def xlFrontSides: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def xlSides: `1` = 1.asInstanceOf[`1`]
}
