...
object HPageBreak {
  ...
  @scala.inline
  implicit class HPageBreakMutableBuilder[Self <: HPageBreak] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcelDotHPageBreak_typekey(value: HPageBreak): Self = StObject.set(x, "Excel.HPageBreak_typekey", value.asInstanceOf[js.Any])
