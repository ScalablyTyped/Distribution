...
*/
trait XlRoutingSlipStatus extends StObject
object XlRoutingSlipStatus {
  
  inline def xlNotYetRouted: `0` = 0.asInstanceOf[`0`]
  
  inline def xlRoutingComplete: `2` = 2.asInstanceOf[`2`]
  
  inline def xlRoutingInProgress: `1` = 1.asInstanceOf[`1`]
}
