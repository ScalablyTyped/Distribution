...
object XlConditionValueTypes {
  ...
  inline def xlConditionValueAutomaticMax: `7` = 7.asInstanceOf[`7`]
  
  inline def xlConditionValueAutomaticMin: `6` = 6.asInstanceOf[`6`]
  
  inline def xlConditionValueFormula: `4` = 4.asInstanceOf[`4`]
  
  inline def xlConditionValueHighestValue: `2` = 2.asInstanceOf[`2`]
  
  inline def xlConditionValueLowestValue: `1` = 1.asInstanceOf[`1`]
  
  inline def xlConditionValueNone: `-1` = -1.asInstanceOf[`-1`]
  
  inline def xlConditionValueNumber: `0` = 0.asInstanceOf[`0`]
  
  inline def xlConditionValuePercent: `3` = 3.asInstanceOf[`3`]
  
  inline def xlConditionValuePercentile: `5` = 5.asInstanceOf[`5`]
}
