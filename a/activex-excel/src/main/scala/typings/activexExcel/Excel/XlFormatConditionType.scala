...
object XlFormatConditionType {
  ...
  inline def xlAboveAverageCondition: `12` = 12.asInstanceOf[`12`]
  
  inline def xlBlanksCondition: `10` = 10.asInstanceOf[`10`]
  
  inline def xlCellValue: `1` = 1.asInstanceOf[`1`]
  
  inline def xlColorScale: `3` = 3.asInstanceOf[`3`]
  
  inline def xlDatabar: `4` = 4.asInstanceOf[`4`]
  
  inline def xlErrorsCondition: `16` = 16.asInstanceOf[`16`]
  
  inline def xlExpression: `2` = 2.asInstanceOf[`2`]
  
  inline def xlIconSets: `6` = 6.asInstanceOf[`6`]
  
  inline def xlNoBlanksCondition: `13` = 13.asInstanceOf[`13`]
  
  inline def xlNoErrorsCondition: `17` = 17.asInstanceOf[`17`]
  
  inline def xlTextString: `9` = 9.asInstanceOf[`9`]
  
  inline def xlTimePeriod: `11` = 11.asInstanceOf[`11`]
  
  inline def xlTop10: `5` = 5.asInstanceOf[`5`]
  
  inline def xlUniqueValues: `8` = 8.asInstanceOf[`8`]
}
