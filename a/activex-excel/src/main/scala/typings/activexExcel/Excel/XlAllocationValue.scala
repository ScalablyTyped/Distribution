...
*/
trait XlAllocationValue extends StObject
object XlAllocationValue {
  
  inline def xlAllocateIncrement: `2` = 2.asInstanceOf[`2`]
  
  inline def xlAllocateValue: `1` = 1.asInstanceOf[`1`]
}
