...
object DefaultWebOptions {
  ...
  implicit class DefaultWebOptionsMutableBuilder[Self <: DefaultWebOptions] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setExcelDotDefaultWebOptions_typekey(value: DefaultWebOptions): Self = StObject.set(x, "Excel.DefaultWebOptions_typekey", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLoadPictures(value: Boolean): Self = StObject.set(x, "LoadPictures", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSaveHiddenData(value: Boolean): Self = StObject.set(x, "SaveHiddenData", value.asInstanceOf[js.Any])
