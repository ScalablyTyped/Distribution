...
object XlSparklineRowCol {
  ...
  inline def xlSparklineColumnsSquare: `2` = 2.asInstanceOf[`2`]
  
  inline def xlSparklineNonSquare: `0` = 0.asInstanceOf[`0`]
  
  inline def xlSparklineRowsSquare: `1` = 1.asInstanceOf[`1`]
}
