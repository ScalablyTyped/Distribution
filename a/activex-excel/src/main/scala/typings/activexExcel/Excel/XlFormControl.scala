...
object XlFormControl {
  ...
  inline def xlButtonControl: `0` = 0.asInstanceOf[`0`]
  
  inline def xlCheckBox: `1` = 1.asInstanceOf[`1`]
  
  inline def xlDropDown: `2` = 2.asInstanceOf[`2`]
  
  inline def xlEditBox: `3` = 3.asInstanceOf[`3`]
  
  inline def xlGroupBox: `4` = 4.asInstanceOf[`4`]
  
  inline def xlLabel: `5` = 5.asInstanceOf[`5`]
  
  inline def xlListBox: `6` = 6.asInstanceOf[`6`]
  
  inline def xlOptionButton: `7` = 7.asInstanceOf[`7`]
  
  inline def xlScrollBar: `8` = 8.asInstanceOf[`8`]
  
  inline def xlSpinner: `9` = 9.asInstanceOf[`9`]
}
