...
object XlDVType {
  ...
  inline def xlValidateCustom: `7` = 7.asInstanceOf[`7`]
  
  inline def xlValidateDate: `4` = 4.asInstanceOf[`4`]
  
  inline def xlValidateDecimal: `2` = 2.asInstanceOf[`2`]
  
  inline def xlValidateInputOnly: `0` = 0.asInstanceOf[`0`]
  
  inline def xlValidateList: `3` = 3.asInstanceOf[`3`]
  
  inline def xlValidateTextLength: `6` = 6.asInstanceOf[`6`]
  
  inline def xlValidateTime: `5` = 5.asInstanceOf[`5`]
  
  inline def xlValidateWholeNumber: `1` = 1.asInstanceOf[`1`]
}
