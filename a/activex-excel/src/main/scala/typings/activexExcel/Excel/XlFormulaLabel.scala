...
*/
trait XlFormulaLabel extends js.Object
object XlFormulaLabel {
  
  @scala.inline
  def xlColumnLabels: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def xlMixedLabels: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def xlNoLabels: `-4142` = -4142.asInstanceOf[`-4142`]
  
  @scala.inline
  def xlRowLabels: `1` = 1.asInstanceOf[`1`]
}
