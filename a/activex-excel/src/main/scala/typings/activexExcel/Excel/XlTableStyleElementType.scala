...
*/
trait XlTableStyleElementType extends StObject
object XlTableStyleElementType {
  
  inline def xlBlankRow: `19` = 19.asInstanceOf[`19`]
  
  inline def xlColumnStripe1: `7` = 7.asInstanceOf[`7`]
  
  inline def xlColumnStripe2: `8` = 8.asInstanceOf[`8`]
  
  inline def xlColumnSubheading1: `20` = 20.asInstanceOf[`20`]
  
  inline def xlColumnSubheading2: `21` = 21.asInstanceOf[`21`]
  
  inline def xlColumnSubheading3: `22` = 22.asInstanceOf[`22`]
  
  inline def xlFirstColumn: `3` = 3.asInstanceOf[`3`]
  
  inline def xlFirstHeaderCell: `9` = 9.asInstanceOf[`9`]
  
  inline def xlFirstTotalCell: `11` = 11.asInstanceOf[`11`]
  
  inline def xlGrandTotalColumn: `4` = 4.asInstanceOf[`4`]
  
  inline def xlGrandTotalRow: `2` = 2.asInstanceOf[`2`]
  
  inline def xlHeaderRow: `1` = 1.asInstanceOf[`1`]
  
  inline def xlLastColumn: `4` = 4.asInstanceOf[`4`]
  
  inline def xlLastHeaderCell: `10` = 10.asInstanceOf[`10`]
  
  inline def xlLastTotalCell: `12` = 12.asInstanceOf[`12`]
  
  inline def xlPageFieldLabels: `26` = 26.asInstanceOf[`26`]
  
  inline def xlPageFieldValues: `27` = 27.asInstanceOf[`27`]
  
  inline def xlRowStripe1: `5` = 5.asInstanceOf[`5`]
  
  inline def xlRowStripe2: `6` = 6.asInstanceOf[`6`]
  
  inline def xlRowSubheading1: `23` = 23.asInstanceOf[`23`]
  
  inline def xlRowSubheading2: `24` = 24.asInstanceOf[`24`]
  
  inline def xlRowSubheading3: `25` = 25.asInstanceOf[`25`]
  
  inline def xlSlicerHoveredSelectedItemWithData: `33` = 33.asInstanceOf[`33`]
  
  inline def xlSlicerHoveredSelectedItemWithNoData: `35` = 35.asInstanceOf[`35`]
  
  inline def xlSlicerHoveredUnselectedItemWithData: `32` = 32.asInstanceOf[`32`]
  
  inline def xlSlicerHoveredUnselectedItemWithNoData: `34` = 34.asInstanceOf[`34`]
  
  inline def xlSlicerSelectedItemWithData: `30` = 30.asInstanceOf[`30`]
  
  inline def xlSlicerSelectedItemWithNoData: `31` = 31.asInstanceOf[`31`]
  
  inline def xlSlicerUnselectedItemWithData: `28` = 28.asInstanceOf[`28`]
  
  inline def xlSlicerUnselectedItemWithNoData: `29` = 29.asInstanceOf[`29`]
  
  inline def xlSubtotalColumn1: `13` = 13.asInstanceOf[`13`]
  
  inline def xlSubtotalColumn2: `14` = 14.asInstanceOf[`14`]
  
  inline def xlSubtotalColumn3: `15` = 15.asInstanceOf[`15`]
  
  inline def xlSubtotalRow1: `16` = 16.asInstanceOf[`16`]
  
  inline def xlSubtotalRow2: `17` = 17.asInstanceOf[`17`]
  
  inline def xlSubtotalRow3: `18` = 18.asInstanceOf[`18`]
  
  inline def xlTotalRow: `2` = 2.asInstanceOf[`2`]
  
  inline def xlWholeTable: `0` = 0.asInstanceOf[`0`]
}
