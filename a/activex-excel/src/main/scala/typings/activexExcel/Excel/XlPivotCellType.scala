...
*/
trait XlPivotCellType extends StObject
object XlPivotCellType {
  
  inline def xlPivotCellBlankCell: `9` = 9.asInstanceOf[`9`]
  
  inline def xlPivotCellCustomSubtotal: `7` = 7.asInstanceOf[`7`]
  
  inline def xlPivotCellDataField: `4` = 4.asInstanceOf[`4`]
  
  inline def xlPivotCellDataPivotField: `8` = 8.asInstanceOf[`8`]
  
  inline def xlPivotCellGrandTotal: `3` = 3.asInstanceOf[`3`]
  
  inline def xlPivotCellPageFieldItem: `6` = 6.asInstanceOf[`6`]
  
  inline def xlPivotCellPivotField: `5` = 5.asInstanceOf[`5`]
  
  inline def xlPivotCellPivotItem: `1` = 1.asInstanceOf[`1`]
  
  inline def xlPivotCellSubtotal: `2` = 2.asInstanceOf[`2`]
  
  inline def xlPivotCellValue: `0` = 0.asInstanceOf[`0`]
}
