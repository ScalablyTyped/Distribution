...
object XlTimePeriods {
  ...
  inline def xlLast7Days: `2` = 2.asInstanceOf[`2`]
  
  inline def xlLastMonth: `5` = 5.asInstanceOf[`5`]
  
  inline def xlLastWeek: `4` = 4.asInstanceOf[`4`]
  
  inline def xlNextMonth: `8` = 8.asInstanceOf[`8`]
  
  inline def xlNextWeek: `7` = 7.asInstanceOf[`7`]
  
  inline def xlThisMonth: `9` = 9.asInstanceOf[`9`]
  
  inline def xlThisWeek: `3` = 3.asInstanceOf[`3`]
  
  inline def xlToday: `0` = 0.asInstanceOf[`0`]
  
  inline def xlTomorrow: `6` = 6.asInstanceOf[`6`]
  
  inline def xlYesterday: `1` = 1.asInstanceOf[`1`]
}
