...
*/
trait XlCubeFieldSubType extends StObject
object XlCubeFieldSubType {
  
  inline def xlCubeAttribute: `4` = 4.asInstanceOf[`4`]
  
  inline def xlCubeCalculatedMeasure: `5` = 5.asInstanceOf[`5`]
  
  inline def xlCubeHierarchy: `1` = 1.asInstanceOf[`1`]
  
  inline def xlCubeKPIGoal: `7` = 7.asInstanceOf[`7`]
  
  inline def xlCubeKPIStatus: `8` = 8.asInstanceOf[`8`]
  
  inline def xlCubeKPITrend: `9` = 9.asInstanceOf[`9`]
  
  inline def xlCubeKPIValue: `6` = 6.asInstanceOf[`6`]
  
  inline def xlCubeKPIWeight: `10` = 10.asInstanceOf[`10`]
  
  inline def xlCubeMeasure: `2` = 2.asInstanceOf[`2`]
  
  inline def xlCubeSet: `3` = 3.asInstanceOf[`3`]
}
