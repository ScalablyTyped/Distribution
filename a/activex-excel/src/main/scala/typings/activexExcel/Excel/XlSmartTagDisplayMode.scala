...
*/
trait XlSmartTagDisplayMode extends StObject
object XlSmartTagDisplayMode {
  
  inline def xlButtonOnly: `2` = 2.asInstanceOf[`2`]
  
  inline def xlDisplayNone: `1` = 1.asInstanceOf[`1`]
  
  inline def xlIndicatorAndButton: `0` = 0.asInstanceOf[`0`]
}
