...
*/
trait XlPropertyDisplayedIn extends StObject
object XlPropertyDisplayedIn {
  
  inline def xlDisplayPropertyInPivotTable: `1` = 1.asInstanceOf[`1`]
  
  inline def xlDisplayPropertyInPivotTableAndTooltip: `3` = 3.asInstanceOf[`3`]
  
  inline def xlDisplayPropertyInTooltip: `2` = 2.asInstanceOf[`2`]
}
