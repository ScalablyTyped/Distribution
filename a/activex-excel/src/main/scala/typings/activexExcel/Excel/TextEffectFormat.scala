...
trait TextEffectFormat extends StObject {
  ...
  /* private */ @JSName("Excel.TextEffectFormat_typekey")
...
object TextEffectFormat {
  ...
  extension [Self <: TextEffectFormat](x: Self) {
    ...
    inline def setExcelDotTextEffectFormat_typekey(value: TextEffectFormat): Self = StObject.set(x, "Excel.TextEffectFormat_typekey", value.asInstanceOf[js.Any])
