...
*/
trait XlTotalsCalculation extends js.Object

object XlTotalsCalculation {
  @scala.inline
  def xlTotalsCalculationAverage: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def xlTotalsCalculationCount: `3` = 3.asInstanceOf[`3`]
  @scala.inline
  def xlTotalsCalculationCountNums: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def xlTotalsCalculationCustom: `9` = 9.asInstanceOf[`9`]
  @scala.inline
  def xlTotalsCalculationMax: `6` = 6.asInstanceOf[`6`]
  @scala.inline
  def xlTotalsCalculationMin: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def xlTotalsCalculationNone: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def xlTotalsCalculationStdDev: `7` = 7.asInstanceOf[`7`]
  @scala.inline
  def xlTotalsCalculationSum: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def xlTotalsCalculationVar: `8` = 8.asInstanceOf[`8`]
}
