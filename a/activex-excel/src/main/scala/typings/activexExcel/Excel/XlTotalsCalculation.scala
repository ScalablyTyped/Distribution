...
*/
trait XlTotalsCalculation extends StObject
object XlTotalsCalculation {
  
  inline def xlTotalsCalculationAverage: `2` = 2.asInstanceOf[`2`]
  
  inline def xlTotalsCalculationCount: `3` = 3.asInstanceOf[`3`]
  
  inline def xlTotalsCalculationCountNums: `4` = 4.asInstanceOf[`4`]
  
  inline def xlTotalsCalculationCustom: `9` = 9.asInstanceOf[`9`]
  
  inline def xlTotalsCalculationMax: `6` = 6.asInstanceOf[`6`]
  
  inline def xlTotalsCalculationMin: `5` = 5.asInstanceOf[`5`]
  
  inline def xlTotalsCalculationNone: `0` = 0.asInstanceOf[`0`]
  
  inline def xlTotalsCalculationStdDev: `7` = 7.asInstanceOf[`7`]
  
  inline def xlTotalsCalculationSum: `1` = 1.asInstanceOf[`1`]
  
  inline def xlTotalsCalculationVar: `8` = 8.asInstanceOf[`8`]
}
