...
import typings.activexExcel.activexExcelNumbers.`48`
...
trait Chart extends Sheet {
  ...
  def Axes(Type: js.UndefOr[scala.Nothing], AxisGroup: XlAxisGroup): typings.activexExcel.Excel.Axes | Axis = js.native
