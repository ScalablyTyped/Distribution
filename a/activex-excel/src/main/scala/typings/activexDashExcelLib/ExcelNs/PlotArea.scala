...
class PlotArea protected () extends js.Object {
  ...
  val _InsideHeight: scala.Double = js.native
  val _InsideLeft: scala.Double = js.native
  val _InsideTop: scala.Double = js.native
  val _InsideWidth: scala.Double = js.native
