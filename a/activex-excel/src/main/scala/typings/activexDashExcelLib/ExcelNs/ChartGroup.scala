...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: activexDashExcelLib.ExcelNs.DownBars = js.native
  val DropLines: activexDashExcelLib.ExcelNs.DropLines = js.native
  ...
  val HiLoLines: activexDashExcelLib.ExcelNs.HiLoLines = js.native
  ...
  val SeriesLines: activexDashExcelLib.ExcelNs.SeriesLines = js.native
  ...
  val UpBars: activexDashExcelLib.ExcelNs.UpBars = js.native
