...
class Trendline protected () extends js.Object {
  ...
  var Forward2: scala.Double = js.native
  val Index: scala.Double = js.native
  var Intercept: scala.Double = js.native
  var InterceptIsAuto: scala.Boolean = js.native
  var Name: java.lang.String = js.native
  var NameIsAuto: scala.Boolean = js.native
