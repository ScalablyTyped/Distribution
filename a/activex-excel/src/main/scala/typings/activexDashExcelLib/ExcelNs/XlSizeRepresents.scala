...
object XlSizeRepresents {
  ...
  @scala.inline
  def xlSizeIsArea: activexDashExcelLib.activexDashExcelLibNumbers.`1` = this.cast(1)
  @scala.inline
  def xlSizeIsWidth: activexDashExcelLib.activexDashExcelLibNumbers.`2` = this.cast(2)
}
