...
class RangeCls protected ()
  extends typings.ace.AceAjax.Range {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def clipRows(firstRow: Double, lastRow: Double): typings.ace.AceAjax.Range = js.native
  /**
    * Returns a range containing the starting and ending rows of the original range, but with a column value of `0`.
    **/
  /* CompleteClass */
  override def collapseRows(): typings.ace.AceAjax.Range = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def comparePoint(p: typings.ace.AceAjax.Range): Double = js.native
  /**
    * Compares `this` range (A) with another range (B).
    * @param range A range to compare with
    **/
  /* CompleteClass */
  override def compareRange(range: typings.ace.AceAjax.Range): Double = js.native
  /**
    * Checks the row and column points with the row and column points of the calling range.
    * @param row A row point to compare with
    * @param column A column point to compare with
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def containsRange(range: typings.ace.AceAjax.Range): Boolean = js.native
  /**
    ...
    **/
  /* CompleteClass */
  override def extend(row: Double, column: Double): typings.ace.AceAjax.Range = js.native
  /**
    ...
    **/
  /* CompleteClass */
  override def fromPoints(start: typings.ace.AceAjax.Range, end: typings.ace.AceAjax.Range): typings.ace.AceAjax.Range = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def intersects(range: typings.ace.AceAjax.Range): Boolean = js.native
  /* CompleteClass */
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def isEqual(range: typings.ace.AceAjax.Range): Unit = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def toScreenRange(session: IEditSession): typings.ace.AceAjax.Range = js.native
}
