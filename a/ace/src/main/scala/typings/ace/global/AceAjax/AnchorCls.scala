...
class AnchorCls protected ()
  extends typings.ace.AceAjax.Anchor {
  /**
    ...
    **/
  def this(doc: typings.ace.AceAjax.Document, row: Double, column: Double) = this()
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getDocument(): typings.ace.AceAjax.Document = js.native
  /**
