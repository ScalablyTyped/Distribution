...
class BackgroundTokenizerCls protected ()
  extends typings.ace.AceAjax.BackgroundTokenizer {
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def setDocument(doc: typings.ace.AceAjax.Document): Unit = js.native
  /**
    * Sets a new tokenizer for this object.
    * @param tokenizer The new tokenizer to use
    **/
  /* CompleteClass */
  override def setTokenizer(tokenizer: typings.ace.AceAjax.Tokenizer): Unit = js.native
  /**
