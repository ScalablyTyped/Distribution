...
/**
  ...
  **/
class DocumentCls ()
  extends typings.ace.AceAjax.Document {
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def getTextRange(range: typings.ace.AceAjax.Range): String = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def remove(range: typings.ace.AceAjax.Range): js.Any = js.native
  /**
  ...
  /**
    ...
    **/
  /* CompleteClass */
  override def replace(range: typings.ace.AceAjax.Range, text: String): js.Any = js.native
  /**
