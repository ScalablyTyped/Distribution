...
trait IEditSession extends OptionProvider {
  ...
  /**
    ...
    **/
  def getTokenAt(row: Double, column: Double): TokenInfo | Null = js.native
  /**
  ...
  /**
    ...
    * @param inFront Set to `true` to establish a front marker
    **/
  def highlightLines(startRow: Double, endRow: Double, clazz: String, inFront: Boolean): Range = js.native
  /**
