...
trait EventMap extends js.Object {
  var hide: Event_[typings.amapJsApiScale.amapJsApiScaleStrings.hide, js.UndefOr[scala.Nothing]]
  var show: Event_[typings.amapJsApiScale.amapJsApiScaleStrings.show, js.UndefOr[scala.Nothing]]
}
