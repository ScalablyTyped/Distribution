...
/* Inlined parent std.Partial<asn1js.asn1js.ILocalRelativeSidValueBlock> */
trait LocalRelativeSidValueBlockParams extends StObject {
...
object LocalRelativeSidValueBlockParams {
  
  inline def apply(): LocalRelativeSidValueBlockParams = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LocalRelativeSidValueBlockParams]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LocalRelativeSidValueBlockParams] (val x: Self) extends AnyVal {
