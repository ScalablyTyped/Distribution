...
- typings.asn1js.mod.LocalStringValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined valueHex, value */ trait LocalSimpleStringBlockParams
  extends StObject
