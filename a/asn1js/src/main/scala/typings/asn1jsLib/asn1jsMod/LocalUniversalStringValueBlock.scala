...
@JSImport("asn1js", "LocalUniversalStringValueBlock")
@js.native
class LocalUniversalStringValueBlock ()
  extends asn1jsLib.asn1jsMod.Asn1jsNs.LocalUniversalStringValueBlock {
  def this(params: asn1jsLib.asn1jsMod.Asn1jsNs.LocalUniversalStringValueParams) = this()
  /* CompleteClass */
