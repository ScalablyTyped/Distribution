...
@js.native
class LocalEndOfContentValueBlock ()
  extends asn1jsLib.asn1jsMod.Asn1jsNs.LocalEndOfContentValueBlock {
  def this(params: asn1jsLib.asn1jsMod.Asn1jsNs.LocalEndOfContentValueBlockParams) = this()
  /* CompleteClass */
