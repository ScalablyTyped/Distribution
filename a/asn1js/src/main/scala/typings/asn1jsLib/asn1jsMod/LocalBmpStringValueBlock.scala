...
@JSImport("asn1js", "LocalBmpStringValueBlock")
@js.native
class LocalBmpStringValueBlock ()
  extends asn1jsLib.asn1jsMod.Asn1jsNs.LocalBmpStringValueBlock {
  def this(params: asn1jsLib.asn1jsMod.Asn1jsNs.LocalBmpStringValueBlockParams) = this()
  /* CompleteClass */
