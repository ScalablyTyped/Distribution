...
@js.native
class namespaced protected () extends Awesomplete {
  def this(input: java.lang.String) = this()
  def this(input: stdLib.Element) = this()
  def this(input: stdLib.HTMLElement) = this()
  def this(input: java.lang.String, o: awesompleteLib.awesompleteMod.AwesompleteNs.Options) = this()
  def this(input: stdLib.Element, o: awesompleteLib.awesompleteMod.AwesompleteNs.Options) = this()
