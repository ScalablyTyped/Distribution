...
/* Inlined axios.axios.RawAxiosRequestHeaders & axios.axios.AxiosHeaders */
@js.native
trait AxiosRequestHeaders
  extends StObject
     with /* key */ StringDictionary[Any] {
  
  var Accept: js.UndefOr[AxiosHeaderValue] = js.native
  
  var Authorization: js.UndefOr[AxiosHeaderValue] = js.native
  
  var `Content-Encoding`: js.UndefOr[AxiosHeaderValue] = js.native
  
  var `Content-Length`: js.UndefOr[AxiosHeaderValue] = js.native
  
  var `Content-Type`: js.UndefOr[ContentType] = js.native
  
  var `User-Agent`: js.UndefOr[AxiosHeaderValue] = js.native
