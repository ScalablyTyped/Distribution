...
version := "3.190.0-840220"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "aws-sdk__client-sso" % "3.190.0-e1b27b",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-imds" % "3.190.0-cd646c",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-ini" % "3.190.0-1974d7",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-sso" % "3.190.0-afea9a",
