...
object defaultProviderMod {
  ...
  - typings.awsSdkSharedIniFileLoader.loadSharedConfigFilesMod.SharedConfigInit because Already inherited
  - typings.awsSdkSharedIniFileLoader.parseKnownFilesMod.SourceProfileInit because Already inherited
  - typings.awsSdkCredentialProviderWebIdentity.fromTokenFileMod.FromTokenFileInit because var conflicts: roleAssumerWithWebIdentity. Inlined webIdentityTokenFile, PolicyArns, WebIdentityToken, roleSessionName, DurationSeconds, RoleSessionName, Policy, ProviderId, RoleArn
  - typings.awsSdkCredentialProviderSso.fromSSOMod.FromSSOInit because var conflicts: configFilepath, filepath, profile. Inlined ssoClient */ trait DefaultProviderInit
    extends StObject
       with FromIniInit
