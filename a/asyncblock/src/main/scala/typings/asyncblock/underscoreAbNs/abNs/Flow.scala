package typings.asyncblock.underscoreAbNs.abNs

import typings.asyncblock.Anon_Key
...
trait Flow extends js.Object {
  ...
  def on(event: String, handler: js.Function1[/* info */ Anon_Key, Unit]): Unit = js.native
