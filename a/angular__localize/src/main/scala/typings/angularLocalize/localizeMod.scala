...
object localizeMod {
  ...
  @JSImport("@angular/localize/localize", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@angular/localize/localize", "\u0275_global")
  @js.native
  val ɵGlobal: Any = js.native
  
  @JSImport("@angular/localize/localize", "\u0275MissingTranslationError")
  @js.native
  ...
  @JSImport("@angular/localize/localize", "\u0275$localize")
  @js.native
