...
object toolsSrcTranslateSourceFilesEs5TranslatePluginMod {
  ...
  inline def makeEs5TranslatePlugin(diagnostics: Diagnostics, translations: Record[String, ɵParsedTranslation]): PluginObj[PluginPass] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeEs5TranslatePlugin")(diagnostics.asInstanceOf[js.Any], translations.asInstanceOf[js.Any])).asInstanceOf[PluginObj[PluginPass]]
