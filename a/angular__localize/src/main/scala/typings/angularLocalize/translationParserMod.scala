...
object translationParserMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularLocalize.translationParserMod.CanParseAnalysis[Hint]
    - typings.angularLocalize.translationParserMod.CannotParseAnalysis
  */
  trait ParseAnalysis[Hint] extends StObject
  object ParseAnalysis {
    
    inline def CanParseAnalysis[Hint](diagnostics: Diagnostics, hint: Hint): typings.angularLocalize.translationParserMod.CanParseAnalysis[Hint] = {
      val __obj = js.Dynamic.literal(canParse = true, diagnostics = diagnostics.asInstanceOf[js.Any], hint = hint.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularLocalize.translationParserMod.CanParseAnalysis[Hint]]
    }
    
    inline def CannotParseAnalysis(diagnostics: Diagnostics): typings.angularLocalize.translationParserMod.CannotParseAnalysis = {
      val __obj = js.Dynamic.literal(canParse = false, diagnostics = diagnostics.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularLocalize.translationParserMod.CannotParseAnalysis]
    }
  }
