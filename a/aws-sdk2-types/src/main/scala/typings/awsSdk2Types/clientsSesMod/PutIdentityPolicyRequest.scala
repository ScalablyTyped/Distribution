...
trait PutIdentityPolicyRequest extends StObject {
  ...
  /**
    ...
    */
  var Policy: typings.awsSdk2Types.clientsSesMod.Policy
  
  /**
    * The name of the policy. The policy name cannot exceed 64 characters and can only include alphanumeric characters, dashes, and underscores.
    */
  var PolicyName: typings.awsSdk2Types.clientsSesMod.PolicyName
}
object PutIdentityPolicyRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutIdentityPolicyRequest] (val x: Self) extends AnyVal {
