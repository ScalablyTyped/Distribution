...
trait ListIdentitiesRequest extends StObject {
  ...
  /**
    ...
    */
  var IdentityType: js.UndefOr[typings.awsSdk2Types.clientsSesMod.IdentityType] = js.undefined
  
  /**
    * The maximum number of identities per page. Possible values are 1-1000 inclusive.
    */
  var MaxItems: js.UndefOr[typings.awsSdk2Types.clientsSesMod.MaxItems] = js.undefined
