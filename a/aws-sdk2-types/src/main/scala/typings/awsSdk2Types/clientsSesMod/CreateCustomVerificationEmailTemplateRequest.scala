...
trait CreateCustomVerificationEmailTemplateRequest extends StObject {
  ...
  /**
    ...
    */
  var FailureRedirectionURL: typings.awsSdk2Types.clientsSesMod.FailureRedirectionURL
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: typings.awsSdk2Types.clientsSesMod.SuccessRedirectionURL
  
  /**
    * The content of the custom verification email. The total size of the email must be less than 10 MB. The message body may contain HTML, with some limitations. For more information, see Custom Verification Email Frequently Asked Questions in the Amazon SES Developer Guide.
    */
  var TemplateContent: typings.awsSdk2Types.clientsSesMod.TemplateContent
