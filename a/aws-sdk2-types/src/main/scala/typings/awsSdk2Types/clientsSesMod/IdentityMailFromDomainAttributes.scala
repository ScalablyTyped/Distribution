...
trait IdentityMailFromDomainAttributes extends StObject {
  ...
  /**
    ...
    */
  var BehaviorOnMXFailure: typings.awsSdk2Types.clientsSesMod.BehaviorOnMXFailure
...
object IdentityMailFromDomainAttributes {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: IdentityMailFromDomainAttributes] (val x: Self) extends AnyVal {
    ...
    inline def setMailFromDomainStatus(value: CustomMailFromStatus): Self = StObject.set(x, "MailFromDomainStatus", value.asInstanceOf[js.Any])
  }
}
