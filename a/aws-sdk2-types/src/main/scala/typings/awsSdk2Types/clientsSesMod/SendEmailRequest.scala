...
trait SendEmailRequest extends StObject {
  ...
  /**
    ...
    */
  var Destination: typings.awsSdk2Types.clientsSesMod.Destination
  
  /**
    * The message to be sent.
    */
  var Message: typings.awsSdk2Types.clientsSesMod.Message
...
object SendEmailRequest {
  ...
  inline def apply(Destination: Destination, Message: Message, Source: Address): SendEmailRequest = {
