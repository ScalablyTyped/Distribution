...
trait IdentityVerificationAttributes extends StObject {
  ...
  /**
    ...
    */
  var VerificationStatus: typings.awsSdk2Types.clientsSesMod.VerificationStatus
  
  /**
    * The verification token for a domain identity. Null for email address identities.
    */
  var VerificationToken: js.UndefOr[typings.awsSdk2Types.clientsSesMod.VerificationToken] = js.undefined
}
