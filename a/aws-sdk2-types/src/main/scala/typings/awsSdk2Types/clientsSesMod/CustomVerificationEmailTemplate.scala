...
trait CustomVerificationEmailTemplate extends StObject {
  ...
  /**
    ...
    */
  var TemplateName: js.UndefOr[typings.awsSdk2Types.clientsSesMod.TemplateName] = js.undefined
...
object CustomVerificationEmailTemplate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CustomVerificationEmailTemplate] (val x: Self) extends AnyVal {
