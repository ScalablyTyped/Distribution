...
object libDynamodbConverterMod {
  ...
  @JSImport("aws-sdk2-types/lib/dynamodb/converter", "Converter")
  @js.native
  ...
  object Converter {
    ...
    type ConverterOptions = typings.awsSdk2Types.libDynamodbDocumentClientMod.DocumentClient.ConverterOptions
  }
}
