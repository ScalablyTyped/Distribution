...
import typings.awsSdk2Types.awsSdk2TypesStrings.httpUploadProgress
import typings.awsSdk2Types.clientsS3Mod.PutObjectRequest
import typings.awsSdk2Types.clientsS3Mod.Tag
...
import typings.awsSdk2Types.libS3ManagedUploadMod.ManagedUpload.Progress
import typings.awsSdk2Types.libS3ManagedUploadMod.ManagedUpload.SendData
...
object libS3ManagedUploadMod {
  ...
  @JSImport("aws-sdk2-types/lib/s3/managed_upload", "ManagedUpload")
  @js.native
  ...
  object ManagedUpload {
    ...
    /**
      * Default value: 10000
      */
    @JSImport("aws-sdk2-types/lib/s3/managed_upload", "ManagedUpload.maxTotalParts")
    @js.native
    ...
    /**
      ...
      * 1024 * 5
      */
    @JSImport("aws-sdk2-types/lib/s3/managed_upload", "ManagedUpload.minPartSize")
    @js.native
    ...
    trait ManagedUploadOptions extends StObject {
      ...
      /**
        ...
        */
      var service: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.^] = js.undefined
    ...
    object ManagedUploadOptions {
      ...
      implicit open class MutableBuilder[Self <: ManagedUploadOptions] (val x: Self) extends AnyVal {
        ...
        inline def setService(value: typings.awsSdk2Types.clientsS3Mod.^): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
