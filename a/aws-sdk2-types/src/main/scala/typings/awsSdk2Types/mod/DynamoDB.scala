...
@JSImport("aws-sdk2-types", "DynamoDB")
@js.native
/**
  * Constructs a service object. This object has one method for each API operation.
  */
open class DynamoDB ()
  extends typings.awsSdk2Types.clientsAllMod.DynamoDB {
  def this(options: ClientConfiguration) = this()
}
object DynamoDB {
  
  @JSImport("aws-sdk2-types", "DynamoDB.Converter")
  @js.native
  open class Converter ()
    extends typings.awsSdk2Types.clientsAllMod.DynamoDB.Converter
  /* static members */
  object Converter {
  ...
  @JSImport("aws-sdk2-types", "DynamoDB.DocumentClient")
  @js.native
  /**
    * Creates a DynamoDB document client with a set of configuration options.
    */
  open class DocumentClient ()
    extends typings.awsSdk2Types.clientsAllMod.DynamoDB.DocumentClient {
