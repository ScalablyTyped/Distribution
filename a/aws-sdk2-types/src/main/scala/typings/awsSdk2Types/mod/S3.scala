...
@JSImport("aws-sdk2-types", "S3")
@js.native
/**
  * Constructs a service object. This object has one method for each API operation.
  */
open class S3 ()
  extends typings.awsSdk2Types.clientsAllMod.S3 {
  def this(options: ClientConfiguration) = this()
}
object S3 {
  
  @JSImport("aws-sdk2-types", "S3.ManagedUpload")
  @js.native
  open class ManagedUpload protected ()
    extends typings.awsSdk2Types.clientsAllMod.S3.ManagedUpload {
    /**
  ...
  object ManagedUpload {
    ...
    /**
      * Default value: 10000
      */
    @JSImport("aws-sdk2-types", "S3.ManagedUpload.maxTotalParts")
    @js.native
    ...
    /**
      ...
      * 1024 * 5
      */
    @JSImport("aws-sdk2-types", "S3.ManagedUpload.minPartSize")
    @js.native
  ...
  @JSImport("aws-sdk2-types", "S3.PresignedPost")
  @js.native
  open class PresignedPost ()
    extends typings.awsSdk2Types.clientsAllMod.S3.PresignedPost
}
