...
import typings.awsSdk2Types.awsSdk2TypesStrings.legacy
import typings.awsSdk2Types.awsSdk2TypesStrings.regional
import typings.awsSdk2Types.awsSdk2TypesStrings.v2
import typings.awsSdk2Types.awsSdk2TypesStrings.v3
import typings.awsSdk2Types.awsSdk2TypesStrings.v4
import typings.awsSdk2Types.clientsDynamodbMod.ClientConfiguration
import typings.awsSdk2Types.libConfigBaseMod.HTTPOptions
import typings.awsSdk2Types.libConfigBaseMod.Logger
import typings.awsSdk2Types.libConfigBaseMod.ParamValidation
import typings.awsSdk2Types.libConfigBaseMod.RetryDelayOptions
import typings.awsSdk2Types.libConfigServicePlaceholdersMod.ConfigurationServiceApiVersions
import typings.awsSdk2Types.libCredentialsCredentialProviderChainMod.CredentialProviderChain
...
import typings.awsSdk2Types.libTokenTokenProviderChainMod.TokenProviderChain
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined aws-sdk2-types.aws-sdk2-types/lib/config-base.ConfigurationOptions & aws-sdk2-types.aws-sdk2-types/lib/config_service_placeholders.ConfigurationServicePlaceholders & aws-sdk2-types.aws-sdk2-types/lib/config.APIVersions & {[key: string] : any} */
trait ConfigurationOptionsConfi
  ...
  var dynamodb: js.UndefOr[ClientConfiguration] = js.undefined
  ...
  var rdsdataservice: js.UndefOr[typings.awsSdk2Types.clientsRdsdataserviceMod.ClientConfiguration] = js.undefined
  ...
  var s3: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.ClientConfiguration] = js.undefined
  ...
  /**
    ...
    * Defaults to 'legacy'
    */
  var s3UsEast1RegionalEndpoint: js.UndefOr[regional | legacy] = js.undefined
  ...
  var ses: js.UndefOr[typings.awsSdk2Types.clientsSesMod.ClientConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var signatureVersion: js.UndefOr[v2 | v3 | v4 | String] = js.undefined
  ...
  var ssm: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.ClientConfiguration] = js.undefined
  
  /**
    * Whether to send sts request to global endpoints or
    * regional endpoints. 
    */
  var stsRegionalEndpoints: js.UndefOr[legacy | regional] = js.undefined
...
object ConfigurationOptionsConfi {
  ...
  inline def apply(): ConfigurationOptionsConfi = {
  ...
  implicit open class MutableBuilder[Self <: ConfigurationOptionsConfi] (val x: Self) extends AnyVal {
    ...
    inline def setDynamodb(value: ClientConfiguration): Self = StObject.set(x, "dynamodb", value.asInstanceOf[js.Any])
    ...
    inline def setRdsdataservice(value: typings.awsSdk2Types.clientsRdsdataserviceMod.ClientConfiguration): Self = StObject.set(x, "rdsdataservice", value.asInstanceOf[js.Any])
    ...
    inline def setS3(value: typings.awsSdk2Types.clientsS3Mod.ClientConfiguration): Self = StObject.set(x, "s3", value.asInstanceOf[js.Any])
    ...
    inline def setS3UsEast1RegionalEndpoint(value: regional | legacy): Self = StObject.set(x, "s3UsEast1RegionalEndpoint", value.asInstanceOf[js.Any])
    ...
    inline def setSes(value: typings.awsSdk2Types.clientsSesMod.ClientConfiguration): Self = StObject.set(x, "ses", value.asInstanceOf[js.Any])
    ...
    inline def setSignatureVersion(value: v2 | v3 | v4 | String): Self = StObject.set(x, "signatureVersion", value.asInstanceOf[js.Any])
    ...
    inline def setSsm(value: typings.awsSdk2Types.clientsSsmMod.ClientConfiguration): Self = StObject.set(x, "ssm", value.asInstanceOf[js.Any])
    
    inline def setSsmUndefined: Self = StObject.set(x, "ssm", js.undefined)
    
    inline def setStsRegionalEndpoints(value: legacy | regional): Self = StObject.set(x, "stsRegionalEndpoints", value.asInstanceOf[js.Any])
