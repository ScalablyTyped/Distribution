...
trait PatchRule extends StObject {
  ...
  /**
    ...
    */
  var ApproveAfterDays: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.ApproveAfterDays] = js.undefined
  ...
  /**
    ...
    */
  var PatchFilterGroup: typings.awsSdk2Types.clientsSsmMod.PatchFilterGroup
}
object PatchRule {
