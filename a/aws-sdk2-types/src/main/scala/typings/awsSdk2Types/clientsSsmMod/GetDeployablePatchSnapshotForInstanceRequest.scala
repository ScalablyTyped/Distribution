...
trait GetDeployablePatchSnapshotForInstanceRequest extends StObject {
  ...
  /**
    ...
    */
  var BaselineOverride: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.BaselineOverride] = js.undefined
  ...
  /**
    ...
    */
  var SnapshotId: typings.awsSdk2Types.clientsSsmMod.SnapshotId
}
