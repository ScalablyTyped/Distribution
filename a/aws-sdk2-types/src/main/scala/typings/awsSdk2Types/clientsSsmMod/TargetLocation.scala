...
trait TargetLocation extends StObject {
  ...
  /**
    ...
    */
  var Accounts: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.Accounts] = js.undefined
  
  /**
    * The Automation execution role used by the currently running Automation. If not specified, the default value is AWS-SystemsManager-AutomationExecutionRole.
    */
  var ExecutionRoleName: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.ExecutionRoleName] = js.undefined
  
  /**
    * The Amazon Web Services Regions targeted by the current Automation execution.
    */
  var Regions: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.Regions] = js.undefined
