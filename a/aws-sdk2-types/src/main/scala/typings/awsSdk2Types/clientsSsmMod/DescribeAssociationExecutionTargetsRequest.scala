...
trait DescribeAssociationExecutionTargetsRequest extends StObject {
  ...
  /**
    ...
    */
  var AssociationId: typings.awsSdk2Types.clientsSsmMod.AssociationId
...
object DescribeAssociationExecutionTargetsRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeAssociationExecutionTargetsRequest] (val x: Self) extends AnyVal {
