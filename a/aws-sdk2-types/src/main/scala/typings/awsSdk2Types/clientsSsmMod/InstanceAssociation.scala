...
trait InstanceAssociation extends StObject {
  ...
  /**
    * The association ID.
    */
  var AssociationId: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.AssociationId] = js.undefined
  
  /**
    * Version information for the association on the managed node.
    */
  var AssociationVersion: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.AssociationVersion] = js.undefined
...
object InstanceAssociation {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstanceAssociation] (val x: Self) extends AnyVal {
