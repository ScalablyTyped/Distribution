...
trait DescribePatchPropertiesRequest extends StObject {
  ...
  /**
    ...
    */
  var OperatingSystem: typings.awsSdk2Types.clientsSsmMod.OperatingSystem
  
  /**
    * Indicates whether to list patches for the Windows operating system or for applications released by Microsoft. Not applicable for the Linux or macOS operating systems.
    */
  var PatchSet: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.PatchSet] = js.undefined
