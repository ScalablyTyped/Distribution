...
trait CompliantSummary extends StObject {
  ...
  /**
    ...
    */
  var SeveritySummary: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.SeveritySummary] = js.undefined
}
object CompliantSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CompliantSummary] (val x: Self) extends AnyVal {
