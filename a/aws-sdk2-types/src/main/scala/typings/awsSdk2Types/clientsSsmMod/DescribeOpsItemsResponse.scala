...
trait DescribeOpsItemsResponse extends StObject {
  ...
  /**
    * A list of OpsItems.
    */
  var OpsItemSummaries: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.OpsItemSummaries] = js.undefined
}
object DescribeOpsItemsResponse {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: DescribeOpsItemsResponse] (val x: Self) extends AnyVal {
