...
trait GetDeployablePatchSnapshotForInstanceResult extends StObject {
  ...
  /**
    ...
    */
  var Product: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.Product] = js.undefined
  
  /**
    * A pre-signed Amazon Simple Storage Service (Amazon S3) URL that can be used to download the patch snapshot.
    */
  var SnapshotDownloadUrl: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.SnapshotDownloadUrl] = js.undefined
  
  /**
    * The user-defined snapshot ID.
    */
  var SnapshotId: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.SnapshotId] = js.undefined
}
