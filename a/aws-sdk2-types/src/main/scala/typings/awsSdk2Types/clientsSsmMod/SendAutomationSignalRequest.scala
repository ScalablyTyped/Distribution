...
trait SendAutomationSignalRequest extends StObject {
  ...
  /**
    ...
    */
  var SignalType: typings.awsSdk2Types.clientsSsmMod.SignalType
}
object SendAutomationSignalRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: SendAutomationSignalRequest] (val x: Self) extends AnyVal {
