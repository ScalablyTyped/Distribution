...
trait OpsItemSummary extends StObject {
  ...
  /**
    ...
    */
  var OpsItemId: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.OpsItemId] = js.undefined
  ...
  /**
    ...
    */
  var OpsItemType: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.OpsItemType] = js.undefined
...
object OpsItemSummary {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: OpsItemSummary] (val x: Self) extends AnyVal {
