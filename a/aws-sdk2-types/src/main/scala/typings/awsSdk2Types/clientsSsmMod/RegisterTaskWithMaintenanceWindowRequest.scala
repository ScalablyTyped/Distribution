...
trait RegisterTaskWithMaintenanceWindowRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.ClientToken] = js.undefined
...
object RegisterTaskWithMaintenanceWindowRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: RegisterTaskWithMaintenanceWindowRequest] (val x: Self) extends AnyVal {
