...
trait LoggingInfo extends StObject {
  ...
  /**
    ...
    */
  var S3BucketName: typings.awsSdk2Types.clientsSsmMod.S3BucketName
  
  /**
    * (Optional) The S3 bucket subfolder. 
    */
  var S3KeyPrefix: js.UndefOr[typings.awsSdk2Types.clientsSsmMod.S3KeyPrefix] = js.undefined
  
  /**
    * The Amazon Web Services Region where the S3 bucket is located.
    */
  var S3Region: typings.awsSdk2Types.clientsSsmMod.S3Region
}
object LoggingInfo {
