...
object libCredentialsProcessCredentialsMod {
  ...
  @JSImport("aws-sdk2-types/lib/credentials/process_credentials", "ProcessCredentials")
  @js.native
  /**
  ...
  object ProcessCredentialsOptions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ProcessCredentialsOptions] (val x: Self) extends AnyVal {
