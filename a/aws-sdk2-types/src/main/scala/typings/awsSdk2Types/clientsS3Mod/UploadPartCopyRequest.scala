...
trait UploadPartCopyRequest extends StObject {
  ...
  /**
    ...
    */
  var CopySource: typings.awsSdk2Types.clientsS3Mod.CopySource
  
  /**
    * Copies the object if its entity tag (ETag) matches the specified tag.
    */
  var CopySourceIfMatch: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceIfMatch] = js.undefined
  ...
  /**
    ...
    */
  var CopySourceIfNoneMatch: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceIfNoneMatch] = js.undefined
  ...
  /**
    ...
    */
  var CopySourceRange: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceRange] = js.undefined
  
  /**
    * Specifies the algorithm to use when decrypting the source object (for example, AES256).
    */
  var CopySourceSSECustomerAlgorithm: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceSSECustomerAlgorithm] = js.undefined
  
  /**
    * Specifies the customer-provided encryption key for Amazon S3 to use to decrypt the source object. The encryption key provided in this header must be one that was used when the source object was created.
    */
  var CopySourceSSECustomerKey: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceSSECustomerKey] = js.undefined
  
  /**
    * Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
    */
  var CopySourceSSECustomerKeyMD5: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceSSECustomerKeyMD5] = js.undefined
  ...
  /**
    ...
    */
  var PartNumber: typings.awsSdk2Types.clientsS3Mod.PartNumber
