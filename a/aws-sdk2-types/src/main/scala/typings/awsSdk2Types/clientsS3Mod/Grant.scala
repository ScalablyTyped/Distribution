...
trait Grant extends StObject {
  ...
  /**
    ...
    */
  var Grantee: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.Grantee] = js.undefined
  
  /**
    * Specifies the permission given to the grantee.
    */
  var Permission: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.Permission] = js.undefined
}
object Grant {
