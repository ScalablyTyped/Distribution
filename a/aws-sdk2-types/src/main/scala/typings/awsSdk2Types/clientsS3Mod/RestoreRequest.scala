...
trait RestoreRequest extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.Description] = js.undefined
  
  /**
    * S3 Glacier related parameters pertaining to this job. Do not use with restores that specify OutputLocation.
    */
  var GlacierJobParameters: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.GlacierJobParameters] = js.undefined
  
  /**
    * Describes the location where the restore job's output is stored.
    */
  var OutputLocation: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.OutputLocation] = js.undefined
  
  /**
    * Describes the parameters for Select job types.
    */
  var SelectParameters: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.SelectParameters] = js.undefined
  
  /**
    * Retrieval tier at which the restore will be processed.
    */
  var Tier: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.Tier] = js.undefined
