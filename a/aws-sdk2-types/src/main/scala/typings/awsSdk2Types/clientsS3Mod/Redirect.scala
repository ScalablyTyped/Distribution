...
trait Redirect extends StObject {
  ...
  /**
    ...
    */
  var HostName: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.HostName] = js.undefined
  
  /**
    * The HTTP redirect code to use on the response. Not required if one of the siblings is present.
    */
  var HttpRedirectCode: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.HttpRedirectCode] = js.undefined
  ...
  /**
    ...
    */
  var ReplaceKeyPrefixWith: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.ReplaceKeyPrefixWith] = js.undefined
  ...
  /**
    ...
    */
  var ReplaceKeyWith: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.ReplaceKeyWith] = js.undefined
}
object Redirect {
