...
@JSImport("aws-sdk2-types/clients/s3", "ManagedUpload")
@js.native
open class ManagedUpload protected ()
  extends typings.awsSdk2Types.libS3ManagedUploadMod.ManagedUpload {
  /**
...
object ManagedUpload {
  ...
  /**
    * Default value: 10000
    */
  @JSImport("aws-sdk2-types/clients/s3", "ManagedUpload.maxTotalParts")
  @js.native
  ...
  /**
    ...
    * 1024 * 5
    */
  @JSImport("aws-sdk2-types/clients/s3", "ManagedUpload.minPartSize")
  @js.native
