...
trait SelectObjectContentRequest extends StObject {
  ...
  /**
    ...
    */
  var Expression: typings.awsSdk2Types.clientsS3Mod.Expression
  
  /**
    * The type of the provided expression (for example, SQL).
    */
  var ExpressionType: typings.awsSdk2Types.clientsS3Mod.ExpressionType
  
  /**
    * Describes the format of the data in the object that is being queried.
    */
  var InputSerialization: typings.awsSdk2Types.clientsS3Mod.InputSerialization
  ...
  /**
    ...
    */
  var OutputSerialization: typings.awsSdk2Types.clientsS3Mod.OutputSerialization
  
  /**
    * Specifies if periodic request progress information should be enabled.
    */
  var RequestProgress: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.RequestProgress] = js.undefined
  ...
  /**
    ...
    */
  var ScanRange: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.ScanRange] = js.undefined
}
