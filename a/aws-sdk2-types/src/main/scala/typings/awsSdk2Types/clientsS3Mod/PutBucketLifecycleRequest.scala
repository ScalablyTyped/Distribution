...
trait PutBucketLifecycleRequest extends StObject {
  ...
  /**
    * 
    */
  var LifecycleConfiguration: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.LifecycleConfiguration] = js.undefined
}
object PutBucketLifecycleRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutBucketLifecycleRequest] (val x: Self) extends AnyVal {
