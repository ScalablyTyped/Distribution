...
trait ListMultipartUploadsOutput extends StObject {
  ...
  /**
    ...
    */
  var KeyMarker: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.KeyMarker] = js.undefined
  
  /**
    * Maximum number of multipart uploads that could have been included in the response.
    */
  var MaxUploads: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.MaxUploads] = js.undefined
  
  /**
    * When a list is truncated, this element specifies the value that should be used for the key-marker request parameter in a subsequent request.
    */
  var NextKeyMarker: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.NextKeyMarker] = js.undefined
  
  /**
    * When a list is truncated, this element specifies the value that should be used for the upload-id-marker request parameter in a subsequent request.
    */
  var NextUploadIdMarker: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.NextUploadIdMarker] = js.undefined
  ...
  /**
    ...
    */
  var UploadIdMarker: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.UploadIdMarker] = js.undefined
