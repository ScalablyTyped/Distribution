...
trait GetBucketWebsiteOutput extends StObject {
  ...
  /**
    ...
    */
  var ErrorDocument: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.ErrorDocument] = js.undefined
  
  /**
    * The name of the index document for the website (for example index.html).
    */
  var IndexDocument: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.IndexDocument] = js.undefined
  
  /**
    * Specifies the redirect behavior of all requests to a website endpoint of an Amazon S3 bucket.
    */
  var RedirectAllRequestsTo: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.RedirectAllRequestsTo] = js.undefined
  
  /**
    * Rules that define when a redirect is applied and the redirect behavior.
    */
  var RoutingRules: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.RoutingRules] = js.undefined
}
