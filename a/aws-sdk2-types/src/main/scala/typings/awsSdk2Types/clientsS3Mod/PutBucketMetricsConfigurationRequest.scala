...
trait PutBucketMetricsConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var MetricsConfiguration: typings.awsSdk2Types.clientsS3Mod.MetricsConfiguration
}
object PutBucketMetricsConfigurationRequest {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PutBucketMetricsConfigurationRequest] (val x: Self) extends AnyVal {
