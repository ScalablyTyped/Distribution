...
trait UploadPartCopyOutput extends StObject {
  ...
  /**
    ...
    */
  var CopyPartResult: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopyPartResult] = js.undefined
  
  /**
    * The version of the source object that was copied, if you have enabled versioning on the source bucket.
    */
  var CopySourceVersionId: js.UndefOr[typings.awsSdk2Types.clientsS3Mod.CopySourceVersionId] = js.undefined
