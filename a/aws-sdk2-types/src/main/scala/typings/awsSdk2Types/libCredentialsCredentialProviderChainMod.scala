...
object libCredentialsCredentialProviderChainMod {
  
  @JSImport("aws-sdk2-types/lib/credentials/credential_provider_chain", "CredentialProviderChain")
  @js.native
  /**
  ...
  object CredentialProviderChain {
    ...
    @JSImport("aws-sdk2-types/lib/credentials/credential_provider_chain", "CredentialProviderChain.defaultProviders")
    @js.native
