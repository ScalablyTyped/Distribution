...
import typings.awsSdk2Types.anon.ConfigurationOptionskeyst
import typings.awsSdk2Types.awsSdk2TypesBooleans.`false`
...
object libConfigBaseMod {
  ...
  @JSImport("aws-sdk2-types/lib/config-base", "ConfigBase")
  @js.native
  ...
  /* note: abstract class */ @JSImport("aws-sdk2-types/lib/config-base", "ConfigurationOptions")
  @js.native
  open class ConfigurationOptions () extends StObject {
    ...
    /**
      ...
      * Defaults to 'legacy'
      */
    var s3UsEast1RegionalEndpoint: js.UndefOr[regional | legacy] = js.native
