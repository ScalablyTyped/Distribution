...
object libTokenTokenProviderChainMod {
  ...
  @JSImport("aws-sdk2-types/lib/token/token_provider_chain", "TokenProviderChain")
  @js.native
  /**
  ...
  object TokenProviderChain {
    ...
    @JSImport("aws-sdk2-types/lib/token/token_provider_chain", "TokenProviderChain.defaultProviders")
    @js.native
