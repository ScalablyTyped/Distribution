...
trait BackupDetails extends StObject {
  ...
  /**
    ...
    */
  var BackupArn: typings.awsSdk2Types.clientsDynamodbMod.BackupArn
  ...
  /**
    ...
    */
  var BackupSizeBytes: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.BackupSizeBytes] = js.undefined
  
  /**
    * Backup can be in one of the following states: CREATING, ACTIVE, DELETED. 
    */
  var BackupStatus: typings.awsSdk2Types.clientsDynamodbMod.BackupStatus
  ...
  /**
    ...
    */
  var BackupType: typings.awsSdk2Types.clientsDynamodbMod.BackupType
}
