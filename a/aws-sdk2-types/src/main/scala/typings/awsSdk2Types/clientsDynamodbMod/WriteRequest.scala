...
trait WriteRequest extends StObject {
  ...
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.DeleteRequest] = js.undefined
  
  /**
    * A request to perform a PutItem operation.
    */
  var PutRequest: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.PutRequest] = js.undefined
}
object WriteRequest {
