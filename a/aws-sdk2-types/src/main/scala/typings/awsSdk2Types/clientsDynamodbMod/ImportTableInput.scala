...
trait ImportTableInput extends StObject {
  ...
  /**
    ...
    */
  var InputFormat: typings.awsSdk2Types.clientsDynamodbMod.InputFormat
  ...
  /**
    ...
    */
  var S3BucketSource: typings.awsSdk2Types.clientsDynamodbMod.S3BucketSource
  
  /**
    * Parameters for the table to import the data into. 
    */
  var TableCreationParameters: typings.awsSdk2Types.clientsDynamodbMod.TableCreationParameters
}
