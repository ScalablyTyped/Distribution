...
trait UpdateTableInput extends StObject {
  ...
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.AttributeDefinitions] = js.undefined
  ...
  /**
    ...
    */
  var StreamSpecification: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.StreamSpecification] = js.undefined
  
  /**
    * The table class of the table to be updated. Valid values are STANDARD and STANDARD_INFREQUENT_ACCESS.
    */
  var TableClass: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.TableClass] = js.undefined
