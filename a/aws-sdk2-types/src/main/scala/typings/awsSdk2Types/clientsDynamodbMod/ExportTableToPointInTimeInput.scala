...
trait ExportTableToPointInTimeInput extends StObject {
  ...
  /**
    ...
    */
  var ExportFormat: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.ExportFormat] = js.undefined
  ...
  /**
    ...
    */
  var S3Prefix: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.S3Prefix] = js.undefined
  ...
  /**
    ...
    */
  var S3SseAlgorithm: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.S3SseAlgorithm] = js.undefined
  
  /**
    * The ID of the KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
    */
  var S3SseKmsKeyId: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.S3SseKmsKeyId] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) associated with the table to export.
    */
  var TableArn: typings.awsSdk2Types.clientsDynamodbMod.TableArn
}
