...
trait ReplicaDescription extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedThroughputOverride: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.ProvisionedThroughputOverride] = js.undefined
  
  /**
    * The name of the Region.
    */
  var RegionName: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.RegionName] = js.undefined
  ...
  /**
    ...
    */
  var ReplicaStatus: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.ReplicaStatus] = js.undefined
  
  /**
    * Detailed information about the replica status.
    */
  var ReplicaStatusDescription: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.ReplicaStatusDescription] = js.undefined
  
  /**
    * Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.
    */
  var ReplicaStatusPercentProgress: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.ReplicaStatusPercentProgress] = js.undefined
