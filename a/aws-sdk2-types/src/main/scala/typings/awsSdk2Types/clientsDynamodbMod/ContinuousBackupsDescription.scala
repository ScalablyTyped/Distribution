...
trait ContinuousBackupsDescription extends StObject {
  ...
  /**
    ...
    */
  var ContinuousBackupsStatus: typings.awsSdk2Types.clientsDynamodbMod.ContinuousBackupsStatus
  
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.PointInTimeRecoveryDescription] = js.undefined
}
