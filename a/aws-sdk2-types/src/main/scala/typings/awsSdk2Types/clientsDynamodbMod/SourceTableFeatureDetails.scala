...
trait SourceTableFeatureDetails extends StObject {
  ...
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.GlobalSecondaryIndexes] = js.undefined
  
  /**
    * Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. 
    */
  var LocalSecondaryIndexes: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.LocalSecondaryIndexes] = js.undefined
  
  /**
    * The description of the server-side encryption status on the table when the backup was created.
    */
  var SSEDescription: js.UndefOr[typings.awsSdk2Types.clientsDynamodbMod.SSEDescription] = js.undefined
