...
import typings.awsSdk2Types.anon.TypeofManagedUpload
import typings.awsSdk2Types.clientsS3Mod.PresignedPost
import typings.awsSdk2Types.clientsS3Mod.PutObjectRequest
import typings.awsSdk2Types.libS3ManagedUploadMod.ManagedUpload
...
import typings.awsSdk2Types.libS3PresignedPostMod.PresignedPost.Params
...
object libServicesS3Mod {
  ...
  @JSImport("aws-sdk2-types/lib/services/s3", "S3Customizations")
  @js.native
  /**
  ...
  object S3Customizations {
    ...
    @JSImport("aws-sdk2-types/lib/services/s3", "S3Customizations.ManagedUpload")
    @js.native
