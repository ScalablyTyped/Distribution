...
import typings.allDashKeys.Anon_Default
...
object ^ extends js.Object {
  ...
  // ): Set<LiteralUnion<keyof ObjectType, string | number | symbol>>;
  // export = allKeys;
  def default[ObjectType /* <: StringDictionary[js.Any] */](`object`: ObjectType): Set[LiteralUnion[String, String | Double | js.Symbol]] = js.native
  def default[ObjectType /* <: StringDictionary[js.Any] */](`object`: ObjectType, options: Options): Set[LiteralUnion[String, String | Double | js.Symbol]] = js.native
}
