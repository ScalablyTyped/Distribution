...
object ^ extends js.Object {
  ...
  // export = allKeys;
  @JSName("default")
  var default_Original: allDashKeysLib.Anon_Default = js.native
  /**
  ...
  def apply[ObjectType /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */](`object`: ObjectType, options: Options): stdLib.Set[
    typeDashFestLib.typeDashFestMod.LiteralUnion[java.lang.String, java.lang.String | scala.Double | js.Symbol]
  ] = js.native
  /**
  	Get all property keys of an object including non-enumerable and inherited ones. Like [Reflect.ownKeys()](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Reflect/ownKeys) but traverses up the prototype-chain.
  ...
  def default[ObjectType /* <: org.scalablytyped.runtime.StringDictionary[js.Any] */](`object`: ObjectType, options: Options): stdLib.Set[
    typeDashFestLib.typeDashFestMod.LiteralUnion[java.lang.String, java.lang.String | scala.Double | js.Symbol]
  ] = js.native
}
