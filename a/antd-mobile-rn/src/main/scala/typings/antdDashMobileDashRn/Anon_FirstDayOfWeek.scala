...
trait Anon_FirstDayOfWeek extends js.Object {
  var firstDayOfWeek: Double
  var minimalDaysInFirstWeek: Double
  var timezoneOffset: Double
}

object Anon_FirstDayOfWeek {
  @scala.inline
  def apply(firstDayOfWeek: Double, minimalDaysInFirstWeek: Double, timezoneOffset: Double): Anon_FirstDayOfWeek = {
    ...
    __obj.asInstanceOf[Anon_FirstDayOfWeek]
  }
}
