package typings.antdDashMobileDashRn.libDrawerIndexDotNativeMod
...
trait Drawer
  ...
  var drawer: typings.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default | Null = js.native
