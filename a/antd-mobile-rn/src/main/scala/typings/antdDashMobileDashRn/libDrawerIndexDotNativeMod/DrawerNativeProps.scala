...
import typings.antdDashMobileDashRn.antdDashMobileDashRnStrings.right
import typings.antdDashMobileDashRn.antdDashMobileDashRnStrings.top
import typings.antdDashMobileDashRn.libDrawerPropsTypeMod.DrawerProps
...
trait DrawerNativeProps extends DrawerProps {
  ...
  var drawerRef: js.UndefOr[
    js.Function1[
      /* el */ typings.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default | Null, 
      Unit
    ]
  ] = js.undefined
...
object DrawerNativeProps {
  ...
  def apply(
    ...
    drawerRef: /* el */ typings.reactDashNativeDashDrawerDashLayout.reactDashNativeDashDrawerDashLayoutMod.default | Null => Unit = null,
