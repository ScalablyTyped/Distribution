package typings.antdDashMobileDashRn.libTabDashBarTabbarDotAndroidMod

import typings.antdDashMobileDashRn.libTabDashBarPropsTypeMod.TabBarProps
import typings.antdDashMobileDashRn.libTabDashBarStyleIndexDotNativeMod.ITabBarStyle
