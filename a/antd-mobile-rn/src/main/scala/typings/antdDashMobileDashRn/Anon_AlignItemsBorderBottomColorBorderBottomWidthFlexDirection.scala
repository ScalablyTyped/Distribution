...
trait Anon_AlignItemsBorderBottomColorBorderBottomWidthFlexDirection extends js.Object {
...
object Anon_AlignItemsBorderBottomColorBorderBottomWidthFlexDirection {
  @scala.inline
  def apply(
    alignItems: String,
  ...
  ): Anon_AlignItemsBorderBottomColorBorderBottomWidthFlexDirection = {
    ...
    __obj.asInstanceOf[Anon_AlignItemsBorderBottomColorBorderBottomWidthFlexDirection]
  }
}
