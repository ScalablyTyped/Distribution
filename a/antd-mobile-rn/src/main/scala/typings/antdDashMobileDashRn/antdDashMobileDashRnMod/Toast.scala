...
object Toast extends js.Object {
  ...
  def fail(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit]): Unit = js.native
  def fail(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit], mask: Boolean): Unit = js.native
  def fail(content: String, duration: Double): Unit = js.native
  ...
  def info(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit]): Unit = js.native
  def info(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit], mask: Boolean): Unit = js.native
  def info(content: String, duration: Double): Unit = js.native
  ...
  def loading(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit]): Unit = js.native
  def loading(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit], mask: Boolean): Unit = js.native
  def loading(content: String, duration: Double): Unit = js.native
  ...
  def offline(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit]): Unit = js.native
  def offline(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit], mask: Boolean): Unit = js.native
  def offline(content: String, duration: Double): Unit = js.native
  ...
  def success(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit]): Unit = js.native
  def success(content: String, duration: js.UndefOr[scala.Nothing], onClose: js.Function0[Unit], mask: Boolean): Unit = js.native
  def success(content: String, duration: Double): Unit = js.native
  def success(content: String, duration: Double, onClose: js.UndefOr[scala.Nothing], mask: Boolean): Unit = js.native
