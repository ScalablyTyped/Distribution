...
import typings.antdDashMobileDashRn.libSearchDashBarPropsTypeMod.SearchBarPropsType
import typings.antdDashMobileDashRn.libSearchDashBarStyleIndexDotNativeMod.ISearchBarStyle
