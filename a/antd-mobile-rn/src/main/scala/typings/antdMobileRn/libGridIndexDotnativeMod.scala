...
import typings.antdMobileRn.libCarouselIndexDotnativeMod.CarouselProps
import typings.antdMobileRn.libGridPropsTypeMod.GridPropsType
...
object libGridIndexDotnativeMod {
