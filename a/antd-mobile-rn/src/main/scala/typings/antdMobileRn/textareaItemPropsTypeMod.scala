...
object textareaItemPropsTypeMod {
  ...
  object TextAreaItemPropsType {
    ...
    implicit class TextAreaItemPropsTypeMutableBuilder[Self <: TextAreaItemPropsType] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnBlur(value: /* val */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      @scala.inline
      def setOnFocus(value: /* val */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
