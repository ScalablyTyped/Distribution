...
object textareaItemPropsTypeMod {
  ...
  object TextAreaItemPropsType {
    ...
    extension [Self <: TextAreaItemPropsType](x: Self) {
      ...
      inline def setOnBlur(value: /* val */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
      ...
      inline def setOnFocus(value: /* val */ js.UndefOr[String] => Unit): Self = StObject.set(x, "onFocus", js.Any.fromFunction1(value))
