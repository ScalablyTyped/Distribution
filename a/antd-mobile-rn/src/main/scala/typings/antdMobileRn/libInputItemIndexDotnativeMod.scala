...
object libInputItemIndexDotnativeMod {
  ...
  trait InputItem extends Component[InputItemProps, Any, Any] {
    ...
    var inputRef: typings.antdMobileRn.libInputItemInputDotnativeMod.default | Null = js.native
