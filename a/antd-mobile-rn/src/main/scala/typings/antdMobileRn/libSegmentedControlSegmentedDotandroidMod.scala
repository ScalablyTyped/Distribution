...
import typings.antdMobileRn.libSegmentedControlStyleIndexDotnativeMod.ISegmentControlStyle
...
object libSegmentedControlSegmentedDotandroidMod {
  ...
  object SegmentControlNativeProps {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: SegmentControlNativeProps] (val x: Self) extends AnyVal {
