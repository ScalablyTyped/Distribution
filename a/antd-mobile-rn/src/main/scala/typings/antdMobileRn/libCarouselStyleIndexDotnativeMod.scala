...
object libCarouselStyleIndexDotnativeMod {
  ...
  object default {
    ...
    inline def paginationX_=(x: Bottom): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("paginationX")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile-rn/lib/carousel/style/index.native", "default.paginationY")
    @js.native
    def paginationY: Right = js.native
    inline def paginationY_=(x: Right): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("paginationY")(x.asInstanceOf[js.Any])
    
    inline def pagination_=(x: AlignItemsPosition): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pagination")(x.asInstanceOf[js.Any])
