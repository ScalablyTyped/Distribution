...
object libDatePickerViewLocaleEnUSMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/date-picker-view/locale/en_US", "default.month")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker-view/locale/en_US", "default.pm")
    @js.native
    def pm: String = js.native
    inline def pm_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("pm")(x.asInstanceOf[js.Any])
    
    @JSImport("antd-mobile-rn/lib/date-picker-view/locale/en_US", "default.year")
    @js.native
