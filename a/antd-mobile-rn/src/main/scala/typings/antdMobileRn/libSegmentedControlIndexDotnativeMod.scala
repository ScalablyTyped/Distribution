...
object libSegmentedControlIndexDotnativeMod {
  
  /* was `typeof SegmentedIOS` */
  @JSImport("antd-mobile-rn/lib/segmented-control/index.native", JSImport.Default)
  @js.native
  open class default ()
    extends typings.antdMobileRn.libSegmentedControlSegmentedDotiosMod.default
  /* static members */
  object default {
  ...
  /* was `typeof SegmentedIOS` */
  type _default = typings.antdMobileRn.libSegmentedControlSegmentedDotiosMod.default
}
