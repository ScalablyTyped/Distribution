...
object textareaItemIndexNativeMod {
  ...
  object TextInputProps {
    ...
    implicit class TextInputPropsMutableBuilder[Self <: TextInputProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setKeyboardAppearance(value: typings.antdMobileRn.antdMobileRnStrings.default | light | dark): Self = StObject.set(x, "keyboardAppearance", value.asInstanceOf[js.Any])
