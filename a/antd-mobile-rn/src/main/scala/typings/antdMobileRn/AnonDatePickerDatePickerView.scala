...
trait AnonDatePickerDatePickerView extends js.Object {
...
object AnonDatePickerDatePickerView {
  @scala.inline
  def apply(
    exist: Boolean,
    ...
    __obj.asInstanceOf[AnonDatePickerDatePickerView]
  }
}
