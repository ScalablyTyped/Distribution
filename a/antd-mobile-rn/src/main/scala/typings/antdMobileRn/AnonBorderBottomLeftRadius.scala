...
trait AnonBorderBottomLeftRadius extends js.Object {
...
object AnonBorderBottomLeftRadius {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonBorderBottomLeftRadius]
  }
}
