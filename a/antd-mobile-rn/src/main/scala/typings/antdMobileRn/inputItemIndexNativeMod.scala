...
import typings.antdMobileRn.anon.Clear
...
object inputItemIndexNativeMod {
  ...
  object InputItemProps {
    ...
    implicit class InputItemPropsMutableBuilder[Self <: InputItemProps] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setOnErrorClick(value: /* event */ GestureResponderEvent => Unit): Self = StObject.set(x, "onErrorClick", js.Any.fromFunction1(value))
      
      @scala.inline
      def setOnErrorClickUndefined: Self = StObject.set(x, "onErrorClick", js.undefined)
      
      @scala.inline
      def setOnExtraClick(value: /* event */ GestureResponderEvent => Unit): Self = StObject.set(x, "onExtraClick", js.Any.fromFunction1(value))
