...
import typings.antdMobileRn.inputItemPropsTypeMod.InputItemPropsType
...
trait InputItemProps extends InputItemPropsType {
  ...
  var keyboardAppearance: js.UndefOr[typings.antdMobileRn.antdMobileRnStrings.default | light | dark] = js.native
  ...
  var onErrorClick: js.UndefOr[js.Function1[/* event */ GestureResponderEvent, Unit]] = js.native
  var onExtraClick: js.UndefOr[js.Function1[/* event */ GestureResponderEvent, Unit]] = js.native
...
object InputItemProps {
  ...
  implicit class InputItemPropsOps[Self <: InputItemProps] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKeyboardAppearance(value: typings.antdMobileRn.antdMobileRnStrings.default | light | dark): Self = this.set("keyboardAppearance", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setOnErrorClick(value: /* event */ GestureResponderEvent => Unit): Self = this.set("onErrorClick", js.Any.fromFunction1(value))
    @scala.inline
    def deleteOnErrorClick: Self = this.set("onErrorClick", js.undefined)
    @scala.inline
    def setOnExtraClick(value: /* event */ GestureResponderEvent => Unit): Self = this.set("onExtraClick", js.Any.fromFunction1(value))
    @scala.inline
