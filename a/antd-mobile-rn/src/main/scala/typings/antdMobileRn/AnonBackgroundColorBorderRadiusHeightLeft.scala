...
trait AnonBackgroundColorBorderRadiusHeightLeft extends js.Object {
...
object AnonBackgroundColorBorderRadiusHeightLeft {
  @scala.inline
  def apply(
    ...
    position: String,
    top: Double
  ): AnonBackgroundColorBorderRadiusHeightLeft = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBorderRadiusHeightLeft]
  }
}
