...
@js.native
trait FontSizeMarginLeft extends js.Object {
...
object FontSizeMarginLeft {
  ...
  @scala.inline
  def apply(color: String, fontSize: Double, marginLeft: Double): FontSizeMarginLeft = {
  ...
  @scala.inline
  implicit class FontSizeMarginLeftOps[Self <: FontSizeMarginLeft] (val x: Self) extends AnyVal {
