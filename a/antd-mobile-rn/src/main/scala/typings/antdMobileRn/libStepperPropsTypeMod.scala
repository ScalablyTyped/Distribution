...
object libStepperPropsTypeMod {
  ...
  object StepPropsType {
    ...
    implicit open class MutableBuilder[Self <: StepPropsType] (val x: Self) extends AnyVal {
      ...
      inline def setDownStyle(value: js.Object): Self = StObject.set(x, "downStyle", value.asInstanceOf[js.Any])
      ...
      inline def setUpStyle(value: js.Object): Self = StObject.set(x, "upStyle", value.asInstanceOf[js.Any])
