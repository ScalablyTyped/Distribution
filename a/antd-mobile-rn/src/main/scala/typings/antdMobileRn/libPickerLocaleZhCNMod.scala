...
object libPickerLocaleZhCNMod {
  
  object default {
    
    @JSImport("antd-mobile-rn/lib/picker/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/picker/locale/zh_CN", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/picker/locale/zh_CN", "default.extra")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/picker/locale/zh_CN", "default.okText")
    @js.native
