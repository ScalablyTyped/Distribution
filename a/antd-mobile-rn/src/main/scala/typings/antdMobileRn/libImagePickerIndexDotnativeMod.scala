...
import typings.antdMobileRn.libImagePickerPropsTypeMod.ImagePickerPropTypes
import typings.antdMobileRn.libImagePickerStyleIndexDotnativeMod.IImagePickerStyle
