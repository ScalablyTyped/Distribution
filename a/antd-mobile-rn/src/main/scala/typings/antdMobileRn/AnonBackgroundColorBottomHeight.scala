...
trait AnonBackgroundColorBottomHeight extends js.Object {
...
object AnonBackgroundColorBottomHeight {
  @scala.inline
  def apply(
    ...
    right: Double,
    top: Double
  ): AnonBackgroundColorBottomHeight = {
    ...
    __obj.asInstanceOf[AnonBackgroundColorBottomHeight]
  }
}
