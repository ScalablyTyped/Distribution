...
object localeSvSEMod {
  
  object default {
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/sv_SE", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/sv_SE", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/sv_SE", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/sv_SE", "default.extra")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/sv_SE", "default.okText")
    @js.native
