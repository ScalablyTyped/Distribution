...
import typings.antdMobileRn.anon.ButtonText
import typings.antdMobileRn.anon.CancelText
import typings.antdMobileRn.anon.Day
...
object localeProviderRuRUMod {
  
  object default {
    
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.DatePicker")
    @js.native
    def DatePicker: DismissText = js.native
    
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.DatePickerView")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.InputItem")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.Modal")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.Pagination")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.Picker")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.SearchBar")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/locale-provider/ru_RU", "default.locale")
    @js.native
