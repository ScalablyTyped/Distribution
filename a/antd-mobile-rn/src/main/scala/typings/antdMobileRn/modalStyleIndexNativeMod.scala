...
import typings.antdMobileRn.anon.AlignItemsJustifyContent
import typings.antdMobileRn.anon.BackgroundColorBottom
import typings.antdMobileRn.anon.BackgroundColorColorFontSize
import typings.antdMobileRn.anon.BorderBottomLeftRadius
import typings.antdMobileRn.anon.BorderColorBorderRightWidth
import typings.antdMobileRn.anon.BorderColorBorderTopWidth
import typings.antdMobileRn.anon.ColorPaddingHorizontal
import typings.antdMobileRn.anon.FlexDirectionFlexGrow
import typings.antdMobileRn.anon.FontSizePaddingHorizontal
import typings.antdMobileRn.anon.Left
import typings.antdMobileRn.anon.LeftPosition
import typings.antdMobileRn.anon.LineHeight
import typings.antdMobileRn.anon.OverflowPaddingTop
import typings.antdMobileRn.anon.PaddingBottomNumber
import typings.antdMobileRn.anon.PaddingBottomPaddingHorizontal
import typings.antdMobileRn.anon.PaddingTopNumber
...
object modalStyleIndexNativeMod {
  ...
  object default {
    ...
    @js.native
    def buttonText: BackgroundColorColorFontSize = js.native
    ...
    @js.native
    def close: LineHeight = js.native
