...
import typings.antdMobileRn.libNoticeBarMarqueeDotnativeMod.MarqueeProps
import typings.antdMobileRn.libNoticeBarPropsTypeMod.NoticeBarPropsType
import typings.antdMobileRn.libNoticeBarStyleIndexDotnativeMod.INoticeBarStyle
