...
trait PaginationPropsType extends js.Object {
  ...
  var mode: js.UndefOr[
    antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.button | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.number | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.pointer
  ] = js.undefined
