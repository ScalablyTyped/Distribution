package typings
package antdDashMobileDashRnLib.libDateDashPickerPropsTypeMod
...
trait DatePickerPropsType extends js.Object {
  ...
  var locale: js.UndefOr[antdDashMobileDashRnLib.Anon_DatePickerLocale] = js.undefined
  ...
  var mode: js.UndefOr[
    antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.datetime | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.date | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.year | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.month | antdDashMobileDashRnLib.antdDashMobileDashRnLibStrings.time
  ] = js.undefined
