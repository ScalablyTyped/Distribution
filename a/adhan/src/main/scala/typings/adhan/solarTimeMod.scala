...
object solarTimeMod {
  ...
  open class default protected ()
    extends StObject
       with SolarTime {
    def this(date: js.Date, coordinates: typings.adhan.coordinatesMod.default) = this()
    ...
    /* CompleteClass */
    var nextSolar: typings.adhan.solarCoordinatesMod.default = js.native
    
    /* CompleteClass */
    var observer: typings.adhan.coordinatesMod.default = js.native
    
    /* CompleteClass */
    var prevSolar: typings.adhan.solarCoordinatesMod.default = js.native
    
    /* CompleteClass */
    var solar: typings.adhan.solarCoordinatesMod.default = js.native
  ...
  trait SolarTime extends StObject {
    ...
    var nextSolar: typings.adhan.solarCoordinatesMod.default
    
    var observer: typings.adhan.coordinatesMod.default
    
    var prevSolar: typings.adhan.solarCoordinatesMod.default
    
    var solar: typings.adhan.solarCoordinatesMod.default
  ...
  object SolarTime {
    ...
    inline def apply(
      ...
      nextSolar: typings.adhan.solarCoordinatesMod.default,
      observer: typings.adhan.coordinatesMod.default,
      prevSolar: typings.adhan.solarCoordinatesMod.default,
      solar: typings.adhan.solarCoordinatesMod.default,
      sunrise: Double,
      sunset: Double,
      transit: Double
    ): SolarTime = {
    ...
    extension [Self <: SolarTime](x: Self) {
      ...
      inline def setNextSolar(value: typings.adhan.solarCoordinatesMod.default): Self = StObject.set(x, "nextSolar", value.asInstanceOf[js.Any])
      
      inline def setObserver(value: typings.adhan.coordinatesMod.default): Self = StObject.set(x, "observer", value.asInstanceOf[js.Any])
      
      inline def setPrevSolar(value: typings.adhan.solarCoordinatesMod.default): Self = StObject.set(x, "prevSolar", value.asInstanceOf[js.Any])
      
      inline def setSolar(value: typings.adhan.solarCoordinatesMod.default): Self = StObject.set(x, "solar", value.asInstanceOf[js.Any])
