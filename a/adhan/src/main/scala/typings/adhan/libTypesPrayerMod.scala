...
object libTypesPrayerMod {
  
  object default {
    
    @JSImport("adhan/lib/types/Prayer", "default.Asr")
    @js.native
    val Asr: asr = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.Dhuhr")
    @js.native
    val Dhuhr: dhuhr = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.Fajr")
    @js.native
    val Fajr: fajr = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.Isha")
    @js.native
    val Isha: isha = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.Maghrib")
    @js.native
    val Maghrib: maghrib = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.None")
    @js.native
    val None: none = js.native
    
    @JSImport("adhan/lib/types/Prayer", "default.Sunrise")
    @js.native
