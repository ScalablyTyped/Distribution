...
object libTypesPrayerTimesMod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      date: js.Date,
      calculationParameters: typings.adhan.libTypesCalculationParametersMod.default
    ) = this()
  }
  ...
  trait PrayerTimes extends StObject {
    ...
    var calculationParameters: typings.adhan.libTypesCalculationParametersMod.default = js.native
    
    var coordinates: typings.adhan.libTypesCoordinatesMod.default = js.native
