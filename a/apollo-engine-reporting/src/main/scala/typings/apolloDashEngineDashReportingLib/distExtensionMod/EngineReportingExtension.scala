...
class EngineReportingExtension[TContext] protected ()
  ...
  def this(options: apolloDashEngineDashReportingLib.distAgentMod.EngineReportingOptions, addTrace: js.Function3[
  ...
  def requestDidStart_MEngineReportingExtension(o: apolloDashEngineDashReportingLib.Anon_ParsedQuery): graphqlDashExtensionsLib.graphqlDashExtensionsMod.EndHandler = js.native
