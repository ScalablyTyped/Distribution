...
import typings.auth0DashJs.Anon_Audience
import typings.auth0DashJs.Anon_Code
import typings.auth0DashJs.Anon_Connection
import typings.auth0DashJs.Anon_ConnectionEmail
import typings.auth0DashJs.Anon_Hash
...
class Popup protected () extends js.Object {
  ...
  /**
    ...
    */
  def authorize(options: Anon_Audience, callback: Auth0Callback[_, Auth0Error]): Unit = js.native
  /**
  ...
  /**
    ...
    * @see {@link parseHash}
    */
  def callback(options: Anon_Hash): Unit = js.native
  /**
    ...
    */
  def loginWithCredentials(options: Anon_Code, callback: Auth0Callback[_, Auth0Error]): Unit = js.native
  /**
    * Verifies the passwordless TOTP and returns the requested token
    */
  def passwordlessVerify(options: Anon_ConnectionEmail, callback: Auth0Callback[_, Auth0Error]): Unit = js.native
  /**
