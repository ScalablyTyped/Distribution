...
trait Table[TFields /* <: FieldSet */] extends js.Object {
  ...
  def create(record: TFields, opts: airtableLib.Anon_Typecast): js.Promise[Response[TFields]] = js.native
  def create(records: js.Array[TFields]): js.Promise[js.Array[Response[TFields]]] = js.native
  def create(records: js.Array[TFields], opts: airtableLib.Anon_Typecast): js.Promise[js.Array[Response[TFields]]] = js.native
  def destroy(args: js.Any*): js.Promise[_] = js.native
  def find(id: java.lang.String): js.Promise[Response[TFields]] = js.native
