...
object libRecordMod {
  ...
  open class ^[TFields /* <: FieldSet */] protected ()
    extends StObject
       with Record[TFields] {
    def this(table: typings.airtable.libTableMod.^[TFields], recordId: String) = this()
    def this(table: typings.airtable.libTableMod.^[TFields], recordId: String, recordJson: RecordJson) = this()
  }
