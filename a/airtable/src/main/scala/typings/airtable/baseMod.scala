...
import typings.airtable.runActionMod.Body
import typings.airtable.runActionMod.Callback
import typings.airtable.runActionMod.Params
...
object baseMod {
  ...
  trait Base extends StObject {
    ...
    def _checkStatusForError(statusCode: Double): Null | typings.airtable.airtableErrorMod.^ = js.native
    def _checkStatusForError(statusCode: Double, body: BaseBody): Null | typings.airtable.airtableErrorMod.^ = js.native
    
    def _getRequestHeaders(headers: StringDictionary[String]): StringDictionary[String] = js.native
    
    val _id: String = js.native
    
    def doCall[TFields /* <: FieldSet */](tableName: String): typings.airtable.tableMod.^[TFields] = js.native
    ...
    def table[TFields /* <: FieldSet */](tableName: String): typings.airtable.tableMod.^[TFields] = js.native
  }
