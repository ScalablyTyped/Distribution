...
import typings.airtable.recordsMod.Records
...
object tableMod {
  ...
  trait Table[TFields /* <: FieldSet */] extends StObject {
    ...
    val _base: typings.airtable.baseMod.^ = js.native
    ...
    def _selectRecords(): typings.airtable.queryMod.^[TFields] = js.native
    def _selectRecords(params: QueryParams[TFields]): typings.airtable.queryMod.^[TFields] = js.native
    ...
    def select(): typings.airtable.queryMod.^[TFields] = js.native
    def select(params: QueryParams[TFields]): typings.airtable.queryMod.^[TFields] = js.native
  ...
  type TableSelectRecord[TFields /* <: FieldSet */] = js.Function1[
    ...
    typings.airtable.queryMod.^[TFields]
  ]
}
