...
@js.native
trait TypeofClassSchemaDirectiveVisitor extends Instantiable1[/* config */ AnonArgs, SchemaDirectiveVisitor] {
  /* protected */ def getDeclaredDirectives(
    schema: GraphQLSchema,
    directiveVisitors: StringDictionary[typings.graphqlTools.TypeofClassSchemaDirectiveVisitor]
