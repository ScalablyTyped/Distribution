...
version := "2.1.0-36c2f4"
scalaVersion := "2.12.7"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "runtime" % "1.0.0-M1",
  "com.scalablytyped" %%% "apollo-cache-control" % "0.2.5-0ecb17",
  "com.scalablytyped" %%% "apollo-datasource" % "0.1.3-022e3c",
  "com.scalablytyped" %%% "apollo-engine-reporting" % "0.0.6-e7ac9a",
  "com.scalablytyped" %%% "apollo-engine-reporting-protobuf" % "0.0.1-e52774",
  ...
  "com.scalablytyped" %%% "apollo-tracing" % "0.2.5-ae5b8d",
  ...
  "com.scalablytyped" %%% "graphql-subscriptions" % "0.5.8-1882e9",
  "com.scalablytyped" %%% "graphql-tag" % "2.10.0-b79734",
  "com.scalablytyped" %%% "graphql-tools" % "4.0.2-f38be0",
  "com.scalablytyped" %%% "hash_dot_js" % "1.1.5-2b7038",
