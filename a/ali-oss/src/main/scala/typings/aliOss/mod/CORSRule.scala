...
object CORSRule {
  ...
  extension [Self <: CORSRule](x: Self) {
    ...
    inline def setAllowedHeaderVarargs(value: String*): Self = StObject.set(x, "allowedHeader", js.Array(value :_*))
    
    inline def setAllowedMethod(value: String | js.Array[String]): Self = StObject.set(x, "allowedMethod", value.asInstanceOf[js.Any])
    
    inline def setAllowedMethodVarargs(value: String*): Self = StObject.set(x, "allowedMethod", js.Array(value :_*))
    
    inline def setAllowedOrigin(value: String | js.Array[String]): Self = StObject.set(x, "allowedOrigin", value.asInstanceOf[js.Any])
    
    inline def setAllowedOriginVarargs(value: String*): Self = StObject.set(x, "allowedOrigin", js.Array(value :_*))
    ...
    inline def setExposeHeaderVarargs(value: String*): Self = StObject.set(x, "exposeHeader", js.Array(value :_*))
    ...
    inline def setMaxAgeSecondsVarargs(value: String*): Self = StObject.set(x, "maxAgeSeconds", js.Array(value :_*))
  }
}
