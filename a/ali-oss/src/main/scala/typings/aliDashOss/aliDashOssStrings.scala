...
import typings.aliDashOss.aliDashOssMod.ACLType
import typings.aliDashOss.aliDashOssMod.HTTPMethods
import typings.aliDashOss.aliDashOssMod.RuleStatusType
import typings.aliDashOss.aliDashOssMod.StorageType
