...
import typings.adone.adoneNs.fsNs.INs.GlobNs.Stream
import typings.adone.adoneNs.fsNs.INs.GlobNs.StreamOptions
...
import typings.adone.adoneNs.fsNs.TailWatcher
import typings.adone.adoneNs.fsNs.Watcher
...
trait TypeoffsAbstractRandomAccessReader extends js.Object {
  /**
    ...
    */
  var AbstractRandomAccessReader: Instantiable0[typings.adone.adoneNs.fsNs.AbstractRandomAccessReader] = js.native
  /**
  ...
  /**
    * Represents a file
    */
  var File: Instantiable1[/* path (repeated) */ String, typings.adone.adoneNs.fsNs.File] = js.native
  val INs: TypeofIDirectory = js.native
  /**
    * Represents the permissions of a file
    */
  var Mode: Instantiable1[/* stat */ Stats, typings.adone.adoneNs.fsNs.Mode] = js.native
  /**
    * Represents a random access reader for a buffer
    */
  var RandomAccessBufferReader: Instantiable1[/* buffer */ Buffer, typings.adone.adoneNs.fsNs.RandomAccessBufferReader] = js.native
  /**
    * Represents a random access reader for a file by its file descriptor
    */
  var RandomAccessFdReader: Instantiable1[/* fd */ Double, typings.adone.adoneNs.fsNs.RandomAccessFdReader] = js.native
  /**
  ...
  /**
    ...
    */
  var SymbolicLinkDirectory: Instantiable0[typings.adone.adoneNs.fsNs.SymbolicLinkDirectory] = js.native
  /**
    * Represents a file that is a symbolic link to another file
    */
  var SymbolicLinkFile: Instantiable0[typings.adone.adoneNs.fsNs.SymbolicLinkFile] = js.native
  /**
    * Represents an event emitter that watches for a file growing,
    * emits "line" event for each new line in a file
    */
  var TailWatcher: Instantiable2[
    /* filename */ String, 
    js.UndefOr[/* options */ ConstructorOptions], 
    typings.adone.adoneNs.fsNs.TailWatcher
  ] = js.native
  /**
    * Represents a file watcher
    */
  var Watcher: Instantiable1[
    js.UndefOr[/* options */ typings.adone.adoneNs.fsNs.INs.WatcherNs.ConstructorOptions], 
    typings.adone.adoneNs.fsNs.Watcher
  ] = js.native
  ...
  /**
    ...
    */
  @JSName("glob")
  val glob_Original: GlobFunction = js.native
  /**
  ...
  /**
    * Creates a glob stream
    */
  def glob(patterns: String): Stream[String] = js.native
  /**
    * Creates a glob stream
    */
  def glob(
  ...
  def glob(patterns: js.Array[String]): Stream[String] = js.native
  def glob(
  ...
  /**
    ...
    */
  def readdirp(root: String): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  def readdirp(root: String, options: ReaddirpOptions): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  def readdirp(root: URL): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  def readdirp(root: URL, options: ReaddirpOptions): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  def readdirp(root: Buffer): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  def readdirp(root: Buffer, options: ReaddirpOptions): typings.adone.adoneNs.streamNs.coreNs.Stream[scala.Nothing, ReaddirpEntry] = js.native
  /**
  ...
  /**
    ...
    */
  def utimes(path: String | Buffer | URL, atime: Double | String | Date, mtime: Double | String | Date): js.Promise[Unit] = js.native
  /**
    * Changes the file system timestamps of the object referenced by path
    */
  ...
  /**
    * Changes the file system timestamps of the object referenced by path
    */
  def utimesSync(path: String | Buffer | URL, atime: Double | String | Date, mtime: Double | String | Date): Unit = js.native
  /**
  ...
  def watch(paths: String, options: typings.adone.adoneNs.fsNs.INs.WatcherNs.ConstructorOptions): Watcher = js.native
  def watch(paths: js.Array[String]): Watcher = js.native
  def watch(paths: js.Array[String], options: typings.adone.adoneNs.fsNs.INs.WatcherNs.ConstructorOptions): Watcher = js.native
  /**
    * Creates a new TailWatcher instance with the given arguments
    */
  def watchTail(filename: String): TailWatcher = js.native
  def watchTail(filename: String, options: ConstructorOptions): TailWatcher = js.native
  /**
