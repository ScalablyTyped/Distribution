...
import typings.adone.adoneNs.mathNs.simdNs.INs.Bool16x8Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Bool8x16Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Int16x8Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Int8x16Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Uint16x8Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4Constructor
import typings.adone.adoneNs.mathNs.simdNs.INs.Uint8x16Constructor
...
trait Typeofsimd extends js.Object {
  @JSName("Bool16x8")
  val Bool16x8_Original: Bool16x8Constructor = js.native
  @JSName("Bool32x4")
  val Bool32x4_Original: Bool32x4Constructor = js.native
  @JSName("Bool8x16")
  val Bool8x16_Original: Bool8x16Constructor = js.native
  @JSName("Float32x4")
  val Float32x4_Original: Float32x4Constructor = js.native
  val INs: js.Any = js.native
  @JSName("Int16x8")
  val Int16x8_Original: Int16x8Constructor = js.native
  @JSName("Int32x4")
  val Int32x4_Original: Int32x4Constructor = js.native
  @JSName("Int8x16")
  val Int8x16_Original: Int8x16Constructor = js.native
  @JSName("Uint16x8")
  val Uint16x8_Original: Uint16x8Constructor = js.native
  @JSName("Uint32x4")
  val Uint32x4_Original: Uint32x4Constructor = js.native
  @JSName("Uint8x16")
  val Uint8x16_Original: Uint8x16Constructor = js.native
  /**
  ...
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Bool16x8 = js.native
  /**
    ...
    */
  def Bool32x4(): typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4 = js.native
  def Bool32x4(s0: Boolean): typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4 = js.native
  def Bool32x4(s0: Boolean, s1: Boolean): typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4 = js.native
  def Bool32x4(s0: Boolean, s1: Boolean, s2: Boolean): typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4 = js.native
  def Bool32x4(s0: Boolean, s1: Boolean, s2: Boolean, s3: Boolean): typings.adone.adoneNs.mathNs.simdNs.INs.Bool32x4 = js.native
  /**
  ...
  def Bool8x16(
    ...
    s6: js.UndefOr[Boolean],
    s7: js.UndefOr[Boolean],
    s8: js.UndefOr[Boolean],
    s9: js.UndefOr[Boolean],
    s10: js.UndefOr[Boolean],
    s11: js.UndefOr[Boolean],
    s12: js.UndefOr[Boolean],
    s13: js.UndefOr[Boolean],
    s14: js.UndefOr[Boolean],
    s15: js.UndefOr[Boolean]
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Bool8x16 = js.native
  /**
    ...
    */
  def Float32x4(): typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4 = js.native
  def Float32x4(s0: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4 = js.native
  def Float32x4(s0: Double, s1: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4 = js.native
  def Float32x4(s0: Double, s1: Double, s2: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4 = js.native
  def Float32x4(s0: Double, s1: Double, s2: Double, s3: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Float32x4 = js.native
  /**
  ...
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Int16x8 = js.native
  /**
    ...
    */
  def Int32x4(): typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4 = js.native
  def Int32x4(s0: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4 = js.native
  def Int32x4(s0: Double, s1: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4 = js.native
  def Int32x4(s0: Double, s1: Double, s2: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4 = js.native
  def Int32x4(s0: Double, s1: Double, s2: Double, s3: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Int32x4 = js.native
  /**
  ...
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Int8x16 = js.native
  /**
  ...
  def Uint16x8(
    ...
    s6: js.UndefOr[Double],
    s7: js.UndefOr[Double]
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Uint16x8 = js.native
  /**
    ...
    */
  def Uint32x4(): typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4 = js.native
  def Uint32x4(s0: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4 = js.native
  def Uint32x4(s0: Double, s1: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4 = js.native
  def Uint32x4(s0: Double, s1: Double, s2: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4 = js.native
  def Uint32x4(s0: Double, s1: Double, s2: Double, s3: Double): typings.adone.adoneNs.mathNs.simdNs.INs.Uint32x4 = js.native
  /**
  ...
  def Uint8x16(
    ...
    s14: js.UndefOr[Double],
    s15: js.UndefOr[Double]
  ): typings.adone.adoneNs.mathNs.simdNs.INs.Uint8x16 = js.native
}
