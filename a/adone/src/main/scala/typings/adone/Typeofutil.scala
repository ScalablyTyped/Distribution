...
trait Typeofutil extends js.Object {
  var TextDecoder: Instantiable0[typings.adone.glossesStdMod.utilNs.TextDecoder] = js.native
  var TextEncoder: Instantiable0[typings.adone.glossesStdMod.utilNs.TextEncoder] = js.native
