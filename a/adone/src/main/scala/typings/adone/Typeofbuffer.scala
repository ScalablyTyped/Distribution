...
trait Typeofbuffer extends js.Object {
  val Buffer: (Instantiable1[/* str */ String, typings.adone.glossesStdMod.bufferNs.Buffer]) | TypeofClassBuffer
  val INSPECT_MAX_BYTES: Double
  val SlowBuffer: Anon_Size | (Instantiable1[/* size */ Double, typings.adone.glossesStdMod.bufferNs.SlowBuffer])
