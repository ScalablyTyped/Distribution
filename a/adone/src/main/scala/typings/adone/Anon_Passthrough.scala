...
trait Anon_Passthrough extends js.Object {
  ...
  /**
    ...
    */
  @JSName("wait")
  var wait_FAnon_Passthrough: js.UndefOr[Boolean] = js.undefined
}

object Anon_Passthrough {
  @scala.inline
  def apply(passthrough: js.UndefOr[Boolean] = js.undefined, wait: js.UndefOr[Boolean] = js.undefined): Anon_Passthrough = {
