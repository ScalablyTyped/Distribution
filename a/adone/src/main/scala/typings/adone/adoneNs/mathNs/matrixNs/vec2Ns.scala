...
object vec2Ns extends js.Object {
  ...
  def cross(out: vec2, a: js.Array[Double], b: js.Array[Double]): vec2 = js.native
  def cross(out: vec2, a: js.Array[Double], b: vec2): vec2 = js.native
  def cross(out: vec2, a: vec2, b: js.Array[Double]): vec2 = js.native
  /**
    ...
    * @returns out
    */
  def cross(out: vec2, a: vec2, b: vec2): vec2 = js.native
