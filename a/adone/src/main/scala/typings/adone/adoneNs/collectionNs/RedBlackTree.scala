...
import typings.adone.adoneNs.collectionNs.INs.RedBlackTreeNs.Iterator
import typings.adone.adoneNs.collectionNs.INs.RedBlackTreeNs.Node
...
class RedBlackTree[K, V] () extends js.Object {
  def this(compare: js.Function2[/* a */ K, /* b */ K, Double]) = this()
  def this(compare: js.Function2[/* a */ K, /* b */ K, Double], root: RedBlackTree[K, V]) = this()
  /**
  ...
  /**
    ...
    */
  def find(key: K): (Iterator[K, V]) | Null = js.native
  /**
