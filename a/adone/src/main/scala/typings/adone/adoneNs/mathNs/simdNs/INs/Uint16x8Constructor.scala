...
trait Uint16x8Constructor extends js.Object {
  ...
  /**
    ...
    */
  def extractLane(simd: Uint16x8, lane: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def load(tarray: TypedArray, index: Double): Uint16x8 = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Uint16x8, lane: Double, value: Double): Uint16x8 = js.native
  /**
  ...
  /**
    ...
    */
  def shiftLeftByScalar(a: Uint16x8, bits: Double): Uint16x8 = js.native
  /**
    ...
    */
  def shiftRightByScalar(a: Uint16x8, bits: Double): Uint16x8 = js.native
  /**
  ...
  /**
    ...
    */
  def splat(n: Double): Uint16x8 = js.native
  /**
    ...
    */
  def store(tarray: TypedArray, index: Double, value: Uint16x8): Uint16x8 = js.native
