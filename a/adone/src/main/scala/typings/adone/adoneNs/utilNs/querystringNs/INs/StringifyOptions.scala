...
import typings.adone.adoneStrings.brackets
import typings.adone.adoneStrings.indices
import typings.adone.adoneStrings.repeat
...
trait StringifyOptions extends js.Object {
  ...
  var arrayFormat: js.UndefOr[indices | brackets | repeat] = js.undefined
  ...
  var serializeDate: js.UndefOr[js.Function1[/* d */ typings.std.Date, String]] = js.undefined
...
object StringifyOptions {
  ...
  def apply(
    ...
    arrayFormat: indices | brackets | repeat = null,
    ...
    serializeDate: /* d */ typings.std.Date => String = null,
