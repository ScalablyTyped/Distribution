...
/**
  ...
  */
class TimeMap[K, V] () extends Map[K, V] {
  def this(timeout: Double) = this()
  def this(timeout: Double, callback: js.Function1[/* key */ K, Unit]) = this()
  /**
    * Iterates over the map and calls the callback for each element
    */
  def forEach[T](callback: js.ThisFunction3[/* this */ T, /* value */ V, /* key */ K, /* cache */ this.type, Unit]): this.type = js.native
  def forEach[T](
    callback: js.ThisFunction3[/* this */ T, /* value */ V, /* key */ K, /* cache */ this.type, Unit],
    thisArg: T
  ): this.type = js.native
  /**
    * Gets the timeout
