...
trait ExecCommonOptions extends js.Object {
  ...
  /**
    ...
    * @default `true`
    */
  var extendEnv: js.UndefOr[Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @default `SIGTERM`
    */
  var killSignal: js.UndefOr[String | Double] = js.undefined
  /**
  ...
  /**
    ...
    * @default `true`
    */
  var preferLocal: js.UndefOr[Boolean] = js.undefined
  /**
    * Setting this to `false` resolves the promise with the error instead of rejecting it.
    * @default `true`
    */
  var reject: js.UndefOr[Boolean] = js.undefined
  /**
  ...
  /**
    ...
    * @see https://nodejs.org/api/child_process.html#child_process_options_stdio
    */
  var stdio: js.UndefOr[pipe | ignore | inherit | js.Array[StdIOOption]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var stripEof: js.UndefOr[Boolean] = js.undefined
  /**
