...
trait Bool32x4Constructor extends js.Object {
  ...
  def apply(s0: Boolean): Bool32x4 = js.native
  def apply(s0: Boolean, s1: Boolean): Bool32x4 = js.native
  def apply(s0: Boolean, s1: Boolean, s2: Boolean): Bool32x4 = js.native
  def apply(s0: Boolean, s1: Boolean, s2: Boolean, s3: Boolean): Bool32x4 = js.native
  /**
    * If all lane values are `true`, return `true`.
    */
  def allTrue(a: Bool32x4): Boolean = js.native
  def and(a: Bool32x4, b: Bool32x4): Bool32x4 = js.native
  /**
    * If any lane values are `true`, return `true`.
    */
  def anyTrue(a: Bool32x4): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def extractLane(simd: Bool32x4, lane: Double): Boolean = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Bool32x4, lane: Double, value: Boolean): Bool32x4 = js.native
  /**
    * Creates a new SIMD.Bool32x4 data type with all lanes set to a given value.
    */
  def splat(n: Boolean): Bool32x4 = js.native
