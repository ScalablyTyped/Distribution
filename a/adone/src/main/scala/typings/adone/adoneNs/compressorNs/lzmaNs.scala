...
/**
  ...
  */
@JSGlobal("adone.compressor.lzma")
@js.native
object lzmaNs extends js.Object {
  ...
  def compress(buf: String, options: AloneEncoderOptions): js.Promise[Buffer] = js.native
  def compress(buf: Buffer): js.Promise[Buffer] = js.native
  def compress(buf: Buffer, options: Double): js.Promise[Buffer] = js.native
  def compress(buf: Buffer, options: AloneEncoderOptions): js.Promise[Buffer] = js.native
  /**
  ...
  def compressStream(options: AloneEncoderOptions): Stream = js.native
  /**
  ...
  def decompress(buf: Buffer, options: AloneDecoderOptions): js.Promise[Buffer] = js.native
  /**
  ...
  def decompressStream(options: AloneDecoderOptions): Stream = js.native
  /**
