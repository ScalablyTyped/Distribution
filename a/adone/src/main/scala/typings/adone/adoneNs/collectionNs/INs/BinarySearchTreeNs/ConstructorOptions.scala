...
trait ConstructorOptions[K, V, Tree] extends js.Object {
  /**
    ...
    */
  var checkValueEquality: js.UndefOr[js.Function2[/* a */ V, /* b */ V, Boolean]] = js.undefined
  /**
    * Custom keys comparator, by default if a > b => -1, a < b -1, a === b => 0
    */
  var compareKeys: js.UndefOr[js.Function2[/* a */ K, /* b */ K, Double]] = js.undefined
  /**
    * The parent tree
    */
...
object ConstructorOptions {
  @scala.inline
  def apply[K, V, Tree](
    checkValueEquality: (/* a */ V, /* b */ V) => Boolean = null,
    compareKeys: (/* a */ K, /* b */ K) => Double = null,
    parent: Tree = null,
