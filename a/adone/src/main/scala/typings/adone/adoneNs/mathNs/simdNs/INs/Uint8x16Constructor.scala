...
trait Uint8x16Constructor extends js.Object {
  ...
  def apply(
    ...
    s8: js.UndefOr[Double],
    s9: js.UndefOr[Double],
    s10: js.UndefOr[Double],
    s11: js.UndefOr[Double],
    s12: js.UndefOr[Double],
    s13: js.UndefOr[Double],
    s14: js.UndefOr[Double],
    s15: js.UndefOr[Double]
  ): Uint8x16 = js.native
  ...
  /**
    ...
    */
  def extractLane(simd: Uint8x16, lane: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def load(tarray: TypedArray, index: Double): Uint8x16 = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Uint8x16, lane: Double, value: Double): Uint8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def shiftLeftByScalar(a: Uint8x16, bits: Double): Uint8x16 = js.native
  /**
    ...
    */
  def shiftRightByScalar(a: Uint8x16, bits: Double): Uint8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def splat(n: Double): Uint8x16 = js.native
  /**
    ...
    */
  def store(tarray: TypedArray, index: Double, value: Uint8x16): Uint8x16 = js.native
