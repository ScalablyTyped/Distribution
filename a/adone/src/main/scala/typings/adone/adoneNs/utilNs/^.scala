...
import typings.adone.Anon_Stringify
import typings.adone.Anon_ToRegex
...
object ^ extends js.Object {
  val binarySearch: BinarySearchFunction = js.native
  val braces: BracesFunction = js.native
  val fakeClock: FakeClock = js.native
  val `match`: MatchFunction = js.native
  /* Extracted nested Instantiables into classes in toposortNs */
  val toposort: ToposortFunction = js.native
  /**
