...
trait Bool8x16Constructor extends js.Object {
  ...
  /**
    ...
    */
  def extractLane(simd: Bool8x16, lane: Double): Boolean = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Bool8x16, lane: Double, value: Boolean): Bool8x16 = js.native
  /**
    * Creates a new SIMD.Bool8x16 data type with all lanes set to a given value.
    */
  def splat(n: Boolean): Bool8x16 = js.native
