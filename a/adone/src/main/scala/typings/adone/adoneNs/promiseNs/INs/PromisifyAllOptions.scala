...
trait PromisifyAllOptions extends js.Object {
  ...
  /**
    ...
    */
  var filter: js.UndefOr[js.Function1[/* key */ String, Boolean]] = js.undefined
  /**
...
object PromisifyAllOptions {
  @scala.inline
  def apply(context: js.Object = null, filter: /* key */ String => Boolean = null, suffix: String = null): PromisifyAllOptions = {
