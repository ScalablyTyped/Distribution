...
trait Float32x4Constructor extends js.Object {
  ...
  def apply(s0: Double): Float32x4 = js.native
  def apply(s0: Double, s1: Double): Float32x4 = js.native
  def apply(s0: Double, s1: Double, s2: Double): Float32x4 = js.native
  ...
  /**
    ...
    */
  def extractLane(simd: Float32x4, lane: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def load(tarray: TypedArray, index: Double): Float32x4 = js.native
  /**
    * Returns a new instance with 1 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load1(tarray: TypedArray, index: Double): Float32x4 = js.native
  /**
    * Returns a new instance with 2 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load2(tarray: TypedArray, index: Double): Float32x4 = js.native
  /**
    * Returns a new instance with 3 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load3(tarray: TypedArray, index: Double): Float32x4 = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Float32x4, lane: Double, value: Double): Float32x4 = js.native
  /**
  ...
  /**
    ...
    */
  def shuffle(a: Float32x4, b: Float32x4, l1: Double, l2: Double, l3: Double, l4: Double): Float32x4 = js.native
  /**
    * Creates a new SIMD.Float32x4 data type with all lanes set to a given value.
    */
  def splat(n: Double): Float32x4 = js.native
  ...
  /**
    ...
    */
  def store(tarray: TypedArray, index: Double, value: Float32x4): Float32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store1(tarray: TypedArray, index: Double, value: Float32x4): Float32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store2(tarray: TypedArray, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Float32Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Float64Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Int16Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Int32Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Uint16Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Uint32Array, index: Double, value: Float32x4): Float32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store3(tarray: Uint8Array, index: Double, value: Float32x4): Float32x4 = js.native
  def store3(tarray: Uint8ClampedArray, index: Double, value: Float32x4): Float32x4 = js.native
  def sub(a: Float32x4, b: Float32x4): Float32x4 = js.native
  /**
    * Returns a new instance with the lane values swizzled.
    */
  def swizzle(a: Float32x4, l1: Double, l2: Double, l3: Double, l4: Double): Float32x4 = js.native
}
