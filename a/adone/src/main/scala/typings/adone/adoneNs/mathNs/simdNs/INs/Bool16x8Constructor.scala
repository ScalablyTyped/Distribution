...
trait Bool16x8Constructor extends js.Object {
  /**
    ...
    */
  def apply(
    s0: js.UndefOr[Boolean],
    s1: js.UndefOr[Boolean],
    s2: js.UndefOr[Boolean],
    s3: js.UndefOr[Boolean],
    s4: js.UndefOr[Boolean],
    s5: js.UndefOr[Boolean],
    s6: js.UndefOr[Boolean],
    s7: js.UndefOr[Boolean]
  ): Bool16x8 = js.native
  /**
    * If all lane values are `true`, return `true`.
    */
  def allTrue(a: Bool16x8): Boolean = js.native
  def and(a: Bool16x8, b: Bool16x8): Bool16x8 = js.native
  /**
    * If any lane values are `true`, return `true`.
    */
  def anyTrue(a: Bool16x8): Boolean = js.native
  /**
  ...
  /**
    ...
    */
  def extractLane(simd: Bool16x8, lane: Double): Boolean = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Bool16x8, lane: Double, value: Boolean): Bool16x8 = js.native
  /**
    * Creates a new SIMD.Bool16x8 data type with all lanes set to a given value.
    */
  def splat(n: Boolean): Bool16x8 = js.native
