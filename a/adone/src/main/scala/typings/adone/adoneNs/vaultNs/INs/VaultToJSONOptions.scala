...
trait VaultToJSONOptions extends js.Object {
  var includeStats: js.UndefOr[Boolean] = js.undefined
  var valuable: js.UndefOr[ValuableToJSONOptions] = js.undefined
}

object VaultToJSONOptions {
  @scala.inline
  def apply(includeStats: js.UndefOr[Boolean] = js.undefined, valuable: ValuableToJSONOptions = null): VaultToJSONOptions = {
