...
trait MockAssertions extends Assertion {
  /**
    ...
    */
  def callCount(n: Double): this.type = js.native
  /**
  ...
  /**
    ...
    */
  def calledAfter(anotherSpy: Spy): this.type = js.native
  /**
    * Asserts that the spy has been called before anotherSpy
    */
  def calledBefore(anotherSpy: Spy): this.type = js.native
  /**
    * Asserts that the spy has been called immediately after anotherSpy
    */
  def calledImmediatelyAfter(anotherSpy: Spy): this.type = js.native
  /**
    * Asserts that the spy has been called immediately before anotherSpy
    */
  def calledImmediatelyBefore(anotherSpy: Spy): this.type = js.native
  /**
