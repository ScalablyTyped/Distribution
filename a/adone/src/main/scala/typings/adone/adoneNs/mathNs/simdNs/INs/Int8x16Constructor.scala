...
trait Int8x16Constructor extends js.Object {
  ...
  def add(a: Int8x16, b: Int8x16): Int8x16 = js.native
  def addSaturate(a: Int8x16, b: Int8x16): Int8x16 = js.native
  def and(a: Int8x16, b: Int8x16): Int8x16 = js.native
  /**
    * Returns a new instance if the parameter is a valid SIMD data type and the same as Int8x16. Throws a TypeError otherwise.
    */
  def check(a: Int8x16): Int8x16 = js.native
  def equal(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  /**
    ...
    */
  def extractLane(simd: Int8x16, lane: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def fromUint16x8Bits(value: Uint16x8): Int8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def fromUint8x16Bits(value: Uint8x16): Int8x16 = js.native
  def greaterThan(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  def greaterThanOrEqual(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  def lessThan(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  def lessThanOrEqual(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  /**
    ...
    */
  def load(tarray: TypedArray, index: Double): Int8x16 = js.native
  def mul(a: Int8x16, b: Int8x16): Int8x16 = js.native
  def neg(a: Int8x16): Int8x16 = js.native
  def not(a: Int8x16, b: Int8x16): Int8x16 = js.native
  def notEqual(a: Int8x16, b: Int8x16): Bool8x16 = js.native
  def or(a: Int8x16, b: Int8x16): Int8x16 = js.native
  /**
    ...
    */
  def replaceLane(simd: Int8x16, lane: Double, value: Double): Int8x16 = js.native
  /**
    ...
    */
  def select(selector: Bool8x16, a: Int8x16, b: Int8x16): Int8x16 = js.native
  /**
    ...
    */
  def shiftLeftByScalar(a: Int8x16, bits: Double): Int8x16 = js.native
  /**
    ...
    */
  def shiftRightByScalar(a: Int8x16, bits: Double): Int8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def splat(n: Double): Int8x16 = js.native
  /**
    ...
    */
  def store(tarray: TypedArray, index: Double, value: Int8x16): Int8x16 = js.native
  def sub(a: Int8x16, b: Int8x16): Int8x16 = js.native
  def subSaturate(a: Int8x16, b: Int8x16): Int8x16 = js.native
  /**
  ...
  def xor(a: Int8x16, b: Int8x16): Int8x16 = js.native
}
