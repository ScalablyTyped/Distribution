...
trait Int32x4Constructor extends js.Object {
  ...
  def apply(s0: Double): Int32x4 = js.native
  def apply(s0: Double, s1: Double): Int32x4 = js.native
  def apply(s0: Double, s1: Double, s2: Double): Int32x4 = js.native
  ...
  /**
    ...
    */
  def extractLane(simd: Int32x4, lane: Double): Double = js.native
  /**
  ...
  /**
    ...
    */
  def load(tarray: TypedArray, index: Double): Int32x4 = js.native
  /**
    * Returns a new instance with 1 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load1(tarray: TypedArray, index: Double): Int32x4 = js.native
  /**
    * Returns a new instance with 2 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load2(tarray: TypedArray, index: Double): Int32x4 = js.native
  /**
    * Returns a new instance with 3 lane values loaded from a typed array.
    * @param tarray An instance of a typed array.
    * @param index A number for the index from where to start loading in the typed array.
    */
  def load3(tarray: TypedArray, index: Double): Int32x4 = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Int32x4, lane: Double, value: Double): Int32x4 = js.native
  /**
  ...
  /**
    ...
    */
  def shiftLeftByScalar(a: Int32x4, bits: Double): Int32x4 = js.native
  /**
    ...
    */
  def shiftRightByScalar(a: Int32x4, bits: Double): Int32x4 = js.native
  /**
    * Returns a new instance with the lane values shuffled.
    */
  def shuffle(a: Int32x4, b: Int32x4, l1: Double, l2: Double, l3: Double, l4: Double): Int32x4 = js.native
  /**
    * Creates a new SIMD.Int32x4 data type with all lanes set to a given value.
    */
  def splat(n: Double): Int32x4 = js.native
  /**
    ...
    */
  def store(tarray: TypedArray, index: Double, value: Int32x4): Int32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store1(tarray: TypedArray, index: Double, value: Int32x4): Int32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store2(tarray: TypedArray, index: Double, value: Int32x4): Int32x4 = js.native
  /**
    ...
    * @return The value that has been stored (a SIMD data type).
    */
  def store3(tarray: TypedArray, index: Double, value: Int32x4): Int32x4 = js.native
  def sub(a: Int32x4, b: Int32x4): Int32x4 = js.native
  /**
    * Returns a new instance with the lane values swizzled.
    */
  def swizzle(a: Int32x4, l1: Double, l2: Double, l3: Double, l4: Double): Int32x4 = js.native
