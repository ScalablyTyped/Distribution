...
@js.native
trait Typeofthrottle extends js.Object {
  val DROPPED: js.Symbol = js.native
  val INs: js.Any = js.native
  var RateLimiter: Instantiable3[
    js.UndefOr[/* tokensPerInterval */ Double], 
    js.UndefOr[/* interval */ Double], 
    js.UndefOr[/* fireImmediately */ Boolean], 
    typings.adone.adoneNs.utilNs.throttleNs.RateLimiter
  ] = js.native
