...
@JSImport("adone/glosses/std", "path")
@js.native
object pathNs extends js.Object {
  /**
    * The platform-specific file delimiter. ';' or ':'.
    */
  val delimiter: adoneLib.adoneLibStrings.`;` | adoneLib.adoneLibStrings.`:` = js.native
  /**
    * The platform-specific file separator. '\\' or '/'.
    */
  val sep: adoneLib.adoneLibStrings.BACKSLASHBACKSLASH | adoneLib.adoneLibStrings.`/` = js.native
  /**
