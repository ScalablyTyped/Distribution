...
@js.native
trait Anon_AArgs extends js.Object {
  ...
  def retry[T](fn: js.Function1[/* info */ Anon_Current, js.Thenable[T] | T]): js.Promise[T] = js.native
  def retry[T](
    fn: js.Function1[/* info */ Anon_Current, js.Thenable[T] | T],
    options: adoneLib.adoneNs.promiseNs.INs.RetryOptions
  ): js.Promise[T] = js.native
  def retry[T](fn: js.Function1[/* info */ Anon_Current, js.Thenable[T] | T], options: scala.Double): js.Promise[T] = js.native
