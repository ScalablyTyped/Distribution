...
@js.native
trait Anon_AArgsArgument extends js.Object {
  var Cloner: org.scalablytyped.runtime.Instantiable0[adoneLib.adoneNs.utilNs.Cloner] = js.native
  var Editor: Anon_DEFAULT = js.native
  // terraformer: TODO
  val INs: Anon_FakeClock = js.native
  /**
  ...
  /**
    * buffer tools
    */
  val bufferNs: Anon_ABBuf = js.native
  val fakeClock: adoneLib.adoneNs.utilNs.INs.fakeClockNs.FakeClock = js.native
  val iconvNs: Anon_BufferDecode = js.native
  val inflectionNs: Anon_AllUpperCase = js.native
  val ltgtNs: Anon_Compare = js.native
  @JSName("match")
  val match_Original: adoneLib.adoneNs.utilNs.INs.MatchFunction = js.native
  val memcpyNs: Anon_Atoa = js.native
  // pool: TODO
  val querystringNs: Anon_Escape = js.native
  val sqlstringNs: Anon_Date = js.native
  val throttleNs: Anon_AArgsB = js.native
  @JSName("toposort")
  val toposort_Original: adoneLib.adoneNs.utilNs.INs.ToposortFunction = js.native
  val uuidNs: Anon_BufIName = js.native
  val xorDistanceNs: Anon_ABCompare = js.native
  /**
