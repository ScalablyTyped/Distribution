...
object ^ extends js.Object {
  ...
  def fromBuffer(
    ...
    options: (adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.BufferOptions with adoneLib.Anon_DecodeStrings) | adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.BufferOptions
  ...
  def fromFd(
    fd: scala.Double,
    options: (adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.FdOptions with adoneLib.Anon_DecodeStrings) | adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.FdOptions
  ): adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.ZipFile[nodeLib.Buffer] = js.native
  /**
  ...
  def fromRandomAccessReader(
    ...
    options: (adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.RandomAccessReaderOptions with adoneLib.Anon_DecodeStrings) | adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.RandomAccessReaderOptions
  ): adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.ZipFile[nodeLib.Buffer] = js.native
  /**
  ...
  def open(
    ...
    options: (adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.PathOptions with adoneLib.Anon_DecodeStrings) | adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.PathOptions
  ): adoneLib.adoneNs.archiveNs.zipNs.unpackNs.INs.ZipFile[nodeLib.Buffer] = js.native
  /**
