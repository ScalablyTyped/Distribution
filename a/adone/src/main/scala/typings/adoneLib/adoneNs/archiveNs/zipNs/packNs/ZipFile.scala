...
class ZipFile () extends js.Object {
  ...
  def addBuffer(buffer: nodeLib.Buffer, metadataPath: java.lang.String, options: adoneLib.Anon_CompressMtime): this.type = js.native
  /**
  ...
  def addEmptyDirectory(metadataPath: java.lang.String, options: adoneLib.Anon_Mtime): this.type = js.native
  /**
  ...
  def addFile(path: java.lang.String, metadataPath: java.lang.String, options: adoneLib.Anon_CompressMtime): this.type = js.native
  /**
  ...
  def addReadStream(
    ...
    options: adoneLib.Anon_ForceZip64Format
  ): this.type = js.native
  /**
  ...
  def end(options: adoneLib.Anon_ForceZip64FormatBoolean): js.Promise[scala.Double] = js.native
}
