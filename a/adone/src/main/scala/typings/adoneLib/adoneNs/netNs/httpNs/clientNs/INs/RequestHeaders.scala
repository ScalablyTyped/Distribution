...
trait RequestHeaders
  ...
  var DNT: js.UndefOr[java.lang.String] = js.undefined
  ...
  var `Front-End-Https`: js.UndefOr[java.lang.String] = js.undefined
  ...
  var `If-Range`: js.UndefOr[java.lang.String] = js.undefined
  var `If-Unmodified-Since`: js.UndefOr[java.lang.String] = js.undefined
  var `Max-Forwards`: js.UndefOr[java.lang.String] = js.undefined
  ...
  var `Proxy-Connection`: js.UndefOr[java.lang.String] = js.undefined
  var Range: js.UndefOr[java.lang.String] = js.undefined
  var Referer: js.UndefOr[java.lang.String] = js.undefined
  var TE: js.UndefOr[java.lang.String] = js.undefined
  ...
  var `X-ATT-DeviceId`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Correlation-ID`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Csrf-Token`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Forwarded-For`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Forwarded-Host`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Forwarded-Proto`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Http-Method-Override`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Request-ID`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Requested-With`: js.UndefOr[java.lang.String] = js.undefined
  var `X-UIDH`: js.UndefOr[java.lang.String] = js.undefined
  var `X-Wap-Profile`: js.UndefOr[java.lang.String] = js.undefined
}
