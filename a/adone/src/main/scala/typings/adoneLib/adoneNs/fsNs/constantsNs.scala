...
@JSGlobal("adone.fs.constants")
@js.native
object constantsNs extends js.Object {
  val F_OK: scala.Double = js.native
  val LOCK_EX: scala.Double = js.native
  val LOCK_NB: scala.Double = js.native
  val LOCK_SH: scala.Double = js.native
  val LOCK_UN: scala.Double = js.native
