...
trait Locale extends js.Object {
  ...
  def calendar(key: CalendarKey, m: Datetime): java.lang.String = js.native
  def calendar(key: CalendarKey, m: Datetime, now: Datetime): java.lang.String = js.native
  ...
  def months(m: Datetime): java.lang.String = js.native
  def months(m: Datetime, format: java.lang.String): java.lang.String = js.native
  ...
  def monthsShort(m: Datetime): java.lang.String = js.native
  def monthsShort(m: Datetime, format: java.lang.String): java.lang.String = js.native
  ...
  def week(m: Datetime): scala.Double = js.native
  def weekdays(): js.Array[java.lang.String] = js.native
  def weekdays(m: Datetime): java.lang.String = js.native
  def weekdays(m: Datetime, format: java.lang.String): java.lang.String = js.native
  def weekdaysMin(): js.Array[java.lang.String] = js.native
  def weekdaysMin(m: Datetime): java.lang.String = js.native
  ...
  def weekdaysShort(m: Datetime): java.lang.String = js.native
