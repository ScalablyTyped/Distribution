...
trait Int8x16Constructor extends js.Object {
  ...
  /**
    ...
    */
  def extractLane(simd: Int8x16, lane: scala.Double): scala.Double = js.native
  /**
  ...
  /**
    ...
    */
  def load(tarray: TypedArray, index: scala.Double): Int8x16 = js.native
  ...
  /**
    ...
    */
  def replaceLane(simd: Int8x16, lane: scala.Double, value: scala.Double): Int8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def shiftLeftByScalar(a: Int8x16, bits: scala.Double): Int8x16 = js.native
  /**
    ...
    */
  def shiftRightByScalar(a: Int8x16, bits: scala.Double): Int8x16 = js.native
  /**
  ...
  /**
    ...
    */
  def splat(n: scala.Double): Int8x16 = js.native
  /**
    ...
    */
  def store(tarray: TypedArray, index: scala.Double, value: Int8x16): Int8x16 = js.native
