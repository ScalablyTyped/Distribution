...
trait RandomAccessReaderOptions extends CommonOptions {
  /**
...
object RandomAccessReaderOptions {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[RandomAccessReaderOptions]
  }
}
