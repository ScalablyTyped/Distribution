...
object ^ extends js.Object {
  ...
  def readFile(
    ...
    options: (adoneLib.adoneNs.fsNs.INs.ReadFileOptions with (adoneLib.Anon_Check | adoneLib.Anon_CheckEncoding | adoneLib.Anon_CheckTrue | adoneLib.Anon_Encoding | adoneLib.Anon_Encoding_1429386911)) | adoneLib.adoneNs.fsNs.INs.ReadFileOptions
