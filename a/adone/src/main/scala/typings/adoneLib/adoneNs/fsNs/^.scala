...
object ^ extends js.Object {
  /**
    ...
    */
  val glob: adoneLib.adoneNs.fsNs.INs.GlobNs.GlobFunction = js.native
  ...
  def readFile(
    ...
    options: (adoneLib.adoneNs.fsNs.INs.ReadFileOptions with (adoneLib.Anon_Check | adoneLib.Anon_CheckEncoding | adoneLib.Anon_CheckTrue | adoneLib.Anon_EncodingNull | adoneLib.Anon_Encoding_1429386911)) | adoneLib.adoneNs.fsNs.INs.ReadFileOptions
  ...
  def readFileSync_String(
    filepath: adoneLib.adoneNs.fsNs.INs.URL,
    options: adoneLib.adoneNs.fsNs.INs.ReadFileOptions with adoneLib.Anon_Encoding_1429386911
  ...
  def realpath(path: adoneLib.adoneNs.fsNs.INs.URL, options: adoneLib.Anon_BufferEncoding): js.Promise[nodeLib.Buffer] = js.native
  ...
  def realpath(path: java.lang.String, options: adoneLib.Anon_BufferEncoding): js.Promise[nodeLib.Buffer] = js.native
  ...
  def realpath(path: nodeLib.Buffer, options: adoneLib.Anon_BufferEncoding): js.Promise[nodeLib.Buffer] = js.native
  ...
  def realpathSync(path: adoneLib.adoneNs.fsNs.INs.URL, options: adoneLib.Anon_BufferEncoding): nodeLib.Buffer = js.native
  ...
  def realpathSync(path: java.lang.String, options: adoneLib.Anon_BufferEncoding): nodeLib.Buffer = js.native
  ...
  def realpathSync(path: nodeLib.Buffer, options: adoneLib.Anon_BufferEncoding): nodeLib.Buffer = js.native
  ...
  def rm(path: java.lang.String, options: adoneLib.Anon_Cwd): js.Promise[scala.Unit] = js.native
  /**
  ...
  def tail(path: java.lang.String, n: scala.Double, options: adoneLib.Anon_ChunkLength): js.Promise[js.Array[nodeLib.Buffer]] = js.native
  /**
