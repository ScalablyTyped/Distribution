...
object utilNsMembers extends js.Object {
  val binarySearch: adoneLib.adoneNs.utilNs.INs.BinarySearchFunction = js.native
  ...
  def fillRange(
    from: scala.Double,
    to: scala.Double,
    options: (adoneLib.adoneNs.utilNs.INs.FillRangeOptions with adoneLib.Anon_Stringify) | adoneLib.adoneNs.utilNs.INs.FillRangeOptions
  ): js.Array[java.lang.String] = js.native
  @JSName("fillRange")
