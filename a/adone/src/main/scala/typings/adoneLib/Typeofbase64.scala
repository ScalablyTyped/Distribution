...
trait Typeofbase64 extends js.Object {
  ...
  @JSName("decodeVLQ")
  def decodeVLQ_true(value: java.lang.String, index: js.UndefOr[scala.Nothing], rest: adoneLib.adoneLibNumbers.`true`): Anon_Index = js.native
  @JSName("decodeVLQ")
  def decodeVLQ_true(value: java.lang.String, index: scala.Double, rest: adoneLib.adoneLibNumbers.`true`): Anon_Index = js.native
  /**
  ...
  def encode_String(
    str: java.lang.String,
    options: adoneLib.adoneNs.dataNs.base64Ns.INs.EncodeOptions with Anon_Buffer
  ): java.lang.String = js.native
  @JSName("encode")
  def encode_String(str: nodeLib.Buffer, options: adoneLib.adoneNs.dataNs.base64Ns.INs.EncodeOptions with Anon_Buffer): java.lang.String = js.native
}
