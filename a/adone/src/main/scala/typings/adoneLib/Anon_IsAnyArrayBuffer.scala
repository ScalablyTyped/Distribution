...
trait Anon_IsAnyArrayBuffer extends js.Object {
  def isAnyArrayBuffer(`object`: js.Any): scala.Boolean
  ...
  def isDate(`object`: js.Any): /* is std.Date */ scala.Boolean
  def isExternal(`object`: js.Any): scala.Boolean
  def isFloat32Array(`object`: js.Any): /* is std.Float32Array */ scala.Boolean
  def isFloat64Array(`object`: js.Any): /* is std.Float64Array */ scala.Boolean
  def isGeneratorFunction(`object`: js.Any): scala.Boolean
  def isGeneratorObject(`object`: js.Any): scala.Boolean
  def isInt16Array(`object`: js.Any): /* is std.Int16Array */ scala.Boolean
  def isInt32Array(`object`: js.Any): /* is std.Int32Array */ scala.Boolean
  ...
  def isProxy(`object`: js.Any): scala.Boolean
  def isRegExp(`object`: js.Any): /* is std.RegExp */ scala.Boolean
  def isSet(`object`: js.Any): scala.Boolean
  def isSetIterator(`object`: js.Any): scala.Boolean
  def isSharedArrayBuffer(`object`: js.Any): scala.Boolean
  def isStringObject(`object`: js.Any): scala.Boolean
  def isSymbolObject(`object`: js.Any): scala.Boolean
  def isTypedArray(`object`: js.Any): /* is node.NodeJS.TypedArray */ scala.Boolean
  def isUint16Array(`object`: js.Any): /* is std.Uint16Array */ scala.Boolean
  def isUint32Array(`object`: js.Any): /* is std.Uint32Array */ scala.Boolean
  def isUint8Array(`object`: js.Any): /* is std.Uint8Array */ scala.Boolean
  def isUint8ClampedArray(`object`: js.Any): /* is std.Uint8ClampedArray */ scala.Boolean
  def isWeakMap(`object`: js.Any): scala.Boolean
  def isWeakSet(`object`: js.Any): scala.Boolean
  def isWebAssemblyCompiledModule(`object`: js.Any): scala.Boolean
}

object Anon_IsAnyArrayBuffer {
  @scala.inline
  def apply(
    isAnyArrayBuffer: js.Any => scala.Boolean,
    ...
    isDate: js.Any => /* is std.Date */ scala.Boolean,
    isExternal: js.Any => scala.Boolean,
    isFloat32Array: js.Any => /* is std.Float32Array */ scala.Boolean,
    isFloat64Array: js.Any => /* is std.Float64Array */ scala.Boolean,
    isGeneratorFunction: js.Any => scala.Boolean,
    isGeneratorObject: js.Any => scala.Boolean,
    isInt16Array: js.Any => /* is std.Int16Array */ scala.Boolean,
    isInt32Array: js.Any => /* is std.Int32Array */ scala.Boolean,
    ...
    isProxy: js.Any => scala.Boolean,
    isRegExp: js.Any => /* is std.RegExp */ scala.Boolean,
    isSet: js.Any => scala.Boolean,
    isSetIterator: js.Any => scala.Boolean,
    isSharedArrayBuffer: js.Any => scala.Boolean,
    isStringObject: js.Any => scala.Boolean,
    isSymbolObject: js.Any => scala.Boolean,
    isTypedArray: js.Any => /* is node.NodeJS.TypedArray */ scala.Boolean,
    isUint16Array: js.Any => /* is std.Uint16Array */ scala.Boolean,
    isUint32Array: js.Any => /* is std.Uint32Array */ scala.Boolean,
    isUint8Array: js.Any => /* is std.Uint8Array */ scala.Boolean,
    isUint8ClampedArray: js.Any => /* is std.Uint8ClampedArray */ scala.Boolean,
    isWeakMap: js.Any => scala.Boolean,
