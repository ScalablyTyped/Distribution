...
object Anon_DisposeKey {
  @scala.inline
  def apply(
    dispose: (/* import warning: RewrittenClass.unapply cls $anonfun was tparam K */ /* key */ js.Any, /* import warning: RewrittenClass.unapply cls $anonfun was tparam V */ /* value */ js.Any) => scala.Unit = null,
