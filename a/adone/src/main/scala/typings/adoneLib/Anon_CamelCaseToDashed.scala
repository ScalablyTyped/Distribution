...
@js.native
trait Anon_CamelCaseToDashed extends js.Object {
  val INs: js.Any = js.native
  val endLineRegExp: stdLib.RegExp = js.native
  val escapeNs: Anon_Control = js.native
  val regexpNs: Anon_ArrayArray2alternatives = js.native
  val spinnerNs: Anon_Arrow = js.native
  val tableNs: Anon_BorderlessTable = js.native
  val unicodeNs: Anon_Approx = js.native
