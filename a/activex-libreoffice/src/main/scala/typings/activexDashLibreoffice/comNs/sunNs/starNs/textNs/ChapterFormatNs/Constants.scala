package typings.activexDashLibreoffice.comNs.sunNs.starNs.textNs.ChapterFormatNs
...
object Constants {
  @scala.inline
  def DIGIT: `4` = this.cast(4)
  @scala.inline
  def NAME: `0` = this.cast(0)
  @scala.inline
  def NAME_NUMBER: `2` = this.cast(2)
  @scala.inline
  def NO_PREFIX_SUFFIX: `3` = this.cast(3)
  @scala.inline
