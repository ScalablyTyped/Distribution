package typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.PropertyConceptNs
...
object Constants {
  ...
  @scala.inline
  def DANGEROUS: `1` = this.cast(1)
  @scala.inline
  def METHODS: `8` = this.cast(8)
  @scala.inline
  def PROPERTYSET: `2` = this.cast(2)
  @scala.inline
