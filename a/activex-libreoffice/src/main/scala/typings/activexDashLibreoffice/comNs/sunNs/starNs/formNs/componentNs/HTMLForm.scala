...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.FormSubmitEncoding
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.FormSubmitMethod
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.XReset
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.XSubmit
