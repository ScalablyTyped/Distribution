package typings.activexDashLibreoffice.comNs.sunNs.starNs.ucbNs.OpenModeNs
...
object Constants {
  ...
  @scala.inline
  def DOCUMENT: `2` = this.cast(2)
  @scala.inline
  def DOCUMENTS: `3` = this.cast(3)
  @scala.inline
  def DOCUMENT_SHARE_DENY_NONE: `4` = this.cast(4)
  @scala.inline
  def DOCUMENT_SHARE_DENY_WRITE: `5` = this.cast(5)
  @scala.inline
  def FOLDERS: `1` = this.cast(1)
  @scala.inline
