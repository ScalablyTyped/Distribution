package typings.activexDashLibreoffice.comNs.sunNs.starNs.uiNs.dialogsNs.CommonFilePickerElementIdsNs
...
object Constants {
  @scala.inline
  def CONTROL_FILEVIEW: `4` = this.cast(4)
  @scala.inline
  def EDIT_FILEURL: `5` = this.cast(5)
  @scala.inline
  def EDIT_FILEURL_LABEL: `7` = this.cast(7)
  @scala.inline
  def LISTBOX_FILTER: `3` = this.cast(3)
  @scala.inline
  def LISTBOX_FILTER_LABEL: `6` = this.cast(6)
  @scala.inline
  def PUSHBUTTON_CANCEL: `2` = this.cast(2)
  @scala.inline
  def PUSHBUTTON_OK: `1` = this.cast(1)
  @scala.inline
