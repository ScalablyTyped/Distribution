...
object Alignment {
  /**
    ...
    */
  @scala.inline
  def BOTTOM: `7` = this.cast(7)
  @scala.inline
  def BOTTOM_LEFT: `6` = this.cast(6)
  @scala.inline
  def BOTTOM_RIGHT: `8` = this.cast(8)
  /** The text is centered inside the shape. */
  @scala.inline
  def CENTER: `4` = this.cast(4)
  /**
  ...
  @scala.inline
  def TOP_LEFT: `0` = this.cast(0)
  @scala.inline
  def TOP_RIGHT: `2` = this.cast(2)
  @scala.inline
