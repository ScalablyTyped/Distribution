...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.xmlNs.saxNs.XEntityResolver
import typings.activexDashLibreoffice.comNs.sunNs.starNs.xmlNs.saxNs.XErrorHandler
