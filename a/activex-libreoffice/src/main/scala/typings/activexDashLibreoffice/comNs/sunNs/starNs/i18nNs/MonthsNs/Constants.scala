package typings.activexDashLibreoffice.comNs.sunNs.starNs.i18nNs.MonthsNs
...
object Constants {
  @scala.inline
  def APRIL: `3` = this.cast(3)
  @scala.inline
  def AUGUST: `7` = this.cast(7)
  @scala.inline
  def DECEMBER: `11` = this.cast(11)
  @scala.inline
  def FEBURARY: `1` = this.cast(1)
  @scala.inline
  def JANUARY: `0` = this.cast(0)
  @scala.inline
  def JULY: `6` = this.cast(6)
  @scala.inline
  def JUNE: `5` = this.cast(5)
  @scala.inline
  def MARCH: `2` = this.cast(2)
  @scala.inline
  def MAY: `4` = this.cast(4)
  @scala.inline
  def NOVEMBER: `10` = this.cast(10)
  @scala.inline
  def OCTOBER: `9` = this.cast(9)
  @scala.inline
  def SEPTEMBER: `8` = this.cast(8)
  @scala.inline
