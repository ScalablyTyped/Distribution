...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.XHierarchicalPropertySet
import typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.XHierarchicalPropertySetInfo
import typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.XMultiHierarchicalPropertySet
