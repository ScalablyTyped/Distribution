package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseArmStyleNs
...
object Constants {
  @scala.inline
  def ANYTHING: `0` = this.cast(0)
  @scala.inline
  def BENT_DOUBLE_SERIF: `11` = this.cast(11)
  @scala.inline
  def BENT_HORIZONTAL: `7` = this.cast(7)
  @scala.inline
  def BENT_SINGLE_SERIF: `10` = this.cast(10)
  @scala.inline
  def BENT_VERTICAL: `9` = this.cast(9)
  @scala.inline
  def BENT_WEDGE: `8` = this.cast(8)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def STRAIGHT_DOUBLE_SERIF: `6` = this.cast(6)
  @scala.inline
  def STRAIGHT_HORIZONTAL: `2` = this.cast(2)
  @scala.inline
  def STRAIGHT_SINGLE_SERIF: `5` = this.cast(5)
  @scala.inline
  def STRAIGHT_VERTICAL: `4` = this.cast(4)
  @scala.inline
  def STRAIGHT_WEDGE: `3` = this.cast(3)
  @scala.inline
