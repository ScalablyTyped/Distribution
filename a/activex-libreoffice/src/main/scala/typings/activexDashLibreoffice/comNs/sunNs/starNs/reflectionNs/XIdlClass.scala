...
trait XIdlClass[T] extends XInterface {
  ...
  /**
    ...
    */
  val TypeClass: typings.activexDashLibreoffice.comNs.sunNs.starNs.unoNs.TypeClass
  /**
    * Deprecated. Do not call.
    * @deprecated Deprecated
    */
  ...
  /**
    ...
    * @returns type class of the reflected type.
    */
  def getTypeClass(): typings.activexDashLibreoffice.comNs.sunNs.starNs.unoNs.TypeClass
  /**
    * Deprecated. Do not call.
    * @deprecated Deprecated
    */
