package typings.activexDashLibreoffice.comNs.sunNs.starNs.textNs.HoriOrientationNs
...
object Constants {
  ...
  @scala.inline
  def FULL: `6` = this.cast(6)
  @scala.inline
  def INSIDE: `4` = this.cast(4)
  @scala.inline
  def LEFT: `3` = this.cast(3)
  @scala.inline
  def LEFT_AND_WIDTH: `7` = this.cast(7)
  @scala.inline
  def NONE: `0` = this.cast(0)
  @scala.inline
  def OUTSIDE: `5` = this.cast(5)
  @scala.inline
