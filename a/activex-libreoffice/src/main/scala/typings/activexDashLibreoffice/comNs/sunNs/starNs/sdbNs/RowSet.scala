...
- typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.RowSet because var conflicts: CursorName, FetchDirection, FetchSize, ResultSetConcurrency, ResultSetType. Inlined Command, DataSourceName, EscapeProcessing, MaxFieldSize, MaxRows, Password, QueryTimeOut, TransactionIsolation, TypeMap, URL, User */ trait RowSet
  extends ResultSet
...
object RowSet {
  ...
  def apply(
    ...
    Privileges: Double,
    RowCount: Double,
    RowSet: typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.RowSet = null,
