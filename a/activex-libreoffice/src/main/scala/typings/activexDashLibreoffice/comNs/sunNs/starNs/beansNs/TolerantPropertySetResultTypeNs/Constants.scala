package typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.TolerantPropertySetResultTypeNs
...
object Constants {
  @scala.inline
  def ILLEGAL_ARGUMENT: `2` = this.cast(2)
  @scala.inline
  def PROPERTY_VETO: `3` = this.cast(3)
  @scala.inline
  def SUCCESS: `0` = this.cast(0)
  @scala.inline
  def UNKNOWN_FAILURE: `5` = this.cast(5)
  @scala.inline
  def UNKNOWN_PROPERTY: `1` = this.cast(1)
  @scala.inline
  def WRAPPED_TARGET: `4` = this.cast(4)
  @scala.inline
