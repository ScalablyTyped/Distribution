package typings.activexDashLibreoffice.comNs.sunNs.starNs.awtNs.FieldUnitNs
...
object Constants {
  @scala.inline
  def FUNIT_100TH_MM: `13` = this.cast(13)
  @scala.inline
  def FUNIT_CM: `2` = this.cast(2)
  @scala.inline
  def FUNIT_CUSTOM: `11` = this.cast(11)
  @scala.inline
  def FUNIT_FOOT: `9` = this.cast(9)
  @scala.inline
  def FUNIT_INCH: `8` = this.cast(8)
  @scala.inline
  def FUNIT_KM: `4` = this.cast(4)
  @scala.inline
  def FUNIT_M: `3` = this.cast(3)
  @scala.inline
  def FUNIT_MILE: `10` = this.cast(10)
  @scala.inline
  def FUNIT_MM: `1` = this.cast(1)
  @scala.inline
  def FUNIT_NONE: `0` = this.cast(0)
  @scala.inline
  def FUNIT_PERCENT: `12` = this.cast(12)
  @scala.inline
  def FUNIT_PICA: `7` = this.cast(7)
  @scala.inline
  def FUNIT_POINT: `6` = this.cast(6)
  @scala.inline
  def FUNIT_TWIP: `5` = this.cast(5)
  @scala.inline
