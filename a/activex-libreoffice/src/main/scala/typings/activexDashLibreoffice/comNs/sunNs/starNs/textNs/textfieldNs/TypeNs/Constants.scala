package typings.activexDashLibreoffice.comNs.sunNs.starNs.textNs.textfieldNs.TypeNs
...
object Constants {
  @scala.inline
  def AUTHOR: `8` = this.cast(8)
  @scala.inline
  def DATE: `0` = this.cast(0)
  @scala.inline
  def DOCINFO_TITLE: `10` = this.cast(10)
  @scala.inline
  def EXTENDED_FILE: `7` = this.cast(7)
  @scala.inline
  def EXTENDED_TIME: `6` = this.cast(6)
  @scala.inline
  def MEASURE: `9` = this.cast(9)
  @scala.inline
  def PAGE: `2` = this.cast(2)
  @scala.inline
  def PAGES: `3` = this.cast(3)
  @scala.inline
  def PAGE_NAME: `14` = this.cast(14)
  @scala.inline
  def PRESENTATION_DATE_TIME: `13` = this.cast(13)
  @scala.inline
  def PRESENTATION_FOOTER: `12` = this.cast(12)
  @scala.inline
  def PRESENTATION_HEADER: `11` = this.cast(11)
  @scala.inline
  def TABLE: `5` = this.cast(5)
  @scala.inline
  def TIME: `4` = this.cast(4)
  @scala.inline
  def UNSPECIFIED: `-1` = this.cast(-1)
  @scala.inline
  def URL: `1` = this.cast(1)
  @scala.inline
