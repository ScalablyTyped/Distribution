package typings.activexDashLibreoffice.comNs.sunNs.starNs.ucbNs.RuleActionNs
...
object Constants {
  @scala.inline
  def COPY: `8` = this.cast(8)
  @scala.inline
  def DELETE: `9` = this.cast(9)
  @scala.inline
  def FORWARD: `11` = this.cast(11)
  @scala.inline
  def HIDE: `2` = this.cast(2)
  @scala.inline
  def LINK: `10` = this.cast(10)
  @scala.inline
  def MARK: `3` = this.cast(3)
  @scala.inline
  def MARKREAD: `5` = this.cast(5)
  @scala.inline
  def MARKUNREAD: `6` = this.cast(6)
  @scala.inline
  def MOVE: `7` = this.cast(7)
  @scala.inline
  def NONE: `0` = this.cast(0)
  @scala.inline
  def SHOW: `1` = this.cast(1)
  @scala.inline
  def UNMARK: `4` = this.cast(4)
  @scala.inline
