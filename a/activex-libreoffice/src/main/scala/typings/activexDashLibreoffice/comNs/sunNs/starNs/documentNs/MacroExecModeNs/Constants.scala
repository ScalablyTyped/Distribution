package typings.activexDashLibreoffice.comNs.sunNs.starNs.documentNs.MacroExecModeNs
...
object Constants {
  @scala.inline
  def ALWAYS_EXECUTE: `2` = this.cast(2)
  @scala.inline
  def ALWAYS_EXECUTE_NO_WARN: `4` = this.cast(4)
  @scala.inline
  def FROM_LIST: `1` = this.cast(1)
  @scala.inline
  def FROM_LIST_AND_SIGNED_NO_WARN: `9` = this.cast(9)
  @scala.inline
  def FROM_LIST_AND_SIGNED_WARN: `8` = this.cast(8)
  @scala.inline
  def FROM_LIST_NO_WARN: `7` = this.cast(7)
  @scala.inline
  def NEVER_EXECUTE: `0` = this.cast(0)
  @scala.inline
  def USE_CONFIG: `3` = this.cast(3)
  @scala.inline
  def USE_CONFIG_APPROVE_CONFIRMATION: `6` = this.cast(6)
  @scala.inline
  def USE_CONFIG_REJECT_CONFIRMATION: `5` = this.cast(5)
  @scala.inline
