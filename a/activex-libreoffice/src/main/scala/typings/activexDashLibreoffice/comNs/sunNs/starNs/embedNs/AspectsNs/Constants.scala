package typings.activexDashLibreoffice.comNs.sunNs.starNs.embedNs.AspectsNs
...
object Constants {
  @scala.inline
  def MSOLE_CONTENT: `1` = this.cast(1)
  @scala.inline
  def MSOLE_DOCPRINT: `8` = this.cast(8)
  @scala.inline
  def MSOLE_ICON: `4` = this.cast(4)
  @scala.inline
  def MSOLE_THUMBNAIL: `2` = this.cast(2)
  @scala.inline
