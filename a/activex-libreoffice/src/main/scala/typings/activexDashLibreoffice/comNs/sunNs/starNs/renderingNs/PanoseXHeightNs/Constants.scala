package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseXHeightNs
...
object Constants {
  ...
  @scala.inline
  def CONSTANT_LARGE: `4` = this.cast(4)
  @scala.inline
  def CONSTANT_SMALL: `2` = this.cast(2)
  @scala.inline
  def CONSTANT_STANDARD: `3` = this.cast(3)
  @scala.inline
  def DUCKING_LARGE: `7` = this.cast(7)
  @scala.inline
  def DUCKING_SMALL: `5` = this.cast(5)
  @scala.inline
  def DUCKING_STANDARD: `6` = this.cast(6)
  @scala.inline
