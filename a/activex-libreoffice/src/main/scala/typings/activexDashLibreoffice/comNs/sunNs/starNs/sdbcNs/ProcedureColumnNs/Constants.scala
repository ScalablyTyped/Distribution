package typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.ProcedureColumnNs
...
object Constants {
  @scala.inline
  def IN: `1` = this.cast(1)
  @scala.inline
  def INOUT: `2` = this.cast(2)
  @scala.inline
  def OUT: `4` = this.cast(4)
  @scala.inline
  def RESULT: `3` = this.cast(3)
  @scala.inline
  def RETURN: `5` = this.cast(5)
  @scala.inline
