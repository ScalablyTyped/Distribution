package typings.activexDashLibreoffice.comNs.sunNs.starNs.sheetNs.ExternalLinkTypeNs
...
object Constants {
  @scala.inline
  def DDE: `2` = this.cast(2)
  @scala.inline
  def DOCUMENT: `1` = this.cast(1)
  @scala.inline
  def SELF: `3` = this.cast(3)
  @scala.inline
