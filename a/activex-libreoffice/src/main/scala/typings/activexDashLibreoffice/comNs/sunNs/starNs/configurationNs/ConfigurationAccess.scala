...
- typings.activexDashLibreoffice.comNs.sunNs.starNs.configurationNs.GroupElement because var conflicts: Name, Parent. Inlined - typings.activexDashLibreoffice.comNs.sunNs.starNs.configurationNs.SetElement because var conflicts: Name, Parent. Inlined  */ trait ConfigurationAccess
  extends GroupAccess
     with SetAccess
