...
- typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.componentNs.PatternField because var conflicts: ClassId, DefaultControl, Height, Name, Parent, PositionX, PositionY, PropertyValues, Step, TabIndex, Tag, Width. Inlined DefaultText */ @js.native
