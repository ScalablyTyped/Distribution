package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseStrokeVariationNs
...
object Constants {
  ...
  @scala.inline
  def GRADUAL_DIAGONAL: `2` = this.cast(2)
  @scala.inline
  def GRADUAL_HORIZONTAL: `5` = this.cast(5)
  @scala.inline
  def GRADUAL_TRANSITIONAL: `3` = this.cast(3)
  @scala.inline
  def GRADUAL_VERTICAL: `4` = this.cast(4)
  @scala.inline
  def INSTANT_VERTICAL: `8` = this.cast(8)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def RAPID_HORIZONTAL: `7` = this.cast(7)
  @scala.inline
  def RAPID_VERTICAL: `6` = this.cast(6)
  @scala.inline
