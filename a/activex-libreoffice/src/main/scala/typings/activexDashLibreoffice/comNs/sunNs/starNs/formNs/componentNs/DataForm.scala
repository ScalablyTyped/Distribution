...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.TabulatorCycle
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.XDatabaseParameterBroadcaster
import typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.XLoadable
...
trait DataForm
  ...
  var NavigationBarMode: typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.NavigationBarMode = js.native
}
