package typings.activexDashLibreoffice.comNs.sunNs.starNs.xsdNs.DataTypeClassNs
...
object Constants {
  @scala.inline
  def BOOLEAN: `2` = this.cast(2)
  @scala.inline
  def DATE: `9` = this.cast(9)
  @scala.inline
  def DATETIME: `7` = this.cast(7)
  @scala.inline
  def DECIMAL: `3` = this.cast(3)
  @scala.inline
  def DOUBLE: `5` = this.cast(5)
  @scala.inline
  def DURATION: `6` = this.cast(6)
  @scala.inline
  def FLOAT: `4` = this.cast(4)
  @scala.inline
  def NOTATION: `19` = this.cast(19)
  @scala.inline
  def QName: `18` = this.cast(18)
  @scala.inline
  def STRING: `1` = this.cast(1)
  @scala.inline
  def TIME: `8` = this.cast(8)
  @scala.inline
  def anyURI: `17` = this.cast(17)
  @scala.inline
  def base64Binary: `16` = this.cast(16)
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def gDay: `13` = this.cast(13)
  @scala.inline
  def gMonth: `14` = this.cast(14)
  @scala.inline
  def gMonthDay: `12` = this.cast(12)
  @scala.inline
  def gYear: `11` = this.cast(11)
  @scala.inline
  def gYearMonth: `10` = this.cast(10)
  @scala.inline
  def hexBinary: `15` = this.cast(15)
}
