...
trait XFormsUIHelper1 extends js.Object {
  ...
  def newModel(xModel: typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel, sName: String): XModel
  ...
  def removeModel(xModel: typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel, sName: String): Unit
  def renameInstance(sFrom: String, sTo: String, sURL: String, bURLOnce: Boolean): Unit
  def renameModel(
    xModel: typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel,
    sFrom: String,
    sTo: String
  ): Unit
...
object XFormsUIHelper1 {
  ...
  def apply(
    ...
    newModel: (typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel, String) => XModel,
    removeBindingForNode: XNode => Unit,
    removeBindingIfUseless: XPropertySet => Unit,
    removeInstance: String => Unit,
    removeModel: (typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel, String) => Unit,
    renameInstance: (String, String, String, Boolean) => Unit,
    renameModel: (typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XModel, String, String) => Unit,
