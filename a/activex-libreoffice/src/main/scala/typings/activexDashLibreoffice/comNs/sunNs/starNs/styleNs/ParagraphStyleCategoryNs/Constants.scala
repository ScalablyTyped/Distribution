package typings.activexDashLibreoffice.comNs.sunNs.starNs.styleNs.ParagraphStyleCategoryNs
...
object Constants {
  @scala.inline
  def CHAPTER: `1` = this.cast(1)
  @scala.inline
  def EXTRA: `4` = this.cast(4)
  @scala.inline
  def HTML: `5` = this.cast(5)
  @scala.inline
  def INDEX: `3` = this.cast(3)
  @scala.inline
  def LIST: `2` = this.cast(2)
  @scala.inline
  def TEXT: `0` = this.cast(0)
  @scala.inline
