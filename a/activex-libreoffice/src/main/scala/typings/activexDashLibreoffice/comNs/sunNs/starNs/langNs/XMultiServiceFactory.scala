...
trait XMultiServiceFactory extends XInterface {
  ...
  def createInstanceWithArguments[K /* <: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 1364 */ js.Any */](ServiceSpecifier: K, Arguments: SeqEquiv[_]): /* import warning: ImportType.apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
  /**
    * Provides the available names of the factory to be used to create instances.
    * @returns sequence of all names
    */
