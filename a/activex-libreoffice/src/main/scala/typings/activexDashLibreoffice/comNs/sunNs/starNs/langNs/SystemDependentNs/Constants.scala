package typings.activexDashLibreoffice.comNs.sunNs.starNs.langNs.SystemDependentNs
...
object Constants {
  @scala.inline
  def SYSTEM_ANDROID: `8` = this.cast(8)
  @scala.inline
  def SYSTEM_IOS: `7` = this.cast(7)
  @scala.inline
  def SYSTEM_JAVA: `3` = this.cast(3)
  @scala.inline
  def SYSTEM_MAC: `5` = this.cast(5)
  @scala.inline
  def SYSTEM_OS2: `4` = this.cast(4)
  @scala.inline
  def SYSTEM_WIN16: `2` = this.cast(2)
  @scala.inline
  def SYSTEM_WIN32: `1` = this.cast(1)
  @scala.inline
  def SYSTEM_XWINDOW: `6` = this.cast(6)
  @scala.inline
