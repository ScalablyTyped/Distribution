...
- typings.activexDashLibreoffice.comNs.sunNs.starNs.formNs.componentNs.ComboBox because var conflicts: ClassId, DefaultControl, Height, Name, Parent, PositionX, PositionY, PropertyValues, Step, TabIndex, Tag, Width. Inlined DefaultText */ @js.native
trait DatabaseComboBox extends DataAwareControlModel {
  /**
