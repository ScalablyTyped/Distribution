package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseWeightNs
...
object Constants {
  ...
  @scala.inline
  def BLACK: `10` = this.cast(10)
  @scala.inline
  def BOLD: `8` = this.cast(8)
  @scala.inline
  def BOOK: `5` = this.cast(5)
  @scala.inline
  def DEMI_BOLD: `7` = this.cast(7)
  @scala.inline
  def HEAVY: `9` = this.cast(9)
  @scala.inline
  def LIGHT: `3` = this.cast(3)
  @scala.inline
  def MEDIUM: `6` = this.cast(6)
  @scala.inline
  def NORD: `11` = this.cast(11)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def THIN: `4` = this.cast(4)
  @scala.inline
  def VERY_LIGHT: `2` = this.cast(2)
  @scala.inline
