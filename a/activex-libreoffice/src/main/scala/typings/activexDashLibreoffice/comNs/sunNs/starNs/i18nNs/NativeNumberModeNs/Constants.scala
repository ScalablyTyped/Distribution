package typings.activexDashLibreoffice.comNs.sunNs.starNs.i18nNs.NativeNumberModeNs
...
object Constants {
  @scala.inline
  def NATNUM0: `0` = this.cast(0)
  @scala.inline
  def NATNUM1: `1` = this.cast(1)
  @scala.inline
  def NATNUM10: `10` = this.cast(10)
  @scala.inline
  def NATNUM11: `11` = this.cast(11)
  @scala.inline
  def NATNUM2: `2` = this.cast(2)
  @scala.inline
  def NATNUM3: `3` = this.cast(3)
  @scala.inline
  def NATNUM4: `4` = this.cast(4)
  @scala.inline
  def NATNUM5: `5` = this.cast(5)
  @scala.inline
  def NATNUM6: `6` = this.cast(6)
  @scala.inline
  def NATNUM7: `7` = this.cast(7)
  @scala.inline
  def NATNUM8: `8` = this.cast(8)
  @scala.inline
  def NATNUM9: `9` = this.cast(9)
  @scala.inline
