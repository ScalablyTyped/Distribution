package typings.activexDashLibreoffice.comNs.sunNs.starNs.animationsNs.EventTriggerNs
...
object Constants {
  @scala.inline
  def BEGIN_EVENT: `3` = this.cast(3)
  @scala.inline
  def END_EVENT: `4` = this.cast(4)
  @scala.inline
  def NONE: `0` = this.cast(0)
  @scala.inline
  def ON_BEGIN: `1` = this.cast(1)
  @scala.inline
  def ON_CLICK: `5` = this.cast(5)
  @scala.inline
  def ON_DBL_CLICK: `6` = this.cast(6)
  @scala.inline
  def ON_END: `2` = this.cast(2)
  @scala.inline
  def ON_MOUSE_ENTER: `7` = this.cast(7)
  @scala.inline
  def ON_MOUSE_LEAVE: `8` = this.cast(8)
  @scala.inline
  def ON_NEXT: `9` = this.cast(9)
  @scala.inline
  def ON_PREV: `10` = this.cast(10)
  @scala.inline
  def ON_STOP_AUDIO: `11` = this.cast(11)
  @scala.inline
  def REPEAT: `12` = this.cast(12)
  @scala.inline
