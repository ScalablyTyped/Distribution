package typings.activexDashLibreoffice.comNs.sunNs.starNs.textNs.RelOrientationNs
...
object Constants {
  @scala.inline
  def CHAR: `2` = this.cast(2)
  @scala.inline
  def FRAME: `0` = this.cast(0)
  @scala.inline
  def FRAME_LEFT: `5` = this.cast(5)
  @scala.inline
  def FRAME_RIGHT: `6` = this.cast(6)
  @scala.inline
  def PAGE_FRAME: `7` = this.cast(7)
  @scala.inline
  def PAGE_LEFT: `3` = this.cast(3)
  @scala.inline
  def PAGE_PRINT_AREA: `8` = this.cast(8)
  @scala.inline
  def PAGE_RIGHT: `4` = this.cast(4)
  @scala.inline
  def PRINT_AREA: `1` = this.cast(1)
  @scala.inline
  def TEXT_LINE: `9` = this.cast(9)
  @scala.inline
