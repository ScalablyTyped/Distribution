...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.documentNs.XScriptInvocationContext
import typings.activexDashLibreoffice.comNs.sunNs.starNs.frameNs.XDesktop
