package typings.activexDashLibreoffice.comNs.sunNs.starNs.uiNs.dialogsNs.ListboxControlActionsNs
...
object Constants {
  @scala.inline
  def ADD_ITEM: `1` = this.cast(1)
  @scala.inline
  def ADD_ITEMS: `2` = this.cast(2)
  @scala.inline
  def DELETE_ITEM: `3` = this.cast(3)
  @scala.inline
  def DELETE_ITEMS: `4` = this.cast(4)
  @scala.inline
  def GET_ITEMS: `6` = this.cast(6)
  @scala.inline
  def GET_SELECTED_ITEM: `7` = this.cast(7)
  @scala.inline
  def SET_SELECT_ITEM: `5` = this.cast(5)
  @scala.inline
