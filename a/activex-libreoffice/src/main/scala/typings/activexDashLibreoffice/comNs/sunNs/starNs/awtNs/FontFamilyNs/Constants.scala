package typings.activexDashLibreoffice.comNs.sunNs.starNs.awtNs.FontFamilyNs
...
object Constants {
  @scala.inline
  def DECORATIVE: `1` = this.cast(1)
  @scala.inline
  def DONTKNOW: `0` = this.cast(0)
  @scala.inline
  def MODERN: `2` = this.cast(2)
  @scala.inline
  def ROMAN: `3` = this.cast(3)
  @scala.inline
  def SCRIPT: `4` = this.cast(4)
  @scala.inline
  def SWISS: `5` = this.cast(5)
  @scala.inline
  def SYSTEM: `6` = this.cast(6)
  @scala.inline
