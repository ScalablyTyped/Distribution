package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.EmphasisMarkNs
...
object Constants {
  @scala.inline
  def ACCENT_ABOVE: `7` = this.cast(7)
  @scala.inline
  def ACCENT_BELOW: `8` = this.cast(8)
  @scala.inline
  def CIRCLE_ABOVE: `3` = this.cast(3)
  @scala.inline
  def CIRCLE_BELOW: `4` = this.cast(4)
  @scala.inline
  def DISC_ABOVE: `5` = this.cast(5)
  @scala.inline
  def DISC_BELOW: `6` = this.cast(6)
  @scala.inline
  def DOT_ABOVE: `1` = this.cast(1)
  @scala.inline
  def DOT_BELOW: `2` = this.cast(2)
  @scala.inline
