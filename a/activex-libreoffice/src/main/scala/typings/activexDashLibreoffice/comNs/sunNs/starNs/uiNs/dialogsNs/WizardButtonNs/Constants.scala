package typings.activexDashLibreoffice.comNs.sunNs.starNs.uiNs.dialogsNs.WizardButtonNs
...
object Constants {
  @scala.inline
  def CANCEL: `4` = this.cast(4)
  @scala.inline
  def FINISH: `3` = this.cast(3)
  @scala.inline
  def HELP: `5` = this.cast(5)
  @scala.inline
  def NEXT: `1` = this.cast(1)
  @scala.inline
  def NONE: `0` = this.cast(0)
  @scala.inline
  def PREVIOUS: `2` = this.cast(2)
  @scala.inline
