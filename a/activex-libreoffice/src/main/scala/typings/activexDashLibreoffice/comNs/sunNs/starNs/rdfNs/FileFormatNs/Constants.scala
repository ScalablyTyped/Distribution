package typings.activexDashLibreoffice.comNs.sunNs.starNs.rdfNs.FileFormatNs
...
object Constants {
  @scala.inline
  def N3: `1` = this.cast(1)
  @scala.inline
  def NTRIPLES: `2` = this.cast(2)
  @scala.inline
  def RDF_XML: `0` = this.cast(0)
  @scala.inline
  def TRIG: `3` = this.cast(3)
  @scala.inline
  def TRIX: `4` = this.cast(4)
  @scala.inline
  def TURTLE: `5` = this.cast(5)
  @scala.inline
