package typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbNs.SQLFilterOperatorNs
...
object Constants {
  ...
  @scala.inline
  def GREATER_EQUAL: `6` = this.cast(6)
  @scala.inline
  def LESS: `3` = this.cast(3)
  @scala.inline
  def LESS_EQUAL: `5` = this.cast(5)
  @scala.inline
  def LIKE: `7` = this.cast(7)
  @scala.inline
  def NOT_EQUAL: `2` = this.cast(2)
  @scala.inline
  def NOT_LIKE: `8` = this.cast(8)
  @scala.inline
  def NOT_SQLNULL: `10` = this.cast(10)
  @scala.inline
  def SQLNULL: `9` = this.cast(9)
  @scala.inline
