...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.XDatabaseMetaData
import typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.XPreparedStatement
import typings.activexDashLibreoffice.comNs.sunNs.starNs.sdbcNs.XStatement
