...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.viewNs.XPrintJobBroadcaster
import typings.activexDashLibreoffice.comNs.sunNs.starNs.viewNs.XPrintable
