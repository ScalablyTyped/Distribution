...
trait XCanvasFont extends XInterface {
  ...
  val FontRequest: typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.FontRequest
  /**
  ...
  /** Query the {@link FontRequest} that was used to generate this object. */
  def getFontRequest(): typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.FontRequest
}
