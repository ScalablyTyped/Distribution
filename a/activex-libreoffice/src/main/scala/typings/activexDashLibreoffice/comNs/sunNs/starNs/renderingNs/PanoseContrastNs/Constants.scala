package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseContrastNs
...
object Constants {
  ...
  @scala.inline
  def HIGH: `8` = this.cast(8)
  @scala.inline
  def LOW: `4` = this.cast(4)
  @scala.inline
  def MEDIUM: `6` = this.cast(6)
  @scala.inline
  def MEDIUM_HIGH: `7` = this.cast(7)
  @scala.inline
  def MEDIUM_LOW: `5` = this.cast(5)
  @scala.inline
  def NONE: `2` = this.cast(2)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def VERY_HIGH: `9` = this.cast(9)
  @scala.inline
  def VERY_LOW: `3` = this.cast(3)
  @scala.inline
