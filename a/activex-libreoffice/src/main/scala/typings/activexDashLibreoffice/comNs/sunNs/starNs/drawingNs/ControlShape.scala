...
- typings.activexDashLibreoffice.comNs.sunNs.starNs.drawingNs.XControlShape because var conflicts: Position, Size. Inlined Control, getControl, setControl */ trait ControlShape extends Shape {
  /**
