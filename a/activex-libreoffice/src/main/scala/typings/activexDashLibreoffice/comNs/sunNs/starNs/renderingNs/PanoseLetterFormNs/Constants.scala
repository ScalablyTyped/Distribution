package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseLetterFormNs
...
object Constants {
  ...
  @scala.inline
  def NORMAL_BOXED: `4` = this.cast(4)
  @scala.inline
  def NORMAL_CONTACT: `2` = this.cast(2)
  @scala.inline
  def NORMAL_FLATTENED: `5` = this.cast(5)
  @scala.inline
  def NORMAL_OFF_CENTER: `7` = this.cast(7)
  @scala.inline
  def NORMAL_ROUNDED: `6` = this.cast(6)
  @scala.inline
  def NORMAL_SQUARE: `8` = this.cast(8)
  @scala.inline
  def NORMAL_WEIGHTED: `3` = this.cast(3)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def OBLIQUE_BOXED: `11` = this.cast(11)
  @scala.inline
  def OBLIQUE_CONTACT: `9` = this.cast(9)
  @scala.inline
  def OBLIQUE_FLATTENED: `12` = this.cast(12)
  @scala.inline
  def OBLIQUE_OFF_CENTER: `14` = this.cast(14)
  @scala.inline
  def OBLIQUE_ROUNDED: `13` = this.cast(13)
  @scala.inline
  def OBLIQUE_SQUARE: `15` = this.cast(15)
  @scala.inline
  def OBLIQUE_WEIGHTED: `10` = this.cast(10)
  @scala.inline
