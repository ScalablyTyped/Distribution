package typings.activexDashLibreoffice.comNs.sunNs.starNs.embedNs.EmbedMapUnitsNs
...
object Constants {
  @scala.inline
  def ONE_1000TH_INCH: `4` = this.cast(4)
  @scala.inline
  def ONE_100TH_INCH: `5` = this.cast(5)
  @scala.inline
  def ONE_100TH_MM: `0` = this.cast(0)
  @scala.inline
  def ONE_10TH_INCH: `6` = this.cast(6)
  @scala.inline
  def ONE_10TH_MM: `1` = this.cast(1)
  @scala.inline
  def ONE_CM: `3` = this.cast(3)
  @scala.inline
  def ONE_INCH: `7` = this.cast(7)
  @scala.inline
  def ONE_MM: `2` = this.cast(2)
  @scala.inline
  def PIXEL: `10` = this.cast(10)
  @scala.inline
  def POINT: `8` = this.cast(8)
  @scala.inline
  def TWIP: `9` = this.cast(9)
  @scala.inline
