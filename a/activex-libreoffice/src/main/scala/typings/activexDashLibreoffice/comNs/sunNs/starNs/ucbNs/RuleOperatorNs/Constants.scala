package typings.activexDashLibreoffice.comNs.sunNs.starNs.ucbNs.RuleOperatorNs
...
object Constants {
  @scala.inline
  def CONTAINS: `1` = this.cast(1)
  @scala.inline
  def CONTAINSNOT: `2` = this.cast(2)
  @scala.inline
  def EQUAL: `5` = this.cast(5)
  @scala.inline
  def GREATEREQUAL: `3` = this.cast(3)
  @scala.inline
  def LESSEQUAL: `4` = this.cast(4)
  @scala.inline
  def NOTEQUAL: `6` = this.cast(6)
  @scala.inline
  def VALUE_FALSE: `8` = this.cast(8)
  @scala.inline
  def VALUE_TRUE: `7` = this.cast(7)
  @scala.inline
