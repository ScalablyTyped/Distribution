package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.PanoseFamilyTypesNs
...
object Constants {
  ...
  @scala.inline
  def DECORATIVE: `4` = this.cast(4)
  @scala.inline
  def NO_FIT: `1` = this.cast(1)
  @scala.inline
  def PICTORIAL: `5` = this.cast(5)
  @scala.inline
  def SCRIPT: `3` = this.cast(3)
  @scala.inline
  def TEXT_DISPLAY: `2` = this.cast(2)
  @scala.inline
