...
trait XColumn extends XInterface {
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  val Date: typings.activexDashLibreoffice.comNs.sunNs.starNs.utilNs.Date
  /**
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  val Time: typings.activexDashLibreoffice.comNs.sunNs.starNs.utilNs.Time
  /**
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  def getDate(): typings.activexDashLibreoffice.comNs.sunNs.starNs.utilNs.Date
  /**
    * gets the value of a column in the current row as a double.
    * @returns the column value
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
  ...
  /**
    ...
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
    */
  def getTime(): typings.activexDashLibreoffice.comNs.sunNs.starNs.utilNs.Time
  /**
    * gets the value of a column in the current row as a datetime object.
    * @returns the column value
    * @throws com::sun::star::sdbc::SQLException if a database access error occurs.
