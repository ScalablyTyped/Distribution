package typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.BlendModeNs
...
object Constants {
  @scala.inline
  def COLOR: `14` = this.cast(14)
  @scala.inline
  def COLOR_BURN: `7` = this.cast(7)
  @scala.inline
  def COLOR_DODGE: `6` = this.cast(6)
  @scala.inline
  def DARKEN: `4` = this.cast(4)
  @scala.inline
  def DIFFERENCE: `10` = this.cast(10)
  @scala.inline
  def EXCLUSION: `11` = this.cast(11)
  @scala.inline
  def HARD_LIGHT: `8` = this.cast(8)
  @scala.inline
  def HUE: `12` = this.cast(12)
  @scala.inline
  def LIGHTEN: `5` = this.cast(5)
  @scala.inline
  def LUMINOSITY: `15` = this.cast(15)
  @scala.inline
  def MULTIPLY: `1` = this.cast(1)
  @scala.inline
  def NORMAL: `0` = this.cast(0)
  @scala.inline
  def OVERLAY: `3` = this.cast(3)
  @scala.inline
  def SATURATION: `13` = this.cast(13)
  @scala.inline
  def SCREEN: `2` = this.cast(2)
  @scala.inline
  def SOFT_LIGHT: `9` = this.cast(9)
  @scala.inline
