...
trait XSlideRenderer extends js.Object {
  ...
  /**
    ...
    * @see createPreview
    */
  def createPreviewForCanvas(xSlide: XDrawPage, aMaximumPreviewPixelSize: Size, nSuperSampleFactor: Double, xCanvas: XCanvas): typings.activexDashLibreoffice.comNs.sunNs.starNs.renderingNs.XBitmap
}
