...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.XProperty
import typings.activexDashLibreoffice.comNs.sunNs.starNs.beansNs.XPropertyWithState
