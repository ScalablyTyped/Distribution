...
import typings.activexDashLibreoffice.comNs.sunNs.starNs.uiNs.dialogsNs.XAsynchronousExecutableDialog
import typings.activexDashLibreoffice.comNs.sunNs.starNs.uiNs.dialogsNs.XDialogClosedListener
