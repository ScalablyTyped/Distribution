package typings.activexDashLibreoffice.comNs.sunNs.starNs.textNs.TextMarkupTypeNs
...
object Constants {
  @scala.inline
  def PROOFREADING: `2` = this.cast(2)
  @scala.inline
  def SENTENCE: `4` = this.cast(4)
  @scala.inline
  def SMARTTAG: `3` = this.cast(3)
  @scala.inline
  def SPELLCHECK: `1` = this.cast(1)
  @scala.inline
  def TRACK_CHANGE_DELETION: `6` = this.cast(6)
  @scala.inline
  def TRACK_CHANGE_FORMATCHANGE: `7` = this.cast(7)
  @scala.inline
  def TRACK_CHANGE_INSERTION: `5` = this.cast(5)
  @scala.inline
