...
object WebDAVHTTPMethod {
  ...
  inline def CONNECT: `7` = 7.asInstanceOf[`7`]
  ...
  /**
    ...
    */
  inline def COPY: `12` = 12.asInstanceOf[`12`]
  ...
  inline def HEAD: `1` = 1.asInstanceOf[`1`]
  
  /**
    * WebDAV methods as defined in [HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)]{@link
    * url="http://tools.ietf.org/html/rfc4918#section-9.10"}
    */
  inline def LOCK: `14` = 14.asInstanceOf[`14`]
  
  /**
    * WebDAV methods as defined in [HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)]{@link
    * url="http://tools.ietf.org/html/rfc4918#section-9.3"}
    */
  inline def MKCOL: `11` = 11.asInstanceOf[`11`]
  ...
  /**
    ...
    */
  inline def MOVE: `13` = 13.asInstanceOf[`13`]
  ...
  inline def PATCH: `8` = 8.asInstanceOf[`8`]
  ...
  inline def POST: `2` = 2.asInstanceOf[`2`]
  
  /**
    * WebDAV methods as defined in [HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)]{@link
    * url="http://tools.ietf.org/html/rfc4918#section-9.1"}
    */
  inline def PROPFIND: `9` = 9.asInstanceOf[`9`]
  
  /**
    * WebDAV methods as defined in [HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)]{@link
    * url="http://tools.ietf.org/html/rfc4918#section-9.2"}
    */
  inline def PROPPATCH: `10` = 10.asInstanceOf[`10`]
  ...
  inline def PUT: `3` = 3.asInstanceOf[`3`]
  ...
  inline def TRACE: `5` = 5.asInstanceOf[`5`]
  
  /**
    * WebDAV methods as defined in [HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)]{@link
    * url="http://tools.ietf.org/html/rfc4918#section-9.11"}
    */
  inline def UNLOCK: `15` = 15.asInstanceOf[`15`]
}
