...
object UnoControlDateFieldModel {
  ...
  implicit class UnoControlDateFieldModelOps[Self <: UnoControlDateFieldModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDateFormat(value: Double): Self = this.set("DateFormat", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateMax(value: Date): Self = this.set("DateMax", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateMin(value: Date): Self = this.set("DateMin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setDateShowCentury(value: Boolean): Self = this.set("DateShowCentury", value.asInstanceOf[js.Any])
