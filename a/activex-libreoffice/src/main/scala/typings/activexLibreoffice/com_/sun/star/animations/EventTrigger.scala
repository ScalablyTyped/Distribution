...
object EventTrigger {
  ...
  */
  ...
  object Constants {
    ...
    inline def BEGIN_EVENT: `3` = 3.asInstanceOf[`3`]
    
    inline def END_EVENT: `4` = 4.asInstanceOf[`4`]
    
    inline def NONE: `0` = 0.asInstanceOf[`0`]
    
    inline def ON_BEGIN: `1` = 1.asInstanceOf[`1`]
    
    inline def ON_CLICK: `5` = 5.asInstanceOf[`5`]
    
    inline def ON_DBL_CLICK: `6` = 6.asInstanceOf[`6`]
    
    inline def ON_END: `2` = 2.asInstanceOf[`2`]
    
    inline def ON_MOUSE_ENTER: `7` = 7.asInstanceOf[`7`]
    
    inline def ON_MOUSE_LEAVE: `8` = 8.asInstanceOf[`8`]
    
    inline def ON_NEXT: `9` = 9.asInstanceOf[`9`]
    
    inline def ON_PREV: `10` = 10.asInstanceOf[`10`]
    
    inline def ON_STOP_AUDIO: `11` = 11.asInstanceOf[`11`]
    
    inline def REPEAT: `12` = 12.asInstanceOf[`12`]
  }
}
