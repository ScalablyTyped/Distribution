package typings.activexLibreoffice.com_.sun.star.embed.EmbedMisc
...
object Constants {
  ...
  @scala.inline
  def EMBED_ACTIVATEIMMEDIATELY: _4294967296 = 4294967296.0.asInstanceOf[_4294967296]
  
  @scala.inline
  def EMBED_NEEDSSIZEONLOAD: _17179869184 = 17179869184.0.asInstanceOf[_17179869184]
  
  @scala.inline
  def EMBED_NEVERRESIZE: _8589934592 = 8589934592.0.asInstanceOf[_8589934592]
  
  @scala.inline
  def MS_EMBED_ACTIVATEWHENVISIBLE: `256` = 256.asInstanceOf[`256`]
  
  @scala.inline
  def MS_EMBED_ACTSLIKEBUTTON: `4096` = 4096.asInstanceOf[`4096`]
  
  @scala.inline
  def MS_EMBED_ACTSLIKELABEL: `8192` = 8192.asInstanceOf[`8192`]
  
  @scala.inline
  def MS_EMBED_ALIGNABLE: `32768` = 32768.asInstanceOf[`32768`]
  
  @scala.inline
  def MS_EMBED_ALWAYSRUN: `2048` = 2048.asInstanceOf[`2048`]
  
  @scala.inline
  def MS_EMBED_CANLINKBYOLE1: `32` = 32.asInstanceOf[`32`]
  
  @scala.inline
  def MS_EMBED_CANTLINKINSIDE: `16` = 16.asInstanceOf[`16`]
  
  @scala.inline
  def MS_EMBED_IGNOREACTIVATEWHENVISIBLE: `524288` = 524288.asInstanceOf[`524288`]
  
  @scala.inline
  def MS_EMBED_IMEMODE: `262144` = 262144.asInstanceOf[`262144`]
  
  @scala.inline
  def MS_EMBED_INSERTNOTREPLACE: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def MS_EMBED_INSIDEOUT: `128` = 128.asInstanceOf[`128`]
  
  @scala.inline
  def MS_EMBED_INVISIBLEATRUNTIME: `1024` = 1024.asInstanceOf[`1024`]
  
  @scala.inline
  def MS_EMBED_ISLINKOBJECT: `64` = 64.asInstanceOf[`64`]
  
  @scala.inline
  def MS_EMBED_NOUIACTIVATE: `16384` = 16384.asInstanceOf[`16384`]
  
  @scala.inline
  def MS_EMBED_ONLYICONIC: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def MS_EMBED_RECOMPOSEONRESIZE: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def MS_EMBED_RENDERINGISDEVICEINDEPENDENT: `512` = 512.asInstanceOf[`512`]
  
  @scala.inline
  def MS_EMBED_SETCLIENTSITEFIRST: `131072` = 131072.asInstanceOf[`131072`]
  
  @scala.inline
  def MS_EMBED_SIMPLEFRAME: `65536` = 65536.asInstanceOf[`65536`]
  
  @scala.inline
  def MS_EMBED_STATIC: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def MS_EMBED_SUPPORTSMULTILEVELUNDO: `2097152` = 2097152.asInstanceOf[`2097152`]
  
  @scala.inline
  def MS_EMBED_WANTSTOMENUMERGE: `1048576` = 1048576.asInstanceOf[`1048576`]
}
