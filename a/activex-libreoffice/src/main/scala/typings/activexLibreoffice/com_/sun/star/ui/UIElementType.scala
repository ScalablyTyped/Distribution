...
object UIElementType {
  ...
  */
  ...
  object Constants {
    ...
    inline def COUNT: `8` = 8.asInstanceOf[`8`]
    
    inline def DOCKINGWINDOW: `7` = 7.asInstanceOf[`7`]
    
    inline def FLOATINGWINDOW: `5` = 5.asInstanceOf[`5`]
    
    inline def MENUBAR: `1` = 1.asInstanceOf[`1`]
    
    inline def POPUPMENU: `2` = 2.asInstanceOf[`2`]
    
    inline def PROGRESSBAR: `6` = 6.asInstanceOf[`6`]
    
    inline def STATUSBAR: `4` = 4.asInstanceOf[`4`]
    
    inline def TOOLBAR: `3` = 3.asInstanceOf[`3`]
    
    inline def TOOLPANEL: `7` = 7.asInstanceOf[`7`]
