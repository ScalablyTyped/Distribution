...
object FormulaMapGroup {
  ...
  */
  ...
  object Constants {
    ...
    inline def BINARY_OPERATORS: `8` = 8.asInstanceOf[`8`]
    
    inline def FUNCTIONS: `16` = 16.asInstanceOf[`16`]
    
    inline def SEPARATORS: `1` = 1.asInstanceOf[`1`]
    
    inline def SPECIAL: `0` = 0.asInstanceOf[`0`]
    
    inline def UNARY_OPERATORS: `4` = 4.asInstanceOf[`4`]
  }
}
