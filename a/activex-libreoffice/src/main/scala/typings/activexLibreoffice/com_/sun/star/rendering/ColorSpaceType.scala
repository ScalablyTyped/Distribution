...
object ColorSpaceType {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def CIELAB: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def CIEXYZ: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def CMYK: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def CMYKOG: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def DEVICE_COLOR: `0` = 0.asInstanceOf[`0`]
    
    @scala.inline
    def GREY: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def HSL: `9` = 9.asInstanceOf[`9`]
    
    @scala.inline
    def HSV: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def INDEXED: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def RGB: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def SRGB: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def YCBCR: `10` = 10.asInstanceOf[`10`]
  }
}
