...
object XDatabaseMetaData2 {
  ...
  @scala.inline
  implicit class XDatabaseMetaData2Ops[Self <: XDatabaseMetaData2] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetConnectionInfo(value: () => SafeArray[PropertyValue]): Self = this.set("getConnectionInfo", js.Any.fromFunction0(value))
  }
}
