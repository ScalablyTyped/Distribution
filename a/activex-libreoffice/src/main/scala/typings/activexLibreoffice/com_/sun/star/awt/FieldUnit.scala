...
object FieldUnit {
  ...
  */
  ...
  object Constants {
    ...
    inline def FUNIT_100TH_MM: `13` = 13.asInstanceOf[`13`]
    
    inline def FUNIT_CM: `2` = 2.asInstanceOf[`2`]
    
    inline def FUNIT_CUSTOM: `11` = 11.asInstanceOf[`11`]
    
    inline def FUNIT_FOOT: `9` = 9.asInstanceOf[`9`]
    
    inline def FUNIT_INCH: `8` = 8.asInstanceOf[`8`]
    
    inline def FUNIT_KM: `4` = 4.asInstanceOf[`4`]
    
    inline def FUNIT_M: `3` = 3.asInstanceOf[`3`]
    
    inline def FUNIT_MILE: `10` = 10.asInstanceOf[`10`]
    
    inline def FUNIT_MM: `1` = 1.asInstanceOf[`1`]
    
    inline def FUNIT_NONE: `0` = 0.asInstanceOf[`0`]
    
    inline def FUNIT_PERCENT: `12` = 12.asInstanceOf[`12`]
    
    inline def FUNIT_PICA: `7` = 7.asInstanceOf[`7`]
    
    inline def FUNIT_POINT: `6` = 6.asInstanceOf[`6`]
    
    inline def FUNIT_TWIP: `5` = 5.asInstanceOf[`5`]
  }
}
