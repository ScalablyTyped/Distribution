...
trait UnoControlCurrencyFieldModel
  extends StObject
...
object UnoControlCurrencyFieldModel {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: UnoControlCurrencyFieldModel] (val x: Self) extends AnyVal {
    ...
    inline def setPrependCurrencySymbol(value: Boolean): Self = StObject.set(x, "PrependCurrencySymbol", value.asInstanceOf[js.Any])
