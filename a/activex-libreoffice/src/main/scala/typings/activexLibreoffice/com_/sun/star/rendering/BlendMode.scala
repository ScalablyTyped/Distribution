...
object BlendMode {
  ...
  */
  ...
  object Constants {
    ...
    inline def COLOR: `14` = 14.asInstanceOf[`14`]
    
    inline def COLOR_BURN: `7` = 7.asInstanceOf[`7`]
    
    inline def COLOR_DODGE: `6` = 6.asInstanceOf[`6`]
    
    inline def DARKEN: `4` = 4.asInstanceOf[`4`]
    
    inline def DIFFERENCE: `10` = 10.asInstanceOf[`10`]
    
    inline def EXCLUSION: `11` = 11.asInstanceOf[`11`]
    
    inline def HARD_LIGHT: `8` = 8.asInstanceOf[`8`]
    
    inline def HUE: `12` = 12.asInstanceOf[`12`]
    
    inline def LIGHTEN: `5` = 5.asInstanceOf[`5`]
    
    inline def LUMINOSITY: `15` = 15.asInstanceOf[`15`]
    
    inline def MULTIPLY: `1` = 1.asInstanceOf[`1`]
    
    inline def NORMAL: `0` = 0.asInstanceOf[`0`]
    
    inline def OVERLAY: `3` = 3.asInstanceOf[`3`]
    
    inline def SATURATION: `13` = 13.asInstanceOf[`13`]
    
    inline def SCREEN: `2` = 2.asInstanceOf[`2`]
    
    inline def SOFT_LIGHT: `9` = 9.asInstanceOf[`9`]
  }
}
