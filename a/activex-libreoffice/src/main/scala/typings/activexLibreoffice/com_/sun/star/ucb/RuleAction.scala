...
object RuleAction {
  ...
  */
  ...
  object Constants {
    ...
    inline def COPY: `8` = 8.asInstanceOf[`8`]
    
    inline def DELETE: `9` = 9.asInstanceOf[`9`]
    
    inline def FORWARD: `11` = 11.asInstanceOf[`11`]
    
    inline def HIDE: `2` = 2.asInstanceOf[`2`]
    
    inline def LINK: `10` = 10.asInstanceOf[`10`]
    
    inline def MARK: `3` = 3.asInstanceOf[`3`]
    
    inline def MARKREAD: `5` = 5.asInstanceOf[`5`]
    
    inline def MARKUNREAD: `6` = 6.asInstanceOf[`6`]
    
    inline def MOVE: `7` = 7.asInstanceOf[`7`]
    
    inline def NONE: `0` = 0.asInstanceOf[`0`]
    
    inline def SHOW: `1` = 1.asInstanceOf[`1`]
    
    inline def UNMARK: `4` = 4.asInstanceOf[`4`]
  }
}
