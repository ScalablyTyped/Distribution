...
object RuleAction {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def COPY: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def DELETE: `9` = 9.asInstanceOf[`9`]
    
    @scala.inline
    def FORWARD: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def HIDE: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def LINK: `10` = 10.asInstanceOf[`10`]
    
    @scala.inline
    def MARK: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def MARKREAD: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def MARKUNREAD: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def MOVE: `7` = 7.asInstanceOf[`7`]
