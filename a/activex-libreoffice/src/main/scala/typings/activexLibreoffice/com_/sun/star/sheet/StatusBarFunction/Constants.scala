package typings.activexLibreoffice.com_.sun.star.sheet.StatusBarFunction
...
object Constants {
  ...
  @scala.inline
  def COUNTNUMS: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def MAX: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def MIN: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def NONE: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def SUM: `9` = 9.asInstanceOf[`9`]
}
