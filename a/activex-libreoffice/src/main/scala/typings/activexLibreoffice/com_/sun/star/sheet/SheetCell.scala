...
import typings.activexLibreoffice.com_.sun.star.text.XRelativeTextContentInsert
...
import typings.activexLibreoffice.com_.sun.star.text.XTextRangeCompare
import typings.activexLibreoffice.com_.sun.star.text.XTextRangeMover
...
- typings.activexLibreoffice.com_.sun.star.text.Text because var conflicts: String. Inlined EndRedline, StartRedline */ trait SheetCell
  extends StObject
     with Cell
