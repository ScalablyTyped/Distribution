package typings.activexLibreoffice.com_.sun.star.rendering.BlendMode
...
object Constants {
  ...
  @scala.inline
  def COLOR: `14` = 14.asInstanceOf[`14`]
  
  @scala.inline
  def COLOR_BURN: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def COLOR_DODGE: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def DARKEN: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def DIFFERENCE: `10` = 10.asInstanceOf[`10`]
  
  @scala.inline
  def EXCLUSION: `11` = 11.asInstanceOf[`11`]
  
  @scala.inline
  def HARD_LIGHT: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def HUE: `12` = 12.asInstanceOf[`12`]
  
  @scala.inline
  def LIGHTEN: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def LUMINOSITY: `15` = 15.asInstanceOf[`15`]
  
  @scala.inline
  def MULTIPLY: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def NORMAL: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def OVERLAY: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def SATURATION: `13` = 13.asInstanceOf[`13`]
  
  @scala.inline
  def SCREEN: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def SOFT_LIGHT: `9` = 9.asInstanceOf[`9`]
}
