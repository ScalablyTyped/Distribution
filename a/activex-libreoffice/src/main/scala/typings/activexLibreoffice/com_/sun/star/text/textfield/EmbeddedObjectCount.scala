...
/**
  * specifies service of a text field that displays the number of embedded objects contained in the document.
  * @see com.sun.star.text.TextField
  */
@js.native
trait EmbeddedObjectCount extends TextField_ {
...
object EmbeddedObjectCount {
  ...
  @scala.inline
  implicit class EmbeddedObjectCountOps[Self <: EmbeddedObjectCount] (val x: Self) extends AnyVal {
    @scala.inline
