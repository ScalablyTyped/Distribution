...
object DimensionFlags {
  ...
  */
  ...
  object Constants {
    ...
    inline def NO_COLUMN_ORIENTATION: `1` = 1.asInstanceOf[`1`]
    
    inline def NO_DATA_ORIENTATION: `8` = 8.asInstanceOf[`8`]
    
    inline def NO_PAGE_ORIENTATION: `4` = 4.asInstanceOf[`4`]
    
    inline def NO_ROW_ORIENTATION: `2` = 2.asInstanceOf[`2`]
  }
}
