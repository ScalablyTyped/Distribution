package typings.activexLibreoffice.com_.sun.star.animations.EventTrigger
...
object Constants {
  ...
  @scala.inline
  def BEGIN_EVENT: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def END_EVENT: `4` = 4.asInstanceOf[`4`]
  
  @scala.inline
  def NONE: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def ON_BEGIN: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def ON_CLICK: `5` = 5.asInstanceOf[`5`]
  
  @scala.inline
  def ON_DBL_CLICK: `6` = 6.asInstanceOf[`6`]
  
  @scala.inline
  def ON_END: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def ON_MOUSE_ENTER: `7` = 7.asInstanceOf[`7`]
  
  @scala.inline
  def ON_MOUSE_LEAVE: `8` = 8.asInstanceOf[`8`]
  
  @scala.inline
  def ON_NEXT: `9` = 9.asInstanceOf[`9`]
  
  @scala.inline
  def ON_PREV: `10` = 10.asInstanceOf[`10`]
  
  @scala.inline
  def ON_STOP_AUDIO: `11` = 11.asInstanceOf[`11`]
  
  @scala.inline
  def REPEAT: `12` = 12.asInstanceOf[`12`]
}
