package typings.activexLibreoffice.com_.sun.star.text.ReferenceFieldPart
...
object Constants {
  @scala.inline
  def CATEGORY_AND_NUMBER: `5` = 5.asInstanceOf[`5`]
  @scala.inline
  def CHAPTER: `1` = 1.asInstanceOf[`1`]
  @scala.inline
  def NUMBER: `8` = 8.asInstanceOf[`8`]
  @scala.inline
  def NUMBER_FULL_CONTEXT: `10` = 10.asInstanceOf[`10`]
  @scala.inline
  def NUMBER_NO_CONTEXT: `9` = 9.asInstanceOf[`9`]
  @scala.inline
  def ONLY_CAPTION: `6` = 6.asInstanceOf[`6`]
  @scala.inline
  def ONLY_SEQUENCE_NUMBER: `7` = 7.asInstanceOf[`7`]
  @scala.inline
  def PAGE: `0` = 0.asInstanceOf[`0`]
  @scala.inline
  def PAGE_DESC: `4` = 4.asInstanceOf[`4`]
  @scala.inline
  def TEXT: `2` = 2.asInstanceOf[`2`]
  @scala.inline
  def UP_DOWN: `3` = 3.asInstanceOf[`3`]
}
