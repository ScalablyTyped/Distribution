...
object XProgressBar {
  ...
  implicit class XProgressBarOps[Self <: XProgressBar] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setSetBackgroundColor(value: Color => Unit): Self = this.set("setBackgroundColor", js.Any.fromFunction1(value))
    @scala.inline
    def setSetForegroundColor(value: Color => Unit): Self = this.set("setForegroundColor", js.Any.fromFunction1(value))
    @scala.inline
