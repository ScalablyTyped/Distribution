...
object EnhancedCustomShapeParameterType {
  ...
  */
  ...
  object Constants {
    ...
    inline def ADJUSTMENT: `2` = 2.asInstanceOf[`2`]
    
    inline def BOTTOM: `6` = 6.asInstanceOf[`6`]
    
    inline def EQUATION: `1` = 1.asInstanceOf[`1`]
    
    inline def HASFILL: `10` = 10.asInstanceOf[`10`]
    
    inline def HASSTROKE: `9` = 9.asInstanceOf[`9`]
    
    inline def HEIGHT: `12` = 12.asInstanceOf[`12`]
    
    inline def LEFT: `3` = 3.asInstanceOf[`3`]
    
    inline def LOGHEIGHT: `14` = 14.asInstanceOf[`14`]
    
    inline def LOGWIDTH: `13` = 13.asInstanceOf[`13`]
    
    inline def NORMAL: `0` = 0.asInstanceOf[`0`]
    
    inline def RIGHT: `5` = 5.asInstanceOf[`5`]
    
    inline def TOP: `4` = 4.asInstanceOf[`4`]
    
    inline def WIDTH: `11` = 11.asInstanceOf[`11`]
    
    inline def XSTRETCH: `7` = 7.asInstanceOf[`7`]
    
    inline def YSTRETCH: `8` = 8.asInstanceOf[`8`]
  }
}
