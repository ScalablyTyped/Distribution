...
object ClickAction {
  ...
  @scala.inline
  def PREVPAGE: `1` = 1.asInstanceOf[`1`]
  
  /** Another program is executed after a click. */
  @scala.inline
  def PROGRAM: `11` = 11.asInstanceOf[`11`]
  
  /** A sound is played after a click. */
  @scala.inline
  def SOUND: `8` = 8.asInstanceOf[`8`]
  
  /** The presentation is stopped after the click. */
  @scala.inline
  def STOPPRESENTATION: `13` = 13.asInstanceOf[`13`]
  
  /** The object vanishes with its effect. */
  @scala.inline
  def VANISH: `10` = 10.asInstanceOf[`10`]
  
  /** An OLE verb is performed on this object. */
  @scala.inline
  def VERB: `9` = 9.asInstanceOf[`9`]
}
