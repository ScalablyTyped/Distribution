...
object CalendarFieldIndex {
  ...
  */
  ...
  object Constants {
    ...
    inline def AM_PM: `0` = 0.asInstanceOf[`0`]
    
    inline def DAY_OF_MONTH: `1` = 1.asInstanceOf[`1`]
    
    inline def DAY_OF_WEEK: `2` = 2.asInstanceOf[`2`]
    
    inline def DAY_OF_YEAR: `3` = 3.asInstanceOf[`3`]
    
    inline def DST_OFFSET: `4` = 4.asInstanceOf[`4`]
    
    inline def DST_OFFSET_SECOND_MILLIS: `16` = 16.asInstanceOf[`16`]
    
    inline def ERA: `13` = 13.asInstanceOf[`13`]
    
    inline def FIELD_COUNT: `15` = 15.asInstanceOf[`15`]
    
    inline def FIELD_COUNT2: `17` = 17.asInstanceOf[`17`]
    
    inline def HOUR: `5` = 5.asInstanceOf[`5`]
    
    inline def MILLISECOND: `8` = 8.asInstanceOf[`8`]
    
    inline def MINUTE: `6` = 6.asInstanceOf[`6`]
    
    inline def MONTH: `12` = 12.asInstanceOf[`12`]
    
    inline def SECOND: `7` = 7.asInstanceOf[`7`]
    
    inline def WEEK_OF_MONTH: `9` = 9.asInstanceOf[`9`]
    
    inline def WEEK_OF_YEAR: `10` = 10.asInstanceOf[`10`]
    
    inline def YEAR: `11` = 11.asInstanceOf[`11`]
    
    inline def ZONE_OFFSET: `14` = 14.asInstanceOf[`14`]
    
    inline def ZONE_OFFSET_SECOND_MILLIS: `15` = 15.asInstanceOf[`15`]
  }
}
