...
object UnoControlPatternFieldModel {
  ...
  @scala.inline
  implicit class UnoControlPatternFieldModelOps[Self <: UnoControlPatternFieldModel] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setEditMask(value: String): Self = this.set("EditMask", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLiteralMask(value: String): Self = this.set("LiteralMask", value.asInstanceOf[js.Any])
    @scala.inline
