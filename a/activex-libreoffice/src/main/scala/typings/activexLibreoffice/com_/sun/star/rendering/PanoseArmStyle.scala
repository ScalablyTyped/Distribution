...
object PanoseArmStyle {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def BENT_DOUBLE_SERIF: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def BENT_HORIZONTAL: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def BENT_SINGLE_SERIF: `10` = 10.asInstanceOf[`10`]
    
    @scala.inline
    def BENT_VERTICAL: `9` = 9.asInstanceOf[`9`]
    
    @scala.inline
    def BENT_WEDGE: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def NO_FIT: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def STRAIGHT_DOUBLE_SERIF: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def STRAIGHT_HORIZONTAL: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def STRAIGHT_SINGLE_SERIF: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def STRAIGHT_VERTICAL: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def STRAIGHT_WEDGE: `3` = 3.asInstanceOf[`3`]
  }
}
