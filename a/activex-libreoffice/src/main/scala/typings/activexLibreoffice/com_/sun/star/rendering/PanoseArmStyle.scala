...
object PanoseArmStyle {
  ...
  */
  ...
  object Constants {
    ...
    inline def BENT_DOUBLE_SERIF: `11` = 11.asInstanceOf[`11`]
    
    inline def BENT_HORIZONTAL: `7` = 7.asInstanceOf[`7`]
    
    inline def BENT_SINGLE_SERIF: `10` = 10.asInstanceOf[`10`]
    
    inline def BENT_VERTICAL: `9` = 9.asInstanceOf[`9`]
    
    inline def BENT_WEDGE: `8` = 8.asInstanceOf[`8`]
    
    inline def NO_FIT: `1` = 1.asInstanceOf[`1`]
    
    inline def STRAIGHT_DOUBLE_SERIF: `6` = 6.asInstanceOf[`6`]
    
    inline def STRAIGHT_HORIZONTAL: `2` = 2.asInstanceOf[`2`]
    
    inline def STRAIGHT_SINGLE_SERIF: `5` = 5.asInstanceOf[`5`]
    
    inline def STRAIGHT_VERTICAL: `4` = 4.asInstanceOf[`4`]
    
    inline def STRAIGHT_WEDGE: `3` = 3.asInstanceOf[`3`]
  }
}
