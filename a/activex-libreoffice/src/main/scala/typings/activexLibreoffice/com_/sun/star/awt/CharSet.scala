...
object CharSet {
  ...
  */
  ...
  object Constants {
    ...
    inline def ANSI: `1` = 1.asInstanceOf[`1`]
    
    inline def DONTKNOW: `0` = 0.asInstanceOf[`0`]
    
    inline def IBMPC_437: `3` = 3.asInstanceOf[`3`]
    
    inline def IBMPC_850: `4` = 4.asInstanceOf[`4`]
    
    inline def IBMPC_860: `5` = 5.asInstanceOf[`5`]
    
    inline def IBMPC_861: `6` = 6.asInstanceOf[`6`]
    
    inline def IBMPC_863: `7` = 7.asInstanceOf[`7`]
    
    inline def IBMPC_865: `8` = 8.asInstanceOf[`8`]
    
    inline def MAC: `2` = 2.asInstanceOf[`2`]
    
    inline def SYMBOL: `10` = 10.asInstanceOf[`10`]
    
    inline def SYSTEM: `9` = 9.asInstanceOf[`9`]
  }
}
