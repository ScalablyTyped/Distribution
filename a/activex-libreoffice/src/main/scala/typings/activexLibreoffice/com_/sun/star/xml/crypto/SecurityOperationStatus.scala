...
object SecurityOperationStatus {
  ...
  inline def ASSERTION: `49` = 49.asInstanceOf[`49`]
  
  inline def CERT_HAS_EXPIRED: `46` = 46.asInstanceOf[`46`]
  
  inline def CERT_ISSUER_FAILED: `44` = 44.asInstanceOf[`44`]
  
  inline def CERT_NOT_FOUND: `42` = 42.asInstanceOf[`42`]
  
  inline def CERT_NOT_YET_VALID: `45` = 45.asInstanceOf[`45`]
  
  inline def CERT_REVOKED: `43` = 43.asInstanceOf[`43`]
  
  inline def CERT_VERIFY_FAILED: `41` = 41.asInstanceOf[`41`]
  
  inline def CRYPTO_FAILED: `6` = 6.asInstanceOf[`6`]
  
  inline def DATA_NOT_MATCH: `19` = 19.asInstanceOf[`19`]
  
  inline def DISABLED: `10` = 10.asInstanceOf[`10`]
  
  inline def DSIG_INVALID_REFERENCE: `48` = 48.asInstanceOf[`48`]
  
  inline def DSIG_NO_REFERENCES: `47` = 47.asInstanceOf[`47`]
  ...
  /**
    ...
    */
  inline def ENGINE_FAILED: `3` = 3.asInstanceOf[`3`]
  
  inline def INVALID_DATA: `13` = 13.asInstanceOf[`13`]
  
  inline def INVALID_FORMAT: `18` = 18.asInstanceOf[`18`]
  
  inline def INVALID_KEY_DATA: `32` = 32.asInstanceOf[`32`]
  
  inline def INVALID_KEY_DATA_SIZE: `35` = 35.asInstanceOf[`35`]
  
  inline def INVALID_NODE: `20` = 20.asInstanceOf[`20`]
  
  inline def INVALID_NODE_ATTRIBUTE: `22` = 22.asInstanceOf[`22`]
  
  inline def INVALID_NODE_CONTENT: `21` = 21.asInstanceOf[`21`]
  
  inline def INVALID_OPERATION: `16` = 16.asInstanceOf[`16`]
  
  inline def INVALID_RESULT: `14` = 14.asInstanceOf[`14`]
  
  inline def INVALID_SIZE: `12` = 12.asInstanceOf[`12`]
  
  inline def INVALID_STATUS: `17` = 17.asInstanceOf[`17`]
  
  inline def INVALID_TRANSFORM: `27` = 27.asInstanceOf[`27`]
  
  inline def INVALID_TRANSFORM_KEY: `28` = 28.asInstanceOf[`28`]
  
  inline def INVALID_TYPE: `15` = 15.asInstanceOf[`15`]
  
  inline def INVALID_URI_TYPE: `29` = 29.asInstanceOf[`29`]
  
  inline def IO_FAILED: `9` = 9.asInstanceOf[`9`]
  
  inline def KEYDATA_DISABLED: `37` = 37.asInstanceOf[`37`]
  
  inline def KEY_DATA_ALREADY_EXIST: `34` = 34.asInstanceOf[`34`]
  
  inline def KEY_DATA_NOT_FOUND: `33` = 33.asInstanceOf[`33`]
  
  inline def KEY_NOT_FOUND: `36` = 36.asInstanceOf[`36`]
  
  inline def MALLOC_FAILED: `4` = 4.asInstanceOf[`4`]
  
  inline def MAX_ENCKEY_LEVEL: `40` = 40.asInstanceOf[`40`]
  
  inline def MAX_RETRIEVALS_LEVEL: `38` = 38.asInstanceOf[`38`]
  
  inline def MAX_RETRIEVAL_TYPE_MISMATCH: `39` = 39.asInstanceOf[`39`]
  
  inline def MISSING_NODE_ATTRIBUTE: `23` = 23.asInstanceOf[`23`]
  
  inline def NODE_ALREADY_PRESENT: `24` = 24.asInstanceOf[`24`]
  
  inline def NODE_NOT_FOUND: `26` = 26.asInstanceOf[`26`]
  
  inline def NOT_IMPLEMENTED: `11` = 11.asInstanceOf[`11`]
  
  inline def OPERATION_SUCCEEDED: `1` = 1.asInstanceOf[`1`]
  
  inline def RUNTIMEERROR_FAILED: `2` = 2.asInstanceOf[`2`]
  
  inline def STRDUP_FAILED: `5` = 5.asInstanceOf[`5`]
  
  inline def TRANSFORM_DISABLED: `31` = 31.asInstanceOf[`31`]
  
  inline def TRANSFORM_SAME_DOCUMENT_REQUIRED: `30` = 30.asInstanceOf[`30`]
  
  inline def UNEXPECTED_NODE: `25` = 25.asInstanceOf[`25`]
  
  inline def UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def XML_FAILED: `7` = 7.asInstanceOf[`7`]
  
  inline def XSLT_FAILED: `8` = 8.asInstanceOf[`8`]
}
