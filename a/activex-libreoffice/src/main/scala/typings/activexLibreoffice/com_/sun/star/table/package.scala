...
package object table {
  ...
  /**
    ...
    */
  type CellCursor = typings.activexLibreoffice.com_.sun.star.table.XCellCursor
  
  /** defines the binding to a single cell in a table document, which can be used to transfer a list position into the cell. */
  type ListPositionCellBinding = typings.activexLibreoffice.com_.sun.star.table.CellValueBinding
  
  /**
    * represents an enumeration of table charts.
    * @see com.sun.star.table.TableCharts
    */
  type TableChartsEnumeration = typings.activexLibreoffice.com_.sun.star.container.XEnumeration
  
  /**
    * represents an enumeration of table columns.
    * @see com.sun.star.table.TableColumns
    */
  type TableColumnsEnumeration = typings.activexLibreoffice.com_.sun.star.container.XEnumeration
  
  /**
    * represents an enumeration of table rows.
    * @see com.sun.star.table.TableRows
    */
  type TableRowsEnumeration = typings.activexLibreoffice.com_.sun.star.container.XEnumeration
}
