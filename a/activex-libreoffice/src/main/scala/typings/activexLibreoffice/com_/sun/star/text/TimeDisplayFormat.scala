...
object TimeDisplayFormat {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def HHMM: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def HHMMAMPM: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def HHMMSS: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def HHMMSS00: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def HHMMSS00AMPM: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def HHMMSSAMPM: `5` = 5.asInstanceOf[`5`]
