...
object TimeDisplayFormat {
  ...
  */
  ...
  object Constants {
    ...
    inline def HHMM: `1` = 1.asInstanceOf[`1`]
    
    inline def HHMMAMPM: `4` = 4.asInstanceOf[`4`]
    
    inline def HHMMSS: `2` = 2.asInstanceOf[`2`]
    
    inline def HHMMSS00: `3` = 3.asInstanceOf[`3`]
    
    inline def HHMMSS00AMPM: `6` = 6.asInstanceOf[`6`]
    
    inline def HHMMSSAMPM: `5` = 5.asInstanceOf[`5`]
