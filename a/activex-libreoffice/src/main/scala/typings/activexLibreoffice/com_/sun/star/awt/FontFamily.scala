...
object FontFamily {
  ...
  */
  ...
  object Constants {
    ...
    inline def DECORATIVE: `1` = 1.asInstanceOf[`1`]
    
    inline def DONTKNOW: `0` = 0.asInstanceOf[`0`]
    
    inline def MODERN: `2` = 2.asInstanceOf[`2`]
    
    inline def ROMAN: `3` = 3.asInstanceOf[`3`]
    
    inline def SCRIPT: `4` = 4.asInstanceOf[`4`]
    
    inline def SWISS: `5` = 5.asInstanceOf[`5`]
    
    inline def SYSTEM: `6` = 6.asInstanceOf[`6`]
  }
}
