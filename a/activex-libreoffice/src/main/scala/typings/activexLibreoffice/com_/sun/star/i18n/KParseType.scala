...
object KParseType {
  ...
  */
  ...
  object Constants {
    ...
    inline def ASC_NUMBER: `32` = 32.asInstanceOf[`32`]
    
    inline def BOOLEAN: `2` = 2.asInstanceOf[`2`]
    
    inline def DOUBLE_QUOTE_STRING: `16` = 16.asInstanceOf[`16`]
    
    inline def IDENTNAME: `4` = 4.asInstanceOf[`4`]
    
    inline def MISSING_QUOTE: `1073741824` = 1073741824.asInstanceOf[`1073741824`]
    
    inline def ONE_SINGLE_CHAR: `1` = 1.asInstanceOf[`1`]
    
    inline def SINGLE_QUOTE_NAME: `8` = 8.asInstanceOf[`8`]
    
    inline def UNI_NUMBER: `64` = 64.asInstanceOf[`64`]
  }
}
