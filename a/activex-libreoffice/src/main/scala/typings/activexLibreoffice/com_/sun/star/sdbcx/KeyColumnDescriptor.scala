...
object KeyColumnDescriptor {
  ...
  @scala.inline
  implicit class KeyColumnDescriptorOps[Self <: KeyColumnDescriptor] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRelatedColumn(value: String): Self = this.set("RelatedColumn", value.asInstanceOf[js.Any])
  }
