...
trait XMultiServiceFactory
  ...
  /**
    ...
    * @returns instance
    */
  def createInstanceWithArguments(ServiceSpecifier: String, Arguments: SeqEquiv[js.Any]): XInterface = js.native
  def createInstanceWithArguments[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 1364 */ js.Any */](ServiceSpecifier: K, Arguments: SeqEquiv[js.Any]): /* import warning: importer.ImportType#apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
