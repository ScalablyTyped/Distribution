...
trait XMultiServiceFactory
  ...
  def createInstance[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 1364 */ Any */](aServiceSpecifier: K): /* import warning: importer.ImportType#apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
  ...
  def createInstanceWithArguments[K /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 1364 */ Any */](ServiceSpecifier: K, Arguments: SeqEquiv[Any]): /* import warning: importer.ImportType#apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
