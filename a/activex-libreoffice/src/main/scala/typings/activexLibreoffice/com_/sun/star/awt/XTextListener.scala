...
object XTextListener {
  ...
  @scala.inline
  implicit class XTextListenerOps[Self <: XTextListener] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTextChanged(value: TextEvent => Unit): Self = this.set("textChanged", js.Any.fromFunction1(value))
  }
}
