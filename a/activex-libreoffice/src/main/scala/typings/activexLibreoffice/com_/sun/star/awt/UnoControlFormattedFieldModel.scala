...
object UnoControlFormattedFieldModel {
  ...
  @scala.inline
  implicit class UnoControlFormattedFieldModelMutableBuilder[Self <: UnoControlFormattedFieldModel] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEffectiveDefault(value: js.Any): Self = StObject.set(x, "EffectiveDefault", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEffectiveMax(value: Double): Self = StObject.set(x, "EffectiveMax", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEffectiveMin(value: Double): Self = StObject.set(x, "EffectiveMin", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setEffectiveValue(value: Double): Self = StObject.set(x, "EffectiveValue", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTreatAsNumber(value: Boolean): Self = StObject.set(x, "TreatAsNumber", value.asInstanceOf[js.Any])
