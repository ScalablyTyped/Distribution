...
object ConditionFormatOperator {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ABOVE_AVERAGE: `14` = 14.asInstanceOf[`14`]
    
    @scala.inline
    def ABOVE_EQUAL_AVERAGE: `16` = 16.asInstanceOf[`16`]
    
    @scala.inline
    def BEGINS_WITH: `20` = 20.asInstanceOf[`20`]
    
    @scala.inline
    def BELOW_AVERAGE: `15` = 15.asInstanceOf[`15`]
    
    @scala.inline
    def BELOW_EQUAL_AVERAGE: `17` = 17.asInstanceOf[`17`]
    
    @scala.inline
    def BETWEEN: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def BOTTOM_N_ELEMENTS: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def BOTTOM_N_PERCENT: `13` = 13.asInstanceOf[`13`]
    
    @scala.inline
    def CONTAINS: `22` = 22.asInstanceOf[`22`]
    
    @scala.inline
    def DUPLICATE: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def ENDS_WITH: `21` = 21.asInstanceOf[`21`]
    
    @scala.inline
    def EQUAL: `0` = 0.asInstanceOf[`0`]
    
    @scala.inline
    def ERROR: `18` = 18.asInstanceOf[`18`]
    
    @scala.inline
    def EXPRESSION: `24` = 24.asInstanceOf[`24`]
    
    @scala.inline
    def GREATER: `2` = 2.asInstanceOf[`2`]
    ...
    @scala.inline
    def LESS_EQUAL: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def NOT_BETWEEN: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def NOT_CONTAINS: `23` = 23.asInstanceOf[`23`]
    
    @scala.inline
    def NOT_EQUAL: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def NO_ERROR: `19` = 19.asInstanceOf[`19`]
    
    @scala.inline
    def TOP_N_ELEMENTS: `10` = 10.asInstanceOf[`10`]
    
    @scala.inline
    def TOP_N_PERCENT: `12` = 12.asInstanceOf[`12`]
    
    @scala.inline
    def UNIQUE: `9` = 9.asInstanceOf[`9`]
  }
}
