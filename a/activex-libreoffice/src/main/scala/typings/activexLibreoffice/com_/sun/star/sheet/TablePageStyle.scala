...
object TablePageStyle {
  ...
  implicit class TablePageStyleOps[Self <: TablePageStyle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeftPageFooterContent(value: XHeaderFooterContent): Self = this.set("LeftPageFooterContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setLeftPageHeaderContent(value: XHeaderFooterContent): Self = this.set("LeftPageHeaderContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setNumberingType(value: Double): Self = this.set("NumberingType", value.asInstanceOf[js.Any])
    @scala.inline
    def setPageScale(value: Double): Self = this.set("PageScale", value.asInstanceOf[js.Any])
    @scala.inline
    def setPageStyleLayout(value: PageStyleLayout): Self = this.set("PageStyleLayout", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintAnnotations(value: Boolean): Self = this.set("PrintAnnotations", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintCharts(value: Boolean): Self = this.set("PrintCharts", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintDownFirst(value: Boolean): Self = this.set("PrintDownFirst", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintDrawing(value: Boolean): Self = this.set("PrintDrawing", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintFormulas(value: Boolean): Self = this.set("PrintFormulas", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintGrid(value: Boolean): Self = this.set("PrintGrid", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintHeaders(value: Boolean): Self = this.set("PrintHeaders", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintObjects(value: Boolean): Self = this.set("PrintObjects", value.asInstanceOf[js.Any])
    @scala.inline
    def setPrintZeroValues(value: Boolean): Self = this.set("PrintZeroValues", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setRightPageFooterContent(value: XHeaderFooterContent): Self = this.set("RightPageFooterContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setRightPageHeaderContent(value: XHeaderFooterContent): Self = this.set("RightPageHeaderContent", value.asInstanceOf[js.Any])
    @scala.inline
    def setScaleToPages(value: Double): Self = this.set("ScaleToPages", value.asInstanceOf[js.Any])
    @scala.inline
    def setScaleToPagesX(value: Double): Self = this.set("ScaleToPagesX", value.asInstanceOf[js.Any])
    @scala.inline
    def setScaleToPagesY(value: Double): Self = this.set("ScaleToPagesY", value.asInstanceOf[js.Any])
    @scala.inline
