...
object ItemStyle {
  ...
  */
  ...
  object Constants {
    ...
    inline def ALIGN_CENTER: `2` = 2.asInstanceOf[`2`]
    
    inline def ALIGN_LEFT: `1` = 1.asInstanceOf[`1`]
    
    inline def ALIGN_RIGHT: `3` = 3.asInstanceOf[`3`]
    
    inline def AUTO_SIZE: `32` = 32.asInstanceOf[`32`]
    
    inline def DRAW_FLAT: `12` = 12.asInstanceOf[`12`]
    
    inline def DRAW_IN3D: `8` = 8.asInstanceOf[`8`]
    
    inline def DRAW_OUT3D: `4` = 4.asInstanceOf[`4`]
    
    inline def DROPDOWN_ONLY: `1024` = 1024.asInstanceOf[`1024`]
    
    inline def DROP_DOWN: `256` = 256.asInstanceOf[`256`]
    
    inline def ICON: `128` = 128.asInstanceOf[`128`]
    
    inline def OWNER_DRAW: `16` = 16.asInstanceOf[`16`]
    
    inline def RADIO_CHECK: `64` = 64.asInstanceOf[`64`]
    
    inline def REPEAT: `512` = 512.asInstanceOf[`512`]
    
    inline def TEXT: `2048` = 2048.asInstanceOf[`2048`]
  }
}
