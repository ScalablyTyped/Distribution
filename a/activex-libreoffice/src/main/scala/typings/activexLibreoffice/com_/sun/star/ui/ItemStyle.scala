...
object ItemStyle {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ALIGN_CENTER: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def ALIGN_LEFT: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def ALIGN_RIGHT: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def AUTO_SIZE: `32` = 32.asInstanceOf[`32`]
    
    @scala.inline
    def DRAW_FLAT: `12` = 12.asInstanceOf[`12`]
    
    @scala.inline
    def DRAW_IN3D: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def DRAW_OUT3D: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def DROPDOWN_ONLY: `1024` = 1024.asInstanceOf[`1024`]
    
    @scala.inline
    def DROP_DOWN: `256` = 256.asInstanceOf[`256`]
    
    @scala.inline
    def ICON: `128` = 128.asInstanceOf[`128`]
    
    @scala.inline
    def OWNER_DRAW: `16` = 16.asInstanceOf[`16`]
    
    @scala.inline
    def RADIO_CHECK: `64` = 64.asInstanceOf[`64`]
    
    @scala.inline
    def REPEAT: `512` = 512.asInstanceOf[`512`]
    
    @scala.inline
    def TEXT: `2048` = 2048.asInstanceOf[`2048`]
  }
}
