...
object XPrimitive2D {
  ...
  @scala.inline
  implicit class XPrimitive2DOps[Self <: XPrimitive2D] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGetDecomposition(value: SeqEquiv[PropertyValue] => SafeArray[XPrimitive2D]): Self = this.set("getDecomposition", js.Any.fromFunction1(value))
    
    @scala.inline
    def setGetRange(value: SeqEquiv[PropertyValue] => RealRectangle2D): Self = this.set("getRange", js.Any.fromFunction1(value))
  }
}
