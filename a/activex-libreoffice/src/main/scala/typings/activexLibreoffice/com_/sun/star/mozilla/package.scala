...
package object mozilla {
  ...
  type MenuProxy = typings.activexLibreoffice.com_.sun.star.mozilla.XMenuProxy
  
  /** Listens for changes in menu items. */
  type MenuProxyListener = typings.activexLibreoffice.com_.sun.star.mozilla.XMenuProxyListener
  ...
  /**
    ...
    */
  type MozillaBootstrap = typings.activexLibreoffice.com_.sun.star.mozilla.XMozillaBootstrap
}
