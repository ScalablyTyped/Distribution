...
object ColorComponentTag {
  ...
  */
  ...
  object Constants {
    ...
    inline def ALPHA: `12` = 12.asInstanceOf[`12`]
    
    inline def CIELAB_A: `19` = 19.asInstanceOf[`19`]
    
    inline def CIELAB_B: `20` = 20.asInstanceOf[`20`]
    
    inline def CIELAB_L: `18` = 18.asInstanceOf[`18`]
    
    inline def CIEXYZ_X: `15` = 15.asInstanceOf[`15`]
    
    inline def CIEXYZ_Y: `16` = 16.asInstanceOf[`16`]
    
    inline def CIEXYZ_Z: `17` = 17.asInstanceOf[`17`]
    
    inline def CMYKOG_GREEN: `9` = 9.asInstanceOf[`9`]
    
    inline def CMYKOG_ORANGE: `8` = 8.asInstanceOf[`8`]
    
    inline def CMYK_BLACK: `7` = 7.asInstanceOf[`7`]
    
    inline def CMYK_CYAN: `4` = 4.asInstanceOf[`4`]
    
    inline def CMYK_MAGENTA: `5` = 5.asInstanceOf[`5`]
    
    inline def CMYK_YELLOW: `6` = 6.asInstanceOf[`6`]
    
    inline def DEVICE: `0` = 0.asInstanceOf[`0`]
    
    inline def GREY: `13` = 13.asInstanceOf[`13`]
    
    inline def HSL_H: `24` = 24.asInstanceOf[`24`]
    
    inline def HSL_L: `26` = 26.asInstanceOf[`26`]
    
    inline def HSL_S: `25` = 25.asInstanceOf[`25`]
    
    inline def HSV_H: `21` = 21.asInstanceOf[`21`]
    
    inline def HSV_S: `22` = 22.asInstanceOf[`22`]
    
    inline def HSV_V: `23` = 23.asInstanceOf[`23`]
    
    inline def INDEX: `11` = 11.asInstanceOf[`11`]
    
    inline def PREMULTIPLIED_ALPHA: `14` = 14.asInstanceOf[`14`]
    
    inline def RGB_BLUE: `3` = 3.asInstanceOf[`3`]
    
    inline def RGB_GREEN: `2` = 2.asInstanceOf[`2`]
    
    inline def RGB_RED: `1` = 1.asInstanceOf[`1`]
    
    inline def SPOT: `10` = 10.asInstanceOf[`10`]
    
    inline def YCBCR_CB: `28` = 28.asInstanceOf[`28`]
    
    inline def YCBCR_CR: `29` = 29.asInstanceOf[`29`]
    
    inline def YCBCR_Y: `27` = 27.asInstanceOf[`27`]
  }
}
