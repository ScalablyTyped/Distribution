...
object ColorComponentTag {
  ...
  */
  ...
  object Constants {
    ...
    @scala.inline
    def ALPHA: `12` = 12.asInstanceOf[`12`]
    
    @scala.inline
    def CIELAB_A: `19` = 19.asInstanceOf[`19`]
    
    @scala.inline
    def CIELAB_B: `20` = 20.asInstanceOf[`20`]
    
    @scala.inline
    def CIELAB_L: `18` = 18.asInstanceOf[`18`]
    
    @scala.inline
    def CIEXYZ_X: `15` = 15.asInstanceOf[`15`]
    
    @scala.inline
    def CIEXYZ_Y: `16` = 16.asInstanceOf[`16`]
    
    @scala.inline
    def CIEXYZ_Z: `17` = 17.asInstanceOf[`17`]
    
    @scala.inline
    def CMYKOG_GREEN: `9` = 9.asInstanceOf[`9`]
    
    @scala.inline
    def CMYKOG_ORANGE: `8` = 8.asInstanceOf[`8`]
    
    @scala.inline
    def CMYK_BLACK: `7` = 7.asInstanceOf[`7`]
    
    @scala.inline
    def CMYK_CYAN: `4` = 4.asInstanceOf[`4`]
    
    @scala.inline
    def CMYK_MAGENTA: `5` = 5.asInstanceOf[`5`]
    
    @scala.inline
    def CMYK_YELLOW: `6` = 6.asInstanceOf[`6`]
    
    @scala.inline
    def DEVICE: `0` = 0.asInstanceOf[`0`]
    
    @scala.inline
    def GREY: `13` = 13.asInstanceOf[`13`]
    
    @scala.inline
    def HSL_H: `24` = 24.asInstanceOf[`24`]
    
    @scala.inline
    def HSL_L: `26` = 26.asInstanceOf[`26`]
    
    @scala.inline
    def HSL_S: `25` = 25.asInstanceOf[`25`]
    
    @scala.inline
    def HSV_H: `21` = 21.asInstanceOf[`21`]
    
    @scala.inline
    def HSV_S: `22` = 22.asInstanceOf[`22`]
    
    @scala.inline
    def HSV_V: `23` = 23.asInstanceOf[`23`]
    
    @scala.inline
    def INDEX: `11` = 11.asInstanceOf[`11`]
    
    @scala.inline
    def PREMULTIPLIED_ALPHA: `14` = 14.asInstanceOf[`14`]
    
    @scala.inline
    def RGB_BLUE: `3` = 3.asInstanceOf[`3`]
    
    @scala.inline
    def RGB_GREEN: `2` = 2.asInstanceOf[`2`]
    
    @scala.inline
    def RGB_RED: `1` = 1.asInstanceOf[`1`]
    
    @scala.inline
    def SPOT: `10` = 10.asInstanceOf[`10`]
    
    @scala.inline
    def YCBCR_CB: `28` = 28.asInstanceOf[`28`]
    
    @scala.inline
    def YCBCR_CR: `29` = 29.asInstanceOf[`29`]
    
    @scala.inline
    def YCBCR_Y: `27` = 27.asInstanceOf[`27`]
  }
}
