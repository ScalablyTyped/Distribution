...
object VclWindowPeerAttribute {
  ...
  */
  ...
  object Constants {
    ...
    inline def CLIPCHILDREN: `524288` = 524288.asInstanceOf[`524288`]
    
    inline def DEFBUTTON: `65536` = 65536.asInstanceOf[`65536`]
    ...
    inline def DEF_RETRY: `536870912` = 536870912.asInstanceOf[`536870912`]
    
    inline def DEF_YES: `1073741824` = 1073741824.asInstanceOf[`1073741824`]
    
    inline def DROPDOWN: `32768` = 32768.asInstanceOf[`32768`]
    
    inline def GROUP: `2097152` = 2097152.asInstanceOf[`2097152`]
    
    inline def HSCROLL: `256` = 256.asInstanceOf[`256`]
    
    inline def LEFT: `1024` = 1024.asInstanceOf[`1024`]
    
    inline def NOBORDER: `1048576` = 1048576.asInstanceOf[`1048576`]
    
    inline def NOLABEL: `536870912` = 536870912.asInstanceOf[`536870912`]
    
    inline def OK: `4194304` = 4194304.asInstanceOf[`4194304`]
    
    inline def OK_CANCEL: `8388608` = 8388608.asInstanceOf[`8388608`]
    
    inline def READONLY: `262144` = 262144.asInstanceOf[`262144`]
    
    inline def RETRY_CANCEL: `67108864` = 67108864.asInstanceOf[`67108864`]
    
    inline def RIGHT: `4096` = 4096.asInstanceOf[`4096`]
    
    inline def SORT: `16384` = 16384.asInstanceOf[`16384`]
    
    inline def SPIN: `8192` = 8192.asInstanceOf[`8192`]
    
    inline def VSCROLL: `512` = 512.asInstanceOf[`512`]
    
    inline def YES_NO: `16777216` = 16777216.asInstanceOf[`16777216`]
    
    inline def YES_NO_CANCEL: `33554432` = 33554432.asInstanceOf[`33554432`]
  }
}
