...
object XColumnsSupplier {
  ...
  implicit class XColumnsSupplierOps[Self <: XColumnsSupplier] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setColumns(value: XNameAccess): Self = this.set("Columns", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGetColumns(value: () => XNameAccess): Self = this.set("getColumns", js.Any.fromFunction0(value))
  }
}
