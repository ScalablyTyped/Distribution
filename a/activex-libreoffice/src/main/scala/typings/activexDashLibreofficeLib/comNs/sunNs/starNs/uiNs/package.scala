...
package object uiNs {
  ...
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleUICategoryDescription = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleUICommandDescription = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
    ...
    * @since OOo 2.0
    */
  type ModuleWindowStateConfiguration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameContainer
  /**
    ...
    * @since OOo 2.0
    */
  type UICategoryDescription = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
  ...
  /**
    ...
    * @since OOo 3.1
    */
  type WindowContentFactory = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleComponentFactory
  /**
    ...
    * @since LibreOffice 4.1
    */
  type WindowContentFactoryManager = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleComponentFactory
  /**
    ...
    * @since OOo 2.0
    */
  type WindowStateConfiguration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theUICategoryDescription = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
  ...
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theWindowContentFactoryManager = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleComponentFactory
  /**
    ...
    * @since LibreOffice 4.3
    */
  type theWindowStateConfiguration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
}
