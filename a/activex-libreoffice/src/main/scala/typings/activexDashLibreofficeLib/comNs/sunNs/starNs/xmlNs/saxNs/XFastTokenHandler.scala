...
trait XFastTokenHandler
  ...
  def getUTF8Identifier(Token: scala.Double): stdLib.SafeArray[scala.Double]
}
...
object XFastTokenHandler {
  ...
  def apply(
    acquire: () => scala.Unit,
    getTokenFromUTF8: activexDashLibreofficeLib.LibreOfficeNs.SeqEquiv[scala.Double] => scala.Double,
    getUTF8Identifier: scala.Double => stdLib.SafeArray[scala.Double],
