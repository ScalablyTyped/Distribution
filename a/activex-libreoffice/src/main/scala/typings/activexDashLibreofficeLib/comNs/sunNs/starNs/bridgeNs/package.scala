...
package object bridgeNs {
  ...
  type BridgeExistsException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    */
  type OleApplicationRegistration = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
  /**
  ...
  /**
    ...
    * @deprecated Deprecated
    */
  type OleObjectFactory = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XMultiServiceFactory
