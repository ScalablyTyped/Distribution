...
package object registryNs {
  /**
    ...
    * a jar file)).;
    */
  type CannotRegisterImplementationException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  type InvalidRegistryException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** signals that the value of the key is invalid or does not have the appropriate key type. */
  type InvalidValueException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** is thrown if entries of two registries are contradictory in the context of {@link XSimpleRegistry.mergeKey()} e() method. */
  type MergeConflictException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
