...
package object oleautomationNs {
  /**
    ...
    */
  type ApplicationRegistration = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
  /**
    ...
    */
  type BridgeSupplier = activexDashLibreofficeLib.comNs.sunNs.starNs.bridgeNs.XBridgeSupplier2
  /**
    ...
    */
  type Factory = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XMultiServiceFactory
  /**
    ...
    * @since OOo 1.1.2
    */
  type XAutomationObject = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
}
