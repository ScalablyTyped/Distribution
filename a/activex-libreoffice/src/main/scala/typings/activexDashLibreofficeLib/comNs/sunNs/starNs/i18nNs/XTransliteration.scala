...
trait XTransliteration
  ...
  /**
    ...
    */
  def getAvailableModules(aLocale: activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.Locale, nType: scala.Double): stdLib.SafeArray[java.lang.String]
  /**
    * Unique ASCII name to identify a module. This name is used to get its localized name for menus, dialogs etc. The behavior is undefined for {@link
    * TransliterationType.CASCADE} modules.
    */
  ...
  /**
    ...
    */
  def transliterateRange(aStr1: java.lang.String, aStr2: java.lang.String): stdLib.SafeArray[java.lang.String]
}
