...
object LabelOrigin {
  /**
    ...
    */
  @scala.inline
  def COLUMN: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`2` = this.cast(2)
  /**
    ...
    */
  @scala.inline
  def LONG_SIDE: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`1` = this.cast(1)
  /**
    ...
    */
  @scala.inline
  def ROW: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`3` = this.cast(3)
  /**
    ...
    */
  @scala.inline
  def SHORT_SIDE: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`0` = this.cast(0)
  @scala.inline
