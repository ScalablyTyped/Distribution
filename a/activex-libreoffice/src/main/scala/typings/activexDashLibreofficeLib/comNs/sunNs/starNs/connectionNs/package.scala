...
package object connectionNs {
  ...
  type AlreadyAcceptingException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** Is thrown, when it is not possible to accept on a local resource. */
  type ConnectionSetupException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  type NoConnectException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
}
