...
package object sdbNs {
  ...
  type ColumnDescriptorControl = activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.UnoControl
  /** @since LibreOffice 4.1 */
  type CommandDefinition = activexDashLibreofficeLib.comNs.sunNs.starNs.sdbcxNs.XRename
  /**
    ...
    */
  type ContentLoader = activexDashLibreofficeLib.comNs.sunNs.starNs.frameNs.FrameLoader
  ...
  /**
    ...
    * information.
    */
  type DatabaseInteractionHandler = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.XInteractionHandler2
  /**
  ...
  /**
    ...
    */
  type InteractionHandler = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.XInteractionHandler
  /**
  ...
  /**
    ...
    * @since LibreOffice 4.1
    */
  type ReportDesign = activexDashLibreofficeLib.comNs.sunNs.starNs.frameNs.XController2
  /**
  ...
  /**
    ...
    */
  type RowSetVetoException = activexDashLibreofficeLib.comNs.sunNs.starNs.sdbcNs.SQLException
  /** @since LibreOffice 4.1 */
