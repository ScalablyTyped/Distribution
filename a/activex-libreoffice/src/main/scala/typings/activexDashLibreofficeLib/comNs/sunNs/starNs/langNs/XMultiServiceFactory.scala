...
trait XMultiServiceFactory
  ...
  def createInstance[K /* <: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 1364 */ java.lang.String */](aServiceSpecifier: K): /* import warning: ImportType.apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
  /**
  ...
  def createInstanceWithArguments[K /* <: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 1364 */ java.lang.String */](ServiceSpecifier: K, Arguments: activexDashLibreofficeLib.LibreOfficeNs.SeqEquiv[_]): /* import warning: ImportType.apply Failed type conversion: activex-libreoffice.LibreOffice.ServicesNameMap[K] */ js.Any = js.native
  /**
    * Provides the available names of the factory to be used to create instances.
    * @returns sequence of all names
    */
