...
object AnimatedImagesControlModel {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(AutoRepeat = AutoRepeat, DefaultControl = DefaultControl, Height = Height, ImageSetCount = ImageSetCount, Name = Name, PositionX = PositionX, PositionY = PositionY, PropertySetInfo = PropertySetInfo, ScaleMode = ScaleMode, ServiceName = ServiceName, Step = Step, StepTime = StepTime, TabIndex = TabIndex, Tag = Tag, Width = Width, acquire = acquire, addContainerListener = addContainerListener, addEventListener = addEventListener, addPropertiesChangeListener = addPropertiesChangeListener, addPropertyChangeListener = addPropertyChangeListener, addVetoableChangeListener = addVetoableChangeListener, createClone = createClone, dispose = dispose, firePropertiesChangeEvent = firePropertiesChangeEvent, getImageSet = getImageSet, getImageSetCount = getImageSetCount, getPropertySetInfo = getPropertySetInfo, getPropertyValue = getPropertyValue, getPropertyValues = getPropertyValues, getServiceName = getServiceName, insertImageSet = insertImageSet, queryInterface = queryInterface, read = read, release = release, removeContainerListener = removeContainerListener, removeEventListener = removeEventListener, removeImageSet = removeImageSet, removePropertiesChangeListener = removePropertiesChangeListener, removePropertyChangeListener = removePropertyChangeListener, removeVetoableChangeListener = removeVetoableChangeListener, replaceImageSet = replaceImageSet, setPropertyValue = setPropertyValue, setPropertyValues = setPropertyValues, write = write)
