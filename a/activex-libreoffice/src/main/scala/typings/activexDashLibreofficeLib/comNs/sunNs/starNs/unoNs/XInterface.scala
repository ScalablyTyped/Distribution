...
trait XInterface extends js.Object {
  ...
  /**
    ...
    */
  def queryInterface(aType: activexDashLibreofficeLib.`type`): js.Any
  /**
...
object XInterface {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire, queryInterface = queryInterface, release = release)
