...
object DocumentIndex {
  ...
  def apply(
    ...
    __obj.updateDynamic("MainEntryCharacterStyleName")(MainEntryCharacterStyleName)
    ...
    __obj.updateDynamic("UseAlphabeticalSeparators")(UseAlphabeticalSeparators)
    __obj.updateDynamic("UseCombinedEntries")(UseCombinedEntries)
    __obj.updateDynamic("UseDash")(UseDash)
    __obj.updateDynamic("UseKeyAsEntry")(UseKeyAsEntry)
    __obj.updateDynamic("UsePP")(UsePP)
    __obj.updateDynamic("UseUpperCase")(UseUpperCase)
