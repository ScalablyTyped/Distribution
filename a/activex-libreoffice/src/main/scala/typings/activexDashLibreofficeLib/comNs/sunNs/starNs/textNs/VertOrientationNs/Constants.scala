package typings
package activexDashLibreofficeLib.comNs.sunNs.starNs.textNs.VertOrientationNs
...
object Constants {
  ...
  @scala.inline
  def CHAR_BOTTOM: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`6` = this.cast(6)
  @scala.inline
  def CHAR_CENTER: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`5` = this.cast(5)
  @scala.inline
  def CHAR_TOP: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`4` = this.cast(4)
  @scala.inline
  def LINE_BOTTOM: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`9` = this.cast(9)
  @scala.inline
  def LINE_CENTER: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`8` = this.cast(8)
  @scala.inline
  def LINE_TOP: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`7` = this.cast(7)
  @scala.inline
