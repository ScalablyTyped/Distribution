...
trait XWizard extends XExecutableDialog {
  ...
  var DialogWindow: activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.XWindow
  ...
  /**
    ...
    */
  def activatePath(PathIndex: scala.Double, Final: scala.Boolean): scala.Unit
  /**
    ...
    */
  def advanceTo(PageId: scala.Double): scala.Boolean
  /**
    ...
    */
  def enableButton(WizardButton: scala.Double, Enable: scala.Boolean): scala.Unit
  /**
    ...
    */
  def enablePage(PageID: scala.Double, Enable: scala.Boolean): scala.Unit
  /** provides access to the current page of the wizard */
  ...
  /**
    ...
    */
  def goBackTo(PageId: scala.Double): scala.Boolean
  /**
    ...
    * defaulted.
    */
  def setDefaultButton(WizardButton: scala.Double): scala.Unit
  /**
