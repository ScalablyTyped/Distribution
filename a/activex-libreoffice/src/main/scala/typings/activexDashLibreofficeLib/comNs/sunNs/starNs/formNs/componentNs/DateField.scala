...
trait DateField
  ...
  var Date: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Date = js.native
  /**
    ...
    */
  var DateFormat: scala.Double = js.native
  /** specifies the maximum date that can be entered. */
  var DateMax: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Date = js.native
  /** specifies the minimum date that can be entered. */
  var DateMin: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Date = js.native
  /** specifies, if the date century is displayed. */
  var DateShowCentury: scala.Boolean = js.native
  /**
