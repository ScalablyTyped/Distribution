...
package object textNs {
  ...
  /**
    ...
    */
  type DocumentIndexLevelFormat = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XIndexReplace
  ...
  type DocumentIndexParagraphStyles = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XIndexReplace
  ...
  type Footnotes = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XIndexAccess
  /**
  ...
  type ParagraphEnumeration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XEnumeration
  /**
    ...
    * @since OOo 1.1.2
    */
  type TableColumns = activexDashLibreofficeLib.comNs.sunNs.starNs.tableNs.XTableColumns
  /**
    ...
    * @since OOo 1.1.2
    */
  type TableRows = activexDashLibreofficeLib.comNs.sunNs.starNs.tableNs.XTableRows
  type TextColumnSequence = activexDashLibreofficeLib.LibreOfficeNs.SeqEquiv[TextColumn]
  ...
  type TextFieldEnumeration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XEnumeration
  /** This is a collection of instances of {@link TextFieldMaster} , defined in a context (e.g. in a document). */
  type TextFieldMasters = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameAccess
  /**
    ...
    */
  type TextPortionEnumeration = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XEnumeration
  /** provides a container for {@link XTextRange} objects. */
  type TextRanges = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XIndexAccess
  /**
    * provides an interface for sorting.
    * @deprecated Deprecated
    * @since OOo 1.1.2
    */
  type TextSortable = activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.XSortable
  /**
