...
trait DataSourceBrowser
  extends activexDashLibreofficeLib.comNs.sunNs.starNs.formNs.FormController
     with activexDashLibreofficeLib.comNs.sunNs.starNs.frameNs.XController
  ...
  override def getModel(): activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.XTabControllerModel with activexDashLibreofficeLib.comNs.sunNs.starNs.frameNs.XModel = js.native
  @JSName("getModel")
  def getModel_XTabControllerModel(): activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.XTabControllerModel = js.native
}
