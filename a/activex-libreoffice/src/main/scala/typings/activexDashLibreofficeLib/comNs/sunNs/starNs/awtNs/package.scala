...
package object awtNs {
  ...
  /**
    ...
    */
  type PrinterException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  type XControlModel = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
  /**
    ...
    */
  type XDisplayBitmap = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
