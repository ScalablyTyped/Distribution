...
object XAccessibleTextMarkup {
  ...
  def apply(
    ...
    __obj.updateDynamic("getTextMarkup")(getTextMarkup)
    __obj.updateDynamic("getTextMarkupAtIndex")(getTextMarkupAtIndex)
    __obj.updateDynamic("getTextMarkupCount")(getTextMarkupCount)
