...
object UnoControlFormattedFieldModel {
  ...
  def apply(
    ...
    __obj.updateDynamic("EffectiveDefault")(EffectiveDefault)
    __obj.updateDynamic("EffectiveMax")(EffectiveMax)
    __obj.updateDynamic("EffectiveMin")(EffectiveMin)
    __obj.updateDynamic("EffectiveValue")(EffectiveValue)
    ...
    __obj.updateDynamic("FormatsSupplier")(FormatsSupplier)
    ...
    __obj.updateDynamic("TreatAsNumber")(TreatAsNumber)
