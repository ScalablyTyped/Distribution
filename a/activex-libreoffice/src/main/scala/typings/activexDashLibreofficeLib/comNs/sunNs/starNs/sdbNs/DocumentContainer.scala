...
trait DocumentContainer
  extends DefinitionContent
     ...
     with activexDashLibreofficeLib.comNs.sunNs.starNs.frameNs.XComponentLoader
     with activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XMultiServiceFactory
     with activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XHierarchicalNameContainer {
