...
package object scriptNs {
  ...
  /**
    ...
    */
  type CannotCreateAdapterException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    */
  type Invocation = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleServiceFactory
  /**
  ...
  /**
    ...
    * @since OOo 3.0
    */
  type LibraryNotLoadedException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
