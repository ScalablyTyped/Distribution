...
package object controlNs {
  /**
    ...
    */
  type GroupBox = activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.UnoControlGroupBox
  /**
    ...
    */
  type NavigationToolBar = activexDashLibreofficeLib.comNs.sunNs.starNs.awtNs.UnoControl
  /**
    ...
    */
  type SubmitButton = activexDashLibreofficeLib.comNs.sunNs.starNs.formNs.submissionNs.XSubmission
}
