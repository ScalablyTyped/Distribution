...
package object chart2Ns {
  ...
  type ChartTypeManager = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.MultiServiceFactory
  ...
  /** @since LibreOffice 4.1 */
  type RegressionEquation = activexDashLibreofficeLib.comNs.sunNs.starNs.beansNs.XPropertySet
  /** stateless service */
  type Scaling = XScaling
  type XChartTypeManager = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
  /** interface for the legend of a diagram */
  type XLegend = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.XInterface
}
