package typings
package activexDashLibreofficeLib.comNs.sunNs.starNs.sheetNs.GeneralFunction2Ns
...
object Constants {
  ...
  @scala.inline
  def MEDIAN: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`13` = this.cast(13)
  @scala.inline
