...
package object bindingNs {
  ...
  type IncompatibleTypesException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** thrown when an {@link XValueBinding} cannot perform a requested operation due to an invalid state. */
  type InvalidBindingStateException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
}
