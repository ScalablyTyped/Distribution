...
object TextAnimationDirection {
  @scala.inline
  def DOWN: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`3` = this.cast(3)
  /**
  ...
  @scala.inline
  def UP: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`2` = this.cast(2)
  @scala.inline
