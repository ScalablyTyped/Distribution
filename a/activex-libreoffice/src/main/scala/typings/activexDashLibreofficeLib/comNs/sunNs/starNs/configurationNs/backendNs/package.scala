...
package object backendNs {
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type BackendAccessException = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.WrappedTargetException
  /**
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type DataImporter = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.XJob
  /**
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type HierarchyBrowser = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.XJob
  /**
