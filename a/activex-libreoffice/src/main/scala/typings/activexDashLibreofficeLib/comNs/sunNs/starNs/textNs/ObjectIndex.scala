...
object ObjectIndex {
  ...
  def apply(
    ...
    __obj.updateDynamic("CreateFromOtherEmbeddedObjects")(CreateFromOtherEmbeddedObjects)
    __obj.updateDynamic("CreateFromStarCalc")(CreateFromStarCalc)
    __obj.updateDynamic("CreateFromStarChart")(CreateFromStarChart)
    __obj.updateDynamic("CreateFromStarDraw")(CreateFromStarDraw)
    __obj.updateDynamic("CreateFromStarImage")(CreateFromStarImage)
    __obj.updateDynamic("CreateFromStarMath")(CreateFromStarMath)
