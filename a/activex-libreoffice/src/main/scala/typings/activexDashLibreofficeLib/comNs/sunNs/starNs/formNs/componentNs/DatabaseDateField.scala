...
- activexDashLibreofficeLib.comNs.sunNs.starNs.formNs.componentNs.DateField because var conflicts: ClassId, DefaultControl, Height, Name, Parent, PositionX, PositionY, PropertyValues, Step, TabIndex, Tag, Width. Inlined DefaultDate, getPropertyValues, getPropertyValues, setPropertyValues, setPropertyValues */ @js.native
