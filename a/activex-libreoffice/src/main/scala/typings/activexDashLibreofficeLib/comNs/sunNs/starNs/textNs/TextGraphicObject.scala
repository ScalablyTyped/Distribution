...
object TextGraphicObject {
  ...
  def apply(
    ...
    __obj.updateDynamic("ActualSize")(ActualSize)
    ...
    __obj.updateDynamic("ContourPolyPolygon")(ContourPolyPolygon.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("GraphicFilter")(GraphicFilter)
    __obj.updateDynamic("GraphicIsInverted")(GraphicIsInverted)
    __obj.updateDynamic("GraphicURL")(GraphicURL)
    __obj.updateDynamic("Height")(Height)
    __obj.updateDynamic("HoriMirroredOnEvenPages")(HoriMirroredOnEvenPages)
    __obj.updateDynamic("HoriMirroredOnOddPages")(HoriMirroredOnOddPages)
    ...
    __obj.updateDynamic("VertMirrored")(VertMirrored)
