...
trait RichTextControl
  ...
  /**
    ...
    * @since OOo 2.3
    */
  var AutoHScroll: scala.Boolean = js.native
  /**
    * If set to true an vertical scrollbar will be added automatically when needed.
    * @since OOo 2.3
    */
  var AutoVScroll: scala.Boolean = js.native
  ...
  var EchoChar: scala.Double = js.native
  ...
  var HScroll: scala.Boolean = js.native
  /**
    ...
    * border.
    */
  var HardLineBreaks: scala.Boolean = js.native
  ...
  /**
    ...
    * @since OOo 2.0
    */
  var LineEndFormat: scala.Double = js.native
  /**
  ...
  /**
    ...
    * @since OOo 2.3
    */
  var PaintTransparent: scala.Boolean = js.native
  ...
  /**
    ...
    */
  var RichText: scala.Boolean = js.native
  ...
  var VScroll: scala.Boolean = js.native
  /**
