...
package object xmlNs {
  /**
    ...
    * use a prefix.
    */
  type AttributeContainer = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameContainer
  /**
  ...
  /**
    ...
    */
  type NamespaceContainer = activexDashLibreofficeLib.comNs.sunNs.starNs.containerNs.XNameContainer
  /**
    ...
    */
  type XMLExportFilter = activexDashLibreofficeLib.comNs.sunNs.starNs.documentNs.ExportFilter
}
