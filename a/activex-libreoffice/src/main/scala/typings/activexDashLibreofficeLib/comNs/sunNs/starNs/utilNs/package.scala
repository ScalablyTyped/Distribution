...
package object utilNs {
  /**
    ...
    * @see ElementChange
    */
  type ChangesSet = activexDashLibreofficeLib.LibreOfficeNs.SeqEquiv[ElementChange]
  /**
    * this exception can be thrown to prevent the environment of any object from closing
    * @see XCloseListener
    */
  type CloseVetoException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  type InvalidStateException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  type NotNumericException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    * @since OOo 1.1.2
    */
  type VetoException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
