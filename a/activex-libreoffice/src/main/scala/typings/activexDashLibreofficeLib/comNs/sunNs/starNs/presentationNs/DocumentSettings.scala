...
object DocumentSettings {
  ...
  def apply(
    ...
    __obj.updateDynamic("IsPrintDrawing")(IsPrintDrawing)
    __obj.updateDynamic("IsPrintFitPage")(IsPrintFitPage)
    __obj.updateDynamic("IsPrintHandout")(IsPrintHandout)
    __obj.updateDynamic("IsPrintHiddenPages")(IsPrintHiddenPages)
    __obj.updateDynamic("IsPrintNotes")(IsPrintNotes)
    __obj.updateDynamic("IsPrintOutline")(IsPrintOutline)
