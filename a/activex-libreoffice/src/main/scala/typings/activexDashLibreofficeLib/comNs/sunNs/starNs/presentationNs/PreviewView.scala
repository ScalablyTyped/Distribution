...
object PreviewView {
  ...
  def apply(
    ...
    dispose: () => scala.Unit,
    getCurrentPage: () => activexDashLibreofficeLib.comNs.sunNs.starNs.drawingNs.XDrawPage,
    ...
    setCurrentPage: activexDashLibreofficeLib.comNs.sunNs.starNs.drawingNs.XDrawPage => scala.Unit,
