package typings
package activexDashLibreofficeLib.comNs.sunNs.starNs.textNs.ParagraphVertAlignNs
...
object Constants {
  ...
  @scala.inline
  def BASELINE: activexDashLibreofficeLib.activexDashLibreofficeLibNumbers.`1` = this.cast(1)
  @scala.inline
