...
object ImageButton {
  ...
  def apply(
    ...
    acquire: () => scala.Unit,
    addApproveActionListener: activexDashLibreofficeLib.comNs.sunNs.starNs.formNs.XApproveActionListener => scala.Unit,
    ...
    release: () => scala.Unit,
    removeApproveActionListener: activexDashLibreofficeLib.comNs.sunNs.starNs.formNs.XApproveActionListener => scala.Unit,
