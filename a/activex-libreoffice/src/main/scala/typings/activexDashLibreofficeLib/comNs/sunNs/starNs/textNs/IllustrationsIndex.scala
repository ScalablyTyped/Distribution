...
object IllustrationsIndex {
  ...
  def apply(
    ...
    __obj.updateDynamic("CreateFromLabels")(CreateFromLabels)
    __obj.updateDynamic("HeaderSection")(HeaderSection)
    __obj.updateDynamic("IsProtected")(IsProtected)
    __obj.updateDynamic("LabelCategory")(LabelCategory)
    __obj.updateDynamic("LabelDisplayType")(LabelDisplayType)
