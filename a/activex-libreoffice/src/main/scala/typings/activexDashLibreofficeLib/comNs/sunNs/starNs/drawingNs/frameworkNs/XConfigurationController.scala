...
trait XConfigurationController
  ...
  /**
    ...
    */
  def requestResourceActivation(xResourceId: XResourceId, eMode: ResourceActivationMode): scala.Unit
  /**
    ...
    */
  def requestResourceDeactivation(xResourceId: XResourceId): scala.Unit
  /**
    ...
    */
  def restoreConfiguration(xConfiguration: XConfiguration): scala.Unit
  /**
