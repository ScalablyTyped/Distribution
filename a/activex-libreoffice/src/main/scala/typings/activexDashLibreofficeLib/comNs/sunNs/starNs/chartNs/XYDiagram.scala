...
object XYDiagram {
  ...
  def apply(
    ...
    __obj.updateDynamic("SplineOrder")(SplineOrder)
    __obj.updateDynamic("SplineResolution")(SplineResolution)
    __obj.updateDynamic("SplineType")(SplineType)
    __obj.updateDynamic("Stacked")(Stacked)
    __obj.updateDynamic("SymbolBitmapURL")(SymbolBitmapURL)
    __obj.updateDynamic("SymbolSize")(SymbolSize)
