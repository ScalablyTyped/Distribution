...
trait UnoControlCurrencyFieldModel extends UnoControlModel {
  ...
  var PrependCurrencySymbol: scala.Boolean
...
object UnoControlCurrencyFieldModel {
  ...
  def apply(
    ...
    __obj.updateDynamic("CurrencySymbol")(CurrencySymbol)
    __obj.updateDynamic("DecimalAccuracy")(DecimalAccuracy)
    ...
    __obj.updateDynamic("PrependCurrencySymbol")(PrependCurrencySymbol)
    ...
    __obj.updateDynamic("ShowThousandsSeparator")(ShowThousandsSeparator)
    ...
    __obj.updateDynamic("ValueStep")(ValueStep)
