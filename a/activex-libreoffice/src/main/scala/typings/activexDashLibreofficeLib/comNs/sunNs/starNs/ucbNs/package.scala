...
package object ucbNs {
  /**
    ...
    * @version 1.0
    */
  type AlreadyInitializedException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  ...
  /**
    ...
    * @version 1.0
    */
  type CommandAbortedException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  ...
  /**
    ...
    * @version 1.0
    */
  type DuplicateCommandIdentifierException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
    ...
    * @version 1.0
    */
  type DuplicateProviderException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    * @version 1.0
    */
  type IllegalIdentifierException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
    * An interaction request to inform the client of a "transfer" command that the supplied source URL is not supported.
    * @see XCommandProcessor
    */
  type InteractiveBadTransferURLException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    */
  type InteractiveNetworkException = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.ClassifiedInteractionRequest
  ...
  /**
    ...
    * @version 1.0
    */
  type MissingInputStreamException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    * @see com.sun.star.ucb.Content
    */
  type PropertiesManager = activexDashLibreofficeLib.comNs.sunNs.starNs.beansNs.XPropertySetInfo
  /**
    * This exception is thrown to propagate exceptions thrown by operations on ContentResultSets.
    * @author Kai Sommerfeld
    * @version 1.0
    */
  type ResultSetException = activexDashLibreofficeLib.comNs.sunNs.starNs.sdbcNs.SQLException
  /** This exception is thrown to indicate that a needed service was not registered. */
  type ServiceNotFoundException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    * @version 1.0
    */
  type UnsupportedCommandException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
  ...
  /**
    ...
    * @version 1.0
    */
  type XInteractionReplaceExistingData = activexDashLibreofficeLib.comNs.sunNs.starNs.taskNs.XInteractionContinuation
}
