...
object XPropertyStateChangeListener {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire, disposing = disposing, propertyStateChange = propertyStateChange, queryInterface = queryInterface, release = release)
