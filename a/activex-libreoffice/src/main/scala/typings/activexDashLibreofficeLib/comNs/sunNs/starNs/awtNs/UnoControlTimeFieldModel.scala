...
trait UnoControlTimeFieldModel extends UnoControlModel {
  ...
  /**
    ...
    */
  var TimeFormat: scala.Double
  /** specifies the maximum time that can be entered. */
  var TimeMax: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Time
  /** specifies the minimum time that can be entered. */
  var TimeMin: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Time
  /**
...
object UnoControlTimeFieldModel {
  ...
  def apply(
    ...
    TimeFormat: scala.Double,
    TimeMax: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Time,
    TimeMin: activexDashLibreofficeLib.comNs.sunNs.starNs.utilNs.Time,
