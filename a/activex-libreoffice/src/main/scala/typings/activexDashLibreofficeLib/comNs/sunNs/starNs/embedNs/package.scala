...
package object embedNs {
  ...
  /**
    ...
    */
  type FileSystemStorageFactory = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleServiceFactory
  /** @since LibreOffice 4.1 */
  ...
  /**
    ...
    */
  type InvalidStorageException = activexDashLibreofficeLib.comNs.sunNs.starNs.ioNs.IOException
  /**
    * This exception can be thrown in case a linked object is misused.
    *
    * Or if embedded object is misused as a linked object.
    */
  type LinkageMisuseException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** @since LibreOffice 4.1 */
  ...
  type NoVisualAreaSizeException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /** @since LibreOffice 4.1 */
  ...
  /**
    ...
    * @see XEmbeddedClient
    */
  type ObjectSaveVetoException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
    ...
    */
  type StorageFactory = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.XSingleServiceFactory
  /** This exception can wrap an exception thrown during {@link XStorage} methods execution. */
  type StorageWrappedTargetException = activexDashLibreofficeLib.comNs.sunNs.starNs.langNs.WrappedTargetException
  /** This exception can be thrown in case the object's state does not allow to call requested functionality. */
  type WrongStateException = activexDashLibreofficeLib.comNs.sunNs.starNs.unoNs.Exception
  /**
