...
trait AutomationServiceManager
  ...
  def Bridge_GetStruct[K /* <: /* import warning: LimitUnionLength.enterTypeRef Was union type with length 388 */ java.lang.String */](structName: K): /* import warning: ImportType.apply Failed type conversion: activex-libreoffice.LibreOffice.StructNameMap[K] */ js.Any = js.native
  /**
