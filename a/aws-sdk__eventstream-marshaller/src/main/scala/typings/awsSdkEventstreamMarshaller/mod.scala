...
object mod {
  ...
  open class EventStreamMarshaller protected ()
    extends typings.awsSdkEventstreamMarshaller.distTypesEventStreamMarshallerMod.EventStreamMarshaller {
  ...
  open class Int64 protected ()
    extends typings.awsSdkEventstreamMarshaller.distTypesInt64Mod.Int64 {
