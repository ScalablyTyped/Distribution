...
object activexDashShdocvwLibNumbers {
  @js.native
  sealed trait `-1`
  ...
  sealed trait `0`
    extends activexDashShdocvwLib.SHDocVwNs.OLECMDEXECOPT
       with activexDashShdocvwLib.SHDocVwNs.RefreshConstants
       with activexDashShdocvwLib.SHDocVwNs.SecureLockIconConstants
       with activexDashShdocvwLib.SHDocVwNs.ShellWindowTypeConstants
       with activexDashShdocvwLib.SHDocVwNs.tagREADYSTATE
  ...
  sealed trait `1`
    extends activexDashShdocvwLib.SHDocVwNs.BrowserNavConstants
       with activexDashShdocvwLib.SHDocVwNs.CommandStateChangeConstants
       with activexDashShdocvwLib.SHDocVwNs.OLECMDEXECOPT
       with activexDashShdocvwLib.SHDocVwNs.OLECMDF
       with activexDashShdocvwLib.SHDocVwNs.OLECMDID
       with activexDashShdocvwLib.SHDocVwNs.RefreshConstants
       with activexDashShdocvwLib.SHDocVwNs.SecureLockIconConstants
       with activexDashShdocvwLib.SHDocVwNs.ShellWindowFindWindowOptions
       with activexDashShdocvwLib.SHDocVwNs.ShellWindowTypeConstants
       with activexDashShdocvwLib.SHDocVwNs.tagREADYSTATE
  
  @js.native
  sealed trait `10`
    extends activexDashShdocvwLib.SHDocVwNs.OLECMDID
  ...
  @js.native
  sealed trait `4`
    extends activexDashShdocvwLib.SHDocVwNs.OLECMDF
       with activexDashShdocvwLib.SHDocVwNs.OLECMDID
       with activexDashShdocvwLib.SHDocVwNs.SecureLockIconConstants
       with activexDashShdocvwLib.SHDocVwNs.ShellWindowFindWindowOptions
       with activexDashShdocvwLib.SHDocVwNs.ShellWindowTypeConstants
