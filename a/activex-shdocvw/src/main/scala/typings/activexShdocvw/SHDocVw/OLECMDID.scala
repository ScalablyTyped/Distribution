...
object OLECMDID {
  ...
  inline def OLECMDID_ACTIVEXINSTALLSCOPE: `66` = 66.asInstanceOf[`66`]
  
  inline def OLECMDID_ADDTRAVELENTRY: `60` = 60.asInstanceOf[`60`]
  
  inline def OLECMDID_ALLOWUILESSSAVEAS: `46` = 46.asInstanceOf[`46`]
  
  inline def OLECMDID_CLEARSELECTION: `18` = 18.asInstanceOf[`18`]
  
  inline def OLECMDID_CLOSE: `45` = 45.asInstanceOf[`45`]
  
  inline def OLECMDID_COPY: `12` = 12.asInstanceOf[`12`]
  
  inline def OLECMDID_CUT: `11` = 11.asInstanceOf[`11`]
  
  inline def OLECMDID_DELETE: `33` = 33.asInstanceOf[`33`]
  
  inline def OLECMDID_DONTDOWNLOADCSS: `47` = 47.asInstanceOf[`47`]
  
  inline def OLECMDID_ENABLE_INTERACTION: `36` = 36.asInstanceOf[`36`]
  
  inline def OLECMDID_ENABLE_VISIBILITY: `77` = 77.asInstanceOf[`77`]
  
  inline def OLECMDID_EXITFULLSCREEN: `81` = 81.asInstanceOf[`81`]
  
  inline def OLECMDID_FIND: `32` = 32.asInstanceOf[`32`]
  
  inline def OLECMDID_FOCUSVIEWCONTROLS: `57` = 57.asInstanceOf[`57`]
  
  inline def OLECMDID_FOCUSVIEWCONTROLSQUERY: `58` = 58.asInstanceOf[`58`]
  
  inline def OLECMDID_GETPRINTTEMPLATE: `52` = 52.asInstanceOf[`52`]
  
  inline def OLECMDID_GETUSERSCALABLE: `75` = 75.asInstanceOf[`75`]
  
  inline def OLECMDID_GETZOOMRANGE: `20` = 20.asInstanceOf[`20`]
  
  inline def OLECMDID_HIDETOOLBARS: `24` = 24.asInstanceOf[`24`]
  
  inline def OLECMDID_HTTPEQUIV: `34` = 34.asInstanceOf[`34`]
  
  inline def OLECMDID_HTTPEQUIV_DONE: `35` = 35.asInstanceOf[`35`]
  
  inline def OLECMDID_LAYOUT_VIEWPORT_WIDTH: `71` = 71.asInstanceOf[`71`]
  
  inline def OLECMDID_MEDIA_PLAYBACK: `78` = 78.asInstanceOf[`78`]
  
  inline def OLECMDID_NEW: `2` = 2.asInstanceOf[`2`]
  
  inline def OLECMDID_ONBEFOREUNLOAD: `83` = 83.asInstanceOf[`83`]
  
  inline def OLECMDID_ONTOOLBARACTIVATED: `31` = 31.asInstanceOf[`31`]
  
  inline def OLECMDID_ONUNLOAD: `37` = 37.asInstanceOf[`37`]
  
  inline def OLECMDID_OPEN: `1` = 1.asInstanceOf[`1`]
  
  inline def OLECMDID_OPTICAL_GETZOOMRANGE: `64` = 64.asInstanceOf[`64`]
  
  inline def OLECMDID_OPTICAL_ZOOM: `63` = 63.asInstanceOf[`63`]
  
  inline def OLECMDID_PAGEACTIONBLOCKED: `55` = 55.asInstanceOf[`55`]
  
  inline def OLECMDID_PAGEACTIONUIQUERY: `56` = 56.asInstanceOf[`56`]
  
  inline def OLECMDID_PAGEAVAILABLE: `74` = 74.asInstanceOf[`74`]
  
  inline def OLECMDID_PAGESETUP: `8` = 8.asInstanceOf[`8`]
  
  inline def OLECMDID_PASTE: `13` = 13.asInstanceOf[`13`]
  
  inline def OLECMDID_PASTESPECIAL: `14` = 14.asInstanceOf[`14`]
  
  inline def OLECMDID_POPSTATEEVENT: `69` = 69.asInstanceOf[`69`]
  
  inline def OLECMDID_PREREFRESH: `39` = 39.asInstanceOf[`39`]
  
  inline def OLECMDID_PRINT: `6` = 6.asInstanceOf[`6`]
  
  inline def OLECMDID_PRINT2: `49` = 49.asInstanceOf[`49`]
  
  inline def OLECMDID_PRINTPREVIEW: `7` = 7.asInstanceOf[`7`]
  
  inline def OLECMDID_PRINTPREVIEW2: `50` = 50.asInstanceOf[`50`]
  
  inline def OLECMDID_PROPERTIES: `10` = 10.asInstanceOf[`10`]
  
  inline def OLECMDID_PROPERTYBAG2: `38` = 38.asInstanceOf[`38`]
  
  inline def OLECMDID_REDO: `16` = 16.asInstanceOf[`16`]
  
  inline def OLECMDID_REFRESH: `22` = 22.asInstanceOf[`22`]
  
  inline def OLECMDID_SAVE: `3` = 3.asInstanceOf[`3`]
  
  inline def OLECMDID_SAVEAS: `4` = 4.asInstanceOf[`4`]
  
  inline def OLECMDID_SAVECOPYAS: `5` = 5.asInstanceOf[`5`]
  
  inline def OLECMDID_SCROLLCOMPLETE: `82` = 82.asInstanceOf[`82`]
  
  inline def OLECMDID_SELECTALL: `17` = 17.asInstanceOf[`17`]
  
  inline def OLECMDID_SETDOWNLOADSTATE: `29` = 29.asInstanceOf[`29`]
  
  inline def OLECMDID_SETFAVICON: `79` = 79.asInstanceOf[`79`]
  
  inline def OLECMDID_SETPRINTTEMPLATE: `51` = 51.asInstanceOf[`51`]
  
  inline def OLECMDID_SETPROGRESSMAX: `25` = 25.asInstanceOf[`25`]
  
  inline def OLECMDID_SETPROGRESSPOS: `26` = 26.asInstanceOf[`26`]
  
  inline def OLECMDID_SETPROGRESSTEXT: `27` = 27.asInstanceOf[`27`]
  
  inline def OLECMDID_SETTITLE: `28` = 28.asInstanceOf[`28`]
  
  inline def OLECMDID_SET_HOST_FULLSCREENMODE: `80` = 80.asInstanceOf[`80`]
  
  inline def OLECMDID_SHOWFIND: `42` = 42.asInstanceOf[`42`]
  
  inline def OLECMDID_SHOWMESSAGE: `41` = 41.asInstanceOf[`41`]
  
  inline def OLECMDID_SHOWMESSAGE_BLOCKABLE: `84` = 84.asInstanceOf[`84`]
  
  inline def OLECMDID_SHOWPAGEACTIONMENU: `59` = 59.asInstanceOf[`59`]
  
  inline def OLECMDID_SHOWPAGESETUP: `43` = 43.asInstanceOf[`43`]
  
  inline def OLECMDID_SHOWPRINT: `44` = 44.asInstanceOf[`44`]
  
  inline def OLECMDID_SHOWSCRIPTERROR: `40` = 40.asInstanceOf[`40`]
  
  inline def OLECMDID_SHOWTASKDLG: `68` = 68.asInstanceOf[`68`]
  
  inline def OLECMDID_SHOWTASKDLG_BLOCKABLE: `85` = 85.asInstanceOf[`85`]
  
  inline def OLECMDID_SPELL: `9` = 9.asInstanceOf[`9`]
  
  inline def OLECMDID_STOP: `23` = 23.asInstanceOf[`23`]
  
  inline def OLECMDID_STOPDOWNLOAD: `30` = 30.asInstanceOf[`30`]
  
  inline def OLECMDID_UNDO: `15` = 15.asInstanceOf[`15`]
  
  inline def OLECMDID_UPDATEBACKFORWARDSTATE: `62` = 62.asInstanceOf[`62`]
  
  inline def OLECMDID_UPDATECOMMANDS: `21` = 21.asInstanceOf[`21`]
  
  inline def OLECMDID_UPDATEPAGESTATUS: `48` = 48.asInstanceOf[`48`]
  
  inline def OLECMDID_UPDATETRAVELENTRY: `61` = 61.asInstanceOf[`61`]
  
  inline def OLECMDID_UPDATETRAVELENTRY_DATARECOVERY: `67` = 67.asInstanceOf[`67`]
  
  inline def OLECMDID_UPDATE_CARET: `76` = 76.asInstanceOf[`76`]
  
  inline def OLECMDID_USER_OPTICAL_ZOOM: `73` = 73.asInstanceOf[`73`]
  
  inline def OLECMDID_VIEWPORT_MODE: `70` = 70.asInstanceOf[`70`]
  
  inline def OLECMDID_VISUAL_VIEWPORT_EXCLUDE_BOTTOM: `72` = 72.asInstanceOf[`72`]
  
  inline def OLECMDID_WINDOWSTATECHANGED: `65` = 65.asInstanceOf[`65`]
  
  inline def OLECMDID_ZOOM: `19` = 19.asInstanceOf[`19`]
}
