...
package object EventHelperTypes {
  type InternetExplorerBeforeNavigate2ArgNames = js.Tuple7[
    ...
    typings.activexShdocvw.activexShdocvwStrings.TargetFrameName, 
    typings.activexShdocvw.activexShdocvwStrings.PostData, 
  ...
  type ShellNameSpaceFavoritesSelectionChangeArgNames = js.Tuple7[
    ...
    typings.activexShdocvw.activexShdocvwStrings.strName, 
    typings.activexShdocvw.activexShdocvwStrings.strUrl, 
    typings.activexShdocvw.activexShdocvwStrings.cVisits, 
