...
object tagREADYSTATE {
  ...
  inline def READYSTATE_COMPLETE: `4` = 4.asInstanceOf[`4`]
  
  inline def READYSTATE_INTERACTIVE: `3` = 3.asInstanceOf[`3`]
  
  inline def READYSTATE_LOADED: `2` = 2.asInstanceOf[`2`]
  
  inline def READYSTATE_LOADING: `1` = 1.asInstanceOf[`1`]
  
  inline def READYSTATE_UNINITIALIZED: `0` = 0.asInstanceOf[`0`]
}
