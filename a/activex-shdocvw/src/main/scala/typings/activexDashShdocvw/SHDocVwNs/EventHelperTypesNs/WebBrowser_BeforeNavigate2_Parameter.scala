...
trait WebBrowser_BeforeNavigate2_Parameter extends js.Object {
  var Cancel: Boolean
  val Flags: js.Any
  val Headers: js.Any
  val PostData: js.Any
...
object WebBrowser_BeforeNavigate2_Parameter {
  @scala.inline
  def apply(
    Cancel: Boolean,
    Flags: js.Any,
    ...
    URL: js.Any,
    pDisp: js.Any
  ): WebBrowser_BeforeNavigate2_Parameter = {
    ...
    __obj.asInstanceOf[WebBrowser_BeforeNavigate2_Parameter]
  }
}
