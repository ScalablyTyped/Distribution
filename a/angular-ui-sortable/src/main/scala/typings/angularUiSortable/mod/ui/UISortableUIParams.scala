...
object UISortableUIParams {
  ...
  @scala.inline
  implicit class UISortableUIParamsOps[Self <: UISortableUIParams[_], T] (val x: Self with UISortableUIParams[T]) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setItem(value: UISortableUIItem[T]): Self = this.set("item", value.asInstanceOf[js.Any])
    @scala.inline
