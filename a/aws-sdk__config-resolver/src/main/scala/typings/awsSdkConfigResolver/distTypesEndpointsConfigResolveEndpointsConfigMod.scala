...
object distTypesEndpointsConfigResolveEndpointsConfigMod {
  ...
  object EndpointsResolvedConfig {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(endpoint = js.Any.fromFunction0(endpoint), tls = tls.asInstanceOf[js.Any], useDualstackEndpoint = js.Any.fromFunction0(useDualstackEndpoint))
