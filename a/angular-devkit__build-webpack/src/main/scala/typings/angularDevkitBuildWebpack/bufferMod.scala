...
object bufferMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/host/buffer", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/host/buffer", "fileBuffer")
  @js.native
