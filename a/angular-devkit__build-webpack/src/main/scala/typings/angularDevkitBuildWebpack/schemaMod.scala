...
object schemaMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/json/schema", JSImport.Namespace)
  @js.native
  ...
  open class CoreSchemaRegistry ()
    extends typings.angularDevkitBuildWebpack.registryMod.CoreSchemaRegistry {
  ...
  open class SchemaValidationException ()
    extends typings.angularDevkitBuildWebpack.registryMod.SchemaValidationException {
