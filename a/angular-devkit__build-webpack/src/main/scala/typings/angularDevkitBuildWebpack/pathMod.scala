...
import typings.angularDevkitBuildWebpack.anon.PRIVATEDEVKITPATHFRAGMENT
...
object pathMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "InvalidPathException")
  @js.native
  open class InvalidPathException protected () extends BaseException {
    def this(path: String) = this()
  }
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "NormalizedRoot")
  @js.native
  val NormalizedRoot: Path_ = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "NormalizedSep")
  @js.native
  val NormalizedSep: Path_ = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "PathCannotBeFragmentException")
  @js.native
  open class PathCannotBeFragmentException protected () extends BaseException {
    def this(path: String) = this()
  }
  
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "PathMustBeAbsoluteException")
  @js.native
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/path", "path")
  @js.native
