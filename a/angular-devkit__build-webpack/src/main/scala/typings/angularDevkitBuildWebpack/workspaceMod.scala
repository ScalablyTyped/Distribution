...
object workspaceMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/workspace", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src/workspace", "ProjectDefinitionCollection")
  @js.native
  open class ProjectDefinitionCollection ()
    extends typings.angularDevkitBuildWebpack.definitionsMod.ProjectDefinitionCollection {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/workspace", "TargetDefinitionCollection")
  @js.native
  open class TargetDefinitionCollection ()
    extends typings.angularDevkitBuildWebpack.definitionsMod.TargetDefinitionCollection {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/workspace", "WorkspaceFormat")
  @js.native
