...
/* Inlined std.Partial<@angular-devkit/build-webpack.@angular-devkit/build-webpack/core/src/utils.Readwrite<@angular-devkit/build-webpack.@angular-devkit/build-webpack/core/src/experimental/jobs/api.JobDescription>> */
