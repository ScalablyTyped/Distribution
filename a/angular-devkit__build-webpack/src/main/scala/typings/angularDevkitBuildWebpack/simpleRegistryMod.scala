...
import typings.angularDevkitBuildWebpack.anon.RegisterJobOptionsnamestr
...
object simpleRegistryMod {
  
  @JSImport("@angular-devkit/build-webpack/core/src/experimental/jobs/simple-registry", "SimpleJobRegistry")
  @js.native
  ...
  /* Inlined parent std.Partial<@angular-devkit/build-webpack.@angular-devkit/build-webpack/core/src/experimental/jobs/api.JobDescription> */
