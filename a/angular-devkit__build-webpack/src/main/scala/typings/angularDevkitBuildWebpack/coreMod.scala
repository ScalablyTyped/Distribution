...
object coreMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/workspace/core", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @js.native
  sealed trait WorkspaceFormat extends StObject
  @JSImport("@angular-devkit/build-webpack/core/src/workspace/core", "WorkspaceFormat")
  @js.native
