...
object experimentalMod {
  ...
  object jobs {
    ...
    @JSImport("@angular-devkit/build-webpack/core/src/experimental", "jobs")
    @js.native
    ...
    open class ChannelAlreadyExistException protected ()
      extends typings.angularDevkitBuildWebpack.jobsMod.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitBuildWebpack.jobsMod.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.jobsMod.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typings.angularDevkitBuildWebpack.jobsMod.JobDoesNotExistException {
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.jobsMod.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typings.angularDevkitBuildWebpack.jobsMod.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    ...
    open class JobOutputSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.jobsMod.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitBuildWebpack.jobsMod.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typings.angularDevkitBuildWebpack.jobsMod.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
