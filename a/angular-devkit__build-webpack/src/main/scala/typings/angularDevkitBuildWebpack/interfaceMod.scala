...
import typings.angularDevkitBuildWebpack.anon.Label
import typings.angularDevkitBuildWebpack.utilsMod.JsonArray
...
object interfaceMod {
  ...
  trait JsonVisitor extends StObject {
    ...
    def apply(value: JsonValue, pointer: JsonPointer): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
    def apply(value: JsonValue, pointer: JsonPointer, schema: Unit, root: JsonArray): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
    def apply(value: JsonValue, pointer: JsonPointer, schema: Unit, root: JsonObject): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
    def apply(value: JsonValue, pointer: JsonPointer, schema: JsonObject): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
    def apply(value: JsonValue, pointer: JsonPointer, schema: JsonObject, root: JsonArray): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
    def apply(value: JsonValue, pointer: JsonPointer, schema: JsonObject, root: JsonObject): (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<JsonValue> */ Any) | JsonValue = js.native
  }
  ...
  type PromptProvider = js.Function1[
    /* definitions */ js.Array[PromptDefinition], 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify SubscribableOrPromise<{[id: string] : JsonValue}> */ Any
  ]
  ...
  trait SchemaKeywordValidator extends StObject {
    ...
    def apply(
      ...
      pointer: JsonPointer,
      rootData: JsonValue
    ): Boolean | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<boolean> */ Any) = js.native
    def apply(
      data: JsonValue,
      schema: JsonValue,
      parent: Unit,
  ...
  trait SchemaRegistry extends StObject {
    ...
    def compile(schema: js.Object): Any = js.native
    
    def flatten(schema: java.lang.String): Any = js.native
    /**
      ...
      */
    def flatten(schema: JsonObject): Any = js.native
  ...
  trait SchemaValidator extends StObject {
    ...
    def apply(data: JsonValue): Any = js.native
    def apply(data: JsonValue, options: SchemaValidatorOptions): Any = js.native
  }
  ...
  type SmartDefaultProvider[T] = js.Function1[
    /* schema */ JsonObject, 
    T | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Observable<T> */ Any)
  ]
}
