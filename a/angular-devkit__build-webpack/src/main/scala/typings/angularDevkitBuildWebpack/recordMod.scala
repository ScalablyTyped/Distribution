...
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.create
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.delete
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.overwrite
...
object recordMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/virtual-fs/host/record", "CordHost")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularDevkitBuildWebpack.recordMod.CordHostCreate
    - typings.angularDevkitBuildWebpack.recordMod.CordHostOverwrite
    - typings.angularDevkitBuildWebpack.recordMod.CordHostRename
    - typings.angularDevkitBuildWebpack.recordMod.CordHostDelete
  */
  trait CordHostRecord extends StObject
  object CordHostRecord {
    
    inline def CordHostCreate(content: js.typedarray.ArrayBuffer, path: Path_): typings.angularDevkitBuildWebpack.recordMod.CordHostCreate = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], kind = "create", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.recordMod.CordHostCreate]
    }
    
    inline def CordHostDelete(path: Path_): typings.angularDevkitBuildWebpack.recordMod.CordHostDelete = {
      val __obj = js.Dynamic.literal(kind = "delete", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.recordMod.CordHostDelete]
    }
    
    inline def CordHostOverwrite(content: js.typedarray.ArrayBuffer, path: Path_): typings.angularDevkitBuildWebpack.recordMod.CordHostOverwrite = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], kind = "overwrite", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.recordMod.CordHostOverwrite]
    }
    
    inline def CordHostRename(from: Path_, to: Path_): typings.angularDevkitBuildWebpack.recordMod.CordHostRename = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], kind = "rename", to = to.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.recordMod.CordHostRename]
    }
  }
