...
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.comment
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.content
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.escape
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.evaluate
import typings.angularDevkitBuildWebpack.angularDevkitBuildWebpackStrings.interpolate
import typings.angularDevkitBuildWebpack.anon.Exports
...
object templateMod {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src/utils/template", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.angularDevkitBuildWebpack.templateMod.TemplateAstContent
    - typings.angularDevkitBuildWebpack.templateMod.TemplateAstEvaluate
    - typings.angularDevkitBuildWebpack.templateMod.TemplateAstComment
    - typings.angularDevkitBuildWebpack.templateMod.TemplateAstEscape
    - typings.angularDevkitBuildWebpack.templateMod.TemplateAstInterpolate
  */
  trait TemplateAstNode extends StObject
  object TemplateAstNode {
    
    inline def TemplateAstComment(end: Position, start: Position, text: String): typings.angularDevkitBuildWebpack.templateMod.TemplateAstComment = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], kind = "comment", start = start.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.templateMod.TemplateAstComment]
    }
    
    inline def TemplateAstContent(content: String, end: Position, start: Position): typings.angularDevkitBuildWebpack.templateMod.TemplateAstContent = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], end = end.asInstanceOf[js.Any], kind = "content", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.templateMod.TemplateAstContent]
    }
    
    inline def TemplateAstEscape(end: Position, expression: String, start: Position): typings.angularDevkitBuildWebpack.templateMod.TemplateAstEscape = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "escape", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.templateMod.TemplateAstEscape]
    }
    
    inline def TemplateAstEvaluate(end: Position, expression: String, start: Position): typings.angularDevkitBuildWebpack.templateMod.TemplateAstEvaluate = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "evaluate", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.templateMod.TemplateAstEvaluate]
    }
    
    inline def TemplateAstInterpolate(end: Position, expression: String, start: Position): typings.angularDevkitBuildWebpack.templateMod.TemplateAstInterpolate = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "interpolate", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.angularDevkitBuildWebpack.templateMod.TemplateAstInterpolate]
    }
  }
