...
object experimental {
  ...
  object jobs {
    ...
    open class ChannelAlreadyExistException protected ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.JobDoesNotExistException {
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    ...
    open class JobOutputSchemaValidationError ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typings.angularDevkitBuildWebpack.experimentalMod.jobs.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
