...
object schema {
  ...
  @JSImport("@angular-devkit/build-webpack/core/src", "schema")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular-devkit/build-webpack/core/src", "schema.CoreSchemaRegistry")
  @js.native
  open class CoreSchemaRegistry ()
    extends typings.angularDevkitBuildWebpack.jsonMod.schema.CoreSchemaRegistry {
  ...
  object CoreSchemaRegistry {
    ...
    @JSImport("@angular-devkit/build-webpack/core/src", "schema.CoreSchemaRegistry._set")
    @js.native
    def _set: Any = js.native
    inline def _set_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_set")(x.asInstanceOf[js.Any])
  }
  
  @JSImport("@angular-devkit/build-webpack/core/src", "schema.SchemaValidationException")
  @js.native
  open class SchemaValidationException ()
    extends typings.angularDevkitBuildWebpack.jsonMod.schema.SchemaValidationException {
  ...
  object transforms {
    ...
    @JSImport("@angular-devkit/build-webpack/core/src", "schema.transforms")
    @js.native
    val ^ : js.Any = js.native
