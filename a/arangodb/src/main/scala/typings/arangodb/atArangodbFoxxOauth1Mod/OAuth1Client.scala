...
trait OAuth1Client extends js.Object {
  ...
  def createSignedRequest(method: HttpMethod, url: String, parameters: Null, oauth_token: String, oauth_token_secret: String): Anon_Headers = js.native
