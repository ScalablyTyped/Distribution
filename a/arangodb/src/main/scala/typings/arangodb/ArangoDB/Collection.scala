...
import typings.arangodb.Anon_IsSystem
import typings.arangodb.Anon_Limit
...
trait Collection[T /* <: js.Object */] extends js.Object {
  ...
  def drop(options: Anon_IsSystem): Unit = js.native
  // Indexes
  ...
  def replaceByExample(example: Partial[Document[T]], newValue: DocumentData[T], options: Anon_Limit): Double = js.native
