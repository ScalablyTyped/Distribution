...
package object ArangoDB {
  ...
  type Document[T /* <: js.Object */] = typings.arangodb.AnonDictkey with typings.arangodb.arangodbStrings.Document with org.scalablytyped.runtime.TopLevel[T] with typings.arangodb.ArangoDB.DocumentMetadata
  // Collection
