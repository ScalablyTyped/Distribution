...
package object ArangoDB {
  ...
  type Document[T /* <: js.Object */] = typings.arangodb.AnonFrom with typings.arangodb.arangodbStrings.Document with T with typings.arangodb.ArangoDB.DocumentMetadata
  // Collection
  type DocumentCollectionType = typings.arangodb.arangodbNumbers.`2`
  type DocumentData[T /* <: js.Object */] = typings.arangodb.arangodbStrings.DocumentData with T with typings.std.Partial[typings.arangodb.ArangoDB.DocumentMetadata]
  type DocumentIterator[T /* <: js.Object */] = js.Function2[
    /* document */ typings.arangodb.ArangoDB.Document[T], 
    /* number */ scala.Double, 
    scala.Unit
  ]
  type Edge[T /* <: js.Object */] = typings.arangodb.ArangoDB.Document[T] with typings.arangodb.AnonFromTo
