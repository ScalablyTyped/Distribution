...
package object ArangoDBNs {
  ...
  type ErrorName = /* LimitUnionLength: was union type with length 300 */java.lang.String
  ...
  type HttpStatus = /* LimitUnionLength: was union type with length 63 */java.lang.String
