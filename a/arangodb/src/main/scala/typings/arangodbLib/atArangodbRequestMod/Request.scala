...
trait Request extends js.Object {
  @JSName("delete")
  var delete_Original: arangodbLib.Fn_Options = js.native
  @JSName("get")
  var get_Original: arangodbLib.Fn_Options = js.native
  @JSName("head")
  var head_Original: arangodbLib.Fn_Options = js.native
  @JSName("patch")
  var patch_Original: arangodbLib.Fn_Options = js.native
  @JSName("post")
  var post_Original: arangodbLib.Fn_Options = js.native
  @JSName("put")
  var put_Original: arangodbLib.Fn_Options = js.native
