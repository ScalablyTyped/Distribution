...
object generalDashGraphModMembers extends js.Object {
  def _create(name: java.lang.String): Graph with ScalablyTyped.runtime.StringDictionary[js.UndefOr[arangodbLib.ArangoDBNs.Collection[_]]] = js.native
  def _create(name: java.lang.String, edgeDefinitions: js.Array[EdgeDefinition]): Graph with ScalablyTyped.runtime.StringDictionary[js.UndefOr[arangodbLib.ArangoDBNs.Collection[_]]] = js.native
  def _create(
    name: java.lang.String,
    edgeDefinitions: js.Array[EdgeDefinition],
    orphanCollections: js.Array[java.lang.String]
  ): Graph with ScalablyTyped.runtime.StringDictionary[js.UndefOr[arangodbLib.ArangoDBNs.Collection[_]]] = js.native
  ...
  def _graph(name: java.lang.String): Graph with ScalablyTyped.runtime.StringDictionary[js.UndefOr[arangodbLib.ArangoDBNs.Collection[_]]] = js.native
