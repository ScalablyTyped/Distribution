...
@JSImport("@aws-sdk/client-cognito-identity", "ErrorCode")
@js.native
object ErrorCode extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.awsSdkClientCognitoIdentity.models0Mod.ErrorCode with String] = js.native
