...
object runtimeConfigMod {
  ...
  object ClientDefaultValues {
    ...
    inline def base64Decoder(input: String): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("base64Decoder")(input.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
    inline def base64Decoder_=(x: Decoder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("base64Decoder")(x.asInstanceOf[js.Any])
    ...
    inline def base64Encoder(input: Uint8Array): String = ^.asInstanceOf[js.Dynamic].applyDynamic("base64Encoder")(input.asInstanceOf[js.Any]).asInstanceOf[String]
    inline def base64Encoder_=(x: Encoder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("base64Encoder")(x.asInstanceOf[js.Any])
    ...
    inline def bodyLengthChecker(body: js.Any): js.UndefOr[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("bodyLengthChecker")(body.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Double]]
    inline def bodyLengthChecker_=(x: js.Function1[/* body */ js.Any, js.UndefOr[Double]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("bodyLengthChecker")(x.asInstanceOf[js.Any])
    ...
    inline def credentialDefaultProvider(input: js.Any): Provider[Credentials] = ^.asInstanceOf[js.Dynamic].applyDynamic("credentialDefaultProvider")(input.asInstanceOf[js.Any]).asInstanceOf[Provider[Credentials]]
    inline def credentialDefaultProvider_=(x: js.Function1[/* input */ js.Any, Provider[Credentials]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("credentialDefaultProvider")(x.asInstanceOf[js.Any])
    ...
    inline def maxAttempts_=(x: Double | Provider[Double]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("maxAttempts")(x.asInstanceOf[js.Any])
    ...
    inline def region_=(x: String | Provider[String]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("region")(x.asInstanceOf[js.Any])
    ...
    inline def requestHandler_=(x: HttpHandler): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("requestHandler")(x.asInstanceOf[js.Any])
    ...
    inline def sha256_=(x: HashConstructor): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("sha256")(x.asInstanceOf[js.Any])
    ...
    inline def streamCollector(stream: js.Any): js.Promise[Uint8Array] = ^.asInstanceOf[js.Dynamic].applyDynamic("streamCollector")(stream.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Uint8Array]]
    inline def streamCollector_=(x: StreamCollector): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("streamCollector")(x.asInstanceOf[js.Any])
    ...
    inline def urlParser(url: String): Endpoint = ^.asInstanceOf[js.Dynamic].applyDynamic("urlParser")(url.asInstanceOf[js.Any]).asInstanceOf[Endpoint]
    inline def urlParser_=(x: UrlParser): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("urlParser")(x.asInstanceOf[js.Any])
    ...
    inline def utf8Decoder(input: String): Uint8Array = ^.asInstanceOf[js.Dynamic].applyDynamic("utf8Decoder")(input.asInstanceOf[js.Any]).asInstanceOf[Uint8Array]
    inline def utf8Decoder_=(x: Decoder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("utf8Decoder")(x.asInstanceOf[js.Any])
    ...
    inline def utf8Encoder(input: Uint8Array): String = ^.asInstanceOf[js.Dynamic].applyDynamic("utf8Encoder")(input.asInstanceOf[js.Any]).asInstanceOf[String]
    inline def utf8Encoder_=(x: Encoder): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("utf8Encoder")(x.asInstanceOf[js.Any])
  }
}
