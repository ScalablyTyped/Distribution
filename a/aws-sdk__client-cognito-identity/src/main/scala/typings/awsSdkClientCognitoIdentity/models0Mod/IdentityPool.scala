...
object IdentityPool {
  ...
  inline def filterSensitiveLog(obj: IdentityPool): js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("filterSensitiveLog")(obj.asInstanceOf[js.Any]).asInstanceOf[js.Any]
