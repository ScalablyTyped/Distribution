...
object typesPutBucketCorsInputMod {
  ...
  trait PutBucketCorsInput
    ...
    /**
      ...
      */
    var CORSConfiguration: typings.awsSdkClientS3Node.typesCorsconfigurationMod.CORSConfiguration
  ...
  object PutBucketCorsInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketCorsInput] (val x: Self) extends AnyVal {
      ...
      inline def setCORSConfiguration(value: CORSConfiguration): Self = StObject.set(x, "CORSConfiguration", value.asInstanceOf[js.Any])
