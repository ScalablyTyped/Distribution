...
object typesPutBucketCorsInputMod {
  ...
  trait PutBucketCorsInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var CORSConfiguration: typings.awsSdkClientS3Node.typesCorsconfigurationMod.CORSConfiguration = js.native
  ...
  object PutBucketCorsInput {
    ...
    @scala.inline
    implicit class PutBucketCorsInputMutableBuilder[Self <: PutBucketCorsInput] (val x: Self) extends AnyVal {
