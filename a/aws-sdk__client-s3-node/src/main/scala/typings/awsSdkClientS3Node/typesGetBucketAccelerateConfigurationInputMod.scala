...
object typesGetBucketAccelerateConfigurationInputMod {
  
  trait GetBucketAccelerateConfigurationInput
    extends StObject
  ...
  object GetBucketAccelerateConfigurationInput {
    ...
    @scala.inline
    implicit class GetBucketAccelerateConfigurationInputMutableBuilder[Self <: GetBucketAccelerateConfigurationInput] (val x: Self) extends AnyVal {
