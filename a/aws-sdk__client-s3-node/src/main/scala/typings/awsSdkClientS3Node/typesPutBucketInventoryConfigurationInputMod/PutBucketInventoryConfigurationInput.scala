package typings.awsSdkClientS3Node.typesPutBucketInventoryConfigurationInputMod
...
@js.native
trait PutBucketInventoryConfigurationInput extends _InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var InventoryConfiguration: typings.awsSdkClientS3Node.typesInventoryConfigurationMod.InventoryConfiguration = js.native
}
...
object PutBucketInventoryConfigurationInput {
  ...
  @scala.inline
  implicit class PutBucketInventoryConfigurationInputOps[Self <: PutBucketInventoryConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
