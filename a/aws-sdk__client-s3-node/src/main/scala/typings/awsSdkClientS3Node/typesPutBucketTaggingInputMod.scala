...
object typesPutBucketTaggingInputMod {
  ...
  trait PutBucketTaggingInput extends _InputTypesUnion {
    ...
    /**
      * _Tagging shape
      */
    var Tagging: typings.awsSdkClientS3Node.typesTaggingMod.Tagging = js.native
  }
  object PutBucketTaggingInput {
    ...
    @scala.inline
    implicit class PutBucketTaggingInputMutableBuilder[Self <: PutBucketTaggingInput] (val x: Self) extends AnyVal {
