...
object typesPutBucketTaggingInputMod {
  ...
  trait PutBucketTaggingInput
    ...
    /**
      * _Tagging shape
      */
    var Tagging: typings.awsSdkClientS3Node.typesTaggingMod.Tagging
  }
  object PutBucketTaggingInput {
    
    inline def apply(Bucket: String, Tagging: Tagging): PutBucketTaggingInput = {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketTaggingInput] (val x: Self) extends AnyVal {
