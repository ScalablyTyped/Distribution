...
object typesRoutingRuleMod {
  ...
  trait RoutingRule extends StObject {
    ...
    /**
      ...
      */
    var Condition: js.UndefOr[typings.awsSdkClientS3Node.typesConditionMod.Condition] = js.undefined
    ...
    /**
      ...
      */
    var Redirect: typings.awsSdkClientS3Node.typesRedirectMod.Redirect
  }
  object RoutingRule {
