package typings.awsSdkClientS3Node.typesGetBucketAnalyticsConfigurationInputMod
...
@js.native
trait GetBucketAnalyticsConfigurationInput extends _InputTypesUnion {
  /**
...
object GetBucketAnalyticsConfigurationInput {
  ...
  @scala.inline
  implicit class GetBucketAnalyticsConfigurationInputOps[Self <: GetBucketAnalyticsConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
