...
object typesListBucketAnalyticsConfigurationsInputMod {
  
  @js.native
  trait ListBucketAnalyticsConfigurationsInput extends _InputTypesUnion {
  ...
  object ListBucketAnalyticsConfigurationsInput {
    
    @scala.inline
    def apply(Bucket: String): ListBucketAnalyticsConfigurationsInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[ListBucketAnalyticsConfigurationsInput]
    }
    
    @scala.inline
    implicit class ListBucketAnalyticsConfigurationsInputMutableBuilder[Self <: ListBucketAnalyticsConfigurationsInput] (val x: Self) extends AnyVal {
