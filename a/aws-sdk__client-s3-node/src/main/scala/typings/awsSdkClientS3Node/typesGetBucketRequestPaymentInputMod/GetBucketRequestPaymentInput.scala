package typings.awsSdkClientS3Node.typesGetBucketRequestPaymentInputMod
...
@js.native
trait GetBucketRequestPaymentInput extends _InputTypesUnion {
  /**
...
object GetBucketRequestPaymentInput {
  ...
  @scala.inline
  implicit class GetBucketRequestPaymentInputOps[Self <: GetBucketRequestPaymentInput] (val x: Self) extends AnyVal {
    @scala.inline
