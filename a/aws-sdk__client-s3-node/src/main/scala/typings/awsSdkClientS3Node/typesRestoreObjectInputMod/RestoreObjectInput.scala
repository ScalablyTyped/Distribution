package typings.awsSdkClientS3Node.typesRestoreObjectInputMod
...
import typings.awsSdkClientS3Node.typesRestoreRequestMod.RestoreRequest
...
trait RestoreObjectInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var RestoreRequest: js.UndefOr[typings.awsSdkClientS3Node.typesRestoreRequestMod.RestoreRequest] = js.native
  /**
...
object RestoreObjectInput {
  ...
  @scala.inline
  implicit class RestoreObjectInputOps[Self <: RestoreObjectInput] (val x: Self) extends AnyVal {
    @scala.inline
