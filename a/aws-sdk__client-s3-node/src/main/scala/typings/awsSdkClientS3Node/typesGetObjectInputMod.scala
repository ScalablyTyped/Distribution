...
object typesGetObjectInputMod {
  ...
  trait GetObjectInput
    ...
    /**
      ...
      */
    var ResponseExpires: js.UndefOr[Date | String | Double] = js.undefined
  ...
  object GetObjectInput {
    ...
    extension [Self <: GetObjectInput](x: Self) {
      ...
      inline def setResponseExpires(value: Date | String | Double): Self = StObject.set(x, "ResponseExpires", value.asInstanceOf[js.Any])
