package typings.awsSdkClientS3Node.typesDeleteBucketPolicyInputMod
...
object DeleteBucketPolicyInput {
  @scala.inline
  def apply(Bucket: String): DeleteBucketPolicyInput = {
    val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[DeleteBucketPolicyInput]
  }
  @scala.inline
  implicit class DeleteBucketPolicyInputOps[Self <: DeleteBucketPolicyInput] (val x: Self) extends AnyVal {
    @scala.inline
