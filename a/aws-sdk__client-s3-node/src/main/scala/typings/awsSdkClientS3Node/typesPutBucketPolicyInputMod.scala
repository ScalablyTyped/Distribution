...
object typesPutBucketPolicyInputMod {
  ...
  object PutBucketPolicyInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketPolicyInput] (val x: Self) extends AnyVal {
      ...
      inline def setConfirmRemoveSelfBucketAccess(value: Boolean): Self = StObject.set(x, "ConfirmRemoveSelfBucketAccess", value.asInstanceOf[js.Any])
