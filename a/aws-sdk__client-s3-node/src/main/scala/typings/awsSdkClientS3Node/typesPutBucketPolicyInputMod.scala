...
object typesPutBucketPolicyInputMod {
  ...
  object PutBucketPolicyInput {
    ...
    @scala.inline
    implicit class PutBucketPolicyInputMutableBuilder[Self <: PutBucketPolicyInput] (val x: Self) extends AnyVal {
      ...
      @scala.inline
      def setConfirmRemoveSelfBucketAccess(value: Boolean): Self = StObject.set(x, "ConfirmRemoveSelfBucketAccess", value.asInstanceOf[js.Any])
