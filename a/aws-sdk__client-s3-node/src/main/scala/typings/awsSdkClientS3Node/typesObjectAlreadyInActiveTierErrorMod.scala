...
object typesObjectAlreadyInActiveTierErrorMod {
  ...
  object ObjectAlreadyInActiveTierError {
    ...
    extension [Self <: ObjectAlreadyInActiveTierError](x: Self) {
      ...
      inline def setName(value: typings.awsSdkClientS3Node.awsSdkClientS3NodeStrings.ObjectAlreadyInActiveTierError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
