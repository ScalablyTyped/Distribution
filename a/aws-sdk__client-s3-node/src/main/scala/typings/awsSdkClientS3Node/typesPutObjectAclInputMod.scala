...
object typesPutObjectAclInputMod {
  ...
  trait PutObjectAclInput
    ...
    /**
      ...
      */
    var AccessControlPolicy: js.UndefOr[typings.awsSdkClientS3Node.typesAccessControlPolicyMod.AccessControlPolicy] = js.undefined
  ...
  object PutObjectAclInput {
    ...
    @scala.inline
    implicit class PutObjectAclInputMutableBuilder[Self <: PutObjectAclInput] (val x: Self) extends AnyVal {
