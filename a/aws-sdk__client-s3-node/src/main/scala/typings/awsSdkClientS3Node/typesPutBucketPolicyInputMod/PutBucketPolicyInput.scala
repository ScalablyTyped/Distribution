package typings.awsSdkClientS3Node.typesPutBucketPolicyInputMod
...
@js.native
trait PutBucketPolicyInput extends _InputTypesUnion {
  /**
  ...
  /**
    ...
    */
  var ConfirmRemoveSelfBucketAccess: js.UndefOr[Boolean] = js.native
  /**
    * _ContentMD5 shape
    */
...
object PutBucketPolicyInput {
  ...
  @scala.inline
  implicit class PutBucketPolicyInputOps[Self <: PutBucketPolicyInput] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setConfirmRemoveSelfBucketAccess(value: Boolean): Self = this.set("ConfirmRemoveSelfBucketAccess", value.asInstanceOf[js.Any])
    @scala.inline
