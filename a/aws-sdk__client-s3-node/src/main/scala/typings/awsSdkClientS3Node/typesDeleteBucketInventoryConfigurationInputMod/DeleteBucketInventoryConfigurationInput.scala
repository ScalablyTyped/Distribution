package typings.awsSdkClientS3Node.typesDeleteBucketInventoryConfigurationInputMod
...
object DeleteBucketInventoryConfigurationInput {
  ...
  @scala.inline
  implicit class DeleteBucketInventoryConfigurationInputOps[Self <: DeleteBucketInventoryConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
