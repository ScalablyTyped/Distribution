...
object typesPutBucketReplicationInputMod {
  ...
  trait PutBucketReplicationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var ReplicationConfiguration: typings.awsSdkClientS3Node.typesReplicationConfigurationMod.ReplicationConfiguration = js.native
  }
  object PutBucketReplicationInput {
    ...
    @scala.inline
    implicit class PutBucketReplicationInputMutableBuilder[Self <: PutBucketReplicationInput] (val x: Self) extends AnyVal {
