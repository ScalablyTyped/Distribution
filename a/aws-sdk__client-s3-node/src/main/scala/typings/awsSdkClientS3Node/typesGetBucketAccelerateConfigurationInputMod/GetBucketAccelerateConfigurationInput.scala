package typings.awsSdkClientS3Node.typesGetBucketAccelerateConfigurationInputMod
...
@js.native
trait GetBucketAccelerateConfigurationInput extends _InputTypesUnion {
...
object GetBucketAccelerateConfigurationInput {
  ...
  @scala.inline
  implicit class GetBucketAccelerateConfigurationInputOps[Self <: GetBucketAccelerateConfigurationInput] (val x: Self) extends AnyVal {
