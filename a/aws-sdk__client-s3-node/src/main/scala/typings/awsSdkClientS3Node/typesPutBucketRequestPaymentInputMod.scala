...
object typesPutBucketRequestPaymentInputMod {
  ...
  trait PutBucketRequestPaymentInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var RequestPaymentConfiguration: typings.awsSdkClientS3Node.typesRequestPaymentConfigurationMod.RequestPaymentConfiguration = js.native
  }
  object PutBucketRequestPaymentInput {
    ...
    @scala.inline
    implicit class PutBucketRequestPaymentInputMutableBuilder[Self <: PutBucketRequestPaymentInput] (val x: Self) extends AnyVal {
