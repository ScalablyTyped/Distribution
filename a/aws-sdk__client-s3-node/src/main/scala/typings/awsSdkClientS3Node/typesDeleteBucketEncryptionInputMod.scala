...
object typesDeleteBucketEncryptionInputMod {
  
  @js.native
  trait DeleteBucketEncryptionInput extends _InputTypesUnion {
  ...
  object DeleteBucketEncryptionInput {
    ...
    @scala.inline
    implicit class DeleteBucketEncryptionInputMutableBuilder[Self <: DeleteBucketEncryptionInput] (val x: Self) extends AnyVal {
