package typings.awsSdkClientS3Node.typesPutBucketAnalyticsConfigurationInputMod
...
@js.native
trait PutBucketAnalyticsConfigurationInput extends _InputTypesUnion {
  ...
  /**
    ...
    */
  var AnalyticsConfiguration: typings.awsSdkClientS3Node.typesAnalyticsConfigurationMod.AnalyticsConfiguration = js.native
...
object PutBucketAnalyticsConfigurationInput {
  ...
  @scala.inline
  implicit class PutBucketAnalyticsConfigurationInputOps[Self <: PutBucketAnalyticsConfigurationInput] (val x: Self) extends AnyVal {
