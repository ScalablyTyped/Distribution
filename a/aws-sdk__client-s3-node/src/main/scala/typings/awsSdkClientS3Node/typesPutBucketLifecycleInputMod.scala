...
import typings.awsSdkClientS3Node.typesLifecycleConfigurationMod.LifecycleConfiguration
...
object typesPutBucketLifecycleInputMod {
  ...
  trait PutBucketLifecycleInput
    ...
    /**
      ...
      */
    var LifecycleConfiguration: js.UndefOr[typings.awsSdkClientS3Node.typesLifecycleConfigurationMod.LifecycleConfiguration] = js.undefined
  }
  object PutBucketLifecycleInput {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: PutBucketLifecycleInput] (val x: Self) extends AnyVal {
