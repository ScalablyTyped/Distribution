...
object typesPutBucketAccelerateConfigurationInputMod {
  ...
  trait PutBucketAccelerateConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var AccelerateConfiguration: typings.awsSdkClientS3Node.typesAccelerateConfigurationMod.AccelerateConfiguration = js.native
  ...
  object PutBucketAccelerateConfigurationInput {
    ...
    @scala.inline
    implicit class PutBucketAccelerateConfigurationInputMutableBuilder[Self <: PutBucketAccelerateConfigurationInput] (val x: Self) extends AnyVal {
