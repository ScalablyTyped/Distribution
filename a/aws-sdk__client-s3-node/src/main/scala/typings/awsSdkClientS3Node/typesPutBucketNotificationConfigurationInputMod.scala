...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketNotificationConfigurationInput", JSImport.Namespace)
@js.native
object typesPutBucketNotificationConfigurationInputMod extends js.Object {
  @js.native
