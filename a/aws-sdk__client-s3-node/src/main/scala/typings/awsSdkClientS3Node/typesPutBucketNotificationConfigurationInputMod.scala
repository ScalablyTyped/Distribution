...
object typesPutBucketNotificationConfigurationInputMod {
  ...
  trait PutBucketNotificationConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var NotificationConfiguration: typings.awsSdkClientS3Node.typesNotificationConfigurationMod.NotificationConfiguration = js.native
  }
  object PutBucketNotificationConfigurationInput {
    ...
    @scala.inline
    implicit class PutBucketNotificationConfigurationInputMutableBuilder[Self <: PutBucketNotificationConfigurationInput] (val x: Self) extends AnyVal {
