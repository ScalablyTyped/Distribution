...
object typesGetBucketReplicationInputMod {
  ...
  object GetBucketReplicationInput {
    ...
    @scala.inline
    implicit class GetBucketReplicationInputMutableBuilder[Self <: GetBucketReplicationInput] (val x: Self) extends AnyVal {
