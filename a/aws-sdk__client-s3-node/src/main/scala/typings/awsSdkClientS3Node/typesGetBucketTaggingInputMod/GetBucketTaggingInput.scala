package typings.awsSdkClientS3Node.typesGetBucketTaggingInputMod
...
object GetBucketTaggingInput {
  @scala.inline
  def apply(Bucket: String): GetBucketTaggingInput = {
    val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
    __obj.asInstanceOf[GetBucketTaggingInput]
  }
  @scala.inline
  implicit class GetBucketTaggingInputOps[Self <: GetBucketTaggingInput] (val x: Self) extends AnyVal {
    @scala.inline
