package typings.awsSdkClientS3Node.typesGetBucketEncryptionInputMod
...
@js.native
trait GetBucketEncryptionInput extends _InputTypesUnion {
  /**
...
object GetBucketEncryptionInput {
  ...
  @scala.inline
  implicit class GetBucketEncryptionInputOps[Self <: GetBucketEncryptionInput] (val x: Self) extends AnyVal {
    @scala.inline
