package typings.awsSdkClientS3Node.typesDeleteBucketMetricsConfigurationInputMod
...
object DeleteBucketMetricsConfigurationInput {
  ...
  @scala.inline
  implicit class DeleteBucketMetricsConfigurationInputOps[Self <: DeleteBucketMetricsConfigurationInput] (val x: Self) extends AnyVal {
    @scala.inline
