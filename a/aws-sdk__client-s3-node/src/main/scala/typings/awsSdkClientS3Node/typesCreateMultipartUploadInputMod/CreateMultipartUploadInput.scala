package typings.awsSdkClientS3Node.typesCreateMultipartUploadInputMod
...
object CreateMultipartUploadInput {
  ...
  @scala.inline
  implicit class CreateMultipartUploadInputOps[Self <: CreateMultipartUploadInput] (val x: Self) extends AnyVal {
    @scala.inline
