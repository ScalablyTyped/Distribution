package typings.awsSdkClientS3Node.typesGetBucketLifecycleInputMod
...
@js.native
trait GetBucketLifecycleInput extends _InputTypesUnion {
  /**
...
object GetBucketLifecycleInput {
  ...
  @scala.inline
  implicit class GetBucketLifecycleInputOps[Self <: GetBucketLifecycleInput] (val x: Self) extends AnyVal {
    @scala.inline
