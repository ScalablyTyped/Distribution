...
import typings.atAwsDashSdkClientDashS3DashNode.Anon_Hash
...
object S3Configuration {
  ...
  def apply(
    ...
    streamHasher: (/* hashCtor */ typings.atAwsDashSdkTypes.Anon_Hash, Readable) => js.Promise[Uint8Array] = null,
