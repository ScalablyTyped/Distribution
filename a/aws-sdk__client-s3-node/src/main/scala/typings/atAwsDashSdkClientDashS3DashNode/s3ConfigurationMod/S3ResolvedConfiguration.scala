...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify __aws_sdk_types.ClientResolvedConfigurationBase<OutputTypesUnion, _stream.Readable> * / any */ @js.native
trait S3ResolvedConfiguration extends S3Configuration {
  ...
  @JSName("streamCollector")
  def streamCollector_MS3ResolvedConfiguration(stream: Readable): js.Promise[Uint8Array] = js.native
  @JSName("streamHasher")
  def streamHasher_MS3ResolvedConfiguration(hashCtor: typings.atAwsDashSdkTypes.Anon_Hash, stream: Readable): js.Promise[Uint8Array] = js.native
  @JSName("urlParser")
