...
@JSImport("@aws-sdk/client-s3-node/types/RestoreObjectInput", JSImport.Namespace)
@js.native
object typesRestoreObjectInputMod extends js.Object {
  @js.native
  trait RestoreObjectInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var RestoreRequest: js.UndefOr[_RestoreRequest] = js.native
    /**
