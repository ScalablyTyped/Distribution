...
import typings.atAwsDashSdkClientDashS3DashNode.typesGetBucketAccelerateConfigurationInputMod.GetBucketAccelerateConfigurationInput
import typings.atAwsDashSdkClientDashS3DashNode.typesGetBucketAccelerateConfigurationOutputMod.GetBucketAccelerateConfigurationOutput
