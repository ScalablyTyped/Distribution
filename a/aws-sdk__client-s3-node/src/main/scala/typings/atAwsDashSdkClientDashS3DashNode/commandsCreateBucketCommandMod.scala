...
import typings.atAwsDashSdkClientDashS3DashNode.typesCreateBucketInputMod.CreateBucketInput
import typings.atAwsDashSdkClientDashS3DashNode.typesCreateBucketOutputMod.CreateBucketOutput
