...
@JSImport("@aws-sdk/client-s3-node/types/DeleteObjectTaggingInput", JSImport.Namespace)
@js.native
object typesDeleteObjectTaggingInputMod extends js.Object {
  @js.native
  trait DeleteObjectTaggingInput extends _InputTypesUnion {
    /**
