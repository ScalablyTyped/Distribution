...
@JSImport("@aws-sdk/client-s3-node/types/ListBucketMetricsConfigurationsOutput", JSImport.Namespace)
@js.native
object typesListBucketMetricsConfigurationsOutputMod extends js.Object {
  ...
  trait ListBucketMetricsConfigurationsOutput
    ...
    /**
      ...
      */
    var MetricsConfigurationList: js.UndefOr[js.Array[_UnmarshalledMetricsConfiguration]] = js.native
    /**
