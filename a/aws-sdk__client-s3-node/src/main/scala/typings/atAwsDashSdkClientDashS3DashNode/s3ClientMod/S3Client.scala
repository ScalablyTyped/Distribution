package typings.atAwsDashSdkClientDashS3DashNode.s3ClientMod
...
- Dropped / * import warning: QualifyReferences.resolveTypeRef many Couldn't qualify __aws_sdk_types.AWSClient<InputTypesUnion, OutputTypesUnion, _stream.Readable> * / any */ @JSImport("@aws-sdk/client-s3-node/S3Client", "S3Client")
@js.native
