package typings.atAwsDashSdkClientDashS3DashNode.typesDeleteBucketMetricsConfigurationInputMod
...
trait DeleteBucketMetricsConfigurationInput extends _InputTypesUnion {
  /**
