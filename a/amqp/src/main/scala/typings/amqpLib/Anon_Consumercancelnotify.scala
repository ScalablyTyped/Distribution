...
trait Anon_Consumercancelnotify extends js.Object {
  var consumer_cancel_notify: js.UndefOr[scala.Boolean] = js.undefined
}

object Anon_Consumercancelnotify {
  @scala.inline
  def apply(consumer_cancel_notify: js.UndefOr[scala.Boolean] = js.undefined): Anon_Consumercancelnotify = {
