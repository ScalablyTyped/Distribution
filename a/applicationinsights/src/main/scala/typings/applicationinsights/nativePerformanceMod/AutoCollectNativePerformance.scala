...
import typings.applicationinsights.AnonDisabledMetrics
...
object AutoCollectNativePerformance extends js.Object {
  ...
  /**
    ...
    * @memberof AutoCollectNativePerformance
    */
  def parseEnabled(collectExtendedMetrics: Boolean): AnonDisabledMetrics = js.native
  def parseEnabled(collectExtendedMetrics: IDisabledExtendedMetrics): AnonDisabledMetrics = js.native
}
