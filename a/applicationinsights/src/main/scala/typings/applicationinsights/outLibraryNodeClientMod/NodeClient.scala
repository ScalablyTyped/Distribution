package typings.applicationinsights.outLibraryNodeClientMod
...
import typings.applicationinsights.outDeclarationsContractsTelemetryTypesNodeHttpRequestTelemetryMod.NodeHttpRequestTelemetry
...
@js.native
trait NodeClient
  extends typings.applicationinsights.outLibraryTelemetryClientMod.^ {
  /**
