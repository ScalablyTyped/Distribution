package typings.applicationinsights.utilMod

import org.scalablytyped.runtime.StringDictionary
import typings.applicationinsights.AnonCode
...
object ^ extends js.Object {
  ...
  /**
    ...
    */
  def canIncludeCorrelationHeader(client: typings.applicationinsights.telemetryClientMod.^, requestUrl: String): Boolean = js.native
  /**
    * Using JSON.stringify, by default Errors do not serialize to something useful:
    * Simplify a generic Node Error into a simpler map for customDimensions
    * Custom errors can still implement toJSON to override this functionality
    */
  /* protected */ def extractError(err: Error): AnonCode = js.native
  /**
