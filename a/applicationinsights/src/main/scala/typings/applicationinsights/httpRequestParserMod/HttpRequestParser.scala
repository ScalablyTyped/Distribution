package typings.applicationinsights.httpRequestParserMod

import org.scalablytyped.runtime.StringDictionary
import typings.applicationinsights.requestParserMod.RequestParser
import typings.applicationinsights.requestTelemetryMod.RequestTelemetry
...
trait HttpRequestParser extends RequestParser {
  ...
  def getTraceparent(): typings.applicationinsights.traceparentMod.^ = js.native
  def getTracestate(): typings.applicationinsights.tracestateMod.^ = js.native
