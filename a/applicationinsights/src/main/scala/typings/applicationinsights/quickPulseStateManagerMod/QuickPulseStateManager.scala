package typings.applicationinsights.quickPulseStateManagerMod
...
trait QuickPulseStateManager extends js.Object {
  ...
  var config: typings.applicationinsights.configMod.^ = js.native
  var context: typings.applicationinsights.contextMod.^ = js.native
  /**
