...
import typings.applicationinsights.outDeclarationsContractsTelemetryTypesNodeHttpDependencyTelemetryMod.NodeHttpDependencyTelemetry
...
object ^ extends js.Object {
  ...
  def trackRequest(
    ...
    telemetry: NodeHttpDependencyTelemetry
  ): Unit = js.native
}
