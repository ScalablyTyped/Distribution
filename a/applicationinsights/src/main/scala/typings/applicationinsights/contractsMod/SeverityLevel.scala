package typings.applicationinsights.contractsMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("applicationinsights/out/Declarations/Contracts", "SeverityLevel")
@js.native
object SeverityLevel extends js.Object {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typings.applicationinsights.severityLevelMod.SeverityLevel with Double] = js.native
  @js.native
  object SeverityLevel extends js.Object {
    /* 4 */ val Critical: typings.applicationinsights.severityLevelMod.SeverityLevel.Critical with Double = js.native
    /* 3 */ val Error: typings.applicationinsights.severityLevelMod.SeverityLevel.Error with Double = js.native
