package typings
package applicationinsightsLib.outLibraryNodeClientMod
...
trait NodeClient
  ...
  /**
       ...
       */
  def trackNodeHttpDependency(
    telemetry: applicationinsightsLib.outDeclarationsContractsTelemetryTypesNodeHttpDependencyTelemetryMod.NodeHttpDependencyTelemetry
  ...
  /**
       ...
       */
  def trackNodeHttpRequest(
    telemetry: applicationinsightsLib.outDeclarationsContractsTelemetryTypesNodeHttpRequestTelemetryMod.NodeHttpRequestTelemetry
  ): scala.Unit = js.native
  /**
