...
class ^ protected () extends Sender {
  def this(config: applicationinsightsLib.outLibraryConfigMod.^) = this()
  def this(config: applicationinsightsLib.outLibraryConfigMod.^, onSuccess: js.Function1[/* response */ java.lang.String, scala.Unit]) = this()
  def this(config: applicationinsightsLib.outLibraryConfigMod.^, onSuccess: js.Function1[/* response */ java.lang.String, scala.Unit], onError: js.Function1[/* error */ stdLib.Error, scala.Unit]) = this()
}
