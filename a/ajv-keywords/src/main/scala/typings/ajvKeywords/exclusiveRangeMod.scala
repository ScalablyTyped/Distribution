...
object exclusiveRangeMod extends Shortcut {
  
  @JSImport("ajv-keywords/dist/definitions/exclusiveRange", JSImport.Default)
  @js.native
  val default: GetDefinition[MacroKeywordDefinition] = js.native
  
  type _To = GetDefinition[MacroKeywordDefinition]
  
  /* This means you don't have to write `default`, but can instead just say `exclusiveRangeMod.foo` */
