...
class ConnectorFormat protected ()
  extends typings.activexOffice.Office.ConnectorFormat {
  /* CompleteClass */
  ...
  override var OfficeDotConnectorFormat_typekey: typings.activexOffice.Office.ConnectorFormat = js.native
  /* CompleteClass */
