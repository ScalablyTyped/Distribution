...
import typings.activexOffice.Office.MsoSearchIn
...
@js.native
/* private */ open class SearchScope ()
  extends StObject
  ...
  /* CompleteClass */
  override val ScopeFolder: typings.activexOffice.Office.ScopeFolder = js.native
  
  /* CompleteClass */
  override val Type: MsoSearchIn = js.native
}
