...
*/
trait MsoBlackWhiteMode extends StObject
object MsoBlackWhiteMode {
  
  inline def msoBlackWhiteAutomatic: `1` = 1.asInstanceOf[`1`]
  
  inline def msoBlackWhiteBlack: `8` = 8.asInstanceOf[`8`]
  
  inline def msoBlackWhiteBlackTextAndLine: `6` = 6.asInstanceOf[`6`]
  
  inline def msoBlackWhiteDontShow: `10` = 10.asInstanceOf[`10`]
  
  inline def msoBlackWhiteGrayOutline: `5` = 5.asInstanceOf[`5`]
  
  inline def msoBlackWhiteGrayScale: `2` = 2.asInstanceOf[`2`]
  
  inline def msoBlackWhiteHighContrast: `7` = 7.asInstanceOf[`7`]
  
  inline def msoBlackWhiteInverseGrayScale: `4` = 4.asInstanceOf[`4`]
  
  inline def msoBlackWhiteLightGrayScale: `3` = 3.asInstanceOf[`3`]
  
  inline def msoBlackWhiteMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoBlackWhiteWhite: `9` = 9.asInstanceOf[`9`]
}
