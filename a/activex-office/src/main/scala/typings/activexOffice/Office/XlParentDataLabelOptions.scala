...
object XlParentDataLabelOptions {
  ...
  inline def xlParentDataLabelOptionsBanner: `1` = 1.asInstanceOf[`1`]
  
  inline def xlParentDataLabelOptionsNone: `0` = 0.asInstanceOf[`0`]
  
  inline def xlParentDataLabelOptionsOverlapping: `2` = 2.asInstanceOf[`2`]
}
