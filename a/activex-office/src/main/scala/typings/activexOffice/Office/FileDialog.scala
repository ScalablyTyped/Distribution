...
object FileDialog {
  ...
  @scala.inline
  implicit class FileDialogMutableBuilder[Self <: FileDialog] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setDialogType(value: MsoFileDialogType): Self = StObject.set(x, "DialogType", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setExecute(value: () => Unit): Self = StObject.set(x, "Execute", js.Any.fromFunction0(value))
    
    @scala.inline
    def setFilterIndex(value: Double): Self = StObject.set(x, "FilterIndex", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFilters(value: FileDialogFilters): Self = StObject.set(x, "Filters", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialFileName(value: String): Self = StObject.set(x, "InitialFileName", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setInitialView(value: MsoFileDialogView): Self = StObject.set(x, "InitialView", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setItem(value: String): Self = StObject.set(x, "Item", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setOfficeDotFileDialog_typekey(value: FileDialog): Self = StObject.set(x, "Office.FileDialog_typekey", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setParent(value: js.Any): Self = StObject.set(x, "Parent", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setSelectedItems(value: FileDialogSelectedItems): Self = StObject.set(x, "SelectedItems", value.asInstanceOf[js.Any])
