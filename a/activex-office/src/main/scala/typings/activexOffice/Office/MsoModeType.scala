...
*/
trait MsoModeType extends StObject
object MsoModeType {
  
  inline def msoModeAutoDown: `1` = 1.asInstanceOf[`1`]
  
  inline def msoModeModal: `0` = 0.asInstanceOf[`0`]
  
  inline def msoModeModeless: `2` = 2.asInstanceOf[`2`]
}
