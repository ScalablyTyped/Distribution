...
*/
trait ContentVerificationResults extends StObject
object ContentVerificationResults {
  
  inline def contverresError: `0` = 0.asInstanceOf[`0`]
  
  inline def contverresModified: `4` = 4.asInstanceOf[`4`]
  
  inline def contverresUnverified: `2` = 2.asInstanceOf[`2`]
  
  inline def contverresValid: `3` = 3.asInstanceOf[`3`]
  
  inline def contverresVerifying: `1` = 1.asInstanceOf[`1`]
}
