...
object MsoCalloutType {
  ...
  @scala.inline
  def msoCalloutFour: `4` = this.cast(4)
  @scala.inline
  def msoCalloutMixed: `-2` = this.cast(-2)
  @scala.inline
  def msoCalloutOne: `1` = this.cast(1)
  @scala.inline
  def msoCalloutThree: `3` = this.cast(3)
  @scala.inline
  def msoCalloutTwo: `2` = this.cast(2)
}
