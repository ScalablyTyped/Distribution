...
*/
trait EncryptionProviderDetail extends StObject
object EncryptionProviderDetail {
  
  inline def encprovdetAlgorithm: `1` = 1.asInstanceOf[`1`]
  
  inline def encprovdetBlockCipher: `2` = 2.asInstanceOf[`2`]
  
  inline def encprovdetCipherBlockSize: `3` = 3.asInstanceOf[`3`]
  
  inline def encprovdetCipherMode: `4` = 4.asInstanceOf[`4`]
  
  inline def encprovdetUrl: `0` = 0.asInstanceOf[`0`]
}
