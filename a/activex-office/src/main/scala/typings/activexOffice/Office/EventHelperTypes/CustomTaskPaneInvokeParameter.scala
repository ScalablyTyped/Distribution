package typings.activexOffice.Office.EventHelperTypes
...
@js.native
trait CustomTaskPaneInvokeParameter extends js.Object {
...
object CustomTaskPaneInvokeParameter {
  ...
  @scala.inline
  implicit class CustomTaskPaneInvokeParameterOps[Self <: CustomTaskPaneInvokeParameter] (val x: Self) extends AnyVal {
    @scala.inline
