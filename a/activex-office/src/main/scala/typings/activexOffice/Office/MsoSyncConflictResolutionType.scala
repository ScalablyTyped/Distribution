...
*/
trait MsoSyncConflictResolutionType extends StObject
object MsoSyncConflictResolutionType {
  
  @scala.inline
  def msoSyncConflictClientWins: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoSyncConflictMerge: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoSyncConflictServerWins: `1` = 1.asInstanceOf[`1`]
}
