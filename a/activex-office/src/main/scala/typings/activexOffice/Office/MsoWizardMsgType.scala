...
object MsoWizardMsgType {
  ...
  inline def msoWizardMsgLocalStateOff: `2` = 2.asInstanceOf[`2`]
  
  inline def msoWizardMsgLocalStateOn: `1` = 1.asInstanceOf[`1`]
  
  inline def msoWizardMsgResuming: `5` = 5.asInstanceOf[`5`]
  
  inline def msoWizardMsgShowHelp: `3` = 3.asInstanceOf[`3`]
  
  inline def msoWizardMsgSuspending: `4` = 4.asInstanceOf[`4`]
}
