...
object MsoAlertButtonType {
  ...
  inline def msoAlertButtonAbortRetryIgnore: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAlertButtonOK: `0` = 0.asInstanceOf[`0`]
  
  inline def msoAlertButtonOKCancel: `1` = 1.asInstanceOf[`1`]
  
  inline def msoAlertButtonRetryCancel: `5` = 5.asInstanceOf[`5`]
  
  inline def msoAlertButtonYesAllNoCancel: `6` = 6.asInstanceOf[`6`]
  
  inline def msoAlertButtonYesNo: `4` = 4.asInstanceOf[`4`]
  
  inline def msoAlertButtonYesNoCancel: `3` = 3.asInstanceOf[`3`]
}
