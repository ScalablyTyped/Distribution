...
object MsoAutomationSecurity {
  ...
  inline def msoAutomationSecurityByUI: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAutomationSecurityForceDisable: `3` = 3.asInstanceOf[`3`]
  
  inline def msoAutomationSecurityLow: `1` = 1.asInstanceOf[`1`]
}
