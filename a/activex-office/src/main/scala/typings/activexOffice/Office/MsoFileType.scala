...
object MsoFileType {
  ...
  inline def msoFileTypeAllFiles: `1` = 1.asInstanceOf[`1`]
  
  inline def msoFileTypeBinders: `6` = 6.asInstanceOf[`6`]
  
  inline def msoFileTypeCalendarItem: `11` = 11.asInstanceOf[`11`]
  
  inline def msoFileTypeContactItem: `12` = 12.asInstanceOf[`12`]
  
  inline def msoFileTypeDataConnectionFiles: `17` = 17.asInstanceOf[`17`]
  
  inline def msoFileTypeDatabases: `7` = 7.asInstanceOf[`7`]
  
  inline def msoFileTypeDesignerFiles: `22` = 22.asInstanceOf[`22`]
  
  inline def msoFileTypeDocumentImagingFiles: `20` = 20.asInstanceOf[`20`]
  
  inline def msoFileTypeExcelWorkbooks: `4` = 4.asInstanceOf[`4`]
  
  inline def msoFileTypeJournalItem: `14` = 14.asInstanceOf[`14`]
  
  inline def msoFileTypeMailItem: `10` = 10.asInstanceOf[`10`]
  
  inline def msoFileTypeNoteItem: `13` = 13.asInstanceOf[`13`]
  
  inline def msoFileTypeOfficeFiles: `2` = 2.asInstanceOf[`2`]
  
  inline def msoFileTypeOutlookItems: `9` = 9.asInstanceOf[`9`]
  
  inline def msoFileTypePhotoDrawFiles: `16` = 16.asInstanceOf[`16`]
  
  inline def msoFileTypePowerPointPresentations: `5` = 5.asInstanceOf[`5`]
  
  inline def msoFileTypeProjectFiles: `19` = 19.asInstanceOf[`19`]
  
  inline def msoFileTypePublisherFiles: `18` = 18.asInstanceOf[`18`]
  
  inline def msoFileTypeTaskItem: `15` = 15.asInstanceOf[`15`]
  
  inline def msoFileTypeTemplates: `8` = 8.asInstanceOf[`8`]
  
  inline def msoFileTypeVisioFiles: `21` = 21.asInstanceOf[`21`]
  
  inline def msoFileTypeWebPages: `23` = 23.asInstanceOf[`23`]
  
  inline def msoFileTypeWordDocuments: `3` = 3.asInstanceOf[`3`]
}
