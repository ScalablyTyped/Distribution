...
object MsoControlOLEUsage {
  ...
  @scala.inline
  def msoControlOLEUsageBoth: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoControlOLEUsageClient: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoControlOLEUsageNeither: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoControlOLEUsageServer: `1` = 1.asInstanceOf[`1`]
}
