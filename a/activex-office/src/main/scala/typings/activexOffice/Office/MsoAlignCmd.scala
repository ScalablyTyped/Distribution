...
*/
trait MsoAlignCmd extends StObject
object MsoAlignCmd {
  
  inline def msoAlignBottoms: `5` = 5.asInstanceOf[`5`]
  
  inline def msoAlignCenters: `1` = 1.asInstanceOf[`1`]
  
  inline def msoAlignLefts: `0` = 0.asInstanceOf[`0`]
  
  inline def msoAlignMiddles: `4` = 4.asInstanceOf[`4`]
  
  inline def msoAlignRights: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAlignTops: `3` = 3.asInstanceOf[`3`]
}
