...
object CertificateDetail {
  ...
  inline def certdetAvailable: `0` = 0.asInstanceOf[`0`]
  
  inline def certdetExpirationDate: `3` = 3.asInstanceOf[`3`]
  
  inline def certdetIssuer: `2` = 2.asInstanceOf[`2`]
  
  inline def certdetSubject: `1` = 1.asInstanceOf[`1`]
  
  inline def certdetThumbprint: `4` = 4.asInstanceOf[`4`]
}
