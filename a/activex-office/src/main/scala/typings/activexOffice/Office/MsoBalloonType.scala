...
*/
trait MsoBalloonType extends StObject
object MsoBalloonType {
  
  inline def msoBalloonTypeBullets: `1` = 1.asInstanceOf[`1`]
  
  inline def msoBalloonTypeButtons: `0` = 0.asInstanceOf[`0`]
  
  inline def msoBalloonTypeNumbers: `2` = 2.asInstanceOf[`2`]
}
