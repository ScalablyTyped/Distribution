...
object MsoArrowheadWidth {
  ...
  @scala.inline
  def msoArrowheadNarrow: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoArrowheadWide: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoArrowheadWidthMedium: `2` = 2.asInstanceOf[`2`]
  
  @scala.inline
  def msoArrowheadWidthMixed: `-2` = -2.asInstanceOf[`-2`]
}
