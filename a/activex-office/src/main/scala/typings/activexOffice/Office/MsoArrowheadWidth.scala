...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.activexOffice.activexOfficeInts.`-2`
*/
trait MsoArrowheadWidth extends StObject
object MsoArrowheadWidth {
  
  inline def msoArrowheadNarrow: `1` = 1.asInstanceOf[`1`]
  
  inline def msoArrowheadWide: `3` = 3.asInstanceOf[`3`]
  
  inline def msoArrowheadWidthMedium: `2` = 2.asInstanceOf[`2`]
  
  inline def msoArrowheadWidthMixed: `-2` = -2.asInstanceOf[`-2`]
}
