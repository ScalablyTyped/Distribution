...
trait FillFormat extends StObject {
  ...
  /* private */ @JSName("Office.FillFormat_typekey")
  var OfficeDotFillFormat_typekey: FillFormat
...
object FillFormat {
  ...
  inline def apply(
    ...
    OfficeDotFillFormat_typekey: FillFormat,
    ...
    __obj.updateDynamic("Office.FillFormat_typekey")(OfficeDotFillFormat_typekey.asInstanceOf[js.Any])
  ...
  extension [Self <: FillFormat](x: Self) {
    ...
    inline def setOfficeDotFillFormat_typekey(value: FillFormat): Self = StObject.set(x, "Office.FillFormat_typekey", value.asInstanceOf[js.Any])
