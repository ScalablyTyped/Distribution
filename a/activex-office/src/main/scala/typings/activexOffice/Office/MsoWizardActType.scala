...
*/
trait MsoWizardActType extends StObject
object MsoWizardActType {
  
  inline def msoWizardActActive: `1` = 1.asInstanceOf[`1`]
  
  inline def msoWizardActInactive: `0` = 0.asInstanceOf[`0`]
  
  inline def msoWizardActResume: `3` = 3.asInstanceOf[`3`]
  
  inline def msoWizardActSuspend: `2` = 2.asInstanceOf[`2`]
}
