...
object MsoWizardActType {
  ...
  @scala.inline
  def msoWizardActActive: `1` = 1.asInstanceOf[`1`]
  
  @scala.inline
  def msoWizardActInactive: `0` = 0.asInstanceOf[`0`]
  
  @scala.inline
  def msoWizardActResume: `3` = 3.asInstanceOf[`3`]
  
  @scala.inline
  def msoWizardActSuspend: `2` = 2.asInstanceOf[`2`]
}
