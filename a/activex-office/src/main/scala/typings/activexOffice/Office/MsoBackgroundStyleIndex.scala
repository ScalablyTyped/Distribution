...
*/
trait MsoBackgroundStyleIndex extends StObject
object MsoBackgroundStyleIndex {
  
  inline def msoBackgroundStyleMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoBackgroundStyleNotAPreset: `0` = 0.asInstanceOf[`0`]
  
  inline def msoBackgroundStylePreset1: `1` = 1.asInstanceOf[`1`]
  
  inline def msoBackgroundStylePreset10: `10` = 10.asInstanceOf[`10`]
  
  inline def msoBackgroundStylePreset11: `11` = 11.asInstanceOf[`11`]
  
  inline def msoBackgroundStylePreset12: `12` = 12.asInstanceOf[`12`]
  
  inline def msoBackgroundStylePreset2: `2` = 2.asInstanceOf[`2`]
  
  inline def msoBackgroundStylePreset3: `3` = 3.asInstanceOf[`3`]
  
  inline def msoBackgroundStylePreset4: `4` = 4.asInstanceOf[`4`]
  
  inline def msoBackgroundStylePreset5: `5` = 5.asInstanceOf[`5`]
  
  inline def msoBackgroundStylePreset6: `6` = 6.asInstanceOf[`6`]
  
  inline def msoBackgroundStylePreset7: `7` = 7.asInstanceOf[`7`]
  
  inline def msoBackgroundStylePreset8: `8` = 8.asInstanceOf[`8`]
  
  inline def msoBackgroundStylePreset9: `9` = 9.asInstanceOf[`9`]
}
