...
package object EventHelperTypes {
  ...
  type CommandBarButtonInvokeArgNames = js.Tuple8[
    ...
    typings.activexOffice.activexOfficeStrings.lcid, 
    typings.activexOffice.activexOfficeStrings.wFlags, 
    typings.activexOffice.activexOfficeStrings.pdispparams, 
    typings.activexOffice.activexOfficeStrings.pvarResult, 
