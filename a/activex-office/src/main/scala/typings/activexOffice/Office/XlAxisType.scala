...
*/
trait XlAxisType extends StObject
object XlAxisType {
  
  inline def xlCategory: `1` = 1.asInstanceOf[`1`]
  
  inline def xlSeriesAxis: `3` = 3.asInstanceOf[`3`]
  
  inline def xlValue: `2` = 2.asInstanceOf[`2`]
}
