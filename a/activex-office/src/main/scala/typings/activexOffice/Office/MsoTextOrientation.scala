...
object MsoTextOrientation {
  ...
  inline def msoTextOrientationDownward: `3` = 3.asInstanceOf[`3`]
  
  inline def msoTextOrientationHorizontal: `1` = 1.asInstanceOf[`1`]
  
  inline def msoTextOrientationHorizontalRotatedFarEast: `6` = 6.asInstanceOf[`6`]
  
  inline def msoTextOrientationMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoTextOrientationUpward: `2` = 2.asInstanceOf[`2`]
  
  inline def msoTextOrientationVertical: `5` = 5.asInstanceOf[`5`]
  
  inline def msoTextOrientationVerticalFarEast: `4` = 4.asInstanceOf[`4`]
}
