...
trait ShapeRange extends js.Object {
  ...
  val ConnectorFormat: typings.activexDashOffice.Office.ConnectorFormat = js.native
  val Count: Double = js.native
  val Creator: Double = js.native
  val Diagram: IMsoDiagram = js.native
  val DiagramNode: typings.activexDashOffice.Office.DiagramNode = js.native
  ...
  val TextFrame: typings.activexDashOffice.Office.TextFrame = js.native
