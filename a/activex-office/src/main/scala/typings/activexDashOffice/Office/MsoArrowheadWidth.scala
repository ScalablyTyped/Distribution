...
object MsoArrowheadWidth {
  ...
  @scala.inline
  def msoArrowheadNarrow: `1` = this.cast(1)
  @scala.inline
  def msoArrowheadWide: `3` = this.cast(3)
  @scala.inline
  def msoArrowheadWidthMedium: `2` = this.cast(2)
  @scala.inline
  def msoArrowheadWidthMixed: `-2` = this.cast(-2)
}
