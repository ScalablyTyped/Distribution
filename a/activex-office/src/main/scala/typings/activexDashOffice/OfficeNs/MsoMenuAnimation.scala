...
object MsoMenuAnimation {
  ...
  @scala.inline
  def msoMenuAnimationNone: `0` = this.cast(0)
  @scala.inline
  def msoMenuAnimationRandom: `1` = this.cast(1)
  @scala.inline
  def msoMenuAnimationSlide: `3` = this.cast(3)
  @scala.inline
  def msoMenuAnimationUnfold: `2` = this.cast(2)
}
