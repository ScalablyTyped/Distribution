...
class SignatureInfo protected () extends js.Object {
  ...
  val CertificateVerificationResults: typings.activexDashOffice.OfficeNs.CertificateVerificationResults = js.native
  val ContentVerificationResults: typings.activexDashOffice.OfficeNs.ContentVerificationResults = js.native
