...
class OfficeTheme protected () extends js.Object {
  ...
  val ThemeEffectScheme: typings.activexDashOffice.OfficeNs.ThemeEffectScheme = js.native
  val ThemeFontScheme: typings.activexDashOffice.OfficeNs.ThemeFontScheme = js.native
