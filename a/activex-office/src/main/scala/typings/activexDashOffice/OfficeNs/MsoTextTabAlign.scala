...
object MsoTextTabAlign {
  ...
  @scala.inline
  def msoTabAlignCenter: `1` = this.cast(1)
  @scala.inline
  def msoTabAlignDecimal: `3` = this.cast(3)
  @scala.inline
  def msoTabAlignLeft: `0` = this.cast(0)
  @scala.inline
  def msoTabAlignMixed: `-2` = this.cast(-2)
  @scala.inline
  def msoTabAlignRight: `2` = this.cast(2)
}
