...
trait CustomXMLParts_Invoke_Parameter extends js.Object {
...
object CustomXMLParts_Invoke_Parameter {
  @scala.inline
  def apply(
    dispidMember: Double,
    lcid: Double,
    ...
    riid: GUID,
    wFlags: Double
  ): CustomXMLParts_Invoke_Parameter = {
    ...
    __obj.asInstanceOf[CustomXMLParts_Invoke_Parameter]
  }
}
