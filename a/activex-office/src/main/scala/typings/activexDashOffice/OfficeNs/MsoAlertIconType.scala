...
object MsoAlertIconType {
  ...
  @scala.inline
  def msoAlertIconCritical: `1` = this.cast(1)
  @scala.inline
  def msoAlertIconInfo: `4` = this.cast(4)
  @scala.inline
  def msoAlertIconNoIcon: `0` = this.cast(0)
  @scala.inline
  def msoAlertIconQuery: `2` = this.cast(2)
  @scala.inline
  def msoAlertIconWarning: `3` = this.cast(3)
}
