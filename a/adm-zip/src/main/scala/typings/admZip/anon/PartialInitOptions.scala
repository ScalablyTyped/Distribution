...
trait PartialInitOptions extends StObject {
  ...
  var method: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62 */ Any
  ] = js.undefined
...
object PartialInitOptions {
  ...
  extension [Self <: PartialInitOptions](x: Self) {
    ...
    inline def setMethod(value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 62 */ Any): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
