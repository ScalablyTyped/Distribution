...
import typings.apolloDashServer.Anon_Cors
import typings.apolloDashServerDashExpress.distApolloServerMod.ApolloServerExpressConfig
...
class ApolloServer protected ()
  extends typings.apolloDashServerDashExpress.apolloDashServerDashExpressMod.ApolloServer {
  def this(config: ApolloServerExpressConfig with Anon_Cors) = this()
