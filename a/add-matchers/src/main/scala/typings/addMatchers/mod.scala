...
object mod {
  ...
  object default {
    ...
    @scala.inline
    def apply(matchersByName: MatchersByName): Unit = ^.asInstanceOf[js.Dynamic].apply(matchersByName.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    @scala.inline
    def asymmetric(matchersByName: MatchersByName): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("asymmetric")(matchersByName.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  object AdapterGetters {
    ...
    @scala.inline
    implicit class AdapterGettersMutableBuilder[Self <: AdapterGetters] (val x: Self) extends AnyVal {
      
      @scala.inline
      def setGetJasmineV1Adapter(value: js.Any): Self = StObject.set(x, "getJasmineV1Adapter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGetJasmineV2Adapter(value: js.Any): Self = StObject.set(x, "getJasmineV2Adapter", value.asInstanceOf[js.Any])
      
      @scala.inline
      def setGetJestAdapter(value: js.Any): Self = StObject.set(x, "getJestAdapter", value.asInstanceOf[js.Any])
    }
  }
    ...
    object NodeJS {
      ...
      object Global {
        ...
        implicit class GlobalMutableBuilder[Self <: Global] (val x: Self) extends AnyVal {
          ...
          @scala.inline
          def setAny(value: StringDictionary[js.Any]): Self = StObject.set(x, "any", value.asInstanceOf[js.Any])
        }
      }
    }
  }
