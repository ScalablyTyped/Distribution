...
object CustomizationDefinition {
  ...
  @scala.inline
  def ConfigCustomizationDefinition(configuration: ConfigurationDefinition): typings.awsSdkBuildTypes.customizationMod.ConfigCustomizationDefinition = {
  ...
  @scala.inline
  def MiddlewareCustomizationDefinition(expression: String, priority: Double, step: Step): typings.awsSdkBuildTypes.customizationMod.MiddlewareCustomizationDefinition = {
  ...
  @scala.inline
  def ParameterSuppressionCustomizationDefinition(location: input | output, name: String): typings.awsSdkBuildTypes.customizationMod.ParameterSuppressionCustomizationDefinition = {
  ...
  @scala.inline
  def ParserDecoratorCustomizationDefinition(expression: String, priority: Double): typings.awsSdkBuildTypes.customizationMod.ParserDecoratorCustomizationDefinition = {
  ...
  @scala.inline
  def SyntheticParameterCustomizationDefinition(documentation: String, location: input | output, name: String, typeExpression: String): typings.awsSdkBuildTypes.customizationMod.SyntheticParameterCustomizationDefinition = {
