...
object Shape {
  ...
  inline def Long(): typings.awsSdkBuildTypes.apiModelMod.Long = {
    val __obj = js.Dynamic.literal()
  ...
  inline def Short(): typings.awsSdkBuildTypes.apiModelMod.Short = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("short")
    __obj.asInstanceOf[typings.awsSdkBuildTypes.apiModelMod.Short]
  }
  
  inline def String(): typings.awsSdkBuildTypes.apiModelMod.String = {
    val __obj = js.Dynamic.literal()
  ...
  inline def Timestamp(): typings.awsSdkBuildTypes.apiModelMod.Timestamp = {
    val __obj = js.Dynamic.literal()
