...
@JSImport("@angular/common/src/location/location_strategy", "LocationStrategy")
@js.native
abstract class LocationStrategy () extends js.Object {
  ...
  def onPopState(fn: atAngularCommonLib.srcLocationPlatformUnderscoreLocationMod.LocationChangeListener): scala.Unit = js.native
