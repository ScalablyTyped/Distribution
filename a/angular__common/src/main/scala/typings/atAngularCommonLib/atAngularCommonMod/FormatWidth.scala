...
object FormatWidth extends js.Object {
  ...
  @js.native
  sealed trait Full
    extends atAngularCommonLib.atAngularCommonMod.FormatWidth
  ...
  @JSBracketAccess
  def apply(value: scala.Double): js.UndefOr[atAngularCommonLib.atAngularCommonMod.FormatWidth with scala.Double] = js.native
}
