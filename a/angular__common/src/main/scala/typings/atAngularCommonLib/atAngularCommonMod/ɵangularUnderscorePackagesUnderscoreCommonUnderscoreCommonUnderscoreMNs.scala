...
@JSImport("@angular/common", "ɵangular_packages_common_common_m")
@js.native
object ɵangularUnderscorePackagesUnderscoreCommonUnderscoreCommonUnderscoreMNs extends js.Object {
  @js.native
  class provide ()
