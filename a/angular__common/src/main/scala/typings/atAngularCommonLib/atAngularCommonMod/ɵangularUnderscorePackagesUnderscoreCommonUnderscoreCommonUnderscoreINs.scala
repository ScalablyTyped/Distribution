...
@JSImport("@angular/common", "ɵangular_packages_common_common_i")
@js.native
object ɵangularUnderscorePackagesUnderscoreCommonUnderscoreCommonUnderscoreINs extends js.Object {
  @js.native
  class provide ()
