...
@JSImport("@angular/common", "ɵangular_packages_common_common_l")
@js.native
object ɵangularUnderscorePackagesUnderscoreCommonUnderscoreCommonUnderscoreLNs extends js.Object {
  @js.native
  class provide ()
