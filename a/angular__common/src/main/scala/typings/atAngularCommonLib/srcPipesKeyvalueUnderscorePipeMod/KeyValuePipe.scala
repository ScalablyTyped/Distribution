...
class KeyValuePipe protected ()
  ...
  def transform[V](input: nodeLib.Map[scala.Double | java.lang.String, V]): js.Array[KeyValue[java.lang.String, V]] = js.native
  def transform[V](
    input: nodeLib.Map[scala.Double | java.lang.String, V],
  ...
  @JSName("transform")
  def transform_KV[K, V](input: nodeLib.Map[K, V]): js.Array[KeyValue[K, V]] = js.native
  @JSName("transform")
  def transform_KV[K, V](
    input: nodeLib.Map[K, V],
    compareFn: js.Function2[/* a */ KeyValue[K, V], /* b */ KeyValue[K, V], scala.Double]
