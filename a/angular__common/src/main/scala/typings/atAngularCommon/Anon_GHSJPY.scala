...
trait Anon_GHSJPY extends js.Object {
...
object Anon_GHSJPY {
  @scala.inline
  def apply(GHS: js.Array[String], JPY: js.Array[String], NGN: js.Array[String], USD: js.Array[String]): Anon_GHSJPY = {
    ...
    __obj.asInstanceOf[Anon_GHSJPY]
  }
}
