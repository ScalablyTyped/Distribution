...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
