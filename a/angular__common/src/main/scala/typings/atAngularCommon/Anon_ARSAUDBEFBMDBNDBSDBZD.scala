...
trait Anon_ARSAUDBEFBMDBNDBSDBZD extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZD {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZD]
  }
}
