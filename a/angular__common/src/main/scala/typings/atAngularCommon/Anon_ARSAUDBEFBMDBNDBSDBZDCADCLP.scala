...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLP extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLP = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLP]
  }
}
