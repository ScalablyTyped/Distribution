...
trait AnonArraybufferBodyEvents extends js.Object {
...
object AnonArraybufferBodyEvents {
  @scala.inline
  def apply(
    observe: events,
    ...
    __obj.asInstanceOf[AnonArraybufferBodyEvents]
  }
}
