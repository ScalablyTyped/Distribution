...
trait AnonARSAUDBEFBMDBNDBSDBZD extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZD {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZD]
  }
}
