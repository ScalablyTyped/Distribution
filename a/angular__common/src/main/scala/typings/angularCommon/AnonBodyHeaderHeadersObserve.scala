...
trait AnonBodyHeaderHeadersObserve extends js.Object {
...
object AnonBodyHeaderHeadersObserve {
  @scala.inline
  def apply(
    responseType: text,
    ...
    __obj.asInstanceOf[AnonBodyHeaderHeadersObserve]
  }
}
