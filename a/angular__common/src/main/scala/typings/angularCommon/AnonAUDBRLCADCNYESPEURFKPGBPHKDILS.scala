...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKDILS extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKDILS {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKDILS = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKDILS]
  }
}
