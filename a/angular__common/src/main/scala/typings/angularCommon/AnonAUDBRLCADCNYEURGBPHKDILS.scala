...
trait AnonAUDBRLCADCNYEURGBPHKDILS extends js.Object {
...
object AnonAUDBRLCADCNYEURGBPHKDILS {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYEURGBPHKDILS]
  }
}
