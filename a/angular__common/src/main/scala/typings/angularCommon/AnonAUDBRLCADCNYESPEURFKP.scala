...
trait AnonAUDBRLCADCNYESPEURFKP extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKP {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKP]
  }
}
