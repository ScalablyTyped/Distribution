...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINR extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINR {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINR = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINR]
  }
}
