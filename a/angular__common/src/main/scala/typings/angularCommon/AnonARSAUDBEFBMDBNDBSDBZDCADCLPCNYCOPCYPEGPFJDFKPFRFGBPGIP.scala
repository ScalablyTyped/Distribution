...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBPGIP extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBPGIP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBPGIP = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBPGIP]
  }
}
