...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPY]
  }
}
