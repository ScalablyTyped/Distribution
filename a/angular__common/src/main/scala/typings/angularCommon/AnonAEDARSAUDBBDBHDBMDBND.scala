...
trait AnonAEDARSAUDBBDBHDBMDBND extends js.Object {
...
object AnonAEDARSAUDBBDBHDBMDBND {
  @scala.inline
  def apply(
    AED: js.Array[String],
    ...
    __obj.asInstanceOf[AnonAEDARSAUDBBDBHDBMDBND]
  }
}
