...
trait AnonArraybufferBodyHeader extends js.Object {
...
object AnonArraybufferBodyHeader {
  @scala.inline
  def apply(
    observe: response,
    ...
    __obj.asInstanceOf[AnonArraybufferBodyHeader]
  }
}
