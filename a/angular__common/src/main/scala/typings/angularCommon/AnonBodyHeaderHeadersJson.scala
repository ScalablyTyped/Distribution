...
trait AnonBodyHeaderHeadersJson extends js.Object {
...
object AnonBodyHeaderHeadersJson {
  @scala.inline
  def apply(
    observe: response,
    body: js.Any = null,
    ...
    __obj.asInstanceOf[AnonBodyHeaderHeadersJson]
  }
}
