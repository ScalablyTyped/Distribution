...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN]
  }
}
