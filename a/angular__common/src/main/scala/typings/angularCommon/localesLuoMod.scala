...
object localesLuoMod extends Shortcut {
  
  @JSImport("@angular/common/locales/luo", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesLuoMod.foo` */
