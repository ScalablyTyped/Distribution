...
object localesLuyMod extends Shortcut {
  
  @JSImport("@angular/common/locales/luy", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesLuyMod.foo` */
