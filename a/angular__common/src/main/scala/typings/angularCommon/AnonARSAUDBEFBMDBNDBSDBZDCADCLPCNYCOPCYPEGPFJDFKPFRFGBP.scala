...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRFGBP]
  }
}
