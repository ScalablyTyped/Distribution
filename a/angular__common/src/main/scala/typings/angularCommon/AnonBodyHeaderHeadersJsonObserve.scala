...
trait AnonBodyHeaderHeadersJsonObserve extends js.Object {
...
object AnonBodyHeaderHeadersJsonObserve {
  @scala.inline
  def apply(
    body: js.Any = null,
  ...
  ): AnonBodyHeaderHeadersJsonObserve = {
    ...
    __obj.asInstanceOf[AnonBodyHeaderHeadersJsonObserve]
  }
}
