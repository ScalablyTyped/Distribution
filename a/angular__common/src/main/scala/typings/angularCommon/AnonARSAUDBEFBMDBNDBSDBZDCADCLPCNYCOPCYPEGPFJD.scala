...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJD]
  }
}
