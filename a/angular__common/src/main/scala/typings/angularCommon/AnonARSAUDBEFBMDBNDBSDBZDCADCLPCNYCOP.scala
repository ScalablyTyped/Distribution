...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOP]
  }
}
