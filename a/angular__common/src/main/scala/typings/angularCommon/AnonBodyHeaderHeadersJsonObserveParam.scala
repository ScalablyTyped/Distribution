...
trait AnonBodyHeaderHeadersJsonObserveParam extends js.Object {
...
object AnonBodyHeaderHeadersJsonObserveParam {
  @scala.inline
  def apply(
  ...
  ): AnonBodyHeaderHeadersJsonObserveParam = {
    ...
    __obj.asInstanceOf[AnonBodyHeaderHeadersJsonObserveParam]
  }
}
