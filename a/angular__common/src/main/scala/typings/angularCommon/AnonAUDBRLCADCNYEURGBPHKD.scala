...
trait AnonAUDBRLCADCNYEURGBPHKD extends js.Object {
...
object AnonAUDBRLCADCNYEURGBPHKD {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYEURGBPHKD]
  }
}
