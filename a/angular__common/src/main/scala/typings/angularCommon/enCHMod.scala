...
object enCHMod extends Shortcut {
  
  @JSImport("@angular/common/locales/en-CH", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `enCHMod.foo` */
