...
object localesEnKEMod extends Shortcut {
  
  @JSImport("@angular/common/locales/en-KE", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesEnKEMod.foo` */
