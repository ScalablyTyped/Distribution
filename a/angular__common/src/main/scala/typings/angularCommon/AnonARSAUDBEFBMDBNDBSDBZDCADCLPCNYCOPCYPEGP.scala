...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGP]
  }
}
