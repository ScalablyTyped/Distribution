...
object AUDBBD {
  ...
  extension [Self <: AUDBBD](x: Self) {
    ...
    inline def setBRLVarargs(value: String*): Self = StObject.set(x, "BRL", js.Array(value*))
    ...
    inline def setDOPVarargs(value: String*): Self = StObject.set(x, "DOP", js.Array(value*))
    ...
    inline def setESPVarargs(value: scala.Nothing*): Self = StObject.set(x, "ESP", js.Array(value*))
    ...
    inline def setIEPVarargs(value: String*): Self = StObject.set(x, "IEP", js.Array(value*))
    ...
    inline def setISKVarargs(value: String*): Self = StObject.set(x, "ISK", js.Array(value*))
