...
trait ContextHeaders extends StObject {
...
object ContextHeaders {
  ...
  inline def apply(): ContextHeaders = {
    val __obj = js.Dynamic.literal(observe = "response", responseType = "text")
    __obj.asInstanceOf[ContextHeaders]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ContextHeaders] (val x: Self) extends AnyVal {
