...
object UYU {
  ...
  implicit open class MutableBuilder[Self <: UYU] (val x: Self) extends AnyVal {
    ...
    inline def setUYW(value: js.Array[String]): Self = StObject.set(x, "UYW", value.asInstanceOf[js.Any])
    
    inline def setUYWVarargs(value: String*): Self = StObject.set(x, "UYW", js.Array(value*))
