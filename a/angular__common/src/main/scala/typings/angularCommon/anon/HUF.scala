...
object HUF {
  ...
  @scala.inline
  implicit class HUFMutableBuilder[Self <: HUF] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setHUF(value: js.Array[String]): Self = StObject.set(x, "HUF", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setHUFVarargs(value: String*): Self = StObject.set(x, "HUF", js.Array(value :_*))
