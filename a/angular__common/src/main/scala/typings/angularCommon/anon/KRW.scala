...
object KRW {
  ...
  implicit open class MutableBuilder[Self <: KRW] (val x: Self) extends AnyVal {
    ...
    inline def setCUP(value: js.Array[String]): Self = StObject.set(x, "CUP", value.asInstanceOf[js.Any])
    
    inline def setCUPVarargs(value: String*): Self = StObject.set(x, "CUP", js.Array(value*))
