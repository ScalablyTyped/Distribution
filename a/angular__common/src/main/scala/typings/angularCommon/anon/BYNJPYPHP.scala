...
trait BYNJPYPHP extends StObject {
...
object BYNJPYPHP {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any])
    __obj.asInstanceOf[BYNJPYPHP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BYNJPYPHP] (val x: Self) extends AnyVal {
