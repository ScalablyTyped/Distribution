...
object MDL {
  ...
  @scala.inline
  implicit class MDLMutableBuilder[Self <: MDL] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMDL(value: js.Array[String]): Self = StObject.set(x, "MDL", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMDLVarargs(value: String*): Self = StObject.set(x, "MDL", js.Array(value :_*))
