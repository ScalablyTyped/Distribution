...
object VEF {
  ...
  implicit open class MutableBuilder[Self <: VEF] (val x: Self) extends AnyVal {
    ...
    inline def setVEF(value: js.Array[String]): Self = StObject.set(x, "VEF", value.asInstanceOf[js.Any])
    
    inline def setVEFVarargs(value: String*): Self = StObject.set(x, "VEF", js.Array(value*))
