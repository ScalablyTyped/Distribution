...
object VEF {
  ...
  extension [Self <: VEF](x: Self) {
    ...
    inline def setVEFVarargs(value: String*): Self = StObject.set(x, "VEF", js.Array(value :_*))
    
    inline def setVES(value: js.Array[String]): Self = StObject.set(x, "VES", value.asInstanceOf[js.Any])
    
    inline def setVESVarargs(value: String*): Self = StObject.set(x, "VES", js.Array(value :_*))
