...
object HRK {
  ...
  extension [Self <: HRK](x: Self) {
    ...
    inline def setHRKVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "HRK", js.Array(value :_*))
    ...
    inline def setKGSVarargs(value: String*): Self = StObject.set(x, "KGS", js.Array(value :_*))
