...
object NIO {
  ...
  implicit open class MutableBuilder[Self <: NIO] (val x: Self) extends AnyVal {
    ...
    inline def setNIO(value: js.Array[String]): Self = StObject.set(x, "NIO", value.asInstanceOf[js.Any])
    
    inline def setNIOVarargs(value: String*): Self = StObject.set(x, "NIO", js.Array(value*))
