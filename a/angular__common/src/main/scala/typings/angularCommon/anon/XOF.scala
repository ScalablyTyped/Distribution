...
object XOF {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BYN = BYN.asInstanceOf[js.Any], GHS = GHS.asInstanceOf[js.Any], GNF = GNF.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], NGN = NGN.asInstanceOf[js.Any], PGK = PGK.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], XAF = XAF.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any])
    __obj.asInstanceOf[XOF]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: XOF] (val x: Self) extends AnyVal {
