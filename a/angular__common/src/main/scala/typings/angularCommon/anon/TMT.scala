...
object TMT {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BYN = BYN.asInstanceOf[js.Any], GEL = GEL.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], RUB = RUB.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TMT = TMT.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], UAH = UAH.asInstanceOf[js.Any], XXX = XXX.asInstanceOf[js.Any])
    __obj.asInstanceOf[TMT]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TMT] (val x: Self) extends AnyVal {
    
    inline def setBYN(value: js.Array[String]): Self = StObject.set(x, "BYN", value.asInstanceOf[js.Any])
    
    inline def setBYNVarargs(value: String*): Self = StObject.set(x, "BYN", js.Array(value*))
    ...
    inline def setTMTVarargs(value: String*): Self = StObject.set(x, "TMT", js.Array(value*))
    ...
    inline def setUAHVarargs(value: String*): Self = StObject.set(x, "UAH", js.Array(value*))
    
    inline def setXXX(value: js.Array[String]): Self = StObject.set(x, "XXX", value.asInstanceOf[js.Any])
    
    inline def setXXXVarargs(value: String*): Self = StObject.set(x, "XXX", js.Array(value*))
  }
}
