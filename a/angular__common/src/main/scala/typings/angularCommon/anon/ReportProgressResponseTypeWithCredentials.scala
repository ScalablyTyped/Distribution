...
object ReportProgressResponseTypeWithCredentials {
  ...
  inline def apply(): ReportProgressResponseTypeWithCredentials = {
    val __obj = js.Dynamic.literal(observe = "events")
    __obj.asInstanceOf[ReportProgressResponseTypeWithCredentials]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
