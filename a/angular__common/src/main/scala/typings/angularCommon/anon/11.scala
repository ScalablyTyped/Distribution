...
object `11` {
  ...
  inline def apply(): `11` = {
    val __obj = js.Dynamic.literal(alias = "ngForTrackBy", required = false)
  ...
  implicit open class MutableBuilder[Self <: `11`] (val x: Self) extends AnyVal {
    ...
    inline def setAlias(value: ngForTrackBy): Self = StObject.set(x, "alias", value.asInstanceOf[js.Any])
