...
object STD {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BDT = BDT.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], STD = STD.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any])
  ...
  extension [Self <: STD](x: Self) {
    ...
    inline def setSTDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "STD", js.Array(value*))
