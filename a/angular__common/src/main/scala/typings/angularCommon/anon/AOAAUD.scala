...
object AOAAUD {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AOA = AOA.asInstanceOf[js.Any], AUD = AUD.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], PTE = PTE.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any])
    __obj.asInstanceOf[AOAAUD]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AOAAUD] (val x: Self) extends AnyVal {
    ...
    inline def setPTEVarargs(value: String*): Self = StObject.set(x, "PTE", js.Array(value*))
