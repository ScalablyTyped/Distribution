...
object AUDBRL {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BRL = BRL.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], CNY = CNY.asInstanceOf[js.Any], EUR = EUR.asInstanceOf[js.Any], GBP = GBP.asInstanceOf[js.Any], HKD = HKD.asInstanceOf[js.Any], HRK = HRK.asInstanceOf[js.Any], ILS = ILS.asInstanceOf[js.Any], INR = INR.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KRW = KRW.asInstanceOf[js.Any], MXN = MXN.asInstanceOf[js.Any], NZD = NZD.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RUR = RUR.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], VND = VND.asInstanceOf[js.Any], XCD = XCD.asInstanceOf[js.Any], XPF = XPF.asInstanceOf[js.Any], XXX = XXX.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: AUDBRL] (val x: Self) extends AnyVal {
    ...
    inline def setHRK(value: js.Array[String]): Self = StObject.set(x, "HRK", value.asInstanceOf[js.Any])
    
    inline def setHRKVarargs(value: String*): Self = StObject.set(x, "HRK", js.Array(value*))
