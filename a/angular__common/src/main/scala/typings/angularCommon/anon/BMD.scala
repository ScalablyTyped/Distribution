...
trait BMD extends js.Object {
  ...
  var KMF: js.Array[String] = js.native
...
object BMD {
  ...
  @scala.inline
  implicit class BMDOps[Self <: BMD] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setKMFVarargs(value: String*): Self = this.set("KMF", js.Array(value :_*))
    
    @scala.inline
    def setKMF(value: js.Array[String]): Self = this.set("KMF", value.asInstanceOf[js.Any])
