...
object HeadersObserveParamsReportProgressResponseTypeWithCredentials {
  ...
  inline def apply(): HeadersObserveParamsReportProgressResponseTypeWithCredentials = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: HeadersObserveParamsReportProgressResponseTypeWithCredentials] (val x: Self) extends AnyVal {
