...
object RON {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AZN = AZN.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: RON] (val x: Self) extends AnyVal {
    ...
    inline def setAZNVarargs(value: String*): Self = StObject.set(x, "AZN", js.Array(value*))
