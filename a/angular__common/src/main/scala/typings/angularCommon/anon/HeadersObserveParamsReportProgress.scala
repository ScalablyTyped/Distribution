...
object HeadersObserveParamsReportProgress {
  ...
  inline def apply(): HeadersObserveParamsReportProgress = {
    val __obj = js.Dynamic.literal(observe = "response", responseType = "text")
    __obj.asInstanceOf[HeadersObserveParamsReportProgress]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: HeadersObserveParamsReportProgress] (val x: Self) extends AnyVal {
