...
object RONUSD {
  ...
  @scala.inline
  implicit class RONUSDOps[Self <: RONUSD] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setRONVarargs(value: String*): Self = this.set("RON", js.Array(value :_*))
    @scala.inline
    def setRON(value: js.Array[String]): Self = this.set("RON", value.asInstanceOf[js.Any])
    @scala.inline
