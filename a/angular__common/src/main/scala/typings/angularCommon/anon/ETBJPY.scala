...
object ETBJPY {
  ...
  inline def apply(ETB: js.Array[String], JPY: js.Array[String], USD: js.Array[String]): ETBJPY = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: ETBJPY] (val x: Self) extends AnyVal {
