...
@js.native
trait ParamsReportProgressResponseType extends js.Object {
...
object ParamsReportProgressResponseType {
  ...
  @scala.inline
  implicit class ParamsReportProgressResponseTypeOps[Self <: ParamsReportProgressResponseType] (val x: Self) extends AnyVal {
    @scala.inline
