...
object ParamsReportProgressResponseType {
  ...
  inline def apply(): ParamsReportProgressResponseType = {
    val __obj = js.Dynamic.literal(observe = "events")
    __obj.asInstanceOf[ParamsReportProgressResponseType]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ParamsReportProgressResponseType] (val x: Self) extends AnyVal {
