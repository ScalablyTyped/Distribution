...
trait ParamsReportProgress extends StObject {
...
object ParamsReportProgress {
  ...
  @scala.inline
  def apply(): ParamsReportProgress = {
    val __obj = js.Dynamic.literal(observe = "response", responseType = "arraybuffer")
    __obj.asInstanceOf[ParamsReportProgress]
  }
  
  @scala.inline
  implicit class ParamsReportProgressMutableBuilder[Self <: ParamsReportProgress] (val x: Self) extends AnyVal {
