...
object SYP {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BRL = BRL.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], CNY = CNY.asInstanceOf[js.Any], ESP = ESP.asInstanceOf[js.Any], EUR = EUR.asInstanceOf[js.Any], FKP = FKP.asInstanceOf[js.Any], GBP = GBP.asInstanceOf[js.Any], HKD = HKD.asInstanceOf[js.Any], ILS = ILS.asInstanceOf[js.Any], INR = INR.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KRW = KRW.asInstanceOf[js.Any], MXN = MXN.asInstanceOf[js.Any], NZD = NZD.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], SSP = SSP.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], VEF = VEF.asInstanceOf[js.Any], VND = VND.asInstanceOf[js.Any], XAF = XAF.asInstanceOf[js.Any], XCD = XCD.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any])
    __obj.asInstanceOf[SYP]
  }
  
  extension [Self <: SYP](x: Self) {
    
    inline def setAUD(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "AUD", value.asInstanceOf[js.Any])
    
    inline def setAUDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "AUD", js.Array(value :_*))
    
    inline def setBRL(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "BRL", value.asInstanceOf[js.Any])
    
    inline def setBRLVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "BRL", js.Array(value :_*))
    ...
    inline def setESP(value: js.Array[String]): Self = StObject.set(x, "ESP", value.asInstanceOf[js.Any])
    
    inline def setESPVarargs(value: String*): Self = StObject.set(x, "ESP", js.Array(value :_*))
    ...
    inline def setFKP(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "FKP", value.asInstanceOf[js.Any])
    
    inline def setFKPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "FKP", js.Array(value :_*))
    ...
    inline def setINR(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "INR", value.asInstanceOf[js.Any])
    
    inline def setINRVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "INR", js.Array(value :_*))
    ...
    inline def setKRWVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "KRW", js.Array(value :_*))
    ...
    inline def setNZDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "NZD", js.Array(value :_*))
    ...
    inline def setSSP(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "SSP", value.asInstanceOf[js.Any])
    
    inline def setSSPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SSP", js.Array(value :_*))
    
    inline def setSYP(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "SYP", value.asInstanceOf[js.Any])
    
    inline def setSYPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SYP", js.Array(value :_*))
    ...
    inline def setVEF(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "VEF", value.asInstanceOf[js.Any])
    
    inline def setVEFVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "VEF", js.Array(value :_*))
    
    inline def setVND(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "VND", value.asInstanceOf[js.Any])
    
    inline def setVNDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "VND", js.Array(value :_*))
    ...
    inline def setXOF(value: js.Array[scala.Nothing]): Self = StObject.set(x, "XOF", value.asInstanceOf[js.Any])
    
    inline def setXOFVarargs(value: scala.Nothing*): Self = StObject.set(x, "XOF", js.Array(value :_*))
  }
}
