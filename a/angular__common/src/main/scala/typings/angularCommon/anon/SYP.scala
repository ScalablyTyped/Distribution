...
object SYP {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BRL = BRL.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], CNY = CNY.asInstanceOf[js.Any], ESP = ESP.asInstanceOf[js.Any], EUR = EUR.asInstanceOf[js.Any], FKP = FKP.asInstanceOf[js.Any], GBP = GBP.asInstanceOf[js.Any], HKD = HKD.asInstanceOf[js.Any], ILS = ILS.asInstanceOf[js.Any], INR = INR.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KRW = KRW.asInstanceOf[js.Any], MXN = MXN.asInstanceOf[js.Any], NZD = NZD.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], SSP = SSP.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], VEF = VEF.asInstanceOf[js.Any], VND = VND.asInstanceOf[js.Any], XAF = XAF.asInstanceOf[js.Any], XCD = XCD.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any])
    __obj.asInstanceOf[SYP]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SYP] (val x: Self) extends AnyVal {
    ...
    inline def setESPVarargs(value: String*): Self = StObject.set(x, "ESP", js.Array(value*))
    ...
    inline def setFKPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "FKP", js.Array(value*))
    ...
    inline def setSSPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SSP", js.Array(value*))
    
    inline def setSYP(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "SYP", value.asInstanceOf[js.Any])
    
    inline def setSYPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SYP", js.Array(value*))
    ...
    inline def setVEFVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "VEF", js.Array(value*))
    ...
    inline def setXOFVarargs(value: scala.Nothing*): Self = StObject.set(x, "XOF", js.Array(value*))
  }
}
