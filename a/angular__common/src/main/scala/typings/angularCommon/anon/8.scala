...
trait `8` extends StObject {
  ...
  var alias: ngComponentOutletNgModule
...
object `8` {
  ...
  inline def apply(): `8` = {
    val __obj = js.Dynamic.literal(alias = "ngComponentOutletNgModule", required = false)
  ...
  implicit open class MutableBuilder[Self <: `8`] (val x: Self) extends AnyVal {
    ...
    inline def setAlias(value: ngComponentOutletNgModule): Self = StObject.set(x, "alias", value.asInstanceOf[js.Any])
