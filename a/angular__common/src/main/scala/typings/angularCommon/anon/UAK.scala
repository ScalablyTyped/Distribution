...
object UAK {
  ...
  @scala.inline
  implicit class UAKMutableBuilder[Self <: UAK] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUAK(value: js.Array[String]): Self = StObject.set(x, "UAK", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setUAKVarargs(value: String*): Self = StObject.set(x, "UAK", js.Array(value :_*))
