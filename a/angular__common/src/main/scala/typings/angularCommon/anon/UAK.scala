...
trait UAK extends js.Object {
  ...
  var UAK: js.Array[String] = js.native
...
object UAK {
  ...
  implicit class UAKOps[Self <: UAK] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setUAKVarargs(value: String*): Self = this.set("UAK", js.Array(value :_*))
    
    @scala.inline
    def setUAK(value: js.Array[String]): Self = this.set("UAK", value.asInstanceOf[js.Any])
