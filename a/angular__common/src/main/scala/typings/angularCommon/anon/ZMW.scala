...
object ZMW {
  ...
  inline def apply(JPY: js.Array[String], USD: js.Array[String], ZMW: js.Array[String]): ZMW = {
  ...
  extension [Self <: ZMW](x: Self) {
    ...
    inline def setZMWVarargs(value: String*): Self = StObject.set(x, "ZMW", js.Array(value :_*))
  }
}
