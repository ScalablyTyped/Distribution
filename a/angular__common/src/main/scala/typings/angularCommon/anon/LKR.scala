...
object LKR {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], LKR = LKR.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any])
    __obj.asInstanceOf[LKR]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: LKR] (val x: Self) extends AnyVal {
    ...
    inline def setLKRVarargs(value: String*): Self = StObject.set(x, "LKR", js.Array(value*))
