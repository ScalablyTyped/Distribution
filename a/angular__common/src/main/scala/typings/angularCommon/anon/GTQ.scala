...
object GTQ {
  ...
  @scala.inline
  implicit class GTQMutableBuilder[Self <: GTQ] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGTQ(value: js.Array[String]): Self = StObject.set(x, "GTQ", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setGTQVarargs(value: String*): Self = StObject.set(x, "GTQ", js.Array(value :_*))
