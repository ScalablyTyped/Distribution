...
object GTQ {
  ...
  @scala.inline
  implicit class GTQOps[Self <: GTQ] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setGTQVarargs(value: String*): Self = this.set("GTQ", js.Array(value :_*))
    
    @scala.inline
    def setGTQ(value: js.Array[String]): Self = this.set("GTQ", value.asInstanceOf[js.Any])
