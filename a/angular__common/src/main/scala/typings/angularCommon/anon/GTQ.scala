...
object GTQ {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[GTQ]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: GTQ] (val x: Self) extends AnyVal {
    ...
    inline def setGTQ(value: js.Array[String]): Self = StObject.set(x, "GTQ", value.asInstanceOf[js.Any])
    
    inline def setGTQVarargs(value: String*): Self = StObject.set(x, "GTQ", js.Array(value*))
