...
object KGS {
  ...
  extension [Self <: KGS](x: Self) {
    ...
    inline def setBRLVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "BRL", js.Array(value*))
    ...
    inline def setEGPVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "EGP", js.Array(value*))
    ...
    inline def setHKDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "HKD", js.Array(value*))
    
    inline def setHRK(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "HRK", value.asInstanceOf[js.Any])
    
    inline def setHRKVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "HRK", js.Array(value*))
    ...
    inline def setINRVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "INR", js.Array(value*))
    ...
    inline def setKGS(value: js.Array[String]): Self = StObject.set(x, "KGS", value.asInstanceOf[js.Any])
    
    inline def setKGSVarargs(value: String*): Self = StObject.set(x, "KGS", js.Array(value*))
    ...
    inline def setTWDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "TWD", js.Array(value*))
    ...
    inline def setXCDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "XCD", js.Array(value*))
  }
}
