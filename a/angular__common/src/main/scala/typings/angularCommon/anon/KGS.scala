...
object KGS {
  ...
  @scala.inline
  implicit class KGSOps[Self <: KGS] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setKGSVarargs(value: String*): Self = this.set("KGS", js.Array(value :_*))
    @scala.inline
    def setKGS(value: js.Array[String]): Self = this.set("KGS", value.asInstanceOf[js.Any])
    @scala.inline
