...
object PYG {
  ...
  @scala.inline
  implicit class PYGOps[Self <: PYG] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setPYGVarargs(value: String*): Self = this.set("PYG", js.Array(value :_*))
    @scala.inline
    def setPYG(value: js.Array[String]): Self = this.set("PYG", value.asInstanceOf[js.Any])
    @scala.inline
