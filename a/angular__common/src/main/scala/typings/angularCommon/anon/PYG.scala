...
object PYG {
  ...
  @scala.inline
  implicit class PYGMutableBuilder[Self <: PYG] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setPYG(value: js.Array[String]): Self = StObject.set(x, "PYG", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setPYGVarargs(value: String*): Self = StObject.set(x, "PYG", js.Array(value :_*))
