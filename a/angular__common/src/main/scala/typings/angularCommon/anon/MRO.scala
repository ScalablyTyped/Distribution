...
object MRO {
  ...
  implicit class MROMutableBuilder[Self <: MRO] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setMRO(value: js.Array[String]): Self = StObject.set(x, "MRO", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setMROVarargs(value: String*): Self = StObject.set(x, "MRO", js.Array(value :_*))
