...
object MRO {
  ...
  extension [Self <: MRO](x: Self) {
    ...
    inline def setBYNVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "BYN", js.Array(value :_*))
    ...
    inline def setMROVarargs(value: String*): Self = StObject.set(x, "MRO", js.Array(value :_*))
