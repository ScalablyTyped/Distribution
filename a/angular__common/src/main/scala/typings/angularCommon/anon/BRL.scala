...
object BRL {
  ...
  implicit open class MutableBuilder[Self <: BRL] (val x: Self) extends AnyVal {
    ...
    inline def setNAD(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "NAD", value.asInstanceOf[js.Any])
    
    inline def setNADVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "NAD", js.Array(value*))
    ...
    inline def setSGD(value: js.Array[js.UndefOr[String]]): Self = StObject.set(x, "SGD", value.asInstanceOf[js.Any])
    
    inline def setSGDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SGD", js.Array(value*))
