...
object BRL {
  ...
  extension [Self <: BRL](x: Self) {
    ...
    inline def setISKVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "ISK", js.Array(value :_*))
    ...
    inline def setNADVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "NAD", js.Array(value :_*))
    ...
    inline def setSGDVarargs(value: js.UndefOr[String]*): Self = StObject.set(x, "SGD", js.Array(value :_*))
