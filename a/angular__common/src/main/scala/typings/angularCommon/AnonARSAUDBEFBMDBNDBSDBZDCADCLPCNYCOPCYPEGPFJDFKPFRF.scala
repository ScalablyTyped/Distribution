...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRF extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRF {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRF = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYPEGPFJDFKPFRF]
  }
}
