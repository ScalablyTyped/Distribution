...
trait AnonArraybufferBodyHeaderHeaders extends js.Object {
...
object AnonArraybufferBodyHeaderHeaders {
  @scala.inline
  def apply(
  ...
  ): AnonArraybufferBodyHeaderHeaders = {
    ...
    __obj.asInstanceOf[AnonArraybufferBodyHeaderHeaders]
  }
}
