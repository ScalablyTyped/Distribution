...
trait AnonBlobBodyHeaderHeaders extends js.Object {
...
object AnonBlobBodyHeaderHeaders {
  @scala.inline
  def apply(
    responseType: blob,
    ...
    __obj.asInstanceOf[AnonBlobBodyHeaderHeaders]
  }
}
