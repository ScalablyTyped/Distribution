...
object swCDMod extends Shortcut {
  
  @JSImport("@angular/common/locales/extra/sw-CD", JSImport.Default)
  @js.native
  val default: js.Array[js.Array[String | js.Array[String]]] = js.native
  
  type _To = js.Array[js.Array[String | js.Array[String]]]
  
  /* This means you don't have to write `default`, but can instead just say `swCDMod.foo` */
