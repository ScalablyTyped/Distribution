...
object localesKamMod extends Shortcut {
  
  @JSImport("@angular/common/locales/kam", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesKamMod.foo` */
