...
trait AnonArraybufferBlobBodyHeaders[V] extends js.Object {
...
object AnonArraybufferBlobBodyHeaders {
  @scala.inline
  def apply[V](
    body: V = null,
  ...
  ): AnonArraybufferBlobBodyHeaders[V] = {
    ...
    __obj.asInstanceOf[AnonArraybufferBlobBodyHeaders[V]]
  }
}
