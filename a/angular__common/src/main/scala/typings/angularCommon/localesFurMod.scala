...
object localesFurMod extends Shortcut {
  
  @JSImport("@angular/common/locales/fur", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesFurMod.foo` */
