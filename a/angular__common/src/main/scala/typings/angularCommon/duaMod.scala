...
object duaMod extends Shortcut {
  
  @JSImport("@angular/common/locales/dua", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `duaMod.foo` */
