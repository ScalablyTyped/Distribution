...
trait AnonAEDARSAUDBBDBHDBMDBNDBSD extends js.Object {
...
object AnonAEDARSAUDBBDBHDBMDBNDBSD {
  @scala.inline
  def apply(
    AED: js.Array[String],
    ...
    __obj.asInstanceOf[AnonAEDARSAUDBBDBHDBMDBNDBSD]
  }
}
