...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKD extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKD {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKD = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKD]
  }
}
