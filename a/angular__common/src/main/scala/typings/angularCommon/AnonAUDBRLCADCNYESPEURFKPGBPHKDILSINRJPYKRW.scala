...
trait AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRW extends js.Object {
...
object AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRW {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRW = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRW]
  }
}
