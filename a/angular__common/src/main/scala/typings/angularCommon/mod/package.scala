...
@scala.inline
def registerLocaleData(data: js.Any, localeId: scala.Unit, extraData: js.Any): scala.Unit = (typings.angularCommon.mod.^.asInstanceOf[js.Dynamic].applyDynamic("registerLocaleData")(data.asInstanceOf[js.Any], localeId.asInstanceOf[js.Any], extraData.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
