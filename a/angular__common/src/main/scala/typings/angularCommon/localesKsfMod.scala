...
object localesKsfMod extends Shortcut {
  
  @JSImport("@angular/common/locales/ksf", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesKsfMod.foo` */
