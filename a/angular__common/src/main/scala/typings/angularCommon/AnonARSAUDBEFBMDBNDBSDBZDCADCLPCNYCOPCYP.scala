...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNYCOPCYP]
  }
}
