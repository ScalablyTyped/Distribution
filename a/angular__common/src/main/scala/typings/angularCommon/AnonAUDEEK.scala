...
trait AnonAUDEEK extends js.Object {
...
object AnonAUDEEK {
  @scala.inline
  def apply(AUD: js.Array[String], EEK: js.Array[String], THB: js.Array[String], TWD: js.Array[String]): AnonAUDEEK = {
