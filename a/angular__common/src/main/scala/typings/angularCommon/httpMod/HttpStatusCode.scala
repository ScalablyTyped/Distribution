...
object HttpStatusCode {
  ...
  inline def Accepted: `202` = 202.asInstanceOf[`202`]
  
  inline def AlreadyReported: `208` = 208.asInstanceOf[`208`]
  
  inline def BadGateway: `502` = 502.asInstanceOf[`502`]
  
  inline def BadRequest: `400` = 400.asInstanceOf[`400`]
  
  inline def Conflict: `409` = 409.asInstanceOf[`409`]
  
  inline def Continue: `100` = 100.asInstanceOf[`100`]
  
  inline def Created: `201` = 201.asInstanceOf[`201`]
  
  inline def EarlyHints: `103` = 103.asInstanceOf[`103`]
  
  inline def ExpectationFailed: `417` = 417.asInstanceOf[`417`]
  
  inline def FailedDependency: `424` = 424.asInstanceOf[`424`]
  
  inline def Forbidden: `403` = 403.asInstanceOf[`403`]
  
  inline def Found: `302` = 302.asInstanceOf[`302`]
  
  inline def GatewayTimeout: `504` = 504.asInstanceOf[`504`]
  
  inline def Gone: `410` = 410.asInstanceOf[`410`]
  
  inline def HttpVersionNotSupported: `505` = 505.asInstanceOf[`505`]
  
  inline def ImATeapot: `418` = 418.asInstanceOf[`418`]
  
  inline def ImUsed: `226` = 226.asInstanceOf[`226`]
  
  inline def InsufficientStorage: `507` = 507.asInstanceOf[`507`]
  
  inline def InternalServerError: `500` = 500.asInstanceOf[`500`]
  
  inline def LengthRequired: `411` = 411.asInstanceOf[`411`]
  
  inline def Locked: `423` = 423.asInstanceOf[`423`]
  
  inline def LoopDetected: `508` = 508.asInstanceOf[`508`]
  
  inline def MethodNotAllowed: `405` = 405.asInstanceOf[`405`]
  
  inline def MisdirectedRequest: `421` = 421.asInstanceOf[`421`]
  
  inline def MovedPermanently: `301` = 301.asInstanceOf[`301`]
  
  inline def MultiStatus: `207` = 207.asInstanceOf[`207`]
  
  inline def MultipleChoices: `300` = 300.asInstanceOf[`300`]
  
  inline def NetworkAuthenticationRequired: `511` = 511.asInstanceOf[`511`]
  
  inline def NoContent: `204` = 204.asInstanceOf[`204`]
  
  inline def NonAuthoritativeInformation: `203` = 203.asInstanceOf[`203`]
  
  inline def NotAcceptable: `406` = 406.asInstanceOf[`406`]
  
  inline def NotExtended: `510` = 510.asInstanceOf[`510`]
  
  inline def NotFound: `404` = 404.asInstanceOf[`404`]
  
  inline def NotImplemented: `501` = 501.asInstanceOf[`501`]
  
  inline def NotModified: `304` = 304.asInstanceOf[`304`]
  
  inline def Ok: `200` = 200.asInstanceOf[`200`]
  
  inline def PartialContent: `206` = 206.asInstanceOf[`206`]
  
  inline def PayloadTooLarge: `413` = 413.asInstanceOf[`413`]
  
  inline def PaymentRequired: `402` = 402.asInstanceOf[`402`]
  
  inline def PermanentRedirect: `308` = 308.asInstanceOf[`308`]
  
  inline def PreconditionFailed: `412` = 412.asInstanceOf[`412`]
  
  inline def PreconditionRequired: `428` = 428.asInstanceOf[`428`]
  
  inline def Processing: `102` = 102.asInstanceOf[`102`]
  
  inline def ProxyAuthenticationRequired: `407` = 407.asInstanceOf[`407`]
  
  inline def RangeNotSatisfiable: `416` = 416.asInstanceOf[`416`]
  
  inline def RequestHeaderFieldsTooLarge: `431` = 431.asInstanceOf[`431`]
  
  inline def RequestTimeout: `408` = 408.asInstanceOf[`408`]
  
  inline def ResetContent: `205` = 205.asInstanceOf[`205`]
  
  inline def SeeOther: `303` = 303.asInstanceOf[`303`]
  
  inline def ServiceUnavailable: `503` = 503.asInstanceOf[`503`]
  
  inline def SwitchingProtocols: `101` = 101.asInstanceOf[`101`]
  
  inline def TemporaryRedirect: `307` = 307.asInstanceOf[`307`]
  
  inline def TooEarly: `425` = 425.asInstanceOf[`425`]
  
  inline def TooManyRequests: `429` = 429.asInstanceOf[`429`]
  
  inline def Unauthorized: `401` = 401.asInstanceOf[`401`]
  
  inline def UnavailableForLegalReasons: `451` = 451.asInstanceOf[`451`]
  
  inline def UnprocessableEntity: `422` = 422.asInstanceOf[`422`]
  
  inline def UnsupportedMediaType: `415` = 415.asInstanceOf[`415`]
  
  inline def Unused: `306` = 306.asInstanceOf[`306`]
  
  inline def UpgradeRequired: `426` = 426.asInstanceOf[`426`]
  
  inline def UriTooLong: `414` = 414.asInstanceOf[`414`]
  
  inline def UseProxy: `305` = 305.asInstanceOf[`305`]
  
  inline def VariantAlsoNegotiates: `506` = 506.asInstanceOf[`506`]
}
