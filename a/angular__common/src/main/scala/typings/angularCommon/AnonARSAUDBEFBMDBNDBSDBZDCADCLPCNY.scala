...
trait AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNY extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNY {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNY = {
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCADCLPCNY]
  }
}
