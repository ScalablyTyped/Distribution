...
trait AnonARSAUDBEFBMDBNDBSDBZDCAD extends js.Object {
...
object AnonARSAUDBEFBMDBNDBSDBZDCAD {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
    ...
    __obj.asInstanceOf[AnonARSAUDBEFBMDBNDBSDBZDCAD]
  }
}
