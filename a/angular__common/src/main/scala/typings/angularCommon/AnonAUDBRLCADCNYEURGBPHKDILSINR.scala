...
trait AnonAUDBRLCADCNYEURGBPHKDILSINR extends js.Object {
...
object AnonAUDBRLCADCNYEURGBPHKDILSINR {
  @scala.inline
  def apply(
  ...
  ): AnonAUDBRLCADCNYEURGBPHKDILSINR = {
    ...
    __obj.asInstanceOf[AnonAUDBRLCADCNYEURGBPHKDILSINR]
  }
}
