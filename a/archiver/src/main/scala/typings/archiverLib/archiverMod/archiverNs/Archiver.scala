...
trait Archiver
  ...
  def glob(pattern: java.lang.String, options: globLib.globMod.GNs.IOptions): this.type = js.native
  def glob(pattern: java.lang.String, options: globLib.globMod.GNs.IOptions, data: EntryData): this.type = js.native
  @JSName("on")
