...
object distTypesTypesRuleSetObjectMod {
  ...
  trait ParameterObject extends StObject {
    ...
    var `type`: typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.String | typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.Boolean
  }
  object ParameterObject {
    
    inline def apply(
      `type`: typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.String | typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.Boolean
    ): ParameterObject = {
      val __obj = js.Dynamic.literal()
    ...
    implicit open class MutableBuilder[Self <: ParameterObject] (val x: Self) extends AnyVal {
      ...
      inline def setType(
        value: typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.String | typings.awsSdkUtilEndpoints.awsSdkUtilEndpointsStrings.Boolean
