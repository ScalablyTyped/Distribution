...
object distTypesDebugMod {
  
  @JSImport("@aws-sdk/util-endpoints/dist-types/debug", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@aws-sdk/util-endpoints/dist-types/debug", "debugId")
  @js.native
  val debugId: /* "endpoints" */ String = js.native
