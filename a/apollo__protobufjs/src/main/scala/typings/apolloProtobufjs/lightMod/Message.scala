...
object Message extends js.Object {
  ...
  def create[T /* <: typings.apolloProtobufjs.mod.Message[T] */](properties: StringDictionary[js.Any]): typings.apolloProtobufjs.mod.Message[T] = js.native
  /**
  ...
  def encode[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: StringDictionary[js.Any]): typings.apolloProtobufjs.mod.Writer = js.native
  def encode[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: StringDictionary[js.Any], writer: typings.apolloProtobufjs.mod.Writer): typings.apolloProtobufjs.mod.Writer = js.native
  /**
  ...
  def encodeDelimited[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: StringDictionary[js.Any]): typings.apolloProtobufjs.mod.Writer = js.native
  def encodeDelimited[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: StringDictionary[js.Any], writer: typings.apolloProtobufjs.mod.Writer): typings.apolloProtobufjs.mod.Writer = js.native
  /**
    * Creates a new message of this type from a plain object. Also converts values to their respective internal types.
    * @param object Plain object
    * @returns Message instance
    */
  def fromObject[T /* <: typings.apolloProtobufjs.mod.Message[T] */](`object`: StringDictionary[js.Any]): T = js.native
  /**
    ...
    */
  def toObject[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: T): StringDictionary[js.Any] = js.native
  def toObject[T /* <: typings.apolloProtobufjs.mod.Message[T] */](message: T, options: IConversionOptions): StringDictionary[js.Any] = js.native
  /**
