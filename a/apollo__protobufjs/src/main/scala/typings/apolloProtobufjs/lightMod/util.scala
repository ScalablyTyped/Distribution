...
object util {
  ...
  object LongBits {
    ...
    @scala.inline
    def from(value: String): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    @scala.inline
    def from(value: Double): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    /**
    ...
    /* static member */
    @scala.inline
    def from(value: typings.long.mod.Long): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    ...
    /* static member */
    @scala.inline
    def fromHash(hash: String): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    ...
    /* static member */
    @scala.inline
    def fromNumber(value: Double): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNumber")(value.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
  ...
  /**
    ...
    */
  @scala.inline
  def compareFieldsById(a: typings.apolloProtobufjs.mod.Field, b: typings.apolloProtobufjs.mod.Field): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareFieldsById")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  @scala.inline
  def decorateEnum(`object`: js.Object): typings.apolloProtobufjs.mod.Enum = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateEnum")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.Enum]
  ...
  /**
    ...
    */
  @scala.inline
  def decorateType[T /* <: typings.apolloProtobufjs.mod.Message[T] */](ctor: Constructor[T]): typings.apolloProtobufjs.mod.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.Type]
  @scala.inline
  def decorateType[T /* <: typings.apolloProtobufjs.mod.Message[T] */](ctor: Constructor[T], typeName: String): typings.apolloProtobufjs.mod.Type = (^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any], typeName.asInstanceOf[js.Any])).asInstanceOf[typings.apolloProtobufjs.mod.Type]
