...
object Namespace {
  ...
  /**
    ...
    */
  @scala.inline
  def arrayToJSON(array: js.Array[typings.apolloProtobufjs.mod.ReflectionObject]): js.UndefOr[StringDictionary[js.UndefOr[js.Any]]] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayToJSON")(array.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[StringDictionary[js.UndefOr[js.Any]]]]
  @scala.inline
  ...
  /**
    ...
    */
  @scala.inline
  def fromJSON(name: String, json: StringDictionary[js.UndefOr[js.Any]]): typings.apolloProtobufjs.mod.Namespace = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[typings.apolloProtobufjs.mod.Namespace]
