...
object util {
  ...
  @JSGlobal("protobuf.util")
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSGlobal("protobuf.util.Array")
  @js.native
  ...
  @JSGlobal("protobuf.util.EventEmitter")
  @js.native
  ...
  @JSGlobal("protobuf.util.LongBits")
  @js.native
  ...
  object LongBits {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromHash(hash: String): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromNumber(value: Double): typings.apolloProtobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNumber")(value.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.util.LongBits]
    
    /** Zero bits. */
    /* static member */
    @JSGlobal("protobuf.util.LongBits.zero")
    @js.native
    def zero: typings.apolloProtobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSGlobal("protobuf.util.LongBits.zeroHash")
    @js.native
  ...
  @JSGlobal("protobuf.util.ProtocolError")
  @js.native
  ...
  object codegen {
    ...
    @JSGlobal("protobuf.util.codegen")
    @js.native
    val ^ : js.Any = js.native
    
    /** When set to `true`, codegen will log generated code to console. Useful for debugging. */
    @JSGlobal("protobuf.util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  inline def compareFieldsById(a: typings.apolloProtobufjs.mod.Field, b: typings.apolloProtobufjs.mod.Field): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareFieldsById")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def decorateEnum(`object`: js.Object): typings.apolloProtobufjs.mod.Enum = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateEnum")(`object`.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.Enum]
  
  /** Decorator root (TypeScript). */
  @JSGlobal("protobuf.util.decorateRoot")
  @js.native
  def decorateRoot: typings.apolloProtobufjs.mod.Root = js.native
  inline def decorateRoot_=(x: typings.apolloProtobufjs.mod.Root): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("decorateRoot")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def decorateType[T /* <: typings.apolloProtobufjs.mod.Message[T] */](ctor: Constructor[T]): typings.apolloProtobufjs.mod.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any]).asInstanceOf[typings.apolloProtobufjs.mod.Type]
  inline def decorateType[T /* <: typings.apolloProtobufjs.mod.Message[T] */](ctor: Constructor[T], typeName: String): typings.apolloProtobufjs.mod.Type = (^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any], typeName.asInstanceOf[js.Any])).asInstanceOf[typings.apolloProtobufjs.mod.Type]
  
  /** An immuable empty array. */
  @JSGlobal("protobuf.util.emptyArray")
  @js.native
  val emptyArray: js.Array[js.Any] = js.native
  
  /** An immutable empty object. */
  @JSGlobal("protobuf.util.emptyObject")
  @js.native
  ...
  @JSGlobal("protobuf.util.key2Re")
  @js.native
  val key2Re: RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSGlobal("protobuf.util.key32Re")
  @js.native
  val key32Re: RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSGlobal("protobuf.util.key64Re")
  @js.native
  ...
  /**
    ...
    */
  @JSGlobal("protobuf.util.toJSONOptions")
  @js.native
