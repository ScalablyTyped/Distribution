...
object OneOf {
  ...
  /**
    ...
    */
  @scala.inline
  def fromJSON(name: String, json: IOneOf): typings.apolloProtobufjs.mod.OneOf = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(name.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[typings.apolloProtobufjs.mod.OneOf]
}
