...
object rpc extends js.Object {
  ...
  class Service protected () extends EventEmitter {
    ...
    /**
      ...
      * @returns `this`
      */
    def end(): typings.atApolloProtobufjs.atApolloProtobufjsMod.rpc.Service = js.native
    def end(endedByRPC: Boolean): typings.atApolloProtobufjs.atApolloProtobufjsMod.rpc.Service = js.native
    /**
