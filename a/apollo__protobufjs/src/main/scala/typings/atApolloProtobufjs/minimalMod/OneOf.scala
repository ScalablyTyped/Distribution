...
import typings.atApolloProtobufjs.atApolloProtobufjsMod.IOneOf
import typings.atApolloProtobufjs.atApolloProtobufjsMod.OneOfDecorator
...
class OneOf protected ()
  extends typings.atApolloProtobufjs.atApolloProtobufjsMod.OneOf {
  /**
...
object OneOf extends js.Object {
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: IOneOf): typings.atApolloProtobufjs.atApolloProtobufjsMod.OneOf = js.native
}
