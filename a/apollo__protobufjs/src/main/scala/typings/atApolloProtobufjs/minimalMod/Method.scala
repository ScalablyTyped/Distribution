...
import typings.atApolloProtobufjs.atApolloProtobufjsMod.IMethod
...
class Method protected ()
  extends typings.atApolloProtobufjs.atApolloProtobufjsMod.Method {
...
object Method extends js.Object {
  /**
    ...
    */
  def fromJSON(name: String, json: IMethod): typings.atApolloProtobufjs.atApolloProtobufjsMod.Method = js.native
}
