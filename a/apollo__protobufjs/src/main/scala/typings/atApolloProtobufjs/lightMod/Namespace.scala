...
import typings.atApolloProtobufjs.atApolloProtobufjsMod.IToJSONOptions
...
class Namespace protected ()
  extends typings.atApolloProtobufjs.atApolloProtobufjsMod.Namespace {
  /**
...
object Namespace extends js.Object {
  /**
    ...
    */
  def arrayToJSON(array: js.Array[typings.atApolloProtobufjs.atApolloProtobufjsMod.ReflectionObject]): js.UndefOr[StringDictionary[js.Any]] = js.native
  def arrayToJSON(
    array: js.Array[typings.atApolloProtobufjs.atApolloProtobufjsMod.ReflectionObject],
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: StringDictionary[js.Any]): typings.atApolloProtobufjs.atApolloProtobufjsMod.Namespace = js.native
