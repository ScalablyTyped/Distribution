...
import typings.atApolloProtobufjs.atApolloProtobufjsMod.IMapField
...
class MapField protected ()
  extends typings.atApolloProtobufjs.atApolloProtobufjsMod.MapField {
  /**
...
object MapField extends js.Object {
  ...
  def d[T /* <: StringDictionary[
    Double | ^  | String | Boolean | Uint8Array | Buffer | js.Array[Double] | typings.atApolloProtobufjs.atApolloProtobufjsMod.Message[js.Object]
  ] */](
    fieldId: Double,
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: IMapField): typings.atApolloProtobufjs.atApolloProtobufjsMod.MapField = js.native
}
