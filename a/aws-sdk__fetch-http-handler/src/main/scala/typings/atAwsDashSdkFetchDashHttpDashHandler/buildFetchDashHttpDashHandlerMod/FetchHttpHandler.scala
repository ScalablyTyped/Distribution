package typings.atAwsDashSdkFetchDashHttpDashHandler.buildFetchDashHttpDashHandlerMod
...
@JSImport("@aws-sdk/fetch-http-handler/build/fetch-http-handler", "FetchHttpHandler")
@js.native
