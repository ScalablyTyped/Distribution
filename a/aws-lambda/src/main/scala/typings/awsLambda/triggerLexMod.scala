...
object triggerLexMod {
  
  type LexCallback = Callback[LexResult]
  
  /* Rewritten from type alias, can be one of: 
    - typings.awsLambda.triggerLexMod.LexDialogActionClose
    - typings.awsLambda.triggerLexMod.LexDialogActionElicitIntent
    - typings.awsLambda.triggerLexMod.LexDialogActionElicitSlot
    - typings.awsLambda.triggerLexMod.LexDialogActionConfirmIntent
    - typings.awsLambda.triggerLexMod.LexDialogActionDelegate
  */
  trait LexDialogAction extends StObject
  object LexDialogAction {
    
    inline def LexDialogActionClose(fulfillmentState: Fulfilled | Failed_): typings.awsLambda.triggerLexMod.LexDialogActionClose = {
      val __obj = js.Dynamic.literal(fulfillmentState = fulfillmentState.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Close")
      __obj.asInstanceOf[typings.awsLambda.triggerLexMod.LexDialogActionClose]
    }
    
    inline def LexDialogActionConfirmIntent(intentName: String, slots: StringDictionary[String | Null]): typings.awsLambda.triggerLexMod.LexDialogActionConfirmIntent = {
      ...
      __obj.asInstanceOf[typings.awsLambda.triggerLexMod.LexDialogActionConfirmIntent]
    }
    
    inline def LexDialogActionDelegate(slots: StringDictionary[String | Null]): typings.awsLambda.triggerLexMod.LexDialogActionDelegate = {
      val __obj = js.Dynamic.literal(slots = slots.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Delegate")
      __obj.asInstanceOf[typings.awsLambda.triggerLexMod.LexDialogActionDelegate]
    }
    
    inline def LexDialogActionElicitIntent(): typings.awsLambda.triggerLexMod.LexDialogActionElicitIntent = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("ElicitIntent")
      __obj.asInstanceOf[typings.awsLambda.triggerLexMod.LexDialogActionElicitIntent]
    }
    
    inline def LexDialogActionElicitSlot(intentName: String, slotToElicit: String, slots: StringDictionary[String | Null]): typings.awsLambda.triggerLexMod.LexDialogActionElicitSlot = {
      ...
      __obj.asInstanceOf[typings.awsLambda.triggerLexMod.LexDialogActionElicitSlot]
    }
  }
