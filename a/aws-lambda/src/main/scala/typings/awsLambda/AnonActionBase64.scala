...
trait AnonActionBase64 extends js.Object {
...
object AnonActionBase64 {
  @scala.inline
  def apply(action: `read-only` | replace, data: String, encoding: base64 | text_, inputTruncated: Boolean): AnonActionBase64 = {
    ...
    __obj.asInstanceOf[AnonActionBase64]
  }
}
