...
object triggerCodepipelineCloudwatchStageMod {
  ...
  object CodePipelineCloudWatchStageEvent {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CodePipelineCloudWatchStageEvent] (val x: Self) extends AnyVal {
      
      inline def setAccount(value: String): Self = StObject.set(x, "account", value.asInstanceOf[js.Any])
      
      inline def setDetail(value: Stage): Self = StObject.set(x, "detail", value.asInstanceOf[js.Any])
      
      inline def `setDetail-type`(value: `CodePipeline Stage Execution State Change`): Self = StObject.set(x, "detail-type", value.asInstanceOf[js.Any])
