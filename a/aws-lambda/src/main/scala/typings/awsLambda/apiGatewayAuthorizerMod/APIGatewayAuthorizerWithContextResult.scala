...
object APIGatewayAuthorizerWithContextResult {
  @scala.inline
  def apply[/* <: typings.awsLambda.apiGatewayMod.APIGatewayAuthorizerResultContext */ TAuthorizerContext](context: TAuthorizerContext, policyDocument: PolicyDocument, principalId: String): APIGatewayAuthorizerWithContextResult[TAuthorizerContext] = {
  ...
  @scala.inline
  implicit class APIGatewayAuthorizerWithContextResultOps[Self <: APIGatewayAuthorizerWithContextResult[_], /* <: typings.awsLambda.apiGatewayMod.APIGatewayAuthorizerResultContext */ TAuthorizerContext] (val x: Self with APIGatewayAuthorizerWithContextResult[TAuthorizerContext]) extends AnyVal {
    @scala.inline
