...
object cdkCustomResourceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseSuccess
    - typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseWaiting
  */
  trait CdkCustomResourceIsCompleteResponse extends StObject
  object CdkCustomResourceIsCompleteResponse {
    
    inline def CdkCustomResourceIsCompleteResponseSuccess(): typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseSuccess = {
      val __obj = js.Dynamic.literal(IsComplete = true)
      __obj.asInstanceOf[typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseSuccess]
    }
    
    inline def CdkCustomResourceIsCompleteResponseWaiting(): typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseWaiting = {
      val __obj = js.Dynamic.literal(IsComplete = false)
      __obj.asInstanceOf[typings.awsLambda.cdkCustomResourceMod.CdkCustomResourceIsCompleteResponseWaiting]
    }
  }
