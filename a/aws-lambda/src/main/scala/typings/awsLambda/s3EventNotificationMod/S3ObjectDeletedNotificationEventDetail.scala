...
/* Rewritten from type alias, can be one of: 
  - typings.awsLambda.s3EventNotificationMod.S3ObjectDeletedNotificationEventLifecycleExpirationDetail
  - typings.awsLambda.s3EventNotificationMod.S3ObjectDeletedNotificationEventDeleteObjectDetail
*/
...
object S3ObjectDeletedNotificationEventDetail {
  ...
  inline def S3ObjectDeletedNotificationEventDeleteObjectDetail(
    ...
    __obj.asInstanceOf[typings.awsLambda.s3EventNotificationMod.S3ObjectDeletedNotificationEventDeleteObjectDetail]
  }
  ...
  inline def S3ObjectDeletedNotificationEventLifecycleExpirationDetail(
    ...
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.updateDynamic("request-id")(`request-id`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.awsLambda.s3EventNotificationMod.S3ObjectDeletedNotificationEventLifecycleExpirationDetail]
  }
}
