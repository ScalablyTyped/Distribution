...
/* Rewritten from type alias, can be one of: 
  - typings.awsDashLambda.awsDashLambdaMod.CloudFormationCustomResourceSuccessResponse
  - typings.awsDashLambda.awsDashLambdaMod.CloudFormationCustomResourceFailedResponse
*/
