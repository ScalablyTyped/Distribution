...
trait Anon_ActionBase64 extends js.Object {
  ...
  var data: String
  var encoding: base64 | text
  val inputTruncated: Boolean
}

object Anon_ActionBase64 {
  @scala.inline
  def apply(action: `read-only` | replace, data: String, encoding: base64 | text, inputTruncated: Boolean): Anon_ActionBase64 = {
    val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], data = data, encoding = encoding.asInstanceOf[js.Any], inputTruncated = inputTruncated)
