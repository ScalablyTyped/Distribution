...
object distTypesTokensAtlassianDarkNewInputBorderColorBorderMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-dark-new-input-border/color/border", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-dark-new-input-border/color/border", "default.color")
    @js.native
