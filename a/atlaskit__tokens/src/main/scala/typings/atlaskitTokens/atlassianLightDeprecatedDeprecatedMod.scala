...
object atlassianLightDeprecatedDeprecatedMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-light/deprecated/deprecated", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-light/deprecated/deprecated", "default.color")
    @js.native
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-light/deprecated/deprecated", "default.shadow")
    @js.native
