...
trait Deprecated[Group /* <: Groups */] extends StObject {
...
object Deprecated {
  ...
  inline def apply[Group /* <: Groups */](
    ...
    __obj.asInstanceOf[Deprecated[Group]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: Deprecated[?], Group /* <: Groups */] (val x: Self & Deprecated[Group]) extends AnyVal {
