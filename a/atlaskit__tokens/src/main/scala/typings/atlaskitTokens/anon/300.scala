...
trait `300`[BaseToken] extends StObject {
  
  var `050`: TypographyToken[BaseToken]
  
  var `075`: TypographyToken[BaseToken]
...
object `300` {
  ...
  inline def apply[BaseToken](
    ...
    __obj.asInstanceOf[`300`[BaseToken]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `300`[?], BaseToken] (val x: Self & `300`[BaseToken]) extends AnyVal {
    
    inline def set050(value: TypographyToken[BaseToken]): Self = StObject.set(x, "050", value.asInstanceOf[js.Any])
    
    inline def set075(value: TypographyToken[BaseToken]): Self = StObject.set(x, "075", value.asInstanceOf[js.Any])
