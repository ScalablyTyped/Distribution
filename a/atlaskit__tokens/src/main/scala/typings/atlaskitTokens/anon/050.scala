...
trait `050`[BaseToken] extends StObject {
...
object `050` {
  ...
  inline def apply[BaseToken](
    ...
    __obj.updateDynamic("025")(`025`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[`050`[BaseToken]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `050`[?], BaseToken] (val x: Self & `050`[BaseToken]) extends AnyVal {
