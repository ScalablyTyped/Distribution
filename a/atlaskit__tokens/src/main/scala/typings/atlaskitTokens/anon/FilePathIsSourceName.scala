...
trait FilePathIsSourceName extends StObject {
...
object FilePathIsSourceName {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[FilePathIsSourceName]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: FilePathIsSourceName] (val x: Self) extends AnyVal {
