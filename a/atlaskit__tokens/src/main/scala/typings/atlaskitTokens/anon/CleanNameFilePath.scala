...
trait CleanNameFilePath extends StObject {
...
object CleanNameFilePath {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CleanNameFilePath]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CleanNameFilePath] (val x: Self) extends AnyVal {
