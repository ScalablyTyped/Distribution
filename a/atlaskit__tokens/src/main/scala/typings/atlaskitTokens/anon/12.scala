...
trait `12`[BaseToken] extends StObject {
...
object `12` {
  ...
  inline def apply[BaseToken](hovered: PaintToken[BaseToken], pressed: PaintToken[BaseToken]): `12`[BaseToken] = {
    val __obj = js.Dynamic.literal(hovered = hovered.asInstanceOf[js.Any], pressed = pressed.asInstanceOf[js.Any])
    __obj.asInstanceOf[`12`[BaseToken]]
  }
  
  extension [Self <: `12`[?], BaseToken](x: Self & `12`[BaseToken]) {
