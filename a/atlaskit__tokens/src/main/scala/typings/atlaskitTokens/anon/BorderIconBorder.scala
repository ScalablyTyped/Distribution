...
trait BorderIconBorder[BaseToken] extends StObject {
  ...
  var interaction: Inverse17[BaseToken]
  
  var overlay: `15`[BaseToken]
...
object BorderIconBorder {
  ...
  inline def apply[BaseToken](
    ...
    interaction: Inverse17[BaseToken],
    overlay: `15`[BaseToken],
  ...
  extension [Self <: BorderIconBorder[?], BaseToken](x: Self & BorderIconBorder[BaseToken]) {
    ...
    inline def setInteraction(value: Inverse17[BaseToken]): Self = StObject.set(x, "interaction", value.asInstanceOf[js.Any])
    
    inline def setOverlay(value: `15`[BaseToken]): Self = StObject.set(x, "overlay", value.asInstanceOf[js.Any])
