...
trait BlueBrand[BaseToken] extends StObject {
  ...
  var purple: BolderBoldest[BaseToken]
...
object BlueBrand {
  ...
  inline def apply[BaseToken](
    ...
    __obj.asInstanceOf[BlueBrand[BaseToken]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: BlueBrand[?], BaseToken] (val x: Self & BlueBrand[BaseToken]) extends AnyVal {
    ...
    inline def setPurple(value: BolderBoldest[BaseToken]): Self = StObject.set(x, "purple", value.asInstanceOf[js.Any])
