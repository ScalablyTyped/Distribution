...
trait `1000`[BaseToken] extends StObject {
  
  var `0`: SpacingToken[BaseToken]
  
  var `100`: SpacingToken[BaseToken]
  
  var `1000`: SpacingToken[BaseToken]
  
  var `1100`: SpacingToken[BaseToken]
  ...
  var `700`: SpacingToken[BaseToken]
  
  var `800`: SpacingToken[BaseToken]
  
  var `900`: SpacingToken[BaseToken]
}
object `1000` {
  ...
  inline def apply[BaseToken](
    ...
    __obj.updateDynamic("1100")(`1100`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[`1000`[BaseToken]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: `1000`[?], BaseToken] (val x: Self & `1000`[BaseToken]) extends AnyVal {
    ...
    inline def set1000(value: SpacingToken[BaseToken]): Self = StObject.set(x, "1000", value.asInstanceOf[js.Any])
    
    inline def set1100(value: SpacingToken[BaseToken]): Self = StObject.set(x, "1100", value.asInstanceOf[js.Any])
    ...
    inline def set700(value: SpacingToken[BaseToken]): Self = StObject.set(x, "700", value.asInstanceOf[js.Any])
    
    inline def set800(value: SpacingToken[BaseToken]): Self = StObject.set(x, "800", value.asInstanceOf[js.Any])
    
    inline def set900(value: SpacingToken[BaseToken]): Self = StObject.set(x, "900", value.asInstanceOf[js.Any])
  }
}
