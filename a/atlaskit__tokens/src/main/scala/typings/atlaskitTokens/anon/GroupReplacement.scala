...
trait GroupReplacement[Group /* <: Groups */] extends StObject {
...
object GroupReplacement {
  
  inline def apply[Group /* <: Groups */](group: Group): GroupReplacement[Group] = {
    val __obj = js.Dynamic.literal(group = group.asInstanceOf[js.Any])
    __obj.asInstanceOf[GroupReplacement[Group]]
  }
  
  extension [Self <: GroupReplacement[?], Group /* <: Groups */](x: Self & GroupReplacement[Group]) {
