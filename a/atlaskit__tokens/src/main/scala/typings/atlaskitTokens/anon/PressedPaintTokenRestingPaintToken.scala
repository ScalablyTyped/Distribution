...
object PressedPaintTokenRestingPaintToken {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: PressedPaintTokenRestingPaintToken[?], BaseToken] (val x: Self & PressedPaintTokenRestingPaintToken[BaseToken]) extends AnyVal {
