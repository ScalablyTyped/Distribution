...
trait ColorInset extends StObject {
...
object ColorInset {
  ...
  inline def apply(color: String, offset: X, opacity: Double, radius: Double): ColorInset = {
    ...
    __obj.asInstanceOf[ColorInset]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ColorInset] (val x: Self) extends AnyVal {
