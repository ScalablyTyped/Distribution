...
trait BoldDiscovery[BaseToken] extends StObject {
  
  var default: PaintToken[BaseToken]
  
  var accent: BlueGreen[BaseToken]
  
  var blanket: PaintToken[BaseToken]
  
  var boldBrand: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var boldDanger: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var boldDiscovery: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var boldNeutral: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var boldSuccess: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var boldWarning: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var brand: `14`[BaseToken]
  
  var card: PaintToken[BaseToken]
  
  var inverse: `13`[BaseToken]
  
  var overlay: PaintToken[BaseToken]
  
  var selected: HoverPaintTokenRestingPaintToken[BaseToken]
  
  var subtleBorderedNeutral: `17`[BaseToken]
  
  var subtleBrand: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var subtleDanger: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var subtleDiscovery: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var subtleNeutral: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var subtleSuccess: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var subtleWarning: PressedPaintTokenRestingPaintToken[BaseToken]
  
  var sunken: PaintToken[BaseToken]
  
  var transparentNeutral: `15`[BaseToken]
}
object BoldDiscovery {
  
  inline def apply[BaseToken](
    accent: BlueGreen[BaseToken],
    blanket: PaintToken[BaseToken],
    boldBrand: PressedPaintTokenRestingPaintToken[BaseToken],
    boldDanger: PressedPaintTokenRestingPaintToken[BaseToken],
    boldDiscovery: PressedPaintTokenRestingPaintToken[BaseToken],
    ...
    subtleNeutral: PressedPaintTokenRestingPaintToken[BaseToken],
    ...
    transparentNeutral: `15`[BaseToken]
  ...
  implicit open class MutableBuilder[Self <: BoldDiscovery[?], BaseToken] (val x: Self & BoldDiscovery[BaseToken]) extends AnyVal {
    ...
    inline def setBoldBrand(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "boldBrand", value.asInstanceOf[js.Any])
    
    inline def setBoldDanger(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "boldDanger", value.asInstanceOf[js.Any])
    
    inline def setBoldDiscovery(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "boldDiscovery", value.asInstanceOf[js.Any])
    
    inline def setBoldNeutral(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "boldNeutral", value.asInstanceOf[js.Any])
    
    inline def setBoldSuccess(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "boldSuccess", value.asInstanceOf[js.Any])
    ...
    inline def setBrand(value: `14`[BaseToken]): Self = StObject.set(x, "brand", value.asInstanceOf[js.Any])
    ...
    inline def setInverse(value: `13`[BaseToken]): Self = StObject.set(x, "inverse", value.asInstanceOf[js.Any])
    ...
    inline def setSubtleBorderedNeutral(value: `17`[BaseToken]): Self = StObject.set(x, "subtleBorderedNeutral", value.asInstanceOf[js.Any])
    ...
    inline def setSubtleDanger(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "subtleDanger", value.asInstanceOf[js.Any])
    
    inline def setSubtleDiscovery(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "subtleDiscovery", value.asInstanceOf[js.Any])
    
    inline def setSubtleNeutral(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "subtleNeutral", value.asInstanceOf[js.Any])
    
    inline def setSubtleSuccess(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "subtleSuccess", value.asInstanceOf[js.Any])
    
    inline def setSubtleWarning(value: PressedPaintTokenRestingPaintToken[BaseToken]): Self = StObject.set(x, "subtleWarning", value.asInstanceOf[js.Any])
    
    inline def setSunken(value: PaintToken[BaseToken]): Self = StObject.set(x, "sunken", value.asInstanceOf[js.Any])
    
    inline def setTransparentNeutral(value: `15`[BaseToken]): Self = StObject.set(x, "transparentNeutral", value.asInstanceOf[js.Any])
  }
}
