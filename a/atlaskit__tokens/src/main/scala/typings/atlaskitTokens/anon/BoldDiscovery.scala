...
trait BoldDiscovery[BaseToken] extends StObject {
  ...
  var transparentNeutral: `7`[BaseToken]
}
object BoldDiscovery {
  ...
  inline def apply[BaseToken](
    ...
    subtleBorderedNeutral: `8`[BaseToken],
    ...
    transparentNeutral: `7`[BaseToken]
  ...
  extension [Self <: BoldDiscovery[?], BaseToken](x: Self & BoldDiscovery[BaseToken]) {
    ...
    inline def setBrand(value: `6`[BaseToken]): Self = StObject.set(x, "brand", value.asInstanceOf[js.Any])
    ...
    inline def setInverse(value: `5`[BaseToken]): Self = StObject.set(x, "inverse", value.asInstanceOf[js.Any])
    ...
    inline def setSubtleBorderedNeutral(value: `8`[BaseToken]): Self = StObject.set(x, "subtleBorderedNeutral", value.asInstanceOf[js.Any])
    ...
    inline def setTransparentNeutral(value: `7`[BaseToken]): Self = StObject.set(x, "transparentNeutral", value.asInstanceOf[js.Any])
  }
}
