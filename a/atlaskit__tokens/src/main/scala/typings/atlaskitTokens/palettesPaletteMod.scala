...
object palettesPaletteMod extends Shortcut {
  
  @JSImport("@atlaskit/tokens/dist/types/palettes/palette", JSImport.Default)
  @js.native
  ...
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `palettesPaletteMod.foo` */
