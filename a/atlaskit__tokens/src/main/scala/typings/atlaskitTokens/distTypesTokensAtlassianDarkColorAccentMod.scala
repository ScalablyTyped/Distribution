...
object distTypesTokensAtlassianDarkColorAccentMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-dark/color/accent", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-dark/color/accent", "default.color")
    @js.native
