...
object distTypesTokensAtlassianLegacyDarkDeprecatedDeprecatedMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-dark/deprecated/deprecated", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-dark/deprecated/deprecated", "default.color")
    @js.native
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-dark/deprecated/deprecated", "default.shadow")
    @js.native
