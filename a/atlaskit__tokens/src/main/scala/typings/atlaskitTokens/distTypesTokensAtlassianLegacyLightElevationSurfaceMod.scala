...
object distTypesTokensAtlassianLegacyLightElevationSurfaceMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-light/elevation/surface", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-light/elevation/surface", "default.elevation")
    @js.native
