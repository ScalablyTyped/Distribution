...
trait DesignToken[TValue, Group /* <: Groups */]
  ...
  @JSName("attributes")
  var attributes_DesignToken: Introduced[Group] | typings.atlaskitTokens.anon.Replacement[Group] | State[Group]
}
object DesignToken {
  
  inline def apply[TValue, Group /* <: Groups */](
    attributes: Introduced[Group] | typings.atlaskitTokens.anon.Replacement[Group] | State[Group],
    value: TValue
  ...
  extension [Self <: DesignToken[?, ?], TValue, Group /* <: Groups */](x: Self & (DesignToken[TValue, Group])) {
    ...
    inline def setAttributes(value: Introduced[Group] | typings.atlaskitTokens.anon.Replacement[Group] | State[Group]): Self = StObject.set(x, "attributes", value.asInstanceOf[js.Any])
  }
}
