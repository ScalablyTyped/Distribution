...
object Groups {
  ...
  inline def paint: typings.atlaskitTokens.atlaskitTokensStrings.paint = "paint".asInstanceOf[typings.atlaskitTokens.atlaskitTokensStrings.paint]
  
  inline def palette: typings.atlaskitTokens.atlaskitTokensStrings.palette = "palette".asInstanceOf[typings.atlaskitTokens.atlaskitTokensStrings.palette]
