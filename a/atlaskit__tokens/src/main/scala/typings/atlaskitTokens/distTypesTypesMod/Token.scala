...
trait Token[TValue, Group /* <: Groups */] extends StObject {
  ...
  var attributes: DescriptionGroup[Group]
  
  var value: TValue
}
object Token {
  
  inline def apply[TValue, Group /* <: Groups */](attributes: DescriptionGroup[Group], value: TValue): Token[TValue, Group] = {
  ...
  extension [Self <: Token[?, ?], TValue, Group /* <: Groups */](x: Self & (Token[TValue, Group])) {
    ...
    inline def setAttributes(value: DescriptionGroup[Group]): Self = StObject.set(x, "attributes", value.asInstanceOf[js.Any])
