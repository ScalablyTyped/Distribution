...
object distTypesArtifactsRenameMappingAtlassianDarkMod extends Shortcut {
  
  @JSImport("@atlaskit/tokens/dist/types/artifacts/rename-mapping/atlassian-dark", JSImport.Default)
  @js.native
  ...
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesArtifactsRenameMappingAtlassianDarkMod.foo` */
