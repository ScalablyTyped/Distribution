...
object distTypesTokensAtlassianLightNewInputBorderColorBorderMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-light-new-input-border/color/border", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-light-new-input-border/color/border", "default.color")
    @js.native
