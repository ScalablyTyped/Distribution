...
object distTypesArtifactsRenameMappingAtlassianLegacyLightMod extends Shortcut {
  
  @JSImport("@atlaskit/tokens/dist/types/artifacts/rename-mapping/atlassian-legacy-light", JSImport.Default)
  @js.native
  ...
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `distTypesArtifactsRenameMappingAtlassianLegacyLightMod.foo` */
