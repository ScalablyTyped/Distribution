...
version := "3.192.0-b31ba5"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "aws-sdk__client-cognito-identity" % "3.194.0-855406",
  "org.scalablytyped" %%% "aws-sdk__client-sso" % "3.193.0-f2d043",
  "org.scalablytyped" %%% "aws-sdk__client-sts" % "3.194.0-de8f4e",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-cognito-identity" % "3.194.0-7b6493",
  ...
  "org.scalablytyped" %%% "aws-sdk__credential-provider-node" % "3.193.0-3566b4",
