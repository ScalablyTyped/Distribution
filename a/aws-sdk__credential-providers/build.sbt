...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "aws-sdk__client-sts" % "3.197.0-044735",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-cognito-identity" % "3.197.0-8bdd32",
  ...
  "org.scalablytyped" %%% "aws-sdk__credential-provider-node" % "3.197.0-3f6496",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-process" % "3.197.0-714a36",
