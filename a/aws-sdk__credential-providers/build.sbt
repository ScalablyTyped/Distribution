...
version := "3.332.0-a72bb2"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "aws-sdk__client-cognito-identity" % "3.332.0-5ca0a8",
  "org.scalablytyped" %%% "aws-sdk__client-sso" % "3.332.0-74d7d4",
  "org.scalablytyped" %%% "aws-sdk__client-sts" % "3.332.0-f5fe90",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-cognito-identity" % "3.332.0-0b1237",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-imds" % "3.329.0-63e6e2",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-ini" % "3.332.0-a6c85d",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-node" % "3.332.0-965b83",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-process" % "3.329.0-bc6338",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-sso" % "3.332.0-dcabdd",
