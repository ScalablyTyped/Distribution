...
version := "3.192.0-51a39c"
scalaVersion := "3.2.0"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped" %%% "aws-sdk__client-cognito-identity" % "3.196.0-c1af56",
  "org.scalablytyped" %%% "aws-sdk__client-sso" % "3.196.0-1dc4de",
  "org.scalablytyped" %%% "aws-sdk__client-sts" % "3.196.0-1b3257",
  "org.scalablytyped" %%% "aws-sdk__credential-provider-cognito-identity" % "3.196.0-9f7cc1",
  ...
  "org.scalablytyped" %%% "aws-sdk__credential-provider-node" % "3.196.0-627d94",
