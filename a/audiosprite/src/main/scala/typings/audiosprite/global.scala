...
object global {
  ...
  inline def audiosprite(files: js.Array[String], callback: js.Function2[/* error */ Error, /* obj */ Result, Unit]): Unit = (js.Dynamic.global.applyDynamic("audiosprite")(files.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
