...
object cssPropertiesMod {
  ...
  - typings.aphrodite.cssPropertiesMod.CSSPropertiesLossy because Inheritance from two classes. Inlined  */ trait CSSProperties
    extends StObject
       ...
       with /* propertyName */ StringDictionary[
          js.UndefOr[
            String | Double | CSSPropertiesComplete | (js.Array[
              js.UndefOr[
                /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 258 */ Any
              ]
            ]) | CSSPropertiesLossy
          ]
        ]
