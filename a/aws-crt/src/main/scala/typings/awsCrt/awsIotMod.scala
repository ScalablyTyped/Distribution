...
import typings.awsCrt.authMod.WebsocketOptionsBase
import typings.awsCrt.nativeAuthMod.AwsCredentialsProvider
import typings.awsCrt.nativeHttpMod.HttpProxyOptions
import typings.awsCrt.nativeIoMod.SocketOptions
import typings.awsCrt.nativeIoMod.TlsContextOptions
...
import typings.awsCrt.nativeMqttMod.MqttWill
