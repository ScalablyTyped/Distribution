...
object distCommonHttpMod {
  ...
  object HttpVersion extends StObject {
    ...
    sealed trait Http1_0
      extends StObject
         with HttpVersion
    /* 1 */ val Http1_0: typings.awsCrt.distCommonHttpMod.HttpVersion.Http1_0 & Double = js.native
    ...
    sealed trait Http1_1
      extends StObject
         with HttpVersion
    /* 2 */ val Http1_1: typings.awsCrt.distCommonHttpMod.HttpVersion.Http1_1 & Double = js.native
    ...
    sealed trait Http2
      extends StObject
         with HttpVersion
    /* 3 */ val Http2: typings.awsCrt.distCommonHttpMod.HttpVersion.Http2 & Double = js.native
    
    @js.native
    sealed trait Unknown
      extends StObject
         with HttpVersion
    /* 0 */ val Unknown: typings.awsCrt.distCommonHttpMod.HttpVersion.Unknown & Double = js.native
  }
