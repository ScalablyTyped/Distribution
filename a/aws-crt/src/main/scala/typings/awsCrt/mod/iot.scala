...
object iot {
  ...
  @JSImport("aws-crt", "iot.AwsIotMqtt5ClientConfigBuilder")
  @js.native
  /* private */ open class AwsIotMqtt5ClientConfigBuilder ()
    extends typings.awsCrt.distNativeIotMod.AwsIotMqtt5ClientConfigBuilder
  /* static members */
  object AwsIotMqtt5ClientConfigBuilder {
    ...
    @JSImport("aws-crt", "iot.AwsIotMqtt5ClientConfigBuilder.DEFAULT_DIRECT_MQTT_PORT")
    @js.native
    ...
    @JSImport("aws-crt", "iot.AwsIotMqtt5ClientConfigBuilder.DEFAULT_WEBSOCKET_MQTT_PORT")
    @js.native
  ...
  /* private */ open class AwsIotMqttConnectionConfigBuilder ()
    extends typings.awsCrt.distNativeIotMod.AwsIotMqttConnectionConfigBuilder
  /* static members */
