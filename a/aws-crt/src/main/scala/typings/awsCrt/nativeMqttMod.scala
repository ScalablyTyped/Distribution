...
import typings.awsCrt.errorMod.CrtError
import typings.awsCrt.eventMod.BufferedEventEmitter
import typings.awsCrt.httpMod.HttpProxyAuthenticationType
import typings.awsCrt.mqttMod.MqttConnectionConnected
import typings.awsCrt.mqttMod.MqttConnectionDisconnected
import typings.awsCrt.mqttMod.MqttConnectionResumed
import typings.awsCrt.mqttMod.MqttRequest
import typings.awsCrt.mqttMod.MqttSubscribeRequest
...
import typings.awsCrt.nativeIoMod.ClientTlsContext
...
object nativeMqttMod {
  ...
  open class MqttWill protected ()
    extends typings.awsCrt.mqttMod.MqttWill {
    def this(
  ...
  trait MqttConnectionConfig extends StObject {
    ...
    var proxy_options: js.UndefOr[typings.awsCrt.nativeHttpMod.HttpProxyOptions] = js.undefined
    ...
    /**
      ...
      */
    var will: js.UndefOr[typings.awsCrt.mqttMod.MqttWill] = js.undefined
  }
  object MqttConnectionConfig {
    ...
    extension [Self <: MqttConnectionConfig](x: Self) {
      ...
      inline def setProxy_options(value: typings.awsCrt.nativeHttpMod.HttpProxyOptions): Self = StObject.set(x, "proxy_options", value.asInstanceOf[js.Any])
      ...
      inline def setWill(value: typings.awsCrt.mqttMod.MqttWill): Self = StObject.set(x, "will", value.asInstanceOf[js.Any])
