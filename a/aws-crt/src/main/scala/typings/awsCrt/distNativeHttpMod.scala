...
import typings.awsCrt.distCommonHttpMod.CommonHttpProxyOptions
import typings.awsCrt.distCommonHttpMod.HttpClientConnectionClosed
import typings.awsCrt.distCommonHttpMod.HttpClientConnectionConnected
import typings.awsCrt.distCommonHttpMod.HttpClientConnectionError
import typings.awsCrt.distCommonHttpMod.HttpHeader
import typings.awsCrt.distCommonHttpMod.HttpProxyAuthenticationType
import typings.awsCrt.distCommonHttpMod.HttpStreamComplete
import typings.awsCrt.distCommonHttpMod.HttpStreamData
import typings.awsCrt.distCommonHttpMod.HttpStreamError
...
object distNativeHttpMod {
  ...
  type HttpHeaders = typings.awsCrt.distNativeBindingMod.HttpHeaders
  ...
  open class HttpRequest protected ()
    extends typings.awsCrt.distNativeBindingMod.HttpRequest {
  ...
  type HttpStreamHeaders = js.Function1[/* headers */ typings.awsCrt.distNativeHttpMod.HttpHeaders, Unit]
  ...
  type nativeHttpRequest = typings.awsCrt.distNativeBindingMod.HttpRequest
}
