...
trait ProtocolMessageOptions extends StObject {
...
object ProtocolMessageOptions {
  
  inline def apply(message: Message): ProtocolMessageOptions = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProtocolMessageOptions]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: ProtocolMessageOptions] (val x: Self) extends AnyVal {
