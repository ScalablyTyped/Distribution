...
trait ITouchSpinConfigProvider extends js.Object {
  def defaults(
    touchSpinOptions: typings.angularDashTouchspin.angularDashTouchspinMod.angularTouchspinNs.ITouchSpinOptions
  ): Unit
}
...
object ITouchSpinConfigProvider {
  @scala.inline
  def apply(
    defaults: typings.angularDashTouchspin.angularDashTouchspinMod.angularTouchspinNs.ITouchSpinOptions => Unit
