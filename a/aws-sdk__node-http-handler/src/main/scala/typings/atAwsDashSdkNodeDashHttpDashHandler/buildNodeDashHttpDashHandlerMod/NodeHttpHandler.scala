package typings.atAwsDashSdkNodeDashHttpDashHandler.buildNodeDashHttpDashHandlerMod
...
@JSImport("@aws-sdk/node-http-handler/build/node-http-handler", "NodeHttpHandler")
@js.native
