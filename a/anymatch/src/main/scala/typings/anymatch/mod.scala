...
object mod {
  ...
  trait CurrriedMatcher extends StObject {
    ...
    def apply(testString: String, returnIndex: Boolean, startIndex: Unit, endIndex: Double): Boolean = js.native
    def apply(testString: String, returnIndex: Unit, startIndex: Double): Boolean = js.native
    def apply(testString: String, returnIndex: Unit, startIndex: Double, endIndex: Double): Boolean = js.native
    def apply(testString: String, returnIndex: Unit, startIndex: Unit, endIndex: Double): Boolean = js.native
    ...
    def apply(testString: String, returnIndex: `true`, startIndex: Unit, endIndex: Double): Double = js.native
    ...
    def apply(testString: js.Array[String], returnIndex: Boolean, startIndex: Unit, endIndex: Double): Boolean = js.native
    def apply(testString: js.Array[String], returnIndex: Unit, startIndex: Double): Boolean = js.native
    def apply(testString: js.Array[String], returnIndex: Unit, startIndex: Double, endIndex: Double): Boolean = js.native
    def apply(testString: js.Array[String], returnIndex: Unit, startIndex: Unit, endIndex: Double): Boolean = js.native
    ...
    def apply(testString: js.Array[String], returnIndex: `true`, startIndex: Unit, endIndex: Double): Double = js.native
  }
