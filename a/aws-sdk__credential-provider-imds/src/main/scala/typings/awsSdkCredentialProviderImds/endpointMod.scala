...
object endpointMod {
  ...
  object Endpoint extends StObject {
    ...
    sealed trait IPv4
      extends StObject
         with Endpoint
    /* "http://169.254.169.254" */ val IPv4: typings.awsSdkCredentialProviderImds.endpointMod.Endpoint.IPv4 & String = js.native
    
    @js.native
    sealed trait IPv6
      extends StObject
         with Endpoint
    /* "http://[fd00:ec2::254]" */ val IPv6: typings.awsSdkCredentialProviderImds.endpointMod.Endpoint.IPv6 & String = js.native
  }
}
