...
object distTypesConfigEndpointModeMod {
  ...
  object EndpointMode extends StObject {
    ...
    sealed trait IPv4
      extends StObject
         with EndpointMode
    /* "IPv4" */ val IPv4: typings.awsSdkCredentialProviderImds.distTypesConfigEndpointModeMod.EndpointMode.IPv4 & String = js.native
    
    @js.native
    sealed trait IPv6
      extends StObject
         with EndpointMode
    /* "IPv6" */ val IPv6: typings.awsSdkCredentialProviderImds.distTypesConfigEndpointModeMod.EndpointMode.IPv6 & String = js.native
  }
}
