...
object ^ extends js.Object {
  ...
  /**
    ...
    * ```
    */
  def getDevices(callback: js.Function1[/* devices */ js.Array[MediaDeviceInfo], scala.Unit]): scala.Unit = js.native
  /**
    ...
    * ```
    */
  def getScreenSources(callback: js.Function1[/* sources */ js.Array[DesktopCapturerSource], scala.Unit]): scala.Unit = js.native
  /**
    ...
    * ```
    */
  def getSupportedCodec(): js.Promise[agoraDashRtcDashSdkLib.Anon_Audio] = js.native
  def getSupportedCodec(supportedCodecOptions: agoraDashRtcDashSdkLib.Anon_Stream): js.Promise[agoraDashRtcDashSdkLib.Anon_Audio] = js.native
}
