...
trait Anon_Contain extends js.Object {
  /**
    ...
    */
  var fit: js.UndefOr[
    agoraDashRtcDashSdkLib.agoraDashRtcDashSdkLibStrings.cover | agoraDashRtcDashSdkLib.agoraDashRtcDashSdkLibStrings.contain
  ] = js.undefined
  /**
...
object Anon_Contain {
  @scala.inline
  def apply(
    fit: agoraDashRtcDashSdkLib.agoraDashRtcDashSdkLibStrings.cover | agoraDashRtcDashSdkLib.agoraDashRtcDashSdkLibStrings.contain = null,
