...
import typings.agoraDashRtcDashSdk.Anon_CacheResource
import typings.agoraDashRtcDashSdk.Anon_Contain
import typings.agoraDashRtcDashSdk.Anon_Cycle
import typings.agoraDashRtcDashSdk.Anon_SoundId
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.accessAllowed
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.accessDenied
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.audio
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.audioMixingFinished
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.audioMixingPlayed
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.high_quality
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.high_quality_stereo
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.music_standard
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.speech_low_quality
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.speech_standard
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.standard_stereo
import typings.agoraDashRtcDashSdk.agoraDashRtcDashSdkStrings.stopScreenSharing
...
trait Stream extends js.Object {
  ...
  /**
    ...
    * ```
    */
  def getEffectsVolume(): js.Array[Anon_SoundId] = js.native
  /**
  ...
  def play(HTMLElementID: String, option: Anon_Contain): Unit = js.native
  /**
    ...
    * ```
    */
  def playEffect(options: Anon_Cycle): Unit = js.native
  def playEffect(options: Anon_Cycle, callback: js.Function1[/* err */ String | Null, Unit]): Unit = js.native
  /**
  ...
  /**
    ...
    * ```
    */
  def startAudioMixing(options: Anon_CacheResource): Unit = js.native
  def startAudioMixing(options: Anon_CacheResource, callback: js.Function1[/* err */ String | Null, Unit]): Unit = js.native
  /**
