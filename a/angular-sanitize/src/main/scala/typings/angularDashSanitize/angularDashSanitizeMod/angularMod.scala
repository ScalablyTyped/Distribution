...
import typings.angularDashSanitize.angularDashSanitizeMod.angularMod.sanitize.ISanitizeProvider
import typings.angularDashSanitize.angularDashSanitizeMod.angularMod.sanitize.filter.ILinky
