...
trait ISanitizeProvider extends js.Object {
  /**
    ...
    */
  def addValidAttrs(attrs: js.Array[java.lang.String]): ISanitizeProvider = js.native
  def addValidElements(elements: angularDashSanitizeLib.Anon_HtmlElements): ISanitizeProvider = js.native
  /**
    ...
    */
  def addValidElements(elements: js.Array[java.lang.String]): ISanitizeProvider = js.native
  def enableSvg(): scala.Boolean | ISanitizeProvider = js.native
  def enableSvg(flag: scala.Boolean): scala.Boolean | ISanitizeProvider = js.native
  /**
    ...
    */
  @JSName("enableSvg")
  def enableSvg_Boolean(): scala.Boolean = js.native
  @JSName("enableSvg")
  def enableSvg_ISanitizeProvider(flag: scala.Boolean): ISanitizeProvider = js.native
}
