...
import typings.azureCoreHttp.operationParameterMod.OperationParameter
import typings.azureCoreHttp.operationParameterMod.OperationQueryParameter
import typings.azureCoreHttp.operationParameterMod.OperationURLParameter
