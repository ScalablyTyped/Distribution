package typings.atAwsDashSdkLogger.atAwsDashSdkLoggerMod

import typings.atAwsDashSdkTypes.buildLoggerMod.LoggerOptions
...
class Logger protected ()
  extends typings.atAwsDashSdkTypes.buildLoggerMod.Logger {
