...
object DrivingPolicy extends js.Object {
  ...
  /* 2 */ val LEAST_DISTANCE: typings.amapDashJsDashSdk.AMapNs.DrivingPolicy.LEAST_DISTANCE with Double = js.native
  /* 1 */ val LEAST_FEE: typings.amapDashJsDashSdk.AMapNs.DrivingPolicy.LEAST_FEE with Double = js.native
  /* 0 */ val LEAST_TIME: typings.amapDashJsDashSdk.AMapNs.DrivingPolicy.LEAST_TIME with Double = js.native
  /* 3 */ val REAL_TRAFFIC: typings.amapDashJsDashSdk.AMapNs.DrivingPolicy.REAL_TRAFFIC with Double = js.native
  @JSBracketAccess
