...
package object mod {
  ...
  type RenderMethod = js.Function3[
    ...
    /* options */ js.UndefOr[typings.vision.mod.ServerViewsConfiguration], 
    js.Promise[java.lang.String]
  ]
  type RuntimeOptions = js.Object
  type ServerViewCompile = typings.vision.mod.ServerViewCompileSync | typings.vision.mod.ServerViewCompileAsync
  type ServerViewCompileAsync = js.Function3[
    /* template */ java.lang.String, 
    /* options */ js.Any, 
    /* next */ typings.vision.mod.ServerViewCompileNext, 
    scala.Unit
  ]
