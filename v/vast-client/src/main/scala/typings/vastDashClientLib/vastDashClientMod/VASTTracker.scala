...
class VASTTracker protected ()
  ...
  ad: VastAd, /**
    ...
    */
  creative: VastCreativeLinear) = this()
  /**
  ...
  creative: VastCreativeLinear, /**
    ...
    */
  variation: VastCreativeCompanion) = this()
  def this(/**
    * An optional instance of VASTClient that can be updated by the tracker.
    */
  client: scala.Null, /**
  ...
  creative: VastCreativeLinear, /**
    * An optional variation of the creative, for Companion and NonLinear Ads
    */
  variation: VastCreativeNonLinear) = this()
  def this(/**
    * An optional instance of VASTClient that can be updated by the tracker.
    */
  client: VASTClient, /**
  ...
  def setExpand(/**
    ...
    */
  expanded: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def setFullscreen(/**
    ...
    */
  fullscreen: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def setMuted(/**
    ...
    */
  muted: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def setPaused(/**
    ...
    */
  paused: scala.Boolean): scala.Unit = js.native
  /**
  ...
  def setProgress(/**
    ...
    */
  progress: scala.Double): scala.Unit = js.native
  /**
  ...
  def setSkipDelay(/**
    ...
    */
  duration: scala.Double): scala.Unit = js.native
  /**
  ...
  /**
    ...
    */
  def trackImpression(): scala.Unit = js.native
}
