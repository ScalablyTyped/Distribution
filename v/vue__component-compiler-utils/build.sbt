...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "consolidate" % "0.0-unknown-dt-20180712Z-fcccf1",
  "org.scalablytyped" %%% "escape-string-regexp" % "1.0-dt-20180721Z-cb7b0b",
  "org.scalablytyped" %%% "hash-sum" % "1.0-dt-20180822Z-25f982",
  ...
  "org.scalablytyped" %%% "prettier" % "1.15-dt-20181124Z-61da16",
