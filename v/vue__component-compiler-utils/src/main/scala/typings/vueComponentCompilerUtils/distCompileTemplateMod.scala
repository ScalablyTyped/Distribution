...
import typings.vueComponentCompilerUtils.distTemplateCompilerModulesAssetUrlMod.AssetURLOptions
import typings.vueComponentCompilerUtils.distTemplateCompilerModulesAssetUrlMod.TransformAssetUrlsOptions
import typings.vueComponentCompilerUtils.distTypesMod.ErrorWithRange
import typings.vueComponentCompilerUtils.distTypesMod.VueTemplateCompiler
import typings.vueComponentCompilerUtils.distTypesMod.VueTemplateCompilerOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distCompileTemplateMod {
  ...
  trait TemplateCompileOptions extends StObject {
    ...
    var transpileOptions: js.UndefOr[Any] = js.undefined
  }
  object TemplateCompileOptions {
    ...
    implicit open class MutableBuilder[Self <: TemplateCompileOptions] (val x: Self) extends AnyVal {
      ...
      inline def setTranspileOptions(value: Any): Self = StObject.set(x, "transpileOptions", value.asInstanceOf[js.Any])
