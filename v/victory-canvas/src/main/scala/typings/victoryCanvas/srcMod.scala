...
object srcMod {
  ...
  @JSImport("victory-canvas/src", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("victory-canvas/src", "CanvasBar")
  @js.native
  ...
  @JSImport("victory-canvas/src", "CanvasCurve")
  @js.native
  ...
  @JSImport("victory-canvas/src", "CanvasGroup")
  @js.native
  ...
  @JSImport("victory-canvas/src", "CanvasPoint")
  @js.native
