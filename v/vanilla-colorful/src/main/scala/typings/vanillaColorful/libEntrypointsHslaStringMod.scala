...
object libEntrypointsHslaStringMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsla-string", "HslaStringBase")
  @js.native
  open class HslaStringBase () extends AlphaColorPicker[String] {
