...
import typings.vanillaColorful.anon.ValueHsvaColor
...
object libEntrypointsHsvaMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsva", "HsvaBase")
  @js.native
  open class HsvaBase () extends AlphaColorPicker[HsvaColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHsvaColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueHsvaColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHsvaColor]]): Unit = js.native
    @JSName("removeEventListener")
