...
object libEntrypointsHsvStringMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsv-string", "HsvStringBase")
  @js.native
  open class HsvStringBase () extends ColorPicker[String] {
