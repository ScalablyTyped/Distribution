...
import typings.vanillaColorful.anon.ValueHslColor
...
object libEntrypointsHslMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsl", "HslBase")
  @js.native
  open class HslBase () extends ColorPicker[HslColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHslColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueHslColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHslColor]]): Unit = js.native
    @JSName("removeEventListener")
