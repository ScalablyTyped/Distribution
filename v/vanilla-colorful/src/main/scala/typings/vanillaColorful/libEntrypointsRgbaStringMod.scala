...
object libEntrypointsRgbaStringMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/rgba-string", "RgbaStringBase")
  @js.native
  open class RgbaStringBase () extends AlphaColorPicker[String] {
