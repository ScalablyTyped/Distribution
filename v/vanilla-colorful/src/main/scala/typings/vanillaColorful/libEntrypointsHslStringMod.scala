...
object libEntrypointsHslStringMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsl-string", "HslStringBase")
  @js.native
  open class HslStringBase () extends ColorPicker[String] {
