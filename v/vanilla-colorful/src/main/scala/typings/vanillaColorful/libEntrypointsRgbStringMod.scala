...
import typings.vanillaColorful.libComponentsColorPickerMod.ColorPicker
...
object libEntrypointsRgbStringMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/rgb-string", "RgbStringBase")
  @js.native
  open class RgbStringBase () extends ColorPicker[String] {
