...
object libEntrypointsHexAlphaMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hex-alpha", "HexAlphaBase")
  @js.native
  open class HexAlphaBase () extends AlphaColorPicker[String] {
