...
object libEntrypointsHexInputMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hex-input", "HexInputBase")
  @js.native
  open class HexInputBase ()
    extends StObject
       with HTMLElement {
    ...
    def alpha_=(alpha: Boolean): Unit = js.native
    ...
    def attributeChangedCallback(attr: String, _oldVal: String, newVal: String): Unit = js.native
    ...
    def color_=(hex: String): Unit = js.native
    ...
    def prefixed: Boolean = js.native
    def prefixed_=(prefixed: Boolean): Unit = js.native
