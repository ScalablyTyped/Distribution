...
import typings.vanillaColorful.anon.ValueRgbaColor
...
object libEntrypointsRgbaMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/rgba", "RgbaBase")
  @js.native
  open class RgbaBase () extends AlphaColorPicker[RgbaColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueRgbaColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueRgbaColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueRgbaColor]]): Unit = js.native
    @JSName("removeEventListener")
