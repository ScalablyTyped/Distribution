...
import typings.vanillaColorful.anon.ValueRgbColor
...
object libEntrypointsRgbMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/rgb", "RgbBase")
  @js.native
  open class RgbBase () extends ColorPicker[RgbColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueRgbColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueRgbColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueRgbColor]]): Unit = js.native
    @JSName("removeEventListener")
