...
import typings.vanillaColorful.anon.ValueHslaColor
...
object libEntrypointsHslaMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsla", "HslaBase")
  @js.native
  open class HslaBase () extends AlphaColorPicker[HslaColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHslaColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueHslaColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHslaColor]]): Unit = js.native
    @JSName("removeEventListener")
