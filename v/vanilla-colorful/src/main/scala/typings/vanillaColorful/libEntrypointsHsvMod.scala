...
import typings.vanillaColorful.anon.ValueHsvColor
...
object libEntrypointsHsvMod {
  
  @JSImport("vanilla-colorful/lib/entrypoints/hsv", "HsvBase")
  @js.native
  open class HsvBase () extends ColorPicker[HsvColor] {
    ...
    @JSName("addEventListener")
    def addEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHsvColor]]): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
      `type`: `color-changed`,
      listener: ColorPickerEventListener[CustomEvent[ValueHsvColor]],
      options: Boolean
    ): Unit = js.native
    @JSName("addEventListener")
    def addEventListener_colorchanged(
    ...
    @JSName("removeEventListener")
    def removeEventListener_colorchanged(`type`: `color-changed`, listener: ColorPickerEventListener[CustomEvent[ValueHsvColor]]): Unit = js.native
    @JSName("removeEventListener")
