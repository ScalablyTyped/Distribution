...
@js.native
object isMobilePhone_any extends js.Object {
  def apply(str: String, locale: any): Boolean = js.native
  def apply(str: String, locale: any, options: typings.validator.validatorMod.IsMobilePhoneOptions): Boolean = js.native
}
