...
object matchesMod {
  ...
  /**
    ...
    * @param pattern - `/foo/i`
    */
  inline def default(str: String, pattern: RegExp): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(str.asInstanceOf[js.Any], pattern.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
