...
object isNumericMod {
  ...
  @scala.inline
  def default(str: String, options: typings.validator.mod.validator.IsNumericOptions): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(str.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
