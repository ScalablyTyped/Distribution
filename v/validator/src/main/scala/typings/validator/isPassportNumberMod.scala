...
object isPassportNumberMod {
  ...
  @scala.inline
  def default(str: String, countryCode: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(str.asInstanceOf[js.Any], countryCode.asInstanceOf[js.Any])).asInstanceOf[Boolean]
}
