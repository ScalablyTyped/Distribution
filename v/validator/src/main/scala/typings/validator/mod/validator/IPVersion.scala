...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.validator.validatorNumbers.`6`
  - typings.validator.validatorStrings.`4`
  - typings.validator.validatorStrings.`6`
*/
...
object IPVersion {
  ...
  @scala.inline
  def `6`: typings.validator.validatorNumbers.`6` = 6.asInstanceOf[typings.validator.validatorNumbers.`6`]
}
