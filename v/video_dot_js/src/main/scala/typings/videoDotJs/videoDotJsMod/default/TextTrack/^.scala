package typings.videoDotJs.videoDotJsMod.default.TextTrack
...
@js.native
class ^ protected ()
  extends typings.videoDotJs.videoDotJsMod.videojs.TextTrack {
  /**
...
object ^
  ...
  *        If this track should default to on or off.
  */
Instantiable1[/* options */ TextTrackOptions, typings.videoDotJs.videoDotJsMod.videojs.TextTrack]
    ]
