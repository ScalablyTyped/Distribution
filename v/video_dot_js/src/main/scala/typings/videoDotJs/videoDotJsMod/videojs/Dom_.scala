...
import typings.videoDotJs.videoDotJsMod.videojs.Dom.Coordinates
import typings.videoDotJs.videoDotJsMod.videojs.Dom.Predicate
import typings.videoDotJs.videoDotJsStrings.canvas
import typings.videoDotJs.videoDotJsStrings.form
import typings.videoDotJs.videoDotJsStrings.img
import typings.videoDotJs.videoDotJsStrings.input
import typings.videoDotJs.videoDotJsStrings.option
import typings.videoDotJs.videoDotJsStrings.select
import typings.videoDotJs.videoDotJsStrings.textarea
...
trait Dom_ extends js.Object {
  ...
  /**
    ...
    */
  def isSingleLeftClick(event: typings.videoDotJs.videoDotJsMod.videojs.EventTarget.Event): Boolean = js.native
  /**
