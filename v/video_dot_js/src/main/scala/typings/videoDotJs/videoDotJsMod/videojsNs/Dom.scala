...
import typings.videoDotJs.videoDotJsMod.videojsNs.DomNs.Coordinates
...
trait Dom extends js.Object {
  ...
  /**
  		 ...
  		 */
  def isSingleLeftClick(event: typings.videoDotJs.videoDotJsMod.videojsNs.EventTargetNs.Event): Boolean = js.native
  /**
