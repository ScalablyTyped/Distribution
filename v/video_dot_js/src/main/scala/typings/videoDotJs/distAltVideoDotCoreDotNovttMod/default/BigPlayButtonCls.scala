...
import typings.videoDotJs.videoDotJsMod.videojs.BigPlayButton
...
@JSImport("video.js/dist/alt/video.core.novtt", "BigPlayButton")
@js.native
class BigPlayButtonCls protected () extends BigPlayButton {
  /**
