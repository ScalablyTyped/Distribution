...
@JSImport("video.js/dist/alt/video.core.novtt", "MediaError")
@js.native
object MediaError
  extends /**
  ...
  */
Instantiable1[
      (/* value */ Double) | (/* value */ typings.videoDotJs.videoDotJsMod.videojs.MediaError) | (/* value */ String) | (/* value */ StringDictionary[js.Any]), 
      typings.videoDotJs.videoDotJsMod.videojs.MediaError
    ] {
  /**
