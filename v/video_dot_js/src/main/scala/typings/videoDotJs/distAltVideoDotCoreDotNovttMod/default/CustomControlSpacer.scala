...
@JSImport("video.js/dist/alt/video.core.novtt", "CustomControlSpacer")
@js.native
object CustomControlSpacer
  ...
  */
Instantiable1[/* player */ Player, typings.videoDotJs.videoDotJsMod.videojs.CustomControlSpacer]
     with Instantiable2[
      /* player */ Player, 
      /* options */ ComponentOptions, 
      typings.videoDotJs.videoDotJsMod.videojs.CustomControlSpacer
    ]
     with Instantiable3[
      /* player */ Player, 
      /* options */ ComponentOptions, 
