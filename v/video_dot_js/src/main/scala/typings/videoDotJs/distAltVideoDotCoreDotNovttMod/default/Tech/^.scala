package typings.videoDotJs.distAltVideoDotCoreDotNovttMod.default.Tech

import org.scalablytyped.runtime.Instantiable0
import org.scalablytyped.runtime.Instantiable1
import org.scalablytyped.runtime.Instantiable2
import org.scalablytyped.runtime.TopLevel
import typings.videoDotJs.TypeofTech
...
/**
  ...
  */
class ^ ()
  extends typings.videoDotJs.videoDotJsMod.videojs.Tech {
...
object ^
  ...
  *        Callback function to call when the `HTML5` Tech is ready.
  */
Instantiable0[typings.videoDotJs.videoDotJsMod.videojs.Tech]) with (Instantiable1[/* options */ js.Any, typings.videoDotJs.videoDotJsMod.videojs.Tech]) with (Instantiable2[
        /* options */ js.Any, 
        /* ready */ ReadyCallback, 
        typings.videoDotJs.videoDotJsMod.videojs.Tech
      ])
    ] {
  /**
  ...
  /**
    ...
    */
  def getTech(name: String): js.UndefOr[typings.videoDotJs.videoDotJsMod.videojs.Tech] = js.native
  /**
