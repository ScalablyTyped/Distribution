...
trait TextTrack extends Track {
  ...
  /**
  		 ...
  		 */
  var mode: videoDotJsLib.videoDotJsMod.videojsNs.TextTrackNs.Mode = js.native
  /**
  		 ...
  		 */
  def addCue(cue: videoDotJsLib.videoDotJsMod.videojsNs.TextTrackCueListNs.TextTrackCue): scala.Unit = js.native
  /**
  		 ...
  		 */
  def removeCue(cue: videoDotJsLib.videoDotJsMod.videojsNs.TextTrackCueListNs.TextTrackCue): scala.Unit = js.native
}
