...
trait MenuButton extends Component {
  ...
  /**
  		 ...
  		 */
  def buildWrapperCSSClass(): java.lang.String = js.native
  /**
  ...
  def controlText(text: java.lang.String, el: stdLib.Element): java.lang.String = js.native
  /**
  ...
  /**
  		 ...
  		 * @listens keydown
  		 */
  def handleSubmenuKeyPress(event: videoDotJsLib.videoDotJsMod.videojsNs.EventTargetNs.Event): scala.Unit = js.native
  /**
  		 * Put the current `MenuButton` into a pressed state.
  		 */
  def pressButton(): scala.Unit = js.native
  /**
  		 * Take the current `MenuButton` out of a pressed state.
  		 */
  def unpressButton(): scala.Unit = js.native
  /**
