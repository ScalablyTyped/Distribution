...
trait ModalDialog extends Component {
  ...
  /**
  		 ...
  		 */
  def closeable(value: scala.Boolean): scala.Boolean = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def fillWith(): scala.Unit = js.native
  def fillWith(content: Content): scala.Unit = js.native
  /**
  		 * Keydown handler. Attached when modal is focused.
  		 *
  		 * @listens keydown
  		 */
  def handleKeyDown(): scala.Unit = js.native
  /**
  		 ...
  		 * @listens keydown
  		 */
  def handleKeyPress(e: videoDotJsLib.videoDotJsMod.videojsNs.EventTargetNs.Event): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def opened(): scala.Boolean = js.native
  def opened(value: scala.Boolean): scala.Boolean = js.native
}
