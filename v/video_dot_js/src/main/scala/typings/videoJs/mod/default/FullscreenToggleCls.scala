...
import typings.videoJs.mod.videojs.FullscreenToggle
...
@JSImport("video.js", "default.FullscreenToggle")
@js.native
class FullscreenToggleCls protected () extends FullscreenToggle {
  /**
