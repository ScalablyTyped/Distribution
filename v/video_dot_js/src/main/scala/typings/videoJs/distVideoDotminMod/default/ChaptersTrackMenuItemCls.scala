...
import typings.videoJs.mod.videojs.ChaptersTrackMenuItem
...
@JSImport("video.js/dist/video.min", "default.ChaptersTrackMenuItem")
@js.native
open class ChaptersTrackMenuItemCls protected ()
  extends StObject
     with ChaptersTrackMenuItem {
  /**
