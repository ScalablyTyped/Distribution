...
@scala.inline
def apply(id: js.Any): typings.videoJs.mod.videojs.Player = typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].apply(id.asInstanceOf[js.Any]).asInstanceOf[typings.videoJs.mod.videojs.Player]
@scala.inline
def apply(id: js.Any, options: scala.Unit, ready: js.Function0[scala.Unit]): typings.videoJs.mod.videojs.Player = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].apply(id.asInstanceOf[js.Any], options.asInstanceOf[js.Any], ready.asInstanceOf[js.Any])).asInstanceOf[typings.videoJs.mod.videojs.Player]
@scala.inline
def apply(id: js.Any, options: typings.videoJs.mod.videojs.PlayerOptions): typings.videoJs.mod.videojs.Player = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].apply(id.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typings.videoJs.mod.videojs.Player]
@scala.inline
...
/**
  ...
  */
@scala.inline
def bind[F /* <: js.Function0[js.Any] */](context: js.Any, fn: F): F = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("bind")(context.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[F]
@scala.inline
def bind[F /* <: js.Function0[js.Any] */](context: js.Any, fn: F, uid: scala.Double): F = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("bind")(context.asInstanceOf[js.Any], fn.asInstanceOf[js.Any], uid.asInstanceOf[js.Any])).asInstanceOf[F]
...
@scala.inline
def createTimeRanges(start: scala.Unit, end: scala.Double): typings.videoJs.mod.videojs.TimeRange = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("createTimeRanges")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typings.videoJs.mod.videojs.TimeRange]
...
@scala.inline
def hookOnce(`type`: java.lang.String, fn: js.Array[js.Function0[js.Any]]): scala.Unit = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("hookOnce")(`type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def hookOnce(`type`: java.lang.String, fn: js.Function0[js.Any]): scala.Unit = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("hookOnce")(`type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def hooks(`type`: java.lang.String, fn: js.Array[js.Function0[js.Any]]): scala.Unit = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("hooks")(`type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
@scala.inline
def hooks(`type`: java.lang.String, fn: js.Function0[js.Any]): scala.Unit = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("hooks")(`type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
/**
  ...
  */
@scala.inline
def mergeOptions[A, B, C, D, E, F](option: A): A & B & C & D & E & F = typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("mergeOptions")(option.asInstanceOf[js.Any]).asInstanceOf[A & B & C & D & E & F]
@scala.inline
def mergeOptions[A, B, C, D, E, F](option: A, option2: B): A & B & C & D & E & F = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("mergeOptions")(option.asInstanceOf[js.Any], option2.asInstanceOf[js.Any])).asInstanceOf[A & B & C & D & E & F]
@scala.inline
def mergeOptions[A, B, C, D, E, F](option: A, option2: B, option3: C): A & B & C & D & E & F = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("mergeOptions")(option.asInstanceOf[js.Any], option2.asInstanceOf[js.Any], option3.asInstanceOf[js.Any])).asInstanceOf[A & B & C & D & E & F]
@scala.inline
...
@scala.inline
def mergeOptions[A, B, C, D, E, F](option: A, option2: scala.Unit, option3: C): A & B & C & D & E & F = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("mergeOptions")(option.asInstanceOf[js.Any], option2.asInstanceOf[js.Any], option3.asInstanceOf[js.Any])).asInstanceOf[A & B & C & D & E & F]
@scala.inline
...
/**
  ...
  */
@scala.inline
def removeHook(`type`: java.lang.String, fn: js.Function0[js.Any]): scala.Boolean = (typings.videoJs.videoCoreNovttMod.default.^.asInstanceOf[js.Dynamic].applyDynamic("removeHook")(`type`.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
