...
object anon {
  ...
  trait Codepoints extends StObject {
    
    var codepoints: StringDictionary[String]
  ...
  object Codepoints {
    ...
    inline def apply(codepoints: StringDictionary[String], fontName: String, src: String): Codepoints = {
      val __obj = js.Dynamic.literal(codepoints = codepoints.asInstanceOf[js.Any], fontName = fontName.asInstanceOf[js.Any], src = src.asInstanceOf[js.Any])
      __obj.asInstanceOf[Codepoints]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: Codepoints] (val x: Self) extends AnyVal {
      
      inline def setCodepoints(value: StringDictionary[String]): Self = StObject.set(x, "codepoints", value.asInstanceOf[js.Any])
  ...
  object FontName {
    ...
    inline def apply(fontName: String, styles: String): FontName = {
      val __obj = js.Dynamic.literal(fontName = fontName.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
  ...
  object TypeofAST {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TypeofAST] (val x: Self) extends AnyVal {
  ...
  trait TypeofHandlebars extends StObject {
    ...
    def noConflict(): typings.handlebars.anon.TypeofHandlebars = js.native
