...
object ReliabilityKind extends js.Object {
  ...
  /* 1 */ val BestEffort: typings.vortexDashWebDashClient.DDSNs.ReliabilityKind.BestEffort with Double = js.native
  /* 0 */ val Reliable: typings.vortexDashWebDashClient.DDSNs.ReliabilityKind.Reliable with Double = js.native
  @JSBracketAccess
