...
class DataCache protected () extends js.Object {
  /**
  		 ...
  		 */
  def this(depth: scala.Double, cache: js.Any) = this()
  /**
  ...
  /**
  		 ...
  		 */
  def filter(f: js.Function1[/* data */ js.Any, scala.Boolean]): js.Array[_] = js.native
  /**
  		 ...
  		 */
  def filterNot(f: js.Function1[/* data */ js.Any, scala.Boolean]): js.Array[_] = js.native
  /**
  		 ...
  		 */
  def fold(z: js.Any, f: js.Function1[/* data */ js.Any, _]): scala.Unit = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def forEachN(f: js.Function1[/* data */ js.Any, _], n: scala.Double): js.Array[_] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def takeWithFilter(f: js.Function1[/* data */ js.Any, scala.Boolean]): js.Array[_] = js.native
  /**
