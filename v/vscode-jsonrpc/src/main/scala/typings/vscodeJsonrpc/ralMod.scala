...
object ralMod {
  ...
  trait MessageBuffer extends StObject {
    ...
    val encoding: typings.vscodeJsonrpc.ralMod.RAL.MessageBufferEncoding = js.native
  ...
  */
  ...
  object RAL {
    ...
    type DuplexStream = typings.vscodeJsonrpc.ralMod.DuplexStream
    
    type MessageBuffer = typings.vscodeJsonrpc.ralMod.MessageBuffer
    
    type MessageBufferEncoding = typings.vscodeJsonrpc.ralMod.MessageBufferEncoding
    ...
    type ReadableStream = typings.vscodeJsonrpc.ralMod.ReadableStream
    
    type WritableStream = typings.vscodeJsonrpc.ralMod.WritableStream
  }
