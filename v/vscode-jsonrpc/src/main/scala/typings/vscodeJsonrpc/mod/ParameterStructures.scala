...
@JSImport("vscode-jsonrpc", "ParameterStructures")
@js.native
/* private */ open class ParameterStructures ()
  extends typings.vscodeJsonrpc.libCommonMessagesMod.ParameterStructures
/* static members */
object ParameterStructures {
  ...
  /**
    ...
    */
  @JSImport("vscode-jsonrpc", "ParameterStructures.auto")
  @js.native
  ...
  /**
    ...
    * parameters.
    */
  @JSImport("vscode-jsonrpc", "ParameterStructures.byName")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-jsonrpc", "ParameterStructures.byPosition")
  @js.native
