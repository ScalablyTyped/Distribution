...
trait MessageConnection extends js.Object {
  ...
  def sendRequest[R, E, RO](`type`: typings.vscodeJsonrpc.messagesMod.RequestType0[R, E, RO]): Thenable[R] = js.native
  ...
  def sendRequest[P1, R, E, RO](`type`: typings.vscodeJsonrpc.messagesMod.RequestType1[P1, R, E, RO], p1: P1): Thenable[R] = js.native
  def sendRequest[P1, R, E, RO](
    `type`: typings.vscodeJsonrpc.messagesMod.RequestType1[P1, R, E, RO],
    p1: P1,
    token: typings.vscodeJsonrpc.cancellationMod.CancellationToken
  ): Thenable[R] = js.native
  def sendRequest[P, R, E, RO](`type`: typings.vscodeJsonrpc.messagesMod.RequestType[P, R, E, RO], params: P): Thenable[R] = js.native
  def sendRequest[P, R, E, RO](
    `type`: typings.vscodeJsonrpc.messagesMod.RequestType[P, R, E, RO],
    params: P,
    token: typings.vscodeJsonrpc.cancellationMod.CancellationToken
  ): Thenable[R] = js.native
  def sendRequest[P1, P2, R, E, RO](`type`: typings.vscodeJsonrpc.messagesMod.RequestType2[P1, P2, R, E, RO], p1: P1, p2: P2): Thenable[R] = js.native
