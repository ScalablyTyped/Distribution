...
trait OmitWrapperLikeexists extends StObject {
  ...
  def getComponent[T /* <: scala.Nothing */](selector: String): Omit[WrapperLike, exists]
  @JSName("getComponent")
  var getComponent_Original: js.Function1[/* selector */ String, Omit[WrapperLike, exists]]
...
object OmitWrapperLikeexists {
  ...
  inline def apply(
    ...
    getComponent: /* selector */ String => Omit[WrapperLike, exists],
    html: () => String,
    isVisible: () => Boolean,
  ...
  implicit open class MutableBuilder[Self <: OmitWrapperLikeexists] (val x: Self) extends AnyVal {
    ...
    inline def setGetComponent(value: /* selector */ String => Omit[WrapperLike, exists]): Self = StObject.set(x, "getComponent", js.Any.fromFunction1(value))
