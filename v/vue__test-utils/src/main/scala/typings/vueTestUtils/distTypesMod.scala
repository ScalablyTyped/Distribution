...
import typings.vueTestUtils.anon.Iterator
import typings.vueTestUtils.anon.PartialOmitAppConfigisNat
...
object distTypesMod {
  ...
  object MountingOptions {
    ...
    implicit open class MutableBuilder[Self <: MountingOptions[?, ?], Props, Data] (val x: Self & (MountingOptions[Props, Data])) extends AnyVal {
      ...
      inline def setData(
        value: () => /* import warning: importer.ImportType#apply Failed type conversion: {} extends Data ? any : Data extends object ? std.Partial<Data> : any */ js.Any
