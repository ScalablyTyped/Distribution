...
trait ComponentDoc
  ...
  var expose: js.UndefOr[js.Array[ExposedDescriptor]] = js.undefined
  ...
  var tags: StringDictionary[js.Array[BlockTag]]
}
object ComponentDoc {
  
  inline def apply(displayName: String, exportName: String, tags: StringDictionary[js.Array[BlockTag]]): ComponentDoc = {
    val __obj = js.Dynamic.literal(displayName = displayName.asInstanceOf[js.Any], exportName = exportName.asInstanceOf[js.Any], tags = tags.asInstanceOf[js.Any])
  ...
  extension [Self <: ComponentDoc](x: Self) {
    ...
    inline def setExpose(value: js.Array[ExposedDescriptor]): Self = StObject.set(x, "expose", value.asInstanceOf[js.Any])
    
    inline def setExposeUndefined: Self = StObject.set(x, "expose", js.undefined)
    
    inline def setExposeVarargs(value: ExposedDescriptor*): Self = StObject.set(x, "expose", js.Array(value*))
