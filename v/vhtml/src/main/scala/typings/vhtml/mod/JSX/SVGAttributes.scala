...
import typings.vhtml.vhtmlStrings.`after-edge`
import typings.vhtml.vhtmlStrings.`before-edge`
import typings.vhtml.vhtmlStrings.`text-after-edge`
import typings.vhtml.vhtmlStrings.`text-before-edge`
import typings.vhtml.vhtmlStrings.`use-credentials`
import typings.vhtml.vhtmlStrings.alphabetic
...
import typings.vhtml.vhtmlStrings.bevel
import typings.vhtml.vhtmlStrings.butt
import typings.vhtml.vhtmlStrings.central
import typings.vhtml.vhtmlStrings.evenodd
import typings.vhtml.vhtmlStrings.hanging
import typings.vhtml.vhtmlStrings.ideographic
import typings.vhtml.vhtmlStrings.inherit
import typings.vhtml.vhtmlStrings.initial
import typings.vhtml.vhtmlStrings.isolated
import typings.vhtml.vhtmlStrings.linearRGB
import typings.vhtml.vhtmlStrings.mathematical
import typings.vhtml.vhtmlStrings.medial
import typings.vhtml.vhtmlStrings.middle
import typings.vhtml.vhtmlStrings.miter
import typings.vhtml.vhtmlStrings.no
import typings.vhtml.vhtmlStrings.none
import typings.vhtml.vhtmlStrings.nonzero
import typings.vhtml.vhtmlStrings.replace
import typings.vhtml.vhtmlStrings.round
import typings.vhtml.vhtmlStrings.sRGB
import typings.vhtml.vhtmlStrings.square
import typings.vhtml.vhtmlStrings.sum
import typings.vhtml.vhtmlStrings.terminal
...
trait SVGAttributes
  ...
  var autoreverse: js.UndefOr[Boolean] = js.undefined
  ...
  var preservealpha: js.UndefOr[Boolean] = js.undefined
...
object SVGAttributes {
  ...
  extension [Self <: SVGAttributes](x: Self) {
    ...
    inline def setPreservealpha(value: Boolean): Self = StObject.set(x, "preservealpha", value.asInstanceOf[js.Any])
