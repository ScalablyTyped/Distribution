...
object NodeTypes {
  ...
  inline def ATTRIBUTE: `6` = 6.asInstanceOf[`6`]
  
  inline def COMMENT: `3` = 3.asInstanceOf[`3`]
  
  inline def COMPOUND_EXPRESSION: `8` = 8.asInstanceOf[`8`]
  
  inline def DIRECTIVE: `7` = 7.asInstanceOf[`7`]
  
  inline def ELEMENT: `1` = 1.asInstanceOf[`1`]
  
  inline def FOR: `11` = 11.asInstanceOf[`11`]
  
  inline def IF: `9` = 9.asInstanceOf[`9`]
  
  inline def IF_BRANCH: `10` = 10.asInstanceOf[`10`]
  
  inline def INTERPOLATION: `5` = 5.asInstanceOf[`5`]
  
  inline def JS_ARRAY_EXPRESSION: `17` = 17.asInstanceOf[`17`]
  
  inline def JS_ASSIGNMENT_EXPRESSION: `24` = 24.asInstanceOf[`24`]
  
  inline def JS_BLOCK_STATEMENT: `21` = 21.asInstanceOf[`21`]
  
  inline def JS_CACHE_EXPRESSION: `20` = 20.asInstanceOf[`20`]
  
  inline def JS_CALL_EXPRESSION: `14` = 14.asInstanceOf[`14`]
  
  inline def JS_CONDITIONAL_EXPRESSION: `19` = 19.asInstanceOf[`19`]
  
  inline def JS_FUNCTION_EXPRESSION: `18` = 18.asInstanceOf[`18`]
  
  inline def JS_IF_STATEMENT: `23` = 23.asInstanceOf[`23`]
  
  inline def JS_OBJECT_EXPRESSION: `15` = 15.asInstanceOf[`15`]
  
  inline def JS_PROPERTY: `16` = 16.asInstanceOf[`16`]
  
  inline def JS_RETURN_STATEMENT: `26` = 26.asInstanceOf[`26`]
  
  inline def JS_SEQUENCE_EXPRESSION: `25` = 25.asInstanceOf[`25`]
  
  inline def JS_TEMPLATE_LITERAL: `22` = 22.asInstanceOf[`22`]
  
  inline def ROOT: `0` = 0.asInstanceOf[`0`]
  
  inline def SIMPLE_EXPRESSION: `4` = 4.asInstanceOf[`4`]
  
  inline def TEXT: `2` = 2.asInstanceOf[`2`]
  
  inline def TEXT_CALL: `12` = 12.asInstanceOf[`12`]
  
  inline def VNODE_CALL: `13` = 13.asInstanceOf[`13`]
}
