...
*/
trait ConstantTypes extends StObject
object ConstantTypes {
  
  inline def CAN_HOIST: `2` = 2.asInstanceOf[`2`]
  
  inline def CAN_SKIP_PATCH: `1` = 1.asInstanceOf[`1`]
  
  inline def CAN_STRINGIFY: `3` = 3.asInstanceOf[`3`]
  
  inline def NOT_CONSTANT: `0` = 0.asInstanceOf[`0`]
}
