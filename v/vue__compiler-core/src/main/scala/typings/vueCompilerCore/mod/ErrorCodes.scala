...
object ErrorCodes {
  ...
  inline def END_TAG_WITH_ATTRIBUTES: `3` = 3.asInstanceOf[`3`]
  
  inline def END_TAG_WITH_TRAILING_SOLIDUS: `4` = 4.asInstanceOf[`4`]
  
  inline def EOF_BEFORE_TAG_NAME: `5` = 5.asInstanceOf[`5`]
  
  inline def EOF_IN_CDATA: `6` = 6.asInstanceOf[`6`]
  
  inline def EOF_IN_COMMENT: `7` = 7.asInstanceOf[`7`]
  
  inline def EOF_IN_SCRIPT_HTML_COMMENT_LIKE_TEXT: `8` = 8.asInstanceOf[`8`]
  
  inline def EOF_IN_TAG: `9` = 9.asInstanceOf[`9`]
  
  inline def INCORRECTLY_CLOSED_COMMENT: `10` = 10.asInstanceOf[`10`]
  
  inline def INCORRECTLY_OPENED_COMMENT: `11` = 11.asInstanceOf[`11`]
  
  inline def INVALID_FIRST_CHARACTER_OF_TAG_NAME: `12` = 12.asInstanceOf[`12`]
  
  inline def MISSING_ATTRIBUTE_VALUE: `13` = 13.asInstanceOf[`13`]
  
  inline def MISSING_END_TAG_NAME: `14` = 14.asInstanceOf[`14`]
  
  inline def MISSING_WHITESPACE_BETWEEN_ATTRIBUTES: `15` = 15.asInstanceOf[`15`]
  
  inline def NESTED_COMMENT: `16` = 16.asInstanceOf[`16`]
  
  inline def UNEXPECTED_CHARACTER_IN_ATTRIBUTE_NAME: `17` = 17.asInstanceOf[`17`]
  
  inline def UNEXPECTED_CHARACTER_IN_UNQUOTED_ATTRIBUTE_VALUE: `18` = 18.asInstanceOf[`18`]
  
  inline def UNEXPECTED_EQUALS_SIGN_BEFORE_ATTRIBUTE_NAME: `19` = 19.asInstanceOf[`19`]
  
  inline def UNEXPECTED_NULL_CHARACTER: `20` = 20.asInstanceOf[`20`]
  
  inline def UNEXPECTED_QUESTION_MARK_INSTEAD_OF_TAG_NAME: `21` = 21.asInstanceOf[`21`]
