...
object mod {
  ...
  @JSImport("victory-selection-container/lib", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  object SelectionHelpers {
    
    @JSImport("victory-selection-container/lib", "SelectionHelpers")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("victory-selection-container/lib", "VictorySelectionContainer")
  @js.native
