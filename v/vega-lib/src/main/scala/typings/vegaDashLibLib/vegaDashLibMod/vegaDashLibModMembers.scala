package typings
package vegaDashLibLib.vegaDashLibMod

import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@JSImport("vega-lib", JSImport.Namespace)
@js.native
object vegaDashLibModMembers extends js.Object {
  ...
  def compare(
    fields: js.Array[vegaDashUtilLib.AccessorFn | java.lang.String],
  ...
  def compare(fields: vegaDashUtilLib.AccessorFn, orders: js.Array[vegaDashUtilLib.vegaDashUtilMod.Order]): js.Function2[/* a */ js.Any, /* b */ js.Any, scala.Double] = js.native
  def compare(fields: vegaDashUtilLib.AccessorFn, orders: vegaDashUtilLib.vegaDashUtilMod.Order): js.Function2[/* a */ js.Any, /* b */ js.Any, scala.Double] = js.native
  ...
  def falsy(): vegaDashLibLib.vegaDashLibLibNumbers.`false` = js.native
  ...
  def one(): vegaDashLibLib.vegaDashLibLibNumbers.`1` = js.native
  ...
  def pad_center(
    ...
    align: vegaDashLibLib.vegaDashLibLibStrings.center
  ...
  def pad_left(
    ...
    len: scala.Double,
    char: java.lang.String,
    align: vegaDashLibLib.vegaDashLibLibStrings.left
  ): java.lang.String = js.native
  @JSName("pad")
  def pad_right(
    str: java.lang.String,
    len: scala.Double,
    char: java.lang.String,
    align: vegaDashLibLib.vegaDashLibLibStrings.right
  ): java.lang.String = js.native
  ...
  def toSet[T](array: js.Array[T]): org.scalablytyped.runtime.StringDictionary[vegaDashLibLib.vegaDashLibLibNumbers.`true`] = js.native
  ...
  @JSName("truncate")
  def truncate_center(a: java.lang.String, length: scala.Double, align: vegaDashLibLib.vegaDashLibLibStrings.center): java.lang.String = js.native
  @JSName("truncate")
  def truncate_center(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_left(a: java.lang.String, length: scala.Double, align: vegaDashLibLib.vegaDashLibLibStrings.left): java.lang.String = js.native
  @JSName("truncate")
  def truncate_left(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_right(a: java.lang.String, length: scala.Double, align: vegaDashLibLib.vegaDashLibLibStrings.right): java.lang.String = js.native
  @JSName("truncate")
  def truncate_right(
    a: java.lang.String,
    length: scala.Double,
  ...
  def truthy(): vegaDashLibLib.vegaDashLibLibNumbers.`true` = js.native
  def visitArray(
    array: js.Array[_],
  ...
  def zero(): vegaDashLibLib.vegaDashLibLibNumbers.`0` = js.native
