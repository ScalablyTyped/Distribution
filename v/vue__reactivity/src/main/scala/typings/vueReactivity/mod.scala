...
import typings.vueReactivity.anon.`0`
import typings.vueReactivity.vueReactivityStrings.ToRefs
...
object mod {
  ...
  type DeepReadonly[T] = T | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {readonly [ K in keyof T ]: any}
    */ typings.vueReactivity.vueReactivityStrings.DeepReadonly & TopLevel[Any]) | Ref_[Any] | js.Promise[Any] | WeakSet[Any] | ReadonlySet[Any] | (WeakMap[Any, Any]) | (ReadonlyMap[Any, Any])
  ...
  */
  ...
  type ShallowUnwrapRef[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof T ]: T[K] extends @vue/reactivity.@vue/reactivity.Ref<infer V>? any : T[K] extends @vue/reactivity.@vue/reactivity.Ref<infer V> | undefined? unknown extends any? undefined : any | undefined : T[K]}
    */ typings.vueReactivity.vueReactivityStrings.ShallowUnwrapRef & TopLevel[Any]
  
  type ToRef_[T] = IfAny[T, Ref_[T], Ref_[T] | T]
  
  type ToRefs_[T] = /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  ...
  */
  ...
  type UnwrapNestedRefs[T] = UnwrapRefSimple[T] | T
  
  type UnwrapRef[T] = UnwrapRefSimple[Any | T]
  
  type UnwrapRefSimple[T] = T | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: P extends symbol? T[P] : @vue/reactivity.@vue/reactivity.UnwrapRef<T[P]>}
    */ typings.vueReactivity.vueReactivityStrings.UnwrapRefSimple & TopLevel[Any]) | (/* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ K in keyof T ]: @vue/reactivity.@vue/reactivity.UnwrapRefSimple<T[K]>}
    */ typings.vueReactivity.vueReactivityStrings.UnwrapRefSimple & TopLevel[T])
