...
object mod {
  ...
  @JSImport("victory-voronoi-container/lib", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("victory-voronoi-container/lib", "VictoryVoronoiContainer")
  @js.native
  ...
  object VoronoiHelpers {
    ...
    @JSImport("victory-voronoi-container/lib", "VoronoiHelpers")
    @js.native
    val ^ : js.Any = js.native
