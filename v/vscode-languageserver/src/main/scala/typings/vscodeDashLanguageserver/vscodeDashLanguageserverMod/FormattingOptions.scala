...
object FormattingOptions extends js.Object {
  /**
    ...
    */
  def create(tabSize: Double, insertSpaces: Boolean): typings.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.FormattingOptions = js.native
  /**
