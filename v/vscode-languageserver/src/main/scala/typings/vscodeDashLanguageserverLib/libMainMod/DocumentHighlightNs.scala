...
@JSImport("vscode-languageserver/lib/main", "DocumentHighlight")
@js.native
object DocumentHighlightNs extends js.Object {
  ...
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.DocumentHighlight = js.native
}
