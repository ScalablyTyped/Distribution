...
@JSImport("vscode-languageserver/lib/main", "DiagnosticRelatedInformation")
@js.native
object DiagnosticRelatedInformationNs extends js.Object {
  ...
  /**
    ...
    */
  def is(value: js.Any): /* is vscode-languageserver-types.vscode-languageserver-types.DiagnosticRelatedInformation */ scala.Boolean = js.native
}
