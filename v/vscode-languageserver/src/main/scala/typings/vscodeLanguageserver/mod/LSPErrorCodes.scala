...
object LSPErrorCodes {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.ContentModified")
  @js.native
  ...
  /**
    ...
    * the cancel.
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.RequestCancelled")
  @js.native
  ...
  /**
    ...
    * @since 3.17.0
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.RequestFailed")
  @js.native
  ...
  /**
    ...
    * @since 3.17.0
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.ServerCancelled")
  @js.native
  ...
  /**
    ...
    * @since 3.16.0
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.lspReservedErrorRangeEnd")
  @js.native
  ...
  /**
    ...
    * @since 3.16.0
    */
  @JSImport("vscode-languageserver", "LSPErrorCodes.lspReservedErrorRangeStart")
  @js.native
