...
@JSImport("vscode-languageserver", "SemanticTokenTypes")
@js.native
object SemanticTokenTypes extends StObject {
  
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typings.vscodeLanguageserverTypes.mod.SemanticTokenTypes & String] = js.native
