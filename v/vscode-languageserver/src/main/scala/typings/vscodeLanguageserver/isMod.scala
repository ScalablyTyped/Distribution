...
object isMod {
  ...
  inline def thenable[T](value: js.Any): /* is vscode-languageserver.Thenable<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("thenable")(value.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-languageserver.Thenable<T> */ Boolean]
