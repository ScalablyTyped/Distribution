...
object filesMod {
  ...
  object FileSystem {
    ...
    inline def isParent(parent: String, child: String): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isParent")(parent.asInstanceOf[js.Any], child.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  }
