...
package object mod {
  ...
  @scala.inline
  def generateCodeFrame(source: java.lang.String, start: js.UndefOr[scala.Nothing], end: scala.Double): java.lang.String = (typings.vueCompilerSfc.mod.^.asInstanceOf[js.Dynamic].applyDynamic("generateCodeFrame")(source.asInstanceOf[js.Any], start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[java.lang.String]
  @scala.inline
