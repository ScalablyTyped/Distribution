...
import typings.vega.vegaStrings.WARN
import typings.vega.vegaStrings.center
import typings.vega.vegaStrings.error_
import typings.vega.vegaStrings.left
import typings.vega.vegaStrings.log
import typings.vega.vegaStrings.right
import typings.vega.vegaStrings.warn_
...
object mod {
  ...
  inline def log(
    method: error_ | warn_ | typings.vega.vegaStrings.log,
