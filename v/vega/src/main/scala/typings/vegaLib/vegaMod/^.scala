...
object ^ extends js.Object {
  ...
  def falsy(): vegaLib.vegaLibNumbers.`false` = js.native
  ...
  def one(): vegaLib.vegaLibNumbers.`1` = js.native
  ...
  def pad_center(
    ...
    align: vegaLib.vegaLibStrings.center
  ...
  def pad_left(
    ...
    len: scala.Double,
    char: java.lang.String,
    align: vegaLib.vegaLibStrings.left
  ): java.lang.String = js.native
  @JSName("pad")
  def pad_right(
    str: java.lang.String,
    len: scala.Double,
    char: java.lang.String,
    align: vegaLib.vegaLibStrings.right
  ): java.lang.String = js.native
  ...
  def toSet[T](array: js.Array[T]): org.scalablytyped.runtime.StringDictionary[vegaLib.vegaLibNumbers.`true`] = js.native
  ...
  @JSName("truncate")
  def truncate_center(a: java.lang.String, length: scala.Double, align: vegaLib.vegaLibStrings.center): java.lang.String = js.native
  @JSName("truncate")
  def truncate_center(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_left(a: java.lang.String, length: scala.Double, align: vegaLib.vegaLibStrings.left): java.lang.String = js.native
  @JSName("truncate")
  def truncate_left(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_right(a: java.lang.String, length: scala.Double, align: vegaLib.vegaLibStrings.right): java.lang.String = js.native
  @JSName("truncate")
  def truncate_right(
    a: java.lang.String,
    length: scala.Double,
  ...
  def truthy(): vegaLib.vegaLibNumbers.`true` = js.native
  ...
  def zero(): vegaLib.vegaLibNumbers.`0` = js.native
