...
object viewportDashMercatorDashProjectModMembers extends js.Object {
  def fitBounds(options: viewportDashMercatorDashProjectLib.Anon_Height): FittedBounds = js.native
  ...
  def getWorldPosition(input: viewportDashMercatorDashProjectLib.Anon_MeterOffset): Vector3 = js.native
