...
object anon {
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.asInstanceOf[js.Any], dataComponent = dataComponent.asInstanceOf[js.Any], groupComponent = groupComponent.asInstanceOf[js.Any], labelComponent = labelComponent.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], sortOrder = sortOrder.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
  ...
  object TypeofVictoryScatterBase {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: TypeofVictoryScatterBase] (val x: Self) extends AnyVal {
