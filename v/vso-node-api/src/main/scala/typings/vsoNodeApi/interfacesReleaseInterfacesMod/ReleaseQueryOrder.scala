...
object ReleaseQueryOrder extends StObject {
  ...
  /* 1 */ val Ascending: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ReleaseQueryOrder.Ascending & Double = js.native
  
  @js.native
  sealed trait Descending
    extends StObject
       with ReleaseQueryOrder
  /* 0 */ val Descending: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ReleaseQueryOrder.Descending & Double = js.native
}
