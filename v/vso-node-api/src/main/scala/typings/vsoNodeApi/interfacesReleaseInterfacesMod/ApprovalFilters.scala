...
object ApprovalFilters extends StObject {
  ...
  /* 7 */ val All: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ApprovalFilters.All & Double = js.native
  ...
  sealed trait ApprovalSnapshots
    extends StObject
       with ApprovalFilters
  /* 4 */ val ApprovalSnapshots: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ApprovalFilters.ApprovalSnapshots & Double = js.native
  ...
  sealed trait AutomatedApprovals
    extends StObject
       with ApprovalFilters
  /* 2 */ val AutomatedApprovals: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ApprovalFilters.AutomatedApprovals & Double = js.native
  ...
  sealed trait ManualApprovals
    extends StObject
       with ApprovalFilters
  /* 1 */ val ManualApprovals: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ApprovalFilters.ManualApprovals & Double = js.native
  ...
  sealed trait None
    extends StObject
       with ApprovalFilters
  /* 0 */ val None: typings.vsoNodeApi.interfacesReleaseInterfacesMod.ApprovalFilters.None & Double = js.native
}
