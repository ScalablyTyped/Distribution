...
object GitRefUpdateMode extends StObject {
  ...
  /* 1 */ val AllOrNone: typings.vsoNodeApi.gitInterfacesMod.GitRefUpdateMode.AllOrNone & Double = js.native
  ...
  sealed trait BestEffort
    extends StObject
       with GitRefUpdateMode
  /* 0 */ val BestEffort: typings.vsoNodeApi.gitInterfacesMod.GitRefUpdateMode.BestEffort & Double = js.native
}
