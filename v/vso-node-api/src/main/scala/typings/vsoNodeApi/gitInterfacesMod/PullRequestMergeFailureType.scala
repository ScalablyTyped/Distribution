...
object PullRequestMergeFailureType extends StObject {
  ...
  /* 2 */ val CaseSensitive: typings.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.CaseSensitive & Double = js.native
  ...
  sealed trait None
    extends StObject
       with PullRequestMergeFailureType
  /* 0 */ val None: typings.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.None & Double = js.native
  ...
  sealed trait ObjectTooLarge
    extends StObject
       with PullRequestMergeFailureType
  /* 3 */ val ObjectTooLarge: typings.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.ObjectTooLarge & Double = js.native
  ...
  sealed trait Unknown
    extends StObject
       with PullRequestMergeFailureType
  /* 1 */ val Unknown: typings.vsoNodeApi.gitInterfacesMod.PullRequestMergeFailureType.Unknown & Double = js.native
}
