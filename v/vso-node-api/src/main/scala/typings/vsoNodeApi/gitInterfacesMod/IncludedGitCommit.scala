...
object IncludedGitCommit {
  ...
  inline def apply(commitId: String, commitTime: Date, parentCommitIds: js.Array[String], repositoryId: String): IncludedGitCommit = {
  ...
  extension [Self <: IncludedGitCommit](x: Self) {
    ...
    inline def setCommitTime(value: Date): Self = StObject.set(x, "commitTime", value.asInstanceOf[js.Any])
    
    inline def setParentCommitIds(value: js.Array[String]): Self = StObject.set(x, "parentCommitIds", value.asInstanceOf[js.Any])
    
    inline def setParentCommitIdsVarargs(value: String*): Self = StObject.set(x, "parentCommitIds", js.Array(value :_*))
