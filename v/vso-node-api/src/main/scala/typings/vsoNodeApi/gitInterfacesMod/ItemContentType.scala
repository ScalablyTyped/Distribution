...
object ItemContentType extends StObject {
  ...
  /* 1 */ val Base64Encoded: typings.vsoNodeApi.gitInterfacesMod.ItemContentType.Base64Encoded & Double = js.native
  
  @js.native
  sealed trait RawText
    extends StObject
       with ItemContentType
  /* 0 */ val RawText: typings.vsoNodeApi.gitInterfacesMod.ItemContentType.RawText & Double = js.native
}
