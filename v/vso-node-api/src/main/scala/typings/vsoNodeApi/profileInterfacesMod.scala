...
object profileInterfacesMod {
  ...
  object AvatarSize extends StObject {
    ...
    /* 2 */ val Large: typings.vsoNodeApi.profileInterfacesMod.AvatarSize.Large with Double = js.native
    
    @js.native
    sealed trait Medium extends AvatarSize
    /* 1 */ val Medium: typings.vsoNodeApi.profileInterfacesMod.AvatarSize.Medium with Double = js.native
    
    @js.native
    sealed trait Small extends AvatarSize
    /* 0 */ val Small: typings.vsoNodeApi.profileInterfacesMod.AvatarSize.Small with Double = js.native
  }
