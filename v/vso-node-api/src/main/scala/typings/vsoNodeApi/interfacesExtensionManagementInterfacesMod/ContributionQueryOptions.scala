...
object ContributionQueryOptions extends StObject {
  ...
  /* 256 */ val IgnoreConstraints: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.IgnoreConstraints & Double = js.native
  ...
  sealed trait IncludeAll
    extends StObject
       with ContributionQueryOptions
  /* 112 */ val IncludeAll: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.IncludeAll & Double = js.native
  ...
  sealed trait IncludeChildren
    extends StObject
       with ContributionQueryOptions
  /* 32 */ val IncludeChildren: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.IncludeChildren & Double = js.native
  ...
  sealed trait IncludeSelf
    extends StObject
       with ContributionQueryOptions
  /* 16 */ val IncludeSelf: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.IncludeSelf & Double = js.native
  ...
  sealed trait IncludeSubTree
    extends StObject
       with ContributionQueryOptions
  /* 96 */ val IncludeSubTree: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.IncludeSubTree & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with ContributionQueryOptions
  /* 0 */ val None: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ContributionQueryOptions.None & Double = js.native
}
