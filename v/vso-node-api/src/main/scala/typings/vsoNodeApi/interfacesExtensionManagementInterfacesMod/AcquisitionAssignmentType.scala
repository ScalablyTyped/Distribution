...
object AcquisitionAssignmentType extends StObject {
  ...
  /* 2 */ val All: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.AcquisitionAssignmentType.All & Double = js.native
  ...
  sealed trait Me
    extends StObject
       with AcquisitionAssignmentType
  /* 1 */ val Me: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.AcquisitionAssignmentType.Me & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with AcquisitionAssignmentType
  /* 0 */ val None: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.AcquisitionAssignmentType.None & Double = js.native
}
