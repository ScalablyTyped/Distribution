...
import typings.vsoNodeApi.interfacesGalleryInterfacesMod.ExtensionFile
...
object InstalledExtension {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstalledExtension] (val x: Self) extends AnyVal {
