...
import typings.vsoNodeApi.interfacesGalleryInterfacesMod.ExtensionIdentifier
...
object InstalledExtensionQuery {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: InstalledExtensionQuery] (val x: Self) extends AnyVal {
