...
object ExtensionRequestState extends StObject {
  ...
  /* 1 */ val Accepted: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ExtensionRequestState.Accepted & Double = js.native
  ...
  sealed trait Open
    extends StObject
       with ExtensionRequestState
  /* 0 */ val Open: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ExtensionRequestState.Open & Double = js.native
  ...
  sealed trait Rejected
    extends StObject
       with ExtensionRequestState
  /* 2 */ val Rejected: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.ExtensionRequestState.Rejected & Double = js.native
}
