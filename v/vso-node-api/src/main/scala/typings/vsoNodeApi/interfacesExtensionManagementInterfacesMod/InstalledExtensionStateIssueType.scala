...
object InstalledExtensionStateIssueType extends StObject {
  ...
  /* 1 */ val Error: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.InstalledExtensionStateIssueType.Error & Double = js.native
  ...
  sealed trait Warning
    extends StObject
       with InstalledExtensionStateIssueType
  /* 0 */ val Warning: typings.vsoNodeApi.interfacesExtensionManagementInterfacesMod.InstalledExtensionStateIssueType.Warning & Double = js.native
}
