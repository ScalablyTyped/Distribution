...
object ExtensionVersionFlags extends StObject {
  ...
  /* 0 */ val None: typings.vsoNodeApi.galleryInterfacesMod.ExtensionVersionFlags.None with Double = js.native
  ...
  /* 1 */ val Validated: typings.vsoNodeApi.galleryInterfacesMod.ExtensionVersionFlags.Validated with Double = js.native
}
