...
object PublisherFlags extends StObject {
  ...
  sealed trait Disabled
    extends StObject
       with PublisherFlags
  /* 1 */ val Disabled: typings.vsoNodeApi.galleryInterfacesMod.PublisherFlags.Disabled & Double = js.native
  ...
  sealed trait None
    extends StObject
       with PublisherFlags
  /* 0 */ val None: typings.vsoNodeApi.galleryInterfacesMod.PublisherFlags.None & Double = js.native
  ...
  sealed trait ServiceFlags
    extends StObject
       with PublisherFlags
  /* 3 */ val ServiceFlags: typings.vsoNodeApi.galleryInterfacesMod.PublisherFlags.ServiceFlags & Double = js.native
  ...
  sealed trait UnChanged
    extends StObject
       with PublisherFlags
  /* 1073741824 */ val UnChanged: typings.vsoNodeApi.galleryInterfacesMod.PublisherFlags.UnChanged & Double = js.native
  ...
  sealed trait Verified
    extends StObject
       with PublisherFlags
  /* 2 */ val Verified: typings.vsoNodeApi.galleryInterfacesMod.PublisherFlags.Verified & Double = js.native
}
