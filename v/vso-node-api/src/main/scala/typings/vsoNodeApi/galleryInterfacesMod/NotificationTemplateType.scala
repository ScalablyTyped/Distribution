...
object NotificationTemplateType extends StObject {
  ...
  /* 3 */ val CustomerContactNotification: typings.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.CustomerContactNotification & Double = js.native
  ...
  sealed trait PublisherMemberUpdateNotification
    extends StObject
       with NotificationTemplateType
  /* 4 */ val PublisherMemberUpdateNotification: typings.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.PublisherMemberUpdateNotification & Double = js.native
  ...
  sealed trait QnaNotification
    extends StObject
       with NotificationTemplateType
  /* 2 */ val QnaNotification: typings.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.QnaNotification & Double = js.native
  ...
  sealed trait ReviewNotification
    extends StObject
       with NotificationTemplateType
  /* 1 */ val ReviewNotification: typings.vsoNodeApi.galleryInterfacesMod.NotificationTemplateType.ReviewNotification & Double = js.native
}
