...
object QnAItemStatus extends StObject {
  ...
  sealed trait None
    extends StObject
       with QnAItemStatus
  /* 0 */ val None: typings.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.None & Double = js.native
  ...
  sealed trait PublisherCreated
    extends StObject
       with QnAItemStatus
  /* 2 */ val PublisherCreated: typings.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.PublisherCreated & Double = js.native
  ...
  sealed trait UserEditable
    extends StObject
       with QnAItemStatus
  /* 1 */ val UserEditable: typings.vsoNodeApi.galleryInterfacesMod.QnAItemStatus.UserEditable & Double = js.native
}
