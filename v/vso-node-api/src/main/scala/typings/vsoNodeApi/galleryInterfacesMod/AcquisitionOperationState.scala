...
object AcquisitionOperationState extends StObject {
  ...
  /* 1 */ val Allow: typings.vsoNodeApi.galleryInterfacesMod.AcquisitionOperationState.Allow & Double = js.native
  ...
  sealed trait Completed
    extends StObject
       with AcquisitionOperationState
  /* 3 */ val Completed: typings.vsoNodeApi.galleryInterfacesMod.AcquisitionOperationState.Completed & Double = js.native
  ...
  sealed trait Disallow
    extends StObject
       with AcquisitionOperationState
  /* 0 */ val Disallow: typings.vsoNodeApi.galleryInterfacesMod.AcquisitionOperationState.Disallow & Double = js.native
}
