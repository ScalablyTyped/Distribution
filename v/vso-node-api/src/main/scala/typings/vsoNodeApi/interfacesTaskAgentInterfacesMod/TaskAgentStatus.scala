...
object TaskAgentStatus extends StObject {
  ...
  /* 1 */ val Offline: typings.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskAgentStatus.Offline & Double = js.native
  
  @js.native
  sealed trait Online
    extends StObject
       with TaskAgentStatus
  /* 2 */ val Online: typings.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskAgentStatus.Online & Double = js.native
}
