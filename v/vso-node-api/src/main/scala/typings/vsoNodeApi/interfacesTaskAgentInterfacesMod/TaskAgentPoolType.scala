...
object TaskAgentPoolType extends StObject {
  ...
  /* 1 */ val Automation: typings.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskAgentPoolType.Automation & Double = js.native
  
  @js.native
  sealed trait Deployment
    extends StObject
       with TaskAgentPoolType
  /* 2 */ val Deployment: typings.vsoNodeApi.interfacesTaskAgentInterfacesMod.TaskAgentPoolType.Deployment & Double = js.native
}
