...
object TypeInfo {
  ...
  inline def FieldType_=(x: EnumValuesHistory): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FieldType")(x.asInstanceOf[js.Any])
  ...
  inline def GetBehaviorsExpand_=(x: EnumValuesFieldsNone): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GetBehaviorsExpand")(x.asInstanceOf[js.Any])
  ...
  inline def GetProcessExpandLevel_=(x: EnumValuesProjects): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GetProcessExpandLevel")(x.asInstanceOf[js.Any])
  ...
  inline def GetWorkItemTypeExpand_=(x: EnumValuesBehaviors): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GetWorkItemTypeExpand")(x.asInstanceOf[js.Any])
  ...
  inline def ProcessClass_=(x: EnumValuesDerived): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ProcessClass")(x.asInstanceOf[js.Any])
  ...
  inline def WorkItemTypeClass_=(x: EnumValuesDerived): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WorkItemTypeClass")(x.asInstanceOf[js.Any])
