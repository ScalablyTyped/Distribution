...
trait AnonBooleanDateTimeDoubleGuid extends js.Object {
  var boolean: Double
  var dateTime: Double
  var double: Double
  var guid: Double
...
object AnonBooleanDateTimeDoubleGuid {
  @scala.inline
  def apply(
    boolean: Double,
    dateTime: Double,
    ...
    __obj.asInstanceOf[AnonBooleanDateTimeDoubleGuid]
  }
}
