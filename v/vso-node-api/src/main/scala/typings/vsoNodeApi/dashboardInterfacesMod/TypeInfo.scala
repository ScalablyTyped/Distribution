...
object TypeInfo {
  ...
  inline def DashboardScope_=(x: EnumValuesCollectionUser): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DashboardScope")(x.asInstanceOf[js.Any])
  ...
  inline def GroupMemberPermission_=(x: EnumValuesEdit): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GroupMemberPermission")(x.asInstanceOf[js.Any])
  ...
  inline def TeamDashboardPermission_=(x: EnumValuesCreate): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TeamDashboardPermission")(x.asInstanceOf[js.Any])
  ...
  inline def WidgetScope_=(x: EnumValuesCollectionUser): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WidgetScope")(x.asInstanceOf[js.Any])
