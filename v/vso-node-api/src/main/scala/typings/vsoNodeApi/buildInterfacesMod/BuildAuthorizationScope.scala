...
object BuildAuthorizationScope extends StObject {
  ...
  /* 2 */ val Project: typings.vsoNodeApi.buildInterfacesMod.BuildAuthorizationScope.Project & Double = js.native
  ...
  sealed trait ProjectCollection
    extends StObject
       with BuildAuthorizationScope
  /* 1 */ val ProjectCollection: typings.vsoNodeApi.buildInterfacesMod.BuildAuthorizationScope.ProjectCollection & Double = js.native
}
