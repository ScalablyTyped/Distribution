...
object RepositoryCleanOptions extends StObject {
  ...
  /* 3 */ val AllBuildDir: typings.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.AllBuildDir & Double = js.native
  
  @js.native
  sealed trait Source
    extends StObject
       with RepositoryCleanOptions
  /* 0 */ val Source: typings.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.Source & Double = js.native
  
  @js.native
  sealed trait SourceAndOutputDir
    extends StObject
       with RepositoryCleanOptions
  /* 1 */ val SourceAndOutputDir: typings.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.SourceAndOutputDir & Double = js.native
  ...
  sealed trait SourceDir
    extends StObject
       with RepositoryCleanOptions
  /* 2 */ val SourceDir: typings.vsoNodeApi.buildInterfacesMod.RepositoryCleanOptions.SourceDir & Double = js.native
}
