...
object DefinitionQueueStatus extends StObject {
  ...
  /* 2 */ val Disabled: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Disabled & Double = js.native
  ...
  sealed trait Enabled
    extends StObject
       with DefinitionQueueStatus
  /* 0 */ val Enabled: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Enabled & Double = js.native
  ...
  sealed trait Paused
    extends StObject
       with DefinitionQueueStatus
  /* 1 */ val Paused: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Paused & Double = js.native
}
