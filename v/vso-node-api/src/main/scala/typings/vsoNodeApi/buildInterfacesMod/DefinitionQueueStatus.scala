...
object DefinitionQueueStatus extends StObject {
  ...
  /* 2 */ val Disabled: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Disabled with Double = js.native
  ...
  /* 0 */ val Enabled: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Enabled with Double = js.native
  ...
  /* 1 */ val Paused: typings.vsoNodeApi.buildInterfacesMod.DefinitionQueueStatus.Paused with Double = js.native
}
