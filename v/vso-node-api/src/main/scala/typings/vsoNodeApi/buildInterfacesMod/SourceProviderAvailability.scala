...
object SourceProviderAvailability extends StObject {
  ...
  /* 3 */ val All: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.All with Double = js.native
  ...
  /* 1 */ val Hosted: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.Hosted with Double = js.native
  ...
  /* 2 */ val OnPremises: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.OnPremises with Double = js.native
}
