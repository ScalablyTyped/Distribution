...
object SourceProviderAvailability extends StObject {
  ...
  /* 3 */ val All: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.All & Double = js.native
  ...
  sealed trait Hosted
    extends StObject
       with SourceProviderAvailability
  /* 1 */ val Hosted: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.Hosted & Double = js.native
  ...
  sealed trait OnPremises
    extends StObject
       with SourceProviderAvailability
  /* 2 */ val OnPremises: typings.vsoNodeApi.buildInterfacesMod.SourceProviderAvailability.OnPremises & Double = js.native
}
