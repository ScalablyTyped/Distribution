...
object AcquisitionOperationState extends StObject {
  ...
  /* 1 */ val Allow: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Allow & Double = js.native
  ...
  sealed trait Completed
    extends StObject
       with AcquisitionOperationState
  /* 3 */ val Completed: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Completed & Double = js.native
  ...
  sealed trait Disallow
    extends StObject
       with AcquisitionOperationState
  /* 0 */ val Disallow: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionOperationState.Disallow & Double = js.native
}
