...
object PagingDirection extends StObject {
  ...
  /* 1 */ val Backward: typings.vsoNodeApi.interfacesGalleryInterfacesMod.PagingDirection.Backward & Double = js.native
  ...
  sealed trait Forward
    extends StObject
       with PagingDirection
  /* 2 */ val Forward: typings.vsoNodeApi.interfacesGalleryInterfacesMod.PagingDirection.Forward & Double = js.native
}
