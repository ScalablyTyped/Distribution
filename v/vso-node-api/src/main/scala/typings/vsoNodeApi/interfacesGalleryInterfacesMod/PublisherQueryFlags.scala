...
object PublisherQueryFlags extends StObject {
  ...
  /* 2 */ val IncludeEmailAddress: typings.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherQueryFlags.IncludeEmailAddress & Double = js.native
  ...
  sealed trait IncludeExtensions
    extends StObject
       with PublisherQueryFlags
  /* 1 */ val IncludeExtensions: typings.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherQueryFlags.IncludeExtensions & Double = js.native
  ...
  sealed trait None
    extends StObject
       with PublisherQueryFlags
  /* 0 */ val None: typings.vsoNodeApi.interfacesGalleryInterfacesMod.PublisherQueryFlags.None & Double = js.native
}
