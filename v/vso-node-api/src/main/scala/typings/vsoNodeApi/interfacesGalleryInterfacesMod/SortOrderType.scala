...
object SortOrderType extends StObject {
  ...
  sealed trait Ascending
    extends StObject
       with SortOrderType
  /* 1 */ val Ascending: typings.vsoNodeApi.interfacesGalleryInterfacesMod.SortOrderType.Ascending & Double = js.native
  ...
  sealed trait Default
    extends StObject
       with SortOrderType
  /* 0 */ val Default: typings.vsoNodeApi.interfacesGalleryInterfacesMod.SortOrderType.Default & Double = js.native
  ...
  sealed trait Descending
    extends StObject
       with SortOrderType
  /* 2 */ val Descending: typings.vsoNodeApi.interfacesGalleryInterfacesMod.SortOrderType.Descending & Double = js.native
}
