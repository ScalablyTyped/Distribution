...
object AcquisitionAssignmentType extends StObject {
  ...
  /* 2 */ val All: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.All & Double = js.native
  ...
  sealed trait Me
    extends StObject
       with AcquisitionAssignmentType
  /* 1 */ val Me: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.Me & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with AcquisitionAssignmentType
  /* 0 */ val None: typings.vsoNodeApi.interfacesGalleryInterfacesMod.AcquisitionAssignmentType.None & Double = js.native
}
