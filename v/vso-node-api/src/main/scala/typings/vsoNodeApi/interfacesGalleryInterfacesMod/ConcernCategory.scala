...
object ConcernCategory extends StObject {
  ...
  /* 2 */ val Abusive: typings.vsoNodeApi.interfacesGalleryInterfacesMod.ConcernCategory.Abusive & Double = js.native
  
  @js.native
  sealed trait General
    extends StObject
       with ConcernCategory
  /* 1 */ val General: typings.vsoNodeApi.interfacesGalleryInterfacesMod.ConcernCategory.General & Double = js.native
  
  @js.native
  sealed trait Spam
    extends StObject
       with ConcernCategory
  /* 4 */ val Spam: typings.vsoNodeApi.interfacesGalleryInterfacesMod.ConcernCategory.Spam & Double = js.native
}
