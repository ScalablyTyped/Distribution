...
object ExtensionVersionFlags extends StObject {
  ...
  /* 0 */ val None: typings.vsoNodeApi.interfacesGalleryInterfacesMod.ExtensionVersionFlags.None & Double = js.native
  ...
  sealed trait Validated
    extends StObject
       with ExtensionVersionFlags
  /* 1 */ val Validated: typings.vsoNodeApi.interfacesGalleryInterfacesMod.ExtensionVersionFlags.Validated & Double = js.native
}
