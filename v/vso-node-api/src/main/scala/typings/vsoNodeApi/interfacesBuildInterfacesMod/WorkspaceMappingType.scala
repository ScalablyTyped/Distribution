...
object WorkspaceMappingType extends StObject {
  ...
  /* 1 */ val Cloak: typings.vsoNodeApi.interfacesBuildInterfacesMod.WorkspaceMappingType.Cloak & Double = js.native
  ...
  sealed trait Map
    extends StObject
       with WorkspaceMappingType
  /* 0 */ val Map: typings.vsoNodeApi.interfacesBuildInterfacesMod.WorkspaceMappingType.Map & Double = js.native
}
