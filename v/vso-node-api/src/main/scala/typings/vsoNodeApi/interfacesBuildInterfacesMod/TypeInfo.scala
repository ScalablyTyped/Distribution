...
object TypeInfo {
  ...
  inline def AgentStatus_=(x: EnumValues): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AgentStatus")(x.asInstanceOf[js.Any])
  ...
  inline def BuildAuthorizationScope_=(x: EnumValuesProject): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildAuthorizationScope")(x.asInstanceOf[js.Any])
  ...
  inline def BuildOptionInputType_=(x: EnumValuesBoolean): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildOptionInputType")(x.asInstanceOf[js.Any])
  ...
  inline def BuildPhaseStatus_=(x: EnumValuesFailed): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildPhaseStatus")(x.asInstanceOf[js.Any])
  ...
  inline def BuildQueryOrder_=(x: EnumValuesFinishTimeAscending): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildQueryOrder")(x.asInstanceOf[js.Any])
  ...
  inline def BuildReason_=(x: EnumValuesAll): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildReason")(x.asInstanceOf[js.Any])
  ...
  inline def BuildResult_=(x: EnumValuesCanceled): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildResult")(x.asInstanceOf[js.Any])
  ...
  inline def BuildStatus_=(x: EnumValuesCancelling): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BuildStatus")(x.asInstanceOf[js.Any])
  ...
  inline def ControllerStatus_=(x: EnumValues): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ControllerStatus")(x.asInstanceOf[js.Any])
  ...
  inline def DefinitionQuality_=(x: EnumValuesDefinition): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefinitionQuality")(x.asInstanceOf[js.Any])
  ...
  inline def DefinitionQueryOrder_=(x: EnumValuesDefinitionNameAscending): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefinitionQueryOrder")(x.asInstanceOf[js.Any])
  ...
  inline def DefinitionQueueStatus_=(x: EnumValuesDisabled): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefinitionQueueStatus")(x.asInstanceOf[js.Any])
  ...
  inline def DefinitionTriggerType_=(x: EnumValuesBatchedContinuousIntegration): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefinitionTriggerType")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/BuildInterfaces", "TypeInfo.DefinitionType")
  @js.native
  def DefinitionType: EnumValuesBuild = js.native
  inline def DefinitionType_=(x: EnumValuesBuild): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefinitionType")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/BuildInterfaces", "TypeInfo.DeleteOptions")
  @js.native
  def DeleteOptions: EnumValuesDetails = js.native
  inline def DeleteOptions_=(x: EnumValuesDetails): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DeleteOptions")(x.asInstanceOf[js.Any])
  ...
  inline def GetOption_=(x: EnumValuesCustom): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GetOption")(x.asInstanceOf[js.Any])
  ...
  inline def ProcessTemplateType_=(x: EnumValuesDefault): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ProcessTemplateType")(x.asInstanceOf[js.Any])
  ...
  inline def QueryDeletedOption_=(x: EnumValuesExcludeDeleted): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("QueryDeletedOption")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/BuildInterfaces", "TypeInfo.QueueOptions")
  @js.native
  def QueueOptions: EnumValuesDoNotRun = js.native
  inline def QueueOptions_=(x: EnumValuesDoNotRun): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("QueueOptions")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/BuildInterfaces", "TypeInfo.QueuePriority")
  @js.native
  def QueuePriority: EnumValuesAboveNormal = js.native
  inline def QueuePriority_=(x: EnumValuesAboveNormal): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("QueuePriority")(x.asInstanceOf[js.Any])
  ...
  inline def RepositoryCleanOptions_=(x: EnumValuesAllBuildDir): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("RepositoryCleanOptions")(x.asInstanceOf[js.Any])
  ...
  inline def ServiceHostStatus_=(x: EnumValuesOffline): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ServiceHostStatus")(x.asInstanceOf[js.Any])
  ...
  inline def SourceProviderAvailability_=(x: EnumValuesHosted): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SourceProviderAvailability")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/BuildInterfaces", "TypeInfo.SupportLevel")
  @js.native
  def SupportLevel: EnumValuesRequired = js.native
  inline def SupportLevel_=(x: EnumValuesRequired): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SupportLevel")(x.asInstanceOf[js.Any])
  ...
  inline def ValidationResult_=(x: EnumValuesOK): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ValidationResult")(x.asInstanceOf[js.Any])
