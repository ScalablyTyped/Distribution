...
object GetOption extends StObject {
  ...
  sealed trait Custom
    extends StObject
       with GetOption
  /* 2 */ val Custom: typings.vsoNodeApi.interfacesBuildInterfacesMod.GetOption.Custom & Double = js.native
  ...
  sealed trait LatestOnBuild
    extends StObject
       with GetOption
  /* 1 */ val LatestOnBuild: typings.vsoNodeApi.interfacesBuildInterfacesMod.GetOption.LatestOnBuild & Double = js.native
  ...
  sealed trait LatestOnQueue
    extends StObject
       with GetOption
  /* 0 */ val LatestOnQueue: typings.vsoNodeApi.interfacesBuildInterfacesMod.GetOption.LatestOnQueue & Double = js.native
}
