...
object ServiceHostStatus extends StObject {
  ...
  /* 2 */ val Offline: typings.vsoNodeApi.interfacesBuildInterfacesMod.ServiceHostStatus.Offline & Double = js.native
  ...
  sealed trait Online
    extends StObject
       with ServiceHostStatus
  /* 1 */ val Online: typings.vsoNodeApi.interfacesBuildInterfacesMod.ServiceHostStatus.Online & Double = js.native
}
