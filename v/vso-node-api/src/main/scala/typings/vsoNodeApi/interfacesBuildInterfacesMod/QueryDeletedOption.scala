...
object QueryDeletedOption extends StObject {
  ...
  /* 0 */ val ExcludeDeleted: typings.vsoNodeApi.interfacesBuildInterfacesMod.QueryDeletedOption.ExcludeDeleted & Double = js.native
  ...
  sealed trait IncludeDeleted
    extends StObject
       with QueryDeletedOption
  /* 1 */ val IncludeDeleted: typings.vsoNodeApi.interfacesBuildInterfacesMod.QueryDeletedOption.IncludeDeleted & Double = js.native
  ...
  sealed trait OnlyDeleted
    extends StObject
       with QueryDeletedOption
  /* 2 */ val OnlyDeleted: typings.vsoNodeApi.interfacesBuildInterfacesMod.QueryDeletedOption.OnlyDeleted & Double = js.native
}
