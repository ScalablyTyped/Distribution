...
object TypeInfo {
  ...
  inline def BugsBehavior_=(x: EnumValuesAsRequirements): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BugsBehavior")(x.asInstanceOf[js.Any])
  ...
  inline def FieldType_=(x: EnumValuesDouble): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FieldType")(x.asInstanceOf[js.Any])
  ...
  inline def IdentityDisplayFormat_=(x: EnumValuesAvatarAndFullName): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IdentityDisplayFormat")(x.asInstanceOf[js.Any])
  ...
  inline def PlanType_=(x: EnumValuesDeliveryTimelineView): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("PlanType")(x.asInstanceOf[js.Any])
  ...
  inline def TimeFrame_=(x: EnumValuesCurrent): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TimeFrame")(x.asInstanceOf[js.Any])
