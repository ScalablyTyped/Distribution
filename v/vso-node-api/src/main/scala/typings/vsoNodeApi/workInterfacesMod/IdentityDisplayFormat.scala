...
object IdentityDisplayFormat extends StObject {
  ...
  /* 2 */ val AvatarAndFullName: typings.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.AvatarAndFullName & Double = js.native
  ...
  sealed trait AvatarOnly
    extends StObject
       with IdentityDisplayFormat
  /* 0 */ val AvatarOnly: typings.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.AvatarOnly & Double = js.native
  ...
  sealed trait FullName
    extends StObject
       with IdentityDisplayFormat
  /* 1 */ val FullName: typings.vsoNodeApi.workInterfacesMod.IdentityDisplayFormat.FullName & Double = js.native
}
