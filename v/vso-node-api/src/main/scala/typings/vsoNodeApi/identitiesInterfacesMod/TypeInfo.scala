...
object TypeInfo {
  ...
  @scala.inline
  def CreateScopeInfo_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CreateScopeInfo")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def FrameworkIdentityInfo_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FrameworkIdentityInfo")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def FrameworkIdentityType_=(x: EnumValuesAggregateIdentity): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FrameworkIdentityType")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def GroupScopeType_=(x: EnumValuesGeneric): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GroupScopeType")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/IdentitiesInterfaces", "TypeInfo.IdentityBatchInfo")
  @js.native
  def IdentityBatchInfo: js.Any = js.native
  @scala.inline
  def IdentityBatchInfo_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IdentityBatchInfo")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/IdentitiesInterfaces", "TypeInfo.IdentityScope")
  @js.native
  def IdentityScope: js.Any = js.native
  @scala.inline
  def IdentityScope_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IdentityScope")(x.asInstanceOf[js.Any])
  
  @JSImport("vso-node-api/interfaces/IdentitiesInterfaces", "TypeInfo.IdentitySnapshot")
  @js.native
  def IdentitySnapshot: js.Any = js.native
  @scala.inline
  def IdentitySnapshot_=(x: js.Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("IdentitySnapshot")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def QueryMembership_=(x: EnumValuesDirect): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("QueryMembership")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def ReadIdentitiesOptions_=(x: EnumValuesFilterIllegalMemberships): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ReadIdentitiesOptions")(x.asInstanceOf[js.Any])
}
