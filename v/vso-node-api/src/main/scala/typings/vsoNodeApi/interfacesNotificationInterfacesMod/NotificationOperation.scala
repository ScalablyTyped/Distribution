...
object NotificationOperation extends StObject {
  ...
  /* 0 */ val None: typings.vsoNodeApi.interfacesNotificationInterfacesMod.NotificationOperation.None & Double = js.native
  
  @js.native
  sealed trait SuspendUnprocessed
    extends StObject
       with NotificationOperation
  /* 1 */ val SuspendUnprocessed: typings.vsoNodeApi.interfacesNotificationInterfacesMod.NotificationOperation.SuspendUnprocessed & Double = js.native
}
