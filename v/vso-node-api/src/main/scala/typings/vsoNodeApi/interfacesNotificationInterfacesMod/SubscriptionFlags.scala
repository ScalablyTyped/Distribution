...
object SubscriptionFlags extends StObject {
  ...
  /* 4 */ val CanOptOut: typings.vsoNodeApi.interfacesNotificationInterfacesMod.SubscriptionFlags.CanOptOut & Double = js.native
  ...
  sealed trait ContributedSubscription
    extends StObject
       with SubscriptionFlags
  /* 2 */ val ContributedSubscription: typings.vsoNodeApi.interfacesNotificationInterfacesMod.SubscriptionFlags.ContributedSubscription & Double = js.native
  ...
  sealed trait GroupSubscription
    extends StObject
       with SubscriptionFlags
  /* 1 */ val GroupSubscription: typings.vsoNodeApi.interfacesNotificationInterfacesMod.SubscriptionFlags.GroupSubscription & Double = js.native
  ...
  sealed trait None
    extends StObject
       with SubscriptionFlags
  /* 0 */ val None: typings.vsoNodeApi.interfacesNotificationInterfacesMod.SubscriptionFlags.None & Double = js.native
  ...
  sealed trait TeamSubscription
    extends StObject
       with SubscriptionFlags
  /* 8 */ val TeamSubscription: typings.vsoNodeApi.interfacesNotificationInterfacesMod.SubscriptionFlags.TeamSubscription & Double = js.native
}
