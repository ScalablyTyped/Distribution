...
object interfacesProjectAnalysisInterfacesMod {
  ...
  object AggregationType extends StObject {
    ...
    /* 1 */ val Daily: typings.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.AggregationType.Daily & Double = js.native
    
    @js.native
    sealed trait Hourly
      extends StObject
         with AggregationType
    /* 0 */ val Hourly: typings.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.AggregationType.Hourly & Double = js.native
  }
  ...
  object ResultPhase extends StObject {
    ...
    sealed trait Full
      extends StObject
         with ResultPhase
    /* 1 */ val Full: typings.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.ResultPhase.Full & Double = js.native
    
    @js.native
    sealed trait Preliminary
      extends StObject
         with ResultPhase
    /* 0 */ val Preliminary: typings.vsoNodeApi.interfacesProjectAnalysisInterfacesMod.ResultPhase.Preliminary & Double = js.native
  }
