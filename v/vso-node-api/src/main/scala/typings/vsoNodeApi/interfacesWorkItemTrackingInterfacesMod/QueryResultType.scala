...
object QueryResultType extends StObject {
  ...
  /* 1 */ val WorkItem: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItem & Double = js.native
  ...
  sealed trait WorkItemLink
    extends StObject
       with QueryResultType
  /* 2 */ val WorkItemLink: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItemLink & Double = js.native
}
