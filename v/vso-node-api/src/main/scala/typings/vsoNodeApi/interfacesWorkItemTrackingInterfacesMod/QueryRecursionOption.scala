...
object QueryRecursionOption extends StObject {
  ...
  /* 1 */ val ChildFirst: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryRecursionOption.ChildFirst & Double = js.native
  ...
  sealed trait ParentFirst
    extends StObject
       with QueryRecursionOption
  /* 0 */ val ParentFirst: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.QueryRecursionOption.ParentFirst & Double = js.native
}
