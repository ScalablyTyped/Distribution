...
object GetFieldsExpand extends StObject {
  ...
  /* 1 */ val ExtensionFields: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.GetFieldsExpand.ExtensionFields & Double = js.native
  ...
  sealed trait None
    extends StObject
       with GetFieldsExpand
  /* 0 */ val None: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.GetFieldsExpand.None & Double = js.native
}
