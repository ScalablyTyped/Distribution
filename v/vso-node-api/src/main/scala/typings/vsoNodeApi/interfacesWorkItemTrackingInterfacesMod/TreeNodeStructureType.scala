...
object TreeNodeStructureType extends StObject {
  ...
  /* 0 */ val Area: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.TreeNodeStructureType.Area & Double = js.native
  ...
  sealed trait Iteration
    extends StObject
       with TreeNodeStructureType
  /* 1 */ val Iteration: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.TreeNodeStructureType.Iteration & Double = js.native
}
