...
object WorkItemErrorPolicy extends StObject {
  ...
  /* 1 */ val Fail: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.WorkItemErrorPolicy.Fail & Double = js.native
  
  @js.native
  sealed trait Omit
    extends StObject
       with WorkItemErrorPolicy
  /* 2 */ val Omit: typings.vsoNodeApi.interfacesWorkItemTrackingInterfacesMod.WorkItemErrorPolicy.Omit & Double = js.native
}
