...
object GitPullRequestQueryType extends StObject {
  ...
  /* 2 */ val Commit: typings.vsoNodeApi.interfacesGitInterfacesMod.GitPullRequestQueryType.Commit & Double = js.native
  ...
  sealed trait LastMergeCommit
    extends StObject
       with GitPullRequestQueryType
  /* 1 */ val LastMergeCommit: typings.vsoNodeApi.interfacesGitInterfacesMod.GitPullRequestQueryType.LastMergeCommit & Double = js.native
  ...
  sealed trait NotSet
    extends StObject
       with GitPullRequestQueryType
  /* 0 */ val NotSet: typings.vsoNodeApi.interfacesGitInterfacesMod.GitPullRequestQueryType.NotSet & Double = js.native
}
