...
object GitConflictUpdateStatus extends StObject {
  ...
  /* 1 */ val BadRequest: typings.vsoNodeApi.interfacesGitInterfacesMod.GitConflictUpdateStatus.BadRequest & Double = js.native
  ...
  sealed trait InvalidResolution
    extends StObject
       with GitConflictUpdateStatus
  /* 2 */ val InvalidResolution: typings.vsoNodeApi.interfacesGitInterfacesMod.GitConflictUpdateStatus.InvalidResolution & Double = js.native
  ...
  sealed trait NotFound
    extends StObject
       with GitConflictUpdateStatus
  /* 4 */ val NotFound: typings.vsoNodeApi.interfacesGitInterfacesMod.GitConflictUpdateStatus.NotFound & Double = js.native
  ...
  sealed trait Succeeded
    extends StObject
       with GitConflictUpdateStatus
  /* 0 */ val Succeeded: typings.vsoNodeApi.interfacesGitInterfacesMod.GitConflictUpdateStatus.Succeeded & Double = js.native
  ...
  sealed trait UnsupportedConflictType
    extends StObject
       with GitConflictUpdateStatus
  /* 3 */ val UnsupportedConflictType: typings.vsoNodeApi.interfacesGitInterfacesMod.GitConflictUpdateStatus.UnsupportedConflictType & Double = js.native
}
