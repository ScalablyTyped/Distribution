...
object GitHistoryMode extends StObject {
  ...
  sealed trait FirstParent
    extends StObject
       with GitHistoryMode
  /* 1 */ val FirstParent: typings.vsoNodeApi.interfacesGitInterfacesMod.GitHistoryMode.FirstParent & Double = js.native
  ...
  sealed trait FullHistory
    extends StObject
       with GitHistoryMode
  /* 2 */ val FullHistory: typings.vsoNodeApi.interfacesGitInterfacesMod.GitHistoryMode.FullHistory & Double = js.native
  ...
  sealed trait FullHistorySimplifyMerges
    extends StObject
       with GitHistoryMode
  /* 3 */ val FullHistorySimplifyMerges: typings.vsoNodeApi.interfacesGitInterfacesMod.GitHistoryMode.FullHistorySimplifyMerges & Double = js.native
  ...
  sealed trait SimplifiedHistory
    extends StObject
       with GitHistoryMode
  /* 0 */ val SimplifiedHistory: typings.vsoNodeApi.interfacesGitInterfacesMod.GitHistoryMode.SimplifiedHistory & Double = js.native
}
