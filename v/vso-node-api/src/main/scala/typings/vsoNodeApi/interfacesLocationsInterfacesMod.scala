...
import typings.vsoNodeApi.interfacesIdentitiesInterfacesMod.Identity
...
object interfacesLocationsInterfacesMod {
  ...
  object InheritLevel extends StObject {
    ...
    sealed trait Account
      extends StObject
         with InheritLevel
    /* 2 */ val Account: typings.vsoNodeApi.interfacesLocationsInterfacesMod.InheritLevel.Account & Double = js.native
    
    @js.native
    sealed trait All
      extends StObject
         with InheritLevel
    /* 7 */ val All: typings.vsoNodeApi.interfacesLocationsInterfacesMod.InheritLevel.All & Double = js.native
    
    @js.native
    sealed trait Collection
      extends StObject
         with InheritLevel
    /* 4 */ val Collection: typings.vsoNodeApi.interfacesLocationsInterfacesMod.InheritLevel.Collection & Double = js.native
    
    @js.native
    sealed trait Deployment
      extends StObject
         with InheritLevel
    /* 1 */ val Deployment: typings.vsoNodeApi.interfacesLocationsInterfacesMod.InheritLevel.Deployment & Double = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with InheritLevel
    /* 0 */ val None: typings.vsoNodeApi.interfacesLocationsInterfacesMod.InheritLevel.None & Double = js.native
  }
  ...
  object RelativeToSetting extends StObject {
    ...
    /* 0 */ val Context: typings.vsoNodeApi.interfacesLocationsInterfacesMod.RelativeToSetting.Context & Double = js.native
    
    @js.native
    sealed trait FullyQualified
      extends StObject
         with RelativeToSetting
    /* 3 */ val FullyQualified: typings.vsoNodeApi.interfacesLocationsInterfacesMod.RelativeToSetting.FullyQualified & Double = js.native
    
    @js.native
    sealed trait WebApplication
      extends StObject
         with RelativeToSetting
    /* 2 */ val WebApplication: typings.vsoNodeApi.interfacesLocationsInterfacesMod.RelativeToSetting.WebApplication & Double = js.native
  }
  ...
  object ServiceStatus extends StObject {
    ...
    sealed trait Active
      extends StObject
         with ServiceStatus
    /* 1 */ val Active: typings.vsoNodeApi.interfacesLocationsInterfacesMod.ServiceStatus.Active & Double = js.native
    
    @js.native
    sealed trait Assigned
      extends StObject
         with ServiceStatus
    /* 0 */ val Assigned: typings.vsoNodeApi.interfacesLocationsInterfacesMod.ServiceStatus.Assigned & Double = js.native
    
    @js.native
    sealed trait Moving
      extends StObject
         with ServiceStatus
    /* 2 */ val Moving: typings.vsoNodeApi.interfacesLocationsInterfacesMod.ServiceStatus.Moving & Double = js.native
  }
