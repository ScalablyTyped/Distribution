...
object TestResultsDetails {
  ...
  extension [Self <: TestResultsDetails](x: Self) {
    ...
    inline def setResultsForGroupVarargs(value: TestResultsDetailsForGroup*): Self = StObject.set(x, "resultsForGroup", js.Array(value :_*))
  }
}
