...
trait AnonAbandonedActive extends js.Object {
...
object AnonAbandonedActive {
  @scala.inline
  def apply(abandoned: Double, active: Double, all: Double, completed: Double, notSet: Double): AnonAbandonedActive = {
    ...
    __obj.asInstanceOf[AnonAbandonedActive]
  }
}
