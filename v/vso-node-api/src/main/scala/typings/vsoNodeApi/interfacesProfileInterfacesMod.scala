...
object interfacesProfileInterfacesMod {
  ...
  object AttributesContainer {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: AttributesContainer] (val x: Self) extends AnyVal {
  ...
  object CreateProfileContext {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: CreateProfileContext] (val x: Self) extends AnyVal {
  ...
  object GeoRegion {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: GeoRegion] (val x: Self) extends AnyVal {
  ...
  object ProfileAttributeBase {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ProfileAttributeBase[?], T] (val x: Self & ProfileAttributeBase[T]) extends AnyVal {
  ...
  object ProfileRegion {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ProfileRegion] (val x: Self) extends AnyVal {
  ...
  object ProfileRegions {
    ...
    @scala.inline
    implicit open class MutableBuilder[Self <: ProfileRegions] (val x: Self) extends AnyVal {
