...
object ContributionLicensingBehaviorType extends StObject {
  ...
  /* 2 */ val AlwaysInclude: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.AlwaysInclude & Double = js.native
  ...
  sealed trait OnlyIfLicensed
    extends StObject
       with ContributionLicensingBehaviorType
  /* 0 */ val OnlyIfLicensed: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfLicensed & Double = js.native
  ...
  sealed trait OnlyIfUnlicensed
    extends StObject
       with ContributionLicensingBehaviorType
  /* 1 */ val OnlyIfUnlicensed: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionLicensingBehaviorType.OnlyIfUnlicensed & Double = js.native
}
