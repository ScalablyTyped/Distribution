...
object ContributionQueryOptions extends StObject {
  ...
  /* 256 */ val IgnoreConstraints: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.IgnoreConstraints with Double = js.native
  ...
  /* 112 */ val IncludeAll: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.IncludeAll with Double = js.native
  ...
  /* 32 */ val IncludeChildren: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.IncludeChildren with Double = js.native
  ...
  /* 16 */ val IncludeSelf: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.IncludeSelf with Double = js.native
  ...
  /* 96 */ val IncludeSubTree: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.IncludeSubTree with Double = js.native
  
  @js.native
  sealed trait None extends ContributionQueryOptions
  /* 0 */ val None: typings.vsoNodeApi.extensionManagementInterfacesMod.ContributionQueryOptions.None with Double = js.native
}
