...
object Key {
  ...
  implicit class KeyOps[Self <: Key] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setValueVarargs(value: WorkItemTypeColor*): Self = this.set("value", js.Array(value :_*))
    @scala.inline
    def setValue(value: js.Array[WorkItemTypeColor]): Self = this.set("value", value.asInstanceOf[js.Any])
  }
