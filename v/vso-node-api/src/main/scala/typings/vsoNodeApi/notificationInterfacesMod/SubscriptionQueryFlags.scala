...
object SubscriptionQueryFlags extends StObject {
  ...
  /* 16 */ val AlwaysReturnBasicInformation: typings.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.AlwaysReturnBasicInformation & Double = js.native
  ...
  sealed trait IncludeDeletedSubscriptions
    extends StObject
       with SubscriptionQueryFlags
  /* 4 */ val IncludeDeletedSubscriptions: typings.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeDeletedSubscriptions & Double = js.native
  ...
  sealed trait IncludeFilterDetails
    extends StObject
       with SubscriptionQueryFlags
  /* 8 */ val IncludeFilterDetails: typings.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeFilterDetails & Double = js.native
  ...
  sealed trait IncludeInvalidSubscriptions
    extends StObject
       with SubscriptionQueryFlags
  /* 2 */ val IncludeInvalidSubscriptions: typings.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.IncludeInvalidSubscriptions & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with SubscriptionQueryFlags
  /* 0 */ val None: typings.vsoNodeApi.notificationInterfacesMod.SubscriptionQueryFlags.None & Double = js.native
}
