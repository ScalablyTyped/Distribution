...
object PropertySelectorType extends StObject {
  ...
  /* 1 */ val Exclusion: typings.vsoNodeApi.releaseInterfacesMod.PropertySelectorType.Exclusion & Double = js.native
  
  @js.native
  sealed trait Inclusion
    extends StObject
       with PropertySelectorType
  /* 0 */ val Inclusion: typings.vsoNodeApi.releaseInterfacesMod.PropertySelectorType.Inclusion & Double = js.native
}
