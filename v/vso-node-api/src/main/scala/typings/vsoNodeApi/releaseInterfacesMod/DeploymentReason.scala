...
object DeploymentReason extends StObject {
  ...
  /* 2 */ val Automated: typings.vsoNodeApi.releaseInterfacesMod.DeploymentReason.Automated & Double = js.native
  ...
  sealed trait Manual
    extends StObject
       with DeploymentReason
  /* 1 */ val Manual: typings.vsoNodeApi.releaseInterfacesMod.DeploymentReason.Manual & Double = js.native
  ...
  sealed trait None
    extends StObject
       with DeploymentReason
  /* 0 */ val None: typings.vsoNodeApi.releaseInterfacesMod.DeploymentReason.None & Double = js.native
  ...
  sealed trait Scheduled
    extends StObject
       with DeploymentReason
  /* 4 */ val Scheduled: typings.vsoNodeApi.releaseInterfacesMod.DeploymentReason.Scheduled & Double = js.native
}
