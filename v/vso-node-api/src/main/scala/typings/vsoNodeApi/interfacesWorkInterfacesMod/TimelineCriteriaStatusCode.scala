...
object TimelineCriteriaStatusCode extends StObject {
  ...
  /* 1 */ val InvalidFilterClause: typings.vsoNodeApi.interfacesWorkInterfacesMod.TimelineCriteriaStatusCode.InvalidFilterClause & Double = js.native
  ...
  sealed trait OK
    extends StObject
       with TimelineCriteriaStatusCode
  /* 0 */ val OK: typings.vsoNodeApi.interfacesWorkInterfacesMod.TimelineCriteriaStatusCode.OK & Double = js.native
  ...
  sealed trait Unknown
    extends StObject
       with TimelineCriteriaStatusCode
  /* 2 */ val Unknown: typings.vsoNodeApi.interfacesWorkInterfacesMod.TimelineCriteriaStatusCode.Unknown & Double = js.native
}
