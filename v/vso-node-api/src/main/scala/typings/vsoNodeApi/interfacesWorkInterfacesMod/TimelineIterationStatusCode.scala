...
object TimelineIterationStatusCode extends StObject {
  ...
  /* 1 */ val IsOverlapping: typings.vsoNodeApi.interfacesWorkInterfacesMod.TimelineIterationStatusCode.IsOverlapping & Double = js.native
  ...
  sealed trait OK
    extends StObject
       with TimelineIterationStatusCode
  /* 0 */ val OK: typings.vsoNodeApi.interfacesWorkInterfacesMod.TimelineIterationStatusCode.OK & Double = js.native
}
