...
object ItemContentType extends StObject {
  ...
  /* 1 */ val Base64Encoded: typings.vsoNodeApi.tfvcInterfacesMod.ItemContentType.Base64Encoded & Double = js.native
  
  @js.native
  sealed trait RawText
    extends StObject
       with ItemContentType
  /* 0 */ val RawText: typings.vsoNodeApi.tfvcInterfacesMod.ItemContentType.RawText & Double = js.native
}
