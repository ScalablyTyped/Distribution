...
object TestConfigurationState extends StObject {
  ...
  /* 1 */ val Active: typings.vsoNodeApi.interfacesTestInterfacesMod.TestConfigurationState.Active & Double = js.native
  ...
  sealed trait Inactive
    extends StObject
       with TestConfigurationState
  /* 2 */ val Inactive: typings.vsoNodeApi.interfacesTestInterfacesMod.TestConfigurationState.Inactive & Double = js.native
}
