...
object CoverageQueryFlags extends StObject {
  ...
  /* 4 */ val BlockData: typings.vsoNodeApi.interfacesTestInterfacesMod.CoverageQueryFlags.BlockData & Double = js.native
  ...
  sealed trait Functions
    extends StObject
       with CoverageQueryFlags
  /* 2 */ val Functions: typings.vsoNodeApi.interfacesTestInterfacesMod.CoverageQueryFlags.Functions & Double = js.native
  ...
  sealed trait Modules
    extends StObject
       with CoverageQueryFlags
  /* 1 */ val Modules: typings.vsoNodeApi.interfacesTestInterfacesMod.CoverageQueryFlags.Modules & Double = js.native
}
