...
object AadLoginPromptOption extends StObject {
  ...
  /* 3 */ val FreshLogin: typings.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.FreshLogin & Double = js.native
  ...
  sealed trait Login
    extends StObject
       with AadLoginPromptOption
  /* 1 */ val Login: typings.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.Login & Double = js.native
  ...
  sealed trait NoOption
    extends StObject
       with AadLoginPromptOption
  /* 0 */ val NoOption: typings.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.NoOption & Double = js.native
  ...
  sealed trait SelectAccount
    extends StObject
       with AadLoginPromptOption
  /* 2 */ val SelectAccount: typings.vsoNodeApi.taskAgentInterfacesMod.AadLoginPromptOption.SelectAccount & Double = js.native
}
