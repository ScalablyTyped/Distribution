...
object interfacesFeatureManagementInterfacesMod {
  ...
  object ContributedFeatureEnabledValue extends StObject {
    ...
    /* 0 */ val Disabled: typings.vsoNodeApi.interfacesFeatureManagementInterfacesMod.ContributedFeatureEnabledValue.Disabled & Double = js.native
    ...
    sealed trait Enabled
      extends StObject
         with ContributedFeatureEnabledValue
    /* 1 */ val Enabled: typings.vsoNodeApi.interfacesFeatureManagementInterfacesMod.ContributedFeatureEnabledValue.Enabled & Double = js.native
    ...
    sealed trait Undefined
      extends StObject
         with ContributedFeatureEnabledValue
    /* -1 */ val Undefined: typings.vsoNodeApi.interfacesFeatureManagementInterfacesMod.ContributedFeatureEnabledValue.Undefined & Double = js.native
  }
