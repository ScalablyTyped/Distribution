...
trait IFeatureManagementApi
  ...
  def getFeature(featureId: java.lang.String): stdLib.Promise[
    vsoDashNodeDashApiLib.interfacesFeatureManagementInterfacesMod.ContributedFeature
  ] = js.native
  def getFeatureState(featureId: java.lang.String, userScope: java.lang.String): stdLib.Promise[
  ...
  def getFeatures(): stdLib.Promise[
    js.Array[
      vsoDashNodeDashApiLib.interfacesFeatureManagementInterfacesMod.ContributedFeature
    ]
  ] = js.native
  def getFeatures(targetContributionId: java.lang.String): stdLib.Promise[
    js.Array[
      vsoDashNodeDashApiLib.interfacesFeatureManagementInterfacesMod.ContributedFeature
    ]
  ] = js.native
  def queryFeatureStates(query: vsoDashNodeDashApiLib.interfacesFeatureManagementInterfacesMod.ContributedFeatureStateQuery): stdLib.Promise[
