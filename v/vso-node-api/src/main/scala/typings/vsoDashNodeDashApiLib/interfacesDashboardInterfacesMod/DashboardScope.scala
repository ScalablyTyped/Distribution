...
object DashboardScope extends js.Object {
  ...
  sealed trait Collection_User
    extends vsoDashNodeDashApiLib.interfacesDashboardInterfacesMod.DashboardScope
  ...
  def apply(value: scala.Double): js.UndefOr[
    vsoDashNodeDashApiLib.interfacesDashboardInterfacesMod.DashboardScope with scala.Double
  ] = js.native
}
