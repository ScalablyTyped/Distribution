...
trait Anon_BuildDefinitionReference extends js.Object {
  ...
  var BuildAuthorizationScope: Anon_EnumValuesAnonProjectCollection
  ...
  var BuildOptionInputType: Anon_EnumValuesAnonBranchFilter
  var BuildPhaseStatus: Anon_EnumValuesAnonSucceededUnknown
  var BuildProcessTemplate: js.Any
  var BuildQueryOrder: Anon_EnumValuesAnonFinishTimeDescending
  var BuildQueuedEvent: js.Any
  var BuildReason: Anon_EnumValuesAnonAllIndividualCI
  var BuildReference: js.Any
  var BuildRequestValidationResult: js.Any
  var BuildResult: Anon_EnumValuesAnonFailedSucceededCanceled
  var BuildServer: js.Any
  var BuildStartedEvent: js.Any
  var BuildStatus: Anon_EnumValuesAnonNotStartedPostponed
  ...
  var ControllerStatus: Anon_EnumValuesAnonOfflineUnavailable
  var DefinitionQuality: Anon_EnumValuesAnonDraft
  var DefinitionQueryOrder: Anon_EnumValuesAnonLastModifiedAscending
  var DefinitionQueueStatus: Anon_EnumValuesAnonPaused
  var DefinitionReference: js.Any
  var DefinitionTriggerType: Anon_EnumValuesAnonContinuousIntegration
  var DefinitionType: Anon_EnumValuesAnonXaml
  var DeleteOptions: Anon_EnumValuesAnonAllLabel
  var DesignerProcess: js.Any
  var Folder: js.Any
  var FolderQueryOrder: Anon_EnumValuesAnonNoneFolderAscending
  var GatedCheckInTrigger: js.Any
  var GetOption: Anon_EnumValuesAnonCustomLatestOnQueue
  var InformationNode: js.Any
  var Issue: js.Any
  var IssueType: Anon_EnumValuesAnonWarning
  var Phase: js.Any
  var ProcessTemplateType: Anon_EnumValuesAnonCustomDefault
  var PullRequestTrigger: js.Any
  var QueryDeletedOption: Anon_EnumValuesAnonIncludeDeleted
  var QueueOptions: Anon_EnumValuesAnonNoneDoNotRun
  var QueuePriority: Anon_EnumValuesAnonAboveNormal
  var RepositoryCleanOptions: Anon_EnumValuesAnonSourceAndOutputDir
  var Schedule: js.Any
  ...
  var SourceProviderAvailability: Anon_EnumValuesAnonHosted
  ...
  var TimelineRecordState: Anon_EnumValuesAnonPending
  var TimelineRecordsUpdatedEvent: js.Any
  var ValidationResult: Anon_EnumValuesAnonOKWarning
