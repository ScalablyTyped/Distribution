...
trait IWorkItemTrackingProcessDefinitionsApi
  ...
  def deleteBehavior(processId: java.lang.String, behaviorId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def deleteList(listId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def deleteStateDefinition(processId: java.lang.String, witRefName: java.lang.String, stateId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def deleteWorkItemType(processId: java.lang.String, witRefName: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def editControl(
    control: vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.Control,
    processId: java.lang.String,
    witRefName: java.lang.String,
  ...
  def getBehavior(processId: java.lang.String, behaviorId: java.lang.String): stdLib.Promise[
    vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.BehaviorModel
  ] = js.native
  ...
  def getBehaviorsForWorkItemType(processId: java.lang.String, witRefNameForBehaviors: java.lang.String): stdLib.Promise[
    js.Array[
      vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeBehavior
    ]
  ] = js.native
  def getFormLayout(processId: java.lang.String, witRefName: java.lang.String): stdLib.Promise[
    vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.FormLayout
  ] = js.native
  def getList(listId: java.lang.String): stdLib.Promise[
    vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.PickListModel
  ] = js.native
  def getListsMetadata(): stdLib.Promise[
    js.Array[
  ...
  def getWorkItemTypeField(processId: java.lang.String, witRefNameForFields: java.lang.String, fieldRefName: java.lang.String): stdLib.Promise[
    vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeFieldModel
  ] = js.native
  def getWorkItemTypeFields(processId: java.lang.String, witRefNameForFields: java.lang.String): stdLib.Promise[
    js.Array[
      vsoDashNodeDashApiLib.interfacesWorkItemTrackingProcessDefinitionsInterfacesMod.WorkItemTypeFieldModel
    ]
  ] = js.native
  ...
  def removeFieldFromWorkItemType(processId: java.lang.String, witRefNameForFields: java.lang.String, fieldRefName: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def removeGroup(
    processId: java.lang.String,
    witRefName: java.lang.String,
    pageId: java.lang.String,
  ...
  def removePage(processId: java.lang.String, witRefName: java.lang.String, pageId: java.lang.String): stdLib.Promise[scala.Unit] = js.native
  def replaceBehavior(
