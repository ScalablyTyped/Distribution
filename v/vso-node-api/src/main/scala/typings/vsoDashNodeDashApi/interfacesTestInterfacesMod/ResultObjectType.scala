...
object ResultObjectType extends js.Object {
  ...
  object TestPlan
    extends TopLevel[
          typings.vsoDashNodeDashApi.interfacesTestInterfacesMod.ResultObjectType.TestPlan with Double
        ]
  
  /* 0 */ @js.native
  object TestSuite
    extends TopLevel[
          typings.vsoDashNodeDashApi.interfacesTestInterfacesMod.ResultObjectType.TestSuite with Double
        ]
