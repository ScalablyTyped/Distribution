...
import typings.vsoDashNodeDashApi.interfacesDashboardInterfacesMod.DashboardScope.Collection_User
import typings.vsoDashNodeDashApi.interfacesDashboardInterfacesMod.DashboardScope.Project_Team
