...
object QueryResultType extends js.Object {
  ...
  object WorkItem
    extends TopLevel[
          typings.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItem with Double
        ]
  
  /* 2 */ @js.native
  object WorkItemLink
    extends TopLevel[
          typings.vsoDashNodeDashApi.interfacesWorkItemTrackingInterfacesMod.QueryResultType.WorkItemLink with Double
        ]
