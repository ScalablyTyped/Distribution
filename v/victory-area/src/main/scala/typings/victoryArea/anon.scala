...
object anon {
  ...
  trait TypeofVictoryAreaBase extends StObject {
  ...
  object TypeofVictoryAreaBase {
    ...
    inline def apply(
      ...
      __obj.asInstanceOf[TypeofVictoryAreaBase]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TypeofVictoryAreaBase] (val x: Self) extends AnyVal {
