...
@js.native
class namespaced protected () extends Victor {
  /**
...
object namespaced extends js.Object {
  /**
       ...
       */
  def fromArray(arr: js.Array[scala.Double]): victorLib.victorMod.Victor = js.native
  /**
       ...
       */
  def fromObject(obj: victorLib.victorMod.VictorCoordinates): victorLib.victorMod.Victor = js.native
}
