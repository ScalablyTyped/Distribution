...
object mod {
  ...
  @scala.inline
  def domCanvas(w: Double, h: Double): HTMLCanvasElement | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("domCanvas")(w.asInstanceOf[js.Any], h.asInstanceOf[js.Any])).asInstanceOf[HTMLCanvasElement | Null]
  
  @scala.inline
  def image(): HTMLImageElement | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Image */ js.Any) | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("image")().asInstanceOf[HTMLImageElement | (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Image */ js.Any) | Null]
