...
trait AnonAnchorAttributes extends js.Object {
  var anchorAttributes: AnonDefault
  var breaks: AnonType
  var emoji: AnonType
  var highlight: AnonType
  var html: AnonType
  var langPrefix: AnonDefaultType
  var linkify: AnonType
  var postrender: AnonDefault
  var prerender: AnonDefault
  var quotes: AnonDefaultType
  var show: AnonType
  var source: AnonDefaultType
  var tableClass: AnonDefaultType
  var taskLists: AnonType
  var toc: AnonType
  var tocAnchorClass: AnonDefaultType
  var tocAnchorLink: AnonType
  var tocAnchorLinkClass: AnonDefaultType
  var tocAnchorLinkSpace: AnonType
  var tocAnchorLinkSymbol: AnonDefaultType
  var tocClass: AnonDefaultType
  var tocFirstLevel: AnonDefaultNumber
  var tocId: AnonTypeAny
  var tocLastLevel: AnonTypeAny
  var typographer: AnonType
  var watches: AnonDefault
  var xhtmlOut: AnonType
}
