...
trait BarConfig
  ...
  /**
    ...
    * @minimum 0
    */
  var continuousBandSize: js.UndefOr[scala.Double] = js.undefined
  /**
    * The size of the bars.  If unspecified, the default size is  `bandSize-1`,
    * which provides 1 pixel offset between bars.
    * @minimum 0
    */
  var discreteBandSize: js.UndefOr[scala.Double] = js.undefined
}
...
object BarConfig {
  ...
  def apply(
    ...
    continuousBandSize: scala.Int | scala.Double = null,
    ...
    discreteBandSize: scala.Int | scala.Double = null,
