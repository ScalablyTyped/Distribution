...
trait AutoSizeParams extends js.Object {
  ...
  var contains: js.UndefOr[
    vegaDashLiteLib.vegaDashLiteLibStrings.content | vegaDashLiteLib.vegaDashLiteLibStrings.padding
  ] = js.undefined
  /**
...
object AutoSizeParams {
  @scala.inline
  def apply(
    contains: vegaDashLiteLib.vegaDashLiteLibStrings.content | vegaDashLiteLib.vegaDashLiteLibStrings.padding = null,
