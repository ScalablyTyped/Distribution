package typings
package vegaDashLiteLib.buildSrcUtilMod
...
object ^ extends js.Object {
  ...
  def differ[T](dict: Dict[T], other: Dict[T]): scala.Boolean = js.native
  ...
  def flagKeys[S /* <: java.lang.String */](f: Flag[S]): js.Array[S] = js.native
  ...
  def hasIntersection(a: StringSet, b: StringSet): scala.Boolean = js.native
  ...
  def omit[T /* <: js.Object */, K /* <: java.lang.String */](obj: T, props: js.Array[K]): Omit[T, K] = js.native
