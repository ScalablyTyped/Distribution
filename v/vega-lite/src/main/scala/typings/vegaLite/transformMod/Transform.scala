...
object Transform {
  ...
  inline def AggregateTransform(aggregate: js.Array[AggregatedFieldDef]): typings.vegaLite.transformMod.AggregateTransform = {
  ...
  inline def BinTransform(as: FieldName | js.Array[FieldName], bin: `true` | BinParams, field: FieldName): typings.vegaLite.transformMod.BinTransform = {
  ...
  inline def CalculateTransform(as: FieldName, calculate: String): typings.vegaLite.transformMod.CalculateTransform = {
  ...
  inline def DensityTransform(density: FieldName): typings.vegaLite.transformMod.DensityTransform = {
  ...
  inline def FilterTransform(filter: LogicalComposition[Predicate]): typings.vegaLite.transformMod.FilterTransform = {
    val __obj = js.Dynamic.literal(filter = filter.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.vegaLite.transformMod.FilterTransform]
  }
  
  inline def FlattenTransform(flatten: js.Array[FieldName]): typings.vegaLite.transformMod.FlattenTransform = {
  ...
  inline def FoldTransform(fold: js.Array[FieldName]): typings.vegaLite.transformMod.FoldTransform = {
    val __obj = js.Dynamic.literal(fold = fold.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.vegaLite.transformMod.FoldTransform]
  }
  
  inline def ImputeTransform(impute: FieldName, key: FieldName): typings.vegaLite.transformMod.ImputeTransform = {
  ...
  inline def JoinAggregateTransform(joinaggregate: js.Array[JoinAggregateFieldDef]): typings.vegaLite.transformMod.JoinAggregateTransform = {
  ...
  inline def LoessTransform(loess: FieldName, on: FieldName): typings.vegaLite.transformMod.LoessTransform = {
  ...
  inline def LookupTransform(from: LookupData | LookupSelection, lookup: String): typings.vegaLite.transformMod.LookupTransform = {
  ...
  inline def PivotTransform(pivot: FieldName, value: FieldName): typings.vegaLite.transformMod.PivotTransform = {
  ...
  inline def QuantileTransform(quantile: FieldName): typings.vegaLite.transformMod.QuantileTransform = {
  ...
  inline def RegressionTransform(on: FieldName, regression: FieldName): typings.vegaLite.transformMod.RegressionTransform = {
  ...
  inline def SampleTransform(sample: Double): typings.vegaLite.transformMod.SampleTransform = {
  ...
  inline def StackTransform(as: FieldName | (js.Tuple2[FieldName, FieldName]), groupby: js.Array[FieldName], stack: FieldName): typings.vegaLite.transformMod.StackTransform = {
  ...
  inline def TimeUnitTransform(as: FieldName, field: FieldName, timeUnit: TimeUnit | TimeUnitParams): typings.vegaLite.transformMod.TimeUnitTransform = {
  ...
  inline def WindowTransform(window: js.Array[WindowFieldDef]): typings.vegaLite.transformMod.WindowTransform = {
