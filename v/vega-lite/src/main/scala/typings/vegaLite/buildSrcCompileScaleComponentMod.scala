...
object buildSrcCompileScaleComponentMod {
  ...
  trait ScaleComponentProps extends StObject {
    ...
    var `type`: js.UndefOr[typings.vegaTypings.typesSpecScaleMod.ScaleType] = js.undefined
  ...
  object ScaleComponentProps {
    ...
    implicit open class MutableBuilder[Self <: ScaleComponentProps] (val x: Self) extends AnyVal {
      ...
      inline def setType(value: typings.vegaTypings.typesSpecScaleMod.ScaleType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
