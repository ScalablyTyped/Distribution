...
object ClipHeight {
  ...
  @scala.inline
  def apply(): ClipHeight = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ClipHeight]
  }
  
  @scala.inline
  implicit class ClipHeightMutableBuilder[Self <: ClipHeight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setFormat(value: String | SignalRef | TimeFormatSpecifier): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setFormatType(value: number | time | SignalRef | utc): Self = StObject.set(x, "formatType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setGridAlign(value: all | none | SignalRef | each): Self = StObject.set(x, "gridAlign", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelFontStyle(value: StringValue): Self = StObject.set(x, "labelFontStyle", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setLabelOverlap(value: Boolean | SignalRef | parity | greedy): Self = StObject.set(x, "labelOverlap", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setSymbolType(value: StringValue): Self = StObject.set(x, "symbolType", value.asInstanceOf[js.Any])
    ...
    @scala.inline
    def setTitleFontStyle(value: StringValue): Self = StObject.set(x, "titleFontStyle", value.asInstanceOf[js.Any])
