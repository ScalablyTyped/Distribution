...
trait GenericHConcatSpecGeneric extends StObject {
  ...
  /**
    ...
    */
  var hconcat: js.Array[GenericSpec[NormalizedUnitSpec, NormalizedLayerSpec, scala.Nothing, String]]
...
object GenericHConcatSpecGeneric {
  ...
  inline def apply(hconcat: js.Array[GenericSpec[NormalizedUnitSpec, NormalizedLayerSpec, scala.Nothing, String]]): GenericHConcatSpecGeneric = {
    val __obj = js.Dynamic.literal(hconcat = hconcat.asInstanceOf[js.Any])
    __obj.asInstanceOf[GenericHConcatSpecGeneric]
  }
  
  extension [Self <: GenericHConcatSpecGeneric](x: Self) {
    ...
    inline def setHconcat(value: js.Array[GenericSpec[NormalizedUnitSpec, NormalizedLayerSpec, scala.Nothing, String]]): Self = StObject.set(x, "hconcat", value.asInstanceOf[js.Any])
    
    inline def setHconcatVarargs(value: (GenericSpec[NormalizedUnitSpec, NormalizedLayerSpec, scala.Nothing, String])*): Self = StObject.set(x, "hconcat", js.Array(value :_*))
