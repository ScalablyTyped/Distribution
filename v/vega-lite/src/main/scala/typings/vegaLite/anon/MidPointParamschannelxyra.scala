...
trait MidPointParamschannelxyra extends StObject {
  ...
  var channel: typings.vegaLite.channelMod.Channel with (x | y | radius | theta) = js.native
...
object MidPointParamschannelxyra {
  ...
  @scala.inline
  def apply(
    channel: typings.vegaLite.channelMod.Channel with (x | y | radius | theta),
  ...
  implicit class MidPointParamschannelxyraMutableBuilder[Self <: MidPointParamschannelxyra] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setChannel(
      value: typings.vegaLite.channelMod.Channel with (typings.vegaLite.vegaLiteStrings.x | y | radius | theta)
