...
trait CornerRadiusTopLeft extends StObject {
...
object CornerRadiusTopLeft {
  
  @scala.inline
  def apply(
    ariaRoleDescription: Unit,
    description: SignalRef | ValueString,
    tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal
  ): CornerRadiusTopLeft = {
    val __obj = js.Dynamic.literal(ariaRoleDescription = ariaRoleDescription.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], tooltip = tooltip.asInstanceOf[js.Any])
    __obj.asInstanceOf[CornerRadiusTopLeft]
  }
  
  @scala.inline
  implicit class CornerRadiusTopLeftMutableBuilder[Self <: CornerRadiusTopLeft] (val x: Self) extends AnyVal {
