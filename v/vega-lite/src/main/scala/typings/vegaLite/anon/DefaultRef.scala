...
trait DefaultRef extends StObject {
  ...
  var defaultValue: js.UndefOr[(typings.vegaLite.buildSrcChanneldefMod.Value[ExprRef | SignalRef]) | SignalRef] = js.undefined
...
object DefaultRef {
  ...
  extension [Self <: DefaultRef](x: Self) {
    ...
    inline def setDefaultValue(value: (typings.vegaLite.buildSrcChanneldefMod.Value[ExprRef | SignalRef]) | SignalRef): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
