...
object `0` {
  ...
  @scala.inline
  def apply[F /* <: typings.vegaLite.channeldefMod.Field */](condition: Conditional[TypedFieldDef[F, _, Boolean | BinParams | binned | Null]]): `0`[F] = {
    val __obj = js.Dynamic.literal(condition = condition.asInstanceOf[js.Any])
    __obj.asInstanceOf[`0`[F]]
  }
  
  @scala.inline
  implicit class `0MutableBuilder`[Self <: `0`[_], F /* <: typings.vegaLite.channeldefMod.Field */] (val x: Self with `0`[F]) extends AnyVal {
