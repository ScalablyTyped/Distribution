...
trait CornerRadiusTopRight extends StObject {
...
object CornerRadiusTopRight {
  
  inline def apply(ariaRoleDescription: `3`, tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal): CornerRadiusTopRight = {
    ...
    __obj.asInstanceOf[CornerRadiusTopRight]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: CornerRadiusTopRight] (val x: Self) extends AnyVal {
