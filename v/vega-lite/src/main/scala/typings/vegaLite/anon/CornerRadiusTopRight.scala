...
trait CornerRadiusTopRight extends StObject {
  ...
  var tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal = js.native
...
object CornerRadiusTopRight {
  ...
  @scala.inline
  def apply(
    ariaRoleDescription: ValueScaleField,
  ...
  @scala.inline
  implicit class CornerRadiusTopRightMutableBuilder[Self <: CornerRadiusTopRight] (val x: Self) extends AnyVal {
