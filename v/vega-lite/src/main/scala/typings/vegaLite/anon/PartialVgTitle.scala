...
trait PartialVgTitle extends StObject {
  ...
  var encode: js.UndefOr[TitleEncode | typings.vegaTypings.encodeMod.Encode[TextEncodeEntry]] = js.native
...
object PartialVgTitle {
  ...
  implicit class PartialVgTitleMutableBuilder[Self <: PartialVgTitle] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setEncode(value: TitleEncode | typings.vegaTypings.encodeMod.Encode[TextEncodeEntry]): Self = StObject.set(x, "encode", value.asInstanceOf[js.Any])
