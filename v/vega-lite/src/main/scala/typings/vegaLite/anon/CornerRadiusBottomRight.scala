...
object CornerRadiusBottomRight {
  ...
  inline def apply(ariaRoleDescription: Unit, tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal): CornerRadiusBottomRight = {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: CornerRadiusBottomRight] (val x: Self) extends AnyVal {
    ...
    inline def setTooltip(value: VgValueRef | js.Array[VgValueRefteststringundef] | Signal): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
