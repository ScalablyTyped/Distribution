...
trait CornerRadiusBottomRight extends StObject {
  ...
  var tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal
...
object CornerRadiusBottomRight {
  
  @scala.inline
  def apply(ariaRoleDescription: Unit, tooltip: VgValueRef | js.Array[VgValueRefteststringundef] | Signal): CornerRadiusBottomRight = {
    val __obj = js.Dynamic.literal(ariaRoleDescription = ariaRoleDescription.asInstanceOf[js.Any], tooltip = tooltip.asInstanceOf[js.Any])
    __obj.asInstanceOf[CornerRadiusBottomRight]
  }
  
  @scala.inline
  implicit class CornerRadiusBottomRightMutableBuilder[Self <: CornerRadiusBottomRight] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setTooltip(value: VgValueRef | js.Array[VgValueRefteststringundef] | Signal): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
