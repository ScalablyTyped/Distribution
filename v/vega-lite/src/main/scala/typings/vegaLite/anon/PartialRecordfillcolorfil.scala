...
/* Inlined std.Partial<std.Record<'fill' | 'color' | 'fillOpacity' | 'opacity' | 'stroke' | 'strokeOpacity' | 'strokeWidth' | 'size' | 'strokeDash' | 'angle' | 'shape', vega-lite.vega-lite/build/src/compile/legend/component.LegendComponent>> */
trait PartialRecordfillcolorfil extends StObject {
...
object PartialRecordfillcolorfil {
  
  inline def apply(): PartialRecordfillcolorfil = {
