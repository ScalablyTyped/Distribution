...
import typings.vegaTypings.typesSpecTransformMod.AggregateTransform
...
object buildSrcCompileDataAggregateMod {
  ...
  object AggregateNode {
    ...
    inline def makeFromTransform(parent: DataFlowNode, t: typings.vegaLite.buildSrcTransformMod.AggregateTransform): AggregateNode = (^.asInstanceOf[js.Dynamic].applyDynamic("makeFromTransform")(parent.asInstanceOf[js.Any], t.asInstanceOf[js.Any])).asInstanceOf[AggregateNode]
  }
