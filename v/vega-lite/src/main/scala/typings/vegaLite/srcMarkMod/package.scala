...
@scala.inline
def getMarkType(m: typings.vegaLite.srcMarkMod.GenericMarkDef[js.Any]): js.Any = typings.vegaLite.srcMarkMod.^.asInstanceOf[js.Dynamic].applyDynamic("getMarkType")(m.asInstanceOf[js.Any]).asInstanceOf[js.Any]
