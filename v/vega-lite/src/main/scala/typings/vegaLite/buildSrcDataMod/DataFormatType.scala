...
/* Rewritten from type alias, can be one of: 
  - typings.vegaLite.vegaLiteStrings.json
  - typings.vegaLite.vegaLiteStrings.csv
  - typings.vegaLite.vegaLiteStrings.tsv
  - typings.vegaLite.vegaLiteStrings.dsv
  - typings.vegaLite.vegaLiteStrings.topojson
*/
