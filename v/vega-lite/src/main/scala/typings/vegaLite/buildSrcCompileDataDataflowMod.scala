...
import typings.vegaLite.buildSrcDataMod.DataSourceType
import typings.vegaLite.buildSrcUtilMod.Dict
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object buildSrcCompileDataDataflowMod {
  
  /* note: abstract class */ @JSImport("vega-lite/build/src/compile/data/dataflow", "DataFlowNode")
  @js.native
  open class DataFlowNode protected () extends StObject {
