...
trait DatumDef[F /* <: Field */, V /* <: PrimitiveValue | DateTime | ExprRef | SignalRef */] extends StObject {
  ...
  var datum: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: F extends vega-lite.vega-lite/build/src/channeldef.RepeatRef ? V | vega-lite.vega-lite/build/src/channeldef.RepeatRef : V */ js.Any
  ] = js.undefined
...
object DatumDef {
  ...
  implicit open class MutableBuilder[Self <: DatumDef[?, ?], F /* <: Field */, V /* <: PrimitiveValue | DateTime | ExprRef | SignalRef */] (val x: Self & (DatumDef[F, V])) extends AnyVal {
    ...
    inline def setDatum(
      value: /* import warning: importer.ImportType#apply Failed type conversion: F extends vega-lite.vega-lite/build/src/channeldef.RepeatRef ? V | vega-lite.vega-lite/build/src/channeldef.RepeatRef : V */ js.Any
