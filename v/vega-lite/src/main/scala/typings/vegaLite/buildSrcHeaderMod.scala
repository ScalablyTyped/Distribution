...
import typings.vegaLite.buildSrcGuideMod.VlOnlyGuideConfig
...
object buildSrcHeaderMod {
  ...
  - typings.vegaLite.buildSrcChanneldefMod.FormatMixins because Already inherited
  - typings.vegaLite.buildSrcGuideMod.Guide because var conflicts: format, formatType. Inlined  */ trait Header[ES /* <: ExprRef | SignalRef */]
    extends StObject
       with CoreHeader[ES]
       with TitleMixins
  object Header {
