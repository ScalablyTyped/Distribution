...
import typings.vegaLite.buildSrcChanneldefMod.ConditionValueDefMixins
...
object buildSrcGuideMod {
  
  @JSImport("vega-lite/build/src/guide", "VL_ONLY_LEGEND_CONFIG")
  @js.native
  val VL_ONLY_LEGEND_CONFIG: js.Array[
    /* keyof vega-lite.vega-lite/build/src/legend.LegendConfig<any> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 75, starting with typings.vegaLite.vegaLiteStrings.labelOverlap, typings.vegaLite.vegaLiteStrings.direction, typings.vegaLite.vegaLiteStrings.orient */ Any
  ] = js.native
