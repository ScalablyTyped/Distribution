...
import typings.vegaLite.buildSrcCompileLayoutsizeComponentMod.LayoutSizeComponent
import typings.vegaLite.buildSrcCompileLayoutsizeComponentMod.LayoutSizeType
import typings.vegaLite.buildSrcCompileLegendComponentMod.LegendComponentIndex
import typings.vegaLite.buildSrcCompileProjectionComponentMod.ProjectionComponent
import typings.vegaLite.buildSrcCompileScaleComponentMod.ScaleComponent
import typings.vegaLite.buildSrcCompileScaleComponentMod.ScaleComponentIndex
...
import typings.vegaLite.buildSrcVegaDotschemaMod.VgLayout
