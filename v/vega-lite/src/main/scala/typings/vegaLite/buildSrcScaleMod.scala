...
object buildSrcScaleMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - js.Array[
  scala.Null | java.lang.String | scala.Double | scala.Boolean | typings.vegaLite.buildSrcDatetimeMod.DateTime | typings.vegaTypings.typesSpecSignalMod.SignalRef]
    - typings.vegaLite.vegaLiteStrings.unaggregated
    - typings.vegaLite.buildSrcSelectionMod.ParameterExtent
    - typings.vegaTypings.typesSpecSignalMod.SignalRef
    - typings.vegaLite.buildSrcScaleMod.DomainUnionWith
  */
