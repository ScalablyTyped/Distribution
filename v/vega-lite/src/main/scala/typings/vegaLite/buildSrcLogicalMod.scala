...
object buildSrcLogicalMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.vegaLite.buildSrcLogicalMod.LogicalNot[T]
    - typings.vegaLite.buildSrcLogicalMod.LogicalAnd[T]
    - typings.vegaLite.buildSrcLogicalMod.LogicalOr[T]
    - T
  */
  ...
  object _LogicalComposition {
    ...
    inline def LogicalAnd[T](and: js.Array[LogicalComposition[T]]): typings.vegaLite.buildSrcLogicalMod.LogicalAnd[T] = {
      val __obj = js.Dynamic.literal(and = and.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaLite.buildSrcLogicalMod.LogicalAnd[T]]
    }
    
    inline def LogicalNot[T](not: LogicalComposition[T]): typings.vegaLite.buildSrcLogicalMod.LogicalNot[T] = {
      val __obj = js.Dynamic.literal(not = not.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaLite.buildSrcLogicalMod.LogicalNot[T]]
    }
    
    inline def LogicalOr[T](or: js.Array[LogicalComposition[T]]): typings.vegaLite.buildSrcLogicalMod.LogicalOr[T] = {
      val __obj = js.Dynamic.literal(or = or.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaLite.buildSrcLogicalMod.LogicalOr[T]]
    }
  }
}
