...
trait Encoding[F] extends js.Object {
  ...
  var color: js.UndefOr[
    FieldDefWithCondition[MarkPropFieldDef[F]] | ValueDefWithCondition[MarkPropFieldDef[F]]
  ] = js.undefined
  /**
    * Additional levels of detail for grouping data in aggregate views and
    * in line, trail, and area marks without mapping data to a specific visual channel.
    */
  var detail: js.UndefOr[FieldDef[F] | js.Array[FieldDef[F]]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var href: js.UndefOr[FieldDefWithCondition[FieldDef[F]] | ValueDefWithCondition[FieldDef[F]]] = js.undefined
  /**
    * A data field to use as a unique key for data binding. When a visualization’s data is updated, the key value will be used to match data elements to existing mark instances. Use a key channel to enable object constancy for transitions over dynamic data.
    */
  var key: js.UndefOr[FieldDef[F]] = js.undefined
  /**
    * Latitude position of geographically projected marks.
    */
  var latitude: js.UndefOr[FieldDef[F]] = js.undefined
  /**
    * Latitude-2 position for geographically projected ranged `"area"`, `"bar"`, `"rect"`, and  `"rule"`.
    */
  var latitude2: js.UndefOr[FieldDef[F]] = js.undefined
  /**
    * Longitude position of geographically projected marks.
    */
  var longitude: js.UndefOr[FieldDef[F]] = js.undefined
  /**
    * Longitude-2 position for geographically projected ranged `"area"`, `"bar"`, `"rect"`, and  `"rule"`.
    */
  var longitude2: js.UndefOr[FieldDef[F]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var order: js.UndefOr[OrderFieldDef[F] | js.Array[OrderFieldDef[F]] | ValueDef] = js.undefined
  /**
  ...
  /**
    ...
    */
  var text: js.UndefOr[FieldDefWithCondition[TextFieldDef[F]] | ValueDefWithCondition[TextFieldDef[F]]] = js.undefined
  /**
    * The tooltip text to show upon mouse hover.
    */
  var tooltip: js.UndefOr[
    FieldDefWithCondition[TextFieldDef[F]] | ValueDefWithCondition[TextFieldDef[F]] | js.Array[TextFieldDef[F]]
  ] = js.undefined
  /**
    * X coordinates of the marks, or width of horizontal `"bar"` and `"area"`.
    */
  var x: js.UndefOr[PositionFieldDef[F] | ValueDef] = js.undefined
  /**
    * X2 coordinates for ranged `"area"`, `"bar"`, `"rect"`, and  `"rule"`.
    */
  var x2: js.UndefOr[FieldDef[F] | ValueDef] = js.undefined
  /**
    * Y coordinates of the marks, or height of vertical `"bar"` and `"area"`.
    */
  var y: js.UndefOr[PositionFieldDef[F] | ValueDef] = js.undefined
  /**
    * Y2 coordinates for ranged `"area"`, `"bar"`, `"rect"`, and  `"rule"`.
    */
  var y2: js.UndefOr[FieldDef[F] | ValueDef] = js.undefined
}
