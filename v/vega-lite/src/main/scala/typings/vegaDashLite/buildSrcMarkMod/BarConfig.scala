...
object BarConfig {
  ...
  def apply(
    ...
    color: String = null,
    continuousBandSize: Int | Double = null,
    cornerRadius: Int | Double = null,
    cursor: Cursor = null,
    dir: Dir = null,
    discreteBandSize: Int | Double = null,
    dx: Int | Double = null,
    dy: Int | Double = null,
    ...
    if (continuousBandSize != null) __obj.updateDynamic("continuousBandSize")(continuousBandSize.asInstanceOf[js.Any])
    if (cornerRadius != null) __obj.updateDynamic("cornerRadius")(cornerRadius.asInstanceOf[js.Any])
    if (cursor != null) __obj.updateDynamic("cursor")(cursor)
    if (dir != null) __obj.updateDynamic("dir")(dir)
    if (discreteBandSize != null) __obj.updateDynamic("discreteBandSize")(discreteBandSize.asInstanceOf[js.Any])
