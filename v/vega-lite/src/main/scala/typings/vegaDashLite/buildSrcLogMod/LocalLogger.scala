...
class LocalLogger () extends LoggerInterface {
  ...
  /* CompleteClass */
  override def debug(args: js.Any*): LoggerInterface = js.native
  /* CompleteClass */
  override def error(args: js.Any*): LoggerInterface = js.native
  /* CompleteClass */
  override def info(args: js.Any*): LoggerInterface = js.native
  def level(): this.type = js.native
  /* CompleteClass */
  override def level(`_`: Double): Double | LoggerInterface = js.native
  /* CompleteClass */
  override def warn(args: js.Any*): LoggerInterface = js.native
}
