...
trait ScaleConfig extends js.Object {
  /**
    ...
    * @maximum 1
    */
  var bandPaddingInner: js.UndefOr[Double] = js.undefined
  /**
    ...
    * @maximum 1
    */
  var bandPaddingOuter: js.UndefOr[Double] = js.undefined
  /**
  ...
  /**
    ...
    * @minimum 0
    */
  var continuousPadding: js.UndefOr[Double] = js.undefined
  /**
  ...
  /**
    ...
    * @minimum 0
    */
  var rangeStep: js.UndefOr[Double | Null] = js.undefined
  /**
  ...
  /**
    ...
    *  @minimum 0
    */
  var textXRangeStep: js.UndefOr[Double] = js.undefined
  /**
...
object ScaleConfig {
  @scala.inline
  def apply(
    bandPaddingInner: Int | Double = null,
    bandPaddingOuter: Int | Double = null,
    clamp: js.UndefOr[Boolean] = js.undefined,
    continuousPadding: Int | Double = null,
    maxBandSize: Int | Double = null,
    maxFontSize: Int | Double = null,
    maxOpacity: Int | Double = null,
    maxSize: Int | Double = null,
    maxStrokeWidth: Int | Double = null,
    minBandSize: Int | Double = null,
    minFontSize: Int | Double = null,
    minOpacity: Int | Double = null,
    minSize: Int | Double = null,
    minStrokeWidth: Int | Double = null,
    pointPadding: Int | Double = null,
    rangeStep: Int | Double = null,
    round: js.UndefOr[Boolean] = js.undefined,
    textXRangeStep: Int | Double = null,
    useUnaggregatedDomain: js.UndefOr[Boolean] = js.undefined
  ): ScaleConfig = {
