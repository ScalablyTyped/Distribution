...
import typings.vegaDashLite.buildSrcVegaDotSchemaMod.ScaleInterpolateParams
import typings.vegaDashLite.vegaDashLiteStrings.unaggregated
...
trait Scale extends js.Object {
  ...
  var domain: js.UndefOr[
    (js.Array[Boolean | DateTime | Double | String]) | unaggregated | SelectionDomain
  ] = js.undefined
  /**
  ...
  /**
    ...
    */
  var range: js.UndefOr[(js.Array[Double | String]) | String] = js.undefined
  /**
  ...
  /**
    ...
    */
  var scheme: js.UndefOr[String | SchemeParams] = js.undefined
  /**
...
object Scale {
  ...
  def apply(
    ...
    domain: (js.Array[Boolean | DateTime | Double | String]) | unaggregated | SelectionDomain = null,
    ...
    range: (js.Array[Double | String]) | String = null,
    rangeStep: Int | Double = null,
    reverse: js.UndefOr[Boolean] = js.undefined,
    round: js.UndefOr[Boolean] = js.undefined,
    scheme: String | SchemeParams = null,
    `type`: ScaleType = null,
