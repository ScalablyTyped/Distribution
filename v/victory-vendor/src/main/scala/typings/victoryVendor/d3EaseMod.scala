...
object d3EaseMod {
  ...
  @JSImport("victory-vendor/d3-ease", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeBack")
  @js.native
  val easeBack: BackEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeBackIn")
  @js.native
  val easeBackIn: BackEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeBackInOut")
  @js.native
  val easeBackInOut: BackEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeBackOut")
  @js.native
  ...
  @JSImport("victory-vendor/d3-ease", "easeElastic")
  @js.native
  val easeElastic: ElasticEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeElasticIn")
  @js.native
  val easeElasticIn: ElasticEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeElasticInOut")
  @js.native
  val easeElasticInOut: ElasticEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easeElasticOut")
  @js.native
  ...
  @JSImport("victory-vendor/d3-ease", "easePoly")
  @js.native
  val easePoly: PolynomialEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easePolyIn")
  @js.native
  val easePolyIn: PolynomialEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easePolyInOut")
  @js.native
  val easePolyInOut: PolynomialEasingFactory = js.native
  
  @JSImport("victory-vendor/d3-ease", "easePolyOut")
  @js.native
