...
trait Options extends js.Object {
  ...
  var onCancel: js.UndefOr[(js.Function2[/* event */ Event, /* element */ Element, Unit]) | `false`] = js.undefined
  ...
  var onDone: js.UndefOr[(js.Function1[/* element */ Element, Unit]) | `false`] = js.undefined
  // A callback function that should be called when scrolling has started. Receives the target element as a
  // parameter. Default: noop
  var onStart: js.UndefOr[(js.Function1[/* element */ Element, Unit]) | `false`] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    onCancel: (js.Function2[/* event */ Event, /* element */ Element, Unit]) | `false` = null,
    onDone: (js.Function1[/* element */ Element, Unit]) | `false` = null,
    onStart: (js.Function1[/* element */ Element, Unit]) | `false` = null,
