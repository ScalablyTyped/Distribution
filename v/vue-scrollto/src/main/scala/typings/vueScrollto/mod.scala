...
object mod {
  ...
  object default {
    ...
    inline def bind_=(x: js.UndefOr[DirectiveFunction]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("bind")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.componentUpdated")
    @js.native
    def componentUpdated: js.UndefOr[DirectiveFunction] = js.native
    inline def componentUpdated_=(x: js.UndefOr[DirectiveFunction]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("componentUpdated")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.inserted")
    @js.native
    def inserted: js.UndefOr[DirectiveFunction] = js.native
    inline def inserted_=(x: js.UndefOr[DirectiveFunction]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("inserted")(x.asInstanceOf[js.Any])
    ...
    inline def install(Vue: VueConstructor[Vue], options: ScrollOptions): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("install")(Vue.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    inline def install_=(x: PluginFunction[ScrollOptions]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("install")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.scrollTo")
    @js.native
    def scrollTo: ScrollToFunction = js.native
    inline def scrollTo(element: ElementDescriptor): js.Function0[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("scrollTo")(element.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Unit]]
    inline def scrollTo(element: ElementDescriptor, duration: Double): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("scrollTo")(element.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def scrollTo(element: ElementDescriptor, duration: Double, options: ScrollOptions): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("scrollTo")(element.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def scrollTo(element: ElementDescriptor, options: ScrollOptions): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("scrollTo")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def scrollTo(options: ScrollOptions): js.Function0[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("scrollTo")(options.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Unit]]
    inline def scrollTo_=(x: ScrollToFunction): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("scrollTo")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.setDefaults")
    @js.native
    def setDefaults: ScrollToFunction = js.native
    inline def setDefaults(element: ElementDescriptor): js.Function0[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaults")(element.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Unit]]
    inline def setDefaults(element: ElementDescriptor, duration: Double): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setDefaults")(element.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def setDefaults(element: ElementDescriptor, duration: Double, options: ScrollOptions): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setDefaults")(element.asInstanceOf[js.Any], duration.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def setDefaults(element: ElementDescriptor, options: ScrollOptions): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("setDefaults")(element.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
    inline def setDefaults(options: ScrollOptions): js.Function0[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaults")(options.asInstanceOf[js.Any]).asInstanceOf[js.Function0[Unit]]
    inline def setDefaults_=(x: ScrollToFunction): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("setDefaults")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.unbind")
    @js.native
    def unbind: js.UndefOr[DirectiveFunction] = js.native
    inline def unbind_=(x: js.UndefOr[DirectiveFunction]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("unbind")(x.asInstanceOf[js.Any])
    
    @JSImport("vue-scrollto", "default.update")
    @js.native
    def update: js.UndefOr[DirectiveFunction] = js.native
    inline def update_=(x: js.UndefOr[DirectiveFunction]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("update")(x.asInstanceOf[js.Any])
  }
  ...
  object ScrollOptions {
    ...
    extension [Self <: ScrollOptions](x: Self) {
      ...
      inline def setOnCancel(value: (js.Function2[/* event */ Event, /* element */ Element, js.Any]) | `false`): Self = StObject.set(x, "onCancel", value.asInstanceOf[js.Any])
      
      inline def setOnCancelFunction2(value: (/* event */ Event, /* element */ Element) => js.Any): Self = StObject.set(x, "onCancel", js.Any.fromFunction2(value))
      
      inline def setOnCancelUndefined: Self = StObject.set(x, "onCancel", js.undefined)
      
      inline def setOnDone(value: (js.Function1[/* element */ Element, js.Any]) | `false`): Self = StObject.set(x, "onDone", value.asInstanceOf[js.Any])
      
      inline def setOnDoneFunction1(value: /* element */ Element => js.Any): Self = StObject.set(x, "onDone", js.Any.fromFunction1(value))
      
      inline def setOnDoneUndefined: Self = StObject.set(x, "onDone", js.undefined)
      
      inline def setOnStart(value: (js.Function1[/* element */ Element, js.Any]) | `false`): Self = StObject.set(x, "onStart", value.asInstanceOf[js.Any])
      
      inline def setOnStartFunction1(value: /* element */ Element => js.Any): Self = StObject.set(x, "onStart", js.Any.fromFunction1(value))
  ...
  object vueTypesVueAugmentingMod {
    ...
    object Vue {
      ...
      inline def apply($scrollTo: ScrollToFunction): typings.vueScrollto.mod.vueTypesVueAugmentingMod.Vue = {
      ...
      extension [Self <: typings.vueScrollto.mod.vueTypesVueAugmentingMod.Vue](x: Self) {
