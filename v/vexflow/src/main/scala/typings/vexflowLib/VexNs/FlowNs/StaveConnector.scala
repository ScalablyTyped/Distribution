...
class StaveConnector protected () extends js.Object {
  ...
  def setFont(font: vexflowLib.Anon_WeightFamilySize): scala.Unit = js.native
  def setText(text: java.lang.String): StaveConnector = js.native
  def setText(text: java.lang.String, text_options: vexflowLib.Anon_Shifty): StaveConnector = js.native
