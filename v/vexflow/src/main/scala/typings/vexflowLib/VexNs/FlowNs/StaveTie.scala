...
class StaveTie protected () extends js.Object {
  ...
  def renderTie(params: vexflowLib.Anon_DirectionFirstxpx): scala.Unit = js.native
  def setContext(context: vexflowLib.VexNs.IRenderContext): StaveTie = js.native
  def setFont(font: vexflowLib.Anon_FamilySize): StaveTie = js.native
  def setNotes(notes: vexflowLib.Anon_FirstindicesFirstnoteLastindices): StaveTie = js.native
}
