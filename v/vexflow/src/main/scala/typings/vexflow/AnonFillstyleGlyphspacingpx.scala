...
trait AnonFillstyleGlyphspacingpx extends js.Object {
...
object AnonFillstyleGlyphspacingpx {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonFillstyleGlyphspacingpx]
  }
}
