...
@scala.inline
def Contains(a: js.Array[js.Any], obj: js.Any): scala.Boolean = (typings.vexflow.global.Vex.^.asInstanceOf[js.Dynamic].applyDynamic("Contains")(a.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[scala.Boolean]
...
@scala.inline
def L(block: java.lang.String, args: js.Array[js.Any]): scala.Unit = (typings.vexflow.global.Vex.^.asInstanceOf[js.Dynamic].applyDynamic("L")(block.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
...
@scala.inline
def SortAndUnique[T /* <: js.Array[js.Any] */](arr: T, cmp: js.Function, eq: js.Function): T = (typings.vexflow.global.Vex.^.asInstanceOf[js.Dynamic].applyDynamic("SortAndUnique")(arr.asInstanceOf[js.Any], cmp.asInstanceOf[js.Any], eq.asInstanceOf[js.Any])).asInstanceOf[T]
