...
trait AnonDotsDurationPositions extends js.Object {
...
object AnonDotsDurationPositions {
  @scala.inline
  def apply(
    duration: String,
    ...
    __obj.asInstanceOf[AnonDotsDurationPositions]
  }
}
