...
object StaveNote extends js.Object {
  ...
  def format(notes: js.Array[typings.vexflow.Vex.Flow.StaveNote], state: AnonLeftshift): Boolean = js.native
  def formatByY(notes: js.Array[typings.vexflow.Vex.Flow.StaveNote], state: AnonLeftshift): Unit = js.native
