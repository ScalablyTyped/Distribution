...
object Font {
  ...
  @scala.inline
  def ascender_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ascender")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.boundingBox")
  @js.native
  def boundingBox: XMax_ = js.native
  @scala.inline
  def boundingBox_=(x: XMax_): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("boundingBox")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.cssFontStyle")
  @js.native
  def cssFontStyle: String = js.native
  @scala.inline
  def cssFontStyle_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cssFontStyle")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.cssFontWeight")
  @js.native
  def cssFontWeight: String = js.native
  @scala.inline
  def cssFontWeight_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("cssFontWeight")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.descender")
  @js.native
  def descender: Double = js.native
  @scala.inline
  def descender_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("descender")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.familyName")
  @js.native
  def familyName: String = js.native
  @scala.inline
  def familyName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("familyName")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.glyphs")
  @js.native
  def glyphs: js.Array[Ha] = js.native
  @scala.inline
  def glyphs_=(x: js.Array[Ha]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("glyphs")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def originalFontInformation_=(x: Copyright): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("original_font_information")(x.asInstanceOf[js.Any])
  ...
  @scala.inline
  def underlinePosition_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("underlinePosition")(x.asInstanceOf[js.Any])
  
  @JSImport("vexflow", "Flow.Font.underlineThickness")
  @js.native
  def underlineThickness: Double = js.native
  @scala.inline
  def underlineThickness_=(x: Double): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("underlineThickness")(x.asInstanceOf[js.Any])
}
