...
trait AnonCodeGracenotewidth extends js.Object {
  var code: String
...
object AnonCodeGracenotewidth {
  @scala.inline
  def apply(code: String, gracenote_width: Double, shift_down: Double, shift_right: Double, width: Double): AnonCodeGracenotewidth = {
    ...
    __obj.asInstanceOf[AnonCodeGracenotewidth]
  }
}
