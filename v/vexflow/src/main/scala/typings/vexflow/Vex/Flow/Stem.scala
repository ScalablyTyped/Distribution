...
object Stem {
  ...
  extension [Self <: Stem](x: Self) {
    ...
    inline def setGetExtents(value: () => BaseY): Self = StObject.set(x, "getExtents", js.Any.fromFunction0(value))
    ...
    inline def setSetDirection(value: Double => Unit): Self = StObject.set(x, "setDirection", js.Any.fromFunction1(value))
    
    inline def setSetExtension(value: Double => Unit): Self = StObject.set(x, "setExtension", js.Any.fromFunction1(value))
    ...
    inline def setSetStyle(value: FillStyle_ => Unit): Self = StObject.set(x, "setStyle", js.Any.fromFunction1(value))
    
    inline def setSetYBounds(value: (Double, Double) => Unit): Self = StObject.set(x, "setYBounds", js.Any.fromFunction2(value))
  }
}
