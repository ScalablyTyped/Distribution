...
trait AnonFirstindicesFirstnoteLastindices extends js.Object {
...
object AnonFirstindicesFirstnoteLastindices {
  @scala.inline
  def apply(
    ...
    last_note: Note = null
  ): AnonFirstindicesFirstnoteLastindices = {
    ...
    __obj.asInstanceOf[AnonFirstindicesFirstnoteLastindices]
  }
}
