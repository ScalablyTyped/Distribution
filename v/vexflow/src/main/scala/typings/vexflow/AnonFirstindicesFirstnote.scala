...
trait AnonFirstindicesFirstnote extends js.Object {
...
object AnonFirstindicesFirstnote {
  @scala.inline
  def apply(
    first_note: Note,
    last_note: Note,
    ...
    __obj.asInstanceOf[AnonFirstindicesFirstnote]
  }
}
