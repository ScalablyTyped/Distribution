...
object Glyphspacingpx {
  ...
  inline def apply(): Glyphspacingpx = {
  ...
  implicit open class MutableBuilder[Self <: Glyphspacingpx] (val x: Self) extends AnyVal {
    ...
    inline def setRight_bar(value: Boolean): Self = StObject.set(x, "right_bar", value.asInstanceOf[js.Any])
    
    inline def setRight_barUndefined: Self = StObject.set(x, "right_bar", js.undefined)
