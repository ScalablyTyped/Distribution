...
@js.native
trait Glyphspacingpx extends StObject {
...
object Glyphspacingpx {
  ...
  @scala.inline
  implicit class GlyphspacingpxMutableBuilder[Self <: Glyphspacingpx] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setLeft_bar(value: Boolean): Self = StObject.set(x, "left_bar", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setLeft_barUndefined: Self = StObject.set(x, "left_bar", js.undefined)
    ...
    @scala.inline
    def setRight_bar(value: Boolean): Self = StObject.set(x, "right_bar", value.asInstanceOf[js.Any])
    
    @scala.inline
    def setRight_barUndefined: Self = StObject.set(x, "right_bar", js.undefined)
