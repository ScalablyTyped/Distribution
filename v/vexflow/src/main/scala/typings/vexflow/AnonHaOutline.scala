...
trait AnonHaOutline extends js.Object {
  var ha: Double
...
object AnonHaOutline {
  @scala.inline
  def apply(ha: Double, outline: js.Array[Double], x_max: Double, x_min: Double): AnonHaOutline = {
    ...
    __obj.asInstanceOf[AnonHaOutline]
  }
}
