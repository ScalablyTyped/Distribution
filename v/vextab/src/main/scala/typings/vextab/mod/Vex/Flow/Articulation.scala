...
@JSImport("vextab", "Vex.Flow.Articulation")
@js.native
open class Articulation protected ()
  extends typings.vexflow.mod.Flow.Articulation {
...
object Articulation {
  ...
  @JSImport("vextab", "Vex.Flow.Articulation.CATEGORY")
  @js.native
  val CATEGORY: String = js.native
  
  /* static member */
  @JSImport("vextab", "Vex.Flow.Articulation.DEBUG")
  @js.native
