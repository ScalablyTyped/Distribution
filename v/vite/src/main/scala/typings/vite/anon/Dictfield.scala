...
object Dictfield {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(browser = browser.asInstanceOf[js.Any], dependencies = dependencies.asInstanceOf[js.Any], exports = exports.asInstanceOf[js.Any], main = main.asInstanceOf[js.Any], module = module.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
