...
trait ComponentDidCatch extends StObject {
  ...
  def getChildren(props: Any): js.Array[String | Double | ReactElement | ReactFragment | Null] = js.native
  
  def getCursorPointers(props: Any): XProps = js.native
  
  def getHandles(props: Any, domain: Any): js.Array[ReactElement] | Null = js.native
  
  def getRect(props: Any): js.Array[js.Array[ReactElement] | (DetailedReactHTMLElement[Cursor, HTMLElement]) | Null] = js.native
  
  def getSelectBox(props: Any, coordinates: Any): (DetailedReactHTMLElement[Cursor, HTMLElement]) | Null = js.native
