...
trait ConstructorOptionscontentDictcustomOption
  ...
  /**
    ...
    * Default: null
    */
  var contents: js.UndefOr[(Buffer | ReadableStream | Null) with Buffer] = js.undefined
  /**
...
object ConstructorOptionscontentDictcustomOption {
  ...
  def apply(
    ...
    base: String = null,
    contents: (Buffer | ReadableStream | Null) with Buffer = null,
    cwd: String = null,
    history: js.Array[String] = null,
    path: String = null,
    stat: Stats = null
  ): ConstructorOptionscontentDictcustomOption = {
