...
trait File
  ...
  /**
       ...
       */
  def isBuffer(): /* is BufferFile */scala.Boolean = js.native
  /**
       ...
       */
  def isDirectory(): /* is DirectoryFile */scala.Boolean = js.native
  /**
       * Returns `true` if the file contents are `null`, otherwise `false`.
       */
  def isNull(): /* is NullFile */scala.Boolean = js.native
  /**
       * Returns `true` if the file contents are a `Stream`, otherwise `false`.
       */
  def isStream(): /* is StreamFile */scala.Boolean = js.native
  /**
       ...
       */
  def isSymbolic(): /* is SymbolicFile */scala.Boolean = js.native
  /**
