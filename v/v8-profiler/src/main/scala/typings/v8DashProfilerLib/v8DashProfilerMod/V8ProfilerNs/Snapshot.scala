...
trait Snapshot extends js.Object {
  ...
  /**
    ...
    */
  def compare(
    snapshot: /* import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt $anonfun#applyOrElse Simplified recursive type alias v8-profiler.v8-profiler.V8Profiler.Snapshot */ js.Object
