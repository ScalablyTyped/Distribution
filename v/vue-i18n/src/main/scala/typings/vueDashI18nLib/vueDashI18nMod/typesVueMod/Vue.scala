...
trait Vue extends js.Object {
  @JSName("$d")
  var $d_Original: vueDashI18nLib.Fn_Args = js.native
  @JSName("$i18n")
  val $i18n: vueDashI18nLib.vueDashI18nMod.VueI18n with vueDashI18nLib.vueDashI18nMod.IVueI18n = js.native
  @JSName("$n")
  var $n_Original: vueDashI18nLib.Fn_ArgsKey = js.native
  @JSName("$t")
  var $t_Original: vueDashI18nLib.Fn_Key = js.native
  @JSName("$tc")
  var $tc_Original: vueDashI18nLib.Fn_Choice = js.native
  @JSName("$te")
