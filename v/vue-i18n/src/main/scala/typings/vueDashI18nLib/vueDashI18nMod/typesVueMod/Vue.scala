...
trait Vue extends js.Object {
  @JSName("$d")
  var $d_Original: js.Function3[
    /* value */ scala.Double | stdLib.Date, 
    /* key */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Path], 
    /* locale */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Locale], 
    vueDashI18nLib.vueDashI18nMod.VueI18nNs.DateTimeFormatResult
  ] = js.native
  @JSName("$i18n")
  val $i18n: vueDashI18nLib.vueDashI18nMod.VueI18n with vueDashI18nLib.vueDashI18nMod.IVueI18n = js.native
  @JSName("$n")
  var $n_Original: js.Function3[
    /* value */ scala.Double, 
    /* key */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Path], 
    /* locale */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Locale], 
    vueDashI18nLib.vueDashI18nMod.VueI18nNs.NumberFormatResult
  ] = js.native
  @JSName("$t")
  var $t_Original: js.Function2[
    /* key */ vueDashI18nLib.vueDashI18nMod.VueI18nNs.Path, 
    /* values */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Values], 
    vueDashI18nLib.vueDashI18nMod.VueI18nNs.TranslateResult
  ] = js.native
  @JSName("$tc")
  var $tc_Original: js.Function3[
    /* key */ vueDashI18nLib.vueDashI18nMod.VueI18nNs.Path, 
    /* choice */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Choice], 
    /* values */ js.UndefOr[vueDashI18nLib.vueDashI18nMod.VueI18nNs.Values], 
    java.lang.String
  ] = js.native
  @JSName("$te")
