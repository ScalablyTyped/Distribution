...
object anon {
  ...
  trait Animate extends StObject {
    ...
    var interpolation: Requireable[String | (js.Function1[/* repeated */ Any, Any])]
    
    var label: typings.propTypes.mod.Validator[js.UndefOr[String | Null]]
  ...
  object Animate {
    ...
    inline def apply(
      interpolation: Requireable[String | (js.Function1[/* repeated */ Any, Any])],
      label: typings.propTypes.mod.Validator[js.UndefOr[String | Null]]
    ): Animate = {
      val __obj = js.Dynamic.literal(interpolation = interpolation.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
    ...
    implicit open class MutableBuilder[Self <: Animate] (val x: Self) extends AnyVal {
      ...
      inline def setInterpolation(value: Requireable[String | (js.Function1[/* repeated */ Any, Any])]): Self = StObject.set(x, "interpolation", value.asInstanceOf[js.Any])
      
      inline def setLabel(value: typings.propTypes.mod.Validator[js.UndefOr[String | Null]]): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
  ...
  object ContainerComponent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(containerComponent = containerComponent.asInstanceOf[js.Any], dataComponent = dataComponent.asInstanceOf[js.Any], groupComponent = groupComponent.asInstanceOf[js.Any], labelComponent = labelComponent.asInstanceOf[js.Any], samples = samples.asInstanceOf[js.Any], sortKey = sortKey.asInstanceOf[js.Any], sortOrder = sortOrder.asInstanceOf[js.Any], standalone = standalone.asInstanceOf[js.Any], theme = theme.asInstanceOf[js.Any])
  ...
  trait TypeofVictoryLineBase extends StObject {
    ...
    /* static member */
    var defaultPolarTransitions: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_victory-core.AnimatePropTypeInterface */ Any
  ...
  object TypeofVictoryLineBase {
    
    inline def apply(
      animationWhitelist: js.Array[String],
      continuous: Boolean,
      defaultPolarTransitions: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify imported_victory-core.AnimatePropTypeInterface */ Any,
      ...
      propTypes: Animate,
      role: String
    ): TypeofVictoryLineBase = {
      val __obj = js.Dynamic.literal(animationWhitelist = animationWhitelist.asInstanceOf[js.Any], continuous = continuous.asInstanceOf[js.Any], defaultPolarTransitions = defaultPolarTransitions.asInstanceOf[js.Any], defaultProps = defaultProps.asInstanceOf[js.Any], defaultTransitions = defaultTransitions.asInstanceOf[js.Any], displayName = displayName.asInstanceOf[js.Any], expectedComponents = expectedComponents.asInstanceOf[js.Any], getBaseProps = js.Any.fromFunction1(getBaseProps), propTypes = propTypes.asInstanceOf[js.Any], role = role.asInstanceOf[js.Any])
      __obj.asInstanceOf[TypeofVictoryLineBase]
    }
    
    @scala.inline
    implicit open class MutableBuilder[Self <: TypeofVictoryLineBase] (val x: Self) extends AnyVal {
      ...
      inline def setDefaultPolarTransitions(
      ...
      ): Self = StObject.set(x, "defaultPolarTransitions", value.asInstanceOf[js.Any])
