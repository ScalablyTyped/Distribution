...
import typings.vueDevtoolsApi.libEsmApiApiMod.InspectorNodeTag
...
object libEsmApiComponentMod {
  ...
  */
  ...
  - typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentState because Already inherited */ trait ComponentCustomState
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentState because Already inherited */ trait ComponentPropState
    extends StObject
       with ComponentStateBase {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentStateBase
    - typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentPropState
    - typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentCustomState
  */
  trait ComponentState extends StObject
  object ComponentState {
    
    inline def ComponentCustomState(key: String, `type`: String, value: CustomState): typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentCustomState = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentCustomState]
    }
    
    inline def ComponentPropState(key: String, `type`: String, value: Any): typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentPropState = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentPropState]
    }
    
    inline def ComponentStateBase(key: String, `type`: String, value: Any): typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentStateBase = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vueDevtoolsApi.libEsmApiComponentMod.ComponentStateBase]
    }
  }
