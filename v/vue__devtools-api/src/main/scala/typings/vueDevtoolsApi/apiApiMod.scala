...
import typings.vueDevtoolsApi.componentMod.ComponentInstance
import typings.vueDevtoolsApi.componentMod.ComponentState
import typings.vueDevtoolsApi.componentMod.StateBase
import typings.vueDevtoolsApi.contextMod.Context
import typings.vueDevtoolsApi.hooksMod.ComponentBounds
import typings.vueDevtoolsApi.hooksMod.Hookable
