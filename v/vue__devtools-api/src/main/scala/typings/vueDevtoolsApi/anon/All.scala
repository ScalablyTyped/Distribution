...
import typings.vueDevtoolsApi.apiApiMod.TimelineEvent
...
object All {
  ...
  inline def apply(app: typings.vueDevtoolsApi.appMod.App, data: Any, event: TimelineEvent[Any, Any], layerId: String): All = {
