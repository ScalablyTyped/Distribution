...
import typings.vscode.Anon_AutoClosingPairs
import typings.vscode.Anon_Brackets
...
trait LanguageConfiguration extends js.Object {
  /**
  		 ...
  		 */
  var __characterPairSupport: js.UndefOr[Anon_AutoClosingPairs] = js.undefined
  /**
  		 * **Deprecated** Do not use.
  		 *
  		 * @deprecated Will be replaced by a better API soon.
  		 */
  var __electricCharacterSupport: js.UndefOr[Anon_Brackets] = js.undefined
  /**
...
object LanguageConfiguration {
  @scala.inline
  def apply(
    __characterPairSupport: Anon_AutoClosingPairs = null,
    __electricCharacterSupport: Anon_Brackets = null,
