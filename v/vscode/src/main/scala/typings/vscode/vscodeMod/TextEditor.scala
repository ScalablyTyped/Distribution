...
import typings.vscode.Anon_UndoStopAfter
...
trait TextEditor extends js.Object {
  ...
  def edit(callback: js.Function1[/* editBuilder */ TextEditorEdit, Unit], options: Anon_UndoStopAfter): Thenable[Boolean] = js.native
  /**
  ...
  def insertSnippet(snippet: SnippetString, location: js.Array[Position | Range], options: Anon_UndoStopAfter): Thenable[Boolean] = js.native
  def insertSnippet(snippet: SnippetString, location: Position): Thenable[Boolean] = js.native
  def insertSnippet(snippet: SnippetString, location: Position, options: Anon_UndoStopAfter): Thenable[Boolean] = js.native
  def insertSnippet(snippet: SnippetString, location: Range): Thenable[Boolean] = js.native
  def insertSnippet(snippet: SnippetString, location: Range, options: Anon_UndoStopAfter): Thenable[Boolean] = js.native
  /**
