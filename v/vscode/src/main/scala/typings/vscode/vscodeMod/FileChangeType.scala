...
import typings.vscode.vscodeMod.FileChangeType.Changed
import typings.vscode.vscodeMod.FileChangeType.Created
import typings.vscode.vscodeMod.FileChangeType.Deleted
