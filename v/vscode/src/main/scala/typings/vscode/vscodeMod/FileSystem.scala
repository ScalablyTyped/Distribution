...
import typings.vscode.Anon_OverwriteBoolean
import typings.vscode.Anon_RecursiveUseTrash
...
trait FileSystem extends js.Object {
  ...
  def copy(source: Uri, target: Uri, options: Anon_OverwriteBoolean): Thenable[Unit] = js.native
  /**
  ...
  def delete(uri: Uri, options: Anon_RecursiveUseTrash): Thenable[Unit] = js.native
  /**
  ...
  def rename(source: Uri, target: Uri, options: Anon_OverwriteBoolean): Thenable[Unit] = js.native
  /**
