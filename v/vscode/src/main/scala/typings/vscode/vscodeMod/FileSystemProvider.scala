...
import typings.vscode.Anon_Create
import typings.vscode.Anon_Excludes
import typings.vscode.Anon_Overwrite
import typings.vscode.Anon_Recursive
...
trait FileSystemProvider extends js.Object {
  ...
  /**
  		 ...
  		 * @throws [`NoPermissions`](#FileSystemError.NoPermissions) when permissions aren't sufficient.
  		 */
  def delete(uri: Uri, options: Anon_Recursive): Unit | Thenable[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 * @throws [`NoPermissions`](#FileSystemError.NoPermissions) when permissions aren't sufficient.
  		 */
  def rename(oldUri: Uri, newUri: Uri, options: Anon_Overwrite): Unit | Thenable[Unit] = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def watch(uri: Uri, options: Anon_Excludes): Disposable = js.native
  /**
  		 ...
  		 * @throws [`NoPermissions`](#FileSystemError.NoPermissions) when permissions aren't sufficient.
  		 */
  def writeFile(uri: Uri, content: Uint8Array, options: Anon_Create): Unit | Thenable[Unit] = js.native
}
