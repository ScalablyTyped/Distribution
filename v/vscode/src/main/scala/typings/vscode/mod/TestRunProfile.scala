...
object TestRunProfile {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(dispose = js.Any.fromFunction0(dispose), isDefault = isDefault.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], runHandler = js.Any.fromFunction2(runHandler), supportsContinuousRun = supportsContinuousRun.asInstanceOf[js.Any])
  ...
  implicit open class MutableBuilder[Self <: TestRunProfile] (val x: Self) extends AnyVal {
    ...
    inline def setSupportsContinuousRun(value: Boolean): Self = StObject.set(x, "supportsContinuousRun", value.asInstanceOf[js.Any])
