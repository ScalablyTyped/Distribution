...
trait Webview extends StObject {
  ...
  /**
    ...
    */
  def onDidReceiveMessage(listener: js.Function1[/* e */ Any, Any]): Disposable = js.native
  def onDidReceiveMessage(listener: js.Function1[/* e */ Any, Any], thisArgs: Any): Disposable = js.native
  def onDidReceiveMessage(listener: js.Function1[/* e */ Any, Any], thisArgs: Any, disposables: js.Array[Disposable]): Disposable = js.native
  def onDidReceiveMessage(listener: js.Function1[/* e */ Any, Any], thisArgs: Unit, disposables: js.Array[Disposable]): Disposable = js.native
