...
object WebviewOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(enableCommandUris)) __obj.updateDynamic("enableCommandUris")(enableCommandUris.get.asInstanceOf[js.Any])
    if (!js.isUndefined(enableScripts)) __obj.updateDynamic("enableScripts")(enableScripts.get.asInstanceOf[js.Any])
