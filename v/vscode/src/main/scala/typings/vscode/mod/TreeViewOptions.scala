...
object TreeViewOptions {
  ...
  def apply[T](
    ...
    if (!js.isUndefined(canSelectMany)) __obj.updateDynamic("canSelectMany")(canSelectMany.get.asInstanceOf[js.Any])
    if (!js.isUndefined(showCollapseAll)) __obj.updateDynamic("showCollapseAll")(showCollapseAll.get.asInstanceOf[js.Any])
