...
object window {
  ...
  inline def registerWebviewPanelSerializer(viewType: String, serializer: WebviewPanelSerializer[js.Any]): Disposable = (^.asInstanceOf[js.Dynamic].applyDynamic("registerWebviewPanelSerializer")(viewType.asInstanceOf[js.Any], serializer.asInstanceOf[js.Any])).asInstanceOf[Disposable]
  ...
  inline def setStatusBarMessage(text: String, hideWhenDone: Thenable[js.Any]): Disposable = (^.asInstanceOf[js.Dynamic].applyDynamic("setStatusBarMessage")(text.asInstanceOf[js.Any], hideWhenDone.asInstanceOf[js.Any])).asInstanceOf[Disposable]
  
  inline def showErrorMessage(message: String, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  inline def showErrorMessage(message: String, options: MessageOptions, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  
  inline def showErrorMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showErrorMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showErrorMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  
  inline def showInformationMessage(message: String, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  inline def showInformationMessage(message: String, options: MessageOptions, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  
  inline def showInformationMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showInformationMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showInformationMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  ...
  inline def showWarningMessage(message: String, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  inline def showWarningMessage(message: String, options: MessageOptions, items: String*): Thenable[js.UndefOr[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[String]]]
  
  inline def showWarningMessage_T_MessageItem[T /* <: MessageItem */](message: String, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(message.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  inline def showWarningMessage_T_MessageItem[T /* <: MessageItem */](message: String, options: MessageOptions, items: T*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("showWarningMessage")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any], items.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
