...
object commands {
  ...
  inline def executeCommand[T](command: String, rest: js.Any*): Thenable[js.UndefOr[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("executeCommand")(command.asInstanceOf[js.Any], rest.asInstanceOf[js.Any])).asInstanceOf[Thenable[js.UndefOr[T]]]
  ...
  inline def registerCommand(command: String, callback: js.Function1[/* repeated */ js.Any, js.Any]): Disposable = (^.asInstanceOf[js.Dynamic].applyDynamic("registerCommand")(command.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Disposable]
  inline def registerCommand(command: String, callback: js.Function1[/* repeated */ js.Any, js.Any], thisArg: js.Any): Disposable = (^.asInstanceOf[js.Dynamic].applyDynamic("registerCommand")(command.asInstanceOf[js.Any], callback.asInstanceOf[js.Any], thisArg.asInstanceOf[js.Any])).asInstanceOf[Disposable]
