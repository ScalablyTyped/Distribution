...
import typings.vscode.AnonCreate
import typings.vscode.AnonExcludes
import typings.vscode.AnonOverwrite
import typings.vscode.AnonRecursive
...
trait FileSystemProvider extends js.Object {
  ...
  /**
  		 ...
  		 * @throws [`NoPermissions`](#FileSystemError.NoPermissions) when permissions aren't sufficient.
  		 */
  def writeFile(uri: Uri, content: Uint8Array, options: AnonCreate): Unit | Thenable[Unit] = js.native
}
