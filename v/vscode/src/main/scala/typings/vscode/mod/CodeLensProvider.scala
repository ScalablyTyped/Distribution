...
trait CodeLensProvider[T] extends js.Object {
  /**
...
object CodeLensProvider {
  @scala.inline
  def apply[T](
    provideCodeLenses: (TextDocument, CancellationToken) => ProviderResult[js.Array[T]],
    ...
    resolveCodeLens: (/* codeLens */ T, /* token */ CancellationToken) => ProviderResult[T] = null
  ): CodeLensProvider[T] = {
