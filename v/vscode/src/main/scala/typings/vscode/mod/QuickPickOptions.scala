...
object QuickPickOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(canPickMany)) __obj.updateDynamic("canPickMany")(canPickMany.get.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreFocusOut)) __obj.updateDynamic("ignoreFocusOut")(ignoreFocusOut.get.asInstanceOf[js.Any])
    if (!js.isUndefined(matchOnDescription)) __obj.updateDynamic("matchOnDescription")(matchOnDescription.get.asInstanceOf[js.Any])
    if (!js.isUndefined(matchOnDetail)) __obj.updateDynamic("matchOnDetail")(matchOnDetail.get.asInstanceOf[js.Any])
