...
trait TreeViewOptions[T] extends js.Object {
  /**
  		 ...
  		 */
  var showCollapseAll: js.UndefOr[scala.Boolean] = js.undefined
  /**
...
object TreeViewOptions {
  @scala.inline
  def apply[T](treeDataProvider: TreeDataProvider[T], showCollapseAll: js.UndefOr[scala.Boolean] = js.undefined): TreeViewOptions[T] = {
