...
class Range protected () extends js.Object {
  ...
  /**
  		 ...
  		 */
  def this(startLine: scala.Double, startCharacter: scala.Double, endLine: scala.Double, endCharacter: scala.Double) = this()
  /**
  ...
  /**
  		 ...
  		 */
  var isSingleLine: scala.Boolean = js.native
  /**
  ...
  /**
  		 ...
  		 * to this range.
  		 */
  def contains(positionOrRange: Position): scala.Boolean = js.native
  def contains(positionOrRange: Range): scala.Boolean = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def isEqual(other: Range): scala.Boolean = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def `with`(change: vscodeLib.Anon_End): Range = js.native
