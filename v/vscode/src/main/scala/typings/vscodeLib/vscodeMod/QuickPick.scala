...
trait QuickPick[T /* <: QuickPickItem */] extends QuickInput {
  ...
  /**
  		 ...
  		 */
  var canSelectMany: scala.Boolean = js.native
  /**
  		 * Items to pick from.
  		 */
  ...
  /**
  		 ...
  		 */
  var matchOnDescription: scala.Boolean = js.native
  /**
  		 * If the filter text should also be matched against the detail of the items. Defaults to false.
  		 */
  var matchOnDetail: scala.Boolean = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def onDidAccept(listener: js.Function1[/* e */ scala.Unit, _]): Disposable = js.native
  def onDidAccept(listener: js.Function1[/* e */ scala.Unit, _], thisArgs: js.Any): Disposable = js.native
  def onDidAccept(listener: js.Function1[/* e */ scala.Unit, _], thisArgs: js.Any, disposables: js.Array[Disposable]): Disposable = js.native
  /**
  ...
  /**
  		 ...
  		 */
  def onDidChangeValue(listener: js.Function1[/* e */ java.lang.String, _]): Disposable = js.native
  def onDidChangeValue(listener: js.Function1[/* e */ java.lang.String, _], thisArgs: js.Any): Disposable = js.native
  def onDidChangeValue(
    listener: js.Function1[/* e */ java.lang.String, _],
    thisArgs: js.Any,
    disposables: js.Array[Disposable]
  ): Disposable = js.native
  /**
