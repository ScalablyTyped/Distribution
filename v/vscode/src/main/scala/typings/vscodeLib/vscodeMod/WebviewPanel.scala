...
trait WebviewPanel extends js.Object {
  ...
  /**
  		 ...
  		 */
  def onDidDispose(listener: js.Function1[/* e */ scala.Unit, _]): Disposable = js.native
  def onDidDispose(listener: js.Function1[/* e */ scala.Unit, _], thisArgs: js.Any): Disposable = js.native
  def onDidDispose(listener: js.Function1[/* e */ scala.Unit, _], thisArgs: js.Any, disposables: js.Array[Disposable]): Disposable = js.native
  /**
  		 ...
  		 */
  def reveal(): scala.Unit = js.native
  def reveal(viewColumn: ViewColumn): scala.Unit = js.native
  def reveal(viewColumn: ViewColumn, preserveFocus: scala.Boolean): scala.Unit = js.native
}
