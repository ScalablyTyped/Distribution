...
trait WebviewPanelOptions extends js.Object {
  /**
  		 ...
  		 * Defaults to false.
  		 */
  val enableFindWidget: js.UndefOr[scala.Boolean] = js.undefined
  /**
  		 ...
  		 */
  val retainContextWhenHidden: js.UndefOr[scala.Boolean] = js.undefined
}

object WebviewPanelOptions {
  @scala.inline
  def apply(
    enableFindWidget: js.UndefOr[scala.Boolean] = js.undefined,
    retainContextWhenHidden: js.UndefOr[scala.Boolean] = js.undefined
  ): WebviewPanelOptions = {
