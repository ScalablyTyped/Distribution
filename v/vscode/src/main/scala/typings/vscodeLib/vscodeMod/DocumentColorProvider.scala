...
trait DocumentColorProvider extends js.Object {
  /**
  		 ...
  		 */
  def provideColorPresentations(color: Color, context: vscodeLib.Anon_Document, token: CancellationToken): ProviderResult[js.Array[ColorPresentation]]
  /**
...
object DocumentColorProvider {
  @scala.inline
  def apply(
    provideColorPresentations: (Color, vscodeLib.Anon_Document, CancellationToken) => ProviderResult[js.Array[ColorPresentation]],
