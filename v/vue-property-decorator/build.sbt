...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped" %%% "vue" % "3.2.41-6fc644",
  "org.scalablytyped" %%% "vue-class-component" % "7.2.6-480504",
  "org.scalablytyped" %%% "vue__compiler-core" % "3.2.41-69d5c2",
