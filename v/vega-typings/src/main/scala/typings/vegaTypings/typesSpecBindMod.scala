...
object typesSpecBindMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typings.vegaTypings.typesSpecBindMod.BindCheckbox
    - typings.vegaTypings.typesSpecBindMod.BindRadioSelect
    - typings.vegaTypings.typesSpecBindMod.BindRange
    - typings.vegaTypings.typesSpecBindMod.BindInput
    - typings.vegaTypings.typesSpecBindMod.BindDirect
  */
  trait Binding extends StObject
  object Binding {
    
    inline def BindCheckbox(): typings.vegaTypings.typesSpecBindMod.BindCheckbox = {
      val __obj = js.Dynamic.literal(input = "checkbox")
      __obj.asInstanceOf[typings.vegaTypings.typesSpecBindMod.BindCheckbox]
    }
    
    inline def BindDirect(element: Element | EventTarget): typings.vegaTypings.typesSpecBindMod.BindDirect = {
      val __obj = js.Dynamic.literal(element = element.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaTypings.typesSpecBindMod.BindDirect]
    }
    
    inline def BindInput(): typings.vegaTypings.typesSpecBindMod.BindInput = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.vegaTypings.typesSpecBindMod.BindInput]
    }
    
    inline def BindRadioSelect(input: radio | select, options: js.Array[Any]): typings.vegaTypings.typesSpecBindMod.BindRadioSelect = {
      val __obj = js.Dynamic.literal(input = input.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaTypings.typesSpecBindMod.BindRadioSelect]
    }
    
    inline def BindRange(): typings.vegaTypings.typesSpecBindMod.BindRange = {
      val __obj = js.Dynamic.literal(input = "range")
      __obj.asInstanceOf[typings.vegaTypings.typesSpecBindMod.BindRange]
    }
  }
