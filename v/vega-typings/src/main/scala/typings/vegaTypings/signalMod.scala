...
object signalMod {
  ...
  */
  ...
  object Signal {
    ...
    inline def InitSignal(init: Expr, name: String): typings.vegaTypings.signalMod.InitSignal = {
      val __obj = js.Dynamic.literal(init = init.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaTypings.signalMod.InitSignal]
    }
    
    inline def NewSignal(name: String): typings.vegaTypings.signalMod.NewSignal = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typings.vegaTypings.signalMod.NewSignal]
    }
    
    inline def PushSignal(name: String): typings.vegaTypings.signalMod.PushSignal = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], push = "outer")
