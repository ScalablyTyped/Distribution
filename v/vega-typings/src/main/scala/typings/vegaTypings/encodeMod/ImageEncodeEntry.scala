...
object ImageEncodeEntry {
  ...
  implicit class ImageEncodeEntryMutableBuilder[Self <: ImageEncodeEntry] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setAspectVarargs(value: (Test & BooleanValueRef)*): Self = StObject.set(x, "aspect", js.Array(value :_*))
    ...
    @scala.inline
    def setBaselineVarargs(value: (Test & ScaledValueRef[Baseline])*): Self = StObject.set(x, "baseline", js.Array(value :_*))
    ...
    @scala.inline
    def setSmoothVarargs(value: (Test & BooleanValueRef)*): Self = StObject.set(x, "smooth", js.Array(value :_*))
    ...
    @scala.inline
    def setUrlVarargs(value: (Test & StringValueRef)*): Self = StObject.set(x, "url", js.Array(value :_*))
  }
}
