...
object ArcEncodeEntry {
  ...
  extension [Self <: ArcEncodeEntry](x: Self) {
    ...
    inline def setEndAngleVarargs(value: (Test & NumericValueRef)*): Self = StObject.set(x, "endAngle", js.Array(value*))
    ...
    inline def setInnerRadiusVarargs(value: (Test & NumericValueRef)*): Self = StObject.set(x, "innerRadius", js.Array(value*))
    ...
    inline def setOuterRadiusVarargs(value: (Test & NumericValueRef)*): Self = StObject.set(x, "outerRadius", js.Array(value*))
    ...
    inline def setPadAngleVarargs(value: (Test & NumericValueRef)*): Self = StObject.set(x, "padAngle", js.Array(value*))
    ...
    inline def setStartAngleVarargs(value: (Test & NumericValueRef)*): Self = StObject.set(x, "startAngle", js.Array(value*))
  }
}
