...
object Gradient {
  ...
  inline def LinearGradient(stops: js.Array[GradientStop]): typings.vegaTypings.encodeMod.LinearGradient = {
  ...
  inline def RadialGradient(stops: js.Array[GradientStop]): typings.vegaTypings.encodeMod.RadialGradient = {
