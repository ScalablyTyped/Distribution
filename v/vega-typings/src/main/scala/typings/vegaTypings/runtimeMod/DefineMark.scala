...
object DefineMark {
  @scala.inline
  def apply[/* <: java.lang.String */ T, I, /* <: java.lang.String */ R](group: js.Any, items: js.Array[Item[I]], marktype: T, role: mark | R): DefineMark[T, I, R] = {
  ...
  @scala.inline
  implicit class DefineMarkOps[Self <: DefineMark[_, _, _], /* <: java.lang.String */ T, I, /* <: java.lang.String */ R] (val x: Self with (DefineMark[T, I, R])) extends AnyVal {
    @scala.inline
