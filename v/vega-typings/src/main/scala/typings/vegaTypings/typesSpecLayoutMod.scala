...
object typesSpecLayoutMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typings.vegaTypings.typesSpecLayoutMod.LayoutParams
  */
  trait Layout extends StObject
  object Layout {
    
    inline def LayoutParams(): typings.vegaTypings.typesSpecLayoutMod.LayoutParams = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typings.vegaTypings.typesSpecLayoutMod.LayoutParams]
    }
