...
object Facet {
  ...
  inline def Aggregate(data: String, groupby: String | js.Array[String], name: String): typings.vegaTypings.anon.Aggregate = {
  ...
  inline def Name(data: String, field: String, name: String): typings.vegaTypings.anon.Name = {
