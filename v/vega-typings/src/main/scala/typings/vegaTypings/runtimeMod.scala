...
object runtimeMod {
  ...
  @scala.inline
  def projection(`type`: String, projection: js.Any): View = (^.asInstanceOf[js.Dynamic].applyDynamic("projection")(`type`.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[View]
  ...
  object DefineMark {
    ...
    @scala.inline
    implicit class DefineMarkMutableBuilder[Self <: DefineMark[?, ?, ?], T /* <: String */, I, R /* <: String */] (val x: Self & (DefineMark[T, I, R])) extends AnyVal {
