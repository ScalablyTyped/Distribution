...
import typings.vegaTypings.typesSpecProjectionMod.GeoJsonFeature
...
object typesSpecConfigMod {
  ...
  */
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends vega-typings.vega-typings/types/spec/signal.SignalRef ? vega-typings.vega-typings/types/spec/signal.SignalRef : never
    }}}
    */
