...
trait SymLogScale
  extends NumericScale
     with Scale {
  var constant: js.UndefOr[scala.Double | vegaDashTypingsLib.typesSpecSignalMod.SignalRef] = js.undefined
  @JSName("type")
...
object SymLogScale {
  ...
  def apply(
    ...
    constant: scala.Double | vegaDashTypingsLib.typesSpecSignalMod.SignalRef = null,
    domain: (js.Array[
