...
package object typesSpecValuesMod {
  type AlignValue = vegaDashTypingsLib.typesSpecEncodeMod.Align | vegaDashTypingsLib.typesSpecEncodeMod.AlignValueRef
  type AnchorValue = vegaDashTypingsLib.typesSpecTitleMod.TitleAnchor | vegaDashTypingsLib.typesSpecEncodeMod.AnchorValueRef
  ...
  type SymbolShapeValue = vegaDashTypingsLib.typesSpecEncodeMod.SymbolShape | vegaDashTypingsLib.typesSpecEncodeMod.SymbolShapeValueRef
  type TextBaselineValue = vegaDashTypingsLib.typesSpecEncodeMod.TextBaseline | vegaDashTypingsLib.typesSpecEncodeMod.TextBaselineValueRef
}
