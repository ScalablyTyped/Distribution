...
import typings.vegaDashEmbed.vegaDashEmbedNumbers.`0`
import typings.vegaDashEmbed.vegaDashEmbedNumbers.`1`
import typings.vegaDashEmbed.vegaDashEmbedNumbers.`false`
import typings.vegaDashEmbed.vegaDashEmbedNumbers.`true`
import typings.vegaDashEmbed.vegaDashEmbedStrings.center
import typings.vegaDashEmbed.vegaDashEmbedStrings.left
import typings.vegaDashEmbed.vegaDashEmbedStrings.right
...
import typings.vegaDashTypings.typesRuntimeMod.Transform
import typings.vegaDashTypings.typesRuntimeMod.TypeInference
import typings.vegaDashTypings.typesRuntimeMod.View
...
/* Extracted nested Instantiables into classes in vegaNs */
@JSImport("vega-embed", "vega")
@js.native
object vega extends js.Object {
  var Bounds: Instantiable0[typings.vega.vegaMod.Bounds] = js.native
  var CanvasHandler: Instantiable0[typings.vega.vegaMod.CanvasHandler] = js.native
  val Debug: Double = js.native
  var Handler: Instantiable0[typings.vega.vegaMod.Handler] = js.native
  val Info: Double = js.native
  val None: Double = js.native
  var Renderer: Instantiable1[/* loader */ Loader, typings.vega.vegaMod.Renderer] = js.native
  var View: Instantiable1[/* runtime */ Runtime, typings.vega.vegaMod.View] = js.native
  val Warn: Double = js.native
  val transforms: StringDictionary[Transform] = js.native
