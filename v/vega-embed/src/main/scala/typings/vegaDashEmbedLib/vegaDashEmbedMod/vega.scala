...
object vega extends js.Object {
  ...
  def falsy(): vegaDashEmbedLib.vegaDashEmbedLibNumbers.`false` = js.native
  ...
  def one(): vegaDashEmbedLib.vegaDashEmbedLibNumbers.`1` = js.native
  ...
  def pad_center(
    ...
    align: vegaDashEmbedLib.vegaDashEmbedLibStrings.center
  ...
  def pad_left(
    ...
    len: scala.Double,
    char: java.lang.String,
    align: vegaDashEmbedLib.vegaDashEmbedLibStrings.left
  ): java.lang.String = js.native
  @JSName("pad")
  def pad_right(
    str: java.lang.String,
    len: scala.Double,
    char: java.lang.String,
    align: vegaDashEmbedLib.vegaDashEmbedLibStrings.right
  ): java.lang.String = js.native
  ...
  def toSet[T](array: js.Array[T]): org.scalablytyped.runtime.StringDictionary[vegaDashEmbedLib.vegaDashEmbedLibNumbers.`true`] = js.native
  ...
  @JSName("truncate")
  def truncate_center(a: java.lang.String, length: scala.Double, align: vegaDashEmbedLib.vegaDashEmbedLibStrings.center): java.lang.String = js.native
  @JSName("truncate")
  def truncate_center(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_left(a: java.lang.String, length: scala.Double, align: vegaDashEmbedLib.vegaDashEmbedLibStrings.left): java.lang.String = js.native
  @JSName("truncate")
  def truncate_left(
    a: java.lang.String,
    length: scala.Double,
  ...
  @JSName("truncate")
  def truncate_right(a: java.lang.String, length: scala.Double, align: vegaDashEmbedLib.vegaDashEmbedLibStrings.right): java.lang.String = js.native
  @JSName("truncate")
  def truncate_right(
    a: java.lang.String,
    length: scala.Double,
  ...
  def truthy(): vegaDashEmbedLib.vegaDashEmbedLibNumbers.`true` = js.native
  ...
  def zero(): vegaDashEmbedLib.vegaDashEmbedLibNumbers.`0` = js.native
