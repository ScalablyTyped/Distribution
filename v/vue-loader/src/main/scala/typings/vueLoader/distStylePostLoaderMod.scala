...
object distStylePostLoaderMod extends Shortcut {
  
  @JSImport("vue-loader/dist/stylePostLoader", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `distStylePostLoaderMod.foo` */
