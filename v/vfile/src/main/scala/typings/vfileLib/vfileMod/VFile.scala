...
trait VFile extends js.Object {
  ...
  /**
    ...
    */
  var messages: js.Array[vfileDashMessageLib.vfileDashMessageMod.VFileMessage] = js.native
  /**
    * Path of `vfile`.
    * Cannot be nullified.
    */
  ...
  /**
    ...
    * @param ruleId Category of message.
    */
  def info(reason: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Node): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Node, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Point): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Point, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Position): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def info(reason: java.lang.String, position: unistLib.unistMod.Position, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  /**
    ...
    * @param ruleId Category of message.
    */
  def message(reason: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Node): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Node, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Point): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Point, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Position): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
  def message(reason: java.lang.String, position: unistLib.unistMod.Position, ruleId: java.lang.String): vfileDashMessageLib.vfileDashMessageMod.VFileMessage = js.native
