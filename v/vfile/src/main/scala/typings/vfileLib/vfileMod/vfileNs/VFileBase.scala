...
@js.native
trait VFileBase[C /* <: vfileLib.Anon_Data */] extends js.Object {
  /**
  ...
  /**
           * Raw value.
           */
  var contents: Contents = js.native
  /**
           * Base of `path`.
  ...
  /**
           ...
           */
  var data: /* import warning: Failed type conversion: TsTypeLookup(TsTypeRef(TsQIdent(List(TsIdentSimple(C))),List()),Left(TsIdentSimple(data))) */js.Any = js.native
  /**
  ...
  /**
           ...
           */
  def apply(): VFile[C] = js.native
  /**
           * @param options If `options` is `string` or `Buffer`, treats it as `{contents: options}`. If `options` is a `VFile`, returns it. All other options are set on the newly created `vfile`.
           */
  def apply(input: Contents): VFile[C] = js.native
  def apply[C](input: VFile[C]): VFile[C] = js.native
  def apply[C](input: VFileParams[C]): VFile[C] = js.native
