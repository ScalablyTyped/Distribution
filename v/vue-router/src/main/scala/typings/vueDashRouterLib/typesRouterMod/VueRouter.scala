...
class VueRouter () extends js.Object {
  ...
  def beforeEach(guard: NavigationGuard[vueLib.typesVueMod.Vue]): js.Function = js.native
  def beforeResolve(guard: NavigationGuard[vueLib.typesVueMod.Vue]): js.Function = js.native
  ...
  def onError(cb: ErrorHandler): scala.Unit = js.native
  def onReady(cb: js.Function): scala.Unit = js.native
  def onReady(cb: js.Function, errorCb: ErrorHandler): scala.Unit = js.native
  ...
  def push(location: RawLocation, onComplete: js.Function, onAbort: ErrorHandler): scala.Unit = js.native
