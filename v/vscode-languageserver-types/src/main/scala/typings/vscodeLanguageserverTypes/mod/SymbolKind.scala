...
import typings.vscodeLanguageserverTypes.vscodeLanguageserverTypesNumbers.`26`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.vscodeLanguageserverTypes.vscodeLanguageserverTypesNumbers.`26`
*/
trait SymbolKind extends StObject
object SymbolKind {
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Array")
  @js.native
  val Array: `18` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Boolean")
  @js.native
  val Boolean: `17` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Class")
  @js.native
  val Class: `5` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Constant")
  @js.native
  val Constant: `14` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Constructor")
  @js.native
  val Constructor: `9` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Enum")
  @js.native
  val Enum: `10` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.EnumMember")
  @js.native
  val EnumMember: `22` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Event")
  @js.native
  val Event: `24` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Field")
  @js.native
  val Field: `8` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.File")
  @js.native
  val File: `1` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Function")
  @js.native
  val Function: `12` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Interface")
  @js.native
  val Interface: `11` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Key")
  @js.native
  val Key: `20` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Method")
  @js.native
  val Method: `6` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Module")
  @js.native
  val Module: `2` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Namespace")
  @js.native
  val Namespace: `3` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Null")
  @js.native
  val Null: `21` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Number")
  @js.native
  val Number: `16` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Object")
  @js.native
  val Object: `19` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Operator")
  @js.native
  val Operator: `25` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Package")
  @js.native
  val Package: `4` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Property")
  @js.native
  val Property: `7` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.String")
  @js.native
  val String: `15` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Struct")
  @js.native
  val Struct: `23` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.TypeParameter")
  @js.native
  val TypeParameter: `26` = js.native
  
  @JSImport("vscode-languageserver-types", "SymbolKind.Variable")
  @js.native
