...
object BaseTransitionPropsValidators {
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators")
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.appear")
  @js.native
  /* standard es5 */
  open class appear ()
    extends StObject
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.mode")
  @js.native
  /* standard es5 */
  open class mode ()
    extends StObject
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onAfterAppear")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onAfterEnter")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onAfterLeave")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onAppear")
  @js.native
  def onAppear: js.Array[ArrayConstructor | FunctionConstructor] = js.native
  
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onAppearCancelled")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onBeforeAppear")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onBeforeEnter")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onBeforeLeave")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onEnter")
  @js.native
  def onEnter: js.Array[ArrayConstructor | FunctionConstructor] = js.native
  
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onEnterCancelled")
  @js.native
  ...
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onLeave")
  @js.native
  def onLeave: js.Array[ArrayConstructor | FunctionConstructor] = js.native
  
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.onLeaveCancelled")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("@vue/runtime-core", "BaseTransitionPropsValidators.persisted")
  @js.native
  /* standard es5 */
