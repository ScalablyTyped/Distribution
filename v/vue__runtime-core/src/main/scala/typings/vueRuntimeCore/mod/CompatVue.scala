...
/* Inlined std.Pick<@vue/runtime-core.@vue/runtime-core.App<any>, 'version' | 'component' | 'directive'> & {  configureCompat :(config : @vue/runtime-core.@vue/runtime-core.CompatConfig): void, new (options : @vue/runtime-core.@vue/runtime-core.ComponentOptions<{}, any, any, any, any, any, any, any> | undefined): @vue/runtime-core.@vue/runtime-core.LegacyPublicInstance,   version :string,   config :@vue/runtime-core.@vue/runtime-core.AppConfig & @vue/runtime-core.@vue/runtime-core.LegacyConfig,   nextTick :{None <T = void>(this : T, fn : (this : T): void | undefined): std.Promise<void>}, use (plugin : @vue/runtime-core.@vue/runtime-core.Plugin_2, options : ...any): @vue/runtime-core.@vue/runtime-core.CompatVue, mixin (mixin : @vue/runtime-core.@vue/runtime-core.ComponentOptions<{}, any, any, any, any, any, any, any>): @vue/runtime-core.@vue/runtime-core.CompatVue, component (name : string): @vue/runtime-core.@vue/runtime-core.Component<any, any, any, @vue/runtime-core.@vue/runtime-core.ComputedOptions, @vue/runtime-core.@vue/runtime-core.MethodOptions> | undefined, component (name : string, component : @vue/runtime-core.@vue/runtime-core.Component<any, any, any, @vue/runtime-core.@vue/runtime-core.ComputedOptions, @vue/runtime-core.@vue/runtime-core.MethodOptions>): @vue/runtime-core.@vue/runtime-core.CompatVue, directive (name : string): @vue/runtime-core.@vue/runtime-core.Directive<any, any> | undefined, directive (name : string, directive : @vue/runtime-core.@vue/runtime-core.Directive<any, any>): @vue/runtime-core.@vue/runtime-core.CompatVue, compile (template : string): @vue/runtime-core.@vue/runtime-core.RenderFunction, extend (options : @vue/runtime-core.@vue/runtime-core.ComponentOptions<{}, any, any, any, any, any, any, any> | undefined): @vue/runtime-core.@vue/runtime-core.CompatVue, set (target : any, key : string | number | symbol, value : any): void, delete (target : any, key : string | number | symbol): void,   observable :{None <T extends object>(target : T): @vue/reactivity.@vue/reactivity.UnwrapNestedRefs<T>}, filter (name : string, arg : any | undefined): null} */
@js.native
trait CompatVue
  extends StObject
     with Instantiable0[LegacyPublicInstance]
     with Instantiable1[
      /* options */ ComponentOptions[js.Object, Any, Any, Any, Any, Any, Any, Any], 
  ...
  def extend(options: ComponentOptions[js.Object, Any, Any, Any, Any, Any, Any, Any]): CompatVue = js.native
  ...
  def mixin(mixin: ComponentOptions[js.Object, Any, Any, Any, Any, Any, Any, Any]): CompatVue = js.native
  ...
  def use(plugin: Plugin2, options: Any*): CompatVue = js.native
