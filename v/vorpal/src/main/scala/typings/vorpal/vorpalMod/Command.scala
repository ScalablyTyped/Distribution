...
import typings.vorpal.Anon_Data
import typings.vorpal.Anon_String
...
class Command () extends js.Object {
  ...
  def autocomplete(values: Anon_Data): this.type = js.native
  ...
  def types(types: Anon_String): this.type = js.native
