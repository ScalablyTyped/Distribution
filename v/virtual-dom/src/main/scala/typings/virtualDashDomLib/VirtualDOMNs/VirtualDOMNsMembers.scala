...
object VirtualDOMNsMembers extends js.Object {
  ...
  def isThunk(vTree: VTree): /* is Thunk */scala.Boolean = js.native
  def isVNode(vTree: VTree): /* is VNode */scala.Boolean = js.native
  def isVText(vTree: VTree): /* is VText */scala.Boolean = js.native
  def isWidget(vTree: VTree): /* is Widget */scala.Boolean = js.native
  /**
