...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.vis.visStrings.controlNodeDragging
  - typings.vis.visStrings.controlNodeDragEnd
...
object NetworkEvents {
  ...
  @scala.inline
  def controlNodeDragEnd: typings.vis.visStrings.controlNodeDragEnd = "controlNodeDragEnd".asInstanceOf[typings.vis.visStrings.controlNodeDragEnd]
  
  @scala.inline
  def controlNodeDragging: typings.vis.visStrings.controlNodeDragging = "controlNodeDragging".asInstanceOf[typings.vis.visStrings.controlNodeDragging]
