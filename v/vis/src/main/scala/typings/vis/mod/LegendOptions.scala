...
object LegendOptions {
  ...
  extension [Self <: LegendOptions](x: Self) {
    ...
    inline def setIconSpacing(value: Double): Self = StObject.set(x, "iconSpacing", value.asInstanceOf[js.Any])
    
    inline def setIconSpacingUndefined: Self = StObject.set(x, "iconSpacing", js.undefined)
    
    inline def setIcons(value: Boolean): Self = StObject.set(x, "icons", value.asInstanceOf[js.Any])
    
    inline def setIconsUndefined: Self = StObject.set(x, "icons", js.undefined)
    
    inline def setLeft(value: LegendPositionOptions): Self = StObject.set(x, "left", value.asInstanceOf[js.Any])
    
    inline def setLeftUndefined: Self = StObject.set(x, "left", js.undefined)
    
    inline def setRight(value: LegendPositionOptions): Self = StObject.set(x, "right", value.asInstanceOf[js.Any])
