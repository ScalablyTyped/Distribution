...
trait AnonEnabledForceDirection extends js.Object {
  var enabled: Boolean
...
object AnonEnabledForceDirection {
  @scala.inline
  def apply(enabled: Boolean, roundness: Double, `type`: String, forceDirection: String | Boolean = null): AnonEnabledForceDirection = {
    ...
    __obj.asInstanceOf[AnonEnabledForceDirection]
  }
}
