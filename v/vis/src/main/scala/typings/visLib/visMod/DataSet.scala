...
class DataSet[T /* <: DataItem | DataGroup | Node | Edge */] () extends js.Object {
  ...
  /**
    ...
    */
  def distinct(field: java.lang.String): js.Array[_] = js.native
  /**
  ...
  /**
    ...
    */
  def forEach(callback: js.Function2[/* item */ T, /* id */ IdType, scala.Unit]): scala.Unit = js.native
  def forEach(
    callback: js.Function2[/* item */ T, /* id */ IdType, scala.Unit],
  ...
  /**
    ...
    */
  def max(field: java.lang.String): T = js.native
  /**
    * Find the item with minimum value of specified field.
    *
    * @returns Returns null if no item is found.
    */
  def min(field: java.lang.String): T = js.native
  /**
  ...
  def setOptions(options: DataSetQueueOptions): scala.Unit = js.native
  /**
