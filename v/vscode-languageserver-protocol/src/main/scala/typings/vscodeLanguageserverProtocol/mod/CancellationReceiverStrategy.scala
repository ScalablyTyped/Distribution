...
object CancellationReceiverStrategy {
  ...
  @JSImport("vscode-languageserver-protocol", "CancellationReceiverStrategy")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("vscode-languageserver-protocol", "CancellationReceiverStrategy.Message")
  @js.native
  val Message: typings.vscodeJsonrpc.libCommonConnectionMod.CancellationReceiverStrategy = js.native
