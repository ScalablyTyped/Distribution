...
object VersionedTextDocumentIdentifier {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "VersionedTextDocumentIdentifier.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "VersionedTextDocumentIdentifier.is")
  @js.native
