...
object SemanticTokensRegistrationType {
  ...
  @JSImport("vscode-languageserver-protocol", "SemanticTokensRegistrationType.method")
  @js.native
  val method: textDocumentSlashsemanticTokens = js.native
  
  @JSImport("vscode-languageserver-protocol", "SemanticTokensRegistrationType.type")
  @js.native
