...
object NotebookCellKind {
  ...
  @JSImport("vscode-languageserver-protocol", "NotebookCellKind")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "NotebookCellKind.Code")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageserver-protocol", "NotebookCellKind.Markup")
  @js.native
