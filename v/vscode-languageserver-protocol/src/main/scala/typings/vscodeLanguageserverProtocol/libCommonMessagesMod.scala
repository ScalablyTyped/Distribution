...
object libCommonMessagesMod {
  ...
  - typings.vscodeLanguageserverProtocol.libCommonMessagesMod.RegistrationType because Inheritance from two classes. Inlined ____ */ @JSImport("vscode-languageserver-protocol/lib/common/messages", "ProtocolNotificationType")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.vscodeLanguageserverProtocol.libCommonMessagesMod.RegistrationType because Inheritance from two classes. Inlined ____ */ @JSImport("vscode-languageserver-protocol/lib/common/messages", "ProtocolNotificationType0")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typings.vscodeJsonrpc.libCommonConnectionMod.ProgressType because Inheritance from two classes. Inlined _pr, __
  - typings.vscodeLanguageserverProtocol.libCommonMessagesMod.RegistrationType because Inheritance from two classes. Inlined ____
