...
import typings.vscodeJsonrpc.connectionMod.ConnectionOptions
import typings.vscodeJsonrpc.connectionMod.ConnectionStrategy
...
import typings.vscodeJsonrpc.connectionMod.Trace
import typings.vscodeJsonrpc.connectionMod.TraceOptions
import typings.vscodeJsonrpc.connectionMod.Tracer
