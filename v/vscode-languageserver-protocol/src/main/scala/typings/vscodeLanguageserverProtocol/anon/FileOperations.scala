...
import typings.vscodeLanguageserverProtocol.protocolFileOperationsMod.FileOperationOptions
import typings.vscodeLanguageserverProtocol.protocolWorkspaceFolderMod.WorkspaceFoldersServerCapabilities
