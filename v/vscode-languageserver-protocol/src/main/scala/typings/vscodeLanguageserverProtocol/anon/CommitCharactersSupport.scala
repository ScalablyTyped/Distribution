...
object CommitCharactersSupport {
  ...
  def apply(
    ...
    tagSupport: ValueSetArray = null
  ): CommitCharactersSupport = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(commitCharactersSupport)) __obj.updateDynamic("commitCharactersSupport")(commitCharactersSupport.get.asInstanceOf[js.Any])
    if (!js.isUndefined(deprecatedSupport)) __obj.updateDynamic("deprecatedSupport")(deprecatedSupport.get.asInstanceOf[js.Any])
    if (documentationFormat != null) __obj.updateDynamic("documentationFormat")(documentationFormat.asInstanceOf[js.Any])
    if (!js.isUndefined(preselectSupport)) __obj.updateDynamic("preselectSupport")(preselectSupport.get.asInstanceOf[js.Any])
    if (!js.isUndefined(snippetSupport)) __obj.updateDynamic("snippetSupport")(snippetSupport.get.asInstanceOf[js.Any])
