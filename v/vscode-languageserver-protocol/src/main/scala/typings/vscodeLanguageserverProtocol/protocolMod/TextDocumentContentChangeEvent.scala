...
object TextDocumentContentChangeEvent {
  ...
  inline def Range(range: typings.vscodeLanguageserverTypes.mod.Range, text: String): typings.vscodeLanguageserverProtocol.anon.Range = {
    val __obj = js.Dynamic.literal(range = range.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.vscodeLanguageserverProtocol.anon.Range]
  }
  
  inline def Text(text: String): typings.vscodeLanguageserverProtocol.anon.Text = {
