...
object SemanticTokensRegistrationType {
  ...
  @JSImport("vscode-languageserver-protocol/lib/common/protocol", "SemanticTokensRegistrationType.method")
  @js.native
  val method: textDocumentSlashsemanticTokens = js.native
  
  @JSImport("vscode-languageserver-protocol/lib/common/protocol", "SemanticTokensRegistrationType.type")
  @js.native
