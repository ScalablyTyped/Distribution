...
object NotebookCellArrayChange {
  ...
  inline def create(start: uinteger, deleteCount: uinteger): typings.vscodeLanguageserverProtocol.protocolNotebookMod.NotebookCellArrayChange = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(start.asInstanceOf[js.Any], deleteCount.asInstanceOf[js.Any])).asInstanceOf[typings.vscodeLanguageserverProtocol.protocolNotebookMod.NotebookCellArrayChange]
  inline def create(
    start: uinteger,
