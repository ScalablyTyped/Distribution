...
object isMod {
  ...
  @scala.inline
  def objectLiteral(value: js.Any): /* is object */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("objectLiteral")(value.asInstanceOf[js.Any]).asInstanceOf[/* is object */ Boolean]
