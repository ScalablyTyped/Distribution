...
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotdiagnosticMod.DiagnosticWorkspaceClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotfileOperationsMod.FileOperationClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotinlayHintMod.InlayHintWorkspaceClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotinlineValueMod.InlineValueWorkspaceClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotsemanticTokensMod.SemanticTokensWorkspaceClientCapabilities
