...
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotcallHierarchyMod.CallHierarchyClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotcolorProviderMod.DocumentColorClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotdeclarationMod.DeclarationClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotdiagnosticMod.DiagnosticClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotfoldingRangeMod.FoldingRangeClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotimplementationMod.ImplementationClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotinlayHintMod.InlayHintClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotinlineValueMod.InlineValueClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotlinkedEditingRangeMod.LinkedEditingRangeClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotmonikerMod.MonikerClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotselectionRangeMod.SelectionRangeClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDotsemanticTokensMod.SemanticTokensClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDottypeDefinitionMod.TypeDefinitionClientCapabilities
import typings.vscodeLanguageserverProtocol.libCommonProtocolDottypeHierarchyMod.TypeHierarchyClientCapabilities
