...
object NotebookCellArrayChange {
  ...
  inline def create(start: uinteger, deleteCount: uinteger): typings.vscodeLanguageserverProtocol.libCommonProtocolDotnotebookMod.NotebookCellArrayChange = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(start.asInstanceOf[js.Any], deleteCount.asInstanceOf[js.Any])).asInstanceOf[typings.vscodeLanguageserverProtocol.libCommonProtocolDotnotebookMod.NotebookCellArrayChange]
  inline def create(
    start: uinteger,
