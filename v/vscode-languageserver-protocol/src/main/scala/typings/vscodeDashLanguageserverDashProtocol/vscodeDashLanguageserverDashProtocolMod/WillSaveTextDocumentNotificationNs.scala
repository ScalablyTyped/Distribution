...
@js.native
object WillSaveTextDocumentNotificationNs extends js.Object {
  val `type`: typings.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[WillSaveTextDocumentParams, TextDocumentRegistrationOptions] = js.native
}
