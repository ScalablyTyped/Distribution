...
import typings.vscodeDashLanguageserverDashProtocol.libProtocolMod.TextDocumentSaveRegistrationOptions
...
object DidSaveTextDocumentNotification extends js.Object {
  val `type`: typings.vscodeDashJsonrpc.vscodeDashJsonrpcMod.NotificationType[DidSaveTextDocumentParams, TextDocumentSaveRegistrationOptions] = js.native
}
