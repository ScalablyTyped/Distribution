...
import typings.vscodeDashLanguageserverDashProtocol.libProtocolMod.CompletionTriggerKind
import typings.vscodeDashLanguageserverDashProtocol.libProtocolMod.FileChangeType
import typings.vscodeDashLanguageserverDashProtocol.libProtocolMod.MessageType
