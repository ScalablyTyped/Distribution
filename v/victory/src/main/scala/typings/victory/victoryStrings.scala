...
object victoryStrings {
  ...
  sealed trait greyscale
    extends StObject
       with _ColorScalePropType
  inline def greyscale: greyscale = "greyscale".asInstanceOf[greyscale]
  ...
  inline def sliceEndAngle: sliceEndAngle = "sliceEndAngle".asInstanceOf[sliceEndAngle]
  
  @js.native
  sealed trait sliceStartAngle extends StObject
  inline def sliceStartAngle: sliceStartAngle = "sliceStartAngle".asInstanceOf[sliceStartAngle]
