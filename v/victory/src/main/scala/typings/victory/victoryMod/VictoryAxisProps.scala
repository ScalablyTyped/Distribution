...
import typings.victory.Fn_Index
...
trait VictoryAxisProps extends VictoryCommonProps {
  ...
  /**
    ...
    */
  var style: js.UndefOr[Anon_AxisAxisLabel] = js.undefined
  /**
  ...
  /**
    ...
    */
  var tickFormat: js.UndefOr[js.Array[_] | Fn_Index] = js.undefined
  /**
...
object VictoryAxisProps {
  ...
  def apply(
    ...
    tickFormat: js.Array[_] | Fn_Index = null,
