...
import typings.victory.Fn_Event
import typings.victory.Fn_EventAny
...
trait EventPropTypeInterface[TTarget, TEventKey] extends js.Object {
  ...
  /**
    ...
    */
  var eventHandlers: StringDictionary[(Fn_Event[TTarget, TEventKey]) | (Fn_EventAny[TTarget, TEventKey])]
...
object EventPropTypeInterface {
  ...
  def apply[TTarget, TEventKey](
    eventHandlers: StringDictionary[(Fn_Event[TTarget, TEventKey]) | (Fn_EventAny[TTarget, TEventKey])],
    target: TTarget,
