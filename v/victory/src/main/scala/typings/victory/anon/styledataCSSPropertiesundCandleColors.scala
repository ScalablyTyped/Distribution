...
object styledataCSSPropertiesundCandleColors {
  ...
  inline def apply(colorScale: js.Array[String], height: Double, width: Double): styledataCSSPropertiesundCandleColors = {
  ...
  extension [Self <: styledataCSSPropertiesundCandleColors](x: Self) {
