...
trait CSSPropertiestypeScatterS extends js.Object {
  ...
  /**
    ...
    */
  var bottom: js.UndefOr[typings.csstype.mod.Property.Bottom[String | Double]] = js.native
  /**
    * The **`box-align`** CSS property specifies how an element aligns its contents across its layout in a perpendicular direction. The effect of the property is only visible if there is extra space in the box.
    *
    * **Syntax**: `start | center | end | baseline | stretch`
  ...
  var fill: js.UndefOr[typings.csstype.mod.Property.Fill] = js.native
  ...
  /**
    ...
    */
  var left: js.UndefOr[typings.csstype.mod.Property.Left[String | Double]] = js.native
  /**
...
object CSSPropertiestypeScatterS {
  ...
  @scala.inline
  implicit class CSSPropertiestypeScatterSOps[Self <: CSSPropertiestypeScatterS] (val x: Self) extends AnyVal {
    @scala.inline
    ...
    @scala.inline
    def setBottom(value: typings.csstype.mod.Property.Bottom[String | Double]): Self = this.set("bottom", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setFill(value: typings.csstype.mod.Property.Fill): Self = this.set("fill", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setLeft(value: typings.csstype.mod.Property.Left[String | Double]): Self = this.set("left", value.asInstanceOf[js.Any])
    @scala.inline
    ...
    @scala.inline
    def setType(value: ScatterSymbolType): Self = this.set("type", value.asInstanceOf[js.Any])
    @scala.inline
