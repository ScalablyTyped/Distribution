...
/* Inlined react.react.CSSProperties & {  type :victory.victory.ScatterSymbolType | undefined} */
trait CSSPropertiestypeScatterS extends StObject {
...
object CSSPropertiestypeScatterS {
  ...
  @scala.inline
  def apply(): CSSPropertiestypeScatterS = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiestypeScatterS]
  }
  
  @scala.inline
  implicit class CSSPropertiestypeScatterSMutableBuilder[Self <: CSSPropertiestypeScatterS] (val x: Self) extends AnyVal {
    ...
    @scala.inline
    def setType(value: ScatterSymbolType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
