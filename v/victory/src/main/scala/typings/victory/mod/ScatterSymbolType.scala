...
/* Rewritten from type alias, can be one of: 
  ...
  - typings.victory.victoryStrings.diamond
  - typings.victory.victoryStrings.plus
  - typings.victory.victoryStrings.square
  - typings.victory.victoryStrings.star
  - typings.victory.victoryStrings.triangleDown
  - typings.victory.victoryStrings.triangleUp
*/
