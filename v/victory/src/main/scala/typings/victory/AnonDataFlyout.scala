...
trait AnonDataFlyout extends js.Object {
...
object AnonDataFlyout {
  @scala.inline
  def apply(data: CSSProperties = null, flyout: CSSProperties = null, labels: CSSProperties = null): AnonDataFlyout = {
    val __obj = js.Dynamic.literal()
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (flyout != null) __obj.updateDynamic("flyout")(flyout.asInstanceOf[js.Any])
    if (labels != null) __obj.updateDynamic("labels")(labels.asInstanceOf[js.Any])
    __obj.asInstanceOf[AnonDataFlyout]
  }
}
