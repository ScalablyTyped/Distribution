...
trait VictoryVoronoiContainerProps extends VictoryContainerProps {
  ...
  /**
  		 ...
  		 */
  var activateLabels: js.UndefOr[scala.Boolean] = js.undefined
  /**
  ...
  var onActivated: js.UndefOr[
    js.Function2[/* points */ js.Array[_], /* props */ VictoryVoronoiContainerProps, scala.Unit]
  ] = js.undefined
  /**
  ...
  /**
  		 ...
  		 */
  var voronoiBlacklist: js.UndefOr[js.Array[java.lang.String]] = js.undefined
  /**
  		 ...
  		 */
  var voronoiDimension: js.UndefOr[victoryLib.victoryLibStrings.x | victoryLib.victoryLibStrings.y] = js.undefined
  /**
  		 ...
  		 */
  var voronoiPadding: js.UndefOr[scala.Double] = js.undefined
}
...
object VictoryVoronoiContainerProps {
  ...
  def apply(
    ...
    voronoiPadding: scala.Int | scala.Double = null,
