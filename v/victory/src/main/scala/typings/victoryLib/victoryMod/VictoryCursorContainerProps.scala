...
trait VictoryCursorContainerProps extends VictoryContainerProps {
  /**
    ...
    */
  var cursorComponent: js.UndefOr[reactLib.reactMod.ReactNs.ReactElement] = js.undefined
  /**
  ...
  /**
    ...
    */
  var cursorLabelComponent: js.UndefOr[reactLib.reactMod.ReactNs.ReactElement] = js.undefined
  /**
