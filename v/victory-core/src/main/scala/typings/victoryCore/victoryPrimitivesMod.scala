...
import typings.victoryCore.arcMod.ArcProps
import typings.victoryCore.backgroundMod.BackgroundProps
import typings.victoryCore.borderMod.BorderProps
import typings.victoryCore.clipPathMod.ClipPathProps
...
import typings.victoryCore.textMod.TextProps
