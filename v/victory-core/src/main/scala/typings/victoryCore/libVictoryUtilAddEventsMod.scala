...
import typings.victoryCore.libTypesPropTypesMod.VictoryLabelableProps
import typings.victoryCore.libVictoryUtilCommonPropsMod.VictoryCommonProps
...
import typings.victoryCore.libVictoryUtilEventsMod.ComponentWithEvents
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libVictoryUtilAddEventsMod {
  ...
  - typings.victoryCore.libVictoryUtilCommonPropsMod.VictoryDatableProps because var conflicts: domainPadding. Inlined categories, data, dataComponent, domain, samples, sortKey, sortOrder, x, y, y0 */ trait EventMixinCommonProps
    extends StObject
