...
import typings.victoryCore.libVictoryContainerVictoryContainerMod.VictoryContainerProps
...
open class VictoryContainer protected ()
  extends typings.victoryCore.libVictoryContainerVictoryContainerMod.VictoryContainer {
