...
import typings.victoryCore.libVictoryPortalVictoryPortalMod.VictoryPortalProps
...
open class VictoryPortal protected ()
  extends typings.victoryCore.libVictoryPortalVictoryPortalMod.VictoryPortal {
