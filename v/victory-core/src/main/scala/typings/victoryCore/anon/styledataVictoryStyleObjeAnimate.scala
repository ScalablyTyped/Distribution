...
object styledataVictoryStyleObjeAnimate {
  ...
  @scala.inline
  implicit open class MutableBuilder[Self <: styledataVictoryStyleObjeAnimate] (val x: Self) extends AnyVal {
