...
trait styledataVictoryStyleObjeColorScale extends StObject {
  ...
  var style: js.UndefOr[DataLabels] = js.undefined
  
  var width: js.UndefOr[Double] = js.undefined
}
object styledataVictoryStyleObjeColorScale {
  
  inline def apply(): styledataVictoryStyleObjeColorScale = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styledataVictoryStyleObjeColorScale]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: styledataVictoryStyleObjeColorScale] (val x: Self) extends AnyVal {
    ...
    inline def setStyle(value: DataLabels): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
