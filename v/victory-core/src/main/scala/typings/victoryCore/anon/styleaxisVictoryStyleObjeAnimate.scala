...
object styleaxisVictoryStyleObjeAnimate {
  
  inline def apply(): styleaxisVictoryStyleObjeAnimate = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[styleaxisVictoryStyleObjeAnimate]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: styleaxisVictoryStyleObjeAnimate] (val x: Self) extends AnyVal {
    ...
    inline def setOrientation(value: OrientationTypes): Self = StObject.set(x, "orientation", value.asInstanceOf[js.Any])
