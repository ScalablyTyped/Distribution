...
import typings.victoryCore.propTypesMod.ID
...
object callbacksMod {
  ...
  trait CallbackArgs extends StObject {
    ...
    var scale: js.UndefOr[`3`] = js.undefined
  ...
  object CallbackArgs {
    ...
    extension [Self <: CallbackArgs](x: Self) {
      ...
      inline def setScale(value: `3`): Self = StObject.set(x, "scale", value.asInstanceOf[js.Any])
