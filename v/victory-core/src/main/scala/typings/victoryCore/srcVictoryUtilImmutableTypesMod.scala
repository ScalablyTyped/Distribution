...
import typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed
import typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Indexed
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcVictoryUtilImmutableTypesMod {
  ...
  trait Iterable[K, V] extends StObject {
    ...
    ): /*Map*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[G, /*this*/ Iterable[K, V]] = js.native
    def groupBy[G](
      grouper: js.Function3[
          /* value */ js.UndefOr[V], 
          /* key */ js.UndefOr[K], 
    ...
    /**
      ...
      *
      */
    def toKeyedSeq(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = js.native
    ...
    /**
      ...
      */
    def toList(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[V] = js.native
    ...
    /**
      ...
      */
    def toSetSeq(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[V] = js.native
  ...
  object Iterable {
    ...
    inline def apply[T](array: js.Array[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    inline def apply[T](iterable: /*ES6Iterable<T>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    inline def apply[T](iterator: Iterator[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
    ...
    inline def apply[V](value: V): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[V] = ^.asInstanceOf[js.Dynamic].apply(value.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[V]]
    ...
    trait Indexed[T]
      ...
      def findIndex(
        predicate: js.Function3[
              ...
              /* iter */ js.UndefOr[/*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]], 
              Boolean
            ]
      ): Double = js.native
      def findIndex(
      ...
      /**
        ...
        */
      def fromEntrySeq(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[Any, Any] = js.native
      ...
      /**
        ...
        *     // Seq [ 1, 'A', 'X', 2, 'B', 'Y' ]
        */
      def interleave(iterables: (Iterable[Any, T])*): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        * in this Iterable.
        */
      def interpose(separator: T): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def splice(index: Double, removeNum: Double, values: (/*Array<Iterable.Indexed<T> | T>*/ Any)*): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = js.native
      ...
      /**
        ...
        *
        */
      def zip(iterables: (Iterable[Any, Any])*): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[Any] = js.native
      
      def zipWith[Z](zipper: js.Function1[/* repeated */ Any, Z], iterables: (Iterable[Any, Any])*): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      /**
        * Returns an Iterable of the same type "zipped" with the provided
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[/* value */ T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
        zipper: js.Function3[/* value */ T, /* otherValue */ U, /* thirdValue */ V, Z],
        otherIterable: Iterable[Any, U],
        thirdIterable: Iterable[Any, V]
      ): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
    }
    object Indexed {
      
      inline def apply[T](array: js.Array[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iterator: Iterator[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]]
      inline def apply[K, V](iter: Keyed[K, V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Indexed")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[/*[K,V]*/ Any]]
    }
    ...
    object Set {
      ...
      inline def apply[T](array: js.Array[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iterator: Iterator[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]]
      inline def apply[K, V](iter: Keyed[K, V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("Set")(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[/*[K,V]*/ Any]]
    }
  ...
  trait List[T]
    extends StObject
       with typings.victoryCore.srcVictoryUtilImmutableTypesMod.Collection.Indexed[T] {
    
    /**
      * @see `Map#asImmutable`
      */
    def asImmutable(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * @see `Map#asMutable`
      */
    def asMutable(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with 0 size and no values.
      */
    def clear(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * @alias remove
      */
    def delete(index: Double): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * @alias removeIn
      */
    def deleteIn(keyPath: js.Array[Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def deleteIn(keyPath: Iterable[Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def insert(index: Double, value: T): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * @see `Map#merge`
      */
    def merge(
      iterables: (js.Array[T] | typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T])*
    ): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    def mergeDeepIn(
      ...
      iterables: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]*
    ): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * in this List.
      */
    def pop(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with the provided `values` appended, starting at this
      * List's `size`.
      */
    def push(values: T*): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def remove(index: Double): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def removeIn(keyPath: js.Array[Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def removeIn(keyPath: Iterable[Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def set(index: Double, value: T): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * the List.
      */
    def setIn(keyPath: js.Array[Any], value: Any): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def setIn(keyPath: Iterable[Any, Any], value: Any): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def setSize(size: Double): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      * value in this List.
      */
    def shift(): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    /**
      * Returns a new List with the provided `values` prepended, shifting other
      * values ahead to higher indices.
      */
    def unshift(values: T*): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def update(index: Double, notSetValue: T, updater: js.Function1[/* value */ T, T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def update(index: Double, updater: js.Function1[/* value */ T, T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    /**
    ...
    def update(
      updater: js.Function1[
          /* value */ typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T], 
          typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]
        ]
    ): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    
    def updateIn(keyPath: js.Array[Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    /**
      * @see `Map#updateIn`
      */
    def updateIn(keyPath: js.Array[Any], updater: js.Function1[/* value */ Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], notSetValue: Any, updater: js.Function1[/* value */ Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    def updateIn(keyPath: Iterable[Any, Any], updater: js.Function1[/* value */ Any, Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
    ...
    /**
      ...
      */
    def withMutations(
      mutator: js.Function1[/* mutable */ typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T], Any]
    ): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = js.native
  }
  object List {
    
    inline def apply[T](): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](array: js.Array[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iterator: Iterator[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
    inline def apply[K, V](iter: Keyed[K, V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[/*[K,V]*/ Any]]
    ...
    /**
      ...
      */
    inline def of[T](values: T*): typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.List[T]]
  }
  
  @js.native
  trait Map[K, V]
    extends StObject
       with typings.victoryCore.srcVictoryUtilImmutableTypesMod.Collection.Keyed[K, V] {
  ...
  object OrderedSet {
    ...
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[OrderedSet[T]]
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): OrderedSet[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[OrderedSet[T]]
  ...
  object Seq {
    ...
    inline def apply[V](obj: StringDictionary[V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].apply(obj.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[String, V]]
    ...
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed because var conflicts: size. Inlined fromEntrySeq, interpose, interleave, splice, zip, zipWith, zipWith, zipWith, indexOf, lastIndexOf, findIndex, findIndex, findLastIndex, findLastIndex */ @js.native
    trait Indexed[T]
      extends StObject
         with Seq[Double, T] {
      ...
      /**
        ...
        *
        */
      def zipWith[U, Z](zipper: js.Function2[T, /* otherValue */ U, Z], otherIterable: Iterable[Any, U]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[Z] = js.native
      def zipWith[U, V, Z](
    ...
    object Indexed {
      ...
      inline def apply[T](iterator: Iterator[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[T](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[T](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): Indexed[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[T]]
      inline def apply[K, V](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): Indexed[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[Indexed[/*[K,V]*/ Any]]
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed because var conflicts: size. Inlined flip, mapKeys, mapKeys, mapEntries, mapEntries */ @js.native
    trait Keyed[K, V]
      extends StObject
         with Seq[K, V] {
      ...
      /**
        ...
        *
        */
      def flip(): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[V, K] = js.native
      ...
      def mapEntries[KM, VM](
        mapper: js.Function3[
              ...
              /* index */ js.UndefOr[Double], 
              /* iter */ js.UndefOr[
                /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]
              ], 
              /*[KM, VM]*/ js.Array[Any]
            ]
      ): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[KM, VM] = js.native
      def mapEntries[KM, VM](
        mapper: js.Function3[
              /* entry */ js.UndefOr[/*(K, V)*/ js.Array[Any]], 
              /* index */ js.UndefOr[Double], 
      ...
      ): /*this*/ typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[M, V] = js.native
      def mapKeys[M](
        mapper: js.Function3[
              /* key */ js.UndefOr[K], 
              /* value */ js.UndefOr[V], 
    ...
    object Keyed {
      ...
      inline def apply[V](obj: StringDictionary[V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[String, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(obj.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[String, V]]
      inline def apply[K, V](): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")().asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](array: js.Array[/*[K,V]*/ Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](iterable: /*Iterable<[K,V]>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](iterator: Iterator[/*[K,V]*/ Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](seq: Iterable[Any, /*[K,V]*/ Any]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(seq.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
      inline def apply[K, V](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V] = ^.asInstanceOf[js.Dynamic].applyDynamic("Keyed")(seq.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Keyed[K, V]]
    }
    
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable because Already inherited
    - typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set because var conflicts: size. Inlined  */ @js.native
    trait Set[T]
      extends StObject
         with Seq[T, T]
    object Set {
      
      inline def apply[T](): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](array: js.Array[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(array.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](iterable: /*Iterable<T>*/ js.Object): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(iterable.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](iterator: Iterator[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(iterator.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[T](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
      inline def apply[K, V](seq: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Keyed[K, V]): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[/*[K,V]*/ Any] = ^.asInstanceOf[js.Dynamic].apply(seq.asInstanceOf[js.Any]).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[/*[K,V]*/ Any]]
      ...
      /**
        ...
        */
      inline def of[T](values: T*): typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("of")(values.asInstanceOf[scala.Seq[js.Any]]*).asInstanceOf[typings.victoryCore.srcVictoryUtilImmutableTypesMod.Seq.Set[T]]
    }
  ...
  trait Set[T]
    extends StObject
       with typings.victoryCore.srcVictoryUtilImmutableTypesMod.Collection.Set[T] {
  ...
  object Set {
    ...
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Set[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): Set[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Set[T]]
  ...
  object Stack {
    ...
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Indexed[T]): Stack[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Stack[T]]
    inline def apply[T](iter: typings.victoryCore.srcVictoryUtilImmutableTypesMod.Iterable.Set[T]): Stack[T] = ^.asInstanceOf[js.Dynamic].apply(iter.asInstanceOf[js.Any]).asInstanceOf[Stack[T]]
