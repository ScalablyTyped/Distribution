...
object VoxImplantCallEvent {
  ...
  inline def Connected(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.Connected = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.CallEventTypes.Connected]
  }
  
  inline def Disconnected(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.Disconnected = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.CallEventTypes.Disconnected]
  }
  
  inline def Failed(call: Call, code: Double, reason: String): typings.voximplantWebsdk.mod.CallEventTypes.Failed = {
  ...
  inline def InfoReceived(body: String, call: Call, mimeType: String): typings.voximplantWebsdk.mod.CallEventTypes.InfoReceived = {
  ...
  inline def MessageReceived(call: Call, text: String): typings.voximplantWebsdk.mod.CallEventTypes.MessageReceived = {
  ...
  inline def ProgressToneStart(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.ProgressToneStart = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.CallEventTypes.ProgressToneStart]
  }
  
  inline def ProgressToneStop(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.ProgressToneStop = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.CallEventTypes.ProgressToneStop]
  }
  
  inline def TransferComplete(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.TransferComplete = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.CallEventTypes.TransferComplete]
  }
  
  inline def TransferFailed(call: Call): typings.voximplantWebsdk.mod.CallEventTypes.TransferFailed = {
    val __obj = js.Dynamic.literal(call = call.asInstanceOf[js.Any])
