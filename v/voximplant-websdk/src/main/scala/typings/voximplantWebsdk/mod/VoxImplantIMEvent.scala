...
object VoxImplantIMEvent {
  ...
  inline def ChatHistoryReceived(id: String, message_id: String, messages: js.Array[IMHistoryMessage]): typings.voximplantWebsdk.mod.IMEventTypes.ChatHistoryReceived = {
  ...
  inline def ChatRoomBanList(participants: js.Array[ChatRoomParticipant], room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomBanList = {
  ...
  inline def ChatRoomCreated(room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomCreated = {
  ...
  inline def ChatRoomError(code: String, operation: String, room: String, text: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomError = {
  ...
  inline def ChatRoomHistoryReceived(message_id: String, messages: js.Array[IMHistoryMessage], room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomHistoryReceived = {
  ...
  inline def ChatRoomInvitation(body: String, from: String, password: String, reason: String, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomInvitation = {
  ...
  inline def ChatRoomInviteDeclined(invitee: String, reason: String, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomInviteDeclined = {
  ...
  inline def ChatRoomMessageNotModified(code: Double, message_id: String, private_message: String, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomMessageNotModified = {
  ...
  inline def ChatRoomNewParticipant(displayName: String, participant: String, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomNewParticipant = {
  ...
  inline def ChatRoomOperation(operation: ChatRoomOperationType, result: Boolean, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomOperation = {
  ...
  inline def ChatRoomParticipantExit(participant: String, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomParticipantExit = {
  ...
  inline def ChatRoomParticipants(participants: js.Array[ChatRoomParticipant], room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomParticipants = {
    val __obj = js.Dynamic.literal(participants = participants.asInstanceOf[js.Any], room = room.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomParticipants]
  }
  
  inline def ChatRoomPresenceUpdate(message: String, participant: ParticipantInfo, presence: UserStatuses, room: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomPresenceUpdate = {
  ...
  inline def ChatRoomStateUpdate(from: String, resource: String, room: String, state: ChatStateType): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomStateUpdate = {
  ...
  inline def ChatRoomSubjectChange(id: String, resource: String, room: String, subject: String): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomSubjectChange = {
  ...
  inline def ChatRoomsDataReceived(rooms: js.Array[ChatRoom]): typings.voximplantWebsdk.mod.IMEventTypes.ChatRoomsDataReceived = {
  ...
  inline def ChatStateUpdate(id: String, state: ChatStateType): typings.voximplantWebsdk.mod.IMEventTypes.ChatStateUpdate = {
  ...
  inline def MessageModified(content: String, id: String, message_id: String, to: String): typings.voximplantWebsdk.mod.IMEventTypes.MessageModified = {
  ...
  inline def MessageNotModified(code: Double, message_id: String, to: String): typings.voximplantWebsdk.mod.IMEventTypes.MessageNotModified = {
  ...
  inline def MessageReceived(content: String, id: String, message_id: String, to: String): typings.voximplantWebsdk.mod.IMEventTypes.MessageReceived = {
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], message_id = message_id.asInstanceOf[js.Any], to = to.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.IMEventTypes.MessageReceived]
  }
  
  inline def MessageRemoved(id: String, message_id: String, to: String): typings.voximplantWebsdk.mod.IMEventTypes.MessageRemoved = {
  ...
  inline def MessageStatus(id: String, message_id: String, `type`: MessageEventType): typings.voximplantWebsdk.mod.IMEventTypes.MessageStatus = {
  ...
  inline def PresenceUpdate(id: String, message: String, presence: UserStatuses): typings.voximplantWebsdk.mod.IMEventTypes.PresenceUpdate = {
  ...
  inline def RosterItemChange(displayName: String, groups: js.Array[String], id: String, `type`: RosterItemEvent): typings.voximplantWebsdk.mod.IMEventTypes.RosterItemChange = {
  ...
  inline def RosterPresenceUpdate(id: String, presence: UserStatuses): typings.voximplantWebsdk.mod.IMEventTypes.RosterPresenceUpdate = {
  ...
  inline def RosterReceived(id: String, roster: js.Array[RosterItem]): typings.voximplantWebsdk.mod.IMEventTypes.RosterReceived = {
  ...
  inline def SubscriptionRequest(id: String, `type`: SubscriptionRequestType): typings.voximplantWebsdk.mod.IMEventTypes.SubscriptionRequest = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typings.voximplantWebsdk.mod.IMEventTypes.SubscriptionRequest]
  }
  
  inline def SystemError(errorData: js.Object, errorType: IMErrorType): typings.voximplantWebsdk.mod.IMEventTypes.SystemError = {
