...
trait ChatRoomInfo extends VoxImplantIMEvent {
  ...
  /**
  			* Room info object
  			*/
  var info: typings.voximplantDashWebsdk.voximplantDashWebsdkMod.IMEventTypesNs.ChatRoomInfo
  /**
  			* Room id
  			*/
  var room: String
...
object ChatRoomInfo {
  ...
  def apply(
    features: Double,
    info: typings.voximplantDashWebsdk.voximplantDashWebsdkMod.IMEventTypesNs.ChatRoomInfo,
    room: String,
    room_name: String
  ): ChatRoomInfo = {
