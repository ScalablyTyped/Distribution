...
trait SubscriptionRequest
  ...
  /**
  			...
  			*/
  var `type`: voximplantDashWebsdkLib.voximplantDashWebsdkMod.SubscriptionRequestType
}
...
object SubscriptionRequest {
  ...
  def apply(
    id: java.lang.String,
    `type`: voximplantDashWebsdkLib.voximplantDashWebsdkMod.SubscriptionRequestType,
