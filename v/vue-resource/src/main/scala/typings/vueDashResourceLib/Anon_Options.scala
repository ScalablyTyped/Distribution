...
trait Anon_Options extends js.Object {
  var delete: vueDashResourceLib.vuejsNs.$http = js.native
  var get: vueDashResourceLib.vuejsNs.$http = js.native
  var jsonp: vueDashResourceLib.vuejsNs.$http = js.native
