...
trait MediaHTMLAttributes
  ...
  var autoplay: js.UndefOr[Booleanish] = js.undefined
  
  var controls: js.UndefOr[Booleanish] = js.undefined
  
  var controlslist: js.UndefOr[String] = js.undefined
  
  var crossorigin: js.UndefOr[String] = js.undefined
  
  var loop: js.UndefOr[Booleanish] = js.undefined
  
  var mediagroup: js.UndefOr[String] = js.undefined
  
  var muted: js.UndefOr[Booleanish] = js.undefined
  
  var playsinline: js.UndefOr[Booleanish] = js.undefined
...
object MediaHTMLAttributes {
  ...
  extension [Self <: MediaHTMLAttributes](x: Self) {
    
    inline def setAutoplay(value: Booleanish): Self = StObject.set(x, "autoplay", value.asInstanceOf[js.Any])
    
    inline def setAutoplayUndefined: Self = StObject.set(x, "autoplay", js.undefined)
    
    inline def setControls(value: Booleanish): Self = StObject.set(x, "controls", value.asInstanceOf[js.Any])
    ...
    inline def setLoop(value: Booleanish): Self = StObject.set(x, "loop", value.asInstanceOf[js.Any])
    ...
    inline def setMuted(value: Booleanish): Self = StObject.set(x, "muted", value.asInstanceOf[js.Any])
    
    inline def setMutedUndefined: Self = StObject.set(x, "muted", js.undefined)
    
    inline def setPlaysinline(value: Booleanish): Self = StObject.set(x, "playsinline", value.asInstanceOf[js.Any])
