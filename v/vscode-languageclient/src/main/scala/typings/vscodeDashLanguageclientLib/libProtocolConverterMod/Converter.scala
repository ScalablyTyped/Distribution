...
trait Converter extends js.Object {
  ...
  def asCodeAction(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CodeAction): js.UndefOr[_] = js.native
  def asCodeActionKind(): js.UndefOr[scala.Nothing] = js.native
  def asCodeActionKind(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CodeActionKind): js.UndefOr[_] = js.native
  ...
  ): js.UndefOr[js.Array[_]] = js.native
  @JSName("asCodeAction")
  ...
  def asCodeLens(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CodeLens): js.UndefOr[_] = js.native
  @JSName("asCodeLens")
  ...
  def asColorInformations(): js.Array[_] = js.native
  ...
  def asCompletionResult(result: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CompletionList): js.UndefOr[js.Array[_] | js.Any] = js.native
  ...
  ): js.UndefOr[js.Array[_] | js.Any] = js.native
  ...
  def asDeclarationResult(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Declaration): js.Any | js.Array[_] = js.native
  ...
  @JSName("asDeclarationResult")
  def asDeclarationResult_UndefOr(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Declaration): js.UndefOr[_] = js.native
  ...
  def asDefinitionResult(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Definition): js.UndefOr[js.Any | js.Array[_]] = js.native
  ...
  ): js.UndefOr[js.Any | js.Array[_]] = js.native
  ...
  def asFoldingRangeKind(): js.UndefOr[_] = js.native
  def asFoldingRangeKind(kind: java.lang.String): js.UndefOr[_] = js.native
  ...
  def asHover(hover: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Hover): js.UndefOr[_] = js.native
  @JSName("asHover")
  ...
  def asLocation(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Location): js.UndefOr[_] = js.native
  @JSName("asLocation")
  ...
  def asPosition(value: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Position): js.UndefOr[_] = js.native
  @JSName("asPosition")
  ...
  def asRange(value: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Range): js.UndefOr[_] = js.native
  @JSName("asRange")
  def asRange_Any(value: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Range): js.Any = js.native
  def asReferences(): js.UndefOr[js.Array[_]] = js.native
  def asReferences(
    values: js.Array[
  ...
  def asSignatureHelp(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.SignatureHelp): js.UndefOr[_] = js.native
  ...
  def asSymbolInformations(values: js.UndefOr[scala.Nothing], uri: js.Any): js.UndefOr[scala.Nothing] = js.native
  def asSymbolInformations(values: scala.Null, uri: js.Any): js.UndefOr[scala.Nothing] = js.native
  ...
  def asTextEdit(edit: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.TextEdit): js.UndefOr[_] = js.native
  @JSName("asTextEdit")
  ...
  def asWorkspaceEdit(item: vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.WorkspaceEdit): js.UndefOr[_] = js.native
