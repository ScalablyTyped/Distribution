...
package object libSelectionRangeDotProposedMod {
  type ProvideSelectionRangeSignature = js.Function3[
    ...
    /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify ProviderResult<Array<VSelectionRange> | null> */ js.Any
  ]
}
