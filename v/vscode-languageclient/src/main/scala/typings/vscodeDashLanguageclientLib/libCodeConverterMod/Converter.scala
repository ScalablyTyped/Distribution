...
trait Converter extends js.Object {
  def asChangeTextDocumentParams(
    textDocument: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.TextDocument */ js.Any
  ...
  def asCodeActionContext(
    context: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.CodeActionContext */ js.Any
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CodeActionContext = js.native
  def asCodeLens(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.CodeLens */ js.Any
  ...
  def asCommand(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Command */ js.Any
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Command = js.native
  def asCompletionItem(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.CompletionItem */ js.Any
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.CompletionItem = js.native
  def asCompletionParams(
    textDocument: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.TextDocument */ js.Any,
    position: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Position */ js.Any,
  ...
  def asDiagnostic(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Diagnostic */ js.Any
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.Diagnostic = js.native
  def asDiagnosticSeverity(
    value: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.DiagnosticSeverity */ js.Any
  ...
  def asDocumentLink(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.DocumentLink */ js.Any
  ...
  def asFormattingOptions(
    item: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.FormattingOptions */ js.Any
  ...
  def asPosition(
    value: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Position */ js.Any
  ...
  def asRange(
    value: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Range */ js.Any
  ): js.UndefOr[
  ...
  def asTextEdit(
    edit: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.TextEdit */ js.Any
  ): vscodeDashLanguageserverDashTypesLib.vscodeDashLanguageserverDashTypesMod.TextEdit = js.native
  def asUri(uri: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.Uri */ js.Any): java.lang.String = js.native
  ...
  def asWillSaveTextDocumentParams(
    event: /* import warning: QualifyReferences.resolveTypeRef many Couldn't qualify code.TextDocumentWillSaveEvent */ js.Any
