...
import typings.vscodeDashLanguageclient.vscodeDashLanguageclientStrings.markdown
import typings.vscodeDashLanguageclient.vscodeDashLanguageclientStrings.plaintext
