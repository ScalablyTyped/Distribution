...
object CodeActionKind extends js.Object {
  /**
    * Empty kind.
    */
  val Empty: typings.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.CodeActionKind = js.native
  /**
  ...
  /**
    ...
    * @since 3.15.0
    */
  val SourceFixAll: typings.vscodeDashLanguageserverDashTypes.vscodeDashLanguageserverDashTypesMod.CodeActionKind = js.native
  /**
