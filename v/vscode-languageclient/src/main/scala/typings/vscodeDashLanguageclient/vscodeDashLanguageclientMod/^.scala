...
@JSImport("vscode-languageclient", JSImport.Namespace)
@js.native
object ^ extends js.Object {
  ...
  def createClientSocketTransport(port: Double): Thenable[typings.vscodeDashJsonrpc.libSocketSupportMod.SocketTransport] = js.native
  def createClientSocketTransport(port: Double, encoding: String): Thenable[typings.vscodeDashJsonrpc.libSocketSupportMod.SocketTransport] = js.native
