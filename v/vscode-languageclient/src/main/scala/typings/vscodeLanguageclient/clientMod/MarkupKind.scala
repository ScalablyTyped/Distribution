...
object MarkupKind {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "MarkupKind.Markdown")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "MarkupKind.PlainText")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "MarkupKind.is")
  @js.native
