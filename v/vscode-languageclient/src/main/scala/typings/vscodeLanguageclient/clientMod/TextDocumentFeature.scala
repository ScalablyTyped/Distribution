...
import typings.vscodeLanguageclient.AnonDocumentSelector
...
abstract class TextDocumentFeature[PO, RO /* <: typings.vscodeLanguageserverProtocol.protocolMod.TextDocumentRegistrationOptions with PO */, PR] protected () extends DynamicFeature[RO] {
  ...
  /* protected */ def getRegistration(): js.Tuple2[js.UndefOr[String], js.UndefOr[RO with AnonDocumentSelector]] = js.native
  ...
  ): js.Tuple2[js.UndefOr[String], js.UndefOr[RO with AnonDocumentSelector]] = js.native
  /* protected */ def getRegistration(documentSelector: typings.vscodeLanguageserverProtocol.protocolMod.DocumentSelector): js.Tuple2[js.UndefOr[String], js.UndefOr[RO with AnonDocumentSelector]] = js.native
  /* protected */ def getRegistration(
    documentSelector: typings.vscodeLanguageserverProtocol.protocolMod.DocumentSelector,
    capability: (RO with typings.vscodeLanguageserverProtocol.protocolMod.StaticRegistrationOptions) | PO
  ): js.Tuple2[js.UndefOr[String], js.UndefOr[RO with AnonDocumentSelector]] = js.native
  /* protected */ def getRegistrationOptions(): js.UndefOr[RO with AnonDocumentSelector] = js.native
  /* protected */ def getRegistrationOptions(documentSelector: js.UndefOr[scala.Nothing], capability: PO): js.UndefOr[RO with AnonDocumentSelector] = js.native
  /* protected */ def getRegistrationOptions(documentSelector: typings.vscodeLanguageserverProtocol.protocolMod.DocumentSelector): js.UndefOr[RO with AnonDocumentSelector] = js.native
