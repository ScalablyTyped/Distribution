...
object DiagnosticRelatedInformation {
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "DiagnosticRelatedInformation.create")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("vscode-languageclient/lib/client", "DiagnosticRelatedInformation.is")
  @js.native
