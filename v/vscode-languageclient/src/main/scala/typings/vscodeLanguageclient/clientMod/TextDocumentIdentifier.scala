...
object TextDocumentIdentifier {
  ...
  /**
    ...
    */
  @scala.inline
  def create(uri: DocumentUri): typings.vscodeLanguageserverTypes.mod.TextDocumentIdentifier = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(uri.asInstanceOf[js.Any]).asInstanceOf[typings.vscodeLanguageserverTypes.mod.TextDocumentIdentifier]
