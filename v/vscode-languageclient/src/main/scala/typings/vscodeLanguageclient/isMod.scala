...
object isMod {
  ...
  inline def thenable[T](value: Any): /* is vscode-jsonrpc.Thenable<T> */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("thenable")(value.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.Thenable<T> */ Boolean]
