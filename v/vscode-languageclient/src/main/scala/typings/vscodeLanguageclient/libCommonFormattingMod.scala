...
import typings.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentFormattingOptions
import typings.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentHighlightRegistrationOptions
import typings.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentOnTypeFormattingOptions
import typings.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentOnTypeFormattingRegistrationOptions
import typings.vscodeLanguageserverProtocol.libCommonProtocolMod.DocumentRangeFormattingOptions
