...
object workspaceFoldersMod {
  ...
  class WorkspaceFoldersFeature protected ()
    ...
    /* private */ var _initialFolders: js.Any = js.native
    
    /* private */ var _listeners: js.Any = js.native
    
    /* private */ var asProtocol: js.Any = js.native
    
    /* private */ var doSendEvent: js.Any = js.native
  ...
  object WorkspaceFolderWorkspaceMiddleware {
    ...
    extension [Self <: WorkspaceFolderWorkspaceMiddleware](x: Self) {
      ...
      inline def setDidChangeWorkspaceFolders(value: NextSignature[WorkspaceFoldersChangeEvent, Unit]): Self = StObject.set(x, "didChangeWorkspaceFolders", value.asInstanceOf[js.Any])
