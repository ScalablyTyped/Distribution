...
/* Inlined vscode-languageclient.vscode-languageclient/lib/common/features.DynamicFeature<vscode-languageserver-protocol.vscode-languageserver-protocol.FileOperationRegistrationOptions> & {send (event : vscode.vscode.FileWillCreateEvent): std.Promise<void>} */
@js.native
trait DynamicFeatureFileOperatiFillInitializeParams extends StObject {
  ...
  def send(event: FileWillCreateEvent): js.Promise[Unit] = js.native
