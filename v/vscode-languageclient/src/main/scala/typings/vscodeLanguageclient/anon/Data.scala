...
trait Data extends StObject {
  ...
  /**
    ...
    */
  var textContent: js.UndefOr[js.Array[TextDocumentChangeEvent]] = js.undefined
}
object Data {
  ...
  implicit open class MutableBuilder[Self <: Data] (val x: Self) extends AnyVal {
    ...
    inline def setTextContent(value: js.Array[TextDocumentChangeEvent]): Self = StObject.set(x, "textContent", value.asInstanceOf[js.Any])
    
    inline def setTextContentUndefined: Self = StObject.set(x, "textContent", js.undefined)
    
    inline def setTextContentVarargs(value: TextDocumentChangeEvent*): Self = StObject.set(x, "textContent", js.Array(value*))
  }
}
