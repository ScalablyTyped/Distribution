...
/* Inlined vscode-languageclient.vscode-languageclient/lib/common/features.DynamicFeature<vscode-languageserver-protocol.vscode-languageserver-protocol.FileOperationRegistrationOptions> & {send (event : vscode.vscode.FileWillDeleteEvent): std.Promise<void>} */
@js.native
trait DynamicFeatureFileOperatiInitialize extends StObject {
  ...
  def send(event: FileWillDeleteEvent): js.Promise[Unit] = js.native
