...
object InlayHintLabelPart {
  ...
  inline def create(value: String): typings.vscodeLanguageserverTypes.mod.InlayHintLabelPart = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(value.asInstanceOf[js.Any]).asInstanceOf[typings.vscodeLanguageserverTypes.mod.InlayHintLabelPart]
