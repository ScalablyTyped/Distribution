...
object NotebookDocumentSyncRegistrationType {
  ...
  @JSImport("vscode-languageclient", "NotebookDocumentSyncRegistrationType.messageDirection")
  @js.native
  val messageDirection: typings.vscodeLanguageserverProtocol.libCommonMessagesMod.MessageDirection = js.native
  
  @JSImport("vscode-languageclient", "NotebookDocumentSyncRegistrationType.method")
  @js.native
  val method: notebookDocumentSlashsync = js.native
  
  @JSImport("vscode-languageclient", "NotebookDocumentSyncRegistrationType.type")
  @js.native
