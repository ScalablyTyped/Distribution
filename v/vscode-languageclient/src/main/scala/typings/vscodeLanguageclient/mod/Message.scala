...
object Message {
  ...
  inline def isNotification(message: typings.vscodeJsonrpc.libCommonMessagesMod.Message): /* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.NotificationMessage */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isNotification")(message.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.NotificationMessage */ Boolean]
  ...
  inline def isRequest(message: typings.vscodeJsonrpc.libCommonMessagesMod.Message): /* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.RequestMessage */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isRequest")(message.asInstanceOf[js.Any]).asInstanceOf[/* is vscode-jsonrpc.vscode-jsonrpc/lib/common/messages.RequestMessage */ Boolean]
