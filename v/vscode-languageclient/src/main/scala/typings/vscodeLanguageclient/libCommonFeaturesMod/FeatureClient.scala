...
import typings.vscodeLanguageclient.libCommonCodeLensMod.CodeLensProviderShape
import typings.vscodeLanguageclient.libCommonDiagnosticMod.DiagnosticProviderShape
import typings.vscodeLanguageclient.libCommonInlayHintMod.InlayHintsProviderShape
import typings.vscodeLanguageclient.libCommonInlineValueMod.InlineValueProviderShape
import typings.vscodeLanguageclient.libCommonNotebookMod.NotebookDocumentProviderShape
import typings.vscodeLanguageclient.libCommonSemanticTokensMod.SemanticTokensProviderShape
import typings.vscodeLanguageclient.libCommonTextSynchronizationMod.DidChangeTextDocumentFeatureShape
import typings.vscodeLanguageclient.libCommonTextSynchronizationMod.DidCloseTextDocumentFeatureShape
import typings.vscodeLanguageclient.libCommonTextSynchronizationMod.DidOpenTextDocumentFeatureShape
import typings.vscodeLanguageclient.libCommonTextSynchronizationMod.DidSaveTextDocumentFeatureShape
...
trait FeatureClient[M, CO] extends StObject {
  ...
  var protocol2CodeConverter: typings.vscodeLanguageclient.libCommonProtocolConverterMod.Converter = js.native
