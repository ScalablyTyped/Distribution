...
object utilMod {
  ...
  inline def isPrimitive(value: js.Any): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPrimitive")(value.asInstanceOf[js.Any]).asInstanceOf[Boolean]
  ...
  inline def mixins[T /* <: js.Array[VueClass[Vue]] */](
  ...
  inline def mixins[T](Ctors: VueClass[Vue]*): VueClass[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("mixins")(Ctors.asInstanceOf[js.Any]).asInstanceOf[VueClass[T]]
