...
object declarationsMod {
  ...
  Instantiable0[
    ...
    ): ExtendedVue[Vue, Data, Methods, Computed, Record[PropNames, js.Any]] = js.native
    ...
    @JSName("component")
    def component_DataMethodsComputedPropNames_String[Data, Methods, Computed, PropNames /* <: String */](id: String): ExtendedVue[Vue, Data, Methods, Computed, Record[PropNames, js.Any]] = js.native
    @JSName("component")
    ...
    @JSName("component")
    def component_PropNames_String[PropNames /* <: String */](id: String, definition: FunctionalComponentOptions[Record[PropNames, js.Any], js.Array[PropNames]]): ExtendedVue[Vue, js.Object, js.Object, js.Object, Record[PropNames, js.Any]] = js.native
    @JSName("component")
    ...
    def extend[Data, Methods, Computed, PropNames /* <: String */](options: ThisTypedComponentOptionsWithArrayProps[Vue, Data, Methods, Computed, PropNames]): ExtendedVue[Vue, Data, Methods, Computed, Record[PropNames, js.Any]] = js.native
    def extend[Data, Methods, Computed, Props](options: ThisTypedComponentOptionsWithRecordProps[Vue, Data, Methods, Computed, Props]): ExtendedVue[Vue, Data, Methods, Computed, Props] = js.native
    @JSName("extend")
    def extend_DataMethodsComputedPropNames_String[Data, Methods, Computed, PropNames /* <: String */](): ExtendedVue[Vue, Data, Methods, Computed, Record[PropNames, js.Any]] = js.native
    @JSName("extend")
    def extend_DataMethodsComputedProps[Data, Methods, Computed, Props](): ExtendedVue[Vue, Data, Methods, Computed, Props] = js.native
    @JSName("extend")
    def extend_PropNames_String[PropNames /* <: String */](definition: FunctionalComponentOptions[Record[PropNames, js.Any], js.Array[PropNames]]): ExtendedVue[Vue, js.Object, js.Object, js.Object, Record[PropNames, js.Any]] = js.native
    ...
    def use(plugin: PluginFunction[js.Any], options: js.Any*): VueConstructor[Vue] = js.native
    def use(plugin: PluginObject[js.Any], options: js.Any*): VueConstructor[Vue] = js.native
