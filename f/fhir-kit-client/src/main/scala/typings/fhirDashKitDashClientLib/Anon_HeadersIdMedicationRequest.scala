...
trait Anon_HeadersIdMedicationRequest extends js.Object {
  ...
  var resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.MedicationRequest
...
object Anon_HeadersIdMedicationRequest {
  ...
  def apply(
    id: java.lang.String,
    resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.MedicationRequest,
