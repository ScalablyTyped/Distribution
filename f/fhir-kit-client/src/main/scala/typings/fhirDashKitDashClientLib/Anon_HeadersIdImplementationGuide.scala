...
trait Anon_HeadersIdImplementationGuide extends js.Object {
...
object Anon_HeadersIdImplementationGuide {
  @scala.inline
  def apply(
    id: java.lang.String,
