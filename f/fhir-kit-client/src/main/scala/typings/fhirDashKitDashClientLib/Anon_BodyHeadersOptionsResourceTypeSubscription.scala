...
trait Anon_BodyHeadersOptionsResourceTypeSubscription extends js.Object {
  var body: fhirLib.fhirNs.Subscription
  var headers: js.UndefOr[requestLib.requestMod.Headers] = js.undefined
  var options: js.UndefOr[requestLib.requestMod.Options] = js.undefined
  var resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.Subscription
}

object Anon_BodyHeadersOptionsResourceTypeSubscription {
  @scala.inline
  def apply(
    body: fhirLib.fhirNs.Subscription,
    resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.Subscription,
