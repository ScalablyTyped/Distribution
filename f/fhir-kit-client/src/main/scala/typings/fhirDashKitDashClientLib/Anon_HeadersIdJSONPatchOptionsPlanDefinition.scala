...
trait Anon_HeadersIdJSONPatchOptionsPlanDefinition extends js.Object {
...
object Anon_HeadersIdJSONPatchOptionsPlanDefinition {
  @scala.inline
  def apply(
  ...
  ): Anon_HeadersIdJSONPatchOptionsPlanDefinition = {
    val __obj = js.Dynamic.literal(JSONPatch = JSONPatch, id = id, resourceType = resourceType)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_HeadersIdJSONPatchOptionsPlanDefinition]
  }
}
