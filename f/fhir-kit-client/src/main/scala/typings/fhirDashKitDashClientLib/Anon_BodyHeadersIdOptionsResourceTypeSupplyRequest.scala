...
trait Anon_BodyHeadersIdOptionsResourceTypeSupplyRequest extends js.Object {
  var body: fhirLib.fhirNs.SupplyRequest
  var headers: js.UndefOr[requestLib.requestMod.Headers] = js.undefined
  var id: java.lang.String
  var options: js.UndefOr[requestLib.requestMod.Options] = js.undefined
  var resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.SupplyRequest
}

object Anon_BodyHeadersIdOptionsResourceTypeSupplyRequest {
  @scala.inline
  def apply(
    body: fhirLib.fhirNs.SupplyRequest,
    id: java.lang.String,
    resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.SupplyRequest,
