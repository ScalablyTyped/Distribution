...
trait Anon_HeadersIdOptionsPlanDefinition extends js.Object {
...
object Anon_HeadersIdOptionsPlanDefinition {
  @scala.inline
  def apply(
    id: java.lang.String,
