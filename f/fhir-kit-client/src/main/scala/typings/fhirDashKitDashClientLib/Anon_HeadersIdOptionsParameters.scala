...
trait Anon_HeadersIdOptionsParameters extends js.Object {
...
object Anon_HeadersIdOptionsParameters {
  @scala.inline
  def apply(
    id: java.lang.String,
