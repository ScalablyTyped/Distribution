...
trait Anon_HeadersIdOptionsResourceTypeSchedule extends js.Object {
...
object Anon_HeadersIdOptionsResourceTypeSchedule {
  @scala.inline
  def apply(
    id: java.lang.String,
  ...
  ): Anon_HeadersIdOptionsResourceTypeSchedule = {
    val __obj = js.Dynamic.literal(id = id, resourceType = resourceType, version = version)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_HeadersIdOptionsResourceTypeSchedule]
  }
}
