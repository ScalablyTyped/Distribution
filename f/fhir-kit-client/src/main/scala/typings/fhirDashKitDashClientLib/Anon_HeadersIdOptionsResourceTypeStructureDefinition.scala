...
trait Anon_HeadersIdOptionsResourceTypeStructureDefinition extends js.Object {
...
object Anon_HeadersIdOptionsResourceTypeStructureDefinition {
  @scala.inline
  def apply(
    id: java.lang.String,
  ...
  ): Anon_HeadersIdOptionsResourceTypeStructureDefinition = {
    val __obj = js.Dynamic.literal(id = id, resourceType = resourceType, version = version)
    if (headers != null) __obj.updateDynamic("headers")(headers)
    if (options != null) __obj.updateDynamic("options")(options.asInstanceOf[js.Any])
    __obj.asInstanceOf[Anon_HeadersIdOptionsResourceTypeStructureDefinition]
  }
}
