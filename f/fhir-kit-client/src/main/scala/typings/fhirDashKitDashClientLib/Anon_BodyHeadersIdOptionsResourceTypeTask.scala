...
trait Anon_BodyHeadersIdOptionsResourceTypeTask extends js.Object {
  var body: fhirLib.fhirNs.Task
  var headers: js.UndefOr[requestLib.requestMod.Headers] = js.undefined
  var id: java.lang.String
  var options: js.UndefOr[requestLib.requestMod.Options] = js.undefined
  var resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.Task
}

object Anon_BodyHeadersIdOptionsResourceTypeTask {
  @scala.inline
  def apply(
    body: fhirLib.fhirNs.Task,
    id: java.lang.String,
    resourceType: fhirDashKitDashClientLib.fhirDashKitDashClientLibStrings.Task,
